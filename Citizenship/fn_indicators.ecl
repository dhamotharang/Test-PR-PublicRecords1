IMPORT DueDiligence, Risk_Indicators, std, Models;
...
//========================================================================================
  ...
  indicators := JOIN(cleanedInput, clam, 
                      ...
                      TRANSFORM(Citizenship.Layouts.IndicatorLayout,  
                                ...
                                //sysdate    := Models.common.sas_date(if(RIGHT.historydate=999999, (STRING)ut.getdate, (STRING6)RIGHT.historydate+'01'));
                                ...
                                earliest_header_date    := Citizenship.Ver_source_Function(False,
                                                                                           ...
                                                                                           RIGHT.header_summary.ver_sources_nas);
                                
                                earliest_header_yrs     := if(min(sysdate, earliest_header_date) = NULL, NULL, 
                                                           if((sysdate - earliest_header_date) / 365.25 >= 0, roundup((sysdate - earliest_header_date) / 365.25), truncate((sysdate - earliest_header_date) / 365.25)));
                                ...
                                iv_header_emergence_age := map(
                                                               ...
                                                               earliest_header_yrs = NULL  => NEG1,   //***added
                             ...
                             //***emergenceAgeBureau 
                                ...
                                earliest_bureau_yrs := if(earliest_bureau_date = NULL or sysdate = NULL, NULL, 
                                                       if((sysdate - earliest_bureau_date) / 365.25 >= 0, roundup((sysdate - earliest_bureau_date) / 365.25), truncate((sysdate - earliest_bureau_date) / 365.25)));                                                        
                             ...
                             //***ssnIssuanceAge
                                ...
                                ssn_years       := if(_rc_ssnlowissue = NULL or sysdate = NULL, NULL, 
                                                   if ((sysdate - _rc_ssnlowissue) / 365.25 >= 0, roundup((sysdate - _rc_ssnlowissue) / 365.25), truncate((sysdate - _rc_ssnlowissue) / 365.25)));
                             ...
                             //***ver_StudentFile  
                                ver_src_sl_pos := Models.Common.findw_cpp(RIGHT.header_summary.ver_sources, 'SL' , '  ,', 'ie');
