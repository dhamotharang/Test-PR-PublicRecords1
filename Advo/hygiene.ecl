...
EXPORT Summary(SALT30.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_ZIP_5 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ZIP_5)));
    avelength_ZIP_5 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ZIP_5)),h.ZIP_5<>(typeof(h.ZIP_5))'');
    populated_Route_Num_pcnt := AVE(GROUP,IF(h.Route_Num = (TYPEOF(h.Route_Num))'',0,100));
    maxlength_Route_Num := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Route_Num)));
    avelength_Route_Num := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Route_Num)),h.Route_Num<>(typeof(h.Route_Num))'');
    populated_ZIP_4_pcnt := AVE(GROUP,IF(h.ZIP_4 = (TYPEOF(h.ZIP_4))'',0,100));
    maxlength_ZIP_4 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ZIP_4)));
    avelength_ZIP_4 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ZIP_4)),h.ZIP_4<>(typeof(h.ZIP_4))'');
    populated_WALK_Sequence_pcnt := AVE(GROUP,IF(h.WALK_Sequence = (TYPEOF(h.WALK_Sequence))'',0,100));
    maxlength_WALK_Sequence := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.WALK_Sequence)));
    avelength_WALK_Sequence := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.WALK_Sequence)),h.WALK_Sequence<>(typeof(h.WALK_Sequence))'');
    populated_STREET_NUM_pcnt := AVE(GROUP,IF(h.STREET_NUM = (TYPEOF(h.STREET_NUM))'',0,100));
    maxlength_STREET_NUM := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_NUM)));
    avelength_STREET_NUM := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_NUM)),h.STREET_NUM<>(typeof(h.STREET_NUM))'');
    populated_STREET_PRE_DIRectional_pcnt := AVE(GROUP,IF(h.STREET_PRE_DIRectional = (TYPEOF(h.STREET_PRE_DIRectional))'',0,100));
    maxlength_STREET_PRE_DIRectional := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_PRE_DIRectional)));
    avelength_STREET_PRE_DIRectional := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_PRE_DIRectional)),h.STREET_PRE_DIRectional<>(typeof(h.STREET_PRE_DIRectional))'');
    ...
    maxlength_STREET_POST_DIRectional := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_POST_DIRectional)));
    avelength_STREET_POST_DIRectional := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.STREET_POST_DIRectional)),h.STREET_POST_DIRectional<>(typeof(h.STREET_POST_DIRectional))'');
    ...
    maxlength_Secondary_Unit_Designator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Secondary_Unit_Designator)));
    avelength_Secondary_Unit_Designator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Secondary_Unit_Designator)),h.Secondary_Unit_Designator<>(typeof(h.Secondary_Unit_Designator))'');
    populated_Secondary_Unit_Number_pcnt := AVE(GROUP,IF(h.Secondary_Unit_Number = (TYPEOF(h.Secondary_Unit_Number))'',0,100));
    maxlength_Secondary_Unit_Number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Secondary_Unit_Number)));
    avelength_Secondary_Unit_Number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Secondary_Unit_Number)),h.Secondary_Unit_Number<>(typeof(h.Secondary_Unit_Number))'');
    ...
    maxlength_Address_Vacancy_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Vacancy_Indicator)));
    avelength_Address_Vacancy_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Vacancy_Indicator)),h.Address_Vacancy_Indicator<>(typeof(h.Address_Vacancy_Indicator))'');
    populated_Throw_Back_Indicator_pcnt := AVE(GROUP,IF(h.Throw_Back_Indicator = (TYPEOF(h.Throw_Back_Indicator))'',0,100));
    maxlength_Throw_Back_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Throw_Back_Indicator)));
    avelength_Throw_Back_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Throw_Back_Indicator)),h.Throw_Back_Indicator<>(typeof(h.Throw_Back_Indicator))'');
    ...
    maxlength_Seasonal_Delivery_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_Delivery_Indicator)));
    avelength_Seasonal_Delivery_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_Delivery_Indicator)),h.Seasonal_Delivery_Indicator<>(typeof(h.Seasonal_Delivery_Indicator))'');
    ...
    maxlength_Seasonal_Start_Suppression_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_Start_Suppression_Date)));
    avelength_Seasonal_Start_Suppression_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_Start_Suppression_Date)),h.Seasonal_Start_Suppression_Date<>(typeof(h.Seasonal_Start_Suppression_Date))'');
    ...
    maxlength_Seasonal_End_Suppression_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_End_Suppression_Date)));
    avelength_Seasonal_End_Suppression_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Seasonal_End_Suppression_Date)),h.Seasonal_End_Suppression_Date<>(typeof(h.Seasonal_End_Suppression_Date))'');
    populated_DND_Indicator_pcnt := AVE(GROUP,IF(h.DND_Indicator = (TYPEOF(h.DND_Indicator))'',0,100));
    maxlength_DND_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.DND_Indicator)));
    avelength_DND_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.DND_Indicator)),h.DND_Indicator<>(typeof(h.DND_Indicator))'');
    populated_College_Indicator_pcnt := AVE(GROUP,IF(h.College_Indicator = (TYPEOF(h.College_Indicator))'',0,100));
    maxlength_College_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_Indicator)));
    avelength_College_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_Indicator)),h.College_Indicator<>(typeof(h.College_Indicator))'');
    ...
    maxlength_College_Start_Suppression_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_Start_Suppression_Date)));
    avelength_College_Start_Suppression_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_Start_Suppression_Date)),h.College_Start_Suppression_Date<>(typeof(h.College_Start_Suppression_Date))'');
    ...
    maxlength_College_End_Suppression_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_End_Suppression_Date)));
    avelength_College_End_Suppression_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.College_End_Suppression_Date)),h.College_End_Suppression_Date<>(typeof(h.College_End_Suppression_Date))'');
    populated_Address_Style_Flag_pcnt := AVE(GROUP,IF(h.Address_Style_Flag = (TYPEOF(h.Address_Style_Flag))'',0,100));
    maxlength_Address_Style_Flag := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Style_Flag)));
    avelength_Address_Style_Flag := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Style_Flag)),h.Address_Style_Flag<>(typeof(h.Address_Style_Flag))'');
    populated_Simplify_Address_Count_pcnt := AVE(GROUP,IF(h.Simplify_Address_Count = (TYPEOF(h.Simplify_Address_Count))'',0,100));
    maxlength_Simplify_Address_Count := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Simplify_Address_Count)));
    avelength_Simplify_Address_Count := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Simplify_Address_Count)),h.Simplify_Address_Count<>(typeof(h.Simplify_Address_Count))'');
    populated_Drop_Indicator_pcnt := AVE(GROUP,IF(h.Drop_Indicator = (TYPEOF(h.Drop_Indicator))'',0,100));
    maxlength_Drop_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Drop_Indicator)));
    avelength_Drop_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Drop_Indicator)),h.Drop_Indicator<>(typeof(h.Drop_Indicator))'');
    ...
    maxlength_Residential_or_Business_Ind := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Residential_or_Business_Ind)));
    avelength_Residential_or_Business_Ind := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Residential_or_Business_Ind)),h.Residential_or_Business_Ind<>(typeof(h.Residential_or_Business_Ind))'');
    populated_DPBC_Digit_pcnt := AVE(GROUP,IF(h.DPBC_Digit = (TYPEOF(h.DPBC_Digit))'',0,100));
    maxlength_DPBC_Digit := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.DPBC_Digit)));
    avelength_DPBC_Digit := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.DPBC_Digit)),h.DPBC_Digit<>(typeof(h.DPBC_Digit))'');
    populated_DPBC_Check_Digit_pcnt := AVE(GROUP,IF(h.DPBC_Check_Digit = (TYPEOF(h.DPBC_Check_Digit))'',0,100));
    maxlength_DPBC_Check_Digit := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.DPBC_Check_Digit)));
    avelength_DPBC_Check_Digit := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.DPBC_Check_Digit)),h.DPBC_Check_Digit<>(typeof(h.DPBC_Check_Digit))'');
    populated_Update_Date_pcnt := AVE(GROUP,IF(h.Update_Date = (TYPEOF(h.Update_Date))'',0,100));
    maxlength_Update_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Update_Date)));
    avelength_Update_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Update_Date)),h.Update_Date<>(typeof(h.Update_Date))'');
    populated_File_Release_Date_pcnt := AVE(GROUP,IF(h.File_Release_Date = (TYPEOF(h.File_Release_Date))'',0,100));
    maxlength_File_Release_Date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.File_Release_Date)));
    avelength_File_Release_Date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.File_Release_Date)),h.File_Release_Date<>(typeof(h.File_Release_Date))'');
    ...
    maxlength_Override_file_release_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Override_file_release_date)));
    avelength_Override_file_release_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Override_file_release_date)),h.Override_file_release_date<>(typeof(h.Override_file_release_date))'');
    populated_County_Num_pcnt := AVE(GROUP,IF(h.County_Num = (TYPEOF(h.County_Num))'',0,100));
    maxlength_County_Num := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.County_Num)));
    avelength_County_Num := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.County_Num)),h.County_Num<>(typeof(h.County_Num))'');
    populated_County_Name_pcnt := AVE(GROUP,IF(h.County_Name = (TYPEOF(h.County_Name))'',0,100));
    maxlength_County_Name := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.County_Name)));
    avelength_County_Name := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.County_Name)),h.County_Name<>(typeof(h.County_Name))'');
    ...
    maxlength_State_Code := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.State_Code)));
    avelength_State_Code := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.State_Code)),h.State_Code<>(typeof(h.State_Code))'');
    populated_State_Num_pcnt := AVE(GROUP,IF(h.State_Num = (TYPEOF(h.State_Num))'',0,100));
    maxlength_State_Num := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.State_Num)));
    avelength_State_Num := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.State_Num)),h.State_Num<>(typeof(h.State_Num))'');
    ...
    maxlength_Congressional_District_Number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Congressional_District_Number)));
    avelength_Congressional_District_Number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Congressional_District_Number)),h.Congressional_District_Number<>(typeof(h.Congressional_District_Number))'');
    populated_OWGM_Indicator_pcnt := AVE(GROUP,IF(h.OWGM_Indicator = (TYPEOF(h.OWGM_Indicator))'',0,100));
    maxlength_OWGM_Indicator := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.OWGM_Indicator)));
    avelength_OWGM_Indicator := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.OWGM_Indicator)),h.OWGM_Indicator<>(typeof(h.OWGM_Indicator))'');
    populated_Record_Type_Code_pcnt := AVE(GROUP,IF(h.Record_Type_Code = (TYPEOF(h.Record_Type_Code))'',0,100));
    maxlength_Record_Type_Code := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Record_Type_Code)));
    avelength_Record_Type_Code := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Record_Type_Code)),h.Record_Type_Code<>(typeof(h.Record_Type_Code))'');
    populated_ADVO_Key_pcnt := AVE(GROUP,IF(h.ADVO_Key = (TYPEOF(h.ADVO_Key))'',0,100));
    maxlength_ADVO_Key := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ADVO_Key)));
    avelength_ADVO_Key := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ADVO_Key)),h.ADVO_Key<>(typeof(h.ADVO_Key))'');
    populated_Address_Type_pcnt := AVE(GROUP,IF(h.Address_Type = (TYPEOF(h.Address_Type))'',0,100));
    maxlength_Address_Type := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Type)));
    avelength_Address_Type := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Address_Type)),h.Address_Type<>(typeof(h.Address_Type))'');
    populated_Mixed_Address_Usage_pcnt := AVE(GROUP,IF(h.Mixed_Address_Usage = (TYPEOF(h.Mixed_Address_Usage))'',0,100));
    maxlength_Mixed_Address_Usage := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Mixed_Address_Usage)));
    avelength_Mixed_Address_Usage := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Mixed_Address_Usage)),h.Mixed_Address_Usage<>(typeof(h.Mixed_Address_Usage))'');
    ...
    maxlength_VAC_BEGDT := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_BEGDT)));
    avelength_VAC_BEGDT := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_BEGDT)),h.VAC_BEGDT<>(typeof(h.VAC_BEGDT))'');
    populated_VAC_ENDDT_pcnt := AVE(GROUP,IF(h.VAC_ENDDT = (TYPEOF(h.VAC_ENDDT))'',0,100));
    maxlength_VAC_ENDDT := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_ENDDT)));
    avelength_VAC_ENDDT := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_ENDDT)),h.VAC_ENDDT<>(typeof(h.VAC_ENDDT))'');
    populated_MONTHS_VAC_CURR_pcnt := AVE(GROUP,IF(h.MONTHS_VAC_CURR = (TYPEOF(h.MONTHS_VAC_CURR))'',0,100));
    maxlength_MONTHS_VAC_CURR := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.MONTHS_VAC_CURR)));
    avelength_MONTHS_VAC_CURR := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.MONTHS_VAC_CURR)),h.MONTHS_VAC_CURR<>(typeof(h.MONTHS_VAC_CURR))'');
    populated_MONTHS_VAC_MAX_pcnt := AVE(GROUP,IF(h.MONTHS_VAC_MAX = (TYPEOF(h.MONTHS_VAC_MAX))'',0,100));
    maxlength_MONTHS_VAC_MAX := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.MONTHS_VAC_MAX)));
    avelength_MONTHS_VAC_MAX := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.MONTHS_VAC_MAX)),h.MONTHS_VAC_MAX<>(typeof(h.MONTHS_VAC_MAX))'');
    populated_VAC_COUNT_pcnt := AVE(GROUP,IF(h.VAC_COUNT = (TYPEOF(h.VAC_COUNT))'',0,100));
    maxlength_VAC_COUNT := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_COUNT)));
    avelength_VAC_COUNT := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.VAC_COUNT)),h.VAC_COUNT<>(typeof(h.VAC_COUNT))'');
    ...
    maxlength_addresstype := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.addresstype)));
    avelength_addresstype := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.addresstype)),h.addresstype<>(typeof(h.addresstype))'');
    populated_Active_flag_pcnt := AVE(GROUP,IF(h.Active_flag = (TYPEOF(h.Active_flag))'',0,100));
    maxlength_Active_flag := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Active_flag)));
    avelength_Active_flag := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Active_flag)),h.Active_flag<>(typeof(h.Active_flag))'');
  END;
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.ZIP_5),TRIM((SALT30.StrType)le.Route_Num),TRIM((SALT30.StrType)le.ZIP_4),TRIM((SALT30.StrType)le.WALK_Sequence),TRIM((SALT30.StrType)le.STREET_NUM),TRIM((SALT30.StrType)le.STREET_PRE_DIRectional),TRIM((SALT30.StrType)le.STREET_NAME),TRIM((SALT30.StrType)le.STREET_POST_DIRectional),TRIM((SALT30.StrType)le.STREET_SUFFIX),TRIM((SALT30.StrType)le.Secondary_Unit_Designator),TRIM((SALT30.StrType)le.Secondary_Unit_Number),TRIM((SALT30.StrType)le.Address_Vacancy_Indicator),TRIM((SALT30.StrType)le.Throw_Back_Indicator),TRIM((SALT30.StrType)le.Seasonal_Delivery_Indicator),TRIM((SALT30.StrType)le.Seasonal_Start_Suppression_Date),TRIM((SALT30.StrType)le.Seasonal_End_Suppression_Date),TRIM((SALT30.StrType)le.DND_Indicator),TRIM((SALT30.StrType)le.College_Indicator),TRIM((SALT30.StrType)le.College_Start_Suppression_Date),TRIM((SALT30.StrType)le.College_End_Suppression_Date),TRIM((SALT30.StrType)le.Address_Style_Flag),TRIM((SALT30.StrType)le.Simplify_Address_Count),TRIM((SALT30.StrType)le.Drop_Indicator),TRIM((SALT30.StrType)le.Residential_or_Business_Ind),TRIM((SALT30.StrType)le.DPBC_Digit),TRIM((SALT30.StrType)le.DPBC_Check_Digit),TRIM((SALT30.StrType)le.Update_Date),TRIM((SALT30.StrType)le.File_Release_Date),TRIM((SALT30.StrType)le.Override_file_release_date),TRIM((SALT30.StrType)le.County_Num),TRIM((SALT30.StrType)le.County_Name),TRIM((SALT30.StrType)le.City_Name),TRIM((SALT30.StrType)le.State_Code),TRIM((SALT30.StrType)le.State_Num),TRIM((SALT30.StrType)le.Congressional_District_Number),TRIM((SALT30.StrType)le.OWGM_Indicator),TRIM((SALT30.StrType)le.Record_Type_Code),TRIM((SALT30.StrType)le.ADVO_Key),TRIM((SALT30.StrType)le.Address_Type),TRIM((SALT30.StrType)le.Mixed_Address_Usage),TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.VAC_BEGDT),TRIM((SALT30.StrType)le.VAC_ENDDT),TRIM((SALT30.StrType)le.MONTHS_VAC_CURR),TRIM((SALT30.StrType)le.MONTHS_VAC_MAX),TRIM((SALT30.StrType)le.VAC_COUNT),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.addr_suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dbpc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.fips_county),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.RawAID),TRIM((SALT30.StrType)le.cleanaid),TRIM((SALT30.StrType)le.addresstype),TRIM((SALT30.StrType)le.Active_flag)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 80);
  SELF.FldNo2 := 1 + (C % 80);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.ZIP_5),TRIM((SALT30.StrType)le.Route_Num),TRIM((SALT30.StrType)le.ZIP_4),TRIM((SALT30.StrType)le.WALK_Sequence),TRIM((SALT30.StrType)le.STREET_NUM),TRIM((SALT30.StrType)le.STREET_PRE_DIRectional),TRIM((SALT30.StrType)le.STREET_NAME),TRIM((SALT30.StrType)le.STREET_POST_DIRectional),TRIM((SALT30.StrType)le.STREET_SUFFIX),TRIM((SALT30.StrType)le.Secondary_Unit_Designator),TRIM((SALT30.StrType)le.Secondary_Unit_Number),TRIM((SALT30.StrType)le.Address_Vacancy_Indicator),TRIM((SALT30.StrType)le.Throw_Back_Indicator),TRIM((SALT30.StrType)le.Seasonal_Delivery_Indicator),TRIM((SALT30.StrType)le.Seasonal_Start_Suppression_Date),TRIM((SALT30.StrType)le.Seasonal_End_Suppression_Date),TRIM((SALT30.StrType)le.DND_Indicator),TRIM((SALT30.StrType)le.College_Indicator),TRIM((SALT30.StrType)le.College_Start_Suppression_Date),TRIM((SALT30.StrType)le.College_End_Suppression_Date),TRIM((SALT30.StrType)le.Address_Style_Flag),TRIM((SALT30.StrType)le.Simplify_Address_Count),TRIM((SALT30.StrType)le.Drop_Indicator),TRIM((SALT30.StrType)le.Residential_or_Business_Ind),TRIM((SALT30.StrType)le.DPBC_Digit),TRIM((SALT30.StrType)le.DPBC_Check_Digit),TRIM((SALT30.StrType)le.Update_Date),TRIM((SALT30.StrType)le.File_Release_Date),TRIM((SALT30.StrType)le.Override_file_release_date),TRIM((SALT30.StrType)le.County_Num),TRIM((SALT30.StrType)le.County_Name),TRIM((SALT30.StrType)le.City_Name),TRIM((SALT30.StrType)le.State_Code),TRIM((SALT30.StrType)le.State_Num),TRIM((SALT30.StrType)le.Congressional_District_Number),TRIM((SALT30.StrType)le.OWGM_Indicator),TRIM((SALT30.StrType)le.Record_Type_Code),TRIM((SALT30.StrType)le.ADVO_Key),TRIM((SALT30.StrType)le.Address_Type),TRIM((SALT30.StrType)le.Mixed_Address_Usage),TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.VAC_BEGDT),TRIM((SALT30.StrType)le.VAC_ENDDT),TRIM((SALT30.StrType)le.MONTHS_VAC_CURR),TRIM((SALT30.StrType)le.MONTHS_VAC_MAX),TRIM((SALT30.StrType)le.VAC_COUNT),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.addr_suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dbpc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.fips_county),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.RawAID),TRIM((SALT30.StrType)le.cleanaid),TRIM((SALT30.StrType)le.addresstype),TRIM((SALT30.StrType)le.Active_flag)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.ZIP_5),TRIM((SALT30.StrType)le.Route_Num),TRIM((SALT30.StrType)le.ZIP_4),TRIM((SALT30.StrType)le.WALK_Sequence),TRIM((SALT30.StrType)le.STREET_NUM),TRIM((SALT30.StrType)le.STREET_PRE_DIRectional),TRIM((SALT30.StrType)le.STREET_NAME),TRIM((SALT30.StrType)le.STREET_POST_DIRectional),TRIM((SALT30.StrType)le.STREET_SUFFIX),TRIM((SALT30.StrType)le.Secondary_Unit_Designator),TRIM((SALT30.StrType)le.Secondary_Unit_Number),TRIM((SALT30.StrType)le.Address_Vacancy_Indicator),TRIM((SALT30.StrType)le.Throw_Back_Indicator),TRIM((SALT30.StrType)le.Seasonal_Delivery_Indicator),TRIM((SALT30.StrType)le.Seasonal_Start_Suppression_Date),TRIM((SALT30.StrType)le.Seasonal_End_Suppression_Date),TRIM((SALT30.StrType)le.DND_Indicator),TRIM((SALT30.StrType)le.College_Indicator),TRIM((SALT30.StrType)le.College_Start_Suppression_Date),TRIM((SALT30.StrType)le.College_End_Suppression_Date),TRIM((SALT30.StrType)le.Address_Style_Flag),TRIM((SALT30.StrType)le.Simplify_Address_Count),TRIM((SALT30.StrType)le.Drop_Indicator),TRIM((SALT30.StrType)le.Residential_or_Business_Ind),TRIM((SALT30.StrType)le.DPBC_Digit),TRIM((SALT30.StrType)le.DPBC_Check_Digit),TRIM((SALT30.StrType)le.Update_Date),TRIM((SALT30.StrType)le.File_Release_Date),TRIM((SALT30.StrType)le.Override_file_release_date),TRIM((SALT30.StrType)le.County_Num),TRIM((SALT30.StrType)le.County_Name),TRIM((SALT30.StrType)le.City_Name),TRIM((SALT30.StrType)le.State_Code),TRIM((SALT30.StrType)le.State_Num),TRIM((SALT30.StrType)le.Congressional_District_Number),TRIM((SALT30.StrType)le.OWGM_Indicator),TRIM((SALT30.StrType)le.Record_Type_Code),TRIM((SALT30.StrType)le.ADVO_Key),TRIM((SALT30.StrType)le.Address_Type),TRIM((SALT30.StrType)le.Mixed_Address_Usage),TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.VAC_BEGDT),TRIM((SALT30.StrType)le.VAC_ENDDT),TRIM((SALT30.StrType)le.MONTHS_VAC_CURR),TRIM((SALT30.StrType)le.MONTHS_VAC_MAX),TRIM((SALT30.StrType)le.VAC_COUNT),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.addr_suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dbpc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.fips_county),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.RawAID),TRIM((SALT30.StrType)le.cleanaid),TRIM((SALT30.StrType)le.addresstype),TRIM((SALT30.StrType)le.Active_flag)));
  END;
...
SHARED FldIds := DATASET([{1,'ZIP_5'}
      ...
      ,{78,'cleanaid'}
      ,{79,'addresstype'}
      ,{80,'Active_flag'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_ZIP_5((SALT30.StrType)le.ZIP_5),
    Fields.InValid_Route_Num((SALT30.StrType)le.Route_Num),
    Fields.InValid_ZIP_4((SALT30.StrType)le.ZIP_4),
    Fields.InValid_WALK_Sequence((SALT30.StrType)le.WALK_Sequence),
    Fields.InValid_STREET_NUM((SALT30.StrType)le.STREET_NUM),
    Fields.InValid_STREET_PRE_DIRectional((SALT30.StrType)le.STREET_PRE_DIRectional),
    Fields.InValid_STREET_NAME((SALT30.StrType)le.STREET_NAME),
    Fields.InValid_STREET_POST_DIRectional((SALT30.StrType)le.STREET_POST_DIRectional),
    Fields.InValid_STREET_SUFFIX((SALT30.StrType)le.STREET_SUFFIX),
    Fields.InValid_Secondary_Unit_Designator((SALT30.StrType)le.Secondary_Unit_Designator),
    Fields.InValid_Secondary_Unit_Number((SALT30.StrType)le.Secondary_Unit_Number),
    Fields.InValid_Address_Vacancy_Indicator((SALT30.StrType)le.Address_Vacancy_Indicator),
    Fields.InValid_Throw_Back_Indicator((SALT30.StrType)le.Throw_Back_Indicator),
    Fields.InValid_Seasonal_Delivery_Indicator((SALT30.StrType)le.Seasonal_Delivery_Indicator),
    Fields.InValid_Seasonal_Start_Suppression_Date((SALT30.StrType)le.Seasonal_Start_Suppression_Date),
    Fields.InValid_Seasonal_End_Suppression_Date((SALT30.StrType)le.Seasonal_End_Suppression_Date),
    Fields.InValid_DND_Indicator((SALT30.StrType)le.DND_Indicator),
    Fields.InValid_College_Indicator((SALT30.StrType)le.College_Indicator),
    Fields.InValid_College_Start_Suppression_Date((SALT30.StrType)le.College_Start_Suppression_Date),
    Fields.InValid_College_End_Suppression_Date((SALT30.StrType)le.College_End_Suppression_Date),
    Fields.InValid_Address_Style_Flag((SALT30.StrType)le.Address_Style_Flag),
    Fields.InValid_Simplify_Address_Count((SALT30.StrType)le.Simplify_Address_Count),
    Fields.InValid_Drop_Indicator((SALT30.StrType)le.Drop_Indicator),
    Fields.InValid_Residential_or_Business_Ind((SALT30.StrType)le.Residential_or_Business_Ind),
    Fields.InValid_DPBC_Digit((SALT30.StrType)le.DPBC_Digit),
    Fields.InValid_DPBC_Check_Digit((SALT30.StrType)le.DPBC_Check_Digit),
    Fields.InValid_Update_Date((SALT30.StrType)le.Update_Date),
    Fields.InValid_File_Release_Date((SALT30.StrType)le.File_Release_Date),
    Fields.InValid_Override_file_release_date((SALT30.StrType)le.Override_file_release_date),
    Fields.InValid_County_Num((SALT30.StrType)le.County_Num),
    Fields.InValid_County_Name((SALT30.StrType)le.County_Name),
    Fields.InValid_City_Name((SALT30.StrType)le.City_Name),
    Fields.InValid_State_Code((SALT30.StrType)le.State_Code),
    Fields.InValid_State_Num((SALT30.StrType)le.State_Num),
    Fields.InValid_Congressional_District_Number((SALT30.StrType)le.Congressional_District_Number),
    Fields.InValid_OWGM_Indicator((SALT30.StrType)le.OWGM_Indicator),
    Fields.InValid_Record_Type_Code((SALT30.StrType)le.Record_Type_Code),
    Fields.InValid_ADVO_Key((SALT30.StrType)le.ADVO_Key),
    Fields.InValid_Address_Type((SALT30.StrType)le.Address_Type),
    Fields.InValid_Mixed_Address_Usage((SALT30.StrType)le.Mixed_Address_Usage),
    ...
    Fields.InValid_VAC_BEGDT((SALT30.StrType)le.VAC_BEGDT),
    Fields.InValid_VAC_ENDDT((SALT30.StrType)le.VAC_ENDDT),
    Fields.InValid_MONTHS_VAC_CURR((SALT30.StrType)le.MONTHS_VAC_CURR),
    Fields.InValid_MONTHS_VAC_MAX((SALT30.StrType)le.MONTHS_VAC_MAX),
    Fields.InValid_VAC_COUNT((SALT30.StrType)le.VAC_COUNT),
    ...
    Fields.InValid_addresstype((SALT30.StrType)le.addresstype),
    Fields.InValid_Active_flag((SALT30.StrType)le.Active_flag),
    0);
