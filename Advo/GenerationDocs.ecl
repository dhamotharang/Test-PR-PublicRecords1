...
//PROCESS:<ProcessName>
FIELDTYPE:invalid_street:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 /-.):LENGTHS(0..)
...
FIELDTYPE:invalid_AddrUsg:ALLOW(ABCDEFGHSTUV):LENGTHS(1)
FIELDTYPE:invalid_zip:ALLOW(0123456789):LENGTHS(0,4,5)
FIELDTYPE:invalid_route_num:ALLOW(0123456789BHGRC):LENGTHS(4)
...
FIELDTYPE:invalid_cda:ALLOW(0123456789LA):Lengths(1,2)
