...
#workunit('name','Advo.BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
IMPORT Advo,SALT311;
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_Scrubs'),NAMED('OptimizedLayout'));// File layout suggested by data
