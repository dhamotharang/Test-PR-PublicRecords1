...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_flag_code','invalid_name_type_cd','invalid_term_exist_cd','invalid_term_exist_desc','invalid_for_dom_ind','invalid_recordorigin','invalid_numeric','invalid_numblank','invalid_status_cd','invalid_llc_managed_cd','invalid_fein','invalid_alphaNum_sp','invalid_alphablank','invalid_orig_org_structure_cd');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_supp_key' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_charter_nbr' => 8,'invalid_flag_code' => 9,'invalid_name_type_cd' => 10,'invalid_term_exist_cd' => 11,'invalid_term_exist_desc' => 12,'invalid_for_dom_ind' => 13,'invalid_recordorigin' => 14,'invalid_numeric' => 15,'invalid_numblank' => 16,'invalid_status_cd' => 17,'invalid_llc_managed_cd' => 18,'invalid_fein' => 19,'invalid_alphaNum_sp' => 20,'invalid_alphablank' => 21,'invalid_orig_org_structure_cd' => 22,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['18']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('18'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['IN']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('IN'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IN_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IN_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_status_cd);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_status_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_llc_managed_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_llc_managed_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['0','1',' ']);
EXPORT InValidMessageFT_invalid_llc_managed_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('0|1| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fein(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_fein(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 9));
...
EXPORT MakeFT_invalid_orig_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_org_structure_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_org_cd);
EXPORT InValidMessageFT_invalid_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_org_cd'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_supp_key(SALT34.StrType s0) := MakeFT_invalid_supp_key(s0);
EXPORT InValid_corp_supp_key(SALT34.StrType s) := InValidFT_invalid_supp_key(s);
EXPORT InValidMessage_corp_supp_key(UNSIGNED1 wh) := InValidMessageFT_invalid_supp_key(wh);
...
EXPORT Make_corp_fed_tax_id(SALT34.StrType s0) := MakeFT_invalid_fein(s0);
EXPORT InValid_corp_fed_tax_id(SALT34.StrType s) := InValidFT_invalid_fein(s);
...
EXPORT Make_corp_orig_org_structure_desc(SALT34.StrType s0) := MakeFT_invalid_alphaNum_sp(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT34.StrType s) := InValidFT_invalid_alphaNum_sp(s);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaNum_sp(wh);
...
EXPORT Make_corp_acts(SALT34.StrType s0) := MakeFT_invalid_alphaNum_sp(s0);
EXPORT InValid_corp_acts(SALT34.StrType s) := InValidFT_invalid_alphaNum_sp(s);
EXPORT InValidMessage_corp_acts(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaNum_sp(wh);
...
EXPORT Make_corp_llc_managed_ind(SALT34.StrType s0) := MakeFT_invalid_llc_managed_cd(s0);
EXPORT InValid_corp_llc_managed_ind(SALT34.StrType s) := InValidFT_invalid_llc_managed_cd(s);
EXPORT InValidMessage_corp_llc_managed_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_llc_managed_cd(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_IN_Main;
