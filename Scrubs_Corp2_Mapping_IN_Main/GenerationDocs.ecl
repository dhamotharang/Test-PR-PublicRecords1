...
Command line options: -MScrubs_Corp2_Mapping_IN_Main -eC:\Users\mattel01\AppData\Local\Temp\TFR6001.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IN_Main
FILENAME:in_file
...
FIELDTYPE:invalid_corp_vendor:ENUM(18)
FIELDTYPE:invalid_state_origin:ENUM(IN)
...
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_IN_Main.Functions.invalid_name_type_code>0,recordorigin)
...
FIELDTYPE:invalid_status_cd:ENUM(Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_status_cd)
FIELDTYPE:invalid_llc_managed_cd:ENUM(0|1| ) 
FIELDTYPE:invalid_fein:ALLOW(0123456789):LENGTHS(0,9)
FIELDTYPE:invalid_alphaNum_sp:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-().)
FIELDTYPE:invalid_alphablank:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_IN_Main.Functions.set_valid_org_cd)
...
FIELD:corp_supp_key:TYPE(STRING30):LIKE(invalid_supp_key):0,0
...
FIELD:corp_inc_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:corp_forgn_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_alphaNum_sp):0,0
...
FIELD:corp_acts:TYPE(STRING50):LIKE(invalid_alphaNum_sp):0,0
...
FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_alphaNum_sp):0,0
...
FIELD:corp_llc_managed_ind:TYPE(STRING1):LIKE(invalid_llc_managed_cd):0,0
