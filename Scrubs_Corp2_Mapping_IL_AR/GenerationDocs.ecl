...
Command line options: -MScrubs_Corp2_Mapping_IL_AR -eC:\Users\butlersx\AppData\Local\Temp\TFR5A9C.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IL_AR
FILENAME:In_IL
...
FIELDTYPE:invalid_percentage:ALLOW( .0123456789)
...
FIELD:ar_tax_factor:TYPE(STRING10):LIKE(invalid_percentage):0,0
FIELD:ar_tax_amount_paid:TYPE(STRING10):LIKE(invalid_money):0,0
FIELD:ar_annual_report_cap:TYPE(STRING10):0,0
FIELD:ar_illinois_capital:TYPE(STRING10):LIKE(invalid_money):0,0
...
FIELD:ar_amount_paid:TYPE(STRING50):0,0
