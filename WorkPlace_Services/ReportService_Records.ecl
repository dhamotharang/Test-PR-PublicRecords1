...
export ReportService_Records := module
  ...
  export val(params in_mod) := function
    ...
    ds_excluded_sources := if(in_excluded_sources_edited = '',
    ...
    transform(iesp.workplace.t_WPReportRecord,
      ...
      self.Company.CompanyName := STD.STR.ToUpperCase(left.company_name);
      ...
      // Parent company info
      self.ParentCompany.CompanyName := STD.STR.ToUpperCase(left.parent_company_name);
      ...
      SELF.AdditionalCompanies := PROJECT(ds_best_cand_wcorpstat_srted,
        TRANSFORM(iesp.workplace.t_WPCompanyInfo,
          self.CompanyName := STD.STR.ToUpperCase(left.company_name);
      ...
      self.WPSecretaryOfStateinfo.CompanyName := STD.STR.ToUpperCase(left.sos_comp_name);
      ...
      self.WPSecretaryOfStateinfo.RegisteredAgent := STD.STR.ToUpperCase(left.sos_reg_agent_name);
