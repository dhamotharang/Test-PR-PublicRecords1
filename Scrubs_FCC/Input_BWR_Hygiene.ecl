...
#workunit('name','Scrubs_FCC.Input_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
IMPORT Scrubs_FCC,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_FCC.Input_In_FCC;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_FCC.Input_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Input_Layout_FCC'),NAMED('OptimizedLayout'));// File layout suggested by data
