/*--SOAP--
<message name="xADL2_Header_Service">
...
*/
export xADL2_Header_Service := MACRO
...
,RecordsOnly,FullMatch,e_DID}],PRTE_PersonLinkingADL2V3.Process_xADL2_Layouts.InputLayout);
output(PRTE_PersonLinkingADL2V3.MEOW_xADL2(Input_Data).Data_,named('Header_Data'));
endmacro;
