...
export Key := index(DataForKey0,,'~key::PRTE_PersonLinkingADL2V3PersonHeaderPHRefs');
...
#IF(#TEXT(Input_PHONE)<>'')
  #uniquename(trans)
  PRTE_PersonLinkingADL2V3.Key_PersonHeader_PH.InputLayout_Batch %trans%(InFile le) := transform
  ...
  output_file := PRTE_PersonLinkingADL2V3.Key_PersonHeader_PH.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
