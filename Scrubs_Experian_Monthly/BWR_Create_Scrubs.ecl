// create folder "Scrubs_Experian_Monthly"
...
IMPORT SALT32;
#WORKUNIT('name','PersonHeader Scrubs_Experian_Monthly');
#OPTION('multiplePersistInstances',FALSE);
// ********************************************************************************************
// Configuration																		<-- STEP 0 (setup only)
IMPORT Scrubs_Experian_Monthly as S;
F := Scrubs_Experian_Monthly.In_File: independent;		// input file
o := 'Scrubs_Experian_Monthly';		// orbit profile
v := '20160321';									// orbit report version (for submission)
// ********************************************************************************************
