...
Command line options: -MScrubs_Experian_Monthly -eC:\Users\marcga01\AppData\Local\Temp\TFR304.tmp 
...
FIELDTYPE:orig_mname:SPACES( ):ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ):LEFTTRIM:LENGTHS(0,1,5,6,4,7,3,8,9,2):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:mname:SPACES( ):ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ):LEFTTRIM:LENGTHS(0,1,5,6,4,3,7,8,9,2):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:name_suffix:SPACES( ):ALLOW( ACDEGHIJLMNOPRSTUV):LEFTTRIM:LENGTHS(0,2,3):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:orig_predir:SPACES( ):ALLOW(ENSW):LEFTTRIM:LENGTHS(0,1,2):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:orig_addr_suffix:SPACES( ):ALLOW(ABCDEGHIKLMNOPQRSTUVWXY):LEFTTRIM:LENGTHS(2,3,0,4):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:orig_postdir:SPACES( ):ALLOW(ENSW):LEFTTRIM:LENGTHS(0,1,2):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:orig_unit_desig:SPACES( ):ALLOW(#ABCDEFGILMNOPRSTU):LEFTTRIM:LENGTHS(0,3,1,4,2):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:orig_sec_range:SPACES( ):ALLOW(-0123456789ABCDEFGHIJKLMNOPQRSTUVW):LEFTTRIM:LENGTHS(0,1,3,2,4,5,6):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:orig_zipcode4:SPACES( ):ALLOW(0123456789):LEFTTRIM:LENGTHS(4,0):WORDS(1):ONFAIL(CLEAN)
...
FIELDTYPE:addr_suffix:SPACES( ):ALLOW(ABCDEGHIKLMNOPQRSTUVWXY):LEFTTRIM:LENGTHS(2,3,0,4):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:postdir:SPACES( ):ALLOW(ENSW):LEFTTRIM:LENGTHS(0,1,2):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:unit_desig:SPACES( ):ALLOW(#ABCDEFGILMNOPRSTUX):LEFTTRIM:LENGTHS(0,3,4,1,2):WORDS(1):ONFAIL(CLEAN)
FIELDTYPE:sec_range:SPACES( ):ALLOW(-0123456789ABCDEFGHIJKLMNOPQRSTUVW):LEFTTRIM:LENGTHS(0,3,1,2,4,5,6):WORDS(1):ONFAIL(CLEAN)
