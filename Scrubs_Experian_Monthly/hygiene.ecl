...
EXPORT Summary(SALT32.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_seq_rec_id := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.seq_rec_id)));
    avelength_seq_rec_id := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.seq_rec_id)),h.seq_rec_id<>(typeof(h.seq_rec_id))'');
    ...
    maxlength_did_score_field := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.did_score_field)));
    avelength_did_score_field := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.did_score_field)),h.did_score_field<>(typeof(h.did_score_field))'');
    populated_current_rec_flag_pcnt := AVE(GROUP,IF(h.current_rec_flag = (TYPEOF(h.current_rec_flag))'',0,100));
    maxlength_current_rec_flag := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.current_rec_flag)));
    avelength_current_rec_flag := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.current_rec_flag)),h.current_rec_flag<>(typeof(h.current_rec_flag))'');
    populated_current_experian_pin_pcnt := AVE(GROUP,IF(h.current_experian_pin = (TYPEOF(h.current_experian_pin))'',0,100));
    maxlength_current_experian_pin := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.current_experian_pin)));
    avelength_current_experian_pin := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.current_experian_pin)),h.current_experian_pin<>(typeof(h.current_experian_pin))'');
    populated_date_first_seen_pcnt := AVE(GROUP,IF(h.date_first_seen = (TYPEOF(h.date_first_seen))'',0,100));
    maxlength_date_first_seen := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_first_seen)));
    avelength_date_first_seen := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_first_seen)),h.date_first_seen<>(typeof(h.date_first_seen))'');
    populated_date_last_seen_pcnt := AVE(GROUP,IF(h.date_last_seen = (TYPEOF(h.date_last_seen))'',0,100));
    maxlength_date_last_seen := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_last_seen)));
    avelength_date_last_seen := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_last_seen)),h.date_last_seen<>(typeof(h.date_last_seen))'');
    ...
    maxlength_date_vendor_first_reported := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_vendor_first_reported)));
    avelength_date_vendor_first_reported := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_vendor_first_reported)),h.date_vendor_first_reported<>(typeof(h.date_vendor_first_reported))'');
    ...
    maxlength_date_vendor_last_reported := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_vendor_last_reported)));
    avelength_date_vendor_last_reported := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.date_vendor_last_reported)),h.date_vendor_last_reported<>(typeof(h.date_vendor_last_reported))'');
    populated_encrypted_experian_pin_pcnt := AVE(GROUP,IF(h.encrypted_experian_pin = (TYPEOF(h.encrypted_experian_pin))'',0,100));
    maxlength_encrypted_experian_pin := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.encrypted_experian_pin)));
    avelength_encrypted_experian_pin := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.encrypted_experian_pin)),h.encrypted_experian_pin<>(typeof(h.encrypted_experian_pin))'');
    populated_social_security_number_pcnt := AVE(GROUP,IF(h.social_security_number = (TYPEOF(h.social_security_number))'',0,100));
    maxlength_social_security_number := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.social_security_number)));
    avelength_social_security_number := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.social_security_number)),h.social_security_number<>(typeof(h.social_security_number))'');
    ...
    maxlength_telephone := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.telephone)));
    avelength_telephone := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.telephone)),h.telephone<>(typeof(h.telephone))'');
    ...
    maxlength_additional_name_count := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.additional_name_count)));
    avelength_additional_name_count := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.additional_name_count)),h.additional_name_count<>(typeof(h.additional_name_count))'');
    populated_previous_address_count_pcnt := AVE(GROUP,IF(h.previous_address_count = (TYPEOF(h.previous_address_count))'',0,100));
    maxlength_previous_address_count := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.previous_address_count)));
    avelength_previous_address_count := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.previous_address_count)),h.previous_address_count<>(typeof(h.previous_address_count))'');
    populated_nametype_pcnt := AVE(GROUP,IF(h.nametype = (TYPEOF(h.nametype))'',0,100));
    maxlength_nametype := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.nametype)));
    avelength_nametype := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.nametype)),h.nametype<>(typeof(h.nametype))'');
    ...
    maxlength_orig_consumer_create_date := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_consumer_create_date)));
    avelength_orig_consumer_create_date := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_consumer_create_date)),h.orig_consumer_create_date<>(typeof(h.orig_consumer_create_date))'');
    ...
    maxlength_addressseq := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.addressseq)));
    avelength_addressseq := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.addressseq)),h.addressseq<>(typeof(h.addressseq))'');
    populated_orig_address_create_date_pcnt := AVE(GROUP,IF(h.orig_address_create_date = (TYPEOF(h.orig_address_create_date))'',0,100));
    maxlength_orig_address_create_date := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_address_create_date)));
    avelength_orig_address_create_date := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_address_create_date)),h.orig_address_create_date<>(typeof(h.orig_address_create_date))'');
    populated_orig_address_update_date_pcnt := AVE(GROUP,IF(h.orig_address_update_date = (TYPEOF(h.orig_address_update_date))'',0,100));
    maxlength_orig_address_update_date := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_address_update_date)));
    avelength_orig_address_update_date := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_address_update_date)),h.orig_address_update_date<>(typeof(h.orig_address_update_date))'');
    populated_orig_prim_range_pcnt := AVE(GROUP,IF(h.orig_prim_range = (TYPEOF(h.orig_prim_range))'',0,100));
    maxlength_orig_prim_range := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_prim_range)));
    avelength_orig_prim_range := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_prim_range)),h.orig_prim_range<>(typeof(h.orig_prim_range))'');
    ...
    maxlength_orig_prim_name := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_prim_name)));
    avelength_orig_prim_name := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_prim_name)),h.orig_prim_name<>(typeof(h.orig_prim_name))'');
    populated_orig_addr_suffix_pcnt := AVE(GROUP,IF(h.orig_addr_suffix = (TYPEOF(h.orig_addr_suffix))'',0,100));
    maxlength_orig_addr_suffix := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_addr_suffix)));
    avelength_orig_addr_suffix := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_addr_suffix)),h.orig_addr_suffix<>(typeof(h.orig_addr_suffix))'');
    ...
    maxlength_orig_unit_desig := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_unit_desig)));
    avelength_orig_unit_desig := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_unit_desig)),h.orig_unit_desig<>(typeof(h.orig_unit_desig))'');
    populated_orig_sec_range_pcnt := AVE(GROUP,IF(h.orig_sec_range = (TYPEOF(h.orig_sec_range))'',0,100));
    maxlength_orig_sec_range := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_sec_range)));
    avelength_orig_sec_range := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_sec_range)),h.orig_sec_range<>(typeof(h.orig_sec_range))'');
    ...
    maxlength_orig_zipcode := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_zipcode)));
    avelength_orig_zipcode := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_zipcode)),h.orig_zipcode<>(typeof(h.orig_zipcode))'');
    populated_orig_zipcode4_pcnt := AVE(GROUP,IF(h.orig_zipcode4 = (TYPEOF(h.orig_zipcode4))'',0,100));
    maxlength_orig_zipcode4 := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_zipcode4)));
    avelength_orig_zipcode4 := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.orig_zipcode4)),h.orig_zipcode4<>(typeof(h.orig_zipcode4))'');
    ...
    maxlength_delete_flag := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.delete_flag)));
    avelength_delete_flag := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.delete_flag)),h.delete_flag<>(typeof(h.delete_flag))'');
    populated_delete_file_date_pcnt := AVE(GROUP,IF(h.delete_file_date = (TYPEOF(h.delete_file_date))'',0,100));
    maxlength_delete_file_date := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.delete_file_date)));
    avelength_delete_file_date := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.delete_file_date)),h.delete_file_date<>(typeof(h.delete_file_date))'');
    populated_suppression_code_pcnt := AVE(GROUP,IF(h.suppression_code = (TYPEOF(h.suppression_code))'',0,100));
    maxlength_suppression_code := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.suppression_code)));
    avelength_suppression_code := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.suppression_code)),h.suppression_code<>(typeof(h.suppression_code))'');
    populated_deceased_ind_pcnt := AVE(GROUP,IF(h.deceased_ind = (TYPEOF(h.deceased_ind))'',0,100));
    maxlength_deceased_ind := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.deceased_ind)));
    avelength_deceased_ind := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.deceased_ind)),h.deceased_ind<>(typeof(h.deceased_ind))'');
  END;
...
SALT32.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.seq_rec_id <> 0,TRIM((SALT32.StrType)le.seq_rec_id), ''),IF (le.did <> 0,TRIM((SALT32.StrType)le.did), ''),IF (le.did_score_field <> 0,TRIM((SALT32.StrType)le.did_score_field), ''),IF (le.current_rec_flag <> 0,TRIM((SALT32.StrType)le.current_rec_flag), ''),IF (le.current_experian_pin <> 0,TRIM((SALT32.StrType)le.current_experian_pin), ''),IF (le.date_first_seen <> 0,TRIM((SALT32.StrType)le.date_first_seen), ''),IF (le.date_last_seen <> 0,TRIM((SALT32.StrType)le.date_last_seen), ''),IF (le.date_vendor_first_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_first_reported), ''),IF (le.date_vendor_last_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_last_reported), ''),TRIM((SALT32.StrType)le.encrypted_experian_pin),TRIM((SALT32.StrType)le.social_security_number),TRIM((SALT32.StrType)le.date_of_birth),TRIM((SALT32.StrType)le.telephone),TRIM((SALT32.StrType)le.gender),TRIM((SALT32.StrType)le.additional_name_count),TRIM((SALT32.StrType)le.previous_address_count),TRIM((SALT32.StrType)le.nametype),TRIM((SALT32.StrType)le.orig_consumer_create_date),TRIM((SALT32.StrType)le.orig_fname),TRIM((SALT32.StrType)le.orig_mname),TRIM((SALT32.StrType)le.orig_lname),TRIM((SALT32.StrType)le.orig_suffix),TRIM((SALT32.StrType)le.title),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.mname),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.name_suffix),TRIM((SALT32.StrType)le.name_score),IF (le.addressseq <> 0,TRIM((SALT32.StrType)le.addressseq), ''),TRIM((SALT32.StrType)le.orig_address_create_date),TRIM((SALT32.StrType)le.orig_address_update_date),TRIM((SALT32.StrType)le.orig_prim_range),TRIM((SALT32.StrType)le.orig_predir),TRIM((SALT32.StrType)le.orig_prim_name),TRIM((SALT32.StrType)le.orig_addr_suffix),TRIM((SALT32.StrType)le.orig_postdir),TRIM((SALT32.StrType)le.orig_unit_desig),TRIM((SALT32.StrType)le.orig_sec_range),TRIM((SALT32.StrType)le.orig_city),TRIM((SALT32.StrType)le.orig_state),TRIM((SALT32.StrType)le.orig_zipcode),TRIM((SALT32.StrType)le.orig_zipcode4),TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.predir),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.addr_suffix),TRIM((SALT32.StrType)le.postdir),TRIM((SALT32.StrType)le.unit_desig),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.p_city_name),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.cart),TRIM((SALT32.StrType)le.cr_sort_sz),TRIM((SALT32.StrType)le.lot),TRIM((SALT32.StrType)le.lot_order),TRIM((SALT32.StrType)le.dbpc),TRIM((SALT32.StrType)le.chk_digit),TRIM((SALT32.StrType)le.rec_type),TRIM((SALT32.StrType)le.county),TRIM((SALT32.StrType)le.geo_lat),TRIM((SALT32.StrType)le.geo_long),TRIM((SALT32.StrType)le.msa),TRIM((SALT32.StrType)le.geo_blk),TRIM((SALT32.StrType)le.geo_match),TRIM((SALT32.StrType)le.err_stat),IF (le.delete_flag <> 0,TRIM((SALT32.StrType)le.delete_flag), ''),IF (le.delete_file_date <> 0,TRIM((SALT32.StrType)le.delete_file_date), ''),IF (le.suppression_code <> 0,TRIM((SALT32.StrType)le.suppression_code), ''),IF (le.deceased_ind <> 0,TRIM((SALT32.StrType)le.deceased_ind), '')));
  SELF.FldNo := C;
END;
...
SALT32.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 72);
  SELF.FldNo2 := 1 + (C % 72);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.seq_rec_id <> 0,TRIM((SALT32.StrType)le.seq_rec_id), ''),IF (le.did <> 0,TRIM((SALT32.StrType)le.did), ''),IF (le.did_score_field <> 0,TRIM((SALT32.StrType)le.did_score_field), ''),IF (le.current_rec_flag <> 0,TRIM((SALT32.StrType)le.current_rec_flag), ''),IF (le.current_experian_pin <> 0,TRIM((SALT32.StrType)le.current_experian_pin), ''),IF (le.date_first_seen <> 0,TRIM((SALT32.StrType)le.date_first_seen), ''),IF (le.date_last_seen <> 0,TRIM((SALT32.StrType)le.date_last_seen), ''),IF (le.date_vendor_first_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_first_reported), ''),IF (le.date_vendor_last_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_last_reported), ''),TRIM((SALT32.StrType)le.encrypted_experian_pin),TRIM((SALT32.StrType)le.social_security_number),TRIM((SALT32.StrType)le.date_of_birth),TRIM((SALT32.StrType)le.telephone),TRIM((SALT32.StrType)le.gender),TRIM((SALT32.StrType)le.additional_name_count),TRIM((SALT32.StrType)le.previous_address_count),TRIM((SALT32.StrType)le.nametype),TRIM((SALT32.StrType)le.orig_consumer_create_date),TRIM((SALT32.StrType)le.orig_fname),TRIM((SALT32.StrType)le.orig_mname),TRIM((SALT32.StrType)le.orig_lname),TRIM((SALT32.StrType)le.orig_suffix),TRIM((SALT32.StrType)le.title),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.mname),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.name_suffix),TRIM((SALT32.StrType)le.name_score),IF (le.addressseq <> 0,TRIM((SALT32.StrType)le.addressseq), ''),TRIM((SALT32.StrType)le.orig_address_create_date),TRIM((SALT32.StrType)le.orig_address_update_date),TRIM((SALT32.StrType)le.orig_prim_range),TRIM((SALT32.StrType)le.orig_predir),TRIM((SALT32.StrType)le.orig_prim_name),TRIM((SALT32.StrType)le.orig_addr_suffix),TRIM((SALT32.StrType)le.orig_postdir),TRIM((SALT32.StrType)le.orig_unit_desig),TRIM((SALT32.StrType)le.orig_sec_range),TRIM((SALT32.StrType)le.orig_city),TRIM((SALT32.StrType)le.orig_state),TRIM((SALT32.StrType)le.orig_zipcode),TRIM((SALT32.StrType)le.orig_zipcode4),TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.predir),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.addr_suffix),TRIM((SALT32.StrType)le.postdir),TRIM((SALT32.StrType)le.unit_desig),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.p_city_name),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.cart),TRIM((SALT32.StrType)le.cr_sort_sz),TRIM((SALT32.StrType)le.lot),TRIM((SALT32.StrType)le.lot_order),TRIM((SALT32.StrType)le.dbpc),TRIM((SALT32.StrType)le.chk_digit),TRIM((SALT32.StrType)le.rec_type),TRIM((SALT32.StrType)le.county),TRIM((SALT32.StrType)le.geo_lat),TRIM((SALT32.StrType)le.geo_long),TRIM((SALT32.StrType)le.msa),TRIM((SALT32.StrType)le.geo_blk),TRIM((SALT32.StrType)le.geo_match),TRIM((SALT32.StrType)le.err_stat),IF (le.delete_flag <> 0,TRIM((SALT32.StrType)le.delete_flag), ''),IF (le.delete_file_date <> 0,TRIM((SALT32.StrType)le.delete_file_date), ''),IF (le.suppression_code <> 0,TRIM((SALT32.StrType)le.suppression_code), ''),IF (le.deceased_ind <> 0,TRIM((SALT32.StrType)le.deceased_ind), '')));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.seq_rec_id <> 0,TRIM((SALT32.StrType)le.seq_rec_id), ''),IF (le.did <> 0,TRIM((SALT32.StrType)le.did), ''),IF (le.did_score_field <> 0,TRIM((SALT32.StrType)le.did_score_field), ''),IF (le.current_rec_flag <> 0,TRIM((SALT32.StrType)le.current_rec_flag), ''),IF (le.current_experian_pin <> 0,TRIM((SALT32.StrType)le.current_experian_pin), ''),IF (le.date_first_seen <> 0,TRIM((SALT32.StrType)le.date_first_seen), ''),IF (le.date_last_seen <> 0,TRIM((SALT32.StrType)le.date_last_seen), ''),IF (le.date_vendor_first_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_first_reported), ''),IF (le.date_vendor_last_reported <> 0,TRIM((SALT32.StrType)le.date_vendor_last_reported), ''),TRIM((SALT32.StrType)le.encrypted_experian_pin),TRIM((SALT32.StrType)le.social_security_number),TRIM((SALT32.StrType)le.date_of_birth),TRIM((SALT32.StrType)le.telephone),TRIM((SALT32.StrType)le.gender),TRIM((SALT32.StrType)le.additional_name_count),TRIM((SALT32.StrType)le.previous_address_count),TRIM((SALT32.StrType)le.nametype),TRIM((SALT32.StrType)le.orig_consumer_create_date),TRIM((SALT32.StrType)le.orig_fname),TRIM((SALT32.StrType)le.orig_mname),TRIM((SALT32.StrType)le.orig_lname),TRIM((SALT32.StrType)le.orig_suffix),TRIM((SALT32.StrType)le.title),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.mname),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.name_suffix),TRIM((SALT32.StrType)le.name_score),IF (le.addressseq <> 0,TRIM((SALT32.StrType)le.addressseq), ''),TRIM((SALT32.StrType)le.orig_address_create_date),TRIM((SALT32.StrType)le.orig_address_update_date),TRIM((SALT32.StrType)le.orig_prim_range),TRIM((SALT32.StrType)le.orig_predir),TRIM((SALT32.StrType)le.orig_prim_name),TRIM((SALT32.StrType)le.orig_addr_suffix),TRIM((SALT32.StrType)le.orig_postdir),TRIM((SALT32.StrType)le.orig_unit_desig),TRIM((SALT32.StrType)le.orig_sec_range),TRIM((SALT32.StrType)le.orig_city),TRIM((SALT32.StrType)le.orig_state),TRIM((SALT32.StrType)le.orig_zipcode),TRIM((SALT32.StrType)le.orig_zipcode4),TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.predir),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.addr_suffix),TRIM((SALT32.StrType)le.postdir),TRIM((SALT32.StrType)le.unit_desig),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.p_city_name),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.cart),TRIM((SALT32.StrType)le.cr_sort_sz),TRIM((SALT32.StrType)le.lot),TRIM((SALT32.StrType)le.lot_order),TRIM((SALT32.StrType)le.dbpc),TRIM((SALT32.StrType)le.chk_digit),TRIM((SALT32.StrType)le.rec_type),TRIM((SALT32.StrType)le.county),TRIM((SALT32.StrType)le.geo_lat),TRIM((SALT32.StrType)le.geo_long),TRIM((SALT32.StrType)le.msa),TRIM((SALT32.StrType)le.geo_blk),TRIM((SALT32.StrType)le.geo_match),TRIM((SALT32.StrType)le.err_stat),IF (le.delete_flag <> 0,TRIM((SALT32.StrType)le.delete_flag), ''),IF (le.delete_file_date <> 0,TRIM((SALT32.StrType)le.delete_file_date), ''),IF (le.suppression_code <> 0,TRIM((SALT32.StrType)le.suppression_code), ''),IF (le.deceased_ind <> 0,TRIM((SALT32.StrType)le.deceased_ind), '')));
  END;
...
SHARED FldIds := DATASET([{1,'seq_rec_id'}
      ...
      ,{70,'delete_file_date'}
      ,{71,'suppression_code'}
      ,{72,'deceased_ind'}],SALT32.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_seq_rec_id((SALT32.StrType)le.seq_rec_id),
    Fields.InValid_did((SALT32.StrType)le.did),
    Fields.InValid_did_score_field((SALT32.StrType)le.did_score_field),
    Fields.InValid_current_rec_flag((SALT32.StrType)le.current_rec_flag),
    Fields.InValid_current_experian_pin((SALT32.StrType)le.current_experian_pin),
    Fields.InValid_date_first_seen((SALT32.StrType)le.date_first_seen),
    Fields.InValid_date_last_seen((SALT32.StrType)le.date_last_seen),
    Fields.InValid_date_vendor_first_reported((SALT32.StrType)le.date_vendor_first_reported),
    Fields.InValid_date_vendor_last_reported((SALT32.StrType)le.date_vendor_last_reported),
    Fields.InValid_encrypted_experian_pin((SALT32.StrType)le.encrypted_experian_pin),
    Fields.InValid_social_security_number((SALT32.StrType)le.social_security_number),
    Fields.InValid_date_of_birth((SALT32.StrType)le.date_of_birth),
    Fields.InValid_telephone((SALT32.StrType)le.telephone),
    Fields.InValid_gender((SALT32.StrType)le.gender),
    Fields.InValid_additional_name_count((SALT32.StrType)le.additional_name_count),
    Fields.InValid_previous_address_count((SALT32.StrType)le.previous_address_count),
    Fields.InValid_nametype((SALT32.StrType)le.nametype),
    Fields.InValid_orig_consumer_create_date((SALT32.StrType)le.orig_consumer_create_date),
    Fields.InValid_orig_fname((SALT32.StrType)le.orig_fname),
    Fields.InValid_orig_mname((SALT32.StrType)le.orig_mname),
    Fields.InValid_orig_lname((SALT32.StrType)le.orig_lname),
    Fields.InValid_orig_suffix((SALT32.StrType)le.orig_suffix),
    ...
    Fields.InValid_addressseq((SALT32.StrType)le.addressseq),
    Fields.InValid_orig_address_create_date((SALT32.StrType)le.orig_address_create_date),
    Fields.InValid_orig_address_update_date((SALT32.StrType)le.orig_address_update_date),
    Fields.InValid_orig_prim_range((SALT32.StrType)le.orig_prim_range),
    Fields.InValid_orig_predir((SALT32.StrType)le.orig_predir),
    Fields.InValid_orig_prim_name((SALT32.StrType)le.orig_prim_name),
    Fields.InValid_orig_addr_suffix((SALT32.StrType)le.orig_addr_suffix),
    Fields.InValid_orig_postdir((SALT32.StrType)le.orig_postdir),
    Fields.InValid_orig_unit_desig((SALT32.StrType)le.orig_unit_desig),
    Fields.InValid_orig_sec_range((SALT32.StrType)le.orig_sec_range),
    Fields.InValid_orig_city((SALT32.StrType)le.orig_city),
    Fields.InValid_orig_state((SALT32.StrType)le.orig_state),
    Fields.InValid_orig_zipcode((SALT32.StrType)le.orig_zipcode),
    Fields.InValid_orig_zipcode4((SALT32.StrType)le.orig_zipcode4),
    ...
    Fields.InValid_delete_flag((SALT32.StrType)le.delete_flag),
    Fields.InValid_delete_file_date((SALT32.StrType)le.delete_file_date),
    Fields.InValid_suppression_code((SALT32.StrType)le.suppression_code),
    Fields.InValid_deceased_ind((SALT32.StrType)le.deceased_ind),
    0);
