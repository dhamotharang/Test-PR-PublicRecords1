Import Data_Services, txbus,text_search;
	...
	ret := dataset(Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::persist::txbus::boolean',text_txbus_flat,thor);
...
export Key_Boolean_Map := index(if(nothor(fileservices.fileexists(Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::persist::txbus::boolean')),
																		tmsid_map,read_ret),{src,doc},{taxpayer_number},Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::txbus::qa::docref.taxpayernumber');
