import txbus,text_search;
	...
	ret := dataset('~thor_data400::persist::txbus::boolean',text_txbus_flat,thor);
...
export Key_Boolean_Map := index(if(fileservices.fileexists('~thor_data400::persist::txbus::boolean'),
																		tmsid_map,read_ret),{src,doc},{taxpayer_number},'~thor_data400::key::txbus::qa::docref.taxpayernumber');
