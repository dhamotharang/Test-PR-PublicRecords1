...
IMPORT SALT32;
#WORKUNIT('name','Scrubs_Inquiry_AccLogs_Update');
#OPTION('multiplePersistInstances',FALSE);
// ********************************************************************************************
// Configuration																		<-- STEP 0 (setup only)
IMPORT Scrubs_Inquiry_AccLogs_Update as S;
F := Scrubs_Inquiry_AccLogs_Update.In_File: independent;		// input file
...
SALT31.MAC_Default_SPC(F, output_spc); 
