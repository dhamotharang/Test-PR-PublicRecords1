...
// BIPV2_POWID_Platform.Cleave(BIPV2_POWID_Platform.In_POWID).BuildAll;
//---------------------------------------------------------------------------------------------
  Und := BIPV2_POWID_Platform.Underlinks(BIPV2_POWID_Platform.In_POWID); // Create underlink module
