...
iter := '25';
#workunit('name','BIPV2_POWID_Platform Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_POWID_Platform.Keys(BIPV2_POWID_Platform.In_powid).MatchSample ,BIPV2_POWID_Platform.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_POWID_Platform.In_powid)
