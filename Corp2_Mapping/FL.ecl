	...
	export Update(string updateType, string fileDate, string version, boolean pShouldSpray = _Dataset().bShouldSpray, boolean pOverwrite = false, boolean pUseProd = Tools._Constants.IsDataland) := function			
	  ...
	  jCorpWithMerger := join(jCorpEventMergerIDDist, CorpFile, 
		...
		Corp2_Mapping.LayoutsCommon.Main corpTransform(Corp2_Raw_FL.Layouts.CorpEvent_TempLay input) := transform
			...
			self.corp_address2_type_cd        := if(Corp2_Mapping.fAddressExists(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).ifAddressExists, 'M', '');			
			self.corp_address2_type_desc      := if(Corp2_Mapping.fAddressExists(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).ifAddressExists, 'MAILING', '');
			self.corp_address2_line1			    := if(self.corp_address2_type_cd<>'',Corp2_Mapping.fCleanAddress(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).AddressLine1,'');
			self.corp_address2_line2			    := if(self.corp_address2_type_cd<>'',Corp2_Mapping.fCleanAddress(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).AddressLine2,'');
			self.corp_address2_line3			    := if(self.corp_address2_type_cd<>'',Corp2_Mapping.fCleanAddress(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).AddressLine3,'');
			self.corp_prep_addr2_line1			  := if(self.corp_address2_type_cd<>'',Corp2_Mapping.fCleanAddress(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).PrepAddrLine1,'');
			self.corp_prep_addr2_last_line	  := if(self.corp_address2_type_cd<>'',Corp2_Mapping.fCleanAddress(state_origin,state_desc,input.ann_cor_2nd_mail_add1,input.ann_cor_2nd_mail_add2,corpAddr2City,corpAddr2State,input.ann_cor_2nd_mail_zip,input.ann_cor_2nd_mail_country).PrepAddrLastLine,'');
