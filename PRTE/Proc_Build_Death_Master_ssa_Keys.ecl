...
export Proc_Build_Death_Master_ssa_Keys(string pIndexVersion)	:=
...
function
  ...
  string3 death_rec_src := '';
	...
	kkey__death_master__did			            :=	index(dkey__death_master__did, {l_did }, {dkey__death_master__did}, '~prte::key::death_master_ssa::' + pIndexVersion + '::did');
    kkey__death_master__ssn_table_v3		    :=	index(dkey__death_master__ssn_table_v3,{ssn}, {dkey__death_master__ssn_table_v3}, '~prte::key::death_master_ssa::' + pIndexVersion + '::ssn_table_v3');
    kkey__death_master__filtered__ssn_table_v3	:=	index(dkey__death_master__filtered__ssn_table_v3,{ssn}, {dkey__death_master__filtered__ssn_table_v3}, '~prte::key::death_master_ssa::' + pIndexVersion + '::ssn_table_v3_filtered');
...
// deathv2 
	...
	kKeydeath_masterv2__autokey__address			:=	index(dKeydeath_masterv2__autokey__address, {prim_name,prim_range,st,city_code,zip,sec_range,dph_lname,lname,pfname,fname,states,lname1,lname2,lname3,lookups}, {dKeydeath_masterv2__autokey__address}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::address');
  ...
  rKeydeath_masterv2__autokey__citystname	:=
	...
	kKeydeath_masterv2__autokey__citystname		:=	index(dKeydeath_masterv2__autokey__citystname, {city_code,st,dph_lname,lname,pfname,fname,dob,states,lname1,lname2,lname3,city1,city2,city3,rel_fname1,rel_fname2,rel_fname3,lookups}, {dKeydeath_masterv2__autokey__citystname}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::citystname');
...
rKeydeath_masterv2__autokey__name	:=
	...
	kKeydeath_masterv2__autokey__name					:=	index(dKeydeath_masterv2__autokey__name, {dph_lname,lname,pfname,fname,minit,yob,s4,dob,states,lname1,lname2,lname3,city1,city2,city3,rel_fname1,rel_fname2,rel_fname3,lookups}, {dKeydeath_masterv2__autokey__name}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::name');
	...
	kKeydeath_masterv2__autokey__payload			:=	index(dKeydeath_masterv2__autokey__payload, {fakeid}, {dKeydeath_masterv2__autokey__payload}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::payload');
	...
	kKeydeath_masterv2__autokey__ssn2					:=	index(dKeydeath_masterv2__autokey__ssn2, {s1,s2,s3,s4,s5,s6,s7,s8,s9,dph_lname,pfname,did}, {dKeydeath_masterv2__autokey__ssn2}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::ssn2');
	...
	kKeydeath_masterv2__autokey__stname				:=	index(dKeydeath_masterv2__autokey__stname, {st,dph_lname,lname,pfname,fname,minit,yob,s4,zip,dob,states,lname1,lname2,lname3,city1,city2,city3,rel_fname1,rel_fname2,rel_fname3,lookups}, {dKeydeath_masterv2__autokey__stname}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::stname');
  ...
  rKeydeath_masterv2__autokey__zip	:=
	...
	kKeydeath_masterv2__autokey__zip					:=	index(dKeydeath_masterv2__autokey__zip, {zip,dph_lname,lname,pfname,fname,minit,yob,s4,dob,states,lname1,lname2,lname3,city1,city2,city3,rel_fname1,rel_fname2,rel_fname3,lookups}, {dKeydeath_masterv2__autokey__zip}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::autokey::zip');
  ...
  unsigned8 __internal_fpos__;
	...
	kKeydeath_masterv2__death_id		:=	index(dKeydeath_masterv2__death_id,{state_death_id}, {dKeydeath_masterv2__death_id}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::death_id');
	...
	kKeydeath_masterv2__did		:=	index(dKeydeath_masterv2__did,{l_did}, {dKeydeath_masterv2__did}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::did');
	...
	kKeydeath_masterv2__dob	:=	index(dKeydeath_masterv2__dob,{dob8, state, dph_lname, pfname}, {state_death_id}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::dob');
	...
	kKeydeath_masterv2__dod		:=	index(dKeydeath_masterv2__dod,{dod8, state, dph_lname, pfname},{state_death_id}, '~prte::key::death_masterv2_ssa::' + pIndexVersion + '::dod');
	...
	kKeydeath_masterv2__supp_id		:=	index(dKeydeath_masterv2__supp_id,{state_death_id},{dKeydeath_masterv2__supp_id}, '~prte::key::death_supplemental_ssa::' + pIndexVersion + '::death_id');
	
	  rkey__death_master__ssn	:= record
	recordof (Death_Master.key_ssn_ssa(false));
	end;
	
     dKeydeath_master__ssn		:= 	project(choosen(pull(Death_Master.key_ssn_ssa(false)), 0), rkey__death_master__ssn);
	kKeydeath_master__ssn		:=	index(dKeydeath_master__ssn,{ssn},{dKeydeath_master__ssn}, '~prte::key::death_master_ssa::' + pIndexVersion + '::ssn');

 
	  rkey__death_master__ssn_fcra	:= record
	recordof (Death_Master.key_ssn_ssa(true));
	end;
	
     dKeydeath_master__ssn_fcra		:= 	project(choosen(pull(Death_Master.key_ssn_ssa(true)), 0), rkey__death_master__ssn_fcra);
	kKeydeath_master__ssn_fcra		:=	index(dKeydeath_master__ssn_fcra,{ssn},{dKeydeath_master__ssn_fcra}, '~prte::key::fcra::death_master_ssa::' + pIndexVersion + '::ssn');

	  rkey__death_masterv2__did_fcra	:= record
	recordof (Doxie.key_death_masterV2_ssa_DID_fcra);
	end;

    dKeydeath_masterv2__did_fcra	:= 	project(choosen(pull(Doxie.key_death_masterV2_ssa_DID_fcra), 0), rkey__death_masterv2__did_fcra);
	kKeydeath_masterv2__did_fcra	:=	index(dKeydeath_masterv2__did_fcra,{l_did}, {dKeydeath_masterv2__did_fcra}, '~prte::key::fcra::death_masterv2_ssa::' + pIndexVersion + '::did');
