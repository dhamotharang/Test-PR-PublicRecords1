...
EXPORT fnDedupContacts(DATASET(Marketing_Suite_List_Gen.layouts.Layout_TempFull) dLv0_ML) := FUNCTION
  ...
  dLv0_ML_Dupes_Sort := SORT(dLv0_ML_Dupes, seleid, lexid, lname, fname, -dt_last_seen, LOCAL);
  ...
  dLv1_ML_Dupes_Sort := SORT(dLv1_ML_Dupes, seleid, lexid, lname, fname, -contact_address, LOCAL);
  ...
  dLv2_ML_Dupes_Sort := SORT(dLv2_ML_Dupes, seleid, lexid, lname, fname, -contact_email_address, LOCAL);
  ...
  dLv3_ML_Dupes_Sort := SORT(dLv3_ML_Dupes, seleid, lexid, lname, fname, -title, LOCAL);
  ...
  dLv4_ML_Dupes_Sort := SORT(dLv4_ML_Dupes, seleid, lexid, lname, fname, -proxid, LOCAL);
  ...
  dLv5_ML_Dupes_Sort := SORT(dLv5_ML_Dupes, seleid, lexid, lname, fname, person_hierarchy, LOCAL);
  ...
  dLv6_ML_Dupes_Sort := SORT(dLv6_ML_Dupes, seleid, lexid, lname, fname, LOCAL);
  ...
  d_ML_Good := dLv0_ML_Good + dLv1_ML_Good + dLv2_ML_Good + dLv3_ML_Good + dLv4_ML_Good + dLv5_ML_Good + dLv6_ML_Good + dLv7_ML;
