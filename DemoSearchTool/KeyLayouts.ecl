...
// IMPORTANT:  This is a PROD THOR attribute -- 
// * * * * * Coordinate modifications and check-ins with the data 
//           Fab team (RoxieDev) so the Thor code and/or keys are not broken
