...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_VA_Stock';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh\n'
    + 'MODULE:Scrubs_Corp2_Mapping_VA_Stock\n'
    + 'FILENAME:In_VA\n'
    ...
    + 'FIELDTYPE:invalid_shares:ALLOW( ,.0123456789)\n'
    + 'FIELDTYPE:invalid_stock_addl_info:ALLOW( ();0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ)\n'
    + '\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
    ...
    + 'FIELD:stock_shares_issued:TYPE(STRING15):LIKE(invalid_shares):0,0\n'
