...
Layout_Moxie_Offenses_temp tJoinForTrafficFlag(Layout_Moxie_Offenses_temp pOffense,Layout_Traffic_Lookup pLookup)
 :=
  transform
...
Layout_Moxie_Offenses_temp tSetTrafficFlagByOffenseLevel(Layout_Moxie_Offenses_temp pOffense)
 :=
  transform
...
Layout_Moxie_Offenses_temp tSetTrafficFlagByOffenderKey(Layout_Moxie_Offenses_temp pOffense)
 :=
  transform
