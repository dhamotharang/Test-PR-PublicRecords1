...
Layout_Moxie_Offenses_temp tRollupOffensesToScore(Layout_Moxie_Offenses_temp pLeft, Layout_Moxie_Offenses_temp pRight)
 :=
  transform
	self				:= pLeft;
  end
...
Layout_Moxie_Offenses_temp tRollupOffensesFlags(Layout_Moxie_Offenses_temp pLeft, Layout_Moxie_Offenses_temp pRight)
 :=
  transform
...
Layout_Moxie_Punishment tRollupPunishmentDates(Layout_Moxie_Punishment pLeft, Layout_Moxie_Punishment pRight)
 :=
  transform
	self.Conviction_Override_Date		:= if(pLeft.Conviction_Override_Date='',
											  pRight.Conviction_Override_Date,
...
dOffensesRolledUpOffenderKey
 :=
  rollup(dCrimSrchOffensesSorted,
		 left.Offender_Key=right.Offender_Key,
		 tRollupOffensesFlags(left,right),
		 local
		)
 ;
...
dPunishmentRolledUpOffenderKey
 :=
  rollup(dCrimSrchPunishmentSorted,
		 left.Offender_Key=right.Offender_Key,
		 tRollupPunishmentDates(left,right),
		 local
		)
 ;

Layout_Moxie_Offender_temp tCrimOffender2AndOffensestoOffender(Crim_Common.Layout_Moxie_Crim_Offender2.previous pCrimOffender2,Layout_Moxie_Offenses_temp pOffenses)
 :=
  transform
	...
	self.fcra_date				:= if((integer4)pOffenses.FCRA_Date<>0,
									  ...
									  if((integer4)pCrimOffender2.Case_Filing_Dt<>0,
									    ...
									    and pCrimOffender2.Vendor not in CrimSrch.sDOC_Vendors_Conviction_Unknown
										and	pCrimOffender2.Vendor not in CrimSrch.sDOC_Vendors_NoOffense_NoConviction,
	...
	self.conviction_override_date		:= if((integer4)pOffenses.Conviction_Override_Date<>0,
											  ...
											  if(pCrimOffender2.Vendor in CrimSrch.sDOC_Vendors_Conviction_Unknown,
												 '',
												 if(pCrimOffender2.Vendor in CrimSrch.sDOC_Vendors_NoOffense_NoConviction,
													pOffenses.Conviction_Override_date,
													pCrimOffender2.Case_Filing_Dt
												   )
												)
...
Layout_Moxie_Offender_temp tOffenderAndPunishmenttoOffender(Layout_Moxie_Offender_temp pOffender,Layout_Moxie_Punishment pPunishment)
 :=
  transform
...
Layout_Moxie_Offender_temp tFixNameType(Layout_Moxie_Offender_temp pLeft, Layout_Moxie_Offender_temp pRight)
 :=
  transform
...
export Crim_Offender2_as_CrimSrch_Offender
 := dCrimOffender2FixedReady
 : persist('persist::Crim_Offender2_as_CrimSrch_Offender')
 ;
#else
export Crim_Offender2_as_CrimSrch_Offender
 := dCrimOffender2FixedReady
