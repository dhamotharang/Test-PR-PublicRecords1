...
Layout_Moxie_Offenses_temp tNormalizeSexPred2asOffenses(Layout_Sex_Pred_2 pInput, unsigned pCounter)
 :=
  transform
...
export Sex_Pred_2_as_CrimSrch_Offenses
 :=	dSexOffensesNormFilled
 :	persist('persist::Sex_Pred_2_as_CrimSrch_Offenses')
 ;
#else
export Sex_Pred_2_as_CrimSrch_Offenses
 :=	dSexOffensesNormFilled
