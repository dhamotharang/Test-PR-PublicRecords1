...
DS:=   Project(prte2_header.pre_keys.header_pre_keybuild(ssn<>'' AND ssn[1..5] <>'00000'), layouts.Layout_Header);  
										 
DS2:=   Project(prte2_header.pre_keys.header_pre_keybuild(ssn<>'' AND ssn[1..5] <>'00000'), layouts.layout_header_v2_dl);    
