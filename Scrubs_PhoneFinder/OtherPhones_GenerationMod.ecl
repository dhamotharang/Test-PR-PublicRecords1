...
EXPORT OtherPhones_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_Risk:ENUM(PASS|FAIL|WARN|)\n'
    + 'FIELDTYPE:Invalid_Type:ENUM(LANDLINE|POSSIBLE WIRELESS|PAGER|POSSIBLE VOIP|WIRELESS|VOIP|)\n'
    + 'FIELDTYPE:Invalid_Status:ENUM(ACTIVE|NOT AVAILABLE|INACTIVE|)\n'
    + 'FIELDTYPE:Invalid_Port:ENUM(Not Ported|Ported|)\n'
