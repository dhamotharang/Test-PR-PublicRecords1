...
#workunit('name','Scrubs_PhoneFinder.RiskIndicators_BWR_Scrubs - Checking field validity in a file - SALT V3.11.11');
IMPORT Scrubs_PhoneFinder,SALT311;
infile := Scrubs_PhoneFinder.RiskIndicators_In_PhoneFinder;
mod_scrubs := Scrubs_PhoneFinder.RiskIndicators_Scrubs;
