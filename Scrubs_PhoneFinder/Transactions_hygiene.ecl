...
SHARED FldIds := DATASET([{1,'transaction_id'}
      ...
      ,{34,'phone_forwarded'}
      ,{35,'date_added'}
      ,{36,'filename'}],SALT311.MAC_Character_Counts.Field_Identification);
