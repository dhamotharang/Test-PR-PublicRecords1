...
// First create an instantiated hygiene module
  ...
  h := Scrubs_PhoneFinder.RiskIndicators_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'RiskIndicators_Layout_PhoneFinder'),NAMED('OptimizedLayout'));// File layout suggested by data
