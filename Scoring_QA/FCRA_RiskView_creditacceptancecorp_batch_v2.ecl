EXPORT FCRA_RiskView_creditacceptancecorp_batch_v2(route,current_dt,previous_dt) := functionmacro



 file1:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Attributes_V2_BATCH_CreditAcceptance_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_CreditAcceptancecorp_Attributes_V2_Global_Layout,


thor);

 file2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Attributes_V2_BATCH_CreditAcceptance_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_CreditAcceptancecorp_Attributes_V2_Global_Layout,
   ...
   result4_stats:=avearage;
    ...
    END;
		...
		compare_layout_stats func(result4_stats l):=transform
                                         self.file_version:='creditacceptancecorp_rv_v2';
																				 self.mode:='xml';
...
compare_layout_stats func1(result2_stats l):=transform
	...
	compare_layout := RECORD
		  ...
		  did_results := DATASET([{'creditacceptancecorp_rv_v2','xml','did','<DID not equal>',count(file1),count(file2),count(file2)-count(file1),pfc,'<DID not equal>',pf,cf,'','','','',pd,abd,ppd,0}
	                    ], compare_layout);
		...
		FileNameNewLogical:='~ScoringQA::bss::stats::'+ scoring_project_pip.Output_Sample_Names.RV_Attributes_V2_BATCH_CreditAcceptance_outfile[2..] + current_dt;
		
		FileNameNewLogical1:='~ScoringQA::bss::averages::'+ scoring_project_pip.Output_Sample_Names.RV_Attributes_V2_BATCH_CreditAcceptance_outfile[2..] + current_dt;
		
		FileNameNewLogical2:='~ScoringQA::bss::dids::'+ scoring_project_pip.Output_Sample_Names.RV_Attributes_V2_BATCH_CreditAcceptance_outfile[2..] + current_dt;
