EXPORT FCRA_RiskView_xml_generic_attributes_v3(route,current_dt,previous_dt) := functionmacro
   ...
   ppd:=if(pfc!= 0 and cfc=0,1,(cf/cfc)*100);
         	...
         	ran:= ran1  + ran2  + ran3  + ran4  + ran5  + ran6  + ran7  + ran8  + ran9  + ran10 +
   			...
   			len:=len1 + len2 + len3;
   				 ...
   				 // Scoring_QA.Range_function_module.Distinct_function6(DS2,'did',did1);
