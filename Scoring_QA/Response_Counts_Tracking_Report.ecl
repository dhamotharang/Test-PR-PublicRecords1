// #workunit('name','Response Counts Tracking Report');
...
input_file_count_ds:=DATASET([ 
   				...
   				file45:=DATASET(LI_Attributes_V4_BATCH_Generic_msn1106_0_historydate_201207_outfile+ dt,Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_Attributes_V4_Global_Layout	  ,thor);	
   						...
   						// file1(errorcode='');
   								  ...
   								  file2_cnt_with_no_roxie_issues:=	count(file2( length(trim(errorcode,left,right))= 0 ));	
      								...
      								file45_cnt_with_no_roxie_issues:=	count(file45( length(trim(errorcode,left,right))= 0 ));	
   ...
   distr:= FileServices.SendEmail('karthik.reddy@lexisnexis.com,Benjamin.Karnatz@lexisnexis.com,Apaar.Sinha@lexisnexis.com,Bridgett.Braaten@lexisnexis.com,Nathan.Koubsky@lexisnexis.com', 'Data Collection Response Counts Tracking Report ' , XtabOut_ds[COUNT(XtabOut_ds)].line);
   		
   distr2:= FileServices.SendEmail('karthik.reddy@lexisnexis.com,Benjamin.Karnatz@lexisnexis.com,Apaar.Sinha@lexisnexis.com,Bridgett.Braaten@lexisnexis.com,Nathan.Koubsky@lexisnexis.com', 'Data Collection Error code Response Counts Tracking Report ' , XtabOut_ds2[COUNT(XtabOut_ds2)].line);
   		
// seq:=
    sequential( filenames_details1,IF(COUNT(flag) > 0,distr),IF(COUNT(flag2) > 0,distr2));
   
// seq: WHEN(CRON('0 14 * *')),
// FAILURE(FileServices.SendEmail( 'karthik.reddy@lexisnexis.com,Benjamin.Karnatz@lexisnexis.com,apaar.sinha@lexisnexis.com,Bridgett.Braaten@lexisnexis.com','Data collection response counts tracking report CRON job failed','The failed workunit is:' + workunit + FailMessage));
