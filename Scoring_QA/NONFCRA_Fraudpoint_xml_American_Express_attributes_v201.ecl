EXPORT NONFCRA_Fraudpoint_xml_American_Express_attributes_v201(route,current_dt,previous_dt) := functionmacro

//

 file1_2:= dataset(route + scoring_project_pip.Output_Sample_Names.FP_V2_XML_American_Express_FP1109_0_outfile + previous_dt,Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_FraudPoint_V201_AmericanExpress_Global_Layout,
...
thor);
 ...
 file2_2:= dataset(route + scoring_project_pip.Output_Sample_Names.FP_V2_XML_American_Express_FP1109_0_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_FraudPoint_V201_AmericanExpress_Global_Layout,
...
Scoring_QA.Range_function_module.range_function_322(DS2,'identityageoldest',ran1);
						Scoring_QA.Range_function_module.range_function_25a(DS2,'identityagenewest',ran2);
						// Scoring_QA.Range_function_module.Range_Function_25(DS2,'identityagenewest',ran2);
Scoring_QA.Range_function_module.range_function_333(DS2,'sourcecreditbureauageoldest',ran3);
				Scoring_QA.Range_function_module.range_function_25(DS2,'sourcecreditbureauagenewest',ran4);
Scoring_QA.Range_function_module.range_function_332(DS2,'sourcecreditbureauagechange',ran5);
Scoring_QA.Range_function_module.range_function_335(DS2,'variationaddrchangeage',ran6);
							// Scoring_QA.Range_function_module.range_function_198(DS2,'ssnhighissueage',ran7);
							Scoring_QA.Range_function_module.range_function_198a(DS2,'ssnhighissueage',ran7);
Scoring_QA.Range_function_module.range_function_334(DS2,'ssnlowissueage',ran8);
Scoring_QA.Range_function_module.range_function_327(DS2,'inputaddrageoldest',ran9);
							// Scoring_QA.Range_function_module.range_function_185(DS2,'inputaddragenewest',ran10);
							Scoring_QA.Range_function_module.range_function_185a(DS2,'inputaddragenewest',ran10);
Scoring_QA.Range_function_module.range_function_315(DS2,'curraddrageoldest',ran11);
				Scoring_QA.Range_function_module.range_function_15(DS2,'curraddragenewest',ran12);
Scoring_QA.Range_function_module.range_function_316(DS2,'curraddrlenofres',ran13);
Scoring_QA.Range_function_module.range_function_310(DS2,'prevaddrageoldest',ran14);
			 	Scoring_QA.Range_function_module.range_function_192(DS2,'prevaddragenewest',ran15);
Scoring_QA.Range_function_module.range_function_310(DS2,'prevaddrlenofres',ran16);
...
Scoring_QA.Range_function_module.range_function_326(DS2,'idverssnsourcecount',ran0_2);
Scoring_QA.Range_function_module.range_function_324(DS2,'idveraddresssourcecount',ran0_3);
Scoring_QA.Range_function_module.range_function_325(DS2,'idverdobsourcecount',ran0_4);
...
Scoring_QA.Range_function_module.range_function_331(DS2,'searchcount',ran0_23);
...
Scoring_QA.Range_function_module.Range_Function_308(DS2,'searchunverifiedphonecountyear',ran0_31);
      	  Scoring_QA.Range_function_module.range_function_141(DS2,'searchbankingsearchcount',ran0_32);
Scoring_QA.Range_function_module.Range_Function_308(DS2,'searchbankingsearchcountyear',ran0_33);
...
Scoring_QA.Range_function_module.Range_Function_308(DS2,'searchfraudsearchcountyear',ran0_43);
...
Scoring_QA.Range_function_module.range_function_311(DS2,'assoccount',ran0_57);
...
Scoring_QA.Range_function_module.range_function_314(DS2,'correlationssnnamecount',ran0_63);
Scoring_QA.Range_function_module.range_function_313(DS2,'correlationssnaddrcount',ran0_64);
Scoring_QA.Range_function_module.range_function_312(DS2,'correlationaddrnamecount',ran0_65);
...
Scoring_QA.Range_function_module.range_function_309(DS2,'divssnaddrcount',ran0_74);
					Scoring_QA.Range_function_module.Range_Function_31(DS2,'divssnaddrcountnew',ran0_75);
Scoring_QA.Range_function_module.Range_Function_309(DS2,'divssnaddrmsourcecount',ran0_76);
Scoring_QA.Range_function_module.range_function_307(DS2,'divaddridentitycount',ran0_77);
				  Scoring_QA.Range_function_module.Range_Function_25(DS2,'divaddridentitycountnew',ran0_78);
Scoring_QA.Range_function_module.range_function_307(DS2,'divaddridentitymsourcecount',ran0_79);
					Scoring_QA.Range_function_module.Range_Function_31(DS2,'divaddrsuspidentitycountnew',ran0_80);
Scoring_QA.Range_function_module.range_function_319(DS2,'divaddrssncount',ran0_81);
Scoring_QA.Range_function_module.Range_Function_308(DS2,'divaddrssncountnew',ran0_82);
Scoring_QA.Range_function_module.range_function_320(DS2,'divaddrssnmsourcecount',ran0_83);
Scoring_QA.Range_function_module.Range_Function_317(DS2,'divaddrphonecount',ran0_84);
					 Scoring_QA.Range_function_module.Range_Function_31(DS2,'divaddrphonecountnew',ran0_85);
Scoring_QA.Range_function_module.Range_Function_318(DS2,'divaddrphonemsourcecount',ran0_86);
...
Scoring_QA.Range_function_module.Range_Function_321(DS2,'divsearchaddridentitycount',ran0_93);
					Scoring_QA.Range_function_module.Range_Function_31(DS2,'divsearchaddrsuspidentitycount',ran0_94);
Scoring_QA.Range_function_module.Range_Function_308(DS2,'divsearchphoneidentitycount',ran0_95);
			    ...
			    Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchssnsearchcountweek',ran0_99);
					...
					Scoring_QA.Range_function_module.range_function_194a(DS2,'searchaddrsearchcount',ran0_101);
Scoring_QA.Range_function_module.Range_Function_330(DS2,'searchaddrsearchcountyear',ran0_102);
...
Scoring_QA.Range_function_module.Range_Function_308(DS2,'searchphonesearchcountyear',ran0_107);
...
Scoring_QA.Range_function_module.range_function_329(DS2,'inputaddrnbrhdvacantpropcount',ran0_115);
			//**********Version201 attributes;		
					Scoring_QA.Range_function_module.range_function_303(DS2,'idveraddressmatchescurrent',ran0_116);
					Scoring_QA.Range_function_module.range_function_303(DS2,'idveraddressvoter',ran0_117);
					Scoring_QA.Range_function_module.range_function_303(DS2,'idveraddressvehicleregistation',ran0_118);
					Scoring_QA.Range_function_module.range_function_303(DS2,'sourcevehicleregistration',ran0_119);
					
					Scoring_QA.Range_function_module.range_function_304(DS2,'idveraddressdriverslicense',ran0_120);
					Scoring_QA.Range_function_module.range_function_304(DS2,'idverssndriverslicense',ran0_121);
					
					Scoring_QA.Range_function_module.range_function_305(DS2,'idverdriverslicensetype',ran0_122);
					Scoring_QA.Range_function_module.range_function_305(DS2,'sourcedriverslicense',ran0_123);
                       ...
                       ran0_81 + ran0_82 + ran0_83 + ran0_84 + ran0_85+ ran0_86 + ran0_87 + ran0_88 + ran0_89 + ran0_90 + 
				               ...
				               ran0_101 + ran0_102 + ran0_103 + ran0_104 + ran0_105 + ran0_106 + ran0_107 + ran0_108 + ran0_109 + ran0_110 + 
											 ran0_111 + ran0_112 + ran0_113 + ran0_114 + ran0_115 + ran0_116 + ran0_117 + ran0_118 + ran0_119 + ran0_120 + ran0_121 + ran0_122 + ran0_123;
...
Scoring_QA.Range_function_module.range_function_306(DS2,'identityrecordcount',ran2_1);
Scoring_QA.Range_function_module.range_function_323(DS2,'identitysourcecount',ran2_2);
								...
								// Range_Function_5
								 ...
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'inputaddrnbrhdmurderindex',ran5_1);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'inputaddrnbrhdcartheftindex',ran5_2);
Scoring_QA.Range_function_module.Range_Function_328(DS2,'inputaddrnbrhdburglaryindex',ran5_3);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'inputaddrnbrhdcrimeindex',ran5_4);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'curraddrmurderindex',ran5_5);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'curraddrcartheftindex',ran5_6);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'curraddrburglaryindex',ran5_7);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'curraddrcrimeindex',ran5_8);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'prevaddrmurderindex',ran5_9);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'prevaddrcartheftindex',ran5_10);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'prevaddrburglaryindex',ran5_11);
								 Scoring_QA.Range_function_module.Range_Function_328(DS2,'prevaddrcrimeindex',ran5_12);
					...
					Scoring_QA.Range_function_module.Distinct_function(DS2,'idverphone',dis9);
								...
								Scoring_QA.Range_function_module.range_function_31a(DS2,'idverdriverslicense',dis10);
	        ...
	        Scoring_QA.Range_function_module.Distinct_function(DS2,'searchcomponentrisklevel',dis43);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'componentcharrisklevel',dis44);					
							...
							Scoring_QA.Range_function_module.range_function_116a(DS2,'ssnissuestate',dis45);
				  ...
				  Scoring_QA.Range_function_module.Distinct_function(DS2,'inputaddroccupantowned',dis55);					
								...
								Scoring_QA.Range_function_module.Distinct_function7a(DS2,'addrchangeecontrajectory',dis56);
	 ...
	 did_stats:=did1;
			...
			result2_stats:= ran + dis + ran_0 + ran_1 +ran_2 + ran_5 + did_stats;
      	...
      	Scoring_QA.Range_function_module.Average_func(DS2,'ssnlowissueage',ave132);
				...
				//*****
					...
					Scoring_QA.Range_function_module.Average_func(DS2,'idveraddressmatchescurrent',ave141);
				Scoring_QA.Range_function_module.Average_func(DS2,'idveraddressvoter',ave142);
				Scoring_QA.Range_function_module.Average_func(DS2,'idveraddressvehicleregistation',ave143);
				Scoring_QA.Range_function_module.Average_func(DS2,'idveraddressdriverslicense',ave144);
				Scoring_QA.Range_function_module.Average_func(DS2,'idverdriverslicensetype',ave145);
				Scoring_QA.Range_function_module.Average_func(DS2,'idverssndriverslicense',ave146);
			 	Scoring_QA.Range_function_module.Average_func(DS2,'sourcevehicleregistration',ave147);
				Scoring_QA.Range_function_module.Average_func(DS2,'sourcedriverslicense',ave148);
				       ...
				       ave101 + ave102 + ave103 + ave104 + ave105 + ave106 + ave107 + ave108 + ave109 + ave110+ 
				  	   ...
				  	   ave121 + ave122 + ave123 + ave124 + ave125 + ave126 + ave127 + ave128 + ave129 + ave130+
						   ave131 + ave132 + ave133 + ave134 + ave135 + ave136 + ave137 + ave138 + ave139 + ave140+ 
							 ave141 + ave142 + ave143 + ave144 + ave145 + ave146 + ave147 + ave148;
