EXPORT FCRA_RiskView_batch_Experian_attributes_v3(route,current_dt,previous_dt) := functionmacro


file1_2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Attributes_V3_BATCH_Experian_outfile + previous_dt,Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_Experian_Attributes_V3_Global_Layout,

thor);
file2_2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Attributes_V3_BATCH_Experian_outfile + current_dt,Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_Experian_Attributes_V3_Global_Layout,
