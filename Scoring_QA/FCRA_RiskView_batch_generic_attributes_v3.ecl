EXPORT FCRA_RiskView_batch_generic_attributes_v3(route,current_dt,previous_dt) := functionmacro
...
ppd:=if(pfc!= 0 and cfc=0,1,(cf/cfc)*100);
         	...
         	Scoring_QA.Range_function_module.Range_Function_158(DS2,'ageoldestrecord',ran1);
         	Scoring_QA.Range_function_module.range_function_51(DS2,'agenewestrecord',ran2);
   				Scoring_QA.Range_function_module.range_function_20(DS2,'iaageoldestrecord',ran3);
         	Scoring_QA.Range_function_module.range_function_15(DS2,'iaagenewestrecord',ran4);
         	Scoring_QA.Range_function_module.range_function_21(DS2,'ialenofres',ran5);
   				Scoring_QA.Range_function_module.range_function_27(DS2,'iaagelastsale',ran6);
   				Scoring_QA.Range_function_module.range_function_20(DS2,'caageoldestrecord',ran7);
         	Scoring_QA.Range_function_module.range_function_15(DS2,'caagenewestrecord',ran8);
   				Scoring_QA.Range_function_module.range_function_21(DS2,'calenofres',ran9);
   				Scoring_QA.Range_function_module.range_function_20(DS2,'paageoldestrecord',ran10);
         	Scoring_QA.Range_function_module.range_function_46(DS2,'paagenewestrecord',ran11);
   				Scoring_QA.Range_function_module.range_function_21(DS2,'palenofres',ran12);
   				Scoring_QA.Range_function_module.range_function_19(DS2,'paagelastsale',ran13);
   				Scoring_QA.Range_function_module.range_function_19(DS2,'caagelastsale',ran14);
   				Scoring_QA.Range_function_module.range_function_86(DS2,'distinputcurr',ran15);
   				Scoring_QA.Range_function_module.range_function_42(DS2,'propageoldestpurchase',ran16);
         	Scoring_QA.Range_function_module.range_function_42(DS2,'propagenewestpurchase',ran17);
   				Scoring_QA.Range_function_module.range_function_241(DS2,'propagenewestsale',ran18);
       		Scoring_QA.Range_function_module.range_function_86(DS2,'distcurrprev',ran19); 
   				...
   				Scoring_QA.Range_function_module.range_function_15(DS2,'proflicage',ran22);
   				Scoring_QA.Range_function_module.range_function_29(DS2,'inferredminimumage',ran23);
   				Scoring_QA.Range_function_module.range_function_18(DS2,'bestreportedage',ran24);
   				Scoring_QA.Range_function_module.range_function_20(DS2,'phoneedaageoldestrecord',ran25);
   				Scoring_QA.Range_function_module.range_function_15(DS2,'phoneedaagenewestrecord',ran26);
         	Scoring_QA.Range_function_module.range_function_20(DS2,'phoneotherageoldestrecord',ran27);
         	Scoring_QA.Range_function_module.range_function_15(DS2,'phoneotheragenewestrecord',ran28);
         		...
         		Scoring_QA.Range_function_module.range_function_35(DS2,'liensmallclaimsreleasedtotal',ran52);	
   			    ...
   			    Scoring_QA.Range_function_module.range_function_35(DS2,'lientaxotherreleasedtotal',ran54);					
   				  ...
   				  Scoring_QA.Range_function_module.range_function_41(DS2,'predictedannualincome',ran60);
   					Scoring_QA.Range_function_module.range_function_22(DS2,'prevaddravmconfidence',ran61);
         	...
         	ran:= ran1  + ran2  + ran3  + ran4  + ran5  + ran6  + ran7  + ran8  + ran9  + ran10 +
   				     ran11 + ran12 + ran13 + ran14 + ran15 + ran16 + ran17  + ran18 + ran19 + ran22 + ran23 + ran24 + ran25 + ran26 + ran27 + ran28 + ran29 + ran30 +
   				  ...
   				  Scoring_QA.Range_function_module.Range_Function_15(DS2,'subjectssncount',ran0_1);
   					Scoring_QA.Range_function_module.Range_Function_45(DS2,'subjectaddrcount',ran0_2);
   					...
   					Scoring_QA.Range_function_module.range_function_46(DS2,'ssnidentitiescount',ran0_7);
   					Scoring_QA.Range_function_module.range_function_45(DS2,'ssnaddrcount',ran0_8);
   			    Scoring_QA.Range_function_module.range_function_31(DS2,'ssnidentitiesrecentcount',ran0_9);
   					...
   					Scoring_QA.Range_function_module.range_function_30(DS2,'inputaddridentitiescount',ran0_11);
   					Scoring_QA.Range_function_module.range_function_32(DS2,'inputaddrssncount',ran0_12);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'inputaddrphonecount',ran0_13);
   					Scoring_QA.Range_function_module.range_function_31(DS2,'inputaddridentitiesrecentcount',ran0_14);
   					Scoring_QA.Range_function_module.range_function_31(DS2,'inputaddrssnrecentcount',ran0_15);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'inputaddrphonerecentcount',ran0_16);
   				  ...
   				  Scoring_QA.Range_function_module.range_function_31(DS2,'phoneidentitiesrecentcount',ran0_18);
   					Scoring_QA.Range_function_module.range_function_22(DS2,'inputaddravmconfidence',ran0_19);
   					Scoring_QA.Range_function_module.range_function_22(DS2,'curraddravmconfidence',ran0_20);
         	  ...
         	  Scoring_QA.Range_function_module.range_function_31(DS2,'lienlandlordtenantreleasedcount',ran0_42);
   				  Scoring_QA.Range_function_module.range_function_31(DS2,'lienjudgmentreleasedcount',ran0_43);
   					...
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count',ran0_46);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count30',ran0_47);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count90',ran0_48);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count180',ran0_49);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count12',ran0_50);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count24',ran0_51);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count36',ran0_52);
   					Scoring_QA.Range_function_module.range_function_51(DS2,'bankruptcy_count60',ran0_53);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count',ran0_54);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count30',ran0_55);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count90',ran0_56);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count180',ran0_57);
   				  Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count12',ran0_58);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count24',ran0_59);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count36',ran0_60);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'eviction_count60',ran0_61);
   							...
   							ran_0:=   ran0_1 + ran0_2  + ran0_3  + ran0_4  + ran0_5  + ran0_6  + ran0_7  + ran0_8  + ran0_9  + ran0_10 +
   				               ran0_11 + ran0_12 + ran0_13 + ran0_14 + ran0_15 + ran0_16 + ran0_17 + ran0_18 + ran0_19 + ran0_20 +
   						             ran0_22 + ran0_23 + ran0_24 + ran0_25 + ran0_26 + ran0_27 + ran0_28 + ran0_29 + ran0_30 +
   						    ...
   						    Scoring_QA.Range_function_module.Range_Function_1(DS2,'inputaddrcountyindex',ran1_1);
   							  ...
   							  Scoring_QA.Range_function_module.Range_Function_1(DS2,'curraddrblockindex',ran1_6);
   								...
   								Scoring_QA.Range_function_module.Range_Function_1(DS2,'propnewestsalepurchaseindex',ran1_10);
   								 	...
   								 	Scoring_QA.Range_function_module.range_function_26(DS2,'felonyage',ran3_1);
   								  Scoring_QA.Range_function_module.range_function_108(DS2,'lienfiledage',ran3_2);
   									Scoring_QA.Range_function_module.range_function_240(DS2,'lienreleasedage',ran3_3);
   								  Scoring_QA.Range_function_module.range_function_26(DS2,'evictionage',ran3_4);
   								 
   								 ran_3:=ran3_1+ ran3_2  + ran3_3  + ran3_4;
   								 
   								 Scoring_QA.Range_function_module.range_function_24(DS2,'derogage',ran4_1);
   					...
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'numsources',dis2);
   				  ...
   				  Scoring_QA.Range_function_module.Distinct_function(DS2,'ssndeceased',dis10);
   					...
   					Scoring_QA.Range_function_module.Distinct_function2(DS2,'lowissuedate',dis14);
   					Scoring_QA.Range_function_module.Distinct_function2(DS2,'highissuedate',dis15);
   					Scoring_QA.Range_function_module.Distinct_function2(DS2,'issuestate',dis16);
   					...
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'diffstate',dis41);
   					...
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'diffstate2',dis44);
   					...
   					Scoring_QA.Range_function_module.range_function_43(DS2,'property_owned_total',dis57);
   					Scoring_QA.Range_function_module.range_function_43(DS2,'property_historically_owned',dis58);
   				  ...
   				  Scoring_QA.Range_function_module.range_function_47(DS2,'total_number_derogs',dis90);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies',dis91);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies30',dis92);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies90',dis93);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies180',dis94);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies12',dis95);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies24',dis96);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies36',dis97);
   					Scoring_QA.Range_function_module.Distinct_function1(DS2,'felonies60',dis98);
   					Scoring_QA.Range_function_module.range_function_15(DS2,'num_liens',dis99);
   				  ...
   				  Scoring_QA.Range_function_module.range_function_40(DS2,'num_released_liens90',dis110);
   					...
   					Scoring_QA.Range_function_module.range_function_37(DS2,'num_nonderogs180',dis117);
   					Scoring_QA.Range_function_module.range_function_37(DS2,'num_nonderogs12',dis118);
   					Scoring_QA.Range_function_module.range_function_37(DS2,'num_nonderogs24',dis119);
   				  Scoring_QA.Range_function_module.range_function_37(DS2,'num_nonderogs36',dis120);
   					Scoring_QA.Range_function_module.range_function_38(DS2,'num_nonderogs60',dis121);
   					...
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic30',dis125);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic90',dis126);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic180',dis127);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic12',dis128);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic24',dis129);
   				  Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic36',dis130);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'num_proflic60',dis131);
   					...
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'addrhighrisk',dis139);
   				  Scoring_QA.Range_function_module.Distinct_function(DS2,'phonehighrisk',dis140);
   					Scoring_QA.Range_function_module.Distinct_function(DS2,'addrprison',dis141);
   				  ...
   				  Scoring_QA.Range_function_module.Distinct_function(DS2,'prescreenoptout',dis170);
   					...
   					Scoring_QA.Range_function_module.range_function_36(DS2,'num_nonderogs',dis174);
   					Scoring_QA.Range_function_module.range_function_25(DS2,'num_nonderogs30',dis175);
   					Scoring_QA.Range_function_module.range_function_15(DS2,'num_nonderogs90',dis176);
	 ...
	 did_stats:=did1;
   			...
   			result2_stats:= ran + dis + ran_0 + ran_1 + ran_3 + ran_4 + len + did_stats;
      	   ...
      	   avearage:= ave1  + ave2  + ave3  + ave5  + ave6  + ave7  + ave8  + ave9  + ave10 +
                ...
                ave81 + ave82 + ave83 + ave84 + ave85 + ave86 + ave87 + ave88 + ave89 + ave90 + 
				       ...
				       ave101 + ave102 + ave103 + ave104 + ave105 + ave106 + ave107 + ave108 + ave109 + ave110+ 
						   ave111 + ave112 + ave113 + ave114 + ave115  + ave124 + ave125 + ave126 + ave127 + ave128 + ave129 + ave130+
