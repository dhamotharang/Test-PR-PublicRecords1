...
/////																																																																																																													/////	
/////																																																																																																													/////	
/////				Please use Scoring_QA_New_Bins.Test_FCRA_Attributes &&& Scoring_QA_New_Bins.Test_nonFCRA_attributes						/////	
/////																																																																																																													/////	
/////																																																																																																													/////	
/////																																																																																																													/////	
/////																																																																																																													/////	
   ...
   // jn;
	...
	new_bins_remove_superfile:= if(  STD.File.FileExists('~scoringqa::bss::stats::'+ a1) and 
        ...
        new_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::'+ a1) and STD.File.FileExists('~scoringqa::bss::averages::'+ a1) and 
   					...
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::' + a1),rpt1,rpt2,rpt3,rpt4,rpt5,rpt6,rpt11,rpt12,rpt15,rpt16,rpt17,rpt18,rpt19,rpt24,rpt25,rpt26,rpt27,rpt28) );
         ...
         old_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::'+ b1) and STD.File.FileExists('~scoringqa::bss::averages::'+ b1)  and
   					...
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::' + b1),rpt1_1,rpt2_1,rpt3_1,rpt4_1,rpt5_1,rpt6_1,rpt11_1,rpt12_1,rpt15_1,rpt16_1,rpt17_1,rpt18_1,rpt19_1,rpt24_1,rpt25_1,rpt26_1,rpt27_1,rpt28_1) );
