EXPORT NONFCRA_leadintegrity_batch_generic_attributes_v4(route,current_dt,previous_dt) := functionmacro



 file1_2:= dataset(route + scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_Attributes_V4_Global_Layout,


thor);

 file2_2:= dataset(route + scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile +current_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_Attributes_V4_Global_Layout,
...
ppd:=if(pfc!= 0 and cfc=0,1,(cf/cfc)*100);
      	...
      	Scoring_QA.Range_function_module.range_function_140(DS2,'ageoldestrecord',ran1);
      	Scoring_QA.Range_function_module.range_function_71(DS2,'agenewestrecord',ran2);		
       	...
       	Scoring_QA.Range_function_module.range_function_165(DS2,'propageoldestpurchase',ran4);
				Scoring_QA.Range_function_module.Range_Function_164(DS2,'propagenewestpurchase',ran5);
				Scoring_QA.Range_function_module.range_function_75(DS2,'derogage',ran6);
				Scoring_QA.Range_function_module.range_function_148(DS2,'felonyage',ran7);
		   	Scoring_QA.Range_function_module.range_function_120(DS2,'arrestage',ran8);
				Scoring_QA.Range_function_module.Range_Function_159(DS2,'lienfiledage',ran9);
				Scoring_QA.Range_function_module.range_function_127(DS2,'lienreleasedage',ran10);
				Scoring_QA.Range_function_module.range_function_142(DS2,'bankruptcyage',ran11);
				Scoring_QA.Range_function_module.range_function_147(DS2,'evictionage',ran12);
			 	Scoring_QA.Range_function_module.Range_Function_163(DS2,'proflicage',ran13);		  
      	Scoring_QA.Range_function_module.Range_Function_160(DS2,'phoneotherageoldestrecord',ran14);
			 	Scoring_QA.Range_function_module.range_function_18(DS2,'phoneotheragenewestrecord',ran15);
				Scoring_QA.Range_function_module.range_function_122(DS2,'curraddragelastsale',ran16);
				Scoring_QA.Range_function_module.range_function_149(DS2,'inputaddragelastsale',ran17);			
				Scoring_QA.Range_function_module.range_function_144(DS2,'curraddrlenofres',ran18);
				Scoring_QA.Range_function_module.range_function_150(DS2,'inputaddragenewestrecord',ran19);
				Scoring_QA.Range_function_module.range_function_151(DS2,'inputaddrageoldestrecord',ran20);
				Scoring_QA.Range_function_module.Range_Function_153(DS2,'inputaddrlenofres',ran21);
				Scoring_QA.Range_function_module.Range_Function_158(DS2,'lastnamechangeage',ran22);
				Scoring_QA.Range_function_module.range_function_18(DS2,'phoneedaagenewestrecord',ran23);
				Scoring_QA.Range_function_module.Range_Function_161(DS2,'prevaddragenewestrecord',ran24);
				Scoring_QA.Range_function_module.Range_Function_162(DS2,'prevaddrageoldestrecord',ran25);
				Scoring_QA.Range_function_module.range_function_110(DS2,'prevaddrlenofres',ran26);				
				Scoring_QA.Range_function_module.range_function_77(DS2,'accidentage',ran27);
				Scoring_QA.Range_function_module.range_function_31(DS2,'accidentcount',ran28);
				Scoring_QA.Range_function_module.range_function_25(DS2,'addrmostrecentstatediff',ran29);
				Scoring_QA.Range_function_module.range_function_31(DS2,'assoccreditbureauonlycount',ran30);
				Scoring_QA.Range_function_module.range_function_31(DS2,'assoccreditbureauonlycountmonth',ran31);
				Scoring_QA.Range_function_module.range_function_31(DS2,'assoccreditbureauonlycountnew',ran32);
				Scoring_QA.Range_function_module.range_function_31(DS2,'assochighrisktopologycount',ran33);	
				Scoring_QA.Range_function_module.range_function_51(DS2,'assocsuspicousidentitiescount',ran34);	
				Scoring_QA.Range_function_module.range_function_75(DS2,'businessassociationage',ran35);
				Scoring_QA.Range_function_module.range_function_145(DS2,'divaddridentitycount',ran36);
				Scoring_QA.Range_function_module.range_function_31(DS2,'divaddridentitycountnew',ran37);
				Scoring_QA.Range_function_module.range_function_145(DS2,'divaddridentitymsourcecount',ran38);
				Scoring_QA.Range_function_module.range_function_145(DS2,'divaddrssncount',ran39);
				Scoring_QA.Range_function_module.range_function_31(DS2,'divaddrssncountnew',ran40);
				Scoring_QA.Range_function_module.range_function_146(DS2,'divaddrssnmsourcecount',ran41);
				Scoring_QA.Range_function_module.range_function_31(DS2,'divaddrsuspidentitycountnew',ran42);
				Scoring_QA.Range_function_module.range_function_146(DS2,'divssnaddrmsourcecount',ran43);
			  Scoring_QA.Range_function_module.range_function_71(DS2,'divssnidentitymsourcecount',ran44);
				Scoring_QA.Range_function_module.range_function_31(DS2,'divssnlnamecountnew',ran45)
				Scoring_QA.Range_function_module.range_function_152(DS2,'inputaddrbusinesscount',ran46);
			  Scoring_QA.Range_function_module.Range_Function_154(DS2,'inputaddrmultifamilycount',ran47);
				Scoring_QA.Range_function_module.Range_Function_156(DS2,'inputaddrsinglefamilycount',ran48);
				Scoring_QA.Range_function_module.Range_Function_157(DS2,'inputaddrvacantpropcount',ran49);
				// Scoring_QA.Range_function_module.Range_Function_160(DS2,'inputaddrvacantpropcount',ran50);
				Scoring_QA.Range_function_module.range_function_166(DS2,'propnewestsaleprice',ran51);				
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchaddridentities',ran52);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchidentityaddrs',ran53);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchidentityphones',ran54);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchidentityssns',ran55);
				Scoring_QA.Range_function_module.Range_Function_25(DS2,'prsearchlocatecount',ran56);
				Scoring_QA.Range_function_module.Range_Function_25(DS2,'prsearchlocatecount12',ran57);
				Scoring_QA.Range_function_module.Range_Function_25(DS2,'prsearchlocatecount24',ran58);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchpersonalfinancecount',ran59);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchpersonalfinancecount01',ran60);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchpersonalfinancecount06',ran61);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchpersonalfinancecount12',ran62);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchpersonalfinancecount24',ran63);				
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchphoneidentities',ran64);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'prsearchssnidentities',ran65);
			  Scoring_QA.Range_function_module.range_function_37(DS2,'searchaddrsearchcount',ran66);
				Scoring_QA.Range_function_module.range_function_51(DS2,'searchphonesearchcount',ran67);
				Scoring_QA.Range_function_module.range_function_168(DS2,'sfduaddridentitiescount',ran68);
				Scoring_QA.Range_function_module.range_function_168(DS2,'sfduaddrssncount',ran69);				
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchunverifiedaddrcountyear',ran70);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchunverifieddobcountyear',ran71)
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchunverifiedphonecountyear',ran72);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchunverifiedssncountyear',ran73);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'searchunverifiedssncountyear',ran74);					
				Scoring_QA.Range_function_module.Range_Function_111(DS2,'sourceorderagelastorder',ran75);
				Scoring_QA.Range_function_module.Range_Function_25(DS2,'sourceordersourcecount',ran76);
				Scoring_QA.Range_function_module.range_function_136(DS2,'srcsconfirmidaddrcount',ran77);
				Scoring_QA.Range_function_module.range_function_51(DS2,'ssnidentitiescount',ran78);								
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount',ran79);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount01',ran80);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount03',ran81);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount06',ran82);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount12',ran83);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount24',ran84);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'subprimeofferrequestcount60',ran85);				
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'variationdobcount',ran86);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'variationdobcountnew',ran87);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'variationidentitycount',ran88);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'variationmsourcesssncount',ran89);
				Scoring_QA.Range_function_module.Range_Function_31(DS2,'variationmsourcesssnunrelcount',ran90);
					
				
      	         ran:= ran1  + ran2    + ran4  + ran5 + ran6   + ran7  + ran8  + ran9  + ran10 +
				               ...
				               ran41 + ran42 + ran43 + ran44 + ran45 + ran46 + ran47 + ran48 + ran49  +
                       ...
                       ran81 + ran82 + ran83 + ran84 + ran85 +ran86 + ran87 + ran88 + ran89 + ran90;
      	
				  Scoring_QA.Range_function_module.range_function_25(DS2,'subjectssncount',ran0_1);
					Scoring_QA.Range_function_module.range_function_108(DS2,'subjectaddrcount',ran0_2);
					...
					Scoring_QA.Range_function_module.range_function_108(DS2,'ssnaddrcount',ran0_8);
			    Scoring_QA.Range_function_module.range_function_31(DS2,'ssnidentitiesrecentcount',ran0_9);
				  ...
				  Scoring_QA.Range_function_module.range_function_135(DS2,'relativescount',ran0_30);
      	  Scoring_QA.Range_function_module.range_function_25(DS2,'relativesbankruptcycount',ran0_31);
      	  Scoring_QA.Range_function_module.range_function_31(DS2,'relativesfelonycount',ran0_32);
				  Scoring_QA.Range_function_module.range_function_25(DS2,'relativespropownedcount',ran0_33);
      	  ...
      	  // Scoring_QA.Range_function_module.range_function_40(DS2,'addrchangecount36',ran0_42);
				  Scoring_QA.Range_function_module.range_function_40(DS2,'addrchangecount60',ran0_43);
					Scoring_QA.Range_function_module.range_function_51(DS2,'propownedcount',ran0_44);
					Scoring_QA.Range_function_module.range_function_51(DS2,'propownedhistoricalcount',ran0_45);
				  ...
				  // Scoring_QA.Range_function_module.range_function_31(DS2,'subprimesolicitedcount36',ran0_82);
					...
					Scoring_QA.Range_function_module.range_function_31(DS2,'felonycount',ran0_84);
					Scoring_QA.Range_function_module.Range_Function_25(DS2,'derogcount',ran0_85);
			    ...
			    Scoring_QA.Range_function_module.range_function_31(DS2,'evictioncount06',ran0_129);
					...
					Scoring_QA.Range_function_module.range_function_36(DS2,'nonderogcount',ran0_134);
					Scoring_QA.Range_function_module.range_function_47(DS2,'nonderogcount01',ran0_135);
					Scoring_QA.Range_function_module.range_function_46(DS2,'nonderogcount03',ran0_136);
					Scoring_QA.Range_function_module.range_function_46(DS2,'nonderogcount06',ran0_137);
					Scoring_QA.Range_function_module.range_function_46(DS2,'nonderogcount12',ran0_138);
			    Scoring_QA.Range_function_module.range_function_43(DS2,'nonderogcount24',ran0_139);
					// Scoring_QA.Range_function_module.range_function_39(DS2,'nonderogcount36',ran0_140);
					Scoring_QA.Range_function_module.range_function_39(DS2,'nonderogcount60',ran0_141);
			    ...
			    // Scoring_QA.Range_function_module.range_function_31(DS2,'prsearchidvfraudcount06',ran0_169);
					...
					// Scoring_QA.Range_function_module.range_function_167(DS2,'prsearchothercount',ran0_174);
					// Scoring_QA.Range_function_module.range_function_31(DS2,'prsearchothercount01',ran0_175);
					// Scoring_QA.Range_function_module.range_function_31(DS2,'prsearchothercount03',ran0_176);
					// Scoring_QA.Range_function_module.range_function_31(DS2,'prsearchothercount06',ran0_177);
					// Scoring_QA.Range_function_module.range_function_31(DS2,'prsearchothercount12',ran0_178);
			    // Scoring_QA.Range_function_module.range_function_51(DS2,'prsearchothercount24',ran0_179);
					...
					// Scoring_QA.Range_function_module.range_function_89(DS2,'prsearchothercount60',ran0_181);		
					 	 ...
					 	 ran_0:=   ran0_1  + ran0_2  + ran0_3  + ran0_4  + ran0_5  + ran0_6    + ran0_8  + ran0_9  + ran0_10 
				            + ran0_13 + ran0_16 + ran0_17 + ran0_18 + ran0_19 + ran0_20 +
						           ran0_21 + ran0_22 + ran0_23 + ran0_24 + ran0_25  + ran0_27  + ran0_30 +
                       ...
                       ran0_71 + ran0_72 + ran0_73  + ran0_75  + ran0_84 + ran0_85 +ran0_86 + ran0_87 + ran0_88 + ran0_89 + ran0_90 + 
							  ...
							  Scoring_QA.Range_function_module.Range_Function_1(DS2,'prevaddrcountyindex',ran1_7);
								...
								Scoring_QA.Range_function_module.Range_Function_1(DS2,'inputaddrmobilityindex',ran1_11);		
								 ...
								 Scoring_QA.Range_function_module.Range_Function_5(DS2,'prevaddrcrimeindex',ran5_12);
								  ...
								  Scoring_QA.Range_function_module.range_function_31(DS2,'derogrecentcount',ran7_2);
          ...
          Scoring_QA.Range_function_module.Distinct_function(DS2,'proflictypecategory',dis70);
				  ...
				  Scoring_QA.Range_function_module.Range_Function_155(DS2,'inputaddrsiccode',dis80);
				  ...
				  Scoring_QA.Range_function_module.Distinct_function(DS2,'addrpop',dis96);
					...
					Scoring_QA.Range_function_module.range_function_71(DS2,'curraddragenewestrecord',dis103);
					Scoring_QA.Range_function_module.range_function_143(DS2,'curraddrageoldestrecord',dis104);
					Scoring_QA.Range_function_module.Distinct_function2(DS2,'addrrecentecontrajectory',dis105);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'addrrecentecontrajectoryindex',dis106);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'addrstability',dis107);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'ageriskindicator',dis108);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'aircraftowner',dis109);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'assetowner',dis110);
					Scoring_QA.Range_function_module.range_function_141(DS2,'assocrisklevel',dis111);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'businessinactiveassociation',dis112);
					Scoring_QA.Range_function_module.range_function_119(DS2,'businesstitle',dis113);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'componentcharrisklevel',dis114);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'correlationrisklevel',dis115);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'divrisklevel',dis116);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'identityrisklevel',dis117);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'idverrisklevel',dis118);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'idverssncreditbureaudelete',dis119);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'inputaddrdelivery',dis120);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'inputaddrhistoricalmatch',dis121);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'inputaddrproblems',dis122);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'inputphoneproblems',dis123);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'onlinedirectory',dis124);		
					Scoring_QA.Range_function_module.Distinct_function(DS2,'prevaddrcorrectional',dis125);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'recentactivityindex',dis126);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'recentupdate',dis127);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'searchcomponentrisklevel',dis128);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'searchvelocityrisklevel',dis129);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'sourceorderactivity',dis130);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'sourcerisklevel',dis131);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'ssn3years',dis132);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'validationrisklevel',dis133);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'variationrisklevel',dis134);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'verificationfailure',dis135);
					Scoring_QA.Range_function_module.Distinct_function(DS2,'verifiedaddress',dis136);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'verifieddob',dis137);													
					Scoring_QA.Range_function_module.Distinct_function(DS2,'verifiedname',dis138);
		     	Scoring_QA.Range_function_module.Distinct_function(DS2,'verifiedphone',dis139);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'verifiedssn',dis140);	
					Scoring_QA.Range_function_module.Distinct_function(DS2,'voterregistrationrecord',dis141);	
												
					dis:=   dis2  + dis3  +  dis7  + dis8  + dis9  + dis10 +
				       ...
				       dis41 + dis42 + dis43  + dis45 + dis46 + dis47 + dis48  + dis55 + dis56 + dis57 + dis58 + dis59 + dis60 +
               dis61 + dis63 + dis64 + dis65 + dis66 + dis67 + dis68  + dis69 + dis70 + 
	 ...
	 did_stats:=did1;
			...
			result2_stats:= ran + dis + ran_0 + ran_1  + ran_5  +ran_7 + did_stats ;
      	...
      	Scoring_QA.Range_function_module.Average_func(DS2,'phoneedaageoldestrecord',ave72);
      		...
      		// Scoring_QA.Range_function_module.Average_func(DS2,'subprimesolicitedcount01',ave77);
			    ...
			    Scoring_QA.Range_function_module.Average_func(DS2,'profliccount60',ave149);
				  ...
				  // Scoring_QA.Range_function_module.Average_func(DS2,'proflicexpirecount06',ave153);
					...
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount',ave157);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount01',ave158);
			    Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount03',ave159);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount06',ave160);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount12',ave161);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchlocatecount24',ave162);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount',ave163);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount01',ave164);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount03',ave165);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount06',ave166);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount12',ave167);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchpersonalfinancecount24',ave168);
			    Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount',ave169);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount01',ave170);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount03',ave171);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount06',ave172);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount12',ave173);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchothercount24',ave174);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchidentityssns',ave175);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchidentityaddrs',ave176);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchidentityphones',ave177);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchssnidentities',ave178);
			    Scoring_QA.Range_function_module.Average_func(DS2,'prsearchaddridentities',ave179);
					Scoring_QA.Range_function_module.Average_func(DS2,'prsearchphoneidentities',ave180);
      	  ...
      	  // Scoring_QA.Range_function_module.Average_func(DS2,'addrchangecount36',ave222);
		  		...
		  		Scoring_QA.Range_function_module.Average_func(DS2,'watercraftcount60',ave247);
					...
					Scoring_QA.Range_function_module.Range_Average_Function_1(DS2,'addrmostrecentcrimediff',ave258);
					Scoring_QA.Range_function_module.Average_func(DS2,'addrmostrecentdistance',ave259);
					Scoring_QA.Range_function_module.Average_func(DS2,'addrmostrecentmoveage',ave260);
				  Scoring_QA.Range_function_module.Average_func(DS2,'assoccreditbureauonlycount',ave261);
					Scoring_QA.Range_function_module.Average_func(DS2,'assoccreditbureauonlycountmonth',ave262);
					Scoring_QA.Range_function_module.Average_func(DS2,'assoccreditbureauonlycountnew',ave263);
					Scoring_QA.Range_function_module.Average_func(DS2,'assochighrisktopologycount',ave264);	
					Scoring_QA.Range_function_module.Average_func(DS2,'curraddravmvalue12',ave265);	
					Scoring_QA.Range_function_module.Average_func(DS2,'curraddravmvalue60',ave266);
					Scoring_QA.Range_function_module.Average_func(DS2,'estimatedannualincome',ave267);	
				  Scoring_QA.Range_function_module.Average_func(DS2,'lienreleasedtotal',ave268);	
      	   ...
      	   avearage:= ave1  + ave2  + ave3  + ave4  + ave5  + ave6    + ave10 +
                   ...
                   ave71 + ave72 + ave73 + ave74 + ave75 + ave76 +  ave84  + ave86 + ave87 + ave88 + ave89 + ave90 + 
					          ave92 + ave93 + ave94 + ave95 + ave96 + ave97 + ave98  + ave100 + 
				           ave101 + ave102 + ave103 + ave104 + ave105 + ave106 + ave107  + ave109 + ave110 + 
									 ave111 + ave112 + ave113 + ave114 + ave115  + ave117 + ave118 + ave119 + ave120 +
									 ave121 + ave122 + ave123  + ave125 + ave126 + ave127 + ave128 + ave129 + ave130 +
				           ave131  + ave133 + ave134 + ave135 + ave136 + ave137 + ave138 + ave139  +
				           ave141 + ave142 + ave143 + ave144 + ave145 + ave146 + ave147  + ave149  +
									 ave157 + ave158 + ave159 + ave160 +
                  ...
                  ave182 + ave183 + ave184 + ave185 + ave186 + ave187 + ave188 + ave189 + ave190 + 
									  ave193  + ave196 + ave197 + ave198 + ave199 + ave200 + 
								   ave201 + ave202 + ave203 + ave204 + ave205  + ave207 + ave208 + ave209 + ave210 + 
									 ave211 + ave212 + ave213 +  ave217 + ave218 + ave219 + ave220 + 
									 ave221  + ave223 + ave224 + ave225 + ave226 + ave227 + ave228 + ave229 + ave230 + 
									  ave232 + ave233 + ave234 + ave235 + ave236 + ave237  + ave239 + ave240 + 
									 ave241 + ave242 + ave243 + ave244 + ave245  + ave247 + ave248 + ave249 + ave250 + 
									 ave251 + ave252 + ave253  + ave255  + ave257 + ave258 + ave259 + ave260 +
									 ave261 + ave262 + ave263 + ave264 + ave265 + ave266+ ave267 + ave268;
...
compare_layout_stats func1(result2_stats l):=transform
	...
	compare_layout := RECORD
		  ...
		  did_results := DATASET([{'leadintegrity_generic_v4','batch','did','<DID not equal>',count(file1),count(file2),count(file2)-count(file1),pfc,'<DID not equal>',pf,cf,'','','','',pd,abd,ppd,0}
	                    ], compare_layout);
		...
		FileNameNewLogical:='~ScoringQA::bss::stats::'+ scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile[2..] + current_dt;
		
		FileNameNewLogical1:='~ScoringQA::bss::averages::'+ scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile[2..] + current_dt;
		
		FileNameNewLogical2:='~ScoringQA::bss::dids::'+ scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile[2..] + current_dt;
