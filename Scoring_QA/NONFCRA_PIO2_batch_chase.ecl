EXPORT NONFCRA_PIO2_batch_chase(route,current_dt,previous_dt) := functionmacro
 ...
 file1_2:= dataset(route + scoring_project_pip.Output_Sample_Names.PRIO_Scores_BATCH_Chase_PIO2_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_Chase_PIO2_Global_Layout,


thor);
 
 file2_2:= dataset(route + scoring_project_pip.Output_Sample_Names.PRIO_Scores_BATCH_Chase_PIO2_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_Chase_PIO2_Global_Layout,
