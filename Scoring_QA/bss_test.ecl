...
ip:='~';
	  ...
	  // rpt2:=Scoring_QA.FCRA_RiskView_xml_generic_attributes_v4(ip,a1,b1);
		
		// rpt3:=Scoring_QA.FCRA_RiskView_batch_generic_attributes_v3(ip,a1,b1);
				
    // rpt4:=Scoring_QA.FCRA_RiskView_batch_generic_attributes_v4(ip,a1,b1);
    ...
    // rpt19:=Scoring_QA.NONFCRA_CBBL_xml_chase(ip,a1,b1);
		...
		// rpt24:=Scoring_QA.FCRA_RiskView_batch_Experian_attributes_v3(ip,a1,b1);
		
		// rpt25:=Scoring_QA.FCRA_RiskView_xml_Experian_attributes_v3(ip,a1,b1);
		
		rpt26:=Scoring_QA.FCRA_RiskView_xml_generic_attributes_v5(ip,a1,b1);
		
		
		//*********************************************************************************************************************
		// rpt1_1:=Scoring_QA.FCRA_RiskView_xml_generic_attributes_v3(ip,b1,a1);
	
	  // rpt2_1:=Scoring_QA.FCRA_RiskView_xml_generic_attributes_v4(ip,b1,a1);
		
		// rpt3_1:=Scoring_QA.FCRA_RiskView_batch_generic_attributes_v3(ip,b1,a1);
    ...
    // rpt19_1:=Scoring_QA.NONFCRA_CBBL_xml_chase(ip,b1,a1);
		...
		// rpt24_1:=Scoring_QA.FCRA_RiskView_batch_Experian_attributes_v3(ip,b1,a1);
		
		// rpt25_1:=Scoring_QA.FCRA_RiskView_xml_Experian_attributes_v3(ip,b1,a1);
		
		rpt26_1:=Scoring_QA.FCRA_RiskView_xml_generic_attributes_v5(ip,b1,a1);
    ...
    END;
		...
		result1_stats:=dataset('~scoringqa::bss::stats::test2::'+ a1 ,compare_layout_stats,CSV(HEADING(single), QUOTE('"')));		
		result2_stats:=dataset('~scoringqa::bss::stats::test2::'+ b1 ,compare_layout_stats,CSV(HEADING(single), QUOTE('"')));		
		
    result3_stats:=dataset('~scoringqa::bss::averages::test2::'+ a1 ,compare_layout_stats,CSV(HEADING(single), QUOTE('"')));	
    result4_stats:=dataset('~scoringqa::bss::averages::test2::'+ b1 ,compare_layout_stats,CSV(HEADING(single), QUOTE('"')));	
   		...
   		compare_layout := RECORD
                  ...
                  decimal20_4 proportion_diff;
                        ...
                        END;	
													...
													did_stats:=dataset('~scoringqa::bss::dids::test2::'+ a1 ,compare_layout,CSV(HEADING(single), QUOTE('"')));	
   ...
   // jn;
      ...
      outfile := dataset('~RiskView_Attributes_Reports::out::AttributeDistribution' + a1, typeof(out_file_layout));
        ...
        no_of_records := count(outfile);
			  ...
			  //////////////////////// report 2///////////////////////////////////
						...
						// filtered_dedup_jn:=dedup_jn(file_version in ['ITA_V3_Capone' , 'RISKVIEW_v3_capone_prescreen' , 'RISKVIEW_v2_capone_prescreen']);
						filtered_dedup_jn:=dedup_jn(file_version in ['RISKVIEW_v5_capone_prescreen']);
	...
	new_bins_remove_superfile:= if(  STD.File.FileExists('~scoringqa::bss::stats::test2::'+ a1) and 
				                                 STD.File.FileExists('~scoringqa::bss::averages::test2::'+ a1) and 
			                                   STD.File.FileExists('~scoringqa::bss::dids::test2::'+ a1),
																				 
      	           sequential(FileServices.DeleteSuperFile('~scoringqa::bss::stats::test2::' + a1),
   							              FileServices.DeleteSuperFile('~scoringqa::bss::averages::test2::' + a1),
					                    FileServices.DeleteSuperFile('~scoringqa::bss::dids::test2::' + a1)) 
															);
					
				  	    old_bins_remove_superfile:= if(  NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::test2::'+ b1) and STD.File.FileExists('~scoringqa::bss::averages::test2::'+ b1)  and
   			                                                                                  STD.File.FileExists('~scoringqa::bss::dids::test2::'+ b1)),
         	           sequential(FileServices.DeleteSuperFile('~scoringqa::bss::stats::test2::' + b1),
      							            FileServices.DeleteSuperFile('~scoringqa::bss::averages::test2::' + b1),
   					FileServices.DeleteSuperFile('~scoringqa::bss::dids::test2::' + b1)));		
   			 
        new_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::test2::'+ a1) and STD.File.FileExists('~scoringqa::bss::averages::test2::'+ a1) and 
   			                                                                                  STD.File.FileExists('~scoringqa::bss::dids::test2::'+ a1)),
         	           sequential(FileServices.CreateSuperFile('~scoringqa::bss::stats::test2::' + a1),
      							            FileServices.CreateSuperFile('~scoringqa::bss::averages::test2::' + a1),
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::test2::' + a1),rpt26) );
                																		 
         old_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::test2::'+ b1) and STD.File.FileExists('~scoringqa::bss::averages::test2::'+ b1)  and
   			                                                                                  STD.File.FileExists('~scoringqa::bss::dids::test2::'+ b1)),
         	           sequential(FileServices.CreateSuperFile('~scoringqa::bss::stats::test2::' + b1),
      							            FileServices.CreateSuperFile('~scoringqa::bss::averages::test2::' + b1),
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::test2::' + b1),rpt26_1) );

         
	 send_file:=	
 	 // fileservices.SendEmailAttachText(Scoring_Project_DailyTracking.email_distribution.BSS_Success_list,
fileservices.SendEmailAttachText('Jonathan.Deurlein@lexisnexis.com',					
...
fileservices.SendEmailAttachText('Jonathan.Deurlein@lexisnexis.com',					
		   ...
		   sequential (new_bins_remove_superfile,old_bins_remove_superfile,new_bins,old_bins, out_file, send_file ,out_file1,send_file1);	
   ...
   // jn;
	...
	new_bins_remove_superfile:= if(  STD.File.FileExists('~scoringqa::bss::stats::'+ a1) and 
        ...
        new_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::'+ a1) and STD.File.FileExists('~scoringqa::bss::averages::'+ a1) and 
   					...
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::' + a1),rpt1,rpt2,rpt3,rpt4,rpt5,rpt6,rpt7,rpt8,rpt11,rpt12,rpt13,rpt14,rpt15,rpt16,rpt17,rpt18,rpt19,rpt24,rpt25) );
         ...
         old_bins:= if( not NOTHOR(STD.File.FileExists('~scoringqa::bss::stats::'+ b1) and STD.File.FileExists('~scoringqa::bss::averages::'+ b1)  and
   					...
   					FileServices.CreateSuperFile('~scoringqa::bss::dids::' + b1),rpt1_1,rpt2_1,rpt3_1,rpt4_1,rpt5_1,rpt6_1,rpt7_1,rpt8_1,rpt11_1,rpt12_1,rpt13_1,rpt14_1,rpt15_1,rpt16_1,rpt17_1,rpt18_1,rpt19_1,rpt24_1,rpt25_1) );
