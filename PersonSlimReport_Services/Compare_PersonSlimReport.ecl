...
EXPORT Compare_PersonSlimReport() := MACRO
...
difference := MODULE
  ...
  EXPORT boolean MonitorAddress := FALSE : STORED('Compare_Address', FORMAT(sequence(11)));
  EXPORT boolean MonitorName := FALSE : STORED('Compare_Name', FORMAT(sequence(12)));
  EXPORT boolean MonitorPhones := FALSE : STORED('Compare_Phones', FORMAT(sequence(13)));
  EXPORT boolean MonitorDeath := FALSE : STORED('Compare_Death', FORMAT(sequence(14)));
  EXPORT boolean MonitorDOB := FALSE : STORED('Compare_DOB', FORMAT(sequence(15)));
  EXPORT boolean MonitorSSNs := FALSE : STORED('Compare_SSNs', FORMAT(sequence(16)));
  EXPORT boolean MonitorProfessionalLicense := FALSE : STORED('Compare_ProfessionalLicense', FORMAT(sequence(17)));
  EXPORT boolean MonitorPeopleAtWork := FALSE : STORED('Compare_PeopleAtWork', FORMAT(sequence(18)));
  EXPORT boolean MonitorAircraft := FALSE : STORED('Compare_Aircraft', FORMAT(sequence(19)));
  EXPORT boolean MonitorCertification := FALSE : STORED('Compare_Certification', FORMAT(sequence(20)));
  EXPORT boolean MonitorWaterCraft := FALSE : STORED('Compare_WaterCraft', FORMAT(sequence(21)));
  EXPORT boolean MonitorUCCFiling := FALSE : STORED('Compare_UCCFiling', FORMAT(sequence(22)));
  EXPORT boolean MonitorSexualOffense := FALSE : STORED('Compare_SexualOffense', FORMAT(sequence(23)));
  EXPORT boolean MonitorCriminal := FALSE : STORED('Compare_Criminal', FORMAT(sequence(24)));
  EXPORT boolean MonitorWeaponPermit := FALSE : STORED('Compare_WeaponPermit', FORMAT(sequence(25)));
  EXPORT boolean MonitorHuntingFishingLicense := FALSE : STORED('Compare_HuntingFishingLicense', FORMAT(sequence(26)));
  EXPORT boolean MonitorFirearmExplosive := FALSE : STORED('Compare_FirearmExplosive', FORMAT(sequence(27)));
  EXPORT boolean MonitorControlledSubstance := FALSE : STORED('Compare_ControlledSubstance', FORMAT(sequence(28)));
  EXPORT boolean MonitorVoterRegistration := FALSE : STORED('Compare_VoterRegistration', FORMAT(sequence(29)));
  EXPORT boolean MonitorDriver := FALSE : STORED('Compare_Driver', FORMAT(sequence(30)));
  EXPORT boolean MonitorVehicle := FALSE : STORED('Compare_Vehicle', FORMAT(sequence(31)));
  EXPORT boolean MonitorAccident := FALSE : STORED('Compare_Accident', FORMAT(sequence(32)));
  EXPORT boolean MonitorBankruptcy := FALSE : STORED('Compare_Bankruptcy', FORMAT(sequence(33)));
  EXPORT boolean MonitorLienJudgment := FALSE : STORED('Compare_LienJudgment', FORMAT(sequence(34)));
  EXPORT boolean MonitorProperty := FALSE : STORED('Compare_Property', FORMAT(sequence(35)));
  EXPORT boolean MonitorMarriageDivorce := FALSE : STORED('Compare_MarriageDivorce', FORMAT(sequence(36)));
  EXPORT boolean MonitorEducation := FALSE : STORED('Compare_Education', FORMAT(sequence(37)));
  EXPORT boolean MonitorAKA := FALSE : STORED('Compare_AKA', FORMAT(sequence(38)));
  EXPORT boolean MonitorImposter := FALSE : STORED('Compare_Imposter', FORMAT(sequence(39)));
  EXPORT boolean MonitorUtility := FALSE : STORED('Compare_Utility', FORMAT(sequence(40)));
