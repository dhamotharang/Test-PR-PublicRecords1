...
difference := MODULE
  ...
  EXPORT boolean MonitorCertification := FALSE : STORED('Compare_Certification', FORMAT(sequence(12)));
  EXPORT boolean MonitorHuntingFishingLicense := FALSE : STORED('Compare_HuntingFishingLicense', FORMAT(sequence(13)));
  EXPORT boolean MonitorFirearmExplosive := FALSE : STORED('Compare_FirearmExplosive', FORMAT(sequence(14)));
  EXPORT boolean MonitorControlledSubstance := FALSE : STORED('Compare_ControlledSubstance', FORMAT(sequence(15)));
  EXPORT boolean MonitorVoterRegistration := FALSE : STORED('Compare_VoterRegistration', FORMAT(sequence(16)));
  EXPORT boolean MonitorDriver := FALSE : STORED('Compare_Driver', FORMAT(sequence(17)));
  EXPORT boolean MonitorVehicle := FALSE : STORED('Compare_Vehicle', FORMAT(sequence(18)));
  EXPORT boolean MonitorBankruptcy := FALSE : STORED('Compare_Bankruptcy', FORMAT(sequence(19)));
  EXPORT boolean MonitorLienJudgment := FALSE : STORED('Compare_LienJudgment', FORMAT(sequence(20)));
