IMPORT ut,SALT34;
EXPORT hygiene(dataset(layout_In_AK) h) := MODULE
...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_key_pcnt *   0.00 / 100 + T.Populated_corp_vendor_pcnt *   0.00 / 100 + T.Populated_corp_state_origin_pcnt *   0.00 / 100 + T.Populated_corp_process_date_pcnt *   0.00 / 100 + T.Populated_corp_orig_sos_charter_nbr_pcnt *   0.00 / 100 + T.Populated_corp_legal_name_pcnt *   0.00 / 100 + T.Populated_corp_ln_name_type_cd_pcnt *   0.00 / 100 + T.Populated_corp_status_desc_pcnt *   0.00 / 100 + T.Populated_corp_standing_pcnt *   0.00 / 100 + T.Populated_corp_inc_state_pcnt *   0.00 / 100 + T.Populated_corp_inc_date_pcnt *   0.00 / 100 + T.Populated_corp_term_exist_cd_pcnt *   0.00 / 100 + T.Populated_corp_term_exist_exp_pcnt *   0.00 / 100 + T.Populated_corp_term_exist_desc_pcnt *   0.00 / 100 + T.Populated_corp_foreign_domestic_ind_pcnt *   0.00 / 100 + T.Populated_corp_forgn_date_pcnt *   0.00 / 100 + T.Populated_corp_orig_org_structure_desc_pcnt *   0.00 / 100 + T.Populated_corp_for_profit_ind_pcnt *   0.00 / 100 + T.Populated_corp_country_of_formation_pcnt *   0.00 / 100 + T.Populated_Corp_Name_Status_Desc_pcnt *   0.00 / 100 + T.Populated_corp_forgn_state_cd_pcnt *   0.00 / 100 + T.Populated_recordorigin_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_vendor_first_reported_pcnt,le.populated_dt_vendor_last_reported_pcnt,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_corp_ra_dt_first_seen_pcnt,le.populated_corp_ra_dt_last_seen_pcnt,le.populated_corp_key_pcnt,le.populated_corp_vendor_pcnt,le.populated_corp_state_origin_pcnt,le.populated_corp_process_date_pcnt,le.populated_corp_orig_sos_charter_nbr_pcnt,le.populated_corp_legal_name_pcnt,le.populated_corp_ln_name_type_cd_pcnt,le.populated_corp_status_desc_pcnt,le.populated_corp_standing_pcnt,le.populated_corp_inc_state_pcnt,le.populated_corp_inc_date_pcnt,le.populated_corp_term_exist_cd_pcnt,le.populated_corp_term_exist_exp_pcnt,le.populated_corp_term_exist_desc_pcnt,le.populated_corp_foreign_domestic_ind_pcnt,le.populated_corp_forgn_date_pcnt,le.populated_corp_orig_org_structure_desc_pcnt,le.populated_corp_for_profit_ind_pcnt,le.populated_corp_country_of_formation_pcnt,le.populated_Corp_Name_Status_Desc_pcnt,le.populated_corp_forgn_state_cd_pcnt,le.populated_recordorigin_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_corp_ra_dt_first_seen,le.maxlength_corp_ra_dt_last_seen,le.maxlength_corp_key,le.maxlength_corp_vendor,le.maxlength_corp_state_origin,le.maxlength_corp_process_date,le.maxlength_corp_orig_sos_charter_nbr,le.maxlength_corp_legal_name,le.maxlength_corp_ln_name_type_cd,le.maxlength_corp_status_desc,le.maxlength_corp_standing,le.maxlength_corp_inc_state,le.maxlength_corp_inc_date,le.maxlength_corp_term_exist_cd,le.maxlength_corp_term_exist_exp,le.maxlength_corp_term_exist_desc,le.maxlength_corp_foreign_domestic_ind,le.maxlength_corp_forgn_date,le.maxlength_corp_orig_org_structure_desc,le.maxlength_corp_for_profit_ind,le.maxlength_corp_country_of_formation,le.maxlength_Corp_Name_Status_Desc,le.maxlength_corp_forgn_state_cd,le.maxlength_recordorigin);
  SELF.avelength := CHOOSE(C,le.avelength_dt_vendor_first_reported,le.avelength_dt_vendor_last_reported,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_corp_ra_dt_first_seen,le.avelength_corp_ra_dt_last_seen,le.avelength_corp_key,le.avelength_corp_vendor,le.avelength_corp_state_origin,le.avelength_corp_process_date,le.avelength_corp_orig_sos_charter_nbr,le.avelength_corp_legal_name,le.avelength_corp_ln_name_type_cd,le.avelength_corp_status_desc,le.avelength_corp_standing,le.avelength_corp_inc_state,le.avelength_corp_inc_date,le.avelength_corp_term_exist_cd,le.avelength_corp_term_exist_exp,le.avelength_corp_term_exist_desc,le.avelength_corp_foreign_domestic_ind,le.avelength_corp_forgn_date,le.avelength_corp_orig_org_structure_desc,le.avelength_corp_for_profit_ind,le.avelength_corp_country_of_formation,le.avelength_Corp_Name_Status_Desc,le.avelength_corp_forgn_state_cd,le.avelength_recordorigin);
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{16,'corp_inc_state'}
      ,{17,'corp_inc_date'}
      ,{18,'corp_term_exist_cd'}
      ,{19,'corp_term_exist_exp'}
      ,{20,'corp_term_exist_desc'}
      ,{21,'corp_foreign_domestic_ind'}
      ,{22,'corp_forgn_date'}
      ,{23,'corp_orig_org_structure_desc'}
      ,{24,'corp_for_profit_ind'}
      ,{25,'corp_country_of_formation'}
      ,{26,'Corp_Name_Status_Desc'}
      ,{27,'corp_forgn_state_cd'}
      ,{28,'recordorigin'}],SALT34.MAC_Character_Counts.Field_Identification);
