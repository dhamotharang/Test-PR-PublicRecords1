...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_term_exist_cd_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.corp_term_exist_exp_Invalid := (le.ScrubsBits1 >> 28) & 3;
    SELF.corp_term_exist_desc_Invalid := (le.ScrubsBits1 >> 30) & 1;
    ...
    SELF.Corp_Name_Status_Desc_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.corp_forgn_state_cd_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_country_of_formation_LENGTH_ErrorCount := COUNT(GROUP,h.corp_country_of_formation_Invalid=1);
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_inc_date:invalid_optional_past_date:ALLOW','corp_inc_date:invalid_optional_past_date:CUSTOM','corp_inc_date:invalid_optional_past_date:LENGTH'
          ...
          ,'corp_forgn_date:invalid_optional_past_date:ALLOW','corp_forgn_date:invalid_optional_past_date:CUSTOM','corp_forgn_date:invalid_optional_past_date:LENGTH'
          ...
          ,'corp_country_of_formation:invalid_mandatory:LENGTH'
          ,'Corp_Name_Status_Desc:invalid_corp_name_status_desc:ENUM'
          ,'corp_forgn_state_cd:invalid_alphablank:ALLOW','UNKNOWN');
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_forgn_state_cd(1),'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_country_of_formation_LENGTH_ErrorCount
          ,le.Corp_Name_Status_Desc_ENUM_ErrorCount
          ,le.corp_forgn_state_cd_ALLOW_ErrorCount,0);
      SELF.rulepcnt := 100 * CHOOSE(c
          ...
          ,le.corp_country_of_formation_LENGTH_ErrorCount
          ,le.Corp_Name_Status_Desc_ENUM_ErrorCount
          ,le.corp_forgn_state_cd_ALLOW_ErrorCount,0) / le.TotalCnt + 0.5;
    END;
