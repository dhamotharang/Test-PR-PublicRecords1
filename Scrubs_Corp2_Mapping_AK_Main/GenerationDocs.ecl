...
Command line options: -MScrubs_Corp2_Mapping_AK_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR5957.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_AK_Main
FILENAME:In_AK
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-ABCDEFGHIJKLMNOPQRSTUVWXYZ):LENGTHS(4..11)
FIELDTYPE:invalid_corp_vendor:ENUM(02)
FIELDTYPE:invalid_state_origin:ENUM(AK)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_AK_Main.Functions.invalid_name_type_code>0,recordOrigin)
FIELDTYPE:invalid_forgn_dom_code:ENUM(F|D| )
FIELDTYPE:invalid_corp_status_desc:ENUM(NON-COMPLIANT|GOOD STANDING|ACTIVE NAME| )
FIELDTYPE:invalid_corp_name_status_desc:ENUM(ACTIVE NAME| )
...
FIELDTYPE:invalid_corp_orig_org_structure_desc:ENUM(BUSINESS CORPORATION|COOP ELECTRIC AND TELEPHONE|COOPERATIVE CORPORATION|LIMITED LIABILITY COMPANY|LIMITED LIABILITY PARTNERSHIP|LIMITED PARTNERSHIP|NONPROFIT CORPORATION|PROFESSIONAL CORPORATION|RELIGIOUS CORPORATION| )
FIELDTYPE:invalid_for_profit_indicator:ENUM(N| )
FIELDTYPE:invalid_charter:ALLOW(0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ):LENGTHS(1..8)
FIELDTYPE:invalid_date:ALLOW(0123456789):LENGTHS(8):CUSTOM(Scrubs.fn_valid_pastDate>0)
FIELDTYPE:invalid_optional_date:ALLOW(0123456789):LENGTHS(0,8):CUSTOM(Scrubs.fn_valid_GeneralDate>0)
FIELDTYPE:invalid_optional_past_date:ALLOW(0123456789):LENGTHS(0,8):CUSTOM(Scrubs.fn_valid_PastDate>0)
...
DATEFIELD:corp_inc_date:TYPE(STRING8):LIKE(invalid_optional_past_date):0,0
FIELD:corp_term_exist_cd:TYPE(STRING8):LIKE(invalid_corp_term_exist_cd):0,0
DATEFIELD:corp_term_exist_exp:TYPE(STRING8):LIKE(invalid_optional_date):0,0
...
DATEFIELD:corp_forgn_date:TYPE(STRING8):LIKE(invalid_optional_past_date):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_mandatory):0,0
...
// Fields not being used for Scrubs
