...
EXPORT KeyName := Health_Provider_Services.Files.FILE_LexID_SF; //'~'+'key::Health_Provider_Services::LNPID::Refs::LEXID';
...
#IF(#TEXT(Input_DID)<>'')
  #uniquename(trans)
  Health_Provider_Services.Key_HealthProvider_LEXID.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Provider_Services.Key_HealthProvider_LEXID.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
