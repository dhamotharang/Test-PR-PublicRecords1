...
EXPORT KeyName := Health_Provider_Services.Files.FILE_UPIN_SF; //'~'+'key::Health_Provider_Services::LNPID::Refs::UPN';
...
#IF(#TEXT(Input_UPIN)<>'')
  #uniquename(trans)
  Health_Provider_Services.Key_HealthProvider_UPN.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Provider_Services.Key_HealthProvider_UPN.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
