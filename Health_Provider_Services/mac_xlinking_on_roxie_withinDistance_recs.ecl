export mac_xlinking_on_roxie_withinDistance_recs (infile,Input_UniqueID,Input_FNAME = '',Input_MNAME = '',Input_LNAME = '',Input_SNAME = '',Input_GENDER = '',
																							...
																							Input_SOURCE_RID = '',OutFile, Input_IDL = '', Match_Records = false, Full_Match = false, score = 45, distance = 0) := MACRO
...
#uniquename(res_out)
%res_out% := Health_Provider_Services.MEOW_xLNPID(%pr%).Data_;
