...
EXPORT KeyName := Health_Provider_Services.Files.FILE_Billing_NPI_SF; //'~'+'key::Health_Provider_Services::LNPID::Refs::BILLING_NPI';
...
#IF(#TEXT(Input_BILLING_NPI_NUMBER)<>'')
  #uniquename(trans)
  Health_Provider_Services.Key_HealthProvider_BILLING_NPI.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Provider_Services.Key_HealthProvider_BILLING_NPI.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
