...
#workunit('name','Health_Provider_Services.BWR_Specificities - Specificities - SALT V2.8 Gold SR1');
IMPORT Health_Provider_Services,SALT28;
IMPORT SALTTOOLS22;
SpecMod := Health_Provider_Services.specificities(Health_Provider_Services.File_HealthProvider);
...
// SALTTOOLS22.mac_Patch_SPC(SpecMod.Specificities,'Health_Provider_Services.<your_spc_attribute>',Health_Provider_Services.File_HealthProvider);
