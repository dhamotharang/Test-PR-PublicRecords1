...
EXPORT KeyName := Health_Provider_Services.Files.FILE_Tax_SF; //'~'+'key::Health_Provider_Services::LNPID::Refs::TAX';
...
#IF(#TEXT(Input_TAX_ID)<>'')
  #uniquename(trans)
  Health_Provider_Services.Key_HealthProvider_TAX.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Provider_Services.Key_HealthProvider_TAX.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
