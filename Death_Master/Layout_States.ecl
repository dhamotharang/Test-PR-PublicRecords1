...
MODULE
	...
	RECORD	
		...
		UNSIGNED3	DateOfInjury;
		UNSIGNED2	TimeOfInjury;
		STRING		PlaceOfInjury;
		STRING		InjuryDescription;
		UNSIGNED1	POD_State2;
		UNSIGNED1	race;
		UNSIGNED1	ageyrs;
		STRING		POR_Town;
		...
		// STRING		NewbornInfantIndicator; // Not in the 2012 Layout
		// STRING		DOB_Mth;
		// STRING		DOB_Day;
		// STRING		DOB_Yr;
		// STRING		POB_Town;
		// STRING		POB_StateOrCountry;
		// STRING		POR_StateOrCountry;
		// STRING		POR_County;
		// STRING		POR_Town;
// `		STRING		POR_ApartmentNumber;
		// STRING		POR_Zip;
		...
		// STRING		fname_spouse;
		// STRING		lname_father;
		// STRING		POD_NamedPlace;
		// STRING		POD_StreetNumber;
		// STRING		POD_StreetName;
		// STRING		POD_StreetType;
		// STRING		HospitalStatus;
		// STRING		POD_Town;
		// STRING		StateCode;
		// STRING		POD_Zip;
		// STRING		MethodOfDisposition;
		// STRING		MedicalExaminerContacted;
		// STRING		Autopsy;
		// STRING		AutopsyFindingsAvailable;
