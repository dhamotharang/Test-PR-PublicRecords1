...
death_ready := table(Death_Master.File_DeathMaster_Building_ssa, death_record /*and not [state_death_flag, death_rec_src]*/);
...
export key_death_id_base_ssa := index(dead_with_county_sort,
                               {state_death_id},{dead_with_county_sort},
				           data_services.data_location.prefix('Death')+'thor_data400::key::death_id_death_masterV2_ssa_'+doxie.Version_SuperKey);
