...
dMasterSupplemental	:=	Header.file_death_master_supplemental_SSA;
dDIDMasterV3				:=	Header.File_DID_Death_MasterV3_ssa;
...
export key_death_id_supplemental_ssa := index(death_supplemental_sort,
                               {state_death_id},{death_supplemental_sort},
				           Data_Services.Data_location.prefix('Death')+'thor_data400::key::death_id_death_supplemental_ssa_'+ doxie.Version_SuperKey);
