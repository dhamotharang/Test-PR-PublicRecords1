...
df := Death_Master.File_DeathMaster_Building_ssa(_Validate.Date.fIsValid(dod8));
...
{state_death_id},
Data_Services.Data_location.prefix('Death')+'thor_data400::key::dod_death_masterV2_ssa_' + doxie.Version_SuperKey
);
