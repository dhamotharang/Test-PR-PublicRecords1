...
EXPORT Transform_Data := MODULE
		...
		SHARED pindexversion := PRTE2_Common.Constants.TodayString;
		SHARED LNPropertyRec := Layouts_V2.layout_LNP_V2_expanded_payload;
		SHARED spreadsheet_layout := Layouts_V2.LN_spreadsheet;
		...
		// EXPORT spreadsheet_layout  Reformat_PHASE2 (spreadsheet_layout L) := TRANSFORM
		...
		// EXPORT spreadsheet_layout  Reformat_PHASE1 (spreadsheet_layout L, Integer C) := TRANSFORM
