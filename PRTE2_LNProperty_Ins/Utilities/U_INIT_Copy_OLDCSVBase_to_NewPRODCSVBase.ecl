/* *********************************************************************************************
PRTE2_LNProperty_Ins.U_INIT_Copy_OLDCSVBase_to_NewPRODCSVBase

same as PRTE2_LNProperty_Ins.U_INIT_Copy_OLDCSVBase_to_NewCSVBase but with all code dependancies removed.
...
newBaseLayout := PRTE2.Layouts.layout_ln_propertyv2_expanded_payload;
// DataDS	:= DATASET(New_Base_Name, LN_spreadsheet, THOR);
DataDS	:= DATASET(New_Base_Name, newBaseLayout, THOR);
OUTPUT(DataDS);
// PromoteSupers.Mac_SF_BuildProcess(DataDS, New_Base_Name, build_main_base);
