...
export CalculateDBTV5(dataset(Business_Credit.Layouts.rAccountBase) TradeLines):= function
    ...
    rAddRequiredFields tCalculateDBTV5(rAddRequiredFields L,rAddRequiredFields R, integer C):=transform
        PastDueAmountStatus:=map( (REAL)R.Past_Due_Amount=  (REAL)R.Past_Due_Aging_Amount_Bucket_1=>1,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2  => 2,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2 +  (REAL)R.past_due_aging_amount_bucket_3  => 3,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2 +  (REAL)R.past_due_aging_amount_bucket_3 +   (REAL)R.past_due_aging_amount_bucket_4  => 4,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2 +  (REAL)R.past_due_aging_amount_bucket_3 +   (REAL)R.past_due_aging_amount_bucket_4 + (REAL)R.past_due_aging_amount_bucket_5  => 5,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2 +  (REAL)R.past_due_aging_amount_bucket_3 +   (REAL)R.past_due_aging_amount_bucket_4 + (REAL)R.past_due_aging_amount_bucket_5 + (REAL)R.past_due_aging_amount_bucket_6  => 6,
                                  (REAL)R.Past_Due_Amount = (REAL)R.past_due_aging_amount_bucket_1 + (REAL)R.past_due_aging_amount_bucket_2 +  (REAL)R.past_due_aging_amount_bucket_3 +   (REAL)R.past_due_aging_amount_bucket_4 + (REAL)R.past_due_aging_amount_bucket_5 + (REAL)R.past_due_aging_amount_bucket_6 +  (REAL)R.past_due_aging_amount_bucket_7 => 7,
                                  -1);
        ...
        self.Internal_Payment_Status:= 
                          MAP(R.payment_status_category='' AND R.Past_Due_Amount<>'' AND (real)R.Past_Due_Amount <> 0 => PastDueAmountStatus,
                              ...
                              (Integer)R.payment_status_category = 0 => 0, 
                              ...
                              -97);
        OpenDateCheck:=if((R.Date_Account_Opened='' or (unsigned4)R.Date_Account_Opened>=(unsigned4)R.cycle_end_date) and self.Internal_Payment_Status>0,true,false);
        ...
        DBT_V5_General_CapRound1:=MAP(R.days_delinquent <> '' and (integer)R.days_delinquent>0=>R.days_delinquent,
                                     ...
                                     R.Date_Account_Opened<>'' and (unsigned4)R.Date_Account_Opened<(unsigned4)R.cycle_end_date=>(string)STD.Date.DaysBetween((unsigned4)R.Date_Account_Opened,(unsigned4)R.cycle_end_date),
                                     '');
        ...
        self.Raw_DBT_V5:=map(
                                     ...
                                     self.Internal_Payment_Status>self.Prior_Payment_Status and self.Internal_Payment_Status in [1,2,3,4,5,6] and PaymentIntervalDays >= 30 => if(self.DBT_V5_General_Cap<>'' or (integer)self.DBT_V5_General_Cap  >= RoundUP(((Self.Internal_Payment_Status-1)*((real)PaymentIntervalDays))+15.0),RoundUP(((Self.Internal_Payment_Status-1)*((real)PaymentIntervalDays))+15.0),(integer)self.DBT_V5_General_Cap),
                                     self.Internal_Payment_Status>self.Prior_Payment_Status and self.Internal_Payment_Status=7 and R.days_delinquent<>'' and (integer)R.days_delinquent > 0 => (integer)R.days_delinquent,
                                     self.Internal_Payment_Status>self.Prior_Payment_Status and self.Internal_Payment_Status=7 and (R.days_delinquent='' or (integer)R.days_delinquent <= 0) => -4,
        ...
        self.Exception_Cycle_Days:=map(
                                     ...
                                     isV5=false and self.Internal_Payment_Status < 0  and self.Prior_Payment_Status >= 0 =>self.Cycle_Days_Diff,
                                     ...
                                     IsMonthly and self.Internal_Payment_Status < 0  and self.Prior_Payment_Status >= 0 =>self.Cycle_Days_Diff,
        ...
        self.Last_Payment_Status_Before_Exception:=map(
                                     OpenDateCheck=>0,
                                     isV5=false and self.Internal_Payment_Status < 0  and self.Prior_Payment_Status >= 0 =>self.Prior_Payment_Status,
                                     ...
                                     IsMonthly and self.Internal_Payment_Status < 0  and self.Prior_Payment_Status >= 0=>self.Prior_Payment_Status,
