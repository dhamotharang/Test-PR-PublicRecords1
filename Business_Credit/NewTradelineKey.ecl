...
EXPORT	NewTradelineKey(STRING pVersion	=	(STRING8)Std.Date.Today(),
											business_credit.Constants().buildType	pBuildType	=	Business_credit.Constants().buildType.Daily)	:=	FUNCTION
