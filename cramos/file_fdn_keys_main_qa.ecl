...
// IMPORT ut,_control,jmills;

// EXPORT file_fdn_keys_main_qa := 
				// DATASET(ut.foreign_prod + '::jmills.file_fdn_keys_main_qa', cramos.layout_fdn_keys_main_qa,thor) ;
				// DATASET('foreign::' +  _control.IPAddress.prod_thor_esp + '::jmills.file_fdn_keys_main_qa', cramos.layout_fdn_keys_main_qa,thor) ;
...
// self.suspected_discrepancy_id := L.suspected_discrepancy_id;
self.classification_activity_suspected_discrepancy := L.classification_activity.suspected_discrepancy;
// self.confidence_that_activity_was_deceitful_id := L.confidence_that_activity_was_deceitful_id;
...
EXPORT file_fdn_keys_main_qa := project(key_in,makerecord(left));
