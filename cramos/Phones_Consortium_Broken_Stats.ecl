...
online5 := online4(date_time_added >= '20100101');
...
customer2 := customer1(date_time_added >= '20100101');
...
batch_cust_type := project(ded_customer_type,transform(batch_disp,self.description := map(LEFT.phone_contact_type = '1' => 'Right Party Contact',
                                                         LEFT.phone_contact_type = '2' => 'Relative or Associate',
																 ...
																 self.source := map(LEFT.customerid = '1005590' => 'Asset Acceptance LLC',
																                    LEFT.customerid = '1006993' => 'FMA Alliance',
																					 LEFT.customerid = '1018002' => 'Monarch',
																					 LEFT.customerid = '1006061' => 'Accutrac',
																					 LEFT.customerid = '1017750' => 'First Financial Asset Management',
																					 LEFT.customerid = '1007664' => 'Plaza Associates',
																					 LEFT.customerid = '1429844' => 'Rozlin',
																					 LEFT.customerid = '1005391' => 'Zenith','');
																 ));
																 
batch_disp2 := record
batch_cust_type.source;
batch_cust_type.contact_type;
batch_cust_type.description;
count(group);
end;

batch_tab := table(batch_cust_type,batch_disp2,source,contact_type,description,few);

output(choosen(sort(batch_tab,contact_type),all),named('Batch_Phone_Contact_type_Counts_with_source_info'));
