...
layout_key_Relatives_key_fields := 
	RECORD
		unsigned5 person1;
		boolean same_lname;
		unsigned2 number_cohabits;
...
layout_key_Relatives_nonkey_fields :=
	RECORD
		integer2 prim_range;
...
key_Relatives := INDEX(layout_key_Relatives_key_fields, layout_key_Relatives_nonkey_fields, ut.foreign_prod+ 'thor_data400::key::relatives_qa');
