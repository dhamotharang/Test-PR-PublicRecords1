...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE877679 := __ENH_U_C_C_6;
  ...
  END;
  EXPORT __ST158566_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST158570_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158566_Layout __ND877641__Project(B_U_C_C_6(__in,__cfg).__ST160563_Layout __PP877341) := TRANSFORM
    __EE877682 := __PP877341.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE877682),__ST158570_Layout),__NL(__EE877682));
    __EE877636 := __PP877341.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE877636),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP877341;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE877679,__ND877641__Project(LEFT));
END;
