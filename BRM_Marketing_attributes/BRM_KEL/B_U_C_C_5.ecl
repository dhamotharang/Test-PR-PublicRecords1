...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE869869 := __ENH_U_C_C_6;
  ...
  END;
  EXPORT __ST152786_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST152790_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST152786_Layout __ND869831__Project(B_U_C_C_6(__in,__cfg).__ST154783_Layout __PP869531) := TRANSFORM
    __EE869872 := __PP869531.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE869872),__ST152790_Layout),__NL(__EE869872));
    __EE869826 := __PP869531.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE869826),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP869531;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE869869,__ND869831__Project(LEFT));
END;
