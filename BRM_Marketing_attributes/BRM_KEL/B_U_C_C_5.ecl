...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE883859 := __ENH_U_C_C_6;
  EXPORT __ST169481_Layout := RECORD
  ...
  END;
  EXPORT __ST169477_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST169481_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169477_Layout __ND883821__Project(B_U_C_C_6(__in,__cfg).__ST171474_Layout __PP883521) := TRANSFORM
    __EE883862 := __PP883521.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE883862),__ST169481_Layout),__NL(__EE883862));
    __EE883816 := __PP883521.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE883816),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP883521;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE883859,__ND883821__Project(LEFT));
END;
