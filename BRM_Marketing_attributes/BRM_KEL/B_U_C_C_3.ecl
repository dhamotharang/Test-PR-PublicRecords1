...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1046653 := __ENH_U_C_C_4;
  EXPORT __ST146189_Layout := RECORD
  ...
  END;
  EXPORT __ST146185_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST146189_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146185_Layout __ND1046658__Project(B_U_C_C_4(__in,__cfg).__ST149889_Layout __PP1046654) := TRANSFORM
    __EE1046694 := __PP1046654.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE1046694,__ST146189_Layout);
    SELF := __PP1046654;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE1046653,__ND1046658__Project(LEFT));
END;
