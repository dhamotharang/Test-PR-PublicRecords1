...
IMPORT CFG_Compile,E_Address,E_Business_Org,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Geo_Link,E_Zip_Code FROM BRM_Marketing_attributes.BRM_KEL;
