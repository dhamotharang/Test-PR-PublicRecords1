...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE802138 := __ENH_U_C_C_10;
  EXPORT __ST163708_Layout := RECORD
  ...
  END;
  EXPORT __ST163704_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST163708_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163704_Layout __ND802101__Project(B_U_C_C_10(__in,__cfg).__ST164167_Layout __PP801810) := TRANSFORM
    __EE802141 := __PP801810.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE802141),__ST163708_Layout),__NL(__EE802141));
    __EE802096 := __PP801810.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE802096))[1].R_M_S_I_D_;
    SELF := __PP801810;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE802138,__ND802101__Project(LEFT));
END;
