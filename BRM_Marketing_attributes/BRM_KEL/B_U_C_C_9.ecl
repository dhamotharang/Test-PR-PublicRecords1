...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE808347 := __ENH_U_C_C_10;
  EXPORT __ST174619_Layout := RECORD
  ...
  END;
  EXPORT __ST174615_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST174619_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174615_Layout __ND808310__Project(B_U_C_C_10(__in,__cfg).__ST175078_Layout __PP808019) := TRANSFORM
    __EE808350 := __PP808019.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE808350),__ST174619_Layout),__NL(__EE808350));
    __EE808305 := __PP808019.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE808305))[1].R_M_S_I_D_;
    SELF := __PP808019;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE808347,__ND808310__Project(LEFT));
END;
