...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE794328 := __ENH_U_C_C_10;
  EXPORT __ST157928_Layout := RECORD
  ...
  END;
  EXPORT __ST157924_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST157928_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157924_Layout __ND794291__Project(B_U_C_C_10(__in,__cfg).__ST158387_Layout __PP794000) := TRANSFORM
    __EE794331 := __PP794000.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE794331),__ST157928_Layout),__NL(__EE794331));
    __EE794286 := __PP794000.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE794286))[1].R_M_S_I_D_;
    SELF := __PP794000;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE794328,__ND794291__Project(LEFT));
END;
