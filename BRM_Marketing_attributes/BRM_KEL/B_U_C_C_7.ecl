...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE822658 := __ENH_U_C_C_8;
  EXPORT __ST161875_Layout := RECORD
  ...
  END;
  EXPORT __ST161871_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST161875_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161871_Layout __ND822663__Project(B_U_C_C_8(__in,__cfg).__ST162860_Layout __PP822659) := TRANSFORM
    __EE822698 := __PP822659.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE822698),__ST161875_Layout),__NL(__EE822698));
    SELF := __PP822659;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE822658,__ND822663__Project(LEFT));
END;
