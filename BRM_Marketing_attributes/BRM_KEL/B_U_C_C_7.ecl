...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE814848 := __ENH_U_C_C_8;
  ...
  END;
  EXPORT __ST156091_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST156095_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156091_Layout __ND814853__Project(B_U_C_C_8(__in,__cfg).__ST157080_Layout __PP814849) := TRANSFORM
    __EE814888 := __PP814849.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE814888),__ST156095_Layout),__NL(__EE814888));
    SELF := __PP814849;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE814848,__ND814853__Project(LEFT));
END;
