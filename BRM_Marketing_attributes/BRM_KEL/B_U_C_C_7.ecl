...
IMPORT KEL16 AS KEL;
IMPORT B_U_C_C_10,B_U_C_C_11,B_U_C_C_8,CFG_Compile,E_U_C_C FROM BRM_Marketing_attributes.BRM_KEL;
...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE828867 := __ENH_U_C_C_8;
  EXPORT __ST172786_Layout := RECORD
  ...
  END;
  EXPORT __ST172782_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST172786_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172782_Layout __ND828872__Project(B_U_C_C_8(__in,__cfg).__ST173771_Layout __PP828868) := TRANSFORM
    __EE828907 := __PP828868.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE828907),__ST172786_Layout),__NL(__EE828907));
    SELF := __PP828868;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE828867,__ND828872__Project(LEFT));
END;
