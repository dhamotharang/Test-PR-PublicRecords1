...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE868543 := __ENH_Sele_Person_6;
  EXPORT __ST152250_Layout := RECORD
  ...
  END;
  SHARED __ST152250_Layout __ND868666__Project(B_Sele_Person_6(__in,__cfg).__ST154376_Layout __PP868544) := TRANSFORM
    __CC63128 := 730;
    SELF.Two_Years_ := __OP2(__PP868544.Age_In_Days_,<=,__CN(__CC63128));
    SELF := __PP868544;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE868543,__ND868666__Project(LEFT));
END;
