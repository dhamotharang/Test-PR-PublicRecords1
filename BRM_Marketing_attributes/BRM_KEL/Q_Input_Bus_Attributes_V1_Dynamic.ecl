...
EXPORT Q_Input_Bus_Attributes_V1_Dynamic(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputBII)) __PInputBIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1492158 := __ENH_Input_B_I_I;
  SHARED __ST84302_Layout := RECORD
  ...
  END;
  SHARED __ST84302_Layout __ND1492163__Project(B_Input_B_I_I(__in,__cfg_Local).__ST150210_Layout __PP1492159) := TRANSFORM
    SELF.G___Proc_Bus_U_I_D_ := __PP1492159.UID;
    SELF.B___Inp_Acct_ := __PP1492159.Bus_Input_Account_Echo_Value_;
    SELF.G___Proc_Bus_U_I_D__1_ := __PP1492159.G___Proc_Bus_U_I_D_;
    SELF.B___Lex_I_D_Ult_ := __PP1492159.B___Lex_I_D_Ult_Value_;
    SELF.B___Lex_I_D_Org_ := __PP1492159.B___Lex_I_D_Org_Value_;
    SELF.B___Lex_I_D_Legal_ := __PP1492159.B___Lex_I_D_Legal_Value_;
    SELF.B___Lex_I_D_Site_ := __PP1492159.B___Lex_I_D_Site_Value_;
    SELF.B___Lex_I_D_Loc_ := __PP1492159.B___Lex_I_D_Loc_Value_;
    SELF.B___Lex_I_D_Legal_Score_ := __PP1492159.B___Lex_I_D_Legal_Score_Value_;
    SELF.B___Inp_Cln_Name_ := __PP1492159.Bus_Input_Name_Clean_Value_;
    SELF.B___Inp_Cln_Alt_Name_ := __PP1492159.Bus_Input_Alternate_Name_Clean_Value_;
    SELF.B___Inp_Cln_Addr_City_ := __PP1492159.Bus_Input_City_Clean_Value_;
    SELF.B___Inp_Cln_Addr_State_ := __PP1492159.Bus_Input_State_Clean_Value_;
    SELF.B___Inp_Cln_Addr_Zip5_ := __PP1492159.Bus_Input_Zip5_Clean_Value_;
    SELF.B___Inp_Cln_Addr_Zip4_ := __PP1492159.Bus_Input_Zip4_Clean_Value_;
    SELF.B___Inp_Cln_Addr_St_ := __PP1492159.Bus_Input_Street_Clean_Value_;
    SELF.B___Inp_Cln_Phone_ := __PP1492159.Bus_Input_Phone_Clean_Value_;
    SELF.B___Inp_Cln_T_I_N_ := __PP1492159.Bus_Input_T_I_N_Clean_Value_;
    SELF.B___Inp_Cln_Email_ := __PP1492159.Bus_Input_Email_Clean_Value_;
    SELF := __PP1492159;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE1492158,__ND1492163__Project(LEFT)));
