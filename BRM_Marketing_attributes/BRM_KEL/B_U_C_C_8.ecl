...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE809193 := __ENH_U_C_C_9;
  ...
  END;
  EXPORT __ST157080_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST157084_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157080_Layout __ND809198__Project(B_U_C_C_9(__in,__cfg).__ST157924_Layout __PP809194) := TRANSFORM
    __EE809233 := __PP809194.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE809233),__ST157084_Layout),__NL(__EE809233));
    SELF := __PP809194;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE809193,__ND809198__Project(LEFT));
END;
