...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1215871 := __ENH_Sele_Address_3;
  EXPORT __ST146925_Layout := RECORD
  ...
  END;
  EXPORT __ST146869_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST146925_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146869_Layout __ND1215876__Project(B_Sele_Address_3(__in,__cfg).__ST151271_Layout __PP1215872) := TRANSFORM
    __EE1215965 := __PP1215872.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1215965),__ST146925_Layout),__NL(__EE1215965));
    SELF := __PP1215872;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE1215871,__ND1215876__Project(LEFT));
END;
