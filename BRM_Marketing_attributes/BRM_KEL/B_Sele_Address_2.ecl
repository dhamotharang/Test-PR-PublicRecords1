...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1208061 := __ENH_Sele_Address_3;
  EXPORT __ST141145_Layout := RECORD
  ...
  END;
  EXPORT __ST141089_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST141145_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST141089_Layout __ND1208066__Project(B_Sele_Address_3(__in,__cfg).__ST145491_Layout __PP1208062) := TRANSFORM
    __EE1208155 := __PP1208062.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1208155),__ST141145_Layout),__NL(__EE1208155));
    SELF := __PP1208062;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE1208061,__ND1208066__Project(LEFT));
END;
