...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1057113 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST162405_Layout := RECORD
  ...
  END;
  EXPORT __ST162367_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST162405_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162367_Layout __ND1057118__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST166020_Layout __PP1057114) := TRANSFORM
    __EE1057166 := __PP1057114.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE1057166,__ST162405_Layout);
    SELF := __PP1057114;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE1057113,__ND1057118__Project(LEFT));
END;
