...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1052786 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST151454_Layout := RECORD
  ...
  END;
  EXPORT __ST151416_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST151454_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151416_Layout __ND1052791__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST155087_Layout __PP1052787) := TRANSFORM
    __EE1052839 := __PP1052787.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE1052839,__ST151454_Layout);
    SELF := __PP1052787;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE1052786,__ND1052791__Project(LEFT));
END;
