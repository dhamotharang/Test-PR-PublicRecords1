...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE882725 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST169041_Layout := RECORD
  ...
  END;
  EXPORT __ST169003_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST169041_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169003_Layout __ND882730__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST171128_Layout __PP882726) := TRANSFORM
    __EE882779 := __PP882726.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE882779),__ST169041_Layout),__NL(__EE882779));
    SELF := __PP882726;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE882725,__ND882730__Project(LEFT));
END;
