...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE906926 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST166058_Layout := RECORD
  ...
  END;
  EXPORT __ST166020_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST166058_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166020_Layout __ND906931__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST169003_Layout __PP906927) := TRANSFORM
    __EE906980 := __PP906927.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE906980),__ST166058_Layout),__NL(__EE906980));
    SELF := __PP906927;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE906926,__ND906931__Project(LEFT));
END;
