...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE893034 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST149345_Layout := RECORD
  ...
  END;
  EXPORT __ST149307_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST149345_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST149307_Layout __ND893039__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST152312_Layout __PP893035) := TRANSFORM
    __EE893088 := __PP893035.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE893088),__ST149345_Layout),__NL(__EE893088));
    SELF := __PP893035;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE893034,__ND893039__Project(LEFT));
END;
