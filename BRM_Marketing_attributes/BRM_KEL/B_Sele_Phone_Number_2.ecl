...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1216324 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST147046_Layout := RECORD
  ...
  END;
  EXPORT __ST147008_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST147046_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST147008_Layout __ND1216329__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST151416_Layout __PP1216325) := TRANSFORM
    __EE1216377 := __PP1216325.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1216377),__ST147046_Layout),__NL(__EE1216377));
    SELF := __PP1216325;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE1216324,__ND1216329__Project(LEFT));
END;
