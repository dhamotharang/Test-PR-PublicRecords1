...
EXPORT B_Sele_Person_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE835236 := __ENH_Sele_Person_7;
  EXPORT __ST154376_Layout := RECORD
  ...
  END;
  SHARED __ST154376_Layout __ND835241__Project(B_Sele_Person_7(__in,__cfg).__ST155875_Layout __PP835237) := TRANSFORM
    ...
    SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP835237.Assoc_Date_),__ECAST(KEL.typ.nkdate,__CC13398));
    SELF := __PP835237;
  END;
  EXPORT __ENH_Sele_Person_6 := PROJECT(__EE835236,__ND835241__Project(LEFT));
END;
