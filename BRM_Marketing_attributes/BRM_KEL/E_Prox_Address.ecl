...
IMPORT CFG_Compile,E_Address,E_Business_Org,E_Business_Prox,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Geo_Link,E_Zip_Code FROM BRM_Marketing_attributes.BRM_KEL;
...
EXPORT E_Prox_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d15_KELfiltered := __d15_Norm((STRING28)prim_name != '' AND (UNSIGNED3)z5 != 0 AND (UNSIGNED)proxid<>0);
  SHARED __d15_Business_Location__Layout := RECORD
    RECORDOF(__d15_KELfiltered);
    KEL.typ.uid Business_Location_;
  END;
  SHARED __d15_Missing_Business_Location__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d15_KELfiltered,'ultid,orgid,seleid,proxid','__in');
  SHARED __d15_Business_Location__Mapped := IF(__d15_Missing_Business_Location__UIDComponents = 'ultid,orgid,seleid,proxid',PROJECT(__d15_KELfiltered,TRANSFORM(__d15_Business_Location__Layout,SELF.Business_Location_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d15_KELfiltered,__d15_Missing_Business_Location__UIDComponents),E_Business_Prox(__in,__cfg).Lookup,TRIM((STRING)LEFT.ultid) + '|' + TRIM((STRING)LEFT.orgid) + '|' + TRIM((STRING)LEFT.seleid) + '|' + TRIM((STRING)LEFT.proxid) = RIGHT.KeyVal,TRANSFORM(__d15_Business_Location__Layout,SELF.Business_Location_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  SHARED __d15_Location__Layout := RECORD
    RECORDOF(__d15_Business_Location__Mapped);
    KEL.typ.uid Location_;
  END;
  SHARED __d15_Missing_Location__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d15_Business_Location__Mapped,'prim_range,predir,prim_name,suffix,postdir,z5,sec_range','__in');
  SHARED __d15_Location__Mapped := IF(__d15_Missing_Location__UIDComponents = 'prim_range,predir,prim_name,suffix,postdir,z5,sec_range',PROJECT(__d15_Business_Location__Mapped,TRANSFORM(__d15_Location__Layout,SELF.Location_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d15_Business_Location__Mapped,__d15_Missing_Location__UIDComponents),E_Address(__in,__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.z5) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d15_Location__Layout,SELF.Location_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BusinessLocation',COUNT(__d15(__NL(Business_Location_))),COUNT(__d15(__NN(Business_Location_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Location',COUNT(__d15(__NL(Location_))),COUNT(__d15(__NN(Location_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d15(__NL(Rec_Type_))),COUNT(__d15(__NN(Rec_Type_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','suffix',COUNT(__d15(__NL(Suffix_))),COUNT(__d15(__NN(Suffix_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','unit_desig',COUNT(__d15(__NL(Unit_Designation_))),COUNT(__d15(__NN(Unit_Designation_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','p_city_name',COUNT(__d15(__NL(Postal_City_))),COUNT(__d15(__NN(Postal_City_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','v_city_name',COUNT(__d15(__NL(Vanity_City_))),COUNT(__d15(__NN(Vanity_City_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','st',COUNT(__d15(__NL(State_))),COUNT(__d15(__NN(State_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','z5',COUNT(__d15(__NL(Z_I_P5_))),COUNT(__d15(__NN(Z_I_P5_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','z4',COUNT(__d15(__NL(Z_I_P4_))),COUNT(__d15(__NN(Z_I_P4_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','MetropolitanStatisticalArea',COUNT(__d15(__NL(Metropolitan_Statistical_Area_))),COUNT(__d15(__NN(Metropolitan_Statistical_Area_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestPrimaryRange',COUNT(__d15(__NL(Best_Primary_Range_))),COUNT(__d15(__NN(Best_Primary_Range_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestPredirectional',COUNT(__d15(__NL(Best_Predirectional_))),COUNT(__d15(__NN(Best_Predirectional_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestPrimaryName',COUNT(__d15(__NL(Best_Primary_Name_))),COUNT(__d15(__NN(Best_Primary_Name_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestSuffix',COUNT(__d15(__NL(Best_Suffix_))),COUNT(__d15(__NN(Best_Suffix_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestPostdirectional',COUNT(__d15(__NL(Best_Postdirectional_))),COUNT(__d15(__NN(Best_Postdirectional_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestUnitDesignation',COUNT(__d15(__NL(Best_Unit_Designation_))),COUNT(__d15(__NN(Best_Unit_Designation_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestSecondaryRange',COUNT(__d15(__NL(Best_Secondary_Range_))),COUNT(__d15(__NN(Best_Secondary_Range_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestPostalCity',COUNT(__d15(__NL(Best_Postal_City_))),COUNT(__d15(__NN(Best_Postal_City_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestVanityCity',COUNT(__d15(__NL(Best_Vanity_City_))),COUNT(__d15(__NN(Best_Vanity_City_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestState',COUNT(__d15(__NL(Best_State_))),COUNT(__d15(__NN(Best_State_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestZip5',COUNT(__d15(__NL(Best_Zip5_))),COUNT(__d15(__NN(Best_Zip5_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestZip4',COUNT(__d15(__NL(Best_Zip4_))),COUNT(__d15(__NN(Best_Zip4_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BestAddressRank',COUNT(__d15(__NL(Best_Address_Rank_))),COUNT(__d15(__NN(Best_Address_Rank_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','CompanyAddressTypeRaw',COUNT(__d15(__NL(Company_Address_Type_Raw_))),COUNT(__d15(__NN(Company_Address_Type_Raw_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','CompanyAddressTypeDerived',COUNT(__d15(__NL(Company_Address_Type_Derived_))),COUNT(__d15(__NN(Company_Address_Type_Derived_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressTypeDerived',COUNT(__d15(__NL(Address_Type_Derived_))),COUNT(__d15(__NN(Address_Type_Derived_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','HeaderHitFlag',COUNT(__d15(__NL(Header_Hit_Flag_))),COUNT(__d15(__NN(Header_Hit_Flag_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','src',COUNT(__d15(__NL(Source_))),COUNT(__d15(__NN(Source_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Archive_Date',COUNT(__d15(Archive___Date_=0)),COUNT(__d15(Archive___Date_!=0))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','HybridArchiveDate',COUNT(__d15(Hybrid_Archive_Date_=0)),COUNT(__d15(Hybrid_Archive_Date_!=0))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateLastSeen',COUNT(__d15(Vault_Date_Last_Seen_=0)),COUNT(__d15(Vault_Date_Last_Seen_!=0))}]
