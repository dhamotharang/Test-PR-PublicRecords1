...
IMPORT KEL16 AS KEL;
IMPORT B_U_C_C_10,B_U_C_C_11,B_U_C_C_5,CFG_Compile,E_U_C_C FROM BRM_Marketing_attributes.BRM_KEL;
...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE911582 := __ENH_U_C_C_5;
  EXPORT __ST166606_Layout := RECORD
  ...
  END;
  EXPORT __ST166602_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST166606_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166602_Layout __ND911816__Project(B_U_C_C_5(__in,__cfg).__ST169477_Layout __PP911583) := TRANSFORM
    __EE911623 := __PP911583.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE911623),__ST166606_Layout),__NL(__EE911623));
    SELF.Terminated_Filing_ := __OP2(__PP911583.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP911583;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE911582,__ND911816__Project(LEFT));
END;
