...
#workunit('name','HealthcareNoMatchHeader_ExternalLinking.BWR_Scrubs - Checking field validity in a file - SALT V3.11.7');
IMPORT HealthcareNoMatchHeader_ExternalLinking,SALT311;
infile := HealthcareNoMatchHeader_ExternalLinking.File_HEADER;
mod_scrubs := HealthcareNoMatchHeader_ExternalLinking.Scrubs;
