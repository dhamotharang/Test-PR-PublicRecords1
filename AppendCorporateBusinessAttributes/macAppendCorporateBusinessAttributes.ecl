...
EXPORT macAppendCorporateBusinessAttributes(dIn, InUltId, InOrgId, InSeleId, InProxId, InState,
  ...
  LOCAL dBipCorpProx := hipie_ecl.macJoinKey(dDeduped, Corp2.Key_LinkIDs.Corp.Key,
  ...
  LOCAL dBipCorpSele := hipie_ecl.macJoinKey(dSeleDeduped, Corp2.Key_LinkIDs.Corp.Key,
