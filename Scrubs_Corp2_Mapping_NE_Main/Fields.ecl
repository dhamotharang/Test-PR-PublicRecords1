...
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_foreign_domestic_ind','invalid_numeric','invalid_alphablank','invalid_st_country','invalid_status_cd','invalid_org_type_cd','invalid_name_type_code','invalid_recordorigin','invalid_flag_code','invalid_trademark_class','invalid_farm_exemptions');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_foreign_domestic_ind' => 8,'invalid_numeric' => 9,'invalid_alphablank' => 10,'invalid_st_country' => 11,'invalid_status_cd' => 12,'invalid_org_type_cd' => 13,'invalid_name_type_code' => 14,'invalid_recordorigin' => 15,'invalid_flag_code' => 16,'invalid_trademark_class' => 17,'invalid_farm_exemptions' => 18,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['31']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('31'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['NE']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('NE'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_st_country(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_st_country(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_st_country(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['A','I','S',' ']);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('A|I|S| '),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_type_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_type_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN Scrubs_Corp2_Mapping_NE_Main.Functions.set_valid_org_cd);
EXPORT InValidMessageFT_invalid_org_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_NE_Main.Functions.set_valid_org_cd'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT35.StrType s,SALT35.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_NE_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NE_Main.Functions.invalid_name_type_code'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_flag_code(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['N',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('N| '),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_trademark_class(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' &()-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_trademark_class(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' &()-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_trademark_class(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' &()-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_farm_exemptions(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' /-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_farm_exemptions(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' /-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_farm_exemptions(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' /-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
...
EXPORT Make_corp_term_exist_desc(SALT35.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_term_exist_desc(SALT35.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_corp_forgn_state_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_state_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_state_desc(SALT35.StrType s0) := MakeFT_invalid_st_country(s0);
EXPORT InValid_corp_forgn_state_desc(SALT35.StrType s) := InValidFT_invalid_st_country(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT35.StrType s0) := MakeFT_invalid_org_type_cd(s0);
EXPORT InValid_corp_orig_org_structure_cd(SALT35.StrType s) := InValidFT_invalid_org_type_cd(s);
...
EXPORT Make_corp_country_of_formation(SALT35.StrType s0) := MakeFT_invalid_st_country(s0);
EXPORT InValid_corp_country_of_formation(SALT35.StrType s) := InValidFT_invalid_st_country(s);
...
EXPORT Make_corp_farm_exemptions(SALT35.StrType s0) := MakeFT_invalid_farm_exemptions(s0);
EXPORT InValid_corp_farm_exemptions(SALT35.StrType s) := InValidFT_invalid_farm_exemptions(s);
EXPORT InValidMessage_corp_farm_exemptions(UNSIGNED1 wh) := InValidMessageFT_invalid_farm_exemptions(wh);
...
EXPORT Make_corp_trademark_class_desc1(SALT35.StrType s0) := MakeFT_invalid_trademark_class(s0);
EXPORT InValid_corp_trademark_class_desc1(SALT35.StrType s) := InValidFT_invalid_trademark_class(s);
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := InValidMessageFT_invalid_trademark_class(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT35,Scrubs_Corp2_Mapping_NE_Main;
