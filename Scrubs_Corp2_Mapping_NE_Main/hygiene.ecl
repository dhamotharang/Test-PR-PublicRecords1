...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_corp_supp_key := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_supp_key)));
    avelength_corp_supp_key := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_supp_key)),h.corp_supp_key<>(typeof(h.corp_supp_key))'');
    ...
    maxlength_corp_supp_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_supp_nbr)));
    avelength_corp_supp_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_supp_nbr)),h.corp_supp_nbr<>(typeof(h.corp_supp_nbr))'');
    ...
    maxlength_corp_name_comment := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_comment)));
    avelength_corp_name_comment := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_comment)),h.corp_name_comment<>(typeof(h.corp_name_comment))'');
    ...
    maxlength_corp_address1_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_type_cd)));
    avelength_corp_address1_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_type_cd)),h.corp_address1_type_cd<>(typeof(h.corp_address1_type_cd))'');
    ...
    maxlength_corp_address1_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_type_desc)));
    avelength_corp_address1_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_type_desc)),h.corp_address1_type_desc<>(typeof(h.corp_address1_type_desc))'');
    ...
    maxlength_corp_address1_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line1)));
    avelength_corp_address1_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line1)),h.corp_address1_line1<>(typeof(h.corp_address1_line1))'');
    ...
    maxlength_corp_address1_line2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line2)));
    avelength_corp_address1_line2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line2)),h.corp_address1_line2<>(typeof(h.corp_address1_line2))'');
    ...
    maxlength_corp_address1_line3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line3)));
    avelength_corp_address1_line3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_line3)),h.corp_address1_line3<>(typeof(h.corp_address1_line3))'');
    ...
    maxlength_corp_address1_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_effective_date)));
    avelength_corp_address1_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address1_effective_date)),h.corp_address1_effective_date<>(typeof(h.corp_address1_effective_date))'');
    ...
    maxlength_corp_address2_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_type_cd)));
    avelength_corp_address2_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_type_cd)),h.corp_address2_type_cd<>(typeof(h.corp_address2_type_cd))'');
    ...
    maxlength_corp_address2_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_type_desc)));
    avelength_corp_address2_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_type_desc)),h.corp_address2_type_desc<>(typeof(h.corp_address2_type_desc))'');
    ...
    maxlength_corp_address2_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line1)));
    avelength_corp_address2_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line1)),h.corp_address2_line1<>(typeof(h.corp_address2_line1))'');
    ...
    maxlength_corp_address2_line2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line2)));
    avelength_corp_address2_line2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line2)),h.corp_address2_line2<>(typeof(h.corp_address2_line2))'');
    ...
    maxlength_corp_address2_line3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line3)));
    avelength_corp_address2_line3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_line3)),h.corp_address2_line3<>(typeof(h.corp_address2_line3))'');
    ...
    maxlength_corp_address2_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_effective_date)));
    avelength_corp_address2_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address2_effective_date)),h.corp_address2_effective_date<>(typeof(h.corp_address2_effective_date))'');
    ...
    maxlength_corp_phone_number := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number)));
    avelength_corp_phone_number := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number)),h.corp_phone_number<>(typeof(h.corp_phone_number))'');
    ...
    maxlength_corp_phone_number_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number_type_cd)));
    avelength_corp_phone_number_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number_type_cd)),h.corp_phone_number_type_cd<>(typeof(h.corp_phone_number_type_cd))'');
    ...
    maxlength_corp_phone_number_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number_type_desc)));
    avelength_corp_phone_number_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_phone_number_type_desc)),h.corp_phone_number_type_desc<>(typeof(h.corp_phone_number_type_desc))'');
    ...
    maxlength_corp_fax_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fax_nbr)));
    avelength_corp_fax_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fax_nbr)),h.corp_fax_nbr<>(typeof(h.corp_fax_nbr))'');
    ...
    maxlength_corp_email_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_email_address)));
    avelength_corp_email_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_email_address)),h.corp_email_address<>(typeof(h.corp_email_address))'');
    ...
    maxlength_corp_web_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_web_address)));
    avelength_corp_web_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_web_address)),h.corp_web_address<>(typeof(h.corp_web_address))'');
    ...
    maxlength_corp_filing_reference_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_reference_nbr)));
    avelength_corp_filing_reference_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_reference_nbr)),h.corp_filing_reference_nbr<>(typeof(h.corp_filing_reference_nbr))'');
    ...
    maxlength_corp_filing_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_cd)));
    avelength_corp_filing_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_cd)),h.corp_filing_cd<>(typeof(h.corp_filing_cd))'');
    ...
    maxlength_corp_filing_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_desc)));
    avelength_corp_filing_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_filing_desc)),h.corp_filing_desc<>(typeof(h.corp_filing_desc))'');
    ...
    maxlength_corp_status_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_status_cd)));
    avelength_corp_status_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_status_cd)),h.corp_status_cd<>(typeof(h.corp_status_cd))'');
    ...
    maxlength_corp_standing := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_standing)));
    avelength_corp_standing := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_standing)),h.corp_standing<>(typeof(h.corp_standing))'');
    ...
    maxlength_corp_status_comment := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_status_comment)));
    avelength_corp_status_comment := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_status_comment)),h.corp_status_comment<>(typeof(h.corp_status_comment))'');
    ...
    maxlength_corp_ticker_symbol := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ticker_symbol)));
    avelength_corp_ticker_symbol := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ticker_symbol)),h.corp_ticker_symbol<>(typeof(h.corp_ticker_symbol))'');
    ...
    maxlength_corp_stock_exchange := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_stock_exchange)));
    avelength_corp_stock_exchange := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_stock_exchange)),h.corp_stock_exchange<>(typeof(h.corp_stock_exchange))'');
    ...
    maxlength_corp_inc_county := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_inc_county)));
    avelength_corp_inc_county := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_inc_county)),h.corp_inc_county<>(typeof(h.corp_inc_county))'');
    ...
    maxlength_corp_anniversary_month := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_anniversary_month)));
    avelength_corp_anniversary_month := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_anniversary_month)),h.corp_anniversary_month<>(typeof(h.corp_anniversary_month))'');
    ...
    maxlength_corp_fed_tax_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fed_tax_id)));
    avelength_corp_fed_tax_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fed_tax_id)),h.corp_fed_tax_id<>(typeof(h.corp_fed_tax_id))'');
    ...
    maxlength_corp_state_tax_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_state_tax_id)));
    avelength_corp_state_tax_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_state_tax_id)),h.corp_state_tax_id<>(typeof(h.corp_state_tax_id))'');
    ...
    maxlength_corp_term_exist_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_term_exist_cd)));
    avelength_corp_term_exist_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_term_exist_cd)),h.corp_term_exist_cd<>(typeof(h.corp_term_exist_cd))'');
    ...
    maxlength_corp_term_exist_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_term_exist_desc)));
    avelength_corp_term_exist_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_term_exist_desc)),h.corp_term_exist_desc<>(typeof(h.corp_term_exist_desc))'');
    ...
    maxlength_corp_forgn_state_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_state_cd)));
    avelength_corp_forgn_state_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_state_cd)),h.corp_forgn_state_cd<>(typeof(h.corp_forgn_state_cd))'');
    ...
    maxlength_corp_forgn_sos_charter_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_sos_charter_nbr)));
    avelength_corp_forgn_sos_charter_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_sos_charter_nbr)),h.corp_forgn_sos_charter_nbr<>(typeof(h.corp_forgn_sos_charter_nbr))'');
    ...
    maxlength_corp_forgn_fed_tax_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_fed_tax_id)));
    avelength_corp_forgn_fed_tax_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_fed_tax_id)),h.corp_forgn_fed_tax_id<>(typeof(h.corp_forgn_fed_tax_id))'');
    ...
    maxlength_corp_forgn_state_tax_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_state_tax_id)));
    avelength_corp_forgn_state_tax_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_state_tax_id)),h.corp_forgn_state_tax_id<>(typeof(h.corp_forgn_state_tax_id))'');
    ...
    maxlength_corp_forgn_term_exist_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_cd)));
    avelength_corp_forgn_term_exist_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_cd)),h.corp_forgn_term_exist_cd<>(typeof(h.corp_forgn_term_exist_cd))'');
    ...
    maxlength_corp_forgn_term_exist_exp := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_exp)));
    avelength_corp_forgn_term_exist_exp := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_exp)),h.corp_forgn_term_exist_exp<>(typeof(h.corp_forgn_term_exist_exp))'');
    ...
    maxlength_corp_forgn_term_exist_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_desc)));
    avelength_corp_forgn_term_exist_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_forgn_term_exist_desc)),h.corp_forgn_term_exist_desc<>(typeof(h.corp_forgn_term_exist_desc))'');
    ...
    maxlength_corp_public_or_private_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_public_or_private_ind)));
    avelength_corp_public_or_private_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_public_or_private_ind)),h.corp_public_or_private_ind<>(typeof(h.corp_public_or_private_ind))'');
    ...
    maxlength_corp_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_sic_code)));
    avelength_corp_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_sic_code)),h.corp_sic_code<>(typeof(h.corp_sic_code))'');
    ...
    maxlength_corp_naic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_naic_code)));
    avelength_corp_naic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_naic_code)),h.corp_naic_code<>(typeof(h.corp_naic_code))'');
    ...
    maxlength_corp_orig_bus_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_orig_bus_type_cd)));
    avelength_corp_orig_bus_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_orig_bus_type_cd)),h.corp_orig_bus_type_cd<>(typeof(h.corp_orig_bus_type_cd))'');
    ...
    maxlength_corp_orig_bus_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_orig_bus_type_desc)));
    avelength_corp_orig_bus_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_orig_bus_type_desc)),h.corp_orig_bus_type_desc<>(typeof(h.corp_orig_bus_type_desc))'');
    ...
    maxlength_corp_entity_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_entity_desc)));
    avelength_corp_entity_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_entity_desc)),h.corp_entity_desc<>(typeof(h.corp_entity_desc))'');
    ...
    maxlength_corp_certificate_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_certificate_nbr)));
    avelength_corp_certificate_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_certificate_nbr)),h.corp_certificate_nbr<>(typeof(h.corp_certificate_nbr))'');
    ...
    maxlength_corp_internal_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_internal_nbr)));
    avelength_corp_internal_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_internal_nbr)),h.corp_internal_nbr<>(typeof(h.corp_internal_nbr))'');
    ...
    maxlength_corp_previous_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_previous_nbr)));
    avelength_corp_previous_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_previous_nbr)),h.corp_previous_nbr<>(typeof(h.corp_previous_nbr))'');
    ...
    maxlength_corp_microfilm_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_microfilm_nbr)));
    avelength_corp_microfilm_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_microfilm_nbr)),h.corp_microfilm_nbr<>(typeof(h.corp_microfilm_nbr))'');
    ...
    maxlength_corp_amendments_filed := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_amendments_filed)));
    avelength_corp_amendments_filed := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_amendments_filed)),h.corp_amendments_filed<>(typeof(h.corp_amendments_filed))'');
    ...
    maxlength_corp_acts := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts)));
    avelength_corp_acts := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts)),h.corp_acts<>(typeof(h.corp_acts))'');
    ...
    maxlength_corp_partnership_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partnership_ind)));
    avelength_corp_partnership_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partnership_ind)),h.corp_partnership_ind<>(typeof(h.corp_partnership_ind))'');
    ...
    maxlength_corp_mfg_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_mfg_ind)));
    avelength_corp_mfg_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_mfg_ind)),h.corp_mfg_ind<>(typeof(h.corp_mfg_ind))'');
    ...
    maxlength_corp_addl_info := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_addl_info)));
    avelength_corp_addl_info := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_addl_info)),h.corp_addl_info<>(typeof(h.corp_addl_info))'');
    ...
    maxlength_corp_taxes := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_taxes)));
    avelength_corp_taxes := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_taxes)),h.corp_taxes<>(typeof(h.corp_taxes))'');
    ...
    maxlength_corp_franchise_taxes := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_franchise_taxes)));
    avelength_corp_franchise_taxes := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_franchise_taxes)),h.corp_franchise_taxes<>(typeof(h.corp_franchise_taxes))'');
    ...
    maxlength_corp_tax_program_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_program_cd)));
    avelength_corp_tax_program_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_program_cd)),h.corp_tax_program_cd<>(typeof(h.corp_tax_program_cd))'');
    ...
    maxlength_corp_tax_program_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_program_desc)));
    avelength_corp_tax_program_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_program_desc)),h.corp_tax_program_desc<>(typeof(h.corp_tax_program_desc))'');
    ...
    maxlength_corp_ra_full_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_full_name)));
    avelength_corp_ra_full_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_full_name)),h.corp_ra_full_name<>(typeof(h.corp_ra_full_name))'');
    ...
    maxlength_corp_ra_fname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fname)));
    avelength_corp_ra_fname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fname)),h.corp_ra_fname<>(typeof(h.corp_ra_fname))'');
    ...
    maxlength_corp_ra_mname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_mname)));
    avelength_corp_ra_mname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_mname)),h.corp_ra_mname<>(typeof(h.corp_ra_mname))'');
    ...
    maxlength_corp_ra_lname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_lname)));
    avelength_corp_ra_lname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_lname)),h.corp_ra_lname<>(typeof(h.corp_ra_lname))'');
    ...
    maxlength_corp_ra_suffix := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_suffix)));
    avelength_corp_ra_suffix := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_suffix)),h.corp_ra_suffix<>(typeof(h.corp_ra_suffix))'');
    ...
    maxlength_corp_ra_title_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_title_cd)));
    avelength_corp_ra_title_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_title_cd)),h.corp_ra_title_cd<>(typeof(h.corp_ra_title_cd))'');
    ...
    maxlength_corp_ra_title_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_title_desc)));
    avelength_corp_ra_title_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_title_desc)),h.corp_ra_title_desc<>(typeof(h.corp_ra_title_desc))'');
    ...
    maxlength_corp_ra_fein := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fein)));
    avelength_corp_ra_fein := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fein)),h.corp_ra_fein<>(typeof(h.corp_ra_fein))'');
    ...
    maxlength_corp_ra_ssn := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_ssn)));
    avelength_corp_ra_ssn := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_ssn)),h.corp_ra_ssn<>(typeof(h.corp_ra_ssn))'');
    ...
    maxlength_corp_ra_dob := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_dob)));
    avelength_corp_ra_dob := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_dob)),h.corp_ra_dob<>(typeof(h.corp_ra_dob))'');
    ...
    maxlength_corp_ra_no_comp := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_no_comp)));
    avelength_corp_ra_no_comp := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_no_comp)),h.corp_ra_no_comp<>(typeof(h.corp_ra_no_comp))'');
    ...
    maxlength_corp_ra_no_comp_igs := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_no_comp_igs)));
    avelength_corp_ra_no_comp_igs := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_no_comp_igs)),h.corp_ra_no_comp_igs<>(typeof(h.corp_ra_no_comp_igs))'');
    ...
    maxlength_corp_ra_addl_info := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_addl_info)));
    avelength_corp_ra_addl_info := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_addl_info)),h.corp_ra_addl_info<>(typeof(h.corp_ra_addl_info))'');
    ...
    maxlength_corp_ra_address_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_type_cd)));
    avelength_corp_ra_address_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_type_cd)),h.corp_ra_address_type_cd<>(typeof(h.corp_ra_address_type_cd))'');
    ...
    maxlength_corp_ra_address_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_type_desc)));
    avelength_corp_ra_address_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_type_desc)),h.corp_ra_address_type_desc<>(typeof(h.corp_ra_address_type_desc))'');
    ...
    maxlength_corp_ra_address_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line1)));
    avelength_corp_ra_address_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line1)),h.corp_ra_address_line1<>(typeof(h.corp_ra_address_line1))'');
    ...
    maxlength_corp_ra_address_line2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line2)));
    avelength_corp_ra_address_line2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line2)),h.corp_ra_address_line2<>(typeof(h.corp_ra_address_line2))'');
    ...
    maxlength_corp_ra_address_line3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line3)));
    avelength_corp_ra_address_line3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_address_line3)),h.corp_ra_address_line3<>(typeof(h.corp_ra_address_line3))'');
    ...
    maxlength_corp_ra_phone_number := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number)));
    avelength_corp_ra_phone_number := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number)),h.corp_ra_phone_number<>(typeof(h.corp_ra_phone_number))'');
    ...
    maxlength_corp_ra_phone_number_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number_type_cd)));
    avelength_corp_ra_phone_number_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number_type_cd)),h.corp_ra_phone_number_type_cd<>(typeof(h.corp_ra_phone_number_type_cd))'');
    ...
    maxlength_corp_ra_phone_number_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number_type_desc)));
    avelength_corp_ra_phone_number_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_phone_number_type_desc)),h.corp_ra_phone_number_type_desc<>(typeof(h.corp_ra_phone_number_type_desc))'');
    ...
    maxlength_corp_ra_fax_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fax_nbr)));
    avelength_corp_ra_fax_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_fax_nbr)),h.corp_ra_fax_nbr<>(typeof(h.corp_ra_fax_nbr))'');
    ...
    maxlength_corp_ra_email_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_email_address)));
    avelength_corp_ra_email_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_email_address)),h.corp_ra_email_address<>(typeof(h.corp_ra_email_address))'');
    ...
    maxlength_corp_ra_web_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_web_address)));
    avelength_corp_ra_web_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_web_address)),h.corp_ra_web_address<>(typeof(h.corp_ra_web_address))'');
    ...
    maxlength_corp_prep_addr1_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr1_line1)));
    avelength_corp_prep_addr1_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr1_line1)),h.corp_prep_addr1_line1<>(typeof(h.corp_prep_addr1_line1))'');
    ...
    maxlength_corp_prep_addr1_last_line := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr1_last_line)));
    avelength_corp_prep_addr1_last_line := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr1_last_line)),h.corp_prep_addr1_last_line<>(typeof(h.corp_prep_addr1_last_line))'');
    ...
    maxlength_corp_prep_addr2_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr2_line1)));
    avelength_corp_prep_addr2_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr2_line1)),h.corp_prep_addr2_line1<>(typeof(h.corp_prep_addr2_line1))'');
    ...
    maxlength_corp_prep_addr2_last_line := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr2_last_line)));
    avelength_corp_prep_addr2_last_line := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_prep_addr2_last_line)),h.corp_prep_addr2_last_line<>(typeof(h.corp_prep_addr2_last_line))'');
    ...
    maxlength_ra_prep_addr_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ra_prep_addr_line1)));
    avelength_ra_prep_addr_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ra_prep_addr_line1)),h.ra_prep_addr_line1<>(typeof(h.ra_prep_addr_line1))'');
    ...
    maxlength_ra_prep_addr_last_line := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ra_prep_addr_last_line)));
    avelength_ra_prep_addr_last_line := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ra_prep_addr_last_line)),h.ra_prep_addr_last_line<>(typeof(h.ra_prep_addr_last_line))'');
    ...
    maxlength_cont_filing_reference_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_reference_nbr)));
    avelength_cont_filing_reference_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_reference_nbr)),h.cont_filing_reference_nbr<>(typeof(h.cont_filing_reference_nbr))'');
    ...
    maxlength_cont_filing_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_date)));
    avelength_cont_filing_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_date)),h.cont_filing_date<>(typeof(h.cont_filing_date))'');
    ...
    maxlength_cont_filing_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_cd)));
    avelength_cont_filing_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_cd)),h.cont_filing_cd<>(typeof(h.cont_filing_cd))'');
    ...
    maxlength_cont_filing_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_desc)));
    avelength_cont_filing_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_filing_desc)),h.cont_filing_desc<>(typeof(h.cont_filing_desc))'');
    ...
    maxlength_cont_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_type_cd)));
    avelength_cont_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_type_cd)),h.cont_type_cd<>(typeof(h.cont_type_cd))'');
    ...
    maxlength_cont_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_type_desc)));
    avelength_cont_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_type_desc)),h.cont_type_desc<>(typeof(h.cont_type_desc))'');
    ...
    maxlength_cont_full_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_full_name)));
    avelength_cont_full_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_full_name)),h.cont_full_name<>(typeof(h.cont_full_name))'');
    ...
    maxlength_cont_fname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fname)));
    avelength_cont_fname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fname)),h.cont_fname<>(typeof(h.cont_fname))'');
    ...
    maxlength_cont_mname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_mname)));
    avelength_cont_mname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_mname)),h.cont_mname<>(typeof(h.cont_mname))'');
    ...
    maxlength_cont_lname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_lname)));
    avelength_cont_lname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_lname)),h.cont_lname<>(typeof(h.cont_lname))'');
    ...
    maxlength_cont_suffix := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_suffix)));
    avelength_cont_suffix := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_suffix)),h.cont_suffix<>(typeof(h.cont_suffix))'');
    ...
    maxlength_cont_title2_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title2_desc)));
    avelength_cont_title2_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title2_desc)),h.cont_title2_desc<>(typeof(h.cont_title2_desc))'');
    ...
    maxlength_cont_title3_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title3_desc)));
    avelength_cont_title3_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title3_desc)),h.cont_title3_desc<>(typeof(h.cont_title3_desc))'');
    ...
    maxlength_cont_title4_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title4_desc)));
    avelength_cont_title4_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title4_desc)),h.cont_title4_desc<>(typeof(h.cont_title4_desc))'');
    ...
    maxlength_cont_title5_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title5_desc)));
    avelength_cont_title5_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_title5_desc)),h.cont_title5_desc<>(typeof(h.cont_title5_desc))'');
    ...
    maxlength_cont_fein := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fein)));
    avelength_cont_fein := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fein)),h.cont_fein<>(typeof(h.cont_fein))'');
    ...
    maxlength_cont_ssn := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_ssn)));
    avelength_cont_ssn := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_ssn)),h.cont_ssn<>(typeof(h.cont_ssn))'');
    ...
    maxlength_cont_dob := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_dob)));
    avelength_cont_dob := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_dob)),h.cont_dob<>(typeof(h.cont_dob))'');
    ...
    maxlength_cont_status_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_status_cd)));
    avelength_cont_status_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_status_cd)),h.cont_status_cd<>(typeof(h.cont_status_cd))'');
    ...
    maxlength_cont_status_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_status_desc)));
    avelength_cont_status_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_status_desc)),h.cont_status_desc<>(typeof(h.cont_status_desc))'');
    ...
    maxlength_cont_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_date)));
    avelength_cont_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_date)),h.cont_effective_date<>(typeof(h.cont_effective_date))'');
    ...
    maxlength_cont_effective_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_cd)));
    avelength_cont_effective_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_cd)),h.cont_effective_cd<>(typeof(h.cont_effective_cd))'');
    ...
    maxlength_cont_effective_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_desc)));
    avelength_cont_effective_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_effective_desc)),h.cont_effective_desc<>(typeof(h.cont_effective_desc))'');
    ...
    maxlength_cont_addl_info := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_addl_info)));
    avelength_cont_addl_info := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_addl_info)),h.cont_addl_info<>(typeof(h.cont_addl_info))'');
    ...
    maxlength_cont_address_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_type_cd)));
    avelength_cont_address_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_type_cd)),h.cont_address_type_cd<>(typeof(h.cont_address_type_cd))'');
    ...
    maxlength_cont_address_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_type_desc)));
    avelength_cont_address_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_type_desc)),h.cont_address_type_desc<>(typeof(h.cont_address_type_desc))'');
    ...
    maxlength_cont_address_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line1)));
    avelength_cont_address_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line1)),h.cont_address_line1<>(typeof(h.cont_address_line1))'');
    ...
    maxlength_cont_address_line2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line2)));
    avelength_cont_address_line2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line2)),h.cont_address_line2<>(typeof(h.cont_address_line2))'');
    ...
    maxlength_cont_address_line3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line3)));
    avelength_cont_address_line3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_line3)),h.cont_address_line3<>(typeof(h.cont_address_line3))'');
    ...
    maxlength_cont_address_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_effective_date)));
    avelength_cont_address_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_effective_date)),h.cont_address_effective_date<>(typeof(h.cont_address_effective_date))'');
    ...
    maxlength_cont_address_county := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_county)));
    avelength_cont_address_county := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_address_county)),h.cont_address_county<>(typeof(h.cont_address_county))'');
    ...
    maxlength_cont_phone_number := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number)));
    avelength_cont_phone_number := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number)),h.cont_phone_number<>(typeof(h.cont_phone_number))'');
    ...
    maxlength_cont_phone_number_type_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number_type_cd)));
    avelength_cont_phone_number_type_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number_type_cd)),h.cont_phone_number_type_cd<>(typeof(h.cont_phone_number_type_cd))'');
    ...
    maxlength_cont_phone_number_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number_type_desc)));
    avelength_cont_phone_number_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_phone_number_type_desc)),h.cont_phone_number_type_desc<>(typeof(h.cont_phone_number_type_desc))'');
    ...
    maxlength_cont_fax_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fax_nbr)));
    avelength_cont_fax_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_fax_nbr)),h.cont_fax_nbr<>(typeof(h.cont_fax_nbr))'');
    ...
    maxlength_cont_email_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_email_address)));
    avelength_cont_email_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_email_address)),h.cont_email_address<>(typeof(h.cont_email_address))'');
    ...
    maxlength_cont_web_address := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_web_address)));
    avelength_cont_web_address := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_web_address)),h.cont_web_address<>(typeof(h.cont_web_address))'');
    ...
    maxlength_corp_acres := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acres)));
    avelength_corp_acres := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acres)),h.corp_acres<>(typeof(h.corp_acres))'');
    ...
    maxlength_corp_action := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action)));
    avelength_corp_action := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action)),h.corp_action<>(typeof(h.corp_action))'');
    ...
    maxlength_corp_action_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_date)));
    avelength_corp_action_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_date)),h.corp_action_date<>(typeof(h.corp_action_date))'');
    ...
    maxlength_corp_action_employment_security_approval_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_employment_security_approval_date)));
    avelength_corp_action_employment_security_approval_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_employment_security_approval_date)),h.corp_action_employment_security_approval_date<>(typeof(h.corp_action_employment_security_approval_date))'');
    ...
    maxlength_corp_action_pending_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_pending_cd)));
    avelength_corp_action_pending_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_pending_cd)),h.corp_action_pending_cd<>(typeof(h.corp_action_pending_cd))'');
    ...
    maxlength_corp_action_pending_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_pending_desc)));
    avelength_corp_action_pending_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_pending_desc)),h.corp_action_pending_desc<>(typeof(h.corp_action_pending_desc))'');
    ...
    maxlength_corp_action_statement_of_intent_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_statement_of_intent_date)));
    avelength_corp_action_statement_of_intent_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_statement_of_intent_date)),h.corp_action_statement_of_intent_date<>(typeof(h.corp_action_statement_of_intent_date))'');
    ...
    maxlength_corp_action_tax_dept_approval_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_tax_dept_approval_date)));
    avelength_corp_action_tax_dept_approval_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_action_tax_dept_approval_date)),h.corp_action_tax_dept_approval_date<>(typeof(h.corp_action_tax_dept_approval_date))'');
    ...
    maxlength_corp_acts2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts2)));
    avelength_corp_acts2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts2)),h.corp_acts2<>(typeof(h.corp_acts2))'');
    ...
    maxlength_corp_acts3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts3)));
    avelength_corp_acts3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_acts3)),h.corp_acts3<>(typeof(h.corp_acts3))'');
    ...
    maxlength_corp_additional_principals := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_additional_principals)));
    avelength_corp_additional_principals := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_additional_principals)),h.corp_additional_principals<>(typeof(h.corp_additional_principals))'');
    ...
    maxlength_corp_address_office_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address_office_type)));
    avelength_corp_address_office_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_address_office_type)),h.corp_address_office_type<>(typeof(h.corp_address_office_type))'');
    ...
    maxlength_corp_agent_assign_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_assign_date)));
    avelength_corp_agent_assign_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_assign_date)),h.corp_agent_assign_date<>(typeof(h.corp_agent_assign_date))'');
    ...
    maxlength_corp_agent_commercial := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_commercial)));
    avelength_corp_agent_commercial := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_commercial)),h.corp_agent_commercial<>(typeof(h.corp_agent_commercial))'');
    ...
    maxlength_corp_agent_country := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_country)));
    avelength_corp_agent_country := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_country)),h.corp_agent_country<>(typeof(h.corp_agent_country))'');
    ...
    maxlength_corp_agent_county := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_county)));
    avelength_corp_agent_county := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_county)),h.corp_agent_county<>(typeof(h.corp_agent_county))'');
    ...
    maxlength_corp_agent_status_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_status_cd)));
    avelength_corp_agent_status_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_status_cd)),h.corp_agent_status_cd<>(typeof(h.corp_agent_status_cd))'');
    ...
    maxlength_corp_agent_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_id)));
    avelength_corp_agent_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agent_id)),h.corp_agent_id<>(typeof(h.corp_agent_id))'');
    ...
    maxlength_corp_agriculture_flag := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agriculture_flag)));
    avelength_corp_agriculture_flag := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_agriculture_flag)),h.corp_agriculture_flag<>(typeof(h.corp_agriculture_flag))'');
    ...
    maxlength_corp_authorized_partners := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_authorized_partners)));
    avelength_corp_authorized_partners := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_authorized_partners)),h.corp_authorized_partners<>(typeof(h.corp_authorized_partners))'');
    ...
    maxlength_corp_comment := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_comment)));
    avelength_corp_comment := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_comment)),h.corp_comment<>(typeof(h.corp_comment))'');
    ...
    maxlength_corp_consent_flag_for_protected_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_consent_flag_for_protected_name)));
    avelength_corp_consent_flag_for_protected_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_consent_flag_for_protected_name)),h.corp_consent_flag_for_protected_name<>(typeof(h.corp_consent_flag_for_protected_name))'');
    ...
    maxlength_corp_converted := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_converted)));
    avelength_corp_converted := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_converted)),h.corp_converted<>(typeof(h.corp_converted))'');
    ...
    maxlength_corp_converted_from := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_converted_from)));
    avelength_corp_converted_from := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_converted_from)),h.corp_converted_from<>(typeof(h.corp_converted_from))'');
    ...
    maxlength_corp_country_of_formation := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_country_of_formation)));
    avelength_corp_country_of_formation := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_country_of_formation)),h.corp_country_of_formation<>(typeof(h.corp_country_of_formation))'');
    ...
    maxlength_corp_date_of_organization_meeting := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_date_of_organization_meeting)));
    avelength_corp_date_of_organization_meeting := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_date_of_organization_meeting)),h.corp_date_of_organization_meeting<>(typeof(h.corp_date_of_organization_meeting))'');
    ...
    maxlength_corp_directors_from_to := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_directors_from_to)));
    avelength_corp_directors_from_to := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_directors_from_to)),h.corp_directors_from_to<>(typeof(h.corp_directors_from_to))'');
    ...
    maxlength_corp_farm_exemptions := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_exemptions)));
    avelength_corp_farm_exemptions := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_exemptions)),h.corp_farm_exemptions<>(typeof(h.corp_farm_exemptions))'');
    ...
    maxlength_corp_farm_qual_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_qual_date)));
    avelength_corp_farm_qual_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_qual_date)),h.corp_farm_qual_date<>(typeof(h.corp_farm_qual_date))'');
    ...
    maxlength_corp_farm_status_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_status_cd)));
    avelength_corp_farm_status_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_status_cd)),h.corp_farm_status_cd<>(typeof(h.corp_farm_status_cd))'');
    ...
    maxlength_corp_farm_status_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_status_desc)));
    avelength_corp_farm_status_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_farm_status_desc)),h.corp_farm_status_desc<>(typeof(h.corp_farm_status_desc))'');
    ...
    maxlength_corp_fiscal_year_month := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fiscal_year_month)));
    avelength_corp_fiscal_year_month := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_fiscal_year_month)),h.corp_fiscal_year_month<>(typeof(h.corp_fiscal_year_month))'');
    ...
    maxlength_corp_foreign_fiduciary_capacity_in_state := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_foreign_fiduciary_capacity_in_state)));
    avelength_corp_foreign_fiduciary_capacity_in_state := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_foreign_fiduciary_capacity_in_state)),h.corp_foreign_fiduciary_capacity_in_state<>(typeof(h.corp_foreign_fiduciary_capacity_in_state))'');
    ...
    maxlength_corp_governing_statute := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_governing_statute)));
    avelength_corp_governing_statute := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_governing_statute)),h.corp_governing_statute<>(typeof(h.corp_governing_statute))'');
    ...
    maxlength_corp_has_members := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_has_members)));
    avelength_corp_has_members := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_has_members)),h.corp_has_members<>(typeof(h.corp_has_members))'');
    ...
    maxlength_corp_has_vested_managers := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_has_vested_managers)));
    avelength_corp_has_vested_managers := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_has_vested_managers)),h.corp_has_vested_managers<>(typeof(h.corp_has_vested_managers))'');
    ...
    maxlength_corp_home_incorporated_county := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_home_incorporated_county)));
    avelength_corp_home_incorporated_county := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_home_incorporated_county)),h.corp_home_incorporated_county<>(typeof(h.corp_home_incorporated_county))'');
    ...
    maxlength_corp_home_state_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_home_state_name)));
    avelength_corp_home_state_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_home_state_name)),h.corp_home_state_name<>(typeof(h.corp_home_state_name))'');
    ...
    maxlength_corp_is_professional := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_is_professional)));
    avelength_corp_is_professional := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_is_professional)),h.corp_is_professional<>(typeof(h.corp_is_professional))'');
    ...
    maxlength_corp_is_non_profit_irs_approved := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_is_non_profit_irs_approved)));
    avelength_corp_is_non_profit_irs_approved := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_is_non_profit_irs_approved)),h.corp_is_non_profit_irs_approved<>(typeof(h.corp_is_non_profit_irs_approved))'');
    ...
    maxlength_corp_last_renewal_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_last_renewal_date)));
    avelength_corp_last_renewal_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_last_renewal_date)),h.corp_last_renewal_date<>(typeof(h.corp_last_renewal_date))'');
    ...
    maxlength_corp_last_renewal_year := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_last_renewal_year)));
    avelength_corp_last_renewal_year := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_last_renewal_year)),h.corp_last_renewal_year<>(typeof(h.corp_last_renewal_year))'');
    ...
    maxlength_corp_license_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_license_type)));
    avelength_corp_license_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_license_type)),h.corp_license_type<>(typeof(h.corp_license_type))'');
    ...
    maxlength_corp_llc_managed_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_llc_managed_desc)));
    avelength_corp_llc_managed_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_llc_managed_desc)),h.corp_llc_managed_desc<>(typeof(h.corp_llc_managed_desc))'');
    ...
    maxlength_corp_llc_managed_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_llc_managed_ind)));
    avelength_corp_llc_managed_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_llc_managed_ind)),h.corp_llc_managed_ind<>(typeof(h.corp_llc_managed_ind))'');
    ...
    maxlength_corp_management_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_management_desc)));
    avelength_corp_management_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_management_desc)),h.corp_management_desc<>(typeof(h.corp_management_desc))'');
    ...
    maxlength_corp_management_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_management_type)));
    avelength_corp_management_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_management_type)),h.corp_management_type<>(typeof(h.corp_management_type))'');
    ...
    maxlength_corp_manager_managed := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_manager_managed)));
    avelength_corp_manager_managed := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_manager_managed)),h.corp_manager_managed<>(typeof(h.corp_manager_managed))'');
    ...
    maxlength_corp_merged_corporation_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merged_corporation_id)));
    avelength_corp_merged_corporation_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merged_corporation_id)),h.corp_merged_corporation_id<>(typeof(h.corp_merged_corporation_id))'');
    ...
    maxlength_corp_merged_fein := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merged_fein)));
    avelength_corp_merged_fein := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merged_fein)),h.corp_merged_fein<>(typeof(h.corp_merged_fein))'');
    ...
    maxlength_corp_merger_allowed_flag := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_allowed_flag)));
    avelength_corp_merger_allowed_flag := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_allowed_flag)),h.corp_merger_allowed_flag<>(typeof(h.corp_merger_allowed_flag))'');
    ...
    maxlength_corp_merger_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_effective_date)));
    avelength_corp_merger_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_effective_date)),h.corp_merger_effective_date<>(typeof(h.corp_merger_effective_date))'');
    ...
    maxlength_corp_merger_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_id)));
    avelength_corp_merger_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_id)),h.corp_merger_id<>(typeof(h.corp_merger_id))'');
    ...
    maxlength_corp_merger_indicator := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_indicator)));
    avelength_corp_merger_indicator := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_indicator)),h.corp_merger_indicator<>(typeof(h.corp_merger_indicator))'');
    ...
    maxlength_corp_merger_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_name)));
    avelength_corp_merger_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_name)),h.corp_merger_name<>(typeof(h.corp_merger_name))'');
    ...
    maxlength_corp_merger_type_converted_to_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_type_converted_to_cd)));
    avelength_corp_merger_type_converted_to_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_type_converted_to_cd)),h.corp_merger_type_converted_to_cd<>(typeof(h.corp_merger_type_converted_to_cd))'');
    ...
    maxlength_corp_merger_type_converted_to_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_type_converted_to_desc)));
    avelength_corp_merger_type_converted_to_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_merger_type_converted_to_desc)),h.corp_merger_type_converted_to_desc<>(typeof(h.corp_merger_type_converted_to_desc))'');
    ...
    maxlength_corp_naics_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_naics_desc)));
    avelength_corp_naics_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_naics_desc)),h.corp_naics_desc<>(typeof(h.corp_naics_desc))'');
    ...
    maxlength_corp_name_effective_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_effective_date)));
    avelength_corp_name_effective_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_effective_date)),h.corp_name_effective_date<>(typeof(h.corp_name_effective_date))'');
    ...
    maxlength_corp_name_reservation_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_date)));
    avelength_corp_name_reservation_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_date)),h.corp_name_reservation_date<>(typeof(h.corp_name_reservation_date))'');
    ...
    maxlength_corp_name_reservation_expiration_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_expiration_date)));
    avelength_corp_name_reservation_expiration_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_expiration_date)),h.corp_name_reservation_expiration_date<>(typeof(h.corp_name_reservation_expiration_date))'');
    ...
    maxlength_corp_name_reservation_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_nbr)));
    avelength_corp_name_reservation_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_nbr)),h.corp_name_reservation_nbr<>(typeof(h.corp_name_reservation_nbr))'');
    ...
    maxlength_corp_name_reservation_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_type)));
    avelength_corp_name_reservation_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_reservation_type)),h.corp_name_reservation_type<>(typeof(h.corp_name_reservation_type))'');
    ...
    maxlength_corp_name_status_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_cd)));
    avelength_corp_name_status_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_cd)),h.corp_name_status_cd<>(typeof(h.corp_name_status_cd))'');
    ...
    maxlength_corp_name_status_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_date)));
    avelength_corp_name_status_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_date)),h.corp_name_status_date<>(typeof(h.corp_name_status_date))'');
    ...
    maxlength_corp_name_status_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_desc)));
    avelength_corp_name_status_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_name_status_desc)),h.corp_name_status_desc<>(typeof(h.corp_name_status_desc))'');
    ...
    maxlength_corp_non_profit_irs_approved_purpose := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_non_profit_irs_approved_purpose)));
    avelength_corp_non_profit_irs_approved_purpose := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_non_profit_irs_approved_purpose)),h.corp_non_profit_irs_approved_purpose<>(typeof(h.corp_non_profit_irs_approved_purpose))'');
    ...
    maxlength_corp_non_profit_solicit_donations := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_non_profit_solicit_donations)));
    avelength_corp_non_profit_solicit_donations := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_non_profit_solicit_donations)),h.corp_non_profit_solicit_donations<>(typeof(h.corp_non_profit_solicit_donations))'');
    ...
    maxlength_corp_nbr_of_amendments := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_amendments)));
    avelength_corp_nbr_of_amendments := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_amendments)),h.corp_nbr_of_amendments<>(typeof(h.corp_nbr_of_amendments))'');
    ...
    maxlength_corp_nbr_of_initial_llc_members := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_initial_llc_members)));
    avelength_corp_nbr_of_initial_llc_members := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_initial_llc_members)),h.corp_nbr_of_initial_llc_members<>(typeof(h.corp_nbr_of_initial_llc_members))'');
    ...
    maxlength_corp_nbr_of_partners := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_partners)));
    avelength_corp_nbr_of_partners := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_nbr_of_partners)),h.corp_nbr_of_partners<>(typeof(h.corp_nbr_of_partners))'');
    ...
    maxlength_corp_operating_agreement := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_operating_agreement)));
    avelength_corp_operating_agreement := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_operating_agreement)),h.corp_operating_agreement<>(typeof(h.corp_operating_agreement))'');
    ...
    maxlength_corp_opt_in_llc_act_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_opt_in_llc_act_desc)));
    avelength_corp_opt_in_llc_act_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_opt_in_llc_act_desc)),h.corp_opt_in_llc_act_desc<>(typeof(h.corp_opt_in_llc_act_desc))'');
    ...
    maxlength_corp_opt_in_llc_act_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_opt_in_llc_act_ind)));
    avelength_corp_opt_in_llc_act_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_opt_in_llc_act_ind)),h.corp_opt_in_llc_act_ind<>(typeof(h.corp_opt_in_llc_act_ind))'');
    ...
    maxlength_corp_organizational_comments := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_organizational_comments)));
    avelength_corp_organizational_comments := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_organizational_comments)),h.corp_organizational_comments<>(typeof(h.corp_organizational_comments))'');
    ...
    maxlength_corp_partner_contributions_total := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partner_contributions_total)));
    avelength_corp_partner_contributions_total := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partner_contributions_total)),h.corp_partner_contributions_total<>(typeof(h.corp_partner_contributions_total))'');
    ...
    maxlength_corp_partner_terms := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partner_terms)));
    avelength_corp_partner_terms := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_partner_terms)),h.corp_partner_terms<>(typeof(h.corp_partner_terms))'');
    ...
    maxlength_corp_percentage_voters_required_to_approve_amendments := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_percentage_voters_required_to_approve_amendments)));
    avelength_corp_percentage_voters_required_to_approve_amendments := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_percentage_voters_required_to_approve_amendments)),h.corp_percentage_voters_required_to_approve_amendments<>(typeof(h.corp_percentage_voters_required_to_approve_amendments))'');
    ...
    maxlength_corp_profession := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_profession)));
    avelength_corp_profession := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_profession)),h.corp_profession<>(typeof(h.corp_profession))'');
    ...
    maxlength_corp_province := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_province)));
    avelength_corp_province := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_province)),h.corp_province<>(typeof(h.corp_province))'');
    ...
    maxlength_corp_public_mutual_corporation := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_public_mutual_corporation)));
    avelength_corp_public_mutual_corporation := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_public_mutual_corporation)),h.corp_public_mutual_corporation<>(typeof(h.corp_public_mutual_corporation))'');
    ...
    maxlength_corp_purpose := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_purpose)));
    avelength_corp_purpose := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_purpose)),h.corp_purpose<>(typeof(h.corp_purpose))'');
    ...
    maxlength_corp_ra_required_flag := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_required_flag)));
    avelength_corp_ra_required_flag := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_ra_required_flag)),h.corp_ra_required_flag<>(typeof(h.corp_ra_required_flag))'');
    ...
    maxlength_corp_registered_counties := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_registered_counties)));
    avelength_corp_registered_counties := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_registered_counties)),h.corp_registered_counties<>(typeof(h.corp_registered_counties))'');
    ...
    maxlength_corp_regulated_ind := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_regulated_ind)));
    avelength_corp_regulated_ind := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_regulated_ind)),h.corp_regulated_ind<>(typeof(h.corp_regulated_ind))'');
    ...
    maxlength_corp_renewal_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_renewal_date)));
    avelength_corp_renewal_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_renewal_date)),h.corp_renewal_date<>(typeof(h.corp_renewal_date))'');
    ...
    maxlength_corp_standing_other := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_standing_other)));
    avelength_corp_standing_other := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_standing_other)),h.corp_standing_other<>(typeof(h.corp_standing_other))'');
    ...
    maxlength_corp_survivor_corporation_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_survivor_corporation_id)));
    avelength_corp_survivor_corporation_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_survivor_corporation_id)),h.corp_survivor_corporation_id<>(typeof(h.corp_survivor_corporation_id))'');
    ...
    maxlength_corp_tax_base := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_base)));
    avelength_corp_tax_base := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_base)),h.corp_tax_base<>(typeof(h.corp_tax_base))'');
    ...
    maxlength_corp_tax_standing := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_standing)));
    avelength_corp_tax_standing := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_tax_standing)),h.corp_tax_standing<>(typeof(h.corp_tax_standing))'');
    ...
    maxlength_corp_termination_cd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_cd)));
    avelength_corp_termination_cd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_cd)),h.corp_termination_cd<>(typeof(h.corp_termination_cd))'');
    ...
    maxlength_corp_termination_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_desc)));
    avelength_corp_termination_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_desc)),h.corp_termination_desc<>(typeof(h.corp_termination_desc))'');
    ...
    maxlength_corp_termination_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_date)));
    avelength_corp_termination_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_termination_date)),h.corp_termination_date<>(typeof(h.corp_termination_date))'');
    ...
    maxlength_corp_trademark_business_mark_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_business_mark_type)));
    avelength_corp_trademark_business_mark_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_business_mark_type)),h.corp_trademark_business_mark_type<>(typeof(h.corp_trademark_business_mark_type))'');
    ...
    maxlength_corp_trademark_cancelled_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_cancelled_date)));
    avelength_corp_trademark_cancelled_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_cancelled_date)),h.corp_trademark_cancelled_date<>(typeof(h.corp_trademark_cancelled_date))'');
    ...
    maxlength_corp_trademark_class_desc1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc1)));
    avelength_corp_trademark_class_desc1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc1)),h.corp_trademark_class_desc1<>(typeof(h.corp_trademark_class_desc1))'');
    ...
    maxlength_corp_trademark_class_desc2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc2)));
    avelength_corp_trademark_class_desc2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc2)),h.corp_trademark_class_desc2<>(typeof(h.corp_trademark_class_desc2))'');
    ...
    maxlength_corp_trademark_class_desc3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc3)));
    avelength_corp_trademark_class_desc3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc3)),h.corp_trademark_class_desc3<>(typeof(h.corp_trademark_class_desc3))'');
    ...
    maxlength_corp_trademark_class_desc4 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc4)));
    avelength_corp_trademark_class_desc4 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc4)),h.corp_trademark_class_desc4<>(typeof(h.corp_trademark_class_desc4))'');
    ...
    maxlength_corp_trademark_class_desc5 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc5)));
    avelength_corp_trademark_class_desc5 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc5)),h.corp_trademark_class_desc5<>(typeof(h.corp_trademark_class_desc5))'');
    ...
    maxlength_corp_trademark_class_desc6 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc6)));
    avelength_corp_trademark_class_desc6 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_class_desc6)),h.corp_trademark_class_desc6<>(typeof(h.corp_trademark_class_desc6))'');
    ...
    maxlength_corp_trademark_classification_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_classification_nbr)));
    avelength_corp_trademark_classification_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_classification_nbr)),h.corp_trademark_classification_nbr<>(typeof(h.corp_trademark_classification_nbr))'');
    ...
    maxlength_corp_trademark_disclaimer1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_disclaimer1)));
    avelength_corp_trademark_disclaimer1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_disclaimer1)),h.corp_trademark_disclaimer1<>(typeof(h.corp_trademark_disclaimer1))'');
    ...
    maxlength_corp_trademark_disclaimer2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_disclaimer2)));
    avelength_corp_trademark_disclaimer2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_disclaimer2)),h.corp_trademark_disclaimer2<>(typeof(h.corp_trademark_disclaimer2))'');
    ...
    maxlength_corp_trademark_first_use_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_first_use_date)));
    avelength_corp_trademark_first_use_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_first_use_date)),h.corp_trademark_first_use_date<>(typeof(h.corp_trademark_first_use_date))'');
    ...
    maxlength_corp_trademark_first_use_date_in_state := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_first_use_date_in_state)));
    avelength_corp_trademark_first_use_date_in_state := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_first_use_date_in_state)),h.corp_trademark_first_use_date_in_state<>(typeof(h.corp_trademark_first_use_date_in_state))'');
    ...
    maxlength_corp_trademark_keywords := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_keywords)));
    avelength_corp_trademark_keywords := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_keywords)),h.corp_trademark_keywords<>(typeof(h.corp_trademark_keywords))'');
    ...
    maxlength_corp_trademark_logo := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_logo)));
    avelength_corp_trademark_logo := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_logo)),h.corp_trademark_logo<>(typeof(h.corp_trademark_logo))'');
    ...
    maxlength_corp_trademark_name_expiration_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_name_expiration_date)));
    avelength_corp_trademark_name_expiration_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_name_expiration_date)),h.corp_trademark_name_expiration_date<>(typeof(h.corp_trademark_name_expiration_date))'');
    ...
    maxlength_corp_trademark_nbr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_nbr)));
    avelength_corp_trademark_nbr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_nbr)),h.corp_trademark_nbr<>(typeof(h.corp_trademark_nbr))'');
    ...
    maxlength_corp_trademark_renewal_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_renewal_date)));
    avelength_corp_trademark_renewal_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_renewal_date)),h.corp_trademark_renewal_date<>(typeof(h.corp_trademark_renewal_date))'');
    ...
    maxlength_corp_trademark_status := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_status)));
    avelength_corp_trademark_status := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_status)),h.corp_trademark_status<>(typeof(h.corp_trademark_status))'');
    ...
    maxlength_corp_trademark_used_1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_1)));
    avelength_corp_trademark_used_1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_1)),h.corp_trademark_used_1<>(typeof(h.corp_trademark_used_1))'');
    ...
    maxlength_corp_trademark_used_2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_2)));
    avelength_corp_trademark_used_2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_2)),h.corp_trademark_used_2<>(typeof(h.corp_trademark_used_2))'');
    ...
    maxlength_corp_trademark_used_3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_3)));
    avelength_corp_trademark_used_3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.corp_trademark_used_3)),h.corp_trademark_used_3<>(typeof(h.corp_trademark_used_3))'');
    ...
    maxlength_cont_owner_percentage := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_owner_percentage)));
    avelength_cont_owner_percentage := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_owner_percentage)),h.cont_owner_percentage<>(typeof(h.cont_owner_percentage))'');
    ...
    maxlength_cont_country := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_country)));
    avelength_cont_country := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_country)),h.cont_country<>(typeof(h.cont_country))'');
    ...
    maxlength_cont_country_mailing := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_country_mailing)));
    avelength_cont_country_mailing := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_country_mailing)),h.cont_country_mailing<>(typeof(h.cont_country_mailing))'');
    ...
    maxlength_cont_nondislosure := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_nondislosure)));
    avelength_cont_nondislosure := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_nondislosure)),h.cont_nondislosure<>(typeof(h.cont_nondislosure))'');
    ...
    maxlength_cont_prep_addr_line1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_prep_addr_line1)));
    avelength_cont_prep_addr_line1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_prep_addr_line1)),h.cont_prep_addr_line1<>(typeof(h.cont_prep_addr_line1))'');
    ...
    maxlength_cont_prep_addr_last_line := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_prep_addr_last_line)));
    avelength_cont_prep_addr_last_line := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cont_prep_addr_last_line)),h.cont_prep_addr_last_line<>(typeof(h.cont_prep_addr_last_line))'');
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{15,'corp_ln_name_type_cd'}
      ,{16,'corp_ln_name_type_desc'}
      ,{17,'corp_supp_nbr'}
      ,{18,'corp_name_comment'}
      ,{19,'corp_address1_type_cd'}
      ,{20,'corp_address1_type_desc'}
      ,{21,'corp_address1_line1'}
      ,{22,'corp_address1_line2'}
      ,{23,'corp_address1_line3'}
      ,{24,'corp_address1_effective_date'}
      ,{25,'corp_address2_type_cd'}
      ,{26,'corp_address2_type_desc'}
      ,{27,'corp_address2_line1'}
      ,{28,'corp_address2_line2'}
      ,{29,'corp_address2_line3'}
      ,{30,'corp_address2_effective_date'}
      ,{31,'corp_phone_number'}
      ,{32,'corp_phone_number_type_cd'}
      ,{33,'corp_phone_number_type_desc'}
      ,{34,'corp_fax_nbr'}
      ,{35,'corp_email_address'}
      ,{36,'corp_web_address'}
      ,{37,'corp_filing_reference_nbr'}
      ,{38,'corp_filing_date'}
      ,{39,'corp_filing_cd'}
      ,{40,'corp_filing_desc'}
      ,{41,'corp_status_cd'}
      ...
      ,{43,'corp_status_date'}
      ,{44,'corp_standing'}
      ,{45,'corp_status_comment'}
      ,{46,'corp_ticker_symbol'}
      ,{47,'corp_stock_exchange'}
      ,{48,'corp_inc_state'}
      ,{49,'corp_inc_county'}
      ,{50,'corp_inc_date'}
      ,{51,'corp_anniversary_month'}
      ,{52,'corp_fed_tax_id'}
      ,{53,'corp_state_tax_id'}
      ,{54,'corp_term_exist_cd'}
      ,{55,'corp_term_exist_exp'}
      ,{56,'corp_term_exist_desc'}
      ,{57,'corp_foreign_domestic_ind'}
      ,{58,'corp_forgn_state_cd'}
      ,{59,'corp_forgn_state_desc'}
      ,{60,'corp_forgn_sos_charter_nbr'}
      ,{61,'corp_forgn_date'}
      ,{62,'corp_forgn_fed_tax_id'}
      ,{63,'corp_forgn_state_tax_id'}
      ,{64,'corp_forgn_term_exist_cd'}
      ,{65,'corp_forgn_term_exist_exp'}
      ,{66,'corp_forgn_term_exist_desc'}
      ,{67,'corp_orig_org_structure_cd'}
      ,{68,'corp_orig_org_structure_desc'}
      ,{69,'corp_for_profit_ind'}
      ,{70,'corp_public_or_private_ind'}
      ,{71,'corp_sic_code'}
      ,{72,'corp_naic_code'}
      ,{73,'corp_orig_bus_type_cd'}
      ,{74,'corp_orig_bus_type_desc'}
      ,{75,'corp_entity_desc'}
      ,{76,'corp_certificate_nbr'}
      ,{77,'corp_internal_nbr'}
      ,{78,'corp_previous_nbr'}
      ,{79,'corp_microfilm_nbr'}
      ,{80,'corp_amendments_filed'}
      ,{81,'corp_acts'}
      ,{82,'corp_partnership_ind'}
      ,{83,'corp_mfg_ind'}
      ,{84,'corp_addl_info'}
      ,{85,'corp_taxes'}
      ,{86,'corp_franchise_taxes'}
      ,{87,'corp_tax_program_cd'}
      ,{88,'corp_tax_program_desc'}
      ,{89,'corp_ra_full_name'}
      ,{90,'corp_ra_fname'}
      ,{91,'corp_ra_mname'}
      ,{92,'corp_ra_lname'}
      ,{93,'corp_ra_suffix'}
      ...
      ,{130,'cont_lname'}
      ,{131,'cont_suffix'}
      ,{132,'cont_title1_desc'}
      ,{133,'cont_title2_desc'}
      ,{134,'cont_title3_desc'}
      ,{135,'cont_title4_desc'}
      ,{136,'cont_title5_desc'}
      ,{137,'cont_fein'}
      ,{138,'cont_ssn'}
      ,{139,'cont_dob'}
      ,{140,'cont_status_cd'}
      ,{141,'cont_status_desc'}
      ,{142,'cont_effective_date'}
      ,{143,'cont_effective_cd'}
      ,{144,'cont_effective_desc'}
      ,{145,'cont_addl_info'}
      ,{146,'cont_address_type_cd'}
      ,{147,'cont_address_type_desc'}
      ,{148,'cont_address_line1'}
      ,{149,'cont_address_line2'}
      ,{150,'cont_address_line3'}
      ,{151,'cont_address_effective_date'}
      ,{152,'cont_address_county'}
      ,{153,'cont_phone_number'}
      ,{154,'cont_phone_number_type_cd'}
      ,{155,'cont_phone_number_type_desc'}
      ,{156,'cont_fax_nbr'}
      ,{157,'cont_email_address'}
      ,{158,'cont_web_address'}
      ,{159,'corp_acres'}
      ,{160,'corp_action'}
      ,{161,'corp_action_date'}
      ,{162,'corp_action_employment_security_approval_date'}
      ,{163,'corp_action_pending_cd'}
      ,{164,'corp_action_pending_desc'}
      ,{165,'corp_action_statement_of_intent_date'}
      ,{166,'corp_action_tax_dept_approval_date'}
      ,{167,'corp_acts2'}
      ,{168,'corp_acts3'}
      ,{169,'corp_additional_principals'}
      ,{170,'corp_address_office_type'}
      ,{171,'corp_agent_assign_date'}
      ...
      ,{196,'corp_has_members'}
      ,{197,'corp_has_vested_managers'}
      ,{198,'corp_home_incorporated_county'}
      ,{199,'corp_home_state_name'}
      ,{200,'corp_is_professional'}
      ,{201,'corp_is_non_profit_irs_approved'}
      ,{202,'corp_last_renewal_date'}
      ,{203,'corp_last_renewal_year'}
      ,{204,'corp_license_type'}
      ,{205,'corp_llc_managed_desc'}
      ,{206,'corp_llc_managed_ind'}
      ,{207,'corp_management_desc'}
      ...
      ,{214,'corp_merger_desc'}
      ,{215,'corp_merger_effective_date'}
      ,{216,'corp_merger_id'}
      ,{217,'corp_merger_indicator'}
      ,{218,'corp_merger_name'}
      ,{219,'corp_merger_type_converted_to_cd'}
      ,{220,'corp_merger_type_converted_to_desc'}
      ,{221,'corp_naics_desc'}
      ,{222,'corp_name_effective_date'}
      ,{223,'corp_name_reservation_date'}
      ,{224,'corp_name_reservation_expiration_date'}
      ,{225,'corp_name_reservation_nbr'}
      ,{226,'corp_name_reservation_type'}
      ,{227,'corp_name_status_cd'}
      ,{228,'corp_name_status_date'}
      ,{229,'corp_name_status_desc'}
      ,{230,'corp_non_profit_irs_approved_purpose'}
      ,{231,'corp_non_profit_solicit_donations'}
      ,{232,'corp_nbr_of_amendments'}
      ,{233,'corp_nbr_of_initial_llc_members'}
      ,{234,'corp_nbr_of_partners'}
      ,{235,'corp_operating_agreement'}
      ,{236,'corp_opt_in_llc_act_desc'}
      ,{237,'corp_opt_in_llc_act_ind'}
      ,{238,'corp_organizational_comments'}
      ,{239,'corp_partner_contributions_total'}
      ,{240,'corp_partner_terms'}
      ,{241,'corp_percentage_voters_required_to_approve_amendments'}
      ,{242,'corp_profession'}
      ,{243,'corp_province'}
      ...
      ,{254,'corp_termination_cd'}
      ,{255,'corp_termination_desc'}
      ,{256,'corp_termination_date'}
      ,{257,'corp_trademark_business_mark_type'}
      ,{258,'corp_trademark_cancelled_date'}
      ,{259,'corp_trademark_class_desc1'}
      ,{260,'corp_trademark_class_desc2'}
      ,{261,'corp_trademark_class_desc3'}
      ,{262,'corp_trademark_class_desc4'}
      ,{263,'corp_trademark_class_desc5'}
      ,{264,'corp_trademark_class_desc6'}
      ,{265,'corp_trademark_classification_nbr'}
      ...
      ,{270,'corp_trademark_first_use_date'}
      ,{271,'corp_trademark_first_use_date_in_state'}
      ,{272,'corp_trademark_keywords'}
      ,{273,'corp_trademark_logo'}
      ,{274,'corp_trademark_name_expiration_date'}
      ,{275,'corp_trademark_nbr'}
      ...
      ,{285,'cont_prep_addr_line1'}
      ,{286,'cont_prep_addr_last_line'}
      ,{287,'recordorigin'}
      ,{288,'InternalField1'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_corp_supp_key((SALT311.StrType)le.corp_supp_key),
    ...
    Fields.InValid_corp_ln_name_type_desc((SALT311.StrType)le.corp_ln_name_type_desc),
    Fields.InValid_corp_supp_nbr((SALT311.StrType)le.corp_supp_nbr),
    Fields.InValid_corp_name_comment((SALT311.StrType)le.corp_name_comment),
    Fields.InValid_corp_address1_type_cd((SALT311.StrType)le.corp_address1_type_cd),
    Fields.InValid_corp_address1_type_desc((SALT311.StrType)le.corp_address1_type_desc),
    Fields.InValid_corp_address1_line1((SALT311.StrType)le.corp_address1_line1),
    Fields.InValid_corp_address1_line2((SALT311.StrType)le.corp_address1_line2),
    Fields.InValid_corp_address1_line3((SALT311.StrType)le.corp_address1_line3),
    Fields.InValid_corp_address1_effective_date((SALT311.StrType)le.corp_address1_effective_date),
    Fields.InValid_corp_address2_type_cd((SALT311.StrType)le.corp_address2_type_cd),
    Fields.InValid_corp_address2_type_desc((SALT311.StrType)le.corp_address2_type_desc),
    Fields.InValid_corp_address2_line1((SALT311.StrType)le.corp_address2_line1),
    Fields.InValid_corp_address2_line2((SALT311.StrType)le.corp_address2_line2),
    Fields.InValid_corp_address2_line3((SALT311.StrType)le.corp_address2_line3),
    Fields.InValid_corp_address2_effective_date((SALT311.StrType)le.corp_address2_effective_date),
    Fields.InValid_corp_phone_number((SALT311.StrType)le.corp_phone_number),
    Fields.InValid_corp_phone_number_type_cd((SALT311.StrType)le.corp_phone_number_type_cd),
    Fields.InValid_corp_phone_number_type_desc((SALT311.StrType)le.corp_phone_number_type_desc),
    Fields.InValid_corp_fax_nbr((SALT311.StrType)le.corp_fax_nbr),
    Fields.InValid_corp_email_address((SALT311.StrType)le.corp_email_address),
    Fields.InValid_corp_web_address((SALT311.StrType)le.corp_web_address),
    Fields.InValid_corp_filing_reference_nbr((SALT311.StrType)le.corp_filing_reference_nbr),
    Fields.InValid_corp_filing_date((SALT311.StrType)le.corp_filing_date),
    Fields.InValid_corp_filing_cd((SALT311.StrType)le.corp_filing_cd),
    Fields.InValid_corp_filing_desc((SALT311.StrType)le.corp_filing_desc),
    Fields.InValid_corp_status_cd((SALT311.StrType)le.corp_status_cd),
    ...
    Fields.InValid_corp_standing((SALT311.StrType)le.corp_standing),
    Fields.InValid_corp_status_comment((SALT311.StrType)le.corp_status_comment),
    Fields.InValid_corp_ticker_symbol((SALT311.StrType)le.corp_ticker_symbol),
    Fields.InValid_corp_stock_exchange((SALT311.StrType)le.corp_stock_exchange),
    Fields.InValid_corp_inc_state((SALT311.StrType)le.corp_inc_state),
    Fields.InValid_corp_inc_county((SALT311.StrType)le.corp_inc_county),
    Fields.InValid_corp_inc_date((SALT311.StrType)le.corp_inc_date),
    Fields.InValid_corp_anniversary_month((SALT311.StrType)le.corp_anniversary_month),
    Fields.InValid_corp_fed_tax_id((SALT311.StrType)le.corp_fed_tax_id),
    Fields.InValid_corp_state_tax_id((SALT311.StrType)le.corp_state_tax_id),
    Fields.InValid_corp_term_exist_cd((SALT311.StrType)le.corp_term_exist_cd),
    Fields.InValid_corp_term_exist_exp((SALT311.StrType)le.corp_term_exist_exp),
    Fields.InValid_corp_term_exist_desc((SALT311.StrType)le.corp_term_exist_desc),
    Fields.InValid_corp_foreign_domestic_ind((SALT311.StrType)le.corp_foreign_domestic_ind),
    Fields.InValid_corp_forgn_state_cd((SALT311.StrType)le.corp_forgn_state_cd),
    Fields.InValid_corp_forgn_state_desc((SALT311.StrType)le.corp_forgn_state_desc),
    Fields.InValid_corp_forgn_sos_charter_nbr((SALT311.StrType)le.corp_forgn_sos_charter_nbr),
    Fields.InValid_corp_forgn_date((SALT311.StrType)le.corp_forgn_date),
    Fields.InValid_corp_forgn_fed_tax_id((SALT311.StrType)le.corp_forgn_fed_tax_id),
    Fields.InValid_corp_forgn_state_tax_id((SALT311.StrType)le.corp_forgn_state_tax_id),
    Fields.InValid_corp_forgn_term_exist_cd((SALT311.StrType)le.corp_forgn_term_exist_cd),
    Fields.InValid_corp_forgn_term_exist_exp((SALT311.StrType)le.corp_forgn_term_exist_exp),
    Fields.InValid_corp_forgn_term_exist_desc((SALT311.StrType)le.corp_forgn_term_exist_desc),
    ...
    Fields.InValid_corp_public_or_private_ind((SALT311.StrType)le.corp_public_or_private_ind),
    Fields.InValid_corp_sic_code((SALT311.StrType)le.corp_sic_code),
    Fields.InValid_corp_naic_code((SALT311.StrType)le.corp_naic_code),
    Fields.InValid_corp_orig_bus_type_cd((SALT311.StrType)le.corp_orig_bus_type_cd),
    Fields.InValid_corp_orig_bus_type_desc((SALT311.StrType)le.corp_orig_bus_type_desc),
    Fields.InValid_corp_entity_desc((SALT311.StrType)le.corp_entity_desc),
    Fields.InValid_corp_certificate_nbr((SALT311.StrType)le.corp_certificate_nbr),
    Fields.InValid_corp_internal_nbr((SALT311.StrType)le.corp_internal_nbr),
    Fields.InValid_corp_previous_nbr((SALT311.StrType)le.corp_previous_nbr),
    Fields.InValid_corp_microfilm_nbr((SALT311.StrType)le.corp_microfilm_nbr),
    Fields.InValid_corp_amendments_filed((SALT311.StrType)le.corp_amendments_filed),
    Fields.InValid_corp_acts((SALT311.StrType)le.corp_acts),
    Fields.InValid_corp_partnership_ind((SALT311.StrType)le.corp_partnership_ind),
    Fields.InValid_corp_mfg_ind((SALT311.StrType)le.corp_mfg_ind),
    Fields.InValid_corp_addl_info((SALT311.StrType)le.corp_addl_info),
    Fields.InValid_corp_taxes((SALT311.StrType)le.corp_taxes),
    Fields.InValid_corp_franchise_taxes((SALT311.StrType)le.corp_franchise_taxes),
    Fields.InValid_corp_tax_program_cd((SALT311.StrType)le.corp_tax_program_cd),
    Fields.InValid_corp_tax_program_desc((SALT311.StrType)le.corp_tax_program_desc),
    Fields.InValid_corp_ra_full_name((SALT311.StrType)le.corp_ra_full_name),
    Fields.InValid_corp_ra_fname((SALT311.StrType)le.corp_ra_fname),
    Fields.InValid_corp_ra_mname((SALT311.StrType)le.corp_ra_mname),
    Fields.InValid_corp_ra_lname((SALT311.StrType)le.corp_ra_lname),
    Fields.InValid_corp_ra_suffix((SALT311.StrType)le.corp_ra_suffix),
    Fields.InValid_corp_ra_title_cd((SALT311.StrType)le.corp_ra_title_cd),
    Fields.InValid_corp_ra_title_desc((SALT311.StrType)le.corp_ra_title_desc),
    Fields.InValid_corp_ra_fein((SALT311.StrType)le.corp_ra_fein),
    Fields.InValid_corp_ra_ssn((SALT311.StrType)le.corp_ra_ssn),
    Fields.InValid_corp_ra_dob((SALT311.StrType)le.corp_ra_dob),
    ...
    Fields.InValid_corp_ra_no_comp((SALT311.StrType)le.corp_ra_no_comp),
    Fields.InValid_corp_ra_no_comp_igs((SALT311.StrType)le.corp_ra_no_comp_igs),
    Fields.InValid_corp_ra_addl_info((SALT311.StrType)le.corp_ra_addl_info),
    Fields.InValid_corp_ra_address_type_cd((SALT311.StrType)le.corp_ra_address_type_cd),
    Fields.InValid_corp_ra_address_type_desc((SALT311.StrType)le.corp_ra_address_type_desc),
    Fields.InValid_corp_ra_address_line1((SALT311.StrType)le.corp_ra_address_line1),
    Fields.InValid_corp_ra_address_line2((SALT311.StrType)le.corp_ra_address_line2),
    Fields.InValid_corp_ra_address_line3((SALT311.StrType)le.corp_ra_address_line3),
    Fields.InValid_corp_ra_phone_number((SALT311.StrType)le.corp_ra_phone_number),
    Fields.InValid_corp_ra_phone_number_type_cd((SALT311.StrType)le.corp_ra_phone_number_type_cd),
    Fields.InValid_corp_ra_phone_number_type_desc((SALT311.StrType)le.corp_ra_phone_number_type_desc),
    Fields.InValid_corp_ra_fax_nbr((SALT311.StrType)le.corp_ra_fax_nbr),
    Fields.InValid_corp_ra_email_address((SALT311.StrType)le.corp_ra_email_address),
    Fields.InValid_corp_ra_web_address((SALT311.StrType)le.corp_ra_web_address),
    Fields.InValid_corp_prep_addr1_line1((SALT311.StrType)le.corp_prep_addr1_line1),
    Fields.InValid_corp_prep_addr1_last_line((SALT311.StrType)le.corp_prep_addr1_last_line),
    Fields.InValid_corp_prep_addr2_line1((SALT311.StrType)le.corp_prep_addr2_line1),
    Fields.InValid_corp_prep_addr2_last_line((SALT311.StrType)le.corp_prep_addr2_last_line),
    Fields.InValid_ra_prep_addr_line1((SALT311.StrType)le.ra_prep_addr_line1),
    Fields.InValid_ra_prep_addr_last_line((SALT311.StrType)le.ra_prep_addr_last_line),
    Fields.InValid_cont_filing_reference_nbr((SALT311.StrType)le.cont_filing_reference_nbr),
    Fields.InValid_cont_filing_date((SALT311.StrType)le.cont_filing_date),
    Fields.InValid_cont_filing_cd((SALT311.StrType)le.cont_filing_cd),
    Fields.InValid_cont_filing_desc((SALT311.StrType)le.cont_filing_desc),
    Fields.InValid_cont_type_cd((SALT311.StrType)le.cont_type_cd),
    Fields.InValid_cont_type_desc((SALT311.StrType)le.cont_type_desc),
    Fields.InValid_cont_full_name((SALT311.StrType)le.cont_full_name),
    Fields.InValid_cont_fname((SALT311.StrType)le.cont_fname),
    Fields.InValid_cont_mname((SALT311.StrType)le.cont_mname),
    Fields.InValid_cont_lname((SALT311.StrType)le.cont_lname),
    Fields.InValid_cont_suffix((SALT311.StrType)le.cont_suffix),
    Fields.InValid_cont_title1_desc((SALT311.StrType)le.cont_title1_desc),
    Fields.InValid_cont_title2_desc((SALT311.StrType)le.cont_title2_desc),
    Fields.InValid_cont_title3_desc((SALT311.StrType)le.cont_title3_desc),
    Fields.InValid_cont_title4_desc((SALT311.StrType)le.cont_title4_desc),
    Fields.InValid_cont_title5_desc((SALT311.StrType)le.cont_title5_desc),
    Fields.InValid_cont_fein((SALT311.StrType)le.cont_fein),
    Fields.InValid_cont_ssn((SALT311.StrType)le.cont_ssn),
    Fields.InValid_cont_dob((SALT311.StrType)le.cont_dob),
    Fields.InValid_cont_status_cd((SALT311.StrType)le.cont_status_cd),
    Fields.InValid_cont_status_desc((SALT311.StrType)le.cont_status_desc),
    Fields.InValid_cont_effective_date((SALT311.StrType)le.cont_effective_date),
    Fields.InValid_cont_effective_cd((SALT311.StrType)le.cont_effective_cd),
    Fields.InValid_cont_effective_desc((SALT311.StrType)le.cont_effective_desc),
    Fields.InValid_cont_addl_info((SALT311.StrType)le.cont_addl_info),
    Fields.InValid_cont_address_type_cd((SALT311.StrType)le.cont_address_type_cd),
    Fields.InValid_cont_address_type_desc((SALT311.StrType)le.cont_address_type_desc),
    Fields.InValid_cont_address_line1((SALT311.StrType)le.cont_address_line1),
    Fields.InValid_cont_address_line2((SALT311.StrType)le.cont_address_line2),
    Fields.InValid_cont_address_line3((SALT311.StrType)le.cont_address_line3),
    Fields.InValid_cont_address_effective_date((SALT311.StrType)le.cont_address_effective_date),
    Fields.InValid_cont_address_county((SALT311.StrType)le.cont_address_county),
    Fields.InValid_cont_phone_number((SALT311.StrType)le.cont_phone_number),
    Fields.InValid_cont_phone_number_type_cd((SALT311.StrType)le.cont_phone_number_type_cd),
    Fields.InValid_cont_phone_number_type_desc((SALT311.StrType)le.cont_phone_number_type_desc),
    Fields.InValid_cont_fax_nbr((SALT311.StrType)le.cont_fax_nbr),
    Fields.InValid_cont_email_address((SALT311.StrType)le.cont_email_address),
    Fields.InValid_cont_web_address((SALT311.StrType)le.cont_web_address),
    Fields.InValid_corp_acres((SALT311.StrType)le.corp_acres),
    Fields.InValid_corp_action((SALT311.StrType)le.corp_action),
    Fields.InValid_corp_action_date((SALT311.StrType)le.corp_action_date),
    Fields.InValid_corp_action_employment_security_approval_date((SALT311.StrType)le.corp_action_employment_security_approval_date),
    Fields.InValid_corp_action_pending_cd((SALT311.StrType)le.corp_action_pending_cd),
    Fields.InValid_corp_action_pending_desc((SALT311.StrType)le.corp_action_pending_desc),
    Fields.InValid_corp_action_statement_of_intent_date((SALT311.StrType)le.corp_action_statement_of_intent_date),
    Fields.InValid_corp_action_tax_dept_approval_date((SALT311.StrType)le.corp_action_tax_dept_approval_date),
    Fields.InValid_corp_acts2((SALT311.StrType)le.corp_acts2),
    Fields.InValid_corp_acts3((SALT311.StrType)le.corp_acts3),
    Fields.InValid_corp_additional_principals((SALT311.StrType)le.corp_additional_principals),
    Fields.InValid_corp_address_office_type((SALT311.StrType)le.corp_address_office_type),
    Fields.InValid_corp_agent_assign_date((SALT311.StrType)le.corp_agent_assign_date),
    Fields.InValid_corp_agent_commercial((SALT311.StrType)le.corp_agent_commercial),
    Fields.InValid_corp_agent_country((SALT311.StrType)le.corp_agent_country),
    Fields.InValid_corp_agent_county((SALT311.StrType)le.corp_agent_county),
    Fields.InValid_corp_agent_status_cd((SALT311.StrType)le.corp_agent_status_cd),
    Fields.InValid_corp_agent_status_desc((SALT311.StrType)le.corp_agent_status_desc),
    Fields.InValid_corp_agent_id((SALT311.StrType)le.corp_agent_id),
    Fields.InValid_corp_agriculture_flag((SALT311.StrType)le.corp_agriculture_flag),
    Fields.InValid_corp_authorized_partners((SALT311.StrType)le.corp_authorized_partners),
    Fields.InValid_corp_comment((SALT311.StrType)le.corp_comment),
    Fields.InValid_corp_consent_flag_for_protected_name((SALT311.StrType)le.corp_consent_flag_for_protected_name),
    Fields.InValid_corp_converted((SALT311.StrType)le.corp_converted),
    Fields.InValid_corp_converted_from((SALT311.StrType)le.corp_converted_from),
    Fields.InValid_corp_country_of_formation((SALT311.StrType)le.corp_country_of_formation),
    Fields.InValid_corp_date_of_organization_meeting((SALT311.StrType)le.corp_date_of_organization_meeting),
    Fields.InValid_corp_delayed_effective_date((SALT311.StrType)le.corp_delayed_effective_date),
    Fields.InValid_corp_directors_from_to((SALT311.StrType)le.corp_directors_from_to),
    Fields.InValid_corp_dissolved_date((SALT311.StrType)le.corp_dissolved_date),
    Fields.InValid_corp_farm_exemptions((SALT311.StrType)le.corp_farm_exemptions),
    Fields.InValid_corp_farm_qual_date((SALT311.StrType)le.corp_farm_qual_date),
    Fields.InValid_corp_farm_status_cd((SALT311.StrType)le.corp_farm_status_cd),
    Fields.InValid_corp_farm_status_desc((SALT311.StrType)le.corp_farm_status_desc),
    Fields.InValid_corp_fiscal_year_month((SALT311.StrType)le.corp_fiscal_year_month),
    Fields.InValid_corp_foreign_fiduciary_capacity_in_state((SALT311.StrType)le.corp_foreign_fiduciary_capacity_in_state),
    Fields.InValid_corp_governing_statute((SALT311.StrType)le.corp_governing_statute),
    Fields.InValid_corp_has_members((SALT311.StrType)le.corp_has_members),
    Fields.InValid_corp_has_vested_managers((SALT311.StrType)le.corp_has_vested_managers),
    Fields.InValid_corp_home_incorporated_county((SALT311.StrType)le.corp_home_incorporated_county),
    Fields.InValid_corp_home_state_name((SALT311.StrType)le.corp_home_state_name),
    Fields.InValid_corp_is_professional((SALT311.StrType)le.corp_is_professional),
    Fields.InValid_corp_is_non_profit_irs_approved((SALT311.StrType)le.corp_is_non_profit_irs_approved),
    Fields.InValid_corp_last_renewal_date((SALT311.StrType)le.corp_last_renewal_date),
    Fields.InValid_corp_last_renewal_year((SALT311.StrType)le.corp_last_renewal_year),
    Fields.InValid_corp_license_type((SALT311.StrType)le.corp_license_type),
    Fields.InValid_corp_llc_managed_desc((SALT311.StrType)le.corp_llc_managed_desc),
    Fields.InValid_corp_llc_managed_ind((SALT311.StrType)le.corp_llc_managed_ind),
    Fields.InValid_corp_management_desc((SALT311.StrType)le.corp_management_desc),
    Fields.InValid_corp_management_type((SALT311.StrType)le.corp_management_type),
    Fields.InValid_corp_manager_managed((SALT311.StrType)le.corp_manager_managed),
    Fields.InValid_corp_merged_corporation_id((SALT311.StrType)le.corp_merged_corporation_id),
    Fields.InValid_corp_merged_fein((SALT311.StrType)le.corp_merged_fein),
    Fields.InValid_corp_merger_allowed_flag((SALT311.StrType)le.corp_merger_allowed_flag),
    ...
    Fields.InValid_corp_merger_effective_date((SALT311.StrType)le.corp_merger_effective_date),
    Fields.InValid_corp_merger_id((SALT311.StrType)le.corp_merger_id),
    Fields.InValid_corp_merger_indicator((SALT311.StrType)le.corp_merger_indicator),
    Fields.InValid_corp_merger_name((SALT311.StrType)le.corp_merger_name),
    Fields.InValid_corp_merger_type_converted_to_cd((SALT311.StrType)le.corp_merger_type_converted_to_cd),
    Fields.InValid_corp_merger_type_converted_to_desc((SALT311.StrType)le.corp_merger_type_converted_to_desc),
    Fields.InValid_corp_naics_desc((SALT311.StrType)le.corp_naics_desc),
    Fields.InValid_corp_name_effective_date((SALT311.StrType)le.corp_name_effective_date),
    Fields.InValid_corp_name_reservation_date((SALT311.StrType)le.corp_name_reservation_date),
    Fields.InValid_corp_name_reservation_expiration_date((SALT311.StrType)le.corp_name_reservation_expiration_date),
    Fields.InValid_corp_name_reservation_nbr((SALT311.StrType)le.corp_name_reservation_nbr),
    Fields.InValid_corp_name_reservation_type((SALT311.StrType)le.corp_name_reservation_type),
    Fields.InValid_corp_name_status_cd((SALT311.StrType)le.corp_name_status_cd),
    Fields.InValid_corp_name_status_date((SALT311.StrType)le.corp_name_status_date),
    Fields.InValid_corp_name_status_desc((SALT311.StrType)le.corp_name_status_desc),
    Fields.InValid_corp_non_profit_irs_approved_purpose((SALT311.StrType)le.corp_non_profit_irs_approved_purpose),
    Fields.InValid_corp_non_profit_solicit_donations((SALT311.StrType)le.corp_non_profit_solicit_donations),
    Fields.InValid_corp_nbr_of_amendments((SALT311.StrType)le.corp_nbr_of_amendments),
    Fields.InValid_corp_nbr_of_initial_llc_members((SALT311.StrType)le.corp_nbr_of_initial_llc_members),
    Fields.InValid_corp_nbr_of_partners((SALT311.StrType)le.corp_nbr_of_partners),
    Fields.InValid_corp_operating_agreement((SALT311.StrType)le.corp_operating_agreement),
    Fields.InValid_corp_opt_in_llc_act_desc((SALT311.StrType)le.corp_opt_in_llc_act_desc),
    Fields.InValid_corp_opt_in_llc_act_ind((SALT311.StrType)le.corp_opt_in_llc_act_ind),
    Fields.InValid_corp_organizational_comments((SALT311.StrType)le.corp_organizational_comments),
    Fields.InValid_corp_partner_contributions_total((SALT311.StrType)le.corp_partner_contributions_total),
    Fields.InValid_corp_partner_terms((SALT311.StrType)le.corp_partner_terms),
    Fields.InValid_corp_percentage_voters_required_to_approve_amendments((SALT311.StrType)le.corp_percentage_voters_required_to_approve_amendments),
    Fields.InValid_corp_profession((SALT311.StrType)le.corp_profession),
    Fields.InValid_corp_province((SALT311.StrType)le.corp_province),
    Fields.InValid_corp_public_mutual_corporation((SALT311.StrType)le.corp_public_mutual_corporation),
    Fields.InValid_corp_purpose((SALT311.StrType)le.corp_purpose),
    Fields.InValid_corp_ra_required_flag((SALT311.StrType)le.corp_ra_required_flag),
    Fields.InValid_corp_registered_counties((SALT311.StrType)le.corp_registered_counties),
    Fields.InValid_corp_regulated_ind((SALT311.StrType)le.corp_regulated_ind),
    Fields.InValid_corp_renewal_date((SALT311.StrType)le.corp_renewal_date),
    Fields.InValid_corp_standing_other((SALT311.StrType)le.corp_standing_other),
    Fields.InValid_corp_survivor_corporation_id((SALT311.StrType)le.corp_survivor_corporation_id),
    Fields.InValid_corp_tax_base((SALT311.StrType)le.corp_tax_base),
    Fields.InValid_corp_tax_standing((SALT311.StrType)le.corp_tax_standing),
    Fields.InValid_corp_termination_cd((SALT311.StrType)le.corp_termination_cd),
    Fields.InValid_corp_termination_desc((SALT311.StrType)le.corp_termination_desc),
    Fields.InValid_corp_termination_date((SALT311.StrType)le.corp_termination_date),
    Fields.InValid_corp_trademark_business_mark_type((SALT311.StrType)le.corp_trademark_business_mark_type),
    Fields.InValid_corp_trademark_cancelled_date((SALT311.StrType)le.corp_trademark_cancelled_date),
    Fields.InValid_corp_trademark_class_desc1((SALT311.StrType)le.corp_trademark_class_desc1),
    Fields.InValid_corp_trademark_class_desc2((SALT311.StrType)le.corp_trademark_class_desc2),
    Fields.InValid_corp_trademark_class_desc3((SALT311.StrType)le.corp_trademark_class_desc3),
    Fields.InValid_corp_trademark_class_desc4((SALT311.StrType)le.corp_trademark_class_desc4),
    Fields.InValid_corp_trademark_class_desc5((SALT311.StrType)le.corp_trademark_class_desc5),
    Fields.InValid_corp_trademark_class_desc6((SALT311.StrType)le.corp_trademark_class_desc6),
    Fields.InValid_corp_trademark_classification_nbr((SALT311.StrType)le.corp_trademark_classification_nbr),
    Fields.InValid_corp_trademark_disclaimer1((SALT311.StrType)le.corp_trademark_disclaimer1),
    Fields.InValid_corp_trademark_disclaimer2((SALT311.StrType)le.corp_trademark_disclaimer2),
    ...
    Fields.InValid_corp_trademark_first_use_date((SALT311.StrType)le.corp_trademark_first_use_date),
    Fields.InValid_corp_trademark_first_use_date_in_state((SALT311.StrType)le.corp_trademark_first_use_date_in_state),
    Fields.InValid_corp_trademark_keywords((SALT311.StrType)le.corp_trademark_keywords),
    Fields.InValid_corp_trademark_logo((SALT311.StrType)le.corp_trademark_logo),
    Fields.InValid_corp_trademark_name_expiration_date((SALT311.StrType)le.corp_trademark_name_expiration_date),
    Fields.InValid_corp_trademark_nbr((SALT311.StrType)le.corp_trademark_nbr),
    Fields.InValid_corp_trademark_renewal_date((SALT311.StrType)le.corp_trademark_renewal_date),
    Fields.InValid_corp_trademark_status((SALT311.StrType)le.corp_trademark_status),
    Fields.InValid_corp_trademark_used_1((SALT311.StrType)le.corp_trademark_used_1),
    Fields.InValid_corp_trademark_used_2((SALT311.StrType)le.corp_trademark_used_2),
    Fields.InValid_corp_trademark_used_3((SALT311.StrType)le.corp_trademark_used_3),
    Fields.InValid_cont_owner_percentage((SALT311.StrType)le.cont_owner_percentage),
    Fields.InValid_cont_country((SALT311.StrType)le.cont_country),
    Fields.InValid_cont_country_mailing((SALT311.StrType)le.cont_country_mailing),
    Fields.InValid_cont_nondislosure((SALT311.StrType)le.cont_nondislosure),
    Fields.InValid_cont_prep_addr_line1((SALT311.StrType)le.cont_prep_addr_line1),
    Fields.InValid_cont_prep_addr_last_line((SALT311.StrType)le.cont_prep_addr_last_line),
    Fields.InValid_recordorigin((SALT311.StrType)le.recordorigin),
    Fields.InValid_InternalField1((SALT311.StrType)le.InternalField1),
    0);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','Unknown','invalid_corp_vendor','Unknown','Unknown','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_name_type_code','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_date','Unknown','Unknown','invalid_status_cd','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_state_origin','Unknown','invalid_date','Unknown','Unknown','Unknown','Unknown','invalid_numeric','invalid_alphablank','invalid_foreign_domestic_ind','Unknown','invalid_st_country','Unknown','invalid_date','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_org_type_cd','Unknown','invalid_flag_code','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_st_country','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_recordorigin','invalid_alphablank');
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Corp2_Mapping_NE_Main, Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
