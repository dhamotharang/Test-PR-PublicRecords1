...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{288,'recordorigin'}
      ,{289,'InternalField1'}],SALT311.MAC_Character_Counts.Field_Identification);
