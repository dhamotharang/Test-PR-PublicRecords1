...
Command line options: -MScrubs_Corp2_Mapping_NE_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR303.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(31)
FIELDTYPE:invalid_state_origin:ENUM(NE)
...
FIELDTYPE:invalid_farm_exemptions:ALLOW( /-;,.ABCDEFGHIJKLMNOPQRSTUVWXYZ) 
...
FIELD:corp_farm_exemptions:TYPE(STRING30):LIKE(invalid_farm_exemptions):0,0
