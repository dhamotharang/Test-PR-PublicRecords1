...
//BUG 150718. Filter out records that are flagged as IS_DUPE in sna.file_prop_transaction
 cluster_fares_transactions_prep := join(cluster_fares, sna.file_prop_transaction_stats(NOT IS_DUPE), 
