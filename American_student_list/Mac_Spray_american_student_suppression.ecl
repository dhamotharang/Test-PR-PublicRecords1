...
%spray_suppre% := FileServices.SprayFixed(Source_IP,source_path + file_name,%suppreRecSize%,group_name,American_student_list.thor_cluster + 'in::american_student_list_suppression_'+ filedate,-1,,,,true,true);
