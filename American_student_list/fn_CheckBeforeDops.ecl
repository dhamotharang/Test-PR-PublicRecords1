...
ScrubsFileBase:=dataset(data_services.foreign_prod + 'thor_data400::scrubs_american_student_list::OrbitReports',Scrubs.Layouts.OrbitLogLayout,thor);
ScrubsFileInput:=dataset(data_services.foreign_prod + 'thor_data400::scrubs_american_student_list::OrbitReports',Scrubs.Layouts.OrbitLogLayout,thor);
