...
#workunit('name','Scrubs_UCCV2.DNB_Main_BWR_Hygiene - Hygiene & Stats - SALT V3.8.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT38.MAC_Character_Counts.EclRecord(p,'DNB_Main_Layout_UCCV2'),NAMED('OptimizedLayout'));// File layout suggested by data
