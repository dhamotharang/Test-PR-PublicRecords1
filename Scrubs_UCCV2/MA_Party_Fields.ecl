...
EXPORT MakeFT_invalid_orig_country(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_country(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_country(s)>0);
EXPORT InValidMessageFT_invalid_orig_country(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_country'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_party_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_party_type(SALT37.StrType s) := WHICH(((SALT37.StrType) s) NOT IN ['D','S','A','N']);
EXPORT InValidMessageFT_invalid_party_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInEnum('D|S|A|N'),SALT37.HygieneErrors.Good);
...
EXPORT Make_incorp_state(SALT37.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_incorp_state(SALT37.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_incorp_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
 
EXPORT Make_corp_number(SALT37.StrType s0) := s0;
EXPORT InValid_corp_number(SALT37.StrType s) := 0;
EXPORT InValidMessage_corp_number(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_type(SALT37.StrType s0) := s0;
EXPORT InValid_corp_type(SALT37.StrType s) := 0;
...
EXPORT Make_orig_state(SALT37.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_orig_state(SALT37.StrType s) := InValidFT_invalid_state(s);
...
EXPORT Make_orig_country(SALT37.StrType s0) := MakeFT_invalid_orig_country(s0);
EXPORT InValid_orig_country(SALT37.StrType s) := InValidFT_invalid_orig_country(s);
