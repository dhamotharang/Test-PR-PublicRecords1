...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    NYC_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    NYC_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    NYC_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname),
    NYC_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_fname),
    NYC_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname),
    NYC_Party_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    NYC_Party_Fields.InValid_orig_suffix((SALT38.StrType)le.orig_suffix),
    NYC_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    NYC_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number),
    NYC_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn),
    NYC_Party_Fields.InValid_fein((SALT38.StrType)le.fein),
    NYC_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state),
    NYC_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number),
    NYC_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type),
    NYC_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1),
    NYC_Party_Fields.InValid_orig_address2((SALT38.StrType)le.orig_address2),
    NYC_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    NYC_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state),
    NYC_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5),
    NYC_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    NYC_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country),
    NYC_Party_Fields.InValid_orig_province((SALT38.StrType)le.orig_province),
    NYC_Party_Fields.InValid_orig_postal_code((SALT38.StrType)le.orig_postal_code),
    NYC_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc),
    NYC_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type),
    NYC_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen),
    NYC_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen),
    NYC_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported),
    NYC_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported),
    NYC_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    NYC_Party_Fields.InValid_title((SALT38.StrType)le.title),
    NYC_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    NYC_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    NYC_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name),
    NYC_Party_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    NYC_Party_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    NYC_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname),
    NYC_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    NYC_Party_Fields.InValid_predir((SALT38.StrType)le.predir),
    NYC_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    NYC_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    NYC_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    NYC_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    NYC_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    NYC_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    NYC_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    NYC_Party_Fields.InValid_st((SALT38.StrType)le.st),
    NYC_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5),
    NYC_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    NYC_Party_Fields.InValid_county((SALT38.StrType)le.county),
    NYC_Party_Fields.InValid_cart((SALT38.StrType)le.cart),
    NYC_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    NYC_Party_Fields.InValid_lot((SALT38.StrType)le.lot),
    NYC_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    NYC_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc),
    NYC_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    NYC_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    NYC_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st),
    NYC_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county),
    NYC_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    NYC_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    NYC_Party_Fields.InValid_msa((SALT38.StrType)le.msa),
    NYC_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    NYC_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    NYC_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    NYC_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid),
    NYC_Party_Fields.InValid_did((SALT38.StrType)le.did),
    NYC_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score),
    NYC_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score),
    NYC_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id),
    NYC_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid),
    NYC_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore),
    NYC_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight),
    NYC_Party_Fields.InValid_empid((SALT38.StrType)le.empid),
    NYC_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore),
    NYC_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight),
    NYC_Party_Fields.InValid_powid((SALT38.StrType)le.powid),
    NYC_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore),
    NYC_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight),
    NYC_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid),
    NYC_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore),
    NYC_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight),
    NYC_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid),
    NYC_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore),
    NYC_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight),
    NYC_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid),
    NYC_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore),
    NYC_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight),
    NYC_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid),
    NYC_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore),
    NYC_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight),
    NYC_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1),
    NYC_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line),
    NYC_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid),
    NYC_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid),
    NYC_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, NYC_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
