...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    WA_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    WA_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    WA_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name),
    WA_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname),
    WA_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname),
    WA_Party_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    WA_Party_Fields.InValid_orig_suffix((SALT38.StrType)le.orig_suffix),
    WA_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    WA_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number),
    WA_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn),
    WA_Party_Fields.InValid_fein((SALT38.StrType)le.fein),
    WA_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state),
    WA_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number),
    WA_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type),
    WA_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1),
    WA_Party_Fields.InValid_orig_address2((SALT38.StrType)le.orig_address2),
    WA_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    WA_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state),
    WA_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5),
    WA_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    WA_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country),
    WA_Party_Fields.InValid_orig_province((SALT38.StrType)le.orig_province),
    WA_Party_Fields.InValid_orig_postal_code((SALT38.StrType)le.orig_postal_code),
    WA_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc),
    WA_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type),
    WA_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen),
    WA_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen),
    WA_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported),
    WA_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported),
    WA_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    WA_Party_Fields.InValid_title((SALT38.StrType)le.title),
    WA_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    WA_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    WA_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name),
    WA_Party_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    WA_Party_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    WA_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname),
    WA_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    WA_Party_Fields.InValid_predir((SALT38.StrType)le.predir),
    WA_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    WA_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    WA_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    WA_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    WA_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    WA_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    WA_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    WA_Party_Fields.InValid_st((SALT38.StrType)le.st),
    WA_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5),
    WA_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    WA_Party_Fields.InValid_county((SALT38.StrType)le.county),
    WA_Party_Fields.InValid_cart((SALT38.StrType)le.cart),
    WA_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    WA_Party_Fields.InValid_lot((SALT38.StrType)le.lot),
    WA_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    WA_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc),
    WA_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    WA_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    WA_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st),
    WA_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county),
    WA_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    WA_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    WA_Party_Fields.InValid_msa((SALT38.StrType)le.msa),
    WA_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    WA_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    WA_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    WA_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid),
    WA_Party_Fields.InValid_did((SALT38.StrType)le.did),
    WA_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score),
    WA_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score),
    WA_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id),
    WA_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid),
    WA_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore),
    WA_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight),
    WA_Party_Fields.InValid_empid((SALT38.StrType)le.empid),
    WA_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore),
    WA_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight),
    WA_Party_Fields.InValid_powid((SALT38.StrType)le.powid),
    WA_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore),
    WA_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight),
    WA_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid),
    WA_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore),
    WA_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight),
    WA_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid),
    WA_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore),
    WA_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight),
    WA_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid),
    WA_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore),
    WA_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight),
    WA_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid),
    WA_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore),
    WA_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight),
    WA_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1),
    WA_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line),
    WA_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid),
    WA_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid),
    WA_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, WA_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
