...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    CA_Party_Fields.InValid_tmsid((SALT37.StrType)le.tmsid),
    CA_Party_Fields.InValid_rmsid((SALT37.StrType)le.rmsid),
    CA_Party_Fields.InValid_orig_name((SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_fname),
    CA_Party_Fields.InValid_orig_lname((SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_fname),
    CA_Party_Fields.InValid_orig_fname((SALT37.StrType)le.orig_fname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname),
    CA_Party_Fields.InValid_orig_mname((SALT37.StrType)le.orig_mname),
    CA_Party_Fields.InValid_orig_suffix((SALT37.StrType)le.orig_suffix),
    CA_Party_Fields.InValid_duns_number((SALT37.StrType)le.duns_number),
    CA_Party_Fields.InValid_hq_duns_number((SALT37.StrType)le.hq_duns_number),
    CA_Party_Fields.InValid_ssn((SALT37.StrType)le.ssn),
    CA_Party_Fields.InValid_fein((SALT37.StrType)le.fein),
    CA_Party_Fields.InValid_incorp_state((SALT37.StrType)le.incorp_state),
    CA_Party_Fields.InValid_corp_number((SALT37.StrType)le.corp_number),
    CA_Party_Fields.InValid_corp_type((SALT37.StrType)le.corp_type),
    CA_Party_Fields.InValid_orig_address1((SALT37.StrType)le.orig_address1),
    CA_Party_Fields.InValid_orig_address2((SALT37.StrType)le.orig_address2),
    CA_Party_Fields.InValid_orig_city((SALT37.StrType)le.orig_city),
    CA_Party_Fields.InValid_orig_state((SALT37.StrType)le.orig_state),
    CA_Party_Fields.InValid_orig_zip5((SALT37.StrType)le.orig_zip5),
    CA_Party_Fields.InValid_orig_zip4((SALT37.StrType)le.orig_zip4),
    CA_Party_Fields.InValid_orig_country((SALT37.StrType)le.orig_country),
    CA_Party_Fields.InValid_orig_province((SALT37.StrType)le.orig_province),
    CA_Party_Fields.InValid_orig_postal_code((SALT37.StrType)le.orig_postal_code),
    CA_Party_Fields.InValid_foreign_indc((SALT37.StrType)le.foreign_indc),
    CA_Party_Fields.InValid_party_type((SALT37.StrType)le.party_type),
    CA_Party_Fields.InValid_dt_first_seen((SALT37.StrType)le.dt_first_seen),
    CA_Party_Fields.InValid_dt_last_seen((SALT37.StrType)le.dt_last_seen),
    CA_Party_Fields.InValid_dt_vendor_last_reported((SALT37.StrType)le.dt_vendor_last_reported),
    CA_Party_Fields.InValid_dt_vendor_first_reported((SALT37.StrType)le.dt_vendor_first_reported),
    CA_Party_Fields.InValid_process_date((SALT37.StrType)le.process_date),
    CA_Party_Fields.InValid_title((SALT37.StrType)le.title),
    CA_Party_Fields.InValid_fname((SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    CA_Party_Fields.InValid_mname((SALT37.StrType)le.mname,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    CA_Party_Fields.InValid_lname((SALT37.StrType)le.lname,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.company_name),
    CA_Party_Fields.InValid_name_suffix((SALT37.StrType)le.name_suffix),
    CA_Party_Fields.InValid_name_score((SALT37.StrType)le.name_score),
    CA_Party_Fields.InValid_company_name((SALT37.StrType)le.company_name,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname),
    CA_Party_Fields.InValid_prim_range((SALT37.StrType)le.prim_range),
    CA_Party_Fields.InValid_predir((SALT37.StrType)le.predir),
    CA_Party_Fields.InValid_prim_name((SALT37.StrType)le.prim_name),
    CA_Party_Fields.InValid_suffix((SALT37.StrType)le.suffix),
    CA_Party_Fields.InValid_postdir((SALT37.StrType)le.postdir),
    CA_Party_Fields.InValid_unit_desig((SALT37.StrType)le.unit_desig),
    CA_Party_Fields.InValid_sec_range((SALT37.StrType)le.sec_range),
    CA_Party_Fields.InValid_p_city_name((SALT37.StrType)le.p_city_name),
    CA_Party_Fields.InValid_v_city_name((SALT37.StrType)le.v_city_name),
    CA_Party_Fields.InValid_st((SALT37.StrType)le.st),
    CA_Party_Fields.InValid_zip5((SALT37.StrType)le.zip5),
    CA_Party_Fields.InValid_zip4((SALT37.StrType)le.zip4),
    CA_Party_Fields.InValid_county((SALT37.StrType)le.county),
    CA_Party_Fields.InValid_cart((SALT37.StrType)le.cart),
    CA_Party_Fields.InValid_cr_sort_sz((SALT37.StrType)le.cr_sort_sz),
    CA_Party_Fields.InValid_lot((SALT37.StrType)le.lot),
    CA_Party_Fields.InValid_lot_order((SALT37.StrType)le.lot_order),
    CA_Party_Fields.InValid_dpbc((SALT37.StrType)le.dpbc),
    CA_Party_Fields.InValid_chk_digit((SALT37.StrType)le.chk_digit),
    CA_Party_Fields.InValid_rec_type((SALT37.StrType)le.rec_type),
    CA_Party_Fields.InValid_ace_fips_st((SALT37.StrType)le.ace_fips_st),
    CA_Party_Fields.InValid_ace_fips_county((SALT37.StrType)le.ace_fips_county),
    CA_Party_Fields.InValid_geo_lat((SALT37.StrType)le.geo_lat),
    CA_Party_Fields.InValid_geo_long((SALT37.StrType)le.geo_long),
    CA_Party_Fields.InValid_msa((SALT37.StrType)le.msa),
    CA_Party_Fields.InValid_geo_blk((SALT37.StrType)le.geo_blk),
    CA_Party_Fields.InValid_geo_match((SALT37.StrType)le.geo_match),
    CA_Party_Fields.InValid_err_stat((SALT37.StrType)le.err_stat),
    CA_Party_Fields.InValid_bdid((SALT37.StrType)le.bdid),
    CA_Party_Fields.InValid_did((SALT37.StrType)le.did),
    CA_Party_Fields.InValid_did_score((SALT37.StrType)le.did_score),
    CA_Party_Fields.InValid_bdid_score((SALT37.StrType)le.bdid_score),
    CA_Party_Fields.InValid_source_rec_id((SALT37.StrType)le.source_rec_id),
    CA_Party_Fields.InValid_dotid((SALT37.StrType)le.dotid),
    CA_Party_Fields.InValid_dotscore((SALT37.StrType)le.dotscore),
    CA_Party_Fields.InValid_dotweight((SALT37.StrType)le.dotweight),
    CA_Party_Fields.InValid_empid((SALT37.StrType)le.empid),
    CA_Party_Fields.InValid_empscore((SALT37.StrType)le.empscore),
    CA_Party_Fields.InValid_empweight((SALT37.StrType)le.empweight),
    CA_Party_Fields.InValid_powid((SALT37.StrType)le.powid),
    CA_Party_Fields.InValid_powscore((SALT37.StrType)le.powscore),
    CA_Party_Fields.InValid_powweight((SALT37.StrType)le.powweight),
    CA_Party_Fields.InValid_proxid((SALT37.StrType)le.proxid),
    CA_Party_Fields.InValid_proxscore((SALT37.StrType)le.proxscore),
    CA_Party_Fields.InValid_proxweight((SALT37.StrType)le.proxweight),
    CA_Party_Fields.InValid_seleid((SALT37.StrType)le.seleid),
    CA_Party_Fields.InValid_selescore((SALT37.StrType)le.selescore),
    CA_Party_Fields.InValid_seleweight((SALT37.StrType)le.seleweight),
    CA_Party_Fields.InValid_orgid((SALT37.StrType)le.orgid),
    CA_Party_Fields.InValid_orgscore((SALT37.StrType)le.orgscore),
    CA_Party_Fields.InValid_orgweight((SALT37.StrType)le.orgweight),
    CA_Party_Fields.InValid_ultid((SALT37.StrType)le.ultid),
    CA_Party_Fields.InValid_ultscore((SALT37.StrType)le.ultscore),
    CA_Party_Fields.InValid_ultweight((SALT37.StrType)le.ultweight),
    CA_Party_Fields.InValid_prep_addr_line1((SALT37.StrType)le.prep_addr_line1),
    CA_Party_Fields.InValid_prep_addr_last_line((SALT37.StrType)le.prep_addr_last_line),
    CA_Party_Fields.InValid_rawaid((SALT37.StrType)le.rawaid),
    CA_Party_Fields.InValid_aceaid((SALT37.StrType)le.aceaid),
    CA_Party_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id),
    0);
