...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MA_Main_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    MA_Main_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    MA_Main_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    MA_Main_Fields.InValid_static_value((SALT38.StrType)le.static_value),
    MA_Main_Fields.InValid_date_vendor_removed((SALT38.StrType)le.date_vendor_removed),
    MA_Main_Fields.InValid_date_vendor_changed((SALT38.StrType)le.date_vendor_changed),
    MA_Main_Fields.InValid_filing_jurisdiction((SALT38.StrType)le.filing_jurisdiction),
    MA_Main_Fields.InValid_orig_filing_number((SALT38.StrType)le.orig_filing_number),
    MA_Main_Fields.InValid_orig_filing_type((SALT38.StrType)le.orig_filing_type),
    MA_Main_Fields.InValid_orig_filing_date((SALT38.StrType)le.orig_filing_date),
    MA_Main_Fields.InValid_orig_filing_time((SALT38.StrType)le.orig_filing_time),
    MA_Main_Fields.InValid_filing_number((SALT38.StrType)le.filing_number),
    MA_Main_Fields.InValid_filing_number_indc((SALT38.StrType)le.filing_number_indc),
    MA_Main_Fields.InValid_filing_type((SALT38.StrType)le.filing_type),
    MA_Main_Fields.InValid_filing_date((SALT38.StrType)le.filing_date),
    MA_Main_Fields.InValid_filing_time((SALT38.StrType)le.filing_time),
    MA_Main_Fields.InValid_filing_status((SALT38.StrType)le.filing_status),
    MA_Main_Fields.InValid_status_type((SALT38.StrType)le.status_type),
    MA_Main_Fields.InValid_page((SALT38.StrType)le.page),
    MA_Main_Fields.InValid_expiration_date((SALT38.StrType)le.expiration_date),
    MA_Main_Fields.InValid_contract_type((SALT38.StrType)le.contract_type),
    MA_Main_Fields.InValid_vendor_entry_date((SALT38.StrType)le.vendor_entry_date),
    MA_Main_Fields.InValid_vendor_upd_date((SALT38.StrType)le.vendor_upd_date),
    MA_Main_Fields.InValid_statements_filed((SALT38.StrType)le.statements_filed),
    MA_Main_Fields.InValid_continuious_expiration((SALT38.StrType)le.continuious_expiration),
    MA_Main_Fields.InValid_microfilm_number((SALT38.StrType)le.microfilm_number),
    MA_Main_Fields.InValid_amount((SALT38.StrType)le.amount),
    MA_Main_Fields.InValid_irs_serial_number((SALT38.StrType)le.irs_serial_number),
    MA_Main_Fields.InValid_effective_date((SALT38.StrType)le.effective_date),
    MA_Main_Fields.InValid_signer_name((SALT38.StrType)le.signer_name),
    MA_Main_Fields.InValid_title((SALT38.StrType)le.title),
    MA_Main_Fields.InValid_filing_agency((SALT38.StrType)le.filing_agency),
    MA_Main_Fields.InValid_address((SALT38.StrType)le.address),
    MA_Main_Fields.InValid_city((SALT38.StrType)le.city),
    MA_Main_Fields.InValid_state((SALT38.StrType)le.state),
    MA_Main_Fields.InValid_county((SALT38.StrType)le.county),
    MA_Main_Fields.InValid_zip((SALT38.StrType)le.zip),
    MA_Main_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    MA_Main_Fields.InValid_cmnt_effective_date((SALT38.StrType)le.cmnt_effective_date),
    MA_Main_Fields.InValid_description((SALT38.StrType)le.description),
    MA_Main_Fields.InValid_collateral_desc((SALT38.StrType)le.collateral_desc),
    MA_Main_Fields.InValid_prim_machine((SALT38.StrType)le.prim_machine),
    MA_Main_Fields.InValid_sec_machine((SALT38.StrType)le.sec_machine),
    MA_Main_Fields.InValid_manufacturer_code((SALT38.StrType)le.manufacturer_code),
    MA_Main_Fields.InValid_manufacturer_name((SALT38.StrType)le.manufacturer_name),
    MA_Main_Fields.InValid_model((SALT38.StrType)le.model),
    MA_Main_Fields.InValid_model_year((SALT38.StrType)le.model_year),
    MA_Main_Fields.InValid_model_desc((SALT38.StrType)le.model_desc),
    MA_Main_Fields.InValid_collateral_count((SALT38.StrType)le.collateral_count),
    MA_Main_Fields.InValid_manufactured_year((SALT38.StrType)le.manufactured_year),
    MA_Main_Fields.InValid_new_used((SALT38.StrType)le.new_used),
    MA_Main_Fields.InValid_serial_number((SALT38.StrType)le.serial_number),
    MA_Main_Fields.InValid_property_desc((SALT38.StrType)le.property_desc),
    MA_Main_Fields.InValid_borough((SALT38.StrType)le.borough),
    MA_Main_Fields.InValid_block((SALT38.StrType)le.block),
    MA_Main_Fields.InValid_lot((SALT38.StrType)le.lot),
    MA_Main_Fields.InValid_collateral_address((SALT38.StrType)le.collateral_address),
    MA_Main_Fields.InValid_air_rights_indc((SALT38.StrType)le.air_rights_indc),
    MA_Main_Fields.InValid_subterranean_rights_indc((SALT38.StrType)le.subterranean_rights_indc),
    MA_Main_Fields.InValid_easment_indc((SALT38.StrType)le.easment_indc),
    MA_Main_Fields.InValid_volume((SALT38.StrType)le.volume),
    MA_Main_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, MA_Main_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
