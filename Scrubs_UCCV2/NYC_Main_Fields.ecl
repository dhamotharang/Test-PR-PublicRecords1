...
EXPORT NYC_Main_Fields := MODULE
 
EXPORT NumFields := 62;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_numeric','invalid_numeric_blank','invalid_boolean_yn_blank','invalid_empty','invalid_8pastdate','invalid_tmsid','invalid_rmsid','invalid_date_vendor_changed','invalid_filing_jurisdiction','invalid_orig_filing_number','invalid_orig_filing_type','invalid_orig_filing_date','invalid_filing_number','invalid_filing_type','invalid_filing_date','invalid_borough');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_numeric' => 2,'invalid_numeric_blank' => 3,'invalid_boolean_yn_blank' => 4,'invalid_empty' => 5,'invalid_8pastdate' => 6,'invalid_tmsid' => 7,'invalid_rmsid' => 8,'invalid_date_vendor_changed' => 9,'invalid_filing_jurisdiction' => 10,'invalid_orig_filing_number' => 11,'invalid_orig_filing_type' => 12,'invalid_orig_filing_date' => 13,'invalid_filing_number' => 14,'invalid_filing_type' => 15,'invalid_filing_date' => 16,'invalid_borough' => 17,0);
...
EXPORT MakeFT_invalid_boolean_yn_blank(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean_yn_blank(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['N','Y','']);
EXPORT InValidMessageFT_invalid_boolean_yn_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('N|Y|'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_rmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_non_empty_numeric(s)>0);
EXPORT InValidMessageFT_invalid_rmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_non_empty_numeric'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date_vendor_changed(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_vendor_changed(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd(s)>0);
EXPORT InValidMessageFT_invalid_date_vendor_changed(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['NYC','NYC']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('NYC|NYC'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_nyc_filing_number(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_nyc_filing_number'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_nyc_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_nyc_orig_filing_type'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_date(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_date(SALT38.StrType s,SALT38.StrType filing_date) := WHICH(~Scrubs_UCCV2.Functions.fn_date1_xor_date2(s,filing_date)>0);
EXPORT InValidMessageFT_invalid_orig_filing_date(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_date1_xor_date2'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_nyc_filing_number(s)>0);
EXPORT InValidMessageFT_invalid_filing_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_nyc_filing_number'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_nyc_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_nyc_filing_type'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_date(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_date(SALT38.StrType s,SALT38.StrType orig_filing_date) := WHICH(~Scrubs_UCCV2.Functions.fn_date1_xor_date2(s,orig_filing_date)>0);
EXPORT InValidMessageFT_invalid_filing_date(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_date1_xor_date2'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_borough(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_borough(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_nyc_borough(s)>0);
EXPORT InValidMessageFT_invalid_borough(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_nyc_borough'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],[],[],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],['CUSTOM'],['LENGTH'],['CUSTOM'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ALLOW'],['ALLOW'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['CUSTOM'],['ALLOW'],[],[],['ENUM'],['ENUM'],['ENUM'],['LENGTH'],['LENGTH'],[]);
...
EXPORT Make_date_vendor_changed(SALT38.StrType s0) := MakeFT_invalid_date_vendor_changed(s0);
EXPORT InValid_date_vendor_changed(SALT38.StrType s) := InValidFT_invalid_date_vendor_changed(s);
EXPORT InValidMessage_date_vendor_changed(UNSIGNED1 wh) := InValidMessageFT_invalid_date_vendor_changed(wh);
...
EXPORT InValid_orig_filing_date(SALT38.StrType s,SALT38.StrType filing_date) := InValidFT_invalid_orig_filing_date(s,filing_date);
...
EXPORT InValid_filing_date(SALT38.StrType s,SALT38.StrType orig_filing_date) := InValidFT_invalid_filing_date(s,orig_filing_date);
EXPORT InValidMessage_filing_date(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_date(wh);
 
EXPORT Make_filing_time(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_filing_time(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_filing_time(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
...
EXPORT Make_expiration_date(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_expiration_date(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_expiration_date(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
...
EXPORT Make_amount(SALT38.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_amount(SALT38.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_irs_serial_number(SALT38.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_irs_serial_number(SALT38.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_irs_serial_number(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
...
EXPORT Make_signer_name(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_signer_name(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_borough(SALT38.StrType s0) := MakeFT_invalid_borough(s0);
EXPORT InValid_borough(SALT38.StrType s) := InValidFT_invalid_borough(s);
EXPORT InValidMessage_borough(UNSIGNED1 wh) := InValidMessageFT_invalid_borough(wh);
 
EXPORT Make_block(SALT38.StrType s0) := MakeFT_invalid_numeric_blank(s0);
EXPORT InValid_block(SALT38.StrType s) := InValidFT_invalid_numeric_blank(s);
EXPORT InValidMessage_block(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric_blank(wh);
 
EXPORT Make_lot(SALT38.StrType s0) := s0;
EXPORT InValid_lot(SALT38.StrType s) := 0;
EXPORT InValidMessage_lot(UNSIGNED1 wh) := '';
 
EXPORT Make_collateral_address(SALT38.StrType s0) := s0;
EXPORT InValid_collateral_address(SALT38.StrType s) := 0;
EXPORT InValidMessage_collateral_address(UNSIGNED1 wh) := '';
 
EXPORT Make_air_rights_indc(SALT38.StrType s0) := MakeFT_invalid_boolean_yn_blank(s0);
EXPORT InValid_air_rights_indc(SALT38.StrType s) := InValidFT_invalid_boolean_yn_blank(s);
EXPORT InValidMessage_air_rights_indc(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean_yn_blank(wh);
 
EXPORT Make_subterranean_rights_indc(SALT38.StrType s0) := MakeFT_invalid_boolean_yn_blank(s0);
EXPORT InValid_subterranean_rights_indc(SALT38.StrType s) := InValidFT_invalid_boolean_yn_blank(s);
EXPORT InValidMessage_subterranean_rights_indc(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean_yn_blank(wh);
 
EXPORT Make_easment_indc(SALT38.StrType s0) := MakeFT_invalid_boolean_yn_blank(s0);
EXPORT InValid_easment_indc(SALT38.StrType s) := InValidFT_invalid_boolean_yn_blank(s);
EXPORT InValidMessage_easment_indc(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean_yn_blank(wh);
