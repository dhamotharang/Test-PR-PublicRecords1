...
Command line options: -MScrubs_UCCV2 -eC:\Users\wolfkg\AppData\Local\Temp\TFRC0DB.tmp 
...
FIELDTYPE:invalid_filing_jurisdiction:ENUM(TX|TX)
FIELDTYPE:invalid_orig_filing_number:CUSTOM(Scrubs_UCCV2.Functions.fn_non_empty_numeric>0)
FIELDTYPE:invalid_orig_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_tx_orig_filing_type>0)
...
FIELDTYPE:invalid_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_tx_filing_type>0)
...
FIELDTYPE:invalid_status:CUSTOM(Scrubs_UCCV2.Functions.fn_status_type>0)
FIELDTYPE:invalid_page:CUSTOM(Scrubs_UCCV2.Functions.fn_numeric>0)
...
FIELD:filing_status:TYPE(STRING8):LIKE(invalid_status):0,0
FIELD:status_type:TYPE(STRING30):LIKE(invalid_status):0,0
FIELD:page:TYPE(STRING3):LIKE(invalid_page):0,0
