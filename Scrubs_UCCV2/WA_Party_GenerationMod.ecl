...
IMPORT SALT39;
EXPORT WA_Party_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + '\n'
    + 'FIELDTYPE:invalid_tmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid>0,\'WA\')\n'
    + 'FIELDTYPE:invalid_rmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid>0,\'WA\')\n'
    ...
    + 'FIELDTYPE:invalid_orig_country:CUSTOM(Scrubs_UCCV2.Functions.fn_country_2_or_3_code>0)\n'
    ...
    + 'FIELD:orig_name:TYPE(STRING120):LIKE(invalid_mandatory):0,0\n'
