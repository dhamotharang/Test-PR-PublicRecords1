IMPORT SALT39,STD;
EXPORT TX_Party_hygiene(dataset(TX_Party_layout_UCCV2) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    TX_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid),
    TX_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid),
    TX_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_fname),
    TX_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_fname),
    TX_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname),
    TX_Party_Fields.InValid_orig_mname((SALT39.StrType)le.orig_mname),
    TX_Party_Fields.InValid_orig_suffix((SALT39.StrType)le.orig_suffix),
    TX_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number),
    TX_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number),
    TX_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn),
    TX_Party_Fields.InValid_fein((SALT39.StrType)le.fein),
    TX_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state),
    TX_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number),
    TX_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type),
    TX_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1),
    TX_Party_Fields.InValid_orig_address2((SALT39.StrType)le.orig_address2),
    TX_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city),
    TX_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state),
    TX_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country),
    TX_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4),
    TX_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country),
    TX_Party_Fields.InValid_orig_province((SALT39.StrType)le.orig_province),
    TX_Party_Fields.InValid_orig_postal_code((SALT39.StrType)le.orig_postal_code),
    TX_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc),
    TX_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type),
    TX_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen),
    TX_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen),
    TX_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported),
    TX_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported),
    TX_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date),
    TX_Party_Fields.InValid_title((SALT39.StrType)le.title),
    TX_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    TX_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    TX_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name),
    TX_Party_Fields.InValid_name_suffix((SALT39.StrType)le.name_suffix),
    TX_Party_Fields.InValid_name_score((SALT39.StrType)le.name_score),
    TX_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname),
    TX_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range),
    TX_Party_Fields.InValid_predir((SALT39.StrType)le.predir),
    TX_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name),
    TX_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix),
    TX_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir),
    TX_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig),
    TX_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range),
    TX_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name),
    TX_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name),
    TX_Party_Fields.InValid_st((SALT39.StrType)le.st),
    TX_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5),
    TX_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4),
    TX_Party_Fields.InValid_county((SALT39.StrType)le.county),
    TX_Party_Fields.InValid_cart((SALT39.StrType)le.cart),
    TX_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz),
    TX_Party_Fields.InValid_lot((SALT39.StrType)le.lot),
    TX_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order),
    TX_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc),
    TX_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit),
    TX_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type),
    TX_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st),
    TX_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county),
    TX_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat),
    TX_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long),
    TX_Party_Fields.InValid_msa((SALT39.StrType)le.msa),
    TX_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk),
    TX_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match),
    TX_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat),
    TX_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid),
    TX_Party_Fields.InValid_did((SALT39.StrType)le.did),
    TX_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score),
    TX_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score),
    TX_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id),
    TX_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid),
    TX_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore),
    TX_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight),
    TX_Party_Fields.InValid_empid((SALT39.StrType)le.empid),
    TX_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore),
    TX_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight),
    TX_Party_Fields.InValid_powid((SALT39.StrType)le.powid),
    TX_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore),
    TX_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight),
    TX_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid),
    TX_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore),
    TX_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight),
    TX_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid),
    TX_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore),
    TX_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight),
    TX_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid),
    TX_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore),
    TX_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight),
    TX_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid),
    TX_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore),
    TX_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight),
    TX_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1),
    TX_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line),
    TX_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid),
    TX_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid),
    TX_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := TX_Party_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_tmsid','invalid_rmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','Unknown','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','Unknown','Unknown','invalid_mandatory','Unknown','invalid_mandatory','invalid_state','invalid_zip5','Unknown','invalid_orig_country','Unknown','Unknown','invalid_boolean_yn','invalid_party_type','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate8','Unknown','invalid_fname','invalid_mname','invalid_lname','Unknown','Unknown','invalid_company_name','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_mandatory','invalid_mandatory','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,TX_Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_hq_duns_number(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_fein(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_incorp_state(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_corp_number(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_corp_type(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_province(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orig_postal_code(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_foreign_indc(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_party_type(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_zip5(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ace_fips_st(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ace_fips_county(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_bdid_score(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_source_rec_id(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dotid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dotscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_dotweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_empid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_empscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_empweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_powid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_powscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_powweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_proxscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_proxweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_selescore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_seleweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orgscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_orgweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ultscore(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_ultweight(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_prep_addr_line1(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_prep_addr_last_line(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_aceaid(TotalErrors.ErrorNum),TX_Party_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, TX_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
