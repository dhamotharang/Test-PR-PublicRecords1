...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    TX_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    TX_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    TX_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname),
    TX_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_fname),
    TX_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname),
    TX_Party_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    TX_Party_Fields.InValid_orig_suffix((SALT38.StrType)le.orig_suffix),
    TX_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    TX_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number),
    TX_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn),
    TX_Party_Fields.InValid_fein((SALT38.StrType)le.fein),
    TX_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state),
    TX_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number),
    TX_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type),
    TX_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1),
    TX_Party_Fields.InValid_orig_address2((SALT38.StrType)le.orig_address2),
    TX_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    TX_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state),
    TX_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5),
    TX_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    TX_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country),
    TX_Party_Fields.InValid_orig_province((SALT38.StrType)le.orig_province),
    TX_Party_Fields.InValid_orig_postal_code((SALT38.StrType)le.orig_postal_code),
    TX_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc),
    TX_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type),
    TX_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen),
    TX_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen),
    TX_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported),
    TX_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported),
    TX_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    TX_Party_Fields.InValid_title((SALT38.StrType)le.title),
    TX_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    TX_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    TX_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name),
    TX_Party_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    TX_Party_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    TX_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname),
    TX_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    TX_Party_Fields.InValid_predir((SALT38.StrType)le.predir),
    TX_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    TX_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    TX_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    TX_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    TX_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    TX_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    TX_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    TX_Party_Fields.InValid_st((SALT38.StrType)le.st),
    TX_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5),
    TX_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    TX_Party_Fields.InValid_county((SALT38.StrType)le.county),
    TX_Party_Fields.InValid_cart((SALT38.StrType)le.cart),
    TX_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    TX_Party_Fields.InValid_lot((SALT38.StrType)le.lot),
    TX_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    TX_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc),
    TX_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    TX_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    TX_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st),
    TX_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county),
    TX_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    TX_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    TX_Party_Fields.InValid_msa((SALT38.StrType)le.msa),
    TX_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    TX_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    TX_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    TX_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid),
    TX_Party_Fields.InValid_did((SALT38.StrType)le.did),
    TX_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score),
    TX_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score),
    TX_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id),
    TX_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid),
    TX_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore),
    TX_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight),
    TX_Party_Fields.InValid_empid((SALT38.StrType)le.empid),
    TX_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore),
    TX_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight),
    TX_Party_Fields.InValid_powid((SALT38.StrType)le.powid),
    TX_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore),
    TX_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight),
    TX_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid),
    TX_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore),
    TX_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight),
    TX_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid),
    TX_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore),
    TX_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight),
    TX_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid),
    TX_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore),
    TX_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight),
    TX_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid),
    TX_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore),
    TX_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight),
    TX_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1),
    TX_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line),
    TX_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid),
    TX_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid),
    TX_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, TX_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
