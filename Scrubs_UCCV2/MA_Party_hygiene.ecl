IMPORT SALT37;
EXPORT MA_Party_hygiene(dataset(MA_Party_layout_UCCV2) h) := MODULE
...
EXPORT Summary(SALT37.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_orig_lname := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_lname)));
    avelength_orig_lname := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_lname)),h.orig_lname<>(typeof(h.orig_lname))'');
    populated_orig_fname_pcnt := AVE(GROUP,IF(h.orig_fname = (TYPEOF(h.orig_fname))'',0,100));
    maxlength_orig_fname := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_fname)));
    avelength_orig_fname := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_fname)),h.orig_fname<>(typeof(h.orig_fname))'');
    populated_orig_mname_pcnt := AVE(GROUP,IF(h.orig_mname = (TYPEOF(h.orig_mname))'',0,100));
    maxlength_orig_mname := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_mname)));
    avelength_orig_mname := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_mname)),h.orig_mname<>(typeof(h.orig_mname))'');
    populated_orig_suffix_pcnt := AVE(GROUP,IF(h.orig_suffix = (TYPEOF(h.orig_suffix))'',0,100));
    maxlength_orig_suffix := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_suffix)));
    avelength_orig_suffix := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_suffix)),h.orig_suffix<>(typeof(h.orig_suffix))'');
    ...
    maxlength_hq_duns_number := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.hq_duns_number)));
    avelength_hq_duns_number := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.hq_duns_number)),h.hq_duns_number<>(typeof(h.hq_duns_number))'');
    ...
    maxlength_fein := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.fein)));
    avelength_fein := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.fein)),h.fein<>(typeof(h.fein))'');
    populated_incorp_state_pcnt := AVE(GROUP,IF(h.incorp_state = (TYPEOF(h.incorp_state))'',0,100));
    maxlength_incorp_state := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.incorp_state)));
    avelength_incorp_state := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.incorp_state)),h.incorp_state<>(typeof(h.incorp_state))'');
    populated_corp_number_pcnt := AVE(GROUP,IF(h.corp_number = (TYPEOF(h.corp_number))'',0,100));
    maxlength_corp_number := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.corp_number)));
    avelength_corp_number := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.corp_number)),h.corp_number<>(typeof(h.corp_number))'');
    populated_corp_type_pcnt := AVE(GROUP,IF(h.corp_type = (TYPEOF(h.corp_type))'',0,100));
    maxlength_corp_type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.corp_type)));
    avelength_corp_type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.corp_type)),h.corp_type<>(typeof(h.corp_type))'');
    populated_orig_address1_pcnt := AVE(GROUP,IF(h.orig_address1 = (TYPEOF(h.orig_address1))'',0,100));
    maxlength_orig_address1 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_address1)));
    avelength_orig_address1 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_address1)),h.orig_address1<>(typeof(h.orig_address1))'');
    populated_orig_address2_pcnt := AVE(GROUP,IF(h.orig_address2 = (TYPEOF(h.orig_address2))'',0,100));
    maxlength_orig_address2 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_address2)));
    avelength_orig_address2 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_address2)),h.orig_address2<>(typeof(h.orig_address2))'');
    ...
    maxlength_orig_state := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_state)));
    avelength_orig_state := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_state)),h.orig_state<>(typeof(h.orig_state))'');
    populated_orig_zip5_pcnt := AVE(GROUP,IF(h.orig_zip5 = (TYPEOF(h.orig_zip5))'',0,100));
    maxlength_orig_zip5 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_zip5)));
    avelength_orig_zip5 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_zip5)),h.orig_zip5<>(typeof(h.orig_zip5))'');
    populated_orig_zip4_pcnt := AVE(GROUP,IF(h.orig_zip4 = (TYPEOF(h.orig_zip4))'',0,100));
    maxlength_orig_zip4 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_zip4)));
    avelength_orig_zip4 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_zip4)),h.orig_zip4<>(typeof(h.orig_zip4))'');
    populated_orig_country_pcnt := AVE(GROUP,IF(h.orig_country = (TYPEOF(h.orig_country))'',0,100));
    maxlength_orig_country := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_country)));
    avelength_orig_country := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_country)),h.orig_country<>(typeof(h.orig_country))'');
    populated_orig_province_pcnt := AVE(GROUP,IF(h.orig_province = (TYPEOF(h.orig_province))'',0,100));
    maxlength_orig_province := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_province)));
    avelength_orig_province := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_province)),h.orig_province<>(typeof(h.orig_province))'');
    populated_orig_postal_code_pcnt := AVE(GROUP,IF(h.orig_postal_code = (TYPEOF(h.orig_postal_code))'',0,100));
    maxlength_orig_postal_code := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_postal_code)));
    avelength_orig_postal_code := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.orig_postal_code)),h.orig_postal_code<>(typeof(h.orig_postal_code))'');
    populated_foreign_indc_pcnt := AVE(GROUP,IF(h.foreign_indc = (TYPEOF(h.foreign_indc))'',0,100));
    maxlength_foreign_indc := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.foreign_indc)));
    avelength_foreign_indc := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.foreign_indc)),h.foreign_indc<>(typeof(h.foreign_indc))'');
    populated_party_type_pcnt := AVE(GROUP,IF(h.party_type = (TYPEOF(h.party_type))'',0,100));
    maxlength_party_type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.party_type)));
    avelength_party_type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.party_type)),h.party_type<>(typeof(h.party_type))'');
    ...
    maxlength_ace_fips_county := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.ace_fips_county)));
    avelength_ace_fips_county := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.ace_fips_county)),h.ace_fips_county<>(typeof(h.ace_fips_county))'');
    ...
    maxlength_did_score := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.did_score)));
    avelength_did_score := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.did_score)),h.did_score<>(typeof(h.did_score))'');
    populated_bdid_score_pcnt := AVE(GROUP,IF(h.bdid_score = (TYPEOF(h.bdid_score))'',0,100));
    maxlength_bdid_score := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.bdid_score)));
    avelength_bdid_score := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.bdid_score)),h.bdid_score<>(typeof(h.bdid_score))'');
...
SALT37.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT37.StrType)le.tmsid),TRIM((SALT37.StrType)le.rmsid),TRIM((SALT37.StrType)le.orig_name),TRIM((SALT37.StrType)le.orig_lname),TRIM((SALT37.StrType)le.orig_fname),TRIM((SALT37.StrType)le.orig_mname),TRIM((SALT37.StrType)le.orig_suffix),TRIM((SALT37.StrType)le.duns_number),TRIM((SALT37.StrType)le.hq_duns_number),TRIM((SALT37.StrType)le.ssn),TRIM((SALT37.StrType)le.fein),TRIM((SALT37.StrType)le.incorp_state),TRIM((SALT37.StrType)le.corp_number),TRIM((SALT37.StrType)le.corp_type),TRIM((SALT37.StrType)le.orig_address1),TRIM((SALT37.StrType)le.orig_address2),TRIM((SALT37.StrType)le.orig_city),TRIM((SALT37.StrType)le.orig_state),TRIM((SALT37.StrType)le.orig_zip5),TRIM((SALT37.StrType)le.orig_zip4),TRIM((SALT37.StrType)le.orig_country),TRIM((SALT37.StrType)le.orig_province),TRIM((SALT37.StrType)le.orig_postal_code),TRIM((SALT37.StrType)le.foreign_indc),TRIM((SALT37.StrType)le.party_type),IF (le.dt_first_seen <> 0,TRIM((SALT37.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT37.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_first_reported), ''),TRIM((SALT37.StrType)le.process_date),TRIM((SALT37.StrType)le.title),TRIM((SALT37.StrType)le.fname),TRIM((SALT37.StrType)le.mname),TRIM((SALT37.StrType)le.lname),TRIM((SALT37.StrType)le.name_suffix),TRIM((SALT37.StrType)le.name_score),TRIM((SALT37.StrType)le.company_name),TRIM((SALT37.StrType)le.prim_range),TRIM((SALT37.StrType)le.predir),TRIM((SALT37.StrType)le.prim_name),TRIM((SALT37.StrType)le.suffix),TRIM((SALT37.StrType)le.postdir),TRIM((SALT37.StrType)le.unit_desig),TRIM((SALT37.StrType)le.sec_range),TRIM((SALT37.StrType)le.p_city_name),TRIM((SALT37.StrType)le.v_city_name),TRIM((SALT37.StrType)le.st),TRIM((SALT37.StrType)le.zip5),TRIM((SALT37.StrType)le.zip4),TRIM((SALT37.StrType)le.county),TRIM((SALT37.StrType)le.cart),TRIM((SALT37.StrType)le.cr_sort_sz),TRIM((SALT37.StrType)le.lot),TRIM((SALT37.StrType)le.lot_order),TRIM((SALT37.StrType)le.dpbc),TRIM((SALT37.StrType)le.chk_digit),TRIM((SALT37.StrType)le.rec_type),TRIM((SALT37.StrType)le.ace_fips_st),TRIM((SALT37.StrType)le.ace_fips_county),TRIM((SALT37.StrType)le.geo_lat),TRIM((SALT37.StrType)le.geo_long),TRIM((SALT37.StrType)le.msa),TRIM((SALT37.StrType)le.geo_blk),TRIM((SALT37.StrType)le.geo_match),TRIM((SALT37.StrType)le.err_stat),IF (le.bdid <> 0,TRIM((SALT37.StrType)le.bdid), ''),IF (le.did <> 0,TRIM((SALT37.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT37.StrType)le.did_score), ''),IF (le.bdid_score <> 0,TRIM((SALT37.StrType)le.bdid_score), ''),IF (le.source_rec_id <> 0,TRIM((SALT37.StrType)le.source_rec_id), ''),IF (le.dotid <> 0,TRIM((SALT37.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT37.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT37.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT37.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT37.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT37.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT37.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT37.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT37.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT37.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT37.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT37.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT37.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT37.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT37.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT37.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT37.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT37.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT37.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT37.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT37.StrType)le.ultweight), ''),TRIM((SALT37.StrType)le.prep_addr_line1),TRIM((SALT37.StrType)le.prep_addr_last_line),IF (le.rawaid <> 0,TRIM((SALT37.StrType)le.rawaid), ''),IF (le.aceaid <> 0,TRIM((SALT37.StrType)le.aceaid), ''),IF (le.persistent_record_id <> 0,TRIM((SALT37.StrType)le.persistent_record_id), '')));
  SELF.FldNo := C;
END;
...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 96);
  SELF.FldNo2 := 1 + (C % 96);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT37.StrType)le.tmsid),TRIM((SALT37.StrType)le.rmsid),TRIM((SALT37.StrType)le.orig_name),TRIM((SALT37.StrType)le.orig_lname),TRIM((SALT37.StrType)le.orig_fname),TRIM((SALT37.StrType)le.orig_mname),TRIM((SALT37.StrType)le.orig_suffix),TRIM((SALT37.StrType)le.duns_number),TRIM((SALT37.StrType)le.hq_duns_number),TRIM((SALT37.StrType)le.ssn),TRIM((SALT37.StrType)le.fein),TRIM((SALT37.StrType)le.incorp_state),TRIM((SALT37.StrType)le.corp_number),TRIM((SALT37.StrType)le.corp_type),TRIM((SALT37.StrType)le.orig_address1),TRIM((SALT37.StrType)le.orig_address2),TRIM((SALT37.StrType)le.orig_city),TRIM((SALT37.StrType)le.orig_state),TRIM((SALT37.StrType)le.orig_zip5),TRIM((SALT37.StrType)le.orig_zip4),TRIM((SALT37.StrType)le.orig_country),TRIM((SALT37.StrType)le.orig_province),TRIM((SALT37.StrType)le.orig_postal_code),TRIM((SALT37.StrType)le.foreign_indc),TRIM((SALT37.StrType)le.party_type),IF (le.dt_first_seen <> 0,TRIM((SALT37.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT37.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_first_reported), ''),TRIM((SALT37.StrType)le.process_date),TRIM((SALT37.StrType)le.title),TRIM((SALT37.StrType)le.fname),TRIM((SALT37.StrType)le.mname),TRIM((SALT37.StrType)le.lname),TRIM((SALT37.StrType)le.name_suffix),TRIM((SALT37.StrType)le.name_score),TRIM((SALT37.StrType)le.company_name),TRIM((SALT37.StrType)le.prim_range),TRIM((SALT37.StrType)le.predir),TRIM((SALT37.StrType)le.prim_name),TRIM((SALT37.StrType)le.suffix),TRIM((SALT37.StrType)le.postdir),TRIM((SALT37.StrType)le.unit_desig),TRIM((SALT37.StrType)le.sec_range),TRIM((SALT37.StrType)le.p_city_name),TRIM((SALT37.StrType)le.v_city_name),TRIM((SALT37.StrType)le.st),TRIM((SALT37.StrType)le.zip5),TRIM((SALT37.StrType)le.zip4),TRIM((SALT37.StrType)le.county),TRIM((SALT37.StrType)le.cart),TRIM((SALT37.StrType)le.cr_sort_sz),TRIM((SALT37.StrType)le.lot),TRIM((SALT37.StrType)le.lot_order),TRIM((SALT37.StrType)le.dpbc),TRIM((SALT37.StrType)le.chk_digit),TRIM((SALT37.StrType)le.rec_type),TRIM((SALT37.StrType)le.ace_fips_st),TRIM((SALT37.StrType)le.ace_fips_county),TRIM((SALT37.StrType)le.geo_lat),TRIM((SALT37.StrType)le.geo_long),TRIM((SALT37.StrType)le.msa),TRIM((SALT37.StrType)le.geo_blk),TRIM((SALT37.StrType)le.geo_match),TRIM((SALT37.StrType)le.err_stat),IF (le.bdid <> 0,TRIM((SALT37.StrType)le.bdid), ''),IF (le.did <> 0,TRIM((SALT37.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT37.StrType)le.did_score), ''),IF (le.bdid_score <> 0,TRIM((SALT37.StrType)le.bdid_score), ''),IF (le.source_rec_id <> 0,TRIM((SALT37.StrType)le.source_rec_id), ''),IF (le.dotid <> 0,TRIM((SALT37.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT37.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT37.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT37.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT37.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT37.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT37.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT37.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT37.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT37.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT37.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT37.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT37.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT37.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT37.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT37.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT37.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT37.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT37.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT37.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT37.StrType)le.ultweight), ''),TRIM((SALT37.StrType)le.prep_addr_line1),TRIM((SALT37.StrType)le.prep_addr_last_line),IF (le.rawaid <> 0,TRIM((SALT37.StrType)le.rawaid), ''),IF (le.aceaid <> 0,TRIM((SALT37.StrType)le.aceaid), ''),IF (le.persistent_record_id <> 0,TRIM((SALT37.StrType)le.persistent_record_id), '')));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT37.StrType)le.tmsid),TRIM((SALT37.StrType)le.rmsid),TRIM((SALT37.StrType)le.orig_name),TRIM((SALT37.StrType)le.orig_lname),TRIM((SALT37.StrType)le.orig_fname),TRIM((SALT37.StrType)le.orig_mname),TRIM((SALT37.StrType)le.orig_suffix),TRIM((SALT37.StrType)le.duns_number),TRIM((SALT37.StrType)le.hq_duns_number),TRIM((SALT37.StrType)le.ssn),TRIM((SALT37.StrType)le.fein),TRIM((SALT37.StrType)le.incorp_state),TRIM((SALT37.StrType)le.corp_number),TRIM((SALT37.StrType)le.corp_type),TRIM((SALT37.StrType)le.orig_address1),TRIM((SALT37.StrType)le.orig_address2),TRIM((SALT37.StrType)le.orig_city),TRIM((SALT37.StrType)le.orig_state),TRIM((SALT37.StrType)le.orig_zip5),TRIM((SALT37.StrType)le.orig_zip4),TRIM((SALT37.StrType)le.orig_country),TRIM((SALT37.StrType)le.orig_province),TRIM((SALT37.StrType)le.orig_postal_code),TRIM((SALT37.StrType)le.foreign_indc),TRIM((SALT37.StrType)le.party_type),IF (le.dt_first_seen <> 0,TRIM((SALT37.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT37.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT37.StrType)le.dt_vendor_first_reported), ''),TRIM((SALT37.StrType)le.process_date),TRIM((SALT37.StrType)le.title),TRIM((SALT37.StrType)le.fname),TRIM((SALT37.StrType)le.mname),TRIM((SALT37.StrType)le.lname),TRIM((SALT37.StrType)le.name_suffix),TRIM((SALT37.StrType)le.name_score),TRIM((SALT37.StrType)le.company_name),TRIM((SALT37.StrType)le.prim_range),TRIM((SALT37.StrType)le.predir),TRIM((SALT37.StrType)le.prim_name),TRIM((SALT37.StrType)le.suffix),TRIM((SALT37.StrType)le.postdir),TRIM((SALT37.StrType)le.unit_desig),TRIM((SALT37.StrType)le.sec_range),TRIM((SALT37.StrType)le.p_city_name),TRIM((SALT37.StrType)le.v_city_name),TRIM((SALT37.StrType)le.st),TRIM((SALT37.StrType)le.zip5),TRIM((SALT37.StrType)le.zip4),TRIM((SALT37.StrType)le.county),TRIM((SALT37.StrType)le.cart),TRIM((SALT37.StrType)le.cr_sort_sz),TRIM((SALT37.StrType)le.lot),TRIM((SALT37.StrType)le.lot_order),TRIM((SALT37.StrType)le.dpbc),TRIM((SALT37.StrType)le.chk_digit),TRIM((SALT37.StrType)le.rec_type),TRIM((SALT37.StrType)le.ace_fips_st),TRIM((SALT37.StrType)le.ace_fips_county),TRIM((SALT37.StrType)le.geo_lat),TRIM((SALT37.StrType)le.geo_long),TRIM((SALT37.StrType)le.msa),TRIM((SALT37.StrType)le.geo_blk),TRIM((SALT37.StrType)le.geo_match),TRIM((SALT37.StrType)le.err_stat),IF (le.bdid <> 0,TRIM((SALT37.StrType)le.bdid), ''),IF (le.did <> 0,TRIM((SALT37.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT37.StrType)le.did_score), ''),IF (le.bdid_score <> 0,TRIM((SALT37.StrType)le.bdid_score), ''),IF (le.source_rec_id <> 0,TRIM((SALT37.StrType)le.source_rec_id), ''),IF (le.dotid <> 0,TRIM((SALT37.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT37.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT37.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT37.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT37.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT37.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT37.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT37.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT37.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT37.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT37.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT37.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT37.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT37.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT37.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT37.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT37.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT37.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT37.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT37.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT37.StrType)le.ultweight), ''),TRIM((SALT37.StrType)le.prep_addr_line1),TRIM((SALT37.StrType)le.prep_addr_last_line),IF (le.rawaid <> 0,TRIM((SALT37.StrType)le.rawaid), ''),IF (le.aceaid <> 0,TRIM((SALT37.StrType)le.aceaid), ''),IF (le.persistent_record_id <> 0,TRIM((SALT37.StrType)le.persistent_record_id), '')));
  END;
...
SHARED FldIds := DATASET([{1,'tmsid'}
      ...
      ,{94,'rawaid'}
      ,{95,'aceaid'}
      ,{96,'persistent_record_id'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MA_Party_Fields.InValid_tmsid((SALT37.StrType)le.tmsid),
    MA_Party_Fields.InValid_rmsid((SALT37.StrType)le.rmsid),
    MA_Party_Fields.InValid_orig_name((SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_fname),
    MA_Party_Fields.InValid_orig_lname((SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_fname),
    MA_Party_Fields.InValid_orig_fname((SALT37.StrType)le.orig_fname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname),
    MA_Party_Fields.InValid_orig_mname((SALT37.StrType)le.orig_mname),
    MA_Party_Fields.InValid_orig_suffix((SALT37.StrType)le.orig_suffix),
    MA_Party_Fields.InValid_duns_number((SALT37.StrType)le.duns_number),
    MA_Party_Fields.InValid_hq_duns_number((SALT37.StrType)le.hq_duns_number),
    MA_Party_Fields.InValid_ssn((SALT37.StrType)le.ssn),
    MA_Party_Fields.InValid_fein((SALT37.StrType)le.fein),
    MA_Party_Fields.InValid_incorp_state((SALT37.StrType)le.incorp_state),
    MA_Party_Fields.InValid_corp_number((SALT37.StrType)le.corp_number),
    MA_Party_Fields.InValid_corp_type((SALT37.StrType)le.corp_type),
    MA_Party_Fields.InValid_orig_address1((SALT37.StrType)le.orig_address1),
    MA_Party_Fields.InValid_orig_address2((SALT37.StrType)le.orig_address2),
    MA_Party_Fields.InValid_orig_city((SALT37.StrType)le.orig_city),
    MA_Party_Fields.InValid_orig_state((SALT37.StrType)le.orig_state),
    MA_Party_Fields.InValid_orig_zip5((SALT37.StrType)le.orig_zip5),
    MA_Party_Fields.InValid_orig_zip4((SALT37.StrType)le.orig_zip4),
    MA_Party_Fields.InValid_orig_country((SALT37.StrType)le.orig_country),
    MA_Party_Fields.InValid_orig_province((SALT37.StrType)le.orig_province),
    MA_Party_Fields.InValid_orig_postal_code((SALT37.StrType)le.orig_postal_code),
    MA_Party_Fields.InValid_foreign_indc((SALT37.StrType)le.foreign_indc),
    MA_Party_Fields.InValid_party_type((SALT37.StrType)le.party_type),
    MA_Party_Fields.InValid_dt_first_seen((SALT37.StrType)le.dt_first_seen),
    MA_Party_Fields.InValid_dt_last_seen((SALT37.StrType)le.dt_last_seen),
    MA_Party_Fields.InValid_dt_vendor_last_reported((SALT37.StrType)le.dt_vendor_last_reported),
    MA_Party_Fields.InValid_dt_vendor_first_reported((SALT37.StrType)le.dt_vendor_first_reported),
    MA_Party_Fields.InValid_process_date((SALT37.StrType)le.process_date),
    MA_Party_Fields.InValid_title((SALT37.StrType)le.title),
    MA_Party_Fields.InValid_fname((SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    MA_Party_Fields.InValid_mname((SALT37.StrType)le.mname,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    MA_Party_Fields.InValid_lname((SALT37.StrType)le.lname,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.company_name),
    MA_Party_Fields.InValid_name_suffix((SALT37.StrType)le.name_suffix),
    MA_Party_Fields.InValid_name_score((SALT37.StrType)le.name_score),
    MA_Party_Fields.InValid_company_name((SALT37.StrType)le.company_name,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname),
    MA_Party_Fields.InValid_prim_range((SALT37.StrType)le.prim_range),
    MA_Party_Fields.InValid_predir((SALT37.StrType)le.predir),
    MA_Party_Fields.InValid_prim_name((SALT37.StrType)le.prim_name),
    MA_Party_Fields.InValid_suffix((SALT37.StrType)le.suffix),
    MA_Party_Fields.InValid_postdir((SALT37.StrType)le.postdir),
    MA_Party_Fields.InValid_unit_desig((SALT37.StrType)le.unit_desig),
    MA_Party_Fields.InValid_sec_range((SALT37.StrType)le.sec_range),
    MA_Party_Fields.InValid_p_city_name((SALT37.StrType)le.p_city_name),
    MA_Party_Fields.InValid_v_city_name((SALT37.StrType)le.v_city_name),
    MA_Party_Fields.InValid_st((SALT37.StrType)le.st),
    MA_Party_Fields.InValid_zip5((SALT37.StrType)le.zip5),
    MA_Party_Fields.InValid_zip4((SALT37.StrType)le.zip4),
    MA_Party_Fields.InValid_county((SALT37.StrType)le.county),
    MA_Party_Fields.InValid_cart((SALT37.StrType)le.cart),
    MA_Party_Fields.InValid_cr_sort_sz((SALT37.StrType)le.cr_sort_sz),
    MA_Party_Fields.InValid_lot((SALT37.StrType)le.lot),
    MA_Party_Fields.InValid_lot_order((SALT37.StrType)le.lot_order),
    MA_Party_Fields.InValid_dpbc((SALT37.StrType)le.dpbc),
    MA_Party_Fields.InValid_chk_digit((SALT37.StrType)le.chk_digit),
    MA_Party_Fields.InValid_rec_type((SALT37.StrType)le.rec_type),
    MA_Party_Fields.InValid_ace_fips_st((SALT37.StrType)le.ace_fips_st),
    MA_Party_Fields.InValid_ace_fips_county((SALT37.StrType)le.ace_fips_county),
    MA_Party_Fields.InValid_geo_lat((SALT37.StrType)le.geo_lat),
    MA_Party_Fields.InValid_geo_long((SALT37.StrType)le.geo_long),
    MA_Party_Fields.InValid_msa((SALT37.StrType)le.msa),
    MA_Party_Fields.InValid_geo_blk((SALT37.StrType)le.geo_blk),
    MA_Party_Fields.InValid_geo_match((SALT37.StrType)le.geo_match),
    MA_Party_Fields.InValid_err_stat((SALT37.StrType)le.err_stat),
    MA_Party_Fields.InValid_bdid((SALT37.StrType)le.bdid),
    MA_Party_Fields.InValid_did((SALT37.StrType)le.did),
    MA_Party_Fields.InValid_did_score((SALT37.StrType)le.did_score),
    MA_Party_Fields.InValid_bdid_score((SALT37.StrType)le.bdid_score),
    MA_Party_Fields.InValid_source_rec_id((SALT37.StrType)le.source_rec_id),
    MA_Party_Fields.InValid_dotid((SALT37.StrType)le.dotid),
    MA_Party_Fields.InValid_dotscore((SALT37.StrType)le.dotscore),
    MA_Party_Fields.InValid_dotweight((SALT37.StrType)le.dotweight),
    MA_Party_Fields.InValid_empid((SALT37.StrType)le.empid),
    MA_Party_Fields.InValid_empscore((SALT37.StrType)le.empscore),
    MA_Party_Fields.InValid_empweight((SALT37.StrType)le.empweight),
    MA_Party_Fields.InValid_powid((SALT37.StrType)le.powid),
    MA_Party_Fields.InValid_powscore((SALT37.StrType)le.powscore),
    MA_Party_Fields.InValid_powweight((SALT37.StrType)le.powweight),
    MA_Party_Fields.InValid_proxid((SALT37.StrType)le.proxid),
    MA_Party_Fields.InValid_proxscore((SALT37.StrType)le.proxscore),
    MA_Party_Fields.InValid_proxweight((SALT37.StrType)le.proxweight),
    MA_Party_Fields.InValid_seleid((SALT37.StrType)le.seleid),
    MA_Party_Fields.InValid_selescore((SALT37.StrType)le.selescore),
    MA_Party_Fields.InValid_seleweight((SALT37.StrType)le.seleweight),
    MA_Party_Fields.InValid_orgid((SALT37.StrType)le.orgid),
    MA_Party_Fields.InValid_orgscore((SALT37.StrType)le.orgscore),
    MA_Party_Fields.InValid_orgweight((SALT37.StrType)le.orgweight),
    MA_Party_Fields.InValid_ultid((SALT37.StrType)le.ultid),
    MA_Party_Fields.InValid_ultscore((SALT37.StrType)le.ultscore),
    MA_Party_Fields.InValid_ultweight((SALT37.StrType)le.ultweight),
    MA_Party_Fields.InValid_prep_addr_line1((SALT37.StrType)le.prep_addr_line1),
    MA_Party_Fields.InValid_prep_addr_last_line((SALT37.StrType)le.prep_addr_last_line),
    MA_Party_Fields.InValid_rawaid((SALT37.StrType)le.rawaid),
    MA_Party_Fields.InValid_aceaid((SALT37.StrType)le.aceaid),
    MA_Party_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := MA_Party_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_tmsid','invalid_rmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','Unknown','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_state','Unknown','Unknown','invalid_mandatory','Unknown','invalid_mandatory','invalid_state','invalid_orig_zip5','Unknown','invalid_orig_country','Unknown','Unknown','invalid_boolean_yn','invalid_party_type','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate8','Unknown','invalid_fname','invalid_mname','invalid_lname','Unknown','Unknown','invalid_company_name','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_mandatory','invalid_mandatory','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,MA_Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_hq_duns_number(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_fein(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_incorp_state(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_corp_number(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_corp_type(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_province(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orig_postal_code(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_foreign_indc(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_party_type(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_zip5(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ace_fips_st(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ace_fips_county(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_bdid_score(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_source_rec_id(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dotid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dotscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_dotweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_empid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_empscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_empweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_powid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_powscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_powweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_proxscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_proxweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_selescore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_seleweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orgscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_orgweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ultscore(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_ultweight(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_prep_addr_line1(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_prep_addr_last_line(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_aceaid(TotalErrors.ErrorNum),MA_Party_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
