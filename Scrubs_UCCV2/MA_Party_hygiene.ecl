...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MA_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid),
    MA_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid),
    MA_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_fname),
    MA_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_fname),
    MA_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname),
    MA_Party_Fields.InValid_orig_mname((SALT39.StrType)le.orig_mname),
    MA_Party_Fields.InValid_orig_suffix((SALT39.StrType)le.orig_suffix),
    MA_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number),
    MA_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number),
    MA_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn),
    MA_Party_Fields.InValid_fein((SALT39.StrType)le.fein),
    MA_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state),
    MA_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number),
    MA_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type),
    MA_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1),
    MA_Party_Fields.InValid_orig_address2((SALT39.StrType)le.orig_address2),
    MA_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city),
    MA_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state),
    MA_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country),
    MA_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4),
    MA_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country),
    MA_Party_Fields.InValid_orig_province((SALT39.StrType)le.orig_province),
    MA_Party_Fields.InValid_orig_postal_code((SALT39.StrType)le.orig_postal_code),
    MA_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc),
    MA_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type),
    MA_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen),
    MA_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen),
    MA_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported),
    MA_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported),
    MA_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date),
    MA_Party_Fields.InValid_title((SALT39.StrType)le.title),
    MA_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    MA_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    MA_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name),
    MA_Party_Fields.InValid_name_suffix((SALT39.StrType)le.name_suffix),
    MA_Party_Fields.InValid_name_score((SALT39.StrType)le.name_score),
    MA_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname),
    MA_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range),
    MA_Party_Fields.InValid_predir((SALT39.StrType)le.predir),
    MA_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name),
    MA_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix),
    MA_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir),
    MA_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig),
    MA_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range),
    MA_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name),
    MA_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name),
    MA_Party_Fields.InValid_st((SALT39.StrType)le.st),
    MA_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5),
    MA_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4),
    MA_Party_Fields.InValid_county((SALT39.StrType)le.county),
    MA_Party_Fields.InValid_cart((SALT39.StrType)le.cart),
    MA_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz),
    MA_Party_Fields.InValid_lot((SALT39.StrType)le.lot),
    MA_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order),
    MA_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc),
    MA_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit),
    MA_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type),
    MA_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st),
    MA_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county),
    MA_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat),
    MA_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long),
    MA_Party_Fields.InValid_msa((SALT39.StrType)le.msa),
    MA_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk),
    MA_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match),
    MA_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat),
    MA_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid),
    MA_Party_Fields.InValid_did((SALT39.StrType)le.did),
    MA_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score),
    MA_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score),
    MA_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id),
    MA_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid),
    MA_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore),
    MA_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight),
    MA_Party_Fields.InValid_empid((SALT39.StrType)le.empid),
    MA_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore),
    MA_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight),
    MA_Party_Fields.InValid_powid((SALT39.StrType)le.powid),
    MA_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore),
    MA_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight),
    MA_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid),
    MA_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore),
    MA_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight),
    MA_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid),
    MA_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore),
    MA_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight),
    MA_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid),
    MA_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore),
    MA_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight),
    MA_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid),
    MA_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore),
    MA_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight),
    MA_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1),
    MA_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line),
    MA_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid),
    MA_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid),
    MA_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, MA_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
