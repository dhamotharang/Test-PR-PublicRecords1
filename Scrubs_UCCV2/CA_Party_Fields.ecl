...
EXPORT MakeFT_invalid_boolean_yn(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean_yn(SALT39.StrType s) := WHICH(((SALT39.StrType) s) NOT IN ['N','Y']);
EXPORT InValidMessageFT_invalid_boolean_yn(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInEnum('N|Y'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_tmsid(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT39.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_tmsid(s)>0);
EXPORT InValidMessageFT_invalid_tmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_tmsid'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_rmsid(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT39.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_rmsid(s)>0);
EXPORT InValidMessageFT_invalid_rmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_rmsid'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_name(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_name(SALT39.StrType s,SALT39.StrType orig_lname,SALT39.StrType orig_fname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_lname,orig_fname)>0);
EXPORT InValidMessageFT_invalid_orig_name(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_lname(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_lname(SALT39.StrType s,SALT39.StrType orig_name,SALT39.StrType orig_fname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_name,orig_fname)>0);
EXPORT InValidMessageFT_invalid_orig_lname(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_fname(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_fname(SALT39.StrType s,SALT39.StrType orig_name,SALT39.StrType orig_lname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_name,orig_lname)>0);
EXPORT InValidMessageFT_invalid_orig_fname(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_state(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_state(SALT39.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_state(s)>0);
EXPORT InValidMessageFT_invalid_orig_state(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_state'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_zip5(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_zip5(SALT39.StrType s,SALT39.StrType orig_country) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip5_country(s,orig_country)>0);
EXPORT InValidMessageFT_invalid_orig_zip5(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip5_country'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_zip4(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_zip4(SALT39.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip4(s)>0);
EXPORT InValidMessageFT_invalid_orig_zip4(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip4'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_party_type(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_party_type(SALT39.StrType s) := WHICH(((SALT39.StrType) s) NOT IN ['D','S']);
EXPORT InValidMessageFT_invalid_party_type(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInEnum('D|S'),SALT39.HygieneErrors.Good);
...
EXPORT Make_orig_name(SALT39.StrType s0) := MakeFT_invalid_orig_name(s0);
EXPORT InValid_orig_name(SALT39.StrType s,SALT39.StrType orig_lname,SALT39.StrType orig_fname) := InValidFT_invalid_orig_name(s,orig_lname,orig_fname);
EXPORT InValidMessage_orig_name(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_name(wh);
 
EXPORT Make_orig_lname(SALT39.StrType s0) := MakeFT_invalid_orig_lname(s0);
EXPORT InValid_orig_lname(SALT39.StrType s,SALT39.StrType orig_name,SALT39.StrType orig_fname) := InValidFT_invalid_orig_lname(s,orig_name,orig_fname);
EXPORT InValidMessage_orig_lname(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_lname(wh);
 
EXPORT Make_orig_fname(SALT39.StrType s0) := MakeFT_invalid_orig_fname(s0);
EXPORT InValid_orig_fname(SALT39.StrType s,SALT39.StrType orig_name,SALT39.StrType orig_lname) := InValidFT_invalid_orig_fname(s,orig_name,orig_lname);
...
EXPORT Make_orig_state(SALT39.StrType s0) := MakeFT_invalid_orig_state(s0);
EXPORT InValid_orig_state(SALT39.StrType s) := InValidFT_invalid_orig_state(s);
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_state(wh);
 
EXPORT Make_orig_zip5(SALT39.StrType s0) := MakeFT_invalid_orig_zip5(s0);
EXPORT InValid_orig_zip5(SALT39.StrType s,SALT39.StrType orig_country) := InValidFT_invalid_orig_zip5(s,orig_country);
EXPORT InValidMessage_orig_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_zip5(wh);
 
EXPORT Make_orig_zip4(SALT39.StrType s0) := MakeFT_invalid_orig_zip4(s0);
EXPORT InValid_orig_zip4(SALT39.StrType s) := InValidFT_invalid_orig_zip4(s);
EXPORT InValidMessage_orig_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_zip4(wh);
 
EXPORT Make_orig_country(SALT39.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_orig_country(SALT39.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_foreign_indc(SALT39.StrType s0) := MakeFT_invalid_boolean_yn(s0);
EXPORT InValid_foreign_indc(SALT39.StrType s) := InValidFT_invalid_boolean_yn(s);
