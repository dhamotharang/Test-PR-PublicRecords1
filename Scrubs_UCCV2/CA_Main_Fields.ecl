...
EXPORT MakeFT_invalid_tmsid(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_tmsid(s)>0);
EXPORT InValidMessageFT_invalid_tmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_tmsid'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_rmsid(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_rmsid(s)>0);
EXPORT InValidMessageFT_invalid_rmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_rmsid'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_jurisdiction(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT37.StrType s) := WHICH(((SALT37.StrType) s) NOT IN ['CA','CA']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInEnum('CA|CA'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_number(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_number(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_non_empty_numeric(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_number(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_non_empty_numeric'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_orig_filing_type'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_time(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_time(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_check_time(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_time(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_check_time'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_filing_type'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_status(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_status(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_filing_status(s)>0);
EXPORT InValidMessageFT_invalid_filing_status(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_filing_status'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_status_type(s)>0);
EXPORT InValidMessageFT_invalid_status_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_status_type'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_microfilm_number(SALT37.StrType s0) := FUNCTION
  s1 := SALT37.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  MakeFT_invalid_numeric(s1);
END;
EXPORT InValidFT_invalid_microfilm_number(SALT37.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT37.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 7 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 11));
EXPORT InValidMessageFT_invalid_microfilm_number(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInChars('0123456789'),SALT37.HygieneErrors.NotLength('0,7,9,10,11'),SALT37.HygieneErrors.Good);
...
EXPORT Make_static_value(SALT37.StrType s0) := s0;
EXPORT InValid_static_value(SALT37.StrType s) := 0;
EXPORT InValidMessage_static_value(UNSIGNED1 wh) := '';
 
EXPORT Make_date_vendor_removed(SALT37.StrType s0) := s0;
EXPORT InValid_date_vendor_removed(SALT37.StrType s) := 0;
EXPORT InValidMessage_date_vendor_removed(UNSIGNED1 wh) := '';
 
EXPORT Make_date_vendor_changed(SALT37.StrType s0) := s0;
EXPORT InValid_date_vendor_changed(SALT37.StrType s) := 0;
...
EXPORT Make_orig_filing_number(SALT37.StrType s0) := MakeFT_invalid_orig_filing_number(s0);
EXPORT InValid_orig_filing_number(SALT37.StrType s) := InValidFT_invalid_orig_filing_number(s);
EXPORT InValidMessage_orig_filing_number(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_filing_number(wh);
 
EXPORT Make_orig_filing_type(SALT37.StrType s0) := MakeFT_invalid_orig_filing_type(s0);
EXPORT InValid_orig_filing_type(SALT37.StrType s) := InValidFT_invalid_orig_filing_type(s);
...
EXPORT Make_orig_filing_time(SALT37.StrType s0) := MakeFT_invalid_orig_filing_time(s0);
EXPORT InValid_orig_filing_time(SALT37.StrType s) := InValidFT_invalid_orig_filing_time(s);
...
EXPORT Make_filing_number_indc(SALT37.StrType s0) := s0;
EXPORT InValid_filing_number_indc(SALT37.StrType s) := 0;
...
EXPORT Make_filing_status(SALT37.StrType s0) := MakeFT_invalid_filing_status(s0);
EXPORT InValid_filing_status(SALT37.StrType s) := InValidFT_invalid_filing_status(s);
EXPORT InValidMessage_filing_status(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_status(wh);
 
EXPORT Make_status_type(SALT37.StrType s0) := MakeFT_invalid_status_type(s0);
EXPORT InValid_status_type(SALT37.StrType s) := InValidFT_invalid_status_type(s);
...
EXPORT Make_contract_type(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_contract_type(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_contract_type(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_vendor_entry_date(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_vendor_entry_date(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_vendor_entry_date(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_vendor_upd_date(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_vendor_upd_date(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_microfilm_number(SALT37.StrType s0) := MakeFT_invalid_microfilm_number(s0);
EXPORT InValid_microfilm_number(SALT37.StrType s) := InValidFT_invalid_microfilm_number(s);
...
EXPORT Make_irs_serial_number(SALT37.StrType s0) := s0;
EXPORT InValid_irs_serial_number(SALT37.StrType s) := 0;
...
EXPORT Make_title(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_title(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_title(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_filing_agency(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_filing_agency(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_filing_agency(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_address(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_address(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_address(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_city(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_city(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_city(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_state(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_state(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_zip(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_zip(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_duns_number(SALT37.StrType s0) := s0;
EXPORT InValid_duns_number(SALT37.StrType s) := 0;
EXPORT InValidMessage_duns_number(UNSIGNED1 wh) := '';
 
EXPORT Make_cmnt_effective_date(SALT37.StrType s0) := s0;
EXPORT InValid_cmnt_effective_date(SALT37.StrType s) := 0;
...
EXPORT Make_prim_machine(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_prim_machine(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_prim_machine(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_sec_machine(SALT37.StrType s0) := s0;
EXPORT InValid_sec_machine(SALT37.StrType s) := 0;
EXPORT InValidMessage_sec_machine(UNSIGNED1 wh) := '';
 
EXPORT Make_manufacturer_code(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufacturer_code(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_manufacturer_code(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_manufacturer_name(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufacturer_name(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_manufacturer_name(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model_year(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model_year(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model_year(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model_desc(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model_desc(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_collateral_count(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_collateral_count(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_collateral_count(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_manufactured_year(SALT37.StrType s0) := s0;
EXPORT InValid_manufactured_year(SALT37.StrType s) := 0;
EXPORT InValidMessage_manufactured_year(UNSIGNED1 wh) := '';
 
EXPORT Make_new_used(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_new_used(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_new_used(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_serial_number(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_serial_number(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_serial_number(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_property_desc(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_property_desc(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_property_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_borough(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_borough(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_borough(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_block(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_block(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_volume(SALT37.StrType s0) := s0;
EXPORT InValid_volume(SALT37.StrType s) := 0;
