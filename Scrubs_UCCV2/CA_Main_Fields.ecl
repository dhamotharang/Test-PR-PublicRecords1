...
EXPORT CA_Main_Fields := MODULE
 
EXPORT NumFields := 62;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_numeric','invalid_numeric_blank','invalid_empty','invalid_wordbag','invalid_8pastdate','invalid_tmsid','invalid_rmsid','invalid_filing_jurisdiction','invalid_orig_filing_number','invalid_orig_filing_type','invalid_orig_filing_date','invalid_orig_filing_time','invalid_filing_type','invalid_filing_date','invalid_filing_time','invalid_filing_status','invalid_status_type','invalid_expiration_date','invalid_microfilm_number');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_numeric' => 2,'invalid_numeric_blank' => 3,'invalid_empty' => 4,'invalid_wordbag' => 5,'invalid_8pastdate' => 6,'invalid_tmsid' => 7,'invalid_rmsid' => 8,'invalid_filing_jurisdiction' => 9,'invalid_orig_filing_number' => 10,'invalid_orig_filing_type' => 11,'invalid_orig_filing_date' => 12,'invalid_orig_filing_time' => 13,'invalid_filing_type' => 14,'invalid_filing_date' => 15,'invalid_filing_time' => 16,'invalid_filing_status' => 17,'invalid_status_type' => 18,'invalid_expiration_date' => 19,'invalid_microfilm_number' => 20,0);
...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['CA','CA']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('CA|CA'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_non_empty_numeric(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_non_empty_numeric'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_orig_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_time(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_time(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_check_time(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_time(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_check_time'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ca_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ca_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_status(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_status(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_filing_status(s)>0);
EXPORT InValidMessageFT_invalid_filing_status(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_filing_status'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_status_type(s)>0);
EXPORT InValidMessageFT_invalid_status_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_status_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_microfilm_number(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  MakeFT_invalid_numeric(s1);
END;
EXPORT InValidFT_invalid_microfilm_number(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 7 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 11));
EXPORT InValidMessageFT_invalid_microfilm_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('0123456789'),SALT38.HygieneErrors.NotLength('0,7,9,10,11'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],[],[],[],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ALLOW','LENGTH'],['LENGTH'],[],['LENGTH'],['ALLOW','LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],[],[],[],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],[]);
...
EXPORT Make_static_value(SALT38.StrType s0) := s0;
EXPORT InValid_static_value(SALT38.StrType s) := 0;
EXPORT InValidMessage_static_value(UNSIGNED1 wh) := '';
 
EXPORT Make_date_vendor_removed(SALT38.StrType s0) := s0;
EXPORT InValid_date_vendor_removed(SALT38.StrType s) := 0;
EXPORT InValidMessage_date_vendor_removed(UNSIGNED1 wh) := '';
 
EXPORT Make_date_vendor_changed(SALT38.StrType s0) := s0;
EXPORT InValid_date_vendor_changed(SALT38.StrType s) := 0;
...
EXPORT Make_orig_filing_number(SALT38.StrType s0) := MakeFT_invalid_orig_filing_number(s0);
EXPORT InValid_orig_filing_number(SALT38.StrType s) := InValidFT_invalid_orig_filing_number(s);
EXPORT InValidMessage_orig_filing_number(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_filing_number(wh);
 
EXPORT Make_orig_filing_type(SALT38.StrType s0) := MakeFT_invalid_orig_filing_type(s0);
EXPORT InValid_orig_filing_type(SALT38.StrType s) := InValidFT_invalid_orig_filing_type(s);
...
EXPORT Make_orig_filing_time(SALT38.StrType s0) := MakeFT_invalid_orig_filing_time(s0);
EXPORT InValid_orig_filing_time(SALT38.StrType s) := InValidFT_invalid_orig_filing_time(s);
...
EXPORT Make_filing_number_indc(SALT38.StrType s0) := s0;
EXPORT InValid_filing_number_indc(SALT38.StrType s) := 0;
...
EXPORT Make_filing_status(SALT38.StrType s0) := MakeFT_invalid_filing_status(s0);
EXPORT InValid_filing_status(SALT38.StrType s) := InValidFT_invalid_filing_status(s);
EXPORT InValidMessage_filing_status(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_status(wh);
 
EXPORT Make_status_type(SALT38.StrType s0) := MakeFT_invalid_status_type(s0);
EXPORT InValid_status_type(SALT38.StrType s) := InValidFT_invalid_status_type(s);
EXPORT InValidMessage_status_type(UNSIGNED1 wh) := InValidMessageFT_invalid_status_type(wh);
...
EXPORT Make_contract_type(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_contract_type(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_contract_type(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_vendor_entry_date(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_vendor_entry_date(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_vendor_entry_date(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_vendor_upd_date(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_vendor_upd_date(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_microfilm_number(SALT38.StrType s0) := MakeFT_invalid_microfilm_number(s0);
EXPORT InValid_microfilm_number(SALT38.StrType s) := InValidFT_invalid_microfilm_number(s);
EXPORT InValidMessage_microfilm_number(UNSIGNED1 wh) := InValidMessageFT_invalid_microfilm_number(wh);
...
EXPORT Make_irs_serial_number(SALT38.StrType s0) := s0;
EXPORT InValid_irs_serial_number(SALT38.StrType s) := 0;
...
EXPORT Make_title(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_title(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_title(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_filing_agency(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_filing_agency(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_filing_agency(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_address(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_address(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_address(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_city(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_city(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_city(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_state(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_state(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_zip(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_zip(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_duns_number(SALT38.StrType s0) := s0;
EXPORT InValid_duns_number(SALT38.StrType s) := 0;
EXPORT InValidMessage_duns_number(UNSIGNED1 wh) := '';
 
EXPORT Make_cmnt_effective_date(SALT38.StrType s0) := s0;
EXPORT InValid_cmnt_effective_date(SALT38.StrType s) := 0;
EXPORT InValidMessage_cmnt_effective_date(UNSIGNED1 wh) := '';
...
EXPORT Make_prim_machine(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_prim_machine(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_prim_machine(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_sec_machine(SALT38.StrType s0) := s0;
EXPORT InValid_sec_machine(SALT38.StrType s) := 0;
EXPORT InValidMessage_sec_machine(UNSIGNED1 wh) := '';
 
EXPORT Make_manufacturer_code(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufacturer_code(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_manufacturer_code(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_manufacturer_name(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufacturer_name(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_manufacturer_name(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model_year(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model_year(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model_year(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_model_desc(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_model_desc(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_model_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_collateral_count(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_collateral_count(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_collateral_count(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_manufactured_year(SALT38.StrType s0) := s0;
EXPORT InValid_manufactured_year(SALT38.StrType s) := 0;
EXPORT InValidMessage_manufactured_year(UNSIGNED1 wh) := '';
 
EXPORT Make_new_used(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_new_used(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_new_used(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_serial_number(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_serial_number(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_serial_number(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_property_desc(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_property_desc(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_property_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_borough(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_borough(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_borough(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_block(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_block(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_volume(SALT38.StrType s0) := s0;
EXPORT InValid_volume(SALT38.StrType s) := 0;
