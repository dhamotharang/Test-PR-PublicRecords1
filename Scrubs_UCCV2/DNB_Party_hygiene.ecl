IMPORT SALT37;
EXPORT DNB_Party_hygiene(dataset(DNB_Party_layout_UCCV2) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    DNB_Party_Fields.InValid_tmsid((SALT37.StrType)le.tmsid),
    DNB_Party_Fields.InValid_rmsid((SALT37.StrType)le.rmsid),
    DNB_Party_Fields.InValid_orig_name((SALT37.StrType)le.orig_name),
    DNB_Party_Fields.InValid_orig_lname((SALT37.StrType)le.orig_lname),
    DNB_Party_Fields.InValid_orig_fname((SALT37.StrType)le.orig_fname),
    DNB_Party_Fields.InValid_orig_mname((SALT37.StrType)le.orig_mname),
    DNB_Party_Fields.InValid_orig_suffix((SALT37.StrType)le.orig_suffix),
    DNB_Party_Fields.InValid_duns_number((SALT37.StrType)le.duns_number),
    DNB_Party_Fields.InValid_hq_duns_number((SALT37.StrType)le.hq_duns_number),
    DNB_Party_Fields.InValid_ssn((SALT37.StrType)le.ssn),
    DNB_Party_Fields.InValid_fein((SALT37.StrType)le.fein),
    DNB_Party_Fields.InValid_incorp_state((SALT37.StrType)le.incorp_state),
    DNB_Party_Fields.InValid_corp_number((SALT37.StrType)le.corp_number),
    DNB_Party_Fields.InValid_corp_type((SALT37.StrType)le.corp_type),
    DNB_Party_Fields.InValid_orig_address1((SALT37.StrType)le.orig_address1,(SALT37.StrType)le.orig_city,(SALT37.StrType)le.orig_state),
    DNB_Party_Fields.InValid_orig_address2((SALT37.StrType)le.orig_address2),
    DNB_Party_Fields.InValid_orig_city((SALT37.StrType)le.orig_city),
    DNB_Party_Fields.InValid_orig_state((SALT37.StrType)le.orig_state),
    DNB_Party_Fields.InValid_orig_zip5((SALT37.StrType)le.orig_zip5),
    DNB_Party_Fields.InValid_orig_zip4((SALT37.StrType)le.orig_zip4),
    DNB_Party_Fields.InValid_orig_country((SALT37.StrType)le.orig_country),
    DNB_Party_Fields.InValid_orig_province((SALT37.StrType)le.orig_province),
    DNB_Party_Fields.InValid_orig_postal_code((SALT37.StrType)le.orig_postal_code),
    DNB_Party_Fields.InValid_foreign_indc((SALT37.StrType)le.foreign_indc),
    DNB_Party_Fields.InValid_party_type((SALT37.StrType)le.party_type),
    DNB_Party_Fields.InValid_dt_first_seen((SALT37.StrType)le.dt_first_seen),
    DNB_Party_Fields.InValid_dt_last_seen((SALT37.StrType)le.dt_last_seen),
    DNB_Party_Fields.InValid_dt_vendor_last_reported((SALT37.StrType)le.dt_vendor_last_reported),
    DNB_Party_Fields.InValid_dt_vendor_first_reported((SALT37.StrType)le.dt_vendor_first_reported),
    DNB_Party_Fields.InValid_process_date((SALT37.StrType)le.process_date),
    DNB_Party_Fields.InValid_title((SALT37.StrType)le.title),
    DNB_Party_Fields.InValid_fname((SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    DNB_Party_Fields.InValid_mname((SALT37.StrType)le.mname,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    DNB_Party_Fields.InValid_lname((SALT37.StrType)le.lname,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.company_name),
    DNB_Party_Fields.InValid_name_suffix((SALT37.StrType)le.name_suffix),
    DNB_Party_Fields.InValid_name_score((SALT37.StrType)le.name_score),
    DNB_Party_Fields.InValid_company_name((SALT37.StrType)le.company_name,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname),
    DNB_Party_Fields.InValid_prim_range((SALT37.StrType)le.prim_range),
    DNB_Party_Fields.InValid_predir((SALT37.StrType)le.predir),
    DNB_Party_Fields.InValid_prim_name((SALT37.StrType)le.prim_name),
    DNB_Party_Fields.InValid_suffix((SALT37.StrType)le.suffix),
    DNB_Party_Fields.InValid_postdir((SALT37.StrType)le.postdir),
    DNB_Party_Fields.InValid_unit_desig((SALT37.StrType)le.unit_desig),
    DNB_Party_Fields.InValid_sec_range((SALT37.StrType)le.sec_range),
    DNB_Party_Fields.InValid_p_city_name((SALT37.StrType)le.p_city_name),
    DNB_Party_Fields.InValid_v_city_name((SALT37.StrType)le.v_city_name),
    DNB_Party_Fields.InValid_st((SALT37.StrType)le.st),
    DNB_Party_Fields.InValid_zip5((SALT37.StrType)le.zip5),
    DNB_Party_Fields.InValid_zip4((SALT37.StrType)le.zip4),
    DNB_Party_Fields.InValid_county((SALT37.StrType)le.county),
    DNB_Party_Fields.InValid_cart((SALT37.StrType)le.cart),
    DNB_Party_Fields.InValid_cr_sort_sz((SALT37.StrType)le.cr_sort_sz),
    DNB_Party_Fields.InValid_lot((SALT37.StrType)le.lot),
    DNB_Party_Fields.InValid_lot_order((SALT37.StrType)le.lot_order),
    DNB_Party_Fields.InValid_dpbc((SALT37.StrType)le.dpbc),
    DNB_Party_Fields.InValid_chk_digit((SALT37.StrType)le.chk_digit),
    DNB_Party_Fields.InValid_rec_type((SALT37.StrType)le.rec_type),
    DNB_Party_Fields.InValid_ace_fips_st((SALT37.StrType)le.ace_fips_st),
    DNB_Party_Fields.InValid_ace_fips_county((SALT37.StrType)le.ace_fips_county),
    DNB_Party_Fields.InValid_geo_lat((SALT37.StrType)le.geo_lat),
    DNB_Party_Fields.InValid_geo_long((SALT37.StrType)le.geo_long),
    DNB_Party_Fields.InValid_msa((SALT37.StrType)le.msa),
    DNB_Party_Fields.InValid_geo_blk((SALT37.StrType)le.geo_blk),
    DNB_Party_Fields.InValid_geo_match((SALT37.StrType)le.geo_match),
    DNB_Party_Fields.InValid_err_stat((SALT37.StrType)le.err_stat),
    DNB_Party_Fields.InValid_bdid((SALT37.StrType)le.bdid),
    DNB_Party_Fields.InValid_did((SALT37.StrType)le.did),
    DNB_Party_Fields.InValid_did_score((SALT37.StrType)le.did_score),
    DNB_Party_Fields.InValid_bdid_score((SALT37.StrType)le.bdid_score),
    DNB_Party_Fields.InValid_source_rec_id((SALT37.StrType)le.source_rec_id),
    DNB_Party_Fields.InValid_dotid((SALT37.StrType)le.dotid),
    DNB_Party_Fields.InValid_dotscore((SALT37.StrType)le.dotscore),
    DNB_Party_Fields.InValid_dotweight((SALT37.StrType)le.dotweight),
    DNB_Party_Fields.InValid_empid((SALT37.StrType)le.empid),
    DNB_Party_Fields.InValid_empscore((SALT37.StrType)le.empscore),
    DNB_Party_Fields.InValid_empweight((SALT37.StrType)le.empweight),
    DNB_Party_Fields.InValid_powid((SALT37.StrType)le.powid),
    DNB_Party_Fields.InValid_powscore((SALT37.StrType)le.powscore),
    DNB_Party_Fields.InValid_powweight((SALT37.StrType)le.powweight),
    DNB_Party_Fields.InValid_proxid((SALT37.StrType)le.proxid),
    DNB_Party_Fields.InValid_proxscore((SALT37.StrType)le.proxscore),
    DNB_Party_Fields.InValid_proxweight((SALT37.StrType)le.proxweight),
    DNB_Party_Fields.InValid_seleid((SALT37.StrType)le.seleid),
    DNB_Party_Fields.InValid_selescore((SALT37.StrType)le.selescore),
    DNB_Party_Fields.InValid_seleweight((SALT37.StrType)le.seleweight),
    DNB_Party_Fields.InValid_orgid((SALT37.StrType)le.orgid),
    DNB_Party_Fields.InValid_orgscore((SALT37.StrType)le.orgscore),
    DNB_Party_Fields.InValid_orgweight((SALT37.StrType)le.orgweight),
    DNB_Party_Fields.InValid_ultid((SALT37.StrType)le.ultid),
    DNB_Party_Fields.InValid_ultscore((SALT37.StrType)le.ultscore),
    DNB_Party_Fields.InValid_ultweight((SALT37.StrType)le.ultweight),
    DNB_Party_Fields.InValid_prep_addr_line1((SALT37.StrType)le.prep_addr_line1),
    DNB_Party_Fields.InValid_prep_addr_last_line((SALT37.StrType)le.prep_addr_last_line),
    DNB_Party_Fields.InValid_rawaid((SALT37.StrType)le.rawaid),
    DNB_Party_Fields.InValid_aceaid((SALT37.StrType)le.aceaid),
    DNB_Party_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := DNB_Party_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_tmsid','invalid_rmsid','invalid_wordbag','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_duns_number','invalid_duns_number','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_orig_address1','invalid_wordbag','invalid_mandatory','invalid_mandatory','invalid_zip_code5','invalid_zip_code4','invalid_alpha_blank','invalid_alpha_blank','Unknown','invalid_boolean_yn_empty','invalid_party_type','invalid_pastdate06','invalid_pastdate06','invalid_pastdate06','invalid_pastdate06','invalid_08pastdate','invalid_wordbag','invalid_fname','invalid_mname','invalid_lname','invalid_wordbag','invalid_numeric_blank','invalid_company_name','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_mandatory','invalid_mandatory','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,DNB_Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_hq_duns_number(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_fein(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_incorp_state(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_corp_number(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_corp_type(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_province(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orig_postal_code(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_foreign_indc(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_party_type(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_zip5(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ace_fips_st(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ace_fips_county(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_bdid_score(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_source_rec_id(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dotid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dotscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_dotweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_empid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_empscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_empweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_powid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_powscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_powweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_proxscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_proxweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_selescore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_seleweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orgscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_orgweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ultscore(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_ultweight(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_prep_addr_line1(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_prep_addr_last_line(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_aceaid(TotalErrors.ErrorNum),DNB_Party_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
