...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    DNB_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid),
    DNB_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid),
    DNB_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name),
    DNB_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname),
    DNB_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname),
    DNB_Party_Fields.InValid_orig_mname((SALT39.StrType)le.orig_mname),
    DNB_Party_Fields.InValid_orig_suffix((SALT39.StrType)le.orig_suffix),
    DNB_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number),
    DNB_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number),
    DNB_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn),
    DNB_Party_Fields.InValid_fein((SALT39.StrType)le.fein),
    DNB_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state),
    DNB_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number),
    DNB_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type),
    DNB_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1,(SALT39.StrType)le.orig_city,(SALT39.StrType)le.orig_state),
    DNB_Party_Fields.InValid_orig_address2((SALT39.StrType)le.orig_address2),
    DNB_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city),
    DNB_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state),
    DNB_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country),
    DNB_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4),
    DNB_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country),
    DNB_Party_Fields.InValid_orig_province((SALT39.StrType)le.orig_province),
    DNB_Party_Fields.InValid_orig_postal_code((SALT39.StrType)le.orig_postal_code),
    DNB_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc),
    DNB_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type),
    DNB_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen),
    DNB_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen),
    DNB_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported),
    DNB_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported),
    DNB_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date),
    DNB_Party_Fields.InValid_title((SALT39.StrType)le.title),
    DNB_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    DNB_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    DNB_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name),
    DNB_Party_Fields.InValid_name_suffix((SALT39.StrType)le.name_suffix),
    DNB_Party_Fields.InValid_name_score((SALT39.StrType)le.name_score),
    DNB_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname),
    DNB_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range),
    DNB_Party_Fields.InValid_predir((SALT39.StrType)le.predir),
    DNB_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name),
    DNB_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix),
    DNB_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir),
    DNB_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig),
    DNB_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range),
    DNB_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name),
    DNB_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name),
    DNB_Party_Fields.InValid_st((SALT39.StrType)le.st),
    DNB_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5),
    DNB_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4),
    DNB_Party_Fields.InValid_county((SALT39.StrType)le.county),
    DNB_Party_Fields.InValid_cart((SALT39.StrType)le.cart),
    DNB_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz),
    DNB_Party_Fields.InValid_lot((SALT39.StrType)le.lot),
    DNB_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order),
    DNB_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc),
    DNB_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit),
    DNB_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type),
    DNB_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st),
    DNB_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county),
    DNB_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat),
    DNB_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long),
    DNB_Party_Fields.InValid_msa((SALT39.StrType)le.msa),
    DNB_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk),
    DNB_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match),
    DNB_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat),
    DNB_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid),
    DNB_Party_Fields.InValid_did((SALT39.StrType)le.did),
    DNB_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score),
    DNB_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score),
    DNB_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id),
    DNB_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid),
    DNB_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore),
    DNB_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight),
    DNB_Party_Fields.InValid_empid((SALT39.StrType)le.empid),
    DNB_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore),
    DNB_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight),
    DNB_Party_Fields.InValid_powid((SALT39.StrType)le.powid),
    DNB_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore),
    DNB_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight),
    DNB_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid),
    DNB_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore),
    DNB_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight),
    DNB_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid),
    DNB_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore),
    DNB_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight),
    DNB_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid),
    DNB_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore),
    DNB_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight),
    DNB_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid),
    DNB_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore),
    DNB_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight),
    DNB_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1),
    DNB_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line),
    DNB_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid),
    DNB_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid),
    DNB_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, DNB_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
