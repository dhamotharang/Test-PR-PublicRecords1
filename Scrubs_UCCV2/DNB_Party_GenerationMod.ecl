...
IMPORT SALT39;
EXPORT DNB_Party_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'DNB_Party';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_pastdate06:LENGTHS(0,6):CUSTOM(Scrubs.valid_date.fn_valid_0468pastDate>0, FALSE, TRUE)\n'
    + '\n'
    ...
    + 'FIELDTYPE:invalid_zip_code5:CUSTOM(Scrubs_UCCV2.Functions.fn_verify_zip5_country>0,orig_country)\n'
    + 'FIELDTYPE:invalid_zip_code4:CUSTOM(Scrubs_UCCV2.Functions.fn_verify_zip4>0)\n'
    + 'FIELDTYPE:invalid_party_type:CUSTOM(Scrubs_UCCV2.Functions.fn_party_type>0)\n'
    ...
    + 'FIELD:orig_name:TYPE(STRING120):LIKE(invalid_wordbag):0,0\n'
    + 'FIELD:orig_lname:TYPE(STRING25):LIKE(invalid_empty):0,0\n'
    + 'FIELD:orig_fname:TYPE(STRING25):LIKE(invalid_empty):0,0\n'
    + 'FIELD:orig_mname:TYPE(STRING35):LIKE(invalid_empty):0,0\n'
    + 'FIELD:orig_suffix:TYPE(STRING10):LIKE(invalid_empty):0,0\n'
    + 'FIELD:duns_number:TYPE(STRING9):LIKE(invalid_duns_number):0,0\n'
    + 'FIELD:hq_duns_number:TYPE(STRING9):LIKE(invalid_duns_number):0,0\n'
    ...
    + 'FIELD:orig_address1:TYPE(STRING60):LIKE(invalid_orig_address1):0,0\n'
    + 'FIELD:orig_address2:TYPE(STRING60):LIKE(invalid_wordbag):0,0\n'
    + 'FIELD:orig_city:TYPE(STRING30):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:orig_state:TYPE(STRING2):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:orig_zip5:TYPE(STRING5):LIKE(invalid_zip_code5):0,0\n'
    + 'FIELD:orig_zip4:TYPE(STRING4):LIKE(invalid_zip_code4):0,0\n'
    + 'FIELD:orig_country:TYPE(STRING30):LIKE(invalid_alpha_blank):0,0\n'
    + 'FIELD:orig_province:TYPE(STRING30):LIKE(invalid_alpha_blank):0,0\n'
    + 'FIELD:orig_postal_code:TYPE(STRING9):0,0\n'
    + 'FIELD:foreign_indc:TYPE(STRING1):LIKE(invalid_boolean_yn_empty):0,0\n'
    + 'FIELD:party_type:TYPE(STRING1):LIKE(invalid_party_type):0,0\n'
    + 'FIELD:dt_first_seen:TYPE(UNSIGNED6):LIKE(invalid_pastdate06):0,0\n'
    + 'FIELD:dt_last_seen:TYPE(UNSIGNED6):LIKE(invalid_pastdate06):0,0\n'
    + 'FIELD:dt_vendor_last_reported:TYPE(UNSIGNED6):LIKE(invalid_pastdate06):0,0\n'
    + 'FIELD:dt_vendor_first_reported:TYPE(UNSIGNED6):LIKE(invalid_pastdate06):0,0\n'
    + 'FIELD:process_date:TYPE(STRING8):LIKE(invalid_08pastdate):0,0\n'
    + 'FIELD:title:TYPE(STRING5):LIKE(invalid_wordbag):0,0\n'
    ...
    + 'FIELD:name_suffix:TYPE(STRING5):LIKE(invalid_wordbag):0,0\n'
    + 'FIELD:name_score:TYPE(STRING3):LIKE(invalid_numeric_blank):0,0\n'
