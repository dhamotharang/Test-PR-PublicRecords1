...
EXPORT FromNone(DATASET(MA_Main_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := MA_Main_Fields.InValid_tmsid((SALT38.StrType)le.tmsid);
    SELF.rmsid_Invalid := MA_Main_Fields.InValid_rmsid((SALT38.StrType)le.rmsid);
    SELF.process_date_Invalid := MA_Main_Fields.InValid_process_date((SALT38.StrType)le.process_date);
    SELF.filing_jurisdiction_Invalid := MA_Main_Fields.InValid_filing_jurisdiction((SALT38.StrType)le.filing_jurisdiction);
    SELF.orig_filing_number_Invalid := MA_Main_Fields.InValid_orig_filing_number((SALT38.StrType)le.orig_filing_number);
    SELF.orig_filing_type_Invalid := MA_Main_Fields.InValid_orig_filing_type((SALT38.StrType)le.orig_filing_type);
    SELF.orig_filing_date_Invalid := MA_Main_Fields.InValid_orig_filing_date((SALT38.StrType)le.orig_filing_date);
    SELF.orig_filing_time_Invalid := MA_Main_Fields.InValid_orig_filing_time((SALT38.StrType)le.orig_filing_time);
    SELF.filing_number_Invalid := MA_Main_Fields.InValid_filing_number((SALT38.StrType)le.filing_number);
    SELF.filing_type_Invalid := MA_Main_Fields.InValid_filing_type((SALT38.StrType)le.filing_type);
    SELF.filing_date_Invalid := MA_Main_Fields.InValid_filing_date((SALT38.StrType)le.filing_date);
    SELF.filing_time_Invalid := MA_Main_Fields.InValid_filing_time((SALT38.StrType)le.filing_time);
    SELF.filing_status_Invalid := MA_Main_Fields.InValid_filing_status((SALT38.StrType)le.filing_status);
    SELF.status_type_Invalid := MA_Main_Fields.InValid_status_type((SALT38.StrType)le.status_type);
    SELF.page_Invalid := MA_Main_Fields.InValid_page((SALT38.StrType)le.page);
    SELF.expiration_date_Invalid := MA_Main_Fields.InValid_expiration_date((SALT38.StrType)le.expiration_date);
    SELF.contract_type_Invalid := MA_Main_Fields.InValid_contract_type((SALT38.StrType)le.contract_type);
    SELF.vendor_entry_date_Invalid := MA_Main_Fields.InValid_vendor_entry_date((SALT38.StrType)le.vendor_entry_date);
    SELF.vendor_upd_date_Invalid := MA_Main_Fields.InValid_vendor_upd_date((SALT38.StrType)le.vendor_upd_date);
    SELF.statements_filed_Invalid := MA_Main_Fields.InValid_statements_filed((SALT38.StrType)le.statements_filed);
    SELF.continuious_expiration_Invalid := MA_Main_Fields.InValid_continuious_expiration((SALT38.StrType)le.continuious_expiration);
    SELF.microfilm_number_Invalid := MA_Main_Fields.InValid_microfilm_number((SALT38.StrType)le.microfilm_number);
    SELF.amount_Invalid := MA_Main_Fields.InValid_amount((SALT38.StrType)le.amount);
    SELF.irs_serial_number_Invalid := MA_Main_Fields.InValid_irs_serial_number((SALT38.StrType)le.irs_serial_number);
    SELF.effective_date_Invalid := MA_Main_Fields.InValid_effective_date((SALT38.StrType)le.effective_date);
    SELF.signer_name_Invalid := MA_Main_Fields.InValid_signer_name((SALT38.StrType)le.signer_name);
    SELF.title_Invalid := MA_Main_Fields.InValid_title((SALT38.StrType)le.title);
    SELF.filing_agency_Invalid := MA_Main_Fields.InValid_filing_agency((SALT38.StrType)le.filing_agency);
    SELF.address_Invalid := MA_Main_Fields.InValid_address((SALT38.StrType)le.address);
    SELF.city_Invalid := MA_Main_Fields.InValid_city((SALT38.StrType)le.city);
    SELF.state_Invalid := MA_Main_Fields.InValid_state((SALT38.StrType)le.state);
    SELF.county_Invalid := MA_Main_Fields.InValid_county((SALT38.StrType)le.county);
    SELF.zip_Invalid := MA_Main_Fields.InValid_zip((SALT38.StrType)le.zip);
    SELF.duns_number_Invalid := MA_Main_Fields.InValid_duns_number((SALT38.StrType)le.duns_number);
    SELF.cmnt_effective_date_Invalid := MA_Main_Fields.InValid_cmnt_effective_date((SALT38.StrType)le.cmnt_effective_date);
    SELF.description_Invalid := MA_Main_Fields.InValid_description((SALT38.StrType)le.description);
    SELF.prim_machine_Invalid := MA_Main_Fields.InValid_prim_machine((SALT38.StrType)le.prim_machine);
    SELF.sec_machine_Invalid := MA_Main_Fields.InValid_sec_machine((SALT38.StrType)le.sec_machine);
    SELF.manufacturer_code_Invalid := MA_Main_Fields.InValid_manufacturer_code((SALT38.StrType)le.manufacturer_code);
    SELF.manufacturer_name_Invalid := MA_Main_Fields.InValid_manufacturer_name((SALT38.StrType)le.manufacturer_name);
    SELF.model_Invalid := MA_Main_Fields.InValid_model((SALT38.StrType)le.model);
    SELF.model_year_Invalid := MA_Main_Fields.InValid_model_year((SALT38.StrType)le.model_year);
    SELF.model_desc_Invalid := MA_Main_Fields.InValid_model_desc((SALT38.StrType)le.model_desc);
    SELF.collateral_count_Invalid := MA_Main_Fields.InValid_collateral_count((SALT38.StrType)le.collateral_count);
    SELF.manufactured_year_Invalid := MA_Main_Fields.InValid_manufactured_year((SALT38.StrType)le.manufactured_year);
    SELF.new_used_Invalid := MA_Main_Fields.InValid_new_used((SALT38.StrType)le.new_used);
    SELF.serial_number_Invalid := MA_Main_Fields.InValid_serial_number((SALT38.StrType)le.serial_number);
    SELF.property_desc_Invalid := MA_Main_Fields.InValid_property_desc((SALT38.StrType)le.property_desc);
    SELF.borough_Invalid := MA_Main_Fields.InValid_borough((SALT38.StrType)le.borough);
    SELF.block_Invalid := MA_Main_Fields.InValid_block((SALT38.StrType)le.block);
    SELF.collateral_address_Invalid := MA_Main_Fields.InValid_collateral_address((SALT38.StrType)le.collateral_address);
    SELF.air_rights_indc_Invalid := MA_Main_Fields.InValid_air_rights_indc((SALT38.StrType)le.air_rights_indc);
    SELF.subterranean_rights_indc_Invalid := MA_Main_Fields.InValid_subterranean_rights_indc((SALT38.StrType)le.subterranean_rights_indc);
    SELF.easment_indc_Invalid := MA_Main_Fields.InValid_easment_indc((SALT38.StrType)le.easment_indc);
    SELF.volume_Invalid := MA_Main_Fields.InValid_volume((SALT38.StrType)le.volume);
    SELF.persistent_record_id_Invalid := MA_Main_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(MA_Main_Layout_UCCV2) prevDS = DATASET([], MA_Main_Layout_UCCV2), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,MA_Main_Fields.InvalidMessage_persistent_record_id(1)
          ,'Fields with errors'
    ...
    mod_hygiene := MA_Main_hygiene(PROJECT(h, MA_Main_Layout_UCCV2));
  ...
  // record count stats
    ...
    mod_Delta := MA_Main_Delta(prevDS, PROJECT(h, MA_Main_Layout_UCCV2));
...
EXPORT StandardStats(DATASET(MA_Main_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, MA_Main_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
