...
RETURN PARALLEL(
  ...
  // scrubs.ScrubsPlus('UCCV2','Scrubs_UCCV2','Scrubs_UCCV2_TH_Main',  'TH_Main',  pVersion,emailList,false),
  // scrubs.ScrubsPlus('UCCV2','Scrubs_UCCV2','Scrubs_UCCV2_TH_Party', 'TH_Party', pVersion,emailList,false),
