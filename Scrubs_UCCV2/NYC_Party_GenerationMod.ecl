...
IMPORT SALT39;
EXPORT NYC_Party_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'NYC_Party';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_alphanum_specials:ALLOW(0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ @-./,&\'#)\n'
    ...
    + '\n'
    + 'FIELDTYPE:invalid_tmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid>0,\'NYC\')\n'
    ...
    + 'FIELDTYPE:invalid_zip5:CUSTOM(Scrubs_UCCV2.Functions.fn_verify_zip5_country>0,orig_country)\n'
    + 'FIELDTYPE:invalid_orig_country:CUSTOM(Scrubs_UCCV2.Functions.fn_country2>0)\n'
    ...
    + 'FIELD:rmsid:TYPE(STRING23):LIKE(invalid_numeric):0,0\n'
    ...
    + 'FIELD:orig_zip5:TYPE(STRING5):LIKE(invalid_zip5):0,0\n'
    ...
    + 'FIELD:orig_postal_code:TYPE(STRING9):LIKE(invalid_mandatory):0,0\n'
