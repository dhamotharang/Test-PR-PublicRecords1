...
EXPORT CA_Party_Scrubs := MODULE
 
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 88;
  EXPORT NumRulesFromFieldType := 88;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 88;
  EXPORT NumFieldsWithPossibleEdits := 0;
  EXPORT NumRulesWithPossibleEdits := 0;
  EXPORT Expanded_Layout := RECORD(CA_Party_Layout_UCCV2)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(CA_Party_Layout_UCCV2)
    UNSIGNED8 ScrubsBits1;
    UNSIGNED8 ScrubsBits2;
  END;
EXPORT FromNone(DATASET(CA_Party_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := CA_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid);
    SELF.rmsid_Invalid := CA_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid);
    SELF.orig_name_Invalid := CA_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname);
    SELF.orig_lname_Invalid := CA_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_fname);
    SELF.orig_fname_Invalid := CA_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname);
    SELF.duns_number_Invalid := CA_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number);
    SELF.hq_duns_number_Invalid := CA_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number);
    SELF.ssn_Invalid := CA_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn);
    SELF.fein_Invalid := CA_Party_Fields.InValid_fein((SALT38.StrType)le.fein);
    SELF.incorp_state_Invalid := CA_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state);
    SELF.corp_number_Invalid := CA_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number);
    SELF.corp_type_Invalid := CA_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type);
    SELF.orig_address1_Invalid := CA_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1);
    SELF.orig_city_Invalid := CA_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city);
    SELF.orig_state_Invalid := CA_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state);
    SELF.orig_zip5_Invalid := CA_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5);
    SELF.orig_zip4_Invalid := CA_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4);
    SELF.orig_country_Invalid := CA_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country);
    SELF.foreign_indc_Invalid := CA_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc);
    SELF.party_type_Invalid := CA_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type);
    SELF.dt_first_seen_Invalid := CA_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen);
    SELF.dt_last_seen_Invalid := CA_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen);
    SELF.dt_vendor_last_reported_Invalid := CA_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported);
    SELF.dt_vendor_first_reported_Invalid := CA_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported);
    SELF.process_date_Invalid := CA_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date);
    SELF.fname_Invalid := CA_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name);
    SELF.mname_Invalid := CA_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name);
    SELF.lname_Invalid := CA_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name);
    SELF.company_name_Invalid := CA_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname);
    SELF.prim_range_Invalid := CA_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range);
    SELF.predir_Invalid := CA_Party_Fields.InValid_predir((SALT38.StrType)le.predir);
    SELF.prim_name_Invalid := CA_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name);
    SELF.suffix_Invalid := CA_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix);
    SELF.postdir_Invalid := CA_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir);
    SELF.unit_desig_Invalid := CA_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig);
    SELF.sec_range_Invalid := CA_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range);
    SELF.p_city_name_Invalid := CA_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name);
    SELF.v_city_name_Invalid := CA_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name);
    SELF.st_Invalid := CA_Party_Fields.InValid_st((SALT38.StrType)le.st);
    SELF.zip5_Invalid := CA_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5);
    SELF.zip4_Invalid := CA_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4);
    SELF.county_Invalid := CA_Party_Fields.InValid_county((SALT38.StrType)le.county);
    SELF.cart_Invalid := CA_Party_Fields.InValid_cart((SALT38.StrType)le.cart);
    SELF.cr_sort_sz_Invalid := CA_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz);
    SELF.lot_Invalid := CA_Party_Fields.InValid_lot((SALT38.StrType)le.lot);
    SELF.lot_order_Invalid := CA_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order);
    SELF.dpbc_Invalid := CA_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc);
    SELF.chk_digit_Invalid := CA_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit);
    SELF.rec_type_Invalid := CA_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type);
    SELF.ace_fips_st_Invalid := CA_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st);
    SELF.ace_fips_county_Invalid := CA_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county);
    SELF.geo_lat_Invalid := CA_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat);
    SELF.geo_long_Invalid := CA_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long);
    SELF.msa_Invalid := CA_Party_Fields.InValid_msa((SALT38.StrType)le.msa);
    SELF.geo_blk_Invalid := CA_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk);
    SELF.geo_match_Invalid := CA_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match);
    SELF.err_stat_Invalid := CA_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat);
    SELF.bdid_Invalid := CA_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid);
    SELF.did_Invalid := CA_Party_Fields.InValid_did((SALT38.StrType)le.did);
    SELF.did_score_Invalid := CA_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score);
    SELF.bdid_score_Invalid := CA_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score);
    SELF.source_rec_id_Invalid := CA_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id);
    SELF.dotid_Invalid := CA_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid);
    SELF.dotscore_Invalid := CA_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore);
    SELF.dotweight_Invalid := CA_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight);
    SELF.empid_Invalid := CA_Party_Fields.InValid_empid((SALT38.StrType)le.empid);
    SELF.empscore_Invalid := CA_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore);
    SELF.empweight_Invalid := CA_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight);
    SELF.powid_Invalid := CA_Party_Fields.InValid_powid((SALT38.StrType)le.powid);
    SELF.powscore_Invalid := CA_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore);
    SELF.powweight_Invalid := CA_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight);
    SELF.proxid_Invalid := CA_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid);
    SELF.proxscore_Invalid := CA_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore);
    SELF.proxweight_Invalid := CA_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight);
    SELF.seleid_Invalid := CA_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid);
    SELF.selescore_Invalid := CA_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore);
    SELF.seleweight_Invalid := CA_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight);
    SELF.orgid_Invalid := CA_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid);
    SELF.orgscore_Invalid := CA_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore);
    SELF.orgweight_Invalid := CA_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight);
    SELF.ultid_Invalid := CA_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid);
    SELF.ultscore_Invalid := CA_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore);
    SELF.ultweight_Invalid := CA_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight);
    SELF.prep_addr_line1_Invalid := CA_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1);
    SELF.prep_addr_last_line_Invalid := CA_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line);
    SELF.rawaid_Invalid := CA_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid);
    SELF.aceaid_Invalid := CA_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid);
    SELF.persistent_record_id_Invalid := CA_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),CA_Party_Layout_UCCV2);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.tmsid_Invalid << 0 ) + ( le.rmsid_Invalid << 1 ) + ( le.orig_name_Invalid << 2 ) + ( le.orig_lname_Invalid << 3 ) + ( le.orig_fname_Invalid << 4 ) + ( le.duns_number_Invalid << 5 ) + ( le.hq_duns_number_Invalid << 6 ) + ( le.ssn_Invalid << 7 ) + ( le.fein_Invalid << 8 ) + ( le.incorp_state_Invalid << 9 ) + ( le.corp_number_Invalid << 10 ) + ( le.corp_type_Invalid << 11 ) + ( le.orig_address1_Invalid << 12 ) + ( le.orig_city_Invalid << 13 ) + ( le.orig_state_Invalid << 14 ) + ( le.orig_zip5_Invalid << 15 ) + ( le.orig_zip4_Invalid << 16 ) + ( le.orig_country_Invalid << 17 ) + ( le.foreign_indc_Invalid << 18 ) + ( le.party_type_Invalid << 19 ) + ( le.dt_first_seen_Invalid << 20 ) + ( le.dt_last_seen_Invalid << 21 ) + ( le.dt_vendor_last_reported_Invalid << 22 ) + ( le.dt_vendor_first_reported_Invalid << 23 ) + ( le.process_date_Invalid << 24 ) + ( le.fname_Invalid << 25 ) + ( le.mname_Invalid << 26 ) + ( le.lname_Invalid << 27 ) + ( le.company_name_Invalid << 28 ) + ( le.prim_range_Invalid << 29 ) + ( le.predir_Invalid << 30 ) + ( le.prim_name_Invalid << 31 ) + ( le.suffix_Invalid << 32 ) + ( le.postdir_Invalid << 33 ) + ( le.unit_desig_Invalid << 34 ) + ( le.sec_range_Invalid << 35 ) + ( le.p_city_name_Invalid << 36 ) + ( le.v_city_name_Invalid << 37 ) + ( le.st_Invalid << 38 ) + ( le.zip5_Invalid << 39 ) + ( le.zip4_Invalid << 40 ) + ( le.county_Invalid << 41 ) + ( le.cart_Invalid << 42 ) + ( le.cr_sort_sz_Invalid << 43 ) + ( le.lot_Invalid << 44 ) + ( le.lot_order_Invalid << 45 ) + ( le.dpbc_Invalid << 46 ) + ( le.chk_digit_Invalid << 47 ) + ( le.rec_type_Invalid << 48 ) + ( le.ace_fips_st_Invalid << 49 ) + ( le.ace_fips_county_Invalid << 50 ) + ( le.geo_lat_Invalid << 51 ) + ( le.geo_long_Invalid << 52 ) + ( le.msa_Invalid << 53 ) + ( le.geo_blk_Invalid << 54 ) + ( le.geo_match_Invalid << 55 ) + ( le.err_stat_Invalid << 56 ) + ( le.bdid_Invalid << 57 ) + ( le.did_Invalid << 58 ) + ( le.did_score_Invalid << 59 ) + ( le.bdid_score_Invalid << 60 ) + ( le.source_rec_id_Invalid << 61 ) + ( le.dotid_Invalid << 62 ) + ( le.dotscore_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.dotweight_Invalid << 0 ) + ( le.empid_Invalid << 1 ) + ( le.empscore_Invalid << 2 ) + ( le.empweight_Invalid << 3 ) + ( le.powid_Invalid << 4 ) + ( le.powscore_Invalid << 5 ) + ( le.powweight_Invalid << 6 ) + ( le.proxid_Invalid << 7 ) + ( le.proxscore_Invalid << 8 ) + ( le.proxweight_Invalid << 9 ) + ( le.seleid_Invalid << 10 ) + ( le.selescore_Invalid << 11 ) + ( le.seleweight_Invalid << 12 ) + ( le.orgid_Invalid << 13 ) + ( le.orgscore_Invalid << 14 ) + ( le.orgweight_Invalid << 15 ) + ( le.ultid_Invalid << 16 ) + ( le.ultscore_Invalid << 17 ) + ( le.ultweight_Invalid << 18 ) + ( le.prep_addr_line1_Invalid << 19 ) + ( le.prep_addr_last_line_Invalid << 20 ) + ( le.rawaid_Invalid << 21 ) + ( le.aceaid_Invalid << 22 ) + ( le.persistent_record_id_Invalid << 23 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,CA_Party_Layout_UCCV2);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.orig_zip4_Invalid := (le.ScrubsBits1 >> 16) & 1;
    SELF.orig_country_Invalid := (le.ScrubsBits1 >> 17) & 1;
    SELF.foreign_indc_Invalid := (le.ScrubsBits1 >> 18) & 1;
    SELF.party_type_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.dt_first_seen_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.dt_last_seen_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.dt_vendor_last_reported_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.dt_vendor_first_reported_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.process_date_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.fname_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.mname_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.lname_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.company_name_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.prim_range_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.predir_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.prim_name_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.suffix_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.postdir_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.unit_desig_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.sec_range_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.p_city_name_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.v_city_name_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.st_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.zip5_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.zip4_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.county_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.cart_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.lot_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.lot_order_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.dpbc_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.chk_digit_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.rec_type_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.ace_fips_st_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.ace_fips_county_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.geo_lat_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.geo_long_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.msa_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.geo_blk_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.geo_match_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.err_stat_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.bdid_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.did_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.did_score_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.bdid_score_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.source_rec_id_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.dotid_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.dotscore_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.dotweight_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.empid_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.empscore_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.empweight_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.powid_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.powscore_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.powweight_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.proxid_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.proxscore_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.proxweight_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.seleid_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.selescore_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.seleweight_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.orgid_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.orgscore_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.orgweight_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.ultid_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.ultscore_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.ultweight_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.prep_addr_line1_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.prep_addr_last_line_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.rawaid_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.aceaid_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.persistent_record_id_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.tmsid_Invalid,le.rmsid_Invalid,le.orig_name_Invalid,le.orig_lname_Invalid,le.orig_fname_Invalid,le.duns_number_Invalid,le.hq_duns_number_Invalid,le.ssn_Invalid,le.fein_Invalid,le.incorp_state_Invalid,le.corp_number_Invalid,le.corp_type_Invalid,le.orig_address1_Invalid,le.orig_city_Invalid,le.orig_state_Invalid,le.orig_zip5_Invalid,le.orig_zip4_Invalid,le.orig_country_Invalid,le.foreign_indc_Invalid,le.party_type_Invalid,le.dt_first_seen_Invalid,le.dt_last_seen_Invalid,le.dt_vendor_last_reported_Invalid,le.dt_vendor_first_reported_Invalid,le.process_date_Invalid,le.fname_Invalid,le.mname_Invalid,le.lname_Invalid,le.company_name_Invalid,le.prim_range_Invalid,le.predir_Invalid,le.prim_name_Invalid,le.suffix_Invalid,le.postdir_Invalid,le.unit_desig_Invalid,le.sec_range_Invalid,le.p_city_name_Invalid,le.v_city_name_Invalid,le.st_Invalid,le.zip5_Invalid,le.zip4_Invalid,le.county_Invalid,le.cart_Invalid,le.cr_sort_sz_Invalid,le.lot_Invalid,le.lot_order_Invalid,le.dpbc_Invalid,le.chk_digit_Invalid,le.rec_type_Invalid,le.ace_fips_st_Invalid,le.ace_fips_county_Invalid,le.geo_lat_Invalid,le.geo_long_Invalid,le.msa_Invalid,le.geo_blk_Invalid,le.geo_match_Invalid,le.err_stat_Invalid,le.bdid_Invalid,le.did_Invalid,le.did_score_Invalid,le.bdid_score_Invalid,le.source_rec_id_Invalid,le.dotid_Invalid,le.dotscore_Invalid,le.dotweight_Invalid,le.empid_Invalid,le.empscore_Invalid,le.empweight_Invalid,le.powid_Invalid,le.powscore_Invalid,le.powweight_Invalid,le.proxid_Invalid,le.proxscore_Invalid,le.proxweight_Invalid,le.seleid_Invalid,le.selescore_Invalid,le.seleweight_Invalid,le.orgid_Invalid,le.orgscore_Invalid,le.orgweight_Invalid,le.ultid_Invalid,le.ultscore_Invalid,le.ultweight_Invalid,le.prep_addr_line1_Invalid,le.prep_addr_last_line_Invalid,le.rawaid_Invalid,le.aceaid_Invalid,le.persistent_record_id_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,CA_Party_Fields.InvalidMessage_tmsid(le.tmsid_Invalid),CA_Party_Fields.InvalidMessage_rmsid(le.rmsid_Invalid),CA_Party_Fields.InvalidMessage_orig_name(le.orig_name_Invalid),CA_Party_Fields.InvalidMessage_orig_lname(le.orig_lname_Invalid),CA_Party_Fields.InvalidMessage_orig_fname(le.orig_fname_Invalid),CA_Party_Fields.InvalidMessage_duns_number(le.duns_number_Invalid),CA_Party_Fields.InvalidMessage_hq_duns_number(le.hq_duns_number_Invalid),CA_Party_Fields.InvalidMessage_ssn(le.ssn_Invalid),CA_Party_Fields.InvalidMessage_fein(le.fein_Invalid),CA_Party_Fields.InvalidMessage_incorp_state(le.incorp_state_Invalid),CA_Party_Fields.InvalidMessage_corp_number(le.corp_number_Invalid),CA_Party_Fields.InvalidMessage_corp_type(le.corp_type_Invalid),CA_Party_Fields.InvalidMessage_orig_address1(le.orig_address1_Invalid),CA_Party_Fields.InvalidMessage_orig_city(le.orig_city_Invalid),CA_Party_Fields.InvalidMessage_orig_state(le.orig_state_Invalid),CA_Party_Fields.InvalidMessage_orig_zip5(le.orig_zip5_Invalid),CA_Party_Fields.InvalidMessage_orig_zip4(le.orig_zip4_Invalid),CA_Party_Fields.InvalidMessage_orig_country(le.orig_country_Invalid),CA_Party_Fields.InvalidMessage_foreign_indc(le.foreign_indc_Invalid),CA_Party_Fields.InvalidMessage_party_type(le.party_type_Invalid),CA_Party_Fields.InvalidMessage_dt_first_seen(le.dt_first_seen_Invalid),CA_Party_Fields.InvalidMessage_dt_last_seen(le.dt_last_seen_Invalid),CA_Party_Fields.InvalidMessage_dt_vendor_last_reported(le.dt_vendor_last_reported_Invalid),CA_Party_Fields.InvalidMessage_dt_vendor_first_reported(le.dt_vendor_first_reported_Invalid),CA_Party_Fields.InvalidMessage_process_date(le.process_date_Invalid),CA_Party_Fields.InvalidMessage_fname(le.fname_Invalid),CA_Party_Fields.InvalidMessage_mname(le.mname_Invalid),CA_Party_Fields.InvalidMessage_lname(le.lname_Invalid),CA_Party_Fields.InvalidMessage_company_name(le.company_name_Invalid),CA_Party_Fields.InvalidMessage_prim_range(le.prim_range_Invalid),CA_Party_Fields.InvalidMessage_predir(le.predir_Invalid),CA_Party_Fields.InvalidMessage_prim_name(le.prim_name_Invalid),CA_Party_Fields.InvalidMessage_suffix(le.suffix_Invalid),CA_Party_Fields.InvalidMessage_postdir(le.postdir_Invalid),CA_Party_Fields.InvalidMessage_unit_desig(le.unit_desig_Invalid),CA_Party_Fields.InvalidMessage_sec_range(le.sec_range_Invalid),CA_Party_Fields.InvalidMessage_p_city_name(le.p_city_name_Invalid),CA_Party_Fields.InvalidMessage_v_city_name(le.v_city_name_Invalid),CA_Party_Fields.InvalidMessage_st(le.st_Invalid),CA_Party_Fields.InvalidMessage_zip5(le.zip5_Invalid),CA_Party_Fields.InvalidMessage_zip4(le.zip4_Invalid),CA_Party_Fields.InvalidMessage_county(le.county_Invalid),CA_Party_Fields.InvalidMessage_cart(le.cart_Invalid),CA_Party_Fields.InvalidMessage_cr_sort_sz(le.cr_sort_sz_Invalid),CA_Party_Fields.InvalidMessage_lot(le.lot_Invalid),CA_Party_Fields.InvalidMessage_lot_order(le.lot_order_Invalid),CA_Party_Fields.InvalidMessage_dpbc(le.dpbc_Invalid),CA_Party_Fields.InvalidMessage_chk_digit(le.chk_digit_Invalid),CA_Party_Fields.InvalidMessage_rec_type(le.rec_type_Invalid),CA_Party_Fields.InvalidMessage_ace_fips_st(le.ace_fips_st_Invalid),CA_Party_Fields.InvalidMessage_ace_fips_county(le.ace_fips_county_Invalid),CA_Party_Fields.InvalidMessage_geo_lat(le.geo_lat_Invalid),CA_Party_Fields.InvalidMessage_geo_long(le.geo_long_Invalid),CA_Party_Fields.InvalidMessage_msa(le.msa_Invalid),CA_Party_Fields.InvalidMessage_geo_blk(le.geo_blk_Invalid),CA_Party_Fields.InvalidMessage_geo_match(le.geo_match_Invalid),CA_Party_Fields.InvalidMessage_err_stat(le.err_stat_Invalid),CA_Party_Fields.InvalidMessage_bdid(le.bdid_Invalid),CA_Party_Fields.InvalidMessage_did(le.did_Invalid),CA_Party_Fields.InvalidMessage_did_score(le.did_score_Invalid),CA_Party_Fields.InvalidMessage_bdid_score(le.bdid_score_Invalid),CA_Party_Fields.InvalidMessage_source_rec_id(le.source_rec_id_Invalid),CA_Party_Fields.InvalidMessage_dotid(le.dotid_Invalid),CA_Party_Fields.InvalidMessage_dotscore(le.dotscore_Invalid),CA_Party_Fields.InvalidMessage_dotweight(le.dotweight_Invalid),CA_Party_Fields.InvalidMessage_empid(le.empid_Invalid),CA_Party_Fields.InvalidMessage_empscore(le.empscore_Invalid),CA_Party_Fields.InvalidMessage_empweight(le.empweight_Invalid),CA_Party_Fields.InvalidMessage_powid(le.powid_Invalid),CA_Party_Fields.InvalidMessage_powscore(le.powscore_Invalid),CA_Party_Fields.InvalidMessage_powweight(le.powweight_Invalid),CA_Party_Fields.InvalidMessage_proxid(le.proxid_Invalid),CA_Party_Fields.InvalidMessage_proxscore(le.proxscore_Invalid),CA_Party_Fields.InvalidMessage_proxweight(le.proxweight_Invalid),CA_Party_Fields.InvalidMessage_seleid(le.seleid_Invalid),CA_Party_Fields.InvalidMessage_selescore(le.selescore_Invalid),CA_Party_Fields.InvalidMessage_seleweight(le.seleweight_Invalid),CA_Party_Fields.InvalidMessage_orgid(le.orgid_Invalid),CA_Party_Fields.InvalidMessage_orgscore(le.orgscore_Invalid),CA_Party_Fields.InvalidMessage_orgweight(le.orgweight_Invalid),CA_Party_Fields.InvalidMessage_ultid(le.ultid_Invalid),CA_Party_Fields.InvalidMessage_ultscore(le.ultscore_Invalid),CA_Party_Fields.InvalidMessage_ultweight(le.ultweight_Invalid),CA_Party_Fields.InvalidMessage_prep_addr_line1(le.prep_addr_line1_Invalid),CA_Party_Fields.InvalidMessage_prep_addr_last_line(le.prep_addr_last_line_Invalid),CA_Party_Fields.InvalidMessage_rawaid(le.rawaid_Invalid),CA_Party_Fields.InvalidMessage_aceaid(le.aceaid_Invalid),CA_Party_Fields.InvalidMessage_persistent_record_id(le.persistent_record_id_Invalid),'UNKNOWN'));
    ...
    SELF.FieldName := CHOOSE(c,'tmsid','rmsid','orig_name','orig_lname','orig_fname','duns_number','hq_duns_number','ssn','fein','incorp_state','corp_number','corp_type','orig_address1','orig_city','orig_state','orig_zip5','orig_zip4','orig_country','foreign_indc','party_type','dt_first_seen','dt_last_seen','dt_vendor_last_reported','dt_vendor_first_reported','process_date','fname','mname','lname','company_name','prim_range','predir','prim_name','suffix','postdir','unit_desig','sec_range','p_city_name','v_city_name','st','zip5','zip4','county','cart','cr_sort_sz','lot','lot_order','dpbc','chk_digit','rec_type','ace_fips_st','ace_fips_county','geo_lat','geo_long','msa','geo_blk','geo_match','err_stat','bdid','did','did_score','bdid_score','source_rec_id','dotid','dotscore','dotweight','empid','empscore','empweight','powid','powscore','powweight','proxid','proxscore','proxweight','seleid','selescore','seleweight','orgid','orgscore','orgweight','ultid','ultscore','ultweight','prep_addr_line1','prep_addr_last_line','rawaid','aceaid','persistent_record_id','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_tmsid','invalid_rmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_mandatory','invalid_mandatory','invalid_orig_state','invalid_orig_zip5','invalid_orig_zip4','invalid_mandatory','invalid_boolean_yn','invalid_party_type','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate8','invalid_fname','invalid_mname','invalid_lname','invalid_company_name','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_mandatory','invalid_mandatory','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT38.StrType)le.tmsid,(SALT38.StrType)le.rmsid,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname,(SALT38.StrType)le.duns_number,(SALT38.StrType)le.hq_duns_number,(SALT38.StrType)le.ssn,(SALT38.StrType)le.fein,(SALT38.StrType)le.incorp_state,(SALT38.StrType)le.corp_number,(SALT38.StrType)le.corp_type,(SALT38.StrType)le.orig_address1,(SALT38.StrType)le.orig_city,(SALT38.StrType)le.orig_state,(SALT38.StrType)le.orig_zip5,(SALT38.StrType)le.orig_zip4,(SALT38.StrType)le.orig_country,(SALT38.StrType)le.foreign_indc,(SALT38.StrType)le.party_type,(SALT38.StrType)le.dt_first_seen,(SALT38.StrType)le.dt_last_seen,(SALT38.StrType)le.dt_vendor_last_reported,(SALT38.StrType)le.dt_vendor_first_reported,(SALT38.StrType)le.process_date,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name,(SALT38.StrType)le.prim_range,(SALT38.StrType)le.predir,(SALT38.StrType)le.prim_name,(SALT38.StrType)le.suffix,(SALT38.StrType)le.postdir,(SALT38.StrType)le.unit_desig,(SALT38.StrType)le.sec_range,(SALT38.StrType)le.p_city_name,(SALT38.StrType)le.v_city_name,(SALT38.StrType)le.st,(SALT38.StrType)le.zip5,(SALT38.StrType)le.zip4,(SALT38.StrType)le.county,(SALT38.StrType)le.cart,(SALT38.StrType)le.cr_sort_sz,(SALT38.StrType)le.lot,(SALT38.StrType)le.lot_order,(SALT38.StrType)le.dpbc,(SALT38.StrType)le.chk_digit,(SALT38.StrType)le.rec_type,(SALT38.StrType)le.ace_fips_st,(SALT38.StrType)le.ace_fips_county,(SALT38.StrType)le.geo_lat,(SALT38.StrType)le.geo_long,(SALT38.StrType)le.msa,(SALT38.StrType)le.geo_blk,(SALT38.StrType)le.geo_match,(SALT38.StrType)le.err_stat,(SALT38.StrType)le.bdid,(SALT38.StrType)le.did,(SALT38.StrType)le.did_score,(SALT38.StrType)le.bdid_score,(SALT38.StrType)le.source_rec_id,(SALT38.StrType)le.dotid,(SALT38.StrType)le.dotscore,(SALT38.StrType)le.dotweight,(SALT38.StrType)le.empid,(SALT38.StrType)le.empscore,(SALT38.StrType)le.empweight,(SALT38.StrType)le.powid,(SALT38.StrType)le.powscore,(SALT38.StrType)le.powweight,(SALT38.StrType)le.proxid,(SALT38.StrType)le.proxscore,(SALT38.StrType)le.proxweight,(SALT38.StrType)le.seleid,(SALT38.StrType)le.selescore,(SALT38.StrType)le.seleweight,(SALT38.StrType)le.orgid,(SALT38.StrType)le.orgscore,(SALT38.StrType)le.orgweight,(SALT38.StrType)le.ultid,(SALT38.StrType)le.ultscore,(SALT38.StrType)le.ultweight,(SALT38.StrType)le.prep_addr_line1,(SALT38.StrType)le.prep_addr_last_line,(SALT38.StrType)le.rawaid,(SALT38.StrType)le.aceaid,(SALT38.StrType)le.persistent_record_id,'***SALTBUG***');
  END;
  EXPORT AllErrors := NORMALIZE(h,88,Into(LEFT,COUNTER));
   bv := TABLE(AllErrors,{FieldContents, FieldName, Cnt := COUNT(GROUP)},FieldContents, FieldName,MERGE);
  EXPORT BadValues := TOPN(bv,1000,-Cnt);
  // Particular form of stats required for Orbit
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(CA_Party_Layout_UCCV2) prevDS = DATASET([], CA_Party_Layout_UCCV2), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'orig_zip4:invalid_orig_zip4:CUSTOM'
          ,'orig_country:invalid_mandatory:CUSTOM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,CA_Party_Fields.InvalidMessage_tmsid(1)
          ,CA_Party_Fields.InvalidMessage_rmsid(1)
          ,CA_Party_Fields.InvalidMessage_orig_name(1)
          ,CA_Party_Fields.InvalidMessage_orig_lname(1)
          ,CA_Party_Fields.InvalidMessage_orig_fname(1)
          ,CA_Party_Fields.InvalidMessage_duns_number(1)
          ,CA_Party_Fields.InvalidMessage_hq_duns_number(1)
          ,CA_Party_Fields.InvalidMessage_ssn(1)
          ,CA_Party_Fields.InvalidMessage_fein(1)
          ,CA_Party_Fields.InvalidMessage_incorp_state(1)
          ,CA_Party_Fields.InvalidMessage_corp_number(1)
          ,CA_Party_Fields.InvalidMessage_corp_type(1)
          ,CA_Party_Fields.InvalidMessage_orig_address1(1)
          ,CA_Party_Fields.InvalidMessage_orig_city(1)
          ,CA_Party_Fields.InvalidMessage_orig_state(1)
          ,CA_Party_Fields.InvalidMessage_orig_zip5(1)
          ,CA_Party_Fields.InvalidMessage_orig_zip4(1)
          ,CA_Party_Fields.InvalidMessage_orig_country(1)
          ,CA_Party_Fields.InvalidMessage_foreign_indc(1)
          ,CA_Party_Fields.InvalidMessage_party_type(1)
          ,CA_Party_Fields.InvalidMessage_dt_first_seen(1)
          ,CA_Party_Fields.InvalidMessage_dt_last_seen(1)
          ,CA_Party_Fields.InvalidMessage_dt_vendor_last_reported(1)
          ,CA_Party_Fields.InvalidMessage_dt_vendor_first_reported(1)
          ,CA_Party_Fields.InvalidMessage_process_date(1)
          ,CA_Party_Fields.InvalidMessage_fname(1)
          ,CA_Party_Fields.InvalidMessage_mname(1)
          ,CA_Party_Fields.InvalidMessage_lname(1)
          ,CA_Party_Fields.InvalidMessage_company_name(1)
          ,CA_Party_Fields.InvalidMessage_prim_range(1)
          ,CA_Party_Fields.InvalidMessage_predir(1)
          ,CA_Party_Fields.InvalidMessage_prim_name(1)
          ,CA_Party_Fields.InvalidMessage_suffix(1)
          ,CA_Party_Fields.InvalidMessage_postdir(1)
          ,CA_Party_Fields.InvalidMessage_unit_desig(1)
          ,CA_Party_Fields.InvalidMessage_sec_range(1)
          ,CA_Party_Fields.InvalidMessage_p_city_name(1)
          ,CA_Party_Fields.InvalidMessage_v_city_name(1)
          ,CA_Party_Fields.InvalidMessage_st(1)
          ,CA_Party_Fields.InvalidMessage_zip5(1)
          ,CA_Party_Fields.InvalidMessage_zip4(1)
          ,CA_Party_Fields.InvalidMessage_county(1)
          ,CA_Party_Fields.InvalidMessage_cart(1)
          ,CA_Party_Fields.InvalidMessage_cr_sort_sz(1)
          ,CA_Party_Fields.InvalidMessage_lot(1)
          ,CA_Party_Fields.InvalidMessage_lot_order(1)
          ,CA_Party_Fields.InvalidMessage_dpbc(1)
          ,CA_Party_Fields.InvalidMessage_chk_digit(1)
          ,CA_Party_Fields.InvalidMessage_rec_type(1)
          ,CA_Party_Fields.InvalidMessage_ace_fips_st(1)
          ,CA_Party_Fields.InvalidMessage_ace_fips_county(1)
          ,CA_Party_Fields.InvalidMessage_geo_lat(1)
          ,CA_Party_Fields.InvalidMessage_geo_long(1)
          ,CA_Party_Fields.InvalidMessage_msa(1)
          ,CA_Party_Fields.InvalidMessage_geo_blk(1)
          ,CA_Party_Fields.InvalidMessage_geo_match(1)
          ,CA_Party_Fields.InvalidMessage_err_stat(1)
          ,CA_Party_Fields.InvalidMessage_bdid(1)
          ,CA_Party_Fields.InvalidMessage_did(1)
          ,CA_Party_Fields.InvalidMessage_did_score(1)
          ,CA_Party_Fields.InvalidMessage_bdid_score(1)
          ,CA_Party_Fields.InvalidMessage_source_rec_id(1)
          ,CA_Party_Fields.InvalidMessage_dotid(1)
          ,CA_Party_Fields.InvalidMessage_dotscore(1)
          ,CA_Party_Fields.InvalidMessage_dotweight(1)
          ,CA_Party_Fields.InvalidMessage_empid(1)
          ,CA_Party_Fields.InvalidMessage_empscore(1)
          ,CA_Party_Fields.InvalidMessage_empweight(1)
          ,CA_Party_Fields.InvalidMessage_powid(1)
          ,CA_Party_Fields.InvalidMessage_powscore(1)
          ,CA_Party_Fields.InvalidMessage_powweight(1)
          ,CA_Party_Fields.InvalidMessage_proxid(1)
          ,CA_Party_Fields.InvalidMessage_proxscore(1)
          ,CA_Party_Fields.InvalidMessage_proxweight(1)
          ,CA_Party_Fields.InvalidMessage_seleid(1)
          ,CA_Party_Fields.InvalidMessage_selescore(1)
          ,CA_Party_Fields.InvalidMessage_seleweight(1)
          ,CA_Party_Fields.InvalidMessage_orgid(1)
          ,CA_Party_Fields.InvalidMessage_orgscore(1)
          ,CA_Party_Fields.InvalidMessage_orgweight(1)
          ,CA_Party_Fields.InvalidMessage_ultid(1)
          ,CA_Party_Fields.InvalidMessage_ultscore(1)
          ,CA_Party_Fields.InvalidMessage_ultweight(1)
          ,CA_Party_Fields.InvalidMessage_prep_addr_line1(1)
          ,CA_Party_Fields.InvalidMessage_prep_addr_last_line(1)
          ,CA_Party_Fields.InvalidMessage_rawaid(1)
          ,CA_Party_Fields.InvalidMessage_aceaid(1)
          ,CA_Party_Fields.InvalidMessage_persistent_record_id(1)
          ,'Fields with errors'
    ...
    mod_hygiene := CA_Party_hygiene(PROJECT(h, CA_Party_Layout_UCCV2));
  ...
  // record count stats
    ...
    mod_Delta := CA_Party_Delta(prevDS, PROJECT(h, CA_Party_Layout_UCCV2));
...
EXPORT StandardStats(DATASET(CA_Party_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, CA_Party_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
