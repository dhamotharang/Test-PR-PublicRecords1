...
EXPORT FromNone(DATASET(CA_Party_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := CA_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid);
    SELF.rmsid_Invalid := CA_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid);
    SELF.orig_name_Invalid := CA_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_fname);
    SELF.orig_lname_Invalid := CA_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_fname);
    SELF.orig_fname_Invalid := CA_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname);
    SELF.duns_number_Invalid := CA_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number);
    SELF.hq_duns_number_Invalid := CA_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number);
    SELF.ssn_Invalid := CA_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn);
    SELF.fein_Invalid := CA_Party_Fields.InValid_fein((SALT39.StrType)le.fein);
    SELF.incorp_state_Invalid := CA_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state);
    SELF.corp_number_Invalid := CA_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number);
    SELF.corp_type_Invalid := CA_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type);
    SELF.orig_address1_Invalid := CA_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1);
    SELF.orig_city_Invalid := CA_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city);
    SELF.orig_state_Invalid := CA_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state);
    SELF.orig_zip5_Invalid := CA_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country);
    SELF.orig_zip4_Invalid := CA_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4);
    SELF.orig_country_Invalid := CA_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country);
    SELF.foreign_indc_Invalid := CA_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc);
    SELF.party_type_Invalid := CA_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type);
    SELF.dt_first_seen_Invalid := CA_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen);
    SELF.dt_last_seen_Invalid := CA_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen);
    SELF.dt_vendor_last_reported_Invalid := CA_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported);
    SELF.dt_vendor_first_reported_Invalid := CA_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported);
    SELF.process_date_Invalid := CA_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date);
    SELF.fname_Invalid := CA_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name);
    SELF.mname_Invalid := CA_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name);
    SELF.lname_Invalid := CA_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name);
    SELF.company_name_Invalid := CA_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname);
    SELF.prim_range_Invalid := CA_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range);
    SELF.predir_Invalid := CA_Party_Fields.InValid_predir((SALT39.StrType)le.predir);
    SELF.prim_name_Invalid := CA_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name);
    SELF.suffix_Invalid := CA_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix);
    SELF.postdir_Invalid := CA_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir);
    SELF.unit_desig_Invalid := CA_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig);
    SELF.sec_range_Invalid := CA_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range);
    SELF.p_city_name_Invalid := CA_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name);
    SELF.v_city_name_Invalid := CA_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name);
    SELF.st_Invalid := CA_Party_Fields.InValid_st((SALT39.StrType)le.st);
    SELF.zip5_Invalid := CA_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5);
    SELF.zip4_Invalid := CA_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4);
    SELF.county_Invalid := CA_Party_Fields.InValid_county((SALT39.StrType)le.county);
    SELF.cart_Invalid := CA_Party_Fields.InValid_cart((SALT39.StrType)le.cart);
    SELF.cr_sort_sz_Invalid := CA_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz);
    SELF.lot_Invalid := CA_Party_Fields.InValid_lot((SALT39.StrType)le.lot);
    SELF.lot_order_Invalid := CA_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order);
    SELF.dpbc_Invalid := CA_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc);
    SELF.chk_digit_Invalid := CA_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit);
    SELF.rec_type_Invalid := CA_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type);
    SELF.ace_fips_st_Invalid := CA_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st);
    SELF.ace_fips_county_Invalid := CA_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county);
    SELF.geo_lat_Invalid := CA_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat);
    SELF.geo_long_Invalid := CA_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long);
    SELF.msa_Invalid := CA_Party_Fields.InValid_msa((SALT39.StrType)le.msa);
    SELF.geo_blk_Invalid := CA_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk);
    SELF.geo_match_Invalid := CA_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match);
    SELF.err_stat_Invalid := CA_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat);
    SELF.bdid_Invalid := CA_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid);
    SELF.did_Invalid := CA_Party_Fields.InValid_did((SALT39.StrType)le.did);
    SELF.did_score_Invalid := CA_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score);
    SELF.bdid_score_Invalid := CA_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score);
    SELF.source_rec_id_Invalid := CA_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id);
    SELF.dotid_Invalid := CA_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid);
    SELF.dotscore_Invalid := CA_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore);
    SELF.dotweight_Invalid := CA_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight);
    SELF.empid_Invalid := CA_Party_Fields.InValid_empid((SALT39.StrType)le.empid);
    SELF.empscore_Invalid := CA_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore);
    SELF.empweight_Invalid := CA_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight);
    SELF.powid_Invalid := CA_Party_Fields.InValid_powid((SALT39.StrType)le.powid);
    SELF.powscore_Invalid := CA_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore);
    SELF.powweight_Invalid := CA_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight);
    SELF.proxid_Invalid := CA_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid);
    SELF.proxscore_Invalid := CA_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore);
    SELF.proxweight_Invalid := CA_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight);
    SELF.seleid_Invalid := CA_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid);
    SELF.selescore_Invalid := CA_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore);
    SELF.seleweight_Invalid := CA_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight);
    SELF.orgid_Invalid := CA_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid);
    SELF.orgscore_Invalid := CA_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore);
    SELF.orgweight_Invalid := CA_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight);
    SELF.ultid_Invalid := CA_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid);
    SELF.ultscore_Invalid := CA_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore);
    SELF.ultweight_Invalid := CA_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight);
    SELF.prep_addr_line1_Invalid := CA_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1);
    SELF.prep_addr_last_line_Invalid := CA_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line);
    SELF.rawaid_Invalid := CA_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid);
    SELF.aceaid_Invalid := CA_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid);
    SELF.persistent_record_id_Invalid := CA_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    incorp_state_LENGTHS_ErrorCount := COUNT(GROUP,h.incorp_state_Invalid=1);
    corp_number_LENGTHS_ErrorCount := COUNT(GROUP,h.corp_number_Invalid=1);
    corp_type_LENGTHS_ErrorCount := COUNT(GROUP,h.corp_type_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.incorp_state_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.corp_number_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.corp_type_Invalid,'LENGTHS','UNKNOWN')
  ...
  // field error stats
    SALT39.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'incorp_state:invalid_empty:LENGTHS'
          ,'corp_number:invalid_empty:LENGTHS'
          ,'corp_type:invalid_empty:LENGTHS'
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.incorp_state_LENGTHS_ErrorCount
          ,le.corp_number_LENGTHS_ErrorCount
          ,le.corp_type_LENGTHS_ErrorCount
...
EXPORT StandardStats(DATASET(CA_Party_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, CA_Party_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
