...
EXPORT MakeFT_invalid_alpha_blank(SALT37.StrType s0) := FUNCTION
  s1 := SALT37.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha_blank(SALT37.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT37.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '))));
EXPORT InValidMessageFT_invalid_alpha_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_boolean_yn_empty(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean_yn_empty(SALT37.StrType s) := WHICH(((SALT37.StrType) s) NOT IN ['N','Y','']);
EXPORT InValidMessageFT_invalid_boolean_yn_empty(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInEnum('N|Y|'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_08pastdate(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_08pastdate(SALT37.StrType s) := WHICH(~Scrubs.fn_valid_pastDate(s)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 8));
EXPORT InValidMessageFT_invalid_08pastdate(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT37.HygieneErrors.NotLength('0,8'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_pastdate06(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pastdate06(SALT37.StrType s) := WHICH(~Scrubs.valid_date.fn_valid_0468pastDate(s,FALSE,TRUE)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 6));
EXPORT InValidMessageFT_invalid_pastdate06(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs.valid_date.fn_valid_0468pastDate'),SALT37.HygieneErrors.NotLength('0,6'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_zip_code5(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip_code5(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip5(s)>0);
EXPORT InValidMessageFT_invalid_zip_code5(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip5'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip_code4(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip_code4(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip4(s)>0);
EXPORT InValidMessageFT_invalid_zip_code4(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip4'),SALT37.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_party_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_party_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_party_type(s)>0);
EXPORT InValidMessageFT_invalid_party_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_party_type'),SALT37.HygieneErrors.Good);
...
EXPORT Make_orig_name(SALT37.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_orig_name(SALT37.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_orig_name(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_orig_lname(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_lname(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_lname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_fname(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_fname(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_fname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_mname(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_mname(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_mname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_suffix(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_suffix(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_hq_duns_number(SALT37.StrType s0) := MakeFT_invalid_duns_number(s0);
EXPORT InValid_hq_duns_number(SALT37.StrType s) := InValidFT_invalid_duns_number(s);
...
EXPORT Make_orig_address1(SALT37.StrType s0) := MakeFT_invalid_orig_address1(s0);
EXPORT InValid_orig_address1(SALT37.StrType s,SALT37.StrType orig_city,SALT37.StrType orig_state) := InValidFT_invalid_orig_address1(s,orig_city,orig_state);
EXPORT InValidMessage_orig_address1(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_address1(wh);
 
EXPORT Make_orig_address2(SALT37.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_orig_address2(SALT37.StrType s) := InValidFT_invalid_wordbag(s);
...
EXPORT Make_orig_state(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_orig_state(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_orig_zip5(SALT37.StrType s0) := MakeFT_invalid_zip_code5(s0);
EXPORT InValid_orig_zip5(SALT37.StrType s) := InValidFT_invalid_zip_code5(s);
EXPORT InValidMessage_orig_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_zip_code5(wh);
 
EXPORT Make_orig_zip4(SALT37.StrType s0) := MakeFT_invalid_zip_code4(s0);
EXPORT InValid_orig_zip4(SALT37.StrType s) := InValidFT_invalid_zip_code4(s);
EXPORT InValidMessage_orig_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_zip_code4(wh);
 
EXPORT Make_orig_country(SALT37.StrType s0) := MakeFT_invalid_alpha_blank(s0);
EXPORT InValid_orig_country(SALT37.StrType s) := InValidFT_invalid_alpha_blank(s);
EXPORT InValidMessage_orig_country(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_blank(wh);
 
EXPORT Make_orig_province(SALT37.StrType s0) := MakeFT_invalid_alpha_blank(s0);
EXPORT InValid_orig_province(SALT37.StrType s) := InValidFT_invalid_alpha_blank(s);
...
EXPORT Make_foreign_indc(SALT37.StrType s0) := MakeFT_invalid_boolean_yn_empty(s0);
EXPORT InValid_foreign_indc(SALT37.StrType s) := InValidFT_invalid_boolean_yn_empty(s);
...
EXPORT Make_dt_first_seen(SALT37.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_first_seen(SALT37.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_last_seen(SALT37.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_last_seen(SALT37.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_vendor_last_reported(SALT37.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_vendor_last_reported(SALT37.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_vendor_last_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_vendor_first_reported(SALT37.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_vendor_first_reported(SALT37.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_vendor_first_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_process_date(SALT37.StrType s0) := MakeFT_invalid_08pastdate(s0);
EXPORT InValid_process_date(SALT37.StrType s) := InValidFT_invalid_08pastdate(s);
...
EXPORT Make_name_suffix(SALT37.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_name_suffix(SALT37.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_name_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_name_score(SALT37.StrType s0) := MakeFT_invalid_numeric_blank(s0);
EXPORT InValid_name_score(SALT37.StrType s) := InValidFT_invalid_numeric_blank(s);
