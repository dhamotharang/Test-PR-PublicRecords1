...
EXPORT DNB_Party_Fields := MODULE
 
EXPORT NumFields := 96;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_alpha_blank','invalid_numeric_blank','invalid_empty','invalid_zero_integer','invalid_boolean_yn_empty','invalid_wordbag','invalid_08pastdate','invalid_pastdate06','invalid_tmsid','invalid_rmsid','invalid_duns_number','invalid_orig_address1','invalid_state','invalid_zip_code5','invalid_zip_code4','invalid_party_type','invalid_fname','invalid_mname','invalid_lname','invalid_company_name');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_alpha_blank' => 2,'invalid_numeric_blank' => 3,'invalid_empty' => 4,'invalid_zero_integer' => 5,'invalid_boolean_yn_empty' => 6,'invalid_wordbag' => 7,'invalid_08pastdate' => 8,'invalid_pastdate06' => 9,'invalid_tmsid' => 10,'invalid_rmsid' => 11,'invalid_duns_number' => 12,'invalid_orig_address1' => 13,'invalid_state' => 14,'invalid_zip_code5' => 15,'invalid_zip_code4' => 16,'invalid_party_type' => 17,'invalid_fname' => 18,'invalid_mname' => 19,'invalid_lname' => 20,'invalid_company_name' => 21,0);
 
EXPORT MakeFT_invalid_mandatory(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mandatory(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s)>0);
EXPORT InValidMessageFT_invalid_mandatory(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alpha_blank(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha_blank(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '))));
EXPORT InValidMessageFT_invalid_alpha_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_numeric_blank(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numeric_blank(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'0123456789 '))));
EXPORT InValidMessageFT_invalid_numeric_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('0123456789 '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_empty(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_empty(SALT38.StrType s) := WHICH(~(LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_empty(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotLength('0'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_boolean_yn_empty(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean_yn_empty(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['N','Y','']);
EXPORT InValidMessageFT_invalid_boolean_yn_empty(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('N|Y|'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_wordbag(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>-^=:;!+&,./#`@*|_"%~{}[]\\\'()'); // Only allow valid symbols
  s2 := SALT38.stringcleanspaces( SALT38.stringsubstituteout(s1,' <>-^=:;!+&,./#`@*|_"%~{}[]\\\'()',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_invalid_wordbag(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>-^=:;!+&,./#`@*|_"%~{}[]\\\'()'))),~(LENGTH(TRIM(s)) >= 0));
EXPORT InValidMessageFT_invalid_wordbag(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>-^=:;!+&,./#`@*|_"%~{}[]\\\'()'),SALT38.HygieneErrors.NotLength('0..'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_08pastdate(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_08pastdate(SALT38.StrType s) := WHICH(~Scrubs.fn_valid_pastDate(s)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 8));
EXPORT InValidMessageFT_invalid_08pastdate(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT38.HygieneErrors.NotLength('0,8'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_pastdate06(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pastdate06(SALT38.StrType s) := WHICH(~Scrubs.valid_date.fn_valid_0468pastDate(s,FALSE,TRUE)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 6));
EXPORT InValidMessageFT_invalid_pastdate06(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs.valid_date.fn_valid_0468pastDate'),SALT38.HygieneErrors.NotLength('0,6'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_tmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_dnb_tmsid(s)>0);
EXPORT InValidMessageFT_invalid_tmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_dnb_tmsid'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_rmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_dnb_rmsid(s)>0);
EXPORT InValidMessageFT_invalid_rmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_dnb_rmsid'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_duns_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_duns_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_duns(s)>0);
EXPORT InValidMessageFT_invalid_duns_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_duns'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_address1(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_address1(SALT38.StrType s,SALT38.StrType orig_city,SALT38.StrType orig_state) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_city,orig_state)>0);
EXPORT InValidMessageFT_invalid_orig_address1(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_state(s)>0);
EXPORT InValidMessageFT_invalid_state(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_state'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip_code5(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip_code5(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip5(s)>0);
EXPORT InValidMessageFT_invalid_zip_code5(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip5'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip_code4(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip_code4(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip4(s)>0);
EXPORT InValidMessageFT_invalid_zip_code4(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip4'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_party_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_party_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_party_type(s)>0);
EXPORT InValidMessageFT_invalid_party_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_party_type'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fname(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_fname(SALT38.StrType s,SALT38.StrType mname,SALT38.StrType lname,SALT38.StrType company_name) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,mname,lname,company_name)>0);
EXPORT InValidMessageFT_invalid_fname(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_mname(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mname(SALT38.StrType s,SALT38.StrType fname,SALT38.StrType lname,SALT38.StrType company_name) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,fname,lname,company_name)>0);
EXPORT InValidMessageFT_invalid_mname(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_lname(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_lname(SALT38.StrType s,SALT38.StrType fname,SALT38.StrType mname,SALT38.StrType company_name) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,fname,mname,company_name)>0);
EXPORT InValidMessageFT_invalid_lname(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_company_name(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_company_name(SALT38.StrType s,SALT38.StrType fname,SALT38.StrType mname,SALT38.StrType lname) := WHICH(~Scrubs_UCCV2.Functions.fn_company_xor_person(s,fname,mname,lname)>0);
EXPORT InValidMessageFT_invalid_company_name(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_company_xor_person'),SALT38.HygieneErrors.Good);
...
EXPORT Make_rmsid(SALT38.StrType s0) := MakeFT_invalid_rmsid(s0);
EXPORT InValid_rmsid(SALT38.StrType s) := InValidFT_invalid_rmsid(s);
EXPORT InValidMessage_rmsid(UNSIGNED1 wh) := InValidMessageFT_invalid_rmsid(wh);
 
EXPORT Make_orig_name(SALT38.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_orig_name(SALT38.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_orig_name(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_orig_lname(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_lname(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_lname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_fname(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_fname(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_fname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_mname(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_mname(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_mname(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_suffix(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_orig_suffix(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_orig_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_duns_number(SALT38.StrType s0) := MakeFT_invalid_duns_number(s0);
EXPORT InValid_duns_number(SALT38.StrType s) := InValidFT_invalid_duns_number(s);
EXPORT InValidMessage_duns_number(UNSIGNED1 wh) := InValidMessageFT_invalid_duns_number(wh);
 
EXPORT Make_hq_duns_number(SALT38.StrType s0) := MakeFT_invalid_duns_number(s0);
EXPORT InValid_hq_duns_number(SALT38.StrType s) := InValidFT_invalid_duns_number(s);
EXPORT InValidMessage_hq_duns_number(UNSIGNED1 wh) := InValidMessageFT_invalid_duns_number(wh);
 
EXPORT Make_ssn(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_ssn(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_ssn(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_fein(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_fein(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_fein(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_incorp_state(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_incorp_state(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_incorp_state(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_corp_number(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_corp_number(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_corp_number(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_corp_type(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_corp_type(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_corp_type(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_orig_address1(SALT38.StrType s0) := MakeFT_invalid_orig_address1(s0);
EXPORT InValid_orig_address1(SALT38.StrType s,SALT38.StrType orig_city,SALT38.StrType orig_state) := InValidFT_invalid_orig_address1(s,orig_city,orig_state);
EXPORT InValidMessage_orig_address1(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_address1(wh);
 
EXPORT Make_orig_address2(SALT38.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_orig_address2(SALT38.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_orig_address2(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
...
EXPORT Make_orig_state(SALT38.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_orig_state(SALT38.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_orig_zip5(SALT38.StrType s0) := MakeFT_invalid_zip_code5(s0);
EXPORT InValid_orig_zip5(SALT38.StrType s) := InValidFT_invalid_zip_code5(s);
EXPORT InValidMessage_orig_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_zip_code5(wh);
 
EXPORT Make_orig_zip4(SALT38.StrType s0) := MakeFT_invalid_zip_code4(s0);
EXPORT InValid_orig_zip4(SALT38.StrType s) := InValidFT_invalid_zip_code4(s);
EXPORT InValidMessage_orig_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_zip_code4(wh);
 
EXPORT Make_orig_country(SALT38.StrType s0) := MakeFT_invalid_alpha_blank(s0);
EXPORT InValid_orig_country(SALT38.StrType s) := InValidFT_invalid_alpha_blank(s);
EXPORT InValidMessage_orig_country(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_blank(wh);
 
EXPORT Make_orig_province(SALT38.StrType s0) := MakeFT_invalid_alpha_blank(s0);
EXPORT InValid_orig_province(SALT38.StrType s) := InValidFT_invalid_alpha_blank(s);
EXPORT InValidMessage_orig_province(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_blank(wh);
 
EXPORT Make_orig_postal_code(SALT38.StrType s0) := s0;
EXPORT InValid_orig_postal_code(SALT38.StrType s) := 0;
EXPORT InValidMessage_orig_postal_code(UNSIGNED1 wh) := '';
 
EXPORT Make_foreign_indc(SALT38.StrType s0) := MakeFT_invalid_boolean_yn_empty(s0);
EXPORT InValid_foreign_indc(SALT38.StrType s) := InValidFT_invalid_boolean_yn_empty(s);
EXPORT InValidMessage_foreign_indc(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean_yn_empty(wh);
 
EXPORT Make_party_type(SALT38.StrType s0) := MakeFT_invalid_party_type(s0);
EXPORT InValid_party_type(SALT38.StrType s) := InValidFT_invalid_party_type(s);
EXPORT InValidMessage_party_type(UNSIGNED1 wh) := InValidMessageFT_invalid_party_type(wh);
 
EXPORT Make_dt_first_seen(SALT38.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_first_seen(SALT38.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_last_seen(SALT38.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_last_seen(SALT38.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_vendor_last_reported(SALT38.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_vendor_last_reported(SALT38.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_vendor_last_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_dt_vendor_first_reported(SALT38.StrType s0) := MakeFT_invalid_pastdate06(s0);
EXPORT InValid_dt_vendor_first_reported(SALT38.StrType s) := InValidFT_invalid_pastdate06(s);
EXPORT InValidMessage_dt_vendor_first_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate06(wh);
 
EXPORT Make_process_date(SALT38.StrType s0) := MakeFT_invalid_08pastdate(s0);
EXPORT InValid_process_date(SALT38.StrType s) := InValidFT_invalid_08pastdate(s);
EXPORT InValidMessage_process_date(UNSIGNED1 wh) := InValidMessageFT_invalid_08pastdate(wh);
 
EXPORT Make_title(SALT38.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_title(SALT38.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_title(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
...
EXPORT Make_name_suffix(SALT38.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_name_suffix(SALT38.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_name_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_name_score(SALT38.StrType s0) := MakeFT_invalid_numeric_blank(s0);
EXPORT InValid_name_score(SALT38.StrType s) := InValidFT_invalid_numeric_blank(s);
EXPORT InValidMessage_name_score(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric_blank(wh);
...
EXPORT Make_prim_range(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_prim_range(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_prim_range(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_predir(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_predir(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_predir(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_prim_name(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_prim_name(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_prim_name(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_suffix(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_suffix(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_postdir(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_postdir(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_postdir(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_unit_desig(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_unit_desig(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_unit_desig(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_sec_range(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_sec_range(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_sec_range(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_p_city_name(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_p_city_name(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_p_city_name(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_v_city_name(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_v_city_name(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_v_city_name(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_st(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_st(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_st(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_zip5(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_zip5(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_zip4(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_zip4(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_county(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_county(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_county(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_cart(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_cart(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_cart(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_cr_sort_sz(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_cr_sort_sz(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_cr_sort_sz(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_lot(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_lot(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_lot(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_lot_order(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_lot_order(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_lot_order(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_dpbc(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_dpbc(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_dpbc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_chk_digit(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_chk_digit(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_chk_digit(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_rec_type(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_rec_type(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_rec_type(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_ace_fips_st(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_ace_fips_st(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_ace_fips_st(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_ace_fips_county(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_ace_fips_county(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_ace_fips_county(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_geo_lat(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_geo_lat(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_geo_lat(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_geo_long(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_geo_long(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_geo_long(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_msa(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_msa(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_msa(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_geo_blk(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_geo_blk(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_geo_blk(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_geo_match(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_geo_match(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_geo_match(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_err_stat(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_err_stat(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_err_stat(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_bdid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_bdid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
...
EXPORT Make_bdid_score(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_bdid_score(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_bdid_score(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_source_rec_id(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_source_rec_id(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
...
EXPORT Make_powid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_powid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_powid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_powscore(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_powscore(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_powscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_powweight(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_powweight(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_powweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_proxid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_proxid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_proxid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_proxscore(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_proxscore(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_proxscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_proxweight(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_proxweight(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_proxweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_seleid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_seleid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_seleid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_selescore(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_selescore(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_selescore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_seleweight(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_seleweight(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_seleweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_orgid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_orgid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_orgid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_orgscore(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_orgscore(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_orgscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_orgweight(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_orgweight(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_orgweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_ultid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_ultid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_ultid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_ultscore(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_ultscore(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_ultscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_ultweight(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_ultweight(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
...
EXPORT Make_prep_addr_last_line(SALT38.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_prep_addr_last_line(SALT38.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_prep_addr_last_line(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_rawaid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_rawaid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_rawaid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_aceaid(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_aceaid(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
EXPORT InValidMessage_aceaid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_integer(wh);
 
EXPORT Make_persistent_record_id(SALT38.StrType s0) := MakeFT_invalid_zero_integer(s0);
EXPORT InValid_persistent_record_id(SALT38.StrType s) := InValidFT_invalid_zero_integer(s);
