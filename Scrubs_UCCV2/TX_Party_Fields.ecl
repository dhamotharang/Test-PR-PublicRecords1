...
EXPORT TX_Party_Fields := MODULE
 
EXPORT NumFields := 96;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_empty','invalid_zero_integer','invalid_boolean_yn','invalid_numeric','invalid_alpha','invalid_alphanum_specials','invalid_pastdate8','invalid_pastdate6','invalid_tmsid','invalid_rmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','invalid_state','invalid_zip5','invalid_orig_country','invalid_party_type','invalid_fname','invalid_mname','invalid_lname','invalid_company_name');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_empty' => 2,'invalid_zero_integer' => 3,'invalid_boolean_yn' => 4,'invalid_numeric' => 5,'invalid_alpha' => 6,'invalid_alphanum_specials' => 7,'invalid_pastdate8' => 8,'invalid_pastdate6' => 9,'invalid_tmsid' => 10,'invalid_rmsid' => 11,'invalid_orig_name' => 12,'invalid_orig_lname' => 13,'invalid_orig_fname' => 14,'invalid_state' => 15,'invalid_zip5' => 16,'invalid_orig_country' => 17,'invalid_party_type' => 18,'invalid_fname' => 19,'invalid_mname' => 20,'invalid_lname' => 21,'invalid_company_name' => 22,0);
...
EXPORT MakeFT_invalid_boolean_yn(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean_yn(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['N','Y']);
EXPORT InValidMessageFT_invalid_boolean_yn(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('N|Y'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_alpha(SALT38.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '))));
EXPORT InValidMessageFT_invalid_alpha(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphanum_specials(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ @-./,&\'#'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphanum_specials(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ @-./,&\'#'))));
EXPORT InValidMessageFT_invalid_alphanum_specials(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ @-./,&\'#'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_pastdate8(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pastdate8(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_past_yyyymmdd(s)>0);
EXPORT InValidMessageFT_invalid_pastdate8(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_past_yyyymmdd'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_pastdate6(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pastdate6(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_past_yyyymm(s)>0);
EXPORT InValidMessageFT_invalid_pastdate6(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_past_yyyymm'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_tmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'TX')>0);
EXPORT InValidMessageFT_invalid_tmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_rmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'TX')>0);
EXPORT InValidMessageFT_invalid_rmsid(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_name(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_name(SALT38.StrType s,SALT38.StrType orig_lname,SALT38.StrType orig_fname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_lname,orig_fname)>0);
EXPORT InValidMessageFT_invalid_orig_name(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_lname(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_lname(SALT38.StrType s,SALT38.StrType orig_name,SALT38.StrType orig_fname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_name,orig_fname)>0);
EXPORT InValidMessageFT_invalid_orig_lname(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_fname(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_fname(SALT38.StrType s,SALT38.StrType orig_name,SALT38.StrType orig_lname) := WHICH(~Scrubs_UCCV2.Functions.fn_populated_strings(s,orig_name,orig_lname)>0);
EXPORT InValidMessageFT_invalid_orig_fname(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_populated_strings'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_zip5(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip5(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_verify_zip5(s)>0);
EXPORT InValidMessageFT_invalid_zip5(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_verify_zip5'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_country(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_country(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_country(s)>0);
EXPORT InValidMessageFT_invalid_orig_country(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_country'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_party_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_party_type(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['D','S','A','N']);
EXPORT InValidMessageFT_invalid_party_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('D|S|A|N'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],[],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],[],[],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],[],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['ENUM'],['ENUM'],['ENUM'],[]);
...
EXPORT Make_orig_name(SALT38.StrType s0) := MakeFT_invalid_orig_name(s0);
EXPORT InValid_orig_name(SALT38.StrType s,SALT38.StrType orig_lname,SALT38.StrType orig_fname) := InValidFT_invalid_orig_name(s,orig_lname,orig_fname);
...
EXPORT InValid_orig_lname(SALT38.StrType s,SALT38.StrType orig_name,SALT38.StrType orig_fname) := InValidFT_invalid_orig_lname(s,orig_name,orig_fname);
...
EXPORT InValid_orig_fname(SALT38.StrType s,SALT38.StrType orig_name,SALT38.StrType orig_lname) := InValidFT_invalid_orig_fname(s,orig_name,orig_lname);
EXPORT InValidMessage_orig_fname(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_fname(wh);
 
EXPORT Make_orig_mname(SALT38.StrType s0) := s0;
EXPORT InValid_orig_mname(SALT38.StrType s) := 0;
EXPORT InValidMessage_orig_mname(UNSIGNED1 wh) := '';
 
EXPORT Make_orig_suffix(SALT38.StrType s0) := s0;
EXPORT InValid_orig_suffix(SALT38.StrType s) := 0;
EXPORT InValidMessage_orig_suffix(UNSIGNED1 wh) := '';
 
EXPORT Make_duns_number(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_duns_number(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_duns_number(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_hq_duns_number(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_hq_duns_number(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_corp_number(SALT38.StrType s0) := s0;
EXPORT InValid_corp_number(SALT38.StrType s) := 0;
EXPORT InValidMessage_corp_number(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_type(SALT38.StrType s0) := s0;
EXPORT InValid_corp_type(SALT38.StrType s) := 0;
EXPORT InValidMessage_corp_type(UNSIGNED1 wh) := '';
...
EXPORT Make_orig_state(SALT38.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_orig_state(SALT38.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
 
EXPORT Make_orig_zip5(SALT38.StrType s0) := MakeFT_invalid_zip5(s0);
EXPORT InValid_orig_zip5(SALT38.StrType s) := InValidFT_invalid_zip5(s);
...
EXPORT Make_orig_country(SALT38.StrType s0) := MakeFT_invalid_orig_country(s0);
EXPORT InValid_orig_country(SALT38.StrType s) := InValidFT_invalid_orig_country(s);
EXPORT InValidMessage_orig_country(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_country(wh);
 
EXPORT Make_orig_province(SALT38.StrType s0) := s0;
EXPORT InValid_orig_province(SALT38.StrType s) := 0;
...
EXPORT Make_foreign_indc(SALT38.StrType s0) := MakeFT_invalid_boolean_yn(s0);
EXPORT InValid_foreign_indc(SALT38.StrType s) := InValidFT_invalid_boolean_yn(s);
...
EXPORT Make_dt_first_seen(SALT38.StrType s0) := MakeFT_invalid_pastdate6(s0);
EXPORT InValid_dt_first_seen(SALT38.StrType s) := InValidFT_invalid_pastdate6(s);
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate6(wh);
 
EXPORT Make_dt_last_seen(SALT38.StrType s0) := MakeFT_invalid_pastdate6(s0);
EXPORT InValid_dt_last_seen(SALT38.StrType s) := InValidFT_invalid_pastdate6(s);
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate6(wh);
 
EXPORT Make_dt_vendor_last_reported(SALT38.StrType s0) := MakeFT_invalid_pastdate6(s0);
EXPORT InValid_dt_vendor_last_reported(SALT38.StrType s) := InValidFT_invalid_pastdate6(s);
EXPORT InValidMessage_dt_vendor_last_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate6(wh);
 
EXPORT Make_dt_vendor_first_reported(SALT38.StrType s0) := MakeFT_invalid_pastdate6(s0);
EXPORT InValid_dt_vendor_first_reported(SALT38.StrType s) := InValidFT_invalid_pastdate6(s);
EXPORT InValidMessage_dt_vendor_first_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate6(wh);
 
EXPORT Make_process_date(SALT38.StrType s0) := MakeFT_invalid_pastdate8(s0);
EXPORT InValid_process_date(SALT38.StrType s) := InValidFT_invalid_pastdate8(s);
