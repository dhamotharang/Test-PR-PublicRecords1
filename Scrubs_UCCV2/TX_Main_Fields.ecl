...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['TX','TX']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('TX|TX'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_tx_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_tx_orig_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_tx_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_tx_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_status_type(s)>0);
EXPORT InValidMessageFT_invalid_status(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_status_type'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_page(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_page(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_page(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_numeric'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],[],[],[],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[]);
...
EXPORT Make_filing_status(SALT38.StrType s0) := MakeFT_invalid_status(s0);
EXPORT InValid_filing_status(SALT38.StrType s) := InValidFT_invalid_status(s);
EXPORT InValidMessage_filing_status(UNSIGNED1 wh) := InValidMessageFT_invalid_status(wh);
 
EXPORT Make_status_type(SALT38.StrType s0) := MakeFT_invalid_status(s0);
EXPORT InValid_status_type(SALT38.StrType s) := InValidFT_invalid_status(s);
EXPORT InValidMessage_status_type(UNSIGNED1 wh) := InValidMessageFT_invalid_status(wh);
 
EXPORT Make_page(SALT38.StrType s0) := MakeFT_invalid_page(s0);
EXPORT InValid_page(SALT38.StrType s) := InValidFT_invalid_page(s);
EXPORT InValidMessage_page(UNSIGNED1 wh) := InValidMessageFT_invalid_page(wh);
