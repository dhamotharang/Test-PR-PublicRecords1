...
EXPORT FromNone(DATASET(CA_Main_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := CA_Main_Fields.InValid_tmsid((SALT38.StrType)le.tmsid);
    SELF.rmsid_Invalid := CA_Main_Fields.InValid_rmsid((SALT38.StrType)le.rmsid);
    SELF.process_date_Invalid := CA_Main_Fields.InValid_process_date((SALT38.StrType)le.process_date);
    SELF.filing_jurisdiction_Invalid := CA_Main_Fields.InValid_filing_jurisdiction((SALT38.StrType)le.filing_jurisdiction);
    SELF.orig_filing_number_Invalid := CA_Main_Fields.InValid_orig_filing_number((SALT38.StrType)le.orig_filing_number);
    SELF.orig_filing_type_Invalid := CA_Main_Fields.InValid_orig_filing_type((SALT38.StrType)le.orig_filing_type);
    SELF.orig_filing_date_Invalid := CA_Main_Fields.InValid_orig_filing_date((SALT38.StrType)le.orig_filing_date);
    SELF.orig_filing_time_Invalid := CA_Main_Fields.InValid_orig_filing_time((SALT38.StrType)le.orig_filing_time);
    SELF.filing_number_Invalid := CA_Main_Fields.InValid_filing_number((SALT38.StrType)le.filing_number);
    SELF.filing_type_Invalid := CA_Main_Fields.InValid_filing_type((SALT38.StrType)le.filing_type);
    SELF.filing_date_Invalid := CA_Main_Fields.InValid_filing_date((SALT38.StrType)le.filing_date);
    SELF.filing_time_Invalid := CA_Main_Fields.InValid_filing_time((SALT38.StrType)le.filing_time);
    SELF.filing_status_Invalid := CA_Main_Fields.InValid_filing_status((SALT38.StrType)le.filing_status);
    SELF.status_type_Invalid := CA_Main_Fields.InValid_status_type((SALT38.StrType)le.status_type);
    SELF.page_Invalid := CA_Main_Fields.InValid_page((SALT38.StrType)le.page);
    SELF.expiration_date_Invalid := CA_Main_Fields.InValid_expiration_date((SALT38.StrType)le.expiration_date);
    SELF.contract_type_Invalid := CA_Main_Fields.InValid_contract_type((SALT38.StrType)le.contract_type);
    SELF.vendor_entry_date_Invalid := CA_Main_Fields.InValid_vendor_entry_date((SALT38.StrType)le.vendor_entry_date);
    SELF.vendor_upd_date_Invalid := CA_Main_Fields.InValid_vendor_upd_date((SALT38.StrType)le.vendor_upd_date);
    SELF.statements_filed_Invalid := CA_Main_Fields.InValid_statements_filed((SALT38.StrType)le.statements_filed);
    SELF.continuious_expiration_Invalid := CA_Main_Fields.InValid_continuious_expiration((SALT38.StrType)le.continuious_expiration);
    SELF.microfilm_number_Invalid := CA_Main_Fields.InValid_microfilm_number((SALT38.StrType)le.microfilm_number);
    SELF.amount_Invalid := CA_Main_Fields.InValid_amount((SALT38.StrType)le.amount);
    SELF.effective_date_Invalid := CA_Main_Fields.InValid_effective_date((SALT38.StrType)le.effective_date);
    SELF.signer_name_Invalid := CA_Main_Fields.InValid_signer_name((SALT38.StrType)le.signer_name);
    SELF.title_Invalid := CA_Main_Fields.InValid_title((SALT38.StrType)le.title);
    SELF.filing_agency_Invalid := CA_Main_Fields.InValid_filing_agency((SALT38.StrType)le.filing_agency);
    SELF.address_Invalid := CA_Main_Fields.InValid_address((SALT38.StrType)le.address);
    SELF.city_Invalid := CA_Main_Fields.InValid_city((SALT38.StrType)le.city);
    SELF.state_Invalid := CA_Main_Fields.InValid_state((SALT38.StrType)le.state);
    SELF.county_Invalid := CA_Main_Fields.InValid_county((SALT38.StrType)le.county);
    SELF.zip_Invalid := CA_Main_Fields.InValid_zip((SALT38.StrType)le.zip);
    SELF.prim_machine_Invalid := CA_Main_Fields.InValid_prim_machine((SALT38.StrType)le.prim_machine);
    SELF.manufacturer_code_Invalid := CA_Main_Fields.InValid_manufacturer_code((SALT38.StrType)le.manufacturer_code);
    SELF.manufacturer_name_Invalid := CA_Main_Fields.InValid_manufacturer_name((SALT38.StrType)le.manufacturer_name);
    SELF.model_Invalid := CA_Main_Fields.InValid_model((SALT38.StrType)le.model);
    SELF.model_year_Invalid := CA_Main_Fields.InValid_model_year((SALT38.StrType)le.model_year);
    SELF.model_desc_Invalid := CA_Main_Fields.InValid_model_desc((SALT38.StrType)le.model_desc);
    SELF.collateral_count_Invalid := CA_Main_Fields.InValid_collateral_count((SALT38.StrType)le.collateral_count);
    SELF.new_used_Invalid := CA_Main_Fields.InValid_new_used((SALT38.StrType)le.new_used);
    SELF.serial_number_Invalid := CA_Main_Fields.InValid_serial_number((SALT38.StrType)le.serial_number);
    SELF.property_desc_Invalid := CA_Main_Fields.InValid_property_desc((SALT38.StrType)le.property_desc);
    SELF.borough_Invalid := CA_Main_Fields.InValid_borough((SALT38.StrType)le.borough);
    SELF.block_Invalid := CA_Main_Fields.InValid_block((SALT38.StrType)le.block);
    SELF.collateral_address_Invalid := CA_Main_Fields.InValid_collateral_address((SALT38.StrType)le.collateral_address);
    SELF.air_rights_indc_Invalid := CA_Main_Fields.InValid_air_rights_indc((SALT38.StrType)le.air_rights_indc);
    SELF.subterranean_rights_indc_Invalid := CA_Main_Fields.InValid_subterranean_rights_indc((SALT38.StrType)le.subterranean_rights_indc);
    SELF.easment_indc_Invalid := CA_Main_Fields.InValid_easment_indc((SALT38.StrType)le.easment_indc);
    SELF.persistent_record_id_Invalid := CA_Main_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    AnyRule_WithErrorsCount := COUNT(GROUP, h.tmsid_Invalid > 0 OR h.rmsid_Invalid > 0 OR h.process_date_Invalid > 0 OR h.filing_jurisdiction_Invalid > 0 OR h.orig_filing_number_Invalid > 0 OR h.orig_filing_type_Invalid > 0 OR h.orig_filing_date_Invalid > 0 OR h.orig_filing_time_Invalid > 0 OR h.filing_number_Invalid > 0 OR h.filing_type_Invalid > 0 OR h.filing_date_Invalid > 0 OR h.filing_time_Invalid > 0 OR h.filing_status_Invalid > 0 OR h.status_type_Invalid > 0 OR h.page_Invalid > 0 OR h.expiration_date_Invalid > 0 OR h.contract_type_Invalid > 0 OR h.vendor_entry_date_Invalid > 0 OR h.vendor_upd_date_Invalid > 0 OR h.statements_filed_Invalid > 0 OR h.continuious_expiration_Invalid > 0 OR h.microfilm_number_Invalid > 0 OR h.amount_Invalid > 0 OR h.effective_date_Invalid > 0 OR h.signer_name_Invalid > 0 OR h.title_Invalid > 0 OR h.filing_agency_Invalid > 0 OR h.address_Invalid > 0 OR h.city_Invalid > 0 OR h.state_Invalid > 0 OR h.county_Invalid > 0 OR h.zip_Invalid > 0 OR h.prim_machine_Invalid > 0 OR h.manufacturer_code_Invalid > 0 OR h.manufacturer_name_Invalid > 0 OR h.model_Invalid > 0 OR h.model_year_Invalid > 0 OR h.model_desc_Invalid > 0 OR h.collateral_count_Invalid > 0 OR h.new_used_Invalid > 0 OR h.serial_number_Invalid > 0 OR h.property_desc_Invalid > 0 OR h.borough_Invalid > 0 OR h.block_Invalid > 0 OR h.collateral_address_Invalid > 0 OR h.air_rights_indc_Invalid > 0 OR h.subterranean_rights_indc_Invalid > 0 OR h.easment_indc_Invalid > 0 OR h.persistent_record_id_Invalid > 0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT38.StrType)le.tmsid,(SALT38.StrType)le.rmsid,(SALT38.StrType)le.process_date,(SALT38.StrType)le.filing_jurisdiction,(SALT38.StrType)le.orig_filing_number,(SALT38.StrType)le.orig_filing_type,(SALT38.StrType)le.orig_filing_date,(SALT38.StrType)le.orig_filing_time,(SALT38.StrType)le.filing_number,(SALT38.StrType)le.filing_type,(SALT38.StrType)le.filing_date,(SALT38.StrType)le.filing_time,(SALT38.StrType)le.filing_status,(SALT38.StrType)le.status_type,(SALT38.StrType)le.page,(SALT38.StrType)le.expiration_date,(SALT38.StrType)le.contract_type,(SALT38.StrType)le.vendor_entry_date,(SALT38.StrType)le.vendor_upd_date,(SALT38.StrType)le.statements_filed,(SALT38.StrType)le.continuious_expiration,(SALT38.StrType)le.microfilm_number,(SALT38.StrType)le.amount,(SALT38.StrType)le.effective_date,(SALT38.StrType)le.signer_name,(SALT38.StrType)le.title,(SALT38.StrType)le.filing_agency,(SALT38.StrType)le.address,(SALT38.StrType)le.city,(SALT38.StrType)le.state,(SALT38.StrType)le.county,(SALT38.StrType)le.zip,(SALT38.StrType)le.prim_machine,(SALT38.StrType)le.manufacturer_code,(SALT38.StrType)le.manufacturer_name,(SALT38.StrType)le.model,(SALT38.StrType)le.model_year,(SALT38.StrType)le.model_desc,(SALT38.StrType)le.collateral_count,(SALT38.StrType)le.new_used,(SALT38.StrType)le.serial_number,(SALT38.StrType)le.property_desc,(SALT38.StrType)le.borough,(SALT38.StrType)le.block,(SALT38.StrType)le.collateral_address,(SALT38.StrType)le.air_rights_indc,(SALT38.StrType)le.subterranean_rights_indc,(SALT38.StrType)le.easment_indc,(SALT38.StrType)le.persistent_record_id,'***SALTBUG***');
  END;
  EXPORT AllErrors := NORMALIZE(h,49,Into(LEFT,COUNTER));
   bv := TABLE(AllErrors,{FieldContents, FieldName, Cnt := COUNT(GROUP)},FieldContents, FieldName,MERGE);
  EXPORT BadValues := TOPN(bv,1000,-Cnt);
  // Particular form of stats required for Orbit
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(CA_Main_Layout_UCCV2) prevDS = DATASET([], CA_Main_Layout_UCCV2), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,CA_Main_Fields.InvalidMessage_persistent_record_id(1)
          ,'Fields with errors'
    ...
    mod_hygiene := CA_Main_hygiene(PROJECT(h, CA_Main_Layout_UCCV2));
  ...
  // record count stats
    ...
    mod_Delta := CA_Main_Delta(prevDS, PROJECT(h, CA_Main_Layout_UCCV2));
...
EXPORT StandardStats(DATASET(CA_Main_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, CA_Main_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
