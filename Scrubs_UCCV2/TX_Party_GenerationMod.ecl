...
IMPORT SALT39;
EXPORT TX_Party_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + '\n'
    + 'FIELDTYPE:invalid_tmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid>0,\'TX\')\n'
    + 'FIELDTYPE:invalid_rmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid>0,\'TX\')\n'
