...
EXPORT WA_Main_Fields := MODULE
 
EXPORT NumFields := 62;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_numeric_blank','invalid_empty','invalid_8pastdate','invalid_tmsid','invalid_rmsid','invalid_filing_jurisdiction','invalid_orig_filing_number','invalid_orig_filing_type','invalid_orig_filing_date','invalid_orig_filing_time','invalid_filing_number','invalid_filing_type','invalid_filing_date','invalid_filing_time','invalid_expiration_date','invalid_filing_agency','invalid_address','invalid_city','invalid_state','invalid_zip');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_numeric_blank' => 2,'invalid_empty' => 3,'invalid_8pastdate' => 4,'invalid_tmsid' => 5,'invalid_rmsid' => 6,'invalid_filing_jurisdiction' => 7,'invalid_orig_filing_number' => 8,'invalid_orig_filing_type' => 9,'invalid_orig_filing_date' => 10,'invalid_orig_filing_time' => 11,'invalid_filing_number' => 12,'invalid_filing_type' => 13,'invalid_filing_date' => 14,'invalid_filing_time' => 15,'invalid_expiration_date' => 16,'invalid_filing_agency' => 17,'invalid_address' => 18,'invalid_city' => 19,'invalid_state' => 20,'invalid_zip' => 21,0);
...
EXPORT MakeFT_invalid_tmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'WA')>0);
...
EXPORT MakeFT_invalid_rmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'WA')>0);
...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['WA','WA']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('WA|WA'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_wa_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_wa_orig_filing_type'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_filing_date(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_date(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_date(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_non_empty_numeric(s)>0);
EXPORT InValidMessageFT_invalid_filing_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_non_empty_numeric'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_wa_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_wa_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_agency(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_agency(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_wa_filing_agency(s)>0);
EXPORT InValidMessageFT_invalid_filing_agency(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_wa_filing_agency'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_wa_address(s)>0);
EXPORT InValidMessageFT_invalid_address(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_wa_address'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_city(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_city(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['OLYMPIA','OLYMPIA']);
EXPORT InValidMessageFT_invalid_city(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('OLYMPIA|OLYMPIA'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['WA','WA']);
EXPORT InValidMessageFT_invalid_state(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('WA|WA'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['98502','98502']);
EXPORT InValidMessageFT_invalid_zip(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('98502|98502'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['CUSTOM'],['CUSTOM'],['ENUM'],['ENUM'],['LENGTH'],['ENUM'],['LENGTH'],['LENGTH'],[],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[]);
...
EXPORT Make_filing_number(SALT38.StrType s0) := MakeFT_invalid_filing_number(s0);
EXPORT InValid_filing_number(SALT38.StrType s) := InValidFT_invalid_filing_number(s);
...
EXPORT Make_page(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_page(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_page(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
...
EXPORT Make_signer_name(SALT38.StrType s0) := s0;
EXPORT InValid_signer_name(SALT38.StrType s) := 0;
EXPORT InValidMessage_signer_name(UNSIGNED1 wh) := '';
...
EXPORT Make_filing_agency(SALT38.StrType s0) := MakeFT_invalid_filing_agency(s0);
EXPORT InValid_filing_agency(SALT38.StrType s) := InValidFT_invalid_filing_agency(s);
EXPORT InValidMessage_filing_agency(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_agency(wh);
 
EXPORT Make_address(SALT38.StrType s0) := MakeFT_invalid_address(s0);
EXPORT InValid_address(SALT38.StrType s) := InValidFT_invalid_address(s);
...
EXPORT Make_cmnt_effective_date(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_cmnt_effective_date(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_sec_machine(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_sec_machine(SALT38.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_manufactured_year(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufactured_year(SALT38.StrType s) := InValidFT_invalid_empty(s);
