...
EXPORT MakeFT_invalid_tmsid(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'MA')>0);
...
EXPORT MakeFT_invalid_rmsid(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'MA')>0);
...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT37.StrType s) := WHICH(((SALT37.StrType) s) NOT IN ['MA','MA']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInEnum('MA|MA'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ma_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ma_orig_filing_type'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ma_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ma_filing_type'),SALT37.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_type(SALT37.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_type(SALT37.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_ma_status_type(s)>0);
EXPORT InValidMessageFT_invalid_status_type(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_ma_status_type'),SALT37.HygieneErrors.Good);
...
EXPORT Make_page(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_page(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_page(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_expiration_date(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_expiration_date(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_microfilm_number(SALT37.StrType s0) := MakeFT_invalid_numeric_blank(s0);
EXPORT InValid_microfilm_number(SALT37.StrType s) := InValidFT_invalid_numeric_blank(s);
...
EXPORT Make_signer_name(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_signer_name(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_cmnt_effective_date(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_cmnt_effective_date(SALT37.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_cmnt_effective_date(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_description(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_description(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_sec_machine(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_sec_machine(SALT37.StrType s) := InValidFT_invalid_empty(s);
...
EXPORT Make_manufactured_year(SALT37.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_manufactured_year(SALT37.StrType s) := InValidFT_invalid_empty(s);
