...
Command line options: -MScrubs_UCCV2 -eC:\Users\wolfkg\AppData\Local\Temp\TFRB8FA.tmp 
...
FIELDTYPE:invalid_filing_jurisdiction:ENUM(WA|WA)
FIELDTYPE:invalid_orig_filing_number:CUSTOM(Scrubs_UCCV2.Functions.fn_non_empty_numeric>0)
FIELDTYPE:invalid_orig_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_wa_orig_filing_type>0)
FIELDTYPE:invalid_orig_filing_date:CUSTOM(Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd>0)
...
FIELDTYPE:invalid_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_wa_filing_type>0)
...
FIELDTYPE:invalid_filing_agency:CUSTOM(Scrubs_UCCV2.Functions.fn_wa_filing_agency>0)
FIELDTYPE:invalid_address:CUSTOM(Scrubs_UCCV2.Functions.fn_wa_address>0)
FIELDTYPE:invalid_city:ENUM(OLYMPIA|OLYMPIA)
FIELDTYPE:invalid_state:ENUM(WA|WA)
FIELDTYPE:invalid_zip:ENUM(98502|98502)
...
FIELD:signer_name:TYPE(STRING75):0,0
FIELD:title:TYPE(STRING60):LIKE(invalid_empty):0,0
FIELD:filing_agency:TYPE(STRING120):LIKE(invalid_filing_agency):0,0
FIELD:address:TYPE(STRING64):LIKE(invalid_address):0,0
FIELD:city:TYPE(STRING30):LIKE(invalid_city):0,0
FIELD:state:TYPE(STRING2):LIKE(invalid_state):0,0
FIELD:county:TYPE(STRING30):LIKE(invalid_empty):0,0
FIELD:zip:TYPE(STRING9):LIKE(invalid_zip):0,0
