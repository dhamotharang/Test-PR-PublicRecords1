...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    IL_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid),
    IL_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid),
    IL_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname),
    IL_Party_Fields.InValid_orig_mname((SALT39.StrType)le.orig_mname),
    IL_Party_Fields.InValid_orig_suffix((SALT39.StrType)le.orig_suffix),
    IL_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number),
    IL_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number),
    IL_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn),
    IL_Party_Fields.InValid_fein((SALT39.StrType)le.fein),
    IL_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state),
    IL_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number),
    IL_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type),
    IL_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1),
    IL_Party_Fields.InValid_orig_address2((SALT39.StrType)le.orig_address2),
    IL_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city),
    IL_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state),
    IL_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country),
    IL_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4),
    IL_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country),
    IL_Party_Fields.InValid_orig_province((SALT39.StrType)le.orig_province),
    IL_Party_Fields.InValid_orig_postal_code((SALT39.StrType)le.orig_postal_code),
    IL_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc),
    IL_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type),
    IL_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen),
    IL_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen),
    IL_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported),
    IL_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported),
    IL_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date),
    IL_Party_Fields.InValid_title((SALT39.StrType)le.title),
    IL_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    IL_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name),
    IL_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name),
    IL_Party_Fields.InValid_name_suffix((SALT39.StrType)le.name_suffix),
    IL_Party_Fields.InValid_name_score((SALT39.StrType)le.name_score),
    IL_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname),
    IL_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range),
    IL_Party_Fields.InValid_predir((SALT39.StrType)le.predir),
    IL_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name),
    IL_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix),
    IL_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir),
    IL_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig),
    IL_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range),
    IL_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name),
    IL_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name),
    IL_Party_Fields.InValid_st((SALT39.StrType)le.st),
    IL_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5),
    IL_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4),
    IL_Party_Fields.InValid_county((SALT39.StrType)le.county),
    IL_Party_Fields.InValid_cart((SALT39.StrType)le.cart),
    IL_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz),
    IL_Party_Fields.InValid_lot((SALT39.StrType)le.lot),
    IL_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order),
    IL_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc),
    IL_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit),
    IL_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type),
    IL_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st),
    IL_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county),
    IL_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat),
    IL_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long),
    IL_Party_Fields.InValid_msa((SALT39.StrType)le.msa),
    IL_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk),
    IL_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match),
    IL_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat),
    IL_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid),
    IL_Party_Fields.InValid_did((SALT39.StrType)le.did),
    IL_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score),
    IL_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score),
    IL_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id),
    IL_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid),
    IL_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore),
    IL_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight),
    IL_Party_Fields.InValid_empid((SALT39.StrType)le.empid),
    IL_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore),
    IL_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight),
    IL_Party_Fields.InValid_powid((SALT39.StrType)le.powid),
    IL_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore),
    IL_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight),
    IL_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid),
    IL_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore),
    IL_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight),
    IL_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid),
    IL_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore),
    IL_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight),
    IL_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid),
    IL_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore),
    IL_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight),
    IL_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid),
    IL_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore),
    IL_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight),
    IL_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1),
    IL_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line),
    IL_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid),
    IL_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid),
    IL_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, IL_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
