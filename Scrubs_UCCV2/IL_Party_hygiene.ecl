...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    IL_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    IL_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    IL_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname),
    IL_Party_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    IL_Party_Fields.InValid_orig_suffix((SALT38.StrType)le.orig_suffix),
    IL_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    IL_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number),
    IL_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn),
    IL_Party_Fields.InValid_fein((SALT38.StrType)le.fein),
    IL_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state),
    IL_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number),
    IL_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type),
    IL_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1),
    IL_Party_Fields.InValid_orig_address2((SALT38.StrType)le.orig_address2),
    IL_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    IL_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state),
    IL_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5),
    IL_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    IL_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country),
    IL_Party_Fields.InValid_orig_province((SALT38.StrType)le.orig_province),
    IL_Party_Fields.InValid_orig_postal_code((SALT38.StrType)le.orig_postal_code),
    IL_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc),
    IL_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type),
    IL_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen),
    IL_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen),
    IL_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported),
    IL_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported),
    IL_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    IL_Party_Fields.InValid_title((SALT38.StrType)le.title),
    IL_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    IL_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name),
    IL_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name),
    IL_Party_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    IL_Party_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    IL_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname),
    IL_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    IL_Party_Fields.InValid_predir((SALT38.StrType)le.predir),
    IL_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    IL_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    IL_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    IL_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    IL_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    IL_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    IL_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    IL_Party_Fields.InValid_st((SALT38.StrType)le.st),
    IL_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5),
    IL_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    IL_Party_Fields.InValid_county((SALT38.StrType)le.county),
    IL_Party_Fields.InValid_cart((SALT38.StrType)le.cart),
    IL_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    IL_Party_Fields.InValid_lot((SALT38.StrType)le.lot),
    IL_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    IL_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc),
    IL_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    IL_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    IL_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st),
    IL_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county),
    IL_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    IL_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    IL_Party_Fields.InValid_msa((SALT38.StrType)le.msa),
    IL_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    IL_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    IL_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    IL_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid),
    IL_Party_Fields.InValid_did((SALT38.StrType)le.did),
    IL_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score),
    IL_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score),
    IL_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id),
    IL_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid),
    IL_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore),
    IL_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight),
    IL_Party_Fields.InValid_empid((SALT38.StrType)le.empid),
    IL_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore),
    IL_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight),
    IL_Party_Fields.InValid_powid((SALT38.StrType)le.powid),
    IL_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore),
    IL_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight),
    IL_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid),
    IL_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore),
    IL_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight),
    IL_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid),
    IL_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore),
    IL_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight),
    IL_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid),
    IL_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore),
    IL_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight),
    IL_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid),
    IL_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore),
    IL_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight),
    IL_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1),
    IL_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line),
    IL_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid),
    IL_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid),
    IL_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, IL_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
