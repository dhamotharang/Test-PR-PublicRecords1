IMPORT SALT37;
EXPORT IL_Party_hygiene(dataset(IL_Party_layout_UCCV2) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    IL_Party_Fields.InValid_tmsid((SALT37.StrType)le.tmsid),
    IL_Party_Fields.InValid_rmsid((SALT37.StrType)le.rmsid),
    IL_Party_Fields.InValid_orig_name((SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_lname((SALT37.StrType)le.orig_lname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_fname),
    IL_Party_Fields.InValid_orig_fname((SALT37.StrType)le.orig_fname,(SALT37.StrType)le.orig_name,(SALT37.StrType)le.orig_lname),
    IL_Party_Fields.InValid_orig_mname((SALT37.StrType)le.orig_mname),
    IL_Party_Fields.InValid_orig_suffix((SALT37.StrType)le.orig_suffix),
    IL_Party_Fields.InValid_duns_number((SALT37.StrType)le.duns_number),
    IL_Party_Fields.InValid_hq_duns_number((SALT37.StrType)le.hq_duns_number),
    IL_Party_Fields.InValid_ssn((SALT37.StrType)le.ssn),
    IL_Party_Fields.InValid_fein((SALT37.StrType)le.fein),
    IL_Party_Fields.InValid_incorp_state((SALT37.StrType)le.incorp_state),
    IL_Party_Fields.InValid_corp_number((SALT37.StrType)le.corp_number),
    IL_Party_Fields.InValid_corp_type((SALT37.StrType)le.corp_type),
    IL_Party_Fields.InValid_orig_address1((SALT37.StrType)le.orig_address1),
    IL_Party_Fields.InValid_orig_address2((SALT37.StrType)le.orig_address2),
    IL_Party_Fields.InValid_orig_city((SALT37.StrType)le.orig_city),
    IL_Party_Fields.InValid_orig_state((SALT37.StrType)le.orig_state),
    IL_Party_Fields.InValid_orig_zip5((SALT37.StrType)le.orig_zip5),
    IL_Party_Fields.InValid_orig_zip4((SALT37.StrType)le.orig_zip4),
    IL_Party_Fields.InValid_orig_country((SALT37.StrType)le.orig_country),
    IL_Party_Fields.InValid_orig_province((SALT37.StrType)le.orig_province),
    IL_Party_Fields.InValid_orig_postal_code((SALT37.StrType)le.orig_postal_code),
    IL_Party_Fields.InValid_foreign_indc((SALT37.StrType)le.foreign_indc),
    IL_Party_Fields.InValid_party_type((SALT37.StrType)le.party_type),
    IL_Party_Fields.InValid_dt_first_seen((SALT37.StrType)le.dt_first_seen),
    IL_Party_Fields.InValid_dt_last_seen((SALT37.StrType)le.dt_last_seen),
    IL_Party_Fields.InValid_dt_vendor_last_reported((SALT37.StrType)le.dt_vendor_last_reported),
    IL_Party_Fields.InValid_dt_vendor_first_reported((SALT37.StrType)le.dt_vendor_first_reported),
    IL_Party_Fields.InValid_process_date((SALT37.StrType)le.process_date),
    IL_Party_Fields.InValid_title((SALT37.StrType)le.title),
    IL_Party_Fields.InValid_fname((SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    IL_Party_Fields.InValid_mname((SALT37.StrType)le.mname,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.company_name),
    IL_Party_Fields.InValid_lname((SALT37.StrType)le.lname,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.company_name),
    IL_Party_Fields.InValid_name_suffix((SALT37.StrType)le.name_suffix),
    IL_Party_Fields.InValid_name_score((SALT37.StrType)le.name_score),
    IL_Party_Fields.InValid_company_name((SALT37.StrType)le.company_name,(SALT37.StrType)le.fname,(SALT37.StrType)le.mname,(SALT37.StrType)le.lname),
    IL_Party_Fields.InValid_prim_range((SALT37.StrType)le.prim_range),
    IL_Party_Fields.InValid_predir((SALT37.StrType)le.predir),
    IL_Party_Fields.InValid_prim_name((SALT37.StrType)le.prim_name),
    IL_Party_Fields.InValid_suffix((SALT37.StrType)le.suffix),
    IL_Party_Fields.InValid_postdir((SALT37.StrType)le.postdir),
    IL_Party_Fields.InValid_unit_desig((SALT37.StrType)le.unit_desig),
    IL_Party_Fields.InValid_sec_range((SALT37.StrType)le.sec_range),
    IL_Party_Fields.InValid_p_city_name((SALT37.StrType)le.p_city_name),
    IL_Party_Fields.InValid_v_city_name((SALT37.StrType)le.v_city_name),
    IL_Party_Fields.InValid_st((SALT37.StrType)le.st),
    IL_Party_Fields.InValid_zip5((SALT37.StrType)le.zip5),
    IL_Party_Fields.InValid_zip4((SALT37.StrType)le.zip4),
    IL_Party_Fields.InValid_county((SALT37.StrType)le.county),
    IL_Party_Fields.InValid_cart((SALT37.StrType)le.cart),
    IL_Party_Fields.InValid_cr_sort_sz((SALT37.StrType)le.cr_sort_sz),
    IL_Party_Fields.InValid_lot((SALT37.StrType)le.lot),
    IL_Party_Fields.InValid_lot_order((SALT37.StrType)le.lot_order),
    IL_Party_Fields.InValid_dpbc((SALT37.StrType)le.dpbc),
    IL_Party_Fields.InValid_chk_digit((SALT37.StrType)le.chk_digit),
    IL_Party_Fields.InValid_rec_type((SALT37.StrType)le.rec_type),
    IL_Party_Fields.InValid_ace_fips_st((SALT37.StrType)le.ace_fips_st),
    IL_Party_Fields.InValid_ace_fips_county((SALT37.StrType)le.ace_fips_county),
    IL_Party_Fields.InValid_geo_lat((SALT37.StrType)le.geo_lat),
    IL_Party_Fields.InValid_geo_long((SALT37.StrType)le.geo_long),
    IL_Party_Fields.InValid_msa((SALT37.StrType)le.msa),
    IL_Party_Fields.InValid_geo_blk((SALT37.StrType)le.geo_blk),
    IL_Party_Fields.InValid_geo_match((SALT37.StrType)le.geo_match),
    IL_Party_Fields.InValid_err_stat((SALT37.StrType)le.err_stat),
    IL_Party_Fields.InValid_bdid((SALT37.StrType)le.bdid),
    IL_Party_Fields.InValid_did((SALT37.StrType)le.did),
    IL_Party_Fields.InValid_did_score((SALT37.StrType)le.did_score),
    IL_Party_Fields.InValid_bdid_score((SALT37.StrType)le.bdid_score),
    IL_Party_Fields.InValid_source_rec_id((SALT37.StrType)le.source_rec_id),
    IL_Party_Fields.InValid_dotid((SALT37.StrType)le.dotid),
    IL_Party_Fields.InValid_dotscore((SALT37.StrType)le.dotscore),
    IL_Party_Fields.InValid_dotweight((SALT37.StrType)le.dotweight),
    IL_Party_Fields.InValid_empid((SALT37.StrType)le.empid),
    IL_Party_Fields.InValid_empscore((SALT37.StrType)le.empscore),
    IL_Party_Fields.InValid_empweight((SALT37.StrType)le.empweight),
    IL_Party_Fields.InValid_powid((SALT37.StrType)le.powid),
    IL_Party_Fields.InValid_powscore((SALT37.StrType)le.powscore),
    IL_Party_Fields.InValid_powweight((SALT37.StrType)le.powweight),
    IL_Party_Fields.InValid_proxid((SALT37.StrType)le.proxid),
    IL_Party_Fields.InValid_proxscore((SALT37.StrType)le.proxscore),
    IL_Party_Fields.InValid_proxweight((SALT37.StrType)le.proxweight),
    IL_Party_Fields.InValid_seleid((SALT37.StrType)le.seleid),
    IL_Party_Fields.InValid_selescore((SALT37.StrType)le.selescore),
    IL_Party_Fields.InValid_seleweight((SALT37.StrType)le.seleweight),
    IL_Party_Fields.InValid_orgid((SALT37.StrType)le.orgid),
    IL_Party_Fields.InValid_orgscore((SALT37.StrType)le.orgscore),
    IL_Party_Fields.InValid_orgweight((SALT37.StrType)le.orgweight),
    IL_Party_Fields.InValid_ultid((SALT37.StrType)le.ultid),
    IL_Party_Fields.InValid_ultscore((SALT37.StrType)le.ultscore),
    IL_Party_Fields.InValid_ultweight((SALT37.StrType)le.ultweight),
    IL_Party_Fields.InValid_prep_addr_line1((SALT37.StrType)le.prep_addr_line1),
    IL_Party_Fields.InValid_prep_addr_last_line((SALT37.StrType)le.prep_addr_last_line),
    IL_Party_Fields.InValid_rawaid((SALT37.StrType)le.rawaid),
    IL_Party_Fields.InValid_aceaid((SALT37.StrType)le.aceaid),
    IL_Party_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := IL_Party_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_tmsid','invalid_rmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','Unknown','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_mandatory','Unknown','invalid_mandatory','invalid_orig_state','invalid_orig_zip5','Unknown','Unknown','Unknown','Unknown','invalid_boolean_yn','invalid_party_type','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate6','invalid_pastdate8','Unknown','invalid_fname','invalid_mname','invalid_lname','Unknown','Unknown','invalid_company_name','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer','invalid_mandatory','invalid_mandatory','invalid_zero_integer','invalid_zero_integer','invalid_zero_integer');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,IL_Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_hq_duns_number(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_fein(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_incorp_state(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_corp_number(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_corp_type(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_province(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orig_postal_code(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_foreign_indc(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_party_type(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_zip5(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ace_fips_st(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ace_fips_county(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_bdid_score(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_source_rec_id(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dotid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dotscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_dotweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_empid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_empscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_empweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_powid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_powscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_powweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_proxscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_proxweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_selescore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_seleweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orgscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_orgweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ultscore(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_ultweight(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_prep_addr_line1(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_prep_addr_last_line(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_aceaid(TotalErrors.ErrorNum),IL_Party_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
