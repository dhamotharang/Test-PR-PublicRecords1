...
IMPORT SALT39;
EXPORT CA_Party_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_orig_zip4:CUSTOM(Scrubs_UCCV2.Functions.fn_verify_zip4>0)\n'
    ...
    + 'FIELD:orig_zip4:TYPE(STRING4):LIKE(invalid_orig_zip4):0,0\n'
    + 'FIELD:orig_country:TYPE(STRING30):LIKE(invalid_mandatory):0,0\n'
