...
Command line options: -MScrubs_UCCV2 -eC:\Users\wolfkg\AppData\Local\Temp\TFRC75F.tmp 
...
FIELDTYPE:invalid_filing_jurisdiction:ENUM(MA|MA)
FIELDTYPE:invalid_orig_filing_number:CUSTOM(Scrubs_UCCV2.Functions.fn_non_empty_numeric>0)
FIELDTYPE:invalid_orig_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_ma_orig_filing_type>0)
...
FIELDTYPE:invalid_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_ma_filing_type>0)
...
FIELDTYPE:invalid_status_type:CUSTOM(Scrubs_UCCV2.Functions.fn_ma_status_type>0)
...
FIELD:microfilm_number:TYPE(STRING17):LIKE(invalid_numeric_blank):0,0
