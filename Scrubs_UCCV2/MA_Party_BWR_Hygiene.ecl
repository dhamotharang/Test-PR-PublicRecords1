...
#workunit('name','Scrubs_UCCV2.MA_Party_BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
IMPORT Scrubs_UCCV2,SALT39;
// First create an instantiated hygiene module
  infile := Scrubs_UCCV2.MA_Party_In_UCCV2;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_UCCV2.MA_Party_hygiene(ip);
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'MA_Party_Layout_UCCV2'),NAMED('OptimizedLayout'));// File layout suggested by data
