...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['IL','IL']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('IL|IL'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_il_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_il_orig_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_il_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_il_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],[],[],[],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['LENGTH'],['LENGTH'],['ALLOW'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['ALLOW'],['ENUM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[]);
...
EXPORT Make_statements_filed(SALT38.StrType s0) := MakeFT_invalid_numeric_blank(s0);
EXPORT InValid_statements_filed(SALT38.StrType s) := InValidFT_invalid_numeric_blank(s);
EXPORT InValidMessage_statements_filed(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric_blank(wh);
 
EXPORT Make_continuious_expiration(SALT38.StrType s0) := MakeFT_invalid_boolean_yn_blank(s0);
EXPORT InValid_continuious_expiration(SALT38.StrType s) := InValidFT_invalid_boolean_yn_blank(s);
