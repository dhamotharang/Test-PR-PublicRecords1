...
EXPORT FromNone(DATASET(IL_Main_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := IL_Main_Fields.InValid_tmsid((SALT37.StrType)le.tmsid);
    SELF.rmsid_Invalid := IL_Main_Fields.InValid_rmsid((SALT37.StrType)le.rmsid);
    SELF.process_date_Invalid := IL_Main_Fields.InValid_process_date((SALT37.StrType)le.process_date);
    SELF.filing_jurisdiction_Invalid := IL_Main_Fields.InValid_filing_jurisdiction((SALT37.StrType)le.filing_jurisdiction);
    SELF.orig_filing_number_Invalid := IL_Main_Fields.InValid_orig_filing_number((SALT37.StrType)le.orig_filing_number);
    SELF.orig_filing_type_Invalid := IL_Main_Fields.InValid_orig_filing_type((SALT37.StrType)le.orig_filing_type);
    SELF.orig_filing_date_Invalid := IL_Main_Fields.InValid_orig_filing_date((SALT37.StrType)le.orig_filing_date);
    SELF.orig_filing_time_Invalid := IL_Main_Fields.InValid_orig_filing_time((SALT37.StrType)le.orig_filing_time);
    SELF.filing_number_Invalid := IL_Main_Fields.InValid_filing_number((SALT37.StrType)le.filing_number);
    SELF.filing_type_Invalid := IL_Main_Fields.InValid_filing_type((SALT37.StrType)le.filing_type);
    SELF.filing_date_Invalid := IL_Main_Fields.InValid_filing_date((SALT37.StrType)le.filing_date);
    SELF.filing_time_Invalid := IL_Main_Fields.InValid_filing_time((SALT37.StrType)le.filing_time);
    SELF.filing_status_Invalid := IL_Main_Fields.InValid_filing_status((SALT37.StrType)le.filing_status);
    SELF.status_type_Invalid := IL_Main_Fields.InValid_status_type((SALT37.StrType)le.status_type);
    SELF.page_Invalid := IL_Main_Fields.InValid_page((SALT37.StrType)le.page);
    SELF.expiration_date_Invalid := IL_Main_Fields.InValid_expiration_date((SALT37.StrType)le.expiration_date);
    SELF.contract_type_Invalid := IL_Main_Fields.InValid_contract_type((SALT37.StrType)le.contract_type);
    SELF.vendor_entry_date_Invalid := IL_Main_Fields.InValid_vendor_entry_date((SALT37.StrType)le.vendor_entry_date);
    SELF.vendor_upd_date_Invalid := IL_Main_Fields.InValid_vendor_upd_date((SALT37.StrType)le.vendor_upd_date);
    SELF.statements_filed_Invalid := IL_Main_Fields.InValid_statements_filed((SALT37.StrType)le.statements_filed);
    SELF.continuious_expiration_Invalid := IL_Main_Fields.InValid_continuious_expiration((SALT37.StrType)le.continuious_expiration);
    SELF.microfilm_number_Invalid := IL_Main_Fields.InValid_microfilm_number((SALT37.StrType)le.microfilm_number);
    SELF.amount_Invalid := IL_Main_Fields.InValid_amount((SALT37.StrType)le.amount);
    SELF.irs_serial_number_Invalid := IL_Main_Fields.InValid_irs_serial_number((SALT37.StrType)le.irs_serial_number);
    SELF.effective_date_Invalid := IL_Main_Fields.InValid_effective_date((SALT37.StrType)le.effective_date);
    SELF.signer_name_Invalid := IL_Main_Fields.InValid_signer_name((SALT37.StrType)le.signer_name);
    SELF.title_Invalid := IL_Main_Fields.InValid_title((SALT37.StrType)le.title);
    SELF.filing_agency_Invalid := IL_Main_Fields.InValid_filing_agency((SALT37.StrType)le.filing_agency);
    SELF.address_Invalid := IL_Main_Fields.InValid_address((SALT37.StrType)le.address);
    SELF.city_Invalid := IL_Main_Fields.InValid_city((SALT37.StrType)le.city);
    SELF.state_Invalid := IL_Main_Fields.InValid_state((SALT37.StrType)le.state);
    SELF.county_Invalid := IL_Main_Fields.InValid_county((SALT37.StrType)le.county);
    SELF.zip_Invalid := IL_Main_Fields.InValid_zip((SALT37.StrType)le.zip);
    SELF.duns_number_Invalid := IL_Main_Fields.InValid_duns_number((SALT37.StrType)le.duns_number);
    SELF.cmnt_effective_date_Invalid := IL_Main_Fields.InValid_cmnt_effective_date((SALT37.StrType)le.cmnt_effective_date);
    SELF.description_Invalid := IL_Main_Fields.InValid_description((SALT37.StrType)le.description);
    SELF.prim_machine_Invalid := IL_Main_Fields.InValid_prim_machine((SALT37.StrType)le.prim_machine);
    SELF.sec_machine_Invalid := IL_Main_Fields.InValid_sec_machine((SALT37.StrType)le.sec_machine);
    SELF.manufacturer_code_Invalid := IL_Main_Fields.InValid_manufacturer_code((SALT37.StrType)le.manufacturer_code);
    SELF.manufacturer_name_Invalid := IL_Main_Fields.InValid_manufacturer_name((SALT37.StrType)le.manufacturer_name);
    SELF.model_Invalid := IL_Main_Fields.InValid_model((SALT37.StrType)le.model);
    SELF.model_year_Invalid := IL_Main_Fields.InValid_model_year((SALT37.StrType)le.model_year);
    SELF.model_desc_Invalid := IL_Main_Fields.InValid_model_desc((SALT37.StrType)le.model_desc);
    SELF.collateral_count_Invalid := IL_Main_Fields.InValid_collateral_count((SALT37.StrType)le.collateral_count);
    SELF.manufactured_year_Invalid := IL_Main_Fields.InValid_manufactured_year((SALT37.StrType)le.manufactured_year);
    SELF.new_used_Invalid := IL_Main_Fields.InValid_new_used((SALT37.StrType)le.new_used);
    SELF.serial_number_Invalid := IL_Main_Fields.InValid_serial_number((SALT37.StrType)le.serial_number);
    SELF.property_desc_Invalid := IL_Main_Fields.InValid_property_desc((SALT37.StrType)le.property_desc);
    SELF.borough_Invalid := IL_Main_Fields.InValid_borough((SALT37.StrType)le.borough);
    SELF.block_Invalid := IL_Main_Fields.InValid_block((SALT37.StrType)le.block);
    SELF.collateral_address_Invalid := IL_Main_Fields.InValid_collateral_address((SALT37.StrType)le.collateral_address);
    SELF.air_rights_indc_Invalid := IL_Main_Fields.InValid_air_rights_indc((SALT37.StrType)le.air_rights_indc);
    SELF.subterranean_rights_indc_Invalid := IL_Main_Fields.InValid_subterranean_rights_indc((SALT37.StrType)le.subterranean_rights_indc);
    SELF.easment_indc_Invalid := IL_Main_Fields.InValid_easment_indc((SALT37.StrType)le.easment_indc);
    SELF.volume_Invalid := IL_Main_Fields.InValid_volume((SALT37.StrType)le.volume);
    SELF.persistent_record_id_Invalid := IL_Main_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id);
    SELF := le;
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT37.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,IL_Main_Fields.InvalidMessage_persistent_record_id(1),'UNKNOWN');
