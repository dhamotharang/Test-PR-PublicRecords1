...
EXPORT NYC_Party_Fields := MODULE
 
EXPORT NumFields := 96;
 
// Processing for each FieldType
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_empty','invalid_zero_integer','invalid_boolean_yn','invalid_numeric','invalid_alpha','invalid_alphanum_specials','invalid_pastdate8','invalid_pastdate6','invalid_tmsid','invalid_orig_name','invalid_orig_lname','invalid_orig_fname','invalid_state','invalid_zip5','invalid_orig_country','invalid_party_type','invalid_fname','invalid_mname','invalid_lname','invalid_company_name');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_empty' => 2,'invalid_zero_integer' => 3,'invalid_boolean_yn' => 4,'invalid_numeric' => 5,'invalid_alpha' => 6,'invalid_alphanum_specials' => 7,'invalid_pastdate8' => 8,'invalid_pastdate6' => 9,'invalid_tmsid' => 10,'invalid_orig_name' => 11,'invalid_orig_lname' => 12,'invalid_orig_fname' => 13,'invalid_state' => 14,'invalid_zip5' => 15,'invalid_orig_country' => 16,'invalid_party_type' => 17,'invalid_fname' => 18,'invalid_mname' => 19,'invalid_lname' => 20,'invalid_company_name' => 21,0);
...
EXPORT MakeFT_invalid_tmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'NYC')>0);
...
EXPORT MakeFT_invalid_orig_country(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_country(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_country2(s)>0);
EXPORT InValidMessageFT_invalid_orig_country(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_country2'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['ALLOW'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],[],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],[],['CUSTOM'],[],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],[],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['ENUM'],['ENUM'],['ENUM'],[]);
...
EXPORT Make_rmsid(SALT38.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_rmsid(SALT38.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_rmsid(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
...
EXPORT Make_orig_postal_code(SALT38.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_orig_postal_code(SALT38.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_orig_postal_code(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_foreign_indc(SALT38.StrType s0) := s0;
EXPORT InValid_foreign_indc(SALT38.StrType s) := 0;
