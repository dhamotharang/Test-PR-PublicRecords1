...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    CA_Main_Fields.InValid_tmsid((SALT37.StrType)le.tmsid),
    CA_Main_Fields.InValid_rmsid((SALT37.StrType)le.rmsid),
    CA_Main_Fields.InValid_process_date((SALT37.StrType)le.process_date),
    CA_Main_Fields.InValid_static_value((SALT37.StrType)le.static_value),
    CA_Main_Fields.InValid_date_vendor_removed((SALT37.StrType)le.date_vendor_removed),
    CA_Main_Fields.InValid_date_vendor_changed((SALT37.StrType)le.date_vendor_changed),
    CA_Main_Fields.InValid_filing_jurisdiction((SALT37.StrType)le.filing_jurisdiction),
    CA_Main_Fields.InValid_orig_filing_number((SALT37.StrType)le.orig_filing_number),
    CA_Main_Fields.InValid_orig_filing_type((SALT37.StrType)le.orig_filing_type),
    CA_Main_Fields.InValid_orig_filing_date((SALT37.StrType)le.orig_filing_date),
    CA_Main_Fields.InValid_orig_filing_time((SALT37.StrType)le.orig_filing_time),
    CA_Main_Fields.InValid_filing_number((SALT37.StrType)le.filing_number),
    CA_Main_Fields.InValid_filing_number_indc((SALT37.StrType)le.filing_number_indc),
    CA_Main_Fields.InValid_filing_type((SALT37.StrType)le.filing_type),
    CA_Main_Fields.InValid_filing_date((SALT37.StrType)le.filing_date),
    CA_Main_Fields.InValid_filing_time((SALT37.StrType)le.filing_time),
    CA_Main_Fields.InValid_filing_status((SALT37.StrType)le.filing_status),
    CA_Main_Fields.InValid_status_type((SALT37.StrType)le.status_type),
    CA_Main_Fields.InValid_page((SALT37.StrType)le.page),
    CA_Main_Fields.InValid_expiration_date((SALT37.StrType)le.expiration_date),
    CA_Main_Fields.InValid_contract_type((SALT37.StrType)le.contract_type),
    CA_Main_Fields.InValid_vendor_entry_date((SALT37.StrType)le.vendor_entry_date),
    CA_Main_Fields.InValid_vendor_upd_date((SALT37.StrType)le.vendor_upd_date),
    CA_Main_Fields.InValid_statements_filed((SALT37.StrType)le.statements_filed),
    CA_Main_Fields.InValid_continuious_expiration((SALT37.StrType)le.continuious_expiration),
    CA_Main_Fields.InValid_microfilm_number((SALT37.StrType)le.microfilm_number),
    CA_Main_Fields.InValid_amount((SALT37.StrType)le.amount),
    CA_Main_Fields.InValid_irs_serial_number((SALT37.StrType)le.irs_serial_number),
    CA_Main_Fields.InValid_effective_date((SALT37.StrType)le.effective_date),
    CA_Main_Fields.InValid_signer_name((SALT37.StrType)le.signer_name),
    CA_Main_Fields.InValid_title((SALT37.StrType)le.title),
    CA_Main_Fields.InValid_filing_agency((SALT37.StrType)le.filing_agency),
    CA_Main_Fields.InValid_address((SALT37.StrType)le.address),
    CA_Main_Fields.InValid_city((SALT37.StrType)le.city),
    CA_Main_Fields.InValid_state((SALT37.StrType)le.state),
    CA_Main_Fields.InValid_county((SALT37.StrType)le.county),
    CA_Main_Fields.InValid_zip((SALT37.StrType)le.zip),
    CA_Main_Fields.InValid_duns_number((SALT37.StrType)le.duns_number),
    CA_Main_Fields.InValid_cmnt_effective_date((SALT37.StrType)le.cmnt_effective_date),
    CA_Main_Fields.InValid_description((SALT37.StrType)le.description),
    CA_Main_Fields.InValid_collateral_desc((SALT37.StrType)le.collateral_desc),
    CA_Main_Fields.InValid_prim_machine((SALT37.StrType)le.prim_machine),
    CA_Main_Fields.InValid_sec_machine((SALT37.StrType)le.sec_machine),
    CA_Main_Fields.InValid_manufacturer_code((SALT37.StrType)le.manufacturer_code),
    CA_Main_Fields.InValid_manufacturer_name((SALT37.StrType)le.manufacturer_name),
    CA_Main_Fields.InValid_model((SALT37.StrType)le.model),
    CA_Main_Fields.InValid_model_year((SALT37.StrType)le.model_year),
    CA_Main_Fields.InValid_model_desc((SALT37.StrType)le.model_desc),
    CA_Main_Fields.InValid_collateral_count((SALT37.StrType)le.collateral_count),
    CA_Main_Fields.InValid_manufactured_year((SALT37.StrType)le.manufactured_year),
    CA_Main_Fields.InValid_new_used((SALT37.StrType)le.new_used),
    CA_Main_Fields.InValid_serial_number((SALT37.StrType)le.serial_number),
    CA_Main_Fields.InValid_property_desc((SALT37.StrType)le.property_desc),
    CA_Main_Fields.InValid_borough((SALT37.StrType)le.borough),
    CA_Main_Fields.InValid_block((SALT37.StrType)le.block),
    CA_Main_Fields.InValid_lot((SALT37.StrType)le.lot),
    CA_Main_Fields.InValid_collateral_address((SALT37.StrType)le.collateral_address),
    CA_Main_Fields.InValid_air_rights_indc((SALT37.StrType)le.air_rights_indc),
    CA_Main_Fields.InValid_subterranean_rights_indc((SALT37.StrType)le.subterranean_rights_indc),
    CA_Main_Fields.InValid_easment_indc((SALT37.StrType)le.easment_indc),
    CA_Main_Fields.InValid_volume((SALT37.StrType)le.volume),
    CA_Main_Fields.InValid_persistent_record_id((SALT37.StrType)le.persistent_record_id),
    0);
