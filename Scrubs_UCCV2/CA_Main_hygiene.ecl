IMPORT SALT38,STD;
EXPORT CA_Main_hygiene(dataset(CA_Main_layout_UCCV2) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    CA_Main_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    CA_Main_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    CA_Main_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    CA_Main_Fields.InValid_static_value((SALT38.StrType)le.static_value),
    CA_Main_Fields.InValid_date_vendor_removed((SALT38.StrType)le.date_vendor_removed),
    CA_Main_Fields.InValid_date_vendor_changed((SALT38.StrType)le.date_vendor_changed),
    CA_Main_Fields.InValid_filing_jurisdiction((SALT38.StrType)le.filing_jurisdiction),
    CA_Main_Fields.InValid_orig_filing_number((SALT38.StrType)le.orig_filing_number),
    CA_Main_Fields.InValid_orig_filing_type((SALT38.StrType)le.orig_filing_type),
    CA_Main_Fields.InValid_orig_filing_date((SALT38.StrType)le.orig_filing_date),
    CA_Main_Fields.InValid_orig_filing_time((SALT38.StrType)le.orig_filing_time),
    CA_Main_Fields.InValid_filing_number((SALT38.StrType)le.filing_number),
    CA_Main_Fields.InValid_filing_number_indc((SALT38.StrType)le.filing_number_indc),
    CA_Main_Fields.InValid_filing_type((SALT38.StrType)le.filing_type),
    CA_Main_Fields.InValid_filing_date((SALT38.StrType)le.filing_date),
    CA_Main_Fields.InValid_filing_time((SALT38.StrType)le.filing_time),
    CA_Main_Fields.InValid_filing_status((SALT38.StrType)le.filing_status),
    CA_Main_Fields.InValid_status_type((SALT38.StrType)le.status_type),
    CA_Main_Fields.InValid_page((SALT38.StrType)le.page),
    CA_Main_Fields.InValid_expiration_date((SALT38.StrType)le.expiration_date),
    CA_Main_Fields.InValid_contract_type((SALT38.StrType)le.contract_type),
    CA_Main_Fields.InValid_vendor_entry_date((SALT38.StrType)le.vendor_entry_date),
    CA_Main_Fields.InValid_vendor_upd_date((SALT38.StrType)le.vendor_upd_date),
    CA_Main_Fields.InValid_statements_filed((SALT38.StrType)le.statements_filed),
    CA_Main_Fields.InValid_continuious_expiration((SALT38.StrType)le.continuious_expiration),
    CA_Main_Fields.InValid_microfilm_number((SALT38.StrType)le.microfilm_number),
    CA_Main_Fields.InValid_amount((SALT38.StrType)le.amount),
    CA_Main_Fields.InValid_irs_serial_number((SALT38.StrType)le.irs_serial_number),
    CA_Main_Fields.InValid_effective_date((SALT38.StrType)le.effective_date),
    CA_Main_Fields.InValid_signer_name((SALT38.StrType)le.signer_name),
    CA_Main_Fields.InValid_title((SALT38.StrType)le.title),
    CA_Main_Fields.InValid_filing_agency((SALT38.StrType)le.filing_agency),
    CA_Main_Fields.InValid_address((SALT38.StrType)le.address),
    CA_Main_Fields.InValid_city((SALT38.StrType)le.city),
    CA_Main_Fields.InValid_state((SALT38.StrType)le.state),
    CA_Main_Fields.InValid_county((SALT38.StrType)le.county),
    CA_Main_Fields.InValid_zip((SALT38.StrType)le.zip),
    CA_Main_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    CA_Main_Fields.InValid_cmnt_effective_date((SALT38.StrType)le.cmnt_effective_date),
    CA_Main_Fields.InValid_description((SALT38.StrType)le.description),
    CA_Main_Fields.InValid_collateral_desc((SALT38.StrType)le.collateral_desc),
    CA_Main_Fields.InValid_prim_machine((SALT38.StrType)le.prim_machine),
    CA_Main_Fields.InValid_sec_machine((SALT38.StrType)le.sec_machine),
    CA_Main_Fields.InValid_manufacturer_code((SALT38.StrType)le.manufacturer_code),
    CA_Main_Fields.InValid_manufacturer_name((SALT38.StrType)le.manufacturer_name),
    CA_Main_Fields.InValid_model((SALT38.StrType)le.model),
    CA_Main_Fields.InValid_model_year((SALT38.StrType)le.model_year),
    CA_Main_Fields.InValid_model_desc((SALT38.StrType)le.model_desc),
    CA_Main_Fields.InValid_collateral_count((SALT38.StrType)le.collateral_count),
    CA_Main_Fields.InValid_manufactured_year((SALT38.StrType)le.manufactured_year),
    CA_Main_Fields.InValid_new_used((SALT38.StrType)le.new_used),
    CA_Main_Fields.InValid_serial_number((SALT38.StrType)le.serial_number),
    CA_Main_Fields.InValid_property_desc((SALT38.StrType)le.property_desc),
    CA_Main_Fields.InValid_borough((SALT38.StrType)le.borough),
    CA_Main_Fields.InValid_block((SALT38.StrType)le.block),
    CA_Main_Fields.InValid_lot((SALT38.StrType)le.lot),
    CA_Main_Fields.InValid_collateral_address((SALT38.StrType)le.collateral_address),
    CA_Main_Fields.InValid_air_rights_indc((SALT38.StrType)le.air_rights_indc),
    CA_Main_Fields.InValid_subterranean_rights_indc((SALT38.StrType)le.subterranean_rights_indc),
    CA_Main_Fields.InValid_easment_indc((SALT38.StrType)le.easment_indc),
    CA_Main_Fields.InValid_volume((SALT38.StrType)le.volume),
    CA_Main_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := CA_Main_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_tmsid','invalid_rmsid','invalid_8pastdate','Unknown','Unknown','Unknown','invalid_filing_jurisdiction','invalid_orig_filing_number','invalid_orig_filing_type','invalid_orig_filing_date','invalid_orig_filing_time','invalid_mandatory','Unknown','invalid_filing_type','invalid_filing_date','invalid_filing_time','invalid_filing_status','invalid_status_type','invalid_numeric_blank','invalid_expiration_date','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_microfilm_number','invalid_empty','Unknown','invalid_empty','invalid_wordbag','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','Unknown','Unknown','Unknown','Unknown','invalid_empty','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','invalid_empty','Unknown','invalid_empty','invalid_empty','invalid_empty','invalid_empty','Unknown','invalid_mandatory');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,CA_Main_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_static_value(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_date_vendor_removed(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_date_vendor_changed(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_jurisdiction(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_orig_filing_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_orig_filing_type(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_orig_filing_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_orig_filing_time(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_number_indc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_type(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_time(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_status(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_status_type(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_page(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_expiration_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_contract_type(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_vendor_entry_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_vendor_upd_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_statements_filed(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_continuious_expiration(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_microfilm_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_amount(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_irs_serial_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_effective_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_signer_name(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_title(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_filing_agency(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_address(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_city(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_state(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_county(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_zip(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_cmnt_effective_date(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_description(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_collateral_desc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_prim_machine(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_sec_machine(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_manufacturer_code(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_manufacturer_name(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_model(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_model_year(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_model_desc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_collateral_count(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_manufactured_year(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_new_used(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_serial_number(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_property_desc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_borough(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_block(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_lot(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_collateral_address(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_air_rights_indc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_subterranean_rights_indc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_easment_indc(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_volume(TotalErrors.ErrorNum),CA_Main_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, CA_Main_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
