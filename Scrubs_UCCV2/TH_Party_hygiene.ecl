IMPORT SALT38,STD;
EXPORT TH_Party_hygiene(dataset(TH_Party_layout_UCCV2) h) := MODULE
...
SALT38.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT38.StrType)le.tmsid),TRIM((SALT38.StrType)le.rmsid),TRIM((SALT38.StrType)le.orig_name),TRIM((SALT38.StrType)le.orig_lname),TRIM((SALT38.StrType)le.orig_fname),TRIM((SALT38.StrType)le.orig_mname),TRIM((SALT38.StrType)le.orig_suffix),TRIM((SALT38.StrType)le.duns_number),TRIM((SALT38.StrType)le.hq_duns_number),TRIM((SALT38.StrType)le.ssn),TRIM((SALT38.StrType)le.fein),TRIM((SALT38.StrType)le.incorp_state),TRIM((SALT38.StrType)le.corp_number),TRIM((SALT38.StrType)le.corp_type),TRIM((SALT38.StrType)le.orig_address1),TRIM((SALT38.StrType)le.orig_address2),TRIM((SALT38.StrType)le.orig_city),TRIM((SALT38.StrType)le.orig_state),TRIM((SALT38.StrType)le.orig_zip5),TRIM((SALT38.StrType)le.orig_zip4),TRIM((SALT38.StrType)le.orig_country),TRIM((SALT38.StrType)le.orig_province),TRIM((SALT38.StrType)le.orig_postal_code),TRIM((SALT38.StrType)le.foreign_indc),TRIM((SALT38.StrType)le.party_type),IF (le.dt_first_seen <> 0,TRIM((SALT38.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT38.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT38.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT38.StrType)le.dt_vendor_first_reported), ''),TRIM((SALT38.StrType)le.process_date),TRIM((SALT38.StrType)le.title),TRIM((SALT38.StrType)le.fname),TRIM((SALT38.StrType)le.mname),TRIM((SALT38.StrType)le.lname),TRIM((SALT38.StrType)le.name_suffix),TRIM((SALT38.StrType)le.name_score),TRIM((SALT38.StrType)le.company_name),TRIM((SALT38.StrType)le.prim_range),TRIM((SALT38.StrType)le.predir),TRIM((SALT38.StrType)le.prim_name),TRIM((SALT38.StrType)le.suffix),TRIM((SALT38.StrType)le.postdir),TRIM((SALT38.StrType)le.unit_desig),TRIM((SALT38.StrType)le.sec_range),TRIM((SALT38.StrType)le.p_city_name),TRIM((SALT38.StrType)le.v_city_name),TRIM((SALT38.StrType)le.st),TRIM((SALT38.StrType)le.zip5),TRIM((SALT38.StrType)le.zip4),TRIM((SALT38.StrType)le.county),TRIM((SALT38.StrType)le.cart),TRIM((SALT38.StrType)le.cr_sort_sz),TRIM((SALT38.StrType)le.lot),TRIM((SALT38.StrType)le.lot_order),TRIM((SALT38.StrType)le.dpbc),TRIM((SALT38.StrType)le.chk_digit),TRIM((SALT38.StrType)le.rec_type),TRIM((SALT38.StrType)le.ace_fips_st),TRIM((SALT38.StrType)le.ace_fips_county),TRIM((SALT38.StrType)le.geo_lat),TRIM((SALT38.StrType)le.geo_long),TRIM((SALT38.StrType)le.msa),TRIM((SALT38.StrType)le.geo_blk),TRIM((SALT38.StrType)le.geo_match),TRIM((SALT38.StrType)le.err_stat),IF (le.bdid <> 0,TRIM((SALT38.StrType)le.bdid), ''),IF (le.did <> 0,TRIM((SALT38.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT38.StrType)le.did_score), ''),IF (le.bdid_score <> 0,TRIM((SALT38.StrType)le.bdid_score), '')));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'tmsid'}
      ...
      ,{67,'did'}
      ,{68,'did_score'}
      ,{69,'bdid_score'}],SALT38.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    TH_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid),
    TH_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid),
    TH_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name),
    TH_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname),
    TH_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname),
    TH_Party_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    TH_Party_Fields.InValid_orig_suffix((SALT38.StrType)le.orig_suffix),
    TH_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number),
    TH_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number),
    TH_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn),
    TH_Party_Fields.InValid_fein((SALT38.StrType)le.fein),
    TH_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state),
    TH_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number),
    TH_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type),
    TH_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1),
    TH_Party_Fields.InValid_orig_address2((SALT38.StrType)le.orig_address2),
    TH_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    TH_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state),
    TH_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5),
    TH_Party_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    TH_Party_Fields.InValid_orig_country((SALT38.StrType)le.orig_country),
    TH_Party_Fields.InValid_orig_province((SALT38.StrType)le.orig_province),
    TH_Party_Fields.InValid_orig_postal_code((SALT38.StrType)le.orig_postal_code),
    TH_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc),
    TH_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type),
    TH_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen),
    TH_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen),
    TH_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported),
    TH_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported),
    TH_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date),
    TH_Party_Fields.InValid_title((SALT38.StrType)le.title),
    TH_Party_Fields.InValid_fname((SALT38.StrType)le.fname),
    TH_Party_Fields.InValid_mname((SALT38.StrType)le.mname),
    TH_Party_Fields.InValid_lname((SALT38.StrType)le.lname),
    TH_Party_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    TH_Party_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    TH_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name),
    TH_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    TH_Party_Fields.InValid_predir((SALT38.StrType)le.predir),
    TH_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    TH_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    TH_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    TH_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    TH_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    TH_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    TH_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    TH_Party_Fields.InValid_st((SALT38.StrType)le.st),
    TH_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5),
    TH_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    TH_Party_Fields.InValid_county((SALT38.StrType)le.county),
    TH_Party_Fields.InValid_cart((SALT38.StrType)le.cart),
    TH_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    TH_Party_Fields.InValid_lot((SALT38.StrType)le.lot),
    TH_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    TH_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc),
    TH_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    TH_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    TH_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st),
    TH_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county),
    TH_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    TH_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    TH_Party_Fields.InValid_msa((SALT38.StrType)le.msa),
    TH_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    TH_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    TH_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    TH_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid),
    TH_Party_Fields.InValid_did((SALT38.StrType)le.did),
    TH_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score),
    TH_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := TH_Party_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,TH_Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_duns_number(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_hq_duns_number(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_fein(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_incorp_state(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_corp_number(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_corp_type(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_province(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_orig_postal_code(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_foreign_indc(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_party_type(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_zip5(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_ace_fips_st(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_ace_fips_county(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),TH_Party_Fields.InValidMessage_bdid_score(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_UCCV2, TH_Party_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
