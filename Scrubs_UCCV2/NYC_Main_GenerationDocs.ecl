...
Command line options: -MScrubs_UCCV2 -eC:\Users\wolfkg\AppData\Local\Temp\TFRC908.tmp 
...
FIELDTYPE:invalid_rmsid:CUSTOM(Scrubs_UCCV2.Functions.fn_non_empty_numeric>0)
FIELDTYPE:invalid_date_vendor_changed:CUSTOM(Scrubs_UCCV2.Functions.fn_optional_past_yyyymmdd>0)
//ENUM requires 2 values, otherwise assumes the single value is an attribute
FIELDTYPE:invalid_filing_jurisdiction:ENUM(NYC|NYC)
FIELDTYPE:invalid_orig_filing_number:CUSTOM(Scrubs_UCCV2.Functions.fn_nyc_filing_number>0)
FIELDTYPE:invalid_orig_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_nyc_orig_filing_type>0)
FIELDTYPE:invalid_orig_filing_date:CUSTOM(Scrubs_UCCV2.Functions.fn_date1_xor_date2>0,filing_date)
FIELDTYPE:invalid_filing_number:CUSTOM(Scrubs_UCCV2.Functions.fn_nyc_filing_number>0)
FIELDTYPE:invalid_filing_type:CUSTOM(Scrubs_UCCV2.Functions.fn_nyc_filing_type>0)
FIELDTYPE:invalid_filing_date:CUSTOM(Scrubs_UCCV2.Functions.fn_date1_xor_date2>0,orig_filing_date)
FIELDTYPE:invalid_borough:CUSTOM(Scrubs_UCCV2.Functions.fn_nyc_borough>0)
...
FIELD:date_vendor_changed:TYPE(STRING8):LIKE(invalid_date_vendor_changed):0,0
...
FIELD:amount:TYPE(STRING17):LIKE(invalid_numeric):0,0
FIELD:irs_serial_number:TYPE(STRING17):LIKE(invalid_numeric):0,0
...
FIELD:borough:TYPE(STRING9):LIKE(invalid_borough):0,0
FIELD:block:TYPE(STRING5):LIKE(invalid_numeric_blank):0,0
FIELD:lot:TYPE(STRING4:LIKE(invalid_numeric_blank)):0,0
FIELD:collateral_address:TYPE(STRING60):0,0
FIELD:air_rights_indc:TYPE(STRING1):LIKE(invalid_boolean_yn_blank):0,0
FIELD:subterranean_rights_indc:TYPE(STRING1):LIKE(invalid_boolean_yn_blank):0,0
FIELD:easment_indc:TYPE(STRING1):LIKE(invalid_boolean_yn_blank):0,0
