...
EXPORT MakeFT_invalid_tmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'TXH')>0);
...
EXPORT MakeFT_invalid_rmsid(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_rmsid(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_state_tmsid_rmsid(s,'TXH')>0);
...
EXPORT MakeFT_invalid_filing_jurisdiction(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_jurisdiction(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['TXH','TXH']);
EXPORT InValidMessageFT_invalid_filing_jurisdiction(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('TXH|TXH'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_orig_filing_type(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_filing_type(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_th_orig_filing_type(s)>0);
EXPORT InValidMessageFT_invalid_orig_filing_type(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_th_orig_filing_type'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_microfilm_number(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_microfilm_number(SALT38.StrType s) := WHICH(~Scrubs_UCCV2.Functions.fn_numeric(s,9)>0);
EXPORT InValidMessageFT_invalid_microfilm_number(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_UCCV2.Functions.fn_numeric'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_county(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_county(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['48201','48201']);
EXPORT InValidMessageFT_invalid_county(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('48201|48201'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['CUSTOM'],['CUSTOM','LENGTH'],[],[],[],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['LENGTH'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['CUSTOM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['ENUM'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],['LENGTH'],[]);
...
EXPORT Make_filing_type(SALT38.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_filing_type(SALT38.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_county(SALT38.StrType s0) := MakeFT_invalid_county(s0);
EXPORT InValid_county(SALT38.StrType s) := InValidFT_invalid_county(s);
...
EXPORT Make_description(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_description(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_description(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
 
EXPORT Make_collateral_desc(SALT38.StrType s0) := MakeFT_invalid_empty(s0);
EXPORT InValid_collateral_desc(SALT38.StrType s) := InValidFT_invalid_empty(s);
EXPORT InValidMessage_collateral_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_empty(wh);
