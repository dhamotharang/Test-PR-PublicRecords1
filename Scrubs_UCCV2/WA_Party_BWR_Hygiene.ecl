...
#workunit('name','Scrubs_UCCV2.WA_Party_BWR_Hygiene - Hygiene & Stats - SALT V3.8.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT38.MAC_Character_Counts.EclRecord(p,'WA_Party_Layout_UCCV2'),NAMED('OptimizedLayout'));// File layout suggested by data
