...
EXPORT FromNone(DATASET(IL_Party_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := IL_Party_Fields.InValid_tmsid((SALT38.StrType)le.tmsid);
    SELF.rmsid_Invalid := IL_Party_Fields.InValid_rmsid((SALT38.StrType)le.rmsid);
    SELF.orig_name_Invalid := IL_Party_Fields.InValid_orig_name((SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_fname);
    SELF.orig_lname_Invalid := IL_Party_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_fname);
    SELF.orig_fname_Invalid := IL_Party_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.orig_name,(SALT38.StrType)le.orig_lname);
    SELF.duns_number_Invalid := IL_Party_Fields.InValid_duns_number((SALT38.StrType)le.duns_number);
    SELF.hq_duns_number_Invalid := IL_Party_Fields.InValid_hq_duns_number((SALT38.StrType)le.hq_duns_number);
    SELF.ssn_Invalid := IL_Party_Fields.InValid_ssn((SALT38.StrType)le.ssn);
    SELF.fein_Invalid := IL_Party_Fields.InValid_fein((SALT38.StrType)le.fein);
    SELF.incorp_state_Invalid := IL_Party_Fields.InValid_incorp_state((SALT38.StrType)le.incorp_state);
    SELF.corp_number_Invalid := IL_Party_Fields.InValid_corp_number((SALT38.StrType)le.corp_number);
    SELF.corp_type_Invalid := IL_Party_Fields.InValid_corp_type((SALT38.StrType)le.corp_type);
    SELF.orig_address1_Invalid := IL_Party_Fields.InValid_orig_address1((SALT38.StrType)le.orig_address1);
    SELF.orig_city_Invalid := IL_Party_Fields.InValid_orig_city((SALT38.StrType)le.orig_city);
    SELF.orig_state_Invalid := IL_Party_Fields.InValid_orig_state((SALT38.StrType)le.orig_state);
    SELF.orig_zip5_Invalid := IL_Party_Fields.InValid_orig_zip5((SALT38.StrType)le.orig_zip5);
    SELF.foreign_indc_Invalid := IL_Party_Fields.InValid_foreign_indc((SALT38.StrType)le.foreign_indc);
    SELF.party_type_Invalid := IL_Party_Fields.InValid_party_type((SALT38.StrType)le.party_type);
    SELF.dt_first_seen_Invalid := IL_Party_Fields.InValid_dt_first_seen((SALT38.StrType)le.dt_first_seen);
    SELF.dt_last_seen_Invalid := IL_Party_Fields.InValid_dt_last_seen((SALT38.StrType)le.dt_last_seen);
    SELF.dt_vendor_last_reported_Invalid := IL_Party_Fields.InValid_dt_vendor_last_reported((SALT38.StrType)le.dt_vendor_last_reported);
    SELF.dt_vendor_first_reported_Invalid := IL_Party_Fields.InValid_dt_vendor_first_reported((SALT38.StrType)le.dt_vendor_first_reported);
    SELF.process_date_Invalid := IL_Party_Fields.InValid_process_date((SALT38.StrType)le.process_date);
    SELF.fname_Invalid := IL_Party_Fields.InValid_fname((SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name);
    SELF.mname_Invalid := IL_Party_Fields.InValid_mname((SALT38.StrType)le.mname,(SALT38.StrType)le.fname,(SALT38.StrType)le.lname,(SALT38.StrType)le.company_name);
    SELF.lname_Invalid := IL_Party_Fields.InValid_lname((SALT38.StrType)le.lname,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.company_name);
    SELF.company_name_Invalid := IL_Party_Fields.InValid_company_name((SALT38.StrType)le.company_name,(SALT38.StrType)le.fname,(SALT38.StrType)le.mname,(SALT38.StrType)le.lname);
    SELF.prim_range_Invalid := IL_Party_Fields.InValid_prim_range((SALT38.StrType)le.prim_range);
    SELF.predir_Invalid := IL_Party_Fields.InValid_predir((SALT38.StrType)le.predir);
    SELF.prim_name_Invalid := IL_Party_Fields.InValid_prim_name((SALT38.StrType)le.prim_name);
    SELF.suffix_Invalid := IL_Party_Fields.InValid_suffix((SALT38.StrType)le.suffix);
    SELF.postdir_Invalid := IL_Party_Fields.InValid_postdir((SALT38.StrType)le.postdir);
    SELF.unit_desig_Invalid := IL_Party_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig);
    SELF.sec_range_Invalid := IL_Party_Fields.InValid_sec_range((SALT38.StrType)le.sec_range);
    SELF.p_city_name_Invalid := IL_Party_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name);
    SELF.v_city_name_Invalid := IL_Party_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name);
    SELF.st_Invalid := IL_Party_Fields.InValid_st((SALT38.StrType)le.st);
    SELF.zip5_Invalid := IL_Party_Fields.InValid_zip5((SALT38.StrType)le.zip5);
    SELF.zip4_Invalid := IL_Party_Fields.InValid_zip4((SALT38.StrType)le.zip4);
    SELF.county_Invalid := IL_Party_Fields.InValid_county((SALT38.StrType)le.county);
    SELF.cart_Invalid := IL_Party_Fields.InValid_cart((SALT38.StrType)le.cart);
    SELF.cr_sort_sz_Invalid := IL_Party_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz);
    SELF.lot_Invalid := IL_Party_Fields.InValid_lot((SALT38.StrType)le.lot);
    SELF.lot_order_Invalid := IL_Party_Fields.InValid_lot_order((SALT38.StrType)le.lot_order);
    SELF.dpbc_Invalid := IL_Party_Fields.InValid_dpbc((SALT38.StrType)le.dpbc);
    SELF.chk_digit_Invalid := IL_Party_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit);
    SELF.rec_type_Invalid := IL_Party_Fields.InValid_rec_type((SALT38.StrType)le.rec_type);
    SELF.ace_fips_st_Invalid := IL_Party_Fields.InValid_ace_fips_st((SALT38.StrType)le.ace_fips_st);
    SELF.ace_fips_county_Invalid := IL_Party_Fields.InValid_ace_fips_county((SALT38.StrType)le.ace_fips_county);
    SELF.geo_lat_Invalid := IL_Party_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat);
    SELF.geo_long_Invalid := IL_Party_Fields.InValid_geo_long((SALT38.StrType)le.geo_long);
    SELF.msa_Invalid := IL_Party_Fields.InValid_msa((SALT38.StrType)le.msa);
    SELF.geo_blk_Invalid := IL_Party_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk);
    SELF.geo_match_Invalid := IL_Party_Fields.InValid_geo_match((SALT38.StrType)le.geo_match);
    SELF.err_stat_Invalid := IL_Party_Fields.InValid_err_stat((SALT38.StrType)le.err_stat);
    SELF.bdid_Invalid := IL_Party_Fields.InValid_bdid((SALT38.StrType)le.bdid);
    SELF.did_Invalid := IL_Party_Fields.InValid_did((SALT38.StrType)le.did);
    SELF.did_score_Invalid := IL_Party_Fields.InValid_did_score((SALT38.StrType)le.did_score);
    SELF.bdid_score_Invalid := IL_Party_Fields.InValid_bdid_score((SALT38.StrType)le.bdid_score);
    SELF.source_rec_id_Invalid := IL_Party_Fields.InValid_source_rec_id((SALT38.StrType)le.source_rec_id);
    SELF.dotid_Invalid := IL_Party_Fields.InValid_dotid((SALT38.StrType)le.dotid);
    SELF.dotscore_Invalid := IL_Party_Fields.InValid_dotscore((SALT38.StrType)le.dotscore);
    SELF.dotweight_Invalid := IL_Party_Fields.InValid_dotweight((SALT38.StrType)le.dotweight);
    SELF.empid_Invalid := IL_Party_Fields.InValid_empid((SALT38.StrType)le.empid);
    SELF.empscore_Invalid := IL_Party_Fields.InValid_empscore((SALT38.StrType)le.empscore);
    SELF.empweight_Invalid := IL_Party_Fields.InValid_empweight((SALT38.StrType)le.empweight);
    SELF.powid_Invalid := IL_Party_Fields.InValid_powid((SALT38.StrType)le.powid);
    SELF.powscore_Invalid := IL_Party_Fields.InValid_powscore((SALT38.StrType)le.powscore);
    SELF.powweight_Invalid := IL_Party_Fields.InValid_powweight((SALT38.StrType)le.powweight);
    SELF.proxid_Invalid := IL_Party_Fields.InValid_proxid((SALT38.StrType)le.proxid);
    SELF.proxscore_Invalid := IL_Party_Fields.InValid_proxscore((SALT38.StrType)le.proxscore);
    SELF.proxweight_Invalid := IL_Party_Fields.InValid_proxweight((SALT38.StrType)le.proxweight);
    SELF.seleid_Invalid := IL_Party_Fields.InValid_seleid((SALT38.StrType)le.seleid);
    SELF.selescore_Invalid := IL_Party_Fields.InValid_selescore((SALT38.StrType)le.selescore);
    SELF.seleweight_Invalid := IL_Party_Fields.InValid_seleweight((SALT38.StrType)le.seleweight);
    SELF.orgid_Invalid := IL_Party_Fields.InValid_orgid((SALT38.StrType)le.orgid);
    SELF.orgscore_Invalid := IL_Party_Fields.InValid_orgscore((SALT38.StrType)le.orgscore);
    SELF.orgweight_Invalid := IL_Party_Fields.InValid_orgweight((SALT38.StrType)le.orgweight);
    SELF.ultid_Invalid := IL_Party_Fields.InValid_ultid((SALT38.StrType)le.ultid);
    SELF.ultscore_Invalid := IL_Party_Fields.InValid_ultscore((SALT38.StrType)le.ultscore);
    SELF.ultweight_Invalid := IL_Party_Fields.InValid_ultweight((SALT38.StrType)le.ultweight);
    SELF.prep_addr_line1_Invalid := IL_Party_Fields.InValid_prep_addr_line1((SALT38.StrType)le.prep_addr_line1);
    SELF.prep_addr_last_line_Invalid := IL_Party_Fields.InValid_prep_addr_last_line((SALT38.StrType)le.prep_addr_last_line);
    SELF.rawaid_Invalid := IL_Party_Fields.InValid_rawaid((SALT38.StrType)le.rawaid);
    SELF.aceaid_Invalid := IL_Party_Fields.InValid_aceaid((SALT38.StrType)le.aceaid);
    SELF.persistent_record_id_Invalid := IL_Party_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,IL_Party_Fields.InvalidMessage_persistent_record_id(1)
          ,'Fields with errors'
    ...
    mod_hygiene := IL_Party_hygiene(PROJECT(h, IL_Party_Layout_UCCV2));
  ...
  // record count stats
    ...
    mod_Delta := IL_Party_Delta(prevDS, PROJECT(h, IL_Party_Layout_UCCV2));
...
EXPORT StandardStats(DATASET(IL_Party_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, IL_Party_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
