...
EXPORT NYC_Party_In_UCCV2 := DATASET(Data_Services.foreign_prod + 'thor_data400::base::UCC::Party::nyc', 
                                     Scrubs_UCCV2.NYC_Party_Layout_UCCV2, THOR);
...
// SHARED NYC_Party_In_UCCV2_old := DATASET(Data_Services.foreign_prod + 'thor_data400::base::UCC::Party::nyc_father', 
                                         // old_layout, THOR);

// SHARED NYC_Party_In_UCCV2_new := DATASET(Data_Services.foreign_prod + 'thor_data400::base::UCC::Party::nyc', 
                                         // Scrubs_UCCV2.NYC_Party_Layout_UCCV2, THOR);

// EXPORT NYC_Party_In_UCCV2 := PROJECT(NYC_Party_In_UCCV2_old, TRANSFORM(Scrubs_UCCV2.NYC_Party_Layout_UCCV2, SELF := LEFT, SELF := [])) + NYC_Party_In_UCCV2_new;
