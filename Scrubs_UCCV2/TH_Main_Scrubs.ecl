...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(TH_Main_Layout_UCCV2)
    ...
    UNSIGNED1 collateral_desc_Invalid;
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(TH_Main_Layout_UCCV2)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(TH_Main_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := TH_Main_Fields.InValid_tmsid((SALT38.StrType)le.tmsid);
    SELF.rmsid_Invalid := TH_Main_Fields.InValid_rmsid((SALT38.StrType)le.rmsid);
    SELF.process_date_Invalid := TH_Main_Fields.InValid_process_date((SALT38.StrType)le.process_date);
    SELF.filing_jurisdiction_Invalid := TH_Main_Fields.InValid_filing_jurisdiction((SALT38.StrType)le.filing_jurisdiction);
    SELF.orig_filing_number_Invalid := TH_Main_Fields.InValid_orig_filing_number((SALT38.StrType)le.orig_filing_number);
    SELF.orig_filing_type_Invalid := TH_Main_Fields.InValid_orig_filing_type((SALT38.StrType)le.orig_filing_type);
    SELF.orig_filing_date_Invalid := TH_Main_Fields.InValid_orig_filing_date((SALT38.StrType)le.orig_filing_date,(SALT38.StrType)le.filing_date);
    SELF.orig_filing_time_Invalid := TH_Main_Fields.InValid_orig_filing_time((SALT38.StrType)le.orig_filing_time);
    SELF.filing_number_Invalid := TH_Main_Fields.InValid_filing_number((SALT38.StrType)le.filing_number);
    SELF.filing_type_Invalid := TH_Main_Fields.InValid_filing_type((SALT38.StrType)le.filing_type);
    SELF.filing_date_Invalid := TH_Main_Fields.InValid_filing_date((SALT38.StrType)le.filing_date,(SALT38.StrType)le.orig_filing_date);
    SELF.filing_time_Invalid := TH_Main_Fields.InValid_filing_time((SALT38.StrType)le.filing_time);
    SELF.filing_status_Invalid := TH_Main_Fields.InValid_filing_status((SALT38.StrType)le.filing_status);
    SELF.status_type_Invalid := TH_Main_Fields.InValid_status_type((SALT38.StrType)le.status_type);
    SELF.page_Invalid := TH_Main_Fields.InValid_page((SALT38.StrType)le.page);
    SELF.expiration_date_Invalid := TH_Main_Fields.InValid_expiration_date((SALT38.StrType)le.expiration_date);
    SELF.contract_type_Invalid := TH_Main_Fields.InValid_contract_type((SALT38.StrType)le.contract_type);
    SELF.vendor_entry_date_Invalid := TH_Main_Fields.InValid_vendor_entry_date((SALT38.StrType)le.vendor_entry_date);
    SELF.vendor_upd_date_Invalid := TH_Main_Fields.InValid_vendor_upd_date((SALT38.StrType)le.vendor_upd_date);
    SELF.statements_filed_Invalid := TH_Main_Fields.InValid_statements_filed((SALT38.StrType)le.statements_filed);
    SELF.continuious_expiration_Invalid := TH_Main_Fields.InValid_continuious_expiration((SALT38.StrType)le.continuious_expiration);
    SELF.microfilm_number_Invalid := TH_Main_Fields.InValid_microfilm_number((SALT38.StrType)le.microfilm_number);
    SELF.amount_Invalid := TH_Main_Fields.InValid_amount((SALT38.StrType)le.amount);
    SELF.irs_serial_number_Invalid := TH_Main_Fields.InValid_irs_serial_number((SALT38.StrType)le.irs_serial_number);
    SELF.effective_date_Invalid := TH_Main_Fields.InValid_effective_date((SALT38.StrType)le.effective_date);
    SELF.signer_name_Invalid := TH_Main_Fields.InValid_signer_name((SALT38.StrType)le.signer_name);
    SELF.title_Invalid := TH_Main_Fields.InValid_title((SALT38.StrType)le.title);
    SELF.filing_agency_Invalid := TH_Main_Fields.InValid_filing_agency((SALT38.StrType)le.filing_agency);
    SELF.address_Invalid := TH_Main_Fields.InValid_address((SALT38.StrType)le.address);
    SELF.city_Invalid := TH_Main_Fields.InValid_city((SALT38.StrType)le.city);
    SELF.state_Invalid := TH_Main_Fields.InValid_state((SALT38.StrType)le.state);
    SELF.county_Invalid := TH_Main_Fields.InValid_county((SALT38.StrType)le.county);
    SELF.zip_Invalid := TH_Main_Fields.InValid_zip((SALT38.StrType)le.zip);
    SELF.duns_number_Invalid := TH_Main_Fields.InValid_duns_number((SALT38.StrType)le.duns_number);
    SELF.cmnt_effective_date_Invalid := TH_Main_Fields.InValid_cmnt_effective_date((SALT38.StrType)le.cmnt_effective_date);
    SELF.description_Invalid := TH_Main_Fields.InValid_description((SALT38.StrType)le.description);
    SELF.collateral_desc_Invalid := TH_Main_Fields.InValid_collateral_desc((SALT38.StrType)le.collateral_desc);
    SELF.prim_machine_Invalid := TH_Main_Fields.InValid_prim_machine((SALT38.StrType)le.prim_machine);
    SELF.sec_machine_Invalid := TH_Main_Fields.InValid_sec_machine((SALT38.StrType)le.sec_machine);
    SELF.manufacturer_code_Invalid := TH_Main_Fields.InValid_manufacturer_code((SALT38.StrType)le.manufacturer_code);
    SELF.manufacturer_name_Invalid := TH_Main_Fields.InValid_manufacturer_name((SALT38.StrType)le.manufacturer_name);
    SELF.model_Invalid := TH_Main_Fields.InValid_model((SALT38.StrType)le.model);
    SELF.model_year_Invalid := TH_Main_Fields.InValid_model_year((SALT38.StrType)le.model_year);
    SELF.model_desc_Invalid := TH_Main_Fields.InValid_model_desc((SALT38.StrType)le.model_desc);
    SELF.collateral_count_Invalid := TH_Main_Fields.InValid_collateral_count((SALT38.StrType)le.collateral_count);
    SELF.manufactured_year_Invalid := TH_Main_Fields.InValid_manufactured_year((SALT38.StrType)le.manufactured_year);
    SELF.new_used_Invalid := TH_Main_Fields.InValid_new_used((SALT38.StrType)le.new_used);
    SELF.serial_number_Invalid := TH_Main_Fields.InValid_serial_number((SALT38.StrType)le.serial_number);
    SELF.property_desc_Invalid := TH_Main_Fields.InValid_property_desc((SALT38.StrType)le.property_desc);
    SELF.borough_Invalid := TH_Main_Fields.InValid_borough((SALT38.StrType)le.borough);
    SELF.block_Invalid := TH_Main_Fields.InValid_block((SALT38.StrType)le.block);
    SELF.collateral_address_Invalid := TH_Main_Fields.InValid_collateral_address((SALT38.StrType)le.collateral_address);
    SELF.air_rights_indc_Invalid := TH_Main_Fields.InValid_air_rights_indc((SALT38.StrType)le.air_rights_indc);
    SELF.subterranean_rights_indc_Invalid := TH_Main_Fields.InValid_subterranean_rights_indc((SALT38.StrType)le.subterranean_rights_indc);
    SELF.easment_indc_Invalid := TH_Main_Fields.InValid_easment_indc((SALT38.StrType)le.easment_indc);
    SELF.volume_Invalid := TH_Main_Fields.InValid_volume((SALT38.StrType)le.volume);
    SELF.persistent_record_id_Invalid := TH_Main_Fields.InValid_persistent_record_id((SALT38.StrType)le.persistent_record_id);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),TH_Main_Layout_UCCV2);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.tmsid_Invalid << 0 ) + ( le.rmsid_Invalid << 1 ) + ( le.process_date_Invalid << 2 ) + ( le.filing_jurisdiction_Invalid << 4 ) + ( le.orig_filing_number_Invalid << 5 ) + ( le.orig_filing_type_Invalid << 6 ) + ( le.orig_filing_date_Invalid << 7 ) + ( le.orig_filing_time_Invalid << 8 ) + ( le.filing_number_Invalid << 9 ) + ( le.filing_type_Invalid << 10 ) + ( le.filing_date_Invalid << 11 ) + ( le.filing_time_Invalid << 12 ) + ( le.filing_status_Invalid << 13 ) + ( le.status_type_Invalid << 14 ) + ( le.page_Invalid << 15 ) + ( le.expiration_date_Invalid << 16 ) + ( le.contract_type_Invalid << 17 ) + ( le.vendor_entry_date_Invalid << 18 ) + ( le.vendor_upd_date_Invalid << 19 ) + ( le.statements_filed_Invalid << 20 ) + ( le.continuious_expiration_Invalid << 21 ) + ( le.microfilm_number_Invalid << 22 ) + ( le.amount_Invalid << 23 ) + ( le.irs_serial_number_Invalid << 24 ) + ( le.effective_date_Invalid << 25 ) + ( le.signer_name_Invalid << 26 ) + ( le.title_Invalid << 27 ) + ( le.filing_agency_Invalid << 28 ) + ( le.address_Invalid << 29 ) + ( le.city_Invalid << 30 ) + ( le.state_Invalid << 31 ) + ( le.county_Invalid << 32 ) + ( le.zip_Invalid << 33 ) + ( le.duns_number_Invalid << 34 ) + ( le.cmnt_effective_date_Invalid << 35 ) + ( le.description_Invalid << 36 ) + ( le.collateral_desc_Invalid << 37 ) + ( le.prim_machine_Invalid << 38 ) + ( le.sec_machine_Invalid << 39 ) + ( le.manufacturer_code_Invalid << 40 ) + ( le.manufacturer_name_Invalid << 41 ) + ( le.model_Invalid << 42 ) + ( le.model_year_Invalid << 43 ) + ( le.model_desc_Invalid << 44 ) + ( le.collateral_count_Invalid << 45 ) + ( le.manufactured_year_Invalid << 46 ) + ( le.new_used_Invalid << 47 ) + ( le.serial_number_Invalid << 48 ) + ( le.property_desc_Invalid << 49 ) + ( le.borough_Invalid << 50 ) + ( le.block_Invalid << 51 ) + ( le.collateral_address_Invalid << 52 ) + ( le.air_rights_indc_Invalid << 53 ) + ( le.subterranean_rights_indc_Invalid << 54 ) + ( le.easment_indc_Invalid << 55 ) + ( le.volume_Invalid << 56 ) + ( le.persistent_record_id_Invalid << 57 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,TH_Main_Layout_UCCV2);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.collateral_desc_Invalid := (le.ScrubsBits1 >> 37) & 1;
    ...
    SELF.property_desc_Invalid := (le.ScrubsBits1 >> 49) & 1;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    microfilm_number_CUSTOM_ErrorCount := COUNT(GROUP,h.microfilm_number_Invalid=1);
    ...
    county_ENUM_ErrorCount := COUNT(GROUP,h.county_Invalid=1);
    ...
    collateral_desc_LENGTH_ErrorCount := COUNT(GROUP,h.collateral_desc_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.tmsid_Invalid,le.rmsid_Invalid,le.process_date_Invalid,le.filing_jurisdiction_Invalid,le.orig_filing_number_Invalid,le.orig_filing_type_Invalid,le.orig_filing_date_Invalid,le.orig_filing_time_Invalid,le.filing_number_Invalid,le.filing_type_Invalid,le.filing_date_Invalid,le.filing_time_Invalid,le.filing_status_Invalid,le.status_type_Invalid,le.page_Invalid,le.expiration_date_Invalid,le.contract_type_Invalid,le.vendor_entry_date_Invalid,le.vendor_upd_date_Invalid,le.statements_filed_Invalid,le.continuious_expiration_Invalid,le.microfilm_number_Invalid,le.amount_Invalid,le.irs_serial_number_Invalid,le.effective_date_Invalid,le.signer_name_Invalid,le.title_Invalid,le.filing_agency_Invalid,le.address_Invalid,le.city_Invalid,le.state_Invalid,le.county_Invalid,le.zip_Invalid,le.duns_number_Invalid,le.cmnt_effective_date_Invalid,le.description_Invalid,le.collateral_desc_Invalid,le.prim_machine_Invalid,le.sec_machine_Invalid,le.manufacturer_code_Invalid,le.manufacturer_name_Invalid,le.model_Invalid,le.model_year_Invalid,le.model_desc_Invalid,le.collateral_count_Invalid,le.manufactured_year_Invalid,le.new_used_Invalid,le.serial_number_Invalid,le.property_desc_Invalid,le.borough_Invalid,le.block_Invalid,le.collateral_address_Invalid,le.air_rights_indc_Invalid,le.subterranean_rights_indc_Invalid,le.easment_indc_Invalid,le.volume_Invalid,le.persistent_record_id_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,TH_Main_Fields.InvalidMessage_tmsid(le.tmsid_Invalid),TH_Main_Fields.InvalidMessage_rmsid(le.rmsid_Invalid),TH_Main_Fields.InvalidMessage_process_date(le.process_date_Invalid),TH_Main_Fields.InvalidMessage_filing_jurisdiction(le.filing_jurisdiction_Invalid),TH_Main_Fields.InvalidMessage_orig_filing_number(le.orig_filing_number_Invalid),TH_Main_Fields.InvalidMessage_orig_filing_type(le.orig_filing_type_Invalid),TH_Main_Fields.InvalidMessage_orig_filing_date(le.orig_filing_date_Invalid),TH_Main_Fields.InvalidMessage_orig_filing_time(le.orig_filing_time_Invalid),TH_Main_Fields.InvalidMessage_filing_number(le.filing_number_Invalid),TH_Main_Fields.InvalidMessage_filing_type(le.filing_type_Invalid),TH_Main_Fields.InvalidMessage_filing_date(le.filing_date_Invalid),TH_Main_Fields.InvalidMessage_filing_time(le.filing_time_Invalid),TH_Main_Fields.InvalidMessage_filing_status(le.filing_status_Invalid),TH_Main_Fields.InvalidMessage_status_type(le.status_type_Invalid),TH_Main_Fields.InvalidMessage_page(le.page_Invalid),TH_Main_Fields.InvalidMessage_expiration_date(le.expiration_date_Invalid),TH_Main_Fields.InvalidMessage_contract_type(le.contract_type_Invalid),TH_Main_Fields.InvalidMessage_vendor_entry_date(le.vendor_entry_date_Invalid),TH_Main_Fields.InvalidMessage_vendor_upd_date(le.vendor_upd_date_Invalid),TH_Main_Fields.InvalidMessage_statements_filed(le.statements_filed_Invalid),TH_Main_Fields.InvalidMessage_continuious_expiration(le.continuious_expiration_Invalid),TH_Main_Fields.InvalidMessage_microfilm_number(le.microfilm_number_Invalid),TH_Main_Fields.InvalidMessage_amount(le.amount_Invalid),TH_Main_Fields.InvalidMessage_irs_serial_number(le.irs_serial_number_Invalid),TH_Main_Fields.InvalidMessage_effective_date(le.effective_date_Invalid),TH_Main_Fields.InvalidMessage_signer_name(le.signer_name_Invalid),TH_Main_Fields.InvalidMessage_title(le.title_Invalid),TH_Main_Fields.InvalidMessage_filing_agency(le.filing_agency_Invalid),TH_Main_Fields.InvalidMessage_address(le.address_Invalid),TH_Main_Fields.InvalidMessage_city(le.city_Invalid),TH_Main_Fields.InvalidMessage_state(le.state_Invalid),TH_Main_Fields.InvalidMessage_county(le.county_Invalid),TH_Main_Fields.InvalidMessage_zip(le.zip_Invalid),TH_Main_Fields.InvalidMessage_duns_number(le.duns_number_Invalid),TH_Main_Fields.InvalidMessage_cmnt_effective_date(le.cmnt_effective_date_Invalid),TH_Main_Fields.InvalidMessage_description(le.description_Invalid),TH_Main_Fields.InvalidMessage_collateral_desc(le.collateral_desc_Invalid),TH_Main_Fields.InvalidMessage_prim_machine(le.prim_machine_Invalid),TH_Main_Fields.InvalidMessage_sec_machine(le.sec_machine_Invalid),TH_Main_Fields.InvalidMessage_manufacturer_code(le.manufacturer_code_Invalid),TH_Main_Fields.InvalidMessage_manufacturer_name(le.manufacturer_name_Invalid),TH_Main_Fields.InvalidMessage_model(le.model_Invalid),TH_Main_Fields.InvalidMessage_model_year(le.model_year_Invalid),TH_Main_Fields.InvalidMessage_model_desc(le.model_desc_Invalid),TH_Main_Fields.InvalidMessage_collateral_count(le.collateral_count_Invalid),TH_Main_Fields.InvalidMessage_manufactured_year(le.manufactured_year_Invalid),TH_Main_Fields.InvalidMessage_new_used(le.new_used_Invalid),TH_Main_Fields.InvalidMessage_serial_number(le.serial_number_Invalid),TH_Main_Fields.InvalidMessage_property_desc(le.property_desc_Invalid),TH_Main_Fields.InvalidMessage_borough(le.borough_Invalid),TH_Main_Fields.InvalidMessage_block(le.block_Invalid),TH_Main_Fields.InvalidMessage_collateral_address(le.collateral_address_Invalid),TH_Main_Fields.InvalidMessage_air_rights_indc(le.air_rights_indc_Invalid),TH_Main_Fields.InvalidMessage_subterranean_rights_indc(le.subterranean_rights_indc_Invalid),TH_Main_Fields.InvalidMessage_easment_indc(le.easment_indc_Invalid),TH_Main_Fields.InvalidMessage_volume(le.volume_Invalid),TH_Main_Fields.InvalidMessage_persistent_record_id(le.persistent_record_id_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.microfilm_number_Invalid,'CUSTOM','UNKNOWN')
          ...
          ,CHOOSE(le.county_Invalid,'ENUM','UNKNOWN')
          ...
          ,CHOOSE(le.collateral_desc_Invalid,'LENGTH','UNKNOWN')
  ...
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'microfilm_number:invalid_microfilm_number:CUSTOM'
          ...
          ,'collateral_desc:invalid_empty:LENGTH'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,TH_Main_Fields.InvalidMessage_tmsid(1)
          ,TH_Main_Fields.InvalidMessage_rmsid(1)
          ,TH_Main_Fields.InvalidMessage_process_date(1),TH_Main_Fields.InvalidMessage_process_date(2)
          ,TH_Main_Fields.InvalidMessage_filing_jurisdiction(1)
          ,TH_Main_Fields.InvalidMessage_orig_filing_number(1)
          ,TH_Main_Fields.InvalidMessage_orig_filing_type(1)
          ,TH_Main_Fields.InvalidMessage_orig_filing_date(1)
          ,TH_Main_Fields.InvalidMessage_orig_filing_time(1)
          ,TH_Main_Fields.InvalidMessage_filing_number(1)
          ,TH_Main_Fields.InvalidMessage_filing_type(1)
          ,TH_Main_Fields.InvalidMessage_filing_date(1)
          ,TH_Main_Fields.InvalidMessage_filing_time(1)
          ,TH_Main_Fields.InvalidMessage_filing_status(1)
          ,TH_Main_Fields.InvalidMessage_status_type(1)
          ,TH_Main_Fields.InvalidMessage_page(1)
          ,TH_Main_Fields.InvalidMessage_expiration_date(1)
          ,TH_Main_Fields.InvalidMessage_contract_type(1)
          ,TH_Main_Fields.InvalidMessage_vendor_entry_date(1)
          ,TH_Main_Fields.InvalidMessage_vendor_upd_date(1)
          ,TH_Main_Fields.InvalidMessage_statements_filed(1)
          ,TH_Main_Fields.InvalidMessage_continuious_expiration(1)
          ,TH_Main_Fields.InvalidMessage_microfilm_number(1)
          ,TH_Main_Fields.InvalidMessage_amount(1)
          ,TH_Main_Fields.InvalidMessage_irs_serial_number(1)
          ,TH_Main_Fields.InvalidMessage_effective_date(1)
          ,TH_Main_Fields.InvalidMessage_signer_name(1)
          ,TH_Main_Fields.InvalidMessage_title(1)
          ,TH_Main_Fields.InvalidMessage_filing_agency(1)
          ,TH_Main_Fields.InvalidMessage_address(1)
          ,TH_Main_Fields.InvalidMessage_city(1)
          ,TH_Main_Fields.InvalidMessage_state(1)
          ,TH_Main_Fields.InvalidMessage_county(1)
          ,TH_Main_Fields.InvalidMessage_zip(1)
          ,TH_Main_Fields.InvalidMessage_duns_number(1)
          ,TH_Main_Fields.InvalidMessage_cmnt_effective_date(1)
          ,TH_Main_Fields.InvalidMessage_description(1)
          ,TH_Main_Fields.InvalidMessage_collateral_desc(1)
          ,TH_Main_Fields.InvalidMessage_prim_machine(1)
          ,TH_Main_Fields.InvalidMessage_sec_machine(1)
          ,TH_Main_Fields.InvalidMessage_manufacturer_code(1)
          ,TH_Main_Fields.InvalidMessage_manufacturer_name(1)
          ,TH_Main_Fields.InvalidMessage_model(1)
          ,TH_Main_Fields.InvalidMessage_model_year(1)
          ,TH_Main_Fields.InvalidMessage_model_desc(1)
          ,TH_Main_Fields.InvalidMessage_collateral_count(1)
          ,TH_Main_Fields.InvalidMessage_manufactured_year(1)
          ,TH_Main_Fields.InvalidMessage_new_used(1)
          ,TH_Main_Fields.InvalidMessage_serial_number(1)
          ,TH_Main_Fields.InvalidMessage_property_desc(1)
          ,TH_Main_Fields.InvalidMessage_borough(1)
          ,TH_Main_Fields.InvalidMessage_block(1)
          ,TH_Main_Fields.InvalidMessage_collateral_address(1)
          ,TH_Main_Fields.InvalidMessage_air_rights_indc(1)
          ,TH_Main_Fields.InvalidMessage_subterranean_rights_indc(1)
          ,TH_Main_Fields.InvalidMessage_easment_indc(1)
          ,TH_Main_Fields.InvalidMessage_volume(1)
          ,TH_Main_Fields.InvalidMessage_persistent_record_id(1)
          ,'Fields with errors'
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.microfilm_number_CUSTOM_ErrorCount
          ...
          ,le.collateral_desc_LENGTH_ErrorCount
    ...
    mod_hygiene := TH_Main_hygiene(PROJECT(h, TH_Main_Layout_UCCV2));
  ...
  // record count stats
    ...
    mod_Delta := TH_Main_Delta(prevDS, PROJECT(h, TH_Main_Layout_UCCV2));
...
EXPORT StandardStats(DATASET(TH_Main_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, TH_Main_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
