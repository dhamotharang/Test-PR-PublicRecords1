...
EXPORT FromNone(DATASET(DNB_Party_Layout_UCCV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.tmsid_Invalid := DNB_Party_Fields.InValid_tmsid((SALT39.StrType)le.tmsid);
    SELF.rmsid_Invalid := DNB_Party_Fields.InValid_rmsid((SALT39.StrType)le.rmsid);
    SELF.orig_name_Invalid := DNB_Party_Fields.InValid_orig_name((SALT39.StrType)le.orig_name);
    SELF.orig_lname_Invalid := DNB_Party_Fields.InValid_orig_lname((SALT39.StrType)le.orig_lname);
    SELF.orig_fname_Invalid := DNB_Party_Fields.InValid_orig_fname((SALT39.StrType)le.orig_fname);
    SELF.orig_mname_Invalid := DNB_Party_Fields.InValid_orig_mname((SALT39.StrType)le.orig_mname);
    SELF.orig_suffix_Invalid := DNB_Party_Fields.InValid_orig_suffix((SALT39.StrType)le.orig_suffix);
    SELF.duns_number_Invalid := DNB_Party_Fields.InValid_duns_number((SALT39.StrType)le.duns_number);
    SELF.hq_duns_number_Invalid := DNB_Party_Fields.InValid_hq_duns_number((SALT39.StrType)le.hq_duns_number);
    SELF.ssn_Invalid := DNB_Party_Fields.InValid_ssn((SALT39.StrType)le.ssn);
    SELF.fein_Invalid := DNB_Party_Fields.InValid_fein((SALT39.StrType)le.fein);
    SELF.incorp_state_Invalid := DNB_Party_Fields.InValid_incorp_state((SALT39.StrType)le.incorp_state);
    SELF.corp_number_Invalid := DNB_Party_Fields.InValid_corp_number((SALT39.StrType)le.corp_number);
    SELF.corp_type_Invalid := DNB_Party_Fields.InValid_corp_type((SALT39.StrType)le.corp_type);
    SELF.orig_address1_Invalid := DNB_Party_Fields.InValid_orig_address1((SALT39.StrType)le.orig_address1,(SALT39.StrType)le.orig_city,(SALT39.StrType)le.orig_state);
    SELF.orig_address2_Invalid := DNB_Party_Fields.InValid_orig_address2((SALT39.StrType)le.orig_address2);
    SELF.orig_city_Invalid := DNB_Party_Fields.InValid_orig_city((SALT39.StrType)le.orig_city);
    SELF.orig_state_Invalid := DNB_Party_Fields.InValid_orig_state((SALT39.StrType)le.orig_state);
    SELF.orig_zip5_Invalid := DNB_Party_Fields.InValid_orig_zip5((SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_country);
    SELF.orig_zip4_Invalid := DNB_Party_Fields.InValid_orig_zip4((SALT39.StrType)le.orig_zip4);
    SELF.orig_country_Invalid := DNB_Party_Fields.InValid_orig_country((SALT39.StrType)le.orig_country);
    SELF.orig_province_Invalid := DNB_Party_Fields.InValid_orig_province((SALT39.StrType)le.orig_province);
    SELF.foreign_indc_Invalid := DNB_Party_Fields.InValid_foreign_indc((SALT39.StrType)le.foreign_indc);
    SELF.party_type_Invalid := DNB_Party_Fields.InValid_party_type((SALT39.StrType)le.party_type);
    SELF.dt_first_seen_Invalid := DNB_Party_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen);
    SELF.dt_last_seen_Invalid := DNB_Party_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen);
    SELF.dt_vendor_last_reported_Invalid := DNB_Party_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported);
    SELF.dt_vendor_first_reported_Invalid := DNB_Party_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported);
    SELF.process_date_Invalid := DNB_Party_Fields.InValid_process_date((SALT39.StrType)le.process_date);
    SELF.title_Invalid := DNB_Party_Fields.InValid_title((SALT39.StrType)le.title);
    SELF.fname_Invalid := DNB_Party_Fields.InValid_fname((SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name);
    SELF.mname_Invalid := DNB_Party_Fields.InValid_mname((SALT39.StrType)le.mname,(SALT39.StrType)le.fname,(SALT39.StrType)le.lname,(SALT39.StrType)le.company_name);
    SELF.lname_Invalid := DNB_Party_Fields.InValid_lname((SALT39.StrType)le.lname,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.company_name);
    SELF.name_suffix_Invalid := DNB_Party_Fields.InValid_name_suffix((SALT39.StrType)le.name_suffix);
    SELF.name_score_Invalid := DNB_Party_Fields.InValid_name_score((SALT39.StrType)le.name_score);
    SELF.company_name_Invalid := DNB_Party_Fields.InValid_company_name((SALT39.StrType)le.company_name,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname);
    SELF.prim_range_Invalid := DNB_Party_Fields.InValid_prim_range((SALT39.StrType)le.prim_range);
    SELF.predir_Invalid := DNB_Party_Fields.InValid_predir((SALT39.StrType)le.predir);
    SELF.prim_name_Invalid := DNB_Party_Fields.InValid_prim_name((SALT39.StrType)le.prim_name);
    SELF.suffix_Invalid := DNB_Party_Fields.InValid_suffix((SALT39.StrType)le.suffix);
    SELF.postdir_Invalid := DNB_Party_Fields.InValid_postdir((SALT39.StrType)le.postdir);
    SELF.unit_desig_Invalid := DNB_Party_Fields.InValid_unit_desig((SALT39.StrType)le.unit_desig);
    SELF.sec_range_Invalid := DNB_Party_Fields.InValid_sec_range((SALT39.StrType)le.sec_range);
    SELF.p_city_name_Invalid := DNB_Party_Fields.InValid_p_city_name((SALT39.StrType)le.p_city_name);
    SELF.v_city_name_Invalid := DNB_Party_Fields.InValid_v_city_name((SALT39.StrType)le.v_city_name);
    SELF.st_Invalid := DNB_Party_Fields.InValid_st((SALT39.StrType)le.st);
    SELF.zip5_Invalid := DNB_Party_Fields.InValid_zip5((SALT39.StrType)le.zip5);
    SELF.zip4_Invalid := DNB_Party_Fields.InValid_zip4((SALT39.StrType)le.zip4);
    SELF.county_Invalid := DNB_Party_Fields.InValid_county((SALT39.StrType)le.county);
    SELF.cart_Invalid := DNB_Party_Fields.InValid_cart((SALT39.StrType)le.cart);
    SELF.cr_sort_sz_Invalid := DNB_Party_Fields.InValid_cr_sort_sz((SALT39.StrType)le.cr_sort_sz);
    SELF.lot_Invalid := DNB_Party_Fields.InValid_lot((SALT39.StrType)le.lot);
    SELF.lot_order_Invalid := DNB_Party_Fields.InValid_lot_order((SALT39.StrType)le.lot_order);
    SELF.dpbc_Invalid := DNB_Party_Fields.InValid_dpbc((SALT39.StrType)le.dpbc);
    SELF.chk_digit_Invalid := DNB_Party_Fields.InValid_chk_digit((SALT39.StrType)le.chk_digit);
    SELF.rec_type_Invalid := DNB_Party_Fields.InValid_rec_type((SALT39.StrType)le.rec_type);
    SELF.ace_fips_st_Invalid := DNB_Party_Fields.InValid_ace_fips_st((SALT39.StrType)le.ace_fips_st);
    SELF.ace_fips_county_Invalid := DNB_Party_Fields.InValid_ace_fips_county((SALT39.StrType)le.ace_fips_county);
    SELF.geo_lat_Invalid := DNB_Party_Fields.InValid_geo_lat((SALT39.StrType)le.geo_lat);
    SELF.geo_long_Invalid := DNB_Party_Fields.InValid_geo_long((SALT39.StrType)le.geo_long);
    SELF.msa_Invalid := DNB_Party_Fields.InValid_msa((SALT39.StrType)le.msa);
    SELF.geo_blk_Invalid := DNB_Party_Fields.InValid_geo_blk((SALT39.StrType)le.geo_blk);
    SELF.geo_match_Invalid := DNB_Party_Fields.InValid_geo_match((SALT39.StrType)le.geo_match);
    SELF.err_stat_Invalid := DNB_Party_Fields.InValid_err_stat((SALT39.StrType)le.err_stat);
    SELF.bdid_Invalid := DNB_Party_Fields.InValid_bdid((SALT39.StrType)le.bdid);
    SELF.did_Invalid := DNB_Party_Fields.InValid_did((SALT39.StrType)le.did);
    SELF.did_score_Invalid := DNB_Party_Fields.InValid_did_score((SALT39.StrType)le.did_score);
    SELF.bdid_score_Invalid := DNB_Party_Fields.InValid_bdid_score((SALT39.StrType)le.bdid_score);
    SELF.source_rec_id_Invalid := DNB_Party_Fields.InValid_source_rec_id((SALT39.StrType)le.source_rec_id);
    SELF.dotid_Invalid := DNB_Party_Fields.InValid_dotid((SALT39.StrType)le.dotid);
    SELF.dotscore_Invalid := DNB_Party_Fields.InValid_dotscore((SALT39.StrType)le.dotscore);
    SELF.dotweight_Invalid := DNB_Party_Fields.InValid_dotweight((SALT39.StrType)le.dotweight);
    SELF.empid_Invalid := DNB_Party_Fields.InValid_empid((SALT39.StrType)le.empid);
    SELF.empscore_Invalid := DNB_Party_Fields.InValid_empscore((SALT39.StrType)le.empscore);
    SELF.empweight_Invalid := DNB_Party_Fields.InValid_empweight((SALT39.StrType)le.empweight);
    SELF.powid_Invalid := DNB_Party_Fields.InValid_powid((SALT39.StrType)le.powid);
    SELF.powscore_Invalid := DNB_Party_Fields.InValid_powscore((SALT39.StrType)le.powscore);
    SELF.powweight_Invalid := DNB_Party_Fields.InValid_powweight((SALT39.StrType)le.powweight);
    SELF.proxid_Invalid := DNB_Party_Fields.InValid_proxid((SALT39.StrType)le.proxid);
    SELF.proxscore_Invalid := DNB_Party_Fields.InValid_proxscore((SALT39.StrType)le.proxscore);
    SELF.proxweight_Invalid := DNB_Party_Fields.InValid_proxweight((SALT39.StrType)le.proxweight);
    SELF.seleid_Invalid := DNB_Party_Fields.InValid_seleid((SALT39.StrType)le.seleid);
    SELF.selescore_Invalid := DNB_Party_Fields.InValid_selescore((SALT39.StrType)le.selescore);
    SELF.seleweight_Invalid := DNB_Party_Fields.InValid_seleweight((SALT39.StrType)le.seleweight);
    SELF.orgid_Invalid := DNB_Party_Fields.InValid_orgid((SALT39.StrType)le.orgid);
    SELF.orgscore_Invalid := DNB_Party_Fields.InValid_orgscore((SALT39.StrType)le.orgscore);
    SELF.orgweight_Invalid := DNB_Party_Fields.InValid_orgweight((SALT39.StrType)le.orgweight);
    SELF.ultid_Invalid := DNB_Party_Fields.InValid_ultid((SALT39.StrType)le.ultid);
    SELF.ultscore_Invalid := DNB_Party_Fields.InValid_ultscore((SALT39.StrType)le.ultscore);
    SELF.ultweight_Invalid := DNB_Party_Fields.InValid_ultweight((SALT39.StrType)le.ultweight);
    SELF.prep_addr_line1_Invalid := DNB_Party_Fields.InValid_prep_addr_line1((SALT39.StrType)le.prep_addr_line1);
    SELF.prep_addr_last_line_Invalid := DNB_Party_Fields.InValid_prep_addr_last_line((SALT39.StrType)le.prep_addr_last_line);
    SELF.rawaid_Invalid := DNB_Party_Fields.InValid_rawaid((SALT39.StrType)le.rawaid);
    SELF.aceaid_Invalid := DNB_Party_Fields.InValid_aceaid((SALT39.StrType)le.aceaid);
    SELF.persistent_record_id_Invalid := DNB_Party_Fields.InValid_persistent_record_id((SALT39.StrType)le.persistent_record_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    orig_name_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_name_Invalid=2);
    orig_name_Total_ErrorCount := COUNT(GROUP,h.orig_name_Invalid>0);
    orig_lname_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_lname_Invalid=1);
    orig_fname_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_fname_Invalid=1);
    orig_mname_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_mname_Invalid=1);
    orig_suffix_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_suffix_Invalid=1);
    ...
    orig_address2_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_address2_Invalid=2);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.orig_name_Invalid,'ALLOW','LENGTHS','UNKNOWN')
          ,CHOOSE(le.orig_lname_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.orig_fname_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.orig_mname_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.orig_suffix_Invalid,'LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_address2_Invalid,'ALLOW','LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.dt_first_seen_Invalid,'CUSTOM','LENGTHS','UNKNOWN')
          ,CHOOSE(le.dt_last_seen_Invalid,'CUSTOM','LENGTHS','UNKNOWN')
          ,CHOOSE(le.dt_vendor_last_reported_Invalid,'CUSTOM','LENGTHS','UNKNOWN')
          ,CHOOSE(le.dt_vendor_first_reported_Invalid,'CUSTOM','LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.name_suffix_Invalid,'ALLOW','LENGTHS','UNKNOWN')
    ...
    SELF.FieldContents := CHOOSE(c,(SALT39.StrType)le.tmsid,(SALT39.StrType)le.rmsid,(SALT39.StrType)le.orig_name,(SALT39.StrType)le.orig_lname,(SALT39.StrType)le.orig_fname,(SALT39.StrType)le.orig_mname,(SALT39.StrType)le.orig_suffix,(SALT39.StrType)le.duns_number,(SALT39.StrType)le.hq_duns_number,(SALT39.StrType)le.ssn,(SALT39.StrType)le.fein,(SALT39.StrType)le.incorp_state,(SALT39.StrType)le.corp_number,(SALT39.StrType)le.corp_type,(SALT39.StrType)le.orig_address1,(SALT39.StrType)le.orig_address2,(SALT39.StrType)le.orig_city,(SALT39.StrType)le.orig_state,(SALT39.StrType)le.orig_zip5,(SALT39.StrType)le.orig_zip4,(SALT39.StrType)le.orig_country,(SALT39.StrType)le.orig_province,(SALT39.StrType)le.foreign_indc,(SALT39.StrType)le.party_type,(SALT39.StrType)le.dt_first_seen,(SALT39.StrType)le.dt_last_seen,(SALT39.StrType)le.dt_vendor_last_reported,(SALT39.StrType)le.dt_vendor_first_reported,(SALT39.StrType)le.process_date,(SALT39.StrType)le.title,(SALT39.StrType)le.fname,(SALT39.StrType)le.mname,(SALT39.StrType)le.lname,(SALT39.StrType)le.name_suffix,(SALT39.StrType)le.name_score,(SALT39.StrType)le.company_name,(SALT39.StrType)le.prim_range,(SALT39.StrType)le.predir,(SALT39.StrType)le.prim_name,(SALT39.StrType)le.suffix,(SALT39.StrType)le.postdir,(SALT39.StrType)le.unit_desig,(SALT39.StrType)le.sec_range,(SALT39.StrType)le.p_city_name,(SALT39.StrType)le.v_city_name,(SALT39.StrType)le.st,(SALT39.StrType)le.zip5,(SALT39.StrType)le.zip4,(SALT39.StrType)le.county,(SALT39.StrType)le.cart,(SALT39.StrType)le.cr_sort_sz,(SALT39.StrType)le.lot,(SALT39.StrType)le.lot_order,(SALT39.StrType)le.dpbc,(SALT39.StrType)le.chk_digit,(SALT39.StrType)le.rec_type,(SALT39.StrType)le.ace_fips_st,(SALT39.StrType)le.ace_fips_county,(SALT39.StrType)le.geo_lat,(SALT39.StrType)le.geo_long,(SALT39.StrType)le.msa,(SALT39.StrType)le.geo_blk,(SALT39.StrType)le.geo_match,(SALT39.StrType)le.err_stat,(SALT39.StrType)le.bdid,(SALT39.StrType)le.did,(SALT39.StrType)le.did_score,(SALT39.StrType)le.bdid_score,(SALT39.StrType)le.source_rec_id,(SALT39.StrType)le.dotid,(SALT39.StrType)le.dotscore,(SALT39.StrType)le.dotweight,(SALT39.StrType)le.empid,(SALT39.StrType)le.empscore,(SALT39.StrType)le.empweight,(SALT39.StrType)le.powid,(SALT39.StrType)le.powscore,(SALT39.StrType)le.powweight,(SALT39.StrType)le.proxid,(SALT39.StrType)le.proxscore,(SALT39.StrType)le.proxweight,(SALT39.StrType)le.seleid,(SALT39.StrType)le.selescore,(SALT39.StrType)le.seleweight,(SALT39.StrType)le.orgid,(SALT39.StrType)le.orgscore,(SALT39.StrType)le.orgweight,(SALT39.StrType)le.ultid,(SALT39.StrType)le.ultscore,(SALT39.StrType)le.ultweight,(SALT39.StrType)le.prep_addr_line1,(SALT39.StrType)le.prep_addr_last_line,(SALT39.StrType)le.rawaid,(SALT39.StrType)le.aceaid,(SALT39.StrType)le.persistent_record_id,'***SALTBUG***');
  END;
  ...
  // field error stats
    SALT39.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'orig_name:invalid_wordbag:ALLOW','orig_name:invalid_wordbag:LENGTHS'
          ,'orig_lname:invalid_empty:LENGTHS'
          ,'orig_fname:invalid_empty:LENGTHS'
          ,'orig_mname:invalid_empty:LENGTHS'
          ,'orig_suffix:invalid_empty:LENGTHS'
          ...
          ,'orig_address2:invalid_wordbag:ALLOW','orig_address2:invalid_wordbag:LENGTHS'
          ...
          ,'dt_first_seen:invalid_pastdate06:CUSTOM','dt_first_seen:invalid_pastdate06:LENGTHS'
          ,'dt_last_seen:invalid_pastdate06:CUSTOM','dt_last_seen:invalid_pastdate06:LENGTHS'
          ,'dt_vendor_last_reported:invalid_pastdate06:CUSTOM','dt_vendor_last_reported:invalid_pastdate06:LENGTHS'
          ,'dt_vendor_first_reported:invalid_pastdate06:CUSTOM','dt_vendor_first_reported:invalid_pastdate06:LENGTHS'
          ,'process_date:invalid_08pastdate:CUSTOM','process_date:invalid_08pastdate:LENGTHS'
          ,'title:invalid_wordbag:ALLOW','title:invalid_wordbag:LENGTHS'
          ,'fname:invalid_fname:CUSTOM'
          ,'mname:invalid_mname:CUSTOM'
          ,'lname:invalid_lname:CUSTOM'
          ,'name_suffix:invalid_wordbag:ALLOW','name_suffix:invalid_wordbag:LENGTHS'
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.orig_name_ALLOW_ErrorCount,le.orig_name_LENGTHS_ErrorCount
          ,le.orig_lname_LENGTHS_ErrorCount
          ,le.orig_fname_LENGTHS_ErrorCount
          ,le.orig_mname_LENGTHS_ErrorCount
          ,le.orig_suffix_LENGTHS_ErrorCount
          ...
          ,le.orig_address2_ALLOW_ErrorCount,le.orig_address2_LENGTHS_ErrorCount
          ...
          ,le.dt_first_seen_CUSTOM_ErrorCount,le.dt_first_seen_LENGTHS_ErrorCount
          ,le.dt_last_seen_CUSTOM_ErrorCount,le.dt_last_seen_LENGTHS_ErrorCount
          ,le.dt_vendor_last_reported_CUSTOM_ErrorCount,le.dt_vendor_last_reported_LENGTHS_ErrorCount
          ,le.dt_vendor_first_reported_CUSTOM_ErrorCount,le.dt_vendor_first_reported_LENGTHS_ErrorCount
          ...
          ,le.name_suffix_ALLOW_ErrorCount,le.name_suffix_LENGTHS_ErrorCount
...
EXPORT StandardStats(DATASET(DNB_Party_Layout_UCCV2) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_UCCV2, DNB_Party_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
