...
EXPORT Make_tmsid(SALT38.StrType s0) := s0;
EXPORT InValid_tmsid(SALT38.StrType s) := 0;
EXPORT InValidMessage_tmsid(UNSIGNED1 wh) := '';
 
EXPORT Make_rmsid(SALT38.StrType s0) := s0;
EXPORT InValid_rmsid(SALT38.StrType s) := 0;
EXPORT InValidMessage_rmsid(UNSIGNED1 wh) := '';
 
EXPORT Make_orig_name(SALT38.StrType s0) := s0;
EXPORT InValid_orig_name(SALT38.StrType s) := 0;
...
EXPORT Make_hq_duns_number(SALT38.StrType s0) := s0;
EXPORT InValid_hq_duns_number(SALT38.StrType s) := 0;
EXPORT InValidMessage_hq_duns_number(UNSIGNED1 wh) := '';
 
EXPORT Make_ssn(SALT38.StrType s0) := s0;
EXPORT InValid_ssn(SALT38.StrType s) := 0;
EXPORT InValidMessage_ssn(UNSIGNED1 wh) := '';
 
EXPORT Make_fein(SALT38.StrType s0) := s0;
EXPORT InValid_fein(SALT38.StrType s) := 0;
EXPORT InValidMessage_fein(UNSIGNED1 wh) := '';
 
EXPORT Make_incorp_state(SALT38.StrType s0) := s0;
EXPORT InValid_incorp_state(SALT38.StrType s) := 0;
EXPORT InValidMessage_incorp_state(UNSIGNED1 wh) := '';
...
EXPORT Make_orig_address1(SALT38.StrType s0) := s0;
EXPORT InValid_orig_address1(SALT38.StrType s) := 0;
EXPORT InValidMessage_orig_address1(UNSIGNED1 wh) := '';
...
EXPORT Make_orig_state(SALT38.StrType s0) := s0;
EXPORT InValid_orig_state(SALT38.StrType s) := 0;
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := '';
 
EXPORT Make_orig_zip5(SALT38.StrType s0) := s0;
EXPORT InValid_orig_zip5(SALT38.StrType s) := 0;
...
EXPORT Make_party_type(SALT38.StrType s0) := s0;
EXPORT InValid_party_type(SALT38.StrType s) := 0;
EXPORT InValidMessage_party_type(UNSIGNED1 wh) := '';
 
EXPORT Make_dt_first_seen(SALT38.StrType s0) := s0;
EXPORT InValid_dt_first_seen(SALT38.StrType s) := 0;
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := '';
 
EXPORT Make_dt_last_seen(SALT38.StrType s0) := s0;
EXPORT InValid_dt_last_seen(SALT38.StrType s) := 0;
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := '';
 
EXPORT Make_dt_vendor_last_reported(SALT38.StrType s0) := s0;
EXPORT InValid_dt_vendor_last_reported(SALT38.StrType s) := 0;
EXPORT InValidMessage_dt_vendor_last_reported(UNSIGNED1 wh) := '';
 
EXPORT Make_dt_vendor_first_reported(SALT38.StrType s0) := s0;
EXPORT InValid_dt_vendor_first_reported(SALT38.StrType s) := 0;
EXPORT InValidMessage_dt_vendor_first_reported(UNSIGNED1 wh) := '';
 
EXPORT Make_process_date(SALT38.StrType s0) := s0;
EXPORT InValid_process_date(SALT38.StrType s) := 0;
...
EXPORT Make_company_name(SALT38.StrType s0) := s0;
EXPORT InValid_company_name(SALT38.StrType s) := 0;
...
EXPORT Make_ace_fips_county(SALT38.StrType s0) := s0;
EXPORT InValid_ace_fips_county(SALT38.StrType s) := 0;
...
EXPORT Make_bdid(SALT38.StrType s0) := s0;
EXPORT InValid_bdid(SALT38.StrType s) := 0;
...
EXPORT Make_bdid_score(SALT38.StrType s0) := s0;
EXPORT InValid_bdid_score(SALT38.StrType s) := 0;
