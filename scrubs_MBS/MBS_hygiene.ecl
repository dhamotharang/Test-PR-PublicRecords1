...
EXPORT Summary(SALT37.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_fdn_file_code := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.fdn_file_code)));
    avelength_fdn_file_code := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.fdn_file_code)),h.fdn_file_code<>(typeof(h.fdn_file_code))'');
    ...
    maxlength_file_type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.file_type)));
    avelength_file_type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.file_type)),h.file_type<>(typeof(h.file_type))'');
    ...
    maxlength_primary_source_entity := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.primary_source_entity)));
    avelength_primary_source_entity := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.primary_source_entity)),h.primary_source_entity<>(typeof(h.primary_source_entity))'');
    ...
    maxlength_update_freq := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.update_freq)));
    avelength_update_freq := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.update_freq)),h.update_freq<>(typeof(h.update_freq))'');
    populated_expiration_days_pcnt := AVE(GROUP,IF(h.expiration_days = (TYPEOF(h.expiration_days))'',0,100));
    maxlength_expiration_days := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.expiration_days)));
    avelength_expiration_days := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.expiration_days)),h.expiration_days<>(typeof(h.expiration_days))'');
    ...
    maxlength_post_contract_expiration_days := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.post_contract_expiration_days)));
    avelength_post_contract_expiration_days := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.post_contract_expiration_days)),h.post_contract_expiration_days<>(typeof(h.post_contract_expiration_days))'');
    ...
    maxlength_product_include := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.product_include)));
    avelength_product_include := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.product_include)),h.product_include<>(typeof(h.product_include))'');
    ...
    maxlength_expectation_of_victim_entities := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.expectation_of_victim_entities)));
    avelength_expectation_of_victim_entities := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.expectation_of_victim_entities)),h.expectation_of_victim_entities<>(typeof(h.expectation_of_victim_entities))'');
    populated_suspected_discrepancy_pcnt := AVE(GROUP,IF(h.suspected_discrepancy = (TYPEOF(h.suspected_discrepancy))'',0,100));
    maxlength_suspected_discrepancy := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.suspected_discrepancy)));
    avelength_suspected_discrepancy := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.suspected_discrepancy)),h.suspected_discrepancy<>(typeof(h.suspected_discrepancy))'');
    ...
    maxlength_confidence_that_activity_was_deceitful := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.confidence_that_activity_was_deceitful)));
    avelength_confidence_that_activity_was_deceitful := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.confidence_that_activity_was_deceitful)),h.confidence_that_activity_was_deceitful<>(typeof(h.confidence_that_activity_was_deceitful))'');
    populated_workflow_stage_committed_pcnt := AVE(GROUP,IF(h.workflow_stage_committed = (TYPEOF(h.workflow_stage_committed))'',0,100));
    maxlength_workflow_stage_committed := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.workflow_stage_committed)));
    avelength_workflow_stage_committed := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.workflow_stage_committed)),h.workflow_stage_committed<>(typeof(h.workflow_stage_committed))'');
    populated_workflow_stage_detected_pcnt := AVE(GROUP,IF(h.workflow_stage_detected = (TYPEOF(h.workflow_stage_detected))'',0,100));
    maxlength_workflow_stage_detected := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.workflow_stage_detected)));
    avelength_workflow_stage_detected := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.workflow_stage_detected)),h.workflow_stage_detected<>(typeof(h.workflow_stage_detected))'');
    populated_channels_pcnt := AVE(GROUP,IF(h.channels = (TYPEOF(h.channels))'',0,100));
    maxlength_channels := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.channels)));
    avelength_channels := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.channels)),h.channels<>(typeof(h.channels))'');
    populated_threat_pcnt := AVE(GROUP,IF(h.threat = (TYPEOF(h.threat))'',0,100));
    maxlength_threat := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.threat)));
    avelength_threat := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.threat)),h.threat<>(typeof(h.threat))'');
    populated_alert_level_pcnt := AVE(GROUP,IF(h.alert_level = (TYPEOF(h.alert_level))'',0,100));
    maxlength_alert_level := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.alert_level)));
    avelength_alert_level := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.alert_level)),h.alert_level<>(typeof(h.alert_level))'');
    populated_entity_type_pcnt := AVE(GROUP,IF(h.entity_type = (TYPEOF(h.entity_type))'',0,100));
    maxlength_entity_type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.entity_type)));
    avelength_entity_type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.entity_type)),h.entity_type<>(typeof(h.entity_type))'');
    populated_entity_sub_type_pcnt := AVE(GROUP,IF(h.entity_sub_type = (TYPEOF(h.entity_sub_type))'',0,100));
    maxlength_entity_sub_type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.entity_sub_type)));
    avelength_entity_sub_type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.entity_sub_type)),h.entity_sub_type<>(typeof(h.entity_sub_type))'');
    populated_role_pcnt := AVE(GROUP,IF(h.role = (TYPEOF(h.role))'',0,100));
    maxlength_role := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.role)));
    avelength_role := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.role)),h.role<>(typeof(h.role))'');
    populated_evidence_pcnt := AVE(GROUP,IF(h.evidence = (TYPEOF(h.evidence))'',0,100));
    maxlength_evidence := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.evidence)));
    avelength_evidence := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.evidence)),h.evidence<>(typeof(h.evidence))'');
...
SALT37.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.fdn_file_info_id <> 0,TRIM((SALT37.StrType)le.fdn_file_info_id), ''),TRIM((SALT37.StrType)le.fdn_file_code),IF (le.gc_id <> 0,TRIM((SALT37.StrType)le.gc_id), ''),IF (le.file_type <> 0,TRIM((SALT37.StrType)le.file_type), ''),TRIM((SALT37.StrType)le.description),IF (le.primary_source_entity <> 0,TRIM((SALT37.StrType)le.primary_source_entity), ''),IF (le.ind_type <> 0,TRIM((SALT37.StrType)le.ind_type), ''),IF (le.update_freq <> 0,TRIM((SALT37.StrType)le.update_freq), ''),IF (le.expiration_days <> 0,TRIM((SALT37.StrType)le.expiration_days), ''),IF (le.post_contract_expiration_days <> 0,TRIM((SALT37.StrType)le.post_contract_expiration_days), ''),IF (le.status <> 0,TRIM((SALT37.StrType)le.status), ''),IF (le.product_include <> 0,TRIM((SALT37.StrType)le.product_include), ''),IF (le.expectation_of_victim_entities <> 0,TRIM((SALT37.StrType)le.expectation_of_victim_entities), ''),IF (le.suspected_discrepancy <> 0,TRIM((SALT37.StrType)le.suspected_discrepancy), ''),IF (le.confidence_that_activity_was_deceitful <> 0,TRIM((SALT37.StrType)le.confidence_that_activity_was_deceitful), ''),IF (le.workflow_stage_committed <> 0,TRIM((SALT37.StrType)le.workflow_stage_committed), ''),IF (le.workflow_stage_detected <> 0,TRIM((SALT37.StrType)le.workflow_stage_detected), ''),IF (le.channels <> 0,TRIM((SALT37.StrType)le.channels), ''),IF (le.threat <> 0,TRIM((SALT37.StrType)le.threat), ''),IF (le.alert_level <> 0,TRIM((SALT37.StrType)le.alert_level), ''),IF (le.entity_type <> 0,TRIM((SALT37.StrType)le.entity_type), ''),IF (le.entity_sub_type <> 0,TRIM((SALT37.StrType)le.entity_sub_type), ''),IF (le.role <> 0,TRIM((SALT37.StrType)le.role), ''),IF (le.evidence <> 0,TRIM((SALT37.StrType)le.evidence), ''),TRIM((SALT37.StrType)le.date_added),TRIM((SALT37.StrType)le.user_added),TRIM((SALT37.StrType)le.date_changed),TRIM((SALT37.StrType)le.user_changed)));
  SELF.FldNo := C;
END;
...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 28);
  SELF.FldNo2 := 1 + (C % 28);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.fdn_file_info_id <> 0,TRIM((SALT37.StrType)le.fdn_file_info_id), ''),TRIM((SALT37.StrType)le.fdn_file_code),IF (le.gc_id <> 0,TRIM((SALT37.StrType)le.gc_id), ''),IF (le.file_type <> 0,TRIM((SALT37.StrType)le.file_type), ''),TRIM((SALT37.StrType)le.description),IF (le.primary_source_entity <> 0,TRIM((SALT37.StrType)le.primary_source_entity), ''),IF (le.ind_type <> 0,TRIM((SALT37.StrType)le.ind_type), ''),IF (le.update_freq <> 0,TRIM((SALT37.StrType)le.update_freq), ''),IF (le.expiration_days <> 0,TRIM((SALT37.StrType)le.expiration_days), ''),IF (le.post_contract_expiration_days <> 0,TRIM((SALT37.StrType)le.post_contract_expiration_days), ''),IF (le.status <> 0,TRIM((SALT37.StrType)le.status), ''),IF (le.product_include <> 0,TRIM((SALT37.StrType)le.product_include), ''),IF (le.expectation_of_victim_entities <> 0,TRIM((SALT37.StrType)le.expectation_of_victim_entities), ''),IF (le.suspected_discrepancy <> 0,TRIM((SALT37.StrType)le.suspected_discrepancy), ''),IF (le.confidence_that_activity_was_deceitful <> 0,TRIM((SALT37.StrType)le.confidence_that_activity_was_deceitful), ''),IF (le.workflow_stage_committed <> 0,TRIM((SALT37.StrType)le.workflow_stage_committed), ''),IF (le.workflow_stage_detected <> 0,TRIM((SALT37.StrType)le.workflow_stage_detected), ''),IF (le.channels <> 0,TRIM((SALT37.StrType)le.channels), ''),IF (le.threat <> 0,TRIM((SALT37.StrType)le.threat), ''),IF (le.alert_level <> 0,TRIM((SALT37.StrType)le.alert_level), ''),IF (le.entity_type <> 0,TRIM((SALT37.StrType)le.entity_type), ''),IF (le.entity_sub_type <> 0,TRIM((SALT37.StrType)le.entity_sub_type), ''),IF (le.role <> 0,TRIM((SALT37.StrType)le.role), ''),IF (le.evidence <> 0,TRIM((SALT37.StrType)le.evidence), ''),TRIM((SALT37.StrType)le.date_added),TRIM((SALT37.StrType)le.user_added),TRIM((SALT37.StrType)le.date_changed),TRIM((SALT37.StrType)le.user_changed)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.fdn_file_info_id <> 0,TRIM((SALT37.StrType)le.fdn_file_info_id), ''),TRIM((SALT37.StrType)le.fdn_file_code),IF (le.gc_id <> 0,TRIM((SALT37.StrType)le.gc_id), ''),IF (le.file_type <> 0,TRIM((SALT37.StrType)le.file_type), ''),TRIM((SALT37.StrType)le.description),IF (le.primary_source_entity <> 0,TRIM((SALT37.StrType)le.primary_source_entity), ''),IF (le.ind_type <> 0,TRIM((SALT37.StrType)le.ind_type), ''),IF (le.update_freq <> 0,TRIM((SALT37.StrType)le.update_freq), ''),IF (le.expiration_days <> 0,TRIM((SALT37.StrType)le.expiration_days), ''),IF (le.post_contract_expiration_days <> 0,TRIM((SALT37.StrType)le.post_contract_expiration_days), ''),IF (le.status <> 0,TRIM((SALT37.StrType)le.status), ''),IF (le.product_include <> 0,TRIM((SALT37.StrType)le.product_include), ''),IF (le.expectation_of_victim_entities <> 0,TRIM((SALT37.StrType)le.expectation_of_victim_entities), ''),IF (le.suspected_discrepancy <> 0,TRIM((SALT37.StrType)le.suspected_discrepancy), ''),IF (le.confidence_that_activity_was_deceitful <> 0,TRIM((SALT37.StrType)le.confidence_that_activity_was_deceitful), ''),IF (le.workflow_stage_committed <> 0,TRIM((SALT37.StrType)le.workflow_stage_committed), ''),IF (le.workflow_stage_detected <> 0,TRIM((SALT37.StrType)le.workflow_stage_detected), ''),IF (le.channels <> 0,TRIM((SALT37.StrType)le.channels), ''),IF (le.threat <> 0,TRIM((SALT37.StrType)le.threat), ''),IF (le.alert_level <> 0,TRIM((SALT37.StrType)le.alert_level), ''),IF (le.entity_type <> 0,TRIM((SALT37.StrType)le.entity_type), ''),IF (le.entity_sub_type <> 0,TRIM((SALT37.StrType)le.entity_sub_type), ''),IF (le.role <> 0,TRIM((SALT37.StrType)le.role), ''),IF (le.evidence <> 0,TRIM((SALT37.StrType)le.evidence), ''),TRIM((SALT37.StrType)le.date_added),TRIM((SALT37.StrType)le.user_added),TRIM((SALT37.StrType)le.date_changed),TRIM((SALT37.StrType)le.user_changed)));
  END;
...
SHARED FldIds := DATASET([{1,'fdn_file_info_id'}
      ...
      ,{26,'user_added'}
      ,{27,'date_changed'}
      ,{28,'user_changed'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MBS_Fields.InValid_fdn_file_info_id((SALT37.StrType)le.fdn_file_info_id),
    MBS_Fields.InValid_fdn_file_code((SALT37.StrType)le.fdn_file_code),
    MBS_Fields.InValid_gc_id((SALT37.StrType)le.gc_id),
    MBS_Fields.InValid_file_type((SALT37.StrType)le.file_type),
    MBS_Fields.InValid_description((SALT37.StrType)le.description),
    MBS_Fields.InValid_primary_source_entity((SALT37.StrType)le.primary_source_entity),
    MBS_Fields.InValid_ind_type((SALT37.StrType)le.ind_type),
    MBS_Fields.InValid_update_freq((SALT37.StrType)le.update_freq),
    MBS_Fields.InValid_expiration_days((SALT37.StrType)le.expiration_days),
    MBS_Fields.InValid_post_contract_expiration_days((SALT37.StrType)le.post_contract_expiration_days),
    MBS_Fields.InValid_status((SALT37.StrType)le.status),
    MBS_Fields.InValid_product_include((SALT37.StrType)le.product_include),
    MBS_Fields.InValid_expectation_of_victim_entities((SALT37.StrType)le.expectation_of_victim_entities),
    MBS_Fields.InValid_suspected_discrepancy((SALT37.StrType)le.suspected_discrepancy),
    MBS_Fields.InValid_confidence_that_activity_was_deceitful((SALT37.StrType)le.confidence_that_activity_was_deceitful),
    MBS_Fields.InValid_workflow_stage_committed((SALT37.StrType)le.workflow_stage_committed),
    MBS_Fields.InValid_workflow_stage_detected((SALT37.StrType)le.workflow_stage_detected),
    MBS_Fields.InValid_channels((SALT37.StrType)le.channels),
    MBS_Fields.InValid_threat((SALT37.StrType)le.threat),
    MBS_Fields.InValid_alert_level((SALT37.StrType)le.alert_level),
    MBS_Fields.InValid_entity_type((SALT37.StrType)le.entity_type),
    MBS_Fields.InValid_entity_sub_type((SALT37.StrType)le.entity_sub_type),
    MBS_Fields.InValid_role((SALT37.StrType)le.role),
    MBS_Fields.InValid_evidence((SALT37.StrType)le.evidence),
    MBS_Fields.InValid_date_added((SALT37.StrType)le.date_added),
    MBS_Fields.InValid_user_added((SALT37.StrType)le.user_added),
    MBS_Fields.InValid_date_changed((SALT37.StrType)le.date_changed),
    MBS_Fields.InValid_user_changed((SALT37.StrType)le.user_changed),
    0);
