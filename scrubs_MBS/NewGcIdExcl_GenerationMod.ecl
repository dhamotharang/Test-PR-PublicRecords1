...
IMPORT SALT39;
EXPORT NewGcIdExcl_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'NewGcIdExcl';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_FILENAME := 'NewGcIdExcl';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,fdn_file_gc_exclusion_id,fdn_file_info_id,exclusion_id,exclusion_id_type,status,date_added,user_added,date_changed,user_changed';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh\n'
    + 'MODULE:Scrubs_MBS\n'
    + 'FILENAME:NewGcIdExcl\n'
    + 'NAMESCOPE:NewGcIdExcl\n'
    ...
    + 'FIELD:fdn_file_gc_exclusion_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:fdn_file_info_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:exclusion_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:exclusion_id_type:TYPE(STRING20):LIKE(invalid_alphanumeric):0,0 \n'
