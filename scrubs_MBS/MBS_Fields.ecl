...
EXPORT Make_fdn_file_code(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_fdn_file_code(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
...
EXPORT Make_file_type(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_file_type(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_file_type(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_description(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_description(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_description(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_primary_source_entity(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_primary_source_entity(SALT37.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_update_freq(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_update_freq(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_update_freq(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_expiration_days(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_expiration_days(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_expiration_days(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_post_contract_expiration_days(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_post_contract_expiration_days(SALT37.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_product_include(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_product_include(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_product_include(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_expectation_of_victim_entities(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_expectation_of_victim_entities(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_expectation_of_victim_entities(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_suspected_discrepancy(SALT37.StrType s0) := s0;
EXPORT InValid_suspected_discrepancy(SALT37.StrType s) := 0;
EXPORT InValidMessage_suspected_discrepancy(UNSIGNED1 wh) := '';


EXPORT Make_confidence_that_activity_was_deceitful(SALT37.StrType s0) := s0;
EXPORT InValid_confidence_that_activity_was_deceitful(SALT37.StrType s) := 0;
EXPORT InValidMessage_confidence_that_activity_was_deceitful(UNSIGNED1 wh) := '';


EXPORT Make_workflow_stage_committed(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_workflow_stage_committed(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_workflow_stage_committed(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_workflow_stage_detected(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_workflow_stage_detected(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_workflow_stage_detected(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_channels(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_channels(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_channels(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_threat(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_threat(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_threat(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_alert_level(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_alert_level(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_alert_level(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_entity_type(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_entity_type(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_entity_type(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_entity_sub_type(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_entity_sub_type(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_entity_sub_type(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_role(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_role(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_role(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_evidence(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_evidence(SALT37.StrType s) := InValidFT_invalid_numeric(s);
