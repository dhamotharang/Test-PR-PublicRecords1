...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'fdn_ind_type_gc_id_inclusion','fdn_file_info_id','ind_type','inclusion_id','inclusion_type','status','date_added','user_added','date_changed','user_changed');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'fdn_ind_type_gc_id_inclusion' => 0,'fdn_file_info_id' => 1,'ind_type' => 2,'inclusion_id' => 3,'inclusion_type' => 4,'status' => 5,'date_added' => 6,'user_added' => 7,'date_changed' => 8,'user_changed' => 9,0);

//Individual field level validation


EXPORT Make_fdn_ind_type_gc_id_inclusion(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fdn_ind_type_gc_id_inclusion(SALT37.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_inclusion_id(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_inclusion_id(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_inclusion_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_inclusion_type(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_inclusion_type(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
...
EXPORT Make_date_added(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_date_added(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_date_added(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_user_added(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_user_added(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_user_added(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_date_changed(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_date_changed(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_date_changed(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_user_changed(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_user_changed(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
