...
#workunit('name','Scrubs_MBS.MasterIdIndTypeIncl_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_MBS,SALT311;
infile := Scrubs_MBS.MasterIdIndTypeIncl_In_MasterIdIndTypeIncl;
mod_scrubs := Scrubs_MBS.MasterIdIndTypeIncl_Scrubs;
