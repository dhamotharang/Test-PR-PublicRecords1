...
EXPORT SALT39.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'ind_type','description','status','date_added','user_added','date_changed','user_changed');
EXPORT SALT39.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'ind_type','description','status','date_added','user_added','date_changed','user_changed');
EXPORT FieldNum(SALT39.StrType fn) := CASE(fn,'ind_type' => 0,'description' => 1,'status' => 2,'date_added' => 3,'user_added' => 4,'date_changed' => 5,'user_changed' => 6,0);
