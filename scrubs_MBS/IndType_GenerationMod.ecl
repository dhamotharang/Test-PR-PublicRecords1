...
IMPORT SALT39;
EXPORT IndType_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_FILENAME := 'IndType';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,ind_type,description,status,date_added,user_added,date_changed,user_changed';
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:description:TYPE(STRING255):LIKE(invalid_alphanumeric):0,0\n'
