...
IMPORT SALT39;
EXPORT CCID_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_FILENAME := 'CCID';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,cc_id,gc_id,account_id';
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:cc_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:gc_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:account_id:TYPE(STRING30):LIKE(invalid_alphanumeric):0,0 \n'
