...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'table_column_id','table_name','column_name','is_column_value');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'table_column_id' => 0,'table_name' => 1,'column_name' => 2,'is_column_value' => 3,0);
...
EXPORT Make_table_name(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_table_name(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_table_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_column_name(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_column_name(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_column_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_is_column_value(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_is_column_value(SALT37.StrType s) := InValidFT_invalid_numeric(s);
