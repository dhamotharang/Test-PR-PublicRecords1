...
IMPORT SALT39;
EXPORT HHID_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_FILENAME := 'HHID';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,gc_id,sub_account_id,hh_id';
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:sub_account_id:TYPE(STRING30):LIKE(invalid_alphanumeric):0,0\n'
    + 'FIELD:hh_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
