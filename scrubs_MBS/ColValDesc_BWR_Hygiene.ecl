...
#workunit('name','Scrubs_MBS.ColValDesc_BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'ColValDesc_Layout_ColValDesc'),NAMED('OptimizedLayout'));// File layout suggested by data
