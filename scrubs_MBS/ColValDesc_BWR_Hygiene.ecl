...
#workunit('name','Scrubs_MBS.ColValDesc_BWR_Hygiene - Hygiene & Stats - SALT V3.7.1');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT37.MAC_Character_Counts.EclRecord(p,'Layout_ColValDesc'),NAMED('OptimizedLayout'));// File layout suggested by data
