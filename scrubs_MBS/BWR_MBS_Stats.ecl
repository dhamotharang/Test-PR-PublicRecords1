...
F := Scrubs_MBS.MBS_In_MBS; // Input file
S := Scrubs_MBS.MBS_Scrubs; // My scrubs module
...
//Generating a template to upload rules to Orbit
Scrubs.OrbitProfileStats('Scrubs_MBS','ScrubsAlerts',stats).ProfileAlertsTemplate;
//Generating a template to upload rules to Orbit
