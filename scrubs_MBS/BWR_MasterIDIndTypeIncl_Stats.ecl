...
F := Scrubs_MBS.MasterIDIndTypeIncl_In_MasterIDIndTypeIncl; // Input file
S := Scrubs_MBS.MasterIdIndTypeIncl_Scrubs; // My scrubs module
...
//Generating a template to upload rules to Orbit
Scrubs.OrbitProfileStats('Scrubs_MBS_MasterIDIndTypeIncl','ScrubsAlerts',stats).ProfileAlertsTemplate;


//Submits stats to Orbit
submitStats:=Scrubs.OrbitProfileStats('Scrubs_MBS_MasterIDIndTypeIncl','ScrubsAlerts',stats,versionDate,'MBS').SubmitStats;
submitStats;			
