...
IMPORT SALT39;
EXPORT SourceGcExclusion_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'SourceGcExclusion';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_FILENAME := 'SourceGcExclusion';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,gc_id,product_id,company_id,status,date_added,user_added,date_changed,user_changed';
