...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'column_value_desc_id','table_column_id','desc_value','status','description');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'column_value_desc_id' => 0,'table_column_id' => 1,'desc_value' => 2,'status' => 3,'description' => 4,0);

//Individual field level validation


EXPORT Make_column_value_desc_id(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_column_value_desc_id(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_column_value_desc_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_table_column_id(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_table_column_id(SALT37.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_table_column_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);


EXPORT Make_desc_value(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_desc_value(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
