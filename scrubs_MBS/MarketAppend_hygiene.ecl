...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_app_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.app_type)));
    avelength_app_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.app_type)),h.app_type<>(typeof(h.app_type))'');
    ...
    maxlength_market := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.market)));
    avelength_market := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.market)),h.market<>(typeof(h.market))'');
    ...
    maxlength_sub_market := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.sub_market)));
    avelength_sub_market := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.sub_market)),h.sub_market<>(typeof(h.sub_market))'');
    ...
    maxlength_vertical := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.vertical)));
    avelength_vertical := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.vertical)),h.vertical<>(typeof(h.vertical))'');
    ...
    maxlength_main_country_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.main_country_code)));
    avelength_main_country_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.main_country_code)),h.main_country_code<>(typeof(h.main_country_code))'');
    ...
    maxlength_bill_country_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bill_country_code)));
    avelength_bill_country_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bill_country_code)),h.bill_country_code<>(typeof(h.bill_country_code))'');
  END;
...
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT311.StrType)le.company_id),TRIM((SALT311.StrType)le.app_type),TRIM((SALT311.StrType)le.market),TRIM((SALT311.StrType)le.sub_market),TRIM((SALT311.StrType)le.vertical),TRIM((SALT311.StrType)le.main_country_code),TRIM((SALT311.StrType)le.bill_country_code)));
  SELF.FldNo := C;
END;
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 7);
  SELF.FldNo2 := 1 + (C % 7);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT311.StrType)le.company_id),TRIM((SALT311.StrType)le.app_type),TRIM((SALT311.StrType)le.market),TRIM((SALT311.StrType)le.sub_market),TRIM((SALT311.StrType)le.vertical),TRIM((SALT311.StrType)le.main_country_code),TRIM((SALT311.StrType)le.bill_country_code)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT311.StrType)le.company_id),TRIM((SALT311.StrType)le.app_type),TRIM((SALT311.StrType)le.market),TRIM((SALT311.StrType)le.sub_market),TRIM((SALT311.StrType)le.vertical),TRIM((SALT311.StrType)le.main_country_code),TRIM((SALT311.StrType)le.bill_country_code)));
  END;
...
SHARED FldIds := DATASET([{1,'company_id'}
      ...
      ,{5,'vertical'}
      ,{6,'main_country_code'}
      ,{7,'bill_country_code'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MarketAppend_Fields.InValid_company_id((SALT311.StrType)le.company_id),
    MarketAppend_Fields.InValid_app_type((SALT311.StrType)le.app_type),
    MarketAppend_Fields.InValid_market((SALT311.StrType)le.market),
    MarketAppend_Fields.InValid_sub_market((SALT311.StrType)le.sub_market),
    MarketAppend_Fields.InValid_vertical((SALT311.StrType)le.vertical),
    MarketAppend_Fields.InValid_main_country_code((SALT311.StrType)le.main_country_code),
    MarketAppend_Fields.InValid_bill_country_code((SALT311.StrType)le.bill_country_code),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_MBS, MarketAppend_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
