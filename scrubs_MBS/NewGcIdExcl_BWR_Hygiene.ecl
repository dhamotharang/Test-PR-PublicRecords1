...
#workunit('name','Scrubs_MBS.NewGcIdExcl_BWR_Hygiene - Hygiene & Stats - SALT V3.7.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT37.MAC_Character_Counts.EclRecord(p,'Layout_NewGcIdExcl'),NAMED('OptimizedLayout'));// File layout suggested by data
