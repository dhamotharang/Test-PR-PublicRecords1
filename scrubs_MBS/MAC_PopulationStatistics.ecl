...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_gc_id = '',Input_product_id = '',Input_company_id = '',Input_status = '',Input_date_added = '',Input_user_added = '',Input_date_changed = '',Input_user_changed = '',OutFile) := MACRO
