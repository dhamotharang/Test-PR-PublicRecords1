...
IMPORT SALT39;
EXPORT TableCol_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_FILENAME := 'TableCol';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,table_column_id,table_name,column_name,is_column_value';
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:table_name:TYPE(QSTRING192):LIKE(invalid_alphanumeric):0,0\n'
    + 'FIELD:column_name:TYPE(QSTRING192):LIKE(invalid_alphanumeric):0,0\n'
    + 'FIELD:is_column_value:TYPE(UNSIGNED2):LIKE(invalid_numeric):0,0 \n'
