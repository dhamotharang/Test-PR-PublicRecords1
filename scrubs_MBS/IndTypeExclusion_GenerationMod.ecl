...
IMPORT SALT39;
EXPORT IndTypeExclusion_GenerationMod := MODULE(SALT39.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'IndTypeExclusion';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_FILENAME := 'IndTypeExclusion';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,fdn_file_ind_type_exclusion_id,fdn_file_info_id,ind_type,status,date_added,user_added,date_changed,user_changed';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh\n'
    + 'MODULE:Scrubs_MBS\n'
    + 'FILENAME:IndTypeExclusion\n'
    + 'NAMESCOPE:IndTypeExclusion\n'
    ...
    + 'FIELD:fdn_file_ind_type_exclusion_id:TYPE(UNSIGNED6):LIKE(invalid_numeric):0,0\n'
