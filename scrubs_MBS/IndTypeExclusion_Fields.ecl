...
EXPORT SALT39.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'fdn_file_ind_type_exclusion_id','fdn_file_info_id','ind_type','status','date_added','user_added','date_changed','user_changed');
EXPORT SALT39.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'fdn_file_ind_type_exclusion_id','fdn_file_info_id','ind_type','status','date_added','user_added','date_changed','user_changed');
EXPORT FieldNum(SALT39.StrType fn) := CASE(fn,'fdn_file_ind_type_exclusion_id' => 0,'fdn_file_info_id' => 1,'ind_type' => 2,'status' => 3,'date_added' => 4,'user_added' => 5,'date_changed' => 6,'user_changed' => 7,0);
...
EXPORT Make_fdn_file_ind_type_exclusion_id(SALT39.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fdn_file_ind_type_exclusion_id(SALT39.StrType s) := InValidFT_invalid_numeric(s);
