...
F := Scrubs_MBS.ColValDesc_In_ColValDesc; // Input file
S := Scrubs_MBS.ColValDesc_Scrubs; // My scrubs module
...
//Generating a template to upload rules to Orbit
Scrubs.OrbitProfileStats('Scrubs_MBS_ColValDesc','ScrubsAlerts',stats).ProfileAlertsTemplate;

//Submits stats to Orbit
submitStats:=Scrubs.OrbitProfileStats('Scrubs_MBS_ColValDesc','ScrubsAlerts',stats,versionDate).SubmitStats;
submitStats;			
