...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'gc_id','sub_account_id','hh_id');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'gc_id' => 0,'sub_account_id' => 1,'hh_id' => 2,0);
...
EXPORT Make_sub_account_id(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_sub_account_id(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_sub_account_id(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_hh_id(SALT37.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_hh_id(SALT37.StrType s) := InValidFT_invalid_numeric(s);
