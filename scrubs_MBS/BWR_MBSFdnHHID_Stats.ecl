...
F := Scrubs_MBS.HHID_In_HHID; // Input file
S := Scrubs_MBS.HHID_Scrubs; // My scrubs module
...
//Generating a template to upload rules to Orbit
Scrubs.OrbitProfileStats('Scrubs_MBS_HHID','ScrubsAlerts',stats).ProfileAlertsTemplate;


//Submits stats to Orbit
// submitStats:=Scrubs.OrbitProfileStats('Scrubs_MBS_HHID','ScrubsAlerts',stats,versionDate,'MBS').SubmitStats;
// submitStats;			
