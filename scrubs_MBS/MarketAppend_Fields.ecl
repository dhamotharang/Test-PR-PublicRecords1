...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'company_id','app_type','market','sub_market','vertical','main_country_code','bill_country_code');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'company_id' => 0,'app_type' => 1,'market' => 2,'sub_market' => 3,'vertical' => 4,'main_country_code' => 5,'bill_country_code' => 6,0);

//Individual field level validation


EXPORT Make_company_id(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_company_id(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_company_id(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_app_type(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_app_type(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_app_type(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_market(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_market(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_market(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_sub_market(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_sub_market(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_sub_market(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_vertical(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_vertical(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_vertical(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_main_country_code(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_main_country_code(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_main_country_code(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);


EXPORT Make_bill_country_code(SALT37.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_bill_country_code(SALT37.StrType s) := InValidFT_invalid_alphanumeric(s);
