...
IMPORT SALT311;
EXPORT MasterIdIndTypeIncl_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:user_added:TYPE(STRING30):LIKE(invalid_email):0,0\n'
    + 'FIELD:date_changed:TYPE(STRING20):LIKE(invalid_date):0,0\n'
    + 'FIELD:user_changed:TYPE(STRING30):LIKE(invalid_email):0,0\n'
