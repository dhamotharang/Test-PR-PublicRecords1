import ut, VersionControl,lib_stringlib,lib_fileservices,_control,did_add,_validate, address, NID, header;
...
ut.MAC_SF_BuildProcess(NewVer,Superfile_List().Flag, PostIt ,2,,true,pVersion:=version);
