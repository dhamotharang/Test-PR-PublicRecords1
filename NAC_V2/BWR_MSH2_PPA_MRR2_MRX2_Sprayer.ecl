...
#workunit('name', 'NAC2 PPA MRR2/MRX2 Sprayer');
#workunit('protect', true);
// ------------------------------------------------------------------------------------------------
string		gLandingZoneServer		:=	'uspr-edata10.risk.regn.net';
string		gLandingZonePathBase	:=	'/data/rin_ppa';
...
string		gLandingZoneInclude		:=	'^([a-z]{2}[0-9]{2})/incoming/mr.2_\\1_';		// Back-reference \\1 to ensure that filename contains same GroupID token as directory containing it.
string		gTargetThor						:=	'thor400_44';
string		gWorkingDirBase				:=	'/data/rin_ppa/data_ops';
...
/////////////////////////////////////////
zGo	: when(cron('7-59/15 * * * *')), failure(Std.System.Email.SendEmail('tony.kirk@lexisnexis.com', 'NAC2 MSH2 PPA MRR2 MRX2 Sprayer Failed', 'NAC2 MSH2 MRR2 PPA MRX2 Sprayer Failed'));
zGo	:	when(event('NAC2Event: PPA MRR2 MRX2 Sprayer Go Now', '*')), failure(STD.System.Email.SendEmail('tony.kirk@lexisnexisrisk.com', 'NAC2 MSH2 MRR2 PPA MRX2 Sprayer Failed', 'NAC2 MSH2 MRR2 PPA MRX2 Sprayer Failed'));
