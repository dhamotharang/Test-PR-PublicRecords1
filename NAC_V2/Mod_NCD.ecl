...
module
	////////////////////////////////////////////////////////////////////////
	shared	dFieldStats	:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).ValidationResults;
	...
	transform
		...
		self.CodeCount			:=	case(pInput.Code,
																 ...
																 ContributionTotalRecords			=>	intformat(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal, 12, 1),
																 ContributionAcceptedRecords	=>	intformat(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal - NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsRejected, 12, 1),
																 ContributionRejectedRecords	=>	intformat(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsRejected, 12, 1),
																 ContributionWarningsCount		=>	intformat(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).WarningCount, 12, 1),
																 ContributionErrorsCount			=>	intformat(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).ErrorCount, 12, 1),
		...
		self.CodePercent		:=	fFixPercent8(case(pInput.Code,
																							...
																							ContributionAcceptedRecords	=>	((NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal - NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsRejected) / NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal) * 100,
																							ContributionRejectedRecords	=>	(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsRejected / NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal) * 100,
		...
		self.SampleValue		:=	case(pInput.Code,
																 ContributionFileName				=>	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).FileName,
																 ContributionIsFileAccepted	=>	if(NAC_V2.Mod_Stats.ValidateInputFields(pFileName).Accepted = 'Y', 'YES', 'NO'),
																 ''
																);
	end;
	...
	////////////////////////////////////////////////////////////////////////
	NAC_V2.Layouts.NCD	tJoined(dNCD_Inline pNCD_Inline, dFieldStats pFieldStats) :=
	transform
	...
	////////////////////////////////////////////////////////////////////////
	dNCMBasis	:=	dataset([{'', '', '', '', '', '', '', '', ''}], NAC_V2.Layouts.NCM);
	NAC_V2.Layouts.NCM	tNCM(dNCMBasis pInput)	:=
	transform
		self.FileName					:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).FileName;
		self.State						:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).FileName[1..2];
		self.FileDate					:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).FileName[8..15];
		self.FileTime					:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).FileName[17..22];
		self.IsAccepted				:=	NAC_V2.Mod_Stats.ValidateInputFields(pFileName).Accepted;
		self.RecordsTotal			:=	(string)NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsTotal;
		self.RecordsRejected	:=	(string)NAC_V2.Mod_Stats.ValidateInputFields(pFileName).RecordsRejected;
		self.ErrorCount				:=	(string)NAC_V2.Mod_Stats.ValidateInputFields(pFileName).ErrorCount;
		self.WarningCount			:=	(string)NAC_V2.Mod_Stats.ValidateInputFields(pFileName).WarningCount;
	end;
	...
	////////////////////////////////////////////////////////////////////////
	shared	lNCDFileName				:=	'nac::out::' + regexreplace('_NCF_', pFileName[2..], '_NCD_');
	shared	lNCMFileName				:=	'nac::out::' + regexreplace('_NCF_', pFileName[2..], '_NCM_');
	export	ProcOutputNCDFile		:=	parallel(
																						output(dNCDReport, , '~' + lNCDFileName, compressed,overwrite)
