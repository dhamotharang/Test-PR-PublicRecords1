...
#workunit('name','Scrubs_Database_USA.Input_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_Database_USA,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Database_USA.Input_In_Database_USA;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Database_USA.Input_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Input_Layout_Database_USA'),NAMED('OptimizedLayout'));// File layout suggested by data
