IMPORT SALT311,STD;
EXPORT Base_hygiene(dataset(Base_layout_Database_USA) h) := MODULE
...
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.FldNo := C;
END;
SHARED FldInv0 := NORMALIZE(h,139,Into(LEFT,COUNTER));
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),139*139,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dt_first_seen'}
      ...
      ,{5,'process_date'}
      ,{6,'record_type'}
      ,{7,'accounting_expenses_code'}
      ,{8,'advertising_expenses_code'}
      ,{9,'bus_insurance_expense_code'}
      ,{10,'business_status_code'}
      ,{11,'business_status_desc'}
      ,{12,'city_population_code'}
      ,{13,'city_population_descr'}
      ,{14,'company_name'}
      ,{15,'corporate_employee_code'}
      ,{16,'corporate_employee_desc'}
      ,{17,'county_code'}
      ,{18,'creditcode'}
      ,{19,'credit_desc'}
      ,{20,'credit_capacity_code'}
      ,{21,'credit_capacity_desc'}
      ,{22,'db_cons_age'}
      ,{23,'db_cons_child_near_hs_grad'}
      ,{24,'db_cons_children_present'}
      ,{25,'db_cons_college_graduate'}
      ,{26,'db_cons_credit_card_user'}
      ,{27,'db_cons_date_of_birth_month'}
      ,{28,'db_cons_date_of_birth_year'}
      ,{29,'db_cons_discretincomecode'}
      ,{30,'db_cons_discretincomedesc'}
      ,{31,'db_cons_dnc'}
      ,{32,'db_cons_donor_capacity_code'}
      ,{33,'db_cons_donor_capacity_desc'}
      ,{34,'db_cons_dwelling_type'}
      ,{35,'db_cons_education_hh'}
      ,{36,'db_cons_education_ind'}
      ,{37,'db_cons_email'}
      ,{38,'db_cons_ethnic_code'}
      ,{39,'db_cons_full_name'}
      ,{40,'db_cons_gender'}
      ,{41,'db_cons_home_owner_renter'}
      ,{42,'db_cons_home_property_type'}
      ,{43,'db_cons_home_sqft_ranges'}
      ,{44,'db_cons_home_value_code'}
      ,{45,'db_cons_home_value_desc'}
      ,{46,'db_cons_home_year_built'}
      ,{47,'db_cons_income_code'}
      ,{48,'db_cons_income_desc'}
      ,{49,'db_cons_intend_purchase_veh'}
      ,{50,'db_cons_language_pref'}
      ,{51,'db_cons_length_of_res_code'}
      ,{52,'db_cons_length_of_res_desc'}
      ,{53,'db_cons_marital_status'}
      ,{54,'db_cons_networthhomevalcode'}
      ,{55,'db_cons_net_worth_desc'}
      ,{56,'db_cons_new_parent'}
      ,{57,'db_cons_new_teen_driver'}
      ,{58,'db_cons_newlywed'}
      ,{59,'db_cons_occupation_ind'}
      ,{60,'db_cons_other_pet_owner'}
      ,{61,'db_cons_phone'}
      ,{62,'db_cons_poli_party_ind'}
      ,{63,'db_cons_recent_divorce'}
      ,{64,'db_cons_recent_home_buyer'}
      ,{65,'db_cons_religious_affil'}
      ,{66,'db_cons_scrubbed_phoneable'}
      ,{67,'db_cons_time_zone_code'}
      ,{68,'db_cons_time_zone_desc'}
      ,{69,'db_cons_unsecuredcredcapcode'}
      ,{70,'db_cons_unsecuredcredcapdesc'}
      ,{71,'domestic_foreign_owner_flag'}
      ,{72,'email'}
      ,{73,'email_available_indicator'}
      ,{74,'exec_type'}
      ,{75,'executive_level'}
      ,{76,'executive_title_rank'}
      ,{77,'expense_accounting_desc'}
      ,{78,'expense_advertising_desc'}
      ,{79,'expense_bus_insurance_desc'}
      ,{80,'expense_legal_desc'}
      ,{81,'expense_office_equip_desc'}
      ,{82,'expense_rent_desc'}
      ,{83,'expense_technology_desc'}
      ,{84,'expense_telecom_desc'}
      ,{85,'expense_utilities_desc'}
      ,{86,'female_owned'}
      ,{87,'franchise_flag'}
      ,{88,'franchise_type'}
      ,{89,'full_name'}
      ,{90,'gender'}
      ,{91,'home_based_indicator'}
      ,{92,'import_export'}
      ,{93,'ind_frm_indicator'}
      ,{94,'legal_expenses_code'}
      ,{95,'location_employee_code'}
      ,{96,'location_employee_desc'}
      ,{97,'location_sales_code'}
      ,{98,'location_sales_desc'}
      ,{99,'mail_addr_state'}
      ,{100,'mail_addr_zip'}
      ,{101,'mail_score'}
      ,{102,'manufacturing_location'}
      ,{103,'minority_owned_flag'}
      ,{104,'minority_type'}
      ,{105,'naics01'}
      ,{106,'naics02'}
      ,{107,'naics03'}
      ...
      ,{111,'nb_flag'}
      ,{112,'non_profit_org'}
      ,{113,'number_of_pcs_code'}
      ,{114,'number_of_pcs_desc'}
      ,{115,'office_equip_expenses_code'}
      ,{116,'phone'}
      ,{117,'phy_addr_state'}
      ,{118,'phy_addr_zip'}
      ,{119,'primary_exec_flag'}
      ,{120,'primary_sic'}
      ,{121,'primarysic2'}
      ,{122,'primarysic4'}
      ,{123,'public_indicator'}
      ,{124,'rent_expenses_code'}
      ,{125,'sic02'}
      ,{126,'sic03'}
      ,{127,'sic04'}
      ,{128,'sic05'}
      ,{129,'sic06'}
      ,{130,'small_business_indicator'}
      ,{131,'square_footage_code'}
      ,{132,'square_footage_desc'}
      ,{133,'standardized_title'}
      ,{134,'technology_expenses_code'}
      ,{135,'telecom_expenses_code'}
      ,{136,'url'}
      ,{137,'utilities_expenses_code'}
      ,{138,'year_established'}
      ,{139,'years_in_business_range'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_business_status_desc((SALT311.StrType)le.business_status_desc,(SALT311.StrType)le.business_status_code),
    Base_Fields.InValid_city_population_code((SALT311.StrType)le.city_population_code),
    Base_Fields.InValid_city_population_descr((SALT311.StrType)le.city_population_descr,(SALT311.StrType)le.city_population_code),
    ...
    Base_Fields.InValid_corporate_employee_desc((SALT311.StrType)le.corporate_employee_desc,(SALT311.StrType)le.corporate_employee_code),
    ...
    Base_Fields.InValid_credit_desc((SALT311.StrType)le.credit_desc,(SALT311.StrType)le.creditcode),
    Base_Fields.InValid_credit_capacity_code((SALT311.StrType)le.credit_capacity_code),
    Base_Fields.InValid_credit_capacity_desc((SALT311.StrType)le.credit_capacity_desc,(SALT311.StrType)le.credit_capacity_code),
    ...
    Base_Fields.InValid_db_cons_discretincomedesc((SALT311.StrType)le.db_cons_discretincomedesc,(SALT311.StrType)le.db_cons_discretincomecode),
    ...
    Base_Fields.InValid_db_cons_donor_capacity_desc((SALT311.StrType)le.db_cons_donor_capacity_desc,(SALT311.StrType)le.db_cons_donor_capacity_code),
    ...
    Base_Fields.InValid_db_cons_home_value_desc((SALT311.StrType)le.db_cons_home_value_desc,(SALT311.StrType)le.db_cons_home_value_code),
    ...
    Base_Fields.InValid_db_cons_income_desc((SALT311.StrType)le.db_cons_income_desc,(SALT311.StrType)le.db_cons_income_code),
    ...
    Base_Fields.InValid_db_cons_length_of_res_desc((SALT311.StrType)le.db_cons_length_of_res_desc,(SALT311.StrType)le.db_cons_length_of_res_code),
    ...
    Base_Fields.InValid_db_cons_net_worth_desc((SALT311.StrType)le.db_cons_net_worth_desc,(SALT311.StrType)le.db_cons_networthhomevalcode),
    ...
    Base_Fields.InValid_db_cons_time_zone_desc((SALT311.StrType)le.db_cons_time_zone_desc),
    Base_Fields.InValid_db_cons_unsecuredcredcapcode((SALT311.StrType)le.db_cons_unsecuredcredcapcode),
    Base_Fields.InValid_db_cons_unsecuredcredcapdesc((SALT311.StrType)le.db_cons_unsecuredcredcapdesc,(SALT311.StrType)le.db_cons_unsecuredcredcapcode),
    ...
    Base_Fields.InValid_executive_level((SALT311.StrType)le.executive_level),
    Base_Fields.InValid_executive_title_rank((SALT311.StrType)le.executive_title_rank),
    Base_Fields.InValid_expense_accounting_desc((SALT311.StrType)le.expense_accounting_desc,(SALT311.StrType)le.accounting_expenses_code),
    Base_Fields.InValid_expense_advertising_desc((SALT311.StrType)le.expense_advertising_desc,(SALT311.StrType)le.advertising_expenses_code),
    Base_Fields.InValid_expense_bus_insurance_desc((SALT311.StrType)le.expense_bus_insurance_desc,(SALT311.StrType)le.bus_insurance_expense_code),
    Base_Fields.InValid_expense_legal_desc((SALT311.StrType)le.expense_legal_desc,(SALT311.StrType)le.legal_expenses_code),
    Base_Fields.InValid_expense_office_equip_desc((SALT311.StrType)le.expense_office_equip_desc,(SALT311.StrType)le.office_equip_expenses_code),
    Base_Fields.InValid_expense_rent_desc((SALT311.StrType)le.expense_rent_desc,(SALT311.StrType)le.rent_expenses_code),
    Base_Fields.InValid_expense_technology_desc((SALT311.StrType)le.expense_technology_desc,(SALT311.StrType)le.technology_expenses_code),
    Base_Fields.InValid_expense_telecom_desc((SALT311.StrType)le.expense_telecom_desc,(SALT311.StrType)le.telecom_expenses_code),
    Base_Fields.InValid_expense_utilities_desc((SALT311.StrType)le.expense_utilities_desc,(SALT311.StrType)le.utilities_expenses_code),
    ...
    Base_Fields.InValid_location_employee_desc((SALT311.StrType)le.location_employee_desc,(SALT311.StrType)le.location_employee_code),
    Base_Fields.InValid_location_sales_code((SALT311.StrType)le.location_sales_code),
    Base_Fields.InValid_location_sales_desc((SALT311.StrType)le.location_sales_desc,(SALT311.StrType)le.location_sales_code),
    ...
    Base_Fields.InValid_minority_type((SALT311.StrType)le.minority_type),
    ...
    Base_Fields.InValid_number_of_pcs_desc((SALT311.StrType)le.number_of_pcs_desc,(SALT311.StrType)le.number_of_pcs_code),
    ...
    Base_Fields.InValid_square_footage_desc((SALT311.StrType)le.square_footage_desc,(SALT311.StrType)le.square_footage_code),
    Base_Fields.InValid_standardized_title((SALT311.StrType)le.standardized_title,(SALT311.StrType)le.executive_title_rank),
    ...
    Base_Fields.InValid_years_in_business_range((SALT311.StrType)le.years_in_business_range),
    0);
  SELF.FieldNum := IF(SELF.ErrorNum=0,SKIP,c); // Bail early to avoid creating record
END;
Errors := NORMALIZE(h,139,NoteErrors(LEFT,COUNTER));
...
PrettyErrorTotals := RECORD
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Base_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Base_Fields.InValidMessage_record_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_accounting_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_advertising_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_bus_insurance_expense_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_business_status_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_business_status_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_city_population_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_city_population_descr(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_corporate_employee_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_corporate_employee_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_county_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_creditcode(TotalErrors.ErrorNum),Base_Fields.InValidMessage_credit_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_credit_capacity_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_credit_capacity_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_age(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_child_near_hs_grad(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_children_present(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_college_graduate(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_credit_card_user(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_date_of_birth_month(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_date_of_birth_year(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_discretincomecode(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_discretincomedesc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_dnc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_donor_capacity_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_donor_capacity_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_dwelling_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_education_hh(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_education_ind(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_email(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_ethnic_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_full_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_gender(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_owner_renter(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_property_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_sqft_ranges(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_value_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_value_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_home_year_built(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_income_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_income_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_intend_purchase_veh(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_language_pref(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_length_of_res_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_length_of_res_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_marital_status(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_networthhomevalcode(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_net_worth_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_new_parent(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_new_teen_driver(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_newlywed(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_occupation_ind(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_other_pet_owner(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_phone(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_poli_party_ind(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_recent_divorce(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_recent_home_buyer(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_religious_affil(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_scrubbed_phoneable(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_time_zone_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_time_zone_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_unsecuredcredcapcode(TotalErrors.ErrorNum),Base_Fields.InValidMessage_db_cons_unsecuredcredcapdesc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_domestic_foreign_owner_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_email(TotalErrors.ErrorNum),Base_Fields.InValidMessage_email_available_indicator(TotalErrors.ErrorNum),Base_Fields.InValidMessage_exec_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_executive_level(TotalErrors.ErrorNum),Base_Fields.InValidMessage_executive_title_rank(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_accounting_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_advertising_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_bus_insurance_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_legal_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_office_equip_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_rent_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_technology_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_telecom_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_expense_utilities_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_female_owned(TotalErrors.ErrorNum),Base_Fields.InValidMessage_franchise_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_franchise_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_full_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_gender(TotalErrors.ErrorNum),Base_Fields.InValidMessage_home_based_indicator(TotalErrors.ErrorNum),Base_Fields.InValidMessage_import_export(TotalErrors.ErrorNum),Base_Fields.InValidMessage_ind_frm_indicator(TotalErrors.ErrorNum),Base_Fields.InValidMessage_legal_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_location_employee_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_location_employee_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_location_sales_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_location_sales_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_mail_addr_state(TotalErrors.ErrorNum),Base_Fields.InValidMessage_mail_addr_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_mail_score(TotalErrors.ErrorNum),Base_Fields.InValidMessage_manufacturing_location(TotalErrors.ErrorNum),Base_Fields.InValidMessage_minority_owned_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_minority_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics01(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics02(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics03(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics04(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics05(TotalErrors.ErrorNum),Base_Fields.InValidMessage_naics06(TotalErrors.ErrorNum),Base_Fields.InValidMessage_nb_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_non_profit_org(TotalErrors.ErrorNum),Base_Fields.InValidMessage_number_of_pcs_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_number_of_pcs_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_office_equip_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Base_Fields.InValidMessage_phy_addr_state(TotalErrors.ErrorNum),Base_Fields.InValidMessage_phy_addr_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_primary_exec_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_primary_sic(TotalErrors.ErrorNum),Base_Fields.InValidMessage_primarysic2(TotalErrors.ErrorNum),Base_Fields.InValidMessage_primarysic4(TotalErrors.ErrorNum),Base_Fields.InValidMessage_public_indicator(TotalErrors.ErrorNum),Base_Fields.InValidMessage_rent_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sic02(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sic03(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sic04(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sic05(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sic06(TotalErrors.ErrorNum),Base_Fields.InValidMessage_small_business_indicator(TotalErrors.ErrorNum),Base_Fields.InValidMessage_square_footage_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_square_footage_desc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_standardized_title(TotalErrors.ErrorNum),Base_Fields.InValidMessage_technology_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_telecom_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_url(TotalErrors.ErrorNum),Base_Fields.InValidMessage_utilities_expenses_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_year_established(TotalErrors.ErrorNum),Base_Fields.InValidMessage_years_in_business_range(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
