...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(Base_Layout_Database_USA)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Base_Layout_Database_USA)
    UNSIGNED8 ScrubsBits1;
    UNSIGNED8 ScrubsBits2;
    UNSIGNED8 ScrubsBits3;
  END;
EXPORT FromNone(DATASET(Base_Layout_Database_USA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.business_status_desc_Invalid := Base_Fields.InValid_business_status_desc((SALT311.StrType)le.business_status_desc,(SALT311.StrType)le.business_status_code);
    SELF.city_population_code_Invalid := Base_Fields.InValid_city_population_code((SALT311.StrType)le.city_population_code);
    SELF.city_population_descr_Invalid := Base_Fields.InValid_city_population_descr((SALT311.StrType)le.city_population_descr,(SALT311.StrType)le.city_population_code);
    ...
    SELF.corporate_employee_desc_Invalid := Base_Fields.InValid_corporate_employee_desc((SALT311.StrType)le.corporate_employee_desc,(SALT311.StrType)le.corporate_employee_code);
    ...
    SELF.credit_desc_Invalid := Base_Fields.InValid_credit_desc((SALT311.StrType)le.credit_desc,(SALT311.StrType)le.creditcode);
    SELF.credit_capacity_code_Invalid := Base_Fields.InValid_credit_capacity_code((SALT311.StrType)le.credit_capacity_code);
    SELF.credit_capacity_desc_Invalid := Base_Fields.InValid_credit_capacity_desc((SALT311.StrType)le.credit_capacity_desc,(SALT311.StrType)le.credit_capacity_code);
    ...
    SELF.db_cons_discretincomedesc_Invalid := Base_Fields.InValid_db_cons_discretincomedesc((SALT311.StrType)le.db_cons_discretincomedesc,(SALT311.StrType)le.db_cons_discretincomecode);
    ...
    SELF.db_cons_donor_capacity_desc_Invalid := Base_Fields.InValid_db_cons_donor_capacity_desc((SALT311.StrType)le.db_cons_donor_capacity_desc,(SALT311.StrType)le.db_cons_donor_capacity_code);
    ...
    SELF.db_cons_home_value_desc_Invalid := Base_Fields.InValid_db_cons_home_value_desc((SALT311.StrType)le.db_cons_home_value_desc,(SALT311.StrType)le.db_cons_home_value_code);
    ...
    SELF.db_cons_income_desc_Invalid := Base_Fields.InValid_db_cons_income_desc((SALT311.StrType)le.db_cons_income_desc,(SALT311.StrType)le.db_cons_income_code);
    ...
    SELF.db_cons_length_of_res_desc_Invalid := Base_Fields.InValid_db_cons_length_of_res_desc((SALT311.StrType)le.db_cons_length_of_res_desc,(SALT311.StrType)le.db_cons_length_of_res_code);
    ...
    SELF.db_cons_net_worth_desc_Invalid := Base_Fields.InValid_db_cons_net_worth_desc((SALT311.StrType)le.db_cons_net_worth_desc,(SALT311.StrType)le.db_cons_networthhomevalcode);
    ...
    SELF.db_cons_time_zone_desc_Invalid := Base_Fields.InValid_db_cons_time_zone_desc((SALT311.StrType)le.db_cons_time_zone_desc);
    ...
    SELF.db_cons_unsecuredcredcapdesc_Invalid := Base_Fields.InValid_db_cons_unsecuredcredcapdesc((SALT311.StrType)le.db_cons_unsecuredcredcapdesc,(SALT311.StrType)le.db_cons_unsecuredcredcapcode);
    ...
    SELF.executive_level_Invalid := Base_Fields.InValid_executive_level((SALT311.StrType)le.executive_level);
    SELF.executive_title_rank_Invalid := Base_Fields.InValid_executive_title_rank((SALT311.StrType)le.executive_title_rank);
    SELF.expense_accounting_desc_Invalid := Base_Fields.InValid_expense_accounting_desc((SALT311.StrType)le.expense_accounting_desc,(SALT311.StrType)le.accounting_expenses_code);
    SELF.expense_advertising_desc_Invalid := Base_Fields.InValid_expense_advertising_desc((SALT311.StrType)le.expense_advertising_desc,(SALT311.StrType)le.advertising_expenses_code);
    SELF.expense_bus_insurance_desc_Invalid := Base_Fields.InValid_expense_bus_insurance_desc((SALT311.StrType)le.expense_bus_insurance_desc,(SALT311.StrType)le.bus_insurance_expense_code);
    SELF.expense_legal_desc_Invalid := Base_Fields.InValid_expense_legal_desc((SALT311.StrType)le.expense_legal_desc,(SALT311.StrType)le.legal_expenses_code);
    SELF.expense_office_equip_desc_Invalid := Base_Fields.InValid_expense_office_equip_desc((SALT311.StrType)le.expense_office_equip_desc,(SALT311.StrType)le.office_equip_expenses_code);
    SELF.expense_rent_desc_Invalid := Base_Fields.InValid_expense_rent_desc((SALT311.StrType)le.expense_rent_desc,(SALT311.StrType)le.rent_expenses_code);
    SELF.expense_technology_desc_Invalid := Base_Fields.InValid_expense_technology_desc((SALT311.StrType)le.expense_technology_desc,(SALT311.StrType)le.technology_expenses_code);
    SELF.expense_telecom_desc_Invalid := Base_Fields.InValid_expense_telecom_desc((SALT311.StrType)le.expense_telecom_desc,(SALT311.StrType)le.telecom_expenses_code);
    SELF.expense_utilities_desc_Invalid := Base_Fields.InValid_expense_utilities_desc((SALT311.StrType)le.expense_utilities_desc,(SALT311.StrType)le.utilities_expenses_code);
    ...
    SELF.location_employee_desc_Invalid := Base_Fields.InValid_location_employee_desc((SALT311.StrType)le.location_employee_desc,(SALT311.StrType)le.location_employee_code);
    SELF.location_sales_code_Invalid := Base_Fields.InValid_location_sales_code((SALT311.StrType)le.location_sales_code);
    SELF.location_sales_desc_Invalid := Base_Fields.InValid_location_sales_desc((SALT311.StrType)le.location_sales_desc,(SALT311.StrType)le.location_sales_code);
    ...
    SELF.minority_type_Invalid := Base_Fields.InValid_minority_type((SALT311.StrType)le.minority_type);
    ...
    SELF.number_of_pcs_desc_Invalid := Base_Fields.InValid_number_of_pcs_desc((SALT311.StrType)le.number_of_pcs_desc,(SALT311.StrType)le.number_of_pcs_code);
    ...
    SELF.square_footage_desc_Invalid := Base_Fields.InValid_square_footage_desc((SALT311.StrType)le.square_footage_desc,(SALT311.StrType)le.square_footage_code);
    SELF.standardized_title_Invalid := Base_Fields.InValid_standardized_title((SALT311.StrType)le.standardized_title,(SALT311.StrType)le.executive_title_rank);
    ...
    SELF.years_in_business_range_Invalid := Base_Fields.InValid_years_in_business_range((SALT311.StrType)le.years_in_business_range);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Base_Layout_Database_USA);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_first_seen_Invalid << 0 ) + ( le.dt_last_seen_Invalid << 1 ) + ( le.dt_vendor_first_reported_Invalid << 2 ) + ( le.dt_vendor_last_reported_Invalid << 3 ) + ( le.process_date_Invalid << 4 ) + ( le.record_type_Invalid << 5 ) + ( le.accounting_expenses_code_Invalid << 6 ) + ( le.advertising_expenses_code_Invalid << 7 ) + ( le.bus_insurance_expense_code_Invalid << 8 ) + ( le.business_status_code_Invalid << 9 ) + ( le.business_status_desc_Invalid << 10 ) + ( le.city_population_code_Invalid << 11 ) + ( le.city_population_descr_Invalid << 12 ) + ( le.company_name_Invalid << 13 ) + ( le.corporate_employee_code_Invalid << 14 ) + ( le.corporate_employee_desc_Invalid << 15 ) + ( le.county_code_Invalid << 16 ) + ( le.creditcode_Invalid << 17 ) + ( le.credit_desc_Invalid << 18 ) + ( le.credit_capacity_code_Invalid << 19 ) + ( le.credit_capacity_desc_Invalid << 20 ) + ( le.db_cons_age_Invalid << 21 ) + ( le.db_cons_child_near_hs_grad_Invalid << 22 ) + ( le.db_cons_children_present_Invalid << 23 ) + ( le.db_cons_college_graduate_Invalid << 24 ) + ( le.db_cons_credit_card_user_Invalid << 25 ) + ( le.db_cons_date_of_birth_month_Invalid << 26 ) + ( le.db_cons_date_of_birth_year_Invalid << 27 ) + ( le.db_cons_discretincomecode_Invalid << 28 ) + ( le.db_cons_discretincomedesc_Invalid << 29 ) + ( le.db_cons_dnc_Invalid << 30 ) + ( le.db_cons_donor_capacity_code_Invalid << 31 ) + ( le.db_cons_donor_capacity_desc_Invalid << 32 ) + ( le.db_cons_dwelling_type_Invalid << 33 ) + ( le.db_cons_education_hh_Invalid << 34 ) + ( le.db_cons_education_ind_Invalid << 35 ) + ( le.db_cons_email_Invalid << 36 ) + ( le.db_cons_ethnic_code_Invalid << 37 ) + ( le.db_cons_full_name_Invalid << 38 ) + ( le.db_cons_gender_Invalid << 39 ) + ( le.db_cons_home_owner_renter_Invalid << 40 ) + ( le.db_cons_home_property_type_Invalid << 41 ) + ( le.db_cons_home_sqft_ranges_Invalid << 42 ) + ( le.db_cons_home_value_code_Invalid << 43 ) + ( le.db_cons_home_value_desc_Invalid << 44 ) + ( le.db_cons_home_year_built_Invalid << 45 ) + ( le.db_cons_income_code_Invalid << 46 ) + ( le.db_cons_income_desc_Invalid << 47 ) + ( le.db_cons_intend_purchase_veh_Invalid << 48 ) + ( le.db_cons_language_pref_Invalid << 49 ) + ( le.db_cons_length_of_res_code_Invalid << 50 ) + ( le.db_cons_length_of_res_desc_Invalid << 51 ) + ( le.db_cons_marital_status_Invalid << 52 ) + ( le.db_cons_networthhomevalcode_Invalid << 53 ) + ( le.db_cons_net_worth_desc_Invalid << 54 ) + ( le.db_cons_new_parent_Invalid << 55 ) + ( le.db_cons_new_teen_driver_Invalid << 56 ) + ( le.db_cons_newlywed_Invalid << 57 ) + ( le.db_cons_occupation_ind_Invalid << 58 ) + ( le.db_cons_other_pet_owner_Invalid << 59 ) + ( le.db_cons_phone_Invalid << 60 ) + ( le.db_cons_poli_party_ind_Invalid << 61 ) + ( le.db_cons_recent_divorce_Invalid << 62 ) + ( le.db_cons_recent_home_buyer_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.db_cons_religious_affil_Invalid << 0 ) + ( le.db_cons_scrubbed_phoneable_Invalid << 1 ) + ( le.db_cons_time_zone_code_Invalid << 2 ) + ( le.db_cons_time_zone_desc_Invalid << 3 ) + ( le.db_cons_unsecuredcredcapcode_Invalid << 4 ) + ( le.db_cons_unsecuredcredcapdesc_Invalid << 5 ) + ( le.domestic_foreign_owner_flag_Invalid << 6 ) + ( le.email_Invalid << 7 ) + ( le.email_available_indicator_Invalid << 8 ) + ( le.exec_type_Invalid << 9 ) + ( le.executive_level_Invalid << 10 ) + ( le.executive_title_rank_Invalid << 11 ) + ( le.expense_accounting_desc_Invalid << 12 ) + ( le.expense_advertising_desc_Invalid << 13 ) + ( le.expense_bus_insurance_desc_Invalid << 14 ) + ( le.expense_legal_desc_Invalid << 15 ) + ( le.expense_office_equip_desc_Invalid << 16 ) + ( le.expense_rent_desc_Invalid << 17 ) + ( le.expense_technology_desc_Invalid << 18 ) + ( le.expense_telecom_desc_Invalid << 19 ) + ( le.expense_utilities_desc_Invalid << 20 ) + ( le.female_owned_Invalid << 21 ) + ( le.franchise_flag_Invalid << 22 ) + ( le.franchise_type_Invalid << 23 ) + ( le.full_name_Invalid << 24 ) + ( le.gender_Invalid << 25 ) + ( le.home_based_indicator_Invalid << 26 ) + ( le.import_export_Invalid << 27 ) + ( le.ind_frm_indicator_Invalid << 28 ) + ( le.legal_expenses_code_Invalid << 29 ) + ( le.location_employee_code_Invalid << 30 ) + ( le.location_employee_desc_Invalid << 31 ) + ( le.location_sales_code_Invalid << 32 ) + ( le.location_sales_desc_Invalid << 33 ) + ( le.mail_addr_state_Invalid << 34 ) + ( le.mail_addr_zip_Invalid << 35 ) + ( le.mail_score_Invalid << 36 ) + ( le.manufacturing_location_Invalid << 37 ) + ( le.minority_owned_flag_Invalid << 38 ) + ( le.minority_type_Invalid << 39 ) + ( le.naics01_Invalid << 40 ) + ( le.naics02_Invalid << 41 ) + ( le.naics03_Invalid << 42 ) + ( le.naics04_Invalid << 43 ) + ( le.naics05_Invalid << 44 ) + ( le.naics06_Invalid << 45 ) + ( le.nb_flag_Invalid << 46 ) + ( le.non_profit_org_Invalid << 47 ) + ( le.number_of_pcs_code_Invalid << 48 ) + ( le.number_of_pcs_desc_Invalid << 49 ) + ( le.office_equip_expenses_code_Invalid << 50 ) + ( le.phone_Invalid << 51 ) + ( le.phy_addr_state_Invalid << 52 ) + ( le.phy_addr_zip_Invalid << 53 ) + ( le.primary_exec_flag_Invalid << 54 ) + ( le.primary_sic_Invalid << 55 ) + ( le.primarysic2_Invalid << 56 ) + ( le.primarysic4_Invalid << 57 ) + ( le.public_indicator_Invalid << 58 ) + ( le.rent_expenses_code_Invalid << 59 ) + ( le.sic02_Invalid << 60 ) + ( le.sic03_Invalid << 61 ) + ( le.sic04_Invalid << 62 ) + ( le.sic05_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.sic06_Invalid << 0 ) + ( le.small_business_indicator_Invalid << 1 ) + ( le.square_footage_code_Invalid << 2 ) + ( le.square_footage_desc_Invalid << 3 ) + ( le.standardized_title_Invalid << 4 ) + ( le.technology_expenses_code_Invalid << 5 ) + ( le.telecom_expenses_code_Invalid << 6 ) + ( le.url_Invalid << 7 ) + ( le.utilities_expenses_code_Invalid << 8 ) + ( le.year_established_Invalid << 9 ) + ( le.years_in_business_range_Invalid << 10 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Base_Layout_Database_USA);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.accounting_expenses_code_Invalid := (le.ScrubsBits1 >> 6) & 1;
    SELF.advertising_expenses_code_Invalid := (le.ScrubsBits1 >> 7) & 1;
    SELF.bus_insurance_expense_code_Invalid := (le.ScrubsBits1 >> 8) & 1;
    SELF.business_status_code_Invalid := (le.ScrubsBits1 >> 9) & 1;
    SELF.business_status_desc_Invalid := (le.ScrubsBits1 >> 10) & 1;
    SELF.city_population_code_Invalid := (le.ScrubsBits1 >> 11) & 1;
    SELF.city_population_descr_Invalid := (le.ScrubsBits1 >> 12) & 1;
    SELF.company_name_Invalid := (le.ScrubsBits1 >> 13) & 1;
    SELF.corporate_employee_code_Invalid := (le.ScrubsBits1 >> 14) & 1;
    SELF.corporate_employee_desc_Invalid := (le.ScrubsBits1 >> 15) & 1;
    SELF.county_code_Invalid := (le.ScrubsBits1 >> 16) & 1;
    SELF.creditcode_Invalid := (le.ScrubsBits1 >> 17) & 1;
    SELF.credit_desc_Invalid := (le.ScrubsBits1 >> 18) & 1;
    SELF.credit_capacity_code_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.credit_capacity_desc_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.db_cons_age_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.db_cons_child_near_hs_grad_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.db_cons_children_present_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.db_cons_college_graduate_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.db_cons_credit_card_user_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.db_cons_date_of_birth_month_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.db_cons_date_of_birth_year_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.db_cons_discretincomecode_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.db_cons_discretincomedesc_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.db_cons_dnc_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.db_cons_donor_capacity_code_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.db_cons_donor_capacity_desc_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.db_cons_dwelling_type_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.db_cons_education_hh_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.db_cons_education_ind_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.db_cons_email_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.db_cons_ethnic_code_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.db_cons_full_name_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.db_cons_gender_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.db_cons_home_owner_renter_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.db_cons_home_property_type_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.db_cons_home_sqft_ranges_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.db_cons_home_value_code_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.db_cons_home_value_desc_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.db_cons_home_year_built_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.db_cons_income_code_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.db_cons_income_desc_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.db_cons_intend_purchase_veh_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.db_cons_language_pref_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.db_cons_length_of_res_code_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.db_cons_length_of_res_desc_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.db_cons_marital_status_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.db_cons_networthhomevalcode_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.db_cons_net_worth_desc_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.db_cons_new_parent_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.db_cons_new_teen_driver_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.db_cons_newlywed_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.db_cons_occupation_ind_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.db_cons_other_pet_owner_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.db_cons_phone_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.db_cons_poli_party_ind_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.db_cons_recent_divorce_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.db_cons_recent_home_buyer_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.db_cons_religious_affil_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.db_cons_scrubbed_phoneable_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.db_cons_time_zone_code_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.db_cons_time_zone_desc_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.db_cons_unsecuredcredcapcode_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.db_cons_unsecuredcredcapdesc_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.domestic_foreign_owner_flag_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.email_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.email_available_indicator_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.exec_type_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.executive_level_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.executive_title_rank_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.expense_accounting_desc_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.expense_advertising_desc_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.expense_bus_insurance_desc_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.expense_legal_desc_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.expense_office_equip_desc_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.expense_rent_desc_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.expense_technology_desc_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.expense_telecom_desc_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.expense_utilities_desc_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.female_owned_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.franchise_flag_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.franchise_type_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.full_name_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.gender_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.home_based_indicator_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.import_export_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.ind_frm_indicator_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.legal_expenses_code_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.location_employee_code_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.location_employee_desc_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.location_sales_code_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF.location_sales_desc_Invalid := (le.ScrubsBits2 >> 33) & 1;
    SELF.mail_addr_state_Invalid := (le.ScrubsBits2 >> 34) & 1;
    SELF.mail_addr_zip_Invalid := (le.ScrubsBits2 >> 35) & 1;
    SELF.mail_score_Invalid := (le.ScrubsBits2 >> 36) & 1;
    SELF.manufacturing_location_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF.minority_owned_flag_Invalid := (le.ScrubsBits2 >> 38) & 1;
    SELF.minority_type_Invalid := (le.ScrubsBits2 >> 39) & 1;
    SELF.naics01_Invalid := (le.ScrubsBits2 >> 40) & 1;
    SELF.naics02_Invalid := (le.ScrubsBits2 >> 41) & 1;
    SELF.naics03_Invalid := (le.ScrubsBits2 >> 42) & 1;
    SELF.naics04_Invalid := (le.ScrubsBits2 >> 43) & 1;
    SELF.naics05_Invalid := (le.ScrubsBits2 >> 44) & 1;
    SELF.naics06_Invalid := (le.ScrubsBits2 >> 45) & 1;
    SELF.nb_flag_Invalid := (le.ScrubsBits2 >> 46) & 1;
    SELF.non_profit_org_Invalid := (le.ScrubsBits2 >> 47) & 1;
    SELF.number_of_pcs_code_Invalid := (le.ScrubsBits2 >> 48) & 1;
    SELF.number_of_pcs_desc_Invalid := (le.ScrubsBits2 >> 49) & 1;
    SELF.office_equip_expenses_code_Invalid := (le.ScrubsBits2 >> 50) & 1;
    SELF.phone_Invalid := (le.ScrubsBits2 >> 51) & 1;
    SELF.phy_addr_state_Invalid := (le.ScrubsBits2 >> 52) & 1;
    SELF.phy_addr_zip_Invalid := (le.ScrubsBits2 >> 53) & 1;
    SELF.primary_exec_flag_Invalid := (le.ScrubsBits2 >> 54) & 1;
    SELF.primary_sic_Invalid := (le.ScrubsBits2 >> 55) & 1;
    SELF.primarysic2_Invalid := (le.ScrubsBits2 >> 56) & 1;
    SELF.primarysic4_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.public_indicator_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.rent_expenses_code_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.sic02_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.sic03_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.sic04_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.sic05_Invalid := (le.ScrubsBits2 >> 63) & 1;
    SELF.sic06_Invalid := (le.ScrubsBits3 >> 0) & 1;
    SELF.small_business_indicator_Invalid := (le.ScrubsBits3 >> 1) & 1;
    SELF.square_footage_code_Invalid := (le.ScrubsBits3 >> 2) & 1;
    SELF.square_footage_desc_Invalid := (le.ScrubsBits3 >> 3) & 1;
    SELF.standardized_title_Invalid := (le.ScrubsBits3 >> 4) & 1;
    SELF.technology_expenses_code_Invalid := (le.ScrubsBits3 >> 5) & 1;
    SELF.telecom_expenses_code_Invalid := (le.ScrubsBits3 >> 6) & 1;
    SELF.url_Invalid := (le.ScrubsBits3 >> 7) & 1;
    SELF.utilities_expenses_code_Invalid := (le.ScrubsBits3 >> 8) & 1;
    SELF.year_established_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.years_in_business_range_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.dt_first_seen_Invalid,le.dt_last_seen_Invalid,le.dt_vendor_first_reported_Invalid,le.dt_vendor_last_reported_Invalid,le.process_date_Invalid,le.record_type_Invalid,le.accounting_expenses_code_Invalid,le.advertising_expenses_code_Invalid,le.bus_insurance_expense_code_Invalid,le.business_status_code_Invalid,le.business_status_desc_Invalid,le.city_population_code_Invalid,le.city_population_descr_Invalid,le.company_name_Invalid,le.corporate_employee_code_Invalid,le.corporate_employee_desc_Invalid,le.county_code_Invalid,le.creditcode_Invalid,le.credit_desc_Invalid,le.credit_capacity_code_Invalid,le.credit_capacity_desc_Invalid,le.db_cons_age_Invalid,le.db_cons_child_near_hs_grad_Invalid,le.db_cons_children_present_Invalid,le.db_cons_college_graduate_Invalid,le.db_cons_credit_card_user_Invalid,le.db_cons_date_of_birth_month_Invalid,le.db_cons_date_of_birth_year_Invalid,le.db_cons_discretincomecode_Invalid,le.db_cons_discretincomedesc_Invalid,le.db_cons_dnc_Invalid,le.db_cons_donor_capacity_code_Invalid,le.db_cons_donor_capacity_desc_Invalid,le.db_cons_dwelling_type_Invalid,le.db_cons_education_hh_Invalid,le.db_cons_education_ind_Invalid,le.db_cons_email_Invalid,le.db_cons_ethnic_code_Invalid,le.db_cons_full_name_Invalid,le.db_cons_gender_Invalid,le.db_cons_home_owner_renter_Invalid,le.db_cons_home_property_type_Invalid,le.db_cons_home_sqft_ranges_Invalid,le.db_cons_home_value_code_Invalid,le.db_cons_home_value_desc_Invalid,le.db_cons_home_year_built_Invalid,le.db_cons_income_code_Invalid,le.db_cons_income_desc_Invalid,le.db_cons_intend_purchase_veh_Invalid,le.db_cons_language_pref_Invalid,le.db_cons_length_of_res_code_Invalid,le.db_cons_length_of_res_desc_Invalid,le.db_cons_marital_status_Invalid,le.db_cons_networthhomevalcode_Invalid,le.db_cons_net_worth_desc_Invalid,le.db_cons_new_parent_Invalid,le.db_cons_new_teen_driver_Invalid,le.db_cons_newlywed_Invalid,le.db_cons_occupation_ind_Invalid,le.db_cons_other_pet_owner_Invalid,le.db_cons_phone_Invalid,le.db_cons_poli_party_ind_Invalid,le.db_cons_recent_divorce_Invalid,le.db_cons_recent_home_buyer_Invalid,le.db_cons_religious_affil_Invalid,le.db_cons_scrubbed_phoneable_Invalid,le.db_cons_time_zone_code_Invalid,le.db_cons_time_zone_desc_Invalid,le.db_cons_unsecuredcredcapcode_Invalid,le.db_cons_unsecuredcredcapdesc_Invalid,le.domestic_foreign_owner_flag_Invalid,le.email_Invalid,le.email_available_indicator_Invalid,le.exec_type_Invalid,le.executive_level_Invalid,le.executive_title_rank_Invalid,le.expense_accounting_desc_Invalid,le.expense_advertising_desc_Invalid,le.expense_bus_insurance_desc_Invalid,le.expense_legal_desc_Invalid,le.expense_office_equip_desc_Invalid,le.expense_rent_desc_Invalid,le.expense_technology_desc_Invalid,le.expense_telecom_desc_Invalid,le.expense_utilities_desc_Invalid,le.female_owned_Invalid,le.franchise_flag_Invalid,le.franchise_type_Invalid,le.full_name_Invalid,le.gender_Invalid,le.home_based_indicator_Invalid,le.import_export_Invalid,le.ind_frm_indicator_Invalid,le.legal_expenses_code_Invalid,le.location_employee_code_Invalid,le.location_employee_desc_Invalid,le.location_sales_code_Invalid,le.location_sales_desc_Invalid,le.mail_addr_state_Invalid,le.mail_addr_zip_Invalid,le.mail_score_Invalid,le.manufacturing_location_Invalid,le.minority_owned_flag_Invalid,le.minority_type_Invalid,le.naics01_Invalid,le.naics02_Invalid,le.naics03_Invalid,le.naics04_Invalid,le.naics05_Invalid,le.naics06_Invalid,le.nb_flag_Invalid,le.non_profit_org_Invalid,le.number_of_pcs_code_Invalid,le.number_of_pcs_desc_Invalid,le.office_equip_expenses_code_Invalid,le.phone_Invalid,le.phy_addr_state_Invalid,le.phy_addr_zip_Invalid,le.primary_exec_flag_Invalid,le.primary_sic_Invalid,le.primarysic2_Invalid,le.primarysic4_Invalid,le.public_indicator_Invalid,le.rent_expenses_code_Invalid,le.sic02_Invalid,le.sic03_Invalid,le.sic04_Invalid,le.sic05_Invalid,le.sic06_Invalid,le.small_business_indicator_Invalid,le.square_footage_code_Invalid,le.square_footage_desc_Invalid,le.standardized_title_Invalid,le.technology_expenses_code_Invalid,le.telecom_expenses_code_Invalid,le.url_Invalid,le.utilities_expenses_code_Invalid,le.year_established_Invalid,le.years_in_business_range_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Base_Fields.InvalidMessage_dt_first_seen(le.dt_first_seen_Invalid),Base_Fields.InvalidMessage_dt_last_seen(le.dt_last_seen_Invalid),Base_Fields.InvalidMessage_dt_vendor_first_reported(le.dt_vendor_first_reported_Invalid),Base_Fields.InvalidMessage_dt_vendor_last_reported(le.dt_vendor_last_reported_Invalid),Base_Fields.InvalidMessage_process_date(le.process_date_Invalid),Base_Fields.InvalidMessage_record_type(le.record_type_Invalid),Base_Fields.InvalidMessage_accounting_expenses_code(le.accounting_expenses_code_Invalid),Base_Fields.InvalidMessage_advertising_expenses_code(le.advertising_expenses_code_Invalid),Base_Fields.InvalidMessage_bus_insurance_expense_code(le.bus_insurance_expense_code_Invalid),Base_Fields.InvalidMessage_business_status_code(le.business_status_code_Invalid),Base_Fields.InvalidMessage_business_status_desc(le.business_status_desc_Invalid),Base_Fields.InvalidMessage_city_population_code(le.city_population_code_Invalid),Base_Fields.InvalidMessage_city_population_descr(le.city_population_descr_Invalid),Base_Fields.InvalidMessage_company_name(le.company_name_Invalid),Base_Fields.InvalidMessage_corporate_employee_code(le.corporate_employee_code_Invalid),Base_Fields.InvalidMessage_corporate_employee_desc(le.corporate_employee_desc_Invalid),Base_Fields.InvalidMessage_county_code(le.county_code_Invalid),Base_Fields.InvalidMessage_creditcode(le.creditcode_Invalid),Base_Fields.InvalidMessage_credit_desc(le.credit_desc_Invalid),Base_Fields.InvalidMessage_credit_capacity_code(le.credit_capacity_code_Invalid),Base_Fields.InvalidMessage_credit_capacity_desc(le.credit_capacity_desc_Invalid),Base_Fields.InvalidMessage_db_cons_age(le.db_cons_age_Invalid),Base_Fields.InvalidMessage_db_cons_child_near_hs_grad(le.db_cons_child_near_hs_grad_Invalid),Base_Fields.InvalidMessage_db_cons_children_present(le.db_cons_children_present_Invalid),Base_Fields.InvalidMessage_db_cons_college_graduate(le.db_cons_college_graduate_Invalid),Base_Fields.InvalidMessage_db_cons_credit_card_user(le.db_cons_credit_card_user_Invalid),Base_Fields.InvalidMessage_db_cons_date_of_birth_month(le.db_cons_date_of_birth_month_Invalid),Base_Fields.InvalidMessage_db_cons_date_of_birth_year(le.db_cons_date_of_birth_year_Invalid),Base_Fields.InvalidMessage_db_cons_discretincomecode(le.db_cons_discretincomecode_Invalid),Base_Fields.InvalidMessage_db_cons_discretincomedesc(le.db_cons_discretincomedesc_Invalid),Base_Fields.InvalidMessage_db_cons_dnc(le.db_cons_dnc_Invalid),Base_Fields.InvalidMessage_db_cons_donor_capacity_code(le.db_cons_donor_capacity_code_Invalid),Base_Fields.InvalidMessage_db_cons_donor_capacity_desc(le.db_cons_donor_capacity_desc_Invalid),Base_Fields.InvalidMessage_db_cons_dwelling_type(le.db_cons_dwelling_type_Invalid),Base_Fields.InvalidMessage_db_cons_education_hh(le.db_cons_education_hh_Invalid),Base_Fields.InvalidMessage_db_cons_education_ind(le.db_cons_education_ind_Invalid),Base_Fields.InvalidMessage_db_cons_email(le.db_cons_email_Invalid),Base_Fields.InvalidMessage_db_cons_ethnic_code(le.db_cons_ethnic_code_Invalid),Base_Fields.InvalidMessage_db_cons_full_name(le.db_cons_full_name_Invalid),Base_Fields.InvalidMessage_db_cons_gender(le.db_cons_gender_Invalid),Base_Fields.InvalidMessage_db_cons_home_owner_renter(le.db_cons_home_owner_renter_Invalid),Base_Fields.InvalidMessage_db_cons_home_property_type(le.db_cons_home_property_type_Invalid),Base_Fields.InvalidMessage_db_cons_home_sqft_ranges(le.db_cons_home_sqft_ranges_Invalid),Base_Fields.InvalidMessage_db_cons_home_value_code(le.db_cons_home_value_code_Invalid),Base_Fields.InvalidMessage_db_cons_home_value_desc(le.db_cons_home_value_desc_Invalid),Base_Fields.InvalidMessage_db_cons_home_year_built(le.db_cons_home_year_built_Invalid),Base_Fields.InvalidMessage_db_cons_income_code(le.db_cons_income_code_Invalid),Base_Fields.InvalidMessage_db_cons_income_desc(le.db_cons_income_desc_Invalid),Base_Fields.InvalidMessage_db_cons_intend_purchase_veh(le.db_cons_intend_purchase_veh_Invalid),Base_Fields.InvalidMessage_db_cons_language_pref(le.db_cons_language_pref_Invalid),Base_Fields.InvalidMessage_db_cons_length_of_res_code(le.db_cons_length_of_res_code_Invalid),Base_Fields.InvalidMessage_db_cons_length_of_res_desc(le.db_cons_length_of_res_desc_Invalid),Base_Fields.InvalidMessage_db_cons_marital_status(le.db_cons_marital_status_Invalid),Base_Fields.InvalidMessage_db_cons_networthhomevalcode(le.db_cons_networthhomevalcode_Invalid),Base_Fields.InvalidMessage_db_cons_net_worth_desc(le.db_cons_net_worth_desc_Invalid),Base_Fields.InvalidMessage_db_cons_new_parent(le.db_cons_new_parent_Invalid),Base_Fields.InvalidMessage_db_cons_new_teen_driver(le.db_cons_new_teen_driver_Invalid),Base_Fields.InvalidMessage_db_cons_newlywed(le.db_cons_newlywed_Invalid),Base_Fields.InvalidMessage_db_cons_occupation_ind(le.db_cons_occupation_ind_Invalid),Base_Fields.InvalidMessage_db_cons_other_pet_owner(le.db_cons_other_pet_owner_Invalid),Base_Fields.InvalidMessage_db_cons_phone(le.db_cons_phone_Invalid),Base_Fields.InvalidMessage_db_cons_poli_party_ind(le.db_cons_poli_party_ind_Invalid),Base_Fields.InvalidMessage_db_cons_recent_divorce(le.db_cons_recent_divorce_Invalid),Base_Fields.InvalidMessage_db_cons_recent_home_buyer(le.db_cons_recent_home_buyer_Invalid),Base_Fields.InvalidMessage_db_cons_religious_affil(le.db_cons_religious_affil_Invalid),Base_Fields.InvalidMessage_db_cons_scrubbed_phoneable(le.db_cons_scrubbed_phoneable_Invalid),Base_Fields.InvalidMessage_db_cons_time_zone_code(le.db_cons_time_zone_code_Invalid),Base_Fields.InvalidMessage_db_cons_time_zone_desc(le.db_cons_time_zone_desc_Invalid),Base_Fields.InvalidMessage_db_cons_unsecuredcredcapcode(le.db_cons_unsecuredcredcapcode_Invalid),Base_Fields.InvalidMessage_db_cons_unsecuredcredcapdesc(le.db_cons_unsecuredcredcapdesc_Invalid),Base_Fields.InvalidMessage_domestic_foreign_owner_flag(le.domestic_foreign_owner_flag_Invalid),Base_Fields.InvalidMessage_email(le.email_Invalid),Base_Fields.InvalidMessage_email_available_indicator(le.email_available_indicator_Invalid),Base_Fields.InvalidMessage_exec_type(le.exec_type_Invalid),Base_Fields.InvalidMessage_executive_level(le.executive_level_Invalid),Base_Fields.InvalidMessage_executive_title_rank(le.executive_title_rank_Invalid),Base_Fields.InvalidMessage_expense_accounting_desc(le.expense_accounting_desc_Invalid),Base_Fields.InvalidMessage_expense_advertising_desc(le.expense_advertising_desc_Invalid),Base_Fields.InvalidMessage_expense_bus_insurance_desc(le.expense_bus_insurance_desc_Invalid),Base_Fields.InvalidMessage_expense_legal_desc(le.expense_legal_desc_Invalid),Base_Fields.InvalidMessage_expense_office_equip_desc(le.expense_office_equip_desc_Invalid),Base_Fields.InvalidMessage_expense_rent_desc(le.expense_rent_desc_Invalid),Base_Fields.InvalidMessage_expense_technology_desc(le.expense_technology_desc_Invalid),Base_Fields.InvalidMessage_expense_telecom_desc(le.expense_telecom_desc_Invalid),Base_Fields.InvalidMessage_expense_utilities_desc(le.expense_utilities_desc_Invalid),Base_Fields.InvalidMessage_female_owned(le.female_owned_Invalid),Base_Fields.InvalidMessage_franchise_flag(le.franchise_flag_Invalid),Base_Fields.InvalidMessage_franchise_type(le.franchise_type_Invalid),Base_Fields.InvalidMessage_full_name(le.full_name_Invalid),Base_Fields.InvalidMessage_gender(le.gender_Invalid),Base_Fields.InvalidMessage_home_based_indicator(le.home_based_indicator_Invalid),Base_Fields.InvalidMessage_import_export(le.import_export_Invalid),Base_Fields.InvalidMessage_ind_frm_indicator(le.ind_frm_indicator_Invalid),Base_Fields.InvalidMessage_legal_expenses_code(le.legal_expenses_code_Invalid),Base_Fields.InvalidMessage_location_employee_code(le.location_employee_code_Invalid),Base_Fields.InvalidMessage_location_employee_desc(le.location_employee_desc_Invalid),Base_Fields.InvalidMessage_location_sales_code(le.location_sales_code_Invalid),Base_Fields.InvalidMessage_location_sales_desc(le.location_sales_desc_Invalid),Base_Fields.InvalidMessage_mail_addr_state(le.mail_addr_state_Invalid),Base_Fields.InvalidMessage_mail_addr_zip(le.mail_addr_zip_Invalid),Base_Fields.InvalidMessage_mail_score(le.mail_score_Invalid),Base_Fields.InvalidMessage_manufacturing_location(le.manufacturing_location_Invalid),Base_Fields.InvalidMessage_minority_owned_flag(le.minority_owned_flag_Invalid),Base_Fields.InvalidMessage_minority_type(le.minority_type_Invalid),Base_Fields.InvalidMessage_naics01(le.naics01_Invalid),Base_Fields.InvalidMessage_naics02(le.naics02_Invalid),Base_Fields.InvalidMessage_naics03(le.naics03_Invalid),Base_Fields.InvalidMessage_naics04(le.naics04_Invalid),Base_Fields.InvalidMessage_naics05(le.naics05_Invalid),Base_Fields.InvalidMessage_naics06(le.naics06_Invalid),Base_Fields.InvalidMessage_nb_flag(le.nb_flag_Invalid),Base_Fields.InvalidMessage_non_profit_org(le.non_profit_org_Invalid),Base_Fields.InvalidMessage_number_of_pcs_code(le.number_of_pcs_code_Invalid),Base_Fields.InvalidMessage_number_of_pcs_desc(le.number_of_pcs_desc_Invalid),Base_Fields.InvalidMessage_office_equip_expenses_code(le.office_equip_expenses_code_Invalid),Base_Fields.InvalidMessage_phone(le.phone_Invalid),Base_Fields.InvalidMessage_phy_addr_state(le.phy_addr_state_Invalid),Base_Fields.InvalidMessage_phy_addr_zip(le.phy_addr_zip_Invalid),Base_Fields.InvalidMessage_primary_exec_flag(le.primary_exec_flag_Invalid),Base_Fields.InvalidMessage_primary_sic(le.primary_sic_Invalid),Base_Fields.InvalidMessage_primarysic2(le.primarysic2_Invalid),Base_Fields.InvalidMessage_primarysic4(le.primarysic4_Invalid),Base_Fields.InvalidMessage_public_indicator(le.public_indicator_Invalid),Base_Fields.InvalidMessage_rent_expenses_code(le.rent_expenses_code_Invalid),Base_Fields.InvalidMessage_sic02(le.sic02_Invalid),Base_Fields.InvalidMessage_sic03(le.sic03_Invalid),Base_Fields.InvalidMessage_sic04(le.sic04_Invalid),Base_Fields.InvalidMessage_sic05(le.sic05_Invalid),Base_Fields.InvalidMessage_sic06(le.sic06_Invalid),Base_Fields.InvalidMessage_small_business_indicator(le.small_business_indicator_Invalid),Base_Fields.InvalidMessage_square_footage_code(le.square_footage_code_Invalid),Base_Fields.InvalidMessage_square_footage_desc(le.square_footage_desc_Invalid),Base_Fields.InvalidMessage_standardized_title(le.standardized_title_Invalid),Base_Fields.InvalidMessage_technology_expenses_code(le.technology_expenses_code_Invalid),Base_Fields.InvalidMessage_telecom_expenses_code(le.telecom_expenses_code_Invalid),Base_Fields.InvalidMessage_url(le.url_Invalid),Base_Fields.InvalidMessage_utilities_expenses_code(le.utilities_expenses_code_Invalid),Base_Fields.InvalidMessage_year_established(le.year_established_Invalid),Base_Fields.InvalidMessage_years_in_business_range(le.years_in_business_range_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Base_Layout_Database_USA) prevDS = DATASET([], Base_Layout_Database_USA), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Base_Fields.InvalidMessage_business_status_desc(1)
          ,Base_Fields.InvalidMessage_city_population_code(1)
          ,Base_Fields.InvalidMessage_city_population_descr(1)
          ,Base_Fields.InvalidMessage_company_name(1)
          ,Base_Fields.InvalidMessage_corporate_employee_code(1)
          ,Base_Fields.InvalidMessage_corporate_employee_desc(1)
          ,Base_Fields.InvalidMessage_county_code(1)
          ,Base_Fields.InvalidMessage_creditcode(1)
          ,Base_Fields.InvalidMessage_credit_desc(1)
          ,Base_Fields.InvalidMessage_credit_capacity_code(1)
          ,Base_Fields.InvalidMessage_credit_capacity_desc(1)
          ...
          ,Base_Fields.InvalidMessage_db_cons_discretincomedesc(1)
          ,Base_Fields.InvalidMessage_db_cons_dnc(1)
          ,Base_Fields.InvalidMessage_db_cons_donor_capacity_code(1)
          ,Base_Fields.InvalidMessage_db_cons_donor_capacity_desc(1)
          ...
          ,Base_Fields.InvalidMessage_db_cons_home_value_desc(1)
          ,Base_Fields.InvalidMessage_db_cons_home_year_built(1)
          ,Base_Fields.InvalidMessage_db_cons_income_code(1)
          ,Base_Fields.InvalidMessage_db_cons_income_desc(1)
          ...
          ,Base_Fields.InvalidMessage_db_cons_time_zone_desc(1)
          ,Base_Fields.InvalidMessage_db_cons_unsecuredcredcapcode(1)
          ,Base_Fields.InvalidMessage_db_cons_unsecuredcredcapdesc(1)
          ...
          ,Base_Fields.InvalidMessage_executive_level(1)
          ,Base_Fields.InvalidMessage_executive_title_rank(1)
          ,Base_Fields.InvalidMessage_expense_accounting_desc(1)
          ,Base_Fields.InvalidMessage_expense_advertising_desc(1)
          ,Base_Fields.InvalidMessage_expense_bus_insurance_desc(1)
          ,Base_Fields.InvalidMessage_expense_legal_desc(1)
          ,Base_Fields.InvalidMessage_expense_office_equip_desc(1)
          ,Base_Fields.InvalidMessage_expense_rent_desc(1)
          ,Base_Fields.InvalidMessage_expense_technology_desc(1)
          ,Base_Fields.InvalidMessage_expense_telecom_desc(1)
          ,Base_Fields.InvalidMessage_expense_utilities_desc(1)
          ...
          ,Base_Fields.InvalidMessage_location_employee_desc(1)
          ,Base_Fields.InvalidMessage_location_sales_code(1)
          ,Base_Fields.InvalidMessage_location_sales_desc(1)
          ...
          ,Base_Fields.InvalidMessage_minority_type(1)
          ...
          ,Base_Fields.InvalidMessage_number_of_pcs_desc(1)
          ...
          ,Base_Fields.InvalidMessage_square_footage_desc(1)
          ,Base_Fields.InvalidMessage_standardized_title(1)
          ...
          ,Base_Fields.InvalidMessage_years_in_business_range(1)
          ,'Fields with errors'
    ...
    mod_hygiene := Base_hygiene(PROJECT(h, Base_Layout_Database_USA));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ErrorMessage := '';
    END;
    FieldPopStats := NORMALIZE(hygiene_summaryStats,139,xNormHygieneStats(LEFT,COUNTER,'POP'));
  ...
  // record count stats
    ...
    mod_Delta := Base_Delta(prevDS, PROJECT(h, Base_Layout_Database_USA));
    deltaHygieneSummary := mod_Delta.DifferenceSummary;
    DeltaFieldPopStats := NORMALIZE(deltaHygieneSummary(txt <> 'New'),139,xNormHygieneStats(LEFT,COUNTER,'DELTA'));
...
EXPORT StandardStats(DATASET(Base_Layout_Database_USA) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
