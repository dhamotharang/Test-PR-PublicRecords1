...
EXPORT Base_MAC_PopulationStatistics(infile,Ref='',Input_dt_first_seen = '',Input_dt_last_seen = '',Input_dt_vendor_first_reported = '',Input_dt_vendor_last_reported = '',Input_process_date = '',Input_record_type = '',Input_ind_frm_indicator = '',Input_company_name = '',Input_full_name = '',Input_gender = '',Input_primary_exec_flag = '',Input_exec_type = '',Input_phy_addr_state = '',Input_phy_addr_zip = '',Input_mail_addr_state = '',Input_mail_addr_zip = '',Input_mail_score = '',Input_phone = '',Input_email = '',Input_email_available_indicator = '',Input_url = '',Input_business_status_code = '',Input_franchise_flag = '',Input_franchise_type = '',Input_county_code = '',Input_primary_sic = '',Input_sic02 = '',Input_sic03 = '',Input_sic04 = '',Input_sic05 = '',Input_sic06 = '',Input_primarysic2 = '',Input_primarysic4 = '',Input_naics01 = '',Input_naics02 = '',Input_naics03 = '',Input_naics04 = '',Input_naics05 = '',Input_naics06 = '',Input_location_employee_code = '',Input_location_sales_code = '',Input_corporate_employee_code = '',Input_year_established = '',Input_female_owned = '',Input_minority_owned_flag = '',Input_home_based_indicator = '',Input_small_business_indicator = '',Input_import_export = '',Input_manufacturing_location = '',Input_public_indicator = '',Input_non_profit_org = '',Input_square_footage_code = '',Input_creditcode = '',Input_credit_capacity_code = '',Input_advertising_expenses_code = '',Input_technology_expenses_code = '',Input_office_equip_expenses_code = '',Input_rent_expenses_code = '',Input_telecom_expenses_code = '',Input_accounting_expenses_code = '',Input_bus_insurance_expense_code = '',Input_legal_expenses_code = '',Input_utilities_expenses_code = '',Input_number_of_pcs_code = '',Input_nb_flag = '',Input_domestic_foreign_owner_flag = '',Input_db_cons_full_name = '',Input_db_cons_email = '',Input_db_cons_gender = '',Input_db_cons_date_of_birth_year = '',Input_db_cons_date_of_birth_month = '',Input_db_cons_age = '',Input_db_cons_ethnic_code = '',Input_db_cons_religious_affil = '',Input_db_cons_language_pref = '',Input_db_cons_time_zone_code = '',Input_db_cons_phone = '',Input_db_cons_dnc = '',Input_db_cons_scrubbed_phoneable = '',Input_db_cons_children_present = '',Input_db_cons_home_value_code = '',Input_db_cons_donor_capacity_code = '',Input_db_cons_home_owner_renter = '',Input_db_cons_length_of_res_code = '',Input_db_cons_dwelling_type = '',Input_db_cons_recent_home_buyer = '',Input_db_cons_income_code = '',Input_db_cons_unsecuredcredcapcode = '',Input_db_cons_networthhomevalcode = '',Input_db_cons_discretincomecode = '',Input_db_cons_marital_status = '',Input_db_cons_new_parent = '',Input_db_cons_child_near_hs_grad = '',Input_db_cons_college_graduate = '',Input_db_cons_intend_purchase_veh = '',Input_db_cons_recent_divorce = '',Input_db_cons_newlywed = '',Input_db_cons_new_teen_driver = '',Input_db_cons_home_year_built = '',Input_db_cons_home_sqft_ranges = '',Input_db_cons_poli_party_ind = '',Input_db_cons_occupation_ind = '',Input_db_cons_credit_card_user = '',Input_db_cons_home_property_type = '',Input_db_cons_education_hh = '',Input_db_cons_education_ind = '',Input_db_cons_other_pet_owner = '',OutFile) := MACRO
