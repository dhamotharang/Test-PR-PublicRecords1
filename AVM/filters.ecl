...
export filters := MODULE
	...
	export land_use_codes := ['1000','1001','1002','1004','1010','1114'];  // codes '1000' and '1001' are converted to land_use='1'(single family dwelling), all others are '2'(condo, multi unit dwelling)
	...
	export recent_sale_for_TA_ratio := ut.DateFrom_DaysSince1900(today1900-365);  // change to 548 to return a date from a year and a half ago
