...
Patient_Clean_REC clean (RECORDOF(Infile) L) := transform
	...
	PatientAddressLine1 := REGEXREPLACE('-|\\Â¦|@|#|\\$|%|Â¬|\\&|\\*|\\(|\\)|_|\\+|=|:|;|!|Â¢|\\}|\\{|,|\\.|/|\\?|\\||\\\\|<|>|"|`|\'|~',HealthCareProvider.CleanData.fUpperCleanSpaces(HealthCareProvider.CleanData.fReplaceUnprintable(IAddressLine1)),' ');
	PatientAddressLine2 := REGEXREPLACE('-|\\Â¦|@|#|\\$|%|Â¬|\\&|\\*|\\(|\\)|_|\\+|=|:|;|!|Â¢|\\}|\\{|,|\\.|/|\\?|\\||\\\\|<|>|"|`|\'|~',HealthCareProvider.CleanData.fUpperCleanSpaces(HealthCareProvider.CleanData.fReplaceUnprintable(IAddressLine2)),' ');	
