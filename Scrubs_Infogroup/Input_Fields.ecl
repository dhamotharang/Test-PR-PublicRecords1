...
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_ace_rec_type' => 1,'invalid_address' => 2,'invalid_alpha' => 3,'invalid_alphanumeric' => 4,'invalid_alphanumericspacehyphen' => 5,'invalid_alphaspacecommaslash' => 6,'invalid_alphaspacecommaslashhyphenparenampquote' => 7,'invalid_alphaspacehyphenquote' => 8,'invalid_date' => 9,'invalid_first_name' => 10,'invalid_last_name' => 11,'invalid_license_number' => 12,'invalid_license_state' => 13,'invalid_match_code' => 14,'invalid_numeric' => 15,'invalid_occupational_title' => 16,'invalid_past_date' => 17,'invalid_residential_business_ind' => 18,'invalid_status_code' => 19,'invalid_suffix' => 20,'invalid_unit_type' => 21,0);
 
EXPORT MakeFT_invalid_ace_rec_type(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ace_rec_type(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['F','G','H','M','P','R','S','U','FD','GD','HD','RD','SD','UD',' ']);
EXPORT InValidMessageFT_invalid_ace_rec_type(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('F|G|H|M|P|R|S|U|FD|GD|HD|RD|SD|UD| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address(SALT32.StrType s) := WHICH(~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_address(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_alphanumericspacehyphen(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphanumericspacehyphen(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'))));
EXPORT InValidMessageFT_invalid_alphanumericspacehyphen(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaspacecommaslash(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' ,/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaspacecommaslash(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' ,/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))));
EXPORT InValidMessageFT_invalid_alphaspacecommaslash(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' ,/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaspacecommaslashhyphenparenampquote(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' ,/-()&\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaspacecommaslashhyphenparenampquote(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' ,/-()&\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))));
EXPORT InValidMessageFT_invalid_alphaspacecommaslashhyphenparenampquote(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' ,/-()&\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaspacehyphenquote(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaspacehyphenquote(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))));
EXPORT InValidMessageFT_invalid_alphaspacehyphenquote(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_first_name(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_first_name(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_first_name(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_last_name(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_last_name(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_last_name(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -\'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_number(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' .-/$#+,:()&;`_*=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_license_number(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' .-/$#+,:()&;`_*=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'))));
EXPORT InValidMessageFT_invalid_license_number(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' .-/$#+,:()&;`_*=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_state(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_license_state(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_license_state(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_match_code(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_match_code(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['0','2','4','X','P',' ']);
EXPORT InValidMessageFT_invalid_match_code(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('0|2|4|X|P| '),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_occupational_title(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' ,/-()&ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_occupational_title(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' ,/-()&ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_occupational_title(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' ,/-()&ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_past_date(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_past_date(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_pastDate(s)>0);
EXPORT InValidMessageFT_invalid_past_date(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('0123456789'),SALT32.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_residential_business_ind(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_residential_business_ind(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['R','B','U']);
EXPORT InValidMessageFT_invalid_residential_business_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('R|B|U'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_code(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_code(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['A','C','O','P','R','X',' '],~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('A|C|O|P|R|X| '),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_suffix(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_suffix(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['SR','JR','I','II','III','IV','V','VI','VII','VIII','IX',' ']);
EXPORT InValidMessageFT_invalid_suffix(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('SR|JR|I|II|III|IV|V|VI|VII|VIII|IX| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_unit_type(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_unit_type(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['#','APT','BLDG','BOX','BSMT','DEPT','FL','FRNT','HNGR','KEY','LBBY','LOT','LOWR','OFC','PH','PIER','REAR','RM','SIDE','SLIP','SPC','STE','STOP','TRLR','UNIT','UPPR',' ']);
EXPORT InValidMessageFT_invalid_unit_type(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('#|APT|BLDG|BOX|BSMT|DEPT|FL|FRNT|HNGR|KEY|LBBY|LOT|LOWR|OFC|PH|PIER|REAR|RM|SIDE|SLIP|SPC|STE|STOP|TRLR|UNIT|UPPR| '),SALT32.HygieneErrors.Good);
...
EXPORT Make_predir(SALT32.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_predir(SALT32.StrType s) := InValidFT_invalid_alpha(s);
...
EXPORT Make_addr_suffix(SALT32.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_addr_suffix(SALT32.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_addr_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_postdir(SALT32.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_postdir(SALT32.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_postdir(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_unit_type(SALT32.StrType s0) := MakeFT_invalid_unit_type(s0);
EXPORT InValid_unit_type(SALT32.StrType s) := InValidFT_invalid_unit_type(s);
EXPORT InValidMessage_unit_type(UNSIGNED1 wh) := InValidMessageFT_invalid_unit_type(wh);
 
EXPORT Make_unit_number(SALT32.StrType s0) := s0;
EXPORT InValid_unit_number(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_unit_number(UNSIGNED1 wh) := '';
 
EXPORT Make_city(SALT32.StrType s0) := MakeFT_invalid_alphanumericspacehyphen(s0);
EXPORT InValid_city(SALT32.StrType s) := InValidFT_invalid_alphanumericspacehyphen(s);
...
EXPORT Make_zip(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_zip(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_zip4(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_zip4(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bar(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bar(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bar(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ace_rec_type(SALT32.StrType s0) := MakeFT_invalid_ace_rec_type(s0);
EXPORT InValid_ace_rec_type(SALT32.StrType s) := InValidFT_invalid_ace_rec_type(s);
EXPORT InValidMessage_ace_rec_type(UNSIGNED1 wh) := InValidMessageFT_invalid_ace_rec_type(wh);
 
EXPORT Make_cart(SALT32.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_cart(SALT32.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_cart(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_census_state_code(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_census_state_code(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_census_state_code(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_census_county_code(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_census_county_code(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_census_county_code(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_county_code_desc(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_county_code_desc(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_county_code_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_census_tract(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_census_tract(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_census_tract(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_census_block_group(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_census_block_group(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_census_block_group(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_match_code(SALT32.StrType s0) := MakeFT_invalid_match_code(s0);
EXPORT InValid_match_code(SALT32.StrType s) := InValidFT_invalid_match_code(s);
...
EXPORT Make_mail_score(SALT32.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_mail_score(SALT32.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_mail_score(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_residential_business_ind(SALT32.StrType s0) := MakeFT_invalid_residential_business_ind(s0);
EXPORT InValid_residential_business_ind(SALT32.StrType s) := InValidFT_invalid_residential_business_ind(s);
EXPORT InValidMessage_residential_business_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_residential_business_ind(wh);
 
EXPORT Make_employer_name(SALT32.StrType s0) := s0;
EXPORT InValid_employer_name(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_employer_name(UNSIGNED1 wh) := '';
 
EXPORT Make_family_id(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_family_id(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_family_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_individual_id(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_individual_id(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_individual_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_abi_number(SALT32.StrType s0) := s0;
EXPORT InValid_abi_number(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_abi_number(UNSIGNED1 wh) := '';
 
EXPORT Make_industry_title(SALT32.StrType s0) := MakeFT_invalid_alphaspacecommaslash(s0);
EXPORT InValid_industry_title(SALT32.StrType s) := InValidFT_invalid_alphaspacecommaslash(s);
EXPORT InValidMessage_industry_title(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaspacecommaslash(wh);
 
EXPORT Make_occupation_title(SALT32.StrType s0) := MakeFT_invalid_occupational_title(s0);
EXPORT InValid_occupation_title(SALT32.StrType s) := InValidFT_invalid_occupational_title(s);
EXPORT InValidMessage_occupation_title(UNSIGNED1 wh) := InValidMessageFT_invalid_occupational_title(wh);
 
EXPORT Make_specialty_title(SALT32.StrType s0) := MakeFT_invalid_alphaspacecommaslashhyphenparenampquote(s0);
EXPORT InValid_specialty_title(SALT32.StrType s) := InValidFT_invalid_alphaspacecommaslashhyphenparenampquote(s);
EXPORT InValidMessage_specialty_title(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaspacecommaslashhyphenparenampquote(wh);
 
EXPORT Make_sic_code(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_sic_code(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_naics_group(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_naics_group(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_naics_group(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_license_state(SALT32.StrType s0) := MakeFT_invalid_license_state(s0);
EXPORT InValid_license_state(SALT32.StrType s) := InValidFT_invalid_license_state(s);
EXPORT InValidMessage_license_state(UNSIGNED1 wh) := InValidMessageFT_invalid_license_state(wh);
 
EXPORT Make_license_id(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_license_id(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_license_id(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_license_number(SALT32.StrType s0) := MakeFT_invalid_license_number(s0);
EXPORT InValid_license_number(SALT32.StrType s) := InValidFT_invalid_license_number(s);
EXPORT InValidMessage_license_number(UNSIGNED1 wh) := InValidMessageFT_invalid_license_number(wh);
 
EXPORT Make_exp_date(SALT32.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_exp_date(SALT32.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_effective_date(SALT32.StrType s0) := MakeFT_invalid_past_date(s0);
EXPORT InValid_effective_date(SALT32.StrType s) := InValidFT_invalid_past_date(s);
EXPORT InValidMessage_effective_date(UNSIGNED1 wh) := InValidMessageFT_invalid_past_date(wh);
 
EXPORT Make_add_date(SALT32.StrType s0) := MakeFT_invalid_past_date(s0);
EXPORT InValid_add_date(SALT32.StrType s) := InValidFT_invalid_past_date(s);
EXPORT InValidMessage_add_date(UNSIGNED1 wh) := InValidMessageFT_invalid_past_date(wh);
 
EXPORT Make_change_date(SALT32.StrType s0) := MakeFT_invalid_past_date(s0);
EXPORT InValid_change_date(SALT32.StrType s) := InValidFT_invalid_past_date(s);
EXPORT InValidMessage_change_date(UNSIGNED1 wh) := InValidMessageFT_invalid_past_date(wh);
 
EXPORT Make_year_licensed(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_year_licensed(SALT32.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_year_licensed(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_carriage_return(SALT32.StrType s0) := s0;
EXPORT InValid_carriage_return(SALT32.StrType s) := FALSE;
