...
EXPORT Functions_LP := MODULE
		...
		//****************************************************************************
		//CorpNameComment: returns the "corp_name_comment" for LP.
		//****************************************************************************
		EXPORT CorpNameComment(STRING cd, STRING cc, STRING ad, STRING rd) := FUNCTION
				...
				cancelcode_desc		 	 := if(Corp2_mapping.fValidateDate(cd,'CCYYMMDD').GeneralDate<>'',
																	 map((integer)cc = 0 => 'ACTIVE NAME',
																			 (integer)cc = 1 => 'VOLUNTARY CANCELLATION: '	+cancel_date,
																			 (integer)cc = 2 => 'INVOLUNTARY CANCELLATION: '+cancel_date,
																			 ''
																		  ),
																	 ''
																	);
				...
				name_comment				 := cancelcode_desc+if(adopted_desc<>'','; '+adopted_desc,'')+if(renew_desc<>'','; '+renew_desc,'');
		...
		//****************************************************************************
		//CorpStatusDesc: returns the "corp_status_desc" for LP.
		//****************************************************************************
		EXPORT CorpStatusDesc(STRING s) := FUNCTION
			 ...
			 RETURN map(uc_s = '00'	=>'GOOD STANDING',
									uc_s = '01'	=>'AGENT RESIGNATION',
									uc_s = '02'	=>'DELINQUENT (MISC)',
									uc_s = '03'	=>'VOLUNTARY CANCELLATION',
									uc_s = '04'	=>'FEIN DELINQUENT',
									uc_s = '05'	=>'NO RENEWAL',
									uc_s = '06'	=>'EXPIRED',
									uc_s = '07'	=>'FAS DELINQUENT',
									uc_s = '08'	=>'NON-COMPLIANCE',
									uc_s = '09'	=>'MERGED',
									uc_s = '10'	=>'CONVERSION',
									uc_s = '11'	=>'VOLUNTARY DISSOLUTION',									
									uc_s = '12'	=>'INVOLUNTARY DISSOLUTION',
									uc_s = '13'	=>'REVOKED',
									uc_s = '14'	=>'AGENT RESIGNATION PENDING',
									''
								 );
		END;

		//****************************************************************************
		//County: returns the associated "IL" county.
		//****************************************************************************
		EXPORT County(STRING s) := FUNCTION
		...
		//****************************************************************************
		EXPORT ContFullName(STRING s) := FUNCTION

			 uc_s  					:= corp2.t2u(s);
			 
		   badnamepattern := '^FAILURE ';

			 RETURN map(regexfind('\\(LAST\\,( )*FIRST\\)',uc_s,0)<>'' => corp2.t2u(regexreplace('\\(LAST\\,( )*FIRST\\)',uc_s,'')),
									regexfind(badnamepattern,uc_s,0)<>'' 					 => '',
									uc_s
								 );
		END;
