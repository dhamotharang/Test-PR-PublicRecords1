...
EXPORT SexOffender_Services.Layouts.batch_out_pre batch_make_flat(SexOffender_Services.Layouts.batch_out_pre l, 
	  ...
	  SELF.offense_date_10 := IF( C=10, r.offense_date     , l.offense_date_10 );
   	...
   	SELF.statements     :=  l.statements + offenses_statements +
   	                        offenses_dispute;
    SELF                := l;
END;