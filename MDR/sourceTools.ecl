import corp2,doxie,codes,_control,MDR;
...
export set_Marketing_Restricted_Master := [
  src_ABMS,                    src_ACA,                       src_Accidents_ECrash,        src_Accidents_ECrash_CRU,
  src_Accidents_FL,            src_Accurint_Arrest_Log,       src_Accurint_Crim_Court,     src_Accurint_DOC,
  src_Accurint_Sex_offender,   src_Accurint_Trade_Show,       src_ACF,                     src_Acquiredweb,             
  src_advo_valassis,           src_AHA,                       src_Aircrafts,               src_Airmen,
  src_AK_Busreg,               src_AK_Corporations,           src_AK_Experian_Veh,         src_AK_Fishing_boats,
  src_AK_Perm_Fund,            src_AK_Watercraft,             src_AL_Corporations,         src_AL_Experian_Veh,
  src_AL_Watercraft,           src_ALC,                       src_AlloyMedia_consumer,     src_AlloyMedia_student_list,
  src_American_Students_List,  src_AMIDIR,                    src_AMS,                     src_AR_Corporations,         
  src_AR_Experian_Veh,         src_AR_Watercraft,             src_AZ_Corporations,         src_AZ_Experian_Veh,
  src_AZ_Watercraft,           src_Bair_Analytics,            src_Bankruptcy,              src_Bankruptcy_Attorney,
  src_Bankruptcy_Trustee,      src_BBB_Member,                src_BBB_Non_Member,          src_BKFS_Nod,
  src_BKFS_Reo,                src_Business_Credit,           src_Business_Registration,   src_CA_Corporations,
  src_CA_Liquor_Licenses,      src_CA_Sales_Tax,              src_Calbus,                  src_CClue,
  src_Cellphones_kroll,        src_Cellphones_nextones,       src_Cellphones_traffix,      src_Certegy,
  src_Clarity,                 src_CLIA,                      src_CNLD_Facilities,         src_CNLD_Practitioner,
  src_CO_Corporations,         src_CO_Experian_DL,            src_CO_Experian_Veh,         src_CO_Watercraft,
  src_Cortera,                 src_CrashCarrier,              src_Credit_Unions,           src_CT_Corporations,
  src_CT_DL,                   src_CT_Experian_Veh,           src_CT_Liquor_Licenses,      
  src_CT_Watercraft,           src_Daily_Utilities,           src_Daily_ZUtilities,        src_Datagence,
  src_DC_Corporations,         src_DC_Experian_Veh,           src_DCA,                     src_DE_Experian_DL,
  src_DE_Experian_Veh,         src_DEA,                       src_Death_CA,                src_Death_CT,
  src_Death_FL,                src_Death_GA,                  src_Death_KY,                src_Death_MA,
  src_Death_Master,            src_Death_ME,                  src_Death_MI,                src_Death_Michigan,
  src_Death_MN,                src_Death_MT,                  src_Death_NC,                src_Death_NV,
  src_Death_Obituary,          src_Death_OH,                  src_Death_Restricted,        src_Death_State,
  src_Death_Tributes,          src_Death_VA,                  src_Debt_Settlement,         src_Diversity_Cert,
  src_Divorce,                 src_Dummy_Records,             src_Dummy_Records2,          src_Dunn_Bradstreet,
  src_Dunn_Bradstreet_Fein,    src_EBR,                       src_Edgar,                   src_Emdeon,
  src_EMerge_Boat,             src_EMerge_CCW,                src_EMerge_CCW_NY,           src_EMerge_Cens,
  src_EMerge_Fish,             src_EMerge_Hunt,               src_EMerge_Master,           src_Employee_Directories,
  src_Enclarity,               src_Entiera,                   src_Eq_Employer,             src_Equifax,
  src_Equifax_Quick,           src_Equifax_Weekly,            src_Experian_CRDB,           src_Experian_Credit_Header,
  src_Experian_FEIN_Rest,      src_Experian_FEIN_Unrest,      src_Experian_Phones,         src_Fares_Deeds_from_Asrs,
  src_FBNV2_BusReg,            src_FBNV2_CA_Orange_county,    src_FBNV2_CA_San_Bernadino,  src_FBNV2_CA_San_Diego,
  src_FBNV2_CA_Santa_Clara,    src_FBNV2_CA_Ventura,          src_FBNV2_Experian_Direct,   src_FBNV2_FL,
  src_FBNV2_Hist_Choicepoint,  src_FBNV2_INF,                 src_FBNV2_New_York,          src_FBNV2_TX_Dallas,
  src_FBNV2_TX_Harris,         src_FCC_Radio_Licenses,        src_FCRA_Corrections_record, src_FDIC,
  src_FDIC_SOD,                src_Federal_Explosives,        src_Federal_Firearms,        src_FL_CH,
  src_FL_Corporations,         src_FL_DL,                     src_FL_Experian_Veh,         src_FL_FBN,
  src_FL_Non_Profit,           src_FL_SO,                     src_FL_Veh,                  src_FL_Watercraft,
  src_FL_Watercraft_LN,        src_Foreclosures,              src_Foreclosures_Delinquent, src_Frandx,
  src_GA_CH,                   src_GA_Corporations,           src_GA_Experian_Veh,         src_GA_SO,
  src_GA_Watercraft,           src_Garnishments,              src_Gong_Business,           src_Gong_Government,
  src_Gong_History,            src_Gong_Neustar,              src_Gong_phone_append,       src_GSA,
  src_GSDD,                    src_HI_Corporations,           src_HMS_PM,                  src_HXMX,
  src_IA_Corporations,         src_IA_DL,                     src_IA_Experian_Veh,         src_IA_Sales_Tax,
  src_IA_Watercraft,           src_Ibehavior,                 src_ID_Corporations,         src_ID_DL,
  src_ID_Experian_DL,          src_ID_Experian_Veh,           src_ID_Veh,                  src_IL_Corporations,
  src_IL_Experian_DL,          src_IL_Experian_Veh,           src_IL_Watercraft,           src_Impulse,
  src_IN_Corporations,         src_IN_Liquor_Licenses,        src_Infogroup,               src_INFOUSA_ABIUS_USABIZ,
  src_INFOUSA_DEAD_COMPANIES,  src_INFOUSA_IDEXEC,            src_Infutor_Motorcycle_Veh,  src_Infutor_Veh,
  src_Infutor_Watercraft,      src_InfutorCID,                src_InfutorNarc,             src_InfutorNare,
  src_InfutorTRK,              src_Ingenix_Sanctions,         src_InquiryAcclogs,          src_Insurance_Certification,
  src_Intrado,                 src_IRS_5500,                  src_IRS_Non_Profit,          src_Jigsaw,
  src_KS_Corporations,         src_KS_Experian_Veh,           src_KS_Watercraft,           src_KY_Corporations,
  src_KY_DL,                   src_KY_Experian_DL,            src_KY_Experian_Veh,         src_KY_Veh,
  src_KY_Watercraft,           src_KY_Watercraft_LN,          src_LA_Corporations,         src_LA_DL,
  src_LA_Experian_DL,          src_LA_Experian_Veh,           src_Lexis_Trans_Union,       src_LA_Liquor_Licenses,      
  src_LaborActions_EBSA,       src_LaborActions_WHD,        
  src_Liens,                   src_Liens_and_Judgments,       src_Liens_v2,
  src_Liens_v2_CA_Federal,     src_Liens_v2_Chicago_Law,      src_Liens_v2_Hogan,          src_Liens_v2_ILFDLN,
  src_Liens_v2_MA,             src_Liens_v2_NYC,              src_Liens_v2_NYFDLN,         src_Liens_v2_Service_Abstract,
  src_Liens_v2_Superior_Party, src_Link2Tek,                  src_LnPropV2_Fares_Asrs,     src_LnPropV2_Fares_Deeds,
  src_LnPropV2_Lexis_Asrs,     src_LnPropV2_Lexis_Deeds_Mtgs, src_Lobbyists,               src_MA_Corporations,
  src_MA_DL,                   src_MA_Experian_Veh,           src_MA_Veh,                  src_MA_Watercraft,
  src_Mari_Prof_Lic,           src_Mari_Public_Sanc,          src_Marriage,                src_MartinDale_Hubbell,
  src_MD_Corporations,         src_MD_Experian_DL,            src_MD_Experian_Veh,         src_MD_Watercraft,
  src_ME_Corporations,         src_ME_DL,                     src_ME_Experian_Veh,         src_ME_Veh,
  src_ME_Watercraft,           src_MediaOne,                  src_Metronet_Gateway,        src_MI_Corporations,
  src_MI_DL,                   src_MI_Experian_Veh,           src_MI_SO,                   src_MI_Watercraft,
  src_Miscellaneous,           src_Mixed_DPPA,                src_Mixed_Non_DPPA,          src_Mixed_Probation,
  src_Mixed_Utilities,         src_MMCP,                      src_MN_Corporations,         src_MN_DL,
  src_MN_Experian_Veh,         src_MN_RESTRICTED_DL,          src_MN_Veh,                  src_MN_Watercraft,
  src_MO_Corporations,         src_MO_DL,                     src_MO_Experian_Veh,         src_MO_Veh,
  src_MO_Watercraft,           src_MO_Watercraft_LN,          src_MPRD_Individual,         src_MS_Corporations,
  src_MS_Experian_DL,          src_MS_Experian_Veh,           src_MS_Veh,                  src_MS_Watercraft,
  src_MS_Worker_Comp,          src_MT_Corporations,           src_MT_Experian_Veh,         src_MT_Veh,
  src_MT_Watercraft,           src_NaturalDisaster_Readiness, src_NC_Corporations,         src_NC_DL,
  src_NC_Experian_Veh,         src_NC_Veh,                    src_NC_Watercraft,           src_NCOA,
  src_NCPDP,                   src_ND_Corporations,           src_ND_Experian_DL,          src_ND_Experian_Veh,
  src_ND_Veh,                  src_ND_Watercraft,             src_NE_Corporations,         src_NE_DL,
  src_NE_Experian_Veh,         src_NE_Veh,                    src_NE_Watercraft,           src_NH_Corporations,
  src_NH_Experian_DL,          src_NH_Watercraft,             src_NJ_Corporations,         src_NJ_Gaming_Licenses,
  src_NM_Corporations,         src_NM_DL,                     src_NM_Experian_Veh,         src_NM_Veh,
  src_NM_Watercraft,           src_NPPES,                     src_NV_Corporations,         src_NV_DL,
  src_NV_Experian_Veh,         src_NV_Veh,                    src_NV_Watercraft,           src_NY_Corporations,
  src_NY_Experian_Veh,         src_NY_Watercraft,             src_OH_Corporations,         src_OH_DL,
  src_OH_Experian_Veh,         src_OH_Liquor_Licenses,        src_OH_Veh,                  src_OH_Watercraft,
  src_OIG,                     src_OK_Corporations,           src_OK_Experian_Veh,         src_One_Click_Data,
  src_OR_Corporations,         src_OR_DL,                     src_OR_Experian_Veh,         src_OR_Watercraft,
  src_OR_Worker_Comp,          src_OSHAIR,                    src_OutwardMedia,            src_PA_CH,
  src_PA_Corporations,         src_PA_Liquor_Licenses,        src_PA_SO,                   src_PBSA,
  src_pcnsr,                   src_Phones_Plus,               src_POS,                     src_Professional_License,
  src_PSS,                     src_Redbooks,                  src_RI_Corporations,         src_RI_Experian_Veh,
  src_SalesChannel,            src_SC_Corporations,           src_SC_Experian_DL,          src_SC_Experian_Veh,
  src_SC_Watercraft,           src_SD_Corporations,           src_SD_Experian_Veh,         src_SDA,
  src_SDAA,                    src_SEC_Broker_Dealer,         src_sexoffender,             src_Sheila_Greco,
  src_SKA,                     src_Spoke,                     src_Targus_White_pages,      src_Tax_practitioner,
  src_TCOA_After_Address,      src_TCOA_Before_Address,       src_Teletrack,               src_Thrive_LT,
  src_Thrive_LT_POE_Email,     src_Thrive_PD,                 src_Thrive_PD_POE_Email,     src_TN_Corporations,
  src_TN_DL,                   src_TN_Experian_Veh,           src_TN_Watercraft,           src_TransUnion,
  src_TU_CreditHeader,         src_TUCS_Ptrack,               src_TX_Corporations,         src_TX_DL,
  src_TX_Experian_Veh,         src_TX_Liquor_Licenses,        src_TX_Veh,                  src_TX_Watercraft,
  src_TXBUS,                   src_UCC,                       src_UCCV2,                   src_UCCV2_WA_Hist,
  src_US_Coastguard,           src_UT_CH,                     src_UT_Corporations,         src_UT_DL,
  src_UT_Experian_Veh,         src_UT_SO,                     src_UT_Veh,                  src_UT_Watercraft,
  src_Util_Work_Phone,         src_Utilities,                 src_VA_Corporations,         src_VA_Watercraft,
  src_Vickers,                 src_Voters_v2,                 src_VT_Corporations,         src_VT_Experian_Veh,
  src_WA_Corporations,         src_WA_Experian_Veh,           src_WA_Watercraft,           src_Whois_domains,
  src_WI_Corporations,         src_WI_DL,                     src_WI_Experian_Veh,         src_WI_Veh,
  src_WI_Watercraft,           src_Wired_Assets_Email,        src_Wired_Assets_Owned,      src_Wired_Assets_Royalty,
  src_Wither_and_Die,          src_Workers_Compensation,      src_WV_Corporations,         src_WV_DL,
  src_WV_Experian_DL,          src_WV_Hist_Corporations,      src_WV_Watercraft,           src_WY_Corporations,
