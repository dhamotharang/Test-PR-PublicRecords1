...
EXPORT FromNone(DATASET(Corp2_Mapping.LayoutsCommon.Main) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.cont_title1_desc_Invalid := Fields.InValid_cont_title1_desc((SALT32.StrType)le.cont_title1_desc);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_vendor_Invalid << 14 ) + ( le.corp_state_origin_Invalid << 15 ) + ( le.corp_process_date_Invalid << 16 ) + ( le.corp_inc_state_Invalid << 18 ) + ( le.corp_forgn_date_Invalid << 19 ) + ( le.corp_inc_date_Invalid << 21 ) + ( le.corp_term_exist_exp_Invalid << 23 ) + ( le.corp_status_date_Invalid << 25 ) + ( le.corp_merger_effective_date_Invalid << 27 ) + ( le.corp_foreign_domestic_ind_Invalid << 29 ) + ( le.corp_for_profit_ind_Invalid << 30 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 31 ) + ( le.corp_legal_name_Invalid << 33 ) + ( le.corp_status_cd_Invalid << 34 ) + ( le.corp_forgn_state_desc_Invalid << 35 ) + ( le.corp_orig_org_structure_cd_Invalid << 36 ) + ( le.cont_title1_desc_Invalid << 37 ) + ( le.corp_ln_name_type_cd_Invalid << 38 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_inc_date_Invalid := (le.ScrubsBits1 >> 21) & 3;
    SELF.corp_term_exist_exp_Invalid := (le.ScrubsBits1 >> 23) & 3;
    SELF.corp_status_date_Invalid := (le.ScrubsBits1 >> 25) & 3;
    SELF.corp_merger_effective_date_Invalid := (le.ScrubsBits1 >> 27) & 3;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.corp_orig_sos_charter_nbr_Invalid := (le.ScrubsBits1 >> 31) & 3;
    SELF.corp_legal_name_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.corp_status_cd_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.corp_orig_org_structure_cd_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.cont_title1_desc_Invalid := (le.ScrubsBits1 >> 37) & 1;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.dt_vendor_first_reported_Invalid,le.dt_vendor_last_reported_Invalid,le.dt_first_seen_Invalid,le.dt_last_seen_Invalid,le.corp_ra_dt_first_seen_Invalid,le.corp_ra_dt_last_seen_Invalid,le.corp_key_Invalid,le.corp_vendor_Invalid,le.corp_state_origin_Invalid,le.corp_process_date_Invalid,le.corp_inc_state_Invalid,le.corp_forgn_date_Invalid,le.corp_inc_date_Invalid,le.corp_term_exist_exp_Invalid,le.corp_status_date_Invalid,le.corp_merger_effective_date_Invalid,le.corp_foreign_domestic_ind_Invalid,le.corp_for_profit_ind_Invalid,le.corp_orig_sos_charter_nbr_Invalid,le.corp_legal_name_Invalid,le.corp_status_cd_Invalid,le.corp_forgn_state_desc_Invalid,le.corp_orig_org_structure_cd_Invalid,le.cont_title1_desc_Invalid,le.corp_ln_name_type_cd_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Fields.InvalidMessage_dt_vendor_first_reported(le.dt_vendor_first_reported_Invalid),Fields.InvalidMessage_dt_vendor_last_reported(le.dt_vendor_last_reported_Invalid),Fields.InvalidMessage_dt_first_seen(le.dt_first_seen_Invalid),Fields.InvalidMessage_dt_last_seen(le.dt_last_seen_Invalid),Fields.InvalidMessage_corp_ra_dt_first_seen(le.corp_ra_dt_first_seen_Invalid),Fields.InvalidMessage_corp_ra_dt_last_seen(le.corp_ra_dt_last_seen_Invalid),Fields.InvalidMessage_corp_key(le.corp_key_Invalid),Fields.InvalidMessage_corp_vendor(le.corp_vendor_Invalid),Fields.InvalidMessage_corp_state_origin(le.corp_state_origin_Invalid),Fields.InvalidMessage_corp_process_date(le.corp_process_date_Invalid),Fields.InvalidMessage_corp_inc_state(le.corp_inc_state_Invalid),Fields.InvalidMessage_corp_forgn_date(le.corp_forgn_date_Invalid),Fields.InvalidMessage_corp_inc_date(le.corp_inc_date_Invalid),Fields.InvalidMessage_corp_term_exist_exp(le.corp_term_exist_exp_Invalid),Fields.InvalidMessage_corp_status_date(le.corp_status_date_Invalid),Fields.InvalidMessage_corp_merger_effective_date(le.corp_merger_effective_date_Invalid),Fields.InvalidMessage_corp_foreign_domestic_ind(le.corp_foreign_domestic_ind_Invalid),Fields.InvalidMessage_corp_for_profit_ind(le.corp_for_profit_ind_Invalid),Fields.InvalidMessage_corp_orig_sos_charter_nbr(le.corp_orig_sos_charter_nbr_Invalid),Fields.InvalidMessage_corp_legal_name(le.corp_legal_name_Invalid),Fields.InvalidMessage_corp_status_cd(le.corp_status_cd_Invalid),Fields.InvalidMessage_corp_forgn_state_desc(le.corp_forgn_state_desc_Invalid),Fields.InvalidMessage_corp_orig_org_structure_cd(le.corp_orig_org_structure_cd_Invalid),Fields.InvalidMessage_cont_title1_desc(le.cont_title1_desc_Invalid),Fields.InvalidMessage_corp_ln_name_type_cd(le.corp_ln_name_type_cd_Invalid),'UNKNOWN'));
    ...
    SELF.FieldContents := CHOOSE(c,(SALT32.StrType)le.dt_vendor_first_reported,(SALT32.StrType)le.dt_vendor_last_reported,(SALT32.StrType)le.dt_first_seen,(SALT32.StrType)le.dt_last_seen,(SALT32.StrType)le.corp_ra_dt_first_seen,(SALT32.StrType)le.corp_ra_dt_last_seen,(SALT32.StrType)le.corp_key,(SALT32.StrType)le.corp_vendor,(SALT32.StrType)le.corp_state_origin,(SALT32.StrType)le.corp_process_date,(SALT32.StrType)le.corp_inc_state,(SALT32.StrType)le.corp_forgn_date,(SALT32.StrType)le.corp_inc_date,(SALT32.StrType)le.corp_term_exist_exp,(SALT32.StrType)le.corp_status_date,(SALT32.StrType)le.corp_merger_effective_date,(SALT32.StrType)le.corp_foreign_domestic_ind,(SALT32.StrType)le.corp_for_profit_ind,(SALT32.StrType)le.corp_orig_sos_charter_nbr,(SALT32.StrType)le.corp_legal_name,(SALT32.StrType)le.corp_status_cd,(SALT32.StrType)le.corp_forgn_state_desc,(SALT32.StrType)le.corp_orig_org_structure_cd,(SALT32.StrType)le.cont_title1_desc,(SALT32.StrType)le.corp_ln_name_type_cd,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT32.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_forgn_state_desc:invalid_statecountry:ALLOW'
          ,'corp_orig_org_structure_cd:invalid_structure_cd:ENUM'
