...
Command line options: -MScrubs_Corp2_Mapping_IA_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR1512.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IA_Main
FILENAME:In_IA
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(4..14)
FIELDTYPE:invalid_charter:ALLOW(0123456789-):LENGTHS(1..11)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_corp_vendor:ENUM(19)
FIELDTYPE:invalid_state_origin:ENUM(IA)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(Y|N| )
FIELDTYPE:invalid_corp_status_cd:ENUM(A|D|R| )
FIELDTYPE:invalid_statecountry:ALLOW( ,()ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_structure_cd:ENUM(set_valid_chapter)
FIELDTYPE:invalid_cont_title1_desc:ENUM(set_valid_officer)
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_IA_Main.Functions.invalid_name_type_code>0,recordOrigin)
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_statecountry):0,0
FIELD:corp_orig_org_structure_cd:TYPE(STRING8):LIKE(invalid_structure_cd):0,0
