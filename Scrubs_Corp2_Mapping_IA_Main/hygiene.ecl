IMPORT ut,SALT32;
EXPORT hygiene(dataset(layout_In_IA) h) := MODULE
...
EXPORT Summary(SALT32.Str30Type txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_key_pcnt *   0.00 / 100 + T.Populated_corp_vendor_pcnt *   0.00 / 100 + T.Populated_corp_state_origin_pcnt *   0.00 / 100 + T.Populated_corp_process_date_pcnt *   0.00 / 100 + T.Populated_corp_inc_state_pcnt *   0.00 / 100 + T.Populated_corp_forgn_date_pcnt *   0.00 / 100 + T.Populated_corp_inc_date_pcnt *   0.00 / 100 + T.Populated_corp_term_exist_exp_pcnt *   0.00 / 100 + T.Populated_corp_status_date_pcnt *   0.00 / 100 + T.Populated_corp_merger_effective_date_pcnt *   0.00 / 100 + T.Populated_corp_foreign_domestic_ind_pcnt *   0.00 / 100 + T.Populated_corp_for_profit_ind_pcnt *   0.00 / 100 + T.Populated_corp_orig_sos_charter_nbr_pcnt *   0.00 / 100 + T.Populated_corp_legal_name_pcnt *   0.00 / 100 + T.Populated_corp_status_cd_pcnt *   0.00 / 100 + T.Populated_corp_forgn_state_desc_pcnt *   0.00 / 100 + T.Populated_corp_orig_org_structure_cd_pcnt *   0.00 / 100 + T.Populated_cont_title1_desc_pcnt *   0.00 / 100 + T.Populated_corp_ln_name_type_cd_pcnt *   0.00 / 100 + T.Populated_recordorigin_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_vendor_first_reported_pcnt,le.populated_dt_vendor_last_reported_pcnt,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_corp_ra_dt_first_seen_pcnt,le.populated_corp_ra_dt_last_seen_pcnt,le.populated_corp_key_pcnt,le.populated_corp_vendor_pcnt,le.populated_corp_state_origin_pcnt,le.populated_corp_process_date_pcnt,le.populated_corp_inc_state_pcnt,le.populated_corp_forgn_date_pcnt,le.populated_corp_inc_date_pcnt,le.populated_corp_term_exist_exp_pcnt,le.populated_corp_status_date_pcnt,le.populated_corp_merger_effective_date_pcnt,le.populated_corp_foreign_domestic_ind_pcnt,le.populated_corp_for_profit_ind_pcnt,le.populated_corp_orig_sos_charter_nbr_pcnt,le.populated_corp_legal_name_pcnt,le.populated_corp_status_cd_pcnt,le.populated_corp_forgn_state_desc_pcnt,le.populated_corp_orig_org_structure_cd_pcnt,le.populated_cont_title1_desc_pcnt,le.populated_corp_ln_name_type_cd_pcnt,le.populated_recordorigin_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_corp_ra_dt_first_seen,le.maxlength_corp_ra_dt_last_seen,le.maxlength_corp_key,le.maxlength_corp_vendor,le.maxlength_corp_state_origin,le.maxlength_corp_process_date,le.maxlength_corp_inc_state,le.maxlength_corp_forgn_date,le.maxlength_corp_inc_date,le.maxlength_corp_term_exist_exp,le.maxlength_corp_status_date,le.maxlength_corp_merger_effective_date,le.maxlength_corp_foreign_domestic_ind,le.maxlength_corp_for_profit_ind,le.maxlength_corp_orig_sos_charter_nbr,le.maxlength_corp_legal_name,le.maxlength_corp_status_cd,le.maxlength_corp_forgn_state_desc,le.maxlength_corp_orig_org_structure_cd,le.maxlength_cont_title1_desc,le.maxlength_corp_ln_name_type_cd,le.maxlength_recordorigin);
  SELF.avelength := CHOOSE(C,le.avelength_dt_vendor_first_reported,le.avelength_dt_vendor_last_reported,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_corp_ra_dt_first_seen,le.avelength_corp_ra_dt_last_seen,le.avelength_corp_key,le.avelength_corp_vendor,le.avelength_corp_state_origin,le.avelength_corp_process_date,le.avelength_corp_inc_state,le.avelength_corp_forgn_date,le.avelength_corp_inc_date,le.avelength_corp_term_exist_exp,le.avelength_corp_status_date,le.avelength_corp_merger_effective_date,le.avelength_corp_foreign_domestic_ind,le.avelength_corp_for_profit_ind,le.avelength_corp_orig_sos_charter_nbr,le.avelength_corp_legal_name,le.avelength_corp_status_cd,le.avelength_corp_forgn_state_desc,le.avelength_corp_orig_org_structure_cd,le.avelength_cont_title1_desc,le.avelength_corp_ln_name_type_cd,le.avelength_recordorigin);
END;
...
SALT32.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT32.StrType)le.dt_vendor_first_reported),TRIM((SALT32.StrType)le.dt_vendor_last_reported),TRIM((SALT32.StrType)le.dt_first_seen),TRIM((SALT32.StrType)le.dt_last_seen),TRIM((SALT32.StrType)le.corp_ra_dt_first_seen),TRIM((SALT32.StrType)le.corp_ra_dt_last_seen),TRIM((SALT32.StrType)le.corp_key),TRIM((SALT32.StrType)le.corp_vendor),TRIM((SALT32.StrType)le.corp_state_origin),TRIM((SALT32.StrType)le.corp_process_date),TRIM((SALT32.StrType)le.corp_inc_state),TRIM((SALT32.StrType)le.corp_forgn_date),TRIM((SALT32.StrType)le.corp_inc_date),TRIM((SALT32.StrType)le.corp_term_exist_exp),TRIM((SALT32.StrType)le.corp_status_date),TRIM((SALT32.StrType)le.corp_merger_effective_date),TRIM((SALT32.StrType)le.corp_foreign_domestic_ind),TRIM((SALT32.StrType)le.corp_for_profit_ind),TRIM((SALT32.StrType)le.corp_orig_sos_charter_nbr),TRIM((SALT32.StrType)le.corp_legal_name),TRIM((SALT32.StrType)le.corp_status_cd),TRIM((SALT32.StrType)le.corp_forgn_state_desc),TRIM((SALT32.StrType)le.corp_orig_org_structure_cd),TRIM((SALT32.StrType)le.cont_title1_desc),TRIM((SALT32.StrType)le.corp_ln_name_type_cd),TRIM((SALT32.StrType)le.recordorigin)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{15,'corp_status_date'}
      ,{16,'corp_merger_effective_date'}
      ,{17,'corp_foreign_domestic_ind'}
      ,{18,'corp_for_profit_ind'}
      ,{19,'corp_orig_sos_charter_nbr'}
      ,{20,'corp_legal_name'}
      ,{21,'corp_status_cd'}
      ,{22,'corp_forgn_state_desc'}
      ,{23,'corp_orig_org_structure_cd'}
      ,{24,'cont_title1_desc'}
      ,{25,'corp_ln_name_type_cd'}
      ,{26,'recordorigin'}],SALT32.MAC_Character_Counts.Field_Identification);
