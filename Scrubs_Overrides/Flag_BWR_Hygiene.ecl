...
#workunit('name','Scrubs_Overrides.Flag_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_Overrides,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Overrides.Flag_In_Overrides;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Overrides.Flag_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Flag_Layout_Overrides'),NAMED('OptimizedLayout'));// File layout suggested by data
