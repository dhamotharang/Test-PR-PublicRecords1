...
EXPORT PROC_BUILD_npi(String pversion) := FUNCTION
npi_Layout:=RECORD
 string10 billing_npi_number;
  ...
  integer2 billing_npi_number_weight100;
 ...
 npi_Build :=  DATASET([ ],npi_layout);
 npi_key := INDEX(npi_Build,
 {billing_npi_number,
   lnpid,
   fname_preferredname,
   fname,
   ...
   lic_state_weight100},{npi_Build},
	 prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::billing::npi'); 
