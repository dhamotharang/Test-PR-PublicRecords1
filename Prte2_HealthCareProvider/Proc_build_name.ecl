...
EXPORT PROC_BUILD_name(String pversion) := FUNCTION
name_layout:=RECORD
  string28 lname;
  string5 zip;
  string25 c_lic_nbr;
 ...
 name_Build :=  DATASET([ ],name_layout);
 name_key := INDEX(name_Build,
 {lname,
 zip,
 c_lic_nbr,
 gender,
...
lic_state,
 ...
 dob_month_weight100,
  ...
  billing_tax_id_weight100},{name_Build},
	prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::name'); 
