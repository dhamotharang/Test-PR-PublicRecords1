...
EXPORT PROC_BUILD_lname(String pversion) := FUNCTION
lname_layout:=RECORD
  string28 lname;
  string5 zip;
  string1 gender;
 ...
 lname_Build :=  DATASET([ ],lname_layout);
 lname_key := INDEX(lname_Build,
  {lname,
  zip,
  gender,
  lnpid,
 ...
 mname_e1_weight100,
  ...
  billing_tax_id_weight100},{lname_Build},
	
	prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::lname'); 
  
	BUILDindex(lname_Key);
