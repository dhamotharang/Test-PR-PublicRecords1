...
EXPORT PROC_BUILD_npi2(String pversion) := FUNCTION
npi2_layout:=RECORD
  string10 npi_number;
  unsigned6 lnpid;
 ...
 END;
 npi2_Build :=  DATASET([ ],npi2_layout);
 npi2_key := INDEX(npi2_Build,
{ npi_number,
 lnpid,
 fname_preferredname,
 fname,
...
lic_state,
 ...
 lname_e1_weight100,
  ...
  lic_state_weight100},{npi2_Build},
	 prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::npi'); 
