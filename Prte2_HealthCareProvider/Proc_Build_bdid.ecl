...
EXPORT PROC_BUILD_bdid(String pversion) := FUNCTION
bdid_layout:=RECORD
  unsigned8 bdid;
  unsigned6 lnpid;
 ...
 bdid_Build :=  DATASET([ ],bdid_layout);
 bdid_key := INDEX(bdid_Build,
 {bdid,
  lnpid,
  fname_preferredname,
  fname,
 ...
 mname_p_weight100,
  mname_e1_weight100,
   ...
   lic_state_weight100},{bdid_Build},
	 prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::bdid'); 
