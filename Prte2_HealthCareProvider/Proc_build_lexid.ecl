...
EXPORT PROC_BUILD_lexid(String pversion) := FUNCTION
lexid_layout:=RECORD
  unsigned8 did;
  unsigned6 lnpid;
 ...
 lexid_Build :=  DATASET([ ],lexid_layout);
 ...
 lic_state_weight100} ,{lexid_Build},
 	 prte2.constants.prefix + 'key::healthcareprovider::' + pversion + '::lexid'); 
  
	BUILDindex(lexid_Key);
