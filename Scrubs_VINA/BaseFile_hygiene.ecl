...
EXPORT Summary(SALT31.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_match_make := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_make)));
    avelength_match_make := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_make)),h.match_make<>(typeof(h.match_make))'');
    populated_match_year_pcnt := AVE(GROUP,IF(h.match_year = (TYPEOF(h.match_year))'',0,100));
    maxlength_match_year := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_year)));
    avelength_match_year := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_year)),h.match_year<>(typeof(h.match_year))'');
    populated_match_vin_pcnt := AVE(GROUP,IF(h.match_vin = (TYPEOF(h.match_vin))'',0,100));
    maxlength_match_vin := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_vin)));
    avelength_match_vin := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.match_vin)),h.match_vin<>(typeof(h.match_vin))'');
    populated_make_abbreviation_pcnt := AVE(GROUP,IF(h.make_abbreviation = (TYPEOF(h.make_abbreviation))'',0,100));
    maxlength_make_abbreviation := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.make_abbreviation)));
    avelength_make_abbreviation := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.make_abbreviation)),h.make_abbreviation<>(typeof(h.make_abbreviation))'');
    populated_model_year_pcnt := AVE(GROUP,IF(h.model_year = (TYPEOF(h.model_year))'',0,100));
    maxlength_model_year := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.model_year)));
    avelength_model_year := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.model_year)),h.model_year<>(typeof(h.model_year))'');
    populated_vehicle_type_pcnt := AVE(GROUP,IF(h.vehicle_type = (TYPEOF(h.vehicle_type))'',0,100));
    maxlength_vehicle_type := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.vehicle_type)));
    avelength_vehicle_type := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.vehicle_type)),h.vehicle_type<>(typeof(h.vehicle_type))'');
    populated_make_name_pcnt := AVE(GROUP,IF(h.make_name = (TYPEOF(h.make_name))'',0,100));
    maxlength_make_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.make_name)));
    avelength_make_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.make_name)),h.make_name<>(typeof(h.make_name))'');
    populated_series_name_pcnt := AVE(GROUP,IF(h.series_name = (TYPEOF(h.series_name))'',0,100));
    maxlength_series_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name)));
    avelength_series_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name)),h.series_name<>(typeof(h.series_name))'');
    populated_body_type_pcnt := AVE(GROUP,IF(h.body_type = (TYPEOF(h.body_type))'',0,100));
    maxlength_body_type := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.body_type)));
    avelength_body_type := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.body_type)),h.body_type<>(typeof(h.body_type))'');
    populated_wheels_pcnt := AVE(GROUP,IF(h.wheels = (TYPEOF(h.wheels))'',0,100));
    maxlength_wheels := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.wheels)));
    avelength_wheels := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.wheels)),h.wheels<>(typeof(h.wheels))'');
    populated_displacement_pcnt := AVE(GROUP,IF(h.displacement = (TYPEOF(h.displacement))'',0,100));
    maxlength_displacement := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.displacement)));
    avelength_displacement := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.displacement)),h.displacement<>(typeof(h.displacement))'');
    populated_cylinders_pcnt := AVE(GROUP,IF(h.cylinders = (TYPEOF(h.cylinders))'',0,100));
    maxlength_cylinders := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.cylinders)));
    avelength_cylinders := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.cylinders)),h.cylinders<>(typeof(h.cylinders))'');
    populated_fuel_pcnt := AVE(GROUP,IF(h.fuel = (TYPEOF(h.fuel))'',0,100));
    maxlength_fuel := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.fuel)));
    avelength_fuel := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.fuel)),h.fuel<>(typeof(h.fuel))'');
    populated_carburetion_pcnt := AVE(GROUP,IF(h.carburetion = (TYPEOF(h.carburetion))'',0,100));
    maxlength_carburetion := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.carburetion)));
    avelength_carburetion := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.carburetion)),h.carburetion<>(typeof(h.carburetion))'');
    populated_gvw_pcnt := AVE(GROUP,IF(h.gvw = (TYPEOF(h.gvw))'',0,100));
    maxlength_gvw := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.gvw)));
    avelength_gvw := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.gvw)),h.gvw<>(typeof(h.gvw))'');
    populated_wheel_base_pcnt := AVE(GROUP,IF(h.wheel_base = (TYPEOF(h.wheel_base))'',0,100));
    maxlength_wheel_base := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.wheel_base)));
    avelength_wheel_base := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.wheel_base)),h.wheel_base<>(typeof(h.wheel_base))'');
    populated_tire_size_pcnt := AVE(GROUP,IF(h.tire_size = (TYPEOF(h.tire_size))'',0,100));
    maxlength_tire_size := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.tire_size)));
    avelength_tire_size := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.tire_size)),h.tire_size<>(typeof(h.tire_size))'');
    populated_ton_rating_pcnt := AVE(GROUP,IF(h.ton_rating = (TYPEOF(h.ton_rating))'',0,100));
    maxlength_ton_rating := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.ton_rating)));
    avelength_ton_rating := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.ton_rating)),h.ton_rating<>(typeof(h.ton_rating))'');
    populated_base_shipping_weight_pcnt := AVE(GROUP,IF(h.base_shipping_weight = (TYPEOF(h.base_shipping_weight))'',0,100));
    maxlength_base_shipping_weight := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_shipping_weight)));
    avelength_base_shipping_weight := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_shipping_weight)),h.base_shipping_weight<>(typeof(h.base_shipping_weight))'');
    populated_variance_weight_pcnt := AVE(GROUP,IF(h.variance_weight = (TYPEOF(h.variance_weight))'',0,100));
    maxlength_variance_weight := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.variance_weight)));
    avelength_variance_weight := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.variance_weight)),h.variance_weight<>(typeof(h.variance_weight))'');
    populated_base_list_price_pcnt := AVE(GROUP,IF(h.base_list_price = (TYPEOF(h.base_list_price))'',0,100));
    maxlength_base_list_price := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_list_price)));
    avelength_base_list_price := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_list_price)),h.base_list_price<>(typeof(h.base_list_price))'');
    populated_price_variance_pcnt := AVE(GROUP,IF(h.price_variance = (TYPEOF(h.price_variance))'',0,100));
    maxlength_price_variance := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.price_variance)));
    avelength_price_variance := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.price_variance)),h.price_variance<>(typeof(h.price_variance))'');
    populated_high_performance_code_pcnt := AVE(GROUP,IF(h.high_performance_code = (TYPEOF(h.high_performance_code))'',0,100));
    maxlength_high_performance_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.high_performance_code)));
    avelength_high_performance_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.high_performance_code)),h.high_performance_code<>(typeof(h.high_performance_code))'');
    populated_driving_wheels_pcnt := AVE(GROUP,IF(h.driving_wheels = (TYPEOF(h.driving_wheels))'',0,100));
    maxlength_driving_wheels := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.driving_wheels)));
    avelength_driving_wheels := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.driving_wheels)),h.driving_wheels<>(typeof(h.driving_wheels))'');
    populated_iso_physical_damage_pcnt := AVE(GROUP,IF(h.iso_physical_damage = (TYPEOF(h.iso_physical_damage))'',0,100));
    maxlength_iso_physical_damage := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.iso_physical_damage)));
    avelength_iso_physical_damage := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.iso_physical_damage)),h.iso_physical_damage<>(typeof(h.iso_physical_damage))'');
    populated_location_indicator_pcnt := AVE(GROUP,IF(h.location_indicator = (TYPEOF(h.location_indicator))'',0,100));
    maxlength_location_indicator := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.location_indicator)));
    avelength_location_indicator := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.location_indicator)),h.location_indicator<>(typeof(h.location_indicator))'');
    populated_air_conditioning_pcnt := AVE(GROUP,IF(h.air_conditioning = (TYPEOF(h.air_conditioning))'',0,100));
    maxlength_air_conditioning := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.air_conditioning)));
    avelength_air_conditioning := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.air_conditioning)),h.air_conditioning<>(typeof(h.air_conditioning))'');
    populated_power_steering_pcnt := AVE(GROUP,IF(h.power_steering = (TYPEOF(h.power_steering))'',0,100));
    maxlength_power_steering := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_steering)));
    avelength_power_steering := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_steering)),h.power_steering<>(typeof(h.power_steering))'');
    populated_power_brakes_pcnt := AVE(GROUP,IF(h.power_brakes = (TYPEOF(h.power_brakes))'',0,100));
    maxlength_power_brakes := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_brakes)));
    avelength_power_brakes := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_brakes)),h.power_brakes<>(typeof(h.power_brakes))'');
    populated_power_windows_pcnt := AVE(GROUP,IF(h.power_windows = (TYPEOF(h.power_windows))'',0,100));
    maxlength_power_windows := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_windows)));
    avelength_power_windows := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.power_windows)),h.power_windows<>(typeof(h.power_windows))'');
    populated_tilt_wheel_pcnt := AVE(GROUP,IF(h.tilt_wheel = (TYPEOF(h.tilt_wheel))'',0,100));
    maxlength_tilt_wheel := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.tilt_wheel)));
    avelength_tilt_wheel := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.tilt_wheel)),h.tilt_wheel<>(typeof(h.tilt_wheel))'');
    populated_roof_pcnt := AVE(GROUP,IF(h.roof = (TYPEOF(h.roof))'',0,100));
    maxlength_roof := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.roof)));
    avelength_roof := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.roof)),h.roof<>(typeof(h.roof))'');
    populated_optional_roof1_pcnt := AVE(GROUP,IF(h.optional_roof1 = (TYPEOF(h.optional_roof1))'',0,100));
    maxlength_optional_roof1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_roof1)));
    avelength_optional_roof1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_roof1)),h.optional_roof1<>(typeof(h.optional_roof1))'');
    populated_optional_roof2_pcnt := AVE(GROUP,IF(h.optional_roof2 = (TYPEOF(h.optional_roof2))'',0,100));
    maxlength_optional_roof2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_roof2)));
    avelength_optional_roof2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_roof2)),h.optional_roof2<>(typeof(h.optional_roof2))'');
    populated_radio_pcnt := AVE(GROUP,IF(h.radio = (TYPEOF(h.radio))'',0,100));
    maxlength_radio := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.radio)));
    avelength_radio := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.radio)),h.radio<>(typeof(h.radio))'');
    populated_optional_radio1_pcnt := AVE(GROUP,IF(h.optional_radio1 = (TYPEOF(h.optional_radio1))'',0,100));
    maxlength_optional_radio1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_radio1)));
    avelength_optional_radio1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_radio1)),h.optional_radio1<>(typeof(h.optional_radio1))'');
    populated_optional_radio2_pcnt := AVE(GROUP,IF(h.optional_radio2 = (TYPEOF(h.optional_radio2))'',0,100));
    maxlength_optional_radio2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_radio2)));
    avelength_optional_radio2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_radio2)),h.optional_radio2<>(typeof(h.optional_radio2))'');
    populated_transmission_pcnt := AVE(GROUP,IF(h.transmission = (TYPEOF(h.transmission))'',0,100));
    maxlength_transmission := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission)));
    avelength_transmission := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission)),h.transmission<>(typeof(h.transmission))'');
    populated_optional_transmission1_pcnt := AVE(GROUP,IF(h.optional_transmission1 = (TYPEOF(h.optional_transmission1))'',0,100));
    maxlength_optional_transmission1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_transmission1)));
    avelength_optional_transmission1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_transmission1)),h.optional_transmission1<>(typeof(h.optional_transmission1))'');
    populated_optional_transmission2_pcnt := AVE(GROUP,IF(h.optional_transmission2 = (TYPEOF(h.optional_transmission2))'',0,100));
    maxlength_optional_transmission2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_transmission2)));
    avelength_optional_transmission2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.optional_transmission2)),h.optional_transmission2<>(typeof(h.optional_transmission2))'');
    populated_anti_lock_brakes_pcnt := AVE(GROUP,IF(h.anti_lock_brakes = (TYPEOF(h.anti_lock_brakes))'',0,100));
    maxlength_anti_lock_brakes := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.anti_lock_brakes)));
    avelength_anti_lock_brakes := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.anti_lock_brakes)),h.anti_lock_brakes<>(typeof(h.anti_lock_brakes))'');
    populated_security_system_pcnt := AVE(GROUP,IF(h.security_system = (TYPEOF(h.security_system))'',0,100));
    maxlength_security_system := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.security_system)));
    avelength_security_system := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.security_system)),h.security_system<>(typeof(h.security_system))'');
    populated_daytime_running_lights_pcnt := AVE(GROUP,IF(h.daytime_running_lights = (TYPEOF(h.daytime_running_lights))'',0,100));
    maxlength_daytime_running_lights := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.daytime_running_lights)));
    avelength_daytime_running_lights := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.daytime_running_lights)),h.daytime_running_lights<>(typeof(h.daytime_running_lights))'');
    populated_visrap_pcnt := AVE(GROUP,IF(h.visrap = (TYPEOF(h.visrap))'',0,100));
    maxlength_visrap := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.visrap)));
    avelength_visrap := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.visrap)),h.visrap<>(typeof(h.visrap))'');
    populated_cab_configuration_pcnt := AVE(GROUP,IF(h.cab_configuration = (TYPEOF(h.cab_configuration))'',0,100));
    maxlength_cab_configuration := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.cab_configuration)));
    avelength_cab_configuration := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.cab_configuration)),h.cab_configuration<>(typeof(h.cab_configuration))'');
    populated_front_axle_code_pcnt := AVE(GROUP,IF(h.front_axle_code = (TYPEOF(h.front_axle_code))'',0,100));
    maxlength_front_axle_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.front_axle_code)));
    avelength_front_axle_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.front_axle_code)),h.front_axle_code<>(typeof(h.front_axle_code))'');
    populated_rear_axle_code_pcnt := AVE(GROUP,IF(h.rear_axle_code = (TYPEOF(h.rear_axle_code))'',0,100));
    maxlength_rear_axle_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.rear_axle_code)));
    avelength_rear_axle_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.rear_axle_code)),h.rear_axle_code<>(typeof(h.rear_axle_code))'');
    populated_brakes_code_pcnt := AVE(GROUP,IF(h.brakes_code = (TYPEOF(h.brakes_code))'',0,100));
    maxlength_brakes_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.brakes_code)));
    avelength_brakes_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.brakes_code)),h.brakes_code<>(typeof(h.brakes_code))'');
    populated_engine_manufacturer_pcnt := AVE(GROUP,IF(h.engine_manufacturer = (TYPEOF(h.engine_manufacturer))'',0,100));
    maxlength_engine_manufacturer := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_manufacturer)));
    avelength_engine_manufacturer := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_manufacturer)),h.engine_manufacturer<>(typeof(h.engine_manufacturer))'');
    populated_engine_model_pcnt := AVE(GROUP,IF(h.engine_model = (TYPEOF(h.engine_model))'',0,100));
    maxlength_engine_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_model)));
    avelength_engine_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_model)),h.engine_model<>(typeof(h.engine_model))'');
    populated_engine_type_code_pcnt := AVE(GROUP,IF(h.engine_type_code = (TYPEOF(h.engine_type_code))'',0,100));
    maxlength_engine_type_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_type_code)));
    avelength_engine_type_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_type_code)),h.engine_type_code<>(typeof(h.engine_type_code))'');
    populated_trailer_body_style_pcnt := AVE(GROUP,IF(h.trailer_body_style = (TYPEOF(h.trailer_body_style))'',0,100));
    maxlength_trailer_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_body_style)));
    avelength_trailer_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_body_style)),h.trailer_body_style<>(typeof(h.trailer_body_style))'');
    populated_trailer_number_of_axles_pcnt := AVE(GROUP,IF(h.trailer_number_of_axles = (TYPEOF(h.trailer_number_of_axles))'',0,100));
    maxlength_trailer_number_of_axles := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_number_of_axles)));
    avelength_trailer_number_of_axles := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_number_of_axles)),h.trailer_number_of_axles<>(typeof(h.trailer_number_of_axles))'');
    populated_trailer_length_pcnt := AVE(GROUP,IF(h.trailer_length = (TYPEOF(h.trailer_length))'',0,100));
    maxlength_trailer_length := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_length)));
    avelength_trailer_length := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.trailer_length)),h.trailer_length<>(typeof(h.trailer_length))'');
    populated_proactive_vin_pcnt := AVE(GROUP,IF(h.proactive_vin = (TYPEOF(h.proactive_vin))'',0,100));
    maxlength_proactive_vin := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.proactive_vin)));
    avelength_proactive_vin := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.proactive_vin)),h.proactive_vin<>(typeof(h.proactive_vin))'');
    populated_ma_state_exceptions_pcnt := AVE(GROUP,IF(h.ma_state_exceptions = (TYPEOF(h.ma_state_exceptions))'',0,100));
    maxlength_ma_state_exceptions := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.ma_state_exceptions)));
    avelength_ma_state_exceptions := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.ma_state_exceptions)),h.ma_state_exceptions<>(typeof(h.ma_state_exceptions))'');
    populated_filler_1_pcnt := AVE(GROUP,IF(h.filler_1 = (TYPEOF(h.filler_1))'',0,100));
    maxlength_filler_1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler_1)));
    avelength_filler_1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler_1)),h.filler_1<>(typeof(h.filler_1))'');
    populated_series_abbreviation_pcnt := AVE(GROUP,IF(h.series_abbreviation = (TYPEOF(h.series_abbreviation))'',0,100));
    maxlength_series_abbreviation := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_abbreviation)));
    avelength_series_abbreviation := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_abbreviation)),h.series_abbreviation<>(typeof(h.series_abbreviation))'');
    populated_vin_pattern_pcnt := AVE(GROUP,IF(h.vin_pattern = (TYPEOF(h.vin_pattern))'',0,100));
    maxlength_vin_pattern := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.vin_pattern)));
    avelength_vin_pattern := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.vin_pattern)),h.vin_pattern<>(typeof(h.vin_pattern))'');
    populated_ncic_data_pcnt := AVE(GROUP,IF(h.ncic_data = (TYPEOF(h.ncic_data))'',0,100));
    maxlength_ncic_data := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.ncic_data)));
    avelength_ncic_data := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.ncic_data)),h.ncic_data<>(typeof(h.ncic_data))'');
    populated_full_body_style_name_pcnt := AVE(GROUP,IF(h.full_body_style_name = (TYPEOF(h.full_body_style_name))'',0,100));
    maxlength_full_body_style_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.full_body_style_name)));
    avelength_full_body_style_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.full_body_style_name)),h.full_body_style_name<>(typeof(h.full_body_style_name))'');
    populated_nvpp_make_code_pcnt := AVE(GROUP,IF(h.nvpp_make_code = (TYPEOF(h.nvpp_make_code))'',0,100));
    maxlength_nvpp_make_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_make_code)));
    avelength_nvpp_make_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_make_code)),h.nvpp_make_code<>(typeof(h.nvpp_make_code))'');
    populated_nvpp_make_abbreviation_pcnt := AVE(GROUP,IF(h.nvpp_make_abbreviation = (TYPEOF(h.nvpp_make_abbreviation))'',0,100));
    maxlength_nvpp_make_abbreviation := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_make_abbreviation)));
    avelength_nvpp_make_abbreviation := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_make_abbreviation)),h.nvpp_make_abbreviation<>(typeof(h.nvpp_make_abbreviation))'');
    populated_nvpp_series_model_pcnt := AVE(GROUP,IF(h.nvpp_series_model = (TYPEOF(h.nvpp_series_model))'',0,100));
    maxlength_nvpp_series_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_series_model)));
    avelength_nvpp_series_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_series_model)),h.nvpp_series_model<>(typeof(h.nvpp_series_model))'');
    populated_nvpp_series_name_pcnt := AVE(GROUP,IF(h.nvpp_series_name = (TYPEOF(h.nvpp_series_name))'',0,100));
    maxlength_nvpp_series_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_series_name)));
    avelength_nvpp_series_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.nvpp_series_name)),h.nvpp_series_name<>(typeof(h.nvpp_series_name))'');
    populated_segmentation_code_pcnt := AVE(GROUP,IF(h.segmentation_code = (TYPEOF(h.segmentation_code))'',0,100));
    maxlength_segmentation_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.segmentation_code)));
    avelength_segmentation_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.segmentation_code)),h.segmentation_code<>(typeof(h.segmentation_code))'');
    populated_country_of_origin_pcnt := AVE(GROUP,IF(h.country_of_origin = (TYPEOF(h.country_of_origin))'',0,100));
    maxlength_country_of_origin := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.country_of_origin)));
    avelength_country_of_origin := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.country_of_origin)),h.country_of_origin<>(typeof(h.country_of_origin))'');
    populated_engine_liter_information_pcnt := AVE(GROUP,IF(h.engine_liter_information = (TYPEOF(h.engine_liter_information))'',0,100));
    maxlength_engine_liter_information := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_liter_information)));
    avelength_engine_liter_information := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_liter_information)),h.engine_liter_information<>(typeof(h.engine_liter_information))'');
    ...
    maxlength_engine_information_filler1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler1)));
    avelength_engine_information_filler1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler1)),h.engine_information_filler1<>(typeof(h.engine_information_filler1))'');
    ...
    maxlength_engine_information_block_type := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_block_type)));
    avelength_engine_information_block_type := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_block_type)),h.engine_information_block_type<>(typeof(h.engine_information_block_type))'');
    ...
    maxlength_engine_information_cylinders := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_cylinders)));
    avelength_engine_information_cylinders := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_cylinders)),h.engine_information_cylinders<>(typeof(h.engine_information_cylinders))'');
    ...
    maxlength_engine_information_filler2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler2)));
    avelength_engine_information_filler2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler2)),h.engine_information_filler2<>(typeof(h.engine_information_filler2))'');
    ...
    maxlength_engine_information_carburetion := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_carburetion)));
    avelength_engine_information_carburetion := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_carburetion)),h.engine_information_carburetion<>(typeof(h.engine_information_carburetion))'');
    ...
    maxlength_engine_information_filler3 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler3)));
    avelength_engine_information_filler3 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler3)),h.engine_information_filler3<>(typeof(h.engine_information_filler3))'');
    ...
    maxlength_engine_information_head_configuration := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_head_configuration)));
    avelength_engine_information_head_configuration := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_head_configuration)),h.engine_information_head_configuration<>(typeof(h.engine_information_head_configuration))'');
    ...
    maxlength_engine_information_filler4 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler4)));
    avelength_engine_information_filler4 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler4)),h.engine_information_filler4<>(typeof(h.engine_information_filler4))'');
    ...
    maxlength_engine_information_total_valves := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_total_valves)));
    avelength_engine_information_total_valves := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_total_valves)),h.engine_information_total_valves<>(typeof(h.engine_information_total_valves))'');
    ...
    maxlength_engine_information_filler5 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler5)));
    avelength_engine_information_filler5 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_filler5)),h.engine_information_filler5<>(typeof(h.engine_information_filler5))'');
    ...
    maxlength_engine_information_aspiration_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_aspiration_code)));
    avelength_engine_information_aspiration_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_aspiration_code)),h.engine_information_aspiration_code<>(typeof(h.engine_information_aspiration_code))'');
    ...
    maxlength_engine_information_carburetion_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_carburetion_code)));
    avelength_engine_information_carburetion_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_carburetion_code)),h.engine_information_carburetion_code<>(typeof(h.engine_information_carburetion_code))'');
    ...
    maxlength_engine_information_valves_per_cylinder := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_valves_per_cylinder)));
    avelength_engine_information_valves_per_cylinder := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_information_valves_per_cylinder)),h.engine_information_valves_per_cylinder<>(typeof(h.engine_information_valves_per_cylinder))'');
    populated_transmission_speed_pcnt := AVE(GROUP,IF(h.transmission_speed = (TYPEOF(h.transmission_speed))'',0,100));
    maxlength_transmission_speed := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_speed)));
    avelength_transmission_speed := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_speed)),h.transmission_speed<>(typeof(h.transmission_speed))'');
    populated_transmission_filler1_pcnt := AVE(GROUP,IF(h.transmission_filler1 = (TYPEOF(h.transmission_filler1))'',0,100));
    maxlength_transmission_filler1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler1)));
    avelength_transmission_filler1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler1)),h.transmission_filler1<>(typeof(h.transmission_filler1))'');
    populated_transmission_type_pcnt := AVE(GROUP,IF(h.transmission_type = (TYPEOF(h.transmission_type))'',0,100));
    maxlength_transmission_type := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_type)));
    avelength_transmission_type := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_type)),h.transmission_type<>(typeof(h.transmission_type))'');
    populated_transmission_filler2_pcnt := AVE(GROUP,IF(h.transmission_filler2 = (TYPEOF(h.transmission_filler2))'',0,100));
    maxlength_transmission_filler2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler2)));
    avelength_transmission_filler2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler2)),h.transmission_filler2<>(typeof(h.transmission_filler2))'');
    populated_transmission_code_pcnt := AVE(GROUP,IF(h.transmission_code = (TYPEOF(h.transmission_code))'',0,100));
    maxlength_transmission_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_code)));
    avelength_transmission_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_code)),h.transmission_code<>(typeof(h.transmission_code))'');
    populated_transmission_filler3_pcnt := AVE(GROUP,IF(h.transmission_filler3 = (TYPEOF(h.transmission_filler3))'',0,100));
    maxlength_transmission_filler3 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler3)));
    avelength_transmission_filler3 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_filler3)),h.transmission_filler3<>(typeof(h.transmission_filler3))'');
    populated_transmission_speed_code_pcnt := AVE(GROUP,IF(h.transmission_speed_code = (TYPEOF(h.transmission_speed_code))'',0,100));
    maxlength_transmission_speed_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_speed_code)));
    avelength_transmission_speed_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.transmission_speed_code)),h.transmission_speed_code<>(typeof(h.transmission_speed_code))'');
    populated_base_model_pcnt := AVE(GROUP,IF(h.base_model = (TYPEOF(h.base_model))'',0,100));
    maxlength_base_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_model)));
    avelength_base_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_model)),h.base_model<>(typeof(h.base_model))'');
    populated_complete_prefix_file_id_pcnt := AVE(GROUP,IF(h.complete_prefix_file_id = (TYPEOF(h.complete_prefix_file_id))'',0,100));
    maxlength_complete_prefix_file_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.complete_prefix_file_id)));
    avelength_complete_prefix_file_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.complete_prefix_file_id)),h.complete_prefix_file_id<>(typeof(h.complete_prefix_file_id))'');
    ...
    maxlength_series_name_full_spelling := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name_full_spelling)));
    avelength_series_name_full_spelling := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name_full_spelling)),h.series_name_full_spelling<>(typeof(h.series_name_full_spelling))'');
    populated_vis_theft_code_pcnt := AVE(GROUP,IF(h.vis_theft_code = (TYPEOF(h.vis_theft_code))'',0,100));
    maxlength_vis_theft_code := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.vis_theft_code)));
    avelength_vis_theft_code := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.vis_theft_code)),h.vis_theft_code<>(typeof(h.vis_theft_code))'');
    populated_base_list_price_expanded_pcnt := AVE(GROUP,IF(h.base_list_price_expanded = (TYPEOF(h.base_list_price_expanded))'',0,100));
    maxlength_base_list_price_expanded := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_list_price_expanded)));
    avelength_base_list_price_expanded := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_list_price_expanded)),h.base_list_price_expanded<>(typeof(h.base_list_price_expanded))'');
    populated_default_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.default_nada_vehicle_id = (TYPEOF(h.default_nada_vehicle_id))'',0,100));
    maxlength_default_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_vehicle_id)));
    avelength_default_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_vehicle_id)),h.default_nada_vehicle_id<>(typeof(h.default_nada_vehicle_id))'');
    populated_default_nada_model_pcnt := AVE(GROUP,IF(h.default_nada_model = (TYPEOF(h.default_nada_model))'',0,100));
    maxlength_default_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_model)));
    avelength_default_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_model)),h.default_nada_model<>(typeof(h.default_nada_model))'');
    populated_default_nada_body_style_pcnt := AVE(GROUP,IF(h.default_nada_body_style = (TYPEOF(h.default_nada_body_style))'',0,100));
    maxlength_default_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_body_style)));
    avelength_default_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_body_style)),h.default_nada_body_style<>(typeof(h.default_nada_body_style))'');
    populated_default_nada_msrp_pcnt := AVE(GROUP,IF(h.default_nada_msrp = (TYPEOF(h.default_nada_msrp))'',0,100));
    maxlength_default_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_msrp)));
    avelength_default_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_msrp)),h.default_nada_msrp<>(typeof(h.default_nada_msrp))'');
    populated_default_nada_gvwr_pcnt := AVE(GROUP,IF(h.default_nada_gvwr = (TYPEOF(h.default_nada_gvwr))'',0,100));
    maxlength_default_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_gvwr)));
    avelength_default_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_gvwr)),h.default_nada_gvwr<>(typeof(h.default_nada_gvwr))'');
    populated_default_nada_gcwr_pcnt := AVE(GROUP,IF(h.default_nada_gcwr = (TYPEOF(h.default_nada_gcwr))'',0,100));
    maxlength_default_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_gcwr)));
    avelength_default_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.default_nada_gcwr)),h.default_nada_gcwr<>(typeof(h.default_nada_gcwr))'');
    populated_alt_1_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_1_nada_vehicle_id = (TYPEOF(h.alt_1_nada_vehicle_id))'',0,100));
    maxlength_alt_1_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_vehicle_id)));
    avelength_alt_1_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_vehicle_id)),h.alt_1_nada_vehicle_id<>(typeof(h.alt_1_nada_vehicle_id))'');
    populated_alt_1_nada_model_pcnt := AVE(GROUP,IF(h.alt_1_nada_model = (TYPEOF(h.alt_1_nada_model))'',0,100));
    maxlength_alt_1_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_model)));
    avelength_alt_1_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_model)),h.alt_1_nada_model<>(typeof(h.alt_1_nada_model))'');
    populated_alt_1_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_1_nada_body_style = (TYPEOF(h.alt_1_nada_body_style))'',0,100));
    maxlength_alt_1_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_body_style)));
    avelength_alt_1_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_body_style)),h.alt_1_nada_body_style<>(typeof(h.alt_1_nada_body_style))'');
    populated_alt_1_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_1_nada_msrp = (TYPEOF(h.alt_1_nada_msrp))'',0,100));
    maxlength_alt_1_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_msrp)));
    avelength_alt_1_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_msrp)),h.alt_1_nada_msrp<>(typeof(h.alt_1_nada_msrp))'');
    populated_alt_1_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_1_nada_gvwr = (TYPEOF(h.alt_1_nada_gvwr))'',0,100));
    maxlength_alt_1_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_gvwr)));
    avelength_alt_1_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_gvwr)),h.alt_1_nada_gvwr<>(typeof(h.alt_1_nada_gvwr))'');
    populated_alt_1_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_1_nada_gcwr = (TYPEOF(h.alt_1_nada_gcwr))'',0,100));
    maxlength_alt_1_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_gcwr)));
    avelength_alt_1_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_1_nada_gcwr)),h.alt_1_nada_gcwr<>(typeof(h.alt_1_nada_gcwr))'');
    populated_alt_2_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_2_nada_vehicle_id = (TYPEOF(h.alt_2_nada_vehicle_id))'',0,100));
    maxlength_alt_2_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_vehicle_id)));
    avelength_alt_2_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_vehicle_id)),h.alt_2_nada_vehicle_id<>(typeof(h.alt_2_nada_vehicle_id))'');
    populated_alt_2_nada_model_pcnt := AVE(GROUP,IF(h.alt_2_nada_model = (TYPEOF(h.alt_2_nada_model))'',0,100));
    maxlength_alt_2_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_model)));
    avelength_alt_2_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_model)),h.alt_2_nada_model<>(typeof(h.alt_2_nada_model))'');
    populated_alt_2_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_2_nada_body_style = (TYPEOF(h.alt_2_nada_body_style))'',0,100));
    maxlength_alt_2_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_body_style)));
    avelength_alt_2_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_body_style)),h.alt_2_nada_body_style<>(typeof(h.alt_2_nada_body_style))'');
    populated_alt_2_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_2_nada_msrp = (TYPEOF(h.alt_2_nada_msrp))'',0,100));
    maxlength_alt_2_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_msrp)));
    avelength_alt_2_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_msrp)),h.alt_2_nada_msrp<>(typeof(h.alt_2_nada_msrp))'');
    populated_alt_2_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_2_nada_gvwr = (TYPEOF(h.alt_2_nada_gvwr))'',0,100));
    maxlength_alt_2_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_gvwr)));
    avelength_alt_2_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_gvwr)),h.alt_2_nada_gvwr<>(typeof(h.alt_2_nada_gvwr))'');
    populated_alt_2_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_2_nada_gcwr = (TYPEOF(h.alt_2_nada_gcwr))'',0,100));
    maxlength_alt_2_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_gcwr)));
    avelength_alt_2_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_2_nada_gcwr)),h.alt_2_nada_gcwr<>(typeof(h.alt_2_nada_gcwr))'');
    populated_alt_3_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_3_nada_vehicle_id = (TYPEOF(h.alt_3_nada_vehicle_id))'',0,100));
    maxlength_alt_3_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_vehicle_id)));
    avelength_alt_3_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_vehicle_id)),h.alt_3_nada_vehicle_id<>(typeof(h.alt_3_nada_vehicle_id))'');
    populated_alt_3_nada_model_pcnt := AVE(GROUP,IF(h.alt_3_nada_model = (TYPEOF(h.alt_3_nada_model))'',0,100));
    maxlength_alt_3_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_model)));
    avelength_alt_3_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_model)),h.alt_3_nada_model<>(typeof(h.alt_3_nada_model))'');
    populated_alt_3_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_3_nada_body_style = (TYPEOF(h.alt_3_nada_body_style))'',0,100));
    maxlength_alt_3_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_body_style)));
    avelength_alt_3_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_body_style)),h.alt_3_nada_body_style<>(typeof(h.alt_3_nada_body_style))'');
    populated_alt_3_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_3_nada_msrp = (TYPEOF(h.alt_3_nada_msrp))'',0,100));
    maxlength_alt_3_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_msrp)));
    avelength_alt_3_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_msrp)),h.alt_3_nada_msrp<>(typeof(h.alt_3_nada_msrp))'');
    populated_alt_3_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_3_nada_gvwr = (TYPEOF(h.alt_3_nada_gvwr))'',0,100));
    maxlength_alt_3_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_gvwr)));
    avelength_alt_3_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_gvwr)),h.alt_3_nada_gvwr<>(typeof(h.alt_3_nada_gvwr))'');
    populated_alt_3_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_3_nada_gcwr = (TYPEOF(h.alt_3_nada_gcwr))'',0,100));
    maxlength_alt_3_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_gcwr)));
    avelength_alt_3_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_3_nada_gcwr)),h.alt_3_nada_gcwr<>(typeof(h.alt_3_nada_gcwr))'');
    populated_alt_4_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_4_nada_vehicle_id = (TYPEOF(h.alt_4_nada_vehicle_id))'',0,100));
    maxlength_alt_4_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_vehicle_id)));
    avelength_alt_4_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_vehicle_id)),h.alt_4_nada_vehicle_id<>(typeof(h.alt_4_nada_vehicle_id))'');
    populated_alt_4_nada_model_pcnt := AVE(GROUP,IF(h.alt_4_nada_model = (TYPEOF(h.alt_4_nada_model))'',0,100));
    maxlength_alt_4_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_model)));
    avelength_alt_4_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_model)),h.alt_4_nada_model<>(typeof(h.alt_4_nada_model))'');
    populated_alt_4_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_4_nada_body_style = (TYPEOF(h.alt_4_nada_body_style))'',0,100));
    maxlength_alt_4_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_body_style)));
    avelength_alt_4_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_body_style)),h.alt_4_nada_body_style<>(typeof(h.alt_4_nada_body_style))'');
    populated_alt_4_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_4_nada_msrp = (TYPEOF(h.alt_4_nada_msrp))'',0,100));
    maxlength_alt_4_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_msrp)));
    avelength_alt_4_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_msrp)),h.alt_4_nada_msrp<>(typeof(h.alt_4_nada_msrp))'');
    populated_alt_4_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_4_nada_gvwr = (TYPEOF(h.alt_4_nada_gvwr))'',0,100));
    maxlength_alt_4_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_gvwr)));
    avelength_alt_4_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_gvwr)),h.alt_4_nada_gvwr<>(typeof(h.alt_4_nada_gvwr))'');
    populated_alt_4_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_4_nada_gcwr = (TYPEOF(h.alt_4_nada_gcwr))'',0,100));
    maxlength_alt_4_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_gcwr)));
    avelength_alt_4_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_4_nada_gcwr)),h.alt_4_nada_gcwr<>(typeof(h.alt_4_nada_gcwr))'');
    populated_alt_5_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_5_nada_vehicle_id = (TYPEOF(h.alt_5_nada_vehicle_id))'',0,100));
    maxlength_alt_5_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_vehicle_id)));
    avelength_alt_5_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_vehicle_id)),h.alt_5_nada_vehicle_id<>(typeof(h.alt_5_nada_vehicle_id))'');
    populated_alt_5_nada_model_pcnt := AVE(GROUP,IF(h.alt_5_nada_model = (TYPEOF(h.alt_5_nada_model))'',0,100));
    maxlength_alt_5_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_model)));
    avelength_alt_5_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_model)),h.alt_5_nada_model<>(typeof(h.alt_5_nada_model))'');
    populated_alt_5_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_5_nada_body_style = (TYPEOF(h.alt_5_nada_body_style))'',0,100));
    maxlength_alt_5_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_body_style)));
    avelength_alt_5_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_body_style)),h.alt_5_nada_body_style<>(typeof(h.alt_5_nada_body_style))'');
    populated_alt_5_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_5_nada_msrp = (TYPEOF(h.alt_5_nada_msrp))'',0,100));
    maxlength_alt_5_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_msrp)));
    avelength_alt_5_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_msrp)),h.alt_5_nada_msrp<>(typeof(h.alt_5_nada_msrp))'');
    populated_alt_5_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_5_nada_gvwr = (TYPEOF(h.alt_5_nada_gvwr))'',0,100));
    maxlength_alt_5_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_gvwr)));
    avelength_alt_5_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_gvwr)),h.alt_5_nada_gvwr<>(typeof(h.alt_5_nada_gvwr))'');
    populated_alt_5_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_5_nada_gcwr = (TYPEOF(h.alt_5_nada_gcwr))'',0,100));
    maxlength_alt_5_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_gcwr)));
    avelength_alt_5_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_5_nada_gcwr)),h.alt_5_nada_gcwr<>(typeof(h.alt_5_nada_gcwr))'');
    populated_alt_6_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_6_nada_vehicle_id = (TYPEOF(h.alt_6_nada_vehicle_id))'',0,100));
    maxlength_alt_6_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_vehicle_id)));
    avelength_alt_6_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_vehicle_id)),h.alt_6_nada_vehicle_id<>(typeof(h.alt_6_nada_vehicle_id))'');
    populated_alt_6_nada_model_pcnt := AVE(GROUP,IF(h.alt_6_nada_model = (TYPEOF(h.alt_6_nada_model))'',0,100));
    maxlength_alt_6_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_model)));
    avelength_alt_6_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_model)),h.alt_6_nada_model<>(typeof(h.alt_6_nada_model))'');
    populated_alt_6_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_6_nada_body_style = (TYPEOF(h.alt_6_nada_body_style))'',0,100));
    maxlength_alt_6_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_body_style)));
    avelength_alt_6_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_body_style)),h.alt_6_nada_body_style<>(typeof(h.alt_6_nada_body_style))'');
    populated_alt_6_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_6_nada_msrp = (TYPEOF(h.alt_6_nada_msrp))'',0,100));
    maxlength_alt_6_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_msrp)));
    avelength_alt_6_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_msrp)),h.alt_6_nada_msrp<>(typeof(h.alt_6_nada_msrp))'');
    populated_alt_6_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_6_nada_gvwr = (TYPEOF(h.alt_6_nada_gvwr))'',0,100));
    maxlength_alt_6_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_gvwr)));
    avelength_alt_6_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_gvwr)),h.alt_6_nada_gvwr<>(typeof(h.alt_6_nada_gvwr))'');
    populated_alt_6_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_6_nada_gcwr = (TYPEOF(h.alt_6_nada_gcwr))'',0,100));
    maxlength_alt_6_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_gcwr)));
    avelength_alt_6_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_6_nada_gcwr)),h.alt_6_nada_gcwr<>(typeof(h.alt_6_nada_gcwr))'');
    populated_alt_7_nada_vehicle_id_pcnt := AVE(GROUP,IF(h.alt_7_nada_vehicle_id = (TYPEOF(h.alt_7_nada_vehicle_id))'',0,100));
    maxlength_alt_7_nada_vehicle_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_vehicle_id)));
    avelength_alt_7_nada_vehicle_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_vehicle_id)),h.alt_7_nada_vehicle_id<>(typeof(h.alt_7_nada_vehicle_id))'');
    populated_alt_7_nada_model_pcnt := AVE(GROUP,IF(h.alt_7_nada_model = (TYPEOF(h.alt_7_nada_model))'',0,100));
    maxlength_alt_7_nada_model := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_model)));
    avelength_alt_7_nada_model := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_model)),h.alt_7_nada_model<>(typeof(h.alt_7_nada_model))'');
    populated_alt_7_nada_body_style_pcnt := AVE(GROUP,IF(h.alt_7_nada_body_style = (TYPEOF(h.alt_7_nada_body_style))'',0,100));
    maxlength_alt_7_nada_body_style := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_body_style)));
    avelength_alt_7_nada_body_style := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_body_style)),h.alt_7_nada_body_style<>(typeof(h.alt_7_nada_body_style))'');
    populated_alt_7_nada_msrp_pcnt := AVE(GROUP,IF(h.alt_7_nada_msrp = (TYPEOF(h.alt_7_nada_msrp))'',0,100));
    maxlength_alt_7_nada_msrp := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_msrp)));
    avelength_alt_7_nada_msrp := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_msrp)),h.alt_7_nada_msrp<>(typeof(h.alt_7_nada_msrp))'');
    populated_alt_7_nada_gvwr_pcnt := AVE(GROUP,IF(h.alt_7_nada_gvwr = (TYPEOF(h.alt_7_nada_gvwr))'',0,100));
    maxlength_alt_7_nada_gvwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_gvwr)));
    avelength_alt_7_nada_gvwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_gvwr)),h.alt_7_nada_gvwr<>(typeof(h.alt_7_nada_gvwr))'');
    populated_alt_7_nada_gcwr_pcnt := AVE(GROUP,IF(h.alt_7_nada_gcwr = (TYPEOF(h.alt_7_nada_gcwr))'',0,100));
    maxlength_alt_7_nada_gcwr := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_gcwr)));
    avelength_alt_7_nada_gcwr := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.alt_7_nada_gcwr)),h.alt_7_nada_gcwr<>(typeof(h.alt_7_nada_gcwr))'');
    populated_aaia_codes_pcnt := AVE(GROUP,IF(h.aaia_codes = (TYPEOF(h.aaia_codes))'',0,100));
    maxlength_aaia_codes := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.aaia_codes)));
    avelength_aaia_codes := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.aaia_codes)),h.aaia_codes<>(typeof(h.aaia_codes))'');
    populated_incomplete_vehicle_flag_pcnt := AVE(GROUP,IF(h.incomplete_vehicle_flag = (TYPEOF(h.incomplete_vehicle_flag))'',0,100));
    maxlength_incomplete_vehicle_flag := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.incomplete_vehicle_flag)));
    avelength_incomplete_vehicle_flag := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.incomplete_vehicle_flag)),h.incomplete_vehicle_flag<>(typeof(h.incomplete_vehicle_flag))'');
    populated_filler2_pcnt := AVE(GROUP,IF(h.filler2 = (TYPEOF(h.filler2))'',0,100));
    maxlength_filler2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler2)));
    avelength_filler2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler2)),h.filler2<>(typeof(h.filler2))'');
    ...
    maxlength_electric_battery_info_type := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_info_type)));
    avelength_electric_battery_info_type := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_info_type)),h.electric_battery_info_type<>(typeof(h.electric_battery_info_type))'');
    populated_filler3_pcnt := AVE(GROUP,IF(h.filler3 = (TYPEOF(h.filler3))'',0,100));
    maxlength_filler3 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler3)));
    avelength_filler3 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler3)),h.filler3<>(typeof(h.filler3))'');
    ...
    maxlength_electric_battery_kilowatts := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_kilowatts)));
    avelength_electric_battery_kilowatts := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_kilowatts)),h.electric_battery_kilowatts<>(typeof(h.electric_battery_kilowatts))'');
    populated_filler4_pcnt := AVE(GROUP,IF(h.filler4 = (TYPEOF(h.filler4))'',0,100));
    maxlength_filler4 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler4)));
    avelength_filler4 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler4)),h.filler4<>(typeof(h.filler4))'');
    populated_electric_battery_volts_pcnt := AVE(GROUP,IF(h.electric_battery_volts = (TYPEOF(h.electric_battery_volts))'',0,100));
    maxlength_electric_battery_volts := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_volts)));
    avelength_electric_battery_volts := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.electric_battery_volts)),h.electric_battery_volts<>(typeof(h.electric_battery_volts))'');
    populated_filler5_pcnt := AVE(GROUP,IF(h.filler5 = (TYPEOF(h.filler5))'',0,100));
    maxlength_filler5 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler5)));
    avelength_filler5 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler5)),h.filler5<>(typeof(h.filler5))'');
    ...
    maxlength_engine_info_proprietary_engine_brand := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_proprietary_engine_brand)));
    avelength_engine_info_proprietary_engine_brand := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_proprietary_engine_brand)),h.engine_info_proprietary_engine_brand<>(typeof(h.engine_info_proprietary_engine_brand))'');
    populated_filler6_pcnt := AVE(GROUP,IF(h.filler6 = (TYPEOF(h.filler6))'',0,100));
    maxlength_filler6 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler6)));
    avelength_filler6 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler6)),h.filler6<>(typeof(h.filler6))'');
    ...
    maxlength_engine_info_high_output_engine := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_high_output_engine)));
    avelength_engine_info_high_output_engine := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_high_output_engine)),h.engine_info_high_output_engine<>(typeof(h.engine_info_high_output_engine))'');
    populated_engine_info_supercharged_pcnt := AVE(GROUP,IF(h.engine_info_supercharged = (TYPEOF(h.engine_info_supercharged))'',0,100));
    maxlength_engine_info_supercharged := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_supercharged)));
    avelength_engine_info_supercharged := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_supercharged)),h.engine_info_supercharged<>(typeof(h.engine_info_supercharged))'');
    populated_engine_info_turbocharged_pcnt := AVE(GROUP,IF(h.engine_info_turbocharged = (TYPEOF(h.engine_info_turbocharged))'',0,100));
    maxlength_engine_info_turbocharged := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_turbocharged)));
    avelength_engine_info_turbocharged := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_turbocharged)),h.engine_info_turbocharged<>(typeof(h.engine_info_turbocharged))'');
    populated_engine_info_vvtl_pcnt := AVE(GROUP,IF(h.engine_info_vvtl = (TYPEOF(h.engine_info_vvtl))'',0,100));
    maxlength_engine_info_vvtl := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_vvtl)));
    avelength_engine_info_vvtl := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.engine_info_vvtl)),h.engine_info_vvtl<>(typeof(h.engine_info_vvtl))'');
    populated_iso_liability_pcnt := AVE(GROUP,IF(h.iso_liability = (TYPEOF(h.iso_liability))'',0,100));
    maxlength_iso_liability := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.iso_liability)));
    avelength_iso_liability := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.iso_liability)),h.iso_liability<>(typeof(h.iso_liability))'');
    populated_series_name_condensed_pcnt := AVE(GROUP,IF(h.series_name_condensed = (TYPEOF(h.series_name_condensed))'',0,100));
    maxlength_series_name_condensed := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name_condensed)));
    avelength_series_name_condensed := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.series_name_condensed)),h.series_name_condensed<>(typeof(h.series_name_condensed))'');
    populated_aces_data_pcnt := AVE(GROUP,IF(h.aces_data = (TYPEOF(h.aces_data))'',0,100));
    maxlength_aces_data := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.aces_data)));
    avelength_aces_data := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.aces_data)),h.aces_data<>(typeof(h.aces_data))'');
    ...
    maxlength_base_shipping_weight_expanded := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_shipping_weight_expanded)));
    avelength_base_shipping_weight_expanded := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.base_shipping_weight_expanded)),h.base_shipping_weight_expanded<>(typeof(h.base_shipping_weight_expanded))'');
    populated_filler7_pcnt := AVE(GROUP,IF(h.filler7 = (TYPEOF(h.filler7))'',0,100));
    maxlength_filler7 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler7)));
    avelength_filler7 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.filler7)),h.filler7<>(typeof(h.filler7))'');
    populated_customer_defined_data_pcnt := AVE(GROUP,IF(h.customer_defined_data = (TYPEOF(h.customer_defined_data))'',0,100));
    maxlength_customer_defined_data := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.customer_defined_data)));
    avelength_customer_defined_data := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.customer_defined_data)),h.customer_defined_data<>(typeof(h.customer_defined_data))'');
  END;
...
SALT31.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT31.StrType)le.match_make),TRIM((SALT31.StrType)le.match_year),TRIM((SALT31.StrType)le.match_vin),TRIM((SALT31.StrType)le.make_abbreviation),TRIM((SALT31.StrType)le.model_year),TRIM((SALT31.StrType)le.vehicle_type),TRIM((SALT31.StrType)le.make_name),TRIM((SALT31.StrType)le.series_name),TRIM((SALT31.StrType)le.body_type),TRIM((SALT31.StrType)le.wheels),TRIM((SALT31.StrType)le.displacement),TRIM((SALT31.StrType)le.cylinders),TRIM((SALT31.StrType)le.fuel),TRIM((SALT31.StrType)le.carburetion),TRIM((SALT31.StrType)le.gvw),TRIM((SALT31.StrType)le.wheel_base),TRIM((SALT31.StrType)le.tire_size),TRIM((SALT31.StrType)le.ton_rating),TRIM((SALT31.StrType)le.base_shipping_weight),TRIM((SALT31.StrType)le.variance_weight),TRIM((SALT31.StrType)le.base_list_price),TRIM((SALT31.StrType)le.price_variance),TRIM((SALT31.StrType)le.high_performance_code),TRIM((SALT31.StrType)le.driving_wheels),TRIM((SALT31.StrType)le.iso_physical_damage),TRIM((SALT31.StrType)le.location_indicator),TRIM((SALT31.StrType)le.air_conditioning),TRIM((SALT31.StrType)le.power_steering),TRIM((SALT31.StrType)le.power_brakes),TRIM((SALT31.StrType)le.power_windows),TRIM((SALT31.StrType)le.tilt_wheel),TRIM((SALT31.StrType)le.roof),TRIM((SALT31.StrType)le.optional_roof1),TRIM((SALT31.StrType)le.optional_roof2),TRIM((SALT31.StrType)le.radio),TRIM((SALT31.StrType)le.optional_radio1),TRIM((SALT31.StrType)le.optional_radio2),TRIM((SALT31.StrType)le.transmission),TRIM((SALT31.StrType)le.optional_transmission1),TRIM((SALT31.StrType)le.optional_transmission2),TRIM((SALT31.StrType)le.anti_lock_brakes),TRIM((SALT31.StrType)le.security_system),TRIM((SALT31.StrType)le.daytime_running_lights),TRIM((SALT31.StrType)le.visrap),TRIM((SALT31.StrType)le.cab_configuration),TRIM((SALT31.StrType)le.front_axle_code),TRIM((SALT31.StrType)le.rear_axle_code),TRIM((SALT31.StrType)le.brakes_code),TRIM((SALT31.StrType)le.engine_manufacturer),TRIM((SALT31.StrType)le.engine_model),TRIM((SALT31.StrType)le.engine_type_code),TRIM((SALT31.StrType)le.trailer_body_style),TRIM((SALT31.StrType)le.trailer_number_of_axles),TRIM((SALT31.StrType)le.trailer_length),TRIM((SALT31.StrType)le.proactive_vin),TRIM((SALT31.StrType)le.ma_state_exceptions),TRIM((SALT31.StrType)le.filler_1),TRIM((SALT31.StrType)le.series_abbreviation),TRIM((SALT31.StrType)le.vin_pattern),TRIM((SALT31.StrType)le.ncic_data),TRIM((SALT31.StrType)le.full_body_style_name),TRIM((SALT31.StrType)le.nvpp_make_code),TRIM((SALT31.StrType)le.nvpp_make_abbreviation),TRIM((SALT31.StrType)le.nvpp_series_model),TRIM((SALT31.StrType)le.nvpp_series_name),TRIM((SALT31.StrType)le.segmentation_code),TRIM((SALT31.StrType)le.country_of_origin),TRIM((SALT31.StrType)le.engine_liter_information),TRIM((SALT31.StrType)le.engine_information_filler1),TRIM((SALT31.StrType)le.engine_information_block_type),TRIM((SALT31.StrType)le.engine_information_cylinders),TRIM((SALT31.StrType)le.engine_information_filler2),TRIM((SALT31.StrType)le.engine_information_carburetion),TRIM((SALT31.StrType)le.engine_information_filler3),TRIM((SALT31.StrType)le.engine_information_head_configuration),TRIM((SALT31.StrType)le.engine_information_filler4),TRIM((SALT31.StrType)le.engine_information_total_valves),TRIM((SALT31.StrType)le.engine_information_filler5),TRIM((SALT31.StrType)le.engine_information_aspiration_code),TRIM((SALT31.StrType)le.engine_information_carburetion_code),TRIM((SALT31.StrType)le.engine_information_valves_per_cylinder),TRIM((SALT31.StrType)le.transmission_speed),TRIM((SALT31.StrType)le.transmission_filler1),TRIM((SALT31.StrType)le.transmission_type),TRIM((SALT31.StrType)le.transmission_filler2),TRIM((SALT31.StrType)le.transmission_code),TRIM((SALT31.StrType)le.transmission_filler3),TRIM((SALT31.StrType)le.transmission_speed_code),TRIM((SALT31.StrType)le.base_model),TRIM((SALT31.StrType)le.complete_prefix_file_id),TRIM((SALT31.StrType)le.series_name_full_spelling),TRIM((SALT31.StrType)le.vis_theft_code),TRIM((SALT31.StrType)le.base_list_price_expanded),TRIM((SALT31.StrType)le.default_nada_vehicle_id),TRIM((SALT31.StrType)le.default_nada_model),TRIM((SALT31.StrType)le.default_nada_body_style),TRIM((SALT31.StrType)le.default_nada_msrp),TRIM((SALT31.StrType)le.default_nada_gvwr),TRIM((SALT31.StrType)le.default_nada_gcwr),TRIM((SALT31.StrType)le.alt_1_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_1_nada_model),TRIM((SALT31.StrType)le.alt_1_nada_body_style),TRIM((SALT31.StrType)le.alt_1_nada_msrp),TRIM((SALT31.StrType)le.alt_1_nada_gvwr),TRIM((SALT31.StrType)le.alt_1_nada_gcwr),TRIM((SALT31.StrType)le.alt_2_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_2_nada_model),TRIM((SALT31.StrType)le.alt_2_nada_body_style),TRIM((SALT31.StrType)le.alt_2_nada_msrp),TRIM((SALT31.StrType)le.alt_2_nada_gvwr),TRIM((SALT31.StrType)le.alt_2_nada_gcwr),TRIM((SALT31.StrType)le.alt_3_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_3_nada_model),TRIM((SALT31.StrType)le.alt_3_nada_body_style),TRIM((SALT31.StrType)le.alt_3_nada_msrp),TRIM((SALT31.StrType)le.alt_3_nada_gvwr),TRIM((SALT31.StrType)le.alt_3_nada_gcwr),TRIM((SALT31.StrType)le.alt_4_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_4_nada_model),TRIM((SALT31.StrType)le.alt_4_nada_body_style),TRIM((SALT31.StrType)le.alt_4_nada_msrp),TRIM((SALT31.StrType)le.alt_4_nada_gvwr),TRIM((SALT31.StrType)le.alt_4_nada_gcwr),TRIM((SALT31.StrType)le.alt_5_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_5_nada_model),TRIM((SALT31.StrType)le.alt_5_nada_body_style),TRIM((SALT31.StrType)le.alt_5_nada_msrp),TRIM((SALT31.StrType)le.alt_5_nada_gvwr),TRIM((SALT31.StrType)le.alt_5_nada_gcwr),TRIM((SALT31.StrType)le.alt_6_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_6_nada_model),TRIM((SALT31.StrType)le.alt_6_nada_body_style),TRIM((SALT31.StrType)le.alt_6_nada_msrp),TRIM((SALT31.StrType)le.alt_6_nada_gvwr),TRIM((SALT31.StrType)le.alt_6_nada_gcwr),TRIM((SALT31.StrType)le.alt_7_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_7_nada_model),TRIM((SALT31.StrType)le.alt_7_nada_body_style),TRIM((SALT31.StrType)le.alt_7_nada_msrp),TRIM((SALT31.StrType)le.alt_7_nada_gvwr),TRIM((SALT31.StrType)le.alt_7_nada_gcwr),TRIM((SALT31.StrType)le.aaia_codes),TRIM((SALT31.StrType)le.incomplete_vehicle_flag),TRIM((SALT31.StrType)le.filler2),TRIM((SALT31.StrType)le.electric_battery_info_type),TRIM((SALT31.StrType)le.filler3),TRIM((SALT31.StrType)le.electric_battery_kilowatts),TRIM((SALT31.StrType)le.filler4),TRIM((SALT31.StrType)le.electric_battery_volts),TRIM((SALT31.StrType)le.filler5),TRIM((SALT31.StrType)le.engine_info_proprietary_engine_brand),TRIM((SALT31.StrType)le.filler6),TRIM((SALT31.StrType)le.engine_info_high_output_engine),TRIM((SALT31.StrType)le.engine_info_supercharged),TRIM((SALT31.StrType)le.engine_info_turbocharged),TRIM((SALT31.StrType)le.engine_info_vvtl),TRIM((SALT31.StrType)le.iso_liability),TRIM((SALT31.StrType)le.series_name_condensed),TRIM((SALT31.StrType)le.aces_data),TRIM((SALT31.StrType)le.base_shipping_weight_expanded),TRIM((SALT31.StrType)le.filler7),TRIM((SALT31.StrType)le.customer_defined_data)));
  SELF.FldNo := C;
END;
...
SALT31.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 162);
  SELF.FldNo2 := 1 + (C % 162);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT31.StrType)le.match_make),TRIM((SALT31.StrType)le.match_year),TRIM((SALT31.StrType)le.match_vin),TRIM((SALT31.StrType)le.make_abbreviation),TRIM((SALT31.StrType)le.model_year),TRIM((SALT31.StrType)le.vehicle_type),TRIM((SALT31.StrType)le.make_name),TRIM((SALT31.StrType)le.series_name),TRIM((SALT31.StrType)le.body_type),TRIM((SALT31.StrType)le.wheels),TRIM((SALT31.StrType)le.displacement),TRIM((SALT31.StrType)le.cylinders),TRIM((SALT31.StrType)le.fuel),TRIM((SALT31.StrType)le.carburetion),TRIM((SALT31.StrType)le.gvw),TRIM((SALT31.StrType)le.wheel_base),TRIM((SALT31.StrType)le.tire_size),TRIM((SALT31.StrType)le.ton_rating),TRIM((SALT31.StrType)le.base_shipping_weight),TRIM((SALT31.StrType)le.variance_weight),TRIM((SALT31.StrType)le.base_list_price),TRIM((SALT31.StrType)le.price_variance),TRIM((SALT31.StrType)le.high_performance_code),TRIM((SALT31.StrType)le.driving_wheels),TRIM((SALT31.StrType)le.iso_physical_damage),TRIM((SALT31.StrType)le.location_indicator),TRIM((SALT31.StrType)le.air_conditioning),TRIM((SALT31.StrType)le.power_steering),TRIM((SALT31.StrType)le.power_brakes),TRIM((SALT31.StrType)le.power_windows),TRIM((SALT31.StrType)le.tilt_wheel),TRIM((SALT31.StrType)le.roof),TRIM((SALT31.StrType)le.optional_roof1),TRIM((SALT31.StrType)le.optional_roof2),TRIM((SALT31.StrType)le.radio),TRIM((SALT31.StrType)le.optional_radio1),TRIM((SALT31.StrType)le.optional_radio2),TRIM((SALT31.StrType)le.transmission),TRIM((SALT31.StrType)le.optional_transmission1),TRIM((SALT31.StrType)le.optional_transmission2),TRIM((SALT31.StrType)le.anti_lock_brakes),TRIM((SALT31.StrType)le.security_system),TRIM((SALT31.StrType)le.daytime_running_lights),TRIM((SALT31.StrType)le.visrap),TRIM((SALT31.StrType)le.cab_configuration),TRIM((SALT31.StrType)le.front_axle_code),TRIM((SALT31.StrType)le.rear_axle_code),TRIM((SALT31.StrType)le.brakes_code),TRIM((SALT31.StrType)le.engine_manufacturer),TRIM((SALT31.StrType)le.engine_model),TRIM((SALT31.StrType)le.engine_type_code),TRIM((SALT31.StrType)le.trailer_body_style),TRIM((SALT31.StrType)le.trailer_number_of_axles),TRIM((SALT31.StrType)le.trailer_length),TRIM((SALT31.StrType)le.proactive_vin),TRIM((SALT31.StrType)le.ma_state_exceptions),TRIM((SALT31.StrType)le.filler_1),TRIM((SALT31.StrType)le.series_abbreviation),TRIM((SALT31.StrType)le.vin_pattern),TRIM((SALT31.StrType)le.ncic_data),TRIM((SALT31.StrType)le.full_body_style_name),TRIM((SALT31.StrType)le.nvpp_make_code),TRIM((SALT31.StrType)le.nvpp_make_abbreviation),TRIM((SALT31.StrType)le.nvpp_series_model),TRIM((SALT31.StrType)le.nvpp_series_name),TRIM((SALT31.StrType)le.segmentation_code),TRIM((SALT31.StrType)le.country_of_origin),TRIM((SALT31.StrType)le.engine_liter_information),TRIM((SALT31.StrType)le.engine_information_filler1),TRIM((SALT31.StrType)le.engine_information_block_type),TRIM((SALT31.StrType)le.engine_information_cylinders),TRIM((SALT31.StrType)le.engine_information_filler2),TRIM((SALT31.StrType)le.engine_information_carburetion),TRIM((SALT31.StrType)le.engine_information_filler3),TRIM((SALT31.StrType)le.engine_information_head_configuration),TRIM((SALT31.StrType)le.engine_information_filler4),TRIM((SALT31.StrType)le.engine_information_total_valves),TRIM((SALT31.StrType)le.engine_information_filler5),TRIM((SALT31.StrType)le.engine_information_aspiration_code),TRIM((SALT31.StrType)le.engine_information_carburetion_code),TRIM((SALT31.StrType)le.engine_information_valves_per_cylinder),TRIM((SALT31.StrType)le.transmission_speed),TRIM((SALT31.StrType)le.transmission_filler1),TRIM((SALT31.StrType)le.transmission_type),TRIM((SALT31.StrType)le.transmission_filler2),TRIM((SALT31.StrType)le.transmission_code),TRIM((SALT31.StrType)le.transmission_filler3),TRIM((SALT31.StrType)le.transmission_speed_code),TRIM((SALT31.StrType)le.base_model),TRIM((SALT31.StrType)le.complete_prefix_file_id),TRIM((SALT31.StrType)le.series_name_full_spelling),TRIM((SALT31.StrType)le.vis_theft_code),TRIM((SALT31.StrType)le.base_list_price_expanded),TRIM((SALT31.StrType)le.default_nada_vehicle_id),TRIM((SALT31.StrType)le.default_nada_model),TRIM((SALT31.StrType)le.default_nada_body_style),TRIM((SALT31.StrType)le.default_nada_msrp),TRIM((SALT31.StrType)le.default_nada_gvwr),TRIM((SALT31.StrType)le.default_nada_gcwr),TRIM((SALT31.StrType)le.alt_1_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_1_nada_model),TRIM((SALT31.StrType)le.alt_1_nada_body_style),TRIM((SALT31.StrType)le.alt_1_nada_msrp),TRIM((SALT31.StrType)le.alt_1_nada_gvwr),TRIM((SALT31.StrType)le.alt_1_nada_gcwr),TRIM((SALT31.StrType)le.alt_2_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_2_nada_model),TRIM((SALT31.StrType)le.alt_2_nada_body_style),TRIM((SALT31.StrType)le.alt_2_nada_msrp),TRIM((SALT31.StrType)le.alt_2_nada_gvwr),TRIM((SALT31.StrType)le.alt_2_nada_gcwr),TRIM((SALT31.StrType)le.alt_3_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_3_nada_model),TRIM((SALT31.StrType)le.alt_3_nada_body_style),TRIM((SALT31.StrType)le.alt_3_nada_msrp),TRIM((SALT31.StrType)le.alt_3_nada_gvwr),TRIM((SALT31.StrType)le.alt_3_nada_gcwr),TRIM((SALT31.StrType)le.alt_4_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_4_nada_model),TRIM((SALT31.StrType)le.alt_4_nada_body_style),TRIM((SALT31.StrType)le.alt_4_nada_msrp),TRIM((SALT31.StrType)le.alt_4_nada_gvwr),TRIM((SALT31.StrType)le.alt_4_nada_gcwr),TRIM((SALT31.StrType)le.alt_5_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_5_nada_model),TRIM((SALT31.StrType)le.alt_5_nada_body_style),TRIM((SALT31.StrType)le.alt_5_nada_msrp),TRIM((SALT31.StrType)le.alt_5_nada_gvwr),TRIM((SALT31.StrType)le.alt_5_nada_gcwr),TRIM((SALT31.StrType)le.alt_6_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_6_nada_model),TRIM((SALT31.StrType)le.alt_6_nada_body_style),TRIM((SALT31.StrType)le.alt_6_nada_msrp),TRIM((SALT31.StrType)le.alt_6_nada_gvwr),TRIM((SALT31.StrType)le.alt_6_nada_gcwr),TRIM((SALT31.StrType)le.alt_7_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_7_nada_model),TRIM((SALT31.StrType)le.alt_7_nada_body_style),TRIM((SALT31.StrType)le.alt_7_nada_msrp),TRIM((SALT31.StrType)le.alt_7_nada_gvwr),TRIM((SALT31.StrType)le.alt_7_nada_gcwr),TRIM((SALT31.StrType)le.aaia_codes),TRIM((SALT31.StrType)le.incomplete_vehicle_flag),TRIM((SALT31.StrType)le.filler2),TRIM((SALT31.StrType)le.electric_battery_info_type),TRIM((SALT31.StrType)le.filler3),TRIM((SALT31.StrType)le.electric_battery_kilowatts),TRIM((SALT31.StrType)le.filler4),TRIM((SALT31.StrType)le.electric_battery_volts),TRIM((SALT31.StrType)le.filler5),TRIM((SALT31.StrType)le.engine_info_proprietary_engine_brand),TRIM((SALT31.StrType)le.filler6),TRIM((SALT31.StrType)le.engine_info_high_output_engine),TRIM((SALT31.StrType)le.engine_info_supercharged),TRIM((SALT31.StrType)le.engine_info_turbocharged),TRIM((SALT31.StrType)le.engine_info_vvtl),TRIM((SALT31.StrType)le.iso_liability),TRIM((SALT31.StrType)le.series_name_condensed),TRIM((SALT31.StrType)le.aces_data),TRIM((SALT31.StrType)le.base_shipping_weight_expanded),TRIM((SALT31.StrType)le.filler7),TRIM((SALT31.StrType)le.customer_defined_data)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT31.StrType)le.match_make),TRIM((SALT31.StrType)le.match_year),TRIM((SALT31.StrType)le.match_vin),TRIM((SALT31.StrType)le.make_abbreviation),TRIM((SALT31.StrType)le.model_year),TRIM((SALT31.StrType)le.vehicle_type),TRIM((SALT31.StrType)le.make_name),TRIM((SALT31.StrType)le.series_name),TRIM((SALT31.StrType)le.body_type),TRIM((SALT31.StrType)le.wheels),TRIM((SALT31.StrType)le.displacement),TRIM((SALT31.StrType)le.cylinders),TRIM((SALT31.StrType)le.fuel),TRIM((SALT31.StrType)le.carburetion),TRIM((SALT31.StrType)le.gvw),TRIM((SALT31.StrType)le.wheel_base),TRIM((SALT31.StrType)le.tire_size),TRIM((SALT31.StrType)le.ton_rating),TRIM((SALT31.StrType)le.base_shipping_weight),TRIM((SALT31.StrType)le.variance_weight),TRIM((SALT31.StrType)le.base_list_price),TRIM((SALT31.StrType)le.price_variance),TRIM((SALT31.StrType)le.high_performance_code),TRIM((SALT31.StrType)le.driving_wheels),TRIM((SALT31.StrType)le.iso_physical_damage),TRIM((SALT31.StrType)le.location_indicator),TRIM((SALT31.StrType)le.air_conditioning),TRIM((SALT31.StrType)le.power_steering),TRIM((SALT31.StrType)le.power_brakes),TRIM((SALT31.StrType)le.power_windows),TRIM((SALT31.StrType)le.tilt_wheel),TRIM((SALT31.StrType)le.roof),TRIM((SALT31.StrType)le.optional_roof1),TRIM((SALT31.StrType)le.optional_roof2),TRIM((SALT31.StrType)le.radio),TRIM((SALT31.StrType)le.optional_radio1),TRIM((SALT31.StrType)le.optional_radio2),TRIM((SALT31.StrType)le.transmission),TRIM((SALT31.StrType)le.optional_transmission1),TRIM((SALT31.StrType)le.optional_transmission2),TRIM((SALT31.StrType)le.anti_lock_brakes),TRIM((SALT31.StrType)le.security_system),TRIM((SALT31.StrType)le.daytime_running_lights),TRIM((SALT31.StrType)le.visrap),TRIM((SALT31.StrType)le.cab_configuration),TRIM((SALT31.StrType)le.front_axle_code),TRIM((SALT31.StrType)le.rear_axle_code),TRIM((SALT31.StrType)le.brakes_code),TRIM((SALT31.StrType)le.engine_manufacturer),TRIM((SALT31.StrType)le.engine_model),TRIM((SALT31.StrType)le.engine_type_code),TRIM((SALT31.StrType)le.trailer_body_style),TRIM((SALT31.StrType)le.trailer_number_of_axles),TRIM((SALT31.StrType)le.trailer_length),TRIM((SALT31.StrType)le.proactive_vin),TRIM((SALT31.StrType)le.ma_state_exceptions),TRIM((SALT31.StrType)le.filler_1),TRIM((SALT31.StrType)le.series_abbreviation),TRIM((SALT31.StrType)le.vin_pattern),TRIM((SALT31.StrType)le.ncic_data),TRIM((SALT31.StrType)le.full_body_style_name),TRIM((SALT31.StrType)le.nvpp_make_code),TRIM((SALT31.StrType)le.nvpp_make_abbreviation),TRIM((SALT31.StrType)le.nvpp_series_model),TRIM((SALT31.StrType)le.nvpp_series_name),TRIM((SALT31.StrType)le.segmentation_code),TRIM((SALT31.StrType)le.country_of_origin),TRIM((SALT31.StrType)le.engine_liter_information),TRIM((SALT31.StrType)le.engine_information_filler1),TRIM((SALT31.StrType)le.engine_information_block_type),TRIM((SALT31.StrType)le.engine_information_cylinders),TRIM((SALT31.StrType)le.engine_information_filler2),TRIM((SALT31.StrType)le.engine_information_carburetion),TRIM((SALT31.StrType)le.engine_information_filler3),TRIM((SALT31.StrType)le.engine_information_head_configuration),TRIM((SALT31.StrType)le.engine_information_filler4),TRIM((SALT31.StrType)le.engine_information_total_valves),TRIM((SALT31.StrType)le.engine_information_filler5),TRIM((SALT31.StrType)le.engine_information_aspiration_code),TRIM((SALT31.StrType)le.engine_information_carburetion_code),TRIM((SALT31.StrType)le.engine_information_valves_per_cylinder),TRIM((SALT31.StrType)le.transmission_speed),TRIM((SALT31.StrType)le.transmission_filler1),TRIM((SALT31.StrType)le.transmission_type),TRIM((SALT31.StrType)le.transmission_filler2),TRIM((SALT31.StrType)le.transmission_code),TRIM((SALT31.StrType)le.transmission_filler3),TRIM((SALT31.StrType)le.transmission_speed_code),TRIM((SALT31.StrType)le.base_model),TRIM((SALT31.StrType)le.complete_prefix_file_id),TRIM((SALT31.StrType)le.series_name_full_spelling),TRIM((SALT31.StrType)le.vis_theft_code),TRIM((SALT31.StrType)le.base_list_price_expanded),TRIM((SALT31.StrType)le.default_nada_vehicle_id),TRIM((SALT31.StrType)le.default_nada_model),TRIM((SALT31.StrType)le.default_nada_body_style),TRIM((SALT31.StrType)le.default_nada_msrp),TRIM((SALT31.StrType)le.default_nada_gvwr),TRIM((SALT31.StrType)le.default_nada_gcwr),TRIM((SALT31.StrType)le.alt_1_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_1_nada_model),TRIM((SALT31.StrType)le.alt_1_nada_body_style),TRIM((SALT31.StrType)le.alt_1_nada_msrp),TRIM((SALT31.StrType)le.alt_1_nada_gvwr),TRIM((SALT31.StrType)le.alt_1_nada_gcwr),TRIM((SALT31.StrType)le.alt_2_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_2_nada_model),TRIM((SALT31.StrType)le.alt_2_nada_body_style),TRIM((SALT31.StrType)le.alt_2_nada_msrp),TRIM((SALT31.StrType)le.alt_2_nada_gvwr),TRIM((SALT31.StrType)le.alt_2_nada_gcwr),TRIM((SALT31.StrType)le.alt_3_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_3_nada_model),TRIM((SALT31.StrType)le.alt_3_nada_body_style),TRIM((SALT31.StrType)le.alt_3_nada_msrp),TRIM((SALT31.StrType)le.alt_3_nada_gvwr),TRIM((SALT31.StrType)le.alt_3_nada_gcwr),TRIM((SALT31.StrType)le.alt_4_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_4_nada_model),TRIM((SALT31.StrType)le.alt_4_nada_body_style),TRIM((SALT31.StrType)le.alt_4_nada_msrp),TRIM((SALT31.StrType)le.alt_4_nada_gvwr),TRIM((SALT31.StrType)le.alt_4_nada_gcwr),TRIM((SALT31.StrType)le.alt_5_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_5_nada_model),TRIM((SALT31.StrType)le.alt_5_nada_body_style),TRIM((SALT31.StrType)le.alt_5_nada_msrp),TRIM((SALT31.StrType)le.alt_5_nada_gvwr),TRIM((SALT31.StrType)le.alt_5_nada_gcwr),TRIM((SALT31.StrType)le.alt_6_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_6_nada_model),TRIM((SALT31.StrType)le.alt_6_nada_body_style),TRIM((SALT31.StrType)le.alt_6_nada_msrp),TRIM((SALT31.StrType)le.alt_6_nada_gvwr),TRIM((SALT31.StrType)le.alt_6_nada_gcwr),TRIM((SALT31.StrType)le.alt_7_nada_vehicle_id),TRIM((SALT31.StrType)le.alt_7_nada_model),TRIM((SALT31.StrType)le.alt_7_nada_body_style),TRIM((SALT31.StrType)le.alt_7_nada_msrp),TRIM((SALT31.StrType)le.alt_7_nada_gvwr),TRIM((SALT31.StrType)le.alt_7_nada_gcwr),TRIM((SALT31.StrType)le.aaia_codes),TRIM((SALT31.StrType)le.incomplete_vehicle_flag),TRIM((SALT31.StrType)le.filler2),TRIM((SALT31.StrType)le.electric_battery_info_type),TRIM((SALT31.StrType)le.filler3),TRIM((SALT31.StrType)le.electric_battery_kilowatts),TRIM((SALT31.StrType)le.filler4),TRIM((SALT31.StrType)le.electric_battery_volts),TRIM((SALT31.StrType)le.filler5),TRIM((SALT31.StrType)le.engine_info_proprietary_engine_brand),TRIM((SALT31.StrType)le.filler6),TRIM((SALT31.StrType)le.engine_info_high_output_engine),TRIM((SALT31.StrType)le.engine_info_supercharged),TRIM((SALT31.StrType)le.engine_info_turbocharged),TRIM((SALT31.StrType)le.engine_info_vvtl),TRIM((SALT31.StrType)le.iso_liability),TRIM((SALT31.StrType)le.series_name_condensed),TRIM((SALT31.StrType)le.aces_data),TRIM((SALT31.StrType)le.base_shipping_weight_expanded),TRIM((SALT31.StrType)le.filler7),TRIM((SALT31.StrType)le.customer_defined_data)));
  END;
...
SHARED FldIds := DATASET([{1,'match_make'}
      ...
      ,{161,'filler7'}
      ,{162,'customer_defined_data'}],SALT31.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    BaseFile_Fields.InValid_match_make((SALT31.StrType)le.match_make),
    BaseFile_Fields.InValid_match_year((SALT31.StrType)le.match_year),
    BaseFile_Fields.InValid_match_vin((SALT31.StrType)le.match_vin),
    BaseFile_Fields.InValid_make_abbreviation((SALT31.StrType)le.make_abbreviation),
    BaseFile_Fields.InValid_model_year((SALT31.StrType)le.model_year),
    BaseFile_Fields.InValid_vehicle_type((SALT31.StrType)le.vehicle_type),
    BaseFile_Fields.InValid_make_name((SALT31.StrType)le.make_name),
    BaseFile_Fields.InValid_series_name((SALT31.StrType)le.series_name),
    BaseFile_Fields.InValid_body_type((SALT31.StrType)le.body_type),
    BaseFile_Fields.InValid_wheels((SALT31.StrType)le.wheels),
    BaseFile_Fields.InValid_displacement((SALT31.StrType)le.displacement),
    BaseFile_Fields.InValid_cylinders((SALT31.StrType)le.cylinders),
    BaseFile_Fields.InValid_fuel((SALT31.StrType)le.fuel),
    BaseFile_Fields.InValid_carburetion((SALT31.StrType)le.carburetion),
    BaseFile_Fields.InValid_gvw((SALT31.StrType)le.gvw),
    BaseFile_Fields.InValid_wheel_base((SALT31.StrType)le.wheel_base),
    BaseFile_Fields.InValid_tire_size((SALT31.StrType)le.tire_size),
    BaseFile_Fields.InValid_ton_rating((SALT31.StrType)le.ton_rating),
    BaseFile_Fields.InValid_base_shipping_weight((SALT31.StrType)le.base_shipping_weight),
    BaseFile_Fields.InValid_variance_weight((SALT31.StrType)le.variance_weight),
    BaseFile_Fields.InValid_base_list_price((SALT31.StrType)le.base_list_price),
    BaseFile_Fields.InValid_price_variance((SALT31.StrType)le.price_variance),
    BaseFile_Fields.InValid_high_performance_code((SALT31.StrType)le.high_performance_code),
    BaseFile_Fields.InValid_driving_wheels((SALT31.StrType)le.driving_wheels),
    BaseFile_Fields.InValid_iso_physical_damage((SALT31.StrType)le.iso_physical_damage),
    BaseFile_Fields.InValid_location_indicator((SALT31.StrType)le.location_indicator),
    BaseFile_Fields.InValid_air_conditioning((SALT31.StrType)le.air_conditioning),
    BaseFile_Fields.InValid_power_steering((SALT31.StrType)le.power_steering),
    BaseFile_Fields.InValid_power_brakes((SALT31.StrType)le.power_brakes),
    BaseFile_Fields.InValid_power_windows((SALT31.StrType)le.power_windows),
    BaseFile_Fields.InValid_tilt_wheel((SALT31.StrType)le.tilt_wheel),
    BaseFile_Fields.InValid_roof((SALT31.StrType)le.roof),
    BaseFile_Fields.InValid_optional_roof1((SALT31.StrType)le.optional_roof1),
    BaseFile_Fields.InValid_optional_roof2((SALT31.StrType)le.optional_roof2),
    BaseFile_Fields.InValid_radio((SALT31.StrType)le.radio),
    BaseFile_Fields.InValid_optional_radio1((SALT31.StrType)le.optional_radio1),
    BaseFile_Fields.InValid_optional_radio2((SALT31.StrType)le.optional_radio2),
    BaseFile_Fields.InValid_transmission((SALT31.StrType)le.transmission),
    BaseFile_Fields.InValid_optional_transmission1((SALT31.StrType)le.optional_transmission1),
    BaseFile_Fields.InValid_optional_transmission2((SALT31.StrType)le.optional_transmission2),
    BaseFile_Fields.InValid_anti_lock_brakes((SALT31.StrType)le.anti_lock_brakes),
    BaseFile_Fields.InValid_security_system((SALT31.StrType)le.security_system),
    BaseFile_Fields.InValid_daytime_running_lights((SALT31.StrType)le.daytime_running_lights),
    BaseFile_Fields.InValid_visrap((SALT31.StrType)le.visrap),
    BaseFile_Fields.InValid_cab_configuration((SALT31.StrType)le.cab_configuration),
    BaseFile_Fields.InValid_front_axle_code((SALT31.StrType)le.front_axle_code),
    BaseFile_Fields.InValid_rear_axle_code((SALT31.StrType)le.rear_axle_code),
    BaseFile_Fields.InValid_brakes_code((SALT31.StrType)le.brakes_code),
    BaseFile_Fields.InValid_engine_manufacturer((SALT31.StrType)le.engine_manufacturer),
    BaseFile_Fields.InValid_engine_model((SALT31.StrType)le.engine_model),
    BaseFile_Fields.InValid_engine_type_code((SALT31.StrType)le.engine_type_code),
    BaseFile_Fields.InValid_trailer_body_style((SALT31.StrType)le.trailer_body_style),
    BaseFile_Fields.InValid_trailer_number_of_axles((SALT31.StrType)le.trailer_number_of_axles),
    BaseFile_Fields.InValid_trailer_length((SALT31.StrType)le.trailer_length),
    BaseFile_Fields.InValid_proactive_vin((SALT31.StrType)le.proactive_vin),
    BaseFile_Fields.InValid_ma_state_exceptions((SALT31.StrType)le.ma_state_exceptions),
    BaseFile_Fields.InValid_filler_1((SALT31.StrType)le.filler_1),
    BaseFile_Fields.InValid_series_abbreviation((SALT31.StrType)le.series_abbreviation),
    BaseFile_Fields.InValid_vin_pattern((SALT31.StrType)le.vin_pattern),
    BaseFile_Fields.InValid_ncic_data((SALT31.StrType)le.ncic_data),
    BaseFile_Fields.InValid_full_body_style_name((SALT31.StrType)le.full_body_style_name),
    BaseFile_Fields.InValid_nvpp_make_code((SALT31.StrType)le.nvpp_make_code),
    BaseFile_Fields.InValid_nvpp_make_abbreviation((SALT31.StrType)le.nvpp_make_abbreviation),
    BaseFile_Fields.InValid_nvpp_series_model((SALT31.StrType)le.nvpp_series_model),
    BaseFile_Fields.InValid_nvpp_series_name((SALT31.StrType)le.nvpp_series_name),
    BaseFile_Fields.InValid_segmentation_code((SALT31.StrType)le.segmentation_code),
    BaseFile_Fields.InValid_country_of_origin((SALT31.StrType)le.country_of_origin),
    BaseFile_Fields.InValid_engine_liter_information((SALT31.StrType)le.engine_liter_information),
    BaseFile_Fields.InValid_engine_information_filler1((SALT31.StrType)le.engine_information_filler1),
    BaseFile_Fields.InValid_engine_information_block_type((SALT31.StrType)le.engine_information_block_type),
    BaseFile_Fields.InValid_engine_information_cylinders((SALT31.StrType)le.engine_information_cylinders),
    BaseFile_Fields.InValid_engine_information_filler2((SALT31.StrType)le.engine_information_filler2),
    BaseFile_Fields.InValid_engine_information_carburetion((SALT31.StrType)le.engine_information_carburetion),
    BaseFile_Fields.InValid_engine_information_filler3((SALT31.StrType)le.engine_information_filler3),
    BaseFile_Fields.InValid_engine_information_head_configuration((SALT31.StrType)le.engine_information_head_configuration),
    BaseFile_Fields.InValid_engine_information_filler4((SALT31.StrType)le.engine_information_filler4),
    BaseFile_Fields.InValid_engine_information_total_valves((SALT31.StrType)le.engine_information_total_valves),
    BaseFile_Fields.InValid_engine_information_filler5((SALT31.StrType)le.engine_information_filler5),
    BaseFile_Fields.InValid_engine_information_aspiration_code((SALT31.StrType)le.engine_information_aspiration_code),
    BaseFile_Fields.InValid_engine_information_carburetion_code((SALT31.StrType)le.engine_information_carburetion_code),
    BaseFile_Fields.InValid_engine_information_valves_per_cylinder((SALT31.StrType)le.engine_information_valves_per_cylinder),
    BaseFile_Fields.InValid_transmission_speed((SALT31.StrType)le.transmission_speed),
    BaseFile_Fields.InValid_transmission_filler1((SALT31.StrType)le.transmission_filler1),
    BaseFile_Fields.InValid_transmission_type((SALT31.StrType)le.transmission_type),
    BaseFile_Fields.InValid_transmission_filler2((SALT31.StrType)le.transmission_filler2),
    BaseFile_Fields.InValid_transmission_code((SALT31.StrType)le.transmission_code),
    BaseFile_Fields.InValid_transmission_filler3((SALT31.StrType)le.transmission_filler3),
    BaseFile_Fields.InValid_transmission_speed_code((SALT31.StrType)le.transmission_speed_code),
    BaseFile_Fields.InValid_base_model((SALT31.StrType)le.base_model),
    BaseFile_Fields.InValid_complete_prefix_file_id((SALT31.StrType)le.complete_prefix_file_id),
    BaseFile_Fields.InValid_series_name_full_spelling((SALT31.StrType)le.series_name_full_spelling),
    BaseFile_Fields.InValid_vis_theft_code((SALT31.StrType)le.vis_theft_code),
    BaseFile_Fields.InValid_base_list_price_expanded((SALT31.StrType)le.base_list_price_expanded),
    BaseFile_Fields.InValid_default_nada_vehicle_id((SALT31.StrType)le.default_nada_vehicle_id),
    BaseFile_Fields.InValid_default_nada_model((SALT31.StrType)le.default_nada_model),
    BaseFile_Fields.InValid_default_nada_body_style((SALT31.StrType)le.default_nada_body_style),
    BaseFile_Fields.InValid_default_nada_msrp((SALT31.StrType)le.default_nada_msrp),
    BaseFile_Fields.InValid_default_nada_gvwr((SALT31.StrType)le.default_nada_gvwr),
    BaseFile_Fields.InValid_default_nada_gcwr((SALT31.StrType)le.default_nada_gcwr),
    BaseFile_Fields.InValid_alt_1_nada_vehicle_id((SALT31.StrType)le.alt_1_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_1_nada_model((SALT31.StrType)le.alt_1_nada_model),
    BaseFile_Fields.InValid_alt_1_nada_body_style((SALT31.StrType)le.alt_1_nada_body_style),
    BaseFile_Fields.InValid_alt_1_nada_msrp((SALT31.StrType)le.alt_1_nada_msrp),
    BaseFile_Fields.InValid_alt_1_nada_gvwr((SALT31.StrType)le.alt_1_nada_gvwr),
    BaseFile_Fields.InValid_alt_1_nada_gcwr((SALT31.StrType)le.alt_1_nada_gcwr),
    BaseFile_Fields.InValid_alt_2_nada_vehicle_id((SALT31.StrType)le.alt_2_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_2_nada_model((SALT31.StrType)le.alt_2_nada_model),
    BaseFile_Fields.InValid_alt_2_nada_body_style((SALT31.StrType)le.alt_2_nada_body_style),
    BaseFile_Fields.InValid_alt_2_nada_msrp((SALT31.StrType)le.alt_2_nada_msrp),
    BaseFile_Fields.InValid_alt_2_nada_gvwr((SALT31.StrType)le.alt_2_nada_gvwr),
    BaseFile_Fields.InValid_alt_2_nada_gcwr((SALT31.StrType)le.alt_2_nada_gcwr),
    BaseFile_Fields.InValid_alt_3_nada_vehicle_id((SALT31.StrType)le.alt_3_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_3_nada_model((SALT31.StrType)le.alt_3_nada_model),
    BaseFile_Fields.InValid_alt_3_nada_body_style((SALT31.StrType)le.alt_3_nada_body_style),
    BaseFile_Fields.InValid_alt_3_nada_msrp((SALT31.StrType)le.alt_3_nada_msrp),
    BaseFile_Fields.InValid_alt_3_nada_gvwr((SALT31.StrType)le.alt_3_nada_gvwr),
    BaseFile_Fields.InValid_alt_3_nada_gcwr((SALT31.StrType)le.alt_3_nada_gcwr),
    BaseFile_Fields.InValid_alt_4_nada_vehicle_id((SALT31.StrType)le.alt_4_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_4_nada_model((SALT31.StrType)le.alt_4_nada_model),
    BaseFile_Fields.InValid_alt_4_nada_body_style((SALT31.StrType)le.alt_4_nada_body_style),
    BaseFile_Fields.InValid_alt_4_nada_msrp((SALT31.StrType)le.alt_4_nada_msrp),
    BaseFile_Fields.InValid_alt_4_nada_gvwr((SALT31.StrType)le.alt_4_nada_gvwr),
    BaseFile_Fields.InValid_alt_4_nada_gcwr((SALT31.StrType)le.alt_4_nada_gcwr),
    BaseFile_Fields.InValid_alt_5_nada_vehicle_id((SALT31.StrType)le.alt_5_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_5_nada_model((SALT31.StrType)le.alt_5_nada_model),
    BaseFile_Fields.InValid_alt_5_nada_body_style((SALT31.StrType)le.alt_5_nada_body_style),
    BaseFile_Fields.InValid_alt_5_nada_msrp((SALT31.StrType)le.alt_5_nada_msrp),
    BaseFile_Fields.InValid_alt_5_nada_gvwr((SALT31.StrType)le.alt_5_nada_gvwr),
    BaseFile_Fields.InValid_alt_5_nada_gcwr((SALT31.StrType)le.alt_5_nada_gcwr),
    BaseFile_Fields.InValid_alt_6_nada_vehicle_id((SALT31.StrType)le.alt_6_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_6_nada_model((SALT31.StrType)le.alt_6_nada_model),
    BaseFile_Fields.InValid_alt_6_nada_body_style((SALT31.StrType)le.alt_6_nada_body_style),
    BaseFile_Fields.InValid_alt_6_nada_msrp((SALT31.StrType)le.alt_6_nada_msrp),
    BaseFile_Fields.InValid_alt_6_nada_gvwr((SALT31.StrType)le.alt_6_nada_gvwr),
    BaseFile_Fields.InValid_alt_6_nada_gcwr((SALT31.StrType)le.alt_6_nada_gcwr),
    BaseFile_Fields.InValid_alt_7_nada_vehicle_id((SALT31.StrType)le.alt_7_nada_vehicle_id),
    BaseFile_Fields.InValid_alt_7_nada_model((SALT31.StrType)le.alt_7_nada_model),
    BaseFile_Fields.InValid_alt_7_nada_body_style((SALT31.StrType)le.alt_7_nada_body_style),
    BaseFile_Fields.InValid_alt_7_nada_msrp((SALT31.StrType)le.alt_7_nada_msrp),
    BaseFile_Fields.InValid_alt_7_nada_gvwr((SALT31.StrType)le.alt_7_nada_gvwr),
    BaseFile_Fields.InValid_alt_7_nada_gcwr((SALT31.StrType)le.alt_7_nada_gcwr),
    BaseFile_Fields.InValid_aaia_codes((SALT31.StrType)le.aaia_codes),
    BaseFile_Fields.InValid_incomplete_vehicle_flag((SALT31.StrType)le.incomplete_vehicle_flag),
    BaseFile_Fields.InValid_filler2((SALT31.StrType)le.filler2),
    BaseFile_Fields.InValid_electric_battery_info_type((SALT31.StrType)le.electric_battery_info_type),
    BaseFile_Fields.InValid_filler3((SALT31.StrType)le.filler3),
    BaseFile_Fields.InValid_electric_battery_kilowatts((SALT31.StrType)le.electric_battery_kilowatts),
    BaseFile_Fields.InValid_filler4((SALT31.StrType)le.filler4),
    BaseFile_Fields.InValid_electric_battery_volts((SALT31.StrType)le.electric_battery_volts),
    BaseFile_Fields.InValid_filler5((SALT31.StrType)le.filler5),
    BaseFile_Fields.InValid_engine_info_proprietary_engine_brand((SALT31.StrType)le.engine_info_proprietary_engine_brand),
    BaseFile_Fields.InValid_filler6((SALT31.StrType)le.filler6),
    BaseFile_Fields.InValid_engine_info_high_output_engine((SALT31.StrType)le.engine_info_high_output_engine),
    BaseFile_Fields.InValid_engine_info_supercharged((SALT31.StrType)le.engine_info_supercharged),
    BaseFile_Fields.InValid_engine_info_turbocharged((SALT31.StrType)le.engine_info_turbocharged),
    BaseFile_Fields.InValid_engine_info_vvtl((SALT31.StrType)le.engine_info_vvtl),
    BaseFile_Fields.InValid_iso_liability((SALT31.StrType)le.iso_liability),
    BaseFile_Fields.InValid_series_name_condensed((SALT31.StrType)le.series_name_condensed),
    BaseFile_Fields.InValid_aces_data((SALT31.StrType)le.aces_data),
    BaseFile_Fields.InValid_base_shipping_weight_expanded((SALT31.StrType)le.base_shipping_weight_expanded),
    BaseFile_Fields.InValid_filler7((SALT31.StrType)le.filler7),
    BaseFile_Fields.InValid_customer_defined_data((SALT31.StrType)le.customer_defined_data),
    0);
