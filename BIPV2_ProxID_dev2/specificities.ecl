...
EXPORT input_layout := RECORD // project out required fields
  ...
  h.company_address_type_raw;
  h.company_address_type_derived;
  h.dt_first_seen;
  h.dt_last_seen;
END;
r := input_layout;
...
EXPORT input_file := h0  : PERSIST('~temp::Proxid::BIPV2_ProxID_dev2::Specificities_Cache');
//We have Proxid specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.Proxid;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,Proxid,LOCAL)  : PERSIST('~temp::Proxid::BIPV2_ProxID_dev2::Cluster_Sizes');
EXPORT TotalClusters := COUNT(ClusterSizes);
 
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::active_duns_number';
 
SHARED  active_duns_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_duns_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_active_duns_number'); // Reduce to field values by UID
...
EXPORT active_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::active_enterprise_number';
 
SHARED  active_enterprise_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_enterprise_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_active_enterprise_number'); // Reduce to field values by UID
...
EXPORT active_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::active_domestic_corp_key';
 
SHARED  active_domestic_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_domestic_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_active_domestic_corp_key'); // Reduce to field values by UID
...
EXPORT hist_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::hist_enterprise_number';
 
SHARED  hist_enterprise_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_enterprise_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_hist_enterprise_number'); // Reduce to field values by UID
...
EXPORT hist_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::hist_duns_number';
 
SHARED  hist_duns_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_duns_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_hist_duns_number'); // Reduce to field values by UID
...
EXPORT hist_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::hist_domestic_corp_key';
 
SHARED  hist_domestic_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_domestic_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_hist_domestic_corp_key'); // Reduce to field values by UID
...
EXPORT foreign_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::foreign_corp_key';
 
SHARED  foreign_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,foreign_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_foreign_corp_key'); // Reduce to field values by UID
...
EXPORT unk_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::unk_corp_key';
 
SHARED  unk_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,unk_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_unk_corp_key'); // Reduce to field values by UID
...
EXPORT ebr_file_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::ebr_file_number';
 
SHARED  ebr_file_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,ebr_file_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_ebr_file_number'); // Reduce to field values by UID
...
EXPORT cnp_nameValuesKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::cnp_name';
 
SHARED  cnp_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,cnp_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_cnp_name'); // Reduce to field values by UID
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::cnp_number';
 
SHARED  cnp_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,cnp_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_cnp_number'); // Reduce to field values by UID
...
EXPORT cnp_btypeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::cnp_btype';
 
SHARED  cnp_btype_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,cnp_btype) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_cnp_btype'); // Reduce to field values by UID
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::company_fein';
 
SHARED  company_fein_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_fein) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_company_fein'); // Reduce to field values by UID
...
EXPORT company_phoneValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::company_phone';
 
SHARED  company_phone_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_phone) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_company_phone'); // Reduce to field values by UID
...
EXPORT iscorpValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::iscorp';
 
SHARED  iscorp_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,iscorp) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_iscorp'); // Reduce to field values by UID
...
EXPORT prim_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::prim_range';
 
SHARED  prim_range_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,prim_range) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_prim_range'); // Reduce to field values by UID
...
EXPORT prim_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::prim_name';
 
SHARED  prim_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,prim_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_prim_name'); // Reduce to field values by UID
...
EXPORT sec_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::sec_range';
 
SHARED  sec_range_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,sec_range) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_sec_range'); // Reduce to field values by UID
...
EXPORT v_city_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::v_city_name';
 
SHARED  v_city_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,v_city_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_v_city_name'); // Reduce to field values by UID
...
EXPORT stValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::st';
 
SHARED  st_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,st) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_st'); // Reduce to field values by UID
...
EXPORT zipValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::zip';
 
SHARED  zip_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,zip) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_zip'); // Reduce to field values by UID
...
EXPORT company_cszValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::company_csz';
 
SHARED  company_csz_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_csz) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_company_csz'); // Reduce to field values by UID
...
EXPORT company_addr1ValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::company_addr1';
 
SHARED  company_addr1_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_addr1) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_company_addr1'); // Reduce to field values by UID
...
EXPORT company_addressValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::company_address';
 
SHARED  company_address_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_address) : PERSIST('~temp::dedups::BIPV2_ProxID_dev2_Proxid_company_address'); // Reduce to field values by UID
...
EXPORT company_address_specificity := ol;
  ...
  END;
  t := TABLE(infile,r);
SHARED SrcRidVlid_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('BIPV2_ProxID_dev2::SrcRidVlid::values');
...
EXPORT SrcRidVlidValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Word::SrcRidVlid';
...
EXPORT SpecIndexKeyName := '~'+'key::BIPV2_ProxID_dev2::Proxid::Specificities';
...
SpcShiftR := RECORD
  ...
  integer1 active_domestic_corp_key_shift0 := ROUND(Specificities[1].active_domestic_corp_key_specificity - 26);
  ...
  integer2 hist_enterprise_number_switch_shift0 := ROUND(1000*Specificities[1].hist_enterprise_number_switch - 11);
  ...
  integer2 foreign_corp_key_switch_shift0 := ROUND(1000*Specificities[1].foreign_corp_key_switch - 95);
  integer1 unk_corp_key_shift0 := ROUND(Specificities[1].unk_corp_key_specificity - 27);
  integer2 unk_corp_key_switch_shift0 := ROUND(1000*Specificities[1].unk_corp_key_switch - 14);
  integer1 ebr_file_number_shift0 := ROUND(Specificities[1].ebr_file_number_specificity - 27);
  integer2 ebr_file_number_switch_shift0 := ROUND(1000*Specificities[1].ebr_file_number_switch - 253);
  integer1 cnp_name_shift0 := ROUND(Specificities[1].cnp_name_specificity - 25);
  integer2 cnp_name_switch_shift0 := ROUND(1000*Specificities[1].cnp_name_switch - 81);
  ...
  integer2 cnp_btype_switch_shift0 := ROUND(1000*Specificities[1].cnp_btype_switch - 27);
  ...
  integer2 company_phone_switch_shift0 := ROUND(1000*Specificities[1].company_phone_switch - 257);
  ...
  integer2 sec_range_switch_shift0 := ROUND(1000*Specificities[1].sec_range_switch - 95);
  ...
  integer2 company_addr1_switch_shift0 := ROUND(1000*Specificities[1].company_addr1_switch - 107);
  ...
  INTEGER2 SrcRidVlid_switch_shift0 := ROUND(1000*Specificities[1].SrcRidVlid_switch - 307);
  END;
