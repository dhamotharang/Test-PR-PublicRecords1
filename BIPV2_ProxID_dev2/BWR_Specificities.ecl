...
#workunit('name','BIPV2_ProxID_dev2.BWR_Specificities - Specificities - SALT V2.5 Beta 2');
...
sequential(
  ...
  ,parallel(
    ...
    ,SALTTOOLS22.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_ProxID_dev2._SPC',dotbase)
));
