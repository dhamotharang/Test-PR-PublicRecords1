EXPORT BWR_Check_Missing_Candidates := 'todo';output(BIPV2_ProxID_dev2.Files().outfile.qa(dotid in [1786858,4063037]));
...
dit10 				:= BIPV2_ProxID_dev2.Files().outfile.qa;
keycandidates := BIPV2_ProxID_dev2.Keys(BFile).Candidates;
...
BIPV2_ProxID_dev2.output_test_cases(dProxidsInBoth);
