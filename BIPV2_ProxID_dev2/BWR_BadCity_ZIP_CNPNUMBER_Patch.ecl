...
dbase1 := BIPV2_ProxID_dev2.files('20130212a_1').base.logical : global;

msd               := BIPV2_ProxID_dev2.Keys(BIPV2_ProxID_dev2.In_DOT_Base).MatchSample;
gte21             := msd(conf >= 21);
...
output(djoin                            ,,'~BIPV2_ProxID_dev2::base::20130212b_1::data',__COMPRESSED__,OVERWRITE);
