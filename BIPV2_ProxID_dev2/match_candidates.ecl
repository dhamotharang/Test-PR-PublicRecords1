...
SHARED SrcRidVlid_prop4 := JOIN(SrcRidVlid_prop3,cnp_name_props,left.Proxid=right.Proxid,LOCAL);
...
layout_withpropvars take_cnp_number(with_props le,cnp_number_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj12 := JOIN(pj8,cnp_number_props,left.Proxid=right.Proxid,take_cnp_number(left,right),LEFT OUTER,HASH);
...
layout_withpropvars take_company_fein(with_props le,company_fein_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj17 := JOIN(pj12,company_fein_props,left.Proxid=right.Proxid,take_company_fein(left,right),LEFT OUTER,HASH);
...
layout_withpropvars take_company_phone(with_props le,company_phone_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj20 := JOIN(pj17,company_phone_props,left.Proxid=right.Proxid,take_company_phone(left,right),LEFT OUTER,HASH);
...
layout_withpropvars take_iscorp(with_props le,iscorp_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj21 := JOIN(pj20,iscorp_props,left.Proxid=right.Proxid,take_iscorp(left,right),LEFT OUTER,HASH);
...
SHARED SrcRidVlid_prop6 := JOIN(SrcRidVlid_prop5,prim_range_props,left.Proxid=right.Proxid,LEFT OUTER,LOCAL);
...
SHARED SrcRidVlid_prop7 := JOIN(SrcRidVlid_prop6,prim_name_props,left.Proxid=right.Proxid,LEFT OUTER,LOCAL);
...
layout_withpropvars take_sec_range(with_props le,sec_range_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj24 := JOIN(pj21,sec_range_props,left.Proxid=right.Proxid,take_sec_range(left,right),LEFT OUTER,HASH);
...
SHARED SrcRidVlid_prop10 := JOIN(SrcRidVlid_prop9,st_props,left.Proxid=right.Proxid,LEFT OUTER,LOCAL);
...
pj24 do_computes(pj24 le) := TRANSFORM
  ...
  SELF := le;
END;
SHARED propogated := PROJECT(pj24,do_computes(left)) : PERSIST('~temp::BIPV2_ProxID_dev2_Proxid_DOT_Base_mc_props'); // to allow to 'jump' over an exported value
...
layout_candidates add_cnp_number(layout_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j19,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_cnp_number,j18);
layout_candidates add_prim_range(layout_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j18,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_prim_range,j17);
layout_candidates add_company_csz(layout_candidates le,Specificities(ih).company_csz_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j17,s.nulls_company_csz,Specificities(ih).company_csz_values_persisted,company_csz,company_csz_weight100,add_company_csz,j16);
layout_candidates add_zip(layout_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j16,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_zip,j15);
...
layout_candidates add_company_fein(layout_candidates le,Specificities(ih).company_fein_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j12,s.nulls_company_fein,Specificities(ih).company_fein_values_persisted,company_fein,company_fein_weight100,add_company_fein,j11);
layout_candidates add_cnp_name(layout_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j11,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_cnp_name,j10);
layout_candidates add_company_phone(layout_candidates le,Specificities(ih).company_phone_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j10,s.nulls_company_phone,Specificities(ih).company_phone_values_persisted,company_phone,company_phone_weight100,add_company_phone,j9);
...
layout_candidates add_active_domestic_corp_key(layout_candidates le,Specificities(ih).active_domestic_corp_key_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j8,s.nulls_active_domestic_corp_key,Specificities(ih).active_domestic_corp_key_values_persisted,active_domestic_corp_key,active_domestic_corp_key_weight100,add_active_domestic_corp_key,j7);
...
layout_candidates add_hist_duns_number(layout_candidates le,Specificities(ih).hist_duns_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j4,s.nulls_hist_duns_number,Specificities(ih).hist_duns_number_values_persisted,hist_duns_number,hist_duns_number_weight100,add_hist_duns_number,j3);
...
SHARED Annotated := DISTRIBUTE(j0,hash(Proxid)) : PERSIST('~temp::BIPV2_ProxID_dev2_DOT_Base_mc'); // Distributed for keybuild case
...
layout_SrcRidVlid_candidates add_SrcRidVlid_active_domestic_corp_key(layout_SrcRidVlid_candidates le,Specificities(ih).active_domestic_corp_key_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_2,s.nulls_active_domestic_corp_key,Specificities(ih).active_domestic_corp_key_values_persisted,active_domestic_corp_key,active_domestic_corp_key_weight100,add_SrcRidVlid_active_domestic_corp_key,jSrcRidVlid_7);
layout_SrcRidVlid_candidates add_SrcRidVlid_cnp_name(layout_SrcRidVlid_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_7,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_SrcRidVlid_cnp_name,jSrcRidVlid_10);
layout_SrcRidVlid_candidates add_SrcRidVlid_company_address(layout_SrcRidVlid_candidates le,Specificities(ih).company_address_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_10,s.nulls_company_address,Specificities(ih).company_address_values_persisted,company_address,company_address_weight100,add_SrcRidVlid_company_address,jSrcRidVlid_12);
...
layout_SrcRidVlid_candidates add_SrcRidVlid_zip(layout_SrcRidVlid_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_14,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_SrcRidVlid_zip,jSrcRidVlid_15);
layout_SrcRidVlid_candidates add_SrcRidVlid_company_csz(layout_SrcRidVlid_candidates le,Specificities(ih).company_csz_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_15,s.nulls_company_csz,Specificities(ih).company_csz_values_persisted,company_csz,company_csz_weight100,add_SrcRidVlid_company_csz,jSrcRidVlid_16);
layout_SrcRidVlid_candidates add_SrcRidVlid_prim_range(layout_SrcRidVlid_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_16,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_SrcRidVlid_prim_range,jSrcRidVlid_17);
layout_SrcRidVlid_candidates add_SrcRidVlid_cnp_number(layout_SrcRidVlid_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(jSrcRidVlid_17,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_SrcRidVlid_cnp_number,jSrcRidVlid_18);
...
export SrcRidVlid_candidates := jSrcRidVlid_21 : persist('~temp::mc::BIPV2_ProxID_dev2::SrcRidVlid');
//Now see if these records are actually linkable
TotalWeight := Annotated.active_enterprise_number_weight100 + Annotated.hist_enterprise_number_weight100 + Annotated.active_duns_number_weight100 + Annotated.hist_duns_number_weight100 + Annotated.hist_domestic_corp_key_weight100 + Annotated.unk_corp_key_weight100 + Annotated.ebr_file_number_weight100 + Annotated.active_domestic_corp_key_weight100 + Annotated.foreign_corp_key_weight100 + Annotated.company_phone_weight100 + Annotated.cnp_name_weight100 + Annotated.company_fein_weight100 + Annotated.company_address_weight100 + Annotated.cnp_number_weight100 + Annotated.cnp_btype_weight100 + Annotated.iscorp_weight100;
