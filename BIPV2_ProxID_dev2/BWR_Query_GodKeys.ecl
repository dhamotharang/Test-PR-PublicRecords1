...
kmtchsmpl  := index(BIPV2_ProxID_dev2.Keys(BIPV2_ProxID_dev2.In_DOT_Base).MatchSample ,BIPV2_ProxID_dev2.keynames('20130212_25').match_sample_debug.logical);
kmtchgt21 := kmtchsmpl(conf >= 21);
ddev2      := BIPV2_ProxID_dev2.files('20130212_25').base.logical;
