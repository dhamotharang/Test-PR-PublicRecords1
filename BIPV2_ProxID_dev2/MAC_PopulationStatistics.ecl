...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_cnp_number = '',Input_prim_range = '',Input_prim_name = '',Input_st = '',Input_active_enterprise_number = '',Input_hist_enterprise_number = '',Input_hist_duns_number = '',Input_hist_domestic_corp_key = '',Input_unk_corp_key = '',Input_ebr_file_number = '',Input_active_duns_number = '',Input_foreign_corp_key = '',Input_company_phone = '',Input_active_domestic_corp_key = '',Input_cnp_name = '',Input_company_fein = '',Input_company_address = '',Input_company_addr1 = '',Input_zip = '',Input_company_csz = '',Input_sec_range = '',Input_v_city_name = '',Input_cnp_btype = '',Input_iscorp = '',Input_company_name = '',Input_cnp_hasnumber = '',Input_cnp_lowv = '',Input_cnp_translated = '',Input_cnp_classid = '',Input_company_foreign_domestic = '',Input_company_bdid = '',Input_company_address_type_raw = '',Input_company_address_type_derived = '',Input_dt_first_seen = '',Input_dt_last_seen = '',OutFile) := MACRO
