//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_dev2',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_dev2.filenames(combo).dall_filenames
                  + BIPV2_ProxID_dev2.keynames (combo).dall_filenames
                  + BIPV2_ProxID_dev2.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_dev2.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_dev2.filenames(siter).dall_filenames
                  + BIPV2_ProxID_dev2.keynames (siter).dall_filenames
                  ;
