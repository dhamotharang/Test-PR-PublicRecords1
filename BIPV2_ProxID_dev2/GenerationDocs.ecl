Generated by SALT V2.7 Alpha 5
...
FIELD:active_domestic_corp_key:FORCE(--):PROP:26,0
 
// Historical and non-domestic IDs from reliable sources
// If match, add to score, if not, don't care(SWITCH0)
FIELD:hist_enterprise_number:SWITCH0:PROP:28,11
FIELD:hist_duns_number:SWITCH0:PROP:27,20
FIELD:hist_domestic_corp_key:SWITCH0:PROP:27,9
FIELD:foreign_corp_key:SWITCH0:PROP:26,95
FIELD:unk_corp_key:SWITCH0:PROP:27,14
FIELD:ebr_file_number:SWITCH0:PROP:27,253
...
FIELD:cnp_name:BAGOFWORDS(MOST):EDIT1:FORCE(+13):TYPE(string250):25,81
...
FIELD:company_fein:PROP:EDIT1:25,38
...
FIELD:company_phone:SWITCH0:PROP:26,257
...
FIELD:sec_range:PROP:SWITCH0:12,95
...
CONCEPT:company_addr1:prim_range:prim_name:sec_range:23,107
CONCEPT:company_address:company_addr1:company_csz:FORCE(+):25,115
 
FIELD:company_address_type_raw:CARRY:0,0
FIELD:company_address_type_derived:CARRY:0,0
...
//  Attribute Files
// ------------------------------------
ATTRIBUTEFILE:SrcRidVlid:NAMED(file_SrcRidVlid):VALUES(source:source_record_id:vl_id):IDFIELD(Proxid):SUPPORTS(company_address):27,307
...
Total available specificity:467
...
(This subtraction estimate is based upon 9% of clusters with 2 or more records have 2 or more values for foreign_corp_key.)
...
(This subtraction estimate is based upon 8% of clusters with 2 or more records have 2 or more values for cnp_name.)
...
company_address_type_raw Scoring: This field is not used for scoring; rather it is carried along for context and debugging
company_address_type_derived Scoring: This field is not used for scoring; rather it is carried along for context and debugging
