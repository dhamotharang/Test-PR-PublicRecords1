...
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(doxie_files.Key_BocaShell_Crim_FCRA,'~thor_data400::key::corrections_offenders::fcra::bocashell_did','~thor_data400::key::corrections_offenders::fcra::'+filedate+'::bocashell_did', b);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(doxie_files.key_offenders_FCRA,'~thor_200::key::criminal_offenders::fcra::' + doxie.Version_SuperKey + '::did','~thor_200::key::criminal_offenders::fcra::'+filedate+'::did',c);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(doxie_files.Key_Offenses_FCRA,'~thor_200::key::criminal_offenses::fcra::' + doxie.Version_SuperKey + '::offender_key','~thor_200::key::criminal_offenses::fcra::'+filedate+'::offender_key',d);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(doxie_files.Key_Punishment_FCRA,'~thor_200::key::criminal_punishment::fcra::'+ doxie.Version_SuperKey + '::offender_key.punishment_type','~thor_200::key::criminal_punishment::fcra::'+filedate+'::offender_key.punishment_type',e);
