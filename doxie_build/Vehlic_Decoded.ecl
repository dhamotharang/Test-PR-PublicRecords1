import Vehlic, codes, doxie,census_data, ut;
...
o15 := project(o14,map_lein_holder_county_names(LEFT)) : PERSIST ('~thor_data400::persist::vehicle::decoded');

export Vehlic_Decoded := o15;