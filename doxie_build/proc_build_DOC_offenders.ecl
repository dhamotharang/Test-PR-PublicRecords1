import ut,corrections,header_slimsort,watchdog,didville,fair_isaac,did_add,doxie_build,census_data,codes, hygenics_crim;


df4 := hygenics_crim.AllOffenders;
...
hygenics_crim.layout_offender into_offender(df4 L) := transform
...
hygenics_crim.layout_offender get_state_mapping1(o1wd L, codes.File_Codes_V3_In R) := transform
...
hygenics_crim.layout_offender get_state_mapping2(o1a L, codes.File_Codes_V3_In R) := transform
...
hygenics_crim.layout_offender get_county_name(o1a2 L, Census_data.File_Fips2County r) := transform
...
hygenics_crim.layout_offender tPostDIDPatch(corrections.Layout_Offender pInput)
 :=
  transform
...
export proc_build_DOC_offenders := dpostfinal;