...
offnd := distribute(doxie_build.proc_build_DOC_offenders(),hash(vendor,offender_key)) ;//: persist('persist::Inputoffender' );
...
export proc_build_DOC_offenders_flagged:= 
 // flaggedRecs :persist ('persist::corrections::Offender_flagged');
                       sequential(outOffnd
											 ,outPun);
