import Vehlic, doxie_build, doxie, codes, census_data;
...
export Key_prep_Vehicles := INDEX(o15, {sseq_no := seq_no}, {o15}, '~thor_data400::key::'+doxie_build.buildstate+'vehiclefull'+thorlib.wuid());
