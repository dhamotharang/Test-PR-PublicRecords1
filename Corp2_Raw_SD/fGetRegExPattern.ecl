export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1	 	:= '^SAME$|^NONE$|^NONE|^UNKNOWN$|^N/A$|^XXX$|^NO ADDRESS$|^X$|^XX$|';
	...
	export City := module
		...
		shared PatternInvalidWords1		:= '^SAME$|^NONE$|^UNKNOWN$|^NO ADDRESS$|^X$|^XX$';
		export InvalidWords						:= PatternInvalidWords1;
	end;
	...
	export State := module
		...
		SHARED PatternInvalidWords1		:= '^X$|^XX$|^NO$|^NA$|^NONE LISTED$|^NONE$';
	...
	export Zip := module
		...
		shared PatternInvalidWords1	 	:= '^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |^UNKNOWN$|^X$|^XX$';
		export InvalidWords						:= PatternInvalidWords1;
	end;
