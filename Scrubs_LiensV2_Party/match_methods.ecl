IMPORT SALT30,std;
EXPORT match_methods(DATASET(layout_Liens_Party) ih) := MODULE
...
EXPORT match_orig_full_debtorname(TYPEOF(h.orig_full_debtorname) L, TYPEOF(h.orig_full_debtorname) R, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
	MAP(L = R => SALT30.MatchCode.ExactMatch,
		SALT30.MatchCode.NoMatch),
	MAP(L = R => SALT30.MatchCode.ExactMatch, SALT30.MatchCode.NoMatch)
);
