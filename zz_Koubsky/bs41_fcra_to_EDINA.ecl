// EXPORT bs41_nonfcra_to_EDINA := 'todo';
...
//===================  input-output files  ======================
// infile_name := '~scoringqa::out::bs_41_tracking_edina_fcra_no_edina_qh_bestaddr_base_20150311';
// outfile_name := '~nkoubsky::out::bs_41_tracking_fcra_qh_bestaddr_base_' + thorlib.wuid();
infile_name := '~scoringqa::out::bs_41_tracking_edina_fcra_no_edina_qh_bestaddr_test_20150312';
outfile_name := '~nkoubsky::out::bs_41_tracking_fcra_qh_bestaddr_test_' + thorlib.wuid();
