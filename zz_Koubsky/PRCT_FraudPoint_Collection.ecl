...
IMPORT ut, Risk_Indicators, riskwise, models, RiskProcessing;
		...
		String outfile_name :=  '~nkoubsky::prct::fp_test_21071121' ;
    ...
    HISTORYDATE := 999999;
	  ...
	  //************** INPUT FILE GENERATION ****************	
		...
		layout_soap_input append_settings(ds_raw_input le, INTEGER c) := TRANSFORM
		  self.accountnumber := (string)le.lexID;	
    ...
    //*********** PERFORMING SOAPCALL TO ROXIE ************ 
		output(soap_in,,'nkoubsky::out::fraudpoint_xml_request', xml, overwrite);
		...
		Soap_output := soapcall(soap_in, roxieIP,
			...
			output(choosen(Soap_output, eyeball), named('Soap_output'));
    ...
    //final file out to thor
		output(choosen(NewRecs, eyeball), named('final_output'));
