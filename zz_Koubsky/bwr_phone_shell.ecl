...
OUTPUT(goodResults,, OutputFile + '_6.csv', CSV(HEADING(single), QUOTE('"')), OVERWRITE);
OUTPUT(modelingShell,, OutputFile + '_ModelLayout_6.csv', CSV(HEADING(single), QUOTE('"')), OVERWRITE);