...
f1 := IF(no_of_records = 0, dataset(Infile_name, layout_input, CSV(heading(single), quote('"'))), choosen(dataset ( Infile_name, layout_input, CSV(heading(single), quote('"'))), no_of_records));
