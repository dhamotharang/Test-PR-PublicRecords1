...
// Bug: 80123. DID = 2074179303	score = 75	ssn append = 178546978
	...
	ds_fixed_data_flagged removeInfo(ds_fixed_data_flagged l):= transform
		self.ssn_appended	:= if((l.ssn_appended='353561176' and l.did=2275932305) or 
									...
									(l.ssn_appended='495742312' and l.did=1033147214),
								'',
								l.ssn_appended);
...
uniquePID := dedup(sort(dedupedOffender,offender_persistent_id),offender_persistent_id) : persist('Persist::Crim_offender_persistentID1_unique'); 
