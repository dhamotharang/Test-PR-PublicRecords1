...
In_Base_file := Hygenics_SOff.File_OKC_Sex_Offender_DID;
...
output(ds_SearchMoxieFile,,'~thor_200::base::hd::OKC_Sex_Offender_Search_File_Moxie',overwrite);

///////////////////////////////////////////////////////////////////////////////////////

export Mapping_OKC_Cleaned_As_SearchFile := output(ds_SearchFile_Final,,'~thor_200::base::hd::OKC_Sex_Offender_Search_File',overwrite);