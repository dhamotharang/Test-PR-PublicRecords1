export Layout_OKC_Sex_Offender_Fixed := record
    string30  	source_file;
	string10	date_added;						//new field added 
    string10  	scrape_date;
	string10    src_upload_date;				//new field added for CROSS
    string2  	orig_state;
    string50  	name_orig;
	string30    orig_firstname;					//new field
	string30    orig_middlename;				//new field
	string30    orig_lastname;					//new field
	string10    orig_suffix;					//new field
	string30	firstname;
	string30	middlename;
	string30	lastname;
	string10	suffix;
