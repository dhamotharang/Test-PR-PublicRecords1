...
email_notice 	:= if(count(exceptList(offense_category='')) > 0
										,sequential(output(exceptList, all, named('Unclassified_Sex_Offenses_List'))
												...
												,fileservices.SendEmail('cindy.loizzo@lexisnexis.com;judy.tao@lexisnexis.com;charles.pettola@lexisnexis.com;tarun.patel@lexisnexis.com;angela.herzberg@lexisnexis.com', 'Sex Offender: Uncategorized Offense List Available', 'The latest uncategorized sex offense list now is available.  Please see: '+'http://prod_esp.br.seisint.com:8010/WsWorkunits/WUInfo?Wuid='+ workunit))
										,fileservices.SendEmail('cindy.loizzo@lexisnexis.com;judy.tao@lexisnexis.com;charles.pettola@lexisnexis.com;tarun.patel@lexisnexis.com;angela.herzberg@lexisnexis.com', 'Sex Offender: No Uncategorized Offense List', 'There are no uncategorized sex offenses in this build'));
