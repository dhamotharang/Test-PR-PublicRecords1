...
EXPORT Spray_Soff_Files_CW (String srcIP,
							String targetGrp,
							String RemoteLoc,
	...
	AddToSuperFile  :=  Parallel(digssoff.SuperFile_Functions.Fun_AddToSuperfile(Sprayeddef, '~thor200_144::in::sex_offender::hd::DEFENDANT_CW'),
										           digssoff.SuperFile_Functions.Fun_AddToSuperfile(Sprayedoff, '~thor200_144::in::sex_offender::hd::OFFENSE_CW'),
										           digssoff.SuperFile_Functions.Fun_AddToSuperfile(Sprayedali, '~thor200_144::in::sex_offender::hd::ALIAS_CW'),
										           digssoff.SuperFile_Functions.Fun_AddToSuperfile(Sprayedadd, '~thor200_144::in::sex_offender::hd::ADDRESS_HISTORY_CW'));
