...
export Layout_Denorm_Offense := RECORD, MAXLENGTH(10000)
		...
		Hygenics_soff.file_in_so_offense.recordid;
		...
		string offense_level_1				:='';	//new field added for CROSS  
		...
		string disposition_dt_1				:='';	//new field added for CROSS  
		string offense_location_1			:='';	//new field added for CROSS  
		...
		string offense_level_2				:='';	//new field added for CROSS  
		...
		string disposition_dt_2				:='';	//new field added for CROSS  
		string offense_location_2			:='';	//new field added for CROSS  
		...
		string offense_level_3				:='';	//new field added for CROSS  
		...
		string disposition_dt_3				:='';	//new field added for CROSS  
		string offense_location_3			:='';	//new field added for CROSS  
		...
		string offense_level_4				:='';	//new field added for CROSS  
		...
		string disposition_dt_4				:='';	//new field added for CROSS  
		string offense_location_4			:='';	//new field added for CROSS  
		...
		string offense_level_5				:='';	//new field added for CROSS  
		...
		string disposition_dt_5				:='';	//new field added for CROSS  
		string offense_location_5			:='';	//new field added for CROSS  
