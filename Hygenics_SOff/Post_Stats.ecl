...
string12 v_run_type := hygenics_soff.Version_Development + 'okc';
...
sex_pred_2 := dataset('~thor_200::base::hd::okc_sex_offender_file_accurint_in', my_layout_sex_pred_2, flat);
b := sex_pred_2;
...
sex_pred_search := dataset('~thor_200::base::hd::okc_sex_offender_search_file', my_layout_sex_pred_search, flat);
s := sex_pred_search;
...
export Post_Stats := okc_post_pop_stats;
