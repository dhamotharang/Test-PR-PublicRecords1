...
Command line options: -MScrubs_Corp2_Mapping_AR_Main -eC:\Users\myanasx\AppData\Local\Temp\TFRFBFB.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_AR_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(05)
FIELDTYPE:invalid_state_origin:ENUM(AR)
FIELDTYPE:invalid_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_orgStruc_codes)
...
FIELDTYPE:invalid_alphablankBar:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ) 
FIELDTYPE:invalid_corp_acts:ALLOW( /;:,.&-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ) 
...
FIELDTYPE:invalid_status_cd:ENUM(Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_status_codes)
FIELDTYPE:invalid_tax_program_cd:ENUM(Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_TaxId_codes)
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_flag_code:ENUM(Y|N| )
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_AR_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_code:ALLOW(0123456789 )
...
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_alphablankBar):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING8):0,0
...
FIELD:corp_acts:TYPE(STRING50):LIKE(invalid_corp_acts):0,0
...
FIELD:corp_tax_program_cd:TYPE(STRING8):LIKE(invalid_tax_program_cd):0,0
...
FIELD:corp_agent_country:TYPE(STRING50):LIKE(invalid_country_of_formation):0,0
...
FIELD:InternalField1:TYPE(STRING100):LIKE(invalid_code):0,0
