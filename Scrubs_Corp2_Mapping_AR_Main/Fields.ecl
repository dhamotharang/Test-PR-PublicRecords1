IMPORT SALT34;
IMPORT Scrubs_Corp2_Mapping_AR_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_org_structure_cd','invalid_mandatory','invalid_numeric','invalid_charter_nbr','invalid_alphablank','invalid_forgn_state_desc','invalid_alphablankBar','invalid_corp_acts','invalid_country_of_formation','invalid_alphaRequired','invalid_date','invalid_status_cd','invalid_tax_program_cd','invalid_for_dom_ind','invalid_recordorigin','invalid_flag_code','invalid_name_type_code','invalid_code');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_org_structure_cd' => 4,'invalid_mandatory' => 5,'invalid_numeric' => 6,'invalid_charter_nbr' => 7,'invalid_alphablank' => 8,'invalid_forgn_state_desc' => 9,'invalid_alphablankBar' => 10,'invalid_corp_acts' => 11,'invalid_country_of_formation' => 12,'invalid_alphaRequired' => 13,'invalid_date' => 14,'invalid_status_cd' => 15,'invalid_tax_program_cd' => 16,'invalid_for_dom_ind' => 17,'invalid_recordorigin' => 18,'invalid_flag_code' => 19,'invalid_name_type_code' => 20,'invalid_code' => 21,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['05']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('05'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['AR']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('AR'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_orgStruc_codes);
EXPORT InValidMessageFT_invalid_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_orgStruc_codes'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_numeric(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numeric(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_numeric(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_forgn_state_desc(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_forgn_state_desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' -,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_forgn_state_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' -,.ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphablankBar(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphablankBar(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphablankBar(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_acts(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' /;:,.&-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_acts(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' /;:,.&-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_corp_acts(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' /;:,.&-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_country_of_formation(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_country_of_formation(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_country_of_formation(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' ().,-ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaRequired(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaRequired(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_alphaRequired(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_date(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_pastDate(s)>0,~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 8));
EXPORT InValidMessageFT_invalid_date(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT34.HygieneErrors.NotLength('0..8'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_status_codes);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_status_codes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_tax_program_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_program_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_TaxId_codes);
EXPORT InValidMessageFT_invalid_tax_program_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_AR_Main.Functions.set_valid_TaxId_codes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_for_dom_ind(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_dom_ind(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D','F',' ']);
EXPORT InValidMessageFT_invalid_for_dom_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D|F| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_AR_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_AR_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_code(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_code(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789 '))));
EXPORT InValidMessageFT_invalid_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789 '),SALT34.HygieneErrors.Good);
...
EXPORT InValid_corp_supp_key(SALT34.StrType s) := 0;
...
EXPORT Make_corp_status_desc(SALT34.StrType s0) := MakeFT_invalid_alphablankBar(s0);
EXPORT InValid_corp_status_desc(SALT34.StrType s) := InValidFT_invalid_alphablankBar(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablankBar(wh);
 
EXPORT Make_corp_status_date(SALT34.StrType s0) := s0;
EXPORT InValid_corp_status_date(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_standing(SALT34.StrType s0) := s0;
EXPORT InValid_corp_standing(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_standing(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_status_comment(SALT34.StrType s0) := s0;
EXPORT InValid_corp_status_comment(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_status_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ticker_symbol(SALT34.StrType s0) := s0;
EXPORT InValid_corp_ticker_symbol(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_ticker_symbol(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_stock_exchange(SALT34.StrType s0) := s0;
EXPORT InValid_corp_stock_exchange(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_inc_county(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_forgn_state_cd(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_forgn_sos_charter_nbr(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_orig_org_structure_desc(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_action_employment_security_approval_date(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_action_employment_security_approval_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_pending_cd(SALT34.StrType s0) := s0;
EXPORT InValid_corp_action_pending_cd(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_action_pending_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_pending_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_action_pending_desc(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_action_statement_of_intent_date(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_foreign_fiduciary_capacity_in_state(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_governing_statute(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_governing_statute(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_members(SALT34.StrType s0) := s0;
EXPORT InValid_corp_has_members(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_has_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_vested_managers(SALT34.StrType s0) := s0;
EXPORT InValid_corp_has_vested_managers(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_home_incorporated_county(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_home_incorporated_county(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_home_state_name(SALT34.StrType s0) := s0;
EXPORT InValid_corp_home_state_name(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_home_state_name(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_is_professional(SALT34.StrType s0) := s0;
EXPORT InValid_corp_is_professional(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_is_professional(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_is_non_profit_irs_approved(SALT34.StrType s0) := s0;
EXPORT InValid_corp_is_non_profit_irs_approved(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_name_reservation_expiration_date(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_expiration_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_nbr(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_type(SALT34.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_type(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_cd(SALT34.StrType s0) := s0;
EXPORT InValid_corp_name_status_cd(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_date(SALT34.StrType s0) := s0;
EXPORT InValid_corp_name_status_date(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_name_status_desc(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_irs_approved_purpose(SALT34.StrType s0) := s0;
EXPORT InValid_corp_non_profit_irs_approved_purpose(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_non_profit_irs_approved_purpose(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_solicit_donations(SALT34.StrType s0) := s0;
EXPORT InValid_corp_non_profit_solicit_donations(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_non_profit_solicit_donations(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_amendments(SALT34.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_amendments(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_amendments(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_initial_llc_members(SALT34.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_initial_llc_members(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_initial_llc_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_partners(SALT34.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_partners(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_partners(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_operating_agreement(SALT34.StrType s0) := s0;
EXPORT InValid_corp_operating_agreement(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_operating_agreement(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_opt_in_llc_act_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_opt_in_llc_act_desc(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_opt_in_llc_act_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_opt_in_llc_act_ind(SALT34.StrType s0) := s0;
EXPORT InValid_corp_opt_in_llc_act_ind(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_opt_in_llc_act_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_organizational_comments(SALT34.StrType s0) := s0;
EXPORT InValid_corp_organizational_comments(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_partner_contributions_total(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_partner_contributions_total(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_partner_terms(SALT34.StrType s0) := s0;
EXPORT InValid_corp_partner_terms(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_percentage_voters_required_to_approve_amendments(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_business_mark_type(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_cancelled_date(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_cancelled_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc1(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc1(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc2(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc2(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc3(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc3(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc4(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc4(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc4(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc5(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc5(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc5(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc6(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc6(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc6(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_classification_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_classification_nbr(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_disclaimer1(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_disclaimer1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_disclaimer2(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_disclaimer2(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_expiration_date(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_filing_date(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_first_use_date(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_first_use_date_in_state(SALT34.StrType s) := 0;
...
EXPORT InValid_corp_trademark_keywords(SALT34.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_keywords(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_logo(SALT34.StrType s0) := s0;
EXPORT InValid_corp_trademark_logo(SALT34.StrType s) := 0;
...
EXPORT Make_InternalField1(SALT34.StrType s0) := MakeFT_invalid_code(s0);
EXPORT InValid_InternalField1(SALT34.StrType s) := InValidFT_invalid_code(s);
EXPORT InValidMessage_InternalField1(UNSIGNED1 wh) := InValidMessageFT_invalid_code(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_AR_Main;
