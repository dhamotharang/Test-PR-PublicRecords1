export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1 	:= '(NONE (SAME)* (AS)* (ABOVE)*|^SAME|XX|SEE DOCUMENT|NONE PROVIDED|NONE GIVEN|UNDER NONE|UNKNOWN|^NONE)';
	...
	export Country := module
		...
		shared PatternInvalidWords1	 	:= '^XX|^SAME|^NONE|UNKNOWN';
		export InvalidWords						:= PatternInvalidWords1;
	end;
	...
	export FirstName := module
		...
		shared PatternInvalidWords1	 	:= 'ABBREVIATED LIST|OPERATES WITHOUT|^OPERATES|^SAME|NONE STATED|NONE LISTED|^NONE|^UNKNOWN|^WITHOUT|^VACANT';
		export InvalidWords						:= PatternInvalidWords1;
	end;
