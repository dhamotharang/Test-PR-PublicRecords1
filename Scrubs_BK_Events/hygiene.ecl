...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_Alpha','Invalid_No','Invalid_No','Invalid_No','Invalid_Alpha','Invalid_CaseNo','Unknown','Invalid_CaseNo','Unknown','Invalid_No','Invalid_Int','Unknown','Invalid_Int','Invalid_Date','Invalid_Date','Invalid_Date','Invalid_Float','Invalid_No','Unknown','Invalid_AlphaNum','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaNumChar','Unknown');
