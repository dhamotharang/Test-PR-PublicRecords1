...
// Compute the score for the concept company_address
  ...
  SELF.Conf := (SELF.cnp_name_score + SELF.cnp_number_score + SELF.ebr_file_number_score + SELF.hist_duns_number_score + SELF.hist_domestic_corp_key_score + SELF.foreign_corp_key_score + SELF.unk_corp_key_score + SELF.company_phone_score + SELF.active_duns_number_score + SELF.active_domestic_corp_key_score + SELF.company_fein_score + SELF.active_enterprise_number_score + SELF.hist_enterprise_number_score + IF(SELF.company_address_score>0,MAX(SELF.company_address_score,IF(SELF.company_addr1_score>0,MAX(SELF.company_addr1_score,SELF.prim_range_score + SELF.prim_name_derived_score + SELF.sec_range_score),SELF.prim_range_score + SELF.prim_name_derived_score + SELF.sec_range_score) + IF(SELF.company_csz_score>0,MAX(SELF.company_csz_score,SELF.v_city_name_score + SELF.st_score + SELF.zip_score),SELF.v_city_name_score + SELF.st_score + SELF.zip_score)),IF(SELF.company_addr1_score>0,MAX(SELF.company_addr1_score,SELF.prim_range_score + SELF.prim_name_derived_score + SELF.sec_range_score),SELF.prim_range_score + SELF.prim_name_derived_score + SELF.sec_range_score) + IF(SELF.company_csz_score>0,MAX(SELF.company_csz_score,SELF.v_city_name_score + SELF.st_score + SELF.zip_score),SELF.v_city_name_score + SELF.st_score + SELF.zip_score))) / 100 + outside;
END;
...
Layout_Chubbies := RECORD,MAXLENGTH(63000)
  t;
  UNSIGNED2 Size := t.cnp_name_size+t.cnp_number_size+t.ebr_file_number_size+t.hist_duns_number_size+t.hist_domestic_corp_key_size+t.foreign_corp_key_size+t.unk_corp_key_size+t.company_phone_size+t.active_duns_number_size+t.active_domestic_corp_key_size+t.company_fein_size+t.active_enterprise_number_size+t.hist_enterprise_number_size+t.company_address_size;
END;
