...
*/
import BIPV2,BIPV2_Build,BIPV2_ProxID_mj6_PlatForm,tools;
iteration := '@iteration@';
pversion  := '@version@';
lih       := if((unsigned)iteration = 1   ,BIPV2_ProxID_mj6_PlatForm.In_DOT_Base    ,BIPV2_ProxID_mj6_PlatForm._files().base.built );
