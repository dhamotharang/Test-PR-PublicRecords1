...
// BIPV2_ProxID_mj6_PlatForm.Cleave(BIPV2_ProxID_mj6_PlatForm.In_DOT_Base).BuildAll;
//---------------------------------------------------------------------------------------------
  Und := BIPV2_ProxID_mj6_PlatForm.Underlinks(BIPV2_ProxID_mj6_PlatForm.In_DOT_Base); // Create underlink module
