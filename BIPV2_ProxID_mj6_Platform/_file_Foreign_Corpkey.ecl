import mdr;
dlatest_iteration := _files().base.built;
...
EXPORT _file_Foreign_Corpkey := dedup(sort(distribute(dproj	,proxid),proxid,company_inc_state,company_charter_number,local),proxid,company_inc_state,company_charter_number,local);
