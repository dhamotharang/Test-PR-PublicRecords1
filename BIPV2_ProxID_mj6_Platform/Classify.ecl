...
SHARED TotalClusters := specificities(h).TotalClusters;
  ...
  cnp_number_tokens := PROJECT(specificities(h).cnp_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_number; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  active_duns_number_tokens := PROJECT(specificities(h).active_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_duns_number; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  active_enterprise_number_tokens := PROJECT(specificities(h).active_enterprise_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_enterprise_number; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  active_domestic_corp_key_tokens := PROJECT(specificities(h).active_domestic_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_domestic_corp_key; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  hist_enterprise_number_tokens := PROJECT(specificities(h).hist_enterprise_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_enterprise_number; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  hist_duns_number_tokens := PROJECT(specificities(h).hist_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_duns_number; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  hist_domestic_corp_key_tokens := PROJECT(specificities(h).hist_domestic_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_domestic_corp_key; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
  foreign_corp_key_tokens := PROJECT(specificities(h).foreign_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.foreign_corp_key; SELF.TokenType := 9; SELF.Spc := LEFT.field_Specificity ));
  unk_corp_key_tokens := PROJECT(specificities(h).unk_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.unk_corp_key; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  ebr_file_number_tokens := PROJECT(specificities(h).ebr_file_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.ebr_file_number; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  company_fein_tokens := PROJECT(specificities(h).company_fein_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_fein; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
  company_phone_tokens := PROJECT(specificities(h).company_phone_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_phone; SELF.TokenType := 13; SELF.Spc := LEFT.field_Specificity ));
  prim_range_tokens := PROJECT(specificities(h).prim_range_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_range; SELF.TokenType := 14; SELF.Spc := LEFT.field_Specificity ));
  prim_name_derived_tokens := PROJECT(specificities(h).prim_name_derived_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_name_derived; SELF.TokenType := 15; SELF.Spc := LEFT.field_Specificity ));
  sec_range_tokens := PROJECT(specificities(h).sec_range_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.sec_range; SELF.TokenType := 16; SELF.Spc := LEFT.field_Specificity ));
  v_city_name_tokens := PROJECT(specificities(h).v_city_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.v_city_name; SELF.TokenType := 17; SELF.Spc := LEFT.field_Specificity ));
  st_tokens := PROJECT(specificities(h).st_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.st; SELF.TokenType := 18; SELF.Spc := LEFT.field_Specificity ));
  zip_tokens := PROJECT(specificities(h).zip_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.zip; SELF.TokenType := 19; SELF.Spc := LEFT.field_Specificity ));
SHARED all_tokens0 := cnp_name_tokens + cnp_number_tokens + active_duns_number_tokens + active_enterprise_number_tokens + active_domestic_corp_key_tokens + hist_enterprise_number_tokens + hist_duns_number_tokens + hist_domestic_corp_key_tokens + foreign_corp_key_tokens + unk_corp_key_tokens + ebr_file_number_tokens + company_fein_tokens + company_phone_tokens + prim_range_tokens + prim_name_derived_tokens + sec_range_tokens + v_city_name_tokens + st_tokens + zip_tokens;
  all_tokens := SALT30.fn_process_multitokens(all_tokens0);
 
EXPORT TokenKeyName := '~'+'key::BIPV2_ProxID_mj6_PlatForm::Proxid::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_ProxID_mj6_PlatForm::Proxid::Token::MultiTokenKey';
...
EXPORT MultiTokenKey := INDEX(all_tokens0(SALT30.WordCount(TokenValue)>1),{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens0},MultiTokenKeyName);
  company_csz_tokens := PROJECT(specificities(h).company_csz_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_csz; SELF.TokenType := 20; SELF.Spc := LEFT.field_Specificity ));
  company_addr1_tokens := PROJECT(specificities(h).company_addr1_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_addr1; SELF.TokenType := 21; SELF.Spc := LEFT.field_Specificity ));
  company_address_tokens := PROJECT(specificities(h).company_address_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_address; SELF.TokenType := 22; SELF.Spc := LEFT.field_Specificity ));
all_tokens1 := company_csz_tokens + company_addr1_tokens + company_address_tokens;
 
EXPORT ConceptKeyName := '~'+'key::BIPV2_ProxID_mj6_PlatForm::Proxid::Token::ConceptKey';
...
shared company_csz_combinations := o_tot;
  Layout_ConceptTemplate Into(company_csz_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.v_city_name_filled => 17, le.st_filled => 18, le.zip_filled => 19,0);
    SELF.FieldNumber2 := MAP ( le.st_filled AND SELF.FieldNumber1 != 18 => 18, le.zip_filled AND SELF.FieldNumber1 != 19 => 19,0);
    SELF.FieldNumber3 := MAP ( le.zip_filled AND SELF.FieldNumber1 != 19 AND SELF.FieldNumber2 != 19 => 19,0);
    SELF := le;
  END;
shared company_csz_templates := project(company_csz_combinations,Into(LEFT));
  ...
  company_addr1_filled_rec_totals := RECORD
    ...
    UNSIGNED Cnt := COUNT(GROUP);
  END;
  t_tot := table(t,company_addr1_filled_rec_totals,prim_range_filled,prim_name_derived_filled,sec_range_filled,few);
  SALT30.MAC_Field_Specificities(t_tot,o_tot);
shared company_addr1_combinations := o_tot;
  Layout_ConceptTemplate Into(company_addr1_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.prim_range_filled => 14, le.prim_name_derived_filled => 15, le.sec_range_filled => 16,0);
    SELF.FieldNumber2 := MAP ( le.prim_name_derived_filled AND SELF.FieldNumber1 != 15 => 15, le.sec_range_filled AND SELF.FieldNumber1 != 16 => 16,0);
    SELF.FieldNumber3 := MAP ( le.sec_range_filled AND SELF.FieldNumber1 != 16 AND SELF.FieldNumber2 != 16 => 16,0);
    SELF := le;
  END;
shared company_addr1_templates := project(company_addr1_combinations,Into(LEFT));
  company_address_filled_rec := RECORD
    boolean company_addr1_filled :=~((SALT30.StrType)ih.prim_range = '' AND (SALT30.StrType)ih.prim_name_derived = '' AND (SALT30.StrType)ih.sec_range = '');
...
shared company_address_combinations := o_tot;
  Layout_ConceptTemplate Into(company_address_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.company_addr1_filled => 21, le.company_csz_filled => 20,0);
    SELF.FieldNumber2 := MAP ( le.company_csz_filled AND SELF.FieldNumber1 != 20 => 20,0);
    SELF := le;
  END;
...
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_ProxID_mj6_PlatForm::Proxid::Token::ConceptKey';
