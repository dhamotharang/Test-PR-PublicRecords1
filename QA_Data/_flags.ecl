...
MODULE
	...
	EXPORT ExistCurrentSprayed		:= COUNT(NOTHOR(fileservices.superfilecontents(filenames().InputTrans.using))) + 
	                                 COUNT(NOTHOR(fileservices.superfilecontents(filenames().InputAddr.using ))) > 0;
