...
export	Vehicle_as_Source(	dataset(VehicleV2.Layout_Base_Main)		pVehiclemain		=	dataset([],VehicleV2.Layout_Base_Main),
	...
	:=
  function
	dSourceDatasearch_	:=	project(map(pForHeaderBuild => dataset(data_services.foreign_prod+'~thor_data400::base::vehicles_v2_party_header_building',VehicleV2.Layout_Base.Party_CCPA,flat)
																		,pFastHeader => dataset('~thor_data400::base::vehicles_v2_party_Quickheader_building',VehicleV2.Layout_Base.Party_CCPA,flat)
