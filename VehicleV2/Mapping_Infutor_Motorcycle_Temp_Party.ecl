...
VehicleV2.Layout_Base.Party_BIP	tParty(dInfutorMotorcycleIterationKey pInput)	:=
transform
...
VehicleV2.Layout_Base.Party_BIP	tAceAddress(dInfutorMotorcycleAppendAID	pInput)	:=
transform
