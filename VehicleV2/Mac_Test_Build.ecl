export MAC_Test_Build (indataset,infname,inmname,inlname,
						inssn,
						indob,
						phone,
...
autokey.MAC_Build_version (%ds_normed% ,infname,inmname,inlname,
						inssn,
						indob,
						phone,
						inprim_name,inprim_range,inst,incity_name,inzip,insec_range,
...
SEQUENTIAL(
	...
	if(useFakeIDs and 'N' not in build_skip_set, %mv_Payload_Key%), //if you are utilizing the fake dids, you will need something
	if('B' not in build_skip_set and 'N' not in build_skip_set, %mvbkeys%)
	)*/);
