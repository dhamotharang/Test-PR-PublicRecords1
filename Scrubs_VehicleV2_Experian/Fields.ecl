...
EXPORT MakeFT_invalid_weight(SALT30.StrType s0) := FUNCTION
  s1 := SALT30.stringfilter(s0,'0123456789 N/A'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_weight(SALT30.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT30.StringFilter(s,'0123456789 N/A'))));
EXPORT InValidMessageFT_invalid_weight(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInChars('0123456789 N/A'),SALT30.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_date1(SALT30.StrType s0) := FUNCTION
  s1 := SALT30.stringfilter(s0,'0123456789/'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_date1(SALT30.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT30.StringFilter(s,'0123456789/'))),~(LENGTH(TRIM(s)) >= 6 AND LENGTH(TRIM(s)) <= 10 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_date1(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInChars('0123456789/'),SALT30.HygieneErrors.NotLength('6..10,0'),SALT30.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_file_typ(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_file_typ(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['R','T','C','S','I','L','B','U'],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_file_typ(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('R|T|C|S|I|L|B|U'),SALT30.HygieneErrors.NotLength('1'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_vin(SALT30.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_invalid_vin(SALT30.StrType s) := WHICH(SALT30.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT30.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 -:;'))),~(LENGTH(TRIM(s)) >= 0));
EXPORT InValidMessageFT_invalid_vin(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotCaps,SALT30.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 -:;'),SALT30.HygieneErrors.NotLength('0..'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_vehicle_typ(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_vehicle_typ(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['P','M','U','X'],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_vehicle_typ(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('P|M|U|X'),SALT30.HygieneErrors.NotLength('1'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_model_yr_ind(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_model_yr_ind(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['V','R'],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_model_yr_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('V|R'),SALT30.HygieneErrors.NotLength('1'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_name_typ_cd(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_typ_cd(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['1','2','4','5','7',''],~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_name_typ_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('1|2|4|5|7|'),SALT30.HygieneErrors.NotLength('1,0'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_owner_typ_cd(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_owner_typ_cd(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['1','2',''],~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_owner_typ_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('1|2|'),SALT30.HygieneErrors.NotLength('1,0'),SALT30.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_zip4(SALT30.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_zip4(SALT30.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT30.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 4 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_zip4(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInChars('0123456789'),SALT30.HygieneErrors.NotLength('4,0'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_cc(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cc(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['0','1','  0','  1',''],~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 3));
EXPORT InValidMessageFT_invalid_cc(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('0|1|  0|  1|'),SALT30.HygieneErrors.NotLength('0..3'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_opt_out_cd(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_opt_out_cd(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['B','I','M','N','U',''],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_opt_out_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('B|I|M|N|U|'),SALT30.HygieneErrors.NotLength('1'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_yes_no(SALT30.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_yes_no(SALT30.StrType s) := WHICH(((SALT30.StrType) s) NOT IN ['Y','N',''],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_yes_no(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInEnum('Y|N|'),SALT30.HygieneErrors.NotLength('1'),SALT30.HygieneErrors.Good);
EXPORT MakeFT_invalid_min_door_count(SALT30.StrType s0) := FUNCTION
  s1 := SALT30.stringfilter(s0,'2345D'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_min_door_count(SALT30.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT30.StringFilter(s,'2345D'))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_min_door_count(UNSIGNED1 wh) := CHOOSE(wh,SALT30.HygieneErrors.NotInChars('2345D'),SALT30.HygieneErrors.NotLength('2,0'),SALT30.HygieneErrors.Good);
...
EXPORT FieldNum(SALT30.StrType fn) := CASE(fn,'append_process_date' => 1,'append_state_origin' => 2,'file_typ' => 3,'vin' => 4,'vehicle_typ' => 5,'model_yr' => 6,'model_yr_ind' => 7,'make' => 8,'make_ind' => 9,'series' => 10,'series_ind' => 11,'prime_color' => 12,'second_color' => 13,'body_style' => 14,'body_style_ind' => 15,'model' => 16,'model_ind' => 17,'weight' => 18,'lengt' => 19,'axle_cnt' => 20,'plate_nbr' => 21,'plate_state' => 22,'prev_plate_nbr' => 23,'prev_plate_state' => 24,'plate_typ_cd' => 25,'mstr_src_state' => 26,'reg_decal_nbr' => 27,'org_reg_dt' => 28,'reg_renew_dt' => 29,'reg_exp_dt' => 30,'title_nbr' => 31,'org_title_dt' => 32,'title_trans_dt' => 33,'name_typ_cd' => 34,'owner_typ_cd' => 35,'first_nm' => 36,'middle_nm' => 37,'last_nm' => 38,'name_suffix' => 39,'prof_suffix' => 40,'ind_ssn' => 41,'ind_dob' => 42,'mail_range' => 43,'m_pre_dir' => 44,'m_street' => 45,'m_suffix' => 46,'m_post_dir' => 47,'m_pob' => 48,'m_rr_nbr' => 49,'m_rr_box' => 50,'m_scndry_rng' => 51,'m_scndry_des' => 52,'m_city' => 53,'m_state' => 54,'m_zip5' => 55,'m_zip4' => 56,'m_cntry_cd' => 57,'m_cc_filler' => 58,'m_cc' => 59,'m_county' => 60,'phys_range' => 61,'p_pre_dir' => 62,'p_street' => 63,'p_suffix' => 64,'p_post_dir' => 65,'p_pob' => 66,'p_rr_nbr' => 67,'p_rr_box' => 68,'p_scndry_rng' => 69,'p_scndry_des' => 70,'p_city' => 71,'p_state' => 72,'p_zip5' => 73,'p_zip4' => 74,'p_cntry_cd' => 75,'p_cc_filler' => 76,'p_cc' => 77,'p_county' => 78,'opt_out_cd' => 79,'asg_wgt' => 80,'asg_wgt_uom' => 81,'source_ctl_id' => 82,'raw_name' => 83,'branded_title_flag' => 84,'brand_code_1' => 85,'brand_date_1' => 86,'brand_state_1' => 87,'brand_code_2' => 88,'brand_date_2' => 89,'brand_state_2' => 90,'brand_code_3' => 91,'brand_date_3' => 92,'brand_state_3' => 93,'brand_code_4' => 94,'brand_date_4' => 95,'brand_state_4' => 96,'brand_code_5' => 97,'brand_date_5' => 98,'brand_state_5' => 99,'tod_flag' => 100,'model_class_code' => 101,'model_class' => 102,'min_door_count' => 103,'safety_type' => 104,'airbag_driver' => 105,'airbag_front_driver_side' => 106,'airbag_front_head_curtain' => 107,'airbag_front_pass' => 108,'airbag_front_pass_side' => 109,'airbags' => 110,0);
//Individual field level validation
EXPORT Make_append_process_date(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_append_process_date(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_append_process_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_append_state_origin(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_append_state_origin(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_append_state_origin(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_file_typ(SALT30.StrType s0) := MakeFT_invalid_file_typ(s0);
EXPORT InValid_file_typ(SALT30.StrType s) := InValidFT_invalid_file_typ(s);
...
EXPORT Make_vehicle_typ(SALT30.StrType s0) := MakeFT_invalid_vehicle_typ(s0);
EXPORT InValid_vehicle_typ(SALT30.StrType s) := InValidFT_invalid_vehicle_typ(s);
EXPORT InValidMessage_vehicle_typ(UNSIGNED1 wh) := InValidMessageFT_invalid_vehicle_typ(wh);
EXPORT Make_model_yr(SALT30.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_model_yr(SALT30.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_model_yr(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_model_yr_ind(SALT30.StrType s0) := MakeFT_invalid_model_yr_ind(s0);
EXPORT InValid_model_yr_ind(SALT30.StrType s) := InValidFT_invalid_model_yr_ind(s);
EXPORT InValidMessage_model_yr_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_model_yr_ind(wh);
EXPORT Make_make(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_make(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_make(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_make_ind(SALT30.StrType s0) := MakeFT_invalid_model_yr_ind(s0);
EXPORT InValid_make_ind(SALT30.StrType s) := InValidFT_invalid_model_yr_ind(s);
EXPORT InValidMessage_make_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_model_yr_ind(wh);
EXPORT Make_series(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_series(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_series(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_series_ind(SALT30.StrType s0) := MakeFT_invalid_model_yr_ind(s0);
EXPORT InValid_series_ind(SALT30.StrType s) := InValidFT_invalid_model_yr_ind(s);
EXPORT InValidMessage_series_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_model_yr_ind(wh);
EXPORT Make_prime_color(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_prime_color(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_prime_color(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_second_color(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_second_color(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_second_color(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_body_style(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_body_style(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_body_style(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_body_style_ind(SALT30.StrType s0) := MakeFT_invalid_model_yr_ind(s0);
EXPORT InValid_body_style_ind(SALT30.StrType s) := InValidFT_invalid_model_yr_ind(s);
EXPORT InValidMessage_body_style_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_model_yr_ind(wh);
EXPORT Make_model(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_model(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_model(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_model_ind(SALT30.StrType s0) := MakeFT_invalid_model_yr_ind(s0);
EXPORT InValid_model_ind(SALT30.StrType s) := InValidFT_invalid_model_yr_ind(s);
EXPORT InValidMessage_model_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_model_yr_ind(wh);
EXPORT Make_weight(SALT30.StrType s0) := MakeFT_invalid_number(s0);
EXPORT InValid_weight(SALT30.StrType s) := InValidFT_invalid_number(s);
EXPORT InValidMessage_weight(UNSIGNED1 wh) := InValidMessageFT_invalid_number(wh);
EXPORT Make_lengt(SALT30.StrType s0) := MakeFT_invalid_number(s0);
EXPORT InValid_lengt(SALT30.StrType s) := InValidFT_invalid_number(s);
EXPORT InValidMessage_lengt(UNSIGNED1 wh) := InValidMessageFT_invalid_number(wh);
EXPORT Make_axle_cnt(SALT30.StrType s0) := MakeFT_invalid_number(s0);
EXPORT InValid_axle_cnt(SALT30.StrType s) := InValidFT_invalid_number(s);
EXPORT InValidMessage_axle_cnt(UNSIGNED1 wh) := InValidMessageFT_invalid_number(wh);
EXPORT Make_plate_nbr(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_plate_nbr(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_plate_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_plate_state(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_plate_state(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_plate_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_prev_plate_nbr(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_prev_plate_nbr(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_prev_plate_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_prev_plate_state(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_prev_plate_state(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_prev_plate_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_plate_typ_cd(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_plate_typ_cd(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_plate_typ_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_mstr_src_state(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_mstr_src_state(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_mstr_src_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_reg_decal_nbr(SALT30.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_reg_decal_nbr(SALT30.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_reg_decal_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
EXPORT Make_org_reg_dt(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_org_reg_dt(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_org_reg_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_reg_renew_dt(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_reg_renew_dt(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_reg_renew_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_reg_exp_dt(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_reg_exp_dt(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_reg_exp_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_title_nbr(SALT30.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_title_nbr(SALT30.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_title_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
EXPORT Make_org_title_dt(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_org_title_dt(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_org_title_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_title_trans_dt(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_title_trans_dt(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_title_trans_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_name_typ_cd(SALT30.StrType s0) := MakeFT_invalid_name_typ_cd(s0);
EXPORT InValid_name_typ_cd(SALT30.StrType s) := InValidFT_invalid_name_typ_cd(s);
EXPORT InValidMessage_name_typ_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_name_typ_cd(wh);
EXPORT Make_owner_typ_cd(SALT30.StrType s0) := MakeFT_invalid_owner_typ_cd(s0);
EXPORT InValid_owner_typ_cd(SALT30.StrType s) := InValidFT_invalid_owner_typ_cd(s);
EXPORT InValidMessage_owner_typ_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_owner_typ_cd(wh);
EXPORT Make_first_nm(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_first_nm(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_first_nm(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_middle_nm(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_middle_nm(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_middle_nm(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_last_nm(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_last_nm(SALT30.StrType s) := InValidFT_invalid_alpha(s);
...
EXPORT Make_prof_suffix(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_prof_suffix(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_prof_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_ind_ssn(SALT30.StrType s0) := MakeFT_invalid_ssn(s0);
EXPORT InValid_ind_ssn(SALT30.StrType s) := InValidFT_invalid_ssn(s);
EXPORT InValidMessage_ind_ssn(UNSIGNED1 wh) := InValidMessageFT_invalid_ssn(wh);
EXPORT Make_ind_dob(SALT30.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_ind_dob(SALT30.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_ind_dob(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_mail_range(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_mail_range(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_mail_range(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_pre_dir(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_pre_dir(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_pre_dir(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_street(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_street(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_street(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_suffix(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_suffix(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_post_dir(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_post_dir(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_post_dir(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_pob(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_pob(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_pob(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_rr_nbr(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_rr_nbr(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_rr_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_rr_box(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_rr_box(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_rr_box(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_scndry_rng(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_scndry_rng(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_scndry_rng(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_scndry_des(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_scndry_des(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_scndry_des(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_city(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_city(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_city(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_m_state(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_m_state(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_m_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_m_zip5(SALT30.StrType s0) := MakeFT_invalid_zip5(s0);
EXPORT InValid_m_zip5(SALT30.StrType s) := InValidFT_invalid_zip5(s);
EXPORT InValidMessage_m_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_zip5(wh);
EXPORT Make_m_zip4(SALT30.StrType s0) := MakeFT_invalid_zip4(s0);
EXPORT InValid_m_zip4(SALT30.StrType s) := InValidFT_invalid_zip4(s);
EXPORT InValidMessage_m_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_zip4(wh);
EXPORT Make_m_cntry_cd(SALT30.StrType s0) := s0;
EXPORT InValid_m_cntry_cd(SALT30.StrType s) := FALSE;
EXPORT InValidMessage_m_cntry_cd(UNSIGNED1 wh) := '';
EXPORT Make_m_cc_filler(SALT30.StrType s0) := s0;
EXPORT InValid_m_cc_filler(SALT30.StrType s) := FALSE;
EXPORT InValidMessage_m_cc_filler(UNSIGNED1 wh) := '';
EXPORT Make_m_cc(SALT30.StrType s0) := MakeFT_invalid_cc(s0);
EXPORT InValid_m_cc(SALT30.StrType s) := InValidFT_invalid_cc(s);
EXPORT InValidMessage_m_cc(UNSIGNED1 wh) := InValidMessageFT_invalid_cc(wh);
EXPORT Make_m_county(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_m_county(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_m_county(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_phys_range(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_phys_range(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_phys_range(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_pre_dir(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_pre_dir(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_pre_dir(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_street(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_street(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_street(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_suffix(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_suffix(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_suffix(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_post_dir(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_post_dir(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_post_dir(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_pob(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_pob(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_pob(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_rr_nbr(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_rr_nbr(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_rr_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_rr_box(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_rr_box(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_rr_box(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_scndry_rng(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_scndry_rng(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_scndry_rng(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_scndry_des(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_scndry_des(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_scndry_des(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_city(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_city(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_city(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_p_state(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_p_state(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_p_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_p_zip5(SALT30.StrType s0) := MakeFT_invalid_zip5(s0);
EXPORT InValid_p_zip5(SALT30.StrType s) := InValidFT_invalid_zip5(s);
EXPORT InValidMessage_p_zip5(UNSIGNED1 wh) := InValidMessageFT_invalid_zip5(wh);
EXPORT Make_p_zip4(SALT30.StrType s0) := MakeFT_invalid_zip4(s0);
EXPORT InValid_p_zip4(SALT30.StrType s) := InValidFT_invalid_zip4(s);
EXPORT InValidMessage_p_zip4(UNSIGNED1 wh) := InValidMessageFT_invalid_zip4(wh);
EXPORT Make_p_cntry_cd(SALT30.StrType s0) := s0;
EXPORT InValid_p_cntry_cd(SALT30.StrType s) := FALSE;
EXPORT InValidMessage_p_cntry_cd(UNSIGNED1 wh) := '';
EXPORT Make_p_cc_filler(SALT30.StrType s0) := s0;
EXPORT InValid_p_cc_filler(SALT30.StrType s) := FALSE;
EXPORT InValidMessage_p_cc_filler(UNSIGNED1 wh) := '';
EXPORT Make_p_cc(SALT30.StrType s0) := MakeFT_invalid_cc(s0);
EXPORT InValid_p_cc(SALT30.StrType s) := InValidFT_invalid_cc(s);
EXPORT InValidMessage_p_cc(UNSIGNED1 wh) := InValidMessageFT_invalid_cc(wh);
EXPORT Make_p_county(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_p_county(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_p_county(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_opt_out_cd(SALT30.StrType s0) := MakeFT_invalid_opt_out_cd(s0);
EXPORT InValid_opt_out_cd(SALT30.StrType s) := InValidFT_invalid_opt_out_cd(s);
EXPORT InValidMessage_opt_out_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_opt_out_cd(wh);
EXPORT Make_asg_wgt(SALT30.StrType s0) := MakeFT_invalid_number(s0);
EXPORT InValid_asg_wgt(SALT30.StrType s) := InValidFT_invalid_number(s);
EXPORT InValidMessage_asg_wgt(UNSIGNED1 wh) := InValidMessageFT_invalid_number(wh);
EXPORT Make_asg_wgt_uom(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_asg_wgt_uom(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_asg_wgt_uom(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_source_ctl_id(SALT30.StrType s0) := MakeFT_invalid_number(s0);
EXPORT InValid_source_ctl_id(SALT30.StrType s) := InValidFT_invalid_number(s);
EXPORT InValidMessage_source_ctl_id(UNSIGNED1 wh) := InValidMessageFT_invalid_number(wh);
EXPORT Make_raw_name(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_raw_name(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_raw_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_branded_title_flag(SALT30.StrType s0) := MakeFT_invalid_yes_no(s0);
EXPORT InValid_branded_title_flag(SALT30.StrType s) := InValidFT_invalid_yes_no(s);
EXPORT InValidMessage_branded_title_flag(UNSIGNED1 wh) := InValidMessageFT_invalid_yes_no(wh);
EXPORT Make_brand_code_1(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_brand_code_1(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_brand_code_1(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_brand_date_1(SALT30.StrType s0) := MakeFT_invalid_date1(s0);
EXPORT InValid_brand_date_1(SALT30.StrType s) := InValidFT_invalid_date1(s);
EXPORT InValidMessage_brand_date_1(UNSIGNED1 wh) := InValidMessageFT_invalid_date1(wh);
EXPORT Make_brand_state_1(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_brand_state_1(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_brand_state_1(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_brand_code_2(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_brand_code_2(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_brand_code_2(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_brand_date_2(SALT30.StrType s0) := MakeFT_invalid_date1(s0);
EXPORT InValid_brand_date_2(SALT30.StrType s) := InValidFT_invalid_date1(s);
EXPORT InValidMessage_brand_date_2(UNSIGNED1 wh) := InValidMessageFT_invalid_date1(wh);
EXPORT Make_brand_state_2(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_brand_state_2(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_brand_state_2(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_brand_code_3(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_brand_code_3(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_brand_code_3(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_brand_date_3(SALT30.StrType s0) := MakeFT_invalid_date1(s0);
EXPORT InValid_brand_date_3(SALT30.StrType s) := InValidFT_invalid_date1(s);
EXPORT InValidMessage_brand_date_3(UNSIGNED1 wh) := InValidMessageFT_invalid_date1(wh);
EXPORT Make_brand_state_3(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_brand_state_3(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_brand_state_3(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_brand_code_4(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_brand_code_4(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_brand_code_4(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_brand_date_4(SALT30.StrType s0) := MakeFT_invalid_date1(s0);
EXPORT InValid_brand_date_4(SALT30.StrType s) := InValidFT_invalid_date1(s);
EXPORT InValidMessage_brand_date_4(UNSIGNED1 wh) := InValidMessageFT_invalid_date1(wh);
EXPORT Make_brand_state_4(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_brand_state_4(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_brand_state_4(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_brand_code_5(SALT30.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_brand_code_5(SALT30.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_brand_code_5(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
EXPORT Make_brand_date_5(SALT30.StrType s0) := MakeFT_invalid_date1(s0);
EXPORT InValid_brand_date_5(SALT30.StrType s) := InValidFT_invalid_date1(s);
EXPORT InValidMessage_brand_date_5(UNSIGNED1 wh) := InValidMessageFT_invalid_date1(wh);
EXPORT Make_brand_state_5(SALT30.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_brand_state_5(SALT30.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_brand_state_5(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
EXPORT Make_tod_flag(SALT30.StrType s0) := MakeFT_invalid_yes_no(s0);
EXPORT InValid_tod_flag(SALT30.StrType s) := InValidFT_invalid_yes_no(s);
EXPORT InValidMessage_tod_flag(UNSIGNED1 wh) := InValidMessageFT_invalid_yes_no(wh);
EXPORT Make_model_class_code(SALT30.StrType s0) := s0;
EXPORT InValid_model_class_code(SALT30.StrType s) := FALSE;
EXPORT InValidMessage_model_class_code(UNSIGNED1 wh) := '';
EXPORT Make_model_class(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_model_class(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_model_class(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_min_door_count(SALT30.StrType s0) := MakeFT_invalid_min_door_count(s0);
EXPORT InValid_min_door_count(SALT30.StrType s) := InValidFT_invalid_min_door_count(s);
EXPORT InValidMessage_min_door_count(UNSIGNED1 wh) := InValidMessageFT_invalid_min_door_count(wh);
EXPORT Make_safety_type(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_safety_type(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_safety_type(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbag_driver(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbag_driver(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_airbag_driver(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbag_front_driver_side(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbag_front_driver_side(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_airbag_front_driver_side(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbag_front_head_curtain(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbag_front_head_curtain(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_airbag_front_head_curtain(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbag_front_pass(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbag_front_pass(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_airbag_front_pass(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbag_front_pass_side(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbag_front_pass_side(SALT30.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_airbag_front_pass_side(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_airbags(SALT30.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_airbags(SALT30.StrType s) := InValidFT_invalid_alpha(s);
