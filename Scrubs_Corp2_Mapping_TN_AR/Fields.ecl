...
EXPORT Make_ar_exempt(SALT34.StrType s0) := MakeFT_invalid_Y_N(s0);
EXPORT InValid_ar_exempt(SALT34.StrType s) := InValidFT_invalid_Y_N(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_TN_AR;
