...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE14155 := __ENH_Event_3;
  EXPORT __ST9294_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST9294_Layout __ND14411__Project(B_Event_3.__ST9825_Layout __PP12802) := TRANSFORM
    SELF.No_Lex_Id_ := MAP(__T(__OP2(__PP12802.Lex_Id_,>,__CN(900000000000)))=>1,0);
    SELF.T18___Is_Ip_Meta_Hit_Flag_ := MAP(__T(__OP2(__PP12802.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=> -99999,__T(__AND(__AND(__OP2(__PP12802.T___Inp_Cln_Ip_Addr_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP12802._iprngbeg_,=,__CN(''))),__OP2(__PP12802._iprngend_,=,__CN(''))))=>0,1);
    SELF.T19___Bnk_Acct_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP12802.T___Inp_Cln_Bnk_Acct_Echo_,IN,__CN(['-99999','-99998'])),__OP2(__PP12802.T___Inp_Cln_Bnk_Acct_Rtg_Echo_,IN,__CN(['-99999','-99998']))))=>0,1);
    SELF.T___Inp_Cln_Addr_City_Echo_ := MAP(__T(__OR(__OP2(__PP12802.Postal_City_,=,__CN('')),__NT(__PP12802.Postal_City_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP12802.Postal_City_));
    SELF.T___Inp_Cln_Addr_Prim_Nm_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP12802.Primary_Name_,=,__CN('')),__NT(__PP12802.Primary_Name_)),__OP2(__PP12802.Location_,=,__CN(0))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP12802.Primary_Name_));
    SELF.T___Inp_Cln_Addr_St_Echo_ := MAP(__T(__OR(__OP2(__PP12802.State_,=,__CN('')),__NT(__PP12802.State_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP12802.State_));
    SELF.T___Inp_Cln_Addr_Zip5_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP12802.Zip_,=,__CN('')),__NT(__PP12802.Zip_)),__OP2(__PP12802.Zip_,=,__CAST(KEL.typ.str,__CN(0)))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP12802.Zip_));
    SELF.T___Inp_Cln_Email_Echo_ := MAP(__T(__OR(__OP2(__PP12802.Email_Address_,=,__CN('')),__NT(__PP12802.Email_Address_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP12802.Email_Address_));
    SELF.T___Person_Uid_Echo_ := MAP(__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP12802.Lex_Id_),=,__CN('')),__NT(__PP12802.Lex_Id_)),__OP2(__PP12802.Lex_Id_,=,__CN(0))))=>__ECAST(KEL.typ.nint,__CN(-99999)),__ECAST(KEL.typ.nint,__PP12802.Lex_Id_));
    SELF.T___Src_Class_Type_ := MAP(__T(__OP2(__PP12802.T___Src_Type_,=,__CN(-99997)))=> -99997,__T(__OP2(__PP12802.T___Src_Type_,IN,__CN([6,14])))=>0,__T(__OP2(__PP12802.T___Src_Type_,IN,__CN([4,8,11])))=>1,__T(__OP2(__PP12802.T___Src_Type_,IN,__CN([3,7])))=>2,__T(__OP2(__PP12802.T___Src_Type_,IN,__CN([2,5])))=>3,4);
    SELF := __PP12802;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE14155,__ND14411__Project(LEFT));
END;
