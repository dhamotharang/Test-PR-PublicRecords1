...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE45218 := __ENH_Event_3;
  EXPORT __ST16586_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST16586_Layout __ND45524__Project(B_Event_3.__ST18036_Layout __PP43487) := TRANSFORM
    SELF.T15___Ssn_Is_Kr_Flag_ := MAP(__PP43487.T15___Ssn_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Ssn_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Ssn_Status_Code_Echo_),IN,__CN(['100','101','190','191','192','193'])))=>1, -99997);
    SELF.T16___Phn_Is_Kr_Flag_ := MAP(__PP43487.T16___Phn_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Phn_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Phn_Status_Code_Echo_),IN,__CN(['400','401','402','490','491','492','493'])))=>1, -99997);
    SELF.T17___Email_Is_Kr_Flag_ := MAP(__PP43487.T17___Email_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Email_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Email_Status_Code_Echo_),IN,__CN(['500','501','502','590','591','592','593'])))=>1, -99997);
    SELF.T18___Ip_Addr_Is_Kr_Flag_ := MAP(__PP43487.T18___Ip_Addr_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Ip_Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Ip_Addr_Status_Code_Echo_),IN,__CN(['600','601','602','603','604','605','1000','1001','1090','1091','1092','1093'])))=>1, -99997);
    SELF.T18___Is_Ip_Meta_Hit_Flag_ := MAP(__T(__OP2(__PP43487.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=> -99999,__T(__AND(__AND(__OP2(__PP43487.T___Inp_Cln_Ip_Addr_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP43487._iprngbeg_,=,__CN(''))),__OP2(__PP43487._iprngend_,=,__CN(''))))=>0,1);
    SELF.T19___Bnk_Acct_Is_Kr_Flag_ := MAP(__PP43487.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Bnk_Acct_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Bnk_Acct_Status_Code_Echo_),IN,__CN(['800','801','802','890','891','892','893'])))=>1, -99997);
    SELF.T1_L___Best_Dl_Echo_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP43487.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP43487.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP43487._best__drivers__license_,=,__CN('')),__NT(__PP43487._best__drivers__license_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP43487._best__drivers__license_));
    SELF.T1_L___Best_Dl_St_Echo_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP43487.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP43487.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP43487._best__drivers__license__state_,=,__CN('')),__NT(__PP43487._best__drivers__license__state_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP43487._best__drivers__license__state_));
    SELF.T1_L___Id_Crim_Hit_Flag_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP43487.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP43487.T___Src_Class_Type_ < 4=> -99998,__T(__OP2(__PP43487.Crim_Hit_,=,__CN(TRUE)))=>1,0);
    SELF.T1_L___Id_Dt_Of_Death_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP43487.T1_L___Id_Deceased_Flag_ < 1 OR __PP43487.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__NOT(__FN1(KEL.Routines.IsValidDate,__PP43487._diddeceaseddate_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__ECAST(KEL.typ.nint,__PP43487._diddeceaseddate_)));
    SELF.T1___Id_Is_Kr_App_Frd_Flag_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0 AND __PP43487.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__PP43487.T1___Id_Is_Kr_Gen_Frd_Flag_ = -99997=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019'])),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019']))),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019']))))=>1, -99997);
    SELF.T1___Id_Is_Kr_Oth_Frd_Flag_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0 AND __PP43487.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__PP43487.T1___Id_Is_Kr_Gen_Frd_Flag_ = -99997=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903'])),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903']))),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903']))))=>1, -99997);
    SELF.T1___Id_Is_Kr_Stol_Id_Flag_ := MAP(__PP43487.T1___Lex_Id_Pop_Flag_ = 0 AND __PP43487.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__PP43487.T1___Id_Is_Kr_Gen_Frd_Flag_ = -99997=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10004'])),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10004']))),__OP2(__CAST(KEL.typ.str,__PP43487.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10004']))))=>1, -99997);
    SELF.T20___Dl_Is_Kr_Flag_ := MAP(__PP43487.T20___Dl_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Dl_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Dl_Status_Code_Echo_),IN,__CN(['200','201','202','203','204','290','291','292','293'])))=>1, -99997);
    SELF.T9___Addr_Is_Kr_Flag_ := MAP(__PP43487.T9___Addr_Pop_Flag_ = 0=> -99999,__PP43487.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP43487.T___Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP43487.T___Addr_Status_Code_Echo_),IN,__CN(['300','301','302','303','390','391','392','393'])))=>1, -99997);
    SELF.T___Act_Dt_Echo_ := __PP43487.Event_Date_;
    SELF.T___Dob_Pop_Flag_ := MAP(__T(__OP2(__PP43487.T___Inp_Cln_Dob_Echo_,<,__CN(-99997)))=>0,1);
    SELF.T___First_Nm_Pop_Flag_ := MAP(__T(__OP2(__PP43487.T___Inp_Cln_First_Nm_Echo_,IN,__CN(['-99999','-99998','-99997'])))=>0,1);
    SELF.T___In_Agency_Flag_ := MAP(__T(__OP2(__PP43487._r_Source_Customer_,<>,__PP43487._r_Customer_))=>0,1);
    SELF.T___Last_Nm_Pop_Flag_ := MAP(__T(__OP2(__PP43487.T___Inp_Cln_Last_Nm_Echo_,IN,__CN(['-99999','-99998','-99997'])))=>0,1);
    SELF := __PP43487;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE45218,__ND45524__Project(LEFT));
END;
