...
EXPORT B_Event_8 := MODULE
  ...
  SHARED __EE25118 := __E_Event;
  EXPORT __ST21254_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST21254_Layout __ND25372__Project(E_Event.Layout __PP23882) := TRANSFORM
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP23882._rin__source_,<=,__CN(0)),__OP2(__PP23882._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP23882._rin__source_));
    SELF := __PP23882;
  END;
  EXPORT __ENH_Event_8 := PROJECT(__EE25118,__ND25372__Project(LEFT));
END;
