...
EXPORT B_Event_8 := MODULE
  ...
  SHARED __EE25381 := __E_Event;
  EXPORT __ST21517_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST21517_Layout __ND25635__Project(E_Event.Layout __PP24145) := TRANSFORM
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP24145._rin__source_,<=,__CN(0)),__OP2(__PP24145._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP24145._rin__source_));
    SELF := __PP24145;
  END;
  EXPORT __ENH_Event_8 := PROJECT(__EE25381,__ND25635__Project(LEFT));
END;
