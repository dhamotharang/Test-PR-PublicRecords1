...
IMPORT B_Event,B_Event_1,B_Event_2,B_Event_3,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM RiskIntelligenceNetwork_Analytics;
...
EXPORT Q_Input_Rin(DATASET(RECORDOF(RiskIntelligenceNetwork_Analytics.Layouts.LayoutInputPII_2)) __PInputPIIDataset) := MODULE
  ...
  SHARED __EE36229 := __ENH_Event;
  SHARED __ST5249_Layout := RECORD
