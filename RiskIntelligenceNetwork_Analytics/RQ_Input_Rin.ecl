...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE72732 := __ENH_Event;
  SHARED __EE73245 := __Params;
  SHARED __ST74159_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC75165(B_Event.__ST11468_Layout __EE72732, CFG_Graph.Input_Rin_Params_Layout __EE73245) := TRUE AND __EE72732.__Part = __EE73245.__Part;
  __ST74159_Layout __JT75165(B_Event.__ST11468_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE75166 := JOIN(__EE72732,__EE73245,__JC75165(LEFT,RIGHT),__JT75165(LEFT,RIGHT),INNER,ALL);
  SHARED __ST71711_Layout := RECORD
    KEL.typ.int T1_L___Id_Curr_Incarc_Flag_ := 0;
    KEL.typ.nint T1_L___Id_Crim_Fl_Sd_Match_Flag_;
    KEL.typ.nstr Entity_Context_Uid_;
    KEL.typ.int In_Customer_Population_ := 0;
