...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE77677 := __ENH_Event;
  SHARED __EE78270 := __Params;
  SHARED __ST79324_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC80456(B_Event.__ST12852_Layout __EE77677, CFG_Graph.Input_Rin_Params_Layout __EE78270) := TRUE AND __EE77677.__Part = __EE78270.__Part;
  __ST79324_Layout __JT80456(B_Event.__ST12852_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE80457 := JOIN(__EE77677,__EE78270,__JC80456(LEFT,RIGHT),__JT80456(LEFT,RIGHT),INNER,ALL);
  SHARED __ST76496_Layout := RECORD
    KEL.typ.int T20___Dl_Pop_Flag_ := 0;
    KEL.typ.nstr T20___Dl_Val_Type_;
    KEL.typ.nstr T16___Phn_Val_Type_;
    KEL.typ.int T1_L___Id_Is_Bc_Shll_Hit_Flag_ := 0;
