...
IMPORT B_Event,B_Event_1,B_Event_2,B_Event_3,CFG_Graph,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM RiskIntelligenceNetwork_Analytics;
...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED E_Customer_Params := MODULE(E_Customer)
    SHARED __Mapping0 := 'gc_id(DEFAULT:UID|OVERRIDE:Customer_Id_:0),ind_type(OVERRIDE:Industry_Type_:0),batchin_rec.st(OVERRIDE:Jurisdiction_State_:\'\'),__Part(DEFAULT:__Part:NA)';
  ...
  SHARED E_Event_Params := MODULE(E_Event)
    ...
    SHARED InLayout __Mapping0_Transform(InLayout __r) := TRANSFORM
      ...
      SELF._name__ssn__dob__match_ := __CN(1);
  ...
  SHARED __EE37677 := __ENH_Event;
  SHARED __EE38054 := __Params;
  SHARED __ST38730_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC39531(B_Event.__ST7567_Layout __EE37677, CFG_Graph.Input_Rin_Params_Layout __EE38054) := TRUE AND __EE37677.__Part = __EE38054.__Part;
  __ST38730_Layout __JT39531(B_Event.__ST7567_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE39532 := JOIN(__EE37677,__EE38054,__JC39531(LEFT,RIGHT),__JT39531(LEFT,RIGHT),INNER,ALL);
  SHARED __ST36928_Layout := RECORD
    KEL.typ.nstr Entity_Context_Uid_;
    KEL.typ.int In_Customer_Population_ := 0;
    KEL.typ.int Deceased_ := 0;
    KEL.typ.int Deceased_Name_Match_ := 0;
