...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE77209 := __ENH_Event;
  SHARED __EE77798 := __Params;
  SHARED __ST78845_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC79971(B_Event.__ST12653_Layout __EE77209, CFG_Graph.Input_Rin_Params_Layout __EE77798) := TRUE AND __EE77209.__Part = __EE77798.__Part;
  __ST78845_Layout __JT79971(B_Event.__ST12653_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE79972 := JOIN(__EE77209,__EE77798,__JC79971(LEFT,RIGHT),__JT79971(LEFT,RIGHT),INNER,ALL);
  SHARED __ST76036_Layout := RECORD
    KEL.typ.int T20___Dl_Pop_Flag_ := 0;
    KEL.typ.nstr T20___Dl_Val_Type_;
    KEL.typ.nstr T16___Phn_Val_Type_;
    KEL.typ.int T1_L___Id_Is_Bc_Shll_Hit_Flag_ := 0;
