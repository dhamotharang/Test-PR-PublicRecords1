...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE75887 := __ENH_Event;
  SHARED __EE76440 := __Params;
  SHARED __ST77424_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC78495(B_Event.__ST12274_Layout __EE75887, CFG_Graph.Input_Rin_Params_Layout __EE76440) := TRUE AND __EE75887.__Part = __EE76440.__Part;
  __ST77424_Layout __JT78495(B_Event.__ST12274_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE78496 := JOIN(__EE75887,__EE76440,__JC78495(LEFT,RIGHT),__JT78495(LEFT,RIGHT),INNER,ALL);
  SHARED __ST74786_Layout := RECORD
    KEL.typ.int T1_L___Id_Curr_Incarc_Flag_ := 0;
    KEL.typ.nint T1_L___Id_Crim_Fl_Sd_Match_Flag_;
    KEL.typ.nstr T18__isanispecho_;
    KEL.typ.int T___Is_Bc_Shll_Hit_Flag_ := 0;
