...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED E_Drivers_License_Params := MODULE(E_Drivers_License)
    SHARED __Mapping0 := 'ottodriverslicenseid(DEFAULT:UID|OVERRIDE:Otto_Drivers_License_Id_:\'\'),associatedcustomerfileinfo(DEFAULT:_r_Customer_:0),sourcecustomerfileinfo(DEFAULT:_r_Source_Customer_:0),batchin_rec.dl_number(OVERRIDE:License_Number_:\'\'),batchin_rec.dl_state(OVERRIDE:State_:\'\'),__Part(DEFAULT:__Part:NA)';
