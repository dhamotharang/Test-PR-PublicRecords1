...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE77048 := __ENH_Event;
  SHARED __EE77633 := __Params;
  SHARED __ST78673_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC79793(B_Event.__ST12591_Layout __EE77048, CFG_Graph.Input_Rin_Params_Layout __EE77633) := TRUE AND __EE77048.__Part = __EE77633.__Part;
  __ST78673_Layout __JT79793(B_Event.__ST12591_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE79794 := JOIN(__EE77048,__EE77633,__JC79793(LEFT,RIGHT),__JT79793(LEFT,RIGHT),INNER,ALL);
  SHARED __ST75883_Layout := RECORD
    KEL.typ.int T20___Dl_Pop_Flag_ := 0;
    KEL.typ.nstr T20___Dl_Val_Type_;
    KEL.typ.nstr T16___Phn_Val_Type_;
    KEL.typ.int T1_L___Id_Is_Bc_Shll_Hit_Flag_ := 0;
