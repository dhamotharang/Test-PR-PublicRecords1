...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED __EE76886 := __ENH_Event;
  SHARED __EE77471 := __Params;
  SHARED __ST78511_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC79630(B_Event.__ST12587_Layout __EE76886, CFG_Graph.Input_Rin_Params_Layout __EE77471) := TRUE AND __EE76886.__Part = __EE77471.__Part;
  __ST78511_Layout __JT79630(B_Event.__ST12587_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE79631 := JOIN(__EE76886,__EE77471,__JC79630(LEFT,RIGHT),__JT79630(LEFT,RIGHT),INNER,ALL);
  SHARED __ST75721_Layout := RECORD
    KEL.typ.int T20___Dl_Pop_Flag_ := 0;
    KEL.typ.nstr T20___Dl_Val_Type_;
    KEL.typ.nstr T16___Phn_Val_Type_;
    KEL.typ.int T1_L___Id_Is_Bc_Shll_Hit_Flag_ := 0;
