...
EXPORT RQ_Input_Rin(DATASET(CFG_Graph.Input_Rin_Params_Layout) __Input_Rin_Params) := MODULE
  ...
  SHARED E_Email_Params := MODULE(E_Email)
    SHARED __Mapping0 := 'ottoemailid(DEFAULT:UID),batchin_rec.email_address(OVERRIDE:Email_Address_:\'\'),__Part(DEFAULT:__Part:NA)';
    SHARED InLayout __Mapping0_Transform(InLayout __r) := TRANSFORM
      SELF.Host_ := __CN('');
  ...
  SHARED __EE72804 := __ENH_Event;
  SHARED __EE73321 := __Params;
  SHARED __ST74242_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC75254(B_Event.__ST11495_Layout __EE72804, CFG_Graph.Input_Rin_Params_Layout __EE73321) := TRUE AND __EE72804.__Part = __EE73321.__Part;
  __ST74242_Layout __JT75254(B_Event.__ST11495_Layout __l, CFG_Graph.Input_Rin_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE75255 := JOIN(__EE72804,__EE73321,__JC75254(LEFT,RIGHT),__JT75254(LEFT,RIGHT),INNER,ALL);
  SHARED __ST71775_Layout := RECORD
    KEL.typ.int T1_L___Id_Curr_Incarc_Flag_ := 0;
    KEL.typ.nint T1_L___Id_Crim_Fl_Sd_Match_Flag_;
    KEL.typ.nstr Entity_Context_Uid_;
    KEL.typ.int In_Customer_Population_ := 0;
