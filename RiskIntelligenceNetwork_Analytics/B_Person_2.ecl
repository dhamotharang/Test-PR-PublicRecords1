...
IMPORT KEL11 AS KEL;
IMPORT B_Event_3,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Person_Event,E_Phone,E_Social_Security_Number FROM RiskIntelligenceNetwork_Analytics;
...
EXPORT B_Person_2 := MODULE
  ...
  SHARED __EE55243 := __E_Person;
  SHARED __EE55436 := __ENH_Event_3;
  SHARED __EE55966 := __EE55436(__EE55436.T___In_Agency_Flag_ = 1);
  SHARED __EE55434 := __E_Person_Event;
  SHARED __EE57178 := __EE55434(__NN(__EE55434.Subject_) AND __NN(__EE55434.Transaction_));
  SHARED __ST56143_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC57196(B_Event_3.__ST17158_Layout __EE55966, E_Person_Event.Layout __EE57178) := __EEQP(__EE57178.Transaction_,__EE55966.UID) AND __EE55966.__Part = __EE57178.__Part;
  __ST56143_Layout __JT57196(B_Event_3.__ST17158_Layout __l, E_Person_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE57197 := JOIN(__EE57178,__EE55966,__JC57196(RIGHT,LEFT),__JT57196(RIGHT,LEFT),INNER,SMART);
  SHARED __ST55812_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST55812_Layout __ND57476__Project(__ST56143_Layout __PP57198) := TRANSFORM
    SELF.UID := __PP57198.Subject__1_;
    SELF._r_Customer_ := __PP57198._r_Customer__1_;
    SELF.Subject_ := __PP57198.Subject__1_;
    SELF.Event_Date_ := __PP57198.Event_Date__1_;
    SELF.U_I_D__1_ := __PP57198.UID;
    SELF := __PP57198;
  END;
  SHARED __EE57517 := PROJECT(__EE57197,__ND57476__Project(LEFT));
  SHARED __ST55853_Layout := RECORD
    KEL.typ.ntyp(E_Person.Typ) UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST55853_Layout __ND57522__Project(__ST55812_Layout __PP57518) := TRANSFORM
    SELF.Exp1_ := __PP57518.T1___Id_Is_Kr_App_Frd_Flag_ = 1;
    SELF.Exp2_ := __PP57518.T1___Id_Is_Kr_Gen_Frd_Flag_ = 1;
    SELF.Exp3_ := __PP57518.T1___Id_Is_Kr_Oth_Frd_Flag_ = 1;
    SELF.Exp4_ := __PP57518.T1___Id_Is_Kr_Stol_Id_Flag_ = 1;
    SELF := __PP57518;
  END;
  SHARED __EE57547 := PROJECT(__EE57517,__ND57522__Project(LEFT));
  SHARED __ST55883_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __EE57578 := PROJECT(__CLEANANDDO(__EE57547,TABLE(__EE57547,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE57547.Exp1_),KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE57547.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE57547.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE57547.Exp4_),UID,__Part},UID,__Part,MERGE)),__ST55883_Layout);
  SHARED __ST56474_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Lex_Id_;
    KEL.typ.nkdate Date_Of_Birth_;
    KEL.typ.nstr Ssn_;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC57584(E_Person.Layout __EE55243, __ST55883_Layout __EE57578) := __EEQP(__EE55243.UID,__EE57578.UID) AND __EE55243.__Part = __EE57578.__Part;
  __ST56474_Layout __JT57584(E_Person.Layout __l, __ST55883_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE57585 := JOIN(__EE55243,__EE57578,__JC57584(LEFT,RIGHT),__JT57584(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST16195_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Lex_Id_;
    KEL.typ.nkdate Date_Of_Birth_;
    KEL.typ.nstr Ssn_;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST16195_Layout __ND57608__Project(__ST56474_Layout __PP57586) := TRANSFORM
    SELF.Aot_Id_Kr_App_Frd_Act_Cnt_Ev_ := MIN(__PP57586.C_O_U_N_T___Exp1_,9999);
    SELF.Aot_Id_Kr_Gen_Frd_Act_Cnt_Ev_ := MIN(__PP57586.C_O_U_N_T___Exp1__1_,9999);
    SELF.Aot_Id_Kr_Oth_Frd_Act_Cnt_Ev_ := MIN(__PP57586.C_O_U_N_T___Exp1__2_,9999);
    SELF.Aot_Id_Kr_Stol_Id_Act_Cnt_Ev_ := MIN(__PP57586.C_O_U_N_T___Exp1__3_,9999);
    SELF := __PP57586;
  END;
  EXPORT __ENH_Person_2 := PROJECT(__EE57585,__ND57608__Project(LEFT));
END;
