...
EXPORT B_Event_3 := MODULE
  ...
  SHARED __EE42056 := __ENH_Event_4;
  EXPORT __ST18236_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST18236_Layout __ND42353__Project(B_Event_4.__ST19181_Layout __PP40350) := TRANSFORM
    SELF.T15___Ssn_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP40350.T___Inp_Cln_Ssn_Echo_,<=,__CAST(KEL.typ.str,__CN(-99997))),__OP2(__FN1(LENGTH,__PP40350.T___Inp_Cln_Ssn_Echo_),<,__CN(9))))=>0,1);
    SELF.T16___Phn_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP40350.T___Inp_Cln_Phn_Echo_,IN,__CN(['-99999','-99998','-99997'])),__OP2(__FN1(LENGTH,__PP40350.T___Inp_Cln_Phn_Echo_),<,__CN(10))))=>0,1);
    SELF.T17___Email_Pop_Flag_ := MAP(__T(__OR(__OR(__OP2(__FN3(KEL.Routines.Word,__PP40350.Email_Address_,__CN(1),__CN('@')),=,__CN('')),__OP2(__FN3(KEL.Routines.Word,__PP40350.Email_Address_,__CN(2),__CN('@')),=,__CN(''))),__OP2(__PP40350.T___Inp_Cln_Email_Echo_,=,__CAST(KEL.typ.str,__CN(-99999)))))=>0,1);
    SELF.T18___Ip_Addr_Pop_Flag_ := MAP(__T(__OP2(__PP40350.T___Inp_Cln_Ip_Addr_Echo_,IN,__CN(['-99999','-99998','-99997'])))=>0,1);
    SELF.T19___Bnk_Acct_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP40350.T___Inp_Cln_Bnk_Acct_Echo_,IN,__CN(['-99999','-99998'])),__OP2(__PP40350.T___Inp_Cln_Bnk_Acct_Rtg_Echo_,IN,__CN(['-99999','-99998']))))=>0,1);
    SELF.T1_L___Id_Deceased_Flag_ := MAP(__PP40350.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP40350.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP40350.T___Src_Class_Type_ < 4=> -99998,__T(__NT(__PP40350._diddeceased_))=> -99997,__T(__OP2(__PP40350._diddeceased_,=,__CN(TRUE)))=>1,0);
    SELF.T1___Id_Is_Kr_Gen_Frd_Flag_ := MAP(__PP40350.T1___Lex_Id_Pop_Flag_ = 0 AND __PP40350.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP40350.T___Src_Class_Type_ <> 3=> -99998,__T(__AND(__AND(__OP2(__PP40350.T___Evt_Type1_Status_Code_Echo_,=,__CN(-99997)),__OP2(__PP40350.T___Evt_Type2_Status_Code_Echo_,=,__CN(-99997))),__OP2(__PP40350.T___Evt_Type3_Status_Code_Echo_,=,__CN(-99997))))=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP40350.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007'])),__OP2(__CAST(KEL.typ.str,__PP40350.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))),__OP2(__CAST(KEL.typ.str,__PP40350.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))))=>1, -99997);
    SELF.T20___Dl_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP40350.T___Inp_Cln_Dl_Echo_,IN,__CN(['-99999','-99998','-99997'])),__OP2(__PP40350.T___Inp_Cln_Dl_St_Echo_,IN,__CN(['-99999','-99998','-99997']))))=>0,1);
    SELF.T9___Addr_Pop_Flag_ := MAP(__T(__OR(__AND(__AND(__OP2(__PP40350.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP40350.T___Inp_Cln_Addr_City_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__OP2(__PP40350.T___Inp_Cln_Addr_St_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__AND(__OP2(__PP40350.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP40350.T___Inp_Cln_Addr_Zip5_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))))))=>1,0);
    SELF.T___Addr_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._physical__address__risk__code_),=,__CN('')),__NT(__PP40350._physical__address__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._physical__address__risk__code_));
    SELF.T___Bnk_Acct_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._bank__account__1__risk__code_),=,__CN('')),__NT(__PP40350._bank__account__1__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._bank__account__1__risk__code_));
    SELF.T___Dl_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._drivers__license__risk__code_),=,__CN('')),__NT(__PP40350._drivers__license__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._drivers__license__risk__code_));
    SELF.T___Email_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._email__address__risk__code_),=,__CN('')),__NT(__PP40350._email__address__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._email__address__risk__code_));
    SELF.T___Inp_Cln_Dob_Echo_ := MAP(__T(__NT(__PP40350.Date_Of_Birth_))=>__ECAST(KEL.typ.nint,__CN(-99999)),__ECAST(KEL.typ.nint,__ECAST(KEL.typ.nint,__PP40350.Date_Of_Birth_)));
    SELF.T___Inp_Cln_First_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP40350.First_Name_,=,__CN('')),__NT(__PP40350.First_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP40350.First_Name_));
    SELF.T___Inp_Cln_Last_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP40350.Last_Name_,=,__CN('')),__NT(__PP40350.Last_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP40350.Last_Name_));
    SELF.T___Ip_Addr_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._ip__address__fraud__code_),=,__CN('')),__NT(__PP40350._ip__address__fraud__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._ip__address__fraud__code_));
    SELF.T___Phn_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._phone__risk__code_),=,__CN('')),__NT(__PP40350._phone__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._phone__risk__code_));
    SELF.T___Ssn_Status_Code_Echo_ := MAP(__PP40350.T___Src_Class_Type_ <> 2 AND __PP40350.T___Src_Class_Type_ <> 3 AND __PP40350.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP40350._ssn__risk__code_),=,__CN('')),__NT(__PP40350._ssn__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP40350._ssn__risk__code_));
    SELF := __PP40350;
  END;
  EXPORT __ENH_Event_3 := PROJECT(__EE42056,__ND42353__Project(LEFT));
END;
