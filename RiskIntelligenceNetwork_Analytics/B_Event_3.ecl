...
EXPORT B_Event_3 := MODULE
  ...
  SHARED __EE11551 := __E_Event;
  EXPORT __ST9825_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST9825_Layout __ND11799__Project(E_Event.Layout __PP10311) := TRANSFORM
    SELF.T___Inp_Cln_Bnk_Acct_Echo_ := MAP(__T(__OR(__OP2(__PP10311.Account_Number_,=,__CN('')),__NT(__PP10311.Account_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP10311.Account_Number_));
    SELF.T___Inp_Cln_Bnk_Acct_Rtg_Echo_ := MAP(__T(__OR(__OP2(__PP10311.Routing_Number_,=,__CN('')),__NT(__PP10311.Routing_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP10311.Routing_Number_));
    SELF.T___Inp_Cln_Ip_Addr_Echo_ := MAP(__T(__OR(__OP2(__PP10311.Ip_Address_,=,__CN('')),__NT(__PP10311.Ip_Address_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP10311.Ip_Address_));
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP10311._rin__source_,<=,__CN(0)),__OP2(__PP10311._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP10311._rin__source_));
    SELF := __PP10311;
  END;
  EXPORT __ENH_Event_3 := PROJECT(__EE11551,__ND11799__Project(LEFT));
END;
