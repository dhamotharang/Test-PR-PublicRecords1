...
EXPORT B_Event_1 := MODULE
  ...
  SHARED __EE17079 := __ENH_Event_2;
  SHARED __EE16541 := __E_Customer;
  SHARED __ST17628_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC19436(B_Event_2.__ST9294_Layout __EE17079, E_Customer.Layout __EE16541) := __EEQP(__EE17079._r_Customer_,__EE16541.UID) AND __EE17079.__Part = __EE16541.__Part;
  __ST17628_Layout __JT19436(B_Event_2.__ST9294_Layout __l, E_Customer.Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE19437 := JOIN(__EE17079,__EE16541,__JC19436(LEFT,RIGHT),__JT19436(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST8598_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Record_Id_;
    KEL.typ.nkdate Event_Date_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST8598_Layout __ND19711__Project(__ST17628_Layout __PP19162) := TRANSFORM
    SELF.Agency_Prog_Jur_St_ := __PP19162.Jurisdiction_State_;
    SELF.Deceased_ := MAP(__T(__FN1(KEL.Routines.IsValidDate,__PP19162.Deceased_Date_))=>1,0);
    SELF.Deceased_Dob_Match_ := MAP(__T(__OP2(__PP19162.Deceased_Date_Of_Birth_,=,__PP19162.Date_Of_Birth_))=>1,0);
    SELF.Deceased_Name_Match_ := MAP(__T(__AND(__OP2(__PP19162.First_Name_,=,__PP19162.Deceased_First_),__OP2(__PP19162.Last_Name_,=,__PP19162.Deceased_Last_)))=>1,0);
    SELF.Id_Age_ := __FN2(KEL.Routines.YearsBetween,__PP19162.Date_Of_Birth_,__PP19162.Event_Date_);
    SELF.T17___Email_Pop_Flag_ := MAP(__T(__OR(__OR(__OP2(__FN3(KEL.Routines.Word,__PP19162.Email_Address_,__CN(1),__CN('@')),=,__CN('')),__OP2(__FN3(KEL.Routines.Word,__PP19162.Email_Address_,__CN(2),__CN('@')),=,__CN(''))),__OP2(__PP19162.T___Inp_Cln_Email_Echo_,=,__CAST(KEL.typ.str,__CN(-99999)))))=>0,1);
    SELF.T18___Ip_Addr_City_ := MAP(__T(__OP2(__PP19162.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP19162.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP19162.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP19162._edgecity_,=,__CN('')),__NT(__PP19162._edgecity_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP19162._edgecity_));
    SELF.T18___Ip_Addr_Country_ := MAP(__T(__OP2(__PP19162.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP19162.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP19162.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OR(__OP2(__PP19162._edgecountry_,=,__CN('')),__NT(__PP19162._edgecountry_)),__OP2(__PP19162._edgecountry_,=,__CN('0'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP19162._edgecountry_));
    SELF.T18___Ip_Addr_Proxy_Desc_ := MAP(__T(__OP2(__PP19162.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP19162.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP19162.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP19162._proxydescription_,=,__CN('')),__NT(__PP19162._proxydescription_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP19162._proxydescription_));
    SELF.T18___Ip_Addr_Proxy_Type_ := MAP(__T(__OP2(__PP19162.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP19162.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP19162.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP19162._proxytype_,=,__CN('')),__NT(__PP19162._proxytype_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP19162._proxytype_));
    SELF.T19___Is_Bnk_App_Hit_Flag_ := MAP(__PP19162.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__T(__OP2(__PP19162.Bank_Hit_,=,__CAST(KEL.typ.str,__CN(1))))=>1,0);
    SELF.T1___Lex_Id_Pop_Flag_ := MAP(__T(__OP2(__PP19162.T___Person_Uid_Echo_,=,__CN(-99999)))=> -99999,__PP19162.No_Lex_Id_ = 1=>0,1);
    SELF.T1___Rin_Id_Pop_Flag_ := MAP(__T(__OP2(__PP19162.T___Person_Uid_Echo_,=,__CN(-99999)))=> -99999,__PP19162.No_Lex_Id_ = 1=>1,0);
    SELF.T9___Addr_Pop_Flag_ := MAP(__T(__OR(__AND(__AND(__OP2(__PP19162.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP19162.T___Inp_Cln_Addr_City_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__OP2(__PP19162.T___Inp_Cln_Addr_St_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__AND(__OP2(__PP19162.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP19162.T___Inp_Cln_Addr_Zip5_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))))))=>1,0);
    SELF.T___Inp_Cln_First_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP19162.First_Name_,=,__CN('')),__NT(__PP19162.First_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP19162.First_Name_));
    SELF.T___Inp_Cln_Last_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP19162.Last_Name_,=,__CN('')),__NT(__PP19162.Last_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP19162.Last_Name_));
    SELF.T___Inp_Cln_Middle_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP19162.Middle_Name_,=,__CN('')),__NT(__PP19162.Middle_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP19162.Middle_Name_));
    SELF.T___Inp_Cln_Phn_Echo_ := MAP(__T(__OR(__OR(__OR(__OP2(__PP19162.Phone_Number_,=,__CN('')),__NT(__PP19162.Phone_Number_)),__OP2(__PP19162.Phone_Number_,=,__CN('0000000000'))),__FN2(KEL.Routines.StartsWith,__PP19162.Phone_Number_,__CN('0'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP19162.Phone_Number_)));
    SELF.T___Inp_Cln_Ssn_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP19162.Ssn_,=,__CN('')),__NT(__PP19162.Ssn_)),__OP2(__PP19162.Ssn_,=,__CN('000000000'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP19162.Ssn_)));
    SELF := __PP19162;
  END;
  EXPORT __ENH_Event_1 := PROJECT(__EE19437,__ND19711__Project(LEFT));
END;
