...
EXPORT B_Event_1 := MODULE
  ...
  SHARED __EE46777 := __ENH_Event_2;
  SHARED __EE45746 := __E_Customer;
  SHARED __ST47410_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC49837(B_Event_2.__ST15146_Layout __EE46777, E_Customer.Layout __EE45746) := __EEQP(__EE46777._r_Customer_,__EE45746.UID) AND __EE46777.__Part = __EE45746.__Part;
  __ST47410_Layout __JT49837(B_Event_2.__ST15146_Layout __l, E_Customer.Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE49838 := JOIN(__EE46777,__EE45746,__JC49837(LEFT,RIGHT),__JT49837(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST21640_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Record_Id_;
    KEL.typ.nkdate Event_Date_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST21640_Layout __ND50147__Project(__ST47410_Layout __PP49521) := TRANSFORM
    SELF.Agency_Prog_Jur_St_ := __PP49521.Jurisdiction_State_;
    SELF.Deceased_ := MAP(__T(__FN1(KEL.Routines.IsValidDate,__PP49521.Deceased_Date_))=>1,0);
    SELF.Deceased_Dob_Match_ := MAP(__T(__OP2(__PP49521.Deceased_Date_Of_Birth_,=,__PP49521.Date_Of_Birth_))=>1,0);
    SELF.Deceased_Name_Match_ := MAP(__T(__AND(__OP2(__PP49521.First_Name_,=,__PP49521.Deceased_First_),__OP2(__PP49521.Last_Name_,=,__PP49521.Deceased_Last_)))=>1,0);
    SELF.Id_Age_ := __FN2(KEL.Routines.YearsBetween,__PP49521.Date_Of_Birth_,__PP49521.Event_Date_);
    SELF.P15___Aot_Ssn_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T15___Ssn_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T15___Ssn_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T15___Ssn_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P16___Aot_Phn_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T16___Phn_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T16___Phn_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T16___Phn_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P17___Aot_Email_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T17___Email_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T17___Email_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T17___Email_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P18___Aot_Ip_Addr_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T18___Ip_Addr_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T18___Ip_Addr_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T18___Ip_Addr_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P19___Aot_Bnk_Acct_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T19___Bnk_Acct_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T19___Bnk_Acct_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P1___Aot_Id_Kr_App_Frd_Act_Cnt_Ev_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T1___Id_Is_Kr_App_Frd_Flag_ = -99997=> -99997,__PP49521.T1___Id_Is_Kr_App_Frd_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P1___Aot_Id_Kr_Gen_Frd_Act_Cnt_Ev_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T1___Id_Is_Kr_Gen_Frd_Flag_ = -99997=> -99997,__PP49521.T1___Id_Is_Kr_Gen_Frd_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P1___Aot_Id_Kr_Oth_Frd_Act_Cnt_Ev_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T1___Id_Is_Kr_Oth_Frd_Flag_ = -99997=> -99997,__PP49521.T1___Id_Is_Kr_Oth_Frd_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P1___Aot_Id_Kr_Stol_Id_Act_Cnt_Ev_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T1___Id_Is_Kr_Stol_Id_Flag_ = -99997=> -99997,__PP49521.T1___Id_Is_Kr_Stol_Id_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P20___Aot_Dl_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T20___Dl_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T20___Dl_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T20___Dl_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.P9___Aot_Addr_Kr_Act_Cnt_Ev_ := MAP(__PP49521.T9___Addr_Pop_Flag_ = 0=> -99999,__PP49521.T___Src_Class_Type_ < 2=> -99998,__PP49521.T9___Addr_Is_Kr_Flag_ = -99997=> -99997,__PP49521.T9___Addr_Is_Kr_Flag_ = 1 AND __PP49521.T___In_Agency_Flag_ = 1=>1,0);
    SELF.T18___Ip_Addr_City_ := MAP(__T(__OP2(__PP49521.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP49521.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP49521._edgecity_,=,__CN('')),__NT(__PP49521._edgecity_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP49521._edgecity_));
    SELF.T18___Ip_Addr_Country_ := MAP(__T(__OP2(__PP49521.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP49521.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OR(__OP2(__PP49521._edgecountry_,=,__CN('')),__NT(__PP49521._edgecountry_)),__OP2(__PP49521._edgecountry_,=,__CN('0'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP49521._edgecountry_));
    SELF.T18___Ip_Addr_Proxy_Desc_ := MAP(__T(__OP2(__PP49521.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP49521.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP49521._proxydescription_,=,__CN('')),__NT(__PP49521._proxydescription_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP49521._proxydescription_));
    SELF.T18___Ip_Addr_Proxy_Type_ := MAP(__T(__OP2(__PP49521.T___Inp_Cln_Ip_Addr_Echo_,=,__CAST(KEL.typ.str,__CN(-99999))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP49521.T18___Is_Ip_Meta_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP49521._proxytype_,=,__CN('')),__NT(__PP49521._proxytype_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP49521._proxytype_));
    SELF.T19___Is_Bnk_App_Hit_Flag_ := MAP(__PP49521.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__T(__OP2(__PP49521.Bank_Hit_,=,__CAST(KEL.typ.str,__CN(1))))=>1,0);
    SELF.T1_L___Best_Dl_Pop_Flag_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=> -99998,__T(__OR(__OP2(__PP49521.T1_L___Best_Dl_Echo_,=,__CAST(KEL.typ.str,__CN(-99997))),__OP2(__PP49521.T1_L___Best_Dl_St_Echo_,=,__CAST(KEL.typ.str,__CN(-99997)))))=>0,1);
    SELF.T1_L___Curr_Addr_Pop_Flag_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=> -99998,__T(__OP2(__PP49521._add__curr__pop_,=,__CN(TRUE)))=>1,0);
    SELF.T1_L___Curr_Addr_St_Echo_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP49521._add__curr__st_,=,__CN('')),__NT(__PP49521._add__curr__st_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP49521._add__curr__st_));
    SELF.T1_L___Dob_Ver_Indx_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 OR __PP49521.T___Dob_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__NT(__PP49521._dobmatchlevel_),__OP2(__PP49521._dobmatchlevel_,=,__CN(0))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._dobmatchlevel_));
    SELF.T1_L___Fp___Source_Risk_Level_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OP2(__PP49521._sourcerisklevel_,<,__CN(1)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._sourcerisklevel_));
    SELF.T1_L___Id_Crim_Fl_Sd_Match_Flag_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T1_L___Id_Crim_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__PP49521.T___First_Nm_Pop_Flag_ = 0 OR __PP49521.T___Last_Nm_Pop_Flag_ = 0 OR __PP49521.T15___Ssn_Pop_Flag_ = 0 OR __PP49521.T___Dob_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._name__ssn__dob__match_));
    SELF.T1_L___Id_Dt_Of_Death_Aft_Id_Act_Cnt_Ev_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP49521.T1_L___Id_Deceased_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=> -99998,__T(__OP2(__PP49521.T1_L___Id_Dt_Of_Death_,=,__CN(-99997)))=> -99997,__T(__OP2(__PP49521.Event_Date_,>,__PP49521._diddeceaseddate_))=>1,0);
    SELF.T1_L___Nas_Summary_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__ECAST(KEL.typ.nint,__PP49521._nas__summary_));
    SELF.T1___Cvi_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__ECAST(KEL.typ.nint,__PP49521._cvi_));
    SELF.T1___Fp3___Manip_Identity_Index_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP49521._manipulatedidentityindex__v3_),=,__CN('')),__NT(__PP49521._manipulatedidentityindex__v3_)),__OP2(__PP49521._manipulatedidentityindex__v3_,=,__CN(0))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._manipulatedidentityindex__v3_));
    SELF.T1___Fp3___Stolen_Identity_Index_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP49521._fp3__stolenidentityindex_),=,__CN('')),__NT(__PP49521._fp3__stolenidentityindex_)),__OP2(__PP49521._fp3__stolenidentityindex_,=,__CN(0))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._fp3__stolenidentityindex_));
    SELF.T1___Fp3___Synthetic_Identity_Index_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP49521._syntheticidentityindex__v3_),=,__CN('')),__NT(__PP49521._syntheticidentityindex__v3_)),__OP2(__PP49521._syntheticidentityindex__v3_,=,__CN(0))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP49521._syntheticidentityindex__v3_));
    SELF.T1___Id_Age_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0 OR __PP49521.T___Dob_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OP2(__ECAST(KEL.typ.nint,__PP49521.T___Inp_Cln_Dob_Echo_),>,__ECAST(KEL.typ.nint,__PP49521.T___Act_Dt_Echo_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,KEL.Routines.MinN(__FN1(KEL.Routines.Floor,__OP2(__FN2(KEL.Routines.DaysBetween,KEL.Routines.DateFromInteger(__PP49521.T___Inp_Cln_Dob_Echo_),__PP49521.T___Act_Dt_Echo_),/,__CN(365.25))),__CN(200))));
    SELF.T1___Nap_Summary_ := MAP(__PP49521.T1___Lex_Id_Pop_Flag_ = 0 AND __PP49521.T1___Rin_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nint,__CN(-99999)),__PP49521.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP49521.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__ECAST(KEL.typ.nint,__PP49521._nap__summary_));
    SELF.T___Inp_Cln_Middle_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP49521.Middle_Name_,=,__CN('')),__NT(__PP49521.Middle_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP49521.Middle_Name_));
    SELF := __PP49521;
  END;
  EXPORT __ENH_Event_1 := PROJECT(__EE49838,__ND50147__Project(LEFT));
END;
