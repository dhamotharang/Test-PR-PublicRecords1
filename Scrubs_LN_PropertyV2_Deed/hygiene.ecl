...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_from_file := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.from_file)));
    avelength_from_file := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.from_file)),h.from_file<>(typeof(h.from_file))'');
    ...
    maxlength_apnt_or_pin_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.apnt_or_pin_number)));
    avelength_apnt_or_pin_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.apnt_or_pin_number)),h.apnt_or_pin_number<>(typeof(h.apnt_or_pin_number))'');
    ...
    maxlength_multi_apn_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.multi_apn_flag)));
    avelength_multi_apn_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.multi_apn_flag)),h.multi_apn_flag<>(typeof(h.multi_apn_flag))'');
    populated_tax_id_number_pcnt := AVE(GROUP,IF(h.tax_id_number = (TYPEOF(h.tax_id_number))'',0,100));
    maxlength_tax_id_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_id_number)));
    avelength_tax_id_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_id_number)),h.tax_id_number<>(typeof(h.tax_id_number))'');
    populated_excise_tax_number_pcnt := AVE(GROUP,IF(h.excise_tax_number = (TYPEOF(h.excise_tax_number))'',0,100));
    maxlength_excise_tax_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.excise_tax_number)));
    avelength_excise_tax_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.excise_tax_number)),h.excise_tax_number<>(typeof(h.excise_tax_number))'');
    populated_buyer_or_borrower_ind_pcnt := AVE(GROUP,IF(h.buyer_or_borrower_ind = (TYPEOF(h.buyer_or_borrower_ind))'',0,100));
    maxlength_buyer_or_borrower_ind := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.buyer_or_borrower_ind)));
    avelength_buyer_or_borrower_ind := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.buyer_or_borrower_ind)),h.buyer_or_borrower_ind<>(typeof(h.buyer_or_borrower_ind))'');
    populated_name1_pcnt := AVE(GROUP,IF(h.name1 = (TYPEOF(h.name1))'',0,100));
    maxlength_name1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.name1)));
    avelength_name1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.name1)),h.name1<>(typeof(h.name1))'');
    populated_name1_id_code_pcnt := AVE(GROUP,IF(h.name1_id_code = (TYPEOF(h.name1_id_code))'',0,100));
    maxlength_name1_id_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.name1_id_code)));
    avelength_name1_id_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.name1_id_code)),h.name1_id_code<>(typeof(h.name1_id_code))'');
    populated_name2_pcnt := AVE(GROUP,IF(h.name2 = (TYPEOF(h.name2))'',0,100));
    maxlength_name2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.name2)));
    avelength_name2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.name2)),h.name2<>(typeof(h.name2))'');
    populated_name2_id_code_pcnt := AVE(GROUP,IF(h.name2_id_code = (TYPEOF(h.name2_id_code))'',0,100));
    maxlength_name2_id_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.name2_id_code)));
    avelength_name2_id_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.name2_id_code)),h.name2_id_code<>(typeof(h.name2_id_code))'');
    populated_vesting_code_pcnt := AVE(GROUP,IF(h.vesting_code = (TYPEOF(h.vesting_code))'',0,100));
    maxlength_vesting_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.vesting_code)));
    avelength_vesting_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.vesting_code)),h.vesting_code<>(typeof(h.vesting_code))'');
    populated_addendum_flag_pcnt := AVE(GROUP,IF(h.addendum_flag = (TYPEOF(h.addendum_flag))'',0,100));
    maxlength_addendum_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.addendum_flag)));
    avelength_addendum_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.addendum_flag)),h.addendum_flag<>(typeof(h.addendum_flag))'');
    ...
    maxlength_mailing_care_of := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_care_of)));
    avelength_mailing_care_of := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_care_of)),h.mailing_care_of<>(typeof(h.mailing_care_of))'');
    populated_mailing_street_pcnt := AVE(GROUP,IF(h.mailing_street = (TYPEOF(h.mailing_street))'',0,100));
    maxlength_mailing_street := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_street)));
    avelength_mailing_street := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_street)),h.mailing_street<>(typeof(h.mailing_street))'');
    ...
    maxlength_mailing_csz := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_csz)));
    avelength_mailing_csz := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_csz)),h.mailing_csz<>(typeof(h.mailing_csz))'');
    populated_mailing_address_cd_pcnt := AVE(GROUP,IF(h.mailing_address_cd = (TYPEOF(h.mailing_address_cd))'',0,100));
    maxlength_mailing_address_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_address_cd)));
    avelength_mailing_address_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_address_cd)),h.mailing_address_cd<>(typeof(h.mailing_address_cd))'');
    populated_seller1_pcnt := AVE(GROUP,IF(h.seller1 = (TYPEOF(h.seller1))'',0,100));
    maxlength_seller1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller1)));
    avelength_seller1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller1)),h.seller1<>(typeof(h.seller1))'');
    populated_seller1_id_code_pcnt := AVE(GROUP,IF(h.seller1_id_code = (TYPEOF(h.seller1_id_code))'',0,100));
    maxlength_seller1_id_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller1_id_code)));
    avelength_seller1_id_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller1_id_code)),h.seller1_id_code<>(typeof(h.seller1_id_code))'');
    populated_seller2_pcnt := AVE(GROUP,IF(h.seller2 = (TYPEOF(h.seller2))'',0,100));
    maxlength_seller2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller2)));
    avelength_seller2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller2)),h.seller2<>(typeof(h.seller2))'');
    populated_seller2_id_code_pcnt := AVE(GROUP,IF(h.seller2_id_code = (TYPEOF(h.seller2_id_code))'',0,100));
    maxlength_seller2_id_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller2_id_code)));
    avelength_seller2_id_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller2_id_code)),h.seller2_id_code<>(typeof(h.seller2_id_code))'');
    populated_seller_addendum_flag_pcnt := AVE(GROUP,IF(h.seller_addendum_flag = (TYPEOF(h.seller_addendum_flag))'',0,100));
    maxlength_seller_addendum_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_addendum_flag)));
    avelength_seller_addendum_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_addendum_flag)),h.seller_addendum_flag<>(typeof(h.seller_addendum_flag))'');
    ...
    maxlength_seller_mailing_full_street_address := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_full_street_address)));
    avelength_seller_mailing_full_street_address := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_full_street_address)),h.seller_mailing_full_street_address<>(typeof(h.seller_mailing_full_street_address))'');
    ...
    maxlength_seller_mailing_address_unit_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_address_unit_number)));
    avelength_seller_mailing_address_unit_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_address_unit_number)),h.seller_mailing_address_unit_number<>(typeof(h.seller_mailing_address_unit_number))'');
    ...
    maxlength_seller_mailing_address_citystatezip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_address_citystatezip)));
    avelength_seller_mailing_address_citystatezip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.seller_mailing_address_citystatezip)),h.seller_mailing_address_citystatezip<>(typeof(h.seller_mailing_address_citystatezip))'');
    ...
    maxlength_property_address_unit_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_unit_number)));
    avelength_property_address_unit_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_unit_number)),h.property_address_unit_number<>(typeof(h.property_address_unit_number))'');
    ...
    maxlength_property_address_citystatezip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_citystatezip)));
    avelength_property_address_citystatezip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_citystatezip)),h.property_address_citystatezip<>(typeof(h.property_address_citystatezip))'');
    ...
    maxlength_recorder_map_reference := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_map_reference)));
    avelength_recorder_map_reference := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_map_reference)),h.recorder_map_reference<>(typeof(h.recorder_map_reference))'');
    ...
    maxlength_complete_legal_description_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.complete_legal_description_code)));
    avelength_complete_legal_description_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.complete_legal_description_code)),h.complete_legal_description_code<>(typeof(h.complete_legal_description_code))'');
    populated_contract_date_pcnt := AVE(GROUP,IF(h.contract_date = (TYPEOF(h.contract_date))'',0,100));
    maxlength_contract_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contract_date)));
    avelength_contract_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contract_date)),h.contract_date<>(typeof(h.contract_date))'');
    ...
    maxlength_arm_reset_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arm_reset_date)));
    avelength_arm_reset_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arm_reset_date)),h.arm_reset_date<>(typeof(h.arm_reset_date))'');
    populated_document_number_pcnt := AVE(GROUP,IF(h.document_number = (TYPEOF(h.document_number))'',0,100));
    maxlength_document_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_number)));
    avelength_document_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_number)),h.document_number<>(typeof(h.document_number))'');
    populated_document_type_code_pcnt := AVE(GROUP,IF(h.document_type_code = (TYPEOF(h.document_type_code))'',0,100));
    maxlength_document_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_type_code)));
    avelength_document_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_type_code)),h.document_type_code<>(typeof(h.document_type_code))'');
    populated_loan_number_pcnt := AVE(GROUP,IF(h.loan_number = (TYPEOF(h.loan_number))'',0,100));
    maxlength_loan_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_number)));
    avelength_loan_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_number)),h.loan_number<>(typeof(h.loan_number))'');
    ...
    maxlength_concurrent_mortgage_book_page_document_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.concurrent_mortgage_book_page_document_number)));
    avelength_concurrent_mortgage_book_page_document_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.concurrent_mortgage_book_page_document_number)),h.concurrent_mortgage_book_page_document_number<>(typeof(h.concurrent_mortgage_book_page_document_number))'');
    ...
    maxlength_city_transfer_tax := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.city_transfer_tax)));
    avelength_city_transfer_tax := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.city_transfer_tax)),h.city_transfer_tax<>(typeof(h.city_transfer_tax))'');
    populated_county_transfer_tax_pcnt := AVE(GROUP,IF(h.county_transfer_tax = (TYPEOF(h.county_transfer_tax))'',0,100));
    maxlength_county_transfer_tax := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_transfer_tax)));
    avelength_county_transfer_tax := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_transfer_tax)),h.county_transfer_tax<>(typeof(h.county_transfer_tax))'');
    populated_total_transfer_tax_pcnt := AVE(GROUP,IF(h.total_transfer_tax = (TYPEOF(h.total_transfer_tax))'',0,100));
    maxlength_total_transfer_tax := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.total_transfer_tax)));
    avelength_total_transfer_tax := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.total_transfer_tax)),h.total_transfer_tax<>(typeof(h.total_transfer_tax))'');
    populated_first_td_loan_amount_pcnt := AVE(GROUP,IF(h.first_td_loan_amount = (TYPEOF(h.first_td_loan_amount))'',0,100));
    maxlength_first_td_loan_amount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_loan_amount)));
    avelength_first_td_loan_amount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_loan_amount)),h.first_td_loan_amount<>(typeof(h.first_td_loan_amount))'');
    populated_second_td_loan_amount_pcnt := AVE(GROUP,IF(h.second_td_loan_amount = (TYPEOF(h.second_td_loan_amount))'',0,100));
    maxlength_second_td_loan_amount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_td_loan_amount)));
    avelength_second_td_loan_amount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_td_loan_amount)),h.second_td_loan_amount<>(typeof(h.second_td_loan_amount))'');
    ...
    maxlength_first_td_lender_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_lender_type_code)));
    avelength_first_td_lender_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_lender_type_code)),h.first_td_lender_type_code<>(typeof(h.first_td_lender_type_code))'');
    ...
    maxlength_second_td_lender_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_td_lender_type_code)));
    avelength_second_td_lender_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_td_lender_type_code)),h.second_td_lender_type_code<>(typeof(h.second_td_lender_type_code))'');
    populated_first_td_loan_type_code_pcnt := AVE(GROUP,IF(h.first_td_loan_type_code = (TYPEOF(h.first_td_loan_type_code))'',0,100));
    maxlength_first_td_loan_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_loan_type_code)));
    avelength_first_td_loan_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_loan_type_code)),h.first_td_loan_type_code<>(typeof(h.first_td_loan_type_code))'');
    populated_type_financing_pcnt := AVE(GROUP,IF(h.type_financing = (TYPEOF(h.type_financing))'',0,100));
    maxlength_type_financing := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.type_financing)));
    avelength_type_financing := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.type_financing)),h.type_financing<>(typeof(h.type_financing))'');
    populated_first_td_interest_rate_pcnt := AVE(GROUP,IF(h.first_td_interest_rate = (TYPEOF(h.first_td_interest_rate))'',0,100));
    maxlength_first_td_interest_rate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_interest_rate)));
    avelength_first_td_interest_rate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_interest_rate)),h.first_td_interest_rate<>(typeof(h.first_td_interest_rate))'');
    populated_first_td_due_date_pcnt := AVE(GROUP,IF(h.first_td_due_date = (TYPEOF(h.first_td_due_date))'',0,100));
    maxlength_first_td_due_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_due_date)));
    avelength_first_td_due_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.first_td_due_date)),h.first_td_due_date<>(typeof(h.first_td_due_date))'');
    populated_title_company_name_pcnt := AVE(GROUP,IF(h.title_company_name = (TYPEOF(h.title_company_name))'',0,100));
    maxlength_title_company_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.title_company_name)));
    avelength_title_company_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.title_company_name)),h.title_company_name<>(typeof(h.title_company_name))'');
    ...
    maxlength_partial_interest_transferred := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.partial_interest_transferred)));
    avelength_partial_interest_transferred := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.partial_interest_transferred)),h.partial_interest_transferred<>(typeof(h.partial_interest_transferred))'');
    populated_loan_term_months_pcnt := AVE(GROUP,IF(h.loan_term_months = (TYPEOF(h.loan_term_months))'',0,100));
    maxlength_loan_term_months := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_term_months)));
    avelength_loan_term_months := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_term_months)),h.loan_term_months<>(typeof(h.loan_term_months))'');
    populated_loan_term_years_pcnt := AVE(GROUP,IF(h.loan_term_years = (TYPEOF(h.loan_term_years))'',0,100));
    maxlength_loan_term_years := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_term_years)));
    avelength_loan_term_years := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.loan_term_years)),h.loan_term_years<>(typeof(h.loan_term_years))'');
    populated_lender_name_pcnt := AVE(GROUP,IF(h.lender_name = (TYPEOF(h.lender_name))'',0,100));
    maxlength_lender_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_name)));
    avelength_lender_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_name)),h.lender_name<>(typeof(h.lender_name))'');
    populated_lender_name_id_pcnt := AVE(GROUP,IF(h.lender_name_id = (TYPEOF(h.lender_name_id))'',0,100));
    maxlength_lender_name_id := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_name_id)));
    avelength_lender_name_id := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_name_id)),h.lender_name_id<>(typeof(h.lender_name_id))'');
    populated_lender_dba_aka_name_pcnt := AVE(GROUP,IF(h.lender_dba_aka_name = (TYPEOF(h.lender_dba_aka_name))'',0,100));
    maxlength_lender_dba_aka_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_dba_aka_name)));
    avelength_lender_dba_aka_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_dba_aka_name)),h.lender_dba_aka_name<>(typeof(h.lender_dba_aka_name))'');
    ...
    maxlength_lender_full_street_address := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_full_street_address)));
    avelength_lender_full_street_address := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_full_street_address)),h.lender_full_street_address<>(typeof(h.lender_full_street_address))'');
    ...
    maxlength_lender_address_unit_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_address_unit_number)));
    avelength_lender_address_unit_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_address_unit_number)),h.lender_address_unit_number<>(typeof(h.lender_address_unit_number))'');
    ...
    maxlength_lender_address_citystatezip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_address_citystatezip)));
    avelength_lender_address_citystatezip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lender_address_citystatezip)),h.lender_address_citystatezip<>(typeof(h.lender_address_citystatezip))'');
    ...
    maxlength_assessment_match_land_use_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessment_match_land_use_code)));
    avelength_assessment_match_land_use_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessment_match_land_use_code)),h.assessment_match_land_use_code<>(typeof(h.assessment_match_land_use_code))'');
    populated_property_use_code_pcnt := AVE(GROUP,IF(h.property_use_code = (TYPEOF(h.property_use_code))'',0,100));
    maxlength_property_use_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_use_code)));
    avelength_property_use_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_use_code)),h.property_use_code<>(typeof(h.property_use_code))'');
    populated_condo_code_pcnt := AVE(GROUP,IF(h.condo_code = (TYPEOF(h.condo_code))'',0,100));
    maxlength_condo_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.condo_code)));
    avelength_condo_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.condo_code)),h.condo_code<>(typeof(h.condo_code))'');
    populated_timeshare_flag_pcnt := AVE(GROUP,IF(h.timeshare_flag = (TYPEOF(h.timeshare_flag))'',0,100));
    maxlength_timeshare_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.timeshare_flag)));
    avelength_timeshare_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.timeshare_flag)),h.timeshare_flag<>(typeof(h.timeshare_flag))'');
    populated_land_lot_size_pcnt := AVE(GROUP,IF(h.land_lot_size = (TYPEOF(h.land_lot_size))'',0,100));
    maxlength_land_lot_size := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_lot_size)));
    avelength_land_lot_size := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_lot_size)),h.land_lot_size<>(typeof(h.land_lot_size))'');
    populated_hawaii_tct_pcnt := AVE(GROUP,IF(h.hawaii_tct = (TYPEOF(h.hawaii_tct))'',0,100));
    maxlength_hawaii_tct := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_tct)));
    avelength_hawaii_tct := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_tct)),h.hawaii_tct<>(typeof(h.hawaii_tct))'');
    populated_hawaii_condo_cpr_code_pcnt := AVE(GROUP,IF(h.hawaii_condo_cpr_code = (TYPEOF(h.hawaii_condo_cpr_code))'',0,100));
    maxlength_hawaii_condo_cpr_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_condo_cpr_code)));
    avelength_hawaii_condo_cpr_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_condo_cpr_code)),h.hawaii_condo_cpr_code<>(typeof(h.hawaii_condo_cpr_code))'');
    populated_hawaii_condo_name_pcnt := AVE(GROUP,IF(h.hawaii_condo_name = (TYPEOF(h.hawaii_condo_name))'',0,100));
    maxlength_hawaii_condo_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_condo_name)));
    avelength_hawaii_condo_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hawaii_condo_name)),h.hawaii_condo_name<>(typeof(h.hawaii_condo_name))'');
    populated_filler_except_hawaii_pcnt := AVE(GROUP,IF(h.filler_except_hawaii = (TYPEOF(h.filler_except_hawaii))'',0,100));
    maxlength_filler_except_hawaii := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.filler_except_hawaii)));
    avelength_filler_except_hawaii := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.filler_except_hawaii)),h.filler_except_hawaii<>(typeof(h.filler_except_hawaii))'');
    populated_rate_change_frequency_pcnt := AVE(GROUP,IF(h.rate_change_frequency = (TYPEOF(h.rate_change_frequency))'',0,100));
    maxlength_rate_change_frequency := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.rate_change_frequency)));
    avelength_rate_change_frequency := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.rate_change_frequency)),h.rate_change_frequency<>(typeof(h.rate_change_frequency))'');
    populated_change_index_pcnt := AVE(GROUP,IF(h.change_index = (TYPEOF(h.change_index))'',0,100));
    maxlength_change_index := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.change_index)));
    avelength_change_index := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.change_index)),h.change_index<>(typeof(h.change_index))'');
    populated_adjustable_rate_index_pcnt := AVE(GROUP,IF(h.adjustable_rate_index = (TYPEOF(h.adjustable_rate_index))'',0,100));
    maxlength_adjustable_rate_index := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.adjustable_rate_index)));
    avelength_adjustable_rate_index := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.adjustable_rate_index)),h.adjustable_rate_index<>(typeof(h.adjustable_rate_index))'');
    populated_adjustable_rate_rider_pcnt := AVE(GROUP,IF(h.adjustable_rate_rider = (TYPEOF(h.adjustable_rate_rider))'',0,100));
    maxlength_adjustable_rate_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.adjustable_rate_rider)));
    avelength_adjustable_rate_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.adjustable_rate_rider)),h.adjustable_rate_rider<>(typeof(h.adjustable_rate_rider))'');
    populated_graduated_payment_rider_pcnt := AVE(GROUP,IF(h.graduated_payment_rider = (TYPEOF(h.graduated_payment_rider))'',0,100));
    maxlength_graduated_payment_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.graduated_payment_rider)));
    avelength_graduated_payment_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.graduated_payment_rider)),h.graduated_payment_rider<>(typeof(h.graduated_payment_rider))'');
    populated_balloon_rider_pcnt := AVE(GROUP,IF(h.balloon_rider = (TYPEOF(h.balloon_rider))'',0,100));
    maxlength_balloon_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.balloon_rider)));
    avelength_balloon_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.balloon_rider)),h.balloon_rider<>(typeof(h.balloon_rider))'');
    populated_fixed_step_rate_rider_pcnt := AVE(GROUP,IF(h.fixed_step_rate_rider = (TYPEOF(h.fixed_step_rate_rider))'',0,100));
    maxlength_fixed_step_rate_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fixed_step_rate_rider)));
    avelength_fixed_step_rate_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fixed_step_rate_rider)),h.fixed_step_rate_rider<>(typeof(h.fixed_step_rate_rider))'');
    populated_condominium_rider_pcnt := AVE(GROUP,IF(h.condominium_rider = (TYPEOF(h.condominium_rider))'',0,100));
    maxlength_condominium_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.condominium_rider)));
    avelength_condominium_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.condominium_rider)),h.condominium_rider<>(typeof(h.condominium_rider))'');
    ...
    maxlength_planned_unit_development_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.planned_unit_development_rider)));
    avelength_planned_unit_development_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.planned_unit_development_rider)),h.planned_unit_development_rider<>(typeof(h.planned_unit_development_rider))'');
    populated_rate_improvement_rider_pcnt := AVE(GROUP,IF(h.rate_improvement_rider = (TYPEOF(h.rate_improvement_rider))'',0,100));
    maxlength_rate_improvement_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.rate_improvement_rider)));
    avelength_rate_improvement_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.rate_improvement_rider)),h.rate_improvement_rider<>(typeof(h.rate_improvement_rider))'');
    populated_assumability_rider_pcnt := AVE(GROUP,IF(h.assumability_rider = (TYPEOF(h.assumability_rider))'',0,100));
    maxlength_assumability_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assumability_rider)));
    avelength_assumability_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assumability_rider)),h.assumability_rider<>(typeof(h.assumability_rider))'');
    populated_prepayment_rider_pcnt := AVE(GROUP,IF(h.prepayment_rider = (TYPEOF(h.prepayment_rider))'',0,100));
    maxlength_prepayment_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prepayment_rider)));
    avelength_prepayment_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prepayment_rider)),h.prepayment_rider<>(typeof(h.prepayment_rider))'');
    populated_one_four_family_rider_pcnt := AVE(GROUP,IF(h.one_four_family_rider = (TYPEOF(h.one_four_family_rider))'',0,100));
    maxlength_one_four_family_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.one_four_family_rider)));
    avelength_one_four_family_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.one_four_family_rider)),h.one_four_family_rider<>(typeof(h.one_four_family_rider))'');
    populated_biweekly_payment_rider_pcnt := AVE(GROUP,IF(h.biweekly_payment_rider = (TYPEOF(h.biweekly_payment_rider))'',0,100));
    maxlength_biweekly_payment_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.biweekly_payment_rider)));
    avelength_biweekly_payment_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.biweekly_payment_rider)),h.biweekly_payment_rider<>(typeof(h.biweekly_payment_rider))'');
    populated_second_home_rider_pcnt := AVE(GROUP,IF(h.second_home_rider = (TYPEOF(h.second_home_rider))'',0,100));
    maxlength_second_home_rider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_home_rider)));
    avelength_second_home_rider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_home_rider)),h.second_home_rider<>(typeof(h.second_home_rider))'');
    populated_data_source_code_pcnt := AVE(GROUP,IF(h.data_source_code = (TYPEOF(h.data_source_code))'',0,100));
    maxlength_data_source_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.data_source_code)));
    avelength_data_source_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.data_source_code)),h.data_source_code<>(typeof(h.data_source_code))'');
    populated_main_record_id_code_pcnt := AVE(GROUP,IF(h.main_record_id_code = (TYPEOF(h.main_record_id_code))'',0,100));
    maxlength_main_record_id_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.main_record_id_code)));
    avelength_main_record_id_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.main_record_id_code)),h.main_record_id_code<>(typeof(h.main_record_id_code))'');
    populated_addl_name_flag_pcnt := AVE(GROUP,IF(h.addl_name_flag = (TYPEOF(h.addl_name_flag))'',0,100));
    maxlength_addl_name_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.addl_name_flag)));
    avelength_addl_name_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.addl_name_flag)),h.addl_name_flag<>(typeof(h.addl_name_flag))'');
    ...
    maxlength_ln_buyer_mailing_country_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_buyer_mailing_country_code)));
    avelength_ln_buyer_mailing_country_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_buyer_mailing_country_code)),h.ln_buyer_mailing_country_code<>(typeof(h.ln_buyer_mailing_country_code))'');
    ...
    maxlength_ln_seller_mailing_country_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_seller_mailing_country_code)));
    avelength_ln_seller_mailing_country_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_seller_mailing_country_code)),h.ln_seller_mailing_country_code<>(typeof(h.ln_seller_mailing_country_code))'');
  END;
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.from_file),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.apnt_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.multi_apn_flag),TRIM((SALT33.StrType)le.tax_id_number),TRIM((SALT33.StrType)le.excise_tax_number),TRIM((SALT33.StrType)le.buyer_or_borrower_ind),TRIM((SALT33.StrType)le.name1),TRIM((SALT33.StrType)le.name1_id_code),TRIM((SALT33.StrType)le.name2),TRIM((SALT33.StrType)le.name2_id_code),TRIM((SALT33.StrType)le.vesting_code),TRIM((SALT33.StrType)le.addendum_flag),TRIM((SALT33.StrType)le.phone_number),TRIM((SALT33.StrType)le.mailing_care_of),TRIM((SALT33.StrType)le.mailing_street),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_csz),TRIM((SALT33.StrType)le.mailing_address_cd),TRIM((SALT33.StrType)le.seller1),TRIM((SALT33.StrType)le.seller1_id_code),TRIM((SALT33.StrType)le.seller2),TRIM((SALT33.StrType)le.seller2_id_code),TRIM((SALT33.StrType)le.seller_addendum_flag),TRIM((SALT33.StrType)le.seller_mailing_full_street_address),TRIM((SALT33.StrType)le.seller_mailing_address_unit_number),TRIM((SALT33.StrType)le.seller_mailing_address_citystatezip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_address_unit_number),TRIM((SALT33.StrType)le.property_address_citystatezip),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.recorder_map_reference),TRIM((SALT33.StrType)le.complete_legal_description_code),TRIM((SALT33.StrType)le.contract_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.arm_reset_date),TRIM((SALT33.StrType)le.document_number),TRIM((SALT33.StrType)le.document_type_code),TRIM((SALT33.StrType)le.loan_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.concurrent_mortgage_book_page_document_number),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.city_transfer_tax),TRIM((SALT33.StrType)le.county_transfer_tax),TRIM((SALT33.StrType)le.total_transfer_tax),TRIM((SALT33.StrType)le.first_td_loan_amount),TRIM((SALT33.StrType)le.second_td_loan_amount),TRIM((SALT33.StrType)le.first_td_lender_type_code),TRIM((SALT33.StrType)le.second_td_lender_type_code),TRIM((SALT33.StrType)le.first_td_loan_type_code),TRIM((SALT33.StrType)le.type_financing),TRIM((SALT33.StrType)le.first_td_interest_rate),TRIM((SALT33.StrType)le.first_td_due_date),TRIM((SALT33.StrType)le.title_company_name),TRIM((SALT33.StrType)le.partial_interest_transferred),TRIM((SALT33.StrType)le.loan_term_months),TRIM((SALT33.StrType)le.loan_term_years),TRIM((SALT33.StrType)le.lender_name),TRIM((SALT33.StrType)le.lender_name_id),TRIM((SALT33.StrType)le.lender_dba_aka_name),TRIM((SALT33.StrType)le.lender_full_street_address),TRIM((SALT33.StrType)le.lender_address_unit_number),TRIM((SALT33.StrType)le.lender_address_citystatezip),TRIM((SALT33.StrType)le.assessment_match_land_use_code),TRIM((SALT33.StrType)le.property_use_code),TRIM((SALT33.StrType)le.condo_code),TRIM((SALT33.StrType)le.timeshare_flag),TRIM((SALT33.StrType)le.land_lot_size),TRIM((SALT33.StrType)le.hawaii_tct),TRIM((SALT33.StrType)le.hawaii_condo_cpr_code),TRIM((SALT33.StrType)le.hawaii_condo_name),TRIM((SALT33.StrType)le.filler_except_hawaii),TRIM((SALT33.StrType)le.rate_change_frequency),TRIM((SALT33.StrType)le.change_index),TRIM((SALT33.StrType)le.adjustable_rate_index),TRIM((SALT33.StrType)le.adjustable_rate_rider),TRIM((SALT33.StrType)le.graduated_payment_rider),TRIM((SALT33.StrType)le.balloon_rider),TRIM((SALT33.StrType)le.fixed_step_rate_rider),TRIM((SALT33.StrType)le.condominium_rider),TRIM((SALT33.StrType)le.planned_unit_development_rider),TRIM((SALT33.StrType)le.rate_improvement_rider),TRIM((SALT33.StrType)le.assumability_rider),TRIM((SALT33.StrType)le.prepayment_rider),TRIM((SALT33.StrType)le.one_four_family_rider),TRIM((SALT33.StrType)le.biweekly_payment_rider),TRIM((SALT33.StrType)le.second_home_rider),TRIM((SALT33.StrType)le.data_source_code),TRIM((SALT33.StrType)le.main_record_id_code),TRIM((SALT33.StrType)le.addl_name_flag),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_buyer_mailing_country_code),TRIM((SALT33.StrType)le.ln_seller_mailing_country_code)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 118);
  SELF.FldNo2 := 1 + (C % 118);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.from_file),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.apnt_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.multi_apn_flag),TRIM((SALT33.StrType)le.tax_id_number),TRIM((SALT33.StrType)le.excise_tax_number),TRIM((SALT33.StrType)le.buyer_or_borrower_ind),TRIM((SALT33.StrType)le.name1),TRIM((SALT33.StrType)le.name1_id_code),TRIM((SALT33.StrType)le.name2),TRIM((SALT33.StrType)le.name2_id_code),TRIM((SALT33.StrType)le.vesting_code),TRIM((SALT33.StrType)le.addendum_flag),TRIM((SALT33.StrType)le.phone_number),TRIM((SALT33.StrType)le.mailing_care_of),TRIM((SALT33.StrType)le.mailing_street),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_csz),TRIM((SALT33.StrType)le.mailing_address_cd),TRIM((SALT33.StrType)le.seller1),TRIM((SALT33.StrType)le.seller1_id_code),TRIM((SALT33.StrType)le.seller2),TRIM((SALT33.StrType)le.seller2_id_code),TRIM((SALT33.StrType)le.seller_addendum_flag),TRIM((SALT33.StrType)le.seller_mailing_full_street_address),TRIM((SALT33.StrType)le.seller_mailing_address_unit_number),TRIM((SALT33.StrType)le.seller_mailing_address_citystatezip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_address_unit_number),TRIM((SALT33.StrType)le.property_address_citystatezip),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.recorder_map_reference),TRIM((SALT33.StrType)le.complete_legal_description_code),TRIM((SALT33.StrType)le.contract_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.arm_reset_date),TRIM((SALT33.StrType)le.document_number),TRIM((SALT33.StrType)le.document_type_code),TRIM((SALT33.StrType)le.loan_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.concurrent_mortgage_book_page_document_number),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.city_transfer_tax),TRIM((SALT33.StrType)le.county_transfer_tax),TRIM((SALT33.StrType)le.total_transfer_tax),TRIM((SALT33.StrType)le.first_td_loan_amount),TRIM((SALT33.StrType)le.second_td_loan_amount),TRIM((SALT33.StrType)le.first_td_lender_type_code),TRIM((SALT33.StrType)le.second_td_lender_type_code),TRIM((SALT33.StrType)le.first_td_loan_type_code),TRIM((SALT33.StrType)le.type_financing),TRIM((SALT33.StrType)le.first_td_interest_rate),TRIM((SALT33.StrType)le.first_td_due_date),TRIM((SALT33.StrType)le.title_company_name),TRIM((SALT33.StrType)le.partial_interest_transferred),TRIM((SALT33.StrType)le.loan_term_months),TRIM((SALT33.StrType)le.loan_term_years),TRIM((SALT33.StrType)le.lender_name),TRIM((SALT33.StrType)le.lender_name_id),TRIM((SALT33.StrType)le.lender_dba_aka_name),TRIM((SALT33.StrType)le.lender_full_street_address),TRIM((SALT33.StrType)le.lender_address_unit_number),TRIM((SALT33.StrType)le.lender_address_citystatezip),TRIM((SALT33.StrType)le.assessment_match_land_use_code),TRIM((SALT33.StrType)le.property_use_code),TRIM((SALT33.StrType)le.condo_code),TRIM((SALT33.StrType)le.timeshare_flag),TRIM((SALT33.StrType)le.land_lot_size),TRIM((SALT33.StrType)le.hawaii_tct),TRIM((SALT33.StrType)le.hawaii_condo_cpr_code),TRIM((SALT33.StrType)le.hawaii_condo_name),TRIM((SALT33.StrType)le.filler_except_hawaii),TRIM((SALT33.StrType)le.rate_change_frequency),TRIM((SALT33.StrType)le.change_index),TRIM((SALT33.StrType)le.adjustable_rate_index),TRIM((SALT33.StrType)le.adjustable_rate_rider),TRIM((SALT33.StrType)le.graduated_payment_rider),TRIM((SALT33.StrType)le.balloon_rider),TRIM((SALT33.StrType)le.fixed_step_rate_rider),TRIM((SALT33.StrType)le.condominium_rider),TRIM((SALT33.StrType)le.planned_unit_development_rider),TRIM((SALT33.StrType)le.rate_improvement_rider),TRIM((SALT33.StrType)le.assumability_rider),TRIM((SALT33.StrType)le.prepayment_rider),TRIM((SALT33.StrType)le.one_four_family_rider),TRIM((SALT33.StrType)le.biweekly_payment_rider),TRIM((SALT33.StrType)le.second_home_rider),TRIM((SALT33.StrType)le.data_source_code),TRIM((SALT33.StrType)le.main_record_id_code),TRIM((SALT33.StrType)le.addl_name_flag),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_buyer_mailing_country_code),TRIM((SALT33.StrType)le.ln_seller_mailing_country_code)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.from_file),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.apnt_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.multi_apn_flag),TRIM((SALT33.StrType)le.tax_id_number),TRIM((SALT33.StrType)le.excise_tax_number),TRIM((SALT33.StrType)le.buyer_or_borrower_ind),TRIM((SALT33.StrType)le.name1),TRIM((SALT33.StrType)le.name1_id_code),TRIM((SALT33.StrType)le.name2),TRIM((SALT33.StrType)le.name2_id_code),TRIM((SALT33.StrType)le.vesting_code),TRIM((SALT33.StrType)le.addendum_flag),TRIM((SALT33.StrType)le.phone_number),TRIM((SALT33.StrType)le.mailing_care_of),TRIM((SALT33.StrType)le.mailing_street),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_csz),TRIM((SALT33.StrType)le.mailing_address_cd),TRIM((SALT33.StrType)le.seller1),TRIM((SALT33.StrType)le.seller1_id_code),TRIM((SALT33.StrType)le.seller2),TRIM((SALT33.StrType)le.seller2_id_code),TRIM((SALT33.StrType)le.seller_addendum_flag),TRIM((SALT33.StrType)le.seller_mailing_full_street_address),TRIM((SALT33.StrType)le.seller_mailing_address_unit_number),TRIM((SALT33.StrType)le.seller_mailing_address_citystatezip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_address_unit_number),TRIM((SALT33.StrType)le.property_address_citystatezip),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.recorder_map_reference),TRIM((SALT33.StrType)le.complete_legal_description_code),TRIM((SALT33.StrType)le.contract_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.arm_reset_date),TRIM((SALT33.StrType)le.document_number),TRIM((SALT33.StrType)le.document_type_code),TRIM((SALT33.StrType)le.loan_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.concurrent_mortgage_book_page_document_number),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.city_transfer_tax),TRIM((SALT33.StrType)le.county_transfer_tax),TRIM((SALT33.StrType)le.total_transfer_tax),TRIM((SALT33.StrType)le.first_td_loan_amount),TRIM((SALT33.StrType)le.second_td_loan_amount),TRIM((SALT33.StrType)le.first_td_lender_type_code),TRIM((SALT33.StrType)le.second_td_lender_type_code),TRIM((SALT33.StrType)le.first_td_loan_type_code),TRIM((SALT33.StrType)le.type_financing),TRIM((SALT33.StrType)le.first_td_interest_rate),TRIM((SALT33.StrType)le.first_td_due_date),TRIM((SALT33.StrType)le.title_company_name),TRIM((SALT33.StrType)le.partial_interest_transferred),TRIM((SALT33.StrType)le.loan_term_months),TRIM((SALT33.StrType)le.loan_term_years),TRIM((SALT33.StrType)le.lender_name),TRIM((SALT33.StrType)le.lender_name_id),TRIM((SALT33.StrType)le.lender_dba_aka_name),TRIM((SALT33.StrType)le.lender_full_street_address),TRIM((SALT33.StrType)le.lender_address_unit_number),TRIM((SALT33.StrType)le.lender_address_citystatezip),TRIM((SALT33.StrType)le.assessment_match_land_use_code),TRIM((SALT33.StrType)le.property_use_code),TRIM((SALT33.StrType)le.condo_code),TRIM((SALT33.StrType)le.timeshare_flag),TRIM((SALT33.StrType)le.land_lot_size),TRIM((SALT33.StrType)le.hawaii_tct),TRIM((SALT33.StrType)le.hawaii_condo_cpr_code),TRIM((SALT33.StrType)le.hawaii_condo_name),TRIM((SALT33.StrType)le.filler_except_hawaii),TRIM((SALT33.StrType)le.rate_change_frequency),TRIM((SALT33.StrType)le.change_index),TRIM((SALT33.StrType)le.adjustable_rate_index),TRIM((SALT33.StrType)le.adjustable_rate_rider),TRIM((SALT33.StrType)le.graduated_payment_rider),TRIM((SALT33.StrType)le.balloon_rider),TRIM((SALT33.StrType)le.fixed_step_rate_rider),TRIM((SALT33.StrType)le.condominium_rider),TRIM((SALT33.StrType)le.planned_unit_development_rider),TRIM((SALT33.StrType)le.rate_improvement_rider),TRIM((SALT33.StrType)le.assumability_rider),TRIM((SALT33.StrType)le.prepayment_rider),TRIM((SALT33.StrType)le.one_four_family_rider),TRIM((SALT33.StrType)le.biweekly_payment_rider),TRIM((SALT33.StrType)le.second_home_rider),TRIM((SALT33.StrType)le.data_source_code),TRIM((SALT33.StrType)le.main_record_id_code),TRIM((SALT33.StrType)le.addl_name_flag),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_buyer_mailing_country_code),TRIM((SALT33.StrType)le.ln_seller_mailing_country_code)));
  END;
...
SHARED FldIds := DATASET([{1,'ln_fares_id'}
      ...
      ,{118,'ln_seller_mailing_country_code'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_from_file((SALT33.StrType)le.from_file),
    ...
    Fields.InValid_record_type((SALT33.StrType)le.record_type,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_apnt_or_pin_number((SALT33.StrType)le.apnt_or_pin_number),
    Fields.InValid_fares_unformatted_apn((SALT33.StrType)le.fares_unformatted_apn),
    Fields.InValid_multi_apn_flag((SALT33.StrType)le.multi_apn_flag),
    Fields.InValid_tax_id_number((SALT33.StrType)le.tax_id_number),
    Fields.InValid_excise_tax_number((SALT33.StrType)le.excise_tax_number),
    Fields.InValid_buyer_or_borrower_ind((SALT33.StrType)le.buyer_or_borrower_ind),
    Fields.InValid_name1((SALT33.StrType)le.name1),
    Fields.InValid_name1_id_code((SALT33.StrType)le.name1_id_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_name2((SALT33.StrType)le.name2),
    Fields.InValid_name2_id_code((SALT33.StrType)le.name2_id_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_vesting_code((SALT33.StrType)le.vesting_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_addendum_flag((SALT33.StrType)le.addendum_flag),
    Fields.InValid_phone_number((SALT33.StrType)le.phone_number),
    Fields.InValid_mailing_care_of((SALT33.StrType)le.mailing_care_of),
    Fields.InValid_mailing_street((SALT33.StrType)le.mailing_street),
    Fields.InValid_mailing_unit_number((SALT33.StrType)le.mailing_unit_number),
    Fields.InValid_mailing_csz((SALT33.StrType)le.mailing_csz),
    Fields.InValid_mailing_address_cd((SALT33.StrType)le.mailing_address_cd),
    Fields.InValid_seller1((SALT33.StrType)le.seller1),
    Fields.InValid_seller1_id_code((SALT33.StrType)le.seller1_id_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_seller2((SALT33.StrType)le.seller2),
    Fields.InValid_seller2_id_code((SALT33.StrType)le.seller2_id_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_seller_addendum_flag((SALT33.StrType)le.seller_addendum_flag),
    Fields.InValid_seller_mailing_full_street_address((SALT33.StrType)le.seller_mailing_full_street_address),
    Fields.InValid_seller_mailing_address_unit_number((SALT33.StrType)le.seller_mailing_address_unit_number),
    Fields.InValid_seller_mailing_address_citystatezip((SALT33.StrType)le.seller_mailing_address_citystatezip),
    Fields.InValid_property_full_street_address((SALT33.StrType)le.property_full_street_address),
    Fields.InValid_property_address_unit_number((SALT33.StrType)le.property_address_unit_number),
    Fields.InValid_property_address_citystatezip((SALT33.StrType)le.property_address_citystatezip),
    Fields.InValid_property_address_code((SALT33.StrType)le.property_address_code),
    ...
    Fields.InValid_recorder_map_reference((SALT33.StrType)le.recorder_map_reference),
    Fields.InValid_complete_legal_description_code((SALT33.StrType)le.complete_legal_description_code),
    Fields.InValid_contract_date((SALT33.StrType)le.contract_date),
    Fields.InValid_recording_date((SALT33.StrType)le.recording_date),
    Fields.InValid_arm_reset_date((SALT33.StrType)le.arm_reset_date),
    Fields.InValid_document_number((SALT33.StrType)le.document_number),
    Fields.InValid_document_type_code((SALT33.StrType)le.document_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_loan_number((SALT33.StrType)le.loan_number),
    ...
    Fields.InValid_concurrent_mortgage_book_page_document_number((SALT33.StrType)le.concurrent_mortgage_book_page_document_number),
    ...
    Fields.InValid_city_transfer_tax((SALT33.StrType)le.city_transfer_tax),
    Fields.InValid_county_transfer_tax((SALT33.StrType)le.county_transfer_tax),
    Fields.InValid_total_transfer_tax((SALT33.StrType)le.total_transfer_tax),
    Fields.InValid_first_td_loan_amount((SALT33.StrType)le.first_td_loan_amount),
    Fields.InValid_second_td_loan_amount((SALT33.StrType)le.second_td_loan_amount),
    Fields.InValid_first_td_lender_type_code((SALT33.StrType)le.first_td_lender_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_second_td_lender_type_code((SALT33.StrType)le.second_td_lender_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_first_td_loan_type_code((SALT33.StrType)le.first_td_loan_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_type_financing((SALT33.StrType)le.type_financing,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_first_td_interest_rate((SALT33.StrType)le.first_td_interest_rate),
    Fields.InValid_first_td_due_date((SALT33.StrType)le.first_td_due_date),
    Fields.InValid_title_company_name((SALT33.StrType)le.title_company_name),
    Fields.InValid_partial_interest_transferred((SALT33.StrType)le.partial_interest_transferred),
    Fields.InValid_loan_term_months((SALT33.StrType)le.loan_term_months),
    Fields.InValid_loan_term_years((SALT33.StrType)le.loan_term_years),
    Fields.InValid_lender_name((SALT33.StrType)le.lender_name),
    Fields.InValid_lender_name_id((SALT33.StrType)le.lender_name_id),
    Fields.InValid_lender_dba_aka_name((SALT33.StrType)le.lender_dba_aka_name),
    Fields.InValid_lender_full_street_address((SALT33.StrType)le.lender_full_street_address),
    Fields.InValid_lender_address_unit_number((SALT33.StrType)le.lender_address_unit_number),
    Fields.InValid_lender_address_citystatezip((SALT33.StrType)le.lender_address_citystatezip),
    Fields.InValid_assessment_match_land_use_code((SALT33.StrType)le.assessment_match_land_use_code),
    Fields.InValid_property_use_code((SALT33.StrType)le.property_use_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_condo_code((SALT33.StrType)le.condo_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_timeshare_flag((SALT33.StrType)le.timeshare_flag),
    Fields.InValid_land_lot_size((SALT33.StrType)le.land_lot_size),
    Fields.InValid_hawaii_tct((SALT33.StrType)le.hawaii_tct),
    Fields.InValid_hawaii_condo_cpr_code((SALT33.StrType)le.hawaii_condo_cpr_code),
    Fields.InValid_hawaii_condo_name((SALT33.StrType)le.hawaii_condo_name),
    Fields.InValid_filler_except_hawaii((SALT33.StrType)le.filler_except_hawaii),
    Fields.InValid_rate_change_frequency((SALT33.StrType)le.rate_change_frequency,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_change_index((SALT33.StrType)le.change_index),
    Fields.InValid_adjustable_rate_index((SALT33.StrType)le.adjustable_rate_index,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_adjustable_rate_rider((SALT33.StrType)le.adjustable_rate_rider),
    Fields.InValid_graduated_payment_rider((SALT33.StrType)le.graduated_payment_rider),
    Fields.InValid_balloon_rider((SALT33.StrType)le.balloon_rider),
    Fields.InValid_fixed_step_rate_rider((SALT33.StrType)le.fixed_step_rate_rider,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_condominium_rider((SALT33.StrType)le.condominium_rider),
    Fields.InValid_planned_unit_development_rider((SALT33.StrType)le.planned_unit_development_rider),
    Fields.InValid_rate_improvement_rider((SALT33.StrType)le.rate_improvement_rider),
    Fields.InValid_assumability_rider((SALT33.StrType)le.assumability_rider),
    Fields.InValid_prepayment_rider((SALT33.StrType)le.prepayment_rider),
    Fields.InValid_one_four_family_rider((SALT33.StrType)le.one_four_family_rider),
    Fields.InValid_biweekly_payment_rider((SALT33.StrType)le.biweekly_payment_rider),
    Fields.InValid_second_home_rider((SALT33.StrType)le.second_home_rider),
    Fields.InValid_data_source_code((SALT33.StrType)le.data_source_code),
    Fields.InValid_main_record_id_code((SALT33.StrType)le.main_record_id_code),
    Fields.InValid_addl_name_flag((SALT33.StrType)le.addl_name_flag),
    ...
    Fields.InValid_ln_buyer_mailing_country_code((SALT33.StrType)le.ln_buyer_mailing_country_code),
    Fields.InValid_ln_seller_mailing_country_code((SALT33.StrType)le.ln_seller_mailing_country_code),
    0);
