...
{'edata12-bld.br.seisint.com'	                    //SourceIP			 Remote Server's IP address									
 	,'/danny_temp2/emdeon/'+version
	//+'/'            //SourceDirectory	 Absolute path of directory on Remote Server where files are located                
 	,'t-ignore-terms-lu'                                    //directory_filter   Regular expression filter for files to be sprayed, default = '*'                          
 	...
 	,'thor400_20'                                       //Thor Group name, ex. 'thor_data400' = dataland400, 'thor_dell400' = prod400(default)
