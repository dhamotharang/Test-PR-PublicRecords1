IMPORT SALT311,STD;
EXPORT FName_Low_hygiene(dataset(FName_Low_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    FName_Low_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    FName_Low_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    FName_Low_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    FName_Low_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    FName_Low_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    FName_Low_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    FName_Low_Fields.InValid_city((SALT311.StrType)le.city),
    FName_Low_Fields.InValid_state((SALT311.StrType)le.state),
    FName_Low_Fields.InValid_zip((SALT311.StrType)le.zip),
    FName_Low_Fields.InValid_dob((SALT311.StrType)le.dob),
    FName_Low_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    FName_Low_Fields.InValid_dl((SALT311.StrType)le.dl),
    FName_Low_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    FName_Low_Fields.InValid_phone((SALT311.StrType)le.phone),
    FName_Low_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    FName_Low_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    FName_Low_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    FName_Low_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    FName_Low_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    FName_Low_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := FName_Low_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,FName_Low_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_city(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_state(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_zip(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_dob(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_dl(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_phone(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),FName_Low_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, FName_Low_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
