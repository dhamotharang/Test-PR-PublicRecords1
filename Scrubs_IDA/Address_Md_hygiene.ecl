IMPORT SALT311,STD;
EXPORT Address_Md_hygiene(dataset(Address_Md_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Address_Md_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    Address_Md_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    Address_Md_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    Address_Md_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    Address_Md_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    Address_Md_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    Address_Md_Fields.InValid_city((SALT311.StrType)le.city),
    Address_Md_Fields.InValid_state((SALT311.StrType)le.state),
    Address_Md_Fields.InValid_zip((SALT311.StrType)le.zip),
    Address_Md_Fields.InValid_dob((SALT311.StrType)le.dob),
    Address_Md_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    Address_Md_Fields.InValid_dl((SALT311.StrType)le.dl),
    Address_Md_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    Address_Md_Fields.InValid_phone((SALT311.StrType)le.phone),
    Address_Md_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    Address_Md_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    Address_Md_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    Address_Md_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    Address_Md_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    Address_Md_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Address_Md_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Address_Md_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_city(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_state(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_dob(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_dl(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),Address_Md_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, Address_Md_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
