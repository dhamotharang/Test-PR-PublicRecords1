...
EXPORT Base_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_Rec_ID:ALLOW(0123456789_):LENGTHS(0,18)\n'
    + 'FIELDTYPE:Invalid_Date:CUSTOM(Scrubs_IDA.Functions.Fn_Valid_Date > 0)\n'
    + 'FIELDTYPE:Invalid_FName:SPACES( ):ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ-):LENGTHS(0,2..15):WORDS(0,1)\n'
    + 'FIELDTYPE:Invalid_MName:SPACES( ):ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ.):LENGTHS(0..2):WORDS(0,1)\n'
    + 'FIELDTYPE:Invalid_LName:SPACES( ):ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ.-):LENGTHS(0,2..20):WORDS(0..2)\n'
    ...
    + 'FIELDTYPE:Invalid_NID:LIKE(Invalid_Num):LENGTHS(1,18,19,20)\n'
    ...
    + 'FIELDTYPE:Invalid_Err:LIKE(Invalid_AlphaNum):LENGTHS(0,4)\n'
    + 'FIELDTYPE:Invalid_AID:LIKE(Invalid_Num):LENGTHS(1,12)\n'
    + '\n'
