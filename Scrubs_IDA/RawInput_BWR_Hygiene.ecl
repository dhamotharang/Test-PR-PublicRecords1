...
#workunit('name','Scrubs_IDA.RawInput_BWR_Hygiene - Hygiene & Stats - SALT V3.11.11');
IMPORT Scrubs_IDA,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_IDA.RawInput_In_IDA;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_IDA.RawInput_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'RawInput_Layout_IDA'),NAMED('OptimizedLayout'));// File layout suggested by data
