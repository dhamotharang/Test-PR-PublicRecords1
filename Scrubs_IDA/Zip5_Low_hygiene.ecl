IMPORT SALT311,STD;
EXPORT Zip5_Low_hygiene(dataset(Zip5_Low_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Zip5_Low_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    Zip5_Low_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    Zip5_Low_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    Zip5_Low_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    Zip5_Low_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    Zip5_Low_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    Zip5_Low_Fields.InValid_city((SALT311.StrType)le.city),
    Zip5_Low_Fields.InValid_state((SALT311.StrType)le.state),
    Zip5_Low_Fields.InValid_zip((SALT311.StrType)le.zip),
    Zip5_Low_Fields.InValid_dob((SALT311.StrType)le.dob),
    Zip5_Low_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    Zip5_Low_Fields.InValid_dl((SALT311.StrType)le.dl),
    Zip5_Low_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    Zip5_Low_Fields.InValid_phone((SALT311.StrType)le.phone),
    Zip5_Low_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    Zip5_Low_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    Zip5_Low_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    Zip5_Low_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    Zip5_Low_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    Zip5_Low_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Zip5_Low_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Zip5_Low_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_city(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_state(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_dob(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_dl(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),Zip5_Low_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, Zip5_Low_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
