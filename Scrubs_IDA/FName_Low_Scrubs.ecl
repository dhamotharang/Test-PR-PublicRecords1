...
EXPORT FName_Low_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(FName_Low_Layout_IDA)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(FName_Low_Layout_IDA)
    UNSIGNED8 ScrubsBits1;
  END;
  EXPORT Rule_Layout := RECORD(FName_Low_Layout_IDA)
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ,FName_Low_Fields.InvalidMessage_firstname(1),FName_Low_Fields.InvalidMessage_firstname(2),FName_Low_Fields.InvalidMessage_firstname(3)
          ,FName_Low_Fields.InvalidMessage_middlename(1),FName_Low_Fields.InvalidMessage_middlename(2),FName_Low_Fields.InvalidMessage_middlename(3)
          ,FName_Low_Fields.InvalidMessage_lastname(1),FName_Low_Fields.InvalidMessage_lastname(2),FName_Low_Fields.InvalidMessage_lastname(3)
          ,FName_Low_Fields.InvalidMessage_suffix(1),FName_Low_Fields.InvalidMessage_suffix(2),FName_Low_Fields.InvalidMessage_suffix(3)
          ,FName_Low_Fields.InvalidMessage_addressline1(1),FName_Low_Fields.InvalidMessage_addressline1(2)
          ,FName_Low_Fields.InvalidMessage_addressline2(1),FName_Low_Fields.InvalidMessage_addressline2(2)
          ,FName_Low_Fields.InvalidMessage_city(1),FName_Low_Fields.InvalidMessage_city(2)
          ,FName_Low_Fields.InvalidMessage_state(1)
          ,FName_Low_Fields.InvalidMessage_zip(1),FName_Low_Fields.InvalidMessage_zip(2)
          ,FName_Low_Fields.InvalidMessage_dob(1)
          ,FName_Low_Fields.InvalidMessage_ssn(1),FName_Low_Fields.InvalidMessage_ssn(2),FName_Low_Fields.InvalidMessage_ssn(3)
          ,FName_Low_Fields.InvalidMessage_dl(1)
          ,FName_Low_Fields.InvalidMessage_dlstate(1)
          ,FName_Low_Fields.InvalidMessage_phone(1),FName_Low_Fields.InvalidMessage_phone(2)
          ,FName_Low_Fields.InvalidMessage_phone2(1),FName_Low_Fields.InvalidMessage_phone2(2)
          ,FName_Low_Fields.InvalidMessage_phone3(1)
          ,FName_Low_Fields.InvalidMessage_clientassigneduniquerecordid(1)
          ,FName_Low_Fields.InvalidMessage_emailaddress(1)
          ,FName_Low_Fields.InvalidMessage_ipaddress(1)
          ,'Fields with errors'
...
EXPORT FromNone(DATASET(FName_Low_Layout_IDA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.firstname_Invalid := FName_Low_Fields.InValid_firstname((SALT311.StrType)le.firstname);
    SELF.middlename_Invalid := FName_Low_Fields.InValid_middlename((SALT311.StrType)le.middlename);
    SELF.lastname_Invalid := FName_Low_Fields.InValid_lastname((SALT311.StrType)le.lastname);
    SELF.suffix_Invalid := FName_Low_Fields.InValid_suffix((SALT311.StrType)le.suffix);
    SELF.addressline1_Invalid := FName_Low_Fields.InValid_addressline1((SALT311.StrType)le.addressline1);
    SELF.addressline2_Invalid := FName_Low_Fields.InValid_addressline2((SALT311.StrType)le.addressline2);
    SELF.city_Invalid := FName_Low_Fields.InValid_city((SALT311.StrType)le.city);
    SELF.state_Invalid := FName_Low_Fields.InValid_state((SALT311.StrType)le.state);
    SELF.zip_Invalid := FName_Low_Fields.InValid_zip((SALT311.StrType)le.zip);
    SELF.dob_Invalid := FName_Low_Fields.InValid_dob((SALT311.StrType)le.dob);
    SELF.ssn_Invalid := FName_Low_Fields.InValid_ssn((SALT311.StrType)le.ssn);
    SELF.dl_Invalid := FName_Low_Fields.InValid_dl((SALT311.StrType)le.dl);
    SELF.dlstate_Invalid := FName_Low_Fields.InValid_dlstate((SALT311.StrType)le.dlstate);
    SELF.phone_Invalid := FName_Low_Fields.InValid_phone((SALT311.StrType)le.phone);
    SELF.phone2_Invalid := FName_Low_Fields.InValid_phone2((SALT311.StrType)le.phone2);
    SELF.phone3_Invalid := FName_Low_Fields.InValid_phone3((SALT311.StrType)le.phone3);
    SELF.clientassigneduniquerecordid_Invalid := FName_Low_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid);
    SELF.emailaddress_Invalid := FName_Low_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress);
    SELF.ipaddress_Invalid := FName_Low_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),FName_Low_Layout_IDA);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,FName_Low_Layout_IDA);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,FName_Low_Fields.InvalidMessage_firstname(le.firstname_Invalid),FName_Low_Fields.InvalidMessage_middlename(le.middlename_Invalid),FName_Low_Fields.InvalidMessage_lastname(le.lastname_Invalid),FName_Low_Fields.InvalidMessage_suffix(le.suffix_Invalid),FName_Low_Fields.InvalidMessage_addressline1(le.addressline1_Invalid),FName_Low_Fields.InvalidMessage_addressline2(le.addressline2_Invalid),FName_Low_Fields.InvalidMessage_city(le.city_Invalid),FName_Low_Fields.InvalidMessage_state(le.state_Invalid),FName_Low_Fields.InvalidMessage_zip(le.zip_Invalid),FName_Low_Fields.InvalidMessage_dob(le.dob_Invalid),FName_Low_Fields.InvalidMessage_ssn(le.ssn_Invalid),FName_Low_Fields.InvalidMessage_dl(le.dl_Invalid),FName_Low_Fields.InvalidMessage_dlstate(le.dlstate_Invalid),FName_Low_Fields.InvalidMessage_phone(le.phone_Invalid),FName_Low_Fields.InvalidMessage_phone2(le.phone2_Invalid),FName_Low_Fields.InvalidMessage_phone3(le.phone3_Invalid),FName_Low_Fields.InvalidMessage_clientassigneduniquerecordid(le.clientassigneduniquerecordid_Invalid),FName_Low_Fields.InvalidMessage_emailaddress(le.emailaddress_Invalid),FName_Low_Fields.InvalidMessage_ipaddress(le.ipaddress_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(FName_Low_Layout_IDA) prevDS = DATASET([], FName_Low_Layout_IDA), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    ...
    mod_hygiene := FName_Low_hygiene(PROJECT(h, FName_Low_Layout_IDA));
  ...
  // record count stats
    ...
    mod_Delta := FName_Low_Delta(prevDS, PROJECT(h, FName_Low_Layout_IDA));
...
EXPORT StandardStats(DATASET(FName_Low_Layout_IDA) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;

  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_IDA, FName_Low_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
