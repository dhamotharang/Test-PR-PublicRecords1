IMPORT SALT311,STD;
EXPORT App_Good_hygiene(dataset(App_Good_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    App_Good_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    App_Good_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    App_Good_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    App_Good_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    App_Good_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    App_Good_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    App_Good_Fields.InValid_city((SALT311.StrType)le.city),
    App_Good_Fields.InValid_state((SALT311.StrType)le.state),
    App_Good_Fields.InValid_zip((SALT311.StrType)le.zip),
    App_Good_Fields.InValid_dob((SALT311.StrType)le.dob),
    App_Good_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    App_Good_Fields.InValid_dl((SALT311.StrType)le.dl),
    App_Good_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    App_Good_Fields.InValid_phone((SALT311.StrType)le.phone),
    App_Good_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    App_Good_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    App_Good_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    App_Good_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    App_Good_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    App_Good_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := App_Good_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,App_Good_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_city(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_state(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_zip(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_dob(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_dl(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_phone(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),App_Good_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, App_Good_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
