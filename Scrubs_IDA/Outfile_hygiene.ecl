IMPORT SALT311,STD;
EXPORT Outfile_hygiene(dataset(Outfile_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Outfile_Fields.InValid_persistent_record_id((SALT311.StrType)le.persistent_record_id),
    Outfile_Fields.InValid_src((SALT311.StrType)le.src),
    Outfile_Fields.InValid_dt_first_seen((SALT311.StrType)le.dt_first_seen),
    Outfile_Fields.InValid_dt_last_seen((SALT311.StrType)le.dt_last_seen),
    Outfile_Fields.InValid_dt_vendor_first_reported((SALT311.StrType)le.dt_vendor_first_reported),
    Outfile_Fields.InValid_dt_vendor_last_reported((SALT311.StrType)le.dt_vendor_last_reported),
    Outfile_Fields.InValid_did((SALT311.StrType)le.did),
    Outfile_Fields.InValid_did_score((SALT311.StrType)le.did_score),
    Outfile_Fields.InValid_orig_first_name((SALT311.StrType)le.orig_first_name),
    Outfile_Fields.InValid_orig_middle_name((SALT311.StrType)le.orig_middle_name),
    Outfile_Fields.InValid_orig_last_name((SALT311.StrType)le.orig_last_name),
    Outfile_Fields.InValid_orig_suffix((SALT311.StrType)le.orig_suffix),
    Outfile_Fields.InValid_orig_address1((SALT311.StrType)le.orig_address1),
    Outfile_Fields.InValid_orig_address2((SALT311.StrType)le.orig_address2),
    Outfile_Fields.InValid_orig_city((SALT311.StrType)le.orig_city),
    Outfile_Fields.InValid_orig_state_province((SALT311.StrType)le.orig_state_province),
    Outfile_Fields.InValid_orig_zip4((SALT311.StrType)le.orig_zip4),
    Outfile_Fields.InValid_orig_zip5((SALT311.StrType)le.orig_zip5),
    Outfile_Fields.InValid_orig_dob((SALT311.StrType)le.orig_dob),
    Outfile_Fields.InValid_orig_ssn((SALT311.StrType)le.orig_ssn),
    Outfile_Fields.InValid_orig_dl((SALT311.StrType)le.orig_dl),
    Outfile_Fields.InValid_orig_dlstate((SALT311.StrType)le.orig_dlstate),
    Outfile_Fields.InValid_orig_phone((SALT311.StrType)le.orig_phone),
    Outfile_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    Outfile_Fields.InValid_adl_ind((SALT311.StrType)le.adl_ind),
    Outfile_Fields.InValid_orig_email((SALT311.StrType)le.orig_email),
    Outfile_Fields.InValid_orig_ipaddress((SALT311.StrType)le.orig_ipaddress),
    Outfile_Fields.InValid_orig_filecategory((SALT311.StrType)le.orig_filecategory),
    Outfile_Fields.InValid_title((SALT311.StrType)le.title),
    Outfile_Fields.InValid_fname((SALT311.StrType)le.fname),
    Outfile_Fields.InValid_mname((SALT311.StrType)le.mname),
    Outfile_Fields.InValid_lname((SALT311.StrType)le.lname),
    Outfile_Fields.InValid_name_suffix((SALT311.StrType)le.name_suffix),
    Outfile_Fields.InValid_nid((SALT311.StrType)le.nid),
    Outfile_Fields.InValid_prim_range((SALT311.StrType)le.prim_range),
    Outfile_Fields.InValid_predir((SALT311.StrType)le.predir),
    Outfile_Fields.InValid_prim_name((SALT311.StrType)le.prim_name),
    Outfile_Fields.InValid_addr_suffix((SALT311.StrType)le.addr_suffix),
    Outfile_Fields.InValid_postdir((SALT311.StrType)le.postdir),
    Outfile_Fields.InValid_unit_desig((SALT311.StrType)le.unit_desig),
    Outfile_Fields.InValid_sec_range((SALT311.StrType)le.sec_range),
    Outfile_Fields.InValid_p_city_name((SALT311.StrType)le.p_city_name),
    Outfile_Fields.InValid_v_city_name((SALT311.StrType)le.v_city_name),
    Outfile_Fields.InValid_st((SALT311.StrType)le.st),
    Outfile_Fields.InValid_zip((SALT311.StrType)le.zip),
    Outfile_Fields.InValid_zip4((SALT311.StrType)le.zip4),
    Outfile_Fields.InValid_cart((SALT311.StrType)le.cart),
    Outfile_Fields.InValid_cr_sort_sz((SALT311.StrType)le.cr_sort_sz),
    Outfile_Fields.InValid_lot((SALT311.StrType)le.lot),
    Outfile_Fields.InValid_lot_order((SALT311.StrType)le.lot_order),
    Outfile_Fields.InValid_dbpc((SALT311.StrType)le.dbpc),
    Outfile_Fields.InValid_chk_digit((SALT311.StrType)le.chk_digit),
    Outfile_Fields.InValid_rec_type((SALT311.StrType)le.rec_type),
    Outfile_Fields.InValid_fips_st((SALT311.StrType)le.fips_st),
    Outfile_Fields.InValid_fips_county((SALT311.StrType)le.fips_county),
    Outfile_Fields.InValid_geo_lat((SALT311.StrType)le.geo_lat),
    Outfile_Fields.InValid_geo_long((SALT311.StrType)le.geo_long),
    Outfile_Fields.InValid_msa((SALT311.StrType)le.msa),
    Outfile_Fields.InValid_geo_blk((SALT311.StrType)le.geo_blk),
    Outfile_Fields.InValid_geo_match((SALT311.StrType)le.geo_match),
    Outfile_Fields.InValid_err_stat((SALT311.StrType)le.err_stat),
    Outfile_Fields.InValid_rawaid((SALT311.StrType)le.rawaid),
    Outfile_Fields.InValid_aceaid((SALT311.StrType)le.aceaid),
    Outfile_Fields.InValid_clean_phone((SALT311.StrType)le.clean_phone),
    Outfile_Fields.InValid_clean_dob((SALT311.StrType)le.clean_dob),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Outfile_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Outfile_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_src(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_did(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_did_score(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_first_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_middle_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_last_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_state_province(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_dob(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_ssn(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_dl(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_dlstate(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_phone(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_adl_ind(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_email(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_ipaddress(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_orig_filecategory(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_title(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_fname(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_mname(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_lname(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_nid(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_predir(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_addr_suffix(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_st(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_cart(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_lot(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_dbpc(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_fips_st(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_fips_county(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_msa(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_aceaid(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_clean_phone(TotalErrors.ErrorNum),Outfile_Fields.InValidMessage_clean_dob(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, Outfile_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
