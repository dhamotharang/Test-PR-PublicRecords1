IMPORT SALT311,STD;
EXPORT Homephone_High_hygiene(dataset(Homephone_High_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Homephone_High_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    Homephone_High_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    Homephone_High_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    Homephone_High_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    Homephone_High_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    Homephone_High_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    Homephone_High_Fields.InValid_city((SALT311.StrType)le.city),
    Homephone_High_Fields.InValid_state((SALT311.StrType)le.state),
    Homephone_High_Fields.InValid_zip((SALT311.StrType)le.zip),
    Homephone_High_Fields.InValid_dob((SALT311.StrType)le.dob),
    Homephone_High_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    Homephone_High_Fields.InValid_dl((SALT311.StrType)le.dl),
    Homephone_High_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    Homephone_High_Fields.InValid_phone((SALT311.StrType)le.phone),
    Homephone_High_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    Homephone_High_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    Homephone_High_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    Homephone_High_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    Homephone_High_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    Homephone_High_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Homephone_High_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Homephone_High_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_city(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_state(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_dob(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_dl(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),Homephone_High_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, Homephone_High_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
