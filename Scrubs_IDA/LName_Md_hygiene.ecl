IMPORT SALT311,STD;
EXPORT LName_Md_hygiene(dataset(LName_Md_layout_IDA) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    LName_Md_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    LName_Md_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    LName_Md_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    LName_Md_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    LName_Md_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    LName_Md_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    LName_Md_Fields.InValid_city((SALT311.StrType)le.city),
    LName_Md_Fields.InValid_state((SALT311.StrType)le.state),
    LName_Md_Fields.InValid_zip((SALT311.StrType)le.zip),
    LName_Md_Fields.InValid_dob((SALT311.StrType)le.dob),
    LName_Md_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    LName_Md_Fields.InValid_dl((SALT311.StrType)le.dl),
    LName_Md_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    LName_Md_Fields.InValid_phone((SALT311.StrType)le.phone),
    LName_Md_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    LName_Md_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    LName_Md_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    LName_Md_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    LName_Md_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    LName_Md_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := LName_Md_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,LName_Md_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_city(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_state(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_zip(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_dob(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_dl(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_phone(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),LName_Md_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, LName_Md_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
