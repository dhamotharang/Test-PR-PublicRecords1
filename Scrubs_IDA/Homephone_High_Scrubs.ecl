...
EXPORT Homephone_High_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(Homephone_High_Layout_IDA)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Homephone_High_Layout_IDA)
    UNSIGNED8 ScrubsBits1;
  END;
  EXPORT Rule_Layout := RECORD(Homephone_High_Layout_IDA)
  ...
  SHARED toRuleDesc(UNSIGNED c) := CHOOSE(c
          ...
          ,'suffix:Invalid_Suffix:ALLOW','suffix:Invalid_Suffix:LENGTHS','suffix:Invalid_Suffix:WORDS'
          ...
          ,'phone2:Invalid_Phone2:ALLOW','phone2:Invalid_Phone2:LENGTHS'
          ,'phone3:Invalid_Phone3:CUSTOM'
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ,Homephone_High_Fields.InvalidMessage_firstname(1),Homephone_High_Fields.InvalidMessage_firstname(2),Homephone_High_Fields.InvalidMessage_firstname(3)
          ,Homephone_High_Fields.InvalidMessage_middlename(1),Homephone_High_Fields.InvalidMessage_middlename(2),Homephone_High_Fields.InvalidMessage_middlename(3)
          ,Homephone_High_Fields.InvalidMessage_lastname(1),Homephone_High_Fields.InvalidMessage_lastname(2),Homephone_High_Fields.InvalidMessage_lastname(3)
          ,Homephone_High_Fields.InvalidMessage_suffix(1),Homephone_High_Fields.InvalidMessage_suffix(2),Homephone_High_Fields.InvalidMessage_suffix(3)
          ,Homephone_High_Fields.InvalidMessage_addressline1(1),Homephone_High_Fields.InvalidMessage_addressline1(2)
          ,Homephone_High_Fields.InvalidMessage_addressline2(1),Homephone_High_Fields.InvalidMessage_addressline2(2)
          ,Homephone_High_Fields.InvalidMessage_city(1),Homephone_High_Fields.InvalidMessage_city(2)
          ,Homephone_High_Fields.InvalidMessage_state(1)
          ,Homephone_High_Fields.InvalidMessage_zip(1),Homephone_High_Fields.InvalidMessage_zip(2)
          ,Homephone_High_Fields.InvalidMessage_dob(1)
          ,Homephone_High_Fields.InvalidMessage_ssn(1),Homephone_High_Fields.InvalidMessage_ssn(2),Homephone_High_Fields.InvalidMessage_ssn(3)
          ,Homephone_High_Fields.InvalidMessage_dl(1)
          ,Homephone_High_Fields.InvalidMessage_dlstate(1)
          ,Homephone_High_Fields.InvalidMessage_phone(1),Homephone_High_Fields.InvalidMessage_phone(2)
          ,Homephone_High_Fields.InvalidMessage_phone2(1),Homephone_High_Fields.InvalidMessage_phone2(2)
          ,Homephone_High_Fields.InvalidMessage_phone3(1)
          ,Homephone_High_Fields.InvalidMessage_clientassigneduniquerecordid(1)
          ,Homephone_High_Fields.InvalidMessage_emailaddress(1)
          ,Homephone_High_Fields.InvalidMessage_ipaddress(1)
          ,'Fields with errors'
...
EXPORT FromNone(DATASET(Homephone_High_Layout_IDA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.firstname_Invalid := Homephone_High_Fields.InValid_firstname((SALT311.StrType)le.firstname);
    SELF.middlename_Invalid := Homephone_High_Fields.InValid_middlename((SALT311.StrType)le.middlename);
    SELF.lastname_Invalid := Homephone_High_Fields.InValid_lastname((SALT311.StrType)le.lastname);
    SELF.suffix_Invalid := Homephone_High_Fields.InValid_suffix((SALT311.StrType)le.suffix);
    SELF.addressline1_Invalid := Homephone_High_Fields.InValid_addressline1((SALT311.StrType)le.addressline1);
    SELF.addressline2_Invalid := Homephone_High_Fields.InValid_addressline2((SALT311.StrType)le.addressline2);
    SELF.city_Invalid := Homephone_High_Fields.InValid_city((SALT311.StrType)le.city);
    SELF.state_Invalid := Homephone_High_Fields.InValid_state((SALT311.StrType)le.state);
    SELF.zip_Invalid := Homephone_High_Fields.InValid_zip((SALT311.StrType)le.zip);
    SELF.dob_Invalid := Homephone_High_Fields.InValid_dob((SALT311.StrType)le.dob);
    SELF.ssn_Invalid := Homephone_High_Fields.InValid_ssn((SALT311.StrType)le.ssn);
    SELF.dl_Invalid := Homephone_High_Fields.InValid_dl((SALT311.StrType)le.dl);
    SELF.dlstate_Invalid := Homephone_High_Fields.InValid_dlstate((SALT311.StrType)le.dlstate);
    SELF.phone_Invalid := Homephone_High_Fields.InValid_phone((SALT311.StrType)le.phone);
    SELF.phone2_Invalid := Homephone_High_Fields.InValid_phone2((SALT311.StrType)le.phone2);
    SELF.phone3_Invalid := Homephone_High_Fields.InValid_phone3((SALT311.StrType)le.phone3);
    SELF.clientassigneduniquerecordid_Invalid := Homephone_High_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid);
    SELF.emailaddress_Invalid := Homephone_High_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress);
    SELF.ipaddress_Invalid := Homephone_High_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Homephone_High_Layout_IDA);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.firstname_Invalid << 0 ) + ( le.middlename_Invalid << 2 ) + ( le.lastname_Invalid << 4 ) + ( le.suffix_Invalid << 6 ) + ( le.addressline1_Invalid << 8 ) + ( le.addressline2_Invalid << 10 ) + ( le.city_Invalid << 12 ) + ( le.state_Invalid << 14 ) + ( le.zip_Invalid << 15 ) + ( le.dob_Invalid << 17 ) + ( le.ssn_Invalid << 18 ) + ( le.dl_Invalid << 20 ) + ( le.dlstate_Invalid << 21 ) + ( le.phone_Invalid << 22 ) + ( le.phone2_Invalid << 24 ) + ( le.phone3_Invalid << 26 ) + ( le.clientassigneduniquerecordid_Invalid << 27 ) + ( le.emailaddress_Invalid << 28 ) + ( le.ipaddress_Invalid << 29 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Homephone_High_Layout_IDA);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.phone2_Invalid := (le.ScrubsBits1 >> 24) & 3;
    SELF.phone3_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.clientassigneduniquerecordid_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.emailaddress_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.ipaddress_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    suffix_LENGTHS_ErrorCount := COUNT(GROUP,h.suffix_Invalid=2);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.firstname_Invalid,le.middlename_Invalid,le.lastname_Invalid,le.suffix_Invalid,le.addressline1_Invalid,le.addressline2_Invalid,le.city_Invalid,le.state_Invalid,le.zip_Invalid,le.dob_Invalid,le.ssn_Invalid,le.dl_Invalid,le.dlstate_Invalid,le.phone_Invalid,le.phone2_Invalid,le.phone3_Invalid,le.clientassigneduniquerecordid_Invalid,le.emailaddress_Invalid,le.ipaddress_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Homephone_High_Fields.InvalidMessage_firstname(le.firstname_Invalid),Homephone_High_Fields.InvalidMessage_middlename(le.middlename_Invalid),Homephone_High_Fields.InvalidMessage_lastname(le.lastname_Invalid),Homephone_High_Fields.InvalidMessage_suffix(le.suffix_Invalid),Homephone_High_Fields.InvalidMessage_addressline1(le.addressline1_Invalid),Homephone_High_Fields.InvalidMessage_addressline2(le.addressline2_Invalid),Homephone_High_Fields.InvalidMessage_city(le.city_Invalid),Homephone_High_Fields.InvalidMessage_state(le.state_Invalid),Homephone_High_Fields.InvalidMessage_zip(le.zip_Invalid),Homephone_High_Fields.InvalidMessage_dob(le.dob_Invalid),Homephone_High_Fields.InvalidMessage_ssn(le.ssn_Invalid),Homephone_High_Fields.InvalidMessage_dl(le.dl_Invalid),Homephone_High_Fields.InvalidMessage_dlstate(le.dlstate_Invalid),Homephone_High_Fields.InvalidMessage_phone(le.phone_Invalid),Homephone_High_Fields.InvalidMessage_phone2(le.phone2_Invalid),Homephone_High_Fields.InvalidMessage_phone3(le.phone3_Invalid),Homephone_High_Fields.InvalidMessage_clientassigneduniquerecordid(le.clientassigneduniquerecordid_Invalid),Homephone_High_Fields.InvalidMessage_emailaddress(le.emailaddress_Invalid),Homephone_High_Fields.InvalidMessage_ipaddress(le.ipaddress_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.suffix_Invalid,'ALLOW','LENGTHS','WORDS','UNKNOWN')
    ...
    SELF.FieldName := CHOOSE(c,'firstname','middlename','lastname','suffix','addressline1','addressline2','city','state','zip','dob','ssn','dl','dlstate','phone','phone2','phone3','clientassigneduniquerecordid','emailaddress','ipaddress','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'Invalid_FName','Invalid_MName','Invalid_LName','Invalid_Suffix','Invalid_Address1','Invalid_Address2','Invalid_City','Invalid_State','Invalid_Zip','Invalid_DOB','Invalid_SSN','Invalid_DL','Invalid_State','Invalid_Phone','Invalid_Phone2','Invalid_Phone3','Invalid_Clientassigneduniquerecordid','Invalid_Emailaddress','Invalid_Ipaddress','UNKNOWN');
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Homephone_High_Layout_IDA) prevDS = DATASET([], Homephone_High_Layout_IDA), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.suffix_ALLOW_ErrorCount,le.suffix_LENGTHS_ErrorCount,le.suffix_WORDS_ErrorCount
    ...
    mod_hygiene := Homephone_High_hygiene(PROJECT(h, Homephone_High_Layout_IDA));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'filecategory:' + getFieldTypeText(h.filecategory) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix,'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_filecategory_cnt,0);
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_filecategory_pcnt,0);
      SELF.ErrorMessage := '';
    END;
  ...
  // record count stats
    ...
    mod_Delta := Homephone_High_Delta(prevDS, PROJECT(h, Homephone_High_Layout_IDA));
...
EXPORT StandardStats(DATASET(Homephone_High_Layout_IDA) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;

  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_IDA, Homephone_High_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
