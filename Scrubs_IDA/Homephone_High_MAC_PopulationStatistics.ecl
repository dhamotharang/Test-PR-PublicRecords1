...
EXPORT Homephone_High_MAC_PopulationStatistics(infile,Ref='',Input_firstname = '',Input_middlename = '',Input_lastname = '',Input_suffix = '',Input_addressline1 = '',Input_addressline2 = '',Input_city = '',Input_state = '',Input_zip = '',Input_dob = '',Input_ssn = '',Input_dl = '',Input_dlstate = '',Input_phone = '',Input_phone2 = '',Input_phone3 = '',Input_clientassigneduniquerecordid = '',Input_emailaddress = '',Input_ipaddress = '',Input_filecategory = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_filecategory)='' )
      '' 
    #ELSE
        IF( le.Input_filecategory = (TYPEOF(le.Input_filecategory))'','',':filecategory')
    #END
;
  END;
  #uniquename(op)
