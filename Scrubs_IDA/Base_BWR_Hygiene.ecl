...
#workunit('name','Scrubs_IDA.Base_BWR_Hygiene - Hygiene & Stats - SALT V3.11.11');
IMPORT Scrubs_IDA,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_IDA.Base_In_IDA;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_IDA.Base_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_Layout_IDA'),NAMED('OptimizedLayout'));// File layout suggested by data
