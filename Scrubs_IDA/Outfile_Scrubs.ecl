...
EXPORT Outfile_Scrubs := MODULE

// The module to handle the case where no scrubs exist
  EXPORT NumRules := 110;
  EXPORT NumRulesFromFieldType := 110;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 65;
  EXPORT NumFieldsWithPossibleEdits := 0;
  EXPORT NumRulesWithPossibleEdits := 0;
  EXPORT Expanded_Layout := RECORD(Outfile_Layout_IDA)
    ...
    UNSIGNED1 orig_filecategory_Invalid;
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Outfile_Layout_IDA)
    UNSIGNED8 ScrubsBits1;
    UNSIGNED8 ScrubsBits2;
  END;
  EXPORT Rule_Layout := RECORD(Outfile_Layout_IDA)
  ...
  SHARED toRuleDesc(UNSIGNED c) := CHOOSE(c
          ...
          ,'orig_state_province:Invalid_State:ALLOW','orig_state_province:Invalid_State:LENGTHS'
          ,'orig_zip4:Invalid_Zip:ALLOW','orig_zip4:Invalid_Zip:LENGTHS'
          ,'orig_zip5:Invalid_Zip:ALLOW','orig_zip5:Invalid_Zip:LENGTHS'
          ,'orig_dob:Invalid_DOB:CUSTOM'
          ,'orig_ssn:Invalid_SSN:ALLOW','orig_ssn:Invalid_SSN:LENGTHS'
          ,'orig_dl:Invalid_DL:ALLOW','orig_dl:Invalid_DL:LENGTHS'
          ,'orig_dlstate:Invalid_State:ALLOW','orig_dlstate:Invalid_State:LENGTHS'
          ...
          ,'orig_filecategory:Invalid_Alpha:ALLOW'
          ...
          ,'geo_lat:Invalid_Coor:ALLOW'
          ,'geo_long:Invalid_Coor:ALLOW'
          ,'msa:Invalid_Num:ALLOW'
          ,'geo_blk:Invalid_Coor:ALLOW'
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ,Outfile_Fields.InvalidMessage_persistent_record_id(1),Outfile_Fields.InvalidMessage_persistent_record_id(2)
          ,Outfile_Fields.InvalidMessage_src(1)
          ,Outfile_Fields.InvalidMessage_dt_first_seen(1)
          ,Outfile_Fields.InvalidMessage_dt_last_seen(1)
          ,Outfile_Fields.InvalidMessage_dt_vendor_first_reported(1)
          ,Outfile_Fields.InvalidMessage_dt_vendor_last_reported(1)
          ,Outfile_Fields.InvalidMessage_did(1)
          ,Outfile_Fields.InvalidMessage_did_score(1)
          ,Outfile_Fields.InvalidMessage_orig_first_name(1),Outfile_Fields.InvalidMessage_orig_first_name(2),Outfile_Fields.InvalidMessage_orig_first_name(3)
          ,Outfile_Fields.InvalidMessage_orig_middle_name(1),Outfile_Fields.InvalidMessage_orig_middle_name(2),Outfile_Fields.InvalidMessage_orig_middle_name(3)
          ,Outfile_Fields.InvalidMessage_orig_last_name(1),Outfile_Fields.InvalidMessage_orig_last_name(2),Outfile_Fields.InvalidMessage_orig_last_name(3)
          ,Outfile_Fields.InvalidMessage_orig_suffix(1),Outfile_Fields.InvalidMessage_orig_suffix(2),Outfile_Fields.InvalidMessage_orig_suffix(3)
          ,Outfile_Fields.InvalidMessage_orig_address1(1),Outfile_Fields.InvalidMessage_orig_address1(2)
          ,Outfile_Fields.InvalidMessage_orig_address2(1),Outfile_Fields.InvalidMessage_orig_address2(2)
          ,Outfile_Fields.InvalidMessage_orig_city(1),Outfile_Fields.InvalidMessage_orig_city(2)
          ,Outfile_Fields.InvalidMessage_orig_state_province(1),Outfile_Fields.InvalidMessage_orig_state_province(2)
          ,Outfile_Fields.InvalidMessage_orig_zip4(1),Outfile_Fields.InvalidMessage_orig_zip4(2)
          ,Outfile_Fields.InvalidMessage_orig_zip5(1),Outfile_Fields.InvalidMessage_orig_zip5(2)
          ,Outfile_Fields.InvalidMessage_orig_dob(1)
          ,Outfile_Fields.InvalidMessage_orig_ssn(1),Outfile_Fields.InvalidMessage_orig_ssn(2)
          ,Outfile_Fields.InvalidMessage_orig_dl(1),Outfile_Fields.InvalidMessage_orig_dl(2)
          ,Outfile_Fields.InvalidMessage_orig_dlstate(1),Outfile_Fields.InvalidMessage_orig_dlstate(2)
          ,Outfile_Fields.InvalidMessage_orig_phone(1),Outfile_Fields.InvalidMessage_orig_phone(2)
          ,Outfile_Fields.InvalidMessage_clientassigneduniquerecordid(1),Outfile_Fields.InvalidMessage_clientassigneduniquerecordid(2)
          ,Outfile_Fields.InvalidMessage_adl_ind(1)
          ,Outfile_Fields.InvalidMessage_orig_email(1)
          ,Outfile_Fields.InvalidMessage_orig_ipaddress(1)
          ,Outfile_Fields.InvalidMessage_orig_filecategory(1)
          ,Outfile_Fields.InvalidMessage_title(1),Outfile_Fields.InvalidMessage_title(2),Outfile_Fields.InvalidMessage_title(3)
          ,Outfile_Fields.InvalidMessage_fname(1),Outfile_Fields.InvalidMessage_fname(2),Outfile_Fields.InvalidMessage_fname(3)
          ,Outfile_Fields.InvalidMessage_mname(1),Outfile_Fields.InvalidMessage_mname(2),Outfile_Fields.InvalidMessage_mname(3)
          ,Outfile_Fields.InvalidMessage_lname(1),Outfile_Fields.InvalidMessage_lname(2),Outfile_Fields.InvalidMessage_lname(3)
          ,Outfile_Fields.InvalidMessage_name_suffix(1),Outfile_Fields.InvalidMessage_name_suffix(2),Outfile_Fields.InvalidMessage_name_suffix(3)
          ,Outfile_Fields.InvalidMessage_nid(1),Outfile_Fields.InvalidMessage_nid(2)
          ,Outfile_Fields.InvalidMessage_prim_range(1)
          ,Outfile_Fields.InvalidMessage_predir(1),Outfile_Fields.InvalidMessage_predir(2)
          ,Outfile_Fields.InvalidMessage_prim_name(1),Outfile_Fields.InvalidMessage_prim_name(2)
          ,Outfile_Fields.InvalidMessage_addr_suffix(1),Outfile_Fields.InvalidMessage_addr_suffix(2)
          ,Outfile_Fields.InvalidMessage_postdir(1),Outfile_Fields.InvalidMessage_postdir(2)
          ,Outfile_Fields.InvalidMessage_unit_desig(1),Outfile_Fields.InvalidMessage_unit_desig(2)
          ,Outfile_Fields.InvalidMessage_sec_range(1)
          ,Outfile_Fields.InvalidMessage_p_city_name(1),Outfile_Fields.InvalidMessage_p_city_name(2)
          ,Outfile_Fields.InvalidMessage_v_city_name(1),Outfile_Fields.InvalidMessage_v_city_name(2)
          ,Outfile_Fields.InvalidMessage_st(1),Outfile_Fields.InvalidMessage_st(2)
          ,Outfile_Fields.InvalidMessage_zip(1),Outfile_Fields.InvalidMessage_zip(2)
          ,Outfile_Fields.InvalidMessage_zip4(1),Outfile_Fields.InvalidMessage_zip4(2)
          ,Outfile_Fields.InvalidMessage_cart(1)
          ,Outfile_Fields.InvalidMessage_cr_sort_sz(1)
          ,Outfile_Fields.InvalidMessage_lot(1)
          ,Outfile_Fields.InvalidMessage_lot_order(1)
          ,Outfile_Fields.InvalidMessage_dbpc(1)
          ,Outfile_Fields.InvalidMessage_chk_digit(1)
          ,Outfile_Fields.InvalidMessage_rec_type(1)
          ,Outfile_Fields.InvalidMessage_fips_st(1)
          ,Outfile_Fields.InvalidMessage_fips_county(1)
          ,Outfile_Fields.InvalidMessage_geo_lat(1)
          ,Outfile_Fields.InvalidMessage_geo_long(1)
          ,Outfile_Fields.InvalidMessage_msa(1)
          ,Outfile_Fields.InvalidMessage_geo_blk(1)
          ,Outfile_Fields.InvalidMessage_geo_match(1)
          ,Outfile_Fields.InvalidMessage_err_stat(1),Outfile_Fields.InvalidMessage_err_stat(2)
          ,Outfile_Fields.InvalidMessage_rawaid(1),Outfile_Fields.InvalidMessage_rawaid(2)
          ,Outfile_Fields.InvalidMessage_aceaid(1),Outfile_Fields.InvalidMessage_aceaid(2)
          ,Outfile_Fields.InvalidMessage_clean_phone(1),Outfile_Fields.InvalidMessage_clean_phone(2)
          ,Outfile_Fields.InvalidMessage_clean_dob(1)
          ,'Fields with errors'
...
EXPORT FromNone(DATASET(Outfile_Layout_IDA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.persistent_record_id_Invalid := Outfile_Fields.InValid_persistent_record_id((SALT311.StrType)le.persistent_record_id);
    SELF.src_Invalid := Outfile_Fields.InValid_src((SALT311.StrType)le.src);
    SELF.dt_first_seen_Invalid := Outfile_Fields.InValid_dt_first_seen((SALT311.StrType)le.dt_first_seen);
    SELF.dt_last_seen_Invalid := Outfile_Fields.InValid_dt_last_seen((SALT311.StrType)le.dt_last_seen);
    SELF.dt_vendor_first_reported_Invalid := Outfile_Fields.InValid_dt_vendor_first_reported((SALT311.StrType)le.dt_vendor_first_reported);
    SELF.dt_vendor_last_reported_Invalid := Outfile_Fields.InValid_dt_vendor_last_reported((SALT311.StrType)le.dt_vendor_last_reported);
    SELF.did_Invalid := Outfile_Fields.InValid_did((SALT311.StrType)le.did);
    SELF.did_score_Invalid := Outfile_Fields.InValid_did_score((SALT311.StrType)le.did_score);
    SELF.orig_first_name_Invalid := Outfile_Fields.InValid_orig_first_name((SALT311.StrType)le.orig_first_name);
    SELF.orig_middle_name_Invalid := Outfile_Fields.InValid_orig_middle_name((SALT311.StrType)le.orig_middle_name);
    SELF.orig_last_name_Invalid := Outfile_Fields.InValid_orig_last_name((SALT311.StrType)le.orig_last_name);
    SELF.orig_suffix_Invalid := Outfile_Fields.InValid_orig_suffix((SALT311.StrType)le.orig_suffix);
    SELF.orig_address1_Invalid := Outfile_Fields.InValid_orig_address1((SALT311.StrType)le.orig_address1);
    SELF.orig_address2_Invalid := Outfile_Fields.InValid_orig_address2((SALT311.StrType)le.orig_address2);
    SELF.orig_city_Invalid := Outfile_Fields.InValid_orig_city((SALT311.StrType)le.orig_city);
    SELF.orig_state_province_Invalid := Outfile_Fields.InValid_orig_state_province((SALT311.StrType)le.orig_state_province);
    SELF.orig_zip4_Invalid := Outfile_Fields.InValid_orig_zip4((SALT311.StrType)le.orig_zip4);
    SELF.orig_zip5_Invalid := Outfile_Fields.InValid_orig_zip5((SALT311.StrType)le.orig_zip5);
    SELF.orig_dob_Invalid := Outfile_Fields.InValid_orig_dob((SALT311.StrType)le.orig_dob);
    SELF.orig_ssn_Invalid := Outfile_Fields.InValid_orig_ssn((SALT311.StrType)le.orig_ssn);
    SELF.orig_dl_Invalid := Outfile_Fields.InValid_orig_dl((SALT311.StrType)le.orig_dl);
    SELF.orig_dlstate_Invalid := Outfile_Fields.InValid_orig_dlstate((SALT311.StrType)le.orig_dlstate);
    SELF.orig_phone_Invalid := Outfile_Fields.InValid_orig_phone((SALT311.StrType)le.orig_phone);
    SELF.clientassigneduniquerecordid_Invalid := Outfile_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid);
    SELF.adl_ind_Invalid := Outfile_Fields.InValid_adl_ind((SALT311.StrType)le.adl_ind);
    SELF.orig_email_Invalid := Outfile_Fields.InValid_orig_email((SALT311.StrType)le.orig_email);
    SELF.orig_ipaddress_Invalid := Outfile_Fields.InValid_orig_ipaddress((SALT311.StrType)le.orig_ipaddress);
    SELF.orig_filecategory_Invalid := Outfile_Fields.InValid_orig_filecategory((SALT311.StrType)le.orig_filecategory);
    SELF.title_Invalid := Outfile_Fields.InValid_title((SALT311.StrType)le.title);
    SELF.fname_Invalid := Outfile_Fields.InValid_fname((SALT311.StrType)le.fname);
    SELF.mname_Invalid := Outfile_Fields.InValid_mname((SALT311.StrType)le.mname);
    SELF.lname_Invalid := Outfile_Fields.InValid_lname((SALT311.StrType)le.lname);
    SELF.name_suffix_Invalid := Outfile_Fields.InValid_name_suffix((SALT311.StrType)le.name_suffix);
    SELF.nid_Invalid := Outfile_Fields.InValid_nid((SALT311.StrType)le.nid);
    SELF.prim_range_Invalid := Outfile_Fields.InValid_prim_range((SALT311.StrType)le.prim_range);
    SELF.predir_Invalid := Outfile_Fields.InValid_predir((SALT311.StrType)le.predir);
    SELF.prim_name_Invalid := Outfile_Fields.InValid_prim_name((SALT311.StrType)le.prim_name);
    SELF.addr_suffix_Invalid := Outfile_Fields.InValid_addr_suffix((SALT311.StrType)le.addr_suffix);
    SELF.postdir_Invalid := Outfile_Fields.InValid_postdir((SALT311.StrType)le.postdir);
    SELF.unit_desig_Invalid := Outfile_Fields.InValid_unit_desig((SALT311.StrType)le.unit_desig);
    SELF.sec_range_Invalid := Outfile_Fields.InValid_sec_range((SALT311.StrType)le.sec_range);
    SELF.p_city_name_Invalid := Outfile_Fields.InValid_p_city_name((SALT311.StrType)le.p_city_name);
    SELF.v_city_name_Invalid := Outfile_Fields.InValid_v_city_name((SALT311.StrType)le.v_city_name);
    SELF.st_Invalid := Outfile_Fields.InValid_st((SALT311.StrType)le.st);
    SELF.zip_Invalid := Outfile_Fields.InValid_zip((SALT311.StrType)le.zip);
    SELF.zip4_Invalid := Outfile_Fields.InValid_zip4((SALT311.StrType)le.zip4);
    SELF.cart_Invalid := Outfile_Fields.InValid_cart((SALT311.StrType)le.cart);
    SELF.cr_sort_sz_Invalid := Outfile_Fields.InValid_cr_sort_sz((SALT311.StrType)le.cr_sort_sz);
    SELF.lot_Invalid := Outfile_Fields.InValid_lot((SALT311.StrType)le.lot);
    SELF.lot_order_Invalid := Outfile_Fields.InValid_lot_order((SALT311.StrType)le.lot_order);
    SELF.dbpc_Invalid := Outfile_Fields.InValid_dbpc((SALT311.StrType)le.dbpc);
    SELF.chk_digit_Invalid := Outfile_Fields.InValid_chk_digit((SALT311.StrType)le.chk_digit);
    SELF.rec_type_Invalid := Outfile_Fields.InValid_rec_type((SALT311.StrType)le.rec_type);
    SELF.fips_st_Invalid := Outfile_Fields.InValid_fips_st((SALT311.StrType)le.fips_st);
    SELF.fips_county_Invalid := Outfile_Fields.InValid_fips_county((SALT311.StrType)le.fips_county);
    SELF.geo_lat_Invalid := Outfile_Fields.InValid_geo_lat((SALT311.StrType)le.geo_lat);
    SELF.geo_long_Invalid := Outfile_Fields.InValid_geo_long((SALT311.StrType)le.geo_long);
    SELF.msa_Invalid := Outfile_Fields.InValid_msa((SALT311.StrType)le.msa);
    SELF.geo_blk_Invalid := Outfile_Fields.InValid_geo_blk((SALT311.StrType)le.geo_blk);
    SELF.geo_match_Invalid := Outfile_Fields.InValid_geo_match((SALT311.StrType)le.geo_match);
    SELF.err_stat_Invalid := Outfile_Fields.InValid_err_stat((SALT311.StrType)le.err_stat);
    SELF.rawaid_Invalid := Outfile_Fields.InValid_rawaid((SALT311.StrType)le.rawaid);
    SELF.aceaid_Invalid := Outfile_Fields.InValid_aceaid((SALT311.StrType)le.aceaid);
    SELF.clean_phone_Invalid := Outfile_Fields.InValid_clean_phone((SALT311.StrType)le.clean_phone);
    SELF.clean_dob_Invalid := Outfile_Fields.InValid_clean_dob((SALT311.StrType)le.clean_dob);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Outfile_Layout_IDA);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.persistent_record_id_Invalid << 0 ) + ( le.src_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 3 ) + ( le.dt_last_seen_Invalid << 4 ) + ( le.dt_vendor_first_reported_Invalid << 5 ) + ( le.dt_vendor_last_reported_Invalid << 6 ) + ( le.did_Invalid << 7 ) + ( le.did_score_Invalid << 8 ) + ( le.orig_first_name_Invalid << 9 ) + ( le.orig_middle_name_Invalid << 11 ) + ( le.orig_last_name_Invalid << 13 ) + ( le.orig_suffix_Invalid << 15 ) + ( le.orig_address1_Invalid << 17 ) + ( le.orig_address2_Invalid << 19 ) + ( le.orig_city_Invalid << 21 ) + ( le.orig_state_province_Invalid << 23 ) + ( le.orig_zip4_Invalid << 25 ) + ( le.orig_zip5_Invalid << 27 ) + ( le.orig_dob_Invalid << 29 ) + ( le.orig_ssn_Invalid << 30 ) + ( le.orig_dl_Invalid << 32 ) + ( le.orig_dlstate_Invalid << 34 ) + ( le.orig_phone_Invalid << 36 ) + ( le.clientassigneduniquerecordid_Invalid << 38 ) + ( le.adl_ind_Invalid << 40 ) + ( le.orig_email_Invalid << 41 ) + ( le.orig_ipaddress_Invalid << 42 ) + ( le.orig_filecategory_Invalid << 43 ) + ( le.title_Invalid << 44 ) + ( le.fname_Invalid << 46 ) + ( le.mname_Invalid << 48 ) + ( le.lname_Invalid << 50 ) + ( le.name_suffix_Invalid << 52 ) + ( le.nid_Invalid << 54 ) + ( le.prim_range_Invalid << 56 ) + ( le.predir_Invalid << 57 ) + ( le.prim_name_Invalid << 59 ) + ( le.addr_suffix_Invalid << 61 );
    SELF.ScrubsBits2 := ( le.postdir_Invalid << 0 ) + ( le.unit_desig_Invalid << 2 ) + ( le.sec_range_Invalid << 4 ) + ( le.p_city_name_Invalid << 5 ) + ( le.v_city_name_Invalid << 7 ) + ( le.st_Invalid << 9 ) + ( le.zip_Invalid << 11 ) + ( le.zip4_Invalid << 13 ) + ( le.cart_Invalid << 15 ) + ( le.cr_sort_sz_Invalid << 16 ) + ( le.lot_Invalid << 17 ) + ( le.lot_order_Invalid << 18 ) + ( le.dbpc_Invalid << 19 ) + ( le.chk_digit_Invalid << 20 ) + ( le.rec_type_Invalid << 21 ) + ( le.fips_st_Invalid << 22 ) + ( le.fips_county_Invalid << 23 ) + ( le.geo_lat_Invalid << 24 ) + ( le.geo_long_Invalid << 25 ) + ( le.msa_Invalid << 26 ) + ( le.geo_blk_Invalid << 27 ) + ( le.geo_match_Invalid << 28 ) + ( le.err_stat_Invalid << 29 ) + ( le.rawaid_Invalid << 31 ) + ( le.aceaid_Invalid << 33 ) + ( le.clean_phone_Invalid << 35 ) + ( le.clean_dob_Invalid << 37 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Outfile_Layout_IDA);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.orig_state_province_Invalid := (le.ScrubsBits1 >> 23) & 3;
    SELF.orig_zip4_Invalid := (le.ScrubsBits1 >> 25) & 3;
    SELF.orig_zip5_Invalid := (le.ScrubsBits1 >> 27) & 3;
    SELF.orig_dob_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.orig_ssn_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.orig_dl_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.orig_dlstate_Invalid := (le.ScrubsBits1 >> 34) & 3;
    SELF.orig_phone_Invalid := (le.ScrubsBits1 >> 36) & 3;
    SELF.clientassigneduniquerecordid_Invalid := (le.ScrubsBits1 >> 38) & 3;
    SELF.adl_ind_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.orig_email_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.orig_ipaddress_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.orig_filecategory_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.title_Invalid := (le.ScrubsBits1 >> 44) & 3;
    SELF.fname_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.mname_Invalid := (le.ScrubsBits1 >> 48) & 3;
    SELF.lname_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.name_suffix_Invalid := (le.ScrubsBits1 >> 52) & 3;
    SELF.nid_Invalid := (le.ScrubsBits1 >> 54) & 3;
    SELF.prim_range_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.predir_Invalid := (le.ScrubsBits1 >> 57) & 3;
    SELF.prim_name_Invalid := (le.ScrubsBits1 >> 59) & 3;
    SELF.addr_suffix_Invalid := (le.ScrubsBits1 >> 61) & 3;
    SELF.postdir_Invalid := (le.ScrubsBits2 >> 0) & 3;
    SELF.unit_desig_Invalid := (le.ScrubsBits2 >> 2) & 3;
    SELF.sec_range_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.p_city_name_Invalid := (le.ScrubsBits2 >> 5) & 3;
    SELF.v_city_name_Invalid := (le.ScrubsBits2 >> 7) & 3;
    SELF.st_Invalid := (le.ScrubsBits2 >> 9) & 3;
    SELF.zip_Invalid := (le.ScrubsBits2 >> 11) & 3;
    SELF.zip4_Invalid := (le.ScrubsBits2 >> 13) & 3;
    SELF.cart_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.lot_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.lot_order_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.dbpc_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.chk_digit_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.rec_type_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.fips_st_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.fips_county_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.geo_lat_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.geo_long_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.msa_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.geo_blk_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.geo_match_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.err_stat_Invalid := (le.ScrubsBits2 >> 29) & 3;
    SELF.rawaid_Invalid := (le.ScrubsBits2 >> 31) & 3;
    SELF.aceaid_Invalid := (le.ScrubsBits2 >> 33) & 3;
    SELF.clean_phone_Invalid := (le.ScrubsBits2 >> 35) & 3;
    SELF.clean_dob_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    orig_state_province_ALLOW_ErrorCount := COUNT(GROUP,h.orig_state_province_Invalid=1);
    orig_state_province_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_state_province_Invalid=2);
    orig_state_province_Total_ErrorCount := COUNT(GROUP,h.orig_state_province_Invalid>0);
    ...
    orig_dl_ALLOW_ErrorCount := COUNT(GROUP,h.orig_dl_Invalid=1);
    orig_dl_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_dl_Invalid=2);
    orig_dl_Total_ErrorCount := COUNT(GROUP,h.orig_dl_Invalid>0);
    orig_dlstate_ALLOW_ErrorCount := COUNT(GROUP,h.orig_dlstate_Invalid=1);
    orig_dlstate_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_dlstate_Invalid=2);
    orig_dlstate_Total_ErrorCount := COUNT(GROUP,h.orig_dlstate_Invalid>0);
    ...
    orig_filecategory_ALLOW_ErrorCount := COUNT(GROUP,h.orig_filecategory_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.persistent_record_id_Invalid,le.src_Invalid,le.dt_first_seen_Invalid,le.dt_last_seen_Invalid,le.dt_vendor_first_reported_Invalid,le.dt_vendor_last_reported_Invalid,le.did_Invalid,le.did_score_Invalid,le.orig_first_name_Invalid,le.orig_middle_name_Invalid,le.orig_last_name_Invalid,le.orig_suffix_Invalid,le.orig_address1_Invalid,le.orig_address2_Invalid,le.orig_city_Invalid,le.orig_state_province_Invalid,le.orig_zip4_Invalid,le.orig_zip5_Invalid,le.orig_dob_Invalid,le.orig_ssn_Invalid,le.orig_dl_Invalid,le.orig_dlstate_Invalid,le.orig_phone_Invalid,le.clientassigneduniquerecordid_Invalid,le.adl_ind_Invalid,le.orig_email_Invalid,le.orig_ipaddress_Invalid,le.orig_filecategory_Invalid,le.title_Invalid,le.fname_Invalid,le.mname_Invalid,le.lname_Invalid,le.name_suffix_Invalid,le.nid_Invalid,le.prim_range_Invalid,le.predir_Invalid,le.prim_name_Invalid,le.addr_suffix_Invalid,le.postdir_Invalid,le.unit_desig_Invalid,le.sec_range_Invalid,le.p_city_name_Invalid,le.v_city_name_Invalid,le.st_Invalid,le.zip_Invalid,le.zip4_Invalid,le.cart_Invalid,le.cr_sort_sz_Invalid,le.lot_Invalid,le.lot_order_Invalid,le.dbpc_Invalid,le.chk_digit_Invalid,le.rec_type_Invalid,le.fips_st_Invalid,le.fips_county_Invalid,le.geo_lat_Invalid,le.geo_long_Invalid,le.msa_Invalid,le.geo_blk_Invalid,le.geo_match_Invalid,le.err_stat_Invalid,le.rawaid_Invalid,le.aceaid_Invalid,le.clean_phone_Invalid,le.clean_dob_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Outfile_Fields.InvalidMessage_persistent_record_id(le.persistent_record_id_Invalid),Outfile_Fields.InvalidMessage_src(le.src_Invalid),Outfile_Fields.InvalidMessage_dt_first_seen(le.dt_first_seen_Invalid),Outfile_Fields.InvalidMessage_dt_last_seen(le.dt_last_seen_Invalid),Outfile_Fields.InvalidMessage_dt_vendor_first_reported(le.dt_vendor_first_reported_Invalid),Outfile_Fields.InvalidMessage_dt_vendor_last_reported(le.dt_vendor_last_reported_Invalid),Outfile_Fields.InvalidMessage_did(le.did_Invalid),Outfile_Fields.InvalidMessage_did_score(le.did_score_Invalid),Outfile_Fields.InvalidMessage_orig_first_name(le.orig_first_name_Invalid),Outfile_Fields.InvalidMessage_orig_middle_name(le.orig_middle_name_Invalid),Outfile_Fields.InvalidMessage_orig_last_name(le.orig_last_name_Invalid),Outfile_Fields.InvalidMessage_orig_suffix(le.orig_suffix_Invalid),Outfile_Fields.InvalidMessage_orig_address1(le.orig_address1_Invalid),Outfile_Fields.InvalidMessage_orig_address2(le.orig_address2_Invalid),Outfile_Fields.InvalidMessage_orig_city(le.orig_city_Invalid),Outfile_Fields.InvalidMessage_orig_state_province(le.orig_state_province_Invalid),Outfile_Fields.InvalidMessage_orig_zip4(le.orig_zip4_Invalid),Outfile_Fields.InvalidMessage_orig_zip5(le.orig_zip5_Invalid),Outfile_Fields.InvalidMessage_orig_dob(le.orig_dob_Invalid),Outfile_Fields.InvalidMessage_orig_ssn(le.orig_ssn_Invalid),Outfile_Fields.InvalidMessage_orig_dl(le.orig_dl_Invalid),Outfile_Fields.InvalidMessage_orig_dlstate(le.orig_dlstate_Invalid),Outfile_Fields.InvalidMessage_orig_phone(le.orig_phone_Invalid),Outfile_Fields.InvalidMessage_clientassigneduniquerecordid(le.clientassigneduniquerecordid_Invalid),Outfile_Fields.InvalidMessage_adl_ind(le.adl_ind_Invalid),Outfile_Fields.InvalidMessage_orig_email(le.orig_email_Invalid),Outfile_Fields.InvalidMessage_orig_ipaddress(le.orig_ipaddress_Invalid),Outfile_Fields.InvalidMessage_orig_filecategory(le.orig_filecategory_Invalid),Outfile_Fields.InvalidMessage_title(le.title_Invalid),Outfile_Fields.InvalidMessage_fname(le.fname_Invalid),Outfile_Fields.InvalidMessage_mname(le.mname_Invalid),Outfile_Fields.InvalidMessage_lname(le.lname_Invalid),Outfile_Fields.InvalidMessage_name_suffix(le.name_suffix_Invalid),Outfile_Fields.InvalidMessage_nid(le.nid_Invalid),Outfile_Fields.InvalidMessage_prim_range(le.prim_range_Invalid),Outfile_Fields.InvalidMessage_predir(le.predir_Invalid),Outfile_Fields.InvalidMessage_prim_name(le.prim_name_Invalid),Outfile_Fields.InvalidMessage_addr_suffix(le.addr_suffix_Invalid),Outfile_Fields.InvalidMessage_postdir(le.postdir_Invalid),Outfile_Fields.InvalidMessage_unit_desig(le.unit_desig_Invalid),Outfile_Fields.InvalidMessage_sec_range(le.sec_range_Invalid),Outfile_Fields.InvalidMessage_p_city_name(le.p_city_name_Invalid),Outfile_Fields.InvalidMessage_v_city_name(le.v_city_name_Invalid),Outfile_Fields.InvalidMessage_st(le.st_Invalid),Outfile_Fields.InvalidMessage_zip(le.zip_Invalid),Outfile_Fields.InvalidMessage_zip4(le.zip4_Invalid),Outfile_Fields.InvalidMessage_cart(le.cart_Invalid),Outfile_Fields.InvalidMessage_cr_sort_sz(le.cr_sort_sz_Invalid),Outfile_Fields.InvalidMessage_lot(le.lot_Invalid),Outfile_Fields.InvalidMessage_lot_order(le.lot_order_Invalid),Outfile_Fields.InvalidMessage_dbpc(le.dbpc_Invalid),Outfile_Fields.InvalidMessage_chk_digit(le.chk_digit_Invalid),Outfile_Fields.InvalidMessage_rec_type(le.rec_type_Invalid),Outfile_Fields.InvalidMessage_fips_st(le.fips_st_Invalid),Outfile_Fields.InvalidMessage_fips_county(le.fips_county_Invalid),Outfile_Fields.InvalidMessage_geo_lat(le.geo_lat_Invalid),Outfile_Fields.InvalidMessage_geo_long(le.geo_long_Invalid),Outfile_Fields.InvalidMessage_msa(le.msa_Invalid),Outfile_Fields.InvalidMessage_geo_blk(le.geo_blk_Invalid),Outfile_Fields.InvalidMessage_geo_match(le.geo_match_Invalid),Outfile_Fields.InvalidMessage_err_stat(le.err_stat_Invalid),Outfile_Fields.InvalidMessage_rawaid(le.rawaid_Invalid),Outfile_Fields.InvalidMessage_aceaid(le.aceaid_Invalid),Outfile_Fields.InvalidMessage_clean_phone(le.clean_phone_Invalid),Outfile_Fields.InvalidMessage_clean_dob(le.clean_dob_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.orig_state_province_Invalid,'ALLOW','LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_dl_Invalid,'ALLOW','LENGTHS','UNKNOWN')
          ,CHOOSE(le.orig_dlstate_Invalid,'ALLOW','LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_filecategory_Invalid,'ALLOW','UNKNOWN')
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.orig_state_province_ALLOW_ErrorCount,le.orig_state_province_LENGTHS_ErrorCount
          ...
          ,le.orig_dl_ALLOW_ErrorCount,le.orig_dl_LENGTHS_ErrorCount
          ,le.orig_dlstate_ALLOW_ErrorCount,le.orig_dlstate_LENGTHS_ErrorCount
          ...
          ,le.orig_filecategory_ALLOW_ErrorCount
    ...
    mod_hygiene := Outfile_hygiene(PROJECT(h, Outfile_Layout_IDA));
  ...
  // record count stats
    ...
    mod_Delta := Outfile_Delta(prevDS, PROJECT(h, Outfile_Layout_IDA));
...
EXPORT StandardStats(DATASET(Outfile_Layout_IDA) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;

  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_IDA, Outfile_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
