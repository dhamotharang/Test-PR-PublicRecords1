...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(App_Poor_Layout_IDA)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(App_Poor_Layout_IDA)
    UNSIGNED8 ScrubsBits1;
  END;
  EXPORT Rule_Layout := RECORD(App_Poor_Layout_IDA)
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ,App_Poor_Fields.InvalidMessage_firstname(1),App_Poor_Fields.InvalidMessage_firstname(2),App_Poor_Fields.InvalidMessage_firstname(3)
          ,App_Poor_Fields.InvalidMessage_middlename(1),App_Poor_Fields.InvalidMessage_middlename(2),App_Poor_Fields.InvalidMessage_middlename(3)
          ,App_Poor_Fields.InvalidMessage_lastname(1),App_Poor_Fields.InvalidMessage_lastname(2),App_Poor_Fields.InvalidMessage_lastname(3)
          ,App_Poor_Fields.InvalidMessage_suffix(1),App_Poor_Fields.InvalidMessage_suffix(2),App_Poor_Fields.InvalidMessage_suffix(3)
          ,App_Poor_Fields.InvalidMessage_addressline1(1),App_Poor_Fields.InvalidMessage_addressline1(2)
          ,App_Poor_Fields.InvalidMessage_addressline2(1),App_Poor_Fields.InvalidMessage_addressline2(2)
          ,App_Poor_Fields.InvalidMessage_city(1),App_Poor_Fields.InvalidMessage_city(2)
          ,App_Poor_Fields.InvalidMessage_state(1)
          ,App_Poor_Fields.InvalidMessage_zip(1),App_Poor_Fields.InvalidMessage_zip(2)
          ,App_Poor_Fields.InvalidMessage_dob(1)
          ,App_Poor_Fields.InvalidMessage_ssn(1),App_Poor_Fields.InvalidMessage_ssn(2),App_Poor_Fields.InvalidMessage_ssn(3)
          ,App_Poor_Fields.InvalidMessage_dl(1)
          ,App_Poor_Fields.InvalidMessage_dlstate(1)
          ,App_Poor_Fields.InvalidMessage_phone(1),App_Poor_Fields.InvalidMessage_phone(2)
          ,App_Poor_Fields.InvalidMessage_phone2(1),App_Poor_Fields.InvalidMessage_phone2(2)
          ,App_Poor_Fields.InvalidMessage_phone3(1)
          ,App_Poor_Fields.InvalidMessage_clientassigneduniquerecordid(1)
          ,App_Poor_Fields.InvalidMessage_emailaddress(1)
          ,App_Poor_Fields.InvalidMessage_ipaddress(1)
          ,'Fields with errors'
...
EXPORT FromNone(DATASET(App_Poor_Layout_IDA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.firstname_Invalid := App_Poor_Fields.InValid_firstname((SALT311.StrType)le.firstname);
    SELF.middlename_Invalid := App_Poor_Fields.InValid_middlename((SALT311.StrType)le.middlename);
    SELF.lastname_Invalid := App_Poor_Fields.InValid_lastname((SALT311.StrType)le.lastname);
    SELF.suffix_Invalid := App_Poor_Fields.InValid_suffix((SALT311.StrType)le.suffix);
    SELF.addressline1_Invalid := App_Poor_Fields.InValid_addressline1((SALT311.StrType)le.addressline1);
    SELF.addressline2_Invalid := App_Poor_Fields.InValid_addressline2((SALT311.StrType)le.addressline2);
    SELF.city_Invalid := App_Poor_Fields.InValid_city((SALT311.StrType)le.city);
    SELF.state_Invalid := App_Poor_Fields.InValid_state((SALT311.StrType)le.state);
    SELF.zip_Invalid := App_Poor_Fields.InValid_zip((SALT311.StrType)le.zip);
    SELF.dob_Invalid := App_Poor_Fields.InValid_dob((SALT311.StrType)le.dob);
    SELF.ssn_Invalid := App_Poor_Fields.InValid_ssn((SALT311.StrType)le.ssn);
    SELF.dl_Invalid := App_Poor_Fields.InValid_dl((SALT311.StrType)le.dl);
    SELF.dlstate_Invalid := App_Poor_Fields.InValid_dlstate((SALT311.StrType)le.dlstate);
    SELF.phone_Invalid := App_Poor_Fields.InValid_phone((SALT311.StrType)le.phone);
    SELF.phone2_Invalid := App_Poor_Fields.InValid_phone2((SALT311.StrType)le.phone2);
    SELF.phone3_Invalid := App_Poor_Fields.InValid_phone3((SALT311.StrType)le.phone3);
    SELF.clientassigneduniquerecordid_Invalid := App_Poor_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid);
    SELF.emailaddress_Invalid := App_Poor_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress);
    SELF.ipaddress_Invalid := App_Poor_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),App_Poor_Layout_IDA);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,App_Poor_Layout_IDA);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,App_Poor_Fields.InvalidMessage_firstname(le.firstname_Invalid),App_Poor_Fields.InvalidMessage_middlename(le.middlename_Invalid),App_Poor_Fields.InvalidMessage_lastname(le.lastname_Invalid),App_Poor_Fields.InvalidMessage_suffix(le.suffix_Invalid),App_Poor_Fields.InvalidMessage_addressline1(le.addressline1_Invalid),App_Poor_Fields.InvalidMessage_addressline2(le.addressline2_Invalid),App_Poor_Fields.InvalidMessage_city(le.city_Invalid),App_Poor_Fields.InvalidMessage_state(le.state_Invalid),App_Poor_Fields.InvalidMessage_zip(le.zip_Invalid),App_Poor_Fields.InvalidMessage_dob(le.dob_Invalid),App_Poor_Fields.InvalidMessage_ssn(le.ssn_Invalid),App_Poor_Fields.InvalidMessage_dl(le.dl_Invalid),App_Poor_Fields.InvalidMessage_dlstate(le.dlstate_Invalid),App_Poor_Fields.InvalidMessage_phone(le.phone_Invalid),App_Poor_Fields.InvalidMessage_phone2(le.phone2_Invalid),App_Poor_Fields.InvalidMessage_phone3(le.phone3_Invalid),App_Poor_Fields.InvalidMessage_clientassigneduniquerecordid(le.clientassigneduniquerecordid_Invalid),App_Poor_Fields.InvalidMessage_emailaddress(le.emailaddress_Invalid),App_Poor_Fields.InvalidMessage_ipaddress(le.ipaddress_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(App_Poor_Layout_IDA) prevDS = DATASET([], App_Poor_Layout_IDA), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    ...
    mod_hygiene := App_Poor_hygiene(PROJECT(h, App_Poor_Layout_IDA));
  ...
  // record count stats
    ...
    mod_Delta := App_Poor_Delta(prevDS, PROJECT(h, App_Poor_Layout_IDA));
...
EXPORT StandardStats(DATASET(App_Poor_Layout_IDA) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;

  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_IDA, App_Poor_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
