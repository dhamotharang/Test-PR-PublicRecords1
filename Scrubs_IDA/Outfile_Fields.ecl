...
EXPORT Outfile_Fields := MODULE

EXPORT NumFields := 65;

// Processing for each FieldType
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Num','Invalid_Alpha','Invalid_AlphaNum','Invalid_Rec_ID','Invalid_Date','Invalid_FName','Invalid_MName','Invalid_LName','Invalid_Suffix','Invalid_Title','Invalid_Address1','Invalid_Address2','Invalid_City','Invalid_State','Invalid_Zip','Invalid_Zip4','Invalid_DOB','Invalid_SSN','Invalid_DL','Invalid_Phone','Invalid_Clientassigneduniquerecordid','Invalid_Emailaddress','Invalid_Ipaddress','Invalid_NID','Invalid_Dir','Invalid_Add','Invalid_Add_Suff','Invalid_Coor','Invalid_Err','Invalid_AID');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'Invalid_Num' => 1,'Invalid_Alpha' => 2,'Invalid_AlphaNum' => 3,'Invalid_Rec_ID' => 4,'Invalid_Date' => 5,'Invalid_FName' => 6,'Invalid_MName' => 7,'Invalid_LName' => 8,'Invalid_Suffix' => 9,'Invalid_Title' => 10,'Invalid_Address1' => 11,'Invalid_Address2' => 12,'Invalid_City' => 13,'Invalid_State' => 14,'Invalid_Zip' => 15,'Invalid_Zip4' => 16,'Invalid_DOB' => 17,'Invalid_SSN' => 18,'Invalid_DL' => 19,'Invalid_Phone' => 20,'Invalid_Clientassigneduniquerecordid' => 21,'Invalid_Emailaddress' => 22,'Invalid_Ipaddress' => 23,'Invalid_NID' => 24,'Invalid_Dir' => 25,'Invalid_Add' => 26,'Invalid_Add_Suff' => 27,'Invalid_Coor' => 28,'Invalid_Err' => 29,'Invalid_AID' => 30,0);
...
EXPORT MakeFT_Invalid_DOB(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_DOB(SALT311.StrType s) := WHICH(~Scrubs.Fn_valid_pastdate(s)>0);
EXPORT InValidMessageFT_Invalid_DOB(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs.Fn_valid_pastdate'),SALT311.HygieneErrors.Good);
...
END;
EXPORT InValidFT_Invalid_DL(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) >= 4 AND LENGTH(TRIM(s)) <= 12));
EXPORT InValidMessageFT_Invalid_DL(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT311.HygieneErrors.NotLength('0,4..12'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_Coor(SALT311.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Coor(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789.-'))));
EXPORT InValidMessageFT_Invalid_Coor(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789.-'),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','LENGTHS'],['ALLOW'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ALLOW'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['ALLOW','WORDS'],['ALLOW','WORDS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['CUSTOM'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS','WORDS'],['ALLOW','LENGTHS'],['ALLOW'],['ALLOW','LENGTHS'],['ALLOW','WORDS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW'],['ALLOW','WORDS'],['ALLOW','WORDS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['ALLOW','LENGTHS'],['CUSTOM'],[]);
...
EXPORT Make_orig_filecategory(SALT311.StrType s0) := MakeFT_Invalid_Alpha(s0);
EXPORT InValid_orig_filecategory(SALT311.StrType s) := InValidFT_Invalid_Alpha(s);
EXPORT InValidMessage_orig_filecategory(UNSIGNED1 wh) := InValidMessageFT_Invalid_Alpha(wh);
...
EXPORT Make_geo_blk(SALT311.StrType s0) := MakeFT_Invalid_Coor(s0);
EXPORT InValid_geo_blk(SALT311.StrType s) := InValidFT_Invalid_Coor(s);
EXPORT InValidMessage_geo_blk(UNSIGNED1 wh) := InValidMessageFT_Invalid_Coor(wh);
...
EXPORT Make_clean_dob(SALT311.StrType s0) := MakeFT_Invalid_DOB(s0);
EXPORT InValid_clean_dob(SALT311.StrType s) := InValidFT_Invalid_DOB(s);
EXPORT InValidMessage_clean_dob(UNSIGNED1 wh) := InValidMessageFT_Invalid_DOB(wh);
