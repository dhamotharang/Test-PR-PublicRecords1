...
IMPORT SALT311;
EXPORT Homephone_High_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Homephone_High';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,firstname,middlename,lastname,suffix,addressline1,addressline2,city,state,zip,dob,ssn,dl,dlstate,phone,phone2,phone3,clientassigneduniquerecordid,emailaddress,ipaddress,filecategory';
