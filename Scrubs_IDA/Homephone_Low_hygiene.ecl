IMPORT SALT311,STD;
EXPORT Homephone_Low_hygiene(dataset(Homephone_Low_layout_IDA) h) := MODULE
...
SHARED FldIds := DATASET([{1,'firstname'}
      ...
      ,{15,'phone2'}
      ,{16,'phone3'}
      ,{17,'clientassigneduniquerecordid'}
      ,{18,'emailaddress'}
      ,{19,'ipaddress'}
      ,{20,'filecategory'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Homephone_Low_Fields.InValid_firstname((SALT311.StrType)le.firstname),
    Homephone_Low_Fields.InValid_middlename((SALT311.StrType)le.middlename),
    Homephone_Low_Fields.InValid_lastname((SALT311.StrType)le.lastname),
    Homephone_Low_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    Homephone_Low_Fields.InValid_addressline1((SALT311.StrType)le.addressline1),
    Homephone_Low_Fields.InValid_addressline2((SALT311.StrType)le.addressline2),
    Homephone_Low_Fields.InValid_city((SALT311.StrType)le.city),
    Homephone_Low_Fields.InValid_state((SALT311.StrType)le.state),
    Homephone_Low_Fields.InValid_zip((SALT311.StrType)le.zip),
    Homephone_Low_Fields.InValid_dob((SALT311.StrType)le.dob),
    Homephone_Low_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    Homephone_Low_Fields.InValid_dl((SALT311.StrType)le.dl),
    Homephone_Low_Fields.InValid_dlstate((SALT311.StrType)le.dlstate),
    Homephone_Low_Fields.InValid_phone((SALT311.StrType)le.phone),
    Homephone_Low_Fields.InValid_phone2((SALT311.StrType)le.phone2),
    Homephone_Low_Fields.InValid_phone3((SALT311.StrType)le.phone3),
    Homephone_Low_Fields.InValid_clientassigneduniquerecordid((SALT311.StrType)le.clientassigneduniquerecordid),
    Homephone_Low_Fields.InValid_emailaddress((SALT311.StrType)le.emailaddress),
    Homephone_Low_Fields.InValid_ipaddress((SALT311.StrType)le.ipaddress),
    Homephone_Low_Fields.InValid_filecategory((SALT311.StrType)le.filecategory),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Homephone_Low_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_FName','Invalid_MName','Invalid_LName','Invalid_Suffix','Invalid_Address1','Invalid_Address2','Invalid_City','Invalid_State','Invalid_Zip','Invalid_DOB','Invalid_SSN','Invalid_DL','Invalid_State','Invalid_Phone','Invalid_Phone2','Invalid_Phone3','Invalid_Clientassigneduniquerecordid','Invalid_Emailaddress','Invalid_Ipaddress','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Homephone_Low_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_addressline1(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_addressline2(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_city(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_state(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_dob(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_dl(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_phone2(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_phone3(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_clientassigneduniquerecordid(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_emailaddress(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_ipaddress(TotalErrors.ErrorNum),Homephone_Low_Fields.InValidMessage_filecategory(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_IDA, Homephone_Low_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
