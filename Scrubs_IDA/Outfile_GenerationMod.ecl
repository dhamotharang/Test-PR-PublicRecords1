...
IMPORT SALT311;
EXPORT Outfile_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_Rec_ID:ALLOW(0123456789_):LENGTHS(18)\n'
    + 'FIELDTYPE:Invalid_Date:CUSTOM(Scrubs.Fn_valid_pastdate > 0)\n'
    + 'FIELDTYPE:Invalid_FName:SPACES( ):LIKE(Invalid_Alpha):LENGTHS(2..15):WORDS(0,1)\n'
    + 'FIELDTYPE:Invalid_MName:SPACES(. ):LIKE(Invalid_Alpha):LENGTHS(0..2):WORDS(0,1)\n'
    ...
    + 'FIELDTYPE:Invalid_DOB:CUSTOM(Scrubs.Fn_valid_pastdate > 0)\n'
    + 'FIELDTYPE:Invalid_SSN:LIKE(Invalid_Num):LENGTHS(0,9)\n'
    + 'FIELDTYPE:Invalid_DL:LIKE(Invalid_AlphaNum):LENGTHS(0,4..12)\n'
    ...
    + 'FIELDTYPE:Invalid_Coor:ALLOW(0123456789.-)\n'
    ...
    + 'FIELD:orig_dob:TYPE(UNSIGNED4):LIKE(Invalid_DOB):0,0\n'
    ...
    + 'FIELD:orig_filecategory:TYPE(STRING20):LIKE(Invalid_Alpha):0,0\n'
    ...
    + 'FIELD:geo_blk:TYPE(STRING7):LIKE(Invalid_Coor):0,0\n'
    ...
    + 'FIELD:clean_dob:TYPE(STRING8):LIKE(Invalid_DOB):0,0\n'
    ;
