...
EXPORT SALT_Profile_Run_Everything(RawInputDataset, FileName = '', UIDField = '', SourceField = '', HPCCFileName = '') := FUNCTIONMACRO
    ...
    IF(HPCCFileName = '', OUTPUT(CHOOSEN(SALTFullProfile, 2000), NAMED('Full_Profile_Results_' + FileName)), OUTPUT(SALTFullProfile,, HPCCFileName, THOR, OVERWRITE));
