...
EXPORT institution_name_full_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT institution_name_abbreviated_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT street_address_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT city_town_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT mail_address_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT mail_city_town_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT branch_office_name_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
EXPORT routing_number_type_Force := 0; // Wordbags have an implicit FORCE(0) when asking 'does it match'
END;
