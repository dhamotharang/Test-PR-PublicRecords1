#workunit('name', 'ChargeBackDefender__Daily_Score_Monitor');
...
emailBody := 
'Charge Back Defender Point Daily Score Monitor' + '\n' +
'========================\n' +
...
potentialProblems(Percent_Scored_Between_300_350, 'Percent_Scored_Between_300_350', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_351_400, 'Percent_Scored_Between_351_400', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_401_450, 'Percent_Scored_Between_401_450', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_451_500, 'Percent_Scored_Between_451_500', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_501_550, 'Percent_Scored_Between_501_550', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_551_600, 'Percent_Scored_Between_551_600', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_601_650, 'Percent_Scored_Between_601_650', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_651_700, 'Percent_Scored_Between_651_700', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_701_750, 'Percent_Scored_Between_701_750', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
potentialProblems(Percent_Scored_Between_751_900, 'Percent_Scored_Between_751_900', Risk_Reporting.Constants.ThreshChargeBackDefenderScoreBuckets) +
...
subject := 'Charge Back Defender Daily Score Monitor';

FileServices.SendEmail(Risk_Reporting.Constants.emailv2ChargeBackDefenderReportsTo, subject,
																		emailBody,
																		GETENV('SMTPserver'),
