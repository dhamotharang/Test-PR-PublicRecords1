import riskwise, AML, Risk_Indicators;

/* ********************************************************
***********************************************************
** This is a snapshot of the BtSt Shell as of 8/21/2015  **
** -- Contains up to Shell 5.0                           **
...
export Layout_Boca_Shell_BtSt := record
	...
	integer btst_cbd_inq_ver_count       := 0; //has to be integer to house -1
	boolean st_addr_is_bt_business_addr ; //Tell Eric I changed
	unsigned2 btst_economic_trajectory     := 0;
	Risk_Indicators.Layout_BocaShell_BtSt.AdditionalInquiryInsights;	
	Risk_Indicators.Layout_BocaShell_BtSt.AdditionalCommercialInsights;

	//CBD 5.0 Appendix A
	unsigned2 btst_did_summary            := 0;   
	// unsigned2 btst_closest_association    := 0; 
	Risk_Indicators.Layout_BocaShell_BtSt.relative_rec ;
	unsigned2 btst_businesses_in_common   := 0;   
	unsigned2 btst_property_deeds_in_common	 := 0;   
	unsigned2 btst_addrs_in_common        := 0;            
	unsigned2 btst_owned_addrs_in_common  := 0;            
	unsigned2 btst_lres_in_common         := 0;             
	unsigned2 btst_addr_dists_in_common   := 0;             
	unsigned2 btst_addr_states_in_common  := 0;             
	unsigned2 btst_phones_in_common       := 0;             
	unsigned2 btst_landlines_in_common    := 0;             
	unsigned2 btst_cellphones_in_common   := 0;             
	unsigned2 btst_last_names_in_common   := 0;             
	unsigned2 btst_emails_in_common       := 0;             
	unsigned2 btst_free_emails_in_common  := 0;             
	unsigned2 btst_isp_emails_in_common   := 0;             
	unsigned2 btst_edu_emails_in_common   := 0;            
	unsigned2 btst_corp_emails_in_common  := 0;             
	unsigned2 bt_phone_found_on_st_inq_count       := 0;
	unsigned2 bt_addr_found_on_st_inq_count             := 0;
	unsigned2 bt_ssn_found_on_st_inq_count              := 0;
	unsigned2 st_phone_found_on_bt_inq_count            := 0;
	unsigned2 st_addr_found_on_bt_inq_count             := 0;
	unsigned2 st_ssn_found_on_bt_inq_count              := 0;
	unsigned2 bt_phone_found_on_st_inq_auto_count       := 0;
	unsigned2 bt_addr_found_on_st_inq_auto_count        := 0;
	unsigned2 bt_ssn_found_on_st_inq_auto_count         := 0;
	unsigned2 st_phone_found_on_bt_inq_auto_count       := 0;
	unsigned2 st_addr_found_on_bt_inq_auto_count        := 0;
	unsigned2 st_ssn_found_on_bt_inq_auto_count         := 0;
	unsigned2 bt_phone_found_on_st_inq_banking_count    := 0;
	unsigned2 bt_addr_found_on_st_inq_banking_count     := 0;
	unsigned2 bt_ssn_found_on_st_inq_banking_count      := 0;
	unsigned2 st_phone_found_on_bt_inq_banking_count    := 0;
	unsigned2 st_addr_found_on_bt_inq_banking_count     := 0;
	unsigned2 st_ssn_found_on_bt_inq_banking_count      := 0;
	unsigned2 bt_phone_found_on_st_inq_Collection_count := 0;
	unsigned2 bt_addr_found_on_st_inq_Collection_count := 0;
	unsigned2 bt_ssn_found_on_st_inq_Collection_count  := 0;
	unsigned2 st_phone_found_on_bt_inq_Collection_count:= 0;
	unsigned2 st_addr_found_on_bt_inq_Collection_count:= 0;
	unsigned2 st_ssn_found_on_bt_inq_Collection_count := 0;
	unsigned2 bt_phone_found_on_st_inq_Mortgage_count := 0;
	unsigned2 bt_addr_found_on_st_inq_Mortgage_count  := 0;
	unsigned2 bt_ssn_found_on_st_inq_Mortgage_count   := 0;
	unsigned2 st_phone_found_on_bt_inq_Mortgage_count := 0;
	unsigned2 st_addr_found_on_bt_inq_Mortgage_count  := 0;
	unsigned2 st_ssn_found_on_bt_inq_Mortgage_count   := 0;
	unsigned2 bt_phone_found_on_st_inq_HighRiskCredit_count:= 0; 
	unsigned2 bt_addr_found_on_st_inq_HighRiskCredit_count := 0;
	unsigned2 bt_ssn_found_on_st_inq_HighRiskCredit_count  := 0;
	unsigned2 st_phone_found_on_bt_inq_HighRiskCredit_count:= 0;
	unsigned2 st_addr_found_on_bt_inq_HighRiskCredit_count := 0;
	unsigned2 st_ssn_found_on_bt_inq_HighRiskCredit_count  := 0;
	unsigned2 bt_phone_found_on_st_inq_Retail_count        := 0;
	unsigned2 bt_addr_found_on_st_inq_Retail_count					:= 0;
	unsigned2 bt_ssn_found_on_st_inq_Retail_count          := 0;
	unsigned2 st_phone_found_on_bt_inq_Retail_count        := 0;
	unsigned2 st_addr_found_on_bt_inq_Retail_count         := 0;
	unsigned2 st_ssn_found_on_bt_inq_Retail_count          := 0;
	unsigned2 bt_phone_found_on_st_inq_Communications_count:= 0;
	unsigned2 bt_addr_found_on_st_inq_Communications_count := 0;
	unsigned2 bt_ssn_found_on_st_inq_Communications_count  := 0;
	unsigned2 st_phone_found_on_bt_inq_Communications_count:= 0;
	unsigned2 st_addr_found_on_bt_inq_Communications_count  := 0;
	unsigned2 st_ssn_found_on_bt_inq_Communications_count   := 0;
	unsigned2 bt_phone_found_on_st_inq_Other_count          := 0;
	unsigned2 bt_addr_found_on_st_inq_Other_count           := 0;
	unsigned2 bt_ssn_found_on_st_inq_Other_count            := 0;
	unsigned2 st_phone_found_on_bt_inq_Other_count          := 0;
	unsigned2 st_addr_found_on_bt_inq_Other_count           := 0;
	unsigned2 st_ssn_found_on_bt_inq_Other_count            := 0;
	unsigned2 bt_phone_found_on_st_inq_prepaidCards_count   := 0;
	unsigned2 bt_addr_found_on_st_inq_prepaidCards_count    := 0;
	unsigned2 bt_ssn_found_on_st_inq_prepaidCards_count     := 0;
	unsigned2 st_phone_found_on_bt_inq_prepaidCards_count   := 0;
	unsigned2 st_addr_found_on_bt_inq_prepaidCards_count    := 0;
	unsigned2 st_ssn_found_on_bt_inq_prepaidCards_count     := 0;
	unsigned2 bt_phone_found_on_st_inq_QuizProvider_count   := 0;
	unsigned2 bt_addr_found_on_st_inq_QuizProvider_count    := 0;
	unsigned2 bt_ssn_found_on_st_inq_QuizProvider_count     := 0;
	unsigned2 st_phone_found_on_bt_inq_QuizProvider_count   := 0;
	unsigned2 st_addr_found_on_bt_inq_QuizProvider_count    := 0;
	unsigned2 st_ssn_found_on_bt_inq_QuizProvider_count     := 0;
	unsigned2 bt_phone_found_on_st_inq_retailPayments_count := 0;
	unsigned2 bt_addr_found_on_st_inq_retailPayments_count:= 0;
	unsigned2 bt_ssn_found_on_st_inq_retailPayments_count   := 0;
	unsigned2 st_phone_found_on_bt_inq_retailPayments_count:= 0;
	unsigned2 st_addr_found_on_bt_inq_retailPayments_count := 0;
	unsigned2 st_ssn_found_on_bt_inq_retailPayments_count  := 0;
	unsigned2 bt_phone_found_on_st_inq_StudentLoans_count  := 0;
	unsigned2 bt_addr_found_on_st_inq_StudentLoans_count   := 0;
	unsigned2 bt_ssn_found_on_st_inq_StudentLoans_count    := 0;
	unsigned2 st_phone_found_on_bt_inq_StudentLoans_count  := 0;
	unsigned2 st_addr_found_on_bt_inq_StudentLoans_count   := 0;
	unsigned2 st_ssn_found_on_bt_inq_StudentLoans_count    := 0;
	unsigned2 bt_phone_found_on_st_inq_Utilities_count     := 0;
	unsigned2 bt_addr_found_on_st_inq_Utilities_count      := 0;
	unsigned2 bt_ssn_found_on_st_inq_Utilities_count       := 0;
	unsigned2 st_phone_found_on_bt_inq_Utilities_count     := 0;
	unsigned2 st_addr_found_on_bt_inq_Utilities_count      := 0;
	unsigned2 st_ssn_found_on_bt_inq_Utilities_count       := 0;

	unsigned2 btst_schools_in_common       := 0;                       
	unsigned2 btst_relationship_index_v1   := 0;               
	unsigned2 btst_relationship_index_v2   := 0; 
