...
SHARED s := Specificities(ih).Specificities[1];
  h00 := Bair_ExternalLinkKeys_V2.Specificities(ih).input_file;
SHARED thin_table := DISTRIBUTE(TABLE(h00,{NAME_SUFFIX,FNAME,FNAME_len,MNAME,MNAME_len,LNAME,PRIM_RANGE,PRIM_RANGE_len,PRIM_NAME,PRIM_NAME_len,SEC_RANGE,P_CITY_NAME,ST,ZIP,DOB_year,DOB_month,DOB_day,PHONE,DL_ST,DL,LEXID,POSSIBLE_SSN,POSSIBLE_SSN_len,CRIME,NAME_TYPE,CLEAN_GENDER,CLASS_CODE,DT_FIRST_SEEN,DT_LAST_SEEN,DATA_PROVIDER_ORI,VIN,PLATE,LATITUDE,LONGITUDE,SEARCH_ADDR1,SEARCH_ADDR2,CLEAN_COMPANY_NAME,MAINNAME,FULLNAME,EID_HASH}),HASH(EID_HASH));
...
SALT37.mac_prop_field(with_props(NAME_SUFFIX NOT IN SET(s.nulls_NAME_SUFFIX,NAME_SUFFIX)),NAME_SUFFIX,EID_HASH,NAME_SUFFIX_props); // For every DID find the best FULL NAME_SUFFIX
...
SALT37.mac_prop_field_init(with_props(MNAME NOT IN SET(s.nulls_MNAME,MNAME)),MNAME,EID_HASH,MNAME_props); // For every DID find the best FULL MNAME
...
SALT37.mac_prop_field(with_props(DOB_year NOT IN SET(s.nulls_DOB_year,DOB_year)),DOB_year,EID_HASH,DOB_year_props); // For every DID find the best FULL DOB_year
...
SALT37.mac_prop_field(with_props(DOB_month NOT IN SET(s.nulls_DOB_month,DOB_month)),DOB_month,EID_HASH,DOB_month_props); // For every DID find the best FULL DOB_month
...
SALT37.mac_prop_field(with_props(DOB_day NOT IN SET(s.nulls_DOB_day,DOB_day)),DOB_day,EID_HASH,DOB_day_props); // For every DID find the best FULL DOB_day
...
SALT37.mac_prop_field(with_props(PHONE NOT IN SET(s.nulls_PHONE,PHONE)),PHONE,EID_HASH,PHONE_props); // For every DID find the best FULL PHONE
...
SALT37.mac_prop_field(with_props(POSSIBLE_SSN NOT IN SET(s.nulls_POSSIBLE_SSN,POSSIBLE_SSN)),POSSIBLE_SSN,EID_HASH,POSSIBLE_SSN_props); // For every DID find the best FULL POSSIBLE_SSN
...
pj15 do_computes(pj15 le) := TRANSFORM
  ...
  SELF := le;
END;
SHARED propogated := PROJECT(pj15,do_computes(left)) : PERSIST('~temp::EID_HASH::Bair_ExternalLinkKeys_V2::mc_props::Classify_PS',EXPIRE(Bair_ExternalLinkKeys_V2.Config.PersistExpire)); // to allow to 'jump' over an exported value
...
EXPORT PostPropogationStats := SALT37.MAC_Pivot(PoPS, poprec);
  Grpd := GROUP( SORT(
    DISTRIBUTE( TABLE( propogated, { propogated, UNSIGNED2 Buddies := 0 }),HASH(EID_HASH)),
    EID_HASH,NAME_SUFFIX,FNAME,MNAME,LNAME,PRIM_RANGE,PRIM_NAME,SEC_RANGE,P_CITY_NAME,ST,ZIP,DOB_year,DOB_month,DOB_day,PHONE,DL_ST,DL,LEXID,POSSIBLE_SSN,CRIME,NAME_TYPE,CLEAN_GENDER,CLASS_CODE,DT_FIRST_SEEN,DT_LAST_SEEN,DATA_PROVIDER_ORI,VIN,PLATE,LATITUDE,LONGITUDE,SEARCH_ADDR1,SEARCH_ADDR2,CLEAN_COMPANY_NAME, LOCAL),
    EID_HASH,NAME_SUFFIX,FNAME,MNAME,LNAME,PRIM_RANGE,PRIM_NAME,SEC_RANGE,P_CITY_NAME,ST,ZIP,DOB_year,DOB_month,DOB_day,PHONE,DL_ST,DL,LEXID,POSSIBLE_SSN,CRIME,NAME_TYPE,CLEAN_GENDER,CLASS_CODE,DT_FIRST_SEEN,DT_LAST_SEEN,DATA_PROVIDER_ORI,VIN,PLATE,LATITUDE,LONGITUDE,SEARCH_ADDR1,SEARCH_ADDR2,CLEAN_COMPANY_NAME, LOCAL);
...
EXPORT Layout_Matches := RECORD//in this module for because of ,foward bug
  ...
  SALT37.UIDType EID_HASH1;
  SALT37.UIDType EID_HASH2;
END;
EXPORT Layout_Candidates := RECORD // A record to hold weights of each field value
  {h0} AND NOT [LNAME]; // remove wordbag fields which need to be expanded
  ...
  STRING56 LNAME := h0.LNAME; // Expanded wordbag field
...
layout_candidates add_SEC_RANGE(layout_candidates le,Specificities(ih).SEC_RANGE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j25,s.nulls_SEC_RANGE,Specificities(ih).SEC_RANGE_values_persisted,SEC_RANGE,SEC_RANGE_weight100,add_SEC_RANGE,j24);
layout_candidates add_MNAME(layout_candidates le,Specificities(ih).MNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j24,s.nulls_MNAME,Specificities(ih).MNAME_values_persisted,MNAME,MNAME_weight100,add_MNAME,j23);
layout_candidates add_DL_ST(layout_candidates le,Specificities(ih).DL_ST_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j23,s.nulls_DL_ST,Specificities(ih).DL_ST_values_persisted,DL_ST,DL_ST_weight100,add_DL_ST,j22);
layout_candidates add_FNAME(layout_candidates le,Specificities(ih).FNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j22,s.nulls_FNAME,Specificities(ih).FNAME_values_persisted,FNAME,FNAME_weight100,add_FNAME,j21);
layout_candidates add_DATA_PROVIDER_ORI(layout_candidates le,Specificities(ih).DATA_PROVIDER_ORI_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j21,s.nulls_DATA_PROVIDER_ORI,Specificities(ih).DATA_PROVIDER_ORI_values_persisted,DATA_PROVIDER_ORI,DATA_PROVIDER_ORI_weight100,add_DATA_PROVIDER_ORI,j20);
layout_candidates add_CLASS_CODE(layout_candidates le,Specificities(ih).CLASS_CODE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j20,s.nulls_CLASS_CODE,Specificities(ih).CLASS_CODE_values_persisted,CLASS_CODE,CLASS_CODE_weight100,add_CLASS_CODE,j19);
layout_candidates add_CLEAN_GENDER(layout_candidates le,Specificities(ih).CLEAN_GENDER_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j19,s.nulls_CLEAN_GENDER,Specificities(ih).CLEAN_GENDER_values_persisted,CLEAN_GENDER,CLEAN_GENDER_weight100,add_CLEAN_GENDER,j18);
layout_candidates add_NAME_TYPE(layout_candidates le,Specificities(ih).NAME_TYPE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j18,s.nulls_NAME_TYPE,Specificities(ih).NAME_TYPE_values_persisted,NAME_TYPE,NAME_TYPE_weight100,add_NAME_TYPE,j17);
layout_candidates add_CRIME(layout_candidates le,Specificities(ih).CRIME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j17,s.nulls_CRIME,Specificities(ih).CRIME_values_persisted,CRIME,CRIME_weight100,add_CRIME,j16);
layout_candidates add_P_CITY_NAME(layout_candidates le,Specificities(ih).P_CITY_NAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j16,s.nulls_P_CITY_NAME,Specificities(ih).P_CITY_NAME_values_persisted,P_CITY_NAME,P_CITY_NAME_weight100,add_P_CITY_NAME,j15);
...
layout_candidates add_LNAME(layout_candidates le,Specificities(ih).LNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.LNAME := IF( ri.field_specificity<>0 or ri.word<>'',SELF.LNAME_weight100+' '+ri.word,SALT37.Fn_WordBag_AppendSpecs_Fake(le.LNAME, s.LNAME_specificity) );// Copy in annotated wordstring
  SELF := le;
END;
...
layout_candidates add_VIN(layout_candidates le,Specificities(ih).VIN_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j12,s.nulls_VIN,Specificities(ih).VIN_values_persisted,VIN,VIN_weight100,add_VIN,j11);
layout_candidates add_ZIP(layout_candidates le,Specificities(ih).ZIP_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j11,s.nulls_ZIP,Specificities(ih).ZIP_values_persisted,ZIP,ZIP_weight100,add_ZIP,j10);
layout_candidates add_LEXID(layout_candidates le,Specificities(ih).LEXID_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j10,s.nulls_LEXID,Specificities(ih).LEXID_values_persisted,LEXID,LEXID_weight100,add_LEXID,j9);
...
layout_candidates add_SEARCH_ADDR1(layout_candidates le,Specificities(ih).SEARCH_ADDR1_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j9002,s.nulls_SEARCH_ADDR1,Specificities(ih).SEARCH_ADDR1_values_persisted,SEARCH_ADDR1,SEARCH_ADDR1_weight100,add_SEARCH_ADDR1,j7);
layout_candidates add_SEARCH_ADDR2(layout_candidates le,Specificities(ih).SEARCH_ADDR2_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j7,s.nulls_SEARCH_ADDR2,Specificities(ih).SEARCH_ADDR2_values_persisted,SEARCH_ADDR2,SEARCH_ADDR2_weight100,add_SEARCH_ADDR2,j6);
...
layout_candidates add_CLEAN_COMPANY_NAME(layout_candidates le,Specificities(ih).CLEAN_COMPANY_NAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j3,s.nulls_CLEAN_COMPANY_NAME,Specificities(ih).CLEAN_COMPANY_NAME_values_persisted,CLEAN_COMPANY_NAME,CLEAN_COMPANY_NAME_weight100,add_CLEAN_COMPANY_NAME,j2);
layout_candidates add_DL(layout_candidates le,Specificities(ih).DL_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j2,s.nulls_DL,Specificities(ih).DL_values_persisted,DL,DL_weight100,add_DL,j1);
layout_candidates add_POSSIBLE_SSN(layout_candidates le,Specificities(ih).POSSIBLE_SSN_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT37.MAC_Choose_JoinType(j1,s.nulls_POSSIBLE_SSN,Specificities(ih).POSSIBLE_SSN_values_persisted,POSSIBLE_SSN,POSSIBLE_SSN_weight100,add_POSSIBLE_SSN,j0);
//Using HASH(did) to get smoother distribution
SHARED Annotated := DISTRIBUTE(j0,hash(EID_HASH)) : PERSIST('~temp::EID_HASH::Bair_ExternalLinkKeys_V2::mc',EXPIRE(Bair_ExternalLinkKeys_V2.Config.PersistExpire)); // Distributed for keybuild case
