...
EXPORT SALT37.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'DEFAULT','NUMBER','T_ALLCAPS','T_ALPHANUM');
EXPORT FieldTypeNum(SALT37.StrType fn) := CASE(fn,'DEFAULT' => 1,'NUMBER' => 2,'T_ALLCAPS' => 3,'T_ALPHANUM' => 4,0);
...
EXPORT Make_P_CITY_NAME(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_P_CITY_NAME(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_PHONE(SALT37.StrType s0) := MakeFT_NUMBER(s0);
EXPORT InValid_PHONE(SALT37.StrType s) := InValidFT_NUMBER(s);
EXPORT InValidMessage_PHONE(UNSIGNED1 wh) := InValidMessageFT_NUMBER(wh);
 
EXPORT Make_DL_ST(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DL_ST(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_DL_ST(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_DL(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DL(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_DL(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_LEXID(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_LEXID(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_LEXID(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_POSSIBLE_SSN(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_POSSIBLE_SSN(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_POSSIBLE_SSN(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_CRIME(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_CRIME(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_CRIME(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_NAME_TYPE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_NAME_TYPE(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_NAME_TYPE(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_CLEAN_GENDER(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_CLEAN_GENDER(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_CLEAN_GENDER(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_CLASS_CODE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_CLASS_CODE(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_DATA_PROVIDER_ORI(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DATA_PROVIDER_ORI(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_DATA_PROVIDER_ORI(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_VIN(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_VIN(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_VIN(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_PLATE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_PLATE(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_PLATE(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_LATITUDE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_LATITUDE(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_LATITUDE(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_LONGITUDE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_LONGITUDE(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_LONGITUDE(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_SEARCH_ADDR1(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_SEARCH_ADDR1(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_SEARCH_ADDR1(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_SEARCH_ADDR2(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_SEARCH_ADDR2(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_SEARCH_ADDR2(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_CLEAN_COMPANY_NAME(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_CLEAN_COMPANY_NAME(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT InValid_FULLNAME(SALT37.StrType MAINNAME,SALT37.StrType NAME_SUFFIX) := 0;
...
EXPORT UIDConsistency(infile) := FUNCTIONMACRO
  ...
  EXPORT EID_HASH_Clusters := SALT37.MOD_ClusterStats.Counts(f,EID_HASH);
 ...
 // Now compute the more involved consistency checks
  ...
  EXPORT Advanced0 := SORT(SALT37.MAC_Pivot(Advanced00,Advanced0Layout), MAP(,0));
  END;
  RETURN m;
ENDMACRO;
END;
