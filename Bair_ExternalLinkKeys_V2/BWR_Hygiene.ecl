...
#workunit('name','Bair_ExternalLinkKeys_V2.BWR_Hygiene - Hygiene & Stats - SALT V3.7.0');
IMPORT Bair_ExternalLinkKeys_V2,SALT37;
// First create an instantiated hygiene module
  infile := Bair_ExternalLinkKeys_V2.File_Classify_PS;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Bair_ExternalLinkKeys_V2.Hygiene(ip);
  ...
  OUTPUT(SALT37.MAC_Character_Counts.EclRecord(p,'Layout_Classify_PS'),NAMED('OptimizedLayout'));// File layout suggested by data
  ...
  CM := Bair_ExternalLinkKeys_V2.Fields.UIDConsistency(Bair_ExternalLinkKeys_V2.File_Classify_PS);
