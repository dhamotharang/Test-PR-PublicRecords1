...
EXPORT FromNone(DATASET(Layout_Classify_PS) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.P_CITY_NAME_Invalid := Fields.InValid_P_CITY_NAME((SALT37.StrType)le.P_CITY_NAME);
      clean_P_CITY_NAME := (TYPEOF(le.P_CITY_NAME))Fields.Make_P_CITY_NAME((SALT37.StrType)le.P_CITY_NAME);
      clean_P_CITY_NAME_Invalid := Fields.InValid_P_CITY_NAME((SALT37.StrType)clean_P_CITY_NAME);
    ...
    SELF.DL_ST_Invalid := Fields.InValid_DL_ST((SALT37.StrType)le.DL_ST);
      clean_DL_ST := (TYPEOF(le.DL_ST))Fields.Make_DL_ST((SALT37.StrType)le.DL_ST);
      clean_DL_ST_Invalid := Fields.InValid_DL_ST((SALT37.StrType)clean_DL_ST);
      SELF.DL_ST := IF(withOnfail, clean_DL_ST, le.DL_ST); // ONFAIL(CLEAN)
    SELF.DL_Invalid := Fields.InValid_DL((SALT37.StrType)le.DL);
      clean_DL := (TYPEOF(le.DL))Fields.Make_DL((SALT37.StrType)le.DL);
      clean_DL_Invalid := Fields.InValid_DL((SALT37.StrType)clean_DL);
      SELF.DL := IF(withOnfail, clean_DL, le.DL); // ONFAIL(CLEAN)
    SELF.LEXID_Invalid := Fields.InValid_LEXID((SALT37.StrType)le.LEXID);
      clean_LEXID := (TYPEOF(le.LEXID))Fields.Make_LEXID((SALT37.StrType)le.LEXID);
      clean_LEXID_Invalid := Fields.InValid_LEXID((SALT37.StrType)clean_LEXID);
      SELF.LEXID := IF(withOnfail, clean_LEXID, le.LEXID); // ONFAIL(CLEAN)
    SELF.POSSIBLE_SSN_Invalid := Fields.InValid_POSSIBLE_SSN((SALT37.StrType)le.POSSIBLE_SSN);
      clean_POSSIBLE_SSN := (TYPEOF(le.POSSIBLE_SSN))Fields.Make_POSSIBLE_SSN((SALT37.StrType)le.POSSIBLE_SSN);
      clean_POSSIBLE_SSN_Invalid := Fields.InValid_POSSIBLE_SSN((SALT37.StrType)clean_POSSIBLE_SSN);
      SELF.POSSIBLE_SSN := IF(withOnfail, clean_POSSIBLE_SSN, le.POSSIBLE_SSN); // ONFAIL(CLEAN)
    SELF.CRIME_Invalid := Fields.InValid_CRIME((SALT37.StrType)le.CRIME);
      clean_CRIME := (TYPEOF(le.CRIME))Fields.Make_CRIME((SALT37.StrType)le.CRIME);
      clean_CRIME_Invalid := Fields.InValid_CRIME((SALT37.StrType)clean_CRIME);
      SELF.CRIME := IF(withOnfail, clean_CRIME, le.CRIME); // ONFAIL(CLEAN)
    SELF.NAME_TYPE_Invalid := Fields.InValid_NAME_TYPE((SALT37.StrType)le.NAME_TYPE);
      clean_NAME_TYPE := (TYPEOF(le.NAME_TYPE))Fields.Make_NAME_TYPE((SALT37.StrType)le.NAME_TYPE);
      clean_NAME_TYPE_Invalid := Fields.InValid_NAME_TYPE((SALT37.StrType)clean_NAME_TYPE);
      SELF.NAME_TYPE := IF(withOnfail, clean_NAME_TYPE, le.NAME_TYPE); // ONFAIL(CLEAN)
    SELF.CLEAN_GENDER_Invalid := Fields.InValid_CLEAN_GENDER((SALT37.StrType)le.CLEAN_GENDER);
      clean_CLEAN_GENDER := (TYPEOF(le.CLEAN_GENDER))Fields.Make_CLEAN_GENDER((SALT37.StrType)le.CLEAN_GENDER);
      clean_CLEAN_GENDER_Invalid := Fields.InValid_CLEAN_GENDER((SALT37.StrType)clean_CLEAN_GENDER);
      SELF.CLEAN_GENDER := IF(withOnfail, clean_CLEAN_GENDER, le.CLEAN_GENDER); // ONFAIL(CLEAN)
    SELF.CLASS_CODE_Invalid := Fields.InValid_CLASS_CODE((SALT37.StrType)le.CLASS_CODE);
      clean_CLASS_CODE := (TYPEOF(le.CLASS_CODE))Fields.Make_CLASS_CODE((SALT37.StrType)le.CLASS_CODE);
      clean_CLASS_CODE_Invalid := Fields.InValid_CLASS_CODE((SALT37.StrType)clean_CLASS_CODE);
    ...
    SELF.DATA_PROVIDER_ORI_Invalid := Fields.InValid_DATA_PROVIDER_ORI((SALT37.StrType)le.DATA_PROVIDER_ORI);
      clean_DATA_PROVIDER_ORI := (TYPEOF(le.DATA_PROVIDER_ORI))Fields.Make_DATA_PROVIDER_ORI((SALT37.StrType)le.DATA_PROVIDER_ORI);
      clean_DATA_PROVIDER_ORI_Invalid := Fields.InValid_DATA_PROVIDER_ORI((SALT37.StrType)clean_DATA_PROVIDER_ORI);
      SELF.DATA_PROVIDER_ORI := IF(withOnfail, clean_DATA_PROVIDER_ORI, le.DATA_PROVIDER_ORI); // ONFAIL(CLEAN)
    SELF.VIN_Invalid := Fields.InValid_VIN((SALT37.StrType)le.VIN);
      clean_VIN := (TYPEOF(le.VIN))Fields.Make_VIN((SALT37.StrType)le.VIN);
      clean_VIN_Invalid := Fields.InValid_VIN((SALT37.StrType)clean_VIN);
      SELF.VIN := IF(withOnfail, clean_VIN, le.VIN); // ONFAIL(CLEAN)
    SELF.PLATE_Invalid := Fields.InValid_PLATE((SALT37.StrType)le.PLATE);
      clean_PLATE := (TYPEOF(le.PLATE))Fields.Make_PLATE((SALT37.StrType)le.PLATE);
      clean_PLATE_Invalid := Fields.InValid_PLATE((SALT37.StrType)clean_PLATE);
      SELF.PLATE := IF(withOnfail, clean_PLATE, le.PLATE); // ONFAIL(CLEAN)
    SELF.LATITUDE_Invalid := Fields.InValid_LATITUDE((SALT37.StrType)le.LATITUDE);
      clean_LATITUDE := (TYPEOF(le.LATITUDE))Fields.Make_LATITUDE((SALT37.StrType)le.LATITUDE);
      clean_LATITUDE_Invalid := Fields.InValid_LATITUDE((SALT37.StrType)clean_LATITUDE);
      SELF.LATITUDE := IF(withOnfail, clean_LATITUDE, le.LATITUDE); // ONFAIL(CLEAN)
    SELF.LONGITUDE_Invalid := Fields.InValid_LONGITUDE((SALT37.StrType)le.LONGITUDE);
      clean_LONGITUDE := (TYPEOF(le.LONGITUDE))Fields.Make_LONGITUDE((SALT37.StrType)le.LONGITUDE);
      clean_LONGITUDE_Invalid := Fields.InValid_LONGITUDE((SALT37.StrType)clean_LONGITUDE);
      SELF.LONGITUDE := IF(withOnfail, clean_LONGITUDE, le.LONGITUDE); // ONFAIL(CLEAN)
    SELF.SEARCH_ADDR1_Invalid := Fields.InValid_SEARCH_ADDR1((SALT37.StrType)le.SEARCH_ADDR1);
      clean_SEARCH_ADDR1 := (TYPEOF(le.SEARCH_ADDR1))Fields.Make_SEARCH_ADDR1((SALT37.StrType)le.SEARCH_ADDR1);
      clean_SEARCH_ADDR1_Invalid := Fields.InValid_SEARCH_ADDR1((SALT37.StrType)clean_SEARCH_ADDR1);
      SELF.SEARCH_ADDR1 := IF(withOnfail, clean_SEARCH_ADDR1, le.SEARCH_ADDR1); // ONFAIL(CLEAN)
    SELF.SEARCH_ADDR2_Invalid := Fields.InValid_SEARCH_ADDR2((SALT37.StrType)le.SEARCH_ADDR2);
      clean_SEARCH_ADDR2 := (TYPEOF(le.SEARCH_ADDR2))Fields.Make_SEARCH_ADDR2((SALT37.StrType)le.SEARCH_ADDR2);
      clean_SEARCH_ADDR2_Invalid := Fields.InValid_SEARCH_ADDR2((SALT37.StrType)clean_SEARCH_ADDR2);
      SELF.SEARCH_ADDR2 := IF(withOnfail, clean_SEARCH_ADDR2, le.SEARCH_ADDR2); // ONFAIL(CLEAN)
    SELF.CLEAN_COMPANY_NAME_Invalid := Fields.InValid_CLEAN_COMPANY_NAME((SALT37.StrType)le.CLEAN_COMPANY_NAME);
      clean_CLEAN_COMPANY_NAME := (TYPEOF(le.CLEAN_COMPANY_NAME))Fields.Make_CLEAN_COMPANY_NAME((SALT37.StrType)le.CLEAN_COMPANY_NAME);
      clean_CLEAN_COMPANY_NAME_Invalid := Fields.InValid_CLEAN_COMPANY_NAME((SALT37.StrType)clean_CLEAN_COMPANY_NAME);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldType := CHOOSE(c,'T_ALPHANUM','T_ALPHANUM','T_ALPHANUM','T_ALPHANUM','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','NUMBER','DEFAULT','NUMBER','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT37.StrType)le.NAME_SUFFIX,(SALT37.StrType)le.FNAME,(SALT37.StrType)le.MNAME,(SALT37.StrType)le.LNAME,(SALT37.StrType)le.PRIM_RANGE,(SALT37.StrType)le.PRIM_NAME,(SALT37.StrType)le.SEC_RANGE,(SALT37.StrType)le.P_CITY_NAME,(SALT37.StrType)le.ST,(SALT37.StrType)le.ZIP,(SALT37.StrType)le.DOB,(SALT37.StrType)le.PHONE,(SALT37.StrType)le.DL_ST,(SALT37.StrType)le.DL,(SALT37.StrType)le.LEXID,(SALT37.StrType)le.POSSIBLE_SSN,(SALT37.StrType)le.CRIME,(SALT37.StrType)le.NAME_TYPE,(SALT37.StrType)le.CLEAN_GENDER,(SALT37.StrType)le.CLASS_CODE,(SALT37.StrType)le.DT_FIRST_SEEN,(SALT37.StrType)le.DT_LAST_SEEN,(SALT37.StrType)le.DATA_PROVIDER_ORI,(SALT37.StrType)le.VIN,(SALT37.StrType)le.PLATE,(SALT37.StrType)le.LATITUDE,(SALT37.StrType)le.LONGITUDE,(SALT37.StrType)le.SEARCH_ADDR1,(SALT37.StrType)le.SEARCH_ADDR2,(SALT37.StrType)le.CLEAN_COMPANY_NAME,'***SALTBUG***');
  END;
