EXPORT KeyNames(string pversion, boolean pUseDelta = false) := MODULE
	...
	SHARED prefix    := KeyPrefix + '::key::bair_externallinkkeys_v2';
	...
	EXPORT lname_super			:= prefix + '::' + KeySuperfile + '::' + 'EID_HASH::WordBag::LNAME';
	...
	EXPORT lname_father			:= prefix + '::' + keyFather + '::' + 'EID_HASH::WordBag::LNAME';
	...
	EXPORT lname_logical		:= prefix + '::' + buildDate + '::' + 'EID_HASH::WordBag::LNAME';
	...
	EXPORT lname_Delta 		:= Getlgnames(lname_super);	
