...
EXPORT Summary(SALT31.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_prov_id_pcnt := AVE(GROUP,IF(h.prov_id = (TYPEOF(h.prov_id))'',0,100));
    maxlength_prov_id := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_id)));
    avelength_prov_id := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_id)),h.prov_id<>(typeof(h.prov_id))'');
    populated_prov_name_pcnt := AVE(GROUP,IF(h.prov_name = (TYPEOF(h.prov_name))'',0,100));
    maxlength_prov_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_name)));
    avelength_prov_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_name)),h.prov_name<>(typeof(h.prov_name))'');
    ...
    populated_prov_type_cd_pcnt := AVE(GROUP,IF(h.prov_type_cd = (TYPEOF(h.prov_type_cd))'',0,100));
    maxlength_prov_type_cd := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_type_cd)));
    avelength_prov_type_cd := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_type_cd)),h.prov_type_cd<>(typeof(h.prov_type_cd))'');
    populated_prov_type_name_pcnt := AVE(GROUP,IF(h.prov_type_name = (TYPEOF(h.prov_type_name))'',0,100));
    maxlength_prov_type_name := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_type_name)));
    avelength_prov_type_name := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_type_name)),h.prov_type_name<>(typeof(h.prov_type_name))'');
    populated_prov_addr_str_pcnt := AVE(GROUP,IF(h.prov_addr_str = (TYPEOF(h.prov_addr_str))'',0,100));
    maxlength_prov_addr_str := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_str)));
    avelength_prov_addr_str := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_str)),h.prov_addr_str<>(typeof(h.prov_addr_str))'');
    populated_prov_addr_line_2_pcnt := AVE(GROUP,IF(h.prov_addr_line_2 = (TYPEOF(h.prov_addr_line_2))'',0,100));
    maxlength_prov_addr_line_2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_line_2)));
    avelength_prov_addr_line_2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_line_2)),h.prov_addr_line_2<>(typeof(h.prov_addr_line_2))'');
    populated_prov_addr_city_pcnt := AVE(GROUP,IF(h.prov_addr_city = (TYPEOF(h.prov_addr_city))'',0,100));
    maxlength_prov_addr_city := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_city)));
    avelength_prov_addr_city := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_city)),h.prov_addr_city<>(typeof(h.prov_addr_city))'');
    populated_prov_addr_st_pcnt := AVE(GROUP,IF(h.prov_addr_st = (TYPEOF(h.prov_addr_st))'',0,100));
    maxlength_prov_addr_st := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_st)));
    avelength_prov_addr_st := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_addr_st)),h.prov_addr_st<>(typeof(h.prov_addr_st))'');
    populated_postal_cd_pcnt := AVE(GROUP,IF(h.postal_cd = (TYPEOF(h.postal_cd))'',0,100));
    maxlength_postal_cd := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.postal_cd)));
    avelength_postal_cd := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.postal_cd)),h.postal_cd<>(typeof(h.postal_cd))'');
    populated_prov_tele_num_pcnt := AVE(GROUP,IF(h.prov_tele_num = (TYPEOF(h.prov_tele_num))'',0,100));
    maxlength_prov_tele_num := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_tele_num)));
    avelength_prov_tele_num := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_tele_num)),h.prov_tele_num<>(typeof(h.prov_tele_num))'');
    populated_spec_cd_pcnt := AVE(GROUP,IF(h.spec_cd = (TYPEOF(h.spec_cd))'',0,100));
    maxlength_spec_cd := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.spec_cd)));
    avelength_spec_cd := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.spec_cd)),h.spec_cd<>(typeof(h.spec_cd))'');
    populated_prov_spec_desc_pcnt := AVE(GROUP,IF(h.prov_spec_desc = (TYPEOF(h.prov_spec_desc))'',0,100));
    maxlength_prov_spec_desc := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_spec_desc)));
    avelength_prov_spec_desc := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.prov_spec_desc)),h.prov_spec_desc<>(typeof(h.prov_spec_desc))'');
    populated_active_ind_pcnt := AVE(GROUP,IF(h.active_ind = (TYPEOF(h.active_ind))'',0,100));
    maxlength_active_ind := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.active_ind)));
    avelength_active_ind := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.active_ind)),h.active_ind<>(typeof(h.active_ind))'');
...
SHARED FldIds := DATASET([{1,'did'}
      ...
      ,{92,'ultid'}
      ,{93,'ultscore'}
      ,{94,'ultweight'}],SALT31.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_prov_id((SALT31.StrType)le.prov_id),
    Fields.InValid_prov_name((SALT31.StrType)le.prov_name),
    Fields.InValid_npi((SALT31.StrType)le.npi),
    Fields.InValid_prov_type_cd((SALT31.StrType)le.prov_type_cd),
    Fields.InValid_prov_type_name((SALT31.StrType)le.prov_type_name),
    Fields.InValid_prov_addr_str((SALT31.StrType)le.prov_addr_str),
    Fields.InValid_prov_addr_line_2((SALT31.StrType)le.prov_addr_line_2),
    Fields.InValid_prov_addr_city((SALT31.StrType)le.prov_addr_city),
    Fields.InValid_prov_addr_st((SALT31.StrType)le.prov_addr_st),
    Fields.InValid_postal_cd((SALT31.StrType)le.postal_cd),
    Fields.InValid_prov_tele_num((SALT31.StrType)le.prov_tele_num),
    Fields.InValid_spec_cd((SALT31.StrType)le.spec_cd),
    Fields.InValid_prov_spec_desc((SALT31.StrType)le.prov_spec_desc),
    Fields.InValid_active_ind((SALT31.StrType)le.active_ind),
