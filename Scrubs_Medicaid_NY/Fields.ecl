...
EXPORT FieldTypeNum(SALT31.StrType fn) := CASE(fn,'did' => 1,'did_score' => 2,'bdid' => 3,'bdid_score' => 4,'best_dob' => 5,'best_ssn' => 6,'data_state' => 7,'prov_id' => 8,'prov_name' => 9,'npi' => 10,'prov_type_cd' => 11,'prov_type_name' => 12,'prov_addr_str' => 13,'prov_addr_line_2' => 14,'prov_addr_city' => 15,'prov_addr_st' => 16,'postal_cd' => 17,'prov_tele_num' => 18,'spec_cd' => 19,'prov_spec_desc' => 20,'active_ind' => 21,'entity_type_code' => 22,'firstname' => 23,'lastname' => 24,'companyname' => 25,'src' => 26,'dt_vendor_first_reported' => 27,'dt_vendor_last_reported' => 28,'dt_first_seen' => 29,'dt_last_seen' => 30,'record_type' => 31,'source_rid' => 32,'lnpid' => 33,'title' => 34,'fname' => 35,'mname' => 36,'lname' => 37,'name_suffix' => 38,'name_type' => 39,'nid' => 40,'clean_clinic_name' => 41,'prepped_addr1' => 42,'prepped_addr2' => 43,'prim_range' => 44,'predir' => 45,'prim_name' => 46,'addr_suffix' => 47,'postdir' => 48,'unit_desig' => 49,'sec_range' => 50,'p_city_name' => 51,'v_city_name' => 52,'st' => 53,'zip' => 54,'zip4' => 55,'cart' => 56,'cr_sort_sz' => 57,'lot' => 58,'lot_order' => 59,'dbpc' => 60,'chk_digit' => 61,'rec_type' => 62,'fips_st' => 63,'fips_county' => 64,'geo_lat' => 65,'geo_long' => 66,'msa' => 67,'geo_blk' => 68,'geo_match' => 69,'err_stat' => 70,'rawaid' => 71,'aceaid' => 72,'clean_phone' => 73,'dotid' => 74,'dotscore' => 75,'dotweight' => 76,'empid' => 77,'empscore' => 78,'empweight' => 79,'powid' => 80,'powscore' => 81,'powweight' => 82,'proxid' => 83,'proxscore' => 84,'proxweight' => 85,'seleid' => 86,'selescore' => 87,'seleweight' => 88,'orgid' => 89,'orgscore' => 90,'orgweight' => 91,'ultid' => 92,'ultscore' => 93,'ultweight' => 94,0);
EXPORT MakeFT_did(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_did(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_did(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_bdid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_bdid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 7 OR LENGTH(TRIM(s)) = 6),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_bdid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,10,9,8,7,6'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_data_state(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_data_state(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'NY '))),~(LENGTH(TRIM(s)) = 2),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_data_state(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('NY '),SALT31.HygieneErrors.NotLength('2'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_id(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_id(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 7 OR LENGTH(TRIM(s)) = 6 OR LENGTH(TRIM(s)) = 8),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_prov_id(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('7,6,8'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_name(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' "#&\'-.0124ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_name(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' "#&\'-.0124ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 6 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 7));
EXPORT InValidMessageFT_prov_name(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' "#&\'-.0124ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT31.HygieneErrors.NotWords('3,4,2,5,6,7'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_prov_type_cd(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'012345689LMT '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_type_cd(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'012345689LMT '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 3 OR LENGTH(TRIM(s)) = 1),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_prov_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('012345689LMT '),SALT31.HygieneErrors.NotLength('2,3,1'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_type_name(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' ()-ACDEFGHIKLMNOPRSTUVWY '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_type_name(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' ()-ACDEFGHIKLMNOPRSTUVWY '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3));
EXPORT InValidMessageFT_prov_type_name(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' ()-ACDEFGHIKLMNOPRSTUVWY '),SALT31.HygieneErrors.NotWords('1,4,2,3'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_addr_str(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' "#-/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_addr_str(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' "#-/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 6 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 7 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 8));
EXPORT InValidMessageFT_prov_addr_str(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' "#-/0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT31.HygieneErrors.NotWords('3,4,5,6,2,1,7,8'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_addr_line_2(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' "#,-./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_addr_line_2(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' "#,-./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 6));
EXPORT InValidMessageFT_prov_addr_line_2(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' "#,-./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT31.HygieneErrors.NotWords('1,3,2,4,5,6'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_addr_city(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' ABCDEFGHIJKLMNOPQRSTUVWXY '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_addr_city(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' ABCDEFGHIJKLMNOPQRSTUVWXY '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3));
EXPORT InValidMessageFT_prov_addr_city(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' ABCDEFGHIJKLMNOPQRSTUVWXY '),SALT31.HygieneErrors.NotWords('1,2,3'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_addr_st(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'ACDEFGHIJLMNOPRSTVWXYZ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_addr_st(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'ACDEFGHIJLMNOPRSTVWXYZ '))),~(LENGTH(TRIM(s)) = 2),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_prov_addr_st(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('ACDEFGHIJLMNOPRSTVWXYZ '),SALT31.HygieneErrors.NotLength('2'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_postal_cd(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_postal_cd(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 5),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_postal_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('5'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_tele_num(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_tele_num(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 0),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_prov_tele_num(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('10,0'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_spec_cd(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_spec_cd(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 3 OR LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 2),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_spec_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('3,0,2'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prov_spec_desc(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' &()/:ABCDEFGHILMNOPQRSTUVY '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prov_spec_desc(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' &()/:ABCDEFGHILMNOPQRSTUVY '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 10 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 7 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 6 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 8 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 9));
EXPORT InValidMessageFT_prov_spec_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' &()/:ABCDEFGHILMNOPQRSTUVY '),SALT31.HygieneErrors.NotWords('1,10,5,7,4,6,2,3,8,9'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_active_ind(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_active_ind(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_active_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' '),SALT31.HygieneErrors.NotLength('0'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_entity_type_code(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'012 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_entity_type_code(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'012 '))),~(LENGTH(TRIM(s)) = 1),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_entity_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('012 '),SALT31.HygieneErrors.NotLength('1'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_firstname(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_firstname(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_firstname(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' '),SALT31.HygieneErrors.NotLength('0'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_lastname(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_lastname(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_lastname(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' '),SALT31.HygieneErrors.NotLength('0'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_companyname(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_companyname(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' "#&,-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 29 OR LENGTH(TRIM(s)) = 28 OR LENGTH(TRIM(s)) = 27 OR LENGTH(TRIM(s)) = 35 OR LENGTH(TRIM(s)) = 26 OR LENGTH(TRIM(s)) = 25 OR LENGTH(TRIM(s)) = 23 OR LENGTH(TRIM(s)) = 24 OR LENGTH(TRIM(s)) = 21 OR LENGTH(TRIM(s)) = 20 OR LENGTH(TRIM(s)) = 22 OR LENGTH(TRIM(s)) = 19 OR LENGTH(TRIM(s)) = 18 OR LENGTH(TRIM(s)) = 16 OR LENGTH(TRIM(s)) = 17 OR LENGTH(TRIM(s)) = 14 OR LENGTH(TRIM(s)) = 34 OR LENGTH(TRIM(s)) = 31 OR LENGTH(TRIM(s)) = 33 OR LENGTH(TRIM(s)) = 30 OR LENGTH(TRIM(s)) = 32 OR LENGTH(TRIM(s)) = 15 OR LENGTH(TRIM(s)) = 13 OR LENGTH(TRIM(s)) = 12 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 6 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 7));
EXPORT InValidMessageFT_companyname(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' "#&,-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT31.HygieneErrors.NotLength('0,29,28,27,35,26,25,23,24,21,20,22,19,18,16,17,14,34,31,33,30,32,15,13,12,11,10'),SALT31.HygieneErrors.NotWords('1,4,3,5,6,2,7'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_src(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'DHMOST_ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_src(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'DHMOST_ '))),~(LENGTH(TRIM(s)) = 8),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_src(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('DHMOST_ '),SALT31.HygieneErrors.NotLength('8'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_dt_vendor_first_reported(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'01258 '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_dt_vendor_first_reported(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'01258 '))),~(LENGTH(TRIM(s)) = 8),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_dt_vendor_first_reported(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('01258 '),SALT31.HygieneErrors.NotLength('8'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_dt_vendor_last_reported(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_dt_vendor_last_reported(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'01258 '))),~(LENGTH(TRIM(s)) = 8),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_dt_vendor_last_reported(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('01258 '),SALT31.HygieneErrors.NotLength('8'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_lname(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_lname(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 2));
EXPORT InValidMessageFT_lname(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT31.HygieneErrors.NotWords('1,2'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_prepped_addr2(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_prepped_addr2(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' ,0123456789ABCDEFGHIJKLMNOPRSTUVWXY '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 3 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 4 OR SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 5));
EXPORT InValidMessageFT_prepped_addr2(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' ,0123456789ABCDEFGHIJKLMNOPRSTUVWXY '),SALT31.HygieneErrors.NotWords('3,4,5'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_prim_range(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'-0123456789ABCDEFLNPST '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_prim_range(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'-0123456789ABCDEFLNPST '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_prim_range(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('-0123456789ABCDEFLNPST '),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_addr_suffix(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'ABCDEHIKLMNPQRSTVWXYZ '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_addr_suffix(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'ABCDEHIKLMNPQRSTVWXYZ '))),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_addr_suffix(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('ABCDEHIKLMNPQRSTVWXYZ '),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_unit_desig(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'#ABCDEFGHILMNOPRSTUXY '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_unit_desig(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'#ABCDEFGHILMNOPRSTUXY '))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 3 OR LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 4 OR LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 5),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_unit_desig(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('#ABCDEFGHILMNOPRSTUXY '),SALT31.HygieneErrors.NotLength('0,3,2,4,1,5'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_sec_range(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,' -0123456789ABCDEFGHIJKLMNOPRSTUVWY '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_sec_range(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,' -0123456789ABCDEFGHIJKLMNOPRSTUVWY '))));
EXPORT InValidMessageFT_sec_range(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars(' -0123456789ABCDEFGHIJKLMNOPRSTUVWY '),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_st(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_st(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'ACDEFGHIJLMNOPRSTVWXYZ '))),~(LENGTH(TRIM(s)) = 2),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_st(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('ACDEFGHIJLMNOPRSTVWXYZ '),SALT31.HygieneErrors.NotLength('2'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_err_stat(SALT31.StrType s0) := FUNCTION
  s1 := SALT31.stringfilter(s0,'012345689ABCES '); // Only allow valid symbols
  s2 := SALT31.stringcleanspaces( SALT31.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_err_stat(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'012345689ABCES '))),~(LENGTH(TRIM(s)) = 4),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_err_stat(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('012345689ABCES '),SALT31.HygieneErrors.NotLength('4'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_powid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_powid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 7),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_powid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,9,8,11,10,7'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
EXPORT MakeFT_powscore(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_powscore(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'014789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 3 OR LENGTH(TRIM(s)) = 2),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_powscore(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('014789 '),SALT31.HygieneErrors.NotLength('1,3,2'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_proxid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_proxid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 7),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_proxid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,9,8,11,10,7'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_seleid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_seleid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 7),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_seleid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,8,9,11,10,7'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_orgid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orgid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 7),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orgid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,8,9,11,10,7'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT MakeFT_ultid(SALT31.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_ultid(SALT31.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT31.StringFilter(s,'0123456789 '))),~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 7),~(SALT31.WordCount(SALT31.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_ultid(UNSIGNED1 wh) := CHOOSE(wh,SALT31.HygieneErrors.NotLeft,SALT31.HygieneErrors.NotInChars('0123456789 '),SALT31.HygieneErrors.NotLength('1,8,9,11,10,7'),SALT31.HygieneErrors.NotWords('1'),SALT31.HygieneErrors.Good);
...
EXPORT Make_prov_id(SALT31.StrType s0) := MakeFT_prov_id(s0);
EXPORT InValid_prov_id(SALT31.StrType s) := InValidFT_prov_id(s);
EXPORT InValidMessage_prov_id(UNSIGNED1 wh) := InValidMessageFT_prov_id(wh);
EXPORT Make_prov_name(SALT31.StrType s0) := MakeFT_prov_name(s0);
EXPORT InValid_prov_name(SALT31.StrType s) := InValidFT_prov_name(s);
EXPORT InValidMessage_prov_name(UNSIGNED1 wh) := InValidMessageFT_prov_name(wh);
...
EXPORT Make_prov_type_cd(SALT31.StrType s0) := MakeFT_prov_type_cd(s0);
EXPORT InValid_prov_type_cd(SALT31.StrType s) := InValidFT_prov_type_cd(s);
EXPORT InValidMessage_prov_type_cd(UNSIGNED1 wh) := InValidMessageFT_prov_type_cd(wh);
EXPORT Make_prov_type_name(SALT31.StrType s0) := MakeFT_prov_type_name(s0);
EXPORT InValid_prov_type_name(SALT31.StrType s) := InValidFT_prov_type_name(s);
EXPORT InValidMessage_prov_type_name(UNSIGNED1 wh) := InValidMessageFT_prov_type_name(wh);
EXPORT Make_prov_addr_str(SALT31.StrType s0) := MakeFT_prov_addr_str(s0);
EXPORT InValid_prov_addr_str(SALT31.StrType s) := InValidFT_prov_addr_str(s);
EXPORT InValidMessage_prov_addr_str(UNSIGNED1 wh) := InValidMessageFT_prov_addr_str(wh);
EXPORT Make_prov_addr_line_2(SALT31.StrType s0) := MakeFT_prov_addr_line_2(s0);
EXPORT InValid_prov_addr_line_2(SALT31.StrType s) := InValidFT_prov_addr_line_2(s);
EXPORT InValidMessage_prov_addr_line_2(UNSIGNED1 wh) := InValidMessageFT_prov_addr_line_2(wh);
EXPORT Make_prov_addr_city(SALT31.StrType s0) := MakeFT_prov_addr_city(s0);
EXPORT InValid_prov_addr_city(SALT31.StrType s) := InValidFT_prov_addr_city(s);
EXPORT InValidMessage_prov_addr_city(UNSIGNED1 wh) := InValidMessageFT_prov_addr_city(wh);
EXPORT Make_prov_addr_st(SALT31.StrType s0) := MakeFT_prov_addr_st(s0);
EXPORT InValid_prov_addr_st(SALT31.StrType s) := InValidFT_prov_addr_st(s);
EXPORT InValidMessage_prov_addr_st(UNSIGNED1 wh) := InValidMessageFT_prov_addr_st(wh);
EXPORT Make_postal_cd(SALT31.StrType s0) := MakeFT_postal_cd(s0);
EXPORT InValid_postal_cd(SALT31.StrType s) := InValidFT_postal_cd(s);
EXPORT InValidMessage_postal_cd(UNSIGNED1 wh) := InValidMessageFT_postal_cd(wh);
EXPORT Make_prov_tele_num(SALT31.StrType s0) := MakeFT_prov_tele_num(s0);
EXPORT InValid_prov_tele_num(SALT31.StrType s) := InValidFT_prov_tele_num(s);
EXPORT InValidMessage_prov_tele_num(UNSIGNED1 wh) := InValidMessageFT_prov_tele_num(wh);
EXPORT Make_spec_cd(SALT31.StrType s0) := MakeFT_spec_cd(s0);
EXPORT InValid_spec_cd(SALT31.StrType s) := InValidFT_spec_cd(s);
EXPORT InValidMessage_spec_cd(UNSIGNED1 wh) := InValidMessageFT_spec_cd(wh);
EXPORT Make_prov_spec_desc(SALT31.StrType s0) := MakeFT_prov_spec_desc(s0);
EXPORT InValid_prov_spec_desc(SALT31.StrType s) := InValidFT_prov_spec_desc(s);
EXPORT InValidMessage_prov_spec_desc(UNSIGNED1 wh) := InValidMessageFT_prov_spec_desc(wh);
EXPORT Make_active_ind(SALT31.StrType s0) := MakeFT_active_ind(s0);
EXPORT InValid_active_ind(SALT31.StrType s) := InValidFT_active_ind(s);
EXPORT InValidMessage_active_ind(UNSIGNED1 wh) := InValidMessageFT_active_ind(wh);
...
#uniquename(dl)
  %dl% := RECORD
    ...
    BOOLEAN Diff_prov_id;
    BOOLEAN Diff_prov_name;
    BOOLEAN Diff_npi;
    BOOLEAN Diff_prov_type_cd;
    BOOLEAN Diff_prov_type_name;
    BOOLEAN Diff_prov_addr_str;
    BOOLEAN Diff_prov_addr_line_2;
    BOOLEAN Diff_prov_addr_city;
    BOOLEAN Diff_prov_addr_st;
    BOOLEAN Diff_postal_cd;
    BOOLEAN Diff_prov_tele_num;
    BOOLEAN Diff_spec_cd;
    BOOLEAN Diff_prov_spec_desc;
    BOOLEAN Diff_active_ind;
...
#uniquename(fd)
  %dl% %fd%(in_left le,in_right ri) := TRANSFORM
    ...
    SELF.Diff_prov_id := le.prov_id <> ri.prov_id;
    SELF.Diff_prov_name := le.prov_name <> ri.prov_name;
    SELF.Diff_npi := le.npi <> ri.npi;
    SELF.Diff_prov_type_cd := le.prov_type_cd <> ri.prov_type_cd;
    SELF.Diff_prov_type_name := le.prov_type_name <> ri.prov_type_name;
    SELF.Diff_prov_addr_str := le.prov_addr_str <> ri.prov_addr_str;
    SELF.Diff_prov_addr_line_2 := le.prov_addr_line_2 <> ri.prov_addr_line_2;
    SELF.Diff_prov_addr_city := le.prov_addr_city <> ri.prov_addr_city;
    SELF.Diff_prov_addr_st := le.prov_addr_st <> ri.prov_addr_st;
    SELF.Diff_postal_cd := le.postal_cd <> ri.postal_cd;
    SELF.Diff_prov_tele_num := le.prov_tele_num <> ri.prov_tele_num;
    SELF.Diff_spec_cd := le.spec_cd <> ri.spec_cd;
    SELF.Diff_prov_spec_desc := le.prov_spec_desc <> ri.prov_spec_desc;
    SELF.Diff_active_ind := le.active_ind <> ri.active_ind;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_prov_id := COUNT(GROUP,%Closest%.Diff_prov_id);
    Count_Diff_prov_name := COUNT(GROUP,%Closest%.Diff_prov_name);
    Count_Diff_npi := COUNT(GROUP,%Closest%.Diff_npi);
    Count_Diff_prov_type_cd := COUNT(GROUP,%Closest%.Diff_prov_type_cd);
    Count_Diff_prov_type_name := COUNT(GROUP,%Closest%.Diff_prov_type_name);
    Count_Diff_prov_addr_str := COUNT(GROUP,%Closest%.Diff_prov_addr_str);
    Count_Diff_prov_addr_line_2 := COUNT(GROUP,%Closest%.Diff_prov_addr_line_2);
    Count_Diff_prov_addr_city := COUNT(GROUP,%Closest%.Diff_prov_addr_city);
    Count_Diff_prov_addr_st := COUNT(GROUP,%Closest%.Diff_prov_addr_st);
    Count_Diff_postal_cd := COUNT(GROUP,%Closest%.Diff_postal_cd);
    Count_Diff_prov_tele_num := COUNT(GROUP,%Closest%.Diff_prov_tele_num);
    Count_Diff_spec_cd := COUNT(GROUP,%Closest%.Diff_spec_cd);
    Count_Diff_prov_spec_desc := COUNT(GROUP,%Closest%.Diff_prov_spec_desc);
    Count_Diff_active_ind := COUNT(GROUP,%Closest%.Diff_active_ind);
