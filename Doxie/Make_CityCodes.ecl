...
--Other:
Make_CityCode				- search this - DONE
HASH((qstring				- search this - DONE
AutoHeaderI.JoinConditions - search this (done, although not sure why i think i care too much.)
AutoKeyI.JoinConditions - search this (seems unused)
dea_lib.ZipToCities - search this (DONE - DELETED)
ut.ZipToCities			- search this (DONE)
	many use set_codes and set_cities
...
CaseConnect_Services.FetchStCityName - lima

--Other Chad
DONE - autostandardi.interfacetranslator
DONE - ut.ZipToCities
DONE - AutoChad.Mod_Address_Scope
DONE - Gong_Services.Fetch_Gong_History
DONE - Header_Services.Fetch_Address_Function
DONE - Header_Services.Fetch_Address_MOXIE_Function
DONE - Header_Services.Fetch_Address_MOXIE_Loose_Function
DONE - Header_Services.Fetch_Header_StCityLFName_Function
DONE - progressive_phone.mac_get_same_apt_lname
DONE - progressive_phone.mac_get_type_f
...
DONE - AutoKeyI.JoinConditions
DONE - AutoKeyB.Fetch_StCityFLName - QA repos.  doesnt match dataland.  still used.  yes, needs update to interface logic.
DONE - AutokeyB2.Fetch_Address - no longer referenced.  trashed.
...
* There are other autokey build access points that Chad needs to retire.  

--Header Search
DONE - AutoHeaderI.FetchI_Hdr_Indv_Address
DONE - AutoHeaderI.FetchI_Hdr_Indv_DA
DONE - AutoHeaderI.FetchI_Hdr_Indv_StCityName
DONE - AutoHeaderI.FetchI_Hdr_Indv_Wild_Address
DONE - AutoHeaderI.FetchI_Hdr_Indv_Wild_StCityName
