...
doxie.MAC_fetch_watchdog(%fetched_glb%,did_stream,did_field,watchdog.Key_watchdog_glb,bestlayout);
#uniquename(fetched_glb_nonutil)
doxie.MAC_fetch_watchdog(%fetched_glb_nonutil%,did_stream,did_field,watchdog.Key_watchdog_glb_nonutil,bestlayout);
#uniquename(fetched_glb_nonutil_nonblank)
doxie.MAC_fetch_watchdog(%fetched_glb_nonutil_nonblank%,did_stream,did_field,watchdog.Key_watchdog_glb_nonutil_nonblank,bestlayout);
#uniquename(fetched_glb_nonexp)
doxie.MAC_fetch_watchdog(%fetched_glb_nonexp%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonExperian,bestlayout);
#uniquename(fetched_glb_noneq)
doxie.MAC_fetch_watchdog(%fetched_glb_noneq%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonEquifax,bestlayout); 
#uniquename(fetched_glb_nonexp_noneq)
doxie.MAC_fetch_watchdog(%fetched_glb_nonexp_noneq%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonExperian_nonEquifax,bestlayout); 
#uniquename(fetched_glb_nonblank)
doxie.MAC_fetch_watchdog(%fetched_glb_nonblank%,did_stream,did_field,watchdog.key_watchdog_glb_nonblank,bestlayout);
#uniquename(fetched_glb_nonexp_nonblank)
doxie.MAC_fetch_watchdog(%fetched_glb_nonexp_nonblank%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonExperian_nonblank,bestlayout);
#uniquename(fetched_glb_noneq_nonblank)
doxie.MAC_fetch_watchdog(%fetched_glb_noneq_nonblank%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonEquifax_nonblank,bestlayout); 
#uniquename(fetched_glb_noexp_noneq_nonblank)
doxie.MAC_fetch_watchdog(%fetched_glb_noexp_noneq_nonblank%,did_stream,did_field,watchdog.Key_Watchdog_GLB_nonExperian_nonEquifax_nonblank,bestlayout); 
#uniquename(fetched_nonglb)
doxie.MAC_fetch_watchdog(%fetched_nonglb%,did_stream,did_field,watchdog.Key_Watchdog_nonglb,bestlayout);
#uniquename(fetched_pre_glb)
doxie.MAC_fetch_watchdog(%fetched_pre_glb%,did_stream,did_field,Watchdog.Key_Watchdog_nonglb_V2,bestlayout);
#uniquename(fetched_nonglb_nonblank)
doxie.MAC_fetch_watchdog(%fetched_nonglb_nonblank%,did_stream,did_field,watchdog.key_watchdog_nonglb_nonblank,bestlayout);
#uniquename(fetched_pre_glb_nonblank)
doxie.MAC_fetch_watchdog(%fetched_pre_glb_nonblank%,did_stream,did_field,Watchdog.key_watchdog_nonglb_nonblank_V2,bestlayout);
#uniquename(fetched_marketing)
doxie.MAC_fetch_watchdog(%fetched_marketing%,did_stream,did_field,watchdog.Key_watchdog_marketing,bestlayout);
#uniquename(fetched_pre_glb_marketing)
doxie.MAC_fetch_watchdog(%fetched_pre_glb_marketing%,did_stream,did_field,Watchdog.Key_Watchdog_marketing_V2,bestlayout);
