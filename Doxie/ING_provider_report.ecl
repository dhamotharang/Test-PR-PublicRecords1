...
IMPORT AutoStandardI, doxie_files, ingenix_natlprof, Prof_licensev2_services, Healthcare_Header_Services,ut;
...
string provsrc := 'H': STORED('ProviderSrc');
...
layout setinput():=transform
	...
	self.providerSRC:=stringlib.StringToUpperCase(provsrc);
	self:=[]
end;
