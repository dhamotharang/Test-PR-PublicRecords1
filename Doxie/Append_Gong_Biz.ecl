import daybatcheda,ut;

export Append_Gong_Biz(dataset(Layout_Append_Gong_Biz.Layout_In) phones) :=
FUNCTION
	temp_norm_rec := record
		Layout_Append_Gong_Biz.Layout_In - [company_names];
	...
	temp_gong_phones0 := join(temp_norm,daybatcheda.Key_gong_phone,
	...
	temp_final := join(phones,temp_dedup,
		...
		transform(Layout_Append_Gong_Biz.Layout_Out,
