...
death_ready := table(Death_Master.File_DeathMaster_Building_ssa((unsigned6)did != 0), death_record /*and not [state_death_flag, death_rec_src]*/);
...
//build index on DID
export key_death_masterv2_ssa_did := index(dead_with_county_sort,
                               {unsigned6 l_did := (integer)did},{dead_with_county_sort},
				           data_services.data_location.prefix('Death')+'thor_data400::key::did_death_masterv2_ssa_'+doxie.Version_SuperKey);