...
autokey.MAC_Address(t,fname,mname,lname,
						ssn,
						dob,
						phone,
						...
						lookups,
						did,
						Data_Services.Data_Location.Person_header +'thor_data400::key::header.pname.prange.st.city.sec_range.lname',
						k)
export key_address := k;