...
*/
IMPORT Data_Services, dx_Banko, dx_Cortera, dx_Cortera_Tradeline, dx_EBR, dx_Property, Patriot, dx_Prof_License_Mari;
EXPORT EchoService := MACRO
  OUTPUT(CHOOSEN(dx_Prof_License_Mari.Key_Search_Delta_Rid(), 10), named('Prof_License_Mari_Key_Search_Delta_Rid'));
  OUTPUT(CHOOSEN(dx_Prof_License_Mari.Key_Regulatory_Actions_Delta_Rid(), 10), named('Prof_License_Mari_Key_Regulatory_Actions_Delta_Rid'));
  OUTPUT(CHOOSEN(dx_Prof_License_Mari.Key_Disciplinary_Actions_Delta_Rid(), 10), named('Prof_License_Mari_Key_Disciplinary_Actions_Delta_Rid'));
  OUTPUT(CHOOSEN(dx_Prof_License_Mari.Key_Individual_Detail_Delta_Rid(), 10), named('Prof_License_Mari_Key_Individual_Detail_Delta_Rid'));
