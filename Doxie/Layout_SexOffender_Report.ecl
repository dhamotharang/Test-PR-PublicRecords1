import address, sexoffender, doxie_build, doxie, FFD;

export layout_sexoffender_report := record, maxlength(200000)
   unsigned8	did := 0;
   unsigned1	score := 0;
   ...
   dataset(doxie.Layout_Sexoffender_Offense_Decode) offenses;
