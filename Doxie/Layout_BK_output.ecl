import doxie_crs, BankruptcyV2_Services;
export Layout_BK_Output := record 
	  integer   penalt := 0;
	...
	string4    trustee_zip4;
	  ...
	  dataset(layout_bk_child) debtor_records {maxcount (BankruptcyV2_Services.layouts.PARTIES_PER_ROLLUP)}; // currently 20
end;