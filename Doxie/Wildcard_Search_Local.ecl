import ut, vehicle_wildcard, drivers, doxie_raw, NID, VehicleV2_Services, suppress;
...
unsigned1	dppa_purpose := inMod.dppaPurpose; // defined for macro use
...
FT := VehicleV2_Services.Fn_Find(F,TRUE,,TRUE,inMod.IncludeCriminalIndicators,inMod.IncludeNonRegulatedSources).v1_ret;
...
ssn_mask_value := inMod.ssnMask; // defined for macro use
dl_mask_value  := inMod.dl_mask; // defined for macro use
