...
MAC_Address_Rollup(Rels1,Max_RelativeAddresses,Rels_Dn, isKnowx)
MAC_Address_Rollup(NS1,Addresses_PerNeighbor,NS_Dn)
MAC_Address_Rollup(NS2,Addresses_PerNeighbor,NS2_Dn)
...
//output(dn, named('dn'));
MAC_Address_Rollup(Dn,1000,res, isKnowx)
