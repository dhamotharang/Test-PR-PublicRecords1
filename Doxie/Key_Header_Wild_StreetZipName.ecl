...
export Key_Header_Wild_StreetZipName := INDEX(recs, 
                                              {recs},
                                              data_services.data_location.prefix() + 'thor_data400::key::header.wild.pname.zip.name.range_'+doxie.Version_SuperKey);