...
#uniquename(file1)
%file1%:=IF(ed_threshold1>0 AND LENGTH(TRIM((SALT310.StrType)infile1[1].infield1))<ed_threshold1,
...
#uniquename(file2)
%file2%:=IF(ed_threshold2>0 AND LENGTH(TRIM((SALT310.StrType)infile2[1].infield2))<ed_threshold2,
...
#uniquename(file3)
%file3%:=IF(ed_threshold3>0 AND LENGTH(TRIM((SALT310.StrType)infile3[1].infield3))<ed_threshold3,
...
#uniquename(file4)
%file4%:=IF(ed_threshold4>0 AND LENGTH(TRIM((SALT310.StrType)infile4[1].infield4))<ed_threshold4,
