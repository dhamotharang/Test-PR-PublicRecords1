...
EXPORT Data_Layout := RECORD
  SALT310.StrType Fld1 { MAXLENGTH(200000) };
	UNSIGNED2 FldNo1;
  SALT310.StrType Fld2 { MAXLENGTH(200000) };
	UNSIGNED2 FldNo2;
  END;
...
EXPORT Layout_Profile := RECORD
	SALT310.StrType Fld1;
	DATASET({SALT310.StrType Fld2, REAL Corr}) Correlations;
	END;
