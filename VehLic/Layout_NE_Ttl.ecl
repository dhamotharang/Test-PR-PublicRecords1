export Layout_NE_Ttl :=
  record
	...
	string18    orig_PREVIOUS_OWNER_CITY;
	string2     orig_PREVIOUS_OWNER_STATE;
	string5     orig_PREVIOUS_OWNER_ZIP1;
	string4     orig_PREVIOUS_OWNER_ZIP2;
	string35    orig_HOLDER_NAME;
	string35    orig_HOLDER_ADDRESS;
	string18    orig_HOLDER_CITY;
	string2     orig_HOLDER_STATE;
	string5     orig_HOLDER_ZIP1;
	string4     orig_HOLDER_ZIP2;
	string10    orig_NOTATION_DATE;
	string10    orig_RELEASE_DATE;
    string1     orig_LF;
