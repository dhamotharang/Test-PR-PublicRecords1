IMPORT ut,SALT34;
EXPORT hygiene(dataset(layout_In_NY) h) := MODULE
...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_key_pcnt *   0.00 / 100 + T.Populated_corp_vendor_pcnt *   0.00 / 100 + T.Populated_corp_state_origin_pcnt *   0.00 / 100 + T.Populated_corp_process_date_pcnt *   0.00 / 100 + T.Populated_corp_inc_state_pcnt *   0.00 / 100 + T.Populated_corp_forgn_date_pcnt *   0.00 / 100 + T.Populated_corp_filing_date_pcnt *   0.00 / 100 + T.Populated_corp_inc_date_pcnt *   0.00 / 100 + T.Populated_corp_term_exist_exp_pcnt *   0.00 / 100 + T.Populated_corp_merger_date_pcnt *   0.00 / 100 + T.Populated_corp_merger_effective_date_pcnt *   0.00 / 100 + T.Populated_corp_name_status_date_pcnt *   0.00 / 100 + T.Populated_corp_orig_sos_charter_nbr_pcnt *   0.00 / 100 + T.Populated_corp_legal_name_pcnt *   0.00 / 100 + T.Populated_corp_foreign_domestic_ind_pcnt *   0.00 / 100 + T.Populated_corp_for_profit_ind_pcnt *   0.00 / 100 + T.Populated_corp_ln_name_type_cd_pcnt *   0.00 / 100 + T.Populated_corp_ln_name_type_desc_pcnt *   0.00 / 100 + T.Populated_corp_status_desc_pcnt *   0.00 / 100 + T.Populated_corp_forgn_state_desc_pcnt *   0.00 / 100 + T.Populated_corp_merger_type_converted_to_cd_pcnt *   0.00 / 100 + T.Populated_InternalField1_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_vendor_first_reported_pcnt,le.populated_dt_vendor_last_reported_pcnt,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_corp_ra_dt_first_seen_pcnt,le.populated_corp_ra_dt_last_seen_pcnt,le.populated_corp_key_pcnt,le.populated_corp_vendor_pcnt,le.populated_corp_state_origin_pcnt,le.populated_corp_process_date_pcnt,le.populated_corp_inc_state_pcnt,le.populated_corp_forgn_date_pcnt,le.populated_corp_filing_date_pcnt,le.populated_corp_inc_date_pcnt,le.populated_corp_term_exist_exp_pcnt,le.populated_corp_merger_date_pcnt,le.populated_corp_merger_effective_date_pcnt,le.populated_corp_name_status_date_pcnt,le.populated_corp_orig_sos_charter_nbr_pcnt,le.populated_corp_legal_name_pcnt,le.populated_corp_foreign_domestic_ind_pcnt,le.populated_corp_for_profit_ind_pcnt,le.populated_corp_ln_name_type_cd_pcnt,le.populated_corp_ln_name_type_desc_pcnt,le.populated_corp_status_desc_pcnt,le.populated_corp_forgn_state_desc_pcnt,le.populated_corp_merger_type_converted_to_cd_pcnt,le.populated_InternalField1_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_corp_ra_dt_first_seen,le.maxlength_corp_ra_dt_last_seen,le.maxlength_corp_key,le.maxlength_corp_vendor,le.maxlength_corp_state_origin,le.maxlength_corp_process_date,le.maxlength_corp_inc_state,le.maxlength_corp_forgn_date,le.maxlength_corp_filing_date,le.maxlength_corp_inc_date,le.maxlength_corp_term_exist_exp,le.maxlength_corp_merger_date,le.maxlength_corp_merger_effective_date,le.maxlength_corp_name_status_date,le.maxlength_corp_orig_sos_charter_nbr,le.maxlength_corp_legal_name,le.maxlength_corp_foreign_domestic_ind,le.maxlength_corp_for_profit_ind,le.maxlength_corp_ln_name_type_cd,le.maxlength_corp_ln_name_type_desc,le.maxlength_corp_status_desc,le.maxlength_corp_forgn_state_desc,le.maxlength_corp_merger_type_converted_to_cd,le.maxlength_InternalField1);
  SELF.avelength := CHOOSE(C,le.avelength_dt_vendor_first_reported,le.avelength_dt_vendor_last_reported,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_corp_ra_dt_first_seen,le.avelength_corp_ra_dt_last_seen,le.avelength_corp_key,le.avelength_corp_vendor,le.avelength_corp_state_origin,le.avelength_corp_process_date,le.avelength_corp_inc_state,le.avelength_corp_forgn_date,le.avelength_corp_filing_date,le.avelength_corp_inc_date,le.avelength_corp_term_exist_exp,le.avelength_corp_merger_date,le.avelength_corp_merger_effective_date,le.avelength_corp_name_status_date,le.avelength_corp_orig_sos_charter_nbr,le.avelength_corp_legal_name,le.avelength_corp_foreign_domestic_ind,le.avelength_corp_for_profit_ind,le.avelength_corp_ln_name_type_cd,le.avelength_corp_ln_name_type_desc,le.avelength_corp_status_desc,le.avelength_corp_forgn_state_desc,le.avelength_corp_merger_type_converted_to_cd,le.avelength_InternalField1);
END;
...
SALT34.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT34.StrType)le.dt_vendor_first_reported),TRIM((SALT34.StrType)le.dt_vendor_last_reported),TRIM((SALT34.StrType)le.dt_first_seen),TRIM((SALT34.StrType)le.dt_last_seen),TRIM((SALT34.StrType)le.corp_ra_dt_first_seen),TRIM((SALT34.StrType)le.corp_ra_dt_last_seen),TRIM((SALT34.StrType)le.corp_key),TRIM((SALT34.StrType)le.corp_vendor),TRIM((SALT34.StrType)le.corp_state_origin),TRIM((SALT34.StrType)le.corp_process_date),TRIM((SALT34.StrType)le.corp_inc_state),TRIM((SALT34.StrType)le.corp_forgn_date),TRIM((SALT34.StrType)le.corp_filing_date),TRIM((SALT34.StrType)le.corp_inc_date),TRIM((SALT34.StrType)le.corp_term_exist_exp),TRIM((SALT34.StrType)le.corp_merger_date),TRIM((SALT34.StrType)le.corp_merger_effective_date),TRIM((SALT34.StrType)le.corp_name_status_date),TRIM((SALT34.StrType)le.corp_orig_sos_charter_nbr),TRIM((SALT34.StrType)le.corp_legal_name),TRIM((SALT34.StrType)le.corp_foreign_domestic_ind),TRIM((SALT34.StrType)le.corp_for_profit_ind),TRIM((SALT34.StrType)le.corp_ln_name_type_cd),TRIM((SALT34.StrType)le.corp_ln_name_type_desc),TRIM((SALT34.StrType)le.corp_status_desc),TRIM((SALT34.StrType)le.corp_forgn_state_desc),TRIM((SALT34.StrType)le.corp_merger_type_converted_to_cd),TRIM((SALT34.StrType)le.InternalField1)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{13,'corp_filing_date'}
      ,{14,'corp_inc_date'}
      ,{15,'corp_term_exist_exp'}
      ,{16,'corp_merger_date'}
      ,{17,'corp_merger_effective_date'}
      ,{18,'corp_name_status_date'}
      ,{19,'corp_orig_sos_charter_nbr'}
      ,{20,'corp_legal_name'}
      ,{21,'corp_foreign_domestic_ind'}
      ,{22,'corp_for_profit_ind'}
      ,{23,'corp_ln_name_type_cd'}
      ,{24,'corp_ln_name_type_desc'}
      ,{25,'corp_status_desc'}
      ,{26,'corp_forgn_state_desc'}
      ,{27,'corp_merger_type_converted_to_cd'}
      ,{28,'InternalField1'}],SALT34.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_InternalField1((SALT34.StrType)le.InternalField1,(SALT34.StrType)le.corp_ln_name_type_cd),
    0);
...
PrettyErrorTotals := RECORD
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_corp_vendor(TotalErrors.ErrorNum),Fields.InValidMessage_corp_state_origin(TotalErrors.ErrorNum),Fields.InValidMessage_corp_process_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_state(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_filing_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_term_exist_exp(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_effective_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_name_status_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_sos_charter_nbr(TotalErrors.ErrorNum),Fields.InValidMessage_corp_legal_name(TotalErrors.ErrorNum),Fields.InValidMessage_corp_foreign_domestic_ind(TotalErrors.ErrorNum),Fields.InValidMessage_corp_for_profit_ind(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ln_name_type_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ln_name_type_desc(TotalErrors.ErrorNum),Fields.InValidMessage_corp_status_desc(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_state_desc(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_type_converted_to_cd(TotalErrors.ErrorNum),Fields.InValidMessage_InternalField1(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
