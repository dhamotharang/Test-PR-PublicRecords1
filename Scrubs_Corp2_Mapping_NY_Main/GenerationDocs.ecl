...
Command line options: -MScrubs_Corp2_Mapping_NY_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFRE6DA.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_NY_Main
FILENAME:In_NY
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(4..11)
FIELDTYPE:invalid_corp_vendor:ENUM(36)
FIELDTYPE:invalid_state_origin:ENUM(NY)
FIELDTYPE:invalid_charter:ALLOW(0123456789):LENGTHS(1..8)
...
FIELDTYPE:invalid_name_type_cd:ENUM(01|02|10|11|DP|P|NS| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|PRIOR|DBA|CURRENT PARTNERSHIP NAME|ORIGINAL PARTNERSHIP NAME|DBA PRIOR|NON-SURVIVOR| )
FIELDTYPE:invalid_corp_status_desc:ENUM(ACTIVE|INACTIVE| )
...
FIELDTYPE:invalid_corp_merger_type_converted_to_cd:ENUM(set_of_merger_cds)
FIELDTYPE:invalid_InternalField1:CUSTOM(Scrubs_Corp2_Mapping_NY_Main.Functions.invalid_doccode>0,corp_ln_name_type_cd)
...
FIELD:corp_merger_type_converted_to_cd:TYPE(STRING4):LIKE(invalid_corp_merger_type_converted_to_cd):0,0
FIELD:InternalField1:TYPE(STRING100):LIKE(invalid_InternalField1):0,0
 
//FIELDS NOT BEING SCRUBBED
// FIELD:corp_comment:TYPE(STRING300):LIKE(invalid_corp_comment):0,0
// DATEFIELD:cont_effective_date:TYPE(STRING8):0,0
