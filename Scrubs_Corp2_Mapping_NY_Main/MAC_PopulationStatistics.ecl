...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_dt_vendor_first_reported = '',Input_dt_vendor_last_reported = '',Input_dt_first_seen = '',Input_dt_last_seen = '',Input_corp_ra_dt_first_seen = '',Input_corp_ra_dt_last_seen = '',Input_corp_key = '',Input_corp_vendor = '',Input_corp_state_origin = '',Input_corp_process_date = '',Input_corp_inc_state = '',Input_corp_forgn_date = '',Input_corp_filing_date = '',Input_corp_inc_date = '',Input_corp_term_exist_exp = '',Input_corp_merger_date = '',Input_corp_merger_effective_date = '',Input_corp_name_status_date = '',Input_corp_orig_sos_charter_nbr = '',Input_corp_legal_name = '',Input_corp_foreign_domestic_ind = '',Input_corp_for_profit_ind = '',Input_corp_ln_name_type_cd = '',Input_corp_ln_name_type_desc = '',Input_corp_status_desc = '',Input_corp_forgn_state_desc = '',Input_corp_merger_type_converted_to_cd = '',Input_InternalField1 = '',OutFile) := MACRO
