EXPORT files := MODULE
  ...
  //EXPORT file_acquireweb_email_ind_dedup    :=  DATASET('~thor::in::acquireweb::individuals', layouts.layout_Acquireweb_Email_Individuals,THOR) : PERSIST('~thor::persist::acquireweb::ind_in');
	...
	//EXPORT file_Acquireweb_Email_Emails				:=	DATASET('~thor::in::acquireweb::emails', layouts.layout_Acquireweb_Email_Emails,THOR);
