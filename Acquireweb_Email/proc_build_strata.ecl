EXPORT proc_build_strata(STRING version) := FUNCTION
  IMPORT STRATA;
	...
	basefile:=Acquireweb_Email.files.file_Acquireweb_Base;
    ...
    activecode_CountNonBlank				 					:= SUM(GROUP,IF(basefile.activecode<>'',1,0));
	...
	strata.createXMLStats(basestrata,'Acquireweb stats','data',version,'',strataResults);
