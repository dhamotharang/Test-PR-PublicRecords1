...
#workunit('name','Acquireweb_Email.BWR_Ingest - Ingest - SALT V3.11.4');
IMPORT Acquireweb_Email,SALT311;
//If you are not ingesting as part of a header build you can use the below;
//Set incremental to TRUE to run an incremental ingest mode
MyDelta := DATASET([],Acquireweb_Email.Layout_Acquireweb);
ingestMod := Acquireweb_Email.Ingest(FALSE, MyDelta);
f_AllRecords := '~temp::RCID::Acquireweb_Email::ingest::AllRecords';
f_ActiveRecords := '~temp::RCID::Acquireweb_Email::ingest::ActiveRecords';
