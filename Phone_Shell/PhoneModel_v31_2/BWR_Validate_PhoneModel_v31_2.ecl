...
SHARED Layouts := PhoneModel_v31_2.z_layouts;
...
SHARED lzFilePathFolder  := '/data/LUCI/PhoneModel_v31_2/';
SHARED CSVSprayFile := '~njj::in::phonemodel_v31_2-validation-file-100k.csv';
SHARED lzFilePath        := lzFilePathFolder + CSVSprayFile;
SHARED SprayCSVName      := '~njj::in::phonemodel_v31_2-validation-file-100k.csv'; // Will set up by user if test file is a logical file.
...
SHARED isCSVFile := TRUE;
  //PhoneModel_v31_2.FNSpray(LandingZoneIP, lzFilePath, SprayCSVName, CSVSpraySeparator, CSVSprayQuote);
/******************************************************************************\
...
SHARED RawInputSet := PROJECT(RawInputSet0, TRANSFORM(Layouts.Input_Layouts, SELF.do_PhoneModel_v31_2 := TRUE, SELF := LEFT));
...
output(pLUCIresults.Base(), NAMED('LuciResultsBase'));
...
\******************************************************************************/
  ...
  output(LUCI_Points_Assignments_Pre, NAMED('LuciResultsValidationF'));
