...
EXPORT Layout_Sources := RECORD
 ...
 STRING400 Source_List_All_Last_Seen := ''; // same, maybe change to qstrings for space saving?
...
EXPORT Layout_PhonesPlus_Characteristics := RECORD
 ...
 QSTRING100 PhonesPlus_DID_Score_List := '';
 UNSIGNED1  PhonesPlus_DID_Count := 0;
 QSTRING100 PhonesPlus_Household_Flags := '';
 STRING50   PhonesPlus_Listing_Name  := '';
 QSTRING200 PhonesPlus_DateFirstSeen := '';
 QSTRING200 PhonesPlus_DateLastSeen  := '';
 QSTRING200 PhonesPlus_DateVendorFirstSeen  := '';
 QSTRING200 PhonesPlus_DateVendorLastSeen   := '';
 STRING8    PhonesPlus_Phone_Last_Seen_Diff_DID := '';
 STRING8    PhonesPlus_Phone_Vendor_Last_Seen_Diff_DID := '';
 QSTRING200 PhonesPlus_Date_NonGLB_LastSeen := '';
 QSTRING100 PhonesPlus_GLB_DPPA_Flag := '';
 ...
 QSTRING150 PhonesPlus_Src_List := '';
 ...
 QSTRING200 PhonesPlus_First_Build_Date := '';
 QSTRING200 PhonesPlus_Last_Build_Date  := '';
END;
...
EXPORT Layout_Phone_Shell_Plus := RECORD
 ...
 Layout_Metadata                        Metadata; // Metadata added in v3.0
