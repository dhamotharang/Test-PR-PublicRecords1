...
EXPORT Phone_Shell.Layout_Modeling_Shell_v30 To_Modeling_Shell_v30(DATASET(Phone_Shell.Layout_Phone_Shell.Phone_Shell_Layout) Shell, STRING50 DataRestrictionMask) := FUNCTION
 Phone_Shell.Layout_Modeling_Shell_v30 toShell(Phone_Shell.Layout_Phone_Shell.Phone_Shell_Layout le) := TRANSFORM
  isFCRA := FALSE; // The Phone Shell is Non-FCRA Only
		
  // Phone Shell Fields
  self.psversion := 30; // phone shell version 3.0
