/*2018-01-16T21:23:52Z (Andrea Koenen)
RR-11911: Changes for Experian removal - changed layout name for Bureau to not be same as in phone shell layout
*/
/*
	This modeling shell is for use by the Modeling team in Minneapolis for version 11.
 SAS requires that all field names be less than 32 characters
	...
	modeling layout which SAS can read in.  Phone_Shell.To_Modeling_Shell_v11 is used to convert the Phone Shell to this layout.
*/
...
EXPORT Layout_Modeling_Shell_v11 := RECORD
