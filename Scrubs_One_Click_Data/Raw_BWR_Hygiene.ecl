...
#workunit('name','Scrubs_One_Click_Data.Raw_BWR_Hygiene - Hygiene & Stats - SALT V3.11.7');
IMPORT Scrubs_One_Click_Data,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_One_Click_Data.Raw_In_One_Click_Data;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_One_Click_Data.Raw_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Raw_Layout_One_Click_Data'),NAMED('OptimizedLayout'));// File layout suggested by data
