...
OptionalInfo := oshair.files().input.OptionalInfo.sprayed;
...
dsAllOptInfo						:=	distribute((OSHAIR.file_out_optional_info_cleaned + ds_Optional_Information),hash32(Activity_Number));
