...
// #workunit ('name', 'build OSHAIR bid autokeys');
dbase := OSHAIR.file_out_inspection_cleaned_bid (Continuation_Flag = ''
...
ak_keyname := '~thor_data400::key::oshair::@version@::autokey::bid::';
ak_logical := '~thor_data400::key::oshair::' + filedate +'::autokey::bid::';
