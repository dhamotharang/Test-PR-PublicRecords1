...
export Key_OSHAIR_hazardous_substance := index(NewKeyBuild
                                              ,{Activity_Number}
											  ,{NewKeyBuild}
											  ,Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::oshair::hazardous_substance_'+doxie.Version_SuperKey);
