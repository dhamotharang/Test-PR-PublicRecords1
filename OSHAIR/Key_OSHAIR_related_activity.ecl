...
export Key_OSHAIR_related_activity := index(NewKeyBuild
                                           ,{Activity_Number}
										   ,{NewKeyBuild}
										   ,Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::oshair::related_activity_'+doxie.Version_SuperKey);
