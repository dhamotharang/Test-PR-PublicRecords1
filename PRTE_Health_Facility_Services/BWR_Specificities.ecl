...
#workunit('name','PRTE_Health_Facility_Services.BWR_Specificities - Specificities - SALT V2.9 Gold SR1');
IMPORT PRTE_Health_Facility_Services,SALT29;
IMPORT SALTTOOLS22;
SpecMod := PRTE_Health_Facility_Services.specificities(PRTE_Health_Facility_Services.File_HealthFacility);
...
// SALTTOOLS22.mac_Patch_SPC(SpecMod.Specificities,'PRTE_Health_Facility_Services.<your_spc_attribute>',PRTE_Health_Facility_Services.File_HealthFacility);
