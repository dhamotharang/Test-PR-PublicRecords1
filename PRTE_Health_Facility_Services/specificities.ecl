...
EXPORT input_file := h0 : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::Specificities_Cache',EXPIRE(30));
//We have LNPID specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LNPID;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LNPID,LOCAL) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::Cluster_Sizes',EXPIRE(30));
EXPORT TotalClusters := COUNT(ClusterSizes);
SHARED  CNP_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNP_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CNP_NAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT CNP_NAMEValuesKeyName :=  PRTE_Health_Facility_Services.Files.FILE_BName_Values; //'~'+'key::PRTE_Health_Facility_Services::LNPID::Word::CNP_NAME';
...
SHARED  CNP_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNP_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CNP_NUMBER',EXPIRE(30)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_NUMBER_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_NUMBER_temp',EXPIRE(30));
SHARED  CNP_STORE_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNP_STORE_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CNP_STORE_NUMBER',EXPIRE(30)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_STORE_NUMBER_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_STORE_NUMBER_temp',EXPIRE(30));
SHARED  CNP_BTYPE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNP_BTYPE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CNP_BTYPE',EXPIRE(30)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_BTYPE_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_BTYPE_temp',EXPIRE(30));
SHARED  CNP_LOWV_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNP_LOWV) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CNP_LOWV',EXPIRE(30)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_LOWV_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_LOWV_temp',EXPIRE(30));
SHARED  PRIM_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_RANGE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::PRIM_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PRIM_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::PRIM_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SEC_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SEC_RANGE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::SEC_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  V_CITY_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,V_CITY_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::V_CITY_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ST_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ST) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::ST',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ZIP_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ZIP) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::ZIP',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAX_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAX_ID) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::TAX_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FEIN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FEIN) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::FEIN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PHONE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PHONE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::PHONE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FAX_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FAX) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::FAX',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LIC_STATE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LIC_STATE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::LIC_STATE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  C_LIC_NBR_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,C_LIC_NBR) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::C_LIC_NBR',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DEA_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DEA_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::DEA_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  VENDOR_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,VENDOR_ID) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::VENDOR_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  NPI_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,NPI_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::NPI_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CLIA_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CLIA_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::CLIA_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  MEDICARE_FACILITY_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MEDICARE_FACILITY_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::MEDICARE_FACILITY_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  MEDICAID_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MEDICAID_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::MEDICAID_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  NCPDP_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,NCPDP_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::NCPDP_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAXONOMY_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAXONOMY) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::TAXONOMY',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAXONOMY_CODE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAXONOMY_CODE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::TAXONOMY_CODE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BDID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BDID) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::BDID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SRC_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SRC) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::SRC',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SOURCE_RID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SOURCE_RID) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::SOURCE_RID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FAC_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FAC_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::FAC_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDR1_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDR1) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::ADDR1',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LOCALE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LOCALE) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::LOCALE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDRES_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDRES) : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::dedups::ADDRES',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT CNP_NAME_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_NAME',EXPIRE(30));
...
EXPORT CNP_NUMBER_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_NUMBER',EXPIRE(30));
...
EXPORT CNP_STORE_NUMBER_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_STORE_NUMBER',EXPIRE(30));
...
EXPORT CNP_BTYPE_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_BTYPE',EXPIRE(30));
...
EXPORT CNP_LOWV_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Facility_Services::values::CNP_LOWV',EXPIRE(30));
