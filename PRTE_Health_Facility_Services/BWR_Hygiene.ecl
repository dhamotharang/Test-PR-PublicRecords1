...
#workunit('name','PRTE_Health_Facility_Services.BWR_Hygiene - Hygiene & Stats - SALT V2.9 Gold SR1');
IMPORT PRTE_Health_Facility_Services,SALT29;
// First create an instantiated hygiene module
  h := PRTE_Health_Facility_Services.Hygiene(PRTE_Health_Facility_Services.File_HealthFacility);
  ...
  CM := PRTE_Health_Facility_Services.Fields.UIDConsistency(PRTE_Health_Facility_Services.File_HealthFacility);
