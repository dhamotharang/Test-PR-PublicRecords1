...
EXPORT KeyName := PRTE_Health_Facility_Services.Files.FILE_ADDR_NPI; //'~'+'key::PRTE_Health_Facility_Services::LNPID::Refs::ADDR_NPI';
...
#IF(#TEXT(Input_NPI_NUMBER)<>'')
  #uniquename(trans)
  PRTE_Health_Facility_Services.Key_HealthFacility_ADDR_NPI.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := PRTE_Health_Facility_Services.Key_HealthFacility_ADDR_NPI.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
