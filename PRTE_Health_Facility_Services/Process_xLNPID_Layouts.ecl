...
EXPORT KeyName := PRTE_Health_Facility_Services.Files.FILE_Header; //'~'+'key::PRTE_Health_Facility_Services::LNPID::meow';
EXPORT Key := INDEX(h,{LNPID},{h},KeyName);
EXPORT BuildAll := SEQUENTIAL(BUILDINDEX(Key, PRTE_Health_Facility_Services.Files.FILE_Header,OVERWRITE));
