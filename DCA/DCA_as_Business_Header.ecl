...
bh_layout Translate_dca_To_BHF(Layout_dca_Local L, integer CTR) := transform
  ...
  SELF.city := CHOOSE(CTR, L.p_city_name, L.p_city_nameA);
...
dca_clean_rollup := ROLLUP(dca_clean_sort,
                    ...
                    LOCAL) : PERSIST('TEMP::dca_Company_Rollup');

EXPORT DCA_as_Business_Header := dca_clean_rollup;