...
layouts.IOInformation		xformIOInfomation(files.basefile L) := transform
		self.powid															:= L.powid;
		...
		self.record_type												:= L.IndividualOwner_Segment_Identifier;
...
EXPORT File_IOInformation := project(files.basefile(IndividualOwner_Address_Segment_Identifier <> ''), xformIOInfomation(left));