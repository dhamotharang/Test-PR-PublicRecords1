import PRTE2_BIPV2_BusHeader, PRTE2_BIPV2_SBFE, BIPV2, PromoteSupers;
...
// SBFE Best Key Base Files
  ...
  PromoteSupers.MAC_SF_BuildProcess(dBestSBFEFile, prte2_business_credit.constants.base_prefix + 'sbfe', sbfe_out);	
	
	export File_SBFE := sInBase;
