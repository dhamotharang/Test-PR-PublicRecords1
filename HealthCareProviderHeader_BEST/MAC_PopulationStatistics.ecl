EXPORT MAC_PopulationStatistics(infile,Ref='',Input_SSN = '',Input_CNSMR_SSN = '',Input_UPIN = '',Input_VENDOR_ID = '',Input_DID = '',Input_NPI_NUMBER = '',Input_BILLING_NPI_NUMBER = '',Input_DEA_NUMBER = '',Input_MAINNAME = '',Input_FULLNAME = '',Input_PHONE = '',Input_FAX = '',Input_ADDRESS = '',Input_LIC_NBR = '',Input_C_LIC_NBR = '',Input_ADDR1 = '',Input_DOB = '',Input_CNSMR_DOB = '',Input_PRIM_NAME = '',Input_ZIP = '',Input_LOCALE = '',Input_PRIM_RANGE = '',Input_V_CITY_NAME = '',Input_FNAME = '',Input_MNAME = '',Input_TAXONOMY = '',Input_SNAME = '',Input_LNAME = '',Input_SEC_RANGE = '',Input_LIC_TYPE = '',Input_ST = '',Input_GENDER = '',Input_DERIVED_GENDER = '',Input_SRC = '',Input_ADDRESS_ID = '',Input_CNAME = '',Input_TAX_ID = '',Input_BILLING_TAX_ID = '',Input_GEO_LAT = '',Input_GEO_LONG = '',Input_DT_FIRST_SEEN = '',Input_DT_LAST_SEEN = '',Input_DT_LIC_EXPIRATION = '',Input_DT_DEA_EXPIRATION = '',Input_LIC_STATE = '',OutFile) := MACRO
