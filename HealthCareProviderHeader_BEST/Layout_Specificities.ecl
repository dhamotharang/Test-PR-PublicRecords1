...
export LIC_TYPE_ChildRec := record
  typeof(l.LIC_TYPE) LIC_TYPE;
  unsigned8 cnt;
  unsigned4 id;
end;
...
EXPORT R := RECORD,MAXLENGTH(32000)
 UNSIGNED1 dummy;
  ...
  real4 LIC_TYPE_specificity;
  real4 LIC_TYPE_switch;
  real4 LIC_TYPE_max;
  dataset(LIC_TYPE_ChildRec) nulls_LIC_TYPE {MAXCOUNT(100)};
