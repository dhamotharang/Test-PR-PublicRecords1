...
EXPORT SpecificitiesDebugKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::HealthCareProviderHeader_BEST::LNPID::MatchHistory';
...
EXPORT MatchHistoryKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::History::Match';
  MH := MatchHistoryFile;
...
EXPORT InDataKeyName := '~'+'key::HealthCareProviderHeader_BEST::LNPID::Datafile::in_data';
