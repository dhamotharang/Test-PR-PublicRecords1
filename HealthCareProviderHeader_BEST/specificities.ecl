...
EXPORT input_layout := RECORD // project out required fields
  ...
  h.CNSMR_DOB_flag; // Flag to be filled in as part of Best processing
  h.SSN;
  h.SSN_flag; // Flag to be filled in as part of Best processing
  h.CNSMR_SSN;
  h.CNSMR_SSN_flag; // Flag to be filled in as part of Best processing
  h.DID;
  ...
  TYPEOF(h.LIC_NBR) LIC_NBR := (TYPEOF(h.LIC_NBR))Fields.Make_LIC_NBR((SALT29.StrType)h.LIC_NBR ); // Cleans before using
  ...
  h.BILLING_TAX_ID_flag; // Flag to be filled in as part of Best processing
  ...
  h.BILLING_NPI_NUMBER_flag; // Flag to be filled in as part of Best processing
  ...
  h.TAXONOMY_flag; // Flag to be filled in as part of Best processing
...
EXPORT input_file := h0 : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Specificities_Cache',EXPIRE(30));
//We have LNPID specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LNPID;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LNPID,LOCAL) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Cluster_Sizes',EXPIRE(30));
EXPORT TotalClusters := COUNT(ClusterSizes);
SHARED  DOB_year_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_year) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DOB_year',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DOB_month_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_month) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DOB_month',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DOB_day_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_day) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DOB_day',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_year_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_year) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::CNSMR_DOB_year',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_month_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_month) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::CNSMR_DOB_month',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_day_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_day) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::CNSMR_DOB_day',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SSN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SSN) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::SSN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_SSN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_SSN) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::CNSMR_SSN',EXPIRE(30)); // Reduce to field values by UID
  ...
  r1 := RECORD
    counted;
    UNSIGNED4 id := 0; // Used to identify value later
    STRING4 CNSMR_SSN_Right4 := fn_Right4(counted.CNSMR_SSN); // Compute fn_Right4 value for CNSMR_SSN
  end;
  with_id := table(counted,r1);
  SALT29.MAC_Field_Accumulate_Counts(with_id,CNSMR_SSN_Right4,Right4_cnt,fuzzies_counted0)
  ut.MAC_Sequence_Records(fuzzies_counted0,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
...
SHARED  DID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DID) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::SNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::FNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT FNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::FNAME_temp',EXPIRE(30));
SHARED  MNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::MNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT MNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::MNAME_temp',EXPIRE(30));
SHARED  LNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::LNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT LNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::LNAME_temp',EXPIRE(30));
SHARED  GENDER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,GENDER) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::GENDER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DERIVED_GENDER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DERIVED_GENDER) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DERIVED_GENDER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LIC_NBR_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LIC_NBR) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::LIC_NBR',EXPIRE(30)); // Reduce to field values by UID
  SALT29.Mac_Field_Count_UID(LIC_NBR_deduped,LIC_NBR,LNPID,counted,counted_clusters) // count the number of UIDs with each field value
  r1 := RECORD
    counted;
    UNSIGNED4 id := 0; // Used to identify value later
  end;
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
  SALT29.mac_edit_distance_pairs(specs_added,LIC_NBR,cnt,1,false,distance_computed);//Computes specificities of fuzzy matches
EXPORT LIC_NBR_values_persisted := distance_computed;
SHARED  C_LIC_NBR_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,C_LIC_NBR) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::C_LIC_NBR',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PHONE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PHONE) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::PHONE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FAX_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FAX) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::FAX',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PRIM_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_NAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::PRIM_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PRIM_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_RANGE) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::PRIM_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SEC_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SEC_RANGE) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::SEC_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  V_CITY_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,V_CITY_NAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::V_CITY_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ST_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ST) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::ST',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ZIP_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ZIP) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::ZIP',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAX_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAX_ID) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::TAX_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BILLING_TAX_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BILLING_TAX_ID) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::BILLING_TAX_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  UPIN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,UPIN) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::UPIN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  NPI_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,NPI_NUMBER) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::NPI_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BILLING_NPI_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BILLING_NPI_NUMBER) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::BILLING_NPI_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DEA_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DEA_NUMBER) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::DEA_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAXONOMY_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAXONOMY) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::TAXONOMY',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  VENDOR_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,VENDOR_ID) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::VENDOR_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LIC_TYPE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LIC_TYPE) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::LIC_TYPE',EXPIRE(30)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT29.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT LIC_TYPE_values_persisted := specs_added;
...
EXPORT LAT_LONG_values_persisted := LAT_LONG_ll_range : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::ll_range::LAT_LONG',EXPIRE(30));
EXPORT LAT_LONG_max := MAX(LAT_LONG_values_persisted,field_specificity);
SHARED  MAINNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MAINNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::MAINNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FULLNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FULLNAME) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::FULLNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDR1_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDR1) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::ADDR1',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LOCALE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LOCALE) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::LOCALE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDRESS_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDRESS) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::dedups::ADDRESS',EXPIRE(30)); // Reduce to field values by UID
...
SALT29.MAC_Concept3_Specificities(MAINNAME_cnt,FNAME_values_persisted_temp,FNAME,e1_cnt,MNAME_values_persisted_temp,MNAME,e2_cnt,LNAME_values_persisted_temp,LNAME,e2_cnt,ofile)
EXPORT FNAME_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::FNAME',EXPIRE(30));
...
SALT29.MAC_Concept3_Specificities(MAINNAME_cnt,MNAME_values_persisted_temp,MNAME,e2_cnt,FNAME_values_persisted_temp,FNAME,e1_cnt,LNAME_values_persisted_temp,LNAME,e2_cnt,ofile)
EXPORT MNAME_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::MNAME',EXPIRE(30));
...
SALT29.MAC_Concept3_Specificities(MAINNAME_cnt,LNAME_values_persisted_temp,LNAME,e2_cnt,FNAME_values_persisted_temp,FNAME,e1_cnt,MNAME_values_persisted_temp,MNAME,e2_cnt,ofile)
EXPORT LNAME_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::values::LNAME',EXPIRE(30));
...
SALT29.MAC_Field_Nulls(LIC_NBR_values_persisted,Layout_Specificities.LIC_NBR_ChildRec,nv) // Use automated NULL spotting
EXPORT LIC_NBR_nulls := nv;
SALT29.MAC_Field_Bfoul(LIC_NBR_deduped,LIC_NBR,LNPID,LIC_NBR_nulls,ClusterSizes,false,false,bf) // Compute the chances of a field having 2 values for one entity
EXPORT LIC_NBR_switch := bf;
EXPORT LIC_NBR_max := MAX(LIC_NBR_values_persisted,field_specificity);
SALT29.MAC_Field_Specificity(LIC_NBR_values_persisted,LIC_NBR,LIC_NBR_nulls,ol) // Compute column level specificity
...
SALT29.MAC_Field_Nulls(LIC_TYPE_values_persisted,Layout_Specificities.LIC_TYPE_ChildRec,nv) // Use automated NULL spotting
EXPORT LIC_TYPE_nulls := nv;
...
iSpecificities := DATASET([{0,DOB_year_specificity,DOB_year_switch,DOB_year_max,DOB_year_nulls,DOB_month_specificity,DOB_month_switch,DOB_month_max,DOB_month_nulls,DOB_day_specificity,DOB_day_switch,DOB_day_max,DOB_day_nulls,CNSMR_DOB_year_specificity,CNSMR_DOB_year_switch,CNSMR_DOB_year_max,CNSMR_DOB_year_nulls,CNSMR_DOB_month_specificity,CNSMR_DOB_month_switch,CNSMR_DOB_month_max,CNSMR_DOB_month_nulls,CNSMR_DOB_day_specificity,CNSMR_DOB_day_switch,CNSMR_DOB_day_max,CNSMR_DOB_day_nulls,SSN_specificity,SSN_switch,SSN_max,SSN_nulls,CNSMR_SSN_specificity,CNSMR_SSN_switch,CNSMR_SSN_max,CNSMR_SSN_nulls,DID_specificity,DID_switch,DID_max,DID_nulls,SNAME_specificity,SNAME_switch,SNAME_max,SNAME_nulls,FNAME_specificity,FNAME_switch,FNAME_max,FNAME_nulls,MNAME_specificity,MNAME_switch,MNAME_max,MNAME_nulls,LNAME_specificity,LNAME_switch,LNAME_max,LNAME_nulls,GENDER_specificity,GENDER_switch,GENDER_max,GENDER_nulls,DERIVED_GENDER_specificity,DERIVED_GENDER_switch,DERIVED_GENDER_max,DERIVED_GENDER_nulls,LIC_NBR_specificity,LIC_NBR_switch,LIC_NBR_max,LIC_NBR_nulls,C_LIC_NBR_specificity,C_LIC_NBR_switch,C_LIC_NBR_max,C_LIC_NBR_nulls,PHONE_specificity,PHONE_switch,PHONE_max,PHONE_nulls,FAX_specificity,FAX_switch,FAX_max,FAX_nulls,PRIM_NAME_specificity,PRIM_NAME_switch,PRIM_NAME_max,PRIM_NAME_nulls,PRIM_RANGE_specificity,PRIM_RANGE_switch,PRIM_RANGE_max,PRIM_RANGE_nulls,SEC_RANGE_specificity,SEC_RANGE_switch,SEC_RANGE_max,SEC_RANGE_nulls,V_CITY_NAME_specificity,V_CITY_NAME_switch,V_CITY_NAME_max,V_CITY_NAME_nulls,ST_specificity,ST_switch,ST_max,ST_nulls,ZIP_specificity,ZIP_switch,ZIP_max,ZIP_nulls,TAX_ID_specificity,TAX_ID_switch,TAX_ID_max,TAX_ID_nulls,BILLING_TAX_ID_specificity,BILLING_TAX_ID_switch,BILLING_TAX_ID_max,BILLING_TAX_ID_nulls,UPIN_specificity,UPIN_switch,UPIN_max,UPIN_nulls,NPI_NUMBER_specificity,NPI_NUMBER_switch,NPI_NUMBER_max,NPI_NUMBER_nulls,BILLING_NPI_NUMBER_specificity,BILLING_NPI_NUMBER_switch,BILLING_NPI_NUMBER_max,BILLING_NPI_NUMBER_nulls,DEA_NUMBER_specificity,DEA_NUMBER_switch,DEA_NUMBER_max,DEA_NUMBER_nulls,TAXONOMY_specificity,TAXONOMY_switch,TAXONOMY_max,TAXONOMY_nulls,VENDOR_ID_specificity,VENDOR_ID_switch,VENDOR_ID_max,VENDOR_ID_nulls,LIC_TYPE_specificity,LIC_TYPE_switch,LIC_TYPE_max,LIC_TYPE_nulls,LAT_LONG_specificity,LAT_LONG_switch,LAT_LONG_max,LAT_LONG_nulls,MAINNAME_specificity,MAINNAME_switch,MAINNAME_max,MAINNAME_nulls,FULLNAME_specificity,FULLNAME_switch,FULLNAME_max,FULLNAME_nulls,ADDR1_specificity,ADDR1_switch,ADDR1_max,ADDR1_nulls,LOCALE_specificity,LOCALE_switch,LOCALE_max,LOCALE_nulls,ADDRESS_specificity,ADDRESS_switch,ADDRESS_max,ADDRESS_nulls}],Layout_Specificities.R) : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Specificities',EXPIRE(30));
...
// Not sure what to do amount a DATE switch yet - MAX of all? 
  ...
  integer1 CNSMR_SSN_shift0 := ROUND(Specificities[1].CNSMR_SSN_specificity - 24);
  integer2 CNSMR_SSN_switch_shift0 := ROUND(1000*Specificities[1].CNSMR_SSN_switch - 0);
  integer1 DID_shift0 := ROUND(Specificities[1].DID_specificity - 23);
  integer2 DID_switch_shift0 := ROUND(1000*Specificities[1].DID_switch - 249);
  integer1 SNAME_shift0 := ROUND(Specificities[1].SNAME_specificity - 7);
  integer2 SNAME_switch_shift0 := ROUND(1000*Specificities[1].SNAME_switch - 8);
  integer1 FNAME_shift0 := ROUND(Specificities[1].FNAME_specificity - 8);
  integer2 FNAME_switch_shift0 := ROUND(1000*Specificities[1].FNAME_switch - 24);
  integer1 MNAME_shift0 := ROUND(Specificities[1].MNAME_specificity - 8);
  integer2 MNAME_switch_shift0 := ROUND(1000*Specificities[1].MNAME_switch - 37);
  integer1 LNAME_shift0 := ROUND(Specificities[1].LNAME_specificity - 7);
  integer2 LNAME_switch_shift0 := ROUND(1000*Specificities[1].LNAME_switch - 74);
  integer1 GENDER_shift0 := ROUND(Specificities[1].GENDER_specificity - 2);
  integer2 GENDER_switch_shift0 := ROUND(1000*Specificities[1].GENDER_switch - 4);
  integer1 DERIVED_GENDER_shift0 := ROUND(Specificities[1].DERIVED_GENDER_specificity - 1);
  integer2 DERIVED_GENDER_switch_shift0 := ROUND(1000*Specificities[1].DERIVED_GENDER_switch - 3);
  integer1 LIC_NBR_shift0 := ROUND(Specificities[1].LIC_NBR_specificity - 20);
  integer2 LIC_NBR_switch_shift0 := ROUND(1000*Specificities[1].LIC_NBR_switch - 265);
  integer1 C_LIC_NBR_shift0 := ROUND(Specificities[1].C_LIC_NBR_specificity - 20);
  integer2 C_LIC_NBR_switch_shift0 := ROUND(1000*Specificities[1].C_LIC_NBR_switch - 265);
  integer1 PHONE_shift0 := ROUND(Specificities[1].PHONE_specificity - 21);
  integer2 PHONE_switch_shift0 := ROUND(1000*Specificities[1].PHONE_switch - 485);
  integer1 FAX_shift0 := ROUND(Specificities[1].FAX_specificity - 21);
  integer2 FAX_switch_shift0 := ROUND(1000*Specificities[1].FAX_switch - 265);
  integer1 PRIM_NAME_shift0 := ROUND(Specificities[1].PRIM_NAME_specificity - 13);
  integer2 PRIM_NAME_switch_shift0 := ROUND(1000*Specificities[1].PRIM_NAME_switch - 607);
  integer1 PRIM_RANGE_shift0 := ROUND(Specificities[1].PRIM_RANGE_specificity - 12);
  integer2 PRIM_RANGE_switch_shift0 := ROUND(1000*Specificities[1].PRIM_RANGE_switch - 586);
  integer1 SEC_RANGE_shift0 := ROUND(Specificities[1].SEC_RANGE_specificity - 7);
  integer2 SEC_RANGE_switch_shift0 := ROUND(1000*Specificities[1].SEC_RANGE_switch - 355);
  integer1 V_CITY_NAME_shift0 := ROUND(Specificities[1].V_CITY_NAME_specificity - 11);
  integer2 V_CITY_NAME_switch_shift0 := ROUND(1000*Specificities[1].V_CITY_NAME_switch - 445);
  integer1 ST_shift0 := ROUND(Specificities[1].ST_specificity - 5);
  integer2 ST_switch_shift0 := ROUND(1000*Specificities[1].ST_switch - 156);
  integer1 ZIP_shift0 := ROUND(Specificities[1].ZIP_specificity - 13);
  integer2 ZIP_switch_shift0 := ROUND(1000*Specificities[1].ZIP_switch - 534);
  ...
  integer1 BILLING_TAX_ID_shift0 := ROUND(Specificities[1].BILLING_TAX_ID_specificity - 0);
  integer2 BILLING_TAX_ID_switch_shift0 := ROUND(1000*Specificities[1].BILLING_TAX_ID_switch - 0);
  ...
  integer1 NPI_NUMBER_shift0 := ROUND(Specificities[1].NPI_NUMBER_specificity - 23);
  integer2 NPI_NUMBER_switch_shift0 := ROUND(1000*Specificities[1].NPI_NUMBER_switch - 0);
  integer1 BILLING_NPI_NUMBER_shift0 := ROUND(Specificities[1].BILLING_NPI_NUMBER_specificity - 23);
  integer2 BILLING_NPI_NUMBER_switch_shift0 := ROUND(1000*Specificities[1].BILLING_NPI_NUMBER_switch - 0);
  integer1 DEA_NUMBER_shift0 := ROUND(Specificities[1].DEA_NUMBER_specificity - 23);
  integer2 DEA_NUMBER_switch_shift0 := ROUND(1000*Specificities[1].DEA_NUMBER_switch - 94);
  integer1 TAXONOMY_shift0 := ROUND(Specificities[1].TAXONOMY_specificity - 8);
  integer2 TAXONOMY_switch_shift0 := ROUND(1000*Specificities[1].TAXONOMY_switch - 97);
  integer1 VENDOR_ID_shift0 := ROUND(Specificities[1].VENDOR_ID_specificity - 24);
  integer2 VENDOR_ID_switch_shift0 := ROUND(1000*Specificities[1].VENDOR_ID_switch - 685);
  integer1 LIC_TYPE_shift0 := ROUND(Specificities[1].LIC_TYPE_specificity - 7);
  integer2 LIC_TYPE_switch_shift0 := ROUND(1000*Specificities[1].LIC_TYPE_switch - 582);
  ...
  integer2 MAINNAME_switch_shift0 := ROUND(1000*Specificities[1].MAINNAME_switch - 296);
  integer1 FULLNAME_shift0 := ROUND(Specificities[1].FULLNAME_specificity - 23);
  integer2 FULLNAME_switch_shift0 := ROUND(1000*Specificities[1].FULLNAME_switch - 300);
  integer1 ADDR1_shift0 := ROUND(Specificities[1].ADDR1_specificity - 20);
  integer2 ADDR1_switch_shift0 := ROUND(1000*Specificities[1].ADDR1_switch - 643);
  integer1 LOCALE_shift0 := ROUND(Specificities[1].LOCALE_specificity - 13);
  integer2 LOCALE_switch_shift0 := ROUND(1000*Specificities[1].LOCALE_switch - 536);
  integer1 ADDRESS_shift0 := ROUND(Specificities[1].ADDRESS_specificity - 21);
  integer2 ADDRESS_switch_shift0 := ROUND(1000*Specificities[1].ADDRESS_switch - 646);
  END;
...
// Service functions for specificity profiling
  ...
  SALT29.MAC_Specificity_Values(LIC_NBR_values_persisted,LIC_NBR,'LIC_NBR',LIC_NBR_specificity,LIC_NBR_specificity_profile);
