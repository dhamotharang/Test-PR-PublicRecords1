...
SHARED Candidates_NPI_NUMBER := Candidates_NPI_NUMBER_ni : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Cleave::Candidates_NPI_NUMBER',EXPIRE(30));
SHARED Possibles_NPI_NUMBER := Possibles_NPI_NUMBER_ni : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Cleave::Possibles_NPI_NUMBER',EXPIRE(30));
...
SHARED Candidates_UPIN := Candidates_UPIN_ni : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Cleave::Candidates_UPIN',EXPIRE(30));
SHARED Possibles_UPIN := Possibles_UPIN_ni : PERSIST('~temp::LNPID::HealthCareProviderHeader_BEST::Cleave::Possibles_UPIN',EXPIRE(30));
// Now construct a function that will perform the cleaves
