...
#workunit('name','HealthCareProviderHeader_BEST.BWR_Hygiene - Hygiene & Stats - SALT V2.9 Beta 3');
IMPORT HealthCareProviderHeader_BEST,SALT29;
// First create an instantiated hygiene module
  h := HealthCareProviderHeader_BEST.Hygiene(HealthCareProviderHeader_BEST.In_HealthProvider);
  ...
  CM := HealthCareProviderHeader_BEST.Fields.UIDConsistency(HealthCareProviderHeader_BEST.In_HealthProvider);
