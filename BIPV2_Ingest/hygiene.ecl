...
SALT35.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),125*125,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'source'}
      ...
      ,{42,'name_score'}
      ,{43,'company_name'}
      ,{44,'company_name_type_raw'}
      ,{45,'company_name_type_derived'}
      ,{46,'company_rawaid'}
      ,{47,'prim_range'}
      ,{48,'predir'}
      ,{49,'prim_name'}
      ...
      ,{73,'err_stat'}
      ,{74,'company_bdid'}
      ,{75,'company_address_type_raw'}
      ,{76,'company_fein'}
      ,{77,'best_fein_indicator'}
      ,{78,'company_phone'}
      ,{79,'phone_type'}
      ,{80,'phone_score'}
      ,{81,'company_org_structure_raw'}
      ,{82,'company_incorporation_date'}
      ,{83,'company_sic_code1'}
      ,{84,'company_sic_code2'}
      ,{85,'company_sic_code3'}
      ,{86,'company_sic_code4'}
      ,{87,'company_sic_code5'}
      ,{88,'company_naics_code1'}
      ,{89,'company_naics_code2'}
      ,{90,'company_naics_code3'}
      ,{91,'company_naics_code4'}
      ,{92,'company_naics_code5'}
      ,{93,'company_ticker'}
      ,{94,'company_ticker_exchange'}
      ,{95,'company_foreign_domestic'}
      ,{96,'company_url'}
      ,{97,'company_inc_state'}
      ,{98,'company_charter_number'}
      ,{99,'company_filing_date'}
      ,{100,'company_status_date'}
      ,{101,'company_foreign_date'}
      ,{102,'event_filing_date'}
      ,{103,'company_name_status_raw'}
      ,{104,'company_status_raw'}
      ,{105,'vl_id'}
      ,{106,'current'}
      ,{107,'contact_did'}
      ,{108,'contact_type_raw'}
      ,{109,'contact_job_title_raw'}
      ,{110,'contact_ssn'}
      ,{111,'contact_dob'}
      ,{112,'contact_status_raw'}
      ,{113,'contact_email'}
      ,{114,'contact_email_username'}
      ,{115,'contact_email_domain'}
      ,{116,'contact_phone'}
      ,{117,'from_hdr'}
      ,{118,'company_department'}
      ,{119,'company_address_type_derived'}
      ,{120,'company_org_structure_derived'}
      ,{121,'company_name_status_derived'}
      ,{122,'company_status_derived'}
      ,{123,'contact_type_derived'}
      ,{124,'contact_job_title_derived'}
      ,{125,'contact_status_derived'}],SALT35.MAC_Character_Counts.Field_Identification);
...
END;
Errors := NORMALIZE(h,125,NoteErrors(LEFT,COUNTER));
