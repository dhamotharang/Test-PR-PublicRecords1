...
Export Layout_Equifax_Infile := Module
//Use input files starting from 20140101
Export NewLayout := Record
				String2	FIPS_State_Code;
				String5	ZIP_Code;
				String4	ZIPPlus_4;
				...
				String4	MSAs;
				String4	Blank_Space2;
				String4	DMA;
				String1	Nielson_County_Size_Code;
				String3	Area_Code_All_Available;
				String7	Telephone_All_Available;
				String1	Record_Quality_Code;
				String1	AddressName_Censor_Code;
				String1	Address_Quality_Code;
				String1	Address_Type;
				String1	File_Code;
				String1	AdvHome_Owner;
				String1	AdvHome_Owner_Indicator;
				String2	Household_Type_Code;
				String1	AdvHousehold_Marital_Status;
				String1	AdvHousehold_Marital_Status_Indicator;
				String1	AdvDwelling_Type;
				String1	AdvDwelling_Type_Indicator;
				String1	AdvLength_of_Residence;
				String1	AdvLength_of_Residence_Indicator;
				String4	Year_Home_Built;
				String6	Verification_Date_of_Household;
				String2	Blank_Space3;
				String2	Number_of_Sources_Verifying_Household;
				String1	AdvHousehold_Income_Identifier;
				String1	AdvHousehold_Income_Identifier_Indicator;
				//Niches20 is renamed to Niches_30 in vendor's field definition 11/5/13
				String3	Niches_30;
				String1	Mail_Order_Buyer;
				//String1	Mail_Order_Donor;													//Field deleted and replaced by blank space. 11/5/13
				String1 Blank_Space_220_220;
				String2	Occupation;
				//String1	Blank_Space4;															//Field deleted and replaced by blank space(s). 11/5/13
				//String4	Combined_Market_Value_of_All_Vehicles;		//Field deleted and replaced by blank space(s). 11/5/13
				//String1	Number_of_Cars_Currently_Registered_Owned;//Field deleted and replaced by blank space(s). 11/5/13
				//String1	Truck_Owner_Code;													//Field deleted and replaced by blank space(s). 11/5/13
				//String1	New_Vehicle_Purchase_Code;								//Field deleted and replaced by blank space(s). 11/5/13
				//String1	Motorcycle_Ownership_Code;								//Field deleted and replaced by blank space(s). 11/5/13
				//String1	Recreational_Vehicle_Ownership_Code;			//Field deleted and replaced by blank space(s). 11/5/13
				String10	Blank_Space_223_232;
				String1	AdvHousehold_Age;
				String1	AdvHousehold_Age_Indicator;
				String1	AdvHousehold_Size;
				String1	AdvHousehold_Size_Indicator;
				String1	AdvNumber_of_Adults;
				String1	AdvNumber_of_Adults_Indicator;
				...
				STRING7 US_Census_Tract_Block_Group;								//US_Census_Tract_Identifier_2000+Census_Tract_Suffix+Block_Group_Number. 11/5/13
				String10	Blank_Space6;
				//String2	US_Census_State_Code_2000;	
				//String3	US_Census_County_Code_2000;
				String2	US_Census_State_Code_2010;									//New field replacing US_Census_State_Code_2000. 11/5/13				
				String3	US_Census_County_Code_2010;									//New field replacing US_Census_County_Code_2000. 11/5/13
				String1	Record_Type;																//['1','2','3']. It is called level code now.
				//String3	Median_Household_Income_3_bytes;					//Replaced by Median_Household_Income. 11/5/13
				STRING3 Blank_Space_416_418;
				...
				String2	ManagementBusinessFinancial_Operations;
				String2	Owner_Occupied_Housing_Units;
				String2	Single_Unit_Structures;
				//String4	Median_Home_Value_4_bytes;								//Replaced by Median_Home_Value. 11/5/13
				STRING4 Blank_Space_433_436;
				String2	Owner_Occ_Structures_Built_Since_1990;
				String2	Persons_Move_In_Since_1995;
				//String2	Households_With_1Vehicles;								//Replaced by Number_of_Vehicles_Available. 11/5/13
				STRING2 Blank_Space_441_442;
				String2	White_Alone;
				String1	Blank_Space7;
				String5	CBSA_Code;
				String6	Blank_Space8;
				String1	TCC_American_Express;
				String1	TCC_Any_Credit_Card;
				String1	TCC_Bank_Card;
				String1	TCC_Catalog_Showroom;
				String1	TCC_ComputerElectronic;
				String1	TCC_Debit_Card;
				String1	TCC_Finance_Co_Card;
				String1	TCC_Furniture;
				String1	TCC_Grocery;
				String1	TCC_Home_Improvement;
				String1	TCC_HomeOffice_Supply;
				String1	TCC_Low_End_Department_Store;
				String1	TCC_Main_Street_Retail;
				String1	TCC_Mastercard;
				String1	TCC_Membership_Warehouse;
				String1	TCC_Miscellaneous;
				String1	TCC_Oil_Gas_Card;
				String1	TCC_Specialty_Apparel;
				String1	TCC_Sporting_Goods;
				String1	TCC_Standard_Retail;
				String1	TCC_Standard_Specialty_Card;
				String1	TCC_Travel_Entertainment;
				String1	TCC_TV_Mail_Order;
				String1	TCC_Upscale_Retail;
				String1	TCC_Upscale_Spec_Retail;
				String1	TCC_Visa;
				String1	AdvHousehold_Education;
				String1	AdvHousehold_Education_Indicator;
				String1	Narrow_Band_Household_Income_Identifier;
				STRING6 Median_Household_Income;   									//New field replacing Median_Household_Income_3_bytes. 11/5/2013
				STRING7 Median_Home_Value;													//New field replacing Median_Home_Value_4_bytes. 11/5/13
				STRING3 Number_of_Vehicles_Available; 							//New field replacing Households_With_1Vehicles. 11/5/13
				String2	lf;
End;

Export CombinedLayout := Record
				String2	State_Code;
				String5	ZIP_Code;   
				String4	ZIPPlus_4;
				String3	Delivery_Point_Code;
				...
				//Input field (mail_order_donor) is not available starting 2014
				...
				//Input fields are not available starting 2014
				String10	Blank_Space10;
				...
				//String2	US_Census_State_Code_2000;
				//String3	US_Census_County_Code_2000;
				//Following 2 fields replace US_Census_State_Code_2000 and US_Census_County_Code_2000
				String2	US_Census_State_Code_2010;
				String3	US_Census_County_Code_2010;
				String1	Record_Type;
				String1	Smacs_2000_Level;
				//This data will not be populated by vendor starting from 2014 deliveries 11/5/13 Cathy
				...
				//New fields starting from 2014. 11/5/2013
				STRING6 Median_Household_Income;							// 6 digits midian household income e.g. 065585
				STRING7 Median_Home_Value;										// 7 digits midian home value. e.g. 0125999
				STRING3 Number_of_Vehicles_Available; 				// 3 digits  number of vehicles. e.g. 002
				String2 lf;
End;
