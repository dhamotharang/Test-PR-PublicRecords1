...
EXPORT FromNone(DATASET(Layout_InFile_) h) := MODULE
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.provider_id_Invalid := Fields.InValid_provider_id((SALT31.StrType)le.provider_id);
    SELF.npi_Invalid := Fields.InValid_npi((SALT31.StrType)le.npi);
    SELF.taxonomy_Invalid := Fields.InValid_taxonomy((SALT31.StrType)le.taxonomy);
    SELF.provider_name_Invalid := Fields.InValid_provider_name((SALT31.StrType)le.provider_name);
    SELF.provider_address_Invalid := Fields.InValid_provider_address((SALT31.StrType)le.provider_address);
    SELF.phone_Invalid := Fields.InValid_phone((SALT31.StrType)le.phone);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.did_Invalid << 0 ) + ( le.did_score_Invalid << 3 ) + ( le.bdid_Invalid << 6 ) + ( le.bdid_score_Invalid << 9 ) + ( le.best_dob_Invalid << 12 ) + ( le.best_ssn_Invalid << 15 ) + ( le.data_state_Invalid << 18 ) + ( le.provider_id_Invalid << 21 ) + ( le.npi_Invalid << 24 ) + ( le.taxonomy_Invalid << 27 ) + ( le.provider_name_Invalid << 30 ) + ( le.provider_address_Invalid << 32 ) + ( le.phone_Invalid << 34 ) + ( le.entity_type_code_Invalid << 37 ) + ( le.firstname_Invalid << 40 ) + ( le.lastname_Invalid << 41 ) + ( le.companyname_Invalid << 43 ) + ( le.src_Invalid << 45 ) + ( le.dt_vendor_first_reported_Invalid << 48 ) + ( le.dt_vendor_last_reported_Invalid << 51 ) + ( le.dt_first_seen_Invalid << 54 ) + ( le.dt_last_seen_Invalid << 57 ) + ( le.record_type_Invalid << 60 );
    SELF.ScrubsBits2 := ( le.source_rid_Invalid << 0 ) + ( le.lnpid_Invalid << 3 ) + ( le.title_Invalid << 6 ) + ( le.fname_Invalid << 9 ) + ( le.mname_Invalid << 11 ) + ( le.lname_Invalid << 14 ) + ( le.name_suffix_Invalid << 16 ) + ( le.name_type_Invalid << 19 ) + ( le.nid_Invalid << 22 ) + ( le.clean_clinic_name_Invalid << 25 ) + ( le.prepped_addr1_Invalid << 28 ) + ( le.prepped_addr2_Invalid << 30 ) + ( le.prim_range_Invalid << 32 ) + ( le.predir_Invalid << 34 ) + ( le.prim_name_Invalid << 37 ) + ( le.addr_suffix_Invalid << 39 ) + ( le.postdir_Invalid << 41 ) + ( le.unit_desig_Invalid << 44 ) + ( le.sec_range_Invalid << 46 ) + ( le.p_city_name_Invalid << 48 ) + ( le.v_city_name_Invalid << 50 ) + ( le.st_Invalid << 52 ) + ( le.zip_Invalid << 55 ) + ( le.zip4_Invalid << 58 ) + ( le.cart_Invalid << 61 );
    SELF.ScrubsBits3 := ( le.cr_sort_sz_Invalid << 0 ) + ( le.lot_Invalid << 3 ) + ( le.lot_order_Invalid << 6 ) + ( le.dbpc_Invalid << 9 ) + ( le.chk_digit_Invalid << 12 ) + ( le.rec_type_Invalid << 15 ) + ( le.fips_st_Invalid << 18 ) + ( le.fips_county_Invalid << 21 ) + ( le.geo_lat_Invalid << 24 ) + ( le.geo_long_Invalid << 27 ) + ( le.msa_Invalid << 30 ) + ( le.geo_blk_Invalid << 33 ) + ( le.geo_match_Invalid << 36 ) + ( le.err_stat_Invalid << 39 ) + ( le.rawaid_Invalid << 42 ) + ( le.aceaid_Invalid << 45 ) + ( le.clean_phone_Invalid << 48 ) + ( le.dotid_Invalid << 51 ) + ( le.dotscore_Invalid << 54 ) + ( le.dotweight_Invalid << 57 ) + ( le.empid_Invalid << 60 );
    SELF.ScrubsBits4 := ( le.empscore_Invalid << 0 ) + ( le.empweight_Invalid << 3 ) + ( le.powid_Invalid << 6 ) + ( le.powscore_Invalid << 9 ) + ( le.powweight_Invalid << 12 ) + ( le.proxid_Invalid << 15 ) + ( le.proxscore_Invalid << 18 ) + ( le.proxweight_Invalid << 21 ) + ( le.seleid_Invalid << 24 ) + ( le.selescore_Invalid << 27 ) + ( le.seleweight_Invalid << 30 ) + ( le.orgid_Invalid << 33 ) + ( le.orgscore_Invalid << 36 ) + ( le.orgweight_Invalid << 39 ) + ( le.ultid_Invalid << 42 ) + ( le.ultscore_Invalid << 45 ) + ( le.ultweight_Invalid << 48 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.provider_id_Invalid := (le.ScrubsBits1 >> 21) & 7;
    SELF.npi_Invalid := (le.ScrubsBits1 >> 24) & 7;
    SELF.taxonomy_Invalid := (le.ScrubsBits1 >> 27) & 7;
    SELF.provider_name_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.provider_address_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.phone_Invalid := (le.ScrubsBits1 >> 34) & 7;
    SELF.entity_type_code_Invalid := (le.ScrubsBits1 >> 37) & 7;
    SELF.firstname_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.lastname_Invalid := (le.ScrubsBits1 >> 41) & 3;
    SELF.companyname_Invalid := (le.ScrubsBits1 >> 43) & 3;
    ...
    SELF.prim_range_Invalid := (le.ScrubsBits2 >> 32) & 3;
    SELF.predir_Invalid := (le.ScrubsBits2 >> 34) & 7;
    SELF.prim_name_Invalid := (le.ScrubsBits2 >> 37) & 3;
    SELF.addr_suffix_Invalid := (le.ScrubsBits2 >> 39) & 3;
    SELF.postdir_Invalid := (le.ScrubsBits2 >> 41) & 7;
    SELF.unit_desig_Invalid := (le.ScrubsBits2 >> 44) & 3;
    SELF.sec_range_Invalid := (le.ScrubsBits2 >> 46) & 3;
    SELF.p_city_name_Invalid := (le.ScrubsBits2 >> 48) & 3;
    SELF.v_city_name_Invalid := (le.ScrubsBits2 >> 50) & 3;
    SELF.st_Invalid := (le.ScrubsBits2 >> 52) & 7;
    SELF.zip_Invalid := (le.ScrubsBits2 >> 55) & 7;
    SELF.zip4_Invalid := (le.ScrubsBits2 >> 58) & 7;
    SELF.cart_Invalid := (le.ScrubsBits2 >> 61) & 7;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits3 >> 0) & 7;
    SELF.lot_Invalid := (le.ScrubsBits3 >> 3) & 7;
    SELF.lot_order_Invalid := (le.ScrubsBits3 >> 6) & 7;
    SELF.dbpc_Invalid := (le.ScrubsBits3 >> 9) & 7;
    SELF.chk_digit_Invalid := (le.ScrubsBits3 >> 12) & 7;
    SELF.rec_type_Invalid := (le.ScrubsBits3 >> 15) & 7;
    SELF.fips_st_Invalid := (le.ScrubsBits3 >> 18) & 7;
    SELF.fips_county_Invalid := (le.ScrubsBits3 >> 21) & 7;
    SELF.geo_lat_Invalid := (le.ScrubsBits3 >> 24) & 7;
    SELF.geo_long_Invalid := (le.ScrubsBits3 >> 27) & 7;
    SELF.msa_Invalid := (le.ScrubsBits3 >> 30) & 7;
    SELF.geo_blk_Invalid := (le.ScrubsBits3 >> 33) & 7;
    SELF.geo_match_Invalid := (le.ScrubsBits3 >> 36) & 7;
    SELF.err_stat_Invalid := (le.ScrubsBits3 >> 39) & 7;
    SELF.rawaid_Invalid := (le.ScrubsBits3 >> 42) & 7;
    SELF.aceaid_Invalid := (le.ScrubsBits3 >> 45) & 7;
    SELF.clean_phone_Invalid := (le.ScrubsBits3 >> 48) & 7;
    SELF.dotid_Invalid := (le.ScrubsBits3 >> 51) & 7;
    SELF.dotscore_Invalid := (le.ScrubsBits3 >> 54) & 7;
    SELF.dotweight_Invalid := (le.ScrubsBits3 >> 57) & 7;
    SELF.empid_Invalid := (le.ScrubsBits3 >> 60) & 7;
    SELF.empscore_Invalid := (le.ScrubsBits4 >> 0) & 7;
    SELF.empweight_Invalid := (le.ScrubsBits4 >> 3) & 7;
    SELF.powid_Invalid := (le.ScrubsBits4 >> 6) & 7;
    SELF.powscore_Invalid := (le.ScrubsBits4 >> 9) & 7;
    SELF.powweight_Invalid := (le.ScrubsBits4 >> 12) & 7;
    SELF.proxid_Invalid := (le.ScrubsBits4 >> 15) & 7;
    SELF.proxscore_Invalid := (le.ScrubsBits4 >> 18) & 7;
    SELF.proxweight_Invalid := (le.ScrubsBits4 >> 21) & 7;
    SELF.seleid_Invalid := (le.ScrubsBits4 >> 24) & 7;
    SELF.selescore_Invalid := (le.ScrubsBits4 >> 27) & 7;
    SELF.seleweight_Invalid := (le.ScrubsBits4 >> 30) & 7;
    SELF.orgid_Invalid := (le.ScrubsBits4 >> 33) & 7;
    SELF.orgscore_Invalid := (le.ScrubsBits4 >> 36) & 7;
    SELF.orgweight_Invalid := (le.ScrubsBits4 >> 39) & 7;
    SELF.ultid_Invalid := (le.ScrubsBits4 >> 42) & 7;
    SELF.ultscore_Invalid := (le.ScrubsBits4 >> 45) & 7;
    SELF.ultweight_Invalid := (le.ScrubsBits4 >> 48) & 7;
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,Into(LEFT));
END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    provider_id_LEFTTRIM_ErrorCount := COUNT(GROUP,h.provider_id_Invalid=1);
    provider_id_ALLOW_ErrorCount := COUNT(GROUP,h.provider_id_Invalid=2);
    provider_id_LENGTH_ErrorCount := COUNT(GROUP,h.provider_id_Invalid=3);
    provider_id_WORDS_ErrorCount := COUNT(GROUP,h.provider_id_Invalid=4);
    provider_id_Total_ErrorCount := COUNT(GROUP,h.provider_id_Invalid>0);
    ...
    taxonomy_LENGTH_ErrorCount := COUNT(GROUP,h.taxonomy_Invalid=3);
    taxonomy_WORDS_ErrorCount := COUNT(GROUP,h.taxonomy_Invalid=4);
    ...
    provider_address_LEFTTRIM_ErrorCount := COUNT(GROUP,h.provider_address_Invalid=1);
    provider_address_ALLOW_ErrorCount := COUNT(GROUP,h.provider_address_Invalid=2);
    provider_address_Total_ErrorCount := COUNT(GROUP,h.provider_address_Invalid>0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.provider_id_Invalid,'LEFTTRIM','ALLOW','LENGTH','WORDS','UNKNOWN')
          ,CHOOSE(le.npi_Invalid,'LEFTTRIM','ALLOW','LENGTH','WORDS','UNKNOWN')
          ,CHOOSE(le.taxonomy_Invalid,'LEFTTRIM','ALLOW','LENGTH','WORDS','UNKNOWN')
          ,CHOOSE(le.provider_name_Invalid,'LEFTTRIM','ALLOW','UNKNOWN')
          ,CHOOSE(le.provider_address_Invalid,'LEFTTRIM','ALLOW','UNKNOWN')
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT31.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'provider_id:provider_id:LEFTTRIM','provider_id:provider_id:ALLOW','provider_id:provider_id:LENGTH','provider_id:provider_id:WORDS'
          ,'npi:npi:LEFTTRIM','npi:npi:ALLOW','npi:npi:LENGTH','npi:npi:WORDS'
          ,'taxonomy:taxonomy:LEFTTRIM','taxonomy:taxonomy:ALLOW','taxonomy:taxonomy:LENGTH','taxonomy:taxonomy:WORDS'
          ,'provider_name:provider_name:LEFTTRIM','provider_name:provider_name:ALLOW'
          ,'provider_address:provider_address:LEFTTRIM','provider_address:provider_address:ALLOW'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_provider_id(1),Fields.InvalidMessage_provider_id(2),Fields.InvalidMessage_provider_id(3),Fields.InvalidMessage_provider_id(4)
          ,Fields.InvalidMessage_npi(1),Fields.InvalidMessage_npi(2),Fields.InvalidMessage_npi(3),Fields.InvalidMessage_npi(4)
          ,Fields.InvalidMessage_taxonomy(1),Fields.InvalidMessage_taxonomy(2),Fields.InvalidMessage_taxonomy(3),Fields.InvalidMessage_taxonomy(4)
          ,Fields.InvalidMessage_provider_name(1),Fields.InvalidMessage_provider_name(2)
          ,Fields.InvalidMessage_provider_address(1),Fields.InvalidMessage_provider_address(2)
          ...
          ,Fields.InvalidMessage_firstname(1)
          ...
          ,Fields.InvalidMessage_unit_desig(1),Fields.InvalidMessage_unit_desig(2)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.provider_id_LEFTTRIM_ErrorCount,le.provider_id_ALLOW_ErrorCount,le.provider_id_LENGTH_ErrorCount,le.provider_id_WORDS_ErrorCount
          ,le.npi_LEFTTRIM_ErrorCount,le.npi_ALLOW_ErrorCount,le.npi_LENGTH_ErrorCount,le.npi_WORDS_ErrorCount
          ,le.taxonomy_LEFTTRIM_ErrorCount,le.taxonomy_ALLOW_ErrorCount,le.taxonomy_LENGTH_ErrorCount,le.taxonomy_WORDS_ErrorCount
          ,le.provider_name_LEFTTRIM_ErrorCount,le.provider_name_ALLOW_ErrorCount
          ,le.provider_address_LEFTTRIM_ErrorCount,le.provider_address_ALLOW_ErrorCount
    ...
    END;
    SummaryInfo := NORMALIZE(SummaryStats,311,Into(LEFT,COUNTER));
    orb_r := RECORD
      AllErrors.Src;
