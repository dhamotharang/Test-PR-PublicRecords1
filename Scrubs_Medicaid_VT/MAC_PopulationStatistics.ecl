...
+    #IF( #TEXT(Input_data_state)='' )
    ...
    #END
+    #IF( #TEXT(Input_provider_id)='' )
      '' 
    #ELSE
        IF( le.Input_provider_id = (TYPEOF(le.Input_provider_id))'','',':provider_id')
    #END
+    #IF( #TEXT(Input_npi)='' )
      '' 
    #ELSE
...
+    #IF( #TEXT(Input_provider_name)='' )
    ...
    #END
+    #IF( #TEXT(Input_provider_address)='' )
      '' 
    #ELSE
        IF( le.Input_provider_address = (TYPEOF(le.Input_provider_address))'','',':provider_address')
    #END
+    #IF( #TEXT(Input_phone)='' )
      '' 
    #ELSE
