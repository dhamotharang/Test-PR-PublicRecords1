...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_supp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_date_type_cd','invalid_date_type_desc');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_supp_key' => 2,'invalid_charter_nbr' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_future_date' => 8,'invalid_date_type_cd' => 9,'invalid_date_type_desc' => 10,0);
...
EXPORT MakeFT_invalid_date_type_cd(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_cd(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['FIL','EFF',' ']);
EXPORT InValidMessageFT_invalid_date_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('FIL|EFF| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_desc(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['FILING','EFFECTIVE',' ']);
EXPORT InValidMessageFT_invalid_date_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('FILING|EFFECTIVE| '),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','LENGTHS'],[],['ENUM'],[],[],['ENUM'],['ALLOW','CUSTOM'],['ALLOW','LENGTHS'],['LENGTHS'],[],['ALLOW','CUSTOM'],['ENUM'],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]);
...
EXPORT Make_event_filing_reference_nbr(SALT311.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_event_filing_reference_nbr(SALT311.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_event_date_type_cd(SALT311.StrType s0) := MakeFT_invalid_date_type_cd(s0);
EXPORT InValid_event_date_type_cd(SALT311.StrType s) := InValidFT_invalid_date_type_cd(s);
EXPORT InValidMessage_event_date_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_date_type_cd(wh);
 
EXPORT Make_event_date_type_desc(SALT311.StrType s0) := MakeFT_invalid_date_type_desc(s0);
EXPORT InValid_event_date_type_desc(SALT311.StrType s) := InValidFT_invalid_date_type_desc(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Corp2_Mapping_NV_Event;
