...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_supp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_date_type_cd','invalid_date_type_desc');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_supp_key' => 2,'invalid_charter_nbr' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_date_type_cd' => 8,'invalid_date_type_desc' => 9,0);
...
EXPORT Make_event_filing_reference_nbr(SALT32.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_event_filing_reference_nbr(SALT32.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_event_filing_reference_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_NV_Event;
