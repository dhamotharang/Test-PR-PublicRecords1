...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_NV_Event';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh\n'
    + 'MODULE:Scrubs_Corp2_Mapping_NV_Event\n'
    + 'FILENAME:In_NV\n'
    ...
    + 'FIELDTYPE:invalid_corp_supp_key:ALLOW( 0123456789-)\n'
    ...
    + 'FIELDTYPE:invalid_date_type_cd:ENUM(FIL|EFF| )\n'
    + 'FIELDTYPE:invalid_date_type_desc:ENUM(FILING|EFFECTIVE| )\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
    ...
    + 'FIELD:event_filing_reference_nbr:TYPE(STRING30):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:event_amendment_nbr:TYPE(STRING3):0,0\n'
    + 'FIELD:event_filing_date:TYPE(STRING8):LIKE(invalid_future_date):0,0\n'
    + 'FIELD:event_date_type_cd:TYPE(STRING3):LIKE(invalid_date_type_cd):0,0\n'
    + 'FIELD:event_date_type_desc:TYPE(STRING30):LIKE(invalid_date_type_desc):0,0\n'
