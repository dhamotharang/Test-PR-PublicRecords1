...
import ut, codes, suppress, prte2_risktable, doxie, dx_header;
...
infile %addSsnRisk%(%recentRec% le, prte2_risktable.keys.key_ssn_table_v4_2 ri) :=
TRANSFORM
...
#uniquename(via_key1)
%via_key1% := JOIN (%ssn_validity%, prte2_risktable.keys.key_ssn_table_v4_2,
