...
EXPORT Constants := Module
  shared prefix := if(_Control.ThisEnvironment.Name = 'Dataland', Data_Services.foreign_prod, '~');
	Export Key_Business_Header_Contacts_BDID := prefix + 'prte::key::business_header::20170926::contacts::bdid';
	Export Key_BDID_PL := prefix 	+ 'prte::key::business_header::20170926::search::bdid.pl';
	Export Key_Linkids := prefix 	+ 'prte::key::bipv2::business_header::qa::linkids';
	Export Key_Business_Header_Contacts  := prefix + 'prte::key::business_header::20170926::contacts::bdid';
	...
	Export Key_Business_Header_Relatives_BDID := prefix + 'prte::key::business_header::20170926::relatives::bdid1';
	Export Key_SuperGroup_Bdid := prefix + 'prte::key::business_header::20170926::supergroup::bdid';
	Export Key_BH_Best := prefix + 'prte::key::business_header::20170926::best::filepos.data';
