/*--SOAP--
<message name="Fragment_Subset_AdvSrch_Service">
  <part name="Search" type="xsd:string" rows="7" cols="40" />
	...
	<part name="LAFN_Enable" type="xsd:boolean"/>
...
EXPORT Fragment_Subset_AdvSrch_Service := MACRO
// Arguments
...
answerRecs := JOIN(m.answers, ansIndx, 
									...
									LIMIT(0));
IF(runSearch AND ~countOnly, OUTPUT(answerRecs, NAMED('Result_AnswerRecords')));
