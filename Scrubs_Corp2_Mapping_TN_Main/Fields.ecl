IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_TN_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_charter_nbr','invalid_mandatory','invalid_corp_address_type_cd','invalid_corp_address_type_desc','invalid_corp_ra_address_type_cd','invalid_corp_ra_address_type_desc','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_org_structure_desc','invalid_corp_forgn_state_cd','invalid_corp_forgn_state_desc','invalid_forgn_dom_code','invalid_term_cd','invalid_term_exp','invalid_term_desc','invalid_flag_code','invalid_date','invalid_future_date','invalid_numericblank','invalid_recordorigin');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_charter_nbr' => 4,'invalid_mandatory' => 5,'invalid_corp_address_type_cd' => 6,'invalid_corp_address_type_desc' => 7,'invalid_corp_ra_address_type_cd' => 8,'invalid_corp_ra_address_type_desc' => 9,'invalid_ln_name_type_cd' => 10,'invalid_ln_name_type_desc' => 11,'invalid_org_structure_desc' => 12,'invalid_corp_forgn_state_cd' => 13,'invalid_corp_forgn_state_desc' => 14,'invalid_forgn_dom_code' => 15,'invalid_term_cd' => 16,'invalid_term_exp' => 17,'invalid_term_desc' => 18,'invalid_flag_code' => 19,'invalid_date' => 20,'invalid_future_date' => 21,'invalid_numericblank' => 22,'invalid_recordorigin' => 23,0);
...
EXPORT MakeFT_invalid_corp_key(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'),SALT34.HygieneErrors.NotLength('4..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['47']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('47'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['TN']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('TN'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_address_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_address_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['B','M',' ']);
EXPORT InValidMessageFT_invalid_corp_address_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('B|M| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_address_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_address_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['BUSINESS','MAILING',' ']);
EXPORT InValidMessageFT_invalid_corp_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('BUSINESS|MAILING| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_ra_address_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_ra_address_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['R',' ']);
EXPORT InValidMessageFT_invalid_corp_ra_address_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('R| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_ra_address_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_ra_address_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['REGISTERED OFFICE',' ']);
EXPORT InValidMessageFT_invalid_corp_ra_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('REGISTERED OFFICE| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_cd(s)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_desc(s)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_org_structure_desc(s)>0);
EXPORT InValidMessageFT_invalid_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_org_structure_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_forgn_state_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_cd(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_forgn_state_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_term_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['P','N',' ']);
EXPORT InValidMessageFT_invalid_term_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('P|N| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exp(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' 0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_term_exp(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' 0123456789'))));
EXPORT InValidMessageFT_invalid_term_exp(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' 0123456789'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['PERPETUAL','NUMBER OF YEARS',' ']);
EXPORT InValidMessageFT_invalid_term_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('PERPETUAL|NUMBER OF YEARS| '),SALT34.HygieneErrors.Good);
...
EXPORT InValid_corp_ln_name_type_cd(SALT34.StrType s) := InValidFT_invalid_ln_name_type_cd(s);
...
EXPORT InValid_corp_ln_name_type_desc(SALT34.StrType s) := InValidFT_invalid_ln_name_type_desc(s);
...
EXPORT Make_corp_address1_type_cd(SALT34.StrType s0) := MakeFT_invalid_corp_address_type_cd(s0);
EXPORT InValid_corp_address1_type_cd(SALT34.StrType s) := InValidFT_invalid_corp_address_type_cd(s);
EXPORT InValidMessage_corp_address1_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_address_type_cd(wh);
 
EXPORT Make_corp_address1_type_desc(SALT34.StrType s0) := MakeFT_invalid_corp_address_type_desc(s0);
EXPORT InValid_corp_address1_type_desc(SALT34.StrType s) := InValidFT_invalid_corp_address_type_desc(s);
EXPORT InValidMessage_corp_address1_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_address_type_desc(wh);
...
EXPORT Make_corp_term_exist_exp(SALT34.StrType s0) := MakeFT_invalid_term_exp(s0);
EXPORT InValid_corp_term_exist_exp(SALT34.StrType s) := InValidFT_invalid_term_exp(s);
...
EXPORT Make_corp_orig_org_structure_desc(SALT34.StrType s0) := MakeFT_invalid_org_structure_desc(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT34.StrType s) := InValidFT_invalid_org_structure_desc(s);
...
EXPORT Make_corp_ra_address_type_cd(SALT34.StrType s0) := MakeFT_invalid_corp_ra_address_type_cd(s0);
EXPORT InValid_corp_ra_address_type_cd(SALT34.StrType s) := InValidFT_invalid_corp_ra_address_type_cd(s);
EXPORT InValidMessage_corp_ra_address_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_ra_address_type_cd(wh);
 
EXPORT Make_corp_ra_address_type_desc(SALT34.StrType s0) := MakeFT_invalid_corp_ra_address_type_desc(s0);
EXPORT InValid_corp_ra_address_type_desc(SALT34.StrType s) := InValidFT_invalid_corp_ra_address_type_desc(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_TN_Main;
