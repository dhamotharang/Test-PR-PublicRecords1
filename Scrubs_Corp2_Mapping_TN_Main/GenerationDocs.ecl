...
Command line options: -MScrubs_Corp2_Mapping_TN_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR8EFA.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_TN_Main
FILENAME:In_TN
...
FIELDTYPE:invalid_corp_vendor:ENUM(47)
FIELDTYPE:invalid_state_origin:ENUM(TN)
FIELDTYPE:invalid_charter_nbr:ALLOW(-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_corp_address_type_cd:ENUM(B|M| )
FIELDTYPE:invalid_corp_address_type_desc:ENUM(BUSINESS|MAILING| )
FIELDTYPE:invalid_corp_ra_address_type_cd:ENUM(R| )
FIELDTYPE:invalid_corp_ra_address_type_desc:ENUM(REGISTERED OFFICE| )
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_cd>0)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_ln_name_type_desc>0)
FIELDTYPE:invalid_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_org_structure_desc>0)
FIELDTYPE:invalid_corp_forgn_state_cd:CUSTOM(Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_cd>0)
FIELDTYPE:invalid_corp_forgn_state_desc:CUSTOM(Scrubs_Corp2_Mapping_TN_Main.Functions.invalid_corp_forgn_state_desc>0)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_term_cd:ENUM(P|N| )
FIELDTYPE:invalid_term_exp:ALLOW( 0123456789)
FIELDTYPE:invalid_term_desc:ENUM(PERPETUAL|NUMBER OF YEARS| )
...
FIELD:corp_address1_type_cd:TYPE(STRING8):LIKE(invalid_corp_address_type_cd):0,0
FIELD:corp_address1_type_desc:TYPE(STRING60):LIKE(invalid_corp_address_type_desc):0,0
...
FIELD:corp_term_exist_exp:TYPE(STRING8):LIKE(invalid_term_exp):0,0
