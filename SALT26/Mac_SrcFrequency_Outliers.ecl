EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT26.Str30Type fieldname := #TEXT(infield);
	  SALT26.StrType fieldvalue {maxlength(200000)} := (SALT26.StrType)infile.infield ;
		SALT26.StrType src {maxlength(30)} := infile.srcfield ;
