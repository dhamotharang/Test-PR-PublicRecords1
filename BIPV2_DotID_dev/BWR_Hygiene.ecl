...
#workunit('name','BIPV2_DOTID_dev.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_DOTID_dev,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_DOTID_dev.In_DOT;
  h := BIPV2_DOTID_dev.Hygiene(infile);
  ...
  OUTPUT(SALT30.MAC_Character_Counts.EclRecord(p,'Layout_DOT'),NAMED('OptimizedLayout'));// File layout suggested by data
  ...
  CM := BIPV2_DOTID_dev.Fields.UIDConsistency(BIPV2_DOTID_dev.In_DOT);
...
//  OUTPUT(CM.orgid_TwoParents,NAMED('Twoparentsorgid'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,corp_legal_name,Examples),NAMED('corp_legal_nameBysource'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,isContact,Examples),NAMED('isContactBysource'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,contact_email,Examples),NAMED('contact_emailBysource'));
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,contact_job_title_raw,Examples),NAMED('contact_job_title_rawBysource'));
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,company_department,Examples),NAMED('company_departmentBysource'));
