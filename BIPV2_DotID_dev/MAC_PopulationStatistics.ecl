...
EXPORT MAC_PopulationStatistics(infile,Ref='',source='',Input_company_name = '',Input_cnp_name = '',Input_corp_legal_name = '',Input_cnp_number = '',Input_cnp_btype = '',Input_cnp_lowv = '',Input_cnp_translated = '',Input_cnp_classid = '',Input_company_fein = '',Input_active_duns_number = '',Input_active_enterprise_number = '',Input_active_domestic_corp_key = '',Input_company_bdid = '',Input_company_phone = '',Input_prim_range = '',Input_prim_name = '',Input_sec_range = '',Input_st = '',Input_v_city_name = '',Input_zip = '',Input_csz = '',Input_addr1 = '',Input_address = '',Input_isContact = '',Input_title = '',Input_fname = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',Input_contact_ssn = '',Input_contact_phone = '',Input_contact_email = '',Input_contact_job_title_raw = '',Input_company_department = '',Input_dt_first_seen = '',Input_dt_last_seen = '',OutFile) := MACRO
