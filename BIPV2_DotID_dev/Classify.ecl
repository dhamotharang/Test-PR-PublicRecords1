...
SHARED TotalClusters := specificities(h).TotalClusters;
  cnp_name_tokens := PROJECT(specificities(h).cnp_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_name; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  corp_legal_name_tokens := PROJECT(specificities(h).corp_legal_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.corp_legal_name; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  cnp_number_tokens := PROJECT(specificities(h).cnp_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_number; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  cnp_btype_tokens := PROJECT(specificities(h).cnp_btype_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_btype; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  company_fein_tokens := PROJECT(specificities(h).company_fein_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_fein; SELF.TokenType := 9; SELF.Spc := LEFT.field_Specificity ));
  active_duns_number_tokens := PROJECT(specificities(h).active_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_duns_number; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  active_enterprise_number_tokens := PROJECT(specificities(h).active_enterprise_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_enterprise_number; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  active_domestic_corp_key_tokens := PROJECT(specificities(h).active_domestic_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_domestic_corp_key; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
  prim_range_tokens := PROJECT(specificities(h).prim_range_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_range; SELF.TokenType := 15; SELF.Spc := LEFT.field_Specificity ));
  prim_name_tokens := PROJECT(specificities(h).prim_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_name; SELF.TokenType := 16; SELF.Spc := LEFT.field_Specificity ));
  ...
  zip_tokens := PROJECT(specificities(h).zip_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.zip; SELF.TokenType := 20; SELF.Spc := LEFT.field_Specificity ));
  isContact_tokens := PROJECT(specificities(h).isContact_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.isContact; SELF.TokenType := 24; SELF.Spc := LEFT.field_Specificity ));
  fname_tokens := PROJECT(specificities(h).fname_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.fname; SELF.TokenType := 26; SELF.Spc := LEFT.field_Specificity ));
  mname_tokens := PROJECT(specificities(h).mname_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.mname; SELF.TokenType := 27; SELF.Spc := LEFT.field_Specificity ));
  lname_tokens := PROJECT(specificities(h).lname_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.lname; SELF.TokenType := 28; SELF.Spc := LEFT.field_Specificity ));
  name_suffix_tokens := PROJECT(specificities(h).name_suffix_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.name_suffix; SELF.TokenType := 29; SELF.Spc := LEFT.field_Specificity ));
  contact_ssn_tokens := PROJECT(specificities(h).contact_ssn_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.contact_ssn; SELF.TokenType := 30; SELF.Spc := LEFT.field_Specificity ));
...
EXPORT TokenKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Token::MultiTokenKey';
...
EXPORT MultiTokenKey := INDEX(all_tokens0(SALT30.WordCount(TokenValue)>1),{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens0},MultiTokenKeyName);
  csz_tokens := PROJECT(specificities(h).csz_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.csz; SELF.TokenType := 21; SELF.Spc := LEFT.field_Specificity ));
  addr1_tokens := PROJECT(specificities(h).addr1_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.addr1; SELF.TokenType := 22; SELF.Spc := LEFT.field_Specificity ));
  address_tokens := PROJECT(specificities(h).address_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.address; SELF.TokenType := 23; SELF.Spc := LEFT.field_Specificity ));
all_tokens1 := csz_tokens + addr1_tokens + address_tokens;
 
EXPORT ConceptKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Token::ConceptKey';
...
shared addr1_templates := project(addr1_combinations,Into(LEFT));
  address_filled_rec := RECORD
    ...
    boolean csz_filled :=~((SALT30.StrType)ih.v_city_name = '' AND (SALT30.StrType)ih.st = '' AND (SALT30.StrType)ih.zip = '');
  END;
...
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_DOTID_dev::DOTid::Token::ConceptKey';
