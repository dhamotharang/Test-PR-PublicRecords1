...
#workunit('name','BIPV2_DOTID_dev.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
IMPORT BIPV2_DOTID_dev,SALT30;
IMPORT SALTTOOLS30;
//BIPV2_DOTID_dev.Specificities(BIPV2_DOTID_dev.In_DOT).Build; // Used to create calibration keys
...
P := BIPV2_DOTID_dev.Proc_Iterate('1'); // Change '1' for later iterations
...
SALT30.MAC_MatchSamplePatterns(BIPV2_DOTID_dev.Keys(BIPV2_DOTID_dev.In_DOT).MatchSample,MatchPatterns,DOTid1,DOTid2,8,36-42);
...
ConfThreshold:=39;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_DOTID_dev.Keys(BIPV2_DOTID_dev.In_DOT).MatchSample,BIPV2_DOTID_dev.Keys(BIPV2_DOTID_dev.In_DOT).Candidates,BIPV2_DOTID_dev.In_DOT,DOTid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
