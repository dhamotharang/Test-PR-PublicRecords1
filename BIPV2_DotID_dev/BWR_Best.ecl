...
#workunit('name','BIPV2_DotID_dev.BWR_Best - BEST - SALT V2.4 Beta 2');
IMPORT BIPV2_DotID_dev,SALT24;
...
BIPV2_DotID_dev.Best(BIPV2_DotID_dev.In_DOT).Stats;
...
b := BIPV2_DotID_dev.Best(BIPV2_DotID_dev.In_DOT); // Instantiate Best module
