...
iter := '25';
#workunit('name','BIPV2_DotID_dev Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;
kmtch      := index(BIPV2_DotID_dev.Keys(BIPV2_DotID_dev.In_DOT).MatchSample ,BIPV2_DotID_dev.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_DotID_dev.In_DOT)
