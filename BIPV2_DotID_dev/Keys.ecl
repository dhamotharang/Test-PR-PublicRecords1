...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Debug::match_candidates_debug';
...
EXPORT AttributeMatchesKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Datafile::attribute_matches';
...
EXPORT MatchHistoryName := '~keep::BIPV2_DOTID_dev::DOTid::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::History::Match';
  MH := MatchHistoryFile;
...
EXPORT InDataKeyName := '~'+'key::BIPV2_DOTID_dev::DOTid::Datafile::in_data';
