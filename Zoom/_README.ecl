/*
	Zoom:
		...
		Overview: Zoom is a networking site where professionals can input their company and contact information,
							and, in turn, all of this information is searchable.
		...
		The Build:
			...
			Quick Documentation to run the build:
				...
				Unix Directory	: edata14-a:/load01/zoom
				Thor Module			: Zoom
				Tapeload02b Dir	: paw/zoom
				Orbit Build			: Zoom
