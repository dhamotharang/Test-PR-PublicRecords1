...
EXPORT NumFields := 178;
 
EXPORT SALT311.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'rcid','domainname','registrarname','contactemail','whoisserver','nameservers','createddate','updateddate','expiresdate','standardregcreateddate','standardregupdateddate','standardregexpiresdate','status','audit_auditupdateddate','registrant_rawtext','registrant_email','registrant_name','registrant_organization','registrant_street1','registrant_street2','registrant_street3','registrant_street4','registrant_city','registrant_state','registrant_postalcode','registrant_country','registrant_fax','registrant_faxext','registrant_phone','registrant_phoneext','administrativecontact_rawtext','administrativecontact_email','administrativecontact_name','administrativecontact_organization','administrativecontact_street1','administrativecontact_street2','administrativecontact_street3','administrativecontact_street4','administrativecontact_city','administrativecontact_state','administrativecontact_postalcode','administrativecontact_country','administrativecontact_fax','administrativecontact_faxext','administrativecontact_phone','administrativecontact_phoneext','billingcontact_rawtext','billingcontact_email','billingcontact_name','billingcontact_organization','billingcontact_street1','billingcontact_street2','billingcontact_street3','billingcontact_street4','billingcontact_city','billingcontact_state','billingcontact_postalcode','billingcontact_country','billingcontact_fax','billingcontact_faxext','billingcontact_phone','billingcontact_phoneext','technicalcontact_rawtext','technicalcontact_email','technicalcontact_name','technicalcontact_organization','technicalcontact_street1','technicalcontact_street2','technicalcontact_street3','technicalcontact_street4','technicalcontact_city','technicalcontact_state','technicalcontact_postalcode','technicalcontact_country','technicalcontact_fax','technicalcontact_faxext','technicalcontact_phone','technicalcontact_phoneext','zonecontact_rawtext','zonecontact_email','zonecontact_name','zonecontact_organization','zonecontact_street1','zonecontact_street2','zonecontact_street3','zonecontact_street4','zonecontact_city','zonecontact_state','zonecontact_postalcode','zonecontact_country','zonecontact_fax','zonecontact_faxext','zonecontact_phone','zonecontact_phoneext','emailtype','rawtext','email','name','organization','street1','street2','street3','street4','city','state','postalcode','country','fax','faxext','phone','phoneext','uniq_record_id','uniq_email_id','did','did_score','clean_title','clean_fname','clean_mname','clean_lname','clean_name_suffix','clean_name_score','rawaid','append_prep_address_situs','append_prep_address_last_situs','prim_range','predir','prim_name','addr_suffix','postdir','unit_desig','sec_range','p_city_name','v_city_name','st','zip','zip4','cart','cr_sort_sz','lot','lot_order','dbpc','chk_digit','rec_type','county','geo_lat','geo_long','msa','geo_blk','geo_match','err_stat','process_date','date_first_seen','date_last_seen','date_vendor_first_reported','date_vendor_last_reported','clean_cname','current_rec','dotid','dotscore','dotweight','empid','empscore','empweight','powid','powscore','powweight','proxid','proxscore','proxweight','seleid','selescore','seleweight','orgid','orgscore','orgweight','ultid','ultscore','ultweight');
EXPORT SALT311.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'rcid','domainname','registrarname','contactemail','whoisserver','nameservers','createddate','updateddate','expiresdate','standardregcreateddate','standardregupdateddate','standardregexpiresdate','status','audit_auditupdateddate','registrant_rawtext','registrant_email','registrant_name','registrant_organization','registrant_street1','registrant_street2','registrant_street3','registrant_street4','registrant_city','registrant_state','registrant_postalcode','registrant_country','registrant_fax','registrant_faxext','registrant_phone','registrant_phoneext','administrativecontact_rawtext','administrativecontact_email','administrativecontact_name','administrativecontact_organization','administrativecontact_street1','administrativecontact_street2','administrativecontact_street3','administrativecontact_street4','administrativecontact_city','administrativecontact_state','administrativecontact_postalcode','administrativecontact_country','administrativecontact_fax','administrativecontact_faxext','administrativecontact_phone','administrativecontact_phoneext','billingcontact_rawtext','billingcontact_email','billingcontact_name','billingcontact_organization','billingcontact_street1','billingcontact_street2','billingcontact_street3','billingcontact_street4','billingcontact_city','billingcontact_state','billingcontact_postalcode','billingcontact_country','billingcontact_fax','billingcontact_faxext','billingcontact_phone','billingcontact_phoneext','technicalcontact_rawtext','technicalcontact_email','technicalcontact_name','technicalcontact_organization','technicalcontact_street1','technicalcontact_street2','technicalcontact_street3','technicalcontact_street4','technicalcontact_city','technicalcontact_state','technicalcontact_postalcode','technicalcontact_country','technicalcontact_fax','technicalcontact_faxext','technicalcontact_phone','technicalcontact_phoneext','zonecontact_rawtext','zonecontact_email','zonecontact_name','zonecontact_organization','zonecontact_street1','zonecontact_street2','zonecontact_street3','zonecontact_street4','zonecontact_city','zonecontact_state','zonecontact_postalcode','zonecontact_country','zonecontact_fax','zonecontact_faxext','zonecontact_phone','zonecontact_phoneext','emailtype','rawtext','email','name','organization','street1','street2','street3','street4','city','state','postalcode','country','fax','faxext','phone','phoneext','uniq_record_id','uniq_email_id','did','did_score','clean_title','clean_fname','clean_mname','clean_lname','clean_name_suffix','clean_name_score','rawaid','append_prep_address_situs','append_prep_address_last_situs','prim_range','predir','prim_name','addr_suffix','postdir','unit_desig','sec_range','p_city_name','v_city_name','st','zip','zip4','cart','cr_sort_sz','lot','lot_order','dbpc','chk_digit','rec_type','county','geo_lat','geo_long','msa','geo_blk','geo_match','err_stat','process_date','date_first_seen','date_last_seen','date_vendor_first_reported','date_vendor_last_reported','clean_cname','current_rec','dotid','dotscore','dotweight','empid','empscore','empweight','powid','powscore','powweight','proxid','proxscore','proxweight','seleid','selescore','seleweight','orgid','orgscore','orgweight','ultid','ultscore','ultweight');
EXPORT FieldNum(SALT311.StrType fn) := CASE(fn,'rcid' => 0,'domainname' => 1,'registrarname' => 2,'contactemail' => 3,'whoisserver' => 4,'nameservers' => 5,'createddate' => 6,'updateddate' => 7,'expiresdate' => 8,'standardregcreateddate' => 9,'standardregupdateddate' => 10,'standardregexpiresdate' => 11,'status' => 12,'audit_auditupdateddate' => 13,'registrant_rawtext' => 14,'registrant_email' => 15,'registrant_name' => 16,'registrant_organization' => 17,'registrant_street1' => 18,'registrant_street2' => 19,'registrant_street3' => 20,'registrant_street4' => 21,'registrant_city' => 22,'registrant_state' => 23,'registrant_postalcode' => 24,'registrant_country' => 25,'registrant_fax' => 26,'registrant_faxext' => 27,'registrant_phone' => 28,'registrant_phoneext' => 29,'administrativecontact_rawtext' => 30,'administrativecontact_email' => 31,'administrativecontact_name' => 32,'administrativecontact_organization' => 33,'administrativecontact_street1' => 34,'administrativecontact_street2' => 35,'administrativecontact_street3' => 36,'administrativecontact_street4' => 37,'administrativecontact_city' => 38,'administrativecontact_state' => 39,'administrativecontact_postalcode' => 40,'administrativecontact_country' => 41,'administrativecontact_fax' => 42,'administrativecontact_faxext' => 43,'administrativecontact_phone' => 44,'administrativecontact_phoneext' => 45,'billingcontact_rawtext' => 46,'billingcontact_email' => 47,'billingcontact_name' => 48,'billingcontact_organization' => 49,'billingcontact_street1' => 50,'billingcontact_street2' => 51,'billingcontact_street3' => 52,'billingcontact_street4' => 53,'billingcontact_city' => 54,'billingcontact_state' => 55,'billingcontact_postalcode' => 56,'billingcontact_country' => 57,'billingcontact_fax' => 58,'billingcontact_faxext' => 59,'billingcontact_phone' => 60,'billingcontact_phoneext' => 61,'technicalcontact_rawtext' => 62,'technicalcontact_email' => 63,'technicalcontact_name' => 64,'technicalcontact_organization' => 65,'technicalcontact_street1' => 66,'technicalcontact_street2' => 67,'technicalcontact_street3' => 68,'technicalcontact_street4' => 69,'technicalcontact_city' => 70,'technicalcontact_state' => 71,'technicalcontact_postalcode' => 72,'technicalcontact_country' => 73,'technicalcontact_fax' => 74,'technicalcontact_faxext' => 75,'technicalcontact_phone' => 76,'technicalcontact_phoneext' => 77,'zonecontact_rawtext' => 78,'zonecontact_email' => 79,'zonecontact_name' => 80,'zonecontact_organization' => 81,'zonecontact_street1' => 82,'zonecontact_street2' => 83,'zonecontact_street3' => 84,'zonecontact_street4' => 85,'zonecontact_city' => 86,'zonecontact_state' => 87,'zonecontact_postalcode' => 88,'zonecontact_country' => 89,'zonecontact_fax' => 90,'zonecontact_faxext' => 91,'zonecontact_phone' => 92,'zonecontact_phoneext' => 93,'emailtype' => 94,'rawtext' => 95,'email' => 96,'name' => 97,'organization' => 98,'street1' => 99,'street2' => 100,'street3' => 101,'street4' => 102,'city' => 103,'state' => 104,'postalcode' => 105,'country' => 106,'fax' => 107,'faxext' => 108,'phone' => 109,'phoneext' => 110,'uniq_record_id' => 111,'uniq_email_id' => 112,'did' => 113,'did_score' => 114,'clean_title' => 115,'clean_fname' => 116,'clean_mname' => 117,'clean_lname' => 118,'clean_name_suffix' => 119,'clean_name_score' => 120,'rawaid' => 121,'append_prep_address_situs' => 122,'append_prep_address_last_situs' => 123,'prim_range' => 124,'predir' => 125,'prim_name' => 126,'addr_suffix' => 127,'postdir' => 128,'unit_desig' => 129,'sec_range' => 130,'p_city_name' => 131,'v_city_name' => 132,'st' => 133,'zip' => 134,'zip4' => 135,'cart' => 136,'cr_sort_sz' => 137,'lot' => 138,'lot_order' => 139,'dbpc' => 140,'chk_digit' => 141,'rec_type' => 142,'county' => 143,'geo_lat' => 144,'geo_long' => 145,'msa' => 146,'geo_blk' => 147,'geo_match' => 148,'err_stat' => 149,'process_date' => 150,'date_first_seen' => 151,'date_last_seen' => 152,'date_vendor_first_reported' => 153,'date_vendor_last_reported' => 154,'clean_cname' => 155,'current_rec' => 156,'dotid' => 157,'dotscore' => 158,'dotweight' => 159,'empid' => 160,'empscore' => 161,'empweight' => 162,'powid' => 163,'powscore' => 164,'powweight' => 165,'proxid' => 166,'proxscore' => 167,'proxweight' => 168,'seleid' => 169,'selescore' => 170,'seleweight' => 171,'orgid' => 172,'orgscore' => 173,'orgweight' => 174,'ultid' => 175,'ultscore' => 176,'ultweight' => 177,0);
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]);
EXPORT BOOLEAN InBaseLayout(UNSIGNED2 i) := CHOOSE(i,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,FALSE);
...
EXPORT Make_uniq_record_id(SALT311.StrType s0) := s0;
EXPORT InValid_uniq_record_id(SALT311.StrType s) := 0;
EXPORT InValidMessage_uniq_record_id(UNSIGNED1 wh) := '';
 
EXPORT Make_uniq_email_id(SALT311.StrType s0) := s0;
EXPORT InValid_uniq_email_id(SALT311.StrType s) := 0;
EXPORT InValidMessage_uniq_email_id(UNSIGNED1 wh) := '';
...
#uniquename(dl)
  %dl% := RECORD
    ...
    BOOLEAN Diff_uniq_record_id;
    BOOLEAN Diff_uniq_email_id;
    BOOLEAN Diff_did;
...
#uniquename(fd)
  %dl% %fd%(in_left le,in_right ri) := TRANSFORM
    ...
    SELF.Diff_uniq_record_id := le.uniq_record_id <> ri.uniq_record_id;
    SELF.Diff_uniq_email_id := le.uniq_email_id <> ri.uniq_email_id;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_uniq_record_id := COUNT(GROUP,%Closest%.Diff_uniq_record_id);
    Count_Diff_uniq_email_id := COUNT(GROUP,%Closest%.Diff_uniq_email_id);
