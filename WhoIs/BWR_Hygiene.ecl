...
#workunit('name','WhoIs.BWR_Hygiene - Hygiene & Stats - SALT V3.11.6');
IMPORT WhoIs,SALT311;
// First create an instantiated hygiene module
  infile := WhoIs.In_WhoIs;
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_WhoIs'),NAMED('OptimizedLayout'));// File layout suggested by data
