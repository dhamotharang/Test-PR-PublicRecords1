...
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.FldNo := C;
END;
SHARED FldInv0 := NORMALIZE(h,177,Into(LEFT,COUNTER));
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),177*177,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'domainname'}
      ,{2,'registrarname'}
      ,{3,'contactemail'}
      ,{4,'whoisserver'}
      ,{5,'nameservers'}
      ...
      ,{7,'updateddate'}
      ,{8,'expiresdate'}
      ,{9,'standardregcreateddate'}
      ,{10,'standardregupdateddate'}
      ,{11,'standardregexpiresdate'}
      ,{12,'status'}
      ,{13,'audit_auditupdateddate'}
      ,{14,'registrant_rawtext'}
      ,{15,'registrant_email'}
      ,{16,'registrant_name'}
      ,{17,'registrant_organization'}
      ,{18,'registrant_street1'}
      ,{19,'registrant_street2'}
      ,{20,'registrant_street3'}
      ,{21,'registrant_street4'}
      ,{22,'registrant_city'}
      ,{23,'registrant_state'}
      ,{24,'registrant_postalcode'}
      ,{25,'registrant_country'}
      ,{26,'registrant_fax'}
      ,{27,'registrant_faxext'}
      ,{28,'registrant_phone'}
      ,{29,'registrant_phoneext'}
      ,{30,'administrativecontact_rawtext'}
      ,{31,'administrativecontact_email'}
      ,{32,'administrativecontact_name'}
      ,{33,'administrativecontact_organization'}
      ,{34,'administrativecontact_street1'}
      ,{35,'administrativecontact_street2'}
      ,{36,'administrativecontact_street3'}
      ,{37,'administrativecontact_street4'}
      ,{38,'administrativecontact_city'}
      ,{39,'administrativecontact_state'}
      ,{40,'administrativecontact_postalcode'}
      ,{41,'administrativecontact_country'}
      ,{42,'administrativecontact_fax'}
      ,{43,'administrativecontact_faxext'}
      ,{44,'administrativecontact_phone'}
      ,{45,'administrativecontact_phoneext'}
      ,{46,'billingcontact_rawtext'}
      ,{47,'billingcontact_email'}
      ,{48,'billingcontact_name'}
      ,{49,'billingcontact_organization'}
      ,{50,'billingcontact_street1'}
      ,{51,'billingcontact_street2'}
      ,{52,'billingcontact_street3'}
      ,{53,'billingcontact_street4'}
      ,{54,'billingcontact_city'}
      ,{55,'billingcontact_state'}
      ,{56,'billingcontact_postalcode'}
      ,{57,'billingcontact_country'}
      ,{58,'billingcontact_fax'}
      ,{59,'billingcontact_faxext'}
      ,{60,'billingcontact_phone'}
      ,{61,'billingcontact_phoneext'}
      ,{62,'technicalcontact_rawtext'}
      ,{63,'technicalcontact_email'}
      ,{64,'technicalcontact_name'}
      ,{65,'technicalcontact_organization'}
      ,{66,'technicalcontact_street1'}
      ,{67,'technicalcontact_street2'}
      ,{68,'technicalcontact_street3'}
      ,{69,'technicalcontact_street4'}
      ,{70,'technicalcontact_city'}
      ,{71,'technicalcontact_state'}
      ,{72,'technicalcontact_postalcode'}
      ,{73,'technicalcontact_country'}
      ,{74,'technicalcontact_fax'}
      ,{75,'technicalcontact_faxext'}
      ,{76,'technicalcontact_phone'}
      ,{77,'technicalcontact_phoneext'}
      ,{78,'zonecontact_rawtext'}
      ,{79,'zonecontact_email'}
      ,{80,'zonecontact_name'}
      ,{81,'zonecontact_organization'}
      ,{82,'zonecontact_street1'}
      ,{83,'zonecontact_street2'}
      ,{84,'zonecontact_street3'}
      ,{85,'zonecontact_street4'}
      ,{86,'zonecontact_city'}
      ,{87,'zonecontact_state'}
      ,{88,'zonecontact_postalcode'}
      ,{89,'zonecontact_country'}
      ,{90,'zonecontact_fax'}
      ,{91,'zonecontact_faxext'}
      ,{92,'zonecontact_phone'}
      ,{93,'zonecontact_phoneext'}
      ,{94,'emailtype'}
      ,{95,'rawtext'}
      ,{96,'email'}
      ,{97,'name'}
      ...
      ,{117,'clean_mname'}
      ,{118,'clean_lname'}
      ,{119,'clean_name_suffix'}
      ,{120,'clean_name_score'}
      ,{121,'rawaid'}
      ,{122,'append_prep_address_situs'}
      ,{123,'append_prep_address_last_situs'}
      ,{124,'prim_range'}
      ,{125,'predir'}
      ,{126,'prim_name'}
      ,{127,'addr_suffix'}
      ...
      ,{151,'date_first_seen'}
      ,{152,'date_last_seen'}
      ,{153,'date_vendor_first_reported'}
      ,{154,'date_vendor_last_reported'}
      ,{155,'clean_cname'}
      ,{156,'current_rec'}
      ,{157,'dotid'}
      ,{158,'dotscore'}
      ...
      ,{175,'ultid'}
      ,{176,'ultscore'}
      ,{177,'ultweight'}],SALT311.MAC_Character_Counts.Field_Identification);
...
END;
Errors := NORMALIZE(h,177,NoteErrors(LEFT,COUNTER));
