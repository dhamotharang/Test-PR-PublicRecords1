...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_uniq_record_id_cnt := COUNT(GROUP,h.uniq_record_id <> (TYPEOF(h.uniq_record_id))'');
    populated_uniq_record_id_pcnt := AVE(GROUP,IF(h.uniq_record_id = (TYPEOF(h.uniq_record_id))'',0,100));
    maxlength_uniq_record_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.uniq_record_id)));
    avelength_uniq_record_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.uniq_record_id)),h.uniq_record_id<>(typeof(h.uniq_record_id))'');
    populated_uniq_email_id_cnt := COUNT(GROUP,h.uniq_email_id <> (TYPEOF(h.uniq_email_id))'');
    populated_uniq_email_id_pcnt := AVE(GROUP,IF(h.uniq_email_id = (TYPEOF(h.uniq_email_id))'',0,100));
    maxlength_uniq_email_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.uniq_email_id)));
    avelength_uniq_email_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.uniq_email_id)),h.uniq_email_id<>(typeof(h.uniq_email_id))'');
...
SHARED FldIds := DATASET([{1,'rcid'}
      ...
      ,{8,'updateddate'}
      ,{9,'expiresdate'}
      ,{10,'standardregcreateddate'}
      ,{11,'standardregupdateddate'}
      ,{12,'standardregexpiresdate'}
      ,{13,'status'}
      ,{14,'audit_auditupdateddate'}
      ,{15,'registrant_rawtext'}
      ,{16,'registrant_email'}
      ,{17,'registrant_name'}
      ,{18,'registrant_organization'}
      ,{19,'registrant_street1'}
      ,{20,'registrant_street2'}
      ,{21,'registrant_street3'}
      ,{22,'registrant_street4'}
      ,{23,'registrant_city'}
      ,{24,'registrant_state'}
      ,{25,'registrant_postalcode'}
      ,{26,'registrant_country'}
      ,{27,'registrant_fax'}
      ,{28,'registrant_faxext'}
      ,{29,'registrant_phone'}
      ,{30,'registrant_phoneext'}
      ,{31,'administrativecontact_rawtext'}
      ,{32,'administrativecontact_email'}
      ,{33,'administrativecontact_name'}
      ,{34,'administrativecontact_organization'}
      ,{35,'administrativecontact_street1'}
      ,{36,'administrativecontact_street2'}
      ,{37,'administrativecontact_street3'}
      ,{38,'administrativecontact_street4'}
      ,{39,'administrativecontact_city'}
      ,{40,'administrativecontact_state'}
      ,{41,'administrativecontact_postalcode'}
      ,{42,'administrativecontact_country'}
      ,{43,'administrativecontact_fax'}
      ,{44,'administrativecontact_faxext'}
      ,{45,'administrativecontact_phone'}
      ,{46,'administrativecontact_phoneext'}
      ,{47,'billingcontact_rawtext'}
      ,{48,'billingcontact_email'}
      ,{49,'billingcontact_name'}
      ,{50,'billingcontact_organization'}
      ,{51,'billingcontact_street1'}
      ,{52,'billingcontact_street2'}
      ,{53,'billingcontact_street3'}
      ,{54,'billingcontact_street4'}
      ,{55,'billingcontact_city'}
      ,{56,'billingcontact_state'}
      ,{57,'billingcontact_postalcode'}
      ,{58,'billingcontact_country'}
      ,{59,'billingcontact_fax'}
      ,{60,'billingcontact_faxext'}
      ,{61,'billingcontact_phone'}
      ,{62,'billingcontact_phoneext'}
      ,{63,'technicalcontact_rawtext'}
      ,{64,'technicalcontact_email'}
      ,{65,'technicalcontact_name'}
      ,{66,'technicalcontact_organization'}
      ,{67,'technicalcontact_street1'}
      ,{68,'technicalcontact_street2'}
      ,{69,'technicalcontact_street3'}
      ,{70,'technicalcontact_street4'}
      ,{71,'technicalcontact_city'}
      ,{72,'technicalcontact_state'}
      ,{73,'technicalcontact_postalcode'}
      ,{74,'technicalcontact_country'}
      ,{75,'technicalcontact_fax'}
      ,{76,'technicalcontact_faxext'}
      ,{77,'technicalcontact_phone'}
      ,{78,'technicalcontact_phoneext'}
      ,{79,'zonecontact_rawtext'}
      ,{80,'zonecontact_email'}
      ,{81,'zonecontact_name'}
      ,{82,'zonecontact_organization'}
      ,{83,'zonecontact_street1'}
      ,{84,'zonecontact_street2'}
      ,{85,'zonecontact_street3'}
      ,{86,'zonecontact_street4'}
      ,{87,'zonecontact_city'}
      ,{88,'zonecontact_state'}
      ,{89,'zonecontact_postalcode'}
      ,{90,'zonecontact_country'}
      ,{91,'zonecontact_fax'}
      ,{92,'zonecontact_faxext'}
      ,{93,'zonecontact_phone'}
      ,{94,'zonecontact_phoneext'}
      ,{95,'emailtype'}
      ,{96,'rawtext'}
      ,{97,'email'}
      ,{98,'name'}
      ...
      ,{118,'clean_mname'}
      ,{119,'clean_lname'}
      ,{120,'clean_name_suffix'}
      ,{121,'clean_name_score'}
      ,{122,'rawaid'}
      ,{123,'append_prep_address_situs'}
      ,{124,'append_prep_address_last_situs'}
      ,{125,'prim_range'}
      ,{126,'predir'}
      ,{127,'prim_name'}
      ,{128,'addr_suffix'}
      ...
      ,{152,'date_first_seen'}
      ,{153,'date_last_seen'}
      ,{154,'date_vendor_first_reported'}
      ,{155,'date_vendor_last_reported'}
      ,{156,'clean_cname'}
      ,{157,'current_rec'}
      ,{158,'dotid'}
      ,{159,'dotscore'}
      ...
      ,{176,'ultid'}
      ,{177,'ultscore'}
      ,{178,'ultweight'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_uniq_record_id((SALT311.StrType)le.uniq_record_id),
    Fields.InValid_uniq_email_id((SALT311.StrType)le.uniq_email_id),
...
END;
Errors := NORMALIZE(h,178,NoteErrors(LEFT,COUNTER));
