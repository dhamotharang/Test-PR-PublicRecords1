...
+    #IF( #TEXT(Input_uniq_record_id)='' )
      '' 
    #ELSE
        IF( le.Input_uniq_record_id = (TYPEOF(le.Input_uniq_record_id))'','',':uniq_record_id')
    #END
 
+    #IF( #TEXT(Input_uniq_email_id)='' )
      '' 
    #ELSE
        IF( le.Input_uniq_email_id = (TYPEOF(le.Input_uniq_email_id))'','',':uniq_email_id')
    #END
