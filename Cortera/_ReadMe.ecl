...
Use either one of these macroâ€™s business_header_ss.MAC_match_FLEX or Business_Header_SS.MAC_Add_BDID_Flex 
    to append the BIP linkids.

Filter out the foreign addresses since the AID canâ€™t handle them and thereâ€™s no foreign addresses in the BIP Header file.
