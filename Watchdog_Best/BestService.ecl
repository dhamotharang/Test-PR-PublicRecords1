...
OUTPUT(CM.AnyFirstName_tab_fname,NAMED('Tab_AnyFirstName_fname'));
OUTPUT(CM.AnyFirstName_method_fname,NAMED('Method_AnyFirstName_fname'));
...
OUTPUT(CM.AnyMiddleName_tab_mname,NAMED('Tab_AnyMiddleName_mname'));
OUTPUT(CM.AnyMiddleName_method_mname,NAMED('Method_AnyMiddleName_mname'));
OUTPUT(CM.BestLastName_tab_lastname,NAMED('Tab_BestLastName_lastname'));
OUTPUT(CM.BestLastName_method_lastname,NAMED('Method_BestLastName_lastname'));
OUTPUT(CM.CommonLastName_tab_lastname,NAMED('Tab_CommonLastName_lastname'));
OUTPUT(CM.CommonLastName_method_lastname,NAMED('Method_CommonLastName_lastname'));
OUTPUT(CM.AnyLastName_tab_lastname,NAMED('Tab_AnyLastName_lastname'));
OUTPUT(CM.AnyLastName_method_lastname,NAMED('Method_AnyLastName_lastname'));
...
OUTPUT(CM.PrefferedDOB_tab_dob,NAMED('Tab_PrefferedDOB_dob'));
OUTPUT(CM.PrefferedDOB_method_dob,NAMED('Method_PrefferedDOB_dob'));
