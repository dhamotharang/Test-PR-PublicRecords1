...
#workunit('name','Watchdog_best.BWR_Iterate - Internal Linking - SALT V3.11.7');
...
P := Watchdog_best.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT311.MAC_MatchSamplePatterns(Watchdog_best.Keys(Watchdog_best.In_Hdr).MatchSample,MatchPatterns,did1,did2,8,38-44);
...
// ConfThreshold:=41;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(Watchdog_best.Keys(Watchdog_best.In_Hdr).MatchSample,Watchdog_best.Keys(Watchdog_best.In_Hdr).Candidates,Watchdog_best.In_Hdr,did,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
