...
+    #IF( #TEXT(Input_corp_number_of_amendments)='' )
      '' 
    #ELSE
        IF( le.Input_corp_number_of_amendments = (TYPEOF(le.Input_corp_number_of_amendments))'','',':corp_number_of_amendments')
    #END
