...
Command line options: -MScrubs_Corp2_Mapping_NM_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR7A1B.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_NM_Main
FILENAME:In_NM
...
FIELDTYPE:invalid_corp_vendor:ENUM(35)
FIELDTYPE:invalid_state_origin:ENUM(NM)
...
FIELDTYPE:invalid_corp_status_code:CUSTOM(Scrubs_Corp2_Mapping_NM_Main.Functions.invalid_corp_status_code>0,recordorigin)
FIELDTYPE:invalid_corp_orig_org_structure_cd:CUSTOM(Scrubs_Corp2_Mapping_NM_Main.Functions.invalid_corp_orig_org_structure_cd>0,recordorigin)
FIELDTYPE:invalid_corp_orig_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_NM_Main.Functions.invalid_corp_orig_org_structure_desc>0,recordorigin)
