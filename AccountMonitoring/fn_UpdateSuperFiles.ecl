...
import dops, _control, AccountMonitoring, STD, _Control;
...
/*    SBFE_mo            := DATASET([{'monitor::sbfe::linkids','~batchr3::base::account_monitoring::sbfe::'+strToday+'::linkids',false},
      														 {'monitor::sbfe::linkids','~batchr3::base::account_monitoring::sbfe::'+strToday+'::linkids',false},
      														 {'monitor::sbfe::linkids','~batchr3::base::account_monitoring::sbfe::'+strToday+'::linkids',false},
      														 {'monitor::sbfe::tradeline','~batchr3::base::account_monitoring::sbfe::'+strToday+'::tradeline',false}
      														],superfile_logicalfile_flat_layout);
...
*/
   ...
   superfile_logicalfile_Rollup_layout RollFiles(superfile_logicalfile_flat_layout L, DATASET(superfile_logicalfile_flat_layout) AllRows) := TRANSFORM
