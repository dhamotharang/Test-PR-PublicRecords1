...
EXPORT DATASET(AccountMonitoring.layouts.history) fn_cgm_watercraft(
		DATASET(AccountMonitoring.layouts.portfolio.base) in_portfolio,
		DATASET(AccountMonitoring.layouts.documents.watercraft.base) in_documents = DATASET([], AccountMonitoring.layouts.documents.watercraft.base),
