...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Date','Invalid_AlphaNum','Invalid_Chars','Invalid_Alpha','Invalid_Num');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'Invalid_Date' => 1,'Invalid_AlphaNum' => 2,'Invalid_Chars' => 3,'Invalid_Alpha' => 4,'Invalid_Num' => 5,0);
...
EXPORT SALT311.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'history_date','fips_geo_12','median_valuation','history_history_date','history_median_valuation');
EXPORT SALT311.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'history_date','fips_geo_12','median_valuation','history_history_date','history_median_valuation');
EXPORT FieldNum(SALT311.StrType fn) := CASE(fn,'history_date' => 0,'fips_geo_12' => 1,'median_valuation' => 2,'history_history_date' => 3,'history_median_valuation' => 4,0);
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['CUSTOM'],['ALLOW'],['ALLOW'],['CUSTOM'],['ALLOW'],[]);
...
EXPORT Make_fips_geo_12(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_fips_geo_12(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_fips_geo_12(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_median_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_median_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_history_median_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_median_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
