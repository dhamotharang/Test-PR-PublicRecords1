...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Date','Invalid_AlphaNum','Invalid_Alpha','Invalid_Num','Invalid_Comps');
...
EXPORT MakeFT_Invalid_Comps(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Comps(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_Invalid_Comps(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT311.HygieneErrors.Good);
...
EXPORT Make_history_date(SALT311.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_history_date(SALT311.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_history_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_ln_fares_id_ta(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_ln_fares_id_ta(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_ln_fares_id_ta(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_ln_fares_id_pi(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_ln_fares_id_pi(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_ln_fares_id_pi(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_unformatted_apn(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_unformatted_apn(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
...
EXPORT Make_lat(SALT311.StrType s0) := s0;
EXPORT InValid_lat(SALT311.StrType s) := 0;
EXPORT InValidMessage_lat(UNSIGNED1 wh) := '';
 
EXPORT Make_long(SALT311.StrType s0) := s0;
EXPORT InValid_long(SALT311.StrType s) := 0;
...
EXPORT Make_fips_code(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_fips_code(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_fips_code(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_land_use(SALT311.StrType s0) := s0;
EXPORT InValid_land_use(SALT311.StrType s) := 0;
...
EXPORT Make_assessed_value_year(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_assessed_value_year(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_assessed_value_year(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_sales_price(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_sales_price(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_sales_price(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_assessed_total_value(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_assessed_total_value(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_assessed_total_value(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_market_total_value(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_market_total_value(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_market_total_value(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_tax_assessment_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_tax_assessment_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_tax_assessment_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_price_index_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_price_index_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_price_index_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_hedonic_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_hedonic_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_hedonic_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_automated_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_automated_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_automated_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_confidence_score(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_confidence_score(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_confidence_score(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_comp1(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_comp1(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_comp1(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_comp2(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_comp2(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_comp2(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_comp3(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_comp3(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_comp3(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_comp4(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_comp4(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_comp4(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_comp5(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_comp5(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_comp5(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_nearby1(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_nearby1(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_nearby1(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_nearby2(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_nearby2(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_nearby2(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_nearby3(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_nearby3(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_nearby3(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_nearby4(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_nearby4(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_nearby4(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_nearby5(SALT311.StrType s0) := MakeFT_Invalid_Comps(s0);
EXPORT InValid_nearby5(SALT311.StrType s) := InValidFT_Invalid_Comps(s);
EXPORT InValidMessage_nearby5(UNSIGNED1 wh) := InValidMessageFT_Invalid_Comps(wh);
 
EXPORT Make_history_history_date(SALT311.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_history_history_date(SALT311.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_history_history_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_history_land_use(SALT311.StrType s0) := s0;
EXPORT InValid_history_land_use(SALT311.StrType s) := 0;
EXPORT InValidMessage_history_land_use(UNSIGNED1 wh) := '';
 
EXPORT Make_history_recording_date(SALT311.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_history_recording_date(SALT311.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_history_recording_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_history_assessed_value_year(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_assessed_value_year(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_assessed_value_year(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_sales_price(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_sales_price(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_sales_price(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_assessed_total_value(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_assessed_total_value(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_assessed_total_value(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_market_total_value(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_market_total_value(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_market_total_value(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_tax_assessment_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_tax_assessment_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_tax_assessment_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_price_index_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_price_index_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_price_index_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_hedonic_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_hedonic_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_hedonic_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_automated_valuation(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_automated_valuation(SALT311.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_history_automated_valuation(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_history_confidence_score(SALT311.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_history_confidence_score(SALT311.StrType s) := InValidFT_Invalid_Num(s);
