...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Comps_Fields.InValid_seq((SALT38.StrType)le.seq),
    Comps_Fields.InValid_ln_fares_id((SALT38.StrType)le.ln_fares_id),
    Comps_Fields.InValid_unformatted_apn((SALT38.StrType)le.unformatted_apn),
    Comps_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    Comps_Fields.InValid_predir((SALT38.StrType)le.predir),
    Comps_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    Comps_Fields.InValid_suffix((SALT38.StrType)le.suffix),
    Comps_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    Comps_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    Comps_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    Comps_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    Comps_Fields.InValid_st((SALT38.StrType)le.st),
    Comps_Fields.InValid_zip((SALT38.StrType)le.zip),
    Comps_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    Comps_Fields.InValid_lat((SALT38.StrType)le.lat),
    Comps_Fields.InValid_long((SALT38.StrType)le.long),
    Comps_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    Comps_Fields.InValid_fips_code((SALT38.StrType)le.fips_code),
    Comps_Fields.InValid_land_use_code((SALT38.StrType)le.land_use_code),
    Comps_Fields.InValid_sales_price((SALT38.StrType)le.sales_price),
    Comps_Fields.InValid_sales_price_code((SALT38.StrType)le.sales_price_code),
    Comps_Fields.InValid_recording_date((SALT38.StrType)le.recording_date),
    Comps_Fields.InValid_assessed_value_year((SALT38.StrType)le.assessed_value_year),
    Comps_Fields.InValid_assessed_total_value((SALT38.StrType)le.assessed_total_value),
    Comps_Fields.InValid_market_total_value((SALT38.StrType)le.market_total_value),
    Comps_Fields.InValid_lot_size((SALT38.StrType)le.lot_size),
    Comps_Fields.InValid_building_area((SALT38.StrType)le.building_area),
    Comps_Fields.InValid_year_built((SALT38.StrType)le.year_built),
    Comps_Fields.InValid_no_of_stories((SALT38.StrType)le.no_of_stories),
    Comps_Fields.InValid_no_of_rooms((SALT38.StrType)le.no_of_rooms),
    Comps_Fields.InValid_no_of_bedrooms((SALT38.StrType)le.no_of_bedrooms),
    Comps_Fields.InValid_no_of_baths((SALT38.StrType)le.no_of_baths),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_AVM, Comps_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
