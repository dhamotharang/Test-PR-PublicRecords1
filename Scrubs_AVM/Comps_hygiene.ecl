IMPORT SALT311,STD;
EXPORT Comps_hygiene(dataset(Comps_layout_AVM) h) := MODULE
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 32);
  SELF.FldNo2 := 1 + (C % 32);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.seq <> 0,TRIM((SALT311.StrType)le.seq), ''),TRIM((SALT311.StrType)le.ln_fares_id),TRIM((SALT311.StrType)le.unformatted_apn),TRIM((SALT311.StrType)le.prim_range),TRIM((SALT311.StrType)le.predir),TRIM((SALT311.StrType)le.prim_name),TRIM((SALT311.StrType)le.suffix),TRIM((SALT311.StrType)le.postdir),TRIM((SALT311.StrType)le.unit_desig),TRIM((SALT311.StrType)le.sec_range),TRIM((SALT311.StrType)le.p_city_name),TRIM((SALT311.StrType)le.st),TRIM((SALT311.StrType)le.zip),TRIM((SALT311.StrType)le.zip4),TRIM((SALT311.StrType)le.lat),TRIM((SALT311.StrType)le.long),TRIM((SALT311.StrType)le.geo_blk),TRIM((SALT311.StrType)le.fips_code),TRIM((SALT311.StrType)le.land_use_code),TRIM((SALT311.StrType)le.sales_price),TRIM((SALT311.StrType)le.sales_price_code),TRIM((SALT311.StrType)le.recording_date),TRIM((SALT311.StrType)le.assessed_value_year),TRIM((SALT311.StrType)le.assessed_total_value),TRIM((SALT311.StrType)le.market_total_value),TRIM((SALT311.StrType)le.lot_size),TRIM((SALT311.StrType)le.building_area),TRIM((SALT311.StrType)le.year_built),TRIM((SALT311.StrType)le.no_of_stories),TRIM((SALT311.StrType)le.no_of_rooms),TRIM((SALT311.StrType)le.no_of_bedrooms),TRIM((SALT311.StrType)le.no_of_baths)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.seq <> 0,TRIM((SALT311.StrType)le.seq), ''),TRIM((SALT311.StrType)le.ln_fares_id),TRIM((SALT311.StrType)le.unformatted_apn),TRIM((SALT311.StrType)le.prim_range),TRIM((SALT311.StrType)le.predir),TRIM((SALT311.StrType)le.prim_name),TRIM((SALT311.StrType)le.suffix),TRIM((SALT311.StrType)le.postdir),TRIM((SALT311.StrType)le.unit_desig),TRIM((SALT311.StrType)le.sec_range),TRIM((SALT311.StrType)le.p_city_name),TRIM((SALT311.StrType)le.st),TRIM((SALT311.StrType)le.zip),TRIM((SALT311.StrType)le.zip4),TRIM((SALT311.StrType)le.lat),TRIM((SALT311.StrType)le.long),TRIM((SALT311.StrType)le.geo_blk),TRIM((SALT311.StrType)le.fips_code),TRIM((SALT311.StrType)le.land_use_code),TRIM((SALT311.StrType)le.sales_price),TRIM((SALT311.StrType)le.sales_price_code),TRIM((SALT311.StrType)le.recording_date),TRIM((SALT311.StrType)le.assessed_value_year),TRIM((SALT311.StrType)le.assessed_total_value),TRIM((SALT311.StrType)le.market_total_value),TRIM((SALT311.StrType)le.lot_size),TRIM((SALT311.StrType)le.building_area),TRIM((SALT311.StrType)le.year_built),TRIM((SALT311.StrType)le.no_of_stories),TRIM((SALT311.StrType)le.no_of_rooms),TRIM((SALT311.StrType)le.no_of_bedrooms),TRIM((SALT311.StrType)le.no_of_baths)));
  END;
...
SHARED FldIds := DATASET([{1,'seq'}
      ...
      ,{30,'no_of_rooms'}
      ,{31,'no_of_bedrooms'}
      ,{32,'no_of_baths'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Comps_Fields.InValid_seq((SALT311.StrType)le.seq),
    Comps_Fields.InValid_ln_fares_id((SALT311.StrType)le.ln_fares_id),
    Comps_Fields.InValid_unformatted_apn((SALT311.StrType)le.unformatted_apn),
    Comps_Fields.InValid_prim_range((SALT311.StrType)le.prim_range),
    Comps_Fields.InValid_predir((SALT311.StrType)le.predir),
    Comps_Fields.InValid_prim_name((SALT311.StrType)le.prim_name),
    Comps_Fields.InValid_suffix((SALT311.StrType)le.suffix),
    Comps_Fields.InValid_postdir((SALT311.StrType)le.postdir),
    Comps_Fields.InValid_unit_desig((SALT311.StrType)le.unit_desig),
    Comps_Fields.InValid_sec_range((SALT311.StrType)le.sec_range),
    Comps_Fields.InValid_p_city_name((SALT311.StrType)le.p_city_name),
    Comps_Fields.InValid_st((SALT311.StrType)le.st),
    Comps_Fields.InValid_zip((SALT311.StrType)le.zip),
    Comps_Fields.InValid_zip4((SALT311.StrType)le.zip4),
    Comps_Fields.InValid_lat((SALT311.StrType)le.lat),
    Comps_Fields.InValid_long((SALT311.StrType)le.long),
    Comps_Fields.InValid_geo_blk((SALT311.StrType)le.geo_blk),
    Comps_Fields.InValid_fips_code((SALT311.StrType)le.fips_code),
    Comps_Fields.InValid_land_use_code((SALT311.StrType)le.land_use_code),
    Comps_Fields.InValid_sales_price((SALT311.StrType)le.sales_price),
    Comps_Fields.InValid_sales_price_code((SALT311.StrType)le.sales_price_code),
    Comps_Fields.InValid_recording_date((SALT311.StrType)le.recording_date),
    Comps_Fields.InValid_assessed_value_year((SALT311.StrType)le.assessed_value_year),
    Comps_Fields.InValid_assessed_total_value((SALT311.StrType)le.assessed_total_value),
    Comps_Fields.InValid_market_total_value((SALT311.StrType)le.market_total_value),
    Comps_Fields.InValid_lot_size((SALT311.StrType)le.lot_size),
    Comps_Fields.InValid_building_area((SALT311.StrType)le.building_area),
    Comps_Fields.InValid_year_built((SALT311.StrType)le.year_built),
    Comps_Fields.InValid_no_of_stories((SALT311.StrType)le.no_of_stories),
    Comps_Fields.InValid_no_of_rooms((SALT311.StrType)le.no_of_rooms),
    Comps_Fields.InValid_no_of_bedrooms((SALT311.StrType)le.no_of_bedrooms),
    Comps_Fields.InValid_no_of_baths((SALT311.StrType)le.no_of_baths),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Comps_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Comps_Fields.InValidMessage_seq(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_ln_fares_id(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_unformatted_apn(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_predir(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_st(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_lat(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_long(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_fips_code(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_land_use_code(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_sales_price(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_sales_price_code(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_recording_date(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_assessed_value_year(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_assessed_total_value(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_market_total_value(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_lot_size(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_building_area(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_year_built(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_no_of_stories(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_no_of_rooms(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_no_of_bedrooms(TotalErrors.ErrorNum),Comps_Fields.InValidMessage_no_of_baths(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_AVM, Comps_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
