...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 146;
  EXPORT NumRulesFromFieldType := 146;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 73;
  EXPORT NumFieldsWithPossibleEdits := 73;
  EXPORT NumRulesWithPossibleEdits := 146;
...
EXPORT FromNone(DATASET(Layout_File) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.confidence_Invalid << 0 ) + ( le.did1_Invalid << 1 ) + ( le.did2_Invalid << 2 ) + ( le.cohabit_score_Invalid << 3 ) + ( le.cohabit_cnt_Invalid << 4 ) + ( le.coapt_score_Invalid << 6 ) + ( le.coapt_cnt_Invalid << 8 ) + ( le.copobox_score_Invalid << 10 ) + ( le.copobox_cnt_Invalid << 12 ) + ( le.cossn_score_Invalid << 14 ) + ( le.cossn_cnt_Invalid << 16 ) + ( le.copolicy_score_Invalid << 18 ) + ( le.copolicy_cnt_Invalid << 20 ) + ( le.coclaim_score_Invalid << 22 ) + ( le.coclaim_cnt_Invalid << 24 ) + ( le.coproperty_score_Invalid << 26 ) + ( le.coproperty_cnt_Invalid << 28 ) + ( le.bcoproperty_score_Invalid << 30 ) + ( le.bcoproperty_cnt_Invalid << 32 ) + ( le.colien_score_Invalid << 34 ) + ( le.colien_cnt_Invalid << 36 ) + ( le.cobankruptcy_score_Invalid << 38 ) + ( le.cobankruptcy_cnt_Invalid << 40 ) + ( le.bcobankruptcy_score_Invalid << 42 ) + ( le.bcobankruptcy_cnt_Invalid << 44 ) + ( le.covehicle_score_Invalid << 46 ) + ( le.covehicle_cnt_Invalid << 48 ) + ( le.coexperian_score_Invalid << 50 ) + ( le.coexperian_cnt_Invalid << 52 ) + ( le.cotransunion_score_Invalid << 54 ) + ( le.cotransunion_cnt_Invalid << 56 ) + ( le.coecrash_score_Invalid << 58 ) + ( le.coecrash_cnt_Invalid << 60 ) + ( le.bcoecrash_score_Invalid << 62 );
    SELF.ScrubsBits2 := ( le.bcoecrash_cnt_Invalid << 0 ) + ( le.coucc_score_Invalid << 2 ) + ( le.coucc_cnt_Invalid << 4 ) + ( le.lname_score_Invalid << 6 ) + ( le.phone_score_Invalid << 8 ) + ( le.dl_nbr_score_Invalid << 10 ) + ( le.total_cnt_Invalid << 12 ) + ( le.total_score_Invalid << 14 ) + ( le.cluster_Invalid << 16 ) + ( le.generation_Invalid << 18 ) + ( le.gender_Invalid << 20 ) + ( le.lname_cnt_Invalid << 22 ) + ( le.rel_dt_first_seen_Invalid << 24 ) + ( le.rel_dt_last_seen_Invalid << 26 ) + ( le.overlap_months_Invalid << 28 ) + ( le.hdr_dt_first_seen_Invalid << 29 ) + ( le.hdr_dt_last_seen_Invalid << 31 ) + ( le.age_first_seen_Invalid << 33 ) + ( le.isanylnamematch_Invalid << 35 ) + ( le.isanyphonematch_Invalid << 37 ) + ( le.isearlylnamematch_Invalid << 39 ) + ( le.iscurrlnamematch_Invalid << 41 ) + ( le.ismixedlnamematch_Invalid << 43 ) + ( le.ssn1_Invalid << 45 ) + ( le.ssn2_Invalid << 47 ) + ( le.dob1_Invalid << 49 ) + ( le.dob2_Invalid << 51 ) + ( le.current_lname1_Invalid << 53 ) + ( le.current_lname2_Invalid << 55 ) + ( le.early_lname1_Invalid << 57 ) + ( le.early_lname2_Invalid << 58 ) + ( le.addr_ind1_Invalid << 59 ) + ( le.addr_ind2_Invalid << 60 ) + ( le.r2rdid_Invalid << 61 ) + ( le.r2cnt_Invalid << 62 );
    SELF.ScrubsBits3 := ( le.personal_Invalid << 0 ) + ( le.business_Invalid << 2 ) + ( le.other_Invalid << 4 ) + ( le.title_Invalid << 6 );
    SELF.ScrubsCleanBits1 := ( IF(le.confidence_wouldClean, 1, 0) << 0 ) + ( IF(le.did1_wouldClean, 1, 0) << 1 ) + ( IF(le.did2_wouldClean, 1, 0) << 2 ) + ( IF(le.cohabit_score_wouldClean, 1, 0) << 3 ) + ( IF(le.cohabit_cnt_wouldClean, 1, 0) << 4 ) + ( IF(le.coapt_score_wouldClean, 1, 0) << 5 ) + ( IF(le.coapt_cnt_wouldClean, 1, 0) << 6 ) + ( IF(le.copobox_score_wouldClean, 1, 0) << 7 ) + ( IF(le.copobox_cnt_wouldClean, 1, 0) << 8 ) + ( IF(le.cossn_score_wouldClean, 1, 0) << 9 ) + ( IF(le.cossn_cnt_wouldClean, 1, 0) << 10 ) + ( IF(le.copolicy_score_wouldClean, 1, 0) << 11 ) + ( IF(le.copolicy_cnt_wouldClean, 1, 0) << 12 ) + ( IF(le.coclaim_score_wouldClean, 1, 0) << 13 ) + ( IF(le.coclaim_cnt_wouldClean, 1, 0) << 14 ) + ( IF(le.coproperty_score_wouldClean, 1, 0) << 15 ) + ( IF(le.coproperty_cnt_wouldClean, 1, 0) << 16 ) + ( IF(le.bcoproperty_score_wouldClean, 1, 0) << 17 ) + ( IF(le.bcoproperty_cnt_wouldClean, 1, 0) << 18 ) + ( IF(le.colien_score_wouldClean, 1, 0) << 19 ) + ( IF(le.colien_cnt_wouldClean, 1, 0) << 20 ) + ( IF(le.cobankruptcy_score_wouldClean, 1, 0) << 21 ) + ( IF(le.cobankruptcy_cnt_wouldClean, 1, 0) << 22 ) + ( IF(le.bcobankruptcy_score_wouldClean, 1, 0) << 23 ) + ( IF(le.bcobankruptcy_cnt_wouldClean, 1, 0) << 24 ) + ( IF(le.covehicle_score_wouldClean, 1, 0) << 25 ) + ( IF(le.covehicle_cnt_wouldClean, 1, 0) << 26 ) + ( IF(le.coexperian_score_wouldClean, 1, 0) << 27 ) + ( IF(le.coexperian_cnt_wouldClean, 1, 0) << 28 ) + ( IF(le.cotransunion_score_wouldClean, 1, 0) << 29 ) + ( IF(le.cotransunion_cnt_wouldClean, 1, 0) << 30 ) + ( IF(le.coecrash_score_wouldClean, 1, 0) << 31 ) + ( IF(le.coecrash_cnt_wouldClean, 1, 0) << 32 ) + ( IF(le.bcoecrash_score_wouldClean, 1, 0) << 33 ) + ( IF(le.bcoecrash_cnt_wouldClean, 1, 0) << 34 ) + ( IF(le.coucc_score_wouldClean, 1, 0) << 35 ) + ( IF(le.coucc_cnt_wouldClean, 1, 0) << 36 ) + ( IF(le.lname_score_wouldClean, 1, 0) << 37 ) + ( IF(le.phone_score_wouldClean, 1, 0) << 38 ) + ( IF(le.dl_nbr_score_wouldClean, 1, 0) << 39 ) + ( IF(le.total_cnt_wouldClean, 1, 0) << 40 ) + ( IF(le.total_score_wouldClean, 1, 0) << 41 ) + ( IF(le.cluster_wouldClean, 1, 0) << 42 ) + ( IF(le.generation_wouldClean, 1, 0) << 43 ) + ( IF(le.gender_wouldClean, 1, 0) << 44 ) + ( IF(le.lname_cnt_wouldClean, 1, 0) << 45 ) + ( IF(le.rel_dt_first_seen_wouldClean, 1, 0) << 46 ) + ( IF(le.rel_dt_last_seen_wouldClean, 1, 0) << 47 ) + ( IF(le.overlap_months_wouldClean, 1, 0) << 48 ) + ( IF(le.hdr_dt_first_seen_wouldClean, 1, 0) << 49 ) + ( IF(le.hdr_dt_last_seen_wouldClean, 1, 0) << 50 ) + ( IF(le.age_first_seen_wouldClean, 1, 0) << 51 ) + ( IF(le.isanylnamematch_wouldClean, 1, 0) << 52 ) + ( IF(le.isanyphonematch_wouldClean, 1, 0) << 53 ) + ( IF(le.isearlylnamematch_wouldClean, 1, 0) << 54 ) + ( IF(le.iscurrlnamematch_wouldClean, 1, 0) << 55 ) + ( IF(le.ismixedlnamematch_wouldClean, 1, 0) << 56 ) + ( IF(le.ssn1_wouldClean, 1, 0) << 57 ) + ( IF(le.ssn2_wouldClean, 1, 0) << 58 ) + ( IF(le.dob1_wouldClean, 1, 0) << 59 ) + ( IF(le.dob2_wouldClean, 1, 0) << 60 ) + ( IF(le.current_lname1_wouldClean, 1, 0) << 61 ) + ( IF(le.current_lname2_wouldClean, 1, 0) << 62 ) + ( IF(le.early_lname1_wouldClean, 1, 0) << 63 );
    SELF.ScrubsCleanBits2 := ( IF(le.early_lname2_wouldClean, 1, 0) << 0 ) + ( IF(le.addr_ind1_wouldClean, 1, 0) << 1 ) + ( IF(le.addr_ind2_wouldClean, 1, 0) << 2 ) + ( IF(le.r2rdid_wouldClean, 1, 0) << 3 ) + ( IF(le.r2cnt_wouldClean, 1, 0) << 4 ) + ( IF(le.personal_wouldClean, 1, 0) << 5 ) + ( IF(le.business_wouldClean, 1, 0) << 6 ) + ( IF(le.other_wouldClean, 1, 0) << 7 ) + ( IF(le.title_wouldClean, 1, 0) << 8 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    SELF.confidence_Invalid := (le.ScrubsBits1 >> 0) & 1;
    SELF.did1_Invalid := (le.ScrubsBits1 >> 1) & 1;
    SELF.did2_Invalid := (le.ScrubsBits1 >> 2) & 1;
    SELF.cohabit_score_Invalid := (le.ScrubsBits1 >> 3) & 1;
    SELF.cohabit_cnt_Invalid := (le.ScrubsBits1 >> 4) & 3;
    SELF.coapt_score_Invalid := (le.ScrubsBits1 >> 6) & 3;
    SELF.coapt_cnt_Invalid := (le.ScrubsBits1 >> 8) & 3;
    SELF.copobox_score_Invalid := (le.ScrubsBits1 >> 10) & 3;
    SELF.copobox_cnt_Invalid := (le.ScrubsBits1 >> 12) & 3;
    SELF.cossn_score_Invalid := (le.ScrubsBits1 >> 14) & 3;
    SELF.cossn_cnt_Invalid := (le.ScrubsBits1 >> 16) & 3;
    SELF.copolicy_score_Invalid := (le.ScrubsBits1 >> 18) & 3;
    SELF.copolicy_cnt_Invalid := (le.ScrubsBits1 >> 20) & 3;
    SELF.coclaim_score_Invalid := (le.ScrubsBits1 >> 22) & 3;
    SELF.coclaim_cnt_Invalid := (le.ScrubsBits1 >> 24) & 3;
    SELF.coproperty_score_Invalid := (le.ScrubsBits1 >> 26) & 3;
    SELF.coproperty_cnt_Invalid := (le.ScrubsBits1 >> 28) & 3;
    SELF.bcoproperty_score_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.bcoproperty_cnt_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.colien_score_Invalid := (le.ScrubsBits1 >> 34) & 3;
    SELF.colien_cnt_Invalid := (le.ScrubsBits1 >> 36) & 3;
    SELF.cobankruptcy_score_Invalid := (le.ScrubsBits1 >> 38) & 3;
    SELF.cobankruptcy_cnt_Invalid := (le.ScrubsBits1 >> 40) & 3;
    SELF.bcobankruptcy_score_Invalid := (le.ScrubsBits1 >> 42) & 3;
    SELF.bcobankruptcy_cnt_Invalid := (le.ScrubsBits1 >> 44) & 3;
    SELF.covehicle_score_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.covehicle_cnt_Invalid := (le.ScrubsBits1 >> 48) & 3;
    SELF.coexperian_score_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.coexperian_cnt_Invalid := (le.ScrubsBits1 >> 52) & 3;
    SELF.cotransunion_score_Invalid := (le.ScrubsBits1 >> 54) & 3;
    SELF.cotransunion_cnt_Invalid := (le.ScrubsBits1 >> 56) & 3;
    SELF.coecrash_score_Invalid := (le.ScrubsBits1 >> 58) & 3;
    SELF.coecrash_cnt_Invalid := (le.ScrubsBits1 >> 60) & 3;
    SELF.bcoecrash_score_Invalid := (le.ScrubsBits1 >> 62) & 3;
    SELF.bcoecrash_cnt_Invalid := (le.ScrubsBits2 >> 0) & 3;
    SELF.coucc_score_Invalid := (le.ScrubsBits2 >> 2) & 3;
    SELF.coucc_cnt_Invalid := (le.ScrubsBits2 >> 4) & 3;
    SELF.lname_score_Invalid := (le.ScrubsBits2 >> 6) & 3;
    SELF.phone_score_Invalid := (le.ScrubsBits2 >> 8) & 3;
    SELF.dl_nbr_score_Invalid := (le.ScrubsBits2 >> 10) & 3;
    SELF.total_cnt_Invalid := (le.ScrubsBits2 >> 12) & 3;
    SELF.total_score_Invalid := (le.ScrubsBits2 >> 14) & 3;
    SELF.cluster_Invalid := (le.ScrubsBits2 >> 16) & 3;
    SELF.generation_Invalid := (le.ScrubsBits2 >> 18) & 3;
    SELF.gender_Invalid := (le.ScrubsBits2 >> 20) & 3;
    SELF.lname_cnt_Invalid := (le.ScrubsBits2 >> 22) & 3;
    SELF.rel_dt_first_seen_Invalid := (le.ScrubsBits2 >> 24) & 3;
    SELF.rel_dt_last_seen_Invalid := (le.ScrubsBits2 >> 26) & 3;
    SELF.overlap_months_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.hdr_dt_first_seen_Invalid := (le.ScrubsBits2 >> 29) & 3;
    SELF.hdr_dt_last_seen_Invalid := (le.ScrubsBits2 >> 31) & 3;
    SELF.age_first_seen_Invalid := (le.ScrubsBits2 >> 33) & 3;
    SELF.isanylnamematch_Invalid := (le.ScrubsBits2 >> 35) & 3;
    SELF.isanyphonematch_Invalid := (le.ScrubsBits2 >> 37) & 3;
    SELF.isearlylnamematch_Invalid := (le.ScrubsBits2 >> 39) & 3;
    SELF.iscurrlnamematch_Invalid := (le.ScrubsBits2 >> 41) & 3;
    SELF.ismixedlnamematch_Invalid := (le.ScrubsBits2 >> 43) & 3;
    SELF.ssn1_Invalid := (le.ScrubsBits2 >> 45) & 3;
    SELF.ssn2_Invalid := (le.ScrubsBits2 >> 47) & 3;
    SELF.dob1_Invalid := (le.ScrubsBits2 >> 49) & 3;
    SELF.dob2_Invalid := (le.ScrubsBits2 >> 51) & 3;
    SELF.current_lname1_Invalid := (le.ScrubsBits2 >> 53) & 3;
    SELF.current_lname2_Invalid := (le.ScrubsBits2 >> 55) & 3;
    SELF.early_lname1_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.early_lname2_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.addr_ind1_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.addr_ind2_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.r2rdid_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.r2cnt_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.personal_Invalid := (le.ScrubsBits3 >> 0) & 3;
    SELF.business_Invalid := (le.ScrubsBits3 >> 2) & 3;
    SELF.other_Invalid := (le.ScrubsBits3 >> 4) & 3;
    SELF.title_Invalid := (le.ScrubsBits3 >> 6) & 3;
    SELF.confidence_wouldClean := le.ScrubsCleanBits1 >> 0;
    SELF.did1_wouldClean := le.ScrubsCleanBits1 >> 1;
    SELF.did2_wouldClean := le.ScrubsCleanBits1 >> 2;
    SELF.cohabit_score_wouldClean := le.ScrubsCleanBits1 >> 3;
    SELF.cohabit_cnt_wouldClean := le.ScrubsCleanBits1 >> 4;
    SELF.coapt_score_wouldClean := le.ScrubsCleanBits1 >> 5;
    SELF.coapt_cnt_wouldClean := le.ScrubsCleanBits1 >> 6;
    SELF.copobox_score_wouldClean := le.ScrubsCleanBits1 >> 7;
    SELF.copobox_cnt_wouldClean := le.ScrubsCleanBits1 >> 8;
    SELF.cossn_score_wouldClean := le.ScrubsCleanBits1 >> 9;
    SELF.cossn_cnt_wouldClean := le.ScrubsCleanBits1 >> 10;
    SELF.copolicy_score_wouldClean := le.ScrubsCleanBits1 >> 11;
    SELF.copolicy_cnt_wouldClean := le.ScrubsCleanBits1 >> 12;
    SELF.coclaim_score_wouldClean := le.ScrubsCleanBits1 >> 13;
    SELF.coclaim_cnt_wouldClean := le.ScrubsCleanBits1 >> 14;
    SELF.coproperty_score_wouldClean := le.ScrubsCleanBits1 >> 15;
    SELF.coproperty_cnt_wouldClean := le.ScrubsCleanBits1 >> 16;
    SELF.bcoproperty_score_wouldClean := le.ScrubsCleanBits1 >> 17;
    SELF.bcoproperty_cnt_wouldClean := le.ScrubsCleanBits1 >> 18;
    SELF.colien_score_wouldClean := le.ScrubsCleanBits1 >> 19;
    SELF.colien_cnt_wouldClean := le.ScrubsCleanBits1 >> 20;
    SELF.cobankruptcy_score_wouldClean := le.ScrubsCleanBits1 >> 21;
    SELF.cobankruptcy_cnt_wouldClean := le.ScrubsCleanBits1 >> 22;
    SELF.bcobankruptcy_score_wouldClean := le.ScrubsCleanBits1 >> 23;
    SELF.bcobankruptcy_cnt_wouldClean := le.ScrubsCleanBits1 >> 24;
    SELF.covehicle_score_wouldClean := le.ScrubsCleanBits1 >> 25;
    SELF.covehicle_cnt_wouldClean := le.ScrubsCleanBits1 >> 26;
    SELF.coexperian_score_wouldClean := le.ScrubsCleanBits1 >> 27;
    SELF.coexperian_cnt_wouldClean := le.ScrubsCleanBits1 >> 28;
    SELF.cotransunion_score_wouldClean := le.ScrubsCleanBits1 >> 29;
    SELF.cotransunion_cnt_wouldClean := le.ScrubsCleanBits1 >> 30;
    SELF.coecrash_score_wouldClean := le.ScrubsCleanBits1 >> 31;
    SELF.coecrash_cnt_wouldClean := le.ScrubsCleanBits1 >> 32;
    SELF.bcoecrash_score_wouldClean := le.ScrubsCleanBits1 >> 33;
    SELF.bcoecrash_cnt_wouldClean := le.ScrubsCleanBits1 >> 34;
    SELF.coucc_score_wouldClean := le.ScrubsCleanBits1 >> 35;
    SELF.coucc_cnt_wouldClean := le.ScrubsCleanBits1 >> 36;
    SELF.lname_score_wouldClean := le.ScrubsCleanBits1 >> 37;
    SELF.phone_score_wouldClean := le.ScrubsCleanBits1 >> 38;
    SELF.dl_nbr_score_wouldClean := le.ScrubsCleanBits1 >> 39;
    SELF.total_cnt_wouldClean := le.ScrubsCleanBits1 >> 40;
    SELF.total_score_wouldClean := le.ScrubsCleanBits1 >> 41;
    SELF.cluster_wouldClean := le.ScrubsCleanBits1 >> 42;
    SELF.generation_wouldClean := le.ScrubsCleanBits1 >> 43;
    SELF.gender_wouldClean := le.ScrubsCleanBits1 >> 44;
    SELF.lname_cnt_wouldClean := le.ScrubsCleanBits1 >> 45;
    SELF.rel_dt_first_seen_wouldClean := le.ScrubsCleanBits1 >> 46;
    SELF.rel_dt_last_seen_wouldClean := le.ScrubsCleanBits1 >> 47;
    SELF.overlap_months_wouldClean := le.ScrubsCleanBits1 >> 48;
    SELF.hdr_dt_first_seen_wouldClean := le.ScrubsCleanBits1 >> 49;
    SELF.hdr_dt_last_seen_wouldClean := le.ScrubsCleanBits1 >> 50;
    SELF.age_first_seen_wouldClean := le.ScrubsCleanBits1 >> 51;
    SELF.isanylnamematch_wouldClean := le.ScrubsCleanBits1 >> 52;
    SELF.isanyphonematch_wouldClean := le.ScrubsCleanBits1 >> 53;
    SELF.isearlylnamematch_wouldClean := le.ScrubsCleanBits1 >> 54;
    SELF.iscurrlnamematch_wouldClean := le.ScrubsCleanBits1 >> 55;
    SELF.ismixedlnamematch_wouldClean := le.ScrubsCleanBits1 >> 56;
    SELF.ssn1_wouldClean := le.ScrubsCleanBits1 >> 57;
    SELF.ssn2_wouldClean := le.ScrubsCleanBits1 >> 58;
    SELF.dob1_wouldClean := le.ScrubsCleanBits1 >> 59;
    SELF.dob2_wouldClean := le.ScrubsCleanBits1 >> 60;
    SELF.current_lname1_wouldClean := le.ScrubsCleanBits1 >> 61;
    SELF.current_lname2_wouldClean := le.ScrubsCleanBits1 >> 62;
    SELF.early_lname1_wouldClean := le.ScrubsCleanBits1 >> 63;
    SELF.early_lname2_wouldClean := le.ScrubsCleanBits2 >> 0;
    SELF.addr_ind1_wouldClean := le.ScrubsCleanBits2 >> 1;
    SELF.addr_ind2_wouldClean := le.ScrubsCleanBits2 >> 2;
    SELF.r2rdid_wouldClean := le.ScrubsCleanBits2 >> 3;
    SELF.r2cnt_wouldClean := le.ScrubsCleanBits2 >> 4;
    SELF.personal_wouldClean := le.ScrubsCleanBits2 >> 5;
    SELF.business_wouldClean := le.ScrubsCleanBits2 >> 6;
    SELF.other_wouldClean := le.ScrubsCleanBits2 >> 7;
    SELF.title_wouldClean := le.ScrubsCleanBits2 >> 8;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    confidence_WORDS_ErrorCount := COUNT(GROUP,h.confidence_Invalid=1);
    confidence_WORDS_WouldModifyCount := COUNT(GROUP,h.confidence_Invalid=1 AND h.confidence_wouldClean);
    did1_WORDS_ErrorCount := COUNT(GROUP,h.did1_Invalid=1);
    did1_WORDS_WouldModifyCount := COUNT(GROUP,h.did1_Invalid=1 AND h.did1_wouldClean);
    did2_WORDS_ErrorCount := COUNT(GROUP,h.did2_Invalid=1);
    did2_WORDS_WouldModifyCount := COUNT(GROUP,h.did2_Invalid=1 AND h.did2_wouldClean);
    cohabit_score_WORDS_ErrorCount := COUNT(GROUP,h.cohabit_score_Invalid=1);
    cohabit_score_WORDS_WouldModifyCount := COUNT(GROUP,h.cohabit_score_Invalid=1 AND h.cohabit_score_wouldClean);
    cohabit_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.cohabit_cnt_Invalid=1);
    cohabit_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cohabit_cnt_Invalid=1 AND h.cohabit_cnt_wouldClean);
    cohabit_cnt_WORDS_ErrorCount := COUNT(GROUP,h.cohabit_cnt_Invalid=2);
    cohabit_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.cohabit_cnt_Invalid=2 AND h.cohabit_cnt_wouldClean);
    cohabit_cnt_Total_ErrorCount := COUNT(GROUP,h.cohabit_cnt_Invalid>0);
    coapt_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coapt_score_Invalid=1);
    coapt_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coapt_score_Invalid=1 AND h.coapt_score_wouldClean);
    coapt_score_WORDS_ErrorCount := COUNT(GROUP,h.coapt_score_Invalid=2);
    coapt_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coapt_score_Invalid=2 AND h.coapt_score_wouldClean);
    coapt_score_Total_ErrorCount := COUNT(GROUP,h.coapt_score_Invalid>0);
    coapt_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coapt_cnt_Invalid=1);
    coapt_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coapt_cnt_Invalid=1 AND h.coapt_cnt_wouldClean);
    coapt_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coapt_cnt_Invalid=2);
    coapt_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coapt_cnt_Invalid=2 AND h.coapt_cnt_wouldClean);
    coapt_cnt_Total_ErrorCount := COUNT(GROUP,h.coapt_cnt_Invalid>0);
    copobox_score_LENGTHS_ErrorCount := COUNT(GROUP,h.copobox_score_Invalid=1);
    copobox_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.copobox_score_Invalid=1 AND h.copobox_score_wouldClean);
    copobox_score_WORDS_ErrorCount := COUNT(GROUP,h.copobox_score_Invalid=2);
    copobox_score_WORDS_WouldModifyCount := COUNT(GROUP,h.copobox_score_Invalid=2 AND h.copobox_score_wouldClean);
    copobox_score_Total_ErrorCount := COUNT(GROUP,h.copobox_score_Invalid>0);
    copobox_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.copobox_cnt_Invalid=1);
    copobox_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.copobox_cnt_Invalid=1 AND h.copobox_cnt_wouldClean);
    copobox_cnt_WORDS_ErrorCount := COUNT(GROUP,h.copobox_cnt_Invalid=2);
    copobox_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.copobox_cnt_Invalid=2 AND h.copobox_cnt_wouldClean);
    copobox_cnt_Total_ErrorCount := COUNT(GROUP,h.copobox_cnt_Invalid>0);
    cossn_score_LENGTHS_ErrorCount := COUNT(GROUP,h.cossn_score_Invalid=1);
    cossn_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cossn_score_Invalid=1 AND h.cossn_score_wouldClean);
    cossn_score_WORDS_ErrorCount := COUNT(GROUP,h.cossn_score_Invalid=2);
    cossn_score_WORDS_WouldModifyCount := COUNT(GROUP,h.cossn_score_Invalid=2 AND h.cossn_score_wouldClean);
    cossn_score_Total_ErrorCount := COUNT(GROUP,h.cossn_score_Invalid>0);
    cossn_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.cossn_cnt_Invalid=1);
    cossn_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cossn_cnt_Invalid=1 AND h.cossn_cnt_wouldClean);
    cossn_cnt_WORDS_ErrorCount := COUNT(GROUP,h.cossn_cnt_Invalid=2);
    cossn_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.cossn_cnt_Invalid=2 AND h.cossn_cnt_wouldClean);
    cossn_cnt_Total_ErrorCount := COUNT(GROUP,h.cossn_cnt_Invalid>0);
    copolicy_score_LENGTHS_ErrorCount := COUNT(GROUP,h.copolicy_score_Invalid=1);
    copolicy_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.copolicy_score_Invalid=1 AND h.copolicy_score_wouldClean);
    copolicy_score_WORDS_ErrorCount := COUNT(GROUP,h.copolicy_score_Invalid=2);
    copolicy_score_WORDS_WouldModifyCount := COUNT(GROUP,h.copolicy_score_Invalid=2 AND h.copolicy_score_wouldClean);
    copolicy_score_Total_ErrorCount := COUNT(GROUP,h.copolicy_score_Invalid>0);
    copolicy_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.copolicy_cnt_Invalid=1);
    copolicy_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.copolicy_cnt_Invalid=1 AND h.copolicy_cnt_wouldClean);
    copolicy_cnt_WORDS_ErrorCount := COUNT(GROUP,h.copolicy_cnt_Invalid=2);
    copolicy_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.copolicy_cnt_Invalid=2 AND h.copolicy_cnt_wouldClean);
    copolicy_cnt_Total_ErrorCount := COUNT(GROUP,h.copolicy_cnt_Invalid>0);
    coclaim_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coclaim_score_Invalid=1);
    coclaim_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coclaim_score_Invalid=1 AND h.coclaim_score_wouldClean);
    coclaim_score_WORDS_ErrorCount := COUNT(GROUP,h.coclaim_score_Invalid=2);
    coclaim_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coclaim_score_Invalid=2 AND h.coclaim_score_wouldClean);
    coclaim_score_Total_ErrorCount := COUNT(GROUP,h.coclaim_score_Invalid>0);
    coclaim_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coclaim_cnt_Invalid=1);
    coclaim_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coclaim_cnt_Invalid=1 AND h.coclaim_cnt_wouldClean);
    coclaim_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coclaim_cnt_Invalid=2);
    coclaim_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coclaim_cnt_Invalid=2 AND h.coclaim_cnt_wouldClean);
    coclaim_cnt_Total_ErrorCount := COUNT(GROUP,h.coclaim_cnt_Invalid>0);
    coproperty_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coproperty_score_Invalid=1);
    coproperty_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coproperty_score_Invalid=1 AND h.coproperty_score_wouldClean);
    coproperty_score_WORDS_ErrorCount := COUNT(GROUP,h.coproperty_score_Invalid=2);
    coproperty_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coproperty_score_Invalid=2 AND h.coproperty_score_wouldClean);
    coproperty_score_Total_ErrorCount := COUNT(GROUP,h.coproperty_score_Invalid>0);
    coproperty_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coproperty_cnt_Invalid=1);
    coproperty_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coproperty_cnt_Invalid=1 AND h.coproperty_cnt_wouldClean);
    coproperty_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coproperty_cnt_Invalid=2);
    coproperty_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coproperty_cnt_Invalid=2 AND h.coproperty_cnt_wouldClean);
    coproperty_cnt_Total_ErrorCount := COUNT(GROUP,h.coproperty_cnt_Invalid>0);
    bcoproperty_score_LENGTHS_ErrorCount := COUNT(GROUP,h.bcoproperty_score_Invalid=1);
    bcoproperty_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcoproperty_score_Invalid=1 AND h.bcoproperty_score_wouldClean);
    bcoproperty_score_WORDS_ErrorCount := COUNT(GROUP,h.bcoproperty_score_Invalid=2);
    bcoproperty_score_WORDS_WouldModifyCount := COUNT(GROUP,h.bcoproperty_score_Invalid=2 AND h.bcoproperty_score_wouldClean);
    bcoproperty_score_Total_ErrorCount := COUNT(GROUP,h.bcoproperty_score_Invalid>0);
    bcoproperty_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.bcoproperty_cnt_Invalid=1);
    bcoproperty_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcoproperty_cnt_Invalid=1 AND h.bcoproperty_cnt_wouldClean);
    bcoproperty_cnt_WORDS_ErrorCount := COUNT(GROUP,h.bcoproperty_cnt_Invalid=2);
    bcoproperty_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.bcoproperty_cnt_Invalid=2 AND h.bcoproperty_cnt_wouldClean);
    bcoproperty_cnt_Total_ErrorCount := COUNT(GROUP,h.bcoproperty_cnt_Invalid>0);
    colien_score_LENGTHS_ErrorCount := COUNT(GROUP,h.colien_score_Invalid=1);
    colien_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.colien_score_Invalid=1 AND h.colien_score_wouldClean);
    colien_score_WORDS_ErrorCount := COUNT(GROUP,h.colien_score_Invalid=2);
    colien_score_WORDS_WouldModifyCount := COUNT(GROUP,h.colien_score_Invalid=2 AND h.colien_score_wouldClean);
    colien_score_Total_ErrorCount := COUNT(GROUP,h.colien_score_Invalid>0);
    colien_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.colien_cnt_Invalid=1);
    colien_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.colien_cnt_Invalid=1 AND h.colien_cnt_wouldClean);
    colien_cnt_WORDS_ErrorCount := COUNT(GROUP,h.colien_cnt_Invalid=2);
    colien_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.colien_cnt_Invalid=2 AND h.colien_cnt_wouldClean);
    colien_cnt_Total_ErrorCount := COUNT(GROUP,h.colien_cnt_Invalid>0);
    cobankruptcy_score_LENGTHS_ErrorCount := COUNT(GROUP,h.cobankruptcy_score_Invalid=1);
    cobankruptcy_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cobankruptcy_score_Invalid=1 AND h.cobankruptcy_score_wouldClean);
    cobankruptcy_score_WORDS_ErrorCount := COUNT(GROUP,h.cobankruptcy_score_Invalid=2);
    cobankruptcy_score_WORDS_WouldModifyCount := COUNT(GROUP,h.cobankruptcy_score_Invalid=2 AND h.cobankruptcy_score_wouldClean);
    cobankruptcy_score_Total_ErrorCount := COUNT(GROUP,h.cobankruptcy_score_Invalid>0);
    cobankruptcy_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.cobankruptcy_cnt_Invalid=1);
    cobankruptcy_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cobankruptcy_cnt_Invalid=1 AND h.cobankruptcy_cnt_wouldClean);
    cobankruptcy_cnt_WORDS_ErrorCount := COUNT(GROUP,h.cobankruptcy_cnt_Invalid=2);
    cobankruptcy_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.cobankruptcy_cnt_Invalid=2 AND h.cobankruptcy_cnt_wouldClean);
    cobankruptcy_cnt_Total_ErrorCount := COUNT(GROUP,h.cobankruptcy_cnt_Invalid>0);
    bcobankruptcy_score_LENGTHS_ErrorCount := COUNT(GROUP,h.bcobankruptcy_score_Invalid=1);
    bcobankruptcy_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcobankruptcy_score_Invalid=1 AND h.bcobankruptcy_score_wouldClean);
    bcobankruptcy_score_WORDS_ErrorCount := COUNT(GROUP,h.bcobankruptcy_score_Invalid=2);
    bcobankruptcy_score_WORDS_WouldModifyCount := COUNT(GROUP,h.bcobankruptcy_score_Invalid=2 AND h.bcobankruptcy_score_wouldClean);
    bcobankruptcy_score_Total_ErrorCount := COUNT(GROUP,h.bcobankruptcy_score_Invalid>0);
    bcobankruptcy_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.bcobankruptcy_cnt_Invalid=1);
    bcobankruptcy_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcobankruptcy_cnt_Invalid=1 AND h.bcobankruptcy_cnt_wouldClean);
    bcobankruptcy_cnt_WORDS_ErrorCount := COUNT(GROUP,h.bcobankruptcy_cnt_Invalid=2);
    bcobankruptcy_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.bcobankruptcy_cnt_Invalid=2 AND h.bcobankruptcy_cnt_wouldClean);
    bcobankruptcy_cnt_Total_ErrorCount := COUNT(GROUP,h.bcobankruptcy_cnt_Invalid>0);
    covehicle_score_LENGTHS_ErrorCount := COUNT(GROUP,h.covehicle_score_Invalid=1);
    covehicle_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.covehicle_score_Invalid=1 AND h.covehicle_score_wouldClean);
    covehicle_score_WORDS_ErrorCount := COUNT(GROUP,h.covehicle_score_Invalid=2);
    covehicle_score_WORDS_WouldModifyCount := COUNT(GROUP,h.covehicle_score_Invalid=2 AND h.covehicle_score_wouldClean);
    covehicle_score_Total_ErrorCount := COUNT(GROUP,h.covehicle_score_Invalid>0);
    covehicle_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.covehicle_cnt_Invalid=1);
    covehicle_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.covehicle_cnt_Invalid=1 AND h.covehicle_cnt_wouldClean);
    covehicle_cnt_WORDS_ErrorCount := COUNT(GROUP,h.covehicle_cnt_Invalid=2);
    covehicle_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.covehicle_cnt_Invalid=2 AND h.covehicle_cnt_wouldClean);
    covehicle_cnt_Total_ErrorCount := COUNT(GROUP,h.covehicle_cnt_Invalid>0);
    coexperian_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coexperian_score_Invalid=1);
    coexperian_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coexperian_score_Invalid=1 AND h.coexperian_score_wouldClean);
    coexperian_score_WORDS_ErrorCount := COUNT(GROUP,h.coexperian_score_Invalid=2);
    coexperian_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coexperian_score_Invalid=2 AND h.coexperian_score_wouldClean);
    coexperian_score_Total_ErrorCount := COUNT(GROUP,h.coexperian_score_Invalid>0);
    coexperian_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coexperian_cnt_Invalid=1);
    coexperian_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coexperian_cnt_Invalid=1 AND h.coexperian_cnt_wouldClean);
    coexperian_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coexperian_cnt_Invalid=2);
    coexperian_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coexperian_cnt_Invalid=2 AND h.coexperian_cnt_wouldClean);
    coexperian_cnt_Total_ErrorCount := COUNT(GROUP,h.coexperian_cnt_Invalid>0);
    cotransunion_score_LENGTHS_ErrorCount := COUNT(GROUP,h.cotransunion_score_Invalid=1);
    cotransunion_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cotransunion_score_Invalid=1 AND h.cotransunion_score_wouldClean);
    cotransunion_score_WORDS_ErrorCount := COUNT(GROUP,h.cotransunion_score_Invalid=2);
    cotransunion_score_WORDS_WouldModifyCount := COUNT(GROUP,h.cotransunion_score_Invalid=2 AND h.cotransunion_score_wouldClean);
    cotransunion_score_Total_ErrorCount := COUNT(GROUP,h.cotransunion_score_Invalid>0);
    cotransunion_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.cotransunion_cnt_Invalid=1);
    cotransunion_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.cotransunion_cnt_Invalid=1 AND h.cotransunion_cnt_wouldClean);
    cotransunion_cnt_WORDS_ErrorCount := COUNT(GROUP,h.cotransunion_cnt_Invalid=2);
    cotransunion_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.cotransunion_cnt_Invalid=2 AND h.cotransunion_cnt_wouldClean);
    cotransunion_cnt_Total_ErrorCount := COUNT(GROUP,h.cotransunion_cnt_Invalid>0);
    coecrash_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coecrash_score_Invalid=1);
    coecrash_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coecrash_score_Invalid=1 AND h.coecrash_score_wouldClean);
    coecrash_score_WORDS_ErrorCount := COUNT(GROUP,h.coecrash_score_Invalid=2);
    coecrash_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coecrash_score_Invalid=2 AND h.coecrash_score_wouldClean);
    coecrash_score_Total_ErrorCount := COUNT(GROUP,h.coecrash_score_Invalid>0);
    coecrash_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coecrash_cnt_Invalid=1);
    coecrash_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coecrash_cnt_Invalid=1 AND h.coecrash_cnt_wouldClean);
    coecrash_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coecrash_cnt_Invalid=2);
    coecrash_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coecrash_cnt_Invalid=2 AND h.coecrash_cnt_wouldClean);
    coecrash_cnt_Total_ErrorCount := COUNT(GROUP,h.coecrash_cnt_Invalid>0);
    bcoecrash_score_LENGTHS_ErrorCount := COUNT(GROUP,h.bcoecrash_score_Invalid=1);
    bcoecrash_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcoecrash_score_Invalid=1 AND h.bcoecrash_score_wouldClean);
    bcoecrash_score_WORDS_ErrorCount := COUNT(GROUP,h.bcoecrash_score_Invalid=2);
    bcoecrash_score_WORDS_WouldModifyCount := COUNT(GROUP,h.bcoecrash_score_Invalid=2 AND h.bcoecrash_score_wouldClean);
    bcoecrash_score_Total_ErrorCount := COUNT(GROUP,h.bcoecrash_score_Invalid>0);
    bcoecrash_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.bcoecrash_cnt_Invalid=1);
    bcoecrash_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.bcoecrash_cnt_Invalid=1 AND h.bcoecrash_cnt_wouldClean);
    bcoecrash_cnt_WORDS_ErrorCount := COUNT(GROUP,h.bcoecrash_cnt_Invalid=2);
    bcoecrash_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.bcoecrash_cnt_Invalid=2 AND h.bcoecrash_cnt_wouldClean);
    bcoecrash_cnt_Total_ErrorCount := COUNT(GROUP,h.bcoecrash_cnt_Invalid>0);
    coucc_score_LENGTHS_ErrorCount := COUNT(GROUP,h.coucc_score_Invalid=1);
    coucc_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coucc_score_Invalid=1 AND h.coucc_score_wouldClean);
    coucc_score_WORDS_ErrorCount := COUNT(GROUP,h.coucc_score_Invalid=2);
    coucc_score_WORDS_WouldModifyCount := COUNT(GROUP,h.coucc_score_Invalid=2 AND h.coucc_score_wouldClean);
    coucc_score_Total_ErrorCount := COUNT(GROUP,h.coucc_score_Invalid>0);
    coucc_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.coucc_cnt_Invalid=1);
    coucc_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.coucc_cnt_Invalid=1 AND h.coucc_cnt_wouldClean);
    coucc_cnt_WORDS_ErrorCount := COUNT(GROUP,h.coucc_cnt_Invalid=2);
    coucc_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.coucc_cnt_Invalid=2 AND h.coucc_cnt_wouldClean);
    coucc_cnt_Total_ErrorCount := COUNT(GROUP,h.coucc_cnt_Invalid>0);
    lname_score_LENGTHS_ErrorCount := COUNT(GROUP,h.lname_score_Invalid=1);
    lname_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.lname_score_Invalid=1 AND h.lname_score_wouldClean);
    lname_score_WORDS_ErrorCount := COUNT(GROUP,h.lname_score_Invalid=2);
    lname_score_WORDS_WouldModifyCount := COUNT(GROUP,h.lname_score_Invalid=2 AND h.lname_score_wouldClean);
    lname_score_Total_ErrorCount := COUNT(GROUP,h.lname_score_Invalid>0);
    phone_score_LENGTHS_ErrorCount := COUNT(GROUP,h.phone_score_Invalid=1);
    phone_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.phone_score_Invalid=1 AND h.phone_score_wouldClean);
    phone_score_WORDS_ErrorCount := COUNT(GROUP,h.phone_score_Invalid=2);
    phone_score_WORDS_WouldModifyCount := COUNT(GROUP,h.phone_score_Invalid=2 AND h.phone_score_wouldClean);
    ...
    total_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.total_cnt_Invalid=1);
    total_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.total_cnt_Invalid=1 AND h.total_cnt_wouldClean);
    total_cnt_WORDS_ErrorCount := COUNT(GROUP,h.total_cnt_Invalid=2);
    total_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.total_cnt_Invalid=2 AND h.total_cnt_wouldClean);
    total_cnt_Total_ErrorCount := COUNT(GROUP,h.total_cnt_Invalid>0);
    total_score_LENGTHS_ErrorCount := COUNT(GROUP,h.total_score_Invalid=1);
    total_score_LENGTHS_WouldModifyCount := COUNT(GROUP,h.total_score_Invalid=1 AND h.total_score_wouldClean);
    total_score_WORDS_ErrorCount := COUNT(GROUP,h.total_score_Invalid=2);
    total_score_WORDS_WouldModifyCount := COUNT(GROUP,h.total_score_Invalid=2 AND h.total_score_wouldClean);
    ...
    lname_cnt_LENGTHS_ErrorCount := COUNT(GROUP,h.lname_cnt_Invalid=1);
    lname_cnt_LENGTHS_WouldModifyCount := COUNT(GROUP,h.lname_cnt_Invalid=1 AND h.lname_cnt_wouldClean);
    lname_cnt_WORDS_ErrorCount := COUNT(GROUP,h.lname_cnt_Invalid=2);
    lname_cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.lname_cnt_Invalid=2 AND h.lname_cnt_wouldClean);
    lname_cnt_Total_ErrorCount := COUNT(GROUP,h.lname_cnt_Invalid>0);
    rel_dt_first_seen_LENGTHS_ErrorCount := COUNT(GROUP,h.rel_dt_first_seen_Invalid=1);
    rel_dt_first_seen_LENGTHS_WouldModifyCount := COUNT(GROUP,h.rel_dt_first_seen_Invalid=1 AND h.rel_dt_first_seen_wouldClean);
    rel_dt_first_seen_WORDS_ErrorCount := COUNT(GROUP,h.rel_dt_first_seen_Invalid=2);
    rel_dt_first_seen_WORDS_WouldModifyCount := COUNT(GROUP,h.rel_dt_first_seen_Invalid=2 AND h.rel_dt_first_seen_wouldClean);
    rel_dt_first_seen_Total_ErrorCount := COUNT(GROUP,h.rel_dt_first_seen_Invalid>0);
    rel_dt_last_seen_LENGTHS_ErrorCount := COUNT(GROUP,h.rel_dt_last_seen_Invalid=1);
    rel_dt_last_seen_LENGTHS_WouldModifyCount := COUNT(GROUP,h.rel_dt_last_seen_Invalid=1 AND h.rel_dt_last_seen_wouldClean);
    rel_dt_last_seen_WORDS_ErrorCount := COUNT(GROUP,h.rel_dt_last_seen_Invalid=2);
    rel_dt_last_seen_WORDS_WouldModifyCount := COUNT(GROUP,h.rel_dt_last_seen_Invalid=2 AND h.rel_dt_last_seen_wouldClean);
    rel_dt_last_seen_Total_ErrorCount := COUNT(GROUP,h.rel_dt_last_seen_Invalid>0);
    overlap_months_WORDS_ErrorCount := COUNT(GROUP,h.overlap_months_Invalid=1);
    overlap_months_WORDS_WouldModifyCount := COUNT(GROUP,h.overlap_months_Invalid=1 AND h.overlap_months_wouldClean);
    hdr_dt_first_seen_LENGTHS_ErrorCount := COUNT(GROUP,h.hdr_dt_first_seen_Invalid=1);
    hdr_dt_first_seen_LENGTHS_WouldModifyCount := COUNT(GROUP,h.hdr_dt_first_seen_Invalid=1 AND h.hdr_dt_first_seen_wouldClean);
    hdr_dt_first_seen_WORDS_ErrorCount := COUNT(GROUP,h.hdr_dt_first_seen_Invalid=2);
    hdr_dt_first_seen_WORDS_WouldModifyCount := COUNT(GROUP,h.hdr_dt_first_seen_Invalid=2 AND h.hdr_dt_first_seen_wouldClean);
    hdr_dt_first_seen_Total_ErrorCount := COUNT(GROUP,h.hdr_dt_first_seen_Invalid>0);
    hdr_dt_last_seen_LENGTHS_ErrorCount := COUNT(GROUP,h.hdr_dt_last_seen_Invalid=1);
    hdr_dt_last_seen_LENGTHS_WouldModifyCount := COUNT(GROUP,h.hdr_dt_last_seen_Invalid=1 AND h.hdr_dt_last_seen_wouldClean);
    hdr_dt_last_seen_WORDS_ErrorCount := COUNT(GROUP,h.hdr_dt_last_seen_Invalid=2);
    hdr_dt_last_seen_WORDS_WouldModifyCount := COUNT(GROUP,h.hdr_dt_last_seen_Invalid=2 AND h.hdr_dt_last_seen_wouldClean);
    hdr_dt_last_seen_Total_ErrorCount := COUNT(GROUP,h.hdr_dt_last_seen_Invalid>0);
    age_first_seen_LENGTHS_ErrorCount := COUNT(GROUP,h.age_first_seen_Invalid=1);
    age_first_seen_LENGTHS_WouldModifyCount := COUNT(GROUP,h.age_first_seen_Invalid=1 AND h.age_first_seen_wouldClean);
    age_first_seen_WORDS_ErrorCount := COUNT(GROUP,h.age_first_seen_Invalid=2);
    age_first_seen_WORDS_WouldModifyCount := COUNT(GROUP,h.age_first_seen_Invalid=2 AND h.age_first_seen_wouldClean);
    ...
    ssn1_LENGTHS_ErrorCount := COUNT(GROUP,h.ssn1_Invalid=1);
    ssn1_LENGTHS_WouldModifyCount := COUNT(GROUP,h.ssn1_Invalid=1 AND h.ssn1_wouldClean);
    ssn1_WORDS_ErrorCount := COUNT(GROUP,h.ssn1_Invalid=2);
    ssn1_WORDS_WouldModifyCount := COUNT(GROUP,h.ssn1_Invalid=2 AND h.ssn1_wouldClean);
    ssn1_Total_ErrorCount := COUNT(GROUP,h.ssn1_Invalid>0);
    ssn2_LENGTHS_ErrorCount := COUNT(GROUP,h.ssn2_Invalid=1);
    ssn2_LENGTHS_WouldModifyCount := COUNT(GROUP,h.ssn2_Invalid=1 AND h.ssn2_wouldClean);
    ssn2_WORDS_ErrorCount := COUNT(GROUP,h.ssn2_Invalid=2);
    ssn2_WORDS_WouldModifyCount := COUNT(GROUP,h.ssn2_Invalid=2 AND h.ssn2_wouldClean);
    ssn2_Total_ErrorCount := COUNT(GROUP,h.ssn2_Invalid>0);
    dob1_LENGTHS_ErrorCount := COUNT(GROUP,h.dob1_Invalid=1);
    dob1_LENGTHS_WouldModifyCount := COUNT(GROUP,h.dob1_Invalid=1 AND h.dob1_wouldClean);
    dob1_WORDS_ErrorCount := COUNT(GROUP,h.dob1_Invalid=2);
    dob1_WORDS_WouldModifyCount := COUNT(GROUP,h.dob1_Invalid=2 AND h.dob1_wouldClean);
    dob1_Total_ErrorCount := COUNT(GROUP,h.dob1_Invalid>0);
    dob2_LENGTHS_ErrorCount := COUNT(GROUP,h.dob2_Invalid=1);
    dob2_LENGTHS_WouldModifyCount := COUNT(GROUP,h.dob2_Invalid=1 AND h.dob2_wouldClean);
    dob2_WORDS_ErrorCount := COUNT(GROUP,h.dob2_Invalid=2);
    dob2_WORDS_WouldModifyCount := COUNT(GROUP,h.dob2_Invalid=2 AND h.dob2_wouldClean);
    ...
    early_lname1_WORDS_ErrorCount := COUNT(GROUP,h.early_lname1_Invalid=1);
    early_lname1_WORDS_WouldModifyCount := COUNT(GROUP,h.early_lname1_Invalid=1 AND h.early_lname1_wouldClean);
    early_lname2_WORDS_ErrorCount := COUNT(GROUP,h.early_lname2_Invalid=1);
    early_lname2_WORDS_WouldModifyCount := COUNT(GROUP,h.early_lname2_Invalid=1 AND h.early_lname2_wouldClean);
    addr_ind1_WORDS_ErrorCount := COUNT(GROUP,h.addr_ind1_Invalid=1);
    addr_ind1_WORDS_WouldModifyCount := COUNT(GROUP,h.addr_ind1_Invalid=1 AND h.addr_ind1_wouldClean);
    addr_ind2_WORDS_ErrorCount := COUNT(GROUP,h.addr_ind2_Invalid=1);
    addr_ind2_WORDS_WouldModifyCount := COUNT(GROUP,h.addr_ind2_Invalid=1 AND h.addr_ind2_wouldClean);
    r2rdid_WORDS_ErrorCount := COUNT(GROUP,h.r2rdid_Invalid=1);
    r2rdid_WORDS_WouldModifyCount := COUNT(GROUP,h.r2rdid_Invalid=1 AND h.r2rdid_wouldClean);
    r2cnt_WORDS_ErrorCount := COUNT(GROUP,h.r2cnt_Invalid=1);
    r2cnt_WORDS_WouldModifyCount := COUNT(GROUP,h.r2cnt_Invalid=1 AND h.r2cnt_wouldClean);
  ...
  SummaryStats0 xAddErrSummary(SummaryStats0 le) := TRANSFORM
    SELF.FieldsChecked_WithErrors := IF(le.confidence_WORDS_ErrorCount > 0, 1, 0) + IF(le.did1_WORDS_ErrorCount > 0, 1, 0) + IF(le.did2_WORDS_ErrorCount > 0, 1, 0) + IF(le.cohabit_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cohabit_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coapt_score_Total_ErrorCount > 0, 1, 0) + IF(le.coapt_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.copobox_score_Total_ErrorCount > 0, 1, 0) + IF(le.copobox_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.cossn_score_Total_ErrorCount > 0, 1, 0) + IF(le.cossn_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.copolicy_score_Total_ErrorCount > 0, 1, 0) + IF(le.copolicy_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coclaim_score_Total_ErrorCount > 0, 1, 0) + IF(le.coclaim_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coproperty_score_Total_ErrorCount > 0, 1, 0) + IF(le.coproperty_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_score_Total_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.colien_score_Total_ErrorCount > 0, 1, 0) + IF(le.colien_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_score_Total_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_score_Total_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.covehicle_score_Total_ErrorCount > 0, 1, 0) + IF(le.covehicle_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coexperian_score_Total_ErrorCount > 0, 1, 0) + IF(le.coexperian_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.cotransunion_score_Total_ErrorCount > 0, 1, 0) + IF(le.cotransunion_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coecrash_score_Total_ErrorCount > 0, 1, 0) + IF(le.coecrash_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_score_Total_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.coucc_score_Total_ErrorCount > 0, 1, 0) + IF(le.coucc_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.lname_score_Total_ErrorCount > 0, 1, 0) + IF(le.phone_score_Total_ErrorCount > 0, 1, 0) + IF(le.dl_nbr_score_Total_ErrorCount > 0, 1, 0) + IF(le.total_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.total_score_Total_ErrorCount > 0, 1, 0) + IF(le.cluster_Total_ErrorCount > 0, 1, 0) + IF(le.generation_Total_ErrorCount > 0, 1, 0) + IF(le.gender_Total_ErrorCount > 0, 1, 0) + IF(le.lname_cnt_Total_ErrorCount > 0, 1, 0) + IF(le.rel_dt_first_seen_Total_ErrorCount > 0, 1, 0) + IF(le.rel_dt_last_seen_Total_ErrorCount > 0, 1, 0) + IF(le.overlap_months_WORDS_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_first_seen_Total_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_last_seen_Total_ErrorCount > 0, 1, 0) + IF(le.age_first_seen_Total_ErrorCount > 0, 1, 0) + IF(le.isanylnamematch_Total_ErrorCount > 0, 1, 0) + IF(le.isanyphonematch_Total_ErrorCount > 0, 1, 0) + IF(le.isearlylnamematch_Total_ErrorCount > 0, 1, 0) + IF(le.iscurrlnamematch_Total_ErrorCount > 0, 1, 0) + IF(le.ismixedlnamematch_Total_ErrorCount > 0, 1, 0) + IF(le.ssn1_Total_ErrorCount > 0, 1, 0) + IF(le.ssn2_Total_ErrorCount > 0, 1, 0) + IF(le.dob1_Total_ErrorCount > 0, 1, 0) + IF(le.dob2_Total_ErrorCount > 0, 1, 0) + IF(le.current_lname1_Total_ErrorCount > 0, 1, 0) + IF(le.current_lname2_Total_ErrorCount > 0, 1, 0) + IF(le.early_lname1_WORDS_ErrorCount > 0, 1, 0) + IF(le.early_lname2_WORDS_ErrorCount > 0, 1, 0) + IF(le.addr_ind1_WORDS_ErrorCount > 0, 1, 0) + IF(le.addr_ind2_WORDS_ErrorCount > 0, 1, 0) + IF(le.r2rdid_WORDS_ErrorCount > 0, 1, 0) + IF(le.r2cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.personal_Total_ErrorCount > 0, 1, 0) + IF(le.business_Total_ErrorCount > 0, 1, 0) + IF(le.other_Total_ErrorCount > 0, 1, 0) + IF(le.title_Total_ErrorCount > 0, 1, 0);
    SELF.FieldsChecked_NoErrors := NumFieldsWithRules - SELF.FieldsChecked_WithErrors;
    SELF.Rules_WithErrors := IF(le.confidence_WORDS_ErrorCount > 0, 1, 0) + IF(le.did1_WORDS_ErrorCount > 0, 1, 0) + IF(le.did2_WORDS_ErrorCount > 0, 1, 0) + IF(le.cohabit_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cohabit_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cohabit_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coapt_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coapt_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coapt_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coapt_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.copobox_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.copobox_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.copobox_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.copobox_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.cossn_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cossn_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cossn_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cossn_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.copolicy_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.copolicy_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.copolicy_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.copolicy_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coclaim_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coclaim_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coclaim_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coclaim_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coproperty_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coproperty_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coproperty_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coproperty_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcoproperty_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.colien_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.colien_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.colien_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.colien_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cobankruptcy_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcobankruptcy_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.covehicle_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.covehicle_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.covehicle_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.covehicle_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coexperian_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coexperian_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coexperian_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coexperian_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.cotransunion_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cotransunion_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cotransunion_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cotransunion_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coecrash_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coecrash_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coecrash_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coecrash_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bcoecrash_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.coucc_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coucc_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.coucc_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.coucc_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.lname_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.lname_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.phone_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.phone_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.dl_nbr_score_ALLOW_ErrorCount > 0, 1, 0) + IF(le.dl_nbr_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.total_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.total_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.total_score_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.total_score_WORDS_ErrorCount > 0, 1, 0) + IF(le.cluster_ALLOW_ErrorCount > 0, 1, 0) + IF(le.cluster_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.cluster_WORDS_ErrorCount > 0, 1, 0) + IF(le.generation_ALLOW_ErrorCount > 0, 1, 0) + IF(le.generation_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.generation_WORDS_ErrorCount > 0, 1, 0) + IF(le.gender_ALLOW_ErrorCount > 0, 1, 0) + IF(le.gender_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.gender_WORDS_ErrorCount > 0, 1, 0) + IF(le.lname_cnt_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.lname_cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.rel_dt_first_seen_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.rel_dt_first_seen_WORDS_ErrorCount > 0, 1, 0) + IF(le.rel_dt_last_seen_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.rel_dt_last_seen_WORDS_ErrorCount > 0, 1, 0) + IF(le.overlap_months_WORDS_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_first_seen_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_first_seen_WORDS_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_last_seen_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.hdr_dt_last_seen_WORDS_ErrorCount > 0, 1, 0) + IF(le.age_first_seen_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.age_first_seen_WORDS_ErrorCount > 0, 1, 0) + IF(le.isanylnamematch_ALLOW_ErrorCount > 0, 1, 0) + IF(le.isanylnamematch_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.isanylnamematch_WORDS_ErrorCount > 0, 1, 0) + IF(le.isanyphonematch_ALLOW_ErrorCount > 0, 1, 0) + IF(le.isanyphonematch_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.isanyphonematch_WORDS_ErrorCount > 0, 1, 0) + IF(le.isearlylnamematch_ALLOW_ErrorCount > 0, 1, 0) + IF(le.isearlylnamematch_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.isearlylnamematch_WORDS_ErrorCount > 0, 1, 0) + IF(le.iscurrlnamematch_ALLOW_ErrorCount > 0, 1, 0) + IF(le.iscurrlnamematch_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.iscurrlnamematch_WORDS_ErrorCount > 0, 1, 0) + IF(le.ismixedlnamematch_ALLOW_ErrorCount > 0, 1, 0) + IF(le.ismixedlnamematch_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.ismixedlnamematch_WORDS_ErrorCount > 0, 1, 0) + IF(le.ssn1_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.ssn1_WORDS_ErrorCount > 0, 1, 0) + IF(le.ssn2_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.ssn2_WORDS_ErrorCount > 0, 1, 0) + IF(le.dob1_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.dob1_WORDS_ErrorCount > 0, 1, 0) + IF(le.dob2_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.dob2_WORDS_ErrorCount > 0, 1, 0) + IF(le.current_lname1_ALLOW_ErrorCount > 0, 1, 0) + IF(le.current_lname1_WORDS_ErrorCount > 0, 1, 0) + IF(le.current_lname2_ALLOW_ErrorCount > 0, 1, 0) + IF(le.current_lname2_WORDS_ErrorCount > 0, 1, 0) + IF(le.early_lname1_WORDS_ErrorCount > 0, 1, 0) + IF(le.early_lname2_WORDS_ErrorCount > 0, 1, 0) + IF(le.addr_ind1_WORDS_ErrorCount > 0, 1, 0) + IF(le.addr_ind2_WORDS_ErrorCount > 0, 1, 0) + IF(le.r2rdid_WORDS_ErrorCount > 0, 1, 0) + IF(le.r2cnt_WORDS_ErrorCount > 0, 1, 0) + IF(le.personal_ALLOW_ErrorCount > 0, 1, 0) + IF(le.personal_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.personal_WORDS_ErrorCount > 0, 1, 0) + IF(le.business_ALLOW_ErrorCount > 0, 1, 0) + IF(le.business_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.business_WORDS_ErrorCount > 0, 1, 0) + IF(le.other_ALLOW_ErrorCount > 0, 1, 0) + IF(le.other_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.other_WORDS_ErrorCount > 0, 1, 0) + IF(le.title_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.title_WORDS_ErrorCount > 0, 1, 0);
    SELF.Rules_NoErrors := NumRules - SELF.Rules_WithErrors;
    SELF.Rules_WithEdits := IF(le.confidence_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.did1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.did2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cohabit_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cohabit_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cohabit_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coapt_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coapt_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coapt_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coapt_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.copobox_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.copobox_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.copobox_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.copobox_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cossn_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cossn_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cossn_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cossn_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.copolicy_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.copolicy_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.copolicy_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.copolicy_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coclaim_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coclaim_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coclaim_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coclaim_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coproperty_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coproperty_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coproperty_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coproperty_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcoproperty_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcoproperty_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcoproperty_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcoproperty_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.colien_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.colien_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.colien_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.colien_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cobankruptcy_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cobankruptcy_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cobankruptcy_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cobankruptcy_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcobankruptcy_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcobankruptcy_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcobankruptcy_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcobankruptcy_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.covehicle_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.covehicle_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.covehicle_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.covehicle_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coexperian_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coexperian_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coexperian_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coexperian_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cotransunion_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cotransunion_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cotransunion_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cotransunion_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coecrash_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coecrash_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coecrash_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coecrash_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcoecrash_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcoecrash_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.bcoecrash_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.bcoecrash_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coucc_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coucc_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.coucc_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.coucc_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.lname_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.lname_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.phone_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.phone_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.dl_nbr_score_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.dl_nbr_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.total_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.total_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.total_score_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.total_score_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.cluster_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.cluster_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.cluster_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.generation_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.generation_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.generation_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.gender_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.gender_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.gender_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.lname_cnt_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.lname_cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.rel_dt_first_seen_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.rel_dt_first_seen_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.rel_dt_last_seen_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.rel_dt_last_seen_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.overlap_months_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.hdr_dt_first_seen_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.hdr_dt_first_seen_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.hdr_dt_last_seen_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.hdr_dt_last_seen_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.age_first_seen_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.age_first_seen_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.isanylnamematch_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.isanylnamematch_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.isanylnamematch_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.isanyphonematch_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.isanyphonematch_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.isanyphonematch_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.isearlylnamematch_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.isearlylnamematch_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.isearlylnamematch_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.iscurrlnamematch_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.iscurrlnamematch_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.iscurrlnamematch_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.ismixedlnamematch_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.ismixedlnamematch_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.ismixedlnamematch_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.ssn1_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.ssn1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.ssn2_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.ssn2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.dob1_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.dob1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.dob2_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.dob2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.current_lname1_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.current_lname1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.current_lname2_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.current_lname2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.early_lname1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.early_lname2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.addr_ind1_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.addr_ind2_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.r2rdid_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.r2cnt_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.personal_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.personal_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.personal_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.business_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.business_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.business_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.other_ALLOW_WouldModifyCount > 0, 1, 0) + IF(le.other_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.other_WORDS_WouldModifyCount > 0, 1, 0) + IF(le.title_LENGTHS_WouldModifyCount > 0, 1, 0) + IF(le.title_WORDS_WouldModifyCount > 0, 1, 0);
    SELF := le;
  END;
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.lname_cnt_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.rel_dt_first_seen_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.rel_dt_last_seen_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.overlap_months_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.hdr_dt_first_seen_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.hdr_dt_last_seen_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.age_first_seen_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.ssn1_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.ssn2_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.dob1_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.dob2_Invalid,'LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.current_lname1_Invalid,'ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.current_lname2_Invalid,'ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.early_lname1_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.early_lname2_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.addr_ind1_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.addr_ind2_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.r2rdid_Invalid,'WORDS','UNKNOWN')
          ,CHOOSE(le.r2cnt_Invalid,'WORDS','UNKNOWN')
  ...
  // field error stats
    SALT39.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'did1:did1:WORDS'
          ,'did2:did2:WORDS'
          ,'cohabit_score:cohabit_score:WORDS'
          ,'cohabit_cnt:cohabit_cnt:LENGTHS','cohabit_cnt:cohabit_cnt:WORDS'
          ,'coapt_score:coapt_score:LENGTHS','coapt_score:coapt_score:WORDS'
          ,'coapt_cnt:coapt_cnt:LENGTHS','coapt_cnt:coapt_cnt:WORDS'
          ,'copobox_score:copobox_score:LENGTHS','copobox_score:copobox_score:WORDS'
          ,'copobox_cnt:copobox_cnt:LENGTHS','copobox_cnt:copobox_cnt:WORDS'
          ,'cossn_score:cossn_score:LENGTHS','cossn_score:cossn_score:WORDS'
          ,'cossn_cnt:cossn_cnt:LENGTHS','cossn_cnt:cossn_cnt:WORDS'
          ,'copolicy_score:copolicy_score:LENGTHS','copolicy_score:copolicy_score:WORDS'
          ,'copolicy_cnt:copolicy_cnt:LENGTHS','copolicy_cnt:copolicy_cnt:WORDS'
          ,'coclaim_score:coclaim_score:LENGTHS','coclaim_score:coclaim_score:WORDS'
          ,'coclaim_cnt:coclaim_cnt:LENGTHS','coclaim_cnt:coclaim_cnt:WORDS'
          ,'coproperty_score:coproperty_score:LENGTHS','coproperty_score:coproperty_score:WORDS'
          ,'coproperty_cnt:coproperty_cnt:LENGTHS','coproperty_cnt:coproperty_cnt:WORDS'
          ,'bcoproperty_score:bcoproperty_score:LENGTHS','bcoproperty_score:bcoproperty_score:WORDS'
          ,'bcoproperty_cnt:bcoproperty_cnt:LENGTHS','bcoproperty_cnt:bcoproperty_cnt:WORDS'
          ,'colien_score:colien_score:LENGTHS','colien_score:colien_score:WORDS'
          ,'colien_cnt:colien_cnt:LENGTHS','colien_cnt:colien_cnt:WORDS'
          ,'cobankruptcy_score:cobankruptcy_score:LENGTHS','cobankruptcy_score:cobankruptcy_score:WORDS'
          ,'cobankruptcy_cnt:cobankruptcy_cnt:LENGTHS','cobankruptcy_cnt:cobankruptcy_cnt:WORDS'
          ,'bcobankruptcy_score:bcobankruptcy_score:LENGTHS','bcobankruptcy_score:bcobankruptcy_score:WORDS'
          ,'bcobankruptcy_cnt:bcobankruptcy_cnt:LENGTHS','bcobankruptcy_cnt:bcobankruptcy_cnt:WORDS'
          ,'covehicle_score:covehicle_score:LENGTHS','covehicle_score:covehicle_score:WORDS'
          ,'covehicle_cnt:covehicle_cnt:LENGTHS','covehicle_cnt:covehicle_cnt:WORDS'
          ,'coexperian_score:coexperian_score:LENGTHS','coexperian_score:coexperian_score:WORDS'
          ,'coexperian_cnt:coexperian_cnt:LENGTHS','coexperian_cnt:coexperian_cnt:WORDS'
          ,'cotransunion_score:cotransunion_score:LENGTHS','cotransunion_score:cotransunion_score:WORDS'
          ,'cotransunion_cnt:cotransunion_cnt:LENGTHS','cotransunion_cnt:cotransunion_cnt:WORDS'
          ,'coecrash_score:coecrash_score:LENGTHS','coecrash_score:coecrash_score:WORDS'
          ,'coecrash_cnt:coecrash_cnt:LENGTHS','coecrash_cnt:coecrash_cnt:WORDS'
          ,'bcoecrash_score:bcoecrash_score:LENGTHS','bcoecrash_score:bcoecrash_score:WORDS'
          ,'bcoecrash_cnt:bcoecrash_cnt:LENGTHS','bcoecrash_cnt:bcoecrash_cnt:WORDS'
          ,'coucc_score:coucc_score:LENGTHS','coucc_score:coucc_score:WORDS'
          ,'coucc_cnt:coucc_cnt:LENGTHS','coucc_cnt:coucc_cnt:WORDS'
          ,'lname_score:lname_score:LENGTHS','lname_score:lname_score:WORDS'
          ,'phone_score:phone_score:LENGTHS','phone_score:phone_score:WORDS'
          ,'dl_nbr_score:dl_nbr_score:ALLOW','dl_nbr_score:dl_nbr_score:WORDS'
          ,'total_cnt:total_cnt:LENGTHS','total_cnt:total_cnt:WORDS'
          ,'total_score:total_score:LENGTHS','total_score:total_score:WORDS'
          ...
          ,'lname_cnt:lname_cnt:LENGTHS','lname_cnt:lname_cnt:WORDS'
          ,'rel_dt_first_seen:rel_dt_first_seen:LENGTHS','rel_dt_first_seen:rel_dt_first_seen:WORDS'
          ,'rel_dt_last_seen:rel_dt_last_seen:LENGTHS','rel_dt_last_seen:rel_dt_last_seen:WORDS'
          ,'overlap_months:overlap_months:WORDS'
          ,'hdr_dt_first_seen:hdr_dt_first_seen:LENGTHS','hdr_dt_first_seen:hdr_dt_first_seen:WORDS'
          ,'hdr_dt_last_seen:hdr_dt_last_seen:LENGTHS','hdr_dt_last_seen:hdr_dt_last_seen:WORDS'
          ,'age_first_seen:age_first_seen:LENGTHS','age_first_seen:age_first_seen:WORDS'
          ...
          ,'ssn1:ssn1:LENGTHS','ssn1:ssn1:WORDS'
          ,'ssn2:ssn2:LENGTHS','ssn2:ssn2:WORDS'
          ,'dob1:dob1:LENGTHS','dob1:dob1:WORDS'
          ,'dob2:dob2:LENGTHS','dob2:dob2:WORDS'
          ...
          ,'early_lname1:early_lname1:WORDS'
          ,'early_lname2:early_lname2:WORDS'
          ,'addr_ind1:addr_ind1:WORDS'
          ,'addr_ind2:addr_ind2:WORDS'
          ,'r2rdid:r2rdid:WORDS'
          ,'r2cnt:r2cnt:WORDS'
          ...
          ,'title:title:LENGTHS','title:title:WORDS'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Fields.InvalidMessage_confidence(1)
          ,Fields.InvalidMessage_did1(1)
          ,Fields.InvalidMessage_did2(1)
          ,Fields.InvalidMessage_cohabit_score(1)
          ,Fields.InvalidMessage_cohabit_cnt(1),Fields.InvalidMessage_cohabit_cnt(2)
          ,Fields.InvalidMessage_coapt_score(1),Fields.InvalidMessage_coapt_score(2)
          ,Fields.InvalidMessage_coapt_cnt(1),Fields.InvalidMessage_coapt_cnt(2)
          ,Fields.InvalidMessage_copobox_score(1),Fields.InvalidMessage_copobox_score(2)
          ,Fields.InvalidMessage_copobox_cnt(1),Fields.InvalidMessage_copobox_cnt(2)
          ,Fields.InvalidMessage_cossn_score(1),Fields.InvalidMessage_cossn_score(2)
          ,Fields.InvalidMessage_cossn_cnt(1),Fields.InvalidMessage_cossn_cnt(2)
          ,Fields.InvalidMessage_copolicy_score(1),Fields.InvalidMessage_copolicy_score(2)
          ,Fields.InvalidMessage_copolicy_cnt(1),Fields.InvalidMessage_copolicy_cnt(2)
          ,Fields.InvalidMessage_coclaim_score(1),Fields.InvalidMessage_coclaim_score(2)
          ,Fields.InvalidMessage_coclaim_cnt(1),Fields.InvalidMessage_coclaim_cnt(2)
          ,Fields.InvalidMessage_coproperty_score(1),Fields.InvalidMessage_coproperty_score(2)
          ,Fields.InvalidMessage_coproperty_cnt(1),Fields.InvalidMessage_coproperty_cnt(2)
          ,Fields.InvalidMessage_bcoproperty_score(1),Fields.InvalidMessage_bcoproperty_score(2)
          ,Fields.InvalidMessage_bcoproperty_cnt(1),Fields.InvalidMessage_bcoproperty_cnt(2)
          ,Fields.InvalidMessage_colien_score(1),Fields.InvalidMessage_colien_score(2)
          ,Fields.InvalidMessage_colien_cnt(1),Fields.InvalidMessage_colien_cnt(2)
          ,Fields.InvalidMessage_cobankruptcy_score(1),Fields.InvalidMessage_cobankruptcy_score(2)
          ,Fields.InvalidMessage_cobankruptcy_cnt(1),Fields.InvalidMessage_cobankruptcy_cnt(2)
          ,Fields.InvalidMessage_bcobankruptcy_score(1),Fields.InvalidMessage_bcobankruptcy_score(2)
          ,Fields.InvalidMessage_bcobankruptcy_cnt(1),Fields.InvalidMessage_bcobankruptcy_cnt(2)
          ,Fields.InvalidMessage_covehicle_score(1),Fields.InvalidMessage_covehicle_score(2)
          ,Fields.InvalidMessage_covehicle_cnt(1),Fields.InvalidMessage_covehicle_cnt(2)
          ,Fields.InvalidMessage_coexperian_score(1),Fields.InvalidMessage_coexperian_score(2)
          ,Fields.InvalidMessage_coexperian_cnt(1),Fields.InvalidMessage_coexperian_cnt(2)
          ,Fields.InvalidMessage_cotransunion_score(1),Fields.InvalidMessage_cotransunion_score(2)
          ,Fields.InvalidMessage_cotransunion_cnt(1),Fields.InvalidMessage_cotransunion_cnt(2)
          ,Fields.InvalidMessage_coecrash_score(1),Fields.InvalidMessage_coecrash_score(2)
          ,Fields.InvalidMessage_coecrash_cnt(1),Fields.InvalidMessage_coecrash_cnt(2)
          ,Fields.InvalidMessage_bcoecrash_score(1),Fields.InvalidMessage_bcoecrash_score(2)
          ,Fields.InvalidMessage_bcoecrash_cnt(1),Fields.InvalidMessage_bcoecrash_cnt(2)
          ,Fields.InvalidMessage_coucc_score(1),Fields.InvalidMessage_coucc_score(2)
          ,Fields.InvalidMessage_coucc_cnt(1),Fields.InvalidMessage_coucc_cnt(2)
          ,Fields.InvalidMessage_lname_score(1),Fields.InvalidMessage_lname_score(2)
          ,Fields.InvalidMessage_phone_score(1),Fields.InvalidMessage_phone_score(2)
          ,Fields.InvalidMessage_dl_nbr_score(1),Fields.InvalidMessage_dl_nbr_score(2)
          ,Fields.InvalidMessage_total_cnt(1),Fields.InvalidMessage_total_cnt(2)
          ,Fields.InvalidMessage_total_score(1),Fields.InvalidMessage_total_score(2)
          ...
          ,Fields.InvalidMessage_lname_cnt(1),Fields.InvalidMessage_lname_cnt(2)
          ,Fields.InvalidMessage_rel_dt_first_seen(1),Fields.InvalidMessage_rel_dt_first_seen(2)
          ,Fields.InvalidMessage_rel_dt_last_seen(1),Fields.InvalidMessage_rel_dt_last_seen(2)
          ,Fields.InvalidMessage_overlap_months(1)
          ,Fields.InvalidMessage_hdr_dt_first_seen(1),Fields.InvalidMessage_hdr_dt_first_seen(2)
          ,Fields.InvalidMessage_hdr_dt_last_seen(1),Fields.InvalidMessage_hdr_dt_last_seen(2)
          ,Fields.InvalidMessage_age_first_seen(1),Fields.InvalidMessage_age_first_seen(2)
          ...
          ,Fields.InvalidMessage_ssn1(1),Fields.InvalidMessage_ssn1(2)
          ,Fields.InvalidMessage_ssn2(1),Fields.InvalidMessage_ssn2(2)
          ,Fields.InvalidMessage_dob1(1),Fields.InvalidMessage_dob1(2)
          ,Fields.InvalidMessage_dob2(1),Fields.InvalidMessage_dob2(2)
          ...
          ,Fields.InvalidMessage_early_lname1(1)
          ,Fields.InvalidMessage_early_lname2(1)
          ,Fields.InvalidMessage_addr_ind1(1)
          ,Fields.InvalidMessage_addr_ind2(1)
          ,Fields.InvalidMessage_r2rdid(1)
          ,Fields.InvalidMessage_r2cnt(1)
      ...
      SELF.rulecnt := CHOOSE(c
          ,le.confidence_WORDS_ErrorCount
          ,le.did1_WORDS_ErrorCount
          ,le.did2_WORDS_ErrorCount
          ,le.cohabit_score_WORDS_ErrorCount
          ,le.cohabit_cnt_LENGTHS_ErrorCount,le.cohabit_cnt_WORDS_ErrorCount
          ,le.coapt_score_LENGTHS_ErrorCount,le.coapt_score_WORDS_ErrorCount
          ,le.coapt_cnt_LENGTHS_ErrorCount,le.coapt_cnt_WORDS_ErrorCount
          ,le.copobox_score_LENGTHS_ErrorCount,le.copobox_score_WORDS_ErrorCount
          ,le.copobox_cnt_LENGTHS_ErrorCount,le.copobox_cnt_WORDS_ErrorCount
          ,le.cossn_score_LENGTHS_ErrorCount,le.cossn_score_WORDS_ErrorCount
          ,le.cossn_cnt_LENGTHS_ErrorCount,le.cossn_cnt_WORDS_ErrorCount
          ,le.copolicy_score_LENGTHS_ErrorCount,le.copolicy_score_WORDS_ErrorCount
          ,le.copolicy_cnt_LENGTHS_ErrorCount,le.copolicy_cnt_WORDS_ErrorCount
          ,le.coclaim_score_LENGTHS_ErrorCount,le.coclaim_score_WORDS_ErrorCount
          ,le.coclaim_cnt_LENGTHS_ErrorCount,le.coclaim_cnt_WORDS_ErrorCount
          ,le.coproperty_score_LENGTHS_ErrorCount,le.coproperty_score_WORDS_ErrorCount
          ,le.coproperty_cnt_LENGTHS_ErrorCount,le.coproperty_cnt_WORDS_ErrorCount
          ,le.bcoproperty_score_LENGTHS_ErrorCount,le.bcoproperty_score_WORDS_ErrorCount
          ,le.bcoproperty_cnt_LENGTHS_ErrorCount,le.bcoproperty_cnt_WORDS_ErrorCount
          ,le.colien_score_LENGTHS_ErrorCount,le.colien_score_WORDS_ErrorCount
          ,le.colien_cnt_LENGTHS_ErrorCount,le.colien_cnt_WORDS_ErrorCount
          ,le.cobankruptcy_score_LENGTHS_ErrorCount,le.cobankruptcy_score_WORDS_ErrorCount
          ,le.cobankruptcy_cnt_LENGTHS_ErrorCount,le.cobankruptcy_cnt_WORDS_ErrorCount
          ,le.bcobankruptcy_score_LENGTHS_ErrorCount,le.bcobankruptcy_score_WORDS_ErrorCount
          ,le.bcobankruptcy_cnt_LENGTHS_ErrorCount,le.bcobankruptcy_cnt_WORDS_ErrorCount
          ,le.covehicle_score_LENGTHS_ErrorCount,le.covehicle_score_WORDS_ErrorCount
          ,le.covehicle_cnt_LENGTHS_ErrorCount,le.covehicle_cnt_WORDS_ErrorCount
          ,le.coexperian_score_LENGTHS_ErrorCount,le.coexperian_score_WORDS_ErrorCount
          ,le.coexperian_cnt_LENGTHS_ErrorCount,le.coexperian_cnt_WORDS_ErrorCount
          ,le.cotransunion_score_LENGTHS_ErrorCount,le.cotransunion_score_WORDS_ErrorCount
          ,le.cotransunion_cnt_LENGTHS_ErrorCount,le.cotransunion_cnt_WORDS_ErrorCount
          ,le.coecrash_score_LENGTHS_ErrorCount,le.coecrash_score_WORDS_ErrorCount
          ,le.coecrash_cnt_LENGTHS_ErrorCount,le.coecrash_cnt_WORDS_ErrorCount
          ,le.bcoecrash_score_LENGTHS_ErrorCount,le.bcoecrash_score_WORDS_ErrorCount
          ,le.bcoecrash_cnt_LENGTHS_ErrorCount,le.bcoecrash_cnt_WORDS_ErrorCount
          ,le.coucc_score_LENGTHS_ErrorCount,le.coucc_score_WORDS_ErrorCount
          ,le.coucc_cnt_LENGTHS_ErrorCount,le.coucc_cnt_WORDS_ErrorCount
          ,le.lname_score_LENGTHS_ErrorCount,le.lname_score_WORDS_ErrorCount
          ,le.phone_score_LENGTHS_ErrorCount,le.phone_score_WORDS_ErrorCount
          ,le.dl_nbr_score_ALLOW_ErrorCount,le.dl_nbr_score_WORDS_ErrorCount
          ,le.total_cnt_LENGTHS_ErrorCount,le.total_cnt_WORDS_ErrorCount
          ,le.total_score_LENGTHS_ErrorCount,le.total_score_WORDS_ErrorCount
          ...
          ,le.lname_cnt_LENGTHS_ErrorCount,le.lname_cnt_WORDS_ErrorCount
          ,le.rel_dt_first_seen_LENGTHS_ErrorCount,le.rel_dt_first_seen_WORDS_ErrorCount
          ,le.rel_dt_last_seen_LENGTHS_ErrorCount,le.rel_dt_last_seen_WORDS_ErrorCount
          ,le.overlap_months_WORDS_ErrorCount
          ,le.hdr_dt_first_seen_LENGTHS_ErrorCount,le.hdr_dt_first_seen_WORDS_ErrorCount
          ,le.hdr_dt_last_seen_LENGTHS_ErrorCount,le.hdr_dt_last_seen_WORDS_ErrorCount
          ,le.age_first_seen_LENGTHS_ErrorCount,le.age_first_seen_WORDS_ErrorCount
          ...
          ,le.ssn1_LENGTHS_ErrorCount,le.ssn1_WORDS_ErrorCount
          ,le.ssn2_LENGTHS_ErrorCount,le.ssn2_WORDS_ErrorCount
          ,le.dob1_LENGTHS_ErrorCount,le.dob1_WORDS_ErrorCount
          ,le.dob2_LENGTHS_ErrorCount,le.dob2_WORDS_ErrorCount
          ...
          ,le.early_lname1_WORDS_ErrorCount
          ,le.early_lname2_WORDS_ErrorCount
          ,le.addr_ind1_WORDS_ErrorCount
          ,le.addr_ind2_WORDS_ErrorCount
          ,le.r2rdid_WORDS_ErrorCount
          ,le.r2cnt_WORDS_ErrorCount
          ...
          ,le.title_LENGTHS_ErrorCount,le.title_WORDS_ErrorCount
      ...
      SELF.rulepcnt := IF(c <= NumRules, 100 * CHOOSE(c
          ...
          ,le.business_ALLOW_ErrorCount,le.business_LENGTHS_ErrorCount,le.business_WORDS_ErrorCount
          ,le.other_ALLOW_ErrorCount,le.other_LENGTHS_ErrorCount,le.other_WORDS_ErrorCount
          ,le.title_LENGTHS_ErrorCount,le.title_WORDS_ErrorCount,0) / le.TotalCnt + 0.5, CHOOSE(c - NumRules
