...
MODULE:Scrubs_Corp2_Build_AR_Base
FILENAME:Scrubs_Corp2_Build_AR_Base.in_file
...
FIELD:ar_mailed_dt:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:ar_due_dt:TYPE(STRING8):LIKE(invalid_date):0,0
...
FIELD:ar_franchise_tax_paid_dt:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:ar_delinquent_dt:TYPE(STRING8):LIKE(invalid_date):0,0
