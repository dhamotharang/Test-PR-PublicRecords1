...
#workunit('name','scrubs_Fed_Bureau_Prisons.raw_BWR_Hygiene - Hygiene & Stats - SALT V3.11.3');
IMPORT scrubs_Fed_Bureau_Prisons,SALT311;
// First create an instantiated hygiene module
  infile := scrubs_Fed_Bureau_Prisons.raw_In_Fed_Bureau_Prisons;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := scrubs_Fed_Bureau_Prisons.raw_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'raw_Layout_Fed_Bureau_Prisons'),NAMED('OptimizedLayout'));// File layout suggested by data
