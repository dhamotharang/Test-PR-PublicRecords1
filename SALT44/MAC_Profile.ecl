 ...
 * 
 * Examples:
 *   SALT44.MAC_Profile(my_dataset);
 *   SALT44.MAC_Profile(my_dataset,pid,source);
 *   SALT44.MAC_Profile(my_dataset,maxFieldCorr:=75);
 */
EXPORT MAC_Profile(inFile,id_field='',src_field='',CorrelateSampleSize=100000000,out_prefix='',maxFieldCorr=50) := MACRO
  SALT44.MOD_Profile(inFile,id_field,src_field,CorrelateSampleSize,out_prefix,maxFieldCorr).out;
ENDMACRO;
