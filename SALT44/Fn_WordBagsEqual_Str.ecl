...
namespace ns_SALT44_Fn_WordBagsEqual_Str {
class wb
{
...
using namespace ns_SALT44_Fn_WordBagsEqual_Str;
#body
#option pure
{	
    ns_SALT44_Fn_WordBagsEqual_Str::wb wbLeft(lenL,l);
    ns_SALT44_Fn_WordBagsEqual_Str::wb wbRight(lenR,r);
