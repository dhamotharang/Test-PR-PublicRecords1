EXPORT mod_Delta := MODULE
	...
	// usage example:  SALT44.mod_Delta.mac_DifferencesByFieldList(old_s, new_s, ['FNAME','MNAME','LNAME']);
	...
	// usage example:  SALT44.mod_Delta.mac_DifferencesByRIDField(old_s, new_s, ['FNAME','MNAME','LNAME'], RID);
	// Note that setting the final parameter to TRUE will generate ECL as a text string for inspection/debug purposes
	...
	// usage example:  SALT44.mod_Delta.mac_DifferencesByRIDFieldChangeStats(diffChanged, ['FNAME','MNAME','LNAME'], src)
	// Note that setting the final parameter to TRUE will generate ECL as a text string for inspection/debug purposes
	...
	// usage example:  SALT44.mod_Delta.mac_DifferencesBySOURCERIDFieldChangeStats(diffChanged, ['FNAME','MNAME','LNAME'], src, srcRID)
	// Note that setting the final parameter to TRUE will generate ECL as a text string for inspection/debug purposes
