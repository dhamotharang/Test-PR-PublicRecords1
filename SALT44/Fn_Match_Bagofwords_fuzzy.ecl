...
namespace ns_SALT44_Fn_Match_Bagofwords_Fuzzy {
...
using namespace ns_SALT44_Fn_Match_Bagofwords_Fuzzy;
#body
#option pure
{
    ...
    ns_SALT44_Fn_Match_Bagofwords_Fuzzy::wb L(lenL,l,stem);
    ns_SALT44_Fn_Match_Bagofwords_Fuzzy::wb R(lenR,r,stem);
    if ( L.error || R.error )
    ...
    // Short & Long
    ns_SALT44_Fn_Match_Bagofwords_Fuzzy::wb &SH = L.nwords < R.nwords || lenL < lenR ? L : R;
    ns_SALT44_Fn_Match_Bagofwords_Fuzzy::wb &LO = L.nwords < R.nwords || lenL < lenR ? R : L;
