...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_Y_N','invalid_numeric','invalid_dollar_amt','invalid_alphaspec_chars');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_Y_N' => 8,'invalid_numeric' => 9,'invalid_dollar_amt' => 10,'invalid_alphaspec_chars' => 11,0);
...
EXPORT MakeFT_invalid_dollar_amt(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'-.0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_dollar_amt(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'-.0123456789'))));
EXPORT InValidMessageFT_invalid_dollar_amt(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('-.0123456789'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaspec_chars(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' ()-/:ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaspec_chars(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' ()-/:ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphaspec_chars(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' ()-/:ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT32.HygieneErrors.Good);
...
EXPORT Make_ar_year(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ar_year(SALT32.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_ar_filed_dt(SALT32.StrType s0) := s0;
EXPORT InValid_ar_filed_dt(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_ar_filed_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_dt(SALT32.StrType s0) := s0;
EXPORT InValid_ar_report_dt(SALT32.StrType s) := FALSE;
...
EXPORT Make_ar_tax_amount_paid(SALT32.StrType s0) := MakeFT_invalid_dollar_amt(s0);
EXPORT InValid_ar_tax_amount_paid(SALT32.StrType s) := InValidFT_invalid_dollar_amt(s);
EXPORT InValidMessage_ar_tax_amount_paid(UNSIGNED1 wh) := InValidMessageFT_invalid_dollar_amt(wh);
...
EXPORT Make_ar_comment(SALT32.StrType s0) := MakeFT_invalid_alphaspec_chars(s0);
EXPORT InValid_ar_comment(SALT32.StrType s) := InValidFT_invalid_alphaspec_chars(s);
EXPORT InValidMessage_ar_comment(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaspec_chars(wh);
...
EXPORT Make_ar_exempt(SALT32.StrType s0) := MakeFT_invalid_Y_N(s0);
EXPORT InValid_ar_exempt(SALT32.StrType s) := InValidFT_invalid_Y_N(s);
EXPORT InValidMessage_ar_exempt(UNSIGNED1 wh) := InValidMessageFT_invalid_Y_N(wh);
 
EXPORT Make_ar_license_tax_amount(SALT32.StrType s0) := MakeFT_invalid_dollar_amt(s0);
EXPORT InValid_ar_license_tax_amount(SALT32.StrType s) := InValidFT_invalid_dollar_amt(s);
EXPORT InValidMessage_ar_license_tax_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_dollar_amt(wh);
 
EXPORT Make_ar_status(SALT32.StrType s0) := MakeFT_invalid_alphaspec_chars(s0);
EXPORT InValid_ar_status(SALT32.StrType s) := InValidFT_invalid_alphaspec_chars(s);
EXPORT InValidMessage_ar_status(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaspec_chars(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_WY_AR;
