...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{36,'ar_year_and_month_due'}],SALT32.MAC_Character_Counts.Field_Identification);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_corp_key','invalid_corp_vendor','Unknown','Unknown','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_numeric','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_dollar_amt','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_alphaspec_chars','Unknown','invalid_Y_N','invalid_dollar_amt','invalid_alphaspec_chars','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
