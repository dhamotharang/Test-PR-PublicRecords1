...
Command line options: -MScrubs_Corp2_Mapping_WY_AR -eC:\Users\butlersx\AppData\Local\Temp\TFRDCC9.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_WY_AR
FILENAME:In_WY
...
FIELDTYPE:invalid_dollar_amt:ALLOW(-.0123456789)
FIELDTYPE:invalid_alphaspec_chars:ALLOW( ()-/:ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:ar_tax_amount_paid:TYPE(STRING10):LIKE(invalid_dollar_amt):0,0
...
FIELD:ar_comment:TYPE(STRING350):LIKE(invalid_alphaspec_chars):0,0
FIELD:ar_type:TYPE(STRING60):0,0
FIELD:ar_exempt:TYPE(STRING1):LIKE(invalid_Y_N):0,0
FIELD:ar_license_tax_amount:TYPE(STRING20):LIKE(invalid_dollar_amt):0,0
FIELD:ar_status:TYPE(STRING50):LIKE(invalid_alphaspec_chars):0,0
