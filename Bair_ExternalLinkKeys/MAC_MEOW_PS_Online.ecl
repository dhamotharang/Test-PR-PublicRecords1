...
#uniquename(res_out)
SALT33.MAC_Soapcall(%pr%,Bair_ExternalLinkKeys.Process_PS_Layouts.OutputLayout, Bair_ExternalLinkKeys.MEOW_roxieIP, ServiceModule+'MEOW_PS_Service', %res_out%);
OutFile := %res_out%;
  #IF (#TEXT(Stats)<>'')
