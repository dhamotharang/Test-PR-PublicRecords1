...
SHARED FldIds := DATASET([{1,'NAME_SUFFIX'}
      ...
      ,{27,'LONGITUDE'}
      ,{28,'SEARCH_ADDR1'}
      ,{29,'SEARCH_ADDR2'}],SALT33.MAC_Character_Counts.Field_Identification);
