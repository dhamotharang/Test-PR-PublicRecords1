...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.SEARCH_ADDR2_Invalid,'LEFTTRIM','QUOTES','UNKNOWN'),'UNKNOWN'));
    SELF.FieldName := CHOOSE(c,'NAME_SUFFIX','FNAME','MNAME','LNAME','PRIM_RANGE','PRIM_NAME','SEC_RANGE','P_CITY_NAME','ST','ZIP','DOB','PHONE','DL_ST','DL','LEXID','POSSIBLE_SSN','CRIME','NAME_TYPE','CLEAN_GENDER','CLASS_CODE','DT_FIRST_SEEN','DT_LAST_SEEN','DATA_PROVIDER_ORI','VIN','PLATE','LATITUDE','LONGITUDE','SEARCH_ADDR1','SEARCH_ADDR2','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','NUMBER','DEFAULT','NUMBER','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','UNKNOWN');
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'SEARCH_ADDR2:DEFAULT:LEFTTRIM','SEARCH_ADDR2:DEFAULT:QUOTES','UNKNOWN');
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_SEARCH_ADDR2(1),Fields.InvalidMessage_SEARCH_ADDR2(2),'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.SEARCH_ADDR2_LEFTTRIM_ErrorCount,le.SEARCH_ADDR2_QUOTES_ErrorCount,0);
      SELF.rulepcnt := 100 * CHOOSE(c
          ...
          ,le.LONGITUDE_LEFTTRIM_ErrorCount,le.LONGITUDE_QUOTES_ErrorCount
          ,le.SEARCH_ADDR1_LEFTTRIM_ErrorCount,le.SEARCH_ADDR1_QUOTES_ErrorCount
          ,le.SEARCH_ADDR2_LEFTTRIM_ErrorCount,le.SEARCH_ADDR2_QUOTES_ErrorCount,0) / le.TotalCnt + 0.5;
    END;
    SummaryInfo := NORMALIZE(SummaryStats,56,Into(LEFT,COUNTER));
    orb_r := RECORD
      AllErrors.Src;
