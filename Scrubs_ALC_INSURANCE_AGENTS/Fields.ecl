...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_addr_type','invalid_alpha','invalid_alphanumeric','invalid_alphaspace','invalid_alphaspacequote','invalid_gender','invalid_numeric','invalid_numericpound');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_addr_type' => 1,'invalid_alpha' => 2,'invalid_alphanumeric' => 3,'invalid_alphaspace' => 4,'invalid_alphaspacequote' => 5,'invalid_gender' => 6,'invalid_numeric' => 7,'invalid_numericpound' => 8,0);
...
EXPORT SALT32.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'fname','lname','title','company','address1','address2','city','state','zip','zip4','cart','bar','gender','country','postal_cd','dpv','addr_type','county_cd','insurance_type','license_type','msa','nielsen_county_cd','list_id','scno','keycode','custno');
EXPORT FieldNum(SALT32.StrType fn) := CASE(fn,'fname' => 0,'lname' => 1,'title' => 2,'company' => 3,'address1' => 4,'address2' => 5,'city' => 6,'state' => 7,'zip' => 8,'zip4' => 9,'cart' => 10,'bar' => 11,'gender' => 12,'country' => 13,'postal_cd' => 14,'dpv' => 15,'addr_type' => 16,'county_cd' => 17,'insurance_type' => 18,'license_type' => 19,'msa' => 20,'nielsen_county_cd' => 21,'list_id' => 22,'scno' => 23,'keycode' => 24,'custno' => 25,0);
...
EXPORT Make_insurance_type(SALT32.StrType s0) := MakeFT_invalid_numericpound(s0);
EXPORT InValid_insurance_type(SALT32.StrType s) := InValidFT_invalid_numericpound(s);
EXPORT InValidMessage_insurance_type(UNSIGNED1 wh) := InValidMessageFT_invalid_numericpound(wh);
 
EXPORT Make_license_type(SALT32.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_license_type(SALT32.StrType s) := InValidFT_invalid_numeric(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_ALC_INSURANCE_AGENTS;
