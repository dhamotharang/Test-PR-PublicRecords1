...
Command line options: -MScrubs_ALC_INSURANCE_AGENTS -eC:\Users\metzmaaj\AppData\Local\Temp\TFRB67C.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_ALC_INSURANCE_AGENTS
FILENAME:ALC_INSURANCE_AGENTS
...
FIELD:insurance_type:TYPE(STRING50):LIKE(invalid_numericpound):0,0
FIELD:license_type:TYPE(STRING4):LIKE(invalid_numeric):0,0
