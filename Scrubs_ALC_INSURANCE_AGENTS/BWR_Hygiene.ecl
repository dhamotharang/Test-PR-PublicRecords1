...
#workunit('name','Scrubs_ALC_INSURANCE_AGENTS.BWR_Hygiene - Hygiene & Stats - SALT V3.2.1');
IMPORT Scrubs_ALC_INSURANCE_AGENTS,SALT32;
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT32.MAC_Character_Counts.EclRecord(p,'Layout_ALC_INSURANCE_AGENTS'),NAMED('OptimizedLayout'));// File layout suggested by data
