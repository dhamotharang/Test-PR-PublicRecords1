import patriot,GlobalWatchLists,doxie,business_header,Gateway;

doxie_cbrs.mac_Selection_Declare()

gwl_key := GlobalWatchLists.Key_GlobalWatchLists_Key;

EXPORT Patriot_records(Dataset(Gateway.Layouts.Config) gateway, unsigned1 ofac_version = 1, boolean include_ofac = false, real global_watchlist_threshold = 0.84) := 
FUNCTION
