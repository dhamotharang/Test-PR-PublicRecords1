...
export getLorJ(string2 thetype, string filingtype_desc) := 
	map(thetype in setLtypes or stringlib.StringContains(filingtype_desc, 'LIEN', true) 
				             or stringlib.StringContains(filingtype_desc, 'LOAN', true)
							 or stringlib.StringContains(filingtype_desc, 'WARRANT', true)
							 or stringlib.StringContains(filingtype_desc, 'TAX', true)=> 'L',
							 
		thetype in setJtypes or stringlib.StringContains(filingtype_desc, 'JUDGMENT', true)
						     or stringlib.StringContains(filingtype_desc, 'CIVIL', true) => 'J',
			'');
