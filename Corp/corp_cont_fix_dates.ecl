...
Layout_Corp_Cont_Base InitDates(Layout_Corp_Cont_Base l) := transform
...
corp_cont_init := project(Corp.File_Corp_Cont_Base, InitDates(left));
...
Layout_Corp_Cont_Base FixDates(Layout_Corp_Cont_Base l, layout_corp_dates r) := transform
...
Corp.Layout_Corp_Cont_Base UpdateDates(Corp.Layout_Corp_Cont_Base l, layout_event_slim r) := transform
...
export corp_cont_fix_dates := cont_update_event : persist('TEMP::corp_cont_base_fixed_dates');