...
export fCorp_As_Business_Header(dataset(Layout_Corp_Base) pInput) :=
function
	...
	//patch some addresses using ra where it looks good
	corp_base := corp.fun_PatchAddrWithRA(corp_base_unp);
