export Corp_event_fix_dates_function(dataset(Corp.Layout_Corp_Event_Temp) event_data) := FUNCTION

import ut;

Layout_Corp_Event_temp FixDates(Layout_Corp_Event_temp l) := transform
