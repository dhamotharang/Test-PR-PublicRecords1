...
Layout_Corp_Supp_Base FixDates(Layout_Corp_Supp_Base l) := transform
...
corp_supp_fix_init := project(Corp.File_Corp_Supp_Base, FixDates(left));
...
Corp.Layout_Corp_Supp_Base UpdateDates(Corp.Layout_Corp_Supp_Base l, layout_event_slim r) := transform
...
export corp_supp_fix_dates := supp_update_event : persist('TEMP::corp_supp_base_fixed_dates');
