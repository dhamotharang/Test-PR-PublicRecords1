...
export corp_fix_dates_function(dataset(Corp.Layout_Corp_Temp) corp_data) := FUNCTION

Layout_Corp_Temp FixDates(Layout_Corp_Temp l) := transform
...
Corp.Layout_Corp_Temp UpdateDates(Corp.Layout_Corp_Temp l, layout_event_slim r) := transform
