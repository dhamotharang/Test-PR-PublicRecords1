import ut, Corp, corp2,fieldstats;
...
emailx := fileservices.sendemail(corp2.Email_Notification_Lists.BuildSuccess,'CORP_FieldPop_Stats','Finished Corp Build ' + ut.getDate +  '\r\n \r\n ' +
			  'Results and stats:  http://10.150.28.12:8010/WsWorkunits/WUInfo?Wuid=' + workunit + '\r\n');

export proc_build_base := sequential(do1,do2,do3,do4,stats,emailx);
