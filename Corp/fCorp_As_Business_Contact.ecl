...
export fCorp_As_Business_Contact(dataset(Layout_Corp_Base) pCorp_Base, dataset(Layout_Corp_Cont_Base) pCont_Base) :=
function
...
cont_base := pCont_Base(cont_name not in Corp.Set_Bad_Contact_Names);
