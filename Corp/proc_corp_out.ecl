...
do1 := output(corp_out_dedup,,'OUT::Corp_' + Corp.Corp_Build_Date, overwrite);
...
do2 := output(corp_event_out_dedup,,'OUT::Corp_Event_' + Corp.Corp_Build_Date, overwrite);
...
do3 := output(corp_supp_out_dedup,,'OUT::Corp_Supp_' + Corp.Corp_Build_Date, overwrite);
//ut.MAC_SF_BuildProcess(corp_supp_out_init,'~thor_data400::out::corp_supp',do3,2);

export proc_corp_out := sequential(do1,do2,do3);
