...
ut.MAC_SK_Move_v2('~thor_Data400::key::corp_base_bdid','Q',do1, '2');
ut.MAC_SK_Move_v2('~thor_data400::key::corp_base_bdid_pl','Q',do1a, '2');
...
ut.mac_sk_move_v2('~thor_data400::key::corp_base_corpkey','Q',do5, '2');
...
export proc_accept_corp_keys_to_QA_rename := sequential(do1,do1a,do5);
