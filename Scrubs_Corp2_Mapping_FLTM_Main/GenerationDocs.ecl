...
Command line options: -MScrubs_Corp2_Mapping_FLTM_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR8268.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_FLTM_Main
FILENAME:In_FLTM
...
FIELDTYPE:invalid_corp_key:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-):LENGTHS(4..15)
FIELDTYPE:invalid_charter:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..12)
...
FIELDTYPE:invalid_corp_vendor:ENUM(12)
FIELDTYPE:invalid_state_origin:ENUM(FL)
FIELDTYPE:invalid_trademark_status:ENUM(I|A| )
...
DATEFIELD:corp_ra_dt_first_seen:TYPE(STRING8):LIKE(invalid_optional_date):0,0
DATEFIELD:corp_ra_dt_last_seen:TYPE(STRING8):LIKE(invalid_optional_date):0,0
DATEFIELD:dt_vendor_first_reported:TYPE(STRING8):LIKE(invalid_optional_date):0,0
DATEFIELD:dt_vendor_last_reported:TYPE(STRING8):LIKE(invalid_optional_date):0,0
...
FIELD:corp_trademark_status:TYPE(STRING1):LIKE(invalid_trademark_status):0,0
