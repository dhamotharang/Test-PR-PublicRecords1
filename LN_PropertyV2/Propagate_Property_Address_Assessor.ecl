import Address,AID,LN_Mortgage,LN_Property,ut ;

export Propagate_Property_Address_Assessor(	dataset(recordof(LN_PropertyV2.layout_property_common_model_base))		Asses_in0,
...
export Assess_resultWflag := LN_PropertyV2.Mac_LN_latest_Recflag.current_assessor(Assess_wpatch); 
...
export new_search_records := dCleanAddress	:	persist('~thor_data400::persist::ln_propertyv2::asses_address_propagated');
