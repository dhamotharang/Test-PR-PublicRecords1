export layout_property_common_model_base_plus := record
  ...
  string2		new_record_type_code;
	string10 	state_land_use_code;//new field
  ...
  string1		school_tax_district3_indicator;
	string20 	lot_size;//new field
	string10 	lot_size_acres;//new field
	string10 	lot_size_frontage_feet;//new field
	string10 	lot_size_depth_feet;//new field
  string30	land_acres;
  ...
  string2		no_of_partial_baths;
	string3 	no_of_plumbing_fixtures;//new field
  ...
  string3		foundation_code;
	string3 	building_quality_code;//new field
	string3 	building_condition_code;//new field
  string3		exterior_walls_code;
	string1 	interior_walls_code;//new field
  string3		roof_cover_code;
  string5		roof_type_code;
	string3 	floor_cover_code;//new field
	string3 	water_code;//new field
	string3 	sewer_code;//new field
