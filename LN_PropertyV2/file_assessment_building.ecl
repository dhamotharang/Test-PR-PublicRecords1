...
export file_assessment_building := dFixAsses(ln_fares_id not in LN_PropertyV2.Suppress_LNFaresID) : persist('~thor_data400::persist::ln_propertyv2::assessor_phone_suppression');