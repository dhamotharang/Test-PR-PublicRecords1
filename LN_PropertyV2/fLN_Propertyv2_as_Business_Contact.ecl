import Business_Header, Lib_StringLib,mdr;

export fLN_Propertyv2_as_Business_Contact(
...
function
	...
	rLayoutBusinessContactFullWithSourceCode tAsBusinessContact(layout_business_prep pInput)
	 :=
		transform
		self.vl_id            := '';
	...
	dPropertyPrepNoPartialOwnership		:= 
										ln_propertyv2_as_Business_Prep(
											...
											,
											,IsPRCT
										)(lib_stringlib.StringLib.StringFilterOut(partial_interest_transferred,' 0') = '');
	...
	Business_Header.Layout_Business_Contact_Full_New tGetMatchingCompany(dPropertyPrepPersonAsBusContact pPerson, dPropertyPrepCompanyAsBusContact pCompany)
	 :=
		transform
	...
	asbus := fLN_Propertyv2_as_Business_Header(
