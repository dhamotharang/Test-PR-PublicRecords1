import LN_Property, doxie, standard, ut, doxie_ln, NID;

// owners when using LN data
fs   := LN_PropertyV2.file_search_building;
fa   := ln_propertyv2.File_Assessment;
fd   := ln_propertyv2.File_Deed;
fafd := ln_propertyv2.File_addl_fares_deed;
...
dd0 := LN_PropertyV2.file_search_building(prim_name!='' and zip!='');
...
export key_addr_fid_prep := ddd : persist('persist::ln_property_addr_fid');