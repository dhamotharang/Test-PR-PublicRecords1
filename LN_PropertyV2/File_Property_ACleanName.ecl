ds_search := LN_PropertyV2.File_Search_did(ln_fares_id<>'' AND err_stat[1] = 'S' AND which_orig='1' AND ln_fares_id[2] ='A');	
rec := record
...
EXPORT File_Property_ACleanName := project(ds_search_out(keepit>0), Layout_Property_KeyExtract);