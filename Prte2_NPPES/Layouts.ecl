...
Export Lnpid_slim_layout	:= record
			String10		NPI;
			unsigned8	lnpid;
end;
...
Export NPPES_Payload_Layout:=RECORD
  unsigned6 fakeid;
  unsigned6 did;
  unsigned1 did_score;
  unsigned6 bdid;
 ...
 Export citystname_layout:=RECORD
  unsigned4 city_code;
  string2 st;
  string6 dph_lname;
  string20 lname;
 ...
 Export citystnameb2_layout:=RECORD
  unsigned4 city_code;
  string2 st;
  string40 cname_indic;
  string40 cname_sec;
 ...
 Export namewords2_layout:=RECORD
  string40 word;
  string2 state;
  unsigned1 seq;
  unsigned6 bdid;
