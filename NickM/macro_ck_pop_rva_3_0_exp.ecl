export macro_ck_pop_rva_3_0_exp(date, adate) := macro
#workunit('name','RVA 3.0 Experian Tracking Populated Fields');
#option ('hthorMemoryLimit', 1000);

IMPORT Risk_Indicators;

//===================  input file  ======================
infile :=  '~nmontpetit::out::rva_30_tracking_exp_'+(string)date+'_'+(string)adate;
...
ds_infile := dataset(infile, layout_rva_30, csv(heading(1), quote('"'), maxlength(32000)));
