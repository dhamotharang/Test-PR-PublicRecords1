...
output(final,,'~nmontpetit::out::rva_30_tracking_' + today + '_' + (string)archive_date, CSV(quote('"')), overwrite);
output(final(errorcode<>''),,'~nmontpetit::out::rva_30_tracking_err',CSV(QUOTE('"')), overwrite);
