export macro_compare_rva_3_0_exp(olddate, newdate, old_adate, new_adate) := macro
#workunit('name','RVA 3.0 Comparison for Tracking with Experian');
...
//===================  input-output files  ======================
infile_original :=  '~nmontpetit::out::rva_30_tracking_exp_'+(string)olddate+'_'+(string)old_adate;
infile_compare :=   '~nmontpetit::out::rva_30_tracking_exp_'+(string)newdate+'_'+(string)new_adate;
