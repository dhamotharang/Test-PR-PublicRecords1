EXPORT macro_run_lia_3_0(archive_date) :=  macro
...
inputFile := '~nmontpetit::in::lia_30_tracking_pii';
outputFile := '~nmontpetit::out::lia_30_tracking_' + today + '_' + (string)archive_date;
