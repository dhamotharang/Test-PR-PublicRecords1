export macro_run_bs_4_1_cert_fcra(archive_date) := macro
...
today := ut.GetDate[3..];
outfile_name_full   := outfile_name + '_full_fcra_' + today + '_' + (string)archive_date;
outfile_name_edina  := outfile_name + '_edina_fcra_' + today + '_' + (string)archive_date;
