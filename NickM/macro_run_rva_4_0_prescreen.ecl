EXPORT macro_run_rva_4_0_prescreen(archive_date) :=  macro
...
outfile_name := '~nmontpetit::out::rva_40_pre_tracking_' + today + '_' + (string)archive_date;
...
output(j_f,,outfile_name,CSV(heading(single), quote('"')));
