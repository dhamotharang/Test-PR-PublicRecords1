...
Layout_InstantID_Results := RECORD
  ...
  string2 reason4;
	string2 reason5;
  string2 reason6;
	unsigned1 DIDCount;	// - The total number of DID’s found	
...
Layout_American_Student := RECORD
	...
	string1 college_major;  // new in shell 4.0
END;
...
export Layout_Boca_Shell_Edina_v4_110803 := RECORD
	...
	Risk_Indicators.layouts.header_verification_summary 		header_summary;  // new to shell 4.0
	Layout_Available_Sources 						Available_Sources;
	Risk_Indicators.layouts.layout_business_header_summary  business_header_address_summary;  // new to shell 4.0
	...
	Risk_Indicators.layouts.layout_inquiries 						acc_logs;  // new to shell 4.0	
	Risk_Indicators.layouts.layout_employment 					employment;  // new to shell 4.0
	Layout_Infutor											Infutor;
	Layout_Impulse											Impulse;
	Risk_Indicators.layouts.layout_email								email_summary;  // new to shell 4.0
