...
module
   ...
   function
      ...
      transform
         ...
         SELF.vendor_id                         := trim(L.rawfields.LicenseNumber);
				 SELF.vl_id                          := trim(L.rawfields.LicenseNumber);
         SELF.phone                             := (unsigned6)0;
         SELF.phone_score                    := IF(self.phone = 0, 0, 1);
         SELF.source                            := MDR.sourceTools.src_AK_Busreg;
   ...
   function
      ...
      transform
         ...
         self.company_phone            := (unsigned8)0;
         self.company_fein             := 0;
         self.bdid                           := 0;
      end;
      dAsBusinessHeader := project(
