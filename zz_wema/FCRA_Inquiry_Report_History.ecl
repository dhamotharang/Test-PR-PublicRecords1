EXPORT FCRA_Inquiry_Report_History(Par1):=FUNCTIONMACRO
...
fcra_inquiries := project(Inquiry_AccLogs.Key_FCRA_DID((unsigned)search_info.datetime[1..8]<=BuildVersion) , transform_raw(left));
