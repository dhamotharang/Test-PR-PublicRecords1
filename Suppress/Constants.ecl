  ...
  EXPORT DATE_MASK_TYPE :=
	...
	EXPORT OptOut(STRING8 filedate='') := MODULE
		...
		EXPORT	STRING Directory			:= IF(	_control.thisenvironment.name='Dataland',
													'/data/hds_2/test/optoutprocessing',
													'/data/Builds/builds/ccpalogs/mbsoptout/data/processing');
		...
		EXPORT SET OF UNSIGNED4 Global_Sids_PR_NPD	:= [11111,23361,23371,23381,8271,23311,22751,22911,23571,24051,24141,23431,22401,23421,25751,25041,27581,27001,24011,23401,23411,16281,16331,22611,24591,24361,22771,24371,23611,23621,24351,24961,25651,19521,25681,25901,27651,24221,23461,23471,23481,23781,24911,23581,26631,23591,22661,22671,22691,23561,23451,22651,22921,22641,22961,22971,22981,22991,23001,23011,23021,23031,23041,23051,23061,23071,23121,22371,22381,23441,22601,14761,23601,27441,23931,23961,23991,27621,25371,17591,17871,26651,24611,24641,23231,25031,24451,25471,25781,25721,25321,27591,22681,23241,25791,26041,26051,26061,26191,26211,23521,23531,24261,26541,26641,23161,26671,26881,23331,27681,27161,27371,27381,27571,24331,25731,26521,27641,22811,26651,26541,17591,8271,27721];
		EXPORT SET OF UNSIGNED4 Global_Sids_PR_PD	:= [22222,23361,23371,23381,8271,23311,22751,22911,23571,24051,24141,23431,22401,23421,25751,25041,27581,27001,24011,23401,23411,16281,16331,22611,24591,24361,22771,24371,23611,23621,24351,24961,25651,19521,25681,25901,27651,24221,23461,23471,23481,23781,24911,23581,26631,23591,22661,22671,22691,23561,23451,22651,22921,22641,22961,22971,22981,22991,23001,23011,23021,23031,23041,23051,23061,23071,23121,22371,22381,23441,22601,14761,23601,27441,23931,23961,23991,27621,25371,17591,17871,26651,24611,24641,23231,25031,24451,25471,25781,25721,25321,27591,22681,23241,25791,26041,26051,26061,26191,26211,23521,23531,24261,26541,26641,23161,26671,26881,23331,27681,27161,27371,27381,27571,24331,25731,26521,27641,22811,26651,26541,17591,8271,27721];
	...
	EXPORT Exemptions(STRING8 filedate='') := MODULE
		...
		EXPORT STRING Directory				:= '/data/hds_2/test/optoutprocessing';
		EXPORT STRING GroupName				:= IF(	_control.thisenvironment.name='Dataland',
													'THOR400_STA01',
													'THOR400_36');					
		...
		// EXPORT STRING FileToSpray_PR 		:= TRIM('pr_test_orbit_exemptionsextract_'+filedate+'*.csv',ALL);	
		// EXPORT STRING FileToSpray_HC 		:= TRIM('mdm_test_orbit_exemptionsextract_'+filedate+'*.csv',ALL);		
		// EXPORT STRING FileToSpray_Ins 		:= TRIM('insuranceus_test_orbit_exemptionsextract_'+filedate+'*.csv',ALL);
