...
EXPORT fDesprayRBIFile(STRING pVersion, 
    ...
    lzFileName      := pDirectory+'/'+$.Constants.OptOut(pVersion).FileNameForRBI;
	...
	despray_rbi_file := fileservices.Despray(thorFileName, pServerIP, lzFileName,,,,TRUE);		
