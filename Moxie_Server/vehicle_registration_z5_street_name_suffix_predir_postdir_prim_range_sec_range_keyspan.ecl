/*--SOAP--
<message name="vehicle_registration_z5_street_name_suffix_predir_postdir_prim_range_sec_range_keyspan">
...
export vehicle_registration_z5_street_name_suffix_predir_postdir_prim_range_sec_range_keyspan := MACRO
