/*--SOAP--
<message name="vehicle_registration_st_city_dph_lname_fname_mname_lname_search">
...
export vehicle_registration_st_city_dph_lname_fname_mname_lname_search := MACRO
