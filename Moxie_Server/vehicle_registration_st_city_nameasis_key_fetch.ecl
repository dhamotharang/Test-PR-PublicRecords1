/*--SOAP--
<message name="vehicle_registration_st_city_nameasis_key_fetch">
...
export vehicle_registration_st_city_nameasis_key_fetch := MACRO

// beginning of fill in values
keyfilename := '~thor_data400::key::moxie.mv.st.city.nameasis.key';
...
key := INDEX(dataset([],datasetlayout),{own_1_state_2,own_1_p_city_name,own_1_customer_name,fpos},keyfilename);
#uniquename(f)
