/*--SOAP--
<message name="vehicle_registration_st_city_cn_key_fetch">
...
export vehicle_registration_st_city_cn_key_fetch := MACRO

// beginning of fill in values
keyfilename := '~thor_data400::key::moxie.mv.st.city.cn.key';
...
key := INDEX(dataset([],datasetlayout),{own_1_state_2,own_1_p_city_name,STRING10 cn := '',fpos},keyfilename);
#uniquename(f)
