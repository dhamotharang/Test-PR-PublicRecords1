/*--SOAP--
<message name="vehicle_registration_st_lfmname_key_fetch">
...
export vehicle_registration_st_lfmname_key_fetch := MACRO

// beginning of fill in values
keyfilename := '~thor_data400::key::moxie.mv.st.lfmname.key';
...
key := INDEX(dataset([],datasetlayout),{own_1_state_2,STRING60 lfmname := own_1_lname,fpos},keyfilename);
#uniquename(f)
...
lim_res := LIMIT(res,max_count_value,FAIL(11, doxie.ErrorCodes(11)),keyed,count);
