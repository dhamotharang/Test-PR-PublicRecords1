/*--SOAP--
<message name="vehicle_registration_dph_lname_fname_mname_lname_key_fetch">
...
export vehicle_registration_dph_lname_fname_mname_lname_key_fetch := MACRO

// beginning of fill in values
keyfilename := '~thor_data400::key::moxie.mv.dph_lname.fname.mname.lname.key';
...
key := INDEX(dataset([],datasetlayout),{string6 dph_lname := '',own_1_fname,own_1_mname,own_1_lname,fpos},keyfilename);
#uniquename(f)
