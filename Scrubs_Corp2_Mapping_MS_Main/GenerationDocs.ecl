...
Command line options: -MScrubs_Corp2_Mapping_MS_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFRC3B9.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_MS_Main
FILENAME:In_MS
...
FIELDTYPE:invalid_corp_vendor:ENUM(28)
FIELDTYPE:invalid_state_origin:ENUM(MS)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_alphablank:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_alphablankhyphen:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_alphablankcomma:ALLOW( ,ABCDEFGHIJKLMNOPQRSTUVWXYZ) 
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(4..)
FIELDTYPE:invalid_charter:ALLOW(0123456789):LENGTHS(1..)
FIELDTYPE:invalid_date_general:ALLOW(0123456789):LENGTHS(8):CUSTOM(Scrubs.fn_valid_GeneralDate>0)
FIELDTYPE:invalid_date_past:ALLOW(0123456789):LENGTHS(8):CUSTOM(Scrubs.fn_valid_pastDate>0)
FIELDTYPE:invalid_optional_date_general:ALLOW(0123456789):LENGTHS(0,1,8):CUSTOM(Scrubs.fn_valid_GeneralDate>0)
FIELDTYPE:invalid_optional_date_past:ALLOW(0123456789):LENGTHS(0,1,8):CUSTOM(Scrubs.fn_valid_pastDate>0)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(Y|N| )
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_MS_Main.Functions.invalid_name_type_code>0,recordOrigin)
FIELDTYPE:invalid_corp_filing_desc:ENUM(HOME STATE|APPROVED|ANNUAL MEETING DATE|DURATION DATE|EXPIRATION DATE|FILED|FUTURE EFFECTIVE DATE|SUBMITTED|AMENDMENT ADOPTED DATE| )
 
//FIELD DEFINITIONS
DATEFIELD:dt_vendor_first_reported:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:dt_vendor_last_reported:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:dt_first_seen:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:dt_last_seen:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:corp_ra_dt_first_seen:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:corp_ra_dt_last_seen:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:corp_process_date:TYPE(STRING8):LIKE(invalid_date_past):0,0
DATEFIELD:corp_filing_date:TYPE(STRING8):LIKE(invalid_optional_date_past):0,0
DATEFIELD:corp_delayed_effective_date:TYPE(STRING8):LIKE(invalid_optional_date_general):0,0
DATEFIELD:corp_forgn_date:TYPE(STRING8):LIKE(invalid_optional_date_general):0,0
DATEFIELD:corp_dissolved_date:TYPE(STRING8):LIKE(invalid_optional_date_general):0,0
DATEFIELD:corp_inc_date:TYPE(STRING8):LIKE(invalid_optional_date_general):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alphablankcomma):0,0
FIELD:corp_for_profit_ind:TYPE(STRING1):LIKE(invalid_for_profit_ind):0,0
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:corp_ln_name_type_cd:TYPE(STRING2):LIKE(invalid_name_type_code):0,0
FIELD:recordorigin:TYPE(STRING1):0,0
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_alphablankhyphen):0,0
FIELD:corp_filing_desc:TYPE(STRING60):LIKE(invalid_corp_filing_desc):0,0
FIELD:cont_type_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:cont_title2_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:cont_title3_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:cont_title4_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:cont_title5_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
...
// FIELD:corp_orig_bus_type_cd:TYPE(STRING8):LIKE(invalid_corp_orig_bus_type_cd):0,0
...
// DATEFIELD:corp_trademark_expiration_date:TYPE(STRING8):0,0
...
//NEVER USED FOR CORP MAPPER SCRUBBING
