EXPORT Layout_Interpol_Most_Wanted := MODULE


export Interpol_Most_Wanted_Red_Notice := record
...
export layout_Reformat_INT_Red_Notice_out0 := record
...
export layout_Reformat_INT_Red_Notice_out1 := record
  string10 last_update_date;
  string10 pty_key;
  string20 Interpol_ID;
  string60 source;
...
//////Interpol Most Wanted Full

export layout_Interpol_Most_Wanted_Full := record
  string ID;
  string FamilyName;
  string Forename;
  string Sex;
...
export layout_Parse_Individual_Citations_out0 := record
  string ID;
  string FamilyName;
  string Forename;
  string Name_Type;
...
export layout_Parse_Individual_Citations_out1 := record
  string ID;
  string FamilyName;
  string Forename;
  string Name_Type;
...
export layout_Reformat_Interpol_Data := record
  string10 last_update_date;
  string10 pty_key;
  string20 Interpol_ID;
  string60 source;
...
export layout_Reformat_Unmatched_Records := record
  string10 pty_key;
  string60 source;
  ...
  string1050 remarks_9;
	string1050 remarks_10;
  string1050 remarks_11;
  string1050 remarks_12;
  string1050 remarks_13;
  string1050 remarks_14;
end;
