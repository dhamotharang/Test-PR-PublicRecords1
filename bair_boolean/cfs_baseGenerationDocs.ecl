...
FIELD:rd:0,0
FIELD:wc_how_received:SEGTYPE(FieldDataType):0,0
FIELD:how_received:0,0
FIELD:wc_initial_type:SEGTYPE(FieldDataType):0,0
FIELD:initial_type:0,0
FIELD:wc_final_type:SEGTYPE(FieldDataType):0,0
FIELD:final_type:0,0
FIELD:incident_code:0,0
FIELD:wc_incident_progress:SEGTYPE(FieldDataType):0,0
...
FIELD:total_minutes_on_call:SEGTYPE(NumericType):1,0
FIELD:accuracy:0,0
FIELD:minutes_on_call:SEGTYPE(NumericType):1,0
FIELD:minutes_response:SEGTYPE(NumericType):1,0
FIELD:wc_unit:SEGTYPE(FieldDataType):0,0
FIELD:unit:0,0
...
FIELD:clean_current_phone:0,0
FIELD:complainant_address:0,0
...
Total available specificity:12
