...
EXPORT ReturnToBatch (string pVersion, boolean pUseProd = false, string gcid, dataset (UPI_DataBuild__dev.Layouts_V2.input_processing) pBaseFile, string pAppendOption):= MODULE
	...
	EXPORT Batch_processing	:= FUNCTION
		...
		UPI_DataBuild__dev.layouts_V2.input_processing tMapping(UPI_DataBuild__dev.layouts_V2.input_processing L) := TRANSFORM
