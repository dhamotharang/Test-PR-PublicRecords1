...
export Cleanup_NoSave_All(pAsOfDate) := functionmacro
	...
	export dataset_for_linking_delete	:= function
		filenames_ds	:= UPI_DataBuild__dev.NoSave_Cleanup.search_logical_files(pAsOfDate,'BASE');
	...
	export step1 := UPI_DataBuild__dev.NoSave_Cleanup.search_and_destroy_all(pAsOfDate);
