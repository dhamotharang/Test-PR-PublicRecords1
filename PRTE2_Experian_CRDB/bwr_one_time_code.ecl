...
MakeSuperKeys ('~prte::key::experian_crdb::@version@::linkids');

MakeSuperFiles ('~PRTE::BASE::experian_crdb::experian_crdb@version@');

FileServices.CreateSuperFile ('~PRTE::IN::experian_crdb::experian_crdb');
