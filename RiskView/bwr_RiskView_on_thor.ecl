...
// 1.  COPY ALL PUBLIC RECORD KEYS THAT RiskView 5.0 USES TO THE THOR40_44 CLUSTER 
//   -  RiskView.bwr_transfer_DIDappend_files
//   -  RiskView.bwr_transfer_rv5_files
// 2.  MAKE SURE _Control.LibraryUse IS SANDBOXED with the following 
//   - export ForceOff_AllLibraries := TRUE;
// 3.  MAKE SURE YOU SANDBOX doxie.Version_SuperKey to the following:
//   - export Version_SuperKey := 'riskviewkeys';
// 4.  Update your input test file logical name:  test_file_name on line 35
...
// 6.  remove the 100 record limit on line 29, change the flag for onThor on line 21 to true and RUN the entire job  
