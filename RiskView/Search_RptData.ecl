import doxie, RiskWiseFCRA, FCRA, riskwise, Risk_Indicators,
				american_student_list, AlloyMedia_student_list, impulse_email, ln_propertyv2,
				dx_Gong, advo, Codes, iesp, address, corrections, Consumerstatement,
				RiskView, suppress, LN_PropertyV2_Services, SexOffender, STD, data_services;
...
EXPORT Search_RptData := MODULE
	...
	SHARED isFCRA := true;
  SHARED integer1 iType := data_services.data_env.iFCRA;
