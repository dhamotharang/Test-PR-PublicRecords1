import versioncontrol, _control, ut, tools, UPI_DataBuild__old, HealthcareNoMatchHeader_InternalLinking, HealthcareNoMatchHeader_Ingest, Workman;
export Build_all_V2(pVersion, pUseProd, gcid, pLexidThreshold, pHistMode, gcid_name, pBatch_jobID, pAppendOption) := functionmacro
	...
	export step1 := sequential(
			check_supers
			,FileServices.ClearSuperFile(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputTemplate) // if processing new input - clear out anything that might still be in the *in* superfile
			,FileServices.AddSuperFile(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputTemplate,UPI_DataBuild__old._Dataset(pUseProd).thor_cluster_files + 'from_batch::' + gcid + '::' + trim(pBatch_jobID,all) + '::' + pVersion)
			
			,UPI_DataBuild__old.Build_Base_V2.process_input_file(pVersion_unique,pUseProd,gcid,pLexidThreshold,pHistMode,gcid_name,pBatch_jobID,pAppendOption).process_input_all
			,UPI_DataBuild__old.Promote_V2.promote_processed_input(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA
			
			,UPI_DataBuild__old.Build_asHeader_V2(pVersion_unique,pUseProd,gcid,pHistMode,gcid_name,pBatch_jobID).asHeader_all // for this product, the asheader is built from the previously processed base file
			,UPI_DataBuild__old.Promote_V2.promote_asHeader(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA
		
			,UPI_DataBuild__old.Build_Base_V2.Build_temp_header(pVersion_unique,pUseProd,gcid,pHistMode,gcid_name,pBatch_jobID).temp_header_all
			,UPI_DataBuild__old.Promote_V2.promote_temp_header(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA
	);
	// export step2	:= output(pVersion_crk_macro(gcid, pVersion));
	export step2	:= HealthcareNoMatchHeader_InternalLinking.MAC_AppendCRK(
				gcid
			 ,pVersion_unique
			 ,UPI_DataBuild__old.Filenames_V2(pVersion_unique, pUseProd, gcid, pHistMode).temp_header.built
			 ,UPI_DataBuild__old.Filenames_V2(pVersion_unique, pUseProd, gcid, pHistMode).asheader.built);
			 			 
	export step3 := sequential(
			UPI_DataBuild__old.Build_Base_V2.Build_base_members(pVersion_unique,pUseProd,gcid,pLexidThreshold,pHistMode,gcid_name,pBatch_jobID,pAppendOption).member_all
			,if(pHistMode = 'A', UPI_DataBuild__old.Promote_V2.promote_base(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA,
					sequential(
						 fileservices.startsuperfiletransaction()
						,fileservices.addsuperfile('~ushc::crk::base::' + gcid + '::qa_nosave',UPI_DataBuild__old.Filenames_V2(pVersion_unique, pUseProd, gcid, pHistMode).member_base.new)
						// ,fileservices.addsuperfile('~ushc::crk::base::' + gcid + '::built_nosave',UPI_DataBuild__old.Filenames_V2(pVersion_unique, pUseProd, gcid, pHistMode).member_base.new)
			...
			,UPI_DataBuild__old.Build_Base_V2.Build_batch_output(pVersion_unique,pUseProd,gcid,pLexidThreshold,pHistMode,gcid_name,pBatch_jobID,pAppendOption).full_batch_all
			,UPI_DataBuild__old.Promote_V2.promote_return_tobatch(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA
			
			,UPI_DataBuild__old.Build_Base_V2.Build_base_metrics(pVersion_unique,pUseProd,gcid,pLexidThreshold,pHistMode,gcid_name,pBatch_jobID,pAppendOption).full_build_metrics
			,UPI_DataBuild__old.Promote_V2.promote_tobatch_metrics(pVersion_unique,pUseProd,gcid,pHistMode).buildfiles.Built2QA
			
			,UPI_DataBuild__old.Build_Base_V2.Build_slim_report(pVersion_unique,pUseProd,gcid,pLexidThreshold,pHistMode,gcid_name,pBatch_jobID,pAppendOption).full_build_slim_report
			,sequential(
						 fileservices.startsuperfiletransaction()
						,fileservices.addsuperfile('~ushc::crk::slim_history::' + gcid + '::qa',UPI_DataBuild__old.Filenames_V2(pVersion_unique, pUseProd, gcid, pHistMode).slim_history_file.new)
						,fileservices.finishsuperfiletransaction())
						// push slim history files to qa superfile - no deletes and no automatic promote through additional generations
													
			,FileServices.StartSuperFileTransaction()
			,FileServices.RemoveOwnedSubFiles(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputHistTemplate,true)
			,FileServices.ClearSuperFile(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputHistTemplate)
			,FileServices.AddSuperFile(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputHistTemplate,  UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputTemplate,,true)
			
			,FileServices.RemoveOwnedSubFiles(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputTemplate,true)
			,FileServices.ClearSuperFile(UPI_DataBuild__old.Filenames_V2(pVersion_unique,pUseProd,gcid,pHistMode).batch_lInputTemplate)
