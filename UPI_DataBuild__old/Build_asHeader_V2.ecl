...
EXPORT Build_asHeader_V2(
			...
			shared dBuildasHeader := UPI_DataBuild__old.Create_asHeader_V2(pVersion,pUseProd,gcid,pHistMode,gcid_name,batch_jobid).Build_it;
			VersionControl.macBuildNewLogicalFile(
																			 UPI_DataBuild__old.Filenames_V2(pVersion, pUseProd, gcid, pHistMode).asHeader.new
																		 	,dBuildasHeader
																			,Build_asHeader_File
																			);
			shared full_build	:=  
