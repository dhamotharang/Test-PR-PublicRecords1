...
EXPORT IngestCompanies(BOOLEAN incremental=FALSE
...
, DATASET(Equifax_Business_Data.Layouts.Base) infile 
  ...
  DistIngest0 := DISTRIBUTE(FilesToIngest0, HASH32(EFX_ID
             ...
             ,AT_CERTEXP9,AT_CERTEXP10,EFX_FOREIGN,normCompany_Name,normCompany_Type,Norm_Geo_Precision,Exploded_Desc_Corporate_Amount_Precision,Exploded_Desc_Location_Amount_Precision,Exploded_Desc_Public_Co_Indicator,Exploded_Desc_Stock_Exchange
             ,Exploded_Desc_Telemarketablity_Score,Exploded_Desc_Telemarketablity_Total_Indicator,Exploded_Desc_Telemarketablity_Total_Score,Exploded_Desc_Government1057_Entity,Exploded_Desc_Merchant_Type,Exploded_Desc_Busstatcd,Exploded_Desc_CMSA,Exploded_Desc_Corpamountcd,Exploded_Desc_Corpamountprec,Exploded_Desc_Corpamounttp
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname));
  SortIngest0 := SORT(DistIngest0,EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
             ...
             ,Exploded_Desc_Telemarketablity_Score,Exploded_Desc_Telemarketablity_Total_Indicator,Exploded_Desc_Telemarketablity_Total_Score,Exploded_Desc_Government1057_Entity,Exploded_Desc_Merchant_Type,Exploded_Desc_Busstatcd,Exploded_Desc_CMSA,Exploded_Desc_Corpamountcd,Exploded_Desc_Corpamountprec,Exploded_Desc_Corpamounttp
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname, __Tpe, rcid, seleid, LOCAL);
  GroupIngest0 := GROUP(SortIngest0,EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
             ...
             ,Exploded_Desc_Telemarketablity_Score,Exploded_Desc_Telemarketablity_Total_Indicator,Exploded_Desc_Telemarketablity_Total_Score,Exploded_Desc_Government1057_Entity,Exploded_Desc_Merchant_Type,Exploded_Desc_Busstatcd,Exploded_Desc_CMSA,Exploded_Desc_Corpamountcd,Exploded_Desc_Corpamountprec,Exploded_Desc_Corpamounttp
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname, LOCAL, ORDERED, STABLE);
  SHARED AllIngestRecs0 := UNGROUP(ROLLUP(GroupIngest0,TRUE,MergeData(LEFT,RIGHT)));
 
  // Existing Base: combine delta with base file
  DistBase0 := DISTRIBUTE(SALT311.MAC_DatasetAsOf(Base0+Delta0,rcid,seleid,,dt_effective_first,dt_effective_last,,'YYYYMMDD',TRUE), HASH32(EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
             ...
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname));
  SortBase0 := SORT(DistBase0,EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
             ...
             ,Exploded_Desc_Telemarketablity_Score,Exploded_Desc_Telemarketablity_Total_Indicator,Exploded_Desc_Telemarketablity_Total_Score,Exploded_Desc_Government1057_Entity,Exploded_Desc_Merchant_Type,Exploded_Desc_Busstatcd,Exploded_Desc_CMSA,Exploded_Desc_Corpamountcd,Exploded_Desc_Corpamountprec,Exploded_Desc_Corpamounttp
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname, __Tpe, rcid, LOCAL);
  GroupBase0 := GROUP(SortBase0,EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
             ...
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname, LOCAL, ORDERED, STABLE);
  SHARED AllBaseRecs0 := UNGROUP(ROLLUP(GroupBase0,TRUE,MergeData(LEFT,RIGHT))) : INDEPENDENT;
 
  // Everything: combine ingest and base recs
  Sort0 := SORT(AllBaseRecs0+AllIngestRecs0,EFX_ID
             ,EFX_NAME,EFX_LEGAL_NAME,EFX_ADDRESS,EFX_CITY,EFX_STATE,EFX_STATEC,EFX_ZIPCODE,EFX_ZIP4,EFX_LAT,EFX_LON
             ,EFX_GEOPREC,EFX_REGION,EFX_CTRYISOCD,EFX_CTRYNUM,EFX_CTRYNAME,EFX_COUNTYNM,EFX_COUNTY,EFX_CMSA,EFX_CMSADESC,EFX_SOHO
             ,EFX_BIZ,EFX_RES,EFX_CMRA,EFX_CONGRESS,EFX_SECADR,EFX_SECCTY,EFX_SECSTAT,EFX_STATEC2,EFX_SECZIP,EFX_SECZIP4
             ,EFX_SECLAT,EFX_SECLON,EFX_SECGEOPREC,EFX_SECREGION,EFX_SECCTRYISOCD,EFX_SECCTRYNUM,EFX_SECCTRYNAME,EFX_CTRYTELCD,EFX_PHONE,EFX_FAXPHONE
  ...
  Group0 := GROUP(Sort0,EFX_ID
             ...
             ,Exploded_Desc_Corpempcd,Exploded_Desc_Ctrytelcd,NormAddress_Type,Norm_Address,Norm_City,Norm_State,Norm_StateC2,Norm_Zip,Norm_Zip4,Norm_Lat
             ,Norm_Lon,Norm_Geoprec,Norm_Region,Norm_Ctryisocd,Norm_Ctrynum,Norm_Ctryname,LOCAL, ORDERED, STABLE);
  SHARED AllRecs0 := UNGROUP(ROLLUP(Group0,TRUE,MergeData(LEFT,RIGHT))) : INDEPENDENT;
...
// seleid changed records
  ...
  seleidChangeAll0     := SALT311.MAC_PoisonRecords(seleidChangePrevRecs, seleidChangeNewRecs, 'seleid,rcid', dt_effective_first, dt_effective_last, 'YYYYMMDD');
  SHARED seleidChangeAll      := PROJECT(seleidChangeAll0, TRANSFORM(RECORDOF(LEFT), SELF.__Tpe := RecordType.Updated, SELF := LEFT)) : PERSIST('~temp::seleid::Equifax_Business_Data::Ingest_LinkChange',EXPIRE(Equifax_Business_Data.Config.PersistExpire));
  // Hard delete records (other than from seleid change)
  SHARED HardDeleteRecs := AllRecs0(__Tpe=RecordType.Updated AND hardDeleteAdded) : PERSIST('~temp::seleid::Equifax_Business_Data::Ingest_HardDeletes',EXPIRE(Equifax_Business_Data.Config.PersistExpire));
  ...
  UpdateStatsSrc_HardDelete := TABLE(HardDeleteRecs, {source,__Tpe,SALT311.StrType INGESTSTATUS:='HardDeleteOnly',UNSIGNED Cnt:=COUNT(GROUP)}, source,__Tpe, FEW);
  UpdateStatsSrc_seleidChanges := TABLE(seleidChangeAll, {source,__Tpe,SALT311.StrType INGESTSTATUS:='HardDeleteLinkChange',UNSIGNED Cnt:=COUNT(GROUP)}, source,__Tpe, FEW);
  ...
  Fields.MAC_CountDifferencesByPivot(NewRecords,IOR,((SALT311.StrType)source+'|'+(SALT311.StrType)efx_id),BadPivs,DC)
