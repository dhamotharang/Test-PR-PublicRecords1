...
EXPORT Summary(SALT37.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_Norm_Corporate_Amount_Precision_pcnt := AVE(GROUP,IF(h.Norm_Corporate_Amount_Precision = (TYPEOF(h.Norm_Corporate_Amount_Precision))'',0,100));
    maxlength_Norm_Corporate_Amount_Precision := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Corporate_Amount_Precision)));
    avelength_Norm_Corporate_Amount_Precision := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Corporate_Amount_Precision)),h.Norm_Corporate_Amount_Precision<>(typeof(h.Norm_Corporate_Amount_Precision))'');
    populated_Norm_Location_Amount_Precision_pcnt := AVE(GROUP,IF(h.Norm_Location_Amount_Precision = (TYPEOF(h.Norm_Location_Amount_Precision))'',0,100));
    maxlength_Norm_Location_Amount_Precision := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Location_Amount_Precision)));
    avelength_Norm_Location_Amount_Precision := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Location_Amount_Precision)),h.Norm_Location_Amount_Precision<>(typeof(h.Norm_Location_Amount_Precision))'');
    populated_Norm_Public_Co_Indicator_pcnt := AVE(GROUP,IF(h.Norm_Public_Co_Indicator = (TYPEOF(h.Norm_Public_Co_Indicator))'',0,100));
    maxlength_Norm_Public_Co_Indicator := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Public_Co_Indicator)));
    avelength_Norm_Public_Co_Indicator := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Public_Co_Indicator)),h.Norm_Public_Co_Indicator<>(typeof(h.Norm_Public_Co_Indicator))'');
    populated_Norm_Stock_Exchange_pcnt := AVE(GROUP,IF(h.Norm_Stock_Exchange = (TYPEOF(h.Norm_Stock_Exchange))'',0,100));
    maxlength_Norm_Stock_Exchange := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Stock_Exchange)));
    avelength_Norm_Stock_Exchange := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Stock_Exchange)),h.Norm_Stock_Exchange<>(typeof(h.Norm_Stock_Exchange))'');
    populated_Norm_Telemarketablity_Score_pcnt := AVE(GROUP,IF(h.Norm_Telemarketablity_Score = (TYPEOF(h.Norm_Telemarketablity_Score))'',0,100));
    maxlength_Norm_Telemarketablity_Score := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Score)));
    avelength_Norm_Telemarketablity_Score := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Score)),h.Norm_Telemarketablity_Score<>(typeof(h.Norm_Telemarketablity_Score))'');
    populated_Norm_Telemarketablity_Total_Indicator_pcnt := AVE(GROUP,IF(h.Norm_Telemarketablity_Total_Indicator = (TYPEOF(h.Norm_Telemarketablity_Total_Indicator))'',0,100));
    maxlength_Norm_Telemarketablity_Total_Indicator := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Total_Indicator)));
    avelength_Norm_Telemarketablity_Total_Indicator := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Total_Indicator)),h.Norm_Telemarketablity_Total_Indicator<>(typeof(h.Norm_Telemarketablity_Total_Indicator))'');
    populated_Norm_Telemarketablity_Total_Score_pcnt := AVE(GROUP,IF(h.Norm_Telemarketablity_Total_Score = (TYPEOF(h.Norm_Telemarketablity_Total_Score))'',0,100));
    maxlength_Norm_Telemarketablity_Total_Score := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Total_Score)));
    avelength_Norm_Telemarketablity_Total_Score := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Telemarketablity_Total_Score)),h.Norm_Telemarketablity_Total_Score<>(typeof(h.Norm_Telemarketablity_Total_Score))'');
    populated_Norm_Government1057_Entity_pcnt := AVE(GROUP,IF(h.Norm_Government1057_Entity = (TYPEOF(h.Norm_Government1057_Entity))'',0,100));
    maxlength_Norm_Government1057_Entity := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Government1057_Entity)));
    avelength_Norm_Government1057_Entity := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Government1057_Entity)),h.Norm_Government1057_Entity<>(typeof(h.Norm_Government1057_Entity))'');
    populated_Norm_Merchant_Type_pcnt := AVE(GROUP,IF(h.Norm_Merchant_Type = (TYPEOF(h.Norm_Merchant_Type))'',0,100));
    maxlength_Norm_Merchant_Type := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Merchant_Type)));
    avelength_Norm_Merchant_Type := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.Norm_Merchant_Type)),h.Norm_Merchant_Type<>(typeof(h.Norm_Merchant_Type))'');
...
SHARED FldIds := DATASET([{1,'dt_effective_first'}
      ...
      ,{81,'EFX_CORPAMOUNTCD'}
      ,{82,'EFX_CORPAMOUNTTP'}
      ,{83,'EFX_CORPAMOUNTPREC'}
      ,{84,'EFX_LOCAMOUNT'}
      ,{85,'EFX_LOCAMOUNTCD'}
      ,{86,'EFX_LOCAMOUNTTP'}
      ,{87,'EFX_LOCAMOUNTPREC'}
      ,{88,'EFX_PUBLIC'}
      ,{89,'EFX_STKEXC'}
      ,{90,'EFX_TCKSYM'}
      ,{91,'EFX_PRIMSIC'}
      ...
      ,{99,'EFX_SECSICDESC3'}
      ,{100,'EFX_SECSICDESC4'}
      ,{101,'EFX_PRIMNAICSCODE'}
      ,{102,'EFX_SECNAICS1'}
      ,{103,'EFX_SECNAICS2'}
      ,{104,'EFX_SECNAICS3'}
      ,{105,'EFX_SECNAICS4'}
      ,{106,'EFX_PRIMNAICSDESC'}
      ,{107,'EFX_SECNAICSDESC1'}
      ,{108,'EFX_SECNAICSDESC2'}
      ,{109,'EFX_SECNAICSDESC3'}
      ,{110,'EFX_SECNAICSDESC4'}
      ,{111,'EFX_DEAD'}
      ,{112,'EFX_DEADDT'}
      ,{113,'EFX_MRKT_TELEVER'}
      ,{114,'EFX_MRKT_TELESCORE'}
      ,{115,'EFX_MRKT_TOTALSCORE'}
      ,{116,'EFX_MRKT_TOTALIND'}
      ,{117,'EFX_MRKT_VACANT'}
      ,{118,'EFX_MRKT_SEASONAL'}
      ,{119,'EFX_MBE'}
      ,{120,'EFX_WBE'}
      ,{121,'EFX_MWBE'}
      ,{122,'EFX_SDB'}
      ...
      ,{212,'AT_CERTEXP9'}
      ,{213,'AT_CERTEXP10'}
      ,{214,'EFX_EXTRACT_DATE'}
      ,{215,'EFX_MERCHANT_ID'}
      ,{216,'EFX_PROJECT_ID'}
      ,{217,'EFX_FOREIGN'}
      ,{218,'Record_Update_Refresh_Date'}
      ,{219,'EFX_DATE_CREATED'}
      ,{220,'normCompany_Name'}
      ,{221,'normCompany_Type'}
      ,{222,'Norm_Geo_Precision'}
      ,{223,'Norm_Corporate_Amount_Precision'}
      ,{224,'Norm_Location_Amount_Precision'}
      ,{225,'Norm_Public_Co_Indicator'}
      ,{226,'Norm_Stock_Exchange'}
      ,{227,'Norm_Telemarketablity_Score'}
      ,{228,'Norm_Telemarketablity_Total_Indicator'}
      ,{229,'Norm_Telemarketablity_Total_Score'}
      ,{230,'Norm_Government1057_Entity'}
      ,{231,'Norm_Merchant_Type'}
      ...
      ,{264,'st'}
      ,{265,'cart'}
      ,{266,'cr_sort_sz'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_did((SALT37.StrType)le.did),
    Fields.InValid_did_score((SALT37.StrType)le.did_score),
    ...
    Fields.InValid_Norm_Corporate_Amount_Precision((SALT37.StrType)le.Norm_Corporate_Amount_Precision),
    Fields.InValid_Norm_Location_Amount_Precision((SALT37.StrType)le.Norm_Location_Amount_Precision),
    Fields.InValid_Norm_Public_Co_Indicator((SALT37.StrType)le.Norm_Public_Co_Indicator),
    Fields.InValid_Norm_Stock_Exchange((SALT37.StrType)le.Norm_Stock_Exchange),
    Fields.InValid_Norm_Telemarketablity_Score((SALT37.StrType)le.Norm_Telemarketablity_Score),
    Fields.InValid_Norm_Telemarketablity_Total_Indicator((SALT37.StrType)le.Norm_Telemarketablity_Total_Indicator),
    Fields.InValid_Norm_Telemarketablity_Total_Score((SALT37.StrType)le.Norm_Telemarketablity_Total_Score),
    Fields.InValid_Norm_Government1057_Entity((SALT37.StrType)le.Norm_Government1057_Entity),
    Fields.InValid_Norm_Merchant_Type((SALT37.StrType)le.Norm_Merchant_Type),
    ...
    Fields.InValid_name_score((SALT37.StrType)le.name_score),
...
END;
Errors := NORMALIZE(h,266,NoteErrors(LEFT,COUNTER));
