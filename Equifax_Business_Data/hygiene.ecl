...
SALT37.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.FldNo := C;
END;
SHARED FldInv0 := NORMALIZE(h,264,Into(LEFT,COUNTER));
...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),264*264,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dt_effective_first'}
      ...
      ,{24,'dt_first_seen'}
      ,{25,'dt_last_seen'}
      ,{26,'dt_vendor_first_reported'}
      ,{27,'dt_vendor_last_reported'}
      ,{28,'record_type'}
      ,{29,'EFX_ID'}
      ,{30,'EFX_NAME'}
      ,{31,'EFX_LEGAL_NAME'}
      ...
      ,{221,'Norm_Corporate_Amount_Precision'}
      ,{222,'Norm_Location_Amount_Precision'}
      ,{223,'Norm_Public_Co_Indicator'}
      ,{224,'Norm_Stock_Exchange'}
      ,{225,'Norm_Telemarketablity_Score'}
      ,{226,'Norm_Telemarketablity_Total_Indicator'}
      ,{227,'Norm_Telemarketablity_Total_Score'}
      ,{228,'Norm_Government1057_Entity'}
      ,{229,'Norm_Merchant_Type'}
      ,{230,'NormAddress_Type'}
      ,{231,'Norm_Address'}
      ,{232,'Norm_City'}
      ,{233,'Norm_State'}
      ,{234,'Norm_StateC2'}
      ...
      ,{242,'Norm_Ctrynum'}
      ,{243,'Norm_Ctryname'}
      ,{244,'clean_company_name'}
      ,{245,'clean_phone'}
      ,{246,'clean_secondary_phone'}
      ,{247,'title'}
      ,{248,'fname'}
      ,{249,'mname'}
      ,{250,'lname'}
      ...
      ,{262,'st'}
      ,{263,'cart'}
      ,{264,'cr_sort_sz'}],SALT37.MAC_Character_Counts.Field_Identification);
...
END;
Errors := NORMALIZE(h,264,NoteErrors(LEFT,COUNTER));
