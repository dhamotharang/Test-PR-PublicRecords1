...
EXPORT Constants := MODULE
		...
		EXPORT  boolean no_state_search(IParam.searchrecords in_mod) :=/*b_internal_pduser(in_mod.UserType) and */in_mod.JurisdictionState='';
		EXPORT  boolean no_jurisdiction_search(IParam.searchrecords in_mod) :=/*b_internal_pduser(in_mod.UserType) and */in_mod.jurisdiction='';
