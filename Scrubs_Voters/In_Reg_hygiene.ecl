...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_alphanum_empty','invalid_agecat','invalid_changedate','invalid_alphanum_empty','invalid_alphanum_empty','invalid_dob','invalid_alphanum','invalid_pastdate8','invalid_alphanum_specials','invalid_gender','invalid_alphanum_empty','invalid_phone','invalid_alphanum_empty','invalid_lastdatevote','invalid_last_name','invalid_boolean_yn_empty','invalid_alphanum_empty_specials','invalid_numeric','invalid_race','invalid_regdate','invalid_mandatory','invalid_mandatory','invalid_st','invalid_mandatory','invalid_alphanum_empty','invalid_alphanum','invalid_alphanum_empty','invalid_alphanumquot_empty','invalid_source_state','invalid_nums_empty','invalid_alphanum_empty','invalid_alphanum_empty','invalid_phone');
