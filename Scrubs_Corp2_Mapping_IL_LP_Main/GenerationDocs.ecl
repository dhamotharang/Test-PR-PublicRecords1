...
Command line options: -MScrubs_Corp2_Mapping_IL_LP_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR9733.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IL_LP_Main
FILENAME:In_IL
...
FIELDTYPE:invalid_corp_key:ALLOW(-CLPS0123456789):LENGTHS(4..)
FIELDTYPE:invalid_supp_key:ALLOW(0123456789)
FIELDTYPE:invalid_corp_vendor:ENUM(17)
FIELDTYPE:invalid_state_origin:ENUM(IL)
...
FIELDTYPE:invalid_charter_nbr:ALLOW(CS0123456789):LENGTHS(1..)
FIELDTYPE:invalid_type_cd:ENUM(01|06|08|P| )
FIELDTYPE:invalid_term_exist_cd:ENUM(D|P| )
FIELDTYPE:invalid_term_exist_desc:ENUM(EXPIRATION DATE|PERPETUAL| )
FIELDTYPE:invalid_address_type_cd:ENUM(B|R|T| )
FIELDTYPE:invalid_address_type_desc:ENUM(BUSINESS|REGISTERED OFFICE|CONTACT| )
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(N|P| )
...
FIELDTYPE:invalid_status_desc:ALLOW( ()-ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_ln_name_type_desc:TYPE(STRING30):LIKE(invalid_alphablank):0,0
...
FIELD:corp_filing_cd:TYPE(STRING8):LIKE(invalid_alphablank):0,0
FIELD:corp_filing_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
FIELD:corp_status_cd:TYPE(STRING8):LIKE(invalid_numblank):0,0
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_status_desc):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
...
FIELD:corp_orig_bus_type_cd:TYPE(STRING8):LIKE(invalid_numblank):0,0
...
FIELD:cont_effective_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:cont_address_type_cd:TYPE(STRING8):LIKE(invalid_address_type_cd):0,0
FIELD:cont_address_type_desc:TYPE(STRING60):LIKE(invalid_address_type_desc):0,0
...
FIELD:corp_agent_county:TYPE(STRING20):LIKE(invalid_alphablankperiod):0,0
...
FIELD:corp_name_status_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
