...
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(corp2_mapping.layoutscommon.main)
    ...
    UNSIGNED1 corp_filing_cd_Invalid;
...
EXPORT FromNone(DATASET(corp2_mapping.layoutscommon.main) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_filing_cd_Invalid := Fields.InValid_corp_filing_cd((SALT34.StrType)le.corp_filing_cd);
    ...
    SELF.corp_inc_county_Invalid := Fields.InValid_corp_inc_county((SALT34.StrType)le.corp_inc_county);
    ...
    SELF.cont_effective_date_Invalid := Fields.InValid_cont_effective_date((SALT34.StrType)le.cont_effective_date);
    SELF.cont_address_type_cd_Invalid := Fields.InValid_cont_address_type_cd((SALT34.StrType)le.cont_address_type_cd);
    SELF.cont_address_type_desc_Invalid := Fields.InValid_cont_address_type_desc((SALT34.StrType)le.cont_address_type_desc);
    SELF.corp_agent_county_Invalid := Fields.InValid_corp_agent_county((SALT34.StrType)le.corp_agent_county);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_vendor_Invalid << 14 ) + ( le.corp_state_origin_Invalid << 15 ) + ( le.corp_process_date_Invalid << 16 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 18 ) + ( le.corp_legal_name_Invalid << 20 ) + ( le.corp_ln_name_type_cd_Invalid << 21 ) + ( le.corp_ln_name_type_desc_Invalid << 22 ) + ( le.corp_address1_type_cd_Invalid << 23 ) + ( le.corp_address1_type_desc_Invalid << 24 ) + ( le.corp_address1_line3_Invalid << 25 ) + ( le.corp_filing_date_Invalid << 26 ) + ( le.corp_filing_cd_Invalid << 28 ) + ( le.corp_filing_desc_Invalid << 29 ) + ( le.corp_status_cd_Invalid << 30 ) + ( le.corp_status_desc_Invalid << 32 ) + ( le.corp_status_date_Invalid << 33 ) + ( le.corp_inc_state_Invalid << 35 ) + ( le.corp_inc_county_Invalid << 36 ) + ( le.corp_inc_date_Invalid << 37 ) + ( le.corp_term_exist_cd_Invalid << 39 ) + ( le.corp_term_exist_exp_Invalid << 40 ) + ( le.corp_term_exist_desc_Invalid << 42 ) + ( le.corp_foreign_domestic_ind_Invalid << 43 ) + ( le.corp_forgn_state_cd_Invalid << 44 ) + ( le.corp_forgn_state_desc_Invalid << 45 ) + ( le.corp_forgn_date_Invalid << 46 ) + ( le.corp_orig_org_structure_desc_Invalid << 48 ) + ( le.corp_for_profit_ind_Invalid << 49 ) + ( le.corp_orig_bus_type_cd_Invalid << 50 ) + ( le.corp_ra_effective_date_Invalid << 52 ) + ( le.corp_ra_address_type_cd_Invalid << 54 ) + ( le.corp_ra_address_type_desc_Invalid << 55 ) + ( le.corp_ra_address_line3_Invalid << 56 ) + ( le.cont_effective_date_Invalid << 57 ) + ( le.cont_address_type_cd_Invalid << 59 ) + ( le.cont_address_type_desc_Invalid << 60 ) + ( le.corp_agent_county_Invalid << 61 ) + ( le.corp_country_of_formation_Invalid << 62 );
    SELF.ScrubsBits2 := ( le.corp_merger_date_Invalid << 0 ) + ( le.corp_name_effective_date_Invalid << 2 ) + ( le.corp_name_status_date_Invalid << 4 ) + ( le.recordorigin_Invalid << 6 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_filing_cd_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.corp_filing_desc_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.corp_status_cd_Invalid := (le.ScrubsBits1 >> 30) & 3;
    ...
    SELF.corp_inc_county_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.corp_inc_date_Invalid := (le.ScrubsBits1 >> 37) & 3;
    SELF.corp_term_exist_cd_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.corp_term_exist_exp_Invalid := (le.ScrubsBits1 >> 40) & 3;
    SELF.corp_term_exist_desc_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.corp_forgn_state_cd_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.corp_forgn_date_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.corp_orig_org_structure_desc_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.corp_orig_bus_type_cd_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.corp_ra_effective_date_Invalid := (le.ScrubsBits1 >> 52) & 3;
    SELF.corp_ra_address_type_cd_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.corp_ra_address_type_desc_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.corp_ra_address_line3_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.cont_effective_date_Invalid := (le.ScrubsBits1 >> 57) & 3;
    SELF.cont_address_type_cd_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.cont_address_type_desc_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.corp_agent_county_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.corp_country_of_formation_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.corp_merger_date_Invalid := (le.ScrubsBits2 >> 0) & 3;
    SELF.corp_name_effective_date_Invalid := (le.ScrubsBits2 >> 2) & 3;
    SELF.corp_name_status_date_Invalid := (le.ScrubsBits2 >> 4) & 3;
    SELF.recordorigin_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_ln_name_type_desc_ALLOW_ErrorCount := COUNT(GROUP,h.corp_ln_name_type_desc_Invalid=1);
    ...
    corp_filing_cd_ALLOW_ErrorCount := COUNT(GROUP,h.corp_filing_cd_Invalid=1);
    corp_filing_desc_ALLOW_ErrorCount := COUNT(GROUP,h.corp_filing_desc_Invalid=1);
    corp_status_cd_ALLOW_ErrorCount := COUNT(GROUP,h.corp_status_cd_Invalid=1);
    corp_status_cd_LENGTH_ErrorCount := COUNT(GROUP,h.corp_status_cd_Invalid=2);
    corp_status_cd_Total_ErrorCount := COUNT(GROUP,h.corp_status_cd_Invalid>0);
    ...
    corp_orig_bus_type_cd_ALLOW_ErrorCount := COUNT(GROUP,h.corp_orig_bus_type_cd_Invalid=1);
    corp_orig_bus_type_cd_LENGTH_ErrorCount := COUNT(GROUP,h.corp_orig_bus_type_cd_Invalid=2);
    corp_orig_bus_type_cd_Total_ErrorCount := COUNT(GROUP,h.corp_orig_bus_type_cd_Invalid>0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.corp_ln_name_type_desc_Invalid,'ALLOW','UNKNOWN')
          ...
          ,CHOOSE(le.corp_filing_cd_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_filing_desc_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_status_cd_Invalid,'ALLOW','LENGTH','UNKNOWN')
          ...
          ,CHOOSE(le.corp_orig_bus_type_cd_Invalid,'ALLOW','LENGTH','UNKNOWN')
          ...
          ,CHOOSE(le.cont_effective_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
    ...
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_key','corp_vendor','corp_state_origin','corp_process_date','corp_orig_sos_charter_nbr','corp_legal_name','corp_ln_name_type_cd','corp_ln_name_type_desc','corp_address1_type_cd','corp_address1_type_desc','corp_address1_line3','corp_filing_date','corp_filing_cd','corp_filing_desc','corp_status_cd','corp_status_desc','corp_status_date','corp_inc_state','corp_inc_county','corp_inc_date','corp_term_exist_cd','corp_term_exist_exp','corp_term_exist_desc','corp_foreign_domestic_ind','corp_forgn_state_cd','corp_forgn_state_desc','corp_forgn_date','corp_orig_org_structure_desc','corp_for_profit_ind','corp_orig_bus_type_cd','corp_ra_effective_date','corp_ra_address_type_cd','corp_ra_address_type_desc','corp_ra_address_line3','cont_effective_date','cont_address_type_cd','cont_address_type_desc','corp_agent_county','corp_country_of_formation','corp_merger_date','corp_name_effective_date','corp_name_status_date','recordorigin','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_mandatory','invalid_type_cd','invalid_alphablank','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablank','invalid_date','invalid_alphablank','invalid_alphablank','invalid_numblank','invalid_status_desc','invalid_date','invalid_state_origin','invalid_alphablank','invalid_date','invalid_term_exist_cd','invalid_future_date','invalid_term_exist_desc','invalid_for_dom_ind','invalid_alphablank','invalid_alphablank','invalid_date','invalid_alphablank','invalid_for_profit_ind','invalid_numblank','invalid_future_date','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablank','invalid_future_date','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablankperiod','invalid_alphablank','invalid_date','invalid_future_date','invalid_future_date','invalid_recordorigin','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.dt_first_seen,(SALT34.StrType)le.dt_last_seen,(SALT34.StrType)le.corp_ra_dt_first_seen,(SALT34.StrType)le.corp_ra_dt_last_seen,(SALT34.StrType)le.corp_key,(SALT34.StrType)le.corp_vendor,(SALT34.StrType)le.corp_state_origin,(SALT34.StrType)le.corp_process_date,(SALT34.StrType)le.corp_orig_sos_charter_nbr,(SALT34.StrType)le.corp_legal_name,(SALT34.StrType)le.corp_ln_name_type_cd,(SALT34.StrType)le.corp_ln_name_type_desc,(SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.corp_address1_line3,(SALT34.StrType)le.corp_filing_date,(SALT34.StrType)le.corp_filing_cd,(SALT34.StrType)le.corp_filing_desc,(SALT34.StrType)le.corp_status_cd,(SALT34.StrType)le.corp_status_desc,(SALT34.StrType)le.corp_status_date,(SALT34.StrType)le.corp_inc_state,(SALT34.StrType)le.corp_inc_county,(SALT34.StrType)le.corp_inc_date,(SALT34.StrType)le.corp_term_exist_cd,(SALT34.StrType)le.corp_term_exist_exp,(SALT34.StrType)le.corp_term_exist_desc,(SALT34.StrType)le.corp_foreign_domestic_ind,(SALT34.StrType)le.corp_forgn_state_cd,(SALT34.StrType)le.corp_forgn_state_desc,(SALT34.StrType)le.corp_forgn_date,(SALT34.StrType)le.corp_orig_org_structure_desc,(SALT34.StrType)le.corp_for_profit_ind,(SALT34.StrType)le.corp_orig_bus_type_cd,(SALT34.StrType)le.corp_ra_effective_date,(SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.corp_ra_address_line3,(SALT34.StrType)le.cont_effective_date,(SALT34.StrType)le.cont_address_type_cd,(SALT34.StrType)le.cont_address_type_desc,(SALT34.StrType)le.corp_agent_county,(SALT34.StrType)le.corp_country_of_formation,(SALT34.StrType)le.corp_merger_date,(SALT34.StrType)le.corp_name_effective_date,(SALT34.StrType)le.corp_name_status_date,(SALT34.StrType)le.recordorigin,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_ln_name_type_desc:invalid_alphablank:ALLOW'
          ,'corp_address1_type_cd:invalid_address_type_cd:ENUM'
          ,'corp_address1_type_desc:invalid_address_type_desc:ENUM'
          ,'corp_address1_line3:invalid_alphablank:ALLOW'
          ,'corp_filing_date:invalid_date:ALLOW','corp_filing_date:invalid_date:CUSTOM'
          ,'corp_filing_cd:invalid_alphablank:ALLOW'
          ,'corp_filing_desc:invalid_alphablank:ALLOW'
          ,'corp_status_cd:invalid_numblank:ALLOW','corp_status_cd:invalid_numblank:LENGTH'
          ...
          ,'corp_orig_bus_type_cd:invalid_numblank:ALLOW','corp_orig_bus_type_cd:invalid_numblank:LENGTH'
          ,'corp_ra_effective_date:invalid_future_date:ALLOW','corp_ra_effective_date:invalid_future_date:CUSTOM'
          ,'corp_ra_address_type_cd:invalid_address_type_cd:ENUM'
          ,'corp_ra_address_type_desc:invalid_address_type_desc:ENUM'
          ,'corp_ra_address_line3:invalid_alphablank:ALLOW'
          ,'cont_effective_date:invalid_future_date:ALLOW','cont_effective_date:invalid_future_date:CUSTOM'
          ,'cont_address_type_cd:invalid_address_type_cd:ENUM'
          ,'cont_address_type_desc:invalid_address_type_desc:ENUM'
          ,'corp_agent_county:invalid_alphablankperiod:ALLOW'
          ...
          ,'corp_name_status_date:invalid_future_date:ALLOW','corp_name_status_date:invalid_future_date:CUSTOM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_filing_cd(1)
          ,Fields.InvalidMessage_corp_filing_desc(1)
          ,Fields.InvalidMessage_corp_status_cd(1),Fields.InvalidMessage_corp_status_cd(2)
          ...
          ,Fields.InvalidMessage_corp_orig_bus_type_cd(1),Fields.InvalidMessage_corp_orig_bus_type_cd(2)
          ...
          ,Fields.InvalidMessage_cont_effective_date(1),Fields.InvalidMessage_cont_effective_date(2)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_ln_name_type_desc_ALLOW_ErrorCount
          ...
          ,le.corp_filing_cd_ALLOW_ErrorCount
          ,le.corp_filing_desc_ALLOW_ErrorCount
          ,le.corp_status_cd_ALLOW_ErrorCount,le.corp_status_cd_LENGTH_ErrorCount
          ...
          ,le.corp_orig_bus_type_cd_ALLOW_ErrorCount,le.corp_orig_bus_type_cd_LENGTH_ErrorCount
          ...
          ,le.cont_effective_date_ALLOW_ErrorCount,le.cont_effective_date_CUSTOM_ErrorCount
