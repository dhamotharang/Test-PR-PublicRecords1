...
SALT34.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),287*287,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{113,'corp_prep_addr1_line1'}
      ,{114,'corp_prep_addr1_last_line'}
      ,{115,'corp_prep_addr2_line1'}
      ,{116,'corp_prep_addr2_last_line'}
      ,{117,'ra_prep_addr_line1'}
      ,{118,'ra_prep_addr_last_line'}
      ,{119,'cont_filing_reference_nbr'}
      ,{120,'cont_filing_date'}
      ,{121,'cont_filing_cd'}
      ,{122,'cont_filing_desc'}
      ,{123,'cont_type_cd'}
      ,{124,'cont_type_desc'}
      ,{125,'cont_full_name'}
      ,{126,'cont_fname'}
      ...
      ,{128,'cont_lname'}
      ,{129,'cont_suffix'}
      ,{130,'cont_title1_desc'}
      ,{131,'cont_title2_desc'}
      ,{132,'cont_title3_desc'}
      ,{133,'cont_title4_desc'}
      ,{134,'cont_title5_desc'}
      ,{135,'cont_fein'}
      ,{136,'cont_ssn'}
      ,{137,'cont_dob'}
      ,{138,'cont_status_cd'}
      ,{139,'cont_status_desc'}
      ,{140,'cont_effective_date'}
      ,{141,'cont_effective_cd'}
      ,{142,'cont_effective_desc'}
      ,{143,'cont_addl_info'}
      ,{144,'cont_address_type_cd'}
      ,{145,'cont_address_type_desc'}
      ,{146,'cont_address_line1'}
      ,{147,'cont_address_line2'}
      ,{148,'cont_address_line3'}
      ,{149,'cont_address_effective_date'}
      ,{150,'cont_address_county'}
      ,{151,'cont_phone_number'}
      ,{152,'cont_phone_number_type_cd'}
      ,{153,'cont_phone_number_type_desc'}
      ,{154,'cont_fax_nbr'}
      ,{155,'cont_email_address'}
      ,{156,'cont_web_address'}
      ,{157,'corp_acres'}
      ,{158,'corp_action'}
      ,{159,'corp_action_date'}
      ,{160,'corp_action_employment_security_approval_date'}
      ,{161,'corp_action_pending_cd'}
      ,{162,'corp_action_pending_desc'}
      ,{163,'corp_action_statement_of_intent_date'}
      ,{164,'corp_action_tax_dept_approval_date'}
      ,{165,'corp_acts2'}
      ,{166,'corp_acts3'}
      ,{167,'corp_additional_principals'}
      ,{168,'corp_address_office_type'}
      ,{169,'corp_agent_assign_date'}
      ...
      ,{175,'corp_agent_id'}
      ,{176,'corp_agriculture_flag'}
      ,{177,'corp_authorized_partners'}
      ,{178,'corp_comment'}
      ,{179,'corp_consent_flag_for_protected_name'}
      ,{180,'corp_converted'}
      ,{181,'corp_converted_from'}
      ,{182,'corp_country_of_formation'}
      ,{183,'corp_date_of_organization_meeting'}
      ,{184,'corp_delayed_effective_date'}
      ,{185,'corp_directors_from_to'}
      ,{186,'corp_dissolved_date'}
      ,{187,'corp_farm_exemptions'}
      ,{188,'corp_farm_qual_date'}
      ,{189,'corp_farm_status_cd'}
      ,{190,'corp_farm_status_date'}
      ...
      ,{195,'corp_has_members'}
      ,{196,'corp_has_vested_managers'}
      ,{197,'corp_home_incorporated_county'}
      ,{198,'corp_home_state_name'}
      ,{199,'corp_is_professional'}
      ,{200,'corp_is_non_profit_irs_approved'}
      ,{201,'corp_last_renewal_date'}
      ,{202,'corp_last_renewal_year'}
      ,{203,'corp_license_type'}
      ,{204,'corp_llc_managed_desc'}
      ,{205,'corp_llc_managed_ind'}
      ,{206,'corp_management_desc'}
      ,{207,'corp_management_type'}
      ,{208,'corp_manager_managed'}
      ,{209,'corp_merged_corporation_id'}
      ,{210,'corp_merged_fein'}
      ,{211,'corp_merger_allowed_flag'}
      ,{212,'corp_merger_date'}
      ,{213,'corp_merger_desc'}
      ,{214,'corp_merger_effective_date'}
      ,{215,'corp_merger_id'}
      ,{216,'corp_merger_indicator'}
      ,{217,'corp_merger_name'}
      ,{218,'corp_merger_type_converted_to_cd'}
      ,{219,'corp_merger_type_converted_to_desc'}
      ,{220,'corp_naics_desc'}
      ,{221,'corp_name_effective_date'}
      ,{222,'corp_name_reservation_date'}
      ,{223,'corp_name_reservation_desc'}
      ...
      ,{287,'recordorigin'}],SALT34.MAC_Character_Counts.Field_Identification);
...
END;
Errors := NORMALIZE(h,287,NoteErrors(LEFT,COUNTER));
