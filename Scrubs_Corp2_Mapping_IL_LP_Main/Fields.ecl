...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_type_cd','invalid_term_exist_cd','invalid_term_exist_desc','invalid_address_type_cd','invalid_address_type_desc','invalid_for_dom_ind','invalid_for_profit_ind','invalid_recordorigin','invalid_alphablankperiod','invalid_alphablank','invalid_status_desc','invalid_numblank');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_supp_key' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_charter_nbr' => 8,'invalid_type_cd' => 9,'invalid_term_exist_cd' => 10,'invalid_term_exist_desc' => 11,'invalid_address_type_cd' => 12,'invalid_address_type_desc' => 13,'invalid_for_dom_ind' => 14,'invalid_for_profit_ind' => 15,'invalid_recordorigin' => 16,'invalid_alphablankperiod' => 17,'invalid_alphablank' => 18,'invalid_status_desc' => 19,'invalid_numblank' => 20,0);
 
EXPORT MakeFT_invalid_corp_key(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'-CLPS0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'-CLPS0123456789'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('-CLPS0123456789'),SALT34.HygieneErrors.NotLength('4..'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['17']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('17'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['IL']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('IL'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_charter_nbr(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'CS0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'CS0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('CS0123456789'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['01','06','08','P',' ']);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('01|06|08|P| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_address_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['B','R','T',' ']);
EXPORT InValidMessageFT_invalid_address_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('B|R|T| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['BUSINESS','REGISTERED OFFICE','CONTACT',' ']);
EXPORT InValidMessageFT_invalid_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('BUSINESS|REGISTERED OFFICE|CONTACT| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_for_profit_ind(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_profit_ind(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['N','P',' ']);
EXPORT InValidMessageFT_invalid_for_profit_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('N|P| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_desc(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_status_desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' ()-ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' ()-ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT InValid_corp_ln_name_type_cd(SALT34.StrType s) := InValidFT_invalid_type_cd(s);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_type_cd(wh);
 
EXPORT Make_corp_ln_name_type_desc(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_ln_name_type_desc(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_ln_name_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
...
EXPORT InValid_corp_address1_type_cd(SALT34.StrType s) := InValidFT_invalid_address_type_cd(s);
...
EXPORT InValid_corp_address1_type_desc(SALT34.StrType s) := InValidFT_invalid_address_type_desc(s);
...
EXPORT Make_corp_filing_cd(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_filing_cd(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_filing_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
 
EXPORT Make_corp_filing_desc(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_filing_desc(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_filing_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
 
EXPORT Make_corp_status_cd(SALT34.StrType s0) := MakeFT_invalid_numblank(s0);
EXPORT InValid_corp_status_cd(SALT34.StrType s) := InValidFT_invalid_numblank(s);
EXPORT InValidMessage_corp_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_numblank(wh);
...
EXPORT Make_corp_inc_county(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_inc_county(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_corp_orig_org_structure_desc(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_corp_orig_bus_type_cd(SALT34.StrType s0) := MakeFT_invalid_numblank(s0);
EXPORT InValid_corp_orig_bus_type_cd(SALT34.StrType s) := InValidFT_invalid_numblank(s);
EXPORT InValidMessage_corp_orig_bus_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_numblank(wh);
...
EXPORT InValid_corp_ra_address_type_cd(SALT34.StrType s) := InValidFT_invalid_address_type_cd(s);
...
EXPORT InValid_corp_ra_address_type_desc(SALT34.StrType s) := InValidFT_invalid_address_type_desc(s);
...
EXPORT Make_cont_effective_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_cont_effective_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_cont_effective_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
EXPORT Make_cont_address_type_cd(SALT34.StrType s0) := MakeFT_invalid_address_type_cd(s0);
EXPORT InValid_cont_address_type_cd(SALT34.StrType s) := InValidFT_invalid_address_type_cd(s);
EXPORT InValidMessage_cont_address_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_cd(wh);
 
EXPORT Make_cont_address_type_desc(SALT34.StrType s0) := MakeFT_invalid_address_type_desc(s0);
EXPORT InValid_cont_address_type_desc(SALT34.StrType s) := InValidFT_invalid_address_type_desc(s);
EXPORT InValidMessage_cont_address_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_desc(wh);
...
EXPORT Make_corp_agent_county(SALT34.StrType s0) := MakeFT_invalid_alphablankperiod(s0);
EXPORT InValid_corp_agent_county(SALT34.StrType s) := InValidFT_invalid_alphablankperiod(s);
EXPORT InValidMessage_corp_agent_county(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablankperiod(wh);
...
EXPORT Make_corp_name_status_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_name_status_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_name_status_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_IL_LP_Main;
