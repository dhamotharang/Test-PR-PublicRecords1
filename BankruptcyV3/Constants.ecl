EXPORT Constants(string filedate = '', boolean isFCRA = false) := module
	...
	export fields_to_clear := module
		...
		// export search_tmsid_linkids	:= 'datetransferred,holdcase,orig_email,orig_fax,phone,screen,tax_id';
		export search_tmsid_linkids	:= 'datetransferred,holdcase,orig_email,orig_fax,phone,screen';
