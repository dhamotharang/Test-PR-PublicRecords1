...
export Key_BocaShell_bkruptV3 := index(bankrupt_slim, {did}, {bankrupt_slim}, '~thor_data400::key::bankruptcyv3::bocashell_did_' + doxie.Version_SuperKey);
