...
#workunit('name','Scrubs_HeaderSlimSortSrc_Monthly.BWR_Scrubs - Checking field validity in a file - SALT V3.9.0');
IMPORT Scrubs_HeaderSlimSortSrc_Monthly,SALT39;
infile := Scrubs_HeaderSlimSortSrc_Monthly.In_File;
mod_scrubs := Scrubs_HeaderSlimSortSrc_Monthly.Scrubs;
