...
export fSpray(string version, boolean pUseProd = false)	:=	DATASET([
 	...
 	,'/hds_180/alloy_consumer/'+version[..8]+'/'            //SourceDirectory	 Absolute path of directory on Remote Server where files are located                
 	...
 	,'thor400_92'                                       //Thor Group name, ex. 'thor_data400' = dataland400, 'thor_dell400' = prod400(default)
