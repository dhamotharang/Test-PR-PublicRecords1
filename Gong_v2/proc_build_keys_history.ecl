import Gong,Gong_v2,doxie_files, ut, doxie,RoxieKeyBuild,DayBatchEda,EDA_VIA_XML,risk_indicators,doxie_cbrs;

export proc_build_keys_history(rundate,outfile) := macro
...
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Address
					  ,Gong_v2.thor_cluster+'key::gongv2_history_address'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::address'
					  ,%bk_addr%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Phone
					  ,Gong_v2.thor_cluster+'key::gongv2_history_phone'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::phone'
					  ,%bk_phone%);
								 
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Did
				      ,Gong_v2.thor_cluster+'key::gongv2_history_did'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::did'
					  ,%bk_did%);
								  
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Hhid
				      ,Gong_v2.thor_cluster+'key::gongv2_history_hhid'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::hhid'
					  ,%bk_hhid%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_BDID
                      ,Gong_v2.thor_cluster+'key::gongv2_hist_bdid'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::bdid'
					  ,%bk_bdid%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Name
				      ,Gong_v2.thor_cluster+'key::gongv2_history_name'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::name'
					  ,%bk_name%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.key_history_zip_name
                      ,Gong_v2.thor_cluster+'key::gongv2_history_zip_name'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::zip_name'
					  ,%bk_zip_name%);
					 
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.key_history_npa_nxx_line
                      ,Gong_v2.thor_cluster+'key::gongv2_history_npa_nxx_line'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::npa_nxx_line'
					  ,%bk_npa_nxx_line%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.Key_History_Surname
				      ,Gong_v2.thor_cluster+'key::gongv2_history::qa::surname'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::surname'
					  ,%bk_surname%);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(relocations.Key_wdtgGong_v2
				      ,Gong_v2.thor_cluster+'key::gongv2_history_wdtg'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::wdtg'
					  ,%bk_wdtg%);
					  
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong_v2.key_history_companyname
					  ,Gong_v2.thor_cluster+'key::gongv2_history_companyname'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::companyname'
					  ,%bk_cmp_name%);
...
#uniquename(mv2blt_name)
#uniquename(mv2blt_zip_name)
#uniquename(mv2blt_npa_nxx_line)
#uniquename(mv2blt_surname)
#uniquename(mv2blt_wdtg)
#uniquename(mv2blt_cmp_name)
...
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_address'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::address'
					  ,%mv2blt_addr%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_phone'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::phone'
					  ,%mv2blt_phone%);
								 
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_did'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::did'
					  ,%mv2blt_did%);
								  
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_hhid'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::hhid'
					  ,%mv2blt_hhid%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_hist_bdid'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::bdid'
					  ,%mv2blt_bdid%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_name'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::name'
					  ,%mv2blt_name%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_zip_name'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::zip_name'
					  ,%mv2blt_zip_name%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_npa_nxx_line'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::npa_nxx_line'
					  ,%mv2blt_npa_nxx_line%);
					  
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_surname'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::surname'
					  ,%mv2blt_surname%);

RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_wdtg'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::wdtg'
					  ,%mv2blt_wdtg%);
					  
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Gong_v2.thor_cluster+'key::gongv2_history_companyname'
					  ,Gong_v2.thor_cluster+'key::gongv2_history::'+rundate+'::companyname'
					  ,%mv2blt_cmp_name%);
...
#uniquename(mv2qa_name)
#uniquename(mv2qa_zip_name)
#uniquename(mv2qa_npa_nxx_line)
#uniquename(mv2qa_surname)
#uniquename(mv2qa_wdtg)
#uniquename(mv2qa_cmp_name)
