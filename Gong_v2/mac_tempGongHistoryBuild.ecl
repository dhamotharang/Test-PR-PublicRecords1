export mac_tempGongHistoryBuild(update_file,update_date,outfile) := macro
...
Gong.proc_build_full_keys(update_date,out1);
Gong.proc_build_history_keys(update_date,out2);

outfile:=
sequential(
output(%history_with_count%,,'~thor_200::base::gong_history'+ update_date,__compressed__,overwrite),
