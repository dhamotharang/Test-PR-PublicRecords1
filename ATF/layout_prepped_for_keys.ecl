//05-09-2013:  BID and BID_score must remain based on BUG 122948.  Comments in BUG 123607 can also be referenced.

export layout_prepped_for_keys:=record
  unsigned4 seq;
  string12 license1_did;
	string9  best_ssn;
  string12 license1_bdid;
  string12 license2_did;
	string9  best_ssn2;
  string12 license2_bdid;
