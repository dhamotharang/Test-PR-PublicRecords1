...
import doxie, drivers, ut, doxie_files, business_header, doxie_build, mdr, suppress;
...
// ***** Call Batch Function
from_batch := UNGROUP(doxie_raw.Veh_Raw_batch(for_batch, , IsCRS, ExcludeLessors, include_non_regulated_data)(VEHICLE_NUMBERxBG1<>''));
