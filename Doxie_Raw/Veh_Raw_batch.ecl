...
F11 := if(mod_access.isConsumer(), F11_veh_info_supressed, F11_veh_info);

//***** Use the seq_nos to get the veh info
FT := PROJECT(Vehiclev2_services.Fn_Find(F11,mod_access,TRUE,excludelessors,,,include_non_regulated_data),outrec);
