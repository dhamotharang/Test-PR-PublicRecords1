...
export Key_BocaShell_bkruptV2 := index(bankrupt_slim, {did}, {bankrupt_slim}, data_services.data_location.prefix('bankruptcyv2') + 'thor_data400::key::bankruptcyv2::bocashell_did_' + doxie.Version_SuperKey);