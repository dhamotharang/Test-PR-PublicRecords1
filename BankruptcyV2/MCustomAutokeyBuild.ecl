import autokeyi, doxie, RoxieKeyBuild, autokey;

export MCustomAutokeyBuild := module
	...
	//***** INDEX BUILD CODE		
		export keybuild(params in_mod) := function
			...
			key := INDEX(recs_ddp, {recs}, in_mod.L_inkeyname + '::' + doxie.Version_SuperKey + '::');
			RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(	key, 
																									'', 
