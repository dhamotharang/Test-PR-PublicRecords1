...
import RoxieKeyBuild,BankruptcyV3;
...
buildkeys := sequential(parallel
								(	//bk_MID_key,bk_SID_key, bk_DID_key,bk_BDID_key,bk_ssn_key,bk_taxID_key,bk_case_number_key, bk_bocashell_did_key,
									...
									bk_ssn4st_fcra_key_V3,bk_fcra_main_supp_key_V3,bk_fcra_bocashell_key_V3
									// ,bk_ssnmatch_key_V3
						...
						parallel
								(
									...
									mv_ssn4st_fcra_key_V3,mv_fcra_main_supp_key_V3,mv_fcra_bocashell_key_V3
									// ,mv_ssnmatch_key_V3
