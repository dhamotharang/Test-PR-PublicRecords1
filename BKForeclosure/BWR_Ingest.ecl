...
#workunit('name','BKForeclosure.BWR_Ingest - Ingest - SALT V3.11.6');
IMPORT BKForeclosure,SALT311;
//If you are not ingesting as part of a header build you can use the below;
//Set incremental to TRUE to run an incremental ingest mode
MyDelta := DATASET([],BKForeclosure.Layout_BKForeclosure);
ingestMod := BKForeclosure.Ingest(FALSE, MyDelta);
f_AllRecords := '~temp::record_id::BKForeclosure::ingest::AllRecords';
f_ActiveRecords := '~temp::record_id::BKForeclosure::ingest::ActiveRecords';
