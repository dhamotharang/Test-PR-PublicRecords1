...
export Proc_Build_REO_Autokeys(string filedate) :=
function
inkey  := '~thor_data400::key::bkforeclosure_reo::autokey::QA::';
inkeyB := '~thor_data400::key::bkforeclosure_reo::autokey::BUILT::';
...
if(fileservices.superfileexists(inkeyb + 'SSN2'),
	...
	ak_keyname  := c.ak_reo_keyname;
	ak_logical  := c.ak_reo_logical;
	ak_dataset  := c.ak_reo_dataset;
	ak_skipSet  := c.ak_reo_skipSet;
	ak_typeStr  := c.ak_reo_typeStr;
