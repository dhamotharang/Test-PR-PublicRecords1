...
base_in	:= BKForeclosure.File_BK_Foreclosure.fNod;

//Transform to flatten layout
BKForeclosure.Layout_BK.base_nod_ext extNOD(base_in L) := TRANSFORM
	...
	pExtBase	:= PROJECT(base_in, extNOD(LEFT));

EXPORT NOD_In_BKForeclosure := pExtBase;