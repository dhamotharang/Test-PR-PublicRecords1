...
EXPORT Denorm_REO (DATASET(Layout_BK.base_reo_ext) Base_reo, DATASET(Layout_BK.CleanFields_REO) Norm_reo) := FUNCTION

//Project base back into original layout
Layout_BK.base_reo SlimBase(Base_reo L) := TRANSFORM
	...
	SELF.name7.dotid			:= L.name7_dotid;
	SELF.name7.dotscore		:= L.name7_dotscore;
	SELF.name7.dotweight	:= L.name7_dotweight;
	SELF.name7.empid			:= L.name7_empid;
	SELF.name7.empscore		:= L.name7_empscore;
	SELF.name7.empweight	:= L.name7_empweight;
	SELF.name7.powid			:= L.name7_powid;
	SELF.name7.powscore		:= L.name7_powscore;
	SELF.name7.powweight	:= L.name7_powweight;
	SELF.name7.proxid			:= L.name7_proxid;
	SELF.name7.proxscore	:= L.name7_proxscore;
	SELF.name7.proxweight	:= L.name7_proxweight;
	SELF.name7.seleid			:= L.name7_seleid;
	SELF.name7.selescore	:= L.name7_selescore;
	SELF.name7.seleweight	:= L.name7_seleweight;
	SELF.name7.orgid			:= L.name7_orgid;
	SELF.name7.orgscore		:= L.name7_orgscore;
	SELF.name7.orgweight	:= L.name7_orgweight;
	SELF.name7.ultid			:= L.name7_ultid;
	SELF.name7.ultscore		:= L.name7_ultscore;
	SELF.name7.ultweight	:= L.name7_ultweight;
	SELF.name8.dotid			:= L.name8_dotid;
	SELF.name8.dotscore		:= L.name8_dotscore;
	SELF.name8.dotweight	:= L.name8_dotweight;
	SELF.name8.empid			:= L.name8_empid;
	SELF.name8.empscore		:= L.name8_empscore;
	SELF.name8.empweight	:= L.name8_empweight;
	SELF.name8.powid			:= L.name8_powid;
	SELF.name8.powscore		:= L.name8_powscore;
	SELF.name8.powweight	:= L.name8_powweight;
	SELF.name8.proxid			:= L.name8_proxid;
	SELF.name8.proxscore	:= L.name8_proxscore;
	SELF.name8.proxweight	:= L.name8_proxweight;
	SELF.name8.seleid			:= L.name8_seleid;
	SELF.name8.selescore	:= L.name8_selescore;
	SELF.name8.seleweight	:= L.name8_seleweight;
	SELF.name8.orgid			:= L.name8_orgid;
	SELF.name8.orgscore		:= L.name8_orgscore;
	SELF.name8.orgweight	:= L.name8_orgweight;
	SELF.name8.ultid			:= L.name8_ultid;
...
Layout_BK.base_reo denormalizeRecords(Layout_BK.base_reo l, Layout_BK.CleanFields_REO r) := TRANSFORM
		...
		SELF.name1_middle			:= IF(r.Name_Type = 'B1', r.cln_mname, l.name1_middle);
		...
		SELF.name1_bdid_score := IF(r.Name_Type = 'B1', (string)r.bdid_score, l.name1_bdid_score);
		SELF.name1.DotID		  := IF(r.Name_Type = 'B1', r.DotID, 		  l.name1.DotID);
		SELF.name1.DotScore		:= IF(r.Name_Type = 'B1', r.DotScore,	  l.name1.DotScore);
		SELF.name1.DotWeight	:= IF(r.Name_Type = 'B1', r.DotWeight,  l.name1.DotWeight);
		SELF.name1.EmpID		  := IF(r.Name_Type = 'B1', r.EmpID, 		  l.name1.EmpID);
		SELF.name1.EmpScore		:= IF(r.Name_Type = 'B1', r.EmpScore,   l.name1.EmpScore);
		SELF.name1.EmpWeight	:= IF(r.Name_Type = 'B1', r.EmpWeight,  l.name1.EmpWeight);
		SELF.name1.POWID		  := IF(r.Name_Type = 'B1', r.POWID, 		  l.name1.POWID);
		SELF.name1.POWScore		:= IF(r.Name_Type = 'B1', r.POWScore,   l.name1.POWScore);
		SELF.name1.POWWeight	:= IF(r.Name_Type = 'B1', r.POWWeight,  l.name1.POWWeight);
		SELF.name1.ProxID		  := IF(r.Name_Type = 'B1', r.ProxID, 	  l.name1.ProxID);
		SELF.name1.ProxScore	:= IF(r.Name_Type = 'B1', r.ProxScore,  l.name1.ProxScore);
		SELF.name1.ProxWeight	:= IF(r.Name_Type = 'B1', r.ProxWeight, l.name1.ProxWeight);
		SELF.name1.SeleID		  := IF(r.Name_Type = 'B1', r.SeleID, 	  l.name1.SeleID);
		SELF.name1.SeleScore	:= IF(r.Name_Type = 'B1', r.SeleScore,  l.name1.SeleScore);
		SELF.name1.SeleWeight	:= IF(r.Name_Type = 'B1', r.SeleWeight, l.name1.SeleWeight);	
		SELF.name1.OrgID		  := IF(r.Name_Type = 'B1', r.OrgID,			l.name1.OrgID);
		SELF.name1.OrgScore		:= IF(r.Name_Type = 'B1', r.OrgScore, 	l.name1.OrgScore);
		SELF.name1.OrgWeight	:= IF(r.Name_Type = 'B1', r.OrgWeight,  l.name1.OrgWeight);
		SELF.name1.UltID		  := IF(r.Name_Type = 'B1', r.UltID, 		 	l.name1.UltID);
		SELF.name1.UltScore		:= IF(r.Name_Type = 'B1', r.UltScore, 	l.name1.UltScore);
		SELF.name1.UltWeight	:= IF(r.Name_Type = 'B1', r.UltWeight,  l.name1.UltWeight);
		...
		SELF.name3_nid 				:= IF(r.Name_Type = 'B1' AND r.cln_fname2 <> '', r.nid, l.name3_nid);
		SELF.name3_prefix			:= IF(r.Name_Type = 'B1' AND r.cln_fname2 <> '', r.cln_title2, l.name3_prefix);
		SELF.name3_first			:= IF(r.Name_Type = 'B1' AND r.cln_fname2 <> '', r.cln_fname2, l.name3_first);
		SELF.name3_middle			:= IF(r.Name_Type = 'B1' AND r.cln_fname2 <> '', r.cln_mname2, l.name3_middle);
		...
		SELF.name5_nid 				:= IF(r.Name_Type = 'S1', r.nid, l.name5_nid);
		SELF.name5_prefix			:= IF(r.Name_Type = 'S1', r.cln_title, l.name5_prefix);
		SELF.name5_first			:= IF(r.Name_Type = 'S1', r.cln_fname, l.name5_first);
		SELF.name5_middle			:= IF(r.Name_Type = 'S1', r.cln_mname, l.name5_middle);
		...
		SELF.name5_bdid_score := IF(r.Name_Type = 'S1', (string)r.bdid_score, l.name5_bdid_score);
		SELF.name5.DotID		  := IF(r.Name_Type = 'S1', r.DotID, 		  l.name5.DotID);
		SELF.name5.DotScore		:= IF(r.Name_Type = 'S1', r.DotScore,	  l.name5.DotScore);
		SELF.name5.DotWeight	:= IF(r.Name_Type = 'S1', r.DotWeight,  l.name5.DotWeight);
		SELF.name5.EmpID		  := IF(r.Name_Type = 'S1', r.EmpID, 		  l.name5.EmpID);
		SELF.name5.EmpScore		:= IF(r.Name_Type = 'S1', r.EmpScore,   l.name5.EmpScore);
		SELF.name5.EmpWeight	:= IF(r.Name_Type = 'S1', r.EmpWeight,  l.name5.EmpWeight);
		SELF.name5.POWID		  := IF(r.Name_Type = 'S1', r.POWID, 		  l.name5.POWID);
		SELF.name5.POWScore		:= IF(r.Name_Type = 'S1', r.POWScore,   l.name5.POWScore);
		SELF.name5.POWWeight	:= IF(r.Name_Type = 'S1', r.POWWeight,  l.name5.POWWeight);
		SELF.name5.ProxID		  := IF(r.Name_Type = 'S1', r.ProxID, 	  l.name5.ProxID);
		SELF.name5.ProxScore	:= IF(r.Name_Type = 'S1', r.ProxScore,  l.name5.ProxScore);
		SELF.name5.ProxWeight	:= IF(r.Name_Type = 'S1', r.ProxWeight, l.name5.ProxWeight);
		SELF.name5.SeleID		  := IF(r.Name_Type = 'S1', r.SeleID, 	  l.name5.SeleID);
		SELF.name5.SeleScore	:= IF(r.Name_Type = 'S1', r.SeleScore,  l.name5.SeleScore);
		SELF.name5.SeleWeight	:= IF(r.Name_Type = 'S1', r.SeleWeight, l.name5.SeleWeight);	
		SELF.name5.OrgID		  := IF(r.Name_Type = 'S1', r.OrgID,			l.name5.OrgID);
		SELF.name5.OrgScore		:= IF(r.Name_Type = 'S1', r.OrgScore, 	l.name5.OrgScore);
		SELF.name5.OrgWeight	:= IF(r.Name_Type = 'S1', r.OrgWeight,  l.name5.OrgWeight);
		SELF.name5.UltID		  := IF(r.Name_Type = 'S1', r.UltID, 		 	l.name5.UltID);
		SELF.name5.UltScore		:= IF(r.Name_Type = 'S1', r.UltScore, 	l.name5.UltScore);
		SELF.name5.UltWeight	:= IF(r.Name_Type = 'S1', r.UltWeight,  l.name5.UltWeight);
		
		SELF.name6_nid 				:= IF(r.Name_Type = 'S2', r.nid, l.name6_nid);
		SELF.name6_prefix			:= IF(r.Name_Type = 'S2', r.cln_title, l.name6_prefix);
		SELF.name6_first			:= IF(r.Name_Type = 'S2', r.cln_fname, l.name6_first);
		SELF.name6_middle			:= IF(r.Name_Type = 'S2', r.cln_mname, l.name6_middle);
		...
		SELF.name6_bdid_score := IF(r.Name_Type = 'S2', (string)r.bdid_score, l.name6_bdid_score);
		SELF.name6.DotID		  := IF(r.Name_Type = 'S2', r.DotID, 		  l.name6.DotID);
		SELF.name6.DotScore		:= IF(r.Name_Type = 'S2', r.DotScore,	  l.name6.DotScore);
		SELF.name6.DotWeight	:= IF(r.Name_Type = 'S2', r.DotWeight,  l.name6.DotWeight);
		SELF.name6.EmpID		  := IF(r.Name_Type = 'S2', r.EmpID, 		  l.name6.EmpID);
		SELF.name6.EmpScore		:= IF(r.Name_Type = 'S2', r.EmpScore,   l.name6.EmpScore);
		SELF.name6.EmpWeight	:= IF(r.Name_Type = 'S2', r.EmpWeight,  l.name6.EmpWeight);
		SELF.name6.POWID		  := IF(r.Name_Type = 'S2', r.POWID, 		  l.name6.POWID);
		SELF.name6.POWScore		:= IF(r.Name_Type = 'S2', r.POWScore,   l.name6.POWScore);
		SELF.name6.POWWeight	:= IF(r.Name_Type = 'S2', r.POWWeight,  l.name6.POWWeight);
		SELF.name6.ProxID		  := IF(r.Name_Type = 'S2', r.ProxID, 	  l.name6.ProxID);
		SELF.name6.ProxScore	:= IF(r.Name_Type = 'S2', r.ProxScore,  l.name6.ProxScore);
		SELF.name6.ProxWeight	:= IF(r.Name_Type = 'S2', r.ProxWeight, l.name6.ProxWeight);
		SELF.name6.SeleID		  := IF(r.Name_Type = 'S2', r.SeleID, 	  l.name6.SeleID);
		SELF.name6.SeleScore	:= IF(r.Name_Type = 'S2', r.SeleScore,  l.name6.SeleScore);
		SELF.name6.SeleWeight	:= IF(r.Name_Type = 'S2', r.SeleWeight, l.name6.SeleWeight);	
		SELF.name6.OrgID		  := IF(r.Name_Type = 'S2', r.OrgID,			l.name6.OrgID);
		SELF.name6.OrgScore		:= IF(r.Name_Type = 'S2', r.OrgScore, 	l.name6.OrgScore);
		SELF.name6.OrgWeight	:= IF(r.Name_Type = 'S2', r.OrgWeight,  l.name6.OrgWeight);
		SELF.name6.UltID		  := IF(r.Name_Type = 'S2', r.UltID, 		 	l.name6.UltID);
		SELF.name6.UltScore		:= IF(r.Name_Type = 'S2', r.UltScore, 	l.name6.UltScore);
		SELF.name6.UltWeight	:= IF(r.Name_Type = 'S2', r.UltWeight,  l.name6.UltWeight);
		
		SELF.name7_nid 				:= IF(r.Name_Type = 'S1' AND r.cln_fname2 <> '', r.nid, l.name7_nid);
		SELF.name7_prefix			:= IF(r.Name_Type = 'S1' AND r.cln_fname2 <> '', r.cln_title2, l.name7_prefix);
		SELF.name7_first			:= IF(r.Name_Type = 'S1' AND r.cln_fname2 <> '', r.cln_fname2, l.name7_first);
		SELF.name7_middle			:= IF(r.Name_Type = 'S1' AND r.cln_fname2 <> '', r.cln_mname2, l.name7_middle);
		...
		SELF.name7_bdid_score := '0';
		SELF.name7.DotID		  := 0;
		SELF.name7.DotScore		:= 0;
		SELF.name7.DotWeight	:= 0;
		SELF.name7.EmpID		  := 0;
		SELF.name7.EmpScore		:= 0;
		SELF.name7.EmpWeight	:= 0;
		SELF.name7.POWID		  := 0;
		SELF.name7.POWScore		:= 0;
		SELF.name7.POWWeight	:= 0;
		SELF.name7.ProxID		  := 0;
		SELF.name7.ProxScore	:= 0;
		SELF.name7.ProxWeight	:= 0;
		SELF.name7.SeleID		  := 0;
		SELF.name7.SeleScore	:= 0;
		SELF.name7.SeleWeight	:= 0;	
		SELF.name7.OrgID		  := 0;
		SELF.name7.OrgScore		:= 0;
		SELF.name7.OrgWeight	:= 0;
		SELF.name7.UltID		  := 0;
		SELF.name7.UltScore		:= 0;
		SELF.name7.UltWeight	:= 0;
		
		SELF.name8_nid 				:= IF(r.Name_Type = 'S2' AND r.cln_fname2 <> '', r.nid, l.name8_nid);
		SELF.name8_prefix			:= IF(r.Name_Type = 'S2' AND r.cln_fname2 <> '', r.cln_title2, l.name8_prefix);
		SELF.name8_first			:= IF(r.Name_Type = 'S2' AND r.cln_fname2 <> '', r.cln_fname2, l.name8_first);
		SELF.name8_middle			:= IF(r.Name_Type = 'S2' AND r.cln_fname2 <> '', r.cln_mname2, l.name8_middle);
		...
		SELF.name8_bdid_score := '0';
		SELF.name8.DotID		  := 0;
		SELF.name8.DotScore		:= 0;
		SELF.name8.DotWeight	:= 0;
		SELF.name8.EmpID		  := 0;
		SELF.name8.EmpScore		:= 0;
		SELF.name8.EmpWeight	:= 0;
		SELF.name8.POWID		  := 0;
		SELF.name8.POWScore		:= 0;
		SELF.name8.POWWeight	:= 0;
		SELF.name8.ProxID		  := 0;
		SELF.name8.ProxScore	:= 0;
		SELF.name8.ProxWeight	:= 0;
		SELF.name8.SeleID		  := 0;
		SELF.name8.SeleScore	:= 0;
		SELF.name8.SeleWeight	:= 0;	
		SELF.name8.OrgID		  := 0;
		SELF.name8.OrgScore		:= 0;
		SELF.name8.OrgWeight	:= 0;
		SELF.name8.UltID		  := 0;
		SELF.name8.UltScore		:= 0;
		SELF.name8.UltWeight	:= 0;
