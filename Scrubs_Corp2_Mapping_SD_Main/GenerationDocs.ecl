...
Command line options: -MScrubs_Corp2_Mapping_SD_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR401F.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_SD_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(46)
FIELDTYPE:invalid_state_origin:ENUM(SD)
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_SD_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_flag_code:ENUM(N| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|DBA|REGISTRATION|RESERVED)
...
FIELDTYPE:invalid_status_code:ENUM(D|I|S|V|G| )
FIELDTYPE:invalid_status_desc:ENUM(DELINQUENT|INACTIVE|DISSOLVED|REVOKED|GOOD STANDING| )
FIELDTYPE:invalid_FARM_status_code:ENUM(D|I|G|C| )
FIELDTYPE:invalid_FARM_status_desc:ENUM(DELINQUENT|INACTIVE|GOOD STANDING|CANCELLATION PENDING| )
FIELDTYPE:invalid_org_struc_cd:ENUM(Scrubs_Corp2_Mapping_SD_Main.Functions.set_valid_orgStruc_codes)
FIELDTYPE:invalid_recordorigin:ENUM(C)
...
FIELD:corp_farm_status_cd:TYPE(STRING1):LIKE(invalid_FARM_status_code):0,0
FIELD:corp_farm_status_desc:TYPE(STRING100):LIKE(invalid_FARM_status_desc):0,0
