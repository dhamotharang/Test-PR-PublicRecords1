...
EXPORT MakeFT_invalid_corp_vendor(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['46']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('46'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['SD']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('SD'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT38.StrType s,SALT38.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SD_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SD_Main.Functions.invalid_name_type_code'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_flag_code(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['N',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('N| '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['LEGAL','DBA','REGISTRATION','RESERVED']);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('LEGAL|DBA|REGISTRATION|RESERVED'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_numeric(SALT38.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numeric(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_numeric(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('0123456789'),SALT38.HygieneErrors.NotLength('1..'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphablank(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,' ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphablank(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,' ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphablank(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars(' ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_code(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_code(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['D','I','S','V','G',' ']);
EXPORT InValidMessageFT_invalid_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('D|I|S|V|G| '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_desc(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_desc(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['DELINQUENT','INACTIVE','DISSOLVED','REVOKED','GOOD STANDING',' ']);
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('DELINQUENT|INACTIVE|DISSOLVED|REVOKED|GOOD STANDING| '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_FARM_status_code(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_FARM_status_code(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['D','I','G','C',' ']);
EXPORT InValidMessageFT_invalid_FARM_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('D|I|G|C| '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_FARM_status_desc(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_FARM_status_desc(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['DELINQUENT','INACTIVE','GOOD STANDING','CANCELLATION PENDING',' ']);
EXPORT InValidMessageFT_invalid_FARM_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('DELINQUENT|INACTIVE|GOOD STANDING|CANCELLATION PENDING| '),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_struc_cd(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_struc_cd(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN Scrubs_Corp2_Mapping_SD_Main.Functions.set_valid_orgStruc_codes);
EXPORT InValidMessageFT_invalid_org_struc_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_SD_Main.Functions.set_valid_orgStruc_codes'),SALT38.HygieneErrors.Good);
...
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','CUSTOM','LENGTH'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','LENGTH'],[],['ENUM'],[],[],['ENUM'],['ALLOW','CUSTOM','LENGTH'],['ALLOW','LENGTH'],['LENGTH'],['CUSTOM'],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ENUM'],['ENUM'],['ALLOW','CUSTOM','LENGTH'],[],[],[],[],['ENUM'],[],['ALLOW','CUSTOM','LENGTH'],[],[],[],[],[],[],['ENUM'],['ALLOW'],[],[],['ALLOW','CUSTOM','LENGTH'],[],[],[],[],[],['ENUM'],[],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW','CUSTOM','LENGTH'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ENUM'],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ENUM'],['ALLOW'],[]);
...
EXPORT Make_corp_status_cd(SALT38.StrType s0) := MakeFT_invalid_status_code(s0);
EXPORT InValid_corp_status_cd(SALT38.StrType s) := InValidFT_invalid_status_code(s);
...
EXPORT Make_corp_status_date(SALT38.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_status_date(SALT38.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_forgn_state_cd(SALT38.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_forgn_state_cd(SALT38.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT38.StrType s0) := MakeFT_invalid_org_struc_cd(s0);
EXPORT InValid_corp_orig_org_structure_cd(SALT38.StrType s) := InValidFT_invalid_org_struc_cd(s);
EXPORT InValidMessage_corp_orig_org_structure_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_org_struc_cd(wh);
 
EXPORT Make_corp_orig_org_structure_desc(SALT38.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_desc(SALT38.StrType s) := 0;
...
EXPORT Make_corp_agent_assign_date(SALT38.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_agent_assign_date(SALT38.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_farm_status_cd(SALT38.StrType s0) := MakeFT_invalid_FARM_status_code(s0);
EXPORT InValid_corp_farm_status_cd(SALT38.StrType s) := InValidFT_invalid_FARM_status_code(s);
EXPORT InValidMessage_corp_farm_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_FARM_status_code(wh);
 
EXPORT Make_corp_farm_status_desc(SALT38.StrType s0) := MakeFT_invalid_FARM_status_desc(s0);
EXPORT InValid_corp_farm_status_desc(SALT38.StrType s) := InValidFT_invalid_FARM_status_desc(s);
...
EXPORT Make_InternalField1(SALT38.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_InternalField1(SALT38.StrType s) := InValidFT_invalid_alphablank(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT38,Scrubs_Corp2_Mapping_SD_Main;
