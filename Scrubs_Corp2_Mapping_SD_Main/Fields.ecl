IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_SD_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter','invalid_corp_vendor','invalid_state_origin','invalid_name_type_code','invalid_forgn_dom_code','invalid_flag_code','invalid_name_type_desc','invalid_mandatory','invalid_numeric','invalid_alphablank','invalid_date','invalid_zip','invalid_status_code','invalid_status_desc','invalid_FARM_status_code','invalid_FARM_status_desc','invalid_org_struc_cd','invalid_recordorigin');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_name_type_code' => 5,'invalid_forgn_dom_code' => 6,'invalid_flag_code' => 7,'invalid_name_type_desc' => 8,'invalid_mandatory' => 9,'invalid_numeric' => 10,'invalid_alphablank' => 11,'invalid_date' => 12,'invalid_zip' => 13,'invalid_status_code' => 14,'invalid_status_desc' => 15,'invalid_FARM_status_code' => 16,'invalid_FARM_status_desc' => 17,'invalid_org_struc_cd' => 18,'invalid_recordorigin' => 19,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['46']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('46'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['SD']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('SD'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SD_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SD_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_flag_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['N',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('N| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['LEGAL','REGISTRATION','RESERVED']);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('LEGAL|REGISTRATION|RESERVED'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_code(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D','I','S','V','G',' ']);
EXPORT InValidMessageFT_invalid_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D|I|S|V|G| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['DELINQUENT','INACTIVE','DISSOLVED','REVOKED','GOOD STANDING',' ']);
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('DELINQUENT|INACTIVE|DISSOLVED|REVOKED|GOOD STANDING| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_FARM_status_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_FARM_status_code(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D','I','G','C',' ']);
EXPORT InValidMessageFT_invalid_FARM_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D|I|G|C| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_FARM_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_FARM_status_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['DELINQUENT','INACTIVE','GOOD STANDING','CANCELLATION PENDING',' ']);
EXPORT InValidMessageFT_invalid_FARM_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('DELINQUENT|INACTIVE|GOOD STANDING|CANCELLATION PENDING| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_struc_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_struc_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_SD_Main.Functions.set_valid_orgStruc_codes);
EXPORT InValidMessageFT_invalid_org_struc_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_SD_Main.Functions.set_valid_orgStruc_codes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_recordorigin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_recordorigin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['C']);
EXPORT InValidMessageFT_invalid_recordorigin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('C'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_agent_assign_date(SALT34.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_agent_assign_date(SALT34.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_farm_status_cd(SALT34.StrType s0) := MakeFT_invalid_FARM_status_code(s0);
EXPORT InValid_corp_farm_status_cd(SALT34.StrType s) := InValidFT_invalid_FARM_status_code(s);
EXPORT InValidMessage_corp_farm_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_FARM_status_code(wh);
 
EXPORT Make_corp_farm_status_desc(SALT34.StrType s0) := MakeFT_invalid_FARM_status_desc(s0);
EXPORT InValid_corp_farm_status_desc(SALT34.StrType s) := InValidFT_invalid_FARM_status_desc(s);
EXPORT InValidMessage_corp_farm_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_FARM_status_desc(wh);
...
EXPORT Make_InternalField1(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_InternalField1(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_SD_Main;
