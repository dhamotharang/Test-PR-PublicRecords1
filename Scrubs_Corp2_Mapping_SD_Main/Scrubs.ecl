...
EXPORT FromNone(DATASET(Layout_In_File) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_agent_assign_date_Invalid := Fields.InValid_corp_agent_assign_date((SALT34.StrType)le.corp_agent_assign_date);
    SELF.corp_farm_status_cd_Invalid := Fields.InValid_corp_farm_status_cd((SALT34.StrType)le.corp_farm_status_cd);
    SELF.corp_farm_status_desc_Invalid := Fields.InValid_corp_farm_status_desc((SALT34.StrType)le.corp_farm_status_desc);
