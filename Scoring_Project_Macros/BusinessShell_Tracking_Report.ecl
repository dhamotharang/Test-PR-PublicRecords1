...
// ******** END: SBFE MODE CALCULATIONS *********************************************************************************************************************
	...
	final := FileServices.SendEmail(Scoring_Project_DailyTracking.email_distribution.busshell_list_all, 'BusinessShell Tracking Report: MaxDiff ' + max_diff, XtabOut[COUNT(XtabOut)].line):
