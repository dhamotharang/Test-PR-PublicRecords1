...
EXPORT Regional_Acceptance_RVA1008_1_Macro (fcraroxie_IP,neutralroxie_IP, Thread, Timeout, Retry, Input_file_name,Output_file_name, records_ToRun):= functionmacro
...
// DRM := '00000000000101';
   ...
   DRM := Scoring_Project_PIP.User_Settings_Module.RV_Scores_XML_RegionalAcceptance_RVA1008_1_settings.DRM;  
	 DPPA := Scoring_Project_PIP.User_Settings_Module.RV_Scores_XML_RegionalAcceptance_RVA1008_1_settings.DPPA;
	 GLB := Scoring_Project_PIP.User_Settings_Module.RV_Scores_XML_RegionalAcceptance_RVA1008_1_settings.GLB;
...
// version 4 models
paramsA := dataset([{'Custom', 'RVA1008_1'}], models.Layout_Parameters);	// use this for non-version1 models, also possibly change the scores that you call below
...
dist_dataset := DISTRIBUTE(PROJECT(p_f,
																		TRANSFORM(layout_soap,
...
Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_RegionalAcceptance_RVA1008_1_V4_Global_Layout;			 
END;
...
Global_output_lay normit(resu L, dist_dataset R) := transform
	...
	// score fields 
	autoModel1 := l.models[1].scores(description='Auto' or description='AutoRVA10081' );
	autoModel2 := l.models[2].scores(description='Auto' or description='AutoRVA10081' );
	autoModel3 := l.models[3].scores(description='Auto' or description='AutoRVA10081' );
	autoModel4 := l.models[4].scores(description='Auto' or description='AutoRVA10081' );
	autoModel5 := l.models[5].scores(description='Auto' or description='AutoRVA10081' );
	autoModel6 := l.models[6].scores(description='Auto' or description='AutoRVA10081' );
