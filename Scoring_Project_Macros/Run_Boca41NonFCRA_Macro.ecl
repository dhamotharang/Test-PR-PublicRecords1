...
dt := ut.getdate;
 ...
 filenames_details1 :=  OUTPUT(nothor(STD.File.LogicalFileList('scoringqa::out::nonfcra::bocashell_41_historydate_999999_cert_*_1')),,'~scoringqa::out::nonfcra::bocashell_41_historydate_999999_cert_file_' + dt, thor, overwrite );
...
ds1 := dataset('~scoringqa::out::nonfcra::bocashell_41_historydate_999999_cert_file_'+ dt , lay1, thor);
...
c_file_name1 := filelist1[1].name[1..62] + curr_date ;
...
// seq:	WHEN(CRON('50 14 * * *')), 
 FAILURE(FileServices.SendEmail(Scoring_Project_DailyTracking.email_distribution.Bocashell_collections_fail_list,'BOCASHELL 4.1 NonFCRA Attributes Macro Call and Distribution Report failed','The failed workunit is:' + workunit + FailMessage));
