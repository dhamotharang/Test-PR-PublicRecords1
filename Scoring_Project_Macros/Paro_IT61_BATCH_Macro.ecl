 EXPORT Paro_IT61_BATCH_Macro (roxie_ip,Gateway_dummy, Thread, Timeout, Retry, Input_file_name,Output_file_name, records_ToRun):= functionmacro
...
it61_in := PROJECT(F, make_rv_in(LEFT, counter));
...
END;
	...
	Scoring_Project_Macros.MAC_PROD_BATCH_Soapcall(it61_in, Global_output_lay, roxieIP, 'RiskWise.IT1O_Batch_Service', it61_results, threads);
