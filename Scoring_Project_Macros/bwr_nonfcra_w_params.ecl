EXPORT bwr_nonfcra_w_params(STRING roxieIP, STRING gateway_ip, INTEGER no_of_threads, INTEGER no_of_recs_to_run, STRING filetag) := FUNCTION
...
// li_v4_attributes_batch_outFile_name_test := '~ScoringQA::out::NONFCRA::leadintegrity_batch_generic_attributes_v4'+  '_historydate_201207_' + ut.GetDate + filetag   ;
// LI_v4_attributes_batch_test := Scoring_Project_PIP.Input_Sample_Names.LI_v4_attributes_batch_test;  //  Scoring_Project_Macros.Test_LI_Attributes_V4_BATCH_Macro(roxieIP, gateway_ip,no_of_threads,Timeout,Retry_time,li_v4_attributes_batch_infile_name,li_v4_attributes_batch_outFile_name_test,no_of_recs_to_run);
...
iid_xml_infile_name := Scoring_Project_PIP.Input_Sample_Names.iid_xml_infile_name;  //  '~Scoring_Project::in::InstantID_XML_Generic_Version0_20141001';
...
//****** NEW IID INPUT *******
// iid_xml_infile_new := Scoring_Project_PIP.Input_Sample_Names.iid_xml_infile_new;  //  '~Scoring_Project::in::InstantID_Generic_Soat_Logs';
// iid_xml_outfile_new := '~ScoringQA::out::NONFCRA::NEW_instantid_xml_generic_' + ut.GetDate + '_' + filetag;

// iid_batch_infile_new := Scoring_Project_PIP.Input_Sample_Names.iid_batch_infile_new;  //  '~Scoring_Project::in::InstantID_Generic_Soat_Logs';
// iid_batch_outfile_new := '~ScoringQA::out::NONFCRA::NEW_instantid_batch_generic_' + ut.GetDate + '_' + filetag;
// iid_batch_outfile_new := '~ScoringQA::out::NONFCRA::NEW_instantid_batch_generic_' + ut.GetDate + '_' + filetag;
//****************************

/*
Scoring_Project_PIP.Input_Sample_Names
...
iid_xml_infile_name := '~Scoring_Project::in::InstantID_XML_Generic_Version0_20141001';
iid_xml_outfile_name := '~ScoringQA::out::NONFCRA::instantid_xml_generic'  + '_' + ut.GetDate + filetag;

iid_batch_infile_name := '~scoring_project::in::instantid_batch_generic_version0_20141013';
