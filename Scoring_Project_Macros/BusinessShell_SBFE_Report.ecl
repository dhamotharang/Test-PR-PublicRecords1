...
dset_curr1 := dataset('~scoring_project::businessshell_SBFE_stats_' + dt1_1, layout, thor);
dset_prev1 := dataset('~scoring_project::businessshell_SBFE_stats_' + dt2_1, layout, thor);
