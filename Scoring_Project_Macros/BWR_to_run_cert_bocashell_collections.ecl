...
parallel(Fcra_41, Fcra_50, Nonfcra_41, Nonfcra_50)
			: WHEN(CRON('30 9 * * *')), //4:30 am
			FAILURE(FileServices.SendEmail(Scoring_Project_DailyTracking.email_distribution.fail_list,'Cert Bocashell collections job failed.','The failed workunit is: ' + workunit + FailMessage))
			;