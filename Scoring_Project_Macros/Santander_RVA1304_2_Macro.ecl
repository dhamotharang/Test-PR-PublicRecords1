EXPORT Santander_RVA1304_2_Macro (fcraroxie_IP,neutralroxie_IP, Thread, Timeout, Retry, Input_file_name,Output_file_name, records_ToRun):= functionmacro
...
DPPA:=Scoring_Project_PIP.User_Settings_Module.RV_Scores_XML_Santander_1304_2_settings.DPPA;
GLB:=Scoring_Project_PIP.User_Settings_Module.RV_Scores_XML_Santander_1304_2_settings.GLB;
...
f := f1;  //Turn off when testing for one account number
...
// version 4 models
// model rva1007_2 changed to rva1304_2 as per nathan request 01/17/2014**************************************************************
//**************************************************************
paramsA := dataset([{'Custom', 'rva1304_2'}], models.Layout_Parameters);	// use this for non-version1 models, also possibly change the scores that you call below
...
Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_Santander_RVA1304_2_V3_Global_Layout;			 
END;
