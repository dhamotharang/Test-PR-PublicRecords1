...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_corp_term_exist_cd','invalid_corp_term_exist_desc','invalid_for_dom_ind','invalid_Y_N','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_org_structure_desc','invalid_alpha_spec','invalid_alpha','invalid_numeric','invalid_cont_title1_desc','invalid_recordorigin','invalid_internalfield1','invalid_internalfield2','invalid_internalfield3');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_corp_term_exist_cd' => 8,'invalid_corp_term_exist_desc' => 9,'invalid_for_dom_ind' => 10,'invalid_Y_N' => 11,'invalid_ln_name_type_cd' => 12,'invalid_ln_name_type_desc' => 13,'invalid_org_structure_desc' => 14,'invalid_alpha_spec' => 15,'invalid_alpha' => 16,'invalid_numeric' => 17,'invalid_cont_title1_desc' => 18,'invalid_recordorigin' => 19,'invalid_internalfield1' => 20,'invalid_internalfield2' => 21,'invalid_internalfield3' => 22,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['41']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('41'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['OR']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('OR'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_org_structure_desc(s)>0);
EXPORT InValidMessageFT_invalid_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_org_structure_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alpha_spec(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'.,&()/\'ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha_spec(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'.,&()/\'ABCDEFGHIJKLMNOPQRSTUVWXYZ '))));
EXPORT InValidMessageFT_invalid_alpha_spec(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('.,&()/\'ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_cont_title1_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_title1_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_cont_title1_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_cont_title1_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_cont_title1_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_internalfield1(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_internalfield1(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_associated_name_type(s)>0);
EXPORT InValidMessageFT_invalid_internalfield1(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_associated_name_type'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_internalfield2(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_internalfield2(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_name_type(s)>0);
EXPORT InValidMessageFT_invalid_internalfield2(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_name_type'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_internalfield3(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_internalfield3(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_bus_type(s)>0);
EXPORT InValidMessageFT_invalid_internalfield3(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_bus_type'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_filing_reference_nbr(SALT34.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_corp_filing_reference_nbr(SALT34.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_corp_filing_reference_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
...
EXPORT Make_corp_forgn_state_desc(SALT34.StrType s0) := MakeFT_invalid_alpha_spec(s0);
EXPORT InValid_corp_forgn_state_desc(SALT34.StrType s) := InValidFT_invalid_alpha_spec(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_spec(wh);
...
EXPORT Make_cont_title1_desc(SALT34.StrType s0) := MakeFT_invalid_cont_title1_desc(s0);
EXPORT InValid_cont_title1_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_cont_title1_desc(s,recordorigin);
...
EXPORT InValid_internalfield1(SALT34.StrType s) := InValidFT_invalid_internalfield1(s);
EXPORT InValidMessage_internalfield1(UNSIGNED1 wh) := InValidMessageFT_invalid_internalfield1(wh);
 
EXPORT Make_internalfield2(SALT34.StrType s0) := MakeFT_invalid_internalfield2(s0);
EXPORT InValid_internalfield2(SALT34.StrType s) := InValidFT_invalid_internalfield2(s);
EXPORT InValidMessage_internalfield2(UNSIGNED1 wh) := InValidMessageFT_invalid_internalfield2(wh);
 
EXPORT Make_internalfield3(SALT34.StrType s0) := MakeFT_invalid_internalfield3(s0);
EXPORT InValid_internalfield3(SALT34.StrType s) := InValidFT_invalid_internalfield3(s);
EXPORT InValidMessage_internalfield3(UNSIGNED1 wh) := InValidMessageFT_invalid_internalfield3(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_OR_Main;
