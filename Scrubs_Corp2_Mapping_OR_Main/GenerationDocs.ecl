...
Command line options: -MScrubs_Corp2_Mapping_OR_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR36F.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_OR_Main
FILENAME:In_OR
...
FIELDTYPE:invalid_corp_vendor:ENUM(41)
FIELDTYPE:invalid_state_origin:ENUM(OR)
...
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_org_structure_desc>0)
FIELDTYPE:invalid_alpha_spec:ALLOW(.,&()/'ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alpha:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_numeric:ALLOW(0123456789)
FIELDTYPE:invalid_cont_title1_desc:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_cont_title1_desc>0,recordorigin)
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
//invalid_internalfield1 is validating a critical field->associated_name_type in raw data 
FIELDTYPE:invalid_internalfield1:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_associated_name_type>0)
//invalid_internalfield2 is validating a critical field->name_type in raw data 
FIELDTYPE:invalid_internalfield2:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_name_type>0)
//invalid_internalfield3 is validating a critical field->bus_type in raw data 
FIELDTYPE:invalid_internalfield3:CUSTOM(Scrubs_Corp2_Mapping_OR_Main.Functions.invalid_bus_type>0)
...
FIELD:corp_filing_reference_nbr:TYPE(STRING30):LIKE(invalid_numeric):0,0
...
FIELD:corp_term_exist_desc:TYPE(STRING60):LIKE(invalid_corp_term_exist_desc):0,0
FIELD:corp_foreign_domestic_ind:TYPE(STRING1):LIKE(invalid_for_dom_ind):0,0
FIELD:corp_forgn_state_cd:TYPE(STRING3):LIKE(invalid_alpha):0,0
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alpha_spec):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_org_structure_desc):0,0
...
FIELD:internalfield1:TYPE(STRING100):LIKE(invalid_internalfield1):0,0
FIELD:internalfield2:TYPE(STRING100):LIKE(invalid_internalfield2):0,0
FIELD:internalfield3:TYPE(STRING100):LIKE(invalid_internalfield3):0,0
