...
EXPORT FromNone(DATASET(Layout_ALC_NURSES) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.household_income_Invalid := Fields.InValid_household_income((SALT37.StrType)le.household_income);
    SELF.marital_status_Invalid := Fields.InValid_marital_status((SALT37.StrType)le.marital_status);
    ...
    SELF.nurse_type_Invalid := Fields.InValid_nurse_type((SALT37.StrType)le.nurse_type);
    SELF.reg_state_Invalid := Fields.InValid_reg_state((SALT37.StrType)le.reg_state);
    SELF.specialty_Invalid := Fields.InValid_specialty((SALT37.StrType)le.specialty);
    ...
    SELF.license_no_Invalid := Fields.InValid_license_no((SALT37.StrType)le.license_no,(SALT37.StrType)le.reg_state);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.title,(SALT37.StrType)le.state,(SALT37.StrType)le.zip,(SALT37.StrType)le.zip4,(SALT37.StrType)le.cart,(SALT37.StrType)le.bar,(SALT37.StrType)le.gender,(SALT37.StrType)le.addr_type,(SALT37.StrType)le.age,(SALT37.StrType)le.county_cd,(SALT37.StrType)le.household_income,(SALT37.StrType)le.marital_status,(SALT37.StrType)le.msa,(SALT37.StrType)le.nielsen_county_cd,(SALT37.StrType)le.nurse_type,(SALT37.StrType)le.reg_state,(SALT37.StrType)le.specialty,(SALT37.StrType)le.phone,(SALT37.StrType)le.list_id,(SALT37.StrType)le.scno,(SALT37.StrType)le.custno,(SALT37.StrType)le.license_no,(SALT37.StrType)le.dob,(SALT37.StrType)le.orig_date,(SALT37.StrType)le.exp_date,'***SALTBUG***');
  END;
