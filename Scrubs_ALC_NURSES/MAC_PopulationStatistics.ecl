...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_fname = '',Input_lname = '',Input_title = '',Input_company = '',Input_address1 = '',Input_address2 = '',Input_city = '',Input_state = '',Input_zip = '',Input_zip4 = '',Input_cart = '',Input_bar = '',Input_gender = '',Input_country = '',Input_postal_cd = '',Input_dpv = '',Input_addr_type = '',Input_age = '',Input_county_cd = '',Input_household_income = '',Input_marital_status = '',Input_msa = '',Input_nielsen_county_cd = '',Input_nurse_type = '',Input_reg_state = '',Input_specialty = '',Input_email = '',Input_phone = '',Input_list_id = '',Input_scno = '',Input_keycode = '',Input_custno = '',Input_license_no = '',Input_dob = '',Input_orig_date = '',Input_exp_date = '',Input_degree = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_nurse_type)='' )
      '' 
    #ELSE
        IF( le.Input_nurse_type = (TYPEOF(le.Input_nurse_type))'','',':nurse_type')
    #END
 
+    #IF( #TEXT(Input_reg_state)='' )
      '' 
    #ELSE
        IF( le.Input_reg_state = (TYPEOF(le.Input_reg_state))'','',':reg_state')
    #END
