...
Command line options: -MScrubs_ALC_NURSES -eC:\Users\metzmaaj\AppData\Local\Temp\TFR1FA8.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_ALC_NURSES
FILENAME:ALC_NURSES
...
FIELD:household_income:TYPE(STRING1):LIKE(invalid_numeric):0,0
FIELD:marital_status:TYPE(STRING1):LIKE(invalid_marital_status):0,0
FIELD:msa:TYPE(STRING4):LIKE(invalid_numeric):0,0
FIELD:nielsen_county_cd:TYPE(STRING1):LIKE(invalid_alphanumeric):0,0
FIELD:nurse_type:TYPE(STRING80):LIKE(invalid_numericpound):0,0
FIELD:reg_state:TYPE(STRING120):LIKE(invalid_alphapound):0,0
FIELD:specialty:TYPE(STRING50):LIKE(invalid_numericpound):0,0
