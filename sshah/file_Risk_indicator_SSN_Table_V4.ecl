//EXPORT file_Risk_indicator_SSN_Table_V4 := 'todo';
import Risk_indicators;

Key_in:=risk_indicators.Key_SSN_Table_v4_filtered_FCRA;
...
self.combo_lname1_lname:=	l.combo.lname1.lname;
...
self.combo_lname2_lname:=	l.combo.lname2.lname;
...
self.combo_lname3_lname:=	l.combo.lname3.lname;
...
self.combo_lname4_lname:=	l.combo.lname4.lname;
...
self.eq_lname1_lname:=	l.eq.lname1.lname;
...
self.eq_lname2_lname:=	l.eq.lname2.lname;
...
self.eq_lname3_lname:=	l.eq.lname3.lname;
...
self.eq_lname4_lname:=	l.eq.lname4.lname;
...
self.en_lname1_lname:=	l.en.lname1.lname;
...
self.en_lname2_lname:=	l.en.lname2.lname;
...
self.en_lname3_lname:=	l.en.lname3.lname;
...
self.en_lname4_lname:=	l.en.lname4.lname;
...
self.tn_lname1_lname:=	l.tn.lname1.lname;
...
self.tn_lname2_lname:=	l.tn.lname2.lname;
...
self.tn_lname3_lname:=	l.tn.lname3.lname;
...
self.tn_lname4_lname:=	l.tn.lname4.lname;
self.tn_lname4_first_seen:=	l.tn.lname4.first_seen;
self.tn_lname4_last_seen:=	l.tn.lname4.last_seen;
end;


export file_Risk_indicator_SSN_Table_V4:= project(key_in,makerecord(left));
