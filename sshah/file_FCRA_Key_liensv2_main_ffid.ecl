...
key_in :=  fcra.key_override_liensv2_main_ffid;
...
self.filing_status_desc:= 'filing_status_desc';
end;

export file_FCRA_Key_liensv2_main_ffid := project(key_in,makerecord(left));
