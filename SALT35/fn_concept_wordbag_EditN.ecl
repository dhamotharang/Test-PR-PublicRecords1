...
export Match2(
							...
							StrType R1,unsigned2 rspec1,unsigned1 R1_len,unsigned2 rfuzzy_spec1,
							StrType R2,unsigned2 rspec2,unsigned1 R2_len,unsigned2 rfuzzy_spec2,
							BOOLEAN edfun(StrType L,unsigned1 L_len,StrType R,unsigned1 R_len,unsigned1 edit,unsigned1 ed_th,UNSIGNED1 mode=0, BOOLEAN edFunction(StrType l,UNSIGNED1 ll, StrType r,UNSIGNED1 rl,UNSIGNED1 d,UNSIGNED1 mode)= fn_EditDistance) = SALT35.WithinEditNew
							) :=
							SALT35.Min0(
								MAX( 
...
/*	 
	...
	*/
	 L1R1 := SALT35.Min0(Match1L(L1,lspec1,lnne1,lfor1,linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R1,rspec1,R1_len,rfuzzy_spec1,edfun)); // take force into consideration
	 L1R2 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R2,rspec2,R2_len,rfuzzy_spec2,edfun));
   L1R3 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R3,rspec3,R3_len,rfuzzy_spec3,edfun));
...
shared Match4L(
   ...
   iL1R1 := getInitMatchWeight(L1, lspec1, R1, rspec1);	 
	 ...
	 */
	 ...
	 L1R2 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R2,rspec2,R2_len,rfuzzy_spec2,edfun));
   L1R3 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R3,rspec3,R3_len,rfuzzy_spec3,edfun));
	 L1R4 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R4,rspec4,R4_len,rfuzzy_spec4,edfun));
...
*/
   ...
   L1R3 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R3,rspec3,R3_len,rfuzzy_spec3,edfun));
	 L1R4 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R4,rspec4,R4_len,rfuzzy_spec4,edfun));
	 L1R5 := SALT35.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,ed_th1,L1_len,lfuzzy_spec1,R5,rspec5,R5_len,rfuzzy_spec5,edfun));
