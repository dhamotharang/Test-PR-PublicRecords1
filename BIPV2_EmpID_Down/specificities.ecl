...
EXPORT input_file := h0(~Reject) : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have EmpID specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.EmpID;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,EmpID,LOCAL) : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::Cluster_Sizes',EXPIRE(Config.PersistExpire));
...
EXPORT orgid_values_persisted := specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::orgid',EXPIRE(Config.PersistExpire));
...
EXPORT fname_values_persisted := initial_specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::fname',EXPIRE(Config.PersistExpire));
...
EXPORT mname_values_persisted := initial_specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::mname',EXPIRE(Config.PersistExpire));
...
EXPORT lname_values_persisted := distance_computed : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::lname',EXPIRE(Config.PersistExpire));
...
EXPORT  name_suffix_deduped := SALT32.MAC_Field_By_UID(input_file,EmpID,name_suffix); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(fuzzies_counted0,id,sequenced)
  SALT32.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT name_suffix_values_persisted := specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::name_suffix',EXPIRE(Config.PersistExpire));
...
EXPORT  contact_did_deduped := SALT32.MAC_Field_By_UID(input_file,EmpID,contact_did); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT32.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT contact_did_values_persisted := specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::contact_did',EXPIRE(Config.PersistExpire));
...
EXPORT contact_ssn_values_persisted := distance_computed : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::contact_ssn',EXPIRE(Config.PersistExpire));
...
EXPORT  dt_first_seen_deduped := SALT32.MAC_Field_By_UID(input_file,EmpID,dt_first_seen); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT32.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT dt_first_seen_values_persisted := specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::dt_first_seen',EXPIRE(Config.PersistExpire));
...
EXPORT  dt_last_seen_deduped := SALT32.MAC_Field_By_UID(input_file,EmpID,dt_last_seen); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT32.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT dt_last_seen_values_persisted := specs_added : PERSIST('~temp::EmpID::BIPV2_EmpID_Down::values::dt_last_seen',EXPIRE(Config.PersistExpire));
