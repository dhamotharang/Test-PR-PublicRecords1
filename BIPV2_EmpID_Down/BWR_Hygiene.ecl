...
#workunit('name','BIPV2_EmpID_Down.BWR_Hygiene - Hygiene & Stats - SALT V3.2.0');
IMPORT BIPV2_EmpID_Down,SALT32;
// First create an instantiated hygiene module
  infile := BIPV2_EmpID_Down.In_EmpID;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := BIPV2_EmpID_Down.Hygiene(ip);
  ...
  CM := BIPV2_EmpID_Down.Fields.UIDConsistency(BIPV2_EmpID_Down.In_EmpID);
