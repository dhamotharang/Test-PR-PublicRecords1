...
dVehiclePartyBase	:=	PRTE2_Vehicle.Files.party_bip;

// Blank out title number for experian states ME and NE
PRTE2_Vehicle.layouts.Base_Party_BIP	tBlankTitleNum(dVehiclePartyBase	pInput)	:=
transform
...
PRTE2_Vehicle.Layouts.Party_Building	tReformat2Bldg(dVehicleV2PartyBldg	pInput)	:=
transform
