...
#workunit('name','Scrubs_Infutor_NARB.Base_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_Layout_Infutor_NARB'),NAMED('OptimizedLayout'));// File layout suggested by data
