...
Command line options: -MScrubs_Corp2_Mapping_AL_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR7C35.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_AL_Main
FILENAME:In_AL
...
FIELDTYPE:invalid_merged_corpid:ALLOW(0123456789 ):LENGTHS(0..7)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_corp_vendor:ENUM(01)
FIELDTYPE:invalid_state_origin:ENUM(AL)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(N| )
FIELDTYPE:invalid_name_type_cd:ENUM(01|09|I|P|N| )
FIELDTYPE:invalid_corp_orig_org_structure_cd:ENUM(D/C|D/S|D3P|DCP|DGP|DHA|DLL|DLP|DML|DNL|DNP|DNS|DPA|DPC|DPL|DPN|DRP|DRT|DSL|DUA|F/C|F3P|FBE|FCP|FGP|FIC|FLL|FLP|FNP|FPA|FPC|FPL|FPN|FRP|FRT|FSL|FUA| )
...
FIELD:corp_merged_corporation_id:TYPE(STRING32):LIKE(invalid_merged_corpid):0,0
