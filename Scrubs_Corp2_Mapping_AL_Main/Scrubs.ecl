...
EXPORT FromNone(DATASET(corp2_mapping.layoutscommon.main) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_process_date_Invalid << 12 ) + ( le.corp_filing_date_Invalid << 14 ) + ( le.corp_merger_date_Invalid << 16 ) + ( le.corp_dissolved_date_Invalid << 18 ) + ( le.corp_forgn_date_Invalid << 20 ) + ( le.corp_inc_date_Invalid << 22 ) + ( le.corp_ra_resign_date_Invalid << 24 ) + ( le.corp_vendor_Invalid << 26 ) + ( le.corp_state_origin_Invalid << 27 ) + ( le.corp_inc_state_Invalid << 28 ) + ( le.corp_legal_name_Invalid << 29 ) + ( le.corp_merged_corporation_id_Invalid << 30 ) + ( le.corp_key_Invalid << 32 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 34 ) + ( le.corp_for_profit_ind_Invalid << 36 ) + ( le.corp_foreign_domestic_ind_Invalid << 37 ) + ( le.corp_ln_name_type_cd_Invalid << 38 ) + ( le.corp_orig_org_structure_cd_Invalid << 39 ) + ( le.corp_forgn_state_desc_Invalid << 40 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_merger_date_Invalid := (le.ScrubsBits1 >> 16) & 3;
    ...
    SELF.corp_legal_name_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.corp_merged_corporation_id_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.corp_key_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.corp_orig_sos_charter_nbr_Invalid := (le.ScrubsBits1 >> 34) & 3;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 37) & 1;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_merged_corporation_id_LENGTH_ErrorCount := COUNT(GROUP,h.corp_merged_corporation_id_Invalid=2);
    corp_merged_corporation_id_Total_ErrorCount := COUNT(GROUP,h.corp_merged_corporation_id_Invalid>0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.dt_vendor_first_reported_Invalid,le.dt_vendor_last_reported_Invalid,le.dt_first_seen_Invalid,le.dt_last_seen_Invalid,le.corp_ra_dt_first_seen_Invalid,le.corp_ra_dt_last_seen_Invalid,le.corp_process_date_Invalid,le.corp_filing_date_Invalid,le.corp_merger_date_Invalid,le.corp_dissolved_date_Invalid,le.corp_forgn_date_Invalid,le.corp_inc_date_Invalid,le.corp_ra_resign_date_Invalid,le.corp_vendor_Invalid,le.corp_state_origin_Invalid,le.corp_inc_state_Invalid,le.corp_legal_name_Invalid,le.corp_merged_corporation_id_Invalid,le.corp_key_Invalid,le.corp_orig_sos_charter_nbr_Invalid,le.corp_for_profit_ind_Invalid,le.corp_foreign_domestic_ind_Invalid,le.corp_ln_name_type_cd_Invalid,le.corp_orig_org_structure_cd_Invalid,le.corp_forgn_state_desc_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Fields.InvalidMessage_dt_vendor_first_reported(le.dt_vendor_first_reported_Invalid),Fields.InvalidMessage_dt_vendor_last_reported(le.dt_vendor_last_reported_Invalid),Fields.InvalidMessage_dt_first_seen(le.dt_first_seen_Invalid),Fields.InvalidMessage_dt_last_seen(le.dt_last_seen_Invalid),Fields.InvalidMessage_corp_ra_dt_first_seen(le.corp_ra_dt_first_seen_Invalid),Fields.InvalidMessage_corp_ra_dt_last_seen(le.corp_ra_dt_last_seen_Invalid),Fields.InvalidMessage_corp_process_date(le.corp_process_date_Invalid),Fields.InvalidMessage_corp_filing_date(le.corp_filing_date_Invalid),Fields.InvalidMessage_corp_merger_date(le.corp_merger_date_Invalid),Fields.InvalidMessage_corp_dissolved_date(le.corp_dissolved_date_Invalid),Fields.InvalidMessage_corp_forgn_date(le.corp_forgn_date_Invalid),Fields.InvalidMessage_corp_inc_date(le.corp_inc_date_Invalid),Fields.InvalidMessage_corp_ra_resign_date(le.corp_ra_resign_date_Invalid),Fields.InvalidMessage_corp_vendor(le.corp_vendor_Invalid),Fields.InvalidMessage_corp_state_origin(le.corp_state_origin_Invalid),Fields.InvalidMessage_corp_inc_state(le.corp_inc_state_Invalid),Fields.InvalidMessage_corp_legal_name(le.corp_legal_name_Invalid),Fields.InvalidMessage_corp_merged_corporation_id(le.corp_merged_corporation_id_Invalid),Fields.InvalidMessage_corp_key(le.corp_key_Invalid),Fields.InvalidMessage_corp_orig_sos_charter_nbr(le.corp_orig_sos_charter_nbr_Invalid),Fields.InvalidMessage_corp_for_profit_ind(le.corp_for_profit_ind_Invalid),Fields.InvalidMessage_corp_foreign_domestic_ind(le.corp_foreign_domestic_ind_Invalid),Fields.InvalidMessage_corp_ln_name_type_cd(le.corp_ln_name_type_cd_Invalid),Fields.InvalidMessage_corp_orig_org_structure_cd(le.corp_orig_org_structure_cd_Invalid),Fields.InvalidMessage_corp_forgn_state_desc(le.corp_forgn_state_desc_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.corp_merged_corporation_id_Invalid,'ALLOW','LENGTH','UNKNOWN')
    ...
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_process_date','corp_filing_date','corp_merger_date','corp_dissolved_date','corp_forgn_date','corp_inc_date','corp_ra_resign_date','corp_vendor','corp_state_origin','corp_inc_state','corp_legal_name','corp_merged_corporation_id','corp_key','corp_orig_sos_charter_nbr','corp_for_profit_ind','corp_foreign_domestic_ind','corp_ln_name_type_cd','corp_orig_org_structure_cd','corp_forgn_state_desc','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_corp_vendor','invalid_state_origin','invalid_state_origin','invalid_mandatory','invalid_merged_corpid','invalid_corp_key','invalid_charter','invalid_for_profit_ind','invalid_forgn_dom_code','invalid_name_type_cd','invalid_corp_orig_org_structure_cd','invalid_alphablank','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.dt_first_seen,(SALT34.StrType)le.dt_last_seen,(SALT34.StrType)le.corp_ra_dt_first_seen,(SALT34.StrType)le.corp_ra_dt_last_seen,(SALT34.StrType)le.corp_process_date,(SALT34.StrType)le.corp_filing_date,(SALT34.StrType)le.corp_merger_date,(SALT34.StrType)le.corp_dissolved_date,(SALT34.StrType)le.corp_forgn_date,(SALT34.StrType)le.corp_inc_date,(SALT34.StrType)le.corp_ra_resign_date,(SALT34.StrType)le.corp_vendor,(SALT34.StrType)le.corp_state_origin,(SALT34.StrType)le.corp_inc_state,(SALT34.StrType)le.corp_legal_name,(SALT34.StrType)le.corp_merged_corporation_id,(SALT34.StrType)le.corp_key,(SALT34.StrType)le.corp_orig_sos_charter_nbr,(SALT34.StrType)le.corp_for_profit_ind,(SALT34.StrType)le.corp_foreign_domestic_ind,(SALT34.StrType)le.corp_ln_name_type_cd,(SALT34.StrType)le.corp_orig_org_structure_cd,(SALT34.StrType)le.corp_forgn_state_desc,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_merged_corporation_id:invalid_merged_corpid:ALLOW','corp_merged_corporation_id:invalid_merged_corpid:LENGTH'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_merged_corporation_id(1),Fields.InvalidMessage_corp_merged_corporation_id(2)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_merged_corporation_id_ALLOW_ErrorCount,le.corp_merged_corporation_id_LENGTH_ErrorCount
