...
scrubsStats := Scrubs_Insurance_Cert.Pol_Scrubs.StandardStats(dsNew);
deltaStats := IF(TRIM(myprevfile) > '' AND EXISTS(dsPrev), Scrubs_Insurance_Cert.Pol_Delta(dsPrev, dsNew).StandardStats());
