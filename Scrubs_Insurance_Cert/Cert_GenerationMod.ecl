...
EXPORT Cert_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_AlphaNum:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz 0123456789)\n'
    + 'FIELDTYPE:Invalid_State:LIKE(Invalid_AlphaCaps):LENGTHS(0,2)\n'
    + 'FIELDTYPE:Invalid_Zip:LIKE(Invalid_No):LENGTHS(0,5,9)\n'
    ...
    + 'FIELD:lninscertrecordid:TYPE(UNSIGNED8):LIKE(Invalid_No):0,0\n'
    + 'FIELD:profilelastupdated:TYPE(STRING):LIKE(Invalid_Date):0,0\n'
    + 'FIELD:siid:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:sipstatuscode:TYPE(STRING):LIKE(Test):0,0\n'
    + 'FIELD:wcbempnumber:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:ubinumber:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:cofanumber:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:usdotnumber:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:businessname:TYPE(STRING):LIKE(Invalid_AlphaChar):0,0\n'
    + 'FIELD:dba:TYPE(STRING):LIKE(Invalid_AlphaChar):0,0\n'
    + 'FIELD:addressline1:TYPE(STRING):LIKE(Invalid_AlphaChar):0,0\n'
    + 'FIELD:addressline2:TYPE(STRING):LIKE(Invalid_AlphaNum):0,0\n'
    + 'FIELD:addresscity:TYPE(STRING):LIKE(Invalid_AlphaCaps):0,0\n'
    + 'FIELD:addressstate:TYPE(STRING):LIKE(Invalid_State):0,0\n'
    + 'FIELD:addresszip:TYPE(STRING):LIKE(Invalid_Zip):0,0\n'
    + 'FIELD:zip4:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    ...
    + 'FIELD:selfinsurancegroup:TYPE(STRING):LIKE(Invalid_AlphaCaps):0,0\n'
