IMPORT AutoStandardI, doxie, MIDEX_Services, PersonReports;

EXPORT SmartLinx_Person_Sections (
  STRING in_did, BOOLEAN include_sourceDocSection, MIDEX_Services.Iparam.smartLinxPersonIncludeOptions options/*,BOOLEAN includeBlackKnight=FALSE*/) :=
