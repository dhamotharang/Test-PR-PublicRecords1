...
EXPORT Layouts := MODULE
  ...
  EXPORT rec_midex_payloadKeyField :=
    RECORD
  ...
  EXPORT rec_profLicMari_payloadKeyField :=
    RECORD
      UNSIGNED6 mari_rid;   
    END;
  ...
  EXPORT rec_temp_layout :=
    ...
    EXPORT Midex_RecordSearch_hash_layout_plus :=
      RECORD
    ...
    EXPORT LicenseReport_RollupTempLayout :=
      RECORD
        LicenseReport_Layout;
        UNSIGNED8 LicNMLS_id := 0;
      END;
			
    EXPORT t_StringArrayItem := 
      RECORD
        STRING value {MAXLENGTH(8192)};
    END;
		
    EXPORT compReport_nonpublicTextRawLayout :=
      RECORD
        rec_midex_payloadKeyField;
    ...
    EXPORT compReport_publicTextRawLayout :=
      RECORD
    ...
    EXPORT compReport_nonpublicCodesRawLayout  := 
      RECORD
        STRING8		BATCH := '';
        STRING1	 	DBCODE := '';
        STRING8		INCIDENT_NUM := '';
    ...
    EXPORT compReport_AkaDbaLayout :=
      RECORD
        STRING26 midex_rpt_nbr;
        STRING1  dbcode;
        STRING8  batchNumber;
    ...
    EXPORT compReport_iespPartyFlatPlusJoinFields :=
      RECORD
    ...
    EXPORT compReport_iespPartyPlusJoinFields :=
      RECORD
    ...
    EXPORT compReport_PartyTempLayout := 
      RECORD
        STRING26 midex_rpt_nbr;
        STRING1  dbcode;
        STRING8  batchNumber;
  ...
  // doxie_cbrs.contact_records_prs_trimmed.company_title_rec ==>  doxie_cbrs.layout_contacts_standardized
  EXPORT company_title_rec := 
    RECORD
  ...
  EXPORT rec_SmartLinxBusinessPlusSources :=
    RECORD
  ...
  EXPORT rec_NMLSWithDBAsAndMariRid :=
    RECORD
      UNSIGNED6 NMLSId;
