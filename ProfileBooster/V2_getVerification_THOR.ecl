...
//search Infutor by DID to verify input name, address, phone
	V2_Layouts.Layout_PB2_Shell getInfutor(PBShell le, infutorcid_key ri) := transform	
...
//search Gong by DID to verify input name, address, phone
	V2_Layouts.Layout_PB2_Shell getGong(PBShell le, gonghistorydid_key ri) := transform	
...
//rollup to accumulate the verification counts 
  V2_Layouts.Layout_PB2_Shell rollVer(V2_Layouts.Layout_PB2_Shell le, V2_Layouts.Layout_PB2_Shell ri) := transform
  ...
  rolledVer := rollup(sortVer, rollVer(left,right), seq);
	...
	V2_Layouts.Layout_PB2_Shell addVerification(PBShell le, rolledVer ri) := TRANSFORM
...
//rollup to get current and previous address on same record
  V2_Layouts.Layout_PB2_Shell rollAddrs(V2_Layouts.Layout_PB2_Shell le, V2_Layouts.Layout_PB2_Shell ri) := transform
