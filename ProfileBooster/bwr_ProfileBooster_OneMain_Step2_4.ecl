...
output(choosen(checkInputs,100), named('checkInputs_step4'));
output(Count(checkInputs), named('checkInputsCounts_step4'));
output(Count(checkInputs(lexid = 0)), named('checkInputs_LexidZeroCount_step4'));	
