...
EXPORT V2_PB1708_1_0(
DATASET(ProfileBooster.V2_Layouts.Layout_PB2_BatchOut) pb_attributes_in ) := FUNCTION
 ...
 Risk_Indicators.Layout_Input;
  ProfileBooster.V2_Layouts.Layout_PB2_BatchOut pb;
...
//layout_temp;
 ...
 END;
  ...
  #ELSE
   ...
   ProfileBooster.V2_Layouts.Layout_PB2_BatchOut doModel(pb_attributes_in le) := TRANSFORM
