...
EXPORT B_Vehicle_8(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE18100 := __ENH_Vehicle_9;
  EXPORT __ST12053_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST12053_Layout __ND18217__Project(B_Vehicle_9(__cfg).__ST12370_Layout __PP17518) := TRANSFORM
    SELF.Vehicle_Type_ := FN_Compile(__cfg).FN_Vehicle_Type_Group(__ECAST(KEL.typ.nstr,__PP17518.Vina_Body_Style_Vehicle_Type_));
    SELF := __PP17518;
  END;
  EXPORT __ENH_Vehicle_8 := PROJECT(__EE18100,__ND18217__Project(LEFT));
END;
