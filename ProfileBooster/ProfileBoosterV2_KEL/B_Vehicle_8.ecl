...
EXPORT B_Vehicle_8(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE17614 := __ENH_Vehicle_9;
  EXPORT __ST11579_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST11579_Layout __ND17731__Project(B_Vehicle_9(__cfg).__ST11896_Layout __PP17032) := TRANSFORM
    SELF.Vehicle_Type_ := FN_Compile(__cfg).FN_Vehicle_Type_Group(__ECAST(KEL.typ.nstr,__PP17032.Vina_Body_Style_Vehicle_Type_));
    SELF := __PP17032;
  END;
  EXPORT __ENH_Vehicle_8 := PROJECT(__EE17614,__ND17731__Project(LEFT));
END;
