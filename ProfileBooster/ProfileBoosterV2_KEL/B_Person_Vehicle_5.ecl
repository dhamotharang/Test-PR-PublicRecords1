...
EXPORT B_Person_Vehicle_5(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE29541 := __ENH_Person_Vehicle_6;
  EXPORT __ST10159_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST10159_Layout __ND29798__Project(B_Person_Vehicle_6(__cfg).__ST10641_Layout __PP29334) := TRANSFORM
    SELF.Flag_Depreciated_Price_ := __OP2(__PP29334.Depreciated_Price_,>=,__CN(0));
    SELF := __PP29334;
  END;
  EXPORT __ENH_Person_Vehicle_5 := PROJECT(__EE29541,__ND29798__Project(LEFT));
END;
