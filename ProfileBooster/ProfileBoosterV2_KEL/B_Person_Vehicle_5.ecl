...
EXPORT B_Person_Vehicle_5(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE29603 := __ENH_Person_Vehicle_6;
  EXPORT __ST10168_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST10168_Layout __ND29860__Project(B_Person_Vehicle_6(__cfg).__ST10650_Layout __PP29396) := TRANSFORM
    SELF.Flag_Depreciated_Price_ := __OP2(__PP29396.Depreciated_Price_,>=,__CN(0));
    SELF := __PP29396;
  END;
  EXPORT __ENH_Person_Vehicle_5 := PROJECT(__EE29603,__ND29860__Project(LEFT));
END;
