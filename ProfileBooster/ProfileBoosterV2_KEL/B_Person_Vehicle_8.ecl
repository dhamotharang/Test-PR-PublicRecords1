...
EXPORT B_Person_Vehicle_8(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE15789 := __ENH_Person_Vehicle_9;
  SHARED __EE15717 := __ENH_Vehicle_9;
  SHARED __ST15888_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC15885(B_Person_Vehicle_9(__cfg).__ST11722_Layout __EE15789, B_Vehicle_9(__cfg).__ST11896_Layout __EE15717) := __EEQP(__EE15789.Automobile_,__EE15717.UID) AND __EE15789.__Part = __EE15717.__Part;
  __ST15888_Layout __JT15885(B_Person_Vehicle_9(__cfg).__ST11722_Layout __l, B_Vehicle_9(__cfg).__ST11896_Layout __r) := TRANSFORM
    SELF.Data_Sources__1_ := __r.Data_Sources_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE15886 := JOIN(__EE15789,__EE15717,__JC15885(LEFT,RIGHT),__JT15885(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST11402_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Vehicle().Typ) Automobile_;
    KEL.typ.ndataset(E_Person_Vehicle(__cfg).Registration_Layout) Registration_;
    KEL.typ.ndataset(E_Person_Vehicle(__cfg).Title_Layout) Title_;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST11402_Layout __ND16454__Project(__ST15888_Layout __PP16213) := TRANSFORM
    __CC1079 := '-99997';
    SELF.Age_At_First_Seen_ := IF(__T(__AND(__OP2(__PP16213.Vina_Model_Date_,<>,__CN(__CC1079)),__FN1(KEL.Routines.IsValidDate,__PP16213.Date_First_Seen_Capped_))),__ECAST(KEL.typ.nint,__FN2(KEL.Routines.DaysBetween,KEL.Routines.CastStringToDate(__PP16213.Vina_Model_Date_),__PP16213.Date_First_Seen_Capped_)),__ECAST(KEL.typ.nint,__CN(0)));
    SELF := __PP16213;
  END;
  EXPORT __ENH_Person_Vehicle_8 := PROJECT(__EE15886,__ND16454__Project(LEFT));
END;
