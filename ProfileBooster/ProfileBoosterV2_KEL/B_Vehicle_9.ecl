...
EXPORT B_Vehicle_9(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE15428 := __E_Vehicle;
  EXPORT __ST12370_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST12370_Layout __ND15663__Project(E_Vehicle(__cfg).Layout __PP14843) := TRANSFORM
    SELF.Vina_Body_Style_Vehicle_Type_ := __OP2(__OP2(__FN1(KEL.Routines.TrimBoth,__PP14843.Vina_Body_Style_Description_),+,__CN('-')),+,__FN1(KEL.Routines.TrimBoth,__PP14843.Vina_Vehicle_Type_));
    SELF.Vina_Model_Date_ := __ECAST(KEL.typ.nstr,__FN3(KEL.Routines.DateFromParts,__OP2(__PP14843.Vina_Model_Year_,-,__CN(1)),__CN(1),__CN(1)));
    SELF := __PP14843;
  END;
  EXPORT __ENH_Vehicle_9 := PROJECT(__EE15428,__ND15663__Project(LEFT));
END;
