...
EXPORT RQ_Non_F_C_R_A_Profile_Booster_V2_All(DATASET(CFG_Compile.Non_F_C_R_A_Profile_Booster_V2_All_Params_Layout) __Non_F_C_R_A_Profile_Booster_V2_All_Params, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE414948 := __ENH_Person;
  SHARED __EE415193 := __Params;
  SHARED __ST415638_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  __JC416049(B_Person(__cfg_Local).__ST7659_Layout __EE414948, CFG_Compile.Non_F_C_R_A_Profile_Booster_V2_All_Params_Layout __EE415193) := TRUE AND __EE414948.__Part = __EE415193.__Part;
  __ST415638_Layout __JT416049(B_Person(__cfg_Local).__ST7659_Layout __l, CFG_Compile.Non_F_C_R_A_Profile_Booster_V2_All_Params_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE416050 := JOIN(__EE414948,__EE415193,__JC416049(LEFT,RIGHT),__JT416049(LEFT,RIGHT),INNER,ALL);
  SHARED __ST414463_Layout := RECORD
    ...
    UNSIGNED4 __Part := 0;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE416050,TRANSFORM(__ST414463_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)),'__Part');
