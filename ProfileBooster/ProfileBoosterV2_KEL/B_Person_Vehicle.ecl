...
EXPORT B_Person_Vehicle(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED __EE467254 := E_Person_Vehicle(__cfg).PreEntityInternal(true);
  SHARED __IDX_Person_Vehicle_Subject__Filtered := __EE467254(__NN(__EE467254.Subject_));
  ...
  EXPORT __ST468372_Layout := RECORDOF(IDX_Person_Vehicle_Subject_);
