...
IMPORT _Validate, ProfileBooster.ProfileBoosterV2_KEL, STD, ut;

EXPORT Fn_Clean_Date (STRING InDate, 
											INTEGER LowYear = ProfileBoosterV2_KEL.ECL_Functions.Constants.VALIDATE_YEAR_RANGE_LOW_DOB, 
											INTEGER HighYear = ProfileBoosterV2_KEL.ECL_Functions.Constants.VALIDATE_YEAR_RANGE_HIGH_DOB,
	...
	ProfileBoosterV2_KEL.ECL_Functions.Cleaned_Date_Layout ClndDate() := TRANSFORM
