...
EXPORT B_Vehicle_7(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE20104 := __ENH_Vehicle_8;
  EXPORT __ST11244_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    UNSIGNED4 __Part := 0;
  END;
  SHARED __ST11244_Layout __ND20342__Project(B_Vehicle_8(__cfg).__ST11579_Layout __PP19517) := TRANSFORM
    SELF.Flag_Auto_ := __OP2(__PP19517.Vehicle_Type_,IN,__CN(['Car','SUV','Truck','Van']));
    SELF := __PP19517;
  END;
  EXPORT __ENH_Vehicle_7 := PROJECT(__EE20104,__ND20342__Project(LEFT));
END;
