...
#ELSE
	ProfileBooster.V2_Layouts.Layout_PB2_BatchOutFlat addAcct(attributes le, PB_wSeq ri) := transform
		...
		self.EmrgAddrType := le.attributes.version2.EmrgAddrType;
		self.EmrgLexIDsAtEmrgAddrCnt1Y := le.attributes.version2.EmrgLexIDsAtEmrgAddrCnt1Y;
		self.EmrgAge25to59Flag := le.attributes.version2.EmrgAge25to59Flag;

		self.DrgCnt7Y := le.attributes.version2.DrgCnt7Y;
		self.DrgSeverityIndx7Y := le.attributes.version2.DrgSeverityIndx7Y;
		self.DrgCnt1Y := le.attributes.version2.DrgCnt1Y;
		self.DrgNewMsnc7Y := le.attributes.version2.DrgNewMsnc7Y;
		self.DrgCrimFelCnt7Y := le.attributes.version2.DrgCrimFelCnt7Y;
		self.DrgCrimFelCnt1Y := le.attributes.version2.DrgCrimFelCnt1Y;
		self.DrgCrimFelNewMsnc7Y := le.attributes.version2.DrgCrimFelNewMsnc7Y;
		...
		self.DrgCrimNFelNewMsnc7Y := le.attributes.version2.DrgCrimNFelNewMsnc7Y;
		self.DrgEvictCnt7Y := le.attributes.version2.DrgEvictCnt7Y;
		self.DrgEvictCnt1Y := le.attributes.version2.DrgEvictCnt1Y;
		self.DrgEvictNewMsnc7Y := le.attributes.version2.DrgEvictNewMsnc7Y;
		self.DrgLnJCnt7Y := le.attributes.version2.DrgLnJCnt7Y;
		self.DrgLnJCnt1Y := le.attributes.version2.DrgLnJCnt1Y;
		self.DrgLnJNewMsnc7Y := le.attributes.version2.DrgLnJNewMsnc7Y;
		self.DrgLnJAmtTot7Y := le.attributes.version2.DrgLnJAmtTot7Y;
		self.DrgBkCnt10Y := le.attributes.version2.DrgBkCnt10Y;
		self.DrgBkCnt1Y := le.attributes.version2.DrgBkCnt1Y;
		self.DrgBkNewMsnc10Y := le.attributes.version2.DrgBkNewMsnc10Y;
		...
		self.HHMmbrAgeMed := le.attributes.version2.HHMmbrAgeMed;
		self.HHMmbrAgeAvg := le.attributes.version2.HHMmbrAgeAvg;
		...
		self.HHMmbrCnt := le.attributes.version2.HHMmbrCnt;
		// self.HHEstimatedIncomeRange := le.attributes.version2.HHEstimatedIncomeRange;
		// self.HHEstimatedIncomeAvg := le.attributes.version2.HHEstimatedIncomeAvg;
		self.HHMmbrWEduCollCnt := le.attributes.version2.HHMmbrWEduCollCnt;
		self.HHMmbrWEduCollEvidEvCnt := le.attributes.version2.HHMmbrWEduCollEvidEvCnt;
		self.HHMmbrWEduColl2YrCnt := le.attributes.version2.HHMmbrWEduColl2YrCnt;
		self.HHMmbrWEduColl4YrCnt := le.attributes.version2.HHMmbrWEduColl4YrCnt;
		self.HHMmbrWEduCollGradCnt := le.attributes.version2.HHMmbrWEduCollGradCnt;
		self.HHMmbrWCollPvtCnt := le.attributes.version2.HHMmbrWCollPvtCnt;
		self.HHMmbrCollTierHighest := le.attributes.version2.HHMmbrCollTierHighest;
		self.HHMmbrCollTierAvg := le.attributes.version2.HHMmbrCollTierAvg;
		...
		self.HHMmbrWAstPropCurrCnt := le.attributes.version2.HHMmbrWAstPropCurrCnt;
		self.HHAstPropCurrCnt := le.attributes.version2.HHAstPropCurrCnt;
		self.HHMmbrPropAVMMax := le.attributes.version2.HHMmbrPropAVMMax;
		self.HHMmbrPropAVMAvg := le.attributes.version2.HHMmbrPropAVMAvg;
		self.HHMmbrPropAVMTot := le.attributes.version2.HHMmbrPropAVMTot;
		self.HHMmbrPropAVMTot1Y := le.attributes.version2.HHMmbrPropAVMTot1Y;
		self.HHMmbrPropAVMTot5Y := le.attributes.version2.HHMmbrPropAVMTot5Y;
