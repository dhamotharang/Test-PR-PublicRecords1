...
ut.MAC_SK_Move_v2('~thor_data400::key::utility_address','Q',mk_addr);
ut.MAC_SK_Move_v2('~thor_data400::key::utility_did','Q',mk_did);
ut.MAC_SK_Move_v2('~thor_data400::key::utility::daily.fdid','Q',big_build1);
ut.MAC_SK_Move_v2('~thor_data400::key::utility::daily.did','Q',big_build2);
ut.MAC_SK_Move_v2('~thor_data400::key::utility::daily.id','Q',big_build3);
AutoKey.MAC_AcceptSK_to_QA('~thor_data400::key::utility::daily.',out_ak,,['-'])

//*** Utility Business Keys
ut.MAC_SK_Move_v2('~thor_data400::key::utility::bus::address','Q',mv_bus_addr);
ut.MAC_SK_Move_v2('~thor_data400::key::utility::daily::bus::bdid','Q',mv_bus_bdid);
ut.MAC_SK_Move_v2('~thor_data400::key::utility::daily::bus::id','Q',mv_bus_id);
...
export Proc_AcceptSK_toQA := sequential(mk_addr,mk_did,big_build1,big_build2,big_build3,out_ak,
																				mv_bus_addr, mv_bus_bdid, mv_bus_id,
