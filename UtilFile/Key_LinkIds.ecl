IMPORT BIPV2, Data_Services, utilfile;

EXPORT Key_LinkIds := MODULE

  // DEFINE THE INDEX
	shared superfile_name	:= Data_Services.Data_location.Prefix('Utility') + 'thor_data400::key::utility::qa::linkids';
	
	shared Base := utilfile.file_util_bus.full_base_for_index;
