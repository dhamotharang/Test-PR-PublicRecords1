...
export Key_Util_Daily_Did := INDEX(p,{unsigned6 s_did := (unsigned6)did},{p},data_services.foreign_prod+'thor_data400::key::utility::daily.did_'+doxie.Version_SuperKey);
