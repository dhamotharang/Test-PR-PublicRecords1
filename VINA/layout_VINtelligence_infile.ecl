EXPORT layout_VINtelligence_infile := RECORD
	...
	STRING1			LPM_ROLL_IND;											//234     18652-18652           LPM_ROLL_IND                          It is common insurance industry practice to Ã‚Â¿roll overÃ‚Â¿ insurance symbols from the previous model year into the new model year. An Ã‚Â¿RÃ‚Â¿ is placed in this field to indicate that the ISO symbol for an existing series / model has been continued into the new model year and is not yet in the ISO country-wide book for the new model year. These symbols are phased out via normal software updates as the ISO symbols are updated and published.  This code is provided as a service to users, and use of the associated symbol is optional 
	...
	STRING1			LPM_ROLL_IND_2008;								//266     19087-19087           LPM_ROLL_IND_2008 										It is common insurance industry practice to Ã‚Â¿roll overÃ‚Â¿ insurance symbols from the previous model year into the new model year. An Ã‚Â¿RÃ‚Â¿ is placed in this field to indicate that the ISO symbol for an existing series / model has been continued into the new model year and is not yet in the ISO country-wide book for the new model year. These symbols are phased out via normal software updates as the ISO symbols are updated and published.  This code is provided as a service to users, and use of the associated symbol is optional
	...
	STRING1			LPM_ROLL_IND_2010;								//269     19097-19097           LPM_ROLL_IND_2010   									It is common insurance industry practice to Ã‚Â¿roll overÃ‚Â¿ insurance symbols from the previous model year into the new model year. An Ã‚Â¿RÃ‚Â¿ is placed in this field to indicate that the ISO symbol for an existing series / model has been continued into the new model year and is not yet in the ISO country-wide book for the new model year. These symbols are phased out via normal software updates as the ISO symbols are updated and published.  This code is provided as a service to users, and use of the associated symbol is optional
