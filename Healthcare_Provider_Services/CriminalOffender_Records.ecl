...
export CriminalOffender_Records (Healthcare_Header_Services.IParams.ReportParams inputData,dataset(doxie.layout_references) dsDids) := module
	tmpCrimSearchMod := module(project(AutoStandardI.GlobalModule(),CriminalRecords_Services.IParam.report,opt))
