export Functions_OneStepPass := Module

	EXPORT compareResults2Configuration(string configName, dataset(Healthcare_Provider_Services.layouts.Verifications) serviceFlags) := Function
		configFlags := Healthcare_Provider_Services.Functions_OneStepPass_Configuration.getConfig(configName);
		cfg_Valid := configFlags[1].VerificationConfigurationStatus = Constants.ONE_STEP_PASS_GOOD_CONFIG;
		...
		OneStepOutcome:= cfg_Valid and cfg_Name_Pass and cfg_CompanyName_Pass and cfg_Address_Pass and cfg_Phone_Pass and 
									cfg_SSN_Pass and cfg_FEIN_Pass and cfg_UPIN_Pass and cfg_NPISupplied_Pass and cfg_NPIValid_Pass and 
									cfg_NPIVerified_Pass and cfg_CLIAValid_Pass and cfg_CLIAVerified_Pass and cfg_DEAValid_Pass and cfg_DEA2Valid_Pass and 
									cfg_DEAVerified_Pass and cfg_DEA2Verified_Pass and cfg_AnyLicenseValid_Pass and cfg_AnyLicenseVerified_Pass and 
									cfg_License1Valid_Pass and cfg_License1Verified_Pass and 
		...
		ds_results := project(serviceFlags, transform(Healthcare_Provider_Services.layouts.Verifications, 
