IMPORT ut,SALT33;
EXPORT address_history_arrests_hygiene(dataset(address_history_arrests_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    address_history_arrests_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    address_history_arrests_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    address_history_arrests_Fields.InValid_street((SALT33.StrType)le.street),
    address_history_arrests_Fields.InValid_unit((SALT33.StrType)le.unit),
    address_history_arrests_Fields.InValid_city((SALT33.StrType)le.city),
    address_history_arrests_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    address_history_arrests_Fields.InValid_orig_zip((SALT33.StrType)le.orig_zip),
    address_history_arrests_Fields.InValid_addresstype((SALT33.StrType)le.addresstype),
    address_history_arrests_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    address_history_arrests_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    address_history_arrests_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := address_history_arrests_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,address_history_arrests_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_street(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_unit(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_city(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_orig_zip(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_addresstype(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),address_history_arrests_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
