...
EXPORT sentence_arrests_Fields := MODULE
// Processing for each FieldType
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Record_ID','Invalid_Char','Non_Blank','Invalid_Future_Date','Invalid_Num');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'Invalid_Record_ID' => 1,'Invalid_Char' => 2,'Non_Blank' => 3,'Invalid_Future_Date' => 4,'Invalid_Num' => 5,0);
...
EXPORT Make_timeservedyears(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_timeservedyears(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_timeservedyears(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_timeservedmonths(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_timeservedmonths(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_timeservedmonths(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_timeserveddays(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_timeserveddays(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_timeserveddays(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_publicservicehours(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_publicservicehours(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_publicservicehours(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_sentenceadditionalinfo(SALT33.StrType s0) := s0;
EXPORT InValid_sentenceadditionalinfo(SALT33.StrType s) := FALSE;
...
EXPORT Make_parolebegindate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_parolebegindate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_parolebegindate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_paroleenddate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_paroleenddate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_paroleenddate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_paroleeligibilitydate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_paroleeligibilitydate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_paroleeligibilitydate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_parolehearingdate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_parolehearingdate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_parolehearingdate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_parolemaxyears(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_parolemaxyears(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_parolemaxyears(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_parolemaxmonths(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_parolemaxmonths(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_parolemaxmonths(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_parolemaxdays(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_parolemaxdays(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_parolemaxdays(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_paroleminyears(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_paroleminyears(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_paroleminyears(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_paroleminmonths(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_paroleminmonths(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_paroleminmonths(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_parolemindays(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_parolemindays(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_parolemindays(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_parolestatus(SALT33.StrType s0) := s0;
EXPORT InValid_parolestatus(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_parolestatus(UNSIGNED1 wh) := '';
EXPORT Make_paroleofficer(SALT33.StrType s0) := s0;
EXPORT InValid_paroleofficer(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_paroleofficer(UNSIGNED1 wh) := '';
EXPORT Make_paroleoffcerphone(SALT33.StrType s0) := s0;
EXPORT InValid_paroleoffcerphone(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_paroleoffcerphone(UNSIGNED1 wh) := '';
EXPORT Make_probationbegindate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_probationbegindate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_probationbegindate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_probationenddate(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_probationenddate(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_probationenddate(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_probationmaxyears(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationmaxyears(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationmaxyears(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationmaxmonths(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationmaxmonths(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationmaxmonths(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationmaxdays(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationmaxdays(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationmaxdays(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationminyears(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationminyears(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationminyears(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationminmonths(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationminmonths(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationminmonths(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationmindays(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_probationmindays(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_probationmindays(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_probationstatus(SALT33.StrType s0) := s0;
EXPORT InValid_probationstatus(SALT33.StrType s) := FALSE;
