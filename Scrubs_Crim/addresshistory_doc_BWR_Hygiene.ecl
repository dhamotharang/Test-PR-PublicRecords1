...
#workunit('name','Scrubs_Crim.addresshistory_doc_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
IMPORT Scrubs_Crim,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Crim.addresshistory_doc_In_crim;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Crim.addresshistory_doc_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'addresshistory_doc_Layout_crim'),NAMED('OptimizedLayout'));// File layout suggested by data
