...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    alias_counties_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    alias_counties_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    alias_counties_Fields.InValid_akaname((SALT33.StrType)le.akaname),
    alias_counties_Fields.InValid_akalastname((SALT33.StrType)le.akalastname),
    alias_counties_Fields.InValid_akafirstname((SALT33.StrType)le.akafirstname),
    alias_counties_Fields.InValid_akamiddlename((SALT33.StrType)le.akamiddlename),
    alias_counties_Fields.InValid_akasuffix((SALT33.StrType)le.akasuffix),
    alias_counties_Fields.InValid_akadob((SALT33.StrType)le.akadob),
    alias_counties_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    alias_counties_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
