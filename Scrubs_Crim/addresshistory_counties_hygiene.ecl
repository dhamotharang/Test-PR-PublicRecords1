...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := addresshistory_counties_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,addresshistory_counties_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_street(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_unit(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_city(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_orig_zip(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_addresstype(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),addresshistory_counties_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
