IMPORT ut,SALT33;
EXPORT vendor_hygiene(dataset(vendor_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    vendor_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    vendor_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    vendor_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    vendor_Fields.InValid_casenumber((SALT33.StrType)le.casenumber),
    vendor_Fields.InValid_casetitle((SALT33.StrType)le.casetitle),
    vendor_Fields.InValid_casetype((SALT33.StrType)le.casetype),
    vendor_Fields.InValid_casestatus((SALT33.StrType)le.casestatus),
    vendor_Fields.InValid_casestatusdate((SALT33.StrType)le.casestatusdate),
    vendor_Fields.InValid_casecomments((SALT33.StrType)le.casecomments),
    vendor_Fields.InValid_fileddate((SALT33.StrType)le.fileddate),
    vendor_Fields.InValid_caseinfo((SALT33.StrType)le.caseinfo),
    vendor_Fields.InValid_docketnumber((SALT33.StrType)le.docketnumber),
    vendor_Fields.InValid_offensecode((SALT33.StrType)le.offensecode),
    vendor_Fields.InValid_offensedesc((SALT33.StrType)le.offensedesc),
    vendor_Fields.InValid_offensedate((SALT33.StrType)le.offensedate),
    vendor_Fields.InValid_offensetype((SALT33.StrType)le.offensetype),
    vendor_Fields.InValid_offensedegree((SALT33.StrType)le.offensedegree),
    vendor_Fields.InValid_offenseclass((SALT33.StrType)le.offenseclass),
    vendor_Fields.InValid_dispositionstatus((SALT33.StrType)le.dispositionstatus),
    vendor_Fields.InValid_dispositionstatusdate((SALT33.StrType)le.dispositionstatusdate),
    vendor_Fields.InValid_disposition((SALT33.StrType)le.disposition),
    vendor_Fields.InValid_dispositiondate((SALT33.StrType)le.dispositiondate),
    vendor_Fields.InValid_offenselocation((SALT33.StrType)le.offenselocation),
    vendor_Fields.InValid_finaloffense((SALT33.StrType)le.finaloffense),
    vendor_Fields.InValid_finaloffensedate((SALT33.StrType)le.finaloffensedate),
    vendor_Fields.InValid_offensecount((SALT33.StrType)le.offensecount),
    vendor_Fields.InValid_victimunder18((SALT33.StrType)le.victimunder18),
    vendor_Fields.InValid_prioroffenseflag((SALT33.StrType)le.prioroffenseflag),
    vendor_Fields.InValid_initialplea((SALT33.StrType)le.initialplea),
    vendor_Fields.InValid_initialpleadate((SALT33.StrType)le.initialpleadate),
    vendor_Fields.InValid_finalruling((SALT33.StrType)le.finalruling),
    vendor_Fields.InValid_finalrulingdate((SALT33.StrType)le.finalrulingdate),
    vendor_Fields.InValid_appealstatus((SALT33.StrType)le.appealstatus),
    vendor_Fields.InValid_appealdate((SALT33.StrType)le.appealdate),
    vendor_Fields.InValid_courtname((SALT33.StrType)le.courtname),
    vendor_Fields.InValid_fineamount((SALT33.StrType)le.fineamount),
    vendor_Fields.InValid_courtfee((SALT33.StrType)le.courtfee),
    vendor_Fields.InValid_restitution((SALT33.StrType)le.restitution),
    vendor_Fields.InValid_trialtype((SALT33.StrType)le.trialtype),
    vendor_Fields.InValid_courtdate((SALT33.StrType)le.courtdate),
    vendor_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    vendor_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    vendor_Fields.InValid_classification_code((SALT33.StrType)le.classification_code),
    vendor_Fields.InValid_sub_classification_code((SALT33.StrType)le.sub_classification_code),
    vendor_Fields.InValid_unit((SALT33.StrType)le.unit),
    vendor_Fields.InValid_city((SALT33.StrType)le.city),
    vendor_Fields.InValid_state((SALT33.StrType)le.state),
    vendor_Fields.InValid_zip((SALT33.StrType)le.zip),
    vendor_Fields.InValid_county((SALT33.StrType)le.county),
    vendor_Fields.InValid_institutionname((SALT33.StrType)le.institutionname),
    vendor_Fields.InValid_institutiondetails((SALT33.StrType)le.institutiondetails),
    vendor_Fields.InValid_institutionreceiptdate((SALT33.StrType)le.institutionreceiptdate),
    vendor_Fields.InValid_releasetolocation((SALT33.StrType)le.releasetolocation),
    vendor_Fields.InValid_releasetodetails((SALT33.StrType)le.releasetodetails),
    vendor_Fields.InValid_deceasedflag((SALT33.StrType)le.deceasedflag),
    vendor_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate),
    vendor_Fields.InValid_healthflag((SALT33.StrType)le.healthflag),
    vendor_Fields.InValid_healthdesc((SALT33.StrType)le.healthdesc),
    vendor_Fields.InValid_bloodtype((SALT33.StrType)le.bloodtype),
    vendor_Fields.InValid_sexoffenderregistrydate((SALT33.StrType)le.sexoffenderregistrydate),
    vendor_Fields.InValid_sexoffenderregexpirationdate((SALT33.StrType)le.sexoffenderregexpirationdate),
    vendor_Fields.InValid_sexoffenderregistrynumber((SALT33.StrType)le.sexoffenderregistrynumber),
    vendor_Fields.InValid_sourceid2((SALT33.StrType)le.sourceid2),
    vendor_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := vendor_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_Record_ID','Invalid_Char','Non_Blank','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Unknown','Invalid_Current_Date','Unknown','Invalid_VictimUnder18','Unknown','Unknown','Invalid_Current_Date','Unknown','Invalid_Current_Date','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Invalid_Num','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown','Unknown','Invalid_Current_Date','Unknown','Unknown','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,vendor_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_caseid(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casenumber(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casetitle(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casetype(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casestatus(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casestatusdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_casecomments(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_fileddate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_caseinfo(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_docketnumber(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensecode(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensedesc(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensedate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensetype(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensedegree(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offenseclass(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_dispositionstatus(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_dispositionstatusdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_disposition(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_dispositiondate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offenselocation(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_finaloffense(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_finaloffensedate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_offensecount(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_victimunder18(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_prioroffenseflag(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_initialplea(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_initialpleadate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_finalruling(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_finalrulingdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_appealstatus(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_appealdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_courtname(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_fineamount(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_courtfee(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_restitution(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_trialtype(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_courtdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_classification_code(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sub_classification_code(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_unit(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_city(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_state(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_zip(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_county(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_institutionname(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_institutiondetails(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_institutionreceiptdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_releasetolocation(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_releasetodetails(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_deceasedflag(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_deceaseddate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_healthflag(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_healthdesc(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_bloodtype(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sexoffenderregistrydate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sexoffenderregexpirationdate(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sexoffenderregistrynumber(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_sourceid2(TotalErrors.ErrorNum),vendor_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
