...
#workunit('name','Scrubs_Crim.charge_arrests_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
IMPORT Scrubs_Crim,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Crim.charge_arrests_In_crim;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Crim.charge_arrests_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'charge_arrests_Layout_crim'),NAMED('OptimizedLayout'));// File layout suggested by data
