...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    charge_counties_Fields.InValid_recordid((SALT311.StrType)le.recordid),
    charge_counties_Fields.InValid_statecode((SALT311.StrType)le.statecode),
    charge_counties_Fields.InValid_caseid((SALT311.StrType)le.caseid),
    charge_counties_Fields.InValid_warrantnumber((SALT311.StrType)le.warrantnumber),
    charge_counties_Fields.InValid_warrantdate((SALT311.StrType)le.warrantdate),
    charge_counties_Fields.InValid_warrantdesc((SALT311.StrType)le.warrantdesc),
    charge_counties_Fields.InValid_warrantissuedate((SALT311.StrType)le.warrantissuedate),
    charge_counties_Fields.InValid_warrantissuingagency((SALT311.StrType)le.warrantissuingagency),
    charge_counties_Fields.InValid_warrantstatus((SALT311.StrType)le.warrantstatus),
    charge_counties_Fields.InValid_citationnumber((SALT311.StrType)le.citationnumber),
    charge_counties_Fields.InValid_bookingnumber((SALT311.StrType)le.bookingnumber),
    charge_counties_Fields.InValid_arrestdate((SALT311.StrType)le.arrestdate),
    charge_counties_Fields.InValid_arrestingagency((SALT311.StrType)le.arrestingagency),
    charge_counties_Fields.InValid_bookingdate((SALT311.StrType)le.bookingdate),
    charge_counties_Fields.InValid_custodydate((SALT311.StrType)le.custodydate),
    charge_counties_Fields.InValid_custodylocation((SALT311.StrType)le.custodylocation),
    charge_counties_Fields.InValid_initialcharge((SALT311.StrType)le.initialcharge),
    charge_counties_Fields.InValid_initialchargedate((SALT311.StrType)le.initialchargedate),
    charge_counties_Fields.InValid_initialchargecancelleddate((SALT311.StrType)le.initialchargecancelleddate),
    charge_counties_Fields.InValid_chargedisposed((SALT311.StrType)le.chargedisposed),
    charge_counties_Fields.InValid_chargedisposeddate((SALT311.StrType)le.chargedisposeddate),
    charge_counties_Fields.InValid_chargeseverity((SALT311.StrType)le.chargeseverity),
    charge_counties_Fields.InValid_chargedisposition((SALT311.StrType)le.chargedisposition),
    charge_counties_Fields.InValid_amendedcharge((SALT311.StrType)le.amendedcharge),
    charge_counties_Fields.InValid_amendedchargedate((SALT311.StrType)le.amendedchargedate),
    charge_counties_Fields.InValid_bondsman((SALT311.StrType)le.bondsman),
    charge_counties_Fields.InValid_bondamount((SALT311.StrType)le.bondamount),
    charge_counties_Fields.InValid_bondtype((SALT311.StrType)le.bondtype),
    charge_counties_Fields.InValid_sourcename((SALT311.StrType)le.sourcename),
    charge_counties_Fields.InValid_sourceid((SALT311.StrType)le.sourceid),
    charge_counties_Fields.InValid_vendor((SALT311.StrType)le.vendor),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doSummaryPerSrc = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Crim, charge_counties_Fields, 'RECORDOF(fieldPopulationOverall)', TRUE);
