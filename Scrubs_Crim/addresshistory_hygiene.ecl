...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    addresshistory_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    addresshistory_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    addresshistory_Fields.InValid_street((SALT33.StrType)le.street),
    addresshistory_Fields.InValid_unit((SALT33.StrType)le.unit),
    addresshistory_Fields.InValid_city((SALT33.StrType)le.city),
    addresshistory_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    addresshistory_Fields.InValid_orig_zip((SALT33.StrType)le.orig_zip),
    addresshistory_Fields.InValid_addresstype((SALT33.StrType)le.addresstype),
    addresshistory_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    addresshistory_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    addresshistory_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
