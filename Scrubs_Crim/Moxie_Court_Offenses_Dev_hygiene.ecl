...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_lev((SALT311.StrType)le.arr_off_lev,(SALT311.StrType)le.vendor),
    ...
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_lev((SALT311.StrType)le.court_off_lev,(SALT311.StrType)le.vendor),
