...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_state_origin := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_origin)));
    avelength_state_origin := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_origin)),h.state_origin<>(typeof(h.state_origin))'');
    ...
    maxlength_off_comp := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_comp)));
    avelength_off_comp := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_comp)),h.off_comp<>(typeof(h.off_comp))'');
    populated_off_delete_flag_pcnt := AVE(GROUP,IF(h.off_delete_flag = (TYPEOF(h.off_delete_flag))'',0,100));
    maxlength_off_delete_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_delete_flag)));
    avelength_off_delete_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_delete_flag)),h.off_delete_flag<>(typeof(h.off_delete_flag))'');
    populated_off_date_pcnt := AVE(GROUP,IF(h.off_date = (TYPEOF(h.off_date))'',0,100));
    maxlength_off_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_date)));
    avelength_off_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_date)),h.off_date<>(typeof(h.off_date))'');
    populated_arr_date_pcnt := AVE(GROUP,IF(h.arr_date = (TYPEOF(h.arr_date))'',0,100));
    maxlength_arr_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_date)));
    avelength_arr_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_date)),h.arr_date<>(typeof(h.arr_date))'');
    populated_num_of_counts_pcnt := AVE(GROUP,IF(h.num_of_counts = (TYPEOF(h.num_of_counts))'',0,100));
    maxlength_num_of_counts := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_of_counts)));
    avelength_num_of_counts := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_of_counts)),h.num_of_counts<>(typeof(h.num_of_counts))'');
    populated_le_agency_cd_pcnt := AVE(GROUP,IF(h.le_agency_cd = (TYPEOF(h.le_agency_cd))'',0,100));
    maxlength_le_agency_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_cd)));
    avelength_le_agency_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_cd)),h.le_agency_cd<>(typeof(h.le_agency_cd))'');
    populated_le_agency_desc_pcnt := AVE(GROUP,IF(h.le_agency_desc = (TYPEOF(h.le_agency_desc))'',0,100));
    maxlength_le_agency_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_desc)));
    avelength_le_agency_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_desc)),h.le_agency_desc<>(typeof(h.le_agency_desc))'');
    populated_le_agency_case_number_pcnt := AVE(GROUP,IF(h.le_agency_case_number = (TYPEOF(h.le_agency_case_number))'',0,100));
    maxlength_le_agency_case_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_case_number)));
    avelength_le_agency_case_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.le_agency_case_number)),h.le_agency_case_number<>(typeof(h.le_agency_case_number))'');
    populated_traffic_ticket_number_pcnt := AVE(GROUP,IF(h.traffic_ticket_number = (TYPEOF(h.traffic_ticket_number))'',0,100));
    maxlength_traffic_ticket_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_ticket_number)));
    avelength_traffic_ticket_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_ticket_number)),h.traffic_ticket_number<>(typeof(h.traffic_ticket_number))'');
    populated_traffic_dl_no_pcnt := AVE(GROUP,IF(h.traffic_dl_no = (TYPEOF(h.traffic_dl_no))'',0,100));
    maxlength_traffic_dl_no := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_dl_no)));
    avelength_traffic_dl_no := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_dl_no)),h.traffic_dl_no<>(typeof(h.traffic_dl_no))'');
    populated_traffic_dl_st_pcnt := AVE(GROUP,IF(h.traffic_dl_st = (TYPEOF(h.traffic_dl_st))'',0,100));
    maxlength_traffic_dl_st := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_dl_st)));
    avelength_traffic_dl_st := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.traffic_dl_st)),h.traffic_dl_st<>(typeof(h.traffic_dl_st))'');
    populated_arr_off_code_pcnt := AVE(GROUP,IF(h.arr_off_code = (TYPEOF(h.arr_off_code))'',0,100));
    maxlength_arr_off_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_code)));
    avelength_arr_off_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_code)),h.arr_off_code<>(typeof(h.arr_off_code))'');
    populated_arr_off_desc_1_pcnt := AVE(GROUP,IF(h.arr_off_desc_1 = (TYPEOF(h.arr_off_desc_1))'',0,100));
    maxlength_arr_off_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_desc_1)));
    avelength_arr_off_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_desc_1)),h.arr_off_desc_1<>(typeof(h.arr_off_desc_1))'');
    populated_arr_off_desc_2_pcnt := AVE(GROUP,IF(h.arr_off_desc_2 = (TYPEOF(h.arr_off_desc_2))'',0,100));
    maxlength_arr_off_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_desc_2)));
    avelength_arr_off_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_desc_2)),h.arr_off_desc_2<>(typeof(h.arr_off_desc_2))'');
    populated_arr_off_type_cd_pcnt := AVE(GROUP,IF(h.arr_off_type_cd = (TYPEOF(h.arr_off_type_cd))'',0,100));
    maxlength_arr_off_type_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_type_cd)));
    avelength_arr_off_type_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_type_cd)),h.arr_off_type_cd<>(typeof(h.arr_off_type_cd))'');
    populated_arr_off_type_desc_pcnt := AVE(GROUP,IF(h.arr_off_type_desc = (TYPEOF(h.arr_off_type_desc))'',0,100));
    maxlength_arr_off_type_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_type_desc)));
    avelength_arr_off_type_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_type_desc)),h.arr_off_type_desc<>(typeof(h.arr_off_type_desc))'');
    populated_arr_off_lev_pcnt := AVE(GROUP,IF(h.arr_off_lev = (TYPEOF(h.arr_off_lev))'',0,100));
    maxlength_arr_off_lev := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_lev)));
    avelength_arr_off_lev := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_lev)),h.arr_off_lev<>(typeof(h.arr_off_lev))'');
    populated_arr_statute_pcnt := AVE(GROUP,IF(h.arr_statute = (TYPEOF(h.arr_statute))'',0,100));
    maxlength_arr_statute := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_statute)));
    avelength_arr_statute := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_statute)),h.arr_statute<>(typeof(h.arr_statute))'');
    populated_arr_statute_desc_pcnt := AVE(GROUP,IF(h.arr_statute_desc = (TYPEOF(h.arr_statute_desc))'',0,100));
    maxlength_arr_statute_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_statute_desc)));
    avelength_arr_statute_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_statute_desc)),h.arr_statute_desc<>(typeof(h.arr_statute_desc))'');
    populated_arr_disp_date_pcnt := AVE(GROUP,IF(h.arr_disp_date = (TYPEOF(h.arr_disp_date))'',0,100));
    maxlength_arr_disp_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_date)));
    avelength_arr_disp_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_date)),h.arr_disp_date<>(typeof(h.arr_disp_date))'');
    populated_arr_disp_code_pcnt := AVE(GROUP,IF(h.arr_disp_code = (TYPEOF(h.arr_disp_code))'',0,100));
    maxlength_arr_disp_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_code)));
    avelength_arr_disp_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_code)),h.arr_disp_code<>(typeof(h.arr_disp_code))'');
    populated_arr_disp_desc_1_pcnt := AVE(GROUP,IF(h.arr_disp_desc_1 = (TYPEOF(h.arr_disp_desc_1))'',0,100));
    maxlength_arr_disp_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_1)));
    avelength_arr_disp_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_1)),h.arr_disp_desc_1<>(typeof(h.arr_disp_desc_1))'');
    populated_arr_disp_desc_2_pcnt := AVE(GROUP,IF(h.arr_disp_desc_2 = (TYPEOF(h.arr_disp_desc_2))'',0,100));
    maxlength_arr_disp_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_2)));
    avelength_arr_disp_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_2)),h.arr_disp_desc_2<>(typeof(h.arr_disp_desc_2))'');
    populated_pros_refer_cd_pcnt := AVE(GROUP,IF(h.pros_refer_cd = (TYPEOF(h.pros_refer_cd))'',0,100));
    maxlength_pros_refer_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_refer_cd)));
    avelength_pros_refer_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_refer_cd)),h.pros_refer_cd<>(typeof(h.pros_refer_cd))'');
    populated_pros_refer_pcnt := AVE(GROUP,IF(h.pros_refer = (TYPEOF(h.pros_refer))'',0,100));
    maxlength_pros_refer := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_refer)));
    avelength_pros_refer := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_refer)),h.pros_refer<>(typeof(h.pros_refer))'');
    populated_pros_assgn_cd_pcnt := AVE(GROUP,IF(h.pros_assgn_cd = (TYPEOF(h.pros_assgn_cd))'',0,100));
    maxlength_pros_assgn_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_assgn_cd)));
    avelength_pros_assgn_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_assgn_cd)),h.pros_assgn_cd<>(typeof(h.pros_assgn_cd))'');
    populated_pros_assgn_pcnt := AVE(GROUP,IF(h.pros_assgn = (TYPEOF(h.pros_assgn))'',0,100));
    maxlength_pros_assgn := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_assgn)));
    avelength_pros_assgn := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_assgn)),h.pros_assgn<>(typeof(h.pros_assgn))'');
    populated_pros_chg_rej_pcnt := AVE(GROUP,IF(h.pros_chg_rej = (TYPEOF(h.pros_chg_rej))'',0,100));
    maxlength_pros_chg_rej := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_chg_rej)));
    avelength_pros_chg_rej := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_chg_rej)),h.pros_chg_rej<>(typeof(h.pros_chg_rej))'');
    populated_pros_off_code_pcnt := AVE(GROUP,IF(h.pros_off_code = (TYPEOF(h.pros_off_code))'',0,100));
    maxlength_pros_off_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_code)));
    avelength_pros_off_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_code)),h.pros_off_code<>(typeof(h.pros_off_code))'');
    populated_pros_off_desc_1_pcnt := AVE(GROUP,IF(h.pros_off_desc_1 = (TYPEOF(h.pros_off_desc_1))'',0,100));
    maxlength_pros_off_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_desc_1)));
    avelength_pros_off_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_desc_1)),h.pros_off_desc_1<>(typeof(h.pros_off_desc_1))'');
    populated_pros_off_desc_2_pcnt := AVE(GROUP,IF(h.pros_off_desc_2 = (TYPEOF(h.pros_off_desc_2))'',0,100));
    maxlength_pros_off_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_desc_2)));
    avelength_pros_off_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_desc_2)),h.pros_off_desc_2<>(typeof(h.pros_off_desc_2))'');
    populated_pros_off_type_cd_pcnt := AVE(GROUP,IF(h.pros_off_type_cd = (TYPEOF(h.pros_off_type_cd))'',0,100));
    maxlength_pros_off_type_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_type_cd)));
    avelength_pros_off_type_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_type_cd)),h.pros_off_type_cd<>(typeof(h.pros_off_type_cd))'');
    populated_pros_off_type_desc_pcnt := AVE(GROUP,IF(h.pros_off_type_desc = (TYPEOF(h.pros_off_type_desc))'',0,100));
    maxlength_pros_off_type_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_type_desc)));
    avelength_pros_off_type_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_type_desc)),h.pros_off_type_desc<>(typeof(h.pros_off_type_desc))'');
    populated_pros_off_lev_pcnt := AVE(GROUP,IF(h.pros_off_lev = (TYPEOF(h.pros_off_lev))'',0,100));
    maxlength_pros_off_lev := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_lev)));
    avelength_pros_off_lev := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_off_lev)),h.pros_off_lev<>(typeof(h.pros_off_lev))'');
    populated_pros_act_filed_pcnt := AVE(GROUP,IF(h.pros_act_filed = (TYPEOF(h.pros_act_filed))'',0,100));
    maxlength_pros_act_filed := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_act_filed)));
    avelength_pros_act_filed := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pros_act_filed)),h.pros_act_filed<>(typeof(h.pros_act_filed))'');
    ...
    maxlength_court_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_cd)));
    avelength_court_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_cd)),h.court_cd<>(typeof(h.court_cd))'');
    populated_court_desc_pcnt := AVE(GROUP,IF(h.court_desc = (TYPEOF(h.court_desc))'',0,100));
    maxlength_court_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_desc)));
    avelength_court_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_desc)),h.court_desc<>(typeof(h.court_desc))'');
    populated_court_appeal_flag_pcnt := AVE(GROUP,IF(h.court_appeal_flag = (TYPEOF(h.court_appeal_flag))'',0,100));
    maxlength_court_appeal_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_appeal_flag)));
    avelength_court_appeal_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_appeal_flag)),h.court_appeal_flag<>(typeof(h.court_appeal_flag))'');
    populated_court_final_plea_pcnt := AVE(GROUP,IF(h.court_final_plea = (TYPEOF(h.court_final_plea))'',0,100));
    maxlength_court_final_plea := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_final_plea)));
    avelength_court_final_plea := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_final_plea)),h.court_final_plea<>(typeof(h.court_final_plea))'');
    populated_court_off_code_pcnt := AVE(GROUP,IF(h.court_off_code = (TYPEOF(h.court_off_code))'',0,100));
    maxlength_court_off_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_code)));
    avelength_court_off_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_code)),h.court_off_code<>(typeof(h.court_off_code))'');
    populated_court_off_desc_1_pcnt := AVE(GROUP,IF(h.court_off_desc_1 = (TYPEOF(h.court_off_desc_1))'',0,100));
    maxlength_court_off_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_desc_1)));
    avelength_court_off_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_desc_1)),h.court_off_desc_1<>(typeof(h.court_off_desc_1))'');
    populated_court_off_desc_2_pcnt := AVE(GROUP,IF(h.court_off_desc_2 = (TYPEOF(h.court_off_desc_2))'',0,100));
    maxlength_court_off_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_desc_2)));
    avelength_court_off_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_desc_2)),h.court_off_desc_2<>(typeof(h.court_off_desc_2))'');
    populated_court_off_type_cd_pcnt := AVE(GROUP,IF(h.court_off_type_cd = (TYPEOF(h.court_off_type_cd))'',0,100));
    maxlength_court_off_type_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_type_cd)));
    avelength_court_off_type_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_type_cd)),h.court_off_type_cd<>(typeof(h.court_off_type_cd))'');
    populated_court_off_type_desc_pcnt := AVE(GROUP,IF(h.court_off_type_desc = (TYPEOF(h.court_off_type_desc))'',0,100));
    maxlength_court_off_type_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_type_desc)));
    avelength_court_off_type_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_type_desc)),h.court_off_type_desc<>(typeof(h.court_off_type_desc))'');
    populated_court_off_lev_pcnt := AVE(GROUP,IF(h.court_off_lev = (TYPEOF(h.court_off_lev))'',0,100));
    maxlength_court_off_lev := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_lev)));
    avelength_court_off_lev := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_lev)),h.court_off_lev<>(typeof(h.court_off_lev))'');
    populated_court_statute_pcnt := AVE(GROUP,IF(h.court_statute = (TYPEOF(h.court_statute))'',0,100));
    maxlength_court_statute := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_statute)));
    avelength_court_statute := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_statute)),h.court_statute<>(typeof(h.court_statute))'');
    ...
    maxlength_court_additional_statutes := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_additional_statutes)));
    avelength_court_additional_statutes := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_additional_statutes)),h.court_additional_statutes<>(typeof(h.court_additional_statutes))'');
    populated_court_statute_desc_pcnt := AVE(GROUP,IF(h.court_statute_desc = (TYPEOF(h.court_statute_desc))'',0,100));
    maxlength_court_statute_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_statute_desc)));
    avelength_court_statute_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_statute_desc)),h.court_statute_desc<>(typeof(h.court_statute_desc))'');
    populated_court_disp_date_pcnt := AVE(GROUP,IF(h.court_disp_date = (TYPEOF(h.court_disp_date))'',0,100));
    maxlength_court_disp_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_date)));
    avelength_court_disp_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_date)),h.court_disp_date<>(typeof(h.court_disp_date))'');
    populated_court_disp_code_pcnt := AVE(GROUP,IF(h.court_disp_code = (TYPEOF(h.court_disp_code))'',0,100));
    maxlength_court_disp_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_code)));
    avelength_court_disp_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_code)),h.court_disp_code<>(typeof(h.court_disp_code))'');
    populated_court_disp_desc_1_pcnt := AVE(GROUP,IF(h.court_disp_desc_1 = (TYPEOF(h.court_disp_desc_1))'',0,100));
    maxlength_court_disp_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_desc_1)));
    avelength_court_disp_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_desc_1)),h.court_disp_desc_1<>(typeof(h.court_disp_desc_1))'');
    populated_court_disp_desc_2_pcnt := AVE(GROUP,IF(h.court_disp_desc_2 = (TYPEOF(h.court_disp_desc_2))'',0,100));
    maxlength_court_disp_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_desc_2)));
    avelength_court_disp_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_disp_desc_2)),h.court_disp_desc_2<>(typeof(h.court_disp_desc_2))'');
    ...
    maxlength_sent_jail := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_jail)));
    avelength_sent_jail := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_jail)),h.sent_jail<>(typeof(h.sent_jail))'');
    populated_sent_susp_time_pcnt := AVE(GROUP,IF(h.sent_susp_time = (TYPEOF(h.sent_susp_time))'',0,100));
    maxlength_sent_susp_time := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_susp_time)));
    avelength_sent_susp_time := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_susp_time)),h.sent_susp_time<>(typeof(h.sent_susp_time))'');
    populated_sent_court_cost_pcnt := AVE(GROUP,IF(h.sent_court_cost = (TYPEOF(h.sent_court_cost))'',0,100));
    maxlength_sent_court_cost := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_court_cost)));
    avelength_sent_court_cost := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_court_cost)),h.sent_court_cost<>(typeof(h.sent_court_cost))'');
    populated_sent_court_fine_pcnt := AVE(GROUP,IF(h.sent_court_fine = (TYPEOF(h.sent_court_fine))'',0,100));
    maxlength_sent_court_fine := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_court_fine)));
    avelength_sent_court_fine := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_court_fine)),h.sent_court_fine<>(typeof(h.sent_court_fine))'');
    populated_sent_susp_court_fine_pcnt := AVE(GROUP,IF(h.sent_susp_court_fine = (TYPEOF(h.sent_susp_court_fine))'',0,100));
    maxlength_sent_susp_court_fine := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_susp_court_fine)));
    avelength_sent_susp_court_fine := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_susp_court_fine)),h.sent_susp_court_fine<>(typeof(h.sent_susp_court_fine))'');
    populated_sent_probation_pcnt := AVE(GROUP,IF(h.sent_probation = (TYPEOF(h.sent_probation))'',0,100));
    maxlength_sent_probation := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_probation)));
    avelength_sent_probation := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_probation)),h.sent_probation<>(typeof(h.sent_probation))'');
    populated_sent_addl_prov_code_pcnt := AVE(GROUP,IF(h.sent_addl_prov_code = (TYPEOF(h.sent_addl_prov_code))'',0,100));
    maxlength_sent_addl_prov_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_code)));
    avelength_sent_addl_prov_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_code)),h.sent_addl_prov_code<>(typeof(h.sent_addl_prov_code))'');
    populated_sent_addl_prov_desc_1_pcnt := AVE(GROUP,IF(h.sent_addl_prov_desc_1 = (TYPEOF(h.sent_addl_prov_desc_1))'',0,100));
    maxlength_sent_addl_prov_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_desc_1)));
    avelength_sent_addl_prov_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_desc_1)),h.sent_addl_prov_desc_1<>(typeof(h.sent_addl_prov_desc_1))'');
    populated_sent_addl_prov_desc_2_pcnt := AVE(GROUP,IF(h.sent_addl_prov_desc_2 = (TYPEOF(h.sent_addl_prov_desc_2))'',0,100));
    maxlength_sent_addl_prov_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_desc_2)));
    avelength_sent_addl_prov_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_addl_prov_desc_2)),h.sent_addl_prov_desc_2<>(typeof(h.sent_addl_prov_desc_2))'');
    populated_sent_consec_pcnt := AVE(GROUP,IF(h.sent_consec = (TYPEOF(h.sent_consec))'',0,100));
    maxlength_sent_consec := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_consec)));
    avelength_sent_consec := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_consec)),h.sent_consec<>(typeof(h.sent_consec))'');
    populated_sent_agency_rec_cust_ori_pcnt := AVE(GROUP,IF(h.sent_agency_rec_cust_ori = (TYPEOF(h.sent_agency_rec_cust_ori))'',0,100));
    maxlength_sent_agency_rec_cust_ori := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_agency_rec_cust_ori)));
    avelength_sent_agency_rec_cust_ori := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_agency_rec_cust_ori)),h.sent_agency_rec_cust_ori<>(typeof(h.sent_agency_rec_cust_ori))'');
    populated_sent_agency_rec_cust_pcnt := AVE(GROUP,IF(h.sent_agency_rec_cust = (TYPEOF(h.sent_agency_rec_cust))'',0,100));
    maxlength_sent_agency_rec_cust := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_agency_rec_cust)));
    avelength_sent_agency_rec_cust := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sent_agency_rec_cust)),h.sent_agency_rec_cust<>(typeof(h.sent_agency_rec_cust))'');
    populated_appeal_date_pcnt := AVE(GROUP,IF(h.appeal_date = (TYPEOF(h.appeal_date))'',0,100));
    maxlength_appeal_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_date)));
    avelength_appeal_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_date)),h.appeal_date<>(typeof(h.appeal_date))'');
    populated_appeal_off_disp_pcnt := AVE(GROUP,IF(h.appeal_off_disp = (TYPEOF(h.appeal_off_disp))'',0,100));
    maxlength_appeal_off_disp := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_off_disp)));
    avelength_appeal_off_disp := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_off_disp)),h.appeal_off_disp<>(typeof(h.appeal_off_disp))'');
    populated_appeal_final_decision_pcnt := AVE(GROUP,IF(h.appeal_final_decision = (TYPEOF(h.appeal_final_decision))'',0,100));
    maxlength_appeal_final_decision := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_final_decision)));
    avelength_appeal_final_decision := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.appeal_final_decision)),h.appeal_final_decision<>(typeof(h.appeal_final_decision))'');
    populated_convict_dt_pcnt := AVE(GROUP,IF(h.convict_dt = (TYPEOF(h.convict_dt))'',0,100));
    maxlength_convict_dt := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.convict_dt)));
    avelength_convict_dt := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.convict_dt)),h.convict_dt<>(typeof(h.convict_dt))'');
    populated_offense_town_pcnt := AVE(GROUP,IF(h.offense_town = (TYPEOF(h.offense_town))'',0,100));
    maxlength_offense_town := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.offense_town)));
    avelength_offense_town := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.offense_town)),h.offense_town<>(typeof(h.offense_town))'');
    populated_cty_conv_pcnt := AVE(GROUP,IF(h.cty_conv = (TYPEOF(h.cty_conv))'',0,100));
    maxlength_cty_conv := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cty_conv)));
    avelength_cty_conv := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cty_conv)),h.cty_conv<>(typeof(h.cty_conv))'');
    ...
    maxlength_community_service := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.community_service)));
    avelength_community_service := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.community_service)),h.community_service<>(typeof(h.community_service))'');
    populated_parole_pcnt := AVE(GROUP,IF(h.parole = (TYPEOF(h.parole))'',0,100));
    maxlength_parole := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.parole)));
    avelength_parole := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.parole)),h.parole<>(typeof(h.parole))'');
    populated_addl_sent_dates_pcnt := AVE(GROUP,IF(h.addl_sent_dates = (TYPEOF(h.addl_sent_dates))'',0,100));
    maxlength_addl_sent_dates := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.addl_sent_dates)));
    avelength_addl_sent_dates := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.addl_sent_dates)),h.addl_sent_dates<>(typeof(h.addl_sent_dates))'');
    populated_probation_desc2_pcnt := AVE(GROUP,IF(h.probation_desc2 = (TYPEOF(h.probation_desc2))'',0,100));
    maxlength_probation_desc2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.probation_desc2)));
    avelength_probation_desc2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.probation_desc2)),h.probation_desc2<>(typeof(h.probation_desc2))'');
    populated_court_dt_pcnt := AVE(GROUP,IF(h.court_dt = (TYPEOF(h.court_dt))'',0,100));
    maxlength_court_dt := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_dt)));
    avelength_court_dt := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_dt)),h.court_dt<>(typeof(h.court_dt))'');
    populated_court_county_pcnt := AVE(GROUP,IF(h.court_county = (TYPEOF(h.court_county))'',0,100));
    maxlength_court_county := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_county)));
    avelength_court_county := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_county)),h.court_county<>(typeof(h.court_county))'');
    populated_arr_off_lev_mapped_pcnt := AVE(GROUP,IF(h.arr_off_lev_mapped = (TYPEOF(h.arr_off_lev_mapped))'',0,100));
    maxlength_arr_off_lev_mapped := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_lev_mapped)));
    avelength_arr_off_lev_mapped := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_off_lev_mapped)),h.arr_off_lev_mapped<>(typeof(h.arr_off_lev_mapped))'');
    populated_court_off_lev_mapped_pcnt := AVE(GROUP,IF(h.court_off_lev_mapped = (TYPEOF(h.court_off_lev_mapped))'',0,100));
    maxlength_court_off_lev_mapped := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_lev_mapped)));
    avelength_court_off_lev_mapped := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.court_off_lev_mapped)),h.court_off_lev_mapped<>(typeof(h.court_off_lev_mapped))'');
    populated_fcra_offense_key_pcnt := AVE(GROUP,IF(h.fcra_offense_key = (TYPEOF(h.fcra_offense_key))'',0,100));
    maxlength_fcra_offense_key := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcra_offense_key)));
    avelength_fcra_offense_key := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcra_offense_key)),h.fcra_offense_key<>(typeof(h.fcra_offense_key))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Src := le.vendor;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.state_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.off_comp),TRIM((SALT33.StrType)le.off_delete_flag),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.le_agency_cd),TRIM((SALT33.StrType)le.le_agency_desc),TRIM((SALT33.StrType)le.le_agency_case_number),TRIM((SALT33.StrType)le.traffic_ticket_number),TRIM((SALT33.StrType)le.traffic_dl_no),TRIM((SALT33.StrType)le.traffic_dl_st),TRIM((SALT33.StrType)le.arr_off_code),TRIM((SALT33.StrType)le.arr_off_desc_1),TRIM((SALT33.StrType)le.arr_off_desc_2),TRIM((SALT33.StrType)le.arr_off_type_cd),TRIM((SALT33.StrType)le.arr_off_type_desc),TRIM((SALT33.StrType)le.arr_off_lev),TRIM((SALT33.StrType)le.arr_statute),TRIM((SALT33.StrType)le.arr_statute_desc),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_code),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.pros_refer_cd),TRIM((SALT33.StrType)le.pros_refer),TRIM((SALT33.StrType)le.pros_assgn_cd),TRIM((SALT33.StrType)le.pros_assgn),TRIM((SALT33.StrType)le.pros_chg_rej),TRIM((SALT33.StrType)le.pros_off_code),TRIM((SALT33.StrType)le.pros_off_desc_1),TRIM((SALT33.StrType)le.pros_off_desc_2),TRIM((SALT33.StrType)le.pros_off_type_cd),TRIM((SALT33.StrType)le.pros_off_type_desc),TRIM((SALT33.StrType)le.pros_off_lev),TRIM((SALT33.StrType)le.pros_act_filed),TRIM((SALT33.StrType)le.court_case_number),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.court_appeal_flag),TRIM((SALT33.StrType)le.court_final_plea),TRIM((SALT33.StrType)le.court_off_code),TRIM((SALT33.StrType)le.court_off_desc_1),TRIM((SALT33.StrType)le.court_off_desc_2),TRIM((SALT33.StrType)le.court_off_type_cd),TRIM((SALT33.StrType)le.court_off_type_desc),TRIM((SALT33.StrType)le.court_off_lev),TRIM((SALT33.StrType)le.court_statute),TRIM((SALT33.StrType)le.court_additional_statutes),TRIM((SALT33.StrType)le.court_statute_desc),TRIM((SALT33.StrType)le.court_disp_date),TRIM((SALT33.StrType)le.court_disp_code),TRIM((SALT33.StrType)le.court_disp_desc_1),TRIM((SALT33.StrType)le.court_disp_desc_2),TRIM((SALT33.StrType)le.sent_date),TRIM((SALT33.StrType)le.sent_jail),TRIM((SALT33.StrType)le.sent_susp_time),TRIM((SALT33.StrType)le.sent_court_cost),TRIM((SALT33.StrType)le.sent_court_fine),TRIM((SALT33.StrType)le.sent_susp_court_fine),TRIM((SALT33.StrType)le.sent_probation),TRIM((SALT33.StrType)le.sent_addl_prov_code),TRIM((SALT33.StrType)le.sent_addl_prov_desc_1),TRIM((SALT33.StrType)le.sent_addl_prov_desc_2),TRIM((SALT33.StrType)le.sent_consec),TRIM((SALT33.StrType)le.sent_agency_rec_cust_ori),TRIM((SALT33.StrType)le.sent_agency_rec_cust),TRIM((SALT33.StrType)le.appeal_date),TRIM((SALT33.StrType)le.appeal_off_disp),TRIM((SALT33.StrType)le.appeal_final_decision),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.offense_town),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.community_service),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.addl_sent_dates),TRIM((SALT33.StrType)le.probation_desc2),TRIM((SALT33.StrType)le.court_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.arr_off_lev_mapped),TRIM((SALT33.StrType)le.court_off_lev_mapped),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), '')));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 97);
  SELF.FldNo2 := 1 + (C % 97);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.state_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.off_comp),TRIM((SALT33.StrType)le.off_delete_flag),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.le_agency_cd),TRIM((SALT33.StrType)le.le_agency_desc),TRIM((SALT33.StrType)le.le_agency_case_number),TRIM((SALT33.StrType)le.traffic_ticket_number),TRIM((SALT33.StrType)le.traffic_dl_no),TRIM((SALT33.StrType)le.traffic_dl_st),TRIM((SALT33.StrType)le.arr_off_code),TRIM((SALT33.StrType)le.arr_off_desc_1),TRIM((SALT33.StrType)le.arr_off_desc_2),TRIM((SALT33.StrType)le.arr_off_type_cd),TRIM((SALT33.StrType)le.arr_off_type_desc),TRIM((SALT33.StrType)le.arr_off_lev),TRIM((SALT33.StrType)le.arr_statute),TRIM((SALT33.StrType)le.arr_statute_desc),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_code),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.pros_refer_cd),TRIM((SALT33.StrType)le.pros_refer),TRIM((SALT33.StrType)le.pros_assgn_cd),TRIM((SALT33.StrType)le.pros_assgn),TRIM((SALT33.StrType)le.pros_chg_rej),TRIM((SALT33.StrType)le.pros_off_code),TRIM((SALT33.StrType)le.pros_off_desc_1),TRIM((SALT33.StrType)le.pros_off_desc_2),TRIM((SALT33.StrType)le.pros_off_type_cd),TRIM((SALT33.StrType)le.pros_off_type_desc),TRIM((SALT33.StrType)le.pros_off_lev),TRIM((SALT33.StrType)le.pros_act_filed),TRIM((SALT33.StrType)le.court_case_number),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.court_appeal_flag),TRIM((SALT33.StrType)le.court_final_plea),TRIM((SALT33.StrType)le.court_off_code),TRIM((SALT33.StrType)le.court_off_desc_1),TRIM((SALT33.StrType)le.court_off_desc_2),TRIM((SALT33.StrType)le.court_off_type_cd),TRIM((SALT33.StrType)le.court_off_type_desc),TRIM((SALT33.StrType)le.court_off_lev),TRIM((SALT33.StrType)le.court_statute),TRIM((SALT33.StrType)le.court_additional_statutes),TRIM((SALT33.StrType)le.court_statute_desc),TRIM((SALT33.StrType)le.court_disp_date),TRIM((SALT33.StrType)le.court_disp_code),TRIM((SALT33.StrType)le.court_disp_desc_1),TRIM((SALT33.StrType)le.court_disp_desc_2),TRIM((SALT33.StrType)le.sent_date),TRIM((SALT33.StrType)le.sent_jail),TRIM((SALT33.StrType)le.sent_susp_time),TRIM((SALT33.StrType)le.sent_court_cost),TRIM((SALT33.StrType)le.sent_court_fine),TRIM((SALT33.StrType)le.sent_susp_court_fine),TRIM((SALT33.StrType)le.sent_probation),TRIM((SALT33.StrType)le.sent_addl_prov_code),TRIM((SALT33.StrType)le.sent_addl_prov_desc_1),TRIM((SALT33.StrType)le.sent_addl_prov_desc_2),TRIM((SALT33.StrType)le.sent_consec),TRIM((SALT33.StrType)le.sent_agency_rec_cust_ori),TRIM((SALT33.StrType)le.sent_agency_rec_cust),TRIM((SALT33.StrType)le.appeal_date),TRIM((SALT33.StrType)le.appeal_off_disp),TRIM((SALT33.StrType)le.appeal_final_decision),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.offense_town),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.community_service),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.addl_sent_dates),TRIM((SALT33.StrType)le.probation_desc2),TRIM((SALT33.StrType)le.court_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.arr_off_lev_mapped),TRIM((SALT33.StrType)le.court_off_lev_mapped),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), '')));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.state_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.off_comp),TRIM((SALT33.StrType)le.off_delete_flag),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.le_agency_cd),TRIM((SALT33.StrType)le.le_agency_desc),TRIM((SALT33.StrType)le.le_agency_case_number),TRIM((SALT33.StrType)le.traffic_ticket_number),TRIM((SALT33.StrType)le.traffic_dl_no),TRIM((SALT33.StrType)le.traffic_dl_st),TRIM((SALT33.StrType)le.arr_off_code),TRIM((SALT33.StrType)le.arr_off_desc_1),TRIM((SALT33.StrType)le.arr_off_desc_2),TRIM((SALT33.StrType)le.arr_off_type_cd),TRIM((SALT33.StrType)le.arr_off_type_desc),TRIM((SALT33.StrType)le.arr_off_lev),TRIM((SALT33.StrType)le.arr_statute),TRIM((SALT33.StrType)le.arr_statute_desc),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_code),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.pros_refer_cd),TRIM((SALT33.StrType)le.pros_refer),TRIM((SALT33.StrType)le.pros_assgn_cd),TRIM((SALT33.StrType)le.pros_assgn),TRIM((SALT33.StrType)le.pros_chg_rej),TRIM((SALT33.StrType)le.pros_off_code),TRIM((SALT33.StrType)le.pros_off_desc_1),TRIM((SALT33.StrType)le.pros_off_desc_2),TRIM((SALT33.StrType)le.pros_off_type_cd),TRIM((SALT33.StrType)le.pros_off_type_desc),TRIM((SALT33.StrType)le.pros_off_lev),TRIM((SALT33.StrType)le.pros_act_filed),TRIM((SALT33.StrType)le.court_case_number),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.court_appeal_flag),TRIM((SALT33.StrType)le.court_final_plea),TRIM((SALT33.StrType)le.court_off_code),TRIM((SALT33.StrType)le.court_off_desc_1),TRIM((SALT33.StrType)le.court_off_desc_2),TRIM((SALT33.StrType)le.court_off_type_cd),TRIM((SALT33.StrType)le.court_off_type_desc),TRIM((SALT33.StrType)le.court_off_lev),TRIM((SALT33.StrType)le.court_statute),TRIM((SALT33.StrType)le.court_additional_statutes),TRIM((SALT33.StrType)le.court_statute_desc),TRIM((SALT33.StrType)le.court_disp_date),TRIM((SALT33.StrType)le.court_disp_code),TRIM((SALT33.StrType)le.court_disp_desc_1),TRIM((SALT33.StrType)le.court_disp_desc_2),TRIM((SALT33.StrType)le.sent_date),TRIM((SALT33.StrType)le.sent_jail),TRIM((SALT33.StrType)le.sent_susp_time),TRIM((SALT33.StrType)le.sent_court_cost),TRIM((SALT33.StrType)le.sent_court_fine),TRIM((SALT33.StrType)le.sent_susp_court_fine),TRIM((SALT33.StrType)le.sent_probation),TRIM((SALT33.StrType)le.sent_addl_prov_code),TRIM((SALT33.StrType)le.sent_addl_prov_desc_1),TRIM((SALT33.StrType)le.sent_addl_prov_desc_2),TRIM((SALT33.StrType)le.sent_consec),TRIM((SALT33.StrType)le.sent_agency_rec_cust_ori),TRIM((SALT33.StrType)le.sent_agency_rec_cust),TRIM((SALT33.StrType)le.appeal_date),TRIM((SALT33.StrType)le.appeal_off_disp),TRIM((SALT33.StrType)le.appeal_final_decision),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.offense_town),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.community_service),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.addl_sent_dates),TRIM((SALT33.StrType)le.probation_desc2),TRIM((SALT33.StrType)le.court_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.arr_off_lev_mapped),TRIM((SALT33.StrType)le.court_off_lev_mapped),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), '')));
  END;
...
SHARED FldIds := DATASET([{1,'process_date'}
      ...
      ,{97,'offense_category'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Moxie_Court_Offenses_Dev_Fields.InValid_process_date((SALT33.StrType)le.process_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_offender_key((SALT33.StrType)le.offender_key),
    Moxie_Court_Offenses_Dev_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    Moxie_Court_Offenses_Dev_Fields.InValid_state_origin((SALT33.StrType)le.state_origin),
    Moxie_Court_Offenses_Dev_Fields.InValid_source_file((SALT33.StrType)le.source_file),
    Moxie_Court_Offenses_Dev_Fields.InValid_data_type((SALT33.StrType)le.data_type),
    Moxie_Court_Offenses_Dev_Fields.InValid_off_comp((SALT33.StrType)le.off_comp),
    Moxie_Court_Offenses_Dev_Fields.InValid_off_delete_flag((SALT33.StrType)le.off_delete_flag),
    Moxie_Court_Offenses_Dev_Fields.InValid_off_date((SALT33.StrType)le.off_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_date((SALT33.StrType)le.arr_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_num_of_counts((SALT33.StrType)le.num_of_counts),
    Moxie_Court_Offenses_Dev_Fields.InValid_le_agency_cd((SALT33.StrType)le.le_agency_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_le_agency_desc((SALT33.StrType)le.le_agency_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_le_agency_case_number((SALT33.StrType)le.le_agency_case_number),
    Moxie_Court_Offenses_Dev_Fields.InValid_traffic_ticket_number((SALT33.StrType)le.traffic_ticket_number),
    Moxie_Court_Offenses_Dev_Fields.InValid_traffic_dl_no((SALT33.StrType)le.traffic_dl_no),
    Moxie_Court_Offenses_Dev_Fields.InValid_traffic_dl_st((SALT33.StrType)le.traffic_dl_st),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_code((SALT33.StrType)le.arr_off_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_desc_1((SALT33.StrType)le.arr_off_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_desc_2((SALT33.StrType)le.arr_off_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_type_cd((SALT33.StrType)le.arr_off_type_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_type_desc((SALT33.StrType)le.arr_off_type_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_lev((SALT33.StrType)le.arr_off_lev,(SALT33.StrType)le.vendor),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_statute((SALT33.StrType)le.arr_statute),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_statute_desc((SALT33.StrType)le.arr_statute_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_disp_date((SALT33.StrType)le.arr_disp_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_disp_code((SALT33.StrType)le.arr_disp_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_disp_desc_1((SALT33.StrType)le.arr_disp_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_disp_desc_2((SALT33.StrType)le.arr_disp_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_refer_cd((SALT33.StrType)le.pros_refer_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_refer((SALT33.StrType)le.pros_refer),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_assgn_cd((SALT33.StrType)le.pros_assgn_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_assgn((SALT33.StrType)le.pros_assgn),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_chg_rej((SALT33.StrType)le.pros_chg_rej),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_code((SALT33.StrType)le.pros_off_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_desc_1((SALT33.StrType)le.pros_off_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_desc_2((SALT33.StrType)le.pros_off_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_type_cd((SALT33.StrType)le.pros_off_type_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_type_desc((SALT33.StrType)le.pros_off_type_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_off_lev((SALT33.StrType)le.pros_off_lev),
    Moxie_Court_Offenses_Dev_Fields.InValid_pros_act_filed((SALT33.StrType)le.pros_act_filed),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_case_number((SALT33.StrType)le.court_case_number),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_cd((SALT33.StrType)le.court_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_desc((SALT33.StrType)le.court_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_appeal_flag((SALT33.StrType)le.court_appeal_flag),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_final_plea((SALT33.StrType)le.court_final_plea),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_code((SALT33.StrType)le.court_off_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_desc_1((SALT33.StrType)le.court_off_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_desc_2((SALT33.StrType)le.court_off_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_type_cd((SALT33.StrType)le.court_off_type_cd),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_type_desc((SALT33.StrType)le.court_off_type_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_lev((SALT33.StrType)le.court_off_lev,(SALT33.StrType)le.vendor),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_statute((SALT33.StrType)le.court_statute),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_additional_statutes((SALT33.StrType)le.court_additional_statutes),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_statute_desc((SALT33.StrType)le.court_statute_desc),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_disp_date((SALT33.StrType)le.court_disp_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_disp_code((SALT33.StrType)le.court_disp_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_disp_desc_1((SALT33.StrType)le.court_disp_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_disp_desc_2((SALT33.StrType)le.court_disp_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_date((SALT33.StrType)le.sent_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_jail((SALT33.StrType)le.sent_jail),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_susp_time((SALT33.StrType)le.sent_susp_time),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_court_cost((SALT33.StrType)le.sent_court_cost),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_court_fine((SALT33.StrType)le.sent_court_fine),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_susp_court_fine((SALT33.StrType)le.sent_susp_court_fine),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_probation((SALT33.StrType)le.sent_probation),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_addl_prov_code((SALT33.StrType)le.sent_addl_prov_code),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_addl_prov_desc_1((SALT33.StrType)le.sent_addl_prov_desc_1),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_addl_prov_desc_2((SALT33.StrType)le.sent_addl_prov_desc_2),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_consec((SALT33.StrType)le.sent_consec),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_agency_rec_cust_ori((SALT33.StrType)le.sent_agency_rec_cust_ori),
    Moxie_Court_Offenses_Dev_Fields.InValid_sent_agency_rec_cust((SALT33.StrType)le.sent_agency_rec_cust),
    Moxie_Court_Offenses_Dev_Fields.InValid_appeal_date((SALT33.StrType)le.appeal_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_appeal_off_disp((SALT33.StrType)le.appeal_off_disp),
    Moxie_Court_Offenses_Dev_Fields.InValid_appeal_final_decision((SALT33.StrType)le.appeal_final_decision),
    Moxie_Court_Offenses_Dev_Fields.InValid_convict_dt((SALT33.StrType)le.convict_dt),
    Moxie_Court_Offenses_Dev_Fields.InValid_offense_town((SALT33.StrType)le.offense_town),
    Moxie_Court_Offenses_Dev_Fields.InValid_cty_conv((SALT33.StrType)le.cty_conv),
    Moxie_Court_Offenses_Dev_Fields.InValid_restitution((SALT33.StrType)le.restitution),
    Moxie_Court_Offenses_Dev_Fields.InValid_community_service((SALT33.StrType)le.community_service),
    Moxie_Court_Offenses_Dev_Fields.InValid_parole((SALT33.StrType)le.parole),
    Moxie_Court_Offenses_Dev_Fields.InValid_addl_sent_dates((SALT33.StrType)le.addl_sent_dates),
    Moxie_Court_Offenses_Dev_Fields.InValid_probation_desc2((SALT33.StrType)le.probation_desc2),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_dt((SALT33.StrType)le.court_dt),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_county((SALT33.StrType)le.court_county),
    Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_lev_mapped((SALT33.StrType)le.arr_off_lev_mapped),
    Moxie_Court_Offenses_Dev_Fields.InValid_court_off_lev_mapped((SALT33.StrType)le.court_off_lev_mapped),
    Moxie_Court_Offenses_Dev_Fields.InValid_fcra_offense_key((SALT33.StrType)le.fcra_offense_key),
    Moxie_Court_Offenses_Dev_Fields.InValid_fcra_conviction_flag((SALT33.StrType)le.fcra_conviction_flag),
    Moxie_Court_Offenses_Dev_Fields.InValid_fcra_traffic_flag((SALT33.StrType)le.fcra_traffic_flag),
    Moxie_Court_Offenses_Dev_Fields.InValid_fcra_date((SALT33.StrType)le.fcra_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_fcra_date_type((SALT33.StrType)le.fcra_date_type),
    Moxie_Court_Offenses_Dev_Fields.InValid_conviction_override_date((SALT33.StrType)le.conviction_override_date),
    Moxie_Court_Offenses_Dev_Fields.InValid_conviction_override_date_type((SALT33.StrType)le.conviction_override_date_type),
    Moxie_Court_Offenses_Dev_Fields.InValid_offense_score((SALT33.StrType)le.offense_score),
    Moxie_Court_Offenses_Dev_Fields.InValid_offense_persistent_id((SALT33.StrType)le.offense_persistent_id),
    Moxie_Court_Offenses_Dev_Fields.InValid_offense_category((SALT33.StrType)le.offense_category),
    0);
