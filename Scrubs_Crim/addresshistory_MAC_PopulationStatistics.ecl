...
EXPORT addresshistory_MAC_PopulationStatistics(infile,Ref='',vendor='',Input_recordid = '',Input_statecode = '',Input_street = '',Input_unit = '',Input_city = '',Input_orig_state = '',Input_orig_zip = '',Input_addresstype = '',Input_sourcename = '',Input_sourceid = '',Input_vendor = '',OutFile) := MACRO
