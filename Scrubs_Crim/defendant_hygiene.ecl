...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    defendant_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    defendant_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    defendant_Fields.InValid_sourcetype((SALT33.StrType)le.sourcetype),
    defendant_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    defendant_Fields.InValid_recordtype((SALT33.StrType)le.recordtype),
    defendant_Fields.InValid_recorduploaddate((SALT33.StrType)le.recorduploaddate),
    defendant_Fields.InValid_docnumber((SALT33.StrType)le.docnumber),
    defendant_Fields.InValid_fbinumber((SALT33.StrType)le.fbinumber),
    defendant_Fields.InValid_stateidnumber((SALT33.StrType)le.stateidnumber),
    defendant_Fields.InValid_inmatenumber((SALT33.StrType)le.inmatenumber),
    defendant_Fields.InValid_aliennumber((SALT33.StrType)le.aliennumber),
    defendant_Fields.InValid_orig_ssn((SALT33.StrType)le.orig_ssn),
    defendant_Fields.InValid_nametype((SALT33.StrType)le.nametype),
    defendant_Fields.InValid_name((SALT33.StrType)le.name),
    defendant_Fields.InValid_lastname((SALT33.StrType)le.lastname),
    defendant_Fields.InValid_firstname((SALT33.StrType)le.firstname),
    defendant_Fields.InValid_middlename((SALT33.StrType)le.middlename),
    defendant_Fields.InValid_suffix((SALT33.StrType)le.suffix),
    defendant_Fields.InValid_defendantstatus((SALT33.StrType)le.defendantstatus),
    defendant_Fields.InValid_defendantadditionalinfo((SALT33.StrType)le.defendantadditionalinfo),
    defendant_Fields.InValid_dob((SALT33.StrType)le.dob),
    defendant_Fields.InValid_birthcity((SALT33.StrType)le.birthcity),
    defendant_Fields.InValid_birthplace((SALT33.StrType)le.birthplace),
    defendant_Fields.InValid_age((SALT33.StrType)le.age),
    defendant_Fields.InValid_gender((SALT33.StrType)le.gender),
    defendant_Fields.InValid_height((SALT33.StrType)le.height),
    defendant_Fields.InValid_weight((SALT33.StrType)le.weight),
    defendant_Fields.InValid_haircolor((SALT33.StrType)le.haircolor),
    defendant_Fields.InValid_eyecolor((SALT33.StrType)le.eyecolor),
    defendant_Fields.InValid_race((SALT33.StrType)le.race),
    defendant_Fields.InValid_ethnicity((SALT33.StrType)le.ethnicity),
    defendant_Fields.InValid_skincolor((SALT33.StrType)le.skincolor),
    defendant_Fields.InValid_bodymarks((SALT33.StrType)le.bodymarks),
    defendant_Fields.InValid_physicalbuild((SALT33.StrType)le.physicalbuild),
    defendant_Fields.InValid_photoname((SALT33.StrType)le.photoname),
    defendant_Fields.InValid_dlnumber((SALT33.StrType)le.dlnumber),
    defendant_Fields.InValid_dlstate((SALT33.StrType)le.dlstate),
    defendant_Fields.InValid_phone((SALT33.StrType)le.phone),
    defendant_Fields.InValid_phonetype((SALT33.StrType)le.phonetype),
    defendant_Fields.InValid_uscitizenflag((SALT33.StrType)le.uscitizenflag),
    defendant_Fields.InValid_addresstype((SALT33.StrType)le.addresstype),
    defendant_Fields.InValid_street((SALT33.StrType)le.street),
    defendant_Fields.InValid_unit((SALT33.StrType)le.unit),
    defendant_Fields.InValid_city((SALT33.StrType)le.city),
    defendant_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    defendant_Fields.InValid_orig_zip((SALT33.StrType)le.orig_zip),
    defendant_Fields.InValid_county((SALT33.StrType)le.county),
    defendant_Fields.InValid_institutionname((SALT33.StrType)le.institutionname),
    defendant_Fields.InValid_institutiondetails((SALT33.StrType)le.institutiondetails),
    defendant_Fields.InValid_institutionreceiptdate((SALT33.StrType)le.institutionreceiptdate),
    defendant_Fields.InValid_releasetolocation((SALT33.StrType)le.releasetolocation),
    defendant_Fields.InValid_releasetodetails((SALT33.StrType)le.releasetodetails),
    defendant_Fields.InValid_deceasedflag((SALT33.StrType)le.deceasedflag),
    defendant_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate),
    defendant_Fields.InValid_healthflag((SALT33.StrType)le.healthflag),
    defendant_Fields.InValid_healthdesc((SALT33.StrType)le.healthdesc),
    defendant_Fields.InValid_bloodtype((SALT33.StrType)le.bloodtype),
    defendant_Fields.InValid_sexoffenderregistrydate((SALT33.StrType)le.sexoffenderregistrydate),
    defendant_Fields.InValid_sexoffenderregexpirationdate((SALT33.StrType)le.sexoffenderregexpirationdate),
    defendant_Fields.InValid_sexoffenderregistrynumber((SALT33.StrType)le.sexoffenderregistrynumber),
    defendant_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    defendant_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
