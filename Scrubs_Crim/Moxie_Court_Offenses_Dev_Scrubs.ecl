...
EXPORT FromNone(DATASET(Moxie_Court_Offenses_Dev_Layout_crim) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.arr_off_lev_Invalid := Moxie_Court_Offenses_Dev_Fields.InValid_arr_off_lev((SALT311.StrType)le.arr_off_lev,(SALT311.StrType)le.vendor);
    SELF.arr_disp_date_Invalid := Moxie_Court_Offenses_Dev_Fields.InValid_arr_disp_date((SALT311.StrType)le.arr_disp_date);
    SELF.court_off_lev_Invalid := Moxie_Court_Offenses_Dev_Fields.InValid_court_off_lev((SALT311.StrType)le.court_off_lev,(SALT311.StrType)le.vendor);
