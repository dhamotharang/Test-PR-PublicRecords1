IMPORT ut,SALT33;
EXPORT offense_doc_hygiene(dataset(offense_doc_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    offense_doc_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    offense_doc_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    offense_doc_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    offense_doc_Fields.InValid_casenumber((SALT33.StrType)le.casenumber),
    offense_doc_Fields.InValid_casetitle((SALT33.StrType)le.casetitle),
    offense_doc_Fields.InValid_casetype((SALT33.StrType)le.casetype),
    offense_doc_Fields.InValid_casestatus((SALT33.StrType)le.casestatus),
    offense_doc_Fields.InValid_casestatusdate((SALT33.StrType)le.casestatusdate),
    offense_doc_Fields.InValid_casecomments((SALT33.StrType)le.casecomments),
    offense_doc_Fields.InValid_fileddate((SALT33.StrType)le.fileddate),
    offense_doc_Fields.InValid_caseinfo((SALT33.StrType)le.caseinfo),
    offense_doc_Fields.InValid_docketnumber((SALT33.StrType)le.docketnumber),
    offense_doc_Fields.InValid_offensecode((SALT33.StrType)le.offensecode),
    offense_doc_Fields.InValid_offensedesc((SALT33.StrType)le.offensedesc),
    offense_doc_Fields.InValid_offensedate((SALT33.StrType)le.offensedate),
    offense_doc_Fields.InValid_offensetype((SALT33.StrType)le.offensetype),
    offense_doc_Fields.InValid_offensedegree((SALT33.StrType)le.offensedegree),
    offense_doc_Fields.InValid_offenseclass((SALT33.StrType)le.offenseclass),
    offense_doc_Fields.InValid_dispositionstatus((SALT33.StrType)le.dispositionstatus),
    offense_doc_Fields.InValid_dispositionstatusdate((SALT33.StrType)le.dispositionstatusdate),
    offense_doc_Fields.InValid_disposition((SALT33.StrType)le.disposition),
    offense_doc_Fields.InValid_dispositiondate((SALT33.StrType)le.dispositiondate),
    offense_doc_Fields.InValid_offenselocation((SALT33.StrType)le.offenselocation),
    offense_doc_Fields.InValid_finaloffense((SALT33.StrType)le.finaloffense),
    offense_doc_Fields.InValid_finaloffensedate((SALT33.StrType)le.finaloffensedate),
    offense_doc_Fields.InValid_offensecount((SALT33.StrType)le.offensecount),
    offense_doc_Fields.InValid_victimunder18((SALT33.StrType)le.victimunder18),
    offense_doc_Fields.InValid_prioroffenseflag((SALT33.StrType)le.prioroffenseflag),
    offense_doc_Fields.InValid_initialplea((SALT33.StrType)le.initialplea),
    offense_doc_Fields.InValid_initialpleadate((SALT33.StrType)le.initialpleadate),
    offense_doc_Fields.InValid_finalruling((SALT33.StrType)le.finalruling),
    offense_doc_Fields.InValid_finalrulingdate((SALT33.StrType)le.finalrulingdate),
    offense_doc_Fields.InValid_appealstatus((SALT33.StrType)le.appealstatus),
    offense_doc_Fields.InValid_appealdate((SALT33.StrType)le.appealdate),
    offense_doc_Fields.InValid_courtname((SALT33.StrType)le.courtname),
    offense_doc_Fields.InValid_fineamount((SALT33.StrType)le.fineamount),
    offense_doc_Fields.InValid_courtfee((SALT33.StrType)le.courtfee),
    offense_doc_Fields.InValid_restitution((SALT33.StrType)le.restitution),
    offense_doc_Fields.InValid_trialtype((SALT33.StrType)le.trialtype),
    offense_doc_Fields.InValid_courtdate((SALT33.StrType)le.courtdate),
    offense_doc_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    offense_doc_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    offense_doc_Fields.InValid_classification_code((SALT33.StrType)le.classification_code),
    offense_doc_Fields.InValid_sub_classification_code((SALT33.StrType)le.sub_classification_code),
    offense_doc_Fields.InValid_unit((SALT33.StrType)le.unit),
    offense_doc_Fields.InValid_city((SALT33.StrType)le.city),
    offense_doc_Fields.InValid_state((SALT33.StrType)le.state),
    offense_doc_Fields.InValid_zip((SALT33.StrType)le.zip),
    offense_doc_Fields.InValid_county((SALT33.StrType)le.county),
    offense_doc_Fields.InValid_institutionname((SALT33.StrType)le.institutionname),
    offense_doc_Fields.InValid_institutiondetails((SALT33.StrType)le.institutiondetails),
    offense_doc_Fields.InValid_institutionreceiptdate((SALT33.StrType)le.institutionreceiptdate),
    offense_doc_Fields.InValid_releasetolocation((SALT33.StrType)le.releasetolocation),
    offense_doc_Fields.InValid_releasetodetails((SALT33.StrType)le.releasetodetails),
    offense_doc_Fields.InValid_deceasedflag((SALT33.StrType)le.deceasedflag),
    offense_doc_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate),
    offense_doc_Fields.InValid_healthflag((SALT33.StrType)le.healthflag),
    offense_doc_Fields.InValid_healthdesc((SALT33.StrType)le.healthdesc),
    offense_doc_Fields.InValid_bloodtype((SALT33.StrType)le.bloodtype),
    offense_doc_Fields.InValid_sexoffenderregistrydate((SALT33.StrType)le.sexoffenderregistrydate),
    offense_doc_Fields.InValid_sexoffenderregexpirationdate((SALT33.StrType)le.sexoffenderregexpirationdate),
    offense_doc_Fields.InValid_sexoffenderregistrynumber((SALT33.StrType)le.sexoffenderregistrynumber),
    offense_doc_Fields.InValid_sourceid2((SALT33.StrType)le.sourceid2),
    offense_doc_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := offense_doc_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,offense_doc_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_caseid(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casenumber(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casetitle(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casetype(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casestatus(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casestatusdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_casecomments(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_fileddate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_caseinfo(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_docketnumber(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensecode(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensedesc(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensedate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensetype(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensedegree(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offenseclass(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_dispositionstatus(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_dispositionstatusdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_disposition(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_dispositiondate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offenselocation(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_finaloffense(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_finaloffensedate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_offensecount(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_victimunder18(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_prioroffenseflag(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_initialplea(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_initialpleadate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_finalruling(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_finalrulingdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_appealstatus(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_appealdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_courtname(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_fineamount(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_courtfee(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_restitution(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_trialtype(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_courtdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_classification_code(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sub_classification_code(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_unit(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_city(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_state(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_zip(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_county(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_institutionname(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_institutiondetails(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_institutionreceiptdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_releasetolocation(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_releasetodetails(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_deceasedflag(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_deceaseddate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_healthflag(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_healthdesc(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_bloodtype(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sexoffenderregistrydate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sexoffenderregexpirationdate(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sexoffenderregistrynumber(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_sourceid2(TotalErrors.ErrorNum),offense_doc_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
