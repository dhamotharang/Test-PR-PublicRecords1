...
EXPORT offense_counties_Scrubs := MODULE
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(offense_counties_Layout_crim)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(offense_counties_Layout_crim)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(offense_counties_Layout_crim) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.recordid_Invalid := offense_counties_Fields.InValid_recordid((SALT33.StrType)le.recordid);
    SELF.statecode_Invalid := offense_counties_Fields.InValid_statecode((SALT33.StrType)le.statecode);
    SELF.caseid_Invalid := offense_counties_Fields.InValid_caseid((SALT33.StrType)le.caseid);
    SELF.casestatusdate_Invalid := offense_counties_Fields.InValid_casestatusdate((SALT33.StrType)le.casestatusdate);
    SELF.fileddate_Invalid := offense_counties_Fields.InValid_fileddate((SALT33.StrType)le.fileddate);
    SELF.offensedate_Invalid := offense_counties_Fields.InValid_offensedate((SALT33.StrType)le.offensedate);
    SELF.dispositiondate_Invalid := offense_counties_Fields.InValid_dispositiondate((SALT33.StrType)le.dispositiondate);
    SELF.finaloffensedate_Invalid := offense_counties_Fields.InValid_finaloffensedate((SALT33.StrType)le.finaloffensedate);
    SELF.victimunder18_Invalid := offense_counties_Fields.InValid_victimunder18((SALT33.StrType)le.victimunder18);
    SELF.initialpleadate_Invalid := offense_counties_Fields.InValid_initialpleadate((SALT33.StrType)le.initialpleadate);
    SELF.finalrulingdate_Invalid := offense_counties_Fields.InValid_finalrulingdate((SALT33.StrType)le.finalrulingdate);
    SELF.appealdate_Invalid := offense_counties_Fields.InValid_appealdate((SALT33.StrType)le.appealdate);
    SELF.courtdate_Invalid := offense_counties_Fields.InValid_courtdate((SALT33.StrType)le.courtdate);
    SELF.deceaseddate_Invalid := offense_counties_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),offense_counties_Layout_crim);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,offense_counties_Layout_crim);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,offense_counties_Fields.InvalidMessage_recordid(le.recordid_Invalid),offense_counties_Fields.InvalidMessage_statecode(le.statecode_Invalid),offense_counties_Fields.InvalidMessage_caseid(le.caseid_Invalid),offense_counties_Fields.InvalidMessage_casestatusdate(le.casestatusdate_Invalid),offense_counties_Fields.InvalidMessage_fileddate(le.fileddate_Invalid),offense_counties_Fields.InvalidMessage_offensedate(le.offensedate_Invalid),offense_counties_Fields.InvalidMessage_dispositiondate(le.dispositiondate_Invalid),offense_counties_Fields.InvalidMessage_finaloffensedate(le.finaloffensedate_Invalid),offense_counties_Fields.InvalidMessage_victimunder18(le.victimunder18_Invalid),offense_counties_Fields.InvalidMessage_initialpleadate(le.initialpleadate_Invalid),offense_counties_Fields.InvalidMessage_finalrulingdate(le.finalrulingdate_Invalid),offense_counties_Fields.InvalidMessage_appealdate(le.appealdate_Invalid),offense_counties_Fields.InvalidMessage_courtdate(le.courtdate_Invalid),offense_counties_Fields.InvalidMessage_deceaseddate(le.deceaseddate_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,offense_counties_Fields.InvalidMessage_recordid(1)
          ,offense_counties_Fields.InvalidMessage_statecode(1)
          ,offense_counties_Fields.InvalidMessage_caseid(1)
          ,offense_counties_Fields.InvalidMessage_casestatusdate(1)
          ,offense_counties_Fields.InvalidMessage_fileddate(1)
          ,offense_counties_Fields.InvalidMessage_offensedate(1)
          ,offense_counties_Fields.InvalidMessage_dispositiondate(1)
          ,offense_counties_Fields.InvalidMessage_finaloffensedate(1)
          ,offense_counties_Fields.InvalidMessage_victimunder18(1)
          ,offense_counties_Fields.InvalidMessage_initialpleadate(1)
          ,offense_counties_Fields.InvalidMessage_finalrulingdate(1)
          ,offense_counties_Fields.InvalidMessage_appealdate(1)
          ,offense_counties_Fields.InvalidMessage_courtdate(1)
          ,offense_counties_Fields.InvalidMessage_deceaseddate(1),'UNKNOWN');
