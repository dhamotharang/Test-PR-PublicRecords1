...
#workunit('name','Scrubs_Crim.defendant_counties_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'defendant_counties_Layout_crim'),NAMED('OptimizedLayout'));// File layout suggested by data
