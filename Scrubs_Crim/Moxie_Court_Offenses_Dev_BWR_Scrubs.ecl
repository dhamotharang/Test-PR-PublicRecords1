...
#workunit('name','Scrubs_Crim.Moxie_Court_Offenses_Dev_BWR_Scrubs - Checking field validity in a file - SALT V3.11.9');
IMPORT Scrubs_Crim,SALT311;
infile := Scrubs_Crim.Moxie_Court_Offenses_Dev_In_crim;
mod_scrubs := Scrubs_Crim.Moxie_Court_Offenses_Dev_Scrubs;
