...
#workunit('name','Scrubs_Crim.addresshistory_doc_BWR_Scrubs - Checking field validity in a file - SALT V3.11.9');
IMPORT Scrubs_Crim,SALT311;
infile := Scrubs_Crim.addresshistory_doc_In_crim;
mod_scrubs := Scrubs_Crim.addresshistory_doc_Scrubs;
