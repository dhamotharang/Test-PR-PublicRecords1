...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    charge_Fields.InValid_recordid((SALT311.StrType)le.recordid),
    charge_Fields.InValid_statecode((SALT311.StrType)le.statecode),
    charge_Fields.InValid_caseid((SALT311.StrType)le.caseid),
    charge_Fields.InValid_warrantnumber((SALT311.StrType)le.warrantnumber),
    charge_Fields.InValid_warrantdate((SALT311.StrType)le.warrantdate),
    charge_Fields.InValid_warrantdesc((SALT311.StrType)le.warrantdesc),
    charge_Fields.InValid_warrantissuedate((SALT311.StrType)le.warrantissuedate),
    charge_Fields.InValid_warrantissuingagency((SALT311.StrType)le.warrantissuingagency),
    charge_Fields.InValid_warrantstatus((SALT311.StrType)le.warrantstatus),
    charge_Fields.InValid_citationnumber((SALT311.StrType)le.citationnumber),
    charge_Fields.InValid_bookingnumber((SALT311.StrType)le.bookingnumber),
    charge_Fields.InValid_arrestdate((SALT311.StrType)le.arrestdate),
    charge_Fields.InValid_arrestingagency((SALT311.StrType)le.arrestingagency),
    charge_Fields.InValid_bookingdate((SALT311.StrType)le.bookingdate),
    charge_Fields.InValid_custodydate((SALT311.StrType)le.custodydate),
    charge_Fields.InValid_custodylocation((SALT311.StrType)le.custodylocation),
    charge_Fields.InValid_initialcharge((SALT311.StrType)le.initialcharge),
    charge_Fields.InValid_initialchargedate((SALT311.StrType)le.initialchargedate),
    charge_Fields.InValid_initialchargecancelleddate((SALT311.StrType)le.initialchargecancelleddate),
    charge_Fields.InValid_chargedisposed((SALT311.StrType)le.chargedisposed),
    charge_Fields.InValid_chargedisposeddate((SALT311.StrType)le.chargedisposeddate),
    charge_Fields.InValid_chargeseverity((SALT311.StrType)le.chargeseverity),
    charge_Fields.InValid_chargedisposition((SALT311.StrType)le.chargedisposition),
    charge_Fields.InValid_amendedcharge((SALT311.StrType)le.amendedcharge),
    charge_Fields.InValid_amendedchargedate((SALT311.StrType)le.amendedchargedate),
    charge_Fields.InValid_bondsman((SALT311.StrType)le.bondsman),
    charge_Fields.InValid_bondamount((SALT311.StrType)le.bondamount),
    charge_Fields.InValid_bondtype((SALT311.StrType)le.bondtype),
    charge_Fields.InValid_sourcename((SALT311.StrType)le.sourcename),
    charge_Fields.InValid_sourceid((SALT311.StrType)le.sourceid),
    charge_Fields.InValid_vendor((SALT311.StrType)le.vendor),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doSummaryPerSrc = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Crim, charge_Fields, 'RECORDOF(fieldPopulationOverall)', TRUE);
