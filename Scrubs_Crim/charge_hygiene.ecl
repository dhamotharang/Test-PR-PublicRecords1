IMPORT ut,SALT33;
EXPORT charge_hygiene(dataset(charge_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    charge_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    charge_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    charge_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    charge_Fields.InValid_warrantnumber((SALT33.StrType)le.warrantnumber),
    charge_Fields.InValid_warrantdate((SALT33.StrType)le.warrantdate),
    charge_Fields.InValid_warrantdesc((SALT33.StrType)le.warrantdesc),
    charge_Fields.InValid_warrantissuedate((SALT33.StrType)le.warrantissuedate),
    charge_Fields.InValid_warrantissuingagency((SALT33.StrType)le.warrantissuingagency),
    charge_Fields.InValid_warrantstatus((SALT33.StrType)le.warrantstatus),
    charge_Fields.InValid_citationnumber((SALT33.StrType)le.citationnumber),
    charge_Fields.InValid_bookingnumber((SALT33.StrType)le.bookingnumber),
    charge_Fields.InValid_arrestdate((SALT33.StrType)le.arrestdate),
    charge_Fields.InValid_arrestingagency((SALT33.StrType)le.arrestingagency),
    charge_Fields.InValid_bookingdate((SALT33.StrType)le.bookingdate),
    charge_Fields.InValid_custodydate((SALT33.StrType)le.custodydate),
    charge_Fields.InValid_custodylocation((SALT33.StrType)le.custodylocation),
    charge_Fields.InValid_initialcharge((SALT33.StrType)le.initialcharge),
    charge_Fields.InValid_initialchargedate((SALT33.StrType)le.initialchargedate),
    charge_Fields.InValid_initialchargecancelleddate((SALT33.StrType)le.initialchargecancelleddate),
    charge_Fields.InValid_chargedisposed((SALT33.StrType)le.chargedisposed),
    charge_Fields.InValid_chargedisposeddate((SALT33.StrType)le.chargedisposeddate),
    charge_Fields.InValid_chargeseverity((SALT33.StrType)le.chargeseverity),
    charge_Fields.InValid_chargedisposition((SALT33.StrType)le.chargedisposition),
    charge_Fields.InValid_amendedcharge((SALT33.StrType)le.amendedcharge),
    charge_Fields.InValid_amendedchargedate((SALT33.StrType)le.amendedchargedate),
    charge_Fields.InValid_bondsman((SALT33.StrType)le.bondsman),
    charge_Fields.InValid_bondamount((SALT33.StrType)le.bondamount),
    charge_Fields.InValid_bondtype((SALT33.StrType)le.bondtype),
    charge_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    charge_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    charge_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := charge_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,charge_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),charge_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),charge_Fields.InValidMessage_caseid(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantnumber(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantdate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantdesc(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantissuedate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantissuingagency(TotalErrors.ErrorNum),charge_Fields.InValidMessage_warrantstatus(TotalErrors.ErrorNum),charge_Fields.InValidMessage_citationnumber(TotalErrors.ErrorNum),charge_Fields.InValidMessage_bookingnumber(TotalErrors.ErrorNum),charge_Fields.InValidMessage_arrestdate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_arrestingagency(TotalErrors.ErrorNum),charge_Fields.InValidMessage_bookingdate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_custodydate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_custodylocation(TotalErrors.ErrorNum),charge_Fields.InValidMessage_initialcharge(TotalErrors.ErrorNum),charge_Fields.InValidMessage_initialchargedate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_initialchargecancelleddate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_chargedisposed(TotalErrors.ErrorNum),charge_Fields.InValidMessage_chargedisposeddate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_chargeseverity(TotalErrors.ErrorNum),charge_Fields.InValidMessage_chargedisposition(TotalErrors.ErrorNum),charge_Fields.InValidMessage_amendedcharge(TotalErrors.ErrorNum),charge_Fields.InValidMessage_amendedchargedate(TotalErrors.ErrorNum),charge_Fields.InValidMessage_bondsman(TotalErrors.ErrorNum),charge_Fields.InValidMessage_bondamount(TotalErrors.ErrorNum),charge_Fields.InValidMessage_bondtype(TotalErrors.ErrorNum),charge_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),charge_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),charge_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
