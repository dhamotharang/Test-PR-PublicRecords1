...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_total_num_of_offenses := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.total_num_of_offenses)));
    avelength_total_num_of_offenses := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.total_num_of_offenses)),h.total_num_of_offenses<>(typeof(h.total_num_of_offenses))'');
    ...
    maxlength_off_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_code)));
    avelength_off_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_code)),h.off_code<>(typeof(h.off_code))'');
    populated_chg_pcnt := AVE(GROUP,IF(h.chg = (TYPEOF(h.chg))'',0,100));
    maxlength_chg := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chg)));
    avelength_chg := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chg)),h.chg<>(typeof(h.chg))'');
    populated_chg_typ_flg_pcnt := AVE(GROUP,IF(h.chg_typ_flg = (TYPEOF(h.chg_typ_flg))'',0,100));
    maxlength_chg_typ_flg := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chg_typ_flg)));
    avelength_chg_typ_flg := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chg_typ_flg)),h.chg_typ_flg<>(typeof(h.chg_typ_flg))'');
    populated_off_of_record_pcnt := AVE(GROUP,IF(h.off_of_record = (TYPEOF(h.off_of_record))'',0,100));
    maxlength_off_of_record := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_of_record)));
    avelength_off_of_record := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_of_record)),h.off_of_record<>(typeof(h.off_of_record))'');
    populated_off_desc_1_pcnt := AVE(GROUP,IF(h.off_desc_1 = (TYPEOF(h.off_desc_1))'',0,100));
    maxlength_off_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_desc_1)));
    avelength_off_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_desc_1)),h.off_desc_1<>(typeof(h.off_desc_1))'');
    populated_off_desc_2_pcnt := AVE(GROUP,IF(h.off_desc_2 = (TYPEOF(h.off_desc_2))'',0,100));
    maxlength_off_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_desc_2)));
    avelength_off_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_desc_2)),h.off_desc_2<>(typeof(h.off_desc_2))'');
    populated_add_off_cd_pcnt := AVE(GROUP,IF(h.add_off_cd = (TYPEOF(h.add_off_cd))'',0,100));
    maxlength_add_off_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.add_off_cd)));
    avelength_add_off_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.add_off_cd)),h.add_off_cd<>(typeof(h.add_off_cd))'');
    populated_add_off_desc_pcnt := AVE(GROUP,IF(h.add_off_desc = (TYPEOF(h.add_off_desc))'',0,100));
    maxlength_add_off_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.add_off_desc)));
    avelength_add_off_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.add_off_desc)),h.add_off_desc<>(typeof(h.add_off_desc))'');
    populated_off_typ_pcnt := AVE(GROUP,IF(h.off_typ = (TYPEOF(h.off_typ))'',0,100));
    maxlength_off_typ := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_typ)));
    avelength_off_typ := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_typ)),h.off_typ<>(typeof(h.off_typ))'');
    populated_off_lev_pcnt := AVE(GROUP,IF(h.off_lev = (TYPEOF(h.off_lev))'',0,100));
    maxlength_off_lev := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_lev)));
    avelength_off_lev := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.off_lev)),h.off_lev<>(typeof(h.off_lev))'');
    ...
    maxlength_arr_disp_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_cd)));
    avelength_arr_disp_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_cd)),h.arr_disp_cd<>(typeof(h.arr_disp_cd))'');
    ...
    maxlength_arr_disp_desc_3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_3)));
    avelength_arr_disp_desc_3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arr_disp_desc_3)),h.arr_disp_desc_3<>(typeof(h.arr_disp_desc_3))'');
    ...
    maxlength_ct_dist := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_dist)));
    avelength_ct_dist := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_dist)),h.ct_dist<>(typeof(h.ct_dist))'');
    populated_ct_fnl_plea_cd_pcnt := AVE(GROUP,IF(h.ct_fnl_plea_cd = (TYPEOF(h.ct_fnl_plea_cd))'',0,100));
    maxlength_ct_fnl_plea_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_fnl_plea_cd)));
    avelength_ct_fnl_plea_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_fnl_plea_cd)),h.ct_fnl_plea_cd<>(typeof(h.ct_fnl_plea_cd))'');
    populated_ct_fnl_plea_pcnt := AVE(GROUP,IF(h.ct_fnl_plea = (TYPEOF(h.ct_fnl_plea))'',0,100));
    maxlength_ct_fnl_plea := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_fnl_plea)));
    avelength_ct_fnl_plea := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_fnl_plea)),h.ct_fnl_plea<>(typeof(h.ct_fnl_plea))'');
    populated_ct_off_code_pcnt := AVE(GROUP,IF(h.ct_off_code = (TYPEOF(h.ct_off_code))'',0,100));
    maxlength_ct_off_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_code)));
    avelength_ct_off_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_code)),h.ct_off_code<>(typeof(h.ct_off_code))'');
    populated_ct_chg_pcnt := AVE(GROUP,IF(h.ct_chg = (TYPEOF(h.ct_chg))'',0,100));
    maxlength_ct_chg := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_chg)));
    avelength_ct_chg := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_chg)),h.ct_chg<>(typeof(h.ct_chg))'');
    populated_ct_chg_typ_flg_pcnt := AVE(GROUP,IF(h.ct_chg_typ_flg = (TYPEOF(h.ct_chg_typ_flg))'',0,100));
    maxlength_ct_chg_typ_flg := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_chg_typ_flg)));
    avelength_ct_chg_typ_flg := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_chg_typ_flg)),h.ct_chg_typ_flg<>(typeof(h.ct_chg_typ_flg))'');
    populated_ct_off_desc_1_pcnt := AVE(GROUP,IF(h.ct_off_desc_1 = (TYPEOF(h.ct_off_desc_1))'',0,100));
    maxlength_ct_off_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_desc_1)));
    avelength_ct_off_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_desc_1)),h.ct_off_desc_1<>(typeof(h.ct_off_desc_1))'');
    populated_ct_off_desc_2_pcnt := AVE(GROUP,IF(h.ct_off_desc_2 = (TYPEOF(h.ct_off_desc_2))'',0,100));
    maxlength_ct_off_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_desc_2)));
    avelength_ct_off_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_desc_2)),h.ct_off_desc_2<>(typeof(h.ct_off_desc_2))'');
    populated_ct_addl_desc_cd_pcnt := AVE(GROUP,IF(h.ct_addl_desc_cd = (TYPEOF(h.ct_addl_desc_cd))'',0,100));
    maxlength_ct_addl_desc_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_addl_desc_cd)));
    avelength_ct_addl_desc_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_addl_desc_cd)),h.ct_addl_desc_cd<>(typeof(h.ct_addl_desc_cd))'');
    populated_ct_off_lev_pcnt := AVE(GROUP,IF(h.ct_off_lev = (TYPEOF(h.ct_off_lev))'',0,100));
    maxlength_ct_off_lev := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_lev)));
    avelength_ct_off_lev := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_off_lev)),h.ct_off_lev<>(typeof(h.ct_off_lev))'');
    populated_ct_disp_dt_pcnt := AVE(GROUP,IF(h.ct_disp_dt = (TYPEOF(h.ct_disp_dt))'',0,100));
    maxlength_ct_disp_dt := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_dt)));
    avelength_ct_disp_dt := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_dt)),h.ct_disp_dt<>(typeof(h.ct_disp_dt))'');
    populated_ct_disp_cd_pcnt := AVE(GROUP,IF(h.ct_disp_cd = (TYPEOF(h.ct_disp_cd))'',0,100));
    maxlength_ct_disp_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_cd)));
    avelength_ct_disp_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_cd)),h.ct_disp_cd<>(typeof(h.ct_disp_cd))'');
    populated_ct_disp_desc_1_pcnt := AVE(GROUP,IF(h.ct_disp_desc_1 = (TYPEOF(h.ct_disp_desc_1))'',0,100));
    maxlength_ct_disp_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_desc_1)));
    avelength_ct_disp_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_desc_1)),h.ct_disp_desc_1<>(typeof(h.ct_disp_desc_1))'');
    populated_ct_disp_desc_2_pcnt := AVE(GROUP,IF(h.ct_disp_desc_2 = (TYPEOF(h.ct_disp_desc_2))'',0,100));
    maxlength_ct_disp_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_desc_2)));
    avelength_ct_disp_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ct_disp_desc_2)),h.ct_disp_desc_2<>(typeof(h.ct_disp_desc_2))'');
    populated_cty_conv_cd_pcnt := AVE(GROUP,IF(h.cty_conv_cd = (TYPEOF(h.cty_conv_cd))'',0,100));
    maxlength_cty_conv_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cty_conv_cd)));
    avelength_cty_conv_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cty_conv_cd)),h.cty_conv_cd<>(typeof(h.cty_conv_cd))'');
    ...
    maxlength_adj_wthd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.adj_wthd)));
    avelength_adj_wthd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.adj_wthd)),h.adj_wthd<>(typeof(h.adj_wthd))'');
    populated_stc_dt_pcnt := AVE(GROUP,IF(h.stc_dt = (TYPEOF(h.stc_dt))'',0,100));
    maxlength_stc_dt := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_dt)));
    avelength_stc_dt := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_dt)),h.stc_dt<>(typeof(h.stc_dt))'');
    populated_stc_cd_pcnt := AVE(GROUP,IF(h.stc_cd = (TYPEOF(h.stc_cd))'',0,100));
    maxlength_stc_cd := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_cd)));
    avelength_stc_cd := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_cd)),h.stc_cd<>(typeof(h.stc_cd))'');
    populated_stc_comp_pcnt := AVE(GROUP,IF(h.stc_comp = (TYPEOF(h.stc_comp))'',0,100));
    maxlength_stc_comp := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_comp)));
    avelength_stc_comp := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_comp)),h.stc_comp<>(typeof(h.stc_comp))'');
    populated_stc_desc_1_pcnt := AVE(GROUP,IF(h.stc_desc_1 = (TYPEOF(h.stc_desc_1))'',0,100));
    maxlength_stc_desc_1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_1)));
    avelength_stc_desc_1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_1)),h.stc_desc_1<>(typeof(h.stc_desc_1))'');
    populated_stc_desc_2_pcnt := AVE(GROUP,IF(h.stc_desc_2 = (TYPEOF(h.stc_desc_2))'',0,100));
    maxlength_stc_desc_2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_2)));
    avelength_stc_desc_2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_2)),h.stc_desc_2<>(typeof(h.stc_desc_2))'');
    populated_stc_desc_3_pcnt := AVE(GROUP,IF(h.stc_desc_3 = (TYPEOF(h.stc_desc_3))'',0,100));
    maxlength_stc_desc_3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_3)));
    avelength_stc_desc_3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_3)),h.stc_desc_3<>(typeof(h.stc_desc_3))'');
    populated_stc_desc_4_pcnt := AVE(GROUP,IF(h.stc_desc_4 = (TYPEOF(h.stc_desc_4))'',0,100));
    maxlength_stc_desc_4 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_4)));
    avelength_stc_desc_4 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_desc_4)),h.stc_desc_4<>(typeof(h.stc_desc_4))'');
    populated_stc_lgth_pcnt := AVE(GROUP,IF(h.stc_lgth = (TYPEOF(h.stc_lgth))'',0,100));
    maxlength_stc_lgth := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_lgth)));
    avelength_stc_lgth := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_lgth)),h.stc_lgth<>(typeof(h.stc_lgth))'');
    populated_stc_lgth_desc_pcnt := AVE(GROUP,IF(h.stc_lgth_desc = (TYPEOF(h.stc_lgth_desc))'',0,100));
    maxlength_stc_lgth_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_lgth_desc)));
    avelength_stc_lgth_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.stc_lgth_desc)),h.stc_lgth_desc<>(typeof(h.stc_lgth_desc))'');
    populated_inc_adm_dt_pcnt := AVE(GROUP,IF(h.inc_adm_dt = (TYPEOF(h.inc_adm_dt))'',0,100));
    maxlength_inc_adm_dt := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.inc_adm_dt)));
    avelength_inc_adm_dt := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.inc_adm_dt)),h.inc_adm_dt<>(typeof(h.inc_adm_dt))'');
    populated_min_term_pcnt := AVE(GROUP,IF(h.min_term = (TYPEOF(h.min_term))'',0,100));
    maxlength_min_term := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.min_term)));
    avelength_min_term := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.min_term)),h.min_term<>(typeof(h.min_term))'');
    populated_min_term_desc_pcnt := AVE(GROUP,IF(h.min_term_desc = (TYPEOF(h.min_term_desc))'',0,100));
    maxlength_min_term_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.min_term_desc)));
    avelength_min_term_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.min_term_desc)),h.min_term_desc<>(typeof(h.min_term_desc))'');
    populated_max_term_pcnt := AVE(GROUP,IF(h.max_term = (TYPEOF(h.max_term))'',0,100));
    maxlength_max_term := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.max_term)));
    avelength_max_term := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.max_term)),h.max_term<>(typeof(h.max_term))'');
    populated_max_term_desc_pcnt := AVE(GROUP,IF(h.max_term_desc = (TYPEOF(h.max_term_desc))'',0,100));
    maxlength_max_term_desc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.max_term_desc)));
    avelength_max_term_desc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.max_term_desc)),h.max_term_desc<>(typeof(h.max_term_desc))'');
    ...
    maxlength_probation := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.probation)));
    avelength_probation := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.probation)),h.probation<>(typeof(h.probation))'');
    populated_offensetown_pcnt := AVE(GROUP,IF(h.offensetown = (TYPEOF(h.offensetown))'',0,100));
    maxlength_offensetown := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.offensetown)));
    avelength_offensetown := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.offensetown)),h.offensetown<>(typeof(h.offensetown))'');
    ...
    maxlength_hyg_classification_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hyg_classification_code)));
    avelength_hyg_classification_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hyg_classification_code)),h.hyg_classification_code<>(typeof(h.hyg_classification_code))'');
    populated_old_ln_offense_score_pcnt := AVE(GROUP,IF(h.old_ln_offense_score = (TYPEOF(h.old_ln_offense_score))'',0,100));
    maxlength_old_ln_offense_score := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.old_ln_offense_score)));
    avelength_old_ln_offense_score := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.old_ln_offense_score)),h.old_ln_offense_score<>(typeof(h.old_ln_offense_score))'');
  END;
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Src := le.vendor;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.county_of_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.offense_key),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.case_num),TRIM((SALT33.StrType)le.total_num_of_offenses),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.off_code),TRIM((SALT33.StrType)le.chg),TRIM((SALT33.StrType)le.chg_typ_flg),TRIM((SALT33.StrType)le.off_of_record),TRIM((SALT33.StrType)le.off_desc_1),TRIM((SALT33.StrType)le.off_desc_2),TRIM((SALT33.StrType)le.add_off_cd),TRIM((SALT33.StrType)le.add_off_desc),TRIM((SALT33.StrType)le.off_typ),TRIM((SALT33.StrType)le.off_lev),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_cd),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.arr_disp_desc_3),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.ct_dist),TRIM((SALT33.StrType)le.ct_fnl_plea_cd),TRIM((SALT33.StrType)le.ct_fnl_plea),TRIM((SALT33.StrType)le.ct_off_code),TRIM((SALT33.StrType)le.ct_chg),TRIM((SALT33.StrType)le.ct_chg_typ_flg),TRIM((SALT33.StrType)le.ct_off_desc_1),TRIM((SALT33.StrType)le.ct_off_desc_2),TRIM((SALT33.StrType)le.ct_addl_desc_cd),TRIM((SALT33.StrType)le.ct_off_lev),TRIM((SALT33.StrType)le.ct_disp_dt),TRIM((SALT33.StrType)le.ct_disp_cd),TRIM((SALT33.StrType)le.ct_disp_desc_1),TRIM((SALT33.StrType)le.ct_disp_desc_2),TRIM((SALT33.StrType)le.cty_conv_cd),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.adj_wthd),TRIM((SALT33.StrType)le.stc_dt),TRIM((SALT33.StrType)le.stc_cd),TRIM((SALT33.StrType)le.stc_comp),TRIM((SALT33.StrType)le.stc_desc_1),TRIM((SALT33.StrType)le.stc_desc_2),TRIM((SALT33.StrType)le.stc_desc_3),TRIM((SALT33.StrType)le.stc_desc_4),TRIM((SALT33.StrType)le.stc_lgth),TRIM((SALT33.StrType)le.stc_lgth_desc),TRIM((SALT33.StrType)le.inc_adm_dt),TRIM((SALT33.StrType)le.min_term),TRIM((SALT33.StrType)le.min_term_desc),TRIM((SALT33.StrType)le.max_term),TRIM((SALT33.StrType)le.max_term_desc),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.probation),TRIM((SALT33.StrType)le.offensetown),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), ''),TRIM((SALT33.StrType)le.hyg_classification_code),TRIM((SALT33.StrType)le.old_ln_offense_score)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 79);
  SELF.FldNo2 := 1 + (C % 79);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.county_of_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.offense_key),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.case_num),TRIM((SALT33.StrType)le.total_num_of_offenses),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.off_code),TRIM((SALT33.StrType)le.chg),TRIM((SALT33.StrType)le.chg_typ_flg),TRIM((SALT33.StrType)le.off_of_record),TRIM((SALT33.StrType)le.off_desc_1),TRIM((SALT33.StrType)le.off_desc_2),TRIM((SALT33.StrType)le.add_off_cd),TRIM((SALT33.StrType)le.add_off_desc),TRIM((SALT33.StrType)le.off_typ),TRIM((SALT33.StrType)le.off_lev),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_cd),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.arr_disp_desc_3),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.ct_dist),TRIM((SALT33.StrType)le.ct_fnl_plea_cd),TRIM((SALT33.StrType)le.ct_fnl_plea),TRIM((SALT33.StrType)le.ct_off_code),TRIM((SALT33.StrType)le.ct_chg),TRIM((SALT33.StrType)le.ct_chg_typ_flg),TRIM((SALT33.StrType)le.ct_off_desc_1),TRIM((SALT33.StrType)le.ct_off_desc_2),TRIM((SALT33.StrType)le.ct_addl_desc_cd),TRIM((SALT33.StrType)le.ct_off_lev),TRIM((SALT33.StrType)le.ct_disp_dt),TRIM((SALT33.StrType)le.ct_disp_cd),TRIM((SALT33.StrType)le.ct_disp_desc_1),TRIM((SALT33.StrType)le.ct_disp_desc_2),TRIM((SALT33.StrType)le.cty_conv_cd),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.adj_wthd),TRIM((SALT33.StrType)le.stc_dt),TRIM((SALT33.StrType)le.stc_cd),TRIM((SALT33.StrType)le.stc_comp),TRIM((SALT33.StrType)le.stc_desc_1),TRIM((SALT33.StrType)le.stc_desc_2),TRIM((SALT33.StrType)le.stc_desc_3),TRIM((SALT33.StrType)le.stc_desc_4),TRIM((SALT33.StrType)le.stc_lgth),TRIM((SALT33.StrType)le.stc_lgth_desc),TRIM((SALT33.StrType)le.inc_adm_dt),TRIM((SALT33.StrType)le.min_term),TRIM((SALT33.StrType)le.min_term_desc),TRIM((SALT33.StrType)le.max_term),TRIM((SALT33.StrType)le.max_term_desc),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.probation),TRIM((SALT33.StrType)le.offensetown),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), ''),TRIM((SALT33.StrType)le.hyg_classification_code),TRIM((SALT33.StrType)le.old_ln_offense_score)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.offender_key),TRIM((SALT33.StrType)le.vendor),TRIM((SALT33.StrType)le.county_of_origin),TRIM((SALT33.StrType)le.source_file),TRIM((SALT33.StrType)le.data_type),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.offense_key),TRIM((SALT33.StrType)le.off_date),TRIM((SALT33.StrType)le.arr_date),TRIM((SALT33.StrType)le.case_num),TRIM((SALT33.StrType)le.total_num_of_offenses),TRIM((SALT33.StrType)le.num_of_counts),TRIM((SALT33.StrType)le.off_code),TRIM((SALT33.StrType)le.chg),TRIM((SALT33.StrType)le.chg_typ_flg),TRIM((SALT33.StrType)le.off_of_record),TRIM((SALT33.StrType)le.off_desc_1),TRIM((SALT33.StrType)le.off_desc_2),TRIM((SALT33.StrType)le.add_off_cd),TRIM((SALT33.StrType)le.add_off_desc),TRIM((SALT33.StrType)le.off_typ),TRIM((SALT33.StrType)le.off_lev),TRIM((SALT33.StrType)le.arr_disp_date),TRIM((SALT33.StrType)le.arr_disp_cd),TRIM((SALT33.StrType)le.arr_disp_desc_1),TRIM((SALT33.StrType)le.arr_disp_desc_2),TRIM((SALT33.StrType)le.arr_disp_desc_3),TRIM((SALT33.StrType)le.court_cd),TRIM((SALT33.StrType)le.court_desc),TRIM((SALT33.StrType)le.ct_dist),TRIM((SALT33.StrType)le.ct_fnl_plea_cd),TRIM((SALT33.StrType)le.ct_fnl_plea),TRIM((SALT33.StrType)le.ct_off_code),TRIM((SALT33.StrType)le.ct_chg),TRIM((SALT33.StrType)le.ct_chg_typ_flg),TRIM((SALT33.StrType)le.ct_off_desc_1),TRIM((SALT33.StrType)le.ct_off_desc_2),TRIM((SALT33.StrType)le.ct_addl_desc_cd),TRIM((SALT33.StrType)le.ct_off_lev),TRIM((SALT33.StrType)le.ct_disp_dt),TRIM((SALT33.StrType)le.ct_disp_cd),TRIM((SALT33.StrType)le.ct_disp_desc_1),TRIM((SALT33.StrType)le.ct_disp_desc_2),TRIM((SALT33.StrType)le.cty_conv_cd),TRIM((SALT33.StrType)le.cty_conv),TRIM((SALT33.StrType)le.adj_wthd),TRIM((SALT33.StrType)le.stc_dt),TRIM((SALT33.StrType)le.stc_cd),TRIM((SALT33.StrType)le.stc_comp),TRIM((SALT33.StrType)le.stc_desc_1),TRIM((SALT33.StrType)le.stc_desc_2),TRIM((SALT33.StrType)le.stc_desc_3),TRIM((SALT33.StrType)le.stc_desc_4),TRIM((SALT33.StrType)le.stc_lgth),TRIM((SALT33.StrType)le.stc_lgth_desc),TRIM((SALT33.StrType)le.inc_adm_dt),TRIM((SALT33.StrType)le.min_term),TRIM((SALT33.StrType)le.min_term_desc),TRIM((SALT33.StrType)le.max_term),TRIM((SALT33.StrType)le.max_term_desc),TRIM((SALT33.StrType)le.parole),TRIM((SALT33.StrType)le.probation),TRIM((SALT33.StrType)le.offensetown),TRIM((SALT33.StrType)le.convict_dt),TRIM((SALT33.StrType)le.court_county),TRIM((SALT33.StrType)le.fcra_offense_key),TRIM((SALT33.StrType)le.fcra_conviction_flag),TRIM((SALT33.StrType)le.fcra_traffic_flag),TRIM((SALT33.StrType)le.fcra_date),TRIM((SALT33.StrType)le.fcra_date_type),TRIM((SALT33.StrType)le.conviction_override_date),TRIM((SALT33.StrType)le.conviction_override_date_type),TRIM((SALT33.StrType)le.offense_score),IF (le.offense_persistent_id <> 0,TRIM((SALT33.StrType)le.offense_persistent_id), ''),IF (le.offense_category <> 0,TRIM((SALT33.StrType)le.offense_category), ''),TRIM((SALT33.StrType)le.hyg_classification_code),TRIM((SALT33.StrType)le.old_ln_offense_score)));
  END;
...
SHARED FldIds := DATASET([{1,'process_date'}
      ...
      ,{79,'old_ln_offense_score'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Moxie_DOC_Offenses_Dev_Fields.InValid_process_date((SALT33.StrType)le.process_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offender_key((SALT33.StrType)le.offender_key),
    Moxie_DOC_Offenses_Dev_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    Moxie_DOC_Offenses_Dev_Fields.InValid_county_of_origin((SALT33.StrType)le.county_of_origin),
    Moxie_DOC_Offenses_Dev_Fields.InValid_source_file((SALT33.StrType)le.source_file),
    Moxie_DOC_Offenses_Dev_Fields.InValid_data_type((SALT33.StrType)le.data_type),
    Moxie_DOC_Offenses_Dev_Fields.InValid_record_type((SALT33.StrType)le.record_type),
    Moxie_DOC_Offenses_Dev_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offense_key((SALT33.StrType)le.offense_key),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_date((SALT33.StrType)le.off_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_date((SALT33.StrType)le.arr_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_case_num((SALT33.StrType)le.case_num),
    Moxie_DOC_Offenses_Dev_Fields.InValid_total_num_of_offenses((SALT33.StrType)le.total_num_of_offenses),
    Moxie_DOC_Offenses_Dev_Fields.InValid_num_of_counts((SALT33.StrType)le.num_of_counts),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_code((SALT33.StrType)le.off_code),
    Moxie_DOC_Offenses_Dev_Fields.InValid_chg((SALT33.StrType)le.chg),
    Moxie_DOC_Offenses_Dev_Fields.InValid_chg_typ_flg((SALT33.StrType)le.chg_typ_flg),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_of_record((SALT33.StrType)le.off_of_record),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_desc_1((SALT33.StrType)le.off_desc_1),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_desc_2((SALT33.StrType)le.off_desc_2),
    Moxie_DOC_Offenses_Dev_Fields.InValid_add_off_cd((SALT33.StrType)le.add_off_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_add_off_desc((SALT33.StrType)le.add_off_desc),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_typ((SALT33.StrType)le.off_typ),
    Moxie_DOC_Offenses_Dev_Fields.InValid_off_lev((SALT33.StrType)le.off_lev,(SALT33.StrType)le.vendor),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_disp_date((SALT33.StrType)le.arr_disp_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_disp_cd((SALT33.StrType)le.arr_disp_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_disp_desc_1((SALT33.StrType)le.arr_disp_desc_1),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_disp_desc_2((SALT33.StrType)le.arr_disp_desc_2),
    Moxie_DOC_Offenses_Dev_Fields.InValid_arr_disp_desc_3((SALT33.StrType)le.arr_disp_desc_3),
    Moxie_DOC_Offenses_Dev_Fields.InValid_court_cd((SALT33.StrType)le.court_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_court_desc((SALT33.StrType)le.court_desc),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_dist((SALT33.StrType)le.ct_dist),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_fnl_plea_cd((SALT33.StrType)le.ct_fnl_plea_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_fnl_plea((SALT33.StrType)le.ct_fnl_plea),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_off_code((SALT33.StrType)le.ct_off_code),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_chg((SALT33.StrType)le.ct_chg),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_chg_typ_flg((SALT33.StrType)le.ct_chg_typ_flg),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_off_desc_1((SALT33.StrType)le.ct_off_desc_1),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_off_desc_2((SALT33.StrType)le.ct_off_desc_2),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_addl_desc_cd((SALT33.StrType)le.ct_addl_desc_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_off_lev((SALT33.StrType)le.ct_off_lev),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_disp_dt((SALT33.StrType)le.ct_disp_dt),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_disp_cd((SALT33.StrType)le.ct_disp_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_disp_desc_1((SALT33.StrType)le.ct_disp_desc_1),
    Moxie_DOC_Offenses_Dev_Fields.InValid_ct_disp_desc_2((SALT33.StrType)le.ct_disp_desc_2),
    Moxie_DOC_Offenses_Dev_Fields.InValid_cty_conv_cd((SALT33.StrType)le.cty_conv_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_cty_conv((SALT33.StrType)le.cty_conv),
    Moxie_DOC_Offenses_Dev_Fields.InValid_adj_wthd((SALT33.StrType)le.adj_wthd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_dt((SALT33.StrType)le.stc_dt),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_cd((SALT33.StrType)le.stc_cd),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_comp((SALT33.StrType)le.stc_comp),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_desc_1((SALT33.StrType)le.stc_desc_1),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_desc_2((SALT33.StrType)le.stc_desc_2),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_desc_3((SALT33.StrType)le.stc_desc_3),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_desc_4((SALT33.StrType)le.stc_desc_4),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_lgth((SALT33.StrType)le.stc_lgth),
    Moxie_DOC_Offenses_Dev_Fields.InValid_stc_lgth_desc((SALT33.StrType)le.stc_lgth_desc),
    Moxie_DOC_Offenses_Dev_Fields.InValid_inc_adm_dt((SALT33.StrType)le.inc_adm_dt),
    Moxie_DOC_Offenses_Dev_Fields.InValid_min_term((SALT33.StrType)le.min_term),
    Moxie_DOC_Offenses_Dev_Fields.InValid_min_term_desc((SALT33.StrType)le.min_term_desc),
    Moxie_DOC_Offenses_Dev_Fields.InValid_max_term((SALT33.StrType)le.max_term),
    Moxie_DOC_Offenses_Dev_Fields.InValid_max_term_desc((SALT33.StrType)le.max_term_desc),
    Moxie_DOC_Offenses_Dev_Fields.InValid_parole((SALT33.StrType)le.parole),
    Moxie_DOC_Offenses_Dev_Fields.InValid_probation((SALT33.StrType)le.probation),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offensetown((SALT33.StrType)le.offensetown),
    Moxie_DOC_Offenses_Dev_Fields.InValid_convict_dt((SALT33.StrType)le.convict_dt),
    Moxie_DOC_Offenses_Dev_Fields.InValid_court_county((SALT33.StrType)le.court_county),
    Moxie_DOC_Offenses_Dev_Fields.InValid_fcra_offense_key((SALT33.StrType)le.fcra_offense_key),
    Moxie_DOC_Offenses_Dev_Fields.InValid_fcra_conviction_flag((SALT33.StrType)le.fcra_conviction_flag),
    Moxie_DOC_Offenses_Dev_Fields.InValid_fcra_traffic_flag((SALT33.StrType)le.fcra_traffic_flag),
    Moxie_DOC_Offenses_Dev_Fields.InValid_fcra_date((SALT33.StrType)le.fcra_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_fcra_date_type((SALT33.StrType)le.fcra_date_type),
    Moxie_DOC_Offenses_Dev_Fields.InValid_conviction_override_date((SALT33.StrType)le.conviction_override_date),
    Moxie_DOC_Offenses_Dev_Fields.InValid_conviction_override_date_type((SALT33.StrType)le.conviction_override_date_type),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offense_score((SALT33.StrType)le.offense_score),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offense_persistent_id((SALT33.StrType)le.offense_persistent_id),
    Moxie_DOC_Offenses_Dev_Fields.InValid_offense_category((SALT33.StrType)le.offense_category),
    Moxie_DOC_Offenses_Dev_Fields.InValid_hyg_classification_code((SALT33.StrType)le.hyg_classification_code),
    Moxie_DOC_Offenses_Dev_Fields.InValid_old_ln_offense_score((SALT33.StrType)le.old_ln_offense_score),
    0);
