IMPORT ut,SALT33;
EXPORT sentence_hygiene(dataset(sentence_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    sentence_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    sentence_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    sentence_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    sentence_Fields.InValid_sentencedate((SALT33.StrType)le.sentencedate),
    sentence_Fields.InValid_sentencebegindate((SALT33.StrType)le.sentencebegindate),
    sentence_Fields.InValid_sentenceenddate((SALT33.StrType)le.sentenceenddate),
    sentence_Fields.InValid_sentencetype((SALT33.StrType)le.sentencetype),
    sentence_Fields.InValid_sentencemaxyears((SALT33.StrType)le.sentencemaxyears),
    sentence_Fields.InValid_sentencemaxmonths((SALT33.StrType)le.sentencemaxmonths),
    sentence_Fields.InValid_sentencemaxdays((SALT33.StrType)le.sentencemaxdays),
    sentence_Fields.InValid_sentenceminyears((SALT33.StrType)le.sentenceminyears),
    sentence_Fields.InValid_sentenceminmonths((SALT33.StrType)le.sentenceminmonths),
    sentence_Fields.InValid_sentencemindays((SALT33.StrType)le.sentencemindays),
    sentence_Fields.InValid_scheduledreleasedate((SALT33.StrType)le.scheduledreleasedate),
    sentence_Fields.InValid_actualreleasedate((SALT33.StrType)le.actualreleasedate),
    sentence_Fields.InValid_sentencestatus((SALT33.StrType)le.sentencestatus),
    sentence_Fields.InValid_timeservedyears((SALT33.StrType)le.timeservedyears),
    sentence_Fields.InValid_timeservedmonths((SALT33.StrType)le.timeservedmonths),
    sentence_Fields.InValid_timeserveddays((SALT33.StrType)le.timeserveddays),
    sentence_Fields.InValid_publicservicehours((SALT33.StrType)le.publicservicehours),
    sentence_Fields.InValid_sentenceadditionalinfo((SALT33.StrType)le.sentenceadditionalinfo),
    sentence_Fields.InValid_communitysupervisioncounty((SALT33.StrType)le.communitysupervisioncounty),
    sentence_Fields.InValid_communitysupervisionyears((SALT33.StrType)le.communitysupervisionyears),
    sentence_Fields.InValid_communitysupervisionmonths((SALT33.StrType)le.communitysupervisionmonths),
    sentence_Fields.InValid_communitysupervisiondays((SALT33.StrType)le.communitysupervisiondays),
    sentence_Fields.InValid_parolebegindate((SALT33.StrType)le.parolebegindate),
    sentence_Fields.InValid_paroleenddate((SALT33.StrType)le.paroleenddate),
    sentence_Fields.InValid_paroleeligibilitydate((SALT33.StrType)le.paroleeligibilitydate),
    sentence_Fields.InValid_parolehearingdate((SALT33.StrType)le.parolehearingdate),
    sentence_Fields.InValid_parolemaxyears((SALT33.StrType)le.parolemaxyears),
    sentence_Fields.InValid_parolemaxmonths((SALT33.StrType)le.parolemaxmonths),
    sentence_Fields.InValid_parolemaxdays((SALT33.StrType)le.parolemaxdays),
    sentence_Fields.InValid_paroleminyears((SALT33.StrType)le.paroleminyears),
    sentence_Fields.InValid_paroleminmonths((SALT33.StrType)le.paroleminmonths),
    sentence_Fields.InValid_parolemindays((SALT33.StrType)le.parolemindays),
    sentence_Fields.InValid_parolestatus((SALT33.StrType)le.parolestatus),
    sentence_Fields.InValid_paroleofficer((SALT33.StrType)le.paroleofficer),
    sentence_Fields.InValid_paroleoffcerphone((SALT33.StrType)le.paroleoffcerphone),
    sentence_Fields.InValid_probationbegindate((SALT33.StrType)le.probationbegindate),
    sentence_Fields.InValid_probationenddate((SALT33.StrType)le.probationenddate),
    sentence_Fields.InValid_probationmaxyears((SALT33.StrType)le.probationmaxyears),
    sentence_Fields.InValid_probationmaxmonths((SALT33.StrType)le.probationmaxmonths),
    sentence_Fields.InValid_probationmaxdays((SALT33.StrType)le.probationmaxdays),
    sentence_Fields.InValid_probationminyears((SALT33.StrType)le.probationminyears),
    sentence_Fields.InValid_probationminmonths((SALT33.StrType)le.probationminmonths),
    sentence_Fields.InValid_probationmindays((SALT33.StrType)le.probationmindays),
    sentence_Fields.InValid_probationstatus((SALT33.StrType)le.probationstatus),
    sentence_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    sentence_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := sentence_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,sentence_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_caseid(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencedate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencebegindate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentenceenddate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencetype(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencemaxyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencemaxmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencemaxdays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentenceminyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentenceminmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencemindays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_scheduledreleasedate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_actualreleasedate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentencestatus(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_timeservedyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_timeservedmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_timeserveddays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_publicservicehours(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sentenceadditionalinfo(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_communitysupervisioncounty(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_communitysupervisionyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_communitysupervisionmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_communitysupervisiondays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolebegindate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleenddate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleeligibilitydate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolehearingdate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolemaxyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolemaxmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolemaxdays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleminyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleminmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolemindays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_parolestatus(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleofficer(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_paroleoffcerphone(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationbegindate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationenddate(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationmaxyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationmaxmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationmaxdays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationminyears(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationminmonths(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationmindays(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_probationstatus(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),sentence_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
