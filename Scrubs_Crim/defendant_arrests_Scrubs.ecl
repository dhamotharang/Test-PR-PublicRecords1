...
EXPORT defendant_arrests_Scrubs := MODULE
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(defendant_arrests_Layout_crim)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(defendant_arrests_Layout_crim)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(defendant_arrests_Layout_crim) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.recordid_Invalid := defendant_arrests_Fields.InValid_recordid((SALT33.StrType)le.recordid);
    SELF.statecode_Invalid := defendant_arrests_Fields.InValid_statecode((SALT33.StrType)le.statecode);
    SELF.inmatenumber_Invalid := defendant_arrests_Fields.InValid_inmatenumber((SALT33.StrType)le.inmatenumber);
    SELF.dob_Invalid := defendant_arrests_Fields.InValid_dob((SALT33.StrType)le.dob);
    SELF.birthcity_Invalid := defendant_arrests_Fields.InValid_birthcity((SALT33.StrType)le.birthcity);
    SELF.gender_Invalid := defendant_arrests_Fields.InValid_gender((SALT33.StrType)le.gender);
    SELF.race_Invalid := defendant_arrests_Fields.InValid_race((SALT33.StrType)le.race);
    SELF.dlstate_Invalid := defendant_arrests_Fields.InValid_dlstate((SALT33.StrType)le.dlstate);
    SELF.city_Invalid := defendant_arrests_Fields.InValid_city((SALT33.StrType)le.city);
    SELF.orig_zip_Invalid := defendant_arrests_Fields.InValid_orig_zip((SALT33.StrType)le.orig_zip);
    SELF.institutionreceiptdate_Invalid := defendant_arrests_Fields.InValid_institutionreceiptdate((SALT33.StrType)le.institutionreceiptdate);
    SELF.deceaseddate_Invalid := defendant_arrests_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate);
    SELF.sexoffenderregistrydate_Invalid := defendant_arrests_Fields.InValid_sexoffenderregistrydate((SALT33.StrType)le.sexoffenderregistrydate);
    SELF.sexoffenderregexpirationdate_Invalid := defendant_arrests_Fields.InValid_sexoffenderregexpirationdate((SALT33.StrType)le.sexoffenderregexpirationdate);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),defendant_arrests_Layout_crim);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,defendant_arrests_Layout_crim);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,defendant_arrests_Fields.InvalidMessage_recordid(le.recordid_Invalid),defendant_arrests_Fields.InvalidMessage_statecode(le.statecode_Invalid),defendant_arrests_Fields.InvalidMessage_inmatenumber(le.inmatenumber_Invalid),defendant_arrests_Fields.InvalidMessage_dob(le.dob_Invalid),defendant_arrests_Fields.InvalidMessage_birthcity(le.birthcity_Invalid),defendant_arrests_Fields.InvalidMessage_gender(le.gender_Invalid),defendant_arrests_Fields.InvalidMessage_race(le.race_Invalid),defendant_arrests_Fields.InvalidMessage_dlstate(le.dlstate_Invalid),defendant_arrests_Fields.InvalidMessage_city(le.city_Invalid),defendant_arrests_Fields.InvalidMessage_orig_zip(le.orig_zip_Invalid),defendant_arrests_Fields.InvalidMessage_institutionreceiptdate(le.institutionreceiptdate_Invalid),defendant_arrests_Fields.InvalidMessage_deceaseddate(le.deceaseddate_Invalid),defendant_arrests_Fields.InvalidMessage_sexoffenderregistrydate(le.sexoffenderregistrydate_Invalid),defendant_arrests_Fields.InvalidMessage_sexoffenderregexpirationdate(le.sexoffenderregexpirationdate_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,defendant_arrests_Fields.InvalidMessage_recordid(1)
          ,defendant_arrests_Fields.InvalidMessage_statecode(1)
          ,defendant_arrests_Fields.InvalidMessage_inmatenumber(1)
          ,defendant_arrests_Fields.InvalidMessage_dob(1)
          ,defendant_arrests_Fields.InvalidMessage_birthcity(1)
          ,defendant_arrests_Fields.InvalidMessage_gender(1)
          ,defendant_arrests_Fields.InvalidMessage_race(1)
          ,defendant_arrests_Fields.InvalidMessage_dlstate(1)
          ,defendant_arrests_Fields.InvalidMessage_city(1)
          ,defendant_arrests_Fields.InvalidMessage_orig_zip(1)
          ,defendant_arrests_Fields.InvalidMessage_institutionreceiptdate(1)
          ,defendant_arrests_Fields.InvalidMessage_deceaseddate(1)
          ,defendant_arrests_Fields.InvalidMessage_sexoffenderregistrydate(1)
          ,defendant_arrests_Fields.InvalidMessage_sexoffenderregexpirationdate(1),'UNKNOWN');
