...
EXPORT sentence_arrests_Scrubs := MODULE
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(sentence_arrests_Layout_crim)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(sentence_arrests_Layout_crim)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(sentence_arrests_Layout_crim) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.recordid_Invalid := sentence_arrests_Fields.InValid_recordid((SALT33.StrType)le.recordid);
    SELF.statecode_Invalid := sentence_arrests_Fields.InValid_statecode((SALT33.StrType)le.statecode);
    SELF.caseid_Invalid := sentence_arrests_Fields.InValid_caseid((SALT33.StrType)le.caseid);
    SELF.sentencedate_Invalid := sentence_arrests_Fields.InValid_sentencedate((SALT33.StrType)le.sentencedate);
    SELF.sentencebegindate_Invalid := sentence_arrests_Fields.InValid_sentencebegindate((SALT33.StrType)le.sentencebegindate);
    SELF.sentenceenddate_Invalid := sentence_arrests_Fields.InValid_sentenceenddate((SALT33.StrType)le.sentenceenddate);
    SELF.sentencemaxyears_Invalid := sentence_arrests_Fields.InValid_sentencemaxyears((SALT33.StrType)le.sentencemaxyears);
    SELF.sentencemaxmonths_Invalid := sentence_arrests_Fields.InValid_sentencemaxmonths((SALT33.StrType)le.sentencemaxmonths);
    SELF.sentencemaxdays_Invalid := sentence_arrests_Fields.InValid_sentencemaxdays((SALT33.StrType)le.sentencemaxdays);
    SELF.sentenceminyears_Invalid := sentence_arrests_Fields.InValid_sentenceminyears((SALT33.StrType)le.sentenceminyears);
    SELF.sentenceminmonths_Invalid := sentence_arrests_Fields.InValid_sentenceminmonths((SALT33.StrType)le.sentenceminmonths);
    SELF.sentencemindays_Invalid := sentence_arrests_Fields.InValid_sentencemindays((SALT33.StrType)le.sentencemindays);
    SELF.scheduledreleasedate_Invalid := sentence_arrests_Fields.InValid_scheduledreleasedate((SALT33.StrType)le.scheduledreleasedate);
    SELF.actualreleasedate_Invalid := sentence_arrests_Fields.InValid_actualreleasedate((SALT33.StrType)le.actualreleasedate);
    SELF.timeservedyears_Invalid := sentence_arrests_Fields.InValid_timeservedyears((SALT33.StrType)le.timeservedyears);
    SELF.timeservedmonths_Invalid := sentence_arrests_Fields.InValid_timeservedmonths((SALT33.StrType)le.timeservedmonths);
    SELF.timeserveddays_Invalid := sentence_arrests_Fields.InValid_timeserveddays((SALT33.StrType)le.timeserveddays);
    SELF.publicservicehours_Invalid := sentence_arrests_Fields.InValid_publicservicehours((SALT33.StrType)le.publicservicehours);
    SELF.communitysupervisionyears_Invalid := sentence_arrests_Fields.InValid_communitysupervisionyears((SALT33.StrType)le.communitysupervisionyears);
    SELF.communitysupervisionmonths_Invalid := sentence_arrests_Fields.InValid_communitysupervisionmonths((SALT33.StrType)le.communitysupervisionmonths);
    SELF.communitysupervisiondays_Invalid := sentence_arrests_Fields.InValid_communitysupervisiondays((SALT33.StrType)le.communitysupervisiondays);
    SELF.parolebegindate_Invalid := sentence_arrests_Fields.InValid_parolebegindate((SALT33.StrType)le.parolebegindate);
    SELF.paroleenddate_Invalid := sentence_arrests_Fields.InValid_paroleenddate((SALT33.StrType)le.paroleenddate);
    SELF.paroleeligibilitydate_Invalid := sentence_arrests_Fields.InValid_paroleeligibilitydate((SALT33.StrType)le.paroleeligibilitydate);
    SELF.parolehearingdate_Invalid := sentence_arrests_Fields.InValid_parolehearingdate((SALT33.StrType)le.parolehearingdate);
    SELF.parolemaxyears_Invalid := sentence_arrests_Fields.InValid_parolemaxyears((SALT33.StrType)le.parolemaxyears);
    SELF.parolemaxmonths_Invalid := sentence_arrests_Fields.InValid_parolemaxmonths((SALT33.StrType)le.parolemaxmonths);
    SELF.parolemaxdays_Invalid := sentence_arrests_Fields.InValid_parolemaxdays((SALT33.StrType)le.parolemaxdays);
    SELF.paroleminyears_Invalid := sentence_arrests_Fields.InValid_paroleminyears((SALT33.StrType)le.paroleminyears);
    SELF.paroleminmonths_Invalid := sentence_arrests_Fields.InValid_paroleminmonths((SALT33.StrType)le.paroleminmonths);
    SELF.parolemindays_Invalid := sentence_arrests_Fields.InValid_parolemindays((SALT33.StrType)le.parolemindays);
    SELF.probationbegindate_Invalid := sentence_arrests_Fields.InValid_probationbegindate((SALT33.StrType)le.probationbegindate);
    SELF.probationenddate_Invalid := sentence_arrests_Fields.InValid_probationenddate((SALT33.StrType)le.probationenddate);
    SELF.probationmaxyears_Invalid := sentence_arrests_Fields.InValid_probationmaxyears((SALT33.StrType)le.probationmaxyears);
    SELF.probationmaxmonths_Invalid := sentence_arrests_Fields.InValid_probationmaxmonths((SALT33.StrType)le.probationmaxmonths);
    SELF.probationmaxdays_Invalid := sentence_arrests_Fields.InValid_probationmaxdays((SALT33.StrType)le.probationmaxdays);
    SELF.probationminyears_Invalid := sentence_arrests_Fields.InValid_probationminyears((SALT33.StrType)le.probationminyears);
    SELF.probationminmonths_Invalid := sentence_arrests_Fields.InValid_probationminmonths((SALT33.StrType)le.probationminmonths);
    SELF.probationmindays_Invalid := sentence_arrests_Fields.InValid_probationmindays((SALT33.StrType)le.probationmindays);
    SELF.sourcename_Invalid := sentence_arrests_Fields.InValid_sourcename((SALT33.StrType)le.sourcename);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),sentence_arrests_Layout_crim);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,sentence_arrests_Layout_crim);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,sentence_arrests_Fields.InvalidMessage_recordid(le.recordid_Invalid),sentence_arrests_Fields.InvalidMessage_statecode(le.statecode_Invalid),sentence_arrests_Fields.InvalidMessage_caseid(le.caseid_Invalid),sentence_arrests_Fields.InvalidMessage_sentencedate(le.sentencedate_Invalid),sentence_arrests_Fields.InvalidMessage_sentencebegindate(le.sentencebegindate_Invalid),sentence_arrests_Fields.InvalidMessage_sentenceenddate(le.sentenceenddate_Invalid),sentence_arrests_Fields.InvalidMessage_sentencemaxyears(le.sentencemaxyears_Invalid),sentence_arrests_Fields.InvalidMessage_sentencemaxmonths(le.sentencemaxmonths_Invalid),sentence_arrests_Fields.InvalidMessage_sentencemaxdays(le.sentencemaxdays_Invalid),sentence_arrests_Fields.InvalidMessage_sentenceminyears(le.sentenceminyears_Invalid),sentence_arrests_Fields.InvalidMessage_sentenceminmonths(le.sentenceminmonths_Invalid),sentence_arrests_Fields.InvalidMessage_sentencemindays(le.sentencemindays_Invalid),sentence_arrests_Fields.InvalidMessage_scheduledreleasedate(le.scheduledreleasedate_Invalid),sentence_arrests_Fields.InvalidMessage_actualreleasedate(le.actualreleasedate_Invalid),sentence_arrests_Fields.InvalidMessage_timeservedyears(le.timeservedyears_Invalid),sentence_arrests_Fields.InvalidMessage_timeservedmonths(le.timeservedmonths_Invalid),sentence_arrests_Fields.InvalidMessage_timeserveddays(le.timeserveddays_Invalid),sentence_arrests_Fields.InvalidMessage_publicservicehours(le.publicservicehours_Invalid),sentence_arrests_Fields.InvalidMessage_communitysupervisionyears(le.communitysupervisionyears_Invalid),sentence_arrests_Fields.InvalidMessage_communitysupervisionmonths(le.communitysupervisionmonths_Invalid),sentence_arrests_Fields.InvalidMessage_communitysupervisiondays(le.communitysupervisiondays_Invalid),sentence_arrests_Fields.InvalidMessage_parolebegindate(le.parolebegindate_Invalid),sentence_arrests_Fields.InvalidMessage_paroleenddate(le.paroleenddate_Invalid),sentence_arrests_Fields.InvalidMessage_paroleeligibilitydate(le.paroleeligibilitydate_Invalid),sentence_arrests_Fields.InvalidMessage_parolehearingdate(le.parolehearingdate_Invalid),sentence_arrests_Fields.InvalidMessage_parolemaxyears(le.parolemaxyears_Invalid),sentence_arrests_Fields.InvalidMessage_parolemaxmonths(le.parolemaxmonths_Invalid),sentence_arrests_Fields.InvalidMessage_parolemaxdays(le.parolemaxdays_Invalid),sentence_arrests_Fields.InvalidMessage_paroleminyears(le.paroleminyears_Invalid),sentence_arrests_Fields.InvalidMessage_paroleminmonths(le.paroleminmonths_Invalid),sentence_arrests_Fields.InvalidMessage_parolemindays(le.parolemindays_Invalid),sentence_arrests_Fields.InvalidMessage_probationbegindate(le.probationbegindate_Invalid),sentence_arrests_Fields.InvalidMessage_probationenddate(le.probationenddate_Invalid),sentence_arrests_Fields.InvalidMessage_probationmaxyears(le.probationmaxyears_Invalid),sentence_arrests_Fields.InvalidMessage_probationmaxmonths(le.probationmaxmonths_Invalid),sentence_arrests_Fields.InvalidMessage_probationmaxdays(le.probationmaxdays_Invalid),sentence_arrests_Fields.InvalidMessage_probationminyears(le.probationminyears_Invalid),sentence_arrests_Fields.InvalidMessage_probationminmonths(le.probationminmonths_Invalid),sentence_arrests_Fields.InvalidMessage_probationmindays(le.probationmindays_Invalid),sentence_arrests_Fields.InvalidMessage_sourcename(le.sourcename_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,sentence_arrests_Fields.InvalidMessage_recordid(1)
          ,sentence_arrests_Fields.InvalidMessage_statecode(1)
          ,sentence_arrests_Fields.InvalidMessage_caseid(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencedate(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencebegindate(1)
          ,sentence_arrests_Fields.InvalidMessage_sentenceenddate(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencemaxyears(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencemaxmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencemaxdays(1)
          ,sentence_arrests_Fields.InvalidMessage_sentenceminyears(1)
          ,sentence_arrests_Fields.InvalidMessage_sentenceminmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_sentencemindays(1)
          ,sentence_arrests_Fields.InvalidMessage_scheduledreleasedate(1)
          ,sentence_arrests_Fields.InvalidMessage_actualreleasedate(1)
          ,sentence_arrests_Fields.InvalidMessage_timeservedyears(1)
          ,sentence_arrests_Fields.InvalidMessage_timeservedmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_timeserveddays(1)
          ,sentence_arrests_Fields.InvalidMessage_publicservicehours(1)
          ,sentence_arrests_Fields.InvalidMessage_communitysupervisionyears(1)
          ,sentence_arrests_Fields.InvalidMessage_communitysupervisionmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_communitysupervisiondays(1)
          ,sentence_arrests_Fields.InvalidMessage_parolebegindate(1)
          ,sentence_arrests_Fields.InvalidMessage_paroleenddate(1)
          ,sentence_arrests_Fields.InvalidMessage_paroleeligibilitydate(1)
          ,sentence_arrests_Fields.InvalidMessage_parolehearingdate(1)
          ,sentence_arrests_Fields.InvalidMessage_parolemaxyears(1)
          ,sentence_arrests_Fields.InvalidMessage_parolemaxmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_parolemaxdays(1)
          ,sentence_arrests_Fields.InvalidMessage_paroleminyears(1)
          ,sentence_arrests_Fields.InvalidMessage_paroleminmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_parolemindays(1)
          ,sentence_arrests_Fields.InvalidMessage_probationbegindate(1)
          ,sentence_arrests_Fields.InvalidMessage_probationenddate(1)
          ,sentence_arrests_Fields.InvalidMessage_probationmaxyears(1)
          ,sentence_arrests_Fields.InvalidMessage_probationmaxmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_probationmaxdays(1)
          ,sentence_arrests_Fields.InvalidMessage_probationminyears(1)
          ,sentence_arrests_Fields.InvalidMessage_probationminmonths(1)
          ,sentence_arrests_Fields.InvalidMessage_probationmindays(1)
          ,sentence_arrests_Fields.InvalidMessage_sourcename(1),'UNKNOWN');
