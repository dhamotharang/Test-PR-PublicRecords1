...
#workunit('name','Scrubs_Crim.addresshistory_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'addresshistory_Layout_crim'),NAMED('OptimizedLayout'));// File layout suggested by data
