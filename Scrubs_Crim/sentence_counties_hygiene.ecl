...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    sentence_counties_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    sentence_counties_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    sentence_counties_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    sentence_counties_Fields.InValid_sentencedate((SALT33.StrType)le.sentencedate),
    sentence_counties_Fields.InValid_sentencebegindate((SALT33.StrType)le.sentencebegindate),
    sentence_counties_Fields.InValid_sentenceenddate((SALT33.StrType)le.sentenceenddate),
    sentence_counties_Fields.InValid_sentencetype((SALT33.StrType)le.sentencetype),
    sentence_counties_Fields.InValid_sentencemaxyears((SALT33.StrType)le.sentencemaxyears),
    sentence_counties_Fields.InValid_sentencemaxmonths((SALT33.StrType)le.sentencemaxmonths),
    sentence_counties_Fields.InValid_sentencemaxdays((SALT33.StrType)le.sentencemaxdays),
    sentence_counties_Fields.InValid_sentenceminyears((SALT33.StrType)le.sentenceminyears),
    sentence_counties_Fields.InValid_sentenceminmonths((SALT33.StrType)le.sentenceminmonths),
    sentence_counties_Fields.InValid_sentencemindays((SALT33.StrType)le.sentencemindays),
    sentence_counties_Fields.InValid_scheduledreleasedate((SALT33.StrType)le.scheduledreleasedate),
    sentence_counties_Fields.InValid_actualreleasedate((SALT33.StrType)le.actualreleasedate),
    sentence_counties_Fields.InValid_sentencestatus((SALT33.StrType)le.sentencestatus),
    sentence_counties_Fields.InValid_timeservedyears((SALT33.StrType)le.timeservedyears),
    sentence_counties_Fields.InValid_timeservedmonths((SALT33.StrType)le.timeservedmonths),
    sentence_counties_Fields.InValid_timeserveddays((SALT33.StrType)le.timeserveddays),
    sentence_counties_Fields.InValid_publicservicehours((SALT33.StrType)le.publicservicehours),
    sentence_counties_Fields.InValid_sentenceadditionalinfo((SALT33.StrType)le.sentenceadditionalinfo),
    sentence_counties_Fields.InValid_communitysupervisioncounty((SALT33.StrType)le.communitysupervisioncounty),
    sentence_counties_Fields.InValid_communitysupervisionyears((SALT33.StrType)le.communitysupervisionyears),
    sentence_counties_Fields.InValid_communitysupervisionmonths((SALT33.StrType)le.communitysupervisionmonths),
    sentence_counties_Fields.InValid_communitysupervisiondays((SALT33.StrType)le.communitysupervisiondays),
    sentence_counties_Fields.InValid_parolebegindate((SALT33.StrType)le.parolebegindate),
    sentence_counties_Fields.InValid_paroleenddate((SALT33.StrType)le.paroleenddate),
    sentence_counties_Fields.InValid_paroleeligibilitydate((SALT33.StrType)le.paroleeligibilitydate),
    sentence_counties_Fields.InValid_parolehearingdate((SALT33.StrType)le.parolehearingdate),
    sentence_counties_Fields.InValid_parolemaxyears((SALT33.StrType)le.parolemaxyears),
    sentence_counties_Fields.InValid_parolemaxmonths((SALT33.StrType)le.parolemaxmonths),
    sentence_counties_Fields.InValid_parolemaxdays((SALT33.StrType)le.parolemaxdays),
    sentence_counties_Fields.InValid_paroleminyears((SALT33.StrType)le.paroleminyears),
    sentence_counties_Fields.InValid_paroleminmonths((SALT33.StrType)le.paroleminmonths),
    sentence_counties_Fields.InValid_parolemindays((SALT33.StrType)le.parolemindays),
    sentence_counties_Fields.InValid_parolestatus((SALT33.StrType)le.parolestatus),
    sentence_counties_Fields.InValid_paroleofficer((SALT33.StrType)le.paroleofficer),
    sentence_counties_Fields.InValid_paroleoffcerphone((SALT33.StrType)le.paroleoffcerphone),
    sentence_counties_Fields.InValid_probationbegindate((SALT33.StrType)le.probationbegindate),
    sentence_counties_Fields.InValid_probationenddate((SALT33.StrType)le.probationenddate),
    sentence_counties_Fields.InValid_probationmaxyears((SALT33.StrType)le.probationmaxyears),
    sentence_counties_Fields.InValid_probationmaxmonths((SALT33.StrType)le.probationmaxmonths),
    sentence_counties_Fields.InValid_probationmaxdays((SALT33.StrType)le.probationmaxdays),
    sentence_counties_Fields.InValid_probationminyears((SALT33.StrType)le.probationminyears),
    sentence_counties_Fields.InValid_probationminmonths((SALT33.StrType)le.probationminmonths),
    sentence_counties_Fields.InValid_probationmindays((SALT33.StrType)le.probationmindays),
    sentence_counties_Fields.InValid_probationstatus((SALT33.StrType)le.probationstatus),
    sentence_counties_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    sentence_counties_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
