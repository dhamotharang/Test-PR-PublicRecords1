...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    addresshistory_doc_Fields.InValid_recordid((SALT311.StrType)le.recordid),
    addresshistory_doc_Fields.InValid_statecode((SALT311.StrType)le.statecode),
    addresshistory_doc_Fields.InValid_street((SALT311.StrType)le.street),
    addresshistory_doc_Fields.InValid_unit((SALT311.StrType)le.unit),
    addresshistory_doc_Fields.InValid_city((SALT311.StrType)le.city),
    addresshistory_doc_Fields.InValid_orig_state((SALT311.StrType)le.orig_state),
    addresshistory_doc_Fields.InValid_orig_zip((SALT311.StrType)le.orig_zip),
    addresshistory_doc_Fields.InValid_addresstype((SALT311.StrType)le.addresstype),
    addresshistory_doc_Fields.InValid_sourcename((SALT311.StrType)le.sourcename),
    addresshistory_doc_Fields.InValid_sourceid((SALT311.StrType)le.sourceid),
    addresshistory_doc_Fields.InValid_vendor((SALT311.StrType)le.vendor),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doSummaryPerSrc = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Crim, addresshistory_doc_Fields, 'RECORDOF(fieldPopulationOverall)', TRUE);
