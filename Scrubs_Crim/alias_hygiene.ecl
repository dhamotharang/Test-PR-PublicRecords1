IMPORT ut,SALT33;
EXPORT alias_hygiene(dataset(alias_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    alias_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    alias_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    alias_Fields.InValid_akaname((SALT33.StrType)le.akaname),
    alias_Fields.InValid_akalastname((SALT33.StrType)le.akalastname),
    alias_Fields.InValid_akafirstname((SALT33.StrType)le.akafirstname),
    alias_Fields.InValid_akamiddlename((SALT33.StrType)le.akamiddlename),
    alias_Fields.InValid_akasuffix((SALT33.StrType)le.akasuffix),
    alias_Fields.InValid_akadob((SALT33.StrType)le.akadob),
    alias_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    alias_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := alias_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,alias_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),alias_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akaname(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akalastname(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akafirstname(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akamiddlename(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akasuffix(TotalErrors.ErrorNum),alias_Fields.InValidMessage_akadob(TotalErrors.ErrorNum),alias_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),alias_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
