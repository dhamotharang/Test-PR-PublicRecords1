...
EXPORT FromNone(DATASET(sentence_counties_Layout_crim) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.recordid_Invalid := sentence_counties_Fields.InValid_recordid((SALT33.StrType)le.recordid);
    SELF.statecode_Invalid := sentence_counties_Fields.InValid_statecode((SALT33.StrType)le.statecode);
    SELF.caseid_Invalid := sentence_counties_Fields.InValid_caseid((SALT33.StrType)le.caseid);
    SELF.sentencedate_Invalid := sentence_counties_Fields.InValid_sentencedate((SALT33.StrType)le.sentencedate);
    SELF.sentencebegindate_Invalid := sentence_counties_Fields.InValid_sentencebegindate((SALT33.StrType)le.sentencebegindate);
    SELF.sentenceenddate_Invalid := sentence_counties_Fields.InValid_sentenceenddate((SALT33.StrType)le.sentenceenddate);
    SELF.sentencemaxyears_Invalid := sentence_counties_Fields.InValid_sentencemaxyears((SALT33.StrType)le.sentencemaxyears);
    SELF.sentencemaxmonths_Invalid := sentence_counties_Fields.InValid_sentencemaxmonths((SALT33.StrType)le.sentencemaxmonths);
    SELF.sentencemaxdays_Invalid := sentence_counties_Fields.InValid_sentencemaxdays((SALT33.StrType)le.sentencemaxdays);
    SELF.sentenceminyears_Invalid := sentence_counties_Fields.InValid_sentenceminyears((SALT33.StrType)le.sentenceminyears);
    SELF.sentenceminmonths_Invalid := sentence_counties_Fields.InValid_sentenceminmonths((SALT33.StrType)le.sentenceminmonths);
    SELF.sentencemindays_Invalid := sentence_counties_Fields.InValid_sentencemindays((SALT33.StrType)le.sentencemindays);
    SELF.scheduledreleasedate_Invalid := sentence_counties_Fields.InValid_scheduledreleasedate((SALT33.StrType)le.scheduledreleasedate);
    SELF.actualreleasedate_Invalid := sentence_counties_Fields.InValid_actualreleasedate((SALT33.StrType)le.actualreleasedate);
    SELF.timeservedyears_Invalid := sentence_counties_Fields.InValid_timeservedyears((SALT33.StrType)le.timeservedyears);
    SELF.timeservedmonths_Invalid := sentence_counties_Fields.InValid_timeservedmonths((SALT33.StrType)le.timeservedmonths);
    SELF.timeserveddays_Invalid := sentence_counties_Fields.InValid_timeserveddays((SALT33.StrType)le.timeserveddays);
    SELF.publicservicehours_Invalid := sentence_counties_Fields.InValid_publicservicehours((SALT33.StrType)le.publicservicehours);
    SELF.communitysupervisionyears_Invalid := sentence_counties_Fields.InValid_communitysupervisionyears((SALT33.StrType)le.communitysupervisionyears);
    SELF.communitysupervisionmonths_Invalid := sentence_counties_Fields.InValid_communitysupervisionmonths((SALT33.StrType)le.communitysupervisionmonths);
    SELF.communitysupervisiondays_Invalid := sentence_counties_Fields.InValid_communitysupervisiondays((SALT33.StrType)le.communitysupervisiondays);
    SELF.parolebegindate_Invalid := sentence_counties_Fields.InValid_parolebegindate((SALT33.StrType)le.parolebegindate);
    SELF.paroleenddate_Invalid := sentence_counties_Fields.InValid_paroleenddate((SALT33.StrType)le.paroleenddate);
    SELF.paroleeligibilitydate_Invalid := sentence_counties_Fields.InValid_paroleeligibilitydate((SALT33.StrType)le.paroleeligibilitydate);
    SELF.parolehearingdate_Invalid := sentence_counties_Fields.InValid_parolehearingdate((SALT33.StrType)le.parolehearingdate);
    SELF.parolemaxyears_Invalid := sentence_counties_Fields.InValid_parolemaxyears((SALT33.StrType)le.parolemaxyears);
    SELF.parolemaxmonths_Invalid := sentence_counties_Fields.InValid_parolemaxmonths((SALT33.StrType)le.parolemaxmonths);
    SELF.parolemaxdays_Invalid := sentence_counties_Fields.InValid_parolemaxdays((SALT33.StrType)le.parolemaxdays);
    SELF.paroleminyears_Invalid := sentence_counties_Fields.InValid_paroleminyears((SALT33.StrType)le.paroleminyears);
    SELF.paroleminmonths_Invalid := sentence_counties_Fields.InValid_paroleminmonths((SALT33.StrType)le.paroleminmonths);
    SELF.parolemindays_Invalid := sentence_counties_Fields.InValid_parolemindays((SALT33.StrType)le.parolemindays);
    SELF.probationbegindate_Invalid := sentence_counties_Fields.InValid_probationbegindate((SALT33.StrType)le.probationbegindate);
    SELF.probationenddate_Invalid := sentence_counties_Fields.InValid_probationenddate((SALT33.StrType)le.probationenddate);
    SELF.probationmaxyears_Invalid := sentence_counties_Fields.InValid_probationmaxyears((SALT33.StrType)le.probationmaxyears);
    SELF.probationmaxmonths_Invalid := sentence_counties_Fields.InValid_probationmaxmonths((SALT33.StrType)le.probationmaxmonths);
    SELF.probationmaxdays_Invalid := sentence_counties_Fields.InValid_probationmaxdays((SALT33.StrType)le.probationmaxdays);
    SELF.probationminyears_Invalid := sentence_counties_Fields.InValid_probationminyears((SALT33.StrType)le.probationminyears);
    SELF.probationminmonths_Invalid := sentence_counties_Fields.InValid_probationminmonths((SALT33.StrType)le.probationminmonths);
    SELF.probationmindays_Invalid := sentence_counties_Fields.InValid_probationmindays((SALT33.StrType)le.probationmindays);
    SELF.sourcename_Invalid := sentence_counties_Fields.InValid_sourcename((SALT33.StrType)le.sourcename);
    SELF := le;
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,sentence_counties_Fields.InvalidMessage_sourcename(1),'UNKNOWN');
