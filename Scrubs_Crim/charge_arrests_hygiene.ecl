...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    charge_arrests_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    charge_arrests_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    charge_arrests_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    charge_arrests_Fields.InValid_warrantnumber((SALT33.StrType)le.warrantnumber),
    charge_arrests_Fields.InValid_warrantdate((SALT33.StrType)le.warrantdate),
    charge_arrests_Fields.InValid_warrantdesc((SALT33.StrType)le.warrantdesc),
    charge_arrests_Fields.InValid_warrantissuedate((SALT33.StrType)le.warrantissuedate),
    charge_arrests_Fields.InValid_warrantissuingagency((SALT33.StrType)le.warrantissuingagency),
    charge_arrests_Fields.InValid_warrantstatus((SALT33.StrType)le.warrantstatus),
    charge_arrests_Fields.InValid_citationnumber((SALT33.StrType)le.citationnumber),
    charge_arrests_Fields.InValid_bookingnumber((SALT33.StrType)le.bookingnumber),
    charge_arrests_Fields.InValid_arrestdate((SALT33.StrType)le.arrestdate),
    charge_arrests_Fields.InValid_arrestingagency((SALT33.StrType)le.arrestingagency),
    charge_arrests_Fields.InValid_bookingdate((SALT33.StrType)le.bookingdate),
    charge_arrests_Fields.InValid_custodydate((SALT33.StrType)le.custodydate),
    charge_arrests_Fields.InValid_custodylocation((SALT33.StrType)le.custodylocation),
    charge_arrests_Fields.InValid_initialcharge((SALT33.StrType)le.initialcharge),
    charge_arrests_Fields.InValid_initialchargedate((SALT33.StrType)le.initialchargedate),
    charge_arrests_Fields.InValid_initialchargecancelleddate((SALT33.StrType)le.initialchargecancelleddate),
    charge_arrests_Fields.InValid_chargedisposed((SALT33.StrType)le.chargedisposed),
    charge_arrests_Fields.InValid_chargedisposeddate((SALT33.StrType)le.chargedisposeddate),
    charge_arrests_Fields.InValid_chargeseverity((SALT33.StrType)le.chargeseverity),
    charge_arrests_Fields.InValid_chargedisposition((SALT33.StrType)le.chargedisposition),
    charge_arrests_Fields.InValid_amendedcharge((SALT33.StrType)le.amendedcharge),
    charge_arrests_Fields.InValid_amendedchargedate((SALT33.StrType)le.amendedchargedate),
    charge_arrests_Fields.InValid_bondsman((SALT33.StrType)le.bondsman),
    charge_arrests_Fields.InValid_bondamount((SALT33.StrType)le.bondamount),
    charge_arrests_Fields.InValid_bondtype((SALT33.StrType)le.bondtype),
    charge_arrests_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    charge_arrests_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    charge_arrests_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
