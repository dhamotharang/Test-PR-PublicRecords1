MODULE:Scrubs_Crim
FILENAME:crim
NAMESCOPE:Moxie_Crim_Offender2_Dev
SOURCEFIELD:vendor

FIELDTYPE:Invalid_Current_DOB:CUSTOM(Scrubs_Crim.fn_valid_dob>0)
FIELDTYPE:Invalid_Current_Date:CUSTOM(Scrubs.fn_valid_date>0)
FIELDTYPE:Invalid_Date_Type:ALLOW(IPSROAFD )
FIELDTYPE:Invalid_Case_Type:ENUM(TRF|CR|ADM|REL|RES|TR|JVTRF|MS|FE|BD|C|AW|AF|DF|DR|DW|SW|WF|DM|)
FIELDTYPE:Invalid_State:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:Invalid_Case_Num:LENGTHS(1..)
FIELDTYPE:Invalid_Num:ALLOW(0123456789)
FIELDTYPE:Invalid_Data_Type:ALLOW(215)
FIELDTYPE:Invalid_Offense_Score:ALLOW(MUFI )
FIELDTYPE:Non_Blank:LENGTHS(1..)

FIELD:process_date:LIKE(Invalid_Current_Date):TYPE(STRING8):0,0
FIELD:file_date:LIKE(Invalid_Current_Date):TYPE(STRING8):0,0
...
FIELD:case_date:LIKE(Invalid_Current_Date):TYPE(STRING8):0,0
...
FIELD:dob:LIKE(Invalid_Current_DOB):TYPE(STRING8):0,0
...
FIELD:clean_errors:LIKE(Invalid_Num):TYPE(UNSIGNED1):0,0
...
FIELD:offender_persistent_id:LIKE(Invalid_Num):TYPE(UNSIGNED8):0,0
