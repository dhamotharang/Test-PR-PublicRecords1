IMPORT ut,SALT33;
EXPORT defendant_doc_hygiene(dataset(defendant_doc_layout_crim) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    defendant_doc_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    defendant_doc_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    defendant_doc_Fields.InValid_sourcetype((SALT33.StrType)le.sourcetype),
    defendant_doc_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    defendant_doc_Fields.InValid_recordtype((SALT33.StrType)le.recordtype),
    defendant_doc_Fields.InValid_recorduploaddate((SALT33.StrType)le.recorduploaddate),
    defendant_doc_Fields.InValid_docnumber((SALT33.StrType)le.docnumber),
    defendant_doc_Fields.InValid_fbinumber((SALT33.StrType)le.fbinumber),
    defendant_doc_Fields.InValid_stateidnumber((SALT33.StrType)le.stateidnumber),
    defendant_doc_Fields.InValid_inmatenumber((SALT33.StrType)le.inmatenumber),
    defendant_doc_Fields.InValid_aliennumber((SALT33.StrType)le.aliennumber),
    defendant_doc_Fields.InValid_orig_ssn((SALT33.StrType)le.orig_ssn),
    defendant_doc_Fields.InValid_nametype((SALT33.StrType)le.nametype),
    defendant_doc_Fields.InValid_name((SALT33.StrType)le.name),
    defendant_doc_Fields.InValid_lastname((SALT33.StrType)le.lastname),
    defendant_doc_Fields.InValid_firstname((SALT33.StrType)le.firstname),
    defendant_doc_Fields.InValid_middlename((SALT33.StrType)le.middlename),
    defendant_doc_Fields.InValid_suffix((SALT33.StrType)le.suffix),
    defendant_doc_Fields.InValid_defendantstatus((SALT33.StrType)le.defendantstatus),
    defendant_doc_Fields.InValid_defendantadditionalinfo((SALT33.StrType)le.defendantadditionalinfo),
    defendant_doc_Fields.InValid_dob((SALT33.StrType)le.dob),
    defendant_doc_Fields.InValid_birthcity((SALT33.StrType)le.birthcity),
    defendant_doc_Fields.InValid_birthplace((SALT33.StrType)le.birthplace),
    defendant_doc_Fields.InValid_age((SALT33.StrType)le.age),
    defendant_doc_Fields.InValid_gender((SALT33.StrType)le.gender),
    defendant_doc_Fields.InValid_height((SALT33.StrType)le.height),
    defendant_doc_Fields.InValid_weight((SALT33.StrType)le.weight),
    defendant_doc_Fields.InValid_haircolor((SALT33.StrType)le.haircolor),
    defendant_doc_Fields.InValid_eyecolor((SALT33.StrType)le.eyecolor),
    defendant_doc_Fields.InValid_race((SALT33.StrType)le.race),
    defendant_doc_Fields.InValid_ethnicity((SALT33.StrType)le.ethnicity),
    defendant_doc_Fields.InValid_skincolor((SALT33.StrType)le.skincolor),
    defendant_doc_Fields.InValid_bodymarks((SALT33.StrType)le.bodymarks),
    defendant_doc_Fields.InValid_physicalbuild((SALT33.StrType)le.physicalbuild),
    defendant_doc_Fields.InValid_photoname((SALT33.StrType)le.photoname),
    defendant_doc_Fields.InValid_dlnumber((SALT33.StrType)le.dlnumber),
    defendant_doc_Fields.InValid_dlstate((SALT33.StrType)le.dlstate),
    defendant_doc_Fields.InValid_phone((SALT33.StrType)le.phone),
    defendant_doc_Fields.InValid_phonetype((SALT33.StrType)le.phonetype),
    defendant_doc_Fields.InValid_uscitizenflag((SALT33.StrType)le.uscitizenflag),
    defendant_doc_Fields.InValid_addresstype((SALT33.StrType)le.addresstype),
    defendant_doc_Fields.InValid_street((SALT33.StrType)le.street),
    defendant_doc_Fields.InValid_unit((SALT33.StrType)le.unit),
    defendant_doc_Fields.InValid_city((SALT33.StrType)le.city),
    defendant_doc_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    defendant_doc_Fields.InValid_orig_zip((SALT33.StrType)le.orig_zip),
    defendant_doc_Fields.InValid_county((SALT33.StrType)le.county),
    defendant_doc_Fields.InValid_institutionname((SALT33.StrType)le.institutionname),
    defendant_doc_Fields.InValid_institutiondetails((SALT33.StrType)le.institutiondetails),
    defendant_doc_Fields.InValid_institutionreceiptdate((SALT33.StrType)le.institutionreceiptdate),
    defendant_doc_Fields.InValid_releasetolocation((SALT33.StrType)le.releasetolocation),
    defendant_doc_Fields.InValid_releasetodetails((SALT33.StrType)le.releasetodetails),
    defendant_doc_Fields.InValid_deceasedflag((SALT33.StrType)le.deceasedflag),
    defendant_doc_Fields.InValid_deceaseddate((SALT33.StrType)le.deceaseddate),
    defendant_doc_Fields.InValid_healthflag((SALT33.StrType)le.healthflag),
    defendant_doc_Fields.InValid_healthdesc((SALT33.StrType)le.healthdesc),
    defendant_doc_Fields.InValid_bloodtype((SALT33.StrType)le.bloodtype),
    defendant_doc_Fields.InValid_sexoffenderregistrydate((SALT33.StrType)le.sexoffenderregistrydate),
    defendant_doc_Fields.InValid_sexoffenderregexpirationdate((SALT33.StrType)le.sexoffenderregexpirationdate),
    defendant_doc_Fields.InValid_sexoffenderregistrynumber((SALT33.StrType)le.sexoffenderregistrynumber),
    defendant_doc_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    defendant_doc_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := defendant_doc_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,defendant_doc_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sourcetype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_recordtype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_recorduploaddate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_docnumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_fbinumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_stateidnumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_inmatenumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_aliennumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_orig_ssn(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_nametype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_name(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_lastname(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_firstname(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_middlename(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_suffix(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_defendantstatus(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_defendantadditionalinfo(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_dob(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_birthcity(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_birthplace(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_age(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_gender(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_height(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_weight(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_haircolor(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_eyecolor(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_race(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_ethnicity(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_skincolor(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_bodymarks(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_physicalbuild(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_photoname(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_dlnumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_dlstate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_phone(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_phonetype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_uscitizenflag(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_addresstype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_street(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_unit(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_city(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_orig_zip(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_county(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_institutionname(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_institutiondetails(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_institutionreceiptdate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_releasetolocation(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_releasetodetails(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_deceasedflag(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_deceaseddate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_healthflag(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_healthdesc(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_bloodtype(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sexoffenderregistrydate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sexoffenderregexpirationdate(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sexoffenderregistrynumber(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),defendant_doc_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
