...
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Current_Date','Invalid_Future_Date','Non_Blank','Invalid_Char','Invalid_Data_Type','Invalid_FCRAConFlag','Invalid_FCRATrafficFlag','Invalid_FCRADateFlag','Invalid_ConOverDateFlag','Invalid_OffenseScore','Invalid_Num','Invalid_CourtOffLev','Invalid_ArrOffLev');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'Invalid_Current_Date' => 1,'Invalid_Future_Date' => 2,'Non_Blank' => 3,'Invalid_Char' => 4,'Invalid_Data_Type' => 5,'Invalid_FCRAConFlag' => 6,'Invalid_FCRATrafficFlag' => 7,'Invalid_FCRADateFlag' => 8,'Invalid_ConOverDateFlag' => 9,'Invalid_OffenseScore' => 10,'Invalid_Num' => 11,'Invalid_CourtOffLev' => 12,'Invalid_ArrOffLev' => 13,0);
...
EXPORT MakeFT_Invalid_Data_Type(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Data_Type(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['2','5']);
EXPORT InValidMessageFT_Invalid_Data_Type(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('2|5'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_FCRAConFlag(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_FCRAConFlag(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['Y','N','U','']);
EXPORT InValidMessageFT_Invalid_FCRAConFlag(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('Y|N|U|'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_FCRATrafficFlag(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_FCRATrafficFlag(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['N','Y','']);
EXPORT InValidMessageFT_Invalid_FCRATrafficFlag(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('N|Y|'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_FCRADateFlag(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_FCRADateFlag(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['S','D','']);
EXPORT InValidMessageFT_Invalid_FCRADateFlag(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('S|D|'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_ConOverDateFlag(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_ConOverDateFlag(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['D','F','O','A','S','']);
EXPORT InValidMessageFT_Invalid_ConOverDateFlag(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('D|F|O|A|S|'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_OffenseScore(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_OffenseScore(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['U','F','M','I','']);
EXPORT InValidMessageFT_Invalid_OffenseScore(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('U|F|M|I|'),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_CourtOffLev(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_CourtOffLev(SALT33.StrType s,SALT33.StrType vendor) := WHICH(~Scrubs_Crim.fn_CourtOffensesV3Check(s,vendor)>0);
EXPORT InValidMessageFT_Invalid_CourtOffLev(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('Scrubs_Crim.fn_CourtOffensesV3Check'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_ArrOffLev(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_ArrOffLev(SALT33.StrType s,SALT33.StrType vendor) := WHICH(~Scrubs_Crim.fn_ArrestOffensesV3Check(s,vendor)>0);
EXPORT InValidMessageFT_Invalid_ArrOffLev(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('Scrubs_Crim.fn_ArrestOffensesV3Check'),SALT33.HygieneErrors.Good);
...
EXPORT Make_state_origin(SALT33.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_state_origin(SALT33.StrType s) := InValidFT_Invalid_Char(s);
...
EXPORT Make_off_comp(SALT33.StrType s0) := s0;
EXPORT InValid_off_comp(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_off_comp(UNSIGNED1 wh) := '';
EXPORT Make_off_delete_flag(SALT33.StrType s0) := s0;
EXPORT InValid_off_delete_flag(SALT33.StrType s) := FALSE;
...
EXPORT Make_num_of_counts(SALT33.StrType s0) := s0;
EXPORT InValid_num_of_counts(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_num_of_counts(UNSIGNED1 wh) := '';
EXPORT Make_le_agency_cd(SALT33.StrType s0) := s0;
EXPORT InValid_le_agency_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_le_agency_cd(UNSIGNED1 wh) := '';
EXPORT Make_le_agency_desc(SALT33.StrType s0) := s0;
EXPORT InValid_le_agency_desc(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_le_agency_desc(UNSIGNED1 wh) := '';
EXPORT Make_le_agency_case_number(SALT33.StrType s0) := s0;
EXPORT InValid_le_agency_case_number(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_le_agency_case_number(UNSIGNED1 wh) := '';
EXPORT Make_traffic_ticket_number(SALT33.StrType s0) := s0;
EXPORT InValid_traffic_ticket_number(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_traffic_ticket_number(UNSIGNED1 wh) := '';
EXPORT Make_traffic_dl_no(SALT33.StrType s0) := s0;
EXPORT InValid_traffic_dl_no(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_traffic_dl_no(UNSIGNED1 wh) := '';
EXPORT Make_traffic_dl_st(SALT33.StrType s0) := s0;
EXPORT InValid_traffic_dl_st(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_traffic_dl_st(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_code(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_code(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_desc_1(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_desc_1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_desc_1(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_desc_2(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_desc_2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_desc_2(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_type_cd(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_type_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_type_cd(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_type_desc(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_type_desc(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_type_desc(UNSIGNED1 wh) := '';
EXPORT Make_arr_off_lev(SALT33.StrType s0) := MakeFT_Invalid_ArrOffLev(s0);
EXPORT InValid_arr_off_lev(SALT33.StrType s,SALT33.StrType vendor) := InValidFT_Invalid_ArrOffLev(s,vendor);
EXPORT InValidMessage_arr_off_lev(UNSIGNED1 wh) := InValidMessageFT_Invalid_ArrOffLev(wh);
EXPORT Make_arr_statute(SALT33.StrType s0) := s0;
EXPORT InValid_arr_statute(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_statute(UNSIGNED1 wh) := '';
EXPORT Make_arr_statute_desc(SALT33.StrType s0) := s0;
EXPORT InValid_arr_statute_desc(SALT33.StrType s) := FALSE;
...
EXPORT Make_arr_disp_code(SALT33.StrType s0) := s0;
EXPORT InValid_arr_disp_code(SALT33.StrType s) := FALSE;
...
EXPORT Make_pros_refer_cd(SALT33.StrType s0) := s0;
EXPORT InValid_pros_refer_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_refer_cd(UNSIGNED1 wh) := '';
EXPORT Make_pros_refer(SALT33.StrType s0) := s0;
EXPORT InValid_pros_refer(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_refer(UNSIGNED1 wh) := '';
EXPORT Make_pros_assgn_cd(SALT33.StrType s0) := s0;
EXPORT InValid_pros_assgn_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_assgn_cd(UNSIGNED1 wh) := '';
EXPORT Make_pros_assgn(SALT33.StrType s0) := s0;
EXPORT InValid_pros_assgn(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_assgn(UNSIGNED1 wh) := '';
EXPORT Make_pros_chg_rej(SALT33.StrType s0) := s0;
EXPORT InValid_pros_chg_rej(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_chg_rej(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_code(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_code(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_desc_1(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_desc_1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_desc_1(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_desc_2(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_desc_2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_desc_2(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_type_cd(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_type_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_type_cd(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_type_desc(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_type_desc(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_type_desc(UNSIGNED1 wh) := '';
EXPORT Make_pros_off_lev(SALT33.StrType s0) := s0;
EXPORT InValid_pros_off_lev(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_pros_off_lev(UNSIGNED1 wh) := '';
EXPORT Make_pros_act_filed(SALT33.StrType s0) := s0;
EXPORT InValid_pros_act_filed(SALT33.StrType s) := FALSE;
...
EXPORT Make_court_appeal_flag(SALT33.StrType s0) := s0;
EXPORT InValid_court_appeal_flag(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_appeal_flag(UNSIGNED1 wh) := '';
EXPORT Make_court_final_plea(SALT33.StrType s0) := s0;
EXPORT InValid_court_final_plea(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_final_plea(UNSIGNED1 wh) := '';
EXPORT Make_court_off_code(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_off_code(UNSIGNED1 wh) := '';
EXPORT Make_court_off_desc_1(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_desc_1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_off_desc_1(UNSIGNED1 wh) := '';
EXPORT Make_court_off_desc_2(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_desc_2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_off_desc_2(UNSIGNED1 wh) := '';
EXPORT Make_court_off_type_cd(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_type_cd(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_off_type_cd(UNSIGNED1 wh) := '';
EXPORT Make_court_off_type_desc(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_type_desc(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_off_type_desc(UNSIGNED1 wh) := '';
EXPORT Make_court_off_lev(SALT33.StrType s0) := MakeFT_Invalid_CourtOffLev(s0);
EXPORT InValid_court_off_lev(SALT33.StrType s,SALT33.StrType vendor) := InValidFT_Invalid_CourtOffLev(s,vendor);
EXPORT InValidMessage_court_off_lev(UNSIGNED1 wh) := InValidMessageFT_Invalid_CourtOffLev(wh);
EXPORT Make_court_statute(SALT33.StrType s0) := s0;
EXPORT InValid_court_statute(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_statute(UNSIGNED1 wh) := '';
EXPORT Make_court_additional_statutes(SALT33.StrType s0) := s0;
EXPORT InValid_court_additional_statutes(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_additional_statutes(UNSIGNED1 wh) := '';
EXPORT Make_court_statute_desc(SALT33.StrType s0) := s0;
EXPORT InValid_court_statute_desc(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_statute_desc(UNSIGNED1 wh) := '';
EXPORT Make_court_disp_date(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_court_disp_date(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_court_disp_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_court_disp_code(SALT33.StrType s0) := s0;
EXPORT InValid_court_disp_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_disp_code(UNSIGNED1 wh) := '';
EXPORT Make_court_disp_desc_1(SALT33.StrType s0) := s0;
EXPORT InValid_court_disp_desc_1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_disp_desc_1(UNSIGNED1 wh) := '';
EXPORT Make_court_disp_desc_2(SALT33.StrType s0) := s0;
EXPORT InValid_court_disp_desc_2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_court_disp_desc_2(UNSIGNED1 wh) := '';
EXPORT Make_sent_date(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_sent_date(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_sent_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
EXPORT Make_sent_jail(SALT33.StrType s0) := s0;
EXPORT InValid_sent_jail(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_jail(UNSIGNED1 wh) := '';
EXPORT Make_sent_susp_time(SALT33.StrType s0) := s0;
EXPORT InValid_sent_susp_time(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_susp_time(UNSIGNED1 wh) := '';
EXPORT Make_sent_court_cost(SALT33.StrType s0) := s0;
EXPORT InValid_sent_court_cost(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_court_cost(UNSIGNED1 wh) := '';
EXPORT Make_sent_court_fine(SALT33.StrType s0) := s0;
EXPORT InValid_sent_court_fine(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_court_fine(UNSIGNED1 wh) := '';
EXPORT Make_sent_susp_court_fine(SALT33.StrType s0) := s0;
EXPORT InValid_sent_susp_court_fine(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_susp_court_fine(UNSIGNED1 wh) := '';
EXPORT Make_sent_probation(SALT33.StrType s0) := s0;
EXPORT InValid_sent_probation(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_probation(UNSIGNED1 wh) := '';
EXPORT Make_sent_addl_prov_code(SALT33.StrType s0) := s0;
EXPORT InValid_sent_addl_prov_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_addl_prov_code(UNSIGNED1 wh) := '';
EXPORT Make_sent_addl_prov_desc_1(SALT33.StrType s0) := s0;
EXPORT InValid_sent_addl_prov_desc_1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_addl_prov_desc_1(UNSIGNED1 wh) := '';
EXPORT Make_sent_addl_prov_desc_2(SALT33.StrType s0) := s0;
EXPORT InValid_sent_addl_prov_desc_2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_addl_prov_desc_2(UNSIGNED1 wh) := '';
EXPORT Make_sent_consec(SALT33.StrType s0) := s0;
EXPORT InValid_sent_consec(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_consec(UNSIGNED1 wh) := '';
EXPORT Make_sent_agency_rec_cust_ori(SALT33.StrType s0) := s0;
EXPORT InValid_sent_agency_rec_cust_ori(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_agency_rec_cust_ori(UNSIGNED1 wh) := '';
EXPORT Make_sent_agency_rec_cust(SALT33.StrType s0) := s0;
EXPORT InValid_sent_agency_rec_cust(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sent_agency_rec_cust(UNSIGNED1 wh) := '';
EXPORT Make_appeal_date(SALT33.StrType s0) := s0;
EXPORT InValid_appeal_date(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_appeal_date(UNSIGNED1 wh) := '';
EXPORT Make_appeal_off_disp(SALT33.StrType s0) := s0;
EXPORT InValid_appeal_off_disp(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_appeal_off_disp(UNSIGNED1 wh) := '';
EXPORT Make_appeal_final_decision(SALT33.StrType s0) := s0;
EXPORT InValid_appeal_final_decision(SALT33.StrType s) := FALSE;
...
EXPORT Make_offense_town(SALT33.StrType s0) := s0;
EXPORT InValid_offense_town(SALT33.StrType s) := FALSE;
...
EXPORT Make_community_service(SALT33.StrType s0) := s0;
EXPORT InValid_community_service(SALT33.StrType s) := FALSE;
...
EXPORT Make_addl_sent_dates(SALT33.StrType s0) := s0;
EXPORT InValid_addl_sent_dates(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_addl_sent_dates(UNSIGNED1 wh) := '';
EXPORT Make_probation_desc2(SALT33.StrType s0) := s0;
EXPORT InValid_probation_desc2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_probation_desc2(UNSIGNED1 wh) := '';
EXPORT Make_court_dt(SALT33.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_court_dt(SALT33.StrType s) := InValidFT_Invalid_Future_Date(s);
...
EXPORT Make_arr_off_lev_mapped(SALT33.StrType s0) := s0;
EXPORT InValid_arr_off_lev_mapped(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_arr_off_lev_mapped(UNSIGNED1 wh) := '';
EXPORT Make_court_off_lev_mapped(SALT33.StrType s0) := s0;
EXPORT InValid_court_off_lev_mapped(SALT33.StrType s) := FALSE;
...
EXPORT Make_offense_score(SALT33.StrType s0) := MakeFT_Invalid_OffenseScore(s0);
EXPORT InValid_offense_score(SALT33.StrType s) := InValidFT_Invalid_OffenseScore(s);
