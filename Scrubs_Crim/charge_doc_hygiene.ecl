IMPORT ut,SALT33;
EXPORT charge_doc_hygiene(dataset(charge_doc_layout_crim) h) := MODULE
...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_warrantnumber := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantnumber)));
    avelength_warrantnumber := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantnumber)),h.warrantnumber<>(typeof(h.warrantnumber))'');
    populated_warrantdate_pcnt := AVE(GROUP,IF(h.warrantdate = (TYPEOF(h.warrantdate))'',0,100));
    maxlength_warrantdate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantdate)));
    avelength_warrantdate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantdate)),h.warrantdate<>(typeof(h.warrantdate))'');
    populated_warrantdesc_pcnt := AVE(GROUP,IF(h.warrantdesc = (TYPEOF(h.warrantdesc))'',0,100));
    maxlength_warrantdesc := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantdesc)));
    avelength_warrantdesc := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantdesc)),h.warrantdesc<>(typeof(h.warrantdesc))'');
    populated_warrantissuedate_pcnt := AVE(GROUP,IF(h.warrantissuedate = (TYPEOF(h.warrantissuedate))'',0,100));
    maxlength_warrantissuedate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantissuedate)));
    avelength_warrantissuedate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantissuedate)),h.warrantissuedate<>(typeof(h.warrantissuedate))'');
    populated_warrantissuingagency_pcnt := AVE(GROUP,IF(h.warrantissuingagency = (TYPEOF(h.warrantissuingagency))'',0,100));
    maxlength_warrantissuingagency := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantissuingagency)));
    avelength_warrantissuingagency := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantissuingagency)),h.warrantissuingagency<>(typeof(h.warrantissuingagency))'');
    populated_warrantstatus_pcnt := AVE(GROUP,IF(h.warrantstatus = (TYPEOF(h.warrantstatus))'',0,100));
    maxlength_warrantstatus := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantstatus)));
    avelength_warrantstatus := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.warrantstatus)),h.warrantstatus<>(typeof(h.warrantstatus))'');
    populated_citationnumber_pcnt := AVE(GROUP,IF(h.citationnumber = (TYPEOF(h.citationnumber))'',0,100));
    maxlength_citationnumber := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.citationnumber)));
    avelength_citationnumber := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.citationnumber)),h.citationnumber<>(typeof(h.citationnumber))'');
    populated_bookingnumber_pcnt := AVE(GROUP,IF(h.bookingnumber = (TYPEOF(h.bookingnumber))'',0,100));
    maxlength_bookingnumber := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.bookingnumber)));
    avelength_bookingnumber := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.bookingnumber)),h.bookingnumber<>(typeof(h.bookingnumber))'');
    populated_arrestdate_pcnt := AVE(GROUP,IF(h.arrestdate = (TYPEOF(h.arrestdate))'',0,100));
    maxlength_arrestdate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arrestdate)));
    avelength_arrestdate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arrestdate)),h.arrestdate<>(typeof(h.arrestdate))'');
    populated_arrestingagency_pcnt := AVE(GROUP,IF(h.arrestingagency = (TYPEOF(h.arrestingagency))'',0,100));
    maxlength_arrestingagency := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.arrestingagency)));
    avelength_arrestingagency := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.arrestingagency)),h.arrestingagency<>(typeof(h.arrestingagency))'');
    populated_bookingdate_pcnt := AVE(GROUP,IF(h.bookingdate = (TYPEOF(h.bookingdate))'',0,100));
    maxlength_bookingdate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.bookingdate)));
    avelength_bookingdate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.bookingdate)),h.bookingdate<>(typeof(h.bookingdate))'');
    populated_custodydate_pcnt := AVE(GROUP,IF(h.custodydate = (TYPEOF(h.custodydate))'',0,100));
    maxlength_custodydate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.custodydate)));
    avelength_custodydate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.custodydate)),h.custodydate<>(typeof(h.custodydate))'');
    populated_custodylocation_pcnt := AVE(GROUP,IF(h.custodylocation = (TYPEOF(h.custodylocation))'',0,100));
    maxlength_custodylocation := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.custodylocation)));
    avelength_custodylocation := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.custodylocation)),h.custodylocation<>(typeof(h.custodylocation))'');
    populated_initialcharge_pcnt := AVE(GROUP,IF(h.initialcharge = (TYPEOF(h.initialcharge))'',0,100));
    maxlength_initialcharge := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialcharge)));
    avelength_initialcharge := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialcharge)),h.initialcharge<>(typeof(h.initialcharge))'');
    populated_initialchargedate_pcnt := AVE(GROUP,IF(h.initialchargedate = (TYPEOF(h.initialchargedate))'',0,100));
    maxlength_initialchargedate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialchargedate)));
    avelength_initialchargedate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialchargedate)),h.initialchargedate<>(typeof(h.initialchargedate))'');
    ...
    maxlength_initialchargecancelleddate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialchargecancelleddate)));
    avelength_initialchargecancelleddate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.initialchargecancelleddate)),h.initialchargecancelleddate<>(typeof(h.initialchargecancelleddate))'');
    populated_chargedisposed_pcnt := AVE(GROUP,IF(h.chargedisposed = (TYPEOF(h.chargedisposed))'',0,100));
    maxlength_chargedisposed := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposed)));
    avelength_chargedisposed := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposed)),h.chargedisposed<>(typeof(h.chargedisposed))'');
    populated_chargedisposeddate_pcnt := AVE(GROUP,IF(h.chargedisposeddate = (TYPEOF(h.chargedisposeddate))'',0,100));
    maxlength_chargedisposeddate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposeddate)));
    avelength_chargedisposeddate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposeddate)),h.chargedisposeddate<>(typeof(h.chargedisposeddate))'');
    populated_chargeseverity_pcnt := AVE(GROUP,IF(h.chargeseverity = (TYPEOF(h.chargeseverity))'',0,100));
    maxlength_chargeseverity := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargeseverity)));
    avelength_chargeseverity := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargeseverity)),h.chargeseverity<>(typeof(h.chargeseverity))'');
    populated_chargedisposition_pcnt := AVE(GROUP,IF(h.chargedisposition = (TYPEOF(h.chargedisposition))'',0,100));
    maxlength_chargedisposition := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposition)));
    avelength_chargedisposition := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.chargedisposition)),h.chargedisposition<>(typeof(h.chargedisposition))'');
    populated_amendedcharge_pcnt := AVE(GROUP,IF(h.amendedcharge = (TYPEOF(h.amendedcharge))'',0,100));
    maxlength_amendedcharge := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amendedcharge)));
    avelength_amendedcharge := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amendedcharge)),h.amendedcharge<>(typeof(h.amendedcharge))'');
    populated_amendedchargedate_pcnt := AVE(GROUP,IF(h.amendedchargedate = (TYPEOF(h.amendedchargedate))'',0,100));
    maxlength_amendedchargedate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amendedchargedate)));
    avelength_amendedchargedate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amendedchargedate)),h.amendedchargedate<>(typeof(h.amendedchargedate))'');
    populated_bondsman_pcnt := AVE(GROUP,IF(h.bondsman = (TYPEOF(h.bondsman))'',0,100));
    maxlength_bondsman := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondsman)));
    avelength_bondsman := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondsman)),h.bondsman<>(typeof(h.bondsman))'');
    populated_bondamount_pcnt := AVE(GROUP,IF(h.bondamount = (TYPEOF(h.bondamount))'',0,100));
    maxlength_bondamount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondamount)));
    avelength_bondamount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondamount)),h.bondamount<>(typeof(h.bondamount))'');
    populated_bondtype_pcnt := AVE(GROUP,IF(h.bondtype = (TYPEOF(h.bondtype))'',0,100));
    maxlength_bondtype := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondtype)));
    avelength_bondtype := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.bondtype)),h.bondtype<>(typeof(h.bondtype))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Src := le.vendor;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.recordid),TRIM((SALT33.StrType)le.statecode),TRIM((SALT33.StrType)le.caseid),TRIM((SALT33.StrType)le.warrantnumber),TRIM((SALT33.StrType)le.warrantdate),TRIM((SALT33.StrType)le.warrantdesc),TRIM((SALT33.StrType)le.warrantissuedate),TRIM((SALT33.StrType)le.warrantissuingagency),TRIM((SALT33.StrType)le.warrantstatus),TRIM((SALT33.StrType)le.citationnumber),TRIM((SALT33.StrType)le.bookingnumber),TRIM((SALT33.StrType)le.arrestdate),TRIM((SALT33.StrType)le.arrestingagency),TRIM((SALT33.StrType)le.bookingdate),TRIM((SALT33.StrType)le.custodydate),TRIM((SALT33.StrType)le.custodylocation),TRIM((SALT33.StrType)le.initialcharge),TRIM((SALT33.StrType)le.initialchargedate),TRIM((SALT33.StrType)le.initialchargecancelleddate),TRIM((SALT33.StrType)le.chargedisposed),TRIM((SALT33.StrType)le.chargedisposeddate),TRIM((SALT33.StrType)le.chargeseverity),TRIM((SALT33.StrType)le.chargedisposition),TRIM((SALT33.StrType)le.amendedcharge),TRIM((SALT33.StrType)le.amendedchargedate),TRIM((SALT33.StrType)le.bondsman),TRIM((SALT33.StrType)le.bondamount),TRIM((SALT33.StrType)le.bondtype),TRIM((SALT33.StrType)le.sourcename),TRIM((SALT33.StrType)le.sourceid),TRIM((SALT33.StrType)le.vendor)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 31);
  SELF.FldNo2 := 1 + (C % 31);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.recordid),TRIM((SALT33.StrType)le.statecode),TRIM((SALT33.StrType)le.caseid),TRIM((SALT33.StrType)le.warrantnumber),TRIM((SALT33.StrType)le.warrantdate),TRIM((SALT33.StrType)le.warrantdesc),TRIM((SALT33.StrType)le.warrantissuedate),TRIM((SALT33.StrType)le.warrantissuingagency),TRIM((SALT33.StrType)le.warrantstatus),TRIM((SALT33.StrType)le.citationnumber),TRIM((SALT33.StrType)le.bookingnumber),TRIM((SALT33.StrType)le.arrestdate),TRIM((SALT33.StrType)le.arrestingagency),TRIM((SALT33.StrType)le.bookingdate),TRIM((SALT33.StrType)le.custodydate),TRIM((SALT33.StrType)le.custodylocation),TRIM((SALT33.StrType)le.initialcharge),TRIM((SALT33.StrType)le.initialchargedate),TRIM((SALT33.StrType)le.initialchargecancelleddate),TRIM((SALT33.StrType)le.chargedisposed),TRIM((SALT33.StrType)le.chargedisposeddate),TRIM((SALT33.StrType)le.chargeseverity),TRIM((SALT33.StrType)le.chargedisposition),TRIM((SALT33.StrType)le.amendedcharge),TRIM((SALT33.StrType)le.amendedchargedate),TRIM((SALT33.StrType)le.bondsman),TRIM((SALT33.StrType)le.bondamount),TRIM((SALT33.StrType)le.bondtype),TRIM((SALT33.StrType)le.sourcename),TRIM((SALT33.StrType)le.sourceid),TRIM((SALT33.StrType)le.vendor)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.recordid),TRIM((SALT33.StrType)le.statecode),TRIM((SALT33.StrType)le.caseid),TRIM((SALT33.StrType)le.warrantnumber),TRIM((SALT33.StrType)le.warrantdate),TRIM((SALT33.StrType)le.warrantdesc),TRIM((SALT33.StrType)le.warrantissuedate),TRIM((SALT33.StrType)le.warrantissuingagency),TRIM((SALT33.StrType)le.warrantstatus),TRIM((SALT33.StrType)le.citationnumber),TRIM((SALT33.StrType)le.bookingnumber),TRIM((SALT33.StrType)le.arrestdate),TRIM((SALT33.StrType)le.arrestingagency),TRIM((SALT33.StrType)le.bookingdate),TRIM((SALT33.StrType)le.custodydate),TRIM((SALT33.StrType)le.custodylocation),TRIM((SALT33.StrType)le.initialcharge),TRIM((SALT33.StrType)le.initialchargedate),TRIM((SALT33.StrType)le.initialchargecancelleddate),TRIM((SALT33.StrType)le.chargedisposed),TRIM((SALT33.StrType)le.chargedisposeddate),TRIM((SALT33.StrType)le.chargeseverity),TRIM((SALT33.StrType)le.chargedisposition),TRIM((SALT33.StrType)le.amendedcharge),TRIM((SALT33.StrType)le.amendedchargedate),TRIM((SALT33.StrType)le.bondsman),TRIM((SALT33.StrType)le.bondamount),TRIM((SALT33.StrType)le.bondtype),TRIM((SALT33.StrType)le.sourcename),TRIM((SALT33.StrType)le.sourceid),TRIM((SALT33.StrType)le.vendor)));
  END;
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    charge_doc_Fields.InValid_recordid((SALT33.StrType)le.recordid),
    charge_doc_Fields.InValid_statecode((SALT33.StrType)le.statecode),
    charge_doc_Fields.InValid_caseid((SALT33.StrType)le.caseid),
    charge_doc_Fields.InValid_warrantnumber((SALT33.StrType)le.warrantnumber),
    charge_doc_Fields.InValid_warrantdate((SALT33.StrType)le.warrantdate),
    charge_doc_Fields.InValid_warrantdesc((SALT33.StrType)le.warrantdesc),
    charge_doc_Fields.InValid_warrantissuedate((SALT33.StrType)le.warrantissuedate),
    charge_doc_Fields.InValid_warrantissuingagency((SALT33.StrType)le.warrantissuingagency),
    charge_doc_Fields.InValid_warrantstatus((SALT33.StrType)le.warrantstatus),
    charge_doc_Fields.InValid_citationnumber((SALT33.StrType)le.citationnumber),
    charge_doc_Fields.InValid_bookingnumber((SALT33.StrType)le.bookingnumber),
    charge_doc_Fields.InValid_arrestdate((SALT33.StrType)le.arrestdate),
    charge_doc_Fields.InValid_arrestingagency((SALT33.StrType)le.arrestingagency),
    charge_doc_Fields.InValid_bookingdate((SALT33.StrType)le.bookingdate),
    charge_doc_Fields.InValid_custodydate((SALT33.StrType)le.custodydate),
    charge_doc_Fields.InValid_custodylocation((SALT33.StrType)le.custodylocation),
    charge_doc_Fields.InValid_initialcharge((SALT33.StrType)le.initialcharge),
    charge_doc_Fields.InValid_initialchargedate((SALT33.StrType)le.initialchargedate),
    charge_doc_Fields.InValid_initialchargecancelleddate((SALT33.StrType)le.initialchargecancelleddate),
    charge_doc_Fields.InValid_chargedisposed((SALT33.StrType)le.chargedisposed),
    charge_doc_Fields.InValid_chargedisposeddate((SALT33.StrType)le.chargedisposeddate),
    charge_doc_Fields.InValid_chargeseverity((SALT33.StrType)le.chargeseverity),
    charge_doc_Fields.InValid_chargedisposition((SALT33.StrType)le.chargedisposition),
    charge_doc_Fields.InValid_amendedcharge((SALT33.StrType)le.amendedcharge),
    charge_doc_Fields.InValid_amendedchargedate((SALT33.StrType)le.amendedchargedate),
    charge_doc_Fields.InValid_bondsman((SALT33.StrType)le.bondsman),
    charge_doc_Fields.InValid_bondamount((SALT33.StrType)le.bondamount),
    charge_doc_Fields.InValid_bondtype((SALT33.StrType)le.bondtype),
    charge_doc_Fields.InValid_sourcename((SALT33.StrType)le.sourcename),
    charge_doc_Fields.InValid_sourceid((SALT33.StrType)le.sourceid),
    charge_doc_Fields.InValid_vendor((SALT33.StrType)le.vendor),
    0);
...
PrettyErrorTotals := RECORD
  TotalErrors.vendor;
  FieldNme := charge_doc_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,charge_doc_Fields.InValidMessage_recordid(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_statecode(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_caseid(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantnumber(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantdate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantdesc(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantissuedate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantissuingagency(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_warrantstatus(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_citationnumber(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_bookingnumber(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_arrestdate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_arrestingagency(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_bookingdate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_custodydate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_custodylocation(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_initialcharge(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_initialchargedate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_initialchargecancelleddate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_chargedisposed(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_chargedisposeddate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_chargeseverity(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_chargedisposition(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_amendedcharge(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_amendedchargedate(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_bondsman(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_bondamount(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_bondtype(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_sourcename(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_sourceid(TotalErrors.ErrorNum),charge_doc_Fields.InValidMessage_vendor(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
