...
IMPORT SALT311;
EXPORT Wireless_to_Wireline_NoRange_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Wireless_to_Wireline_NoRange';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FILENAME:Phone_TCPA\n'
    + 'NAMESCOPE:Wireless_to_Wireline_NoRange\n'
    + '\n'
