...
#workunit('name','Scrubs_Phone_TCPA.Wireline_to_Wireless2_BWR_Scrubs - Checking field validity in a file - SALT V3.11.11');
IMPORT Scrubs_Phone_TCPA,SALT311;
infile := Scrubs_Phone_TCPA.Wireline_to_Wireless2_In_Phone_TCPA;
mod_scrubs := Scrubs_Phone_TCPA.Wireline_to_Wireless2_Scrubs;
