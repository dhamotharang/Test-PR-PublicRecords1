...
IMPORT SALT311;
EXPORT Wireline_to_Wireless_NoRange_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Wireline_to_Wireless_NoRange';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FILENAME:Phone_TCPA\n'
    + 'NAMESCOPE:Wireline_to_Wireless_NoRange\n'
    + '\n'
