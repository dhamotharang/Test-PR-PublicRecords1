...
#workunit('name','Scrubs_Phone_TCPA.BaseFile2_BWR_Hygiene - Hygiene & Stats - SALT V3.11.11');
IMPORT Scrubs_Phone_TCPA,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Phone_TCPA.BaseFile2_In_Phone_TCPA;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Phone_TCPA.BaseFile2_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'BaseFile2_Layout_Phone_TCPA'),NAMED('OptimizedLayout'));// File layout suggested by data
