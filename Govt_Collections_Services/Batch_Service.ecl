...
EXPORT Batch_Service() := FUNCTION
  ...
  #CONSTANT('TwoPartySearch', FALSE);
    ...
    #WEBSERVICE(FIELDS(
      ...
      'DPPAPurpose',
      'GLBPurpose',
      'DataRestrictionMask', //[7] must be '0' for non-DMV sources
      'DataPermissionMask',
      'AppendBestData',
      'DIDScoreThreshold', //Not per requirements; for convenience.
      'GetSSNBest',
      'IncludeMinors',
      'industry_class',
      'InputState', //2-char state abbr.
      'MaxPhoneCount', //values 0 or 3.
      'MaxResultsPerAcct',
      'PenaltThreshold',
      'SSNMask'
    ));
