export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1	 	:= 'PHYSICAL ADDRESS|PHYSICAL REGISTERED ADDRESS|MAILING ADDRESS|NO LETTER SENT|';		
		shared PatternInvalidWords2		:= '^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |UNKNOWN|^NO OFFICE$';
