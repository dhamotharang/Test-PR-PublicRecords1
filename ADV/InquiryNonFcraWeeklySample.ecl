...
import ut, STD,did_add, riskwise;
 ...
 completeInquiryNonFCRAWeekly := dataset( '~thor_data400::out::inquiry_tracking::weekly_historical', final_layout, thor);



 inqNonFCRAWeeklyBuildName := 'inquiry_build_version';
 inqNonFCRAWeeklyBuildDate := did_add.get_EnvVariable(inqNonFCRAWeeklyBuildName, riskwise.shortcuts.staging_neutral_roxieIP);
 
  // inquiryNonFCRAWeeklySample := enth(completeInquiryNonFCRAWeekly, 50000);
	
 /*********************************************************************************************/
 //we can use the following sample to capture the records on the inqNonFCRAWeeklyBuildDate.
  /*********************************************************************************************/
 inquiryNonFCRAWeeklySample := choosen(completeInquiryNonFCRAWeekly(search_info.datetime[1..8] = inqNonFCRAWeeklyBuildDate), 50000);
 
 OUTPUT(inquiryNonFCRAWeeklySample,,'~ADV::inquiryNonFCRAWeeklySample_' + inqNonFCRAWeeklyBuildDate, thor, overwrite);
