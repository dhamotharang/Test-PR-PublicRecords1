...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_Y_N','invalid_ar_report_nbr','invalid_numeric');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_Y_N' => 8,'invalid_ar_report_nbr' => 9,'invalid_numeric' => 10,0);
...
EXPORT MakeFT_invalid_ar_report_nbr(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ar_report_nbr(SALT311.StrType s) := WHICH(~Scrubs_Corp2_Mapping_NH_AR.Functions.valid_documentid(s)>0);
EXPORT InValidMessageFT_invalid_ar_report_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NH_AR.Functions.valid_documentid'),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','LENGTHS'],['ENUM'],[],[],['ENUM'],['ALLOW','CUSTOM'],['ALLOW','LENGTHS'],['ALLOW'],[],[],['ALLOW'],['ALLOW','CUSTOM'],['CUSTOM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]);
...
EXPORT Make_ar_year(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ar_year(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_ar_due_dt(SALT311.StrType s0) := s0;
EXPORT InValid_ar_due_dt(SALT311.StrType s) := 0;
EXPORT InValidMessage_ar_due_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_filed_dt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ar_filed_dt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ar_filed_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
...
EXPORT Make_ar_report_nbr(SALT311.StrType s0) := MakeFT_invalid_ar_report_nbr(s0);
EXPORT InValid_ar_report_nbr(SALT311.StrType s) := InValidFT_invalid_ar_report_nbr(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Corp2_Mapping_NH_AR;
