...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_NH_AR';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_NH_AR\n'
    + 'FILENAME:In_NH\n'
    ...
    + 'FIELDTYPE:invalid_ar_report_nbr:CUSTOM(Scrubs_Corp2_Mapping_NH_AR.Functions.valid_documentid>0)\n'
    ...
    + 'FIELD:ar_filed_dt:TYPE(STRING8):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:ar_report_dt:TYPE(STRING8):LIKE(invalid_date):0,0\n'
    + 'FIELD:ar_report_nbr:TYPE(STRING30):LIKE(invalid_ar_report_nbr):0,0\n'
