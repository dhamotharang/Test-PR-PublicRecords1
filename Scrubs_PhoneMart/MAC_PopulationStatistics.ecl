EXPORT MAC_PopulationStatistics(infile,Ref='',Input_phone = '',Input_did = '',Input_dt_vendor_first_reported = '',Input_dt_vendor_last_reported = '',Input_dt_first_seen = '',Input_dt_last_seen = '',Input_record_type = '',Input_cid_number = '',Input_csd_ref_number = '',Input_ssn = '',Input_address = '',Input_city = '',Input_state = '',Input_zipcode = '',Input_history_flag = '',Input_title = '',Input_fname = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_record_type)='' )
    ...
    #END
+    #IF( #TEXT(Input_cid_number)='' )
      '' 
    #ELSE
        IF( le.Input_cid_number = (TYPEOF(le.Input_cid_number))'','',':cid_number')
    #END
+    #IF( #TEXT(Input_csd_ref_number)='' )
      '' 
    #ELSE
        IF( le.Input_csd_ref_number = (TYPEOF(le.Input_csd_ref_number))'','',':csd_ref_number')
    #END
+    #IF( #TEXT(Input_ssn)='' )
      '' 
    #ELSE
