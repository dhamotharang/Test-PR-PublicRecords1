...
EXPORT TokenKeyName := '~'+'key::BIPV2_Best_Seleid::Seleid::Token::TokenKey';
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_Best_Seleid::Seleid::Token::MultiTokenKey';
...
EXPORT ConceptKeyName := '~'+'key::BIPV2_Best_Seleid::Seleid::Token::ConceptKey';
...
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_Best_Seleid::Seleid::Token::ConceptKey';
