...
OUTPUT(CM.BestDbaNameVotedSeleLevel_tab_dba_name,NAMED('Tab_BestDbaNameVotedSeleLevel_dba_name'));
OUTPUT(CM.BestDbaNameVotedSeleLevel_method_dba_name,NAMED('Method_BestDbaNameVotedSeleLevel_dba_name'));
