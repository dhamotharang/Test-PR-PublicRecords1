...
#workunit('name','BIPV2_Best_Seleid.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_Best_Seleid,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_Best_Seleid.In_Base;
  h := BIPV2_Best_Seleid.Hygiene(infile);
  ...
  CM := BIPV2_Best_Seleid.Fields.UIDConsistency(BIPV2_Best_Seleid.In_Base);
