...
#workunit('name','BIPV2_Best_Seleid.BWR_Specificities - Specificities - SALT V3.0 Gold');
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_Best_Seleid.<your_spc_attribute>',BIPV2_Best_Seleid.In_Base);
