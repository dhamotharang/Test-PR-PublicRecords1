...
//DBA Name
BESTTYPE:BestDbaNameLegal:BASIS(Seleid):VOTED(fn_Best_Name_Legal_Votes):FUZZY:VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameVotedSeleLevel:BASIS(Seleid):VOTED(fn_Best_Sele_Level_Votes,2):VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameCommon:BASIS(Seleid):COMMONEST:FUZZY:MINIMUM(2):VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameCurrent:BASIS(Seleid):RECENT(dt_last_seen):FUZZY:MINIMUM(2):VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameVoted:BASIS(Seleid):VOTED(fn_Best_Name_Source_Votes,2):VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameLength:BASIS(Seleid):LONGEST:FUZZY:VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameStrong:BASIS(Seleid):UNIQUE:FUZZY:VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameCurrent2:BASIS(Seleid):RECENT(dt_last_seen):VALID(fn_valid_cname):EXTEND
BESTTYPE:BestDbaNameVotedUnrestricted:BASIS(Seleid):VOTED(fn_Best_Source_Unrestricted_Votes,2):VALID(fn_valid_cname):EXTEND
...
FIELD:dba_name:LIKE(cname):BestDbaNameLegal:BestDbaNameVotedSeleLevel:BestDbaNameCommon:BestDbaNameCurrent:BestDbaNameVoted:BestDbaNameLength:BestDbaNameStrong:BestDbaNameCurrent2:BestDbaNameVotedUnrestricted:FLAG:26,148
// ------------------------------------
...
Total available specificity:332
...
(This subtraction estimate is based upon 14% of clusters with 2 or more records have 2 or more values for dba_name.)
