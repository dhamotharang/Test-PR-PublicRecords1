...
#workunit('name','BIPV2_Best_Seleid.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
...
SALT30.MAC_MatchSamplePatterns(BIPV2_Best_Seleid.Keys(BIPV2_Best_Seleid.In_Base).MatchSample,MatchPatterns,Seleid1,Seleid2,8,38-44);
...
ConfThreshold:=41;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_Best_Seleid.Keys(BIPV2_Best_Seleid.In_Base).MatchSample,BIPV2_Best_Seleid.Keys(BIPV2_Best_Seleid.In_Base).Candidates,BIPV2_Best_Seleid.In_Base,Seleid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
