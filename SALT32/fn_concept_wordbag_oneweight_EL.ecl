...
shared getInitMatchWeight(StrType L1, unsigned2 lspec1, unsigned2 ispec1, StrType R1) := function
	iWeight := map( 				(length(L1) > length(R1)) and lspec1 > 0 => ((lspec1 - ispec1)/(length(L1) - 1)) * length(R1) + (ispec1* length(L1) - lspec1)/(length(L1) - 1),//lspec1 * length(r1)/length(l1), 
...
export  Match1L( StrType L1, unsigned2 lspec1, boolean lnne1, integer lfor1, Boolean linit1, unsigned2 ispec1, StrType R1) := FUNCTION
...
export Match2L(
							StrType L1,unsigned2 lspec1,boolean lnne1,integer lfor1,Boolean linit1, unsigned2 ispec1,
    ...
    L1BlankCost := IF ( lfor1 > 0, FailedForce, Failed );
	 ...
	 L1R1 := Match1L(L1,lspec1,lnne1,lfor1,linit1,ispec1,R1);
	 L1R2 := Match1L(L1,lspec1,lnne1,lfor1,linit1,ispec1,R2);
	 L2R1 := Match1L(L2,lspec2,lnne2,lfor2,linit2,ispec2,R1);
	 L2R2 := Match1L(L2,lspec2,lnne2,lfor2,linit2,ispec2,R2);
...
export Match2(
							...
							SALT32.Min0(
								MAX( 
										 Match2L(L1,lspec1,lnne1,lfor1,linit1,ispec1,L2,lspec2,lnne2,lfor2,linit2,ispec2,R1,R2)
...
shared Match3L(
   ...
   L1BlankCost := IF ( lfor1 > 0, FailedForce, Failed );
	L23R12 := Match2L(L2,lspec2,lnne2,lfor2,linit2,ispec2,L3,lspec3,lnne3,lfor3,linit3,ispec3,R1,R2);
	L23R23 := Match2L(L2,lspec2,lnne2,lfor2,linit2,ispec2,L3,lspec3,lnne3,lfor3,linit3,ispec3,R2,R3);
	L23R13 := Match2L(L2,lspec2,lnne2,lfor2,linit2,ispec2,L3,lspec3,lnne3,lfor3,linit3,ispec3,R1,R3);
	 
	iL1R1 := getInitMatchWeight(L1, lspec1, ispec1, R1);	 
	iL1R2 := getInitMatchWeight(L1, lspec1, ispec1, R2);	 
	iL1R3 := getInitMatchWeight(L1, lspec1, ispec1, R3);	 
...
export Match3(
							...
							SALT32.Min0(
								MAX(
									 Match3L(trim(L1),lspec1,lnne1,lfor1,linit1,ispec1,trim(L2),lspec2,lnne2,lfor2,linit2,ispec2,trim(L3),lspec3,lnne3,lfor3,linit3,ispec3,trim(R1),trim(R2),trim(R3))
