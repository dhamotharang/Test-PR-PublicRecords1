EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT32.Str30Type fieldname := #TEXT(infield);
	  SALT32.StrType fieldvalue {maxlength(200000)} := (SALT32.StrType)infile.infield ;
		SALT32.StrType src {maxlength(30)} := infile.srcfield ;
