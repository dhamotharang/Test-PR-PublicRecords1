...
EXPORT FieldNum(SALT36.StrType fn) := CASE(fn,'dt_first_seen' => 0,'dt_last_seen' => 1,'beg_octet1' => 2,'end_octet1' => 3,'beg_octet2' => 4,'end_octet2' => 5,'beg_octets34' => 6,'end_octets34' => 7,'ip_rng_beg' => 8,'ip_rng_end' => 9,'edge_country' => 10,'edge_region' => 11,'edge_city' => 12,'edge_conn_speed' => 13,'edge_metro_code' => 14,'edge_latitude' => 15,'edge_longitude' => 16,'edge_postal_code' => 17,'edge_country_code' => 18,'edge_region_code' => 19,'edge_city_code' => 20,'edge_continent_code' => 21,'edge_two_letter_country' => 22,'edge_internal_code' => 23,'edge_area_codes' => 24,'edge_country_conf' => 25,'edge_region_conf' => 26,'edge_city_conf' => 27,'edge_postal_conf' => 28,'edge_gmt_offset' => 29,'edge_in_dst' => 30,'sic_code' => 31,'domain_name' => 32,'isp_name' => 33,'homebiz_type' => 34,'asn' => 35,'asn_name' => 36,'primary_lang' => 37,'secondary_lang' => 38,'proxy_type' => 39,'proxy_description' => 40,'is_an_isp' => 41,'company_name' => 42,'ranks' => 43,'households' => 44,'women' => 45,'w18_34' => 46,'w35_49' => 47,'men' => 48,'m18_34' => 49,'m35_49' => 50,'teens' => 51,'kids' => 52,'naics_code' => 53,'cbsa_code' => 54,'cbsa_title' => 55,'cbsa_type' => 56,'csa_code' => 57,'csa_title' => 58,'md_code' => 59,'md_title' => 60,'organization_name' => 61,'generated_rec' => 62,'is_current' => 63,0);

//Individual field level validation


EXPORT Make_dt_first_seen(SALT36.StrType s0) := s0;
EXPORT InValid_dt_first_seen(SALT36.StrType s) := 0;
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := '';


EXPORT Make_dt_last_seen(SALT36.StrType s0) := s0;
EXPORT InValid_dt_last_seen(SALT36.StrType s) := 0;
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := '';


EXPORT Make_beg_octet1(SALT36.StrType s0) := s0;
EXPORT InValid_beg_octet1(SALT36.StrType s) := 0;
EXPORT InValidMessage_beg_octet1(UNSIGNED1 wh) := '';


EXPORT Make_end_octet1(SALT36.StrType s0) := s0;
EXPORT InValid_end_octet1(SALT36.StrType s) := 0;
EXPORT InValidMessage_end_octet1(UNSIGNED1 wh) := '';


EXPORT Make_beg_octet2(SALT36.StrType s0) := s0;
EXPORT InValid_beg_octet2(SALT36.StrType s) := 0;
EXPORT InValidMessage_beg_octet2(UNSIGNED1 wh) := '';


EXPORT Make_end_octet2(SALT36.StrType s0) := s0;
EXPORT InValid_end_octet2(SALT36.StrType s) := 0;
EXPORT InValidMessage_end_octet2(UNSIGNED1 wh) := '';


EXPORT Make_beg_octets34(SALT36.StrType s0) := s0;
EXPORT InValid_beg_octets34(SALT36.StrType s) := 0;
EXPORT InValidMessage_beg_octets34(UNSIGNED1 wh) := '';


EXPORT Make_end_octets34(SALT36.StrType s0) := s0;
EXPORT InValid_end_octets34(SALT36.StrType s) := 0;
EXPORT InValidMessage_end_octets34(UNSIGNED1 wh) := '';


EXPORT Make_ip_rng_beg(SALT36.StrType s0) := s0;
EXPORT InValid_ip_rng_beg(SALT36.StrType s) := 0;
EXPORT InValidMessage_ip_rng_beg(UNSIGNED1 wh) := '';


EXPORT Make_ip_rng_end(SALT36.StrType s0) := s0;
EXPORT InValid_ip_rng_end(SALT36.StrType s) := 0;
EXPORT InValidMessage_ip_rng_end(UNSIGNED1 wh) := '';


EXPORT Make_edge_country(SALT36.StrType s0) := s0;
EXPORT InValid_edge_country(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_country(UNSIGNED1 wh) := '';


EXPORT Make_edge_region(SALT36.StrType s0) := s0;
EXPORT InValid_edge_region(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_region(UNSIGNED1 wh) := '';


EXPORT Make_edge_city(SALT36.StrType s0) := s0;
EXPORT InValid_edge_city(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_city(UNSIGNED1 wh) := '';


EXPORT Make_edge_conn_speed(SALT36.StrType s0) := s0;
EXPORT InValid_edge_conn_speed(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_conn_speed(UNSIGNED1 wh) := '';


EXPORT Make_edge_metro_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_metro_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_metro_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_latitude(SALT36.StrType s0) := s0;
EXPORT InValid_edge_latitude(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_latitude(UNSIGNED1 wh) := '';


EXPORT Make_edge_longitude(SALT36.StrType s0) := s0;
EXPORT InValid_edge_longitude(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_longitude(UNSIGNED1 wh) := '';


EXPORT Make_edge_postal_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_postal_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_postal_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_country_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_country_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_country_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_region_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_region_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_region_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_city_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_city_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_city_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_continent_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_continent_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_continent_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_two_letter_country(SALT36.StrType s0) := s0;
EXPORT InValid_edge_two_letter_country(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_two_letter_country(UNSIGNED1 wh) := '';


EXPORT Make_edge_internal_code(SALT36.StrType s0) := s0;
EXPORT InValid_edge_internal_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_internal_code(UNSIGNED1 wh) := '';


EXPORT Make_edge_area_codes(SALT36.StrType s0) := s0;
EXPORT InValid_edge_area_codes(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_area_codes(UNSIGNED1 wh) := '';


EXPORT Make_edge_country_conf(SALT36.StrType s0) := s0;
EXPORT InValid_edge_country_conf(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_country_conf(UNSIGNED1 wh) := '';


EXPORT Make_edge_region_conf(SALT36.StrType s0) := s0;
EXPORT InValid_edge_region_conf(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_region_conf(UNSIGNED1 wh) := '';


EXPORT Make_edge_city_conf(SALT36.StrType s0) := s0;
EXPORT InValid_edge_city_conf(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_city_conf(UNSIGNED1 wh) := '';


EXPORT Make_edge_postal_conf(SALT36.StrType s0) := s0;
EXPORT InValid_edge_postal_conf(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_postal_conf(UNSIGNED1 wh) := '';


EXPORT Make_edge_gmt_offset(SALT36.StrType s0) := s0;
EXPORT InValid_edge_gmt_offset(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_gmt_offset(UNSIGNED1 wh) := '';


EXPORT Make_edge_in_dst(SALT36.StrType s0) := s0;
EXPORT InValid_edge_in_dst(SALT36.StrType s) := 0;
EXPORT InValidMessage_edge_in_dst(UNSIGNED1 wh) := '';


EXPORT Make_sic_code(SALT36.StrType s0) := s0;
EXPORT InValid_sic_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_sic_code(UNSIGNED1 wh) := '';


EXPORT Make_domain_name(SALT36.StrType s0) := s0;
EXPORT InValid_domain_name(SALT36.StrType s) := 0;
EXPORT InValidMessage_domain_name(UNSIGNED1 wh) := '';


EXPORT Make_isp_name(SALT36.StrType s0) := s0;
EXPORT InValid_isp_name(SALT36.StrType s) := 0;
EXPORT InValidMessage_isp_name(UNSIGNED1 wh) := '';


EXPORT Make_homebiz_type(SALT36.StrType s0) := s0;
EXPORT InValid_homebiz_type(SALT36.StrType s) := 0;
EXPORT InValidMessage_homebiz_type(UNSIGNED1 wh) := '';


EXPORT Make_asn(SALT36.StrType s0) := s0;
EXPORT InValid_asn(SALT36.StrType s) := 0;
EXPORT InValidMessage_asn(UNSIGNED1 wh) := '';


EXPORT Make_asn_name(SALT36.StrType s0) := s0;
EXPORT InValid_asn_name(SALT36.StrType s) := 0;
EXPORT InValidMessage_asn_name(UNSIGNED1 wh) := '';


EXPORT Make_primary_lang(SALT36.StrType s0) := s0;
EXPORT InValid_primary_lang(SALT36.StrType s) := 0;
EXPORT InValidMessage_primary_lang(UNSIGNED1 wh) := '';


EXPORT Make_secondary_lang(SALT36.StrType s0) := s0;
EXPORT InValid_secondary_lang(SALT36.StrType s) := 0;
EXPORT InValidMessage_secondary_lang(UNSIGNED1 wh) := '';


EXPORT Make_proxy_type(SALT36.StrType s0) := s0;
EXPORT InValid_proxy_type(SALT36.StrType s) := 0;
EXPORT InValidMessage_proxy_type(UNSIGNED1 wh) := '';


EXPORT Make_proxy_description(SALT36.StrType s0) := s0;
EXPORT InValid_proxy_description(SALT36.StrType s) := 0;
EXPORT InValidMessage_proxy_description(UNSIGNED1 wh) := '';


EXPORT Make_is_an_isp(SALT36.StrType s0) := s0;
EXPORT InValid_is_an_isp(SALT36.StrType s) := 0;
EXPORT InValidMessage_is_an_isp(UNSIGNED1 wh) := '';


EXPORT Make_company_name(SALT36.StrType s0) := s0;
EXPORT InValid_company_name(SALT36.StrType s) := 0;
EXPORT InValidMessage_company_name(UNSIGNED1 wh) := '';


EXPORT Make_ranks(SALT36.StrType s0) := s0;
EXPORT InValid_ranks(SALT36.StrType s) := 0;
EXPORT InValidMessage_ranks(UNSIGNED1 wh) := '';


EXPORT Make_households(SALT36.StrType s0) := s0;
EXPORT InValid_households(SALT36.StrType s) := 0;
EXPORT InValidMessage_households(UNSIGNED1 wh) := '';


EXPORT Make_women(SALT36.StrType s0) := s0;
EXPORT InValid_women(SALT36.StrType s) := 0;
EXPORT InValidMessage_women(UNSIGNED1 wh) := '';


EXPORT Make_w18_34(SALT36.StrType s0) := s0;
EXPORT InValid_w18_34(SALT36.StrType s) := 0;
EXPORT InValidMessage_w18_34(UNSIGNED1 wh) := '';


EXPORT Make_w35_49(SALT36.StrType s0) := s0;
EXPORT InValid_w35_49(SALT36.StrType s) := 0;
EXPORT InValidMessage_w35_49(UNSIGNED1 wh) := '';


EXPORT Make_men(SALT36.StrType s0) := s0;
EXPORT InValid_men(SALT36.StrType s) := 0;
EXPORT InValidMessage_men(UNSIGNED1 wh) := '';


EXPORT Make_m18_34(SALT36.StrType s0) := s0;
EXPORT InValid_m18_34(SALT36.StrType s) := 0;
EXPORT InValidMessage_m18_34(UNSIGNED1 wh) := '';


EXPORT Make_m35_49(SALT36.StrType s0) := s0;
EXPORT InValid_m35_49(SALT36.StrType s) := 0;
EXPORT InValidMessage_m35_49(UNSIGNED1 wh) := '';


EXPORT Make_teens(SALT36.StrType s0) := s0;
EXPORT InValid_teens(SALT36.StrType s) := 0;
EXPORT InValidMessage_teens(UNSIGNED1 wh) := '';


EXPORT Make_kids(SALT36.StrType s0) := s0;
EXPORT InValid_kids(SALT36.StrType s) := 0;
EXPORT InValidMessage_kids(UNSIGNED1 wh) := '';


EXPORT Make_naics_code(SALT36.StrType s0) := s0;
EXPORT InValid_naics_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_naics_code(UNSIGNED1 wh) := '';


EXPORT Make_cbsa_code(SALT36.StrType s0) := s0;
EXPORT InValid_cbsa_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_cbsa_code(UNSIGNED1 wh) := '';


EXPORT Make_cbsa_title(SALT36.StrType s0) := s0;
EXPORT InValid_cbsa_title(SALT36.StrType s) := 0;
EXPORT InValidMessage_cbsa_title(UNSIGNED1 wh) := '';


EXPORT Make_cbsa_type(SALT36.StrType s0) := s0;
EXPORT InValid_cbsa_type(SALT36.StrType s) := 0;
EXPORT InValidMessage_cbsa_type(UNSIGNED1 wh) := '';


EXPORT Make_csa_code(SALT36.StrType s0) := s0;
EXPORT InValid_csa_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_csa_code(UNSIGNED1 wh) := '';


EXPORT Make_csa_title(SALT36.StrType s0) := s0;
EXPORT InValid_csa_title(SALT36.StrType s) := 0;
EXPORT InValidMessage_csa_title(UNSIGNED1 wh) := '';


EXPORT Make_md_code(SALT36.StrType s0) := s0;
EXPORT InValid_md_code(SALT36.StrType s) := 0;
EXPORT InValidMessage_md_code(UNSIGNED1 wh) := '';


EXPORT Make_md_title(SALT36.StrType s0) := s0;
EXPORT InValid_md_title(SALT36.StrType s) := 0;
EXPORT InValidMessage_md_title(UNSIGNED1 wh) := '';


EXPORT Make_organization_name(SALT36.StrType s0) := s0;
EXPORT InValid_organization_name(SALT36.StrType s) := 0;
EXPORT InValidMessage_organization_name(UNSIGNED1 wh) := '';


EXPORT Make_generated_rec(SALT36.StrType s0) := s0;
EXPORT InValid_generated_rec(SALT36.StrType s) := 0;
EXPORT InValidMessage_generated_rec(UNSIGNED1 wh) := '';


EXPORT Make_is_current(SALT36.StrType s0) := s0;
EXPORT InValid_is_current(SALT36.StrType s) := 0;
