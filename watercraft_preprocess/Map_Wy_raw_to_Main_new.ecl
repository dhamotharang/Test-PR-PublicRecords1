...
watercraft.Layout_Watercraft_Main_Base main_mapping_format(wDatasetwithflag L) := TRANSFORM
	...
	self.watercraft_color_1_code			:=	TRIM(L.COLORID,LEFT,RIGHT);
	self.watercraft_color_1_description		:=	MAP(L.COLORID = '1' => 'SOLID',	
                                                L.COLORID = '2' => 'TWO-TONE',	
                                                L.COLORID = '3' => 'OTHER','');
...
EXPORT Map_Wy_raw_to_Main_new := project(wDatasetwithflag, main_mapping_format(left));