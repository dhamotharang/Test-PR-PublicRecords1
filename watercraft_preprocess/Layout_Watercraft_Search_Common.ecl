EXPORT Layout_Watercraft_Search_Common := 
  RECORD
	...
	string1		name_format;		//F=FML, L=LFM, U=combination, P=parsed
	string100	prep_address_situs;
	string50	prep_address_last_situs;
END;