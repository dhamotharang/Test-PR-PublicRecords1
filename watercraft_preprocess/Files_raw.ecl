...
export ND := dataset('~thor_data400::in::watercraft_raw_nd', Watercraft.layout_ND_20Q3, flat); //DOPS-864 new layout
...
export MA := dataset('~thor_data400::in::watercraft_raw_ma', Watercraft.layout_MA_new, flat);
export ME := dataset('~thor_data400::in::watercraft_raw_me', Watercraft.layout_ME_18q3_new, flat);
export MI := dataset('~thor_data400::in::watercraft_raw_mi', Watercraft.layout_MI_new, flat);
...
export NE := dataset('~thor_data400::in::watercraft_raw_ne', Watercraft.layout_NE_20q1_new, flat); //DF-27939
...
export OH := dataset('~thor_data400::in::watercraft_raw_oh', Watercraft.layout_OH_20Q3, flat); //DOPS-864 new layout
