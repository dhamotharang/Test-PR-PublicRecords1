// create folder "Scrubs_Equifax_Monthly"
...
IMPORT SALT32;
#WORKUNIT('name','PersonHeader Scrubs Equifax');
#OPTION('multiplePersistInstances',FALSE);
// ********************************************************************************************
// Configuration																		<-- STEP 0 (setup only)
IMPORT Scrubs_Equifax_Monthly as S;
F := Scrubs_Equifax_Monthly.In_File: independent;		// input file
o := 'Scrubs_Equifax_Monthly';		// orbit profile
