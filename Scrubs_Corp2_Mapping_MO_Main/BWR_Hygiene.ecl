...
#workunit('name','Scrubs_Corp2_Mapping_MO_Main.BWR_Hygiene - Hygiene & Stats - SALT V3.6.0');
IMPORT Scrubs_Corp2_Mapping_MO_Main,SALT36;
// First create an instantiated hygiene module
  infile := Scrubs_Corp2_Mapping_MO_Main.In_In_File;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Corp2_Mapping_MO_Main.Hygiene(ip);
