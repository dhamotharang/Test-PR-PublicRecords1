...
doxie.MAC_Get_GLB_DPPA_PhonesPlus(dids, cellphone_recs, is_roxie, true, 
                                  glb_value, dppa_value,'',
																	min_confidencescore,,,,doxie.DataRestriction.fixed_DRM,is_CompReport,checkRNA);
