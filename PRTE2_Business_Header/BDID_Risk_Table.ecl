...
bdid_stats := Prte2_Business_Header.BDID_Table;
...
bh_best := Prte2_Business_Header.Files().Base.Business_Header_Best.built;
...
export BDID_Risk_Table := bdid_risk_table_score : persist('~prte::persist::business_risk::bdid_risk_table');