...
export BH_Stat(
	...
	,dataset(Business_Header.Layout_Business_Relative				)	pBH_Relatives				= Files().Base.Business_Relatives.built
	,dataset(Business_Header.Layout_Business_Relative_Group	)	pBH_Relative_Group	= Files().Base.Business_Relatives_Group.built
...
function
	...
	Business_Header.Layout_Business_Header_Stat CombineBaseRelativeStats(layout_bh_base_stat l, layout_br_stat r) := transform
	self.bdid := l.bdid;
	...
	// Add group counts
	Business_Header.Layout_Business_Header_Stat AddGroupCounts(Business_Header.Layout_Business_Header_Stat l, layout_brg_stat_bdid r, integer c) := transform
