...
module
	export Root 	:= _dataset(pUseOtherEnvironment).thor_cluster_persists + 'persist::PRTE2_Business_Header::'		;
	...
	export CompanyNameAddressJoinBackZip	:= Root + 'CompanyName_Address::JoinBackZip'	;
	export CompanyNameAddress							:= Root + 'CompanyName_Address'								;
	export CompanyNameAddressBroadJoinBackZip	:= Root + 'CompanyName_AddressBroad::JoinBackZip'	;
	export CompanyNameAddressBroad				:= Root + 'CompanyName_AddressBroad'					;
	export CompanyNameFein								:= Root + 'CompanyName_Fein'									;
	export CompanyNamePhone								:= Root + 'CompanyName_Phone'									;
