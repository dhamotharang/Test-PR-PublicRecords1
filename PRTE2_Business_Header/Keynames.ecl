...
module
	...
	//////////////////////////////////////////////////////////////////
	export lOldRoot			:= _Dataset(pUseOtherEnvironment).thor_cluster_Files + pkeystring + '::'									;

	shared lversiondate	:= pversion														;
	shared lNewRoot			:= _Dataset(pUseOtherEnvironment).thor_cluster_Files + pkeystring + '::business_header::';
	...
	module
		...
		shared lOldRoot 	:= _Dataset(pUseOtherEnvironment).thor_cluster_Files + 'key::gong_eda_bizword_frequency'									;
		shared lNewRoot 	:= _Dataset(pUseOtherEnvironment).thor_cluster_Files + 'key::business_header::@version@::eda::word.freq'	;
