...
EXPORT DueDiligence_Batch_Service() := FUNCTION
  ...
  perProductResults := DueDiligence.CommonQuery.v3PersonResults(perRecs, regulatoryCompliance, DueDiligence.Constants.EMPTY, FALSE, debugIndicator, validateModel);
