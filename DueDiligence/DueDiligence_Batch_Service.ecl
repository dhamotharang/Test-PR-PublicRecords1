...
EXPORT DueDiligence_Batch_Service() := FUNCTION
  ...
  indIndex := JOIN(indRecs, consumerResults, 
                              ...
                              SELF.PerLegalStateCriminal := RIGHT.PerLegalStateCriminal;
                              SELF.PerLegalStateCriminal_Flag := RIGHT.PerLegalStateCriminal_Flag;
                              SELF.PerLegalFedCriminal := RIGHT.PerLegalFedCriminal;
                              SELF.PerLegalFedCriminal_Flag := RIGHT.PerLegalFedCriminal_Flag;
                              SELF.PerLegalCivil := RIGHT.PerLegalCivil;
                              SELF.PerLegalCivil_Flag := RIGHT.PerLegalCivil_Flag;
                              SELF.PerLegalTraffInfr := RIGHT.PerLegalTraffInfr;
                              SELF.PerLegalTraffInfr_Flag := RIGHT.PerLegalTraffInfr_Flag;
                              SELF.PerLegalTypes := RIGHT.PerLegalTypes;
                              SELF.PerLegalTypes_Flag := RIGHT.PerLegalTypes_Flag;
...
//********************************************************BUSINESS ATTRIBUTES STARTS HERE********************************************************
  ...
  busIndex := JOIN(busRecs, businessResults,
                              ...
                              SELF.BusLegalStateCriminal := RIGHT.BusLegalStateCriminal;
                              SELF.BusLegalStateCriminal_Flag := RIGHT.BusLegalStateCriminal_Flag;
                              SELF.BusLegalFedCriminal := RIGHT.BusLegalFedCriminal;
                              SELF.BusLegalFedCriminal_Flag := RIGHT.BusLegalFedCriminal_Flag;
                              SELF.BusLegalCivil := RIGHT.BusLegalCivil;
                              SELF.BusLegalCivil_Flag := RIGHT.BusLegalCivil_Flag;
                              SELF.BusLegalTraffInfr := RIGHT.BusLegalTraffInfr;
                              SELF.BusLegalTraffInfr_Flag := RIGHT.BusLegalTraffInfr_Flag;
                              SELF.BusLegalTypes := RIGHT.BusLegalTypes;
                              SELF.BusLegalTypes_Flag := RIGHT.BusLegalTypes_Flag;
