...
EXPORT getBusExec(DATASET(DueDiligence.Layouts.Busn_Internal) indata,
	...
	execsRaw := BIPV2_Build.key_contact_linkids.kFetch(DueDiligence.Common.GetLinkIDsForKFetch(indata),
	...
	execsRawSeq := DueDiligence.Common.AppendSeq(execsRaw, indata, FALSE);
	...
	groupExecs := GROUP(rollUniqueExecsWithDID, seq, #expand(BIPV2.IDmacros.mac_ListTop3Linkids()));
