IMPORT Business_Risk_BIP, Doxie, DueDiligence, Header, Relationship, RelationshipIdentifier_Services, STD;
...
EXPORT getIndRelationships(DATASET(DueDiligence.Layouts.Indv_Internal) inData,
    ...
    getRelations(DATASET(Relationship.Layout_GetRelationship.DIDs_layout) listOfDIDs) := FUNCTION
        ...
        RETURN relativeIDs(r2rdid = 0);// AND TRIM(STD.Str.ToUpperCase(cluster)) <> 'DEAD'
    END;
