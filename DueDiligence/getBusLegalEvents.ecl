IMPORT BIPV2, DueDiligence, doxie;
...
EXPORT getBusLegalEvents(DATASET(DueDiligence.layouts.Busn_Internal) busnData,
    ...
    //The results will come back this layout: DueDiligence.LayoutsInternal.RelatedParty
    ...
    //The results will come back this layout: DueDiligence.layouts.Busn_Internal
    ...
    RETURN updateBusnWithEvidenceOfCrim;
END; 