IMPORT BIPv2, DueDiligence, VehicleV2, Doxie, Suppress;

/*
  Following Keys being used:
        VehicleV2.Key_Vehicle_Main_Key
*/
EXPORT getSharedVehicle(DATASET(DueDiligence.LayoutsInternal.VehicleSlimLayout) inVehicleData,
  ...
  permissibleVehicles := vehicleDetails(doxie.compliance.dppa_state_ok (stateOrigin, mod_access.dppa, '', sourceCode));
