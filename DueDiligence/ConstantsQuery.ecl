...
EXPORT ConstantsQuery := MODULE
    ...
    EXPORT VALID_PRODUCT_DUE_DILIGENCE_MODULES := 'modules';
    EXPORT VALID_PRODUCT_DUE_DILIGENCE_REPORT_DEFAULT := 'standard';
    
    EXPORT VALID_REQUESTED_PRODUCTS := [VALID_PRODUCT_DUE_DILIGENCE_ONLY, VALID_PRODUCT_CITIZENSHIP_ONLY, VALID_PRODUCT_DUE_DILIGENCE_AND_CITIZENSHIP, VALID_PRODUCT_DUE_DILIGENCE_MODULES, VALID_PRODUCT_DUE_DILIGENCE_REPORT_DEFAULT];
    ...
    EXPORT VALIDATION_INVALID_PRODUCT_REQUEST_TYPE := 'ProductRequestType is required or invalid. Valid ProductRequestType =';
