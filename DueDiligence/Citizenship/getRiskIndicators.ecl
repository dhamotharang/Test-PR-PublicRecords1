...
//========================================================================================
  ...
  indicators := JOIN(cleanedInput, clam, 
                      ...
                      TRANSFORM({DueDiligence.Citizenship.Layouts.IndicatorLayout, unsigned8 shell_dob_SAS;}, 
                                ...
                                earliest_header_yrs := IF(earliest_header_date = NULL or sysdate = NULL, NULL, TRUNCATE((sysdate - earliest_header_date) / DAYSINYEAR));
                                ...
                                calc_dob := IF(_in_dob = NULL or sysdate = NULL, NULL, TRUNCATE((sysdate - _in_dob) / DAYSINYEAR));
                                inferred_age := RIGHT.inferred_age;
                                iv_header_emergence_age_temp := MAP(NOT(RIGHT.truedid) => NULL,
                                ...
                                earliest_bureau_yrs := IF(earliest_bureau_date = NULL or sysdate = NULL, NULL, TRUNCATE((sysdate - earliest_bureau_date) / DAYSINYEAR));                                                        
                                iv_bureau_emergence_age_temp := MAP(NOT(RIGHT.truedid) or earliest_bureau_yrs = NULL => NULL,
                                ...
                                ssn_years := IF(_rc_ssnlowissue = NULL or sysdate = NULL, NULL, TRUNCATE((sysdate - _rc_ssnlowissue) / DAYSINYEAR));
                                ...
                                rv_c14_addrs_10yr := map(not(RIGHT.truedid)             => NULL,
                                ...
                                YRSinceLastReportedCredential := map(not(RIGHT.truedid) => NULL,
                                ...
                                iv_best_ssn_invalid := map(best_ssn_valid = '6' or best_ssn_valid = '7' or not(RIGHT.truedid) => NULL,
