IMPORT Address, BusinessCredit_Services, Business_Risk_BIP, Gateway, iesp, Models, Risk_Indicators, Riskwise, ut, STD;
...
EXPORT fn_SmallBusiness_getScores( DATASET(Business_Risk_BIP.Layouts.Input) Shell_Input,
	...
	FUNCTION
		...
		DPPA_Purpose        := options.dppa;
		GLBA_Purpose        := options.glb;
