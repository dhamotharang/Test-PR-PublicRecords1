  ...
  SHARED iesp.share.t_NameValuePair createRecord(STRING Name, STRING Value) := 
	...
	END;
 	...
 	EXPORT iesp.share.t_NameValuePair intoVersion2(LNSmallBusiness.BIP_Layouts.IntermediateLayout le, UNSIGNED AttributeNumber) := TRANSFORM
		SELF := CASE(AttributeNumber, 
				1 => ROW(createRecord('LNLexIDPOW', le.Version2.LNLexIDPOW)),
				2 => ROW(createRecord('LNLexIDProx', le.Version2.LNLexIDProx)),
				3 => ROW(createRecord('LNLexIDSELE', le.Version2.LNLexIDSELE)),
				4 => ROW(createRecord('LNLexIDORG', le.Version2.LNLexIDORG)),
				5 => ROW(createRecord('LNLexIDULT', le.Version2.LNLexIDULT)),
				6 => ROW(createRecord('InputCheckBusName', le.Version2.InputCheckBusName)),
				7 => ROW(createRecord('InputCheckBusAltName', le.Version2.InputCheckBusAltName)),
				8 => ROW(createRecord('InputCheckBusAddr', le.Version2.InputCheckBusAddr)),
				9 => ROW(createRecord('InputCheckBusCity', le.Version2.InputCheckBusCity)),
				10 => ROW(createRecord('InputCheckBusState', le.Version2.InputCheckBusState)),
				11 => ROW(createRecord('InputCheckBusZip', le.Version2.InputCheckBusZip)),
				12 => ROW(createRecord('InputCheckBusFEIN', le.Version2.InputCheckBusFEIN)),
				13 => ROW(createRecord('InputCheckBusPhone', le.Version2.InputCheckBusPhone)),
				14 => ROW(createRecord('InputCheckBusFax', le.Version2.InputCheckBusFax)),
				15 => ROW(createRecord('InputCheckBusNAICS', le.Version2.InputCheckBusNAICS)),
				16 => ROW(createRecord('InputCheckBusSIC', le.Version2.InputCheckBusSIC)),
				17 => ROW(createRecord('InputCheckBusStartDate', le.Version2.InputCheckBusStartDate)),
				18 => ROW(createRecord('InputCheckBusStructure', le.Version2.InputCheckBusStructure)),
				19 => ROW(createRecord('InputCheckAnnualRevenue', le.Version2.InputCheckAnnualRevenue)),
				20 => ROW(createRecord('InputCheckAuthRepFirstName', le.Version2.InputCheckAuthRepFirstName)),
				21 => ROW(createRecord('InputCheckAuthRepMiddleName', le.Version2.InputCheckAuthRepMiddleName)),
				22 => ROW(createRecord('InputCheckAuthRepLastName', le.Version2.InputCheckAuthRepLastName)),
				23 => ROW(createRecord('InputCheckAuthRepAddr', le.Version2.InputCheckAuthRepAddr)),
				24 => ROW(createRecord('InputCheckAuthRepCity', le.Version2.InputCheckAuthRepCity)),
				25 => ROW(createRecord('InputCheckAuthRepState', le.Version2.InputCheckAuthRepState)),
				26 => ROW(createRecord('InputCheckAuthRepZip', le.Version2.InputCheckAuthRepZip)),
				27 => ROW(createRecord('InputCheckAuthRepSSN', le.Version2.InputCheckAuthRepSSN)),
				28 => ROW(createRecord('InputCheckAuthRepPhone', le.Version2.InputCheckAuthRepPhone)),
				29 => ROW(createRecord('InputCheckAuthRepAge', le.Version2.InputCheckAuthRepAge)),
				30 => ROW(createRecord('InputCheckAuthRepDOB', le.Version2.InputCheckAuthRepDOB)),
				31 => ROW(createRecord('InputCheckAuthRepDL', le.Version2.InputCheckAuthRepDL)),
				32 => ROW(createRecord('InputCheckAuthRepDLState', le.Version2.InputCheckAuthRepDLState)),
				33 => ROW(createRecord('InputCheckAuthRepTitle', le.Version2.InputCheckAuthRepTitle)),
				34 => ROW(createRecord('InputCheckAuthRep2FirstName', le.Version2.InputCheckAuthRep2FirstName)),
				35 => ROW(createRecord('InputCheckAuthRep2MiddleName', le.Version2.InputCheckAuthRep2MiddleName)),
				36 => ROW(createRecord('InputCheckAuthRep2LastName', le.Version2.InputCheckAuthRep2LastName)),
				37 => ROW(createRecord('InputCheckAuthRep2Addr', le.Version2.InputCheckAuthRep2Addr)),
				38 => ROW(createRecord('InputCheckAuthRep2City', le.Version2.InputCheckAuthRep2City)),
				39 => ROW(createRecord('InputCheckAuthRep2State', le.Version2.InputCheckAuthRep2State)),
				40 => ROW(createRecord('InputCheckAuthRep2Zip', le.Version2.InputCheckAuthRep2Zip)),
				41 => ROW(createRecord('InputCheckAuthRep2SSN', le.Version2.InputCheckAuthRep2SSN)),
				42 => ROW(createRecord('InputCheckAuthRep2Phone', le.Version2.InputCheckAuthRep2Phone)),
				43 => ROW(createRecord('InputCheckAuthRep2Age', le.Version2.InputCheckAuthRep2Age)),
				44 => ROW(createRecord('InputCheckAuthRep2DOB', le.Version2.InputCheckAuthRep2DOB)),
				45 => ROW(createRecord('InputCheckAuthRep2DL', le.Version2.InputCheckAuthRep2DL)),
				46 => ROW(createRecord('InputCheckAuthRep2DLState', le.Version2.InputCheckAuthRep2DLState)),
				47 => ROW(createRecord('InputCheckAuthRep2Title', le.Version2.InputCheckAuthRep2Title)),
				48 => ROW(createRecord('InputCheckAuthRep3FirstName', le.Version2.InputCheckAuthRep3FirstName)),
				49 => ROW(createRecord('InputCheckAuthRep3MiddleName', le.Version2.InputCheckAuthRep3MiddleName)),
				50 => ROW(createRecord('InputCheckAuthRep3LastName', le.Version2.InputCheckAuthRep3LastName)),
				51 => ROW(createRecord('InputCheckAuthRep3Addr', le.Version2.InputCheckAuthRep3Addr)),
				52 => ROW(createRecord('InputCheckAuthRep3City', le.Version2.InputCheckAuthRep3City)),
				53 => ROW(createRecord('InputCheckAuthRep3State', le.Version2.InputCheckAuthRep3State)),
				54 => ROW(createRecord('InputCheckAuthRep3Zip', le.Version2.InputCheckAuthRep3Zip)),
				55 => ROW(createRecord('InputCheckAuthRep3SSN', le.Version2.InputCheckAuthRep3SSN)),
				56 => ROW(createRecord('InputCheckAuthRep3Phone', le.Version2.InputCheckAuthRep3Phone)),
				57 => ROW(createRecord('InputCheckAuthRep3Age', le.Version2.InputCheckAuthRep3Age)),
				58 => ROW(createRecord('InputCheckAuthRep3DOB', le.Version2.InputCheckAuthRep3DOB)),
				59 => ROW(createRecord('InputCheckAuthRep3DL', le.Version2.InputCheckAuthRep3DL)),
				60 => ROW(createRecord('InputCheckAuthRep3DLState', le.Version2.InputCheckAuthRep3DLState)),
				61 => ROW(createRecord('InputCheckAuthRep3Title', le.Version2.InputCheckAuthRep3Title)),
				62 => ROW(createRecord('OutBestBusName', le.Version2.OutBestBusName)),
				63 => ROW(createRecord('OutBestBusStreetAddr', le.Version2.OutBestBusStreetAddr)),
				64 => ROW(createRecord('OutBestBusCity', le.Version2.OutBestBusCity)),
				65 => ROW(createRecord('OutBestBusState', le.Version2.OutBestBusState)),
				66 => ROW(createRecord('OutBestBusZip', le.Version2.OutBestBusZip)),
				67 => ROW(createRecord('OutBestBusFEIN', le.Version2.OutBestBusFEIN)),
				68 => ROW(createRecord('OutBestBusPhone', le.Version2.OutBestBusPhone)),
				69 => ROW(createRecord('OutBestNAICS', le.Version2.OutBestNAICS)),
				70 => ROW(createRecord('OutBestSIC', le.Version2.OutBestSIC)),
				71 => ROW(createRecord('LNHitInd', le.Version2.LNHitInd)),
				72 => ROW(createRecord('LNInputInd', le.Version2.LNInputInd)),
				73 => ROW(createRecord('VerificationBusInputName', le.Version2.VerificationBusInputName)),
				74 => ROW(createRecord('VerificationBusInputAltName', le.Version2.VerificationBusInputAltName)),
				75 => ROW(createRecord('VerificationBusInputAddr', le.Version2.VerificationBusInputAddr)),
				76 => ROW(createRecord('VerificationBusInputPhone', le.Version2.VerificationBusInputPhone)),
				77 => ROW(createRecord('VerificationBusInputFEIN', le.Version2.VerificationBusInputFEIN)),
				78 => ROW(createRecord('VerificationBusInputIndustry', le.Version2.VerificationBusInputIndustry)),
				79 => ROW(createRecord('BusinessRecordTimeOldest', le.Version2.BusinessRecordTimeOldest)),
				80 => ROW(createRecord('BusinessRecordTimeNewest', le.Version2.BusinessRecordTimeNewest)),
				81 => ROW(createRecord('BusinessRecordUpdated12M', le.Version2.BusinessRecordUpdated12M)),
				82 => ROW(createRecord('BusinessActivity03M', le.Version2.BusinessActivity03M)),
				83 => ROW(createRecord('BusinessActivity06M', le.Version2.BusinessActivity06M)),
				84 => ROW(createRecord('BusinessActivity12M', le.Version2.BusinessActivity12M)),
				85 => ROW(createRecord('AddrOwnershipCurrent', le.Version2.AddrOwnershipCurrent)),
				86 => ROW(createRecord('AddrAssessedValueCurrent', le.Version2.AddrAssessedValueCurrent)),
				87 => ROW(createRecord('AddrLotSizeCurrent', le.Version2.AddrLotSizeCurrent)),
				88 => ROW(createRecord('AddrBuildingSizeCurrent', le.Version2.AddrBuildingSizeCurrent)),
				89 => ROW(createRecord('FirmNonProfit', le.Version2.FirmNonProfit)),
				90 => ROW(createRecord('FirmIRSRetirementPlan', le.Version2.FirmIRSRetirementPlan)),
				91 => ROW(createRecord('FirmAgeObserved', le.Version2.FirmAgeObserved)),
				92 => ROW(createRecord('FirmAgeEstablished', le.Version2.FirmAgeEstablished)),
				93 => ROW(createRecord('FirmEmployeeCount', le.Version2.FirmEmployeeCount)),
				94 => ROW(createRecord('FirmOwnershipType', le.Version2.FirmOwnershipType)),
				95 => ROW(createRecord('FirmReportedSales', le.Version2.FirmReportedSales)),
				96 => ROW(createRecord('FirmParentCompanyInd', le.Version2.FirmParentCompanyInd)),
				97 => ROW(createRecord('SOSIncorporationFilingsCount', le.Version2.SOSIncorporationFilingsCount)),
				98 => ROW(createRecord('SOSIncorporationTimeOldest', le.Version2.SOSIncorporationTimeOldest)),
				99 => ROW(createRecord('SOSStateCount', le.Version2.SOSStateCount)),
				100 => ROW(createRecord('SOSStateMatchInputState', le.Version2.SOSStateMatchInputState)),
				101 => ROW(createRecord('SOSDomesticCount', le.Version2.SOSDomesticCount)),
				102 => ROW(createRecord('SOSForeignCount', le.Version2.SOSForeignCount)),
				103 => ROW(createRecord('SOSForeignStateCount', le.Version2.SOSForeignStateCount)),
				104 => ROW(createRecord('SOSStandingWorst', le.Version2.SOSStandingWorst)),
				105 => ROW(createRecord('SOSStandingBest', le.Version2.SOSStandingBest)),
				106 => ROW(createRecord('SOSStandingDefunct', le.Version2.SOSStandingDefunct)),
				107 => ROW(createRecord('BankruptcyCount', le.Version2.BankruptcyCount)),
				108 => ROW(createRecord('BankruptcyCount12M', le.Version2.BankruptcyCount12M)),
				109 => ROW(createRecord('BankruptcyCount24M', le.Version2.BankruptcyCount24M)),
				110 => ROW(createRecord('BankruptcyCount84M', le.Version2.BankruptcyCount84M)),
				111 => ROW(createRecord('BankruptcyChapter', le.Version2.BankruptcyChapter)),
				112 => ROW(createRecord('BankruptcyTimeNewest', le.Version2.BankruptcyTimeNewest)),
				113 => ROW(createRecord('LienCount', le.Version2.LienCount)),
				114 => ROW(createRecord('LienStateCount', le.Version2.LienStateCount)),
				115 => ROW(createRecord('LienStateMatchInputState', le.Version2.LienStateMatchInputState)),
				116 => ROW(createRecord('LienTotalAmount', le.Version2.LienTotalAmount)),
				117 => ROW(createRecord('LienNewestType', le.Version2.LienNewestType)),
				118 => ROW(createRecord('LienTimeOldest', le.Version2.LienTimeOldest)),
				119 => ROW(createRecord('LienTimeNewest', le.Version2.LienTimeNewest)),
				120 => ROW(createRecord('LienCount03M', le.Version2.LienCount03M)),
				121 => ROW(createRecord('LienCount06M', le.Version2.LienCount06M)),
				122 => ROW(createRecord('LienCount12M', le.Version2.LienCount12M)),
				123 => ROW(createRecord('LienCount24M', le.Version2.LienCount24M)),
				124 => ROW(createRecord('LienCount36M', le.Version2.LienCount36M)),
				125 => ROW(createRecord('LienCount60M', le.Version2.LienCount60M)),
				126 => ROW(createRecord('LienFedTaxCount', le.Version2.LienFedTaxCount)),
				127 => ROW(createRecord('LienFedTaxTotalAmount', le.Version2.LienFedTaxTotalAmount)),
				128 => ROW(createRecord('LienForeclosureCount', le.Version2.LienForeclosureCount)),
				129 => ROW(createRecord('LienForeclosureTotalAmount', le.Version2.LienForeclosureTotalAmount)),
				130 => ROW(createRecord('LienTenantCount', le.Version2.LienTenantCount)),
				131 => ROW(createRecord('LienTenantTotalAmount', le.Version2.LienTenantTotalAmount)),
				132 => ROW(createRecord('LienMechanicalCount', le.Version2.LienMechanicalCount)),
				133 => ROW(createRecord('LienMechanicalTotalAmount', le.Version2.LienMechanicalTotalAmount)),
				134 => ROW(createRecord('LienOtherCount', le.Version2.LienOtherCount)),
				135 => ROW(createRecord('LienOtherTotalAmount', le.Version2.LienOtherTotalAmount)),
				136 => ROW(createRecord('JudgmentCount', le.Version2.JudgmentCount)),
				137 => ROW(createRecord('JudgmentStateCount', le.Version2.JudgmentStateCount)),
				138 => ROW(createRecord('JudgmentStateMatchInputState', le.Version2.JudgmentStateMatchInputState)),
				139 => ROW(createRecord('JudgmentTotalAmount', le.Version2.JudgmentTotalAmount)),
				140 => ROW(createRecord('JudgmentNewestType', le.Version2.JudgmentNewestType)),
				141 => ROW(createRecord('JudgmentTimeOldest', le.Version2.JudgmentTimeOldest)),
				142 => ROW(createRecord('JudgmentTimeNewest', le.Version2.JudgmentTimeNewest)),
				143 => ROW(createRecord('JudgmentCount03M', le.Version2.JudgmentCount03M)),
				144 => ROW(createRecord('JudgmentCount06M', le.Version2.JudgmentCount06M)),
				145 => ROW(createRecord('JudgmentCount12M', le.Version2.JudgmentCount12M)),
				146 => ROW(createRecord('JudgmentCount24M', le.Version2.JudgmentCount24M)),
				147 => ROW(createRecord('JudgmentCount36M', le.Version2.JudgmentCount36M)),
				148 => ROW(createRecord('JudgmentCount60M', le.Version2.JudgmentCount60M)),
				149 => ROW(createRecord('JudgmentClaimsCount', le.Version2.JudgmentClaimsCount)),
				150 => ROW(createRecord('JudgmentClaimsTotalAmount', le.Version2.JudgmentClaimsTotalAmount)),
				151 => ROW(createRecord('JudgmentSmallClaimsCount', le.Version2.JudgmentSmallClaimsCount)),
				152 => ROW(createRecord('JudgmentSmallClaimsTotalAmount', le.Version2.JudgmentSmallClaimsTotalAmount)),
				153 => ROW(createRecord('JudgmentSuitsCount', le.Version2.JudgmentSuitsCount)),
				154 => ROW(createRecord('JudgmentsSuitsTotalAmount', le.Version2.JudgmentsSuitsTotalAmount)),
				155 => ROW(createRecord('JudgmentsOtherCount', le.Version2.JudgmentsOtherCount)),
				156 => ROW(createRecord('JudgmentOtherTotalAmount', le.Version2.JudgmentOtherTotalAmount)),
				157 => ROW(createRecord('AssetPropCountEver', le.Version2.AssetPropCountEver)),
				158 => ROW(createRecord('AssetPropCountCurrent', le.Version2.AssetPropCountCurrent)),
				159 => ROW(createRecord('AssetPropStateCountEver', le.Version2.AssetPropStateCountEver)),
				160 => ROW(createRecord('AssetPropStateCountCurrent', le.Version2.AssetPropStateCountCurrent)),
				161 => ROW(createRecord('AssetPropLotSizeTotalEver', le.Version2.AssetPropLotSizeTotalEver)),
				162 => ROW(createRecord('AssetPropLotSizeTotalCurrent', le.Version2.AssetPropLotSizeTotalCurrent)),
				163 => ROW(createRecord('AssetPropSqFootageTotalEver', le.Version2.AssetPropSqFootageTotalEver)),
				164 => ROW(createRecord('AssetPropSqFootageTotalCurrent', le.Version2.AssetPropSqFootageTotalCurrent)),
				165 => ROW(createRecord('AssetPropAssessedTotalEver', le.Version2.AssetPropAssessedTotalEver)),
				166 => ROW(createRecord('AssetPropAssessedTotalCurrent', le.Version2.AssetPropAssessedTotalCurrent)),
				167 => ROW(createRecord('AssetAircraftCount', le.Version2.AssetAircraftCount)),
				168 => ROW(createRecord('AssetWatercraftCount', le.Version2.AssetWatercraftCount)),
				169 => ROW(createRecord('AssetVehicleCount', le.Version2.AssetVehicleCount)),
				170 => ROW(createRecord('AssetVehiclePersonalCount', le.Version2.AssetVehiclePersonalCount)),
				171 => ROW(createRecord('AssetVehicleCommercialCount', le.Version2.AssetVehicleCommercialCount)),
				172 => ROW(createRecord('AssetVehicleOtherCount', le.Version2.AssetVehicleOtherCount)),
				173 => ROW(createRecord('UCCCount', le.Version2.UCCCount)),
				174 => ROW(createRecord('UCCTimeOldest', le.Version2.UCCTimeOldest)),
				175 => ROW(createRecord('UCCTimeNewest', le.Version2.UCCTimeNewest)),
				176 => ROW(createRecord('UCCActiveCount', le.Version2.UCCActiveCount)),
				177 => ROW(createRecord('UCCTerminatedCount', le.Version2.UCCTerminatedCount)),
				178 => ROW(createRecord('UCCOtherCount', le.Version2.UCCOtherCount)),
				179 => ROW(createRecord('UCCRoles', le.Version2.UCCRoles)),
				180 => ROW(createRecord('UCCRolesActive', le.Version2.UCCRolesActive)),
				181 => ROW(createRecord('GovernmentDebarred', le.Version2.GovernmentDebarred)),
				182 => ROW(createRecord('B2BProviderAvg12M', le.Version2.B2BProviderAvg12M)),
				183 => ROW(createRecord('B2BProviderDelta12M', le.Version2.B2BProviderDelta12M)),
				184 => ROW(createRecord('B2BProviderDelta24M', le.Version2.B2BProviderDelta24M)),
				185 => ROW(createRecord('B2BSpendCategories12M', le.Version2.B2BSpendCategories12M)),
				186 => ROW(createRecord('B2BSpendTotal12M', le.Version2.B2BSpendTotal12M)),
				187 => ROW(createRecord('B2BSpendDelta12M', le.Version2.B2BSpendDelta12M)),
				188 => ROW(createRecord('B2BSpendDelta24M', le.Version2.B2BSpendDelta24M)),
				189 => ROW(createRecord('B2BDBTAvg03', le.Version2.B2BDBTAvg03)),
				190 => ROW(createRecord('B2B30DBT12MInd', le.Version2.B2B30DBT12MInd)),
				191 => ROW(createRecord('B2B60DBT12MInd', le.Version2.B2B60DBT12MInd)),
				192 => ROW(createRecord('B2B90DBT12Ind', le.Version2.B2B90DBT12Ind)),
				193 => ROW(createRecord('B2BDBT30Delta12M', le.Version2.B2BDBT30Delta12M)),
				194 => ROW(createRecord('B2BDBT30Delta24M', le.Version2.B2BDBT30Delta24M)),
				195 => ROW(createRecord('B2BDBT60Delta12M', le.Version2.B2BDBT60Delta12M)),
				196 => ROW(createRecord('B2BDBT60Delta24M', le.Version2.B2BDBT60Delta24M)),
				197 => ROW(createRecord('B2BPaid12M', le.Version2.B2BPaid12M)),
				198 => ROW(createRecord('B2BBalanceAvg03M', le.Version2.B2BBalanceAvg03M)),
				199 => ROW(createRecord('InquiryCount', le.Version2.InquiryCount)),
				200 => ROW(createRecord('InquiryCount03M', le.Version2.InquiryCount03M)),
				201 => ROW(createRecord('InquiryCount06M', le.Version2.InquiryCount06M)),
				202 => ROW(createRecord('InquiryCount12M', le.Version2.InquiryCount12M)),
				203 => ROW(createRecord('InquiryCount24M', le.Version2.InquiryCount24M)),
				204 => ROW(createRecord('InquiryCreditCount', le.Version2.InquiryCreditCount)),
				205 => ROW(createRecord('InquiryCreditCount03M', le.Version2.InquiryCreditCount03M)),
				206 => ROW(createRecord('InquiryCreditCount06M', le.Version2.InquiryCreditCount06M)),
				207 => ROW(createRecord('InquiryCreditCount12M', le.Version2.InquiryCreditCount12M)),
				208 => ROW(createRecord('InquiryCreditCount24M', le.Version2.InquiryCreditCount24M)),
				209 => ROW(createRecord('InquiryHighRiskCount', le.Version2.InquiryHighRiskCount)),
				210 => ROW(createRecord('InquiryHighRiskCount03M', le.Version2.InquiryHighRiskCount03M)),
				211 => ROW(createRecord('InquiryHighRiskCount06M', le.Version2.InquiryHighRiskCount06M)),
				212 => ROW(createRecord('InquiryHighRiskCount12M', le.Version2.InquiryHighRiskCount12M)),
				213 => ROW(createRecord('InquiryHighRiskCount24M', le.Version2.InquiryHighRiskCount24M)),
				214 => ROW(createRecord('InquiryOtherCount', le.Version2.InquiryOtherCount)),
				215 => ROW(createRecord('InquiryOtherCount03M', le.Version2.InquiryOtherCount03M)),
				216 => ROW(createRecord('InquiryOtherCount06M', le.Version2.InquiryOtherCount06M)),
				217 => ROW(createRecord('InquiryOtherCount12M', le.Version2.InquiryOtherCount12M)),
				218 => ROW(createRecord('InquiryOtherCount24M', le.Version2.InquiryOtherCount24M)),
				219 => ROW(createRecord('BusExecLinkRepNameOnFile', le.Version2.BusExecLinkRepNameOnFile)),
				220 => ROW(createRecord('BusExecLinkRepAddrOnFile', le.Version2.BusExecLinkRepAddrOnFile)),
				221 => ROW(createRecord('BusExecLinkRepPhoneOnFile', le.Version2.BusExecLinkRepPhoneOnFile)),
				222 => ROW(createRecord('BusExecLinkRepSSNOnFile', le.Version2.BusExecLinkRepSSNOnFile)),
				223 => ROW(createRecord('BusExecLinkBusNameRepFirst', le.Version2.BusExecLinkBusNameRepFirst)),
				224 => ROW(createRecord('BusExecLinkBusNameRepLast', le.Version2.BusExecLinkBusNameRepLast)),
				225 => ROW(createRecord('BusExecLinkBusNameRepFull', le.Version2.BusExecLinkBusNameRepFull)),
				226 => ROW(createRecord('BusExecLinkRepAddrBusAddr', le.Version2.BusExecLinkRepAddrBusAddr)),
				227 => ROW(createRecord('BusExecLinkRepPhoneBusPhone', le.Version2.BusExecLinkRepPhoneBusPhone)),
				228 => ROW(createRecord('BusExecLinkRepSSNBusFEIN', le.Version2.BusExecLinkRepSSNBusFEIN)),
				229 => ROW(createRecord('BusExecLinkUtilOverlapCount', le.Version2.BusExecLinkUtilOverlapCount)),
				230 => ROW(createRecord('BusExecLinkInqOverlapCount', le.Version2.BusExecLinkInqOverlapCount)),
				231 => ROW(createRecord('BusExecLinkPropOverlapCount', le.Version2.BusExecLinkPropOverlapCount)),
				232 => ROW(createRecord('BusExecLinkBusAddrRepOwned', le.Version2.BusExecLinkBusAddrRepOwned)),
				233 => ROW(createRecord('BusExecLinkRep2NameOnFile', le.Version2.BusExecLinkRep2NameOnFile)),
				234 => ROW(createRecord('BusExecLinkRep2AddrOnFile', le.Version2.BusExecLinkRep2AddrOnFile)),
				235 => ROW(createRecord('BusExecLinkRep2PhoneOnFile', le.Version2.BusExecLinkRep2PhoneOnFile)),
				236 => ROW(createRecord('BusExecLinkRep2SSNOnFile', le.Version2.BusExecLinkRep2SSNOnFile)),
				237 => ROW(createRecord('BusExecLinkBusNameRep2First', le.Version2.BusExecLinkBusNameRep2First)),
				238 => ROW(createRecord('BusExecLinkBusNameRep2Last', le.Version2.BusExecLinkBusNameRep2Last)),
				239 => ROW(createRecord('BusExecLinkBusNameRep2Full', le.Version2.BusExecLinkBusNameRep2Full)),
				240 => ROW(createRecord('BusExecLinkRep2AddrBusAddr', le.Version2.BusExecLinkRep2AddrBusAddr)),
				241 => ROW(createRecord('BusExecLinkRep2PhoneBusPhone', le.Version2.BusExecLinkRep2PhoneBusPhone)),
				242 => ROW(createRecord('BusExecLinkRep2SSNBusFEIN', le.Version2.BusExecLinkRep2SSNBusFEIN)),
				243 => ROW(createRecord('BusExecLinkUtilOverlapCount2', le.Version2.BusExecLinkUtilOverlapCount2)),
				244 => ROW(createRecord('BusExecLinkInqOverlapCount2', le.Version2.BusExecLinkInqOverlapCount2)),
				245 => ROW(createRecord('BusExecLinkPropOverlapCount2', le.Version2.BusExecLinkPropOverlapCount2)),
				246 => ROW(createRecord('BusExecLinkBusAddrRep2Owned', le.Version2.BusExecLinkBusAddrRep2Owned)),
				247 => ROW(createRecord('BusExecLinkRep3NameOnFile', le.Version2.BusExecLinkRep3NameOnFile)),
				248 => ROW(createRecord('BusExecLinkRep3AddrOnFile', le.Version2.BusExecLinkRep3AddrOnFile)),
				249 => ROW(createRecord('BusExecLinkRep3PhoneOnFile', le.Version2.BusExecLinkRep3PhoneOnFile)),
				250 => ROW(createRecord('BusExecLinkRep3SSNOnFile', le.Version2.BusExecLinkRep3SSNOnFile)),
				251 => ROW(createRecord('BusExecLinkBusNameRep3First', le.Version2.BusExecLinkBusNameRep3First)),
				252 => ROW(createRecord('BusExecLinkBusNameRep3Last', le.Version2.BusExecLinkBusNameRep3Last)),
				253 => ROW(createRecord('BusExecLinkBusNameRep3Full', le.Version2.BusExecLinkBusNameRep3Full)),
				254 => ROW(createRecord('BusExecLinkRep3AddrBusAddr', le.Version2.BusExecLinkRep3AddrBusAddr)),
				255 => ROW(createRecord('BusExecLinkRep3PhoneBusPhone', le.Version2.BusExecLinkRep3PhoneBusPhone)),
				256 => ROW(createRecord('BusExecLinkRep3SSNBusFEIN', le.Version2.BusExecLinkRep3SSNBusFEIN)),
				257 => ROW(createRecord('BusExecLinkUtilOverlapCount3', le.Version2.BusExecLinkUtilOverlapCount3)),
				258 => ROW(createRecord('BusExecLinkInqOverlapCount3', le.Version2.BusExecLinkInqOverlapCount3)),
				259 => ROW(createRecord('BusExecLinkPropOverlapCount3', le.Version2.BusExecLinkPropOverlapCount3)),
				260 => ROW(createRecord('BusExecLinkBusAddrRep3Owned', le.Version2.BusExecLinkBusAddrRep3Owned)),
				261 => ROW(createRecord('BusAddrPersonNameOverlap ', le.Version2.BusAddrPersonNameOverlap )),
				262 => ROW(createRecord('BusAddrPersonNameAltNameOverlap', le.Version2.BusAddrPersonNameAltNameOverlap)),
				263 => ROW(createRecord('BusFEINPersonAddrOverlap ', le.Version2.BusFEINPersonAddrOverlap )),
				264 => ROW(createRecord('BusFEINPersonPhoneOverlap ', le.Version2.BusFEINPersonPhoneOverlap )),
				265 => ROW(createRecord('BusFEINPersonOverlap ', le.Version2.BusFEINPersonOverlap )),
				266 => ROW(createRecord('InputAddrConsumerCount', le.Version2.InputAddrConsumerCount)),
				267 => ROW(createRecord('InputFEINEntityCount', le.Version2.InputFEINEntityCount)),
				268 => ROW(createRecord('InputPhoneEntityCount ', le.Version2.InputPhoneEntityCount )),
				269 => ROW(createRecord('InputBusAddrCurrentCount', le.Version2.InputBusAddrCurrentCount)),
				270 => ROW(createRecord('InputAddrFEINCount', le.Version2.InputAddrFEINCount)),
				271 => ROW(createRecord('InputBusNameOtherBusNameMatch', le.Version2.InputBusNameOtherBusNameMatch)),
				272 => ROW(createRecord('InputBusNameDBAMatch', le.Version2.InputBusNameDBAMatch)),
				273 => ROW(createRecord('InputAltNameBusNameMatch', le.Version2.InputAltNameBusNameMatch)),
				274 => ROW(createRecord('InputAltNameOtherBusNameMatch', le.Version2.InputAltNameOtherBusNameMatch)),
				275 => ROW(createRecord('InputAltNameDBAMatch', le.Version2.InputAltNameDBAMatch)),
				276 => ROW(createRecord('InputAddrValid', le.Version2.InputAddrValid)),
				277 => ROW(createRecord('InputAddrPoBox', le.Version2.InputAddrPoBox)),
				278 => ROW(createRecord('InputAddrType', le.Version2.InputAddrType)),
				279 => ROW(createRecord('InputAddrZipMismatch', le.Version2.InputAddrZipMismatch)),
				280 => ROW(createRecord('InputAddrVacancy', le.Version2.InputAddrVacancy)),
				281 => ROW(createRecord('InputAddrTimeOldest', le.Version2.InputAddrTimeOldest)),
				282 => ROW(createRecord('InputAddrOwnership', le.Version2.InputAddrOwnership)),
				283 => ROW(createRecord('InputAddrAssessedValue', le.Version2.InputAddrAssessedValue)),
				284 => ROW(createRecord('InputAddrLotSize', le.Version2.InputAddrLotSize)),
				285 => ROW(createRecord('InputAddrBuildingSize', le.Version2.InputAddrBuildingSize)),
				286 => ROW(createRecord('InputPhoneMismatch', le.Version2.InputPhoneMismatch)),
				287 => ROW(createRecord('InputPhoneDisconnected', le.Version2.InputPhoneDisconnected)),
				288 => ROW(createRecord('InputPhoneValid', le.Version2.InputPhoneValid)),
				289 => ROW(createRecord('InputPhoneType', le.Version2.InputPhoneType)),
				290 => ROW(createRecord('InputPhoneResidential', le.Version2.InputPhoneResidential)),
				291 => ROW(createRecord('InputPhoneProblems', le.Version2.InputPhoneProblems)),
				292 => ROW(createRecord('InputFEINBIIMismatch', le.Version2.InputFEINBIIMismatch)),
				293 => ROW(createRecord('InputFEINHitIndex', le.Version2.InputFEINHitIndex)),
				294 => ROW(createRecord('AssociateCount', le.Version2.AssociateCount)),
				295 => ROW(createRecord('AssociateBusinessCount', le.Version2.AssociateBusinessCount)),
				296 => ROW(createRecord('AssociateFelonyCount', le.Version2.AssociateFelonyCount)),
				297 => ROW(createRecord('AssociateCountWithFelony', le.Version2.AssociateCountWithFelony)),
				298 => ROW(createRecord('AssociateBankruptCount', le.Version2.AssociateBankruptCount)),
				299 => ROW(createRecord('AssociateCountWithBankruptcy', le.Version2.AssociateCountWithBankruptcy)),
				300 => ROW(createRecord('AssociateBankrupt12MCount', le.Version2.AssociateBankrupt12MCount)),
				301 => ROW(createRecord('AssociateLienCount', le.Version2.AssociateLienCount)),
				302 => ROW(createRecord('AssociateCountWithLien', le.Version2.AssociateCountWithLien)),
				303 => ROW(createRecord('AssociateJudgmentCount', le.Version2.AssociateJudgmentCount)),
				304 => ROW(createRecord('AssociateCountWithJudgment', le.Version2.AssociateCountWithJudgment)),
				305 => ROW(createRecord('AssociateCityCount', le.Version2.AssociateCityCount)),
				306 => ROW(createRecord('AssociateCountyCount', le.Version2.AssociateCountyCount)),
				307 => ROW(createRecord('AssociateHighRiskAddrCount', le.Version2.AssociateHighRiskAddrCount)),
				308 => ROW(createRecord('AssociateHighCrimeAddrCount', le.Version2.AssociateHighCrimeAddrCount)),
				309 => ROW(createRecord('AssociateCurrCount', le.Version2.AssociateCurrCount)),
				310 => ROW(createRecord('AssociateCurrCountWithFelony', le.Version2.AssociateCurrCountWithFelony)),
				311 => ROW(createRecord('AssociateCurrCountWithBkrpt', le.Version2.AssociateCurrCountWithBkrpt)),
				312 => ROW(createRecord('AssociateCurrCountWithLien', le.Version2.AssociateCurrCountWithLien)),
				313 => ROW(createRecord('AssociateCurrCountWithJudgment', le.Version2.AssociateCurrCountWithJudgment)),
				314 => ROW(createRecord('AssociateCurrCountWithProp', le.Version2.AssociateCurrCountWithProp)),
				315 => ROW(createRecord('AssociateCurrBusinessesTotal', le.Version2.AssociateCurrBusinessesTotal)),
				316 => ROW(createRecord('AssociateCurrSOSCount', le.Version2.AssociateCurrSOSCount)),
							 ROW(createRecord('Invalid',	'Invalid')));
	END;
