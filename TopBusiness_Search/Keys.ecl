...
module
	...
	export LLID9 := KeyPrep_BID_LLID9(TopBusiness.Files(version,pUseOtherEnvironment).LLID.Linked.Built,version,pUseOtherEnvironment);
	export LLID12 := KeyPrep_BID_LLID12(TopBusiness.Files(version,pUseOtherEnvironment).LLID.Linked.Built,version,pUseOtherEnvironment);
