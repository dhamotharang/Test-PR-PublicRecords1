...
KeyFileName := '~prte::key::propertyinfo::20170427d::rid ';
// KeyFileName := ut.foreign_prod+'prte::key::propertyinfo::20170427b::rid ';
...
newTypes := prct_data_key(roof_type <> '');
OUTPUT(newTypes(src_roof_type = 'OKCTY'));
OUTPUT(newTypes(src_roof_type = 'FARES'));
