EXPORT _Constants(BOOLEAN	pUseOtherEnvironment = FALSE) := MODULE
	...
	EXPORT autokey_buildskipset := ['P', 'Q', 'F', 'B', 'S'];
	/*
	...
	*/
	...
	EXPORT ak_qa_keyname   := _Dataset(pUseOtherEnvironment).thor_cluster_files + 'key::death_mi::qa::autokey::';
  ...
  // Autokey Search variables
	...
	EXPORT         AUTOKEY_NAME     := Death_MI._Dataset().thor_cluster_files + 'key::' +
	                                      Death_MI._Dataset().name + '::qa::autokey::';
