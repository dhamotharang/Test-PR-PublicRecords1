...
Command line options: -MScrubs_Corp2_Mapping_KS_AR -eC:\Users\butlersx\AppData\Local\Temp\TFR7FFE.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_KS_AR
FILENAME:In_KS
...
FIELDTYPE:invalid_ar_status:CUSTOM(Scrubs_Corp2_Mapping_KS_AR.Functions.invalid_ar_status>0)
...
FIELD:ar_report_nbr:TYPE(STRING30):LIKE(invalid_numeric):0,0
...
FIELD:ar_roll:TYPE(STRING10):LIKE(invalid_numeric):0,0
FIELD:ar_frame:TYPE(STRING10):LIKE(invalid_numeric):0,0
...
FIELD:ar_status:TYPE(STRING50):LIKE(invalid_ar_status):0,0
FIELD:ar_paid_date:TYPE(STRING8):LIKE(invalid_date):0,0
