import ut, STD, Email_Data;
export Fn_Rollup_Email_Data_Orig(dataset(recordof(Email_Data.Layout_Email.Base)) email_in) := function


email_rec_and_fix_dates := project(email_in, transform(Email_Data.Layout_Email.Base,
