...
rgxSureHonor := 	// no oriental names
 '(MD|DMD|DDS|CNFP|CNM|CNP|CPA|CSW|DR|PHD|ESQ|RN|RPN|LPN|LN|DC|DPM|DPC|DD|LMT|DVM|PSYD|ASID|CLU|JD|OEmergency Medical D|CFP|AA|NP|ARNP|MSW|LCSW|LSW|ACSW|LMHC|LMFT|CMT|LPCC|SJ|OP|MBA|MSD|CTM|DTM|CPS|ADJ|DWP|SEC|VDM|VMD|PA-C|PA|RPA-C|RPA|APA-C|CSJ|SSJ|BVM|CSC|MSN|CPNP|FNP|CRNP|PBLN|PMLN|RLTR|LRCP|CRNA|MBBS|PNP|RNP|CNS|CMS|C<RS|LMHP|LIMHP|PLMHP|MDIV|CEO|CFO|RDN)';
