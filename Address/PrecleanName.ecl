...
rgxHonor := 
 '(MD|DMD|DDS|CNFP|CNM|CNP|CPA|CSW|DR|PHD|ESQ|RN|RPN|LPN|LN|DO|DC|DPM|DPC|DD|LMT|DVM|PSYD|ASID|CLU|JD|OD|CFP|AA|AS|NP|FNP|ARNP|MSW|LCSW|LSW|ACSW|LMHC|LMFT|CMT|LPCC|MA|SJ|OP|MBA|MSD|CTM|DTM|CPS|ADJ|DWP|SEC|VDM|VMD|PA-C|PA|RPA-C|RPA|APA-C|CSJ|SSJ|BVM|CSC|MSN|CPNP|FNP|CRNP|PBLN|PMLN|RLTR|LRCP|CRNA|MBBS|PNP|RNP|CNS|CMS|CMRS|LMHP|LIMHP|PLMHP|MDIV|CEO|CFO|RD|RDN)';
rgxSureHonor := 	// no oriental names
 '(MD|DMD|DDS|CNFP|CNM|CNP|CPA|CSW|DR|PHD|ESQ|RN|RPN|LPN|LN|DC|DPM|DPC|DD|LMT|DVM|PSYD|ASID|CLU|JD|OEmergency Medical D|CFP|AA|NP|ARNP|MSW|LCSW|LSW|ACSW|LMHC|LMFT|CMT|LPCC|SJ|OP|MBA|MSD|CTM|DTM|CPS|ADJ|DWP|SEC|VDM|VMD|PA-C|PA|RPA-C|RPA|APA-C|CSJ|SSJ|BVM|CSC|MSN|CPNP|FNP|CRNP|PBLN|PMLN|RLTR|LRCP|CRNA|MBBS|PNP|RNP|CNS|CMS|CMRS|LMHP|LIMHP|PLMHP|MDIV|CEO|CFO|RDN)';
