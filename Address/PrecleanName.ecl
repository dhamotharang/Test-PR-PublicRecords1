...
rgxHonor := 
 '(MD|DMD|DDS|CNFP|CNM|CNP|CPA|CSW|DR|PHD|ESQ|RN|RPN|LPN|LN|DO|DC|DPM|DPC|DD|LMT|DVM|PSYD|ASID|CLU|JD|OD|CFP|AA|AS|NP|FNP|ARNP|MSW|LCSW|LSW|ACSW|LMHC|LMFT|CMT|LPCC|MA|SJ|OP|MBA|MSD|CTM|DTM|CPS|ADJ|DWP|SEC|VDM|VMD|PA-C|PA|RPA-C|RPA|APA-C|CSJ|SSJ|BVM|CSC|MSN|CPNP|FNP|CRNP|PBLN|PMLN|RLTR|LRCP|CRNA|MBBS|PNP|RNP|CNS|CMS|CMRS|LMHP|LIMHP|PLMHP|MDIV|CEO|CFO|RD|RDN|DPT|RPH|PHARMD)';
rgxSureHonor := 	// no oriental names
 '(MD|DMD|DDS|CNFP|CNM|CNP|CPA|CSW|DR|PHD|ESQ|RN|RPN|LPN|LN|DC|DPM|DPC|DD|LMT|DVM|PSYD|ASID|CLU|JD|OD|CFP|AA|NP|ARNP|MSW|LCSW|LSW|ACSW|LMHC|LMFT|CMT|LPCC|SJ|OP|MBA|MSD|CTM|DTM|CPS|ADJ|DWP|SEC|VDM|VMD|PA-C|PA|RPA-C|RPA|APA-C|CSJ|SSJ|BVM|CSC|MSN|CPNP|FNP|CRNP|PBLN|PMLN|RLTR|LRCP|CRNA|MBBS|PNP|RNP|CNS|CMS|CMRS|LMHP|LIMHP|PLMHP|MDIV|CEO|CFO|RDN|DPT|RPH|PHARMD)';
...
rgxEtuxAtEnd := '\\b(ET ?UX ET ?AL|ET ?AL ET ?UX|ETUX|ET UX|ET-UX|ET UM|ETUM|ET VIR|ETVIR|UX|ET|AND|OR|LTR(S)?|MKD|MCC|VLB|RF|TRT|ITF|MB|HRS|TST|TLT|RTS|TTS|TRSRS|HSB|JP|FC|FST|LW|HWJT|HWLP|RLT|RVT|LVG|DTD|MGP|JTV|RVC|PMB|COC|CPRS|CPWR(S)?|JTS|JTWRS|JT/ROS|[JKD]/REF|TRU ST|HUSBAND *( AND |&) *WIFE)$';
...
string StripoutSemicolon(string s) :=
		MAP(
			...
			REGEXFIND('; *(JR|SR|II|III)[ .]*$', s) => StringLib.StringFindReplace(s, ';',' '),
