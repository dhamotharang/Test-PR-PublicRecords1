...
email_success := fileservices.sendemail('RoxieBuilds@seisint.com;kgummadi@seisint.com;christopher.brodeur@lexisnexis.com',
  ...
  '6)thor_data400::key::daybatch_pcnsr::pcnsr.z137lf_qa(thor_data400::key::daybatch_pcnsr::'+file_date+'::pcnsr.z137lf) , \n' +             
  '7)thor_data400::key::daybatch_pcnsr::pcnsr.hhid_qa(thor_data400::key::daybatch_pcnsr::'+file_date+'::pcnsr.hhid) , \n' + 
  '8)thor_data400::key::daybatch_pcnsr::pcnsr.address_qa(thor_data400::key::daybatch_pcnsr::'+file_date+'::pcnsr.address) , \n' + 
