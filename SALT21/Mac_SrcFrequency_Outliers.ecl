export mac_srcfrequency_outliers(infile,infield,srcfield,o) := macro
  #uniquename(r)
  %r% := record
	  SALT21.Str30Type fieldname := #TEXT(infield);
	  SALT21.StrType fieldvalue {maxlength(200000)} := (SALT21.StrType)infile.infield ;
		SALT21.StrType src {maxlength(30)} := infile.srcfield ;
