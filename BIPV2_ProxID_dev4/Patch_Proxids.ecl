...
import bipv2,bipv2_files,BIPV2_ProxID_dev4,ut,salt26,tools;
...
function
  ...
  filename  := BIPV2_ProxID_dev4.filenames(combo).base.logical;
  ...
  dproxidsold := table(ddefaultproxids  ,{proxid},proxid);
  ...
  sequential(
    ...
    ,iff(pAdd2Super = true  ,BIPV2_ProxID_dev4.Promote(combo).new2built)
  )
  ;
