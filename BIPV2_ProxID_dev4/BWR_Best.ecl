...
#workunit('name','BIPV2_ProxID_dev4.BWR_Best - BEST - SALT V2.5 Alpha 1');
...
// BIPV2_ProxID_dev4.Keys(BIPV2_ProxID_dev4.In_DOT_Base).BuildData;

// The statistics for the best (also builds all the persists)
BIPV2_ProxID_dev4.Best(BIPV2_ProxID_dev4.In_DOT_Base).Stats;
...
b := BIPV2_ProxID_dev4.Best(BIPV2_ProxID_dev4.In_DOT_Base); // Instantiate Best module
