//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_dev4',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_dev4.filenames(combo).dall_filenames
                  + BIPV2_ProxID_dev4.keynames (combo).dall_filenames
                  + BIPV2_ProxID_dev4.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_dev4.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_dev4.filenames(siter).dall_filenames
                  + BIPV2_ProxID_dev4.keynames (siter).dall_filenames
                  ;
