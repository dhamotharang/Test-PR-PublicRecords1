...
SHARED h0 := SALT27.MAC_Partition_Stars(h02,SALT_Partition,Proxid); // Note b-list inside a-list clusters
...
EXPORT input_file := h0  : PERSIST('~temp::Proxid::BIPV2_ProxID_dev4::Specificities_Cache');
//We have Proxid specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.Proxid;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,Proxid,LOCAL)  : PERSIST('~temp::Proxid::BIPV2_ProxID_dev4::Cluster_Sizes');
EXPORT TotalClusters := COUNT(ClusterSizes);
 
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::active_duns_number';
 
SHARED  active_duns_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_duns_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_active_duns_number'); // Reduce to field values by UID
...
EXPORT active_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::active_enterprise_number';
 
SHARED  active_enterprise_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_enterprise_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_active_enterprise_number'); // Reduce to field values by UID
...
EXPORT active_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::active_domestic_corp_key';
 
SHARED  active_domestic_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,active_domestic_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_active_domestic_corp_key'); // Reduce to field values by UID
...
EXPORT hist_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::hist_enterprise_number';
 
SHARED  hist_enterprise_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_enterprise_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_hist_enterprise_number'); // Reduce to field values by UID
...
EXPORT hist_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::hist_duns_number';
 
SHARED  hist_duns_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_duns_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_hist_duns_number'); // Reduce to field values by UID
...
EXPORT hist_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::hist_domestic_corp_key';
 
SHARED  hist_domestic_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,hist_domestic_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_hist_domestic_corp_key'); // Reduce to field values by UID
...
EXPORT foreign_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::foreign_corp_key';
 
SHARED  foreign_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,foreign_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_foreign_corp_key'); // Reduce to field values by UID
...
EXPORT unk_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::unk_corp_key';
 
SHARED  unk_corp_key_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,unk_corp_key) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_unk_corp_key'); // Reduce to field values by UID
...
EXPORT ebr_file_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::ebr_file_number';
 
SHARED  ebr_file_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,ebr_file_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_ebr_file_number'); // Reduce to field values by UID
...
EXPORT company_nameValuesKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_name';
 
SHARED  company_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_name'); // Reduce to field values by UID
  SALT27.MAC_Field_Variants_Hyphen(company_name_deduped,Proxid,company_name,expanded) // expand out all variants when hyphenated
  SALT27.Mac_Field_Count_UID(expanded,company_name,Proxid,counted,counted_clusters) // count the number of UIDs with each field value
  r1 := RECORD
    counted;
    UNSIGNED4 id := 0; // Used to identify value later
  end;
...
// This field is a word bag; so create specifcities for the words too
  SALT27.MAC_Field_Variants_WordBag(company_name_deduped,Proxid,company_name,expanded)// expand out all variants of wordbag
  SALT27.Mac_Field_Count_UID(expanded,company_name,Proxid,counted,counted_clusters) // count the number of UIDs with each field value
...
EXPORT company_name_values_key := INDEX(company_name_ad,{company_name},{company_name_ad},company_nameValuesKeyName);
  SALT27.mac_wordbag_addweights(company_name_sa,company_name,company_name_ad,p);
 
EXPORT company_name_values_index := INDEX(p,{company_name},{p},company_nameValuesKeyName);
...
SALT27.MAC_Field_Bfoul(company_name_deduped,company_name,Proxid,company_name_nulls,ClusterSizes,false,true,bf) // Compute the chances of a field having 2 values for one entity
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::cnp_number';
 
SHARED  cnp_number_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,cnp_number) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_cnp_number'); // Reduce to field values by UID
...
EXPORT cnp_btypeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::cnp_btype';
 
SHARED  cnp_btype_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,cnp_btype) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_cnp_btype'); // Reduce to field values by UID
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_fein';
 
SHARED  company_fein_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_fein) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_fein'); // Reduce to field values by UID
...
EXPORT company_phoneValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_phone';
 
SHARED  company_phone_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_phone) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_phone'); // Reduce to field values by UID
...
EXPORT iscorpValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::iscorp';
 
SHARED  iscorp_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,iscorp) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_iscorp'); // Reduce to field values by UID
...
EXPORT prim_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::prim_range';
 
SHARED  prim_range_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,prim_range) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_prim_range'); // Reduce to field values by UID
...
EXPORT prim_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::prim_name';
 
SHARED  prim_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,prim_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_prim_name'); // Reduce to field values by UID
...
EXPORT sec_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::sec_range';
 
SHARED  sec_range_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,sec_range) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_sec_range'); // Reduce to field values by UID
...
EXPORT v_city_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::v_city_name';
 
SHARED  v_city_name_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,v_city_name) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_v_city_name'); // Reduce to field values by UID
...
EXPORT stValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::st';
 
SHARED  st_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,st) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_st'); // Reduce to field values by UID
...
EXPORT zipValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::zip';
 
SHARED  zip_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,zip) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_zip'); // Reduce to field values by UID
...
EXPORT company_cszValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_csz';
 
SHARED  company_csz_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_csz) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_csz'); // Reduce to field values by UID
...
EXPORT company_addr1ValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_addr1';
 
SHARED  company_addr1_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_addr1) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_addr1'); // Reduce to field values by UID
...
EXPORT company_addressValuesIndexKeyName := '~'+'key::BIPV2_ProxID_dev4::Proxid::Word::company_address';
 
SHARED  company_address_deduped := SALT27.MAC_Field_By_UID(input_file,Proxid,company_address) : PERSIST('~temp::dedups::BIPV2_ProxID_dev4_Proxid_company_address'); // Reduce to field values by UID
...
SpcShiftR := RECORD
  integer1 active_duns_number_shift0 := ROUND(Specificities[1].active_duns_number_specificity - 26);
  ...
  integer2 hist_enterprise_number_switch_shift0 := ROUND(1000*Specificities[1].hist_enterprise_number_switch - 9);
  integer1 hist_duns_number_shift0 := ROUND(Specificities[1].hist_duns_number_specificity - 26);
  integer2 hist_duns_number_switch_shift0 := ROUND(1000*Specificities[1].hist_duns_number_switch - 56);
  integer1 hist_domestic_corp_key_shift0 := ROUND(Specificities[1].hist_domestic_corp_key_specificity - 27);
  integer2 hist_domestic_corp_key_switch_shift0 := ROUND(1000*Specificities[1].hist_domestic_corp_key_switch - 5);
  integer1 foreign_corp_key_shift0 := ROUND(Specificities[1].foreign_corp_key_specificity - 25);
  integer2 foreign_corp_key_switch_shift0 := ROUND(1000*Specificities[1].foreign_corp_key_switch - 97);
  integer1 unk_corp_key_shift0 := ROUND(Specificities[1].unk_corp_key_specificity - 27);
  integer2 unk_corp_key_switch_shift0 := ROUND(1000*Specificities[1].unk_corp_key_switch - 7);
  integer1 ebr_file_number_shift0 := ROUND(Specificities[1].ebr_file_number_specificity - 28);
  integer2 ebr_file_number_switch_shift0 := ROUND(1000*Specificities[1].ebr_file_number_switch - 231);
  integer1 company_name_shift0 := ROUND(Specificities[1].company_name_specificity - 25);
  integer2 company_name_switch_shift0 := ROUND(1000*Specificities[1].company_name_switch - 75);
  ...
  integer2 cnp_btype_switch_shift0 := ROUND(1000*Specificities[1].cnp_btype_switch - 18);
  integer1 company_fein_shift0 := ROUND(Specificities[1].company_fein_specificity - 26);
  integer2 company_fein_switch_shift0 := ROUND(1000*Specificities[1].company_fein_switch - 38);
  integer1 company_phone_shift0 := ROUND(Specificities[1].company_phone_specificity - 26);
  integer2 company_phone_switch_shift0 := ROUND(1000*Specificities[1].company_phone_switch - 227);
  ...
  integer2 sec_range_switch_shift0 := ROUND(1000*Specificities[1].sec_range_switch - 57);
  integer1 v_city_name_shift0 := ROUND(Specificities[1].v_city_name_specificity - 11);
  integer2 v_city_name_switch_shift0 := ROUND(1000*Specificities[1].v_city_name_switch - 5);
  ...
  integer2 company_csz_switch_shift0 := ROUND(1000*Specificities[1].company_csz_switch - 10);
  integer1 company_addr1_shift0 := ROUND(Specificities[1].company_addr1_specificity - 23);
  integer2 company_addr1_switch_shift0 := ROUND(1000*Specificities[1].company_addr1_switch - 97);
  integer1 company_address_shift0 := ROUND(Specificities[1].company_address_specificity - 25);
  integer2 company_address_switch_shift0 := ROUND(1000*Specificities[1].company_address_switch - 106);
  END;
...
EXPORT AllProfiles := active_duns_number_specificity_profile + active_enterprise_number_specificity_profile + active_domestic_corp_key_specificity_profile + hist_enterprise_number_specificity_profile + hist_duns_number_specificity_profile + hist_domestic_corp_key_specificity_profile + foreign_corp_key_specificity_profile + unk_corp_key_specificity_profile + ebr_file_number_specificity_profile + company_name_specificity_profile + cnp_number_specificity_profile + cnp_btype_specificity_profile + company_fein_specificity_profile + company_phone_specificity_profile + iscorp_specificity_profile + prim_range_specificity_profile + prim_name_specificity_profile + sec_range_specificity_profile + v_city_name_specificity_profile + st_specificity_profile + zip_specificity_profile;
END;
