...
#workunit('name','BIPV2_ProxID_dev4.BWR_Specificities - Specificities - SALT V2.5 Beta 2');
IMPORT BIPV2_ProxID_dev4,SALT25;
IMPORT SALTTOOLS22;

dotbase := BIPV2_ProxID_dev4.In_DOT_Base;
...
sequential(
  ...
  ,parallel(
    ...
    ,SALTTOOLS22.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_ProxID_dev4._SPC',dotbase)
));
