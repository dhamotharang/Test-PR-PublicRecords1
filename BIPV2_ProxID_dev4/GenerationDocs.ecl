...
(This subtraction estimate is based upon 5% of clusters with 2 or more records have 2 or more values for hist_duns_number.)
...
but should average 25 points with a failed match substracting 22 points.
...
but should average 27 points with a failed match substracting 26 points.
(This subtraction estimate is based upon 0% of clusters with 2 or more records have 2 or more values for unk_corp_key.)
...
(This subtraction estimate is based upon 23% of clusters with 2 or more records have 2 or more values for ebr_file_number.)
...
(This subtraction estimate is based upon 7% of clusters with 2 or more records have 2 or more values for company_name.)
...
(This subtraction estimate is based upon 1% of clusters with 2 or more records have 2 or more values for cnp_btype.)
...
and the degree of fuzziness required but should average 26 points with a failed match substracting 25 points.
...
(This subtraction estimate is based upon 22% of clusters with 2 or more records have 2 or more values for company_phone.)
...
(This subtraction estimate is based upon 5% of clusters with 2 or more records have 2 or more values for sec_range.)
