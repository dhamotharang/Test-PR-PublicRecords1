import ML;
EXPORT macComputeSuspectProviderAddressScoreV4 (Infile, 
																									 LNPID = '',
																									 PrimaryRange = '',
																									 PreDirectional = '',
																									 PrimaryName = '',
																								   ...
																								   ExpiredLicenseNumber = '',
																									 ...
																									 ImpactScoreRange = 0,
																									 PercentileRange = 0,
																									 OIGExclusionBeginDate = '',
																									 OPMExclusionBeginDate = '',
																									 PastRevocationBeginDate = '',
																									 PastStateExclusionBeginDate = '',
																									 PastStateExclusionEndDate = '',
																									 appendPrefix = '\'\''
																									 ) := FUNCTIONMACRO
    ...
    LOCAL ScoreLayout ScoreXForm(RECORDOF(Infile) L) := TRANSFORM
        ...
        evalStudentNPI 										:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.EvalStudentNPI								(L.TotalNPICount, L.StudentNPICount, StudentNPISwitch, StudentNPIScore);	
	        ...
	        // Score each element
				...
				evalPastStateExclusion 						:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.EvalPastStateExclusion				(L.PastStateExclusion, PastStateExclusionSwitch, PastStateExclusionScore, L.StateExclusionReinstatedState, L.PastStateExclusionBeginDate, L.PastStateExclusionEndDate, L.PastStateExclusionImpactAmount);				
				evalPastOIGExclusion 							:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.EvalPastOIGExclusion					(L.PastOIGExclusion, PastOIGExclusionSwitch, PastOIGExclusionScore, L.OIGExclusionBeginDate, L.OIGExclusionReinstatedDate, L.PastOIGExclusionImpactAmount);				
				evalPastOPMExclusion 							:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.EvalPastOPMExclusion					(L.PastOPMExclusion, PastOPMExclusionSwitch, PastOPMExclusionScore, L.OPMExclusionBeginDate, L.OPMExclusionReinstatedDate, L.PastOPMExclusionImpactAmount);				
				/* Fix this line */
				evalReinstatedSanctionRevocation 	:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.EvalPastLicenseRevocation			(L.PastLicenseRevocation, PastLicenseRevocationSwitch, PastLicenseRevocationScore, L.LicenseRevocationReinstatedState, L.LicenseRevocationReinstatedDate, L.PastRevokedMedicalLicenseImpactAmount, L.PastRevocationBeginDate);				
            ...
            (
                [
								{evalSharedAddress.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalSharedAddress.reason),
								  evalSharedAddress.Value},			
								{evalDMEOutlier.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalDMEOutlier.reason),
									evalDMEOutlier.Value},							
								{evalLABOutlier.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalLABOutlier.reason),
									evalLABOutlier.Value},							
								{evalSingleAddress.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalSingleAddress.reason),
								  evalSingleAddress.Value},			 			
								{evalRecentNPI.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalRecentNPI.reason),
									evalRecentNPI.Value},			 				
								{evalStudentNPI.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalStudentNPI.reason),
								  evalStudentNPI.Value},			 				
								{evalDND.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalDND.reason),
								  evalDND.Value},			 				
								{evalVacancy.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalVacancy.reason),
								  evalVacancy.Value},			 				
								{evalMailDrop.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalMailDrop.reason),
								  evalMailDrop.Value},							
								{evalPOBox.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalPOBox.reason),
								  evalPOBox.Value},			 				
								{evalPrison.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalPrison.reason),
								  evalPrison.Value},			 				
								{evalresidential.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalresidential.reason),
								  evalresidential.Value},			 			
								{evalActiveStateExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalActiveStateExclusion.reason),
								  evalActiveStateExclusion.Value},			 		
								{evalActiveOIGExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalActiveOIGExclusion.reason),
								  evalActiveOIGExclusion.Value},			 			
								{evalActiveOPMExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalActiveOPMExclusion.reason),
								  evalActiveOPMExclusion.Value},			 			
								{evalActiveSanctionRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalActiveSanctionRevocation.reason),
								  evalActiveSanctionRevocation.Value},			 		
								{evalPastStateExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalPastStateExclusion.reason),
								  evalPastStateExclusion.Value},			 			
								{evalPastOIGExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalPastOIGExclusion.reason),
								  evalPastOIGExclusion.Value},			 			
								{evalPastOPMExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalPastOPMExclusion.reason),
								  evalPastOPMExclusion.Value},			 			
								{evalReinstatedSanctionRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalReinstatedSanctionRevocation.reason),
								  evalReinstatedSanctionRevocation.Value},			 	
								{evalLicenseExpired.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalLicenseExpired.reason),
								  evalLicenseExpired.Value},			 			
								{evalDeaExpired.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalDeaExpired.reason),
								  evalDeaExpired.Value},			 				
								{evalDeceased.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalDeceased.reason), 
								  evalDeceased.Value},			 				
								{evalBankruptcy.reason, ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalBankruptcy.reason),
								  evalBankruptcy.Value},			 				
								{evalCriminalHistory.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalCriminalHistory.reason),
								  evalCriminalHistory.Value},						
								{evalDeceasedPatients.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalDeceasedPatients.reason),
								  evalDeceasedPatients.Value},						
								{evalLargePatientGroups.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalLargePatientGroups.reason),
								  evalLargePatientGroups.Value},						
								{evalLicenseInactive.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalLicenseInactive.reason),
								  evalLicenseInactive.Value},			 			
								{evalNPIDeactivated.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalNPIDeactivated.reason),
								  evalNPIDeactivated.Value},				 		
								{evalLongPatientDrivingDistance.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalLongPatientDrivingDistance.reason), 
								  evalLongPatientDrivingDistance.Value},					
								{evalHighPaidDollarsPerPatient.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalHighPaidDollarsPerPatient.reason), 
								  evalHighPaidDollarsPerPatient.Value},					
								{evalHighPaidDollarsPerClaim.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalHighPaidDollarsPerClaim.reason),
								  evalHighPaidDollarsPerClaim.Value},					
								{evalHighNumberOfPatients.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalHighNumberOfPatients.reason),
								  evalHighNumberOfPatients.Value},					
								{evalHighNumberOfClaims.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalHighNumberOfClaims.reason),
								  evalHighNumberOfClaims.Value},						
								{evalHighPaidDollars.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalHighPaidDollars.reason),
								  evalHighPaidDollars.Value},						
								{evalInNetworkCurrentExclusion.reason, 
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkCurrentExclusion.reason),
									evalInNetworkCurrentExclusion.Value},					
								{evalInNetworkCurrentRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkCurrentRevocation.reason),
									evalInNetworkCurrentRevocation.Value},					
								{evalInNetworkPastExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkPastExclusion.reason),
									evalInNetworkPastExclusion.Value},					
								{evalInNetworkPastRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkPastRevocation.reason),
									evalInNetworkPastRevocation.Value},					
								{evalInNetworkCriminal.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkCriminal.reason),
									evalInNetworkCriminal.Value},						
								{evalInNetworkBankruptcy.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalInNetworkBankruptcy.reason),
									evalInNetworkBankruptcy.Value},						
								{evalOutNetworkCurrentExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkCurrentExclusion.reason),
									evalOutNetworkCurrentExclusion.Value},					
								{evalOutNetworkCurrentRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkCurrentRevocation.reason),
									evalOutNetworkCurrentRevocation.Value},					
								{evalOutNetworkPastExclusion.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkPastExclusion.reason),
									evalOutNetworkPastExclusion.Value},					
								{evalOutNetworkPastRevocation.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkPastRevocation.reason),
									evalOutNetworkPastRevocation.Value},					
								{evalOutNetworkCriminal.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkCriminal.reason),
									evalOutNetworkCriminal.Value},						
								{evalOutNetworkBankruptcy.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalOutNetworkBankruptcy.reason),
									evalOutNetworkBankruptcy.Value},					
								{evalRelativeCriminal.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalRelativeCriminal.reason),
									evalRelativeCriminal.Value},					
								{evalRelativeBankruptcy.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalRelativeBankruptcy.reason),
									evalRelativeBankruptcy.Value},
								{evalAssocCriminal.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalAssocCriminal.reason),
									evalAssocCriminal.Value},					
								{evalAssocBankruptcy.reason,
								  ComputeSuspectProviderAddressScore.ScoringAlgorithmsV3.GetReasonDescription(evalAssocBankruptcy.reason),
