import ML;
EXPORT macComputeSuspectProviderAddressScoreV1 (Infile, 
																									 LNPID = '',
																									 PrimaryRange = '',
																									 PreDirectional = '',
																									 PrimaryName = '',
																								  ...
																								  ExpiredLicenseNumber = '',
																									 ...
																									 PractiseState = '',
																									 PractiseZip5 = '',
																										CurrentStateExclusionImpactAmount,
																										CurrentOIGExclusionImpactAmount,
																										CurrentOPMExclusionImpactAmount,
																										PastStateExclusionImpactAmount,
																										PastOIGExclusionImpactAmount,
																										PastOPMExclusionImpactAmount,
																										CurrentRevoedMedicalLicenseImpactAmount,
																										PastRevokedMedicalLicenseImpactAmount,
																										ExpiredMedicalLicenseImpactAmount,
																										DeactivatedNPIImpactedAmount,
																										DeceasedPatientImpactAmount,
																										DeceasedProviderImpactAmount,
																										BankruptcyClaimImpactAmount,
																										FelonyConvictionImpactAmount,
    ...
    LOCAL ScoreLayout ScoreXForm(RECORDOF(Infile) L) := TRANSFORM
				...
				evalSingleAddress 								:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV1.EvalSingleAddress							(L.SingleAddressIndicator, SingleAddressSwitch, SingleAddressScore, L.NoOfProviderAtAddress, isSingleAddress);				
        ...
        evalStudentNPI 										:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV1.EvalStudentNPI								(L.TotalNPICount, L.StudentNPICount, StudentNPISwitch, StudentNPIScore);	
	        ...
	        // Score each element
				...
				/* Fix this line */
				evalReinstatedSanctionRevocation 	:= ComputeSuspectProviderAddressScore.ScoringAlgorithmsV1.EvalPastLicenseRevocation			(L.PastLicenseRevocation, PastLicenseRevocationSwitch, PastLicenseRevocationScore, L.LicenseRevocationReinstatedState, L.LicenseRevocationReinstatedDate, L.PastRevokedMedicalLicenseImpactAmount);				
        ...
        SELF.#EXPAND(appendPrefix + 'reasons') := join(reasonDS(reason != ''),ComputeSuspectProviderAddressScore.ScoringAlgorithmsV1.reasonDescriptions,left.reason = right.reasonCode,transform(ReasonLayout, self.description := right.description, SELF.Value := left.Value; self := left;));
