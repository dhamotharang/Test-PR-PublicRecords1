...
EXPORT ScoringAlgorithms := MODULE
    ...
    END;
		...
		EXPORT EvalDMEOutlier (STRING1 DMEHighPaidOutlierFlag, STRING1 DMESwitch,  UNSIGNED1 DMEScore, UNSIGNED2 OutlierRank, INTEGER4 HighPaidAmountPerPatient, INTEGER4 HighPaidAmountPerClaim, INTEGER4 DMEPatientMedian, INTEGER4 DMEClaimMedian) := FUNCTION

			STRING Value := IF(HighPaidAmountPerPatient > 0 OR HighPaidAmountPerClaim > 0 OR DMEPatientMedian > 0 OR DMEClaimMedian > 0, '(Paid/Patient:$' + (STRING) HighPaidAmountPerPatient + ', Median - $' + (STRING)DMEPatientMedian + ',' + 'Paid/Claim: $' + (STRING)HighPaidAmountPerClaim + ',' + 'Median - $' + (STRING)DMEClaimMedian + ')',''); 
    ...
    EXPORT EvalLABOutlier (STRING1 LabHighPaidOutlierFlag, STRING1 LABSwitch,  UNSIGNED1 LABScore, UNSIGNED2 OutlierRank, INTEGER4 HighPaidAmountPerPatient, INTEGER4 HighPaidAmountPerClaim, INTEGER4 LABPatientMedian, INTEGER4 LABClaimMedian) := FUNCTION

			STRING Value := IF(HighPaidAmountPerPatient > 0 OR HighPaidAmountPerClaim > 0 OR LABPatientMedian > 0 OR LABClaimMedian > 0, '(Paid/Patient:$' + (STRING) HighPaidAmountPerPatient + ', Median - $' + (STRING)LABPatientMedian + ',' + 'Paid/Claim: $' + (STRING)HighPaidAmountPerClaim + ',' + 'Median - $' + (STRING)LABClaimMedian + ')',''); 
    ...
    EXPORT EvalActiveStateExclusion (STRING1 ActiveStateExclusion, STRING1 ActiveStateExclusionSwitch,  UNSIGNED1 ActiveStateExclusionScore, STRING2 ActiveLicenseExclusionState = '', STRING8 ActiveLicenseExclusionDate = '') := FUNCTION

				STRING Value := IF(ActiveLicenseExclusionState <> '' AND ActiveLicenseExclusionDate <> '', '(' + ActiveLicenseExclusionDate[5..6] + '/' + ActiveLicenseExclusionDate[7..8] + '/' + ActiveLicenseExclusionDate[3..4] + ',' + ActiveLicenseExclusionState + ')',''); 
    ...
    EXPORT EvalActiveOIGExclusion (STRING1 ActiveOIGExclusion, STRING1 ActiveOIGExclusionSwitch,  UNSIGNED1 ActiveOIGExclusionScore, STRING8 ActiveOIGExclusionDate = '') := FUNCTION

				STRING Value := IF(ActiveOIGExclusionDate <> '', '(' + ActiveOIGExclusionDate[5..6] + '/' + ActiveOIGExclusionDate[7..8] + '/' + ActiveOIGExclusionDate[3..4] + ')',''); 
    ...
    EXPORT EvalActiveOPMExclusion (STRING1 ActiveOPMExclusion, STRING1 ActiveOPMExclusionSwitch,  UNSIGNED1 ActiveOPMExclusionScore, STRING8 ActiveOPMExclusionDate = '') := FUNCTION

				STRING Value := IF(ActiveOPMExclusionDate <> '', '(' + ActiveOPMExclusionDate[5..6] + '/' + ActiveOPMExclusionDate[7..8] + '/' + ActiveOPMExclusionDate[3..4] + ')',''); 
    ...
    EXPORT EvalActiveSanctionRevocation (STRING1 ActiveLicenseRevocation, STRING1 ActiveLicenseRevocationSwitch,  UNSIGNED1 ActiveLicenseRevocationScore, STRING2 ActiveLicenseRevocationState = '', STRING8 ActiveLicenseRevocationDate = '') := FUNCTION

				STRING Value := IF(ActiveLicenseRevocationState <> '' AND ActiveLicenseRevocationDate <> '', '(' + ActiveLicenseRevocationDate[5..6] + '/' + ActiveLicenseRevocationDate[7..8] + '/' + ActiveLicenseRevocationDate[3..4] + ',' + ActiveLicenseRevocationState + ')',''); 
    ...
    EXPORT EvalPastStateExclusion (STRING1 PastStateExclusion, STRING1 PastStateExclusionSwitch,  UNSIGNED1 PastStateExclusionScore, STRING2 PastStateExclusionState = '', STRING8 PastStateExclusionDate = '') := FUNCTION

				STRING Value := IF(PastStateExclusionState <> '' AND PastStateExclusionDate <> '', '(' + PastStateExclusionDate[5..6] + '/' + PastStateExclusionDate[7..8] + '/' + PastStateExclusionDate[3..4] + ',' + PastStateExclusionState + ')',''); 
    ...
    EXPORT EvalPastOIGExclusion (STRING1 PastOIGExclusion, STRING1 PastOIGExclusionSwitch,  UNSIGNED1 PastOIGExclusionScore, STRING8 PastOIGExclusionDate = '') := FUNCTION

				STRING Value := IF(PastOIGExclusionDate <> '', '(' + PastOIGExclusionDate[5..6] + '/' + PastOIGExclusionDate[7..8] + '/' + PastOIGExclusionDate[3..4] + ')',''); 
    ...
    EXPORT EvalPastOPMExclusion (STRING1 PastOPMExclusion, STRING1 PastOPMExclusionSwitch,  UNSIGNED1 PastOPMExclusionScore, STRING8 PastOPMExclusionDate = '') := FUNCTION

 				STRING Value := IF(PastOPMExclusionDate <> '', '(' + PastOPMExclusionDate[5..6] + '/' + PastOPMExclusionDate[7..8] + '/' + PastOPMExclusionDate[3..4] + ')',''); 
    ...
    EXPORT EvalPastLicenseRevocation (STRING1 PastLicenseRevocation, STRING1 PastLicenseRevocationSwitch,  UNSIGNED1 PastLicenseRevocationScore, STRING2 PastLicenseRevocationState = '', STRING8 PastLicenseRevocationDate = '') := FUNCTION

				STRING Value := IF(PastLicenseRevocationState <> '' AND PastLicenseRevocationDate <> '', '(' + PastLicenseRevocationDate[5..6] + '/' + PastLicenseRevocationDate[7..8] + '/' + PastLicenseRevocationDate[3..4] + ',' + PastLicenseRevocationState + ')',''); 
    ...
    EXPORT EvalLicenseExpired (STRING1 LicenseExpiredFlag, STRING1 LicenseExpiredSwitch,  UNSIGNED1 ExpiredLicenseScore, UNSIGNED4 iLicenseExpiredDate = 0, STRING25 LicenseExpired = '', STRING2 LicenseExpiredState = '', UNSIGNED8 TotalChargeAmount = 0) := FUNCTION
				STRING8 LicenseExpiredDate := INTFORMAT(iLicenseExpiredDate,8,1);
				STRING Value := IF(LicenseExpiredDate <> '' AND LicenseExpired <> '' AND LicenseExpiredState <> '', '(' + LicenseExpiredDate[5..6] + '/' + LicenseExpiredDate[7..8] + '/' + LicenseExpiredDate[3..4] + ',' + TRIM(LicenseExpired,ALL) + ',' + LicenseExpiredState + ')',''); 
    ...
    END;
		...
		EXPORT EvalDeceased (STRING1 DeceasedFlag, STRING8 DateofDeath, STRING1 DeceasedSwitch,  UNSIGNED1 DeceasedScore, UNSIGNED8 TotalChargeAmount = 0, UNSIGNED8 LNPID = 0) := FUNCTION		
				STRING8 DOD := DateOfDeath; //INTFORMAT (DateofDeath,8,1);
 				STRING Value := IF(DOD <> '' , '(' + DOD[5..6] + '/' + DOD[7..8] + '/' + DOD[3..4] + ')',''); 
    ...
    EXPORT EvalBankruptcy (STRING1 BankruptcyFlag, STRING1 BankruptcySwitch,  UNSIGNED1 BankruptcyScore, STRING8 BankruptcyDate = '', UNSIGNED8 LNPID = 0) := FUNCTION

 				STRING Value := IF(BankruptcyDate <> '' , '(' + TRIM(BankruptcyDate) + ')',''); 
    ...
    EXPORT EvalCriminalHistory (STRING1 CriminalHistoryFlag, STRING1 CriminalHistorySwitch,  UNSIGNED1 CriminalHistoryScore, STRING8 CriminalHistoryDate = '', UNSIGNED8 LNPID = 0) := FUNCTION
 				STRING Value := IF(CriminalHistoryDate <> '' , '(' + TRIM(CriminalHistoryDate) + ')',''); 
    ...
    EXPORT EvalDeceasedPatients (STRING1 DeceasedPatientsFlag, STRING1 DeceasedPatientsSwitch,  UNSIGNED1 DeceasedPatientsScore, UNSIGNED2 DeceasedPatientCount = 0, UNSIGNED2 PatientCount = 0, UNSIGNED4 PatientDOD = 0, UNSIGNED8 TotalChargeAmount = 0) := FUNCTION

				STRING8 DOD := INTFORMAT (PatientDOD,8,1);
 				STRING Value := IF(DOD <> '' AND DeceasedPatientCount > 0 AND PatientCount > 0, '(' + (STRING) DeceasedPatientCount + '/' + (STRING) PatientCount + ', ' + DOD[5..6] + '/' + DOD[7..8] + '/' + DOD[3..4] + ')',''); 
    ...
    END;
		...
		EXPORT EvalNPIDeactivated (STRING8 NPIDeactivatedFlag, STRING1 NPIDeactivatedSwitch,  UNSIGNED1 NPIDeactivatedScore, STRING8 NPIDeactivatedDate = '', UNSIGNED8 TotalChargeAmount = 0) := FUNCTION

				STRING Value := IF(NPIDeactivatedDate <> '', '(' + NPIDeactivatedDate[5..6] + '/' + NPIDeactivatedDate[7..8] + '/' + NPIDeactivatedDate[3..4] + ')',''); 
    ...
    END;
		...
		EXPORT EvalHighPaidDollarsPerPatient (STRING1 HighPaidDollarsPerPatientFlag, UNSIGNED1 FlagRank, STRING1 HighPaidDollarsPerPatientSwitch,  UNSIGNED1 HighPaidDollarsPerPatientScore, UNSIGNED8 PaidDollars, UNSIGNED8 MedianPaid) := FUNCTION

				STRING Value := IF(PaidDollars > 0, '($' + (STRING)PaidDollars + ', Median - $' + (STRING) MedianPaid + ')',''); 
    ...
    END;
		...
		EXPORT EvalHighPaidDollarsPerClaim (STRING1 HighPaidDollarsPerClaimFlag, UNSIGNED1 FlagRank, STRING1 HighPaidDollarsPerClaimSwitch, UNSIGNED1 HighPaidDollarsPerClaimScore, UNSIGNED8 PaidDollars, UNSIGNED8 MedianPaid) := FUNCTION
				STRING Value := IF(PaidDollars > 0, '($' + (STRING)PaidDollars + ', Median - $' + (STRING) MedianPaid + ')',''); 
				// STRING Value := IF(PaidDollars > 0 and MedianPaid > 0 , '($' + (STRING)PaidDollars + ', Median - $' + (STRING) MedianPaid + ')',''); 
    ...
    END;
		...
		EXPORT EvalHighNumberOfPatients (STRING1 HighNumberOfPatientsFlag, UNSIGNED1 FlagRank, STRING1 HighPatientSwitch,  UNSIGNED1 HighPatientScore, UNSIGNED2 PatientCount, UNSIGNED2 PatientMedian) := FUNCTION

				STRING Value := IF(PatientCount > 0, '(' + (STRING)PatientCount + ', Median - ' + (STRING) PatientMedian + ')',''); 
    ...
    END;
		...
		EXPORT EvalHighNumberOfClaims (STRING1 HighNumberOfClaimsFlag, UNSIGNED1 FlagRank, STRING1 HighNumberOfClaimsSwitch,  UNSIGNED1 HighNumberOfClaimsScore, UNSIGNED2 ClaimCount, UNSIGNED2 ClaimMedian) := FUNCTION

				STRING Value := IF(ClaimCount > 0, '(' + (STRING)ClaimCount + ', Median - ' + (STRING) ClaimMedian + ')',''); 
    ...
    END;
		...
		EXPORT EvalHighPaidDollars (STRING1 HighPaidDollarsFlag, UNSIGNED1 FlagRank, STRING1 HighPaidDollarsSwitch,  UNSIGNED1 HighPaidDollarsScore, UNSIGNED8 ChargeAmount, UNSIGNED8 PaidAmount, UNSIGNED2 HighPaidDollarsMedian) := FUNCTION
				PaidPercent := ROUND((PaidAmount * 100) / ChargeAmount);
				STRING Value := IF(ChargeAmount > 0 and PaidAmount > 0, '($' + (STRING)ChargeAmount + ', $' + (STRING) PaidAmount + ',' + (STRING) PaidPercent + '%, Median - $' + (STRING) HighPaidDollarsMedian + ')',''); 
