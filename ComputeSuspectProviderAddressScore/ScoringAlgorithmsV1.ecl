...
EXPORT ScoringAlgorithmsV1 := MODULE
    ...
    EXPORT EvalPastLicenseRevocation (STRING1 PastLicenseRevocation, STRING1 PastLicenseRevocationSwitch,  UNSIGNED1 PastLicenseRevocationScore, STRING2 PastLicenseRevocationState = '', STRING8 PastLicenseRevocationDate = '', INTEGER8 PastLicenseImpactAmount) := FUNCTION

				STRING Value := IF(PastLicenseRevocationState <> '' AND PastLicenseRevocationDate <> '', '(' + PastLicenseRevocationDate[5..6] + '/' + PastLicenseRevocationDate[7..8] + '/' + PastLicenseRevocationDate[3..4] + ', 00/00/00 ' + PastLicenseRevocationState + ' ,$' + PastLicenseImpactAmount + ')','(00/00/00, 00/00/00, ' + PastLicenseRevocationState + ',6MPRIORREINST-$' + PastLicenseImpactAmount + ')'); 
