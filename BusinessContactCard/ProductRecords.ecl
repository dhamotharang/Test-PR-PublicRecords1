...
EXPORT ProductRecords := MODULE
    ...
    // Suppression from opt_out key, project back to original layout.
    gong_records_ant_suppressed := Suppress.MAC_SuppressSource(_gong_records_acctno_no_timezone, mod_access);
