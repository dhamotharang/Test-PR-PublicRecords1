...
tag:='~';
ds_curr := dataset(tag + 'scoringqa::out::fcra::bocashell_54_historydate_999999_prod_' + dt + '_1', Scoring_Project_Macros.Global_Output_Layouts.BocaShell_Global_Layout, thor)(length(trim(errorcode,left,right))= 0 );
