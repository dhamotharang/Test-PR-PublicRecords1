EXPORT BocaShell_54_Prod_Tracking_DailyReport := FUNCTION
//making new
...
tag:='~';
ds_curr := distribute(dataset(tag + 'scoringqa::out::fcra::bocashell_54_historydate_999999_prod_' + dt + '_1', Scoring_Project_Macros.Global_Output_Layouts.BocaShell_Global_Layout, thor)(length(trim(errorcode,left,right))= 0 ),(integer)AccountNumber);
...
nonfcra_ds_curr := dataset(tag + 'scoringqa::out::nonfcra::bocashell_54_historydate_999999_prod_' + dt + '_1', Scoring_Project_Macros.Global_Output_Layouts.BocaShell_Global_Layout, thor)(length(trim(errorcode,left,right))= 0 );
...
nonfcra_filenames_details :=  nothor(STD.File.LogicalFileList('scoringqa::out::nonfcra::bocashell_54_historydate_999999_prod_*_1'));
