...
EXPORT Append_Ids := MODULE
	...
	// -- Standardizes names
	//////////////////////////////////////////////////////////////////////////////////////
	EXPORT fAppendDid(DATASET(Infutor_NARB.Layouts.Base) pDataset) :=	FUNCTION

		Infutor_NARB.Layouts.Temp.UniqueId tAddUniqueId(Infutor_NARB.Layouts.Base L, UNSIGNED8 cnt) :=	TRANSFORM
			SELF.unique_id		:= cnt;
			SELF							:= L;
		END;   
    ...
    Infutor_NARB.Layouts.Temp.DidSlim taddDID(Infutor_NARB.Layouts.Temp.UniqueId L) :=  TRANSFORM
	    SELF.fname            := L.fname;
	    SELF.mname            := L.mname;
	    SELF.lname            := L.lname;
    ...
    did_Add.MAC_Match_Flex(
	    ...
	    prim_range,                          //Prim_range  
			...
			phone,                               //Phone
	    did,   			                         //DID
	    Infutor_NARB.Layouts.Temp.DidSlim,   //Output rec layout
    ...
    dGoodDIDs := DISTRIBUTE(postDID(did != 0), unique_id);
		...
		Infutor_NARB.Layouts.Base tAssignDIDs(Infutor_NARB.Layouts.Temp.UniqueId L,Infutor_NARB.Layouts.Temp.DidSlim R) := TRANSFORM
			SELF.did          := R.did;
	...
	// -- Creates the linkIDs
	//////////////////////////////////////////////////////////////////////////////////////
	EXPORT fAppendBIP(DATASET(Infutor_NARB.Layouts.Base) pDataset) :=	FUNCTION
		...
		//////////////////////////////////////////////////////////////////////////////////////
		Infutor_NARB.Layouts.Temp.BIPSlim tSlimForBIPing(Infutor_NARB.Layouts.Temp.UniqueId L) := TRANSFORM
    ...
    dSlimInput	:= project(dAddUniqueId(clean_company_name <> '') ,tSlimForBIPing(LEFT));
		...
		Business_Header_SS.MAC_Add_BDID_Flex(
			...
			,fein_not_used                        // fein              
			,bdid_not_used 								        // bdid												
			,Infutor_NARB.Layouts.Temp.BIPSlim    // Output Layout 
    ...
    dBIP_dist           := DISTRIBUTE(dBIPOut(Ultid 	!= 0 OR 
		...
		Infutor_NARB.Layouts.Base tAssignLinkids(Infutor_NARB.Layouts.Temp.UniqueId L,Infutor_NARB.Layouts.Temp.BIPSlim R) := TRANSFORM
			SELF.Ultid				:= R.Ultid;
	...
	EXPORT fAll(DATASET(Infutor_NARB.Layouts.Base) pDataset, STRING pversion) := FUNCTION
