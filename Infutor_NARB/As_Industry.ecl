...
SKIP((C = 2 AND L.sic2[1..8] in ['',L.sic1[1..8] ])                           OR
     ...
     (C = 4 AND L.sic4[1..8] in ['',L.sic1[1..8],L.sic2[1..8],L.sic3[1..8] ]) OR
     (C = 5 AND L.sic5[1..8] in ['',L.sic1[1..8],L.sic2[1..8],L.sic3[1..8],L.sic4[1..8] ]))
  ...
  SELF.DotWeight								:=	L.DotWeight;	
	...
	SELF.siccode       						:=	CHOOSE(C, L.sic1[1..8], L.sic2[1..8], L.sic3[1..8], L.sic4[1..8], L.sic5[1..8]);
