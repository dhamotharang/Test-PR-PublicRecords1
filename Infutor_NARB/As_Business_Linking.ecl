...
EXPORT As_Business_Linking (
	...
	,boolean IsPersist = true
		...
		business_header.layout_business_linking.linking_interface	trfMapBLInterface(Infutor_NARB.layouts.Base l) := transform																				
				...
				self.company_sic_code1           := l.sic1[1..8];
				self.company_sic_code2           := l.sic2[1..8];
				self.company_sic_code3           := l.sic3[1..8];
				self.company_sic_code4           := l.sic4[1..8];
				self.company_sic_code5           := l.sic5[1..8];
