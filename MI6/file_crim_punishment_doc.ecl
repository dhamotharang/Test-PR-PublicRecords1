...
export file_crim_punishment_doc := DATASET('~thor_data400::base::crim_punishment_' + crim_common.Version_Development,Crim_Common.Layout_In_DOC_Punishment.previous,FLAT);
