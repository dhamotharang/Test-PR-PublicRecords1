...
#workunit('name','Scrubs_PCNSR.BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_PCNSR,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_PCNSR.In_PCNSR;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_PCNSR.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_PCNSR'),NAMED('OptimizedLayout'));// File layout suggested by data
