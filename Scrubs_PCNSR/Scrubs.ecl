...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 74;
  EXPORT NumRulesFromFieldType := 74;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 74;
...
EXPORT FromNone(DATASET(Layout_PCNSR) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.title_Invalid << 0 ) + ( le.fname_Invalid << 1 ) + ( le.mname_Invalid << 2 ) + ( le.lname_Invalid << 3 ) + ( le.name_suffix_Invalid << 4 ) + ( le.name_score_Invalid << 5 ) + ( le.fname_orig_Invalid << 6 ) + ( le.mname_orig_Invalid << 7 ) + ( le.lname_orig_Invalid << 8 ) + ( le.name_suffix_orig_Invalid << 9 ) + ( le.title_orig_Invalid << 10 ) + ( le.st_Invalid << 11 ) + ( le.zip_Invalid << 12 ) + ( le.zip4_Invalid << 13 ) + ( le.cart_Invalid << 14 ) + ( le.cr_sort_sz_Invalid << 15 ) + ( le.lot_Invalid << 16 ) + ( le.lot_order_Invalid << 17 ) + ( le.dbpc_Invalid << 18 ) + ( le.chk_digit_Invalid << 19 ) + ( le.rec_type_Invalid << 20 ) + ( le.county_Invalid << 21 ) + ( le.geo_lat_Invalid << 22 ) + ( le.geo_long_Invalid << 23 ) + ( le.msa_Invalid << 24 ) + ( le.geo_blk_Invalid << 25 ) + ( le.geo_match_Invalid << 26 ) + ( le.err_stat_Invalid << 27 ) + ( le.hhid_Invalid << 28 ) + ( le.did_Invalid << 29 ) + ( le.did_score_Invalid << 30 ) + ( le.phone_fordid_Invalid << 31 ) + ( le.gender_Invalid << 32 ) + ( le.date_of_birth_Invalid << 33 ) + ( le.address_type_Invalid << 34 ) + ( le.demographic_level_indicator_Invalid << 35 ) + ( le.length_of_residence_Invalid << 36 ) + ( le.location_type_Invalid << 37 ) + ( le.dqi2_occupancy_count_Invalid << 38 ) + ( le.delivery_unit_size_Invalid << 39 ) + ( le.household_arrival_date_Invalid << 40 ) + ( le.area_code_Invalid << 41 ) + ( le.phone_number_Invalid << 42 ) + ( le.telephone_number_type_Invalid << 43 ) + ( le.phone2_number_Invalid << 44 ) + ( le.telephone2_number_type_Invalid << 45 ) + ( le.time_zone_Invalid << 46 ) + ( le.refresh_date_Invalid << 47 ) + ( le.name_address_verification_source_Invalid << 48 ) + ( le.drop_indicator_Invalid << 49 ) + ( le.do_not_mail_flag_Invalid << 50 ) + ( le.do_not_call_flag_Invalid << 51 ) + ( le.business_file_hit_flag_Invalid << 52 ) + ( le.spouse_title_Invalid << 53 ) + ( le.spouse_fname_Invalid << 54 ) + ( le.spouse_mname_Invalid << 55 ) + ( le.spouse_lname_Invalid << 56 ) + ( le.spouse_name_suffix_Invalid << 57 ) + ( le.spouse_fname_orig_Invalid << 58 ) + ( le.spouse_mname_orig_Invalid << 59 ) + ( le.spouse_lname_orig_Invalid << 60 ) + ( le.spouse_name_suffix_orig_Invalid << 61 ) + ( le.spouse_title_orig_Invalid << 62 ) + ( le.spouse_date_of_birth_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.find_income_in_1000s_Invalid << 0 ) + ( le.phhincomeunder25k_Invalid << 1 ) + ( le.phhincome50kplus_Invalid << 2 ) + ( le.phhincome200kplus_Invalid << 3 ) + ( le.medianhhincome_Invalid << 4 ) + ( le.own_rent_Invalid << 5 ) + ( le.homeowner_source_code_Invalid << 6 ) + ( le.telephone_acquisition_date_Invalid << 7 ) + ( le.recency_date_Invalid << 8 ) + ( le.source_Invalid << 9 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.fname_orig_Invalid := (le.ScrubsBits1 >> 6) & 1;
    SELF.mname_orig_Invalid := (le.ScrubsBits1 >> 7) & 1;
    SELF.lname_orig_Invalid := (le.ScrubsBits1 >> 8) & 1;
    SELF.name_suffix_orig_Invalid := (le.ScrubsBits1 >> 9) & 1;
    SELF.title_orig_Invalid := (le.ScrubsBits1 >> 10) & 1;
    SELF.st_Invalid := (le.ScrubsBits1 >> 11) & 1;
    SELF.zip_Invalid := (le.ScrubsBits1 >> 12) & 1;
    SELF.zip4_Invalid := (le.ScrubsBits1 >> 13) & 1;
    SELF.cart_Invalid := (le.ScrubsBits1 >> 14) & 1;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits1 >> 15) & 1;
    SELF.lot_Invalid := (le.ScrubsBits1 >> 16) & 1;
    SELF.lot_order_Invalid := (le.ScrubsBits1 >> 17) & 1;
    SELF.dbpc_Invalid := (le.ScrubsBits1 >> 18) & 1;
    SELF.chk_digit_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.rec_type_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.county_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.geo_lat_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.geo_long_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.msa_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.geo_blk_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.geo_match_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.err_stat_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.hhid_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.did_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.did_score_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.phone_fordid_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.gender_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.date_of_birth_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.address_type_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.demographic_level_indicator_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.length_of_residence_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.location_type_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.dqi2_occupancy_count_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.delivery_unit_size_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.household_arrival_date_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.area_code_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.phone_number_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.telephone_number_type_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.phone2_number_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.telephone2_number_type_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.time_zone_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.refresh_date_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.name_address_verification_source_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.drop_indicator_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.do_not_mail_flag_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.do_not_call_flag_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.business_file_hit_flag_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.spouse_title_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.spouse_fname_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.spouse_mname_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.spouse_lname_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.spouse_name_suffix_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.spouse_fname_orig_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.spouse_mname_orig_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.spouse_lname_orig_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.spouse_name_suffix_orig_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.spouse_title_orig_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.spouse_date_of_birth_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.find_income_in_1000s_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.phhincomeunder25k_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.phhincome50kplus_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.phhincome200kplus_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.medianhhincome_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.own_rent_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.homeowner_source_code_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.telephone_acquisition_date_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.recency_date_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.source_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  END;
  EXPORT AllErrors := NORMALIZE(h,74,Into(LEFT,COUNTER));
