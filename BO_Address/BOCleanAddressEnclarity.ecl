...
export BOCleanAddressEnclarity (const string line1,const string line2,
							const string server = BO_Address.BO_Server, 
							unsigned2 port = BO_Address.BO_Port)	:= FUNCTION

//	CorrectPort := 11200; 
//	CorrectServer := 'postalclean18';
string send_payload := '<transaction><command_name>cleanaddress182Enclarity</command_name><parameters>' +
