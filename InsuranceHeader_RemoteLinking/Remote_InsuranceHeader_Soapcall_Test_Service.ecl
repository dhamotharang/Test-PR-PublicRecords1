...
EXPORT Remote_InsuranceHeader_Soapcall_Test_Service := MACRO
  ...
  InsuranceHeader_RemoteLinking.Layouts.ServiceInputLayout Inquiry_Data() := TRANSFORM
    SELF.Inquiry_Lexid := Input_Inquiry_Lexid;
    SELF.Results_Lexid := Input_Results_Lexid;
    SELF.VENDOR_ID_1 := Input_VENDOR_ID_1;
    SELF.BOCA_DID_1 := Input_BOCA_DID_1;
    SELF.SRC_1 := Input_SRC_1;
    SELF.SSN_1 := Input_SSN_1;
    SELF.DOB_1 := Input_DOB_1;
    SELF.SNAME_1 := Input_SNAME_1;
    SELF.FNAME_1 := Input_FNAME_1;
    SELF.MNAME_1 := Input_MNAME_1;
    SELF.LNAME_1 := Input_LNAME_1;
    SELF.GENDER_1 := Input_GENDER_1;
    SELF.DERIVED_GENDER_1 := Input_DERIVED_GENDER_1;
    SELF.PRIM_NAME_1 := Input_PRIM_NAME_1;
    SELF.PRIM_RANGE_1 := Input_PRIM_RANGE_1;
    SELF.SEC_RANGE_1 := Input_SEC_RANGE_1;
    SELF.CITY_1 := Input_CITY_1;
    SELF.ST_1 := Input_ST_1;
    SELF.ZIP_1 := Input_ZIP_1;
    SELF.POLICY_NUMBER_1 := Input_POLICY_NUMBER_1;
    SELF.CLAIM_NUMBER_1 := Input_CLAIM_NUMBER_1;
    SELF.DT_FIRST_SEEN_1 := Input_DT_FIRST_SEEN_1;
    SELF.DT_LAST_SEEN_1 := Input_DT_LAST_SEEN_1;
    SELF.DL_STATE_1 := Input_DL_STATE_1;
    SELF.DL_NBR_1 := Input_DL_NBR_1;
    SELF.AMBEST_1 := Input_AMBEST_1;
    SELF.VENDOR_ID_2 := Input_VENDOR_ID_2;
    SELF.BOCA_DID_2 := Input_BOCA_DID_2;
    SELF.SRC_2 := Input_SRC_2;
    SELF.SSN_2 := Input_SSN_2;
    SELF.DOB_2 := Input_DOB_2;
    SELF.SNAME_2 := Input_SNAME_2;
    SELF.FNAME_2 := Input_FNAME_2;
    SELF.MNAME_2 := Input_MNAME_2;
    SELF.LNAME_2 := Input_LNAME_2;
    SELF.GENDER_2 := Input_GENDER_2;
    SELF.DERIVED_GENDER_2 := Input_DERIVED_GENDER_2;
    SELF.PRIM_NAME_2 := Input_PRIM_NAME_2;
    SELF.PRIM_RANGE_2 := Input_PRIM_RANGE_2;
    SELF.SEC_RANGE_2 := Input_SEC_RANGE_2;
    SELF.CITY_2 := Input_CITY_2;
    SELF.ST_2 := Input_ST_2;
    SELF.ZIP_2 := Input_ZIP_2;
    SELF.POLICY_NUMBER_2 := Input_POLICY_NUMBER_2;
    SELF.CLAIM_NUMBER_2 := Input_CLAIM_NUMBER_2;
    SELF.DT_FIRST_SEEN_2 := Input_DT_FIRST_SEEN_2;
    SELF.DT_LAST_SEEN_2 := Input_DT_LAST_SEEN_2;
    SELF.DL_STATE_2 := Input_DL_STATE_2;
    SELF.DL_NBR_2 := Input_DL_NBR_2;
    SELF.AMBEST_2 := Input_AMBEST_2;
  END;
