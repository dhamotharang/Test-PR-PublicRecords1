...
/*HACK-O-MATIC*/ SHARED thin_table := DISTRIBUTE(TABLE(h00,{RID,VENDOR_ID,BOCA_DID,SRC,SSN,SSN_len,DOB_year,DOB_month,DOB_day,DL_NBR,SNAME,FNAME,FNAME_len,MNAME,MNAME_len,LNAME,LNAME_len,GENDER,DERIVED_GENDER,PRIM_NAME,PRIM_RANGE,SEC_RANGE,CITY,ST,ZIP,POLICY_NUMBER,CLAIM_NUMBER,DT_FIRST_SEEN,DT_LAST_SEEN,MAINNAME,ADDR1,LOCALE,ADDRESS,FULLNAME,DL_STATE,AMBEST,DID,REMID,REMLEXID,REMFLAG}),HASH(DID));
  Grpd := GROUP( SORT(
    DISTRIBUTE( TABLE( thin_table, { thin_table, UNSIGNED2 Buddies := 0 }),HASH(DID)),
    /*HACK-O-MATIC*/ DID,SSN,DOB_year,DOB_month,DOB_day,DL_NBR,SNAME,FNAME,MNAME,LNAME,GENDER,DERIVED_GENDER,PRIM_NAME,PRIM_RANGE,SEC_RANGE,CITY,ST,ZIP,POLICY_NUMBER,CLAIM_NUMBER,DT_FIRST_SEEN,DT_LAST_SEEN,REMID,LOCAL),
    /*HACK-O-MATIC*/ DID,SSN,DOB_year,DOB_month,DOB_day,DL_NBR,SNAME,FNAME,MNAME,LNAME,GENDER,DERIVED_GENDER,PRIM_NAME,PRIM_RANGE,SEC_RANGE,CITY,ST,ZIP,POLICY_NUMBER,CLAIM_NUMBER,DT_FIRST_SEEN,DT_LAST_SEEN,REMID,LOCAL);
