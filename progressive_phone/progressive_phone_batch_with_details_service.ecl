...
export progressive_phone_batch_with_details_service := macro
  ...
  f_out := PROJECT(addrbest.Progressive_phone_common(
    f_in_raw, 
    ,
    ,
    gateways_in, 
  ...
  results_with_qsent := progressive_phone.FN_AppendQSentDetails(f_in_raw, ungroup(results_without_qsent), mod_access, QSENTV2_GW, QSentV2_SearchType);
