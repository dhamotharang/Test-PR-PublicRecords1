...
results_1 := progressive_phone.FN_BatchFinalAssignments(f_out_temp_1, Progressive_Phone.Layout_Progressive_phones.common_with_meta_rec, UsePremiumSource_A, scoreModel);
