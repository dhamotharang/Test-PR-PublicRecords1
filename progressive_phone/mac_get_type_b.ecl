...
#uniquename(pre_f_b_out_ready)
#uniquename(f_b_out_ready_optout)
#uniquename(f_b_out_ready)
%pre_f_b_out_ready% := join(%f_to_match%, %gong_addr_key%,
...
%f_b_out_ready_optout% := Suppress.MAC_SuppressSource(%pre_f_b_out_ready%, mod_access, key_did);
%f_b_out_ready% := PROJECT(%f_b_out_ready_optout%, progressive_phone.layout_progressive_batch_out_with_did)
 + %f_b_out_from_blue%;
