...
EXPORT functions := MODULE
  ...
  EXPORT GetPhonesV1(DATASET(progressive_phone.layout_progressive_batch_in) f_in_raw,
    ...
    progressive_phone.mac_get_type_a(f_in_batch_for_a, f_out_type_a_pre, mod_access);
    progressive_phone.mac_get_type_b(f_with_did, f_in_batch, f_out_type_b, mod_access);
    progressive_phone.mac_get_type_c(f_with_did, f_in_batch, f_out_type_c, mod_access, inMod.IncludeLandlordPhones);
