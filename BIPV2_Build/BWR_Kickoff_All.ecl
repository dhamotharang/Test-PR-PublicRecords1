...
eclcodepre  := 
 ...
 + 'Lgid3NumIterations    := 7                    ;//For S47, use 15 and will back to 8 after S47!!! change from 4 to 10 after 2/16/2016 BIP meeting. changed to 15 according to Verns email 4/20/2016; change to 8 on 20161215\n'
 ...
 + 'SkipProxidUnderlinks  := SkipProxPost         ;\n'
 + 'SkipHierarchy         := SkipProxidUnderlinks ;\n'
 ...
 + '  ,pSkipProxidUnderlinks  := SkipProxidUnderlinks\n'
 ...
 + '  ,pSkipCleanCommonBase   := SkipCleanCommonBase\n'
 ...
 + '  ,pSkipCopyToAlphaProd   := SkipCopyToAlphaProd\n'
