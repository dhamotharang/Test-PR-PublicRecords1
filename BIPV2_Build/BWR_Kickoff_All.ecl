...
eclcodepre  := 
 ...
 + 'DotNumIterations      := 2                     ;\n //2 is minimum, max of 3, convergence threshold of 99.99' 
 + 'ProxNumIterations     := 2                     ;\n'
 + 'ProxMj6NumIterations  := 3                     ;\n'
 + 'ProxPostNumIterations := 1                     ; //added 1 more iteration for more convergence 6/20/2017\n'
 + 'Lgid3NumIterations    := 7                     ;//for S76, lower to 7, but that is minimum.  max is still 15, convergence threshold 99.999.  For S47, use 15 and will back to 8 after S47!!! change from 4 to 10 after 2/16/2016 BIP meeting. changed to 15 according to Verns email 4/20/2016; change to 8 on 20161215\n'
 ...
 + 'SkipXlink             := SkipCleanCommonBase  ; // -- Thread 1\n'
