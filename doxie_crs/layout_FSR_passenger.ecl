export layout_FSR_passenger := record
	string1   rec_type_5,
	...
	string3   score,
	string25  cname,
	string40 passenger_injury_sev_name;
	string40 first_passenger_safe_name;
	string40 second_passenger_safe_name;
	string10 passenger_eject_code_name;
	string17 PASSENGER_LOCATION_name;
