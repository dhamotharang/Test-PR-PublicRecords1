export layout_FSR_pedestrian := record
	string1   rec_type_6,
  ...
  string25  ped_race_desc; //string1 ped_race
  string8   ped_sex_desc;  //string1 ped_sex
  // DESCRIPTIONS NOT IN KEY
	string50 ped_action_name;
	string10 ped_sex_name;
	string10 ped_race_name;
end;