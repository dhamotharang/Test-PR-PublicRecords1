export layout_FSR_vehicle := record
	string1   rec_type_2,
  ...
  string20  vehicle_type_desc,     //string1 vehicle_type
  string15  direction_travel_desc, //string1 direction_travel
  string30  point_of_impact_desc,  //string2 point_of_impact
  string30  vehicle_use_desc,      //string2 vehicle_use
  // DESCRIPTIONS NOT IN KEY
	string40  Vehicle_Type_Name,
	string25	Vehicle_Reg_State_Name,
	string30	Direction_Travel_Name,
	string30	Damage_Type_Name,
	string10	Vehicle_Owner_Sex_Name,
	string10	Vehicle_Owner_Race_Name,
	string40	Point_of_Impact_Name,
	string40	Vehicle_Movement_Name,
	string40	Vehs_First_Defect_Name,
	string40	Vehs_Second_Defect_Name,
	string100	Moving_Violation_Name,
	string30	Vehicle_Fault_Code_Name,
	string10  vehicle_fr_code_name,
	string30  vehicle_insur_code_name,
	string20  vehicle_driver_action_name,
	string30  vehicle_owner_driver_code_name,
	string30  how_removed_code_name,
	string18  county_name,
	string50	hazard_material_transport_Name,
	string40  vehicle_use_Name,
	string3   placarded_Name,
	string25  vehicle_roadway_loc_name,
  string32  vehicle_function_name;
	string12  did,
end;