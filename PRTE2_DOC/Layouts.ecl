Import hygenics_crim, corrections, address, Criminal_Records, ut, doxie,PRTE2_crim_offense_cat ;
EXPORT Layouts := module

Export base_layout:= PRTE2_crim_offense_cat.layouts.base_layout;
