...
EXPORT input_file := h0 : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::Specificities_Cache',EXPIRE(30));
//We have LNPID specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LNPID;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LNPID,LOCAL) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::Cluster_Sizes',EXPIRE(30));
EXPORT TotalClusters := COUNT(ClusterSizes);
SHARED  FNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::FNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT FNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::FNAME_temp',EXPIRE(30));
SHARED  MNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::MNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT MNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::MNAME_temp',EXPIRE(30));
SHARED  LNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::LNAME',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT LNAME_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::LNAME_temp',EXPIRE(30));
SHARED  SNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::SNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  GENDER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,GENDER) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::GENDER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PRIM_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_RANGE) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::PRIM_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PRIM_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PRIM_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::PRIM_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SEC_RANGE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SEC_RANGE) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::SEC_RANGE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  V_CITY_NAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,V_CITY_NAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::V_CITY_NAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ST_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ST) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::ST',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ZIP_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ZIP) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::ZIP',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SSN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SSN) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::SSN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_SSN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_SSN) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::CNSMR_SSN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DOB_year_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_year) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::DOB_year',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DOB_month_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_month) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::DOB_month',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DOB_day_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DOB_day) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::DOB_day',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_year_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_year) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::CNSMR_DOB_year',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_month_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_month) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::CNSMR_DOB_month',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  CNSMR_DOB_day_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,CNSMR_DOB_day) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::CNSMR_DOB_day',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  PHONE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,PHONE) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::PHONE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LIC_STATE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LIC_STATE) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::LIC_STATE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  C_LIC_NBR_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,C_LIC_NBR) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::C_LIC_NBR',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  TAX_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,TAX_ID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::TAX_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BILLING_TAX_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BILLING_TAX_ID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::BILLING_TAX_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DEA_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DEA_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::DEA_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  VENDOR_ID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,VENDOR_ID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::VENDOR_ID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  NPI_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,NPI_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::NPI_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BILLING_NPI_NUMBER_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BILLING_NPI_NUMBER) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::BILLING_NPI_NUMBER',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  UPIN_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,UPIN) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::UPIN',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  DID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,DID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::DID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  BDID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,BDID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::BDID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SRC_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SRC) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::SRC',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  SOURCE_RID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,SOURCE_RID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::SOURCE_RID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  RID_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,RID) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::RID',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  MAINNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,MAINNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::MAINNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  FULLNAME_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,FULLNAME) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::FULLNAME',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDR1_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDR1) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::ADDR1',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  LOCALE_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,LOCALE) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::LOCALE',EXPIRE(30)); // Reduce to field values by UID
...
SHARED  ADDRESS_deduped := SALT29.MAC_Field_By_UID(input_file,LNPID,ADDRESS) : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::dedups::ADDRESS',EXPIRE(30)); // Reduce to field values by UID
...
EXPORT FNAME_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::FNAME',EXPIRE(30));
...
EXPORT MNAME_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::MNAME',EXPIRE(30));
...
EXPORT LNAME_values_persisted := ofile : PERSIST('~temp::LNPID::PRTE_Health_Provider_Services::values::LNAME',EXPIRE(30));
