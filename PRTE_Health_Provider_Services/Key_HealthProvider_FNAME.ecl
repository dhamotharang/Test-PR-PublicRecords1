...
EXPORT KeyName := PRTE_Health_Provider_Services.Files.FILE_FName;  //'~'+'key::PRTE_Health_Provider_Services::LNPID::Refs::FNAME';
...
#IF(#TEXT(Input_LNAME)<>'' AND #TEXT(Input_ST)<>'')
  #uniquename(trans)
  PRTE_Health_Provider_Services.Key_HealthProvider_FNAME.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := PRTE_Health_Provider_Services.Key_HealthProvider_FNAME.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
