...
EXPORT KeyName := PRTE_Health_Provider_Services.Files.FILE_DEA; //'~'+'key::PRTE_Health_Provider_Services::LNPID::Refs::DEA';
...
#IF(#TEXT(Input_DEA_NUMBER)<>'')
  #uniquename(trans)
  PRTE_Health_Provider_Services.Key_HealthProvider_DEA.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := PRTE_Health_Provider_Services.Key_HealthProvider_DEA.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
