...
EXPORT KeyName := PRTE_Health_Provider_Services.Files.FILE_PHONE; //'~'+'key::PRTE_Health_Provider_Services::LNPID::Refs::PHONE_LP';
...
#IF(#TEXT(Input_PHONE)<>'')
  #uniquename(trans)
  PRTE_Health_Provider_Services.Key_HealthProvider_PHONE_LP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := PRTE_Health_Provider_Services.Key_HealthProvider_PHONE_LP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
