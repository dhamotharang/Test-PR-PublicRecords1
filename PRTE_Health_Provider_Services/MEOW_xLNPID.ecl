...
Process_xLNPID_Layouts.OutputLayout GetResults(Process_xLNPID_Layouts.InputLayout le) := TRANSFORM
  ...
  SELF.Results := TOPN(ROLLUP(IF ( Process_xLNPID_Layouts.HardKeyMatch(le) ,
    MERGE(
    SORTED(Key_HealthProvider_NAMEL.ScoredLNPIDFetch(le.LNAME,le.ST,le.C_LIC_NBR,le.FNAME,le.GENDER,le.SNAME,le.MNAME,le.PRIM_RANGE,le.PRIM_NAME,le.SEC_RANGE,le.V_CITY_NAME,le.ZIP,(UNSIGNED4)le.DOB,le.LIC_STATE,le.NPI_NUMBER,le.BILLING_TAX_ID),LNPID)
    ...
    ,SORTED(Key_HealthProvider_NAMED.ScoredLNPIDFetch(le.LNAME,le.ZIP,le.C_LIC_NBR,le.FNAME,le.GENDER,le.SNAME,le.MNAME,le.PRIM_RANGE,le.PRIM_NAME,le.SEC_RANGE,le.V_CITY_NAME,le.ST,(UNSIGNED4)le.DOB,le.LIC_STATE,le.NPI_NUMBER,le.BILLING_TAX_ID),LNPID)
    ...
    ,SORTED(Key_HealthProvider_MNAME.ScoredLNPIDFetch(le.LNAME,le.MNAME,le.ST,le.GENDER,le.SNAME,le.FNAME,le.PRIM_RANGE,le.PRIM_NAME,le.SEC_RANGE,le.V_CITY_NAME,le.ZIP,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE,le.NPI_NUMBER,le.BILLING_TAX_ID),LNPID)
    ,SORTED(Key_HealthProvider_ADDRESS.ScoredLNPIDFetch(le.PRIM_RANGE,le.PRIM_NAME,le.ZIP,le.SEC_RANGE,le.FNAME,le.V_CITY_NAME,le.ST,le.GENDER,le.LNAME,le.MNAME,le.SNAME,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE,le.BILLING_TAX_ID),LNPID)
    ,SORTED(Key_HealthProvider_ZIP_PR.ScoredLNPIDFetch(le.PRIM_NAME,le.ZIP,le.FNAME,le.PRIM_RANGE,le.SEC_RANGE,le.V_CITY_NAME,le.ST,le.GENDER,le.LNAME,le.MNAME,le.SNAME,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE,le.BILLING_TAX_ID),LNPID)
    ,SORTED(Key_HealthProvider_SSN_LP.ScoredLNPIDFetch(le.SSN,le.FNAME,le.MNAME,le.LNAME,le.V_CITY_NAME,le.ST,le.GENDER,le.SNAME,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_CNSMR_SSN_LP.ScoredLNPIDFetch(le.CNSMR_SSN,le.FNAME,le.MNAME,le.LNAME,le.V_CITY_NAME,le.ST,le.GENDER,le.SNAME,(UNSIGNED4)le.CNSMR_DOB),LNPID)
    ,SORTED(Key_HealthProvider_DOB_LP.ScoredLNPIDFetch((UNSIGNED4)le.DOB,le.FNAME,le.LNAME,le.MNAME,le.ST,le.V_CITY_NAME,le.SSN,le.GENDER,le.SNAME),LNPID)
    ,SORTED(Key_HealthProvider_CNSMR_DOB_LP.ScoredLNPIDFetch((UNSIGNED4)le.CNSMR_DOB,le.FNAME,le.LNAME,le.MNAME,le.ST,le.V_CITY_NAME,le.CNSMR_SSN,le.GENDER,le.SNAME),LNPID)
    ,SORTED(Key_HealthProvider_PHONE_LP.ScoredLNPIDFetch(le.PHONE,le.FNAME,le.LNAME,(UNSIGNED4)le.DOB,le.MNAME,le.SNAME,le.V_CITY_NAME,le.ST,le.SSN),LNPID)
    ,SORTED(Key_HealthProvider_LIC.ScoredLNPIDFetch(le.C_LIC_NBR,le.LIC_STATE,le.FNAME,le.MNAME,le.LNAME,le.SSN,le.GENDER,le.SNAME,(UNSIGNED4)le.DOB),LNPID)
    ,SORTED(Key_HealthProvider_VEN.ScoredLNPIDFetch(le.VENDOR_ID,le.SRC,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB),LNPID)
    ,SORTED(Key_HealthProvider_TAX.ScoredLNPIDFetch(le.TAX_ID,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_BILLING_TAX.ScoredLNPIDFetch(le.BILLING_TAX_ID,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_DEA.ScoredLNPIDFetch(le.DEA_NUMBER,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_NPI.ScoredLNPIDFetch(le.NPI_NUMBER,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_BILLING_NPI.ScoredLNPIDFetch(le.BILLING_NPI_NUMBER,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB),LNPID)
    ,SORTED(Key_HealthProvider_UPN.ScoredLNPIDFetch(le.UPIN,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_LEXID.ScoredLNPIDFetch(le.DID,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_BID.ScoredLNPIDFetch(le.BDID,le.FNAME,le.MNAME,le.LNAME,le.SNAME,le.GENDER,(UNSIGNED4)le.DOB,le.C_LIC_NBR,le.LIC_STATE),LNPID)
    ,SORTED(Key_HealthProvider_SRC_RID.ScoredLNPIDFetch(le.SOURCE_RID,le.SRC,le.FNAME,le.LNAME,(UNSIGNED4)le.DOB,le.V_CITY_NAME,le.ST,le.GENDER,le.MNAME,le.SNAME),LNPID)
    ,SORTED(Key_HealthProvider_RID.ScoredLNPIDFetch(le.RID),LNPID),SORTED(LNPID)) /* Merged */
