...
EXPORT KeyName := PRTE_Health_Provider_Services.Files.FILE_Header_Refs; //'~'+'key::PRTE_Health_Provider_Services::LNPID::Refs';
...
EXPORT ValueKeyName := PRTE_Health_Provider_Services.Files.FILE_Header_Words; //'~'+'key::PRTE_Health_Provider_Services::LNPID::Words';
  r0 := RECORD
    DataForKey0.uid;
