...
export t_ThinRpsSearchBy := record (share.t_BaseSearchBy)
...
export t_ThinRpsSearchOptions := record (share.t_BaseSearchOption)
...
export t_ThinRpsAddress := record
	...
	share.t_Date VendorDateLastSeen {xpath('VendorDateLastSeen')};//hidden[ecl_only]
	share.t_Date VendorDateFirstSeen {xpath('VendorDateFirstSeen')};//hidden[ecl_only]
end;
...
export t_ThinRpsSearchRecord := record
	...
	dataset(share.t_Name) Names {xpath('Names/Name'), MAXCOUNT(iesp.Constants.ThinRps.MaxCountNames)};
	...
	dataset(share.t_Name) Relatives {xpath('Relatives/Relative'), MAXCOUNT(iesp.Constants.ThinRps.MaxCountRelatives)};
end;
...
export t_ThinRollupPersonSearchRequest := record (share.t_BaseRequest)
