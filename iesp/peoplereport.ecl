...
export t_PeopleReportIndividual := record
	...
	dataset(iesp.bpsreport.t_BpsReportAddressSlim) BpsReportAddresses2 {xpath('BpsReportAddresses/BpsReportAddress'), MAXCOUNT(iesp.constants.BR.MaxAddress)};
	...
	dataset(t_PeopleReportOldPhone) OldPhones2 {xpath('OldPhones/OldPhone'), MAXCOUNT(iesp.constants.BR.MaxPhonesHistorical)};
	dataset(iesp.bpsreport.t_NeighborSlim) Neighbors2 {xpath('Neighbors/Neighborhood'), MAXCOUNT(iesp.constants.BR.MaxNeighborhood)};
	dataset(iesp.bpsreport.t_BpsReportRelativeSlim) Relatives2 {xpath('Relatives/Relative'), MAXCOUNT(iesp.constants.BR.MaxRelatives)};
	dataset(iesp.bpsreport.t_BpsReportAssociateSlim) Associates2 {xpath('Associates/Associate'), MAXCOUNT(iesp.constants.BR.MaxAssociates)};
