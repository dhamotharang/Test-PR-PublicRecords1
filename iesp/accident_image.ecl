...
export t_AccidentImageSearchOption := record (share.t_BaseSearchOption)
	string DataSource {xpath('DataSource')}; //values['CRU','IyeTek','Appriss','HarrisCounty','']
...
export t_AccidentImageRequest := record (share.t_BaseRequest)
