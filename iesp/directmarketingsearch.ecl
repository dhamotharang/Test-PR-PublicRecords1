...
/*** ECL Interface generated by esdl2ecl version 1.0 from directmarketingsearch.xml. ***/
/*===================================================*/

export directmarketingsearch := MODULE
			
export t_DirectMarketingSearchOptions := record (share.t_BaseSearchOption)
	integer ReturnCount {xpath('ReturnCount')};
	integer StartingRecord {xpath('StartingRecord')};
	string DataPackageEnhancement {xpath('DataPackageEnhancement')}; //values['A','B','C','D','']
end;
		
export t_DirectMarketingSearchBy := record
...
export t_DirectMarketingSearchRecord := record
...
export t_DirectMarketingSearchResponse := record
	share.t_ResponseHeader _Header {xpath('Header')};
	integer RecordCount {xpath('RecordCount')};
	dataset(t_DirectMarketingSearchRecord) Records {xpath('Records/Record'), MAXCOUNT(1)};
end;
		
export t_DirectMarketingSearchRequest := record (share.t_BaseRequest)
	t_DirectMarketingSearchOptions Options {xpath('Options')};
	t_DirectMarketingSearchBy SearchBy {xpath('SearchBy')};
end;
		
export t_DirectMarketingSearchResponseEx := record
	t_DirectMarketingSearchResponse response {xpath('response')};
end;
