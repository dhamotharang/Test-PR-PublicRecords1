...
export t_IdentityManagementReportOption := record (share.t_BaseSearchOption)
	...
	boolean IncludeInsuranceDrivers {xpath('IncludeInsuranceDrivers')};
...
export t_IdentityManagementReportRequest := record (share.t_BaseRequest)
