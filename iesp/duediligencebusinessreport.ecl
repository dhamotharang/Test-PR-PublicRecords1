...
export t_DDRBusinessExecutiveCriminalEvents := record
	...
	dataset(iesp.duediligenceshared.t_DDRLegalEventCriminal) CriminalEvents {xpath('CriminalEvents/CriminalEvent'), MAXCOUNT(1)};
end;
...
export t_DDRBusinessLegalAttributeDetails := record
	...
	dataset(iesp.duediligenceshared.t_DDRLegalEventCriminal) PossibleLegalEvents {xpath('PossibleLegalEvents/PossibleLegalEvent'), MAXCOUNT(iesp.constants.DDRAttributesConst.MaxLegalEvents)};
end;
