...
export t_DDRAttributesAdditionalInfo := record
	...
	string100 FIAdditionalCodes1 {xpath('FIAdditionalCodes1')};
	string100 FIAdditionalCodes2 {xpath('FIAdditionalCodes2')};
	string100 FIAdditionalCodes3 {xpath('FIAdditionalCodes3')};
	string100 FIAdditionalCodes4 {xpath('FIAdditionalCodes4')};
	string100 FIAdditionalCodes5 {xpath('FIAdditionalCodes5')};
end;
...
export t_DDRLegalSourceInfo := record
	...
	iesp.share.t_Date DOCParoleActualReleaseDate {xpath('DOCParoleActualReleaseDate')};
	iesp.share.t_Date DOCParolePresumptiveReleaseDate {xpath('DOCParolePresumptiveReleaseDate')};
	iesp.share.t_Date DOCParoleScheduledReleaseDate {xpath('DOCParoleScheduledReleaseDate')};
	string DOCCurrentLocationSecurity {xpath('DOCCurrentLocationSecurity')};
	string DOCParoleCurrentStatus {xpath('DOCParoleCurrentStatus')};
	string DOCCurrentKnownInmateStatus {xpath('DOCCurrentKnownInmateStatus')};
	boolean currentIncarcerationFlag {xpath('currentIncarcerationFlag')};
	boolean currentParoleFlag {xpath('currentParoleFlag')};
	boolean currentProbationFlag {xpath('currentProbationFlag')};
end;
...
export t_DDRLegalStateCriminal := record
	...
	integer2 OffenseID {xpath('OffenseID')};
	integer2 OffensePriorityOrder {xpath('OffensePriorityOrder')};
	integer1 OffenseLevel {xpath('OffenseLevel')};
	...
	string OffenseChargeLevelReported {xpath('OffenseChargeLevelReported')};
	string7 OffenseConviction {xpath('OffenseConviction')};
	string35 OffenseIncarcerationProbationParole {xpath('OffenseIncarcerationProbationParole')};
...
export t_DDRAttributesOptions := record (iesp.share.t_BaseOption)
	...
	t_DDRAttributesAdditionalInfo AdditionalInput {xpath('AdditionalInput')};
end;
