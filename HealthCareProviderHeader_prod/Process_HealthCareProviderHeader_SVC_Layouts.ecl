EXPORT Process_HealthCareProviderHeader_SVC_Layouts := MODULE
...
h.NPI_NUMBER;
h.DEA_NUMBER;
SALT26b2.StrType MAINNAME;//Wordbag field for concept
SALT26b2.StrType FULLNAME;//Wordbag field for concept
h.LIC_NBR;
h.UPIN;
SALT26b2.StrType ADDR1;//Wordbag field for concept
SALT26b2.StrType ADDRESS;//Wordbag field for concept
h.TAX_ID;
h.DOB;
h.PRIM_NAME;
h.ZIP;
SALT26b2.StrType LOCALE;//Wordbag field for concept
h.PRIM_RANGE;
h.LNAME;
h.V_CITY_NAME;
h.MNAME;
...
SALT26b2.UIDType Entered_RID := 0; // Allow user to enter RID to pull data
SALT26b2.UIDType Entered_LNPID := 0; // Allow user to enter LNPID to pull data
END;
...
SALT26b2.UIDType Reference := 0;//Presently for batch
SALT26b2.UIDType RID := 0;
...
SALT26b2.StrType MAINNAME := ''; // Concepts always a wordbag
INTEGER2 MAINNAMEWeight := 0;
SALT26b2.StrType FULLNAME := ''; // Concepts always a wordbag
...
SALT26b2.StrType ADDR1 := ''; // Concepts always a wordbag
INTEGER2 ADDR1Weight := 0;
SALT26b2.StrType ADDRESS := ''; // Concepts always a wordbag
...
SALT26b2.StrType LOCALE := ''; // Concepts always a wordbag
...
SELF.ADDR1Weight := MAX( le.ADDR1Weight, ri.ADDR1Weight );
SELF.ADDR1 := IF ( le.ADDR1Weight>ri.ADDR1Weight, le.ADDR1, ri.ADDR1 );
SELF.ADDRESSWeight := MAX( le.ADDRESSWeight, ri.ADDRESSWeight );
SELF.ADDRESS := IF ( le.ADDRESSWeight>ri.ADDRESSWeight, le.ADDRESS, ri.ADDRESS );
...
END;
r0 := ROLLUP( SORT( GROUP( SORT ( DISTRIBUTE(In_Data,HASH(reference)),Reference, LOCAL ), Reference, LOCAL),LNPID),LEFT.LNPID=RIGHT.LNPID,Combine_Scores(LEFT,RIGHT))(SALT26b2.DebugMode OR ~ForceFailed);
r1 := ROLLUP( TOPN(r0,100,-Weight),GROUP, Create_Output(LEFT,ROWS(LEFT)) );
SALT26b2.MAC_External_AddPcnt(r1,LayoutScoredFetch,OutputLayout_Batch,27,r2);
RETURN r2;
END;
...
SALT26b2.UIDType LNPID;
DATASET(SALT26b2.Layout_FieldValueList) VENDOR_ID_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) DID_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) NPI_NUMBER_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) DEA_NUMBER_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) FULLNAME_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) LIC_NBR_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) UPIN_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) ADDRESS_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) TAX_ID_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) DOB_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) LAT_LONG_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) GENDER_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) LIC_STATE_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) CNAME_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) SRC_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) DT_FIRST_SEEN_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) DT_LAST_SEEN_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) GEO_LAT_Values := DATASET([],SALT26b2.Layout_FieldValueList);
DATASET(SALT26b2.Layout_FieldValueList) GEO_LONG_Values := DATASET([],SALT26b2.Layout_FieldValueList);
END;
...
SELF.LNPID := le.LNPID;
SELF.VENDOR_ID_values := SALT26b2.fn_combine_fieldvaluelist(le.VENDOR_ID_values,ri.VENDOR_ID_values);
SELF.DID_values := SALT26b2.fn_combine_fieldvaluelist(le.DID_values,ri.DID_values);
SELF.NPI_NUMBER_values := SALT26b2.fn_combine_fieldvaluelist(le.NPI_NUMBER_values,ri.NPI_NUMBER_values);
SELF.DEA_NUMBER_values := SALT26b2.fn_combine_fieldvaluelist(le.DEA_NUMBER_values,ri.DEA_NUMBER_values);
SELF.FULLNAME_values := SALT26b2.fn_combine_fieldvaluelist(le.FULLNAME_values,ri.FULLNAME_values);
SELF.LIC_NBR_values := SALT26b2.fn_combine_fieldvaluelist(le.LIC_NBR_values,ri.LIC_NBR_values);
SELF.UPIN_values := SALT26b2.fn_combine_fieldvaluelist(le.UPIN_values,ri.UPIN_values);
SELF.ADDRESS_values := SALT26b2.fn_combine_fieldvaluelist(le.ADDRESS_values,ri.ADDRESS_values);
SELF.TAX_ID_values := SALT26b2.fn_combine_fieldvaluelist(le.TAX_ID_values,ri.TAX_ID_values);
SELF.DOB_values := SALT26b2.fn_combine_fieldvaluelist(le.DOB_values,ri.DOB_values);
SELF.LAT_LONG_values := SALT26b2.fn_combine_fieldvaluelist(le.LAT_LONG_values,ri.LAT_LONG_values);
SELF.GENDER_values := SALT26b2.fn_combine_fieldvaluelist(le.GENDER_values,ri.GENDER_values);
SELF.LIC_STATE_values := SALT26b2.fn_combine_fieldvaluelist(le.LIC_STATE_values,ri.LIC_STATE_values);
SELF.CNAME_values := SALT26b2.fn_combine_fieldvaluelist(le.CNAME_values,ri.CNAME_values);
SELF.SRC_values := SALT26b2.fn_combine_fieldvaluelist(le.SRC_values,ri.SRC_values);
SELF.DT_FIRST_SEEN_values := SALT26b2.fn_combine_fieldvaluelist(le.DT_FIRST_SEEN_values,ri.DT_FIRST_SEEN_values);
SELF.DT_LAST_SEEN_values := SALT26b2.fn_combine_fieldvaluelist(le.DT_LAST_SEEN_values,ri.DT_LAST_SEEN_values);
SELF.GEO_LAT_values := SALT26b2.fn_combine_fieldvaluelist(le.GEO_LAT_values,ri.GEO_LAT_values);
SELF.GEO_LONG_values := SALT26b2.fn_combine_fieldvaluelist(le.GEO_LONG_values,ri.GEO_LONG_values);
END;
...
SELF.LNPID := le.LNPID;
SELF.VENDOR_ID_Values := IF ( (SALT26b2.StrType)le.VENDOR_ID = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.VENDOR_ID)}],SALT26b2.Layout_FieldValueList));
SELF.DID_Values := IF ( (SALT26b2.StrType)le.DID = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.DID)}],SALT26b2.Layout_FieldValueList));
SELF.NPI_NUMBER_Values := IF ( (SALT26b2.StrType)le.NPI_NUMBER = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.NPI_NUMBER)}],SALT26b2.Layout_FieldValueList));
SELF.DEA_NUMBER_Values := IF ( (SALT26b2.StrType)le.DEA_NUMBER = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.DEA_NUMBER)}],SALT26b2.Layout_FieldValueList));
self.FULLNAME_Values := IF ( (SALT26b2.StrType)le.FNAME = '' AND (SALT26b2.StrType)le.MNAME = '' AND (SALT26b2.StrType)le.LNAME = '' AND (SALT26b2.StrType)le.SNAME = '',dataset([],SALT26b2.Layout_FieldValueList),dataset([{TRIM((SALT26b2.StrType)le.FNAME) + ' ' + TRIM((SALT26b2.StrType)le.MNAME) + ' ' + TRIM((SALT26b2.StrType)le.LNAME) + ' ' + TRIM((SALT26b2.StrType)le.SNAME)}],SALT26b2.Layout_FieldValueList));
SELF.LIC_NBR_Values := IF ( (SALT26b2.StrType)le.LIC_NBR = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.LIC_NBR)}],SALT26b2.Layout_FieldValueList));
SELF.UPIN_Values := IF ( (SALT26b2.StrType)le.UPIN = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.UPIN)}],SALT26b2.Layout_FieldValueList));
self.ADDRESS_Values := IF ( (SALT26b2.StrType)le.PRIM_RANGE = '' AND (SALT26b2.StrType)le.SEC_RANGE = '' AND (SALT26b2.StrType)le.PRIM_NAME = '' AND (SALT26b2.StrType)le.V_CITY_NAME = '' AND (SALT26b2.StrType)le.ST = '' AND (SALT26b2.StrType)le.ZIP = '',dataset([],SALT26b2.Layout_FieldValueList),dataset([{TRIM((SALT26b2.StrType)le.PRIM_RANGE) + ' ' + TRIM((SALT26b2.StrType)le.SEC_RANGE) + ' ' + TRIM((SALT26b2.StrType)le.PRIM_NAME) + ' ' + TRIM((SALT26b2.StrType)le.V_CITY_NAME) + ' ' + TRIM((SALT26b2.StrType)le.ST) + ' ' + TRIM((SALT26b2.StrType)le.ZIP)}],SALT26b2.Layout_FieldValueList));
SELF.TAX_ID_Values := IF ( (SALT26b2.StrType)le.TAX_ID = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.TAX_ID)}],SALT26b2.Layout_FieldValueList));
self.DOB_Values := IF ( (unsigned)le.DOB = 0,dataset([],SALT26b2.Layout_FieldValueList),dataset([{(SALT26b2.StrType)le.DOB}],SALT26b2.Layout_FieldValueList));
SELF.GENDER_Values := IF ( (SALT26b2.StrType)le.GENDER = '',DATASET([],SALT26b2.Layout_FieldValueList),DATASET([{TRIM((SALT26b2.StrType)le.GENDER)}],SALT26b2.Layout_FieldValueList));
SELF.LIC_STATE_Values := DATASET([{TRIM((SALT26b2.StrType)le.LIC_STATE)}],SALT26b2.Layout_FieldValueList);
SELF.CNAME_Values := DATASET([{TRIM((SALT26b2.StrType)le.CNAME)}],SALT26b2.Layout_FieldValueList);
SELF.SRC_Values := DATASET([{TRIM((SALT26b2.StrType)le.SRC)}],SALT26b2.Layout_FieldValueList);
SELF.DT_FIRST_SEEN_Values := DATASET([{TRIM((SALT26b2.StrType)le.DT_FIRST_SEEN)}],SALT26b2.Layout_FieldValueList);
SELF.DT_LAST_SEEN_Values := DATASET([{TRIM((SALT26b2.StrType)le.DT_LAST_SEEN)}],SALT26b2.Layout_FieldValueList);
SELF.GEO_LAT_Values := DATASET([{TRIM((SALT26b2.StrType)le.GEO_LAT)}],SALT26b2.Layout_FieldValueList);
SELF.GEO_LONG_Values := DATASET([{TRIM((SALT26b2.StrType)le.GEO_LONG)}],SALT26b2.Layout_FieldValueList);
END;
