/*--SOAP--
<message name="HealthCareProviderHeader_SVC_Header_Service">
...
*/
EXPORT HealthCareProviderHeader_SVC_Header_Service := MACRO
...
,RecordsOnly,FullMatch,e_RID,e_LNPID}],HealthCareProviderHeader_prod.Process_HealthCareProviderHeader_SVC_Layouts.InputLayout);
