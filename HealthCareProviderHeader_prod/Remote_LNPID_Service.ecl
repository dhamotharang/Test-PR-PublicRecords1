/*--SOAP--
<message name="Remote_LNPID_Service">
...
<part name="PHONE_1" type="xsd:string"/>
<part name="LIC_STATE_1" type="xsd:string"/>
<part name="ADDRESS_ID_1" type="xsd:string"/>
...
<part name="DT_LIC_EXPIRATION_1" type="xsd:string"/>
<part name="DT_DEA_EXPIRATION_1" type="xsd:string"/>
...
<part name="ADDRESS_ID_2" type="xsd:string"/>
...
<part name="DT_LIC_EXPIRATION_2" type="xsd:string"/>
<part name="DT_DEA_EXPIRATION_2" type="xsd:string"/>
...
EXPORT Remote_LNPID_Service := MACRO
IMPORT SALT27,HealthCareProviderHeader_prod;
SALT27.StrType Input_VENDOR_ID_1 := '' : STORED('VENDOR_ID_1');
SALT27.StrType Input_DID_1 := '' : STORED('DID_1');
SALT27.StrType Input_NPI_NUMBER_1 := '' : STORED('NPI_NUMBER_1');
SALT27.StrType Input_DEA_NUMBER_1 := '' : STORED('DEA_NUMBER_1');
SALT27.StrType Input_LIC_NBR_1 := '' : STORED('LIC_NBR_1');
SALT27.StrType Input_UPIN_1 := '' : STORED('UPIN_1');
SALT27.StrType Input_TAX_ID_1 := '' : STORED('TAX_ID_1');
SALT27.StrType Input_DOB_1 := '' : STORED('DOB_1');
SALT27.StrType Input_PRIM_NAME_1 := '' : STORED('PRIM_NAME_1');
SALT27.StrType Input_ZIP_1 := '' : STORED('ZIP_1');
SALT27.StrType Input_PRIM_RANGE_1 := '' : STORED('PRIM_RANGE_1');
SALT27.StrType Input_LNAME_1 := '' : STORED('LNAME_1');
SALT27.StrType Input_V_CITY_NAME_1 := '' : STORED('V_CITY_NAME_1');
SALT27.StrType Input_MNAME_1 := '' : STORED('MNAME_1');
SALT27.StrType Input_FNAME_1 := '' : STORED('FNAME_1');
SALT27.StrType Input_SEC_RANGE_1 := '' : STORED('SEC_RANGE_1');
SALT27.StrType Input_SNAME_1 := '' : STORED('SNAME_1');
SALT27.StrType Input_ST_1 := '' : STORED('ST_1');
SALT27.StrType Input_GENDER_1 := '' : STORED('GENDER_1');
SALT27.StrType Input_PHONE_1 := '' : STORED('PHONE_1');
SALT27.StrType Input_LIC_STATE_1 := '' : STORED('LIC_STATE_1');
SALT27.StrType Input_ADDRESS_ID_1 := '' : STORED('ADDRESS_ID_1');
SALT27.StrType Input_CNAME_1 := '' : STORED('CNAME_1');
SALT27.StrType Input_SRC_1 := '' : STORED('SRC_1');
SALT27.StrType Input_DT_FIRST_SEEN_1 := '' : STORED('DT_FIRST_SEEN_1');
SALT27.StrType Input_DT_LAST_SEEN_1 := '' : STORED('DT_LAST_SEEN_1');
SALT27.StrType Input_DT_LIC_EXPIRATION_1 := '' : STORED('DT_LIC_EXPIRATION_1');
SALT27.StrType Input_DT_DEA_EXPIRATION_1 := '' : STORED('DT_DEA_EXPIRATION_1');
SALT27.StrType Input_GEO_LAT_1 := '' : STORED('GEO_LAT_1');
SALT27.StrType Input_GEO_LONG_1 := '' : STORED('GEO_LONG_1');
SALT27.StrType Input_VENDOR_ID_2 := '' : STORED('VENDOR_ID_2');
SALT27.StrType Input_DID_2 := '' : STORED('DID_2');
SALT27.StrType Input_NPI_NUMBER_2 := '' : STORED('NPI_NUMBER_2');
SALT27.StrType Input_DEA_NUMBER_2 := '' : STORED('DEA_NUMBER_2');
SALT27.StrType Input_LIC_NBR_2 := '' : STORED('LIC_NBR_2');
SALT27.StrType Input_UPIN_2 := '' : STORED('UPIN_2');
SALT27.StrType Input_TAX_ID_2 := '' : STORED('TAX_ID_2');
SALT27.StrType Input_DOB_2 := '' : STORED('DOB_2');
SALT27.StrType Input_PRIM_NAME_2 := '' : STORED('PRIM_NAME_2');
SALT27.StrType Input_ZIP_2 := '' : STORED('ZIP_2');
SALT27.StrType Input_PRIM_RANGE_2 := '' : STORED('PRIM_RANGE_2');
SALT27.StrType Input_LNAME_2 := '' : STORED('LNAME_2');
SALT27.StrType Input_V_CITY_NAME_2 := '' : STORED('V_CITY_NAME_2');
SALT27.StrType Input_MNAME_2 := '' : STORED('MNAME_2');
SALT27.StrType Input_FNAME_2 := '' : STORED('FNAME_2');
SALT27.StrType Input_SEC_RANGE_2 := '' : STORED('SEC_RANGE_2');
SALT27.StrType Input_SNAME_2 := '' : STORED('SNAME_2');
SALT27.StrType Input_ST_2 := '' : STORED('ST_2');
SALT27.StrType Input_GENDER_2 := '' : STORED('GENDER_2');
SALT27.StrType Input_PHONE_2 := '' : STORED('PHONE_2');
SALT27.StrType Input_LIC_STATE_2 := '' : STORED('LIC_STATE_2');
SALT27.StrType Input_ADDRESS_ID_2 := '' : STORED('ADDRESS_ID_2');
SALT27.StrType Input_CNAME_2 := '' : STORED('CNAME_2');
SALT27.StrType Input_SRC_2 := '' : STORED('SRC_2');
SALT27.StrType Input_DT_FIRST_SEEN_2 := '' : STORED('DT_FIRST_SEEN_2');
SALT27.StrType Input_DT_LAST_SEEN_2 := '' : STORED('DT_LAST_SEEN_2');
SALT27.StrType Input_DT_LIC_EXPIRATION_2 := '' : STORED('DT_LIC_EXPIRATION_2');
SALT27.StrType Input_DT_DEA_EXPIRATION_2 := '' : STORED('DT_DEA_EXPIRATION_2');
SALT27.StrType Input_GEO_LAT_2 := '' : STORED('GEO_LAT_2');
SALT27.StrType Input_GEO_LONG_2 := '' : STORED('GEO_LONG_2');
...
SELF.PHONE := (TYPEOF(self.PHONE))IF (le.num=1, Input_PHONE_1, Input_PHONE_2 );
SELF.LIC_STATE := (TYPEOF(self.LIC_STATE))IF (le.num=1, Input_LIC_STATE_1, Input_LIC_STATE_2 );
SELF.ADDRESS_ID := (TYPEOF(self.ADDRESS_ID))IF (le.num=1, Input_ADDRESS_ID_1, Input_ADDRESS_ID_2 );
...
SELF.DT_LIC_EXPIRATION := (TYPEOF(self.DT_LIC_EXPIRATION))IF (le.num=1, Input_DT_LIC_EXPIRATION_1, Input_DT_LIC_EXPIRATION_2 );
SELF.DT_DEA_EXPIRATION := (TYPEOF(self.DT_DEA_EXPIRATION))IF (le.num=1, Input_DT_DEA_EXPIRATION_1, Input_DT_DEA_EXPIRATION_2 );
