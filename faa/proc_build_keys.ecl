...
export proc_build_keys(string version_date) := function
	...
	OnlyCrim:=GetDops(datasetname='FCRA_FAAKeys');
	father_version_date := OnlyCrim[1].buildversion;

	set of string DistSet_faa_aircraft_id :=['aircraft_id']; // persistent_id -> FAA.searchFile_Linkids
	...
	set of string DistSet_faa_aircraft_info :=['aircraft_mfr_model_code'];//  FAA.layout_aircraft_info
	set of string InputSet_faa_aircraft_info := ['aircraft_mfr_name','model_name','type_aircraft','type_engine','aircraft_category_code','amateur_certification_code','number_of_engines','number_of_seats','aircraft_weight','aircraft_cruising_speed','lf'];													
	
	set of string DistSet_faa_airmen_cert :=['unique_id'];// persistent_id -> FAA.file_airmen_certificate_bldg
	set of string InputSet_faa_airmen_cert := ['current_flag','letter','rec_type','cer_type','cer_type_mapped','cer_level','cer_level_mapped','cer_exp_date','ratings'];	
	
	set of string DistSet_faa_airmen_did :=['airmen_id']; // persistent_id -> FAA.file_airmen_data_bldg
	...
	set of string DistSet_faa_engine_info :=['engine_mfr_model_code']; // FAA.layout_engine_info 
	set of string InputSet_faa_engine_info := ['engine_mfr_name','model_name','type_engine','engine_hp_or_thrust','fuel_consumed','lf'];	
	
	DeltaCommands:=sequential(
									DOPSGrowthCheck.CalculateStats('FCRA_FAAKeys','faa.key_aircraft_id(true)','key_faa_aircraft_id_FCRA','~thor_data400::key::faa::fcra::'+version_date+'::aircraft_id','aircraft_id','aircraft_id','','','','',version_date,father_version_date,true,true),
									DOPSGrowthCheck.DeltaCommand('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_id','~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_id','FCRA_FAAKeys','key_faa_aircraft_id_FCRA','faa.key_aircraft_id(true)','aircraft_id',version_date,father_version_date,['aircraft_id','best_ssn','did_out','bdid_out','serial_number','aircraft_mfr_name','model_name'],true,true),
									DOPSGrowthCheck.ChangesByField('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_id','~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_id','FCRA_FAAKeys','key_faa_aircraft_id_FCRA','faa.key_aircraft_id(true)','aircraft_id','date_first_seen,date_last_seen,last_action_date,cert_issue_date',version_date,father_version_date,true,true),
									DOPSGrowthCheck.PersistenceCheck('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_id','~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_id','FCRA_FAAKeys','key_faa_aircraft_id_FCRA','faa.key_aircraft_id(true)','aircraft_id',InputSet_faa_aircraft_id,DistSet_faa_aircraft_id,version_date,father_version_date,true,true),

									DOPSGrowthCheck.CalculateStats('FCRA_FAAKeys', 'faa.key_aircraft_info(true)', 'key_faa_aircraft_info_FCRA', '~thor_data400::key::faa::fcra::'+version_date+'::aircraft_info', 'code', 'aircraft_mfr_model_code', '', '', '', '', version_date, father_version_date, true, true), 
									DOPSGrowthCheck.DeltaCommand('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_info', 'FCRA_FAAKeys', 'key_faa_aircraft_info_FCRA', 'faa.key_aircraft_info(true)', 'aircraft_mfr_model_code', version_date, father_version_date, ['code','aircraft_mfr_name', 'model_name', 'type_aircraft', 'type_engine', 'aircraft_category_code'], true, true), 
									DOPSGrowthCheck.ChangesByField('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_info', 'FCRA_FAAKeys', 'key_faa_aircraft_info_FCRA', 'faa.key_aircraft_info(true)', 'aircraft_mfr_model_code', 'filedate,lf', version_date, father_version_date, true, true), 
									DOPSGrowthCheck.PersistenceCheck('~thor_data400::key::faa::fcra::'+version_date+'::aircraft_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::aircraft_info', 'FCRA_FAAKeys', 'key_faa_aircraft_info_FCRA', 'faa.key_aircraft_info(true)', 'aircraft_mfr_model_code', InputSet_faa_aircraft_info, DistSet_faa_aircraft_info, version_date, father_version_date, true, true),
									
									DOPSGrowthCheck.CalculateStats('FCRA_FAAKeys', 'faa.key_airmen_certs(true)', 'key_faa_aircraft_certs_FCRA', '~thor_data400::key::faa::fcra::'+version_date+'::airmen_certs', 'uid', 'unique_id', '', '', '', '', version_date, father_version_date, true, true), 
									DOPSGrowthCheck.DeltaCommand('~thor_data400::key::faa::fcra::'+version_date+'::airmen_certs', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_certs', 'FCRA_FAAKeys', 'key_faa_aircraft_certs_FCRA', 'faa.key_airmen_certs(true)', 'unique_id', version_date, father_version_date, ['unique_id','current_flag','letter','rec_type','cer_type','cer_type_mapped','cer_level', 'cer_level_mapped', 'ratings'], true, true), 
									DOPSGrowthCheck.ChangesByField('~thor_data400::key::faa::fcra::'+version_date+'::airmen_certs', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_certs', 'FCRA_FAAKeys', 'key_faa_aircraft_certs_FCRA', 'faa.key_airmen_certs(true)', 'unique_id', 'date_first_seen,date_last_seen,filler,lfcr', version_date, father_version_date, true, true),
									DOPSGrowthCheck.PersistenceCheck('~thor_data400::key::faa::fcra::'+version_date+'::airmen_certs', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_certs', 'FCRA_FAAKeys', 'key_faa_aircraft_certs_FCRA', 'faa.key_airmen_certs(true)', 'unique_id', InputSet_faa_airmen_cert, DistSet_faa_airmen_cert, version_date, father_version_date, true, true),	
	
									DOPSGrowthCheck.CalculateStats('FCRA_FAAKeys', 'faa.key_airmen_did(true)', 'key_faa_aircraft_did_FCRA', '~thor_data400::key::faa::fcra::'+version_date+'::airmen_did', 'did', 'airmen_id', '', '', '', '', version_date, father_version_date, true, true), 
									DOPSGrowthCheck.DeltaCommand('~thor_data400::key::faa::fcra::'+version_date+'::airmen_did', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_did', 'FCRA_FAAKeys', 'key_faa_aircraft_did_FCRA', 'faa.key_airmen_did(true)', 'airmen_id', version_date, father_version_date, ['d_score','best_ssn','did_out','letter_code','unique_id','orig_rec_type','orig_fname', 'orig_lname', 'street1', 'city'], true, true), 
									DOPSGrowthCheck.ChangesByField('~thor_data400::key::faa::fcra::'+version_date+'::airmen_did', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_did', 'FCRA_FAAKeys', 'key_faa_aircraft_did_FCRA', 'faa.key_airmen_did(true)', 'airmen_id', 'date_first_seen,date_last_seen,med_date,med_exp_date', version_date, father_version_date, true, true),
									DOPSGrowthCheck.PersistenceCheck('~thor_data400::key::faa::fcra::'+version_date+'::airmen_did', '~thor_data400::key::faa::fcra::'+father_version_date+'::airmen_did', 'FCRA_FAAKeys', 'key_faa_aircraft_did_FCRA', 'faa.key_airmen_did(true)', 'airmen_id', InputSet_faa_airmen_did, DistSet_faa_airmen_did, version_date, father_version_date,true, true),
									
									DOPSGrowthCheck.CalculateStats('FCRA_FAAKeys', 'faa.key_engine_info(true)', 'key_faa_engine_info_FCRA', '~thor_data400::key::faa::fcra::'+version_date+'::engine_info', 'code', 'engine_mfr_model_code', '', '', '', '', version_date, father_version_date, true, true), 
									DOPSGrowthCheck.DeltaCommand('~thor_data400::key::faa::fcra::'+version_date+'::engine_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::engine_info', 'FCRA_FAAKeys', 'key_faa_engine_info_FCRA', 'faa.key_engine_info(true)', 'engine_mfr_model_code', version_date, father_version_date, ['engine_mfr_model_code','engine_mfr_name', 'model_name', 'type_engine', 'engine_hp_or_thrust','fuel_consumed'], true, true),
									DOPSGrowthCheck.ChangesByField('~thor_data400::key::faa::fcra::'+version_date+'::engine_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::engine_info', 'FCRA_FAAKeys', 'key_faa_engine_info_FCRA', 'faa.key_engine_info(true)', 'engine_mfr_model_code', 'filedate', version_date, father_version_date, true, true),
									DOPSGrowthCheck.PersistenceCheck('~thor_data400::key::faa::fcra::'+version_date+'::engine_info', '~thor_data400::key::faa::fcra::'+father_version_date+'::engine_info', 'FCRA_FAAKeys', 'key_faa_engine_info_FCRA', 'faa.key_engine_info(true)', 'engine_mfr_model_code', InputSet_faa_engine_info, DistSet_faa_engine_info, version_date, father_version_date, true, true)
								);
