...
EXPORT L_CNPNAME_ZIP_MAXBLOCKSIZE:=100000; // Increased limit to 100K from 10K /*HACK27a*/
EXPORT L_CNPNAME_ZIP_MAXBLOCKLIMIT:=100000; // Increased limit to 100K from 10K /*HACK27b*/
EXPORT L_CNPNAME_ST_MAXBLOCKSIZE:=100000; // Increased limit to 100K from 10K /*HACK27c*/
EXPORT L_CNPNAME_ST_MAXBLOCKLIMIT:=100000; // Increased limit to 100K from 10K /*HACK27d*/
...
EXPORT L_CNPNAME_FUZZY_MAXBLOCKSIZE:=100000; // Increased limit to 100K from 10K /*HACK27e*/
EXPORT L_CNPNAME_FUZZY_MAXBLOCKLIMIT:=100000; // Increased limit to 100K from 10K /*HACK27f*/
