...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_parent_proxid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.parent_proxid)));
    avelength_parent_proxid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.parent_proxid)),h.parent_proxid<>(typeof(h.parent_proxid))'');
    populated_sele_proxid_pcnt := AVE(GROUP,IF(h.sele_proxid = (TYPEOF(h.sele_proxid))'',0,100));
    maxlength_sele_proxid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sele_proxid)));
    avelength_sele_proxid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sele_proxid)),h.sele_proxid<>(typeof(h.sele_proxid))'');
    populated_org_proxid_pcnt := AVE(GROUP,IF(h.org_proxid = (TYPEOF(h.org_proxid))'',0,100));
    maxlength_org_proxid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.org_proxid)));
    avelength_org_proxid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.org_proxid)),h.org_proxid<>(typeof(h.org_proxid))'');
    populated_ultimate_proxid_pcnt := AVE(GROUP,IF(h.ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',0,100));
    maxlength_ultimate_proxid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ultimate_proxid)));
    avelength_ultimate_proxid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ultimate_proxid)),h.ultimate_proxid<>(typeof(h.ultimate_proxid))'');
    populated_has_lgid_pcnt := AVE(GROUP,IF(h.has_lgid = (TYPEOF(h.has_lgid))'',0,100));
    maxlength_has_lgid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.has_lgid)));
    avelength_has_lgid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.has_lgid)),h.has_lgid<>(typeof(h.has_lgid))'');
    ...
    maxlength_source_record_id := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_record_id)));
    avelength_source_record_id := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_record_id)),h.source_record_id<>(typeof(h.source_record_id))'');
    populated_source_docid_pcnt := AVE(GROUP,IF(h.source_docid = (TYPEOF(h.source_docid))'',0,100));
    maxlength_source_docid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_docid)));
    avelength_source_docid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_docid)),h.source_docid<>(typeof(h.source_docid))'');
    populated_company_name_pcnt := AVE(GROUP,IF(h.company_name = (TYPEOF(h.company_name))'',0,100));
    maxlength_company_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name)));
    avelength_company_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name)),h.company_name<>(typeof(h.company_name))'');
    populated_company_name_prefix_pcnt := AVE(GROUP,IF(h.company_name_prefix = (TYPEOF(h.company_name_prefix))'',0,100));
    maxlength_company_name_prefix := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name_prefix)));
    avelength_company_name_prefix := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name_prefix)),h.company_name_prefix<>(typeof(h.company_name_prefix))'');
    populated_cnp_name_pcnt := AVE(GROUP,IF(h.cnp_name = (TYPEOF(h.cnp_name))'',0,100));
    maxlength_cnp_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_name)));
    avelength_cnp_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_name)),h.cnp_name<>(typeof(h.cnp_name))'');
    populated_cnp_number_pcnt := AVE(GROUP,IF(h.cnp_number = (TYPEOF(h.cnp_number))'',0,100));
    maxlength_cnp_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_number)));
    avelength_cnp_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_number)),h.cnp_number<>(typeof(h.cnp_number))'');
    populated_cnp_btype_pcnt := AVE(GROUP,IF(h.cnp_btype = (TYPEOF(h.cnp_btype))'',0,100));
    maxlength_cnp_btype := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_btype)));
    avelength_cnp_btype := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_btype)),h.cnp_btype<>(typeof(h.cnp_btype))'');
    populated_cnp_lowv_pcnt := AVE(GROUP,IF(h.cnp_lowv = (TYPEOF(h.cnp_lowv))'',0,100));
    maxlength_cnp_lowv := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_lowv)));
    avelength_cnp_lowv := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_lowv)),h.cnp_lowv<>(typeof(h.cnp_lowv))'');
    populated_company_phone_pcnt := AVE(GROUP,IF(h.company_phone = (TYPEOF(h.company_phone))'',0,100));
    maxlength_company_phone := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone)));
    avelength_company_phone := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone)),h.company_phone<>(typeof(h.company_phone))'');
    populated_company_phone_3_pcnt := AVE(GROUP,IF(h.company_phone_3 = (TYPEOF(h.company_phone_3))'',0,100));
    maxlength_company_phone_3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_3)));
    avelength_company_phone_3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_3)),h.company_phone_3<>(typeof(h.company_phone_3))'');
    populated_company_phone_3_ex_pcnt := AVE(GROUP,IF(h.company_phone_3_ex = (TYPEOF(h.company_phone_3_ex))'',0,100));
    maxlength_company_phone_3_ex := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_3_ex)));
    avelength_company_phone_3_ex := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_3_ex)),h.company_phone_3_ex<>(typeof(h.company_phone_3_ex))'');
    populated_company_phone_7_pcnt := AVE(GROUP,IF(h.company_phone_7 = (TYPEOF(h.company_phone_7))'',0,100));
    maxlength_company_phone_7 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_7)));
    avelength_company_phone_7 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_phone_7)),h.company_phone_7<>(typeof(h.company_phone_7))'');
    populated_company_fein_pcnt := AVE(GROUP,IF(h.company_fein = (TYPEOF(h.company_fein))'',0,100));
    maxlength_company_fein := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_fein)));
    avelength_company_fein := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_fein)),h.company_fein<>(typeof(h.company_fein))'');
    populated_company_sic_code1_pcnt := AVE(GROUP,IF(h.company_sic_code1 = (TYPEOF(h.company_sic_code1))'',0,100));
    maxlength_company_sic_code1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_sic_code1)));
    avelength_company_sic_code1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_sic_code1)),h.company_sic_code1<>(typeof(h.company_sic_code1))'');
    populated_active_duns_number_pcnt := AVE(GROUP,IF(h.active_duns_number = (TYPEOF(h.active_duns_number))'',0,100));
    maxlength_active_duns_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_duns_number)));
    avelength_active_duns_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_duns_number)),h.active_duns_number<>(typeof(h.active_duns_number))'');
    ...
    maxlength_city_clean := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.city_clean)));
    avelength_city_clean := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.city_clean)),h.city_clean<>(typeof(h.city_clean))'');
    ...
    maxlength_company_url := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_url)));
    avelength_company_url := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_url)),h.company_url<>(typeof(h.company_url))'');
    populated_isContact_pcnt := AVE(GROUP,IF(h.isContact = (TYPEOF(h.isContact))'',0,100));
    maxlength_isContact := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.isContact)));
    avelength_isContact := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.isContact)),h.isContact<>(typeof(h.isContact))'');
    populated_contact_did_pcnt := AVE(GROUP,IF(h.contact_did = (TYPEOF(h.contact_did))'',0,100));
    maxlength_contact_did := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_did)));
    avelength_contact_did := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_did)),h.contact_did<>(typeof(h.contact_did))'');
    ...
    maxlength_fname_preferred := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fname_preferred)));
    avelength_fname_preferred := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fname_preferred)),h.fname_preferred<>(typeof(h.fname_preferred))'');
    ...
    maxlength_contact_ssn := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_ssn)));
    avelength_contact_ssn := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_ssn)),h.contact_ssn<>(typeof(h.contact_ssn))'');
    populated_contact_email_pcnt := AVE(GROUP,IF(h.contact_email = (TYPEOF(h.contact_email))'',0,100));
    maxlength_contact_email := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_email)));
    avelength_contact_email := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_email)),h.contact_email<>(typeof(h.contact_email))'');
    populated_sele_flag_pcnt := AVE(GROUP,IF(h.sele_flag = (TYPEOF(h.sele_flag))'',0,100));
    maxlength_sele_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sele_flag)));
    avelength_sele_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sele_flag)),h.sele_flag<>(typeof(h.sele_flag))'');
    populated_org_flag_pcnt := AVE(GROUP,IF(h.org_flag = (TYPEOF(h.org_flag))'',0,100));
    maxlength_org_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.org_flag)));
    avelength_org_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.org_flag)),h.org_flag<>(typeof(h.org_flag))'');
    populated_ult_flag_pcnt := AVE(GROUP,IF(h.ult_flag = (TYPEOF(h.ult_flag))'',0,100));
    maxlength_ult_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ult_flag)));
    avelength_ult_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ult_flag)),h.ult_flag<>(typeof(h.ult_flag))'');
    populated_fallback_value_pcnt := AVE(GROUP,IF(h.fallback_value = (TYPEOF(h.fallback_value))'',0,100));
    maxlength_fallback_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fallback_value)));
    avelength_fallback_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fallback_value)),h.fallback_value<>(typeof(h.fallback_value))'');
  END;
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.proxid;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.parent_proxid),TRIM((SALT33.StrType)le.sele_proxid),TRIM((SALT33.StrType)le.org_proxid),TRIM((SALT33.StrType)le.ultimate_proxid),TRIM((SALT33.StrType)le.has_lgid),TRIM((SALT33.StrType)le.empid),TRIM((SALT33.StrType)le.source),TRIM((SALT33.StrType)le.source_record_id),TRIM((SALT33.StrType)le.source_docid),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.company_name_prefix),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_phone_3),TRIM((SALT33.StrType)le.company_phone_3_ex),TRIM((SALT33.StrType)le.company_phone_7),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.company_sic_code1),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.city),TRIM((SALT33.StrType)le.city_clean),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.company_url),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_did),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.fname_preferred),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.sele_flag),TRIM((SALT33.StrType)le.org_flag),TRIM((SALT33.StrType)le.ult_flag),TRIM((SALT33.StrType)le.fallback_value)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 44);
  SELF.FldNo2 := 1 + (C % 44);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.parent_proxid),TRIM((SALT33.StrType)le.sele_proxid),TRIM((SALT33.StrType)le.org_proxid),TRIM((SALT33.StrType)le.ultimate_proxid),TRIM((SALT33.StrType)le.has_lgid),TRIM((SALT33.StrType)le.empid),TRIM((SALT33.StrType)le.source),TRIM((SALT33.StrType)le.source_record_id),TRIM((SALT33.StrType)le.source_docid),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.company_name_prefix),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_phone_3),TRIM((SALT33.StrType)le.company_phone_3_ex),TRIM((SALT33.StrType)le.company_phone_7),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.company_sic_code1),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.city),TRIM((SALT33.StrType)le.city_clean),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.company_url),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_did),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.fname_preferred),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.sele_flag),TRIM((SALT33.StrType)le.org_flag),TRIM((SALT33.StrType)le.ult_flag),TRIM((SALT33.StrType)le.fallback_value)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.parent_proxid),TRIM((SALT33.StrType)le.sele_proxid),TRIM((SALT33.StrType)le.org_proxid),TRIM((SALT33.StrType)le.ultimate_proxid),TRIM((SALT33.StrType)le.has_lgid),TRIM((SALT33.StrType)le.empid),TRIM((SALT33.StrType)le.source),TRIM((SALT33.StrType)le.source_record_id),TRIM((SALT33.StrType)le.source_docid),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.company_name_prefix),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_phone_3),TRIM((SALT33.StrType)le.company_phone_3_ex),TRIM((SALT33.StrType)le.company_phone_7),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.company_sic_code1),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.city),TRIM((SALT33.StrType)le.city_clean),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.company_url),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_did),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.fname_preferred),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.sele_flag),TRIM((SALT33.StrType)le.org_flag),TRIM((SALT33.StrType)le.ult_flag),TRIM((SALT33.StrType)le.fallback_value)));
  END;
...
SHARED FldIds := DATASET([{1,'parent_proxid'}
      ...
      ,{42,'org_flag'}
      ,{43,'ult_flag'}
      ,{44,'fallback_value'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_parent_proxid((SALT33.StrType)le.parent_proxid),
    Fields.InValid_sele_proxid((SALT33.StrType)le.sele_proxid),
    Fields.InValid_org_proxid((SALT33.StrType)le.org_proxid),
    Fields.InValid_ultimate_proxid((SALT33.StrType)le.ultimate_proxid),
    Fields.InValid_has_lgid((SALT33.StrType)le.has_lgid),
    Fields.InValid_empid((SALT33.StrType)le.empid),
    Fields.InValid_source((SALT33.StrType)le.source),
    Fields.InValid_source_record_id((SALT33.StrType)le.source_record_id),
    Fields.InValid_source_docid((SALT33.StrType)le.source_docid),
    Fields.InValid_company_name((SALT33.StrType)le.company_name),
    Fields.InValid_company_name_prefix((SALT33.StrType)le.company_name_prefix),
    Fields.InValid_cnp_name((SALT33.StrType)le.cnp_name),
    Fields.InValid_cnp_number((SALT33.StrType)le.cnp_number),
    Fields.InValid_cnp_btype((SALT33.StrType)le.cnp_btype),
    Fields.InValid_cnp_lowv((SALT33.StrType)le.cnp_lowv),
    Fields.InValid_company_phone((SALT33.StrType)le.company_phone),
    Fields.InValid_company_phone_3((SALT33.StrType)le.company_phone_3),
    Fields.InValid_company_phone_3_ex((SALT33.StrType)le.company_phone_3_ex),
    Fields.InValid_company_phone_7((SALT33.StrType)le.company_phone_7),
    Fields.InValid_company_fein((SALT33.StrType)le.company_fein),
    Fields.InValid_company_sic_code1((SALT33.StrType)le.company_sic_code1),
    Fields.InValid_active_duns_number((SALT33.StrType)le.active_duns_number),
    ...
    Fields.InValid_city_clean((SALT33.StrType)le.city_clean),
    Fields.InValid_st((SALT33.StrType)le.st),
    Fields.InValid_zip((SALT33.StrType)le.zip),
    Fields.InValid_company_url((SALT33.StrType)le.company_url),
    Fields.InValid_isContact((SALT33.StrType)le.isContact),
    Fields.InValid_contact_did((SALT33.StrType)le.contact_did),
    Fields.InValid_title((SALT33.StrType)le.title),
    Fields.InValid_fname((SALT33.StrType)le.fname),
    Fields.InValid_fname_preferred((SALT33.StrType)le.fname_preferred),
    ...
    Fields.InValid_contact_ssn((SALT33.StrType)le.contact_ssn),
    Fields.InValid_contact_email((SALT33.StrType)le.contact_email),
    Fields.InValid_sele_flag((SALT33.StrType)le.sele_flag),
    Fields.InValid_org_flag((SALT33.StrType)le.org_flag),
    Fields.InValid_ult_flag((SALT33.StrType)le.ult_flag),
    Fields.InValid_fallback_value((SALT33.StrType)le.fallback_value),
    0, // Uncleanable field
    0, // Uncleanable field
    0);
