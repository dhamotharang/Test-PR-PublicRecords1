...
EXPORT Layout_Uber_Record := RECORD(SALT44.Layout_Uber_Record0)
END;
EXPORT Layout_Uber_Plus := RECORD(Layout_Uber_Record)
  SALT44.Str30Type word;
...
Layout_Uber_Plus IntoInversion(h le,UNSIGNED2 c) := TRANSFORM
  SELF.word := CHOOSE(c,(SALT44.StrType)le.parent_proxid,(SALT44.StrType)le.sele_proxid,(SALT44.StrType)le.org_proxid,(SALT44.StrType)le.ultimate_proxid,(SALT44.StrType)le.has_lgid,(SALT44.StrType)le.empid,(SALT44.StrType)le.source,(SALT44.StrType)le.source_record_id,(SALT44.StrType)le.source_docid,Fields.Make_company_name((SALT44.StrType)le.company_name),Fields.Make_company_name_prefix((SALT44.StrType)le.company_name_prefix),'',(SALT44.StrType)le.cnp_number,(SALT44.StrType)le.cnp_btype,(SALT44.StrType)le.cnp_lowv,(SALT44.StrType)le.company_phone,(SALT44.StrType)le.company_phone_3,(SALT44.StrType)le.company_phone_3_ex,(SALT44.StrType)le.company_phone_7,(SALT44.StrType)le.company_fein,(SALT44.StrType)le.company_sic_code1,(SALT44.StrType)le.active_duns_number,(SALT44.StrType)le.prim_range,Fields.Make_prim_name((SALT44.StrType)le.prim_name),Fields.Make_sec_range((SALT44.StrType)le.sec_range),Fields.Make_city((SALT44.StrType)le.city),Fields.Make_city_clean((SALT44.StrType)le.city_clean),Fields.Make_st((SALT44.StrType)le.st),Fields.Make_zip((SALT44.StrType)le.zip),'',(SALT44.StrType)le.isContact,(SALT44.StrType)le.contact_did,(SALT44.StrType)le.title,Fields.Make_fname((SALT44.StrType)le.fname),Fields.Make_fname_preferred((SALT44.StrType)le.fname_preferred),Fields.Make_mname((SALT44.StrType)le.mname),Fields.Make_lname((SALT44.StrType)le.lname),Fields.Make_name_suffix((SALT44.StrType)le.name_suffix),(SALT44.StrType)le.contact_ssn,Fields.Make_contact_email((SALT44.StrType)le.contact_email),(SALT44.StrType)le.sele_flag,(SALT44.StrType)le.org_flag,(SALT44.StrType)le.ult_flag,(SALT44.StrType)le.fallback_value,SKIP,SKIP,SKIP);
  SELF.field := c;
  SELF.uid := le.proxid;
  SELF := le;
END;
nfields_r := Fn_Reduce_UBER_Local(NORMALIZE(h,46,IntoInversion(LEFT,COUNTER))(word<>''));
SALT44.MAC_Expand_Wordbag_Field(h,cnp_name,12,proxid,layout_uber_plus,nfields12);
SALT44.MAC_Expand_Wordbag_Field(h,company_url,30,proxid,layout_uber_plus,nfields30);
SALT44.MAC_Expand_Normal_Field(h,fname,45,proxid,layout_uber_plus,nfields10485);
SALT44.MAC_Expand_Normal_Field(h,mname,45,proxid,layout_uber_plus,nfields10486);
SALT44.MAC_Expand_Normal_Field(h,lname,45,proxid,layout_uber_plus,nfields10487);
nfields45 := nfields10485+nfields10486+nfields10487;//Collect wordbags for parts of concept field
SALT44.MAC_Expand_Normal_Field(h,prim_range,46,proxid,layout_uber_plus,nfields10718);
SALT44.MAC_Expand_Normal_Field(h,prim_name,46,proxid,layout_uber_plus,nfields10719);
SALT44.MAC_Expand_Normal_Field(h,sec_range,46,proxid,layout_uber_plus,nfields10720);
...
EXPORT ValueKeyName := BizLinkFull.Filename_keys.Words; /*HACK07Words*/
  ...
  SALT44.MAC_Specificity_Local(DataForKey0,word,uid,word_nulls,SALT44.Layout_Uber_Nulls,word_specificity,word_switch,word_values);
...
EXPORT ValueKey := INDEX(word_values,{word},{word_values},ValueKeyName);
  Layout_Uber_Plus add_id(Layout_Uber_Plus le,word_values ri,BOOLEAN patch_default) := TRANSFORM
    ...
    SELF := le;
  END;
  SALT44.Mac_Choose_JoinType(DataForKey0,word_nulls,word_values,word,word_weight100,add_id,DataForKey1);
...
EXPORT RawFetch(TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.has_lgid) param_has_lgid = (TYPEOF(h.has_lgid))'',TYPEOF(h.empid) param_empid = (TYPEOF(h.empid))'',TYPEOF(h.source) param_source = (TYPEOF(h.source))'',TYPEOF(h.source_record_id) param_source_record_id = (TYPEOF(h.source_record_id))'',TYPEOF(h.source_docid) param_source_docid = (TYPEOF(h.source_docid))'',TYPEOF(h.company_name) param_company_name = (TYPEOF(h.company_name))'',TYPEOF(h.company_name_prefix) param_company_name_prefix = (TYPEOF(h.company_name_prefix))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.company_phone) param_company_phone = (TYPEOF(h.company_phone))'',TYPEOF(h.company_phone_3) param_company_phone_3 = (TYPEOF(h.company_phone_3))'',TYPEOF(h.company_phone_3_ex) param_company_phone_3_ex = (TYPEOF(h.company_phone_3_ex))'',TYPEOF(h.company_phone_7) param_company_phone_7 = (TYPEOF(h.company_phone_7))'',TYPEOF(h.company_fein) param_company_fein = (TYPEOF(h.company_fein))'',TYPEOF(h.company_fein_len) param_company_fein_len = (TYPEOF(h.company_fein_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.active_duns_number) param_active_duns_number = (TYPEOF(h.active_duns_number))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.city_clean) param_city_clean = (TYPEOF(h.city_clean))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',DATASET(process_Biz_layouts.layout_zip_cases) param_zip,TYPEOF(h.company_url) param_company_url = (TYPEOF(h.company_url))'',TYPEOF(h.isContact) param_isContact = (TYPEOF(h.isContact))'',TYPEOF(h.contact_did) param_contact_did = (TYPEOF(h.contact_did))'',TYPEOF(h.title) param_title = (TYPEOF(h.title))'',TYPEOF(h.fname) param_fname = (TYPEOF(h.fname))'',TYPEOF(h.fname_len) param_fname_len = (TYPEOF(h.fname_len))'',TYPEOF(h.fname_preferred) param_fname_preferred = (TYPEOF(h.fname_preferred))'',TYPEOF(h.mname) param_mname = (TYPEOF(h.mname))'',TYPEOF(h.mname_len) param_mname_len = (TYPEOF(h.mname_len))'',TYPEOF(h.lname) param_lname = (TYPEOF(h.lname))'',TYPEOF(h.lname_len) param_lname_len = (TYPEOF(h.lname_len))'',TYPEOF(h.name_suffix) param_name_suffix = (TYPEOF(h.name_suffix))'',TYPEOF(h.contact_ssn) param_contact_ssn = (TYPEOF(h.contact_ssn))'',TYPEOF(h.contact_email) param_contact_email = (TYPEOF(h.contact_email))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',SALT44.StrType param_CONTACTNAME,TYPEOF(h.fname_len) param_fname_len = (TYPEOF(h.fname_len))'',TYPEOF(h.mname_len) param_mname_len = (TYPEOF(h.mname_len))'',TYPEOF(h.lname_len) param_lname_len = (TYPEOF(h.lname_len))'',SALT44.StrType param_STREETADDRESS,TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'') := 
  FUNCTION
 //Create wordstream from parameters
    SALT44.MAC_Field_To_UberStream(param_parent_proxid,1,ValueKey,WS1);
    SALT44.MAC_Field_To_UberStream(param_sele_proxid,2,ValueKey,WS2);
    SALT44.MAC_Field_To_UberStream(param_org_proxid,3,ValueKey,WS3);
    SALT44.MAC_Field_To_UberStream(param_ultimate_proxid,4,ValueKey,WS4);
    SALT44.MAC_Field_To_UberStream(param_has_lgid,5,ValueKey,WS5);
    SALT44.MAC_Field_To_UberStream(param_empid,6,ValueKey,WS6);
    SALT44.MAC_Field_To_UberStream(param_source,7,ValueKey,WS7);
    SALT44.MAC_Field_To_UberStream(param_source_record_id,8,ValueKey,WS8);
    SALT44.MAC_Field_To_UberStream(param_source_docid,9,ValueKey,WS9);
    SALT44.MAC_Field_To_UberStream(param_company_name,10,ValueKey,WS10);
    SALT44.MAC_Field_To_UberStream(param_company_name_prefix,11,ValueKey,WS11);
    SALT44.MAC_FieldWordBag_To_UberStream(param_cnp_name,12,ValueKey,WS12);
    SALT44.MAC_Field_To_UberStream(param_cnp_number,13,ValueKey,WS13);
    SALT44.MAC_Field_To_UberStream(param_cnp_btype,14,ValueKey,WS14);
    SALT44.MAC_Field_To_UberStream(param_cnp_lowv,15,ValueKey,WS15);
    SALT44.MAC_Field_To_UberStream(param_company_phone,16,ValueKey,WS16);
    SALT44.MAC_Field_To_UberStream(param_company_phone_3,17,ValueKey,WS17);
    SALT44.MAC_Field_To_UberStream(param_company_phone_3_ex,18,ValueKey,WS18);
    SALT44.MAC_Field_To_UberStream(param_company_phone_7,19,ValueKey,WS19);
    SALT44.MAC_Field_To_UberStream(param_company_fein,20,ValueKey,WS20);
    SALT44.MAC_Field_To_UberStream(param_company_sic_code1,21,ValueKey,WS21);
    SALT44.MAC_Field_To_UberStream(param_active_duns_number,22,ValueKey,WS22);
    SALT44.MAC_Field_To_UberStream(param_prim_range,23,ValueKey,WS23);
    SALT44.MAC_Field_To_UberStream(param_prim_name,24,ValueKey,WS24);
    SALT44.MAC_Field_To_UberStream(param_sec_range,25,ValueKey,WS25);
    SALT44.MAC_Field_To_UberStream(param_city,26,ValueKey,WS26);
    SALT44.MAC_Field_To_UberStream(param_city_clean,27,ValueKey,WS27);
    SALT44.MAC_Field_To_UberStream(param_st,28,ValueKey,WS28);
    SALT44.MAC_FieldSet_To_UberStream(SET(param_zip,zip),29,ValueKey,WS29);
    SALT44.MAC_FieldWordBag_To_UberStream(param_company_url,30,ValueKey,WS30);
    SALT44.MAC_Field_To_UberStream(param_isContact,31,ValueKey,WS31);
    SALT44.MAC_Field_To_UberStream(param_contact_did,32,ValueKey,WS32);
    SALT44.MAC_Field_To_UberStream(param_title,33,ValueKey,WS33);
    SALT44.MAC_Field_To_UberStream(param_fname,34,ValueKey,WS34);
    SALT44.MAC_Field_To_UberStream(param_fname_preferred,35,ValueKey,WS35);
    SALT44.MAC_Field_To_UberStream(param_mname,36,ValueKey,WS36);
    SALT44.MAC_Field_To_UberStream(param_lname,37,ValueKey,WS37);
    SALT44.MAC_Field_To_UberStream(param_name_suffix,38,ValueKey,WS38);
    SALT44.MAC_Field_To_UberStream(param_contact_ssn,39,ValueKey,WS39);
    SALT44.MAC_Field_To_UberStream(param_contact_email,40,ValueKey,WS40);
    SALT44.MAC_Field_To_UberStream(param_sele_flag,41,ValueKey,WS41);
    SALT44.MAC_Field_To_UberStream(param_org_flag,42,ValueKey,WS42);
    SALT44.MAC_Field_To_UberStream(param_ult_flag,43,ValueKey,WS43);
    SALT44.MAC_Field_To_UberStream(param_fallback_value,44,ValueKey,WS44);
    SALT44.MAC_Field_To_UberStream(param_CONTACTNAME,45,ValueKey,WS45);
    SALT44.MAC_Field_To_UberStream(param_STREETADDRESS,46,ValueKey,WS46);
    ...
    SALT44.MAC_Collate_Uber_Matches(Key,Wds,steppedmatches,Layout_Uber_Record,,,,,,,);
