...
EXPORT CanSearch(Process_Biz_Layouts.InputLayout le) := le.contact_ssn <> (TYPEOF(le.contact_ssn))'' AND Fields.InValid_contact_ssn((SALT311.StrType)le.contact_ssn)=0;
KeyRec := RECORDOF(Key);
