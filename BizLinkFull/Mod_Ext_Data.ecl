...
EXPORT Mod_Ext_Data(BOOLEAN MultiRec = FALSE,SET OF SALT311.UIDType ButNot=[], DATASET(RECORDOF(File_Ext_Data))  inefile = File_Ext_Data) := MODULE
  R := RECORD
    inefile;
...
EXPORT Mapped := Process_Biz_Layouts.CleanInput(Mapped_ToClean) : PERSIST('~temp::proxid::BizLinkFull::Mapped::UID::Ext_Data',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
...
SHARED LinkResults := ofi : PERSIST('~temp::proxid::BizLinkFull::LinkResults::UID::Ext_Data',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
...
EXPORT WithUID := j0 : PERSIST('~temp::proxid::BizLinkFull::WithUID::UID::Ext_Data',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
...
// We need this payload key to be indexed by proxid
  RLayout := RECORD
  SALT311.UIDType Fetch_proxid;
  SALT311.UIDType Fetch_seleid;
  SALT311.UIDType Fetch_orgid;
  SALT311.UIDType Fetch_ultid;
  SALT311.UIDType Fetch_rcid;
    WithUID;
  END;
...
// Extra credit fields
  ...
  h.cnp_name;
  UNSIGNED8 gss_bloom := SALT311.Fn_Wordbag_To_Bloom(h.cnp_name); // To allow pruning of positives from rawfetch
  h.prim_name_len;
  h.city_len;
  h.prim_range_len;
  h.sec_range_len;
...
SALT311.mac_expand_wordbag_key(DataForKey0,GSS_hash,cnp_name,DataForKey1,GSS_word_weight)
...
EXPORT ScoredproxidFetchL_CNPNAME_ZIP(TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  RawData := RawFetchL_CNPNAME_ZIP(param_cnp_name,param_zip,param_prim_name,param_prim_name_len,param_st,param_city,param_city_len,param_fallback_value);
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.cnp_nameWeight := SALT311.MatchBagOfWords(le.cnp_name,param_cnp_name,3177747,1)/100; /*HACK22_a*/
...
EXPORT RawFetchL_CNPNAME_ST(TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
 ...
 //Generate service attributes for GSS join
    ...
    doIndexRead(UNSIGNED4 search,UNSIGNED2 spc) := STEPPED(KEYL_CNPNAME_ST( KEYED(GSS_hash = search) AND (GSS_bloom & BloomF) = BloomF
      ...
      AND ((param_prim_name = (TYPEOF(prim_name))'' OR prim_name = (TYPEOF(prim_name))'') OR (prim_name = param_prim_name) OR ((Config_BIP.WithinEditN(prim_name,prim_name_len,param_prim_name,param_prim_name_len,1, 0)) ))
      AND ((~EXISTS(param_zip) OR zip = (TYPEOF(zip))'') OR (zip IN SET(param_zip,zip)))
      AND ((param_city = (TYPEOF(city))'' OR city = (TYPEOF(city))'') OR (city = param_city) OR ( (metaphonelib.DMetaPhone1(city)=metaphonelib.DMetaPhone1(param_city))  OR (Config_BIP.WithinEditN(city,city_len,param_city,param_city_len,2, 0)) ))),ultid,orgid,seleid,proxid,PRIORITY(40-spc)); // Filter for each row of index fetch
    SALT311.MAC_collate_wordbag_matches4(wds,slimrec,doIndexRead,ultid,orgid,seleid,proxid,steppedmatches) // Perform N-way join
...
EXPORT ScoredproxidFetchL_CNPNAME_ST(TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  RawData := RawFetchL_CNPNAME_ST(param_cnp_name,param_st,param_prim_name,param_prim_name_len,param_zip,param_city,param_city_len,param_fallback_value);
...
EXPORT ScoredproxidFetchL_CNPNAME(TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  RawData := RawFetchL_CNPNAME(param_cnp_name,param_prim_name,param_prim_name_len,param_st,param_city,param_city_len,param_fallback_value);
  ...
  SELF.cnp_name_gss_cases := DATASET([{le.gss_hash}],SALT311.layout_GSS_cases);
    ...
    SELF.zipWeight := (50+MAP (
           ...
           -0.995*le.zip_weight100))/100; 
    SELF.zip_cases := DATASET([{le.zip,SELF.zipweight}],Process_Biz_Layouts.layout_zip_cases);
    SELF.Weight := IF(le.proxid = 0 AND le.seleid = 0 AND le.orgid = 0 AND le.ultid = 0 AND le.rcid = 0, 1, MAX(0, SELF.cnp_nameWeight) + MAX(0, SELF.prim_nameWeight) + MAX(0, SELF.stWeight) + MAX(0, SELF.cityWeight) + MAX(0, SELF.company_sic_code1Weight) + MAX(0, SELF.cnp_numberWeight) + MAX(0, SELF.cnp_btypeWeight) + MAX(0, SELF.cnp_lowvWeight) + MAX(0, SELF.prim_rangeWeight) + MAX(0, SELF.sec_rangeWeight) + MAX(0, SELF.parent_proxidWeight) + MAX(0, SELF.sele_proxidWeight) + MAX(0, SELF.org_proxidWeight) + MAX(0, SELF.ultimate_proxidWeight) + MAX(0, SELF.sele_flagWeight) + MAX(0, SELF.org_flagWeight) + MAX(0, SELF.ult_flagWeight) + MAX(0, SELF.zipWeight));
    SELF := le;
  END;
  result0 := PROJECT(NOFOLD(RawData),Score(LEFT));
  result1 := PROJECT(result0, Process_Biz_Layouts.update_forcefailed(LEFT,param_disableForce));
...
DataForKey0 := DEDUP(SORT(TABLE(h((company_name_prefix NOT IN SET(s.nulls_company_name_prefix,company_name_prefix) AND company_name_prefix <> (TYPEOF(company_name_prefix))''),(cnp_name NOT IN SET(s.nulls_cnp_name,cnp_name) AND cnp_name <> (TYPEOF(cnp_name))''),(zip NOT IN SET(s.nulls_zip,zip) AND zip <> (TYPEOF(zip))'')),layout),company_name_prefix,zip,st,proxid,seleid,orgid,ultid,rcid,cnp_name,city,company_sic_code1,cnp_number,cnp_btype,cnp_lowv,prim_range,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,powid,city_len,prim_range_len,sec_range_len,company_name_prefix_weight100,cnp_name_weight100,cnp_name_initial_char_weight100,zip_weight100,city_weight100,city_p_Weight100,city_e2_Weight100,city_e2p_Weight100,st_weight100,company_sic_code1_weight100,cnp_number_weight100,cnp_btype_weight100,cnp_lowv_weight100,prim_range_weight100,prim_range_e1_Weight100,sec_range_weight100,sec_range_e1_Weight100,parent_proxid_weight100,sele_proxid_weight100,org_proxid_weight100,ultimate_proxid_weight100,sele_flag_weight100,org_flag_weight100,ult_flag_weight100,-fallback_value,LOCAL),WHOLE RECORD,EXCEPT fallback_value,LOCAL);
...
EXPORT RawFetchL_CNPNAME_FUZZY(TYPEOF(h.company_name_prefix) param_company_name_prefix = (TYPEOF(h.company_name_prefix))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_CNPNAME_FUZZY(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_CNPNAME_FUZZY_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
 
 
EXPORT ScoredproxidFetchL_CNPNAME_FUZZY(TYPEOF(h.company_name_prefix) param_company_name_prefix = (TYPEOF(h.company_name_prefix))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  RawData := RawFetchL_CNPNAME_FUZZY(param_company_name_prefix,param_cnp_name,param_zip,param_city,param_city_len,param_st,param_fallback_value);
...
EXPORT RawFetchL_ADDRESS1(TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_ADDRESS1(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_ADDRESS1_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT RawFetchL_ADDRESS2(TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_ADDRESS2(
      ...
      AND KEYED((zip IN SET(param_zip,zip)))
      AND ((param_prim_range = (TYPEOF(prim_range))'' OR prim_range = (TYPEOF(prim_range))'') OR (prim_range = param_prim_range) OR ((Config_BIP.WithinEditN(prim_range,prim_range_len,param_prim_range,param_prim_range_len,1, 0)) ))
      AND ((param_cnp_name = (TYPEOF(cnp_name))'' OR cnp_name = (TYPEOF(cnp_name))'') OR (SALT311.MatchBagOfWords(cnp_name,param_cnp_name,3177747,1)+400/*HACK08_b*/ > Config_BIP.cnp_name_Force * 100))
      AND KEYED((param_st = (TYPEOF(st))'' OR st = (TYPEOF(st))'') OR (st = param_st))
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_ADDRESS2_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT RawFetchL_ADDRESS3(TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_ADDRESS3(
      ...
      AND KEYED((zip IN SET(param_zip,zip)))
      AND ((param_cnp_name = (TYPEOF(cnp_name))'' OR cnp_name = (TYPEOF(cnp_name))'') OR (SALT311.MatchBagOfWords(cnp_name,param_cnp_name,3177747,1)+400/*HACK08_c*/ > Config_BIP.cnp_name_Force * 100))
      AND KEYED((param_st = (TYPEOF(st))'' OR st = (TYPEOF(st))'') OR (st = param_st))
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_ADDRESS3_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT RawFetchL_PHONE(TYPEOF(h.company_phone_7) param_company_phone_7 = (TYPEOF(h.company_phone_7))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.company_phone_3) param_company_phone_3 = (TYPEOF(h.company_phone_3))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_PHONE(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_PHONE_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT ScoredproxidFetchL_PHONE(TYPEOF(h.company_phone_7) param_company_phone_7 = (TYPEOF(h.company_phone_7))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.company_phone_3) param_company_phone_3 = (TYPEOF(h.company_phone_3))'',TYPEOF(h.company_phone_3_ex) param_company_phone_3_ex = (TYPEOF(h.company_phone_3_ex))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.company_phone_7Weight := (50+MAP (
           SELF.company_phone_7_match_code = SALT311.MatchCode.ExactMatch =>le.company_phone_7_weight100,
    ...
    SELF.company_phone_3_match_code := MAP(
           le.company_phone_3 = (TYPEOF(le.company_phone_3))'' OR param_company_phone_3 = (TYPEOF(param_company_phone_3))'' => SALT311.MatchCode.OneSideNull,
    ...
    SELF.company_phone_3Weight := (50+MAP (
           SELF.company_phone_3_match_code = SALT311.MatchCode.OneSideNull => 0,
           SELF.company_phone_3_match_code = SALT311.MatchCode.ExactMatch =>le.company_phone_3_weight100,
           -0.952*le.company_phone_3_weight100))/100; 
    SELF.company_phone_3_ex_match_code := MAP(
           le.company_phone_3_ex = (TYPEOF(le.company_phone_3_ex))'' OR param_company_phone_3_ex = (TYPEOF(param_company_phone_3_ex))'' => SALT311.MatchCode.OneSideNull,
    ...
    SELF.company_phone_3_exWeight := (50+MAP (
           SELF.company_phone_3_ex_match_code = SALT311.MatchCode.OneSideNull => 0,
           SELF.company_phone_3_ex_match_code = SALT311.MatchCode.ExactMatch =>le.company_phone_3_ex_weight100,
...
//Scores for various field components
  ...
  INTEGER2 company_fein_e1_Weight100 := SALT311.Min0(h.company_fein_weight100 + 100*log(h.company_fein_cnt/h.company_fein_e1_cnt)/log(2)); // Precompute edit-distance specificity
  h.company_sic_code1_weight100 ; // Contains 100x the specificity
  h.cnp_name_weight100 ; // Contains 100x the specificity
  h.cnp_name_initial_char_weight100 ; // Contains 100x the specificity
  h.cnp_number_weight100 ; // Contains 100x the specificity
...
EXPORT RawFetchL_FEIN(TYPEOF(h.company_fein) param_company_fein = (TYPEOF(h.company_fein))'',TYPEOF(h.company_fein_len) param_company_fein_len = (TYPEOF(h.company_fein_len))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_FEIN(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_FEIN_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT ScoredproxidFetchL_FEIN(TYPEOF(h.company_fein) param_company_fein = (TYPEOF(h.company_fein))'',TYPEOF(h.company_fein_len) param_company_fein_len = (TYPEOF(h.company_fein_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.company_feinWeight := (50+MAP (
           SELF.company_fein_match_code = SALT311.MatchCode.ExactMatch =>le.company_fein_weight100,
...
// Extra credit fields
  ...
  //Required in project to allow later processing
  h.company_url;
  UNSIGNED8 gss_bloom := SALT311.Fn_Wordbag_To_Bloom(h.company_url); // To allow pruning of positives from rawfetch
  h.prim_name_len;
  h.city_len;
  h.prim_range_len;
  h.sec_range_len;
...
// Now need to 'blow out' the fixed word-bag fields to create the pseudo-inversion
SALT311.mac_expand_wordbag_key(DataForKey0,GSS_hash,company_url,DataForKey1,GSS_word_weight)
DataForKey2 := DEDUP(SORT(DataForKey1,WHOLE RECORD,LOCAL),WHOLE RECORD,LOCAL); // Can remove wordbag fields now
...
EXPORT RawFetchL_URL(TYPEOF(h.company_url) param_company_url = (TYPEOF(h.company_url))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
  FUNCTION
 //Generate service attributes for GSS join
    wds := SALT311.fn_string_to_wordstream(param_company_url);
...
EXPORT ScoredproxidFetchL_URL(TYPEOF(h.company_url) param_company_url = (TYPEOF(h.company_url))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  SELF.company_url_gss_cases := DATASET([{le.gss_hash}],SALT311.layout_GSS_cases);
    SELF.st_match_code := MAP(
           le.st = (TYPEOF(le.st))'' OR param_st = (TYPEOF(param_st))'' => SALT311.MatchCode.OneSideNull,
           match_methods(File_BizHead).match_st(le.st,param_st,FALSE));
    SELF.stWeight := (50+MAP (
...
EXPORT ScoredproxidFetchL_CONTACT(TYPEOF(h.fname_preferred) param_fname_preferred = (TYPEOF(h.fname_preferred))'',TYPEOF(h.lname) param_lname = (TYPEOF(h.lname))'',TYPEOF(h.lname_len) param_lname_len = (TYPEOF(h.lname_len))'',TYPEOF(h.mname) param_mname = (TYPEOF(h.mname))'',TYPEOF(h.mname_len) param_mname_len = (TYPEOF(h.mname_len))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fname) param_fname = (TYPEOF(h.fname))'',TYPEOF(h.fname_len) param_fname_len = (TYPEOF(h.fname_len))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.fname_preferredWeight := (50+MAP (
           SELF.fname_preferred_match_code = SALT311.MatchCode.ExactMatch =>le.fname_preferred_weight100,
    ...
    SELF.fnameWeight := (50+MAP (
           ...
           SELF.fname_match_code = SALT311.MatchCode.EditDistanceMatch =>le.fname_e1_weight100,
...
EXPORT RawFetchL_CONTACT_SSN(TYPEOF(h.contact_ssn) param_contact_ssn = (TYPEOF(h.contact_ssn))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_CONTACT_SSN(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_CONTACT_SSN_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT ScoredproxidFetchL_CONTACT_SSN(TYPEOF(h.contact_ssn) param_contact_ssn = (TYPEOF(h.contact_ssn))'',TYPEOF(h.contact_email) param_contact_email = (TYPEOF(h.contact_email))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.contact_ssnWeight := (50+MAP (
           SELF.contact_ssn_match_code = SALT311.MatchCode.ExactMatch =>le.contact_ssn_weight100,
    ...
    SELF.contact_emailWeight := (50+MAP (
           SELF.contact_email_match_code = SALT311.MatchCode.OneSideNull => 0,
           SELF.contact_email_match_code = SALT311.MatchCode.ExactMatch =>le.contact_email_weight100,
...
EXPORT RawFetchL_EMAIL(TYPEOF(h.contact_email) param_contact_email = (TYPEOF(h.contact_email))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_EMAIL(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_EMAIL_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT RawFetchL_SOURCE(TYPEOF(h.source_record_id) param_source_record_id = (TYPEOF(h.source_record_id))'',TYPEOF(h.source) param_source = (TYPEOF(h.source))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_SOURCE(
      ...
      AND ((param_city = (TYPEOF(city))'' OR city = (TYPEOF(city))'') OR (city = param_city) OR ( (metaphonelib.DMetaPhone1(city)=metaphonelib.DMetaPhone1(param_city))  OR (Config_BIP.WithinEditN(city,city_len,param_city,param_city_len,2, 0)) ))
      AND KEYED((param_st = (TYPEOF(st))'' OR st = (TYPEOF(st))'') OR (st = param_st))
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_SOURCE_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT ScoredproxidFetchL_SOURCE(TYPEOF(h.source_record_id) param_source_record_id = (TYPEOF(h.source_record_id))'',TYPEOF(h.source) param_source = (TYPEOF(h.source))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.prim_name_len) param_prim_name_len = (TYPEOF(h.prim_name_len))'',DATASET(Process_Biz_Layouts.layout_zip_cases) param_zip,TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.city_len) param_city_len = (TYPEOF(h.city_len))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.prim_range_len) param_prim_range_len = (TYPEOF(h.prim_range_len))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.sec_range_len) param_sec_range_len = (TYPEOF(h.sec_range_len))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.source_record_idWeight := (50+MAP (
           SELF.source_record_id_match_code = SALT311.MatchCode.ExactMatch =>le.source_record_id_weight100,
    ...
    SELF.sourceWeight := (50+MAP (
           SELF.source_match_code = SALT311.MatchCode.ExactMatch =>le.source_weight100,
...
EXPORT RawFetchL_CONTACT_DID(TYPEOF(h.contact_did) param_contact_did = (TYPEOF(h.contact_did))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := 
    STEPPED( LIMIT( KeyL_CONTACT_DID(
      ...
      AND KEYED(fallback_value >= param_fallback_value)),Config_BIP.L_CONTACT_DID_MAXBLOCKLIMIT,ONFAIL(TRANSFORM(KeyRec,SELF := ROW([],KeyRec))),KEYED),ultid,orgid,seleid,proxid);
...
EXPORT ScoredproxidFetchL_CONTACT_DID(TYPEOF(h.contact_did) param_contact_did = (TYPEOF(h.contact_did))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'',BOOLEAN param_disableForce = FALSE) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.contact_didWeight := (50+MAP (
           SELF.contact_did_match_code = SALT311.MatchCode.ExactMatch =>le.contact_did_weight100,
...
EXPORT BuildAll := PARALLEL(BUILDINDEX(PayloadByproxid, OVERWRITE),BUILDINDEX(KeyL_CNPNAME_ZIP, OVERWRITE),BUILDINDEX(KeyL_CNPNAME_ST, OVERWRITE),BUILDINDEX(KeyL_CNPNAME, OVERWRITE),BUILDINDEX(KeyL_CNPNAME_FUZZY, OVERWRITE),BUILDINDEX(KeyL_ADDRESS1, OVERWRITE),BUILDINDEX(KeyL_ADDRESS2, OVERWRITE),BUILDINDEX(KeyL_ADDRESS3, OVERWRITE),BUILDINDEX(KeyL_PHONE, OVERWRITE),BUILDINDEX(KeyL_FEIN, OVERWRITE),BUILDINDEX(KeyL_URL, OVERWRITE),BUILDINDEX(KeyL_CONTACT, OVERWRITE),BUILDINDEX(KeyL_CONTACT_SSN, OVERWRITE),BUILDINDEX(KeyL_EMAIL, OVERWRITE),BUILDINDEX(KeyL_SIC, OVERWRITE),BUILDINDEX(KeyL_SOURCE, OVERWRITE),BUILDINDEX(KeyL_CONTACT_DID, OVERWRITE));
...
// Need to annotate wordbags with specificities
  cnp_name_spec := SALT311.fn_wordbag_appendspecs_fake(le.cnp_name);
  company_url_spec := SALT311.fn_wordbag_appendspecs_fake(le.company_url);
// Need to calculate lengths for EDIT fields
  ...
  SELF.keys_tried := IF (Key_BizHead_L_CNPNAME_ZIP.CanSearch(le),1 << 1,0) + IF (Key_BizHead_L_CNPNAME_ST.CanSearch(le),1 << 2,0) + IF (Key_BizHead_L_CNPNAME.CanSearch(le),1 << 3,0) + IF (Key_BizHead_L_CNPNAME_FUZZY.CanSearch(le),1 << 4,0) + IF (Key_BizHead_L_ADDRESS1.CanSearch(le),1 << 5,0) + IF (Key_BizHead_L_ADDRESS2.CanSearch(le),1 << 6,0) + IF (Key_BizHead_L_ADDRESS3.CanSearch(le),1 << 7,0) + IF (Key_BizHead_L_PHONE.CanSearch(le),1 << 8,0) + IF (Key_BizHead_L_FEIN.CanSearch(le),1 << 9,0) + IF (Key_BizHead_L_URL.CanSearch(le),1 << 10,0) + IF (Key_BizHead_L_CONTACT.CanSearch(le),1 << 11,0) + IF (Key_BizHead_L_CONTACT_SSN.CanSearch(le),1 << 12,0) + IF (Key_BizHead_L_EMAIL.CanSearch(le),1 << 13,0) + IF (Key_BizHead_L_SIC.CanSearch(le),1 << 14,0) + IF (Key_BizHead_L_SOURCE.CanSearch(le),1 << 15,0) + IF (Key_BizHead_L_CONTACT_DID.CanSearch(le),1 << 16,0) + IF (Key_BizHead_L_CNPNAME_ZIP.CanSearch(le),1 << 1+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CNPNAME_ST.CanSearch(le),1 << 2+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CNPNAME.CanSearch(le),1 << 3+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CNPNAME_FUZZY.CanSearch(le),1 << 4+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_ADDRESS1.CanSearch(le),1 << 5+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_ADDRESS2.CanSearch(le),1 << 6+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_ADDRESS3.CanSearch(le),1 << 7+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_PHONE.CanSearch(le),1 << 8+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_FEIN.CanSearch(le),1 << 9+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_URL.CanSearch(le),1 << 10+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CONTACT.CanSearch(le),1 << 11+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CONTACT_SSN.CanSearch(le),1 << 12+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_EMAIL.CanSearch(le),1 << 13+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_SIC.CanSearch(le),1 << 14+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_SOURCE.CanSearch(le),1 << 15+Config_BIP.KeysBitmapOffset,0) + IF (Key_BizHead_L_CONTACT_DID.CanSearch(le),1 << 16+Config_BIP.KeysBitmapOffset,0);
  fetchResults0 := ROLLUP(
    ...
    ,SORTED(IF((~BizLinkFull.Key_BizHead_L_CNPNAME_ST.CanSearch(le) AND ~BizLinkFull.Key_BizHead_L_CNPNAME_ZIP.CanSearch(le)),IF(BizLinkFull.Key_BizHead_L_CNPNAME.CanSearch(le),ScoredproxidFetchL_CNPNAME(param_cnp_name := cnp_name_spec,param_prim_name := le.prim_name,param_prim_name_len := prim_name_len,param_st := le.st,param_city := le.city,param_city_len := city_len,param_company_sic_code1 := le.company_sic_code1,param_cnp_number := le.cnp_number,param_cnp_btype := le.cnp_btype,param_cnp_lowv := le.cnp_lowv,param_prim_range := le.prim_range,param_prim_range_len := prim_range_len,param_sec_range := le.sec_range,param_sec_range_len := sec_range_len,param_parent_proxid := le.parent_proxid,param_sele_proxid := le.sele_proxid,param_org_proxid := le.org_proxid,param_ultimate_proxid := le.ultimate_proxid,param_sele_flag := le.sele_flag,param_org_flag := le.org_flag,param_ult_flag := le.ult_flag,param_zip := le.zip_cases,param_fallback_value := le.fallback_value,param_disableForce := In_disableForce))),ultid,orgid,seleid,proxid,rcid)
    ,SORTED(IF(BizLinkFull.Key_BizHead_L_CNPNAME_FUZZY.CanSearch(le),ScoredproxidFetchL_CNPNAME_FUZZY(param_company_name_prefix := le.company_name_prefix,param_cnp_name := cnp_name_spec,param_zip := le.zip_cases,param_city := le.city,param_city_len := city_len,param_st := le.st,param_company_sic_code1 := le.company_sic_code1,param_cnp_number := le.cnp_number,param_cnp_btype := le.cnp_btype,param_cnp_lowv := le.cnp_lowv,param_prim_range := le.prim_range,param_prim_range_len := prim_range_len,param_sec_range := le.sec_range,param_sec_range_len := sec_range_len,param_parent_proxid := le.parent_proxid,param_sele_proxid := le.sele_proxid,param_org_proxid := le.org_proxid,param_ultimate_proxid := le.ultimate_proxid,param_sele_flag := le.sele_flag,param_org_flag := le.org_flag,param_ult_flag := le.ult_flag,param_fallback_value := le.fallback_value,param_disableForce := In_disableForce)),ultid,orgid,seleid,proxid,rcid)
    ...
    , (RIGHT.proxid > 0 OR RIGHT.rcid = LEFT.rcid) AND LEFT.proxid = RIGHT.proxid AND LEFT.seleid = RIGHT.seleid AND LEFT.orgid = RIGHT.orgid AND LEFT.ultid = RIGHT.ultid, Process_Biz_Layouts.Combine_Scores(LEFT, RIGHT, In_disableForce))((proxid NOT IN ButNot) AND (SALT311.DebugMode OR ~ForceFailed OR ButNot <> [])); // Warning - is a fetch to keys etc
...
END;
  ...
  Process_Biz_Layouts.OutputLayout rl(RR0 le,RR0 ri) := TRANSFORM
    ...
    , (RIGHT.proxid > 0 OR RIGHT.rcid = LEFT.rcid) AND LEFT.proxid = RIGHT.proxid AND LEFT.seleid = RIGHT.seleid AND LEFT.orgid = RIGHT.orgid AND LEFT.ultid = RIGHT.ultid, Process_Biz_Layouts.Combine_Scores(LEFT, RIGHT, In_disableForce))((proxid NOT IN ButNot) AND (SALT311.DebugMode OR ~ForceFailed OR ButNot <> [])),le.MaxIds + 1,-Weight);
...
EXPORT Raw_Data := Fetch_(Uid_Results);
  ...
  EXPORT ScoreExt_DataData(RD,Inv) := FUNCTIONMACRO
    ...
    SELF.Match_parent_proxid := MAP ( ri.parent_proxid = (TYPEOF(ri.parent_proxid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.parent_proxid = (TYPEOF(ri.parent_proxid))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_parent_proxid(le.parent_proxid,ri.parent_proxid,FALSE)));
    SELF.Match_sele_proxid := MAP ( ri.sele_proxid = (TYPEOF(ri.sele_proxid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.sele_proxid = (TYPEOF(ri.sele_proxid))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_sele_proxid(le.sele_proxid,ri.sele_proxid,FALSE)));
    SELF.Match_org_proxid := MAP ( ri.org_proxid = (TYPEOF(ri.org_proxid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.org_proxid = (TYPEOF(ri.org_proxid))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_org_proxid(le.org_proxid,ri.org_proxid,FALSE)));
    SELF.Match_ultimate_proxid := MAP ( ri.ultimate_proxid = (TYPEOF(ri.ultimate_proxid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.ultimate_proxid = (TYPEOF(ri.ultimate_proxid))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_ultimate_proxid(le.ultimate_proxid,ri.ultimate_proxid,FALSE)));
    SELF.Match_has_lgid := MAP ( ri.has_lgid = (TYPEOF(ri.has_lgid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.has_lgid = (TYPEOF(ri.has_lgid))'' => SALT311.HeaderSearchMatchCode.BlankField,ri.has_lgid = le.has_lgid => SALT311.HeaderSearchMatchCode.Match,SALT311.HeaderSearchMatchCode.NoMatch);
    SELF.Match_empid := MAP ( ri.empid = (TYPEOF(ri.empid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.empid = (TYPEOF(ri.empid))'' => SALT311.HeaderSearchMatchCode.BlankField,ri.empid = le.empid => SALT311.HeaderSearchMatchCode.Match,SALT311.HeaderSearchMatchCode.NoMatch);
    SELF.Match_source := MAP ( ri.source = (TYPEOF(ri.source))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.source = (TYPEOF(ri.source))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_source(le.source,ri.source,FALSE)));
    SELF.Match_source_record_id := MAP ( ri.source_record_id = (TYPEOF(ri.source_record_id))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.source_record_id = (TYPEOF(ri.source_record_id))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_source_record_id(le.source_record_id,ri.source_record_id,FALSE)));
    SELF.Match_source_docid := MAP ( ri.source_docid = (TYPEOF(ri.source_docid))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.source_docid = (TYPEOF(ri.source_docid))'' => SALT311.HeaderSearchMatchCode.BlankField,ri.source_docid = le.source_docid => SALT311.HeaderSearchMatchCode.Match,SALT311.HeaderSearchMatchCode.NoMatch);
    SELF.Match_company_name := MAP ( ri.company_name = (TYPEOF(ri.company_name))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_name = (TYPEOF(ri.company_name))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_name(le.company_name,ri.company_name,FALSE)));
    ...
    le_cnp_name := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)le.cnp_name);//For later scoring
    ri_cnp_name := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)ri.cnp_name);//For later scoring
    SELF.Match_cnp_name := MAP ( ri.cnp_name = (TYPEOF(ri.cnp_name))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.cnp_name = (TYPEOF(ri.cnp_name))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_cnp_name(le.cnp_name,ri.cnp_name,FALSE)));
    SELF.Match_cnp_number := MAP ( ri.cnp_number = (TYPEOF(ri.cnp_number))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.cnp_number = (TYPEOF(ri.cnp_number))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_cnp_number(le.cnp_number,ri.cnp_number,FALSE)));
    SELF.Match_cnp_btype := MAP ( ri.cnp_btype = (TYPEOF(ri.cnp_btype))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.cnp_btype = (TYPEOF(ri.cnp_btype))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_cnp_btype(le.cnp_btype,ri.cnp_btype,FALSE)));
    SELF.Match_cnp_lowv := MAP ( ri.cnp_lowv = (TYPEOF(ri.cnp_lowv))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.cnp_lowv = (TYPEOF(ri.cnp_lowv))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_cnp_lowv(le.cnp_lowv,ri.cnp_lowv,FALSE)));
    SELF.Match_company_phone := MAP ( ri.company_phone = (TYPEOF(ri.company_phone))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_phone = (TYPEOF(ri.company_phone))'' => SALT311.HeaderSearchMatchCode.BlankField,ri.company_phone = le.company_phone => SALT311.HeaderSearchMatchCode.Match,SALT311.HeaderSearchMatchCode.NoMatch);
    SELF.Match_company_phone_3 := MAP ( ri.company_phone_3 = (TYPEOF(ri.company_phone_3))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_phone_3 = (TYPEOF(ri.company_phone_3))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_phone_3(le.company_phone_3,ri.company_phone_3,FALSE)));
    ...
    SELF.Match_company_phone_7 := MAP ( ri.company_phone_7 = (TYPEOF(ri.company_phone_7))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_phone_7 = (TYPEOF(ri.company_phone_7))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_phone_7(le.company_phone_7,ri.company_phone_7,FALSE)));
    SELF.Match_company_fein := MAP ( ri.company_fein = (TYPEOF(ri.company_fein))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_fein = (TYPEOF(ri.company_fein))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_fein(le.company_fein,ri.company_fein,0,0,FALSE)));
    SELF.Match_company_sic_code1 := MAP ( ri.company_sic_code1 = (TYPEOF(ri.company_sic_code1))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_sic_code1 = (TYPEOF(ri.company_sic_code1))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_sic_code1(le.company_sic_code1,ri.company_sic_code1,FALSE)));
    SELF.Match_active_duns_number := MAP ( ri.active_duns_number = (TYPEOF(ri.active_duns_number))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.active_duns_number = (TYPEOF(ri.active_duns_number))'' => SALT311.HeaderSearchMatchCode.BlankField,ri.active_duns_number = le.active_duns_number => SALT311.HeaderSearchMatchCode.Match,SALT311.HeaderSearchMatchCode.NoMatch);
    SELF.Match_prim_range := MAP ( ri.prim_range = (TYPEOF(ri.prim_range))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.prim_range = (TYPEOF(ri.prim_range))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_prim_range(le.prim_range,ri.prim_range,0,0,FALSE)));
    ...
    SELF.Match_sec_range := MAP ( ri.sec_range = (TYPEOF(ri.sec_range))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.sec_range = (TYPEOF(ri.sec_range))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_sec_range(le.sec_range,ri.sec_range,0,0,FALSE)));
    SELF.Match_city := MAP ( ri.city = (TYPEOF(ri.city))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.city = (TYPEOF(ri.city))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_city(le.city,ri.city,0,0,FALSE)));
    SELF.Match_city_clean := MAP ( ri.city_clean = (TYPEOF(ri.city_clean))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.city_clean = (TYPEOF(ri.city_clean))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_city_clean(le.city_clean,ri.city_clean,FALSE)));
    SELF.Match_st := MAP ( ri.st = (TYPEOF(ri.st))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.st = (TYPEOF(ri.st))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_st(le.st,ri.st,FALSE)));
    SELF.Match_zip := MAP ( ~EXISTS(ri.zip_cases) => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.zip = (TYPEOF(le.zip))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_zip_el(le.zip,SET(ri.zip_cases,zip),FALSE)));
    le_company_url := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)le.company_url);//For later scoring
    ri_company_url := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)ri.company_url);//For later scoring
    SELF.Match_company_url := MAP ( ri.company_url = (TYPEOF(ri.company_url))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.company_url = (TYPEOF(ri.company_url))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_company_url(le.company_url,ri.company_url,FALSE)));
    SELF.Match_isContact := MAP ( ri.isContact = (TYPEOF(ri.isContact))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.isContact = (TYPEOF(ri.isContact))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_isContact(le.isContact,ri.isContact,FALSE)));
    SELF.Match_contact_did := MAP ( ri.contact_did = (TYPEOF(ri.contact_did))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.contact_did = (TYPEOF(ri.contact_did))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_contact_did(le.contact_did,ri.contact_did,FALSE)));
    SELF.Match_title := MAP ( ri.title = (TYPEOF(ri.title))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.title = (TYPEOF(ri.title))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_title(le.title,ri.title,FALSE)));
    SELF.Match_fname := MAP ( ri.fname = (TYPEOF(ri.fname))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.fname = (TYPEOF(ri.fname))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_fname(le.fname,ri.fname,0,0,FALSE)));
    SELF.Match_fname_preferred := MAP ( ri.fname_preferred = (TYPEOF(ri.fname_preferred))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.fname_preferred = (TYPEOF(ri.fname_preferred))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_fname_preferred(le.fname_preferred,ri.fname_preferred,FALSE)));
    SELF.Match_mname := MAP ( ri.mname = (TYPEOF(ri.mname))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.mname = (TYPEOF(ri.mname))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_mname(le.mname,ri.mname,0,0,FALSE)));
    SELF.Match_lname := MAP ( ri.lname = (TYPEOF(ri.lname))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.lname = (TYPEOF(ri.lname))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_lname(le.lname,ri.lname,0,0,FALSE)));
    SELF.Match_name_suffix := MAP ( ri.name_suffix = (TYPEOF(ri.name_suffix))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.name_suffix = (TYPEOF(ri.name_suffix))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_name_suffix(le.name_suffix,ri.name_suffix,FALSE)));
    SELF.Match_contact_ssn := MAP ( ri.contact_ssn = (TYPEOF(ri.contact_ssn))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.contact_ssn = (TYPEOF(ri.contact_ssn))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_contact_ssn(le.contact_ssn,ri.contact_ssn,FALSE)));
    SELF.Match_contact_email := MAP ( ri.contact_email = (TYPEOF(ri.contact_email))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.contact_email = (TYPEOF(ri.contact_email))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_contact_email(le.contact_email,ri.contact_email,FALSE)));
    SELF.Match_fallback_value := MAP ( ri.fallback_value = (TYPEOF(ri.fallback_value))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le.fallback_value = (TYPEOF(ri.fallback_value))'' => SALT311.HeaderSearchMatchCode.BlankField,SALT311.MatchCode.GroupHeaderSearchCodes(BizLinkFull.match_methods(BizLinkFull.File_BizHead).match_fallback_value(le.fallback_value,ri.fallback_value,FALSE)));
    ri_CONTACTNAME := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)ri.CONTACTNAME);//For later scoring
    le_CONTACTNAME := SALT311.Fn_WordBag_AppendSpecs_Fake(TRIM((SALT311.StrType)le.fname) + ' ' + TRIM((SALT311.StrType)le.mname) + ' ' + TRIM((SALT311.StrType)le.lname));//For later scoring
    SELF.Match_CONTACTNAME := MAP ( ri.CONTACTNAME = (typeof(ri.CONTACTNAME))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le_CONTACTNAME = (typeof(ri.CONTACTNAME))'' => SALT311.HeaderSearchMatchCode.BlankField, ri_CONTACTNAME = le_CONTACTNAME => SALT311.HeaderSearchMatchCode.Match, SALT311.HeaderSearchMatchCode.NoMatch);
    ri_STREETADDRESS := SALT311.Fn_WordBag_AppendSpecs_Fake((SALT311.StrType)ri.STREETADDRESS);//For later scoring
    le_STREETADDRESS := SALT311.Fn_WordBag_AppendSpecs_Fake(TRIM((SALT311.StrType)le.prim_range) + ' ' + TRIM((SALT311.StrType)le.prim_name) + ' ' + TRIM((SALT311.StrType)le.sec_range));//For later scoring
    SELF.Match_STREETADDRESS := MAP ( ri.STREETADDRESS = (typeof(ri.STREETADDRESS))'' => SALT311.HeaderSearchMatchCode.NoSearchCriteria, le_STREETADDRESS = (typeof(ri.STREETADDRESS))'' => SALT311.HeaderSearchMatchCode.BlankField, ri_STREETADDRESS = le_STREETADDRESS => SALT311.HeaderSearchMatchCode.Match, SALT311.HeaderSearchMatchCode.NoMatch);
