...
#workunit('name','BizLinkFull.BWR_Hygiene - Hygiene & Stats - SALT V3.11.8');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_BizHead'),NAMED('OptimizedLayout'));// File layout suggested by data
