...
EXPORT Wheel_city_clean_Service() := FUNCTION
    SALT44.StrType Input_prefix := '' : STORED('prefix');
    ...
    results := BizLinkFull.Wheel.Fetch_city_clean(SALT44.StringToUppercase(Input_prefix), Input_count, Input_WheelThreshold);
