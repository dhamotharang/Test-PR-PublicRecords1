...
EXPORT input_layout := RECORD // project out required fields
  ...
  h.source_record_id;
  h.source_docid;
  TYPEOF(h.company_name) company_name := (TYPEOF(h.company_name))Fields.Make_company_name((SALT37.StrType)h.company_name ); // Cleans before using
  TYPEOF(h.company_name_prefix) company_name_prefix := (TYPEOF(h.company_name_prefix))Fields.Make_company_name_prefix((SALT37.StrType)h.company_name_prefix ); // Cleans before using
  TYPEOF(h.cnp_name) cnp_name := (TYPEOF(h.cnp_name))Fields.Make_cnp_name((SALT37.StrType)h.cnp_name ); // Cleans before using
  h.cnp_number;
  h.cnp_btype;
  h.cnp_lowv;
  h.company_phone;
  ...
  TYPEOF(h.city_clean) city_clean := (TYPEOF(h.city_clean))Fields.Make_city_clean((SALT37.StrType)h.city_clean ); // Cleans before using
  ...
  TYPEOF(h.company_url) company_url := (TYPEOF(h.company_url))Fields.Make_company_url((SALT37.StrType)h.company_url ); // Cleans before using
  h.isContact;
  h.contact_did;
  h.title;
  ...
  TYPEOF(h.fname_preferred) fname_preferred := (TYPEOF(h.fname_preferred))Fields.Make_fname_preferred((SALT37.StrType)h.fname_preferred ); // Cleans before using
  ...
  h.contact_ssn;
  TYPEOF(h.contact_email) contact_email := (TYPEOF(h.contact_email))Fields.Make_contact_email((SALT37.StrType)h.contact_email ); // Cleans before using
  h.sele_flag;
  h.org_flag;
  h.ult_flag;
  h.fallback_value;
...
EXPORT  parent_proxid_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,parent_proxid) : PERSIST('~temp::proxid::BizLinkFull::dedups::parent_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT parent_proxid_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::parent_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  sele_proxid_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,sele_proxid) : PERSIST('~temp::proxid::BizLinkFull::dedups::sele_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT sele_proxid_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::sele_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  org_proxid_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,org_proxid) : PERSIST('~temp::proxid::BizLinkFull::dedups::org_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT org_proxid_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::org_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  ultimate_proxid_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,ultimate_proxid) : PERSIST('~temp::proxid::BizLinkFull::dedups::ultimate_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ultimate_proxid_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::ultimate_proxid',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  source_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,source) : PERSIST('~temp::proxid::BizLinkFull::dedups::source',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT source_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::source',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  source_record_id_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,source_record_id) : PERSIST('~temp::proxid::BizLinkFull::dedups::source_record_id',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT source_record_id_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::source_record_id',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_name_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_name) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_name',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_name_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_name',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_name_prefix_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_name_prefix) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_name_prefix',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_name_prefix_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_name_prefix',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  cnp_name_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,cnp_name) : PERSIST('~temp::proxid::BizLinkFull::dedups::cnp_name',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT  cnp_number_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,cnp_number) : PERSIST('~temp::proxid::BizLinkFull::dedups::cnp_number',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT cnp_number_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::cnp_number',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  cnp_btype_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,cnp_btype) : PERSIST('~temp::proxid::BizLinkFull::dedups::cnp_btype',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT cnp_btype_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::cnp_btype',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  cnp_lowv_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,cnp_lowv) : PERSIST('~temp::proxid::BizLinkFull::dedups::cnp_lowv',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT cnp_lowv_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::cnp_lowv',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_phone_3_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_phone_3) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_phone_3',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_phone_3_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_phone_3',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_phone_3_ex_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_phone_3_ex) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_phone_3_ex',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_phone_3_ex_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_phone_3_ex',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_phone_7_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_phone_7) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_phone_7',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_phone_7_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_phone_7',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_fein_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_fein) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_fein',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT company_fein_values_persisted := distance_computed : PERSIST('~temp::proxid::BizLinkFull::values::company_fein',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_sic_code1_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_sic_code1) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_sic_code1',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT company_sic_code1_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::company_sic_code1',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  prim_range_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,prim_range) : PERSIST('~temp::proxid::BizLinkFull::dedups::prim_range',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT prim_range_values_persisted := distance_computed : PERSIST('~temp::proxid::BizLinkFull::values::prim_range',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  prim_name_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,prim_name) : PERSIST('~temp::proxid::BizLinkFull::dedups::prim_name',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT prim_name_values_persisted := distance_computed : PERSIST('~temp::proxid::BizLinkFull::values::prim_name',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  sec_range_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,sec_range) : PERSIST('~temp::proxid::BizLinkFull::dedups::sec_range',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT sec_range_values_persisted := distance_computed : PERSIST('~temp::proxid::BizLinkFull::values::sec_range',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  city_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,city) : PERSIST('~temp::proxid::BizLinkFull::dedups::city',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT city_values_persisted := distance_computed : PERSIST('~temp::proxid::BizLinkFull::values::city',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  city_clean_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,city_clean) : PERSIST('~temp::proxid::BizLinkFull::dedups::city_clean',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT city_clean_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::city_clean',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  st_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,st) : PERSIST('~temp::proxid::BizLinkFull::dedups::st',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT st_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::st',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  zip_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,zip) : PERSIST('~temp::proxid::BizLinkFull::dedups::zip',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT zip_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::zip',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  company_url_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,company_url) : PERSIST('~temp::proxid::BizLinkFull::dedups::company_url',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT  isContact_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,isContact) : PERSIST('~temp::proxid::BizLinkFull::dedups::isContact',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT isContact_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::isContact',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  contact_did_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,contact_did) : PERSIST('~temp::proxid::BizLinkFull::dedups::contact_did',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT contact_did_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::contact_did',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  title_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,title) : PERSIST('~temp::proxid::BizLinkFull::dedups::title',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT title_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::title',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  fname_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,fname) : PERSIST('~temp::proxid::BizLinkFull::dedups::fname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT fname_values_persisted := initial_specs_added : PERSIST('~temp::proxid::BizLinkFull::values::fname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  fname_preferred_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,fname_preferred) : PERSIST('~temp::proxid::BizLinkFull::dedups::fname_preferred',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT fname_preferred_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::fname_preferred',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  mname_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,mname) : PERSIST('~temp::proxid::BizLinkFull::dedups::mname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT mname_values_persisted := initial_specs_added : PERSIST('~temp::proxid::BizLinkFull::values::mname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  lname_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,lname) : PERSIST('~temp::proxid::BizLinkFull::dedups::lname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
...
EXPORT lname_values_persisted := initial_specs_added : PERSIST('~temp::proxid::BizLinkFull::values::lname',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  name_suffix_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,name_suffix) : PERSIST('~temp::proxid::BizLinkFull::dedups::name_suffix',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT name_suffix_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::name_suffix',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  contact_ssn_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,contact_ssn) : PERSIST('~temp::proxid::BizLinkFull::dedups::contact_ssn',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT contact_ssn_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::contact_ssn',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  contact_email_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,contact_email) : PERSIST('~temp::proxid::BizLinkFull::dedups::contact_email',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT contact_email_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::contact_email',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  sele_flag_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,sele_flag) : PERSIST('~temp::proxid::BizLinkFull::dedups::sele_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT sele_flag_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::sele_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  org_flag_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,org_flag) : PERSIST('~temp::proxid::BizLinkFull::dedups::org_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT org_flag_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::org_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  ult_flag_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,ult_flag) : PERSIST('~temp::proxid::BizLinkFull::dedups::ult_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ult_flag_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::ult_flag',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  fallback_value_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,fallback_value) : PERSIST('~temp::proxid::BizLinkFull::dedups::fallback_value',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT fallback_value_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::fallback_value',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  CONTACTNAME_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,CONTACTNAME) : PERSIST('~temp::proxid::BizLinkFull::dedups::CONTACTNAME',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CONTACTNAME_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::CONTACTNAME',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT  STREETADDRESS_deduped := SALT37.MAC_Field_By_UID(input_file,proxid,STREETADDRESS) : PERSIST('~temp::proxid::BizLinkFull::dedups::STREETADDRESS',EXPIRE(BizLinkFull.Config_BIP.PersistExpire)); // Reduce to field values by UID
  ...
  SALT37.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT37.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT STREETADDRESS_values_persisted := specs_added : PERSIST('~temp::proxid::BizLinkFull::values::STREETADDRESS',EXPIRE(BizLinkFull.Config_BIP.PersistExpire));
 
EXPORT BuildBOWFields := PARALLEL(BUILDINDEX(cnp_name_values_key, OVERWRITE),BUILDINDEX(company_url_values_key, OVERWRITE));
SALT37.MAC_Field_Nulls(parent_proxid_values_persisted,Layout_Specificities.parent_proxid_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(sele_proxid_values_persisted,Layout_Specificities.sele_proxid_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(org_proxid_values_persisted,Layout_Specificities.org_proxid_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(ultimate_proxid_values_persisted,Layout_Specificities.ultimate_proxid_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(source_values_persisted,Layout_Specificities.source_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(source_record_id_values_persisted,Layout_Specificities.source_record_id_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_name_values_persisted,Layout_Specificities.company_name_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_name_prefix_values_persisted,Layout_Specificities.company_name_prefix_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(cnp_lowv_values_persisted,Layout_Specificities.cnp_lowv_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_phone_3_values_persisted,Layout_Specificities.company_phone_3_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_phone_3_ex_values_persisted,Layout_Specificities.company_phone_3_ex_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_phone_7_values_persisted,Layout_Specificities.company_phone_7_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(company_sic_code1_values_persisted,Layout_Specificities.company_sic_code1_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(city_clean_values_persisted,Layout_Specificities.city_clean_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(contact_did_values_persisted,Layout_Specificities.contact_did_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(fname_preferred_values_persisted,Layout_Specificities.fname_preferred_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(contact_ssn_values_persisted,Layout_Specificities.contact_ssn_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(contact_email_values_persisted,Layout_Specificities.contact_email_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(sele_flag_values_persisted,Layout_Specificities.sele_flag_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(org_flag_values_persisted,Layout_Specificities.org_flag_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(ult_flag_values_persisted,Layout_Specificities.ult_flag_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(CONTACTNAME_values_persisted,Layout_Specificities.CONTACTNAME_ChildRec,nv) // Use automated NULL spotting
...
SALT37.MAC_Field_Nulls(STREETADDRESS_values_persisted,Layout_Specificities.STREETADDRESS_ChildRec,nv) // Use automated NULL spotting
