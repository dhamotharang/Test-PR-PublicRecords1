...
#uniquename(res_out)
SALT44.MAC_Soapcall(%pr%,BizLinkFull.Process_Biz_Layouts.OutputLayout, %Soapcall_RoxieIP_temp%, ServiceModule+'MEOW_Biz_Service', %res_out%,,,Soapcall_Timeout,Soapcall_Time_Limit,Soapcall_Retry,Soapcall_Parallel);
OutFile := %res_out%;
  #IF (#TEXT(Stats)<>'')
