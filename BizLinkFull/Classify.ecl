...
SHARED TotalClusters := Specificities(h).TotalClusters;
  parent_proxid_tokens := PROJECT(Specificities(h).parent_proxid_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.parent_proxid; SELF.TokenType := 1; SELF.Spc := LEFT.field_Specificity ));
  sele_proxid_tokens := PROJECT(Specificities(h).sele_proxid_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.sele_proxid; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  org_proxid_tokens := PROJECT(Specificities(h).org_proxid_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.org_proxid; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  ultimate_proxid_tokens := PROJECT(Specificities(h).ultimate_proxid_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.ultimate_proxid; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  source_tokens := PROJECT(Specificities(h).source_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.source; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  source_record_id_tokens := PROJECT(Specificities(h).source_record_id_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.source_record_id; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
  company_name_tokens := PROJECT(Specificities(h).company_name_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_name; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  company_name_prefix_tokens := PROJECT(Specificities(h).company_name_prefix_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_name_prefix; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  cnp_name_tokens := PROJECT(Specificities(h).cnp_name_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.cnp_name; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
  cnp_number_tokens := PROJECT(Specificities(h).cnp_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.cnp_number; SELF.TokenType := 13; SELF.Spc := LEFT.field_Specificity ));
  cnp_btype_tokens := PROJECT(Specificities(h).cnp_btype_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.cnp_btype; SELF.TokenType := 14; SELF.Spc := LEFT.field_Specificity ));
  cnp_lowv_tokens := PROJECT(Specificities(h).cnp_lowv_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.cnp_lowv; SELF.TokenType := 15; SELF.Spc := LEFT.field_Specificity ));
  company_phone_3_tokens := PROJECT(Specificities(h).company_phone_3_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_phone_3; SELF.TokenType := 17; SELF.Spc := LEFT.field_Specificity ));
  company_phone_3_ex_tokens := PROJECT(Specificities(h).company_phone_3_ex_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_phone_3_ex; SELF.TokenType := 18; SELF.Spc := LEFT.field_Specificity ));
  company_phone_7_tokens := PROJECT(Specificities(h).company_phone_7_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_phone_7; SELF.TokenType := 19; SELF.Spc := LEFT.field_Specificity ));
  company_fein_tokens := PROJECT(Specificities(h).company_fein_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_fein; SELF.TokenType := 20; SELF.Spc := LEFT.field_Specificity ));
  company_sic_code1_tokens := PROJECT(Specificities(h).company_sic_code1_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_sic_code1; SELF.TokenType := 21; SELF.Spc := LEFT.field_Specificity ));
  prim_range_tokens := PROJECT(Specificities(h).prim_range_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.prim_range; SELF.TokenType := 23; SELF.Spc := LEFT.field_Specificity ));
  prim_name_tokens := PROJECT(Specificities(h).prim_name_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.prim_name; SELF.TokenType := 24; SELF.Spc := LEFT.field_Specificity ));
  sec_range_tokens := PROJECT(Specificities(h).sec_range_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.sec_range; SELF.TokenType := 25; SELF.Spc := LEFT.field_Specificity ));
  city_tokens := PROJECT(Specificities(h).city_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.city; SELF.TokenType := 26; SELF.Spc := LEFT.field_Specificity ));
  city_clean_tokens := PROJECT(Specificities(h).city_clean_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.city_clean; SELF.TokenType := 27; SELF.Spc := LEFT.field_Specificity ));
  st_tokens := PROJECT(Specificities(h).st_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.st; SELF.TokenType := 28; SELF.Spc := LEFT.field_Specificity ));
  zip_tokens := PROJECT(Specificities(h).zip_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.zip; SELF.TokenType := 29; SELF.Spc := LEFT.field_Specificity ));
  company_url_tokens := PROJECT(Specificities(h).company_url_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.company_url; SELF.TokenType := 30; SELF.Spc := LEFT.field_Specificity ));
  isContact_tokens := PROJECT(Specificities(h).isContact_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.isContact; SELF.TokenType := 31; SELF.Spc := LEFT.field_Specificity ));
  contact_did_tokens := PROJECT(Specificities(h).contact_did_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.contact_did; SELF.TokenType := 32; SELF.Spc := LEFT.field_Specificity ));
  title_tokens := PROJECT(Specificities(h).title_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.title; SELF.TokenType := 33; SELF.Spc := LEFT.field_Specificity ));
  fname_tokens := PROJECT(Specificities(h).fname_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.fname; SELF.TokenType := 34; SELF.Spc := LEFT.field_Specificity ));
  fname_preferred_tokens := PROJECT(Specificities(h).fname_preferred_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.fname_preferred; SELF.TokenType := 35; SELF.Spc := LEFT.field_Specificity ));
  mname_tokens := PROJECT(Specificities(h).mname_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.mname; SELF.TokenType := 36; SELF.Spc := LEFT.field_Specificity ));
  lname_tokens := PROJECT(Specificities(h).lname_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.lname; SELF.TokenType := 37; SELF.Spc := LEFT.field_Specificity ));
  name_suffix_tokens := PROJECT(Specificities(h).name_suffix_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.name_suffix; SELF.TokenType := 38; SELF.Spc := LEFT.field_Specificity ));
  contact_ssn_tokens := PROJECT(Specificities(h).contact_ssn_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.contact_ssn; SELF.TokenType := 39; SELF.Spc := LEFT.field_Specificity ));
  contact_email_tokens := PROJECT(Specificities(h).contact_email_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.contact_email; SELF.TokenType := 40; SELF.Spc := LEFT.field_Specificity ));
  sele_flag_tokens := PROJECT(Specificities(h).sele_flag_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.sele_flag; SELF.TokenType := 41; SELF.Spc := LEFT.field_Specificity ));
  org_flag_tokens := PROJECT(Specificities(h).org_flag_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.org_flag; SELF.TokenType := 42; SELF.Spc := LEFT.field_Specificity ));
  ult_flag_tokens := PROJECT(Specificities(h).ult_flag_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.ult_flag; SELF.TokenType := 43; SELF.Spc := LEFT.field_Specificity ));
  fallback_value_tokens := PROJECT(Specificities(h).fallback_value_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.fallback_value; SELF.TokenType := 44; SELF.Spc := LEFT.field_Specificity ));
...
EXPORT MultiTokenKey := INDEX(all_tokens0(SALT311.WordCount(TokenValue)>1),{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens0},MultiTokenKeyName);
  CONTACTNAME_tokens := PROJECT(Specificities(h).CONTACTNAME_values_persisted,TRANSFORM(SALT311.Layout_Classify_Concept,SELF.ConceptHash := LEFT.CONTACTNAME; SELF.TokenType := 45; SELF.Spc := LEFT.field_Specificity ));
  STREETADDRESS_tokens := PROJECT(Specificities(h).STREETADDRESS_values_persisted,TRANSFORM(SALT311.Layout_Classify_Concept,SELF.ConceptHash := LEFT.STREETADDRESS; SELF.TokenType := 46; SELF.Spc := LEFT.field_Specificity ));
