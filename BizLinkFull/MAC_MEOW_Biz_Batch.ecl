EXPORT MAC_MEOW_Biz_Batch(infile,Ref='',Input_parent_proxid = '',Input_sele_proxid = '',Input_org_proxid = '',Input_ultimate_proxid = '',Input_has_lgid = '',Input_empid = '',Input_source = '',Input_source_record_id = '',Input_source_docid = '',Input_company_name = '',Input_company_name_prefix = '',Input_cnp_name = '',Input_cnp_number = '',Input_cnp_btype = '',Input_cnp_lowv = '',Input_company_phone = '',Input_company_phone_3 = '',Input_company_phone_3_ex = '',Input_company_phone_7 = '',Input_company_fein = '',Input_company_sic_code1 = '',Input_active_duns_number = '',Input_prim_range = '',Input_prim_name = '',Input_sec_range = '',Input_city = '',Input_city_clean = '',Input_st = '',Input_zip = '',Input_company_url = '',Input_isContact = '',Input_contact_did = '',Input_title = '',Input_fname = '',Input_fname_preferred = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',Input_contact_ssn = '',Input_contact_email = '',Input_sele_flag = '',Input_org_flag = '',Input_ult_flag = '',Input_fallback_value = '',Input_CONTACTNAME = '',Input_STREETADDRESS = '',OutFile,AsIndex='true',Stats='',bIncludeFilter=TRUE,/*HACK22*/bGetAllScores=TRUE) := MACRO
  ...
  %TPRec% %CleanT%(%fats0% le) := TRANSFORM
    ...
    SELF.company_name := (TYPEOF(SELF.company_name))BizLinkFull.Fields.Make_company_name((SALT33.StrType)le.company_name);
    SELF.company_name_prefix := (TYPEOF(SELF.company_name_prefix))BizLinkFull.Fields.Make_company_name_prefix((SALT33.StrType)le.company_name_prefix);
    SELF.cnp_name := (TYPEOF(SELF.cnp_name))BizLinkFull.Fields.Make_cnp_name((SALT33.StrType)le.cnp_name);
    ...
    SELF.company_fein := IF ( BizLinkFull.Fields.Invalid_company_fein((SALT33.StrType)le.company_fein)=0,(TYPEOF(SELF.company_fein))le.company_fein,(TYPEOF(SELF.company_fein))'');
    ...
    SELF.prim_name := (TYPEOF(SELF.prim_name))BizLinkFull.Fields.Make_prim_name((SALT33.StrType)le.prim_name);
    SELF.sec_range := (TYPEOF(SELF.sec_range))BizLinkFull.Fields.Make_sec_range((SALT33.StrType)le.sec_range);
    SELF.city := (TYPEOF(SELF.city))BizLinkFull.Fields.Make_city((SALT33.StrType)le.city);
    SELF.city_clean := (TYPEOF(SELF.city_clean))BizLinkFull.Fields.Make_city_clean((SALT33.StrType)le.city_clean);
    SELF.st := (TYPEOF(SELF.st))BizLinkFull.Fields.Make_st((SALT33.StrType)le.st);
    SELF.zip_cases := le.zip_cases;
    SELF.company_url := (TYPEOF(SELF.company_url))BizLinkFull.Fields.Make_company_url((SALT33.StrType)le.company_url);
    ...
    SELF.fname := (TYPEOF(SELF.fname))BizLinkFull.Fields.Make_fname((SALT33.StrType)le.fname);
    SELF.fname_preferred := (TYPEOF(SELF.fname_preferred))BizLinkFull.Fields.Make_fname_preferred((SALT33.StrType)le.fname_preferred);
    SELF.mname := (TYPEOF(SELF.mname))BizLinkFull.Fields.Make_mname((SALT33.StrType)le.mname);
    SELF.lname := (TYPEOF(SELF.lname))BizLinkFull.Fields.Make_lname((SALT33.StrType)le.lname);
    SELF.name_suffix := (TYPEOF(SELF.name_suffix))BizLinkFull.Fields.Make_name_suffix((SALT33.StrType)le.name_suffix);
    SELF.contact_ssn := (TYPEOF(SELF.contact_ssn))le.contact_ssn;
    SELF.contact_email := (TYPEOF(SELF.contact_email))BizLinkFull.Fields.Make_contact_email((SALT33.StrType)le.contact_email);
 ...
 // In case multiple copies of the same indicative are in there - remove them
  SALT33.MAC_Dups_Note(%fats1%,%TPRec%,%fats%,%dups%,,BizLinkFull.Config.meow_dedup);
...
#IF(#TEXT(Input_cnp_name)<>'')
  ...
  BizLinkFull.Key_BizHead_L_CNPNAME.MAC_ScoredFetch_Batch(%HoldL_CNPNAME%,UniqueId,cnp_name_wb,prim_name,st,city,company_sic_code1,cnp_number,cnp_btype,cnp_lowv,prim_range,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,zip_cases,%OutputL_CNPNAME%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_prim_name)<>'' AND #TEXT(Input_city)<>'' AND #TEXT(Input_st)<>'')
  ...
  BizLinkFull.Key_BizHead_L_ADDRESS1.MAC_ScoredFetch_Batch(%HoldL_ADDRESS1%,UniqueId,prim_name,city,st,prim_range,cnp_name_wb,zip_cases,company_sic_code1,cnp_number,cnp_btype,cnp_lowv,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_ADDRESS1%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_prim_name)<>'' AND #TEXT(Input_zip)<>'')
  ...
  BizLinkFull.Key_BizHead_L_ADDRESS2.MAC_ScoredFetch_Batch(%HoldL_ADDRESS2%,UniqueId,prim_name,zip_cases,prim_range,cnp_name_wb,st,city,company_sic_code1,cnp_number,cnp_btype,cnp_lowv,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_ADDRESS2%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_prim_name)<>'' AND #TEXT(Input_prim_range)<>'' AND #TEXT(Input_zip)<>'')
  ...
  BizLinkFull.Key_BizHead_L_ADDRESS3.MAC_ScoredFetch_Batch(%HoldL_ADDRESS3%,UniqueId,prim_name,prim_range,zip_cases,cnp_name_wb,st,city,company_sic_code1,cnp_number,cnp_btype,cnp_lowv,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_ADDRESS3%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_company_fein)<>'')
  ...
  BizLinkFull.Key_BizHead_L_FEIN.MAC_ScoredFetch_Batch(%HoldL_FEIN%,UniqueId,company_fein,company_sic_code1,cnp_name_wb,cnp_number,cnp_btype,cnp_lowv,zip_cases,prim_name,city,st,prim_range,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_FEIN%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_company_url)<>'')
  ...
  %HoldL_URL% := %ToProcess%;
  BizLinkFull.Key_BizHead_L_URL.MAC_ScoredFetch_Batch(%HoldL_URL%,UniqueId,company_url_wb,st,company_sic_code1,cnp_name_wb,cnp_number,cnp_btype,cnp_lowv,zip_cases,prim_name,city,prim_range,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_URL%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_contact_email)<>'')
  ...
  BizLinkFull.Key_BizHead_L_EMAIL.MAC_ScoredFetch_Batch(%HoldL_EMAIL%,UniqueId,contact_email,company_sic_code1,cnp_name_wb,cnp_number,cnp_btype,cnp_lowv,zip_cases,prim_name,city,st,prim_range,sec_range,parent_proxid,sele_proxid,org_proxid,ultimate_proxid,sele_flag,org_flag,ult_flag,%OutputL_EMAIL%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_company_sic_code1)<>'' AND #TEXT(Input_zip)<>'')
  ...
  %HoldL_SIC% := %ToProcess%;
  BizLinkFull.Key_BizHead_L_SIC.MAC_ScoredFetch_Batch(%HoldL_SIC%,UniqueId,company_sic_code1,zip_cases,cnp_name_wb,prim_name,%OutputL_SIC%,AsIndex)
#ELSE
...
#IF(#TEXT(Input_contact_did)<>'')
  ...
  BizLinkFull.Key_BizHead_L_CONTACT_DID.MAC_ScoredFetch_Batch(%HoldL_CONTACT_DID%,UniqueId,contact_did,%OutputL_CONTACT_DID%,AsIndex)
#ELSE
...
#END
  ...
  #uniquename(All)
  %All% := BizLinkFull.Process_Biz_Layouts.CombineAllScores(%AllRes%,bIncludeFilter/*HACK13*/,/*HACK22*/bGetAllScores);
  #uniquename(OutFile0)
