...
Input_Data := DATASET([{(TYPEOF(Template.UniqueID))Input_UniqueID,Input_MaxIds,Input_LeadThreshold,TRUE,TRUE,0
  ...
  ,(TYPEOF(Template.company_name_prefix))THISMODULE.Fields.Make_company_name_prefix((SALT311.StrType)dCnpName[1].cnp_name[..5])
  ...
  ,(TYPEOF(Template.company_fein))THISMODULE.Fields.Make_company_fein((SALT311.StrType)Input_company_fein)
