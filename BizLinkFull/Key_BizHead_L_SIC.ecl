...
EXPORT CanSearch(Process_Biz_Layouts.InputLayout le) := le.company_sic_code1 <> (TYPEOF(le.company_sic_code1))'' AND Fields.InValid_company_sic_code1((SALT311.StrType)le.company_sic_code1)=0 AND EXISTS(le.zip_cases);
KeyRec := RECORDOF(Key);
