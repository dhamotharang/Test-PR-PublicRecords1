...
// This is the 'thor only' version (no roxie)
  ...
  myinfile := DATASET([], {BizLinkFull.Layout_BizHead, UNSIGNED myreference_number});
  BizLinkFull.Config_BIP.MAC_Meow_Biz_Batch_Wrapper(myinfile,myreference_number,/* MY_proxid */,/* MY_seleid */,/* MY_orgid */,/* MY_ultid */,/* MY_parent_proxid*/,/* MY_sele_proxid*/,/* MY_org_proxid*/,/* MY_ultimate_proxid*/
          ...
          ,/* MY_CONTACTNAME*/,/* MY_STREETADDRESS*/,MyOutFile,SmallJob,InUpdateIDs,Stats,GetAllScores,DisableForce,DoClean);
//The online version can be used if a Roxie version of the xproxid is available
//  BizLinkFull.MAC_Meow_Biz_Online(myinfile,myreference_number,/* MY_parent_proxid*/,/* MY_sele_proxid*/,/* MY_org_proxid*/,/* MY_ultimate_proxid*/
//        ,/* MY_has_lgid*/,/* MY_empid*/,/* MY_source*/,/* MY_source_record_id*/,/* MY_source_docid*/
//        ,/* MY_company_name*/,/* MY_company_name_prefix*/,/* MY_cnp_name*/,/* MY_cnp_number*/,/* MY_cnp_btype*/
//        ,/* MY_cnp_lowv*/,/* MY_company_phone*/,/* MY_company_phone_3*/,/* MY_company_phone_3_ex*/,/* MY_company_phone_7*/
//        ,/* MY_company_fein*/,/* MY_company_sic_code1*/,/* MY_active_duns_number*/,/* MY_prim_range*/,/* MY_prim_name*/
