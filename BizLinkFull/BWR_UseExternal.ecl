...
#workunit('name','BizLinkFull.BWR_UseExternal - Using External Linking - SALT V3.3.1');
IMPORT BizLinkFull,SALT33;
// For any fields you have replace the /* */ 
 
// This is the 'thor only' version (no roxie)
  SmallJob := TRUE;
  BizLinkFull.Config_BIP.MAC_Meow_Biz_Batch_Wrapper(myinfile,myrefence_number,/* MY_parent_proxid*/,/* MY_sele_proxid*/,/* MY_org_proxid*/,/* MY_ultimate_proxid*/
