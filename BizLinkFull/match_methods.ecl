...
EXPORT match_parent_proxid(TYPEOF(h.parent_proxid) L, TYPEOF(h.parent_proxid) R,  BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    SALT44.MatchCode.NoMatch),
     MAP(L = R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_cnp_name(TYPEOF(h.cnp_name) L, TYPEOF(h.cnp_name) R,  BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(SALT44.WordBagsEqual(L,R) => SALT44.MatchCode.ExactMatch,
    SALT44.MatchBagOfWords(L,R,3177747,1) <> 0 => SALT44.MatchCode.WordBagMatch,
    SALT44.MatchCode.NoMatch),
     MAP(SALT44.WordBagsEqual(L,R) => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_company_fein(TYPEOF(h.company_fein) L, TYPEOF(h.company_fein) R,  UNSIGNED1 LL = 0, UNSIGNED1 RL = 0, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    Config_BIP.WithinEditN(L,LL,R,RL,1,0)=> SALT44.MatchCode.EditDistanceMatch,
    SALT44.MatchCode.NoMatch),
     MAP(L = R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_city(TYPEOF(h.city) L, TYPEOF(h.city) R,  UNSIGNED1 LL = 0, UNSIGNED1 RL = 0, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    Config_BIP.WithinEditN(L,LL,R,RL,2,0)=> SALT44.MatchCode.EditDistanceMatch,
    metaphonelib.dmetaphone1(L) = metaphonelib.dmetaphone1(R) => SALT44.MatchCode.PhoneticMatch,
    SALT44.MatchCode.NoMatch),
     MAP(L = R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_zip_el(TYPEOF(h.zip) L, SET OF TYPEOF(h.zip) R, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L IN R => SALT44.MatchCode.ExactMatch,
    SALT44.MatchCode.NoMatch),
     MAP(L IN R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_company_url(TYPEOF(h.company_url) L, TYPEOF(h.company_url) R,  BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(SALT44.WordBagsEqual(L,R) => SALT44.MatchCode.ExactMatch,
    SALT44.MatchBagOfWords(L,R,31744,0) <> 0 => SALT44.MatchCode.WordBagMatch,
    SALT44.MatchCode.NoMatch),
     MAP(SALT44.WordBagsEqual(L,R) => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_fname(TYPEOF(h.fname) L, TYPEOF(h.fname) R,  UNSIGNED1 LL = 0, UNSIGNED1 RL = 0, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    LENGTH(TRIM(L))>0 and L = R[1..LENGTH(TRIM(L))] => SALT44.MatchCode.InitialLMatch,
    LENGTH(TRIM(R))>0 and R = L[1..LENGTH(TRIM(R))] => SALT44.MatchCode.InitialRMatch,
    Config_BIP.WithinEditN(L,LL,R,RL,1,0)=> SALT44.MatchCode.EditDistanceMatch,
    SALT44.MatchCode.NoMatch),
     MAP(L = R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
...
EXPORT match_lname(TYPEOF(h.lname) L, TYPEOF(h.lname) R,  UNSIGNED1 LL = 0, UNSIGNED1 RL = 0, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    SALT44.HyphenMatch(L,R,1)<=2 => SALT44.MatchCode.HyphenMatch,
    LENGTH(TRIM(L))>0 and L = R[1..LENGTH(TRIM(L))] => SALT44.MatchCode.InitialLMatch,
    LENGTH(TRIM(R))>0 and R = L[1..LENGTH(TRIM(R))] => SALT44.MatchCode.InitialRMatch,
    Config_BIP.WithinEditN(L,LL,R,RL,2,0)=> SALT44.MatchCode.EditDistanceMatch,
    SALT44.MatchCode.NoMatch),
...
EXPORT match_name_suffix(TYPEOF(h.name_suffix) L, TYPEOF(h.name_suffix) R,  BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT44.MatchCode.ExactMatch,
    fn_normSuffix(L) =  fn_normSuffix(R) => SALT44.MatchCode.CustomFuzzyMatch, // Compare fn_normSuffix values
    SALT44.MatchCode.NoMatch),
     MAP(L = R => SALT44.MatchCode.ExactMatch, SALT44.MatchCode.NoMatch)
);
