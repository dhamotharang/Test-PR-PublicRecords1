...
EXPORT id_stream_layout := RECORD
    ...
    SALT311.UIDType seleid;
    INTEGER2 seleid_weight;
    UNSIGNED2 seleid_score;
    SALT311.UIDType orgid;
    INTEGER2 orgid_weight;
    UNSIGNED2 orgid_score;
    SALT311.UIDType ultid;
    INTEGER2 ultid_weight;
    UNSIGNED2 ultid_score;
    SALT311.UIDType proxid;
    SALT311.UIDType powid; // Is an UNCLE - may be left blank unless required for filtering
    INTEGER2 powid_weight;
    UNSIGNED2 powid_score;
    SALT311.UIDType rcid := 0; // Unique record ID for external file
END;
...
EXPORT InputLayout := RECORD
  ...
  h.ult_flag;
  h.fallback_value;
  SALT311.StrType CONTACTNAME;//Wordbag field for concept
  SALT311.StrType STREETADDRESS;//Wordbag field for concept
// Below only used in header search (data returning) case
  ...
  SALT311.UIDType Entered_rcid := 0; // Allow user to enter rcid to pull data
  SALT311.UIDType Entered_proxid := 0; // Allow user to enter proxid to pull data
  SALT311.UIDType Entered_seleid := 0; // Allow user to enter seleid to pull data
  SALT311.UIDType Entered_orgid := 0; // Allow user to enter orgid to pull data
  SALT311.UIDType Entered_ultid := 0; // Allow user to enter ultid to pull data
  SALT311.UIDType Entered_powid := 0; // Allow user to enter powid to pull data
END;
...
EXPORT CleanInput(DATASET(InputLayout) inData) := FUNCTION
  InputLayout CleanT(inData le) := TRANSFORM
    ...
    SELF.company_name := (TYPEOF(SELF.company_name))BizLinkFull.Fields.Make_company_name((SALT311.StrType)le.company_name);
    SELF.company_name_prefix := (TYPEOF(SELF.company_name_prefix))BizLinkFull.Fields.Make_company_name_prefix((SALT311.StrType)le.company_name_prefix);
    SELF.cnp_name := (TYPEOF(SELF.cnp_name))BizLinkFull.Fields.Make_cnp_name((SALT311.StrType)le.cnp_name);
    ...
    SELF.company_fein := IF ( BizLinkFull.Fields.Invalid_company_fein((SALT311.StrType)le.company_fein)=0,(TYPEOF(SELF.company_fein))le.company_fein,(TYPEOF(SELF.company_fein))'');
    ...
    SELF.prim_name := (TYPEOF(SELF.prim_name))BizLinkFull.Fields.Make_prim_name((SALT311.StrType)le.prim_name);
    SELF.sec_range := (TYPEOF(SELF.sec_range))BizLinkFull.Fields.Make_sec_range((SALT311.StrType)le.sec_range);
    SELF.city := (TYPEOF(SELF.city))BizLinkFull.Fields.Make_city((SALT311.StrType)le.city);
    SELF.city_clean := (TYPEOF(SELF.city_clean))BizLinkFull.Fields.Make_city_clean((SALT311.StrType)le.city_clean);
    SELF.st := (TYPEOF(SELF.st))BizLinkFull.Fields.Make_st((SALT311.StrType)le.st);
    SELF.zip_cases := le.zip_cases;
    SELF.company_url := (TYPEOF(SELF.company_url))BizLinkFull.Fields.Make_company_url((SALT311.StrType)le.company_url);
    ...
    SELF.fname := (TYPEOF(SELF.fname))BizLinkFull.Fields.Make_fname((SALT311.StrType)le.fname);
    SELF.fname_preferred := (TYPEOF(SELF.fname_preferred))BizLinkFull.Fields.Make_fname_preferred((SALT311.StrType)le.fname_preferred);
    SELF.mname := (TYPEOF(SELF.mname))BizLinkFull.Fields.Make_mname((SALT311.StrType)le.mname);
    SELF.lname := (TYPEOF(SELF.lname))BizLinkFull.Fields.Make_lname((SALT311.StrType)le.lname);
    SELF.name_suffix := (TYPEOF(SELF.name_suffix))BizLinkFull.Fields.Make_name_suffix((SALT311.StrType)le.name_suffix);
    SELF.contact_ssn := (TYPEOF(SELF.contact_ssn))le.contact_ssn;
    SELF.contact_email := (TYPEOF(SELF.contact_email))BizLinkFull.Fields.Make_contact_email((SALT311.StrType)le.contact_email);
...
Layout_Candidates0 := RECORD
  ...
  inpu.company_fein;
  UNSIGNED1 company_fein_len := LENGTH(TRIM((SALT311.StrType)inpu.company_fein));
  inpu.company_sic_code1;
  inpu.active_duns_number;
  inpu.prim_range;
  UNSIGNED1 prim_range_len := LENGTH(TRIM((SALT311.StrType)inpu.prim_range));
  inpu.prim_name;
  UNSIGNED1 prim_name_len := LENGTH(TRIM((SALT311.StrType)inpu.prim_name));
  inpu.sec_range;
  UNSIGNED1 sec_range_len := LENGTH(TRIM((SALT311.StrType)inpu.sec_range));
  inpu.city;
  UNSIGNED1 city_len := LENGTH(TRIM((SALT311.StrType)inpu.city));
  inpu.city_clean;
  inpu.st;
  ...
  inpu.title;
  inpu.fname;
  UNSIGNED1 fname_len := LENGTH(TRIM((SALT311.StrType)inpu.fname));
  inpu.fname_preferred;
  inpu.mname;
  UNSIGNED1 mname_len := LENGTH(TRIM((SALT311.StrType)inpu.mname));
  inpu.lname;
  UNSIGNED1 lname_len := LENGTH(TRIM((SALT311.StrType)inpu.lname));
  inpu.name_suffix;
  inpu.contact_ssn;
  inpu.contact_email;
  inpu.sele_flag;
...
layout_candidates add_name_suffix(layout_candidates le,Specificities(ih).name_suffix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j31,s.nulls_name_suffix,Specificities(ih).name_suffix_values_persisted,name_suffix,name_suffix_weight100,add_name_suffix,j30);
layout_candidates add_fname(layout_candidates le,Specificities(ih).fname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j30,s.nulls_fname,Specificities(ih).fname_values_persisted,fname,fname_weight100,add_fname,j29);
...
layout_candidates add_fname_preferred(layout_candidates le,Specificities(ih).fname_preferred_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j28,s.nulls_fname_preferred,Specificities(ih).fname_preferred_values_persisted,fname_preferred,fname_preferred_weight100,add_fname_preferred,j27);
layout_candidates add_company_phone_3_ex(layout_candidates le,Specificities(ih).company_phone_3_ex_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j27,s.nulls_company_phone_3_ex,Specificities(ih).company_phone_3_ex_values_persisted,company_phone_3_ex,company_phone_3_ex_weight100,add_company_phone_3_ex,j26);
layout_candidates add_company_phone_3(layout_candidates le,Specificities(ih).company_phone_3_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j26,s.nulls_company_phone_3,Specificities(ih).company_phone_3_values_persisted,company_phone_3,company_phone_3_weight100,add_company_phone_3,j25);
layout_candidates add_lname(layout_candidates le,Specificities(ih).lname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j25,s.nulls_lname,Specificities(ih).lname_values_persisted,lname,lname_weight100,add_lname,j24);
layout_candidates add_company_sic_code1(layout_candidates le,Specificities(ih).company_sic_code1_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j24,s.nulls_company_sic_code1,Specificities(ih).company_sic_code1_values_persisted,company_sic_code1,company_sic_code1_weight100,add_company_sic_code1,j23);
layout_candidates add_city_clean(layout_candidates le,Specificities(ih).city_clean_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j23,s.nulls_city_clean,Specificities(ih).city_clean_values_persisted,city_clean,city_clean_weight100,add_city_clean,j22);
layout_candidates add_city(layout_candidates le,Specificities(ih).city_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j22,s.nulls_city,Specificities(ih).city_values_persisted,city,city_weight100,add_city,j21);
...
layout_candidates add_prim_range(layout_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j20,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_prim_range,j19);
layout_candidates add_cnp_number(layout_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j19,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_cnp_number,j18);
layout_candidates add_zip(layout_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j18,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_zip,j17);
layout_candidates add_prim_name(layout_candidates le,Specificities(ih).prim_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j17,s.nulls_prim_name,Specificities(ih).prim_name_values_persisted,prim_name,prim_name_weight100,add_prim_name,j16);
layout_candidates add_company_name_prefix(layout_candidates le,Specificities(ih).company_name_prefix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j16,s.nulls_company_name_prefix,Specificities(ih).company_name_prefix_values_persisted,company_name_prefix,company_name_prefix_weight100,add_company_name_prefix,j15);
layout_candidates add_STREETADDRESS(layout_candidates le,Specificities(ih).STREETADDRESS_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j15,s.nulls_STREETADDRESS,Specificities(ih).STREETADDRESS_values_persisted,STREETADDRESS,STREETADDRESS_weight100,add_STREETADDRESS,j14);
layout_candidates add_CONTACTNAME(layout_candidates le,Specificities(ih).CONTACTNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j14,s.nulls_CONTACTNAME,Specificities(ih).CONTACTNAME_values_persisted,CONTACTNAME,CONTACTNAME_weight100,add_CONTACTNAME,j13);
layout_candidates add_company_phone_7(layout_candidates le,Specificities(ih).company_phone_7_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j13,s.nulls_company_phone_7,Specificities(ih).company_phone_7_values_persisted,company_phone_7,company_phone_7_weight100,add_company_phone_7,j12);
layout_candidates add_contact_did(layout_candidates le,Specificities(ih).contact_did_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j12,s.nulls_contact_did,Specificities(ih).contact_did_values_persisted,contact_did,contact_did_weight100,add_contact_did,j11);
...
layout_candidates add_cnp_name(layout_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.cnp_name := IF( ri.field_specificity<>0 or ri.word<>'',SELF.cnp_name_weight100+' '+ri.word,SALT311.Fn_WordBag_AppendSpecs_Fake(le.cnp_name) );// Copy in annotated wordstring
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j10,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_cnp_name,j9);
layout_candidates add_company_name(layout_candidates le,Specificities(ih).company_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j9,s.nulls_company_name,Specificities(ih).company_name_values_persisted,company_name,company_name_weight100,add_company_name,j8);
layout_candidates add_contact_email(layout_candidates le,Specificities(ih).contact_email_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j8,s.nulls_contact_email,Specificities(ih).contact_email_values_persisted,contact_email,contact_email_weight100,add_contact_email,j7);
layout_candidates add_contact_ssn(layout_candidates le,Specificities(ih).contact_ssn_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j7,s.nulls_contact_ssn,Specificities(ih).contact_ssn_values_persisted,contact_ssn,contact_ssn_weight100,add_contact_ssn,j6);
layout_candidates add_company_url(layout_candidates le,Specificities(ih).company_url_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.company_url := IF( ri.field_specificity<>0 or ri.word<>'',SELF.company_url_weight100+' '+ri.word,SALT311.Fn_WordBag_AppendSpecs_Fake(le.company_url) );// Copy in annotated wordstring
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j6,s.nulls_company_url,Specificities(ih).company_url_values_persisted,company_url,company_url_weight100,add_company_url,j5);
layout_candidates add_source_record_id(layout_candidates le,Specificities(ih).source_record_id_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j5,s.nulls_source_record_id,Specificities(ih).source_record_id_values_persisted,source_record_id,source_record_id_weight100,add_source_record_id,j4);
layout_candidates add_ultimate_proxid(layout_candidates le,Specificities(ih).ultimate_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j4,s.nulls_ultimate_proxid,Specificities(ih).ultimate_proxid_values_persisted,ultimate_proxid,ultimate_proxid_weight100,add_ultimate_proxid,j3);
layout_candidates add_org_proxid(layout_candidates le,Specificities(ih).org_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j3,s.nulls_org_proxid,Specificities(ih).org_proxid_values_persisted,org_proxid,org_proxid_weight100,add_org_proxid,j2);
layout_candidates add_sele_proxid(layout_candidates le,Specificities(ih).sele_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j2,s.nulls_sele_proxid,Specificities(ih).sele_proxid_values_persisted,sele_proxid,sele_proxid_weight100,add_sele_proxid,j1);
layout_candidates add_parent_proxid(layout_candidates le,Specificities(ih).parent_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j1,s.nulls_parent_proxid,Specificities(ih).parent_proxid_values_persisted,parent_proxid,parent_proxid_weight100,add_parent_proxid,j0);
...
Layout_Scaled_Candidates ProcessConceptScaling(j0 le) := TRANSFORM
  ...
  SELF.prim_range_weight100 := SALT311.Min0(le.prim_range_weight100); // Precompute the scale
  SELF.prim_range_e1_Weight100 := SALT311.Min0(le.prim_range_weight100 + 100*log(le.prim_range_cnt/le.prim_range_e1_cnt)/log(2)); // Precompute edit-distance specificity
  SELF.prim_name_weight100 := SALT311.Min0(le.prim_name_weight100); // Precompute the scale
  SELF.prim_name_e1_Weight100 := SALT311.Min0(le.prim_name_weight100 + 100*log(le.prim_name_cnt/le.prim_name_e1_cnt)/log(2)); // Precompute edit-distance specificity
  SELF.sec_range_weight100 := SALT311.Min0(le.sec_range_weight100); // Precompute the scale
  SELF.sec_range_e1_Weight100 := SALT311.Min0(le.sec_range_weight100 + 100*log(le.sec_range_cnt/le.sec_range_e1_cnt)/log(2)); // Precompute edit-distance specificity
  SELF := le;
END;
...
EXPORT LayoutScoredFetch := RECORD // Nulls required for linkpaths that do not have field
  ...
  DATASET(SALT311.layout_gss_cases) cnp_name_GSS_cases := DATASET([],SALT311.layout_gss_cases);
  ...
  DATASET(SALT311.layout_gss_cases) company_url_GSS_cases := DATASET([],SALT311.layout_gss_cases);
  ...
  SALT311.StrType CONTACTNAME := ''; // Concepts always a wordbag
  INTEGER2 CONTACTNAMEWeight := 0;
  INTEGER1 CONTACTNAME_match_code := 0;
  SALT311.StrType STREETADDRESS := ''; // Concepts always a wordbag
...
aggregateRec := RECORD
  in_data.reference;
  parent_proxidWeight := MAX(GROUP,IF( in_data.parent_proxid_match_code=SALT311.MatchCode.ExactMatch, in_data.parent_proxidWeight,0 ));
  sele_proxidWeight := MAX(GROUP,IF( in_data.sele_proxid_match_code=SALT311.MatchCode.ExactMatch, in_data.sele_proxidWeight,0 ));
  org_proxidWeight := MAX(GROUP,IF( in_data.org_proxid_match_code=SALT311.MatchCode.ExactMatch, in_data.org_proxidWeight,0 ));
  ultimate_proxidWeight := MAX(GROUP,IF( in_data.ultimate_proxid_match_code=SALT311.MatchCode.ExactMatch, in_data.ultimate_proxidWeight,0 ));
  has_lgidWeight := MAX(GROUP,IF( in_data.has_lgid_match_code=SALT311.MatchCode.ExactMatch, in_data.has_lgidWeight,0 ));
  empidWeight := MAX(GROUP,IF( in_data.empid_match_code=SALT311.MatchCode.ExactMatch, in_data.empidWeight,0 ));
  sourceWeight := MAX(GROUP,IF( in_data.source_match_code=SALT311.MatchCode.ExactMatch, in_data.sourceWeight,0 ));
  source_record_idWeight := MAX(GROUP,IF( in_data.source_record_id_match_code=SALT311.MatchCode.ExactMatch, in_data.source_record_idWeight,0 ));
  source_docidWeight := MAX(GROUP,IF( in_data.source_docid_match_code=SALT311.MatchCode.ExactMatch, in_data.source_docidWeight,0 ));
  company_nameWeight := MAX(GROUP,IF( in_data.company_name_match_code=SALT311.MatchCode.ExactMatch, in_data.company_nameWeight,0 ));
  company_name_prefixWeight := MAX(GROUP,IF( in_data.company_name_prefix_match_code=SALT311.MatchCode.ExactMatch, in_data.company_name_prefixWeight,0 ));
  cnp_nameWeight := MAX(GROUP,IF( in_data.cnp_name_match_code=SALT311.MatchCode.ExactMatch, in_data.cnp_nameWeight,0 ));
  cnp_numberWeight := MAX(GROUP,IF( in_data.cnp_number_match_code=SALT311.MatchCode.ExactMatch, in_data.cnp_numberWeight,0 ));
  cnp_btypeWeight := MAX(GROUP,IF( in_data.cnp_btype_match_code=SALT311.MatchCode.ExactMatch, in_data.cnp_btypeWeight,0 ));
  cnp_lowvWeight := MAX(GROUP,IF( in_data.cnp_lowv_match_code=SALT311.MatchCode.ExactMatch, in_data.cnp_lowvWeight,0 ));
  company_phoneWeight := MAX(GROUP,IF( in_data.company_phone_match_code=SALT311.MatchCode.ExactMatch, in_data.company_phoneWeight,0 ));
  company_phone_3Weight := MAX(GROUP,IF( in_data.company_phone_3_match_code=SALT311.MatchCode.ExactMatch, in_data.company_phone_3Weight,0 ));
  company_phone_3_exWeight := MAX(GROUP,IF( in_data.company_phone_3_ex_match_code=SALT311.MatchCode.ExactMatch, in_data.company_phone_3_exWeight,0 ));
  company_phone_7Weight := MAX(GROUP,IF( in_data.company_phone_7_match_code=SALT311.MatchCode.ExactMatch, in_data.company_phone_7Weight,0 ));
  company_feinWeight := MAX(GROUP,IF( in_data.company_fein_match_code=SALT311.MatchCode.ExactMatch, in_data.company_feinWeight,0 ));
  company_sic_code1Weight := MAX(GROUP,IF( in_data.company_sic_code1_match_code=SALT311.MatchCode.ExactMatch, in_data.company_sic_code1Weight,0 ));
  active_duns_numberWeight := MAX(GROUP,IF( in_data.active_duns_number_match_code=SALT311.MatchCode.ExactMatch, in_data.active_duns_numberWeight,0 ));
  ...
  cityWeight := MAX(GROUP,IF( in_data.city_match_code=SALT311.MatchCode.ExactMatch, in_data.cityWeight,0 ));
  city_cleanWeight := MAX(GROUP,IF( in_data.city_clean_match_code=SALT311.MatchCode.ExactMatch, in_data.city_cleanWeight,0 ));
  ...
  company_urlWeight := MAX(GROUP,IF( in_data.company_url_match_code=SALT311.MatchCode.ExactMatch, in_data.company_urlWeight,0 ));
  isContactWeight := MAX(GROUP,IF( in_data.isContact_match_code=SALT311.MatchCode.ExactMatch, in_data.isContactWeight,0 ));
  contact_didWeight := MAX(GROUP,IF( in_data.contact_did_match_code=SALT311.MatchCode.ExactMatch, in_data.contact_didWeight,0 ));
  titleWeight := MAX(GROUP,IF( in_data.title_match_code=SALT311.MatchCode.ExactMatch, in_data.titleWeight,0 ));
  fnameWeight := MAX(GROUP,IF( in_data.fname_match_code=SALT311.MatchCode.ExactMatch, in_data.fnameWeight,0 ));
  fname_preferredWeight := MAX(GROUP,IF( in_data.fname_preferred_match_code=SALT311.MatchCode.ExactMatch, in_data.fname_preferredWeight,0 ));
  ...
  name_suffixWeight := MAX(GROUP,IF( in_data.name_suffix_match_code=SALT311.MatchCode.ExactMatch, in_data.name_suffixWeight,0 ));
  contact_ssnWeight := MAX(GROUP,IF( in_data.contact_ssn_match_code=SALT311.MatchCode.ExactMatch, in_data.contact_ssnWeight,0 ));
  contact_emailWeight := MAX(GROUP,IF( in_data.contact_email_match_code=SALT311.MatchCode.ExactMatch, in_data.contact_emailWeight,0 ));
  sele_flagWeight := MAX(GROUP,IF( in_data.sele_flag_match_code=SALT311.MatchCode.ExactMatch, in_data.sele_flagWeight,0 ));
  org_flagWeight := MAX(GROUP,IF( in_data.org_flag_match_code=SALT311.MatchCode.ExactMatch, in_data.org_flagWeight,0 ));
  ult_flagWeight := MAX(GROUP,IF( in_data.ult_flag_match_code=SALT311.MatchCode.ExactMatch, in_data.ult_flagWeight,0 ));
  fallback_valueWeight := MAX(GROUP,IF( in_data.fallback_value_match_code=SALT311.MatchCode.ExactMatch, in_data.fallback_valueWeight,0 ));
  CONTACTNAMEWeight := MAX(GROUP,IF( in_data.CONTACTNAME_match_code=SALT311.MatchCode.ExactMatch, in_data.CONTACTNAMEWeight,0 ));
  STREETADDRESSWeight := MAX(GROUP,IF( in_data.STREETADDRESS_match_code=SALT311.MatchCode.ExactMatch, in_data.STREETADDRESSWeight,0 ));
END;
  R1 := TABLE(in_data,aggregateRec,Reference);
 
LayoutScoredFetch FixScores(LayoutScoredFetch le, aggregateRec ri) := TRANSFORM
  SELF.parent_proxidWeight := MAP( ri.parent_proxidWeight=0 OR le.parent_proxid_match_code=SALT311.MatchCode.ExactMatch => le.parent_proxidWeight,MIN(le.parent_proxidWeight,ri.parent_proxidWeight-1) );
  SELF.sele_proxidWeight := MAP( ri.sele_proxidWeight=0 OR le.sele_proxid_match_code=SALT311.MatchCode.ExactMatch => le.sele_proxidWeight,MIN(le.sele_proxidWeight,ri.sele_proxidWeight-1) );
  SELF.org_proxidWeight := MAP( ri.org_proxidWeight=0 OR le.org_proxid_match_code=SALT311.MatchCode.ExactMatch => le.org_proxidWeight,MIN(le.org_proxidWeight,ri.org_proxidWeight-1) );
  SELF.ultimate_proxidWeight := MAP( ri.ultimate_proxidWeight=0 OR le.ultimate_proxid_match_code=SALT311.MatchCode.ExactMatch => le.ultimate_proxidWeight,MIN(le.ultimate_proxidWeight,ri.ultimate_proxidWeight-1) );
  SELF.has_lgidWeight := MAP( ri.has_lgidWeight=0 OR le.has_lgid_match_code=SALT311.MatchCode.ExactMatch => le.has_lgidWeight,MIN(le.has_lgidWeight,ri.has_lgidWeight-1) );
  SELF.empidWeight := MAP( ri.empidWeight=0 OR le.empid_match_code=SALT311.MatchCode.ExactMatch => le.empidWeight,MIN(le.empidWeight,ri.empidWeight-1) );
  SELF.sourceWeight := MAP( ri.sourceWeight=0 OR le.source_match_code=SALT311.MatchCode.ExactMatch => le.sourceWeight,MIN(le.sourceWeight,ri.sourceWeight-1) );
  SELF.source_record_idWeight := MAP( ri.source_record_idWeight=0 OR le.source_record_id_match_code=SALT311.MatchCode.ExactMatch => le.source_record_idWeight,MIN(le.source_record_idWeight,ri.source_record_idWeight-1) );
  SELF.source_docidWeight := MAP( ri.source_docidWeight=0 OR le.source_docid_match_code=SALT311.MatchCode.ExactMatch => le.source_docidWeight,MIN(le.source_docidWeight,ri.source_docidWeight-1) );
  SELF.company_nameWeight := MAP( ri.company_nameWeight=0 OR le.company_name_match_code=SALT311.MatchCode.ExactMatch => le.company_nameWeight,MIN(le.company_nameWeight,ri.company_nameWeight-1) );
  SELF.company_name_prefixWeight := MAP( ri.company_name_prefixWeight=0 OR le.company_name_prefix_match_code=SALT311.MatchCode.ExactMatch => le.company_name_prefixWeight,MIN(le.company_name_prefixWeight,ri.company_name_prefixWeight-1) );
  SELF.cnp_nameWeight := MAP( ri.cnp_nameWeight=0 OR le.cnp_name_match_code=SALT311.MatchCode.ExactMatch => le.cnp_nameWeight,MIN(le.cnp_nameWeight,ri.cnp_nameWeight-1) );
  SELF.cnp_numberWeight := MAP( ri.cnp_numberWeight=0 OR le.cnp_number_match_code=SALT311.MatchCode.ExactMatch => le.cnp_numberWeight,MIN(le.cnp_numberWeight,ri.cnp_numberWeight-1) );
  SELF.cnp_btypeWeight := MAP( ri.cnp_btypeWeight=0 OR le.cnp_btype_match_code=SALT311.MatchCode.ExactMatch => le.cnp_btypeWeight,MIN(le.cnp_btypeWeight,ri.cnp_btypeWeight-1) );
  SELF.cnp_lowvWeight := MAP( ri.cnp_lowvWeight=0 OR le.cnp_lowv_match_code=SALT311.MatchCode.ExactMatch => le.cnp_lowvWeight,MIN(le.cnp_lowvWeight,ri.cnp_lowvWeight-1) );
  SELF.company_phoneWeight := MAP( ri.company_phoneWeight=0 OR le.company_phone_match_code=SALT311.MatchCode.ExactMatch => le.company_phoneWeight,MIN(le.company_phoneWeight,ri.company_phoneWeight-1) );
  SELF.company_phone_3Weight := MAP( ri.company_phone_3Weight=0 OR le.company_phone_3_match_code=SALT311.MatchCode.ExactMatch => le.company_phone_3Weight,MIN(le.company_phone_3Weight,ri.company_phone_3Weight-1) );
  SELF.company_phone_3_exWeight := MAP( ri.company_phone_3_exWeight=0 OR le.company_phone_3_ex_match_code=SALT311.MatchCode.ExactMatch => le.company_phone_3_exWeight,MIN(le.company_phone_3_exWeight,ri.company_phone_3_exWeight-1) );
  SELF.company_phone_7Weight := MAP( ri.company_phone_7Weight=0 OR le.company_phone_7_match_code=SALT311.MatchCode.ExactMatch => le.company_phone_7Weight,MIN(le.company_phone_7Weight,ri.company_phone_7Weight-1) );
  SELF.company_feinWeight := MAP( ri.company_feinWeight=0 OR le.company_fein_match_code=SALT311.MatchCode.ExactMatch => le.company_feinWeight,MIN(le.company_feinWeight,ri.company_feinWeight-1) );
  SELF.company_sic_code1Weight := MAP( ri.company_sic_code1Weight=0 OR le.company_sic_code1_match_code=SALT311.MatchCode.ExactMatch => le.company_sic_code1Weight,MIN(le.company_sic_code1Weight,ri.company_sic_code1Weight-1) );
  SELF.active_duns_numberWeight := MAP( ri.active_duns_numberWeight=0 OR le.active_duns_number_match_code=SALT311.MatchCode.ExactMatch => le.active_duns_numberWeight,MIN(le.active_duns_numberWeight,ri.active_duns_numberWeight-1) );
  ...
  SELF.cityWeight := MAP( ri.cityWeight=0 OR le.city_match_code=SALT311.MatchCode.ExactMatch => le.cityWeight,MIN(le.cityWeight,ri.cityWeight-1) );
  SELF.city_cleanWeight := MAP( ri.city_cleanWeight=0 OR le.city_clean_match_code=SALT311.MatchCode.ExactMatch => le.city_cleanWeight,MIN(le.city_cleanWeight,ri.city_cleanWeight-1) );
  ...
  SELF.company_urlWeight := MAP( ri.company_urlWeight=0 OR le.company_url_match_code=SALT311.MatchCode.ExactMatch => le.company_urlWeight,MIN(le.company_urlWeight,ri.company_urlWeight-1) );
  SELF.isContactWeight := MAP( ri.isContactWeight=0 OR le.isContact_match_code=SALT311.MatchCode.ExactMatch => le.isContactWeight,MIN(le.isContactWeight,ri.isContactWeight-1) );
  SELF.contact_didWeight := MAP( ri.contact_didWeight=0 OR le.contact_did_match_code=SALT311.MatchCode.ExactMatch => le.contact_didWeight,MIN(le.contact_didWeight,ri.contact_didWeight-1) );
  SELF.titleWeight := MAP( ri.titleWeight=0 OR le.title_match_code=SALT311.MatchCode.ExactMatch => le.titleWeight,MIN(le.titleWeight,ri.titleWeight-1) );
  ...
  SELF.fname_preferredWeight := MAP( ri.fname_preferredWeight=0 OR le.fname_preferred_match_code=SALT311.MatchCode.ExactMatch => le.fname_preferredWeight,MIN(le.fname_preferredWeight,ri.fname_preferredWeight-1) );
  ...
  SELF.name_suffixWeight := MAP( ri.name_suffixWeight=0 OR le.name_suffix_match_code=SALT311.MatchCode.ExactMatch => le.name_suffixWeight,MIN(le.name_suffixWeight,ri.name_suffixWeight-1) );
  SELF.contact_ssnWeight := MAP( ri.contact_ssnWeight=0 OR le.contact_ssn_match_code=SALT311.MatchCode.ExactMatch => le.contact_ssnWeight,MIN(le.contact_ssnWeight,ri.contact_ssnWeight-1) );
  SELF.contact_emailWeight := MAP( ri.contact_emailWeight=0 OR le.contact_email_match_code=SALT311.MatchCode.ExactMatch => le.contact_emailWeight,MIN(le.contact_emailWeight,ri.contact_emailWeight-1) );
  SELF.sele_flagWeight := MAP( ri.sele_flagWeight=0 OR le.sele_flag_match_code=SALT311.MatchCode.ExactMatch => le.sele_flagWeight,MIN(le.sele_flagWeight,ri.sele_flagWeight-1) );
  SELF.org_flagWeight := MAP( ri.org_flagWeight=0 OR le.org_flag_match_code=SALT311.MatchCode.ExactMatch => le.org_flagWeight,MIN(le.org_flagWeight,ri.org_flagWeight-1) );
  SELF.ult_flagWeight := MAP( ri.ult_flagWeight=0 OR le.ult_flag_match_code=SALT311.MatchCode.ExactMatch => le.ult_flagWeight,MIN(le.ult_flagWeight,ri.ult_flagWeight-1) );
  SELF.fallback_valueWeight := MAP( ri.fallback_valueWeight=0 OR le.fallback_value_match_code=SALT311.MatchCode.ExactMatch => le.fallback_valueWeight,MIN(le.fallback_valueWeight,ri.fallback_valueWeight-1) );
  SELF.CONTACTNAMEWeight := MAP( ri.CONTACTNAMEWeight=0 OR le.CONTACTNAME_match_code=SALT311.MatchCode.ExactMatch => le.CONTACTNAMEWeight,MIN(le.CONTACTNAMEWeight,ri.CONTACTNAMEWeight-1) );
  SELF.STREETADDRESSWeight := MAP( ri.STREETADDRESSWeight=0 OR le.STREETADDRESS_match_code=SALT311.MatchCode.ExactMatch => le.STREETADDRESSWeight,MIN(le.STREETADDRESSWeight,ri.STREETADDRESSWeight-1) );
  INTEGER2 Weight := MAX(0, SELF.parent_proxidWeight) + MAX(0, SELF.sele_proxidWeight) + MAX(0, SELF.org_proxidWeight) + MAX(0, SELF.ultimate_proxidWeight) + MAX(0, SELF.has_lgidWeight) + MAX(0, SELF.empidWeight) + MAX(0, SELF.sourceWeight) + MAX(0, SELF.source_record_idWeight) + MAX(0, SELF.source_docidWeight) + MAX(0, SELF.company_nameWeight) + MAX(0, SELF.company_name_prefixWeight) + MAX(0, SELF.cnp_nameWeight) + MAX(0, SELF.cnp_numberWeight) + MAX(0, SELF.cnp_btypeWeight) + MAX(0, SELF.cnp_lowvWeight) + MAX(0, SELF.company_phoneWeight) + MAX(0, SELF.company_phone_3Weight) + MAX(0, SELF.company_phone_3_exWeight) + MAX(0, SELF.company_phone_7Weight) + MAX(0, SELF.company_feinWeight) + MAX(0, SELF.company_sic_code1Weight) + MAX(0, SELF.active_duns_numberWeight) + MAX(0, SELF.cityWeight) + MAX(0, SELF.city_cleanWeight) + MAX(0, SELF.stWeight) + MAX(0, SELF.zipWeight) + MAX(0, SELF.company_urlWeight) + MAX(0, SELF.isContactWeight) + MAX(0, SELF.contact_didWeight) + MAX(0, SELF.titleWeight) + MAX(0, SELF.fname_preferredWeight) + MAX(0, SELF.name_suffixWeight) + MAX(0, SELF.contact_ssnWeight) + MAX(0, SELF.contact_emailWeight) + MAX(0, SELF.sele_flagWeight) + MAX(0, SELF.org_flagWeight) + MAX(0, SELF.ult_flagWeight) + MAX(0, SELF.fallback_valueWeight) + (MAX(0, SELF.fnameWeight) + MAX(0, SELF.mnameWeight) + MAX(0, SELF.lnameWeight)) + (MAX(0, SELF.prim_rangeWeight) + MAX(0, SELF.prim_nameWeight) + MAX(0, SELF.sec_rangeWeight));
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT311.Layout_FieldValueList) empid_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) source_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) source_record_id_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) source_docid_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_name_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_name_prefix_Values := DATASET([],SALT311.Layout_FieldValueList);
  ...
  DATASET(SALT311.Layout_FieldValueList) company_phone_3_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_phone_3_ex_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_phone_7_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_fein_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) company_sic_code1_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) active_duns_number_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) city_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) city_clean_Values := DATASET([],SALT311.Layout_FieldValueList);
  ...
  DATASET(SALT311.Layout_FieldValueList) company_url_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) isContact_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) contact_did_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) title_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) fname_preferred_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) name_suffix_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) contact_ssn_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) contact_email_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) sele_flag_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) org_flag_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) ult_flag_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) fallback_value_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) CONTACTNAME_Values := DATASET([],SALT311.Layout_FieldValueList);
  DATASET(SALT311.Layout_FieldValueList) STREETADDRESS_Values := DATASET([],SALT311.Layout_FieldValueList);
END;
...
SHARED RollEntities(dataset(Layout_RolledEntity) infile) := FUNCTION
  ...
  SELF.proxid := le.proxid;
    ...
    SELF.empid_values := SALT311.fn_combine_fieldvaluelist(le.empid_values,ri.empid_values);
    SELF.source_values := SALT311.fn_combine_fieldvaluelist(le.source_values,ri.source_values);
    SELF.source_record_id_values := SALT311.fn_combine_fieldvaluelist(le.source_record_id_values,ri.source_record_id_values);
    SELF.source_docid_values := SALT311.fn_combine_fieldvaluelist(le.source_docid_values,ri.source_docid_values);
    SELF.company_name_values := SALT311.fn_combine_fieldvaluelist(le.company_name_values,ri.company_name_values);
    SELF.company_name_prefix_values := SALT311.fn_combine_fieldvaluelist(le.company_name_prefix_values,ri.company_name_prefix_values);
    ...
    SELF.company_phone_3_values := SALT311.fn_combine_fieldvaluelist(le.company_phone_3_values,ri.company_phone_3_values);
    SELF.company_phone_3_ex_values := SALT311.fn_combine_fieldvaluelist(le.company_phone_3_ex_values,ri.company_phone_3_ex_values);
    SELF.company_phone_7_values := SALT311.fn_combine_fieldvaluelist(le.company_phone_7_values,ri.company_phone_7_values);
    SELF.company_fein_values := SALT311.fn_combine_fieldvaluelist(le.company_fein_values,ri.company_fein_values);
    SELF.company_sic_code1_values := SALT311.fn_combine_fieldvaluelist(le.company_sic_code1_values,ri.company_sic_code1_values);
    ...
    SELF.city_values := SALT311.fn_combine_fieldvaluelist(le.city_values,ri.city_values);
    SELF.city_clean_values := SALT311.fn_combine_fieldvaluelist(le.city_clean_values,ri.city_clean_values);
    ...
    SELF.company_url_values := SALT311.fn_combine_fieldvaluelist(le.company_url_values,ri.company_url_values);
    SELF.isContact_values := SALT311.fn_combine_fieldvaluelist(le.isContact_values,ri.isContact_values);
    SELF.contact_did_values := SALT311.fn_combine_fieldvaluelist(le.contact_did_values,ri.contact_did_values);
    SELF.title_values := SALT311.fn_combine_fieldvaluelist(le.title_values,ri.title_values);
    SELF.fname_preferred_values := SALT311.fn_combine_fieldvaluelist(le.fname_preferred_values,ri.fname_preferred_values);
    SELF.name_suffix_values := SALT311.fn_combine_fieldvaluelist(le.name_suffix_values,ri.name_suffix_values);
    SELF.contact_ssn_values := SALT311.fn_combine_fieldvaluelist(le.contact_ssn_values,ri.contact_ssn_values);
    SELF.contact_email_values := SALT311.fn_combine_fieldvaluelist(le.contact_email_values,ri.contact_email_values);
    SELF.sele_flag_values := SALT311.fn_combine_fieldvaluelist(le.sele_flag_values,ri.sele_flag_values);
    SELF.org_flag_values := SALT311.fn_combine_fieldvaluelist(le.org_flag_values,ri.org_flag_values);
    SELF.ult_flag_values := SALT311.fn_combine_fieldvaluelist(le.ult_flag_values,ri.ult_flag_values);
    SELF.fallback_value_values := SALT311.fn_combine_fieldvaluelist(le.fallback_value_values,ri.fallback_value_values);
    SELF.CONTACTNAME_values := SALT311.fn_combine_fieldvaluelist(le.CONTACTNAME_values,ri.CONTACTNAME_values);
    SELF.STREETADDRESS_values := SALT311.fn_combine_fieldvaluelist(le.STREETADDRESS_values,ri.STREETADDRESS_values);
  END;
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  SELF.proxid := le.proxid;
  SELF.parent_proxid_Values := IF ( (SALT311.StrType)le.parent_proxid = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.parent_proxid)}],SALT311.Layout_FieldValueList));
  SELF.sele_proxid_Values := IF ( (SALT311.StrType)le.sele_proxid = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.sele_proxid)}],SALT311.Layout_FieldValueList));
  SELF.org_proxid_Values := IF ( (SALT311.StrType)le.org_proxid = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.org_proxid)}],SALT311.Layout_FieldValueList));
  SELF.ultimate_proxid_Values := IF ( (SALT311.StrType)le.ultimate_proxid = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.ultimate_proxid)}],SALT311.Layout_FieldValueList));
  SELF.has_lgid_Values := DATASET([{TRIM((SALT311.StrType)le.has_lgid)}],SALT311.Layout_FieldValueList);
  SELF.empid_Values := DATASET([{TRIM((SALT311.StrType)le.empid)}],SALT311.Layout_FieldValueList);
  SELF.source_Values := IF ( (SALT311.StrType)le.source = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.source)}],SALT311.Layout_FieldValueList));
  SELF.source_record_id_Values := IF ( (SALT311.StrType)le.source_record_id = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.source_record_id)}],SALT311.Layout_FieldValueList));
  SELF.source_docid_Values := DATASET([{TRIM((SALT311.StrType)le.source_docid)}],SALT311.Layout_FieldValueList);
  SELF.company_name_Values := IF ( (SALT311.StrType)le.company_name = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_name)}],SALT311.Layout_FieldValueList));
  SELF.company_name_prefix_Values := IF ( (SALT311.StrType)le.company_name_prefix = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_name_prefix)}],SALT311.Layout_FieldValueList));
  SELF.cnp_name_Values := IF ( (SALT311.StrType)le.cnp_name = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.cnp_name)}],SALT311.Layout_FieldValueList));
  SELF.cnp_number_Values := IF ( (SALT311.StrType)le.cnp_number = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.cnp_number)}],SALT311.Layout_FieldValueList));
  SELF.cnp_btype_Values := IF ( (SALT311.StrType)le.cnp_btype = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.cnp_btype)}],SALT311.Layout_FieldValueList));
  SELF.cnp_lowv_Values := IF ( (SALT311.StrType)le.cnp_lowv = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.cnp_lowv)}],SALT311.Layout_FieldValueList));
  SELF.company_phone_Values := DATASET([{TRIM((SALT311.StrType)le.company_phone)}],SALT311.Layout_FieldValueList);
  SELF.company_phone_3_Values := IF ( (SALT311.StrType)le.company_phone_3 = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_phone_3)}],SALT311.Layout_FieldValueList));
  SELF.company_phone_3_ex_Values := IF ( (SALT311.StrType)le.company_phone_3_ex = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_phone_3_ex)}],SALT311.Layout_FieldValueList));
  SELF.company_phone_7_Values := IF ( (SALT311.StrType)le.company_phone_7 = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_phone_7)}],SALT311.Layout_FieldValueList));
  SELF.company_fein_Values := IF ( (SALT311.StrType)le.company_fein = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_fein)}],SALT311.Layout_FieldValueList));
  SELF.company_sic_code1_Values := IF ( (SALT311.StrType)le.company_sic_code1 = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_sic_code1)}],SALT311.Layout_FieldValueList));
  SELF.active_duns_number_Values := DATASET([{TRIM((SALT311.StrType)le.active_duns_number)}],SALT311.Layout_FieldValueList);
  SELF.city_Values := IF ( (SALT311.StrType)le.city = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.city)}],SALT311.Layout_FieldValueList));
  SELF.city_clean_Values := IF ( (SALT311.StrType)le.city_clean = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.city_clean)}],SALT311.Layout_FieldValueList));
  SELF.st_Values := IF ( (SALT311.StrType)le.st = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.st)}],SALT311.Layout_FieldValueList));
  SELF.zip_Values := IF ( (SALT311.StrType)le.zip = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.zip)}],SALT311.Layout_FieldValueList));
  SELF.company_url_Values := IF ( (SALT311.StrType)le.company_url = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.company_url)}],SALT311.Layout_FieldValueList));
  SELF.isContact_Values := IF ( (SALT311.StrType)le.isContact = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.isContact)}],SALT311.Layout_FieldValueList));
  SELF.contact_did_Values := IF ( (SALT311.StrType)le.contact_did = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.contact_did)}],SALT311.Layout_FieldValueList));
  SELF.title_Values := IF ( (SALT311.StrType)le.title = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.title)}],SALT311.Layout_FieldValueList));
  SELF.fname_preferred_Values := IF ( (SALT311.StrType)le.fname_preferred = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.fname_preferred)}],SALT311.Layout_FieldValueList));
  SELF.name_suffix_Values := IF ( (SALT311.StrType)le.name_suffix = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.name_suffix)}],SALT311.Layout_FieldValueList));
  SELF.contact_ssn_Values := IF ( (SALT311.StrType)le.contact_ssn = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.contact_ssn)}],SALT311.Layout_FieldValueList));
  SELF.contact_email_Values := IF ( (SALT311.StrType)le.contact_email = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.contact_email)}],SALT311.Layout_FieldValueList));
  SELF.sele_flag_Values := IF ( (SALT311.StrType)le.sele_flag = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.sele_flag)}],SALT311.Layout_FieldValueList));
  SELF.org_flag_Values := IF ( (SALT311.StrType)le.org_flag = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.org_flag)}],SALT311.Layout_FieldValueList));
  SELF.ult_flag_Values := IF ( (SALT311.StrType)le.ult_flag = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.ult_flag)}],SALT311.Layout_FieldValueList));
  SELF.fallback_value_Values := IF ( (SALT311.StrType)le.fallback_value = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.fallback_value)}],SALT311.Layout_FieldValueList));
  SELF.CONTACTNAME_Values := IF ( (SALT311.StrType)le.fname = '' AND (SALT311.StrType)le.mname = '' AND (SALT311.StrType)le.lname = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.fname) + ' ' + TRIM((SALT311.StrType)le.mname) + ' ' + TRIM((SALT311.StrType)le.lname)}],SALT311.Layout_FieldValueList));
  SELF.STREETADDRESS_Values := IF ( (SALT311.StrType)le.prim_range = '' AND (SALT311.StrType)le.prim_name = '' AND (SALT311.StrType)le.sec_range = '',DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.prim_range) + ' ' + TRIM((SALT311.StrType)le.prim_name) + ' ' + TRIM((SALT311.StrType)le.sec_range)}],SALT311.Layout_FieldValueList));
END;
