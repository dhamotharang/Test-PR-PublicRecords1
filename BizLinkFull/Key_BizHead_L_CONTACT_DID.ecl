...
EXPORT CanSearch(Process_Biz_Layouts.InputLayout le) := le.contact_did <> (TYPEOF(le.contact_did))'' AND Fields.InValid_contact_did((SALT311.StrType)le.contact_did)=0;
KeyRec := RECORDOF(Key);
