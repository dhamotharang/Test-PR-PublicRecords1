...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_DC_Main';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh\n'
    + 'MODULE:Scrubs_Corp2_Mapping_DC_Main\n'
    + 'FILENAME:In_File\n'
    + '\n'
    ...
    + 'FIELDTYPE:invalid_corp_vendor:ENUM(11|11)\n'
    + 'FIELDTYPE:invalid_state_origin:ENUM(DC|DC)\n'
    + 'FIELDTYPE:invalid_name_type_code:ENUM(01|04|07)\n'
    + 'FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )\n'
    + 'FIELDTYPE:invalid_flag_code:ENUM(Y|N| )\n'
    + 'FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|TRADE NAME|RESERVED)\n'
