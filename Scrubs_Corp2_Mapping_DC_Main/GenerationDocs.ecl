...
Command line options: -MScrubs_Corp2_Mapping_DC_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR213D.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(11)
FIELDTYPE:invalid_state_origin:ENUM(DC)
FIELDTYPE:invalid_name_type_code:ENUM(01|04)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_flag_code:ENUM(Y|N| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|TRADE NAME)
