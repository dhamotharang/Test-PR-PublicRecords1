EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT25.Str30Type fieldname := #TEXT(infield);
	  SALT25.StrType fieldvalue {maxlength(200000)} := (SALT25.StrType)infile.infield ;
		SALT25.StrType src {maxlength(30)} := infile.srcfield ;
