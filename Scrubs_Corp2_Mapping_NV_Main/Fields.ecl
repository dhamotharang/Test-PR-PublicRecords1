...
EXPORT NumFields := 290;
 
// Processing for each FieldType
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_supp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_name_type_code','invalid_name_type_desc','invalid_corp_status_comment','invalid_corp_term_exist_cd','invalid_corp_term_exist_desc','invalid_for_dom_ind','invalid_for_profit','invalid_recordorigin','invalid_corp_ra_address_type_desc','invalid_alphanum_spchar_blank');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_supp_key' => 2,'invalid_charter_nbr' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_future_date' => 8,'invalid_name_type_code' => 9,'invalid_name_type_desc' => 10,'invalid_corp_status_comment' => 11,'invalid_corp_term_exist_cd' => 12,'invalid_corp_term_exist_desc' => 13,'invalid_for_dom_ind' => 14,'invalid_for_profit' => 15,'invalid_recordorigin' => 16,'invalid_corp_ra_address_type_desc' => 17,'invalid_alphanum_spchar_blank' => 18,0);
...
EXPORT MakeFT_invalid_corp_supp_key(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,' 0123456789-'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_supp_key(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,' 0123456789-'))));
EXPORT InValidMessageFT_invalid_corp_supp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars(' 0123456789-'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_vendor(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['32','32']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('32|32'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['NV','NV']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('NV|NV'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT311.StrType s,SALT311.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_cd'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT311.StrType s,SALT311.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_desc'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_status_comment(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_status_comment(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['IS ON ADMINISTRATIVE HOLD',' ']);
EXPORT InValidMessageFT_invalid_corp_status_comment(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('IS ON ADMINISTRATIVE HOLD| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_term_exist_cd(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_cd(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['D',' ']);
EXPORT InValidMessageFT_invalid_corp_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('D| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_term_exist_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_desc(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['EXPIRATION DATE',' ']);
EXPORT InValidMessageFT_invalid_corp_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('EXPIRATION DATE| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_for_dom_ind(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_dom_ind(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['D','F',' ']);
EXPORT InValidMessageFT_invalid_for_dom_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('D|F| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_for_profit(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_profit(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['N',' ']);
EXPORT InValidMessageFT_invalid_for_profit(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('N| '),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_ra_address_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_ra_address_type_desc(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN Scrubs_Corp2_Mapping_NV_Main.Functions.set_valid_RA_AddrType);
EXPORT InValidMessageFT_invalid_corp_ra_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_NV_Main.Functions.set_valid_RA_AddrType'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphanum_spchar_blank(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,' -\',.%():;/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphanum_spchar_blank(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,' -\',.%():;/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))));
EXPORT InValidMessageFT_invalid_alphanum_spchar_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars(' -\',.%():;/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],['ALLOW','LENGTHS'],['ALLOW'],['ENUM'],[],[],['ENUM'],['ALLOW','CUSTOM'],['ALLOW','LENGTHS'],['LENGTHS'],['CUSTOM'],['CUSTOM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW','CUSTOM'],[],[],[],['ALLOW'],['ALLOW','CUSTOM'],[],['ENUM'],[],[],[],[],['ALLOW','CUSTOM'],[],[],[],['ENUM'],['ALLOW','CUSTOM'],[],['ENUM'],['ALLOW'],['ALLOW'],[],['ALLOW','CUSTOM'],[],[],[],[],[],[],['ALLOW'],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW','CUSTOM'],[],[],[],[],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],['ALLOW','CUSTOM'],['ALLOW','CUSTOM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ENUM'],[]);
EXPORT BOOLEAN InBaseLayout(UNSIGNED2 i) := CHOOSE(i,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,FALSE);
...
EXPORT Make_corp_supp_key(SALT311.StrType s0) := MakeFT_invalid_corp_supp_key(s0);
EXPORT InValid_corp_supp_key(SALT311.StrType s) := InValidFT_invalid_corp_supp_key(s);
...
EXPORT Make_corp_status_desc(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_status_desc(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_status_comment(SALT311.StrType s0) := MakeFT_invalid_corp_status_comment(s0);
EXPORT InValid_corp_status_comment(SALT311.StrType s) := InValidFT_invalid_corp_status_comment(s);
...
EXPORT Make_corp_inc_state(SALT311.StrType s0) := s0;
EXPORT InValid_corp_inc_state(SALT311.StrType s) := 0;
...
EXPORT Make_corp_term_exist_cd(SALT311.StrType s0) := MakeFT_invalid_corp_term_exist_cd(s0);
EXPORT InValid_corp_term_exist_cd(SALT311.StrType s) := InValidFT_invalid_corp_term_exist_cd(s);
...
EXPORT Make_corp_term_exist_desc(SALT311.StrType s0) := s0;
EXPORT InValid_corp_term_exist_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_corp_term_exist_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_foreign_domestic_ind(SALT311.StrType s0) := MakeFT_invalid_for_dom_ind(s0);
EXPORT InValid_corp_foreign_domestic_ind(SALT311.StrType s) := InValidFT_invalid_for_dom_ind(s);
EXPORT InValidMessage_corp_foreign_domestic_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_for_dom_ind(wh);
 
EXPORT Make_corp_forgn_state_cd(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_forgn_state_cd(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_forgn_state_desc(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_orig_org_structure_desc(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
 
EXPORT Make_corp_for_profit_ind(SALT311.StrType s0) := MakeFT_invalid_for_profit(s0);
EXPORT InValid_corp_for_profit_ind(SALT311.StrType s) := InValidFT_invalid_for_profit(s);
EXPORT InValidMessage_corp_for_profit_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_for_profit(wh);
...
EXPORT Make_corp_addl_info(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_addl_info(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_addl_info(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_ra_resign_date(SALT311.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_ra_resign_date(SALT311.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_ra_address_type_desc(SALT311.StrType s0) := MakeFT_invalid_corp_ra_address_type_desc(s0);
EXPORT InValid_corp_ra_address_type_desc(SALT311.StrType s) := InValidFT_invalid_corp_ra_address_type_desc(s);
...
EXPORT Make_cont_title1_desc(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_cont_title1_desc(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_cont_title1_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_country_of_formation(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_country_of_formation(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_country_of_formation(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_llc_managed_desc(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_llc_managed_desc(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_llc_managed_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_trademark_class_desc1(SALT311.StrType s0) := MakeFT_invalid_alphanum_spchar_blank(s0);
EXPORT InValid_corp_trademark_class_desc1(SALT311.StrType s) := InValidFT_invalid_alphanum_spchar_blank(s);
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanum_spchar_blank(wh);
...
EXPORT Make_corp_trademark_expiration_date(SALT311.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_trademark_expiration_date(SALT311.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_trademark_expiration_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
 
EXPORT Make_corp_trademark_filing_date(SALT311.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_trademark_filing_date(SALT311.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_trademark_filing_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Corp2_Mapping_NV_Main;
