IMPORT ut,SALT32;
IMPORT Scrubs,Scrubs_Corp2_Mapping_NV_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_supp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_corp_type','invalid_corp_type_desc','invalid_corp_standing','invalid_corp_status_comment','invalid_corp_term_exist_cd','invalid_corp_term_exist_desc','invalid_for_dom_ind','invalid_Y_N','invalid_recordorigin','invalid_corp_ra_title_desc','invalid_corp_ra_address_type_desc','invalid_alpha_spchar_blank');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_supp_key' => 2,'invalid_charter_nbr' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_future_date' => 8,'invalid_corp_type' => 9,'invalid_corp_type_desc' => 10,'invalid_corp_standing' => 11,'invalid_corp_status_comment' => 12,'invalid_corp_term_exist_cd' => 13,'invalid_corp_term_exist_desc' => 14,'invalid_for_dom_ind' => 15,'invalid_Y_N' => 16,'invalid_recordorigin' => 17,'invalid_corp_ra_title_desc' => 18,'invalid_corp_ra_address_type_desc' => 19,'invalid_alpha_spchar_blank' => 20,0);
...
EXPORT MakeFT_invalid_corp_supp_key(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' 0123456789-'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_supp_key(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' 0123456789-'))));
EXPORT InValidMessageFT_invalid_corp_supp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' 0123456789-'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_charter_nbr(SALT32.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'-.ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('-.ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['32']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('32'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['NV']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('NV'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_type(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_type(SALT32.StrType s) := WHICH(~Scrubs_Corp2_Mapping_NV_Main.Functions.ValidCorpTypes(s)>0);
EXPORT InValidMessageFT_invalid_corp_type(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NV_Main.Functions.ValidCorpTypes'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['LEGAL','TRADEMARK','TRADENAME','SERVICEMARK','RESERVED','FOREIGN NAME',' ']);
EXPORT InValidMessageFT_invalid_corp_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('LEGAL|TRADEMARK|TRADENAME|SERVICEMARK|RESERVED|FOREIGN NAME| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_standing(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_standing(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['Y',' ']);
EXPORT InValidMessageFT_invalid_corp_standing(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('Y| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_status_comment(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_status_comment(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['IS ON ADMINISTRATIVE HOLD',' ']);
EXPORT InValidMessageFT_invalid_corp_status_comment(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('IS ON ADMINISTRATIVE HOLD| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_term_exist_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['D','P',' ']);
EXPORT InValidMessageFT_invalid_corp_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('D|P| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_term_exist_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['PERPETUAL','EXPIRATION DATE']);
EXPORT InValidMessageFT_invalid_corp_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('PERPETUAL|EXPIRATION DATE'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_for_dom_ind(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_dom_ind(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['D','F',' ']);
EXPORT InValidMessageFT_invalid_for_dom_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('D|F| '),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_ra_title_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_ra_title_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN [' ','REGISTERED AGENT']);
EXPORT InValidMessageFT_invalid_corp_ra_title_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum(' |REGISTERED AGENT'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_ra_address_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_ra_address_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN [' ','REGISTERED OFFICE','REGISTERED AGENT MAILING ADDRESS']);
EXPORT InValidMessageFT_invalid_corp_ra_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum(' |REGISTERED OFFICE|REGISTERED AGENT MAILING ADDRESS'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alpha_spchar_blank(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -\',.()ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha_spchar_blank(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -\',.()ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alpha_spchar_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -\',.()ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT32.HygieneErrors.Good);
...
EXPORT Make_corp_supp_key(SALT32.StrType s0) := MakeFT_invalid_corp_supp_key(s0);
EXPORT InValid_corp_supp_key(SALT32.StrType s) := InValidFT_invalid_corp_supp_key(s);
EXPORT InValidMessage_corp_supp_key(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_supp_key(wh);
...
EXPORT Make_corp_ln_name_type_cd(SALT32.StrType s0) := MakeFT_invalid_corp_type(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT32.StrType s) := InValidFT_invalid_corp_type(s);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_type(wh);
 
EXPORT Make_corp_ln_name_type_desc(SALT32.StrType s0) := MakeFT_invalid_corp_type_desc(s0);
EXPORT InValid_corp_ln_name_type_desc(SALT32.StrType s) := InValidFT_invalid_corp_type_desc(s);
EXPORT InValidMessage_corp_ln_name_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_type_desc(wh);
...
EXPORT Make_corp_standing(SALT32.StrType s0) := MakeFT_invalid_corp_standing(s0);
EXPORT InValid_corp_standing(SALT32.StrType s) := InValidFT_invalid_corp_standing(s);
EXPORT InValidMessage_corp_standing(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_standing(wh);
 
EXPORT Make_corp_status_comment(SALT32.StrType s0) := MakeFT_invalid_corp_status_comment(s0);
EXPORT InValid_corp_status_comment(SALT32.StrType s) := InValidFT_invalid_corp_status_comment(s);
EXPORT InValidMessage_corp_status_comment(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_status_comment(wh);
...
EXPORT Make_corp_inc_state(SALT32.StrType s0) := s0;
EXPORT InValid_corp_inc_state(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_inc_state(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_term_exist_cd(SALT32.StrType s0) := MakeFT_invalid_corp_term_exist_cd(s0);
EXPORT InValid_corp_term_exist_cd(SALT32.StrType s) := InValidFT_invalid_corp_term_exist_cd(s);
...
EXPORT Make_corp_forgn_state_cd(SALT32.StrType s0) := MakeFT_invalid_alpha_spchar_blank(s0);
EXPORT InValid_corp_forgn_state_cd(SALT32.StrType s) := InValidFT_invalid_alpha_spchar_blank(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_spchar_blank(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT32.StrType s0) := MakeFT_invalid_alpha_spchar_blank(s0);
EXPORT InValid_corp_forgn_state_desc(SALT32.StrType s) := InValidFT_invalid_alpha_spchar_blank(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_spchar_blank(wh);
...
EXPORT Make_corp_ra_title_desc(SALT32.StrType s0) := MakeFT_invalid_corp_ra_title_desc(s0);
EXPORT InValid_corp_ra_title_desc(SALT32.StrType s) := InValidFT_invalid_corp_ra_title_desc(s);
EXPORT InValidMessage_corp_ra_title_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_ra_title_desc(wh);
...
EXPORT Make_corp_ra_address_type_desc(SALT32.StrType s0) := MakeFT_invalid_corp_ra_address_type_desc(s0);
EXPORT InValid_corp_ra_address_type_desc(SALT32.StrType s) := InValidFT_invalid_corp_ra_address_type_desc(s);
EXPORT InValidMessage_corp_ra_address_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_ra_address_type_desc(wh);
...
EXPORT Make_corp_country_of_formation(SALT32.StrType s0) := MakeFT_invalid_alpha_spchar_blank(s0);
EXPORT InValid_corp_country_of_formation(SALT32.StrType s) := InValidFT_invalid_alpha_spchar_blank(s);
EXPORT InValidMessage_corp_country_of_formation(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_spchar_blank(wh);
...
EXPORT Make_corp_trademark_class_desc1(SALT32.StrType s0) := MakeFT_invalid_alpha_spchar_blank(s0);
EXPORT InValid_corp_trademark_class_desc1(SALT32.StrType s) := InValidFT_invalid_alpha_spchar_blank(s);
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha_spchar_blank(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_NV_Main;
