...
Command line options: -MScrubs_Corp2_Mapping_NV_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR67C0.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(32)
FIELDTYPE:invalid_state_origin:ENUM(NV)
...
FIELDTYPE:invalid_corp_type:CUSTOM(Scrubs_Corp2_Mapping_NV_Main.Functions.ValidCorpTypes>0)
FIELDTYPE:invalid_corp_type_desc:ENUM(LEGAL|TRADEMARK|TRADENAME|SERVICEMARK|RESERVED|FOREIGN NAME| )
...
FIELDTYPE:invalid_corp_ra_title_desc:ENUM( |REGISTERED AGENT)
FIELDTYPE:invalid_corp_ra_address_type_desc:ENUM( |REGISTERED OFFICE|REGISTERED AGENT MAILING ADDRESS)
FIELDTYPE:invalid_alpha_spchar_blank:ALLOW( -',.()ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_ln_name_type_cd:TYPE(STRING2):LIKE(invalid_corp_type):0,0
FIELD:corp_ln_name_type_desc:TYPE(STRING30):LIKE(invalid_corp_type_desc):0,0
...
FIELD:corp_forgn_state_cd:TYPE(STRING3):LIKE(invalid_alpha_spchar_blank):0,0
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alpha_spchar_blank):0,0
...
FIELD:corp_ra_title_desc:TYPE(STRING60):LIKE(invalid_corp_ra_title_desc):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alpha_spchar_blank):0,0
...
FIELD:corp_trademark_class_desc1:TYPE(STRING250):LIKE(invalid_alpha_spchar_blank):0,0
