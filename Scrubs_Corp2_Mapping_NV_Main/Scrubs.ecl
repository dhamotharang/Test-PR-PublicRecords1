...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 55;
  EXPORT NumRulesFromFieldType := 55;
  ...
  EXPORT Expanded_Layout := RECORD(Layout_In_NV)
    ...
    UNSIGNED1 corp_addl_info_Invalid;
...
EXPORT FromNone(DATASET(Layout_In_NV) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_supp_key_Invalid := Fields.InValid_corp_supp_key((SALT311.StrType)le.corp_supp_key);
    ...
    SELF.corp_status_comment_Invalid := Fields.InValid_corp_status_comment((SALT311.StrType)le.corp_status_comment);
    ...
    SELF.corp_term_exist_exp_Invalid := Fields.InValid_corp_term_exist_exp((SALT311.StrType)le.corp_term_exist_exp);
    ...
    SELF.corp_forgn_state_cd_Invalid := Fields.InValid_corp_forgn_state_cd((SALT311.StrType)le.corp_forgn_state_cd);
    ...
    SELF.corp_addl_info_Invalid := Fields.InValid_corp_addl_info((SALT311.StrType)le.corp_addl_info);
    SELF.corp_ra_resign_date_Invalid := Fields.InValid_corp_ra_resign_date((SALT311.StrType)le.corp_ra_resign_date);
    SELF.corp_ra_address_type_desc_Invalid := Fields.InValid_corp_ra_address_type_desc((SALT311.StrType)le.corp_ra_address_type_desc);
    SELF.cont_title1_desc_Invalid := Fields.InValid_cont_title1_desc((SALT311.StrType)le.cont_title1_desc);
    SELF.corp_country_of_formation_Invalid := Fields.InValid_corp_country_of_formation((SALT311.StrType)le.corp_country_of_formation);
    SELF.corp_llc_managed_desc_Invalid := Fields.InValid_corp_llc_managed_desc((SALT311.StrType)le.corp_llc_managed_desc);
    SELF.corp_trademark_class_desc1_Invalid := Fields.InValid_corp_trademark_class_desc1((SALT311.StrType)le.corp_trademark_class_desc1);
    SELF.corp_trademark_expiration_date_Invalid := Fields.InValid_corp_trademark_expiration_date((SALT311.StrType)le.corp_trademark_expiration_date);
    SELF.corp_trademark_filing_date_Invalid := Fields.InValid_corp_trademark_filing_date((SALT311.StrType)le.corp_trademark_filing_date);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_supp_key_Invalid << 14 ) + ( le.corp_vendor_Invalid << 15 ) + ( le.corp_state_origin_Invalid << 16 ) + ( le.corp_process_date_Invalid << 17 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 19 ) + ( le.corp_legal_name_Invalid << 21 ) + ( le.corp_ln_name_type_cd_Invalid << 22 ) + ( le.corp_ln_name_type_desc_Invalid << 23 ) + ( le.corp_filing_date_Invalid << 24 ) + ( le.corp_status_desc_Invalid << 26 ) + ( le.corp_status_date_Invalid << 27 ) + ( le.corp_status_comment_Invalid << 29 ) + ( le.corp_inc_date_Invalid << 30 ) + ( le.corp_term_exist_cd_Invalid << 32 ) + ( le.corp_term_exist_exp_Invalid << 33 ) + ( le.corp_foreign_domestic_ind_Invalid << 35 ) + ( le.corp_forgn_state_cd_Invalid << 36 ) + ( le.corp_forgn_state_desc_Invalid << 37 ) + ( le.corp_forgn_date_Invalid << 38 ) + ( le.corp_orig_org_structure_desc_Invalid << 40 ) + ( le.corp_for_profit_ind_Invalid << 41 ) + ( le.corp_addl_info_Invalid << 42 ) + ( le.corp_ra_resign_date_Invalid << 43 ) + ( le.corp_ra_address_type_desc_Invalid << 45 ) + ( le.cont_title1_desc_Invalid << 46 ) + ( le.corp_country_of_formation_Invalid << 47 ) + ( le.corp_llc_managed_desc_Invalid << 48 ) + ( le.corp_trademark_class_desc1_Invalid << 49 ) + ( le.corp_trademark_expiration_date_Invalid << 50 ) + ( le.corp_trademark_filing_date_Invalid << 52 ) + ( le.recordorigin_Invalid << 54 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_status_date_Invalid := (le.ScrubsBits1 >> 27) & 3;
    SELF.corp_status_comment_Invalid := (le.ScrubsBits1 >> 29) & 1;
    ...
    SELF.corp_addl_info_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.corp_ra_resign_date_Invalid := (le.ScrubsBits1 >> 43) & 3;
    SELF.corp_ra_address_type_desc_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.cont_title1_desc_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.corp_country_of_formation_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.corp_llc_managed_desc_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.corp_trademark_class_desc1_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.corp_trademark_expiration_date_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.corp_trademark_filing_date_Invalid := (le.ScrubsBits1 >> 52) & 3;
    SELF.recordorigin_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_status_comment_ENUM_ErrorCount := COUNT(GROUP,h.corp_status_comment_Invalid=1);
    ...
    corp_addl_info_ALLOW_ErrorCount := COUNT(GROUP,h.corp_addl_info_Invalid=1);
    ...
    corp_llc_managed_desc_ALLOW_ErrorCount := COUNT(GROUP,h.corp_llc_managed_desc_Invalid=1);
    ...
    AnyRule_WithErrorsCount := COUNT(GROUP, h.dt_vendor_first_reported_Invalid > 0 OR h.dt_vendor_last_reported_Invalid > 0 OR h.dt_first_seen_Invalid > 0 OR h.dt_last_seen_Invalid > 0 OR h.corp_ra_dt_first_seen_Invalid > 0 OR h.corp_ra_dt_last_seen_Invalid > 0 OR h.corp_key_Invalid > 0 OR h.corp_supp_key_Invalid > 0 OR h.corp_vendor_Invalid > 0 OR h.corp_state_origin_Invalid > 0 OR h.corp_process_date_Invalid > 0 OR h.corp_orig_sos_charter_nbr_Invalid > 0 OR h.corp_legal_name_Invalid > 0 OR h.corp_ln_name_type_cd_Invalid > 0 OR h.corp_ln_name_type_desc_Invalid > 0 OR h.corp_filing_date_Invalid > 0 OR h.corp_status_desc_Invalid > 0 OR h.corp_status_date_Invalid > 0 OR h.corp_status_comment_Invalid > 0 OR h.corp_inc_date_Invalid > 0 OR h.corp_term_exist_cd_Invalid > 0 OR h.corp_term_exist_exp_Invalid > 0 OR h.corp_foreign_domestic_ind_Invalid > 0 OR h.corp_forgn_state_cd_Invalid > 0 OR h.corp_forgn_state_desc_Invalid > 0 OR h.corp_forgn_date_Invalid > 0 OR h.corp_orig_org_structure_desc_Invalid > 0 OR h.corp_for_profit_ind_Invalid > 0 OR h.corp_addl_info_Invalid > 0 OR h.corp_ra_resign_date_Invalid > 0 OR h.corp_ra_address_type_desc_Invalid > 0 OR h.cont_title1_desc_Invalid > 0 OR h.corp_country_of_formation_Invalid > 0 OR h.corp_llc_managed_desc_Invalid > 0 OR h.corp_trademark_class_desc1_Invalid > 0 OR h.corp_trademark_expiration_date_Invalid > 0 OR h.corp_trademark_filing_date_Invalid > 0 OR h.recordorigin_Invalid > 0);
  ...
  SummaryStats0 xAddErrSummary(SummaryStats0 le) := TRANSFORM
    SELF.FieldsChecked_WithErrors := IF(le.dt_vendor_first_reported_Total_ErrorCount > 0, 1, 0) + IF(le.dt_vendor_last_reported_Total_ErrorCount > 0, 1, 0) + IF(le.dt_first_seen_Total_ErrorCount > 0, 1, 0) + IF(le.dt_last_seen_Total_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_first_seen_Total_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_last_seen_Total_ErrorCount > 0, 1, 0) + IF(le.corp_key_Total_ErrorCount > 0, 1, 0) + IF(le.corp_supp_key_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_vendor_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_state_origin_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_process_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_orig_sos_charter_nbr_Total_ErrorCount > 0, 1, 0) + IF(le.corp_legal_name_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.corp_ln_name_type_cd_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_ln_name_type_desc_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_filing_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_status_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_status_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_status_comment_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_inc_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_term_exist_cd_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_term_exist_exp_Total_ErrorCount > 0, 1, 0) + IF(le.corp_foreign_domestic_ind_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_state_cd_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_state_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_orig_org_structure_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_for_profit_ind_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_addl_info_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_ra_resign_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_ra_address_type_desc_ENUM_ErrorCount > 0, 1, 0) + IF(le.cont_title1_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_country_of_formation_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_llc_managed_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_class_desc1_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_expiration_date_Total_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_filing_date_Total_ErrorCount > 0, 1, 0) + IF(le.recordorigin_ENUM_ErrorCount > 0, 1, 0);
    SELF.FieldsChecked_NoErrors := NumFieldsWithRules - SELF.FieldsChecked_WithErrors;
    SELF.Rules_WithErrors := IF(le.dt_vendor_first_reported_ALLOW_ErrorCount > 0, 1, 0) + IF(le.dt_vendor_first_reported_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.dt_vendor_last_reported_ALLOW_ErrorCount > 0, 1, 0) + IF(le.dt_vendor_last_reported_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.dt_first_seen_ALLOW_ErrorCount > 0, 1, 0) + IF(le.dt_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.dt_last_seen_ALLOW_ErrorCount > 0, 1, 0) + IF(le.dt_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_first_seen_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_last_seen_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_ra_dt_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_key_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_key_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.corp_supp_key_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_vendor_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_state_origin_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_process_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_process_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_orig_sos_charter_nbr_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_orig_sos_charter_nbr_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.corp_legal_name_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.corp_ln_name_type_cd_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_ln_name_type_desc_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_filing_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_filing_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_status_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_status_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_status_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_status_comment_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_inc_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_inc_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_term_exist_cd_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_term_exist_exp_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_term_exist_exp_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_foreign_domestic_ind_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_state_cd_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_state_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_forgn_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_orig_org_structure_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_for_profit_ind_ENUM_ErrorCount > 0, 1, 0) + IF(le.corp_addl_info_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_ra_resign_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_ra_resign_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_ra_address_type_desc_ENUM_ErrorCount > 0, 1, 0) + IF(le.cont_title1_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_country_of_formation_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_llc_managed_desc_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_class_desc1_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_expiration_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_expiration_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_filing_date_ALLOW_ErrorCount > 0, 1, 0) + IF(le.corp_trademark_filing_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.recordorigin_ENUM_ErrorCount > 0, 1, 0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.corp_status_comment_Invalid,'ENUM','UNKNOWN')
          ...
          ,CHOOSE(le.corp_addl_info_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_ra_resign_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ...
          ,CHOOSE(le.corp_llc_managed_desc_Invalid,'ALLOW','UNKNOWN')
          ...
          ,CHOOSE(le.corp_trademark_filing_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ,CHOOSE(le.recordorigin_Invalid,'ENUM','UNKNOWN'),'UNKNOWN'));
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_key','corp_supp_key','corp_vendor','corp_state_origin','corp_process_date','corp_orig_sos_charter_nbr','corp_legal_name','corp_ln_name_type_cd','corp_ln_name_type_desc','corp_filing_date','corp_status_desc','corp_status_date','corp_status_comment','corp_inc_date','corp_term_exist_cd','corp_term_exist_exp','corp_foreign_domestic_ind','corp_forgn_state_cd','corp_forgn_state_desc','corp_forgn_date','corp_orig_org_structure_desc','corp_for_profit_ind','corp_addl_info','corp_ra_resign_date','corp_ra_address_type_desc','cont_title1_desc','corp_country_of_formation','corp_llc_managed_desc','corp_trademark_class_desc1','corp_trademark_expiration_date','corp_trademark_filing_date','recordorigin','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','invalid_corp_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_mandatory','invalid_name_type_code','invalid_name_type_desc','invalid_date','invalid_alphanum_spchar_blank','invalid_date','invalid_corp_status_comment','invalid_date','invalid_corp_term_exist_cd','invalid_future_date','invalid_for_dom_ind','invalid_alphanum_spchar_blank','invalid_alphanum_spchar_blank','invalid_date','invalid_alphanum_spchar_blank','invalid_for_profit','invalid_alphanum_spchar_blank','invalid_date','invalid_corp_ra_address_type_desc','invalid_alphanum_spchar_blank','invalid_alphanum_spchar_blank','invalid_alphanum_spchar_blank','invalid_alphanum_spchar_blank','invalid_future_date','invalid_date','invalid_recordorigin','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT311.StrType)le.dt_vendor_first_reported,(SALT311.StrType)le.dt_vendor_last_reported,(SALT311.StrType)le.dt_first_seen,(SALT311.StrType)le.dt_last_seen,(SALT311.StrType)le.corp_ra_dt_first_seen,(SALT311.StrType)le.corp_ra_dt_last_seen,(SALT311.StrType)le.corp_key,(SALT311.StrType)le.corp_supp_key,(SALT311.StrType)le.corp_vendor,(SALT311.StrType)le.corp_state_origin,(SALT311.StrType)le.corp_process_date,(SALT311.StrType)le.corp_orig_sos_charter_nbr,(SALT311.StrType)le.corp_legal_name,(SALT311.StrType)le.corp_ln_name_type_cd,(SALT311.StrType)le.corp_ln_name_type_desc,(SALT311.StrType)le.corp_filing_date,(SALT311.StrType)le.corp_status_desc,(SALT311.StrType)le.corp_status_date,(SALT311.StrType)le.corp_status_comment,(SALT311.StrType)le.corp_inc_date,(SALT311.StrType)le.corp_term_exist_cd,(SALT311.StrType)le.corp_term_exist_exp,(SALT311.StrType)le.corp_foreign_domestic_ind,(SALT311.StrType)le.corp_forgn_state_cd,(SALT311.StrType)le.corp_forgn_state_desc,(SALT311.StrType)le.corp_forgn_date,(SALT311.StrType)le.corp_orig_org_structure_desc,(SALT311.StrType)le.corp_for_profit_ind,(SALT311.StrType)le.corp_addl_info,(SALT311.StrType)le.corp_ra_resign_date,(SALT311.StrType)le.corp_ra_address_type_desc,(SALT311.StrType)le.cont_title1_desc,(SALT311.StrType)le.corp_country_of_formation,(SALT311.StrType)le.corp_llc_managed_desc,(SALT311.StrType)le.corp_trademark_class_desc1,(SALT311.StrType)le.corp_trademark_expiration_date,(SALT311.StrType)le.corp_trademark_filing_date,(SALT311.StrType)le.recordorigin,'***SALTBUG***');
  END;
  EXPORT AllErrors := NORMALIZE(h,38,Into(LEFT,COUNTER));
   bv := TABLE(AllErrors,{FieldContents, FieldName, Cnt := COUNT(GROUP)},FieldContents, FieldName,MERGE);
  EXPORT BadValues := TOPN(bv,1000,-Cnt);
  // Particular form of stats required for Orbit
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Layout_In_NV) prevDS = DATASET([], Layout_In_NV), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_status_desc:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_status_date:invalid_date:ALLOW','corp_status_date:invalid_date:CUSTOM'
          ,'corp_status_comment:invalid_corp_status_comment:ENUM'
          ...
          ,'corp_forgn_state_cd:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_forgn_state_desc:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_forgn_date:invalid_date:ALLOW','corp_forgn_date:invalid_date:CUSTOM'
          ,'corp_orig_org_structure_desc:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_for_profit_ind:invalid_for_profit:ENUM'
          ,'corp_addl_info:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_ra_resign_date:invalid_date:ALLOW','corp_ra_resign_date:invalid_date:CUSTOM'
          ,'corp_ra_address_type_desc:invalid_corp_ra_address_type_desc:ENUM'
          ,'cont_title1_desc:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_country_of_formation:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_llc_managed_desc:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_trademark_class_desc1:invalid_alphanum_spchar_blank:ALLOW'
          ,'corp_trademark_expiration_date:invalid_future_date:ALLOW','corp_trademark_expiration_date:invalid_future_date:CUSTOM'
          ,'corp_trademark_filing_date:invalid_date:ALLOW','corp_trademark_filing_date:invalid_date:CUSTOM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_addl_info(1)
          ,Fields.InvalidMessage_corp_ra_resign_date(1),Fields.InvalidMessage_corp_ra_resign_date(2)
          ...
          ,Fields.InvalidMessage_corp_trademark_filing_date(1),Fields.InvalidMessage_corp_trademark_filing_date(2)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_status_comment_ENUM_ErrorCount
          ...
          ,le.corp_addl_info_ALLOW_ErrorCount
          ,le.corp_ra_resign_date_ALLOW_ErrorCount,le.corp_ra_resign_date_CUSTOM_ErrorCount
          ...
          ,le.corp_llc_managed_desc_ALLOW_ErrorCount
          ...
          ,le.corp_trademark_filing_date_ALLOW_ErrorCount,le.corp_trademark_filing_date_CUSTOM_ErrorCount
    ...
    mod_hygiene := hygiene(PROJECT(h, Layout_In_NV));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_ra_suffix:' + getFieldTypeText(h.corp_ra_suffix) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ...
          ,'cont_suffix:' + getFieldTypeText(h.cont_suffix) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ...
          ,'corp_farm_status_date:' + getFieldTypeText(h.corp_farm_status_date) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_corp_ra_suffix_cnt
          ...
          ,le.populated_corp_farm_status_date_cnt
      ...
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_corp_ra_suffix_pcnt
          ...
          ,le.populated_corp_farm_status_date_pcnt
      ...
      SELF.ErrorMessage := '';
    END;
    FieldPopStats := NORMALIZE(hygiene_summaryStats,290,xNormHygieneStats(LEFT,COUNTER,'POP'));
  ...
  // record count stats
    ...
    mod_Delta := Delta(prevDS, PROJECT(h, Layout_In_NV));
    deltaHygieneSummary := mod_Delta.DifferenceSummary;
    DeltaFieldPopStats := NORMALIZE(deltaHygieneSummary(txt <> 'New'),290,xNormHygieneStats(LEFT,COUNTER,'DELTA'));
...
EXPORT StandardStats(DATASET(Layout_In_NV) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_Corp2_Mapping_NV_Main, Fields, 'RECORDOF(scrubsSummaryOverall)', '');
