...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_NV_Main';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_NV_Main\n'
    + 'FILENAME:In_NV\n'
    ...
    + 'FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)\n'
    + 'FIELDTYPE:invalid_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_NV_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)\n'
    + 'FIELDTYPE:invalid_corp_status_comment:ENUM(IS ON ADMINISTRATIVE HOLD| )\n'
    + 'FIELDTYPE:invalid_corp_term_exist_cd:ENUM(D| )\n'
    + 'FIELDTYPE:invalid_corp_term_exist_desc:ENUM(EXPIRATION DATE| )\n'
    + 'FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )\n'
    + 'FIELDTYPE:invalid_for_profit:ENUM(N| )\n'
    + 'FIELDTYPE:invalid_recordorigin:ENUM(C|T)\n'
    + 'FIELDTYPE:invalid_corp_ra_address_type_desc:ENUM(Scrubs_Corp2_Mapping_NV_Main.Functions.set_valid_RA_AddrType)\n'
    + 'FIELDTYPE:invalid_alphanum_spchar_blank:ALLOW( -\',.%():;/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789)\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
    ...
    + 'FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    + 'FIELD:corp_status_date:TYPE(STRING8):LIKE(invalid_date):0,0\n'
    + 'FIELD:corp_standing:TYPE(STRING1):0,0\n'
    + 'FIELD:corp_status_comment:TYPE(STRING350):LIKE(invalid_corp_status_comment):0,0\n'
    ...
    + 'FIELD:corp_forgn_state_cd:TYPE(STRING3):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    + 'FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    + 'FIELD:corp_for_profit_ind:TYPE(STRING1):LIKE(invalid_for_profit):0,0\n'
    ...
    + 'FIELD:corp_addl_info:TYPE(STRING250):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_ra_resign_date:TYPE(STRING8):LIKE(invalid_date):0,0\n'
    ...
    + 'FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_llc_managed_desc:TYPE(STRING100):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_trademark_class_desc1:TYPE(STRING250):LIKE(invalid_alphanum_spchar_blank):0,0\n'
    ...
    + 'FIELD:corp_trademark_filing_date:TYPE(STRING8):LIKE(invalid_date):0,0\n'
