EXPORT test_LIv4_attr_report_Batch(route,current_dt,previous_dt) := functionmacro



 file1_2:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_Attributes_V4_Global_Layout,


thor),(integer)accountnumber);

 file2_2:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.LI_Attributes_V4_BATCH_Generic_msn1106_0_outfile +current_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_Attributes_V4_Global_Layout,
