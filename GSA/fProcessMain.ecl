...
export fProcessMain(dataset(GSA.Layouts_GSA.layout_GSA_ID) pRawFileInput) := function
		...
		layouts_gsa.slim_main_lo setMain(pRawFileInput l) := transform
			...
			self.name             := trimUpper(StringLib.StringCleanSpaces(l.title+' '+l.first_name+' '+l.middle_name+' '+l.last_name+' '+l.generation));
