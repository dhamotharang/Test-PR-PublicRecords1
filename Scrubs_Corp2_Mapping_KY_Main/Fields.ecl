IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_KY_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_term_cd','invalid_term_desc','invalid_flag_code','invalid_mandatory','invalid_numeric','invalid_for_dom_ind','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_status_cd','invalid_status_desc','invalid_filing_desc','invalid_cont_type_cd','invalid_cont_type_desc','invalid_cont_filing_cd','invalid_cont_filing_desc','invalid_corp_orig_org_structure_cd','invalid_corp_forgn_state_cd','invalid_corp_forgn_state_desc','invalid_comptype','invalid_recordorigin','invalid_date','invalid_future_date','invalid_alphablank','invalid_type1');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_term_cd' => 5,'invalid_term_desc' => 6,'invalid_flag_code' => 7,'invalid_mandatory' => 8,'invalid_numeric' => 9,'invalid_for_dom_ind' => 10,'invalid_ln_name_type_cd' => 11,'invalid_ln_name_type_desc' => 12,'invalid_status_cd' => 13,'invalid_status_desc' => 14,'invalid_filing_desc' => 15,'invalid_cont_type_cd' => 16,'invalid_cont_type_desc' => 17,'invalid_cont_filing_cd' => 18,'invalid_cont_filing_desc' => 19,'invalid_corp_orig_org_structure_cd' => 20,'invalid_corp_forgn_state_cd' => 21,'invalid_corp_forgn_state_desc' => 22,'invalid_comptype' => 23,'invalid_recordorigin' => 24,'invalid_date' => 25,'invalid_future_date' => 26,'invalid_alphablank' => 27,'invalid_type1' => 28,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['21']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('21'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['KY']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('KY'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_cd(s)>0);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_desc(s)>0);
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['AUTHORITY','ORGANIZATION',' ']);
EXPORT InValidMessageFT_invalid_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('AUTHORITY|ORGANIZATION| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['F',' ']);
EXPORT InValidMessageFT_invalid_cont_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('F| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['OFFICER',' ']);
EXPORT InValidMessageFT_invalid_cont_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('OFFICER| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_filing_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_filing_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['X',' ']);
EXPORT InValidMessageFT_invalid_cont_filing_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('X| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_filing_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_filing_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['ADDED OR EDITED',' ']);
EXPORT InValidMessageFT_invalid_cont_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('ADDED OR EDITED| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_orig_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_orig_org_structure_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_org_structure_cd(s)>0);
EXPORT InValidMessageFT_invalid_corp_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_org_structure_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_forgn_state_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_cd(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_forgn_state_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_comptype(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_comptype(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_comptype(s)>0);
EXPORT InValidMessageFT_invalid_comptype(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_comptype'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_future_date(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_future_date(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_generaldate(s)>0,~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 8));
EXPORT InValidMessageFT_invalid_future_date(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.CustomFail('Scrubs.fn_valid_generaldate'),SALT34.HygieneErrors.NotLength('0..8'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type1(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type1(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_type1(s)>0);
EXPORT InValidMessageFT_invalid_type1(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_type1'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_filing_desc(SALT34.StrType s0) := MakeFT_invalid_filing_desc(s0);
EXPORT InValid_corp_filing_desc(SALT34.StrType s) := InValidFT_invalid_filing_desc(s);
...
EXPORT Make_corp_status_desc(SALT34.StrType s0) := MakeFT_invalid_status_desc(s0);
EXPORT InValid_corp_status_desc(SALT34.StrType s) := InValidFT_invalid_status_desc(s);
...
EXPORT Make_corp_inc_state(SALT34.StrType s0) := s0;
EXPORT InValid_corp_inc_state(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_forgn_term_exist_cd(SALT34.StrType s0) := MakeFT_invalid_term_cd(s0);
EXPORT InValid_corp_forgn_term_exist_cd(SALT34.StrType s) := InValidFT_invalid_term_cd(s);
EXPORT InValidMessage_corp_forgn_term_exist_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_term_cd(wh);
 
EXPORT Make_corp_forgn_term_exist_exp(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_forgn_term_exist_exp(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_forgn_term_exist_exp(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
 
EXPORT Make_corp_forgn_term_exist_desc(SALT34.StrType s0) := MakeFT_invalid_term_desc(s0);
EXPORT InValid_corp_forgn_term_exist_desc(SALT34.StrType s) := InValidFT_invalid_term_desc(s);
EXPORT InValidMessage_corp_forgn_term_exist_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_term_desc(wh);
...
EXPORT Make_cont_filing_date(SALT34.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_cont_filing_date(SALT34.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_cont_filing_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_cont_filing_cd(SALT34.StrType s0) := MakeFT_invalid_cont_filing_cd(s0);
EXPORT InValid_cont_filing_cd(SALT34.StrType s) := InValidFT_invalid_cont_filing_cd(s);
EXPORT InValidMessage_cont_filing_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_cont_filing_cd(wh);
 
EXPORT Make_cont_filing_desc(SALT34.StrType s0) := MakeFT_invalid_cont_filing_desc(s0);
EXPORT InValid_cont_filing_desc(SALT34.StrType s) := InValidFT_invalid_cont_filing_desc(s);
EXPORT InValidMessage_cont_filing_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_cont_filing_desc(wh);
 
EXPORT Make_cont_type_cd(SALT34.StrType s0) := MakeFT_invalid_cont_type_cd(s0);
EXPORT InValid_cont_type_cd(SALT34.StrType s) := InValidFT_invalid_cont_type_cd(s);
...
EXPORT InValid_cont_type_desc(SALT34.StrType s) := InValidFT_invalid_cont_type_desc(s);
...
EXPORT Make_corp_renewal_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_renewal_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT Make_internalfield1(SALT34.StrType s0) := MakeFT_invalid_comptype(s0);
EXPORT InValid_internalfield1(SALT34.StrType s) := InValidFT_invalid_comptype(s);
EXPORT InValidMessage_internalfield1(UNSIGNED1 wh) := InValidMessageFT_invalid_comptype(wh);
 
EXPORT Make_internalfield2(SALT34.StrType s0) := MakeFT_invalid_type1(s0);
EXPORT InValid_internalfield2(SALT34.StrType s) := InValidFT_invalid_type1(s);
EXPORT InValidMessage_internalfield2(UNSIGNED1 wh) := InValidMessageFT_invalid_type1(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_KY_Main;
