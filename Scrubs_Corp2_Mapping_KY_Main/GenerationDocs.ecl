...
Command line options: -MScrubs_Corp2_Mapping_KY_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR9F0.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_KY_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(21)
FIELDTYPE:invalid_state_origin:ENUM(KY)
...
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_status_cd:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_cd>0)
FIELDTYPE:invalid_status_desc:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_status_desc>0)
FIELDTYPE:invalid_filing_desc:ENUM(AUTHORITY|ORGANIZATION| )
FIELDTYPE:invalid_cont_type_cd:ENUM(F| )
FIELDTYPE:invalid_cont_type_desc:ENUM(OFFICER| )
FIELDTYPE:invalid_cont_filing_cd:ENUM(X| )
FIELDTYPE:invalid_cont_filing_desc:ENUM(ADDED OR EDITED| )
FIELDTYPE:invalid_corp_orig_org_structure_cd:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_org_structure_cd>0)
FIELDTYPE:invalid_corp_forgn_state_cd:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_cd>0)
FIELDTYPE:invalid_corp_forgn_state_desc:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_corp_forgn_state_desc>0)
FIELDTYPE:invalid_comptype:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_comptype>0)
...
FIELDTYPE:invalid_future_date:ALLOW(0123456789):LENGTHS(0..8):CUSTOM(Scrubs.fn_valid_generaldate>0)
FIELDTYPE:invalid_alphablank:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_type1:CUSTOM(Scrubs_Corp2_Mapping_KY_Main.Functions.invalid_type1>0)
...
FIELD:corp_filing_desc:TYPE(STRING60):LIKE(invalid_filing_desc):0,0
...
FIELD:corp_forgn_term_exist_cd:TYPE(STRING8):LIKE(invalid_term_cd):0,0
FIELD:corp_forgn_term_exist_exp:TYPE(STRING8):LIKE(invalid_future_date):0,0
FIELD:corp_forgn_term_exist_desc:TYPE(STRING60):LIKE(invalid_term_desc):0,0
...
FIELD:cont_filing_cd:TYPE(STRING8):LIKE(invalid_cont_filing_cd):0,0
FIELD:cont_filing_desc:TYPE(STRING60):LIKE(invalid_cont_filing_desc):0,0
...
FIELD:corp_renewal_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:internalfield1:TYPE(STRING100):LIKE(invalid_comptype):0,0
FIELD:internalfield2:TYPE(STRING100):LIKE(invalid_type1):0,0
