...
EXPORT defaultVarietyStatsRunCron := MODULE 
    ...
    sDescription := 'Roxie vs. Thor Stat Varieties';
    sRerunID    := '';
    iNumSamples := 25000;
    iExpireTime := 30; 
    sSamplesFileName := '';
    bBaseline      := FALSE;
    bIsTest := TRUE;
    sInPrefix := '~thor::bizlinkfull::elert::stats_varieties::';
    ssConstantValues := ['\'\'','\'qa\''];
    sProfiles := 'BizLinkFull_ELERT.modProfiles.statProfilesDefault';
