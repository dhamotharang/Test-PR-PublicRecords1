IMPORT ut,SALT34;
IMPORT Scrubs,Scrubs_Corp2_Mapping_CO_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_org_structure_cd','invalid_Y_N','invalid_type_cd','invalid_addr_type_cd','invalid_addr_type_desc','invalid_forgn_state_cd','invalid_forgn_state_desc','invalid_term_exist_cd','invalid_term_exist_desc','invalid_for_dom_ind','invalid_recordorigin','invalid_alphablank','invalid_alphaparensblank','invalid_numeric','invalid_numblank');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_org_structure_cd' => 8,'invalid_Y_N' => 9,'invalid_type_cd' => 10,'invalid_addr_type_cd' => 11,'invalid_addr_type_desc' => 12,'invalid_forgn_state_cd' => 13,'invalid_forgn_state_desc' => 14,'invalid_term_exist_cd' => 15,'invalid_term_exist_desc' => 16,'invalid_for_dom_ind' => 17,'invalid_recordorigin' => 18,'invalid_alphablank' => 19,'invalid_alphaparensblank' => 20,'invalid_numeric' => 21,'invalid_numblank' => 22,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['08']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('08'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['CO']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('CO'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_CO_Main.Functions.valid_org_structure_cd(s)>0);
EXPORT InValidMessageFT_invalid_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_CO_Main.Functions.valid_org_structure_cd'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['01','03','04',' ']);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('01|03|04| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_addr_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_addr_type_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['B','M',' '],~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_addr_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('B|M| '),SALT34.HygieneErrors.NotLength('1,0'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_addr_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_addr_type_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['BUSINESS','MAILING',' ']);
EXPORT InValidMessageFT_invalid_addr_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('BUSINESS|MAILING| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_forgn_state_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_state_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_cd(s)>0);
EXPORT InValidMessageFT_invalid_forgn_state_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_forgn_state_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_state_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_desc(s)>0);
EXPORT InValidMessageFT_invalid_forgn_state_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_alphaparensblank(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ() '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaparensblank(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ() '))));
EXPORT InValidMessageFT_invalid_alphaparensblank(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ() '),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_address2_type_cd(SALT34.StrType s0) := MakeFT_invalid_addr_type_cd(s0);
EXPORT InValid_corp_address2_type_cd(SALT34.StrType s) := InValidFT_invalid_addr_type_cd(s);
EXPORT InValidMessage_corp_address2_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_addr_type_cd(wh);
 
EXPORT Make_corp_address2_type_desc(SALT34.StrType s0) := MakeFT_invalid_addr_type_desc(s0);
EXPORT InValid_corp_address2_type_desc(SALT34.StrType s) := InValidFT_invalid_addr_type_desc(s);
...
EXPORT Make_corp_status_desc(SALT34.StrType s0) := MakeFT_invalid_alphaparensblank(s0);
EXPORT InValid_corp_status_desc(SALT34.StrType s) := InValidFT_invalid_alphaparensblank(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphaparensblank(wh);
...
EXPORT Make_corp_forgn_state_cd(SALT34.StrType s0) := MakeFT_invalid_forgn_state_cd(s0);
EXPORT InValid_corp_forgn_state_cd(SALT34.StrType s) := InValidFT_invalid_forgn_state_cd(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_state_cd(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_CO_Main;
