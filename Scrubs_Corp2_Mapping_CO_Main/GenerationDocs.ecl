...
Command line options: -MScrubs_Corp2_Mapping_CO_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR5D4D.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_CO_Main
FILENAME:In_CO
...
FIELDTYPE:invalid_corp_vendor:ENUM(08)
FIELDTYPE:invalid_state_origin:ENUM(CO)
...
FIELDTYPE:invalid_org_structure_cd:CUSTOM(Scrubs_Corp2_Mapping_CO_Main.Functions.valid_org_structure_cd>0)
FIELDTYPE:invalid_Y_N:ENUM(Y|N| )
FIELDTYPE:invalid_type_cd:ENUM(01|03|04| )
FIELDTYPE:invalid_addr_type_cd:ENUM(B|M| ):LENGTHS(1,0)
FIELDTYPE:invalid_addr_type_desc:ENUM(BUSINESS|MAILING| )
FIELDTYPE:invalid_forgn_state_cd:CUSTOM(Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_cd>0)
FIELDTYPE:invalid_forgn_state_desc:CUSTOM(Scrubs_Corp2_Mapping_CO_Main.Functions.valid_corp_forgn_state_desc>0)
...
FIELDTYPE:invalid_alphaparensblank:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ() )
...
FIELD:corp_address1_type_cd:TYPE(STRING8):LIKE(invalid_addr_type_cd):0,0
FIELD:corp_address1_type_desc:TYPE(STRING60):LIKE(invalid_addr_type_desc):0,0
...
FIELD:corp_address2_type_cd:TYPE(STRING8):LIKE(invalid_addr_type_cd):0,0
FIELD:corp_address2_type_desc:TYPE(STRING60):LIKE(invalid_addr_type_desc):0,0
...
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_alphaparensblank):0,0
...
FIELD:corp_term_exist_exp:TYPE(STRING8):LIKE(invalid_numblank):0,0
...
FIELD:corp_forgn_state_cd:TYPE(STRING3):LIKE(invalid_forgn_state_cd):0,0
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_forgn_state_desc):0,0
