...
one := output(valid_date_new_file_dist,,'~thor_data400::base::fares_2580_weekly_'+thorlib.wuid(),__compressed__);
two := fileservices.addsuperfile('~thor_data400::base::fares_2580','~thor_data400::base::fares_2580_weekly_'+thorlib.wuid());
