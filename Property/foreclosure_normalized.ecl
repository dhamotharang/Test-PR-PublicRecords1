...
*/
import bipv2, property, ut, header_slimsort, DID_Add, Business_Header_SS, MDR, Business_header, Address, Header, Watchdog, lib_stringlib, BKForeclosure, STD, dx_Property;
...
dx_Property.Layout_Foreclosure_Base_Normalized normalizeRecords (foreclosureIn l, unsigned1 nameCounter) := transform
...
// by address
dx_Property.Layout_Foreclosure_Base_Normalized normalize_Addr_Records(dx_Property.Layout_Foreclosure_Base_Normalized l, unsigned1 c) := transform
...
dx_Property.Layout_Foreclosure_Base_Normalized;
end;
...
//remove src 
foreclosureDID := project(foreclosureDID_src, transform(dx_Property.Layout_Foreclosure_Base_Normalized, self := left));
...
Business_Header_SS.MAC_Match_Flex(
			...
			,foo            			           	  	// fein              
			,bdid										        			// bdid												
			,dx_Property.Layout_Foreclosure_Base_Normalized		// output layout 
...
dx_Property.Layout_Foreclosure_Base_Normalized normalizeBK(BKforeclosureIn l, unsigned1 nameCounter) := TRANSFORM
	self.name_first := choose(nameCounter,l.name1_first,l.name2_first,l.name3_first,l.name4_first,l.name5_first,l.name6_first,l.name7_first,l.name8_first);
	self.name_middle := choose(nameCounter,l.name1_middle,l.name2_middle,l.name3_middle,l.name4_middle,l.name5_middle,l.name6_middle,l.name7_middle,l.name8_middle);
	self.name_last := choose(nameCounter,l.name1_last,l.name2_last,l.name3_last,l.name4_last,l.name5_last,l.name6_last,l.name7_last,l.name8_last);
	self.name_suffix := choose(nameCounter,l.name1_suffix,l.name2_suffix,l.name3_suffix,l.name4_suffix,l.name5_suffix,l.name6_suffix,l.name7_suffix,l.name8_suffix);
