...
EXPORT Key_Foreclosure_ParcelNum := INDEX(dedForeclosure,{parcel_number_parcel_id},{string70 fid := foreclosure_id},'thor_data400::key::foreclosures_parcelNum_' + doxie.Version_SuperKey);