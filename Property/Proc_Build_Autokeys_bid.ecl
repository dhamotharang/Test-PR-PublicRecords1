...
inkey := '~thor_data400::key::foreclosure::autokey::QA::bid::';
inkeyB := '~thor_data400::key::foreclosure::autokey::BUILT::bid::';
...
// ak_keyname  := c.str_autokeyname_bid;
ak_keyname  := c.ak_keyname_bid;
ak_logical  := c.ak_logical_bid;
ak_dataset  := c.ak_dataset_bid;
ak_skipSet  := c.ak_skipSet_bid;
ak_typeStr  := c.ak_typeStr_bid;
