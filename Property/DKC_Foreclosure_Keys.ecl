...
DesprayFile(string FileName,string Destfilename)
 :=
  if(lib_fileservices.fileservices.FileExists(FileName),
	 lib_fileservices.FileServices.Despray(FileName,DestinationIP,'/thor_back5/fares/foreclosure/build/'+Destfilename,,,,TRUE),
...
export DKC_Foreclosure_Keys := sequential(baseFile,key1,key2,key3,key4,key5,key6,key7,key8,key9,
