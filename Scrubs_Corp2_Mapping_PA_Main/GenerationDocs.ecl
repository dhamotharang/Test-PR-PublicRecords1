...
Command line options: -MScrubs_Corp2_Mapping_PA_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFRF434.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(42)
FIELDTYPE:invalid_state_origin:ENUM(PA)
...
FIELDTYPE:invalid_address1_type_cd:ENUM(A|AA|AD|M|5|6|7|PE|PP|PM|11|12|9|16|B|19|20| )
...
FIELDTYPE:invalid_ra_addr_type_cd:ENUM(14|15|R| )
FIELDTYPE:invalid_ra_addr_type_desc:ENUM(PREVIOUS REGISTERED MAILING|PREVIOUS REGISTERED OFFICE|REGISTERED OFFICE| )
