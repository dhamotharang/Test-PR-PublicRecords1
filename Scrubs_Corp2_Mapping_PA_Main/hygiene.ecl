...
SALT34.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT34.StrType)le.dt_vendor_first_reported),TRIM((SALT34.StrType)le.dt_vendor_last_reported),TRIM((SALT34.StrType)le.dt_first_seen),TRIM((SALT34.StrType)le.dt_last_seen),TRIM((SALT34.StrType)le.corp_ra_dt_first_seen),TRIM((SALT34.StrType)le.corp_ra_dt_last_seen),TRIM((SALT34.StrType)le.corp_key),TRIM((SALT34.StrType)le.corp_vendor),TRIM((SALT34.StrType)le.corp_state_origin),TRIM((SALT34.StrType)le.corp_process_date),TRIM((SALT34.StrType)le.corp_orig_sos_charter_nbr),TRIM((SALT34.StrType)le.corp_legal_name),TRIM((SALT34.StrType)le.corp_ln_name_type_cd),TRIM((SALT34.StrType)le.corp_ln_name_type_desc),TRIM((SALT34.StrType)le.corp_address1_type_cd),TRIM((SALT34.StrType)le.corp_address1_type_desc),TRIM((SALT34.StrType)le.corp_status_cd),TRIM((SALT34.StrType)le.corp_status_desc),TRIM((SALT34.StrType)le.corp_inc_state),TRIM((SALT34.StrType)le.corp_inc_date),TRIM((SALT34.StrType)le.corp_term_exist_cd),TRIM((SALT34.StrType)le.corp_term_exist_desc),TRIM((SALT34.StrType)le.corp_term_exist_exp),TRIM((SALT34.StrType)le.corp_foreign_domestic_ind),TRIM((SALT34.StrType)le.corp_forgn_date),TRIM((SALT34.StrType)le.corp_orig_org_structure_cd),TRIM((SALT34.StrType)le.corp_orig_org_structure_desc),TRIM((SALT34.StrType)le.corp_for_profit_ind),TRIM((SALT34.StrType)le.corp_ra_address_type_cd),TRIM((SALT34.StrType)le.corp_ra_address_type_desc),TRIM((SALT34.StrType)le.cont_type_cd),TRIM((SALT34.StrType)le.cont_type_desc),TRIM((SALT34.StrType)le.cont_title1_desc),TRIM((SALT34.StrType)le.cont_address_type_cd),TRIM((SALT34.StrType)le.cont_address_type_desc),TRIM((SALT34.StrType)le.corp_dissolved_date),TRIM((SALT34.StrType)le.corp_merger_date),TRIM((SALT34.StrType)le.corp_name_status_cd),TRIM((SALT34.StrType)le.corp_name_status_desc),TRIM((SALT34.StrType)le.corp_forgn_state_desc),TRIM((SALT34.StrType)le.recordorigin)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{29,'corp_ra_address_type_cd'}
      ,{30,'corp_ra_address_type_desc'}
      ,{31,'cont_type_cd'}
      ,{32,'cont_type_desc'}
      ,{33,'cont_title1_desc'}
      ,{34,'cont_address_type_cd'}
      ,{35,'cont_address_type_desc'}
      ,{36,'corp_dissolved_date'}
      ,{37,'corp_merger_date'}
      ,{38,'corp_name_status_cd'}
      ,{39,'corp_name_status_desc'}
      ,{40,'corp_forgn_state_desc'}
      ,{41,'recordorigin'}],SALT34.MAC_Character_Counts.Field_Identification);
