...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_ra_address_type_cd_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.corp_ra_address_type_desc_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.cont_type_cd_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.cont_type_desc_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.cont_title1_desc_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.cont_address_type_cd_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.cont_address_type_desc_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.corp_dissolved_date_Invalid := (le.ScrubsBits1 >> 47) & 3;
    SELF.corp_merger_date_Invalid := (le.ScrubsBits1 >> 49) & 3;
    SELF.corp_name_status_cd_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.corp_name_status_desc_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.dt_first_seen,(SALT34.StrType)le.dt_last_seen,(SALT34.StrType)le.corp_ra_dt_first_seen,(SALT34.StrType)le.corp_ra_dt_last_seen,(SALT34.StrType)le.corp_key,(SALT34.StrType)le.corp_vendor,(SALT34.StrType)le.corp_state_origin,(SALT34.StrType)le.corp_process_date,(SALT34.StrType)le.corp_orig_sos_charter_nbr,(SALT34.StrType)le.corp_legal_name,(SALT34.StrType)le.corp_ln_name_type_cd,(SALT34.StrType)le.corp_ln_name_type_desc,(SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.corp_status_cd,(SALT34.StrType)le.corp_status_desc,(SALT34.StrType)le.corp_inc_state,(SALT34.StrType)le.corp_inc_date,(SALT34.StrType)le.corp_term_exist_cd,(SALT34.StrType)le.corp_term_exist_desc,(SALT34.StrType)le.corp_term_exist_exp,(SALT34.StrType)le.corp_foreign_domestic_ind,(SALT34.StrType)le.corp_forgn_date,(SALT34.StrType)le.corp_orig_org_structure_cd,(SALT34.StrType)le.corp_orig_org_structure_desc,(SALT34.StrType)le.corp_for_profit_ind,(SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.cont_type_cd,(SALT34.StrType)le.cont_type_desc,(SALT34.StrType)le.cont_title1_desc,(SALT34.StrType)le.cont_address_type_cd,(SALT34.StrType)le.cont_address_type_desc,(SALT34.StrType)le.corp_dissolved_date,(SALT34.StrType)le.corp_merger_date,(SALT34.StrType)le.corp_name_status_cd,(SALT34.StrType)le.corp_name_status_desc,(SALT34.StrType)le.corp_forgn_state_desc,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_ra_address_type_cd:invalid_ra_addr_type_cd:ENUM'
          ,'corp_ra_address_type_desc:invalid_ra_addr_type_desc:ENUM'
          ...
          ,'corp_forgn_state_desc:invalid_alphablankcomma:ALLOW','UNKNOWN');
