import autokeyb,doxie,Corp2,Corp2_services, data_services;
...
autokeyb.MAC_FID_Payload(fakepf,'','','','','','','','','',0,0,data_services.data_location.prefix() + 'thor_data400::key::corp2::qa::autokey::Payload',plk,'');
