...
export fCorp4AsCorp2ContHistory(DATASET(Layout_Corporate_Direct_Cont_AID) cont_base) :=
FUNCTION
...
Layout_Corporate_Direct_Cont_AID SelectHistory(Layout_Corporate_Direct_Cont_AID l, layout_cont_datefs r) := transform
self := l;
end;
