...
SHARED FldIds := DATASET([{1,'cellphoneidkey'}
      ...
      ,{11,'datefirstseen'}
      ,{12,'datelastseen'}
      ,{13,'datevendorfirstreported'}
      ,{14,'datevendorlastreported'}
      ,{15,'dt_nonglb_last_seen'}
      ,{16,'glb_dppa_flag'}
      ,{17,'did_type'}
      ,{18,'origname'}
      ,{19,'address1'}
      ...
      ,{68,'prepaid'}
      ,{69,'global_sid'}
      ,{70,'record_sid'}],SALT311.MAC_Character_Counts.Field_Identification);
