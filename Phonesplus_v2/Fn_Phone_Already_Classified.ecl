...
already_classified 	   := phplus_in(in_flag or 
									...
									Translation_Codes.fFlagIsOn(rules, Translation_Codes.rules_bitmap_code('Included-for-someone-else')) or
									Translation_Codes.fFlagIsOn(rules, Translation_Codes.rules_bitmap_code('Gongh-Disconnect'))
									);
