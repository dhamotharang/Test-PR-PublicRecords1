...
latest_include_flagged := dedup(sort(distribute(last_resort_vendor_conf(in_flag), hash(npa+phone7)), npa+phone7,-append_latest_phone_owner_flag, -DateLastSeen, local), npa+phone7, local);
