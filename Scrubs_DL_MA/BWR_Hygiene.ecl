...
#workunit('name','Scrubs_DL_MA.BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'Layout_In_MA'),NAMED('OptimizedLayout'));// File layout suggested by data
