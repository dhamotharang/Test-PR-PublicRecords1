...
EXPORT MakeFT_invalid_alpha_specials(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ @-.,#'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alpha_specials(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ @-.,#'))));
EXPORT InValidMessageFT_invalid_alpha_specials(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ @-.,#'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_wordbag(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_invalid_wordbag(SALT34.StrType s) := WHICH(SALT34.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]()-^=!+&,./#*\'\\|"'))));
EXPORT InValidMessageFT_invalid_wordbag(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotCaps,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]()-^=!+&,./#*\'\\|"'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_8date(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_8date(SALT34.StrType s) := WHICH(~Scrubs.fn_valid_GeneralDate(s)>0,~(LENGTH(TRIM(s)) = 8));
EXPORT InValidMessageFT_invalid_8date(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs.fn_valid_GeneralDate'),SALT34.HygieneErrors.NotLength('8'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_pers_surrogate(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  MakeFT_invalid_numeric(s1);
END;
EXPORT InValidFT_invalid_pers_surrogate(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_invalid_pers_surrogate(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.NotLength('9'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_licno(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_license_licno(SALT34.StrType s) := WHICH(~Scrubs_DL_MA.Functions.fn_verify_licno(s)>0,~(LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_invalid_license_licno(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_verify_licno'),SALT34.HygieneErrors.NotLength('9'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_lic_class(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_license_lic_class(SALT34.StrType s) := WHICH(~Scrubs_DL_MA.Functions.fn_verify_lic_class(s)>0,~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 2));
EXPORT InValidMessageFT_invalid_license_lic_class(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_verify_lic_class'),SALT34.HygieneErrors.NotLength('1,2'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_height(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_license_height(SALT34.StrType s) := WHICH(~Scrubs_DL_MA.Functions.fn_verify_height(s)>0);
EXPORT InValidMessageFT_invalid_license_height(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_verify_height'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_sex(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_license_sex(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['F','M','U']);
EXPORT InValidMessageFT_invalid_license_sex(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('F|M|U'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_name(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringtouppercase(s0); // Force to upper case
  s2 := SALT34.stringfilter(s1,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]()-^=!+&,./#*\'\\|"'); // Only allow valid symbols
  s3 := SALT34.stringcleanspaces( SALT34.stringsubstituteout(s2,' <>{}[]()-^=!+&,./#*\'\\|"',' ') ); // Insert spaces but avoid doubles
  RETURN  MakeFT_invalid_wordbag(s3);
END;
EXPORT InValidFT_invalid_license_name(SALT34.StrType s,SALT34.StrType license_first_name,SALT34.StrType license_middle_name) := WHICH(SALT34.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]()-^=!+&,./#*\'\\|"'))),~Scrubs_DL_MA.Functions.fn_valid_name(s,license_first_name,license_middle_name)>0);
EXPORT InValidMessageFT_invalid_license_name(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotCaps,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]()-^=!+&,./#*\'\\|"'),SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_valid_name'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_licmail_state(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_licmail_state(SALT34.StrType s) := WHICH(~Scrubs_DL_MA.Functions.fn_verify_state(s)>0,~(LENGTH(TRIM(s)) = 2));
EXPORT InValidMessageFT_invalid_licmail_state(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_verify_state'),SALT34.HygieneErrors.NotLength('2'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_mailzip(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  MakeFT_invalid_numeric(s1);
END;
EXPORT InValidFT_invalid_mailzip(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_invalid_mailzip(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.NotLength('9'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_licresi_state(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_licresi_state(SALT34.StrType s) := WHICH(~Scrubs_DL_MA.Functions.fn_verify_state(s)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 2));
EXPORT InValidMessageFT_invalid_licresi_state(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_DL_MA.Functions.fn_verify_state'),SALT34.HygieneErrors.NotLength('0,2'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_resizip(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  MakeFT_invalid_numeric(s1);
END;
EXPORT InValidFT_invalid_resizip(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_invalid_resizip(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.NotLength('0,9'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_status(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'/ACENPRSTUVX'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_license_status(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'/ACENPRSTUVX'))),~(LENGTH(TRIM(s)) = 3 OR LENGTH(TRIM(s)) = 7));
EXPORT InValidMessageFT_invalid_license_status(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('/ACENPRSTUVX'),SALT34.HygieneErrors.NotLength('3,7'),SALT34.HygieneErrors.Good);
 
EXPORT SALT34.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'pers_surrogate','filler1','license_licno','filler2','license_bdate_yyyymmdd','license_edate_yyyymmdd','license_lic_class','license_height','license_sex','license_last_name','license_first_name','license_middle_name','licmail_street1','licmail_street2','licmail_city','licmail_state','licmail_zip','licresi_street1','licresi_street2','licresi_city','licresi_state','licresi_zip','issue_date_yyyymmdd','license_status','crlf','clean_status','process_date');
EXPORT FieldNum(SALT34.StrType fn) := CASE(fn,'pers_surrogate' => 0,'filler1' => 1,'license_licno' => 2,'filler2' => 3,'license_bdate_yyyymmdd' => 4,'license_edate_yyyymmdd' => 5,'license_lic_class' => 6,'license_height' => 7,'license_sex' => 8,'license_last_name' => 9,'license_first_name' => 10,'license_middle_name' => 11,'licmail_street1' => 12,'licmail_street2' => 13,'licmail_city' => 14,'licmail_state' => 15,'licmail_zip' => 16,'licresi_street1' => 17,'licresi_street2' => 18,'licresi_city' => 19,'licresi_state' => 20,'licresi_zip' => 21,'issue_date_yyyymmdd' => 22,'license_status' => 23,'crlf' => 24,'clean_status' => 25,'process_date' => 26,0);
 
//Individual field level validation
 
EXPORT Make_pers_surrogate(SALT34.StrType s0) := MakeFT_invalid_pers_surrogate(s0);
EXPORT InValid_pers_surrogate(SALT34.StrType s) := InValidFT_invalid_pers_surrogate(s);
EXPORT InValidMessage_pers_surrogate(UNSIGNED1 wh) := InValidMessageFT_invalid_pers_surrogate(wh);
 
EXPORT Make_filler1(SALT34.StrType s0) := s0;
EXPORT InValid_filler1(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_filler1(UNSIGNED1 wh) := '';
 
EXPORT Make_license_licno(SALT34.StrType s0) := MakeFT_invalid_license_licno(s0);
EXPORT InValid_license_licno(SALT34.StrType s) := InValidFT_invalid_license_licno(s);
...
EXPORT Make_license_bdate_yyyymmdd(SALT34.StrType s0) := MakeFT_invalid_8pastdate(s0);
EXPORT InValid_license_bdate_yyyymmdd(SALT34.StrType s) := InValidFT_invalid_8pastdate(s);
EXPORT InValidMessage_license_bdate_yyyymmdd(UNSIGNED1 wh) := InValidMessageFT_invalid_8pastdate(wh);
 
EXPORT Make_license_edate_yyyymmdd(SALT34.StrType s0) := MakeFT_invalid_8date(s0);
EXPORT InValid_license_edate_yyyymmdd(SALT34.StrType s) := InValidFT_invalid_8date(s);
EXPORT InValidMessage_license_edate_yyyymmdd(UNSIGNED1 wh) := InValidMessageFT_invalid_8date(wh);
 
EXPORT Make_license_lic_class(SALT34.StrType s0) := MakeFT_invalid_license_lic_class(s0);
EXPORT InValid_license_lic_class(SALT34.StrType s) := InValidFT_invalid_license_lic_class(s);
EXPORT InValidMessage_license_lic_class(UNSIGNED1 wh) := InValidMessageFT_invalid_license_lic_class(wh);
 
EXPORT Make_license_height(SALT34.StrType s0) := MakeFT_invalid_license_height(s0);
EXPORT InValid_license_height(SALT34.StrType s) := InValidFT_invalid_license_height(s);
EXPORT InValidMessage_license_height(UNSIGNED1 wh) := InValidMessageFT_invalid_license_height(wh);
 
EXPORT Make_license_sex(SALT34.StrType s0) := MakeFT_invalid_license_sex(s0);
EXPORT InValid_license_sex(SALT34.StrType s) := InValidFT_invalid_license_sex(s);
EXPORT InValidMessage_license_sex(UNSIGNED1 wh) := InValidMessageFT_invalid_license_sex(wh);
 
EXPORT Make_license_last_name(SALT34.StrType s0) := MakeFT_invalid_license_name(s0);
EXPORT InValid_license_last_name(SALT34.StrType s,SALT34.StrType license_first_name,SALT34.StrType license_middle_name) := InValidFT_invalid_license_name(s,license_first_name,license_middle_name);
EXPORT InValidMessage_license_last_name(UNSIGNED1 wh) := InValidMessageFT_invalid_license_name(wh);
 
EXPORT Make_license_first_name(SALT34.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_license_first_name(SALT34.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_license_first_name(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_license_middle_name(SALT34.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_license_middle_name(SALT34.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_license_middle_name(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_licmail_street1(SALT34.StrType s0) := s0;
EXPORT InValid_licmail_street1(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_licmail_street1(UNSIGNED1 wh) := '';
 
EXPORT Make_licmail_street2(SALT34.StrType s0) := s0;
EXPORT InValid_licmail_street2(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_licmail_street2(UNSIGNED1 wh) := '';
 
EXPORT Make_licmail_city(SALT34.StrType s0) := s0;
EXPORT InValid_licmail_city(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_licmail_city(UNSIGNED1 wh) := '';
 
EXPORT Make_licmail_state(SALT34.StrType s0) := MakeFT_invalid_licmail_state(s0);
EXPORT InValid_licmail_state(SALT34.StrType s) := InValidFT_invalid_licmail_state(s);
EXPORT InValidMessage_licmail_state(UNSIGNED1 wh) := InValidMessageFT_invalid_licmail_state(wh);
 
EXPORT Make_licmail_zip(SALT34.StrType s0) := MakeFT_invalid_mailzip(s0);
EXPORT InValid_licmail_zip(SALT34.StrType s) := InValidFT_invalid_mailzip(s);
EXPORT InValidMessage_licmail_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_mailzip(wh);
 
EXPORT Make_licresi_street1(SALT34.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_licresi_street1(SALT34.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_licresi_street1(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_licresi_street2(SALT34.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_licresi_street2(SALT34.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_licresi_street2(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_licresi_city(SALT34.StrType s0) := MakeFT_invalid_wordbag(s0);
EXPORT InValid_licresi_city(SALT34.StrType s) := InValidFT_invalid_wordbag(s);
EXPORT InValidMessage_licresi_city(UNSIGNED1 wh) := InValidMessageFT_invalid_wordbag(wh);
 
EXPORT Make_licresi_state(SALT34.StrType s0) := MakeFT_invalid_licresi_state(s0);
EXPORT InValid_licresi_state(SALT34.StrType s) := InValidFT_invalid_licresi_state(s);
EXPORT InValidMessage_licresi_state(UNSIGNED1 wh) := InValidMessageFT_invalid_licresi_state(wh);
 
EXPORT Make_licresi_zip(SALT34.StrType s0) := MakeFT_invalid_resizip(s0);
EXPORT InValid_licresi_zip(SALT34.StrType s) := InValidFT_invalid_resizip(s);
EXPORT InValidMessage_licresi_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_resizip(wh);
 
EXPORT Make_issue_date_yyyymmdd(SALT34.StrType s0) := MakeFT_invalid_08pastdate(s0);
EXPORT InValid_issue_date_yyyymmdd(SALT34.StrType s) := InValidFT_invalid_08pastdate(s);
EXPORT InValidMessage_issue_date_yyyymmdd(UNSIGNED1 wh) := InValidMessageFT_invalid_08pastdate(wh);
 
EXPORT Make_license_status(SALT34.StrType s0) := MakeFT_invalid_license_status(s0);
EXPORT InValid_license_status(SALT34.StrType s) := InValidFT_invalid_license_status(s);
EXPORT InValidMessage_license_status(UNSIGNED1 wh) := InValidMessageFT_invalid_license_status(wh);
 
EXPORT Make_crlf(SALT34.StrType s0) := s0;
EXPORT InValid_crlf(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_crlf(UNSIGNED1 wh) := '';
 
EXPORT Make_clean_status(SALT34.StrType s0) := s0;
EXPORT InValid_clean_status(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_clean_status(UNSIGNED1 wh) := '';
 
EXPORT Make_process_date(SALT34.StrType s0) := MakeFT_invalid_8pastdate(s0);
EXPORT InValid_process_date(SALT34.StrType s) := InValidFT_invalid_8pastdate(s);
