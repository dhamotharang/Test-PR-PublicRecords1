...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_pers_surrogate := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.pers_surrogate)));
    avelength_pers_surrogate := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.pers_surrogate)),h.pers_surrogate<>(typeof(h.pers_surrogate))'');
    populated_filler1_pcnt := AVE(GROUP,IF(h.filler1 = (TYPEOF(h.filler1))'',0,100));
    maxlength_filler1 := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.filler1)));
    avelength_filler1 := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.filler1)),h.filler1<>(typeof(h.filler1))'');
    populated_license_licno_pcnt := AVE(GROUP,IF(h.license_licno = (TYPEOF(h.license_licno))'',0,100));
    maxlength_license_licno := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_licno)));
    avelength_license_licno := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_licno)),h.license_licno<>(typeof(h.license_licno))'');
    ...
    maxlength_license_bdate_yyyymmdd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_bdate_yyyymmdd)));
    avelength_license_bdate_yyyymmdd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_bdate_yyyymmdd)),h.license_bdate_yyyymmdd<>(typeof(h.license_bdate_yyyymmdd))'');
    populated_license_edate_yyyymmdd_pcnt := AVE(GROUP,IF(h.license_edate_yyyymmdd = (TYPEOF(h.license_edate_yyyymmdd))'',0,100));
    maxlength_license_edate_yyyymmdd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_edate_yyyymmdd)));
    avelength_license_edate_yyyymmdd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_edate_yyyymmdd)),h.license_edate_yyyymmdd<>(typeof(h.license_edate_yyyymmdd))'');
    populated_license_lic_class_pcnt := AVE(GROUP,IF(h.license_lic_class = (TYPEOF(h.license_lic_class))'',0,100));
    maxlength_license_lic_class := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_lic_class)));
    avelength_license_lic_class := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_lic_class)),h.license_lic_class<>(typeof(h.license_lic_class))'');
    populated_license_height_pcnt := AVE(GROUP,IF(h.license_height = (TYPEOF(h.license_height))'',0,100));
    maxlength_license_height := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_height)));
    avelength_license_height := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_height)),h.license_height<>(typeof(h.license_height))'');
    populated_license_sex_pcnt := AVE(GROUP,IF(h.license_sex = (TYPEOF(h.license_sex))'',0,100));
    maxlength_license_sex := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_sex)));
    avelength_license_sex := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_sex)),h.license_sex<>(typeof(h.license_sex))'');
    populated_license_last_name_pcnt := AVE(GROUP,IF(h.license_last_name = (TYPEOF(h.license_last_name))'',0,100));
    maxlength_license_last_name := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_last_name)));
    avelength_license_last_name := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_last_name)),h.license_last_name<>(typeof(h.license_last_name))'');
    populated_license_first_name_pcnt := AVE(GROUP,IF(h.license_first_name = (TYPEOF(h.license_first_name))'',0,100));
    maxlength_license_first_name := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_first_name)));
    avelength_license_first_name := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_first_name)),h.license_first_name<>(typeof(h.license_first_name))'');
    populated_license_middle_name_pcnt := AVE(GROUP,IF(h.license_middle_name = (TYPEOF(h.license_middle_name))'',0,100));
    maxlength_license_middle_name := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_middle_name)));
    avelength_license_middle_name := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_middle_name)),h.license_middle_name<>(typeof(h.license_middle_name))'');
    populated_licmail_street1_pcnt := AVE(GROUP,IF(h.licmail_street1 = (TYPEOF(h.licmail_street1))'',0,100));
    maxlength_licmail_street1 := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_street1)));
    avelength_licmail_street1 := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_street1)),h.licmail_street1<>(typeof(h.licmail_street1))'');
    populated_licmail_street2_pcnt := AVE(GROUP,IF(h.licmail_street2 = (TYPEOF(h.licmail_street2))'',0,100));
    maxlength_licmail_street2 := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_street2)));
    avelength_licmail_street2 := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_street2)),h.licmail_street2<>(typeof(h.licmail_street2))'');
    populated_licmail_city_pcnt := AVE(GROUP,IF(h.licmail_city = (TYPEOF(h.licmail_city))'',0,100));
    maxlength_licmail_city := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_city)));
    avelength_licmail_city := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_city)),h.licmail_city<>(typeof(h.licmail_city))'');
    populated_licmail_state_pcnt := AVE(GROUP,IF(h.licmail_state = (TYPEOF(h.licmail_state))'',0,100));
    maxlength_licmail_state := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_state)));
    avelength_licmail_state := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_state)),h.licmail_state<>(typeof(h.licmail_state))'');
    populated_licmail_zip_pcnt := AVE(GROUP,IF(h.licmail_zip = (TYPEOF(h.licmail_zip))'',0,100));
    maxlength_licmail_zip := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_zip)));
    avelength_licmail_zip := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licmail_zip)),h.licmail_zip<>(typeof(h.licmail_zip))'');
    populated_licresi_street1_pcnt := AVE(GROUP,IF(h.licresi_street1 = (TYPEOF(h.licresi_street1))'',0,100));
    maxlength_licresi_street1 := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_street1)));
    avelength_licresi_street1 := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_street1)),h.licresi_street1<>(typeof(h.licresi_street1))'');
    populated_licresi_street2_pcnt := AVE(GROUP,IF(h.licresi_street2 = (TYPEOF(h.licresi_street2))'',0,100));
    maxlength_licresi_street2 := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_street2)));
    avelength_licresi_street2 := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_street2)),h.licresi_street2<>(typeof(h.licresi_street2))'');
    populated_licresi_city_pcnt := AVE(GROUP,IF(h.licresi_city = (TYPEOF(h.licresi_city))'',0,100));
    maxlength_licresi_city := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_city)));
    avelength_licresi_city := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_city)),h.licresi_city<>(typeof(h.licresi_city))'');
    populated_licresi_state_pcnt := AVE(GROUP,IF(h.licresi_state = (TYPEOF(h.licresi_state))'',0,100));
    maxlength_licresi_state := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_state)));
    avelength_licresi_state := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_state)),h.licresi_state<>(typeof(h.licresi_state))'');
    populated_licresi_zip_pcnt := AVE(GROUP,IF(h.licresi_zip = (TYPEOF(h.licresi_zip))'',0,100));
    maxlength_licresi_zip := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_zip)));
    avelength_licresi_zip := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.licresi_zip)),h.licresi_zip<>(typeof(h.licresi_zip))'');
    populated_issue_date_yyyymmdd_pcnt := AVE(GROUP,IF(h.issue_date_yyyymmdd = (TYPEOF(h.issue_date_yyyymmdd))'',0,100));
    maxlength_issue_date_yyyymmdd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.issue_date_yyyymmdd)));
    avelength_issue_date_yyyymmdd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.issue_date_yyyymmdd)),h.issue_date_yyyymmdd<>(typeof(h.issue_date_yyyymmdd))'');
    populated_license_status_pcnt := AVE(GROUP,IF(h.license_status = (TYPEOF(h.license_status))'',0,100));
    maxlength_license_status := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_status)));
    avelength_license_status := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.license_status)),h.license_status<>(typeof(h.license_status))'');
    populated_crlf_pcnt := AVE(GROUP,IF(h.crlf = (TYPEOF(h.crlf))'',0,100));
    maxlength_crlf := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.crlf)));
    avelength_crlf := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.crlf)),h.crlf<>(typeof(h.crlf))'');
    populated_clean_status_pcnt := AVE(GROUP,IF(h.clean_status = (TYPEOF(h.clean_status))'',0,100));
    maxlength_clean_status := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.clean_status)));
    avelength_clean_status := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.clean_status)),h.clean_status<>(typeof(h.clean_status))'');
...
SALT34.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT34.StrType)le.pers_surrogate),TRIM((SALT34.StrType)le.filler1),TRIM((SALT34.StrType)le.license_licno),TRIM((SALT34.StrType)le.filler2),TRIM((SALT34.StrType)le.license_bdate_yyyymmdd),TRIM((SALT34.StrType)le.license_edate_yyyymmdd),TRIM((SALT34.StrType)le.license_lic_class),TRIM((SALT34.StrType)le.license_height),TRIM((SALT34.StrType)le.license_sex),TRIM((SALT34.StrType)le.license_last_name),TRIM((SALT34.StrType)le.license_first_name),TRIM((SALT34.StrType)le.license_middle_name),TRIM((SALT34.StrType)le.licmail_street1),TRIM((SALT34.StrType)le.licmail_street2),TRIM((SALT34.StrType)le.licmail_city),TRIM((SALT34.StrType)le.licmail_state),TRIM((SALT34.StrType)le.licmail_zip),TRIM((SALT34.StrType)le.licresi_street1),TRIM((SALT34.StrType)le.licresi_street2),TRIM((SALT34.StrType)le.licresi_city),TRIM((SALT34.StrType)le.licresi_state),TRIM((SALT34.StrType)le.licresi_zip),TRIM((SALT34.StrType)le.issue_date_yyyymmdd),TRIM((SALT34.StrType)le.license_status),TRIM((SALT34.StrType)le.crlf),TRIM((SALT34.StrType)le.clean_status),TRIM((SALT34.StrType)le.process_date)));
  SELF.FldNo := C;
END;
...
SALT34.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 27);
  SELF.FldNo2 := 1 + (C % 27);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT34.StrType)le.pers_surrogate),TRIM((SALT34.StrType)le.filler1),TRIM((SALT34.StrType)le.license_licno),TRIM((SALT34.StrType)le.filler2),TRIM((SALT34.StrType)le.license_bdate_yyyymmdd),TRIM((SALT34.StrType)le.license_edate_yyyymmdd),TRIM((SALT34.StrType)le.license_lic_class),TRIM((SALT34.StrType)le.license_height),TRIM((SALT34.StrType)le.license_sex),TRIM((SALT34.StrType)le.license_last_name),TRIM((SALT34.StrType)le.license_first_name),TRIM((SALT34.StrType)le.license_middle_name),TRIM((SALT34.StrType)le.licmail_street1),TRIM((SALT34.StrType)le.licmail_street2),TRIM((SALT34.StrType)le.licmail_city),TRIM((SALT34.StrType)le.licmail_state),TRIM((SALT34.StrType)le.licmail_zip),TRIM((SALT34.StrType)le.licresi_street1),TRIM((SALT34.StrType)le.licresi_street2),TRIM((SALT34.StrType)le.licresi_city),TRIM((SALT34.StrType)le.licresi_state),TRIM((SALT34.StrType)le.licresi_zip),TRIM((SALT34.StrType)le.issue_date_yyyymmdd),TRIM((SALT34.StrType)le.license_status),TRIM((SALT34.StrType)le.crlf),TRIM((SALT34.StrType)le.clean_status),TRIM((SALT34.StrType)le.process_date)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT34.StrType)le.pers_surrogate),TRIM((SALT34.StrType)le.filler1),TRIM((SALT34.StrType)le.license_licno),TRIM((SALT34.StrType)le.filler2),TRIM((SALT34.StrType)le.license_bdate_yyyymmdd),TRIM((SALT34.StrType)le.license_edate_yyyymmdd),TRIM((SALT34.StrType)le.license_lic_class),TRIM((SALT34.StrType)le.license_height),TRIM((SALT34.StrType)le.license_sex),TRIM((SALT34.StrType)le.license_last_name),TRIM((SALT34.StrType)le.license_first_name),TRIM((SALT34.StrType)le.license_middle_name),TRIM((SALT34.StrType)le.licmail_street1),TRIM((SALT34.StrType)le.licmail_street2),TRIM((SALT34.StrType)le.licmail_city),TRIM((SALT34.StrType)le.licmail_state),TRIM((SALT34.StrType)le.licmail_zip),TRIM((SALT34.StrType)le.licresi_street1),TRIM((SALT34.StrType)le.licresi_street2),TRIM((SALT34.StrType)le.licresi_city),TRIM((SALT34.StrType)le.licresi_state),TRIM((SALT34.StrType)le.licresi_zip),TRIM((SALT34.StrType)le.issue_date_yyyymmdd),TRIM((SALT34.StrType)le.license_status),TRIM((SALT34.StrType)le.crlf),TRIM((SALT34.StrType)le.clean_status),TRIM((SALT34.StrType)le.process_date)));
  END;
...
SHARED FldIds := DATASET([{1,'pers_surrogate'}
      ...
      ,{25,'crlf'}
      ,{26,'clean_status'}
      ,{27,'process_date'}],SALT34.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_pers_surrogate((SALT34.StrType)le.pers_surrogate),
    Fields.InValid_filler1((SALT34.StrType)le.filler1),
    Fields.InValid_license_licno((SALT34.StrType)le.license_licno),
    Fields.InValid_filler2((SALT34.StrType)le.filler2),
    Fields.InValid_license_bdate_yyyymmdd((SALT34.StrType)le.license_bdate_yyyymmdd),
    Fields.InValid_license_edate_yyyymmdd((SALT34.StrType)le.license_edate_yyyymmdd),
    Fields.InValid_license_lic_class((SALT34.StrType)le.license_lic_class),
    Fields.InValid_license_height((SALT34.StrType)le.license_height),
    Fields.InValid_license_sex((SALT34.StrType)le.license_sex),
    Fields.InValid_license_last_name((SALT34.StrType)le.license_last_name,(SALT34.StrType)le.license_first_name,(SALT34.StrType)le.license_middle_name),
    Fields.InValid_license_first_name((SALT34.StrType)le.license_first_name),
    Fields.InValid_license_middle_name((SALT34.StrType)le.license_middle_name),
    Fields.InValid_licmail_street1((SALT34.StrType)le.licmail_street1),
    Fields.InValid_licmail_street2((SALT34.StrType)le.licmail_street2),
    Fields.InValid_licmail_city((SALT34.StrType)le.licmail_city),
    Fields.InValid_licmail_state((SALT34.StrType)le.licmail_state),
    Fields.InValid_licmail_zip((SALT34.StrType)le.licmail_zip),
    Fields.InValid_licresi_street1((SALT34.StrType)le.licresi_street1),
    Fields.InValid_licresi_street2((SALT34.StrType)le.licresi_street2),
    Fields.InValid_licresi_city((SALT34.StrType)le.licresi_city),
    Fields.InValid_licresi_state((SALT34.StrType)le.licresi_state),
    Fields.InValid_licresi_zip((SALT34.StrType)le.licresi_zip),
    Fields.InValid_issue_date_yyyymmdd((SALT34.StrType)le.issue_date_yyyymmdd),
    Fields.InValid_license_status((SALT34.StrType)le.license_status),
    Fields.InValid_crlf((SALT34.StrType)le.crlf),
    Fields.InValid_clean_status((SALT34.StrType)le.clean_status),
