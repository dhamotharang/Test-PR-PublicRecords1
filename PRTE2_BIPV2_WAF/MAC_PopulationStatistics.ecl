...
EXPORT MAC_PopulationStatistics(infile,Ref='',SOURCE='',Input_parent_proxid = '',Input_ultimate_proxid = '',Input_has_lgid = '',Input_empid = '',Input_powid = '',Input_source = '',Input_source_record_id = '',Input_cnp_number = '',Input_cnp_btype = '',Input_cnp_lowv = '',Input_cnp_name = '',Input_company_phone = '',Input_company_fein = '',Input_company_sic_code1 = '',Input_prim_range = '',Input_prim_name = '',Input_sec_range = '',Input_p_city_name = '',Input_st = '',Input_zip = '',Input_company_url = '',Input_isContact = '',Input_title = '',Input_fname = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',Input_contact_email = '',Input_CONTACTNAME = '',Input_STREETADDRESS = '',OutFile) := MACRO
  IMPORT SALT38,PRTE2_BIPV2_WAF;
  #uniquename(of)
  %of% := RECORD
    #IF (#TEXT(SOURCE)<>'')
    SALT38.StrType source;
    #END
