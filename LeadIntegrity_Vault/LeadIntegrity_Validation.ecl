...
EXPORT LeadIntegrity_Validation(STRING8 date_in, STRING part_in) := MODULE
        ...
        EXPORT dset_Input_Validation() := FUNCTION
                ...
                dset_Input := DATASET(LeadIntegrity_Vault.Constants.MMPrefix + date_in+ '_' + TRIM(part_in)+'_of_05', LeadIntegrity_Vault_Layout.Layout_LeadIntegrity_Inlayout, THOR);
                ...
                fn_IndvFilecount(STRING2 part) := FUNCTION
                    IndvFilecount := DATASET(LeadIntegrity_Vault.Constants.MMPrefix + date_in+ '_' + TRIM(part_in)+'_of_05',
        ...
        EXPORT dset_Output_Validation(STRING8 date_in, STRING2 part_in) := FUNCTION
                ...
                lead_integrity_input_suffix := date_in+ '_' + TRIM(part_in)+'_of_05';
