...
//LPFile => rec_type = '03'
//******************************************************************** 
Corp2_Raw_VA.Layouts.LPLayoutIn  LPTranform(Corp2_Raw_VA.Layouts.CorpsStringLayoutIn l) := TRANSFORM
...
EXPORT FileLPFile(dataset(Corp2_Raw_VA.Layouts.CorpsStringLayoutIn) pInCorps) := project(pInCorps,LPTranform(LEFT));