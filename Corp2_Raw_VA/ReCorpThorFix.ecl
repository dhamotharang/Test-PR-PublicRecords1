...
dsMainCorp			:=	distribute(dataset('~thor_data400::in::corp2::20160425::main_va',		Corp2_Mapping.LayoutsCommon.main, flat)(recordorigin='C'),hash(corp_key));
dsMainCont			:=	distribute(dataset('~thor_data400::in::corp2::20160425::main_va',		Corp2_Mapping.LayoutsCommon.main, flat)(recordorigin='T'),hash(corp_key));
dsEvent					:=	distribute(dataset('~thor_data400::in::corp2::20160425::event_va',	Corp2_Mapping.LayoutsCommon.events, flat),hash(corp_key));
dsStock					:=	distribute(dataset('~thor_data400::in::corp2::20160425::stock_va',	Corp2_Mapping.LayoutsCommon.stock, flat),hash(corp_key));
...
Corp2.Layout_Corporate_Direct_Corp_Base_Expanded trfCorpFields(Corp2.Layout_Corporate_Direct_Corp_Base_Expanded Input)	:=	transform
			...
			self.corp_forgn_state_cd     		 := if (corp2.t2u(input.corp_forgn_state_cd) = '' and corp2.t2u(input.corp_forgn_state_desc)<>'',
																							corp2_raw_va.functions.state_codes(input.corp_forgn_state_desc),
