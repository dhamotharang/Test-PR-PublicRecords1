export Functions_OneStepPass := Module
	...
	EXPORT compareResults2Configuration(string configName, dataset(layouts.Verifications) serviceFlags) := Function
		configFlags := Functions_OneStepPass_Configuration.getConfig(configName);
		...
		OneStepOutcome:= cfg_Valid and cfg_Name_Pass and cfg_CompanyName_Pass and cfg_Address_Pass and cfg_Phone_Pass and 
									...
									cfg_DEAVerified_Pass and cfg_DEA2Verified_Pass and cfg_NCPDPNumberVerified_Pass and cfg_AnyLicenseValid_Pass and cfg_AnyLicenseVerified_Pass and 
		...
		ds_results := project(serviceFlags, transform(layouts.Verifications, 
