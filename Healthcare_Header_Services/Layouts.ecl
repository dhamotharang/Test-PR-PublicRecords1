...
export Layouts := MODULE
	...
	EXPORT layout_npi := record
		...
		integer bestsource := Constants.DEFAULT_BESTSCORE;
	...
	export common_runtime_config := record
			...
			UNSIGNED2 penalty_threshold := Constants.CFG_penalty_threshold;
			UNSIGNED2 maxResults := Constants.CFG_maxResults;
			string	DRM := Constants.CFG_DRM;
			boolean	hasFullNCPDP := Constants.CFG_False;
			boolean	glb_ok := Constants.CFG_False;
			boolean	dppa_ok := Constants.CFG_False;
			boolean isReport := Constants.CFG_False;
			boolean isBatchService := Constants.CFG_False;
			boolean isExactAddressMatch := Constants.CFG_False;
			boolean IsShowAllDoDs := Constants.CFG_False;
			boolean doDeepDive := Constants.CFG_False;
			boolean BestOnly := Constants.CFG_False;
			boolean ShowComplete := Constants.CFG_False;
			boolean excludeSourceAMS := Constants.CFG_False;
			boolean excludeSourceNPPES := Constants.CFG_False;
			boolean excludeSourceDEA := Constants.CFG_False;
			boolean excludeSourceProfLic := Constants.CFG_False;
			boolean excludeSourceSelectFile := Constants.CFG_False;
			boolean excludeSourceCLIA := Constants.CFG_False;
			boolean excludeSourceNCPDP := Constants.CFG_False;
			boolean excludeLegacySanctions := Constants.CFG_False;
			boolean IncludeAlsoFound := Constants.CFG_False;
			boolean includeCustomerData := Constants.CFG_False;
			boolean IncludeProvidersOnly := Constants.CFG_False;
			boolean IncludeSanctionsOnly := Constants.CFG_False;
			boolean IncludeSanctions := Constants.CFG_True;
			boolean IncludeGroupAffiliations := Constants.CFG_False;
			boolean IncludeHospitalAffiliations := Constants.CFG_False;
			boolean IncludeSpecialties  := Constants.CFG_False;
			boolean IncludeLicenses  := Constants.CFG_False;
			boolean IncludeResidencies  := Constants.CFG_False;
			boolean IncludeABMSBoardCertifiedSpecialty := Constants.CFG_False;
			boolean IncludeABMSCareer := Constants.CFG_False;
			boolean IncludeABMSEducation := Constants.CFG_False;
			boolean IncludeABMSProfessionalAssociations := Constants.CFG_False;
			boolean IncludeNPI := Constants.CFG_False;
			boolean IncludeDEA := Constants.CFG_False;
			boolean IncludeCLIA := Constants.CFG_False;
			boolean IncludeNCPDP := Constants.CFG_False;
			boolean IncludeFEIN := Constants.CFG_False;
