EXPORT Bus_shell_21_Sprint2_Layout := module
...
layoutsbfe := RECORD
   ...
   string3 sbfeutilizationhighrevolving;
   string3 sbfeutilizationhighline;
   string3 sbfeutilizationhighcard;
   string3 sbfeutilizationindexcard12month;
   string3 sbfeutilizationindexcard24month;
   string3 sbfeutiliztionhigholine;
  END;
