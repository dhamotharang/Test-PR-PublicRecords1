...
basefilename := '~scoringqa::out::nonfcra::bocashell_41_historydate_999999_cert_20190227_1';            //Bocashell Version 41 in Production     
testfilename := '~scoringqa::out::nonfcra::bocashell_41_historydate_999999_cert_20190301_1';             //PhoneShell version 10
...
j1 := join(ds_baseline, ds_new, left.AccountNumber = right.AccountNumber
				AND left.source_verification.num_nonderogs12 <> right.source_verification.num_nonderogs12,
...
OUTPUT(COUNT(j1), named('Diff_num_nonderogs12_Count'));
OUTPUT(COUNT(j2), named('Increase_num_nonderogs12_Count'));
OUTPUT(COUNT(j3), named('Decrease_num_nonderogs12_Count'));
OUTPUT(COUNT(j4), named('increase_num_nonderogs_Count'));
OUTPUT(COUNT(j5), named('Decrease_num_nonderogs_Count'));

OUTPUT(choosen(j1, 20), NAMED('Diff_num_nonderogs12'));
OUTPUT(CHOOSEN(j2, eyeball), NAMED('Increase_num_nonderogs12'));
OUTPUT(CHOOSEN(j3, eyeball), NAMED('Decrease_num_nonderogs12'));
OUTPUT(CHOOSEN(j4, eyeball), NAMED('increase_num_nonderogs'));
OUTPUT(CHOOSEN(j5, eyeball), NAMED('Decrease_num_nonderogs'));
