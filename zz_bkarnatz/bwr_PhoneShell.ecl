#workunit('name', 'PhoneShell_Analysis');
...
ds_base := choosen(dataset('~bkarnatz::out::phone_shell_neustar_baseline_w20160822-084616.csv', input_layout, CSV(heading(single), QUOTE('"'))), all);
...
ds_test := choosen(dataset('~bkarnatz::out::phone_shell_neustar_second_w20160822-164417.csv', input_layout, CSV(heading(single), QUOTE('"'))), all);
...
output(ave(j_base, phone_score), named('base_phone_ave'));
output(ave(j_test, phone_score),named('test_phone_ave'));
