#workunit('name','Paro IT60');   //Paro IT 60 Batch and XML Attributes and Score1 and score3

import risk_indicators, ut, ashirey, scoring_project_Macros, scoring_project_pip;

eyeball := 25;

input_layout := scoring_project_Macros.Global_Output_Layouts.NONFCRA_IT60_Paro_Global_Layout;
...
basefilename := '~scoringqa::out::nonfcra::it60_xml_paro_msn605_20150223_1';    // XML or Batch
testfilename := '~scoringqa::out::nonfcra::it60_xml_paro_msn605_20150224_1';  
pii_name := scoring_project_pip.Input_Sample_Names.Paro_it60_XML_infile_name;  //XML or Batch
