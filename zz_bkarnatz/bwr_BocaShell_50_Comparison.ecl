...
// #workunit('name','FCRA-Bocashell 5.0');
...
basefilename := '~scoringqa::out::bs_50_nonfcra_no_edina_196_experianvin_baseline_20160621';      //remove cert_ for Prod
testfilename := '~scoringqa::out::bs_50_nonfcra_no_edina_196_experianvin_second_20160621';      //change fcra to nonfcra
...
// ashirey.Diff(flatten_baseline, flatten_second, ['AccountNumber'], j1, 'BS50' );

// output(COUNT(ds_baseline(bjl.criminal_count > 0)), NAMED('baseline_Criminal_count'));
// output(COUNT(ds_new(bjl.criminal_count > 0)), NAMED('Test_Criminal_count'));
// OUTPUT(COUNT(j1), named('DID_Not_Equal_Count'));
// OUTPUT(CHOOSEN(j1, eyeball), NAMED('DID_Not_Equal'));
