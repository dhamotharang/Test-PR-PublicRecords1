EXPORT BocaShell_51_NonFCRA_Macro(string IP, unsigned1 Threads, unsigned records, string filename) := Function
...
IMPORT Risk_Indicators, RiskWise, ut, riskprocessing;
...
outfile_name := '~ScoringQA::out::BocaShell_51_NonFCRA_ ' + filename + '_' + thorlib.wuid();
...
OUTPUT(res, , outfile_name, thor, overwrite);  // Write to disk.
...
Return OUTPUT(edina,, outfile_name+'_edina_v51',CSV(heading(single), quote('"')), overwrite); // Write to disk.
