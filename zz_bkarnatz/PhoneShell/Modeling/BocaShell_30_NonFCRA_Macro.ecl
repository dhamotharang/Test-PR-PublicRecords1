EXPORT BocaShell_30_NonFCRA_Macro(string IP, unsigned1 Threads, unsigned records, string filename ) := Function

IMPORT Risk_Indicators, RiskWise, std;

// #workunit('name','NonFCRA BocaShell3');
...
//===================  input-output files  ======================
// infile_name := '~jpyon::in::sprint_pii_090709_subset_in';
infile_name := '~scoring_project::in::ndobmeier::fp30dev::fp3_modelval_pii';

// outfile_name := '~tsteil::out::bocashell3_nonfcra_sprint_'+ thorlib.wuid();	// this will output your work unit number in your filename
outfile_name := '~ScoringQA::out::BocaShell_30_NonFCRA_'+ filename + '_' + thorlib.wuid();
...
Return output(edina,, outfile_name+'_edina',CSV(heading(single), quote('"')), overwrite);
