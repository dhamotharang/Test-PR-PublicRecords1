// EXPORT Phone_Shell_10_NoGateways := 'todo';
...
#WORKUNIT('name', 'Phone_Shell_10_NoGateways');
...
// OutputFile := '~ScoringQA::out::phone_shell_version_10_May_July_No_gateways_NoRestrictions' + '_PhonesPlusv2_Gong_Base_' + thorlib.wuid();						//Run with No Restrictions
OutputFile := '~ScoringQA::out::phone_shell_version_10_May_July_No_gateways_Restrictions' + '_PhonesPlusv2_Gong_Base_' + thorlib.wuid();         //Run with Restrictions
...
soapResults := SOAPCALL(
													...
													'Phone_Shell.Phone_Shell_service', // only active version for Cert/Prod
													{soap},  
