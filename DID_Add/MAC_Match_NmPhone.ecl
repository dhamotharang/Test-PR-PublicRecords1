...
typeof(infile) %phone_tra%(infile l, %ca% r) := transform
		localscore :=   100 div MAP (
				   ...
				   ut.Translate_Suffix(l.suffix_field)=ut.Translate_Suffix(r.name_suffix) and r.phone_fullname_dids<>0 => r.phone_fullname_dids,
				   l.suffix_field<>'' and
				   ut.Translate_Suffix(l.suffix_field)=ut.Translate_Suffix(r.name_suffix) and r.phone_fname_suffix_dids<>0 => r.phone_fname_suffix_dids,
				   r.phone_fname_dids);
