...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_corp_action_pending_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_action_pending_desc)));
    avelength_corp_action_pending_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_action_pending_desc)),h.corp_action_pending_desc<>(typeof(h.corp_action_pending_desc))'');
    ...
    maxlength_corp_management_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_management_desc)));
    avelength_corp_management_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_management_desc)),h.corp_management_desc<>(typeof(h.corp_management_desc))'');
    ...
    maxlength_corp_merger_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_desc)));
    avelength_corp_merger_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_desc)),h.corp_merger_desc<>(typeof(h.corp_merger_desc))'');
    ...
    maxlength_corp_merger_type_converted_to_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_type_converted_to_desc)));
    avelength_corp_merger_type_converted_to_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_type_converted_to_desc)),h.corp_merger_type_converted_to_desc<>(typeof(h.corp_merger_type_converted_to_desc))'');
    populated_corp_naics_desc_pcnt := AVE(GROUP,IF(h.corp_naics_desc = (TYPEOF(h.corp_naics_desc))'',0,100));
    maxlength_corp_naics_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_naics_desc)));
    avelength_corp_naics_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_naics_desc)),h.corp_naics_desc<>(typeof(h.corp_naics_desc))'');
    ...
    maxlength_corp_name_reservation_nbr := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_reservation_nbr)));
    avelength_corp_name_reservation_nbr := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_reservation_nbr)),h.corp_name_reservation_nbr<>(typeof(h.corp_name_reservation_nbr))'');
    ...
    maxlength_corp_name_status_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_status_desc)));
    avelength_corp_name_status_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_status_desc)),h.corp_name_status_desc<>(typeof(h.corp_name_status_desc))'');
    ...
    maxlength_corp_nbr_of_amendments := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_amendments)));
    avelength_corp_nbr_of_amendments := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_amendments)),h.corp_nbr_of_amendments<>(typeof(h.corp_nbr_of_amendments))'');
    ...
    maxlength_corp_nbr_of_initial_llc_members := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_initial_llc_members)));
    avelength_corp_nbr_of_initial_llc_members := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_initial_llc_members)),h.corp_nbr_of_initial_llc_members<>(typeof(h.corp_nbr_of_initial_llc_members))'');
    populated_corp_nbr_of_partners_pcnt := AVE(GROUP,IF(h.corp_nbr_of_partners = (TYPEOF(h.corp_nbr_of_partners))'',0,100));
    maxlength_corp_nbr_of_partners := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_partners)));
    avelength_corp_nbr_of_partners := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_nbr_of_partners)),h.corp_nbr_of_partners<>(typeof(h.corp_nbr_of_partners))'');
    ...
    maxlength_corp_opt_in_llc_act_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_opt_in_llc_act_desc)));
    avelength_corp_opt_in_llc_act_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_opt_in_llc_act_desc)),h.corp_opt_in_llc_act_desc<>(typeof(h.corp_opt_in_llc_act_desc))'');
    ...
    maxlength_corp_termination_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_termination_desc)));
    avelength_corp_termination_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_termination_desc)),h.corp_termination_desc<>(typeof(h.corp_termination_desc))'');
    ...
    maxlength_corp_trademark_classification_nbr := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_trademark_classification_nbr)));
    avelength_corp_trademark_classification_nbr := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_trademark_classification_nbr)),h.corp_trademark_classification_nbr<>(typeof(h.corp_trademark_classification_nbr))'');
    ...
    maxlength_corp_trademark_nbr := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_trademark_nbr)));
    avelength_corp_trademark_nbr := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_trademark_nbr)),h.corp_trademark_nbr<>(typeof(h.corp_trademark_nbr))'');
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{260,'corp_trademark_classification_nbr'}
...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_corp_action_pending_desc((SALT34.StrType)le.corp_action_pending_desc),
    ...
    Fields.InValid_corp_management_desc((SALT34.StrType)le.corp_management_desc),
    ...
    Fields.InValid_corp_merger_desc((SALT34.StrType)le.corp_merger_desc),
    ...
    Fields.InValid_corp_merger_type_converted_to_desc((SALT34.StrType)le.corp_merger_type_converted_to_desc),
    Fields.InValid_corp_naics_desc((SALT34.StrType)le.corp_naics_desc),
    ...
    Fields.InValid_corp_name_reservation_nbr((SALT34.StrType)le.corp_name_reservation_nbr),
    ...
    Fields.InValid_corp_name_status_desc((SALT34.StrType)le.corp_name_status_desc),
    ...
    Fields.InValid_corp_nbr_of_amendments((SALT34.StrType)le.corp_nbr_of_amendments),
    Fields.InValid_corp_nbr_of_initial_llc_members((SALT34.StrType)le.corp_nbr_of_initial_llc_members),
    Fields.InValid_corp_nbr_of_partners((SALT34.StrType)le.corp_nbr_of_partners),
    Fields.InValid_corp_operatingagreement((SALT34.StrType)le.corp_operatingagreement),
    Fields.InValid_corp_opt_in_llc_act_desc((SALT34.StrType)le.corp_opt_in_llc_act_desc),
    ...
    Fields.InValid_corp_termination_desc((SALT34.StrType)le.corp_termination_desc),
    Fields.InValid_corp_termination_date((SALT34.StrType)le.corp_termination_date),
    Fields.InValid_corp_trademark_classification_nbr((SALT34.StrType)le.corp_trademark_classification_nbr),
    ...
    Fields.InValid_corp_trademark_nbr((SALT34.StrType)le.corp_trademark_nbr),
