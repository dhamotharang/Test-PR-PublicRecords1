...
Command line options: -MScrubs_Corp2_Mapping_MI_Main -eC:\Users\mattel01\AppData\Local\Temp\TFRC796.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_MI_Main
FILENAME:In_MI
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_org_structure_desc>0)
FIELDTYPE:invalid_status_comment:ALLOW( /-();:,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ) 
...
FIELDTYPE:invalid_forgn_state:CUSTOM(Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_forgn_state>0)
...
FIELD:corp_address1_line3:TYPE(STRING70):LIKE(invalid_alpha):0,0
...
FIELD:corp_status_comment:TYPE(STRING350):LIKE(invalid_status_comment):0,0
...
FIELD:corp_foreign_domestic_ind:TYPE(STRING1):0,0
FIELD:corp_forgn_state_cd:TYPE(STRING3):LIKE(invalid_forgn_state):0,0
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_forgn_state):0,0
...
FIELD:cont_address_line3:TYPE(STRING70):LIKE(invalid_alpha):0,0
...
FIELD:corp_comment:TYPE(STRING2):0,0
...
FIELD:corp_dissolved_date:TYPE(STRING8):LIKE(invalid_date):0,0
...
FIELD:corp_non_profit_irs_approved_purpose:TYPE(STRING):0,0
FIELD:corp_non_profit_solicit_donations:TYPE(STRING1):0,0
FIELD:corp_nbr_of_amendments:TYPE(UNSIGNED6):0,0
FIELD:corp_nbr_of_initial_llc_members:TYPE(STRING):0,0
FIELD:corp_nbr_of_partners:TYPE(UNSIGNED6):0,0
