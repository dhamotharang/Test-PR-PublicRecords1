...
EXPORT MakeFT_invalid_future_date(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_future_date(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_GeneralDate(s)>0);
EXPORT InValidMessageFT_invalid_future_date(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars('0123456789'),SALT38.HygieneErrors.CustomFail('Scrubs.fn_valid_GeneralDate'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_Y_N(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_Y_N(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['Y','N']);
EXPORT InValidMessageFT_invalid_Y_N(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('Y|N'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_cd(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT38.StrType s,SALT38.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_cd'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT38.StrType s,SALT38.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_desc'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_desc(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_desc(SALT38.StrType s) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_org_structure_desc(s)>0);
EXPORT InValidMessageFT_invalid_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_org_structure_desc'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_comment(SALT38.StrType s0) := FUNCTION
  s1 := SALT38.stringfilter(s0,' /-();:,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_status_comment(SALT38.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT38.StringFilter(s,' /-();:,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_status_comment(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInChars(' /-();:,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['INACTIVE','ACTIVE']);
EXPORT InValidMessageFT_invalid_status(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('INACTIVE|ACTIVE'),SALT38.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_recordorigin(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_recordorigin(SALT38.StrType s) := WHICH(((SALT38.StrType) s) NOT IN ['C','T']);
EXPORT InValidMessageFT_invalid_recordorigin(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.NotInEnum('C|T'),SALT38.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_forgn_state(SALT38.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_state(SALT38.StrType s) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_forgn_state(s)>0);
EXPORT InValidMessageFT_invalid_forgn_state(UNSIGNED1 wh) := CHOOSE(wh,SALT38.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_forgn_state'),SALT38.HygieneErrors.Good);
...
EXPORT Make_corp_ln_name_type_cd(SALT38.StrType s0) := MakeFT_invalid_type_cd(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT38.StrType s,SALT38.StrType recordorigin) := InValidFT_invalid_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_type_cd(wh);
 
EXPORT Make_corp_ln_name_type_desc(SALT38.StrType s0) := MakeFT_invalid_type_desc(s0);
EXPORT InValid_corp_ln_name_type_desc(SALT38.StrType s,SALT38.StrType recordorigin) := InValidFT_invalid_type_desc(s,recordorigin);
...
EXPORT Make_corp_address1_line3(SALT38.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_corp_address1_line3(SALT38.StrType s) := InValidFT_invalid_alpha(s);
...
EXPORT Make_corp_status_desc(SALT38.StrType s0) := s0;
EXPORT InValid_corp_status_desc(SALT38.StrType s) := 0;
...
EXPORT Make_corp_status_comment(SALT38.StrType s0) := MakeFT_invalid_status_comment(s0);
EXPORT InValid_corp_status_comment(SALT38.StrType s) := InValidFT_invalid_status_comment(s);
...
EXPORT Make_corp_foreign_domestic_ind(SALT38.StrType s0) := s0;
EXPORT InValid_corp_foreign_domestic_ind(SALT38.StrType s) := 0;
EXPORT InValidMessage_corp_foreign_domestic_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_state_cd(SALT38.StrType s0) := MakeFT_invalid_forgn_state(s0);
EXPORT InValid_corp_forgn_state_cd(SALT38.StrType s) := InValidFT_invalid_forgn_state(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_state(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT38.StrType s0) := MakeFT_invalid_forgn_state(s0);
EXPORT InValid_corp_forgn_state_desc(SALT38.StrType s) := InValidFT_invalid_forgn_state(s);
...
EXPORT Make_corp_orig_org_structure_desc(SALT38.StrType s0) := MakeFT_invalid_org_structure_desc(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT38.StrType s) := InValidFT_invalid_org_structure_desc(s);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_org_structure_desc(wh);
 
EXPORT Make_corp_for_profit_ind(SALT38.StrType s0) := s0;
EXPORT InValid_corp_for_profit_ind(SALT38.StrType s) := 0;
...
EXPORT Make_corp_ra_suffix(SALT38.StrType s0) := s0;
EXPORT InValid_corp_ra_suffix(SALT38.StrType s) := 0;
...
EXPORT Make_cont_suffix(SALT38.StrType s0) := s0;
EXPORT InValid_cont_suffix(SALT38.StrType s) := 0;
...
EXPORT Make_cont_address_line3(SALT38.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_cont_address_line3(SALT38.StrType s) := InValidFT_invalid_alpha(s);
...
EXPORT Make_corp_dissolved_date(SALT38.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_dissolved_date(SALT38.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_farm_status_date(SALT38.StrType s0) := s0;
EXPORT InValid_corp_farm_status_date(SALT38.StrType s) := 0;
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT38,Scrubs_Corp2_Mapping_MI_Main;
