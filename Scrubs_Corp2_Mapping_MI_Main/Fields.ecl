IMPORT ut,SALT34;
IMPORT Scrubs,Scrubs_Corp2_Mapping_MI_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_Y_N','invalid_type_cd','invalid_type_desc','invalid_org_structure_desc','invalid_status_comment','invalid_status','invalid_numeric','invalid_recordorigin','invalid_forgn_state','invalid_alpha');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_Y_N' => 8,'invalid_type_cd' => 9,'invalid_type_desc' => 10,'invalid_org_structure_desc' => 11,'invalid_status_comment' => 12,'invalid_status' => 13,'invalid_numeric' => 14,'invalid_recordorigin' => 15,'invalid_forgn_state' => 16,'invalid_alpha' => 17,0);
...
EXPORT MakeFT_invalid_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_org_structure_desc(s)>0);
EXPORT InValidMessageFT_invalid_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_org_structure_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_comment(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' /-();,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_status_comment(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' /-();,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_status_comment(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' /-();,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['INACTIVE','ACTIVE']);
EXPORT InValidMessageFT_invalid_status(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('INACTIVE|ACTIVE'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_forgn_state(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_state(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_forgn_state(s)>0);
EXPORT InValidMessageFT_invalid_forgn_state(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MI_Main.Functions.invalid_forgn_state'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_status_comment(SALT34.StrType s0) := MakeFT_invalid_status_comment(s0);
EXPORT InValid_corp_status_comment(SALT34.StrType s) := InValidFT_invalid_status_comment(s);
EXPORT InValidMessage_corp_status_comment(UNSIGNED1 wh) := InValidMessageFT_invalid_status_comment(wh);
...
EXPORT Make_corp_forgn_state_cd(SALT34.StrType s0) := MakeFT_invalid_forgn_state(s0);
EXPORT InValid_corp_forgn_state_cd(SALT34.StrType s) := InValidFT_invalid_forgn_state(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_state(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT34.StrType s0) := MakeFT_invalid_forgn_state(s0);
EXPORT InValid_corp_forgn_state_desc(SALT34.StrType s) := InValidFT_invalid_forgn_state(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_state(wh);
...
EXPORT Make_cont_address_line3(SALT34.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_cont_address_line3(SALT34.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_cont_address_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
...
EXPORT Make_corp_dissolved_date(SALT34.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_dissolved_date(SALT34.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_dissolved_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_MI_Main;
