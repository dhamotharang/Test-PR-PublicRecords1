...
#workunit('name','BIPV2_Best_Proxid.BWR_Specificities - Specificities - SALT V2.8 Gold SR1');
...
// SALTTOOLS22.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_Best_Proxid.<your_spc_attribute>',BIPV2_Best_Proxid.In_Base);
