...
#workunit('name','BIPV2_Best_Proxid.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
...
P := BIPV2_Best_Proxid.Proc_Iterate('1'); // Change '1' for later iterations
...
SALT30.MAC_MatchSamplePatterns(BIPV2_Best_Proxid.Keys(BIPV2_Best_Proxid.In_Base).MatchSample,MatchPatterns,Proxid1,Proxid2,8,38-44);
...
ConfThreshold:=41;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_Best_Proxid.Keys(BIPV2_Best_Proxid.In_Base).MatchSample,BIPV2_Best_Proxid.Keys(BIPV2_Best_Proxid.In_Base).Candidates,BIPV2_Best_Proxid.In_Base,Proxid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
