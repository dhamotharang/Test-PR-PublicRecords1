...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::BIPV2_Best_Proxid::Proxid::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::History::Match';
  MH := MatchHistoryFile;
...
EXPORT InDataKeyName := '~'+'key::BIPV2_Best_Proxid::Proxid::Datafile::in_data';
