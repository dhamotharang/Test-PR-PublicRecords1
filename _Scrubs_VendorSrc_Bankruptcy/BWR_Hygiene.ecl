...
#workunit('name','_Scrubs_VendorSrc_Bankruptcy.BWR_Hygiene - Hygiene & Stats - SALT V3.11.6');
IMPORT _Scrubs_VendorSrc_Bankruptcy,SALT311;
// First create an instantiated hygiene module
  infile := _Scrubs_VendorSrc_Bankruptcy.In_Bankruptcy;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := _Scrubs_VendorSrc_Bankruptcy.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_Bankruptcy'),NAMED('OptimizedLayout'));// File layout suggested by data
