...
export File_Preferred := dedup(sort(preferred_name_clean(clean_name <> preferred_name and preferred_name <> ''), 
                       clean_name, preferred_name),clean_name, preferred_name) : persist('~thor_data400::persist::BIPV2::biz_preferred');
											 //(clean_name = 'BANK OF NEW YORK' and preferred_name = 'BNY MELLON');
