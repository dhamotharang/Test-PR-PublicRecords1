...
EXPORT ProcessDailyFileHybridHistory(dataset(layout_Neustar) daily, dataset(layout_history) history_base, string updatedate='') := FUNCTION
		...
		h1 := ApplyDelsToHybridHistory(dels, history_base);
