...
dHistory := distribute(File_History(phone10 <> '' and regexfind('[1-9]', phone10[1..3]) and length(trim(phone10, left,right)) = 10), hash(phone10));
...
samples := sort(File_Master(phone10 in Set_phone10), phone10);
