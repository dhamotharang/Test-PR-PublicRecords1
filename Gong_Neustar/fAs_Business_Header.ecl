IMPORT ut, Business_Header,mdr, gong_neustar;

export fAs_Business_Header(

	dataset(Gong_Neustar.Layout_History) pMasterFile = Gong_Neustar.File_GongHistory
...
function
	...
	Layout_Gong_Temp  Translate_Gong_to_BHF(Gong_Neustar.Layout_History L) :=
	TRANSFORM
