...
hist_in := File_History_Full_Prepped_for_Keys(trim(prim_name)<>'', trim(z5)<>'');	//,deletion_date<>'' OR current_record_flag='Y');
...
//	(pid)							'~thor_data400::key::gong_history::20121003::address');
		    Data_Services.Data_location.Prefix('Gong_History') +'thor_data400::key::gong_history_address_' + doxie.Version_SuperKey);
