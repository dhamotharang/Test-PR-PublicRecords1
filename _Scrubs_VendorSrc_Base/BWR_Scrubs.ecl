...
#workunit('name','_Scrubs_VendorSrc_Base.BWR_Scrubs - Checking field validity in a file - SALT V3.11.6');
IMPORT _Scrubs_VendorSrc_Base,SALT311;
infile := _Scrubs_VendorSrc_Base.In_Base;
mod_scrubs := _Scrubs_VendorSrc_Base.Scrubs;
