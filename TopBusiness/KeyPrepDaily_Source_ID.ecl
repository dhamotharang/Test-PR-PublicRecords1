...
export KeyPrepDaily_Source_ID(
  ...
  // foreclosurenod_items := project(Property_Master_Foreclosure(source_docid != ''),
	...
	tools.mac_FilesIndex('deduped_items,{bid,item_type,item_hash,source},{deduped_items}',keynamesdaily(version,pUseOtherEnvironment).Source,idx);
