...
export KeyPrep_Bankruptcy_ID(
	...
	tools.mac_FilesIndex('deduped,{bid,party_type,date_filed_9999},{deduped}',keynames(version,pUseOtherEnvironment).Bankruptcy.Main,idx);
