export Constants := module
	...
	export MatchCodes := module
		...
		export unsigned4 REZADDR_CLOSENAME     := 1 <<  5; //        32
		...
		export unsigned4 BID_ZIP_NAME          := 1 << 19; //    524288
	...
	export SelectLienCreditorNames := dedup(dataset([
		{'IRS'},
		{'STATE OF CALIFORNIA'},
		...
		{'NYSHES'},
		{'SEARS ROEBUCK AND CO'}],{string120 clean_company_name}),record,all);
   ...
   export string1 PRIOR      := 'P';
	 ...
	 // shared layout_positionTitle := record
	    // string position;
			// string normalizedTitle; 
			// string normalizedTitle2;			
			// string normalizedTitle3;
	 // end;
	 // EXPORT normalized_set := dataset([
...
// {'ACCOUNTING MANAGER','EXECUTIVE - FINANCE','',''},
// {'ACTOR','CONTACT','',''},
// {'ADMINISTRA','ADMINISTRATOR','',''},
// {'ADMINISTRATION','ADMINISTRATOR','',''},
// {'ADMINISTRATION EXECUTIVE','ADMINISTRATOR','',''},
// {'ADVISOR','CONTACT','',''},
// {'STATUTORY AGENT','AGENT','',''},
// {'AMBASSADOR','CONTACT','',''},
// {'ANALYST','ANALYST','',''},
// {'ANESTHESIOLOGIST','PHYSICIAN','',''},
// {'ARCHITECT','CONTACT','',''},
// {'ART DIRECTOR','CONTACT','',''},
// {'ARTIST','CONTACT','',''},
...
// {'ASST SEC','ASSISTANT SECRETARY','CONTACT',''},
// {'ASSISTANT SEC','CONTACT','',''},
// {'ASSISTANT VICE PRESIDENT','CONTACT','',''},
// {'ASSOCIATE','ASSOCIATE','',''},
// {'ASSOCIATE BROKER','CONTACT','',''},
...
// {'COUNSEL','ATTORNEY','',''},
// {'LAWYER','ATTORNEY','',''},
// {'MEMBER OF VIRGINIA STATE BAR, RESID','ATTORNEY','',''},
// {'OF COUNSEL','ATTORNEY','',''},
// {'AUTHORIZED REPRESENTATIVE','AUTHORIZED REPRESENTATIVE','AUTHORIZED REPRESENTATIVE',''},
// {'AGENT','AUTHORIZED REPRESENTATIVE','',''},
// {'AUTH REP','AUTHORIZED REPRESENTATIVE','',''},
// {'AUTHORIZED REPRESENTATIVE','AUTHORIZED REPRESENTATIVE','',''},
// {'BAND MEMBER','CONTACT','',''},
// {'ADVISORY BOARD MEMBER','BOARD MEMBER','',''},
// {'BOARD MEMBER','BOARD MEMBER','',''},
// {'BOARD OF ADVISORS MEMBER','BOARD MEMBER','',''},
// {'BOARD OF DIRECTORS','BOARD MEMBER','',''},
// {'BOARD OF GOVERNORS MEMBER','BOARD MEMBER','',''},
// {'BOARD OF TRUSTEES MEMBER','BOARD MEMBER','',''},
// {'EXECUTIVE BOARD MEMBER','BOARD MEMBER','',''},
// {'MEMBER OF ADVISORY BOARD','BOARD MEMBER','',''},
// {'MEMBER OF BOARD OF GOVERNORS','BOARD MEMBER','',''},
// {'MEMBER OF BOARD OF TRUSTEES','BOARD MEMBER','',''},
// {'MEMBER OF EXECUTIVE BOARD','BOARD MEMBER','',''},
// {'MEMBER OF VSB','BOARD MEMBER','',''},
// {'MEMBER', 'BOARD OF DIRECTORS','BOARD MEMBER',''},
// {'BOOKKEEPER','BOOKKEEPER','',''},
// {'BRANCH MANAGER','BRANCH MANAGER','BRANCH MANAGER',''},
// {'BRANCH MAN','BRANCH MANAGER','',''},
// {'BRANCH MANAGER','BRANCH MANAGER','',''},
// {'BRANCH MGR','BRANCH MANAGER','',''},
// {'BRAND MGR','CONTACT','',''},
// {'BROKER','CONTACT','',''},
// {'BROKER ASSOCIATE','CONTACT','',''},
// {'BUSINESS MANAGER','MANAGER','',''},
// {'CAPTAIN','CAPTAIN','',''},
// {'CARDIOLOGIST','PHYSICIAN','',''},
// {'CARPENTER','CONTACT','',''},
// {'OWNER/CHIEF PHARMICIST','OWNER/CHIEF PHARMICIST','CHAIR',''},
// {'CHAIR','CHAIR','CHAIR',''},
// {'CHAIRMAN','CHAIRMAN','CHAIR',''},
// {'CHAIRMAN O','CHAIRMAN O','CHAIR,CHIEF EXECUTIVE OFFICER',''},
// {'CHAIR','CHAIR','',''},
// {'CHAIRMAN','CHAIR','',''},
// {'CHAIRMAN AND CHIEF EXECUTIVE OFFICE','CHAIR,CHIEF EXECUTIVE OFFICER','',''},
// {'CHAIRMAN O','CHAIR','',''},
// {'CHAIRMAN OR CHIEF EXECUTIVE OFFICER','CHAIR,CHIEF EXECUTIVE OFFICER','',''},
// {'CHAIRPERSON','CHAIR','',''},
// {'CO-CHAIR','CHAIR','',''},
// {'VICE CHAIR','CHAIR','',''},
// {'VICE CHAIRMAN','CHAIR','',''},
...
// {'CHEF','CHEF','',''},
// {'EXECUTIVE CHEF','CHEF','',''},
// {'CHIEF ACCOUNTANT','CHIEF ACCOUNTANT','CHIEF FINANCIAL OFFICER',''},
// {'CHIEF CUSTOMER OFFICER','CHIEF CUSTOMER OFFICER','CHIEF CUSTOMER OFFICER',''},
// {'CHIEF EDITOR','EDITOR IN CHIEF','',''},
// {'CHAIRMAN OR CHIEF EXECUTIVE OFFICER','CHIEF EXECUTIVE OFFICER','CHAIR',''},
// {'CHIEF EXECUTIVE O','CHIEF EXECUTIVE OFFICER','',''},
...
// {'CEO;SECRETARY;CFO','CHIEF EXECUTIVE OFFICER','SECRETARY','CHIEF FINANCIAL OFFICER'},
// {'CHIEF EXEC','CHIEF EXECUTIVE OFFICER','',''},
// {'CHIEF EXECUTIVE OFFICER','CHIEF EXECUTIVE OFFICER','',''},
// {'PRES & CEO','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'PRES,CEO','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'PRES-CEO','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'PRESIDENT/CEO','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'PRESIDENT-CHIEF EXECUTIVE OFFI','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'PRESIDENT-CHIEF EXECUTIVE OFFICER','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'CEO','CHIEF EXECUTIVE OFFICER','',''},
// {'CEO;SECRETARY;CFO','CHIEF EXECUTIVE OFFICER','SECRETARY','CHIEF FINANCIAL OFFICER,SECRETARY'},
// {'CHIEF EXEC','CHIEF EXECUTIVE OFFICER','',''},
// {'CHIEF EXECUTIVE OFFICER','CHIEF EXECUTIVE OFFICER','',''},
// {'CHM & CEO','CHIEF EXECUTIVE OFFICER','',''},
// {'CHM, PRES & CEO','CHIEF EXECUTIVE OFFICER','PRESIDENT',''},
// {'CHIEF FINANCIAL O','CHIEF FINANCIAL O','CHIEF FINANCIAL OFFICER',''},
// {'CFO','CHIEF FINANCIAL OFFICER','',''},
// {'CF0','CHIEF FINANCIAL OFFICER','',''}, // added to compensate for CF0 (the number 0) instead of O
// {'CFO & EXEC VP','CHIEF FINANCIAL OFFICER','EXECUTIVE VICE PRESIDENT',''},
// {'CFO, TREAS & SR VP','CHIEF FINANCIAL OFFICER','TREASURER','SR VICE PRESIDENT'},
// {'CFO-SUBSIDIARIES','CFO-SUBSIDIARIES','CHIEF FINANCIAL OFFICER',''},
// {'CHIEF FINANCIAL OFFICER','CHIEF FINANCIAL OFFICER','',''},
// {'CFO','CHIEF FINANCIAL OFFICER','',''},
// {'CFO & SR VP','CHIEF FINANCIAL OFFICER','SR VICE PRESIDENT',''},
// {'CHIEF FINANCIAL OFFICER','CHIEF FINANCIAL OFFICER','',''},
// {'CHIEF INFO','CIO','CHIEF INFORMATION OFFICER',''},
// {'CHIEF INFORMATION OFFICER','CIO','CHIEF INFORMATION OFFICER',''},
// {'CIO','CHIEF INFORMATION OFFICER','',''},
// {'CTO','CHIEF INFORMATION OFFICER','',''},
// {'PROGRAM MANAGER CIO','CHIEF INFORMATION OFFICER','PROGRAM MANAGER',''},
// {'CHIEF INFORMATION OFFICER','CHIEF INFORMATION OFFICER','',''},
// {'CIO','CHIEF INFORMATION OFFICER','',''},
// {'CHIEF OF POLICE','POLICE CHIEF','',''},
// {'HUMAN RESOURCES, CHIEF OFFICER','CHIEF OFFICER - HUMAN RESOURCES','',''},
// {'MARKETING, CHIEF OFFICER','CHIEF OFFICER - MARKETING','',''},
// {'MARKETING CHIEF/VICE PRESIDENT','CHIEF OFFICER - MARKETING','VICE PRESIDENT',''},
// {'SALES, CHIEF OFFICER','CHIEF OFFICER - SALES','',''},
// {'CHIEF OPERATING OFFICER','CHIEF OPERATING OFFICER','',''},
// {'COO','CHIEF OPERATING OFFICER','',''},
// {'CHIEF OPERATING OFFICER','CHIEF OPERATING OFFICER','',''},
// {'CHIEF PHAR','CHIEF PHARMACIST','',''},
// {'CHIEF PHARMICIST','CHIEF PHARMICIST','',''},
// {'CHIEF TECHNOLGY OFFICER','CTO','CHIEF TECHNOLOGY OFFICER',''},
// {'CTO TECH','CHIEF TECHNOLOGY OFFICER','',''},
...
// {'FILER','CONTACT','',''},
// {'MISC OTHER','CONTACT','',''},
// {'NO TITLE SPECIFIED','CONTACT','',''},
// {'OFFICE ASSISTANT','CONTACT','',''},
// {'OTHER','CONTACT','',''},
// {'PRINCIPAL EXECUTIVE OFFICE CONTACT','CONTACT','',''},
// {'PROCESS ADDRESS CONTACT','CONTACT','',''},
// {'RECEPTIONIST','CONTACT','',''},
// {'RECEPTIONIST SECRETARY','CONTACT','',''},
// {'RECEPTIONIST SECRETARY','CONTACT','',''},
// {'RECEPTIONIST/SECRETARY','CONTACT','',''},
// {'REGISTRANT','CONTACT','',''},
// {'REGISTRAR','CONTACT','',''},
...
// {'APPLICANT','CONTACT','',''},
// {'APPRAISAL SUBCOMMITTEE APPR','CONTACT','',''},
// {'ARP SIGNATURE','CONTACT','',''},
// {'CASHIER','CONTACT','',''},
// {'CHIEF','CONTACT','',''},
// {'CONTRIBUTOR','CONTACT','',''},
// {'COOK','CONTACT','',''},
...
// {'E-BUSINESS','CONTACT','',''},
// {'HEAD','CONTACT','',''},
// {'HONORARY MEMBER','CONTACT','',''},
// {'HOST','CONTACT','',''},
// {'LIFE MEMBER','CONTACT','',''},
// {'MEDICINE','CONTACT','',''},
// {'MINIMUM DATA SET COORDINATOR','CONTACT','',''},
// {'OPERATIONS','CONTACT','',''},
// {'PRODUCER','CONTACT','',''},
// {'PRODUCTION','CONTACT','',''},
...
// {'SENIOR CONSULTANT','CONTACT','',''},
// {'SENIOR LEVEL OFFICER','CONTACT','',''},
// {'SOC SIGNATORY','CONTACT','',''},
// {'SPECIALIST','CONTACT','',''},
// {'TAX RESPONSIBLE PARTY','CONTACT','',''},
// {'TECH','CONTACT','',''},
// {'TECHNICIAN','CONTACT','',''},
// {'TELLER','CONTACT','',''},
// {'TRADE NAME OWNER','CONTACT','',''},
// {'TRADE NAME OWNER FILED PRIOR TO 7/1','CONTACT','',''},
// {'TRAINER','CONTACT','',''},
// {'VEHICLE BOARD','CONTACT','',''},
// {'VEHICLE MANUFACTURERS DEALERS AND S','CONTACT','',''},
// {'VICE','CONTACT','',''},
// {'WAITRESS','CONTACT','',''},
// {'WELCOME NEW MEMBER','CONTACT','',''},
// {'WELDER','CONTACT','',''},
...
// {'COUNSELOR','CONTACT','',''},
// {'CREATIVE DIRECTOR','CONTACT','',''},
// {'CURATOR','CONTACT','',''},
// {'CUSTODIAN','CONTACT','',''},
// {'CUSTOMER SERVICE REPRESENTATIVE','CUSTOMER SERVICE REPRESENTATIVE','',''},
// {'POSITION IN CUSTOMER SERVICE','CUSTOMER SERVICE REPRESENTATIVE','',''},
// {'DEAN','CONTACT','',''},
// {'DELEGATE','CONTACT','',''},
...
// {'DIR ELECTRONIC PUB','DIRECTOR','',''},
// {'DIR HUMAN RESOURCES','DIRECTOR','',''},
// {'DIR. OF ACCOUNTING/AUDITING','DIRECTOR','',''},
// {'DIRECTOR','DIRECTOR','',''},
// {'DIRECTOR CARE TECHNOLOGY','DIRECTOR','',''},
// {'DIRECTOR ELECTRONIC PUB','DIRECTOR','',''},
// {'DIRECTOR ELECTRONIC PUBLISHING','DIRECTOR','',''},
// {'DIRECTOR OF ACCTNG./AUDITING','DIRECTOR','',''},
// {'DIRECTOR OF ADVERTISING','DIRECTOR','',''},
// {'DIRECTOR OF HUMAN RESOURCES','DIRECTOR','',''},
// {'DIRECTOR OF MARKETING','DIRECTOR','',''},
// {'DIRECTOR OF SCORING','DIRECTOR','',''},
// {'DIRECTOR;PRESIDENT','DIRECTOR','',''},
// {'DIRECTOR;VICE PRESIDENT','DIRECTOR','',''},
// {'DIR-VILLAGE DEVELOPMENT','DIRECTOR','',''},
// {'FINANCE DIRECTOR','DIRECTOR','',''},
// {'HUMAN RESOURCE DIRECTOR','DIRECTOR','',''},
// {'HUMAN RESOURCES DIRECTOR','DIRECTOR','',''},
// {'INFORMATION TECHNOLOGY DIR','INFORMATION TECHNOLOGY DIRECTOR','DIRECTOR',''},
// {'INFORMATION TECHNOLOGY DIRECTOR','INFORMATION TECHNOLOGY DIRECTOR','DIRECTOR',''},
// {'IT DIRECTOR','DIRECTOR','',''},
// {'MKTG DIR','DIRECTOR','',''},
// {'SAFETY DIRECTOR','DIRECTOR','',''},
// {'SFTY DIR','DIRECTOR','',''},
// {'ADVERTISING/PR DIRECTOR/MANAGE','DIRECTOR','',''},
// {'DEPUTY DIRECTOR','DIRECTOR','',''},
// {'DEVELOPMENT DIRECTOR','DIRECTOR','',''},
// {'DIR','DIRECTOR','',''},
// {'DIRECTOR','DIRECTOR','',''},
// {'DIRECTOR (PUBLIC CO)','DIRECTOR','',''},
// {'DIRECTOR ELECTRONIC COMMERCE','DIRECTOR','',''},
...
// {'DIRECTOR OF DATA PROCESSING','DIRECTOR','',''},
// {'DIRECTOR OF DEVELOPMENT','DIRECTOR','',''},
// {'DIRECTOR OF ENGINEERING','DIRECTOR','',''},
// {'DIRECTOR OF FINANCE','DIRECTOR','',''},
// {'DIRECTOR OF FOOD SERVICES','DIRECTOR','',''},
// {'DIRECTOR OF HOUSEKEEPING','DIRECTOR','',''},
// {'DIRECTOR OF HUMAN RESOURCES','DIRECTOR','',''},
// {'DIRECTOR OF HUMAN RESOURCES','DIRECTOR','',''},
// {'DIRECTOR OF MARKETING','DIRECTOR','',''},
// {'DIRECTOR OF MARKETING','DIRECTOR','',''},
// {'DIRECTOR OF MEDICAL RECORDS','DIRECTOR','',''},
// {'DIRECTOR OF NURSING SERVICES','DIRECTOR','',''},
// {'DIRECTOR OF OPERATIONS','DIRECTOR','',''},
// {'DIRECTOR OF PHYSICAL THERAPY','DIRECTOR','',''},
// {'DIRECTOR OF PURCHASING','DIRECTOR','',''},
// {'DIRECTOR OF SALES','DIRECTOR','',''},
// {'DIRECTOR OF SOCIAL SERVICES','DIRECTOR','',''},
// {'DIRECTOR ONLY','DIRECTOR','',''},
// {'DIRECTOR, MANUFACTURING/OPERAT','DIRECTOR','',''},
// {'DIRECTOR,PRESIDENT','DIRECTOR','',''},
...
// {'EXECUTIVE OFFICER','EXECUTIVE OFFICER','EXECUTIVE',''},
// {'TELECOMMUNICATION EXECUTIVE','TELECOMMUNICATION EXECUTIVE','EXECUTIVE',''},
// {'DIVISION/SUBSIDIARY HEAD','DIVISION/SUBSIDIARY HEAD','EXECUTIVE',''},
// {'MANUFACTURING/OPERATIONS HEAD','MANUFACTURING/OPERATIONS HEAD','EXECUTIVE',''},
// {'CORPORATE COMMUNICATIONS EXECUTIVE','EXECUTIVE','',''},
// {'DATA PROCESSING EXECUTIVE','EXECUTIVE','',''},
// {'EXECUTIVE','EXECUTIVE','',''},
...
// {'TELECOMMUNICATION EXECUTIVE','EXECUTIVE','',''},
// {'FINANCE EXECUTIVE','EXECUTIVE - FINANCE','',''},
// {'FINANCE DIRECTOR','EXECUTIVE - FINANCE','',''},
// {'FINANCE EXECUTIVE','EXECUTIVE - FINANCE','',''},
// {'FINANCE MANAGER','EXECUTIVE - FINANCE','',''},
// {'FINANCE MANAGER/DIRECTOR','EXECUTIVE - FINANCE','',''},
// {'HUMAN RESOURCES EXECUTIVE','EXECUTIVE - HUMAN RESOURCE','',''},
// {'HUMAN RESOURCE EXECUTIVE','HUMAN RESOURCES EXECUTIVE','EXECUTIVE - HUMAN RESOURCES',''},
// {'HUMAN RESOURCES EXECUTIVE','HUMAN RESOURCES EXECUTIVE','EXECUTIVE - HUMAN RESOURCES',''},
// {'MARKETING EXECUTIVE','MARKETING EXECUTIVE','EXECUTIVE -MARKETING',''},
// {'EXEC V PRES','EXECUTIVE VICE PRESIDENT','EXECUTIVE VICE PRESIDENT',''},
// {'EXEC VP','EXECUTIVE VICE PRESIDENT','EXECUTIVE VICE PRESIDENT',''},
// {'EVP,COO','EVP,COO','EXECUTIVE VICE PRESIDENT,CHIEF OPERATIONAL OFFICER',''},
// {'EVP','EXECUTIVE VICE PRESIDENT','EXECUTIVE VICE PRESIDENT',''},
// {'EVP,SEC','EXECUTIVE VICE PRESIDENT','SECRETARY',''},
// {'EX VICE PRESIDENT','EXECUTIVE VICE PRESIDENT','',''},
// {'EXECUTIVE VICE PRESIDENT','EXECUTIVE VICE PRESIDENT','',''},
// {'EXEC V PRES','EXECUTIVE VICE PRESIDENT','',''},
// {'EXEC VP','EXECUTIVE VICE PRESIDENT','',''},
// {'EXECUTIVE VICE PRESIDENT AND CHIEF','EXECUTIVE VICE PRESIDENT','',''},
// {'EX VICE PRES SALES','EXECUTIVE VICE PRESIDENT - SALES','',''},
// {'EX VP-WW SALES/SVS-CBO','EXECUTIVE VICE PRESIDENT - SALES','',''},
// {'EXEC VP-SLS','EXECUTIVE VICE PRESIDENT - SALES','',''},
// {'FIRE CHIEF','FIRE CHIEF','',''},
// {'FIREFIGHTER','CONTACT','',''},
// {'CO-FOUNDER','FOUNDER','',''},
// {'FOUNDER','FOUNDER','',''},
// {'FOUNDER AND CHIEF EXECUTIVE OFFICER','FOUNDER','CHIEF EXECUTIVE OFFICER',''},
// {'FOUNDER AND PRESIDENT','FOUNDER','PRESIDENT',''},
// {'GENERAL COUNSEL','GENERAL COUNSEL','',''},
// {'GEN MGR','GENERAL MANAGER','',''},
// {'GENERAL MANAGER','GENERAL MANAGER','',''},
// {'GM','GENERAL MANAGER','',''},
// {'GEN MGR','GENERAL MANAGER','',''},
// {'GENERAL MA','GENERAL MANAGER','',''},
// {'GM','GENERAL MANAGER','',''},
// {'GOVERNOR','GOVERNOR','',''},
// {'CHB','PHYSICIAN','Human honorary title: ChB - bachelor of surgery',''},
// {'CHM','PHYSICIAN','Human honorary title: ChM - masters of surgery',''},
...
// {'HUMAN RESOURCE MANAGER','HUMAN RESOURCE MANAGER','',''},
// {'HUMAN RESOURCES DIRECTOR','HUMAN RESOURCE MANAGER','',''},
// {'HR MANAGER','HUMAN RESOURCE MANAGER','',''},
// {'INCORPORATOR','INCORPORATOR','',''},
// {'INCORPORATOR/ORGANIZER','INCORPORATOR','',''},
// {'INSTRUCTOR','INSTRUCTOR','',''},
// {'INSURANCE BROKERS','CONTACT','',''},
// {'DOMAIN ADMINISTRATIVE CONTACT','IT','',''},
// {'DOMAIN TECHNICAL CONTACT','IT','',''},
...
// {'BUSINESS OFFICE MANAGER','MANAGER','',''},
// {'GOVERNING PERSON','MANAGER','',''},
// {'INFORMATION TECHNOLOGY MANAGER','MANAGER','',''},
// {'IS/IT DIRECTOR/MANAGER','MANAGER','',''},
// {'IT MANAGER','MANAGER','',''},
// {'MANAGER/COORDINATOR','MANAGER','',''},
// {'MANAGER/GENERAL MANAGER/PROJEC','MANAGER','GENERAL MANAGER',''},
// {'MANAGER/MEMBER','MANAGER','MEMBER',''},
// {'MANAGER;MEMBER','MANAGER','MEMBER',''},
// {'MANAGING DIRECTOR','MANAGER','',''},
// {'MANAGING EDITOR','MANAGER','',''},
// {'MANAGING MEMBER','MANAGER,MANAGER','',''},
// {'MANAGING PARTNER','MANAGER,PARTNER','',''},
// {'MGR','MANAGER','',''},
// {'MGR-MKTG','MANAGER','',''},
// {'MIS MANAGE','MANAGER','',''},
// {'MIS MANAGER','MANAGER','',''},
...
// {'TECHNOLOGY COORDINATOR','MANAGER','',''},
// {'TECHNOLOGY MANAGER','MANAGER','',''},
// {'TRAINING SUPERVISOR','MANAGER','',''},
// {'SERVICE MANAGER','MANAGER','',''},
// {'OPERATOR','MANAGER','',''},
// {'ORGANIZER','MANAGER','',''},
// {'MARKETING COORDINATOR','EXECUTIVE -MARKETING','',''},
// {'MARKETING MANAGER','EXECUTIVE -MARKETING','',''},
// {'MARKETING/PRODUCT MANAGER','EXECUTIVE -MARKETING','PRODUCT MANAGER',''},
// {'MAYOR','MAYOR','',''},
...
// {'MEMBER, TEAM','MEMBER','',''},
// {'MEMBER/MANAGER','MEMBER','MANAGER',''},
// {'MEMBER/MANAGER OF LLC','MEMBER','MANAGER',''},
// {'MEMBER;MANAGER','MEMBER','MANAGER',''},
// {'MEMBERS','MEMBER','',''},
// {'MNG MBR','MEMBER','MANAGER',''},
// {'LIMITED LIABILITY COMPANY INDIVIDUA','MEMBER','',''},
// {'LTD LIAB COMPANY INDIVIDUAL MANAGER','MEMBER','',''},
...
// {'OFFICER','OFFICER','',''},
// {'OFFICER ACL','OFFICER','',''},
// {'OFFICER C/P/D','OFFICER','',''},
// {'OFFICER D','OFFICER','DIRECTOR',''},
// {'OFFICER EV','OFFICER','EXECUTIVE VICE PRESIDENT',''},
// {'OFFICER P/D','OFFICER','OFFICER',''},
// {'OFFICER S/GC','OFFICER','OFFICER',''},
// {'OFFICER SRV','OFFICER','',''},
// {'OFFICER V','OFFICER','',''},
// {'OFFICER V/AS','OFFICER','',''},
// {'OFFICER V/S','OFFICER','',''},
// {'OFFICER V/S/GC','OFFICER','',''},
// {'OFFICER','OFFICER','',''},
// {'CO-OWNER','OWNER','',''},
// {'INDIVIDUAL - SOLE OWNER','OWNER','',''},
// {'OWNER','OWNER','',''},
// {'OWNER/CHIEF PHARMACIST','OWNER','CHIEF PHARMICIST',''},
// {'UNINCORPORATED ACCOUNT OWNER','OWNER','',''},
...
// {'CERTIFIED PHARMACY TCHNCN','PHARMACY TECHNICIAN','',''},
...
// {'OBSTETRIC GYNECOLOGIST','PHYSICIAN','',''},
...
// {'PLANT MANA','PLANT MANAGER','',''},
// {'PLANT MANAGER','PLANT MANAGER','',''},
// {'PLT MGR','PLANT MANAGER','',''},
// {'SITE MANAG','PLANT MANAGER','',''},
// {'POLICE CHIEF','POLICE CHIEF','',''},
// {'PRES','PRESIDENT','',''},
// {'PRES/TREAS','PRESIDENT','TREASURER',''},
// {'PRES-GLOBAL FAMILY CARE','PRESIDENT','',''},
// {'PRES-GLOBAL SKIN CARE','PRESIDENT','',''},
// {'PRES-GLOBAL SNACKS','PRESIDENT','',''},
// {'PRES-GLOBAL STRATEGY','PRESIDENT','',''},
// {'PRES-GLOBAL WAL-MART TEAM','PRESIDENT','',''},
// {'PRESI','PRESIDENT','',''},
// {'PRESIDENT','PRESIDENT','',''},
// {'PRES-NEW BUS DEVEL, DEODORANTS/MALE','PRESIDENT','',''},
// {'PRES-SEC','PRESIDENT','SECRETARY',''},
// {'PRES-TREAS','PRESIDENT','TREASURER',''},
// {'PRES','PRESIDENT','',''},
// {'PRES & CEO','PRESIDENT','CHIEF OPERATING OFFICER',''},
// {'PRES-CEO','PRESIDENT','CHIEF OPERATING OFFICER',''},
// {'PRESIDENT AND CHIEF EXECUTIVE OFFIC','PRESIDENT','CHIEF EXECUTIVE OFFICER',''},
// {'PRESIDENT AND CHIEF OPERATING OFFIC','PRESIDENT','CHIEF OPERATING OFFICER',''},
...
// {'REAL ESTATE SALES PEOPLE & BROKERS','REAL ESTATE AGENT','',''},
// {'REAL PROPERTY','REAL ESTATE AGENT','',''},
// {'REALTOR','REAL ESTATE AGENT','',''},
// {'REAL ESTATE BROKERS','REAL ESTATE BROKER','',''},
// {'REAL ESTATE COMPANIES, BROKERS & SA','REAL ESTATE BROKER','',''},
// {'REAL ESTATE COMMISSION','REAL ESTATE BROKER','',''},
// {'BISHOP','RELIGIOUS LEADER','',''},
// {'MINISTER','RELIGIOUS LEADER','',''},
// {'PASTOR','RELIGIOUS LEADER','',''},
// {'RELIGIOUS LEADER','RELIGIOUS LEADER','',''},
// {'SENIOR PASTOR','RELIGIOUS LEADER','',''},
// {'REPORTER','REPORTER','',''},
...
// {'SECRETARY TREASURER','SECRETARY','TREASURER',''},
// {'SECRETARY/TREASURER','SECRETARY','TREASURER',''},
// {'SECRETARY;CFO','SECRETARY','CHIEF FINANCIAL OFFICER',''},
// {'SECRETARY-TREASURER','SECRETARY','TREASURER',''},
// {'SEC-TREAS','SECRETARY','TREASURER',''},
// {'SELF','SELF EMPLOYED','',''},
// {'SERGEANT','SERGEANT','',''},
...
// {'SENIOR VICE PRESIDENT-WOOD FLOOR','SR VICE PRESIDENT','',''},
// {'SENIOR VP','SR VICE PRESIDENT','SR VICE PRESIDENT',''},
// {'SR V P','SR VICE PRESIDENT','SR VICE PRESIDENT',''},
// {'SR V.P.','SR VICE PRESIDENT','SR VICE PRESIDENT',''},
// {'SR VP','SR VICE PRESIDENT','SR VICE PRESIDENT',''},
// {'SR. VICE PRESIDENT','SR VICE PRESIDENT','',''},
// {'SVP','SR VICE PRESIDENT','SR VICE PRESIDENT',''},
// {'SENIOR VICE PRESIDENT','SR VICE PRESIDENT','',''},
// {'SR VP','SR VICE PRESIDENT','',''},
// {'SENIOR VICE PRESIDENT HUMAN RESO','SR VICE PRESIDENT - HUMAN RESOURCES','',''},
// {'SR V PRES, HUMAN RESOURCES','SR VICE PRESIDENT, HUMAN RESOURCES','',''},
// {'SR VICE PRES CORP HUMAN RESOUR','SR VICE PRESIDENT, HUMAN RESOURCES','SR VICE PRESIDENT - HUMAN RESOURCES',''},
// {'SR VICE PRESIDENT-HUMAN RESOURCES','SR VICE PRESIDENT, HUMAN RESOURCES','SR VICE PRESIDENT - HUMAN RESOURCES',''},
// {'SR VP-CORPORATE HUMAN RESOURCES','SR VICE PRESIDENT, HUMAN RESOURCES','',''},
// {'SR VP-HR','SR VICE PRESIDENT, HUMAN RESOURCES','',''},
// {'SR. VP, HUMAN RESOURCES','SR VICE PRESIDENT, HUMAN RESOURCES','SR VICE PRESIDENT - HUMAN RESOURCES',''},
// {'STUDENT','STUDENT','',''},
// {'STUDENTS','STUDENT','',''},
// {'GRADUATE STUDENT','STUDENT','',''},
// {'SUPERINTENDENT','SUPERINTENDENT','',''},
// {'TEACHER','TEACHER','',''},
// {'TREAS,EVP,CFO','TREASURER','EXECUTIVE VICE PRESIDENT','CHIEF FINANCIAL OFFICER'},
...
// {'TREASURER','TREASURER','',''},
// {'TRUSTEE','TRUSTEE','',''},
// {'VICE CHM & CFO','VICE CHAIR','CHIEF FINANCIAL OFFICER',''},
// {'VICE CHAIRMAN','VICE CHAIR','',''},
// {'VICE PRES','VICE PRESIDENT','',''},
// {'VICE PRESI','VICE PRESIDENT','',''},
// {'VICE PRESIDENT','VICE PRESIDENT','',''},
// {'VICE PRESIDENT & CONTROLLER','VICE PRESIDENT','CONTROLLER',''},
// {'VICE PRESIDENT, NORTH AMERICAN','VICE PRESIDENT','',''},
// {'VICE PRESIDENT-EDUCATION STRATEG','VICE PRESIDENT','',''},
// {'VICEPRES','VICE PRESIDENT','',''},
// {'VICE-PRESIDENT','VICE PRESIDENT','',''},
// {'VICEPRESIDENT','VICE PRESIDENT','',''},
// {'VP','VICE PRESIDENT','',''},
// {'VP & GEN MGR-HOME CARE & GLOBAL STR','VICE PRESIDENT','GENERAL MANAGER',''},
// {'VP ADMINIS','VICE PRESIDENT','',''},
// {'VP BUSINESS DEVELOPMENT','VICE PRESIDENT','',''},
// {'VP EDITORIAL SERVICES','VICE PRESIDENT','',''},
// {'VP MANUFACTURING','VICE PRESIDENT','',''},
// {'VP OF BUSINESS DVLPMNT','VICE PRESIDENT','',''},
// {'VP OF BUSINESS DVLPMNT CO','VICE PRESIDENT','',''},
// {'VP OF TECHNICAL SUPPORT','VICE PRESIDENT','',''},
// {'VP TECHNICAL SUPPORT','VICE PRESIDENT','',''},
// {'VP WOOD FLOORING','VICE PRESIDENT','',''},
// {'VP/FINANCE','VICE PRESIDENT','',''},
// {'VP-DESIGN INNOVATION & STRATEGY','VICE PRESIDENT','',''},
// {'VP-EDITORIAL SERVICES','VICE PRESIDENT','',''},
// {'VP-GLOBAL CONSUMER & MARKET KNOWLED','VICE PRESIDENT','',''},
// {'VP-PUR','VICE PRESIDENT','',''},
// {'REGIONAL VICE PRES','VICE PRESIDENT','',''},
// {'REGIONAL VICE PRESIDENT','VICE PRESIDENT','',''},
// {'REGIONAL VP','VICE PRESIDENT','',''},
// {'V.P. MARKETING','VICE PRESIDENT','',''},
// {'VICE PRES MARKETING','VICE PRESIDENT','',''},
// {'VP MARKETING','VICE PRESIDENT','',''},
// {'VP-MKTG','VICE PRESIDENT','',''},
// {'VICE PRESIDENT SLS MRKTNG','VICE PRESIDENT','',''},
// {'FIRST VICE PRESIDENT','VICE PRESIDENT','',''},
// {'SECOND VICE PRESIDENT','VICE PRESIDENT','',''},
// {'V PRES','VICE PRESIDENT','',''},
// {'V PRES-SEC','VICE PRESIDENT','SECRETARY',''},
// {'V.P. MARKETING','VICE PRESIDENT','',''},
// {'VICE PRES','VICE PRESIDENT','',''},
// {'VICE PRESI','VICE PRESIDENT','',''},
// {'VICE PRESIDENT','VICE PRESIDENT','',''},
// {'VICE PRESIDENT AND GENERAL MANAGER','VICE PRESIDENT','GENERAL MANAGER',''},
// {'VICE PRESIDENT OF MARKETING','VICE PRESIDENT','',''},
// {'VICE PRESIDENT OF OPERATIONS','VICE PRESIDENT','',''},
// {'VICE PRESIDENT OF SALES','VICE PRESIDENT','',''},
// {'VICE PRESIDENT OF SALES AND MARKETI','VICE PRESIDENT','',''},
// {'VICEPRES','VICE PRESIDENT','',''},
// {'VICEPRESIDENT','VICE PRESIDENT','',''},
// {'VICE-PRESIDENT','VICE PRESIDENT','',''},
// {'VP','VICE PRESIDENT','',''},
// {'VP MARKETING','VICE PRESIDENT','',''},
// {'VP-HR','VICE PRESIDENT','',''},
// {'VP-MKTG','VICE PRESIDENT','',''},
// {'V P MANUFACTURING','VICE PRESIDENT','',''},
// {'V PRES','VICE PRESIDENT','',''},
// {'V PRES-MFG','VICE PRESIDENT','',''},
// {'V PRES-SEC','VICE PRESIDENT','SECRETARY',''},
// {'V PRES-TREAS','VICE PRESIDENT','TREASURER',''},
// {'VP,D','VICE PRESIDENT','',''},
// {'STAFF WRITER','WRITER','',''},
// {'WRITER','WRITER','',''}
// ],
// layout_positionTitle);
