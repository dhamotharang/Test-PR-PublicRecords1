...
EXPORT Summary(SALT30.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_event_revocation_comment1 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_revocation_comment1)));
    avelength_event_revocation_comment1 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_revocation_comment1)),h.event_revocation_comment1<>(typeof(h.event_revocation_comment1))'');
    ...
    maxlength_event_revocation_comment2 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_revocation_comment2)));
    avelength_event_revocation_comment2 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_revocation_comment2)),h.event_revocation_comment2<>(typeof(h.event_revocation_comment2))'');
    populated_event_book_number_pcnt := AVE(GROUP,IF(h.event_book_number = (TYPEOF(h.event_book_number))'',0,100));
    maxlength_event_book_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_book_number)));
    avelength_event_book_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_book_number)),h.event_book_number<>(typeof(h.event_book_number))'');
    populated_event_page_number_pcnt := AVE(GROUP,IF(h.event_page_number = (TYPEOF(h.event_page_number))'',0,100));
    maxlength_event_page_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_page_number)));
    avelength_event_page_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_page_number)),h.event_page_number<>(typeof(h.event_page_number))'');
    ...
    maxlength_event_certification_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_certification_number)));
    avelength_event_certification_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.event_certification_number)),h.event_certification_number<>(typeof(h.event_certification_number))'');
  END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 29);
  SELF.FldNo2 := 1 + (C % 29);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_supp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.event_filing_reference_nbr),TRIM((SALT30.StrType)le.event_amendment_nbr),TRIM((SALT30.StrType)le.event_filing_date),TRIM((SALT30.StrType)le.event_date_type_cd),TRIM((SALT30.StrType)le.event_date_type_desc),TRIM((SALT30.StrType)le.event_filing_cd),TRIM((SALT30.StrType)le.event_filing_desc),TRIM((SALT30.StrType)le.event_corp_nbr),TRIM((SALT30.StrType)le.event_corp_nbr_cd),TRIM((SALT30.StrType)le.event_corp_nbr_desc),TRIM((SALT30.StrType)le.event_roll),TRIM((SALT30.StrType)le.event_frame),TRIM((SALT30.StrType)le.event_start),TRIM((SALT30.StrType)le.event_end),TRIM((SALT30.StrType)le.event_microfilm_nbr),TRIM((SALT30.StrType)le.event_desc),TRIM((SALT30.StrType)le.event_revocation_comment1),TRIM((SALT30.StrType)le.event_revocation_comment2),TRIM((SALT30.StrType)le.event_book_number),TRIM((SALT30.StrType)le.event_page_number),TRIM((SALT30.StrType)le.event_certification_number)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_supp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.event_filing_reference_nbr),TRIM((SALT30.StrType)le.event_amendment_nbr),TRIM((SALT30.StrType)le.event_filing_date),TRIM((SALT30.StrType)le.event_date_type_cd),TRIM((SALT30.StrType)le.event_date_type_desc),TRIM((SALT30.StrType)le.event_filing_cd),TRIM((SALT30.StrType)le.event_filing_desc),TRIM((SALT30.StrType)le.event_corp_nbr),TRIM((SALT30.StrType)le.event_corp_nbr_cd),TRIM((SALT30.StrType)le.event_corp_nbr_desc),TRIM((SALT30.StrType)le.event_roll),TRIM((SALT30.StrType)le.event_frame),TRIM((SALT30.StrType)le.event_start),TRIM((SALT30.StrType)le.event_end),TRIM((SALT30.StrType)le.event_microfilm_nbr),TRIM((SALT30.StrType)le.event_desc),TRIM((SALT30.StrType)le.event_revocation_comment1),TRIM((SALT30.StrType)le.event_revocation_comment2),TRIM((SALT30.StrType)le.event_book_number),TRIM((SALT30.StrType)le.event_page_number),TRIM((SALT30.StrType)le.event_certification_number)));
  END;
...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{29,'event_certification_number'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_event_revocation_comment1((SALT30.StrType)le.event_revocation_comment1),
    Fields.InValid_event_revocation_comment2((SALT30.StrType)le.event_revocation_comment2),
    Fields.InValid_event_book_number((SALT30.StrType)le.event_book_number),
    Fields.InValid_event_page_number((SALT30.StrType)le.event_page_number),
    Fields.InValid_event_certification_number((SALT30.StrType)le.event_certification_number),
    0);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_corp_key','Unknown','invalid_corp_vendor','Unknown','Unknown','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_alphanumericblank','Unknown','invalid_date','invalid_event_date_type_cd','Unknown','invalid_event_filing_cd','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
