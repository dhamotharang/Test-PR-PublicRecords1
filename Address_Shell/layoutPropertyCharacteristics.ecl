/*
 * This is a flattened layout of the results from PropertyCharacteristics_Services.ReportService.
...
SHARED attributesVersion1 := RECORD
	STRING2 State := '';
...
SHARED propertyAttributes := RECORD
...
SHARED propertyCharacteristics := RECORD
	// Category 001
...
SHARED propertyMortgages := RECORD
...
SHARED costSummary := RECORD
	STRING15 Insurance_To_Value := '';
	STRING15 Estimated_Replacement_Cost := '';
	STRING15 Profit := '';
	STRING15 Architect_Amount := '';
	STRING1 Sales_Tax_Included := '';
	STRING15 Debris_Amount := '';
	STRING15 Actual_Cash_Value := '';
	STRING15 Overhead_Amount := '';
	STRING10 Est_Replacement_Cost_Score := '';
	STRING10 Actual_Cash_Value_Score := '';
END;

SHARED propertyDescriptionRecordSet := RECORD
	STRING2 Classification := '';
	STRING64 Property_Desc := '';
	STRING15 Property_Addition_Value := '';
	STRING1 Property_Addition_Quality := '';
	STRING64 Property_Addition_Quality_Desc := '';
	STRING1 Property_Addition_Condition := '';
	STRING64 Property_Addition_Condition_Desc := '';
	STRING1 Living_Area_Indicator := '';
	STRING15 ERC_Value := '';
	STRING15 Low_ERC_Value := '';
	STRING15 High_ERC_Value := '';
END;
...
SHARED ercCharacteristics := RECORD
	costSummary CostSummary;
	propertyAttributes Attributes;
	propertyCharacteristics Characteristics;
	propertyDescriptionRecordSet Descriptions;
END;

EXPORT layoutPropertyCharacteristics := RECORD
	Address_Shell.layoutInput Input;
	
	propAttributes PropertyAttributes;
	propCharacteristics PropertyCharacteristics;
	ercCharacteristics ERCCalculations;
END;