IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_HI_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_corp_status_desc','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_address_type_cd','invalid_address_type_desc','invalid_term_exist_cd','invalid_term_exist_exp','invalid_term_exist_desc','invalid_corp_filing_desc','invalid_for_dom_ind','invalid_for_profit_ind','invalid_filesuffix','invalid_companytype','invalid_cont_type_cd','invalid_cont_type_desc','invalid_corp_llc_managed_desc','invalid_corp_name_status_desc','invalid_alphablank','invalid_alphadashblank','invalid_numeric','invalid_numblank','invalid_recordorigin');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_supp_key' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_future_date' => 8,'invalid_corp_status_desc' => 9,'invalid_ln_name_type_cd' => 10,'invalid_ln_name_type_desc' => 11,'invalid_address_type_cd' => 12,'invalid_address_type_desc' => 13,'invalid_term_exist_cd' => 14,'invalid_term_exist_exp' => 15,'invalid_term_exist_desc' => 16,'invalid_corp_filing_desc' => 17,'invalid_for_dom_ind' => 18,'invalid_for_profit_ind' => 19,'invalid_filesuffix' => 20,'invalid_companytype' => 21,'invalid_cont_type_cd' => 22,'invalid_cont_type_desc' => 23,'invalid_corp_llc_managed_desc' => 24,'invalid_corp_name_status_desc' => 25,'invalid_alphablank' => 26,'invalid_alphadashblank' => 27,'invalid_numeric' => 28,'invalid_numblank' => 29,'invalid_recordorigin' => 30,0);
...
EXPORT MakeFT_invalid_corp_key(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))),~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_key(s)>0,~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_key'),SALT34.HygieneErrors.NotLength('4..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter_nbr(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))),~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_sos_charter_nbr(s)>0,~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_sos_charter_nbr'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_supp_key(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_supp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))));
EXPORT InValidMessageFT_invalid_supp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['15']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('15'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['HI']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('HI'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_status_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_status_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_status_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_address_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_address_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_address_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exist_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_exist_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_cd(s)>0);
EXPORT InValidMessageFT_invalid_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exist_exp(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_term_exist_exp(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789'))),~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_term_exist_exp(s)>0);
EXPORT InValidMessageFT_invalid_term_exist_exp(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789'),SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_term_exist_exp'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exist_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_exist_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_desc(s)>0);
EXPORT InValidMessageFT_invalid_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_filing_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_filing_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_filing_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_filing_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_for_profit_ind(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_profit_ind(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['N','Y',' ']);
EXPORT InValidMessageFT_invalid_for_profit_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('N|Y| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filesuffix(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filesuffix(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_filesuffix(s)>0);
EXPORT InValidMessageFT_invalid_filesuffix(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_filesuffix'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_companytype(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_companytype(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_companytype(s)>0);
EXPORT InValidMessageFT_invalid_companytype(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_companytype'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_cont_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cont_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cont_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_cont_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_llc_managed_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_llc_managed_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_llc_managed_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_llc_managed_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_llc_managed_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_name_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_name_status_desc(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_name_status_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_name_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_name_status_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_alphadashblank(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphadashblank(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphadashblank(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_ln_name_type_cd(SALT34.StrType s0) := MakeFT_invalid_ln_name_type_cd(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_ln_name_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_ln_name_type_cd(wh);
 
EXPORT Make_corp_ln_name_type_desc(SALT34.StrType s0) := MakeFT_invalid_ln_name_type_desc(s0);
EXPORT InValid_corp_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_ln_name_type_desc(s,recordorigin);
EXPORT InValidMessage_corp_ln_name_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_ln_name_type_desc(wh);
...
EXPORT Make_corp_address1_type_cd(SALT34.StrType s0) := MakeFT_invalid_address_type_cd(s0);
EXPORT InValid_corp_address1_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_address1_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_cd(wh);
 
EXPORT Make_corp_address1_type_desc(SALT34.StrType s0) := MakeFT_invalid_address_type_desc(s0);
EXPORT InValid_corp_address1_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_desc(s,recordorigin);
EXPORT InValidMessage_corp_address1_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_desc(wh);
...
EXPORT Make_corp_address1_line3(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_address1_line3(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_corp_address2_type_cd(SALT34.StrType s0) := MakeFT_invalid_address_type_cd(s0);
EXPORT InValid_corp_address2_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_address2_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_cd(wh);
 
EXPORT Make_corp_address2_type_desc(SALT34.StrType s0) := MakeFT_invalid_address_type_desc(s0);
EXPORT InValid_corp_address2_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_desc(s,recordorigin);
EXPORT InValidMessage_corp_address2_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_desc(wh);
...
EXPORT Make_corp_address2_line3(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_address2_line3(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_address2_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
...
EXPORT Make_corp_filing_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_filing_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_filing_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
EXPORT Make_corp_status_date(SALT34.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_status_date(SALT34.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_term_exist_exp(SALT34.StrType s0) := MakeFT_invalid_term_exist_exp(s0);
EXPORT InValid_corp_term_exist_exp(SALT34.StrType s) := InValidFT_invalid_term_exist_exp(s);
EXPORT InValidMessage_corp_term_exist_exp(UNSIGNED1 wh) := InValidMessageFT_invalid_term_exist_exp(wh);
 
EXPORT Make_corp_term_exist_desc(SALT34.StrType s0) := MakeFT_invalid_term_exist_desc(s0);
EXPORT InValid_corp_term_exist_desc(SALT34.StrType s) := InValidFT_invalid_term_exist_desc(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT34.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_cd(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_certificate_nbr(SALT34.StrType s0) := MakeFT_invalid_numblank(s0);
EXPORT InValid_corp_certificate_nbr(SALT34.StrType s) := InValidFT_invalid_numblank(s);
EXPORT InValidMessage_corp_certificate_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_numblank(wh);
...
EXPORT Make_corp_ra_effective_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_ra_effective_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT Make_corp_ra_address_type_cd(SALT34.StrType s0) := MakeFT_invalid_address_type_cd(s0);
EXPORT InValid_corp_ra_address_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_ra_address_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_cd(wh);
 
EXPORT Make_corp_ra_address_type_desc(SALT34.StrType s0) := MakeFT_invalid_address_type_desc(s0);
EXPORT InValid_corp_ra_address_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_address_type_desc(s,recordorigin);
EXPORT InValidMessage_corp_ra_address_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_address_type_desc(wh);
...
EXPORT Make_corp_ra_address_line3(SALT34.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_ra_address_line3(SALT34.StrType s) := InValidFT_invalid_alphablank(s);
...
EXPORT Make_cont_type_cd(SALT34.StrType s0) := MakeFT_invalid_cont_type_cd(s0);
EXPORT InValid_cont_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_cont_type_cd(s,recordorigin);
EXPORT InValidMessage_cont_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_cont_type_cd(wh);
 
EXPORT Make_cont_type_desc(SALT34.StrType s0) := MakeFT_invalid_cont_type_desc(s0);
EXPORT InValid_cont_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_cont_type_desc(s,recordorigin);
...
EXPORT InValid_corp_action_pending_cd(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_action_pending_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_pending_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_action_pending_desc(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_comment(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_has_members(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_has_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_vested_managers(SALT34.StrType s0) := s0;
EXPORT InValid_corp_has_vested_managers(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_is_non_profit_irs_approved(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_llc_managed_desc(SALT34.StrType s0) := MakeFT_invalid_corp_llc_managed_desc(s0);
EXPORT InValid_corp_llc_managed_desc(SALT34.StrType s) := InValidFT_invalid_corp_llc_managed_desc(s);
EXPORT InValidMessage_corp_llc_managed_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_llc_managed_desc(wh);
 
EXPORT Make_corp_llc_managed_ind(SALT34.StrType s0) := s0;
EXPORT InValid_corp_llc_managed_ind(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_llc_managed_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_management_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_management_desc(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_merger_desc(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_merger_type_converted_to_cd(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_merger_type_converted_to_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_merger_type_converted_to_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_naics_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_naics_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_naics_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_effective_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_name_effective_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT InValid_corp_name_reservation_desc(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_name_reservation_nbr(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_non_profit_irs_approved_purpose(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_non_profit_solicit_donations(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_nbr_of_amendments(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_termination_cd(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_termination_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_termination_desc(SALT34.StrType s0) := s0;
EXPORT InValid_corp_termination_desc(SALT34.StrType s) := FALSE;
...
EXPORT InValid_corp_trademark_classification_nbr(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_trademark_expiration_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_trademark_expiration_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT InValid_corp_trademark_nbr(SALT34.StrType s) := FALSE;
...
EXPORT Make_internalfield1(SALT34.StrType s0) := MakeFT_invalid_filesuffix(s0);
EXPORT InValid_internalfield1(SALT34.StrType s) := InValidFT_invalid_filesuffix(s);
EXPORT InValidMessage_internalfield1(UNSIGNED1 wh) := InValidMessageFT_invalid_filesuffix(wh);
 
EXPORT Make_internalfield2(SALT34.StrType s0) := MakeFT_invalid_companytype(s0);
EXPORT InValid_internalfield2(SALT34.StrType s) := InValidFT_invalid_companytype(s);
EXPORT InValidMessage_internalfield2(UNSIGNED1 wh) := InValidMessageFT_invalid_companytype(wh);
 
EXPORT Make_internalfield3(SALT34.StrType s0) := s0;
EXPORT InValid_internalfield3(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_internalfield3(UNSIGNED1 wh) := '';
 
EXPORT Make_internalfield4(SALT34.StrType s0) := s0;
EXPORT InValid_internalfield4(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_internalfield4(UNSIGNED1 wh) := '';
 
EXPORT Make_internalfield5(SALT34.StrType s0) := s0;
EXPORT InValid_internalfield5(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_internalfield5(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_HI_Main;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_internalfield5 := COUNT(GROUP,%Closest%.Diff_internalfield5);
  END;
