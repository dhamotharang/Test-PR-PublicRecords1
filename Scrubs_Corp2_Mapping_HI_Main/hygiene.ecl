...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{252,'corp_termination_cd'}
      ,{253,'corp_termination_desc'}
      ,{254,'corp_termination_date'}
      ,{255,'corp_trademark_business_mark_type'}
      ,{256,'corp_trademark_cancelled_date'}
      ,{257,'corp_trademark_class_desc1'}
      ,{258,'corp_trademark_class_desc2'}
      ,{259,'corp_trademark_class_desc3'}
      ,{260,'corp_trademark_class_desc4'}
      ,{261,'corp_trademark_class_desc5'}
      ,{262,'corp_trademark_class_desc6'}
      ,{263,'corp_trademark_classification_nbr'}
      ,{264,'corp_trademark_disclaimer1'}
      ,{265,'corp_trademark_disclaimer2'}
      ,{266,'corp_trademark_expiration_date'}
      ,{267,'corp_trademark_filing_date'}
      ,{268,'corp_trademark_first_use_date'}
      ,{269,'corp_trademark_first_use_date_in_state'}
      ,{270,'corp_trademark_keywords'}
      ,{271,'corp_trademark_logo'}
      ,{272,'corp_trademark_name_expiration_date'}
      ,{273,'corp_trademark_nbr'}
      ...
      ,{288,'internalfield3'}
      ,{289,'internalfield4'}
      ,{290,'internalfield5'}],SALT34.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_corp_address1_type_cd((SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.recordorigin),
    Fields.InValid_corp_address1_type_desc((SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.recordorigin),
    ...
    Fields.InValid_corp_address2_type_cd((SALT34.StrType)le.corp_address2_type_cd,(SALT34.StrType)le.recordorigin),
    Fields.InValid_corp_address2_type_desc((SALT34.StrType)le.corp_address2_type_desc,(SALT34.StrType)le.recordorigin),
    ...
    Fields.InValid_corp_ra_address_type_cd((SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.recordorigin),
    Fields.InValid_corp_ra_address_type_desc((SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.recordorigin),
    ...
    Fields.InValid_cont_type_cd((SALT34.StrType)le.cont_type_cd,(SALT34.StrType)le.recordorigin),
    Fields.InValid_cont_type_desc((SALT34.StrType)le.cont_type_desc,(SALT34.StrType)le.recordorigin),
    ...
    Fields.InValid_internalfield1((SALT34.StrType)le.internalfield1),
    Fields.InValid_internalfield2((SALT34.StrType)le.internalfield2),
    Fields.InValid_internalfield3((SALT34.StrType)le.internalfield3),
    Fields.InValid_internalfield4((SALT34.StrType)le.internalfield4),
    Fields.InValid_internalfield5((SALT34.StrType)le.internalfield5),
    0);
