...
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(corp2_mapping.layoutscommon.main)
    ...
    UNSIGNED1 corp_address2_type_cd_Invalid;
    UNSIGNED1 corp_address2_type_desc_Invalid;
    UNSIGNED1 corp_address2_line3_Invalid;
    ...
    UNSIGNED1 corp_certificate_nbr_Invalid;
    ...
    UNSIGNED1 corp_llc_managed_desc_Invalid;
...
EXPORT FromNone(DATASET(corp2_mapping.layoutscommon.main) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_address1_type_cd_Invalid := Fields.InValid_corp_address1_type_cd((SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.recordorigin);
    SELF.corp_address1_type_desc_Invalid := Fields.InValid_corp_address1_type_desc((SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.recordorigin);
    SELF.corp_address1_line3_Invalid := Fields.InValid_corp_address1_line3((SALT34.StrType)le.corp_address1_line3);
    SELF.corp_address2_type_cd_Invalid := Fields.InValid_corp_address2_type_cd((SALT34.StrType)le.corp_address2_type_cd,(SALT34.StrType)le.recordorigin);
    SELF.corp_address2_type_desc_Invalid := Fields.InValid_corp_address2_type_desc((SALT34.StrType)le.corp_address2_type_desc,(SALT34.StrType)le.recordorigin);
    SELF.corp_address2_line3_Invalid := Fields.InValid_corp_address2_line3((SALT34.StrType)le.corp_address2_line3);
    ...
    SELF.corp_certificate_nbr_Invalid := Fields.InValid_corp_certificate_nbr((SALT34.StrType)le.corp_certificate_nbr);
    SELF.corp_ra_effective_date_Invalid := Fields.InValid_corp_ra_effective_date((SALT34.StrType)le.corp_ra_effective_date);
    SELF.corp_ra_address_type_cd_Invalid := Fields.InValid_corp_ra_address_type_cd((SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.recordorigin);
    SELF.corp_ra_address_type_desc_Invalid := Fields.InValid_corp_ra_address_type_desc((SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.recordorigin);
    SELF.corp_ra_address_line3_Invalid := Fields.InValid_corp_ra_address_line3((SALT34.StrType)le.corp_ra_address_line3);
    SELF.cont_type_cd_Invalid := Fields.InValid_cont_type_cd((SALT34.StrType)le.cont_type_cd,(SALT34.StrType)le.recordorigin);
    SELF.cont_type_desc_Invalid := Fields.InValid_cont_type_desc((SALT34.StrType)le.cont_type_desc,(SALT34.StrType)le.recordorigin);
    ...
    SELF.corp_llc_managed_desc_Invalid := Fields.InValid_corp_llc_managed_desc((SALT34.StrType)le.corp_llc_managed_desc);
    SELF.corp_name_effective_date_Invalid := Fields.InValid_corp_name_effective_date((SALT34.StrType)le.corp_name_effective_date);
    SELF.corp_name_status_desc_Invalid := Fields.InValid_corp_name_status_desc((SALT34.StrType)le.corp_name_status_desc);
    SELF.corp_trademark_expiration_date_Invalid := Fields.InValid_corp_trademark_expiration_date((SALT34.StrType)le.corp_trademark_expiration_date);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_vendor_Invalid << 14 ) + ( le.corp_state_origin_Invalid << 15 ) + ( le.corp_process_date_Invalid << 16 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 18 ) + ( le.corp_legal_name_Invalid << 20 ) + ( le.corp_ln_name_type_cd_Invalid << 21 ) + ( le.corp_ln_name_type_desc_Invalid << 22 ) + ( le.corp_address1_type_cd_Invalid << 23 ) + ( le.corp_address1_type_desc_Invalid << 24 ) + ( le.corp_address1_line3_Invalid << 25 ) + ( le.corp_address2_type_cd_Invalid << 26 ) + ( le.corp_address2_type_desc_Invalid << 27 ) + ( le.corp_address2_line3_Invalid << 28 ) + ( le.corp_filing_date_Invalid << 29 ) + ( le.corp_filing_desc_Invalid << 31 ) + ( le.corp_status_desc_Invalid << 32 ) + ( le.corp_status_date_Invalid << 33 ) + ( le.corp_inc_state_Invalid << 35 ) + ( le.corp_inc_date_Invalid << 36 ) + ( le.corp_term_exist_cd_Invalid << 38 ) + ( le.corp_term_exist_exp_Invalid << 39 ) + ( le.corp_term_exist_desc_Invalid << 41 ) + ( le.corp_foreign_domestic_ind_Invalid << 42 ) + ( le.corp_forgn_state_cd_Invalid << 43 ) + ( le.corp_forgn_state_desc_Invalid << 44 ) + ( le.corp_forgn_date_Invalid << 45 ) + ( le.corp_for_profit_ind_Invalid << 47 ) + ( le.corp_certificate_nbr_Invalid << 48 ) + ( le.corp_ra_effective_date_Invalid << 50 ) + ( le.corp_ra_address_type_cd_Invalid << 52 ) + ( le.corp_ra_address_type_desc_Invalid << 53 ) + ( le.corp_ra_address_line3_Invalid << 54 ) + ( le.cont_type_cd_Invalid << 55 ) + ( le.cont_type_desc_Invalid << 56 ) + ( le.corp_country_of_formation_Invalid << 57 ) + ( le.corp_llc_managed_desc_Invalid << 58 ) + ( le.corp_name_effective_date_Invalid << 59 ) + ( le.corp_name_status_desc_Invalid << 61 ) + ( le.corp_trademark_expiration_date_Invalid << 62 );
    SELF.ScrubsBits2 := ( le.recordorigin_Invalid << 0 ) + ( le.internalfield1_Invalid << 1 ) + ( le.internalfield2_Invalid << 2 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_address1_line3_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.corp_address2_type_cd_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.corp_address2_type_desc_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.corp_address2_line3_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.corp_filing_date_Invalid := (le.ScrubsBits1 >> 29) & 3;
    SELF.corp_filing_desc_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.corp_status_desc_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.corp_status_date_Invalid := (le.ScrubsBits1 >> 33) & 3;
    SELF.corp_inc_state_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.corp_inc_date_Invalid := (le.ScrubsBits1 >> 36) & 3;
    SELF.corp_term_exist_cd_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.corp_term_exist_exp_Invalid := (le.ScrubsBits1 >> 39) & 3;
    SELF.corp_term_exist_desc_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.corp_forgn_state_cd_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.corp_forgn_date_Invalid := (le.ScrubsBits1 >> 45) & 3;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.corp_certificate_nbr_Invalid := (le.ScrubsBits1 >> 48) & 3;
    SELF.corp_ra_effective_date_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.corp_ra_address_type_cd_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.corp_ra_address_type_desc_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.corp_ra_address_line3_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.cont_type_cd_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.cont_type_desc_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.corp_country_of_formation_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.corp_llc_managed_desc_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.corp_name_effective_date_Invalid := (le.ScrubsBits1 >> 59) & 3;
    SELF.corp_name_status_desc_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.corp_trademark_expiration_date_Invalid := (le.ScrubsBits1 >> 62) & 3;
    SELF.recordorigin_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.internalfield1_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.internalfield2_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_orig_sos_charter_nbr_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_orig_sos_charter_nbr_Invalid=2);
    corp_orig_sos_charter_nbr_LENGTH_ErrorCount := COUNT(GROUP,h.corp_orig_sos_charter_nbr_Invalid=3);
    ...
    corp_address1_type_cd_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_address1_type_cd_Invalid=1);
    corp_address1_type_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_address1_type_desc_Invalid=1);
    corp_address1_line3_ALLOW_ErrorCount := COUNT(GROUP,h.corp_address1_line3_Invalid=1);
    corp_address2_type_cd_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_address2_type_cd_Invalid=1);
    corp_address2_type_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_address2_type_desc_Invalid=1);
    corp_address2_line3_ALLOW_ErrorCount := COUNT(GROUP,h.corp_address2_line3_Invalid=1);
    ...
    corp_filing_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_filing_desc_Invalid=1);
    corp_status_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_status_desc_Invalid=1);
    ...
    corp_term_exist_cd_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_term_exist_cd_Invalid=1);
    ...
    corp_term_exist_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_term_exist_desc_Invalid=1);
    ...
    corp_certificate_nbr_ALLOW_ErrorCount := COUNT(GROUP,h.corp_certificate_nbr_Invalid=1);
    corp_certificate_nbr_LENGTH_ErrorCount := COUNT(GROUP,h.corp_certificate_nbr_Invalid=2);
    corp_certificate_nbr_Total_ErrorCount := COUNT(GROUP,h.corp_certificate_nbr_Invalid>0);
    ...
    corp_ra_address_type_cd_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_ra_address_type_cd_Invalid=1);
    corp_ra_address_type_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_ra_address_type_desc_Invalid=1);
    corp_ra_address_line3_ALLOW_ErrorCount := COUNT(GROUP,h.corp_ra_address_line3_Invalid=1);
    cont_type_cd_CUSTOM_ErrorCount := COUNT(GROUP,h.cont_type_cd_Invalid=1);
    cont_type_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.cont_type_desc_Invalid=1);
    corp_country_of_formation_ALLOW_ErrorCount := COUNT(GROUP,h.corp_country_of_formation_Invalid=1);
    corp_llc_managed_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_llc_managed_desc_Invalid=1);
    ...
    corp_name_status_desc_CUSTOM_ErrorCount := COUNT(GROUP,h.corp_name_status_desc_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.corp_orig_sos_charter_nbr_Invalid,'ALLOW','CUSTOM','LENGTH','UNKNOWN')
          ...
          ,CHOOSE(le.corp_address1_type_cd_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_address1_type_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_address1_line3_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_address2_type_cd_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_address2_type_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_address2_line3_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_filing_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_filing_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_status_desc_Invalid,'CUSTOM','UNKNOWN')
          ...
          ,CHOOSE(le.corp_term_exist_cd_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_term_exist_exp_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_term_exist_desc_Invalid,'CUSTOM','UNKNOWN')
          ...
          ,CHOOSE(le.corp_certificate_nbr_Invalid,'ALLOW','LENGTH','UNKNOWN')
          ,CHOOSE(le.corp_ra_effective_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_ra_address_type_cd_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_ra_address_type_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_ra_address_line3_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.cont_type_cd_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.cont_type_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_country_of_formation_Invalid,'ALLOW','UNKNOWN')
          ,CHOOSE(le.corp_llc_managed_desc_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_name_effective_date_Invalid,'ALLOW','CUSTOM','UNKNOWN')
          ,CHOOSE(le.corp_name_status_desc_Invalid,'CUSTOM','UNKNOWN')
          ...
          ,CHOOSE(le.internalfield2_Invalid,'CUSTOM','UNKNOWN'),'UNKNOWN'));
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_key','corp_vendor','corp_state_origin','corp_process_date','corp_orig_sos_charter_nbr','corp_legal_name','corp_ln_name_type_cd','corp_ln_name_type_desc','corp_address1_type_cd','corp_address1_type_desc','corp_address1_line3','corp_address2_type_cd','corp_address2_type_desc','corp_address2_line3','corp_filing_date','corp_filing_desc','corp_status_desc','corp_status_date','corp_inc_state','corp_inc_date','corp_term_exist_cd','corp_term_exist_exp','corp_term_exist_desc','corp_foreign_domestic_ind','corp_forgn_state_cd','corp_forgn_state_desc','corp_forgn_date','corp_for_profit_ind','corp_certificate_nbr','corp_ra_effective_date','corp_ra_address_type_cd','corp_ra_address_type_desc','corp_ra_address_line3','cont_type_cd','cont_type_desc','corp_country_of_formation','corp_llc_managed_desc','corp_name_effective_date','corp_name_status_desc','corp_trademark_expiration_date','recordorigin','internalfield1','internalfield2','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_mandatory','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablank','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablank','invalid_future_date','invalid_corp_filing_desc','invalid_corp_status_desc','invalid_date','invalid_state_origin','invalid_date','invalid_term_exist_cd','invalid_term_exist_exp','invalid_term_exist_desc','invalid_for_dom_ind','invalid_alphablank','invalid_alphablank','invalid_date','invalid_for_profit_ind','invalid_numblank','invalid_future_date','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablank','invalid_cont_type_cd','invalid_cont_type_desc','invalid_alphablank','invalid_corp_llc_managed_desc','invalid_future_date','invalid_corp_name_status_desc','invalid_future_date','invalid_recordorigin','invalid_filesuffix','invalid_companytype','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.dt_first_seen,(SALT34.StrType)le.dt_last_seen,(SALT34.StrType)le.corp_ra_dt_first_seen,(SALT34.StrType)le.corp_ra_dt_last_seen,(SALT34.StrType)le.corp_key,(SALT34.StrType)le.corp_vendor,(SALT34.StrType)le.corp_state_origin,(SALT34.StrType)le.corp_process_date,(SALT34.StrType)le.corp_orig_sos_charter_nbr,(SALT34.StrType)le.corp_legal_name,(SALT34.StrType)le.corp_ln_name_type_cd,(SALT34.StrType)le.corp_ln_name_type_desc,(SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.corp_address1_line3,(SALT34.StrType)le.corp_address2_type_cd,(SALT34.StrType)le.corp_address2_type_desc,(SALT34.StrType)le.corp_address2_line3,(SALT34.StrType)le.corp_filing_date,(SALT34.StrType)le.corp_filing_desc,(SALT34.StrType)le.corp_status_desc,(SALT34.StrType)le.corp_status_date,(SALT34.StrType)le.corp_inc_state,(SALT34.StrType)le.corp_inc_date,(SALT34.StrType)le.corp_term_exist_cd,(SALT34.StrType)le.corp_term_exist_exp,(SALT34.StrType)le.corp_term_exist_desc,(SALT34.StrType)le.corp_foreign_domestic_ind,(SALT34.StrType)le.corp_forgn_state_cd,(SALT34.StrType)le.corp_forgn_state_desc,(SALT34.StrType)le.corp_forgn_date,(SALT34.StrType)le.corp_for_profit_ind,(SALT34.StrType)le.corp_certificate_nbr,(SALT34.StrType)le.corp_ra_effective_date,(SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.corp_ra_address_line3,(SALT34.StrType)le.cont_type_cd,(SALT34.StrType)le.cont_type_desc,(SALT34.StrType)le.corp_country_of_formation,(SALT34.StrType)le.corp_llc_managed_desc,(SALT34.StrType)le.corp_name_effective_date,(SALT34.StrType)le.corp_name_status_desc,(SALT34.StrType)le.corp_trademark_expiration_date,(SALT34.StrType)le.recordorigin,(SALT34.StrType)le.internalfield1,(SALT34.StrType)le.internalfield2,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_orig_sos_charter_nbr:invalid_charter_nbr:ALLOW','corp_orig_sos_charter_nbr:invalid_charter_nbr:CUSTOM','corp_orig_sos_charter_nbr:invalid_charter_nbr:LENGTH'
          ...
          ,'corp_address1_type_cd:invalid_address_type_cd:CUSTOM'
          ,'corp_address1_type_desc:invalid_address_type_desc:CUSTOM'
          ,'corp_address1_line3:invalid_alphablank:ALLOW'
          ,'corp_address2_type_cd:invalid_address_type_cd:CUSTOM'
          ,'corp_address2_type_desc:invalid_address_type_desc:CUSTOM'
          ,'corp_address2_line3:invalid_alphablank:ALLOW'
          ,'corp_filing_date:invalid_future_date:ALLOW','corp_filing_date:invalid_future_date:CUSTOM'
          ,'corp_filing_desc:invalid_corp_filing_desc:CUSTOM'
          ,'corp_status_desc:invalid_corp_status_desc:CUSTOM'
          ...
          ,'corp_term_exist_cd:invalid_term_exist_cd:CUSTOM'
          ,'corp_term_exist_exp:invalid_term_exist_exp:ALLOW','corp_term_exist_exp:invalid_term_exist_exp:CUSTOM'
          ,'corp_term_exist_desc:invalid_term_exist_desc:CUSTOM'
          ...
          ,'corp_certificate_nbr:invalid_numblank:ALLOW','corp_certificate_nbr:invalid_numblank:LENGTH'
          ,'corp_ra_effective_date:invalid_future_date:ALLOW','corp_ra_effective_date:invalid_future_date:CUSTOM'
          ,'corp_ra_address_type_cd:invalid_address_type_cd:CUSTOM'
          ,'corp_ra_address_type_desc:invalid_address_type_desc:CUSTOM'
          ,'corp_ra_address_line3:invalid_alphablank:ALLOW'
          ,'cont_type_cd:invalid_cont_type_cd:CUSTOM'
          ,'cont_type_desc:invalid_cont_type_desc:CUSTOM'
          ,'corp_country_of_formation:invalid_alphablank:ALLOW'
          ,'corp_llc_managed_desc:invalid_corp_llc_managed_desc:CUSTOM'
          ,'corp_name_effective_date:invalid_future_date:ALLOW','corp_name_effective_date:invalid_future_date:CUSTOM'
          ,'corp_name_status_desc:invalid_corp_name_status_desc:CUSTOM'
          ...
          ,'internalfield1:invalid_filesuffix:CUSTOM'
          ,'internalfield2:invalid_companytype:CUSTOM','UNKNOWN');
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_orig_sos_charter_nbr(1),Fields.InvalidMessage_corp_orig_sos_charter_nbr(2),Fields.InvalidMessage_corp_orig_sos_charter_nbr(3)
          ...
          ,Fields.InvalidMessage_corp_address2_type_cd(1)
          ,Fields.InvalidMessage_corp_address2_type_desc(1)
          ,Fields.InvalidMessage_corp_address2_line3(1)
          ...
          ,Fields.InvalidMessage_corp_certificate_nbr(1),Fields.InvalidMessage_corp_certificate_nbr(2)
          ...
          ,Fields.InvalidMessage_corp_llc_managed_desc(1)
          ...
          ,Fields.InvalidMessage_internalfield2(1),'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_orig_sos_charter_nbr_ALLOW_ErrorCount,le.corp_orig_sos_charter_nbr_CUSTOM_ErrorCount,le.corp_orig_sos_charter_nbr_LENGTH_ErrorCount
          ,le.corp_legal_name_LENGTH_ErrorCount
          ,le.corp_ln_name_type_cd_CUSTOM_ErrorCount
          ,le.corp_ln_name_type_desc_CUSTOM_ErrorCount
          ,le.corp_address1_type_cd_CUSTOM_ErrorCount
          ,le.corp_address1_type_desc_CUSTOM_ErrorCount
          ,le.corp_address1_line3_ALLOW_ErrorCount
          ,le.corp_address2_type_cd_CUSTOM_ErrorCount
          ,le.corp_address2_type_desc_CUSTOM_ErrorCount
          ,le.corp_address2_line3_ALLOW_ErrorCount
          ,le.corp_filing_date_ALLOW_ErrorCount,le.corp_filing_date_CUSTOM_ErrorCount
          ,le.corp_filing_desc_CUSTOM_ErrorCount
          ,le.corp_status_desc_CUSTOM_ErrorCount
          ...
          ,le.corp_term_exist_cd_CUSTOM_ErrorCount
          ,le.corp_term_exist_exp_ALLOW_ErrorCount,le.corp_term_exist_exp_CUSTOM_ErrorCount
          ,le.corp_term_exist_desc_CUSTOM_ErrorCount
          ...
          ,le.corp_certificate_nbr_ALLOW_ErrorCount,le.corp_certificate_nbr_LENGTH_ErrorCount
          ,le.corp_ra_effective_date_ALLOW_ErrorCount,le.corp_ra_effective_date_CUSTOM_ErrorCount
          ,le.corp_ra_address_type_cd_CUSTOM_ErrorCount
          ,le.corp_ra_address_type_desc_CUSTOM_ErrorCount
          ,le.corp_ra_address_line3_ALLOW_ErrorCount
          ,le.cont_type_cd_CUSTOM_ErrorCount
          ,le.cont_type_desc_CUSTOM_ErrorCount
          ,le.corp_country_of_formation_ALLOW_ErrorCount
          ,le.corp_llc_managed_desc_CUSTOM_ErrorCount
          ,le.corp_name_effective_date_ALLOW_ErrorCount,le.corp_name_effective_date_CUSTOM_ErrorCount
          ,le.corp_name_status_desc_CUSTOM_ErrorCount
          ...
          ,le.internalfield2_CUSTOM_ErrorCount,0);
      SELF.rulepcnt := 100 * CHOOSE(c
          ...
          ,le.recordorigin_ENUM_ErrorCount
          ,le.internalfield1_CUSTOM_ErrorCount
          ,le.internalfield2_CUSTOM_ErrorCount,0) / le.TotalCnt + 0.5;
    END;
