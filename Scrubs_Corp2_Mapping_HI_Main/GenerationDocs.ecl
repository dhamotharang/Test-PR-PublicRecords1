...
Command line options: -MScrubs_Corp2_Mapping_HI_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR640B.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_HI_Main
FILENAME:In_HI
...
FIELDTYPE:invalid_corp_key:ALLOW(-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(4..):CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_key>0)
FIELDTYPE:invalid_charter_nbr:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..):CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_sos_charter_nbr>0)
FIELDTYPE:invalid_supp_key:ALLOW(0123456789)
FIELDTYPE:invalid_corp_vendor:ENUM(15)
FIELDTYPE:invalid_state_origin:ENUM(HI)
...
FIELDTYPE:invalid_corp_status_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_status_desc>0)
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_address_type_cd:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_cd>0,recordorigin)
FIELDTYPE:invalid_address_type_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_address_type_desc>0,recordorigin)
FIELDTYPE:invalid_term_exist_cd:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_cd>0)
FIELDTYPE:invalid_term_exist_exp:ALLOW(0123456789):CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_term_exist_exp>0)
FIELDTYPE:invalid_term_exist_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_term_exist_desc>0)
FIELDTYPE:invalid_corp_filing_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_filing_desc>0)
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(N|Y| )
FIELDTYPE:invalid_filesuffix:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_filesuffix>0)
FIELDTYPE:invalid_companytype:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_companytype>0)
FIELDTYPE:invalid_cont_type_cd:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_cd>0,recordorigin)
FIELDTYPE:invalid_cont_type_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_cont_type_desc>0,recordorigin)
FIELDTYPE:invalid_corp_llc_managed_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_llc_managed_desc>0)
FIELDTYPE:invalid_corp_name_status_desc:CUSTOM(Scrubs_Corp2_Mapping_HI_Main.Functions.invalid_corp_name_status_desc>0)
FIELDTYPE:invalid_alphablank:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alphadashblank:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_numeric:ALLOW(0123456789)
FIELDTYPE:invalid_numblank:ALLOW(0123456789):LENGTHS(0,1..)
...
FIELD:corp_ln_name_type_cd:TYPE(STRING2):LIKE(invalid_ln_name_type_cd):0,0
FIELD:corp_ln_name_type_desc:TYPE(STRING30):LIKE(invalid_ln_name_type_desc):0,0
FIELD:corp_supp_nbr:TYPE(STRING32):0,0
FIELD:corp_name_comment:TYPE(STRING250):0,0
FIELD:corp_address1_type_cd:TYPE(STRING8):LIKE(invalid_address_type_cd):0,0
FIELD:corp_address1_type_desc:TYPE(STRING60):LIKE(invalid_address_type_desc):0,0
FIELD:corp_address1_line1:TYPE(STRING70):0,0
FIELD:corp_address1_line2:TYPE(STRING70):0,0
FIELD:corp_address1_line3:TYPE(STRING70):LIKE(invalid_alphablank):0,0
FIELD:corp_address1_effective_date:TYPE(STRING8):0,0
FIELD:corp_address2_type_cd:TYPE(STRING8):LIKE(invalid_address_type_cd):0,0
FIELD:corp_address2_type_desc:TYPE(STRING60):LIKE(invalid_address_type_desc):0,0
FIELD:corp_address2_line1:TYPE(STRING70):0,0
FIELD:corp_address2_line2:TYPE(STRING70):0,0
FIELD:corp_address2_line3:TYPE(STRING70):LIKE(invalid_alphablank):0,0
...
FIELD:corp_filing_desc:TYPE(STRING60):LIKE(invalid_corp_filing_desc):0,0
...
FIELD:corp_term_exist_cd:TYPE(STRING8):LIKE(invalid_term_exist_cd):0,0
FIELD:corp_term_exist_exp:TYPE(STRING8):LIKE(invalid_term_exist_exp):0,0
FIELD:corp_term_exist_desc:TYPE(STRING60):LIKE(invalid_term_exist_desc):0,0
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
...
FIELD:corp_certificate_nbr:TYPE(STRING32):LIKE(invalid_numblank):0,0
...
FIELD:corp_ra_effective_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:corp_ra_address_type_cd:TYPE(STRING8):LIKE(invalid_address_type_cd):0,0
FIELD:corp_ra_address_type_desc:TYPE(STRING60):LIKE(invalid_address_type_desc):0,0
FIELD:corp_ra_address_line1:TYPE(STRING70):0,0
FIELD:corp_ra_address_line2:TYPE(STRING70):0,0
FIELD:corp_ra_address_line3:TYPE(STRING70):LIKE(invalid_alphablank):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alphablank):0,0
...
FIELD:corp_llc_managed_desc:TYPE(STRING100):LIKE(invalid_corp_llc_managed_desc):0,0
...
FIELD:corp_name_effective_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:corp_name_status_desc:TYPE(STRING100):LIKE(invalid_corp_name_status_desc):0,0
...
FIELD:corp_trademark_expiration_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:internalfield1:TYPE(STRING100):LIKE(invalid_filesuffix):0,0
FIELD:internalfield2:TYPE(STRING100):LIKE(invalid_companytype):0,0
FIELD:internalfield3:TYPE(STRING100):0,0
FIELD:internalfield4:TYPE(STRING100):0,0
FIELD:internalfield5:TYPE(STRING100):0,0
