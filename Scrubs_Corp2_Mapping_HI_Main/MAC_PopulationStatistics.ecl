...
+    #IF( #TEXT(Input_internalfield5)='' )
      '' 
    #ELSE
        IF( le.Input_internalfield5 = (TYPEOF(le.Input_internalfield5))'','',':internalfield5')
    #END
;
  END;
  #uniquename(op)
