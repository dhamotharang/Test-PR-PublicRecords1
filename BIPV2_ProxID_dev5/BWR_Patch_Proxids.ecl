import bipv2,bipv2_files,BIPV2_ProxID_dev5,ut,salt26,tools;

iter      := '24';
pversion  := BIPV2.KeySuffix + 'b';
pdataset  := BIPV2_Files.files_dotid.DS_DOTID_BASE(not mdr.sourceTools.sourceisZoom(source));
filename  := BIPV2_ProxID_dev5.filenames(BIPV2.KeySuffix + '_' + iter).base.logical;

#workunit('name','BIPV2_ProxID_dev5 Proxid patch ' + BIPV2.KeySuffix + ', ' + iter);
