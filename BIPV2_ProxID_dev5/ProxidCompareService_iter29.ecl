...
IMPORT SALT24,BIPV2_ProxID_dev5,ut,tools,BIPV2;
...
odl := PROJECT(CHOOSEN(BIPV2_ProxID_dev5.Keys(BFile,both).Candidates(Proxid=Proxidone),100000),BIPV2_ProxID_dev5.match_candidates(BFile).layout_candidates);
odr := PROJECT(CHOOSEN(BIPV2_ProxID_dev5.Keys(BFile,both).Candidates(Proxid=ProxidTwo),100000),BIPV2_ProxID_dev5.match_candidates(BFile).layout_candidates);
k := BIPV2_ProxID_dev5.Keys(BFile,both).Specificities_Key;
