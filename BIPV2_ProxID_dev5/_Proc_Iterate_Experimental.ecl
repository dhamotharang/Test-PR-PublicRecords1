//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_dev5',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_dev5.filenames(combo).dall_filenames
                  + BIPV2_ProxID_dev5.keynames (combo).dall_filenames
                  + BIPV2_ProxID_dev5.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_dev5.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_dev5.filenames(siter).dall_filenames
                  + BIPV2_ProxID_dev5.keynames (siter).dall_filenames
                  ;
