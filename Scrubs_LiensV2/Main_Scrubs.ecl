...
EXPORT Main_Scrubs := MODULE
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(Main_Layout_LiensV2)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Main_Layout_LiensV2)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Main_Layout_LiensV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.process_date_Invalid := Main_Fields.InValid_process_date((SALT33.StrType)le.process_date);
    SELF.record_code_Invalid := Main_Fields.InValid_record_code((SALT33.StrType)le.record_code);
    SELF.date_vendor_removed_Invalid := Main_Fields.InValid_date_vendor_removed((SALT33.StrType)le.date_vendor_removed);
    SELF.orig_filing_type_Invalid := Main_Fields.InValid_orig_filing_type((SALT33.StrType)le.orig_filing_type);
    SELF.orig_filing_date_Invalid := Main_Fields.InValid_orig_filing_date((SALT33.StrType)le.orig_filing_date);
    SELF.orig_filing_time_Invalid := Main_Fields.InValid_orig_filing_time((SALT33.StrType)le.orig_filing_time);
    SELF.filing_type_desc_Invalid := Main_Fields.InValid_filing_type_desc((SALT33.StrType)le.filing_type_desc);
    SELF.filing_date_Invalid := Main_Fields.InValid_filing_date((SALT33.StrType)le.filing_date);
    SELF.filing_time_Invalid := Main_Fields.InValid_filing_time((SALT33.StrType)le.filing_time);
    SELF.vendor_entry_date_Invalid := Main_Fields.InValid_vendor_entry_date((SALT33.StrType)le.vendor_entry_date);
    SELF.release_date_Invalid := Main_Fields.InValid_release_date((SALT33.StrType)le.release_date);
    SELF.eviction_Invalid := Main_Fields.InValid_eviction((SALT33.StrType)le.eviction);
    SELF.judg_satisfied_date_Invalid := Main_Fields.InValid_judg_satisfied_date((SALT33.StrType)le.judg_satisfied_date);
    SELF.judg_vacated_date_Invalid := Main_Fields.InValid_judg_vacated_date((SALT33.StrType)le.judg_vacated_date);
    SELF.effective_date_Invalid := Main_Fields.InValid_effective_date((SALT33.StrType)le.effective_date);
    SELF.lapse_date_Invalid := Main_Fields.InValid_lapse_date((SALT33.StrType)le.lapse_date);
    SELF.accident_date_Invalid := Main_Fields.InValid_accident_date((SALT33.StrType)le.accident_date);
    SELF.expiration_date_Invalid := Main_Fields.InValid_expiration_date((SALT33.StrType)le.expiration_date);
    SELF.agency_city_Invalid := Main_Fields.InValid_agency_city((SALT33.StrType)le.agency_city);
    SELF.agency_state_Invalid := Main_Fields.InValid_agency_state((SALT33.StrType)le.agency_state);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Main_Layout_LiensV2);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Main_Layout_LiensV2);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Main_Fields.InvalidMessage_process_date(le.process_date_Invalid),Main_Fields.InvalidMessage_record_code(le.record_code_Invalid),Main_Fields.InvalidMessage_date_vendor_removed(le.date_vendor_removed_Invalid),Main_Fields.InvalidMessage_orig_filing_type(le.orig_filing_type_Invalid),Main_Fields.InvalidMessage_orig_filing_date(le.orig_filing_date_Invalid),Main_Fields.InvalidMessage_orig_filing_time(le.orig_filing_time_Invalid),Main_Fields.InvalidMessage_filing_type_desc(le.filing_type_desc_Invalid),Main_Fields.InvalidMessage_filing_date(le.filing_date_Invalid),Main_Fields.InvalidMessage_filing_time(le.filing_time_Invalid),Main_Fields.InvalidMessage_vendor_entry_date(le.vendor_entry_date_Invalid),Main_Fields.InvalidMessage_release_date(le.release_date_Invalid),Main_Fields.InvalidMessage_eviction(le.eviction_Invalid),Main_Fields.InvalidMessage_judg_satisfied_date(le.judg_satisfied_date_Invalid),Main_Fields.InvalidMessage_judg_vacated_date(le.judg_vacated_date_Invalid),Main_Fields.InvalidMessage_effective_date(le.effective_date_Invalid),Main_Fields.InvalidMessage_lapse_date(le.lapse_date_Invalid),Main_Fields.InvalidMessage_accident_date(le.accident_date_Invalid),Main_Fields.InvalidMessage_expiration_date(le.expiration_date_Invalid),Main_Fields.InvalidMessage_agency_city(le.agency_city_Invalid),Main_Fields.InvalidMessage_agency_state(le.agency_state_Invalid),'UNKNOWN'));
    ...
    SELF.FieldContents := CHOOSE(c,(SALT33.StrType)le.process_date,(SALT33.StrType)le.record_code,(SALT33.StrType)le.date_vendor_removed,(SALT33.StrType)le.orig_filing_type,(SALT33.StrType)le.orig_filing_date,(SALT33.StrType)le.orig_filing_time,(SALT33.StrType)le.filing_type_desc,(SALT33.StrType)le.filing_date,(SALT33.StrType)le.filing_time,(SALT33.StrType)le.vendor_entry_date,(SALT33.StrType)le.release_date,(SALT33.StrType)le.eviction,(SALT33.StrType)le.judg_satisfied_date,(SALT33.StrType)le.judg_vacated_date,(SALT33.StrType)le.effective_date,(SALT33.StrType)le.lapse_date,(SALT33.StrType)le.accident_date,(SALT33.StrType)le.expiration_date,(SALT33.StrType)le.agency_city,(SALT33.StrType)le.agency_state,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Main_Fields.InvalidMessage_process_date(1),Main_Fields.InvalidMessage_process_date(2),Main_Fields.InvalidMessage_process_date(3)
          ,Main_Fields.InvalidMessage_record_code(1)
          ,Main_Fields.InvalidMessage_date_vendor_removed(1),Main_Fields.InvalidMessage_date_vendor_removed(2),Main_Fields.InvalidMessage_date_vendor_removed(3)
          ,Main_Fields.InvalidMessage_orig_filing_type(1)
          ,Main_Fields.InvalidMessage_orig_filing_date(1),Main_Fields.InvalidMessage_orig_filing_date(2),Main_Fields.InvalidMessage_orig_filing_date(3)
          ,Main_Fields.InvalidMessage_orig_filing_time(1)
          ,Main_Fields.InvalidMessage_filing_type_desc(1)
          ,Main_Fields.InvalidMessage_filing_date(1),Main_Fields.InvalidMessage_filing_date(2),Main_Fields.InvalidMessage_filing_date(3)
          ,Main_Fields.InvalidMessage_filing_time(1)
          ,Main_Fields.InvalidMessage_vendor_entry_date(1),Main_Fields.InvalidMessage_vendor_entry_date(2),Main_Fields.InvalidMessage_vendor_entry_date(3)
          ,Main_Fields.InvalidMessage_release_date(1),Main_Fields.InvalidMessage_release_date(2),Main_Fields.InvalidMessage_release_date(3)
          ,Main_Fields.InvalidMessage_eviction(1)
          ,Main_Fields.InvalidMessage_judg_satisfied_date(1),Main_Fields.InvalidMessage_judg_satisfied_date(2),Main_Fields.InvalidMessage_judg_satisfied_date(3)
          ,Main_Fields.InvalidMessage_judg_vacated_date(1),Main_Fields.InvalidMessage_judg_vacated_date(2),Main_Fields.InvalidMessage_judg_vacated_date(3)
          ,Main_Fields.InvalidMessage_effective_date(1),Main_Fields.InvalidMessage_effective_date(2),Main_Fields.InvalidMessage_effective_date(3)
          ,Main_Fields.InvalidMessage_lapse_date(1),Main_Fields.InvalidMessage_lapse_date(2),Main_Fields.InvalidMessage_lapse_date(3)
          ,Main_Fields.InvalidMessage_accident_date(1),Main_Fields.InvalidMessage_accident_date(2),Main_Fields.InvalidMessage_accident_date(3)
          ,Main_Fields.InvalidMessage_expiration_date(1),Main_Fields.InvalidMessage_expiration_date(2),Main_Fields.InvalidMessage_expiration_date(3)
          ,Main_Fields.InvalidMessage_agency_city(1),Main_Fields.InvalidMessage_agency_city(2)
          ,Main_Fields.InvalidMessage_agency_state(1),Main_Fields.InvalidMessage_agency_state(2),'UNKNOWN');
