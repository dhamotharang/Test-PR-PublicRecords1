...
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(Party_Layout_LiensV2)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Party_Layout_LiensV2)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Party_Layout_LiensV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.orig_full_debtorname_Invalid := Party_Fields.InValid_orig_full_debtorname((SALT33.StrType)le.orig_full_debtorname);
    SELF.orig_name_Invalid := Party_Fields.InValid_orig_name((SALT33.StrType)le.orig_name);
    SELF.orig_lname_Invalid := Party_Fields.InValid_orig_lname((SALT33.StrType)le.orig_lname);
    SELF.orig_suffix_Invalid := Party_Fields.InValid_orig_suffix((SALT33.StrType)le.orig_suffix);
    SELF.tax_id_Invalid := Party_Fields.InValid_tax_id((SALT33.StrType)le.tax_id);
    SELF.ssn_Invalid := Party_Fields.InValid_ssn((SALT33.StrType)le.ssn);
    SELF.name_suffix_Invalid := Party_Fields.InValid_name_suffix((SALT33.StrType)le.name_suffix);
    SELF.orig_address1_Invalid := Party_Fields.InValid_orig_address1((SALT33.StrType)le.orig_address1);
    SELF.orig_address2_Invalid := Party_Fields.InValid_orig_address2((SALT33.StrType)le.orig_address2);
    SELF.orig_city_Invalid := Party_Fields.InValid_orig_city((SALT33.StrType)le.orig_city);
    SELF.orig_state_Invalid := Party_Fields.InValid_orig_state((SALT33.StrType)le.orig_state);
    SELF.orig_zip5_Invalid := Party_Fields.InValid_orig_zip5((SALT33.StrType)le.orig_zip5);
    SELF.orig_county_Invalid := Party_Fields.InValid_orig_county((SALT33.StrType)le.orig_county);
    SELF.orig_country_Invalid := Party_Fields.InValid_orig_country((SALT33.StrType)le.orig_country);
    SELF.date_first_seen_Invalid := Party_Fields.InValid_date_first_seen((SALT33.StrType)le.date_first_seen);
    SELF.date_last_seen_Invalid := Party_Fields.InValid_date_last_seen((SALT33.StrType)le.date_last_seen);
    SELF.date_vendor_first_reported_Invalid := Party_Fields.InValid_date_vendor_first_reported((SALT33.StrType)le.date_vendor_first_reported);
    SELF.date_vendor_last_reported_Invalid := Party_Fields.InValid_date_vendor_last_reported((SALT33.StrType)le.date_vendor_last_reported);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Party_Layout_LiensV2);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Party_Layout_LiensV2);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Party_Fields.InvalidMessage_orig_full_debtorname(le.orig_full_debtorname_Invalid),Party_Fields.InvalidMessage_orig_name(le.orig_name_Invalid),Party_Fields.InvalidMessage_orig_lname(le.orig_lname_Invalid),Party_Fields.InvalidMessage_orig_suffix(le.orig_suffix_Invalid),Party_Fields.InvalidMessage_tax_id(le.tax_id_Invalid),Party_Fields.InvalidMessage_ssn(le.ssn_Invalid),Party_Fields.InvalidMessage_name_suffix(le.name_suffix_Invalid),Party_Fields.InvalidMessage_orig_address1(le.orig_address1_Invalid),Party_Fields.InvalidMessage_orig_address2(le.orig_address2_Invalid),Party_Fields.InvalidMessage_orig_city(le.orig_city_Invalid),Party_Fields.InvalidMessage_orig_state(le.orig_state_Invalid),Party_Fields.InvalidMessage_orig_zip5(le.orig_zip5_Invalid),Party_Fields.InvalidMessage_orig_county(le.orig_county_Invalid),Party_Fields.InvalidMessage_orig_country(le.orig_country_Invalid),Party_Fields.InvalidMessage_date_first_seen(le.date_first_seen_Invalid),Party_Fields.InvalidMessage_date_last_seen(le.date_last_seen_Invalid),Party_Fields.InvalidMessage_date_vendor_first_reported(le.date_vendor_first_reported_Invalid),Party_Fields.InvalidMessage_date_vendor_last_reported(le.date_vendor_last_reported_Invalid),'UNKNOWN'));
    ...
    SELF.FieldContents := CHOOSE(c,(SALT33.StrType)le.orig_full_debtorname,(SALT33.StrType)le.orig_name,(SALT33.StrType)le.orig_lname,(SALT33.StrType)le.orig_suffix,(SALT33.StrType)le.tax_id,(SALT33.StrType)le.ssn,(SALT33.StrType)le.name_suffix,(SALT33.StrType)le.orig_address1,(SALT33.StrType)le.orig_address2,(SALT33.StrType)le.orig_city,(SALT33.StrType)le.orig_state,(SALT33.StrType)le.orig_zip5,(SALT33.StrType)le.orig_county,(SALT33.StrType)le.orig_country,(SALT33.StrType)le.date_first_seen,(SALT33.StrType)le.date_last_seen,(SALT33.StrType)le.date_vendor_first_reported,(SALT33.StrType)le.date_vendor_last_reported,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT33.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Party_Fields.InvalidMessage_orig_full_debtorname(1)
          ,Party_Fields.InvalidMessage_orig_name(1)
          ,Party_Fields.InvalidMessage_orig_lname(1),Party_Fields.InvalidMessage_orig_lname(2)
          ,Party_Fields.InvalidMessage_orig_suffix(1)
          ,Party_Fields.InvalidMessage_tax_id(1)
          ,Party_Fields.InvalidMessage_ssn(1)
          ,Party_Fields.InvalidMessage_name_suffix(1)
          ,Party_Fields.InvalidMessage_orig_address1(1)
          ,Party_Fields.InvalidMessage_orig_address2(1)
          ,Party_Fields.InvalidMessage_orig_city(1)
          ,Party_Fields.InvalidMessage_orig_state(1)
          ,Party_Fields.InvalidMessage_orig_zip5(1),Party_Fields.InvalidMessage_orig_zip5(2),Party_Fields.InvalidMessage_orig_zip5(3)
          ,Party_Fields.InvalidMessage_orig_county(1)
          ,Party_Fields.InvalidMessage_orig_country(1)
          ,Party_Fields.InvalidMessage_date_first_seen(1),Party_Fields.InvalidMessage_date_first_seen(2),Party_Fields.InvalidMessage_date_first_seen(3)
          ,Party_Fields.InvalidMessage_date_last_seen(1),Party_Fields.InvalidMessage_date_last_seen(2),Party_Fields.InvalidMessage_date_last_seen(3)
          ,Party_Fields.InvalidMessage_date_vendor_first_reported(1),Party_Fields.InvalidMessage_date_vendor_first_reported(2),Party_Fields.InvalidMessage_date_vendor_first_reported(3)
          ,Party_Fields.InvalidMessage_date_vendor_last_reported(1),Party_Fields.InvalidMessage_date_vendor_last_reported(2),Party_Fields.InvalidMessage_date_vendor_last_reported(3),'UNKNOWN');
