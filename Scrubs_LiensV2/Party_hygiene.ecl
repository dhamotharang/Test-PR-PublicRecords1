IMPORT ut,SALT33;
EXPORT Party_hygiene(dataset(Party_layout_LiensV2) h) := MODULE
...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_orig_full_debtorname := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_full_debtorname)));
    avelength_orig_full_debtorname := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_full_debtorname)),h.orig_full_debtorname<>(typeof(h.orig_full_debtorname))'');
    ...
    maxlength_orig_suffix := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_suffix)));
    avelength_orig_suffix := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_suffix)),h.orig_suffix<>(typeof(h.orig_suffix))'');
    ...
    maxlength_orig_address1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_address1)));
    avelength_orig_address1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_address1)),h.orig_address1<>(typeof(h.orig_address1))'');
    populated_orig_address2_pcnt := AVE(GROUP,IF(h.orig_address2 = (TYPEOF(h.orig_address2))'',0,100));
    maxlength_orig_address2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_address2)));
    avelength_orig_address2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_address2)),h.orig_address2<>(typeof(h.orig_address2))'');
    ...
    maxlength_orig_country := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_country)));
    avelength_orig_country := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.orig_country)),h.orig_country<>(typeof(h.orig_country))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.tmsid),TRIM((SALT33.StrType)le.rmsid),TRIM((SALT33.StrType)le.orig_rmsid),TRIM((SALT33.StrType)le.orig_full_debtorname),TRIM((SALT33.StrType)le.orig_name),TRIM((SALT33.StrType)le.orig_lname),TRIM((SALT33.StrType)le.orig_fname),TRIM((SALT33.StrType)le.orig_mname),TRIM((SALT33.StrType)le.orig_suffix),TRIM((SALT33.StrType)le.tax_id),TRIM((SALT33.StrType)le.ssn),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.orig_address1),TRIM((SALT33.StrType)le.orig_address2),TRIM((SALT33.StrType)le.orig_city),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.orig_zip5),TRIM((SALT33.StrType)le.orig_zip4),TRIM((SALT33.StrType)le.orig_county),TRIM((SALT33.StrType)le.orig_country),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dbpc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.rec_type),TRIM((SALT33.StrType)le.county),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.msa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.err_stat),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.name_type),TRIM((SALT33.StrType)le.did),TRIM((SALT33.StrType)le.bdid),TRIM((SALT33.StrType)le.date_first_seen),TRIM((SALT33.StrType)le.date_last_seen),TRIM((SALT33.StrType)le.date_vendor_first_reported),TRIM((SALT33.StrType)le.date_vendor_last_reported),TRIM((SALT33.StrType)le.persistent_record_id),TRIM((SALT33.StrType)le.source_file)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 62);
  SELF.FldNo2 := 1 + (C % 62);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.tmsid),TRIM((SALT33.StrType)le.rmsid),TRIM((SALT33.StrType)le.orig_rmsid),TRIM((SALT33.StrType)le.orig_full_debtorname),TRIM((SALT33.StrType)le.orig_name),TRIM((SALT33.StrType)le.orig_lname),TRIM((SALT33.StrType)le.orig_fname),TRIM((SALT33.StrType)le.orig_mname),TRIM((SALT33.StrType)le.orig_suffix),TRIM((SALT33.StrType)le.tax_id),TRIM((SALT33.StrType)le.ssn),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.orig_address1),TRIM((SALT33.StrType)le.orig_address2),TRIM((SALT33.StrType)le.orig_city),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.orig_zip5),TRIM((SALT33.StrType)le.orig_zip4),TRIM((SALT33.StrType)le.orig_county),TRIM((SALT33.StrType)le.orig_country),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dbpc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.rec_type),TRIM((SALT33.StrType)le.county),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.msa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.err_stat),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.name_type),TRIM((SALT33.StrType)le.did),TRIM((SALT33.StrType)le.bdid),TRIM((SALT33.StrType)le.date_first_seen),TRIM((SALT33.StrType)le.date_last_seen),TRIM((SALT33.StrType)le.date_vendor_first_reported),TRIM((SALT33.StrType)le.date_vendor_last_reported),TRIM((SALT33.StrType)le.persistent_record_id),TRIM((SALT33.StrType)le.source_file)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.tmsid),TRIM((SALT33.StrType)le.rmsid),TRIM((SALT33.StrType)le.orig_rmsid),TRIM((SALT33.StrType)le.orig_full_debtorname),TRIM((SALT33.StrType)le.orig_name),TRIM((SALT33.StrType)le.orig_lname),TRIM((SALT33.StrType)le.orig_fname),TRIM((SALT33.StrType)le.orig_mname),TRIM((SALT33.StrType)le.orig_suffix),TRIM((SALT33.StrType)le.tax_id),TRIM((SALT33.StrType)le.ssn),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.orig_address1),TRIM((SALT33.StrType)le.orig_address2),TRIM((SALT33.StrType)le.orig_city),TRIM((SALT33.StrType)le.orig_state),TRIM((SALT33.StrType)le.orig_zip5),TRIM((SALT33.StrType)le.orig_zip4),TRIM((SALT33.StrType)le.orig_county),TRIM((SALT33.StrType)le.orig_country),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dbpc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.rec_type),TRIM((SALT33.StrType)le.county),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.msa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.err_stat),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.name_type),TRIM((SALT33.StrType)le.did),TRIM((SALT33.StrType)le.bdid),TRIM((SALT33.StrType)le.date_first_seen),TRIM((SALT33.StrType)le.date_last_seen),TRIM((SALT33.StrType)le.date_vendor_first_reported),TRIM((SALT33.StrType)le.date_vendor_last_reported),TRIM((SALT33.StrType)le.persistent_record_id),TRIM((SALT33.StrType)le.source_file)));
  END;
...
SHARED FldIds := DATASET([{1,'tmsid'}
      ...
      ,{62,'source_file'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Party_Fields.InValid_tmsid((SALT33.StrType)le.tmsid),
    Party_Fields.InValid_rmsid((SALT33.StrType)le.rmsid),
    Party_Fields.InValid_orig_rmsid((SALT33.StrType)le.orig_rmsid),
    Party_Fields.InValid_orig_full_debtorname((SALT33.StrType)le.orig_full_debtorname),
    Party_Fields.InValid_orig_name((SALT33.StrType)le.orig_name),
    Party_Fields.InValid_orig_lname((SALT33.StrType)le.orig_lname),
    Party_Fields.InValid_orig_fname((SALT33.StrType)le.orig_fname),
    Party_Fields.InValid_orig_mname((SALT33.StrType)le.orig_mname),
    Party_Fields.InValid_orig_suffix((SALT33.StrType)le.orig_suffix),
    Party_Fields.InValid_tax_id((SALT33.StrType)le.tax_id),
    Party_Fields.InValid_ssn((SALT33.StrType)le.ssn),
    ...
    Party_Fields.InValid_orig_address1((SALT33.StrType)le.orig_address1),
    Party_Fields.InValid_orig_address2((SALT33.StrType)le.orig_address2),
    Party_Fields.InValid_orig_city((SALT33.StrType)le.orig_city),
    Party_Fields.InValid_orig_state((SALT33.StrType)le.orig_state),
    Party_Fields.InValid_orig_zip5((SALT33.StrType)le.orig_zip5),
    Party_Fields.InValid_orig_zip4((SALT33.StrType)le.orig_zip4),
    Party_Fields.InValid_orig_county((SALT33.StrType)le.orig_county),
    Party_Fields.InValid_orig_country((SALT33.StrType)le.orig_country),
    ...
    Party_Fields.InValid_zip((SALT33.StrType)le.zip),
    ...
    Party_Fields.InValid_dbpc((SALT33.StrType)le.dbpc),
    Party_Fields.InValid_chk_digit((SALT33.StrType)le.chk_digit),
    Party_Fields.InValid_rec_type((SALT33.StrType)le.rec_type),
    Party_Fields.InValid_county((SALT33.StrType)le.county),
    Party_Fields.InValid_geo_lat((SALT33.StrType)le.geo_lat),
    Party_Fields.InValid_geo_long((SALT33.StrType)le.geo_long),
    Party_Fields.InValid_msa((SALT33.StrType)le.msa),
    ...
    Party_Fields.InValid_phone((SALT33.StrType)le.phone),
    Party_Fields.InValid_name_type((SALT33.StrType)le.name_type),
    Party_Fields.InValid_did((SALT33.StrType)le.did),
    Party_Fields.InValid_bdid((SALT33.StrType)le.bdid),
    Party_Fields.InValid_date_first_seen((SALT33.StrType)le.date_first_seen),
    Party_Fields.InValid_date_last_seen((SALT33.StrType)le.date_last_seen),
    Party_Fields.InValid_date_vendor_first_reported((SALT33.StrType)le.date_vendor_first_reported),
    Party_Fields.InValid_date_vendor_last_reported((SALT33.StrType)le.date_vendor_last_reported),
    Party_Fields.InValid_persistent_record_id((SALT33.StrType)le.persistent_record_id),
    Party_Fields.InValid_source_file((SALT33.StrType)le.source_file),
    0);
...
PrettyErrorTotals := RECORD
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Party_Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),Party_Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_rmsid(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_full_debtorname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_name(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_suffix(TotalErrors.ErrorNum),Party_Fields.InValidMessage_tax_id(TotalErrors.ErrorNum),Party_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Party_Fields.InValidMessage_title(TotalErrors.ErrorNum),Party_Fields.InValidMessage_fname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_mname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_lname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),Party_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),Party_Fields.InValidMessage_cname(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_address1(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_address2(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_state(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_zip5(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_county(TotalErrors.ErrorNum),Party_Fields.InValidMessage_orig_country(TotalErrors.ErrorNum),Party_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Party_Fields.InValidMessage_predir(TotalErrors.ErrorNum),Party_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Party_Fields.InValidMessage_addr_suffix(TotalErrors.ErrorNum),Party_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Party_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),Party_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Party_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Party_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),Party_Fields.InValidMessage_st(TotalErrors.ErrorNum),Party_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Party_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Party_Fields.InValidMessage_cart(TotalErrors.ErrorNum),Party_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),Party_Fields.InValidMessage_lot(TotalErrors.ErrorNum),Party_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),Party_Fields.InValidMessage_dbpc(TotalErrors.ErrorNum),Party_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),Party_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),Party_Fields.InValidMessage_county(TotalErrors.ErrorNum),Party_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),Party_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),Party_Fields.InValidMessage_msa(TotalErrors.ErrorNum),Party_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),Party_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),Party_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),Party_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Party_Fields.InValidMessage_name_type(TotalErrors.ErrorNum),Party_Fields.InValidMessage_did(TotalErrors.ErrorNum),Party_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),Party_Fields.InValidMessage_date_first_seen(TotalErrors.ErrorNum),Party_Fields.InValidMessage_date_last_seen(TotalErrors.ErrorNum),Party_Fields.InValidMessage_date_vendor_first_reported(TotalErrors.ErrorNum),Party_Fields.InValidMessage_date_vendor_last_reported(TotalErrors.ErrorNum),Party_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum),Party_Fields.InValidMessage_source_file(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
