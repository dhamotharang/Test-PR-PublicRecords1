...
EXPORT Batch_Records( DATASET(Inquiry_Services.Layouts.Batch_Input_Processed) ds_BatchIn,
		...
		ds_from_linkidsUpd := PROJECT(Inquiry_AccLogs.Key_Inquiry_LinkIds_Update.kFetch2(ds_linkIds,inMod.BIPFetchLevel,,Inquiry_Services.Constants.INQUIRY_LIMIT),
																								TRANSFORM(Inquiry_Services.Layouts.Batch_Raw_Linkid, 
