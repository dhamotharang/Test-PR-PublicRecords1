...
RELATIONSHIP:COLOCATE:BASIS(PRIM_NAME:PRIM_RANGE:CITY:STATE:?:SEC_RANGE):SPLIT(8):SCORE(company_name:fein):DEDUP(PRIM_RANGE):
RELATIONSHIP:COFEIN:BASIS(fein):SCORE(company_name):DEDUP(fein):
RELATIONSHIP:ASSOC:COLOCATE:COFEIN:
