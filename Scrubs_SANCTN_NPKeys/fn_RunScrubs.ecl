...
return sequential(
    ...
    scrubs.ScrubsPlus('SANCTN_NPKeys','Scrubs_SANCTN_NPKeys','Scrubs_SANCTN_NPKeys_party_aka_dba','party_aka_dba','20200205_TEST_C','',false),
    ...
    //crubs.ScrubsPlus('SANCTN_NPKeys','Scrubs_SANCTN_NPKeys','Scrubs_SANCTN_NPKeys_party_bip','party_bip',pVersion,emailList,false)
);
