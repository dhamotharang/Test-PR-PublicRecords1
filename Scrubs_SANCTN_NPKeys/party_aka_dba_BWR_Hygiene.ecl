...
#workunit('name','Scrubs_SANCTN_NPKeys.party_aka_dba_BWR_Hygiene - Hygiene & Stats - SALT V3.3.2');
...
// First create an instantiated hygiene module
  ...
  //  OUTPUT(SALT33.MAC_CrossTab(infile,dbcode,name_type,Examples),NAMED('name_typeBydbcode'));
  //  OUTPUT(SALT33.MAC_CrossTab(infile,dbcode,first_name,Examples),NAMED('first_nameBydbcode'));
  //  OUTPUT(SALT33.MAC_CrossTab(infile,dbcode,middle_name,Examples),NAMED('middle_nameBydbcode'));
  //  OUTPUT(SALT33.MAC_CrossTab(infile,dbcode,last_name,Examples),NAMED('last_nameBydbcode'));
  //  OUTPUT(SALT33.MAC_CrossTab(infile,dbcode,aka_dba_text,Examples),NAMED('aka_dba_textBydbcode'));
