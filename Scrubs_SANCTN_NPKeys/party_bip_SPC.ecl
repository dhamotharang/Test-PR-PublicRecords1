...
FIELDTYPE:Invalid_Suffix:ENUM(JR|SR|JR.|SR.|1|2|3|I|II|III|IV|V|VI|VII|VIII|IX|X|)
...
FIELD:sanctions:LIKE(Invalid_Char):TYPE(STRING):0,0
FIELD:additional_info:TYPE(STRING):0,0
FIELD:party_firm:TYPE(STRING150):0,0
FIELD:tin:LIKE(Invalid_Num):TYPE(STRING10):0,0
FIELD:name_first:TYPE(STRING50):0,0
FIELD:name_last:TYPE(STRING50):0,0
FIELD:name_middle:TYPE(STRING50):0,0
FIELD:suffix:LIKE(Invalid_Suffix):TYPE(STRING10):0,0
FIELD:nickname:TYPE(STRING20):0,0
FIELD:party_position:TYPE(STRING45):0,0
FIELD:party_employer:TYPE(STRING150):0,0
FIELD:ssn:LIKE(Invalid_Num):TYPE(STRING9):0,0
FIELD:dob:LIKE(Invalid_CurrentDate):TYPE(STRING8):0,0
FIELD:address:TYPE(STRING45):0,0
FIELD:city:TYPE(STRING45):0,0
FIELD:state:LIKE(Invalid_State):TYPE(STRING2):0,0
FIELD:zip:LIKE(Invalid_Zip):TYPE(STRING9):0,0
...
FIELD:phone:LIKE(Invalid_Num):TYPE(STRING20):0,0
FIELD:akaname:TYPE(STRING500):0,0
FIELD:dbaname:TYPE(STRING500):0,0
...
FIELD:enh_did_src:LIKE(Invalid_Enh_Did_Src):TYPE(STRING1):0,0
...
FIELD:ename:TYPE(STRING150):0,0
