...
#workunit('name','Scrubs_SANCTN_NPKeys.incident_text_BWR_Hygiene - Hygiene & Stats - SALT V3.3.2');
IMPORT Scrubs_SANCTN_NPKeys,SALT33;
// First create an instantiated hygiene module
  infile := Scrubs_SANCTN_NPKeys.incident_text_In_SANCTN_NPKeys;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_SANCTN_NPKeys.incident_text_Hygiene(ip);
