...
#workunit('name','Scrubs_SANCTN_NPKeys.party_aka_dba_BWR_Scrubs - Checking field validity in a file - SALT V3.11.9');
IMPORT Scrubs_SANCTN_NPKeys,SALT311;
infile := Scrubs_SANCTN_NPKeys.party_aka_dba_In_SANCTN_NPKeys;
mod_scrubs := Scrubs_SANCTN_NPKeys.party_aka_dba_Scrubs;
