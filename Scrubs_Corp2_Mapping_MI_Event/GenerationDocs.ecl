...
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_MI_Event
FILENAME:In_MI
...
//NINES:<Precision required 3 = 99.9, 2 = 99 3.791791e+255tc>
...
FIELDTYPE:invalid_event_date_type_cd:ALLOW(FIL)
FIELDTYPE:invalid_event_date_type_desc:ALLOW(FGILN)
