...
/*--INFO-- Attempt to resolve or find proxids.<p>Input fields are cleaned according to the standard hygiene requirements of this file.</p>
...
EXPORT MEOW_Biz_Service := MACRO
  ...
  DATASET(BizLinkFull_HS.process_Biz_layouts.layout_zip_cases) Input_zip := DATASET([],BizLinkFull_HS.process_Biz_layouts.layout_zip_cases)  : STORED('zip_cases');
  ...
  Template := DATASET([],BizLinkFull_HS.Process_Biz_Layouts.InputLayout);
  ...
  ,(TYPEOF(Template.company_name))BizLinkFull_HS.Fields.Make_company_name((SALT33.StrType)Input_company_name)
  ,(TYPEOF(Template.company_name_prefix))BizLinkFull_HS.Fields.Make_company_name_prefix((SALT33.StrType)Input_company_name_prefix)
  ,(TYPEOF(Template.cnp_name))BizLinkFull_HS.Fields.Make_cnp_name((SALT33.StrType)Input_cnp_name)
  ...
  ,IF ( BizLinkFull_HS.Fields.Invalid_company_fein((SALT33.StrType)Input_company_fein)=0,(TYPEOF(Template.company_fein))Input_company_fein,(TYPEOF(Template.company_fein))'')
  ...
  ,(TYPEOF(Template.prim_name))BizLinkFull_HS.Fields.Make_prim_name((SALT33.StrType)Input_prim_name)
  ,(TYPEOF(Template.sec_range))BizLinkFull_HS.Fields.Make_sec_range((SALT33.StrType)Input_sec_range)
  ,(TYPEOF(Template.city))BizLinkFull_HS.Fields.Make_city((SALT33.StrType)Input_city)
  ,(TYPEOF(Template.city_clean))BizLinkFull_HS.Fields.Make_city_clean((SALT33.StrType)Input_city_clean)
  ,(TYPEOF(Template.st))BizLinkFull_HS.Fields.Make_st((SALT33.StrType)Input_st)
  ,Input_zip
  ,(TYPEOF(Template.company_url))BizLinkFull_HS.Fields.Make_company_url((SALT33.StrType)Input_company_url)
  ,(TYPEOF(Template.isContact))Input_isContact
  ,(TYPEOF(Template.contact_did))Input_contact_did
  ,(TYPEOF(Template.title))Input_title
  ,(TYPEOF(Template.fname))BizLinkFull_HS.Fields.Make_fname((SALT33.StrType)Input_fname)
  ,(TYPEOF(Template.fname_preferred))BizLinkFull_HS.Fields.Make_fname_preferred((SALT33.StrType)Input_fname_preferred)
  ,(TYPEOF(Template.mname))BizLinkFull_HS.Fields.Make_mname((SALT33.StrType)Input_mname)
  ,(TYPEOF(Template.lname))BizLinkFull_HS.Fields.Make_lname((SALT33.StrType)Input_lname)
  ,(TYPEOF(Template.name_suffix))BizLinkFull_HS.Fields.Make_name_suffix((SALT33.StrType)Input_name_suffix)
  ,(TYPEOF(Template.contact_ssn))Input_contact_ssn
  ,(TYPEOF(Template.contact_email))BizLinkFull_HS.Fields.Make_contact_email((SALT33.StrType)Input_contact_email)
  ...
  ,false,false,0,0,0,0,0,0}],BizLinkFull_HS.Process_Biz_Layouts.InputLayout);
 
  pm := BizLinkFull_HS.MEOW_Biz(Input_Data); // This module performs regular xproxid functions
