EXPORT matchCodes := module
    ...
    EXPORT STRING online_MatchCode(onlineMatchLayout rec, BizLinkFull_HS.lBatchInput dsInput) := 
    ...
    EXPORT batch_MatchCode(BizLinkFull_HS.Process_Biz_Layouts.LayoutScoredFetch rec) := 
