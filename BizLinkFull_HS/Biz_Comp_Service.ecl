...
// Options to override the data-bomb fetch
  ...
  ,(typeof(Template.company_name))BizLinkFull_HS.Fields.Make_company_name((SALT26.StrType)Input_company_name)
  ,(typeof(Template.cnp_name))BizLinkFull_HS.Fields.Make_cnp_name((SALT26.StrType)Input_cnp_name)
  ...
  ,(typeof(Template.company_fein))BizLinkFull_HS.Fields.Make_company_fein((SALT26.StrType)Input_company_fein)
  ,(typeof(Template.company_sic_code1))Input_company_sic_code1
  ,(typeof(Template.prim_range))Input_prim_range
  ,(typeof(Template.prim_name))BizLinkFull_HS.Fields.Make_prim_name((SALT26.StrType)Input_prim_name)
  ,(typeof(Template.sec_range))BizLinkFull_HS.Fields.Make_sec_range((SALT26.StrType)Input_sec_range)
  ,(typeof(Template.p_city_name))BizLinkFull_HS.Fields.Make_p_city_name((SALT26.StrType)Input_p_city_name)
  ,(typeof(Template.st))BizLinkFull_HS.Fields.Make_st((SALT26.StrType)Input_st)
  ,Input_zip
  ,(typeof(Template.company_url))BizLinkFull_HS.Fields.Make_company_url((SALT26.StrType)Input_company_url)
  ,(typeof(Template.isContact))Input_isContact
  ,(typeof(Template.title))Input_title
  ,(typeof(Template.fname))BizLinkFull_HS.Fields.Make_fname((SALT26.StrType)Input_fname)
  ,(typeof(Template.mname))BizLinkFull_HS.Fields.Make_mname((SALT26.StrType)Input_mname)
  ,(typeof(Template.lname))BizLinkFull_HS.Fields.Make_lname((SALT26.StrType)Input_lname)
  ,(typeof(Template.name_suffix))BizLinkFull_HS.Fields.Make_name_suffix((SALT26.StrType)Input_name_suffix)
  ...
  ,false,false,e_rcid,e_proxid,e_seleid,e_orgid,e_ultid}],BizLinkFull_HS.Process_Biz_Layouts.InputLayout);
  pm := BizLinkFull_HS.MEOW_Biz(Input_Data); // This module performs regular xproxid functions
  Options := MODULE(BizLinkFull_HS.Externals.FetchParams) // Interface to pass parameters to fetch
    EXPORT SET OF INTEGER2 ToFetch := [];
  END;
  e := BizLinkFull_HS.Externals.Fetch(pm.Uid_Results,Options); // Perform data-bomb fetch
