...
EXPORT KeyName := BizLinkFull_HS.Filename_keys.L_PHONE; /*HACK07*/
...
EXPORT ScoredproxidFetch(TYPEOF(h.company_phone_7) param_company_phone_7 = (TYPEOF(h.company_phone_7))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.company_phone_3) param_company_phone_3 = (TYPEOF(h.company_phone_3))'',TYPEOF(h.company_phone_3_ex) param_company_phone_3_ex = (TYPEOF(h.company_phone_3_ex))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(process_Biz_layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.company_phone_7_match_code := MAP(le.company_phone_7 = (TYPEOF(le.company_phone_7))'' OR le.company_phone_7 = (TYPEOF(le.company_phone_7))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_7(le.company_phone_7,param_company_phone_7,TRUE));
    ...
    SELF.company_phone_3_match_code := MAP(le.company_phone_3 = (TYPEOF(le.company_phone_3))'' OR param_company_phone_3 = (TYPEOF(param_company_phone_3))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_3(le.company_phone_3,param_company_phone_3,FALSE));
    ...
    SELF.company_phone_3_ex_match_code := MAP(le.company_phone_3_ex = (TYPEOF(le.company_phone_3_ex))'' OR param_company_phone_3_ex = (TYPEOF(param_company_phone_3_ex))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_3_ex(le.company_phone_3_ex,param_company_phone_3_ex,FALSE));
...
EXPORT ScoredFetch_Batch(DATASET(InputLayout_Batch) recs,BOOLEAN AsIndex) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score_Batch(Key le,recs ri) := TRANSFORM
    ...
    SELF.company_phone_7_match_code := MAP(le.company_phone_7 = (TYPEOF(le.company_phone_7))'' OR le.company_phone_7 = (TYPEOF(le.company_phone_7))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_7(le.company_phone_7,ri.company_phone_7,TRUE));
    ...
    SELF.company_phone_3_match_code := MAP(le.company_phone_3 = (TYPEOF(le.company_phone_3))'' OR ri.company_phone_3 = (TYPEOF(ri.company_phone_3))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_3(le.company_phone_3,ri.company_phone_3,FALSE));
    SELF.company_phone_3Weight := (50+MAP ( le.company_phone_3 = (TYPEOF(le.company_phone_3))'' OR ri.company_phone_3 = (TYPEOF(ri.company_phone_3))'' => 0,
           ...
           -0.952*le.company_phone_3_weight100))/100; 
    SELF.company_phone_3_ex_match_code := MAP(le.company_phone_3_ex = (TYPEOF(le.company_phone_3_ex))'' OR ri.company_phone_3_ex = (TYPEOF(ri.company_phone_3_ex))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_company_phone_3_ex(le.company_phone_3_ex,ri.company_phone_3_ex,FALSE));
...
#IF(#TEXT(Input_company_phone_7)<>'')
  #uniquename(trans)
  BizLinkFull_HS.Key_BizHead_L_PHONE.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := BizLinkFull_HS.Key_BizHead_L_PHONE.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
