...
function
  ...
  Buildrefs_l_address1           := tools.macf_writeindex('Key_BizHead_L_ADDRESS1.Key      ,knames.refs_l_address1          .new'      );
  Buildrefs_l_address2           := tools.macf_writeindex('Key_BizHead_L_ADDRESS2.Key      ,knames.refs_l_address2          .new'      );
  Buildrefs_l_address3           := tools.macf_writeindex('Key_BizHead_L_ADDRESS3.Key      ,knames.refs_l_address3          .new'      );
  ...
  Buildrefs_l_email              := tools.macf_writeindex('Key_BizHead_L_EMAIL.Key         ,knames.refs_l_email             .new'      );
  Buildrefs_l_contact_did        := tools.macf_writeindex('Key_BizHead_L_CONTACT_DID.Key   ,knames.refs_l_contact_did       .new'      );
  Buildrefs_l_contact_ssn        := tools.macf_writeindex('Key_BizHead_L_CONTACT_SSN.Key   ,knames.refs_l_contact_ssn       .new'      );
  Buildrefs_l_source             := tools.macf_writeindex('Key_BizHead_L_SOURCE.Key        ,knames.refs_l_source            .new'      );
  ...
  returnresult := sequential(
     BizLinkFull_HS._dostrata_ID_Check(File_BizHead,pversion)
    ,BuildSpecs
