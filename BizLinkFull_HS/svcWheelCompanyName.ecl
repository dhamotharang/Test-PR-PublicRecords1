...
*/
IMPORT SALT26,BizLinkFull_HS, iesp;
EXPORT svcWheelCompanyName() := FUNCTION
    ...
    results := BizLinkFull_HS.Wheel.Fetch_company_name(SALT26.StringToUppercase(Input_prefix), min(StartingRecord + ReturnCount,MaxResults));
