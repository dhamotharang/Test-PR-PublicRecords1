...
EXPORT KeyName_city_clean := BizLinkFull_HS.Filename_keys.Wheel_city_clean; /*HACK07Wheel_city_clean*/
...
EXPORT KeyNameQuick_city_clean := BizLinkFull_HS.Filename_keys.Wheel_Quick_city_clean; /*HACK07Wheel_Quick_city_clean*/
