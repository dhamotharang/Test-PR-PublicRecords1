...
EXPORT KeyName := BizLinkFull_HS.Filename_keys.L_CONTACT_SSN; /*HACK07*/
...
EXPORT ScoredproxidFetch(TYPEOF(h.contact_ssn) param_contact_ssn = (TYPEOF(h.contact_ssn))'',TYPEOF(h.contact_email) param_contact_email = (TYPEOF(h.contact_email))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',DATASET(process_Biz_layouts.layout_zip_cases) param_zip,TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.contact_ssn_match_code := MAP(le.contact_ssn = (TYPEOF(le.contact_ssn))'' OR le.contact_ssn = (TYPEOF(le.contact_ssn))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_contact_ssn(le.contact_ssn,param_contact_ssn,TRUE));
    ...
    SELF.contact_email_match_code := MAP(le.contact_email = (TYPEOF(le.contact_email))'' OR param_contact_email = (TYPEOF(param_contact_email))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_contact_email(le.contact_email,param_contact_email,FALSE));
...
EXPORT ScoredFetch_Batch(DATASET(InputLayout_Batch) recs,BOOLEAN AsIndex) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score_Batch(Key le,recs ri) := TRANSFORM
    ...
    SELF.contact_ssn_match_code := MAP(le.contact_ssn = (TYPEOF(le.contact_ssn))'' OR le.contact_ssn = (TYPEOF(le.contact_ssn))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_contact_ssn(le.contact_ssn,ri.contact_ssn,TRUE));
    SELF.contact_ssnWeight := (50+MAP ( le.contact_ssn = ri.contact_ssn  => le.contact_ssn_weight100,
          ...
          -0.866*le.contact_ssn_weight100))/100; 
    SELF.contact_email_match_code := MAP(le.contact_email = (TYPEOF(le.contact_email))'' OR ri.contact_email = (TYPEOF(ri.contact_email))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_contact_email(le.contact_email,ri.contact_email,FALSE));
...
#IF(#TEXT(Input_contact_ssn)<>'')
  #uniquename(trans)
  BizLinkFull_HS.Key_BizHead_L_CONTACT_SSN.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := BizLinkFull_HS.Key_BizHead_L_CONTACT_SSN.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
