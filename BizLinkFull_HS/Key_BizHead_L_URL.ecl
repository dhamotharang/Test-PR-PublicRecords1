...
EXPORT KeyName := BizLinkFull_HS.Filename_keys.L_URL; /*HACK07*/
...
#IF(#TEXT(Input_company_url)<>'')
  #uniquename(trans)
  BizLinkFull_HS.Key_BizHead_L_URL.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := BizLinkFull_HS.Key_BizHead_L_URL.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
