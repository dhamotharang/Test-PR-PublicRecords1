...
SALT33.mac_prop_field(with_props(cnp_btype NOT IN SET(s.nulls_cnp_btype,cnp_btype)),cnp_btype,proxid,cnp_btype_props); // For every DID find the best FULL cnp_btype
layout_withpropvars take_cnp_btype(with_props le,cnp_btype_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj13 := JOIN(with_props,cnp_btype_props,left.proxid=right.proxid,take_cnp_btype(left,right),LEFT OUTER,HASH,HINT(parallel_match));
 
SALT33.mac_prop_field(with_props(company_fein NOT IN SET(s.nulls_company_fein,company_fein)),company_fein,proxid,company_fein_props); // For every DID find the best FULL company_fein
layout_withpropvars take_company_fein(with_props le,company_fein_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj19 := JOIN(pj13,company_fein_props,left.proxid=right.proxid,take_company_fein(left,right),LEFT OUTER,HASH,HINT(parallel_match));
 
SALT33.mac_prop_field(with_props(company_sic_code1 NOT IN SET(s.nulls_company_sic_code1,company_sic_code1)),company_sic_code1,proxid,company_sic_code1_props); // For every DID find the best FULL company_sic_code1
layout_withpropvars take_company_sic_code1(with_props le,company_sic_code1_props ri) := TRANSFORM
  ...
  SELF := le;
  END;
SHARED pj20 := JOIN(pj19,company_sic_code1_props,left.proxid=right.proxid,take_company_sic_code1(left,right),LEFT OUTER,HASH,HINT(parallel_match));
...
pj20 do_computes(pj20 le) := TRANSFORM
  ...
  SELF := le;
END;
SHARED propogated := PROJECT(pj20,do_computes(left)) : PERSIST('~temp::proxid::BizLinkFull_HS::mc_props::BizHead',EXPIRE(Config_BIP.PersistExpire)); // to allow to 'jump' over an exported value
...
EXPORT PostPropogationStats := SALT33.MAC_Pivot(PoPS, poprec);
  Grpd := GROUP( DISTRIBUTE( TABLE( propogated, { propogated, UNSIGNED2 Buddies := 0 }),HASH(proxid)),parent_proxid,sele_proxid,org_proxid,ultimate_proxid,source,source_record_id,company_name,company_name_prefix,cnp_name,cnp_number,cnp_btype,cnp_lowv,company_phone_3,company_phone_3_ex,company_phone_7,company_fein,company_sic_code1,prim_range,prim_name,sec_range,city,city_clean,st,zip,company_url,isContact,contact_did,title,fname,fname_preferred,mname,lname,name_suffix,contact_ssn,contact_email,sele_flag,org_flag,ult_flag,fallback_value);
...
layout_candidates add_fallback_value(layout_candidates le,Specificities(ih).fallback_value_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j40 := JOIN(h1,PULL(Specificities(ih).fallback_value_values_persisted),LEFT.fallback_value=RIGHT.fallback_value,add_fallback_value(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
...
layout_candidates add_name_suffix(layout_candidates le,Specificities(ih).name_suffix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j31,s.nulls_name_suffix,Specificities(ih).name_suffix_values_persisted,name_suffix,name_suffix_weight100,add_name_suffix,j30);
layout_candidates add_fname(layout_candidates le,Specificities(ih).fname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j30,s.nulls_fname,Specificities(ih).fname_values_persisted,fname,fname_weight100,add_fname,j29);
layout_candidates add_mname(layout_candidates le,Specificities(ih).mname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j29,s.nulls_mname,Specificities(ih).mname_values_persisted,mname,mname_weight100,add_mname,j28);
layout_candidates add_fname_preferred(layout_candidates le,Specificities(ih).fname_preferred_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j28,s.nulls_fname_preferred,Specificities(ih).fname_preferred_values_persisted,fname_preferred,fname_preferred_weight100,add_fname_preferred,j27);
layout_candidates add_company_phone_3_ex(layout_candidates le,Specificities(ih).company_phone_3_ex_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j27,s.nulls_company_phone_3_ex,Specificities(ih).company_phone_3_ex_values_persisted,company_phone_3_ex,company_phone_3_ex_weight100,add_company_phone_3_ex,j26);
layout_candidates add_company_phone_3(layout_candidates le,Specificities(ih).company_phone_3_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j26,s.nulls_company_phone_3,Specificities(ih).company_phone_3_values_persisted,company_phone_3,company_phone_3_weight100,add_company_phone_3,j25);
layout_candidates add_lname(layout_candidates le,Specificities(ih).lname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j25,s.nulls_lname,Specificities(ih).lname_values_persisted,lname,lname_weight100,add_lname,j24);
layout_candidates add_company_sic_code1(layout_candidates le,Specificities(ih).company_sic_code1_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j24,s.nulls_company_sic_code1,Specificities(ih).company_sic_code1_values_persisted,company_sic_code1,company_sic_code1_weight100,add_company_sic_code1,j23);
layout_candidates add_city_clean(layout_candidates le,Specificities(ih).city_clean_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j23,s.nulls_city_clean,Specificities(ih).city_clean_values_persisted,city_clean,city_clean_weight100,add_city_clean,j22);
layout_candidates add_city(layout_candidates le,Specificities(ih).city_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j22,s.nulls_city,Specificities(ih).city_values_persisted,city,city_weight100,add_city,j21);
layout_candidates add_sec_range(layout_candidates le,Specificities(ih).sec_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j21,s.nulls_sec_range,Specificities(ih).sec_range_values_persisted,sec_range,sec_range_weight100,add_sec_range,j20);
layout_candidates add_prim_range(layout_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j20,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_prim_range,j19);
layout_candidates add_cnp_number(layout_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j19,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_cnp_number,j18);
layout_candidates add_zip(layout_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j18,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_zip,j17);
layout_candidates add_prim_name(layout_candidates le,Specificities(ih).prim_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j17,s.nulls_prim_name,Specificities(ih).prim_name_values_persisted,prim_name,prim_name_weight100,add_prim_name,j16);
layout_candidates add_company_name_prefix(layout_candidates le,Specificities(ih).company_name_prefix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j16,s.nulls_company_name_prefix,Specificities(ih).company_name_prefix_values_persisted,company_name_prefix,company_name_prefix_weight100,add_company_name_prefix,j15);
layout_candidates add_STREETADDRESS(layout_candidates le,Specificities(ih).STREETADDRESS_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j15,s.nulls_STREETADDRESS,Specificities(ih).STREETADDRESS_values_persisted,STREETADDRESS,STREETADDRESS_weight100,add_STREETADDRESS,j14);
layout_candidates add_CONTACTNAME(layout_candidates le,Specificities(ih).CONTACTNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j14,s.nulls_CONTACTNAME,Specificities(ih).CONTACTNAME_values_persisted,CONTACTNAME,CONTACTNAME_weight100,add_CONTACTNAME,j13);
layout_candidates add_company_phone_7(layout_candidates le,Specificities(ih).company_phone_7_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j13,s.nulls_company_phone_7,Specificities(ih).company_phone_7_values_persisted,company_phone_7,company_phone_7_weight100,add_company_phone_7,j12);
layout_candidates add_contact_did(layout_candidates le,Specificities(ih).contact_did_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j12,s.nulls_contact_did,Specificities(ih).contact_did_values_persisted,contact_did,contact_did_weight100,add_contact_did,j11);
layout_candidates add_company_fein(layout_candidates le,Specificities(ih).company_fein_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j11,s.nulls_company_fein,Specificities(ih).company_fein_values_persisted,company_fein,company_fein_weight100,add_company_fein,j10);
layout_candidates add_cnp_name(layout_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.cnp_name := IF( ri.field_specificity<>0 or ri.word<>'',SELF.cnp_name_weight100+' '+ri.word,SALT33.Fn_WordBag_AppendSpecs_Fake(le.cnp_name, s.cnp_name_specificity) );// Copy in annotated wordstring
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j10,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_cnp_name,j9);
layout_candidates add_company_name(layout_candidates le,Specificities(ih).company_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j9,s.nulls_company_name,Specificities(ih).company_name_values_persisted,company_name,company_name_weight100,add_company_name,j8);
layout_candidates add_contact_email(layout_candidates le,Specificities(ih).contact_email_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j8,s.nulls_contact_email,Specificities(ih).contact_email_values_persisted,contact_email,contact_email_weight100,add_contact_email,j7);
layout_candidates add_contact_ssn(layout_candidates le,Specificities(ih).contact_ssn_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j7,s.nulls_contact_ssn,Specificities(ih).contact_ssn_values_persisted,contact_ssn,contact_ssn_weight100,add_contact_ssn,j6);
layout_candidates add_company_url(layout_candidates le,Specificities(ih).company_url_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.company_url := IF( ri.field_specificity<>0 or ri.word<>'',SELF.company_url_weight100+' '+ri.word,SALT33.Fn_WordBag_AppendSpecs_Fake(le.company_url, s.company_url_specificity) );// Copy in annotated wordstring
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j6,s.nulls_company_url,Specificities(ih).company_url_values_persisted,company_url,company_url_weight100,add_company_url,j5);
layout_candidates add_source_record_id(layout_candidates le,Specificities(ih).source_record_id_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j5,s.nulls_source_record_id,Specificities(ih).source_record_id_values_persisted,source_record_id,source_record_id_weight100,add_source_record_id,j4);
layout_candidates add_ultimate_proxid(layout_candidates le,Specificities(ih).ultimate_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j4,s.nulls_ultimate_proxid,Specificities(ih).ultimate_proxid_values_persisted,ultimate_proxid,ultimate_proxid_weight100,add_ultimate_proxid,j3);
layout_candidates add_org_proxid(layout_candidates le,Specificities(ih).org_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j3,s.nulls_org_proxid,Specificities(ih).org_proxid_values_persisted,org_proxid,org_proxid_weight100,add_org_proxid,j2);
layout_candidates add_sele_proxid(layout_candidates le,Specificities(ih).sele_proxid_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j2,s.nulls_sele_proxid,Specificities(ih).sele_proxid_values_persisted,sele_proxid,sele_proxid_weight100,add_sele_proxid,j1);
