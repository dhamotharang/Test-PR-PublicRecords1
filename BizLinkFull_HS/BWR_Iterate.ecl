...
#workunit('name','BizLinkFull_HS.BWR_Iterate - Internal Linking - SALT V3.3.1');
...
P := BizLinkFull_HS.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT33.MAC_MatchSamplePatterns(BizLinkFull_HS.Keys(BizLinkFull_HS.In_BizHead).MatchSample,MatchPatterns,proxid1,proxid2,8,35-41);
...
// ConfThreshold:=38;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BizLinkFull_HS.Keys(BizLinkFull_HS.In_BizHead).MatchSample,BizLinkFull_HS.Keys(BizLinkFull_HS.In_BizHead).Candidates,BizLinkFull_HS.In_BizHead,proxid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
