...
EXPORT KeyName := BizLinkFull_HS.Filename_keys.L_CONTACT; /*HACK07*/
...
EXPORT ScoredproxidFetch(TYPEOF(h.fname_preferred) param_fname_preferred = (TYPEOF(h.fname_preferred))'',TYPEOF(h.lname) param_lname = (TYPEOF(h.lname))'',TYPEOF(h.mname) param_mname = (TYPEOF(h.mname))'',TYPEOF(h.cnp_name) param_cnp_name = (TYPEOF(h.cnp_name))'',DATASET(process_Biz_layouts.layout_zip_cases) param_zip,TYPEOF(h.st) param_st = (TYPEOF(h.st))'',TYPEOF(h.fname) param_fname = (TYPEOF(h.fname))'',TYPEOF(h.company_sic_code1) param_company_sic_code1 = (TYPEOF(h.company_sic_code1))'',TYPEOF(h.cnp_number) param_cnp_number = (TYPEOF(h.cnp_number))'',TYPEOF(h.cnp_btype) param_cnp_btype = (TYPEOF(h.cnp_btype))'',TYPEOF(h.cnp_lowv) param_cnp_lowv = (TYPEOF(h.cnp_lowv))'',TYPEOF(h.prim_name) param_prim_name = (TYPEOF(h.prim_name))'',TYPEOF(h.city) param_city = (TYPEOF(h.city))'',TYPEOF(h.prim_range) param_prim_range = (TYPEOF(h.prim_range))'',TYPEOF(h.sec_range) param_sec_range = (TYPEOF(h.sec_range))'',TYPEOF(h.parent_proxid) param_parent_proxid = (TYPEOF(h.parent_proxid))'',TYPEOF(h.sele_proxid) param_sele_proxid = (TYPEOF(h.sele_proxid))'',TYPEOF(h.org_proxid) param_org_proxid = (TYPEOF(h.org_proxid))'',TYPEOF(h.ultimate_proxid) param_ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',TYPEOF(h.sele_flag) param_sele_flag = (TYPEOF(h.sele_flag))'',TYPEOF(h.org_flag) param_org_flag = (TYPEOF(h.org_flag))'',TYPEOF(h.ult_flag) param_ult_flag = (TYPEOF(h.ult_flag))'',TYPEOF(h.fallback_value) param_fallback_value = (TYPEOF(h.fallback_value))'') := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score(RawData le) := TRANSFORM
    ...
    SELF.fname_preferred_match_code := MAP(le.fname_preferred = (TYPEOF(le.fname_preferred))'' OR le.fname_preferred = (TYPEOF(le.fname_preferred))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_fname_preferred(le.fname_preferred,param_fname_preferred,TRUE));
    ...
    SELF.lname_match_code := MAP(le.lname = (TYPEOF(le.lname))'' OR le.lname = (TYPEOF(le.lname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_lname(le.lname,param_lname,0,0,TRUE));
    ...
    SELF.mname_match_code := MAP(le.mname = (TYPEOF(le.mname))'' OR param_mname = (TYPEOF(param_mname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_mname(le.mname,param_mname,0,0,FALSE));
    ...
    SELF.fname_match_code := MAP(le.fname = (TYPEOF(le.fname))'' OR param_fname = (TYPEOF(param_fname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_fname(le.fname,param_fname,0,0,FALSE));
...
EXPORT ScoredFetch_Batch(DATASET(InputLayout_Batch) recs,BOOLEAN AsIndex) := FUNCTION
  ...
  Process_Biz_Layouts.LayoutScoredFetch Score_Batch(Key le,recs ri) := TRANSFORM
    ...
    SELF.fname_preferred_match_code := MAP(le.fname_preferred = (TYPEOF(le.fname_preferred))'' OR le.fname_preferred = (TYPEOF(le.fname_preferred))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_fname_preferred(le.fname_preferred,ri.fname_preferred,TRUE));
    SELF.fname_preferredWeight := (50+MAP ( le.fname_preferred = ri.fname_preferred  => le.fname_preferred_weight100,
          ...
          -0.562*le.fname_preferred_weight100))/100; 
    SELF.lname_match_code := MAP(le.lname = (TYPEOF(le.lname))'' OR le.lname = (TYPEOF(le.lname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_lname(le.lname,ri.lname,0,0,TRUE));
    SELF.lnameWeight := (50+MAP ( le.lname = ri.lname  => le.lname_weight100,
          le.lname = (TYPEOF(le.lname))'' OR ri.lname = (TYPEOF(le.lname))'' => 0,
          -0.651*le.lname_weight100))/100; 
    SELF.mname_match_code := MAP(le.mname = (TYPEOF(le.mname))'' OR ri.mname = (TYPEOF(ri.mname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_mname(le.mname,ri.mname,0,0,FALSE));
    ...
    SELF.stWeight := (50+MAP ( le.st = (TYPEOF(le.st))'' OR ri.st = (TYPEOF(ri.st))'' => 0,
           ...
           -1.000*le.st_weight100))/100; 
    SELF.fname_match_code := MAP(le.fname = (TYPEOF(le.fname))'' OR ri.fname = (TYPEOF(ri.fname))'' => SALT33.MatchCode.OneSideNull,match_methods(File_BizHead).match_fname(le.fname,ri.fname,0,0,FALSE));
...
#IF(#TEXT(Input_fname_preferred)<>'' AND #TEXT(Input_lname)<>'')
  #uniquename(trans)
  BizLinkFull_HS.Key_BizHead_L_CONTACT.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := BizLinkFull_HS.Key_BizHead_L_CONTACT.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
