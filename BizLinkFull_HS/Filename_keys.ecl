...
EXPORT Filename_Keys := module
  SHARED THISMODULE:='BizLinkFull_HS';
...
/*
//for testing
output(BizLinkFull_HS02.Key_BizHead_.Key);
output(BizLinkFull_HS02.Key_BizHead_.ValueKey);
output(BizLinkFull_HS02.Key_BizHead_L_ADDRESS1.key);
output(BizLinkFull_HS02.Key_BizHead_L_ADDRESS2.key);
output(BizLinkFull_HS02.Key_BizHead_L_ADDRESS3.key);
output(BizLinkFull_HS02.Key_BizHead_L_CNPNAME.key);
output(BizLinkFull_HS02.Key_BizHead_L_CNPNAME_FUZZY.key);
output(BizLinkFull_HS02.Key_BizHead_L_CNPNAME_ST.key);
output(BizLinkFull_HS02.Key_BizHead_L_CONTACT.key);
output(BizLinkFull_HS02.Key_BizHead_L_CONTACT_SSN.key);
output(BizLinkFull_HS02.Key_BizHead_L_EMAIL.key);
output(BizLinkFull_HS02.Key_BizHead_L_FEIN.key);
output(BizLinkFull_HS02.Key_BizHead_L_PHONE.key);
output(BizLinkFull_HS02.Key_BizHead_L_SIC.key);
output(BizLinkFull_HS02.Key_BizHead_L_SOURCE.key);
output(BizLinkFull_HS02.Key_BizHead_L_URL.key);
output(BizLinkFull_HS02.Process_Biz_Layouts.key);
output(BizLinkFull_HS02.Process_Biz_Layouts.KeyproxidUp);
output(BizLinkFull_HS02.Process_Biz_Layouts.KeyseleidUp);
output(BizLinkFull_HS02.Process_Biz_Layouts.KeyorgidUp);
output(BizLinkFull_HS02.specificities(DATASET([], BizLinkFull_HS02.layout_BizHead)).cnp_name_values_key);
output(BizLinkFull_HS02.specificities(DATASET([], BizLinkFull_HS02.layout_BizHead)).company_url_values_key);
output(BizLinkFull_HS02.Wheel.Key_city_clean);
output(BizLinkFull_HS02.Wheel.KeyQuick_city_clean);
*/
