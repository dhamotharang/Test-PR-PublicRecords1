...
*/
IMPORT SALT27,BizLinkFull_HS, iesp;
EXPORT svcWheelCity() := FUNCTION
    ...
    results := BizLinkFull_HS.Wheel.Fetch_city_clean(SALT27.StringToUppercase(Input_prefix), min(StartingRecord + ReturnCount,MaxResults),BizLinkFull_HS.Config_BIP.city_clean_WheelThreshold);
