...
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'T_ALLCAPS','T_ALPHANUM','T_ALPHA','T_NUMBER','T_FEIN');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'T_ALLCAPS' => 1,'T_ALPHANUM' => 2,'T_ALPHA' => 3,'T_NUMBER' => 4,'T_FEIN' => 5,0);
 
EXPORT MakeFT_T_ALLCAPS(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringtouppercase(s0); // Force to upper case
  RETURN  s1;
END;
EXPORT InValidFT_T_ALLCAPS(SALT33.StrType s) := WHICH(SALT33.stringtouppercase(s)<>s);
EXPORT InValidMessageFT_T_ALLCAPS(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotCaps,SALT33.HygieneErrors.Good);
 
EXPORT MakeFT_T_ALPHANUM(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringtouppercase(s0); // Force to upper case
  s2 := SALT33.stringfilter(s1,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]-^=!+&,./'); // Only allow valid symbols
  s3 := SALT33.stringcleanspaces( SALT33.stringsubstituteout(s2,' <>{}[]-^=!+&,./',' ') ); // Insert spaces but avoid doubles
  RETURN  s3;
END;
EXPORT InValidFT_T_ALPHANUM(SALT33.StrType s) := WHICH(SALT33.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]-^=!+&,./'))));
EXPORT InValidMessageFT_T_ALPHANUM(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotCaps,SALT33.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 <>{}[]-^=!+&,./'),SALT33.HygieneErrors.Good);
 
EXPORT MakeFT_T_ALPHA(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringtouppercase(s0); // Force to upper case
  s2 := SALT33.stringfilter(s1,'ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s2;
END;
EXPORT InValidFT_T_ALPHA(SALT33.StrType s) := WHICH(SALT33.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_T_ALPHA(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotCaps,SALT33.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT33.HygieneErrors.Good);
 
EXPORT MakeFT_T_NUMBER(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_T_NUMBER(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789'))));
EXPORT InValidMessageFT_T_NUMBER(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789'),SALT33.HygieneErrors.Good);
 
EXPORT MakeFT_T_FEIN(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_T_FEIN(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_T_FEIN(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789'),SALT33.HygieneErrors.NotLength('9'),SALT33.HygieneErrors.Good);
...
EXPORT Make_source_record_id(SALT33.StrType s0) := s0;
EXPORT InValid_source_record_id(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_source_record_id(UNSIGNED1 wh) := '';
 
EXPORT Make_source_docid(SALT33.StrType s0) := s0;
EXPORT InValid_source_docid(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_source_docid(UNSIGNED1 wh) := '';
 
EXPORT Make_company_name(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_company_name(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_company_name(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_company_name_prefix(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_company_name_prefix(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_company_name_prefix(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_cnp_name(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_cnp_name(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_cnp_name(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_cnp_number(SALT33.StrType s0) := s0;
EXPORT InValid_cnp_number(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_cnp_number(UNSIGNED1 wh) := '';
 
EXPORT Make_cnp_btype(SALT33.StrType s0) := s0;
EXPORT InValid_cnp_btype(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_cnp_btype(UNSIGNED1 wh) := '';
 
EXPORT Make_cnp_lowv(SALT33.StrType s0) := s0;
EXPORT InValid_cnp_lowv(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_cnp_lowv(UNSIGNED1 wh) := '';
 
EXPORT Make_company_phone(SALT33.StrType s0) := s0;
EXPORT InValid_company_phone(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_company_phone(UNSIGNED1 wh) := '';
 
EXPORT Make_company_phone_3(SALT33.StrType s0) := s0;
EXPORT InValid_company_phone_3(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_company_phone_3(UNSIGNED1 wh) := '';
 
EXPORT Make_company_phone_3_ex(SALT33.StrType s0) := s0;
EXPORT InValid_company_phone_3_ex(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_company_phone_3_ex(UNSIGNED1 wh) := '';
 
EXPORT Make_company_phone_7(SALT33.StrType s0) := s0;
EXPORT InValid_company_phone_7(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_company_phone_7(UNSIGNED1 wh) := '';
 
EXPORT Make_company_fein(SALT33.StrType s0) := MakeFT_T_FEIN(s0);
EXPORT InValid_company_fein(SALT33.StrType s) := InValidFT_T_FEIN(s);
EXPORT InValidMessage_company_fein(UNSIGNED1 wh) := InValidMessageFT_T_FEIN(wh);
 
EXPORT Make_company_sic_code1(SALT33.StrType s0) := s0;
EXPORT InValid_company_sic_code1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_company_sic_code1(UNSIGNED1 wh) := '';
 
EXPORT Make_active_duns_number(SALT33.StrType s0) := s0;
EXPORT InValid_active_duns_number(SALT33.StrType s) := FALSE;
...
EXPORT Make_prim_name(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_prim_name(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_prim_name(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_sec_range(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_sec_range(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_sec_range(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_city(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_city(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_city(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_city_clean(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_city_clean(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_city_clean(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_st(SALT33.StrType s0) := MakeFT_T_ALPHA(s0);
EXPORT InValid_st(SALT33.StrType s) := InValidFT_T_ALPHA(s);
EXPORT InValidMessage_st(UNSIGNED1 wh) := InValidMessageFT_T_ALPHA(wh);
 
EXPORT Make_zip(SALT33.StrType s0) := MakeFT_T_NUMBER(s0);
EXPORT InValid_zip(SALT33.StrType s) := InValidFT_T_NUMBER(s);
EXPORT InValidMessage_zip(UNSIGNED1 wh) := InValidMessageFT_T_NUMBER(wh);
 
EXPORT Make_company_url(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_company_url(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_company_url(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_isContact(SALT33.StrType s0) := s0;
EXPORT InValid_isContact(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_isContact(UNSIGNED1 wh) := '';
 
EXPORT Make_contact_did(SALT33.StrType s0) := s0;
EXPORT InValid_contact_did(SALT33.StrType s) := FALSE;
...
EXPORT Make_fname(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_fname(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_fname(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_fname_preferred(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_fname_preferred(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_fname_preferred(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_mname(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_mname(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_mname(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_lname(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_lname(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_lname(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_name_suffix(SALT33.StrType s0) := MakeFT_T_ALPHANUM(s0);
EXPORT InValid_name_suffix(SALT33.StrType s) := InValidFT_T_ALPHANUM(s);
EXPORT InValidMessage_name_suffix(UNSIGNED1 wh) := InValidMessageFT_T_ALPHANUM(wh);
 
EXPORT Make_contact_ssn(SALT33.StrType s0) := s0;
EXPORT InValid_contact_ssn(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_contact_ssn(UNSIGNED1 wh) := '';
 
EXPORT Make_contact_email(SALT33.StrType s0) := MakeFT_T_ALLCAPS(s0);
EXPORT InValid_contact_email(SALT33.StrType s) := InValidFT_T_ALLCAPS(s);
EXPORT InValidMessage_contact_email(UNSIGNED1 wh) := InValidMessageFT_T_ALLCAPS(wh);
 
EXPORT Make_sele_flag(SALT33.StrType s0) := s0;
EXPORT InValid_sele_flag(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sele_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_org_flag(SALT33.StrType s0) := s0;
EXPORT InValid_org_flag(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_org_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_ult_flag(SALT33.StrType s0) := s0;
EXPORT InValid_ult_flag(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ult_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_fallback_value(SALT33.StrType s0) := s0;
EXPORT InValid_fallback_value(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_fallback_value(UNSIGNED1 wh) := '';
 
EXPORT Make_CONTACTNAME(SALT33.StrType s0) := s0;
EXPORT InValid_CONTACTNAME(SALT33.StrType fname,SALT33.StrType mname,SALT33.StrType lname) := FALSE;
EXPORT InValidMessage_CONTACTNAME(UNSIGNED1 wh) := '';
 
EXPORT Make_STREETADDRESS(SALT33.StrType s0) := s0;
EXPORT InValid_STREETADDRESS(SALT33.StrType prim_range,SALT33.StrType prim_name,SALT33.StrType sec_range) := FALSE;
...
EXPORT UIDConsistency(infile) := FUNCTIONMACRO
  ...
  EXPORT rcid_Clusters := SALT33.MOD_ClusterStats.Counts(f,rcid);
  EXPORT proxid_Clusters := SALT33.MOD_ClusterStats.Counts(f,proxid);
  EXPORT seleid_Clusters := SALT33.MOD_ClusterStats.Counts(f,seleid);
  EXPORT orgid_Clusters := SALT33.MOD_ClusterStats.Counts(f,orgid);
  EXPORT ultid_Clusters := SALT33.MOD_ClusterStats.Counts(f,ultid);
 ...
 // Children with two parents
  ...
  EXPORT rcid_Twoparents := DEDUP(JOIN(f_thin,f_thin,LEFT.rcid=RIGHT.rcid AND LEFT.proxid>RIGHT.proxid,TRANSFORM({SALT33.UIDType proxid1,SALT33.UIDType rcid,SALT33.UIDType proxid2},SELF.proxid1:=LEFT.proxid,SELF.proxid2:=RIGHT.proxid,SELF.rcid:=LEFT.rcid),HASH),WHOLE RECORD,ALL);
    f_thin := TABLE(f(proxid<>0,seleid<>0),{proxid,seleid},proxid,seleid,MERGE);
  EXPORT proxid_Twoparents := DEDUP(JOIN(f_thin,f_thin,LEFT.proxid=RIGHT.proxid AND LEFT.seleid>RIGHT.seleid,TRANSFORM({SALT33.UIDType seleid1,SALT33.UIDType proxid,SALT33.UIDType seleid2},SELF.seleid1:=LEFT.seleid,SELF.seleid2:=RIGHT.seleid,SELF.proxid:=LEFT.proxid),HASH),WHOLE RECORD,ALL);
    f_thin := TABLE(f(seleid<>0,orgid<>0),{seleid,orgid},seleid,orgid,MERGE);
  EXPORT seleid_Twoparents := DEDUP(JOIN(f_thin,f_thin,LEFT.seleid=RIGHT.seleid AND LEFT.orgid>RIGHT.orgid,TRANSFORM({SALT33.UIDType orgid1,SALT33.UIDType seleid,SALT33.UIDType orgid2},SELF.orgid1:=LEFT.orgid,SELF.orgid2:=RIGHT.orgid,SELF.seleid:=LEFT.seleid),HASH),WHOLE RECORD,ALL);
    f_thin := TABLE(f(orgid<>0,ultid<>0),{orgid,ultid},orgid,ultid,MERGE);
  EXPORT orgid_Twoparents := DEDUP(JOIN(f_thin,f_thin,LEFT.orgid=RIGHT.orgid AND LEFT.ultid>RIGHT.ultid,TRANSFORM({SALT33.UIDType ultid1,SALT33.UIDType orgid,SALT33.UIDType ultid2},SELF.ultid1:=LEFT.ultid,SELF.ultid2:=RIGHT.ultid,SELF.orgid:=LEFT.orgid),HASH),WHOLE RECORD,ALL);
 // Now compute the more involved consistency checks
  ...
  EXPORT Advanced0 := SORT(SALT33.MAC_Pivot(Advanced00,Advanced0Layout), MAP(label='rcid'=>0,label='proxid'=>1,label='seleid'=>2,label='orgid'=>3,4));
  END;
  RETURN m;
ENDMACRO;
END;
