...
EXPORT did_getAllRecs  (unsigned8 inDid):= FUNCTION	
	...
	recsDate := SALT311.MAC_DatasetAsOf(recs, RID, DID, Uniqueid, DT_EFFECTIVE_FIRST, DT_EFFECTIVE_LAST, , 'YYYYMMDD', FALSE);	
 ...
 // get history for DIDs not found with incremental
	...
	didsNotFoundDate := 	SALT311.MAC_DatasetAsOf(didsNotFound, RID, DID, Uniqueid, DT_EFFECTIVE_FIRST, DT_EFFECTIVE_LAST, , 'YYYYMMDD', FALSE);	
	...
	recsNotFoundDate := SALT311.MAC_DatasetAsOf(recsNotFound, RID, DID, Uniqueid, DT_EFFECTIVE_FIRST, DT_EFFECTIVE_LAST, , 'YYYYMMDD', FALSE);	
