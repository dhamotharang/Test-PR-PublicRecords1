...
f := govdata.File_MS_Workers_Comp_In;
...
Business_Header.Layout_Business_Contact_Full into(f L) := transform
	...
	SELF.city := L.claimant_p_city_name;
	...
	SELF.company_city := L.emp_p_city_name;
...
export MS_Workers_As_Business_Contact := project(f, into(left))(lname!='')
	: persist('TEMP::MS_Workers_As_BC');