...
f := govdata.File_FL_FBN_In;
fev := govdata.File_FL_FBN_Events_In;

// Extract Filings
Business_Header.Layout_Business_Header ExtractFilings(govdata.Layout_FL_FBN_In l) := transform
self.source := 'FF';          // Source file type
...
self.city := l.fic_fil_p_city_name;
...
// Extract Owners
Business_Header.Layout_Business_Header ExtractOwners(govdata.Layout_FL_FBN_In l, unsigned1 c) := transform
self.source := 'FF';          // Source file type
self.source_group := 'FL' + l.fic_fil_doc_num;
self.vendor_id := 'FL' + l.fic_fil_doc_num;
self.dt_first_seen := (unsigned4)l.fic_fil_date;
...
self.city := choose(c,l.fic_owner1_p_city_name,l.fic_owner2_p_city_name,l.fic_owner3_p_city_name,l.fic_owner4_p_city_name,l.fic_owner5_p_city_name,
                            l.fic_owner6_p_city_name,l.fic_owner7_p_city_name,l.fic_owner8_p_city_name,l.fic_owner9_p_city_name,l.fic_owner10_p_city_name);
...
Business_Header.Layout_Business_Header ExtractAddressChange(govdata.Layout_FL_FBN_Events_In l, unsigned1 c) := transform
self.source := 'FF';          // Source file type
...
self.city := choose(c,l.old_p_city_name,l.new_p_city_name);
...
Business_Header.Layout_Business_Header ExtractOwnerChange(govdata.Layout_FL_FBN_Events_In l) := transform
self.source := 'FF';          // Source file type
self.source_group := 'FL' + l.event_orig_doc_number;
self.vendor_id := 'FL' + l.event_orig_doc_number;
self.dt_first_seen := (unsigned4)l.event_date;
...
// Rollup
Business_Header.Layout_Business_Header RollupFLFBN(Business_Header.Layout_Business_Header L, Business_Header.Layout_Business_Header R) := TRANSFORM
SELF.dt_first_seen := 
...
FL_FBN_Combined_Rollup := ROLLUP(FL_FBN_Combined_Sort,
                    ...
                    LOCAL) : PERSIST('TMTEMP::FL_FBN_Company_Rollup');

export FL_FBN_As_Business_Header := FL_FBN_Combined_Rollup;