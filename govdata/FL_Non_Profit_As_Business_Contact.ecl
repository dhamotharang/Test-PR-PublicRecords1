...
Business_Header.Layout_Business_Contact_Full cleaner(f L, INTEGER C) :=
TRANSFORM
	// General Record Data
	SELF.bdid := 0;
	SELF.did := 0;
	...
	SELF.city := CHOOSE(C, L.princ1_p_city_name, L.princ2_p_city_name, L.princ3_p_city_name, 
	...
	SELF.county := CHOOSE(C, L.princ1_county, L.princ2_county, L.princ3_county, 
									L.princ4_county, L.princ5_county, L.princ6_county);
	...
	SELF.company_city := L.corp_p_city_name;
...
Business_Header.Layout_Business_Contact_Full cleaner2(f L) :=
TRANSFORM
	// General Record Data
	SELF.bdid := 0;
	SELF.did := 0;
...
export FL_Non_Profit_As_Business_Contact := allCompanies
	: persist('TEMP::FL_Non_Profit_As_As_BC');