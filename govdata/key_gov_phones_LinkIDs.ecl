IMPORT BIPV2;
EXPORT key_gov_phones_LinkIDs := MODULE
  shared  base_recs 					 := govdata.File_Gov_Phones_Base;
	export  out_superfile_Name   := govdata.keynames().EmployeeDirsLinkIDs.qa; //linkid Key Super FileName
