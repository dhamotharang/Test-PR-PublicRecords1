...
EXPORT key_fdic_LinkIDs := MODULE
  shared  base_recs 					:= govdata.File_FDIC_Base_AID;
	export  out_superfile_Name  := govdata.keynames().FDICLinkIDs.qa; //linkid Key Super FileName
