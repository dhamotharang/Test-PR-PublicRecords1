...
Business_Header.Layout_Business_Contact_Full ExtractOwners(Layout_FL_FBN_In l, unsigned1 c) := transform
...
self.company_city := l.fic_fil_p_city_name;
...
Business_Header.Layout_Business_Contact_Full ExtractOwnerChange(Layout_FL_FBN_Events_In l, Layout_FL_FBN_In r) := transform
self.source := 'FF';          // Source file type
...
self.company_city := r.fic_fil_p_city_name;
...
export FL_FBN_As_Business_Contact := FL_FBN_Contacts_Combined
	: persist('TEMP::FL_FBN_As_BC');