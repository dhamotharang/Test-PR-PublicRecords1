...
export Cleaned_IRS_NonProfit(string filedate,
	...
	govdata.Layouts_IRS_NonProfit.Base_AID  CleanUpName( dCleanName  l) := transform
		...
		self.In_Care_Of_Name								:= ut.CleanSpacesAndUpper(l.In_Care_Of_Name) ;
		...
		self.Group_Exemption_Number					:= ut.CleanSpacesAndUpper(l.Group_Exemption_Number) ; 
		...
		self.Univ_Loc_Code									:= ut.CleanSpacesAndUpper(l.Univ_Loc_Code) ; 
		self.Advance_Ruling_Exp_Date				:= ut.CleanSpacesAndUpper(l.Advance_Ruling_Exp_Date) ;
		...
		self.Income_Amount									:= ut.CleanSpacesAndUpper(l.Income_Amount) ;
		self.Negative_Sign									:= ut.CleanSpacesAndUpper(l.Negative_Sign) ; 
		self.Form_990_Revenue_Amount				:= ut.CleanSpacesAndUpper(l.Form_990_Revenue_Amount) ;
		self.Negative_Rev_Amount						:= ut.CleanSpacesAndUpper(l.Negative_Rev_Amount) ;
