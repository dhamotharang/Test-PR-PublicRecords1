...
EXPORT  Key_FL_FBN_LinkIDs:= MODULE
  shared  base_recs 					 := govdata.file_fl_fbn_base; 
	export  out_superfile_Name   := govdata.keynames().FL_FBNLinkIDs.qa; //linkid Key Super FileName
