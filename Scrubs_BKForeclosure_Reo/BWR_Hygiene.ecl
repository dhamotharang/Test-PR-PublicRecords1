...
#workunit('name','Scrubs_BKForeclosure_Reo.BWR_Hygiene - Hygiene & Stats - SALT V3.11.6');
IMPORT Scrubs_BKForeclosure_Reo,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_BKForeclosure_Reo.In_BKForeclosure_Reo;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_BKForeclosure_Reo.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_BKForeclosure_Reo'),NAMED('OptimizedLayout'));// File layout suggested by data
