...
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_ar_type');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_date' => 5,'invalid_ar_type' => 6,0);
...
EXPORT MakeFT_invalid_ar_type(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ar_type(SALT35.StrType s) := WHICH(~Scrubs_Corp2_Mapping_NC_Main.Functions.fn_valid_AR_type(s)>0);
EXPORT InValidMessageFT_invalid_ar_type(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NC_Main.Functions.fn_valid_AR_type'),SALT35.HygieneErrors.Good);
...
EXPORT Make_corp_sos_charter_nbr(SALT35.StrType s0) := MakeFT_invalid_charter_nbr(s0);
EXPORT InValid_corp_sos_charter_nbr(SALT35.StrType s) := InValidFT_invalid_charter_nbr(s);
EXPORT InValidMessage_corp_sos_charter_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_charter_nbr(wh);
 
EXPORT Make_ar_year(SALT35.StrType s0) := s0;
EXPORT InValid_ar_year(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_year(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_mailed_dt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_mailed_dt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_mailed_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_due_dt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_due_dt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_due_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_filed_dt(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_ar_filed_dt(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_ar_filed_dt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_ar_report_dt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_report_dt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_report_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_ar_report_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_report_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_franchise_tax_paid_dt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_franchise_tax_paid_dt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_franchise_tax_paid_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_delinquent_dt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_delinquent_dt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_delinquent_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_tax_factor(SALT35.StrType s0) := s0;
EXPORT InValid_ar_tax_factor(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_tax_factor(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_tax_amount_paid(SALT35.StrType s0) := s0;
EXPORT InValid_ar_tax_amount_paid(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_tax_amount_paid(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_annual_report_cap(SALT35.StrType s0) := s0;
EXPORT InValid_ar_annual_report_cap(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_annual_report_cap(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_illinois_capital(SALT35.StrType s0) := s0;
EXPORT InValid_ar_illinois_capital(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_illinois_capital(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_roll(SALT35.StrType s0) := s0;
EXPORT InValid_ar_roll(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_roll(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_frame(SALT35.StrType s0) := s0;
EXPORT InValid_ar_frame(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_frame(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_extension(SALT35.StrType s0) := s0;
EXPORT InValid_ar_extension(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_extension(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_microfilm_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_ar_microfilm_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_microfilm_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_comment(SALT35.StrType s0) := s0;
EXPORT InValid_ar_comment(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_type(SALT35.StrType s0) := MakeFT_invalid_ar_type(s0);
EXPORT InValid_ar_type(SALT35.StrType s) := InValidFT_invalid_ar_type(s);
EXPORT InValidMessage_ar_type(UNSIGNED1 wh) := InValidMessageFT_invalid_ar_type(wh);
 
EXPORT Make_ar_exempt(SALT35.StrType s0) := s0;
EXPORT InValid_ar_exempt(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_exempt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_license_tax_amount(SALT35.StrType s0) := s0;
EXPORT InValid_ar_license_tax_amount(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_license_tax_amount(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_status(SALT35.StrType s0) := s0;
EXPORT InValid_ar_status(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_status(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_paid_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_paid_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_paid_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_prev_paid_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_prev_paid_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_prev_paid_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_prev_tax_factor(SALT35.StrType s0) := s0;
EXPORT InValid_ar_prev_tax_factor(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_prev_tax_factor(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_extension_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_extension_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_extension_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_mail_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_report_mail_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_report_mail_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_deliquent_report_mail_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_deliquent_report_mail_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_deliquent_report_mail_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_filed_date(SALT35.StrType s0) := s0;
EXPORT InValid_ar_report_filed_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_report_filed_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_year_and_month_due(SALT35.StrType s0) := s0;
EXPORT InValid_ar_year_and_month_due(SALT35.StrType s) := 0;
EXPORT InValidMessage_ar_year_and_month_due(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT35,Scrubs_Corp2_Mapping_NC_AR;
