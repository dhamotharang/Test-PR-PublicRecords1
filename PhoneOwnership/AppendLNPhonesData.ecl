...
*/
IMPORT Doxie, Phones, PhoneOwnership, Risk_Indicators, STD, ut;
EXPORT AppendLNPhonesData(DATASET(PhoneOwnership.Layouts.BatchOut) ds_batch_in,
  ...
  dsLNIdentities := SORT(Phones.GetLNIdentity_byPhone(dsLNPhonesRequest, mod_access), acctno, phone, lname='',
    fname='', -dt_last_seen, dt_first_seen);
