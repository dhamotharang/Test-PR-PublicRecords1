...
IMPORT std;
 ...
 EXPORT spray_federal_bureau_files (String Update_filedate, string inTargetGrp, string inRemoteLoc ) := function																 
																	 
	srcIP := 'bctlpedata12.risk.regn.net'; 
  targetGrp := inTargetGrp; 
  RemoteLoc := inRemoteLoc+Update_filedate+'/';			
