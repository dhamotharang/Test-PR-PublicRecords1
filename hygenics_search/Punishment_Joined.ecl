import CrimSrch, Crim_Common;
	...
	Layout_Moxie_Punishment tDOCtoCrimSrchPunishment(Layout_Moxie_DOC_Punishment pInput) := transform
...
lPunishmentProcessed := project(File_DOC_Punishment,tDOCtoCrimSrchPunishment(left));
	...
	export Punishment_Joined :=	lPunishmentProcessed : persist('persist::CrimSrch_Punishment_Joined');
#else
