import CrimSrch, lib_stringlib;
	...
	CrimSrch.Layout_Moxie_Offenses_temp tJoinForConvictionFlag(CrimSrch.Layout_Moxie_Offenses_temp pOffense, Layout_Conviction_Lookup pLookup) := transform
...
dCourtOffensesConvictionsMaybe	:= join(dCourtOffensesConvictionByDisp2,File_Conviction_Lookup(Court_Disp_Desc='' and Court_Disp_Desc=''),
	...
	CrimSrch.Layout_Moxie_Offenses_temp tSetConvictionFlagBySentDate(CrimSrch.Layout_Moxie_Offenses_temp pOffense) :=transform
...
dCourtOffensesConvictionBySentDate1	:= project(dCourtOffensesConvictionBySentDate,tSetConvictionFlagBySentDate(left));
	...
	export Court_Offenses_Step2_Conviction := dCourtOffensesConvictionsMaybe +	dCourtOffensesConvictionBySentDate1 : persist('Persist::CrimSrch_Court_Offenses_Fixed_Conviction');
#else
	export Court_Offenses_Step2_Conviction := dCourtOffensesConvictionsMaybe +	dCourtOffensesConvictionBySentDate1;
#end