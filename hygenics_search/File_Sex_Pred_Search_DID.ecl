...
inputFile	:= dataset('~thor_data400::in::sex_pred_search_' + CrimSrch.Version.SexPred,
							ds_layout_new,flat,unsorted
							);
				//dataset('~thor_200::base::okc_sex_offender_search_file', ds_layout_new, flat, unsorted);

Layout_Sex_Pred_Search_DID oldFormat(inputFile l):= transform
