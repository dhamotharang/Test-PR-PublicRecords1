import Crim_Common, Corrections,codes, crimsrch;
...
fcra_v1_as_v2 := join(df2,codes.File_Codes_V3_In,right.file_name='COURT_OFFENSES' and 
...
export Out_Offenses := sequential(
							output(fcra_v1_as_v1,,Name_Moxie_Offenses_Dev,overwrite, __compressed__),
							output(fcra_v1_as_v2,,'~thor_Data400::base::fcra::life_eir::court_offenses_' + Version.Development,overwrite, __compressed__));