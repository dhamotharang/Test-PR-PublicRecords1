...
// Build Keys
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(PRTE2_Infutor_CID.keys.key_did(filedate), Constants.KEY_PREFIX + 'did', Constants.KEY_PREFIX + filedate +'::did', did_Key);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(PRTE2_Infutor_CID.keys.fcra_Key_did(filedate), Constants.FCRA_KEY_PREFIX + 'did', Constants.FCRA_KEY_PREFIX + filedate +'::did', did_fcra_Key);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(PRTE2_Infutor_CID.keys.Key_Phone(filedate), Constants.KEY_PREFIX + 'phone', Constants.KEY_PREFIX + filedate +'::phone', phone_Key);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(PRTE2_Infutor_CID.keys.fcra_Key_Phone(filedate), Constants.FCRA_KEY_PREFIX + 'phone', Constants.FCRA_KEY_PREFIX + filedate +'::phone', phone_fcra_Key);
