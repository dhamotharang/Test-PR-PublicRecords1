...
#workunit('name','Scrubs_Equifax_Business_Data.Contacts_BWR_Scrubs - Checking field validity in a file - SALT V3.11.4');
IMPORT Scrubs_Equifax_Business_Data,SALT311;
infile := Scrubs_Equifax_Business_Data.Contacts_In_Equifax_Business_Data;
mod_scrubs := Scrubs_Equifax_Business_Data.Contacts_Scrubs;
