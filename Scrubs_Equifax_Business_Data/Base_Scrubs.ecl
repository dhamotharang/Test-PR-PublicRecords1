...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 164;
  EXPORT NumRulesFromFieldType := 164;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 164;
...
EXPORT FromNone(DATASET(Base_Layout_Equifax_Business_Data) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.dotid_Invalid := Base_Fields.InValid_dotid((SALT311.StrType)le.dotid);
    SELF.dotscore_Invalid := Base_Fields.InValid_dotscore((SALT311.StrType)le.dotscore);
    SELF.dotweight_Invalid := Base_Fields.InValid_dotweight((SALT311.StrType)le.dotweight);
    SELF.empid_Invalid := Base_Fields.InValid_empid((SALT311.StrType)le.empid);
    SELF.empscore_Invalid := Base_Fields.InValid_empscore((SALT311.StrType)le.empscore);
    SELF.empweight_Invalid := Base_Fields.InValid_empweight((SALT311.StrType)le.empweight);
    SELF.powid_Invalid := Base_Fields.InValid_powid((SALT311.StrType)le.powid);
    SELF.powscore_Invalid := Base_Fields.InValid_powscore((SALT311.StrType)le.powscore);
    SELF.powweight_Invalid := Base_Fields.InValid_powweight((SALT311.StrType)le.powweight);
    SELF.proxid_Invalid := Base_Fields.InValid_proxid((SALT311.StrType)le.proxid);
    SELF.proxscore_Invalid := Base_Fields.InValid_proxscore((SALT311.StrType)le.proxscore);
    SELF.proxweight_Invalid := Base_Fields.InValid_proxweight((SALT311.StrType)le.proxweight);
    SELF.seleid_Invalid := Base_Fields.InValid_seleid((SALT311.StrType)le.seleid);
    SELF.selescore_Invalid := Base_Fields.InValid_selescore((SALT311.StrType)le.selescore);
    SELF.seleweight_Invalid := Base_Fields.InValid_seleweight((SALT311.StrType)le.seleweight);
    SELF.orgid_Invalid := Base_Fields.InValid_orgid((SALT311.StrType)le.orgid);
    SELF.orgscore_Invalid := Base_Fields.InValid_orgscore((SALT311.StrType)le.orgscore);
    SELF.orgweight_Invalid := Base_Fields.InValid_orgweight((SALT311.StrType)le.orgweight);
    SELF.ultid_Invalid := Base_Fields.InValid_ultid((SALT311.StrType)le.ultid);
    SELF.ultscore_Invalid := Base_Fields.InValid_ultscore((SALT311.StrType)le.ultscore);
    SELF.ultweight_Invalid := Base_Fields.InValid_ultweight((SALT311.StrType)le.ultweight);
    ...
    SELF.normaddress_type_Invalid := Base_Fields.InValid_normaddress_type((SALT311.StrType)le.normaddress_type);
    SELF.norm_state_Invalid := Base_Fields.InValid_norm_state((SALT311.StrType)le.norm_state);
    SELF.norm_zip_Invalid := Base_Fields.InValid_norm_zip((SALT311.StrType)le.norm_zip);
    SELF.norm_zip4_Invalid := Base_Fields.InValid_norm_zip4((SALT311.StrType)le.norm_zip4);
    SELF.EFX_NAME_Invalid := Base_Fields.InValid_EFX_NAME((SALT311.StrType)le.EFX_NAME);
    SELF.EFX_LEGAL_NAME_Invalid := Base_Fields.InValid_EFX_LEGAL_NAME((SALT311.StrType)le.EFX_LEGAL_NAME);
    SELF.EFX_ADDRESS_Invalid := Base_Fields.InValid_EFX_ADDRESS((SALT311.StrType)le.EFX_ADDRESS);
    ...
    SELF.raw_aid_Invalid := Base_Fields.InValid_raw_aid((SALT311.StrType)le.raw_aid);
    SELF.ace_aid_Invalid := Base_Fields.InValid_ace_aid((SALT311.StrType)le.ace_aid);
    SELF.EFX_BUSSTATCD_Invalid := Base_Fields.InValid_EFX_BUSSTATCD((SALT311.StrType)le.EFX_BUSSTATCD);
    SELF.EFX_CMSA_Invalid := Base_Fields.InValid_EFX_CMSA((SALT311.StrType)le.EFX_CMSA);
    SELF.EFX_CORPAMOUNTCD_Invalid := Base_Fields.InValid_EFX_CORPAMOUNTCD((SALT311.StrType)le.EFX_CORPAMOUNTCD);
    SELF.EFX_CORPAMOUNTPREC_Invalid := Base_Fields.InValid_EFX_CORPAMOUNTPREC((SALT311.StrType)le.EFX_CORPAMOUNTPREC);
    SELF.EFX_CORPAMOUNTTP_Invalid := Base_Fields.InValid_EFX_CORPAMOUNTTP((SALT311.StrType)le.EFX_CORPAMOUNTTP);
    SELF.EFX_CORPEMPCD_Invalid := Base_Fields.InValid_EFX_CORPEMPCD((SALT311.StrType)le.EFX_CORPEMPCD);
    SELF.EFX_CTRYISOCD_Invalid := Base_Fields.InValid_EFX_CTRYISOCD((SALT311.StrType)le.EFX_CTRYISOCD);
    SELF.EFX_CTRYNUM_Invalid := Base_Fields.InValid_EFX_CTRYNUM((SALT311.StrType)le.EFX_CTRYNUM);
    SELF.EFX_CTRYTELCD_Invalid := Base_Fields.InValid_EFX_CTRYTELCD((SALT311.StrType)le.EFX_CTRYTELCD);
    SELF.EFX_GEOPREC_Invalid := Base_Fields.InValid_EFX_GEOPREC((SALT311.StrType)le.EFX_GEOPREC);
    SELF.EFX_MERCTYPE_Invalid := Base_Fields.InValid_EFX_MERCTYPE((SALT311.StrType)le.EFX_MERCTYPE);
    SELF.EFX_MRKT_TELESCORE_Invalid := Base_Fields.InValid_EFX_MRKT_TELESCORE((SALT311.StrType)le.EFX_MRKT_TELESCORE);
    SELF.EFX_MRKT_TOTALIND_Invalid := Base_Fields.InValid_EFX_MRKT_TOTALIND((SALT311.StrType)le.EFX_MRKT_TOTALIND);
    SELF.EFX_MRKT_TOTALSCORE_Invalid := Base_Fields.InValid_EFX_MRKT_TOTALSCORE((SALT311.StrType)le.EFX_MRKT_TOTALSCORE);
    SELF.EFX_PUBLIC_Invalid := Base_Fields.InValid_EFX_PUBLIC((SALT311.StrType)le.EFX_PUBLIC);
    SELF.EFX_STKEXC_Invalid := Base_Fields.InValid_EFX_STKEXC((SALT311.StrType)le.EFX_STKEXC);
    SELF.EFX_PRIMSIC_Invalid := Base_Fields.InValid_EFX_PRIMSIC((SALT311.StrType)le.EFX_PRIMSIC);
    SELF.EFX_SECSIC1_Invalid := Base_Fields.InValid_EFX_SECSIC1((SALT311.StrType)le.EFX_SECSIC1);
    SELF.EFX_SECSIC2_Invalid := Base_Fields.InValid_EFX_SECSIC2((SALT311.StrType)le.EFX_SECSIC2);
    SELF.EFX_SECSIC3_Invalid := Base_Fields.InValid_EFX_SECSIC3((SALT311.StrType)le.EFX_SECSIC3);
    SELF.EFX_SECSIC4_Invalid := Base_Fields.InValid_EFX_SECSIC4((SALT311.StrType)le.EFX_SECSIC4);
    SELF.EFX_ID_Invalid := Base_Fields.InValid_EFX_ID((SALT311.StrType)le.EFX_ID);
    SELF.EFX_CITY_Invalid := Base_Fields.InValid_EFX_CITY((SALT311.StrType)le.EFX_CITY);
    SELF.EFX_CTRYNAME_Invalid := Base_Fields.InValid_EFX_CTRYNAME((SALT311.StrType)le.EFX_CTRYNAME);
    SELF.EFX_COUNTYNM_Invalid := Base_Fields.InValid_EFX_COUNTYNM((SALT311.StrType)le.EFX_COUNTYNM);
    SELF.EFX_COUNTY_Invalid := Base_Fields.InValid_EFX_COUNTY((SALT311.StrType)le.EFX_COUNTY);
    SELF.EFX_SOHO_Invalid := Base_Fields.InValid_EFX_SOHO((SALT311.StrType)le.EFX_SOHO);
    SELF.EFX_BIZ_Invalid := Base_Fields.InValid_EFX_BIZ((SALT311.StrType)le.EFX_BIZ);
    SELF.EFX_RES_Invalid := Base_Fields.InValid_EFX_RES((SALT311.StrType)le.EFX_RES);
    SELF.EFX_CMRA_Invalid := Base_Fields.InValid_EFX_CMRA((SALT311.StrType)le.EFX_CMRA);
    SELF.EFX_SECGEOPREC_Invalid := Base_Fields.InValid_EFX_SECGEOPREC((SALT311.StrType)le.EFX_SECGEOPREC);
    SELF.EFX_SECCTRYISOCD_Invalid := Base_Fields.InValid_EFX_SECCTRYISOCD((SALT311.StrType)le.EFX_SECCTRYISOCD);
    SELF.EFX_SECCTRYNUM_Invalid := Base_Fields.InValid_EFX_SECCTRYNUM((SALT311.StrType)le.EFX_SECCTRYNUM);
    SELF.EFX_PHONE_Invalid := Base_Fields.InValid_EFX_PHONE((SALT311.StrType)le.EFX_PHONE);
    SELF.EFX_FAXPHONE_Invalid := Base_Fields.InValid_EFX_FAXPHONE((SALT311.StrType)le.EFX_FAXPHONE);
    SELF.EFX_YREST_Invalid := Base_Fields.InValid_EFX_YREST((SALT311.StrType)le.EFX_YREST);
    SELF.EFX_CORPEMPCNT_Invalid := Base_Fields.InValid_EFX_CORPEMPCNT((SALT311.StrType)le.EFX_CORPEMPCNT);
    SELF.EFX_LOCEMPCNT_Invalid := Base_Fields.InValid_EFX_LOCEMPCNT((SALT311.StrType)le.EFX_LOCEMPCNT);
    SELF.EFX_LOCEMPCD_Invalid := Base_Fields.InValid_EFX_LOCEMPCD((SALT311.StrType)le.EFX_LOCEMPCD);
    SELF.EFX_CORPAMOUNT_Invalid := Base_Fields.InValid_EFX_CORPAMOUNT((SALT311.StrType)le.EFX_CORPAMOUNT);
    SELF.EFX_LOCAMOUNT_Invalid := Base_Fields.InValid_EFX_LOCAMOUNT((SALT311.StrType)le.EFX_LOCAMOUNT);
    SELF.EFX_LOCAMOUNTCD_Invalid := Base_Fields.InValid_EFX_LOCAMOUNTCD((SALT311.StrType)le.EFX_LOCAMOUNTCD);
    SELF.EFX_LOCAMOUNTTP_Invalid := Base_Fields.InValid_EFX_LOCAMOUNTTP((SALT311.StrType)le.EFX_LOCAMOUNTTP);
    SELF.EFX_LOCAMOUNTPREC_Invalid := Base_Fields.InValid_EFX_LOCAMOUNTPREC((SALT311.StrType)le.EFX_LOCAMOUNTPREC);
    SELF.EFX_PRIMNAICSCODE_Invalid := Base_Fields.InValid_EFX_PRIMNAICSCODE((SALT311.StrType)le.EFX_PRIMNAICSCODE);
    SELF.EFX_SECNAICS1_Invalid := Base_Fields.InValid_EFX_SECNAICS1((SALT311.StrType)le.EFX_SECNAICS1);
    SELF.EFX_SECNAICS2_Invalid := Base_Fields.InValid_EFX_SECNAICS2((SALT311.StrType)le.EFX_SECNAICS2);
    SELF.EFX_SECNAICS3_Invalid := Base_Fields.InValid_EFX_SECNAICS3((SALT311.StrType)le.EFX_SECNAICS3);
    SELF.EFX_SECNAICS4_Invalid := Base_Fields.InValid_EFX_SECNAICS4((SALT311.StrType)le.EFX_SECNAICS4);
    SELF.EFX_DEAD_Invalid := Base_Fields.InValid_EFX_DEAD((SALT311.StrType)le.EFX_DEAD);
    SELF.EFX_DEADDT_Invalid := Base_Fields.InValid_EFX_DEADDT((SALT311.StrType)le.EFX_DEADDT);
    SELF.EFX_MRKT_TELEVER_Invalid := Base_Fields.InValid_EFX_MRKT_TELEVER((SALT311.StrType)le.EFX_MRKT_TELEVER);
    SELF.EFX_MRKT_VACANT_Invalid := Base_Fields.InValid_EFX_MRKT_VACANT((SALT311.StrType)le.EFX_MRKT_VACANT);
    SELF.EFX_MRKT_SEASONAL_Invalid := Base_Fields.InValid_EFX_MRKT_SEASONAL((SALT311.StrType)le.EFX_MRKT_SEASONAL);
    SELF.EFX_MBE_Invalid := Base_Fields.InValid_EFX_MBE((SALT311.StrType)le.EFX_MBE);
    SELF.EFX_WBE_Invalid := Base_Fields.InValid_EFX_WBE((SALT311.StrType)le.EFX_WBE);
    SELF.EFX_MWBE_Invalid := Base_Fields.InValid_EFX_MWBE((SALT311.StrType)le.EFX_MWBE);
    SELF.EFX_SDB_Invalid := Base_Fields.InValid_EFX_SDB((SALT311.StrType)le.EFX_SDB);
    SELF.EFX_HUBZONE_Invalid := Base_Fields.InValid_EFX_HUBZONE((SALT311.StrType)le.EFX_HUBZONE);
    SELF.EFX_DBE_Invalid := Base_Fields.InValid_EFX_DBE((SALT311.StrType)le.EFX_DBE);
    SELF.EFX_VET_Invalid := Base_Fields.InValid_EFX_VET((SALT311.StrType)le.EFX_VET);
    SELF.EFX_DVET_Invalid := Base_Fields.InValid_EFX_DVET((SALT311.StrType)le.EFX_DVET);
    SELF.EFX_8a_Invalid := Base_Fields.InValid_EFX_8a((SALT311.StrType)le.EFX_8a);
    SELF.EFX_8aEXPDT_Invalid := Base_Fields.InValid_EFX_8aEXPDT((SALT311.StrType)le.EFX_8aEXPDT);
    SELF.EFX_DIS_Invalid := Base_Fields.InValid_EFX_DIS((SALT311.StrType)le.EFX_DIS);
    SELF.EFX_SBE_Invalid := Base_Fields.InValid_EFX_SBE((SALT311.StrType)le.EFX_SBE);
    SELF.EFX_BUSSIZE_Invalid := Base_Fields.InValid_EFX_BUSSIZE((SALT311.StrType)le.EFX_BUSSIZE);
    SELF.EFX_LBE_Invalid := Base_Fields.InValid_EFX_LBE((SALT311.StrType)le.EFX_LBE);
    SELF.EFX_GOV_Invalid := Base_Fields.InValid_EFX_GOV((SALT311.StrType)le.EFX_GOV);
    SELF.EFX_FGOV_Invalid := Base_Fields.InValid_EFX_FGOV((SALT311.StrType)le.EFX_FGOV);
    SELF.EFX_NONPROFIT_Invalid := Base_Fields.InValid_EFX_NONPROFIT((SALT311.StrType)le.EFX_NONPROFIT);
    SELF.EFX_HBCU_Invalid := Base_Fields.InValid_EFX_HBCU((SALT311.StrType)le.EFX_HBCU);
    SELF.EFX_GAYLESBIAN_Invalid := Base_Fields.InValid_EFX_GAYLESBIAN((SALT311.StrType)le.EFX_GAYLESBIAN);
    SELF.EFX_WSBE_Invalid := Base_Fields.InValid_EFX_WSBE((SALT311.StrType)le.EFX_WSBE);
    SELF.EFX_VSBE_Invalid := Base_Fields.InValid_EFX_VSBE((SALT311.StrType)le.EFX_VSBE);
    SELF.EFX_DVSBE_Invalid := Base_Fields.InValid_EFX_DVSBE((SALT311.StrType)le.EFX_DVSBE);
    SELF.EFX_MWBESTATUS_Invalid := Base_Fields.InValid_EFX_MWBESTATUS((SALT311.StrType)le.EFX_MWBESTATUS);
    SELF.EFX_NMSDC_Invalid := Base_Fields.InValid_EFX_NMSDC((SALT311.StrType)le.EFX_NMSDC);
    SELF.EFX_WBENC_Invalid := Base_Fields.InValid_EFX_WBENC((SALT311.StrType)le.EFX_WBENC);
    SELF.EFX_CA_PUC_Invalid := Base_Fields.InValid_EFX_CA_PUC((SALT311.StrType)le.EFX_CA_PUC);
    SELF.EFX_TX_HUB_Invalid := Base_Fields.InValid_EFX_TX_HUB((SALT311.StrType)le.EFX_TX_HUB);
    SELF.EFX_GSAX_Invalid := Base_Fields.InValid_EFX_GSAX((SALT311.StrType)le.EFX_GSAX);
    SELF.EFX_CALTRANS_Invalid := Base_Fields.InValid_EFX_CALTRANS((SALT311.StrType)le.EFX_CALTRANS);
    SELF.EFX_EDU_Invalid := Base_Fields.InValid_EFX_EDU((SALT311.StrType)le.EFX_EDU);
    SELF.EFX_MI_Invalid := Base_Fields.InValid_EFX_MI((SALT311.StrType)le.EFX_MI);
    SELF.EFX_ANC_Invalid := Base_Fields.InValid_EFX_ANC((SALT311.StrType)le.EFX_ANC);
    SELF.AT_CERTLEV1_Invalid := Base_Fields.InValid_AT_CERTLEV1((SALT311.StrType)le.AT_CERTLEV1);
    SELF.AT_CERTLEV2_Invalid := Base_Fields.InValid_AT_CERTLEV2((SALT311.StrType)le.AT_CERTLEV2);
    SELF.AT_CERTLEV3_Invalid := Base_Fields.InValid_AT_CERTLEV3((SALT311.StrType)le.AT_CERTLEV3);
    SELF.AT_CERTLEV4_Invalid := Base_Fields.InValid_AT_CERTLEV4((SALT311.StrType)le.AT_CERTLEV4);
    SELF.AT_CERTLEV5_Invalid := Base_Fields.InValid_AT_CERTLEV5((SALT311.StrType)le.AT_CERTLEV5);
    SELF.AT_CERTLEV6_Invalid := Base_Fields.InValid_AT_CERTLEV6((SALT311.StrType)le.AT_CERTLEV6);
    SELF.AT_CERTLEV7_Invalid := Base_Fields.InValid_AT_CERTLEV7((SALT311.StrType)le.AT_CERTLEV7);
    SELF.AT_CERTLEV8_Invalid := Base_Fields.InValid_AT_CERTLEV8((SALT311.StrType)le.AT_CERTLEV8);
    SELF.AT_CERTLEV9_Invalid := Base_Fields.InValid_AT_CERTLEV9((SALT311.StrType)le.AT_CERTLEV9);
    SELF.AT_CERTLEV10_Invalid := Base_Fields.InValid_AT_CERTLEV10((SALT311.StrType)le.AT_CERTLEV10);
    SELF.AT_CERTEXP1_Invalid := Base_Fields.InValid_AT_CERTEXP1((SALT311.StrType)le.AT_CERTEXP1);
    SELF.AT_CERTEXP2_Invalid := Base_Fields.InValid_AT_CERTEXP2((SALT311.StrType)le.AT_CERTEXP2);
    SELF.AT_CERTEXP3_Invalid := Base_Fields.InValid_AT_CERTEXP3((SALT311.StrType)le.AT_CERTEXP3);
    SELF.AT_CERTEXP4_Invalid := Base_Fields.InValid_AT_CERTEXP4((SALT311.StrType)le.AT_CERTEXP4);
    SELF.AT_CERTEXP5_Invalid := Base_Fields.InValid_AT_CERTEXP5((SALT311.StrType)le.AT_CERTEXP5);
    SELF.AT_CERTEXP6_Invalid := Base_Fields.InValid_AT_CERTEXP6((SALT311.StrType)le.AT_CERTEXP6);
    SELF.AT_CERTEXP7_Invalid := Base_Fields.InValid_AT_CERTEXP7((SALT311.StrType)le.AT_CERTEXP7);
    SELF.AT_CERTEXP8_Invalid := Base_Fields.InValid_AT_CERTEXP8((SALT311.StrType)le.AT_CERTEXP8);
    SELF.AT_CERTEXP9_Invalid := Base_Fields.InValid_AT_CERTEXP9((SALT311.StrType)le.AT_CERTEXP9);
    SELF.AT_CERTEXP10_Invalid := Base_Fields.InValid_AT_CERTEXP10((SALT311.StrType)le.AT_CERTEXP10);
    SELF.EFX_EXTRACT_DATE_Invalid := Base_Fields.InValid_EFX_EXTRACT_DATE((SALT311.StrType)le.EFX_EXTRACT_DATE);
    SELF.EFX_MERCHANT_ID_Invalid := Base_Fields.InValid_EFX_MERCHANT_ID((SALT311.StrType)le.EFX_MERCHANT_ID);
    SELF.EFX_PROJECT_ID_Invalid := Base_Fields.InValid_EFX_PROJECT_ID((SALT311.StrType)le.EFX_PROJECT_ID);
    SELF.EFX_FOREIGN_Invalid := Base_Fields.InValid_EFX_FOREIGN((SALT311.StrType)le.EFX_FOREIGN);
    SELF.Record_Update_Refresh_Date_Invalid := Base_Fields.InValid_Record_Update_Refresh_Date((SALT311.StrType)le.Record_Update_Refresh_Date);
    SELF.EFX_DATE_CREATED_Invalid := Base_Fields.InValid_EFX_DATE_CREATED((SALT311.StrType)le.EFX_DATE_CREATED);
    SELF := le;
  END;
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    ...
    SELF.ScrubsBits2 := ( le.EFX_MRKT_TOTALIND_Invalid << 0 ) + ( le.EFX_MRKT_TOTALSCORE_Invalid << 1 ) + ( le.EFX_PUBLIC_Invalid << 2 ) + ( le.EFX_STKEXC_Invalid << 3 ) + ( le.EFX_PRIMSIC_Invalid << 4 ) + ( le.EFX_SECSIC1_Invalid << 5 ) + ( le.EFX_SECSIC2_Invalid << 6 ) + ( le.EFX_SECSIC3_Invalid << 7 ) + ( le.EFX_SECSIC4_Invalid << 8 ) + ( le.EFX_ID_Invalid << 9 ) + ( le.EFX_CITY_Invalid << 10 ) + ( le.EFX_CTRYNAME_Invalid << 11 ) + ( le.EFX_COUNTYNM_Invalid << 12 ) + ( le.EFX_COUNTY_Invalid << 13 ) + ( le.EFX_SOHO_Invalid << 14 ) + ( le.EFX_BIZ_Invalid << 15 ) + ( le.EFX_RES_Invalid << 16 ) + ( le.EFX_CMRA_Invalid << 17 ) + ( le.EFX_SECGEOPREC_Invalid << 18 ) + ( le.EFX_SECCTRYISOCD_Invalid << 19 ) + ( le.EFX_SECCTRYNUM_Invalid << 20 ) + ( le.EFX_PHONE_Invalid << 21 ) + ( le.EFX_FAXPHONE_Invalid << 22 ) + ( le.EFX_YREST_Invalid << 23 ) + ( le.EFX_CORPEMPCNT_Invalid << 24 ) + ( le.EFX_LOCEMPCNT_Invalid << 25 ) + ( le.EFX_LOCEMPCD_Invalid << 26 ) + ( le.EFX_CORPAMOUNT_Invalid << 27 ) + ( le.EFX_LOCAMOUNT_Invalid << 28 ) + ( le.EFX_LOCAMOUNTCD_Invalid << 29 ) + ( le.EFX_LOCAMOUNTTP_Invalid << 30 ) + ( le.EFX_LOCAMOUNTPREC_Invalid << 31 ) + ( le.EFX_PRIMNAICSCODE_Invalid << 32 ) + ( le.EFX_SECNAICS1_Invalid << 33 ) + ( le.EFX_SECNAICS2_Invalid << 34 ) + ( le.EFX_SECNAICS3_Invalid << 35 ) + ( le.EFX_SECNAICS4_Invalid << 36 ) + ( le.EFX_DEAD_Invalid << 37 ) + ( le.EFX_DEADDT_Invalid << 38 ) + ( le.EFX_MRKT_TELEVER_Invalid << 39 ) + ( le.EFX_MRKT_VACANT_Invalid << 40 ) + ( le.EFX_MRKT_SEASONAL_Invalid << 41 ) + ( le.EFX_MBE_Invalid << 42 ) + ( le.EFX_WBE_Invalid << 43 ) + ( le.EFX_MWBE_Invalid << 44 ) + ( le.EFX_SDB_Invalid << 45 ) + ( le.EFX_HUBZONE_Invalid << 46 ) + ( le.EFX_DBE_Invalid << 47 ) + ( le.EFX_VET_Invalid << 48 ) + ( le.EFX_DVET_Invalid << 49 ) + ( le.EFX_8a_Invalid << 50 ) + ( le.EFX_8aEXPDT_Invalid << 51 ) + ( le.EFX_DIS_Invalid << 52 ) + ( le.EFX_SBE_Invalid << 53 ) + ( le.EFX_BUSSIZE_Invalid << 54 ) + ( le.EFX_LBE_Invalid << 55 ) + ( le.EFX_GOV_Invalid << 56 ) + ( le.EFX_FGOV_Invalid << 57 ) + ( le.EFX_NONPROFIT_Invalid << 58 ) + ( le.EFX_HBCU_Invalid << 59 ) + ( le.EFX_GAYLESBIAN_Invalid << 60 ) + ( le.EFX_WSBE_Invalid << 61 ) + ( le.EFX_VSBE_Invalid << 62 ) + ( le.EFX_DVSBE_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.EFX_MWBESTATUS_Invalid << 0 ) + ( le.EFX_NMSDC_Invalid << 1 ) + ( le.EFX_WBENC_Invalid << 2 ) + ( le.EFX_CA_PUC_Invalid << 3 ) + ( le.EFX_TX_HUB_Invalid << 4 ) + ( le.EFX_GSAX_Invalid << 5 ) + ( le.EFX_CALTRANS_Invalid << 6 ) + ( le.EFX_EDU_Invalid << 7 ) + ( le.EFX_MI_Invalid << 8 ) + ( le.EFX_ANC_Invalid << 9 ) + ( le.AT_CERTLEV1_Invalid << 10 ) + ( le.AT_CERTLEV2_Invalid << 11 ) + ( le.AT_CERTLEV3_Invalid << 12 ) + ( le.AT_CERTLEV4_Invalid << 13 ) + ( le.AT_CERTLEV5_Invalid << 14 ) + ( le.AT_CERTLEV6_Invalid << 15 ) + ( le.AT_CERTLEV7_Invalid << 16 ) + ( le.AT_CERTLEV8_Invalid << 17 ) + ( le.AT_CERTLEV9_Invalid << 18 ) + ( le.AT_CERTLEV10_Invalid << 19 ) + ( le.AT_CERTEXP1_Invalid << 20 ) + ( le.AT_CERTEXP2_Invalid << 21 ) + ( le.AT_CERTEXP3_Invalid << 22 ) + ( le.AT_CERTEXP4_Invalid << 23 ) + ( le.AT_CERTEXP5_Invalid << 24 ) + ( le.AT_CERTEXP6_Invalid << 25 ) + ( le.AT_CERTEXP7_Invalid << 26 ) + ( le.AT_CERTEXP8_Invalid << 27 ) + ( le.AT_CERTEXP9_Invalid << 28 ) + ( le.AT_CERTEXP10_Invalid << 29 ) + ( le.EFX_EXTRACT_DATE_Invalid << 30 ) + ( le.EFX_MERCHANT_ID_Invalid << 31 ) + ( le.EFX_PROJECT_ID_Invalid << 32 ) + ( le.EFX_FOREIGN_Invalid << 33 ) + ( le.Record_Update_Refresh_Date_Invalid << 34 ) + ( le.EFX_DATE_CREATED_Invalid << 35 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.EFX_COUNTYNM_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.EFX_COUNTY_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.EFX_SOHO_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.EFX_BIZ_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.EFX_RES_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.EFX_CMRA_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.EFX_SECGEOPREC_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.EFX_SECCTRYISOCD_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.EFX_SECCTRYNUM_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.EFX_PHONE_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.EFX_FAXPHONE_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.EFX_YREST_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.EFX_CORPEMPCNT_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.EFX_LOCEMPCNT_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.EFX_LOCEMPCD_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.EFX_CORPAMOUNT_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.EFX_LOCAMOUNT_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.EFX_LOCAMOUNTCD_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.EFX_LOCAMOUNTTP_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.EFX_LOCAMOUNTPREC_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.EFX_PRIMNAICSCODE_Invalid := (le.ScrubsBits2 >> 32) & 1;
    ...
    SELF.EFX_DEAD_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF.EFX_DEADDT_Invalid := (le.ScrubsBits2 >> 38) & 1;
    SELF.EFX_MRKT_TELEVER_Invalid := (le.ScrubsBits2 >> 39) & 1;
    SELF.EFX_MRKT_VACANT_Invalid := (le.ScrubsBits2 >> 40) & 1;
    SELF.EFX_MRKT_SEASONAL_Invalid := (le.ScrubsBits2 >> 41) & 1;
    SELF.EFX_MBE_Invalid := (le.ScrubsBits2 >> 42) & 1;
    SELF.EFX_WBE_Invalid := (le.ScrubsBits2 >> 43) & 1;
    SELF.EFX_MWBE_Invalid := (le.ScrubsBits2 >> 44) & 1;
    SELF.EFX_SDB_Invalid := (le.ScrubsBits2 >> 45) & 1;
    SELF.EFX_HUBZONE_Invalid := (le.ScrubsBits2 >> 46) & 1;
    SELF.EFX_DBE_Invalid := (le.ScrubsBits2 >> 47) & 1;
    SELF.EFX_VET_Invalid := (le.ScrubsBits2 >> 48) & 1;
    SELF.EFX_DVET_Invalid := (le.ScrubsBits2 >> 49) & 1;
    SELF.EFX_8a_Invalid := (le.ScrubsBits2 >> 50) & 1;
    SELF.EFX_8aEXPDT_Invalid := (le.ScrubsBits2 >> 51) & 1;
    SELF.EFX_DIS_Invalid := (le.ScrubsBits2 >> 52) & 1;
    SELF.EFX_SBE_Invalid := (le.ScrubsBits2 >> 53) & 1;
    SELF.EFX_BUSSIZE_Invalid := (le.ScrubsBits2 >> 54) & 1;
    SELF.EFX_LBE_Invalid := (le.ScrubsBits2 >> 55) & 1;
    SELF.EFX_GOV_Invalid := (le.ScrubsBits2 >> 56) & 1;
    SELF.EFX_FGOV_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.EFX_NONPROFIT_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.EFX_HBCU_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.EFX_GAYLESBIAN_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.EFX_WSBE_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.EFX_VSBE_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.EFX_DVSBE_Invalid := (le.ScrubsBits2 >> 63) & 1;
    SELF.EFX_MWBESTATUS_Invalid := (le.ScrubsBits3 >> 0) & 1;
    SELF.EFX_NMSDC_Invalid := (le.ScrubsBits3 >> 1) & 1;
    SELF.EFX_WBENC_Invalid := (le.ScrubsBits3 >> 2) & 1;
    SELF.EFX_CA_PUC_Invalid := (le.ScrubsBits3 >> 3) & 1;
    SELF.EFX_TX_HUB_Invalid := (le.ScrubsBits3 >> 4) & 1;
    SELF.EFX_GSAX_Invalid := (le.ScrubsBits3 >> 5) & 1;
    SELF.EFX_CALTRANS_Invalid := (le.ScrubsBits3 >> 6) & 1;
    SELF.EFX_EDU_Invalid := (le.ScrubsBits3 >> 7) & 1;
    SELF.EFX_MI_Invalid := (le.ScrubsBits3 >> 8) & 1;
    SELF.EFX_ANC_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.AT_CERTLEV1_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF.AT_CERTLEV2_Invalid := (le.ScrubsBits3 >> 11) & 1;
    SELF.AT_CERTLEV3_Invalid := (le.ScrubsBits3 >> 12) & 1;
    SELF.AT_CERTLEV4_Invalid := (le.ScrubsBits3 >> 13) & 1;
    SELF.AT_CERTLEV5_Invalid := (le.ScrubsBits3 >> 14) & 1;
    SELF.AT_CERTLEV6_Invalid := (le.ScrubsBits3 >> 15) & 1;
    SELF.AT_CERTLEV7_Invalid := (le.ScrubsBits3 >> 16) & 1;
    SELF.AT_CERTLEV8_Invalid := (le.ScrubsBits3 >> 17) & 1;
    SELF.AT_CERTLEV9_Invalid := (le.ScrubsBits3 >> 18) & 1;
    SELF.AT_CERTLEV10_Invalid := (le.ScrubsBits3 >> 19) & 1;
    SELF.AT_CERTEXP1_Invalid := (le.ScrubsBits3 >> 20) & 1;
    SELF.AT_CERTEXP2_Invalid := (le.ScrubsBits3 >> 21) & 1;
    SELF.AT_CERTEXP3_Invalid := (le.ScrubsBits3 >> 22) & 1;
    SELF.AT_CERTEXP4_Invalid := (le.ScrubsBits3 >> 23) & 1;
    SELF.AT_CERTEXP5_Invalid := (le.ScrubsBits3 >> 24) & 1;
    SELF.AT_CERTEXP6_Invalid := (le.ScrubsBits3 >> 25) & 1;
    SELF.AT_CERTEXP7_Invalid := (le.ScrubsBits3 >> 26) & 1;
    SELF.AT_CERTEXP8_Invalid := (le.ScrubsBits3 >> 27) & 1;
    SELF.AT_CERTEXP9_Invalid := (le.ScrubsBits3 >> 28) & 1;
    SELF.AT_CERTEXP10_Invalid := (le.ScrubsBits3 >> 29) & 1;
    SELF.EFX_EXTRACT_DATE_Invalid := (le.ScrubsBits3 >> 30) & 1;
    SELF.EFX_MERCHANT_ID_Invalid := (le.ScrubsBits3 >> 31) & 1;
    SELF.EFX_PROJECT_ID_Invalid := (le.ScrubsBits3 >> 32) & 1;
    SELF.EFX_FOREIGN_Invalid := (le.ScrubsBits3 >> 33) & 1;
    SELF.Record_Update_Refresh_Date_Invalid := (le.ScrubsBits3 >> 34) & 1;
    SELF.EFX_DATE_CREATED_Invalid := (le.ScrubsBits3 >> 35) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  END;
  EXPORT AllErrors := NORMALIZE(h,164,Into(LEFT,COUNTER));
   bv := TABLE(AllErrors,{FieldContents, FieldName, Cnt := COUNT(GROUP)},FieldContents, FieldName,MERGE);
  EXPORT BadValues := TOPN(bv,1000,-Cnt);
  // Particular form of stats required for Orbit
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Base_Layout_Equifax_Business_Data) prevDS = DATASET([], Base_Layout_Equifax_Business_Data), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Base_Fields.InvalidMessage_EFX_COUNTYNM(1)
          ,Base_Fields.InvalidMessage_EFX_COUNTY(1)
          ...
          ,Base_Fields.InvalidMessage_EFX_DATE_CREATED(1)
          ,'Fields with errors'
    ...
    mod_hygiene := Base_hygiene(PROJECT(h, Base_Layout_Equifax_Business_Data));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ErrorMessage := '';
    END;
    FieldPopStats := NORMALIZE(hygiene_summaryStats,227,xNormHygieneStats(LEFT,COUNTER,'POP'));
  ...
  // record count stats
    ...
    mod_Delta := Base_Delta(prevDS, PROJECT(h, Base_Layout_Equifax_Business_Data));
    deltaHygieneSummary := mod_Delta.DifferenceSummary;
    DeltaFieldPopStats := NORMALIZE(deltaHygieneSummary(txt <> 'New'),227,xNormHygieneStats(LEFT,COUNTER,'DELTA'));
...
EXPORT StandardStats(DATASET(Base_Layout_Equifax_Business_Data) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_Equifax_Business_Data, Base_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
