...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),241*241,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dotid'}
      ...
      ,{62,'ace_aid'}
      ,{63,'prep_addr_line1'}
      ,{64,'prep_addr_line_last'}
      ,{65,'EFX_BUSSTATCD'}
      ,{66,'EFX_CMSA'}
      ,{67,'EFX_CORPAMOUNTCD'}
      ,{68,'EFX_CORPAMOUNTPREC'}
      ,{69,'EFX_CORPAMOUNTTP'}
      ,{70,'EFX_CORPEMPCD'}
      ,{71,'EFX_WEB'}
      ,{72,'EFX_CTRYISOCD'}
      ...
      ,{78,'EFX_MRKT_TOTALIND'}
      ,{79,'EFX_MRKT_TOTALSCORE'}
      ,{80,'EFX_PUBLIC'}
      ,{81,'EFX_STATEC'}
      ,{82,'EFX_STKEXC'}
      ,{83,'EFX_PRIMSIC'}
      ...
      ,{127,'EFX_SECSICDESC3'}
      ,{128,'EFX_SECSICDESC4'}
      ,{129,'EFX_PRIMNAICSCODE'}
      ,{130,'EFX_SECNAICS1'}
      ,{131,'EFX_SECNAICS2'}
      ,{132,'EFX_SECNAICS3'}
      ,{133,'EFX_SECNAICS4'}
      ,{134,'EFX_PRIMNAICSDESC'}
      ,{135,'EFX_SECNAICSDESC1'}
      ,{136,'EFX_SECNAICSDESC2'}
      ,{137,'EFX_SECNAICSDESC3'}
      ,{138,'EFX_SECNAICSDESC4'}
      ,{139,'EFX_DEAD'}
      ,{140,'EFX_DEADDT'}
      ,{141,'EFX_MRKT_TELEVER'}
      ,{142,'EFX_MRKT_VACANT'}
      ,{143,'EFX_MRKT_SEASONAL'}
      ,{144,'EFX_MBE'}
      ,{145,'EFX_WBE'}
      ,{146,'EFX_MWBE'}
      ,{147,'EFX_SDB'}
      ...
      ,{234,'AT_CERTEXP9'}
      ,{235,'AT_CERTEXP10'}
      ,{236,'EFX_EXTRACT_DATE'}
      ,{237,'EFX_MERCHANT_ID'}
      ,{238,'EFX_PROJECT_ID'}
      ,{239,'EFX_FOREIGN'}
      ,{240,'Record_Update_Refresh_Date'}
      ,{241,'EFX_DATE_CREATED'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_did_score((SALT37.StrType)le.did_score),
...
END;
Errors := NORMALIZE(h,241,NoteErrors(LEFT,COUNTER));
