...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),226*226,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dotid'}
      ...
      ,{112,'EFX_SECSICDESC3'}
      ,{113,'EFX_SECSICDESC4'}
      ,{114,'EFX_PRIMNAICSCODE'}
      ,{115,'EFX_SECNAICS1'}
      ,{116,'EFX_SECNAICS2'}
      ,{117,'EFX_SECNAICS3'}
      ,{118,'EFX_SECNAICS4'}
      ,{119,'EFX_PRIMNAICSDESC'}
      ,{120,'EFX_SECNAICSDESC1'}
      ,{121,'EFX_SECNAICSDESC2'}
      ,{122,'EFX_SECNAICSDESC3'}
      ,{123,'EFX_SECNAICSDESC4'}
      ,{124,'EFX_DEAD'}
      ,{125,'EFX_DEADDT'}
      ,{126,'EFX_MRKT_TELEVER'}
      ,{127,'EFX_MRKT_VACANT'}
      ,{128,'EFX_MRKT_SEASONAL'}
      ,{129,'EFX_MBE'}
      ,{130,'EFX_WBE'}
      ,{131,'EFX_MWBE'}
      ,{132,'EFX_SDB'}
      ...
      ,{219,'AT_CERTEXP9'}
      ,{220,'AT_CERTEXP10'}
      ,{221,'EFX_EXTRACT_DATE'}
      ,{222,'EFX_MERCHANT_ID'}
      ,{223,'EFX_PROJECT_ID'}
      ,{224,'EFX_FOREIGN'}
      ,{225,'Record_Update_Refresh_Date'}
      ,{226,'EFX_DATE_CREATED'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_norm_state((SALT37.StrType)le.norm_state),
    Base_Fields.InValid_norm_zip((SALT37.StrType)le.norm_zip),
    Base_Fields.InValid_norm_zip4((SALT37.StrType)le.norm_zip4),
...
END;
Errors := NORMALIZE(h,226,NoteErrors(LEFT,COUNTER));
