...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),236*236,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dotid'}
      ...
      ,{122,'EFX_SECSICDESC3'}
      ,{123,'EFX_SECSICDESC4'}
      ,{124,'EFX_PRIMNAICSCODE'}
      ,{125,'EFX_SECNAICS1'}
      ,{126,'EFX_SECNAICS2'}
      ,{127,'EFX_SECNAICS3'}
      ,{128,'EFX_SECNAICS4'}
      ,{129,'EFX_PRIMNAICSDESC'}
      ,{130,'EFX_SECNAICSDESC1'}
      ,{131,'EFX_SECNAICSDESC2'}
      ,{132,'EFX_SECNAICSDESC3'}
      ,{133,'EFX_SECNAICSDESC4'}
      ,{134,'EFX_DEAD'}
      ,{135,'EFX_DEADDT'}
      ,{136,'EFX_MRKT_TELEVER'}
      ,{137,'EFX_MRKT_VACANT'}
      ,{138,'EFX_MRKT_SEASONAL'}
      ,{139,'EFX_MBE'}
      ,{140,'EFX_WBE'}
      ,{141,'EFX_MWBE'}
      ,{142,'EFX_SDB'}
      ...
      ,{229,'AT_CERTEXP9'}
      ,{230,'AT_CERTEXP10'}
      ,{231,'EFX_EXTRACT_DATE'}
      ,{232,'EFX_MERCHANT_ID'}
      ,{233,'EFX_PROJECT_ID'}
      ,{234,'EFX_FOREIGN'}
      ,{235,'Record_Update_Refresh_Date'}
      ,{236,'EFX_DATE_CREATED'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_norm_state((SALT37.StrType)le.norm_state,(SALT37.StrType)le.EFX_CTRYNAME),
...
END;
Errors := NORMALIZE(h,236,NoteErrors(LEFT,COUNTER));
