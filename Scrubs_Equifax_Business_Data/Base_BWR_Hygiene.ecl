...
#workunit('name','Scrubs_Equifax_Business_Data.Base_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
...
// First create an instantiated hygiene module
  ...
  h := Scrubs_Equifax_Business_Data.Base_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_Layout_Equifax_Business_Data'),NAMED('OptimizedLayout'));// File layout suggested by data
