...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),185*185,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dt_first_seen'}
      ...
      ,{70,'EFX_SECSICDESC3'}
      ,{71,'EFX_SECSICDESC4'}
      ,{72,'EFX_PRIMNAICSCODE'}
      ,{73,'EFX_SECNAICS1'}
      ,{74,'EFX_SECNAICS2'}
      ,{75,'EFX_SECNAICS3'}
      ,{76,'EFX_SECNAICS4'}
      ,{77,'EFX_PRIMNAICSDESC'}
      ,{78,'EFX_SECNAICSDESC1'}
      ,{79,'EFX_SECNAICSDESC2'}
      ,{80,'EFX_SECNAICSDESC3'}
      ,{81,'EFX_SECNAICSDESC4'}
      ,{82,'EFX_DEAD'}
      ,{83,'EFX_DEADDT'}
      ,{84,'EFX_MRKT_TELEVER'}
      ,{85,'EFX_MRKT_VACANT'}
      ,{86,'EFX_MRKT_SEASONAL'}
      ,{87,'EFX_MBE'}
      ,{88,'EFX_WBE'}
      ,{89,'EFX_MWBE'}
      ,{90,'EFX_SDB'}
      ...
      ,{178,'AT_CERTEXP9'}
      ,{179,'AT_CERTEXP10'}
      ,{180,'EFX_EXTRACT_DATE'}
      ,{181,'EFX_MERCHANT_ID'}
      ,{182,'EFX_PROJECT_ID'}
      ,{183,'EFX_FOREIGN'}
      ,{184,'Record_Update_Refresh_Date'}
      ,{185,'EFX_DATE_CREATED'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Input_Fields.InValid_norm_state((SALT37.StrType)le.norm_state),
    Input_Fields.InValid_norm_zip((SALT37.StrType)le.norm_zip),
    Input_Fields.InValid_norm_zip4((SALT37.StrType)le.norm_zip4),
...
END;
Errors := NORMALIZE(h,185,NoteErrors(LEFT,COUNTER));
