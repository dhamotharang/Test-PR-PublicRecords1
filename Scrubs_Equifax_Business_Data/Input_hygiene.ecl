...
SHARED FldIds := DATASET([{1,'dt_first_seen'}
      ...
      ,{25,'EFX_GEOPREC'}
      ,{26,'EFX_MERCTYPE'}
      ,{27,'EFX_MRKT_TELESCORE'}
      ,{28,'EFX_MRKT_TOTALIND'}
      ,{29,'EFX_MRKT_TOTALSCORE'}
      ,{30,'EFX_PUBLIC'}
      ,{31,'EFX_STKEXC'}
      ,{32,'EFX_PRIMSIC'}
      ,{33,'EFX_SECSIC1'}
      ...
      ,{186,'EFX_DATE_CREATED'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Input_Fields.InValid_normaddress_type((SALT311.StrType)le.normaddress_type),
    Input_Fields.InValid_norm_state((SALT311.StrType)le.norm_state),
    Input_Fields.InValid_norm_zip((SALT311.StrType)le.norm_zip),
    Input_Fields.InValid_norm_zip4((SALT311.StrType)le.norm_zip4),
    ...
    Input_Fields.InValid_EFX_WEB((SALT311.StrType)le.EFX_WEB),
    ...
    Input_Fields.InValid_EFX_REGION((SALT311.StrType)le.EFX_REGION),
    ...
    Input_Fields.InValid_EFX_CMSADESC((SALT311.StrType)le.EFX_CMSADESC),
    ...
    Input_Fields.InValid_EFX_SECADR((SALT311.StrType)le.EFX_SECADR),
    Input_Fields.InValid_EFX_SECCTY((SALT311.StrType)le.EFX_SECCTY),
    Input_Fields.InValid_EFX_SECGEOPREC((SALT311.StrType)le.EFX_SECGEOPREC),
    Input_Fields.InValid_EFX_SECREGION((SALT311.StrType)le.EFX_SECREGION),
    ...
    Input_Fields.InValid_EFX_SECCTRYNAME((SALT311.StrType)le.EFX_SECCTRYNAME),
    ...
    Input_Fields.InValid_EFX_BUSSTAT((SALT311.StrType)le.EFX_BUSSTAT),
    ...
    Input_Fields.InValid_EFX_TCKSYM((SALT311.StrType)le.EFX_TCKSYM),
    Input_Fields.InValid_EFX_PRIMSICDESC((SALT311.StrType)le.EFX_PRIMSICDESC),
    Input_Fields.InValid_EFX_SECSICDESC1((SALT311.StrType)le.EFX_SECSICDESC1),
    Input_Fields.InValid_EFX_SECSICDESC2((SALT311.StrType)le.EFX_SECSICDESC2),
    Input_Fields.InValid_EFX_SECSICDESC3((SALT311.StrType)le.EFX_SECSICDESC3),
    Input_Fields.InValid_EFX_SECSICDESC4((SALT311.StrType)le.EFX_SECSICDESC4),
    ...
    Input_Fields.InValid_EFX_PRIMNAICSDESC((SALT311.StrType)le.EFX_PRIMNAICSDESC),
    Input_Fields.InValid_EFX_SECNAICSDESC1((SALT311.StrType)le.EFX_SECNAICSDESC1),
    Input_Fields.InValid_EFX_SECNAICSDESC2((SALT311.StrType)le.EFX_SECNAICSDESC2),
    Input_Fields.InValid_EFX_SECNAICSDESC3((SALT311.StrType)le.EFX_SECNAICSDESC3),
    Input_Fields.InValid_EFX_SECNAICSDESC4((SALT311.StrType)le.EFX_SECNAICSDESC4),
    ...
    Input_Fields.InValid_EFX_TX_HUBCERTNUM((SALT311.StrType)le.EFX_TX_HUBCERTNUM),
    ...
    Input_Fields.InValid_AT_CERT1((SALT311.StrType)le.AT_CERT1),
    Input_Fields.InValid_AT_CERT2((SALT311.StrType)le.AT_CERT2),
    Input_Fields.InValid_AT_CERT3((SALT311.StrType)le.AT_CERT3),
    Input_Fields.InValid_AT_CERT4((SALT311.StrType)le.AT_CERT4),
    Input_Fields.InValid_AT_CERT5((SALT311.StrType)le.AT_CERT5),
    Input_Fields.InValid_AT_CERT6((SALT311.StrType)le.AT_CERT6),
    Input_Fields.InValid_AT_CERT7((SALT311.StrType)le.AT_CERT7),
    Input_Fields.InValid_AT_CERT8((SALT311.StrType)le.AT_CERT8),
    Input_Fields.InValid_AT_CERT9((SALT311.StrType)le.AT_CERT9),
    Input_Fields.InValid_AT_CERT10((SALT311.StrType)le.AT_CERT10),
    Input_Fields.InValid_AT_CERTDESC1((SALT311.StrType)le.AT_CERTDESC1),
    Input_Fields.InValid_AT_CERTDESC2((SALT311.StrType)le.AT_CERTDESC2),
    Input_Fields.InValid_AT_CERTDESC3((SALT311.StrType)le.AT_CERTDESC3),
    Input_Fields.InValid_AT_CERTDESC4((SALT311.StrType)le.AT_CERTDESC4),
    Input_Fields.InValid_AT_CERTDESC5((SALT311.StrType)le.AT_CERTDESC5),
    Input_Fields.InValid_AT_CERTDESC6((SALT311.StrType)le.AT_CERTDESC6),
    Input_Fields.InValid_AT_CERTDESC7((SALT311.StrType)le.AT_CERTDESC7),
    Input_Fields.InValid_AT_CERTDESC8((SALT311.StrType)le.AT_CERTDESC8),
    Input_Fields.InValid_AT_CERTDESC9((SALT311.StrType)le.AT_CERTDESC9),
    Input_Fields.InValid_AT_CERTDESC10((SALT311.StrType)le.AT_CERTDESC10),
    Input_Fields.InValid_AT_CERTSRC1((SALT311.StrType)le.AT_CERTSRC1),
    Input_Fields.InValid_AT_CERTSRC2((SALT311.StrType)le.AT_CERTSRC2),
    Input_Fields.InValid_AT_CERTSRC3((SALT311.StrType)le.AT_CERTSRC3),
    Input_Fields.InValid_AT_CERTSRC4((SALT311.StrType)le.AT_CERTSRC4),
    Input_Fields.InValid_AT_CERTSRC5((SALT311.StrType)le.AT_CERTSRC5),
    Input_Fields.InValid_AT_CERTSRC6((SALT311.StrType)le.AT_CERTSRC6),
    Input_Fields.InValid_AT_CERTSRC7((SALT311.StrType)le.AT_CERTSRC7),
    Input_Fields.InValid_AT_CERTSRC8((SALT311.StrType)le.AT_CERTSRC8),
    Input_Fields.InValid_AT_CERTSRC9((SALT311.StrType)le.AT_CERTSRC9),
    Input_Fields.InValid_AT_CERTSRC10((SALT311.StrType)le.AT_CERTSRC10),
    ...
    Input_Fields.InValid_AT_CERTNUM1((SALT311.StrType)le.AT_CERTNUM1),
    Input_Fields.InValid_AT_CERTNUM2((SALT311.StrType)le.AT_CERTNUM2),
    Input_Fields.InValid_AT_CERTNUM3((SALT311.StrType)le.AT_CERTNUM3),
    Input_Fields.InValid_AT_CERTNUM4((SALT311.StrType)le.AT_CERTNUM4),
    Input_Fields.InValid_AT_CERTNUM5((SALT311.StrType)le.AT_CERTNUM5),
    Input_Fields.InValid_AT_CERTNUM6((SALT311.StrType)le.AT_CERTNUM6),
    Input_Fields.InValid_AT_CERTNUM7((SALT311.StrType)le.AT_CERTNUM7),
    Input_Fields.InValid_AT_CERTNUM8((SALT311.StrType)le.AT_CERTNUM8),
    Input_Fields.InValid_AT_CERTNUM9((SALT311.StrType)le.AT_CERTNUM9),
    Input_Fields.InValid_AT_CERTNUM10((SALT311.StrType)le.AT_CERTNUM10),
