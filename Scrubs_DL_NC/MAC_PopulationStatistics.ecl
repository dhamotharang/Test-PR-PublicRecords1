...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_process_date = '',Input_customer_id = '',Input_license_number = '',Input_firstname = '',Input_middlename = '',Input_lastname = '',Input_suffix = '',Input_address1 = '',Input_address2 = '',Input_city = '',Input_state = '',Input_zip = '',Input_dob = '',Input_licensetype = '',Input_issuedate = '',Input_expiration = '',Input_restriction1 = '',Input_restriction2 = '',Input_restriction3 = '',Input_restriction4 = '',Input_restriction5 = '',Input_status = '',Input_title = '',Input_fname = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',Input_cleaning_score = '',Input_prim_range = '',Input_predir = '',Input_prim_name = '',Input_addr_suffix = '',Input_postdir = '',Input_unit_desig = '',Input_sec_range = '',Input_p_city_name = '',Input_v_city_name = '',Input_st = '',Input_zip5 = '',Input_zip4 = '',Input_cart = '',Input_cr_sort_sz = '',Input_lot = '',Input_lot_order = '',Input_dpbc = '',Input_chk_digit = '',Input_rec_type = '',Input_ace_fips_st = '',Input_county = '',Input_geo_lat = '',Input_geo_long = '',Input_msa = '',Input_geo_blk = '',Input_geo_match = '',Input_err_stat = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_issuedate)='' )
      '' 
    #ELSE
        IF( le.Input_issuedate = (TYPEOF(le.Input_issuedate))'','',':issuedate')
    #END
 
+    #IF( #TEXT(Input_expiration)='' )
      '' 
    #ELSE
        IF( le.Input_expiration = (TYPEOF(le.Input_expiration))'','',':expiration')
    #END
 
+    #IF( #TEXT(Input_restriction1)='' )
      '' 
    #ELSE
        IF( le.Input_restriction1 = (TYPEOF(le.Input_restriction1))'','',':restriction1')
    #END
 
+    #IF( #TEXT(Input_restriction2)='' )
      '' 
    #ELSE
        IF( le.Input_restriction2 = (TYPEOF(le.Input_restriction2))'','',':restriction2')
    #END
 
+    #IF( #TEXT(Input_restriction3)='' )
      '' 
    #ELSE
        IF( le.Input_restriction3 = (TYPEOF(le.Input_restriction3))'','',':restriction3')
    #END
 
+    #IF( #TEXT(Input_restriction4)='' )
      '' 
    #ELSE
        IF( le.Input_restriction4 = (TYPEOF(le.Input_restriction4))'','',':restriction4')
    #END
 
+    #IF( #TEXT(Input_restriction5)='' )
      '' 
    #ELSE
        IF( le.Input_restriction5 = (TYPEOF(le.Input_restriction5))'','',':restriction5')
    #END
