...
R ProcessConceptScaling(cfk le) := TRANSFORM
  REAL FULLNAME_DOB_score_scale := 1.0; // No scaling required
  ...
  self.DOB_year_weight100 := le.DOB_year_weight100; // Precompute the scale
  self.DOB_month_weight100 := le.DOB_month_weight100;
  self.DOB_day_weight100 := le.DOB_day_weight100;
