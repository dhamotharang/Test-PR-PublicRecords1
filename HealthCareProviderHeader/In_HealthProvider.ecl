...
export In_HealthProvider := HealthCareProvider.Files.Person_Salt_Output_DS; // ('~ thor::base::healthcareprovider::person::salt::output::w20140127-044459',HealthCareProvider.Layout_HealthProvider.HealthCareProvider_Header,THOR);
