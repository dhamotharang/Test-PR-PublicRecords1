...
#workunit('name','HealthCareProviderHeader.BWR_Iterate - Internal Linking - SALT V2.9 Gold');
...
P := HealthCareProviderHeader.Proc_Iterate('1'); // Change '1' for later iterations
...
//SALT29.MAC_MatchSamplePatterns(HealthCareProviderHeader.Keys(HealthCareProviderHeader.In_HealthProvider).MatchSample,MatchPatterns,LNPID1,LNPID2,8,42-48);
