...
CM := HealthCareProviderHeader.Best(TheData,s,TRUE);
...
OUTPUT(CM.UniqueSingleValue_tab_DERIVED_GENDER,NAMED('Tab_UniqueSingleValue_DERIVED_GENDER'));
OUTPUT(CM.UniqueSingleValue_method_DERIVED_GENDER,NAMED('Method_UniqueSingleValue_DERIVED_GENDER'));
