EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT29.Str30Type fieldname := #TEXT(infield);
	  SALT29.StrType fieldvalue {maxlength(200000)} := (SALT29.StrType)infile.infield ;
		SALT29.StrType src {maxlength(30)} := infile.srcfield ;
