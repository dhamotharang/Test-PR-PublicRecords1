...
module 
	...
	pBase_Dist        := distribute(inBaseSuspectIP, hash(orig_ip));	
		...
		FraudDefenseNetwork.Layouts.Base.SuspectIP getSrcRid (pDataset_Dist l, pBase_dist r) := transform
...
// Return
	...
	if(tools.fun_IsValidVersion(pversion)
		,full_build
		,output('No Valid version parameter passed, skipping Build_Base_SuspectIP atribute')
	);
