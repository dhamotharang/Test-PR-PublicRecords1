      ...
      Public_Offenses_slim_lay := {Public_Offenses.offender_key; Public_Offenses.stc_desc_2; Public_Offenses.off_desc_1; Public_Offenses.off_desc_2; string8 st_start_dt; Public_Offenses.off_date;  
                                   Public_Offenses.convict_dt; Public_Offenses.ct_disp_dt; Public_Offenses.stc_dt; Public_Offenses.inc_adm_dt};
      Court_Offenses_slim_lay := {Court_Offenses.offender_key; Court_Offenses.court_disp_desc_1; Court_Offenses.court_off_desc_1; Court_Offenses.court_off_desc_2;  
                                  Court_Offenses.off_date; Court_Offenses.convict_dt; Court_Offenses.court_disp_date; Court_Offenses.sent_date};
    ...
    //DOC
      ...
      temp_layout1 := {Unq_offenders; string150 off_desc; string75 off_desc_1; string50 off_desc_2; string8 off_date;
                       ...
                       string8 event_date};
      JDOC := JOIN(Unq_Public_Offenses, Unq_offenders, left.offender_key = right.offender_key, transform(temp_layout1,
                    self := right,
    ...
    //AOC
      ...
      Layouts.Base.TextMinedCrim tPrep(Layouts.Input.TextMinedCrim pInput) :=
                               transform
                                   ...
                                   self.Unique_Id := 0;
                                   self.global_sid := 0; //Added for CCPA Compliance
                                   self.record_sid := 0; //Added for CCPA Compliance
                                   self.Source := 'CRIM';
    ...
    //Return
      ...
      export All := if(
                        tools.fun_IsValidVersion(pversion), full_build, output('No Valid version parameter passed, skipping Build_Base_TextMinedCrim atribute')
                       );
