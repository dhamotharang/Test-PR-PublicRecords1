...
dist_erie                        := DISTRIBUTE(erie_base_BID, hash32(claimnumber,cleaned_name.fname,cleaned_name.lname,typeofloss, dateofloss, dateio, findings, responsibleparty, policynumber, cleaned_name_cp.fname, cleaned_name_cp.lname));
...
dist_erieWL                        := DISTRIBUTE(erieWL_base_BID, hash32(alertnumber, firstname, lastname, business_name, ssn,  dob, validstartDate, entity ));
...
dist_oig                        := DISTRIBUTE(oig_base_BID, hash32(did, bdid));
