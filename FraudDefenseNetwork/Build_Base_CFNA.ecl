...
export Build_Base_CFNA (
                         string pversion, dataset(Layouts.Base.CFNA) inBaseCFNA = Files().Base.CFNA.QA
  ...
  //Rollup Update and previous base
   ...
   //Return
    ...
    export All := if(
                      tools.fun_IsValidVersion(pversion), full_build, output('No Valid version parameter passed, skipping Build_Base_CFNA atribute')
                    );
end;