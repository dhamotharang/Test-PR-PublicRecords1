...
f := File_IRS5500_Base(spons_sign_name_score > 80);

// Project to business contact format, then do some filtering.
Business_Header.Layout_Business_Contact_Full Proj(f l) := TRANSFORM
...
EXPORT IRS5500_As_Business_Contact := contacts : PERSIST('TEMP::IRS5500_As_Business_Contact');