...
EXPORT GetTufaPicklistVerification(DATASET(iesp.tu_fraud_alert.t_TuFraudAlertResponseEx) ds_tufa_soap_response) := FUNCTION
	...
	tufa_plist_req := IF(is_soap_call_ok, DATASET([FCRAGateway_Services.TuFraudAlert_Transforms.output_to_picklist(soap_response)]));
