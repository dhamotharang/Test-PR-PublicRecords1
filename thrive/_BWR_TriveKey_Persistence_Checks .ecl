...
CalculateStatsResults   :=  DOPSGrowthCheck.CalculateStats('FCRA_ThriveKeys','Thrive.Keys(filedate).Did_fcra.New','Key_Thrive','~thor_data400::key::thrive::fcra::' + filedate + '::did','did','persistent_record_id','','','','',filedate,father_filedate);	

DeltaCommandResults     :=  DOPSGrowthCheck.DeltaCommand('~thor_data400::key::thrive::fcra::' + filedate + '::did','~thor_data400::key::thrive::fcra::' + father_filedate + '::did','FCRA_ThriveKeys','Key_Thrive','Thrive.Keys(filedate).Did_fcra.New','persistent_record_id',filedate,father_filedate,['persistent_record_id']);

ChangesByFieldResults   :=  DOPSGrowthCheck.ChangesByField('~thor_data400::key::thrive::fcra::' + filedate + '::did','~thor_data400::key::thrive::fcra::' + father_filedate + '::did','FCRA_ThriveKeys','Key_Thrive','Thrive.Keys(filedate).Did_fcra.New','persistent_record_id','',filedate,father_filedate);

PersistenceCheckResults :=  DopsGrowthCheck.PersistenceCheck('~thor_data400::key::thrive::fcra::' + filedate + '::did','~thor_data400::key::thrive::fcra::' + father_filedate + '::did','FCRA_ThriveKeys','Key_Thrive','Thrive.Keys(filedate).Did_fcra.New','persistent_record_id',Key_Thrive_InputSet,Key_Thrive_InputSet,filedate,father_filedate);
