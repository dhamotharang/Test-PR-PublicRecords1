...
//respectively. The workunits need to go to QA_PlatFormComparisonSummary as WU_ProxSpec_Before and WU_ProxSpec_After 
...
//h:=dataset('~thor::cemtemp::ProxInput_CA',rec, THOR, OPT);
h:=dataset('~thor::cemtemp::ProxInput_CAnew',BIPV2_Testing.Test_Layout, THOR, OPT);
SpecMod := BIPV2_ProxID_Platform.specificities(h);
sequential(
  SpecMod.Build
  ,parallel(
