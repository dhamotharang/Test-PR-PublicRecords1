...
EXPORT Summary(SALT39.Str30Type  txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_source_expanded := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_expanded)));
    avelength_source_expanded := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_expanded)),h.source_expanded<>(typeof(h.source_expanded))'');
    ...
    maxlength_rcid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.rcid)));
    avelength_rcid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.rcid)),h.rcid<>(typeof(h.rcid))'');
    ...
    maxlength_company_bdid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_bdid)));
    avelength_company_bdid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_bdid)),h.company_bdid<>(typeof(h.company_bdid))'');
    ...
    maxlength_company_name_type_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_type_raw)));
    avelength_company_name_type_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_type_raw)),h.company_name_type_raw<>(typeof(h.company_name_type_raw))'');
    ...
    maxlength_company_rawaid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_rawaid)));
    avelength_company_rawaid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_rawaid)),h.company_rawaid<>(typeof(h.company_rawaid))'');
    ...
    maxlength_company_address_prim_range := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_prim_range)));
    avelength_company_address_prim_range := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_prim_range)),h.company_address_prim_range<>(typeof(h.company_address_prim_range))'');
    ...
    maxlength_company_address_predir := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_predir)));
    avelength_company_address_predir := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_predir)),h.company_address_predir<>(typeof(h.company_address_predir))'');
    ...
    maxlength_company_address_prim_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_prim_name)));
    avelength_company_address_prim_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_prim_name)),h.company_address_prim_name<>(typeof(h.company_address_prim_name))'');
    ...
    maxlength_company_address_addr_suffix := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_addr_suffix)));
    avelength_company_address_addr_suffix := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_addr_suffix)),h.company_address_addr_suffix<>(typeof(h.company_address_addr_suffix))'');
    ...
    maxlength_company_address_postdir := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_postdir)));
    avelength_company_address_postdir := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_postdir)),h.company_address_postdir<>(typeof(h.company_address_postdir))'');
    ...
    maxlength_company_address_unit_desig := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_unit_desig)));
    avelength_company_address_unit_desig := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_unit_desig)),h.company_address_unit_desig<>(typeof(h.company_address_unit_desig))'');
    ...
    maxlength_company_address_sec_range := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_sec_range)));
    avelength_company_address_sec_range := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_sec_range)),h.company_address_sec_range<>(typeof(h.company_address_sec_range))'');
    ...
    maxlength_company_address_p_city_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_p_city_name)));
    avelength_company_address_p_city_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_p_city_name)),h.company_address_p_city_name<>(typeof(h.company_address_p_city_name))'');
    ...
    maxlength_company_address_v_city_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_v_city_name)));
    avelength_company_address_v_city_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_v_city_name)),h.company_address_v_city_name<>(typeof(h.company_address_v_city_name))'');
    ...
    maxlength_company_address_st := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_st)));
    avelength_company_address_st := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_st)),h.company_address_st<>(typeof(h.company_address_st))'');
    ...
    maxlength_company_address_zip := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_zip)));
    avelength_company_address_zip := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_zip)),h.company_address_zip<>(typeof(h.company_address_zip))'');
    ...
    maxlength_company_address_zip4 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_zip4)));
    avelength_company_address_zip4 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_zip4)),h.company_address_zip4<>(typeof(h.company_address_zip4))'');
    ...
    maxlength_company_address_cart := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_cart)));
    avelength_company_address_cart := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_cart)),h.company_address_cart<>(typeof(h.company_address_cart))'');
    ...
    maxlength_company_address_cr_sort_sz := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_cr_sort_sz)));
    avelength_company_address_cr_sort_sz := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_cr_sort_sz)),h.company_address_cr_sort_sz<>(typeof(h.company_address_cr_sort_sz))'');
    ...
    maxlength_company_address_lot := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_lot)));
    avelength_company_address_lot := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_lot)),h.company_address_lot<>(typeof(h.company_address_lot))'');
    ...
    maxlength_company_address_lot_order := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_lot_order)));
    avelength_company_address_lot_order := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_lot_order)),h.company_address_lot_order<>(typeof(h.company_address_lot_order))'');
    ...
    maxlength_company_address_dbpc := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_dbpc)));
    avelength_company_address_dbpc := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_dbpc)),h.company_address_dbpc<>(typeof(h.company_address_dbpc))'');
    ...
    maxlength_company_address_chk_digit := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_chk_digit)));
    avelength_company_address_chk_digit := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_chk_digit)),h.company_address_chk_digit<>(typeof(h.company_address_chk_digit))'');
    ...
    maxlength_company_address_rec_type := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_rec_type)));
    avelength_company_address_rec_type := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_rec_type)),h.company_address_rec_type<>(typeof(h.company_address_rec_type))'');
    ...
    maxlength_company_address_fips_state := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_fips_state)));
    avelength_company_address_fips_state := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_fips_state)),h.company_address_fips_state<>(typeof(h.company_address_fips_state))'');
    ...
    maxlength_company_address_fips_county := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_fips_county)));
    avelength_company_address_fips_county := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_fips_county)),h.company_address_fips_county<>(typeof(h.company_address_fips_county))'');
    ...
    maxlength_company_address_geo_lat := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_lat)));
    avelength_company_address_geo_lat := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_lat)),h.company_address_geo_lat<>(typeof(h.company_address_geo_lat))'');
    ...
    maxlength_company_address_geo_long := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_long)));
    avelength_company_address_geo_long := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_long)),h.company_address_geo_long<>(typeof(h.company_address_geo_long))'');
    ...
    maxlength_company_address_msa := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_msa)));
    avelength_company_address_msa := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_msa)),h.company_address_msa<>(typeof(h.company_address_msa))'');
    ...
    maxlength_company_address_geo_blk := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_blk)));
    avelength_company_address_geo_blk := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_blk)),h.company_address_geo_blk<>(typeof(h.company_address_geo_blk))'');
    ...
    maxlength_company_address_geo_match := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_match)));
    avelength_company_address_geo_match := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_geo_match)),h.company_address_geo_match<>(typeof(h.company_address_geo_match))'');
    ...
    maxlength_company_address_err_stat := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_err_stat)));
    avelength_company_address_err_stat := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_err_stat)),h.company_address_err_stat<>(typeof(h.company_address_err_stat))'');
    ...
    maxlength_company_address_type_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_type_raw)));
    avelength_company_address_type_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_type_raw)),h.company_address_type_raw<>(typeof(h.company_address_type_raw))'');
    ...
    maxlength_company_address_category := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_category)));
    avelength_company_address_category := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_category)),h.company_address_category<>(typeof(h.company_address_category))'');
    ...
    maxlength_company_address_country_code := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_country_code)));
    avelength_company_address_country_code := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_country_code)),h.company_address_country_code<>(typeof(h.company_address_country_code))'');
    ...
    maxlength_company_fein := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_fein)));
    avelength_company_fein := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_fein)),h.company_fein<>(typeof(h.company_fein))'');
    ...
    maxlength_best_fein_indicator := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.best_fein_indicator)));
    avelength_best_fein_indicator := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.best_fein_indicator)),h.best_fein_indicator<>(typeof(h.best_fein_indicator))'');
    ...
    maxlength_company_phone := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_phone)));
    avelength_company_phone := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_phone)),h.company_phone<>(typeof(h.company_phone))'');
    ...
    maxlength_phone_type := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.phone_type)));
    avelength_phone_type := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.phone_type)),h.phone_type<>(typeof(h.phone_type))'');
    ...
    maxlength_company_org_structure_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_org_structure_raw)));
    avelength_company_org_structure_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_org_structure_raw)),h.company_org_structure_raw<>(typeof(h.company_org_structure_raw))'');
    ...
    maxlength_company_incorporation_date := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_incorporation_date)));
    avelength_company_incorporation_date := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_incorporation_date)),h.company_incorporation_date<>(typeof(h.company_incorporation_date))'');
    ...
    maxlength_company_sic_code1 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code1)));
    avelength_company_sic_code1 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code1)),h.company_sic_code1<>(typeof(h.company_sic_code1))'');
    ...
    maxlength_company_sic_code2 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code2)));
    avelength_company_sic_code2 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code2)),h.company_sic_code2<>(typeof(h.company_sic_code2))'');
    ...
    maxlength_company_sic_code3 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code3)));
    avelength_company_sic_code3 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code3)),h.company_sic_code3<>(typeof(h.company_sic_code3))'');
    ...
    maxlength_company_sic_code4 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code4)));
    avelength_company_sic_code4 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code4)),h.company_sic_code4<>(typeof(h.company_sic_code4))'');
    ...
    maxlength_company_sic_code5 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code5)));
    avelength_company_sic_code5 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_sic_code5)),h.company_sic_code5<>(typeof(h.company_sic_code5))'');
    ...
    maxlength_company_naics_code1 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code1)));
    avelength_company_naics_code1 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code1)),h.company_naics_code1<>(typeof(h.company_naics_code1))'');
    ...
    maxlength_company_naics_code2 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code2)));
    avelength_company_naics_code2 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code2)),h.company_naics_code2<>(typeof(h.company_naics_code2))'');
    ...
    maxlength_company_naics_code3 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code3)));
    avelength_company_naics_code3 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code3)),h.company_naics_code3<>(typeof(h.company_naics_code3))'');
    ...
    maxlength_company_naics_code4 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code4)));
    avelength_company_naics_code4 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code4)),h.company_naics_code4<>(typeof(h.company_naics_code4))'');
    ...
    maxlength_company_naics_code5 := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code5)));
    avelength_company_naics_code5 := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_naics_code5)),h.company_naics_code5<>(typeof(h.company_naics_code5))'');
    ...
    maxlength_company_ticker := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_ticker)));
    avelength_company_ticker := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_ticker)),h.company_ticker<>(typeof(h.company_ticker))'');
    ...
    maxlength_company_ticker_exchange := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_ticker_exchange)));
    avelength_company_ticker_exchange := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_ticker_exchange)),h.company_ticker_exchange<>(typeof(h.company_ticker_exchange))'');
    ...
    maxlength_company_foreign_domestic := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_foreign_domestic)));
    avelength_company_foreign_domestic := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_foreign_domestic)),h.company_foreign_domestic<>(typeof(h.company_foreign_domestic))'');
    ...
    maxlength_company_url := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_url)));
    avelength_company_url := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_url)),h.company_url<>(typeof(h.company_url))'');
    ...
    maxlength_company_inc_state := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_inc_state)));
    avelength_company_inc_state := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_inc_state)),h.company_inc_state<>(typeof(h.company_inc_state))'');
    ...
    maxlength_company_charter_number := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_charter_number)));
    avelength_company_charter_number := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_charter_number)),h.company_charter_number<>(typeof(h.company_charter_number))'');
    ...
    maxlength_company_filing_date := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_filing_date)));
    avelength_company_filing_date := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_filing_date)),h.company_filing_date<>(typeof(h.company_filing_date))'');
    ...
    maxlength_company_status_date := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_date)));
    avelength_company_status_date := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_date)),h.company_status_date<>(typeof(h.company_status_date))'');
    ...
    maxlength_company_foreign_date := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_foreign_date)));
    avelength_company_foreign_date := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_foreign_date)),h.company_foreign_date<>(typeof(h.company_foreign_date))'');
    ...
    maxlength_event_filing_date := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.event_filing_date)));
    avelength_event_filing_date := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.event_filing_date)),h.event_filing_date<>(typeof(h.event_filing_date))'');
    ...
    maxlength_company_name_status_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_status_raw)));
    avelength_company_name_status_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_status_raw)),h.company_name_status_raw<>(typeof(h.company_name_status_raw))'');
    ...
    maxlength_company_status_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_raw)));
    avelength_company_status_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_raw)),h.company_status_raw<>(typeof(h.company_status_raw))'');
    ...
    maxlength_dt_first_seen_company_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_company_name)));
    avelength_dt_first_seen_company_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_company_name)),h.dt_first_seen_company_name<>(typeof(h.dt_first_seen_company_name))'');
    ...
    maxlength_dt_last_seen_company_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_company_name)));
    avelength_dt_last_seen_company_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_company_name)),h.dt_last_seen_company_name<>(typeof(h.dt_last_seen_company_name))'');
    ...
    maxlength_dt_first_seen_company_address := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_company_address)));
    avelength_dt_first_seen_company_address := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_company_address)),h.dt_first_seen_company_address<>(typeof(h.dt_first_seen_company_address))'');
    ...
    maxlength_dt_last_seen_company_address := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_company_address)));
    avelength_dt_last_seen_company_address := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_company_address)),h.dt_last_seen_company_address<>(typeof(h.dt_last_seen_company_address))'');
    populated_vl_id_cnt := COUNT(GROUP,h.vl_id <> (TYPEOF(h.vl_id))'');
    populated_vl_id_pcnt := AVE(GROUP,IF(h.vl_id = (TYPEOF(h.vl_id))'',0,100));
    maxlength_vl_id := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.vl_id)));
    avelength_vl_id := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.vl_id)),h.vl_id<>(typeof(h.vl_id))'');
    ...
    maxlength_current := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.current)));
    avelength_current := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.current)),h.current<>(typeof(h.current))'');
    ...
    maxlength_source_record_id := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_record_id)));
    avelength_source_record_id := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_record_id)),h.source_record_id<>(typeof(h.source_record_id))'');
    populated_glb_cnt := COUNT(GROUP,h.glb <> (TYPEOF(h.glb))'');
    populated_glb_pcnt := AVE(GROUP,IF(h.glb = (TYPEOF(h.glb))'',0,100));
    maxlength_glb := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.glb)));
    avelength_glb := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.glb)),h.glb<>(typeof(h.glb))'');
    populated_dppa_cnt := COUNT(GROUP,h.dppa <> (TYPEOF(h.dppa))'');
    populated_dppa_pcnt := AVE(GROUP,IF(h.dppa = (TYPEOF(h.dppa))'',0,100));
    maxlength_dppa := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dppa)));
    avelength_dppa := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dppa)),h.dppa<>(typeof(h.dppa))'');
    ...
    maxlength_match_company_name := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_company_name)));
    avelength_match_company_name := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_company_name)),h.match_company_name<>(typeof(h.match_company_name))'');
    ...
    maxlength_match_branch_city := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_branch_city)));
    avelength_match_branch_city := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_branch_city)),h.match_branch_city<>(typeof(h.match_branch_city))'');
    ...
    maxlength_match_geo_city := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_geo_city)));
    avelength_match_geo_city := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.match_geo_city)),h.match_geo_city<>(typeof(h.match_geo_city))'');
    ...
    maxlength_source_docid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_docid)));
    avelength_source_docid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.source_docid)),h.source_docid<>(typeof(h.source_docid))'');
    ...
    maxlength_is_contact := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_contact)));
    avelength_is_contact := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_contact)),h.is_contact<>(typeof(h.is_contact))'');
    ...
    maxlength_dt_first_seen_contact := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_contact)));
    avelength_dt_first_seen_contact := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_first_seen_contact)),h.dt_first_seen_contact<>(typeof(h.dt_first_seen_contact))'');
    ...
    maxlength_dt_last_seen_contact := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_contact)));
    avelength_dt_last_seen_contact := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.dt_last_seen_contact)),h.dt_last_seen_contact<>(typeof(h.dt_last_seen_contact))'');
    ...
    maxlength_contact_did := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_did)));
    avelength_contact_did := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_did)),h.contact_did<>(typeof(h.contact_did))'');
    ...
    maxlength_contact_name_title := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_title)));
    avelength_contact_name_title := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_title)),h.contact_name_title<>(typeof(h.contact_name_title))'');
    ...
    maxlength_contact_name_fname := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_fname)));
    avelength_contact_name_fname := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_fname)),h.contact_name_fname<>(typeof(h.contact_name_fname))'');
    populated_contact_name_mname_cnt := COUNT(GROUP,h.contact_name_mname <> (TYPEOF(h.contact_name_mname))'');
    populated_contact_name_mname_pcnt := AVE(GROUP,IF(h.contact_name_mname = (TYPEOF(h.contact_name_mname))'',0,100));
    maxlength_contact_name_mname := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_mname)));
    avelength_contact_name_mname := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_mname)),h.contact_name_mname<>(typeof(h.contact_name_mname))'');
    ...
    maxlength_contact_name_lname := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_lname)));
    avelength_contact_name_lname := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_lname)),h.contact_name_lname<>(typeof(h.contact_name_lname))'');
    ...
    maxlength_contact_name_name_suffix := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_name_suffix)));
    avelength_contact_name_name_suffix := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_name_suffix)),h.contact_name_name_suffix<>(typeof(h.contact_name_name_suffix))'');
    ...
    maxlength_contact_name_name_score := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_name_score)));
    avelength_contact_name_name_score := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_name_name_score)),h.contact_name_name_score<>(typeof(h.contact_name_name_score))'');
    ...
    maxlength_contact_type_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_type_raw)));
    avelength_contact_type_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_type_raw)),h.contact_type_raw<>(typeof(h.contact_type_raw))'');
    ...
    maxlength_contact_job_title_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_job_title_raw)));
    avelength_contact_job_title_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_job_title_raw)),h.contact_job_title_raw<>(typeof(h.contact_job_title_raw))'');
    ...
    maxlength_contact_ssn := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_ssn)));
    avelength_contact_ssn := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_ssn)),h.contact_ssn<>(typeof(h.contact_ssn))'');
    ...
    maxlength_contact_dob := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_dob)));
    avelength_contact_dob := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_dob)),h.contact_dob<>(typeof(h.contact_dob))'');
    ...
    maxlength_contact_status_raw := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_status_raw)));
    avelength_contact_status_raw := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_status_raw)),h.contact_status_raw<>(typeof(h.contact_status_raw))'');
    ...
    maxlength_contact_email := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email)));
    avelength_contact_email := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email)),h.contact_email<>(typeof(h.contact_email))'');
    ...
    maxlength_contact_email_username := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email_username)));
    avelength_contact_email_username := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email_username)),h.contact_email_username<>(typeof(h.contact_email_username))'');
    ...
    maxlength_contact_email_domain := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email_domain)));
    avelength_contact_email_domain := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_email_domain)),h.contact_email_domain<>(typeof(h.contact_email_domain))'');
    ...
    maxlength_contact_phone := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_phone)));
    avelength_contact_phone := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_phone)),h.contact_phone<>(typeof(h.contact_phone))'');
    populated_cid_cnt := COUNT(GROUP,h.cid <> (TYPEOF(h.cid))'');
    populated_cid_pcnt := AVE(GROUP,IF(h.cid = (TYPEOF(h.cid))'',0,100));
    maxlength_cid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.cid)));
    avelength_cid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.cid)),h.cid<>(typeof(h.cid))'');
    ...
    maxlength_contact_score := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_score)));
    avelength_contact_score := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_score)),h.contact_score<>(typeof(h.contact_score))'');
    ...
    maxlength_from_hdr := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.from_hdr)));
    avelength_from_hdr := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.from_hdr)),h.from_hdr<>(typeof(h.from_hdr))'');
    ...
    maxlength_company_department := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_department)));
    avelength_company_department := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_department)),h.company_department<>(typeof(h.company_department))'');
    ...
    maxlength_company_aceaid := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_aceaid)));
    avelength_company_aceaid := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_aceaid)),h.company_aceaid<>(typeof(h.company_aceaid))'');
    ...
    maxlength_company_name_type_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_type_derived)));
    avelength_company_name_type_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_type_derived)),h.company_name_type_derived<>(typeof(h.company_name_type_derived))'');
    ...
    maxlength_company_address_type_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_type_derived)));
    avelength_company_address_type_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_address_type_derived)),h.company_address_type_derived<>(typeof(h.company_address_type_derived))'');
    ...
    maxlength_company_org_structure_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_org_structure_derived)));
    avelength_company_org_structure_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_org_structure_derived)),h.company_org_structure_derived<>(typeof(h.company_org_structure_derived))'');
    ...
    maxlength_company_name_status_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_status_derived)));
    avelength_company_name_status_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_name_status_derived)),h.company_name_status_derived<>(typeof(h.company_name_status_derived))'');
    ...
    maxlength_company_status_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_derived)));
    avelength_company_status_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.company_status_derived)),h.company_status_derived<>(typeof(h.company_status_derived))'');
    ...
    maxlength_proxid_status_private := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.proxid_status_private)));
    avelength_proxid_status_private := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.proxid_status_private)),h.proxid_status_private<>(typeof(h.proxid_status_private))'');
    ...
    maxlength_powid_status_private := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.powid_status_private)));
    avelength_powid_status_private := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.powid_status_private)),h.powid_status_private<>(typeof(h.powid_status_private))'');
    ...
    maxlength_seleid_status_private := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.seleid_status_private)));
    avelength_seleid_status_private := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.seleid_status_private)),h.seleid_status_private<>(typeof(h.seleid_status_private))'');
    ...
    maxlength_orgid_status_private := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.orgid_status_private)));
    avelength_orgid_status_private := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.orgid_status_private)),h.orgid_status_private<>(typeof(h.orgid_status_private))'');
    ...
    maxlength_ultid_status_private := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.ultid_status_private)));
    avelength_ultid_status_private := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.ultid_status_private)),h.ultid_status_private<>(typeof(h.ultid_status_private))'');
    ...
    maxlength_proxid_status_public := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.proxid_status_public)));
    avelength_proxid_status_public := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.proxid_status_public)),h.proxid_status_public<>(typeof(h.proxid_status_public))'');
    ...
    maxlength_powid_status_public := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.powid_status_public)));
    avelength_powid_status_public := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.powid_status_public)),h.powid_status_public<>(typeof(h.powid_status_public))'');
    ...
    maxlength_seleid_status_public := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.seleid_status_public)));
    avelength_seleid_status_public := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.seleid_status_public)),h.seleid_status_public<>(typeof(h.seleid_status_public))'');
    ...
    maxlength_orgid_status_public := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.orgid_status_public)));
    avelength_orgid_status_public := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.orgid_status_public)),h.orgid_status_public<>(typeof(h.orgid_status_public))'');
    ...
    maxlength_ultid_status_public := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.ultid_status_public)));
    avelength_ultid_status_public := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.ultid_status_public)),h.ultid_status_public<>(typeof(h.ultid_status_public))'');
    ...
    maxlength_contact_type_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_type_derived)));
    avelength_contact_type_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_type_derived)),h.contact_type_derived<>(typeof(h.contact_type_derived))'');
    ...
    maxlength_contact_job_title_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_job_title_derived)));
    avelength_contact_job_title_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_job_title_derived)),h.contact_job_title_derived<>(typeof(h.contact_job_title_derived))'');
    ...
    maxlength_contact_status_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_status_derived)));
    avelength_contact_status_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.contact_status_derived)),h.contact_status_derived<>(typeof(h.contact_status_derived))'');
    ...
    maxlength_address_type_derived := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.address_type_derived)));
    avelength_address_type_derived := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.address_type_derived)),h.address_type_derived<>(typeof(h.address_type_derived))'');
...
SALT39.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT39.StrType)le.source_expanded),TRIM((SALT39.StrType)le.source),IF (le.dt_first_seen <> 0,TRIM((SALT39.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT39.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_last_reported), ''),IF (le.rcid <> 0,TRIM((SALT39.StrType)le.rcid), ''),IF (le.company_bdid <> 0,TRIM((SALT39.StrType)le.company_bdid), ''),TRIM((SALT39.StrType)le.company_name),TRIM((SALT39.StrType)le.company_name_type_raw),IF (le.company_rawaid <> 0,TRIM((SALT39.StrType)le.company_rawaid), ''),TRIM((SALT39.StrType)le.company_address_prim_range),TRIM((SALT39.StrType)le.company_address_predir),TRIM((SALT39.StrType)le.company_address_prim_name),TRIM((SALT39.StrType)le.company_address_addr_suffix),TRIM((SALT39.StrType)le.company_address_postdir),TRIM((SALT39.StrType)le.company_address_unit_desig),TRIM((SALT39.StrType)le.company_address_sec_range),TRIM((SALT39.StrType)le.company_address_p_city_name),TRIM((SALT39.StrType)le.company_address_v_city_name),TRIM((SALT39.StrType)le.company_address_st),TRIM((SALT39.StrType)le.company_address_zip),TRIM((SALT39.StrType)le.company_address_zip4),TRIM((SALT39.StrType)le.company_address_cart),TRIM((SALT39.StrType)le.company_address_cr_sort_sz),TRIM((SALT39.StrType)le.company_address_lot),TRIM((SALT39.StrType)le.company_address_lot_order),TRIM((SALT39.StrType)le.company_address_dbpc),TRIM((SALT39.StrType)le.company_address_chk_digit),TRIM((SALT39.StrType)le.company_address_rec_type),TRIM((SALT39.StrType)le.company_address_fips_state),TRIM((SALT39.StrType)le.company_address_fips_county),TRIM((SALT39.StrType)le.company_address_geo_lat),TRIM((SALT39.StrType)le.company_address_geo_long),TRIM((SALT39.StrType)le.company_address_msa),TRIM((SALT39.StrType)le.company_address_geo_blk),TRIM((SALT39.StrType)le.company_address_geo_match),TRIM((SALT39.StrType)le.company_address_err_stat),TRIM((SALT39.StrType)le.company_address_type_raw),TRIM((SALT39.StrType)le.company_address_category),TRIM((SALT39.StrType)le.company_address_country_code),TRIM((SALT39.StrType)le.company_fein),TRIM((SALT39.StrType)le.best_fein_indicator),TRIM((SALT39.StrType)le.company_phone),TRIM((SALT39.StrType)le.phone_type),TRIM((SALT39.StrType)le.company_org_structure_raw),IF (le.company_incorporation_date <> 0,TRIM((SALT39.StrType)le.company_incorporation_date), ''),TRIM((SALT39.StrType)le.company_sic_code1),TRIM((SALT39.StrType)le.company_sic_code2),TRIM((SALT39.StrType)le.company_sic_code3),TRIM((SALT39.StrType)le.company_sic_code4),TRIM((SALT39.StrType)le.company_sic_code5),TRIM((SALT39.StrType)le.company_naics_code1),TRIM((SALT39.StrType)le.company_naics_code2),TRIM((SALT39.StrType)le.company_naics_code3),TRIM((SALT39.StrType)le.company_naics_code4),TRIM((SALT39.StrType)le.company_naics_code5),TRIM((SALT39.StrType)le.company_ticker),TRIM((SALT39.StrType)le.company_ticker_exchange),TRIM((SALT39.StrType)le.company_foreign_domestic),TRIM((SALT39.StrType)le.company_url),TRIM((SALT39.StrType)le.company_inc_state),TRIM((SALT39.StrType)le.company_charter_number),IF (le.company_filing_date <> 0,TRIM((SALT39.StrType)le.company_filing_date), ''),IF (le.company_status_date <> 0,TRIM((SALT39.StrType)le.company_status_date), ''),IF (le.company_foreign_date <> 0,TRIM((SALT39.StrType)le.company_foreign_date), ''),IF (le.event_filing_date <> 0,TRIM((SALT39.StrType)le.event_filing_date), ''),TRIM((SALT39.StrType)le.company_name_status_raw),TRIM((SALT39.StrType)le.company_status_raw),IF (le.dt_first_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_name), ''),IF (le.dt_last_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_name), ''),IF (le.dt_first_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_address), ''),IF (le.dt_last_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_address), ''),TRIM((SALT39.StrType)le.vl_id),TRIM((SALT39.StrType)le.current),IF (le.source_record_id <> 0,TRIM((SALT39.StrType)le.source_record_id), ''),TRIM((SALT39.StrType)le.glb),TRIM((SALT39.StrType)le.dppa),IF (le.phone_score <> 0,TRIM((SALT39.StrType)le.phone_score), ''),TRIM((SALT39.StrType)le.match_company_name),TRIM((SALT39.StrType)le.match_branch_city),TRIM((SALT39.StrType)le.match_geo_city),TRIM((SALT39.StrType)le.duns_number),TRIM((SALT39.StrType)le.source_docid),TRIM((SALT39.StrType)le.is_contact),IF (le.dt_first_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_first_seen_contact), ''),IF (le.dt_last_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_last_seen_contact), ''),IF (le.contact_did <> 0,TRIM((SALT39.StrType)le.contact_did), ''),TRIM((SALT39.StrType)le.contact_name_title),TRIM((SALT39.StrType)le.contact_name_fname),TRIM((SALT39.StrType)le.contact_name_mname),TRIM((SALT39.StrType)le.contact_name_lname),TRIM((SALT39.StrType)le.contact_name_name_suffix),TRIM((SALT39.StrType)le.contact_name_name_score),TRIM((SALT39.StrType)le.contact_type_raw),TRIM((SALT39.StrType)le.contact_job_title_raw),TRIM((SALT39.StrType)le.contact_ssn),IF (le.contact_dob <> 0,TRIM((SALT39.StrType)le.contact_dob), ''),TRIM((SALT39.StrType)le.contact_status_raw),TRIM((SALT39.StrType)le.contact_email),TRIM((SALT39.StrType)le.contact_email_username),TRIM((SALT39.StrType)le.contact_email_domain),TRIM((SALT39.StrType)le.contact_phone),IF (le.cid <> 0,TRIM((SALT39.StrType)le.cid), ''),IF (le.contact_score <> 0,TRIM((SALT39.StrType)le.contact_score), ''),TRIM((SALT39.StrType)le.from_hdr),TRIM((SALT39.StrType)le.company_department),IF (le.company_aceaid <> 0,TRIM((SALT39.StrType)le.company_aceaid), ''),TRIM((SALT39.StrType)le.company_name_type_derived),TRIM((SALT39.StrType)le.company_address_type_derived),TRIM((SALT39.StrType)le.company_org_structure_derived),TRIM((SALT39.StrType)le.company_name_status_derived),TRIM((SALT39.StrType)le.company_status_derived),TRIM((SALT39.StrType)le.proxid_status_private),TRIM((SALT39.StrType)le.powid_status_private),TRIM((SALT39.StrType)le.seleid_status_private),TRIM((SALT39.StrType)le.orgid_status_private),TRIM((SALT39.StrType)le.ultid_status_private),TRIM((SALT39.StrType)le.proxid_status_public),TRIM((SALT39.StrType)le.powid_status_public),TRIM((SALT39.StrType)le.seleid_status_public),TRIM((SALT39.StrType)le.orgid_status_public),TRIM((SALT39.StrType)le.ultid_status_public),TRIM((SALT39.StrType)le.contact_type_derived),TRIM((SALT39.StrType)le.contact_job_title_derived),TRIM((SALT39.StrType)le.contact_status_derived),TRIM((SALT39.StrType)le.address_type_derived),TRIM((SALT39.StrType)le.is_vanity_name_derived)));
  SELF.FldNo := C;
END;
...
SALT39.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 128);
  SELF.FldNo2 := 1 + (C % 128);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT39.StrType)le.source_expanded),TRIM((SALT39.StrType)le.source),IF (le.dt_first_seen <> 0,TRIM((SALT39.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT39.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_last_reported), ''),IF (le.rcid <> 0,TRIM((SALT39.StrType)le.rcid), ''),IF (le.company_bdid <> 0,TRIM((SALT39.StrType)le.company_bdid), ''),TRIM((SALT39.StrType)le.company_name),TRIM((SALT39.StrType)le.company_name_type_raw),IF (le.company_rawaid <> 0,TRIM((SALT39.StrType)le.company_rawaid), ''),TRIM((SALT39.StrType)le.company_address_prim_range),TRIM((SALT39.StrType)le.company_address_predir),TRIM((SALT39.StrType)le.company_address_prim_name),TRIM((SALT39.StrType)le.company_address_addr_suffix),TRIM((SALT39.StrType)le.company_address_postdir),TRIM((SALT39.StrType)le.company_address_unit_desig),TRIM((SALT39.StrType)le.company_address_sec_range),TRIM((SALT39.StrType)le.company_address_p_city_name),TRIM((SALT39.StrType)le.company_address_v_city_name),TRIM((SALT39.StrType)le.company_address_st),TRIM((SALT39.StrType)le.company_address_zip),TRIM((SALT39.StrType)le.company_address_zip4),TRIM((SALT39.StrType)le.company_address_cart),TRIM((SALT39.StrType)le.company_address_cr_sort_sz),TRIM((SALT39.StrType)le.company_address_lot),TRIM((SALT39.StrType)le.company_address_lot_order),TRIM((SALT39.StrType)le.company_address_dbpc),TRIM((SALT39.StrType)le.company_address_chk_digit),TRIM((SALT39.StrType)le.company_address_rec_type),TRIM((SALT39.StrType)le.company_address_fips_state),TRIM((SALT39.StrType)le.company_address_fips_county),TRIM((SALT39.StrType)le.company_address_geo_lat),TRIM((SALT39.StrType)le.company_address_geo_long),TRIM((SALT39.StrType)le.company_address_msa),TRIM((SALT39.StrType)le.company_address_geo_blk),TRIM((SALT39.StrType)le.company_address_geo_match),TRIM((SALT39.StrType)le.company_address_err_stat),TRIM((SALT39.StrType)le.company_address_type_raw),TRIM((SALT39.StrType)le.company_address_category),TRIM((SALT39.StrType)le.company_address_country_code),TRIM((SALT39.StrType)le.company_fein),TRIM((SALT39.StrType)le.best_fein_indicator),TRIM((SALT39.StrType)le.company_phone),TRIM((SALT39.StrType)le.phone_type),TRIM((SALT39.StrType)le.company_org_structure_raw),IF (le.company_incorporation_date <> 0,TRIM((SALT39.StrType)le.company_incorporation_date), ''),TRIM((SALT39.StrType)le.company_sic_code1),TRIM((SALT39.StrType)le.company_sic_code2),TRIM((SALT39.StrType)le.company_sic_code3),TRIM((SALT39.StrType)le.company_sic_code4),TRIM((SALT39.StrType)le.company_sic_code5),TRIM((SALT39.StrType)le.company_naics_code1),TRIM((SALT39.StrType)le.company_naics_code2),TRIM((SALT39.StrType)le.company_naics_code3),TRIM((SALT39.StrType)le.company_naics_code4),TRIM((SALT39.StrType)le.company_naics_code5),TRIM((SALT39.StrType)le.company_ticker),TRIM((SALT39.StrType)le.company_ticker_exchange),TRIM((SALT39.StrType)le.company_foreign_domestic),TRIM((SALT39.StrType)le.company_url),TRIM((SALT39.StrType)le.company_inc_state),TRIM((SALT39.StrType)le.company_charter_number),IF (le.company_filing_date <> 0,TRIM((SALT39.StrType)le.company_filing_date), ''),IF (le.company_status_date <> 0,TRIM((SALT39.StrType)le.company_status_date), ''),IF (le.company_foreign_date <> 0,TRIM((SALT39.StrType)le.company_foreign_date), ''),IF (le.event_filing_date <> 0,TRIM((SALT39.StrType)le.event_filing_date), ''),TRIM((SALT39.StrType)le.company_name_status_raw),TRIM((SALT39.StrType)le.company_status_raw),IF (le.dt_first_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_name), ''),IF (le.dt_last_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_name), ''),IF (le.dt_first_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_address), ''),IF (le.dt_last_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_address), ''),TRIM((SALT39.StrType)le.vl_id),TRIM((SALT39.StrType)le.current),IF (le.source_record_id <> 0,TRIM((SALT39.StrType)le.source_record_id), ''),TRIM((SALT39.StrType)le.glb),TRIM((SALT39.StrType)le.dppa),IF (le.phone_score <> 0,TRIM((SALT39.StrType)le.phone_score), ''),TRIM((SALT39.StrType)le.match_company_name),TRIM((SALT39.StrType)le.match_branch_city),TRIM((SALT39.StrType)le.match_geo_city),TRIM((SALT39.StrType)le.duns_number),TRIM((SALT39.StrType)le.source_docid),TRIM((SALT39.StrType)le.is_contact),IF (le.dt_first_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_first_seen_contact), ''),IF (le.dt_last_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_last_seen_contact), ''),IF (le.contact_did <> 0,TRIM((SALT39.StrType)le.contact_did), ''),TRIM((SALT39.StrType)le.contact_name_title),TRIM((SALT39.StrType)le.contact_name_fname),TRIM((SALT39.StrType)le.contact_name_mname),TRIM((SALT39.StrType)le.contact_name_lname),TRIM((SALT39.StrType)le.contact_name_name_suffix),TRIM((SALT39.StrType)le.contact_name_name_score),TRIM((SALT39.StrType)le.contact_type_raw),TRIM((SALT39.StrType)le.contact_job_title_raw),TRIM((SALT39.StrType)le.contact_ssn),IF (le.contact_dob <> 0,TRIM((SALT39.StrType)le.contact_dob), ''),TRIM((SALT39.StrType)le.contact_status_raw),TRIM((SALT39.StrType)le.contact_email),TRIM((SALT39.StrType)le.contact_email_username),TRIM((SALT39.StrType)le.contact_email_domain),TRIM((SALT39.StrType)le.contact_phone),IF (le.cid <> 0,TRIM((SALT39.StrType)le.cid), ''),IF (le.contact_score <> 0,TRIM((SALT39.StrType)le.contact_score), ''),TRIM((SALT39.StrType)le.from_hdr),TRIM((SALT39.StrType)le.company_department),IF (le.company_aceaid <> 0,TRIM((SALT39.StrType)le.company_aceaid), ''),TRIM((SALT39.StrType)le.company_name_type_derived),TRIM((SALT39.StrType)le.company_address_type_derived),TRIM((SALT39.StrType)le.company_org_structure_derived),TRIM((SALT39.StrType)le.company_name_status_derived),TRIM((SALT39.StrType)le.company_status_derived),TRIM((SALT39.StrType)le.proxid_status_private),TRIM((SALT39.StrType)le.powid_status_private),TRIM((SALT39.StrType)le.seleid_status_private),TRIM((SALT39.StrType)le.orgid_status_private),TRIM((SALT39.StrType)le.ultid_status_private),TRIM((SALT39.StrType)le.proxid_status_public),TRIM((SALT39.StrType)le.powid_status_public),TRIM((SALT39.StrType)le.seleid_status_public),TRIM((SALT39.StrType)le.orgid_status_public),TRIM((SALT39.StrType)le.ultid_status_public),TRIM((SALT39.StrType)le.contact_type_derived),TRIM((SALT39.StrType)le.contact_job_title_derived),TRIM((SALT39.StrType)le.contact_status_derived),TRIM((SALT39.StrType)le.address_type_derived),TRIM((SALT39.StrType)le.is_vanity_name_derived)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT39.StrType)le.source_expanded),TRIM((SALT39.StrType)le.source),IF (le.dt_first_seen <> 0,TRIM((SALT39.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT39.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT39.StrType)le.dt_vendor_last_reported), ''),IF (le.rcid <> 0,TRIM((SALT39.StrType)le.rcid), ''),IF (le.company_bdid <> 0,TRIM((SALT39.StrType)le.company_bdid), ''),TRIM((SALT39.StrType)le.company_name),TRIM((SALT39.StrType)le.company_name_type_raw),IF (le.company_rawaid <> 0,TRIM((SALT39.StrType)le.company_rawaid), ''),TRIM((SALT39.StrType)le.company_address_prim_range),TRIM((SALT39.StrType)le.company_address_predir),TRIM((SALT39.StrType)le.company_address_prim_name),TRIM((SALT39.StrType)le.company_address_addr_suffix),TRIM((SALT39.StrType)le.company_address_postdir),TRIM((SALT39.StrType)le.company_address_unit_desig),TRIM((SALT39.StrType)le.company_address_sec_range),TRIM((SALT39.StrType)le.company_address_p_city_name),TRIM((SALT39.StrType)le.company_address_v_city_name),TRIM((SALT39.StrType)le.company_address_st),TRIM((SALT39.StrType)le.company_address_zip),TRIM((SALT39.StrType)le.company_address_zip4),TRIM((SALT39.StrType)le.company_address_cart),TRIM((SALT39.StrType)le.company_address_cr_sort_sz),TRIM((SALT39.StrType)le.company_address_lot),TRIM((SALT39.StrType)le.company_address_lot_order),TRIM((SALT39.StrType)le.company_address_dbpc),TRIM((SALT39.StrType)le.company_address_chk_digit),TRIM((SALT39.StrType)le.company_address_rec_type),TRIM((SALT39.StrType)le.company_address_fips_state),TRIM((SALT39.StrType)le.company_address_fips_county),TRIM((SALT39.StrType)le.company_address_geo_lat),TRIM((SALT39.StrType)le.company_address_geo_long),TRIM((SALT39.StrType)le.company_address_msa),TRIM((SALT39.StrType)le.company_address_geo_blk),TRIM((SALT39.StrType)le.company_address_geo_match),TRIM((SALT39.StrType)le.company_address_err_stat),TRIM((SALT39.StrType)le.company_address_type_raw),TRIM((SALT39.StrType)le.company_address_category),TRIM((SALT39.StrType)le.company_address_country_code),TRIM((SALT39.StrType)le.company_fein),TRIM((SALT39.StrType)le.best_fein_indicator),TRIM((SALT39.StrType)le.company_phone),TRIM((SALT39.StrType)le.phone_type),TRIM((SALT39.StrType)le.company_org_structure_raw),IF (le.company_incorporation_date <> 0,TRIM((SALT39.StrType)le.company_incorporation_date), ''),TRIM((SALT39.StrType)le.company_sic_code1),TRIM((SALT39.StrType)le.company_sic_code2),TRIM((SALT39.StrType)le.company_sic_code3),TRIM((SALT39.StrType)le.company_sic_code4),TRIM((SALT39.StrType)le.company_sic_code5),TRIM((SALT39.StrType)le.company_naics_code1),TRIM((SALT39.StrType)le.company_naics_code2),TRIM((SALT39.StrType)le.company_naics_code3),TRIM((SALT39.StrType)le.company_naics_code4),TRIM((SALT39.StrType)le.company_naics_code5),TRIM((SALT39.StrType)le.company_ticker),TRIM((SALT39.StrType)le.company_ticker_exchange),TRIM((SALT39.StrType)le.company_foreign_domestic),TRIM((SALT39.StrType)le.company_url),TRIM((SALT39.StrType)le.company_inc_state),TRIM((SALT39.StrType)le.company_charter_number),IF (le.company_filing_date <> 0,TRIM((SALT39.StrType)le.company_filing_date), ''),IF (le.company_status_date <> 0,TRIM((SALT39.StrType)le.company_status_date), ''),IF (le.company_foreign_date <> 0,TRIM((SALT39.StrType)le.company_foreign_date), ''),IF (le.event_filing_date <> 0,TRIM((SALT39.StrType)le.event_filing_date), ''),TRIM((SALT39.StrType)le.company_name_status_raw),TRIM((SALT39.StrType)le.company_status_raw),IF (le.dt_first_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_name), ''),IF (le.dt_last_seen_company_name <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_name), ''),IF (le.dt_first_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_first_seen_company_address), ''),IF (le.dt_last_seen_company_address <> 0,TRIM((SALT39.StrType)le.dt_last_seen_company_address), ''),TRIM((SALT39.StrType)le.vl_id),TRIM((SALT39.StrType)le.current),IF (le.source_record_id <> 0,TRIM((SALT39.StrType)le.source_record_id), ''),TRIM((SALT39.StrType)le.glb),TRIM((SALT39.StrType)le.dppa),IF (le.phone_score <> 0,TRIM((SALT39.StrType)le.phone_score), ''),TRIM((SALT39.StrType)le.match_company_name),TRIM((SALT39.StrType)le.match_branch_city),TRIM((SALT39.StrType)le.match_geo_city),TRIM((SALT39.StrType)le.duns_number),TRIM((SALT39.StrType)le.source_docid),TRIM((SALT39.StrType)le.is_contact),IF (le.dt_first_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_first_seen_contact), ''),IF (le.dt_last_seen_contact <> 0,TRIM((SALT39.StrType)le.dt_last_seen_contact), ''),IF (le.contact_did <> 0,TRIM((SALT39.StrType)le.contact_did), ''),TRIM((SALT39.StrType)le.contact_name_title),TRIM((SALT39.StrType)le.contact_name_fname),TRIM((SALT39.StrType)le.contact_name_mname),TRIM((SALT39.StrType)le.contact_name_lname),TRIM((SALT39.StrType)le.contact_name_name_suffix),TRIM((SALT39.StrType)le.contact_name_name_score),TRIM((SALT39.StrType)le.contact_type_raw),TRIM((SALT39.StrType)le.contact_job_title_raw),TRIM((SALT39.StrType)le.contact_ssn),IF (le.contact_dob <> 0,TRIM((SALT39.StrType)le.contact_dob), ''),TRIM((SALT39.StrType)le.contact_status_raw),TRIM((SALT39.StrType)le.contact_email),TRIM((SALT39.StrType)le.contact_email_username),TRIM((SALT39.StrType)le.contact_email_domain),TRIM((SALT39.StrType)le.contact_phone),IF (le.cid <> 0,TRIM((SALT39.StrType)le.cid), ''),IF (le.contact_score <> 0,TRIM((SALT39.StrType)le.contact_score), ''),TRIM((SALT39.StrType)le.from_hdr),TRIM((SALT39.StrType)le.company_department),IF (le.company_aceaid <> 0,TRIM((SALT39.StrType)le.company_aceaid), ''),TRIM((SALT39.StrType)le.company_name_type_derived),TRIM((SALT39.StrType)le.company_address_type_derived),TRIM((SALT39.StrType)le.company_org_structure_derived),TRIM((SALT39.StrType)le.company_name_status_derived),TRIM((SALT39.StrType)le.company_status_derived),TRIM((SALT39.StrType)le.proxid_status_private),TRIM((SALT39.StrType)le.powid_status_private),TRIM((SALT39.StrType)le.seleid_status_private),TRIM((SALT39.StrType)le.orgid_status_private),TRIM((SALT39.StrType)le.ultid_status_private),TRIM((SALT39.StrType)le.proxid_status_public),TRIM((SALT39.StrType)le.powid_status_public),TRIM((SALT39.StrType)le.seleid_status_public),TRIM((SALT39.StrType)le.orgid_status_public),TRIM((SALT39.StrType)le.ultid_status_public),TRIM((SALT39.StrType)le.contact_type_derived),TRIM((SALT39.StrType)le.contact_job_title_derived),TRIM((SALT39.StrType)le.contact_status_derived),TRIM((SALT39.StrType)le.address_type_derived),TRIM((SALT39.StrType)le.is_vanity_name_derived)));
  END;
...
SHARED FldIds := DATASET([{1,'source_expanded'}
      ...
      ,{128,'is_vanity_name_derived'}],SALT39.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Ingest_Fields.InValid_source_expanded((SALT39.StrType)le.source_expanded),
    Ingest_Fields.InValid_source((SALT39.StrType)le.source),
    Ingest_Fields.InValid_dt_first_seen((SALT39.StrType)le.dt_first_seen,(SALT39.StrType)le.dt_last_seen),
    Ingest_Fields.InValid_dt_last_seen((SALT39.StrType)le.dt_last_seen),
    Ingest_Fields.InValid_dt_vendor_first_reported((SALT39.StrType)le.dt_vendor_first_reported,(SALT39.StrType)le.dt_vendor_last_reported),
    Ingest_Fields.InValid_dt_vendor_last_reported((SALT39.StrType)le.dt_vendor_last_reported),
    Ingest_Fields.InValid_rcid((SALT39.StrType)le.rcid),
    Ingest_Fields.InValid_company_bdid((SALT39.StrType)le.company_bdid),
    Ingest_Fields.InValid_company_name((SALT39.StrType)le.company_name),
    Ingest_Fields.InValid_company_name_type_raw((SALT39.StrType)le.company_name_type_raw,(SALT39.StrType)le.company_name_type_derived),
    Ingest_Fields.InValid_company_rawaid((SALT39.StrType)le.company_rawaid),
    Ingest_Fields.InValid_company_address_prim_range((SALT39.StrType)le.company_address_prim_range),
    Ingest_Fields.InValid_company_address_predir((SALT39.StrType)le.company_address_predir),
    Ingest_Fields.InValid_company_address_prim_name((SALT39.StrType)le.company_address_prim_name),
    Ingest_Fields.InValid_company_address_addr_suffix((SALT39.StrType)le.company_address_addr_suffix),
    Ingest_Fields.InValid_company_address_postdir((SALT39.StrType)le.company_address_postdir),
    Ingest_Fields.InValid_company_address_unit_desig((SALT39.StrType)le.company_address_unit_desig),
    Ingest_Fields.InValid_company_address_sec_range((SALT39.StrType)le.company_address_sec_range),
    Ingest_Fields.InValid_company_address_p_city_name((SALT39.StrType)le.company_address_p_city_name,(SALT39.StrType)le.company_address_v_city_name),
    Ingest_Fields.InValid_company_address_v_city_name((SALT39.StrType)le.company_address_v_city_name,(SALT39.StrType)le.company_address_p_city_name),
    Ingest_Fields.InValid_company_address_st((SALT39.StrType)le.company_address_st),
    Ingest_Fields.InValid_company_address_zip((SALT39.StrType)le.company_address_zip),
    Ingest_Fields.InValid_company_address_zip4((SALT39.StrType)le.company_address_zip4),
    Ingest_Fields.InValid_company_address_cart((SALT39.StrType)le.company_address_cart),
    Ingest_Fields.InValid_company_address_cr_sort_sz((SALT39.StrType)le.company_address_cr_sort_sz),
    Ingest_Fields.InValid_company_address_lot((SALT39.StrType)le.company_address_lot),
    Ingest_Fields.InValid_company_address_lot_order((SALT39.StrType)le.company_address_lot_order),
    Ingest_Fields.InValid_company_address_dbpc((SALT39.StrType)le.company_address_dbpc),
    Ingest_Fields.InValid_company_address_chk_digit((SALT39.StrType)le.company_address_chk_digit),
    Ingest_Fields.InValid_company_address_rec_type((SALT39.StrType)le.company_address_rec_type),
    Ingest_Fields.InValid_company_address_fips_state((SALT39.StrType)le.company_address_fips_state),
    Ingest_Fields.InValid_company_address_fips_county((SALT39.StrType)le.company_address_fips_county),
    Ingest_Fields.InValid_company_address_geo_lat((SALT39.StrType)le.company_address_geo_lat),
    Ingest_Fields.InValid_company_address_geo_long((SALT39.StrType)le.company_address_geo_long),
    Ingest_Fields.InValid_company_address_msa((SALT39.StrType)le.company_address_msa),
    Ingest_Fields.InValid_company_address_geo_blk((SALT39.StrType)le.company_address_geo_blk),
    Ingest_Fields.InValid_company_address_geo_match((SALT39.StrType)le.company_address_geo_match),
    Ingest_Fields.InValid_company_address_err_stat((SALT39.StrType)le.company_address_err_stat),
    Ingest_Fields.InValid_company_address_type_raw((SALT39.StrType)le.company_address_type_raw,(SALT39.StrType)le.company_address_type_derived),
    Ingest_Fields.InValid_company_address_category((SALT39.StrType)le.company_address_category),
    Ingest_Fields.InValid_company_address_country_code((SALT39.StrType)le.company_address_country_code),
    Ingest_Fields.InValid_company_fein((SALT39.StrType)le.company_fein),
    Ingest_Fields.InValid_best_fein_indicator((SALT39.StrType)le.best_fein_indicator),
    Ingest_Fields.InValid_company_phone((SALT39.StrType)le.company_phone),
    Ingest_Fields.InValid_phone_type((SALT39.StrType)le.phone_type),
    Ingest_Fields.InValid_company_org_structure_raw((SALT39.StrType)le.company_org_structure_raw,(SALT39.StrType)le.company_org_structure_derived),
    Ingest_Fields.InValid_company_incorporation_date((SALT39.StrType)le.company_incorporation_date),
    Ingest_Fields.InValid_company_sic_code1((SALT39.StrType)le.company_sic_code1),
    Ingest_Fields.InValid_company_sic_code2((SALT39.StrType)le.company_sic_code2),
    Ingest_Fields.InValid_company_sic_code3((SALT39.StrType)le.company_sic_code3),
    Ingest_Fields.InValid_company_sic_code4((SALT39.StrType)le.company_sic_code4),
    Ingest_Fields.InValid_company_sic_code5((SALT39.StrType)le.company_sic_code5),
    Ingest_Fields.InValid_company_naics_code1((SALT39.StrType)le.company_naics_code1),
    Ingest_Fields.InValid_company_naics_code2((SALT39.StrType)le.company_naics_code2),
    Ingest_Fields.InValid_company_naics_code3((SALT39.StrType)le.company_naics_code3),
    Ingest_Fields.InValid_company_naics_code4((SALT39.StrType)le.company_naics_code4),
    Ingest_Fields.InValid_company_naics_code5((SALT39.StrType)le.company_naics_code5),
    Ingest_Fields.InValid_company_ticker((SALT39.StrType)le.company_ticker,(SALT39.StrType)le.company_ticker_exchange),
    Ingest_Fields.InValid_company_ticker_exchange((SALT39.StrType)le.company_ticker_exchange,(SALT39.StrType)le.company_ticker),
    Ingest_Fields.InValid_company_foreign_domestic((SALT39.StrType)le.company_foreign_domestic),
    Ingest_Fields.InValid_company_url((SALT39.StrType)le.company_url),
    Ingest_Fields.InValid_company_inc_state((SALT39.StrType)le.company_inc_state),
    Ingest_Fields.InValid_company_charter_number((SALT39.StrType)le.company_charter_number),
    Ingest_Fields.InValid_company_filing_date((SALT39.StrType)le.company_filing_date),
    Ingest_Fields.InValid_company_status_date((SALT39.StrType)le.company_status_date),
    Ingest_Fields.InValid_company_foreign_date((SALT39.StrType)le.company_foreign_date),
    Ingest_Fields.InValid_event_filing_date((SALT39.StrType)le.event_filing_date),
    Ingest_Fields.InValid_company_name_status_raw((SALT39.StrType)le.company_name_status_raw),
    Ingest_Fields.InValid_company_status_raw((SALT39.StrType)le.company_status_raw,(SALT39.StrType)le.company_status_derived),
    Ingest_Fields.InValid_dt_first_seen_company_name((SALT39.StrType)le.dt_first_seen_company_name),
    Ingest_Fields.InValid_dt_last_seen_company_name((SALT39.StrType)le.dt_last_seen_company_name),
    Ingest_Fields.InValid_dt_first_seen_company_address((SALT39.StrType)le.dt_first_seen_company_address),
    Ingest_Fields.InValid_dt_last_seen_company_address((SALT39.StrType)le.dt_last_seen_company_address),
    Ingest_Fields.InValid_vl_id((SALT39.StrType)le.vl_id),
    Ingest_Fields.InValid_current((SALT39.StrType)le.current),
    Ingest_Fields.InValid_source_record_id((SALT39.StrType)le.source_record_id),
    Ingest_Fields.InValid_glb((SALT39.StrType)le.glb),
    Ingest_Fields.InValid_dppa((SALT39.StrType)le.dppa),
    Ingest_Fields.InValid_phone_score((SALT39.StrType)le.phone_score),
    Ingest_Fields.InValid_match_company_name((SALT39.StrType)le.match_company_name),
    Ingest_Fields.InValid_match_branch_city((SALT39.StrType)le.match_branch_city),
    Ingest_Fields.InValid_match_geo_city((SALT39.StrType)le.match_geo_city),
    Ingest_Fields.InValid_duns_number((SALT39.StrType)le.duns_number),
    Ingest_Fields.InValid_source_docid((SALT39.StrType)le.source_docid),
    Ingest_Fields.InValid_is_contact((SALT39.StrType)le.is_contact,(SALT39.StrType)le.contact_name_fname,(SALT39.StrType)le.contact_name_lname),
    Ingest_Fields.InValid_dt_first_seen_contact((SALT39.StrType)le.dt_first_seen_contact),
    Ingest_Fields.InValid_dt_last_seen_contact((SALT39.StrType)le.dt_last_seen_contact),
    Ingest_Fields.InValid_contact_did((SALT39.StrType)le.contact_did),
    Ingest_Fields.InValid_contact_name_title((SALT39.StrType)le.contact_name_title),
    Ingest_Fields.InValid_contact_name_fname((SALT39.StrType)le.contact_name_fname,(SALT39.StrType)le.contact_name_lname),
    Ingest_Fields.InValid_contact_name_mname((SALT39.StrType)le.contact_name_mname),
    Ingest_Fields.InValid_contact_name_lname((SALT39.StrType)le.contact_name_lname,(SALT39.StrType)le.contact_name_fname),
    Ingest_Fields.InValid_contact_name_name_suffix((SALT39.StrType)le.contact_name_name_suffix),
    Ingest_Fields.InValid_contact_name_name_score((SALT39.StrType)le.contact_name_name_score),
    Ingest_Fields.InValid_contact_type_raw((SALT39.StrType)le.contact_type_raw,(SALT39.StrType)le.contact_type_derived),
    Ingest_Fields.InValid_contact_job_title_raw((SALT39.StrType)le.contact_job_title_raw,(SALT39.StrType)le.contact_job_title_derived),
    Ingest_Fields.InValid_contact_ssn((SALT39.StrType)le.contact_ssn),
    Ingest_Fields.InValid_contact_dob((SALT39.StrType)le.contact_dob),
    Ingest_Fields.InValid_contact_status_raw((SALT39.StrType)le.contact_status_raw),
    Ingest_Fields.InValid_contact_email((SALT39.StrType)le.contact_email),
    Ingest_Fields.InValid_contact_email_username((SALT39.StrType)le.contact_email_username),
    Ingest_Fields.InValid_contact_email_domain((SALT39.StrType)le.contact_email_domain),
    Ingest_Fields.InValid_contact_phone((SALT39.StrType)le.contact_phone),
    Ingest_Fields.InValid_cid((SALT39.StrType)le.cid),
    Ingest_Fields.InValid_contact_score((SALT39.StrType)le.contact_score),
    Ingest_Fields.InValid_from_hdr((SALT39.StrType)le.from_hdr),
    Ingest_Fields.InValid_company_department((SALT39.StrType)le.company_department),
    Ingest_Fields.InValid_company_aceaid((SALT39.StrType)le.company_aceaid),
    Ingest_Fields.InValid_company_name_type_derived((SALT39.StrType)le.company_name_type_derived,(SALT39.StrType)le.company_name_type_raw),
    Ingest_Fields.InValid_company_address_type_derived((SALT39.StrType)le.company_address_type_derived,(SALT39.StrType)le.company_address_type_raw),
    Ingest_Fields.InValid_company_org_structure_derived((SALT39.StrType)le.company_org_structure_derived,(SALT39.StrType)le.company_org_structure_raw),
    Ingest_Fields.InValid_company_name_status_derived((SALT39.StrType)le.company_name_status_derived,(SALT39.StrType)le.company_name_status_raw),
    Ingest_Fields.InValid_company_status_derived((SALT39.StrType)le.company_status_derived,(SALT39.StrType)le.company_status_raw),
    Ingest_Fields.InValid_proxid_status_private((SALT39.StrType)le.proxid_status_private),
    Ingest_Fields.InValid_powid_status_private((SALT39.StrType)le.powid_status_private),
    Ingest_Fields.InValid_seleid_status_private((SALT39.StrType)le.seleid_status_private),
    Ingest_Fields.InValid_orgid_status_private((SALT39.StrType)le.orgid_status_private),
    Ingest_Fields.InValid_ultid_status_private((SALT39.StrType)le.ultid_status_private),
    Ingest_Fields.InValid_proxid_status_public((SALT39.StrType)le.proxid_status_public),
    Ingest_Fields.InValid_powid_status_public((SALT39.StrType)le.powid_status_public),
    Ingest_Fields.InValid_seleid_status_public((SALT39.StrType)le.seleid_status_public),
    Ingest_Fields.InValid_orgid_status_public((SALT39.StrType)le.orgid_status_public),
    Ingest_Fields.InValid_ultid_status_public((SALT39.StrType)le.ultid_status_public),
    Ingest_Fields.InValid_contact_type_derived((SALT39.StrType)le.contact_type_derived,(SALT39.StrType)le.contact_type_raw),
    Ingest_Fields.InValid_contact_job_title_derived((SALT39.StrType)le.contact_job_title_derived,(SALT39.StrType)le.contact_job_title_raw),
    Ingest_Fields.InValid_contact_status_derived((SALT39.StrType)le.contact_status_derived,(SALT39.StrType)le.contact_status_raw),
    Ingest_Fields.InValid_address_type_derived((SALT39.StrType)le.address_type_derived),
    Ingest_Fields.InValid_is_vanity_name_derived((SALT39.StrType)le.is_vanity_name_derived),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doSummaryPerSrc = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_BIPV2, Ingest_Fields, 'RECORDOF(fieldPopulationOverall)', TRUE);
  ...
  fieldPopulationOverall_TotalRecs_Standard := IF(doSummaryGlobal, SALT39.mod_StandardStatsTransforms.mac_hygieneTotalRecs(fieldPopulationOverall, myTimeStamp, 'all', TRUE, 'all'));
  fieldPopulationPerSource_TotalRecs_Standard := IF(doSummaryPerSrc, SALT39.mod_StandardStatsTransforms.mac_hygieneTotalRecs(fieldPopulationPerSource, myTimeStamp, 'src', TRUE, 'src'));
