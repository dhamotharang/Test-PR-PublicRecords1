...
SHARED FldIds := DATASET([{1,'source_expanded'}
      ...
      ,{92,'contact_name_name_suffix'}
      ,{93,'contact_name_name_score'}
      ,{94,'contact_type_raw'}
      ,{95,'contact_job_title_raw'}
      ,{96,'contact_ssn'}
      ,{97,'contact_dob'}
      ,{98,'contact_status_raw'}
      ,{99,'contact_email'}
      ,{100,'contact_email_username'}
      ,{101,'contact_email_domain'}
      ,{102,'contact_phone'}
      ,{103,'cid'}
      ,{104,'contact_score'}
      ,{105,'from_hdr'}
      ,{106,'company_department'}
      ,{107,'company_aceaid'}
      ,{108,'company_name_type_derived'}
      ,{109,'company_address_type_derived'}
      ,{110,'company_org_structure_derived'}
      ,{111,'company_name_status_derived'}
      ,{112,'company_status_derived'}
      ,{113,'proxid_status_private'}
      ,{114,'powid_status_private'}
      ,{115,'seleid_status_private'}
      ,{116,'orgid_status_private'}
      ,{117,'ultid_status_private'}
      ,{118,'proxid_status_public'}
      ,{119,'powid_status_public'}
      ,{120,'seleid_status_public'}
      ,{121,'orgid_status_public'}
      ,{122,'ultid_status_public'}
      ,{123,'contact_type_derived'}
      ,{124,'contact_job_title_derived'}
      ,{125,'contact_status_derived'}
      ,{126,'address_type_derived'}
      ,{127,'is_vanity_name_derived'}],SALT311.MAC_Character_Counts.Field_Identification);
