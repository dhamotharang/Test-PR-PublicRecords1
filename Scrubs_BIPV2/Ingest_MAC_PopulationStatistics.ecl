...
+    #IF( #TEXT(Input_contact_name_mname)='' )
      '' 
    #ELSE
        IF( le.Input_contact_name_mname = (TYPEOF(le.Input_contact_name_mname))'','',':contact_name_mname')
    #END
