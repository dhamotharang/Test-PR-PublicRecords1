...
EXPORT Make_contact_name_lname(SALT311.StrType s0) := s0;
EXPORT InValid_contact_name_lname(SALT311.StrType s) := 0;
EXPORT InValidMessage_contact_name_lname(UNSIGNED1 wh) := '';
