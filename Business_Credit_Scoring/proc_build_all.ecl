...
EXPORT	proc_Build_All(	STRING	pVersion		=	(STRING8)Std.Date.Today(),
	...
	EXPORT	dops_update		:=	dops.updateversion('SbfeCvScoringKeys', pVersion, 'Kranthi.Kumar@lexisnexisrisk.com, Christopher.Brodeur@lexisnexis.com, Sudhir.Kasavajjala@lexisnexisrisk.com', , 'N',l_isprodready:=pIsProdReady,l_updateflag:=pUpdateFlag); 															
