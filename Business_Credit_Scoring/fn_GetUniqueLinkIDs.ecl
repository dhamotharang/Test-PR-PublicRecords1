IMPORT	Business_Credit_Scoring,	Business_Credit,	Business_Risk_BIP,	ut,	Address;
EXPORT	fn_GetUniqueLinkIDs(	STRING	pVersion	=	ut.GetDate,
	...
	pInputGroup	:=	GROUP(SORT(DISTRIBUTE(pInput(	UltID		>	0 OR 
										...
										HASH(	UltID, OrgID, SeleID)),
													UltID, OrgID, SeleID, -cycle_end_date, LOCAL),
