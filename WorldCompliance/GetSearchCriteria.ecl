...
GetCategories(set of string fCategory) := PROJECT(AllCategories(category in fCategory),rCriteria);
...
EXPORT GetSearchCriteria(set of string fCategory = [], integer fCountry = 0) := 
