EXPORT names := MODULE
  ...
  EXPORT key_DNC := key_dnc_part1 +'qa::' +key_dnc_part2;
  EXPORT key_DNC_father := key_dnc_part1 +'father::' + key_dnc_part2;
  EXPORT key_DNC_grandfather := key_dnc_part1 + 'grandfather::' +key_dnc_part2;
