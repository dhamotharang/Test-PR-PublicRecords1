...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_contact_id_pcnt *   0.00 / 100 + T.Populated_did_pcnt *   0.00 / 100 + T.Populated_bdid_pcnt *   0.00 / 100 + T.Populated_ssn_pcnt *   0.00 / 100 + T.Populated_company_name_pcnt *   0.00 / 100 + T.Populated_company_predir_pcnt *   0.00 / 100 + T.Populated_company_postdir_pcnt *   0.00 / 100 + T.Populated_company_state_pcnt *   0.00 / 100 + T.Populated_company_zip_pcnt *   0.00 / 100 + T.Populated_company_zip4_pcnt *   0.00 / 100 + T.Populated_company_phone_pcnt *   0.00 / 100 + T.Populated_fname_pcnt *   0.00 / 100 + T.Populated_lname_pcnt *   0.00 / 100 + T.Populated_county_pcnt *   0.00 / 100 + T.Populated_phone_pcnt *   0.00 / 100 + T.Populated_active_phone_flag_pcnt *   0.00 / 100 + T.Populated_GLB_pcnt *   0.00 / 100 + T.Populated_source_pcnt *   0.00 / 100 + T.Populated_source_count_pcnt *   0.00 / 100 + T.Populated_dead_flag_pcnt *   0.00 / 100 + T.Populated_from_hdr_pcnt *   0.00 / 100 + T.Populated_RawAid_pcnt *   0.00 / 100 + T.Populated_Company_RawAid_pcnt *   0.00 / 100 + T.Populated_global_sid_pcnt *   0.00 / 100 + T.Populated_record_sid_pcnt *   0.00 / 100 + T.Populated_record_type_pcnt *   0.00 / 100 + T.Populated_predir_pcnt *   0.00 / 100 + T.Populated_postdir_pcnt *   0.00 / 100 + T.Populated_state_pcnt *   0.00 / 100 + T.Populated_zip_pcnt *   0.00 / 100 + T.Populated_zip4_pcnt *   0.00 / 100 + T.Populated_geo_lat_pcnt *   0.00 / 100 + T.Populated_geo_long_pcnt *   0.00 / 100 + T.Populated_msa_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_contact_id_pcnt,le.populated_did_pcnt,le.populated_bdid_pcnt,le.populated_ssn_pcnt,le.populated_company_name_pcnt,le.populated_company_predir_pcnt,le.populated_company_postdir_pcnt,le.populated_company_state_pcnt,le.populated_company_zip_pcnt,le.populated_company_zip4_pcnt,le.populated_company_phone_pcnt,le.populated_fname_pcnt,le.populated_lname_pcnt,le.populated_county_pcnt,le.populated_phone_pcnt,le.populated_active_phone_flag_pcnt,le.populated_GLB_pcnt,le.populated_source_pcnt,le.populated_source_count_pcnt,le.populated_dead_flag_pcnt,le.populated_from_hdr_pcnt,le.populated_RawAid_pcnt,le.populated_Company_RawAid_pcnt,le.populated_global_sid_pcnt,le.populated_record_sid_pcnt,le.populated_record_type_pcnt,le.populated_predir_pcnt,le.populated_postdir_pcnt,le.populated_state_pcnt,le.populated_zip_pcnt,le.populated_zip4_pcnt,le.populated_geo_lat_pcnt,le.populated_geo_long_pcnt,le.populated_msa_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_contact_id,le.maxlength_did,le.maxlength_bdid,le.maxlength_ssn,le.maxlength_company_name,le.maxlength_company_predir,le.maxlength_company_postdir,le.maxlength_company_state,le.maxlength_company_zip,le.maxlength_company_zip4,le.maxlength_company_phone,le.maxlength_fname,le.maxlength_lname,le.maxlength_county,le.maxlength_phone,le.maxlength_active_phone_flag,le.maxlength_GLB,le.maxlength_source,le.maxlength_source_count,le.maxlength_dead_flag,le.maxlength_from_hdr,le.maxlength_RawAid,le.maxlength_Company_RawAid,le.maxlength_global_sid,le.maxlength_record_sid,le.maxlength_record_type,le.maxlength_predir,le.maxlength_postdir,le.maxlength_state,le.maxlength_zip,le.maxlength_zip4,le.maxlength_geo_lat,le.maxlength_geo_long,le.maxlength_msa);
  SELF.avelength := CHOOSE(C,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_contact_id,le.avelength_did,le.avelength_bdid,le.avelength_ssn,le.avelength_company_name,le.avelength_company_predir,le.avelength_company_postdir,le.avelength_company_state,le.avelength_company_zip,le.avelength_company_zip4,le.avelength_company_phone,le.avelength_fname,le.avelength_lname,le.avelength_county,le.avelength_phone,le.avelength_active_phone_flag,le.avelength_GLB,le.avelength_source,le.avelength_source_count,le.avelength_dead_flag,le.avelength_from_hdr,le.avelength_RawAid,le.avelength_Company_RawAid,le.avelength_global_sid,le.avelength_record_sid,le.avelength_record_type,le.avelength_predir,le.avelength_postdir,le.avelength_state,le.avelength_zip,le.avelength_zip4,le.avelength_geo_lat,le.avelength_geo_long,le.avelength_msa);
END;
EXPORT invSummary := NORMALIZE(summary0, 36, invert(LEFT,COUNTER));
// The character counts
// Move everything into 'inverted list' form so processing can be done 'in library'
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT311.StrType)le.dt_first_seen),TRIM((SALT311.StrType)le.dt_last_seen),IF (le.contact_id <> 0,TRIM((SALT311.StrType)le.contact_id), ''),IF (le.did <> 0,TRIM((SALT311.StrType)le.did), ''),IF (le.bdid <> 0,TRIM((SALT311.StrType)le.bdid), ''),TRIM((SALT311.StrType)le.ssn),TRIM((SALT311.StrType)le.company_name),TRIM((SALT311.StrType)le.company_predir),TRIM((SALT311.StrType)le.company_postdir),TRIM((SALT311.StrType)le.company_state),TRIM((SALT311.StrType)le.company_zip),TRIM((SALT311.StrType)le.company_zip4),TRIM((SALT311.StrType)le.company_phone),TRIM((SALT311.StrType)le.fname),TRIM((SALT311.StrType)le.lname),TRIM((SALT311.StrType)le.county),TRIM((SALT311.StrType)le.phone),TRIM((SALT311.StrType)le.active_phone_flag),TRIM((SALT311.StrType)le.GLB),TRIM((SALT311.StrType)le.source),IF (le.source_count <> 0,TRIM((SALT311.StrType)le.source_count), ''),IF (le.dead_flag <> 0,TRIM((SALT311.StrType)le.dead_flag), ''),TRIM((SALT311.StrType)le.from_hdr),IF (le.RawAid <> 0,TRIM((SALT311.StrType)le.RawAid), ''),IF (le.Company_RawAid <> 0,TRIM((SALT311.StrType)le.Company_RawAid), ''),IF (le.global_sid <> 0,TRIM((SALT311.StrType)le.global_sid), ''),IF (le.record_sid <> 0,TRIM((SALT311.StrType)le.record_sid), ''),TRIM((SALT311.StrType)le.record_type),TRIM((SALT311.StrType)le.predir),TRIM((SALT311.StrType)le.postdir),TRIM((SALT311.StrType)le.state),TRIM((SALT311.StrType)le.zip),TRIM((SALT311.StrType)le.zip4),TRIM((SALT311.StrType)le.geo_lat),TRIM((SALT311.StrType)le.geo_long),TRIM((SALT311.StrType)le.msa)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_first_seen'}
      ...
      ,{34,'geo_lat'}
      ,{35,'geo_long'}
      ,{36,'msa'}],SALT311.MAC_Character_Counts.Field_Identification);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_reformated_date','invalid_reformated_date','invalid_numeric','invalid_mandatory','invalid_mandatory','invalid_numeric_or_blank','invalid_name','invalid_direction','invalid_direction','invalid_st','invalid_zip5','invalid_zip4','invalid_phone','invalid_name','invalid_name','invalid_county','invalid_phone','invalid_phone_flag','invalid_glb','invalid_mandatory','invalid_numeric','invalid_dead_flag','invalid_from_hdr','invalid_numeric','invalid_numeric','invalid_numeric_or_blank','invalid_numeric_or_blank','invalid_record_type','invalid_direction','invalid_direction','invalid_st','invalid_zip5','invalid_zip4','invalid_geo','invalid_geo','invalid_msa');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Base_Fields.InValidMessage_contact_id(TotalErrors.ErrorNum),Base_Fields.InValidMessage_did(TotalErrors.ErrorNum),Base_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),Base_Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_predir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_postdir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_state(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_zip4(TotalErrors.ErrorNum),Base_Fields.InValidMessage_company_phone(TotalErrors.ErrorNum),Base_Fields.InValidMessage_fname(TotalErrors.ErrorNum),Base_Fields.InValidMessage_lname(TotalErrors.ErrorNum),Base_Fields.InValidMessage_county(TotalErrors.ErrorNum),Base_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Base_Fields.InValidMessage_active_phone_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_GLB(TotalErrors.ErrorNum),Base_Fields.InValidMessage_source(TotalErrors.ErrorNum),Base_Fields.InValidMessage_source_count(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dead_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_from_hdr(TotalErrors.ErrorNum),Base_Fields.InValidMessage_RawAid(TotalErrors.ErrorNum),Base_Fields.InValidMessage_Company_RawAid(TotalErrors.ErrorNum),Base_Fields.InValidMessage_global_sid(TotalErrors.ErrorNum),Base_Fields.InValidMessage_record_sid(TotalErrors.ErrorNum),Base_Fields.InValidMessage_record_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_predir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_state(TotalErrors.ErrorNum),Base_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),Base_Fields.InValidMessage_msa(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
