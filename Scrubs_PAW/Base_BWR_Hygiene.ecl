...
#workunit('name','Scrubs_PAW.Base_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_PAW,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_PAW.Base_In_PAW;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_PAW.Base_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_Layout_PAW'),NAMED('OptimizedLayout'));// File layout suggested by data
