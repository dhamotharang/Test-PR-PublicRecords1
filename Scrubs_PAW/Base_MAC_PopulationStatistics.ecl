...
EXPORT Base_MAC_PopulationStatistics(infile,Ref='',Input_dt_first_seen = '',Input_dt_last_seen = '',Input_contact_id = '',Input_did = '',Input_bdid = '',Input_ssn = '',Input_company_name = '',Input_company_predir = '',Input_company_postdir = '',Input_company_state = '',Input_company_zip = '',Input_company_zip4 = '',Input_company_phone = '',Input_fname = '',Input_lname = '',Input_county = '',Input_phone = '',Input_active_phone_flag = '',Input_GLB = '',Input_source = '',Input_source_count = '',Input_dead_flag = '',Input_from_hdr = '',Input_RawAid = '',Input_Company_RawAid = '',Input_global_sid = '',Input_record_sid = '',Input_record_type = '',Input_predir = '',Input_postdir = '',Input_state = '',Input_zip = '',Input_zip4 = '',Input_geo_lat = '',Input_geo_long = '',Input_msa = '',OutFile) := MACRO
