...
export Configuration := module
	...
	// export IsMetronet		(string40 svcName) := STD.Str.ToLowerCase(trim(svcName)) = Gateway.Constants.ServiceName.Metronet; // Discontinued as a part of Experian Removal Project 
