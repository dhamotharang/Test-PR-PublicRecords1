/*2016-08-09T23:57:55Z (Kevin Huls)
JIRA RQ-12879  Initial check in
*/
import iesp, gateway, Royalty;

export SoapCall_FICOScoreXD(dataset(iesp.equifax_sts.t_EquifaxSTSRequest) Input, Gateway.Layouts.Config gateway_cfg, boolean makeGatewayCall = FALSE) := function
...
iesp.equifax_sts.t_EquifaxSTSRequest into_in(Input le) := transform
	...
	self.GatewayParams.RoyaltyCode 			:= Royalty.Constants.RoyaltyCode.FICOScoreXD;
	self.GatewayParams.RoyaltyType 			:= Royalty.Constants.RoyaltyType.FICOScoreXD;	
