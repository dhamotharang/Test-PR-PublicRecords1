...
(ids,t,datasetPL,outPL,didL ='did',bdidL ='bdid',uniqueid = 'prolic_seq_id', typeStr='\'AK\'',FakeIDField = 'unsigned6 FakeID',
...
outPL := project(%outPLfat%, {%outPLfat%.id, %outPLfat%.didL, %outPLfat%.bdidL, %outPLfat%.uniqueid});
