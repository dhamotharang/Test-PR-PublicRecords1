...
*/
IMPORT Autokey_batch,BatchServices,doxie,Prof_License,Prof_LicenseV2,doxie_files,Ingenix_NatlProf;
...
EXPORT PL_Batch_Service_Records(unsigned1 pt = 20,
  ...
  ids_acctno_by_NPI :=  prof_LicenseV2_Services.Prof_Lic_Raw.Batch_View.get_prolic_seq_ID_by_npi(	                                                                       
	                                            project(ds_batch_in_NPI,transform(prof_LicenseV2_Services.Assorted_Layouts.ProvId_NPI,
																							                          self.npi := left.npi,
