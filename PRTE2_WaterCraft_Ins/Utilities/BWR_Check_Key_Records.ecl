...
IMPORT PRTE2_WaterCraft_Ins.Utilities;
...
KeyLayouts := Key_Layouts_For_Checking;
DIDKeyLay_i := KeyLayouts.DIDKeyLay_i;
DIDKeyLay := KeyLayouts.DIDKeyLay;
WID_Key_Layout_i := KeyLayouts.WID_Key_Layout_i;
WID_Key_Layout := KeyLayouts.WID_Key_Layout;
