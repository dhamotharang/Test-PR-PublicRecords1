...
Command line options: -MScrubs_Corp2_Mapping_WI_Main -eC:\Users\myanasx\AppData\Local\Temp\TFRAF1.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_WI_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(55)
FIELDTYPE:invalid_state_origin:ENUM(WI)
FIELDTYPE:invalid_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_WI_Main.Functions.set_valid_org_structure_cd)
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_WI_Main.Functions.invalid_name_type_code>0,recordorigin)
...
FIELDTYPE:invalid_status_cd:ENUM(Scrubs_Corp2_Mapping_WI_Main.Functions.set_valid_status_cd)
