...
export fLiens_As_Business_Header(dataset(Layout_Liens) pFile_Liens) :=
function
	...
	Business_Header.Layout_Business_Header  Translate_Liens_to_BHF(Layout_Liens l) := 
	transform
	...
	liens_init := project(pFile_Liens((indivbusun='B' or aka_yn = 'B') and (integer)did <= 999999001000 ), Translate_Liens_to_BHF(left));
