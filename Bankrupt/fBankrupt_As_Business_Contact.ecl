...
export fBankrupt_As_Business_Contact(dataset(Layout_BK_Search_v8) pFile_BK_Search, dataset(layout_bk_main_v8) pFile_BK_Main) :=
function
	...
	bs := pFile_BK_Search((court_code <> '' and case_number <> '') or case_number[1..3] <> '449');
	...
	Business_Bankruptcies_Dist := distribute(fBankrupt_As_Business_Header(pFile_BK_Search, pFile_BK_Main), hash((string5)vendor_id[1..5], (string7)(vendor_id[6..12])));
