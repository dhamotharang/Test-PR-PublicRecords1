import strata, ut;
export createAsBusinessContactStats(
	 pDataset
	,pBuildName 
	,pBuildSubSet 
	,pVersionName 
...
macro
	...
	strata.createXMLStats(%pDataset_stat%, pBuildName, pBuildSubSet, pVersionName, pEmailNotifyList, pOutput, 'AsBusinessContact', 'Population');
