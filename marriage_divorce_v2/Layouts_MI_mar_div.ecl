...
export Layouts_MI_mar_div := MODULE




 export Layout_Intermediate_MI_mar_div := record
...
//going to use abintio or unix process to format and process this file.
/*
export Layout_MI_mar_div:= record
