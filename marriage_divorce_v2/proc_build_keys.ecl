...
DOPSGrowthCheck.CalculateStats(	'FCRA_MDV2Keys','marriage_divorce_v2.key_mar_div_id_main(true)','key_MDV2_FCRA','~thor_data400::key::mar_div::fcra::'+filedate+'::id_main','record_id','persistent_record_id','','','','',filedate,father_filedate,true,true),
DOPSGrowthCheck.CalculateStats(	'FCRA_MDV2Keys','marriage_divorce_v2.key_mar_div_id_search(true)','key_MDV2_FCRA','~thor_data400::key::mar_div::fcra::'+filedate+'::id_search','record_id,which_party','persistent_record_id','','','','',filedate,father_filedate,true,true),
DOPSGrowthCheck.DeltaCommand('~thor_data400::key::mar_div::fcra::'+filedate+'::id_main', '~thor_data400::key::mar_div::fcra::'+father_filedate+'::id_main', 'FCRA_MDV2Keys', 'key_MDV2_FCRA', 'marriage_divorce_v2.key_mar_div_id_main(true)', 'persistent_record_id', filedate, father_filedate, InputSet_MDV2_id_main,true,true),
DOPSGrowthCheck.DeltaCommand('~thor_data400::key::mar_div::fcra::'+filedate+'::id_search', '~thor_data400::key::mar_div::fcra::'+father_filedate+'::id_search', 'FCRA_MDV2Keys', 'key_MDV2_FCRA', 'marriage_divorce_v2.key_mar_div_id_search(true)', 'persistent_record_id', filedate, father_filedate, InputSet_MDV2_id_search,true,true),
DOPSGrowthCheck.ChangesByField('~thor_data400::key::mar_div::fcra::'+filedate+'::id_main','~thor_data400::key::mar_div::fcra::'+father_filedate+'::id_main','FCRA_MDV2Keys','key_MDV2_FCRA','marriage_divorce_v2.key_mar_div_id_main(true)','persistent_record_id','',filedate,father_filedate,true,true),
DOPSGrowthCheck.ChangesByField('~thor_data400::key::mar_div::fcra::'+filedate+'::id_search','~thor_data400::key::mar_div::fcra::'+father_filedate+'::id_search','FCRA_MDV2Keys','key_MDV2_FCRA','marriage_divorce_v2.key_mar_div_id_search(true)','persistent_record_id','',filedate,father_filedate,true,true),
DOPSGrowthCheck.PersistenceCheck('~thor_data400::base::mar_div::base',  '~thor_data400::base::mar_div::base_father',  'FCRA_MDV2Keys',  'key_MDV2_FCRA',  'marriage_divorce_v2.layout_mar_div_base',  'persistent_record_id',  Persistent_ID_MDV2,  Persistent_ID_MDV2,  filedate,  father_filedate,true,  false),
DOPSGrowthCheck.PersistenceCheck('~thor_data400::base::mar_div::base',  '~thor_data400::base::mar_div::base_father',  'FCRA_MDV2Keys',  'key_MDV2_FCRA',  'marriage_divorce_v2.layout_mar_div_base',  'persistent_record_id',  Persistent_ID_MDV2,  Persistent_ID_MDV2,  filedate,  father_filedate,true,  false)
);
