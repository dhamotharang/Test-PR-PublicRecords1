...
self.party1_previous_marital_status := case(le.groom_last_mar_end,'M'=>'MARRIAGE','CU'=>'CIVIL UNION','');
...
//wife
 ...
 self.party2_previous_marital_status := case(le.bride_last_mar_end,'M'=>'MARRIAGE','CU'=>'CIVIL UNION','');
