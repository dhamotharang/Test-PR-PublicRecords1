...
export Constants := module
  ...
  export RoyaltyCode := module
    ...
    export unsigned2 NETACUITY_IP_METADATA := 171;
    ...
    export unsigned2 CA_VALUE_AVM_INTERACTIVE_PLUS := 573;
    export unsigned2 CA_VALUE_RANGE_AVM := 574;
    export unsigned2 CA_VALUE_RANGE_AVM_PLUS := 575;
    export unsigned2 CA_VALUE_RANGE_AVM_EXPRESS := 576;
    export unsigned2 CA_VALUE_AVM_EXPRESS := 577;
    export unsigned2 CA_VALUE_AVM_EXPRESS_PLUS := 578;
    export unsigned2 CA_NEIGHBORHOOD_VALUE_RANGE := 579;
    export unsigned2 CA_NEIGHBORHOOD_VALUE_RANGE_PLUS := 580;
    export unsigned2 CA_COMPLEXITY_PROFILER := 581;
    export unsigned2 CA_COMPLEXITY_PROFILER_PLUS := 582;
    export unsigned2 CA_MARKET_CONDITION := 583;
    export unsigned2 CA_RISK_PROFILER := 584;
  ...
  export RoyaltyType := module
    ...
    export NETACUITY_IP_METADATA := _TYPE(RoyaltyCode.NETACUITY_IP_METADATA);
    ...
    export CA_VALUE_AVM_INTERACTIVE_PLUS := _TYPE(RoyaltyCode.CA_VALUE_AVM_INTERACTIVE_PLUS);
    export CA_VALUE_RANGE_AVM := _TYPE(RoyaltyCode.CA_VALUE_RANGE_AVM);
    export CA_VALUE_RANGE_AVM_PLUS := _TYPE(RoyaltyCode.CA_VALUE_RANGE_AVM_PLUS);
    export CA_VALUE_RANGE_AVM_EXPRESS := _TYPE(RoyaltyCode.CA_VALUE_RANGE_AVM_EXPRESS);
    export CA_VALUE_AVM_EXPRESS := _TYPE(RoyaltyCode.CA_VALUE_AVM_EXPRESS);
    export CA_VALUE_AVM_EXPRESS_PLUS := _TYPE(RoyaltyCode.CA_VALUE_AVM_EXPRESS_PLUS);
    export CA_NEIGHBORHOOD_VALUE_RANGE := _TYPE(RoyaltyCode.CA_NEIGHBORHOOD_VALUE_RANGE);
    export CA_NEIGHBORHOOD_VALUE_RANGE_PLUS := _TYPE(RoyaltyCode.CA_NEIGHBORHOOD_VALUE_RANGE_PLUS);
    export CA_COMPLEXITY_PROFILER := _TYPE(RoyaltyCode.CA_COMPLEXITY_PROFILER);
    export CA_COMPLEXITY_PROFILER_PLUS := _TYPE(RoyaltyCode.CA_COMPLEXITY_PROFILER_PLUS);
    export CA_MARKET_CONDITION := _TYPE(RoyaltyCode.CA_MARKET_CONDITION);
    export CA_RISK_PROFILER := _TYPE(RoyaltyCode.CA_RISK_PROFILER);
