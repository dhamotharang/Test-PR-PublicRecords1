...
EXPORT Constants := module
	...
	export RoyaltyType := module	
		shared _TYPE(unsigned2 _code)	:= TRIM(Master(file_name='ROYALTY', field_name2=(string)_code)[1].field_name, LEFT, RIGHT);	
	...
	export GatewayRoyalties := SET(Master(source_type=SourceType.GATEWAY), (unsigned2) field_name2);
