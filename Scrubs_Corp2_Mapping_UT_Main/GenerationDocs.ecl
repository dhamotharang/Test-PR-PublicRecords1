...
Command line options: -MScrubs_Corp2_Mapping_UT_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR2169.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_UT_Main
FILENAME:in_file
...
FIELDTYPE:invalid_corp_vendor:ENUM(49)
FIELDTYPE:invalid_state_origin:ENUM(UT)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_UT_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_name_type_desc:ALLOW( -.ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_flag_code:ENUM(Y|N| )
FIELDTYPE:invalid_date:ALLOW(0123456789):CUSTOM(Scrubs.fn_valid_pastDate>0):SPACES( )
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_alphablank:ALLOW( ,ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_org_struc_desc:ENUM(Scrubs_Corp2_Mapping_UT_Main.Functions.set_valid_org_desc)
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_org_struc_desc):0,0
