 IMPORT prte2, PRTE, PRTE2_Common;
...
// END: ************ OLD historical files. data - search - ALL OF THESE may be obsolete. **********************************
	...
	// The DS is always referenced via the PRTE_CSV.ge_header_base.AlphaFinalHeaderDS --- May become obsolete
	// EXPORT AlphaFinalHeaderBaseDS := DATASET(AlphaFinalHeaderBaseName, prte2.layouts.batch_in_LNProperty, THOR);
	...
	EXPORT PhonesPlus_MODULE_SUFFIX		:= '::phonesplus_Alpha';
