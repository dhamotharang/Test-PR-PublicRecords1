...
%vls% := PROJECT ( TOPN (values_file,SALT33.Config.Specificity_Profile_MaxExamples,-field_specificity),%intoval%(LEFT) ) +
         SORT ( PROJECT ( TOPN (values_file,SALT33.Config.Specificity_Profile_MaxExamples,field_specificity),%intoval%(LEFT) ),cnt );
