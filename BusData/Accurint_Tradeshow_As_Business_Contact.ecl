import ut, address, Business_Header, Busdata;
...
Business_Header.Layout_Business_Contact_Full Extract_aca_internet_march_success(BusData.Layout_aca_internet_march_success_in l) := transform
self.source := 'AT';
...
// ace_check_serv
Business_Header.Layout_Business_Contact_Full Extract_ace_check_serv(BusData.Layout_ace_check_serv_in l) := transform
self.source := 'AT';
...
// ace_icsp
Business_Header.Layout_Business_Contact_Full Extract_ace_icsp(BusData.Layout_ace_icsp_in l) := transform
self.source := 'AT';
...
// ace_international
Business_Header.Layout_Business_Contact_Full Extract_ace_international(BusData.Layout_ace_international_in l) := transform
self.source := 'AT';
...
// card_tech_securtech
Business_Header.Layout_Business_Contact_Full Extract_card_tech_securtech(BusData.Layout_card_tech_securtech_in l) := transform
self.source := 'AT';
...
Business_Header.Layout_Business_Contact_Full Extract_customer_info_system(BusData.Layout_customer_info_system_in l) := transform
self.source := 'AT';
...
self.clean_name := choose(c, AddrCleanLib.CleanPerson73(l.Name1),
                             AddrCleanLib.CleanPerson73(l.Name2),
                             AddrCleanLib.CleanPerson73(l.Name3),
                             AddrCleanLib.CleanPerson73(l.Name_4),
                             AddrCleanLib.CleanPerson73(l.Name_5),
                             AddrCleanLib.CleanPerson73(l.Name_6),
                             AddrCleanLib.CleanPerson73(l.Name_7),
                             AddrCleanLib.CleanPerson73(l.Name_8));
					    self := l;
end;

factoring_conference_norm := normalize(BusData.File_factoring_conference_in, 8, Norm_factoring_conference(left, counter));

Business_Header.Layout_Business_Contact_Full Extract_factoring_conference(Layout_factoring_conference_temp l) := transform
self.source := 'AT';
...
// factory_conference
Business_Header.Layout_Business_Contact_Full Extract_factory_conference(BusData.Layout_factory_conference_in l) := transform
self.source := 'AT';
...
// ins_fraud_manage
Business_Header.Layout_Business_Contact_Full Extract_ins_fraud_manage(BusData.Layout_ins_fraud_manage_in l) := transform
self.source := 'AT';
...
Business_Header.Layout_Business_Contact_Full Extract_las_vegas_recruit_expo(BusData.Layout_las_vegas_recruit_expo_in l) := transform
self.source := 'AT';
...
export Accurint_Tradeshow_As_Business_Contact := tradeshow_init((INTEGER)name_score < 3,
              Business_Header.CheckPersonName(fname, mname, lname, name_suffix)) : persist('TEMP::Accurint_Tradeshow_As_BC') ;