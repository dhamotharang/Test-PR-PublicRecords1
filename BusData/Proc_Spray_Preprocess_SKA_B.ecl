...
layouts_ska.parse_ska_b t_CleanName_ska_b(CleanName_owner le) := TRANSFORM
    ...
    self.SPEC_EXPL                := le.SPEC_EXPL;
		self.DEPT_FILE                := decode_SpecDeptCode(le.SPEC);
    ...
    self.PHONE                    := le.PHONE[1..3]+le.PHONE[5..8];
    self.ID                       := le.ID;
...
address.mac_address_clean(la_raw_baddr_ska_b,ADDRESS, addr_line1,true,la_clean_baddr_ska_b); //: persist('~thor_data400::persist::ska_b_cleanaddr'); 
