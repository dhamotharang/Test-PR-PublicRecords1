...
Business_Header.Layout_Business_Header  Translate_SKA_Nixie_to_BHF(Layout_SKA_Nixie_BDID l) := transform
self.group1_id := 0;
self.company_name := Stringlib.StringToUpperCase(l.company_name);
...
ska_nixie_init := project(File_SKA_Nixie_Base, Translate_SKA_Nixie_to_BHF(left));
...
export SKA_As_Business_Header := ska_clean_rollup : persist('TEMP::SKA_As_Business_Header');