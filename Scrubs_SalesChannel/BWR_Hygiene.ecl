...
// First create an instantiated hygiene module
  ...
  h := Scrubs_SalesChannel.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_SalesChannel'),NAMED('OptimizedLayout'));// File layout suggested by data
