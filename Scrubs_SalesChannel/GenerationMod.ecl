...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:rawfields_company_name:TYPE(STRING50):LIKE(Invalid_AlphaNum):0,0\n'
    + 'FIELD:rawfields_web_address:TYPE(STRING80):LIKE(Invalid_AlphaNum):0,0\n'
    + 'FIELD:rawfields_prefix:TYPE(STRING8_):LIKE(Invalid_AlphaChars):0,0\n'
    + 'FIELD:rawfields_contact_name:TYPE(STRING60):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:rawfields_first_name:TYPE(STRING30):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:rawfields_middle_name:TYPE(STRING20):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:rawfields_last_name:TYPE(STRING30):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:rawfields_title:TYPE(STRING170):LIKE(Invalid_AlphaChars):0,0\n'
    + 'FIELD:rawfields_address:TYPE(STRING40):LIKE(Invalid_AlphaNum):0,0\n'
    + 'FIELD:rawfields_address1:TYPE(STRING20):LIKE(Invalid_AlphaNum):0,0\n'
    ...
    + 'FIELD:rawfields_email:TYPE(STRING50):LIKE(Invalid_AlphaNum):0,0\n'
    ...
    + 'FIELD:clean_address_prim_range:TYPE(STRING10):LIKE(Invalid_AlphaNum):0,0\n'
    + 'FIELD:clean_address_predir:TYPE(STRING2):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:clean_address_prim_name:TYPE(STRING28):LIKE(Invalid_AlphaNum):0,0\n'
