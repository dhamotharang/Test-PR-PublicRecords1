...
// -- Value Types
//////////////////////////////////////////////////////////////////////////////////////////////
File_in 				:= File_4010_Bankruptcy_In;
segment_code 		:= '4010';
dBase						:=	EBR.File_4010_Bankruptcy_Base;

//////////////////////////////////////////////////////////////////////////////////////////////
// -- Convert the Input File to Base format
//////////////////////////////////////////////////////////////////////////////////////////////
Layout_4010_Bankruptcy_Base Convert2Base(File_in l) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_4010_Bankruptcy_Base BlankBDIDBase(ebr.Layout_4010_Bankruptcy_Base l) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////
File_Combined_Grpd_Sort	:= SORT(File_Combined, FILE_NUMBER, -process_date_last_seen, Action_code, Document_number, local);
File_Combined_Grpd 			:= GROUP(File_Combined_Grpd_Sort,	FILE_NUMBER, Action_code, Document_number, LOCAL);

EBR.Layout_4010_Bankruptcy_Base SetRecordType(EBR.Layout_4010_Bankruptcy_Base l, EBR.Layout_4010_Bankruptcy_Base r) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_4010_Bankruptcy_Base RollupBase(ebr.Layout_4010_Bankruptcy_Base L, ebr.Layout_4010_Bankruptcy_Base R) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_4010_Bankruptcy_Base getBDID(File_sort l, File_Header_sort r) := 
transform
	self.DotID 					 	:= r.DotID;
...
ebr.Layout_4010_Bankruptcy_Base	tLayout_4010_Bankruptcy_Base(ebr.Layout_4010_Bankruptcy_Base	l) :=
transform
	self.process_date :=	(string)l.process_date_last_seen;
	self 							:=	l;
end;

projectBase  := project(File_Out,  tLayout_4010_Bankruptcy_Base(left));

addGlobalSID := mdr.macGetGlobalSID(projectBase,'EBR','','global_sid'); //DF-26349: Populate Global_SID Field

export BDID_4010_Bankruptcy := addGlobalSID
