...
// -- Value Types
//////////////////////////////////////////////////////////////////////////////////////////////
File_in 			:= 	ebr.File_2000_Trade_In;
segment_code	:= 	'2000';
dBase					:=	ebr.File_2000_Trade_Base;
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_2000_Trade_Base BlankBDIDBase(ebr.Layout_2000_Trade_Base l) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////
File_Combined_Grpd_Sort	:= SORT(File_Combined, FILE_NUMBER, business_category_code, payment_terms, -process_date_last_seen,  local);

File_Combined_Grpd			:= GROUP(File_Combined_Grpd_Sort,	FILE_NUMBER, business_category_code, payment_terms, local);

ebr.Layout_2000_Trade_Base SetRecordType(File_Combined_Grpd l, File_Combined_Grpd r) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_2000_Trade_Base RollupBase(ebr.Layout_2000_Trade_Base L, ebr.Layout_2000_Trade_Base R) := 
transform
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_2000_Trade_Base getBDID(File_sort l, File_Header_sort r) := 
transform
	self.DotID 					 	:= r.DotID;
...
projectBase  := project(File_Out, tLayout_2000_Trade_Base(left));
