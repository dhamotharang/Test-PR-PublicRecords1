...
// -- Value Types
//////////////////////////////////////////////////////////////////////////////////////////////
File_in 			:= File_4035_Attachment_Lien_In;
segment_code 		:= '4035';

//////////////////////////////////////////////////////////////////////////////////////////////
// -- Convert the Input File to Base format
//////////////////////////////////////////////////////////////////////////////////////////////
Layout_4035_Attachment_Lien_Base Convert2Base(File_in l) := 
transform
...
EBR.Layout_4035_Attachment_Lien_Base							tLayout_4035_Attachment_Lien_Base(						EBR.Layout_4035_Attachment_Lien_Base						l) :=
transform
	self.process_date := (string)l.process_date_last_seen;
	self := l;
end;

export BDID_4035_Attachment_Lien := project(BDID_Append,  tLayout_4035_Attachment_Lien_Base(left)) 
