...
// -- Value Types
//////////////////////////////////////////////////////////////////////////////////////////////
File_in 			:= File_4040_Bulk_Transfers_In;
segment_code 		:= '4040';

//////////////////////////////////////////////////////////////////////////////////////////////
// -- Convert the Input File to Base format
//////////////////////////////////////////////////////////////////////////////////////////////
Layout_4040_Bulk_Transfers_Base Convert2Base(File_in l) := 
transform
...
EBR.Layout_4040_Bulk_Transfers_Base							tLayout_4040_Bulk_Transfers_Base(						EBR.Layout_4040_Bulk_Transfers_Base						l) :=
transform
	self.process_date := (string)l.process_date_last_seen;
	self := l;
end;

export BDID_4040_Bulk_Transfers := project(BDID_Append, tLayout_4040_Bulk_Transfers_Base(left))
