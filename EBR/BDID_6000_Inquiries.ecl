...
// -- Value Types
//////////////////////////////////////////////////////////////////////////////////////////////
File_in 			:=	ebr.File_6000_Inquiries_In;
segment_code	:=	'6000';
dBase					:=	ebr.File_6000_Inquiries_Base;
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_6000_Inquiries_Base BlankBDIDBase(ebr.Layout_6000_Inquiries_Base l) := 
transform
...
SetCurrent 	:= join (File_Combined
											,latestPerFileNumber
											,left.FILE_NUMBER = right.FILE_NUMBER
											,transform(ebr.Layout_6000_Inquiries_Base,
...
//////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_6000_Inquiries_Base RollupBase(ebr.Layout_6000_Inquiries_Base L, ebr.Layout_6000_Inquiries_Base R) := 
transform
	...
	self.record_sid								:=  if (L.record_sid<>0, L.record_sid, R.record_sid);
	self.dt_effective_first				:= 	ut.EarliestDate(	L.dt_effective_first,R.dt_effective_first);
	self := L;
END;
...
//////////////////////////////////////////////////////////////////////////////////////////////
ebr.Layout_6000_Inquiries_Base getBDID(File_sort l, File_Header_sort r) := 
transform
	self.DotID 					 	:= r.DotID;
...
projectBase  := project(File_Out, tLayout_6000_Inquiries_Base(left));
