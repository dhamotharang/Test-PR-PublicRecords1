...
//////////////////////////////////////////////////////////////////////////////////////////////
Layout_5000_Bank_Details_Base Convert2Base(File_in l) := 
transform
...
export BDID_5000_Bank_Details := BDID_Append : persist(EBR_thor + 'TEMP::BDID_' + dataset_name + '_' + segment_code + '_' + decode_segments(segment_code));
