IMPORT dx_common, dx_EBR, BIPV2, Doxie, AutoStandardI, mdr;
...
EXPORT Key_5600_Demographic_Data_linkids := MODULE
  ...
  FUNCTION
    ...
    rolled := dx_common.Incrementals.mac_Rollup(fetched, dx_ebr.mod_delta_rid.key_5600_delta_rid); //Support for incremental updates
