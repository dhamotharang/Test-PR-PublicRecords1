IMPORT banko;
/*--SOAP--
<message name="AdditionalEventsBatchServiceFCRA">
...
/*--INFO--
Bankruptcy Additional Events FCRA batch query.
*/
...
EXPORT AdditionalEventsBatchServiceFCRA(useCannedRecs = 'FALSE') := MACRO
...
// banko.AdditionalEventsBatchServiceFCRA();	