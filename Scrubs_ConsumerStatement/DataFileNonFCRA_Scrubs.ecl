...
EXPORT DataFileNonFCRA_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(DataFileNonFCRA_Layout_ConsumerStatement)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(DataFileNonFCRA_Layout_ConsumerStatement)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(DataFileNonFCRA_Layout_ConsumerStatement) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.statement_id_Invalid := DataFileNonFCRA_Fields.InValid_statement_id((SALT38.StrType)le.statement_id);
    SELF.orig_fname_Invalid := DataFileNonFCRA_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname);
    SELF.orig_lname_Invalid := DataFileNonFCRA_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname);
    SELF.orig_mname_Invalid := DataFileNonFCRA_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname);
    SELF.orig_cname_Invalid := DataFileNonFCRA_Fields.InValid_orig_cname((SALT38.StrType)le.orig_cname);
    SELF.orig_st_Invalid := DataFileNonFCRA_Fields.InValid_orig_st((SALT38.StrType)le.orig_st);
    SELF.orig_zip_Invalid := DataFileNonFCRA_Fields.InValid_orig_zip((SALT38.StrType)le.orig_zip);
    SELF.orig_zip4_Invalid := DataFileNonFCRA_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4);
    SELF.phone_Invalid := DataFileNonFCRA_Fields.InValid_phone((SALT38.StrType)le.phone);
    SELF.fname_Invalid := DataFileNonFCRA_Fields.InValid_fname((SALT38.StrType)le.fname);
    SELF.mname_Invalid := DataFileNonFCRA_Fields.InValid_mname((SALT38.StrType)le.mname);
    SELF.lname_Invalid := DataFileNonFCRA_Fields.InValid_lname((SALT38.StrType)le.lname);
    SELF.st_Invalid := DataFileNonFCRA_Fields.InValid_st((SALT38.StrType)le.st);
    SELF.zip_Invalid := DataFileNonFCRA_Fields.InValid_zip((SALT38.StrType)le.zip);
    SELF.zip4_Invalid := DataFileNonFCRA_Fields.InValid_zip4((SALT38.StrType)le.zip4);
    SELF.date_submitted_Invalid := DataFileNonFCRA_Fields.InValid_date_submitted((SALT38.StrType)le.date_submitted);
    SELF.date_created_Invalid := DataFileNonFCRA_Fields.InValid_date_created((SALT38.StrType)le.date_created);
    SELF.did_Invalid := DataFileNonFCRA_Fields.InValid_did((SALT38.StrType)le.did);
    SELF.override_flag_Invalid := DataFileNonFCRA_Fields.InValid_override_flag((SALT38.StrType)le.override_flag);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),DataFileNonFCRA_Layout_ConsumerStatement);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,DataFileNonFCRA_Layout_ConsumerStatement);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,DataFileNonFCRA_Fields.InvalidMessage_statement_id(le.statement_id_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_fname(le.orig_fname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_lname(le.orig_lname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_mname(le.orig_mname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_cname(le.orig_cname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_st(le.orig_st_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_zip(le.orig_zip_Invalid),DataFileNonFCRA_Fields.InvalidMessage_orig_zip4(le.orig_zip4_Invalid),DataFileNonFCRA_Fields.InvalidMessage_phone(le.phone_Invalid),DataFileNonFCRA_Fields.InvalidMessage_fname(le.fname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_mname(le.mname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_lname(le.lname_Invalid),DataFileNonFCRA_Fields.InvalidMessage_st(le.st_Invalid),DataFileNonFCRA_Fields.InvalidMessage_zip(le.zip_Invalid),DataFileNonFCRA_Fields.InvalidMessage_zip4(le.zip4_Invalid),DataFileNonFCRA_Fields.InvalidMessage_date_submitted(le.date_submitted_Invalid),DataFileNonFCRA_Fields.InvalidMessage_date_created(le.date_created_Invalid),DataFileNonFCRA_Fields.InvalidMessage_did(le.did_Invalid),DataFileNonFCRA_Fields.InvalidMessage_override_flag(le.override_flag_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(DataFileNonFCRA_Layout_ConsumerStatement) prevDS = DATASET([], DataFileNonFCRA_Layout_ConsumerStatement), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT38.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,DataFileNonFCRA_Fields.InvalidMessage_statement_id(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_fname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_lname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_mname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_cname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_st(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_zip(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_orig_zip4(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_phone(1),DataFileNonFCRA_Fields.InvalidMessage_phone(2)
          ,DataFileNonFCRA_Fields.InvalidMessage_fname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_mname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_lname(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_st(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_zip(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_zip4(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_date_submitted(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_date_created(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_did(1)
          ,DataFileNonFCRA_Fields.InvalidMessage_override_flag(1)
          ,'Fields with errors'
    ...
    mod_hygiene := DataFileNonFCRA_hygiene(PROJECT(h, DataFileNonFCRA_Layout_ConsumerStatement));
  ...
  // record count stats
    ...
    mod_Delta := DataFileNonFCRA_Delta(prevDS, PROJECT(h, DataFileNonFCRA_Layout_ConsumerStatement));
...
EXPORT StandardStats(DATASET(DataFileNonFCRA_Layout_ConsumerStatement) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT38.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_ConsumerStatement, DataFileNonFCRA_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
