IMPORT SALT38,STD;
EXPORT RawFileNonFCRA_hygiene(dataset(RawFileNonFCRA_layout_ConsumerStatement) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    RawFileNonFCRA_Fields.InValid_statement_id((SALT38.StrType)le.statement_id),
    RawFileNonFCRA_Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname),
    RawFileNonFCRA_Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname),
    RawFileNonFCRA_Fields.InValid_orig_mname((SALT38.StrType)le.orig_mname),
    RawFileNonFCRA_Fields.InValid_orig_cname((SALT38.StrType)le.orig_cname),
    RawFileNonFCRA_Fields.InValid_orig_address((SALT38.StrType)le.orig_address),
    RawFileNonFCRA_Fields.InValid_orig_city((SALT38.StrType)le.orig_city),
    RawFileNonFCRA_Fields.InValid_orig_st((SALT38.StrType)le.orig_st),
    RawFileNonFCRA_Fields.InValid_orig_zip((SALT38.StrType)le.orig_zip),
    RawFileNonFCRA_Fields.InValid_orig_zip4((SALT38.StrType)le.orig_zip4),
    RawFileNonFCRA_Fields.InValid_phone((SALT38.StrType)le.phone),
    RawFileNonFCRA_Fields.InValid_title((SALT38.StrType)le.title),
    RawFileNonFCRA_Fields.InValid_fname((SALT38.StrType)le.fname),
    RawFileNonFCRA_Fields.InValid_mname((SALT38.StrType)le.mname),
    RawFileNonFCRA_Fields.InValid_lname((SALT38.StrType)le.lname),
    RawFileNonFCRA_Fields.InValid_name_suffix((SALT38.StrType)le.name_suffix),
    RawFileNonFCRA_Fields.InValid_name_score((SALT38.StrType)le.name_score),
    RawFileNonFCRA_Fields.InValid_prim_range((SALT38.StrType)le.prim_range),
    RawFileNonFCRA_Fields.InValid_predir((SALT38.StrType)le.predir),
    RawFileNonFCRA_Fields.InValid_prim_name((SALT38.StrType)le.prim_name),
    RawFileNonFCRA_Fields.InValid_addr_suffix((SALT38.StrType)le.addr_suffix),
    RawFileNonFCRA_Fields.InValid_postdir((SALT38.StrType)le.postdir),
    RawFileNonFCRA_Fields.InValid_unit_desig((SALT38.StrType)le.unit_desig),
    RawFileNonFCRA_Fields.InValid_sec_range((SALT38.StrType)le.sec_range),
    RawFileNonFCRA_Fields.InValid_p_city_name((SALT38.StrType)le.p_city_name),
    RawFileNonFCRA_Fields.InValid_v_city_name((SALT38.StrType)le.v_city_name),
    RawFileNonFCRA_Fields.InValid_st((SALT38.StrType)le.st),
    RawFileNonFCRA_Fields.InValid_zip((SALT38.StrType)le.zip),
    RawFileNonFCRA_Fields.InValid_zip4((SALT38.StrType)le.zip4),
    RawFileNonFCRA_Fields.InValid_cart((SALT38.StrType)le.cart),
    RawFileNonFCRA_Fields.InValid_cr_sort_sz((SALT38.StrType)le.cr_sort_sz),
    RawFileNonFCRA_Fields.InValid_lot((SALT38.StrType)le.lot),
    RawFileNonFCRA_Fields.InValid_lot_order((SALT38.StrType)le.lot_order),
    RawFileNonFCRA_Fields.InValid_dbpc((SALT38.StrType)le.dbpc),
    RawFileNonFCRA_Fields.InValid_chk_digit((SALT38.StrType)le.chk_digit),
    RawFileNonFCRA_Fields.InValid_rec_type((SALT38.StrType)le.rec_type),
    RawFileNonFCRA_Fields.InValid_county((SALT38.StrType)le.county),
    RawFileNonFCRA_Fields.InValid_geo_lat((SALT38.StrType)le.geo_lat),
    RawFileNonFCRA_Fields.InValid_geo_long((SALT38.StrType)le.geo_long),
    RawFileNonFCRA_Fields.InValid_msa((SALT38.StrType)le.msa),
    RawFileNonFCRA_Fields.InValid_geo_blk((SALT38.StrType)le.geo_blk),
    RawFileNonFCRA_Fields.InValid_geo_match((SALT38.StrType)le.geo_match),
    RawFileNonFCRA_Fields.InValid_err_stat((SALT38.StrType)le.err_stat),
    RawFileNonFCRA_Fields.InValid_date_submitted((SALT38.StrType)le.date_submitted),
    RawFileNonFCRA_Fields.InValid_date_created((SALT38.StrType)le.date_created),
    RawFileNonFCRA_Fields.InValid_did((SALT38.StrType)le.did),
    RawFileNonFCRA_Fields.InValid_consumer_text((SALT38.StrType)le.consumer_text),
    RawFileNonFCRA_Fields.InValid_override_flag((SALT38.StrType)le.override_flag),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := RawFileNonFCRA_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,RawFileNonFCRA_Fields.InValidMessage_statement_id(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_fname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_lname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_mname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_cname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_address(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_city(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_st(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_zip(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_orig_zip4(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_phone(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_title(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_fname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_mname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_lname(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_name_score(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_predir(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_addr_suffix(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_st(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_zip(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_cart(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_lot(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_dbpc(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_county(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_msa(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_date_submitted(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_date_created(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_did(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_consumer_text(TotalErrors.ErrorNum),RawFileNonFCRA_Fields.InValidMessage_override_flag(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_ConsumerStatement, RawFileNonFCRA_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
