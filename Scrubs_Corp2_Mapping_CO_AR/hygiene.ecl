...
EXPORT Summary(SALT30.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_ar_exempt := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_exempt)));
    avelength_ar_exempt := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_exempt)),h.ar_exempt<>(typeof(h.ar_exempt))'');
    populated_ar_license_tax_amount_pcnt := AVE(GROUP,IF(h.ar_license_tax_amount = (TYPEOF(h.ar_license_tax_amount))'',0,100));
    maxlength_ar_license_tax_amount := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_license_tax_amount)));
    avelength_ar_license_tax_amount := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_license_tax_amount)),h.ar_license_tax_amount<>(typeof(h.ar_license_tax_amount))'');
    populated_ar_status_pcnt := AVE(GROUP,IF(h.ar_status = (TYPEOF(h.ar_status))'',0,100));
    maxlength_ar_status := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_status)));
    avelength_ar_status := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_status)),h.ar_status<>(typeof(h.ar_status))'');
    populated_ar_paid_date_pcnt := AVE(GROUP,IF(h.ar_paid_date = (TYPEOF(h.ar_paid_date))'',0,100));
    maxlength_ar_paid_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_paid_date)));
    avelength_ar_paid_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_paid_date)),h.ar_paid_date<>(typeof(h.ar_paid_date))'');
    populated_ar_prev_paid_date_pcnt := AVE(GROUP,IF(h.ar_prev_paid_date = (TYPEOF(h.ar_prev_paid_date))'',0,100));
    maxlength_ar_prev_paid_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_prev_paid_date)));
    avelength_ar_prev_paid_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_prev_paid_date)),h.ar_prev_paid_date<>(typeof(h.ar_prev_paid_date))'');
    populated_ar_prev_tax_factor_pcnt := AVE(GROUP,IF(h.ar_prev_tax_factor = (TYPEOF(h.ar_prev_tax_factor))'',0,100));
    maxlength_ar_prev_tax_factor := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_prev_tax_factor)));
    avelength_ar_prev_tax_factor := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_prev_tax_factor)),h.ar_prev_tax_factor<>(typeof(h.ar_prev_tax_factor))'');
    populated_ar_extension_date_pcnt := AVE(GROUP,IF(h.ar_extension_date = (TYPEOF(h.ar_extension_date))'',0,100));
    maxlength_ar_extension_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_extension_date)));
    avelength_ar_extension_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_extension_date)),h.ar_extension_date<>(typeof(h.ar_extension_date))'');
    populated_ar_report_mail_date_pcnt := AVE(GROUP,IF(h.ar_report_mail_date = (TYPEOF(h.ar_report_mail_date))'',0,100));
    maxlength_ar_report_mail_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_report_mail_date)));
    avelength_ar_report_mail_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_report_mail_date)),h.ar_report_mail_date<>(typeof(h.ar_report_mail_date))'');
    ...
    maxlength_ar_deliquent_report_mail_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_deliquent_report_mail_date)));
    avelength_ar_deliquent_report_mail_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_deliquent_report_mail_date)),h.ar_deliquent_report_mail_date<>(typeof(h.ar_deliquent_report_mail_date))'');
    populated_ar_report_filed_date_pcnt := AVE(GROUP,IF(h.ar_report_filed_date = (TYPEOF(h.ar_report_filed_date))'',0,100));
    maxlength_ar_report_filed_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_report_filed_date)));
    avelength_ar_report_filed_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_report_filed_date)),h.ar_report_filed_date<>(typeof(h.ar_report_filed_date))'');
    populated_ar_year_and_month_due_pcnt := AVE(GROUP,IF(h.ar_year_and_month_due = (TYPEOF(h.ar_year_and_month_due))'',0,100));
    maxlength_ar_year_and_month_due := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_year_and_month_due)));
    avelength_ar_year_and_month_due := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ar_year_and_month_due)),h.ar_year_and_month_due<>(typeof(h.ar_year_and_month_due))'');
  END;
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.ar_year),TRIM((SALT30.StrType)le.ar_mailed_dt),TRIM((SALT30.StrType)le.ar_due_dt),TRIM((SALT30.StrType)le.ar_filed_dt),TRIM((SALT30.StrType)le.ar_report_dt),TRIM((SALT30.StrType)le.ar_report_nbr),TRIM((SALT30.StrType)le.ar_franchise_tax_paid_dt),TRIM((SALT30.StrType)le.ar_delinquent_dt),TRIM((SALT30.StrType)le.ar_tax_factor),TRIM((SALT30.StrType)le.ar_tax_amount_paid),TRIM((SALT30.StrType)le.ar_annual_report_cap),TRIM((SALT30.StrType)le.ar_illinois_capital),TRIM((SALT30.StrType)le.ar_roll),TRIM((SALT30.StrType)le.ar_frame),TRIM((SALT30.StrType)le.ar_extension),TRIM((SALT30.StrType)le.ar_microfilm_nbr),TRIM((SALT30.StrType)le.ar_comment),TRIM((SALT30.StrType)le.ar_type),TRIM((SALT30.StrType)le.ar_exempt),TRIM((SALT30.StrType)le.ar_license_tax_amount),TRIM((SALT30.StrType)le.ar_status),TRIM((SALT30.StrType)le.ar_paid_date),TRIM((SALT30.StrType)le.ar_prev_paid_date),TRIM((SALT30.StrType)le.ar_prev_tax_factor),TRIM((SALT30.StrType)le.ar_extension_date),TRIM((SALT30.StrType)le.ar_report_mail_date),TRIM((SALT30.StrType)le.ar_deliquent_report_mail_date),TRIM((SALT30.StrType)le.ar_report_filed_date),TRIM((SALT30.StrType)le.ar_year_and_month_due)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{36,'ar_year_and_month_due'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_ar_exempt((SALT30.StrType)le.ar_exempt),
    Fields.InValid_ar_license_tax_amount((SALT30.StrType)le.ar_license_tax_amount),
    Fields.InValid_ar_status((SALT30.StrType)le.ar_status),
    Fields.InValid_ar_paid_date((SALT30.StrType)le.ar_paid_date),
    Fields.InValid_ar_prev_paid_date((SALT30.StrType)le.ar_prev_paid_date),
    Fields.InValid_ar_prev_tax_factor((SALT30.StrType)le.ar_prev_tax_factor),
    Fields.InValid_ar_extension_date((SALT30.StrType)le.ar_extension_date),
    Fields.InValid_ar_report_mail_date((SALT30.StrType)le.ar_report_mail_date),
    Fields.InValid_ar_deliquent_report_mail_date((SALT30.StrType)le.ar_deliquent_report_mail_date),
    Fields.InValid_ar_report_filed_date((SALT30.StrType)le.ar_report_filed_date),
    Fields.InValid_ar_year_and_month_due((SALT30.StrType)le.ar_year_and_month_due),
    0);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_corp_key','invalid_corp_vendor','Unknown','Unknown','invalid_state_origin','invalid_date','invalid_charter_nbr','Unknown','Unknown','Unknown','invalid_date','Unknown','invalid_numeric','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
