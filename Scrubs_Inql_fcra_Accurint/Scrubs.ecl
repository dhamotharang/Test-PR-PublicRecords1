...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 236;
  EXPORT NumRulesFromFieldType := 236;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 68;
  EXPORT NumFieldsWithPossibleEdits := 68;
  EXPORT NumRulesWithPossibleEdits := 236;
  EXPORT Expanded_Layout := RECORD(Layout_FILE)
    ...
    UNSIGNED1 inquiry_type_Invalid;
    BOOLEAN inquiry_type_wouldClean;
    UNSIGNED1 lex_id_Invalid;
    BOOLEAN lex_id_wouldClean;
    UNSIGNED1 reprice_batch_number_Invalid;
    BOOLEAN reprice_batch_number_wouldClean;
    ...
    UNSIGNED1 fcra_purpose_Invalid;
    BOOLEAN fcra_purpose_wouldClean;
    ...
    UNSIGNED1 orig_jobid_Invalid;
    BOOLEAN orig_jobid_wouldClean;
    UNSIGNED1 orig_acctno_Invalid;
    BOOLEAN orig_acctno_wouldClean;
...
EXPORT FromNone(DATASET(Layout_FILE) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.inquiry_type_Invalid := Fields.InValid_inquiry_type((SALT39.StrType)le.inquiry_type);
    clean_inquiry_type := (TYPEOF(le.inquiry_type))Fields.Make_inquiry_type((SALT39.StrType)le.inquiry_type);
    clean_inquiry_type_Invalid := Fields.InValid_inquiry_type((SALT39.StrType)clean_inquiry_type);
    SELF.inquiry_type := IF(withOnfail, clean_inquiry_type, le.inquiry_type); // ONFAIL(CLEAN)
    SELF.inquiry_type_wouldClean := TRIM((SALT39.StrType)le.inquiry_type) <> TRIM((SALT39.StrType)clean_inquiry_type);
    SELF.lex_id_Invalid := Fields.InValid_lex_id((SALT39.StrType)le.lex_id);
    clean_lex_id := (TYPEOF(le.lex_id))Fields.Make_lex_id((SALT39.StrType)le.lex_id);
    clean_lex_id_Invalid := Fields.InValid_lex_id((SALT39.StrType)clean_lex_id);
    SELF.lex_id := IF(withOnfail, clean_lex_id, le.lex_id); // ONFAIL(CLEAN)
    SELF.lex_id_wouldClean := TRIM((SALT39.StrType)le.lex_id) <> TRIM((SALT39.StrType)clean_lex_id);
    SELF.reprice_batch_number_Invalid := Fields.InValid_reprice_batch_number((SALT39.StrType)le.reprice_batch_number);
    clean_reprice_batch_number := (TYPEOF(le.reprice_batch_number))Fields.Make_reprice_batch_number((SALT39.StrType)le.reprice_batch_number);
    clean_reprice_batch_number_Invalid := Fields.InValid_reprice_batch_number((SALT39.StrType)clean_reprice_batch_number);
    SELF.reprice_batch_number := IF(withOnfail, clean_reprice_batch_number, le.reprice_batch_number); // ONFAIL(CLEAN)
    SELF.reprice_batch_number_wouldClean := TRIM((SALT39.StrType)le.reprice_batch_number) <> TRIM((SALT39.StrType)clean_reprice_batch_number);
    SELF.user_changed_Invalid := Fields.InValid_user_changed((SALT39.StrType)le.user_changed);
    clean_user_changed := (TYPEOF(le.user_changed))Fields.Make_user_changed((SALT39.StrType)le.user_changed);
    clean_user_changed_Invalid := Fields.InValid_user_changed((SALT39.StrType)clean_user_changed);
    SELF.user_changed := IF(withOnfail, clean_user_changed, le.user_changed); // ONFAIL(CLEAN)
    SELF.user_changed_wouldClean := TRIM((SALT39.StrType)le.user_changed) <> TRIM((SALT39.StrType)clean_user_changed);
    SELF.date_changed_Invalid := Fields.InValid_date_changed((SALT39.StrType)le.date_changed);
    clean_date_changed := (TYPEOF(le.date_changed))Fields.Make_date_changed((SALT39.StrType)le.date_changed);
    clean_date_changed_Invalid := Fields.InValid_date_changed((SALT39.StrType)clean_date_changed);
    SELF.date_changed := IF(withOnfail, clean_date_changed, le.date_changed); // ONFAIL(CLEAN)
    SELF.date_changed_wouldClean := TRIM((SALT39.StrType)le.date_changed) <> TRIM((SALT39.StrType)clean_date_changed);
    SELF.fcra_purpose_Invalid := Fields.InValid_fcra_purpose((SALT39.StrType)le.fcra_purpose);
    clean_fcra_purpose := (TYPEOF(le.fcra_purpose))Fields.Make_fcra_purpose((SALT39.StrType)le.fcra_purpose);
    clean_fcra_purpose_Invalid := Fields.InValid_fcra_purpose((SALT39.StrType)clean_fcra_purpose);
    SELF.fcra_purpose := IF(withOnfail, clean_fcra_purpose, le.fcra_purpose); // ONFAIL(CLEAN)
    SELF.fcra_purpose_wouldClean := TRIM((SALT39.StrType)le.fcra_purpose) <> TRIM((SALT39.StrType)clean_fcra_purpose);
    ...
    SELF.orig_jobid_Invalid := Fields.InValid_orig_jobid((SALT39.StrType)le.orig_jobid);
    clean_orig_jobid := (TYPEOF(le.orig_jobid))Fields.Make_orig_jobid((SALT39.StrType)le.orig_jobid);
    clean_orig_jobid_Invalid := Fields.InValid_orig_jobid((SALT39.StrType)clean_orig_jobid);
    SELF.orig_jobid := IF(withOnfail, clean_orig_jobid, le.orig_jobid); // ONFAIL(CLEAN)
    SELF.orig_jobid_wouldClean := TRIM((SALT39.StrType)le.orig_jobid) <> TRIM((SALT39.StrType)clean_orig_jobid);
    SELF.orig_acctno_Invalid := Fields.InValid_orig_acctno((SALT39.StrType)le.orig_acctno);
    clean_orig_acctno := (TYPEOF(le.orig_acctno))Fields.Make_orig_acctno((SALT39.StrType)le.orig_acctno);
    clean_orig_acctno_Invalid := Fields.InValid_orig_acctno((SALT39.StrType)clean_orig_acctno);
    SELF.orig_acctno := IF(withOnfail, clean_orig_acctno, le.orig_acctno); // ONFAIL(CLEAN)
    SELF.orig_acctno_wouldClean := TRIM((SALT39.StrType)le.orig_acctno) <> TRIM((SALT39.StrType)clean_orig_acctno);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.orig_end_user_id_Invalid << 0 ) + ( le.orig_loginid_Invalid << 3 ) + ( le.orig_billing_code_Invalid << 5 ) + ( le.orig_transaction_id_Invalid << 7 ) + ( le.orig_transaction_type_Invalid << 9 ) + ( le.orig_neighbors_Invalid << 12 ) + ( le.orig_relatives_Invalid << 15 ) + ( le.orig_associates_Invalid << 18 ) + ( le.orig_property_Invalid << 21 ) + ( le.orig_company_id_Invalid << 24 ) + ( le.orig_reference_code_Invalid << 26 ) + ( le.orig_fname_Invalid << 27 ) + ( le.orig_mname_Invalid << 29 ) + ( le.orig_lname_Invalid << 31 ) + ( le.orig_address_Invalid << 33 ) + ( le.orig_city_Invalid << 34 ) + ( le.orig_state_Invalid << 36 ) + ( le.orig_zip_Invalid << 39 ) + ( le.orig_zip4_Invalid << 42 ) + ( le.orig_phone_Invalid << 45 ) + ( le.orig_ssn_Invalid << 48 ) + ( le.orig_free_Invalid << 51 ) + ( le.orig_record_count_Invalid << 54 ) + ( le.orig_price_Invalid << 57 ) + ( le.orig_bankruptcy_Invalid << 59 );
    SELF.ScrubsBits2 := ( le.orig_transaction_code_Invalid << 0 ) + ( le.orig_dateadded_Invalid << 3 ) + ( le.orig_full_name_Invalid << 6 ) + ( le.orig_billingdate_Invalid << 9 ) + ( le.orig_business_name_Invalid << 12 ) + ( le.orig_pricing_error_code_Invalid << 15 ) + ( le.orig_dl_purpose_Invalid << 18 ) + ( le.orig_result_format_Invalid << 21 ) + ( le.orig_dob_Invalid << 24 ) + ( le.orig_unique_id_Invalid << 27 ) + ( le.orig_dls_Invalid << 29 ) + ( le.orig_mvs_Invalid << 32 ) + ( le.orig_function_name_Invalid << 35 ) + ( le.orig_response_time_Invalid << 37 ) + ( le.orig_data_source_Invalid << 39 ) + ( le.orig_glb_purpose_Invalid << 42 ) + ( le.orig_report_options_Invalid << 45 ) + ( le.orig_unused_Invalid << 47 ) + ( le.orig_login_history_id_Invalid << 50 ) + ( le.orig_aseid_Invalid << 53 ) + ( le.orig_years_Invalid << 56 ) + ( le.orig_ip_address_Invalid << 59 ) + ( le.orig_source_code_Invalid << 61 );
    SELF.ScrubsBits3 := ( le.orig_retail_price_Invalid << 0 ) + ( le.inquiry_type_Invalid << 2 ) + ( le.lex_id_Invalid << 5 ) + ( le.reprice_batch_number_Invalid << 8 ) + ( le.user_changed_Invalid << 11 ) + ( le.date_changed_Invalid << 14 ) + ( le.fcra_purpose_Invalid << 17 ) + ( le.orig_address_2_Invalid << 20 ) + ( le.orig_city_2_Invalid << 23 ) + ( le.orig_state_2_Invalid << 26 ) + ( le.orig_zip_2_Invalid << 29 ) + ( le.orig_zip4_2_Invalid << 32 ) + ( le.orig_jobid_Invalid << 35 ) + ( le.orig_acctno_Invalid << 38 ) + ( le.orig_end_user_name_Invalid << 40 ) + ( le.orig_end_user_address_1_Invalid << 42 ) + ( le.orig_end_user_address_2_Invalid << 43 ) + ( le.orig_end_user_city_Invalid << 46 ) + ( le.orig_end_user_state_Invalid << 48 ) + ( le.orig_end_user_zip_Invalid << 51 );
    SELF.ScrubsCleanBits1 := ( IF(le.orig_end_user_id_wouldClean, 1, 0) << 0 ) + ( IF(le.orig_loginid_wouldClean, 1, 0) << 1 ) + ( IF(le.orig_billing_code_wouldClean, 1, 0) << 2 ) + ( IF(le.orig_transaction_id_wouldClean, 1, 0) << 3 ) + ( IF(le.orig_transaction_type_wouldClean, 1, 0) << 4 ) + ( IF(le.orig_neighbors_wouldClean, 1, 0) << 5 ) + ( IF(le.orig_relatives_wouldClean, 1, 0) << 6 ) + ( IF(le.orig_associates_wouldClean, 1, 0) << 7 ) + ( IF(le.orig_property_wouldClean, 1, 0) << 8 ) + ( IF(le.orig_company_id_wouldClean, 1, 0) << 9 ) + ( IF(le.orig_reference_code_wouldClean, 1, 0) << 10 ) + ( IF(le.orig_fname_wouldClean, 1, 0) << 11 ) + ( IF(le.orig_mname_wouldClean, 1, 0) << 12 ) + ( IF(le.orig_lname_wouldClean, 1, 0) << 13 ) + ( IF(le.orig_address_wouldClean, 1, 0) << 14 ) + ( IF(le.orig_city_wouldClean, 1, 0) << 15 ) + ( IF(le.orig_state_wouldClean, 1, 0) << 16 ) + ( IF(le.orig_zip_wouldClean, 1, 0) << 17 ) + ( IF(le.orig_zip4_wouldClean, 1, 0) << 18 ) + ( IF(le.orig_phone_wouldClean, 1, 0) << 19 ) + ( IF(le.orig_ssn_wouldClean, 1, 0) << 20 ) + ( IF(le.orig_free_wouldClean, 1, 0) << 21 ) + ( IF(le.orig_record_count_wouldClean, 1, 0) << 22 ) + ( IF(le.orig_price_wouldClean, 1, 0) << 23 ) + ( IF(le.orig_bankruptcy_wouldClean, 1, 0) << 24 ) + ( IF(le.orig_transaction_code_wouldClean, 1, 0) << 25 ) + ( IF(le.orig_dateadded_wouldClean, 1, 0) << 26 ) + ( IF(le.orig_full_name_wouldClean, 1, 0) << 27 ) + ( IF(le.orig_billingdate_wouldClean, 1, 0) << 28 ) + ( IF(le.orig_business_name_wouldClean, 1, 0) << 29 ) + ( IF(le.orig_pricing_error_code_wouldClean, 1, 0) << 30 ) + ( IF(le.orig_dl_purpose_wouldClean, 1, 0) << 31 ) + ( IF(le.orig_result_format_wouldClean, 1, 0) << 32 ) + ( IF(le.orig_dob_wouldClean, 1, 0) << 33 ) + ( IF(le.orig_unique_id_wouldClean, 1, 0) << 34 ) + ( IF(le.orig_dls_wouldClean, 1, 0) << 35 ) + ( IF(le.orig_mvs_wouldClean, 1, 0) << 36 ) + ( IF(le.orig_function_name_wouldClean, 1, 0) << 37 ) + ( IF(le.orig_response_time_wouldClean, 1, 0) << 38 ) + ( IF(le.orig_data_source_wouldClean, 1, 0) << 39 ) + ( IF(le.orig_glb_purpose_wouldClean, 1, 0) << 40 ) + ( IF(le.orig_report_options_wouldClean, 1, 0) << 41 ) + ( IF(le.orig_unused_wouldClean, 1, 0) << 42 ) + ( IF(le.orig_login_history_id_wouldClean, 1, 0) << 43 ) + ( IF(le.orig_aseid_wouldClean, 1, 0) << 44 ) + ( IF(le.orig_years_wouldClean, 1, 0) << 45 ) + ( IF(le.orig_ip_address_wouldClean, 1, 0) << 46 ) + ( IF(le.orig_source_code_wouldClean, 1, 0) << 47 ) + ( IF(le.orig_retail_price_wouldClean, 1, 0) << 48 ) + ( IF(le.inquiry_type_wouldClean, 1, 0) << 49 ) + ( IF(le.lex_id_wouldClean, 1, 0) << 50 ) + ( IF(le.reprice_batch_number_wouldClean, 1, 0) << 51 ) + ( IF(le.user_changed_wouldClean, 1, 0) << 52 ) + ( IF(le.date_changed_wouldClean, 1, 0) << 53 ) + ( IF(le.fcra_purpose_wouldClean, 1, 0) << 54 ) + ( IF(le.orig_address_2_wouldClean, 1, 0) << 55 ) + ( IF(le.orig_city_2_wouldClean, 1, 0) << 56 ) + ( IF(le.orig_state_2_wouldClean, 1, 0) << 57 ) + ( IF(le.orig_zip_2_wouldClean, 1, 0) << 58 ) + ( IF(le.orig_zip4_2_wouldClean, 1, 0) << 59 ) + ( IF(le.orig_jobid_wouldClean, 1, 0) << 60 ) + ( IF(le.orig_acctno_wouldClean, 1, 0) << 61 ) + ( IF(le.orig_end_user_name_wouldClean, 1, 0) << 62 ) + ( IF(le.orig_end_user_address_1_wouldClean, 1, 0) << 63 );
    SELF.ScrubsCleanBits2 := ( IF(le.orig_end_user_address_2_wouldClean, 1, 0) << 0 ) + ( IF(le.orig_end_user_city_wouldClean, 1, 0) << 1 ) + ( IF(le.orig_end_user_state_wouldClean, 1, 0) << 2 ) + ( IF(le.orig_end_user_zip_wouldClean, 1, 0) << 3 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    SELF.orig_end_user_id_Invalid := (le.ScrubsBits1 >> 0) & 7;
    SELF.orig_loginid_Invalid := (le.ScrubsBits1 >> 3) & 3;
    SELF.orig_billing_code_Invalid := (le.ScrubsBits1 >> 5) & 3;
    SELF.orig_transaction_id_Invalid := (le.ScrubsBits1 >> 7) & 3;
    SELF.orig_transaction_type_Invalid := (le.ScrubsBits1 >> 9) & 7;
    SELF.orig_neighbors_Invalid := (le.ScrubsBits1 >> 12) & 7;
    SELF.orig_relatives_Invalid := (le.ScrubsBits1 >> 15) & 7;
    SELF.orig_associates_Invalid := (le.ScrubsBits1 >> 18) & 7;
    SELF.orig_property_Invalid := (le.ScrubsBits1 >> 21) & 7;
    SELF.orig_company_id_Invalid := (le.ScrubsBits1 >> 24) & 3;
    SELF.orig_reference_code_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.orig_fname_Invalid := (le.ScrubsBits1 >> 27) & 3;
    SELF.orig_mname_Invalid := (le.ScrubsBits1 >> 29) & 3;
    SELF.orig_lname_Invalid := (le.ScrubsBits1 >> 31) & 3;
    SELF.orig_address_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.orig_city_Invalid := (le.ScrubsBits1 >> 34) & 3;
    SELF.orig_state_Invalid := (le.ScrubsBits1 >> 36) & 7;
    SELF.orig_zip_Invalid := (le.ScrubsBits1 >> 39) & 7;
    SELF.orig_zip4_Invalid := (le.ScrubsBits1 >> 42) & 7;
    SELF.orig_phone_Invalid := (le.ScrubsBits1 >> 45) & 7;
    SELF.orig_ssn_Invalid := (le.ScrubsBits1 >> 48) & 7;
    SELF.orig_free_Invalid := (le.ScrubsBits1 >> 51) & 7;
    SELF.orig_record_count_Invalid := (le.ScrubsBits1 >> 54) & 7;
    SELF.orig_price_Invalid := (le.ScrubsBits1 >> 57) & 3;
    SELF.orig_bankruptcy_Invalid := (le.ScrubsBits1 >> 59) & 7;
    SELF.orig_transaction_code_Invalid := (le.ScrubsBits2 >> 0) & 7;
    SELF.orig_dateadded_Invalid := (le.ScrubsBits2 >> 3) & 7;
    SELF.orig_full_name_Invalid := (le.ScrubsBits2 >> 6) & 7;
    SELF.orig_billingdate_Invalid := (le.ScrubsBits2 >> 9) & 7;
    SELF.orig_business_name_Invalid := (le.ScrubsBits2 >> 12) & 7;
    SELF.orig_pricing_error_code_Invalid := (le.ScrubsBits2 >> 15) & 7;
    SELF.orig_dl_purpose_Invalid := (le.ScrubsBits2 >> 18) & 7;
    SELF.orig_result_format_Invalid := (le.ScrubsBits2 >> 21) & 7;
    SELF.orig_dob_Invalid := (le.ScrubsBits2 >> 24) & 7;
    SELF.orig_unique_id_Invalid := (le.ScrubsBits2 >> 27) & 3;
    SELF.orig_dls_Invalid := (le.ScrubsBits2 >> 29) & 7;
    SELF.orig_mvs_Invalid := (le.ScrubsBits2 >> 32) & 7;
    SELF.orig_function_name_Invalid := (le.ScrubsBits2 >> 35) & 3;
    SELF.orig_response_time_Invalid := (le.ScrubsBits2 >> 37) & 3;
    SELF.orig_data_source_Invalid := (le.ScrubsBits2 >> 39) & 7;
    SELF.orig_glb_purpose_Invalid := (le.ScrubsBits2 >> 42) & 7;
    SELF.orig_report_options_Invalid := (le.ScrubsBits2 >> 45) & 3;
    SELF.orig_unused_Invalid := (le.ScrubsBits2 >> 47) & 7;
    SELF.orig_login_history_id_Invalid := (le.ScrubsBits2 >> 50) & 7;
    SELF.orig_aseid_Invalid := (le.ScrubsBits2 >> 53) & 7;
    SELF.orig_years_Invalid := (le.ScrubsBits2 >> 56) & 7;
    SELF.orig_ip_address_Invalid := (le.ScrubsBits2 >> 59) & 3;
    SELF.orig_source_code_Invalid := (le.ScrubsBits2 >> 61) & 7;
    SELF.orig_retail_price_Invalid := (le.ScrubsBits3 >> 0) & 3;
    SELF.inquiry_type_Invalid := (le.ScrubsBits3 >> 2) & 7;
    SELF.lex_id_Invalid := (le.ScrubsBits3 >> 5) & 7;
    SELF.reprice_batch_number_Invalid := (le.ScrubsBits3 >> 8) & 7;
    SELF.user_changed_Invalid := (le.ScrubsBits3 >> 11) & 7;
    SELF.date_changed_Invalid := (le.ScrubsBits3 >> 14) & 7;
    SELF.fcra_purpose_Invalid := (le.ScrubsBits3 >> 17) & 7;
    SELF.orig_address_2_Invalid := (le.ScrubsBits3 >> 20) & 7;
    SELF.orig_city_2_Invalid := (le.ScrubsBits3 >> 23) & 7;
    SELF.orig_state_2_Invalid := (le.ScrubsBits3 >> 26) & 7;
    SELF.orig_zip_2_Invalid := (le.ScrubsBits3 >> 29) & 7;
    SELF.orig_zip4_2_Invalid := (le.ScrubsBits3 >> 32) & 7;
    SELF.orig_jobid_Invalid := (le.ScrubsBits3 >> 35) & 7;
    SELF.orig_acctno_Invalid := (le.ScrubsBits3 >> 38) & 3;
    SELF.orig_end_user_name_Invalid := (le.ScrubsBits3 >> 40) & 3;
    SELF.orig_end_user_address_1_Invalid := (le.ScrubsBits3 >> 42) & 1;
    SELF.orig_end_user_address_2_Invalid := (le.ScrubsBits3 >> 43) & 7;
    SELF.orig_end_user_city_Invalid := (le.ScrubsBits3 >> 46) & 3;
    SELF.orig_end_user_state_Invalid := (le.ScrubsBits3 >> 48) & 7;
    SELF.orig_end_user_zip_Invalid := (le.ScrubsBits3 >> 51) & 7;
    ...
    SELF.inquiry_type_wouldClean := le.ScrubsCleanBits1 >> 49;
    SELF.lex_id_wouldClean := le.ScrubsCleanBits1 >> 50;
    SELF.reprice_batch_number_wouldClean := le.ScrubsCleanBits1 >> 51;
    SELF.user_changed_wouldClean := le.ScrubsCleanBits1 >> 52;
    SELF.date_changed_wouldClean := le.ScrubsCleanBits1 >> 53;
    SELF.fcra_purpose_wouldClean := le.ScrubsCleanBits1 >> 54;
    SELF.orig_address_2_wouldClean := le.ScrubsCleanBits1 >> 55;
    SELF.orig_city_2_wouldClean := le.ScrubsCleanBits1 >> 56;
    SELF.orig_state_2_wouldClean := le.ScrubsCleanBits1 >> 57;
    SELF.orig_zip_2_wouldClean := le.ScrubsCleanBits1 >> 58;
    SELF.orig_zip4_2_wouldClean := le.ScrubsCleanBits1 >> 59;
    SELF.orig_jobid_wouldClean := le.ScrubsCleanBits1 >> 60;
    SELF.orig_acctno_wouldClean := le.ScrubsCleanBits1 >> 61;
    SELF.orig_end_user_name_wouldClean := le.ScrubsCleanBits1 >> 62;
    SELF.orig_end_user_address_1_wouldClean := le.ScrubsCleanBits1 >> 63;
    SELF.orig_end_user_address_2_wouldClean := le.ScrubsCleanBits2 >> 0;
    SELF.orig_end_user_city_wouldClean := le.ScrubsCleanBits2 >> 1;
    SELF.orig_end_user_state_wouldClean := le.ScrubsCleanBits2 >> 2;
    SELF.orig_end_user_zip_wouldClean := le.ScrubsCleanBits2 >> 3;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    orig_end_user_id_LEFTTRIM_ErrorCount := COUNT(GROUP,h.orig_end_user_id_Invalid=1);
    orig_end_user_id_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.orig_end_user_id_Invalid=1 AND h.orig_end_user_id_wouldClean);
    orig_end_user_id_ALLOW_ErrorCount := COUNT(GROUP,h.orig_end_user_id_Invalid=2);
    orig_end_user_id_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_end_user_id_Invalid=2 AND h.orig_end_user_id_wouldClean);
    orig_end_user_id_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_end_user_id_Invalid=3);
    orig_end_user_id_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_id_Invalid=3 AND h.orig_end_user_id_wouldClean);
    orig_end_user_id_WORDS_ErrorCount := COUNT(GROUP,h.orig_end_user_id_Invalid=4);
    orig_end_user_id_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_id_Invalid=4 AND h.orig_end_user_id_wouldClean);
    orig_end_user_id_Total_ErrorCount := COUNT(GROUP,h.orig_end_user_id_Invalid>0);
    ...
    orig_billing_code_WORDS_ErrorCount := COUNT(GROUP,h.orig_billing_code_Invalid=3);
    orig_billing_code_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_billing_code_Invalid=3 AND h.orig_billing_code_wouldClean);
    ...
    orig_company_id_ALLOW_ErrorCount := COUNT(GROUP,h.orig_company_id_Invalid=1);
    orig_company_id_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_company_id_Invalid=1 AND h.orig_company_id_wouldClean);
    orig_company_id_WORDS_ErrorCount := COUNT(GROUP,h.orig_company_id_Invalid=2);
    orig_company_id_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_company_id_Invalid=2 AND h.orig_company_id_wouldClean);
    ...
    orig_zip_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_zip_Invalid=3);
    orig_zip_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_zip_Invalid=3 AND h.orig_zip_wouldClean);
    orig_zip_WORDS_ErrorCount := COUNT(GROUP,h.orig_zip_Invalid=4);
    orig_zip_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_zip_Invalid=4 AND h.orig_zip_wouldClean);
    orig_zip_Total_ErrorCount := COUNT(GROUP,h.orig_zip_Invalid>0);
    orig_zip4_LEFTTRIM_ErrorCount := COUNT(GROUP,h.orig_zip4_Invalid=1);
    orig_zip4_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.orig_zip4_Invalid=1 AND h.orig_zip4_wouldClean);
    orig_zip4_ALLOW_ErrorCount := COUNT(GROUP,h.orig_zip4_Invalid=2);
    orig_zip4_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_zip4_Invalid=2 AND h.orig_zip4_wouldClean);
    orig_zip4_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_zip4_Invalid=3);
    orig_zip4_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_zip4_Invalid=3 AND h.orig_zip4_wouldClean);
    orig_zip4_WORDS_ErrorCount := COUNT(GROUP,h.orig_zip4_Invalid=4);
    orig_zip4_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_zip4_Invalid=4 AND h.orig_zip4_wouldClean);
    ...
    inquiry_type_LEFTTRIM_ErrorCount := COUNT(GROUP,h.inquiry_type_Invalid=1);
    inquiry_type_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.inquiry_type_Invalid=1 AND h.inquiry_type_wouldClean);
    inquiry_type_ALLOW_ErrorCount := COUNT(GROUP,h.inquiry_type_Invalid=2);
    inquiry_type_ALLOW_WouldModifyCount := COUNT(GROUP,h.inquiry_type_Invalid=2 AND h.inquiry_type_wouldClean);
    inquiry_type_LENGTHS_ErrorCount := COUNT(GROUP,h.inquiry_type_Invalid=3);
    inquiry_type_LENGTHS_WouldModifyCount := COUNT(GROUP,h.inquiry_type_Invalid=3 AND h.inquiry_type_wouldClean);
    inquiry_type_WORDS_ErrorCount := COUNT(GROUP,h.inquiry_type_Invalid=4);
    inquiry_type_WORDS_WouldModifyCount := COUNT(GROUP,h.inquiry_type_Invalid=4 AND h.inquiry_type_wouldClean);
    inquiry_type_Total_ErrorCount := COUNT(GROUP,h.inquiry_type_Invalid>0);
    lex_id_LEFTTRIM_ErrorCount := COUNT(GROUP,h.lex_id_Invalid=1);
    lex_id_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.lex_id_Invalid=1 AND h.lex_id_wouldClean);
    lex_id_ALLOW_ErrorCount := COUNT(GROUP,h.lex_id_Invalid=2);
    lex_id_ALLOW_WouldModifyCount := COUNT(GROUP,h.lex_id_Invalid=2 AND h.lex_id_wouldClean);
    lex_id_LENGTHS_ErrorCount := COUNT(GROUP,h.lex_id_Invalid=3);
    lex_id_LENGTHS_WouldModifyCount := COUNT(GROUP,h.lex_id_Invalid=3 AND h.lex_id_wouldClean);
    lex_id_WORDS_ErrorCount := COUNT(GROUP,h.lex_id_Invalid=4);
    lex_id_WORDS_WouldModifyCount := COUNT(GROUP,h.lex_id_Invalid=4 AND h.lex_id_wouldClean);
    lex_id_Total_ErrorCount := COUNT(GROUP,h.lex_id_Invalid>0);
    reprice_batch_number_LEFTTRIM_ErrorCount := COUNT(GROUP,h.reprice_batch_number_Invalid=1);
    reprice_batch_number_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.reprice_batch_number_Invalid=1 AND h.reprice_batch_number_wouldClean);
    reprice_batch_number_ALLOW_ErrorCount := COUNT(GROUP,h.reprice_batch_number_Invalid=2);
    reprice_batch_number_ALLOW_WouldModifyCount := COUNT(GROUP,h.reprice_batch_number_Invalid=2 AND h.reprice_batch_number_wouldClean);
    reprice_batch_number_LENGTHS_ErrorCount := COUNT(GROUP,h.reprice_batch_number_Invalid=3);
    reprice_batch_number_LENGTHS_WouldModifyCount := COUNT(GROUP,h.reprice_batch_number_Invalid=3 AND h.reprice_batch_number_wouldClean);
    reprice_batch_number_WORDS_ErrorCount := COUNT(GROUP,h.reprice_batch_number_Invalid=4);
    reprice_batch_number_WORDS_WouldModifyCount := COUNT(GROUP,h.reprice_batch_number_Invalid=4 AND h.reprice_batch_number_wouldClean);
    reprice_batch_number_Total_ErrorCount := COUNT(GROUP,h.reprice_batch_number_Invalid>0);
    user_changed_LEFTTRIM_ErrorCount := COUNT(GROUP,h.user_changed_Invalid=1);
    user_changed_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.user_changed_Invalid=1 AND h.user_changed_wouldClean);
    user_changed_ALLOW_ErrorCount := COUNT(GROUP,h.user_changed_Invalid=2);
    user_changed_ALLOW_WouldModifyCount := COUNT(GROUP,h.user_changed_Invalid=2 AND h.user_changed_wouldClean);
    user_changed_LENGTHS_ErrorCount := COUNT(GROUP,h.user_changed_Invalid=3);
    user_changed_LENGTHS_WouldModifyCount := COUNT(GROUP,h.user_changed_Invalid=3 AND h.user_changed_wouldClean);
    user_changed_WORDS_ErrorCount := COUNT(GROUP,h.user_changed_Invalid=4);
    user_changed_WORDS_WouldModifyCount := COUNT(GROUP,h.user_changed_Invalid=4 AND h.user_changed_wouldClean);
    user_changed_Total_ErrorCount := COUNT(GROUP,h.user_changed_Invalid>0);
    ...
    date_changed_LENGTHS_ErrorCount := COUNT(GROUP,h.date_changed_Invalid=3);
    date_changed_LENGTHS_WouldModifyCount := COUNT(GROUP,h.date_changed_Invalid=3 AND h.date_changed_wouldClean);
    date_changed_WORDS_ErrorCount := COUNT(GROUP,h.date_changed_Invalid=4);
    date_changed_WORDS_WouldModifyCount := COUNT(GROUP,h.date_changed_Invalid=4 AND h.date_changed_wouldClean);
    date_changed_Total_ErrorCount := COUNT(GROUP,h.date_changed_Invalid>0);
    fcra_purpose_LEFTTRIM_ErrorCount := COUNT(GROUP,h.fcra_purpose_Invalid=1);
    fcra_purpose_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.fcra_purpose_Invalid=1 AND h.fcra_purpose_wouldClean);
    fcra_purpose_ALLOW_ErrorCount := COUNT(GROUP,h.fcra_purpose_Invalid=2);
    fcra_purpose_ALLOW_WouldModifyCount := COUNT(GROUP,h.fcra_purpose_Invalid=2 AND h.fcra_purpose_wouldClean);
    fcra_purpose_LENGTHS_ErrorCount := COUNT(GROUP,h.fcra_purpose_Invalid=3);
    fcra_purpose_LENGTHS_WouldModifyCount := COUNT(GROUP,h.fcra_purpose_Invalid=3 AND h.fcra_purpose_wouldClean);
    fcra_purpose_WORDS_ErrorCount := COUNT(GROUP,h.fcra_purpose_Invalid=4);
    fcra_purpose_WORDS_WouldModifyCount := COUNT(GROUP,h.fcra_purpose_Invalid=4 AND h.fcra_purpose_wouldClean);
    fcra_purpose_Total_ErrorCount := COUNT(GROUP,h.fcra_purpose_Invalid>0);
    ...
    orig_jobid_LEFTTRIM_ErrorCount := COUNT(GROUP,h.orig_jobid_Invalid=1);
    orig_jobid_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.orig_jobid_Invalid=1 AND h.orig_jobid_wouldClean);
    orig_jobid_ALLOW_ErrorCount := COUNT(GROUP,h.orig_jobid_Invalid=2);
    orig_jobid_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_jobid_Invalid=2 AND h.orig_jobid_wouldClean);
    orig_jobid_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_jobid_Invalid=3);
    orig_jobid_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_jobid_Invalid=3 AND h.orig_jobid_wouldClean);
    orig_jobid_WORDS_ErrorCount := COUNT(GROUP,h.orig_jobid_Invalid=4);
    orig_jobid_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_jobid_Invalid=4 AND h.orig_jobid_wouldClean);
    orig_jobid_Total_ErrorCount := COUNT(GROUP,h.orig_jobid_Invalid>0);
    orig_acctno_ALLOW_ErrorCount := COUNT(GROUP,h.orig_acctno_Invalid=1);
    orig_acctno_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_acctno_Invalid=1 AND h.orig_acctno_wouldClean);
    orig_acctno_WORDS_ErrorCount := COUNT(GROUP,h.orig_acctno_Invalid=2);
    orig_acctno_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_acctno_Invalid=2 AND h.orig_acctno_wouldClean);
    orig_acctno_Total_ErrorCount := COUNT(GROUP,h.orig_acctno_Invalid>0);
    ...
    orig_end_user_name_WORDS_ErrorCount := COUNT(GROUP,h.orig_end_user_name_Invalid=3);
    orig_end_user_name_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_name_Invalid=3 AND h.orig_end_user_name_wouldClean);
    orig_end_user_name_Total_ErrorCount := COUNT(GROUP,h.orig_end_user_name_Invalid>0);
    orig_end_user_address_1_ALLOW_ErrorCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=1);
    orig_end_user_address_1_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=1 AND h.orig_end_user_address_1_wouldClean);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.orig_company_id_Invalid,'ALLOW','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_zip_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_zip4_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_price_Invalid,'LEFTTRIM','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_ip_address_Invalid,'LEFTTRIM','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.inquiry_type_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.lex_id_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.reprice_batch_number_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.user_changed_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.date_changed_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.fcra_purpose_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_jobid_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_acctno_Invalid,'ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_name_Invalid,'LEFTTRIM','ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_address_1_Invalid,'ALLOW','UNKNOWN')
  ...
  // field error stats
    SALT39.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ,'orig_end_user_id:orig_end_user_id:LEFTTRIM','orig_end_user_id:orig_end_user_id:ALLOW','orig_end_user_id:orig_end_user_id:LENGTHS','orig_end_user_id:orig_end_user_id:WORDS'
          ,'orig_loginid:orig_loginid:ALLOW','orig_loginid:orig_loginid:WORDS'
          ,'orig_billing_code:orig_billing_code:LEFTTRIM','orig_billing_code:orig_billing_code:ALLOW','orig_billing_code:orig_billing_code:WORDS'
          ...
          ,'orig_company_id:orig_company_id:ALLOW','orig_company_id:orig_company_id:WORDS'
          ...
          ,'orig_zip:orig_zip:LEFTTRIM','orig_zip:orig_zip:ALLOW','orig_zip:orig_zip:LENGTHS','orig_zip:orig_zip:WORDS'
          ,'orig_zip4:orig_zip4:LEFTTRIM','orig_zip4:orig_zip4:ALLOW','orig_zip4:orig_zip4:LENGTHS','orig_zip4:orig_zip4:WORDS'
          ...
          ,'orig_price:orig_price:LEFTTRIM','orig_price:orig_price:LENGTHS','orig_price:orig_price:WORDS'
          ...
          ,'inquiry_type:inquiry_type:LEFTTRIM','inquiry_type:inquiry_type:ALLOW','inquiry_type:inquiry_type:LENGTHS','inquiry_type:inquiry_type:WORDS'
          ,'lex_id:lex_id:LEFTTRIM','lex_id:lex_id:ALLOW','lex_id:lex_id:LENGTHS','lex_id:lex_id:WORDS'
          ,'reprice_batch_number:reprice_batch_number:LEFTTRIM','reprice_batch_number:reprice_batch_number:ALLOW','reprice_batch_number:reprice_batch_number:LENGTHS','reprice_batch_number:reprice_batch_number:WORDS'
          ,'user_changed:user_changed:LEFTTRIM','user_changed:user_changed:ALLOW','user_changed:user_changed:LENGTHS','user_changed:user_changed:WORDS'
          ,'date_changed:date_changed:LEFTTRIM','date_changed:date_changed:ALLOW','date_changed:date_changed:LENGTHS','date_changed:date_changed:WORDS'
          ,'fcra_purpose:fcra_purpose:LEFTTRIM','fcra_purpose:fcra_purpose:ALLOW','fcra_purpose:fcra_purpose:LENGTHS','fcra_purpose:fcra_purpose:WORDS'
          ...
          ,'orig_jobid:orig_jobid:LEFTTRIM','orig_jobid:orig_jobid:ALLOW','orig_jobid:orig_jobid:LENGTHS','orig_jobid:orig_jobid:WORDS'
          ,'orig_acctno:orig_acctno:ALLOW','orig_acctno:orig_acctno:WORDS'
          ,'orig_end_user_name:orig_end_user_name:LEFTTRIM','orig_end_user_name:orig_end_user_name:ALLOW','orig_end_user_name:orig_end_user_name:WORDS'
          ,'orig_end_user_address_1:orig_end_user_address_1:ALLOW'
          ...
          ,'orig_end_user_zip:orig_end_user_zip:LEFTTRIM','orig_end_user_zip:orig_end_user_zip:ALLOW','orig_end_user_zip:orig_end_user_zip:LENGTHS','orig_end_user_zip:orig_end_user_zip:WORDS'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Fields.InvalidMessage_orig_end_user_id(1),Fields.InvalidMessage_orig_end_user_id(2),Fields.InvalidMessage_orig_end_user_id(3),Fields.InvalidMessage_orig_end_user_id(4)
          ,Fields.InvalidMessage_orig_loginid(1),Fields.InvalidMessage_orig_loginid(2)
          ,Fields.InvalidMessage_orig_billing_code(1),Fields.InvalidMessage_orig_billing_code(2),Fields.InvalidMessage_orig_billing_code(3)
          ...
          ,Fields.InvalidMessage_orig_zip(1),Fields.InvalidMessage_orig_zip(2),Fields.InvalidMessage_orig_zip(3),Fields.InvalidMessage_orig_zip(4)
          ,Fields.InvalidMessage_orig_zip4(1),Fields.InvalidMessage_orig_zip4(2),Fields.InvalidMessage_orig_zip4(3),Fields.InvalidMessage_orig_zip4(4)
          ...
          ,Fields.InvalidMessage_inquiry_type(1),Fields.InvalidMessage_inquiry_type(2),Fields.InvalidMessage_inquiry_type(3),Fields.InvalidMessage_inquiry_type(4)
          ,Fields.InvalidMessage_lex_id(1),Fields.InvalidMessage_lex_id(2),Fields.InvalidMessage_lex_id(3),Fields.InvalidMessage_lex_id(4)
          ,Fields.InvalidMessage_reprice_batch_number(1),Fields.InvalidMessage_reprice_batch_number(2),Fields.InvalidMessage_reprice_batch_number(3),Fields.InvalidMessage_reprice_batch_number(4)
          ,Fields.InvalidMessage_user_changed(1),Fields.InvalidMessage_user_changed(2),Fields.InvalidMessage_user_changed(3),Fields.InvalidMessage_user_changed(4)
          ,Fields.InvalidMessage_date_changed(1),Fields.InvalidMessage_date_changed(2),Fields.InvalidMessage_date_changed(3),Fields.InvalidMessage_date_changed(4)
          ,Fields.InvalidMessage_fcra_purpose(1),Fields.InvalidMessage_fcra_purpose(2),Fields.InvalidMessage_fcra_purpose(3),Fields.InvalidMessage_fcra_purpose(4)
          ...
          ,Fields.InvalidMessage_orig_jobid(1),Fields.InvalidMessage_orig_jobid(2),Fields.InvalidMessage_orig_jobid(3),Fields.InvalidMessage_orig_jobid(4)
          ,Fields.InvalidMessage_orig_acctno(1),Fields.InvalidMessage_orig_acctno(2)
          ,Fields.InvalidMessage_orig_end_user_name(1),Fields.InvalidMessage_orig_end_user_name(2),Fields.InvalidMessage_orig_end_user_name(3)
          ,Fields.InvalidMessage_orig_end_user_address_1(1)
          ...
          ,Fields.InvalidMessage_orig_end_user_zip(1),Fields.InvalidMessage_orig_end_user_zip(2),Fields.InvalidMessage_orig_end_user_zip(3),Fields.InvalidMessage_orig_end_user_zip(4)
          ,'Fields with errors'
      ...
      SELF.rulecnt := CHOOSE(c
          ,le.orig_end_user_id_LEFTTRIM_ErrorCount,le.orig_end_user_id_ALLOW_ErrorCount,le.orig_end_user_id_LENGTHS_ErrorCount,le.orig_end_user_id_WORDS_ErrorCount
          ,le.orig_loginid_ALLOW_ErrorCount,le.orig_loginid_WORDS_ErrorCount
          ,le.orig_billing_code_LEFTTRIM_ErrorCount,le.orig_billing_code_ALLOW_ErrorCount,le.orig_billing_code_WORDS_ErrorCount
          ...
          ,le.orig_company_id_ALLOW_ErrorCount,le.orig_company_id_WORDS_ErrorCount
          ...
          ,le.orig_zip_LEFTTRIM_ErrorCount,le.orig_zip_ALLOW_ErrorCount,le.orig_zip_LENGTHS_ErrorCount,le.orig_zip_WORDS_ErrorCount
          ,le.orig_zip4_LEFTTRIM_ErrorCount,le.orig_zip4_ALLOW_ErrorCount,le.orig_zip4_LENGTHS_ErrorCount,le.orig_zip4_WORDS_ErrorCount
          ...
          ,le.orig_price_LEFTTRIM_ErrorCount,le.orig_price_LENGTHS_ErrorCount,le.orig_price_WORDS_ErrorCount
          ...
          ,le.inquiry_type_LEFTTRIM_ErrorCount,le.inquiry_type_ALLOW_ErrorCount,le.inquiry_type_LENGTHS_ErrorCount,le.inquiry_type_WORDS_ErrorCount
          ,le.lex_id_LEFTTRIM_ErrorCount,le.lex_id_ALLOW_ErrorCount,le.lex_id_LENGTHS_ErrorCount,le.lex_id_WORDS_ErrorCount
          ,le.reprice_batch_number_LEFTTRIM_ErrorCount,le.reprice_batch_number_ALLOW_ErrorCount,le.reprice_batch_number_LENGTHS_ErrorCount,le.reprice_batch_number_WORDS_ErrorCount
          ,le.user_changed_LEFTTRIM_ErrorCount,le.user_changed_ALLOW_ErrorCount,le.user_changed_LENGTHS_ErrorCount,le.user_changed_WORDS_ErrorCount
          ,le.date_changed_LEFTTRIM_ErrorCount,le.date_changed_ALLOW_ErrorCount,le.date_changed_LENGTHS_ErrorCount,le.date_changed_WORDS_ErrorCount
          ,le.fcra_purpose_LEFTTRIM_ErrorCount,le.fcra_purpose_ALLOW_ErrorCount,le.fcra_purpose_LENGTHS_ErrorCount,le.fcra_purpose_WORDS_ErrorCount
          ...
          ,le.orig_jobid_LEFTTRIM_ErrorCount,le.orig_jobid_ALLOW_ErrorCount,le.orig_jobid_LENGTHS_ErrorCount,le.orig_jobid_WORDS_ErrorCount
          ,le.orig_acctno_ALLOW_ErrorCount,le.orig_acctno_WORDS_ErrorCount
          ,le.orig_end_user_name_LEFTTRIM_ErrorCount,le.orig_end_user_name_ALLOW_ErrorCount,le.orig_end_user_name_WORDS_ErrorCount
          ,le.orig_end_user_address_1_ALLOW_ErrorCount
          ...
          ,le.orig_end_user_zip_LEFTTRIM_ErrorCount,le.orig_end_user_zip_ALLOW_ErrorCount,le.orig_end_user_zip_LENGTHS_ErrorCount,le.orig_end_user_zip_WORDS_ErrorCount
      ...
      SELF.rulepcnt := IF(c <= NumRules, 100 * CHOOSE(c
          ...
          ,le.orig_end_user_city_LEFTTRIM_ErrorCount,le.orig_end_user_city_ALLOW_ErrorCount,le.orig_end_user_city_WORDS_ErrorCount
          ,le.orig_end_user_state_LEFTTRIM_ErrorCount,le.orig_end_user_state_ALLOW_ErrorCount,le.orig_end_user_state_LENGTHS_ErrorCount,le.orig_end_user_state_WORDS_ErrorCount
          ,le.orig_end_user_zip_LEFTTRIM_ErrorCount,le.orig_end_user_zip_ALLOW_ErrorCount,le.orig_end_user_zip_LENGTHS_ErrorCount,le.orig_end_user_zip_WORDS_ErrorCount,0) / le.TotalCnt + 0.5, CHOOSE(c - NumRules
    ...
    SALT39.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'inquiry_type:' + getFieldTypeText(h.inquiry_type) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ,'lex_id:' + getFieldTypeText(h.lex_id) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ,'reprice_batch_number:' + getFieldTypeText(h.reprice_batch_number) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ...
          ,'fcra_purpose:' + getFieldTypeText(h.fcra_purpose) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ...
          ,'orig_jobid:' + getFieldTypeText(h.orig_jobid) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ,'orig_acctno:' + getFieldTypeText(h.orig_acctno) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ...
          ,'orig_end_user_zip:' + getFieldTypeText(h.orig_end_user_zip) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix,'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_inquiry_type_cnt
          ,le.populated_lex_id_cnt
          ,le.populated_reprice_batch_number_cnt
          ,le.populated_user_changed_cnt
          ,le.populated_date_changed_cnt
          ,le.populated_fcra_purpose_cnt
          ...
          ,le.populated_orig_jobid_cnt
          ,le.populated_orig_acctno_cnt
          ...
          ,le.populated_orig_end_user_zip_cnt,0);
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_inquiry_type_pcnt
          ,le.populated_lex_id_pcnt
          ,le.populated_reprice_batch_number_pcnt
          ,le.populated_user_changed_pcnt
          ,le.populated_date_changed_pcnt
          ,le.populated_fcra_purpose_pcnt
          ...
          ,le.populated_orig_jobid_pcnt
          ,le.populated_orig_acctno_pcnt
          ...
          ,le.populated_orig_end_user_zip_pcnt,0);
      SELF.ErrorMessage := '';
    END;
    FieldPopStats := NORMALIZE(hygiene_summaryStats,68,xNormHygieneStats(LEFT,COUNTER,'POP'));
  ...
  // record count stats
    ...
    DeltaFieldPopStats := NORMALIZE(deltaHygieneSummary(txt <> 'New'),68,xNormHygieneStats(LEFT,COUNTER,'DELTA'));
...
EXPORT StandardStats(DATASET(Layout_FILE) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_Inql_fcra_Accurint, Fields, 'RECORDOF(scrubsSummaryOverall)', '');
