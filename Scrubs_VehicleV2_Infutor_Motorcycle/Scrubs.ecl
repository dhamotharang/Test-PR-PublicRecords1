...
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(Layout_Profile_VehicleV2_Infutor_Motorcycle)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Layout_Profile_VehicleV2_Infutor_Motorcycle)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Layout_Profile_VehicleV2_Infutor_Motorcycle) h) := MODULE
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.fuel_type_code_Invalid := Fields.InValid_fuel_type_code((SALT30.StrType)le.fuel_type_code);
    SELF.style_code_Invalid := Fields.InValid_style_code((SALT30.StrType)le.style_code);
    SELF.mileagecd_Invalid := Fields.InValid_mileagecd((SALT30.StrType)le.mileagecd);
    SELF.nbr_vehicles_Invalid := Fields.InValid_nbr_vehicles((SALT30.StrType)le.nbr_vehicles);
    SELF.idate_Invalid := Fields.InValid_idate((SALT30.StrType)le.idate);
    SELF.odate_Invalid := Fields.InValid_odate((SALT30.StrType)le.odate);
    SELF.fname_Invalid := Fields.InValid_fname((SALT30.StrType)le.fname);
    SELF.mi_Invalid := Fields.InValid_mi((SALT30.StrType)le.mi);
    ...
    SELF.house_Invalid := Fields.InValid_house((SALT30.StrType)le.house);
    SELF.predir_Invalid := Fields.InValid_predir((SALT30.StrType)le.predir);
    SELF.street_Invalid := Fields.InValid_street((SALT30.StrType)le.street);
    SELF.strtype_Invalid := Fields.InValid_strtype((SALT30.StrType)le.strtype);
    SELF.postdir_Invalid := Fields.InValid_postdir((SALT30.StrType)le.postdir);
    SELF.apttype_Invalid := Fields.InValid_apttype((SALT30.StrType)le.apttype);
    SELF.aptnbr_Invalid := Fields.InValid_aptnbr((SALT30.StrType)le.aptnbr);
    ...
    SELF.z4_Invalid := Fields.InValid_z4((SALT30.StrType)le.z4);
    SELF.phone_Invalid := Fields.InValid_phone((SALT30.StrType)le.phone);
    SELF.internal1_Invalid := Fields.InValid_internal1((SALT30.StrType)le.internal1);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Layout_Profile_VehicleV2_Infutor_Motorcycle);
  Expanded_Layout into(h le) := TRANSFORM
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Fields.InvalidMessage_make(le.make_Invalid),Fields.InvalidMessage_model(le.model_Invalid),Fields.InvalidMessage_year(le.year_Invalid),Fields.InvalidMessage_fuel_type_code(le.fuel_type_code_Invalid),Fields.InvalidMessage_style_code(le.style_code_Invalid),Fields.InvalidMessage_mileagecd(le.mileagecd_Invalid),Fields.InvalidMessage_nbr_vehicles(le.nbr_vehicles_Invalid),Fields.InvalidMessage_idate(le.idate_Invalid),Fields.InvalidMessage_odate(le.odate_Invalid),Fields.InvalidMessage_fname(le.fname_Invalid),Fields.InvalidMessage_mi(le.mi_Invalid),Fields.InvalidMessage_lname(le.lname_Invalid),Fields.InvalidMessage_suffix(le.suffix_Invalid),Fields.InvalidMessage_gender(le.gender_Invalid),Fields.InvalidMessage_house(le.house_Invalid),Fields.InvalidMessage_predir(le.predir_Invalid),Fields.InvalidMessage_street(le.street_Invalid),Fields.InvalidMessage_strtype(le.strtype_Invalid),Fields.InvalidMessage_postdir(le.postdir_Invalid),Fields.InvalidMessage_apttype(le.apttype_Invalid),Fields.InvalidMessage_aptnbr(le.aptnbr_Invalid),Fields.InvalidMessage_city(le.city_Invalid),Fields.InvalidMessage_state(le.state_Invalid),Fields.InvalidMessage_zip(le.zip_Invalid),Fields.InvalidMessage_z4(le.z4_Invalid),Fields.InvalidMessage_phone(le.phone_Invalid),Fields.InvalidMessage_internal1(le.internal1_Invalid),Fields.InvalidMessage_county(le.county_Invalid),'UNKNOWN'));
    ...
    SELF.FieldContents := CHOOSE(c,(SALT30.StrType)le.make,(SALT30.StrType)le.model,(SALT30.StrType)le.year,(SALT30.StrType)le.fuel_type_code,(SALT30.StrType)le.style_code,(SALT30.StrType)le.mileagecd,(SALT30.StrType)le.nbr_vehicles,(SALT30.StrType)le.idate,(SALT30.StrType)le.odate,(SALT30.StrType)le.fname,(SALT30.StrType)le.mi,(SALT30.StrType)le.lname,(SALT30.StrType)le.suffix,(SALT30.StrType)le.gender,(SALT30.StrType)le.house,(SALT30.StrType)le.predir,(SALT30.StrType)le.street,(SALT30.StrType)le.strtype,(SALT30.StrType)le.postdir,(SALT30.StrType)le.apttype,(SALT30.StrType)le.aptnbr,(SALT30.StrType)le.city,(SALT30.StrType)le.state,(SALT30.StrType)le.zip,(SALT30.StrType)le.z4,(SALT30.StrType)le.phone,(SALT30.StrType)le.internal1,(SALT30.StrType)le.county,'***SALTBUG***');
  END;
