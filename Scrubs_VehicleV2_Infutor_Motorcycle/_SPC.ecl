MODULE:Scrubs_VehicleV2_Infutor_Motorcycle
FILENAME:Profile_VehicleV2_Infutor_Motorcycle
...
FIELDTYPE:invalid_vin:CAPS:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789x-*')
...
FIELDTYPE:invalid_name:CAPS:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZÃ‘'&):SPACES( -.()"):LENGTHS(0..)
FIELDTYPE:invalid_address:CAPS:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZÃ‘0123456789#'/-&):SPACES( .,):LENGTHS(0..)
