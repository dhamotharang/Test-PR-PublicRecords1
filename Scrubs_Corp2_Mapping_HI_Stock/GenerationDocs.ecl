...
Command line options: -MScrubs_Corp2_Mapping_HI_Stock -eC:\Users\butlersx\AppData\Local\Temp\TFR658D.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_HI_Stock
FILENAME:In_HI
...
FIELDTYPE:invalid_corp_key:ALLOW(-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(4..):CUSTOM(Scrubs_Corp2_Mapping_HI_Stock.Functions.invalid_corp_key>0)
FIELDTYPE:invalid_charter_nbr:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..):CUSTOM(Scrubs_Corp2_Mapping_HI_Stock.Functions.invalid_corp_sos_charter_nbr>0)
...
FIELDTYPE:invalid_class:ALLOW( -/().,;%$ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789)
FIELDTYPE:invalid_shares:ALLOW( .,BILMNORT0123456789)
FIELDTYPE:invalid_money:ALLOW( $.,/0123456789ACHMNPSV)
...
FIELD:stock_class:TYPE(STRING20):LIKE(invalid_class):0,0
FIELD:stock_shares_issued:TYPE(STRING15):LIKE(invalid_shares):0,0
FIELD:stock_authorized_nbr:TYPE(STRING50):0,0
FIELD:stock_par_value:TYPE(STRING15):LIKE(invalid_money):0,0
...
FIELD:stock_total_capital:TYPE(STRING15):LIKE(invalid_money):0,0
...
FIELD:stock_date_stock_limit_approved:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:stock_number_of_shares_paid_for:TYPE(UNSIGNED8):LIKE(invalid_numeric):0,0
FIELD:stock_total_value_of_shares_paid_for:TYPE(UNSIGNED8):LIKE(invalid_numeric):0,0
