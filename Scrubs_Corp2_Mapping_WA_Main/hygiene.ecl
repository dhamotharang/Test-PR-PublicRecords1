...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid__date','invalid__date','invalid__date','invalid__date','invalid__date','invalid__date','invalid__date','invalid__optional_date','invalid__optional_date','invalid__optional_date','invalid__optional_date','invalid__corp_key','invalid__charter','invalid__corp_vendor','invalid__state_origin','invalid__mandatory','invalid__state_origin','invalid__alphablank','invalid__forgn_dom_code','invalid__for_profit_ind','invalid__name_type_cd','invalid__name_type_desc','invalid__orig_org_structure_cd','invalid__alphablankhyphen','invalid__alphablank','invalid__merger_desc','invalid__alphablank','invalid__recordOrigin');
