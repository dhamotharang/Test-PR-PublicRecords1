...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_corp_ln_name_type_cd((SALT311.StrType)le.corp_ln_name_type_cd+++Line:329:DEPRECATED case-insensitive label match: recordOrigin
,(SALT311.StrType)le.recordOrigin),
    Fields.InValid_corp_ln_name_type_desc((SALT311.StrType)le.corp_ln_name_type_desc+++Line:329:DEPRECATED case-insensitive label match: recordOrigin
,(SALT311.StrType)le.recordOrigin),
