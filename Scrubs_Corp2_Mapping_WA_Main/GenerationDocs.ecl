...
Command line options: -MScrubs_Corp2_Mapping_WA_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR3346.tmp 
...
FIELDTYPE:invalid_charter:ALLOW(0123456789):LENGTHS(7,8,9)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_cd:ENUM(01|07| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|RESERVED| )
FIELDTYPE:invalid_corp_status_desc:ENUM(ACTIVE|INACTIVE|FEDERAL BANK| )
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(3LP|AUT|BNK|CAS|COP|CRU|FBS|FMA|FRA|GRG|INS|LLC|LLP|LTD|MAS|MMC|PBC|PLC|PRO|PUB|REG|SAL|SOL|FMA|MAS|MIL|MIN|MMC|PBC|PLC|PRO|PUB|REG|RFN|SAL|SOL|SPC| )
...
// FIELD:corp_orig_bus_type_cd:TYPE(STRING8):LIKE(invalid_orig_bus_type_cd):0,0
