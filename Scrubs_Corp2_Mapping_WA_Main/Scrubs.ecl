...
EXPORT FromNone(DATASET(Layout_In_WA) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_ln_name_type_cd_Invalid := Fields.InValid_corp_ln_name_type_cd((SALT311.StrType)le.corp_ln_name_type_cd+++Line:329:DEPRECATED case-insensitive label match: recordOrigin
,(SALT311.StrType)le.recordOrigin);
    SELF.corp_ln_name_type_desc_Invalid := Fields.InValid_corp_ln_name_type_desc((SALT311.StrType)le.corp_ln_name_type_desc+++Line:329:DEPRECATED case-insensitive label match: recordOrigin
,(SALT311.StrType)le.recordOrigin);
