...
EXPORT Summary(SALT36.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_append_process_date := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_process_date)));
    avelength_append_process_date := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_process_date)),h.append_process_date<>(typeof(h.append_process_date))'');
    populated_append_state_origin_pcnt := AVE(GROUP,IF(h.append_state_origin = (TYPEOF(h.append_state_origin))'',0,100));
    maxlength_append_state_origin := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_state_origin)));
    avelength_append_state_origin := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_state_origin)),h.append_state_origin<>(typeof(h.append_state_origin))'');
    populated_file_typ_pcnt := AVE(GROUP,IF(h.file_typ = (TYPEOF(h.file_typ))'',0,100));
    maxlength_file_typ := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.file_typ)));
    avelength_file_typ := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.file_typ)),h.file_typ<>(typeof(h.file_typ))'');
    populated_vin_pcnt := AVE(GROUP,IF(h.vin = (TYPEOF(h.vin))'',0,100));
    maxlength_vin := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vin)));
    avelength_vin := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vin)),h.vin<>(typeof(h.vin))'');
    populated_vehicle_typ_pcnt := AVE(GROUP,IF(h.vehicle_typ = (TYPEOF(h.vehicle_typ))'',0,100));
    maxlength_vehicle_typ := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicle_typ)));
    avelength_vehicle_typ := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicle_typ)),h.vehicle_typ<>(typeof(h.vehicle_typ))'');
    populated_model_yr_pcnt := AVE(GROUP,IF(h.model_yr = (TYPEOF(h.model_yr))'',0,100));
    maxlength_model_yr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_yr)));
    avelength_model_yr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_yr)),h.model_yr<>(typeof(h.model_yr))'');
    populated_model_yr_ind_pcnt := AVE(GROUP,IF(h.model_yr_ind = (TYPEOF(h.model_yr_ind))'',0,100));
    maxlength_model_yr_ind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_yr_ind)));
    avelength_model_yr_ind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_yr_ind)),h.model_yr_ind<>(typeof(h.model_yr_ind))'');
    populated_make_pcnt := AVE(GROUP,IF(h.make = (TYPEOF(h.make))'',0,100));
    maxlength_make := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.make)));
    avelength_make := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.make)),h.make<>(typeof(h.make))'');
    populated_make_ind_pcnt := AVE(GROUP,IF(h.make_ind = (TYPEOF(h.make_ind))'',0,100));
    maxlength_make_ind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.make_ind)));
    avelength_make_ind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.make_ind)),h.make_ind<>(typeof(h.make_ind))'');
    populated_series_pcnt := AVE(GROUP,IF(h.series = (TYPEOF(h.series))'',0,100));
    maxlength_series := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.series)));
    avelength_series := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.series)),h.series<>(typeof(h.series))'');
    populated_series_ind_pcnt := AVE(GROUP,IF(h.series_ind = (TYPEOF(h.series_ind))'',0,100));
    maxlength_series_ind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.series_ind)));
    avelength_series_ind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.series_ind)),h.series_ind<>(typeof(h.series_ind))'');
    populated_prime_color_pcnt := AVE(GROUP,IF(h.prime_color = (TYPEOF(h.prime_color))'',0,100));
    maxlength_prime_color := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prime_color)));
    avelength_prime_color := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prime_color)),h.prime_color<>(typeof(h.prime_color))'');
    populated_second_color_pcnt := AVE(GROUP,IF(h.second_color = (TYPEOF(h.second_color))'',0,100));
    maxlength_second_color := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.second_color)));
    avelength_second_color := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.second_color)),h.second_color<>(typeof(h.second_color))'');
    populated_body_style_pcnt := AVE(GROUP,IF(h.body_style = (TYPEOF(h.body_style))'',0,100));
    maxlength_body_style := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.body_style)));
    avelength_body_style := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.body_style)),h.body_style<>(typeof(h.body_style))'');
    populated_body_style_ind_pcnt := AVE(GROUP,IF(h.body_style_ind = (TYPEOF(h.body_style_ind))'',0,100));
    maxlength_body_style_ind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.body_style_ind)));
    avelength_body_style_ind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.body_style_ind)),h.body_style_ind<>(typeof(h.body_style_ind))'');
    populated_model_pcnt := AVE(GROUP,IF(h.model = (TYPEOF(h.model))'',0,100));
    maxlength_model := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model)));
    avelength_model := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model)),h.model<>(typeof(h.model))'');
    populated_model_ind_pcnt := AVE(GROUP,IF(h.model_ind = (TYPEOF(h.model_ind))'',0,100));
    maxlength_model_ind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_ind)));
    avelength_model_ind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_ind)),h.model_ind<>(typeof(h.model_ind))'');
    populated_weight_pcnt := AVE(GROUP,IF(h.weight = (TYPEOF(h.weight))'',0,100));
    maxlength_weight := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.weight)));
    avelength_weight := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.weight)),h.weight<>(typeof(h.weight))'');
    populated_lengt_pcnt := AVE(GROUP,IF(h.lengt = (TYPEOF(h.lengt))'',0,100));
    maxlength_lengt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.lengt)));
    avelength_lengt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.lengt)),h.lengt<>(typeof(h.lengt))'');
    populated_axle_cnt_pcnt := AVE(GROUP,IF(h.axle_cnt = (TYPEOF(h.axle_cnt))'',0,100));
    maxlength_axle_cnt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.axle_cnt)));
    avelength_axle_cnt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.axle_cnt)),h.axle_cnt<>(typeof(h.axle_cnt))'');
    populated_plate_nbr_pcnt := AVE(GROUP,IF(h.plate_nbr = (TYPEOF(h.plate_nbr))'',0,100));
    maxlength_plate_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_nbr)));
    avelength_plate_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_nbr)),h.plate_nbr<>(typeof(h.plate_nbr))'');
    populated_plate_state_pcnt := AVE(GROUP,IF(h.plate_state = (TYPEOF(h.plate_state))'',0,100));
    maxlength_plate_state := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_state)));
    avelength_plate_state := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_state)),h.plate_state<>(typeof(h.plate_state))'');
    populated_prev_plate_nbr_pcnt := AVE(GROUP,IF(h.prev_plate_nbr = (TYPEOF(h.prev_plate_nbr))'',0,100));
    maxlength_prev_plate_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prev_plate_nbr)));
    avelength_prev_plate_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prev_plate_nbr)),h.prev_plate_nbr<>(typeof(h.prev_plate_nbr))'');
    populated_prev_plate_state_pcnt := AVE(GROUP,IF(h.prev_plate_state = (TYPEOF(h.prev_plate_state))'',0,100));
    maxlength_prev_plate_state := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prev_plate_state)));
    avelength_prev_plate_state := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prev_plate_state)),h.prev_plate_state<>(typeof(h.prev_plate_state))'');
    populated_plate_typ_cd_pcnt := AVE(GROUP,IF(h.plate_typ_cd = (TYPEOF(h.plate_typ_cd))'',0,100));
    maxlength_plate_typ_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_typ_cd)));
    avelength_plate_typ_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.plate_typ_cd)),h.plate_typ_cd<>(typeof(h.plate_typ_cd))'');
    populated_mstr_src_state_pcnt := AVE(GROUP,IF(h.mstr_src_state = (TYPEOF(h.mstr_src_state))'',0,100));
    maxlength_mstr_src_state := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.mstr_src_state)));
    avelength_mstr_src_state := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.mstr_src_state)),h.mstr_src_state<>(typeof(h.mstr_src_state))'');
    populated_reg_decal_nbr_pcnt := AVE(GROUP,IF(h.reg_decal_nbr = (TYPEOF(h.reg_decal_nbr))'',0,100));
    maxlength_reg_decal_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_decal_nbr)));
    avelength_reg_decal_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_decal_nbr)),h.reg_decal_nbr<>(typeof(h.reg_decal_nbr))'');
    populated_org_reg_dt_pcnt := AVE(GROUP,IF(h.org_reg_dt = (TYPEOF(h.org_reg_dt))'',0,100));
    maxlength_org_reg_dt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.org_reg_dt)));
    avelength_org_reg_dt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.org_reg_dt)),h.org_reg_dt<>(typeof(h.org_reg_dt))'');
    populated_reg_renew_dt_pcnt := AVE(GROUP,IF(h.reg_renew_dt = (TYPEOF(h.reg_renew_dt))'',0,100));
    maxlength_reg_renew_dt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_renew_dt)));
    avelength_reg_renew_dt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_renew_dt)),h.reg_renew_dt<>(typeof(h.reg_renew_dt))'');
    populated_reg_exp_dt_pcnt := AVE(GROUP,IF(h.reg_exp_dt = (TYPEOF(h.reg_exp_dt))'',0,100));
    maxlength_reg_exp_dt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_exp_dt)));
    avelength_reg_exp_dt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.reg_exp_dt)),h.reg_exp_dt<>(typeof(h.reg_exp_dt))'');
    populated_title_nbr_pcnt := AVE(GROUP,IF(h.title_nbr = (TYPEOF(h.title_nbr))'',0,100));
    maxlength_title_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.title_nbr)));
    avelength_title_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.title_nbr)),h.title_nbr<>(typeof(h.title_nbr))'');
    populated_org_title_dt_pcnt := AVE(GROUP,IF(h.org_title_dt = (TYPEOF(h.org_title_dt))'',0,100));
    maxlength_org_title_dt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.org_title_dt)));
    avelength_org_title_dt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.org_title_dt)),h.org_title_dt<>(typeof(h.org_title_dt))'');
    populated_title_trans_dt_pcnt := AVE(GROUP,IF(h.title_trans_dt = (TYPEOF(h.title_trans_dt))'',0,100));
    maxlength_title_trans_dt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.title_trans_dt)));
    avelength_title_trans_dt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.title_trans_dt)),h.title_trans_dt<>(typeof(h.title_trans_dt))'');
    populated_name_typ_cd_pcnt := AVE(GROUP,IF(h.name_typ_cd = (TYPEOF(h.name_typ_cd))'',0,100));
    maxlength_name_typ_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_typ_cd)));
    avelength_name_typ_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_typ_cd)),h.name_typ_cd<>(typeof(h.name_typ_cd))'');
    populated_owner_typ_cd_pcnt := AVE(GROUP,IF(h.owner_typ_cd = (TYPEOF(h.owner_typ_cd))'',0,100));
    maxlength_owner_typ_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.owner_typ_cd)));
    avelength_owner_typ_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.owner_typ_cd)),h.owner_typ_cd<>(typeof(h.owner_typ_cd))'');
    populated_first_nm_pcnt := AVE(GROUP,IF(h.first_nm = (TYPEOF(h.first_nm))'',0,100));
    maxlength_first_nm := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.first_nm)));
    avelength_first_nm := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.first_nm)),h.first_nm<>(typeof(h.first_nm))'');
    populated_middle_nm_pcnt := AVE(GROUP,IF(h.middle_nm = (TYPEOF(h.middle_nm))'',0,100));
    maxlength_middle_nm := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.middle_nm)));
    avelength_middle_nm := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.middle_nm)),h.middle_nm<>(typeof(h.middle_nm))'');
    populated_last_nm_pcnt := AVE(GROUP,IF(h.last_nm = (TYPEOF(h.last_nm))'',0,100));
    maxlength_last_nm := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.last_nm)));
    avelength_last_nm := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.last_nm)),h.last_nm<>(typeof(h.last_nm))'');
    populated_name_suffix_pcnt := AVE(GROUP,IF(h.name_suffix = (TYPEOF(h.name_suffix))'',0,100));
    maxlength_name_suffix := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_suffix)));
    avelength_name_suffix := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_suffix)),h.name_suffix<>(typeof(h.name_suffix))'');
    populated_prof_suffix_pcnt := AVE(GROUP,IF(h.prof_suffix = (TYPEOF(h.prof_suffix))'',0,100));
    maxlength_prof_suffix := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prof_suffix)));
    avelength_prof_suffix := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prof_suffix)),h.prof_suffix<>(typeof(h.prof_suffix))'');
    populated_ind_ssn_pcnt := AVE(GROUP,IF(h.ind_ssn = (TYPEOF(h.ind_ssn))'',0,100));
    maxlength_ind_ssn := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ind_ssn)));
    avelength_ind_ssn := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ind_ssn)),h.ind_ssn<>(typeof(h.ind_ssn))'');
    populated_ind_dob_pcnt := AVE(GROUP,IF(h.ind_dob = (TYPEOF(h.ind_dob))'',0,100));
    maxlength_ind_dob := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ind_dob)));
    avelength_ind_dob := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ind_dob)),h.ind_dob<>(typeof(h.ind_dob))'');
    populated_mail_range_pcnt := AVE(GROUP,IF(h.mail_range = (TYPEOF(h.mail_range))'',0,100));
    maxlength_mail_range := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.mail_range)));
    avelength_mail_range := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.mail_range)),h.mail_range<>(typeof(h.mail_range))'');
    populated_m_pre_dir_pcnt := AVE(GROUP,IF(h.m_pre_dir = (TYPEOF(h.m_pre_dir))'',0,100));
    maxlength_m_pre_dir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_pre_dir)));
    avelength_m_pre_dir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_pre_dir)),h.m_pre_dir<>(typeof(h.m_pre_dir))'');
    populated_m_street_pcnt := AVE(GROUP,IF(h.m_street = (TYPEOF(h.m_street))'',0,100));
    maxlength_m_street := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_street)));
    avelength_m_street := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_street)),h.m_street<>(typeof(h.m_street))'');
    populated_m_suffix_pcnt := AVE(GROUP,IF(h.m_suffix = (TYPEOF(h.m_suffix))'',0,100));
    maxlength_m_suffix := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_suffix)));
    avelength_m_suffix := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_suffix)),h.m_suffix<>(typeof(h.m_suffix))'');
    populated_m_post_dir_pcnt := AVE(GROUP,IF(h.m_post_dir = (TYPEOF(h.m_post_dir))'',0,100));
    maxlength_m_post_dir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_post_dir)));
    avelength_m_post_dir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_post_dir)),h.m_post_dir<>(typeof(h.m_post_dir))'');
    populated_m_pob_pcnt := AVE(GROUP,IF(h.m_pob = (TYPEOF(h.m_pob))'',0,100));
    maxlength_m_pob := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_pob)));
    avelength_m_pob := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_pob)),h.m_pob<>(typeof(h.m_pob))'');
    populated_m_rr_nbr_pcnt := AVE(GROUP,IF(h.m_rr_nbr = (TYPEOF(h.m_rr_nbr))'',0,100));
    maxlength_m_rr_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_rr_nbr)));
    avelength_m_rr_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_rr_nbr)),h.m_rr_nbr<>(typeof(h.m_rr_nbr))'');
    populated_m_rr_box_pcnt := AVE(GROUP,IF(h.m_rr_box = (TYPEOF(h.m_rr_box))'',0,100));
    maxlength_m_rr_box := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_rr_box)));
    avelength_m_rr_box := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_rr_box)),h.m_rr_box<>(typeof(h.m_rr_box))'');
    populated_m_scndry_rng_pcnt := AVE(GROUP,IF(h.m_scndry_rng = (TYPEOF(h.m_scndry_rng))'',0,100));
    maxlength_m_scndry_rng := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_scndry_rng)));
    avelength_m_scndry_rng := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_scndry_rng)),h.m_scndry_rng<>(typeof(h.m_scndry_rng))'');
    populated_m_scndry_des_pcnt := AVE(GROUP,IF(h.m_scndry_des = (TYPEOF(h.m_scndry_des))'',0,100));
    maxlength_m_scndry_des := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_scndry_des)));
    avelength_m_scndry_des := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_scndry_des)),h.m_scndry_des<>(typeof(h.m_scndry_des))'');
    populated_m_city_pcnt := AVE(GROUP,IF(h.m_city = (TYPEOF(h.m_city))'',0,100));
    maxlength_m_city := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_city)));
    avelength_m_city := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_city)),h.m_city<>(typeof(h.m_city))'');
    populated_m_state_pcnt := AVE(GROUP,IF(h.m_state = (TYPEOF(h.m_state))'',0,100));
    maxlength_m_state := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_state)));
    avelength_m_state := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_state)),h.m_state<>(typeof(h.m_state))'');
    populated_m_zip5_pcnt := AVE(GROUP,IF(h.m_zip5 = (TYPEOF(h.m_zip5))'',0,100));
    maxlength_m_zip5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_zip5)));
    avelength_m_zip5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_zip5)),h.m_zip5<>(typeof(h.m_zip5))'');
    populated_m_zip4_pcnt := AVE(GROUP,IF(h.m_zip4 = (TYPEOF(h.m_zip4))'',0,100));
    maxlength_m_zip4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_zip4)));
    avelength_m_zip4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_zip4)),h.m_zip4<>(typeof(h.m_zip4))'');
    populated_m_cntry_cd_pcnt := AVE(GROUP,IF(h.m_cntry_cd = (TYPEOF(h.m_cntry_cd))'',0,100));
    maxlength_m_cntry_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cntry_cd)));
    avelength_m_cntry_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cntry_cd)),h.m_cntry_cd<>(typeof(h.m_cntry_cd))'');
    populated_m_cc_filler_pcnt := AVE(GROUP,IF(h.m_cc_filler = (TYPEOF(h.m_cc_filler))'',0,100));
    maxlength_m_cc_filler := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cc_filler)));
    avelength_m_cc_filler := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cc_filler)),h.m_cc_filler<>(typeof(h.m_cc_filler))'');
    populated_m_cc_pcnt := AVE(GROUP,IF(h.m_cc = (TYPEOF(h.m_cc))'',0,100));
    maxlength_m_cc := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cc)));
    avelength_m_cc := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_cc)),h.m_cc<>(typeof(h.m_cc))'');
    populated_m_county_pcnt := AVE(GROUP,IF(h.m_county = (TYPEOF(h.m_county))'',0,100));
    maxlength_m_county := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_county)));
    avelength_m_county := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.m_county)),h.m_county<>(typeof(h.m_county))'');
    populated_phys_range_pcnt := AVE(GROUP,IF(h.phys_range = (TYPEOF(h.phys_range))'',0,100));
    maxlength_phys_range := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.phys_range)));
    avelength_phys_range := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.phys_range)),h.phys_range<>(typeof(h.phys_range))'');
    populated_p_pre_dir_pcnt := AVE(GROUP,IF(h.p_pre_dir = (TYPEOF(h.p_pre_dir))'',0,100));
    maxlength_p_pre_dir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_pre_dir)));
    avelength_p_pre_dir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_pre_dir)),h.p_pre_dir<>(typeof(h.p_pre_dir))'');
    populated_p_street_pcnt := AVE(GROUP,IF(h.p_street = (TYPEOF(h.p_street))'',0,100));
    maxlength_p_street := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_street)));
    avelength_p_street := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_street)),h.p_street<>(typeof(h.p_street))'');
    populated_p_suffix_pcnt := AVE(GROUP,IF(h.p_suffix = (TYPEOF(h.p_suffix))'',0,100));
    maxlength_p_suffix := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_suffix)));
    avelength_p_suffix := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_suffix)),h.p_suffix<>(typeof(h.p_suffix))'');
    populated_p_post_dir_pcnt := AVE(GROUP,IF(h.p_post_dir = (TYPEOF(h.p_post_dir))'',0,100));
    maxlength_p_post_dir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_post_dir)));
    avelength_p_post_dir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_post_dir)),h.p_post_dir<>(typeof(h.p_post_dir))'');
    populated_p_pob_pcnt := AVE(GROUP,IF(h.p_pob = (TYPEOF(h.p_pob))'',0,100));
    maxlength_p_pob := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_pob)));
    avelength_p_pob := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_pob)),h.p_pob<>(typeof(h.p_pob))'');
    populated_p_rr_nbr_pcnt := AVE(GROUP,IF(h.p_rr_nbr = (TYPEOF(h.p_rr_nbr))'',0,100));
    maxlength_p_rr_nbr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_rr_nbr)));
    avelength_p_rr_nbr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_rr_nbr)),h.p_rr_nbr<>(typeof(h.p_rr_nbr))'');
    populated_p_rr_box_pcnt := AVE(GROUP,IF(h.p_rr_box = (TYPEOF(h.p_rr_box))'',0,100));
    maxlength_p_rr_box := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_rr_box)));
    avelength_p_rr_box := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_rr_box)),h.p_rr_box<>(typeof(h.p_rr_box))'');
    populated_p_scndry_rng_pcnt := AVE(GROUP,IF(h.p_scndry_rng = (TYPEOF(h.p_scndry_rng))'',0,100));
    maxlength_p_scndry_rng := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_scndry_rng)));
    avelength_p_scndry_rng := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_scndry_rng)),h.p_scndry_rng<>(typeof(h.p_scndry_rng))'');
    populated_p_scndry_des_pcnt := AVE(GROUP,IF(h.p_scndry_des = (TYPEOF(h.p_scndry_des))'',0,100));
    maxlength_p_scndry_des := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_scndry_des)));
    avelength_p_scndry_des := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_scndry_des)),h.p_scndry_des<>(typeof(h.p_scndry_des))'');
    populated_p_city_pcnt := AVE(GROUP,IF(h.p_city = (TYPEOF(h.p_city))'',0,100));
    maxlength_p_city := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_city)));
    avelength_p_city := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_city)),h.p_city<>(typeof(h.p_city))'');
    populated_p_state_pcnt := AVE(GROUP,IF(h.p_state = (TYPEOF(h.p_state))'',0,100));
    maxlength_p_state := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_state)));
    avelength_p_state := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_state)),h.p_state<>(typeof(h.p_state))'');
    populated_p_zip5_pcnt := AVE(GROUP,IF(h.p_zip5 = (TYPEOF(h.p_zip5))'',0,100));
    maxlength_p_zip5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_zip5)));
    avelength_p_zip5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_zip5)),h.p_zip5<>(typeof(h.p_zip5))'');
    populated_p_zip4_pcnt := AVE(GROUP,IF(h.p_zip4 = (TYPEOF(h.p_zip4))'',0,100));
    maxlength_p_zip4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_zip4)));
    avelength_p_zip4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_zip4)),h.p_zip4<>(typeof(h.p_zip4))'');
    populated_p_cntry_cd_pcnt := AVE(GROUP,IF(h.p_cntry_cd = (TYPEOF(h.p_cntry_cd))'',0,100));
    maxlength_p_cntry_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cntry_cd)));
    avelength_p_cntry_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cntry_cd)),h.p_cntry_cd<>(typeof(h.p_cntry_cd))'');
    populated_p_cc_filler_pcnt := AVE(GROUP,IF(h.p_cc_filler = (TYPEOF(h.p_cc_filler))'',0,100));
    maxlength_p_cc_filler := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cc_filler)));
    avelength_p_cc_filler := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cc_filler)),h.p_cc_filler<>(typeof(h.p_cc_filler))'');
    populated_p_cc_pcnt := AVE(GROUP,IF(h.p_cc = (TYPEOF(h.p_cc))'',0,100));
    maxlength_p_cc := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cc)));
    avelength_p_cc := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_cc)),h.p_cc<>(typeof(h.p_cc))'');
    populated_p_county_pcnt := AVE(GROUP,IF(h.p_county = (TYPEOF(h.p_county))'',0,100));
    maxlength_p_county := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_county)));
    avelength_p_county := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_county)),h.p_county<>(typeof(h.p_county))'');
    populated_opt_out_cd_pcnt := AVE(GROUP,IF(h.opt_out_cd = (TYPEOF(h.opt_out_cd))'',0,100));
    maxlength_opt_out_cd := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.opt_out_cd)));
    avelength_opt_out_cd := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.opt_out_cd)),h.opt_out_cd<>(typeof(h.opt_out_cd))'');
    populated_asg_wgt_pcnt := AVE(GROUP,IF(h.asg_wgt = (TYPEOF(h.asg_wgt))'',0,100));
    maxlength_asg_wgt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.asg_wgt)));
    avelength_asg_wgt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.asg_wgt)),h.asg_wgt<>(typeof(h.asg_wgt))'');
    populated_asg_wgt_uom_pcnt := AVE(GROUP,IF(h.asg_wgt_uom = (TYPEOF(h.asg_wgt_uom))'',0,100));
    maxlength_asg_wgt_uom := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.asg_wgt_uom)));
    avelength_asg_wgt_uom := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.asg_wgt_uom)),h.asg_wgt_uom<>(typeof(h.asg_wgt_uom))'');
    populated_source_ctl_id_pcnt := AVE(GROUP,IF(h.source_ctl_id = (TYPEOF(h.source_ctl_id))'',0,100));
    maxlength_source_ctl_id := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.source_ctl_id)));
    avelength_source_ctl_id := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.source_ctl_id)),h.source_ctl_id<>(typeof(h.source_ctl_id))'');
    populated_raw_name_pcnt := AVE(GROUP,IF(h.raw_name = (TYPEOF(h.raw_name))'',0,100));
    maxlength_raw_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.raw_name)));
    avelength_raw_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.raw_name)),h.raw_name<>(typeof(h.raw_name))'');
    populated_branded_title_flag_pcnt := AVE(GROUP,IF(h.branded_title_flag = (TYPEOF(h.branded_title_flag))'',0,100));
    maxlength_branded_title_flag := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.branded_title_flag)));
    avelength_branded_title_flag := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.branded_title_flag)),h.branded_title_flag<>(typeof(h.branded_title_flag))'');
    populated_brand_code_1_pcnt := AVE(GROUP,IF(h.brand_code_1 = (TYPEOF(h.brand_code_1))'',0,100));
    maxlength_brand_code_1 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_1)));
    avelength_brand_code_1 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_1)),h.brand_code_1<>(typeof(h.brand_code_1))'');
    populated_brand_date_1_pcnt := AVE(GROUP,IF(h.brand_date_1 = (TYPEOF(h.brand_date_1))'',0,100));
    maxlength_brand_date_1 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_1)));
    avelength_brand_date_1 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_1)),h.brand_date_1<>(typeof(h.brand_date_1))'');
    populated_brand_state_1_pcnt := AVE(GROUP,IF(h.brand_state_1 = (TYPEOF(h.brand_state_1))'',0,100));
    maxlength_brand_state_1 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_1)));
    avelength_brand_state_1 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_1)),h.brand_state_1<>(typeof(h.brand_state_1))'');
    populated_brand_code_2_pcnt := AVE(GROUP,IF(h.brand_code_2 = (TYPEOF(h.brand_code_2))'',0,100));
    maxlength_brand_code_2 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_2)));
    avelength_brand_code_2 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_2)),h.brand_code_2<>(typeof(h.brand_code_2))'');
    populated_brand_date_2_pcnt := AVE(GROUP,IF(h.brand_date_2 = (TYPEOF(h.brand_date_2))'',0,100));
    maxlength_brand_date_2 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_2)));
    avelength_brand_date_2 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_2)),h.brand_date_2<>(typeof(h.brand_date_2))'');
    populated_brand_state_2_pcnt := AVE(GROUP,IF(h.brand_state_2 = (TYPEOF(h.brand_state_2))'',0,100));
    maxlength_brand_state_2 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_2)));
    avelength_brand_state_2 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_2)),h.brand_state_2<>(typeof(h.brand_state_2))'');
    populated_brand_code_3_pcnt := AVE(GROUP,IF(h.brand_code_3 = (TYPEOF(h.brand_code_3))'',0,100));
    maxlength_brand_code_3 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_3)));
    avelength_brand_code_3 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_3)),h.brand_code_3<>(typeof(h.brand_code_3))'');
    populated_brand_date_3_pcnt := AVE(GROUP,IF(h.brand_date_3 = (TYPEOF(h.brand_date_3))'',0,100));
    maxlength_brand_date_3 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_3)));
    avelength_brand_date_3 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_3)),h.brand_date_3<>(typeof(h.brand_date_3))'');
    populated_brand_state_3_pcnt := AVE(GROUP,IF(h.brand_state_3 = (TYPEOF(h.brand_state_3))'',0,100));
    maxlength_brand_state_3 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_3)));
    avelength_brand_state_3 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_3)),h.brand_state_3<>(typeof(h.brand_state_3))'');
    populated_brand_code_4_pcnt := AVE(GROUP,IF(h.brand_code_4 = (TYPEOF(h.brand_code_4))'',0,100));
    maxlength_brand_code_4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_4)));
    avelength_brand_code_4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_4)),h.brand_code_4<>(typeof(h.brand_code_4))'');
    populated_brand_date_4_pcnt := AVE(GROUP,IF(h.brand_date_4 = (TYPEOF(h.brand_date_4))'',0,100));
    maxlength_brand_date_4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_4)));
    avelength_brand_date_4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_4)),h.brand_date_4<>(typeof(h.brand_date_4))'');
    populated_brand_state_4_pcnt := AVE(GROUP,IF(h.brand_state_4 = (TYPEOF(h.brand_state_4))'',0,100));
    maxlength_brand_state_4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_4)));
    avelength_brand_state_4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_4)),h.brand_state_4<>(typeof(h.brand_state_4))'');
    populated_brand_code_5_pcnt := AVE(GROUP,IF(h.brand_code_5 = (TYPEOF(h.brand_code_5))'',0,100));
    maxlength_brand_code_5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_5)));
    avelength_brand_code_5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_code_5)),h.brand_code_5<>(typeof(h.brand_code_5))'');
    populated_brand_date_5_pcnt := AVE(GROUP,IF(h.brand_date_5 = (TYPEOF(h.brand_date_5))'',0,100));
    maxlength_brand_date_5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_5)));
    avelength_brand_date_5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_date_5)),h.brand_date_5<>(typeof(h.brand_date_5))'');
    populated_brand_state_5_pcnt := AVE(GROUP,IF(h.brand_state_5 = (TYPEOF(h.brand_state_5))'',0,100));
    maxlength_brand_state_5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_5)));
    avelength_brand_state_5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.brand_state_5)),h.brand_state_5<>(typeof(h.brand_state_5))'');
    populated_tod_flag_pcnt := AVE(GROUP,IF(h.tod_flag = (TYPEOF(h.tod_flag))'',0,100));
    maxlength_tod_flag := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.tod_flag)));
    avelength_tod_flag := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.tod_flag)),h.tod_flag<>(typeof(h.tod_flag))'');
    populated_model_class_code_pcnt := AVE(GROUP,IF(h.model_class_code = (TYPEOF(h.model_class_code))'',0,100));
    maxlength_model_class_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_class_code)));
    avelength_model_class_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_class_code)),h.model_class_code<>(typeof(h.model_class_code))'');
    populated_model_class_pcnt := AVE(GROUP,IF(h.model_class = (TYPEOF(h.model_class))'',0,100));
    maxlength_model_class := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_class)));
    avelength_model_class := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.model_class)),h.model_class<>(typeof(h.model_class))'');
    populated_min_door_count_pcnt := AVE(GROUP,IF(h.min_door_count = (TYPEOF(h.min_door_count))'',0,100));
    maxlength_min_door_count := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.min_door_count)));
    avelength_min_door_count := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.min_door_count)),h.min_door_count<>(typeof(h.min_door_count))'');
    populated_safety_type_pcnt := AVE(GROUP,IF(h.safety_type = (TYPEOF(h.safety_type))'',0,100));
    maxlength_safety_type := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.safety_type)));
    avelength_safety_type := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.safety_type)),h.safety_type<>(typeof(h.safety_type))'');
    populated_airbag_driver_pcnt := AVE(GROUP,IF(h.airbag_driver = (TYPEOF(h.airbag_driver))'',0,100));
    maxlength_airbag_driver := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_driver)));
    avelength_airbag_driver := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_driver)),h.airbag_driver<>(typeof(h.airbag_driver))'');
    populated_airbag_front_driver_side_pcnt := AVE(GROUP,IF(h.airbag_front_driver_side = (TYPEOF(h.airbag_front_driver_side))'',0,100));
    maxlength_airbag_front_driver_side := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_driver_side)));
    avelength_airbag_front_driver_side := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_driver_side)),h.airbag_front_driver_side<>(typeof(h.airbag_front_driver_side))'');
    ...
    maxlength_airbag_front_head_curtain := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_head_curtain)));
    avelength_airbag_front_head_curtain := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_head_curtain)),h.airbag_front_head_curtain<>(typeof(h.airbag_front_head_curtain))'');
    populated_airbag_front_pass_pcnt := AVE(GROUP,IF(h.airbag_front_pass = (TYPEOF(h.airbag_front_pass))'',0,100));
    maxlength_airbag_front_pass := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_pass)));
    avelength_airbag_front_pass := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_pass)),h.airbag_front_pass<>(typeof(h.airbag_front_pass))'');
    populated_airbag_front_pass_side_pcnt := AVE(GROUP,IF(h.airbag_front_pass_side = (TYPEOF(h.airbag_front_pass_side))'',0,100));
    maxlength_airbag_front_pass_side := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_pass_side)));
    avelength_airbag_front_pass_side := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbag_front_pass_side)),h.airbag_front_pass_side<>(typeof(h.airbag_front_pass_side))'');
    populated_airbags_pcnt := AVE(GROUP,IF(h.airbags = (TYPEOF(h.airbags))'',0,100));
    maxlength_airbags := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbags)));
    avelength_airbags := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.airbags)),h.airbags<>(typeof(h.airbags))'');
  END;
...
SALT36.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT36.StrType)le.append_process_date),TRIM((SALT36.StrType)le.append_state_origin),TRIM((SALT36.StrType)le.file_typ),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.vehicle_typ),TRIM((SALT36.StrType)le.model_yr),TRIM((SALT36.StrType)le.model_yr_ind),TRIM((SALT36.StrType)le.make),TRIM((SALT36.StrType)le.make_ind),TRIM((SALT36.StrType)le.series),TRIM((SALT36.StrType)le.series_ind),TRIM((SALT36.StrType)le.prime_color),TRIM((SALT36.StrType)le.second_color),TRIM((SALT36.StrType)le.body_style),TRIM((SALT36.StrType)le.body_style_ind),TRIM((SALT36.StrType)le.model),TRIM((SALT36.StrType)le.model_ind),TRIM((SALT36.StrType)le.weight),TRIM((SALT36.StrType)le.lengt),TRIM((SALT36.StrType)le.axle_cnt),TRIM((SALT36.StrType)le.plate_nbr),TRIM((SALT36.StrType)le.plate_state),TRIM((SALT36.StrType)le.prev_plate_nbr),TRIM((SALT36.StrType)le.prev_plate_state),TRIM((SALT36.StrType)le.plate_typ_cd),TRIM((SALT36.StrType)le.mstr_src_state),TRIM((SALT36.StrType)le.reg_decal_nbr),TRIM((SALT36.StrType)le.org_reg_dt),TRIM((SALT36.StrType)le.reg_renew_dt),TRIM((SALT36.StrType)le.reg_exp_dt),TRIM((SALT36.StrType)le.title_nbr),TRIM((SALT36.StrType)le.org_title_dt),TRIM((SALT36.StrType)le.title_trans_dt),TRIM((SALT36.StrType)le.name_typ_cd),TRIM((SALT36.StrType)le.owner_typ_cd),TRIM((SALT36.StrType)le.first_nm),TRIM((SALT36.StrType)le.middle_nm),TRIM((SALT36.StrType)le.last_nm),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.prof_suffix),TRIM((SALT36.StrType)le.ind_ssn),TRIM((SALT36.StrType)le.ind_dob),TRIM((SALT36.StrType)le.mail_range),TRIM((SALT36.StrType)le.m_pre_dir),TRIM((SALT36.StrType)le.m_street),TRIM((SALT36.StrType)le.m_suffix),TRIM((SALT36.StrType)le.m_post_dir),TRIM((SALT36.StrType)le.m_pob),TRIM((SALT36.StrType)le.m_rr_nbr),TRIM((SALT36.StrType)le.m_rr_box),TRIM((SALT36.StrType)le.m_scndry_rng),TRIM((SALT36.StrType)le.m_scndry_des),TRIM((SALT36.StrType)le.m_city),TRIM((SALT36.StrType)le.m_state),TRIM((SALT36.StrType)le.m_zip5),TRIM((SALT36.StrType)le.m_zip4),TRIM((SALT36.StrType)le.m_cntry_cd),TRIM((SALT36.StrType)le.m_cc_filler),TRIM((SALT36.StrType)le.m_cc),TRIM((SALT36.StrType)le.m_county),TRIM((SALT36.StrType)le.phys_range),TRIM((SALT36.StrType)le.p_pre_dir),TRIM((SALT36.StrType)le.p_street),TRIM((SALT36.StrType)le.p_suffix),TRIM((SALT36.StrType)le.p_post_dir),TRIM((SALT36.StrType)le.p_pob),TRIM((SALT36.StrType)le.p_rr_nbr),TRIM((SALT36.StrType)le.p_rr_box),TRIM((SALT36.StrType)le.p_scndry_rng),TRIM((SALT36.StrType)le.p_scndry_des),TRIM((SALT36.StrType)le.p_city),TRIM((SALT36.StrType)le.p_state),TRIM((SALT36.StrType)le.p_zip5),TRIM((SALT36.StrType)le.p_zip4),TRIM((SALT36.StrType)le.p_cntry_cd),TRIM((SALT36.StrType)le.p_cc_filler),TRIM((SALT36.StrType)le.p_cc),TRIM((SALT36.StrType)le.p_county),TRIM((SALT36.StrType)le.opt_out_cd),TRIM((SALT36.StrType)le.asg_wgt),TRIM((SALT36.StrType)le.asg_wgt_uom),TRIM((SALT36.StrType)le.source_ctl_id),TRIM((SALT36.StrType)le.raw_name),TRIM((SALT36.StrType)le.branded_title_flag),TRIM((SALT36.StrType)le.brand_code_1),TRIM((SALT36.StrType)le.brand_date_1),TRIM((SALT36.StrType)le.brand_state_1),TRIM((SALT36.StrType)le.brand_code_2),TRIM((SALT36.StrType)le.brand_date_2),TRIM((SALT36.StrType)le.brand_state_2),TRIM((SALT36.StrType)le.brand_code_3),TRIM((SALT36.StrType)le.brand_date_3),TRIM((SALT36.StrType)le.brand_state_3),TRIM((SALT36.StrType)le.brand_code_4),TRIM((SALT36.StrType)le.brand_date_4),TRIM((SALT36.StrType)le.brand_state_4),TRIM((SALT36.StrType)le.brand_code_5),TRIM((SALT36.StrType)le.brand_date_5),TRIM((SALT36.StrType)le.brand_state_5),TRIM((SALT36.StrType)le.tod_flag),TRIM((SALT36.StrType)le.model_class_code),TRIM((SALT36.StrType)le.model_class),TRIM((SALT36.StrType)le.min_door_count),TRIM((SALT36.StrType)le.safety_type),TRIM((SALT36.StrType)le.airbag_driver),TRIM((SALT36.StrType)le.airbag_front_driver_side),TRIM((SALT36.StrType)le.airbag_front_head_curtain),TRIM((SALT36.StrType)le.airbag_front_pass),TRIM((SALT36.StrType)le.airbag_front_pass_side),TRIM((SALT36.StrType)le.airbags)));
  SELF.FldNo := C;
END;
...
SALT36.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 110);
  SELF.FldNo2 := 1 + (C % 110);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT36.StrType)le.append_process_date),TRIM((SALT36.StrType)le.append_state_origin),TRIM((SALT36.StrType)le.file_typ),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.vehicle_typ),TRIM((SALT36.StrType)le.model_yr),TRIM((SALT36.StrType)le.model_yr_ind),TRIM((SALT36.StrType)le.make),TRIM((SALT36.StrType)le.make_ind),TRIM((SALT36.StrType)le.series),TRIM((SALT36.StrType)le.series_ind),TRIM((SALT36.StrType)le.prime_color),TRIM((SALT36.StrType)le.second_color),TRIM((SALT36.StrType)le.body_style),TRIM((SALT36.StrType)le.body_style_ind),TRIM((SALT36.StrType)le.model),TRIM((SALT36.StrType)le.model_ind),TRIM((SALT36.StrType)le.weight),TRIM((SALT36.StrType)le.lengt),TRIM((SALT36.StrType)le.axle_cnt),TRIM((SALT36.StrType)le.plate_nbr),TRIM((SALT36.StrType)le.plate_state),TRIM((SALT36.StrType)le.prev_plate_nbr),TRIM((SALT36.StrType)le.prev_plate_state),TRIM((SALT36.StrType)le.plate_typ_cd),TRIM((SALT36.StrType)le.mstr_src_state),TRIM((SALT36.StrType)le.reg_decal_nbr),TRIM((SALT36.StrType)le.org_reg_dt),TRIM((SALT36.StrType)le.reg_renew_dt),TRIM((SALT36.StrType)le.reg_exp_dt),TRIM((SALT36.StrType)le.title_nbr),TRIM((SALT36.StrType)le.org_title_dt),TRIM((SALT36.StrType)le.title_trans_dt),TRIM((SALT36.StrType)le.name_typ_cd),TRIM((SALT36.StrType)le.owner_typ_cd),TRIM((SALT36.StrType)le.first_nm),TRIM((SALT36.StrType)le.middle_nm),TRIM((SALT36.StrType)le.last_nm),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.prof_suffix),TRIM((SALT36.StrType)le.ind_ssn),TRIM((SALT36.StrType)le.ind_dob),TRIM((SALT36.StrType)le.mail_range),TRIM((SALT36.StrType)le.m_pre_dir),TRIM((SALT36.StrType)le.m_street),TRIM((SALT36.StrType)le.m_suffix),TRIM((SALT36.StrType)le.m_post_dir),TRIM((SALT36.StrType)le.m_pob),TRIM((SALT36.StrType)le.m_rr_nbr),TRIM((SALT36.StrType)le.m_rr_box),TRIM((SALT36.StrType)le.m_scndry_rng),TRIM((SALT36.StrType)le.m_scndry_des),TRIM((SALT36.StrType)le.m_city),TRIM((SALT36.StrType)le.m_state),TRIM((SALT36.StrType)le.m_zip5),TRIM((SALT36.StrType)le.m_zip4),TRIM((SALT36.StrType)le.m_cntry_cd),TRIM((SALT36.StrType)le.m_cc_filler),TRIM((SALT36.StrType)le.m_cc),TRIM((SALT36.StrType)le.m_county),TRIM((SALT36.StrType)le.phys_range),TRIM((SALT36.StrType)le.p_pre_dir),TRIM((SALT36.StrType)le.p_street),TRIM((SALT36.StrType)le.p_suffix),TRIM((SALT36.StrType)le.p_post_dir),TRIM((SALT36.StrType)le.p_pob),TRIM((SALT36.StrType)le.p_rr_nbr),TRIM((SALT36.StrType)le.p_rr_box),TRIM((SALT36.StrType)le.p_scndry_rng),TRIM((SALT36.StrType)le.p_scndry_des),TRIM((SALT36.StrType)le.p_city),TRIM((SALT36.StrType)le.p_state),TRIM((SALT36.StrType)le.p_zip5),TRIM((SALT36.StrType)le.p_zip4),TRIM((SALT36.StrType)le.p_cntry_cd),TRIM((SALT36.StrType)le.p_cc_filler),TRIM((SALT36.StrType)le.p_cc),TRIM((SALT36.StrType)le.p_county),TRIM((SALT36.StrType)le.opt_out_cd),TRIM((SALT36.StrType)le.asg_wgt),TRIM((SALT36.StrType)le.asg_wgt_uom),TRIM((SALT36.StrType)le.source_ctl_id),TRIM((SALT36.StrType)le.raw_name),TRIM((SALT36.StrType)le.branded_title_flag),TRIM((SALT36.StrType)le.brand_code_1),TRIM((SALT36.StrType)le.brand_date_1),TRIM((SALT36.StrType)le.brand_state_1),TRIM((SALT36.StrType)le.brand_code_2),TRIM((SALT36.StrType)le.brand_date_2),TRIM((SALT36.StrType)le.brand_state_2),TRIM((SALT36.StrType)le.brand_code_3),TRIM((SALT36.StrType)le.brand_date_3),TRIM((SALT36.StrType)le.brand_state_3),TRIM((SALT36.StrType)le.brand_code_4),TRIM((SALT36.StrType)le.brand_date_4),TRIM((SALT36.StrType)le.brand_state_4),TRIM((SALT36.StrType)le.brand_code_5),TRIM((SALT36.StrType)le.brand_date_5),TRIM((SALT36.StrType)le.brand_state_5),TRIM((SALT36.StrType)le.tod_flag),TRIM((SALT36.StrType)le.model_class_code),TRIM((SALT36.StrType)le.model_class),TRIM((SALT36.StrType)le.min_door_count),TRIM((SALT36.StrType)le.safety_type),TRIM((SALT36.StrType)le.airbag_driver),TRIM((SALT36.StrType)le.airbag_front_driver_side),TRIM((SALT36.StrType)le.airbag_front_head_curtain),TRIM((SALT36.StrType)le.airbag_front_pass),TRIM((SALT36.StrType)le.airbag_front_pass_side),TRIM((SALT36.StrType)le.airbags)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT36.StrType)le.append_process_date),TRIM((SALT36.StrType)le.append_state_origin),TRIM((SALT36.StrType)le.file_typ),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.vehicle_typ),TRIM((SALT36.StrType)le.model_yr),TRIM((SALT36.StrType)le.model_yr_ind),TRIM((SALT36.StrType)le.make),TRIM((SALT36.StrType)le.make_ind),TRIM((SALT36.StrType)le.series),TRIM((SALT36.StrType)le.series_ind),TRIM((SALT36.StrType)le.prime_color),TRIM((SALT36.StrType)le.second_color),TRIM((SALT36.StrType)le.body_style),TRIM((SALT36.StrType)le.body_style_ind),TRIM((SALT36.StrType)le.model),TRIM((SALT36.StrType)le.model_ind),TRIM((SALT36.StrType)le.weight),TRIM((SALT36.StrType)le.lengt),TRIM((SALT36.StrType)le.axle_cnt),TRIM((SALT36.StrType)le.plate_nbr),TRIM((SALT36.StrType)le.plate_state),TRIM((SALT36.StrType)le.prev_plate_nbr),TRIM((SALT36.StrType)le.prev_plate_state),TRIM((SALT36.StrType)le.plate_typ_cd),TRIM((SALT36.StrType)le.mstr_src_state),TRIM((SALT36.StrType)le.reg_decal_nbr),TRIM((SALT36.StrType)le.org_reg_dt),TRIM((SALT36.StrType)le.reg_renew_dt),TRIM((SALT36.StrType)le.reg_exp_dt),TRIM((SALT36.StrType)le.title_nbr),TRIM((SALT36.StrType)le.org_title_dt),TRIM((SALT36.StrType)le.title_trans_dt),TRIM((SALT36.StrType)le.name_typ_cd),TRIM((SALT36.StrType)le.owner_typ_cd),TRIM((SALT36.StrType)le.first_nm),TRIM((SALT36.StrType)le.middle_nm),TRIM((SALT36.StrType)le.last_nm),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.prof_suffix),TRIM((SALT36.StrType)le.ind_ssn),TRIM((SALT36.StrType)le.ind_dob),TRIM((SALT36.StrType)le.mail_range),TRIM((SALT36.StrType)le.m_pre_dir),TRIM((SALT36.StrType)le.m_street),TRIM((SALT36.StrType)le.m_suffix),TRIM((SALT36.StrType)le.m_post_dir),TRIM((SALT36.StrType)le.m_pob),TRIM((SALT36.StrType)le.m_rr_nbr),TRIM((SALT36.StrType)le.m_rr_box),TRIM((SALT36.StrType)le.m_scndry_rng),TRIM((SALT36.StrType)le.m_scndry_des),TRIM((SALT36.StrType)le.m_city),TRIM((SALT36.StrType)le.m_state),TRIM((SALT36.StrType)le.m_zip5),TRIM((SALT36.StrType)le.m_zip4),TRIM((SALT36.StrType)le.m_cntry_cd),TRIM((SALT36.StrType)le.m_cc_filler),TRIM((SALT36.StrType)le.m_cc),TRIM((SALT36.StrType)le.m_county),TRIM((SALT36.StrType)le.phys_range),TRIM((SALT36.StrType)le.p_pre_dir),TRIM((SALT36.StrType)le.p_street),TRIM((SALT36.StrType)le.p_suffix),TRIM((SALT36.StrType)le.p_post_dir),TRIM((SALT36.StrType)le.p_pob),TRIM((SALT36.StrType)le.p_rr_nbr),TRIM((SALT36.StrType)le.p_rr_box),TRIM((SALT36.StrType)le.p_scndry_rng),TRIM((SALT36.StrType)le.p_scndry_des),TRIM((SALT36.StrType)le.p_city),TRIM((SALT36.StrType)le.p_state),TRIM((SALT36.StrType)le.p_zip5),TRIM((SALT36.StrType)le.p_zip4),TRIM((SALT36.StrType)le.p_cntry_cd),TRIM((SALT36.StrType)le.p_cc_filler),TRIM((SALT36.StrType)le.p_cc),TRIM((SALT36.StrType)le.p_county),TRIM((SALT36.StrType)le.opt_out_cd),TRIM((SALT36.StrType)le.asg_wgt),TRIM((SALT36.StrType)le.asg_wgt_uom),TRIM((SALT36.StrType)le.source_ctl_id),TRIM((SALT36.StrType)le.raw_name),TRIM((SALT36.StrType)le.branded_title_flag),TRIM((SALT36.StrType)le.brand_code_1),TRIM((SALT36.StrType)le.brand_date_1),TRIM((SALT36.StrType)le.brand_state_1),TRIM((SALT36.StrType)le.brand_code_2),TRIM((SALT36.StrType)le.brand_date_2),TRIM((SALT36.StrType)le.brand_state_2),TRIM((SALT36.StrType)le.brand_code_3),TRIM((SALT36.StrType)le.brand_date_3),TRIM((SALT36.StrType)le.brand_state_3),TRIM((SALT36.StrType)le.brand_code_4),TRIM((SALT36.StrType)le.brand_date_4),TRIM((SALT36.StrType)le.brand_state_4),TRIM((SALT36.StrType)le.brand_code_5),TRIM((SALT36.StrType)le.brand_date_5),TRIM((SALT36.StrType)le.brand_state_5),TRIM((SALT36.StrType)le.tod_flag),TRIM((SALT36.StrType)le.model_class_code),TRIM((SALT36.StrType)le.model_class),TRIM((SALT36.StrType)le.min_door_count),TRIM((SALT36.StrType)le.safety_type),TRIM((SALT36.StrType)le.airbag_driver),TRIM((SALT36.StrType)le.airbag_front_driver_side),TRIM((SALT36.StrType)le.airbag_front_head_curtain),TRIM((SALT36.StrType)le.airbag_front_pass),TRIM((SALT36.StrType)le.airbag_front_pass_side),TRIM((SALT36.StrType)le.airbags)));
  END;
...
SHARED FldIds := DATASET([{1,'append_process_date'}
      ...
      ,{110,'airbags'}],SALT36.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Experian_Fields.InValid_append_process_date((SALT36.StrType)le.append_process_date),
    Experian_Fields.InValid_append_state_origin((SALT36.StrType)le.append_state_origin),
    Experian_Fields.InValid_file_typ((SALT36.StrType)le.file_typ),
    Experian_Fields.InValid_vin((SALT36.StrType)le.vin),
    Experian_Fields.InValid_vehicle_typ((SALT36.StrType)le.vehicle_typ),
    Experian_Fields.InValid_model_yr((SALT36.StrType)le.model_yr),
    Experian_Fields.InValid_model_yr_ind((SALT36.StrType)le.model_yr_ind),
    Experian_Fields.InValid_make((SALT36.StrType)le.make),
    Experian_Fields.InValid_make_ind((SALT36.StrType)le.make_ind),
    Experian_Fields.InValid_series((SALT36.StrType)le.series),
    Experian_Fields.InValid_series_ind((SALT36.StrType)le.series_ind),
    Experian_Fields.InValid_prime_color((SALT36.StrType)le.prime_color),
    Experian_Fields.InValid_second_color((SALT36.StrType)le.second_color),
    Experian_Fields.InValid_body_style((SALT36.StrType)le.body_style),
    Experian_Fields.InValid_body_style_ind((SALT36.StrType)le.body_style_ind),
    Experian_Fields.InValid_model((SALT36.StrType)le.model),
    Experian_Fields.InValid_model_ind((SALT36.StrType)le.model_ind),
    Experian_Fields.InValid_weight((SALT36.StrType)le.weight),
    Experian_Fields.InValid_lengt((SALT36.StrType)le.lengt),
    Experian_Fields.InValid_axle_cnt((SALT36.StrType)le.axle_cnt),
    Experian_Fields.InValid_plate_nbr((SALT36.StrType)le.plate_nbr),
    Experian_Fields.InValid_plate_state((SALT36.StrType)le.plate_state),
    Experian_Fields.InValid_prev_plate_nbr((SALT36.StrType)le.prev_plate_nbr),
    Experian_Fields.InValid_prev_plate_state((SALT36.StrType)le.prev_plate_state),
    Experian_Fields.InValid_plate_typ_cd((SALT36.StrType)le.plate_typ_cd),
    Experian_Fields.InValid_mstr_src_state((SALT36.StrType)le.mstr_src_state),
    Experian_Fields.InValid_reg_decal_nbr((SALT36.StrType)le.reg_decal_nbr),
    Experian_Fields.InValid_org_reg_dt((SALT36.StrType)le.org_reg_dt),
    Experian_Fields.InValid_reg_renew_dt((SALT36.StrType)le.reg_renew_dt),
    Experian_Fields.InValid_reg_exp_dt((SALT36.StrType)le.reg_exp_dt),
    Experian_Fields.InValid_title_nbr((SALT36.StrType)le.title_nbr),
    Experian_Fields.InValid_org_title_dt((SALT36.StrType)le.org_title_dt),
    Experian_Fields.InValid_title_trans_dt((SALT36.StrType)le.title_trans_dt),
    Experian_Fields.InValid_name_typ_cd((SALT36.StrType)le.name_typ_cd),
    Experian_Fields.InValid_owner_typ_cd((SALT36.StrType)le.owner_typ_cd),
    Experian_Fields.InValid_first_nm((SALT36.StrType)le.first_nm),
    Experian_Fields.InValid_middle_nm((SALT36.StrType)le.middle_nm),
    Experian_Fields.InValid_last_nm((SALT36.StrType)le.last_nm),
    Experian_Fields.InValid_name_suffix((SALT36.StrType)le.name_suffix),
    Experian_Fields.InValid_prof_suffix((SALT36.StrType)le.prof_suffix),
    Experian_Fields.InValid_ind_ssn((SALT36.StrType)le.ind_ssn),
    Experian_Fields.InValid_ind_dob((SALT36.StrType)le.ind_dob),
    Experian_Fields.InValid_mail_range((SALT36.StrType)le.mail_range),
    Experian_Fields.InValid_m_pre_dir((SALT36.StrType)le.m_pre_dir),
    Experian_Fields.InValid_m_street((SALT36.StrType)le.m_street),
    Experian_Fields.InValid_m_suffix((SALT36.StrType)le.m_suffix),
    Experian_Fields.InValid_m_post_dir((SALT36.StrType)le.m_post_dir),
    Experian_Fields.InValid_m_pob((SALT36.StrType)le.m_pob),
    Experian_Fields.InValid_m_rr_nbr((SALT36.StrType)le.m_rr_nbr),
    Experian_Fields.InValid_m_rr_box((SALT36.StrType)le.m_rr_box),
    Experian_Fields.InValid_m_scndry_rng((SALT36.StrType)le.m_scndry_rng),
    Experian_Fields.InValid_m_scndry_des((SALT36.StrType)le.m_scndry_des),
    Experian_Fields.InValid_m_city((SALT36.StrType)le.m_city),
    Experian_Fields.InValid_m_state((SALT36.StrType)le.m_state),
    Experian_Fields.InValid_m_zip5((SALT36.StrType)le.m_zip5),
    Experian_Fields.InValid_m_zip4((SALT36.StrType)le.m_zip4),
    Experian_Fields.InValid_m_cntry_cd((SALT36.StrType)le.m_cntry_cd),
    Experian_Fields.InValid_m_cc_filler((SALT36.StrType)le.m_cc_filler),
    Experian_Fields.InValid_m_cc((SALT36.StrType)le.m_cc),
    Experian_Fields.InValid_m_county((SALT36.StrType)le.m_county),
    Experian_Fields.InValid_phys_range((SALT36.StrType)le.phys_range),
    Experian_Fields.InValid_p_pre_dir((SALT36.StrType)le.p_pre_dir),
    Experian_Fields.InValid_p_street((SALT36.StrType)le.p_street),
    Experian_Fields.InValid_p_suffix((SALT36.StrType)le.p_suffix),
    Experian_Fields.InValid_p_post_dir((SALT36.StrType)le.p_post_dir),
    Experian_Fields.InValid_p_pob((SALT36.StrType)le.p_pob),
    Experian_Fields.InValid_p_rr_nbr((SALT36.StrType)le.p_rr_nbr),
    Experian_Fields.InValid_p_rr_box((SALT36.StrType)le.p_rr_box),
    Experian_Fields.InValid_p_scndry_rng((SALT36.StrType)le.p_scndry_rng),
    Experian_Fields.InValid_p_scndry_des((SALT36.StrType)le.p_scndry_des),
    Experian_Fields.InValid_p_city((SALT36.StrType)le.p_city),
    Experian_Fields.InValid_p_state((SALT36.StrType)le.p_state),
    Experian_Fields.InValid_p_zip5((SALT36.StrType)le.p_zip5),
    Experian_Fields.InValid_p_zip4((SALT36.StrType)le.p_zip4),
    Experian_Fields.InValid_p_cntry_cd((SALT36.StrType)le.p_cntry_cd),
    Experian_Fields.InValid_p_cc_filler((SALT36.StrType)le.p_cc_filler),
    Experian_Fields.InValid_p_cc((SALT36.StrType)le.p_cc),
    Experian_Fields.InValid_p_county((SALT36.StrType)le.p_county),
    Experian_Fields.InValid_opt_out_cd((SALT36.StrType)le.opt_out_cd),
    Experian_Fields.InValid_asg_wgt((SALT36.StrType)le.asg_wgt),
    Experian_Fields.InValid_asg_wgt_uom((SALT36.StrType)le.asg_wgt_uom),
    Experian_Fields.InValid_source_ctl_id((SALT36.StrType)le.source_ctl_id),
    Experian_Fields.InValid_raw_name((SALT36.StrType)le.raw_name),
    Experian_Fields.InValid_branded_title_flag((SALT36.StrType)le.branded_title_flag),
    Experian_Fields.InValid_brand_code_1((SALT36.StrType)le.brand_code_1),
    Experian_Fields.InValid_brand_date_1((SALT36.StrType)le.brand_date_1),
    Experian_Fields.InValid_brand_state_1((SALT36.StrType)le.brand_state_1),
    Experian_Fields.InValid_brand_code_2((SALT36.StrType)le.brand_code_2),
    Experian_Fields.InValid_brand_date_2((SALT36.StrType)le.brand_date_2),
    Experian_Fields.InValid_brand_state_2((SALT36.StrType)le.brand_state_2),
    Experian_Fields.InValid_brand_code_3((SALT36.StrType)le.brand_code_3),
    Experian_Fields.InValid_brand_date_3((SALT36.StrType)le.brand_date_3),
    Experian_Fields.InValid_brand_state_3((SALT36.StrType)le.brand_state_3),
    Experian_Fields.InValid_brand_code_4((SALT36.StrType)le.brand_code_4),
    Experian_Fields.InValid_brand_date_4((SALT36.StrType)le.brand_date_4),
    Experian_Fields.InValid_brand_state_4((SALT36.StrType)le.brand_state_4),
    Experian_Fields.InValid_brand_code_5((SALT36.StrType)le.brand_code_5),
    Experian_Fields.InValid_brand_date_5((SALT36.StrType)le.brand_date_5),
    Experian_Fields.InValid_brand_state_5((SALT36.StrType)le.brand_state_5),
    Experian_Fields.InValid_tod_flag((SALT36.StrType)le.tod_flag),
    Experian_Fields.InValid_model_class_code((SALT36.StrType)le.model_class_code),
    Experian_Fields.InValid_model_class((SALT36.StrType)le.model_class),
    Experian_Fields.InValid_min_door_count((SALT36.StrType)le.min_door_count),
    Experian_Fields.InValid_safety_type((SALT36.StrType)le.safety_type),
    Experian_Fields.InValid_airbag_driver((SALT36.StrType)le.airbag_driver),
    Experian_Fields.InValid_airbag_front_driver_side((SALT36.StrType)le.airbag_front_driver_side),
    Experian_Fields.InValid_airbag_front_head_curtain((SALT36.StrType)le.airbag_front_head_curtain),
    Experian_Fields.InValid_airbag_front_pass((SALT36.StrType)le.airbag_front_pass),
    Experian_Fields.InValid_airbag_front_pass_side((SALT36.StrType)le.airbag_front_pass_side),
    Experian_Fields.InValid_airbags((SALT36.StrType)le.airbags),
    0);
