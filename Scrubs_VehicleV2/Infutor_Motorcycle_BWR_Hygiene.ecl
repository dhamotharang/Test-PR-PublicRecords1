...
#workunit('name','Scrubs_VehicleV2.Infutor_Motorcycle_BWR_Hygiene - Hygiene & Stats - SALT V3.6.1');
IMPORT Scrubs_VehicleV2,SALT36;
// First create an instantiated hygiene module
  infile := Scrubs_VehicleV2.Infutor_Motorcycle_In_VehicleV2;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_VehicleV2.Infutor_Motorcycle_Hygiene(ip);
