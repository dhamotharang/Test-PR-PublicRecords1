...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Infutor_Motorcycle_Fields.InValid_iid((SALT36.StrType)le.iid),
    Infutor_Motorcycle_Fields.InValid_pid((SALT36.StrType)le.pid),
    Infutor_Motorcycle_Fields.InValid_vin((SALT36.StrType)le.vin),
    Infutor_Motorcycle_Fields.InValid_make((SALT36.StrType)le.make),
    Infutor_Motorcycle_Fields.InValid_model((SALT36.StrType)le.model),
    Infutor_Motorcycle_Fields.InValid_year((SALT36.StrType)le.year),
    Infutor_Motorcycle_Fields.InValid_class_code((SALT36.StrType)le.class_code),
    Infutor_Motorcycle_Fields.InValid_fuel_type_code((SALT36.StrType)le.fuel_type_code),
    Infutor_Motorcycle_Fields.InValid_mfg_code((SALT36.StrType)le.mfg_code),
    Infutor_Motorcycle_Fields.InValid_style_code((SALT36.StrType)le.style_code),
    Infutor_Motorcycle_Fields.InValid_mileagecd((SALT36.StrType)le.mileagecd),
    Infutor_Motorcycle_Fields.InValid_nbr_vehicles((SALT36.StrType)le.nbr_vehicles),
    Infutor_Motorcycle_Fields.InValid_idate((SALT36.StrType)le.idate),
    Infutor_Motorcycle_Fields.InValid_odate((SALT36.StrType)le.odate),
    Infutor_Motorcycle_Fields.InValid_fname((SALT36.StrType)le.fname),
    Infutor_Motorcycle_Fields.InValid_mi((SALT36.StrType)le.mi),
    Infutor_Motorcycle_Fields.InValid_lname((SALT36.StrType)le.lname),
    Infutor_Motorcycle_Fields.InValid_suffix((SALT36.StrType)le.suffix),
    Infutor_Motorcycle_Fields.InValid_gender((SALT36.StrType)le.gender),
    Infutor_Motorcycle_Fields.InValid_house((SALT36.StrType)le.house),
    Infutor_Motorcycle_Fields.InValid_predir((SALT36.StrType)le.predir),
    Infutor_Motorcycle_Fields.InValid_street((SALT36.StrType)le.street),
    Infutor_Motorcycle_Fields.InValid_strtype((SALT36.StrType)le.strtype),
    Infutor_Motorcycle_Fields.InValid_postdir((SALT36.StrType)le.postdir),
    Infutor_Motorcycle_Fields.InValid_apttype((SALT36.StrType)le.apttype),
    Infutor_Motorcycle_Fields.InValid_aptnbr((SALT36.StrType)le.aptnbr),
    Infutor_Motorcycle_Fields.InValid_city((SALT36.StrType)le.city),
    Infutor_Motorcycle_Fields.InValid_state((SALT36.StrType)le.state),
    Infutor_Motorcycle_Fields.InValid_zip((SALT36.StrType)le.zip),
    Infutor_Motorcycle_Fields.InValid_z4((SALT36.StrType)le.z4),
    Infutor_Motorcycle_Fields.InValid_dpc((SALT36.StrType)le.dpc),
    Infutor_Motorcycle_Fields.InValid_crte((SALT36.StrType)le.crte),
    Infutor_Motorcycle_Fields.InValid_cnty((SALT36.StrType)le.cnty),
    Infutor_Motorcycle_Fields.InValid_z4type((SALT36.StrType)le.z4type),
    Infutor_Motorcycle_Fields.InValid_dpv((SALT36.StrType)le.dpv),
    Infutor_Motorcycle_Fields.InValid_vacant((SALT36.StrType)le.vacant),
    Infutor_Motorcycle_Fields.InValid_phone((SALT36.StrType)le.phone),
    Infutor_Motorcycle_Fields.InValid_dnc((SALT36.StrType)le.dnc),
    Infutor_Motorcycle_Fields.InValid_internal1((SALT36.StrType)le.internal1),
    Infutor_Motorcycle_Fields.InValid_internal2((SALT36.StrType)le.internal2),
    Infutor_Motorcycle_Fields.InValid_internal3((SALT36.StrType)le.internal3),
    Infutor_Motorcycle_Fields.InValid_county((SALT36.StrType)le.county),
    Infutor_Motorcycle_Fields.InValid_msa((SALT36.StrType)le.msa),
    Infutor_Motorcycle_Fields.InValid_cbsa((SALT36.StrType)le.cbsa),
    Infutor_Motorcycle_Fields.InValid_ehi((SALT36.StrType)le.ehi),
    Infutor_Motorcycle_Fields.InValid_child((SALT36.StrType)le.child),
    Infutor_Motorcycle_Fields.InValid_homeowner((SALT36.StrType)le.homeowner),
    Infutor_Motorcycle_Fields.InValid_pctw((SALT36.StrType)le.pctw),
    Infutor_Motorcycle_Fields.InValid_pctb((SALT36.StrType)le.pctb),
    Infutor_Motorcycle_Fields.InValid_pcta((SALT36.StrType)le.pcta),
    Infutor_Motorcycle_Fields.InValid_pcth((SALT36.StrType)le.pcth),
    Infutor_Motorcycle_Fields.InValid_pctspe((SALT36.StrType)le.pctspe),
    Infutor_Motorcycle_Fields.InValid_pctsps((SALT36.StrType)le.pctsps),
    Infutor_Motorcycle_Fields.InValid_pctspa((SALT36.StrType)le.pctspa),
    Infutor_Motorcycle_Fields.InValid_mhv((SALT36.StrType)le.mhv),
    Infutor_Motorcycle_Fields.InValid_mor((SALT36.StrType)le.mor),
    Infutor_Motorcycle_Fields.InValid_pctoccw((SALT36.StrType)le.pctoccw),
    Infutor_Motorcycle_Fields.InValid_pctoccb((SALT36.StrType)le.pctoccb),
    Infutor_Motorcycle_Fields.InValid_pctocco((SALT36.StrType)le.pctocco),
    Infutor_Motorcycle_Fields.InValid_lor((SALT36.StrType)le.lor),
    Infutor_Motorcycle_Fields.InValid_sfdu((SALT36.StrType)le.sfdu),
    Infutor_Motorcycle_Fields.InValid_mfdu((SALT36.StrType)le.mfdu),
    Infutor_Motorcycle_Fields.InValid_processdate((SALT36.StrType)le.processdate),
    Infutor_Motorcycle_Fields.InValid_source_code((SALT36.StrType)le.source_code),
    Infutor_Motorcycle_Fields.InValid_state_origin((SALT36.StrType)le.state_origin),
    Infutor_Motorcycle_Fields.InValid_append_ownernametypeind((SALT36.StrType)le.append_ownernametypeind),
    Infutor_Motorcycle_Fields.InValid_fullname((SALT36.StrType)le.fullname),
    0);
