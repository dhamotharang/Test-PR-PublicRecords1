...
EXPORT FromNone(DATASET(Infutor_Motorcycle_Layout_VehicleV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.make_Invalid := Infutor_Motorcycle_Fields.InValid_make((SALT36.StrType)le.make);
    SELF.model_Invalid := Infutor_Motorcycle_Fields.InValid_model((SALT36.StrType)le.model);
    SELF.year_Invalid := Infutor_Motorcycle_Fields.InValid_year((SALT36.StrType)le.year);
    SELF.fuel_type_code_Invalid := Infutor_Motorcycle_Fields.InValid_fuel_type_code((SALT36.StrType)le.fuel_type_code);
    SELF.style_code_Invalid := Infutor_Motorcycle_Fields.InValid_style_code((SALT36.StrType)le.style_code);
    SELF.mileagecd_Invalid := Infutor_Motorcycle_Fields.InValid_mileagecd((SALT36.StrType)le.mileagecd);
    SELF.nbr_vehicles_Invalid := Infutor_Motorcycle_Fields.InValid_nbr_vehicles((SALT36.StrType)le.nbr_vehicles);
    SELF.idate_Invalid := Infutor_Motorcycle_Fields.InValid_idate((SALT36.StrType)le.idate);
    SELF.odate_Invalid := Infutor_Motorcycle_Fields.InValid_odate((SALT36.StrType)le.odate);
    SELF.fname_Invalid := Infutor_Motorcycle_Fields.InValid_fname((SALT36.StrType)le.fname);
    SELF.mi_Invalid := Infutor_Motorcycle_Fields.InValid_mi((SALT36.StrType)le.mi);
    SELF.lname_Invalid := Infutor_Motorcycle_Fields.InValid_lname((SALT36.StrType)le.lname);
    SELF.suffix_Invalid := Infutor_Motorcycle_Fields.InValid_suffix((SALT36.StrType)le.suffix);
    SELF.gender_Invalid := Infutor_Motorcycle_Fields.InValid_gender((SALT36.StrType)le.gender);
    SELF.house_Invalid := Infutor_Motorcycle_Fields.InValid_house((SALT36.StrType)le.house);
    SELF.predir_Invalid := Infutor_Motorcycle_Fields.InValid_predir((SALT36.StrType)le.predir);
    SELF.street_Invalid := Infutor_Motorcycle_Fields.InValid_street((SALT36.StrType)le.street);
    SELF.strtype_Invalid := Infutor_Motorcycle_Fields.InValid_strtype((SALT36.StrType)le.strtype);
    SELF.postdir_Invalid := Infutor_Motorcycle_Fields.InValid_postdir((SALT36.StrType)le.postdir);
    SELF.apttype_Invalid := Infutor_Motorcycle_Fields.InValid_apttype((SALT36.StrType)le.apttype);
    SELF.aptnbr_Invalid := Infutor_Motorcycle_Fields.InValid_aptnbr((SALT36.StrType)le.aptnbr);
    SELF.city_Invalid := Infutor_Motorcycle_Fields.InValid_city((SALT36.StrType)le.city);
    SELF.state_Invalid := Infutor_Motorcycle_Fields.InValid_state((SALT36.StrType)le.state);
    SELF.zip_Invalid := Infutor_Motorcycle_Fields.InValid_zip((SALT36.StrType)le.zip);
    SELF.z4_Invalid := Infutor_Motorcycle_Fields.InValid_z4((SALT36.StrType)le.z4);
    SELF.phone_Invalid := Infutor_Motorcycle_Fields.InValid_phone((SALT36.StrType)le.phone);
    SELF.internal1_Invalid := Infutor_Motorcycle_Fields.InValid_internal1((SALT36.StrType)le.internal1);
    SELF.county_Invalid := Infutor_Motorcycle_Fields.InValid_county((SALT36.StrType)le.county);
    SELF := le;
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT36.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Infutor_Motorcycle_Fields.InvalidMessage_county(1),Infutor_Motorcycle_Fields.InvalidMessage_county(2),Infutor_Motorcycle_Fields.InvalidMessage_county(3),'UNKNOWN');
