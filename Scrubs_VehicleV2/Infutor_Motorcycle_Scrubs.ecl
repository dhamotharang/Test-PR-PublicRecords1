IMPORT SALT311,STD;
EXPORT Infutor_Motorcycle_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(Infutor_Motorcycle_Layout_VehicleV2)
  ...
  END;
  EXPORT  Bitmap_Layout := RECORD(Infutor_Motorcycle_Layout_VehicleV2)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Infutor_Motorcycle_Layout_VehicleV2) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.make_Invalid := Infutor_Motorcycle_Fields.InValid_make((SALT311.StrType)le.make);
    SELF.model_Invalid := Infutor_Motorcycle_Fields.InValid_model((SALT311.StrType)le.model);
    SELF.year_Invalid := Infutor_Motorcycle_Fields.InValid_year((SALT311.StrType)le.year);
    SELF.fuel_type_code_Invalid := Infutor_Motorcycle_Fields.InValid_fuel_type_code((SALT311.StrType)le.fuel_type_code);
    SELF.style_code_Invalid := Infutor_Motorcycle_Fields.InValid_style_code((SALT311.StrType)le.style_code);
    SELF.mileagecd_Invalid := Infutor_Motorcycle_Fields.InValid_mileagecd((SALT311.StrType)le.mileagecd);
    SELF.nbr_vehicles_Invalid := Infutor_Motorcycle_Fields.InValid_nbr_vehicles((SALT311.StrType)le.nbr_vehicles);
    SELF.idate_Invalid := Infutor_Motorcycle_Fields.InValid_idate((SALT311.StrType)le.idate);
    SELF.odate_Invalid := Infutor_Motorcycle_Fields.InValid_odate((SALT311.StrType)le.odate);
    SELF.fname_Invalid := Infutor_Motorcycle_Fields.InValid_fname((SALT311.StrType)le.fname);
    SELF.mi_Invalid := Infutor_Motorcycle_Fields.InValid_mi((SALT311.StrType)le.mi);
    SELF.lname_Invalid := Infutor_Motorcycle_Fields.InValid_lname((SALT311.StrType)le.lname);
    SELF.suffix_Invalid := Infutor_Motorcycle_Fields.InValid_suffix((SALT311.StrType)le.suffix);
    SELF.gender_Invalid := Infutor_Motorcycle_Fields.InValid_gender((SALT311.StrType)le.gender);
    SELF.house_Invalid := Infutor_Motorcycle_Fields.InValid_house((SALT311.StrType)le.house);
    SELF.predir_Invalid := Infutor_Motorcycle_Fields.InValid_predir((SALT311.StrType)le.predir);
    SELF.street_Invalid := Infutor_Motorcycle_Fields.InValid_street((SALT311.StrType)le.street);
    SELF.strtype_Invalid := Infutor_Motorcycle_Fields.InValid_strtype((SALT311.StrType)le.strtype);
    SELF.postdir_Invalid := Infutor_Motorcycle_Fields.InValid_postdir((SALT311.StrType)le.postdir);
    SELF.apttype_Invalid := Infutor_Motorcycle_Fields.InValid_apttype((SALT311.StrType)le.apttype);
    SELF.aptnbr_Invalid := Infutor_Motorcycle_Fields.InValid_aptnbr((SALT311.StrType)le.aptnbr);
    SELF.city_Invalid := Infutor_Motorcycle_Fields.InValid_city((SALT311.StrType)le.city);
    SELF.state_Invalid := Infutor_Motorcycle_Fields.InValid_state((SALT311.StrType)le.state);
    SELF.zip_Invalid := Infutor_Motorcycle_Fields.InValid_zip((SALT311.StrType)le.zip);
    SELF.z4_Invalid := Infutor_Motorcycle_Fields.InValid_z4((SALT311.StrType)le.z4);
    SELF.phone_Invalid := Infutor_Motorcycle_Fields.InValid_phone((SALT311.StrType)le.phone);
    SELF.internal1_Invalid := Infutor_Motorcycle_Fields.InValid_internal1((SALT311.StrType)le.internal1);
    SELF.county_Invalid := Infutor_Motorcycle_Fields.InValid_county((SALT311.StrType)le.county);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Infutor_Motorcycle_Layout_VehicleV2);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Infutor_Motorcycle_Layout_VehicleV2);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h, BOOLEAN Glob = FALSE) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Infutor_Motorcycle_Fields.InvalidMessage_make(le.make_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_model(le.model_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_year(le.year_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_fuel_type_code(le.fuel_type_code_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_style_code(le.style_code_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_mileagecd(le.mileagecd_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_nbr_vehicles(le.nbr_vehicles_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_idate(le.idate_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_odate(le.odate_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_fname(le.fname_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_mi(le.mi_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_lname(le.lname_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_suffix(le.suffix_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_gender(le.gender_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_house(le.house_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_predir(le.predir_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_street(le.street_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_strtype(le.strtype_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_postdir(le.postdir_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_apttype(le.apttype_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_aptnbr(le.aptnbr_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_city(le.city_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_state(le.state_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_zip(le.zip_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_z4(le.z4_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_phone(le.phone_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_internal1(le.internal1_Invalid),Infutor_Motorcycle_Fields.InvalidMessage_county(le.county_Invalid),'UNKNOWN'));
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Infutor_Motorcycle_Layout_VehicleV2) prevDS = DATASET([], Infutor_Motorcycle_Layout_VehicleV2)):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Infutor_Motorcycle_Fields.InvalidMessage_make(1),Infutor_Motorcycle_Fields.InvalidMessage_make(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_model(1),Infutor_Motorcycle_Fields.InvalidMessage_model(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_year(1),Infutor_Motorcycle_Fields.InvalidMessage_year(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_fuel_type_code(1),Infutor_Motorcycle_Fields.InvalidMessage_fuel_type_code(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_style_code(1),Infutor_Motorcycle_Fields.InvalidMessage_style_code(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_mileagecd(1),Infutor_Motorcycle_Fields.InvalidMessage_mileagecd(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_nbr_vehicles(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_idate(1),Infutor_Motorcycle_Fields.InvalidMessage_idate(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_odate(1),Infutor_Motorcycle_Fields.InvalidMessage_odate(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_fname(1),Infutor_Motorcycle_Fields.InvalidMessage_fname(2),Infutor_Motorcycle_Fields.InvalidMessage_fname(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_mi(1),Infutor_Motorcycle_Fields.InvalidMessage_mi(2),Infutor_Motorcycle_Fields.InvalidMessage_mi(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_lname(1),Infutor_Motorcycle_Fields.InvalidMessage_lname(2),Infutor_Motorcycle_Fields.InvalidMessage_lname(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_suffix(1),Infutor_Motorcycle_Fields.InvalidMessage_suffix(2),Infutor_Motorcycle_Fields.InvalidMessage_suffix(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_gender(1),Infutor_Motorcycle_Fields.InvalidMessage_gender(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_house(1),Infutor_Motorcycle_Fields.InvalidMessage_house(2),Infutor_Motorcycle_Fields.InvalidMessage_house(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_predir(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_street(1),Infutor_Motorcycle_Fields.InvalidMessage_street(2),Infutor_Motorcycle_Fields.InvalidMessage_street(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_strtype(1),Infutor_Motorcycle_Fields.InvalidMessage_strtype(2),Infutor_Motorcycle_Fields.InvalidMessage_strtype(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_postdir(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_apttype(1),Infutor_Motorcycle_Fields.InvalidMessage_apttype(2),Infutor_Motorcycle_Fields.InvalidMessage_apttype(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_aptnbr(1),Infutor_Motorcycle_Fields.InvalidMessage_aptnbr(2),Infutor_Motorcycle_Fields.InvalidMessage_aptnbr(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_city(1),Infutor_Motorcycle_Fields.InvalidMessage_city(2),Infutor_Motorcycle_Fields.InvalidMessage_city(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_state(1),Infutor_Motorcycle_Fields.InvalidMessage_state(2),Infutor_Motorcycle_Fields.InvalidMessage_state(3)
          ,Infutor_Motorcycle_Fields.InvalidMessage_zip(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_z4(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_phone(1)
          ,Infutor_Motorcycle_Fields.InvalidMessage_internal1(1),Infutor_Motorcycle_Fields.InvalidMessage_internal1(2)
          ,Infutor_Motorcycle_Fields.InvalidMessage_county(1),Infutor_Motorcycle_Fields.InvalidMessage_county(2),Infutor_Motorcycle_Fields.InvalidMessage_county(3)
          ,'Fields with errors'
    ...
    mod_hygiene := Infutor_Motorcycle_hygiene(PROJECT(h, Infutor_Motorcycle_Layout_VehicleV2));
  ...
  // record count stats
    ...
    mod_Delta := Infutor_Motorcycle_Delta(prevDS, PROJECT(h, Infutor_Motorcycle_Layout_VehicleV2));
...
EXPORT StandardStats(DATASET(Infutor_Motorcycle_Layout_VehicleV2) inFile, BOOLEAN doErrorOverall = TRUE, BOOLEAN doErrorPerSrc = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_VehicleV2, Infutor_Motorcycle_Fields, 'RECORDOF(scrubsSummaryOverall)', 'state_origin');
