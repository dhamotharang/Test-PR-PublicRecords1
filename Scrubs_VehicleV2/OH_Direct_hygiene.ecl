...
EXPORT Summary(SALT36.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_categorycode := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.categorycode)));
    avelength_categorycode := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.categorycode)),h.categorycode<>(typeof(h.categorycode))'');
    ...
    maxlength_modelyr := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.modelyr)));
    avelength_modelyr := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.modelyr)),h.modelyr<>(typeof(h.modelyr))'');
    populated_titlenum_pcnt := AVE(GROUP,IF(h.titlenum = (TYPEOF(h.titlenum))'',0,100));
    maxlength_titlenum := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.titlenum)));
    avelength_titlenum := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.titlenum)),h.titlenum<>(typeof(h.titlenum))'');
    populated_ownercode_pcnt := AVE(GROUP,IF(h.ownercode = (TYPEOF(h.ownercode))'',0,100));
    maxlength_ownercode := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownercode)));
    avelength_ownercode := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownercode)),h.ownercode<>(typeof(h.ownercode))'');
    populated_grossweight_pcnt := AVE(GROUP,IF(h.grossweight = (TYPEOF(h.grossweight))'',0,100));
    maxlength_grossweight := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.grossweight)));
    avelength_grossweight := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.grossweight)),h.grossweight<>(typeof(h.grossweight))'');
    populated_ownername_pcnt := AVE(GROUP,IF(h.ownername = (TYPEOF(h.ownername))'',0,100));
    maxlength_ownername := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownername)));
    avelength_ownername := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownername)),h.ownername<>(typeof(h.ownername))'');
    populated_ownerstreetaddress_pcnt := AVE(GROUP,IF(h.ownerstreetaddress = (TYPEOF(h.ownerstreetaddress))'',0,100));
    maxlength_ownerstreetaddress := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerstreetaddress)));
    avelength_ownerstreetaddress := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerstreetaddress)),h.ownerstreetaddress<>(typeof(h.ownerstreetaddress))'');
    populated_ownercity_pcnt := AVE(GROUP,IF(h.ownercity = (TYPEOF(h.ownercity))'',0,100));
    maxlength_ownercity := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownercity)));
    avelength_ownercity := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownercity)),h.ownercity<>(typeof(h.ownercity))'');
    populated_ownerstate_pcnt := AVE(GROUP,IF(h.ownerstate = (TYPEOF(h.ownerstate))'',0,100));
    maxlength_ownerstate := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerstate)));
    avelength_ownerstate := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerstate)),h.ownerstate<>(typeof(h.ownerstate))'');
    populated_ownerzip_pcnt := AVE(GROUP,IF(h.ownerzip = (TYPEOF(h.ownerzip))'',0,100));
    maxlength_ownerzip := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerzip)));
    avelength_ownerzip := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ownerzip)),h.ownerzip<>(typeof(h.ownerzip))'');
    populated_countynumber_pcnt := AVE(GROUP,IF(h.countynumber = (TYPEOF(h.countynumber))'',0,100));
    maxlength_countynumber := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.countynumber)));
    avelength_countynumber := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.countynumber)),h.countynumber<>(typeof(h.countynumber))'');
    populated_vehiclepurchasedt_pcnt := AVE(GROUP,IF(h.vehiclepurchasedt = (TYPEOF(h.vehiclepurchasedt))'',0,100));
    maxlength_vehiclepurchasedt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehiclepurchasedt)));
    avelength_vehiclepurchasedt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehiclepurchasedt)),h.vehiclepurchasedt<>(typeof(h.vehiclepurchasedt))'');
    populated_vehicletaxweight_pcnt := AVE(GROUP,IF(h.vehicletaxweight = (TYPEOF(h.vehicletaxweight))'',0,100));
    maxlength_vehicletaxweight := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletaxweight)));
    avelength_vehicletaxweight := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletaxweight)),h.vehicletaxweight<>(typeof(h.vehicletaxweight))'');
    populated_vehicletaxcode_pcnt := AVE(GROUP,IF(h.vehicletaxcode = (TYPEOF(h.vehicletaxcode))'',0,100));
    maxlength_vehicletaxcode := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletaxcode)));
    avelength_vehicletaxcode := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletaxcode)),h.vehicletaxcode<>(typeof(h.vehicletaxcode))'');
    populated_vehicleunladdenweight_pcnt := AVE(GROUP,IF(h.vehicleunladdenweight = (TYPEOF(h.vehicleunladdenweight))'',0,100));
    maxlength_vehicleunladdenweight := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicleunladdenweight)));
    avelength_vehicleunladdenweight := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicleunladdenweight)),h.vehicleunladdenweight<>(typeof(h.vehicleunladdenweight))'');
    populated_additionalownername_pcnt := AVE(GROUP,IF(h.additionalownername = (TYPEOF(h.additionalownername))'',0,100));
    maxlength_additionalownername := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.additionalownername)));
    avelength_additionalownername := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.additionalownername)),h.additionalownername<>(typeof(h.additionalownername))'');
    populated_registrationissuedt_pcnt := AVE(GROUP,IF(h.registrationissuedt = (TYPEOF(h.registrationissuedt))'',0,100));
    maxlength_registrationissuedt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.registrationissuedt)));
    avelength_registrationissuedt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.registrationissuedt)),h.registrationissuedt<>(typeof(h.registrationissuedt))'');
    populated_vehiclemake_pcnt := AVE(GROUP,IF(h.vehiclemake = (TYPEOF(h.vehiclemake))'',0,100));
    maxlength_vehiclemake := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehiclemake)));
    avelength_vehiclemake := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehiclemake)),h.vehiclemake<>(typeof(h.vehiclemake))'');
    populated_vehicletype_pcnt := AVE(GROUP,IF(h.vehicletype = (TYPEOF(h.vehicletype))'',0,100));
    maxlength_vehicletype := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletype)));
    avelength_vehicletype := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicletype)),h.vehicletype<>(typeof(h.vehicletype))'');
    populated_vehicleexpdt_pcnt := AVE(GROUP,IF(h.vehicleexpdt = (TYPEOF(h.vehicleexpdt))'',0,100));
    maxlength_vehicleexpdt := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicleexpdt)));
    avelength_vehicleexpdt := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.vehicleexpdt)),h.vehicleexpdt<>(typeof(h.vehicleexpdt))'');
    populated_previousplatenum_pcnt := AVE(GROUP,IF(h.previousplatenum = (TYPEOF(h.previousplatenum))'',0,100));
    maxlength_previousplatenum := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.previousplatenum)));
    avelength_previousplatenum := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.previousplatenum)),h.previousplatenum<>(typeof(h.previousplatenum))'');
    populated_platenum_pcnt := AVE(GROUP,IF(h.platenum = (TYPEOF(h.platenum))'',0,100));
    maxlength_platenum := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.platenum)));
    avelength_platenum := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.platenum)),h.platenum<>(typeof(h.platenum))'');
    ...
    maxlength_append_addlownernametypeind := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_addlownernametypeind)));
    avelength_append_addlownernametypeind := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.append_addlownernametypeind)),h.append_addlownernametypeind<>(typeof(h.append_addlownernametypeind))'');
  END;
...
SALT36.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT36.StrType)le.categorycode),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.modelyr),TRIM((SALT36.StrType)le.titlenum),TRIM((SALT36.StrType)le.ownercode),TRIM((SALT36.StrType)le.grossweight),TRIM((SALT36.StrType)le.ownername),TRIM((SALT36.StrType)le.ownerstreetaddress),TRIM((SALT36.StrType)le.ownercity),TRIM((SALT36.StrType)le.ownerstate),TRIM((SALT36.StrType)le.ownerzip),TRIM((SALT36.StrType)le.countynumber),TRIM((SALT36.StrType)le.vehiclepurchasedt),TRIM((SALT36.StrType)le.vehicletaxweight),TRIM((SALT36.StrType)le.vehicletaxcode),TRIM((SALT36.StrType)le.vehicleunladdenweight),TRIM((SALT36.StrType)le.additionalownername),TRIM((SALT36.StrType)le.registrationissuedt),TRIM((SALT36.StrType)le.vehiclemake),TRIM((SALT36.StrType)le.vehicletype),TRIM((SALT36.StrType)le.vehicleexpdt),TRIM((SALT36.StrType)le.previousplatenum),TRIM((SALT36.StrType)le.platenum),TRIM((SALT36.StrType)le.processdate),TRIM((SALT36.StrType)le.source_code),TRIM((SALT36.StrType)le.state_origin),TRIM((SALT36.StrType)le.append_ownernametypeind),TRIM((SALT36.StrType)le.append_addlownernametypeind)));
  SELF.FldNo := C;
END;
...
SALT36.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 28);
  SELF.FldNo2 := 1 + (C % 28);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT36.StrType)le.categorycode),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.modelyr),TRIM((SALT36.StrType)le.titlenum),TRIM((SALT36.StrType)le.ownercode),TRIM((SALT36.StrType)le.grossweight),TRIM((SALT36.StrType)le.ownername),TRIM((SALT36.StrType)le.ownerstreetaddress),TRIM((SALT36.StrType)le.ownercity),TRIM((SALT36.StrType)le.ownerstate),TRIM((SALT36.StrType)le.ownerzip),TRIM((SALT36.StrType)le.countynumber),TRIM((SALT36.StrType)le.vehiclepurchasedt),TRIM((SALT36.StrType)le.vehicletaxweight),TRIM((SALT36.StrType)le.vehicletaxcode),TRIM((SALT36.StrType)le.vehicleunladdenweight),TRIM((SALT36.StrType)le.additionalownername),TRIM((SALT36.StrType)le.registrationissuedt),TRIM((SALT36.StrType)le.vehiclemake),TRIM((SALT36.StrType)le.vehicletype),TRIM((SALT36.StrType)le.vehicleexpdt),TRIM((SALT36.StrType)le.previousplatenum),TRIM((SALT36.StrType)le.platenum),TRIM((SALT36.StrType)le.processdate),TRIM((SALT36.StrType)le.source_code),TRIM((SALT36.StrType)le.state_origin),TRIM((SALT36.StrType)le.append_ownernametypeind),TRIM((SALT36.StrType)le.append_addlownernametypeind)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT36.StrType)le.categorycode),TRIM((SALT36.StrType)le.vin),TRIM((SALT36.StrType)le.modelyr),TRIM((SALT36.StrType)le.titlenum),TRIM((SALT36.StrType)le.ownercode),TRIM((SALT36.StrType)le.grossweight),TRIM((SALT36.StrType)le.ownername),TRIM((SALT36.StrType)le.ownerstreetaddress),TRIM((SALT36.StrType)le.ownercity),TRIM((SALT36.StrType)le.ownerstate),TRIM((SALT36.StrType)le.ownerzip),TRIM((SALT36.StrType)le.countynumber),TRIM((SALT36.StrType)le.vehiclepurchasedt),TRIM((SALT36.StrType)le.vehicletaxweight),TRIM((SALT36.StrType)le.vehicletaxcode),TRIM((SALT36.StrType)le.vehicleunladdenweight),TRIM((SALT36.StrType)le.additionalownername),TRIM((SALT36.StrType)le.registrationissuedt),TRIM((SALT36.StrType)le.vehiclemake),TRIM((SALT36.StrType)le.vehicletype),TRIM((SALT36.StrType)le.vehicleexpdt),TRIM((SALT36.StrType)le.previousplatenum),TRIM((SALT36.StrType)le.platenum),TRIM((SALT36.StrType)le.processdate),TRIM((SALT36.StrType)le.source_code),TRIM((SALT36.StrType)le.state_origin),TRIM((SALT36.StrType)le.append_ownernametypeind),TRIM((SALT36.StrType)le.append_addlownernametypeind)));
  END;
...
SHARED FldIds := DATASET([{1,'categorycode'}
      ...
      ,{28,'append_addlownernametypeind'}],SALT36.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    OH_Direct_Fields.InValid_categorycode((SALT36.StrType)le.categorycode),
    OH_Direct_Fields.InValid_vin((SALT36.StrType)le.vin),
    OH_Direct_Fields.InValid_modelyr((SALT36.StrType)le.modelyr),
    OH_Direct_Fields.InValid_titlenum((SALT36.StrType)le.titlenum),
    OH_Direct_Fields.InValid_ownercode((SALT36.StrType)le.ownercode),
    OH_Direct_Fields.InValid_grossweight((SALT36.StrType)le.grossweight),
    OH_Direct_Fields.InValid_ownername((SALT36.StrType)le.ownername),
    OH_Direct_Fields.InValid_ownerstreetaddress((SALT36.StrType)le.ownerstreetaddress),
    OH_Direct_Fields.InValid_ownercity((SALT36.StrType)le.ownercity),
    OH_Direct_Fields.InValid_ownerstate((SALT36.StrType)le.ownerstate),
    OH_Direct_Fields.InValid_ownerzip((SALT36.StrType)le.ownerzip),
    OH_Direct_Fields.InValid_countynumber((SALT36.StrType)le.countynumber),
    OH_Direct_Fields.InValid_vehiclepurchasedt((SALT36.StrType)le.vehiclepurchasedt),
    OH_Direct_Fields.InValid_vehicletaxweight((SALT36.StrType)le.vehicletaxweight),
    OH_Direct_Fields.InValid_vehicletaxcode((SALT36.StrType)le.vehicletaxcode),
    OH_Direct_Fields.InValid_vehicleunladdenweight((SALT36.StrType)le.vehicleunladdenweight),
    OH_Direct_Fields.InValid_additionalownername((SALT36.StrType)le.additionalownername),
    OH_Direct_Fields.InValid_registrationissuedt((SALT36.StrType)le.registrationissuedt),
    OH_Direct_Fields.InValid_vehiclemake((SALT36.StrType)le.vehiclemake),
    OH_Direct_Fields.InValid_vehicletype((SALT36.StrType)le.vehicletype),
    OH_Direct_Fields.InValid_vehicleexpdt((SALT36.StrType)le.vehicleexpdt),
    OH_Direct_Fields.InValid_previousplatenum((SALT36.StrType)le.previousplatenum),
    OH_Direct_Fields.InValid_platenum((SALT36.StrType)le.platenum),
    OH_Direct_Fields.InValid_processdate((SALT36.StrType)le.processdate),
    OH_Direct_Fields.InValid_source_code((SALT36.StrType)le.source_code),
    OH_Direct_Fields.InValid_state_origin((SALT36.StrType)le.state_origin),
    OH_Direct_Fields.InValid_append_ownernametypeind((SALT36.StrType)le.append_ownernametypeind),
    OH_Direct_Fields.InValid_append_addlownernametypeind((SALT36.StrType)le.append_addlownernametypeind),
    0);
