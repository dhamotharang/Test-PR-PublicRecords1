...
EXPORT MakeFT_invalid_weight(SALT36.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_weight(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 6 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_weight(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('0123456789'),SALT36.HygieneErrors.NotLength('6,0'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alpha(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringtouppercase(s0); // Force to upper case
  s2 := SALT36.stringfilter(s1,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789~@&\'"`$*-_? <>{}[]^=!+,.;:/#()\\|'); // Only allow valid symbols
  s3 := SALT36.stringcleanspaces( SALT36.stringsubstituteout(s2,' <>{}[]^=!+,.;:/#()\\|',' ') ); // Insert spaces but avoid doubles
  RETURN  s3;
END;
EXPORT InValidFT_invalid_alpha(SALT36.StrType s) := WHICH(SALT36.stringtouppercase(s)<>s,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789~@&\'"`$*-_? <>{}[]^=!+,.;:/#()\\|'))));
EXPORT InValidMessageFT_invalid_alpha(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotCaps,SALT36.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789~@&\'"`$*-_? <>{}[]^=!+,.;:/#()\\|'),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_categorycode(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_categorycode(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['BU','PC','NC','NT','MC','TK','HV','TL','MH','FM','RV','','MP',''],~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_categorycode(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('BU|PC|NC|NT|MC|TK|HV|TL|MH|FM|RV||MP|'),SALT36.HygieneErrors.NotLength('2,0'),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_vin(SALT36.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_vin(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))));
EXPORT InValidMessageFT_invalid_vin(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_titlenum(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_titlenum(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))));
EXPORT InValidMessageFT_invalid_titlenum(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ownercode(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ownercode(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['S','Y','L'],~(LENGTH(TRIM(s)) = 1));
EXPORT InValidMessageFT_invalid_ownercode(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('S|Y|L'),SALT36.HygieneErrors.NotLength('1'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['OH',''],~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_state(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('OH|'),SALT36.HygieneErrors.NotLength('2,0'),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_countycode(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_countycode(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_countycode(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('0123456789'),SALT36.HygieneErrors.NotLength('2,0'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_vehicletaxcode(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_vehicletaxcode(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['0','2','D',''],~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_vehicletaxcode(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('0|2|D|'),SALT36.HygieneErrors.NotLength('1,0'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_vehiclemake(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_vehiclemake(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ '))));
EXPORT InValidMessageFT_invalid_vehiclemake(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_source_code(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_source_code(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['DI',''],~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_source_code(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('DI|'),SALT36.HygieneErrors.NotLength('2,0'),SALT36.HygieneErrors.Good);
...
EXPORT Make_modelyr(SALT36.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_modelyr(SALT36.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_modelyr(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
 
EXPORT Make_titlenum(SALT36.StrType s0) := MakeFT_invalid_titlenum(s0);
EXPORT InValid_titlenum(SALT36.StrType s) := InValidFT_invalid_titlenum(s);
EXPORT InValidMessage_titlenum(UNSIGNED1 wh) := InValidMessageFT_invalid_titlenum(wh);
 
EXPORT Make_ownercode(SALT36.StrType s0) := MakeFT_invalid_ownercode(s0);
EXPORT InValid_ownercode(SALT36.StrType s) := InValidFT_invalid_ownercode(s);
EXPORT InValidMessage_ownercode(UNSIGNED1 wh) := InValidMessageFT_invalid_ownercode(wh);
 
EXPORT Make_grossweight(SALT36.StrType s0) := MakeFT_invalid_weight(s0);
EXPORT InValid_grossweight(SALT36.StrType s) := InValidFT_invalid_weight(s);
EXPORT InValidMessage_grossweight(UNSIGNED1 wh) := InValidMessageFT_invalid_weight(wh);
 
EXPORT Make_ownername(SALT36.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_ownername(SALT36.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_ownername(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_ownerstreetaddress(SALT36.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_ownerstreetaddress(SALT36.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_ownerstreetaddress(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_ownercity(SALT36.StrType s0) := MakeFT_invalid_only_alpha(s0);
EXPORT InValid_ownercity(SALT36.StrType s) := InValidFT_invalid_only_alpha(s);
EXPORT InValidMessage_ownercity(UNSIGNED1 wh) := InValidMessageFT_invalid_only_alpha(wh);
 
EXPORT Make_ownerstate(SALT36.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_ownerstate(SALT36.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_ownerstate(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
 
EXPORT Make_ownerzip(SALT36.StrType s0) := MakeFT_invalid_zip(s0);
EXPORT InValid_ownerzip(SALT36.StrType s) := InValidFT_invalid_zip(s);
EXPORT InValidMessage_ownerzip(UNSIGNED1 wh) := InValidMessageFT_invalid_zip(wh);
 
EXPORT Make_countynumber(SALT36.StrType s0) := MakeFT_invalid_countycode(s0);
EXPORT InValid_countynumber(SALT36.StrType s) := InValidFT_invalid_countycode(s);
EXPORT InValidMessage_countynumber(UNSIGNED1 wh) := InValidMessageFT_invalid_countycode(wh);
 
EXPORT Make_vehiclepurchasedt(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_vehiclepurchasedt(SALT36.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_vehiclepurchasedt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_vehicletaxweight(SALT36.StrType s0) := MakeFT_invalid_weight(s0);
EXPORT InValid_vehicletaxweight(SALT36.StrType s) := InValidFT_invalid_weight(s);
EXPORT InValidMessage_vehicletaxweight(UNSIGNED1 wh) := InValidMessageFT_invalid_weight(wh);
 
EXPORT Make_vehicletaxcode(SALT36.StrType s0) := MakeFT_invalid_vehicletaxcode(s0);
EXPORT InValid_vehicletaxcode(SALT36.StrType s) := InValidFT_invalid_vehicletaxcode(s);
EXPORT InValidMessage_vehicletaxcode(UNSIGNED1 wh) := InValidMessageFT_invalid_vehicletaxcode(wh);
 
EXPORT Make_vehicleunladdenweight(SALT36.StrType s0) := MakeFT_invalid_weight(s0);
EXPORT InValid_vehicleunladdenweight(SALT36.StrType s) := InValidFT_invalid_weight(s);
EXPORT InValidMessage_vehicleunladdenweight(UNSIGNED1 wh) := InValidMessageFT_invalid_weight(wh);
 
EXPORT Make_additionalownername(SALT36.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_additionalownername(SALT36.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_additionalownername(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_registrationissuedt(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_registrationissuedt(SALT36.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_registrationissuedt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_vehiclemake(SALT36.StrType s0) := MakeFT_invalid_vehiclemake(s0);
EXPORT InValid_vehiclemake(SALT36.StrType s) := InValidFT_invalid_vehiclemake(s);
EXPORT InValidMessage_vehiclemake(UNSIGNED1 wh) := InValidMessageFT_invalid_vehiclemake(wh);
 
EXPORT Make_vehicletype(SALT36.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_vehicletype(SALT36.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_vehicletype(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_vehicleexpdt(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_vehicleexpdt(SALT36.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_vehicleexpdt(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_previousplatenum(SALT36.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_previousplatenum(SALT36.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_previousplatenum(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_platenum(SALT36.StrType s0) := MakeFT_invalid_alphanumeric(s0);
EXPORT InValid_platenum(SALT36.StrType s) := InValidFT_invalid_alphanumeric(s);
EXPORT InValidMessage_platenum(UNSIGNED1 wh) := InValidMessageFT_invalid_alphanumeric(wh);
 
EXPORT Make_processdate(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_processdate(SALT36.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_processdate(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_source_code(SALT36.StrType s0) := MakeFT_invalid_source_code(s0);
EXPORT InValid_source_code(SALT36.StrType s) := InValidFT_invalid_source_code(s);
EXPORT InValidMessage_source_code(UNSIGNED1 wh) := InValidMessageFT_invalid_source_code(wh);
 
EXPORT Make_state_origin(SALT36.StrType s0) := MakeFT_invalid_state(s0);
EXPORT InValid_state_origin(SALT36.StrType s) := InValidFT_invalid_state(s);
EXPORT InValidMessage_state_origin(UNSIGNED1 wh) := InValidMessageFT_invalid_state(wh);
 
EXPORT Make_append_ownernametypeind(SALT36.StrType s0) := MakeFT_invalid_append_ownernametypeind(s0);
EXPORT InValid_append_ownernametypeind(SALT36.StrType s) := InValidFT_invalid_append_ownernametypeind(s);
EXPORT InValidMessage_append_ownernametypeind(UNSIGNED1 wh) := InValidMessageFT_invalid_append_ownernametypeind(wh);
 
EXPORT Make_append_addlownernametypeind(SALT36.StrType s0) := MakeFT_invalid_append_ownernametypeind(s0);
EXPORT InValid_append_addlownernametypeind(SALT36.StrType s) := InValidFT_invalid_append_ownernametypeind(s);
