...
#workunit('name','Scrubs_Business_Credit.AH_BWR_Hygiene - Hygiene & Stats - SALT V3.1.3');
IMPORT Scrubs_Business_Credit,SALT31;
// First create an instantiated hygiene module
  infile := Scrubs_Business_Credit.AH_In_Business_Credit;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Business_Credit.AH_Hygiene(ip);
