...
FIELDTYPE:invalid_firstpymtduedate:ALLOW(0123456789):LENGTHS(8,6,4,0):CUSTOM(Scrubs.fn_valid_date>0)
FIELDTYPE:invalid_finalpymtduedate:ALLOW(0123456789):LENGTHS(8,6,4,0):CUSTOM(Scrubs.fn_valid_date>0)
