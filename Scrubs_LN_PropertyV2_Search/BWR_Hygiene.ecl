...
#workunit('name','Scrubs_LN_PropertyV2_Search.BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_LN_PropertyV2_Search,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_LN_PropertyV2_Search.In_LN_PropertyV2_Search;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_LN_PropertyV2_Search.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_LN_PropertyV2_Search'),NAMED('OptimizedLayout'));// File layout suggested by data
