...
*/
import  autokey, AutoKeyI,AutokeyB2,FraudShared;
...
FUNCTION
	...
	module(AutokeyB2.Fn_Build.params) 
		...
		export string														L_inkeyname							:= Platform.autokeytemplate()						;
		export string														L_inlogical							:= Keynames(pversion).autokeyroot.new			;
		export set of string1 									L_build_skip_set				:= Platform.autokey_buildskipset()			; 
	...
	AutoKeyB2.MAC_AcceptSK_to_QA(Platform.autokeytemplate(), moveToQA);
