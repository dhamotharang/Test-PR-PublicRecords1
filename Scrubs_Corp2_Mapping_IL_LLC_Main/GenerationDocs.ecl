...
Command line options: -MScrubs_Corp2_Mapping_IL_LLC_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR4AB8.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IL_LLC_Main
FILENAME:In_IL
...
FIELDTYPE:invalid_corp_key:ALLOW(-CL0123456789):LENGTHS(4..)
...
FIELDTYPE:invalid_type_cd:ENUM(01|06|P| )
FIELDTYPE:invalid_fed_tax_id:ALLOW( -0123456789)
...
FIELDTYPE:invalid_managed_ind:ENUM(0|1|2|3| )
...
FIELD:corp_fed_tax_id:TYPE(STRING32):LIKE(invalid_fed_tax_id):0,0
...
FIELD:corp_llc_managed_ind:TYPE(STRING1):LIKE(invalid_managed_ind):0,0
...
FIELD:cont_country:TYPE(STRING50):LIKE(invalid_alphablank):0,0
