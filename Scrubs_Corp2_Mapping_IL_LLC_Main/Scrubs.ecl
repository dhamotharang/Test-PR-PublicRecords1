...
// The module to handle the case where no scrubs exist
  EXPORT  Expanded_Layout := RECORD(corp2_mapping.layoutscommon.main)
    ...
    UNSIGNED1 corp_llc_managed_ind_Invalid;
...
EXPORT FromNone(DATASET(corp2_mapping.layoutscommon.main) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_llc_managed_ind_Invalid := Fields.InValid_corp_llc_managed_ind((SALT34.StrType)le.corp_llc_managed_ind);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_vendor_Invalid << 14 ) + ( le.corp_state_origin_Invalid << 15 ) + ( le.corp_process_date_Invalid << 16 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 18 ) + ( le.corp_legal_name_Invalid << 20 ) + ( le.corp_ln_name_type_cd_Invalid << 21 ) + ( le.corp_ln_name_type_desc_Invalid << 22 ) + ( le.corp_address1_type_cd_Invalid << 23 ) + ( le.corp_address1_type_desc_Invalid << 24 ) + ( le.corp_status_cd_Invalid << 25 ) + ( le.corp_status_desc_Invalid << 27 ) + ( le.corp_status_date_Invalid << 28 ) + ( le.corp_inc_state_Invalid << 30 ) + ( le.corp_inc_date_Invalid << 31 ) + ( le.corp_fed_tax_id_Invalid << 33 ) + ( le.corp_term_exist_cd_Invalid << 34 ) + ( le.corp_term_exist_exp_Invalid << 35 ) + ( le.corp_term_exist_desc_Invalid << 37 ) + ( le.corp_foreign_domestic_ind_Invalid << 38 ) + ( le.corp_forgn_state_cd_Invalid << 39 ) + ( le.corp_forgn_state_desc_Invalid << 40 ) + ( le.corp_forgn_date_Invalid << 41 ) + ( le.corp_for_profit_ind_Invalid << 43 ) + ( le.corp_orig_bus_type_cd_Invalid << 44 ) + ( le.corp_ra_effective_date_Invalid << 46 ) + ( le.corp_ra_address_type_cd_Invalid << 48 ) + ( le.corp_ra_address_type_desc_Invalid << 49 ) + ( le.cont_address_type_cd_Invalid << 50 ) + ( le.cont_address_type_desc_Invalid << 51 ) + ( le.corp_agent_county_Invalid << 52 ) + ( le.corp_country_of_formation_Invalid << 53 ) + ( le.corp_llc_managed_ind_Invalid << 54 ) + ( le.corp_merger_date_Invalid << 55 ) + ( le.corp_name_effective_date_Invalid << 57 ) + ( le.corp_name_status_date_Invalid << 59 ) + ( le.cont_country_Invalid << 61 ) + ( le.recordorigin_Invalid << 62 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_status_cd_Invalid := (le.ScrubsBits1 >> 25) & 3;
    ...
    SELF.corp_fed_tax_id_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.corp_term_exist_cd_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.corp_term_exist_exp_Invalid := (le.ScrubsBits1 >> 35) & 3;
    SELF.corp_term_exist_desc_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.corp_forgn_state_cd_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.corp_forgn_date_Invalid := (le.ScrubsBits1 >> 41) & 3;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.corp_orig_bus_type_cd_Invalid := (le.ScrubsBits1 >> 44) & 3;
    SELF.corp_ra_effective_date_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.corp_ra_address_type_cd_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.corp_ra_address_type_desc_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.cont_address_type_cd_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.cont_address_type_desc_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.corp_agent_county_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.corp_country_of_formation_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.corp_llc_managed_ind_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.corp_merger_date_Invalid := (le.ScrubsBits1 >> 55) & 3;
    SELF.corp_name_effective_date_Invalid := (le.ScrubsBits1 >> 57) & 3;
    SELF.corp_name_status_date_Invalid := (le.ScrubsBits1 >> 59) & 3;
    SELF.cont_country_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.recordorigin_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_key','corp_vendor','corp_state_origin','corp_process_date','corp_orig_sos_charter_nbr','corp_legal_name','corp_ln_name_type_cd','corp_ln_name_type_desc','corp_address1_type_cd','corp_address1_type_desc','corp_status_cd','corp_status_desc','corp_status_date','corp_inc_state','corp_inc_date','corp_fed_tax_id','corp_term_exist_cd','corp_term_exist_exp','corp_term_exist_desc','corp_foreign_domestic_ind','corp_forgn_state_cd','corp_forgn_state_desc','corp_forgn_date','corp_for_profit_ind','corp_orig_bus_type_cd','corp_ra_effective_date','corp_ra_address_type_cd','corp_ra_address_type_desc','cont_address_type_cd','cont_address_type_desc','corp_agent_county','corp_country_of_formation','corp_llc_managed_ind','corp_merger_date','corp_name_effective_date','corp_name_status_date','cont_country','recordorigin','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_mandatory','invalid_type_cd','invalid_alphablank','invalid_address_type_cd','invalid_address_type_desc','invalid_numblank','invalid_alphablank','invalid_date','invalid_state_origin','invalid_date','invalid_fed_tax_id','invalid_term_exist_cd','invalid_future_date','invalid_term_exist_desc','invalid_for_dom_ind','invalid_alphablank','invalid_alphablank','invalid_date','invalid_for_profit_ind','invalid_numblank','invalid_future_date','invalid_address_type_cd','invalid_address_type_desc','invalid_address_type_cd','invalid_address_type_desc','invalid_alphablankperiod','invalid_alphablank','invalid_managed_ind','invalid_date','invalid_future_date','invalid_future_date','invalid_alphablank','invalid_recordorigin','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.dt_first_seen,(SALT34.StrType)le.dt_last_seen,(SALT34.StrType)le.corp_ra_dt_first_seen,(SALT34.StrType)le.corp_ra_dt_last_seen,(SALT34.StrType)le.corp_key,(SALT34.StrType)le.corp_vendor,(SALT34.StrType)le.corp_state_origin,(SALT34.StrType)le.corp_process_date,(SALT34.StrType)le.corp_orig_sos_charter_nbr,(SALT34.StrType)le.corp_legal_name,(SALT34.StrType)le.corp_ln_name_type_cd,(SALT34.StrType)le.corp_ln_name_type_desc,(SALT34.StrType)le.corp_address1_type_cd,(SALT34.StrType)le.corp_address1_type_desc,(SALT34.StrType)le.corp_status_cd,(SALT34.StrType)le.corp_status_desc,(SALT34.StrType)le.corp_status_date,(SALT34.StrType)le.corp_inc_state,(SALT34.StrType)le.corp_inc_date,(SALT34.StrType)le.corp_fed_tax_id,(SALT34.StrType)le.corp_term_exist_cd,(SALT34.StrType)le.corp_term_exist_exp,(SALT34.StrType)le.corp_term_exist_desc,(SALT34.StrType)le.corp_foreign_domestic_ind,(SALT34.StrType)le.corp_forgn_state_cd,(SALT34.StrType)le.corp_forgn_state_desc,(SALT34.StrType)le.corp_forgn_date,(SALT34.StrType)le.corp_for_profit_ind,(SALT34.StrType)le.corp_orig_bus_type_cd,(SALT34.StrType)le.corp_ra_effective_date,(SALT34.StrType)le.corp_ra_address_type_cd,(SALT34.StrType)le.corp_ra_address_type_desc,(SALT34.StrType)le.cont_address_type_cd,(SALT34.StrType)le.cont_address_type_desc,(SALT34.StrType)le.corp_agent_county,(SALT34.StrType)le.corp_country_of_formation,(SALT34.StrType)le.corp_llc_managed_ind,(SALT34.StrType)le.corp_merger_date,(SALT34.StrType)le.corp_name_effective_date,(SALT34.StrType)le.corp_name_status_date,(SALT34.StrType)le.cont_country,(SALT34.StrType)le.recordorigin,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_llc_managed_ind:invalid_managed_ind:ENUM'
          ...
          ,'cont_country:invalid_alphablank:ALLOW'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_llc_managed_ind(1)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_llc_managed_ind_ENUM_ErrorCount
