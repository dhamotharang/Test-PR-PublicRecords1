...
EXPORT MAC_PopulationStatistics(infile,Ref='',Input_file_date = '',Input_record_id = '',Input_record_type = '',Input_first_name = '',Input_middle_initial = '',Input_last_name = '',Input_full_name = '',Input_company_name = '',Input_address_line1 = '',Input_address_line2 = '',Input_city = '',Input_state = '',Input_zip = '',Input_country = '',Input_phone = '',Input_append_prepaddr1 = '',Input_append_prepaddr2 = '',Input_append_rawaid = '',Input_nametype = '',Input_business_indicator = '',Input_prim_range = '',Input_predir = '',Input_prim_name = '',Input_addr_suffix = '',Input_postdir = '',Input_unit_desig = '',Input_sec_range = '',Input_p_city_name = '',Input_v_city_name = '',Input_st = '',Input_zip5 = '',Input_zip6 = '',Input_zip4 = '',Input_cart = '',Input_cr_sort_sz = '',Input_lot = '',Input_lot_order = '',Input_dbpc = '',Input_chk_digit = '',Input_rec_type = '',Input_county = '',Input_geo_lat = '',Input_geo_long = '',Input_msa = '',Input_geo_blk = '',Input_geo_match = '',Input_err_stat = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_address_line1)='' )
      '' 
    #ELSE
        IF( le.Input_address_line1 = (TYPEOF(le.Input_address_line1))'','',':address_line1')
    #END
 
+    #IF( #TEXT(Input_address_line2)='' )
      '' 
    #ELSE
        IF( le.Input_address_line2 = (TYPEOF(le.Input_address_line2))'','',':address_line2')
    #END
...
+    #IF( #TEXT(Input_business_indicator)='' )
      '' 
    #ELSE
        IF( le.Input_business_indicator = (TYPEOF(le.Input_business_indicator))'','',':business_indicator')
    #END
...
+    #IF( #TEXT(Input_zip6)='' )
      '' 
    #ELSE
        IF( le.Input_zip6 = (TYPEOF(le.Input_zip6))'','',':zip6')
    #END
