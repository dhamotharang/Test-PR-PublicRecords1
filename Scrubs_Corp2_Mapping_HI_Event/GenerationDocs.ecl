...
Command line options: -MScrubs_Corp2_Mapping_HI_Event -eC:\Users\butlersx\AppData\Local\Temp\TFREA76.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_HI_Event
FILENAME:In_HI
...
FIELDTYPE:invalid_corp_key:ALLOW(-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(4..):CUSTOM(Scrubs_Corp2_Mapping_HI_Event.Functions.invalid_corp_key>0)
FIELDTYPE:invalid_charter_nbr:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..):CUSTOM(Scrubs_Corp2_Mapping_HI_Event.Functions.invalid_corp_sos_charter_nbr>0)
FIELDTYPE:invalid_corp_vendor:ENUM(15)
FIELDTYPE:invalid_state_origin:ENUM(HI)
FIELDTYPE:invalid_date_type_cd:ENUM(EFF)
FIELDTYPE:invalid_date_type_desc:ENUM(EFFECTIVE)
...
FIELD:event_filing_cd:TYPE(STRING8):LIKE(invalid_numeric):0,0
