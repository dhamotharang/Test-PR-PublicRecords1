...
IMPORT R, ut, Python;
EXPORT string Python_evaluate_expression_except_vals(set of string layout_string, Recordof(Kel_Shell_QA.Layouts.AC_Lay) data_row, set of string cond, set of integer def_vals):= embed(Python)
