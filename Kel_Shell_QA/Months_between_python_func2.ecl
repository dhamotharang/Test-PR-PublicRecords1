IMPORT R, ut, python3;
EXPORT string Months_between_python_func2(Recordof(Kel_Shell_QA.Layouts.AC_Lay) data_row,string cond, string def_par, set of string lay_set):= embed(python3)
import re
result =''
str_list = lay_set
