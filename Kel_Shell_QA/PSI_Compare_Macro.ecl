EXPORT PSI_Compare_Macro(logical_file_name, unique_field, new_input_file_records, old_input_file_records, new_Tag, old_Tag) := FUNCTIONMACRO
		...
		new_Distribution_report:=Kel_Shell_QA.Distribution_Module_call(unique_field, DS2, new_Tag);
		old_Distribution_report:=Kel_Shell_QA.Distribution_Module_call(unique_field, DS1, old_Tag);
