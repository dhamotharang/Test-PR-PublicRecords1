...
IMPORT SALT311;
EXPORT ReleaseRefresh_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'ReleaseRefresh';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FILENAME:BKMortgage\n'
    + 'NAMESCOPE:ReleaseRefresh\n'
    + '\n'
    + 'RIDFIELD:record_id:GENERATE\n'
    + 'INGESTFILE:release_update:NAMED(BKMortgage_Release.ReleaseRefresh_prep_ingest_file)\n'
    + '\n'
