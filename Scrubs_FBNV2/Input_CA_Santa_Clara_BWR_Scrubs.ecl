...
#workunit('name','Scrubs_FBNV2.Input_CA_Santa_Clara_BWR_Scrubs - Checking field validity in a file - SALT V3.11.4');
IMPORT Scrubs_FBNV2,SALT311;
infile := Scrubs_FBNV2.Input_CA_Santa_Clara_In_FBNV2;
mod_scrubs := Scrubs_FBNV2.Input_CA_Santa_Clara_Scrubs;
