IMPORT SALT38, _Control, Scrubs, Scrubs_FBNV2;

#OPTION('multiplePersistInstances',FALSE);
#WORKUNIT('name','Scrubs_FBNV2.BWR_Contact_Scrubs_Report');
/*******************************************************************************/
/*	datasetName:=<Dataset>                                                     */
/*	This assumes:                                                              */
...
EXPORT MAC_Scrubs_Report(BuildDate,myFolder,myFile)	:=	MACRO
	...
	scrubs_name := 'Base_Contact_Scrubs';
	scope_datasetName := 'FBNV2';
