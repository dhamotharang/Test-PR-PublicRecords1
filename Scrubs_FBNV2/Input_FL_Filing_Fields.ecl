...
EXPORT Make_fic_fil_name(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_fic_fil_name(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_fic_fil_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_fic_owner_name(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_fic_owner_name(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_fic_owner_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_fic_fil_date(SALT37.StrType s0) := MakeFT_invalid_general_date(s0);
EXPORT InValid_fic_fil_date(SALT37.StrType s) := InValidFT_invalid_general_date(s);
EXPORT InValidMessage_fic_fil_date(UNSIGNED1 wh) := InValidMessageFT_invalid_general_date(wh);
 
EXPORT Make_fic_fil_doc_num(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_fic_fil_doc_num(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_fic_fil_doc_num(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_fic_owner_doc_num(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_fic_owner_doc_num(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_fic_owner_doc_num(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_p_owner_name(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_p_owner_name(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_p_owner_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_c_owner_name(SALT37.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_c_owner_name(SALT37.StrType s) := InValidFT_invalid_mandatory(s);
