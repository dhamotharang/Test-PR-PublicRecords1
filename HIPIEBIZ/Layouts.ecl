EXPORT Layouts := MODULE
    ...
    integer1 businessisnewbusinesshierarchy;
    ...
    string1 advoselehitflag;
    string1 advoselevacancyindicator;
    string1 advoselethrowbackindicator;
    string1 advoseleseasonaldeliveryindicator;
    string5 advoseleseasonalsuppressionstartdate;
    string5 advoseleseasonalsuppressionenddate;
    string1 advoseledonotdeliverindicator;
    string1 advoselecollegeindicator;
    string10 advoselecollegesuppressionstartdate;
    string10 advoselecollegesuppressionenddate;
    string1 advoseleaddressstyle;
    string5 advoselesimplifyaddresscount;
    string1 advoseledropindicator;
    string1 advoseleresidentialorbusinessindicator;
    string1 advoseleonlywaytogetmailindicator;
    string1 advoselerecordtypecode;
    string1 advoseleaddresstype;
    string1 advoseleaddressusagetype;
    string8 advoselefirstseendate;
    string8 advoselelastseendate;
    string8 advoselevendorfirstreporteddate;
    string8 advoselevendorlastreporteddate;
    string8 advoselevacationbegindate;
    string8 advoselevacationenddate;
    string8 advoselenumberofcurrentvacationmonths;
    string8 advoselemaxvacationmonths;
    string8 advoselevacationperiodscount;
    string1 advoproxhitflag;
    string1 advoproxvacancyindicator;
    string1 advoproxthrowbackindicator;
    string1 advoproxseasonaldeliveryindicator;
    string5 advoproxseasonalsuppressionstartdate;
    string5 advoproxseasonalsuppressionenddate;
    string1 advoproxdonotdeliverindicator;
    string1 advoproxcollegeindicator;
    string10 advoproxcollegesuppressionstartdate;
    string10 advoproxcollegesuppressionenddate;
    string1 advoproxaddressstyle;
    string5 advoproxsimplifyaddresscount;
    string1 advoproxdropindicator;
    string1 advoproxresidentialorbusinessindicator;
    string1 advoproxonlywaytogetmailindicator;
    string1 advoproxrecordtypecode;
    string1 advoproxaddresstype;
    string1 advoproxaddressusagetype;
    string8 advoproxfirstseendate;
    string8 advoproxlastseendate;
    string8 advoproxvendorfirstreporteddate;
    string8 advoproxvendorlastreporteddate;
    string8 advoproxvacationbegindate;
    string8 advoproxvacationenddate;
    string8 advoproxnumberofcurrentvacationmonths;
    string8 advoproxmaxvacationmonths;
    string8 advoproxvacationperiodscount;
    integer8 isnotvacantbusinessflag;
    integer8 ispoboxflag;
    integer8 ispoboxseleflag;
    integer8 ispoboxproxflag;
    string advoresidentialorbusinessindicatordescription;
    integer8 seleaddressflag;
    integer8 proxaddressflag;
    ...
    string bisbiplevel;
    integer8 selecorpprofitflag;
    integer8 proxcorpprofitflag;
    integer8 selecorpinactiveflag;
    integer8 proxcorpinactiveflag;
    ...
    string person_name;
    string focuslistcleanedaddress;
    string business_type;
    string focus_entry_type;
    string focus_entry_category;
    string focus_entry_sub_category;
    string focus_effective_date;
    string focus_expiration_date;
    string focus_entry_note;
    string10 focuslistlatitude;
    string11 focuslistlongitude;
    integer8 oncustomerfocuslistflag;
  END;
 	
  EXPORT OfficerFileLayout := RECORD
    string customer_account;
    string fein;
    string ssn;
    string suffix;
    ...
    string bestproxsicdescription;
    unsigned6 bizrecid;
    string reportedofficerrawname;
    string reportedofficerrawssn;
    string reportedofficerlexid;
    string reportedofficerfirstname;
    string reportedofficermiddlename;
    string reportedofficerlastname;
    string reportedofficernamesuffix;
    string reportedofficerssn;
    string reportedofficerdob;
    string reportedofficerdod;
    string reportedofficeraddress;
    string reportedofficercity;
    string reportedofficerstate;
    string reportedofficerzip;
    string reportedofficerzip4;
    string reportedofficeraddressdate;
    string reportedofficerlexidscore;
    string reportedofficerssnscore;
    string reportedofficernamescore;
    string10 reportedofficercleanprimaryrange;
    string2 reportedofficercleanpredirectional;
    string28 reportedofficercleanprimaryname;
    string4 reportedofficercleanaddresssuffix;
    string2 reportedofficercleanpostdirectional;
    string10 reportedofficercleanunitdesignation;
    string8 reportedofficercleansecondaryrange;
    string25 reportedofficercleanpostalcity;
    string25 reportedofficercleanvanitycity;
    string2 reportedofficercleanstate;
    string5 reportedofficercleanzip;
    string4 reportedofficercleanzip4;
    string2 reportedofficercleandbpc;
    string1 reportedofficercleancheckdigit;
    string2 reportedofficercleanrecordtype;
    string5 reportedofficercleancounty;
    string10 reportedofficercleanlatitude;
    string11 reportedofficercleanlongitude;
    string4 reportedofficercleanmsa;
    string7 reportedofficercleangeoblock;
    string1 reportedofficercleangeomatchcode;
    string4 reportedofficercleanerrorstatus;
    boolean reportedofficercleancachehit;
    boolean reportedofficercleancleanerhit;
    string reportedofficercleancleanedaddress;
    string reportedofficercleaninputaddress;
    boolean reportedofficercleannoaddressinput;
    boolean reportedofficercleannoaddresscleanererror;
    string reportedofficercleanerrorcodedescription;
    string reportedofficerentitycontextuid;
    string reportedofficernameconcatenated;
    integer8 reportedofficerhasgsaflag;
  END;
  
  EXPORT rOfficers := RECORD
    OfficerFileLayout;
    STRING100 OfficerFirstName; 
    STRING20 OfficerMiddleName; 
    STRING100 OfficerLastName; 
    STRING10 OfficerNameSuffix; 
  END;
  
	EXPORT BusinessInput := RECORD
		INTEGER seq := 0;
		STRING BusinessName			 := '';
	...
	EXPORT SearchInput := RECORD
		INTEGER seq := 0;
		BusinessInput AND NOT [seq];	
		OfficerInput AND NOT [seq];
    ...
    STRING10 OfficerNameSuffix := ''; 
    string reportedofficerentitycontextuid:='';
		INTEGER ShowNewBusinesses := 0;
    INTEGER SoapCallErrorCode := 0;
