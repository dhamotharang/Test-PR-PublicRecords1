...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_supp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_corp_status_cd','invalid_corp_standing','invalid_corp_term_exist_cd','invalid_corp_term_exist_desc','invalid_forgn_term_exist_cd','invalid_forgn_term_exist_desc','invalid_corp_orig_org_structure_cd','invalid_corp_orig_org_structure_desc','invalid_for_dom_ind','invalid_Y_N','invalid_recordorigin','invalid_corp_ra_address_type_cd','invalid_corp_ra_address_type_desc','invalid_alphablank','invalid_alphadashblank');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_supp_key' => 2,'invalid_charter_nbr' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_future_date' => 8,'invalid_ln_name_type_cd' => 9,'invalid_ln_name_type_desc' => 10,'invalid_corp_status_cd' => 11,'invalid_corp_standing' => 12,'invalid_corp_term_exist_cd' => 13,'invalid_corp_term_exist_desc' => 14,'invalid_forgn_term_exist_cd' => 15,'invalid_forgn_term_exist_desc' => 16,'invalid_corp_orig_org_structure_cd' => 17,'invalid_corp_orig_org_structure_desc' => 18,'invalid_for_dom_ind' => 19,'invalid_Y_N' => 20,'invalid_recordorigin' => 21,'invalid_corp_ra_address_type_cd' => 22,'invalid_corp_ra_address_type_desc' => 23,'invalid_alphablank' => 24,'invalid_alphadashblank' => 25,0);
...
EXPORT MakeFT_invalid_corp_supp_key(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' 0123456789-'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_supp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' 0123456789-'))));
EXPORT InValidMessageFT_invalid_corp_supp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' 0123456789-'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['45']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('45'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['SC']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('SC'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_status_cd(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_status_cd(s)>0);
EXPORT InValidMessageFT_invalid_corp_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_status_cd'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_term_exist_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['PERPETUAL','EXPIRATION DATE']);
EXPORT InValidMessageFT_invalid_corp_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('PERPETUAL|EXPIRATION DATE'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_forgn_term_exist_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_term_exist_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D',' ']);
EXPORT InValidMessageFT_invalid_forgn_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_forgn_term_exist_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_forgn_term_exist_desc(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['EXPIRATION DATE',' ']);
EXPORT InValidMessageFT_invalid_forgn_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('EXPIRATION DATE| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_orig_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_orig_org_structure_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_corp_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_orig_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_orig_org_structure_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_corp_orig_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_desc'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_supp_key(SALT34.StrType s0) := MakeFT_invalid_corp_supp_key(s0);
EXPORT InValid_corp_supp_key(SALT34.StrType s) := InValidFT_invalid_corp_supp_key(s);
...
EXPORT Make_corp_forgn_term_exist_cd(SALT34.StrType s0) := MakeFT_invalid_forgn_term_exist_cd(s0);
EXPORT InValid_corp_forgn_term_exist_cd(SALT34.StrType s) := InValidFT_invalid_forgn_term_exist_cd(s);
EXPORT InValidMessage_corp_forgn_term_exist_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_term_exist_cd(wh);
...
EXPORT Make_corp_forgn_term_exist_desc(SALT34.StrType s0) := MakeFT_invalid_forgn_term_exist_desc(s0);
EXPORT InValid_corp_forgn_term_exist_desc(SALT34.StrType s) := InValidFT_invalid_forgn_term_exist_desc(s);
EXPORT InValidMessage_corp_forgn_term_exist_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_forgn_term_exist_desc(wh);
...
EXPORT Make_corp_additonal_info(SALT34.StrType s0) := s0;
EXPORT InValid_corp_additonal_info(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_naics_code(SALT34.StrType s0) := s0;
EXPORT InValid_corp_naics_code(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_number_of_ammendments(SALT34.StrType s0) := s0;
EXPORT InValid_corp_number_of_ammendments(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_percentage_voters_required_to_approve_ammendments(SALT34.StrType s0) := s0;
EXPORT InValid_corp_percentage_voters_required_to_approve_ammendments(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_terminiation_date(SALT34.StrType s0) := s0;
EXPORT InValid_corp_terminiation_date(SALT34.StrType s) := FALSE;
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_SC_Main;
