...
Command line options: -MScrubs_Corp2_Mapping_SC_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR82AA.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_SC_Main
FILENAME:In_SC
...
FIELDTYPE:invalid_corp_vendor:ENUM(45)
FIELDTYPE:invalid_state_origin:ENUM(SC)
...
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_corp_status_cd:CUSTOM(Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_status_cd>0)
FIELDTYPE:invalid_corp_standing:ENUM(Y| )
FIELDTYPE:invalid_corp_term_exist_cd:ENUM(D|P| )
FIELDTYPE:invalid_corp_term_exist_desc:ENUM(PERPETUAL|EXPIRATION DATE)
FIELDTYPE:invalid_forgn_term_exist_cd:ENUM(D| )
FIELDTYPE:invalid_forgn_term_exist_desc:ENUM(EXPIRATION DATE| )
FIELDTYPE:invalid_corp_orig_org_structure_cd:CUSTOM(Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_cd>0,recordorigin)
FIELDTYPE:invalid_corp_orig_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_SC_Main.Functions.invalid_corp_orig_org_structure_desc>0,recordorigin)
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_Y_N:ENUM(Y|N| )
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_corp_ra_address_type_cd:ENUM(R| )
FIELDTYPE:invalid_corp_ra_address_type_desc:ENUM(REGISTERED OFFICE| )
...
FIELD:corp_supp_key:TYPE(STRING30):LIKE(invalid_corp_supp_key):0,0
...
FIELD:corp_standing:TYPE(STRING1):LIKE(invalid_corp_standing):0,0
...
FIELD:corp_forgn_term_exist_cd:TYPE(STRING8):LIKE(invalid_forgn_term_exist_cd):0,0
FIELD:corp_forgn_term_exist_exp:TYPE(STRING8):LIKE(invalid_future_date):0,0
FIELD:corp_forgn_term_exist_desc:TYPE(STRING60):LIKE(invalid_forgn_term_exist_desc):0,0
...
FIELD:corp_ra_address_type_cd:TYPE(STRING8):LIKE(invalid_corp_ra_address_type_cd):0,0
FIELD:corp_ra_address_type_desc:TYPE(STRING60):LIKE(invalid_corp_ra_address_type_desc):0,0
...
FIELD:corp_additonal_info:TYPE(STRING350):0,0
...
FIELD:corp_naics_code:TYPE(STRING6):0,0
...
FIELD:corp_name_status_cd:TYPE(STRING2):0,0
...
FIELD:corp_number_of_ammendments:TYPE(UNSIGNED6):0,0
...
FIELD:corp_percentage_voters_required_to_approve_ammendments:TYPE(STRING):0,0
...
FIELD:corp_terminiation_date:TYPE(STRING8):0,0
