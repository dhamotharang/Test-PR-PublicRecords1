...
//export Mac_OKC_SexOffenders_Spray(source_IP,source_path,source_state,file_name,group_name ='\'thor_dataland_linux\'',clear_Super ='Y') := 
export Mac_OKC_SexOffenders_Spray(source_IP,source_path,source_state,file_name,group_name ='\'thor_200\'',clear_Super ='Y') := 
macro
...
%outfile% := project(dataset(OKC_Sexual_Offenders.Cluster + 'in::OKC_Sex_Off::'+source_state+'::temp_'+file_name,%Layout_In_File%,csv(heading(1),separator('|'),terminator(['\r\n','\r','\n']),quote('"'),maxlength(9999))),
                     %trfProject%(left));
