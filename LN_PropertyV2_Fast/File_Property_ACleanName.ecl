...
ds_search := LN_PropertyV2_Fast.Files.base.search_prp(ln_fares_id<>'' AND err_stat[1] = 'S' AND which_orig='1' AND ln_fares_id[2] ='A');	
rec := record
...
EXPORT File_Property_ACleanName := project(ds_search_out(keepit>0), LN_PropertyV2.Layout_Property_KeyExtract);