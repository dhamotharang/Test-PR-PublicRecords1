import Scrubs_LN_PropertyV2_Deed,ut,  Scrubs_LN_PropertyV2_Assessor,_control,std,scrubs,tools;
EXPORT fn_scrubs_deed (string source = '', string version, string emailList='') :=  function
vendor := if(source = 'O', 'SourceB', 'SourceA'); 
pProfileName:='Scrubs_LN_Property_Deed';
F := Scrubs_LN_PropertyV2_Deed.In_property_deed(source, version);
none :=Scrubs_LN_PropertyV2_Deed.Scrubs.FromNone(F);
S :=Scrubs_LN_PropertyV2_Deed.Scrubs; // My scrubs module
...
H := Scrubs_LN_PropertyV2_Deed.hygiene(F);	
