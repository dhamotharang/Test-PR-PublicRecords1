IMPORT strata;
EXPORT Proc_FCRA_Field_Deprecation_Stats(BOOLEAN isFast) := FUNCTION

	//DF-21968 Verify followings fields are cleared in thor_data400::key::ln_propertyv2::fcra::qa::assessor.fid
	cnt_fcra_assessor_fid := OUTPUT(strata.macf_pops(LN_PropertyV2_Fast.key_assessor_fid(true,isFast),,,,,,FALSE,
	...
	cnt_fcra_deed_fid := OUTPUT(strata.macf_pops(LN_PropertyV2_Fast.key_deed_fid(true,isFast),,,,,,FALSE,
	...
	RETURN SEQUENTIAL(cnt_fcra_assessor_fid,cnt_fcra_deed_fid);
