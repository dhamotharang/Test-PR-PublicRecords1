...
EXPORT proc4channeldelta (string	filedate, boolean isFast)	:=	FUNCTION
...
RoxieKeyBuild.Mac_SK_BuildProcess_v2_local(k27,SuperKeyName+s27, BaseKeyName + '::' +s27,key27); //Deprecated key Jira DF-26972 - currently on hold
