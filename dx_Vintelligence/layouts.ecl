EXPORT layouts := module
	export r_VintelligencePart1:=record
...
string1	carburetion;
string1	gvw;
// Blank for Passengers GVW for Trucks The manufacturerâ€™s GVW rating. Codes and associated weight ranges are as follows:
// 1=6,000 and less
// 2=6,001 - 10,000
// 3=10,001 - 14,000
// 4=14,001 - 16,000
...
// 1, 2, 3,â€¦=Number of cycles of the bike.
// R=Rotary
...
STRING64		VIN_SIGNI_PATTRN_MASK;						//1       1-64                  VIN_SIGNI_PATTRN_MASK                 VIN Prefix that includes the significant digits of the VIN 
	...
	STRING250		FRNT_TYRE_DESC;										//35      3776-4025             FRNT_TYRE_DESC                        more specific tire description (ex. Michelin Eagle P245/40ZR)Ãƒâ€šÃ‚Â¿  
	...
	STRING250		REAR_TIRE_DESC;										//39      4290-4539             REAR_TIRE_DESC                        more specific tire description (ex. Michelin Eagle P245/40ZR)Ãƒâ€šÃ‚Â¿  
	...
	STRING1			ISO_PERFORMANCE_IND;							//57      5376-5376             ISO_PERFORMANCE_IND                   Contains the one position ISO High Performance Code 4 = Sporty premium (This previously coded as a Ãƒâ€šÃ‚Â¿PÃƒâ€šÃ‚Â¿)2 = High Performance (This previously coded as an Ãƒâ€šÃ‚Â¿HÃƒâ€šÃ‚Â¿)1= Intermediate (This previously coded as an Ãƒâ€šÃ‚Â¿IÃƒâ€šÃ‚Â¿)3= Sporty (This previously coded as an Ãƒâ€šÃ‚Â¿SÃƒâ€šÃ‚Â¿) 
	...
	STRING1			LPM_ROLL_IND_2016;								//278     19127-19127           LPM_ROLL_IND_2016											It is common insurance industry practice to Ãƒâ€šÃ‚Â¿roll overÃƒâ€šÃ‚Â¿ insurance symbols from the previous model year into the new model year. An Ãƒâ€šÃ‚Â¿RÃƒâ€šÃ‚Â¿ is placed in this field to indicate that the ISO symbol for an existing series / model has been continued into the new model year and is not yet in the ISO country-wide book for the new model year. These symbols are phased out via normal software updates as the ISO symbols are updated and published.  This code is provided as a service to users, and use of the associated symbol is optional
	...
	//New 20150930
	STRING2			RP_COMP_RATING_SYM;								//302     19687-19688           RP_COMP_RATING_SYM										Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Rating Symbol
	STRING2			RP_COLL_RATING_SYM;								//303     19690-19691						RP_COLL_RATING_SYM										Risk AnalyzerÃƒâ€šÃ‚Â® Collision Rating Symbol
	STRING2			RP_COMP_RATING_SYM_GA;						//304     19693-19694						RP_COMP_RATING_SYM_GA									Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Rating Symbol - Georgia
	STRING2			RP_COLL_RATING_SYM_GA;						//305     19696-19697						RP_COLL_RATING_SYM_GA									Risk AnalyzerÃƒâ€šÃ‚Â® Collision Rating Symbol - Georgia
	STRING2			RP_COMP_IND_SYM;									//306     19699-19700						RP_COMP_IND_SYM												Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Indicated Symbol
	STRING2			RP_COLL_IND_SYM;									//307     19702-19703						RP_COLL_IND_SYM												Risk AnalyzerÃƒâ€šÃ‚Â® Collision Indicated Symbol
	STRING9			RP_COMP_IND_SYM_RELTIVTY;					//308     19705-19713						RP_COMP_IND_SYM_RELTIVTY							Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Indicated Symbol Relativity
	STRING9			RP_COLL_IND_SYM_RELTIVTY;					//309     19715-19723           RP_COLL_IND_SYM_RELTIVTY							Risk AnalyzerÃƒâ€šÃ‚Â® Collision Indicated Symbol Relativity
	STRING9			RP_COMP_PRC_NEW_RELTIVTY;					//310     19725-19733						RP_COMP_PRC_NEW_RELTIVTY							Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Price New Relativity
	STRING10		RP_COMP_LUX_ADD_PRC_RELTIVTY;			//311     19735-19744						RP_COMP_LUX_ADD_PRC_RELTIVTY					Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Luxury Price Addtn. To Price New Relativity
	STRING14		RP_COMP_FREQ_THEFT_VAND_FIRE;			//312     19746-19759 					RP_COMP_FREQ_THEFT_VAND_FIRE					Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Frequency - Theft, Vandalism and Fire
	STRING14		RP_COMP_FREQ_WIND_WATER;					//313     19761-19774						RP_COMP_FREQ_WIND_WATER								Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Frequency - Wind and Water
	STRING14		RP_COMP_FREQ_ANIMAL;							//314     19776-19789						RP_COMP_FREQ_ANIMAL										Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Frequency - Animal
	STRING14		RP_COMP_FREQ_OTHER_TYPE_LOSS;			//315     19791-19804						RP_COMP_FREQ_OTHER_TYPE_LOSS					Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Frequency - Other Type of Loss
	STRING14		RP_COMP_FREQ_GLASS;								//316     19806-19819						RP_COMP_FREQ_GLASS										Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Frequency - Glass
	STRING14		RP_COMP_SVRITY_THEFT_VAND_FIRE;		//317     19821-19834						RP_COMP_SVRITY_THEFT_VAND_FIRE				Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Severity - Theft, Vandalism and Fire
	STRING14		RP_COMP_SVRITY_WIND_WATER;				//318     19836-19849						RP_COMP_SVRITY_WIND_WATER							Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Severity - Wind and Water
	STRING14		RP_COMP_SVRITY_ANIMAL;						//319     19851-19864						RP_COMP_SVRITY_ANIMAL									Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Severity - Animal
	STRING14		RP_COMP_SVRITY_OTHER_TYPE_LOSS;		//320     19866-19879						RP_COMP_SVRITY_OTHER_TYPE_LOSS				Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Severity - Other Type of Loss
	STRING14		RP_COMP_SVRITY_GLASS;							//321     19881-19894						RP_COMP_SVRITY_GLASS									Risk AnalyzerÃƒâ€šÃ‚Â® Comprehensive Severity - Glass
	STRING9			RP_COLL_PRC_NEW_RELTIVTY;					//322     19896-19904						RP_COLL_PRC_NEW_RELTIVTY							Risk AnalyzerÃƒâ€šÃ‚Â® Collision Price New Relativity
	STRING10		RP_COLL_LUX_ADD_PRC_RELTIVTY;			//323     19906-19915						RP_COLL_LUX_ADD_PRC_RELTIVTY					Risk AnalyzerÃƒâ€šÃ‚Â® Collision Luxury Price Addtn. to Price New Relativity
	STRING14		RP_COLL_FREQ_BOD_STY_DIMEN;				//324     19917-19930						RP_COLL_FREQ_BOD_STY_DIMEN						Risk AnalyzerÃƒâ€šÃ‚Â® Collision Frequency - Body Style and Dimensions
	STRING14		RP_COLL_SVRITY_BOD_STY_DIMEN;			//325     19932-19945						RP_COLL_SVRITY_BOD_STY_DIMEN					Risk AnalyzerÃƒâ€šÃ‚Â® Collision Severity - Body Style and Dimensions
	STRING14		RP_COLL_FREQ_PERFM_SAFETY;				//326     19947-19960						RP_COLL_FREQ_PERFM_SAFETY							Risk AnalyzerÃƒâ€šÃ‚Â® Collision Frequency - Performance and Safety
	STRING14		RP_COLL_SVRITY_PERFM_SAFETY;			//327     19962-19975						RP_COLL_SVRITY_PERFM_SAFETY						Risk AnalyzerÃƒâ€šÃ‚Â® Collision Severity - Performance and Safety
...
export r_VintelligencePart2:=record
string1 l_vin1;
string1 l_vin2;
string1 l_vin3;
string1 l_vin4;
...
string1 l_vin17;
string17	match_vin;
	STRING2			RL_SINGLE_LMT_RATING_SYM;					//331     19992-19993						RL_SINGLE_LMT_RATING_SYM							Risk AnalyzerÃƒâ€šÃ‚Â® Single Limit Rating Symbol
	STRING2			RL_BOD_INJRY_RATING_SYM;					//332     19995-19996						RL_BOD_INJRY_RATING_SYM								Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury Rating Symbol
	STRING2			RL_PROP_DAM_RATING_SYM;						//333     19998-19999						RL_PROP_DAM_RATING_SYM								Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage Rating Symbol
	STRING2			RL_PIP_RATING_SYM;								//334     20001-20002						RL_PIP_RATING_SYM											Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection Rating Symbol
	STRING2			RL_MED_PYMT_RATING_SYM; 					//335     20004-20005						RL_MED_PYMT_RATING_SYM								Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments Rating Symbol
	STRING2			RL_SINGLE_LMT_RATING_SYM_GA; 			//336     20007-20008						RL_SINGLE_LMT_RATING_SYM_GA						Risk AnalyzerÃƒâ€šÃ‚Â® Single Limit Rating Symbol - Georgia
	STRING2			RL_BOD_INJRY_RATING_SYM_GA; 			//337     20010-20011 					RL_BOD_INJRY_RATING_SYM_GA						Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury Rating Symbol - Georgia
	STRING2			RL_PROP_DAM_RATING_SYM_GA; 				//338     20013-20014						RL_PROP_DAM_RATING_SYM_GA							Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage Rating Symbol - Georgia
	STRING2			RL_PIP_RATING_SYM_GA; 						//339     20016-20017						RL_PIP_RATING_SYM_GA									Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection Rating Symbol - Georgia
	STRING2			RL_MED_PYMT_RATING_SYM_GA; 				//340     20019-20020						RL_MED_PYMT_RATING_SYM_GA							Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments Rating Symbol - Georgia
	STRING2			RL_SINGLE_LMT_IND_SYM; 						//341     20022-20023						RL_SINGLE_LMT_IND_SYM									Risk AnalyzerÃƒâ€šÃ‚Â® Single Limit Indicated Symbol
	STRING2			RL_BOD_INJRY_IND_SYM; 						//342     20025-20026						RL_BOD_INJRY_IND_SYM									Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury Indicated Symbol
	STRING2			RL_PROP_DAM_IND_SYM; 							//343     20028-20029						RL_PROP_DAM_IND_SYM										Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage Indicated Symbol
	STRING2			RL_PIP_IND_SYM; 									//344     20031-20032						RL_PIP_IND_SYM												Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection Indicated Symbol
	STRING2			RL_MED_PYMT_IND_SYM; 							//345     20034-20035						RL_MED_PYMT_IND_SYM										Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments Indicated Symbol
	STRING9			RL_SINGLE_LMT_IND_SYM_RELTIVTY; 	//346     20037-20045						RL_SINGLE_LMT_IND_SYM_RELTIVTY				Risk AnalyzerÃƒâ€šÃ‚Â® Single Limit Indicated Symbol Relativity
	STRING9			RL_BOD_INJRY_IND_SYM_RELTIVTY; 		//347     20047-20055						RL_BOD_INJRY_IND_SYM_RELTIVTY					Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury Indicated Symbol Relativity
	STRING9			RL_PROP_DAM_IND_SYM_RELTIVTY; 		//348     20057-20065						RL_PROP_DAM_IND_SYM_RELTIVTY					Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage Indicated Symbol Relativity
	STRING9			RL_PIP_IND_SYM_RELTIVTY; 					//349     20067-20075						RL_PIP_IND_SYM_RELTIVTY								Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection Indicated Symbol Relativity
	STRING9			RL_MED_PYMT_IND_SYM_RELTIVTY; 		//350     20077-20085						RL_MED_PYMT_IND_SYM_RELTIVTY					Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments Indicated Symbol Relativity
	STRING14		RL_BOD_INJRY_BOD_STY_DIMN_COMP; 	//543			21746-21759						RL_BOD_INJRY_BOD_STY_DIMN_COMP				Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury - Body Style & Dimensions Component
	STRING14		RL_BOD_INJRY_PERFM_SAFETY_COMP; 	//544			21761-21774						RL_BOD_INJRY_PERFM_SAFETY_COMP				Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury - Performance & Safety Component
	STRING14		RL_BOD_INJRY_PRC_NEW_EXP_COMP; 		//545			21776-21789						RL_BOD_INJRY_PRC_NEW_EXP_COMP					Risk AnalyzerÃƒâ€šÃ‚Â® Bodily Injury - Price New & Experience Component
	STRING14		RL_PROP_DAM_BOD_STY_DIMN_COMP; 		//546			21791-21804						RL_PROP_DAM_BOD_STY_DIMN_COMP					Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage - Body Style & Dimensions Component
	STRING14		RL_PROP_DAM_PERFM_SAFETY_COMP; 		//547			21806-21819						RL_PROP_DAM_PERFM_SAFETY_COMP					Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage - Performance & Safety Component
	STRING14		RL_PROP_DAM_PRICE_NEW_EXP_COMP; 	//548			21821-21834						RL_PROP_DAM_PRICE_NEW_EXP_COMP				Risk AnalyzerÃƒâ€šÃ‚Â® Property Damage - Price New & Experience Component
	STRING14		RL_PIP_BOD_STY_DIMN_COMP; 				//549			21836-21849						RL_PIP_BOD_STY_DIMN_COMP							Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection - Body Style & Dimensions Component
	STRING14		RL_PIP_PRICE_PERFM_SAFETY_COMP; 	//550			21851-21864						RL_PIP_PRICE_PERFM_SAFETY_COMP				Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection - Performance & Safety Component
	STRING14		RL_PIP_PRICE_NEW_EXP_COMP;				//551			21866-21879						RL_PIP_PRICE_NEW_EXP_COMP							Risk AnalyzerÃƒâ€šÃ‚Â® Personal Injury Protection - Price New & Experience Component
	STRING14		RL_MED_PYMT_BOD_STY_DIMN_COMP;		//552			21881-21894						RL_MED_PYMT_BOD_STY_DIMN_COMP					Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments - Body Style & Dimensions Component
	STRING14		RL_MED_PYMT_PERFM_SAFETY_COMP;		//553			21896-21909						RL_MED_PYMT_PERFM_SAFETY_COMP					Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments - Performance & Safety Component
	STRING14		RL_MED_PYMT_PRICE_NEW_EXP_COMP;		//554			21911-21924						RL_MED_PYMT_PRICE_NEW_EXP_COMP				Risk AnalyzerÃƒâ€šÃ‚Â® Medical Payments - Price New & Experience Component
	...
	STRING1			RL_PERFORMANCE_IND;								//565			22036-22036						RL_PERFORMANCE_IND										Risk AnalyzerÃƒâ€šÃ‚Â® LPM Performance Indicator
	STRING1			RL_ROLL_IND;											//566			22038-22038						RL_ROLL_IND														Risk AnalyzerÃƒâ€šÃ‚Â® LPM Symbol Rolled
	...
	STRING1			MA_PERFORMANCE_IND;								//472     30362-30362           MA_PERFORMANCE_IND                    Contains the one position High Performance Code 4 = Sporty premium (This previously coded as a Ãƒâ€šÃ‚Â¿PÃƒâ€šÃ‚Â¿)2 = High Performance (This previously coded as 
	STRING1			MA_ROLL_IND;											//473     30364-30364           MA_ROLL_IND                           It is common insurance industry practice to Ãƒâ€šÃ‚Â¿roll overÃƒâ€šÃ‚Â¿ insurance symbols from the previous model year into the new model year. An Ãƒâ€šÃ‚Â¿RÃƒâ€šÃ‚Â¿ is placed in this field to indicate that the symbol for an existing series / model has been continued into the new model year and is not yet in the country-wide book for the new model year. These symbols are phased out via normal software updates as the symbols are updated and published.  This code is provided as a service to users, and use of the associated symbol is optional 
	...
	STRING1			RPS_ENG_ASP_TRBL_CHGR_CD;					//506     33481-33481           RPS_ENG_ASP_TRBL_CHGR_CD              (Code) Turbocharged:  A centrifugal air pump driven by the engineÃƒâ€šÃ‚Â¿s exhaust designed to force more air into the engine in order to produce higher power. 
	STRING250		RPS_ENG_ASP_TRBL_CHGR_DESC;				//507     33483-33732           RPS_ENG_ASP_TRBL_CHGR_DESC            (Description) Turbocharged:  A centrifugal air pump driven by the engineÃƒâ€šÃ‚Â¿s exhaust designed to force more air into the engine in order to produce higher power. 
