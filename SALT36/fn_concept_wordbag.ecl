...
shared Match3L(
   ...
   L1BlankCost := IF ( lfor1 > 0 , FailedForce, Failed );
	 ...
	 L1R1 := SALT36.Min0(Match1L(L1,lspec1,lnne1,lfor1,R1, rspec1)); // take force into consideration
	 L1R2 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),R2, rspec2));
   L1R3 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R3, rspec3));
...
shared Match4L(
   ...
   L1BlankCost := IF ( lfor1 > 0 , FailedForce, Failed );
	 ...
	 L1R2 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),R2, rspec2));
   L1R3 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R3, rspec3));
	 L1R4 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R4, rspec4));
...
shared Match5L(
   ...
   L1R3 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R3, rspec3));
	 L1R4 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R4, rspec4));
	 L1R5 := SALT36.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),R5, rspec5));
