...
#else
			MAP(n<=1 => sep+SALT36.GetRangeOfWords(s,n+1,wc,sep),
			    n=wc => SALT36.GetRangeOfWords(s,1,wc-1,sep)+sep,
					n>wc => SALT36.GetRangeOfWords(s,1,wc,sep),
					SALT36.GetRangeOfWords(s,1,n-1,sep)+sep+sep+SALT36.GetRangeOfWords(s,n+1,wc,sep));
#end
