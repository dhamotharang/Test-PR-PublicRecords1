...
if(trim(sprayMessage,left,right) = '', nonFCRA_Consumer):FAILURE(FileServices.SendEmail(email_list,'KEL SHELL QA UI run job','The failed workunit is:' + workunit + FailMessage));
