...
execu:=Kel_Shell_QA.UI_descriptive_Stats_Report(email_list,logical_file_name, unique_id, input_file_recs, Tag, unique_tag);

execu;


EXPORT BWR_UI_descriptive_Stats_Report := 'todo';