...
lay:=RECORD
  ...
  integer8 be_bestaddrnewmktvalev;
  integer8 be_bestaddrnewtaxvalev;
  string6 be_bestaddrnewmktvalyrev;
  string6 be_bestaddrnewtaxvalyrev;
  integer8 be_bestaddrlotsize;
  integer8 be_bestaddrbldgsize;
...
logical_file_name:='~lweiner::out::business_roxie_100k_archive_ks-6444take2_w20200802-133200_masterlayout.csv';
...
Kel_Shell_QA_UI.UI_Output_Distribution_Report_Module(email_list, logical_file_name, unique_id, input_file_recs, Tag, unique_tag);

EXPORT BWR_UI_Distribution_Module := 'todo';