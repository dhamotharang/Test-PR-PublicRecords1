...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_fname((SALT311.StrType)le.fname,(SALT311.StrType)le.mname,(SALT311.StrType)le.lname),
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_Date','Invalid_Date','Invalid_numeric','Invalid_mandatory_alpha','Unknown','Invalid_mandatory_alpha','Invalid_mandatory_alpha','Invalid_alpha','Invalid_St','Invalid_zip','Invalid_numeric_optional','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_fname','Unknown','Unknown','Unknown','Unknown','Invalid_company_flag','Unknown','Unknown');
