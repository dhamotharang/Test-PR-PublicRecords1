...
EXPORT Base_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_fname:CUSTOM(Scrubs.Functions.fn_populated_strings>0,mname,lname)\n'
    ...
    + 'FIELD:address1:TYPE(STRING40):LIKE(Invalid_alpha):0,0\n'
    ...
    + 'FIELD:irs_taxpayer_id:TYPE(STRING9):LIKE(Invalid_numeric):0,0\n'
