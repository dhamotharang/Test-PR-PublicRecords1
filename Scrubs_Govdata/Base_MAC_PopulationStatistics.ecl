...
EXPORT Base_MAC_PopulationStatistics(infile,Ref='',Input_dt_first_reported = '',Input_dt_last_reported = '',Input_cik_number = '',Input_company_name = '',Input_reporting_file_number = '',Input_address1 = '',Input_address2 = '',Input_city = '',Input_state_code = '',Input_zip_code = '',Input_irs_taxpayer_id = '',Input_prim_range = '',Input_predir = '',Input_prim_name = '',Input_addr_suffix = '',Input_postdir = '',Input_unit_desig = '',Input_sec_range = '',Input_p_city_name = '',Input_v_city_name = '',Input_st = '',Input_zip = '',Input_zip4 = '',Input_cart = '',Input_cr_sort_sz = '',Input_lot = '',Input_lot_order = '',Input_dpbc = '',Input_chk_digit = '',Input_record_type = '',Input_ace_fips_st = '',Input_county = '',Input_geo_lat = '',Input_geo_long = '',Input_msa = '',Input_geo_blk = '',Input_geo_match = '',Input_err_stat = '',Input_title = '',Input_fname = '',Input_mname = '',Input_lname = '',Input_name_suffix = '',Input_name_score = '',Input_is_company_flag = '',Input_cname = '',Input_lf = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_cik_number)='' )
      '' 
    #ELSE
        IF( le.Input_cik_number = (TYPEOF(le.Input_cik_number))'','',':cik_number')
    #END
...
+    #IF( #TEXT(Input_reporting_file_number)='' )
      '' 
    #ELSE
        IF( le.Input_reporting_file_number = (TYPEOF(le.Input_reporting_file_number))'','',':reporting_file_number')
    #END
...
+    #IF( #TEXT(Input_irs_taxpayer_id)='' )
      '' 
    #ELSE
        IF( le.Input_irs_taxpayer_id = (TYPEOF(le.Input_irs_taxpayer_id))'','',':irs_taxpayer_id')
    #END
...
+    #IF( #TEXT(Input_is_company_flag)='' )
      '' 
    #ELSE
        IF( le.Input_is_company_flag = (TYPEOF(le.Input_is_company_flag))'','',':is_company_flag')
    #END
