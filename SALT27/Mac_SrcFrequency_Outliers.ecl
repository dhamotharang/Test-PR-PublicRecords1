EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT27.Str30Type fieldname := #TEXT(infield);
	  SALT27.StrType fieldvalue {maxlength(200000)} := (SALT27.StrType)infile.infield ;
		SALT27.StrType src {maxlength(30)} := infile.srcfield ;
