...
self.offender_key		:= '1W'+trim(l.casenumber,left,right)+l.id;
self.vendor				:= '1W';
self.state_origin		:= 'OK';
self.data_type			:= '2';
self.source_file		:= 'OK_GARFIELD_CRIM_COURT';
...
dedOffender := dedup(sort(distribute(cleanOffender,hash(offender_key)),
										...
										:PERSIST('~thor_dell400::persist::Crim_OK_GARFIELD_Offender_Clean')
										;

export Map_OK_GARFIELD_Offender := dedOffender;