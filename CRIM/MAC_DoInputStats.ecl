...
stat2 := table(offender, %offender_key_short_layout%, offender_key, few);
...
output(stat42, all, named('STAT_court_off_lev')),
output(stat57, all, named('STAT_Court_Statute')),
output(stat58, all, named('STAT_Court_Statute_Description')),
output(stat43, all, named('STAT_court_disp_date')),
output(stat59, all, named('STAT_court_disp_code')),
output(stat44, all, named('STAT_court_disp_desc_1')),
output(stat45, all, named('STAT_sent_jail')),
output(stat46, all, named('STAT_sent_court_cost')),
output(stat47, all, named('STAT_sent_court_fine')),
output(stat48, all, named('STAT_sent_susp_court_fine')),
output(stat49, all, named('STAT_sent_probation'))
);
ENDMACRO;