...
d := crim.File_OH_Richland(Charge_Decision <> 'Charge_Decision');
...
fOHOffend:= dedup(sort(distribute(pOHCrim,hash(offender_key)),
									...
									PERSIST('~thor_dell400::persist::Crim_OH_Richland_Offenses');

export map_OH_Richland_Offenses	:= fOHOffend;
