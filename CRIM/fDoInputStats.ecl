...
export fDoInputStats(dataset(Crim_Common.Layout_In_Court_Offender) offender, dataset(Crim_Common.Layout_In_Court_Offenses) offenses) := function 
...
output(choosen(der_nm_file, 500), named('No_Matches_Sample')),
output(choosen(off_key_file, 500), named('Sample_Dupe_Offender_Keys')),
...
output(choosen(ses_nm_file, 500), named('No_Matches_Sample_')),
output(choosen(offs_key_file, 500), named('Sample_Dupe_Offender_Keys_')),
...
output(choosen(stat7, 500), all, named('STAT_Case_Filing_Date')),
output(choosen(stat8, 500), named('Top_Sample_Party_Name')),
output(choosen(sort(stat8, -pty_nm), 500), named('Bottom_Sample_Party_Name')),
output(stat9, named('STAT_Party_Name_Format')),
output(stat10, all, named('STAT_Party_Type')),
output(choosen(stat11, 500), named('Top_Sample_lname')),
output(choosen(sort(stat11, -orig_lname), 500), named('Bottom_Sample_lname')),
output(choosen(stat12, 500), named('Top_Sample_fname')),
output(choosen(sort(stat12, -orig_fname), 500), named('Bottom_Sample_fname')),
output(choosen(stat13, 500), named('Top_Sample_mname')),
output(choosen(sort(stat13, -orig_mname), 500), named('Bottom_Sample_mname')),
output(stat14, all, named('STAT_name_suffix')),
output(choosen(stat15, 500), named('Top_Sample_ID_Number')),
output(choosen(sort(stat15, -id_num), 500), named('Bottom_Sample_ID_Number')),
output(choosen(stat50, 500), named('Top_Sample_Address1')),
output(choosen(sort(stat50, -street_address_1), 500), named('Bottom_Sample_Address1')),
output(choosen(stat51, 500), named('Top_Sample_Address2')),
output(choosen(sort(stat51, -street_address_2), 500), named('Bottom_Sample_Address2')),
output(choosen(stat52, 500), named('Top_Sample_Address3')),
output(choosen(sort(stat52, -street_address_3), 500), named('Bottom_Sample_Address3')),
output(choosen(stat53, 500), named('Top_Sample_Address4')),
output(choosen(sort(stat53, -street_address_4), 500), named('Bottom_Sample_Address4')),
output(choosen(stat54, 500), named('Top_Sample_Address5')),
output(choosen(sort(stat54, -street_address_5), 500), named('Bottom_Sample_Address5')),

output(choosen(stat16, 500), named('STAT_Date_of_Birth')),
...
output(choosen(stat35, 500), all, named('STAT_Height')),
output(choosen(stat36, 500), all, named('STAT_Weight')),
output(stat19, all, named('STAT_Party_Status_Description')),

output(stat20, all, named('STAT_Offense_Composition')),
output(choosen(stat40, 500), all, named('STAT_Num_Of_Counts')),
...
output(choosen(stat22, 500),all, named('STAT_Arrest_Offense_Description')),
...
output(choosen(stat56, 500), all, named('STAT_Court_Case_Number')),
output(choosen(stat41, 500), all, named('STAT_court_off_desc_1')),
output(choosen(stat42, 500), all, named('STAT_court_off_lev')),
output(choosen(stat57, 500), named('STAT_Court_Statute')),
output(stat58, all, named('STAT_Court_Statute_Description')),
output(choosen(stat43, 500), all, named('STAT_court_disp_date')),
output(choosen(stat59, 500), all, named('STAT_court_disp_code')),
output(choosen(stat44, 500), all, named('STAT_court_disp_desc_1')),
output(stat45, all, named('STAT_sent_jail')),
output(choosen(stat46, 500), all, named('STAT_sent_court_cost')),
output(choosen(stat47, 500), all, named('STAT_sent_court_fine')),
output(stat48, all, named('STAT_sent_susp_court_fine')),
output(choosen(stat49, 500), all, named('STAT_sent_probation'))
);
