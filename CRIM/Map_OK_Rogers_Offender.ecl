...
dedOffender := dedup(sort(distribute(cleanOffender,hash(offender_key)),
										...
										:PERSIST('~thor_dell400::persist::Crim_OK_ROGERS_Offender_Clean')
										;

export Map_OK_ROGERS_Offender := dedOffender;