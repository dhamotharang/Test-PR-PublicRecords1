...
EXPORT input_file := h0 : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6::Specificities_Cache',EXPIRE(Config.PersistExpire));
...
EXPORT cnp_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::cnp_name';
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::cnp_number';
...
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::active_duns_number';
...
EXPORT active_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::active_enterprise_number';
...
EXPORT active_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::active_domestic_corp_key';
...
EXPORT hist_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::hist_enterprise_number';
...
EXPORT hist_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::hist_duns_number';
...
EXPORT hist_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::hist_domestic_corp_key';
...
EXPORT foreign_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::foreign_corp_key';
...
EXPORT unk_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::unk_corp_key';
...
EXPORT ebr_file_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::ebr_file_number';
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::company_fein';
...
EXPORT company_phoneValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::company_phone';
...
EXPORT prim_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::prim_range';
...
EXPORT prim_name_derivedValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::prim_name_derived';
...
EXPORT sec_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::sec_range';
...
EXPORT v_city_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::v_city_name';
...
EXPORT stValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::st';
...
EXPORT zipValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::zip';
...
EXPORT company_cszValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::company_csz';
...
EXPORT company_addr1ValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::company_addr1';
...
EXPORT company_addressValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::company_address';
...
EXPORT company_address_specificity := ol;
  ...
  END;
  t := TABLE(infile,r);
SHARED ForeignCorpkey_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6::values::ForeignCorpkey',EXPIRE(Config.PersistExpire));
...
EXPORT ForeignCorpkeyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Word::ForeignCorpkey';
...
EXPORT SpecIndexKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Specificities';
