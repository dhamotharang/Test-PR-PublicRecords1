...
OutputFilename          := BIPV2_ProxID_mj6.filenames(pversion).wkhistory.logical                   ;
NumRecords              := 150                                                                  ;
lOverwrite              := true                                                                 ; 
archived                := false                                                                 ;
ShouldRestore           := false                                                                 ;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
dWks := sort(dedup(sort(BIPV2_ProxID_mj6.Files(pversion).wkhistory.logical(iteration != '',version = pversion,(unsigned)matchesperformed != 0                  ),iteration,-wuid),iteration),(unsigned)iteration);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
w1                := tools.macf_writefile(BIPV2_ProxID_mj6.filenames(pversion).precision.logical ,dsetupprecision ,pOverwrite := true);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
sequential(
  ...
  ,doprecision
  ,parallel(
     BIPV2_ProxID_mj6.Promote(pversion,'precision|wkhistory').new2qamult
  )
);
