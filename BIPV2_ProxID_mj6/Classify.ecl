...
EXPORT TokenKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Token::MultiTokenKey';
...
EXPORT ConceptKeyName := '~'+'key::BIPV2_ProxID_mj6::Proxid::Token::ConceptKey';
...
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_ProxID_mj6::Proxid::Token::ConceptKey';
