...
OutputFilename          := BIPV2_ProxID_mj6._filenames(pversion).wkhistory.logical                   ;
NumRecords              := 150                                                                  ;
lOverwrite              := true                                                                 ; 
archived                := false                                                                ;
ShouldRestore           := false                                                                ;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
dWks := sort(dedup(sort(BIPV2_ProxID_mj6._Files(pversion).wkhistory.logical(iteration != '',version = pversion,(unsigned)matchesperformed != 0                  ),iteration,-wuid),iteration),(unsigned)iteration);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
w1                := tools.macf_writefile(BIPV2_ProxID_mj6._filenames(pversion).precision.logical ,dsetupprecision ,pOverwrite := true);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
doprecision := wk_ut.mac_SALT_Precision(BIPV2_ProxID_mj6._files(pversion).precision.logical,setiters,false);
sequential(
   createsummaryreport
  ,w1  
  ,setprecision
  ,doprecision
  ,parallel(
     BIPV2_ProxID_mj6._Promote(pversion,'precision|wkhistory').new2qamult
  )
);
