//so take iteration 24 from BIPV2_ProxID_mj6 
...
//#workunit('name','BIPV2_ProxID_mj6.BWR_Specificities - Specificities');
IMPORT BIPV2_ProxID_mj6,SALT25;
IMPORT SALTTOOLS22;
dotbase := BIPV2_ProxID_mj6.files().base.built;
SpecMod := BIPV2_ProxID_mj6.specificities(dotbase);
...
//  ,BIPV2_ProxID_mj6.Promote('0').new2built    //promote it as zeroth iteration to superfile(for attribute file use)
  ,SpecMod.Build
  ,parallel(
