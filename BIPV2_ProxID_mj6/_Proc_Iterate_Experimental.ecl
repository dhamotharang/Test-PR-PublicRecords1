//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_mj6',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_mj6.filenames(combo).dall_filenames
                  + BIPV2_ProxID_mj6.keynames (combo).dall_filenames
                  + BIPV2_ProxID_mj6.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_mj6.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_mj6.filenames(siter).dall_filenames
                  + BIPV2_ProxID_mj6.keynames (siter).dall_filenames
                  ;
