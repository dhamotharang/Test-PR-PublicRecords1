...
P := BIPV2_ProxID_mj6.Proc_Iterate('1'); // Change '1' for later iterations
...
//SALT30.MAC_MatchSamplePatterns(BIPV2_ProxID_mj6.Keys(BIPV2_ProxID_mj6.In_DOT_Base).MatchSample,MatchPatterns,Proxid1,Proxid2,8,35-41);
...
//ConfThreshold:=38;
//ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_ProxID_mj6.Keys(BIPV2_ProxID_mj6.In_DOT_Base).MatchSample,BIPV2_ProxID_mj6.Keys(BIPV2_ProxID_mj6.In_DOT_Base).Candidates,BIPV2_ProxID_mj6.In_DOT_Base,Proxid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
