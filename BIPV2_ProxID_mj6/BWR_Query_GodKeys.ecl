...
kmtchsmpl  := index(BIPV2_ProxID_mj6.Keys(BIPV2_ProxID_mj6.In_DOT_Base).MatchSample ,BIPV2_ProxID_mj6.keynames('20130212_25').match_sample_debug.logical);
kmtchgt21 := kmtchsmpl(conf >= 21);
ddev2      := BIPV2_ProxID_mj6.files('20130212_25').base.logical;
