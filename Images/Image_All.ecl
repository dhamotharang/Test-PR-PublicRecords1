/*--SOAP--
<message name="Image_All">
	<part name="state" type="xsd:string">
        <html>
          <td width="25%"><font face="Verdana" size="2">state:</font></td>
	...
	<part name="b_seq" type="xsd:integer"/>
	<part name="e_seq" type="xsd:integer"/>
...
*/
/*--INFO-- Outputs image data sans image
*/
export Image_All := MACRO
