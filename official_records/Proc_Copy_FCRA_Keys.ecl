...
export Proc_Copy_FCRA_Keys(string filedate,string datasetname,string keysuffix) := function
	...
	movekey(string fdate,string dsname,string ks) := 
		sequential(
				if ( NOT fileservices.superfileexists('~thor_200::key::'+dsname+'::fcra::delete::'+ks),
					fileservices.createsuperfile('~thor_200::key::'+dsname+'::fcra::delete::'+ks)),
				if ( NOT fileservices.superfileexists('~thor_200::key::'+dsname+'::fcra::father::'+ks),
					fileservices.createsuperfile('~thor_200::key::'+dsname+'::fcra::father::'+ks)),
				if ( NOT fileservices.superfileexists('~thor_200::key::'+dsname+'::fcra::qa::'+ks),
					fileservices.createsuperfile('~thor_200::key::'+dsname+'::fcra::qa::'+ks)),
				fileservices.startsuperfiletransaction(),
				fileservices.addsuperfile('~thor_200::key::'+dsname+'::fcra::delete::'+ks,
										'~thor_200::key::'+dsname+'::fcra::father::'+ks,,true),
				fileservices.clearsuperfile('~thor_200::key::'+dsname+'::fcra::father::'+ks),
				fileservices.addsuperfile('~thor_200::key::'+dsname+'::fcra::father::'+ks,
										'~thor_200::key::'+dsname+'::fcra::qa::'+ks,,true),
				fileservices.clearsuperfile('~thor_200::key::'+dsname+'::fcra::qa::'+ks),
				fileservices.addsuperfile('~thor_200::key::'+dsname+'::fcra::qa::'+ks,
										'~thor_200::key::'+dsname+'::fcra::'+filedate+'::'+ks),
				fileservices.finishsuperfiletransaction(),
				fileservices.clearsuperfile('~thor_200::key::'+dsname+'::fcra::delete::'+ks,true)
		);
	

	sourcekeyname := '~thor_200::key::'+datasetname+'::'+filedate+'::'+keysuffix;
	destkeyname := '~thor_200::key::'+datasetname+'::fcra::'+filedate+'::'+keysuffix;
	superkeys := fileservices.LogicalFileSuperOwners(destkeyname);
	
	email_me := fileservices.sendemail(
													'skasavajjala@seisint.com',
													'Official Records NonFCRA-FCRA Copy Failed ' + filedate,
