export Extract_marriage_divorces := function
...
dr_with_filing_type append_filing_type(ds_in R) := TRANSFORM
	 self.filing_type := MAP(
		...
		R.vendor='02' AND StringLib.StringToUpperCase(R.doc_type_desc)='MARRIAGERECORD'  => '3',
...
offrout := output(ds_with_filing_type(filing_type<>''),,'~thor_200::out::official_records_marriage_divorce_party',Overwrite);
