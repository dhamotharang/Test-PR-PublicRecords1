...
Standard.Official_Records_Party tPartyInToRoxie(dInAsOutDeduped pInput)
 ...
 transform
  ...
  self.dob				:= (INTEGER) pInput.entity_dob;
  self.ssn				:= pInput.entity_ssn;
  self.pname_1_title	:= pInput.title1;
  self.pname_1_fname 	:= pInput.fname1;
  self.pname_1_mname	:= pInput.mname1;
  self.pname_1_lname	:= pInput.lname1;
  self.pname_1_name_suffix := pInput.suffix1;
  self.pname_1_name_score := pInput.pname1_score;
  self.cname_1			:= pInput.cname1;
  self.pname_2_title	:= pInput.title2;
  self.pname_2_fname 	:= pInput.fname2;
  self.pname_2_mname	:= pInput.mname2;
  self.pname_2_lname	:= pInput.lname2;
  self.pname_2_name_suffix := pInput.suffix2;
  self.pname_2_name_score := pInput.pname2_score;
  self.cname_2			:= pInput.cname2;
  self.pname_3_title	:= pInput.title3;
  self.pname_3_fname 	:= pInput.fname3;
  self.pname_3_mname	:= pInput.mname3;
  self.pname_3_lname	:= pInput.lname3;
  self.pname_3_name_suffix := pInput.suffix3;
  self.pname_3_name_score := pInput.pname3_score;
  self.cname_3			:= pInput.cname3;
  self.pname_4_title	:= pInput.title4;
  self.pname_4_fname 	:= pInput.fname4;
  self.pname_4_mname	:= pInput.mname4;
  self.pname_4_lname	:= pInput.lname4;
  self.pname_4_name_suffix := pInput.suffix4;
  self.pname_4_name_score := pInput.pname4_score;
  self.cname_4			:= pInput.cname4;
  self.pname_5_title	:= pInput.title5;
  self.pname_5_fname 	:= pInput.fname5;
  self.pname_5_mname	:= pInput.mname5;
  self.pname_5_lname	:= pInput.lname5;
  self.pname_5_name_suffix := pInput.suffix5;
  self.pname_5_name_score := pInput.pname5_score;
...
export Out_Roxie_Party := output(dPartyAsRoxie,,Official_Records.Name_Roxie_Party_Dev,__compressed__,overwrite);
