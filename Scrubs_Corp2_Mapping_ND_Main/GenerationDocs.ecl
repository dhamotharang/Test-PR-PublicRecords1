...
Command line options: -MScrubs_Corp2_Mapping_ND_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR8C4A.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(38)
FIELDTYPE:invalid_state_origin:ENUM(ND)
FIELDTYPE:invalid_corp_status_cd:ENUM(A|C|CV|E|I|M|N|R|RD|T|V| )
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_for_profit_ind:ENUM(N| )
FIELDTYPE:invalid_corp_orig_org_structure_cd:ENUM(AA|BANK|BC|C|CH|CITY|F|FC|FLC|FNLC|FPC|FPLC|FNP|CNPD|NP|NPLC|CU|EC|FARM|FID|FMLC|GA|IC|ID|LC|MAC|MP|PC|PLC|PTC|REIT|SCD|VC|VCD|WMD|G|L|LLLP|LLP|LP|PLLP| )
FIELDTYPE:invalid_name_type_cd:ENUM(01|F|03|04| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|FBN|TRADEMARK|TRADENAME| )
FIELDTYPE:invalid_alphablankhyphencommaperiod:ALLOW( ,.-ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphablankhyphencommaperiod):0,0
