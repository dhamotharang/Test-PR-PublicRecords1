...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter','invalid_mandatory','invalid_date','invalid_optional_date','invalid_corp_vendor','invalid_state_origin','invalid_forgn_dom_code','invalid_for_profit_ind','invalid_status','invalid_name_type_desc','invalid_name_type_cd','invalid_recordorigin');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter' => 2,'invalid_mandatory' => 3,'invalid_date' => 4,'invalid_optional_date' => 5,'invalid_corp_vendor' => 6,'invalid_state_origin' => 7,'invalid_forgn_dom_code' => 8,'invalid_for_profit_ind' => 9,'invalid_status' => 10,'invalid_name_type_desc' => 11,'invalid_name_type_cd' => 12,'invalid_recordorigin' => 13,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['38','38']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('38|38'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['ND','ND']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('ND|ND'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_for_profit_ind(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_profit_ind(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['N',' ']);
EXPORT InValidMessageFT_invalid_for_profit_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('N| '),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN Scrubs_Corp2_Mapping_ND_Main.Functions.set_valid_status);
EXPORT InValidMessageFT_invalid_status(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_ND_Main.Functions.set_valid_status'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT311.StrType s,SALT311.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ND_Main.Functions.invalid_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ND_Main.Functions.invalid_name_type_desc'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_cd(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_cd(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['01','03','04','F',' ']);
EXPORT InValidMessageFT_invalid_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('01|03|04|F| '),SALT311.HygieneErrors.Good);
...
EXPORT FieldNum(SALT311.StrType fn) := CASE(fn,'dt_vendor_first_reported' => 0,'dt_vendor_last_reported' => 1,'dt_first_seen' => 2,'dt_last_seen' => 3,'corp_ra_dt_first_seen' => 4,'corp_ra_dt_last_seen' => 5,'corp_trademark_filing_date' => 6,'corp_key' => 7,'corp_vendor' => 8,'corp_state_origin' => 9,'corp_process_date' => 10,'corp_orig_sos_charter_nbr' => 11,'corp_legal_name' => 12,'corp_filing_date' => 13,'corp_status_date' => 14,'corp_status_desc' => 15,'corp_inc_state' => 16,'corp_inc_date' => 17,'corp_foreign_domestic_ind' => 18,'corp_forgn_date' => 19,'corp_for_profit_ind' => 20,'corp_ln_name_type_cd' => 21,'corp_ln_name_type_desc' => 22,'corp_delayed_effective_date' => 23,'corp_term_exist_exp' => 24,'corp_trademark_expiration_date' => 25,'recordorigin' => 26,0);
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','LENGTHS'],['ENUM'],['ENUM'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','LENGTHS'],['LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ENUM'],['ENUM'],['ALLOW','CUSTOM','LENGTHS'],['ENUM'],['ALLOW','CUSTOM','LENGTHS'],['ENUM'],['ENUM'],['CUSTOM'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ENUM'],[]);
...
EXPORT Make_corp_trademark_filing_date(SALT311.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_trademark_filing_date(SALT311.StrType s) := InValidFT_invalid_optional_date(s);
...
EXPORT Make_corp_status_date(SALT311.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_status_date(SALT311.StrType s) := InValidFT_invalid_optional_date(s);
...
EXPORT Make_corp_ln_name_type_cd(SALT311.StrType s0) := MakeFT_invalid_name_type_cd(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT311.StrType s) := InValidFT_invalid_name_type_cd(s);
...
EXPORT Make_corp_delayed_effective_date(SALT311.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_delayed_effective_date(SALT311.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_delayed_effective_date(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_term_exist_exp(SALT311.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_term_exist_exp(SALT311.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_term_exist_exp(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_trademark_expiration_date(SALT311.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_trademark_expiration_date(SALT311.StrType s) := InValidFT_invalid_optional_date(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Corp2_Mapping_ND_Main;
