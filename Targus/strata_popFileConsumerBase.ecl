import ut, data_services, std, strata;
...
strata.createXMLStats(tStats,'Targus White Pages','data',(string)std.date.today(),'',resultsOut);

export strata_popFileConsumerBase := resultsOut;
