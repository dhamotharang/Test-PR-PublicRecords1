export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1	 	:= 'ADDRESS NOT YET REPORTED|SAME SEE 4|SEE 4|SAME AS ABOVE|SAME|AS ABOVE|NOT GIVEN|NOT PROVIDED|';		
		shared PatternInvalidWords2	 	:= 'AS ADDRESSED|^NONE|^NA|AL NONE|VARIOUS|^N\\/A$|INACTIVE|(NO STREET ADDRESSS FOR CORP OR DIRECTORS)';
	...
	export City := module
		...
		shared PatternInvalidWords1		:= 'SAME AS ABOVE|^SAME$|^NONE$|NOT GIVEN|NOT PROVIDED|AS ADDRESSED';
	...
	export State := module
		...
		SHARED PatternInvalidWords1		 := '^XX|SAME AS ABOVE|^SAME$|^NONE$|NOT GIVEN|NOT PROVIDED|AS ADDRESSED';
