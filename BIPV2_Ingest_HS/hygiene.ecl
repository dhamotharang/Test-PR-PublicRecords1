...
SALT35.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),123*123,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'source'}
      ...
      ,{40,'name_score'}
      ,{41,'company_name'}
      ,{42,'company_name_type_raw'}
      ,{43,'company_name_type_derived'}
      ,{44,'company_rawaid'}
      ,{45,'prim_range'}
      ,{46,'predir'}
      ,{47,'prim_name'}
      ...
      ,{71,'err_stat'}
      ,{72,'company_bdid'}
      ,{73,'company_address_type_raw'}
      ,{74,'company_fein'}
      ,{75,'best_fein_indicator'}
      ,{76,'company_phone'}
      ,{77,'phone_type'}
      ,{78,'phone_score'}
      ,{79,'company_org_structure_raw'}
      ,{80,'company_incorporation_date'}
      ,{81,'company_sic_code1'}
      ,{82,'company_sic_code2'}
      ,{83,'company_sic_code3'}
      ,{84,'company_sic_code4'}
      ,{85,'company_sic_code5'}
      ,{86,'company_naics_code1'}
      ,{87,'company_naics_code2'}
      ,{88,'company_naics_code3'}
      ,{89,'company_naics_code4'}
      ,{90,'company_naics_code5'}
      ,{91,'company_ticker'}
      ,{92,'company_ticker_exchange'}
      ,{93,'company_foreign_domestic'}
      ,{94,'company_url'}
      ,{95,'company_inc_state'}
      ,{96,'company_charter_number'}
      ,{97,'company_filing_date'}
      ,{98,'company_status_date'}
      ,{99,'company_foreign_date'}
      ,{100,'event_filing_date'}
      ,{101,'company_name_status_raw'}
      ,{102,'company_status_raw'}
      ,{103,'vl_id'}
      ,{104,'current'}
      ,{105,'contact_did'}
      ,{106,'contact_type_raw'}
      ,{107,'contact_job_title_raw'}
      ,{108,'contact_ssn'}
      ,{109,'contact_dob'}
      ,{110,'contact_status_raw'}
      ,{111,'contact_email'}
      ,{112,'contact_email_username'}
      ,{113,'contact_email_domain'}
      ,{114,'contact_phone'}
      ,{115,'from_hdr'}
      ,{116,'company_department'}
      ,{117,'company_address_type_derived'}
      ,{118,'company_org_structure_derived'}
      ,{119,'company_name_status_derived'}
      ,{120,'company_status_derived'}
      ,{121,'contact_type_derived'}
      ,{122,'contact_job_title_derived'}
      ,{123,'contact_status_derived'}],SALT35.MAC_Character_Counts.Field_Identification);
...
END;
Errors := NORMALIZE(h,123,NoteErrors(LEFT,COUNTER));
