...
#workunit('name','BIPV2_Ingest_HS.BWR_Hygiene - Hygiene & Stats - SALT V3.5.2');
IMPORT BIPV2_Ingest_HS,SALT35;
// First create an instantiated hygiene module
  infile := BIPV2_Ingest_HS.In_BASE;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := BIPV2_Ingest_HS.Hygiene(ip);
  ...
  CM := BIPV2_Ingest_HS.Fields.UIDConsistency(BIPV2_Ingest_HS.In_BASE);
