...
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'WORDBAG','NAME','CITY','fld_contact','zip5','hasZip4','alpha_st','number','multiword','Noblanks');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'WORDBAG' => 1,'NAME' => 2,'CITY' => 3,'fld_contact' => 4,'zip5' => 5,'hasZip4' => 6,'alpha_st' => 7,'number' => 8,'multiword' => 9,'Noblanks' => 10,0);
...
EXPORT MakeFT_NAME(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_NAME(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\''))));
EXPORT InValidMessageFT_NAME(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\''),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_zip5(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_zip5(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 5));
EXPORT InValidMessageFT_zip5(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.NotLength('5'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_alpha_st(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_alpha_st(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))),~(LENGTH(TRIM(s)) = 2));
EXPORT InValidMessageFT_alpha_st(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.NotLength('2'),SALT35.HygieneErrors.Good);
...
EXPORT Make_active_duns_number(SALT35.StrType s0) := s0;
EXPORT InValid_active_duns_number(SALT35.StrType s) := 0;
...
EXPORT Make_active_enterprise_number(SALT35.StrType s0) := s0;
EXPORT InValid_active_enterprise_number(SALT35.StrType s) := 0;
...
EXPORT Make_ebr_file_number(SALT35.StrType s0) := s0;
EXPORT InValid_ebr_file_number(SALT35.StrType s) := 0;
EXPORT InValidMessage_ebr_file_number(UNSIGNED1 wh) := '';
 
EXPORT Make_active_domestic_corp_key(SALT35.StrType s0) := s0;
EXPORT InValid_active_domestic_corp_key(SALT35.StrType s) := 0;
...
EXPORT Make_foreign_corp_key(SALT35.StrType s0) := s0;
EXPORT InValid_foreign_corp_key(SALT35.StrType s) := 0;
...
EXPORT Make_name_suffix(SALT35.StrType s0) := MakeFT_NAME(s0);
EXPORT InValid_name_suffix(SALT35.StrType s) := InValidFT_NAME(s);
EXPORT InValidMessage_name_suffix(UNSIGNED1 wh) := InValidMessageFT_NAME(wh);
...
EXPORT Make_company_inc_state(SALT35.StrType s0) := s0;
EXPORT InValid_company_inc_state(SALT35.StrType s) := 0;
EXPORT InValidMessage_company_inc_state(UNSIGNED1 wh) := '';
 
EXPORT Make_company_charter_number(SALT35.StrType s0) := s0;
EXPORT InValid_company_charter_number(SALT35.StrType s) := 0;
...
EXPORT Make_contact_ssn(SALT35.StrType s0) := MakeFT_number(s0);
EXPORT InValid_contact_ssn(SALT35.StrType s) := InValidFT_number(s);
...
EXPORT Make_contact_email(SALT35.StrType s0) := s0;
EXPORT InValid_contact_email(SALT35.StrType s) := 0;
