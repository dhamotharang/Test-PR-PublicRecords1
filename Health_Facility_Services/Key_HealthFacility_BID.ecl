...
EXPORT KeyName := Health_Facility_Services.Files.FILE_BDID_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::BID';
...
#IF(#TEXT(Input_BDID)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_BID.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_BID.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
