...
EXPORT KeyName := Health_Facility_Services.Files.FILE_NCPDP_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::NCPDP';
...
#IF(#TEXT(Input_NCPDP_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_NCPDP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_NCPDP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
