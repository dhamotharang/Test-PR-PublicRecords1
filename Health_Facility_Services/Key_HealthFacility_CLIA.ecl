...
EXPORT KeyName := Health_Facility_Services.Files.FILE_CLIA_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::CLIA';
...
#IF(#TEXT(Input_CLIA_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_CLIA.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_CLIA.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
