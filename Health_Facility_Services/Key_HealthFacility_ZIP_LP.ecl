...
EXPORT KeyName := Health_Facility_Services.Files.FILE_ZIP_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::ZIP_LP';
...
#IF(#TEXT(Input_PRIM_NAME)<>'' AND #TEXT(Input_ZIP)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_ZIP_LP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_ZIP_LP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
