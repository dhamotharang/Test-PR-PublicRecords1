...
#workunit('name','Health_Facility_Services.BWR_UseExternal - Using External Linking - SALT V2.9 Gold SR1');
...
// This is the 'thor only' version (no roxie)
  ...
  Health_Facility_Services.MAC_Meow_xLNPID_Batch(myinfile,myrefence_number,/* MY_CNAME*/,/* MY_CNP_NAME*/,/* MY_CNP_NUMBER*/,/* MY_CNP_STORE_NUMBER*/
          ...
          ,/* MY_NCPDP_NUMBER*/,/* MY_BDID*/,/* MY_SRC*/,/* MY_SOURCE_RID*/,/* MY_FAC_NAME*/
          ,/* MY_ADDR1*/,/* MY_LOCALE*/,/* MY_ADDRESS*/,MyOutFile,SmallJob,Stats);
...
//        ,/* MY_VENDOR_ID*/,/* MY_NPI_NUMBER*/,/* MY_CLIA_NUMBER*/,/* MY_MEDICARE_FACILITY_NUMBER*/,/* MY_MEDICAID_NUMBER*/
//        ,/* MY_NCPDP_NUMBER*/,/* MY_BDID*/,/* MY_SRC*/,/* MY_SOURCE_RID*/,/* MY_FAC_NAME*/
//        ,/* MY_ADDR1*/,/* MY_LOCALE*/,/* MY_ADDRESS*/,MyOutFile,Stats);
  MyOutFile;
  Stats;
