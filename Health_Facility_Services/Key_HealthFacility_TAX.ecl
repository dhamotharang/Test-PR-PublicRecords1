...
EXPORT KeyName := Health_Facility_Services.Files.FILE_Tax_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::TAX';
...
#IF(#TEXT(Input_TAX_ID)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_TAX.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_TAX.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
