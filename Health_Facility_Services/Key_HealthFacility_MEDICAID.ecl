...
EXPORT KeyName := Health_Facility_Services.Files.FILE_MEDICAID_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::MEDICAID';
...
#IF(#TEXT(Input_MEDICAID_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_MEDICAID.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_MEDICAID.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
