...
EXPORT KeyName := Health_Facility_Services.Files.FILE_City_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::CITY_LP';
...
#IF(#TEXT(Input_PRIM_NAME)<>'' AND #TEXT(Input_V_CITY_NAME)<>'' AND #TEXT(Input_ST)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_CITY_LP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_CITY_LP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
