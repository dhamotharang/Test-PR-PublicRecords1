...
EXPORT KeyName := Health_Facility_Services.Files.FILE_VendorID_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::VEN';
...
#IF(#TEXT(Input_VENDOR_ID)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_VEN.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_VEN.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
