...
EXPORT KeyName := Health_Facility_Services.Files.FILE_FEIN_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::FEN';
...
#IF(#TEXT(Input_FEIN)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_FEN.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_FEN.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
