...
EXPORT KeyName := Health_Facility_Services.Files.FILE_PHONE_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::PHONE_LP';
...
#IF(#TEXT(Input_PHONE)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_PHONE_LP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_PHONE_LP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
