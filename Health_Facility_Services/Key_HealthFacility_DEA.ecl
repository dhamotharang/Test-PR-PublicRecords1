...
EXPORT KeyName := Health_Facility_Services.Files.FILE_DEA_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::DEA';
...
#IF(#TEXT(Input_DEA_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_DEA.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_DEA.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
