...
EXPORT KeyName := Health_Facility_Services.Files.FILE_LIC_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::LIC';
...
#IF(#TEXT(Input_C_LIC_NBR)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_LIC.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_LIC.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
