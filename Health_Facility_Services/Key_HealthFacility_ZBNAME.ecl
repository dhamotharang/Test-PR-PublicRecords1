...
EXPORT KeyName := Health_Facility_Services.Files.FILE_BName_Zip_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::ZBNAME';
...
#IF(#TEXT(Input_CNP_NAME)<>'' AND #TEXT(Input_ZIP)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_ZBNAME.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_ZBNAME.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
