...
EXPORT KeyName := Health_Facility_Services.Files.FILE_BName_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::BNAME';
...
#IF(#TEXT(Input_CNP_NAME)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_BNAME.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_BNAME.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
