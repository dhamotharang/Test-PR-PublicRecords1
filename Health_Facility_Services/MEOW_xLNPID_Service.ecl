...
EXPORT MEOW_xLNPID_Service := MACRO
  ...
  ,(TYPEOF(Template.TAXONOMY_CODE))Health_Facility_Services.Fields.Make_TAXONOMY_CODE((SALT29.StrType)Input_TAXONOMY_CODE)
  ...
  ,false,false,0}],Health_Facility_Services.Process_xLNPID_Layouts.InputLayout);
