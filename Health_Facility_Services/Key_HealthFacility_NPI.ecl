...
EXPORT KeyName := Health_Facility_Services.Files.FILE_NPI_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::NPI';
...
#IF(#TEXT(Input_NPI_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_NPI.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_NPI.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
