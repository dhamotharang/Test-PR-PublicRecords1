...
EXPORT KeyName := Health_Facility_Services.Files.FILE_MEDICARE_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::MEDICARE';
...
#IF(#TEXT(Input_MEDICARE_FACILITY_NUMBER)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_MEDICARE.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_MEDICARE.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
