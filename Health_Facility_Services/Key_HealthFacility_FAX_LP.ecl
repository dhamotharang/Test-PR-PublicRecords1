...
EXPORT KeyName := Health_Facility_Services.Files.FILE_FAX_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::FAX_LP';
...
#IF(#TEXT(Input_FAX)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_FAX_LP.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_FAX_LP.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
