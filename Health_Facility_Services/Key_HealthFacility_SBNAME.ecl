...
EXPORT KeyName := Health_Facility_Services.Files.FILE_BName_St_SF; //'~'+'key::Health_Facility_Services::LNPID::Refs::SBNAME';
...
#IF(#TEXT(Input_CNP_NAME)<>'' AND #TEXT(Input_ST)<>'')
  #uniquename(trans)
  Health_Facility_Services.Key_HealthFacility_SBNAME.InputLayout_Batch %trans%(InFile le) := TRANSFORM
  ...
  output_file := Health_Facility_Services.Key_HealthFacility_SBNAME.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
