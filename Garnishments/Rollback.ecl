...
export Rollback(
	 string								pversion						=		''
//	,boolean							pDeleteInputFiles		= 	false		//don't allow deletion of inputs since they belong to another build
...
module
	...
	export inputfiles	:= tools.mod_RollbackInput(pInputFilenames,pFilter,false,pIsTesting);
