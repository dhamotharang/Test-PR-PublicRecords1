...
#workunit('name','BIPV2_ProxID.BWR_Best - BEST - SALT V3.0 Gold');
...
BIPV2_ProxID.Best(BIPV2_ProxID.In_DOT_Base).Stats;
...
b := BIPV2_ProxID.Best(BIPV2_ProxID.In_DOT_Base); // Instantiate Best module
