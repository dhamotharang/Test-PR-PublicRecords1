...
EXPORT input_file := h0 : PERSIST('~temp::Proxid::BIPV2_ProxID::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have Proxid specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.Proxid;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,Proxid,LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID::Cluster_Sizes',EXPIRE(Config.PersistExpire));
EXPORT TotalClusters := COUNT(ClusterSizes);
 
EXPORT  active_duns_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_duns_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::active_duns_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  active_enterprise_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_enterprise_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::active_enterprise_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  active_domestic_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_domestic_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::active_domestic_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  hist_enterprise_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_enterprise_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::hist_enterprise_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  hist_duns_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_duns_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::hist_duns_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  hist_domestic_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_domestic_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::hist_domestic_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  foreign_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,foreign_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::foreign_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  unk_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,unk_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::unk_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  ebr_file_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,ebr_file_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::ebr_file_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  company_fein_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_fein) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::company_fein',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  cnp_name_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,cnp_name) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::cnp_name',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT cnp_nameValuesKeyName := '~'+'key::BIPV2_ProxID::Proxid::Word::cnp_name';
...
EXPORT  cnp_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,cnp_number) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::cnp_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  cnp_btype_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,cnp_btype) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::cnp_btype',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  company_phone_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_phone) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::company_phone',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  prim_name_derived_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,prim_name_derived) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::prim_name_derived',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT prim_name_derivedValuesKeyName := '~'+'key::BIPV2_ProxID::Proxid::Word::prim_name_derived';
...
EXPORT  sec_range_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,sec_range) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::sec_range',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  v_city_name_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,v_city_name) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::v_city_name',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  st_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,st) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::st',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  zip_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,zip) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::zip',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  prim_range_derived_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,prim_range_derived) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::prim_range_derived',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  company_csz_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_csz) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::company_csz',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  company_addr1_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_addr1) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::company_addr1',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  company_address_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_address) : PERSIST('~temp::Proxid::BIPV2_ProxID::dedups::company_address',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT company_address_specificity := ol;
  ...
  END;
  t := TABLE(infile,r);
SHARED SrcRidVlid_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID::values::SrcRidVlid',EXPIRE(Config.PersistExpire));
...
EXPORT SrcRidVlid_values_persisted := SrcRidVlid_values_index;
  ...
  END;
  t := TABLE(infile,r);
SHARED ForeignCorpkey_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID::values::ForeignCorpkey',EXPIRE(Config.PersistExpire));
...
EXPORT ForeignCorpkey_values_persisted := ForeignCorpkey_values_index;
  ...
  END;
  t := TABLE(infile,r);
SHARED RAAddresses_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID::values::RAAddresses',EXPIRE(Config.PersistExpire));
...
EXPORT RAAddresses_values_persisted := RAAddresses_values_index;
  ...
  END;
  t := TABLE(infile,r);
SHARED FilterPrimNames_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID::values::FilterPrimNames',EXPIRE(Config.PersistExpire));
...
SpcShiftR := RECORD
  ...
  integer2 active_duns_number_switch_shift0 := ROUND(1000*Specificities[1].active_duns_number_switch - 22);
  ...
  integer2 active_domestic_corp_key_switch_shift0 := ROUND(1000*Specificities[1].active_domestic_corp_key_switch - 5);
  integer1 hist_enterprise_number_shift0 := ROUND(Specificities[1].hist_enterprise_number_specificity - 27);
  integer2 hist_enterprise_number_switch_shift0 := ROUND(1000*Specificities[1].hist_enterprise_number_switch - 6);
  integer1 hist_duns_number_shift0 := ROUND(Specificities[1].hist_duns_number_specificity - 27);
  integer2 hist_duns_number_switch_shift0 := ROUND(1000*Specificities[1].hist_duns_number_switch - 169);
  ...
  integer2 foreign_corp_key_switch_shift0 := ROUND(1000*Specificities[1].foreign_corp_key_switch - 155);
  integer1 unk_corp_key_shift0 := ROUND(Specificities[1].unk_corp_key_specificity - 27);
  integer2 unk_corp_key_switch_shift0 := ROUND(1000*Specificities[1].unk_corp_key_switch - 48);
  integer1 ebr_file_number_shift0 := ROUND(Specificities[1].ebr_file_number_specificity - 28);
  integer2 ebr_file_number_switch_shift0 := ROUND(1000*Specificities[1].ebr_file_number_switch - 223);
  integer1 company_fein_shift0 := ROUND(Specificities[1].company_fein_specificity - 27);
  integer2 company_fein_switch_shift0 := ROUND(1000*Specificities[1].company_fein_switch - 155);
  integer1 cnp_name_shift0 := ROUND(Specificities[1].cnp_name_specificity - 15);
  integer2 cnp_name_switch_shift0 := ROUND(1000*Specificities[1].cnp_name_switch - 160);
  ...
  integer2 cnp_btype_switch_shift0 := ROUND(1000*Specificities[1].cnp_btype_switch - 49);
  ...
  integer2 company_csz_switch_shift0 := ROUND(1000*Specificities[1].company_csz_switch - 25);
  ...
  INTEGER2 SrcRidVlid_switch_shift0 := ROUND(1000*Specificities[1].SrcRidVlid_switch - 620);
  INTEGER1 ForeignCorpkey_shift0 := ROUND(Specificities[1].ForeignCorpkey_specificity - 27);
  INTEGER2 ForeignCorpkey_switch_shift0 := ROUND(1000*Specificities[1].ForeignCorpkey_switch - 38);
