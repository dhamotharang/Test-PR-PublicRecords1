...
SHARED FldIds := DATASET([{1,'active_duns_number'}
      ...
      ,{10,'company_fein'}
      ,{11,'company_name'}
      ,{12,'cnp_name_phonetic'}
      ,{13,'cnp_name'}
      ,{14,'company_name_type_raw'}
      ,{15,'company_name_type_derived'}
      ,{16,'cnp_hasnumber'}
      ,{17,'cnp_number'}
      ,{18,'cnp_btype'}
      ,{19,'cnp_lowv'}
      ,{20,'cnp_translated'}
      ,{21,'cnp_classid'}
      ,{22,'company_foreign_domestic'}
      ,{23,'company_bdid'}
      ,{24,'company_phone'}
      ,{25,'prim_name'}
      ,{26,'prim_name_derived'}
      ,{27,'sec_range'}
      ,{28,'v_city_name'}
      ,{29,'st'}
      ,{30,'zip'}
      ,{31,'prim_range'}
      ,{32,'prim_range_derived'}
      ,{33,'dt_first_seen'}
      ,{34,'dt_last_seen'}],SALT311.MAC_Character_Counts.Field_Identification);
