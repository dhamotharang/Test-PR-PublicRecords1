...
daddunique := project(dcorpy_topRA_addresses_iter/*(running_total_percent <= 80.0)*/,transform({unsigned6 rcid,recordof(left)},self.rcid := counter,self := left));//,2000); //limit to 2000 addresses
...
export file_RA_Addresses  := table(file_RA_Addresses2/* + file_RA_Addresses3*/,{proxid,cname},proxid,cname,merge);
