...
#workunit('name','BIPV2_ProxID.BWR_Specificities - Specificities - SALT V3.0 Gold');
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_ProxID.<your_spc_attribute>',BIPV2_ProxID.In_DOT_Base);
