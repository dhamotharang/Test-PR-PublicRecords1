...
EXPORT Layout_Sample_Matches := RECORD(match_candidates(ih).Layout_Matches)
  ...
  TYPEOF(h.hist_corp_key) left_hist_corp_key;
  INTEGER1 hist_corp_key_match_code;
  INTEGER2 hist_corp_key_score;
  INTEGER2 hist_corp_key_score_prop;
  TYPEOF(h.hist_corp_key) right_hist_corp_key;
...
EXPORT layout_sample_matches sample_match_join(match_candidates(ih).layout_candidates le,match_candidates(ih).layout_candidates ri,UNSIGNED c=0,UNSIGNED outside=0,UNSIGNED cnp_name_support0 = 0) := TRANSFORM
  ...
  SELF.hist_enterprise_number_match_code := MAP(
                        le.hist_enterprise_number_isnull OR ri.hist_enterprise_number_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.ebr_file_number_match_code := MAP(
                        le.ebr_file_number_isnull OR ri.ebr_file_number_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.active_enterprise_number_match_code := MAP(
                        le.active_enterprise_number_isnull OR ri.active_enterprise_number_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.left_hist_corp_key := le.hist_corp_key;
  SELF.right_hist_corp_key := ri.hist_corp_key;
  SELF.hist_corp_key_match_code := MAP(
                        le.hist_corp_key_isnull OR ri.hist_corp_key_isnull => SALT311.MatchCode.OneSideNull,
                        match_methods(ih).match_hist_corp_key(le.hist_corp_key,ri.hist_corp_key));
  SELF.hist_corp_key_score := MAP(
  ...
  SELF.hist_duns_number_match_code := MAP(
                        le.hist_duns_number_isnull OR ri.hist_duns_number_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.company_phone_match_code := MAP(
                        le.company_phone_isnull OR ri.company_phone_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.company_name_type_derived_match_code := MAP(
                        le.company_name_type_derived_isnull OR ri.company_name_type_derived_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.company_addr1_match_code := MAP(
                        (le.company_addr1_isnull OR le.prim_range_derived_isnull AND le.prim_name_derived_isnull AND le.sec_range_isnull) OR (ri.company_addr1_isnull OR ri.prim_range_derived_isnull AND ri.prim_name_derived_isnull AND ri.sec_range_isnull) => SALT311.MatchCode.OneSideNull,
                        company_address_score_pre > 0 => SALT311.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.company_csz_match_code := MAP(
                        (le.company_csz_isnull OR le.v_city_name_isnull AND le.st_isnull AND le.zip_isnull) OR (ri.company_csz_isnull OR ri.v_city_name_isnull AND ri.st_isnull AND ri.zip_isnull) OR le.company_csz_weight100 = 0 => SALT311.MatchCode.OneSideNull,
                        company_address_score_pre > 0 => SALT311.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.cnp_name_match_code := MAP(
                        le.cnp_name_isnull OR ri.cnp_name_isnull => SALT311.MatchCode.OneSideNull,
  ...
  SELF.prim_name_derived_match_code := MAP(
                        le.prim_name_derived_isnull OR ri.prim_name_derived_isnull => SALT311.MatchCode.OneSideNull,
                        company_addr1_score_pre > 0 OR company_address_score_pre > 0 => SALT311.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.v_city_name_match_code := MAP(
                        le.v_city_name_isnull OR ri.v_city_name_isnull => SALT311.MatchCode.OneSideNull,
                        company_csz_score_pre > 0 OR company_address_score_pre > 0 => SALT311.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
                        le.st_isnull OR ri.st_isnull OR le.st <> ri.st  => SALT311.MatchCode.ContextInvolved, // Only valid if the context variable is equal
  ...
  SELF.prim_range_derived_match_code := MAP(
                        le.prim_range_derived_isnull OR ri.prim_range_derived_isnull => SALT311.MatchCode.OneSideNull,
                        company_addr1_score_pre > 0 OR company_address_score_pre > 0 => SALT311.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.cnp_name_score := IF ( cnp_name_score_supp >= Config.cnp_name_Force * 100 OR SELF.company_charter_number_score > Config.cnp_name_OR1_company_charter_number_Force*100 OR SELF.active_duns_number_score > Config.cnp_name_OR2_active_duns_number_Force*100 OR SELF.company_fein_score > Config.cnp_name_OR3_company_fein_Force*100 OR SELF.cnp_name_phonetic_score > Config.cnp_name_OR4_cnp_name_phonetic_Force*100 OR SELF.sbfe_id_score > Config.cnp_name_OR5_sbfe_id_Force*100, cnp_name_score_supp, -9999 ); // Enforce FORCE parameter
...
// Compute the score for the concept company_addr1
  INTEGER2 company_addr1_score_ext := SALT311.ClipScore(MAX(company_addr1_score_pre,0) + self.prim_range_derived_score + self.prim_name_derived_score + self.sec_range_score + MAX(company_address_score_pre,0));// Score in surrounding context
...
// Compute the score for the concept company_csz
  INTEGER2 company_csz_score_ext := SALT311.ClipScore(MAX(company_csz_score_pre,0) + self.v_city_name_score + self.st_score + self.zip_score + MAX(company_address_score_pre,0));// Score in surrounding context
...
// Compute the score for the concept company_address
  INTEGER2 company_address_score_ext := SALT311.ClipScore(MAX(company_address_score_pre,0)+ SELF.company_addr1_score + self.prim_range_derived_score + self.prim_name_derived_score + self.sec_range_score+ SELF.company_csz_score + self.v_city_name_score + self.st_score + self.zip_score);// Score in surrounding context
  ...
  SELF.hist_corp_key_score_prop := MAX(le.hist_corp_key_prop,ri.hist_corp_key_prop)*SELF.hist_corp_key_score; // Score if either field propogated
  ...
  SELF.Conf_Prop := (0 + SELF.cnp_number_score_prop + SELF.prim_range_derived_score_prop + SELF.hist_enterprise_number_score_prop + SELF.ebr_file_number_score_prop + SELF.active_enterprise_number_score_prop + SELF.hist_corp_key_score_prop + SELF.hist_duns_number_score_prop + SELF.active_duns_number_score_prop + SELF.company_phone_score_prop + SELF.company_fein_score_prop + SELF.company_addr1_score_prop + SELF.sec_range_score_prop + SELF.company_name_type_derived_score_prop + SELF.company_address_score_prop) / 100; // Score based on propogated fields
  SELF.Conf := (SELF.cnp_number_score + SELF.sbfe_id_score + SELF.company_charter_number_score + SELF.hist_enterprise_number_score + SELF.ebr_file_number_score + SELF.active_enterprise_number_score + SELF.hist_corp_key_score + SELF.hist_duns_number_score + SELF.active_duns_number_score + SELF.company_phone_score + SELF.company_fein_score /*+ SELF.cnp_name_phonetic_score*/ /*HACKcnp_name_phonetic_score*/ + SELF.cnp_name_score + SELF.company_inc_state_score + SELF.cnp_btype_score + SELF.company_name_type_derived_score + IF(SELF.company_address_score>0,MAX(SELF.company_address_score,IF(SELF.company_addr1_score>0,MAX(SELF.company_addr1_score,SELF.prim_range_derived_score + SELF.prim_name_derived_score + SELF.sec_range_score),SELF.prim_range_derived_score + SELF.prim_name_derived_score + SELF.sec_range_score) + IF(SELF.company_csz_score>0,MAX(SELF.company_csz_score,SELF.v_city_name_score + SELF.st_score + SELF.zip_score),SELF.v_city_name_score + SELF.st_score + SELF.zip_score)),IF(SELF.company_addr1_score>0,MAX(SELF.company_addr1_score,SELF.prim_range_derived_score + SELF.prim_name_derived_score + SELF.sec_range_score),SELF.prim_range_derived_score + SELF.prim_name_derived_score + SELF.sec_range_score) + IF(SELF.company_csz_score>0,MAX(SELF.company_csz_score,SELF.v_city_name_score + SELF.st_score + SELF.zip_score),SELF.v_city_name_score + SELF.st_score + SELF.zip_score))) / 100 + outside;
END;
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT311.Layout_FieldValueList) hist_corp_key_Values := DATASET([],SALT311.Layout_FieldValueList);
  ...
  DATASET(SALT311.Layout_FieldValueList) cnp_name_phonetic_Values := DATASET([],SALT311.Layout_FieldValueList);
...
SHARED RollEntities(dataset(Layout_RolledEntity) infile) := FUNCTION
  ...
  SELF.Proxid := le.Proxid;
    ...
    SELF.hist_enterprise_number_values := SALT311.fn_combine_fieldvaluelist(le.hist_enterprise_number_values,ri.hist_enterprise_number_values);
    SELF.ebr_file_number_values := SALT311.fn_combine_fieldvaluelist(le.ebr_file_number_values,ri.ebr_file_number_values);
    SELF.active_enterprise_number_values := SALT311.fn_combine_fieldvaluelist(le.active_enterprise_number_values,ri.active_enterprise_number_values);
    SELF.hist_corp_key_values := SALT311.fn_combine_fieldvaluelist(le.hist_corp_key_values,ri.hist_corp_key_values);
    ...
    SELF.cnp_name_phonetic_values := SALT311.fn_combine_fieldvaluelist(le.cnp_name_phonetic_values,ri.cnp_name_phonetic_values);
    ...
    SELF.company_name_type_raw_values := SALT311.fn_combine_fieldvaluelist(le.company_name_type_raw_values,ri.company_name_type_raw_values);
    ...
    SELF.company_foreign_domestic_values := SALT311.fn_combine_fieldvaluelist(le.company_foreign_domestic_values,ri.company_foreign_domestic_values);
    SELF.company_bdid_values := SALT311.fn_combine_fieldvaluelist(le.company_bdid_values,ri.company_bdid_values);
    ...
    SELF.company_address_values := SALT311.fn_combine_fieldvaluelist(le.company_address_values,ri.company_address_values);
  ...
  Layout_RolledEntity SortValues(Layout_RolledEntity le) := TRANSFORM
    ...
    SELF.hist_corp_key_values := SORT(le.hist_corp_key_values, -cnt, val, LOCAL);
    ...
    SELF.cnp_name_phonetic_values := SORT(le.cnp_name_phonetic_values, -cnt, val, LOCAL);
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  ...
  SELF.ebr_file_number_Values := IF ( (le.ebr_file_number  IN SET(s.nulls_ebr_file_number,ebr_file_number) OR le.ebr_file_number = (TYPEOF(le.ebr_file_number))''),DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.ebr_file_number)}],SALT311.Layout_FieldValueList));
  ...
  SELF.hist_corp_key_Values := IF ( (le.hist_corp_key  IN SET(s.nulls_hist_corp_key,hist_corp_key) OR le.hist_corp_key = (TYPEOF(le.hist_corp_key))''),DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.hist_corp_key)}],SALT311.Layout_FieldValueList));
  SELF.hist_duns_number_Values := IF ( (le.hist_duns_number  IN SET(s.nulls_hist_duns_number,hist_duns_number) OR le.hist_duns_number = (TYPEOF(le.hist_duns_number))''),DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.hist_duns_number)}],SALT311.Layout_FieldValueList));
  ...
  SELF.cnp_name_phonetic_Values := IF ( (le.cnp_name_phonetic  IN SET(s.nulls_cnp_name_phonetic,cnp_name_phonetic) OR le.cnp_name_phonetic = (TYPEOF(le.cnp_name_phonetic))''),DATASET([],SALT311.Layout_FieldValueList),DATASET([{TRIM((SALT311.StrType)le.cnp_name_phonetic)}],SALT311.Layout_FieldValueList));
  ...
  SELF.company_name_Values := DATASET([{TRIM((SALT311.StrType)le.company_name)}],SALT311.Layout_FieldValueList);
  SELF.company_name_type_raw_Values := DATASET([{TRIM((SALT311.StrType)le.company_name_type_raw)}],SALT311.Layout_FieldValueList);
  ...
  SELF.company_foreign_domestic_Values := DATASET([{TRIM((SALT311.StrType)le.company_foreign_domestic)}],SALT311.Layout_FieldValueList);
  SELF.company_bdid_Values := DATASET([{TRIM((SALT311.StrType)le.company_bdid)}],SALT311.Layout_FieldValueList);
...
EXPORT RemoveProps(DATASET(match_candidates(ih).layout_candidates) im) := FUNCTION
  ...
  im rem(im le) := TRANSFORM
    ...
    self.hist_corp_key := if ( le.hist_corp_key_prop>0, (TYPEOF(le.hist_corp_key))'', le.hist_corp_key ); // Blank if propogated
    self.hist_corp_key_isnull := le.hist_corp_key_prop>0 OR le.hist_corp_key_isnull;
    self.hist_corp_key_prop := 0; // Avoid reducing score later
...
Layout_Chubbies0 := RECORD,MAXLENGTH(63000)
  ...
  UNSIGNED1 hist_corp_key_size := 0;
  ...
  UNSIGNED1 cnp_name_phonetic_size := 0;
...
Layout_Chubbies0 NoteSize(Layout_Chubbies0 le) := TRANSFORM
  ...
  SELF.hist_enterprise_number_size := SALT311.Fn_SwitchSpec(s.hist_enterprise_number_switch,count(le.hist_enterprise_number_values));
  SELF.ebr_file_number_size := SALT311.Fn_SwitchSpec(s.ebr_file_number_switch,count(le.ebr_file_number_values));
  SELF.active_enterprise_number_size := SALT311.Fn_SwitchSpec(s.active_enterprise_number_switch,count(le.active_enterprise_number_values));
  SELF.hist_corp_key_size := SALT311.Fn_SwitchSpec(s.hist_corp_key_switch,count(le.hist_corp_key_values));
  SELF.hist_duns_number_size := SALT311.Fn_SwitchSpec(s.hist_duns_number_switch,count(le.hist_duns_number_values));
  ...
  SELF.cnp_name_phonetic_size := SALT311.Fn_SwitchSpec(s.cnp_name_phonetic_switch,count(le.cnp_name_phonetic_values));
  ...
  SELF.company_address_size := SALT311.Fn_SwitchSpec(s.company_address_switch,count(le.company_address_values));
  SELF := le;
END;  t := PROJECT(t0,NoteSize(LEFT));
Layout_Chubbies := RECORD,MAXLENGTH(63000)
  t;
  UNSIGNED2 Size := t.cnp_number_size+t.sbfe_id_size+t.company_charter_number_size+t.hist_enterprise_number_size+t.ebr_file_number_size+t.active_enterprise_number_size+t.hist_corp_key_size+t.hist_duns_number_size+t.active_duns_number_size+t.company_phone_size+t.company_fein_size+t.cnp_name_phonetic_size+t.cnp_name_size+t.company_inc_state_size+t.cnp_btype_size+t.company_name_type_derived_size+t.company_address_size;
END;
