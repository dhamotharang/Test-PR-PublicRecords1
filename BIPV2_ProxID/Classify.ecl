...
SHARED TotalClusters := Specificities(h).TotalClusters;
  ...
  hist_enterprise_number_tokens := PROJECT(Specificities(h).hist_enterprise_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.hist_enterprise_number; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  ebr_file_number_tokens := PROJECT(Specificities(h).ebr_file_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.ebr_file_number; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  active_enterprise_number_tokens := PROJECT(Specificities(h).active_enterprise_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.active_enterprise_number; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  hist_domestic_corp_key_tokens := PROJECT(Specificities(h).hist_domestic_corp_key_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.hist_domestic_corp_key; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  foreign_corp_key_tokens := PROJECT(Specificities(h).foreign_corp_key_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.foreign_corp_key; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
  unk_corp_key_tokens := PROJECT(Specificities(h).unk_corp_key_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.unk_corp_key; SELF.TokenType := 9; SELF.Spc := LEFT.field_Specificity ));
  active_domestic_corp_key_tokens := PROJECT(Specificities(h).active_domestic_corp_key_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.active_domestic_corp_key; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  hist_duns_number_tokens := PROJECT(Specificities(h).hist_duns_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.hist_duns_number; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  active_duns_number_tokens := PROJECT(Specificities(h).active_duns_number_values_persisted,TRANSFORM(SALT311.Layout_Classify_Token,SELF.TokenValue := (SALT311.StrType)LEFT.active_duns_number; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
...
shared company_address_combinations := o_tot;
  Layout_ConceptTemplate Into(company_address_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.company_addr1_filled => 15, le.company_csz_filled => 17,0);
    SELF.FieldNumber2 := MAP ( le.company_csz_filled AND SELF.FieldNumber1 != 17 => 17,0);
    SELF := le;
  END;
