...
EXPORT SALT311.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'active_duns_number','active_enterprise_number','company_inc_state','company_charter_number','sbfe_id','hist_enterprise_number','hist_duns_number','hist_corp_key','ebr_file_number','company_fein','company_name','cnp_name_phonetic','cnp_name','company_name_type_raw','company_name_type_derived','cnp_hasnumber','cnp_number','cnp_btype','cnp_lowv','cnp_translated','cnp_classid','company_foreign_domestic','company_bdid','company_phone','prim_name','prim_name_derived','sec_range','v_city_name','st','zip','prim_range','prim_range_derived','company_csz','company_addr1','company_address','dt_first_seen','dt_last_seen');
EXPORT SALT311.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'active_duns_number','active_enterprise_number','company_inc_state','company_charter_number','sbfe_id','hist_enterprise_number','hist_duns_number','hist_corp_key','ebr_file_number','company_fein','company_name','cnp_name_phonetic','cnp_name','company_name_type_raw','company_name_type_derived','cnp_hasnumber','cnp_number','cnp_btype','cnp_lowv','cnp_translated','cnp_classid','company_foreign_domestic','company_bdid','company_phone','prim_name','prim_name_derived','sec_range','v_city_name','st','zip','prim_range','prim_range_derived','company_csz','company_addr1','company_address','dt_first_seen','dt_last_seen');
EXPORT FieldNum(SALT311.StrType fn) := CASE(fn,'active_duns_number' => 0,'active_enterprise_number' => 1,'company_inc_state' => 2,'company_charter_number' => 3,'sbfe_id' => 4,'hist_enterprise_number' => 5,'hist_duns_number' => 6,'hist_corp_key' => 7,'ebr_file_number' => 8,'company_fein' => 9,'company_name' => 10,'cnp_name_phonetic' => 11,'cnp_name' => 12,'company_name_type_raw' => 13,'company_name_type_derived' => 14,'cnp_hasnumber' => 15,'cnp_number' => 16,'cnp_btype' => 17,'cnp_lowv' => 18,'cnp_translated' => 19,'cnp_classid' => 20,'company_foreign_domestic' => 21,'company_bdid' => 22,'company_phone' => 23,'prim_name' => 24,'prim_name_derived' => 25,'sec_range' => 26,'v_city_name' => 27,'st' => 28,'zip' => 29,'prim_range' => 30,'prim_range_derived' => 31,'company_csz' => 32,'company_addr1' => 33,'company_address' => 34,'dt_first_seen' => 35,'dt_last_seen' => 36,0);
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,[],[],[],[],[],[],[],[],[],[],[],[],['CAPS','ALLOW','LENGTHS'],[],[],[],[],[],[],[],[],[],[],[],[],['CAPS','ALLOW','LENGTHS'],[],[],['CAPS','ALLOW'],['ALLOW'],[],[],[],[],[],[],[],[]);
EXPORT BOOLEAN InBaseLayout(UNSIGNED2 i) := CHOOSE(i,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,FALSE,FALSE,FALSE,TRUE,TRUE,FALSE);
