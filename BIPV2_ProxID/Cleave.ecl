...
SHARED Candidates_active_domestic_corp_key := Candidates_active_domestic_corp_key_ni : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::Candidates_active_domestic_corp_key',EXPIRE(Config.PersistExpire));
...
SHARED Possibles_active_domestic_corp_key := Possibles_active_domestic_corp_key_ni : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::Possibles_active_domestic_corp_key',EXPIRE(Config.PersistExpire));
...
SHARED Candidates_cnp_number := Candidates_cnp_number_ni : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::Candidates_cnp_number',EXPIRE(Config.PersistExpire));
...
SHARED Possibles_cnp_number := Possibles_cnp_number_ni : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::Possibles_cnp_number',EXPIRE(Config.PersistExpire));
...
EXPORT CandidatesCounts := DATASET([{COUNT(Candidates_active_domestic_corp_key),COUNT(Candidates_cnp_number)}],{UNSIGNED count_Candidates_active_domestic_corp_key,UNSIGNED count_Candidates_cnp_number});
  ...
  converted2 := converted1;
SHARED input_file_np := IF(Config.ByPassCleave,h,converted2);
EXPORT input_file := input_file_np : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::input_file',EXPIRE(Config.PersistExpire));
...
EXPORT patch_file := patch_file_np : PERSIST('~temp::Proxid::BIPV2_ProxID::Cleave::patch_file',EXPIRE(Config.PersistExpire));
