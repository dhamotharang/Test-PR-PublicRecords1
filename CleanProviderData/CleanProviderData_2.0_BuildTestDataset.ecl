...
ds := DATASET
    (
        [
            {'PDI12236','1396814414','BO0201854','','042743585','','10006','0126','EP','','X','BRIGHAM AND WOMENS','900060','DAVID','CAHAN','STE 5985','1155 CENTRE ST','JAMAICA PLAIN','MA','02130','SUFFOLK','','','4','30','P','','','CM','','','','','','','','','','20010203','720820241'}
        ],
        Input_Record
    );
