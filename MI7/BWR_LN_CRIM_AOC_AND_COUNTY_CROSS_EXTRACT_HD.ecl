...
//Need to add sequental envoking of maps and despray
...
//*** Need to run first mi7.MapValidCaseMasterSourceUID and below order
OUTPUT(mi7.MapValidCaseMasterSourceUID
						 ,{MI7.bCaseMasterMaxKey + CAMA_ID,
							...
							SUBJECT_AGE,
							NC_DOB},'~thor_data400::out::crim::cross_aoc_and_county::case_master'+ crim_common.version_development,CSV(SEPARATOR('|'), TERMINATOR('\n')),OVERWRITE,EXPIRE(200));


OUTPUT(MI7.MapValidCaseDetailsSourceUID
										,{MI7.bCaseDetailsMaxKey + ecl_cade_id,
										CASE_DT_C,
										CASE_SUFFIX_FLG,
										CASE_CATEGORY_CD_C,
										...
										SCAR_TATTOO,
										ETHNICITY,
										CASE_BUILD},'~thor_data400::out::crim::cross_aoc_and_county::case_details'+ crim_common.version_development,CSV(SEPARATOR('|'), TERMINATOR('\n')),OVERWRITE,EXPIRE(200));
																				

OUTPUT(MI7.MapValidCriminalSupplimentalSourceUID
										,{MI7.bCaseDetailsMaxKey + CRSU_ID,
											...
											CUSTODY_INFO_CASE,
											PROBATION_INFO,
											CUSTODY_LOCATION},'~thor_data400::out::crim::cross_aoc_and_county::criminal_supplimental'+ crim_common.version_development,CSV(SEPARATOR('|'), TERMINATOR('\n')),OVERWRITE,EXPIRE(200));
 
OUTPUT(MI7.MapValidCriminalChargesSourceUID
                   		,{MI7.bCriminalChargesMaxKey + ECL_CHARGE_ID,
											  ...
											  CHARGE_INFO,
											  CUSTODY_INFO,
												OFFENSE_STATUS},'~thor_data400::out::crim::cross_aoc_and_county::criminal_charges'+ crim_common.version_development,CSV(SEPARATOR('|'), TERMINATOR('\n')),OVERWRITE,EXPIRE(200));

OUTPUT(MI7.MapValidCriminalSentencesSourceUID
				             		 ,{MI7.bCriminalSentencesMaxKey + CRSE_ID,
												  ...
												  SENTENCE_COMMENT_C,
													...
													RECORD_SUPPLIER_CD,
													MI7.bBatchNumber,
													OLD_RECORD_SUPPLIER_CD},'~thor_data400::out::crim::cross_aoc_and_county::criminal_sentences'+ crim_common.version_development,CSV(SEPARATOR('|'), TERMINATOR('\n')),OVERWRITE,EXPIRE(200))
