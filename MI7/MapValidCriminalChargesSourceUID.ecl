...
ds_get_source_UID := join(join_get_valid_crim_charges , File_references_tables,
...
export MapValidCriminalChargesSourceUID := ds_crim_charges_source_uid_validation
                                                                              : persist ('~thor_data400::persist::out::crim::cross_aoc_and_county::MapValidCriminalChargesSourceUID');   
