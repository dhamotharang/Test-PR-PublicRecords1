export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords2	 	:= '^SAME$|^NONE$|^UNKNOWN$|N/A|XXX|NO ADDRESS|INACTIV|INACTIVE';
	...
	export City := module
		...
		shared PatternInvalidWords1		:= '^SAME$|^NONE$|^UNKNOWN$|NO ADDRESS';
	...
	export State := module
		...
		SHARED PatternInvalidWords1		:= '^XX$|^X|NO$|^UN|^FF|^NA|^U|NONE LISTED|^NONE$';
