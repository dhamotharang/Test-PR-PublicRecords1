...
Layout_Lobbyists_Common MyTransform(Layout_Lobbyists_AZ_2005 input) := transform
...
export Mapping_AZ_2005_As_Common := project(File_Lobbyists_AZ_2005,MyTransform(left));