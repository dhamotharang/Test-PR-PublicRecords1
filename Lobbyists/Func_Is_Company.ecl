export boolean Func_Is_Company(string pInput) := regexfind('( & SONS|, N A| INC |,INC |,INC$| & | ' +
															...
															'ACCOUNTING|ACCOUNTS|ADMINISTRATION| ADVOCATES$| AFL-CIO| AFFORDABLE|AGENCY|AIR CONDITIONING|'+
															...
															'FURNITURE| GAZETTE | GAZETTE$|GOVERNMENT|GREATER | GROCERY | GROUP |^GROUP |'+
