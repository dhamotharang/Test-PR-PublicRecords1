...
pout := project(Lobbyists.File_Lobbyists_AL_2004, AddSequenceTrf(LEFT, COUNTER));
...
export Mapping_AL_2004_As_Common := project(ds_with_lobbyist_association,MyTransform(left));