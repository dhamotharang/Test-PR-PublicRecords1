...
export fCleaned_Lobbyists_As_Business_Header(dataset(Layout_Lobbyists_Common) pLobbyists)
 :=
  function
	...
	Cleaned_Lobbyists_Base := pLobbyists;
	...
	Business_Header.Layout_Business_Header_New  Translate_Cleaned_Lobbyists_To_BHF(Layout_Cleaned_Lobbyists_Local l, integer c) := transform
	  ...
	  self.source            := MDR.sourceTools.src_Lobbyists;
	  ...
	  self.city              := choose(c, l.Firm_Address_Clean_v_city_name,     l.Association_Address_Clean_v_city_name);
	...
	Business_Header.Layout_Business_Header_New RollupCleanedLobbyistsNorm(Business_Header.Layout_Business_Header_New l, Business_Header.Layout_Business_Header_New r) := transform
	  self := l;
	end;
	...
	Business_Header.Layout_Business_Header_New RollupCleanedLobbyists(Business_Header.Layout_Business_Header_New L, Business_Header.Layout_Business_Header_New R) := transform
	...
	return Cleaned_Lobbyists_Clean_Rollup;
  end
 ;
