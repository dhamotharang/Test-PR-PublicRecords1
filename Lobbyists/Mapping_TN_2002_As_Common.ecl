...
Layout_Lobbyists_Common MyTransform(Layout_Lobbyists_TN_2002 input) := transform

	self.Key := 'TN' + '2002' + hash64(input.Contl_Name,input.Contf_Name,input.Emp_Name);
...
export Mapping_TN_2002_As_Common := project(File_Lobbyists_TN_2002,MyTransform(left));