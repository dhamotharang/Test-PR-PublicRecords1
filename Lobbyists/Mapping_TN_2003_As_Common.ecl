...
Layout_Lobbyists_Common MyTransform(Layout_Lobbyists_TN_2003 input) := transform

	self.Key := 'TN' + '2003' + hash64(input.Contl_Name,input.Contf_Name,input.Emp_Name);
...
export Mapping_TN_2003_As_Common := project(File_Lobbyists_TN_2003,MyTransform(left));