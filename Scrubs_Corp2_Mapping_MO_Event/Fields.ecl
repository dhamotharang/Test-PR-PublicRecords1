...
EXPORT SALT36.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter','invalid_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_filing_desc');
EXPORT FieldTypeNum(SALT36.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter' => 2,'invalid_supp_key' => 3,'invalid_corp_vendor' => 4,'invalid_state_origin' => 5,'invalid_mandatory' => 6,'invalid_date' => 7,'invalid_filing_desc' => 8,0);
...
EXPORT MakeFT_invalid_charter(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT36.HygieneErrors.NotLength('1..'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_supp_key(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_supp_key(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'0123456789'))));
EXPORT InValidMessageFT_invalid_supp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('0123456789'),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_filing_desc(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,' \'.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&(),:'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_filing_desc(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,' \'.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&(),:'))));
EXPORT InValidMessageFT_invalid_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars(' \'.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&(),:'),SALT36.HygieneErrors.Good);
...
EXPORT Make_corp_sos_charter_nbr(SALT36.StrType s0) := MakeFT_invalid_charter(s0);
EXPORT InValid_corp_sos_charter_nbr(SALT36.StrType s) := InValidFT_invalid_charter(s);
...
EXPORT Make_event_filing_date(SALT36.StrType s0) := s0;
EXPORT InValid_event_filing_date(SALT36.StrType s) := 0;
...
EXPORT Make_event_filing_cd(SALT36.StrType s0) := s0;
EXPORT InValid_event_filing_cd(SALT36.StrType s) := 0;
EXPORT InValidMessage_event_filing_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_filing_desc(SALT36.StrType s0) := MakeFT_invalid_filing_desc(s0);
EXPORT InValid_event_filing_desc(SALT36.StrType s) := InValidFT_invalid_filing_desc(s);
EXPORT InValidMessage_event_filing_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_desc(wh);
...
EXPORT Make_event_book_nbr(SALT36.StrType s0) := s0;
EXPORT InValid_event_book_nbr(SALT36.StrType s) := 0;
EXPORT InValidMessage_event_book_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_page_nbr(SALT36.StrType s0) := s0;
EXPORT InValid_event_page_nbr(SALT36.StrType s) := 0;
EXPORT InValidMessage_event_page_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_certification_nbr(SALT36.StrType s0) := s0;
EXPORT InValid_event_certification_nbr(SALT36.StrType s) := 0;
EXPORT InValidMessage_event_certification_nbr(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT36,Scrubs_Corp2_Mapping_MO_Event;
