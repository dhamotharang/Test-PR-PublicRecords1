...
#workunit('name','Scrubs_Credit_Unions.Base_BWR_Hygiene - Hygiene & Stats - SALT V3.11.1');
IMPORT Scrubs_Credit_Unions,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_Credit_Unions.Base_In_Credit_Unions;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Credit_Unions.Base_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_Layout_Credit_Unions'),NAMED('OptimizedLayout'));// File layout suggested by data
