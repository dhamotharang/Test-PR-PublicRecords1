...
EXPORT Summary(SALT32.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_cname_devanitize := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.cname_devanitize)));
    avelength_cname_devanitize := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.cname_devanitize)),h.cname_devanitize<>(typeof(h.cname_devanitize))'');
    ...
    maxlength_isCorpEnhanced := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.isCorpEnhanced)));
    avelength_isCorpEnhanced := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.isCorpEnhanced)),h.isCorpEnhanced<>(typeof(h.isCorpEnhanced))'');
    ...
    maxlength_contact_job_title_derived := MAX(GROUP,LENGTH(TRIM((SALT32.StrType)h.contact_job_title_derived)));
    avelength_contact_job_title_derived := AVE(GROUP,LENGTH(TRIM((SALT32.StrType)h.contact_job_title_derived)),h.contact_job_title_derived<>(typeof(h.contact_job_title_derived))'');
...
SALT32.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.EmpID;
  SELF.Src := le.source;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.contact_phone),TRIM((SALT32.StrType)le.contact_did),TRIM((SALT32.StrType)le.cname_devanitize),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.contact_ssn),TRIM((SALT32.StrType)le.isCorpEnhanced),TRIM((SALT32.StrType)le.contact_job_title_derived),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.company_name),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.company_inc_state),TRIM((SALT32.StrType)le.company_charter_number),TRIM((SALT32.StrType)le.active_duns_number),TRIM((SALT32.StrType)le.hist_duns_number),TRIM((SALT32.StrType)le.active_domestic_corp_key),TRIM((SALT32.StrType)le.hist_domestic_corp_key),TRIM((SALT32.StrType)le.foreign_corp_key),TRIM((SALT32.StrType)le.unk_corp_key),TRIM((SALT32.StrType)le.company_fein),TRIM((SALT32.StrType)le.cnp_btype),TRIM((SALT32.StrType)le.cnp_name),TRIM((SALT32.StrType)le.company_name_type_derived),TRIM((SALT32.StrType)le.company_bdid),TRIM((SALT32.StrType)le.nodes_total),TRIM((SALT32.StrType)le.dt_first_seen),TRIM((SALT32.StrType)le.dt_last_seen)));
  SELF.FldNo := C;
END;
...
SALT32.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 32);
  SELF.FldNo2 := 1 + (C % 32);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.contact_phone),TRIM((SALT32.StrType)le.contact_did),TRIM((SALT32.StrType)le.cname_devanitize),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.contact_ssn),TRIM((SALT32.StrType)le.isCorpEnhanced),TRIM((SALT32.StrType)le.contact_job_title_derived),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.company_name),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.company_inc_state),TRIM((SALT32.StrType)le.company_charter_number),TRIM((SALT32.StrType)le.active_duns_number),TRIM((SALT32.StrType)le.hist_duns_number),TRIM((SALT32.StrType)le.active_domestic_corp_key),TRIM((SALT32.StrType)le.hist_domestic_corp_key),TRIM((SALT32.StrType)le.foreign_corp_key),TRIM((SALT32.StrType)le.unk_corp_key),TRIM((SALT32.StrType)le.company_fein),TRIM((SALT32.StrType)le.cnp_btype),TRIM((SALT32.StrType)le.cnp_name),TRIM((SALT32.StrType)le.company_name_type_derived),TRIM((SALT32.StrType)le.company_bdid),TRIM((SALT32.StrType)le.nodes_total),TRIM((SALT32.StrType)le.dt_first_seen),TRIM((SALT32.StrType)le.dt_last_seen)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT32.StrType)le.prim_range),TRIM((SALT32.StrType)le.prim_name),TRIM((SALT32.StrType)le.lname),TRIM((SALT32.StrType)le.contact_phone),TRIM((SALT32.StrType)le.contact_did),TRIM((SALT32.StrType)le.cname_devanitize),TRIM((SALT32.StrType)le.zip),TRIM((SALT32.StrType)le.fname),TRIM((SALT32.StrType)le.contact_ssn),TRIM((SALT32.StrType)le.isCorpEnhanced),TRIM((SALT32.StrType)le.contact_job_title_derived),TRIM((SALT32.StrType)le.zip4),TRIM((SALT32.StrType)le.company_name),TRIM((SALT32.StrType)le.sec_range),TRIM((SALT32.StrType)le.v_city_name),TRIM((SALT32.StrType)le.st),TRIM((SALT32.StrType)le.company_inc_state),TRIM((SALT32.StrType)le.company_charter_number),TRIM((SALT32.StrType)le.active_duns_number),TRIM((SALT32.StrType)le.hist_duns_number),TRIM((SALT32.StrType)le.active_domestic_corp_key),TRIM((SALT32.StrType)le.hist_domestic_corp_key),TRIM((SALT32.StrType)le.foreign_corp_key),TRIM((SALT32.StrType)le.unk_corp_key),TRIM((SALT32.StrType)le.company_fein),TRIM((SALT32.StrType)le.cnp_btype),TRIM((SALT32.StrType)le.cnp_name),TRIM((SALT32.StrType)le.company_name_type_derived),TRIM((SALT32.StrType)le.company_bdid),TRIM((SALT32.StrType)le.nodes_total),TRIM((SALT32.StrType)le.dt_first_seen),TRIM((SALT32.StrType)le.dt_last_seen)));
  END;
...
SHARED FldIds := DATASET([{1,'prim_range'}
      ...
      ,{30,'nodes_total'}
      ,{31,'dt_first_seen'}
      ,{32,'dt_last_seen'}],SALT32.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_cname_devanitize((SALT32.StrType)le.cname_devanitize),
    ...
    Fields.InValid_isCorpEnhanced((SALT32.StrType)le.isCorpEnhanced),
    Fields.InValid_contact_job_title_derived((SALT32.StrType)le.contact_job_title_derived),
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'Unknown','Unknown','Unknown','Unknown','Unknown','multiword','number','Unknown','Unknown','isNoCorp','isOwner','hasZip4','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Fields.InValidMessage_lname(TotalErrors.ErrorNum),Fields.InValidMessage_contact_phone(TotalErrors.ErrorNum),Fields.InValidMessage_contact_did(TotalErrors.ErrorNum),Fields.InValidMessage_cname_devanitize(TotalErrors.ErrorNum),Fields.InValidMessage_zip(TotalErrors.ErrorNum),Fields.InValidMessage_fname(TotalErrors.ErrorNum),Fields.InValidMessage_contact_ssn(TotalErrors.ErrorNum),Fields.InValidMessage_isCorpEnhanced(TotalErrors.ErrorNum),Fields.InValidMessage_contact_job_title_derived(TotalErrors.ErrorNum),Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Fields.InValidMessage_company_name(TotalErrors.ErrorNum),Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),Fields.InValidMessage_st(TotalErrors.ErrorNum),Fields.InValidMessage_company_inc_state(TotalErrors.ErrorNum),Fields.InValidMessage_company_charter_number(TotalErrors.ErrorNum),Fields.InValidMessage_active_duns_number(TotalErrors.ErrorNum),Fields.InValidMessage_hist_duns_number(TotalErrors.ErrorNum),Fields.InValidMessage_active_domestic_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_hist_domestic_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_foreign_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_unk_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_company_fein(TotalErrors.ErrorNum),Fields.InValidMessage_cnp_btype(TotalErrors.ErrorNum),Fields.InValidMessage_cnp_name(TotalErrors.ErrorNum),Fields.InValidMessage_company_name_type_derived(TotalErrors.ErrorNum),Fields.InValidMessage_company_bdid(TotalErrors.ErrorNum),Fields.InValidMessage_nodes_total(TotalErrors.ErrorNum),Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
//Compute field consistencies between sources
  SALT32.mac_srcfrequency_outliers(h,cname_devanitize,source,cname_devanitize_outliers)
