...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_EmpID::EmpID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_EmpID::EmpID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_EmpID::EmpID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_EmpID::EmpID::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::BIPV2_EmpID::EmpID::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_EmpID::EmpID::History::Match';
  MH := MatchHistoryFile;
