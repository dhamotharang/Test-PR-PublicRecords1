...
#workunit('name','BIPV2_EmpID.BWR_Specificities - Specificities - SALT V3.2.0');
IMPORT BIPV2_EmpID,SALT32;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_EmpID.specificities(BIPV2_EmpID.In_EmpID);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_EmpID.<your_spc_attribute>',BIPV2_EmpID.In_EmpID);
