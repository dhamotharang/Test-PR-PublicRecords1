...
SHARED TotalClusters := specificities(h).TotalClusters;
  cname_devanitize_tokens := PROJECT(specificities(h).cname_devanitize_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.cname_devanitize; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  prim_range_tokens := PROJECT(specificities(h).prim_range_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.prim_range; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  prim_name_tokens := PROJECT(specificities(h).prim_name_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.prim_name; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  zip_tokens := PROJECT(specificities(h).zip_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.zip; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  fname_tokens := PROJECT(specificities(h).fname_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.fname; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
  lname_tokens := PROJECT(specificities(h).lname_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.lname; SELF.TokenType := 9; SELF.Spc := LEFT.field_Specificity ));
  contact_phone_tokens := PROJECT(specificities(h).contact_phone_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.contact_phone; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  contact_did_tokens := PROJECT(specificities(h).contact_did_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.contact_did; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  contact_ssn_tokens := PROJECT(specificities(h).contact_ssn_values_persisted,TRANSFORM(SALT32.Layout_Classify_Token,SELF.TokenValue := (SALT32.StrType)LEFT.contact_ssn; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
...
EXPORT TokenKeyName := '~'+'key::BIPV2_EmpID::EmpID::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_EmpID::EmpID::Token::MultiTokenKey';
