...
iter := '25';
#workunit('name','BIPV2_EmpID Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_EmpID.Keys(BIPV2_EmpID.In_EmpID).MatchSample ,BIPV2_EmpID.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT _mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_EmpID.In_EmpID)
