EXPORT MAC_PopulationStatistics(infile,Ref='',SRC='',Input_UPIN = '',Input_NPI_NUMBER = '',Input_DEA_NUMBER = '',Input_CLIA_NUMBER = '',Input_MEDICARE_FACILITY_NUMBER = '',Input_NCPDP_NUMBER = '',Input_TAX_ID = '',Input_FEIN = '',Input_C_LIC_NBR = '',Input_SRC = '',Input_CNAME = '',Input_CNP_NAME = '',Input_CNP_NUMBER = '',Input_CNP_STORE_NUMBER = '',Input_CNP_BTYPE = '',Input_CNP_LOWV = '',Input_CNP_TRANSLATED = '',Input_CNP_CLASSID = '',Input_ADDRESS_ID = '',Input_ADDRESS_CLASSIFICATION = '',Input_PRIM_RANGE = '',Input_PRIM_NAME = '',Input_SEC_RANGE = '',Input_ST = '',Input_V_CITY_NAME = '',Input_ZIP = '',Input_PHONE = '',Input_FAX = '',Input_TAXONOMY = '',Input_TAXONOMY_CODE = '',Input_MEDICAID_NUMBER = '',Input_VENDOR_ID = '',Input_FAC_NAME = '',Input_ADDR1 = '',Input_LOCALE = '',Input_ADDRESS = '',Input_LIC_STATE = '',OutFile) := MACRO
