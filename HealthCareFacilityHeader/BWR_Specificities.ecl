...
#workunit('name','HealthCareFacilityHeader.BWR_Specificities - Specificities - SALT V3.0 Gold');
IMPORT HealthCareFacilityHeader,SALT30;
IMPORT SALTTOOLS30;
SpecMod := HealthCareFacilityHeader.specificities(HealthCareFacilityHeader.In_HealthFacility);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'HealthCareFacilityHeader.<your_spc_attribute>',HealthCareFacilityHeader.In_HealthFacility);
