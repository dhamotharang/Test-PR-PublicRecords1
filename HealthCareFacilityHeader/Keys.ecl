...
EXPORT SpecificitiesDebugKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::HealthCareFacilityHeader::LNPID::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
EXPORT MatchHistoryKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::History::Match';
  MH := MatchHistoryFile;
