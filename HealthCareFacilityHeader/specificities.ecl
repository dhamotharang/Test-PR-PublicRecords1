...
EXPORT input_file := h0 : PERSIST('~temp::LNPID::HealthCareFacilityHeader::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have LNPID specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LNPID;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LNPID,LOCAL) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::Cluster_Sizes',EXPIRE(Config.PersistExpire));
EXPORT TotalClusters := COUNT(ClusterSizes);
EXPORT  NPI_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,NPI_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::NPI_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  DEA_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,DEA_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::DEA_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  CLIA_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,CLIA_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::CLIA_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  MEDICARE_FACILITY_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,MEDICARE_FACILITY_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::MEDICARE_FACILITY_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  NCPDP_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,NCPDP_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::NCPDP_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  TAX_ID_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,TAX_ID) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::TAX_ID',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  FEIN_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,FEIN) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::FEIN',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  C_LIC_NBR_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,C_LIC_NBR) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::C_LIC_NBR',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  CNP_NAME_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,CNP_NAME) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::CNP_NAME',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT CNP_NAMEValuesKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Word::CNP_NAME';
...
EXPORT  CNP_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,CNP_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::CNP_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT30.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_NUMBER_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_NUMBER_temp',EXPIRE(Config.PersistExpire));
EXPORT  CNP_STORE_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,CNP_STORE_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::CNP_STORE_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT30.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_STORE_NUMBER_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_STORE_NUMBER_temp',EXPIRE(Config.PersistExpire));
EXPORT  CNP_BTYPE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,CNP_BTYPE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::CNP_BTYPE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT30.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CNP_BTYPE_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_BTYPE_temp',EXPIRE(Config.PersistExpire));
EXPORT  PRIM_RANGE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,PRIM_RANGE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::PRIM_RANGE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT PRIM_RANGE_values_persisted_temp := distance_computed : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::PRIM_RANGE_temp',EXPIRE(Config.PersistExpire));
EXPORT  PRIM_NAME_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,PRIM_NAME) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::PRIM_NAME',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT PRIM_NAMEValuesKeyName := '~'+'key::HealthCareFacilityHeader::LNPID::Word::PRIM_NAME';
...
EXPORT  SEC_RANGE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,SEC_RANGE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::SEC_RANGE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT30.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT SEC_RANGE_values_persisted_temp := specs_added : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::SEC_RANGE_temp',EXPIRE(Config.PersistExpire));
EXPORT  ST_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,ST) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::ST',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  V_CITY_NAME_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,V_CITY_NAME) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::V_CITY_NAME',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  ZIP_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,ZIP) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::ZIP',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  PHONE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,PHONE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::PHONE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  FAX_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,FAX) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::FAX',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  TAXONOMY_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,TAXONOMY) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::TAXONOMY',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  TAXONOMY_CODE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,TAXONOMY_CODE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::TAXONOMY_CODE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  MEDICAID_NUMBER_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,MEDICAID_NUMBER) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::MEDICAID_NUMBER',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  VENDOR_ID_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,VENDOR_ID) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::VENDOR_ID',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  FAC_NAME_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,FAC_NAME) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::FAC_NAME',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  ADDR1_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,ADDR1) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::ADDR1',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  LOCALE_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,LOCALE) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::LOCALE',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT  ADDRESS_deduped := SALT30.MAC_Field_By_UID(input_file,LNPID,ADDRESS) : PERSIST('~temp::LNPID::HealthCareFacilityHeader::dedups::ADDRESS',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT CNP_NAME_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_NAME',EXPIRE(Config.PersistExpire));
...
EXPORT CNP_NUMBER_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_NUMBER',EXPIRE(Config.PersistExpire));
...
EXPORT CNP_STORE_NUMBER_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_STORE_NUMBER',EXPIRE(Config.PersistExpire));
...
EXPORT CNP_BTYPE_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::CNP_BTYPE',EXPIRE(Config.PersistExpire));
...
SALT30.MAC_Concept3_Specificities(ADDR1_cnt,PRIM_RANGE_values_persisted_temp,PRIM_RANGE,e1_cnt,PRIM_NAME_values_persisted_temp,PRIM_NAME,cnt,SEC_RANGE_values_persisted_temp,SEC_RANGE,cnt,ofile)
EXPORT PRIM_RANGE_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::PRIM_RANGE',EXPIRE(Config.PersistExpire));
...
SALT30.MAC_Concept3_Specificities(ADDR1_cnt,PRIM_NAME_values_persisted_temp,PRIM_NAME,cnt,PRIM_RANGE_values_persisted_temp,PRIM_RANGE,e1_cnt,SEC_RANGE_values_persisted_temp,SEC_RANGE,cnt,ofile)
EXPORT PRIM_NAME_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::PRIM_NAME',EXPIRE(Config.PersistExpire));
...
SALT30.MAC_Concept3_Specificities(ADDR1_cnt,SEC_RANGE_values_persisted_temp,SEC_RANGE,cnt,PRIM_RANGE_values_persisted_temp,PRIM_RANGE,e1_cnt,PRIM_NAME_values_persisted_temp,PRIM_NAME,cnt,ofile)
EXPORT SEC_RANGE_values_persisted := ofile : PERSIST('~temp::LNPID::HealthCareFacilityHeader::values::SEC_RANGE',EXPIRE(Config.PersistExpire));
...
EXPORT AllProfiles := NPI_NUMBER_specificity_profile + DEA_NUMBER_specificity_profile + CLIA_NUMBER_specificity_profile + MEDICARE_FACILITY_NUMBER_specificity_profile + NCPDP_NUMBER_specificity_profile + TAX_ID_specificity_profile + FEIN_specificity_profile + C_LIC_NBR_specificity_profile + CNP_NAME_specificity_profile + CNP_NUMBER_specificity_profile + CNP_STORE_NUMBER_specificity_profile + CNP_BTYPE_specificity_profile + PRIM_RANGE_specificity_profile + PRIM_NAME_specificity_profile + SEC_RANGE_specificity_profile + ST_specificity_profile + V_CITY_NAME_specificity_profile + ZIP_specificity_profile + PHONE_specificity_profile + FAX_specificity_profile + TAXONOMY_specificity_profile + TAXONOMY_CODE_specificity_profile + MEDICAID_NUMBER_specificity_profile + VENDOR_ID_specificity_profile;
END;
