...
EXPORT FromNone(DATASET(Layout_FILE) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.orig_login_id_Invalid << 0 ) + ( le.orig_billing_code_Invalid << 3 ) + ( le.orig_transaction_id_Invalid << 6 ) + ( le.orig_function_name_Invalid << 8 ) + ( le.orig_company_id_Invalid << 11 ) + ( le.orig_reference_code_Invalid << 13 ) + ( le.orig_fname_Invalid << 16 ) + ( le.orig_mname_Invalid << 18 ) + ( le.orig_lname_Invalid << 20 ) + ( le.orig_name_suffix_Invalid << 22 ) + ( le.orig_fname_2_Invalid << 25 ) + ( le.orig_mname_2_Invalid << 27 ) + ( le.orig_lname_2_Invalid << 30 ) + ( le.orig_name_suffix_2_Invalid << 32 ) + ( le.orig_address_Invalid << 35 ) + ( le.orig_city_Invalid << 36 ) + ( le.orig_state_Invalid << 38 ) + ( le.orig_zip_Invalid << 40 ) + ( le.orig_zip4_Invalid << 42 ) + ( le.orig_address_2_Invalid << 45 ) + ( le.orig_city_2_Invalid << 48 ) + ( le.orig_state_2_Invalid << 50 ) + ( le.orig_zip_2_Invalid << 52 ) + ( le.orig_zip4_2_Invalid << 55 ) + ( le.orig_clean_address_Invalid << 58 ) + ( le.orig_clean_city_Invalid << 61 );
    SELF.ScrubsBits2 := ( le.orig_clean_state_Invalid << 0 ) + ( le.orig_clean_zip_Invalid << 3 ) + ( le.orig_clean_zip4_Invalid << 6 ) + ( le.orig_phone_Invalid << 9 ) + ( le.orig_homephone_Invalid << 12 ) + ( le.orig_homephone_2_Invalid << 15 ) + ( le.orig_workphone_Invalid << 18 ) + ( le.orig_workphone_2_Invalid << 21 ) + ( le.orig_ssn_Invalid << 24 ) + ( le.orig_ssn_2_Invalid << 27 ) + ( le.orig_free_Invalid << 30 ) + ( le.orig_record_count_Invalid << 33 ) + ( le.orig_price_Invalid << 36 ) + ( le.orig_revenue_Invalid << 38 ) + ( le.orig_full_name_Invalid << 41 ) + ( le.orig_business_name_Invalid << 44 ) + ( le.orig_business_name_2_Invalid << 46 ) + ( le.orig_years_Invalid << 48 ) + ( le.orig_pricing_error_code_Invalid << 51 ) + ( le.orig_fcra_purpose_Invalid << 54 ) + ( le.orig_result_format_Invalid << 57 ) + ( le.orig_dob_Invalid << 60 );
    SELF.ScrubsBits3 := ( le.orig_dob_2_Invalid << 0 ) + ( le.orig_unique_id_Invalid << 3 ) + ( le.orig_response_time_Invalid << 6 ) + ( le.orig_data_source_Invalid << 8 ) + ( le.orig_report_options_Invalid << 11 ) + ( le.orig_end_user_name_Invalid << 14 ) + ( le.orig_end_user_address_1_Invalid << 17 ) + ( le.orig_end_user_address_2_Invalid << 20 ) + ( le.orig_end_user_city_Invalid << 23 ) + ( le.orig_end_user_state_Invalid << 26 ) + ( le.orig_end_user_zip_Invalid << 29 ) + ( le.orig_login_history_id_Invalid << 32 ) + ( le.orig_employment_state_Invalid << 35 ) + ( le.orig_end_user_industry_class_Invalid << 38 ) + ( le.orig_function_specific_data_Invalid << 41 ) + ( le.orig_date_added_Invalid << 44 ) + ( le.orig_retail_price_Invalid << 47 ) + ( le.orig_country_code_Invalid << 50 ) + ( le.orig_email_Invalid << 53 ) + ( le.orig_email_2_Invalid << 55 ) + ( le.orig_dl_number_Invalid << 58 ) + ( le.orig_dl_number_2_Invalid << 60 );
    SELF.ScrubsBits4 := ( le.orig_sub_id_Invalid << 0 ) + ( le.orig_neighbors_Invalid << 2 ) + ( le.orig_relatives_Invalid << 5 ) + ( le.orig_associates_Invalid << 8 ) + ( le.orig_property_Invalid << 11 ) + ( le.orig_bankruptcy_Invalid << 14 ) + ( le.orig_dls_Invalid << 17 ) + ( le.orig_mvs_Invalid << 20 ) + ( le.orig_ip_address_Invalid << 23 );
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    SELF.orig_login_id_Invalid := (le.ScrubsBits1 >> 0) & 7;
    SELF.orig_billing_code_Invalid := (le.ScrubsBits1 >> 3) & 7;
    SELF.orig_transaction_id_Invalid := (le.ScrubsBits1 >> 6) & 3;
    SELF.orig_function_name_Invalid := (le.ScrubsBits1 >> 8) & 7;
    SELF.orig_company_id_Invalid := (le.ScrubsBits1 >> 11) & 3;
    SELF.orig_reference_code_Invalid := (le.ScrubsBits1 >> 13) & 7;
    SELF.orig_fname_Invalid := (le.ScrubsBits1 >> 16) & 3;
    SELF.orig_mname_Invalid := (le.ScrubsBits1 >> 18) & 3;
    SELF.orig_lname_Invalid := (le.ScrubsBits1 >> 20) & 3;
    SELF.orig_name_suffix_Invalid := (le.ScrubsBits1 >> 22) & 7;
    SELF.orig_fname_2_Invalid := (le.ScrubsBits1 >> 25) & 3;
    SELF.orig_mname_2_Invalid := (le.ScrubsBits1 >> 27) & 7;
    SELF.orig_lname_2_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.orig_name_suffix_2_Invalid := (le.ScrubsBits1 >> 32) & 7;
    SELF.orig_address_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.orig_city_Invalid := (le.ScrubsBits1 >> 36) & 3;
    SELF.orig_state_Invalid := (le.ScrubsBits1 >> 38) & 3;
    SELF.orig_zip_Invalid := (le.ScrubsBits1 >> 40) & 3;
    SELF.orig_zip4_Invalid := (le.ScrubsBits1 >> 42) & 7;
    SELF.orig_address_2_Invalid := (le.ScrubsBits1 >> 45) & 7;
    SELF.orig_city_2_Invalid := (le.ScrubsBits1 >> 48) & 3;
    SELF.orig_state_2_Invalid := (le.ScrubsBits1 >> 50) & 3;
    SELF.orig_zip_2_Invalid := (le.ScrubsBits1 >> 52) & 7;
    SELF.orig_zip4_2_Invalid := (le.ScrubsBits1 >> 55) & 7;
    SELF.orig_clean_address_Invalid := (le.ScrubsBits1 >> 58) & 7;
    SELF.orig_clean_city_Invalid := (le.ScrubsBits1 >> 61) & 7;
    SELF.orig_clean_state_Invalid := (le.ScrubsBits2 >> 0) & 7;
    SELF.orig_clean_zip_Invalid := (le.ScrubsBits2 >> 3) & 7;
    SELF.orig_clean_zip4_Invalid := (le.ScrubsBits2 >> 6) & 7;
    SELF.orig_phone_Invalid := (le.ScrubsBits2 >> 9) & 7;
    SELF.orig_homephone_Invalid := (le.ScrubsBits2 >> 12) & 7;
    SELF.orig_homephone_2_Invalid := (le.ScrubsBits2 >> 15) & 7;
    SELF.orig_workphone_Invalid := (le.ScrubsBits2 >> 18) & 7;
    SELF.orig_workphone_2_Invalid := (le.ScrubsBits2 >> 21) & 7;
    SELF.orig_ssn_Invalid := (le.ScrubsBits2 >> 24) & 7;
    SELF.orig_ssn_2_Invalid := (le.ScrubsBits2 >> 27) & 7;
    SELF.orig_free_Invalid := (le.ScrubsBits2 >> 30) & 7;
    SELF.orig_record_count_Invalid := (le.ScrubsBits2 >> 33) & 7;
    SELF.orig_price_Invalid := (le.ScrubsBits2 >> 36) & 3;
    SELF.orig_revenue_Invalid := (le.ScrubsBits2 >> 38) & 7;
    SELF.orig_full_name_Invalid := (le.ScrubsBits2 >> 41) & 7;
    SELF.orig_business_name_Invalid := (le.ScrubsBits2 >> 44) & 3;
    SELF.orig_business_name_2_Invalid := (le.ScrubsBits2 >> 46) & 3;
    SELF.orig_years_Invalid := (le.ScrubsBits2 >> 48) & 7;
    SELF.orig_pricing_error_code_Invalid := (le.ScrubsBits2 >> 51) & 7;
    SELF.orig_fcra_purpose_Invalid := (le.ScrubsBits2 >> 54) & 7;
    SELF.orig_result_format_Invalid := (le.ScrubsBits2 >> 57) & 7;
    SELF.orig_dob_Invalid := (le.ScrubsBits2 >> 60) & 7;
    SELF.orig_dob_2_Invalid := (le.ScrubsBits3 >> 0) & 7;
    SELF.orig_unique_id_Invalid := (le.ScrubsBits3 >> 3) & 7;
    SELF.orig_response_time_Invalid := (le.ScrubsBits3 >> 6) & 3;
    SELF.orig_data_source_Invalid := (le.ScrubsBits3 >> 8) & 7;
    SELF.orig_report_options_Invalid := (le.ScrubsBits3 >> 11) & 7;
    SELF.orig_end_user_name_Invalid := (le.ScrubsBits3 >> 14) & 7;
    SELF.orig_end_user_address_1_Invalid := (le.ScrubsBits3 >> 17) & 7;
    SELF.orig_end_user_address_2_Invalid := (le.ScrubsBits3 >> 20) & 7;
    SELF.orig_end_user_city_Invalid := (le.ScrubsBits3 >> 23) & 7;
    SELF.orig_end_user_state_Invalid := (le.ScrubsBits3 >> 26) & 7;
    SELF.orig_end_user_zip_Invalid := (le.ScrubsBits3 >> 29) & 7;
    SELF.orig_login_history_id_Invalid := (le.ScrubsBits3 >> 32) & 7;
    SELF.orig_employment_state_Invalid := (le.ScrubsBits3 >> 35) & 7;
    SELF.orig_end_user_industry_class_Invalid := (le.ScrubsBits3 >> 38) & 7;
    SELF.orig_function_specific_data_Invalid := (le.ScrubsBits3 >> 41) & 7;
    SELF.orig_date_added_Invalid := (le.ScrubsBits3 >> 44) & 7;
    SELF.orig_retail_price_Invalid := (le.ScrubsBits3 >> 47) & 7;
    SELF.orig_country_code_Invalid := (le.ScrubsBits3 >> 50) & 7;
    SELF.orig_email_Invalid := (le.ScrubsBits3 >> 53) & 3;
    SELF.orig_email_2_Invalid := (le.ScrubsBits3 >> 55) & 7;
    SELF.orig_dl_number_Invalid := (le.ScrubsBits3 >> 58) & 3;
    SELF.orig_dl_number_2_Invalid := (le.ScrubsBits3 >> 60) & 7;
    SELF.orig_sub_id_Invalid := (le.ScrubsBits4 >> 0) & 3;
    SELF.orig_neighbors_Invalid := (le.ScrubsBits4 >> 2) & 7;
    SELF.orig_relatives_Invalid := (le.ScrubsBits4 >> 5) & 7;
    SELF.orig_associates_Invalid := (le.ScrubsBits4 >> 8) & 7;
    SELF.orig_property_Invalid := (le.ScrubsBits4 >> 11) & 7;
    SELF.orig_bankruptcy_Invalid := (le.ScrubsBits4 >> 14) & 7;
    SELF.orig_dls_Invalid := (le.ScrubsBits4 >> 17) & 7;
    SELF.orig_mvs_Invalid := (le.ScrubsBits4 >> 20) & 7;
    SELF.orig_ip_address_Invalid := (le.ScrubsBits4 >> 23) & 3;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    orig_login_id_LEFTTRIM_WouldModifyCount := COUNT(GROUP,h.orig_login_id_Invalid=1 AND h.orig_login_id_wouldClean);
    orig_login_id_ALLOW_ErrorCount := COUNT(GROUP,h.orig_login_id_Invalid=2);
    orig_login_id_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_login_id_Invalid=2 AND h.orig_login_id_wouldClean);
    orig_login_id_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_login_id_Invalid=3);
    orig_login_id_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_login_id_Invalid=3 AND h.orig_login_id_wouldClean);
    orig_login_id_WORDS_ErrorCount := COUNT(GROUP,h.orig_login_id_Invalid=4);
    orig_login_id_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_login_id_Invalid=4 AND h.orig_login_id_wouldClean);
    ...
    orig_fname_2_ALLOW_ErrorCount := COUNT(GROUP,h.orig_fname_2_Invalid=1);
    orig_fname_2_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_fname_2_Invalid=1 AND h.orig_fname_2_wouldClean);
    orig_fname_2_WORDS_ErrorCount := COUNT(GROUP,h.orig_fname_2_Invalid=2);
    orig_fname_2_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_fname_2_Invalid=2 AND h.orig_fname_2_wouldClean);
    ...
    orig_lname_2_ALLOW_ErrorCount := COUNT(GROUP,h.orig_lname_2_Invalid=1);
    orig_lname_2_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_lname_2_Invalid=1 AND h.orig_lname_2_wouldClean);
    orig_lname_2_WORDS_ErrorCount := COUNT(GROUP,h.orig_lname_2_Invalid=2);
    orig_lname_2_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_lname_2_Invalid=2 AND h.orig_lname_2_wouldClean);
    ...
    orig_city_2_ALLOW_ErrorCount := COUNT(GROUP,h.orig_city_2_Invalid=1);
    orig_city_2_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_city_2_Invalid=1 AND h.orig_city_2_wouldClean);
    orig_city_2_WORDS_ErrorCount := COUNT(GROUP,h.orig_city_2_Invalid=2);
    orig_city_2_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_city_2_Invalid=2 AND h.orig_city_2_wouldClean);
    orig_city_2_Total_ErrorCount := COUNT(GROUP,h.orig_city_2_Invalid>0);
    orig_state_2_ALLOW_ErrorCount := COUNT(GROUP,h.orig_state_2_Invalid=1);
    orig_state_2_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_state_2_Invalid=1 AND h.orig_state_2_wouldClean);
    orig_state_2_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_state_2_Invalid=2);
    orig_state_2_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_state_2_Invalid=2 AND h.orig_state_2_wouldClean);
    orig_state_2_WORDS_ErrorCount := COUNT(GROUP,h.orig_state_2_Invalid=3);
    orig_state_2_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_state_2_Invalid=3 AND h.orig_state_2_wouldClean);
    ...
    orig_business_name_2_ALLOW_ErrorCount := COUNT(GROUP,h.orig_business_name_2_Invalid=1);
    orig_business_name_2_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_business_name_2_Invalid=1 AND h.orig_business_name_2_wouldClean);
    orig_business_name_2_WORDS_ErrorCount := COUNT(GROUP,h.orig_business_name_2_Invalid=2);
    orig_business_name_2_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_business_name_2_Invalid=2 AND h.orig_business_name_2_wouldClean);
    ...
    orig_unique_id_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_unique_id_Invalid=3);
    orig_unique_id_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_unique_id_Invalid=3 AND h.orig_unique_id_wouldClean);
    orig_unique_id_WORDS_ErrorCount := COUNT(GROUP,h.orig_unique_id_Invalid=4);
    orig_unique_id_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_unique_id_Invalid=4 AND h.orig_unique_id_wouldClean);
    ...
    orig_report_options_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_report_options_Invalid=3);
    orig_report_options_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_report_options_Invalid=3 AND h.orig_report_options_wouldClean);
    orig_report_options_WORDS_ErrorCount := COUNT(GROUP,h.orig_report_options_Invalid=4);
    orig_report_options_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_report_options_Invalid=4 AND h.orig_report_options_wouldClean);
    ...
    orig_end_user_name_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_end_user_name_Invalid=3);
    orig_end_user_name_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_name_Invalid=3 AND h.orig_end_user_name_wouldClean);
    orig_end_user_name_WORDS_ErrorCount := COUNT(GROUP,h.orig_end_user_name_Invalid=4);
    orig_end_user_name_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_name_Invalid=4 AND h.orig_end_user_name_wouldClean);
    ...
    orig_end_user_address_1_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=3);
    orig_end_user_address_1_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=3 AND h.orig_end_user_address_1_wouldClean);
    orig_end_user_address_1_WORDS_ErrorCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=4);
    orig_end_user_address_1_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_address_1_Invalid=4 AND h.orig_end_user_address_1_wouldClean);
    ...
    orig_end_user_city_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_end_user_city_Invalid=3);
    orig_end_user_city_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_city_Invalid=3 AND h.orig_end_user_city_wouldClean);
    orig_end_user_city_WORDS_ErrorCount := COUNT(GROUP,h.orig_end_user_city_Invalid=4);
    orig_end_user_city_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_end_user_city_Invalid=4 AND h.orig_end_user_city_wouldClean);
    ...
    orig_retail_price_ALLOW_ErrorCount := COUNT(GROUP,h.orig_retail_price_Invalid=2);
    orig_retail_price_ALLOW_WouldModifyCount := COUNT(GROUP,h.orig_retail_price_Invalid=2 AND h.orig_retail_price_wouldClean);
    orig_retail_price_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_retail_price_Invalid=3);
    orig_retail_price_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_retail_price_Invalid=3 AND h.orig_retail_price_wouldClean);
    orig_retail_price_WORDS_ErrorCount := COUNT(GROUP,h.orig_retail_price_Invalid=4);
    orig_retail_price_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_retail_price_Invalid=4 AND h.orig_retail_price_wouldClean);
    ...
    orig_ip_address_LENGTHS_ErrorCount := COUNT(GROUP,h.orig_ip_address_Invalid=2);
    orig_ip_address_LENGTHS_WouldModifyCount := COUNT(GROUP,h.orig_ip_address_Invalid=2 AND h.orig_ip_address_wouldClean);
    orig_ip_address_WORDS_ErrorCount := COUNT(GROUP,h.orig_ip_address_Invalid=3);
    orig_ip_address_WORDS_WouldModifyCount := COUNT(GROUP,h.orig_ip_address_Invalid=3 AND h.orig_ip_address_wouldClean);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ,CHOOSE(le.orig_login_id_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_fname_2_Invalid,'ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_mname_2_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_lname_2_Invalid,'ALLOW','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_zip_Invalid,'LEFTTRIM','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_city_2_Invalid,'ALLOW','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_state_2_Invalid,'ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_business_name_2_Invalid,'ALLOW','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_unique_id_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_report_options_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_name_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_address_1_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_address_2_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_city_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_state_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ,CHOOSE(le.orig_end_user_zip_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_retail_price_Invalid,'LEFTTRIM','ALLOW','LENGTHS','WORDS','UNKNOWN')
          ...
          ,CHOOSE(le.orig_ip_address_Invalid,'LEFTTRIM','LENGTHS','WORDS','UNKNOWN'),'UNKNOWN'));
  ...
  // field error stats
    SALT39.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ,'orig_login_id:orig_login_id:LEFTTRIM','orig_login_id:orig_login_id:ALLOW','orig_login_id:orig_login_id:LENGTHS','orig_login_id:orig_login_id:WORDS'
          ...
          ,'orig_fname_2:orig_fname_2:ALLOW','orig_fname_2:orig_fname_2:WORDS'
          ...
          ,'orig_lname_2:orig_lname_2:ALLOW','orig_lname_2:orig_lname_2:WORDS'
          ...
          ,'orig_zip:orig_zip:LEFTTRIM','orig_zip:orig_zip:LENGTHS','orig_zip:orig_zip:WORDS'
          ...
          ,'orig_city_2:orig_city_2:ALLOW','orig_city_2:orig_city_2:WORDS'
          ,'orig_state_2:orig_state_2:ALLOW','orig_state_2:orig_state_2:LENGTHS','orig_state_2:orig_state_2:WORDS'
          ...
          ,'orig_business_name_2:orig_business_name_2:ALLOW','orig_business_name_2:orig_business_name_2:WORDS'
          ...
          ,'orig_unique_id:orig_unique_id:LEFTTRIM','orig_unique_id:orig_unique_id:ALLOW','orig_unique_id:orig_unique_id:LENGTHS','orig_unique_id:orig_unique_id:WORDS'
          ...
          ,'orig_report_options:orig_report_options:LEFTTRIM','orig_report_options:orig_report_options:ALLOW','orig_report_options:orig_report_options:LENGTHS','orig_report_options:orig_report_options:WORDS'
          ,'orig_end_user_name:orig_end_user_name:LEFTTRIM','orig_end_user_name:orig_end_user_name:ALLOW','orig_end_user_name:orig_end_user_name:LENGTHS','orig_end_user_name:orig_end_user_name:WORDS'
          ,'orig_end_user_address_1:orig_end_user_address_1:LEFTTRIM','orig_end_user_address_1:orig_end_user_address_1:ALLOW','orig_end_user_address_1:orig_end_user_address_1:LENGTHS','orig_end_user_address_1:orig_end_user_address_1:WORDS'
          ...
          ,'orig_end_user_city:orig_end_user_city:LEFTTRIM','orig_end_user_city:orig_end_user_city:ALLOW','orig_end_user_city:orig_end_user_city:LENGTHS','orig_end_user_city:orig_end_user_city:WORDS'
          ...
          ,'orig_retail_price:orig_retail_price:LEFTTRIM','orig_retail_price:orig_retail_price:ALLOW','orig_retail_price:orig_retail_price:LENGTHS','orig_retail_price:orig_retail_price:WORDS'
          ...
          ,'orig_ip_address:orig_ip_address:LEFTTRIM','orig_ip_address:orig_ip_address:LENGTHS','orig_ip_address:orig_ip_address:WORDS'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Fields.InvalidMessage_orig_login_id(1),Fields.InvalidMessage_orig_login_id(2),Fields.InvalidMessage_orig_login_id(3),Fields.InvalidMessage_orig_login_id(4)
          ...
          ,Fields.InvalidMessage_orig_fname_2(1),Fields.InvalidMessage_orig_fname_2(2)
          ...
          ,Fields.InvalidMessage_orig_lname_2(1),Fields.InvalidMessage_orig_lname_2(2)
          ...
          ,Fields.InvalidMessage_orig_city_2(1),Fields.InvalidMessage_orig_city_2(2)
          ,Fields.InvalidMessage_orig_state_2(1),Fields.InvalidMessage_orig_state_2(2),Fields.InvalidMessage_orig_state_2(3)
          ...
          ,Fields.InvalidMessage_orig_business_name_2(1),Fields.InvalidMessage_orig_business_name_2(2)
          ...
          ,Fields.InvalidMessage_orig_unique_id(1),Fields.InvalidMessage_orig_unique_id(2),Fields.InvalidMessage_orig_unique_id(3),Fields.InvalidMessage_orig_unique_id(4)
          ...
          ,Fields.InvalidMessage_orig_report_options(1),Fields.InvalidMessage_orig_report_options(2),Fields.InvalidMessage_orig_report_options(3),Fields.InvalidMessage_orig_report_options(4)
          ,Fields.InvalidMessage_orig_end_user_name(1),Fields.InvalidMessage_orig_end_user_name(2),Fields.InvalidMessage_orig_end_user_name(3),Fields.InvalidMessage_orig_end_user_name(4)
          ,Fields.InvalidMessage_orig_end_user_address_1(1),Fields.InvalidMessage_orig_end_user_address_1(2),Fields.InvalidMessage_orig_end_user_address_1(3),Fields.InvalidMessage_orig_end_user_address_1(4)
          ...
          ,Fields.InvalidMessage_orig_end_user_city(1),Fields.InvalidMessage_orig_end_user_city(2),Fields.InvalidMessage_orig_end_user_city(3),Fields.InvalidMessage_orig_end_user_city(4)
          ...
          ,Fields.InvalidMessage_orig_retail_price(1),Fields.InvalidMessage_orig_retail_price(2),Fields.InvalidMessage_orig_retail_price(3),Fields.InvalidMessage_orig_retail_price(4)
          ...
          ,Fields.InvalidMessage_orig_ip_address(1),Fields.InvalidMessage_orig_ip_address(2),Fields.InvalidMessage_orig_ip_address(3)
          ,'Fields with errors'
      ...
      SELF.rulecnt := CHOOSE(c
          ,le.orig_login_id_LEFTTRIM_ErrorCount,le.orig_login_id_ALLOW_ErrorCount,le.orig_login_id_LENGTHS_ErrorCount,le.orig_login_id_WORDS_ErrorCount
          ...
          ,le.orig_fname_2_ALLOW_ErrorCount,le.orig_fname_2_WORDS_ErrorCount
          ...
          ,le.orig_lname_2_ALLOW_ErrorCount,le.orig_lname_2_WORDS_ErrorCount
          ...
          ,le.orig_zip_LEFTTRIM_ErrorCount,le.orig_zip_LENGTHS_ErrorCount,le.orig_zip_WORDS_ErrorCount
          ...
          ,le.orig_city_2_ALLOW_ErrorCount,le.orig_city_2_WORDS_ErrorCount
          ,le.orig_state_2_ALLOW_ErrorCount,le.orig_state_2_LENGTHS_ErrorCount,le.orig_state_2_WORDS_ErrorCount
          ...
          ,le.orig_business_name_2_ALLOW_ErrorCount,le.orig_business_name_2_WORDS_ErrorCount
          ...
          ,le.orig_unique_id_LEFTTRIM_ErrorCount,le.orig_unique_id_ALLOW_ErrorCount,le.orig_unique_id_LENGTHS_ErrorCount,le.orig_unique_id_WORDS_ErrorCount
          ...
          ,le.orig_report_options_LEFTTRIM_ErrorCount,le.orig_report_options_ALLOW_ErrorCount,le.orig_report_options_LENGTHS_ErrorCount,le.orig_report_options_WORDS_ErrorCount
          ,le.orig_end_user_name_LEFTTRIM_ErrorCount,le.orig_end_user_name_ALLOW_ErrorCount,le.orig_end_user_name_LENGTHS_ErrorCount,le.orig_end_user_name_WORDS_ErrorCount
          ,le.orig_end_user_address_1_LEFTTRIM_ErrorCount,le.orig_end_user_address_1_ALLOW_ErrorCount,le.orig_end_user_address_1_LENGTHS_ErrorCount,le.orig_end_user_address_1_WORDS_ErrorCount
          ...
          ,le.orig_end_user_city_LEFTTRIM_ErrorCount,le.orig_end_user_city_ALLOW_ErrorCount,le.orig_end_user_city_LENGTHS_ErrorCount,le.orig_end_user_city_WORDS_ErrorCount
          ...
          ,le.orig_retail_price_LEFTTRIM_ErrorCount,le.orig_retail_price_ALLOW_ErrorCount,le.orig_retail_price_LENGTHS_ErrorCount,le.orig_retail_price_WORDS_ErrorCount
          ...
          ,le.orig_ip_address_LEFTTRIM_ErrorCount,le.orig_ip_address_LENGTHS_ErrorCount,le.orig_ip_address_WORDS_ErrorCount
      ...
      SELF.rulepcnt := IF(c <= NumRules, 100 * CHOOSE(c
          ...
          ,le.orig_dls_LEFTTRIM_ErrorCount,le.orig_dls_ALLOW_ErrorCount,le.orig_dls_LENGTHS_ErrorCount,le.orig_dls_WORDS_ErrorCount
          ,le.orig_mvs_LEFTTRIM_ErrorCount,le.orig_mvs_ALLOW_ErrorCount,le.orig_mvs_LENGTHS_ErrorCount,le.orig_mvs_WORDS_ErrorCount
          ,le.orig_ip_address_LEFTTRIM_ErrorCount,le.orig_ip_address_LENGTHS_ErrorCount,le.orig_ip_address_WORDS_ErrorCount,0) / le.TotalCnt + 0.5, CHOOSE(c - NumRules
...
EXPORT StandardStats(DATASET(Layout_FILE) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_Inql_Nonfcra_Riskwise, Fields, 'RECORDOF(scrubsSummaryOverall)', '');
