...
EXPORT SALT39.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'DEFAULT','ALPHA','NAME','NUMBER','WORDBAG','orig_login_id','orig_billing_code','orig_transaction_id','orig_function_name','orig_company_id','orig_reference_code','orig_fname','orig_mname','orig_lname','orig_name_suffix','orig_fname_2','orig_mname_2','orig_lname_2','orig_name_suffix_2','orig_address','orig_city','orig_state','orig_zip','orig_zip4','orig_address_2','orig_city_2','orig_state_2','orig_zip_2','orig_zip4_2','orig_clean_address','orig_clean_city','orig_clean_state','orig_clean_zip','orig_clean_zip4','orig_phone','orig_homephone','orig_homephone_2','orig_workphone','orig_workphone_2','orig_ssn','orig_ssn_2','orig_free','orig_record_count','orig_price','orig_revenue','orig_full_name','orig_business_name','orig_business_name_2','orig_years','orig_pricing_error_code','orig_fcra_purpose','orig_result_format','orig_dob','orig_dob_2','orig_unique_id','orig_response_time','orig_data_source','orig_report_options','orig_end_user_name','orig_end_user_address_1','orig_end_user_address_2','orig_end_user_city','orig_end_user_state','orig_end_user_zip','orig_login_history_id','orig_employment_state','orig_end_user_industry_class','orig_function_specific_data','orig_date_added','orig_retail_price','orig_country_code','orig_email','orig_email_2','orig_dl_number','orig_dl_number_2','orig_sub_id','orig_neighbors','orig_relatives','orig_associates','orig_property','orig_bankruptcy','orig_dls','orig_mvs','orig_ip_address');
EXPORT FieldTypeNum(SALT39.StrType fn) := CASE(fn,'DEFAULT' => 1,'ALPHA' => 2,'NAME' => 3,'NUMBER' => 4,'WORDBAG' => 5,'orig_login_id' => 6,'orig_billing_code' => 7,'orig_transaction_id' => 8,'orig_function_name' => 9,'orig_company_id' => 10,'orig_reference_code' => 11,'orig_fname' => 12,'orig_mname' => 13,'orig_lname' => 14,'orig_name_suffix' => 15,'orig_fname_2' => 16,'orig_mname_2' => 17,'orig_lname_2' => 18,'orig_name_suffix_2' => 19,'orig_address' => 20,'orig_city' => 21,'orig_state' => 22,'orig_zip' => 23,'orig_zip4' => 24,'orig_address_2' => 25,'orig_city_2' => 26,'orig_state_2' => 27,'orig_zip_2' => 28,'orig_zip4_2' => 29,'orig_clean_address' => 30,'orig_clean_city' => 31,'orig_clean_state' => 32,'orig_clean_zip' => 33,'orig_clean_zip4' => 34,'orig_phone' => 35,'orig_homephone' => 36,'orig_homephone_2' => 37,'orig_workphone' => 38,'orig_workphone_2' => 39,'orig_ssn' => 40,'orig_ssn_2' => 41,'orig_free' => 42,'orig_record_count' => 43,'orig_price' => 44,'orig_revenue' => 45,'orig_full_name' => 46,'orig_business_name' => 47,'orig_business_name_2' => 48,'orig_years' => 49,'orig_pricing_error_code' => 50,'orig_fcra_purpose' => 51,'orig_result_format' => 52,'orig_dob' => 53,'orig_dob_2' => 54,'orig_unique_id' => 55,'orig_response_time' => 56,'orig_data_source' => 57,'orig_report_options' => 58,'orig_end_user_name' => 59,'orig_end_user_address_1' => 60,'orig_end_user_address_2' => 61,'orig_end_user_city' => 62,'orig_end_user_state' => 63,'orig_end_user_zip' => 64,'orig_login_history_id' => 65,'orig_employment_state' => 66,'orig_end_user_industry_class' => 67,'orig_function_specific_data' => 68,'orig_date_added' => 69,'orig_retail_price' => 70,'orig_country_code' => 71,'orig_email' => 72,'orig_email_2' => 73,'orig_dl_number' => 74,'orig_dl_number_2' => 75,'orig_sub_id' => 76,'orig_neighbors' => 77,'orig_relatives' => 78,'orig_associates' => 79,'orig_property' => 80,'orig_bankruptcy' => 81,'orig_dls' => 82,'orig_mvs' => 83,'orig_ip_address' => 84,0);
...
END;
EXPORT InValidFT_orig_login_id(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '))),~(LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 17 OR LENGTH(TRIM(s)) = 6),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_login_id(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '),SALT39.HygieneErrors.NotLength('8,17,6'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_billing_code(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_billing_code(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_billing_code(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_orig_transaction_id(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'0123456789U '); // Only allow valid symbols
  s2 := SALT39.stringcleanspaces( SALT39.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_orig_transaction_id(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789U '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_transaction_id(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('0123456789U '),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_function_name(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_WORDBAG(s3);
END;
EXPORT InValidFT_orig_function_name(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '))),~(LENGTH(TRIM(s)) = 7),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_function_name(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '),SALT39.HygieneErrors.NotLength('7'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_reference_code(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_reference_code(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_reference_code(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
END;
EXPORT InValidFT_orig_fname(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2));
EXPORT InValidMessageFT_orig_fname(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1,2'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_mname(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_NAME(s2);
END;
EXPORT InValidFT_orig_mname(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2));
EXPORT InValidMessageFT_orig_mname(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1,2'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_lname(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_NAME(s2);
END;
EXPORT InValidFT_orig_lname(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 3));
EXPORT InValidMessageFT_orig_lname(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1,2,3'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_name_suffix(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_name_suffix(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_name_suffix(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_fname_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_NAME(s2);
END;
EXPORT InValidFT_orig_fname_2(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_fname_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_mname_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_mname_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_mname_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_lname_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_NAME(s2);
END;
EXPORT InValidFT_orig_lname_2(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_lname_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
END;
EXPORT InValidFT_orig_city(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 3));
EXPORT InValidMessageFT_orig_city(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT39.HygieneErrors.NotWords('1,2,3'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_state(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_ALPHA(s2);
END;
EXPORT InValidFT_orig_state(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_state(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_zip(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s2;
END;
EXPORT InValidFT_orig_zip(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,~(LENGTH(TRIM(s)) = 5 OR LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_zip(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotLength('5,9,2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_zip4(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_zip4(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_zip4(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_city_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_ALPHA(s2);
END;
EXPORT InValidFT_orig_city_2(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2));
EXPORT InValidMessageFT_orig_city_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT39.HygieneErrors.NotWords('1,2'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_state_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_ALPHA(s2);
END;
EXPORT InValidFT_orig_state_2(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_state_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_zip_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_zip_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789N '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 5 OR LENGTH(TRIM(s)) = 9),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_zip_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0123456789N '),SALT39.HygieneErrors.NotLength('2,5,9'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_homephone(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_homephone(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'-0123456789N '))),~(LENGTH(TRIM(s)) = 10 OR LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 7 OR LENGTH(TRIM(s)) = 12),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_homephone(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('-0123456789N '),SALT39.HygieneErrors.NotLength('10,2,7,12'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_homephone_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_homephone_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789N '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 10),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_homephone_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0123456789N '),SALT39.HygieneErrors.NotLength('2,10'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_workphone(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_workphone(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789N '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 10),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_workphone(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0123456789N '),SALT39.HygieneErrors.NotLength('2,10'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_workphone_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_workphone_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_workphone_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2,0'),SALT39.HygieneErrors.NotWords('1,0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_ssn(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_ssn(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789N '))),~(LENGTH(TRIM(s)) = 9 OR LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_ssn(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0123456789N '),SALT39.HygieneErrors.NotLength('9,2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_ssn_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_ssn_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789N '))),~(LENGTH(TRIM(s)) = 2 OR LENGTH(TRIM(s)) = 9),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_ssn_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0123456789N '),SALT39.HygieneErrors.NotLength('2,9'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_record_count(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_record_count(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'1 '))),~(LENGTH(TRIM(s)) = 1),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_record_count(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('1 '),SALT39.HygieneErrors.NotLength('1'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_price(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s2;
END;
EXPORT InValidFT_orig_price(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,~(LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 9),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_price(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotLength('8,9'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_full_name(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_full_name(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_full_name(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_business_name(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_WORDBAG(s2);
END;
EXPORT InValidFT_orig_business_name(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 3 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 4 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 5 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 6));
EXPORT InValidMessageFT_orig_business_name(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '),SALT39.HygieneErrors.NotWords('1,2,3,4,5,6'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_business_name_2(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_NAME(s2);
END;
EXPORT InValidFT_orig_business_name_2(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 2 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 3 OR SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 4));
EXPORT InValidMessageFT_orig_business_name_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-,\'. '),SALT39.HygieneErrors.NotWords('1,2,3,4'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_fcra_purpose(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_fcra_purpose(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0 '))),~(LENGTH(TRIM(s)) = 1),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_fcra_purpose(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('0 '),SALT39.HygieneErrors.NotLength('1'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_dob(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_dob(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'/0123456789N '))),~(LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_dob(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('/0123456789N '),SALT39.HygieneErrors.NotLength('8,2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_orig_dob_2(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'1N '); // Only allow valid symbols
  s2 := SALT39.stringcleanspaces( SALT39.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_orig_dob_2(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'1N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_dob_2(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('1N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_unique_id(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_unique_id(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_unique_id(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_report_options(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_report_options(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'N '))),~(LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_report_options(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('N '),SALT39.HygieneErrors.NotLength('2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_end_user_name(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_end_user_name(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_end_user_name(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars(' '),SALT39.HygieneErrors.NotLength('0'),SALT39.HygieneErrors.NotWords('0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_end_user_address_1(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_end_user_address_1(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_end_user_address_1(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars(' '),SALT39.HygieneErrors.NotLength('0'),SALT39.HygieneErrors.NotWords('0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_end_user_city(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_end_user_city(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_end_user_city(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars(' '),SALT39.HygieneErrors.NotLength('0'),SALT39.HygieneErrors.NotWords('0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_end_user_state(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_end_user_state(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_end_user_state(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars(' '),SALT39.HygieneErrors.NotLength('0'),SALT39.HygieneErrors.NotWords('0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_end_user_zip(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s3;
END;
EXPORT InValidFT_orig_end_user_zip(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,' '))),~(LENGTH(TRIM(s)) = 0),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 0));
EXPORT InValidMessageFT_orig_end_user_zip(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars(' '),SALT39.HygieneErrors.NotLength('0'),SALT39.HygieneErrors.NotWords('0'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_retail_price(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'.0123478N '); // Only allow valid symbols
  s2 := SALT39.stringcleanspaces( SALT39.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  s3 := TRIM(s2,LEFT); // Left trim
  RETURN  s3;
END;
EXPORT InValidFT_orig_retail_price(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'.0123478N '))),~(LENGTH(TRIM(s)) = 8 OR LENGTH(TRIM(s)) = 2),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_retail_price(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('.0123478N '),SALT39.HygieneErrors.NotLength('8,2'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_dl_number(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_WORDBAG(s3);
END;
EXPORT InValidFT_orig_dl_number(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_dl_number(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_sub_id(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  MakeFT_WORDBAG(s3);
END;
EXPORT InValidFT_orig_sub_id(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '))),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_sub_id(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789<>{}[]-^=!+&,./:|#_@$ '),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_orig_ip_address(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s2;
END;
EXPORT InValidFT_orig_ip_address(SALT39.StrType s) := WHICH(s[1]=' ' AND LENGTH(TRIM(s))>0,~(LENGTH(TRIM(s)) = 13 OR LENGTH(TRIM(s)) = 14 OR LENGTH(TRIM(s)) = 11 OR LENGTH(TRIM(s)) = 12),~(SALT39.WordCount(SALT39.StringSubstituteOut(s,' ',' ')) = 1));
EXPORT InValidMessageFT_orig_ip_address(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotLeft,SALT39.HygieneErrors.NotLength('13,14,11,12'),SALT39.HygieneErrors.NotWords('1'),SALT39.HygieneErrors.Good);
...
EXPORT SET OF SALT39.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['ALLOW','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW'],['ALLOW','WORDS'],['ALLOW','LENGTHS','WORDS'],['LEFTTRIM','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['ALLOW','WORDS'],['ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','ALLOW','LENGTHS','WORDS'],['LEFTTRIM','LENGTHS','WORDS'],[]);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT39,Scrubs_Inql_Nonfcra_Riskwise;
