...
Command line options: -MScrubs_Corp2_Mapping_CT_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFRFC21.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_CT_Main
FILENAME:In_CT
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(10)
FIELDTYPE:invalid_corp_vendor:ENUM(09)
FIELDTYPE:invalid_state_origin:ENUM(CT)
FIELDTYPE:invalid_charter:ALLOW(0123456789):LENGTHS(7)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_cd:ENUM(01|07|I| )
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL|RESERVED|OLD NAME| )
FIELDTYPE:invalid_corp_status_cd:ENUM(AC|CN|CO|CS|CV|D|ER|EX|FF|M|PC|PE|PM|PR|RC|RD|RE|RG|RN|RS|RV|WD| )
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(B|C|D|F|G|H|I|J|K|L|M|O| )
FIELDTYPE:invalid_orig_bus_type_cd:ENUM(BK|C|CU|IN|R| )
