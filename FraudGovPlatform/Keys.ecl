...
export Keys(
	...
	shared Base_DisposableEmailDomains 					:= PROJECT(Files().Input.DisposableEmailDomains.Sprayed,Transform(Layouts_Key.DisposableEmailDomains,Self:=left));
 ...
 export Main := module
	...
	tools.mac_FilesIndex('Base_DisposableEmailDomains,{DisposableEmailDomain},{Base_DisposableEmailDomains}',KeyNames(pversion).Main.DisposableEmailDomains,DisposableEmailDomains);
	end; 	
end;