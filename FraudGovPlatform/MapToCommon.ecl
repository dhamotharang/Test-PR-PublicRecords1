...
module  
	...
	Export Deltabase := project (extra_dedup_delta, transform(FraudShared.Layouts.Base.Main , 
		...
		// self.name_risk_code 				:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		self.ssn_risk_code 					:= if(left.event_entity_1 = 'FULL_SSN'	, left.event_type_1, '') ;
		// self.dob_risk_code 				:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		...
		// self.cell_phone_risk_code 		:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		self.work_phone_risk_code 			:= if(left.event_entity_1 = 'NAME'			, left.event_type_1, '') ;
		self.bank_account_1_risk_code 		:= if(left.event_entity_1 = 'BANK_ACCOUNT'			, left.event_type_1, '') ;
		// self.bank_account_2_risk_code 	:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		...
		// self.business_risk_code 			:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		// self.mailing_address_risk_code 	:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
		// self.device_risk_code 			:= if(left.event_entity_1 = ''					, left.event_type_1, '') ;
