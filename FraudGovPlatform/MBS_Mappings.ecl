...
transform({unsigned6 fdn_file_info_id, string20 contribution_source, string contribution_gc_id, unsigned6 Customer_Account_Number, string2 Customer_State, string Customer_Agency_Vertical_Type, string1 Customer_Program, unsigned3 file_type},
