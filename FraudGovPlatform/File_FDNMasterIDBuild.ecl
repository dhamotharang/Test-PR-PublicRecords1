...
shared 	MsIndTypIncl_ds		 			:= Files().Input.mbsfdnmasteridindtypeinclusion.sprayed;
				...
				gcid_excl_proj     			:= project(newGCExcl_ds(exclusion_id_type='GCID'), transform(Layouts.Input.FDNMasterID,
				...
				gcid_incl_proj		 			:= Project(MsIndTypIncl_ds(inclusion_type ='GCID'),transform(Layouts.Input.FDNMasterID,
				...
				ccid_proj          			:= project(ccid_ds(gc_id<>0),transform(Layouts.Input.FDNMasterID, 
				...
				hhid_proj          			:= project(hhid_ds(gc_id<>0),transform(Layouts.Input.FDNMasterID,
