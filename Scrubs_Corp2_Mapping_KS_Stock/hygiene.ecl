...
EXPORT Summary(SALT30.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_stock_stock_description := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_description)));
    avelength_stock_stock_description := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_description)),h.stock_stock_description<>(typeof(h.stock_stock_description))'');
    populated_stock_stock_series_pcnt := AVE(GROUP,IF(h.stock_stock_series = (TYPEOF(h.stock_stock_series))'',0,100));
    maxlength_stock_stock_series := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_series)));
    avelength_stock_stock_series := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_series)),h.stock_stock_series<>(typeof(h.stock_stock_series))'');
    populated_stock_non_par_value_flag_pcnt := AVE(GROUP,IF(h.stock_non_par_value_flag = (TYPEOF(h.stock_non_par_value_flag))'',0,100));
    maxlength_stock_non_par_value_flag := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_non_par_value_flag)));
    avelength_stock_non_par_value_flag := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_non_par_value_flag)),h.stock_non_par_value_flag<>(typeof(h.stock_non_par_value_flag))'');
    populated_stock_additional_stock_pcnt := AVE(GROUP,IF(h.stock_additional_stock = (TYPEOF(h.stock_additional_stock))'',0,100));
    maxlength_stock_additional_stock := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_additional_stock)));
    avelength_stock_additional_stock := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_additional_stock)),h.stock_additional_stock<>(typeof(h.stock_additional_stock))'');
    ...
    maxlength_stock_shares_proportion_to_ohio_for_foreign_license := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_shares_proportion_to_ohio_for_foreign_license)));
    avelength_stock_shares_proportion_to_ohio_for_foreign_license := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_shares_proportion_to_ohio_for_foreign_license)),h.stock_shares_proportion_to_ohio_for_foreign_license<>(typeof(h.stock_shares_proportion_to_ohio_for_foreign_license))'');
    populated_stock_share_credits_pcnt := AVE(GROUP,IF(h.stock_share_credits = (TYPEOF(h.stock_share_credits))'',0,100));
    maxlength_stock_share_credits := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_share_credits)));
    avelength_stock_share_credits := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_share_credits)),h.stock_share_credits<>(typeof(h.stock_share_credits))'');
    populated_stock_authorized_capital_pcnt := AVE(GROUP,IF(h.stock_authorized_capital = (TYPEOF(h.stock_authorized_capital))'',0,100));
    maxlength_stock_authorized_capital := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_authorized_capital)));
    avelength_stock_authorized_capital := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_authorized_capital)),h.stock_authorized_capital<>(typeof(h.stock_authorized_capital))'');
    ...
    maxlength_stock_stock_paid_in_capital := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_paid_in_capital)));
    avelength_stock_stock_paid_in_capital := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_stock_paid_in_capital)),h.stock_stock_paid_in_capital<>(typeof(h.stock_stock_paid_in_capital))'');
    ...
    maxlength_stock_pay_higher_stock_fees := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_pay_higher_stock_fees)));
    avelength_stock_pay_higher_stock_fees := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_pay_higher_stock_fees)),h.stock_pay_higher_stock_fees<>(typeof(h.stock_pay_higher_stock_fees))'');
    ...
    maxlength_stock_actual_amt_invested_in_state := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_actual_amt_invested_in_state)));
    avelength_stock_actual_amt_invested_in_state := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_actual_amt_invested_in_state)),h.stock_actual_amt_invested_in_state<>(typeof(h.stock_actual_amt_invested_in_state))'');
    ...
    maxlength_stock_share_exchange_during_merger := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_share_exchange_during_merger)));
    avelength_stock_share_exchange_during_merger := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_share_exchange_during_merger)),h.stock_share_exchange_during_merger<>(typeof(h.stock_share_exchange_during_merger))'');
    ...
    maxlength_stock_date_stock_limit_approved := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_date_stock_limit_approved)));
    avelength_stock_date_stock_limit_approved := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_date_stock_limit_approved)),h.stock_date_stock_limit_approved<>(typeof(h.stock_date_stock_limit_approved))'');
    ...
    maxlength_stock_number_of_shares_paid_for := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_number_of_shares_paid_for)));
    avelength_stock_number_of_shares_paid_for := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_number_of_shares_paid_for)),h.stock_number_of_shares_paid_for<>(typeof(h.stock_number_of_shares_paid_for))'');
    ...
    maxlength_stock_total_value_of_shares_paid_for := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_total_value_of_shares_paid_for)));
    avelength_stock_total_value_of_shares_paid_for := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_total_value_of_shares_paid_for)),h.stock_total_value_of_shares_paid_for<>(typeof(h.stock_total_value_of_shares_paid_for))'');
    ...
    maxlength_stock_sharesofbeneficialinterest := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_sharesofbeneficialinterest)));
    avelength_stock_sharesofbeneficialinterest := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_sharesofbeneficialinterest)),h.stock_sharesofbeneficialinterest<>(typeof(h.stock_sharesofbeneficialinterest))'');
    ...
    maxlength_stock_beneficialsharevalue := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_beneficialsharevalue)));
    avelength_stock_beneficialsharevalue := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.stock_beneficialsharevalue)),h.stock_beneficialsharevalue<>(typeof(h.stock_beneficialsharevalue))'');
  END;
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.stock_ticker_symbol),TRIM((SALT30.StrType)le.stock_exchange),TRIM((SALT30.StrType)le.stock_type),TRIM((SALT30.StrType)le.stock_class),TRIM((SALT30.StrType)le.stock_shares_issued),TRIM((SALT30.StrType)le.stock_authorized_nbr),TRIM((SALT30.StrType)le.stock_par_value),TRIM((SALT30.StrType)le.stock_nbr_par_shares),TRIM((SALT30.StrType)le.stock_change_ind),TRIM((SALT30.StrType)le.stock_change_date),TRIM((SALT30.StrType)le.stock_voting_rights_ind),TRIM((SALT30.StrType)le.stock_convert_ind),TRIM((SALT30.StrType)le.stock_convert_date),TRIM((SALT30.StrType)le.stock_change_in_cap),TRIM((SALT30.StrType)le.stock_tax_capital),TRIM((SALT30.StrType)le.stock_total_capital),TRIM((SALT30.StrType)le.stock_addl_info),TRIM((SALT30.StrType)le.stock_stock_description),TRIM((SALT30.StrType)le.stock_stock_series),TRIM((SALT30.StrType)le.stock_non_par_value_flag),TRIM((SALT30.StrType)le.stock_additional_stock),TRIM((SALT30.StrType)le.stock_shares_proportion_to_ohio_for_foreign_license),TRIM((SALT30.StrType)le.stock_share_credits),TRIM((SALT30.StrType)le.stock_authorized_capital),TRIM((SALT30.StrType)le.stock_stock_paid_in_capital),TRIM((SALT30.StrType)le.stock_pay_higher_stock_fees),TRIM((SALT30.StrType)le.stock_actual_amt_invested_in_state),TRIM((SALT30.StrType)le.stock_share_exchange_during_merger),TRIM((SALT30.StrType)le.stock_date_stock_limit_approved),TRIM((SALT30.StrType)le.stock_number_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_total_value_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_sharesofbeneficialinterest),TRIM((SALT30.StrType)le.stock_beneficialsharevalue)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 40);
  SELF.FldNo2 := 1 + (C % 40);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.stock_ticker_symbol),TRIM((SALT30.StrType)le.stock_exchange),TRIM((SALT30.StrType)le.stock_type),TRIM((SALT30.StrType)le.stock_class),TRIM((SALT30.StrType)le.stock_shares_issued),TRIM((SALT30.StrType)le.stock_authorized_nbr),TRIM((SALT30.StrType)le.stock_par_value),TRIM((SALT30.StrType)le.stock_nbr_par_shares),TRIM((SALT30.StrType)le.stock_change_ind),TRIM((SALT30.StrType)le.stock_change_date),TRIM((SALT30.StrType)le.stock_voting_rights_ind),TRIM((SALT30.StrType)le.stock_convert_ind),TRIM((SALT30.StrType)le.stock_convert_date),TRIM((SALT30.StrType)le.stock_change_in_cap),TRIM((SALT30.StrType)le.stock_tax_capital),TRIM((SALT30.StrType)le.stock_total_capital),TRIM((SALT30.StrType)le.stock_addl_info),TRIM((SALT30.StrType)le.stock_stock_description),TRIM((SALT30.StrType)le.stock_stock_series),TRIM((SALT30.StrType)le.stock_non_par_value_flag),TRIM((SALT30.StrType)le.stock_additional_stock),TRIM((SALT30.StrType)le.stock_shares_proportion_to_ohio_for_foreign_license),TRIM((SALT30.StrType)le.stock_share_credits),TRIM((SALT30.StrType)le.stock_authorized_capital),TRIM((SALT30.StrType)le.stock_stock_paid_in_capital),TRIM((SALT30.StrType)le.stock_pay_higher_stock_fees),TRIM((SALT30.StrType)le.stock_actual_amt_invested_in_state),TRIM((SALT30.StrType)le.stock_share_exchange_during_merger),TRIM((SALT30.StrType)le.stock_date_stock_limit_approved),TRIM((SALT30.StrType)le.stock_number_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_total_value_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_sharesofbeneficialinterest),TRIM((SALT30.StrType)le.stock_beneficialsharevalue)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.corp_key),TRIM((SALT30.StrType)le.corp_vendor),TRIM((SALT30.StrType)le.corp_vendor_county),TRIM((SALT30.StrType)le.corp_vendor_subcode),TRIM((SALT30.StrType)le.corp_state_origin),TRIM((SALT30.StrType)le.corp_process_date),TRIM((SALT30.StrType)le.corp_sos_charter_nbr),TRIM((SALT30.StrType)le.stock_ticker_symbol),TRIM((SALT30.StrType)le.stock_exchange),TRIM((SALT30.StrType)le.stock_type),TRIM((SALT30.StrType)le.stock_class),TRIM((SALT30.StrType)le.stock_shares_issued),TRIM((SALT30.StrType)le.stock_authorized_nbr),TRIM((SALT30.StrType)le.stock_par_value),TRIM((SALT30.StrType)le.stock_nbr_par_shares),TRIM((SALT30.StrType)le.stock_change_ind),TRIM((SALT30.StrType)le.stock_change_date),TRIM((SALT30.StrType)le.stock_voting_rights_ind),TRIM((SALT30.StrType)le.stock_convert_ind),TRIM((SALT30.StrType)le.stock_convert_date),TRIM((SALT30.StrType)le.stock_change_in_cap),TRIM((SALT30.StrType)le.stock_tax_capital),TRIM((SALT30.StrType)le.stock_total_capital),TRIM((SALT30.StrType)le.stock_addl_info),TRIM((SALT30.StrType)le.stock_stock_description),TRIM((SALT30.StrType)le.stock_stock_series),TRIM((SALT30.StrType)le.stock_non_par_value_flag),TRIM((SALT30.StrType)le.stock_additional_stock),TRIM((SALT30.StrType)le.stock_shares_proportion_to_ohio_for_foreign_license),TRIM((SALT30.StrType)le.stock_share_credits),TRIM((SALT30.StrType)le.stock_authorized_capital),TRIM((SALT30.StrType)le.stock_stock_paid_in_capital),TRIM((SALT30.StrType)le.stock_pay_higher_stock_fees),TRIM((SALT30.StrType)le.stock_actual_amt_invested_in_state),TRIM((SALT30.StrType)le.stock_share_exchange_during_merger),TRIM((SALT30.StrType)le.stock_date_stock_limit_approved),TRIM((SALT30.StrType)le.stock_number_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_total_value_of_shares_paid_for),TRIM((SALT30.StrType)le.stock_sharesofbeneficialinterest),TRIM((SALT30.StrType)le.stock_beneficialsharevalue)));
  END;
...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{40,'stock_beneficialsharevalue'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_stock_stock_description((SALT30.StrType)le.stock_stock_description),
    Fields.InValid_stock_stock_series((SALT30.StrType)le.stock_stock_series),
    Fields.InValid_stock_non_par_value_flag((SALT30.StrType)le.stock_non_par_value_flag),
    Fields.InValid_stock_additional_stock((SALT30.StrType)le.stock_additional_stock),
    Fields.InValid_stock_shares_proportion_to_ohio_for_foreign_license((SALT30.StrType)le.stock_shares_proportion_to_ohio_for_foreign_license),
    Fields.InValid_stock_share_credits((SALT30.StrType)le.stock_share_credits),
    Fields.InValid_stock_authorized_capital((SALT30.StrType)le.stock_authorized_capital),
    Fields.InValid_stock_stock_paid_in_capital((SALT30.StrType)le.stock_stock_paid_in_capital),
    Fields.InValid_stock_pay_higher_stock_fees((SALT30.StrType)le.stock_pay_higher_stock_fees),
    Fields.InValid_stock_actual_amt_invested_in_state((SALT30.StrType)le.stock_actual_amt_invested_in_state),
    Fields.InValid_stock_share_exchange_during_merger((SALT30.StrType)le.stock_share_exchange_during_merger),
    Fields.InValid_stock_date_stock_limit_approved((SALT30.StrType)le.stock_date_stock_limit_approved),
    Fields.InValid_stock_number_of_shares_paid_for((SALT30.StrType)le.stock_number_of_shares_paid_for),
    Fields.InValid_stock_total_value_of_shares_paid_for((SALT30.StrType)le.stock_total_value_of_shares_paid_for),
    Fields.InValid_stock_sharesofbeneficialinterest((SALT30.StrType)le.stock_sharesofbeneficialinterest),
    Fields.InValid_stock_beneficialsharevalue((SALT30.StrType)le.stock_beneficialsharevalue),
    0);
