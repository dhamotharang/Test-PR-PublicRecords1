...
Ingenix_Provider_File_dist 				:= distribute(Ingenix_Provider_File,HASH32(providerid));
Ingenix_Provider_Father_File_dist := distribute(Ingenix_Provider_Father_File,HASH32(providerid));
...
Ingenix_Sanc_File_dist 				:= distribute(Ingenix_Sanc_File,HASH32(sanc_id));
Ingenix_Sanc_Father_File_dist := distribute(Ingenix_Sanc_Father_File,HASH32(sanc_id));
