...
export Proc_AcceptSK_ToQA :=  parallel(	mv_did_key, mv_pid_key, mv_psanc_pid_key, 
																				mv_lic_key, mv_lic_pid_key,
																				mv_language_key, mv_upin_key,
																				mv_dea_key, mv_dea_DEANumber_key,
																				mv_degree_key, mv_speciality_key,
																				mv_group_LinkIDs_key, mv_group_key,
																				mv_hospital_LinkIDs_key, mv_hospital_key, 
																				mv_residency_LinkIDs_key, mv_residency_key,
																				mv_medschool_LinkIDs_key, mv_medschool_key,
																				mv_prov_taxid_key, mv_san_did_key, 
																				mv_san_bdid_key, mv_san_LinkIDs_key,
																				mv_san_sancid_key, mv_san_upin_key, mv_san_license_key,
																				mv_san_taxid_key, mv_san_autokey,
																				mv_san_fdids_key, mv_san_taxid_name_key,
