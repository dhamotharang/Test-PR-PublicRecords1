...
file_in := Ingenix_NatlProf.update_medschool_bdid;

Pre_BDID_Rec
 :=
  record
	Ingenix_NatlProf.Layout_Medschool_Base_BIP;
...
Layout_Medschool_Base_BIP tBdid(PostBDIDpersist L)
 :=
  transform
...
export Medschool_BDID := project(PostBDIDpersist, tBdid(left)):persist('~thor_data400::persist::Ingenix_provider_medschool_bdid');