...
main_file := Ingenix_NatlProf.File_Ingenix_Sanctions_DIDed_BDIDed;
...
src_rec := record
 ...
 Ingenix_NatlProf.File_Ingenix_Sanctions_DIDed_BDIDed;
end;

header.Mac_Set_Header_Source(main_file,layout_out,src_rec,'IS',withUID)

export Ingenix_Sanctions_as_source := withUID : persist('~thor_data400::persist::headerbuild_Ingenix_Sanctions_src');
