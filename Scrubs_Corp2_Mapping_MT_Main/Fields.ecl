...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_charter_nbr','invalid_mandatory','invalid_date','invalid_optional_date','invalid_recordorigin','invalid_name_type_cd','invalid_forgn_dom_code','invalid_characters','invalid_term_cd','invalid_term_exp','invalid_status_cd','invalid_orig_org_structure_cd','invalid_bus_type_cd');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_charter_nbr' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_optional_date' => 7,'invalid_recordorigin' => 8,'invalid_name_type_cd' => 9,'invalid_forgn_dom_code' => 10,'invalid_characters' => 11,'invalid_term_cd' => 12,'invalid_term_exp' => 13,'invalid_status_cd' => 14,'invalid_orig_org_structure_cd' => 15,'invalid_bus_type_cd' => 16,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['30']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('30'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['MT']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('MT'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_cd(SALT34.StrType s,SALT34.StrType recordOrigin) := WHICH(~Scrubs_Corp2_Mapping_MT_Main.Functions.invalid_name_type_code(s,recordOrigin)>0);
EXPORT InValidMessageFT_invalid_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MT_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_characters(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' .,-&:/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789()'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_characters(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' .,-&:/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789()'))));
EXPORT InValidMessageFT_invalid_characters(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' .,-&:/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789()'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D','P','N',' ']);
EXPORT InValidMessageFT_invalid_term_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D|P|N| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['A','C',' ']);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('A|C| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_org_structure_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['C','D','E','F','L','N','P',' ']);
EXPORT InValidMessageFT_invalid_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('C|D|E|F|L|N|P| '),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_forgn_state_desc(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_forgn_state_desc(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc1(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc1(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc2(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc2(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc2(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc3(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc3(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc3(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc4(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc4(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc4(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc5(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc5(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc5(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_trademark_class_desc6(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_trademark_class_desc6(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_trademark_class_desc6(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
...
EXPORT Make_corp_status_desc(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_status_desc(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_status_comment(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_status_comment(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_status_comment(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_purpose(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_purpose(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_purpose(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
...
EXPORT Make_corp_name_effective_date(SALT34.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_name_effective_date(SALT34.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_name_effective_date(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_ra_addl_info(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_ra_addl_info(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_ra_addl_info(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_corp_agent_status_cd(SALT34.StrType s0) := MakeFT_invalid_status_cd(s0);
EXPORT InValid_corp_agent_status_cd(SALT34.StrType s) := InValidFT_invalid_status_cd(s);
EXPORT InValidMessage_corp_agent_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_status_cd(wh);
 
EXPORT Make_corp_trademark_first_use_date(SALT34.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_trademark_first_use_date(SALT34.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_trademark_first_use_date(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_trademark_first_use_date_in_state(SALT34.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_trademark_first_use_date_in_state(SALT34.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_trademark_first_use_date_in_state(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_trademark_renewal_date(SALT34.StrType s0) := MakeFT_invalid_optional_date(s0);
EXPORT InValid_corp_trademark_renewal_date(SALT34.StrType s) := InValidFT_invalid_optional_date(s);
EXPORT InValidMessage_corp_trademark_renewal_date(UNSIGNED1 wh) := InValidMessageFT_invalid_optional_date(wh);
 
EXPORT Make_corp_registered_counties(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_registered_counties(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_registered_counties(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
 
EXPORT Make_cont_status_cd(SALT34.StrType s0) := MakeFT_invalid_status_cd(s0);
EXPORT InValid_cont_status_cd(SALT34.StrType s) := InValidFT_invalid_status_cd(s);
EXPORT InValidMessage_cont_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_status_cd(wh);
 
EXPORT Make_cont_title1_desc(SALT34.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_cont_title1_desc(SALT34.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_cont_title1_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
...
#uniquename(fd)
  %dl% %fd%(in_left le,in_right ri) := TRANSFORM
    ...
    SELF.Num_Diffs := 0+ IF( SELF.Diff_dt_vendor_first_reported,1,0)+ IF( SELF.Diff_dt_vendor_last_reported,1,0)+ IF( SELF.Diff_dt_first_seen,1,0)+ IF( SELF.Diff_dt_last_seen,1,0)+ IF( SELF.Diff_corp_ra_dt_first_seen,1,0)+ IF( SELF.Diff_corp_ra_dt_last_seen,1,0)+ IF( SELF.Diff_corp_process_date,1,0)+ IF( SELF.Diff_corp_key,1,0)+ IF( SELF.Diff_corp_orig_sos_charter_nbr,1,0)+ IF( SELF.Diff_corp_vendor,1,0)+ IF( SELF.Diff_corp_state_origin,1,0)+ IF( SELF.Diff_corp_inc_state,1,0)+ IF( SELF.Diff_corp_legal_name,1,0)+ IF( SELF.Diff_corp_ln_name_type_cd,1,0)+ IF( SELF.Diff_corp_filing_date,1,0)+ IF( SELF.Diff_corp_inc_date,1,0)+ IF( SELF.Diff_corp_forgn_date,1,0)+ IF( SELF.Diff_corp_foreign_domestic_ind,1,0)+ IF( SELF.Diff_corp_forgn_state_desc,1,0)+ IF( SELF.Diff_corp_trademark_class_desc1,1,0)+ IF( SELF.Diff_corp_trademark_class_desc2,1,0)+ IF( SELF.Diff_corp_trademark_class_desc3,1,0)+ IF( SELF.Diff_corp_trademark_class_desc4,1,0)+ IF( SELF.Diff_corp_trademark_class_desc5,1,0)+ IF( SELF.Diff_corp_trademark_class_desc6,1,0)+ IF( SELF.Diff_corp_term_exist_cd,1,0)+ IF( SELF.Diff_corp_term_exist_exp,1,0)+ IF( SELF.Diff_corp_orig_org_structure_cd,1,0)+ IF( SELF.Diff_corp_orig_bus_type_cd,1,0)+ IF( SELF.Diff_corp_status_desc,1,0)+ IF( SELF.Diff_corp_status_comment,1,0)+ IF( SELF.Diff_corp_purpose,1,0)+ IF( SELF.Diff_corp_ra_resign_date,1,0)+ IF( SELF.Diff_corp_dissolved_date,1,0)+ IF( SELF.Diff_corp_name_effective_date,1,0)+ IF( SELF.Diff_corp_ra_addl_info,1,0)+ IF( SELF.Diff_corp_agent_status_cd,1,0)+ IF( SELF.Diff_corp_trademark_first_use_date,1,0)+ IF( SELF.Diff_corp_trademark_first_use_date_in_state,1,0)+ IF( SELF.Diff_corp_trademark_renewal_date,1,0)+ IF( SELF.Diff_corp_registered_counties,1,0)+ IF( SELF.Diff_cont_status_cd,1,0)+ IF( SELF.Diff_cont_title1_desc,1,0)+ IF( SELF.Diff_recordorigin,1,0);
  END;
