Generated by SALT V3.10.1
Command line options: -MScrubs_Corp2_Mapping_MT_Main -eC:\Users\mattel01\AppData\Local\Temp\TFR7E09.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_MT_Main
FILENAME:In_MT
...
FIELDTYPE:invalid_corp_vendor:ENUM(30)
FIELDTYPE:invalid_state_origin:ENUM(MT)
...
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_MT_Main.Functions.invalid_name_type_code>0,recordOrigin)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_characters:ALLOW( .,-&:/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789())
FIELDTYPE:invalid_characters_ext:ALLOW( .,'-_&;:/ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789()*+"#?$=)
FIELDTYPE:invalid_term_cd:ENUM(D|P|F| )
FIELDTYPE:invalid_term_exp:ALLOW(0123456789 )
FIELDTYPE:invalid_bus_type_cd:ENUM(set_valid_bus_type_cd)
 
//FIELD DEFINITIONS
DATEFIELD:dt_vendor_first_reported:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
DATEFIELD:dt_vendor_last_reported:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
DATEFIELD:dt_first_seen:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
DATEFIELD:dt_last_seen:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
DATEFIELD:corp_ra_dt_first_seen:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
DATEFIELD:corp_ra_dt_last_seen:TYPE(UNSIGNED4):LIKE(invalid_date):0,0
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc1:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_trademark_class_desc2:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_trademark_class_desc3:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_trademark_class_desc4:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_trademark_class_desc5:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_trademark_class_desc6:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
FIELD:corp_term_exist_cd:TYPE(STRING8):LIKE(invalid_term_cd):0,0
DATEFIELD:corp_term_exist_exp:TYPE(STRING8):LIKE(invalid_term_exp):0,0
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_characters):0,0
FIELD:corp_status_comment:TYPE(STRING350):LIKE(invalid_characters):0,0
DATEFIELD:corp_trademark_first_use_date:TYPE(STRING8):LIKE(invalid_optional_date):0,0
DATEFIELD:corp_trademark_first_use_date_in_state:TYPE(STRING8):LIKE(invalid_optional_date):0,0
DATEFIELD:corp_trademark_renewal_date:TYPE(STRING8):LIKE(invalid_optional_date):0,0
FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_characters_ext):0,0
...
// DATEFIELD:corp_name_reservation_date:TYPE(STRING8):LIKE(invalid_optional_date):0,0
...
// FIELD:cont_country:TYPE(STRING50):LIKE(invalid_alphablankperiod):0,0
// FIELD:corp_agent_country:TYPE(STRING50):LIKE(invalid_alphablankperiod):0,0
// FIELD:corp_status_cd:TYPE(STRING8):LIKE(invalid_status_cd):0,0
// FIELD:corp_name_status_cd:TYPE(STRING5):LIKE(invalid_status_cd):0,0
...
// FIELD:corp_ra_addl_info:TYPE(STRING250):LIKE(invalid_characters):0,0
// FIELD:corp_agent_status_cd:TYPE(STRING5):LIKE(invalid_status_cd):0,0
// DATEFIELD:corp_ra_resign_date:TYPE(STRING8):LIKE(invalid_optional_date):0,0
// DATEFIELD:corp_dissolved_date:TYPE(STRING8):LIKE(invalid_optional_date):0,0
// FIELD:corp_orig_org_structure_cd:TYPE(STRING8):LIKE(invalid_orig_org_structure_cd):0,0
// FIELD:corp_orig_bus_type_cd:TYPE(STRING8):LIKE(invalid_bus_type_cd):0,0
// FIELD:corp_registered_counties:TYPE(STRING500):LIKE(invalid_characters):0,0
// FIELD:cont_status_cd:TYPE(STRING8):LIKE(invalid_status_cd):0,0
// FIELD:corp_purpose:TYPE(STRING250):LIKE(invalid_characters_ext):0,0
