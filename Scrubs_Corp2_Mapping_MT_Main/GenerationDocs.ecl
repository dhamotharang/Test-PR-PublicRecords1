...
Command line options: -MScrubs_Corp2_Mapping_MT_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR968C.tmp 
...
FIELDTYPE:invalid_term_cd:ENUM(D|P|N| )
FIELDTYPE:invalid_term_exp:ALLOW(0123456789 )
FIELDTYPE:invalid_status_cd:ENUM(A|C| )
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(C|D|E|F|L|N|P| )
...
FIELD:corp_trademark_class_desc1:TYPE(STRING250):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc2:TYPE(STRING250):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc3:TYPE(STRING250):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc4:TYPE(STRING250):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc5:TYPE(STRING250):LIKE(invalid_characters):0,0
FIELD:corp_trademark_class_desc6:TYPE(STRING250):LIKE(invalid_characters):0,0
...
FIELD:corp_purpose:TYPE(STRING250):LIKE(invalid_characters):0,0
...
FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_characters):0,0
