MODULE:Scrubs_VehicleV2_OH_Direct
FILENAME:Profile_VehicleV2_OH_Direct
...
FIELDTYPE:invalid_categorycode:ENUM(BU|PC|NC|NT|MC|TK|HV|TL|MH|FM|RV||MP|):LENGTHS(2,0)
...
FIELDTYPE:invalid_state:ENUM(OH|):LENGTHS(2,0)
