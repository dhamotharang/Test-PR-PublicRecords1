...
EXPORT proc_generate_report (boolean submitTheStats = true) := FUNCTION
        ...
        submitStats       := Scrubs.OrbitProfileStatsPost310(o,'ScrubsAlerts',orbitStats,ver,m,CustomTag:='').SubmitStats;
