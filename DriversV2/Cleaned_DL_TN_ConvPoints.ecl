...
EXPORT Cleaned_DL_TN_ConvPoints(STRING processDate, STRING fileDate) := FUNCTION
  ...
  END;
	...
	Cleaned_TN_DL_CP_All  := SEQUENTIAL(
	            OUTPUT(Cleaned_TN_Conv,,DriversV2.Constants.cluster+'in::dl2::TN_CP_Clean_Update::'+ fileDate,OVERWRITE),
