import doxie_build, lib_fileservices, header_services;
...
END;
	...
	base := dataset('~thor_data400::base::DL2::DLSearch_' + doxie_build.buildstate, rec, flat);
	...
	DLOnly_withMD5 := PROJECT(base,Hash_DID_and_dlSeq(left));
...
UNSIGNED6 endMax := MAX(dlFixedAllSupp, dl_seq);
...
export File_DL_KeyBuilding := dlFixedAllSupp + Base_File_Append;