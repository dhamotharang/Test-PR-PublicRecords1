import Ut, lib_stringlib, DriversV2;
...
layout_normAddr trfNormAddr(DriversV2.File_DL_NV_In_All l, integer c) := transform
...
norm_file1 := normalize(DriversV2.File_DL_NV_In_All, 
...
export NV_as_DL := project(norm_file2, lTransform_NV_To_Common(left));
