...
RoxieKeyBuild.MAC_SK_Move_v2('~thor_data400::key::dl2::fcra::@version@::BocaShell.DID','Q',out5);

export Proc_AcceptSK_dl_toQA := parallel(out1, out1a, out2, out3, out4, out5);
