...
dNonExperianDLs 
 ...
 +    MN_as_DL 
 +    MN_New_as_DL 
 +    MN_RESTRICTED_as_DL.MN_RESTRICTED_DL
 /* -- Removed as per Rob Becker and Joe Lezcando due to samba restrictions on this state
 +    NM_as_DL */
 +    ID_as_DL
 +    WI_as_DL
 +    WV_as_DL
 ...
 +    OR_as_DL
 +    IA_as_DL */
 +    MO_as_DL  //removed MO, per Jill Luber to be compliant with the new state law(bug#37550; 20090309) 
...
export DL_joined := dedup(srt_dis_res, record, except dl_seq, status, dt_first_seen, dt_last_seen,
                          dt_vendor_first_reported, dt_vendor_last_reported, local) : persist(DriversV2.Constants.cluster + 'Persist::DL2::DrvLic_DL_Joined');
