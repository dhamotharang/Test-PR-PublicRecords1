...
DriversV2.Layout_DL_Extended lTransform_TN_To_Common(DriversV2.File_DL_TN_Update2 pInput):= TRANSFORM
	SELF.orig_state 			  			:= 'TN';
...
EXPORT TN_as_DL_Update := PROJECT(DriversV2.File_DL_TN_Update2, lTransform_TN_To_Common(LEFT));