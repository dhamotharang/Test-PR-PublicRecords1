...
DriversV2.Layout_DL_Extended intof(o le) := transform
  self.orig_state       := 'OH';
...
export OH_as_DL := project(o+u+m,intof(left)) : persist(DriversV2.Constants.Cluster + 'Persist::DL2::DrvLic_OH_as_DL');