import doxie_build, lib_fileservices;
...
//************************************************************************
//ADD INFORMATION - CNG 20070508 - dW20070508-150712 dW20070508-150600
//************************************************************************

IP_Loc := '10.150.12.240';
Directory_Loc := '/data_999/lnfab/';
Rec_Length := 744; //Rec_Length := sizeof(header.Layout_Header);  //*** USE WHEN WE START TO RECEIVE FILES IN THE CORRECT LAYOUT - RIGHT NOW SET FOR STRING INPUTS
...
export File_DL_Search := dataset('~thor_data400::base::DL2::DLSearch_'+doxie_build.buildstate, rec, flat) + Base_File_Append;
