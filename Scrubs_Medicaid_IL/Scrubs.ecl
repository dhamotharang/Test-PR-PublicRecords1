...
EXPORT FromNone(DATASET(Layout_InFile_) h) := MODULE
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.address_Invalid := Fields.InValid_address((SALT31.StrType)le.address);
    SELF.citystate_Invalid := Fields.InValid_citystate((SALT31.StrType)le.citystate);
    SELF.zipcode_Invalid := Fields.InValid_zipcode((SALT31.StrType)le.zipcode);
    SELF.phone_Invalid := Fields.InValid_phone((SALT31.StrType)le.phone);
    SELF.providertypedesc_Invalid := Fields.InValid_providertypedesc((SALT31.StrType)le.providertypedesc);
    SELF.medicaidid_Invalid := Fields.InValid_medicaidid((SALT31.StrType)le.medicaidid);
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT31.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_name(1),Fields.InvalidMessage_name(2)
          ,Fields.InvalidMessage_address(1),Fields.InvalidMessage_address(2)
          ,Fields.InvalidMessage_citystate(1),Fields.InvalidMessage_citystate(2)
          ...
          ,Fields.InvalidMessage_providertypedesc(1),Fields.InvalidMessage_providertypedesc(2)
          ,Fields.InvalidMessage_medicaidid(1),Fields.InvalidMessage_medicaidid(2),Fields.InvalidMessage_medicaidid(3),Fields.InvalidMessage_medicaidid(4)
          ...
          ,Fields.InvalidMessage_companyname(1)
