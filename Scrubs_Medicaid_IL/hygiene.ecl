...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_address((SALT31.StrType)le.address),
    Fields.InValid_citystate((SALT31.StrType)le.citystate),
    Fields.InValid_zipcode((SALT31.StrType)le.zipcode),
    Fields.InValid_phone((SALT31.StrType)le.phone),
    Fields.InValid_providertypedesc((SALT31.StrType)le.providertypedesc),
    Fields.InValid_medicaidid((SALT31.StrType)le.medicaidid),
