IMPORT ut,SALT31;
EXPORT base_hygiene(dataset(layout_InFile_) h) := MODULE
...
EXPORT Summary(SALT31.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_address := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.address)));
    avelength_address := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.address)),h.address<>(typeof(h.address))'');
    populated_citystate_pcnt := AVE(GROUP,IF(h.citystate = (TYPEOF(h.citystate))'',0,100));
    maxlength_citystate := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.citystate)));
    avelength_citystate := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.citystate)),h.citystate<>(typeof(h.citystate))'');
    ...
    populated_providertypedesc_pcnt := AVE(GROUP,IF(h.providertypedesc = (TYPEOF(h.providertypedesc))'',0,100));
    maxlength_providertypedesc := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.providertypedesc)));
    avelength_providertypedesc := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.providertypedesc)),h.providertypedesc<>(typeof(h.providertypedesc))'');
    populated_medicaidid_pcnt := AVE(GROUP,IF(h.medicaidid = (TYPEOF(h.medicaidid))'',0,100));
    maxlength_medicaidid := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.medicaidid)));
    avelength_medicaidid := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.medicaidid)),h.medicaidid<>(typeof(h.medicaidid))'');
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    base_Fields.InValid_data_state((SALT31.StrType)le.data_state),
    base_Fields.InValid_name((SALT31.StrType)le.name),
    base_Fields.InValid_address((SALT31.StrType)le.address),
    base_Fields.InValid_citystate((SALT31.StrType)le.citystate),
    base_Fields.InValid_zipcode((SALT31.StrType)le.zipcode),
    base_Fields.InValid_phone((SALT31.StrType)le.phone),
    base_Fields.InValid_providertypedesc((SALT31.StrType)le.providertypedesc),
    base_Fields.InValid_medicaidid((SALT31.StrType)le.medicaidid),
    base_Fields.InValid_npi((SALT31.StrType)le.npi),
    base_Fields.InValid_entity_type_code((SALT31.StrType)le.entity_type_code),
    base_Fields.InValid_companyname((SALT31.StrType)le.companyname),
    base_Fields.InValid_src((SALT31.StrType)le.src),
    ...
    base_Fields.InValid_record_type((SALT31.StrType)le.record_type),
    base_Fields.InValid_source_rid((SALT31.StrType)le.source_rid),
    ...
    base_Fields.InValid_lot_order((SALT31.StrType)le.lot_order),
    base_Fields.InValid_dbpc((SALT31.StrType)le.dbpc),
    base_Fields.InValid_chk_digit((SALT31.StrType)le.chk_digit),
    base_Fields.InValid_rec_type((SALT31.StrType)le.rec_type),
    base_Fields.InValid_fips_st((SALT31.StrType)le.fips_st),
    base_Fields.InValid_fips_county((SALT31.StrType)le.fips_county),
    base_Fields.InValid_geo_lat((SALT31.StrType)le.geo_lat),
    base_Fields.InValid_geo_long((SALT31.StrType)le.geo_long),
    base_Fields.InValid_msa((SALT31.StrType)le.msa),
    base_Fields.InValid_geo_blk((SALT31.StrType)le.geo_blk),
    base_Fields.InValid_geo_match((SALT31.StrType)le.geo_match),
    base_Fields.InValid_err_stat((SALT31.StrType)le.err_stat),
    base_Fields.InValid_rawaid((SALT31.StrType)le.rawaid),
    base_Fields.InValid_aceaid((SALT31.StrType)le.aceaid),
    base_Fields.InValid_clean_phone((SALT31.StrType)le.clean_phone),
    base_Fields.InValid_dotid((SALT31.StrType)le.dotid),
    base_Fields.InValid_dotscore((SALT31.StrType)le.dotscore),
    base_Fields.InValid_dotweight((SALT31.StrType)le.dotweight),
    base_Fields.InValid_empid((SALT31.StrType)le.empid),
    base_Fields.InValid_empscore((SALT31.StrType)le.empscore),
    base_Fields.InValid_empweight((SALT31.StrType)le.empweight),
    base_Fields.InValid_powid((SALT31.StrType)le.powid),
    base_Fields.InValid_powscore((SALT31.StrType)le.powscore),
    base_Fields.InValid_powweight((SALT31.StrType)le.powweight),
    base_Fields.InValid_proxid((SALT31.StrType)le.proxid),
    base_Fields.InValid_proxscore((SALT31.StrType)le.proxscore),
    base_Fields.InValid_proxweight((SALT31.StrType)le.proxweight),
    base_Fields.InValid_seleid((SALT31.StrType)le.seleid),
    base_Fields.InValid_selescore((SALT31.StrType)le.selescore),
    base_Fields.InValid_seleweight((SALT31.StrType)le.seleweight),
    base_Fields.InValid_orgid((SALT31.StrType)le.orgid),
    base_Fields.InValid_orgscore((SALT31.StrType)le.orgscore),
    base_Fields.InValid_orgweight((SALT31.StrType)le.orgweight),
    base_Fields.InValid_ultid((SALT31.StrType)le.ultid),
    base_Fields.InValid_ultscore((SALT31.StrType)le.ultscore),
    base_Fields.InValid_ultweight((SALT31.StrType)le.ultweight),
    0);
