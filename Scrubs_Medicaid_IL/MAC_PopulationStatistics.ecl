...
+    #IF( #TEXT(Input_address)='' )
    ...
    #END
+    #IF( #TEXT(Input_citystate)='' )
      '' 
    #ELSE
        IF( le.Input_citystate = (TYPEOF(le.Input_citystate))'','',':citystate')
    #END
...
+    #IF( #TEXT(Input_phone)='' )
    ...
    #END
+    #IF( #TEXT(Input_providertypedesc)='' )
      '' 
    #ELSE
        IF( le.Input_providertypedesc = (TYPEOF(le.Input_providertypedesc))'','',':providertypedesc')
    #END
+    #IF( #TEXT(Input_medicaidid)='' )
      '' 
    #ELSE
        IF( le.Input_medicaidid = (TYPEOF(le.Input_medicaidid))'','',':medicaidid')
    #END
+    #IF( #TEXT(Input_npi)='' )
      '' 
    #ELSE
