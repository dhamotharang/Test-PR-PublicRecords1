...
//NINES:<Precision required 3 = 99.9, 2 = 99 9.080585e+266tc>
...
FIELDTYPE:invalid_std_license_type
FIELDTYPE:invalid_std_license_desc
FIELDTYPE:invalid_raw_license_status:LIKE(uppercaseandnums):SPACES( -.()/#&)
FIELDTYPE:invalid_std_license_status
FIELDTYPE:invalid_std_status_desc:LIKE(uppercaseandnums):SPACES( -.()/#&)
...
FIELDTYPE:invalid_disp_type_desc:LIKE(uppercase)
