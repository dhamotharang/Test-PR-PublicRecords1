//gong_neustar.Layout_bscurrent_raw (as it appears in Thor branches)
//NB: almost identical to gong_neustar.Layout_Gong

EXPORT layout_prepped_for_keys := RECORD
  string3     bell_id;
  //string3     bell;
  string11    filedate;
  ...
  string64    see_also_text;  //RT added 12/27/01
END;
