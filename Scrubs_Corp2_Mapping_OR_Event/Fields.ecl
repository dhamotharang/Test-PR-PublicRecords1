IMPORT ut,SALT32;
IMPORT Scrubs,Scrubs_Corp2_Mapping_OR_Event; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_date_type_cd','invalid_date_type_desc','invalid_event_filing_desc');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_date_type_cd' => 7,'invalid_date_type_desc' => 8,'invalid_event_filing_desc' => 9,0);
...
EXPORT MakeFT_invalid_date_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['FIL','EFF',' ']);
EXPORT InValidMessageFT_invalid_date_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('FIL|EFF| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['FILING','EFFECTIVE',' ']);
EXPORT InValidMessageFT_invalid_date_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('FILING|EFFECTIVE| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_event_filing_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_event_filing_desc(SALT32.StrType s) := WHICH(~Scrubs_Corp2_Mapping_OR_Event.fn_valid_event_filing_desc(s)>0);
EXPORT InValidMessageFT_invalid_event_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OR_Event.fn_valid_event_filing_desc'),SALT32.HygieneErrors.Good);
...
EXPORT Make_event_date_type_cd(SALT32.StrType s0) := MakeFT_invalid_date_type_cd(s0);
EXPORT InValid_event_date_type_cd(SALT32.StrType s) := InValidFT_invalid_date_type_cd(s);
EXPORT InValidMessage_event_date_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_date_type_cd(wh);
 
EXPORT Make_event_date_type_desc(SALT32.StrType s0) := MakeFT_invalid_date_type_desc(s0);
EXPORT InValid_event_date_type_desc(SALT32.StrType s) := InValidFT_invalid_date_type_desc(s);
EXPORT InValidMessage_event_date_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_date_type_desc(wh);
...
EXPORT Make_event_filing_desc(SALT32.StrType s0) := MakeFT_invalid_event_filing_desc(s0);
EXPORT InValid_event_filing_desc(SALT32.StrType s) := InValidFT_invalid_event_filing_desc(s);
EXPORT InValidMessage_event_filing_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_event_filing_desc(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_OR_Event;
