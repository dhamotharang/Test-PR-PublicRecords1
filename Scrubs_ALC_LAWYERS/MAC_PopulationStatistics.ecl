...
+    #IF( #TEXT(Input_business_ind)='' )
      '' 
    #ELSE
        IF( le.Input_business_ind = (TYPEOF(le.Input_business_ind))'','',':business_ind')
    #END
...
+    #IF( #TEXT(Input_number_of_lawyers_range)='' )
      '' 
    #ELSE
        IF( le.Input_number_of_lawyers_range = (TYPEOF(le.Input_number_of_lawyers_range))'','',':number_of_lawyers_range')
    #END
 
+    #IF( #TEXT(Input_practice_area)='' )
      '' 
    #ELSE
        IF( le.Input_practice_area = (TYPEOF(le.Input_practice_area))'','',':practice_area')
    #END
 
+    #IF( #TEXT(Input_title_cd)='' )
      '' 
    #ELSE
        IF( le.Input_title_cd = (TYPEOF(le.Input_title_cd))'','',':title_cd')
    #END
