...
Command line options: -MScrubs_ALC_LAWYERS -eC:\Users\metzmaaj\AppData\Local\Temp\TFR161A.tmp 
...
FIELD:practice_area:TYPE(STRING255):LIKE(invalid_alphanumericpound):0,0
FIELD:title_cd:TYPE(STRING25):LIKE(invalid_numericpound):0,0
