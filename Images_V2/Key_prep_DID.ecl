...
all_images := images_v2.File_Images_KeyBuilding(did != 0, imglength != 0);
...
i := INDEX(numbered,,  /*Data_Services.Data_location.Prefix('SexOffender') +*/ '~images_v2::key::Matrix_Images_did'+thorlib.wuid());
