...
export fSpray_Specialty(string version, boolean pUseProd = false)	:=	DATASET([
 	...
 	,'ss_specs.tab' // Note the casing of the file name                                 //directory_filter   Regular expression filter for files to be sprayed, default = '*'                          
// 	,'*.txt' // Note the casing of the file name                                 //directory_filter   Regular expression filter for files to be sprayed, default = '*'                          
 	...
 	,_Dataset(pUseProd).thor_cluster_Files+ 'in::' + _Dataset().Specialty_Name + '::' + version      //Thor_filename_template	-- template filename for files to be sprayed, ex. '~thor_data400::in::corp2::@version@::cont'
 	,[{_Dataset(pUseProd).thor_cluster_Files+'in::' + _Dataset().Specialty_Name  }]            //dSuperfilenames			-- dataset of superfiles to add the sprayed files to.
