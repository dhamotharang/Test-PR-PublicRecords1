...
export fSpray_Specialty_Details(string version, boolean pUseProd = false)	:=	DATASET([
 	...
 	,_Dataset(pUseProd).thor_cluster_Files+ 'in::' + _Dataset().Specialty_Name + '::' + 'SpecDetails'      //Thor_filename_template	-- template filename for files to be sprayed, ex. '~thor_data400::in::corp2::@version@::cont'
