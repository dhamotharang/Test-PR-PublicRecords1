...
*/
  SHARED EarthRadius := 3963.3453; // In synch with SALT38.utLL_Dist
	SHARED PI := 3.14159;
	EXPORT Distance(REAL8 Lat1,REAL8 Long1, REAL8 Lat2, REAL8 Long2 ) := SALT38.utLL_Dist(lat1,long1,lat2,long2);
