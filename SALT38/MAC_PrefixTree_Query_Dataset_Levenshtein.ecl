...
//=============================== Query Prefix Tree ================================================
//==================================================================================================
Export MAC_PrefixTree_Query_Dataset_Levenshtein(query_ds, query_field, pt_index, max_edit_distance) := FUNCTIONMACRO
...
results := MAC_PrefixTree_Query_Dataset_Levenshtein(query_ds, word, pt_index, 2);
OUTPUT(results);
*/
