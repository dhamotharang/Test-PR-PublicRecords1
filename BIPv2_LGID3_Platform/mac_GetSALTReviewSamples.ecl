...
iter := '25';
#workunit('name','BIPV2_LGID3_PlatForm Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_LGID3_PlatForm.Keys(BIPV2_LGID3_PlatForm.In_LGID3).MatchSample ,BIPV2_LGID3_PlatForm.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_LGID3_PlatForm.In_LGID3)
