...
EXPORT Summary(SALT30.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_nodes_below_st := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.nodes_below_st)));
    avelength_nodes_below_st := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.nodes_below_st)),h.nodes_below_st<>(typeof(h.nodes_below_st))'');
    populated_Lgid3IfHrchy_pcnt := AVE(GROUP,IF(h.Lgid3IfHrchy = (TYPEOF(h.Lgid3IfHrchy))'',0,100));
    maxlength_Lgid3IfHrchy := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.Lgid3IfHrchy)));
    avelength_Lgid3IfHrchy := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.Lgid3IfHrchy)),h.Lgid3IfHrchy<>(typeof(h.Lgid3IfHrchy))'');
    populated_OriginalSeleId_pcnt := AVE(GROUP,IF(h.OriginalSeleId = (TYPEOF(h.OriginalSeleId))'',0,100));
    maxlength_OriginalSeleId := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.OriginalSeleId)));
    avelength_OriginalSeleId := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.OriginalSeleId)),h.OriginalSeleId<>(typeof(h.OriginalSeleId))'');
    populated_OriginalOrgId_pcnt := AVE(GROUP,IF(h.OriginalOrgId = (TYPEOF(h.OriginalOrgId))'',0,100));
    maxlength_OriginalOrgId := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.OriginalOrgId)));
    avelength_OriginalOrgId := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.OriginalOrgId)),h.OriginalOrgId<>(typeof(h.OriginalOrgId))'');
    ...
    maxlength_has_lgid := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.has_lgid)));
    avelength_has_lgid := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.has_lgid)),h.has_lgid<>(typeof(h.has_lgid))'');
    populated_is_sele_level_pcnt := AVE(GROUP,IF(h.is_sele_level = (TYPEOF(h.is_sele_level))'',0,100));
    maxlength_is_sele_level := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_sele_level)));
    avelength_is_sele_level := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_sele_level)),h.is_sele_level<>(typeof(h.is_sele_level))'');
    populated_is_org_level_pcnt := AVE(GROUP,IF(h.is_org_level = (TYPEOF(h.is_org_level))'',0,100));
    maxlength_is_org_level := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_org_level)));
    avelength_is_org_level := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_org_level)),h.is_org_level<>(typeof(h.is_org_level))'');
    populated_is_ult_level_pcnt := AVE(GROUP,IF(h.is_ult_level = (TYPEOF(h.is_ult_level))'',0,100));
    maxlength_is_ult_level := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_ult_level)));
    avelength_is_ult_level := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.is_ult_level)),h.is_ult_level<>(typeof(h.is_ult_level))'');
    populated_parent_proxid_pcnt := AVE(GROUP,IF(h.parent_proxid = (TYPEOF(h.parent_proxid))'',0,100));
    maxlength_parent_proxid := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.parent_proxid)));
    avelength_parent_proxid := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.parent_proxid)),h.parent_proxid<>(typeof(h.parent_proxid))'');
    populated_sele_proxid_pcnt := AVE(GROUP,IF(h.sele_proxid = (TYPEOF(h.sele_proxid))'',0,100));
    maxlength_sele_proxid := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.sele_proxid)));
    avelength_sele_proxid := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.sele_proxid)),h.sele_proxid<>(typeof(h.sele_proxid))'');
    populated_org_proxid_pcnt := AVE(GROUP,IF(h.org_proxid = (TYPEOF(h.org_proxid))'',0,100));
    maxlength_org_proxid := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.org_proxid)));
    avelength_org_proxid := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.org_proxid)),h.org_proxid<>(typeof(h.org_proxid))'');
    populated_ultimate_proxid_pcnt := AVE(GROUP,IF(h.ultimate_proxid = (TYPEOF(h.ultimate_proxid))'',0,100));
    maxlength_ultimate_proxid := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.ultimate_proxid)));
    avelength_ultimate_proxid := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.ultimate_proxid)),h.ultimate_proxid<>(typeof(h.ultimate_proxid))'');
    populated_levels_from_top_pcnt := AVE(GROUP,IF(h.levels_from_top = (TYPEOF(h.levels_from_top))'',0,100));
    maxlength_levels_from_top := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.levels_from_top)));
    avelength_levels_from_top := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.levels_from_top)),h.levels_from_top<>(typeof(h.levels_from_top))'');
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.LGID3;
  SELF.Src := le.source;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.sbfe_id),TRIM((SALT30.StrType)le.nodes_below_st),TRIM((SALT30.StrType)le.Lgid3IfHrchy),TRIM((SALT30.StrType)le.OriginalSeleId),TRIM((SALT30.StrType)le.OriginalOrgId),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.duns_number),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_inc_state),TRIM((SALT30.StrType)le.company_charter_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.cnp_hasNumber),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.has_lgid),TRIM((SALT30.StrType)le.is_sele_level),TRIM((SALT30.StrType)le.is_org_level),TRIM((SALT30.StrType)le.is_ult_level),TRIM((SALT30.StrType)le.parent_proxid),TRIM((SALT30.StrType)le.sele_proxid),TRIM((SALT30.StrType)le.org_proxid),TRIM((SALT30.StrType)le.ultimate_proxid),TRIM((SALT30.StrType)le.levels_from_top),TRIM((SALT30.StrType)le.nodes_total),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 42);
  SELF.FldNo2 := 1 + (C % 42);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.sbfe_id),TRIM((SALT30.StrType)le.nodes_below_st),TRIM((SALT30.StrType)le.Lgid3IfHrchy),TRIM((SALT30.StrType)le.OriginalSeleId),TRIM((SALT30.StrType)le.OriginalOrgId),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.duns_number),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_inc_state),TRIM((SALT30.StrType)le.company_charter_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.cnp_hasNumber),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.has_lgid),TRIM((SALT30.StrType)le.is_sele_level),TRIM((SALT30.StrType)le.is_org_level),TRIM((SALT30.StrType)le.is_ult_level),TRIM((SALT30.StrType)le.parent_proxid),TRIM((SALT30.StrType)le.sele_proxid),TRIM((SALT30.StrType)le.org_proxid),TRIM((SALT30.StrType)le.ultimate_proxid),TRIM((SALT30.StrType)le.levels_from_top),TRIM((SALT30.StrType)le.nodes_total),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.sbfe_id),TRIM((SALT30.StrType)le.nodes_below_st),TRIM((SALT30.StrType)le.Lgid3IfHrchy),TRIM((SALT30.StrType)le.OriginalSeleId),TRIM((SALT30.StrType)le.OriginalOrgId),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.duns_number),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_inc_state),TRIM((SALT30.StrType)le.company_charter_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.cnp_hasNumber),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.has_lgid),TRIM((SALT30.StrType)le.is_sele_level),TRIM((SALT30.StrType)le.is_org_level),TRIM((SALT30.StrType)le.is_ult_level),TRIM((SALT30.StrType)le.parent_proxid),TRIM((SALT30.StrType)le.sele_proxid),TRIM((SALT30.StrType)le.org_proxid),TRIM((SALT30.StrType)le.ultimate_proxid),TRIM((SALT30.StrType)le.levels_from_top),TRIM((SALT30.StrType)le.nodes_total),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  END;
...
SHARED FldIds := DATASET([{1,'sbfe_id'}
      ...
      ,{40,'nodes_total'}
      ,{41,'dt_first_seen'}
      ,{42,'dt_last_seen'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_nodes_below_st((SALT30.StrType)le.nodes_below_st),
    Fields.InValid_Lgid3IfHrchy((SALT30.StrType)le.Lgid3IfHrchy),
    Fields.InValid_OriginalSeleId((SALT30.StrType)le.OriginalSeleId),
    Fields.InValid_OriginalOrgId((SALT30.StrType)le.OriginalOrgId),
    ...
    Fields.InValid_has_lgid((SALT30.StrType)le.has_lgid),
    Fields.InValid_is_sele_level((SALT30.StrType)le.is_sele_level),
    Fields.InValid_is_org_level((SALT30.StrType)le.is_org_level),
    Fields.InValid_is_ult_level((SALT30.StrType)le.is_ult_level),
    Fields.InValid_parent_proxid((SALT30.StrType)le.parent_proxid),
    Fields.InValid_sele_proxid((SALT30.StrType)le.sele_proxid),
    Fields.InValid_org_proxid((SALT30.StrType)le.org_proxid),
    Fields.InValid_ultimate_proxid((SALT30.StrType)le.ultimate_proxid),
    Fields.InValid_levels_from_top((SALT30.StrType)le.levels_from_top),
