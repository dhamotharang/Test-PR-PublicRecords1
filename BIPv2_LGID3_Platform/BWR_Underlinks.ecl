...
// BIPV2_LGID3_PlatForm.Cleave(BIPV2_LGID3_PlatForm.In_LGID3).BuildAll;
//---------------------------------------------------------------------------------------------
  Und := BIPV2_LGID3_PlatForm.Underlinks(BIPV2_LGID3_PlatForm.In_LGID3); // Create underlink module
