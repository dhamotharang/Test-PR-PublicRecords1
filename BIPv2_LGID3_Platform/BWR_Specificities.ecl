...
#workunit('name','BIPV2_LGID3_PlatForm.BWR_Specificities - Specificities - SALT V3.0 Gold');
IMPORT BIPV2_LGID3_PlatForm,SALT30;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_LGID3_PlatForm.specificities(BIPV2_LGID3_PlatForm.In_LGID3);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_LGID3_PlatForm.<your_spc_attribute>',BIPV2_LGID3_PlatForm.In_LGID3);
