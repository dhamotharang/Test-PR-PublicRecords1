...
FIELD:company_name:LIKE(multiword):LIKE(Noblanks):BAGOFWORDS(MOST):EDIT1(2):PROP:TYPE(string250):26,333
...
// DUNS number (v2)
FIELD:active_duns_number:PROP:SWITCH0:27,44
FIELD:duns_number:PROP:SWITCH0:26,114
CONCEPT:duns_number_concept:active_duns_number:duns_number:26,172
...
FIELD:company_fein:26,178
FIELD:company_inc_state:PROP:FORCE(+,OR(active_duns_number),OR(duns_number),OR(duns_number_concept),OR(company_fein),OR(sbfe_id)):6,29
FIELD:company_charter_number:PROP:CONTEXT(company_inc_state):26,95
