...
*/
import doxie, ut, progressive_phone, risk_indicators, iesp, suppress;
export GongHistorySearchService := MACRO
  ...
  #STORED('ScoreThreshold',if((in_cname_value<>'' or in_county_value<>''), 10, 1000));
	...
	MatchingRawRecs := Gong_Services.Fetch_Gong_History(indids := dataset([{did_value}],doxie.layout_references),
