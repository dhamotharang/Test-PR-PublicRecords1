...
wdog0 := dataset( '~thor_data400::BASE::Watchdog_best_noneq',string_rec,flat);
...
glb_pst        := distribute(dataset('~thor400_84::out::watchdog_filtered_header_noneq',header.layout_header,flat),hash(did));;
...
export Key_Watchdog_GLB_nonEquifax_nonblank_old := INDEX(fb,{fb},
 Data_Services.Data_location.Prefix('Watchdog_Best')+'thor_data400::key::watchdog_best_noneq.did_nonblank_'+doxie.Version_SuperKey);