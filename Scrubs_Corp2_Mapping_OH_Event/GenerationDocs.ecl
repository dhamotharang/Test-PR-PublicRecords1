...
Command line options: -MScrubs_Corp2_Mapping_OH_Event -eC:\Users\myanasx\AppData\Local\Temp\TFRA9FC.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_OH_Event
FILENAME:in_file
...
FIELDTYPE:invalid_filing_cd:ENUM(Corp2_Raw_OH.Functions.Set_Of_Event_FilingCodes)
FIELDTYPE:invalid_event_code:ALLOW( 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:event_filing_date:TYPE(STRING8):0,0
FIELD:event_date_type_cd:TYPE(STRING3):0,0
FIELD:event_date_type_desc:TYPE(STRING30):0,0
FIELD:event_filing_cd:TYPE(STRING8):LIKE(invalid_filing_cd):0,0
...
FIELD:event_book_number:TYPE(STRING9):0,0
FIELD:event_page_number:TYPE(STRING9):0,0
FIELD:event_certification_number:TYPE(STRING9):0,0
FIELD:InternalField1:TYPE(STRING100):LIKE(invalid_event_code):0,0
FIELD:InternalField2:TYPE(STRING100):LIKE(invalid_event_code):0,0
