IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_OH_Main,Scrubs,Corp2_Raw_OH; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_filing_cd','invalid_event_code');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_filing_cd' => 8,'invalid_event_code' => 9,0);
...
EXPORT MakeFT_invalid_filing_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Corp2_Raw_OH.Functions.Set_Of_Event_FilingCodes);
EXPORT InValidMessageFT_invalid_filing_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Corp2_Raw_OH.Functions.Set_Of_Event_FilingCodes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_event_code(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_event_code(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_event_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT Make_event_filing_reference_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_event_filing_reference_nbr(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_filing_reference_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_amendment_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_event_amendment_nbr(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_amendment_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_filing_date(SALT34.StrType s0) := s0;
EXPORT InValid_event_filing_date(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_filing_date(UNSIGNED1 wh) := '';
 
EXPORT Make_event_date_type_cd(SALT34.StrType s0) := s0;
EXPORT InValid_event_date_type_cd(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_date_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_date_type_desc(SALT34.StrType s0) := s0;
EXPORT InValid_event_date_type_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_date_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_filing_cd(SALT34.StrType s0) := MakeFT_invalid_filing_cd(s0);
EXPORT InValid_event_filing_cd(SALT34.StrType s) := InValidFT_invalid_filing_cd(s);
EXPORT InValidMessage_event_filing_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_cd(wh);
 
EXPORT Make_event_filing_desc(SALT34.StrType s0) := s0;
EXPORT InValid_event_filing_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_filing_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_event_corp_nbr(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_corp_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr_cd(SALT34.StrType s0) := s0;
EXPORT InValid_event_corp_nbr_cd(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_corp_nbr_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr_desc(SALT34.StrType s0) := s0;
EXPORT InValid_event_corp_nbr_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_corp_nbr_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_roll(SALT34.StrType s0) := s0;
EXPORT InValid_event_roll(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_roll(UNSIGNED1 wh) := '';
 
EXPORT Make_event_frame(SALT34.StrType s0) := s0;
EXPORT InValid_event_frame(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_frame(UNSIGNED1 wh) := '';
 
EXPORT Make_event_start(SALT34.StrType s0) := s0;
EXPORT InValid_event_start(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_start(UNSIGNED1 wh) := '';
 
EXPORT Make_event_end(SALT34.StrType s0) := s0;
EXPORT InValid_event_end(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_end(UNSIGNED1 wh) := '';
 
EXPORT Make_event_microfilm_nbr(SALT34.StrType s0) := s0;
EXPORT InValid_event_microfilm_nbr(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_microfilm_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_desc(SALT34.StrType s0) := s0;
EXPORT InValid_event_desc(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_revocation_comment1(SALT34.StrType s0) := s0;
EXPORT InValid_event_revocation_comment1(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_revocation_comment1(UNSIGNED1 wh) := '';
 
EXPORT Make_event_revocation_comment2(SALT34.StrType s0) := s0;
EXPORT InValid_event_revocation_comment2(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_revocation_comment2(UNSIGNED1 wh) := '';
 
EXPORT Make_event_book_number(SALT34.StrType s0) := s0;
EXPORT InValid_event_book_number(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_book_number(UNSIGNED1 wh) := '';
 
EXPORT Make_event_page_number(SALT34.StrType s0) := s0;
EXPORT InValid_event_page_number(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_page_number(UNSIGNED1 wh) := '';
 
EXPORT Make_event_certification_number(SALT34.StrType s0) := s0;
EXPORT InValid_event_certification_number(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_event_certification_number(UNSIGNED1 wh) := '';
 
EXPORT Make_InternalField1(SALT34.StrType s0) := MakeFT_invalid_event_code(s0);
EXPORT InValid_InternalField1(SALT34.StrType s) := InValidFT_invalid_event_code(s);
EXPORT InValidMessage_InternalField1(UNSIGNED1 wh) := InValidMessageFT_invalid_event_code(wh);
 
EXPORT Make_InternalField2(SALT34.StrType s0) := MakeFT_invalid_event_code(s0);
EXPORT InValid_InternalField2(SALT34.StrType s) := InValidFT_invalid_event_code(s);
EXPORT InValidMessage_InternalField2(UNSIGNED1 wh) := InValidMessageFT_invalid_event_code(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_OH_Event;
