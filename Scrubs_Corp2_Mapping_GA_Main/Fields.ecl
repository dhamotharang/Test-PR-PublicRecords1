...
EXPORT MakeFT_invalid_corp_key(SALT311.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'),SALT311.HygieneErrors.NotLength('4..'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['13','13']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('13|13'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['GA','GA']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('GA|GA'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT311.StrType s,SALT311.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_GA_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_GA_Main.Functions.invalid_ln_name_type_cd'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT311.StrType s,SALT311.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_GA_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_GA_Main.Functions.invalid_ln_name_type_desc'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_flag_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['N','Y',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('N|Y| '),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_numeric(SALT311.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numeric(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_numeric(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789'),SALT311.HygieneErrors.NotLength('1..'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'),SALT311.HygieneErrors.NotLength('1..'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_phone(SALT311.StrType s0) := FUNCTION
  ...
  RETURN  s2;
END;
EXPORT InValidFT_invalid_phone(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789- '))),~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 12));
EXPORT InValidMessageFT_invalid_phone(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789- '),SALT311.HygieneErrors.NotLength('0..12'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_characters(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,' ABCDEFGHIJKLMNOPQRSTUVWXYZ/-()&.\''); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_characters(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,' ABCDEFGHIJKLMNOPQRSTUVWXYZ/-()&.\''))));
EXPORT InValidMessageFT_invalid_characters(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars(' ABCDEFGHIJKLMNOPQRSTUVWXYZ/-()&.\''),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_State_Desc(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,' &ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_State_Desc(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,' &ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_State_Desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars(' &ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','LENGTHS'],[],['ENUM'],[],[],['ENUM'],['ALLOW','CUSTOM','LENGTHS'],['ALLOW','LENGTHS'],['LENGTHS'],['CUSTOM'],['CUSTOM'],[],[],[],[],[],[],[],['ALLOW','CUSTOM','LENGTHS'],[],[],[],[],[],[],['ALLOW','LENGTHS'],[],[],[],[],[],[],['ALLOW','CUSTOM'],[],[],[],['ALLOW'],['ALLOW','CUSTOM','LENGTHS'],[],[],[],[],['ENUM'],[],['ALLOW','CUSTOM','LENGTHS'],[],[],[],[],[],[],['ENUM'],['ALLOW'],['ALLOW'],[],['ALLOW','CUSTOM','LENGTHS'],[],[],[],[],[],[],['ALLOW'],['ENUM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW','LENGTHS'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW','CUSTOM','LENGTHS'],[],[],[],[],[],[],[],[],[],[],[],[],['ALLOW'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['ENUM'],[]);
...
EXPORT Make_corp_phone_number(SALT311.StrType s0) := MakeFT_invalid_phone(s0);
EXPORT InValid_corp_phone_number(SALT311.StrType s) := InValidFT_invalid_phone(s);
...
EXPORT Make_corp_filing_date(SALT311.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_filing_date(SALT311.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT Make_corp_status_desc(SALT311.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_status_desc(SALT311.StrType s) := InValidFT_invalid_characters(s);
...
EXPORT Make_corp_term_exist_exp(SALT311.StrType s0) := s0;
EXPORT InValid_corp_term_exist_exp(SALT311.StrType s) := 0;
...
EXPORT Make_corp_forgn_state_desc(SALT311.StrType s0) := MakeFT_invalid_State_Desc(s0);
EXPORT InValid_corp_forgn_state_desc(SALT311.StrType s) := InValidFT_invalid_State_Desc(s);
...
EXPORT Make_corp_orig_org_structure_desc(SALT311.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT311.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
...
EXPORT Make_corp_ra_phone_number(SALT311.StrType s0) := MakeFT_invalid_phone(s0);
EXPORT InValid_corp_ra_phone_number(SALT311.StrType s) := InValidFT_invalid_phone(s);
...
EXPORT Make_corp_country_of_formation(SALT311.StrType s0) := MakeFT_invalid_characters(s0);
EXPORT InValid_corp_country_of_formation(SALT311.StrType s) := InValidFT_invalid_characters(s);
EXPORT InValidMessage_corp_country_of_formation(UNSIGNED1 wh) := InValidMessageFT_invalid_characters(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Corp2_Mapping_GA_Main;
