...
#workunit('name','Scrubs_Corp2_Mapping_GA_Main.BWR_Iterate - Internal Linking - SALT V3.4.3');
...
P := Scrubs_Corp2_Mapping_GA_Main.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT34.MAC_MatchSamplePatterns(Scrubs_Corp2_Mapping_GA_Main.Keys(Scrubs_Corp2_Mapping_GA_Main.In_in_file).MatchSample,MatchPatterns,1,2,8,-3-3);
...
// ConfThreshold:=0;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(Scrubs_Corp2_Mapping_GA_Main.Keys(Scrubs_Corp2_Mapping_GA_Main.In_in_file).MatchSample,Scrubs_Corp2_Mapping_GA_Main.Keys(Scrubs_Corp2_Mapping_GA_Main.In_in_file).Candidates,Scrubs_Corp2_Mapping_GA_Main.In_in_file,,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
