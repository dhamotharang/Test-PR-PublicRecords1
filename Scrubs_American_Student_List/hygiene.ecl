...
EXPORT Summary(SALT36.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_key := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.key)));
    avelength_key := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.key)),h.key<>(typeof(h.key))'');
    ...
    maxlength_did := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.did)));
    avelength_did := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.did)),h.did<>(typeof(h.did))'');
    ...
    maxlength_date_first_seen := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_first_seen)));
    avelength_date_first_seen := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_first_seen)),h.date_first_seen<>(typeof(h.date_first_seen))'');
    populated_date_last_seen_pcnt := AVE(GROUP,IF(h.date_last_seen = (TYPEOF(h.date_last_seen))'',0,100));
    maxlength_date_last_seen := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_last_seen)));
    avelength_date_last_seen := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_last_seen)),h.date_last_seen<>(typeof(h.date_last_seen))'');
    ...
    maxlength_date_vendor_first_reported := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_vendor_first_reported)));
    avelength_date_vendor_first_reported := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_vendor_first_reported)),h.date_vendor_first_reported<>(typeof(h.date_vendor_first_reported))'');
    ...
    maxlength_date_vendor_last_reported := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_vendor_last_reported)));
    avelength_date_vendor_last_reported := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.date_vendor_last_reported)),h.date_vendor_last_reported<>(typeof(h.date_vendor_last_reported))'');
    populated_historical_flag_pcnt := AVE(GROUP,IF(h.historical_flag = (TYPEOF(h.historical_flag))'',0,100));
    maxlength_historical_flag := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.historical_flag)));
    avelength_historical_flag := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.historical_flag)),h.historical_flag<>(typeof(h.historical_flag))'');
    populated_full_name_pcnt := AVE(GROUP,IF(h.full_name = (TYPEOF(h.full_name))'',0,100));
    maxlength_full_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.full_name)));
    avelength_full_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.full_name)),h.full_name<>(typeof(h.full_name))'');
    ...
    maxlength_address_1 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_1)));
    avelength_address_1 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_1)),h.address_1<>(typeof(h.address_1))'');
    populated_address_2_pcnt := AVE(GROUP,IF(h.address_2 = (TYPEOF(h.address_2))'',0,100));
    maxlength_address_2 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_2)));
    avelength_address_2 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_2)),h.address_2<>(typeof(h.address_2))'');
    ...
    maxlength_zip := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip)));
    avelength_zip := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip)),h.zip<>(typeof(h.zip))'');
    populated_zip_4_pcnt := AVE(GROUP,IF(h.zip_4 = (TYPEOF(h.zip_4))'',0,100));
    maxlength_zip_4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip_4)));
    avelength_zip_4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip_4)),h.zip_4<>(typeof(h.zip_4))'');
    populated_crrt_code_pcnt := AVE(GROUP,IF(h.crrt_code = (TYPEOF(h.crrt_code))'',0,100));
    maxlength_crrt_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.crrt_code)));
    avelength_crrt_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.crrt_code)),h.crrt_code<>(typeof(h.crrt_code))'');
    populated_delivery_point_barcode_pcnt := AVE(GROUP,IF(h.delivery_point_barcode = (TYPEOF(h.delivery_point_barcode))'',0,100));
    maxlength_delivery_point_barcode := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.delivery_point_barcode)));
    avelength_delivery_point_barcode := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.delivery_point_barcode)),h.delivery_point_barcode<>(typeof(h.delivery_point_barcode))'');
    populated_zip4_check_digit_pcnt := AVE(GROUP,IF(h.zip4_check_digit = (TYPEOF(h.zip4_check_digit))'',0,100));
    maxlength_zip4_check_digit := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip4_check_digit)));
    avelength_zip4_check_digit := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip4_check_digit)),h.zip4_check_digit<>(typeof(h.zip4_check_digit))'');
    populated_address_type_code_pcnt := AVE(GROUP,IF(h.address_type_code = (TYPEOF(h.address_type_code))'',0,100));
    maxlength_address_type_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_type_code)));
    avelength_address_type_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_type_code)),h.address_type_code<>(typeof(h.address_type_code))'');
    populated_address_type_pcnt := AVE(GROUP,IF(h.address_type = (TYPEOF(h.address_type))'',0,100));
    maxlength_address_type := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_type)));
    avelength_address_type := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.address_type)),h.address_type<>(typeof(h.address_type))'');
    populated_county_number_pcnt := AVE(GROUP,IF(h.county_number = (TYPEOF(h.county_number))'',0,100));
    maxlength_county_number := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.county_number)));
    avelength_county_number := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.county_number)),h.county_number<>(typeof(h.county_number))'');
    populated_county_name_pcnt := AVE(GROUP,IF(h.county_name = (TYPEOF(h.county_name))'',0,100));
    maxlength_county_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.county_name)));
    avelength_county_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.county_name)),h.county_name<>(typeof(h.county_name))'');
    populated_gender_code_pcnt := AVE(GROUP,IF(h.gender_code = (TYPEOF(h.gender_code))'',0,100));
    maxlength_gender_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.gender_code)));
    avelength_gender_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.gender_code)),h.gender_code<>(typeof(h.gender_code))'');
    populated_gender_pcnt := AVE(GROUP,IF(h.gender = (TYPEOF(h.gender))'',0,100));
    maxlength_gender := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.gender)));
    avelength_gender := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.gender)),h.gender<>(typeof(h.gender))'');
    populated_age_pcnt := AVE(GROUP,IF(h.age = (TYPEOF(h.age))'',0,100));
    maxlength_age := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.age)));
    avelength_age := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.age)),h.age<>(typeof(h.age))'');
    populated_birth_date_pcnt := AVE(GROUP,IF(h.birth_date = (TYPEOF(h.birth_date))'',0,100));
    maxlength_birth_date := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.birth_date)));
    avelength_birth_date := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.birth_date)),h.birth_date<>(typeof(h.birth_date))'');
    populated_dob_formatted_pcnt := AVE(GROUP,IF(h.dob_formatted = (TYPEOF(h.dob_formatted))'',0,100));
    maxlength_dob_formatted := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.dob_formatted)));
    avelength_dob_formatted := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.dob_formatted)),h.dob_formatted<>(typeof(h.dob_formatted))'');
    populated_telephone_pcnt := AVE(GROUP,IF(h.telephone = (TYPEOF(h.telephone))'',0,100));
    maxlength_telephone := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.telephone)));
    avelength_telephone := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.telephone)),h.telephone<>(typeof(h.telephone))'');
    populated_class_pcnt := AVE(GROUP,IF(h.class = (TYPEOF(h.class))'',0,100));
    maxlength_class := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.class)));
    avelength_class := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.class)),h.class<>(typeof(h.class))'');
    populated_college_class_pcnt := AVE(GROUP,IF(h.college_class = (TYPEOF(h.college_class))'',0,100));
    maxlength_college_class := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_class)));
    avelength_college_class := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_class)),h.college_class<>(typeof(h.college_class))'');
    populated_college_name_pcnt := AVE(GROUP,IF(h.college_name = (TYPEOF(h.college_name))'',0,100));
    maxlength_college_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_name)));
    avelength_college_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_name)),h.college_name<>(typeof(h.college_name))'');
    populated_ln_college_name_pcnt := AVE(GROUP,IF(h.ln_college_name = (TYPEOF(h.ln_college_name))'',0,100));
    maxlength_ln_college_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ln_college_name)));
    avelength_ln_college_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ln_college_name)),h.ln_college_name<>(typeof(h.ln_college_name))'');
    populated_college_major_pcnt := AVE(GROUP,IF(h.college_major = (TYPEOF(h.college_major))'',0,100));
    maxlength_college_major := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_major)));
    avelength_college_major := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_major)),h.college_major<>(typeof(h.college_major))'');
    populated_new_college_major_pcnt := AVE(GROUP,IF(h.new_college_major = (TYPEOF(h.new_college_major))'',0,100));
    maxlength_new_college_major := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_college_major)));
    avelength_new_college_major := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_college_major)),h.new_college_major<>(typeof(h.new_college_major))'');
    populated_college_code_pcnt := AVE(GROUP,IF(h.college_code = (TYPEOF(h.college_code))'',0,100));
    maxlength_college_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_code)));
    avelength_college_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_code)),h.college_code<>(typeof(h.college_code))'');
    populated_college_code_exploded_pcnt := AVE(GROUP,IF(h.college_code_exploded = (TYPEOF(h.college_code_exploded))'',0,100));
    maxlength_college_code_exploded := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_code_exploded)));
    avelength_college_code_exploded := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_code_exploded)),h.college_code_exploded<>(typeof(h.college_code_exploded))'');
    populated_college_type_pcnt := AVE(GROUP,IF(h.college_type = (TYPEOF(h.college_type))'',0,100));
    maxlength_college_type := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_type)));
    avelength_college_type := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_type)),h.college_type<>(typeof(h.college_type))'');
    populated_college_type_exploded_pcnt := AVE(GROUP,IF(h.college_type_exploded = (TYPEOF(h.college_type_exploded))'',0,100));
    maxlength_college_type_exploded := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_type_exploded)));
    avelength_college_type_exploded := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.college_type_exploded)),h.college_type_exploded<>(typeof(h.college_type_exploded))'');
    ...
    maxlength_head_of_household_first_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_first_name)));
    avelength_head_of_household_first_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_first_name)),h.head_of_household_first_name<>(typeof(h.head_of_household_first_name))'');
    ...
    maxlength_head_of_household_gender_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_gender_code)));
    avelength_head_of_household_gender_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_gender_code)),h.head_of_household_gender_code<>(typeof(h.head_of_household_gender_code))'');
    populated_head_of_household_gender_pcnt := AVE(GROUP,IF(h.head_of_household_gender = (TYPEOF(h.head_of_household_gender))'',0,100));
    maxlength_head_of_household_gender := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_gender)));
    avelength_head_of_household_gender := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.head_of_household_gender)),h.head_of_household_gender<>(typeof(h.head_of_household_gender))'');
    populated_income_level_code_pcnt := AVE(GROUP,IF(h.income_level_code = (TYPEOF(h.income_level_code))'',0,100));
    maxlength_income_level_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.income_level_code)));
    avelength_income_level_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.income_level_code)),h.income_level_code<>(typeof(h.income_level_code))'');
    populated_income_level_pcnt := AVE(GROUP,IF(h.income_level = (TYPEOF(h.income_level))'',0,100));
    maxlength_income_level := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.income_level)));
    avelength_income_level := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.income_level)),h.income_level<>(typeof(h.income_level))'');
    populated_new_income_level_code_pcnt := AVE(GROUP,IF(h.new_income_level_code = (TYPEOF(h.new_income_level_code))'',0,100));
    maxlength_new_income_level_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_income_level_code)));
    avelength_new_income_level_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_income_level_code)),h.new_income_level_code<>(typeof(h.new_income_level_code))'');
    populated_new_income_level_pcnt := AVE(GROUP,IF(h.new_income_level = (TYPEOF(h.new_income_level))'',0,100));
    maxlength_new_income_level := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_income_level)));
    avelength_new_income_level := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.new_income_level)),h.new_income_level<>(typeof(h.new_income_level))'');
    populated_file_type_pcnt := AVE(GROUP,IF(h.file_type = (TYPEOF(h.file_type))'',0,100));
    maxlength_file_type := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.file_type)));
    avelength_file_type := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.file_type)),h.file_type<>(typeof(h.file_type))'');
    populated_tier_pcnt := AVE(GROUP,IF(h.tier = (TYPEOF(h.tier))'',0,100));
    maxlength_tier := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.tier)));
    avelength_tier := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.tier)),h.tier<>(typeof(h.tier))'');
    populated_school_size_code_pcnt := AVE(GROUP,IF(h.school_size_code = (TYPEOF(h.school_size_code))'',0,100));
    maxlength_school_size_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.school_size_code)));
    avelength_school_size_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.school_size_code)),h.school_size_code<>(typeof(h.school_size_code))'');
    populated_competitive_code_pcnt := AVE(GROUP,IF(h.competitive_code = (TYPEOF(h.competitive_code))'',0,100));
    maxlength_competitive_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.competitive_code)));
    avelength_competitive_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.competitive_code)),h.competitive_code<>(typeof(h.competitive_code))'');
    populated_tuition_code_pcnt := AVE(GROUP,IF(h.tuition_code = (TYPEOF(h.tuition_code))'',0,100));
    maxlength_tuition_code := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.tuition_code)));
    avelength_tuition_code := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.tuition_code)),h.tuition_code<>(typeof(h.tuition_code))'');
    populated_title_pcnt := AVE(GROUP,IF(h.title = (TYPEOF(h.title))'',0,100));
    maxlength_title := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.title)));
    avelength_title := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.title)),h.title<>(typeof(h.title))'');
    populated_fname_pcnt := AVE(GROUP,IF(h.fname = (TYPEOF(h.fname))'',0,100));
    maxlength_fname := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.fname)));
    avelength_fname := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.fname)),h.fname<>(typeof(h.fname))'');
    populated_mname_pcnt := AVE(GROUP,IF(h.mname = (TYPEOF(h.mname))'',0,100));
    maxlength_mname := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.mname)));
    avelength_mname := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.mname)),h.mname<>(typeof(h.mname))'');
    populated_lname_pcnt := AVE(GROUP,IF(h.lname = (TYPEOF(h.lname))'',0,100));
    maxlength_lname := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.lname)));
    avelength_lname := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.lname)),h.lname<>(typeof(h.lname))'');
    ...
    maxlength_name_score := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_score)));
    avelength_name_score := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.name_score)),h.name_score<>(typeof(h.name_score))'');
    populated_rawaid_pcnt := AVE(GROUP,IF(h.rawaid = (TYPEOF(h.rawaid))'',0,100));
    maxlength_rawaid := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.rawaid)));
    avelength_rawaid := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.rawaid)),h.rawaid<>(typeof(h.rawaid))'');
    populated_prim_range_pcnt := AVE(GROUP,IF(h.prim_range = (TYPEOF(h.prim_range))'',0,100));
    maxlength_prim_range := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prim_range)));
    avelength_prim_range := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prim_range)),h.prim_range<>(typeof(h.prim_range))'');
    populated_predir_pcnt := AVE(GROUP,IF(h.predir = (TYPEOF(h.predir))'',0,100));
    maxlength_predir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.predir)));
    avelength_predir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.predir)),h.predir<>(typeof(h.predir))'');
    populated_prim_name_pcnt := AVE(GROUP,IF(h.prim_name = (TYPEOF(h.prim_name))'',0,100));
    maxlength_prim_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.prim_name)));
    avelength_prim_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.prim_name)),h.prim_name<>(typeof(h.prim_name))'');
    populated_addr_suffix_pcnt := AVE(GROUP,IF(h.addr_suffix = (TYPEOF(h.addr_suffix))'',0,100));
    maxlength_addr_suffix := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.addr_suffix)));
    avelength_addr_suffix := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.addr_suffix)),h.addr_suffix<>(typeof(h.addr_suffix))'');
    populated_postdir_pcnt := AVE(GROUP,IF(h.postdir = (TYPEOF(h.postdir))'',0,100));
    maxlength_postdir := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.postdir)));
    avelength_postdir := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.postdir)),h.postdir<>(typeof(h.postdir))'');
    populated_unit_desig_pcnt := AVE(GROUP,IF(h.unit_desig = (TYPEOF(h.unit_desig))'',0,100));
    maxlength_unit_desig := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.unit_desig)));
    avelength_unit_desig := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.unit_desig)),h.unit_desig<>(typeof(h.unit_desig))'');
    populated_sec_range_pcnt := AVE(GROUP,IF(h.sec_range = (TYPEOF(h.sec_range))'',0,100));
    maxlength_sec_range := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.sec_range)));
    avelength_sec_range := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.sec_range)),h.sec_range<>(typeof(h.sec_range))'');
    populated_p_city_name_pcnt := AVE(GROUP,IF(h.p_city_name = (TYPEOF(h.p_city_name))'',0,100));
    maxlength_p_city_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_city_name)));
    avelength_p_city_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.p_city_name)),h.p_city_name<>(typeof(h.p_city_name))'');
    populated_v_city_name_pcnt := AVE(GROUP,IF(h.v_city_name = (TYPEOF(h.v_city_name))'',0,100));
    maxlength_v_city_name := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.v_city_name)));
    avelength_v_city_name := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.v_city_name)),h.v_city_name<>(typeof(h.v_city_name))'');
    populated_st_pcnt := AVE(GROUP,IF(h.st = (TYPEOF(h.st))'',0,100));
    maxlength_st := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.st)));
    avelength_st := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.st)),h.st<>(typeof(h.st))'');
    populated_z5_pcnt := AVE(GROUP,IF(h.z5 = (TYPEOF(h.z5))'',0,100));
    maxlength_z5 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.z5)));
    avelength_z5 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.z5)),h.z5<>(typeof(h.z5))'');
    populated_zip4_pcnt := AVE(GROUP,IF(h.zip4 = (TYPEOF(h.zip4))'',0,100));
    maxlength_zip4 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip4)));
    avelength_zip4 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.zip4)),h.zip4<>(typeof(h.zip4))'');
    populated_cart_pcnt := AVE(GROUP,IF(h.cart = (TYPEOF(h.cart))'',0,100));
    maxlength_cart := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.cart)));
    avelength_cart := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.cart)),h.cart<>(typeof(h.cart))'');
    populated_cr_sort_sz_pcnt := AVE(GROUP,IF(h.cr_sort_sz = (TYPEOF(h.cr_sort_sz))'',0,100));
    maxlength_cr_sort_sz := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.cr_sort_sz)));
    avelength_cr_sort_sz := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.cr_sort_sz)),h.cr_sort_sz<>(typeof(h.cr_sort_sz))'');
    ...
    maxlength_lot_order := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.lot_order)));
    avelength_lot_order := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.lot_order)),h.lot_order<>(typeof(h.lot_order))'');
    populated_dpbc_pcnt := AVE(GROUP,IF(h.dpbc = (TYPEOF(h.dpbc))'',0,100));
    maxlength_dpbc := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.dpbc)));
    avelength_dpbc := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.dpbc)),h.dpbc<>(typeof(h.dpbc))'');
    populated_chk_digit_pcnt := AVE(GROUP,IF(h.chk_digit = (TYPEOF(h.chk_digit))'',0,100));
    maxlength_chk_digit := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.chk_digit)));
    avelength_chk_digit := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.chk_digit)),h.chk_digit<>(typeof(h.chk_digit))'');
    populated_rec_type_pcnt := AVE(GROUP,IF(h.rec_type = (TYPEOF(h.rec_type))'',0,100));
    maxlength_rec_type := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.rec_type)));
    avelength_rec_type := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.rec_type)),h.rec_type<>(typeof(h.rec_type))'');
    ...
    maxlength_ace_fips_st := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.ace_fips_st)));
    avelength_ace_fips_st := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.ace_fips_st)),h.ace_fips_st<>(typeof(h.ace_fips_st))'');
    populated_fips_county_pcnt := AVE(GROUP,IF(h.fips_county = (TYPEOF(h.fips_county))'',0,100));
    maxlength_fips_county := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.fips_county)));
    avelength_fips_county := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.fips_county)),h.fips_county<>(typeof(h.fips_county))'');
    populated_geo_lat_pcnt := AVE(GROUP,IF(h.geo_lat = (TYPEOF(h.geo_lat))'',0,100));
    maxlength_geo_lat := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_lat)));
    avelength_geo_lat := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_lat)),h.geo_lat<>(typeof(h.geo_lat))'');
    populated_geo_long_pcnt := AVE(GROUP,IF(h.geo_long = (TYPEOF(h.geo_long))'',0,100));
    maxlength_geo_long := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_long)));
    avelength_geo_long := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_long)),h.geo_long<>(typeof(h.geo_long))'');
    populated_msa_pcnt := AVE(GROUP,IF(h.msa = (TYPEOF(h.msa))'',0,100));
    maxlength_msa := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.msa)));
    avelength_msa := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.msa)),h.msa<>(typeof(h.msa))'');
    populated_geo_blk_pcnt := AVE(GROUP,IF(h.geo_blk = (TYPEOF(h.geo_blk))'',0,100));
    maxlength_geo_blk := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_blk)));
    avelength_geo_blk := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_blk)),h.geo_blk<>(typeof(h.geo_blk))'');
    populated_geo_match_pcnt := AVE(GROUP,IF(h.geo_match = (TYPEOF(h.geo_match))'',0,100));
    maxlength_geo_match := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_match)));
    avelength_geo_match := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.geo_match)),h.geo_match<>(typeof(h.geo_match))'');
    populated_err_stat_pcnt := AVE(GROUP,IF(h.err_stat = (TYPEOF(h.err_stat))'',0,100));
    maxlength_err_stat := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.err_stat)));
    avelength_err_stat := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.err_stat)),h.err_stat<>(typeof(h.err_stat))'');
    populated_tier2_pcnt := AVE(GROUP,IF(h.tier2 = (TYPEOF(h.tier2))'',0,100));
    maxlength_tier2 := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.tier2)));
    avelength_tier2 := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.tier2)),h.tier2<>(typeof(h.tier2))'');
    populated_source_pcnt := AVE(GROUP,IF(h.source = (TYPEOF(h.source))'',0,100));
    maxlength_source := MAX(GROUP,LENGTH(TRIM((SALT36.StrType)h.source)));
    avelength_source := AVE(GROUP,LENGTH(TRIM((SALT36.StrType)h.source)),h.source<>(typeof(h.source))'');
  END;
...
SALT36.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.key <> 0,TRIM((SALT36.StrType)le.key), ''),TRIM((SALT36.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT36.StrType)le.did), ''),TRIM((SALT36.StrType)le.process_date),TRIM((SALT36.StrType)le.date_first_seen),TRIM((SALT36.StrType)le.date_last_seen),TRIM((SALT36.StrType)le.date_vendor_first_reported),TRIM((SALT36.StrType)le.date_vendor_last_reported),TRIM((SALT36.StrType)le.historical_flag),TRIM((SALT36.StrType)le.full_name),TRIM((SALT36.StrType)le.first_name),TRIM((SALT36.StrType)le.last_name),TRIM((SALT36.StrType)le.address_1),TRIM((SALT36.StrType)le.address_2),TRIM((SALT36.StrType)le.city),TRIM((SALT36.StrType)le.state),TRIM((SALT36.StrType)le.zip),TRIM((SALT36.StrType)le.zip_4),TRIM((SALT36.StrType)le.crrt_code),TRIM((SALT36.StrType)le.delivery_point_barcode),TRIM((SALT36.StrType)le.zip4_check_digit),TRIM((SALT36.StrType)le.address_type_code),TRIM((SALT36.StrType)le.address_type),TRIM((SALT36.StrType)le.county_number),TRIM((SALT36.StrType)le.county_name),TRIM((SALT36.StrType)le.gender_code),TRIM((SALT36.StrType)le.gender),TRIM((SALT36.StrType)le.age),TRIM((SALT36.StrType)le.birth_date),TRIM((SALT36.StrType)le.dob_formatted),TRIM((SALT36.StrType)le.telephone),TRIM((SALT36.StrType)le.class),TRIM((SALT36.StrType)le.college_class),TRIM((SALT36.StrType)le.college_name),TRIM((SALT36.StrType)le.ln_college_name),TRIM((SALT36.StrType)le.college_major),TRIM((SALT36.StrType)le.new_college_major),TRIM((SALT36.StrType)le.college_code),TRIM((SALT36.StrType)le.college_code_exploded),TRIM((SALT36.StrType)le.college_type),TRIM((SALT36.StrType)le.college_type_exploded),TRIM((SALT36.StrType)le.head_of_household_first_name),TRIM((SALT36.StrType)le.head_of_household_gender_code),TRIM((SALT36.StrType)le.head_of_household_gender),TRIM((SALT36.StrType)le.income_level_code),TRIM((SALT36.StrType)le.income_level),TRIM((SALT36.StrType)le.new_income_level_code),TRIM((SALT36.StrType)le.new_income_level),TRIM((SALT36.StrType)le.file_type),TRIM((SALT36.StrType)le.tier),TRIM((SALT36.StrType)le.school_size_code),TRIM((SALT36.StrType)le.competitive_code),TRIM((SALT36.StrType)le.tuition_code),TRIM((SALT36.StrType)le.title),TRIM((SALT36.StrType)le.fname),TRIM((SALT36.StrType)le.mname),TRIM((SALT36.StrType)le.lname),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT36.StrType)le.rawaid), ''),TRIM((SALT36.StrType)le.prim_range),TRIM((SALT36.StrType)le.predir),TRIM((SALT36.StrType)le.prim_name),TRIM((SALT36.StrType)le.addr_suffix),TRIM((SALT36.StrType)le.postdir),TRIM((SALT36.StrType)le.unit_desig),TRIM((SALT36.StrType)le.sec_range),TRIM((SALT36.StrType)le.p_city_name),TRIM((SALT36.StrType)le.v_city_name),TRIM((SALT36.StrType)le.st),TRIM((SALT36.StrType)le.z5),TRIM((SALT36.StrType)le.zip4),TRIM((SALT36.StrType)le.cart),TRIM((SALT36.StrType)le.cr_sort_sz),TRIM((SALT36.StrType)le.lot),TRIM((SALT36.StrType)le.lot_order),TRIM((SALT36.StrType)le.dpbc),TRIM((SALT36.StrType)le.chk_digit),TRIM((SALT36.StrType)le.rec_type),TRIM((SALT36.StrType)le.county),TRIM((SALT36.StrType)le.ace_fips_st),TRIM((SALT36.StrType)le.fips_county),TRIM((SALT36.StrType)le.geo_lat),TRIM((SALT36.StrType)le.geo_long),TRIM((SALT36.StrType)le.msa),TRIM((SALT36.StrType)le.geo_blk),TRIM((SALT36.StrType)le.geo_match),TRIM((SALT36.StrType)le.err_stat),TRIM((SALT36.StrType)le.tier2),TRIM((SALT36.StrType)le.source)));
  SELF.FldNo := C;
END;
...
SALT36.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 90);
  SELF.FldNo2 := 1 + (C % 90);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.key <> 0,TRIM((SALT36.StrType)le.key), ''),TRIM((SALT36.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT36.StrType)le.did), ''),TRIM((SALT36.StrType)le.process_date),TRIM((SALT36.StrType)le.date_first_seen),TRIM((SALT36.StrType)le.date_last_seen),TRIM((SALT36.StrType)le.date_vendor_first_reported),TRIM((SALT36.StrType)le.date_vendor_last_reported),TRIM((SALT36.StrType)le.historical_flag),TRIM((SALT36.StrType)le.full_name),TRIM((SALT36.StrType)le.first_name),TRIM((SALT36.StrType)le.last_name),TRIM((SALT36.StrType)le.address_1),TRIM((SALT36.StrType)le.address_2),TRIM((SALT36.StrType)le.city),TRIM((SALT36.StrType)le.state),TRIM((SALT36.StrType)le.zip),TRIM((SALT36.StrType)le.zip_4),TRIM((SALT36.StrType)le.crrt_code),TRIM((SALT36.StrType)le.delivery_point_barcode),TRIM((SALT36.StrType)le.zip4_check_digit),TRIM((SALT36.StrType)le.address_type_code),TRIM((SALT36.StrType)le.address_type),TRIM((SALT36.StrType)le.county_number),TRIM((SALT36.StrType)le.county_name),TRIM((SALT36.StrType)le.gender_code),TRIM((SALT36.StrType)le.gender),TRIM((SALT36.StrType)le.age),TRIM((SALT36.StrType)le.birth_date),TRIM((SALT36.StrType)le.dob_formatted),TRIM((SALT36.StrType)le.telephone),TRIM((SALT36.StrType)le.class),TRIM((SALT36.StrType)le.college_class),TRIM((SALT36.StrType)le.college_name),TRIM((SALT36.StrType)le.ln_college_name),TRIM((SALT36.StrType)le.college_major),TRIM((SALT36.StrType)le.new_college_major),TRIM((SALT36.StrType)le.college_code),TRIM((SALT36.StrType)le.college_code_exploded),TRIM((SALT36.StrType)le.college_type),TRIM((SALT36.StrType)le.college_type_exploded),TRIM((SALT36.StrType)le.head_of_household_first_name),TRIM((SALT36.StrType)le.head_of_household_gender_code),TRIM((SALT36.StrType)le.head_of_household_gender),TRIM((SALT36.StrType)le.income_level_code),TRIM((SALT36.StrType)le.income_level),TRIM((SALT36.StrType)le.new_income_level_code),TRIM((SALT36.StrType)le.new_income_level),TRIM((SALT36.StrType)le.file_type),TRIM((SALT36.StrType)le.tier),TRIM((SALT36.StrType)le.school_size_code),TRIM((SALT36.StrType)le.competitive_code),TRIM((SALT36.StrType)le.tuition_code),TRIM((SALT36.StrType)le.title),TRIM((SALT36.StrType)le.fname),TRIM((SALT36.StrType)le.mname),TRIM((SALT36.StrType)le.lname),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT36.StrType)le.rawaid), ''),TRIM((SALT36.StrType)le.prim_range),TRIM((SALT36.StrType)le.predir),TRIM((SALT36.StrType)le.prim_name),TRIM((SALT36.StrType)le.addr_suffix),TRIM((SALT36.StrType)le.postdir),TRIM((SALT36.StrType)le.unit_desig),TRIM((SALT36.StrType)le.sec_range),TRIM((SALT36.StrType)le.p_city_name),TRIM((SALT36.StrType)le.v_city_name),TRIM((SALT36.StrType)le.st),TRIM((SALT36.StrType)le.z5),TRIM((SALT36.StrType)le.zip4),TRIM((SALT36.StrType)le.cart),TRIM((SALT36.StrType)le.cr_sort_sz),TRIM((SALT36.StrType)le.lot),TRIM((SALT36.StrType)le.lot_order),TRIM((SALT36.StrType)le.dpbc),TRIM((SALT36.StrType)le.chk_digit),TRIM((SALT36.StrType)le.rec_type),TRIM((SALT36.StrType)le.county),TRIM((SALT36.StrType)le.ace_fips_st),TRIM((SALT36.StrType)le.fips_county),TRIM((SALT36.StrType)le.geo_lat),TRIM((SALT36.StrType)le.geo_long),TRIM((SALT36.StrType)le.msa),TRIM((SALT36.StrType)le.geo_blk),TRIM((SALT36.StrType)le.geo_match),TRIM((SALT36.StrType)le.err_stat),TRIM((SALT36.StrType)le.tier2),TRIM((SALT36.StrType)le.source)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.key <> 0,TRIM((SALT36.StrType)le.key), ''),TRIM((SALT36.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT36.StrType)le.did), ''),TRIM((SALT36.StrType)le.process_date),TRIM((SALT36.StrType)le.date_first_seen),TRIM((SALT36.StrType)le.date_last_seen),TRIM((SALT36.StrType)le.date_vendor_first_reported),TRIM((SALT36.StrType)le.date_vendor_last_reported),TRIM((SALT36.StrType)le.historical_flag),TRIM((SALT36.StrType)le.full_name),TRIM((SALT36.StrType)le.first_name),TRIM((SALT36.StrType)le.last_name),TRIM((SALT36.StrType)le.address_1),TRIM((SALT36.StrType)le.address_2),TRIM((SALT36.StrType)le.city),TRIM((SALT36.StrType)le.state),TRIM((SALT36.StrType)le.zip),TRIM((SALT36.StrType)le.zip_4),TRIM((SALT36.StrType)le.crrt_code),TRIM((SALT36.StrType)le.delivery_point_barcode),TRIM((SALT36.StrType)le.zip4_check_digit),TRIM((SALT36.StrType)le.address_type_code),TRIM((SALT36.StrType)le.address_type),TRIM((SALT36.StrType)le.county_number),TRIM((SALT36.StrType)le.county_name),TRIM((SALT36.StrType)le.gender_code),TRIM((SALT36.StrType)le.gender),TRIM((SALT36.StrType)le.age),TRIM((SALT36.StrType)le.birth_date),TRIM((SALT36.StrType)le.dob_formatted),TRIM((SALT36.StrType)le.telephone),TRIM((SALT36.StrType)le.class),TRIM((SALT36.StrType)le.college_class),TRIM((SALT36.StrType)le.college_name),TRIM((SALT36.StrType)le.ln_college_name),TRIM((SALT36.StrType)le.college_major),TRIM((SALT36.StrType)le.new_college_major),TRIM((SALT36.StrType)le.college_code),TRIM((SALT36.StrType)le.college_code_exploded),TRIM((SALT36.StrType)le.college_type),TRIM((SALT36.StrType)le.college_type_exploded),TRIM((SALT36.StrType)le.head_of_household_first_name),TRIM((SALT36.StrType)le.head_of_household_gender_code),TRIM((SALT36.StrType)le.head_of_household_gender),TRIM((SALT36.StrType)le.income_level_code),TRIM((SALT36.StrType)le.income_level),TRIM((SALT36.StrType)le.new_income_level_code),TRIM((SALT36.StrType)le.new_income_level),TRIM((SALT36.StrType)le.file_type),TRIM((SALT36.StrType)le.tier),TRIM((SALT36.StrType)le.school_size_code),TRIM((SALT36.StrType)le.competitive_code),TRIM((SALT36.StrType)le.tuition_code),TRIM((SALT36.StrType)le.title),TRIM((SALT36.StrType)le.fname),TRIM((SALT36.StrType)le.mname),TRIM((SALT36.StrType)le.lname),TRIM((SALT36.StrType)le.name_suffix),TRIM((SALT36.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT36.StrType)le.rawaid), ''),TRIM((SALT36.StrType)le.prim_range),TRIM((SALT36.StrType)le.predir),TRIM((SALT36.StrType)le.prim_name),TRIM((SALT36.StrType)le.addr_suffix),TRIM((SALT36.StrType)le.postdir),TRIM((SALT36.StrType)le.unit_desig),TRIM((SALT36.StrType)le.sec_range),TRIM((SALT36.StrType)le.p_city_name),TRIM((SALT36.StrType)le.v_city_name),TRIM((SALT36.StrType)le.st),TRIM((SALT36.StrType)le.z5),TRIM((SALT36.StrType)le.zip4),TRIM((SALT36.StrType)le.cart),TRIM((SALT36.StrType)le.cr_sort_sz),TRIM((SALT36.StrType)le.lot),TRIM((SALT36.StrType)le.lot_order),TRIM((SALT36.StrType)le.dpbc),TRIM((SALT36.StrType)le.chk_digit),TRIM((SALT36.StrType)le.rec_type),TRIM((SALT36.StrType)le.county),TRIM((SALT36.StrType)le.ace_fips_st),TRIM((SALT36.StrType)le.fips_county),TRIM((SALT36.StrType)le.geo_lat),TRIM((SALT36.StrType)le.geo_long),TRIM((SALT36.StrType)le.msa),TRIM((SALT36.StrType)le.geo_blk),TRIM((SALT36.StrType)le.geo_match),TRIM((SALT36.StrType)le.err_stat),TRIM((SALT36.StrType)le.tier2),TRIM((SALT36.StrType)le.source)));
  END;
...
SHARED FldIds := DATASET([{1,'key'}
      ...
      ,{88,'err_stat'}
      ,{89,'tier2'}
      ,{90,'source'}],SALT36.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_key((SALT36.StrType)le.key),
    Fields.InValid_ssn((SALT36.StrType)le.ssn),
    Fields.InValid_did((SALT36.StrType)le.did),
    Fields.InValid_process_date((SALT36.StrType)le.process_date),
    Fields.InValid_date_first_seen((SALT36.StrType)le.date_first_seen),
    Fields.InValid_date_last_seen((SALT36.StrType)le.date_last_seen),
    Fields.InValid_date_vendor_first_reported((SALT36.StrType)le.date_vendor_first_reported),
    Fields.InValid_date_vendor_last_reported((SALT36.StrType)le.date_vendor_last_reported),
    Fields.InValid_historical_flag((SALT36.StrType)le.historical_flag),
    Fields.InValid_full_name((SALT36.StrType)le.full_name),
    Fields.InValid_first_name((SALT36.StrType)le.first_name),
    Fields.InValid_last_name((SALT36.StrType)le.last_name),
    Fields.InValid_address_1((SALT36.StrType)le.address_1),
    Fields.InValid_address_2((SALT36.StrType)le.address_2),
    Fields.InValid_city((SALT36.StrType)le.city),
    Fields.InValid_state((SALT36.StrType)le.state),
    Fields.InValid_zip((SALT36.StrType)le.zip),
    Fields.InValid_zip_4((SALT36.StrType)le.zip_4),
    Fields.InValid_crrt_code((SALT36.StrType)le.crrt_code),
    Fields.InValid_delivery_point_barcode((SALT36.StrType)le.delivery_point_barcode),
    Fields.InValid_zip4_check_digit((SALT36.StrType)le.zip4_check_digit),
    Fields.InValid_address_type_code((SALT36.StrType)le.address_type_code),
    Fields.InValid_address_type((SALT36.StrType)le.address_type),
    Fields.InValid_county_number((SALT36.StrType)le.county_number),
    Fields.InValid_county_name((SALT36.StrType)le.county_name),
    Fields.InValid_gender_code((SALT36.StrType)le.gender_code),
    Fields.InValid_gender((SALT36.StrType)le.gender),
    Fields.InValid_age((SALT36.StrType)le.age),
    Fields.InValid_birth_date((SALT36.StrType)le.birth_date),
    Fields.InValid_dob_formatted((SALT36.StrType)le.dob_formatted),
    Fields.InValid_telephone((SALT36.StrType)le.telephone),
    Fields.InValid_class((SALT36.StrType)le.class),
    Fields.InValid_college_class((SALT36.StrType)le.college_class),
    Fields.InValid_college_name((SALT36.StrType)le.college_name),
    Fields.InValid_ln_college_name((SALT36.StrType)le.ln_college_name),
    Fields.InValid_college_major((SALT36.StrType)le.college_major),
    Fields.InValid_new_college_major((SALT36.StrType)le.new_college_major),
    Fields.InValid_college_code((SALT36.StrType)le.college_code),
    Fields.InValid_college_code_exploded((SALT36.StrType)le.college_code_exploded),
    Fields.InValid_college_type((SALT36.StrType)le.college_type),
    Fields.InValid_college_type_exploded((SALT36.StrType)le.college_type_exploded),
    Fields.InValid_head_of_household_first_name((SALT36.StrType)le.head_of_household_first_name),
    Fields.InValid_head_of_household_gender_code((SALT36.StrType)le.head_of_household_gender_code),
    Fields.InValid_head_of_household_gender((SALT36.StrType)le.head_of_household_gender),
    Fields.InValid_income_level_code((SALT36.StrType)le.income_level_code),
    Fields.InValid_income_level((SALT36.StrType)le.income_level),
    Fields.InValid_new_income_level_code((SALT36.StrType)le.new_income_level_code),
    Fields.InValid_new_income_level((SALT36.StrType)le.new_income_level),
    Fields.InValid_file_type((SALT36.StrType)le.file_type),
    Fields.InValid_tier((SALT36.StrType)le.tier),
    Fields.InValid_school_size_code((SALT36.StrType)le.school_size_code),
    Fields.InValid_competitive_code((SALT36.StrType)le.competitive_code),
    Fields.InValid_tuition_code((SALT36.StrType)le.tuition_code),
    Fields.InValid_title((SALT36.StrType)le.title),
    Fields.InValid_fname((SALT36.StrType)le.fname),
    Fields.InValid_mname((SALT36.StrType)le.mname),
    Fields.InValid_lname((SALT36.StrType)le.lname),
    Fields.InValid_name_suffix((SALT36.StrType)le.name_suffix),
    Fields.InValid_name_score((SALT36.StrType)le.name_score),
    Fields.InValid_rawaid((SALT36.StrType)le.rawaid),
    Fields.InValid_prim_range((SALT36.StrType)le.prim_range),
    Fields.InValid_predir((SALT36.StrType)le.predir),
    Fields.InValid_prim_name((SALT36.StrType)le.prim_name),
    Fields.InValid_addr_suffix((SALT36.StrType)le.addr_suffix),
    Fields.InValid_postdir((SALT36.StrType)le.postdir),
    Fields.InValid_unit_desig((SALT36.StrType)le.unit_desig),
    Fields.InValid_sec_range((SALT36.StrType)le.sec_range),
    Fields.InValid_p_city_name((SALT36.StrType)le.p_city_name),
    Fields.InValid_v_city_name((SALT36.StrType)le.v_city_name),
    Fields.InValid_st((SALT36.StrType)le.st),
    Fields.InValid_z5((SALT36.StrType)le.z5),
    Fields.InValid_zip4((SALT36.StrType)le.zip4),
    Fields.InValid_cart((SALT36.StrType)le.cart),
    Fields.InValid_cr_sort_sz((SALT36.StrType)le.cr_sort_sz),
    Fields.InValid_lot((SALT36.StrType)le.lot),
    Fields.InValid_lot_order((SALT36.StrType)le.lot_order),
    Fields.InValid_dpbc((SALT36.StrType)le.dpbc),
    Fields.InValid_chk_digit((SALT36.StrType)le.chk_digit),
    Fields.InValid_rec_type((SALT36.StrType)le.rec_type),
    Fields.InValid_county((SALT36.StrType)le.county),
    Fields.InValid_ace_fips_st((SALT36.StrType)le.ace_fips_st),
    Fields.InValid_fips_county((SALT36.StrType)le.fips_county),
    Fields.InValid_geo_lat((SALT36.StrType)le.geo_lat),
    Fields.InValid_geo_long((SALT36.StrType)le.geo_long),
    Fields.InValid_msa((SALT36.StrType)le.msa),
    Fields.InValid_geo_blk((SALT36.StrType)le.geo_blk),
    Fields.InValid_geo_match((SALT36.StrType)le.geo_match),
    Fields.InValid_err_stat((SALT36.StrType)le.err_stat),
    Fields.InValid_tier2((SALT36.StrType)le.tier2),
    Fields.InValid_source((SALT36.StrType)le.source),
    0);
