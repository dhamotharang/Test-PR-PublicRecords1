...
EXPORT Summary(SALT38.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_key := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.key)));
    avelength_key := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.key)),h.key<>(typeof(h.key))'');
    ...
    maxlength_historical_flag := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.historical_flag)));
    avelength_historical_flag := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.historical_flag)),h.historical_flag<>(typeof(h.historical_flag))'');
    ...
    maxlength_full_name := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.full_name)));
    avelength_full_name := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.full_name)),h.full_name<>(typeof(h.full_name))'');
    ...
    maxlength_gender_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.gender_code)));
    avelength_gender_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.gender_code)),h.gender_code<>(typeof(h.gender_code))'');
    ...
    maxlength_dob_formatted := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.dob_formatted)));
    avelength_dob_formatted := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.dob_formatted)),h.dob_formatted<>(typeof(h.dob_formatted))'');
    ...
    maxlength_ln_college_name := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.ln_college_name)));
    avelength_ln_college_name := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.ln_college_name)),h.ln_college_name<>(typeof(h.ln_college_name))'');
    ...
    maxlength_new_college_major := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_college_major)));
    avelength_new_college_major := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_college_major)),h.new_college_major<>(typeof(h.new_college_major))'');
    ...
    maxlength_college_code_exploded := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.college_code_exploded)));
    avelength_college_code_exploded := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.college_code_exploded)),h.college_code_exploded<>(typeof(h.college_code_exploded))'');
    ...
    maxlength_college_type_exploded := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.college_type_exploded)));
    avelength_college_type_exploded := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.college_type_exploded)),h.college_type_exploded<>(typeof(h.college_type_exploded))'');
    ...
    maxlength_head_of_household_gender_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.head_of_household_gender_code)));
    avelength_head_of_household_gender_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.head_of_household_gender_code)),h.head_of_household_gender_code<>(typeof(h.head_of_household_gender_code))'');
    ...
    maxlength_income_level_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.income_level_code)));
    avelength_income_level_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.income_level_code)),h.income_level_code<>(typeof(h.income_level_code))'');
    ...
    maxlength_new_income_level_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_income_level_code)));
    avelength_new_income_level_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_income_level_code)),h.new_income_level_code<>(typeof(h.new_income_level_code))'');
    ...
    maxlength_new_income_level := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_income_level)));
    avelength_new_income_level := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.new_income_level)),h.new_income_level<>(typeof(h.new_income_level))'');
    ...
    maxlength_tier := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.tier)));
    avelength_tier := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.tier)),h.tier<>(typeof(h.tier))'');
    ...
    maxlength_school_size_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.school_size_code)));
    avelength_school_size_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.school_size_code)),h.school_size_code<>(typeof(h.school_size_code))'');
    ...
    maxlength_competitive_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.competitive_code)));
    avelength_competitive_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.competitive_code)),h.competitive_code<>(typeof(h.competitive_code))'');
    ...
    maxlength_tuition_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.tuition_code)));
    avelength_tuition_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.tuition_code)),h.tuition_code<>(typeof(h.tuition_code))'');
    ...
    maxlength_tier2 := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.tier2)));
    avelength_tier2 := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.tier2)),h.tier2<>(typeof(h.tier2))'');
...
SALT38.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.key <> 0,TRIM((SALT38.StrType)le.key), ''),TRIM((SALT38.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT38.StrType)le.did), ''),TRIM((SALT38.StrType)le.process_date),TRIM((SALT38.StrType)le.date_first_seen),TRIM((SALT38.StrType)le.date_last_seen),TRIM((SALT38.StrType)le.date_vendor_first_reported),TRIM((SALT38.StrType)le.date_vendor_last_reported),TRIM((SALT38.StrType)le.historical_flag),TRIM((SALT38.StrType)le.full_name),TRIM((SALT38.StrType)le.first_name),TRIM((SALT38.StrType)le.last_name),TRIM((SALT38.StrType)le.address_1),TRIM((SALT38.StrType)le.address_2),TRIM((SALT38.StrType)le.city),TRIM((SALT38.StrType)le.state),TRIM((SALT38.StrType)le.zip),TRIM((SALT38.StrType)le.zip_4),TRIM((SALT38.StrType)le.crrt_code),TRIM((SALT38.StrType)le.delivery_point_barcode),TRIM((SALT38.StrType)le.zip4_check_digit),TRIM((SALT38.StrType)le.address_type_code),TRIM((SALT38.StrType)le.address_type),TRIM((SALT38.StrType)le.county_number),TRIM((SALT38.StrType)le.county_name),TRIM((SALT38.StrType)le.gender_code),TRIM((SALT38.StrType)le.gender),TRIM((SALT38.StrType)le.age),TRIM((SALT38.StrType)le.birth_date),TRIM((SALT38.StrType)le.dob_formatted),TRIM((SALT38.StrType)le.telephone),TRIM((SALT38.StrType)le.class),TRIM((SALT38.StrType)le.college_class),TRIM((SALT38.StrType)le.college_name),TRIM((SALT38.StrType)le.ln_college_name),TRIM((SALT38.StrType)le.college_major),TRIM((SALT38.StrType)le.new_college_major),TRIM((SALT38.StrType)le.college_code),TRIM((SALT38.StrType)le.college_code_exploded),TRIM((SALT38.StrType)le.college_type),TRIM((SALT38.StrType)le.college_type_exploded),TRIM((SALT38.StrType)le.head_of_household_first_name),TRIM((SALT38.StrType)le.head_of_household_gender_code),TRIM((SALT38.StrType)le.head_of_household_gender),TRIM((SALT38.StrType)le.income_level_code),TRIM((SALT38.StrType)le.income_level),TRIM((SALT38.StrType)le.new_income_level_code),TRIM((SALT38.StrType)le.new_income_level),TRIM((SALT38.StrType)le.file_type),TRIM((SALT38.StrType)le.tier),TRIM((SALT38.StrType)le.school_size_code),TRIM((SALT38.StrType)le.competitive_code),TRIM((SALT38.StrType)le.tuition_code),TRIM((SALT38.StrType)le.title),TRIM((SALT38.StrType)le.fname),TRIM((SALT38.StrType)le.mname),TRIM((SALT38.StrType)le.lname),TRIM((SALT38.StrType)le.name_suffix),TRIM((SALT38.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT38.StrType)le.rawaid), ''),TRIM((SALT38.StrType)le.prim_range),TRIM((SALT38.StrType)le.predir),TRIM((SALT38.StrType)le.prim_name),TRIM((SALT38.StrType)le.addr_suffix),TRIM((SALT38.StrType)le.postdir),TRIM((SALT38.StrType)le.unit_desig),TRIM((SALT38.StrType)le.sec_range),TRIM((SALT38.StrType)le.p_city_name),TRIM((SALT38.StrType)le.v_city_name),TRIM((SALT38.StrType)le.st),TRIM((SALT38.StrType)le.z5),TRIM((SALT38.StrType)le.zip4),TRIM((SALT38.StrType)le.cart),TRIM((SALT38.StrType)le.cr_sort_sz),TRIM((SALT38.StrType)le.lot),TRIM((SALT38.StrType)le.lot_order),TRIM((SALT38.StrType)le.dpbc),TRIM((SALT38.StrType)le.chk_digit),TRIM((SALT38.StrType)le.rec_type),TRIM((SALT38.StrType)le.county),TRIM((SALT38.StrType)le.ace_fips_st),TRIM((SALT38.StrType)le.fips_county),TRIM((SALT38.StrType)le.geo_lat),TRIM((SALT38.StrType)le.geo_long),TRIM((SALT38.StrType)le.msa),TRIM((SALT38.StrType)le.geo_blk),TRIM((SALT38.StrType)le.geo_match),TRIM((SALT38.StrType)le.err_stat),TRIM((SALT38.StrType)le.tier2),TRIM((SALT38.StrType)le.source)));
  SELF.FldNo := C;
END;
...
SALT38.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 90);
  SELF.FldNo2 := 1 + (C % 90);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.key <> 0,TRIM((SALT38.StrType)le.key), ''),TRIM((SALT38.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT38.StrType)le.did), ''),TRIM((SALT38.StrType)le.process_date),TRIM((SALT38.StrType)le.date_first_seen),TRIM((SALT38.StrType)le.date_last_seen),TRIM((SALT38.StrType)le.date_vendor_first_reported),TRIM((SALT38.StrType)le.date_vendor_last_reported),TRIM((SALT38.StrType)le.historical_flag),TRIM((SALT38.StrType)le.full_name),TRIM((SALT38.StrType)le.first_name),TRIM((SALT38.StrType)le.last_name),TRIM((SALT38.StrType)le.address_1),TRIM((SALT38.StrType)le.address_2),TRIM((SALT38.StrType)le.city),TRIM((SALT38.StrType)le.state),TRIM((SALT38.StrType)le.zip),TRIM((SALT38.StrType)le.zip_4),TRIM((SALT38.StrType)le.crrt_code),TRIM((SALT38.StrType)le.delivery_point_barcode),TRIM((SALT38.StrType)le.zip4_check_digit),TRIM((SALT38.StrType)le.address_type_code),TRIM((SALT38.StrType)le.address_type),TRIM((SALT38.StrType)le.county_number),TRIM((SALT38.StrType)le.county_name),TRIM((SALT38.StrType)le.gender_code),TRIM((SALT38.StrType)le.gender),TRIM((SALT38.StrType)le.age),TRIM((SALT38.StrType)le.birth_date),TRIM((SALT38.StrType)le.dob_formatted),TRIM((SALT38.StrType)le.telephone),TRIM((SALT38.StrType)le.class),TRIM((SALT38.StrType)le.college_class),TRIM((SALT38.StrType)le.college_name),TRIM((SALT38.StrType)le.ln_college_name),TRIM((SALT38.StrType)le.college_major),TRIM((SALT38.StrType)le.new_college_major),TRIM((SALT38.StrType)le.college_code),TRIM((SALT38.StrType)le.college_code_exploded),TRIM((SALT38.StrType)le.college_type),TRIM((SALT38.StrType)le.college_type_exploded),TRIM((SALT38.StrType)le.head_of_household_first_name),TRIM((SALT38.StrType)le.head_of_household_gender_code),TRIM((SALT38.StrType)le.head_of_household_gender),TRIM((SALT38.StrType)le.income_level_code),TRIM((SALT38.StrType)le.income_level),TRIM((SALT38.StrType)le.new_income_level_code),TRIM((SALT38.StrType)le.new_income_level),TRIM((SALT38.StrType)le.file_type),TRIM((SALT38.StrType)le.tier),TRIM((SALT38.StrType)le.school_size_code),TRIM((SALT38.StrType)le.competitive_code),TRIM((SALT38.StrType)le.tuition_code),TRIM((SALT38.StrType)le.title),TRIM((SALT38.StrType)le.fname),TRIM((SALT38.StrType)le.mname),TRIM((SALT38.StrType)le.lname),TRIM((SALT38.StrType)le.name_suffix),TRIM((SALT38.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT38.StrType)le.rawaid), ''),TRIM((SALT38.StrType)le.prim_range),TRIM((SALT38.StrType)le.predir),TRIM((SALT38.StrType)le.prim_name),TRIM((SALT38.StrType)le.addr_suffix),TRIM((SALT38.StrType)le.postdir),TRIM((SALT38.StrType)le.unit_desig),TRIM((SALT38.StrType)le.sec_range),TRIM((SALT38.StrType)le.p_city_name),TRIM((SALT38.StrType)le.v_city_name),TRIM((SALT38.StrType)le.st),TRIM((SALT38.StrType)le.z5),TRIM((SALT38.StrType)le.zip4),TRIM((SALT38.StrType)le.cart),TRIM((SALT38.StrType)le.cr_sort_sz),TRIM((SALT38.StrType)le.lot),TRIM((SALT38.StrType)le.lot_order),TRIM((SALT38.StrType)le.dpbc),TRIM((SALT38.StrType)le.chk_digit),TRIM((SALT38.StrType)le.rec_type),TRIM((SALT38.StrType)le.county),TRIM((SALT38.StrType)le.ace_fips_st),TRIM((SALT38.StrType)le.fips_county),TRIM((SALT38.StrType)le.geo_lat),TRIM((SALT38.StrType)le.geo_long),TRIM((SALT38.StrType)le.msa),TRIM((SALT38.StrType)le.geo_blk),TRIM((SALT38.StrType)le.geo_match),TRIM((SALT38.StrType)le.err_stat),TRIM((SALT38.StrType)le.tier2),TRIM((SALT38.StrType)le.source)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.key <> 0,TRIM((SALT38.StrType)le.key), ''),TRIM((SALT38.StrType)le.ssn),IF (le.did <> 0,TRIM((SALT38.StrType)le.did), ''),TRIM((SALT38.StrType)le.process_date),TRIM((SALT38.StrType)le.date_first_seen),TRIM((SALT38.StrType)le.date_last_seen),TRIM((SALT38.StrType)le.date_vendor_first_reported),TRIM((SALT38.StrType)le.date_vendor_last_reported),TRIM((SALT38.StrType)le.historical_flag),TRIM((SALT38.StrType)le.full_name),TRIM((SALT38.StrType)le.first_name),TRIM((SALT38.StrType)le.last_name),TRIM((SALT38.StrType)le.address_1),TRIM((SALT38.StrType)le.address_2),TRIM((SALT38.StrType)le.city),TRIM((SALT38.StrType)le.state),TRIM((SALT38.StrType)le.zip),TRIM((SALT38.StrType)le.zip_4),TRIM((SALT38.StrType)le.crrt_code),TRIM((SALT38.StrType)le.delivery_point_barcode),TRIM((SALT38.StrType)le.zip4_check_digit),TRIM((SALT38.StrType)le.address_type_code),TRIM((SALT38.StrType)le.address_type),TRIM((SALT38.StrType)le.county_number),TRIM((SALT38.StrType)le.county_name),TRIM((SALT38.StrType)le.gender_code),TRIM((SALT38.StrType)le.gender),TRIM((SALT38.StrType)le.age),TRIM((SALT38.StrType)le.birth_date),TRIM((SALT38.StrType)le.dob_formatted),TRIM((SALT38.StrType)le.telephone),TRIM((SALT38.StrType)le.class),TRIM((SALT38.StrType)le.college_class),TRIM((SALT38.StrType)le.college_name),TRIM((SALT38.StrType)le.ln_college_name),TRIM((SALT38.StrType)le.college_major),TRIM((SALT38.StrType)le.new_college_major),TRIM((SALT38.StrType)le.college_code),TRIM((SALT38.StrType)le.college_code_exploded),TRIM((SALT38.StrType)le.college_type),TRIM((SALT38.StrType)le.college_type_exploded),TRIM((SALT38.StrType)le.head_of_household_first_name),TRIM((SALT38.StrType)le.head_of_household_gender_code),TRIM((SALT38.StrType)le.head_of_household_gender),TRIM((SALT38.StrType)le.income_level_code),TRIM((SALT38.StrType)le.income_level),TRIM((SALT38.StrType)le.new_income_level_code),TRIM((SALT38.StrType)le.new_income_level),TRIM((SALT38.StrType)le.file_type),TRIM((SALT38.StrType)le.tier),TRIM((SALT38.StrType)le.school_size_code),TRIM((SALT38.StrType)le.competitive_code),TRIM((SALT38.StrType)le.tuition_code),TRIM((SALT38.StrType)le.title),TRIM((SALT38.StrType)le.fname),TRIM((SALT38.StrType)le.mname),TRIM((SALT38.StrType)le.lname),TRIM((SALT38.StrType)le.name_suffix),TRIM((SALT38.StrType)le.name_score),IF (le.rawaid <> 0,TRIM((SALT38.StrType)le.rawaid), ''),TRIM((SALT38.StrType)le.prim_range),TRIM((SALT38.StrType)le.predir),TRIM((SALT38.StrType)le.prim_name),TRIM((SALT38.StrType)le.addr_suffix),TRIM((SALT38.StrType)le.postdir),TRIM((SALT38.StrType)le.unit_desig),TRIM((SALT38.StrType)le.sec_range),TRIM((SALT38.StrType)le.p_city_name),TRIM((SALT38.StrType)le.v_city_name),TRIM((SALT38.StrType)le.st),TRIM((SALT38.StrType)le.z5),TRIM((SALT38.StrType)le.zip4),TRIM((SALT38.StrType)le.cart),TRIM((SALT38.StrType)le.cr_sort_sz),TRIM((SALT38.StrType)le.lot),TRIM((SALT38.StrType)le.lot_order),TRIM((SALT38.StrType)le.dpbc),TRIM((SALT38.StrType)le.chk_digit),TRIM((SALT38.StrType)le.rec_type),TRIM((SALT38.StrType)le.county),TRIM((SALT38.StrType)le.ace_fips_st),TRIM((SALT38.StrType)le.fips_county),TRIM((SALT38.StrType)le.geo_lat),TRIM((SALT38.StrType)le.geo_long),TRIM((SALT38.StrType)le.msa),TRIM((SALT38.StrType)le.geo_blk),TRIM((SALT38.StrType)le.geo_match),TRIM((SALT38.StrType)le.err_stat),TRIM((SALT38.StrType)le.tier2),TRIM((SALT38.StrType)le.source)));
  END;
...
SHARED FldIds := DATASET([{1,'key'}
      ...
      ,{88,'err_stat'}
      ,{89,'tier2'}
      ,{90,'source'}],SALT38.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_key((SALT38.StrType)le.key),
    Fields.InValid_ssn((SALT38.StrType)le.ssn),
    Fields.InValid_did((SALT38.StrType)le.did),
    Fields.InValid_process_date((SALT38.StrType)le.process_date),
    Fields.InValid_date_first_seen((SALT38.StrType)le.date_first_seen),
    Fields.InValid_date_last_seen((SALT38.StrType)le.date_last_seen),
    Fields.InValid_date_vendor_first_reported((SALT38.StrType)le.date_vendor_first_reported),
    Fields.InValid_date_vendor_last_reported((SALT38.StrType)le.date_vendor_last_reported),
    Fields.InValid_historical_flag((SALT38.StrType)le.historical_flag),
    Fields.InValid_full_name((SALT38.StrType)le.full_name),
    Fields.InValid_first_name((SALT38.StrType)le.first_name),
    ...
    Fields.InValid_crrt_code((SALT38.StrType)le.crrt_code),
    Fields.InValid_delivery_point_barcode((SALT38.StrType)le.delivery_point_barcode),
    Fields.InValid_zip4_check_digit((SALT38.StrType)le.zip4_check_digit),
    Fields.InValid_address_type_code((SALT38.StrType)le.address_type_code),
    Fields.InValid_address_type((SALT38.StrType)le.address_type),
    Fields.InValid_county_number((SALT38.StrType)le.county_number),
    Fields.InValid_county_name((SALT38.StrType)le.county_name),
    Fields.InValid_gender_code((SALT38.StrType)le.gender_code),
    Fields.InValid_gender((SALT38.StrType)le.gender),
    Fields.InValid_age((SALT38.StrType)le.age),
    Fields.InValid_birth_date((SALT38.StrType)le.birth_date),
    Fields.InValid_dob_formatted((SALT38.StrType)le.dob_formatted),
    Fields.InValid_telephone((SALT38.StrType)le.telephone),
    Fields.InValid_class((SALT38.StrType)le.class),
    Fields.InValid_college_class((SALT38.StrType)le.college_class),
    Fields.InValid_college_name((SALT38.StrType)le.college_name),
    Fields.InValid_ln_college_name((SALT38.StrType)le.ln_college_name),
    Fields.InValid_college_major((SALT38.StrType)le.college_major),
    Fields.InValid_new_college_major((SALT38.StrType)le.new_college_major),
    Fields.InValid_college_code((SALT38.StrType)le.college_code),
    Fields.InValid_college_code_exploded((SALT38.StrType)le.college_code_exploded),
    Fields.InValid_college_type((SALT38.StrType)le.college_type),
    Fields.InValid_college_type_exploded((SALT38.StrType)le.college_type_exploded),
    Fields.InValid_head_of_household_first_name((SALT38.StrType)le.head_of_household_first_name),
    Fields.InValid_head_of_household_gender_code((SALT38.StrType)le.head_of_household_gender_code),
    Fields.InValid_head_of_household_gender((SALT38.StrType)le.head_of_household_gender),
    Fields.InValid_income_level_code((SALT38.StrType)le.income_level_code),
    Fields.InValid_income_level((SALT38.StrType)le.income_level),
    Fields.InValid_new_income_level_code((SALT38.StrType)le.new_income_level_code),
    Fields.InValid_new_income_level((SALT38.StrType)le.new_income_level),
    Fields.InValid_file_type((SALT38.StrType)le.file_type),
    Fields.InValid_tier((SALT38.StrType)le.tier),
    Fields.InValid_school_size_code((SALT38.StrType)le.school_size_code),
    Fields.InValid_competitive_code((SALT38.StrType)le.competitive_code),
    Fields.InValid_tuition_code((SALT38.StrType)le.tuition_code),
    ...
    Fields.InValid_z5((SALT38.StrType)le.z5),
    ...
    Fields.InValid_tier2((SALT38.StrType)le.tier2),
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_American_Student_List, Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
