...
function
  ...
  ds_best_filter_out_seleid_level := ds_best(proxid != 0); //-- remove seleid level records, only want proxid level
  ...
  ds_best_prep := project(ds_best_get_active_proxids  ,transform(Marketing_List.Layouts.base_prep,
    ...
    self.fname               := ''              ; //get from contact_title_linkids and contact_linkids
    self.lname               := ''              ;//get from contact_title_linkids and contact_linkids
    self.title               := ''              ;//get from contact_title_linkids and contact_linkids
    self.lexid               := 0               ;//get from contact_title_linkids and contact_linkids
