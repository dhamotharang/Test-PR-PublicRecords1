...
output(Marketing_List.Create_Business_Contact_File(ds_crosswalk2,Marketing_List._Config().Marketing_Bitmap,ds_mktng_biz_info,true,[myseleid]) ,named('Marketing_List_Create_Business_Contact_File_'),all);
output(Marketing_List.Create_Business_Information_File(ds_bip_best ,ds_bip_base  ,ds_dca ,ds_eq_biz  ,ds_oshair  ,ds_cortera ,ds_infutor ,ds_accutrend ,true ,[myseleid]) ,named('Marketing_List_Create_Business_Information_File_'),all);
