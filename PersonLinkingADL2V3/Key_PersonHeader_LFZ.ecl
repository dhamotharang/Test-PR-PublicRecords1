/*2011-08-04T12:32:21Z (Jose Bello)
Bug: 84022
*/
...
#IF(#TEXT(Input_LNAME)<>'' AND #TEXT(Input_FNAME)<>'' AND #TEXT(Input_ZIP)<>'')
  #uniquename(trans)
  PersonLinkingADL2V3.Key_PersonHeader_LFZ.InputLayout_Batch %trans%(InFile le) := transform
  ...
  output_file := PersonLinkingADL2V3.Key_PersonHeader_LFZ.ScoredFetch_Batch(%p%,AsIndex);
#ELSE
