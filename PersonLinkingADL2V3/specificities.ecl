...
export input_file := h0  : persist('temp::DID::PersonLinkingADL2V3::Specificities_Cache');
//We have DID specified - so we can compute statistics on the cluster counts
  r0 := record
    input_file.DID;
    unsigned6 InCluster := count(group);
  end;
export ClusterSizes := table(input_file,r0,DID,local)  : persist('temp::DID::PersonLinkingADL2V3::Cluster_Sizes');
shared  NAME_SUFFIX_deduped := SALT20.MAC_Field_By_UID(input_file,DID,NAME_SUFFIX) : persist('temp::dedups::PersonLinkingADL2V3_DID_NAME_SUFFIX'); // Reduce to field values by UID
...
export NAME_SUFFIX_values_index := index(distance_computed,{NAME_SUFFIX},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_NAME_SUFFIX');
...
shared  FNAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,FNAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_FNAME'); // Reduce to field values by UID
...
export FNAME_values_index := index(distance_computed,{FNAME},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_FNAME');
...
shared  MNAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,MNAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_MNAME'); // Reduce to field values by UID
...
export MNAME_values_index := index(distance_computed,{MNAME},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_MNAME');
...
shared  LNAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,LNAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_LNAME'); // Reduce to field values by UID
...
export LNAME_values_index := index(distance_computed,{LNAME},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_LNAME');
...
shared  PRIM_RANGE_deduped := SALT20.MAC_Field_By_UID(input_file,DID,PRIM_RANGE) : persist('temp::dedups::PersonLinkingADL2V3_DID_PRIM_RANGE'); // Reduce to field values by UID
...
export PRIM_RANGE_values_index := index(distance_computed,{PRIM_RANGE},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_PRIM_RANGE');
...
shared  PRIM_NAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,PRIM_NAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_PRIM_NAME'); // Reduce to field values by UID
...
export PRIM_NAME_values_index := index(distance_computed,{PRIM_NAME},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_PRIM_NAME');
...
shared  SEC_RANGE_deduped := SALT20.MAC_Field_By_UID(input_file,DID,SEC_RANGE) : persist('temp::dedups::PersonLinkingADL2V3_DID_SEC_RANGE'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export SEC_RANGE_values_index := index(specs_added,{SEC_RANGE},{specs_added},'~key::values::PersonLinkingADL2V3_DID_SEC_RANGE');
...
shared  CITY_deduped := SALT20.MAC_Field_By_UID(input_file,DID,CITY) : persist('temp::dedups::PersonLinkingADL2V3_DID_CITY'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export CITY_values_index := index(specs_added,{CITY},{specs_added},'~key::values::PersonLinkingADL2V3_DID_CITY');
...
shared  STATE_deduped := SALT20.MAC_Field_By_UID(input_file,DID,STATE) : persist('temp::dedups::PersonLinkingADL2V3_DID_STATE'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export STATE_values_index := index(specs_added,{STATE},{specs_added},'~key::values::PersonLinkingADL2V3_DID_STATE');
export STATE_values_persisted := STATE_values_index;
...
shared  ZIP_deduped := SALT20.MAC_Field_By_UID(input_file,DID,ZIP) : persist('temp::dedups::PersonLinkingADL2V3_DID_ZIP'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export ZIP_values_index := index(specs_added,{ZIP},{specs_added},'~key::values::PersonLinkingADL2V3_DID_ZIP');
...
shared  ZIP4_deduped := SALT20.MAC_Field_By_UID(input_file,DID,ZIP4) : persist('temp::dedups::PersonLinkingADL2V3_DID_ZIP4'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export ZIP4_values_index := index(specs_added,{ZIP4},{specs_added},'~key::values::PersonLinkingADL2V3_DID_ZIP4');
export ZIP4_values_persisted := ZIP4_values_index;
...
shared  COUNTY_deduped := SALT20.MAC_Field_By_UID(input_file,DID,COUNTY) : persist('temp::dedups::PersonLinkingADL2V3_DID_COUNTY'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export COUNTY_values_index := index(specs_added,{COUNTY},{specs_added},'~key::values::PersonLinkingADL2V3_DID_COUNTY');
export COUNTY_values_persisted := COUNTY_values_index;
...
shared  SSN5_deduped := SALT20.MAC_Field_By_UID(input_file,DID,SSN5) : persist('temp::dedups::PersonLinkingADL2V3_DID_SSN5'); // Reduce to field values by UID
...
export SSN5_values_index := index(distance_computed,{SSN5},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_SSN5');
...
shared  SSN4_deduped := SALT20.MAC_Field_By_UID(input_file,DID,SSN4) : persist('temp::dedups::PersonLinkingADL2V3_DID_SSN4'); // Reduce to field values by UID
...
export SSN4_values_index := index(distance_computed,{SSN4},{distance_computed},'~key::values::PersonLinkingADL2V3_DID_SSN4');
...
shared  DOB_year_deduped := SALT20.MAC_Field_By_UID(input_file,DID,DOB_year) : persist('temp::dedups::PersonLinkingADL2V3_DID_DOB_year'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export DOB_year_values_index := index(specs_added,{DOB_year},{specs_added},'~key::values::PersonLinkingADL2V3_DID_DOB_year');
...
shared  DOB_month_deduped := SALT20.MAC_Field_By_UID(input_file,DID,DOB_month) : persist('temp::dedups::PersonLinkingADL2V3_DID_DOB_month'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export DOB_month_values_index := index(specs_added,{DOB_month},{specs_added},'~key::values::PersonLinkingADL2V3_DID_DOB_month');
...
shared  DOB_day_deduped := SALT20.MAC_Field_By_UID(input_file,DID,DOB_day) : persist('temp::dedups::PersonLinkingADL2V3_DID_DOB_day'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export DOB_day_values_index := index(specs_added,{DOB_day},{specs_added},'~key::values::PersonLinkingADL2V3_DID_DOB_day');
...
shared  PHONE_deduped := SALT20.MAC_Field_By_UID(input_file,DID,PHONE) : persist('temp::dedups::PersonLinkingADL2V3_DID_PHONE'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export PHONE_values_index := index(specs_added,{PHONE},{specs_added},'~key::values::PersonLinkingADL2V3_DID_PHONE');
...
shared  MAINNAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,MAINNAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_MAINNAME'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export MAINNAME_values_index := index(specs_added,{MAINNAME},{specs_added},'~key::values::PersonLinkingADL2V3_DID_MAINNAME');
...
shared  FULLNAME_deduped := SALT20.MAC_Field_By_UID(input_file,DID,FULLNAME) : persist('temp::dedups::PersonLinkingADL2V3_DID_FULLNAME'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export FULLNAME_values_index := index(specs_added,{FULLNAME},{specs_added},'~key::values::PersonLinkingADL2V3_DID_FULLNAME');
...
shared  ADDR1_deduped := SALT20.MAC_Field_By_UID(input_file,DID,ADDR1) : persist('temp::dedups::PersonLinkingADL2V3_DID_ADDR1'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export ADDR1_values_index := index(specs_added,{ADDR1},{specs_added},'~key::values::PersonLinkingADL2V3_DID_ADDR1');
...
shared  LOCALE_deduped := SALT20.MAC_Field_By_UID(input_file,DID,LOCALE) : persist('temp::dedups::PersonLinkingADL2V3_DID_LOCALE'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export LOCALE_values_index := index(specs_added,{LOCALE},{specs_added},'~key::values::PersonLinkingADL2V3_DID_LOCALE');
...
shared  ADDRS_deduped := SALT20.MAC_Field_By_UID(input_file,DID,ADDRS) : persist('temp::dedups::PersonLinkingADL2V3_DID_ADDRS'); // Reduce to field values by UID
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT20.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
export ADDRS_values_index := index(specs_added,{ADDRS},{specs_added},'~key::values::PersonLinkingADL2V3_DID_ADDRS');
export ADDRS_values_persisted := ADDRS_values_index;
...
iSpecificities := dataset([{0,NAME_SUFFIX_specificity,NAME_SUFFIX_switch,NAME_SUFFIX_max,NAME_SUFFIX_nulls,FNAME_specificity,FNAME_switch,FNAME_max,FNAME_nulls,MNAME_specificity,MNAME_switch,MNAME_max,MNAME_nulls,LNAME_specificity,LNAME_switch,LNAME_max,LNAME_nulls,PRIM_RANGE_specificity,PRIM_RANGE_switch,PRIM_RANGE_max,PRIM_RANGE_nulls,PRIM_NAME_specificity,PRIM_NAME_switch,PRIM_NAME_max,PRIM_NAME_nulls,SEC_RANGE_specificity,SEC_RANGE_switch,SEC_RANGE_max,SEC_RANGE_nulls,CITY_specificity,CITY_switch,CITY_max,CITY_nulls,STATE_specificity,STATE_switch,STATE_max,STATE_nulls,ZIP_specificity,ZIP_switch,ZIP_max,ZIP_nulls,ZIP4_specificity,ZIP4_switch,ZIP4_max,ZIP4_nulls,COUNTY_specificity,COUNTY_switch,COUNTY_max,COUNTY_nulls,SSN5_specificity,SSN5_switch,SSN5_max,SSN5_nulls,SSN4_specificity,SSN4_switch,SSN4_max,SSN4_nulls,DOB_year_specificity,DOB_year_switch,DOB_year_max,DOB_year_nulls,DOB_month_specificity,DOB_month_switch,DOB_month_max,DOB_month_nulls,DOB_day_specificity,DOB_day_switch,DOB_day_max,DOB_day_nulls,PHONE_specificity,PHONE_switch,PHONE_max,PHONE_nulls,MAINNAME_specificity,MAINNAME_switch,MAINNAME_max,MAINNAME_nulls,FULLNAME_specificity,FULLNAME_switch,FULLNAME_max,FULLNAME_nulls,ADDR1_specificity,ADDR1_switch,ADDR1_max,ADDR1_nulls,LOCALE_specificity,LOCALE_switch,LOCALE_max,LOCALE_nulls,ADDRS_specificity,ADDRS_switch,ADDRS_max,ADDRS_nulls}],Layout_Specificities.R);
export Specificities_Index := index(iSpecificities,{1},{iSpecificities},'~key::PersonLinkingADL2V3::DID::Specificities');
Layout_Specificities.R Into(Specificities_Index i) := TRANSFORM
  SELF := i;
END;
export Specificities := PROJECT(Specificities_Index,Into(LEFT));
export Build := SEQUENTIAL ( PARALLEL( 
     BUILDINDEX(NAME_SUFFIX_values_index,overwrite)
    ,BUILDINDEX(FNAME_values_index,overwrite)
    ,BUILDINDEX(MNAME_values_index,overwrite)
    ,BUILDINDEX(LNAME_values_index,overwrite)
    ,BUILDINDEX(PRIM_RANGE_values_index,overwrite)
    ,BUILDINDEX(PRIM_NAME_values_index,overwrite)
    ,BUILDINDEX(SEC_RANGE_values_index,overwrite)
    ,BUILDINDEX(CITY_values_index,overwrite)
    ,BUILDINDEX(STATE_values_index,overwrite)
    ,BUILDINDEX(ZIP_values_index,overwrite)
    ,BUILDINDEX(ZIP4_values_index,overwrite)
    ,BUILDINDEX(COUNTY_values_index,overwrite)
    ,BUILDINDEX(SSN5_values_index,overwrite)
    ,BUILDINDEX(SSN4_values_index,overwrite)
    ,BUILDINDEX(DOB_year_values_index,overwrite)
    ,BUILDINDEX(DOB_month_values_index,overwrite)
    ,BUILDINDEX(DOB_day_values_index,overwrite)
    ,BUILDINDEX(PHONE_values_index,overwrite)
    ,BUILDINDEX(MAINNAME_values_index,overwrite)
    ,BUILDINDEX(FULLNAME_values_index,overwrite)
    ,BUILDINDEX(ADDR1_values_index,overwrite)
    ,BUILDINDEX(LOCALE_values_index,overwrite)
    ,BUILDINDEX(ADDRS_values_index,overwrite)
