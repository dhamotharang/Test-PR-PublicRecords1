...
%idata% := TABLE(infile((UNSIGNED4)low_infield<>null_field,(UNSIGNED4)high_infield<>null_field),{ufield,UNSIGNED2 xx_low := SALT34.fn_YYYYMM_to_Int((UNSIGNED4)low_infield),UNSIGNED2 xx_high := SALT34.fn_YYYYMM_to_Int((UNSIGNED4)high_infield)})(xx_low<=xx_high);
#uniquename(r)
%r% := RECORD
