...
/*	 
	...
	*/
	 L1R1 := SALT34.Min0(Match1L(L1,lspec1,lnne1,lfor1,linit1,edit1,R1, rspec1)); // take force into consideration
	 L1R2 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,edit1,R2, rspec2));
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R3, rspec3));
...
shared Match4L(
   ...
   iL1R1 := getInitMatchWeight(L1, lspec1, R1, rspec1);	 
	 ...
	 */
	 ...
	 L1R2 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,edit1,R2, rspec2));
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R3, rspec3));
	 L1R4 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R4, rspec4));
...
*/
   ...
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R3, rspec3));
	 L1R4 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R4, rspec4));
	 L1R5 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,edit1,R5, rspec5));
