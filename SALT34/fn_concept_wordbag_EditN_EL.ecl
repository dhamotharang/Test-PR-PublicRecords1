...
export  Match1L( StrType L1, unsigned2 lspec1, boolean lnne1, integer lfor1, Boolean linit1, unsigned2 ispec1, integer edit1, StrType R1, unsigned2 rspec1) := FUNCTION
	...
	result1 := map(L1 = R1  => if(minWeight > lfor1*100, minWeight, FailedForce),  
	               SALT34.WithinEditN(L1,R1,edit1)  => if(minWeight*(1-edit1*0.1) > lfor1*100, minWeight*(1-edit1*0.1), FailedForce), 
	...
	result := MAP ( 
							 ...
							 not linit1 and not lnne1 and SALT34.WithinEditN(L1,R1,edit1) => if(minWeight*(1-edit1*0.1) > lfor1*100, minWeight*(1-edit1*0.1), FailedForce),	// boolean linit - initial flag,  boolean lnnel - nulls not allowed flag
							 not linit1 and lnne1 and ( L1 = '' or R1 = '' ) 			=> 0,
    					 not linit1 and lnne1 and L1 = R1 => if(minWeight > lfor1*100, minWeight, FailedForce),					 
							 not linit1 and lnne1 and SALT34.WithinEditN(L1,R1,edit1) => if(minWeight*(1-edit1*0.1) > lfor1*100, minWeight*(1-edit1*0.1), FailedForce),
...
export Match2L(
   ...
   L1BlankCost := IF ( lfor1 > 0, FailedForce, Failed );
	 ...
	 result := MAP(not lnne1  and not linit1  and lfor1 > 0 	     => r0,
								...
								SALT34.WithinEditN(L1,R1,edit1) and SALT34.WithinEditN(L2,R2,edit2) => if(weight1*(1-edit1*0.1)+weight2*(1-edit2*0.1) > lfor1*100, weight1*(1-edit1*0.1)+weight2*(1-edit2*0.1), FailedForce), 
								SALT34.WithinEditN(L1,R2,edit1) and SALT34.WithinEditN(L2,R1,edit2) => if(weight1*(1-edit1*0.1)+weight2*(1-edit2*0.1) > lfor1*100, weight1*(1-edit1*0.1)+weight2*(1-edit2*0.1), FailedForce), 
...
shared stringCompare(StrType L1, boolean init, boolean nne, integer edit, StrType R1) := function
	...
	result := map(not nne and (L1 = '' or R1 = '') => false,
							  ...
							  SALT34.WithinEditN(L1,R1,edit) => true , 
							  false);
...
/*	 
	...
	*/
	 L1R1 := SALT34.Min0(Match1L(L1,lspec1,lnne1,lfor1,linit1,ispec1,edit1,R1,rspec1)); // take force into consideration
	 L1R2 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,ispec1,edit1,R2,rspec2));
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R3,rspec3));
...
shared Match4L(
   ...
   iL1R1 := getInitMatchWeight(L1, lspec1, R1, rspec1);	 
	 ...
	 */
	 ...
	 L1R2 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor2),linit1,ispec1,edit1,R2,rspec2));
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R3,rspec3));
	 L1R4 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R4,rspec4));
...
*/
   ...
   L1R3 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R3,rspec3));
	 L1R4 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R4,rspec4));
	 L1R5 := SALT34.Min0(Match1L(L1,lspec1,lnne1,MAX(lfor1,lfor3),linit1,ispec1,edit1,R5,rspec5));
