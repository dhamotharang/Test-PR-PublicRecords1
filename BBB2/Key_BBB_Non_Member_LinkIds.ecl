...
EXPORT Key_BBB_Non_Member_LinkIds := MODULE

  // DEFINE THE INDEX
	EXPORT out_SuperKeyName		:= Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::bbb_non_member_linkids_'+ doxie.Version_SuperKey; //SuperKeyName

	SHARED Base						  	:= project(BBB2.Files().Base.NonMember.Built, transform(BBB2.Layouts_Files.Base.NonMember_BIP - BBB2.Layouts_Files.Base.Layout_Addr_AID, self := left));
