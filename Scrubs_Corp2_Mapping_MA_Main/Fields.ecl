...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_Y_N','invalid_type_cd','invalid_type_desc','invalid_fed_tax_id','invalid_numericblank','invalid_alphablank','invalid_publicprivate_ind','invalid_recordorigin');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_Y_N' => 8,'invalid_type_cd' => 9,'invalid_type_desc' => 10,'invalid_fed_tax_id' => 11,'invalid_numericblank' => 12,'invalid_alphablank' => 13,'invalid_publicprivate_ind' => 14,'invalid_recordorigin' => 15,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['25']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('25'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['MA']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('MA'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT32.StrType s,SALT32.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_cd'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT32.StrType s,SALT32.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_desc'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fed_tax_id(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_fed_tax_id(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -0123456789'))));
EXPORT InValidMessageFT_invalid_fed_tax_id(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -0123456789'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_numericblank(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numericblank(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'0123456789 '))));
EXPORT InValidMessageFT_invalid_numericblank(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('0123456789 '),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_publicprivate_ind(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'1 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_publicprivate_ind(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'1 '))));
EXPORT InValidMessageFT_invalid_publicprivate_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('1 '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_recordorigin(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'C|T'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_recordorigin(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'C|T'))));
EXPORT InValidMessageFT_invalid_recordorigin(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('C|T'),SALT32.HygieneErrors.Good);
...
EXPORT Make_corp_address1_line3(SALT32.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_address1_line3(SALT32.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_address1_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
...
EXPORT Make_corp_fed_tax_id(SALT32.StrType s0) := MakeFT_invalid_fed_tax_id(s0);
EXPORT InValid_corp_fed_tax_id(SALT32.StrType s) := InValidFT_invalid_fed_tax_id(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT32.StrType s0) := MakeFT_invalid_numericblank(s0);
EXPORT InValid_corp_orig_org_structure_cd(SALT32.StrType s) := InValidFT_invalid_numericblank(s);
EXPORT InValidMessage_corp_orig_org_structure_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_numericblank(wh);
...
EXPORT Make_corp_public_or_private_ind(SALT32.StrType s0) := MakeFT_invalid_publicprivate_ind(s0);
EXPORT InValid_corp_public_or_private_ind(SALT32.StrType s) := InValidFT_invalid_publicprivate_ind(s);
EXPORT InValidMessage_corp_public_or_private_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_publicprivate_ind(wh);
...
EXPORT Make_corp_merger_date(SALT32.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_merger_date(SALT32.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_merger_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_MA_Main;
