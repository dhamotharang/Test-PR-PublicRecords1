...
Command line options: -MScrubs_Corp2_Mapping_MA_Main -eC:\Users\butlersx\AppData\Local\Temp\TFRC7DE.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_MA_Main
FILENAME:In_MA
...
FIELDTYPE:invalid_corp_vendor:ENUM(25)
FIELDTYPE:invalid_state_origin:ENUM(MA)
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_MA_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
...
FIELDTYPE:invalid_publicprivate_ind:ALLOW(1 )
...
FIELD:corp_orig_org_structure_cd:TYPE(STRING8):LIKE(invalid_numericblank):0,0
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):0,0
FIELD:corp_for_profit_ind:TYPE(STRING1):LIKE(invalid_Y_N):0,0
FIELD:corp_public_or_private_ind:TYPE(STRING1):LIKE(invalid_publicprivate_ind):0,0
