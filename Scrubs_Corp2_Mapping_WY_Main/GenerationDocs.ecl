...
Command line options: -MScrubs_Corp2_Mapping_WY_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR384C.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_WY_Main
FILENAME:In_WY
...
FIELDTYPE:invalid_corp_vendor:ENUM(56)
FIELDTYPE:invalid_state_origin:ENUM(WY)
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_addr_type_cd:ENUM(B|M| ):LENGTHS(1,0)
FIELDTYPE:invalid_addr_type_desc:ENUM(BUSINESS|MAILING| )
FIELDTYPE:invalid_filing_desc:ENUM(FILING| )
FIELDTYPE:invalid_term_exist_cd:ENUM(D|N|P| )
FIELDTYPE:invalid_for_dom_ind:ENUM(F|D| )
FIELDTYPE:invalid_corp_forgn_state_cd:CUSTOM(Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_cd>0)
FIELDTYPE:invalid_corp_forgn_state_desc:CUSTOM(Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_desc>0)
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_status:ENUM(EN|NN| )
...
FIELDTYPE:invalid_term_exist_desc:ENUM(DATE|PERPETUAL|NUMBER OF YEARS|UNKNOWN| )
...
FIELD:corp_forgn_term_exist_cd:TYPE(STRING8):LIKE(invalid_term_exist_cd):0,0
FIELD:corp_forgn_term_exist_exp:TYPE(STRING8):0,0
FIELD:corp_forgn_term_exist_desc:TYPE(STRING60):LIKE(invalid_term_exist_desc):0,0 
