...
EXPORT FromNone(DATASET(Corp2_Mapping.LayoutsCommon.Main) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.corp_address1_type_cd_Invalid := Fields.InValid_corp_address1_type_cd((SALT32.StrType)le.corp_address1_type_cd);
    SELF.corp_address1_type_desc_Invalid := Fields.InValid_corp_address1_type_desc((SALT32.StrType)le.corp_address1_type_desc);
    SELF.corp_address2_type_cd_Invalid := Fields.InValid_corp_address2_type_cd((SALT32.StrType)le.corp_address2_type_cd);
    SELF.corp_address2_type_desc_Invalid := Fields.InValid_corp_address2_type_desc((SALT32.StrType)le.corp_address2_type_desc);
    SELF.corp_filing_date_Invalid := Fields.InValid_corp_filing_date((SALT32.StrType)le.corp_filing_date);
    SELF.corp_filing_desc_Invalid := Fields.InValid_corp_filing_desc((SALT32.StrType)le.corp_filing_desc);
    ...
    SELF.corp_forgn_term_exist_cd_Invalid := Fields.InValid_corp_forgn_term_exist_cd((SALT32.StrType)le.corp_forgn_term_exist_cd);
    SELF.corp_forgn_term_exist_desc_Invalid := Fields.InValid_corp_forgn_term_exist_desc((SALT32.StrType)le.corp_forgn_term_exist_desc);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_vendor_first_reported_Invalid << 0 ) + ( le.dt_vendor_last_reported_Invalid << 2 ) + ( le.dt_first_seen_Invalid << 4 ) + ( le.dt_last_seen_Invalid << 6 ) + ( le.corp_ra_dt_first_seen_Invalid << 8 ) + ( le.corp_ra_dt_last_seen_Invalid << 10 ) + ( le.corp_key_Invalid << 12 ) + ( le.corp_vendor_Invalid << 14 ) + ( le.corp_state_origin_Invalid << 15 ) + ( le.corp_process_date_Invalid << 16 ) + ( le.corp_orig_sos_charter_nbr_Invalid << 18 ) + ( le.corp_legal_name_Invalid << 20 ) + ( le.corp_ln_name_type_cd_Invalid << 21 ) + ( le.corp_ln_name_type_desc_Invalid << 22 ) + ( le.corp_address1_type_cd_Invalid << 23 ) + ( le.corp_address1_type_desc_Invalid << 25 ) + ( le.corp_address2_type_cd_Invalid << 26 ) + ( le.corp_address2_type_desc_Invalid << 28 ) + ( le.corp_filing_date_Invalid << 29 ) + ( le.corp_filing_desc_Invalid << 31 ) + ( le.corp_status_date_Invalid << 32 ) + ( le.corp_standing_Invalid << 34 ) + ( le.corp_inc_state_Invalid << 35 ) + ( le.corp_inc_date_Invalid << 36 ) + ( le.corp_term_exist_cd_Invalid << 38 ) + ( le.corp_term_exist_desc_Invalid << 39 ) + ( le.corp_foreign_domestic_ind_Invalid << 40 ) + ( le.corp_forgn_state_cd_Invalid << 41 ) + ( le.corp_forgn_state_desc_Invalid << 42 ) + ( le.corp_forgn_date_Invalid << 43 ) + ( le.corp_forgn_term_exist_cd_Invalid << 45 ) + ( le.corp_forgn_term_exist_desc_Invalid << 46 ) + ( le.corp_for_profit_ind_Invalid << 47 ) + ( le.corp_ra_resign_date_Invalid << 48 ) + ( le.corp_trademark_expiration_date_Invalid << 50 ) + ( le.recordorigin_Invalid << 52 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_address2_type_cd_Invalid := (le.ScrubsBits1 >> 26) & 3;
    SELF.corp_address2_type_desc_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.corp_filing_date_Invalid := (le.ScrubsBits1 >> 29) & 3;
    SELF.corp_filing_desc_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.corp_status_date_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.corp_standing_Invalid := (le.ScrubsBits1 >> 34) & 1;
    ...
    SELF.corp_term_exist_desc_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.corp_foreign_domestic_ind_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.corp_forgn_state_cd_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.corp_forgn_state_desc_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.corp_forgn_date_Invalid := (le.ScrubsBits1 >> 43) & 3;
    SELF.corp_forgn_term_exist_cd_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.corp_forgn_term_exist_desc_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.corp_for_profit_ind_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.corp_ra_resign_date_Invalid := (le.ScrubsBits1 >> 48) & 3;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    corp_address2_type_cd_ENUM_ErrorCount := COUNT(GROUP,h.corp_address2_type_cd_Invalid=1);
    corp_address2_type_cd_LENGTH_ErrorCount := COUNT(GROUP,h.corp_address2_type_cd_Invalid=2);
    corp_address2_type_cd_Total_ErrorCount := COUNT(GROUP,h.corp_address2_type_cd_Invalid>0);
    corp_address2_type_desc_ENUM_ErrorCount := COUNT(GROUP,h.corp_address2_type_desc_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.corp_address2_type_cd_Invalid,'ENUM','LENGTH','UNKNOWN')
          ,CHOOSE(le.corp_address2_type_desc_Invalid,'ENUM','UNKNOWN')
    ...
    SELF.FieldName := CHOOSE(c,'dt_vendor_first_reported','dt_vendor_last_reported','dt_first_seen','dt_last_seen','corp_ra_dt_first_seen','corp_ra_dt_last_seen','corp_key','corp_vendor','corp_state_origin','corp_process_date','corp_orig_sos_charter_nbr','corp_legal_name','corp_ln_name_type_cd','corp_ln_name_type_desc','corp_address1_type_cd','corp_address1_type_desc','corp_address2_type_cd','corp_address2_type_desc','corp_filing_date','corp_filing_desc','corp_status_date','corp_standing','corp_inc_state','corp_inc_date','corp_term_exist_cd','corp_term_exist_desc','corp_foreign_domestic_ind','corp_forgn_state_cd','corp_forgn_state_desc','corp_forgn_date','corp_forgn_term_exist_cd','corp_forgn_term_exist_desc','corp_for_profit_ind','corp_ra_resign_date','corp_trademark_expiration_date','recordorigin','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter_nbr','invalid_mandatory','invalid_type_cd','invalid_type_desc','invalid_addr_type_cd','invalid_addr_type_desc','invalid_addr_type_cd','invalid_addr_type_desc','invalid_date','invalid_filing_desc','invalid_date','invalid_Y_N','invalid_state_origin','invalid_date','invalid_term_exist_cd','invalid_term_exist_desc','invalid_for_dom_ind','invalid_corp_forgn_state_cd','invalid_corp_forgn_state_desc','invalid_date','invalid_term_exist_cd','invalid_term_exist_desc','invalid_Y_N','invalid_date','invalid_future_date','invalid_recordorigin','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT32.StrType)le.dt_vendor_first_reported,(SALT32.StrType)le.dt_vendor_last_reported,(SALT32.StrType)le.dt_first_seen,(SALT32.StrType)le.dt_last_seen,(SALT32.StrType)le.corp_ra_dt_first_seen,(SALT32.StrType)le.corp_ra_dt_last_seen,(SALT32.StrType)le.corp_key,(SALT32.StrType)le.corp_vendor,(SALT32.StrType)le.corp_state_origin,(SALT32.StrType)le.corp_process_date,(SALT32.StrType)le.corp_orig_sos_charter_nbr,(SALT32.StrType)le.corp_legal_name,(SALT32.StrType)le.corp_ln_name_type_cd,(SALT32.StrType)le.corp_ln_name_type_desc,(SALT32.StrType)le.corp_address1_type_cd,(SALT32.StrType)le.corp_address1_type_desc,(SALT32.StrType)le.corp_address2_type_cd,(SALT32.StrType)le.corp_address2_type_desc,(SALT32.StrType)le.corp_filing_date,(SALT32.StrType)le.corp_filing_desc,(SALT32.StrType)le.corp_status_date,(SALT32.StrType)le.corp_standing,(SALT32.StrType)le.corp_inc_state,(SALT32.StrType)le.corp_inc_date,(SALT32.StrType)le.corp_term_exist_cd,(SALT32.StrType)le.corp_term_exist_desc,(SALT32.StrType)le.corp_foreign_domestic_ind,(SALT32.StrType)le.corp_forgn_state_cd,(SALT32.StrType)le.corp_forgn_state_desc,(SALT32.StrType)le.corp_forgn_date,(SALT32.StrType)le.corp_forgn_term_exist_cd,(SALT32.StrType)le.corp_forgn_term_exist_desc,(SALT32.StrType)le.corp_for_profit_ind,(SALT32.StrType)le.corp_ra_resign_date,(SALT32.StrType)le.corp_trademark_expiration_date,(SALT32.StrType)le.recordorigin,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT32.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_address2_type_cd:invalid_addr_type_cd:ENUM','corp_address2_type_cd:invalid_addr_type_cd:LENGTH'
          ,'corp_address2_type_desc:invalid_addr_type_desc:ENUM'
          ...
          ,'corp_forgn_term_exist_cd:invalid_term_exist_cd:ENUM'
          ,'corp_forgn_term_exist_desc:invalid_term_exist_desc:ENUM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_corp_address2_type_cd(1),Fields.InvalidMessage_corp_address2_type_cd(2)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.corp_address2_type_cd_ENUM_ErrorCount,le.corp_address2_type_cd_LENGTH_ErrorCount
          ,le.corp_address2_type_desc_ENUM_ErrorCount
