IMPORT ut,SALT32;
IMPORT Scrubs,Scrubs_Corp2_Mapping_WY_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_Y_N','invalid_type_cd','invalid_type_desc','invalid_addr_type_cd','invalid_addr_type_desc','invalid_filing_desc','invalid_term_exist_cd','invalid_for_dom_ind','invalid_corp_forgn_state_cd','invalid_corp_forgn_state_desc','invalid_recordorigin','invalid_status','invalid_alphablank','invalid_numeric','invalid_numblank','invalid_term_exist_desc');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_Y_N' => 8,'invalid_type_cd' => 9,'invalid_type_desc' => 10,'invalid_addr_type_cd' => 11,'invalid_addr_type_desc' => 12,'invalid_filing_desc' => 13,'invalid_term_exist_cd' => 14,'invalid_for_dom_ind' => 15,'invalid_corp_forgn_state_cd' => 16,'invalid_corp_forgn_state_desc' => 17,'invalid_recordorigin' => 18,'invalid_status' => 19,'invalid_alphablank' => 20,'invalid_numeric' => 21,'invalid_numblank' => 22,'invalid_term_exist_desc' => 23,0);
 
EXPORT MakeFT_invalid_corp_key(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'-0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'-0123456789'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('-0123456789'),SALT32.HygieneErrors.NotLength('4..'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['56']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('56'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['WY']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('WY'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_charter_nbr(SALT32.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'-0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('-0123456789'),SALT32.HygieneErrors.NotLength('1..'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT32.StrType s,SALT32.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_cd'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT32.StrType s,SALT32.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_WY_Main.Functions.invalid_ln_name_type_desc'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_addr_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_addr_type_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['B','M',' '],~(LENGTH(TRIM(s)) = 1 OR LENGTH(TRIM(s)) = 0));
EXPORT InValidMessageFT_invalid_addr_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('B|M| '),SALT32.HygieneErrors.NotLength('1,0'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_addr_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_addr_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['BUSINESS','MAILING',' ']);
EXPORT InValidMessageFT_invalid_addr_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('BUSINESS|MAILING| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['FILING',' ']);
EXPORT InValidMessageFT_invalid_filing_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('FILING| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exist_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_exist_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['D','N','P',' ']);
EXPORT InValidMessageFT_invalid_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('D|N|P| '),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_forgn_state_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_cd(SALT32.StrType s) := WHICH(~Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_cd(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_cd'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_forgn_state_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_forgn_state_desc(SALT32.StrType s) := WHICH(~Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_desc(s)>0);
EXPORT InValidMessageFT_invalid_corp_forgn_state_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_WY_Main.Functions.valid_corp_forgn_state_desc'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['EN','NN',' ']);
EXPORT InValidMessageFT_invalid_status(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('EN|NN| '),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_term_exist_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_exist_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['DATE','PERPETUAL','NUMBER OF YEARS','UNKNOWN',' ']);
EXPORT InValidMessageFT_invalid_term_exist_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('DATE|PERPETUAL|NUMBER OF YEARS|UNKNOWN| '),SALT32.HygieneErrors.Good);
...
EXPORT Make_corp_address1_type_cd(SALT32.StrType s0) := MakeFT_invalid_addr_type_cd(s0);
EXPORT InValid_corp_address1_type_cd(SALT32.StrType s) := InValidFT_invalid_addr_type_cd(s);
EXPORT InValidMessage_corp_address1_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_addr_type_cd(wh);
 
EXPORT Make_corp_address1_type_desc(SALT32.StrType s0) := MakeFT_invalid_addr_type_desc(s0);
EXPORT InValid_corp_address1_type_desc(SALT32.StrType s) := InValidFT_invalid_addr_type_desc(s);
...
EXPORT Make_corp_address2_type_cd(SALT32.StrType s0) := MakeFT_invalid_addr_type_cd(s0);
EXPORT InValid_corp_address2_type_cd(SALT32.StrType s) := InValidFT_invalid_addr_type_cd(s);
EXPORT InValidMessage_corp_address2_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_addr_type_cd(wh);
 
EXPORT Make_corp_address2_type_desc(SALT32.StrType s0) := MakeFT_invalid_addr_type_desc(s0);
EXPORT InValid_corp_address2_type_desc(SALT32.StrType s) := InValidFT_invalid_addr_type_desc(s);
EXPORT InValidMessage_corp_address2_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_addr_type_desc(wh);
...
EXPORT Make_corp_filing_date(SALT32.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_filing_date(SALT32.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_filing_desc(SALT32.StrType s0) := MakeFT_invalid_filing_desc(s0);
EXPORT InValid_corp_filing_desc(SALT32.StrType s) := InValidFT_invalid_filing_desc(s);
EXPORT InValidMessage_corp_filing_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_desc(wh);
...
EXPORT Make_corp_status_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_status_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_term_exist_desc(SALT32.StrType s0) := MakeFT_invalid_term_exist_desc(s0);
EXPORT InValid_corp_term_exist_desc(SALT32.StrType s) := InValidFT_invalid_term_exist_desc(s);
...
EXPORT Make_corp_forgn_state_cd(SALT32.StrType s0) := MakeFT_invalid_corp_forgn_state_cd(s0);
EXPORT InValid_corp_forgn_state_cd(SALT32.StrType s) := InValidFT_invalid_corp_forgn_state_cd(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_forgn_state_cd(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT32.StrType s0) := MakeFT_invalid_corp_forgn_state_desc(s0);
EXPORT InValid_corp_forgn_state_desc(SALT32.StrType s) := InValidFT_invalid_corp_forgn_state_desc(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_forgn_state_desc(wh);
...
EXPORT Make_corp_forgn_term_exist_cd(SALT32.StrType s0) := MakeFT_invalid_term_exist_cd(s0);
EXPORT InValid_corp_forgn_term_exist_cd(SALT32.StrType s) := InValidFT_invalid_term_exist_cd(s);
EXPORT InValidMessage_corp_forgn_term_exist_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_term_exist_cd(wh);
...
EXPORT Make_corp_forgn_term_exist_desc(SALT32.StrType s0) := MakeFT_invalid_term_exist_desc(s0);
EXPORT InValid_corp_forgn_term_exist_desc(SALT32.StrType s) := InValidFT_invalid_term_exist_desc(s);
EXPORT InValidMessage_corp_forgn_term_exist_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_term_exist_desc(wh);
 
EXPORT Make_corp_orig_org_structure_cd(SALT32.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_cd(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_ra_resign_date(SALT32.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_ra_resign_date(SALT32.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_ra_resign_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
...
EXPORT Make_corp_ra_address_line3(SALT32.StrType s0) := s0;
EXPORT InValid_corp_ra_address_line3(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_action_pending_cd(SALT32.StrType s0) := s0;
EXPORT InValid_corp_action_pending_cd(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_comment(SALT32.StrType s0) := s0;
EXPORT InValid_corp_comment(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_has_members(SALT32.StrType s0) := s0;
EXPORT InValid_corp_has_members(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_has_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_vested_managers(SALT32.StrType s0) := s0;
EXPORT InValid_corp_has_vested_managers(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_is_non_profit_irs_approved(SALT32.StrType s0) := s0;
EXPORT InValid_corp_is_non_profit_irs_approved(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_merger_type_converted_to_cd(SALT32.StrType s0) := s0;
EXPORT InValid_corp_merger_type_converted_to_cd(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_name_reservation_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_name_reservation_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_nbr(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_name_status_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_status_desc(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_name_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_irs_approved_purpose(SALT32.StrType s0) := s0;
EXPORT InValid_corp_non_profit_irs_approved_purpose(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_non_profit_irs_approved_purpose(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_solicit_donations(SALT32.StrType s0) := s0;
EXPORT InValid_corp_non_profit_solicit_donations(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_non_profit_solicit_donations(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_amendments(SALT32.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_amendments(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_nbr_of_amendments(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_initial_llc_members(SALT32.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_initial_llc_members(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_nbr_of_initial_llc_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_partners(SALT32.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_partners(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_nbr_of_partners(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_operating_agreement(SALT32.StrType s0) := s0;
EXPORT InValid_corp_operating_agreement(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_termination_cd(SALT32.StrType s0) := s0;
EXPORT InValid_corp_termination_cd(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_trademark_classification_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_classification_nbr(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_trademark_expiration_date(SALT32.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_trademark_expiration_date(SALT32.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_trademark_expiration_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
EXPORT Make_corp_trademark_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_nbr(SALT32.StrType s) := FALSE;
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_WY_Main;
