...
#workunit('name','Scrubs_Corp2_Mapping_WY_Main.BWR_Hygiene - Hygiene & Stats - SALT V3.2 Beta 1');
IMPORT Scrubs_Corp2_Mapping_WY_Main,SALT32;
// First create an instantiated hygiene module
  infile := Scrubs_Corp2_Mapping_WY_Main.In_In_WY;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Corp2_Mapping_WY_Main.Hygiene(ip);
