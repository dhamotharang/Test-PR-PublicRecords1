/*--SOAP--
<message name="St. Cloud Main Service SC1O FCRA">
...
*/
/*--INFO-- 'ex13','ex14','ex15','ex17','ex18','ex19','ex23','ex25','ex26','ex31',
'ex44','ex47','ex63','ex73','ex80','ex89','sc63','sc64','ex30','ex64','2x12','2x13',
'2x14','2x15','2x16','2x17','2x18','2x19','2x20', '2x59', '2x66', '2x67', '2x68', '2x69', '2x70', '2x71' */

import Risk_Indicators, RiskWise, Seed_Files, gateway;
...
productSet := ['ex13','ex14','ex15','ex17','ex18','ex19','ex23','ex25','ex26','ex31','ex44','ex47','ex63','ex73','ex80',
		'ex89','sc63','sc64','ex30','ex64','2x12','2x13','2x14','2x15','2x16','2x17','2x18','2x19','2x20','2x59','2x66','2x67','2x68','2x69','2x70','2x71'];
...
finalAnswer := if(tribCode in productSet,
			   if(count(final_seed)>0 and runSeed_value, final_seed, RiskWiseFCRA.SC1O_Function_FCRA(f, gateways, GLB_Purpose, DPPA_Purpose, tribCode,DataRestriction, DataPermission,UsePersonContext)), 
