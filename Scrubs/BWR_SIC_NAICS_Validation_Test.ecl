...
OUTPUT(SCRUBS.fn_valid_NAICSCode('0111'),NAMED('fn_valid_naics_FALSE'));
...
OUTPUT(SCRUBS.fn_valid_NAICSCode('1111'),NAMED('fn_valid_naics9B_TRUE'));
OUTPUT(SCRUBS.fn_valid_NAICSCode('11111'),NAMED('fn_valid_naics10_TRUE'));
OUTPUT(SCRUBS.fn_valid_NAICSCode('111110'),NAMED('fn_valid_naics10B_TRUE'));
