...
import salt310;
	...
	AcquireOrbitStats:=U.OrbitStats();
	Orbit_stats					:=	project(AcquireOrbitStats,transform(SALT310.ScrubsOrbitLayout,Self.rulepcnt:=(decimal5_2)Left.rulepcnt;Self:=Left)); 
