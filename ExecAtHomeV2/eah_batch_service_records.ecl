IMPORT doxie, BIPV2, BipV2_Best, BIPV2_Contacts, ExecAtHomeV2, MDR, paw;
...
FUNCTION
  ...
  dsMarketingContactsAll := BIPV2_Contacts.key_contact_linkids.kFetchMarketing(dsMrktContactsLinkIdsLayout,
	                                                                          BIPV2.IDconstants.Fetch_Level_SELEID,0,
                                                	                          marketingInMod,
																																						ExecAtHomeV2.Constants.MAX_CONTACTS,,mod_access);
