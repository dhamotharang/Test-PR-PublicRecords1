export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords2	 	:= 'NO STREET|NO STREET ADDRESS GIVEN|NONE APPOINTED|NO STREET ADDRESS LISTED|NOW IS|NO ADDRESS TO MIGRATE';
	...
	export City := module
		...
		shared PatternInvalidWords1	 	:= '^N(\\/)*A$|^NONE|SAME *(AS)*|^AS|^UNKNOWN|^UNKNONW|^NKNOWN|^NOW IS|^NO CITY$';	
	...
	export State := module
		...
		shared PatternInvalidWords1		:= '^XX$|^X$|^NO$|NONE LISTED|^NONE$|NOW IS';
		export InvalidWords						:= PatternInvalidWords1;
	end;
	...
	export LastName := module
		...
		shared PatternInvalidWords1	 	:= 'NOT ENTERED IN SYSTEM|^SAME$|^NONE$|^UNKNOWN$|NOW IS';
		export InvalidWords						:= PatternInvalidWords1 ;
	end;
