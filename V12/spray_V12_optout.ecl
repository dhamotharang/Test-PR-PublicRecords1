...
function
	...
	spry_raw:=DATASET([
			...
			,'*ptou*_emails_*txt'						 	// directory_filter
			,0																			// record_size
			,'~thor_data400::in::email::v12_optout::@version@'	// Thor_filename_template
			,[{'~thor_data400::in::email::v12_optout'}]				// dSuperfilenames
...
RETURN tools.fun_Spray
				( 
					...
					,'V12 optout spray' + ' ' + pVersionDate	// pEmailSubjectDataset
