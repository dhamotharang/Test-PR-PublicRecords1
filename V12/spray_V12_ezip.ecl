...
function
	...
	spry_raw:=DATASET([
			...
			,'*zip_emails_*txt'						 	// directory_filter
			,0																			// record_size
			,'~thor_data400::in::email::v12_ezip::@version@'	// Thor_filename_template
			,[{'~thor_data400::in::email::v12_ezip'}]				// dSuperfilenames
...
RETURN tools.fun_Spray
				( 
					...
					,'V12 ezip spray' + ' ' + pVersionDate	// pEmailSubjectDataset
