...
function
	...
	spry_raw:=DATASET([
			...
			,'*hb_emails_*txt'						 	// directory_filter
			,0																			// record_size
			,'~thor_data400::in::email::v12_hb::@version@'	// Thor_filename_template
			,[{'~thor_data400::in::email::v12_hb'}]				// dSuperfilenames
...
RETURN tools.fun_Spray
				( 
					...
					,'V12 hb spray' + ' ' + pVersionDate	// pEmailSubjectDataset
