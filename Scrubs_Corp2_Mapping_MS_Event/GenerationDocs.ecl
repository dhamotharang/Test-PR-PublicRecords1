...
Command line options: -MScrubs_Corp2_Mapping_MS_Event -eC:\Users\mireleaa\AppData\Local\Temp\TFR2EF2.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_MS_Event
FILENAME:in_ms
...
FIELDTYPE:invalid_desc:ENUM(set_valid_filing) 
 
//FIELD DEFINITIONS for Fields being scrubbed
FIELD:corp_key:TYPE(STRING30):LIKE(invalid_corp_key):0,0
FIELD:event_filing_desc:TYPE(STRING60):LIKE(invalid_desc):0,0
