/*--SOAP--
  <message name="Service_AddressLinking_2">
...
EXPORT Service_AddressLinking_2() := FUNCTION
  string16 Request     := ''    : STORED('LEXID', FEW);
	...
	//new results  
	ds := dataset('~thor_data400::base::insuranceheader::idl_salt_iter_w20140113-190429_best',{idl_header.Layout_Header_address,UNSIGNED8 RecPtr {virtual(fileposition)}}, FLAT);
  EXPORT AddrLink_Key := INDEX(ds,{did},{ds},'~thor::address_link::best::december::key');
