...
EXPORT RemoteCopyInfile(	string	pInSuperFile						=  '~foreign::' + '10.194.10.1' + '::'+'thor::base::cclue::qa::search::output' //~foreign::10.194.12.1::
												,	string	pCluster								= 'thor400_sta01'
												, string	pRemoteIp								= '10.194.10.1:7070'   // insurance prod 
