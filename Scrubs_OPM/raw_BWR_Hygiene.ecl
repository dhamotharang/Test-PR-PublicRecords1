...
#workunit('name','Scrubs_OPM.raw_BWR_Hygiene - Hygiene & Stats - SALT V3.11.7');
IMPORT Scrubs_OPM,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_OPM.raw_In_OPM;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_OPM.raw_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'raw_Layout_OPM'),NAMED('OptimizedLayout'));// File layout suggested by data
