...
Command line options: -MScrubs_Corp2_Mapping_MA_Event -eC:\Users\butlersx\AppData\Local\Temp\TFR6518.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_MA_Event
FILENAME:In_MA
...
//Blanks allowed for charter_nbr
FIELDTYPE:invalid_charter_nbr:ALLOW( -0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_numericblank:ALLOW(0123456789 )
FIELDTYPE:invalid_numericperiodblank:ALLOW(.0123456789 )
FIELDTYPE:invalid_alphablank:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alphanumericblank:ALLOW(0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alphaslashblank:ALLOW('-/().ABCDEFGHIJKLMNOPQRSTUVWXYZ )
...
FIELD:event_filing_reference_nbr:TYPE(STRING30):LIKE(invalid_alphanumericblank):0,0
...
FIELD:event_filing_cd:TYPE(STRING8):LIKE(invalid_numericblank):0,0
FIELD:event_filing_desc:TYPE(STRING60):LIKE(invalid_alphaslashblank):0,0
