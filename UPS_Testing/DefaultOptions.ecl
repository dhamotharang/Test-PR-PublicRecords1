...
UseVals := RECORD
	...
	TYPEOF(SearchOpts.highlight)        Highlight := false;
//	TYPEOF(SearchOpts.ReturnTokens)     ReturnTokens := false;
END;	
...
export DefaultOptions := PROJECT(EmptyOption, MyTransform(LEFT));