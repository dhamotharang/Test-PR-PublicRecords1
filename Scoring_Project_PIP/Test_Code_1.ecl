...
input_file_count_ds:=DATASET([ 
   ...
   distr:= FileServices.SendEmail('Benjamin.Karnatz@lexisnexis.com,Bridgett.Braaten@lexisnexis.com,Joseph.Nassar@lexisnexisrisk.com,Nathan.koubsky@lexisnexis.com,Matthew.Ludewig@lexisnexisrisk.com', 'Data Collection Response Counts Tracking Report ' , XtabOut_ds[COUNT(XtabOut_ds)].line);
   		
   distr2:= FileServices.SendEmail('Benjamin.Karnatz@lexisnexis.com,Bridgett.Braaten@lexisnexis.com,Joseph.Nassar@lexisnexisrisk.com,Nathan.koubsky@lexisnexis.com,Matthew.Ludewig@lexisnexisrisk.com', 'Data Collection Error code Response Counts Tracking Report ' , XtabOut_ds2[COUNT(XtabOut_ds2)].line);
