...
IMPORT Models, iESP, Risk_Indicators, RiskWise, RiskProcessing, UT;
    ...
    paramsT := dataset([{'Custom', 'rvt1212_1'}], models.Layout_Parameters);
  ...
  //*********** PERFORMING SOAPCALL TO ROXIE ************ 
	  ...
	  // ***************************************************************************************************
		...
		Global_output_lay:= RECORD	 
		  Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_T_mobile_RVT1212_1_v4_Global_Layout;			 
		END;
