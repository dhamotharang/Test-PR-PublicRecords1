...
#workunit('name','SmallBusinessAnalyticsNonSBFE_SLBB1809');
...
outputFile := '~ScoringQA::out::NonSBFE::Small_Business_Analytics_SLBB1809_Attributes_'+ curr_date+'_1';
...
BusinessModelRequested := IF(includeBusinessOnlyModel,
					// DATASET([{'SLBB1809_0_0'}], iesp.share.t_StringArrayItem), // can't mix 1702 with 1809 models
