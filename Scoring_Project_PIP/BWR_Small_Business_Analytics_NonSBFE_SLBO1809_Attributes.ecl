...
#workunit('name','SmallBusinessAnalyticsNonSBFE_SLBO1809');
...
outputFile := '~ScoringQA::out::NonSBFE::Small_Business_Analytics_SLBO1809_Attributes_'+ curr_date+'_1';
...
////////////////////////////////////////////////////////////////////////////
	...
	SELF.Model1Name := IF(includeBlendedModel, 'SLBO1809_0_0', Model1.Name);
...
SUCCESS(FileServices.SendEmail('Noah.Lahr@lexisnexisrisk.com;', 'SLBO1809_'+curr_date+'_1 Completed','The Completed workunit is:' + workunit)),
FAILURE(FileServices.SendEmail('Noah.Lahr@lexisnexisrisk.com; ', 'SLBO1809_'+curr_date+'_1 Failed','The Failed workunit is:'   + workunit + FailMessage));