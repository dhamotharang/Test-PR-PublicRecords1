...
IMPORT ut, Risk_Indicators, riskwise, models, RiskProcessing, Scoring_Project_PIP, gateway,Scoring_Project_Macros;
	...
	unsigned8 no_of_records := records_ToRun;
		...
		DPPA:=Scoring_Project_PIP.User_Settings_Module.FP_V201_American_Express_XML_Generic_FP1109_0_settings.DPPA;
		GLB:=Scoring_Project_PIP.User_Settings_Module.FP_V201_American_Express_XML_Generic_FP1109_0_settings.GLB;
		DRM:=Scoring_Project_PIP.User_Settings_Module.FP_V201_American_Express_XML_Generic_FP1109_0_settings.DRM;
		DPM:=Scoring_Project_PIP.User_Settings_Module.FP_V201_American_Express_XML_Generic_FP1109_0_settings.DPM;
		AttributesVersionRequest:=Scoring_Project_PIP.User_Settings_Module.FP_V201_American_Express_XML_Generic_FP1109_0_settings.AttributesVersionRequest;
    HISTORYDATE := 999999;
	  ...
	  //************** INPUT FILE GENERATION ****************	
		...
		layout_soap_input := RECORD
			...
			// string RequestedAttributeGroups;
			string Model;
...
// output(Soap_output);
		...
		// zz_bbraaten2.BWR_FP201_layout;
		scoring_project_macros.Global_Output_Layouts.NONFCRA_FraudPoint_V201_AmericanExpress_Global_Layout
		END;

		get_group(recordof(layout_Soap_output) groups, string name_i) := FUNCTION
		...
		Global_output_lay v2_trans(Soap_output L, soap_in R) := TRANSFORM
			 ...
			 // self.IdentityRiskLevel	:= L.AttributeGroup[1].IdentityRiskLevel;
		...
		ds_slim := JOIN(Soap_output, soap_in,LEFT.accountnumber=RIGHT.accountnumber, v2_trans(LEFT,RIGHT));
			 
			 
    attr_plus_scores := group(sort(ds_slim, accountnumber), accountnumber);
			 
		Global_output_lay combine_scores_attributes(Global_output_lay le, Global_output_lay rt) := transform
