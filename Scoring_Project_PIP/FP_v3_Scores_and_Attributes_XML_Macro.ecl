EXPORT FP_v3_Scores_and_Attributes_XML_Macro (roxie_ip, Gateway_dummy, Thread, Timeout, Retry, Input_file_name, Output_file_name, records_ToRun, filetag):= FUNCTIONMACRO
...
/* end */
    ...
    //*********** PERFORMING SOAPCALL TO ROXIE ************ 
		...
		servicename := 'Models.FraudAdvisor_Service'; 
		...
		tag12 := 'flas_';
      		...
      		ds_output_plus_input_flpsd := Scoring_Project_PIP.FP_V3_Generic_Transform_Macro(Soap_output_flpsd,soap_in_flpsd, tag7);  //this transform joins the soap output with the input file
      		...
      		ds_output_plus_input_flas := Scoring_Project_PIP.FP_V3_Generic_Transform_Macro(Soap_output_flas,soap_in_flas, tag12);  //this transform joins the soap output with the input file
					...
					final_result := sequential(run_flapsd,run_fls,run_fla,run_flaps,run_flapd,run_flasd,run_flpsd,run_flap,run_flps,run_flsd,run_flad,run_flas);
					
					
					// combined_output := ds_output_plus_input_flapsd + ds_output_plus_input_fls + ds_output_plus_input_fla + ds_output_plus_input_flaps + 
														 // ds_output_plus_input_flapd + ds_output_plus_input_flasd + ds_output_plus_input_flpsd + ds_output_plus_input_flap + 
														 // ds_output_plus_input_flps + ds_output_plus_input_flsd + ds_output_plus_input_flad + ds_output_plus_input_flas;
					
					
						 // final file out to thor
          // final_output :=   output(combined_output,, Output_file_name + filetag, thor, compressed, overwrite );
