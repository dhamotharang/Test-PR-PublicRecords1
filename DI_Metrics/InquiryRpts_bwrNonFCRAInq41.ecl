...
despray_InqADLsByMonth := STD.File.DeSpray('~thor_data400::data_insight::data_metrics::tbl_InquiryRpts_NonFCRAInq41_InqADLsByMonth_'+ filedate +'.csv',
																		pHostname, 
																		pTarget+ '/tbl_InquiryRpts_NonFCRAInq41_InqADLsByMonth_'+ filedate +'.csv'
																		,,,,true);

despray_InqByMonth := STD.File.DeSpray('~thor_data400::data_insight::data_metrics::tbl_InquiryRpts_NonFCRAInq41_InqByMonth_'+ filedate +'.csv',
																		pHostname, 
																		pTarget+ '/tbl_InquiryRpts_NonFCRAInq41_InqByMonth_'+ filedate +'.csv'
																		,,,,true);
...
email_alert := SEQUENTIAL(
					...
					Failure(FileServices.SendEmail(pContact, 'InquiryRpts Group: InquiryRpts_bwrNonFCRAInq41 Build Failed', workunit + filedate + '\n' + FAILMESSAGE)
													);
return email_alert;
