...
export Key_Impulse_DID_FCRA := INDEX(base_key_file,{did},{base_key_file},data_services.data_location.prefix() + 'thor_data400::key::impulse_email::fcra::'+doxie.Version_SuperKey+'::did');