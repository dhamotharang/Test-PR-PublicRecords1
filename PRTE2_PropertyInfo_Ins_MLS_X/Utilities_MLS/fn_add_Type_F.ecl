...
EXPORT fn_add_Type_F(DATASET(BaseLayout) CloneableDS, DATASET(BaseLayout) EnhanceableDS1) := FUNCTION
EnhanceableDS1A := EnhanceableDS1(vendor_source='A');
EnhanceableDS1B := EnhanceableDS1(vendor_source='B');
EnhanceableDS1C := EnhanceableDS1(vendor_source='C');
EnhanceableDS1D := EnhanceableDS1(vendor_source='D');
RandomMix := CloneableDS+CloneableDS+CloneableDS+EnhanceableDS1C+EnhanceableDS1C+EnhanceableDS1D+EnhanceableDS1D+EnhanceableDS1B;
EnhanceableDS := PRTE2_Common_DevOnly.MAC_Add_Sort_Random(RandomMix);   // more MLS, next OKC, next FARES, next DEFLT
...
finalSetF := DENORMALIZE(CloneableDS,EnhanceableDS,
														LEFT.apn_number = RIGHT.apn_number,
														GROUP,
														TRANSFORM({CloneableDS},
																...
																SELF.air_conditioning_type := rowPick(rowsIn,air_conditioning_type).air_conditioning_type;
																SELF.src_air_conditioning_type := rowPick(rowsIn,air_conditioning_type).src_air_conditioning_type;
																SELF.tax_dt_air_conditioning_type := rowPick(rowsIn,air_conditioning_type).tax_dt_air_conditioning_type;
																...
																SELF.construction_type := rowPick(rowsIn,construction_type).construction_type;
																SELF.src_construction_type := rowPick(rowsIn,construction_type).src_construction_type;
																SELF.tax_dt_construction_type := rowPick(rowsIn,construction_type).tax_dt_construction_type;
																...
																SELF.fireplace_ind := rowPick(rowsIn,fireplace_ind).fireplace_ind;
																SELF.src_fireplace_ind := rowPick(rowsIn,fireplace_ind).src_fireplace_ind;
																SELF.tax_dt_fireplace_ind := rowPick(rowsIn,fireplace_ind).tax_dt_fireplace_ind;
																...
																SELF.flood_zone_panel := rowPick(rowsIn,flood_zone_panel).flood_zone_panel;
																SELF.src_flood_zone_panel := rowPick(rowsIn,flood_zone_panel).src_flood_zone_panel;
																SELF.tax_dt_flood_zone_panel := rowPick(rowsIn,flood_zone_panel).tax_dt_flood_zone_panel;
																...
																SELF.first_floor_square_footage := rowPick(rowsIn,first_floor_square_footage).first_floor_square_footage;
																SELF.src_first_floor_square_footage := rowPick(rowsIn,first_floor_square_footage).src_first_floor_square_footage;
																SELF.tax_dt_first_floor_square_footage := rowPick(rowsIn,first_floor_square_footage).tax_dt_first_floor_square_footage;
																...
																SELF.no_of_bedrooms := rowPick(rowsIn,no_of_bedrooms).no_of_bedrooms;
																SELF.src_no_of_bedrooms := rowPick(rowsIn,no_of_bedrooms).src_no_of_bedrooms;
																SELF.tax_dt_no_of_bedrooms := rowPick(rowsIn,no_of_bedrooms).tax_dt_no_of_bedrooms;
																...
																SELF.no_of_stories := rowPick(rowsIn,no_of_stories).no_of_stories;
																SELF.src_no_of_stories := rowPick(rowsIn,no_of_stories).src_no_of_stories;
																SELF.tax_dt_no_of_stories := rowPick(rowsIn,no_of_stories).tax_dt_no_of_stories;
																...
																SELF.roof_cover := rowPick(rowsIn,roof_cover).roof_cover;
																SELF.src_roof_cover := rowPick(rowsIn,roof_cover).src_roof_cover;
																SELF.tax_dt_roof_cover := rowPick(rowsIn,roof_cover).tax_dt_roof_cover;
																
																SELF.roof_type := rowPick(rowsIn,roof_type).roof_type;
																SELF.src_roof_type := rowPick(rowsIn,roof_type).src_roof_type;
																SELF.tax_dt_roof_type := rowPick(rowsIn,roof_type).tax_dt_roof_type;
																...
																SELF.census_tract := rowPick(rowsIn,census_tract).census_tract;
																SELF.src_census_tract := rowPick(rowsIn,census_tract).src_census_tract;
																SELF.tax_dt_census_tract := rowPick(rowsIn,census_tract).tax_dt_census_tract;
																
																// range will just have to stay with whatever the cloned record had, can't get compiler to accept range as a field
																// rowBadTermRange := rowsIn(range <>'')[];
																...
																SELF.county_name := rowPick(rowsIn,county_name).county_name;
																SELF.src_county_name := rowPick(rowsIn,county_name).src_county_name;
																SELF.tax_dt_county_name := rowPick(rowsIn,county_name).tax_dt_county_name;
																...
																SELF.township := rowPick(rowsIn,township).township;
																SELF.src_township := rowPick(rowsIn,township).src_township;
																SELF.tax_dt_township := rowPick(rowsIn,township).tax_dt_township;
																...
																SELF.acres := rowPick(rowsIn,acres).acres;
																SELF.src_acres := rowPick(rowsIn,acres).src_acres;
																SELF.tax_dt_acres := rowPick(rowsIn,acres).tax_dt_acres;
																...
																SELF.lot_size := rowPick(rowsIn,lot_size).lot_size;
																SELF.src_lot_size := rowPick(rowsIn,lot_size).src_lot_size;
																SELF.tax_dt_lot_size := rowPick(rowsIn,lot_size).tax_dt_lot_size;
