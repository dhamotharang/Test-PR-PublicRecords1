...
// BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code('HOLDING');
// BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code(BIPv2_HRCHY_Dev.Constants.LNCA.ctype_decode(BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code('HOLDING')));
// BIPv2_HRCHY_Dev.Constants.LNCA.ctype_decode(BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code('HOLDING'));
// BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code_is_SELE_level(BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code('DIVISION'));
// BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code_is_SELE_level(BIPv2_HRCHY_Dev.Constants.LNCA.ctype_code('SUBSIDIARY'));

BIPv2_HRCHY_Dev.Constants.duns.ctype_code('HEADQUARTERS');
BIPv2_HRCHY_Dev.Constants.duns.ctype_code(BIPv2_HRCHY_Dev.Constants.duns.ctype_decode(BIPv2_HRCHY_Dev.Constants.duns.ctype_code('HEADQUARTERS')));
BIPv2_HRCHY_Dev.Constants.duns.ctype_decode(BIPv2_HRCHY_Dev.Constants.duns.ctype_code('HEADQUARTERS'));
BIPv2_HRCHY_Dev.Constants.duns.ctype_code_is_SELE_level(BIPv2_HRCHY_Dev.Constants.duns.ctype_code('DIVISION'));
BIPv2_HRCHY_Dev.Constants.duns.ctype_code_is_SELE_level(BIPv2_HRCHY_Dev.Constants.duns.ctype_code('HEADQUARTERS'));
*/