...
gong_raw := Gong_v2.proc_roxie_keybuild_prep;


// where to put the restructured data
fname_persist := Gong_v2.thor_cluster+'persist::gong_historyv2_wdtg';
...
export file_wdtgGongv2 := results : PERSIST(fname_persist);