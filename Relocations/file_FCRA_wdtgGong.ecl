...
gong_raw := Gong_Neustar.File_History_Full_Prepped_for_FCRA_Keys;



// where to put the restructured data
fname_persist := '~thor_data400::persist::gong_history_FCRA_wdtg';
...
export file_FCRA_wdtgGong := results : PERSIST(fname_persist);
