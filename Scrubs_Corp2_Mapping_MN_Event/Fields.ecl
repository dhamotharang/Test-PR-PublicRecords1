...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_event_filing_reference_nbr','invalid_event_date_type_cd','invalid_event_date_type_desc');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_event_filing_reference_nbr' => 8,'invalid_event_date_type_cd' => 9,'invalid_event_date_type_desc' => 10,0);
...
EXPORT MakeFT_invalid_corp_key(SALT32.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'-/=.+_0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('-/=.+_0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ '),SALT32.HygieneErrors.NotLength('4..'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_event_filing_reference_nbr(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,' -0123456789ABDEFGHIJKLNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_event_filing_reference_nbr(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,' -0123456789ABDEFGHIJKLNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_event_filing_reference_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars(' -0123456789ABDEFGHIJKLNOPQRSTUVWXYZ'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_event_date_type_cd(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'EFIL'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_event_date_type_cd(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'EFIL'))));
EXPORT InValidMessageFT_invalid_event_date_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('EFIL'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_event_date_type_desc(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'CEFGILNTV '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_event_date_type_desc(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'CEFGILNTV '))));
EXPORT InValidMessageFT_invalid_event_date_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('CEFGILNTV '),SALT32.HygieneErrors.Good);
...
EXPORT Make_event_filing_reference_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_event_filing_reference_nbr(SALT32.StrType s) := FALSE;
...
EXPORT Make_event_filing_date(SALT32.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_event_filing_date(SALT32.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_event_filing_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
 
EXPORT Make_event_date_type_cd(SALT32.StrType s0) := MakeFT_invalid_event_date_type_cd(s0);
EXPORT InValid_event_date_type_cd(SALT32.StrType s) := InValidFT_invalid_event_date_type_cd(s);
EXPORT InValidMessage_event_date_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_event_date_type_cd(wh);
 
EXPORT Make_event_date_type_desc(SALT32.StrType s0) := MakeFT_invalid_event_date_type_desc(s0);
EXPORT InValid_event_date_type_desc(SALT32.StrType s) := InValidFT_invalid_event_date_type_desc(s);
EXPORT InValidMessage_event_date_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_event_date_type_desc(wh);
 
EXPORT Make_event_filing_cd(SALT32.StrType s0) := s0;
EXPORT InValid_event_filing_cd(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_event_filing_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_filing_desc(SALT32.StrType s0) := s0;
EXPORT InValid_event_filing_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_event_book_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_event_book_nbr(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_event_book_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_page_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_event_page_nbr(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_event_page_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_certification_nbr(SALT32.StrType s0) := s0;
EXPORT InValid_event_certification_nbr(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_event_certification_nbr(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_MN_Event;
