...
module
	...
	function
		...
		return dedup(sort(dAsBusinessHeader(company_name != ''),company_name, prim_range, prim_name, addr_suffix, predir, postdir, unit_desig, sec_range, city, state, zip, phone, -dt_last_seen),
	...
	function
		...
		//return	dAsBusinessHeader((integer)name_score < 3, Business_Header.CheckPersonName(fname, mname, lname, name_suffix), company_name != '');
		return	dedup(sort(dAsBusinessHeader((integer)name_score < 3, Business_Header.CheckPersonName(fname, mname, lname, name_suffix), company_name != '')
		              ,fname, lname, mname, name_suffix, prim_range, prim_name, addr_suffix, predir, postdir, unit_desig, sec_range, city, state, zip, company_name, company_title, phone, -dt_last_seen)
									,fname, lname, mname, name_suffix, prim_range, prim_name, addr_suffix, predir, postdir, unit_desig, sec_range, city, state, zip, company_name, company_title, phone
								 );
