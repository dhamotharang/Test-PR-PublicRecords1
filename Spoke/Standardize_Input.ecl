import _control, CCPA, Address, Ut, lib_stringlib, _Control, business_header, _Validate, idl_header, Std;
...
module
	...
	function
		...
		addGlobalSID := CCPA.macGetGlobalSID(dCleanDatesAppended, 'Spoke', '', 'global_sid'); //DF-25334: Append Global_SIDs
