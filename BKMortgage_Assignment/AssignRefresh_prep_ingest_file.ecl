...
EXPORT AssignRefresh_prep_ingest_file := FUNCTION

  //Project to base layout for ingest
	fIn_Raw   := BKMortgage_Assignment.Files().Assignment_Refresh;
	...
	BKMortgage_Assignment.Layouts.base CleanTrimFields(ClnRawIn L) := TRANSFORM
		...
		SELF.SOURCE  									 	:= mdr.sourceTools.src_BKFS_Assignment_Refresh;
