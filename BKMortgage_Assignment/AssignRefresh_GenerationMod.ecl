...
IMPORT SALT311;
EXPORT AssignRefresh_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'BKMortgage_Assignment';
  EXPORT spc_NAMESCOPE := 'AssignRefresh';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,date_first_seen,date_last_seen,date_vendor_first_reported,date_vendor_last_reported,process_date,source,ln_filedate,bk_infile_type,rectype,documenttype,fipscode,mersindicator,mainaddendum,assigrecdate,assigeffecdate,assigdoc,assigbk,assigpg,multiplepageimage,bkfsimageid,origdotrecdate,origdotcontractdate,origdotdoc,origdotbk,origdotpg,origlenderben,origloanamnt,assignorname,loannumber,assignee,mers,mersvalidation,assigneepool,mspsvcrloan,borrowername,apn,multiapncode,taxacctid,propertyfulladd,propertyunit,propertycity,propertystate,propertyzip,propertyzip4,dataentrydate,dataentryopercode,vendorsourcecode,hids_recordingflag,hids_docnumber,transfercertificateoftitle,hi_condo_cpr_hpr,hi_situs_unit_number,hids_previous_docnumber,prevtransfercertificateoftitle,pid,matchedororphan,deed_pid,sam_pid,assessorparcelnumber_matched,assessorpropertyfulladd,assessorpropertyunittype,assessorpropertyunit,assessorpropertycity,assessorpropertystate,assessorpropertyzip,assessorpropertyzip4,assessorpropertyaddrsource,clnoriglenderben,clnassignorname,clnassignee,clnborrowername';
  ...
  EXPORT spcString :=
    'OPTIONS:-gn\n'
    + 'MODULE:BKMortgage_Assignment\n'
    + 'FILENAME:BKMortgage\n'
    + 'NAMESCOPE:AssignRefresh\n'
    + '\n'
    + 'RIDFIELD:record_id:GENERATE\n'
    + 'INGESTFILE:assign_update:NAMED(BKMortgage_Assignment.AssignRefresh_prep_ingest_file)\n'
    + '\n'
