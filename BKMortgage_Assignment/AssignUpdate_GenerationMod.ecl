...
IMPORT SALT311;
EXPORT AssignUpdate_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'AssignUpdate';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FILENAME:BKMortgage\n'
    + 'NAMESCOPE:AssignUpdate\n'
    + '\n'
    + 'RIDFIELD:record_id:GENERATE\n'
    + 'INGESTFILE:assign_update:NAMED(BKMortgage_Assignment.AssignUpdate_prep_ingest_file)\n'
    + '\n'
