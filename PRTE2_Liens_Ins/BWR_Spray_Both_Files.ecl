...
CSVNameMain := 'Liens_Main_PROD_20190108_UPD.csv';
CSVNameParty := 'Liens_Party_PROD_20190108_UPD.csv';
SprayInFile1 := PRTE2_Liens_Ins.fSprays.fSpray_Main(CSVNameMain);
SprayInFile2 := PRTE2_Liens_Ins.fSprays.fSpray_Party(CSVNameParty);
BuildBaseFiles := PRTE2_Liens_Ins.proc_build_base;					// have to do this to move from CSV to Boca compatible
SEQUENTIAL (SprayInFile1, SprayInFile2, BuildBaseFiles);
