//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_Platform',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_Platform.filenames(combo).dall_filenames
                  ...
                  + BIPV2_ProxID_Platform.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_Platform.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_Platform.filenames(siter).dall_filenames
                  + BIPV2_ProxID_Platform.keynames (siter).dall_filenames
                  ;
