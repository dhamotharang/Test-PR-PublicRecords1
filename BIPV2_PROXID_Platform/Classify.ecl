...
SHARED TotalClusters := specificities(h).TotalClusters;
  active_duns_number_tokens := PROJECT(specificities(h).active_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_duns_number; SELF.TokenType := 1; SELF.Spc := LEFT.field_Specificity ));
  active_enterprise_number_tokens := PROJECT(specificities(h).active_enterprise_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_enterprise_number; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  active_domestic_corp_key_tokens := PROJECT(specificities(h).active_domestic_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_domestic_corp_key; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  hist_enterprise_number_tokens := PROJECT(specificities(h).hist_enterprise_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_enterprise_number; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  hist_duns_number_tokens := PROJECT(specificities(h).hist_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_duns_number; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  hist_domestic_corp_key_tokens := PROJECT(specificities(h).hist_domestic_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.hist_domestic_corp_key; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  foreign_corp_key_tokens := PROJECT(specificities(h).foreign_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.foreign_corp_key; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  unk_corp_key_tokens := PROJECT(specificities(h).unk_corp_key_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.unk_corp_key; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
  ebr_file_number_tokens := PROJECT(specificities(h).ebr_file_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.ebr_file_number; SELF.TokenType := 9; SELF.Spc := LEFT.field_Specificity ));
  cnp_name_tokens := PROJECT(specificities(h).cnp_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_name; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  cnp_number_tokens := PROJECT(specificities(h).cnp_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_number; SELF.TokenType := 15; SELF.Spc := LEFT.field_Specificity ));
  cnp_btype_tokens := PROJECT(specificities(h).cnp_btype_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_btype; SELF.TokenType := 16; SELF.Spc := LEFT.field_Specificity ));
  company_fein_tokens := PROJECT(specificities(h).company_fein_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_fein; SELF.TokenType := 20; SELF.Spc := LEFT.field_Specificity ));
  company_phone_tokens := PROJECT(specificities(h).company_phone_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_phone; SELF.TokenType := 23; SELF.Spc := LEFT.field_Specificity ));
  prim_name_derived_tokens := PROJECT(specificities(h).prim_name_derived_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_name_derived; SELF.TokenType := 25; SELF.Spc := LEFT.field_Specificity ));
  sec_range_tokens := PROJECT(specificities(h).sec_range_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.sec_range; SELF.TokenType := 26; SELF.Spc := LEFT.field_Specificity ));
  v_city_name_tokens := PROJECT(specificities(h).v_city_name_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.v_city_name; SELF.TokenType := 27; SELF.Spc := LEFT.field_Specificity ));
  st_tokens := PROJECT(specificities(h).st_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.st; SELF.TokenType := 28; SELF.Spc := LEFT.field_Specificity ));
  zip_tokens := PROJECT(specificities(h).zip_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.zip; SELF.TokenType := 29; SELF.Spc := LEFT.field_Specificity ));
  prim_range_derived_tokens := PROJECT(specificities(h).prim_range_derived_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.prim_range_derived; SELF.TokenType := 31; SELF.Spc := LEFT.field_Specificity ));
SHARED all_tokens0 := active_duns_number_tokens + active_enterprise_number_tokens + active_domestic_corp_key_tokens + hist_enterprise_number_tokens + hist_duns_number_tokens + hist_domestic_corp_key_tokens + foreign_corp_key_tokens + unk_corp_key_tokens + ebr_file_number_tokens + cnp_name_tokens + cnp_number_tokens + cnp_btype_tokens + company_fein_tokens + company_phone_tokens + prim_name_derived_tokens + sec_range_tokens + v_city_name_tokens + st_tokens + zip_tokens + prim_range_derived_tokens;
  all_tokens := SALT30.fn_process_multitokens(all_tokens0);
 
EXPORT TokenKeyName := '~'+'key::BIPV2_ProxID_Platform::Proxid::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_ProxID_Platform::Proxid::Token::MultiTokenKey';
...
EXPORT MultiTokenKey := INDEX(all_tokens0(SALT30.WordCount(TokenValue)>1),{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens0},MultiTokenKeyName);
  company_csz_tokens := PROJECT(specificities(h).company_csz_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_csz; SELF.TokenType := 32; SELF.Spc := LEFT.field_Specificity ));
  company_addr1_tokens := PROJECT(specificities(h).company_addr1_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_addr1; SELF.TokenType := 33; SELF.Spc := LEFT.field_Specificity ));
  company_address_tokens := PROJECT(specificities(h).company_address_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.company_address; SELF.TokenType := 34; SELF.Spc := LEFT.field_Specificity ));
all_tokens1 := company_csz_tokens + company_addr1_tokens + company_address_tokens;
 
EXPORT ConceptKeyName := '~'+'key::BIPV2_ProxID_Platform::Proxid::Token::ConceptKey';
...
shared company_csz_combinations := o_tot;
  Layout_ConceptTemplate Into(company_csz_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.v_city_name_filled => 27, le.st_filled => 28, le.zip_filled => 29,0);
    SELF.FieldNumber2 := MAP ( le.st_filled AND SELF.FieldNumber1 != 28 => 28, le.zip_filled AND SELF.FieldNumber1 != 29 => 29,0);
    SELF.FieldNumber3 := MAP ( le.zip_filled AND SELF.FieldNumber1 != 29 AND SELF.FieldNumber2 != 29 => 29,0);
    SELF := le;
  END;
shared company_csz_templates := project(company_csz_combinations,Into(LEFT));
  company_addr1_filled_rec := RECORD
    boolean prim_range_derived_filled :=(SALT30.StrType)ih.prim_range_derived != '';
    boolean prim_name_derived_filled :=(SALT30.StrType)ih.prim_name_derived != '';
...
shared company_addr1_combinations := o_tot;
  Layout_ConceptTemplate Into(company_addr1_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.prim_range_derived_filled => 31, le.prim_name_derived_filled => 25, le.sec_range_filled => 26,0);
    SELF.FieldNumber2 := MAP ( le.prim_name_derived_filled AND SELF.FieldNumber1 != 25 => 25, le.sec_range_filled AND SELF.FieldNumber1 != 26 => 26,0);
    SELF.FieldNumber3 := MAP ( le.sec_range_filled AND SELF.FieldNumber1 != 26 AND SELF.FieldNumber2 != 26 => 26,0);
    SELF := le;
  END;
shared company_addr1_templates := project(company_addr1_combinations,Into(LEFT));
  company_address_filled_rec := RECORD
    boolean company_addr1_filled :=~((SALT30.StrType)ih.prim_range_derived = '' AND (SALT30.StrType)ih.prim_name_derived = '' AND (SALT30.StrType)ih.sec_range = '');
    boolean company_csz_filled :=~((SALT30.StrType)ih.v_city_name = '' AND (SALT30.StrType)ih.st = '' AND (SALT30.StrType)ih.zip = '');
  END;
...
shared company_address_combinations := o_tot;
  Layout_ConceptTemplate Into(company_address_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.company_addr1_filled => 33, le.company_csz_filled => 32,0);
    SELF.FieldNumber2 := MAP ( le.company_csz_filled AND SELF.FieldNumber1 != 32 => 32,0);
    SELF := le;
  END;
shared company_address_templates := project(company_address_combinations,Into(LEFT));
all_templates := company_csz_templates + company_addr1_templates + company_address_templates;
 
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_ProxID_Platform::Proxid::Token::ConceptKey';
