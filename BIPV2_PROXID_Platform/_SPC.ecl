...
FIELD:active_duns_number:PROP:28,22
...
FIELD:hist_domestic_corp_key:PROP:27,48
FIELD:foreign_corp_key:SWITCH0:PROP:27,155
FIELD:unk_corp_key:SWITCH0:PROP:27,48
FIELD:ebr_file_number:PROP:28,223

FIELD:company_name:CARRY:0,0
FIELD:cnp_name:TYPE(STRING250):BAGOFWORDS(MOST):EDIT1:FORCE(+6,OR(active_domestic_corp_key),OR(active_duns_number)):ABBR(ACRONYM,INITIAL,MAXSPC(13)):HYPHEN1:TYPE(string250):15,160
...
FIELD:company_fein:PROP:EDIT1:27,155
...
CONCEPT:company_csz:v_city_name:st:zip:FORCE(+-2):14,25
...
//  Attribute Files
// ------------------------------------
ATTRIBUTEFILE:SrcRidVlid:NAMED(file_SrcRidVlid):VALUES(source:source_record_id:vl_id):IDFIELD(Proxid):SUPPORTS(cnp_name):27,620
...
ATTRIBUTEFILE:RAAddresses:NAMED(file_RA_Addresses):VALUES(cname):FORCE:IDFIELD(Proxid):28,90
