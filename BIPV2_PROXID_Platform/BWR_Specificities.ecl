...
#workunit('name','BIPV2_ProxID_Platform.BWR_Specificities - Specificities - SALT V3.0 Gold');
IMPORT BIPV2_ProxID_Platform,SALT30;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_ProxID_Platform.specificities(BIPV2_ProxID_Platform.In_DOT_Base);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_ProxID_Platform.<your_spc_attribute>',BIPV2_ProxID_Platform.In_DOT_Base);
