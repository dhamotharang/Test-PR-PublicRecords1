...
import bipv2,BIPV2_ProxID_Platform,Business_DOT_SALT_micro12,BIPV2_Tools;
dinput 						:= BIPV2_ProxID_Platform.In_DOT_Base;
dlegalentityrels 	:= BIPV2_ProxID_Platform.relationships(dinput).SAMELEGALENTITY_links	;
...
BIPV2_ProxID_Platform.Proc_Iterate('1').RelationshipKeys;
BIPV2_ProxID_Platform.Proc_Iterate('1').DebugKeys;
...
output(dpatchlegalentitycluster_proj		,,'~thor_data400::base::BIPV2_ProxID_Platform::legalentity_patched_file_filt'	,__compressed__,overwrite);
output(dbadlegalentityrels 							,,'~thor_data400::base::BIPV2_ProxID_Platform::badlegalentity_rels'						,__compressed__,overwrite);
////////////////extra outputs
p := project(dpatchlegalentitycluster_proj, transform(BIPV2_ProxID_Platform.layouts.dot_base, self.dotid := left.proxid, self := left));
