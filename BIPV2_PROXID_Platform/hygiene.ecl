...
EXPORT Summary(SALT30.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_company_name_type_raw := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.company_name_type_raw)));
    avelength_company_name_type_raw := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.company_name_type_raw)),h.company_name_type_raw<>(typeof(h.company_name_type_raw))'');
    ...
    maxlength_company_foreign_domestic := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.company_foreign_domestic)));
    avelength_company_foreign_domestic := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.company_foreign_domestic)),h.company_foreign_domestic<>(typeof(h.company_foreign_domestic))'');
    ...
    maxlength_prim_range_derived := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.prim_range_derived)));
    avelength_prim_range_derived := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.prim_range_derived)),h.prim_range_derived<>(typeof(h.prim_range_derived))'');
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_active_duns_number_pcnt *  28.00 / 100 + T.Populated_active_enterprise_number_pcnt *  27.00 / 100 + T.Populated_active_domestic_corp_key_pcnt *  27.00 / 100 + T.Populated_hist_enterprise_number_pcnt *  28.00 / 100 + T.Populated_hist_duns_number_pcnt *  27.00 / 100 + T.Populated_hist_domestic_corp_key_pcnt *  27.00 / 100 + T.Populated_foreign_corp_key_pcnt *  27.00 / 100 + T.Populated_unk_corp_key_pcnt *  28.00 / 100 + T.Populated_ebr_file_number_pcnt *  28.00 / 100 + T.Populated_company_name_pcnt *   0.00 / 100 + T.Populated_cnp_name_pcnt *  15.00 / 100 + T.Populated_company_name_type_raw_pcnt *   0.00 / 100 + T.Populated_company_name_type_derived_pcnt *   0.00 / 100 + T.Populated_cnp_hasnumber_pcnt *   0.00 / 100 + T.Populated_cnp_number_pcnt *  15.00 / 100 + T.Populated_cnp_btype_pcnt *   3.00 / 100 + T.Populated_cnp_lowv_pcnt *   0.00 / 100 + T.Populated_cnp_translated_pcnt *   0.00 / 100 + T.Populated_cnp_classid_pcnt *   0.00 / 100 + T.Populated_company_fein_pcnt *  27.00 / 100 + T.Populated_company_foreign_domestic_pcnt *   0.00 / 100 + T.Populated_company_bdid_pcnt *   0.00 / 100 + T.Populated_company_phone_pcnt *  27.00 / 100 + T.Populated_prim_name_pcnt *   0.00 / 100 + T.Populated_prim_name_derived_pcnt *  13.00 / 100 + T.Populated_sec_range_pcnt *  12.00 / 100 + T.Populated_v_city_name_pcnt *  11.00 / 100 + T.Populated_st_pcnt *   5.00 / 100 + T.Populated_zip_pcnt *  14.00 / 100 + T.Populated_prim_range_pcnt *   0.00 / 100 + T.Populated_prim_range_derived_pcnt *  13.00 / 100 + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
EXPORT SourceCounts := Summary('SummaryBySource',FALSE);  R := RECORD
  ...
  R T(SourceCounts le, SourceCounts ri) := TRANSFORM
    ...
    SELF.LinkingPotential := 0 + le.Populated_active_duns_number_pcnt*ri.Populated_active_duns_number_pcnt *  28.00 / 10000 + le.Populated_active_enterprise_number_pcnt*ri.Populated_active_enterprise_number_pcnt *  27.00 / 10000 + le.Populated_active_domestic_corp_key_pcnt*ri.Populated_active_domestic_corp_key_pcnt *  27.00 / 10000 + le.Populated_hist_enterprise_number_pcnt*ri.Populated_hist_enterprise_number_pcnt *  28.00 / 10000 + le.Populated_hist_duns_number_pcnt*ri.Populated_hist_duns_number_pcnt *  27.00 / 10000 + le.Populated_hist_domestic_corp_key_pcnt*ri.Populated_hist_domestic_corp_key_pcnt *  27.00 / 10000 + le.Populated_foreign_corp_key_pcnt*ri.Populated_foreign_corp_key_pcnt *  27.00 / 10000 + le.Populated_unk_corp_key_pcnt*ri.Populated_unk_corp_key_pcnt *  28.00 / 10000 + le.Populated_ebr_file_number_pcnt*ri.Populated_ebr_file_number_pcnt *  28.00 / 10000 + le.Populated_company_name_pcnt*ri.Populated_company_name_pcnt *   0.00 / 10000 + le.Populated_cnp_name_pcnt*ri.Populated_cnp_name_pcnt *  15.00 / 10000 + le.Populated_company_name_type_raw_pcnt*ri.Populated_company_name_type_raw_pcnt *   0.00 / 10000 + le.Populated_company_name_type_derived_pcnt*ri.Populated_company_name_type_derived_pcnt *   0.00 / 10000 + le.Populated_cnp_hasnumber_pcnt*ri.Populated_cnp_hasnumber_pcnt *   0.00 / 10000 + le.Populated_cnp_number_pcnt*ri.Populated_cnp_number_pcnt *  15.00 / 10000 + le.Populated_cnp_btype_pcnt*ri.Populated_cnp_btype_pcnt *   3.00 / 10000 + le.Populated_cnp_lowv_pcnt*ri.Populated_cnp_lowv_pcnt *   0.00 / 10000 + le.Populated_cnp_translated_pcnt*ri.Populated_cnp_translated_pcnt *   0.00 / 10000 + le.Populated_cnp_classid_pcnt*ri.Populated_cnp_classid_pcnt *   0.00 / 10000 + le.Populated_company_fein_pcnt*ri.Populated_company_fein_pcnt *  27.00 / 10000 + le.Populated_company_foreign_domestic_pcnt*ri.Populated_company_foreign_domestic_pcnt *   0.00 / 10000 + le.Populated_company_bdid_pcnt*ri.Populated_company_bdid_pcnt *   0.00 / 10000 + le.Populated_company_phone_pcnt*ri.Populated_company_phone_pcnt *  27.00 / 10000 + le.Populated_prim_name_pcnt*ri.Populated_prim_name_pcnt *   0.00 / 10000 + le.Populated_prim_name_derived_pcnt*ri.Populated_prim_name_derived_pcnt *  13.00 / 10000 + le.Populated_sec_range_pcnt*ri.Populated_sec_range_pcnt *  12.00 / 10000 + le.Populated_v_city_name_pcnt*ri.Populated_v_city_name_pcnt *  11.00 / 10000 + le.Populated_st_pcnt*ri.Populated_st_pcnt *   5.00 / 10000 + le.Populated_zip_pcnt*ri.Populated_zip_pcnt *  14.00 / 10000 + le.Populated_prim_range_pcnt*ri.Populated_prim_range_pcnt *   0.00 / 10000 + le.Populated_prim_range_derived_pcnt*ri.Populated_prim_range_derived_pcnt *  13.00 / 10000 + le.Populated_dt_first_seen_pcnt*ri.Populated_dt_first_seen_pcnt *   0.00 / 10000 + le.Populated_dt_last_seen_pcnt*ri.Populated_dt_last_seen_pcnt *   0.00 / 10000;
  END;
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.Proxid;
  SELF.Src := le.source;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.active_enterprise_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_enterprise_number),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.ebr_file_number),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.company_name_type_raw),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.cnp_hasnumber),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_foreign_domestic),TRIM((SALT30.StrType)le.company_bdid),TRIM((SALT30.StrType)le.company_phone),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.prim_name_derived),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_range_derived),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 33);
  SELF.FldNo2 := 1 + (C % 33);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.active_enterprise_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_enterprise_number),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.ebr_file_number),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.company_name_type_raw),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.cnp_hasnumber),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_foreign_domestic),TRIM((SALT30.StrType)le.company_bdid),TRIM((SALT30.StrType)le.company_phone),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.prim_name_derived),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_range_derived),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.active_duns_number),TRIM((SALT30.StrType)le.active_enterprise_number),TRIM((SALT30.StrType)le.active_domestic_corp_key),TRIM((SALT30.StrType)le.hist_enterprise_number),TRIM((SALT30.StrType)le.hist_duns_number),TRIM((SALT30.StrType)le.hist_domestic_corp_key),TRIM((SALT30.StrType)le.foreign_corp_key),TRIM((SALT30.StrType)le.unk_corp_key),TRIM((SALT30.StrType)le.ebr_file_number),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.cnp_name),TRIM((SALT30.StrType)le.company_name_type_raw),TRIM((SALT30.StrType)le.company_name_type_derived),TRIM((SALT30.StrType)le.cnp_hasnumber),TRIM((SALT30.StrType)le.cnp_number),TRIM((SALT30.StrType)le.cnp_btype),TRIM((SALT30.StrType)le.cnp_lowv),TRIM((SALT30.StrType)le.cnp_translated),TRIM((SALT30.StrType)le.cnp_classid),TRIM((SALT30.StrType)le.company_fein),TRIM((SALT30.StrType)le.company_foreign_domestic),TRIM((SALT30.StrType)le.company_bdid),TRIM((SALT30.StrType)le.company_phone),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.prim_name_derived),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.prim_range_derived),TRIM((SALT30.StrType)le.dt_first_seen),TRIM((SALT30.StrType)le.dt_last_seen)));
  END;
...
SHARED FldIds := DATASET([{1,'active_duns_number'}
      ...
      ,{10,'company_name'}
      ,{11,'cnp_name'}
      ,{12,'company_name_type_raw'}
      ,{13,'company_name_type_derived'}
      ,{14,'cnp_hasnumber'}
      ,{15,'cnp_number'}
      ,{16,'cnp_btype'}
      ,{17,'cnp_lowv'}
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_company_name_type_raw((SALT30.StrType)le.company_name_type_raw),
    ...
    Fields.InValid_company_foreign_domestic((SALT30.StrType)le.company_foreign_domestic),
    ...
    Fields.InValid_prim_range_derived((SALT30.StrType)le.prim_range_derived),
    0, // Uncleanable field
    0, // Uncleanable field
    0, // Uncleanable field
