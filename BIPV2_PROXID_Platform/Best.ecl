...
EXPORT BestBy_cnp_name_prim_name_derived_v_city_name_st_zip := BestBy_cnp_name_prim_name_derived_v_city_name_st_zip_np : PERSIST('~temp::Proxid::BIPV2_ProxID_Platform::best::BestBy_cnp_name_prim_name_derived_v_city_name_st_zip',EXPIRE(Config.PersistExpire));
