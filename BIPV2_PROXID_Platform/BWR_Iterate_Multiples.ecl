//so take iteration 24 from BIPV2_ProxID_Platform 
...
//#workunit('name','BIPV2_ProxID_Platform.BWR_Specificities - Specificities');
IMPORT BIPV2_ProxID_Platform,SALT25;
IMPORT SALTTOOLS22;
dotbase := BIPV2_ProxID_Platform.files().base.built;
SpecMod := BIPV2_ProxID_Platform.specificities(dotbase);
...
//  ,BIPV2_ProxID_Platform.Promote('0').new2built    //promote it as zeroth iteration to superfile(for attribute file use)
  ,SpecMod.Build
  ,parallel(
