...
dbasebuilt  := BIPV2_ProxID_Platform.files('20130808_43').base.logical;
...
writefile   := tools.macf_writefile(BIPV2_ProxID_Platform.filenames(newversion).base.logical,dsproxidproj,poverwrite := true,pDescription := 'fix cnp_numbers, patch overlinked dotids and proxids');
