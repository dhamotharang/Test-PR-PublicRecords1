...
#workunit('name','BIPV2_ProxID_Platform.BWR_Best - BEST - SALT V3.0 Gold');
...
// BIPV2_ProxID_Platform.Keys(BIPV2_ProxID_Platform.In_DOT_Base).BuildData;
 
// The statistics for the best (also builds all the persists)
BIPV2_ProxID_Platform.Best(BIPV2_ProxID_Platform.In_DOT_Base).Stats;
...
b := BIPV2_ProxID_Platform.Best(BIPV2_ProxID_Platform.In_DOT_Base); // Instantiate Best module
