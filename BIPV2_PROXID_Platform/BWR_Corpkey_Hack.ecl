...
dbase14 := BIPV2_ProxID_Platform.files(BIPV2.KeySuffix + '_14').base.logical : global;
...
output(djoin  ,,'~BIPV2_ProxID_Platform::base::20130212_14a::data',__COMPRESSED__,OVERWRITE);
