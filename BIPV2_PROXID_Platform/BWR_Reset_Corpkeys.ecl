...
*/
//use alpha
pDataset := BIPV2_ProxID_Platform.files('20130330_29').base.logical;
...
output(dproj,,BIPV2_ProxID_Platform.filenames('20130330a_29').base.logical,__COMPRESSED__,OVERWRITE);
