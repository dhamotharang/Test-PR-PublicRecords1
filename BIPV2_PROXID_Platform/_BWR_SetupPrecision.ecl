...
////////////////////////////////////////////////////////////////////////////////////////////////////////
dWks := sort(dedup(sort(BIPV2_ProxID_Platform.Files(combo).wkhistory.logical(iteration != '' ,version = pversion ,(unsigned)matchesperformed != 0),iteration,-wuid),iteration),(unsigned)iteration);
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
writefile         := tools.macf_writefile(BIPV2_ProxID_Platform.filenames(combo).precision.logical ,dsetupprecision ,pOverwrite := true,pCompress := false);
sequential(
   writefile
  ,BIPV2_ProxID_Platform.Promote(combo,'precision').new2qamult
);
