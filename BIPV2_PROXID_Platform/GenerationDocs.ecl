...
FIELD:active_duns_number:PROP:28,21
FIELD:active_enterprise_number:FORCE(--):PROP:27,4
FIELD:active_domestic_corp_key:PROP:27,4
// Historical and non-domestic IDs from reliable sources
// If match, add to score, if not, don't care(SWITCH0)
FIELD:hist_enterprise_number:PROP:28,7
FIELD:hist_duns_number:PROP:27,171
FIELD:hist_domestic_corp_key:PROP:27,48
FIELD:foreign_corp_key:SWITCH0:PROP:27,157
FIELD:unk_corp_key:SWITCH0:PROP:28,44
FIELD:ebr_file_number:PROP:28,225
FIELD:company_name:CARRY:0,0
FIELD:cnp_name:TYPE(STRING250):BAGOFWORDS(MOST):EDIT1:FORCE(+6,OR(active_domestic_corp_key),OR(active_duns_number)):ABBR(ACRONYM,INITIAL,MAXSPC(13)):HYPHEN1:TYPE(string250):15,148
...
FIELD:company_fein:PROP:EDIT1:27,97
...
FIELD:company_phone:SWITCH0:PROP:27,290
...
FIELD:prim_name_derived:BAGOFWORDS(MOST):EDIT1:FORCE(+5):ABBR(FIRST):HYPHEN1:13,6
// FIELD:prim_name:BAGOFWORDS(MOST):EDIT1:FORCE(+5):ABBR(FIRST):HYPHEN1:13,4
//FIELD:prim_name:FORCE(+):15,0
FIELD:sec_range:HYPHEN1:PROP:12,76
...
CONCEPT:company_addr1:prim_range_derived:prim_name_derived:sec_range:24,95
CONCEPT:company_address:company_addr1:company_csz:FORCE(+):25,112
// ------------------------------------
//  3. Contact
// ------------------------------------
...
//  Attribute Files
// ------------------------------------
ATTRIBUTEFILE:SrcRidVlid:NAMED(file_SrcRidVlid):VALUES(source:source_record_id:vl_id):IDFIELD(Proxid):SUPPORTS(cnp_name):28,598
ATTRIBUTEFILE:ForeignCorpkey:NAMED(file_Foreign_Corpkey):VALUES(company_charter_number<company_inc_state):FORCE(--,ALL):IDFIELD(Proxid):27,47
...
Total available specificity:465
...
This process was told to produce 3 nines of accuracy on a population of 200000000 with  5991392256 records.
...
active_domestic_corp_key Scoring: If a field is null and another record in the same cluster has a value for that field then the other records value will be used.
...
(This subtraction estimate is based upon 4% of clusters with 2 or more records have 2 or more values for hist_domestic_corp_key.)
...
but should average 27 points with a failed match substracting 22 points.
(This subtraction estimate is based upon 15% of clusters with 2 or more records have 2 or more values for foreign_corp_key.)
...
(This subtraction estimate is based upon 14% of clusters with 2 or more records have 2 or more values for cnp_name.)
...
(This subtraction estimate is based upon 4% of clusters with 2 or more records have 2 or more values for cnp_btype.)
...
(This subtraction estimate is based upon 9% of clusters with 2 or more records have 2 or more values for company_fein.)
...
and the degree of fuzziness required but should average 12 points with a failed match substracting 11 points.
...
The exact score will depend upon the global scarcity of SrcRidVlid but should average 28.
...
Additional Scoring for fieldcname from file RAAddresses:
...
Additional Scoring for fieldpname_digits from file FilterPrimNames:
