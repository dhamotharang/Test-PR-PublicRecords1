...
kmtchsmpl  := index(BIPV2_ProxID_Platform.Keys(BIPV2_ProxID_Platform.In_DOT_Base).MatchSample ,BIPV2_ProxID_Platform.keynames('20130212_25').match_sample_debug.logical);
kmtchgt21 := kmtchsmpl(conf >= 21);
ddev2      := BIPV2_ProxID_Platform.files('20130212_25').base.logical;
