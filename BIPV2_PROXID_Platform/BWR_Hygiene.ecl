...
#workunit('name','BIPV2_ProxID_Platform.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_ProxID_Platform,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_ProxID_Platform.In_DOT_Base;
  h := BIPV2_ProxID_Platform.Hygiene(infile);
  ...
  CM := BIPV2_ProxID_Platform.Fields.UIDConsistency(BIPV2_ProxID_Platform.In_DOT_Base);
...
//  OUTPUT(CM.orgid_TwoParents,NAMED('Twoparentsorgid'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,company_name_type_raw,Examples),NAMED('company_name_type_rawBysource'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,company_foreign_domestic,Examples),NAMED('company_foreign_domesticBysource'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,prim_range_derived,Examples),NAMED('prim_range_derivedBysource'));
