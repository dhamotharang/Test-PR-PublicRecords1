...
EXPORT B_Business_Sele_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE430011 := __ENH_Business_Sele_6;
  EXPORT __ST155981_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST155981_Layout __ND430016__Project(B_Business_Sele_6(__in,__cfg).__ST156521_Layout __PP430012) := TRANSFORM
    SELF.B_E___B2_B_Carr_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Carr_Cnt24_Mc_No_Cap_,0,999);
    SELF.B_E___B2_B_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Cnt24_Mc_No_Cap_,0,999);
    SELF.B_E___B2_B_Flt_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Flt_Cnt24_Mc_No_Cap_,0,999);
    SELF.B_E___B2_B_Mat_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Mat_Cnt24_Mc_No_Cap_,0,999);
    SELF.B_E___B2_B_Ops_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Ops_Cnt24_Mc_No_Cap_,0,999);
    SELF.B_E___B2_B_Oth_Cnt24_Mc_ := KEL.Routines.BoundsFold(__PP430012.B_E___B2_B_Oth_Cnt24_Mc_No_Cap_,0,999);
    SELF := __PP430012;
  END;
  EXPORT __ENH_Business_Sele_5 := PROJECT(__EE430011,__ND430016__Project(LEFT));
END;
