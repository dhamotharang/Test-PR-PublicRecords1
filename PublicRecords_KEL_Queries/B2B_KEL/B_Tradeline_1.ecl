...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE640868 := __ENH_Tradeline_2;
  EXPORT __ST156334_Layout := RECORD
  ...
  END;
  EXPORT __ST156327_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST156334_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156327_Layout __ND640873__Project(B_Tradeline_2(__in,__cfg).__ST160377_Layout __PP640869) := TRANSFORM
    __EE640898 := __PP640869.Records_;
    SELF.Records_ := __PROJECT(__EE640898,__ST156334_Layout);
    SELF := __PP640869;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE640868,__ND640873__Project(LEFT));
END;
