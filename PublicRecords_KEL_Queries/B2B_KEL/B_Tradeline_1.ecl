...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE629867 := __ENH_Tradeline_2;
  EXPORT __ST145333_Layout := RECORD
  ...
  END;
  EXPORT __ST145326_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST145333_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST145326_Layout __ND629872__Project(B_Tradeline_2(__in,__cfg).__ST149376_Layout __PP629868) := TRANSFORM
    __EE629897 := __PP629868.Records_;
    SELF.Records_ := __PROJECT(__EE629897,__ST145333_Layout);
    SELF := __PP629868;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE629867,__ND629872__Project(LEFT));
END;
