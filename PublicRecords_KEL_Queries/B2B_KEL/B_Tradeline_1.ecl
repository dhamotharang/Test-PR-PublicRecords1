...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE563499 := __ENH_Tradeline_2;
  EXPORT __ST106111_Layout := RECORD
  ...
  END;
  EXPORT __ST106104_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST106111_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST106104_Layout __ND563504__Project(B_Tradeline_2(__in,__cfg).__ST110244_Layout __PP563500) := TRANSFORM
    __EE563529 := __PP563500.Records_;
    SELF.Records_ := __PROJECT(__EE563529,__ST106111_Layout);
    SELF := __PP563500;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE563499,__ND563504__Project(LEFT));
END;
