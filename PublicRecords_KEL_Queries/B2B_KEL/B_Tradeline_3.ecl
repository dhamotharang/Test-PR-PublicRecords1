...
EXPORT B_Tradeline_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE477670 := __ENH_Tradeline_4;
  EXPORT __ST131251_Layout := RECORD
  ...
  END;
  EXPORT __ST131244_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST131251_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST131244_Layout __ND477635__Project(B_Tradeline_4(__in,__cfg).__ST134233_Layout __PP477274) := TRANSFORM
    __EE477673 := __PP477274.Records_;
    __ST131251_Layout __ND477322__Project(B_Tradeline_4(__in,__cfg).__ST134240_Layout __PP477318) := TRANSFORM
      SELF.D_P_D1_Total_ := __OP2(__OP2(__OP2(__PP477318.Aging1_To30_L_N_,+,__PP477318.Aging31_To60_L_N_),+,__PP477318.Aging61_To90_L_N_),+,__PP477318.Aging91_Plus_L_N_);
      SELF.D_P_D31_Total_ := __OP2(__OP2(__PP477318.Aging31_To60_L_N_,+,__PP477318.Aging61_To90_L_N_),+,__PP477318.Aging91_Plus_L_N_);
      SELF.D_P_D61_Total_ := __OP2(__PP477318.Aging61_To90_L_N_,+,__PP477318.Aging91_Plus_L_N_);
      SELF.D_P_D91_Total_ := __PP477318.Aging91_Plus_L_N_;
      SELF := __PP477318;
    END;
    SELF.Records_ := __PROJECT(__EE477673,__ND477322__Project(LEFT));
    __EE477609 := __PP477274.Records_;
    __EE477624 := __PP477274.Records_;
    __BS477610 := __T(__EE477609);
    __EE477630 := __BS477610(__T(__OP2(__T(__EE477609).Record_Age_In_Days_,=,KEL.Aggregates.MinNN(__EE477624,__T(__EE477624).Record_Age_In_Days_))));
    SELF.Total_A_R_L_N_ := (__EE477630)[1].Total_A_R_L_N_;
    SELF := __PP477274;
  END;
  EXPORT __ENH_Tradeline_3 := PROJECT(__EE477670,__ND477635__Project(LEFT));
END;
