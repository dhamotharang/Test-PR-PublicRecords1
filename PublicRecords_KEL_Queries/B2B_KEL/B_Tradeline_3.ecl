...
EXPORT B_Tradeline_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE595818 := __ENH_Tradeline_4;
  EXPORT __ST163815_Layout := RECORD
  ...
  END;
  EXPORT __ST163808_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST163815_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163808_Layout __ND595783__Project(B_Tradeline_4(__in,__cfg).__ST166797_Layout __PP595142) := TRANSFORM
    __EE595821 := __PP595142.Records_;
    __ST163815_Layout __ND595190__Project(B_Tradeline_4(__in,__cfg).__ST166804_Layout __PP595186) := TRANSFORM
      SELF.D_P_D1_Total_ := __OP2(__OP2(__OP2(__PP595186.Aging1_To30_L_N_,+,__PP595186.Aging31_To60_L_N_),+,__PP595186.Aging61_To90_L_N_),+,__PP595186.Aging91_Plus_L_N_);
      SELF.D_P_D31_Total_ := __OP2(__OP2(__PP595186.Aging31_To60_L_N_,+,__PP595186.Aging61_To90_L_N_),+,__PP595186.Aging91_Plus_L_N_);
      SELF.D_P_D61_Total_ := __OP2(__PP595186.Aging61_To90_L_N_,+,__PP595186.Aging91_Plus_L_N_);
      SELF.D_P_D91_Total_ := __PP595186.Aging91_Plus_L_N_;
      SELF := __PP595186;
    END;
    SELF.Records_ := __PROJECT(__EE595821,__ND595190__Project(LEFT));
    __EE595757 := __PP595142.Records_;
    __EE595772 := __PP595142.Records_;
    __BS595758 := __T(__EE595757);
    __EE595778 := __BS595758(__T(__OP2(__T(__EE595757).Record_Age_In_Days_,=,KEL.Aggregates.MinNN(__EE595772,__T(__EE595772).Record_Age_In_Days_))));
    SELF.Total_A_R_L_N_ := (__EE595778)[1].Total_A_R_L_N_;
    SELF := __PP595142;
  END;
  EXPORT __ENH_Tradeline_3 := PROJECT(__EE595818,__ND595783__Project(LEFT));
END;
