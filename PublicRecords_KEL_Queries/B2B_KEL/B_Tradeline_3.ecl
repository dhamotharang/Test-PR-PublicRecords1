...
EXPORT B_Tradeline_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE521001 := __ENH_Tradeline_4;
  EXPORT __ST113772_Layout := RECORD
  ...
  EXPORT __ST113765_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST113772_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST113765_Layout __ND520966__Project(B_Tradeline_4(__in,__cfg).__ST116844_Layout __PP520605) := TRANSFORM
    __EE521004 := __PP520605.Records_;
    __ST113772_Layout __ND520653__Project(B_Tradeline_4(__in,__cfg).__ST116851_Layout __PP520649) := TRANSFORM
      SELF.D_P_D1_Total_ := __OP2(__OP2(__OP2(__PP520649.Aging1_To30_L_N_,+,__PP520649.Aging31_To60_L_N_),+,__PP520649.Aging61_To90_L_N_),+,__PP520649.Aging91_Plus_L_N_);
      SELF.D_P_D31_Total_ := __OP2(__OP2(__PP520649.Aging31_To60_L_N_,+,__PP520649.Aging61_To90_L_N_),+,__PP520649.Aging91_Plus_L_N_);
      SELF.D_P_D61_Total_ := __OP2(__PP520649.Aging61_To90_L_N_,+,__PP520649.Aging91_Plus_L_N_);
      SELF.D_P_D91_Total_ := __PP520649.Aging91_Plus_L_N_;
      SELF := __PP520649;
    END;
    SELF.Records_ := __PROJECT(__EE521004,__ND520653__Project(LEFT));
    __EE520940 := __PP520605.Records_;
    __EE520955 := __PP520605.Records_;
    __BS520941 := __T(__EE520940);
    __EE520961 := __BS520941(__T(__OP2(__T(__EE520940).Record_Age_In_Days_,=,KEL.Aggregates.MinNN(__EE520955,__T(__EE520955).Record_Age_In_Days_))));
    SELF.Total_A_R_L_N_ := (__EE520961)[1].Total_A_R_L_N_;
    SELF := __PP520605;
  END;
  EXPORT __ENH_Tradeline_3 := PROJECT(__EE521001,__ND520966__Project(LEFT));
END;
