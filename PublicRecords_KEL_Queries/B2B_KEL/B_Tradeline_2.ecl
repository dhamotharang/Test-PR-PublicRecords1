...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE499005 := __ENH_Tradeline_3;
  EXPORT __ST127774_Layout := RECORD
  ...
  END;
  EXPORT __ST127767_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST127774_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST127767_Layout __ND498949__Project(B_Tradeline_3(__in,__cfg).__ST131198_Layout __PP498523) := TRANSFORM
    __EE499008 := __PP498523.Records_;
    __ST127774_Layout __ND498869__Project(B_Tradeline_3(__in,__cfg).__ST131205_Layout __PP498564) := TRANSFORM
      __EE498862 := __PP498523.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP498523.Is_Active_,__OP2(__PP498564.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE498862,__T(__EE498862).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP498564.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP498564.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP498564.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP498564.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP498564;
    END;
    SELF.Records_ := __PROJECT(__EE499008,__ND498869__Project(LEFT));
    SELF := __PP498523;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE499005,__ND498949__Project(LEFT));
END;
