...
IMPORT KEL13 AS KEL;
IMPORT B_Sele_Tradeline_3,CFG_Compile,E_Business_Org,E_Business_Sele,E_Business_Ult,E_Sele_Tradeline,E_Tradeline FROM PublicRecords_KEL_Queries.B2B_KEL;
...
EXPORT B_Sele_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE544272 := __ENH_Sele_Tradeline_3;
  EXPORT __ENH_Sele_Tradeline_2 := __EE544272;
END;
