...
all_images := hygenics_images.File_Images_KeyBuilding(did != 0, imglength != 0);
...
i := INDEX(numbered,,Data_Services.Data_location.Prefix('Provider') + 'criminal_images::key::Matrix_Images_did'+thorlib.wuid());
