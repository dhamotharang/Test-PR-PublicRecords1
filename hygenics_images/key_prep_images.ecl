import Data_Services;
	...
	all_images := hygenics_images.File_Images_KeyBuilding(imglength != 0);
...
i := INDEX(numbered,, Data_Services.Data_location.Prefix('Images') + 'criminal_images::key::Matrix_Images'+thorlib.wuid());
