...
self.courtname												:= regexreplace('\n',stringlib.stringfilterout(pInput.courtname,'"'),' ');
self.filingamounts												:= regexreplace('\n',stringlib.stringfilterout(pInput.filingamounts,'"'),' ');
self.courtcosts												:= regexreplace('\n',stringlib.stringfilterout(pInput.courtcosts,'"'),' ');
self.address1											:= regexreplace('\n',stringlib.stringfilterout(pInput.address1,'"'),' ');
self.mailaddress1										:= regexreplace('\n',stringlib.stringfilterout(pInput.mailaddress1,'"'),' ');
