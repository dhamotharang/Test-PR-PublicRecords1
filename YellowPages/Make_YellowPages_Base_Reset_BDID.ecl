...
YP_Base_BusName_NonBlank 	:= YellowPages.File_YellowPages_Base_V2_BIP(business_name <> '');
YP_Base_BusName_Blank		  := YellowPages.File_YellowPages_Base_V2_BIP(business_name = '');
...
//OUTPUT(YellowPages_Base_BDID_All,,'BASE::YellowPages_' + YellowPages.YellowPages_Reset_Date, OVERWRITE);
