...
EXPORT key_yellowpages_linkids := MODULE

  // DEFINE THE INDEX
	BIPV2.IDmacros.mac_IndexWithXLinkIDs(YellowPages.file_YellowPages_Base_V2_BIP, k, YellowPages.Constants(VersionControl._Flags.IsDataland).oldkeytemplate + '_linkids_' + doxie.Version_SuperKey);
	export Key := k;
