...
parallel(
		sequential	(
			output(dedup(ds_FLCrash0_in + prod_FLCrash0(rec_type_o='0'),all),,'~thor_data400::in::FLCrash0_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash1_in + prod_FLCrash1(rec_type_1='1'),all),,'~thor_data400::in::FLCrash1_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash2v_out  + prod_FLCrash2v(rec_type_2='2'),all),,'~thor_data400::in::FLCrash2v_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash3v_out + prod_FLCrash3v(rec_type_3='3'),all),,'~thor_data400::in::FLCrash3v_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash4_in + prod_FLCrash4(rec_type_4='4'),all),,'~thor_data400::in::FLCrash4_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash5_in + prod_FLCrash5(rec_type_5='5'),all),,'~thor_data400::in::FLCrash5_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash6_in + prod_FLCrash6(rec_type_6='6'),all),,'~thor_data400::in::FLCrash6_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash7_in + prod_FLCrash7(rec_type_7='7'),all),,'~thor_data400::in::FLCrash7_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash8_in + prod_FLCrash8(rec_type_8='8'),all),,'~thor_data400::in::FLCrash8_'+ FLAccidents.Version_Development),
		...
		sequential	(
			output(dedup(ds_FLCrash9_in + prod_FLCrash9(rec_type_9='9'),all),,'~thor_data400::in::FLCrash9_'+ FLAccidents.Version_Development),
