...
flc6 := project(basefile_flcrash6,transform (slim_layout,
  self.ped_st_city := trim(trim(left.ped_address,left,right)+' '+ trim(left.ped_st_city,left,right),left,right),
...
export key_flcrash6 := index(flc6
							...
							,{flc6}
							,Data_Services.Data_location.Prefix('NONAMEGIVEN') +'~thor_data400::key::flcrash6_' + doxie.Version_SuperKey);
