import DEA, doxie, suppress, AutoStandardI, ut, Doxie_raw, CriminalRecords_Services;
...
export DEAV2_Search_recs (
  ...
  dea_active := dea_reg(expiration_Date>ut.IndustryClass.sys_date);										 
  dea_inactive := dea_reg(expiration_Date<=ut.IndustryClass.sys_date);										 
