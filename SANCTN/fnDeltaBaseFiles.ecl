...
file_compare.Fn_File_Compare(file_base_party_aka_dba_father,file_base_party_aka_dba_new,SANCTN.layout_SANCTN_aka_dba_base,,SANCTN.layout_SANCTN_aka_dba_base,true,,true,true,'SANCTN','file_base_party_aka_dba',version),
file_compare.Fn_File_Compare(file_base_rebuttal_father,file_base_rebuttal_new,SANCTN.layout_SANCTN_rebuttal_base,,SANCTN.layout_SANCTN_rebuttal_base,true,,true,true,'SANCTN','file_base_rebuttal',version)
);