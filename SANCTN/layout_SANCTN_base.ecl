export layout_SANCTN_base := module 


//-------------------------------------------------------------------------
//Child Layouts
export layout_partyv := record, maxlength(30000)

string4   order_number:='';
string255 party_text:='';
end;

export  layout_incidentv := record, maxlength(30000)
string4   order_number:='';
...
//-------------------------------------------------------------------------
//Parent Layouts
export layout_SANCTN_partyFull := record, maxlength(500000)
	...
	unsigned6 		did := 0;
	string3 		did_score := '';
dataset(layout_partyv)   pty_detail;
end;

export layout_SANCTN_incidentFull := record, maxlength(500000)
	STRING8  BATCH_NUMBER;
	STRING8  INCIDENT_NUMBER;
	STRING8  PARTY_NUMBER;
	STRING1  RECORD_TYPE;
	...
	STRING1  OK_FOR_FCR;
dataset(layout_incidentv) inc_detail; 
end;
