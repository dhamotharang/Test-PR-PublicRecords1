export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1 	:= '(NONE (SAME)* (AS)* (ABOVE)*|SAME|XX|SEE DOCUMENT|NONE PROVIDED|NONE GIVEN|UNDER NONE|^UNKNOWN|^NONE$|^NONE | NONE )';
	...
	export Country := module
		...
		shared PatternInvalidWords1		:= 'XX|^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |UNKNOWN';
		export InvalidWords						:= PatternInvalidWords1;
	end;
