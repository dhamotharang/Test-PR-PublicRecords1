...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 215;
  EXPORT NumRulesFromFieldType := 215;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 204;
  ...
  SHARED toRuleDesc(UNSIGNED c) := CHOOSE(c
          ...
          ,'businessdescription:Invalid_AlphaNumChar:ALLOW'
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ...
          ,Fields.InvalidMessage_firmlocationaddresszipcode(1),Fields.InvalidMessage_firmlocationaddresszipcode(2)
...
EXPORT FromNone(DATASET(Layout_Diversity_Certification) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.firmlocationaddresszipcode_Invalid := Fields.InValid_firmlocationaddresszipcode((SALT311.StrType)le.firmlocationaddresszipcode);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dartid_Invalid << 0 ) + ( le.dateadded_Invalid << 1 ) + ( le.dateupdated_Invalid << 2 ) + ( le.website_Invalid << 3 ) + ( le.state_Invalid << 4 ) + ( le.profilelastupdated_Invalid << 6 ) + ( le.county_Invalid << 7 ) + ( le.servicearea_Invalid << 8 ) + ( le.region1_Invalid << 9 ) + ( le.region2_Invalid << 10 ) + ( le.region3_Invalid << 11 ) + ( le.region4_Invalid << 12 ) + ( le.region5_Invalid << 13 ) + ( le.fname_Invalid << 14 ) + ( le.lname_Invalid << 15 ) + ( le.mname_Invalid << 16 ) + ( le.suffix_Invalid << 17 ) + ( le.title_Invalid << 18 ) + ( le.ethnicity_Invalid << 19 ) + ( le.gender_Invalid << 20 ) + ( le.address1_Invalid << 21 ) + ( le.address2_Invalid << 22 ) + ( le.addresscity_Invalid << 23 ) + ( le.addressstate_Invalid << 24 ) + ( le.addresszipcode_Invalid << 26 ) + ( le.addresszip4_Invalid << 28 ) + ( le.building_Invalid << 29 ) + ( le.contact_Invalid << 30 ) + ( le.phone1_Invalid << 31 ) + ( le.phone2_Invalid << 33 ) + ( le.phone3_Invalid << 35 ) + ( le.cell_Invalid << 37 ) + ( le.fax_Invalid << 39 ) + ( le.email1_Invalid << 41 ) + ( le.email2_Invalid << 42 ) + ( le.email3_Invalid << 43 ) + ( le.webpage1_Invalid << 44 ) + ( le.webpage2_Invalid << 45 ) + ( le.webpage3_Invalid << 46 ) + ( le.businessname_Invalid << 47 ) + ( le.dba_Invalid << 48 ) + ( le.businessid_Invalid << 49 ) + ( le.businesstype1_Invalid << 50 ) + ( le.businesslocation1_Invalid << 51 ) + ( le.businesstype2_Invalid << 52 ) + ( le.businesslocation2_Invalid << 53 ) + ( le.businesstype3_Invalid << 54 ) + ( le.businesslocation3_Invalid << 55 ) + ( le.businesstype4_Invalid << 56 ) + ( le.businesslocation4_Invalid << 57 ) + ( le.businesstype5_Invalid << 58 ) + ( le.businesslocation5_Invalid << 59 ) + ( le.industry_Invalid << 60 ) + ( le.trade_Invalid << 61 ) + ( le.resourcedescription_Invalid << 62 ) + ( le.natureofbusiness_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.businessdescription_Invalid << 0 ) + ( le.businessstructure_Invalid << 1 ) + ( le.totalemployees_Invalid << 2 ) + ( le.avgcontractsize_Invalid << 3 ) + ( le.firmid_Invalid << 4 ) + ( le.firmlocationaddress_Invalid << 5 ) + ( le.firmlocationaddresscity_Invalid << 6 ) + ( le.firmlocationaddresszip4_Invalid << 7 ) + ( le.firmlocationaddresszipcode_Invalid << 8 ) + ( le.firmlocationcounty_Invalid << 10 ) + ( le.firmlocationstate_Invalid << 11 ) + ( le.certfed_Invalid << 13 ) + ( le.certstate_Invalid << 14 ) + ( le.contractsfederal_Invalid << 16 ) + ( le.contractsva_Invalid << 17 ) + ( le.contractscommercial_Invalid << 18 ) + ( le.contractorgovernmentprime_Invalid << 19 ) + ( le.contractorgovernmentsub_Invalid << 20 ) + ( le.contractornongovernment_Invalid << 21 ) + ( le.registeredgovernmentbus_Invalid << 22 ) + ( le.registerednongovernmentbus_Invalid << 23 ) + ( le.clearancelevelpersonnel_Invalid << 24 ) + ( le.clearancelevelfacility_Invalid << 25 ) + ( le.certificatedatefrom1_Invalid << 26 ) + ( le.certificatedateto1_Invalid << 27 ) + ( le.certificatestatus1_Invalid << 28 ) + ( le.certificationnumber1_Invalid << 29 ) + ( le.certificationtype1_Invalid << 30 ) + ( le.certificatedatefrom2_Invalid << 31 ) + ( le.certificatedateto2_Invalid << 32 ) + ( le.certificatestatus2_Invalid << 33 ) + ( le.certificationnumber2_Invalid << 34 ) + ( le.certificationtype2_Invalid << 35 ) + ( le.certificatedatefrom3_Invalid << 36 ) + ( le.certificatedateto3_Invalid << 37 ) + ( le.certificatestatus3_Invalid << 38 ) + ( le.certificationnumber3_Invalid << 39 ) + ( le.certificationtype3_Invalid << 40 ) + ( le.certificatedatefrom4_Invalid << 41 ) + ( le.certificatedateto4_Invalid << 42 ) + ( le.certificatestatus4_Invalid << 43 ) + ( le.certificationnumber4_Invalid << 44 ) + ( le.certificationtype4_Invalid << 45 ) + ( le.certificatedatefrom5_Invalid << 46 ) + ( le.certificatedateto5_Invalid << 47 ) + ( le.certificatestatus5_Invalid << 48 ) + ( le.certificationnumber5_Invalid << 49 ) + ( le.certificationtype5_Invalid << 50 ) + ( le.certificatedatefrom6_Invalid << 51 ) + ( le.certificatedateto6_Invalid << 52 ) + ( le.certificatestatus6_Invalid << 53 ) + ( le.certificationnumber6_Invalid << 54 ) + ( le.certificationtype6_Invalid << 55 ) + ( le.starrating_Invalid << 56 ) + ( le.assets_Invalid << 57 ) + ( le.biddescription_Invalid << 58 ) + ( le.competitiveadvantage_Invalid << 59 ) + ( le.cagecode_Invalid << 60 ) + ( le.capabilitiesnarrative_Invalid << 61 ) + ( le.category_Invalid << 62 ) + ( le.chtrclass_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.productdescription1_Invalid << 0 ) + ( le.productdescription2_Invalid << 1 ) + ( le.productdescription3_Invalid << 2 ) + ( le.productdescription4_Invalid << 3 ) + ( le.productdescription5_Invalid << 4 ) + ( le.classdescription1_Invalid << 5 ) + ( le.subclassdescription1_Invalid << 6 ) + ( le.classdescription2_Invalid << 7 ) + ( le.subclassdescription2_Invalid << 8 ) + ( le.classdescription3_Invalid << 9 ) + ( le.subclassdescription3_Invalid << 10 ) + ( le.classdescription4_Invalid << 11 ) + ( le.subclassdescription4_Invalid << 12 ) + ( le.classdescription5_Invalid << 13 ) + ( le.subclassdescription5_Invalid << 14 ) + ( le.classifications_Invalid << 15 ) + ( le.commodity1_Invalid << 16 ) + ( le.commodity2_Invalid << 17 ) + ( le.commodity3_Invalid << 18 ) + ( le.commodity4_Invalid << 19 ) + ( le.commodity5_Invalid << 20 ) + ( le.commodity6_Invalid << 21 ) + ( le.commodity7_Invalid << 22 ) + ( le.commodity8_Invalid << 23 ) + ( le.completedate_Invalid << 24 ) + ( le.crossreference_Invalid << 25 ) + ( le.dateestablished_Invalid << 26 ) + ( le.businessage_Invalid << 27 ) + ( le.deposits_Invalid << 28 ) + ( le.dunsnumber_Invalid << 29 ) + ( le.enttype_Invalid << 30 ) + ( le.expirationdate_Invalid << 31 ) + ( le.extendeddate_Invalid << 32 ) + ( le.issuingauthority_Invalid << 33 ) + ( le.keywords_Invalid << 34 ) + ( le.licensenumber_Invalid << 35 ) + ( le.licensetype_Invalid << 36 ) + ( le.mincd_Invalid << 37 ) + ( le.minorityaffiliation_Invalid << 38 ) + ( le.minorityownershipdate_Invalid << 39 ) + ( le.siccode1_Invalid << 40 ) + ( le.siccode2_Invalid << 41 ) + ( le.siccode3_Invalid << 42 ) + ( le.siccode4_Invalid << 43 ) + ( le.siccode5_Invalid << 44 ) + ( le.siccode6_Invalid << 45 ) + ( le.siccode7_Invalid << 46 ) + ( le.siccode8_Invalid << 47 ) + ( le.naicscode1_Invalid << 48 ) + ( le.naicscode2_Invalid << 49 ) + ( le.naicscode3_Invalid << 50 ) + ( le.naicscode4_Invalid << 51 ) + ( le.naicscode5_Invalid << 52 ) + ( le.naicscode6_Invalid << 53 ) + ( le.naicscode7_Invalid << 54 ) + ( le.naicscode8_Invalid << 55 ) + ( le.prequalify_Invalid << 56 ) + ( le.procurementcategory1_Invalid << 57 ) + ( le.subprocurementcategory1_Invalid << 58 ) + ( le.procurementcategory2_Invalid << 59 ) + ( le.subprocurementcategory2_Invalid << 60 ) + ( le.procurementcategory3_Invalid << 61 ) + ( le.subprocurementcategory3_Invalid << 62 ) + ( le.procurementcategory4_Invalid << 63 );
    SELF.ScrubsBits4 := ( le.subprocurementcategory4_Invalid << 0 ) + ( le.procurementcategory5_Invalid << 1 ) + ( le.subprocurementcategory5_Invalid << 2 ) + ( le.renewal_Invalid << 3 ) + ( le.renewaldate_Invalid << 4 ) + ( le.unitedcertprogrampartner_Invalid << 5 ) + ( le.vendorkey_Invalid << 6 ) + ( le.vendornumber_Invalid << 7 ) + ( le.workcode1_Invalid << 8 ) + ( le.workcode2_Invalid << 9 ) + ( le.workcode3_Invalid << 10 ) + ( le.workcode4_Invalid << 11 ) + ( le.workcode5_Invalid << 12 ) + ( le.workcode6_Invalid << 13 ) + ( le.workcode7_Invalid << 14 ) + ( le.workcode8_Invalid << 15 ) + ( le.exporter_Invalid << 16 ) + ( le.exportbusinessactivities_Invalid << 17 ) + ( le.exportto_Invalid << 18 ) + ( le.exportbusinessrelationships_Invalid << 19 ) + ( le.exportobjectives_Invalid << 20 ) + ( le.reference1_Invalid << 21 ) + ( le.reference2_Invalid << 22 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.addresszipcode_Invalid := (le.ScrubsBits1 >> 26) & 3;
    SELF.addresszip4_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.building_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.contact_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.phone1_Invalid := (le.ScrubsBits1 >> 31) & 3;
    SELF.phone2_Invalid := (le.ScrubsBits1 >> 33) & 3;
    SELF.phone3_Invalid := (le.ScrubsBits1 >> 35) & 3;
    SELF.cell_Invalid := (le.ScrubsBits1 >> 37) & 3;
    SELF.fax_Invalid := (le.ScrubsBits1 >> 39) & 3;
    SELF.email1_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.email2_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.email3_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.webpage1_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.webpage2_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.webpage3_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.businessname_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.dba_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.businessid_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.businesstype1_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.businesslocation1_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.businesstype2_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.businesslocation2_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.businesstype3_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.businesslocation3_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.businesstype4_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.businesslocation4_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.businesstype5_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.businesslocation5_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.industry_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.trade_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.resourcedescription_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.natureofbusiness_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.businessdescription_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.businessstructure_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.totalemployees_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.avgcontractsize_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.firmid_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.firmlocationaddress_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.firmlocationaddresscity_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.firmlocationaddresszip4_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.firmlocationaddresszipcode_Invalid := (le.ScrubsBits2 >> 8) & 3;
    SELF.firmlocationcounty_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.firmlocationstate_Invalid := (le.ScrubsBits2 >> 11) & 3;
    SELF.certfed_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.certstate_Invalid := (le.ScrubsBits2 >> 14) & 3;
    SELF.contractsfederal_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.contractsva_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.contractscommercial_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.contractorgovernmentprime_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.contractorgovernmentsub_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.contractornongovernment_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.registeredgovernmentbus_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.registerednongovernmentbus_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.clearancelevelpersonnel_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.clearancelevelfacility_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.certificatedatefrom1_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.certificatedateto1_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.certificatestatus1_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.certificationnumber1_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.certificationtype1_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.certificatedatefrom2_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.certificatedateto2_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF.certificatestatus2_Invalid := (le.ScrubsBits2 >> 33) & 1;
    SELF.certificationnumber2_Invalid := (le.ScrubsBits2 >> 34) & 1;
    SELF.certificationtype2_Invalid := (le.ScrubsBits2 >> 35) & 1;
    SELF.certificatedatefrom3_Invalid := (le.ScrubsBits2 >> 36) & 1;
    SELF.certificatedateto3_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF.certificatestatus3_Invalid := (le.ScrubsBits2 >> 38) & 1;
    SELF.certificationnumber3_Invalid := (le.ScrubsBits2 >> 39) & 1;
    SELF.certificationtype3_Invalid := (le.ScrubsBits2 >> 40) & 1;
    SELF.certificatedatefrom4_Invalid := (le.ScrubsBits2 >> 41) & 1;
    SELF.certificatedateto4_Invalid := (le.ScrubsBits2 >> 42) & 1;
    SELF.certificatestatus4_Invalid := (le.ScrubsBits2 >> 43) & 1;
    SELF.certificationnumber4_Invalid := (le.ScrubsBits2 >> 44) & 1;
    SELF.certificationtype4_Invalid := (le.ScrubsBits2 >> 45) & 1;
    SELF.certificatedatefrom5_Invalid := (le.ScrubsBits2 >> 46) & 1;
    SELF.certificatedateto5_Invalid := (le.ScrubsBits2 >> 47) & 1;
    SELF.certificatestatus5_Invalid := (le.ScrubsBits2 >> 48) & 1;
    SELF.certificationnumber5_Invalid := (le.ScrubsBits2 >> 49) & 1;
    SELF.certificationtype5_Invalid := (le.ScrubsBits2 >> 50) & 1;
    SELF.certificatedatefrom6_Invalid := (le.ScrubsBits2 >> 51) & 1;
    SELF.certificatedateto6_Invalid := (le.ScrubsBits2 >> 52) & 1;
    SELF.certificatestatus6_Invalid := (le.ScrubsBits2 >> 53) & 1;
    SELF.certificationnumber6_Invalid := (le.ScrubsBits2 >> 54) & 1;
    SELF.certificationtype6_Invalid := (le.ScrubsBits2 >> 55) & 1;
    SELF.starrating_Invalid := (le.ScrubsBits2 >> 56) & 1;
    SELF.assets_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.biddescription_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.competitiveadvantage_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.cagecode_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.capabilitiesnarrative_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.category_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.chtrclass_Invalid := (le.ScrubsBits2 >> 63) & 1;
    SELF.productdescription1_Invalid := (le.ScrubsBits3 >> 0) & 1;
    SELF.productdescription2_Invalid := (le.ScrubsBits3 >> 1) & 1;
    SELF.productdescription3_Invalid := (le.ScrubsBits3 >> 2) & 1;
    SELF.productdescription4_Invalid := (le.ScrubsBits3 >> 3) & 1;
    SELF.productdescription5_Invalid := (le.ScrubsBits3 >> 4) & 1;
    SELF.classdescription1_Invalid := (le.ScrubsBits3 >> 5) & 1;
    SELF.subclassdescription1_Invalid := (le.ScrubsBits3 >> 6) & 1;
    SELF.classdescription2_Invalid := (le.ScrubsBits3 >> 7) & 1;
    SELF.subclassdescription2_Invalid := (le.ScrubsBits3 >> 8) & 1;
    SELF.classdescription3_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.subclassdescription3_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF.classdescription4_Invalid := (le.ScrubsBits3 >> 11) & 1;
    SELF.subclassdescription4_Invalid := (le.ScrubsBits3 >> 12) & 1;
    SELF.classdescription5_Invalid := (le.ScrubsBits3 >> 13) & 1;
    SELF.subclassdescription5_Invalid := (le.ScrubsBits3 >> 14) & 1;
    SELF.classifications_Invalid := (le.ScrubsBits3 >> 15) & 1;
    SELF.commodity1_Invalid := (le.ScrubsBits3 >> 16) & 1;
    SELF.commodity2_Invalid := (le.ScrubsBits3 >> 17) & 1;
    SELF.commodity3_Invalid := (le.ScrubsBits3 >> 18) & 1;
    SELF.commodity4_Invalid := (le.ScrubsBits3 >> 19) & 1;
    SELF.commodity5_Invalid := (le.ScrubsBits3 >> 20) & 1;
    SELF.commodity6_Invalid := (le.ScrubsBits3 >> 21) & 1;
    SELF.commodity7_Invalid := (le.ScrubsBits3 >> 22) & 1;
    SELF.commodity8_Invalid := (le.ScrubsBits3 >> 23) & 1;
    SELF.completedate_Invalid := (le.ScrubsBits3 >> 24) & 1;
    SELF.crossreference_Invalid := (le.ScrubsBits3 >> 25) & 1;
    SELF.dateestablished_Invalid := (le.ScrubsBits3 >> 26) & 1;
    SELF.businessage_Invalid := (le.ScrubsBits3 >> 27) & 1;
    SELF.deposits_Invalid := (le.ScrubsBits3 >> 28) & 1;
    SELF.dunsnumber_Invalid := (le.ScrubsBits3 >> 29) & 1;
    SELF.enttype_Invalid := (le.ScrubsBits3 >> 30) & 1;
    SELF.expirationdate_Invalid := (le.ScrubsBits3 >> 31) & 1;
    SELF.extendeddate_Invalid := (le.ScrubsBits3 >> 32) & 1;
    SELF.issuingauthority_Invalid := (le.ScrubsBits3 >> 33) & 1;
    SELF.keywords_Invalid := (le.ScrubsBits3 >> 34) & 1;
    SELF.licensenumber_Invalid := (le.ScrubsBits3 >> 35) & 1;
    SELF.licensetype_Invalid := (le.ScrubsBits3 >> 36) & 1;
    SELF.mincd_Invalid := (le.ScrubsBits3 >> 37) & 1;
    SELF.minorityaffiliation_Invalid := (le.ScrubsBits3 >> 38) & 1;
    SELF.minorityownershipdate_Invalid := (le.ScrubsBits3 >> 39) & 1;
    SELF.siccode1_Invalid := (le.ScrubsBits3 >> 40) & 1;
    SELF.siccode2_Invalid := (le.ScrubsBits3 >> 41) & 1;
    SELF.siccode3_Invalid := (le.ScrubsBits3 >> 42) & 1;
    SELF.siccode4_Invalid := (le.ScrubsBits3 >> 43) & 1;
    SELF.siccode5_Invalid := (le.ScrubsBits3 >> 44) & 1;
    SELF.siccode6_Invalid := (le.ScrubsBits3 >> 45) & 1;
    SELF.siccode7_Invalid := (le.ScrubsBits3 >> 46) & 1;
    SELF.siccode8_Invalid := (le.ScrubsBits3 >> 47) & 1;
    SELF.naicscode1_Invalid := (le.ScrubsBits3 >> 48) & 1;
    SELF.naicscode2_Invalid := (le.ScrubsBits3 >> 49) & 1;
    SELF.naicscode3_Invalid := (le.ScrubsBits3 >> 50) & 1;
    SELF.naicscode4_Invalid := (le.ScrubsBits3 >> 51) & 1;
    SELF.naicscode5_Invalid := (le.ScrubsBits3 >> 52) & 1;
    SELF.naicscode6_Invalid := (le.ScrubsBits3 >> 53) & 1;
    SELF.naicscode7_Invalid := (le.ScrubsBits3 >> 54) & 1;
    SELF.naicscode8_Invalid := (le.ScrubsBits3 >> 55) & 1;
    SELF.prequalify_Invalid := (le.ScrubsBits3 >> 56) & 1;
    SELF.procurementcategory1_Invalid := (le.ScrubsBits3 >> 57) & 1;
    SELF.subprocurementcategory1_Invalid := (le.ScrubsBits3 >> 58) & 1;
    SELF.procurementcategory2_Invalid := (le.ScrubsBits3 >> 59) & 1;
    SELF.subprocurementcategory2_Invalid := (le.ScrubsBits3 >> 60) & 1;
    SELF.procurementcategory3_Invalid := (le.ScrubsBits3 >> 61) & 1;
    SELF.subprocurementcategory3_Invalid := (le.ScrubsBits3 >> 62) & 1;
    SELF.procurementcategory4_Invalid := (le.ScrubsBits3 >> 63) & 1;
    SELF.subprocurementcategory4_Invalid := (le.ScrubsBits4 >> 0) & 1;
    SELF.procurementcategory5_Invalid := (le.ScrubsBits4 >> 1) & 1;
    SELF.subprocurementcategory5_Invalid := (le.ScrubsBits4 >> 2) & 1;
    SELF.renewal_Invalid := (le.ScrubsBits4 >> 3) & 1;
    SELF.renewaldate_Invalid := (le.ScrubsBits4 >> 4) & 1;
    SELF.unitedcertprogrampartner_Invalid := (le.ScrubsBits4 >> 5) & 1;
    SELF.vendorkey_Invalid := (le.ScrubsBits4 >> 6) & 1;
    SELF.vendornumber_Invalid := (le.ScrubsBits4 >> 7) & 1;
    SELF.workcode1_Invalid := (le.ScrubsBits4 >> 8) & 1;
    SELF.workcode2_Invalid := (le.ScrubsBits4 >> 9) & 1;
    SELF.workcode3_Invalid := (le.ScrubsBits4 >> 10) & 1;
    SELF.workcode4_Invalid := (le.ScrubsBits4 >> 11) & 1;
    SELF.workcode5_Invalid := (le.ScrubsBits4 >> 12) & 1;
    SELF.workcode6_Invalid := (le.ScrubsBits4 >> 13) & 1;
    SELF.workcode7_Invalid := (le.ScrubsBits4 >> 14) & 1;
    SELF.workcode8_Invalid := (le.ScrubsBits4 >> 15) & 1;
    SELF.exporter_Invalid := (le.ScrubsBits4 >> 16) & 1;
    SELF.exportbusinessactivities_Invalid := (le.ScrubsBits4 >> 17) & 1;
    SELF.exportto_Invalid := (le.ScrubsBits4 >> 18) & 1;
    SELF.exportbusinessrelationships_Invalid := (le.ScrubsBits4 >> 19) & 1;
    SELF.exportobjectives_Invalid := (le.ScrubsBits4 >> 20) & 1;
    SELF.reference1_Invalid := (le.ScrubsBits4 >> 21) & 1;
    SELF.reference2_Invalid := (le.ScrubsBits4 >> 22) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  END;
  EXPORT AllErrors := NORMALIZE(h,204,Into(LEFT,COUNTER));
