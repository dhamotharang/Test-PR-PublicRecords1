...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 208;
  EXPORT NumRulesFromFieldType := 208;
  ...
  SHARED toRuleDesc(UNSIGNED c) := CHOOSE(c
          ...
          ,'addresszipcode:Invalid_Zip:LEFTTRIM','addresszipcode:Invalid_Zip:ALLOW','addresszipcode:Invalid_Zip:LENGTHS'
          ...
          ,'firmlocationaddresszipcode:Invalid_Zip:LEFTTRIM','firmlocationaddresszipcode:Invalid_Zip:ALLOW','firmlocationaddresszipcode:Invalid_Zip:LENGTHS'
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ...
          ,Input_Fields.InvalidMessage_addresszipcode(1),Input_Fields.InvalidMessage_addresszipcode(2),Input_Fields.InvalidMessage_addresszipcode(3)
          ...
          ,Input_Fields.InvalidMessage_firmlocationaddresszipcode(1),Input_Fields.InvalidMessage_firmlocationaddresszipcode(2),Input_Fields.InvalidMessage_firmlocationaddresszipcode(3)
...
EXPORT FromNone(DATASET(Input_Layout_Diversity_Certification) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dartid_Invalid << 0 ) + ( le.dateadded_Invalid << 1 ) + ( le.dateupdated_Invalid << 2 ) + ( le.website_Invalid << 3 ) + ( le.state_Invalid << 4 ) + ( le.profilelastupdated_Invalid << 5 ) + ( le.county_Invalid << 6 ) + ( le.servicearea_Invalid << 7 ) + ( le.region1_Invalid << 8 ) + ( le.region2_Invalid << 9 ) + ( le.region3_Invalid << 10 ) + ( le.region4_Invalid << 11 ) + ( le.region5_Invalid << 12 ) + ( le.fname_Invalid << 13 ) + ( le.lname_Invalid << 14 ) + ( le.mname_Invalid << 15 ) + ( le.suffix_Invalid << 16 ) + ( le.title_Invalid << 17 ) + ( le.ethnicity_Invalid << 18 ) + ( le.gender_Invalid << 19 ) + ( le.address1_Invalid << 20 ) + ( le.address2_Invalid << 21 ) + ( le.addresscity_Invalid << 22 ) + ( le.addressstate_Invalid << 23 ) + ( le.addresszipcode_Invalid << 24 ) + ( le.addresszip4_Invalid << 26 ) + ( le.building_Invalid << 27 ) + ( le.contact_Invalid << 28 ) + ( le.phone1_Invalid << 29 ) + ( le.phone2_Invalid << 30 ) + ( le.phone3_Invalid << 31 ) + ( le.cell_Invalid << 32 ) + ( le.fax_Invalid << 33 ) + ( le.email1_Invalid << 34 ) + ( le.email2_Invalid << 35 ) + ( le.email3_Invalid << 36 ) + ( le.webpage1_Invalid << 37 ) + ( le.webpage2_Invalid << 38 ) + ( le.webpage3_Invalid << 39 ) + ( le.businessname_Invalid << 40 ) + ( le.dba_Invalid << 41 ) + ( le.businessid_Invalid << 42 ) + ( le.businesstype1_Invalid << 43 ) + ( le.businesslocation1_Invalid << 44 ) + ( le.businesstype2_Invalid << 45 ) + ( le.businesslocation2_Invalid << 46 ) + ( le.businesstype3_Invalid << 47 ) + ( le.businesslocation3_Invalid << 48 ) + ( le.businesstype4_Invalid << 49 ) + ( le.businesslocation4_Invalid << 50 ) + ( le.businesstype5_Invalid << 51 ) + ( le.businesslocation5_Invalid << 52 ) + ( le.industry_Invalid << 53 ) + ( le.trade_Invalid << 54 ) + ( le.resourcedescription_Invalid << 55 ) + ( le.natureofbusiness_Invalid << 56 ) + ( le.businessdescription_Invalid << 57 ) + ( le.businessstructure_Invalid << 58 ) + ( le.totalemployees_Invalid << 59 ) + ( le.avgcontractsize_Invalid << 60 ) + ( le.firmid_Invalid << 61 ) + ( le.firmlocationaddress_Invalid << 62 ) + ( le.firmlocationaddresscity_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.firmlocationaddresszip4_Invalid << 0 ) + ( le.firmlocationaddresszipcode_Invalid << 1 ) + ( le.firmlocationcounty_Invalid << 3 ) + ( le.firmlocationstate_Invalid << 4 ) + ( le.certfed_Invalid << 5 ) + ( le.certstate_Invalid << 6 ) + ( le.contractsfederal_Invalid << 7 ) + ( le.contractsva_Invalid << 8 ) + ( le.contractscommercial_Invalid << 9 ) + ( le.contractorgovernmentprime_Invalid << 10 ) + ( le.contractorgovernmentsub_Invalid << 11 ) + ( le.contractornongovernment_Invalid << 12 ) + ( le.registeredgovernmentbus_Invalid << 13 ) + ( le.registerednongovernmentbus_Invalid << 14 ) + ( le.clearancelevelpersonnel_Invalid << 15 ) + ( le.clearancelevelfacility_Invalid << 16 ) + ( le.certificatedatefrom1_Invalid << 17 ) + ( le.certificatedateto1_Invalid << 18 ) + ( le.certificatestatus1_Invalid << 19 ) + ( le.certificationnumber1_Invalid << 20 ) + ( le.certificationtype1_Invalid << 21 ) + ( le.certificatedatefrom2_Invalid << 22 ) + ( le.certificatedateto2_Invalid << 23 ) + ( le.certificatestatus2_Invalid << 24 ) + ( le.certificationnumber2_Invalid << 25 ) + ( le.certificationtype2_Invalid << 26 ) + ( le.certificatedatefrom3_Invalid << 27 ) + ( le.certificatedateto3_Invalid << 28 ) + ( le.certificatestatus3_Invalid << 29 ) + ( le.certificationnumber3_Invalid << 30 ) + ( le.certificationtype3_Invalid << 31 ) + ( le.certificatedatefrom4_Invalid << 32 ) + ( le.certificatedateto4_Invalid << 33 ) + ( le.certificatestatus4_Invalid << 34 ) + ( le.certificationnumber4_Invalid << 35 ) + ( le.certificationtype4_Invalid << 36 ) + ( le.certificatedatefrom5_Invalid << 37 ) + ( le.certificatedateto5_Invalid << 38 ) + ( le.certificatestatus5_Invalid << 39 ) + ( le.certificationnumber5_Invalid << 40 ) + ( le.certificationtype5_Invalid << 41 ) + ( le.certificatedatefrom6_Invalid << 42 ) + ( le.certificatedateto6_Invalid << 43 ) + ( le.certificatestatus6_Invalid << 44 ) + ( le.certificationnumber6_Invalid << 45 ) + ( le.certificationtype6_Invalid << 46 ) + ( le.starrating_Invalid << 47 ) + ( le.assets_Invalid << 48 ) + ( le.biddescription_Invalid << 49 ) + ( le.competitiveadvantage_Invalid << 50 ) + ( le.cagecode_Invalid << 51 ) + ( le.capabilitiesnarrative_Invalid << 52 ) + ( le.category_Invalid << 53 ) + ( le.chtrclass_Invalid << 54 ) + ( le.productdescription1_Invalid << 55 ) + ( le.productdescription2_Invalid << 56 ) + ( le.productdescription3_Invalid << 57 ) + ( le.productdescription4_Invalid << 58 ) + ( le.productdescription5_Invalid << 59 ) + ( le.classdescription1_Invalid << 60 ) + ( le.subclassdescription1_Invalid << 61 ) + ( le.classdescription2_Invalid << 62 ) + ( le.subclassdescription2_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.classdescription3_Invalid << 0 ) + ( le.subclassdescription3_Invalid << 1 ) + ( le.classdescription4_Invalid << 2 ) + ( le.subclassdescription4_Invalid << 3 ) + ( le.classdescription5_Invalid << 4 ) + ( le.subclassdescription5_Invalid << 5 ) + ( le.classifications_Invalid << 6 ) + ( le.commodity1_Invalid << 7 ) + ( le.commodity2_Invalid << 8 ) + ( le.commodity3_Invalid << 9 ) + ( le.commodity4_Invalid << 10 ) + ( le.commodity5_Invalid << 11 ) + ( le.commodity6_Invalid << 12 ) + ( le.commodity7_Invalid << 13 ) + ( le.commodity8_Invalid << 14 ) + ( le.completedate_Invalid << 15 ) + ( le.crossreference_Invalid << 16 ) + ( le.dateestablished_Invalid << 17 ) + ( le.businessage_Invalid << 18 ) + ( le.deposits_Invalid << 19 ) + ( le.dunsnumber_Invalid << 20 ) + ( le.enttype_Invalid << 21 ) + ( le.expirationdate_Invalid << 22 ) + ( le.extendeddate_Invalid << 23 ) + ( le.issuingauthority_Invalid << 24 ) + ( le.keywords_Invalid << 25 ) + ( le.licensenumber_Invalid << 26 ) + ( le.licensetype_Invalid << 27 ) + ( le.mincd_Invalid << 28 ) + ( le.minorityaffiliation_Invalid << 29 ) + ( le.minorityownershipdate_Invalid << 30 ) + ( le.siccode1_Invalid << 31 ) + ( le.siccode2_Invalid << 32 ) + ( le.siccode3_Invalid << 33 ) + ( le.siccode4_Invalid << 34 ) + ( le.siccode5_Invalid << 35 ) + ( le.siccode6_Invalid << 36 ) + ( le.siccode7_Invalid << 37 ) + ( le.siccode8_Invalid << 38 ) + ( le.naicscode1_Invalid << 39 ) + ( le.naicscode2_Invalid << 40 ) + ( le.naicscode3_Invalid << 41 ) + ( le.naicscode4_Invalid << 42 ) + ( le.naicscode5_Invalid << 43 ) + ( le.naicscode6_Invalid << 44 ) + ( le.naicscode7_Invalid << 45 ) + ( le.naicscode8_Invalid << 46 ) + ( le.prequalify_Invalid << 47 ) + ( le.procurementcategory1_Invalid << 48 ) + ( le.subprocurementcategory1_Invalid << 49 ) + ( le.procurementcategory2_Invalid << 50 ) + ( le.subprocurementcategory2_Invalid << 51 ) + ( le.procurementcategory3_Invalid << 52 ) + ( le.subprocurementcategory3_Invalid << 53 ) + ( le.procurementcategory4_Invalid << 54 ) + ( le.subprocurementcategory4_Invalid << 55 ) + ( le.procurementcategory5_Invalid << 56 ) + ( le.subprocurementcategory5_Invalid << 57 ) + ( le.renewal_Invalid << 58 ) + ( le.renewaldate_Invalid << 59 ) + ( le.unitedcertprogrampartner_Invalid << 60 ) + ( le.vendorkey_Invalid << 61 ) + ( le.vendornumber_Invalid << 62 ) + ( le.workcode1_Invalid << 63 );
    SELF.ScrubsBits4 := ( le.workcode2_Invalid << 0 ) + ( le.workcode3_Invalid << 1 ) + ( le.workcode4_Invalid << 2 ) + ( le.workcode5_Invalid << 3 ) + ( le.workcode6_Invalid << 4 ) + ( le.workcode7_Invalid << 5 ) + ( le.workcode8_Invalid << 6 ) + ( le.exporter_Invalid << 7 ) + ( le.exportbusinessactivities_Invalid << 8 ) + ( le.exportto_Invalid << 9 ) + ( le.exportbusinessrelationships_Invalid << 10 ) + ( le.exportobjectives_Invalid << 11 ) + ( le.reference1_Invalid << 12 ) + ( le.reference2_Invalid << 13 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.businessdescription_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.businessstructure_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.totalemployees_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.avgcontractsize_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.firmid_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.firmlocationaddress_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.firmlocationaddresscity_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.firmlocationaddresszip4_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.firmlocationaddresszipcode_Invalid := (le.ScrubsBits2 >> 1) & 3;
    SELF.firmlocationcounty_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.firmlocationstate_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.certfed_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.certstate_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.contractsfederal_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.contractsva_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.contractscommercial_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.contractorgovernmentprime_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.contractorgovernmentsub_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.contractornongovernment_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.registeredgovernmentbus_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.registerednongovernmentbus_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.clearancelevelpersonnel_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.clearancelevelfacility_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.certificatedatefrom1_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.certificatedateto1_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.certificatestatus1_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.certificationnumber1_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.certificationtype1_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.certificatedatefrom2_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.certificatedateto2_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.certificatestatus2_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.certificationnumber2_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.certificationtype2_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.certificatedatefrom3_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.certificatedateto3_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.certificatestatus3_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.certificationnumber3_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.certificationtype3_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.certificatedatefrom4_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF.certificatedateto4_Invalid := (le.ScrubsBits2 >> 33) & 1;
    SELF.certificatestatus4_Invalid := (le.ScrubsBits2 >> 34) & 1;
    SELF.certificationnumber4_Invalid := (le.ScrubsBits2 >> 35) & 1;
    SELF.certificationtype4_Invalid := (le.ScrubsBits2 >> 36) & 1;
    SELF.certificatedatefrom5_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF.certificatedateto5_Invalid := (le.ScrubsBits2 >> 38) & 1;
    SELF.certificatestatus5_Invalid := (le.ScrubsBits2 >> 39) & 1;
    SELF.certificationnumber5_Invalid := (le.ScrubsBits2 >> 40) & 1;
    SELF.certificationtype5_Invalid := (le.ScrubsBits2 >> 41) & 1;
    SELF.certificatedatefrom6_Invalid := (le.ScrubsBits2 >> 42) & 1;
    SELF.certificatedateto6_Invalid := (le.ScrubsBits2 >> 43) & 1;
    SELF.certificatestatus6_Invalid := (le.ScrubsBits2 >> 44) & 1;
    SELF.certificationnumber6_Invalid := (le.ScrubsBits2 >> 45) & 1;
    SELF.certificationtype6_Invalid := (le.ScrubsBits2 >> 46) & 1;
    SELF.starrating_Invalid := (le.ScrubsBits2 >> 47) & 1;
    SELF.assets_Invalid := (le.ScrubsBits2 >> 48) & 1;
    SELF.biddescription_Invalid := (le.ScrubsBits2 >> 49) & 1;
    SELF.competitiveadvantage_Invalid := (le.ScrubsBits2 >> 50) & 1;
    SELF.cagecode_Invalid := (le.ScrubsBits2 >> 51) & 1;
    SELF.capabilitiesnarrative_Invalid := (le.ScrubsBits2 >> 52) & 1;
    SELF.category_Invalid := (le.ScrubsBits2 >> 53) & 1;
    SELF.chtrclass_Invalid := (le.ScrubsBits2 >> 54) & 1;
    SELF.productdescription1_Invalid := (le.ScrubsBits2 >> 55) & 1;
    SELF.productdescription2_Invalid := (le.ScrubsBits2 >> 56) & 1;
    SELF.productdescription3_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.productdescription4_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.productdescription5_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.classdescription1_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.subclassdescription1_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.classdescription2_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.subclassdescription2_Invalid := (le.ScrubsBits2 >> 63) & 1;
    SELF.classdescription3_Invalid := (le.ScrubsBits3 >> 0) & 1;
    SELF.subclassdescription3_Invalid := (le.ScrubsBits3 >> 1) & 1;
    SELF.classdescription4_Invalid := (le.ScrubsBits3 >> 2) & 1;
    SELF.subclassdescription4_Invalid := (le.ScrubsBits3 >> 3) & 1;
    SELF.classdescription5_Invalid := (le.ScrubsBits3 >> 4) & 1;
    SELF.subclassdescription5_Invalid := (le.ScrubsBits3 >> 5) & 1;
    SELF.classifications_Invalid := (le.ScrubsBits3 >> 6) & 1;
    SELF.commodity1_Invalid := (le.ScrubsBits3 >> 7) & 1;
    SELF.commodity2_Invalid := (le.ScrubsBits3 >> 8) & 1;
    SELF.commodity3_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.commodity4_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF.commodity5_Invalid := (le.ScrubsBits3 >> 11) & 1;
    SELF.commodity6_Invalid := (le.ScrubsBits3 >> 12) & 1;
    SELF.commodity7_Invalid := (le.ScrubsBits3 >> 13) & 1;
    SELF.commodity8_Invalid := (le.ScrubsBits3 >> 14) & 1;
    SELF.completedate_Invalid := (le.ScrubsBits3 >> 15) & 1;
    SELF.crossreference_Invalid := (le.ScrubsBits3 >> 16) & 1;
    SELF.dateestablished_Invalid := (le.ScrubsBits3 >> 17) & 1;
    SELF.businessage_Invalid := (le.ScrubsBits3 >> 18) & 1;
    SELF.deposits_Invalid := (le.ScrubsBits3 >> 19) & 1;
    SELF.dunsnumber_Invalid := (le.ScrubsBits3 >> 20) & 1;
    SELF.enttype_Invalid := (le.ScrubsBits3 >> 21) & 1;
    SELF.expirationdate_Invalid := (le.ScrubsBits3 >> 22) & 1;
    SELF.extendeddate_Invalid := (le.ScrubsBits3 >> 23) & 1;
    SELF.issuingauthority_Invalid := (le.ScrubsBits3 >> 24) & 1;
    SELF.keywords_Invalid := (le.ScrubsBits3 >> 25) & 1;
    SELF.licensenumber_Invalid := (le.ScrubsBits3 >> 26) & 1;
    SELF.licensetype_Invalid := (le.ScrubsBits3 >> 27) & 1;
    SELF.mincd_Invalid := (le.ScrubsBits3 >> 28) & 1;
    SELF.minorityaffiliation_Invalid := (le.ScrubsBits3 >> 29) & 1;
    SELF.minorityownershipdate_Invalid := (le.ScrubsBits3 >> 30) & 1;
    SELF.siccode1_Invalid := (le.ScrubsBits3 >> 31) & 1;
    SELF.siccode2_Invalid := (le.ScrubsBits3 >> 32) & 1;
    SELF.siccode3_Invalid := (le.ScrubsBits3 >> 33) & 1;
    SELF.siccode4_Invalid := (le.ScrubsBits3 >> 34) & 1;
    SELF.siccode5_Invalid := (le.ScrubsBits3 >> 35) & 1;
    SELF.siccode6_Invalid := (le.ScrubsBits3 >> 36) & 1;
    SELF.siccode7_Invalid := (le.ScrubsBits3 >> 37) & 1;
    SELF.siccode8_Invalid := (le.ScrubsBits3 >> 38) & 1;
    SELF.naicscode1_Invalid := (le.ScrubsBits3 >> 39) & 1;
    SELF.naicscode2_Invalid := (le.ScrubsBits3 >> 40) & 1;
    SELF.naicscode3_Invalid := (le.ScrubsBits3 >> 41) & 1;
    SELF.naicscode4_Invalid := (le.ScrubsBits3 >> 42) & 1;
    SELF.naicscode5_Invalid := (le.ScrubsBits3 >> 43) & 1;
    SELF.naicscode6_Invalid := (le.ScrubsBits3 >> 44) & 1;
    SELF.naicscode7_Invalid := (le.ScrubsBits3 >> 45) & 1;
    SELF.naicscode8_Invalid := (le.ScrubsBits3 >> 46) & 1;
    SELF.prequalify_Invalid := (le.ScrubsBits3 >> 47) & 1;
    SELF.procurementcategory1_Invalid := (le.ScrubsBits3 >> 48) & 1;
    SELF.subprocurementcategory1_Invalid := (le.ScrubsBits3 >> 49) & 1;
    SELF.procurementcategory2_Invalid := (le.ScrubsBits3 >> 50) & 1;
    SELF.subprocurementcategory2_Invalid := (le.ScrubsBits3 >> 51) & 1;
    SELF.procurementcategory3_Invalid := (le.ScrubsBits3 >> 52) & 1;
    SELF.subprocurementcategory3_Invalid := (le.ScrubsBits3 >> 53) & 1;
    SELF.procurementcategory4_Invalid := (le.ScrubsBits3 >> 54) & 1;
    SELF.subprocurementcategory4_Invalid := (le.ScrubsBits3 >> 55) & 1;
    SELF.procurementcategory5_Invalid := (le.ScrubsBits3 >> 56) & 1;
    SELF.subprocurementcategory5_Invalid := (le.ScrubsBits3 >> 57) & 1;
    SELF.renewal_Invalid := (le.ScrubsBits3 >> 58) & 1;
    SELF.renewaldate_Invalid := (le.ScrubsBits3 >> 59) & 1;
    SELF.unitedcertprogrampartner_Invalid := (le.ScrubsBits3 >> 60) & 1;
    SELF.vendorkey_Invalid := (le.ScrubsBits3 >> 61) & 1;
    SELF.vendornumber_Invalid := (le.ScrubsBits3 >> 62) & 1;
    SELF.workcode1_Invalid := (le.ScrubsBits3 >> 63) & 1;
    SELF.workcode2_Invalid := (le.ScrubsBits4 >> 0) & 1;
    SELF.workcode3_Invalid := (le.ScrubsBits4 >> 1) & 1;
    SELF.workcode4_Invalid := (le.ScrubsBits4 >> 2) & 1;
    SELF.workcode5_Invalid := (le.ScrubsBits4 >> 3) & 1;
    SELF.workcode6_Invalid := (le.ScrubsBits4 >> 4) & 1;
    SELF.workcode7_Invalid := (le.ScrubsBits4 >> 5) & 1;
    SELF.workcode8_Invalid := (le.ScrubsBits4 >> 6) & 1;
    SELF.exporter_Invalid := (le.ScrubsBits4 >> 7) & 1;
    SELF.exportbusinessactivities_Invalid := (le.ScrubsBits4 >> 8) & 1;
    SELF.exportto_Invalid := (le.ScrubsBits4 >> 9) & 1;
    SELF.exportbusinessrelationships_Invalid := (le.ScrubsBits4 >> 10) & 1;
    SELF.exportobjectives_Invalid := (le.ScrubsBits4 >> 11) & 1;
    SELF.reference1_Invalid := (le.ScrubsBits4 >> 12) & 1;
    SELF.reference2_Invalid := (le.ScrubsBits4 >> 13) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    addresszipcode_LEFTTRIM_ErrorCount := COUNT(GROUP,h.addresszipcode_Invalid=1);
    addresszipcode_ALLOW_ErrorCount := COUNT(GROUP,h.addresszipcode_Invalid=2);
    addresszipcode_LENGTHS_ErrorCount := COUNT(GROUP,h.addresszipcode_Invalid=3);
    ...
    firmlocationaddresszipcode_LEFTTRIM_ErrorCount := COUNT(GROUP,h.firmlocationaddresszipcode_Invalid=1);
    firmlocationaddresszipcode_ALLOW_ErrorCount := COUNT(GROUP,h.firmlocationaddresszipcode_Invalid=2);
    firmlocationaddresszipcode_LENGTHS_ErrorCount := COUNT(GROUP,h.firmlocationaddresszipcode_Invalid=3);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.addresszipcode_Invalid,'LEFTTRIM','ALLOW','LENGTHS','UNKNOWN')
          ...
          ,CHOOSE(le.firmlocationaddresszipcode_Invalid,'LEFTTRIM','ALLOW','LENGTHS','UNKNOWN')
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.addresszipcode_LEFTTRIM_ErrorCount,le.addresszipcode_ALLOW_ErrorCount,le.addresszipcode_LENGTHS_ErrorCount
          ...
          ,le.firmlocationaddresszipcode_LEFTTRIM_ErrorCount,le.firmlocationaddresszipcode_ALLOW_ErrorCount,le.firmlocationaddresszipcode_LENGTHS_ErrorCount
