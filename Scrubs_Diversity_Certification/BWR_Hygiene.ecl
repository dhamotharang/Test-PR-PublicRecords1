...
#workunit('name','Scrubs_Diversity_Certification.BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
...
// First create an instantiated hygiene module
  ...
  h := Scrubs_Diversity_Certification.hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_Diversity_Certification'),NAMED('OptimizedLayout'));// File layout suggested by data
