...
+    #IF( #TEXT(Input_businessdescription)='' )
      '' 
    #ELSE
        IF( le.Input_businessdescription = (TYPEOF(le.Input_businessdescription))'','',':businessdescription')
    #END
