IMPORT SALT311,STD;
EXPORT hygiene(dataset(layout_Diversity_Certification) h) := MODULE
...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_businessdescription_cnt := COUNT(GROUP,h.businessdescription <> (TYPEOF(h.businessdescription))'');
    populated_businessdescription_pcnt := AVE(GROUP,IF(h.businessdescription = (TYPEOF(h.businessdescription))'',0,100));
    maxlength_businessdescription := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.businessdescription)));
    avelength_businessdescription := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.businessdescription)),h.businessdescription<>(typeof(h.businessdescription))'');
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),205*205,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'dartid'}
      ...
      ,{56,'natureofbusiness'}
      ,{57,'businessdescription'}
      ,{58,'businessstructure'}
      ,{59,'totalemployees'}
      ,{60,'avgcontractsize'}
      ,{61,'firmid'}
      ,{62,'firmlocationaddress'}
      ,{63,'firmlocationaddresscity'}
      ,{64,'firmlocationaddresszip4'}
      ,{65,'firmlocationaddresszipcode'}
      ,{66,'firmlocationcounty'}
      ,{67,'firmlocationstate'}
      ,{68,'certfed'}
      ,{69,'certstate'}
      ,{70,'contractsfederal'}
      ,{71,'contractsva'}
      ,{72,'contractscommercial'}
      ,{73,'contractorgovernmentprime'}
      ,{74,'contractorgovernmentsub'}
      ,{75,'contractornongovernment'}
      ,{76,'registeredgovernmentbus'}
      ,{77,'registerednongovernmentbus'}
      ,{78,'clearancelevelpersonnel'}
      ,{79,'clearancelevelfacility'}
      ,{80,'certificatedatefrom1'}
      ,{81,'certificatedateto1'}
      ,{82,'certificatestatus1'}
      ,{83,'certificationnumber1'}
      ,{84,'certificationtype1'}
      ,{85,'certificatedatefrom2'}
      ,{86,'certificatedateto2'}
      ,{87,'certificatestatus2'}
      ,{88,'certificationnumber2'}
      ,{89,'certificationtype2'}
      ,{90,'certificatedatefrom3'}
      ,{91,'certificatedateto3'}
      ,{92,'certificatestatus3'}
      ,{93,'certificationnumber3'}
      ,{94,'certificationtype3'}
      ,{95,'certificatedatefrom4'}
      ,{96,'certificatedateto4'}
      ,{97,'certificatestatus4'}
      ,{98,'certificationnumber4'}
      ,{99,'certificationtype4'}
      ,{100,'certificatedatefrom5'}
      ,{101,'certificatedateto5'}
      ,{102,'certificatestatus5'}
      ,{103,'certificationnumber5'}
      ,{104,'certificationtype5'}
      ,{105,'certificatedatefrom6'}
      ,{106,'certificatedateto6'}
      ,{107,'certificatestatus6'}
      ,{108,'certificationnumber6'}
      ,{109,'certificationtype6'}
      ,{110,'starrating'}
      ,{111,'assets'}
      ,{112,'biddescription'}
      ,{113,'competitiveadvantage'}
      ,{114,'cagecode'}
      ,{115,'capabilitiesnarrative'}
      ,{116,'category'}
      ,{117,'chtrclass'}
      ,{118,'productdescription1'}
      ,{119,'productdescription2'}
      ,{120,'productdescription3'}
      ,{121,'productdescription4'}
      ,{122,'productdescription5'}
      ,{123,'classdescription1'}
      ,{124,'subclassdescription1'}
      ,{125,'classdescription2'}
      ,{126,'subclassdescription2'}
      ,{127,'classdescription3'}
      ,{128,'subclassdescription3'}
      ,{129,'classdescription4'}
      ,{130,'subclassdescription4'}
      ,{131,'classdescription5'}
      ,{132,'subclassdescription5'}
      ,{133,'classifications'}
      ,{134,'commodity1'}
      ,{135,'commodity2'}
      ,{136,'commodity3'}
      ...
      ,{149,'expirationdate'}
      ,{150,'extendeddate'}
      ,{151,'issuingauthority'}
      ,{152,'keywords'}
      ,{153,'licensenumber'}
      ,{154,'licensetype'}
      ,{155,'mincd'}
      ,{156,'minorityaffiliation'}
      ,{157,'minorityownershipdate'}
      ,{158,'siccode1'}
      ,{159,'siccode2'}
      ,{160,'siccode3'}
      ,{161,'siccode4'}
      ...
      ,{173,'naicscode8'}
      ,{174,'prequalify'}
      ,{175,'procurementcategory1'}
      ,{176,'subprocurementcategory1'}
      ,{177,'procurementcategory2'}
      ,{178,'subprocurementcategory2'}
      ,{179,'procurementcategory3'}
      ,{180,'subprocurementcategory3'}
      ,{181,'procurementcategory4'}
      ,{182,'subprocurementcategory4'}
      ,{183,'procurementcategory5'}
      ,{184,'subprocurementcategory5'}
      ,{185,'renewal'}
      ,{186,'renewaldate'}
      ,{187,'unitedcertprogrampartner'}
      ,{188,'vendorkey'}
      ,{189,'vendornumber'}
      ,{190,'workcode1'}
      ,{191,'workcode2'}
      ...
      ,{197,'workcode8'}
      ,{198,'exporter'}
      ,{199,'exportbusinessactivities'}
      ,{200,'exportto'}
      ,{201,'exportbusinessrelationships'}
      ,{202,'exportobjectives'}
      ,{203,'reference1'}
      ,{204,'reference2'}
      ,{205,'reference3'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_profilelastupdated((SALT311.StrType)le.profilelastupdated),
    Fields.InValid_county((SALT311.StrType)le.county),
    Fields.InValid_servicearea((SALT311.StrType)le.servicearea),
    Fields.InValid_region1((SALT311.StrType)le.region1),
    Fields.InValid_region2((SALT311.StrType)le.region2),
    Fields.InValid_region3((SALT311.StrType)le.region3),
    Fields.InValid_region4((SALT311.StrType)le.region4),
    Fields.InValid_region5((SALT311.StrType)le.region5),
    ...
    Fields.InValid_ethnicity((SALT311.StrType)le.ethnicity),
    ...
    Fields.InValid_addresscity((SALT311.StrType)le.addresscity),
    Fields.InValid_addressstate((SALT311.StrType)le.addressstate),
    Fields.InValid_addresszipcode((SALT311.StrType)le.addresszipcode),
    Fields.InValid_addresszip4((SALT311.StrType)le.addresszip4),
    Fields.InValid_building((SALT311.StrType)le.building),
    Fields.InValid_contact((SALT311.StrType)le.contact),
    Fields.InValid_phone1((SALT311.StrType)le.phone1),
    Fields.InValid_phone2((SALT311.StrType)le.phone2),
    Fields.InValid_phone3((SALT311.StrType)le.phone3),
    Fields.InValid_cell((SALT311.StrType)le.cell),
    Fields.InValid_fax((SALT311.StrType)le.fax),
    Fields.InValid_email1((SALT311.StrType)le.email1),
    Fields.InValid_email2((SALT311.StrType)le.email2),
    Fields.InValid_email3((SALT311.StrType)le.email3),
    Fields.InValid_webpage1((SALT311.StrType)le.webpage1),
    Fields.InValid_webpage2((SALT311.StrType)le.webpage2),
    Fields.InValid_webpage3((SALT311.StrType)le.webpage3),
    Fields.InValid_businessname((SALT311.StrType)le.businessname),
    Fields.InValid_dba((SALT311.StrType)le.dba),
    Fields.InValid_businessid((SALT311.StrType)le.businessid),
    Fields.InValid_businesstype1((SALT311.StrType)le.businesstype1),
    Fields.InValid_businesslocation1((SALT311.StrType)le.businesslocation1),
    Fields.InValid_businesstype2((SALT311.StrType)le.businesstype2),
    Fields.InValid_businesslocation2((SALT311.StrType)le.businesslocation2),
    Fields.InValid_businesstype3((SALT311.StrType)le.businesstype3),
    Fields.InValid_businesslocation3((SALT311.StrType)le.businesslocation3),
    Fields.InValid_businesstype4((SALT311.StrType)le.businesstype4),
    Fields.InValid_businesslocation4((SALT311.StrType)le.businesslocation4),
    Fields.InValid_businesstype5((SALT311.StrType)le.businesstype5),
    Fields.InValid_businesslocation5((SALT311.StrType)le.businesslocation5),
    Fields.InValid_industry((SALT311.StrType)le.industry),
    Fields.InValid_trade((SALT311.StrType)le.trade),
    Fields.InValid_resourcedescription((SALT311.StrType)le.resourcedescription),
    Fields.InValid_natureofbusiness((SALT311.StrType)le.natureofbusiness),
    Fields.InValid_businessdescription((SALT311.StrType)le.businessdescription),
    Fields.InValid_businessstructure((SALT311.StrType)le.businessstructure),
    Fields.InValid_totalemployees((SALT311.StrType)le.totalemployees),
    Fields.InValid_avgcontractsize((SALT311.StrType)le.avgcontractsize),
    Fields.InValid_firmid((SALT311.StrType)le.firmid),
    Fields.InValid_firmlocationaddress((SALT311.StrType)le.firmlocationaddress),
    Fields.InValid_firmlocationaddresscity((SALT311.StrType)le.firmlocationaddresscity),
    Fields.InValid_firmlocationaddresszip4((SALT311.StrType)le.firmlocationaddresszip4),
    Fields.InValid_firmlocationaddresszipcode((SALT311.StrType)le.firmlocationaddresszipcode),
    Fields.InValid_firmlocationcounty((SALT311.StrType)le.firmlocationcounty),
    Fields.InValid_firmlocationstate((SALT311.StrType)le.firmlocationstate),
    Fields.InValid_certfed((SALT311.StrType)le.certfed),
    Fields.InValid_certstate((SALT311.StrType)le.certstate),
    Fields.InValid_contractsfederal((SALT311.StrType)le.contractsfederal),
    Fields.InValid_contractsva((SALT311.StrType)le.contractsva),
    Fields.InValid_contractscommercial((SALT311.StrType)le.contractscommercial),
    Fields.InValid_contractorgovernmentprime((SALT311.StrType)le.contractorgovernmentprime),
    Fields.InValid_contractorgovernmentsub((SALT311.StrType)le.contractorgovernmentsub),
    Fields.InValid_contractornongovernment((SALT311.StrType)le.contractornongovernment),
    Fields.InValid_registeredgovernmentbus((SALT311.StrType)le.registeredgovernmentbus),
    Fields.InValid_registerednongovernmentbus((SALT311.StrType)le.registerednongovernmentbus),
    Fields.InValid_clearancelevelpersonnel((SALT311.StrType)le.clearancelevelpersonnel),
    Fields.InValid_clearancelevelfacility((SALT311.StrType)le.clearancelevelfacility),
    Fields.InValid_certificatedatefrom1((SALT311.StrType)le.certificatedatefrom1),
    Fields.InValid_certificatedateto1((SALT311.StrType)le.certificatedateto1),
    Fields.InValid_certificatestatus1((SALT311.StrType)le.certificatestatus1),
    Fields.InValid_certificationnumber1((SALT311.StrType)le.certificationnumber1),
    Fields.InValid_certificationtype1((SALT311.StrType)le.certificationtype1),
    Fields.InValid_certificatedatefrom2((SALT311.StrType)le.certificatedatefrom2),
    Fields.InValid_certificatedateto2((SALT311.StrType)le.certificatedateto2),
    Fields.InValid_certificatestatus2((SALT311.StrType)le.certificatestatus2),
    Fields.InValid_certificationnumber2((SALT311.StrType)le.certificationnumber2),
    Fields.InValid_certificationtype2((SALT311.StrType)le.certificationtype2),
    Fields.InValid_certificatedatefrom3((SALT311.StrType)le.certificatedatefrom3),
    Fields.InValid_certificatedateto3((SALT311.StrType)le.certificatedateto3),
    Fields.InValid_certificatestatus3((SALT311.StrType)le.certificatestatus3),
    Fields.InValid_certificationnumber3((SALT311.StrType)le.certificationnumber3),
    Fields.InValid_certificationtype3((SALT311.StrType)le.certificationtype3),
    Fields.InValid_certificatedatefrom4((SALT311.StrType)le.certificatedatefrom4),
    Fields.InValid_certificatedateto4((SALT311.StrType)le.certificatedateto4),
    Fields.InValid_certificatestatus4((SALT311.StrType)le.certificatestatus4),
    Fields.InValid_certificationnumber4((SALT311.StrType)le.certificationnumber4),
    Fields.InValid_certificationtype4((SALT311.StrType)le.certificationtype4),
    Fields.InValid_certificatedatefrom5((SALT311.StrType)le.certificatedatefrom5),
    Fields.InValid_certificatedateto5((SALT311.StrType)le.certificatedateto5),
    Fields.InValid_certificatestatus5((SALT311.StrType)le.certificatestatus5),
    Fields.InValid_certificationnumber5((SALT311.StrType)le.certificationnumber5),
    Fields.InValid_certificationtype5((SALT311.StrType)le.certificationtype5),
    Fields.InValid_certificatedatefrom6((SALT311.StrType)le.certificatedatefrom6),
    Fields.InValid_certificatedateto6((SALT311.StrType)le.certificatedateto6),
    Fields.InValid_certificatestatus6((SALT311.StrType)le.certificatestatus6),
    Fields.InValid_certificationnumber6((SALT311.StrType)le.certificationnumber6),
    Fields.InValid_certificationtype6((SALT311.StrType)le.certificationtype6),
    Fields.InValid_starrating((SALT311.StrType)le.starrating),
    Fields.InValid_assets((SALT311.StrType)le.assets),
    Fields.InValid_biddescription((SALT311.StrType)le.biddescription),
    Fields.InValid_competitiveadvantage((SALT311.StrType)le.competitiveadvantage),
    Fields.InValid_cagecode((SALT311.StrType)le.cagecode),
    Fields.InValid_capabilitiesnarrative((SALT311.StrType)le.capabilitiesnarrative),
    Fields.InValid_category((SALT311.StrType)le.category),
    Fields.InValid_chtrclass((SALT311.StrType)le.chtrclass),
    Fields.InValid_productdescription1((SALT311.StrType)le.productdescription1),
    Fields.InValid_productdescription2((SALT311.StrType)le.productdescription2),
    Fields.InValid_productdescription3((SALT311.StrType)le.productdescription3),
    Fields.InValid_productdescription4((SALT311.StrType)le.productdescription4),
    Fields.InValid_productdescription5((SALT311.StrType)le.productdescription5),
    Fields.InValid_classdescription1((SALT311.StrType)le.classdescription1),
    Fields.InValid_subclassdescription1((SALT311.StrType)le.subclassdescription1),
    Fields.InValid_classdescription2((SALT311.StrType)le.classdescription2),
    Fields.InValid_subclassdescription2((SALT311.StrType)le.subclassdescription2),
    Fields.InValid_classdescription3((SALT311.StrType)le.classdescription3),
    Fields.InValid_subclassdescription3((SALT311.StrType)le.subclassdescription3),
    Fields.InValid_classdescription4((SALT311.StrType)le.classdescription4),
    Fields.InValid_subclassdescription4((SALT311.StrType)le.subclassdescription4),
    Fields.InValid_classdescription5((SALT311.StrType)le.classdescription5),
    Fields.InValid_subclassdescription5((SALT311.StrType)le.subclassdescription5),
    Fields.InValid_classifications((SALT311.StrType)le.classifications),
    Fields.InValid_commodity1((SALT311.StrType)le.commodity1),
    Fields.InValid_commodity2((SALT311.StrType)le.commodity2),
    Fields.InValid_commodity3((SALT311.StrType)le.commodity3),
    Fields.InValid_commodity4((SALT311.StrType)le.commodity4),
    Fields.InValid_commodity5((SALT311.StrType)le.commodity5),
    Fields.InValid_commodity6((SALT311.StrType)le.commodity6),
    Fields.InValid_commodity7((SALT311.StrType)le.commodity7),
    Fields.InValid_commodity8((SALT311.StrType)le.commodity8),
    Fields.InValid_completedate((SALT311.StrType)le.completedate),
    Fields.InValid_crossreference((SALT311.StrType)le.crossreference),
    Fields.InValid_dateestablished((SALT311.StrType)le.dateestablished),
    Fields.InValid_businessage((SALT311.StrType)le.businessage),
    Fields.InValid_deposits((SALT311.StrType)le.deposits),
    Fields.InValid_dunsnumber((SALT311.StrType)le.dunsnumber),
    Fields.InValid_enttype((SALT311.StrType)le.enttype),
    Fields.InValid_expirationdate((SALT311.StrType)le.expirationdate),
    Fields.InValid_extendeddate((SALT311.StrType)le.extendeddate),
    Fields.InValid_issuingauthority((SALT311.StrType)le.issuingauthority),
    Fields.InValid_keywords((SALT311.StrType)le.keywords),
    Fields.InValid_licensenumber((SALT311.StrType)le.licensenumber),
    Fields.InValid_licensetype((SALT311.StrType)le.licensetype),
    Fields.InValid_mincd((SALT311.StrType)le.mincd),
    Fields.InValid_minorityaffiliation((SALT311.StrType)le.minorityaffiliation),
    Fields.InValid_minorityownershipdate((SALT311.StrType)le.minorityownershipdate),
    Fields.InValid_siccode1((SALT311.StrType)le.siccode1),
    Fields.InValid_siccode2((SALT311.StrType)le.siccode2),
    Fields.InValid_siccode3((SALT311.StrType)le.siccode3),
    Fields.InValid_siccode4((SALT311.StrType)le.siccode4),
    Fields.InValid_siccode5((SALT311.StrType)le.siccode5),
    Fields.InValid_siccode6((SALT311.StrType)le.siccode6),
    Fields.InValid_siccode7((SALT311.StrType)le.siccode7),
    Fields.InValid_siccode8((SALT311.StrType)le.siccode8),
    Fields.InValid_naicscode1((SALT311.StrType)le.naicscode1),
    Fields.InValid_naicscode2((SALT311.StrType)le.naicscode2),
    Fields.InValid_naicscode3((SALT311.StrType)le.naicscode3),
    Fields.InValid_naicscode4((SALT311.StrType)le.naicscode4),
    Fields.InValid_naicscode5((SALT311.StrType)le.naicscode5),
    Fields.InValid_naicscode6((SALT311.StrType)le.naicscode6),
    Fields.InValid_naicscode7((SALT311.StrType)le.naicscode7),
    Fields.InValid_naicscode8((SALT311.StrType)le.naicscode8),
    Fields.InValid_prequalify((SALT311.StrType)le.prequalify),
    Fields.InValid_procurementcategory1((SALT311.StrType)le.procurementcategory1),
    Fields.InValid_subprocurementcategory1((SALT311.StrType)le.subprocurementcategory1),
    Fields.InValid_procurementcategory2((SALT311.StrType)le.procurementcategory2),
    Fields.InValid_subprocurementcategory2((SALT311.StrType)le.subprocurementcategory2),
    Fields.InValid_procurementcategory3((SALT311.StrType)le.procurementcategory3),
    Fields.InValid_subprocurementcategory3((SALT311.StrType)le.subprocurementcategory3),
    Fields.InValid_procurementcategory4((SALT311.StrType)le.procurementcategory4),
    Fields.InValid_subprocurementcategory4((SALT311.StrType)le.subprocurementcategory4),
    Fields.InValid_procurementcategory5((SALT311.StrType)le.procurementcategory5),
    Fields.InValid_subprocurementcategory5((SALT311.StrType)le.subprocurementcategory5),
    Fields.InValid_renewal((SALT311.StrType)le.renewal),
    Fields.InValid_renewaldate((SALT311.StrType)le.renewaldate),
    Fields.InValid_unitedcertprogrampartner((SALT311.StrType)le.unitedcertprogrampartner),
    Fields.InValid_vendorkey((SALT311.StrType)le.vendorkey),
    Fields.InValid_vendornumber((SALT311.StrType)le.vendornumber),
    Fields.InValid_workcode1((SALT311.StrType)le.workcode1),
    Fields.InValid_workcode2((SALT311.StrType)le.workcode2),
    Fields.InValid_workcode3((SALT311.StrType)le.workcode3),
    Fields.InValid_workcode4((SALT311.StrType)le.workcode4),
    Fields.InValid_workcode5((SALT311.StrType)le.workcode5),
    Fields.InValid_workcode6((SALT311.StrType)le.workcode6),
    Fields.InValid_workcode7((SALT311.StrType)le.workcode7),
    Fields.InValid_workcode8((SALT311.StrType)le.workcode8),
    Fields.InValid_exporter((SALT311.StrType)le.exporter),
    Fields.InValid_exportbusinessactivities((SALT311.StrType)le.exportbusinessactivities),
    Fields.InValid_exportto((SALT311.StrType)le.exportto),
    Fields.InValid_exportbusinessrelationships((SALT311.StrType)le.exportbusinessrelationships),
    Fields.InValid_exportobjectives((SALT311.StrType)le.exportobjectives),
    Fields.InValid_reference1((SALT311.StrType)le.reference1),
    Fields.InValid_reference2((SALT311.StrType)le.reference2),
    Fields.InValid_reference3((SALT311.StrType)le.reference3),
    0);
  SELF.FieldNum := IF(SELF.ErrorNum=0,SKIP,c); // Bail early to avoid creating record
END;
Errors := NORMALIZE(h,205,NoteErrors(LEFT,COUNTER));
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_No','Invalid_Date','Invalid_Date','Invalid_AlphaNumChar','Invalid_State','Invalid_Date','Invalid_AlphaNum','Invalid_Alpha','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaChar','Invalid_Alpha','Invalid_AlphaChar','Invalid_AlphaChar','Invalid_Alpha','Invalid_AlphaNumChar','Invalid_AlphaNum','Invalid_Alpha','Invalid_State','Unknown','Invalid_No','Invalid_Alpha','Invalid_Alpha','Invalid_Phone','Invalid_Phone','Invalid_Phone','Invalid_Phone','Invalid_Phone','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_AlphaNumChar','Invalid_Float','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaChar','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaChar','Invalid_AlphaNumChar','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaNum','Invalid_No','Invalid_AlphaNumChar','Invalid_Alpha','Invalid_No','Unknown','Invalid_Alpha','Invalid_State','Invalid_Alpha','Invalid_State','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_Date','Invalid_Future','Invalid_Alpha','Invalid_Float','Invalid_AlphaChar','Invalid_No','Invalid_Float','Invalid_AlphaChar','Invalid_Alpha','Invalid_No','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Commodity','Invalid_Date','Invalid_Alpha','Invalid_Date','Invalid_No','Invalid_No','Invalid_No','Invalid_Alpha','Invalid_Future','Invalid_Future','Invalid_AlphaChar','Invalid_Alpha','Invalid_AlphaNum','Invalid_Alpha','Invalid_No','Invalid_Alpha','Invalid_Date','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_Sic','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_NAICS','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Future','Invalid_Alpha','Invalid_No','Invalid_No','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_Alpha','Invalid_AlphaNum','Invalid_AlphaNum','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_dartid(TotalErrors.ErrorNum),Fields.InValidMessage_dateadded(TotalErrors.ErrorNum),Fields.InValidMessage_dateupdated(TotalErrors.ErrorNum),Fields.InValidMessage_website(TotalErrors.ErrorNum),Fields.InValidMessage_state(TotalErrors.ErrorNum),Fields.InValidMessage_profilelastupdated(TotalErrors.ErrorNum),Fields.InValidMessage_county(TotalErrors.ErrorNum),Fields.InValidMessage_servicearea(TotalErrors.ErrorNum),Fields.InValidMessage_region1(TotalErrors.ErrorNum),Fields.InValidMessage_region2(TotalErrors.ErrorNum),Fields.InValidMessage_region3(TotalErrors.ErrorNum),Fields.InValidMessage_region4(TotalErrors.ErrorNum),Fields.InValidMessage_region5(TotalErrors.ErrorNum),Fields.InValidMessage_fname(TotalErrors.ErrorNum),Fields.InValidMessage_lname(TotalErrors.ErrorNum),Fields.InValidMessage_mname(TotalErrors.ErrorNum),Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Fields.InValidMessage_title(TotalErrors.ErrorNum),Fields.InValidMessage_ethnicity(TotalErrors.ErrorNum),Fields.InValidMessage_gender(TotalErrors.ErrorNum),Fields.InValidMessage_address1(TotalErrors.ErrorNum),Fields.InValidMessage_address2(TotalErrors.ErrorNum),Fields.InValidMessage_addresscity(TotalErrors.ErrorNum),Fields.InValidMessage_addressstate(TotalErrors.ErrorNum),Fields.InValidMessage_addresszipcode(TotalErrors.ErrorNum),Fields.InValidMessage_addresszip4(TotalErrors.ErrorNum),Fields.InValidMessage_building(TotalErrors.ErrorNum),Fields.InValidMessage_contact(TotalErrors.ErrorNum),Fields.InValidMessage_phone1(TotalErrors.ErrorNum),Fields.InValidMessage_phone2(TotalErrors.ErrorNum),Fields.InValidMessage_phone3(TotalErrors.ErrorNum),Fields.InValidMessage_cell(TotalErrors.ErrorNum),Fields.InValidMessage_fax(TotalErrors.ErrorNum),Fields.InValidMessage_email1(TotalErrors.ErrorNum),Fields.InValidMessage_email2(TotalErrors.ErrorNum),Fields.InValidMessage_email3(TotalErrors.ErrorNum),Fields.InValidMessage_webpage1(TotalErrors.ErrorNum),Fields.InValidMessage_webpage2(TotalErrors.ErrorNum),Fields.InValidMessage_webpage3(TotalErrors.ErrorNum),Fields.InValidMessage_businessname(TotalErrors.ErrorNum),Fields.InValidMessage_dba(TotalErrors.ErrorNum),Fields.InValidMessage_businessid(TotalErrors.ErrorNum),Fields.InValidMessage_businesstype1(TotalErrors.ErrorNum),Fields.InValidMessage_businesslocation1(TotalErrors.ErrorNum),Fields.InValidMessage_businesstype2(TotalErrors.ErrorNum),Fields.InValidMessage_businesslocation2(TotalErrors.ErrorNum),Fields.InValidMessage_businesstype3(TotalErrors.ErrorNum),Fields.InValidMessage_businesslocation3(TotalErrors.ErrorNum),Fields.InValidMessage_businesstype4(TotalErrors.ErrorNum),Fields.InValidMessage_businesslocation4(TotalErrors.ErrorNum),Fields.InValidMessage_businesstype5(TotalErrors.ErrorNum),Fields.InValidMessage_businesslocation5(TotalErrors.ErrorNum),Fields.InValidMessage_industry(TotalErrors.ErrorNum),Fields.InValidMessage_trade(TotalErrors.ErrorNum),Fields.InValidMessage_resourcedescription(TotalErrors.ErrorNum),Fields.InValidMessage_natureofbusiness(TotalErrors.ErrorNum),Fields.InValidMessage_businessdescription(TotalErrors.ErrorNum),Fields.InValidMessage_businessstructure(TotalErrors.ErrorNum),Fields.InValidMessage_totalemployees(TotalErrors.ErrorNum),Fields.InValidMessage_avgcontractsize(TotalErrors.ErrorNum),Fields.InValidMessage_firmid(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationaddress(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationaddresscity(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationaddresszip4(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationaddresszipcode(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationcounty(TotalErrors.ErrorNum),Fields.InValidMessage_firmlocationstate(TotalErrors.ErrorNum),Fields.InValidMessage_certfed(TotalErrors.ErrorNum),Fields.InValidMessage_certstate(TotalErrors.ErrorNum),Fields.InValidMessage_contractsfederal(TotalErrors.ErrorNum),Fields.InValidMessage_contractsva(TotalErrors.ErrorNum),Fields.InValidMessage_contractscommercial(TotalErrors.ErrorNum),Fields.InValidMessage_contractorgovernmentprime(TotalErrors.ErrorNum),Fields.InValidMessage_contractorgovernmentsub(TotalErrors.ErrorNum),Fields.InValidMessage_contractornongovernment(TotalErrors.ErrorNum),Fields.InValidMessage_registeredgovernmentbus(TotalErrors.ErrorNum),Fields.InValidMessage_registerednongovernmentbus(TotalErrors.ErrorNum),Fields.InValidMessage_clearancelevelpersonnel(TotalErrors.ErrorNum),Fields.InValidMessage_clearancelevelfacility(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom1(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto1(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus1(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber1(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype1(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom2(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto2(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus2(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber2(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype2(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom3(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto3(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus3(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber3(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype3(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom4(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto4(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus4(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber4(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype4(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom5(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto5(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus5(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber5(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype5(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedatefrom6(TotalErrors.ErrorNum),Fields.InValidMessage_certificatedateto6(TotalErrors.ErrorNum),Fields.InValidMessage_certificatestatus6(TotalErrors.ErrorNum),Fields.InValidMessage_certificationnumber6(TotalErrors.ErrorNum),Fields.InValidMessage_certificationtype6(TotalErrors.ErrorNum),Fields.InValidMessage_starrating(TotalErrors.ErrorNum),Fields.InValidMessage_assets(TotalErrors.ErrorNum),Fields.InValidMessage_biddescription(TotalErrors.ErrorNum),Fields.InValidMessage_competitiveadvantage(TotalErrors.ErrorNum),Fields.InValidMessage_cagecode(TotalErrors.ErrorNum),Fields.InValidMessage_capabilitiesnarrative(TotalErrors.ErrorNum),Fields.InValidMessage_category(TotalErrors.ErrorNum),Fields.InValidMessage_chtrclass(TotalErrors.ErrorNum),Fields.InValidMessage_productdescription1(TotalErrors.ErrorNum),Fields.InValidMessage_productdescription2(TotalErrors.ErrorNum),Fields.InValidMessage_productdescription3(TotalErrors.ErrorNum),Fields.InValidMessage_productdescription4(TotalErrors.ErrorNum),Fields.InValidMessage_productdescription5(TotalErrors.ErrorNum),Fields.InValidMessage_classdescription1(TotalErrors.ErrorNum),Fields.InValidMessage_subclassdescription1(TotalErrors.ErrorNum),Fields.InValidMessage_classdescription2(TotalErrors.ErrorNum),Fields.InValidMessage_subclassdescription2(TotalErrors.ErrorNum),Fields.InValidMessage_classdescription3(TotalErrors.ErrorNum),Fields.InValidMessage_subclassdescription3(TotalErrors.ErrorNum),Fields.InValidMessage_classdescription4(TotalErrors.ErrorNum),Fields.InValidMessage_subclassdescription4(TotalErrors.ErrorNum),Fields.InValidMessage_classdescription5(TotalErrors.ErrorNum),Fields.InValidMessage_subclassdescription5(TotalErrors.ErrorNum),Fields.InValidMessage_classifications(TotalErrors.ErrorNum),Fields.InValidMessage_commodity1(TotalErrors.ErrorNum),Fields.InValidMessage_commodity2(TotalErrors.ErrorNum),Fields.InValidMessage_commodity3(TotalErrors.ErrorNum),Fields.InValidMessage_commodity4(TotalErrors.ErrorNum),Fields.InValidMessage_commodity5(TotalErrors.ErrorNum),Fields.InValidMessage_commodity6(TotalErrors.ErrorNum),Fields.InValidMessage_commodity7(TotalErrors.ErrorNum),Fields.InValidMessage_commodity8(TotalErrors.ErrorNum),Fields.InValidMessage_completedate(TotalErrors.ErrorNum),Fields.InValidMessage_crossreference(TotalErrors.ErrorNum),Fields.InValidMessage_dateestablished(TotalErrors.ErrorNum),Fields.InValidMessage_businessage(TotalErrors.ErrorNum),Fields.InValidMessage_deposits(TotalErrors.ErrorNum),Fields.InValidMessage_dunsnumber(TotalErrors.ErrorNum),Fields.InValidMessage_enttype(TotalErrors.ErrorNum),Fields.InValidMessage_expirationdate(TotalErrors.ErrorNum),Fields.InValidMessage_extendeddate(TotalErrors.ErrorNum),Fields.InValidMessage_issuingauthority(TotalErrors.ErrorNum),Fields.InValidMessage_keywords(TotalErrors.ErrorNum),Fields.InValidMessage_licensenumber(TotalErrors.ErrorNum),Fields.InValidMessage_licensetype(TotalErrors.ErrorNum),Fields.InValidMessage_mincd(TotalErrors.ErrorNum),Fields.InValidMessage_minorityaffiliation(TotalErrors.ErrorNum),Fields.InValidMessage_minorityownershipdate(TotalErrors.ErrorNum),Fields.InValidMessage_siccode1(TotalErrors.ErrorNum),Fields.InValidMessage_siccode2(TotalErrors.ErrorNum),Fields.InValidMessage_siccode3(TotalErrors.ErrorNum),Fields.InValidMessage_siccode4(TotalErrors.ErrorNum),Fields.InValidMessage_siccode5(TotalErrors.ErrorNum),Fields.InValidMessage_siccode6(TotalErrors.ErrorNum),Fields.InValidMessage_siccode7(TotalErrors.ErrorNum),Fields.InValidMessage_siccode8(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode1(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode2(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode3(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode4(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode5(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode6(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode7(TotalErrors.ErrorNum),Fields.InValidMessage_naicscode8(TotalErrors.ErrorNum),Fields.InValidMessage_prequalify(TotalErrors.ErrorNum),Fields.InValidMessage_procurementcategory1(TotalErrors.ErrorNum),Fields.InValidMessage_subprocurementcategory1(TotalErrors.ErrorNum),Fields.InValidMessage_procurementcategory2(TotalErrors.ErrorNum),Fields.InValidMessage_subprocurementcategory2(TotalErrors.ErrorNum),Fields.InValidMessage_procurementcategory3(TotalErrors.ErrorNum),Fields.InValidMessage_subprocurementcategory3(TotalErrors.ErrorNum),Fields.InValidMessage_procurementcategory4(TotalErrors.ErrorNum),Fields.InValidMessage_subprocurementcategory4(TotalErrors.ErrorNum),Fields.InValidMessage_procurementcategory5(TotalErrors.ErrorNum),Fields.InValidMessage_subprocurementcategory5(TotalErrors.ErrorNum),Fields.InValidMessage_renewal(TotalErrors.ErrorNum),Fields.InValidMessage_renewaldate(TotalErrors.ErrorNum),Fields.InValidMessage_unitedcertprogrampartner(TotalErrors.ErrorNum),Fields.InValidMessage_vendorkey(TotalErrors.ErrorNum),Fields.InValidMessage_vendornumber(TotalErrors.ErrorNum),Fields.InValidMessage_workcode1(TotalErrors.ErrorNum),Fields.InValidMessage_workcode2(TotalErrors.ErrorNum),Fields.InValidMessage_workcode3(TotalErrors.ErrorNum),Fields.InValidMessage_workcode4(TotalErrors.ErrorNum),Fields.InValidMessage_workcode5(TotalErrors.ErrorNum),Fields.InValidMessage_workcode6(TotalErrors.ErrorNum),Fields.InValidMessage_workcode7(TotalErrors.ErrorNum),Fields.InValidMessage_workcode8(TotalErrors.ErrorNum),Fields.InValidMessage_exporter(TotalErrors.ErrorNum),Fields.InValidMessage_exportbusinessactivities(TotalErrors.ErrorNum),Fields.InValidMessage_exportto(TotalErrors.ErrorNum),Fields.InValidMessage_exportbusinessrelationships(TotalErrors.ErrorNum),Fields.InValidMessage_exportobjectives(TotalErrors.ErrorNum),Fields.InValidMessage_reference1(TotalErrors.ErrorNum),Fields.InValidMessage_reference2(TotalErrors.ErrorNum),Fields.InValidMessage_reference3(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Diversity_Certification, Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
