...
Command line options: -MScrubs_Diversity_Certification -eC:\Users\granjo01\AppData\Local\Temp\TFR83FA.tmp 
...
FIELDTYPE:Invalid_NAICS:CUSTOM(fn_valid_naics > 0)
FIELDTYPE:Invalid_Commodity:CUSTOM(fn_valid_Commodity > 0)
FIELDTYPE:Invalid_Sic:CUSTOM(fn_valid_Sic > 0)
...
FIELD:natureofbusiness:TYPE(STRING):LIKE(Invalid_AlphaChar):00,0
FIELD:businessdescription:TYPE(STRING):LIKE(Invalid_AlphaNumChar):00,0
