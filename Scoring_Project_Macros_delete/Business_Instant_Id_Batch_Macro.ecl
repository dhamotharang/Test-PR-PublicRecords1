...
EXPORT Business_Instant_Id_Batch_Macro (roxie_ip,Gateway, Thread, Timeout, Retry, Input_file_name,Output_file_name, records_ToRun):= functionmacro
...
f1 := IF(no_of_records = 0, 
                DATASET(ut.foreign_prod + Infile_name, Layout, thor ),
