...
// op_despray := FileServices.DeSpray('~sghatti::out::batch_fcra_rvattributes_v2_' + ut.getdate ,'10.48.72.175', 'G:\\Scoring Project\\landing\\'+ 'batch_fcra_rvattributes_v2_' + ut.getdate  + '_' + ut.getTime()  + '.csv',,,,TRUE);
