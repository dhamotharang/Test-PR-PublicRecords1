...
// version 4 models
// model rva1007_1 changed to rva1304_1 as per nathan request 01/17/2014**************************************************************
//**************************************************************
paramsA := dataset([{'Custom', 'rva1304_1'}], models.Layout_Parameters);	// use this for non-version1 models, also possibly change the scores that you call below
