...
export rthor_data400__key__nod__autokey__address	:=
record
	string28 prim_name;
	string10 prim_range;
	string2 st;
...
export rthor_data400__key__nod__autokey__addressb2	:=
record
	string28 prim_name;
	string10 prim_range;
	string2 st;
...
export rthor_data400__key__nod__autokey__citystname	:=
record
	unsigned4 city_code;
	string2 st;
	string6 dph_lname;
...
export rthor_data400__key__nod__autokey__citystnameb2	:=
record
	unsigned4 city_code;
	string2 st;
	string40 cname_indic;
...
export rthor_data400__key__nod__autokey__name	:=
record
	string6 dph_lname;
	string20 lname;
	string20 pfname;
...
export rthor_data400__key__nod__autokey__nameb2	:=
record
	string40 cname_indic;
	string40 cname_sec;
	unsigned6 bdid;
...
export rthor_data400__key__nod__autokey__namewords2	:=
record
	string40 word;
	string2 state;
	unsigned1 seq;
...
export rthor_data400__key__nod__autokey__payload	:=
record
	unsigned6 fakeid;
...
export rthor_data400__key__nod__autokey__ssn2	:=
record
	string1 s1;
	string1 s2;
	string1 s3;
...
export rthor_data400__key__nod__autokey__stname	:=
record
	string2 st;
	string6 dph_lname;
	string20 lname;
...
export rthor_data400__key__nod__autokey__stnameb2	:=
record
	string2 st;
	string40 cname_indic;
	string40 cname_sec;
...
export rthor_data400__key__nod__autokey__zip	:=
record
	integer4 zip;
	string6 dph_lname;
	string20 lname;
...
export rthor_data400__key__nod__autokey__zipb2	:=
record
	integer4 zip;
	string40 cname_indic;
	string40 cname_sec;
...
export rthor_data400__key__nod__bdid := { unsigned6 bdid, string70 fid, unsigned8 __internal_fpos__ };

export rthor_data400__key__nod__did := { unsigned6 did, string70 fid, unsigned8 __internal_fpos__ };

export rthor_data400__key__nod__fid	:=
record
	string70 fid;
	string70 foreclosure_id;
	string2 state;
...
export rthor_data400__key__nod__fid__linkids	:=
record
  string70 fid;
  string70 foreclosure_id;
  string2 state;
...
export rthor_data400__key__nod__linkids	:=
record
  unsigned6 ultid;
  unsigned6 orgid;
  unsigned6 seleid;
...
export dthor_data400__key__nod__autokey__address 			:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__address.csv', rthor_data400__key__nod__autokey__address, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__addressb2 		:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__addressb2.csv', rthor_data400__key__nod__autokey__addressb2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__citystname 	:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__citystname.csv', rthor_data400__key__nod__autokey__citystname, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__citystnameb2 := dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__citystnameb2.csv', rthor_data400__key__nod__autokey__citystnameb2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__name 				:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__name.csv', rthor_data400__key__nod__autokey__name, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__nameb2 			:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__nameb2.csv', rthor_data400__key__nod__autokey__nameb2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__namewords2 	:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__namewords2.csv', rthor_data400__key__nod__autokey__namewords2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__payload 			:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__payload.csv', rthor_data400__key__nod__autokey__payload, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__ssn2 				:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__ssn2.csv', rthor_data400__key__nod__autokey__ssn2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__stname 			:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__stname.csv', rthor_data400__key__nod__autokey__stname, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__stnameb2 		:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__stnameb2.csv', rthor_data400__key__nod__autokey__stnameb2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__zip 					:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__zip.csv', rthor_data400__key__nod__autokey__zip, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__autokey__zipb2 				:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__autokey__zipb2.csv', rthor_data400__key__nod__autokey__zipb2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__bdid 									:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__bdid.csv', rthor_data400__key__nod__bdid, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__did 									:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__did.csv', rthor_data400__key__nod__did, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__fid  									:= dataset(lCSVFileNamePrefix + 'thor_data400__key__nod__' + lCSVVersion + '__fid.csv', rthor_data400__key__nod__fid, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__nod__fid__linkids					:= dataset([],rthor_data400__key__nod__fid__linkids);
export dthor_data400__key__nod__linkids								:= dataset([],rthor_data400__key__nod__linkids);
end;