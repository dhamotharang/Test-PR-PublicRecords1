...
module
	...
	shared	lSubDirName					:=	'';
	shared	lCSVVersion					:=	'20090818';
	shared	lCSVFileNamePrefix	:=	PRTE_CSV.Constants.CSVFilesBaseName + lSubDirName;


export rthor_data400__key__advo__addr_search1	:=
record
	string5 zip;
	string10 prim_range;
	string28 prim_name;
...
export rthor_data400__key__advo__addr_search2	:=
record
	string2 st;
	string25 v_city_name;
	string10 prim_range;
...
export dthor_data400__key__advo__addr_search1 := dataset(lCSVFileNamePrefix + 'thor_data400__key__advo__'+ lCSVVersion + '__addr_search1.csv', rthor_data400__key__advo__addr_search1, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
export dthor_data400__key__advo__addr_search2 := dataset(lCSVFileNamePrefix + 'thor_data400__key__advo__'+ lCSVVersion + '__addr_search2.csv', rthor_data400__key__advo__addr_search2, csv(separator('\t'), terminator('\r\n'), quote(''), heading(single)));
