...
module
	...
	shared	lSubDirName					:=	'';
	shared	lCSVVersion					:=	'20130102';
	shared	lCSVFileNamePrefix	:=	PRTE_CSV.Constants.CSVFilesBaseName	+	lSubDirName;

	export	rthor_data400__key__propertyinfo__rid	:=
	record
	...
	export	rthor_data400__key__propertyinfo__address	:=
	record
		string28	prim_name;
		string10	prim_range;
		string5		zip;
	...
	export	dthor_data400__key__propertyinfo__rid 								:=	dataset(lCSVFileNamePrefix + 'thor_data400__key__propertyinfo__' + lCSVVersion + '__rid.csv',rthor_data400__key__propertyinfo__rid,csv(separator('\t'),terminator('\r\n'),quote('')));
	export	dthor_data400__key__propertyinfo__address							:=	dataset(lCSVFileNamePrefix + 'thor_data400__key__propertyinfo__' + lCSVVersion + '__address.csv',rthor_data400__key__propertyinfo__address,csv(separator('\t'),terminator('\r\n'),quote(''),heading(single)));
