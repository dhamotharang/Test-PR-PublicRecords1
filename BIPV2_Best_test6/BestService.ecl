...
SALT27.UIDType uid := (SALT27.UIDType)Proxidstr;
TheData := PROJECT(BIPV2_Best_test6.Keys(BIPV2_Best_test6.In_Base).InData(Proxid=uid),BIPV2_Best_test6.Layout_Base);
s := GLOBAL(PROJECT(BIPV2_Best_test6.Keys(TheData).Specificities_Key,BIPV2_Best_test6.Layout_Specificities.R)[1]);
CM := BIPV2_Best_test6.Best(TheData,s,TRUE);
