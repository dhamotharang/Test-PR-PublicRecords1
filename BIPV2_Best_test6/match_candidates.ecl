...
SHARED thin_table := DISTRIBUTE(TABLE(h00,{rcid,dt_first_seen,dt_last_seen,source_for_votes,company_name,company_fein,company_phone,company_url,prim_range,predir,prim_name,addr_suffix,postdir,unit_desig,sec_range,p_city_name,v_city_name,st,zip,zip4,fips_state,fips_county,address,Proxid}),HASH(Proxid));
...
// There are 32 best types that we can propogate from this basis which means we will not need to use this basis again
  Layout_WithPropVars T_BestCompanyNameCommon_32_0(Layout_WithPropVars le,Best(ih).BestBy_Proxid_best ri) := TRANSFORM
    SELF.company_name_prop_method := MAP ( ri.company_name_method = 0 OR le.company_name_prop_method <> 0 OR le.company_name = ri.company_name => le.company_name_prop_method, // No propogation
      ...
      ri.company_name_method = 4 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => 4, // This field is extensible
      ri.company_name_method = 5 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => 5, // This field is extensible
      ri.company_name_method = 6 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => 6, // This field is extensible
      ri.company_name_method = 7 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => 7, // This field is extensible
    ...
    SELF.company_name := MAP ( le.company_name_prop > 0 OR le.company_name = ri.company_name OR ri.company_name  IN SET(s.nulls_company_name,company_name) => le.company_name, // No propogation
      ...
      ri.company_name_method = 4 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => ri.company_name, // This field is extensible
      ri.company_name_method = 5 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => ri.company_name, // This field is extensible
      ri.company_name_method = 6 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => ri.company_name, // This field is extensible
      ri.company_name_method = 7 AND ri.company_name[1..length(trim(le.company_name))] = le.company_name  => ri.company_name, // This field is extensible
      le.company_name);
    ...
    SELF.company_fein_prop_method := MAP ( ri.company_fein_method = 0 OR le.company_fein_prop_method <> 0 OR le.company_fein = ri.company_fein => le.company_fein_prop_method, // No propogation
      ...
      ri.company_fein_method = 3 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => 3, // This field is extensible
      ri.company_fein_method = 4 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => 4, // This field is extensible
      ri.company_fein_method = 5 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => 5, // This field is extensible
      ri.company_fein_method = 6 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => 6, // This field is extensible
    ...
    SELF.company_fein := MAP ( le.company_fein_prop > 0 OR le.company_fein = ri.company_fein OR ri.company_fein  IN SET(s.nulls_company_fein,company_fein) => le.company_fein, // No propogation
      ...
      ri.company_fein_method = 3 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => ri.company_fein, // This field is extensible
      ri.company_fein_method = 4 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => ri.company_fein, // This field is extensible
      ri.company_fein_method = 5 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => ri.company_fein, // This field is extensible
      ri.company_fein_method = 6 AND ri.company_fein[1..length(trim(le.company_fein))] = le.company_fein  => ri.company_fein, // This field is extensible
      le.company_fein);
    ...
    SELF.company_phone_prop_method := MAP ( ri.company_phone_method = 0 OR le.company_phone_prop_method <> 0 OR le.company_phone = ri.company_phone => le.company_phone_prop_method, // No propogation
      ...
      ri.company_phone_method = 3 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => 3, // This field is extensible
      ri.company_phone_method = 4 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => 4, // This field is extensible
      ri.company_phone_method = 5 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => 5, // This field is extensible
      ri.company_phone_method = 6 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => 6, // This field is extensible
      ri.company_phone_method = 7 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => 7, // This field is extensible
    ...
    SELF.company_phone := MAP ( le.company_phone_prop > 0 OR le.company_phone = ri.company_phone OR ri.company_phone  IN SET(s.nulls_company_phone,company_phone) => le.company_phone, // No propogation
      ...
      ri.company_phone_method = 3 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => ri.company_phone, // This field is extensible
      ri.company_phone_method = 4 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => ri.company_phone, // This field is extensible
      ri.company_phone_method = 5 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => ri.company_phone, // This field is extensible
      ri.company_phone_method = 6 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => ri.company_phone, // This field is extensible
      ri.company_phone_method = 7 AND ri.company_phone[1..length(trim(le.company_phone))] = le.company_phone  => ri.company_phone, // This field is extensible
      le.company_phone);
    ...
    SELF.company_url_prop_method := MAP ( ri.company_url_method = 0 OR le.company_url_prop_method <> 0 OR le.company_url = ri.company_url => le.company_url_prop_method, // No propogation
      ri.company_url_method = 1 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => 1, // This field is extensible
      ri.company_url_method = 2 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => 2, // This field is extensible
      ri.company_url_method = 3 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => 3, // This field is extensible
      ri.company_url_method = 4 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => 4, // This field is extensible
      ri.company_url_method = 5 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => 5, // This field is extensible
    ...
    SELF.company_url := MAP ( le.company_url_prop > 0 OR le.company_url = ri.company_url OR ri.company_url  IN SET(s.nulls_company_url,company_url) => le.company_url, // No propogation
      ri.company_url_method = 1 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => ri.company_url, // This field is extensible
      ri.company_url_method = 2 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => ri.company_url, // This field is extensible
      ri.company_url_method = 3 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => ri.company_url, // This field is extensible
      ri.company_url_method = 4 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => ri.company_url, // This field is extensible
      ri.company_url_method = 5 AND ri.company_url[1..length(trim(le.company_url))] = le.company_url  => ri.company_url, // This field is extensible
      le.company_url);
    SELF.company_url_prop := IF ( le.company_url = SELF.company_url, le.company_url_prop,1); // Flag the propagation for sliceouts
    SELF := le;
  END;
SHARED P_BestCompanyNameCommon_32_0 := JOIN(with_props(Proxid <> 0),Best(ih).BestBy_Proxid_best, LEFT.Proxid = RIGHT.Proxid ,T_BestCompanyNameCommon_32_0(LEFT,RIGHT),LEFT OUTER,HASH)
                 + with_props(Proxid = 0);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressVoted := JOIN(P_BestCompanyNameCommon_32_0,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressVoted(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressCurrent := JOIN(J_address_BestCompanyAddressVoted,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressCurrent(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressVotedSrc := JOIN(J_address_BestCompanyAddressCurrent,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressVotedSrc(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressCommon := JOIN(J_address_BestCompanyAddressVotedSrc,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressCommon(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressStrong := JOIN(J_address_BestCompanyAddressCommon,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressStrong(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressCurrent2 := JOIN(J_address_BestCompanyAddressStrong,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressCurrent2(LEFT,RIGHT),LEFT OUTER);
...
//First find the propogation candidates; and translate into normal field names 
  ...
  // By the time we are in here - if 'ri' has a value then any fields that need to match do
    ...
    SELF := le;
  END;
SHARED J_address_BestCompanyAddressVotedUnrestricted := JOIN(J_address_BestCompanyAddressCurrent2,PC, LEFT.Proxid = RIGHT.Proxid  AND (RIGHT.prim_range[1..length(trim(LEFT.prim_range))] = LEFT.prim_range ) AND (RIGHT.predir[1..length(trim(LEFT.predir))] = LEFT.predir ) AND (RIGHT.prim_name[1..length(trim(LEFT.prim_name))] = LEFT.prim_name ) AND (RIGHT.addr_suffix[1..length(trim(LEFT.addr_suffix))] = LEFT.addr_suffix ) AND (RIGHT.postdir[1..length(trim(LEFT.postdir))] = LEFT.postdir ) AND (RIGHT.unit_desig[1..length(trim(LEFT.unit_desig))] = LEFT.unit_desig ) AND (RIGHT.sec_range[1..length(trim(LEFT.sec_range))] = LEFT.sec_range ) AND (RIGHT.st[1..length(trim(LEFT.st))] = LEFT.st ) AND (RIGHT.zip[1..length(trim(LEFT.zip))] = LEFT.zip ),T_address_BestCompanyAddressVotedUnrestricted(LEFT,RIGHT),LEFT OUTER);
J_address_BestCompanyAddressVotedUnrestricted do_computes(J_address_BestCompanyAddressVotedUnrestricted le) := TRANSFORM
  ...
  SELF := le;
END;
SHARED propogated := PROJECT(J_address_BestCompanyAddressVotedUnrestricted,do_computes(left)) : PERSIST('~temp::BIPV2_Best_test6_Proxid_Base_mc_props'); // to allow to 'jump' over an exported value
...
EXPORT Layout_Candidates := RECORD // A record to hold weights of each field value
  ...
  UNSIGNED company_name_e2_cnt := 0; // Number of names instances matching this one by edit distance
...
layout_candidates add_addr_suffix(layout_candidates le,Specificities(ih).addr_suffix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j18 := JOIN(h1,PULL(Specificities(ih).addr_suffix_values_persisted),LEFT.addr_suffix=RIGHT.addr_suffix,add_addr_suffix(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_fips_state(layout_candidates le,Specificities(ih).fips_state_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j17 := JOIN(j18,PULL(Specificities(ih).fips_state_values_persisted),LEFT.fips_state=RIGHT.fips_state,add_fips_state(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_st(layout_candidates le,Specificities(ih).st_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j16 := JOIN(j17,PULL(Specificities(ih).st_values_persisted),LEFT.st=RIGHT.st,add_st(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_unit_desig(layout_candidates le,Specificities(ih).unit_desig_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j15 := JOIN(j16,PULL(Specificities(ih).unit_desig_values_persisted),LEFT.unit_desig=RIGHT.unit_desig,add_unit_desig(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
...
layout_candidates add_fips_county(layout_candidates le,Specificities(ih).fips_county_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j13 := JOIN(j14,PULL(Specificities(ih).fips_county_values_persisted),LEFT.fips_county=RIGHT.fips_county,add_fips_county(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_postdir(layout_candidates le,Specificities(ih).postdir_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j12 := JOIN(j13,PULL(Specificities(ih).postdir_values_persisted),LEFT.postdir=RIGHT.postdir,add_postdir(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_v_city_name(layout_candidates le,Specificities(ih).v_city_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j12,s.nulls_v_city_name,Specificities(ih).v_city_name_values_persisted,v_city_name,v_city_name_weight100,add_v_city_name,j11);
layout_candidates add_p_city_name(layout_candidates le,Specificities(ih).p_city_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j11,s.nulls_p_city_name,Specificities(ih).p_city_name_values_persisted,p_city_name,p_city_name_weight100,add_p_city_name,j10);
layout_candidates add_sec_range(layout_candidates le,Specificities(ih).sec_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j10,s.nulls_sec_range,Specificities(ih).sec_range_values_persisted,sec_range,sec_range_weight100,add_sec_range,j9);
layout_candidates add_zip4(layout_candidates le,Specificities(ih).zip4_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j9,s.nulls_zip4,Specificities(ih).zip4_values_persisted,zip4,zip4_weight100,add_zip4,j8);
layout_candidates add_prim_range(layout_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j8,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_prim_range,j7);
layout_candidates add_zip(layout_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j7,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_zip,j6);
layout_candidates add_prim_name(layout_candidates le,Specificities(ih).prim_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j6,s.nulls_prim_name,Specificities(ih).prim_name_values_persisted,prim_name,prim_name_weight100,add_prim_name,j5);
layout_candidates add_address(layout_candidates le,Specificities(ih).address_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j5,s.nulls_address,Specificities(ih).address_values_persisted,address,address_weight100,add_address,j4);
layout_candidates add_company_phone(layout_candidates le,Specificities(ih).company_phone_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j4,s.nulls_company_phone,Specificities(ih).company_phone_values_persisted,company_phone,company_phone_weight100,add_company_phone,j3);
layout_candidates add_company_fein(layout_candidates le,Specificities(ih).company_fein_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j3,s.nulls_company_fein,Specificities(ih).company_fein_values_persisted,company_fein,company_fein_weight100,add_company_fein,j2);
layout_candidates add_company_name(layout_candidates le,Specificities(ih).company_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.company_name_e2_cnt := ri.e2_cnt;
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j2,s.nulls_company_name,Specificities(ih).company_name_values_persisted,company_name,company_name_weight100,add_company_name,j1);
layout_candidates add_company_url(layout_candidates le,Specificities(ih).company_url_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT27.MAC_Choose_JoinType(j1,s.nulls_company_url,Specificities(ih).company_url_values_persisted,company_url,company_url_weight100,add_company_url,j0);
//Using HASH(did) to get smoother distribution
SHARED Annotated := DISTRIBUTE(j0,hash(Proxid)) : PERSIST('~temp::BIPV2_Best_test6_Base_mc'); // Distributed for keybuild case
//Now see if these records are actually linkable
TotalWeight := Annotated.company_url_weight100 + Annotated.company_name_weight100 + Annotated.company_fein_weight100 + Annotated.company_phone_weight100 + Annotated.address_weight100 + Annotated.zip4_weight100 + Annotated.p_city_name_weight100 + Annotated.v_city_name_weight100 + Annotated.fips_county_weight100 + Annotated.fips_state_weight100;
SHARED Linkable := TotalWeight >= 41;
