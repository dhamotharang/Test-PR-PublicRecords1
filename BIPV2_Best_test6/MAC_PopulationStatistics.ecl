EXPORT MAC_PopulationStatistics(infile,Ref='',Input_company_url = '',Input_company_name = '',Input_company_fein = '',Input_company_phone = '',Input_address = '',Input_prim_name = '',Input_zip = '',Input_prim_range = '',Input_zip4 = '',Input_sec_range = '',Input_p_city_name = '',Input_v_city_name = '',Input_postdir = '',Input_fips_county = '',Input_predir = '',Input_unit_desig = '',Input_st = '',Input_fips_state = '',Input_addr_suffix = '',Input_dt_first_seen = '',Input_dt_last_seen = '',Input_source_for_votes = '',OutFile) := MACRO
