Generated by SALT V2.7 Beta 1
File being processed :-
MODULE:BIPV2_Best_test6
FILENAME:Base
// Uncomment up to NINES for internal or external adl
IDFIELD:EXISTS:Proxid
RIDFIELD:rcid
RECORDS:1680000000
POPULATION:1680000000
NINES:3
...
SOURCEFIELD:source_for_votes:PERMITS(fn_sources,5)
...
FIELD:company_name:LIKE(cname):EDIT2:BestCompanyNameCommon:BestCompanyNameCurrent:BestCompanyNameVoted:BestCompanyNameLength:BestCompanyNameStrong:BestCompanyNameCurrent2:BestCompanyNameVotedUnrestricted:FLAG:26,341
...
FIELD:company_fein:LIKE(number):right4:EDIT1:BestFeinStrong:BestFeinCommon:BestFeinCurrent:BestFeinVotedUnrestricted:BestFeinMin:BestFeinMax:OWNED:FLAG:26,64
FIELD:company_phone:LIKE(number):EDIT1:BestPhoneCurrentWithNpa:BestPhoneCurrent:BestPhoneVoted:BestPhoneLongest:BestPhoneStrong:BestPhoneVotedUnrestricted:BestPhoneCommon:FLAG:26,237
FIELD:company_url:BestUrlCommon:BestUrlCurrent:BestUrlLength:BestUrlStrong:BestUrlVotedUnrestricted:EDIT1:FLAG:27,10
// ------------------------------------
...
FIELD:postdir:7,11
FIELD:unit_desig:5,36
FIELD:sec_range:FORCE(--):12,111
FIELD:p_city_name:12,30 
FIELD:v_city_name:11,6
FIELD:st:LIKE(alpha):5,0
FIELD:zip:LIKE(number):14,7
FIELD:zip4:LIKE(number):13,66
FIELD:fips_state:LIKE(number):5,0
FIELD:fips_county:LIKE(number):7,3
CONCEPT:address:prim_range:predir:prim_name:addr_suffix:postdir:unit_desig:sec_range:st:zip:BestCompanyAddressVoted:BestCompanyAddressCurrent:BestCompanyAddressVotedSrc:BestCompanyAddressCommon:BestCompanyAddressStrong:BestCompanyAddressCurrent2:BestCompanyAddressVotedUnrestricted:FLAG:25,313
...
Total available specificity:258
...
This process was told to produce 3 nines of accuracy on a population of 1680000000 with 1680000000 records.
...
and the degree of fuzziness required but should average 26 points with a failed match substracting 19 points.
...
but should average 7 points with a failed match substracting 6 points.
(This subtraction estimate is based upon 0% of clusters with 2 or more records have 2 or more values for fips_county.)
address Scoring: 
Prior to matching the following rules are applied in a cascade in an attempt to fix or complete field values.
