...
EXPORT getOtherSources(DATASET(Business_Risk_BIP.Layouts.Shell) Shell, 
  ...
  withUtil := JOIN(withPhonesPlus, UtilAttrsStatsSources, LEFT.Seq = RIGHT.Seq,
                       ...
                       SELF.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount2 := RIGHT.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount,
                       SELF.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount3 := RIGHT.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount,
                       SELF.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount4 := RIGHT.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount,
                       SELF.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount5 := RIGHT.Business_To_Executive_Link.BusExecLinkUtilityOverlapCount,
                       SELF.NameSources             := LEFT.NameSources + RIGHT.NameSources,
                       SELF.AddressVerSources       := LEFT.AddressVerSources + RIGHT.AddressVerSources,
                       SELF.BestAddressSources			   := RIGHT.BestAddressSources,
                       SELF.PhoneSources            := LEFT.PhoneSources + RIGHT.PhoneSources,
