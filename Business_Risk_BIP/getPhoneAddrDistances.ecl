/*2016-11-15T02:49:51Z (aleksandar tomovic)
corrected as per review
*/
IMPORT BIPV2, Gateway, Risk_Indicators, RiskWise, UT;
...
EXPORT getPhoneAddrDistances(DATASET(Business_Risk_BIP.Layouts.Shell) Shell, 
	...
	DirsByPhone := RiskWise.getDirsByPhone(PhonePrep, Gateway.Constants.void_gateway, Options.DPPA_Purpose, Options.GLBA_Purpose, isFCRA := FALSE, BSOptions:=0, lastSeenThreshold:=risk_indicators.iid_constants.oneyear, 
