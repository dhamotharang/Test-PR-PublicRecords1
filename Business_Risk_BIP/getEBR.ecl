...
EXPORT getEBR(DATASET(Business_Risk_BIP.Layouts.Shell) Shell, 
  ...
  EBRCRDB_NAIC := TABLE(EBRCRDB,
    ...
    Seq, Business_Risk_BIP.Common.GetLinkSearchLevel(Options.LinkSearchLevel, SeleID), ((STRING)primary_naics_code)[1..6]
  );
  ...
  EBRCRDB_SIC := TABLE(EBRCRDB,
    ...
    Seq, Business_Risk_BIP.Common.GetLinkSearchLevel(Options.LinkSearchLevel, SeleID), ((STRING)primary_sic_code)[1..4]
  );
