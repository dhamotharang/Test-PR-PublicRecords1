...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_experian_bus_id := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_bus_id)));
    avelength_experian_bus_id := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_bus_id)),h.experian_bus_id<>(typeof(h.experian_bus_id))'');
    ...
    maxlength_zip_plus_4 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.zip_plus_4)));
    avelength_zip_plus_4 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.zip_plus_4)),h.zip_plus_4<>(typeof(h.zip_plus_4))'');
    ...
    maxlength_carrier_route := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.carrier_route)));
    avelength_carrier_route := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.carrier_route)),h.carrier_route<>(typeof(h.carrier_route))'');
    ...
    maxlength_msa_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.msa_code)));
    avelength_msa_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.msa_code)),h.msa_code<>(typeof(h.msa_code))'');
    ...
    maxlength_msa_description := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.msa_description)));
    avelength_msa_description := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.msa_description)),h.msa_description<>(typeof(h.msa_description))'');
    ...
    maxlength_establish_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.establish_date)));
    avelength_establish_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.establish_date)),h.establish_date<>(typeof(h.establish_date))'');
    ...
    maxlength_latest_reported_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.latest_reported_date)));
    avelength_latest_reported_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.latest_reported_date)),h.latest_reported_date<>(typeof(h.latest_reported_date))'');
    ...
    maxlength_years_in_file := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_file)));
    avelength_years_in_file := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_file)),h.years_in_file<>(typeof(h.years_in_file))'');
    ...
    maxlength_geo_code_latitude := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_latitude)));
    avelength_geo_code_latitude := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_latitude)),h.geo_code_latitude<>(typeof(h.geo_code_latitude))'');
    ...
    maxlength_geo_code_latitude_direction := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_latitude_direction)));
    avelength_geo_code_latitude_direction := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_latitude_direction)),h.geo_code_latitude_direction<>(typeof(h.geo_code_latitude_direction))'');
    ...
    maxlength_geo_code_longitude := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_longitude)));
    avelength_geo_code_longitude := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_longitude)),h.geo_code_longitude<>(typeof(h.geo_code_longitude))'');
    ...
    maxlength_geo_code_longitude_direction := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_longitude_direction)));
    avelength_geo_code_longitude_direction := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.geo_code_longitude_direction)),h.geo_code_longitude_direction<>(typeof(h.geo_code_longitude_direction))'');
    ...
    maxlength_recent_update_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_update_code)));
    avelength_recent_update_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_update_code)),h.recent_update_code<>(typeof(h.recent_update_code))'');
    ...
    maxlength_years_in_business_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_business_code)));
    avelength_years_in_business_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_business_code)),h.years_in_business_code<>(typeof(h.years_in_business_code))'');
    ...
    maxlength_year_business_started := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.year_business_started)));
    avelength_year_business_started := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.year_business_started)),h.year_business_started<>(typeof(h.year_business_started))'');
    ...
    maxlength_months_in_file := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.months_in_file)));
    avelength_months_in_file := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.months_in_file)),h.months_in_file<>(typeof(h.months_in_file))'');
    ...
    maxlength_estimated_number_of_employees := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_number_of_employees)));
    avelength_estimated_number_of_employees := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_number_of_employees)),h.estimated_number_of_employees<>(typeof(h.estimated_number_of_employees))'');
    ...
    maxlength_employee_size_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.employee_size_code)));
    avelength_employee_size_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.employee_size_code)),h.employee_size_code<>(typeof(h.employee_size_code))'');
    ...
    maxlength_estimated_annual_sales_amount_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_annual_sales_amount_sign)));
    avelength_estimated_annual_sales_amount_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_annual_sales_amount_sign)),h.estimated_annual_sales_amount_sign<>(typeof(h.estimated_annual_sales_amount_sign))'');
    ...
    maxlength_estimated_annual_sales_amount := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_annual_sales_amount)));
    avelength_estimated_annual_sales_amount := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.estimated_annual_sales_amount)),h.estimated_annual_sales_amount<>(typeof(h.estimated_annual_sales_amount))'');
    ...
    maxlength_annual_sales_size_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.annual_sales_size_code)));
    avelength_annual_sales_size_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.annual_sales_size_code)),h.annual_sales_size_code<>(typeof(h.annual_sales_size_code))'');
    ...
    maxlength_primary_sic_code_industry_classification := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_industry_classification)));
    avelength_primary_sic_code_industry_classification := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_industry_classification)),h.primary_sic_code_industry_classification<>(typeof(h.primary_sic_code_industry_classification))'');
    ...
    maxlength_primary_sic_code_4_digit := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_4_digit)));
    avelength_primary_sic_code_4_digit := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_4_digit)),h.primary_sic_code_4_digit<>(typeof(h.primary_sic_code_4_digit))'');
    ...
    maxlength_primary_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code)));
    avelength_primary_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code)),h.primary_sic_code<>(typeof(h.primary_sic_code))'');
    ...
    maxlength_second_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.second_sic_code)));
    avelength_second_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.second_sic_code)),h.second_sic_code<>(typeof(h.second_sic_code))'');
    ...
    maxlength_third_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.third_sic_code)));
    avelength_third_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.third_sic_code)),h.third_sic_code<>(typeof(h.third_sic_code))'');
    ...
    maxlength_fourth_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fourth_sic_code)));
    avelength_fourth_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fourth_sic_code)),h.fourth_sic_code<>(typeof(h.fourth_sic_code))'');
    ...
    maxlength_fifth_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fifth_sic_code)));
    avelength_fifth_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fifth_sic_code)),h.fifth_sic_code<>(typeof(h.fifth_sic_code))'');
    ...
    maxlength_sixth_sic_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.sixth_sic_code)));
    avelength_sixth_sic_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.sixth_sic_code)),h.sixth_sic_code<>(typeof(h.sixth_sic_code))'');
    ...
    maxlength_primary_naics_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_naics_code)));
    avelength_primary_naics_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_naics_code)),h.primary_naics_code<>(typeof(h.primary_naics_code))'');
    ...
    maxlength_second_naics_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.second_naics_code)));
    avelength_second_naics_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.second_naics_code)),h.second_naics_code<>(typeof(h.second_naics_code))'');
    ...
    maxlength_third_naics_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.third_naics_code)));
    avelength_third_naics_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.third_naics_code)),h.third_naics_code<>(typeof(h.third_naics_code))'');
    ...
    maxlength_fourth_naics_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fourth_naics_code)));
    avelength_fourth_naics_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fourth_naics_code)),h.fourth_naics_code<>(typeof(h.fourth_naics_code))'');
    ...
    maxlength_executive_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_count)));
    avelength_executive_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_count)),h.executive_count<>(typeof(h.executive_count))'');
    ...
    maxlength_executive_last_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_last_name)));
    avelength_executive_last_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_last_name)),h.executive_last_name<>(typeof(h.executive_last_name))'');
    ...
    maxlength_executive_first_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_first_name)));
    avelength_executive_first_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_first_name)),h.executive_first_name<>(typeof(h.executive_first_name))'');
    ...
    maxlength_executive_middle_initial := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_middle_initial)));
    avelength_executive_middle_initial := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.executive_middle_initial)),h.executive_middle_initial<>(typeof(h.executive_middle_initial))'');
    ...
    maxlength_ownership_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ownership_code)));
    avelength_ownership_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ownership_code)),h.ownership_code<>(typeof(h.ownership_code))'');
    ...
    maxlength_derogatory_indicator := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_indicator)));
    avelength_derogatory_indicator := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_indicator)),h.derogatory_indicator<>(typeof(h.derogatory_indicator))'');
    ...
    maxlength_recent_derogatory_filed_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_derogatory_filed_date)));
    avelength_recent_derogatory_filed_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_derogatory_filed_date)),h.recent_derogatory_filed_date<>(typeof(h.recent_derogatory_filed_date))'');
    ...
    maxlength_derogatory_liability_amount_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_liability_amount_sign)));
    avelength_derogatory_liability_amount_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_liability_amount_sign)),h.derogatory_liability_amount_sign<>(typeof(h.derogatory_liability_amount_sign))'');
    ...
    maxlength_derogatory_liability_amount := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_liability_amount)));
    avelength_derogatory_liability_amount := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.derogatory_liability_amount)),h.derogatory_liability_amount<>(typeof(h.derogatory_liability_amount))'');
    ...
    maxlength_ucc_data_indicator := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_data_indicator)));
    avelength_ucc_data_indicator := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_data_indicator)),h.ucc_data_indicator<>(typeof(h.ucc_data_indicator))'');
    ...
    maxlength_ucc_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_count)));
    avelength_ucc_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_count)),h.ucc_count<>(typeof(h.ucc_count))'');
    ...
    maxlength_number_of_legal_items := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.number_of_legal_items)));
    avelength_number_of_legal_items := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.number_of_legal_items)),h.number_of_legal_items<>(typeof(h.number_of_legal_items))'');
    ...
    maxlength_legal_balance_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.legal_balance_sign)));
    avelength_legal_balance_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.legal_balance_sign)),h.legal_balance_sign<>(typeof(h.legal_balance_sign))'');
    ...
    maxlength_legal_balance_amount := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.legal_balance_amount)));
    avelength_legal_balance_amount := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.legal_balance_amount)),h.legal_balance_amount<>(typeof(h.legal_balance_amount))'');
    ...
    maxlength_pmtkbankruptcy := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkbankruptcy)));
    avelength_pmtkbankruptcy := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkbankruptcy)),h.pmtkbankruptcy<>(typeof(h.pmtkbankruptcy))'');
    ...
    maxlength_pmtkjudgment := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkjudgment)));
    avelength_pmtkjudgment := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkjudgment)),h.pmtkjudgment<>(typeof(h.pmtkjudgment))'');
    ...
    maxlength_pmtktaxlien := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtktaxlien)));
    avelength_pmtktaxlien := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtktaxlien)),h.pmtktaxlien<>(typeof(h.pmtktaxlien))'');
    ...
    maxlength_pmtkpayment := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkpayment)));
    avelength_pmtkpayment := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pmtkpayment)),h.pmtkpayment<>(typeof(h.pmtkpayment))'');
    ...
    maxlength_bankruptcy_filed := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bankruptcy_filed)));
    avelength_bankruptcy_filed := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bankruptcy_filed)),h.bankruptcy_filed<>(typeof(h.bankruptcy_filed))'');
    ...
    maxlength_number_of_derogatory_legal_items := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.number_of_derogatory_legal_items)));
    avelength_number_of_derogatory_legal_items := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.number_of_derogatory_legal_items)),h.number_of_derogatory_legal_items<>(typeof(h.number_of_derogatory_legal_items))'');
    ...
    maxlength_lien_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.lien_count)));
    avelength_lien_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.lien_count)),h.lien_count<>(typeof(h.lien_count))'');
    ...
    maxlength_judgment_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.judgment_count)));
    avelength_judgment_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.judgment_count)),h.judgment_count<>(typeof(h.judgment_count))'');
    ...
    maxlength_bkc006 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc006)));
    avelength_bkc006 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc006)),h.bkc006<>(typeof(h.bkc006))'');
    ...
    maxlength_bkc007 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc007)));
    avelength_bkc007 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc007)),h.bkc007<>(typeof(h.bkc007))'');
    ...
    maxlength_bkc008 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc008)));
    avelength_bkc008 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkc008)),h.bkc008<>(typeof(h.bkc008))'');
    ...
    maxlength_bko009 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko009)));
    avelength_bko009 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko009)),h.bko009<>(typeof(h.bko009))'');
    ...
    maxlength_bkb001_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb001_sign)));
    avelength_bkb001_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb001_sign)),h.bkb001_sign<>(typeof(h.bkb001_sign))'');
    ...
    maxlength_bkb001 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb001)));
    avelength_bkb001 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb001)),h.bkb001<>(typeof(h.bkb001))'');
    ...
    maxlength_bkb003_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb003_sign)));
    avelength_bkb003_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb003_sign)),h.bkb003_sign<>(typeof(h.bkb003_sign))'');
    ...
    maxlength_bkb003 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb003)));
    avelength_bkb003 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bkb003)),h.bkb003<>(typeof(h.bkb003))'');
    ...
    maxlength_bko010 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko010)));
    avelength_bko010 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko010)),h.bko010<>(typeof(h.bko010))'');
    ...
    maxlength_bko011 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko011)));
    avelength_bko011 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.bko011)),h.bko011<>(typeof(h.bko011))'');
    ...
    maxlength_jdc010 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc010)));
    avelength_jdc010 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc010)),h.jdc010<>(typeof(h.jdc010))'');
    ...
    maxlength_jdc011 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc011)));
    avelength_jdc011 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc011)),h.jdc011<>(typeof(h.jdc011))'');
    ...
    maxlength_jdc012 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc012)));
    avelength_jdc012 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdc012)),h.jdc012<>(typeof(h.jdc012))'');
    ...
    maxlength_jdb004 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb004)));
    avelength_jdb004 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb004)),h.jdb004<>(typeof(h.jdb004))'');
    ...
    maxlength_jdb005 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb005)));
    avelength_jdb005 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb005)),h.jdb005<>(typeof(h.jdb005))'');
    ...
    maxlength_jdb006 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb006)));
    avelength_jdb006 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb006)),h.jdb006<>(typeof(h.jdb006))'');
    ...
    maxlength_jDO013 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jDO013)));
    avelength_jDO013 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jDO013)),h.jDO013<>(typeof(h.jDO013))'');
    ...
    maxlength_jDO014 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jDO014)));
    avelength_jDO014 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jDO014)),h.jDO014<>(typeof(h.jDO014))'');
    ...
    maxlength_jdb002 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb002)));
    avelength_jdb002 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdb002)),h.jdb002<>(typeof(h.jdb002))'');
    ...
    maxlength_jdp016 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdp016)));
    avelength_jdp016 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.jdp016)),h.jdp016<>(typeof(h.jdp016))'');
    ...
    maxlength_lgc004 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.lgc004)));
    avelength_lgc004 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.lgc004)),h.lgc004<>(typeof(h.lgc004))'');
    ...
    maxlength_pro001 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pro001)));
    avelength_pro001 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pro001)),h.pro001<>(typeof(h.pro001))'');
    ...
    maxlength_pro003 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.pro003)));
    avelength_pro003 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.pro003)),h.pro003<>(typeof(h.pro003))'');
    ...
    maxlength_txc010 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txc010)));
    avelength_txc010 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txc010)),h.txc010<>(typeof(h.txc010))'');
    ...
    maxlength_txc011 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txc011)));
    avelength_txc011 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txc011)),h.txc011<>(typeof(h.txc011))'');
    ...
    maxlength_txb004_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb004_sign)));
    avelength_txb004_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb004_sign)),h.txb004_sign<>(typeof(h.txb004_sign))'');
    ...
    maxlength_txb004 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb004)));
    avelength_txb004 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb004)),h.txb004<>(typeof(h.txb004))'');
    ...
    maxlength_txo013 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txo013)));
    avelength_txo013 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txo013)),h.txo013<>(typeof(h.txo013))'');
    ...
    maxlength_txb002_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb002_sign)));
    avelength_txb002_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb002_sign)),h.txb002_sign<>(typeof(h.txb002_sign))'');
    ...
    maxlength_txb002 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb002)));
    avelength_txb002 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txb002)),h.txb002<>(typeof(h.txb002))'');
    ...
    maxlength_txp016 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.txp016)));
    avelength_txp016 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.txp016)),h.txp016<>(typeof(h.txp016))'');
    ...
    maxlength_ucc001 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc001)));
    avelength_ucc001 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc001)),h.ucc001<>(typeof(h.ucc001))'');
    ...
    maxlength_ucc002 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc002)));
    avelength_ucc002 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc002)),h.ucc002<>(typeof(h.ucc002))'');
    ...
    maxlength_ucc003 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc003)));
    avelength_ucc003 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc003)),h.ucc003<>(typeof(h.ucc003))'');
    ...
    maxlength_intelliscore_plus := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.intelliscore_plus)));
    avelength_intelliscore_plus := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.intelliscore_plus)),h.intelliscore_plus<>(typeof(h.intelliscore_plus))'');
    ...
    maxlength_percentile_model := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.percentile_model)));
    avelength_percentile_model := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.percentile_model)),h.percentile_model<>(typeof(h.percentile_model))'');
    ...
    maxlength_model_action := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_action)));
    avelength_model_action := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_action)),h.model_action<>(typeof(h.model_action))'');
    ...
    maxlength_score_factor_1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_1)));
    avelength_score_factor_1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_1)),h.score_factor_1<>(typeof(h.score_factor_1))'');
    ...
    maxlength_score_factor_2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_2)));
    avelength_score_factor_2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_2)),h.score_factor_2<>(typeof(h.score_factor_2))'');
    ...
    maxlength_score_factor_3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_3)));
    avelength_score_factor_3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_3)),h.score_factor_3<>(typeof(h.score_factor_3))'');
    ...
    maxlength_score_factor_4 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_4)));
    avelength_score_factor_4 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.score_factor_4)),h.score_factor_4<>(typeof(h.score_factor_4))'');
    ...
    maxlength_model_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_code)));
    avelength_model_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_code)),h.model_code<>(typeof(h.model_code))'');
    ...
    maxlength_model_type := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_type)));
    avelength_model_type := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.model_type)),h.model_type<>(typeof(h.model_type))'');
    ...
    maxlength_last_experian_inquiry_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_experian_inquiry_date)));
    avelength_last_experian_inquiry_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_experian_inquiry_date)),h.last_experian_inquiry_date<>(typeof(h.last_experian_inquiry_date))'');
    ...
    maxlength_recent_high_credit_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_high_credit_sign)));
    avelength_recent_high_credit_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_high_credit_sign)),h.recent_high_credit_sign<>(typeof(h.recent_high_credit_sign))'');
    ...
    maxlength_median_credit_amount_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.median_credit_amount_sign)));
    avelength_median_credit_amount_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.median_credit_amount_sign)),h.median_credit_amount_sign<>(typeof(h.median_credit_amount_sign))'');
    ...
    maxlength_median_credit_amount := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.median_credit_amount)));
    avelength_median_credit_amount := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.median_credit_amount)),h.median_credit_amount<>(typeof(h.median_credit_amount))'');
    ...
    maxlength_total_combined_trade_lines_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_combined_trade_lines_count)));
    avelength_total_combined_trade_lines_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_combined_trade_lines_count)),h.total_combined_trade_lines_count<>(typeof(h.total_combined_trade_lines_count))'');
    ...
    maxlength_dbt_of_combined_trade_totals := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.dbt_of_combined_trade_totals)));
    avelength_dbt_of_combined_trade_totals := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.dbt_of_combined_trade_totals)),h.dbt_of_combined_trade_totals<>(typeof(h.dbt_of_combined_trade_totals))'');
    ...
    maxlength_combined_trade_balance := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_trade_balance)));
    avelength_combined_trade_balance := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_trade_balance)),h.combined_trade_balance<>(typeof(h.combined_trade_balance))'');
    ...
    maxlength_aged_trade_lines := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.aged_trade_lines)));
    avelength_aged_trade_lines := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.aged_trade_lines)),h.aged_trade_lines<>(typeof(h.aged_trade_lines))'');
    ...
    maxlength_experian_credit_rating := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_credit_rating)));
    avelength_experian_credit_rating := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_credit_rating)),h.experian_credit_rating<>(typeof(h.experian_credit_rating))'');
    ...
    maxlength_quarter_1_average_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_1_average_dbt)));
    avelength_quarter_1_average_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_1_average_dbt)),h.quarter_1_average_dbt<>(typeof(h.quarter_1_average_dbt))'');
    ...
    maxlength_quarter_2_average_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_2_average_dbt)));
    avelength_quarter_2_average_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_2_average_dbt)),h.quarter_2_average_dbt<>(typeof(h.quarter_2_average_dbt))'');
    ...
    maxlength_quarter_3_average_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_3_average_dbt)));
    avelength_quarter_3_average_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_3_average_dbt)),h.quarter_3_average_dbt<>(typeof(h.quarter_3_average_dbt))'');
    ...
    maxlength_quarter_4_average_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_4_average_dbt)));
    avelength_quarter_4_average_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_4_average_dbt)),h.quarter_4_average_dbt<>(typeof(h.quarter_4_average_dbt))'');
    ...
    maxlength_quarter_5_average_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_5_average_dbt)));
    avelength_quarter_5_average_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.quarter_5_average_dbt)),h.quarter_5_average_dbt<>(typeof(h.quarter_5_average_dbt))'');
    ...
    maxlength_combined_dbt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_dbt)));
    avelength_combined_dbt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_dbt)),h.combined_dbt<>(typeof(h.combined_dbt))'');
    ...
    maxlength_total_account_balance_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_account_balance_sign)));
    avelength_total_account_balance_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_account_balance_sign)),h.total_account_balance_sign<>(typeof(h.total_account_balance_sign))'');
    ...
    maxlength_total_account_balance := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_account_balance)));
    avelength_total_account_balance := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.total_account_balance)),h.total_account_balance<>(typeof(h.total_account_balance))'');
    ...
    maxlength_combined_account_balance_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_account_balance_sign)));
    avelength_combined_account_balance_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_account_balance_sign)),h.combined_account_balance_sign<>(typeof(h.combined_account_balance_sign))'');
    ...
    maxlength_combined_account_balance := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_account_balance)));
    avelength_combined_account_balance := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.combined_account_balance)),h.combined_account_balance<>(typeof(h.combined_account_balance))'');
    ...
    maxlength_collection_count := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.collection_count)));
    avelength_collection_count := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.collection_count)),h.collection_count<>(typeof(h.collection_count))'');
    ...
    maxlength_atc021 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc021)));
    avelength_atc021 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc021)),h.atc021<>(typeof(h.atc021))'');
    ...
    maxlength_atc022 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc022)));
    avelength_atc022 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc022)),h.atc022<>(typeof(h.atc022))'');
    ...
    maxlength_atc023 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc023)));
    avelength_atc023 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc023)),h.atc023<>(typeof(h.atc023))'');
    ...
    maxlength_atc024 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc024)));
    avelength_atc024 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc024)),h.atc024<>(typeof(h.atc024))'');
    ...
    maxlength_atc025 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc025)));
    avelength_atc025 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.atc025)),h.atc025<>(typeof(h.atc025))'');
    ...
    maxlength_last_activity_age_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_activity_age_code)));
    avelength_last_activity_age_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_activity_age_code)),h.last_activity_age_code<>(typeof(h.last_activity_age_code))'');
    ...
    maxlength_cottage_indicator := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cottage_indicator)));
    avelength_cottage_indicator := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cottage_indicator)),h.cottage_indicator<>(typeof(h.cottage_indicator))'');
    ...
    maxlength_nonprofit_indicator := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.nonprofit_indicator)));
    avelength_nonprofit_indicator := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.nonprofit_indicator)),h.nonprofit_indicator<>(typeof(h.nonprofit_indicator))'');
    ...
    maxlength_financial_stability_risk_score := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.financial_stability_risk_score)));
    avelength_financial_stability_risk_score := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.financial_stability_risk_score)),h.financial_stability_risk_score<>(typeof(h.financial_stability_risk_score))'');
    ...
    maxlength_fsr_risk_class := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_risk_class)));
    avelength_fsr_risk_class := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_risk_class)),h.fsr_risk_class<>(typeof(h.fsr_risk_class))'');
    ...
    maxlength_fsr_score_factor_1 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_1)));
    avelength_fsr_score_factor_1 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_1)),h.fsr_score_factor_1<>(typeof(h.fsr_score_factor_1))'');
    ...
    maxlength_fsr_score_factor_2 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_2)));
    avelength_fsr_score_factor_2 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_2)),h.fsr_score_factor_2<>(typeof(h.fsr_score_factor_2))'');
    ...
    maxlength_fsr_score_factor_3 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_3)));
    avelength_fsr_score_factor_3 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_3)),h.fsr_score_factor_3<>(typeof(h.fsr_score_factor_3))'');
    ...
    maxlength_fsr_score_factor_4 := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_4)));
    avelength_fsr_score_factor_4 := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_factor_4)),h.fsr_score_factor_4<>(typeof(h.fsr_score_factor_4))'');
    ...
    maxlength_ip_score_change_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ip_score_change_sign)));
    avelength_ip_score_change_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ip_score_change_sign)),h.ip_score_change_sign<>(typeof(h.ip_score_change_sign))'');
    ...
    maxlength_ip_score_change := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ip_score_change)));
    avelength_ip_score_change := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ip_score_change)),h.ip_score_change<>(typeof(h.ip_score_change))'');
    ...
    maxlength_fsr_score_change_sign := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_change_sign)));
    avelength_fsr_score_change_sign := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_change_sign)),h.fsr_score_change_sign<>(typeof(h.fsr_score_change_sign))'');
    ...
    maxlength_fsr_score_change := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_change)));
    avelength_fsr_score_change := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.fsr_score_change)),h.fsr_score_change<>(typeof(h.fsr_score_change))'');
    ...
    maxlength_clean_dba_name := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.clean_dba_name)));
    avelength_clean_dba_name := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.clean_dba_name)),h.clean_dba_name<>(typeof(h.clean_dba_name))'');
    ...
    maxlength_recent_update_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_update_desc)));
    avelength_recent_update_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.recent_update_desc)),h.recent_update_desc<>(typeof(h.recent_update_desc))'');
    ...
    maxlength_years_in_business_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_business_desc)));
    avelength_years_in_business_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.years_in_business_desc)),h.years_in_business_desc<>(typeof(h.years_in_business_desc))'');
    ...
    maxlength_address_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.address_type_desc)));
    avelength_address_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.address_type_desc)),h.address_type_desc<>(typeof(h.address_type_desc))'');
    ...
    maxlength_employee_size_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.employee_size_desc)));
    avelength_employee_size_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.employee_size_desc)),h.employee_size_desc<>(typeof(h.employee_size_desc))'');
    ...
    maxlength_annual_sales_size_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.annual_sales_size_desc)));
    avelength_annual_sales_size_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.annual_sales_size_desc)),h.annual_sales_size_desc<>(typeof(h.annual_sales_size_desc))'');
    ...
    maxlength_primary_sic_code_industry_class_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_industry_class_desc)));
    avelength_primary_sic_code_industry_class_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.primary_sic_code_industry_class_desc)),h.primary_sic_code_industry_class_desc<>(typeof(h.primary_sic_code_industry_class_desc))'');
    ...
    maxlength_business_type_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.business_type_desc)));
    avelength_business_type_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.business_type_desc)),h.business_type_desc<>(typeof(h.business_type_desc))'');
    ...
    maxlength_ownership_code_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ownership_code_desc)));
    avelength_ownership_code_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ownership_code_desc)),h.ownership_code_desc<>(typeof(h.ownership_code_desc))'');
    ...
    maxlength_ucc_data_indicator_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_data_indicator_desc)));
    avelength_ucc_data_indicator_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ucc_data_indicator_desc)),h.ucc_data_indicator_desc<>(typeof(h.ucc_data_indicator_desc))'');
    ...
    maxlength_experian_credit_rating_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_credit_rating_desc)));
    avelength_experian_credit_rating_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.experian_credit_rating_desc)),h.experian_credit_rating_desc<>(typeof(h.experian_credit_rating_desc))'');
    ...
    maxlength_last_activity_age_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_activity_age_desc)));
    avelength_last_activity_age_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.last_activity_age_desc)),h.last_activity_age_desc<>(typeof(h.last_activity_age_desc))'');
    ...
    maxlength_cottage_indicator_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cottage_indicator_desc)));
    avelength_cottage_indicator_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cottage_indicator_desc)),h.cottage_indicator_desc<>(typeof(h.cottage_indicator_desc))'');
    ...
    maxlength_nonprofit_indicator_desc := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.nonprofit_indicator_desc)));
    avelength_nonprofit_indicator_desc := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.nonprofit_indicator_desc)),h.nonprofit_indicator_desc<>(typeof(h.nonprofit_indicator_desc))'');
    ...
    maxlength_p_title := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_title)));
    avelength_p_title := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_title)),h.p_title<>(typeof(h.p_title))'');
    ...
    maxlength_p_fname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_fname)));
    avelength_p_fname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_fname)),h.p_fname<>(typeof(h.p_fname))'');
    ...
    maxlength_p_mname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_mname)));
    avelength_p_mname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_mname)),h.p_mname<>(typeof(h.p_mname))'');
    ...
    maxlength_p_lname := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_lname)));
    avelength_p_lname := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_lname)),h.p_lname<>(typeof(h.p_lname))'');
    ...
    maxlength_p_name_suffix := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_name_suffix)));
    avelength_p_name_suffix := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.p_name_suffix)),h.p_name_suffix<>(typeof(h.p_name_suffix))'');
...
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.dotid <> 0,TRIM((SALT311.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT311.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT311.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT311.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT311.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT311.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT311.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT311.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT311.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT311.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT311.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT311.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT311.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT311.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT311.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT311.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT311.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT311.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT311.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT311.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT311.StrType)le.ultweight), ''),IF (le.bdid <> 0,TRIM((SALT311.StrType)le.bdid), ''),IF (le.bdid_score <> 0,TRIM((SALT311.StrType)le.bdid_score), ''),IF (le.did <> 0,TRIM((SALT311.StrType)le.did), ''),IF (le.dt_first_seen <> 0,TRIM((SALT311.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT311.StrType)le.dt_last_seen), ''),IF (le.dt_vendor_first_reported <> 0,TRIM((SALT311.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT311.StrType)le.dt_vendor_last_reported), ''),TRIM((SALT311.StrType)le.experian_bus_id),TRIM((SALT311.StrType)le.business_name),TRIM((SALT311.StrType)le.address),TRIM((SALT311.StrType)le.city),TRIM((SALT311.StrType)le.state),TRIM((SALT311.StrType)le.zip_code),TRIM((SALT311.StrType)le.zip_plus_4),TRIM((SALT311.StrType)le.carrier_route),TRIM((SALT311.StrType)le.county_code),TRIM((SALT311.StrType)le.county_name),TRIM((SALT311.StrType)le.phone_number),TRIM((SALT311.StrType)le.msa_code),TRIM((SALT311.StrType)le.msa_description),TRIM((SALT311.StrType)le.establish_date),TRIM((SALT311.StrType)le.latest_reported_date),TRIM((SALT311.StrType)le.years_in_file),TRIM((SALT311.StrType)le.geo_code_latitude),TRIM((SALT311.StrType)le.geo_code_latitude_direction),TRIM((SALT311.StrType)le.geo_code_longitude),TRIM((SALT311.StrType)le.geo_code_longitude_direction),TRIM((SALT311.StrType)le.recent_update_code),TRIM((SALT311.StrType)le.years_in_business_code),TRIM((SALT311.StrType)le.year_business_started),TRIM((SALT311.StrType)le.months_in_file),TRIM((SALT311.StrType)le.address_type_code),TRIM((SALT311.StrType)le.estimated_number_of_employees),TRIM((SALT311.StrType)le.employee_size_code),TRIM((SALT311.StrType)le.estimated_annual_sales_amount_sign),TRIM((SALT311.StrType)le.estimated_annual_sales_amount),TRIM((SALT311.StrType)le.annual_sales_size_code),TRIM((SALT311.StrType)le.location_code),TRIM((SALT311.StrType)le.primary_sic_code_industry_classification),TRIM((SALT311.StrType)le.primary_sic_code_4_digit),TRIM((SALT311.StrType)le.primary_sic_code),TRIM((SALT311.StrType)le.second_sic_code),TRIM((SALT311.StrType)le.third_sic_code),TRIM((SALT311.StrType)le.fourth_sic_code),TRIM((SALT311.StrType)le.fifth_sic_code),TRIM((SALT311.StrType)le.sixth_sic_code),TRIM((SALT311.StrType)le.primary_naics_code),TRIM((SALT311.StrType)le.second_naics_code),TRIM((SALT311.StrType)le.third_naics_code),TRIM((SALT311.StrType)le.fourth_naics_code),TRIM((SALT311.StrType)le.executive_count),TRIM((SALT311.StrType)le.executive_last_name),TRIM((SALT311.StrType)le.executive_first_name),TRIM((SALT311.StrType)le.executive_middle_initial),TRIM((SALT311.StrType)le.executive_title),TRIM((SALT311.StrType)le.business_type),TRIM((SALT311.StrType)le.ownership_code),TRIM((SALT311.StrType)le.url),TRIM((SALT311.StrType)le.derogatory_indicator),TRIM((SALT311.StrType)le.recent_derogatory_filed_date),TRIM((SALT311.StrType)le.derogatory_liability_amount_sign),TRIM((SALT311.StrType)le.derogatory_liability_amount),TRIM((SALT311.StrType)le.ucc_data_indicator),TRIM((SALT311.StrType)le.ucc_count),TRIM((SALT311.StrType)le.number_of_legal_items),TRIM((SALT311.StrType)le.legal_balance_sign),TRIM((SALT311.StrType)le.legal_balance_amount),TRIM((SALT311.StrType)le.pmtkbankruptcy),TRIM((SALT311.StrType)le.pmtkjudgment),TRIM((SALT311.StrType)le.pmtktaxlien),TRIM((SALT311.StrType)le.pmtkpayment),TRIM((SALT311.StrType)le.bankruptcy_filed),TRIM((SALT311.StrType)le.number_of_derogatory_legal_items),TRIM((SALT311.StrType)le.lien_count),TRIM((SALT311.StrType)le.judgment_count),TRIM((SALT311.StrType)le.bkc006),TRIM((SALT311.StrType)le.bkc007),TRIM((SALT311.StrType)le.bkc008),TRIM((SALT311.StrType)le.bko009),TRIM((SALT311.StrType)le.bkb001_sign),TRIM((SALT311.StrType)le.bkb001),TRIM((SALT311.StrType)le.bkb003_sign),TRIM((SALT311.StrType)le.bkb003),TRIM((SALT311.StrType)le.bko010),TRIM((SALT311.StrType)le.bko011),TRIM((SALT311.StrType)le.jdc010),TRIM((SALT311.StrType)le.jdc011),TRIM((SALT311.StrType)le.jdc012),TRIM((SALT311.StrType)le.jdb004),TRIM((SALT311.StrType)le.jdb005),TRIM((SALT311.StrType)le.jdb006),TRIM((SALT311.StrType)le.jDO013),TRIM((SALT311.StrType)le.jDO014),TRIM((SALT311.StrType)le.jdb002),TRIM((SALT311.StrType)le.jdp016),TRIM((SALT311.StrType)le.lgc004),TRIM((SALT311.StrType)le.pro001),TRIM((SALT311.StrType)le.pro003),TRIM((SALT311.StrType)le.txc010),TRIM((SALT311.StrType)le.txc011),TRIM((SALT311.StrType)le.txb004_sign),TRIM((SALT311.StrType)le.txb004),TRIM((SALT311.StrType)le.txo013),TRIM((SALT311.StrType)le.txb002_sign),TRIM((SALT311.StrType)le.txb002),TRIM((SALT311.StrType)le.txp016),TRIM((SALT311.StrType)le.ucc001),TRIM((SALT311.StrType)le.ucc002),TRIM((SALT311.StrType)le.ucc003),TRIM((SALT311.StrType)le.intelliscore_plus),TRIM((SALT311.StrType)le.percentile_model),TRIM((SALT311.StrType)le.model_action),TRIM((SALT311.StrType)le.score_factor_1),TRIM((SALT311.StrType)le.score_factor_2),TRIM((SALT311.StrType)le.score_factor_3),TRIM((SALT311.StrType)le.score_factor_4),TRIM((SALT311.StrType)le.model_code),TRIM((SALT311.StrType)le.model_type),TRIM((SALT311.StrType)le.last_experian_inquiry_date),TRIM((SALT311.StrType)le.recent_high_credit_sign),TRIM((SALT311.StrType)le.recent_high_credit),TRIM((SALT311.StrType)le.median_credit_amount_sign),TRIM((SALT311.StrType)le.median_credit_amount),TRIM((SALT311.StrType)le.total_combined_trade_lines_count),TRIM((SALT311.StrType)le.dbt_of_combined_trade_totals),TRIM((SALT311.StrType)le.combined_trade_balance),TRIM((SALT311.StrType)le.aged_trade_lines),TRIM((SALT311.StrType)le.experian_credit_rating),TRIM((SALT311.StrType)le.quarter_1_average_dbt),TRIM((SALT311.StrType)le.quarter_2_average_dbt),TRIM((SALT311.StrType)le.quarter_3_average_dbt),TRIM((SALT311.StrType)le.quarter_4_average_dbt),TRIM((SALT311.StrType)le.quarter_5_average_dbt),TRIM((SALT311.StrType)le.combined_dbt),TRIM((SALT311.StrType)le.total_account_balance_sign),TRIM((SALT311.StrType)le.total_account_balance),TRIM((SALT311.StrType)le.combined_account_balance_sign),TRIM((SALT311.StrType)le.combined_account_balance),TRIM((SALT311.StrType)le.collection_count),TRIM((SALT311.StrType)le.atc021),TRIM((SALT311.StrType)le.atc022),TRIM((SALT311.StrType)le.atc023),TRIM((SALT311.StrType)le.atc024),TRIM((SALT311.StrType)le.atc025),TRIM((SALT311.StrType)le.last_activity_age_code),TRIM((SALT311.StrType)le.cottage_indicator),TRIM((SALT311.StrType)le.nonprofit_indicator),TRIM((SALT311.StrType)le.financial_stability_risk_score),TRIM((SALT311.StrType)le.fsr_risk_class),TRIM((SALT311.StrType)le.fsr_score_factor_1),TRIM((SALT311.StrType)le.fsr_score_factor_2),TRIM((SALT311.StrType)le.fsr_score_factor_3),TRIM((SALT311.StrType)le.fsr_score_factor_4),TRIM((SALT311.StrType)le.ip_score_change_sign),TRIM((SALT311.StrType)le.ip_score_change),TRIM((SALT311.StrType)le.fsr_score_change_sign),TRIM((SALT311.StrType)le.fsr_score_change),TRIM((SALT311.StrType)le.dba_name),TRIM((SALT311.StrType)le.clean_dba_name),TRIM((SALT311.StrType)le.clean_phone),TRIM((SALT311.StrType)le.prim_range),TRIM((SALT311.StrType)le.predir),TRIM((SALT311.StrType)le.prim_name),TRIM((SALT311.StrType)le.addr_suffix),TRIM((SALT311.StrType)le.postdir),TRIM((SALT311.StrType)le.unit_desig),TRIM((SALT311.StrType)le.sec_range),TRIM((SALT311.StrType)le.p_city_name),TRIM((SALT311.StrType)le.v_city_name),TRIM((SALT311.StrType)le.st),TRIM((SALT311.StrType)le.zip),TRIM((SALT311.StrType)le.zip4),TRIM((SALT311.StrType)le.cart),TRIM((SALT311.StrType)le.cr_sort_sz),TRIM((SALT311.StrType)le.lot),TRIM((SALT311.StrType)le.lot_order),TRIM((SALT311.StrType)le.dbpc),TRIM((SALT311.StrType)le.chk_digit),TRIM((SALT311.StrType)le.rec_type),TRIM((SALT311.StrType)le.fips_state),TRIM((SALT311.StrType)le.fips_county),TRIM((SALT311.StrType)le.geo_lat),TRIM((SALT311.StrType)le.geo_long),TRIM((SALT311.StrType)le.msa),TRIM((SALT311.StrType)le.geo_blk),TRIM((SALT311.StrType)le.geo_match),TRIM((SALT311.StrType)le.err_stat),TRIM((SALT311.StrType)le.recent_update_desc),TRIM((SALT311.StrType)le.years_in_business_desc),TRIM((SALT311.StrType)le.address_type_desc),TRIM((SALT311.StrType)le.employee_size_desc),TRIM((SALT311.StrType)le.annual_sales_size_desc),TRIM((SALT311.StrType)le.location_desc),TRIM((SALT311.StrType)le.primary_sic_code_industry_class_desc),TRIM((SALT311.StrType)le.business_type_desc),TRIM((SALT311.StrType)le.ownership_code_desc),TRIM((SALT311.StrType)le.ucc_data_indicator_desc),TRIM((SALT311.StrType)le.experian_credit_rating_desc),TRIM((SALT311.StrType)le.last_activity_age_desc),TRIM((SALT311.StrType)le.cottage_indicator_desc),TRIM((SALT311.StrType)le.nonprofit_indicator_desc),TRIM((SALT311.StrType)le.company_name),TRIM((SALT311.StrType)le.p_title),TRIM((SALT311.StrType)le.p_fname),TRIM((SALT311.StrType)le.p_mname),TRIM((SALT311.StrType)le.p_lname),TRIM((SALT311.StrType)le.p_name_suffix),IF (le.raw_aid <> 0,TRIM((SALT311.StrType)le.raw_aid), ''),IF (le.ace_aid <> 0,TRIM((SALT311.StrType)le.ace_aid), ''),TRIM((SALT311.StrType)le.prep_addr_line1),TRIM((SALT311.StrType)le.prep_addr_line_last),IF (le.source_rec_id <> 0,TRIM((SALT311.StrType)le.source_rec_id), '')));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dotid'}
      ...
      ,{233,'source_rec_id'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Base_Fields.InValid_experian_bus_id((SALT311.StrType)le.experian_bus_id),
    Base_Fields.InValid_business_name((SALT311.StrType)le.business_name),
    ...
    Base_Fields.InValid_zip_plus_4((SALT311.StrType)le.zip_plus_4),
    Base_Fields.InValid_carrier_route((SALT311.StrType)le.carrier_route),
    Base_Fields.InValid_county_code((SALT311.StrType)le.county_code),
    Base_Fields.InValid_county_name((SALT311.StrType)le.county_name),
    Base_Fields.InValid_phone_number((SALT311.StrType)le.phone_number),
    Base_Fields.InValid_msa_code((SALT311.StrType)le.msa_code),
    Base_Fields.InValid_msa_description((SALT311.StrType)le.msa_description),
    Base_Fields.InValid_establish_date((SALT311.StrType)le.establish_date),
    Base_Fields.InValid_latest_reported_date((SALT311.StrType)le.latest_reported_date),
    Base_Fields.InValid_years_in_file((SALT311.StrType)le.years_in_file),
    Base_Fields.InValid_geo_code_latitude((SALT311.StrType)le.geo_code_latitude),
    Base_Fields.InValid_geo_code_latitude_direction((SALT311.StrType)le.geo_code_latitude_direction),
    Base_Fields.InValid_geo_code_longitude((SALT311.StrType)le.geo_code_longitude),
    Base_Fields.InValid_geo_code_longitude_direction((SALT311.StrType)le.geo_code_longitude_direction),
    Base_Fields.InValid_recent_update_code((SALT311.StrType)le.recent_update_code),
    Base_Fields.InValid_years_in_business_code((SALT311.StrType)le.years_in_business_code),
    Base_Fields.InValid_year_business_started((SALT311.StrType)le.year_business_started),
    Base_Fields.InValid_months_in_file((SALT311.StrType)le.months_in_file),
    Base_Fields.InValid_address_type_code((SALT311.StrType)le.address_type_code),
    Base_Fields.InValid_estimated_number_of_employees((SALT311.StrType)le.estimated_number_of_employees),
    Base_Fields.InValid_employee_size_code((SALT311.StrType)le.employee_size_code),
    Base_Fields.InValid_estimated_annual_sales_amount_sign((SALT311.StrType)le.estimated_annual_sales_amount_sign),
    Base_Fields.InValid_estimated_annual_sales_amount((SALT311.StrType)le.estimated_annual_sales_amount),
    Base_Fields.InValid_annual_sales_size_code((SALT311.StrType)le.annual_sales_size_code),
    Base_Fields.InValid_location_code((SALT311.StrType)le.location_code),
    Base_Fields.InValid_primary_sic_code_industry_classification((SALT311.StrType)le.primary_sic_code_industry_classification),
    Base_Fields.InValid_primary_sic_code_4_digit((SALT311.StrType)le.primary_sic_code_4_digit),
    Base_Fields.InValid_primary_sic_code((SALT311.StrType)le.primary_sic_code),
    Base_Fields.InValid_second_sic_code((SALT311.StrType)le.second_sic_code),
    Base_Fields.InValid_third_sic_code((SALT311.StrType)le.third_sic_code),
    Base_Fields.InValid_fourth_sic_code((SALT311.StrType)le.fourth_sic_code),
    Base_Fields.InValid_fifth_sic_code((SALT311.StrType)le.fifth_sic_code),
    Base_Fields.InValid_sixth_sic_code((SALT311.StrType)le.sixth_sic_code),
    Base_Fields.InValid_primary_naics_code((SALT311.StrType)le.primary_naics_code),
    Base_Fields.InValid_second_naics_code((SALT311.StrType)le.second_naics_code),
    Base_Fields.InValid_third_naics_code((SALT311.StrType)le.third_naics_code),
    Base_Fields.InValid_fourth_naics_code((SALT311.StrType)le.fourth_naics_code),
    Base_Fields.InValid_executive_count((SALT311.StrType)le.executive_count),
    Base_Fields.InValid_executive_last_name((SALT311.StrType)le.executive_last_name),
    Base_Fields.InValid_executive_first_name((SALT311.StrType)le.executive_first_name),
    Base_Fields.InValid_executive_middle_initial((SALT311.StrType)le.executive_middle_initial),
    Base_Fields.InValid_executive_title((SALT311.StrType)le.executive_title),
    Base_Fields.InValid_business_type((SALT311.StrType)le.business_type),
    Base_Fields.InValid_ownership_code((SALT311.StrType)le.ownership_code),
    Base_Fields.InValid_url((SALT311.StrType)le.url),
    Base_Fields.InValid_derogatory_indicator((SALT311.StrType)le.derogatory_indicator),
    Base_Fields.InValid_recent_derogatory_filed_date((SALT311.StrType)le.recent_derogatory_filed_date),
    Base_Fields.InValid_derogatory_liability_amount_sign((SALT311.StrType)le.derogatory_liability_amount_sign),
    Base_Fields.InValid_derogatory_liability_amount((SALT311.StrType)le.derogatory_liability_amount),
    Base_Fields.InValid_ucc_data_indicator((SALT311.StrType)le.ucc_data_indicator),
    Base_Fields.InValid_ucc_count((SALT311.StrType)le.ucc_count),
    Base_Fields.InValid_number_of_legal_items((SALT311.StrType)le.number_of_legal_items),
    Base_Fields.InValid_legal_balance_sign((SALT311.StrType)le.legal_balance_sign),
    Base_Fields.InValid_legal_balance_amount((SALT311.StrType)le.legal_balance_amount),
    Base_Fields.InValid_pmtkbankruptcy((SALT311.StrType)le.pmtkbankruptcy),
    Base_Fields.InValid_pmtkjudgment((SALT311.StrType)le.pmtkjudgment),
    Base_Fields.InValid_pmtktaxlien((SALT311.StrType)le.pmtktaxlien),
    Base_Fields.InValid_pmtkpayment((SALT311.StrType)le.pmtkpayment),
    Base_Fields.InValid_bankruptcy_filed((SALT311.StrType)le.bankruptcy_filed),
    Base_Fields.InValid_number_of_derogatory_legal_items((SALT311.StrType)le.number_of_derogatory_legal_items),
    Base_Fields.InValid_lien_count((SALT311.StrType)le.lien_count),
    Base_Fields.InValid_judgment_count((SALT311.StrType)le.judgment_count),
    Base_Fields.InValid_bkc006((SALT311.StrType)le.bkc006),
    Base_Fields.InValid_bkc007((SALT311.StrType)le.bkc007),
    Base_Fields.InValid_bkc008((SALT311.StrType)le.bkc008),
    Base_Fields.InValid_bko009((SALT311.StrType)le.bko009),
    Base_Fields.InValid_bkb001_sign((SALT311.StrType)le.bkb001_sign),
    Base_Fields.InValid_bkb001((SALT311.StrType)le.bkb001),
    Base_Fields.InValid_bkb003_sign((SALT311.StrType)le.bkb003_sign),
    Base_Fields.InValid_bkb003((SALT311.StrType)le.bkb003),
    Base_Fields.InValid_bko010((SALT311.StrType)le.bko010),
    Base_Fields.InValid_bko011((SALT311.StrType)le.bko011),
    Base_Fields.InValid_jdc010((SALT311.StrType)le.jdc010),
    Base_Fields.InValid_jdc011((SALT311.StrType)le.jdc011),
    Base_Fields.InValid_jdc012((SALT311.StrType)le.jdc012),
    Base_Fields.InValid_jdb004((SALT311.StrType)le.jdb004),
    Base_Fields.InValid_jdb005((SALT311.StrType)le.jdb005),
    Base_Fields.InValid_jdb006((SALT311.StrType)le.jdb006),
    Base_Fields.InValid_jDO013((SALT311.StrType)le.jDO013),
    Base_Fields.InValid_jDO014((SALT311.StrType)le.jDO014),
    Base_Fields.InValid_jdb002((SALT311.StrType)le.jdb002),
    Base_Fields.InValid_jdp016((SALT311.StrType)le.jdp016),
    Base_Fields.InValid_lgc004((SALT311.StrType)le.lgc004),
    Base_Fields.InValid_pro001((SALT311.StrType)le.pro001),
    Base_Fields.InValid_pro003((SALT311.StrType)le.pro003),
    Base_Fields.InValid_txc010((SALT311.StrType)le.txc010),
    Base_Fields.InValid_txc011((SALT311.StrType)le.txc011),
    Base_Fields.InValid_txb004_sign((SALT311.StrType)le.txb004_sign),
    Base_Fields.InValid_txb004((SALT311.StrType)le.txb004),
    Base_Fields.InValid_txo013((SALT311.StrType)le.txo013),
    Base_Fields.InValid_txb002_sign((SALT311.StrType)le.txb002_sign),
    Base_Fields.InValid_txb002((SALT311.StrType)le.txb002),
    Base_Fields.InValid_txp016((SALT311.StrType)le.txp016),
    Base_Fields.InValid_ucc001((SALT311.StrType)le.ucc001),
    Base_Fields.InValid_ucc002((SALT311.StrType)le.ucc002),
    Base_Fields.InValid_ucc003((SALT311.StrType)le.ucc003),
    Base_Fields.InValid_intelliscore_plus((SALT311.StrType)le.intelliscore_plus),
    Base_Fields.InValid_percentile_model((SALT311.StrType)le.percentile_model),
    Base_Fields.InValid_model_action((SALT311.StrType)le.model_action),
    Base_Fields.InValid_score_factor_1((SALT311.StrType)le.score_factor_1),
    Base_Fields.InValid_score_factor_2((SALT311.StrType)le.score_factor_2),
    Base_Fields.InValid_score_factor_3((SALT311.StrType)le.score_factor_3),
    Base_Fields.InValid_score_factor_4((SALT311.StrType)le.score_factor_4),
    Base_Fields.InValid_model_code((SALT311.StrType)le.model_code),
    Base_Fields.InValid_model_type((SALT311.StrType)le.model_type),
    Base_Fields.InValid_last_experian_inquiry_date((SALT311.StrType)le.last_experian_inquiry_date),
    Base_Fields.InValid_recent_high_credit_sign((SALT311.StrType)le.recent_high_credit_sign),
    Base_Fields.InValid_recent_high_credit((SALT311.StrType)le.recent_high_credit),
    Base_Fields.InValid_median_credit_amount_sign((SALT311.StrType)le.median_credit_amount_sign),
    Base_Fields.InValid_median_credit_amount((SALT311.StrType)le.median_credit_amount),
    Base_Fields.InValid_total_combined_trade_lines_count((SALT311.StrType)le.total_combined_trade_lines_count),
    Base_Fields.InValid_dbt_of_combined_trade_totals((SALT311.StrType)le.dbt_of_combined_trade_totals),
    Base_Fields.InValid_combined_trade_balance((SALT311.StrType)le.combined_trade_balance),
    Base_Fields.InValid_aged_trade_lines((SALT311.StrType)le.aged_trade_lines),
    Base_Fields.InValid_experian_credit_rating((SALT311.StrType)le.experian_credit_rating),
    Base_Fields.InValid_quarter_1_average_dbt((SALT311.StrType)le.quarter_1_average_dbt),
    Base_Fields.InValid_quarter_2_average_dbt((SALT311.StrType)le.quarter_2_average_dbt),
    Base_Fields.InValid_quarter_3_average_dbt((SALT311.StrType)le.quarter_3_average_dbt),
    Base_Fields.InValid_quarter_4_average_dbt((SALT311.StrType)le.quarter_4_average_dbt),
    Base_Fields.InValid_quarter_5_average_dbt((SALT311.StrType)le.quarter_5_average_dbt),
    Base_Fields.InValid_combined_dbt((SALT311.StrType)le.combined_dbt),
    Base_Fields.InValid_total_account_balance_sign((SALT311.StrType)le.total_account_balance_sign),
    Base_Fields.InValid_total_account_balance((SALT311.StrType)le.total_account_balance),
    Base_Fields.InValid_combined_account_balance_sign((SALT311.StrType)le.combined_account_balance_sign),
    Base_Fields.InValid_combined_account_balance((SALT311.StrType)le.combined_account_balance),
    Base_Fields.InValid_collection_count((SALT311.StrType)le.collection_count),
    Base_Fields.InValid_atc021((SALT311.StrType)le.atc021),
    Base_Fields.InValid_atc022((SALT311.StrType)le.atc022),
    Base_Fields.InValid_atc023((SALT311.StrType)le.atc023),
    Base_Fields.InValid_atc024((SALT311.StrType)le.atc024),
    Base_Fields.InValid_atc025((SALT311.StrType)le.atc025),
    Base_Fields.InValid_last_activity_age_code((SALT311.StrType)le.last_activity_age_code),
    Base_Fields.InValid_cottage_indicator((SALT311.StrType)le.cottage_indicator),
    Base_Fields.InValid_nonprofit_indicator((SALT311.StrType)le.nonprofit_indicator),
    Base_Fields.InValid_financial_stability_risk_score((SALT311.StrType)le.financial_stability_risk_score),
    Base_Fields.InValid_fsr_risk_class((SALT311.StrType)le.fsr_risk_class),
    Base_Fields.InValid_fsr_score_factor_1((SALT311.StrType)le.fsr_score_factor_1),
    Base_Fields.InValid_fsr_score_factor_2((SALT311.StrType)le.fsr_score_factor_2),
    Base_Fields.InValid_fsr_score_factor_3((SALT311.StrType)le.fsr_score_factor_3),
    Base_Fields.InValid_fsr_score_factor_4((SALT311.StrType)le.fsr_score_factor_4),
    Base_Fields.InValid_ip_score_change_sign((SALT311.StrType)le.ip_score_change_sign),
    Base_Fields.InValid_ip_score_change((SALT311.StrType)le.ip_score_change),
    Base_Fields.InValid_fsr_score_change_sign((SALT311.StrType)le.fsr_score_change_sign),
    Base_Fields.InValid_fsr_score_change((SALT311.StrType)le.fsr_score_change),
    Base_Fields.InValid_dba_name((SALT311.StrType)le.dba_name),
    Base_Fields.InValid_clean_dba_name((SALT311.StrType)le.clean_dba_name),
    ...
    Base_Fields.InValid_recent_update_desc((SALT311.StrType)le.recent_update_desc),
    Base_Fields.InValid_years_in_business_desc((SALT311.StrType)le.years_in_business_desc),
    Base_Fields.InValid_address_type_desc((SALT311.StrType)le.address_type_desc),
    Base_Fields.InValid_employee_size_desc((SALT311.StrType)le.employee_size_desc),
    Base_Fields.InValid_annual_sales_size_desc((SALT311.StrType)le.annual_sales_size_desc),
    Base_Fields.InValid_location_desc((SALT311.StrType)le.location_desc),
    Base_Fields.InValid_primary_sic_code_industry_class_desc((SALT311.StrType)le.primary_sic_code_industry_class_desc),
    Base_Fields.InValid_business_type_desc((SALT311.StrType)le.business_type_desc),
    Base_Fields.InValid_ownership_code_desc((SALT311.StrType)le.ownership_code_desc),
    Base_Fields.InValid_ucc_data_indicator_desc((SALT311.StrType)le.ucc_data_indicator_desc),
    Base_Fields.InValid_experian_credit_rating_desc((SALT311.StrType)le.experian_credit_rating_desc),
    Base_Fields.InValid_last_activity_age_desc((SALT311.StrType)le.last_activity_age_desc),
    Base_Fields.InValid_cottage_indicator_desc((SALT311.StrType)le.cottage_indicator_desc),
    Base_Fields.InValid_nonprofit_indicator_desc((SALT311.StrType)le.nonprofit_indicator_desc),
    Base_Fields.InValid_company_name((SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_mname,(SALT311.StrType)le.p_lname),
    Base_Fields.InValid_p_title((SALT311.StrType)le.p_title),
    Base_Fields.InValid_p_fname((SALT311.StrType)le.p_fname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_mname,(SALT311.StrType)le.p_lname),
    Base_Fields.InValid_p_mname((SALT311.StrType)le.p_mname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_lname),
    Base_Fields.InValid_p_lname((SALT311.StrType)le.p_lname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_mname),
    Base_Fields.InValid_p_name_suffix((SALT311.StrType)le.p_name_suffix),
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Experian_CRDB, Base_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
