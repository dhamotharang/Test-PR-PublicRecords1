...
Command line options: -MScrubs_Experian_CRDB -eC:\Users\granjo01\AppData\Local\Temp\TFRA00E.tmp 
...
FIELDTYPE:invalid_experian_bus_id:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
...
FIELDTYPE:invalid_lot:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_lot_order:ENUM(A|D|)
FIELDTYPE:invalid_dpbc:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_chk_digit:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_fips_state:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_fips_county:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_geo:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_geo_coord>0)
FIELDTYPE:invalid_msa:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
FIELDTYPE:invalid_geo_match:CUSTOM(Scrubs_Experian_CRDB.Functions.fn_numeric>0)
