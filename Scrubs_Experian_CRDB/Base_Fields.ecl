...
EXPORT SALT311.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_mandatory','invalid_alphaHyphen','invalid_numericPeriod','invalid_zero_blank','invalid_model_action','invalid_numeric','invalid_experian_bus_id','invalid_percentage','invalid_sic_codes','invalid_naics_codes','invalid_pastdate','invalid_boolean','invalid_sign','invalid_state','invalid_zip','invalid_zip4','invalid_phone','invalid_first_name','invalid_mid_name','invalid_last_name','invalid_business_name','invalid_carrier_route','invalid_Experian_Credit_Rating','invalid_geo_code_latitude_direction','invalid_geo_code_longitude_direction','invalid_recent_update_code','invalid_years_in_business_code','invalid_address_type_code','invalid_employee_size_code','invalid_annual_Sales_Size_Code','invalid_location_code','invalid_primary_sic_code_industry_classification','invalid_executive_count','invalid_business_type','invalid_ownership_code','invalid_derogatory_indicator','invalid_ucc_data_indicator','invalid_model_type','invalid_aged_trade_lines','invalid_last_activity_age_code','invalid_nonprofit_indicator','invalid_fsr_risk_class','invalid_cart','invalid_cr_sort_sz','invalid_lot','invalid_lot_order','invalid_dpbc','invalid_chk_digit','invalid_fips_state','invalid_fips_county','invalid_geo','invalid_msa','invalid_geo_match','invalid_err_stat','invalid_raw_aid','invalid_ace_aid','invalid_direction','invalid_year','invalid_bName_pName','invalid_bName_fName','invalid_bName_mName','invalid_bName_lName');
EXPORT FieldTypeNum(SALT311.StrType fn) := CASE(fn,'invalid_mandatory' => 1,'invalid_alphaHyphen' => 2,'invalid_numericPeriod' => 3,'invalid_zero_blank' => 4,'invalid_model_action' => 5,'invalid_numeric' => 6,'invalid_experian_bus_id' => 7,'invalid_percentage' => 8,'invalid_sic_codes' => 9,'invalid_naics_codes' => 10,'invalid_pastdate' => 11,'invalid_boolean' => 12,'invalid_sign' => 13,'invalid_state' => 14,'invalid_zip' => 15,'invalid_zip4' => 16,'invalid_phone' => 17,'invalid_first_name' => 18,'invalid_mid_name' => 19,'invalid_last_name' => 20,'invalid_business_name' => 21,'invalid_carrier_route' => 22,'invalid_Experian_Credit_Rating' => 23,'invalid_geo_code_latitude_direction' => 24,'invalid_geo_code_longitude_direction' => 25,'invalid_recent_update_code' => 26,'invalid_years_in_business_code' => 27,'invalid_address_type_code' => 28,'invalid_employee_size_code' => 29,'invalid_annual_Sales_Size_Code' => 30,'invalid_location_code' => 31,'invalid_primary_sic_code_industry_classification' => 32,'invalid_executive_count' => 33,'invalid_business_type' => 34,'invalid_ownership_code' => 35,'invalid_derogatory_indicator' => 36,'invalid_ucc_data_indicator' => 37,'invalid_model_type' => 38,'invalid_aged_trade_lines' => 39,'invalid_last_activity_age_code' => 40,'invalid_nonprofit_indicator' => 41,'invalid_fsr_risk_class' => 42,'invalid_cart' => 43,'invalid_cr_sort_sz' => 44,'invalid_lot' => 45,'invalid_lot_order' => 46,'invalid_dpbc' => 47,'invalid_chk_digit' => 48,'invalid_fips_state' => 49,'invalid_fips_county' => 50,'invalid_geo' => 51,'invalid_msa' => 52,'invalid_geo_match' => 53,'invalid_err_stat' => 54,'invalid_raw_aid' => 55,'invalid_ace_aid' => 56,'invalid_direction' => 57,'invalid_year' => 58,'invalid_bName_pName' => 59,'invalid_bName_fName' => 60,'invalid_bName_mName' => 61,'invalid_bName_lName' => 62,0);
 
EXPORT MakeFT_invalid_mandatory(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mandatory(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.functions.fn_chk_blanks(s)>0);
EXPORT InValidMessageFT_invalid_mandatory(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_chk_blanks'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaHyphen(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaHyphen(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphaHyphen(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_numericPeriod(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'.0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numericPeriod(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'.0123456789'))));
EXPORT InValidMessageFT_invalid_numericPeriod(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('.0123456789'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zero_blank(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zero_blank(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['0','']);
EXPORT InValidMessageFT_invalid_zero_blank(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('0|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_model_action(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_model_action(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['MEDIUM RISK','LOW-MEDIUM RISK','LOW RISK','MEDIUM-HIGH RISK','HIGH RISK','INSUFFICIENT DATA TO SCORE','RECENT BANKRUPTCY ON FILE']);
EXPORT InValidMessageFT_invalid_model_action(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('MEDIUM RISK|LOW-MEDIUM RISK|LOW RISK|MEDIUM-HIGH RISK|HIGH RISK|INSUFFICIENT DATA TO SCORE|RECENT BANKRUPTCY ON FILE'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_numeric(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_numeric(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_numeric(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_experian_bus_id(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_experian_bus_id(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_experian_bus_id(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_percentage(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_percentage(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_range_numeric(s,0,100)>0);
EXPORT InValidMessageFT_invalid_percentage(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_range_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_sic_codes(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_sic_codes(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_sic_code(s)>0);
EXPORT InValidMessageFT_invalid_sic_codes(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_sic_code'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_naics_codes(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_naics_codes(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_naics_code(s)>0);
EXPORT InValidMessageFT_invalid_naics_codes(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_naics_code'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_pastdate(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pastdate(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_past_yyyymmdd(s)>0);
EXPORT InValidMessageFT_invalid_pastdate(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_past_yyyymmdd'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_boolean(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_boolean(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['Y','N','']);
EXPORT InValidMessageFT_invalid_boolean(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('Y|N|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_sign(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_sign(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['+','-','I','B','']);
EXPORT InValidMessageFT_invalid_sign(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('+|-|I|B|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_verify_state(s)>0);
EXPORT InValidMessageFT_invalid_state(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_verify_state'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.functions.fn_verify_zip5(s)>0);
EXPORT InValidMessageFT_invalid_zip(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_verify_zip5'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_zip4(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_zip4(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.functions.fn_verify_zip4(s)>0);
EXPORT InValidMessageFT_invalid_zip4(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_verify_zip4'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_phone(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_phone(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.functions.fn_CleanPhone(s)>0);
EXPORT InValidMessageFT_invalid_phone(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_CleanPhone'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_first_name(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_first_name(SALT311.StrType s,SALT311.StrType p_mname,SALT311.StrType p_lname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_chk_people_names(s,p_mname,p_lname)>0);
EXPORT InValidMessageFT_invalid_first_name(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_chk_people_names'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_mid_name(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mid_name(SALT311.StrType s,SALT311.StrType p_fname,SALT311.StrType p_lname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_chk_people_names(s,p_fname,p_lname)>0);
EXPORT InValidMessageFT_invalid_mid_name(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_chk_people_names'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_last_name(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_last_name(SALT311.StrType s,SALT311.StrType p_fname,SALT311.StrType p_mname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_chk_people_names(s,p_fname,p_mname)>0);
EXPORT InValidMessageFT_invalid_last_name(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_chk_people_names'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_business_name(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_business_name(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.functions.fn_chk_blanks(s)>0);
EXPORT InValidMessageFT_invalid_business_name(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_chk_blanks'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_carrier_route(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'0123456789BCGHR'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_carrier_route(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0123456789BCGHR'))));
EXPORT InValidMessageFT_invalid_carrier_route(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0123456789BCGHR'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_Experian_Credit_Rating(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'01234567'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_Experian_Credit_Rating(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'01234567'))));
EXPORT InValidMessageFT_invalid_Experian_Credit_Rating(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('01234567'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_geo_code_latitude_direction(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'NS'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_geo_code_latitude_direction(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'NS'))));
EXPORT InValidMessageFT_invalid_geo_code_latitude_direction(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('NS'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_geo_code_longitude_direction(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'WE'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_geo_code_longitude_direction(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'WE'))));
EXPORT InValidMessageFT_invalid_geo_code_longitude_direction(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('WE'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_recent_update_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_recent_update_code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['A','B','C','']);
EXPORT InValidMessageFT_invalid_recent_update_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('A|B|C|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_years_in_business_code(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'ABCDEF'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_years_in_business_code(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'ABCDEF'))));
EXPORT InValidMessageFT_invalid_years_in_business_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('ABCDEF'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_address_type_code(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'FGHMPRS'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_address_type_code(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'FGHMPRS'))));
EXPORT InValidMessageFT_invalid_address_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('FGHMPRS'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_employee_size_code(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'ABCDEFGHI'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_employee_size_code(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'ABCDEFGHI'))));
EXPORT InValidMessageFT_invalid_employee_size_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('ABCDEFGHI'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_annual_Sales_Size_Code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_annual_Sales_Size_Code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['A','B','C','D','E','F','G','H','I','J','K','']);
EXPORT InValidMessageFT_invalid_annual_Sales_Size_Code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('A|B|C|D|E|F|G|H|I|J|K|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_location_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_location_code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['B','H','S','']);
EXPORT InValidMessageFT_invalid_location_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('B|H|S|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_primary_sic_code_industry_classification(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_primary_sic_code_industry_classification(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['A','B','C','D','E','F','G','H','I','J','K','']);
EXPORT InValidMessageFT_invalid_primary_sic_code_industry_classification(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('A|B|C|D|E|F|G|H|I|J|K|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_executive_count(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'01'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_executive_count(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'01'))));
EXPORT InValidMessageFT_invalid_executive_count(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('01'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_business_type(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'CGPS'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_business_type(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'CGPS'))));
EXPORT InValidMessageFT_invalid_business_type(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('CGPS'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ownership_code(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'01'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_ownership_code(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'01'))));
EXPORT InValidMessageFT_invalid_ownership_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('01'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_derogatory_indicator(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'CNY'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_derogatory_indicator(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'CNY'))));
EXPORT InValidMessageFT_invalid_derogatory_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('CNY'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ucc_data_indicator(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'DNY'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_ucc_data_indicator(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'DNY'))));
EXPORT InValidMessageFT_invalid_ucc_data_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('DNY'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_model_type(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'1'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_model_type(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'1'))));
EXPORT InValidMessageFT_invalid_model_type(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('1'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_aged_trade_lines(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'0'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_aged_trade_lines(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'0'))));
EXPORT InValidMessageFT_invalid_aged_trade_lines(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('0'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_last_activity_age_code(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'ABCDEFGHIJKLMNO'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_last_activity_age_code(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'ABCDEFGHIJKLMNO'))));
EXPORT InValidMessageFT_invalid_last_activity_age_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('ABCDEFGHIJKLMNO'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_nonprofit_indicator(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'NPU'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_nonprofit_indicator(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'NPU'))));
EXPORT InValidMessageFT_invalid_nonprofit_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('NPU'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fsr_risk_class(SALT311.StrType s0) := FUNCTION
  s1 := SALT311.stringfilter(s0,'-12345'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_fsr_risk_class(SALT311.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT311.StringFilter(s,'-12345'))));
EXPORT InValidMessageFT_invalid_fsr_risk_class(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInChars('-12345'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cart(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cart(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_alphanumeric(s,4)>0);
EXPORT InValidMessageFT_invalid_cart(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_alphanumeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_cr_sort_sz(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_cr_sort_sz(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['B','C','D','']);
EXPORT InValidMessageFT_invalid_cr_sort_sz(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('B|C|D|'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_lot(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_lot(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_lot(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_dpbc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_dpbc(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_dpbc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_chk_digit(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_chk_digit(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_chk_digit(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fips_state(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_fips_state(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_fips_state(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fips_county(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_fips_county(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_fips_county(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_geo(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_geo(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_geo_coord(s)>0);
EXPORT InValidMessageFT_invalid_geo(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_geo_coord'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_msa(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_msa(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_msa(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_geo_match(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_geo_match(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_geo_match(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_err_stat(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_err_stat(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_alphanumeric(s,4)>0);
EXPORT InValidMessageFT_invalid_err_stat(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_alphanumeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_raw_aid(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_raw_aid(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_raw_aid(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ace_aid(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ace_aid(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_numeric(s)>0);
EXPORT InValidMessageFT_invalid_ace_aid(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_numeric'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_year(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_year(SALT311.StrType s) := WHICH(~Scrubs_Experian_CRDB.Functions.fn_valid_year(s)>0);
EXPORT InValidMessageFT_invalid_year(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.Functions.fn_valid_year'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_bName_pName(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_bName_pName(SALT311.StrType s,SALT311.StrType p_fname,SALT311.StrType p_mname,SALT311.StrType p_lname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_bName_pName(s,p_fname,p_mname,p_lname)>0);
EXPORT InValidMessageFT_invalid_bName_pName(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_bName_pName'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_bName_fName(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_bName_fName(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_mname,SALT311.StrType p_lname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_bName_pName(s,company_name,p_mname,p_lname)>0);
EXPORT InValidMessageFT_invalid_bName_fName(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_bName_pName'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_bName_mName(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_bName_mName(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_fname,SALT311.StrType p_lname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_bName_pName(s,company_name,p_fname,p_lname)>0);
EXPORT InValidMessageFT_invalid_bName_mName(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_bName_pName'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_bName_lName(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_bName_lName(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_fname,SALT311.StrType p_mname) := WHICH(~Scrubs_Experian_CRDB.functions.fn_bName_pName(s,company_name,p_fname,p_mname)>0);
EXPORT InValidMessageFT_invalid_bName_lName(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_Experian_CRDB.functions.fn_bName_pName'),SALT311.HygieneErrors.Good);
...
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ENUM'],['ALLOW'],['CUSTOM'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['ENUM'],['CUSTOM'],['ENUM'],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],[],[],[],['ALLOW'],['ALLOW'],[],['ALLOW'],['CUSTOM'],['ENUM'],['CUSTOM'],['ALLOW'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['ALLOW'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ALLOW'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ENUM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['CUSTOM'],[],[],[],[],['ALLOW'],['CUSTOM'],[],['ALLOW'],[],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ENUM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],[],[],[],[],[],[],[],[],[],[],[],[],[],[],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],[],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[]);
...
EXPORT Make_dotid(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_dotid(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_dotid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_dotscore(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_dotscore(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_dotscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_dotweight(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_dotweight(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_dotweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_empid(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_empid(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_empid(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_empscore(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_empscore(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_empscore(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_empweight(SALT311.StrType s0) := MakeFT_invalid_zero_blank(s0);
EXPORT InValid_empweight(SALT311.StrType s) := InValidFT_invalid_zero_blank(s);
EXPORT InValidMessage_empweight(UNSIGNED1 wh) := InValidMessageFT_invalid_zero_blank(wh);
 
EXPORT Make_powid(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_powid(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_powid(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_powscore(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_powscore(SALT311.StrType s) := InValidFT_invalid_percentage(s);
EXPORT InValidMessage_powscore(UNSIGNED1 wh) := InValidMessageFT_invalid_percentage(wh);
 
EXPORT Make_powweight(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_powweight(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_powweight(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_proxid(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_proxid(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_proxid(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_proxscore(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_proxscore(SALT311.StrType s) := InValidFT_invalid_percentage(s);
EXPORT InValidMessage_proxscore(UNSIGNED1 wh) := InValidMessageFT_invalid_percentage(wh);
 
EXPORT Make_proxweight(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_proxweight(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_selescore(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_selescore(SALT311.StrType s) := InValidFT_invalid_percentage(s);
EXPORT InValidMessage_selescore(UNSIGNED1 wh) := InValidMessageFT_invalid_percentage(wh);
 
EXPORT Make_seleweight(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_seleweight(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_orgscore(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_orgscore(SALT311.StrType s) := InValidFT_invalid_percentage(s);
EXPORT InValidMessage_orgscore(UNSIGNED1 wh) := InValidMessageFT_invalid_percentage(wh);
 
EXPORT Make_orgweight(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_orgweight(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_ultscore(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_ultscore(SALT311.StrType s) := InValidFT_invalid_percentage(s);
EXPORT InValidMessage_ultscore(UNSIGNED1 wh) := InValidMessageFT_invalid_percentage(wh);
 
EXPORT Make_ultweight(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ultweight(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_bdid_score(SALT311.StrType s0) := MakeFT_invalid_percentage(s0);
EXPORT InValid_bdid_score(SALT311.StrType s) := InValidFT_invalid_percentage(s);
...
EXPORT Make_experian_bus_id(SALT311.StrType s0) := MakeFT_invalid_experian_bus_id(s0);
EXPORT InValid_experian_bus_id(SALT311.StrType s) := InValidFT_invalid_experian_bus_id(s);
...
EXPORT Make_address(SALT311.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_address(SALT311.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_zip_plus_4(SALT311.StrType s0) := MakeFT_invalid_zip4(s0);
EXPORT InValid_zip_plus_4(SALT311.StrType s) := InValidFT_invalid_zip4(s);
EXPORT InValidMessage_zip_plus_4(UNSIGNED1 wh) := InValidMessageFT_invalid_zip4(wh);
 
EXPORT Make_carrier_route(SALT311.StrType s0) := MakeFT_invalid_carrier_route(s0);
EXPORT InValid_carrier_route(SALT311.StrType s) := InValidFT_invalid_carrier_route(s);
...
EXPORT Make_county_name(SALT311.StrType s0) := MakeFT_invalid_alphaHyphen(s0);
EXPORT InValid_county_name(SALT311.StrType s) := InValidFT_invalid_alphaHyphen(s);
...
EXPORT Make_msa_code(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_msa_code(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_msa_code(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_msa_description(SALT311.StrType s0) := s0;
EXPORT InValid_msa_description(SALT311.StrType s) := 0;
EXPORT InValidMessage_msa_description(UNSIGNED1 wh) := '';
 
EXPORT Make_establish_date(SALT311.StrType s0) := MakeFT_invalid_pastdate(s0);
EXPORT InValid_establish_date(SALT311.StrType s) := InValidFT_invalid_pastdate(s);
EXPORT InValidMessage_establish_date(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate(wh);
 
EXPORT Make_latest_reported_date(SALT311.StrType s0) := MakeFT_invalid_pastdate(s0);
EXPORT InValid_latest_reported_date(SALT311.StrType s) := InValidFT_invalid_pastdate(s);
EXPORT InValidMessage_latest_reported_date(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate(wh);
 
EXPORT Make_years_in_file(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_years_in_file(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_years_in_file(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_geo_code_latitude(SALT311.StrType s0) := MakeFT_invalid_numericPeriod(s0);
EXPORT InValid_geo_code_latitude(SALT311.StrType s) := InValidFT_invalid_numericPeriod(s);
EXPORT InValidMessage_geo_code_latitude(UNSIGNED1 wh) := InValidMessageFT_invalid_numericPeriod(wh);
 
EXPORT Make_geo_code_latitude_direction(SALT311.StrType s0) := MakeFT_invalid_geo_code_latitude_direction(s0);
EXPORT InValid_geo_code_latitude_direction(SALT311.StrType s) := InValidFT_invalid_geo_code_latitude_direction(s);
EXPORT InValidMessage_geo_code_latitude_direction(UNSIGNED1 wh) := InValidMessageFT_invalid_geo_code_latitude_direction(wh);
 
EXPORT Make_geo_code_longitude(SALT311.StrType s0) := MakeFT_invalid_numericPeriod(s0);
EXPORT InValid_geo_code_longitude(SALT311.StrType s) := InValidFT_invalid_numericPeriod(s);
EXPORT InValidMessage_geo_code_longitude(UNSIGNED1 wh) := InValidMessageFT_invalid_numericPeriod(wh);
 
EXPORT Make_geo_code_longitude_direction(SALT311.StrType s0) := MakeFT_invalid_geo_code_longitude_direction(s0);
EXPORT InValid_geo_code_longitude_direction(SALT311.StrType s) := InValidFT_invalid_geo_code_longitude_direction(s);
EXPORT InValidMessage_geo_code_longitude_direction(UNSIGNED1 wh) := InValidMessageFT_invalid_geo_code_longitude_direction(wh);
 
EXPORT Make_recent_update_code(SALT311.StrType s0) := MakeFT_invalid_recent_update_code(s0);
EXPORT InValid_recent_update_code(SALT311.StrType s) := InValidFT_invalid_recent_update_code(s);
EXPORT InValidMessage_recent_update_code(UNSIGNED1 wh) := InValidMessageFT_invalid_recent_update_code(wh);
 
EXPORT Make_years_in_business_code(SALT311.StrType s0) := MakeFT_invalid_years_in_business_code(s0);
EXPORT InValid_years_in_business_code(SALT311.StrType s) := InValidFT_invalid_years_in_business_code(s);
EXPORT InValidMessage_years_in_business_code(UNSIGNED1 wh) := InValidMessageFT_invalid_years_in_business_code(wh);
 
EXPORT Make_year_business_started(SALT311.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_year_business_started(SALT311.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_year_business_started(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
 
EXPORT Make_months_in_file(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_months_in_file(SALT311.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_estimated_number_of_employees(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_estimated_number_of_employees(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_estimated_number_of_employees(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_employee_size_code(SALT311.StrType s0) := MakeFT_invalid_employee_size_code(s0);
EXPORT InValid_employee_size_code(SALT311.StrType s) := InValidFT_invalid_employee_size_code(s);
EXPORT InValidMessage_employee_size_code(UNSIGNED1 wh) := InValidMessageFT_invalid_employee_size_code(wh);
 
EXPORT Make_estimated_annual_sales_amount_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_estimated_annual_sales_amount_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_estimated_annual_sales_amount_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_estimated_annual_sales_amount(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_estimated_annual_sales_amount(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_estimated_annual_sales_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_annual_sales_size_code(SALT311.StrType s0) := MakeFT_invalid_annual_Sales_Size_Code(s0);
EXPORT InValid_annual_sales_size_code(SALT311.StrType s) := InValidFT_invalid_annual_Sales_Size_Code(s);
...
EXPORT Make_primary_sic_code_industry_classification(SALT311.StrType s0) := MakeFT_invalid_primary_sic_code_industry_classification(s0);
EXPORT InValid_primary_sic_code_industry_classification(SALT311.StrType s) := InValidFT_invalid_primary_sic_code_industry_classification(s);
...
EXPORT Make_primary_sic_code_4_digit(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_primary_sic_code_4_digit(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_primary_sic_code_4_digit(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_primary_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_primary_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_primary_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_second_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_second_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_second_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_third_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_third_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_third_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_fourth_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_fourth_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_fourth_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_fifth_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_fifth_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_fifth_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_sixth_sic_code(SALT311.StrType s0) := MakeFT_invalid_sic_codes(s0);
EXPORT InValid_sixth_sic_code(SALT311.StrType s) := InValidFT_invalid_sic_codes(s);
EXPORT InValidMessage_sixth_sic_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sic_codes(wh);
 
EXPORT Make_primary_naics_code(SALT311.StrType s0) := MakeFT_invalid_naics_codes(s0);
EXPORT InValid_primary_naics_code(SALT311.StrType s) := InValidFT_invalid_naics_codes(s);
EXPORT InValidMessage_primary_naics_code(UNSIGNED1 wh) := InValidMessageFT_invalid_naics_codes(wh);
 
EXPORT Make_second_naics_code(SALT311.StrType s0) := MakeFT_invalid_naics_codes(s0);
EXPORT InValid_second_naics_code(SALT311.StrType s) := InValidFT_invalid_naics_codes(s);
EXPORT InValidMessage_second_naics_code(UNSIGNED1 wh) := InValidMessageFT_invalid_naics_codes(wh);
 
EXPORT Make_third_naics_code(SALT311.StrType s0) := MakeFT_invalid_naics_codes(s0);
EXPORT InValid_third_naics_code(SALT311.StrType s) := InValidFT_invalid_naics_codes(s);
EXPORT InValidMessage_third_naics_code(UNSIGNED1 wh) := InValidMessageFT_invalid_naics_codes(wh);
 
EXPORT Make_fourth_naics_code(SALT311.StrType s0) := MakeFT_invalid_naics_codes(s0);
EXPORT InValid_fourth_naics_code(SALT311.StrType s) := InValidFT_invalid_naics_codes(s);
EXPORT InValidMessage_fourth_naics_code(UNSIGNED1 wh) := InValidMessageFT_invalid_naics_codes(wh);
 
EXPORT Make_executive_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_executive_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_executive_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_executive_last_name(SALT311.StrType s0) := s0;
EXPORT InValid_executive_last_name(SALT311.StrType s) := 0;
EXPORT InValidMessage_executive_last_name(UNSIGNED1 wh) := '';
 
EXPORT Make_executive_first_name(SALT311.StrType s0) := s0;
EXPORT InValid_executive_first_name(SALT311.StrType s) := 0;
EXPORT InValidMessage_executive_first_name(UNSIGNED1 wh) := '';
 
EXPORT Make_executive_middle_initial(SALT311.StrType s0) := s0;
EXPORT InValid_executive_middle_initial(SALT311.StrType s) := 0;
EXPORT InValidMessage_executive_middle_initial(UNSIGNED1 wh) := '';
 
EXPORT Make_executive_title(SALT311.StrType s0) := s0;
EXPORT InValid_executive_title(SALT311.StrType s) := 0;
EXPORT InValidMessage_executive_title(UNSIGNED1 wh) := '';
 
EXPORT Make_business_type(SALT311.StrType s0) := MakeFT_invalid_business_type(s0);
EXPORT InValid_business_type(SALT311.StrType s) := InValidFT_invalid_business_type(s);
...
EXPORT Make_derogatory_indicator(SALT311.StrType s0) := MakeFT_invalid_derogatory_indicator(s0);
EXPORT InValid_derogatory_indicator(SALT311.StrType s) := InValidFT_invalid_derogatory_indicator(s);
EXPORT InValidMessage_derogatory_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_derogatory_indicator(wh);
 
EXPORT Make_recent_derogatory_filed_date(SALT311.StrType s0) := MakeFT_invalid_pastdate(s0);
EXPORT InValid_recent_derogatory_filed_date(SALT311.StrType s) := InValidFT_invalid_pastdate(s);
EXPORT InValidMessage_recent_derogatory_filed_date(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate(wh);
 
EXPORT Make_derogatory_liability_amount_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_derogatory_liability_amount_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_derogatory_liability_amount_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_derogatory_liability_amount(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_derogatory_liability_amount(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_derogatory_liability_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ucc_data_indicator(SALT311.StrType s0) := MakeFT_invalid_ucc_data_indicator(s0);
EXPORT InValid_ucc_data_indicator(SALT311.StrType s) := InValidFT_invalid_ucc_data_indicator(s);
EXPORT InValidMessage_ucc_data_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_ucc_data_indicator(wh);
 
EXPORT Make_ucc_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ucc_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ucc_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_number_of_legal_items(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_number_of_legal_items(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_number_of_legal_items(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_legal_balance_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_legal_balance_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_legal_balance_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_legal_balance_amount(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_legal_balance_amount(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_legal_balance_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_pmtkbankruptcy(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_pmtkbankruptcy(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_pmtkbankruptcy(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_pmtkjudgment(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_pmtkjudgment(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_pmtkjudgment(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_pmtktaxlien(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_pmtktaxlien(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_pmtktaxlien(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_pmtkpayment(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_pmtkpayment(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_pmtkpayment(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_bankruptcy_filed(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_bankruptcy_filed(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_bankruptcy_filed(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_number_of_derogatory_legal_items(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_number_of_derogatory_legal_items(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_number_of_derogatory_legal_items(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_lien_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_lien_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_lien_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_judgment_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_judgment_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_judgment_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bkc006(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bkc006(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bkc006(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bkc007(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bkc007(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bkc007(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bkc008(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bkc008(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bkc008(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bko009(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bko009(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bko009(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bkb001_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_bkb001_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_bkb001_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_bkb001(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bkb001(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bkb001(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bkb003_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_bkb003_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_bkb003_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_bkb003(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bkb003(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bkb003(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bko010(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bko010(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bko010(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_bko011(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_bko011(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_bko011(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdc010(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdc010(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdc010(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdc011(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdc011(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdc011(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdc012(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdc012(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdc012(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdb004(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdb004(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdb004(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdb005(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdb005(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdb005(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdb006(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdb006(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdb006(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jDO013(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jDO013(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jDO013(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jDO014(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jDO014(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jDO014(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdb002(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdb002(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdb002(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_jdp016(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_jdp016(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_jdp016(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_lgc004(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_lgc004(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_lgc004(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_pro001(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_pro001(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_pro001(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_pro003(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_pro003(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_pro003(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txc010(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txc010(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txc010(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txc011(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txc011(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txc011(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txb004_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_txb004_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_txb004_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_txb004(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txb004(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txb004(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txo013(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txo013(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txo013(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txb002_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_txb002_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_txb002_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_txb002(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txb002(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txb002(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_txp016(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_txp016(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_txp016(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ucc001(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ucc001(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ucc001(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ucc002(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ucc002(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ucc002(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ucc003(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ucc003(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ucc003(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_intelliscore_plus(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_intelliscore_plus(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_intelliscore_plus(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_percentile_model(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_percentile_model(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_percentile_model(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_model_action(SALT311.StrType s0) := MakeFT_invalid_model_action(s0);
EXPORT InValid_model_action(SALT311.StrType s) := InValidFT_invalid_model_action(s);
EXPORT InValidMessage_model_action(UNSIGNED1 wh) := InValidMessageFT_invalid_model_action(wh);
 
EXPORT Make_score_factor_1(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_score_factor_1(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_score_factor_1(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_score_factor_2(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_score_factor_2(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_score_factor_2(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_score_factor_3(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_score_factor_3(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_score_factor_3(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_score_factor_4(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_score_factor_4(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_score_factor_4(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_model_code(SALT311.StrType s0) := s0;
EXPORT InValid_model_code(SALT311.StrType s) := 0;
EXPORT InValidMessage_model_code(UNSIGNED1 wh) := '';
 
EXPORT Make_model_type(SALT311.StrType s0) := MakeFT_invalid_model_type(s0);
EXPORT InValid_model_type(SALT311.StrType s) := InValidFT_invalid_model_type(s);
EXPORT InValidMessage_model_type(UNSIGNED1 wh) := InValidMessageFT_invalid_model_type(wh);
 
EXPORT Make_last_experian_inquiry_date(SALT311.StrType s0) := MakeFT_invalid_pastdate(s0);
EXPORT InValid_last_experian_inquiry_date(SALT311.StrType s) := InValidFT_invalid_pastdate(s);
EXPORT InValidMessage_last_experian_inquiry_date(UNSIGNED1 wh) := InValidMessageFT_invalid_pastdate(wh);
 
EXPORT Make_recent_high_credit_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_recent_high_credit_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_recent_high_credit_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_recent_high_credit(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_recent_high_credit(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_recent_high_credit(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_median_credit_amount_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_median_credit_amount_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_median_credit_amount_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_median_credit_amount(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_median_credit_amount(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_median_credit_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_total_combined_trade_lines_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_total_combined_trade_lines_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_total_combined_trade_lines_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_dbt_of_combined_trade_totals(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_dbt_of_combined_trade_totals(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_dbt_of_combined_trade_totals(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_combined_trade_balance(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_combined_trade_balance(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_combined_trade_balance(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_aged_trade_lines(SALT311.StrType s0) := MakeFT_invalid_aged_trade_lines(s0);
EXPORT InValid_aged_trade_lines(SALT311.StrType s) := InValidFT_invalid_aged_trade_lines(s);
EXPORT InValidMessage_aged_trade_lines(UNSIGNED1 wh) := InValidMessageFT_invalid_aged_trade_lines(wh);
 
EXPORT Make_experian_credit_rating(SALT311.StrType s0) := MakeFT_invalid_Experian_Credit_Rating(s0);
EXPORT InValid_experian_credit_rating(SALT311.StrType s) := InValidFT_invalid_Experian_Credit_Rating(s);
EXPORT InValidMessage_experian_credit_rating(UNSIGNED1 wh) := InValidMessageFT_invalid_Experian_Credit_Rating(wh);
 
EXPORT Make_quarter_1_average_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_quarter_1_average_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_quarter_1_average_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_quarter_2_average_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_quarter_2_average_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_quarter_2_average_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_quarter_3_average_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_quarter_3_average_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_quarter_3_average_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_quarter_4_average_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_quarter_4_average_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_quarter_4_average_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_quarter_5_average_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_quarter_5_average_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_quarter_5_average_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_combined_dbt(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_combined_dbt(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_combined_dbt(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_total_account_balance_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_total_account_balance_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_total_account_balance_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_total_account_balance(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_total_account_balance(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_total_account_balance(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_combined_account_balance_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_combined_account_balance_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_combined_account_balance_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_combined_account_balance(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_combined_account_balance(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_combined_account_balance(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_collection_count(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_collection_count(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_collection_count(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_atc021(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_atc021(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_atc021(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_atc022(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_atc022(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_atc022(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_atc023(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_atc023(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_atc023(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_atc024(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_atc024(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_atc024(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_atc025(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_atc025(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_atc025(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_last_activity_age_code(SALT311.StrType s0) := MakeFT_invalid_last_activity_age_code(s0);
EXPORT InValid_last_activity_age_code(SALT311.StrType s) := InValidFT_invalid_last_activity_age_code(s);
EXPORT InValidMessage_last_activity_age_code(UNSIGNED1 wh) := InValidMessageFT_invalid_last_activity_age_code(wh);
 
EXPORT Make_cottage_indicator(SALT311.StrType s0) := MakeFT_invalid_boolean(s0);
EXPORT InValid_cottage_indicator(SALT311.StrType s) := InValidFT_invalid_boolean(s);
EXPORT InValidMessage_cottage_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_boolean(wh);
 
EXPORT Make_nonprofit_indicator(SALT311.StrType s0) := MakeFT_invalid_nonprofit_indicator(s0);
EXPORT InValid_nonprofit_indicator(SALT311.StrType s) := InValidFT_invalid_nonprofit_indicator(s);
EXPORT InValidMessage_nonprofit_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_nonprofit_indicator(wh);
 
EXPORT Make_financial_stability_risk_score(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_financial_stability_risk_score(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_financial_stability_risk_score(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_fsr_risk_class(SALT311.StrType s0) := MakeFT_invalid_fsr_risk_class(s0);
EXPORT InValid_fsr_risk_class(SALT311.StrType s) := InValidFT_invalid_fsr_risk_class(s);
EXPORT InValidMessage_fsr_risk_class(UNSIGNED1 wh) := InValidMessageFT_invalid_fsr_risk_class(wh);
 
EXPORT Make_fsr_score_factor_1(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fsr_score_factor_1(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_fsr_score_factor_1(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_fsr_score_factor_2(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fsr_score_factor_2(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_fsr_score_factor_2(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_fsr_score_factor_3(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fsr_score_factor_3(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_fsr_score_factor_3(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_fsr_score_factor_4(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fsr_score_factor_4(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_fsr_score_factor_4(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_ip_score_change_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_ip_score_change_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_ip_score_change_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_ip_score_change(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_ip_score_change(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_ip_score_change(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_fsr_score_change_sign(SALT311.StrType s0) := MakeFT_invalid_sign(s0);
EXPORT InValid_fsr_score_change_sign(SALT311.StrType s) := InValidFT_invalid_sign(s);
EXPORT InValidMessage_fsr_score_change_sign(UNSIGNED1 wh) := InValidMessageFT_invalid_sign(wh);
 
EXPORT Make_fsr_score_change(SALT311.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_fsr_score_change(SALT311.StrType s) := InValidFT_invalid_numeric(s);
EXPORT InValidMessage_fsr_score_change(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric(wh);
 
EXPORT Make_dba_name(SALT311.StrType s0) := s0;
EXPORT InValid_dba_name(SALT311.StrType s) := 0;
EXPORT InValidMessage_dba_name(UNSIGNED1 wh) := '';
 
EXPORT Make_clean_dba_name(SALT311.StrType s0) := s0;
EXPORT InValid_clean_dba_name(SALT311.StrType s) := 0;
EXPORT InValidMessage_clean_dba_name(UNSIGNED1 wh) := '';
...
EXPORT Make_prim_name(SALT311.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_prim_name(SALT311.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_p_city_name(SALT311.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_p_city_name(SALT311.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_p_city_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_v_city_name(SALT311.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_v_city_name(SALT311.StrType s) := InValidFT_invalid_mandatory(s);
...
EXPORT Make_cart(SALT311.StrType s0) := MakeFT_invalid_cart(s0);
EXPORT InValid_cart(SALT311.StrType s) := InValidFT_invalid_cart(s);
EXPORT InValidMessage_cart(UNSIGNED1 wh) := InValidMessageFT_invalid_cart(wh);
 
EXPORT Make_cr_sort_sz(SALT311.StrType s0) := MakeFT_invalid_cr_sort_sz(s0);
EXPORT InValid_cr_sort_sz(SALT311.StrType s) := InValidFT_invalid_cr_sort_sz(s);
EXPORT InValidMessage_cr_sort_sz(UNSIGNED1 wh) := InValidMessageFT_invalid_cr_sort_sz(wh);
 
EXPORT Make_lot(SALT311.StrType s0) := MakeFT_invalid_lot(s0);
EXPORT InValid_lot(SALT311.StrType s) := InValidFT_invalid_lot(s);
EXPORT InValidMessage_lot(UNSIGNED1 wh) := InValidMessageFT_invalid_lot(wh);
 
EXPORT Make_lot_order(SALT311.StrType s0) := MakeFT_invalid_lot_order(s0);
EXPORT InValid_lot_order(SALT311.StrType s) := InValidFT_invalid_lot_order(s);
EXPORT InValidMessage_lot_order(UNSIGNED1 wh) := InValidMessageFT_invalid_lot_order(wh);
 
EXPORT Make_dbpc(SALT311.StrType s0) := MakeFT_invalid_dpbc(s0);
EXPORT InValid_dbpc(SALT311.StrType s) := InValidFT_invalid_dpbc(s);
...
EXPORT Make_recent_update_desc(SALT311.StrType s0) := s0;
EXPORT InValid_recent_update_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_recent_update_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_years_in_business_desc(SALT311.StrType s0) := s0;
EXPORT InValid_years_in_business_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_years_in_business_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_address_type_desc(SALT311.StrType s0) := s0;
EXPORT InValid_address_type_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_address_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_employee_size_desc(SALT311.StrType s0) := s0;
EXPORT InValid_employee_size_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_employee_size_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_annual_sales_size_desc(SALT311.StrType s0) := s0;
EXPORT InValid_annual_sales_size_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_annual_sales_size_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_location_desc(SALT311.StrType s0) := s0;
EXPORT InValid_location_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_location_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_primary_sic_code_industry_class_desc(SALT311.StrType s0) := s0;
EXPORT InValid_primary_sic_code_industry_class_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_primary_sic_code_industry_class_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_business_type_desc(SALT311.StrType s0) := s0;
EXPORT InValid_business_type_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_business_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_ownership_code_desc(SALT311.StrType s0) := s0;
EXPORT InValid_ownership_code_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_ownership_code_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_ucc_data_indicator_desc(SALT311.StrType s0) := s0;
EXPORT InValid_ucc_data_indicator_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_ucc_data_indicator_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_experian_credit_rating_desc(SALT311.StrType s0) := s0;
EXPORT InValid_experian_credit_rating_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_experian_credit_rating_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_last_activity_age_desc(SALT311.StrType s0) := s0;
EXPORT InValid_last_activity_age_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_last_activity_age_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cottage_indicator_desc(SALT311.StrType s0) := s0;
EXPORT InValid_cottage_indicator_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_cottage_indicator_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_nonprofit_indicator_desc(SALT311.StrType s0) := s0;
EXPORT InValid_nonprofit_indicator_desc(SALT311.StrType s) := 0;
EXPORT InValidMessage_nonprofit_indicator_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_company_name(SALT311.StrType s0) := MakeFT_invalid_bName_pName(s0);
EXPORT InValid_company_name(SALT311.StrType s,SALT311.StrType p_fname,SALT311.StrType p_mname,SALT311.StrType p_lname) := InValidFT_invalid_bName_pName(s,p_fname,p_mname,p_lname);
EXPORT InValidMessage_company_name(UNSIGNED1 wh) := InValidMessageFT_invalid_bName_pName(wh);
 
EXPORT Make_p_title(SALT311.StrType s0) := s0;
EXPORT InValid_p_title(SALT311.StrType s) := 0;
EXPORT InValidMessage_p_title(UNSIGNED1 wh) := '';
 
EXPORT Make_p_fname(SALT311.StrType s0) := MakeFT_invalid_bName_fName(s0);
EXPORT InValid_p_fname(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_mname,SALT311.StrType p_lname) := InValidFT_invalid_bName_fName(s,company_name,p_mname,p_lname);
EXPORT InValidMessage_p_fname(UNSIGNED1 wh) := InValidMessageFT_invalid_bName_fName(wh);
 
EXPORT Make_p_mname(SALT311.StrType s0) := MakeFT_invalid_bName_mName(s0);
EXPORT InValid_p_mname(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_fname,SALT311.StrType p_lname) := InValidFT_invalid_bName_mName(s,company_name,p_fname,p_lname);
EXPORT InValidMessage_p_mname(UNSIGNED1 wh) := InValidMessageFT_invalid_bName_mName(wh);
 
EXPORT Make_p_lname(SALT311.StrType s0) := MakeFT_invalid_bName_lName(s0);
EXPORT InValid_p_lname(SALT311.StrType s,SALT311.StrType company_name,SALT311.StrType p_fname,SALT311.StrType p_mname) := InValidFT_invalid_bName_lName(s,company_name,p_fname,p_mname);
EXPORT InValidMessage_p_lname(UNSIGNED1 wh) := InValidMessageFT_invalid_bName_lName(wh);
 
EXPORT Make_p_name_suffix(SALT311.StrType s0) := s0;
EXPORT InValid_p_name_suffix(SALT311.StrType s) := 0;
EXPORT InValidMessage_p_name_suffix(UNSIGNED1 wh) := '';
 
EXPORT Make_raw_aid(SALT311.StrType s0) := MakeFT_invalid_raw_aid(s0);
EXPORT InValid_raw_aid(SALT311.StrType s) := InValidFT_invalid_raw_aid(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT311,Scrubs_Experian_CRDB;
