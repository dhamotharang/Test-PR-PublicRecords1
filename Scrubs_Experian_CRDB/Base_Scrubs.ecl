...
// The module to handle the case where no scrubs exist
  ...
  END;
  EXPORT Rule_Layout := RECORD(Base_Layout_Experian_CRDB)
...
EXPORT FromNone(DATASET(Base_Layout_Experian_CRDB) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.bdid_score_Invalid := Base_Fields.InValid_bdid_score((SALT311.StrType)le.bdid_score);
    ...
    SELF.experian_bus_id_Invalid := Base_Fields.InValid_experian_bus_id((SALT311.StrType)le.experian_bus_id);
    SELF.business_name_Invalid := Base_Fields.InValid_business_name((SALT311.StrType)le.business_name);
    SELF.address_Invalid := Base_Fields.InValid_address((SALT311.StrType)le.address);
    ...
    SELF.zip_plus_4_Invalid := Base_Fields.InValid_zip_plus_4((SALT311.StrType)le.zip_plus_4);
    SELF.carrier_route_Invalid := Base_Fields.InValid_carrier_route((SALT311.StrType)le.carrier_route);
    SELF.county_code_Invalid := Base_Fields.InValid_county_code((SALT311.StrType)le.county_code);
    SELF.county_name_Invalid := Base_Fields.InValid_county_name((SALT311.StrType)le.county_name);
    SELF.phone_number_Invalid := Base_Fields.InValid_phone_number((SALT311.StrType)le.phone_number);
    SELF.msa_code_Invalid := Base_Fields.InValid_msa_code((SALT311.StrType)le.msa_code);
    SELF.establish_date_Invalid := Base_Fields.InValid_establish_date((SALT311.StrType)le.establish_date);
    SELF.latest_reported_date_Invalid := Base_Fields.InValid_latest_reported_date((SALT311.StrType)le.latest_reported_date);
    SELF.years_in_file_Invalid := Base_Fields.InValid_years_in_file((SALT311.StrType)le.years_in_file);
    SELF.geo_code_latitude_Invalid := Base_Fields.InValid_geo_code_latitude((SALT311.StrType)le.geo_code_latitude);
    SELF.geo_code_latitude_direction_Invalid := Base_Fields.InValid_geo_code_latitude_direction((SALT311.StrType)le.geo_code_latitude_direction);
    SELF.geo_code_longitude_Invalid := Base_Fields.InValid_geo_code_longitude((SALT311.StrType)le.geo_code_longitude);
    SELF.geo_code_longitude_direction_Invalid := Base_Fields.InValid_geo_code_longitude_direction((SALT311.StrType)le.geo_code_longitude_direction);
    SELF.recent_update_code_Invalid := Base_Fields.InValid_recent_update_code((SALT311.StrType)le.recent_update_code);
    SELF.years_in_business_code_Invalid := Base_Fields.InValid_years_in_business_code((SALT311.StrType)le.years_in_business_code);
    SELF.year_business_started_Invalid := Base_Fields.InValid_year_business_started((SALT311.StrType)le.year_business_started);
    SELF.months_in_file_Invalid := Base_Fields.InValid_months_in_file((SALT311.StrType)le.months_in_file);
    SELF.address_type_code_Invalid := Base_Fields.InValid_address_type_code((SALT311.StrType)le.address_type_code);
    SELF.estimated_number_of_employees_Invalid := Base_Fields.InValid_estimated_number_of_employees((SALT311.StrType)le.estimated_number_of_employees);
    SELF.employee_size_code_Invalid := Base_Fields.InValid_employee_size_code((SALT311.StrType)le.employee_size_code);
    SELF.estimated_annual_sales_amount_sign_Invalid := Base_Fields.InValid_estimated_annual_sales_amount_sign((SALT311.StrType)le.estimated_annual_sales_amount_sign);
    SELF.estimated_annual_sales_amount_Invalid := Base_Fields.InValid_estimated_annual_sales_amount((SALT311.StrType)le.estimated_annual_sales_amount);
    SELF.annual_sales_size_code_Invalid := Base_Fields.InValid_annual_sales_size_code((SALT311.StrType)le.annual_sales_size_code);
    SELF.location_code_Invalid := Base_Fields.InValid_location_code((SALT311.StrType)le.location_code);
    SELF.primary_sic_code_industry_classification_Invalid := Base_Fields.InValid_primary_sic_code_industry_classification((SALT311.StrType)le.primary_sic_code_industry_classification);
    SELF.primary_sic_code_4_digit_Invalid := Base_Fields.InValid_primary_sic_code_4_digit((SALT311.StrType)le.primary_sic_code_4_digit);
    SELF.primary_sic_code_Invalid := Base_Fields.InValid_primary_sic_code((SALT311.StrType)le.primary_sic_code);
    SELF.second_sic_code_Invalid := Base_Fields.InValid_second_sic_code((SALT311.StrType)le.second_sic_code);
    SELF.third_sic_code_Invalid := Base_Fields.InValid_third_sic_code((SALT311.StrType)le.third_sic_code);
    SELF.fourth_sic_code_Invalid := Base_Fields.InValid_fourth_sic_code((SALT311.StrType)le.fourth_sic_code);
    SELF.fifth_sic_code_Invalid := Base_Fields.InValid_fifth_sic_code((SALT311.StrType)le.fifth_sic_code);
    SELF.sixth_sic_code_Invalid := Base_Fields.InValid_sixth_sic_code((SALT311.StrType)le.sixth_sic_code);
    SELF.primary_naics_code_Invalid := Base_Fields.InValid_primary_naics_code((SALT311.StrType)le.primary_naics_code);
    SELF.second_naics_code_Invalid := Base_Fields.InValid_second_naics_code((SALT311.StrType)le.second_naics_code);
    SELF.third_naics_code_Invalid := Base_Fields.InValid_third_naics_code((SALT311.StrType)le.third_naics_code);
    SELF.fourth_naics_code_Invalid := Base_Fields.InValid_fourth_naics_code((SALT311.StrType)le.fourth_naics_code);
    SELF.executive_count_Invalid := Base_Fields.InValid_executive_count((SALT311.StrType)le.executive_count);
    SELF.business_type_Invalid := Base_Fields.InValid_business_type((SALT311.StrType)le.business_type);
    SELF.ownership_code_Invalid := Base_Fields.InValid_ownership_code((SALT311.StrType)le.ownership_code);
    SELF.derogatory_indicator_Invalid := Base_Fields.InValid_derogatory_indicator((SALT311.StrType)le.derogatory_indicator);
    SELF.recent_derogatory_filed_date_Invalid := Base_Fields.InValid_recent_derogatory_filed_date((SALT311.StrType)le.recent_derogatory_filed_date);
    SELF.derogatory_liability_amount_sign_Invalid := Base_Fields.InValid_derogatory_liability_amount_sign((SALT311.StrType)le.derogatory_liability_amount_sign);
    SELF.derogatory_liability_amount_Invalid := Base_Fields.InValid_derogatory_liability_amount((SALT311.StrType)le.derogatory_liability_amount);
    SELF.ucc_data_indicator_Invalid := Base_Fields.InValid_ucc_data_indicator((SALT311.StrType)le.ucc_data_indicator);
    SELF.ucc_count_Invalid := Base_Fields.InValid_ucc_count((SALT311.StrType)le.ucc_count);
    SELF.number_of_legal_items_Invalid := Base_Fields.InValid_number_of_legal_items((SALT311.StrType)le.number_of_legal_items);
    SELF.legal_balance_sign_Invalid := Base_Fields.InValid_legal_balance_sign((SALT311.StrType)le.legal_balance_sign);
    SELF.legal_balance_amount_Invalid := Base_Fields.InValid_legal_balance_amount((SALT311.StrType)le.legal_balance_amount);
    SELF.pmtkbankruptcy_Invalid := Base_Fields.InValid_pmtkbankruptcy((SALT311.StrType)le.pmtkbankruptcy);
    SELF.pmtkjudgment_Invalid := Base_Fields.InValid_pmtkjudgment((SALT311.StrType)le.pmtkjudgment);
    SELF.pmtktaxlien_Invalid := Base_Fields.InValid_pmtktaxlien((SALT311.StrType)le.pmtktaxlien);
    SELF.pmtkpayment_Invalid := Base_Fields.InValid_pmtkpayment((SALT311.StrType)le.pmtkpayment);
    SELF.bankruptcy_filed_Invalid := Base_Fields.InValid_bankruptcy_filed((SALT311.StrType)le.bankruptcy_filed);
    SELF.number_of_derogatory_legal_items_Invalid := Base_Fields.InValid_number_of_derogatory_legal_items((SALT311.StrType)le.number_of_derogatory_legal_items);
    SELF.lien_count_Invalid := Base_Fields.InValid_lien_count((SALT311.StrType)le.lien_count);
    SELF.judgment_count_Invalid := Base_Fields.InValid_judgment_count((SALT311.StrType)le.judgment_count);
    SELF.bkc006_Invalid := Base_Fields.InValid_bkc006((SALT311.StrType)le.bkc006);
    SELF.bkc007_Invalid := Base_Fields.InValid_bkc007((SALT311.StrType)le.bkc007);
    SELF.bkc008_Invalid := Base_Fields.InValid_bkc008((SALT311.StrType)le.bkc008);
    SELF.bko009_Invalid := Base_Fields.InValid_bko009((SALT311.StrType)le.bko009);
    SELF.bkb001_sign_Invalid := Base_Fields.InValid_bkb001_sign((SALT311.StrType)le.bkb001_sign);
    SELF.bkb001_Invalid := Base_Fields.InValid_bkb001((SALT311.StrType)le.bkb001);
    SELF.bkb003_sign_Invalid := Base_Fields.InValid_bkb003_sign((SALT311.StrType)le.bkb003_sign);
    SELF.bkb003_Invalid := Base_Fields.InValid_bkb003((SALT311.StrType)le.bkb003);
    SELF.bko010_Invalid := Base_Fields.InValid_bko010((SALT311.StrType)le.bko010);
    SELF.bko011_Invalid := Base_Fields.InValid_bko011((SALT311.StrType)le.bko011);
    SELF.jdc010_Invalid := Base_Fields.InValid_jdc010((SALT311.StrType)le.jdc010);
    SELF.jdc011_Invalid := Base_Fields.InValid_jdc011((SALT311.StrType)le.jdc011);
    SELF.jdc012_Invalid := Base_Fields.InValid_jdc012((SALT311.StrType)le.jdc012);
    SELF.jdb004_Invalid := Base_Fields.InValid_jdb004((SALT311.StrType)le.jdb004);
    SELF.jdb005_Invalid := Base_Fields.InValid_jdb005((SALT311.StrType)le.jdb005);
    SELF.jdb006_Invalid := Base_Fields.InValid_jdb006((SALT311.StrType)le.jdb006);
    SELF.jDO013_Invalid := Base_Fields.InValid_jDO013((SALT311.StrType)le.jDO013);
    SELF.jDO014_Invalid := Base_Fields.InValid_jDO014((SALT311.StrType)le.jDO014);
    SELF.jdb002_Invalid := Base_Fields.InValid_jdb002((SALT311.StrType)le.jdb002);
    SELF.jdp016_Invalid := Base_Fields.InValid_jdp016((SALT311.StrType)le.jdp016);
    SELF.lgc004_Invalid := Base_Fields.InValid_lgc004((SALT311.StrType)le.lgc004);
    SELF.pro001_Invalid := Base_Fields.InValid_pro001((SALT311.StrType)le.pro001);
    SELF.pro003_Invalid := Base_Fields.InValid_pro003((SALT311.StrType)le.pro003);
    SELF.txc010_Invalid := Base_Fields.InValid_txc010((SALT311.StrType)le.txc010);
    SELF.txc011_Invalid := Base_Fields.InValid_txc011((SALT311.StrType)le.txc011);
    SELF.txb004_sign_Invalid := Base_Fields.InValid_txb004_sign((SALT311.StrType)le.txb004_sign);
    SELF.txb004_Invalid := Base_Fields.InValid_txb004((SALT311.StrType)le.txb004);
    SELF.txo013_Invalid := Base_Fields.InValid_txo013((SALT311.StrType)le.txo013);
    SELF.txb002_sign_Invalid := Base_Fields.InValid_txb002_sign((SALT311.StrType)le.txb002_sign);
    SELF.txb002_Invalid := Base_Fields.InValid_txb002((SALT311.StrType)le.txb002);
    SELF.txp016_Invalid := Base_Fields.InValid_txp016((SALT311.StrType)le.txp016);
    SELF.ucc001_Invalid := Base_Fields.InValid_ucc001((SALT311.StrType)le.ucc001);
    SELF.ucc002_Invalid := Base_Fields.InValid_ucc002((SALT311.StrType)le.ucc002);
    SELF.ucc003_Invalid := Base_Fields.InValid_ucc003((SALT311.StrType)le.ucc003);
    SELF.intelliscore_plus_Invalid := Base_Fields.InValid_intelliscore_plus((SALT311.StrType)le.intelliscore_plus);
    SELF.percentile_model_Invalid := Base_Fields.InValid_percentile_model((SALT311.StrType)le.percentile_model);
    SELF.model_action_Invalid := Base_Fields.InValid_model_action((SALT311.StrType)le.model_action);
    SELF.score_factor_1_Invalid := Base_Fields.InValid_score_factor_1((SALT311.StrType)le.score_factor_1);
    SELF.score_factor_2_Invalid := Base_Fields.InValid_score_factor_2((SALT311.StrType)le.score_factor_2);
    SELF.score_factor_3_Invalid := Base_Fields.InValid_score_factor_3((SALT311.StrType)le.score_factor_3);
    SELF.score_factor_4_Invalid := Base_Fields.InValid_score_factor_4((SALT311.StrType)le.score_factor_4);
    SELF.model_type_Invalid := Base_Fields.InValid_model_type((SALT311.StrType)le.model_type);
    SELF.last_experian_inquiry_date_Invalid := Base_Fields.InValid_last_experian_inquiry_date((SALT311.StrType)le.last_experian_inquiry_date);
    SELF.recent_high_credit_sign_Invalid := Base_Fields.InValid_recent_high_credit_sign((SALT311.StrType)le.recent_high_credit_sign);
    SELF.recent_high_credit_Invalid := Base_Fields.InValid_recent_high_credit((SALT311.StrType)le.recent_high_credit);
    SELF.median_credit_amount_sign_Invalid := Base_Fields.InValid_median_credit_amount_sign((SALT311.StrType)le.median_credit_amount_sign);
    SELF.median_credit_amount_Invalid := Base_Fields.InValid_median_credit_amount((SALT311.StrType)le.median_credit_amount);
    SELF.total_combined_trade_lines_count_Invalid := Base_Fields.InValid_total_combined_trade_lines_count((SALT311.StrType)le.total_combined_trade_lines_count);
    SELF.dbt_of_combined_trade_totals_Invalid := Base_Fields.InValid_dbt_of_combined_trade_totals((SALT311.StrType)le.dbt_of_combined_trade_totals);
    SELF.combined_trade_balance_Invalid := Base_Fields.InValid_combined_trade_balance((SALT311.StrType)le.combined_trade_balance);
    SELF.aged_trade_lines_Invalid := Base_Fields.InValid_aged_trade_lines((SALT311.StrType)le.aged_trade_lines);
    SELF.experian_credit_rating_Invalid := Base_Fields.InValid_experian_credit_rating((SALT311.StrType)le.experian_credit_rating);
    SELF.quarter_1_average_dbt_Invalid := Base_Fields.InValid_quarter_1_average_dbt((SALT311.StrType)le.quarter_1_average_dbt);
    SELF.quarter_2_average_dbt_Invalid := Base_Fields.InValid_quarter_2_average_dbt((SALT311.StrType)le.quarter_2_average_dbt);
    SELF.quarter_3_average_dbt_Invalid := Base_Fields.InValid_quarter_3_average_dbt((SALT311.StrType)le.quarter_3_average_dbt);
    SELF.quarter_4_average_dbt_Invalid := Base_Fields.InValid_quarter_4_average_dbt((SALT311.StrType)le.quarter_4_average_dbt);
    SELF.quarter_5_average_dbt_Invalid := Base_Fields.InValid_quarter_5_average_dbt((SALT311.StrType)le.quarter_5_average_dbt);
    SELF.combined_dbt_Invalid := Base_Fields.InValid_combined_dbt((SALT311.StrType)le.combined_dbt);
    SELF.total_account_balance_sign_Invalid := Base_Fields.InValid_total_account_balance_sign((SALT311.StrType)le.total_account_balance_sign);
    SELF.total_account_balance_Invalid := Base_Fields.InValid_total_account_balance((SALT311.StrType)le.total_account_balance);
    SELF.combined_account_balance_sign_Invalid := Base_Fields.InValid_combined_account_balance_sign((SALT311.StrType)le.combined_account_balance_sign);
    SELF.combined_account_balance_Invalid := Base_Fields.InValid_combined_account_balance((SALT311.StrType)le.combined_account_balance);
    SELF.collection_count_Invalid := Base_Fields.InValid_collection_count((SALT311.StrType)le.collection_count);
    SELF.atc021_Invalid := Base_Fields.InValid_atc021((SALT311.StrType)le.atc021);
    SELF.atc022_Invalid := Base_Fields.InValid_atc022((SALT311.StrType)le.atc022);
    SELF.atc023_Invalid := Base_Fields.InValid_atc023((SALT311.StrType)le.atc023);
    SELF.atc024_Invalid := Base_Fields.InValid_atc024((SALT311.StrType)le.atc024);
    SELF.atc025_Invalid := Base_Fields.InValid_atc025((SALT311.StrType)le.atc025);
    SELF.last_activity_age_code_Invalid := Base_Fields.InValid_last_activity_age_code((SALT311.StrType)le.last_activity_age_code);
    SELF.cottage_indicator_Invalid := Base_Fields.InValid_cottage_indicator((SALT311.StrType)le.cottage_indicator);
    SELF.nonprofit_indicator_Invalid := Base_Fields.InValid_nonprofit_indicator((SALT311.StrType)le.nonprofit_indicator);
    SELF.financial_stability_risk_score_Invalid := Base_Fields.InValid_financial_stability_risk_score((SALT311.StrType)le.financial_stability_risk_score);
    SELF.fsr_risk_class_Invalid := Base_Fields.InValid_fsr_risk_class((SALT311.StrType)le.fsr_risk_class);
    SELF.fsr_score_factor_1_Invalid := Base_Fields.InValid_fsr_score_factor_1((SALT311.StrType)le.fsr_score_factor_1);
    SELF.fsr_score_factor_2_Invalid := Base_Fields.InValid_fsr_score_factor_2((SALT311.StrType)le.fsr_score_factor_2);
    SELF.fsr_score_factor_3_Invalid := Base_Fields.InValid_fsr_score_factor_3((SALT311.StrType)le.fsr_score_factor_3);
    SELF.fsr_score_factor_4_Invalid := Base_Fields.InValid_fsr_score_factor_4((SALT311.StrType)le.fsr_score_factor_4);
    SELF.ip_score_change_sign_Invalid := Base_Fields.InValid_ip_score_change_sign((SALT311.StrType)le.ip_score_change_sign);
    SELF.ip_score_change_Invalid := Base_Fields.InValid_ip_score_change((SALT311.StrType)le.ip_score_change);
    SELF.fsr_score_change_sign_Invalid := Base_Fields.InValid_fsr_score_change_sign((SALT311.StrType)le.fsr_score_change_sign);
    SELF.fsr_score_change_Invalid := Base_Fields.InValid_fsr_score_change((SALT311.StrType)le.fsr_score_change);
    ...
    SELF.company_name_Invalid := Base_Fields.InValid_company_name((SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_mname,(SALT311.StrType)le.p_lname);
    SELF.p_fname_Invalid := Base_Fields.InValid_p_fname((SALT311.StrType)le.p_fname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_mname,(SALT311.StrType)le.p_lname);
    SELF.p_mname_Invalid := Base_Fields.InValid_p_mname((SALT311.StrType)le.p_mname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_lname);
    SELF.p_lname_Invalid := Base_Fields.InValid_p_lname((SALT311.StrType)le.p_lname,(SALT311.StrType)le.company_name,(SALT311.StrType)le.p_fname,(SALT311.StrType)le.p_mname);
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.predir_Invalid := (le.ScrubsBits3 >> 43) & 1;
    SELF.prim_name_Invalid := (le.ScrubsBits3 >> 44) & 1;
    SELF.postdir_Invalid := (le.ScrubsBits3 >> 45) & 1;
    SELF.p_city_name_Invalid := (le.ScrubsBits3 >> 46) & 1;
    SELF.v_city_name_Invalid := (le.ScrubsBits3 >> 47) & 1;
    SELF.st_Invalid := (le.ScrubsBits3 >> 48) & 1;
    SELF.zip_Invalid := (le.ScrubsBits3 >> 49) & 1;
    SELF.zip4_Invalid := (le.ScrubsBits3 >> 50) & 1;
    SELF.cart_Invalid := (le.ScrubsBits3 >> 51) & 1;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits3 >> 52) & 1;
    SELF.lot_Invalid := (le.ScrubsBits3 >> 53) & 1;
    SELF.lot_order_Invalid := (le.ScrubsBits3 >> 54) & 1;
    SELF.dbpc_Invalid := (le.ScrubsBits3 >> 55) & 1;
    SELF.chk_digit_Invalid := (le.ScrubsBits3 >> 56) & 1;
    SELF.fips_state_Invalid := (le.ScrubsBits3 >> 57) & 1;
    SELF.fips_county_Invalid := (le.ScrubsBits3 >> 58) & 1;
    SELF.geo_lat_Invalid := (le.ScrubsBits3 >> 59) & 1;
    SELF.geo_long_Invalid := (le.ScrubsBits3 >> 60) & 1;
    SELF.msa_Invalid := (le.ScrubsBits3 >> 61) & 1;
    SELF.geo_match_Invalid := (le.ScrubsBits3 >> 62) & 1;
    SELF.err_stat_Invalid := (le.ScrubsBits3 >> 63) & 1;
    SELF.company_name_Invalid := (le.ScrubsBits4 >> 0) & 1;
    SELF.p_fname_Invalid := (le.ScrubsBits4 >> 1) & 1;
    SELF.p_mname_Invalid := (le.ScrubsBits4 >> 2) & 1;
    SELF.p_lname_Invalid := (le.ScrubsBits4 >> 3) & 1;
    SELF.raw_aid_Invalid := (le.ScrubsBits4 >> 4) & 1;
    SELF.ace_aid_Invalid := (le.ScrubsBits4 >> 5) & 1;
    SELF.prep_addr_line1_Invalid := (le.ScrubsBits4 >> 6) & 1;
    SELF.prep_addr_line_last_Invalid := (le.ScrubsBits4 >> 7) & 1;
    SELF.source_rec_id_Invalid := (le.ScrubsBits4 >> 8) & 1;
    SELF := le;
  END;
...
EXPORT StandardStats(DATASET(Base_Layout_Experian_CRDB) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_Experian_CRDB, Base_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
