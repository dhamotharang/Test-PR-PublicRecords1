...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_NV_Stock';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_NV_Stock\n'
    + 'FILENAME:In_NV\n'
    ...
    + 'FIELDTYPE:invalid_corp_vendor:ENUM(32|32)\n'
    + 'FIELDTYPE:invalid_state_origin:ENUM(NV|NV)\n'
    ...
    + 'FIELDTYPE:invalid_stock_authorized_nbr:ALLOW(,.0123456789)\n'
    + 'FIELDTYPE:invalid_stock_par_value:ALLOW(,.0123456789)\n'
    + 'FIELDTYPE:invalid_stock_nbr_par_shares:ALLOW(.,0123456789)\n'
    + 'FIELDTYPE:invalid_stock_total_capital:ALLOW(,.0123456789)\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
    ...
    + 'FIELD:stock_par_value:TYPE(STRING15):LIKE(invalid_stock_par_value):0,0\n'
    + 'FIELD:stock_nbr_par_shares:TYPE(STRING15):LIKE(invalid_stock_nbr_par_shares):0,0\n'
    ...
    + 'FIELD:stock_total_capital:TYPE(STRING15):LIKE(invalid_stock_total_capital):0,0\n'
