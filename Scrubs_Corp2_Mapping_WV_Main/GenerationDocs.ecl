...
Command line options: -MScrubs_Corp2_Mapping_WV_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR5A88.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_WV_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(54)
FIELDTYPE:invalid_state_origin:ENUM(WV)
FIELDTYPE:invalid_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_WV_Main.Functions.valid_org_structure_codes)
...
FIELDTYPE:invalid_charter:ALLOW(-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ):LENGTHS(1..)
...
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_WV_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_Termination_Cd:ENUM(Scrubs_Corp2_Mapping_WV_Main.Functions.valid_Termination_codes)
FIELDTYPE:invalid_country_of_formation:ALLOW( (),. ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_Termination_Desc:ALLOW( (),ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_address1_effective_date:0,0
...
FIELD:corp_action_pending_cd:TYPE(STRING1):LIKE(invalid_Termination_Cd):0,0
FIELD:corp_action_pending_desc:TYPE(STRING50):LIKE(invalid_Termination_desc):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_country_of_formation):0,0
...
FIELD:corp_termination_cd:TYPE(STRING2):LIKE(invalid_Termination_Cd):0,0
FIELD:corp_termination_desc:TYPE(STRING100):LIKE(invalid_Termination_Desc):0,0
