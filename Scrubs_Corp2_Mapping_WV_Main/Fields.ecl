IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_WV_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_org_structure_cd','invalid_org_structure_desc','invalid_mandatory','invalid_numeric','invalid_charter','invalid_alphaOnly','invalid_alphaRequired','invalid_date','invalid_zip','invalid_recordorigin','invalid_foreign_domestic_ind','invalid_flag_code','invalid_alphablank','invalid_name_type_code','invalid_Termination_Cd','invalid_country_of_formation','invalid_Termination_Desc');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_org_structure_cd' => 4,'invalid_org_structure_desc' => 5,'invalid_mandatory' => 6,'invalid_numeric' => 7,'invalid_charter' => 8,'invalid_alphaOnly' => 9,'invalid_alphaRequired' => 10,'invalid_date' => 11,'invalid_zip' => 12,'invalid_recordorigin' => 13,'invalid_foreign_domestic_ind' => 14,'invalid_flag_code' => 15,'invalid_alphablank' => 16,'invalid_name_type_code' => 17,'invalid_Termination_Cd' => 18,'invalid_country_of_formation' => 19,'invalid_Termination_Desc' => 20,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['54']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('54'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['WV']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('WV'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_WV_Main.Functions.valid_org_structure_codes);
EXPORT InValidMessageFT_invalid_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_WV_Main.Functions.valid_org_structure_codes'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_charter(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaOnly(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaOnly(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))));
EXPORT InValidMessageFT_invalid_alphaOnly(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_WV_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_WV_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_Termination_Cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_Termination_Cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_WV_Main.Functions.valid_Termination_codes);
EXPORT InValidMessageFT_invalid_Termination_Cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_WV_Main.Functions.valid_Termination_codes'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_Termination_Desc(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' (),ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_Termination_Desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' (),ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_Termination_Desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' (),ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_action_pending_cd(SALT34.StrType s0) := MakeFT_invalid_Termination_Cd(s0);
EXPORT InValid_corp_action_pending_cd(SALT34.StrType s) := InValidFT_invalid_Termination_Cd(s);
EXPORT InValidMessage_corp_action_pending_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_Termination_Cd(wh);
 
EXPORT Make_corp_action_pending_desc(SALT34.StrType s0) := MakeFT_invalid_Termination_Desc(s0);
EXPORT InValid_corp_action_pending_desc(SALT34.StrType s) := InValidFT_invalid_Termination_Desc(s);
EXPORT InValidMessage_corp_action_pending_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_Termination_Desc(wh);
...
EXPORT Make_corp_termination_cd(SALT34.StrType s0) := MakeFT_invalid_Termination_Cd(s0);
EXPORT InValid_corp_termination_cd(SALT34.StrType s) := InValidFT_invalid_Termination_Cd(s);
EXPORT InValidMessage_corp_termination_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_Termination_Cd(wh);
 
EXPORT Make_corp_termination_desc(SALT34.StrType s0) := MakeFT_invalid_Termination_Desc(s0);
EXPORT InValid_corp_termination_desc(SALT34.StrType s) := InValidFT_invalid_Termination_Desc(s);
EXPORT InValidMessage_corp_termination_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_Termination_Desc(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_WV_Main;
