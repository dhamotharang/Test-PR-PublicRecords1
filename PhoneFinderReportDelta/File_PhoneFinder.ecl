EXPORT File_PhoneFinder := MODULE
		...
		export Identities_Main				:= dataset('~thor_data400::base::phonefinderreportdelta::identities', 					PhoneFinderReportDelta.Layout_PhoneFinder.Identities_Main, flat);
		export OtherPhones_Main				:= dataset('~thor_data400::base::phonefinderreportdelta::otherphones', 					PhoneFinderReportDelta.Layout_PhoneFinder.OtherPhones_Main, flat);
		export RiskIndicators_Main		:= dataset('~thor_data400::base::phonefinderreportdelta::riskindicators', 			PhoneFinderReportDelta.Layout_PhoneFinder.RiskIndicators_Main, flat);
		export Transactions_Main			:= dataset('~thor_data400::base::phonefinderreportdelta::transactions', 				PhoneFinderReportDelta.Layout_PhoneFinder.Transactions_Main, flat);
