...
SHARED Layouts := fiwn12103_0_nossn.z_layouts;
...
SHARED lzFilePathFolder  := '/data/LUCI/FIWN12103_0_NOSSN/';
SHARED CSVSprayFile := '~mmarshik::in::fiwn12103_0_nossn-validation-file.csv';
SHARED lzFilePath        := lzFilePathFolder + CSVSprayFile;
SHARED SprayCSVName      := '~mmarshik::in::fiwn12103_0_nossn-validation-file.csv'; // Will set up by user if test file is a logical file.
...
SHARED isCSVFile := TRUE;
  //fiwn12103_0_nossn.FNSpray(LandingZoneIP, lzFilePath, SprayCSVName, CSVSpraySeparator, CSVSprayQuote);
/******************************************************************************\
...
SHARED RawInputSet := PROJECT(RawInputSet0, TRANSFORM(Layouts.Input_Layouts, SELF.do_FIWN12103_0_NOSSN := TRUE, SELF := LEFT));
