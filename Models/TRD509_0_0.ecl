...
export TRD509_0_0(grouped dataset(Risk_Indicators.Layout_Boca_Shell) clam, unsigned3 history_date=999999, boolean OFAC=true) := 
FUNCTION

// need to calculate inCalif in here
inCalif := false;
