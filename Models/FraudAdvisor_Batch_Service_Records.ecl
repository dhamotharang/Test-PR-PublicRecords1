...
#END		
    ...
    //End for Paro
		...
		// Identity Authentication Attributes
			...
			// version2
			self.index4 := if(doVersion2, '0', '');	
			self.v2_IdentityRiskLevel	:= if(doVersion2, le.version2.IdentityRiskLevel, '');
			self.v2_IdentityAgeOldest	:= if(doVersion2, le.version2.IdentityAgeOldest, '');
			self.v2_IdentityAgeNewest	:= if(doVersion2, le.version2.IdentityAgeNewest, '');
			self.v2_IdentityRecentUpdate	:= if(doVersion2, le.version2.IdentityRecentUpdate, '');
			self.v2_IdentityRecordCount	:= if(doVersion2, le.version2.IdentityRecordCount, '');
			self.v2_IdentitySourceCount	:= if(doVersion2, le.version2.IdentitySourceCount, '');
			self.v2_IdentityAgeRiskIndicator	:= if(doVersion2, le.version2.IdentityAgeRiskIndicator, '');
			self.v2_IDVerRiskLevel	:= if(doVersion2, le.version2.IDVerRiskLevel, '');
			self.v2_IDVerSSN	:= if(doVersion2, le.version2.IDVerSSN, '');
			self.v2_IDVerName	:= if(doVersion2, le.version2.IDVerName, '');
			self.v2_IDVerAddress	:= if(doVersion2, le.version2.IDVerAddress, '');
			self.v2_IDVerAddressNotCurrent	:= if(doVersion2, le.version2.IDVerAddressNotCurrent, '');
			self.v2_IDVerAddressAssocCount	:= if(doVersion2, le.version2.IDVerAddressAssocCount, '');
			self.v2_IDVerPhone	:= if(doVersion2, le.version2.IDVerPhone, '');
			self.v2_IDVerDriversLicense	:= if(doVersion2, le.version2.IDVerDriversLicense, '');
			self.v2_IDVerDOB	:= if(doVersion2, le.version2.IDVerDOB, '');
			self.v2_IDVerSSNSourceCount	:= if(doVersion2, le.version2.IDVerSSNSourceCount, '');
			self.v2_IDVerAddressSourceCount	:= if(doVersion2, le.version2.IDVerAddressSourceCount, '');
			self.v2_IDVerDOBSourceCount	:= if(doVersion2, le.version2.IDVerDOBSourceCount, '');
			self.v2_IDVerSSNCreditBureauCount	:= if(doVersion2, le.version2.IDVerSSNCreditBureauCount, '');
			self.v2_IDVerSSNCreditBureauDelete	:= if(doVersion2, le.version2.IDVerSSNCreditBureauDelete, '');
			self.v2_IDVerAddrCreditBureauCount	:= if(doVersion2, le.version2.IDVerAddrCreditBureauCount, '');
			self.v2_SourceRiskLevel	:= if(doVersion2, le.version2.SourceRiskLevel, '');
			self.v2_SourceFirstReportingIdentity	:= if(doVersion2, le.version2.SourceFirstReportingIdentity, '');
			self.v2_SourceCreditBureau	:= if(doVersion2, le.version2.SourceCreditBureau, '');
			self.v2_SourceCreditBureauCount	:= if(doVersion2, le.version2.SourceCreditBureauCount, '');
			self.v2_SourceCreditBureauAgeOldest	:= if(doVersion2, le.version2.SourceCreditBureauAgeOldest, '');
			self.v2_SourceCreditBureauAgeNewest	:= if(doVersion2, le.version2.SourceCreditBureauAgeNewest, '');
			self.v2_SourceCreditBureauAgeChange	:= if(doVersion2, le.version2.SourceCreditBureauAgeChange, '');
			self.v2_SourcePublicRecord	:= if(doVersion2, le.version2.SourcePublicRecord, '');
			self.v2_SourcePublicRecordCount	:= if(doVersion2, le.version2.SourcePublicRecordCount, '');
			self.v2_SourcePublicRecordCountYear	:= if(doVersion2, le.version2.SourcePublicRecordCountYear, '');
			self.v2_SourceEducation	:= if(doVersion2, le.version2.SourceEducation, '');
			self.v2_SourceOccupationalLicense	:= if(doVersion2, le.version2.SourceOccupationalLicense, '');
			self.v2_SourceVoterRegistration	:= if(doVersion2, le.version2.SourceVoterRegistration, '');
			self.v2_SourceOnlineDirectory	:= if(doVersion2, le.version2.SourceOnlineDirectory, '');
			self.v2_SourceDoNotMail	:= if(doVersion2, le.version2.SourceDoNotMail, '');
			self.v2_SourceAccidents	:= if(doVersion2, le.version2.SourceAccidents, '');
			self.v2_SourceBusinessRecords	:= if(doVersion2, le.version2.SourceBusinessRecords, '');
			self.v2_SourceProperty	:= if(doVersion2, le.version2.SourceProperty, '');
			self.v2_SourceAssets	:= if(doVersion2, le.version2.SourceAssets, '');
			self.v2_SourcePhoneDirectoryAssistance	:= if(doVersion2, le.version2.SourcePhoneDirectoryAssistance, '');
			self.v2_SourcePhoneNonPublicDirectory	:= if(doVersion2, le.version2.SourcePhoneNonPublicDirectory, '');
			self.v2_VariationRiskLevel	:= if(doVersion2, le.version2.VariationRiskLevel, '');
			self.v2_VariationIdentityCount	:= if(doVersion2, le.version2.VariationIdentityCount, '');
			self.v2_VariationSSNCount	:= if(doVersion2, le.version2.VariationSSNCount, '');
			self.v2_VariationSSNCountNew	:= if(doVersion2, le.version2.VariationSSNCountNew, '');
			self.v2_VariationMSourcesSSNCount	:= if(doVersion2, le.version2.VariationMSourcesSSNCount, '');
			self.v2_VariationMSourcesSSNUnrelCount	:= if(doVersion2, le.version2.VariationMSourcesSSNUnrelCount, '');
			self.v2_VariationLastNameCount	:= if(doVersion2, le.version2.VariationLastNameCount, '');
			self.v2_VariationLastNameCountNew	:= if(doVersion2, le.version2.VariationLastNameCountNew, '');
			self.v2_VariationAddrCountYear	:= if(doVersion2, le.version2.VariationAddrCountYear, '');
			self.v2_VariationAddrCountNew	:= if(doVersion2, le.version2.VariationAddrCountNew, '');
			self.v2_VariationAddrStability	:= if(doVersion2, le.version2.VariationAddrStability, '');
			self.v2_VariationAddrChangeAge	:= if(doVersion2, le.version2.VariationAddrChangeAge, '');
			self.v2_VariationDOBCount	:= if(doVersion2, le.version2.VariationDOBCount, '');
			self.v2_VariationDOBCountNew	:= if(doVersion2, le.version2.VariationDOBCountNew, '');
			self.v2_VariationPhoneCount	:= if(doVersion2, le.version2.VariationPhoneCount, '');
			self.v2_VariationPhoneCountNew	:= if(doVersion2, le.version2.VariationPhoneCountNew, '');
			self.v2_VariationSearchSSNCount	:= if(doVersion2, le.version2.VariationSearchSSNCount, '');
			self.v2_VariationSearchAddrCount	:= if(doVersion2, le.version2.VariationSearchAddrCount, '');
			self.v2_VariationSearchPhoneCount	:= if(doVersion2, le.version2.VariationSearchPhoneCount, '');
			self.v2_SearchVelocityRiskLevel	:= if(doVersion2, le.version2.SearchVelocityRiskLevel, '');
			self.v2_SearchCount	:= if(doVersion2, le.version2.SearchCount, '');
			self.v2_SearchCountYear	:= if(doVersion2, le.version2.SearchCountYear, '');
			self.v2_SearchCountMonth	:= if(doVersion2, le.version2.SearchCountMonth, '');
			self.v2_SearchCountWeek	:= if(doVersion2, le.version2.SearchCountWeek, '');
			self.v2_SearchCountDay	:= if(doVersion2, le.version2.SearchCountDay, '');
			self.v2_SearchUnverifiedSSNCountYear	:= if(doVersion2, le.version2.SearchUnverifiedSSNCountYear, '');
			self.v2_SearchUnverifiedAddrCountYear	:= if(doVersion2, le.version2.SearchUnverifiedAddrCountYear, '');
			self.v2_SearchUnverifiedDOBCountYear	:= if(doVersion2, le.version2.SearchUnverifiedDOBCountYear, '');
			self.v2_SearchUnverifiedPhoneCountYear	:= if(doVersion2, le.version2.SearchUnverifiedPhoneCountYear, '');
			self.v2_SearchBankingSearchCount	:= if(doVersion2, le.version2.SearchBankingSearchCount, '');
			self.v2_SearchBankingSearchCountYear	:= if(doVersion2, le.version2.SearchBankingSearchCountYear, '');
			self.v2_SearchBankingSearchCountMonth	:= if(doVersion2, le.version2.SearchBankingSearchCountMonth, '');
			self.v2_SearchBankingSearchCountWeek	:= if(doVersion2, le.version2.SearchBankingSearchCountWeek, '');
			self.v2_SearchBankingSearchCountDay	:= if(doVersion2, le.version2.SearchBankingSearchCountDay, '');
			self.v2_SearchHighRiskSearchCount	:= if(doVersion2, le.version2.SearchHighRiskSearchCount, '');
			self.v2_SearchHighRiskSearchCountYear	:= if(doVersion2, le.version2.SearchHighRiskSearchCountYear, '');
			self.v2_SearchHighRiskSearchCountMonth	:= if(doVersion2, le.version2.SearchHighRiskSearchCountMonth, '');
			self.v2_SearchHighRiskSearchCountWeek	:= if(doVersion2, le.version2.SearchHighRiskSearchCountWeek, '');
			self.v2_SearchHighRiskSearchCountDay	:= if(doVersion2, le.version2.SearchHighRiskSearchCountDay, '');
			self.v2_SearchFraudSearchCount	:= if(doVersion2, le.version2.SearchFraudSearchCount, '');
			self.v2_SearchFraudSearchCountYear	:= if(doVersion2, le.version2.SearchFraudSearchCountYear, '');
			self.v2_SearchFraudSearchCountMonth	:= if(doVersion2, le.version2.SearchFraudSearchCountMonth, '');
			self.v2_SearchFraudSearchCountWeek	:= if(doVersion2, le.version2.SearchFraudSearchCountWeek, '');
			self.v2_SearchFraudSearchCountDay	:= if(doVersion2, le.version2.SearchFraudSearchCountDay, '');
			self.v2_SearchLocateSearchCount	:= if(doVersion2, le.version2.SearchLocateSearchCount, '');
			self.v2_SearchLocateSearchCountYear	:= if(doVersion2, le.version2.SearchLocateSearchCountYear, '');
			self.v2_SearchLocateSearchCountMonth	:= if(doVersion2, le.version2.SearchLocateSearchCountMonth, '');
			self.v2_SearchLocateSearchCountWeek	:= if(doVersion2, le.version2.SearchLocateSearchCountWeek, '');
			self.v2_SearchLocateSearchCountDay	:= if(doVersion2, le.version2.SearchLocateSearchCountDay, '');
			self.v2_AssocRiskLevel	:= if(doVersion2, le.version2.AssocRiskLevel, '');
			self.v2_AssocCount	:= if(doVersion2, le.version2.AssocCount, '');
			self.v2_AssocDistanceClosest	:= if(doVersion2, le.version2.AssocDistanceClosest, '');
			self.v2_AssocSuspicousIdentitiesCount	:= if(doVersion2, le.version2.AssocSuspicousIdentitiesCount, '');
			self.v2_AssocCreditBureauOnlyCount	:= if(doVersion2, le.version2.AssocCreditBureauOnlyCount, '');
			self.v2_AssocCreditBureauOnlyCountNew	:= if(doVersion2, le.version2.AssocCreditBureauOnlyCountNew, '');
			self.v2_AssocCreditBureauOnlyCountMonth	:= if(doVersion2, le.version2.AssocCreditBureauOnlyCountMonth, '');
			self.v2_AssocHighRiskTopologyCount	:= if(doVersion2, le.version2.AssocHighRiskTopologyCount, '');
			self.v2_ValidationRiskLevel	:= if(doVersion2, le.version2.ValidationRiskLevel, '');
			self.v2_ValidationSSNProblems	:= if(doVersion2, le.version2.ValidationSSNProblems, '');
			self.v2_ValidationAddrProblems	:= if(doVersion2, le.version2.ValidationAddrProblems, '');
			self.v2_ValidationPhoneProblems	:= if(doVersion2, le.version2.ValidationPhoneProblems, '');
			self.v2_ValidationDLProblems	:= if(doVersion2, le.version2.ValidationDLProblems, '');
			self.v2_ValidationIPProblems	:= if(doVersion2, le.version2.ValidationIPProblems, '');
			self.v2_CorrelationRiskLevel	:= if(doVersion2, le.version2.CorrelationRiskLevel, '');
			self.v2_CorrelationSSNNameCount	:= if(doVersion2, le.version2.CorrelationSSNNameCount, '');
			self.v2_CorrelationSSNAddrCount	:= if(doVersion2, le.version2.CorrelationSSNAddrCount, '');
			self.v2_CorrelationAddrNameCount	:= if(doVersion2, le.version2.CorrelationAddrNameCount, '');
			self.v2_CorrelationAddrPhoneCount	:= if(doVersion2, le.version2.CorrelationAddrPhoneCount, '');
			self.v2_CorrelationPhoneLastNameCount	:= if(doVersion2, le.version2.CorrelationPhoneLastNameCount, '');
			self.v2_DivRiskLevel	:= if(doVersion2, le.version2.DivRiskLevel, '');
			self.v2_DivSSNIdentityCount	:= if(doVersion2, le.version2.DivSSNIdentityCount, '');
			self.v2_DivSSNIdentityCountNew	:= if(doVersion2, le.version2.DivSSNIdentityCountNew, '');
			self.v2_DivSSNIdentityMSourceCount	:= if(doVersion2, le.version2.DivSSNIdentityMSourceCount, '');
			self.v2_DivSSNIdentityMSourceUrelCount	:= if(doVersion2, le.version2.DivSSNIdentityMSourceUrelCount, '');
			self.v2_DivSSNLNameCount	:= if(doVersion2, le.version2.DivSSNLNameCount, '');
			self.v2_DivSSNLNameCountNew	:= if(doVersion2, le.version2.DivSSNLNameCountNew, '');
			self.v2_DivSSNAddrCount	:= if(doVersion2, le.version2.DivSSNAddrCount, '');
			self.v2_DivSSNAddrCountNew	:= if(doVersion2, le.version2.DivSSNAddrCountNew, '');
			self.v2_DivSSNAddrMSourceCount	:= if(doVersion2, le.version2.DivSSNAddrMSourceCount, '');
			self.v2_DivAddrIdentityCount	:= if(doVersion2, le.version2.DivAddrIdentityCount, '');
			self.v2_DivAddrIdentityCountNew	:= if(doVersion2, le.version2.DivAddrIdentityCountNew, '');
			self.v2_DivAddrIdentityMSourceCount	:= if(doVersion2, le.version2.DivAddrIdentityMSourceCount, '');
			self.v2_DivAddrSuspIdentityCountNew	:= if(doVersion2, le.version2.DivAddrSuspIdentityCountNew, '');
			self.v2_DivAddrSSNCount	:= if(doVersion2, le.version2.DivAddrSSNCount, '');
			self.v2_DivAddrSSNCountNew	:= if(doVersion2, le.version2.DivAddrSSNCountNew, '');
			self.v2_DivAddrSSNMSourceCount	:= if(doVersion2, le.version2.DivAddrSSNMSourceCount, '');
			self.v2_DivAddrPhoneCount	:= if(doVersion2, le.version2.DivAddrPhoneCount, '');
			self.v2_DivAddrPhoneCountNew	:= if(doVersion2, le.version2.DivAddrPhoneCountNew, '');
			self.v2_DivAddrPhoneMSourceCount	:= if(doVersion2, le.version2.DivAddrPhoneMSourceCount, '');
			self.v2_DivPhoneIdentityCount	:= if(doVersion2, le.version2.DivPhoneIdentityCount, '');
			self.v2_DivPhoneIdentityCountNew	:= if(doVersion2, le.version2.DivPhoneIdentityCountNew, '');
			self.v2_DivPhoneIdentityMSourceCount	:= if(doVersion2, le.version2.DivPhoneIdentityMSourceCount, '');
			self.v2_DivPhoneAddrCount	:= if(doVersion2, le.version2.DivPhoneAddrCount, '');
			self.v2_DivPhoneAddrCountNew	:= if(doVersion2, le.version2.DivPhoneAddrCountNew, '');
			self.v2_DivSearchSSNIdentityCount	:= if(doVersion2, le.version2.DivSearchSSNIdentityCount, '');
			self.v2_DivSearchAddrIdentityCount	:= if(doVersion2, le.version2.DivSearchAddrIdentityCount, '');
			self.v2_DivSearchAddrSuspIdentityCount	:= if(doVersion2, le.version2.DivSearchAddrSuspIdentityCount, '');
			self.v2_DivSearchPhoneIdentityCount	:= if(doVersion2, le.version2.DivSearchPhoneIdentityCount, '');
			self.v2_SearchComponentRiskLevel	:= if(doVersion2, le.version2.SearchComponentRiskLevel, '');
			self.v2_SearchSSNSearchCount	:= if(doVersion2, le.version2.SearchSSNSearchCount, '');
			self.v2_SearchSSNSearchCountYear	:= if(doVersion2, le.version2.SearchSSNSearchCountYear, '');
			self.v2_SearchSSNSearchCountMonth	:= if(doVersion2, le.version2.SearchSSNSearchCountMonth, '');
			self.v2_SearchSSNSearchCountWeek	:= if(doVersion2, le.version2.SearchSSNSearchCountWeek, '');
			self.v2_SearchSSNSearchCountDay	:= if(doVersion2, le.version2.SearchSSNSearchCountDay, '');
			self.v2_SearchAddrSearchCount	:= if(doVersion2, le.version2.SearchAddrSearchCount, '');
			self.v2_SearchAddrSearchCountYear	:= if(doVersion2, le.version2.SearchAddrSearchCountYear, '');
			self.v2_SearchAddrSearchCountMonth	:= if(doVersion2, le.version2.SearchAddrSearchCountMonth, '');
			self.v2_SearchAddrSearchCountWeek	:= if(doVersion2, le.version2.SearchAddrSearchCountWeek, '');
			self.v2_SearchAddrSearchCountDay	:= if(doVersion2, le.version2.SearchAddrSearchCountDay, '');
			self.v2_SearchPhoneSearchCount	:= if(doVersion2, le.version2.SearchPhoneSearchCount, '');
			self.v2_SearchPhoneSearchCountYear	:= if(doVersion2, le.version2.SearchPhoneSearchCountYear, '');
			self.v2_SearchPhoneSearchCountMonth	:= if(doVersion2, le.version2.SearchPhoneSearchCountMonth, '');
			self.v2_SearchPhoneSearchCountWeek	:= if(doVersion2, le.version2.SearchPhoneSearchCountWeek, '');
			self.v2_SearchPhoneSearchCountDay	:= if(doVersion2, le.version2.SearchPhoneSearchCountDay, '');
			self.v2_ComponentCharRiskLevel	:= if(doVersion2, le.version2.ComponentCharRiskLevel, '');
			self.v2_SSNHighIssueAge	:= if(doVersion2, le.version2.SSNHighIssueAge, '');
			self.v2_SSNLowIssueAge	:= if(doVersion2, le.version2.SSNLowIssueAge, '');
			self.v2_SSNIssueState	:= if(doVersion2, le.version2.SSNIssueState, '');
			self.v2_SSNNonUS	:= if(doVersion2, le.version2.SSNNonUS, '');
			self.v2_InputPhoneType	:= if(doVersion2, le.version2.InputPhoneType, '');
			self.v2_IPState	:= if(doVersion2, le.version2.IPState, '');
			self.v2_IPCountry	:= if(doVersion2, le.version2.IPCountry, '');
			self.v2_IPContinent	:= if(doVersion2, le.version2.IPContinent, '');
			self.v2_InputAddrAgeOldest	:= if(doVersion2, le.version2.InputAddrAgeOldest, '');
			self.v2_InputAddrAgeNewest	:= if(doVersion2, le.version2.InputAddrAgeNewest, '');
			self.v2_InputAddrType	:= if(doVersion2, le.version2.InputAddrType, '');
			self.v2_InputAddrLenOfRes	:= if(doVersion2, le.version2.InputAddrLenOfRes, '');
			self.v2_InputAddrDwellType	:= if(doVersion2, le.version2.InputAddrDwellType, '');
			self.v2_InputAddrDelivery	:= if(doVersion2, le.version2.InputAddrDelivery, '');
			self.v2_InputAddrActivePhoneList	:= if(doVersion2, le.version2.InputAddrActivePhoneList, '');
			self.v2_InputAddrOccupantOwned	:= if(doVersion2, le.version2.InputAddrOccupantOwned, '');
			self.v2_InputAddrBusinessCount	:= if(doVersion2, le.version2.InputAddrBusinessCount, '');
			self.v2_InputAddrNBRHDBusinessCount	:= if(doVersion2, le.version2.InputAddrNBRHDBusinessCount, '');
			self.v2_InputAddrNBRHDSingleFamilyCount	:= if(doVersion2, le.version2.InputAddrNBRHDSingleFamilyCount, '');
			self.v2_InputAddrNBRHDMultiFamilyCount	:= if(doVersion2, le.version2.InputAddrNBRHDMultiFamilyCount, '');
			self.v2_InputAddrNBRHDMedianIncome	:= if(doVersion2, le.version2.InputAddrNBRHDMedianIncome, '');
			self.v2_InputAddrNBRHDMedianValue	:= if(doVersion2, le.version2.InputAddrNBRHDMedianValue, '');
			self.v2_InputAddrNBRHDMurderIndex	:= if(doVersion2, le.version2.InputAddrNBRHDMurderIndex, '');
			self.v2_InputAddrNBRHDCarTheftIndex	:= if(doVersion2, le.version2.InputAddrNBRHDCarTheftIndex, '');
			self.v2_InputAddrNBRHDBurglaryIndex	:= if(doVersion2, le.version2.InputAddrNBRHDBurglaryIndex, '');
			self.v2_InputAddrNBRHDCrimeIndex	:= if(doVersion2, le.version2.InputAddrNBRHDCrimeIndex, '');
			self.v2_InputAddrNBRHDMobilityIndex	:= if(doVersion2, le.version2.InputAddrNBRHDMobilityIndex, '');
			self.v2_InputAddrNBRHDVacantPropCount	:= if(doVersion2, le.version2.InputAddrNBRHDVacantPropCount, '');
			self.v2_AddrChangeDistance	:= if(doVersion2, le.version2.AddrChangeDistance, '');
			self.v2_AddrChangeStateDiff	:= if(doVersion2, le.version2.AddrChangeStateDiff, '');
			self.v2_AddrChangeIncomeDiff	:= if(doVersion2, le.version2.AddrChangeIncomeDiff, '');
			self.v2_AddrChangeValueDiff	:= if(doVersion2, le.version2.AddrChangeValueDiff, '');
			self.v2_AddrChangeCrimeDiff	:= if(doVersion2, le.version2.AddrChangeCrimeDiff, '');
			self.v2_AddrChangeEconTrajectory	:= if(doVersion2, le.version2.AddrChangeEconTrajectory, '');
			self.v2_AddrChangeEconTrajectoryIndex	:= if(doVersion2, le.version2.AddrChangeEconTrajectoryIndex, '');
			self.v2_CurrAddrAgeOldest	:= if(doVersion2, le.version2.CurrAddrAgeOldest, '');
			self.v2_CurrAddrAgeNewest	:= if(doVersion2, le.version2.CurrAddrAgeNewest, '');
			self.v2_CurrAddrLenOfRes	:= if(doVersion2, le.version2.CurrAddrLenOfRes, '');
			self.v2_CurrAddrDwellType	:= if(doVersion2, le.version2.CurrAddrDwellType, '');
			self.v2_CurrAddrStatus	:= if(doVersion2, le.version2.CurrAddrStatus, '');
			self.v2_CurrAddrActivePhoneList	:= if(doVersion2, le.version2.CurrAddrActivePhoneList, '');
			self.v2_CurrAddrMedianIncome	:= if(doVersion2, le.version2.CurrAddrMedianIncome, '');
			self.v2_CurrAddrMedianValue	:= if(doVersion2, le.version2.CurrAddrMedianValue, '');
			self.v2_CurrAddrMurderIndex	:= if(doVersion2, le.version2.CurrAddrMurderIndex, '');
			self.v2_CurrAddrCarTheftIndex	:= if(doVersion2, le.version2.CurrAddrCarTheftIndex, '');
			self.v2_CurrAddrBurglaryIndex	:= if(doVersion2, le.version2.CurrAddrBurglaryIndex, '');
			self.v2_CurrAddrCrimeIndex	:= if(doVersion2, le.version2.CurrAddrCrimeIndex, '');
			self.v2_PrevAddrAgeOldest	:= if(doVersion2, le.version2.PrevAddrAgeOldest, '');
			self.v2_PrevAddrAgeNewest	:= if(doVersion2, le.version2.PrevAddrAgeNewest, '');
			self.v2_PrevAddrLenOfRes	:= if(doVersion2, le.version2.PrevAddrLenOfRes, '');
			self.v2_PrevAddrDwellType	:= if(doVersion2, le.version2.PrevAddrDwellType, '');
			self.v2_PrevAddrStatus	:= if(doVersion2, le.version2.PrevAddrStatus, '');
			self.v2_PrevAddrOccupantOwned	:= if(doVersion2, le.version2.PrevAddrOccupantOwned, '');
			self.v2_PrevAddrMedianIncome	:= if(doVersion2, le.version2.PrevAddrMedianIncome, '');
			self.v2_PrevAddrMedianValue	:= if(doVersion2, le.version2.PrevAddrMedianValue, '');
			self.v2_PrevAddrMurderIndex	:= if(doVersion2, le.version2.PrevAddrMurderIndex, '');
