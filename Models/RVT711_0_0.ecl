...
FUNCTION
	...
	Models.Layout_ModelOut DoModel(clam le) := TRANSFORM	
		...
		RVT711_0_0_tmp := min(900,max(501,ModRVT8));
		...
		self.ri := map(
			...
			RVT711_0_0 = 222 and ~inCalif => DATASET([{'19',risk_indicators.getHRIDesc('19')}, {'00',''}, {'00',''}, {'00',''}, {'00',''} ],risk_indicators.Layout_Desc),		
