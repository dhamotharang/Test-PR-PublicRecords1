...
// same model as SLBO1702_0_2 without fellony assoc_felony_count =0 and assoc_felony_total =0

EXPORT SLBO1809_0_0 (GROUPED DATASET(Business_Risk_BIP.Layouts.Shell) busShell) := FUNCTION
...
slbo1809_0_0_1 := __common__( round(max((real)501, min(900, if(base + pts * (bo_lgt - lgt) / ln(2) = NULL, -NULL, base + pts * (bo_lgt - lgt) / ln(2))))) ) ;


slbo1809_0_0 := __common__( if((integer)ver_src_id_count <= 0, 222, slbo1809_0_0_1) ) ;
...
slbo_rc4 := __common__( if(slbo1809_0_0 >= 832, '', slbo_rc4_1) ) ;


slbo_rc2 := __common__( if(slbo1809_0_0 >= 832, '', slbo_rc2_1) ) ;


slbo_rc1 := __common__( if(slbo1809_0_0 >= 832, '', slbo_rc1_1) ) ;


slbo_rc3 := __common__( if(slbo1809_0_0 >= 832, '', slbo_rc3_1) ) ;
...
reasonCodes := CHOOSEN(reasons & zeros, 4); // Keep up to 4 reason codes
                    ...
                    self.pts                              := pts;
                    self.lgt                              := lgt;
                    self.slbo1809_0_0                     := slbo1809_0_0;
		...
		SELF.score := (STRING3)SLBO1809_0_0;
