...
export FP3FDN1505_0_Base( dataset(bs_with_ip) clam, integer1 num_reasons, boolean criminal ) := FUNCTION
...
Models.Layout_FP31505 doTopLevel(clam le, Easi.Key_Easi_Census ri) := TRANSFORM
	...
	//pick up new FDN fields from Boca shell
	tf_lexid_ct 										 := le.bs.test_fraud.tf_lexid_count;
	tf_ssn_ct 											 := le.bs.test_fraud.tf_ssn_count;
	tf_phone_ct 										 := le.bs.test_fraud.tf_phone_count;
	tf_addr_ct 											 := le.bs.test_fraud.tf_addr_count;
	cf_lexid_ct 										 := le.bs.contributory_fraud.cf_lexid_count;
	cf_ssn_ct 											 := le.bs.contributory_fraud.cf_ssn_count;
	cf_phone_ct 										 := le.bs.contributory_fraud.cf_phone_count;
	cf_addr_ct 											 := le.bs.contributory_fraud.cf_addr_count;
...
nf_seg_fraudpoint_3_0 := __common__( map(
    ...
    hh_members_ct > 1 and (hh_payday_loan_users > 0 or _hh_strikes >= 2 or rel_felony_count >= 2)                                                                    																			=> '5: Vuln Vic/Friendly',
			...
			//move new FDN fields
			self.tf_lexid_ct                      := tf_lexid_ct;
			self.tf_ssn_ct                        := tf_ssn_ct;
			self.tf_phone_ct                      := tf_phone_ct;
			self.tf_addr_ct                       := tf_addr_ct;
			self.cf_lexid_ct                      := cf_lexid_ct;
			self.cf_ssn_ct                        := cf_ssn_ct;
			self.cf_phone_ct                      := cf_phone_ct;
			self.cf_addr_ct                       := cf_addr_ct;			
			self := [];
			// self.seqa := le.seq;
  END;
	...
	Models.Layout_FP31505 projModel(topLevelVars le) := TRANSFORM
		subModel := map(le.pii_profile_n	= '|FLAPSD|'			=>	Models.FP3FDN1505_FLAPSD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLAPS |'			=>	Models.FP3FDN1505_FLAPS(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLAP D|'			=>	Models.FP3FDN1505_FLAPD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLA SD|'			=>	Models.FP3FDN1505_FLASD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FL PSD|'			=>	Models.FP3FDN1505_FLPSD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLAP  |'			=>	Models.FP3FDN1505_FLAP(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FL PS |'			=>	Models.FP3FDN1505_FLPS(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLA S |'			=>	Models.FP3FDN1505_FLAS(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FL  SD|'			=>	Models.FP3FDN1505_FLSD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLA  D|'			=>	Models.FP3FDN1505_FLAD(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FL  S |'			=>	Models.FP3FDN1505_FLS(dataset(row(le, Models.Layout_FP31505))),
										le.pii_profile_n	= '|FLA   |'			=>	Models.FP3FDN1505_FLA(dataset(row(le, Models.Layout_FP31505))),
																														emptyModel); 
		...
		// self.woFDN_submodel_lgt	:= subModel[1].woFDN_submodel_lgt;		
		self.FP3_wFDN_LGT		:= subModel[1].FP3_wFDN_LGT;		
		self									:= le;
	end;
	...
	#else
		// Models.Layout_ModelOut doModel(withModel le, clam ri) := TRANSFORM
		Models.layouts.layout_fp1109 doModel(withModel le, clam ri) := TRANSFORM
	#end

	FP3_wFDN_LGT									:= le.FP3_wFDN_LGT;
...
stolidindexfdn := __common__( map(
    ...
    600 <= stolenc_fp3fdn1505_0_0 AND stolenc_fp3fdn1505_0_0 < 670  => 8,
    670 <= stolenc_fp3fdn1505_0_0 AND stolenc_fp3fdn1505_0_0 < 710  => 7,
    710 <= stolenc_fp3fdn1505_0_0 AND stolenc_fp3fdn1505_0_0 < 750  => 6,
    750 <= stolenc_fp3fdn1505_0_0 AND stolenc_fp3fdn1505_0_0 < 795  => 5,
...
manipidindexfdn := __common__( map(
    ...
    550 <= manip2c_fp3fdn1505_0_0 AND manip2c_fp3fdn1505_0_0 < 680  => 8,
    680 <= manip2c_fp3fdn1505_0_0 AND manip2c_fp3fdn1505_0_0 < 730  => 7,
    730 <= manip2c_fp3fdn1505_0_0 AND manip2c_fp3fdn1505_0_0 < 760  => 6,
    760 <= manip2c_fp3fdn1505_0_0 AND manip2c_fp3fdn1505_0_0 < 800  => 5,
...
synthidindexfdn := __common__( map(
    ...
    590 <= synthc_fp3fdn1505_0_0 AND synthc_fp3fdn1505_0_0 < 650  => 8,
    650 <= synthc_fp3fdn1505_0_0 AND synthc_fp3fdn1505_0_0 < 710  => 7,
    710 <= synthc_fp3fdn1505_0_0 AND synthc_fp3fdn1505_0_0 < 750  => 6,
    750 <= synthc_fp3fdn1505_0_0 AND synthc_fp3fdn1505_0_0 < 790  => 5,
...
suspactindexfdn := __common__( map(
    ...
    570 <= suspactc_fp3fdn1505_0_0 AND suspactc_fp3fdn1505_0_0 < 640  => 8,
    640 <= suspactc_fp3fdn1505_0_0 AND suspactc_fp3fdn1505_0_0 < 690  => 7,
    690 <= suspactc_fp3fdn1505_0_0 AND suspactc_fp3fdn1505_0_0 < 740  => 6,
    740 <= suspactc_fp3fdn1505_0_0 AND suspactc_fp3fdn1505_0_0 < 790  => 5,
...
vulnvicindexfdn := __common__( map(
    ...
    550 <= vulnvicc_fp3fdn1505_0_0 AND vulnvicc_fp3fdn1505_0_0 < 700  => 8,
    700 <= vulnvicc_fp3fdn1505_0_0 AND vulnvicc_fp3fdn1505_0_0 < 765  => 7,
    765 <= vulnvicc_fp3fdn1505_0_0 AND vulnvicc_fp3fdn1505_0_0 < 795  => 6,
    795 <= vulnvicc_fp3fdn1505_0_0 AND vulnvicc_fp3fdn1505_0_0 < 830  => 5,
...
friendfrdindexfdn := __common__( map(
    ...
    600 <= friendlyc_fp3fdn1505_0_0 AND friendlyc_fp3fdn1505_0_0 < 650  => 8,
    650 <= friendlyc_fp3fdn1505_0_0 AND friendlyc_fp3fdn1505_0_0 < 710  => 7,
    710 <= friendlyc_fp3fdn1505_0_0 AND friendlyc_fp3fdn1505_0_0 < 750  => 6,
    750 <= friendlyc_fp3fdn1505_0_0 AND friendlyc_fp3fdn1505_0_0 < 810  => 5,
	...
	self.lgt                              := lgt;
	self.offset                           := offset;
	self.fp3_wfdn_scaled                  := fp3_wfdn_scaled;
	self.tf_lexid_ct                      := tf_lexid_ct;
	self.tf_ssn_ct                        := tf_ssn_ct;
	self.tf_phone_ct                      := tf_phone_ct;
	self.tf_addr_ct                       := tf_addr_ct;
	...
	self.fp3_wfdn_score                   := fp3_wfdn_score;
	self.fp3fdn1505_0_0                   := fp3fdn1505_0_0;
	...
	self.stolenc_fp3fdn1505_0_0           := stolenc_fp3fdn1505_0_0;
	self.manip2c_fp3fdn1505_0_0           := manip2c_fp3fdn1505_0_0;
	self.synthc_fp3fdn1505_0_0            := synthc_fp3fdn1505_0_0;
	self.suspactc_fp3fdn1505_0_0          := suspactc_fp3fdn1505_0_0;
	self.vulnvicc_fp3fdn1505_0_0          := vulnvicc_fp3fdn1505_0_0;
	self.friendlyc_fp3fdn1505_0_0         := friendlyc_fp3fdn1505_0_0;
	self.stolidindexfdn                   := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, stolidindexfdn);
	self.manipidindexfdn                  := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, manipidindexfdn);
	self.synthidindexfdn                  := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, synthidindexfdn);
	self.suspactindexfdn                  := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, suspactindexfdn);
	self.vulnvicindexfdn                  := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, vulnvicindexfdn);
	self.friendfrdindexfdn                := if(pii_profile_n = Risk_Indicators.iid_constants.error_con, 0, friendfrdindexfdn);

	self.clam															:= ri.bs;
	self.seq															:= le.seqa;
	self.score														:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)fp3fdn1505_0_0);
	ritmp 																:= Models.fraudpoint3_reasons(ri.bs, ri.ip, num_reasons, criminal, true, nf_seg_fraudpoint_3_0, r_C10_M_Hdr_FS_d );
  reasons 															:= Models.Common.checkFraudPointRC34(fp3fdn1505_0_0, ritmp, num_reasons);
	...
	self.score														:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)fp3fdn1505_0_0);
	ritmp 																:= Models.fraudpoint3_reasons(ri.bs, ri.ip, num_reasons, criminal, true, nf_seg_fraudpoint_3_0, r_C10_M_Hdr_FS_d );
  reasons 															:= Models.Common.checkFraudPoint3RC34(fp3fdn1505_0_0, ritmp, num_reasons);
	blankRCs := DATASET([{'00',''}],risk_indicators.Layout_Desc) &
					    DATASET([{'00',''}],risk_indicators.Layout_Desc) &
					    DATASET([{'00',''}],risk_indicators.Layout_Desc) &
					    DATASET([{'00',''}],risk_indicators.Layout_Desc) &
					    ...
					    DATASET([{'00',''}],risk_indicators.Layout_Desc);
  self.ri 															:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, blankRCs, reasons);	
	self.StolenIdentityIndex							:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)stolidindexfdn);
	self.SyntheticIdentityIndex						:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)synthidindexfdn);
	self.ManipulatedIdentityIndex					:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)manipidindexfdn);
	self.VulnerableVictimIndex						:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)vulnvicindexfdn);
	self.FriendlyFraudIndex								:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)friendfrdindexfdn);
	self.SuspiciousActivityIndex					:= if(pii_profile_n = Risk_Indicators.iid_constants.error_con, '', (string)suspactindexfdn);
	#end
	End;
