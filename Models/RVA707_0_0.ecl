...
export RVA707_0_0(grouped dataset(Risk_Indicators.Layout_Boca_Shell) clam, boolean isCalifornia) := FUNCTION
	...
	/****************************/
		...
		rva707_0_0a := (INTEGER)(point*(log(phat/(1-phat)) - log(odds))/log(2) + base);
		rva707_0_0b := map(
			rva707_0_0a < 501 => 501,
			rva707_0_0a > 900 => 900,
			rva707_0_0a
		...
		rva707_0_0c := map(
			ssndead          and rva707_0_0b > 560 => 560,
			corrections      and rva707_0_0b > 560 => 560,
			nas_summary <= 4 and nap_summary <= 4 and add1_naprop <= 2 and rva707_0_0b > 620 => 620,
			ssnprior         and rva707_0_0b > 620 => 620,
			criminal_count > 0 and rva707_0_0b > 610 => 610,
			rva707_0_0b
		);

		rva707_0_0d := if(riskview.constants.noscore(le.iid.nas_summary,le.iid.nap_summary, le.address_verification.input_address_information.naprop, le.truedid), 222, rva707_0_0c );		
		...
		self.ri := map(
			...
			rva707_0_0d = 222 and ~inCalif => DATASET([{'19',risk_indicators.getHRIDesc('19')}, {'00',''}, {'00',''}, {'00',''} ],risk_indicators.Layout_Desc ),		
