...
riskview.layouts.Layout_Custom_Inputs intoCustomInput(clam le) := TRANSFORM
		customInputs := DATASET([TRANSFORM(iesp.riskview_share.t_ModelOptionRV,
					self.OptionName:= '';
					self.OptionValue := '';
					SELF := [])])[1];
...
FP1704_1_0_score := Models.FP1704_1_0	( ungroup(clam), 6);
// output(FP1704_1_0_score, named('FP1704_1_0_score'));

with_FP1704_1_0	:= join(with_FP1706_1_0, FP1704_1_0_score,
left.seq=right.seq,
transform(Models.layout_Runway,
self.FP1704_1_0_score := right.score;
self.FP1704_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.FP1704_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.FP1704_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.FP1704_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.FP1704_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self.FP1704_1_0_reason6 := if(exclude_reasons, '',  right.ri[6].hri);
self := left), keep(1), left outer);
// output(with_FP1704_1_0, named('with_FP1704_1_0'));
...
with_FP1705_1_0	:= join(with_FP1704_1_0, FP1705_1_0_score,
left.seq=right.seq,
transform(Models.layout_Runway,
...
//=== Kohl's Custom Model (Online) ===
fp1907_1_0_score := models.fp1907_1_0(ungroup(clam_ip), 6);
// output(fp1907_1_0_score, named('fp1907_1_0_score'));

with_fp1907_1_0	:= join(with_fp1902_1_0, fp1907_1_0_score,
left.seq=right.seq,
transform(Models.layout_Runway,
self.fp1907_1_0_score := right.score;
self.fp1907_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.fp1907_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.fp1907_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.fp1907_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.fp1907_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self.fp1907_1_0_reason6 := if(exclude_reasons, '',  right.ri[6].hri);
self := left), keep(1), left outer);
// output(with_fp1907_1_0, named('with_fp1907_1_0'));

//=== Kohl's Custom Model (Store) ===
fp1907_2_0_score := models.fp1907_2_0(ungroup(clam), 6);
// output(fp1907_1_0_score, named('fp1907_2_0_score'));

with_fp1907_2_0	:= join(with_fp1907_1_0, fp1907_2_0_score,
left.seq=right.seq,
transform(Models.layout_Runway,
self.fp1907_2_0_score := right.score;
self.fp1907_2_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.fp1907_2_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.fp1907_2_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.fp1907_2_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.fp1907_2_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self.fp1907_2_0_reason6 := if(exclude_reasons, '',  right.ri[6].hri);
self := left), keep(1), left outer);
// output(with_fp1907_2_0, named('with_fp1907_2_0'));
...
with_fp1908_1_0	:= join(with_fp1907_2_0, fp1908_1_0_score,
left.seq=right.seq,
transform(Models.layout_Runway,
...
RVA2008_1_0_score := Models.getCreditLuciModels( , attrv5).RVA2008_1;
// output(RVA2008_1_0_score, named('RVA2008_1_0_score'));
                             
with_RVA2008_1_0 := join(with_RVA1811_1_0, RVA2008_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVA2008_1_0_score := right.score;
self.RVA2008_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVA2008_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVA2008_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVA2008_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVA2008_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self := left), keep(1), left outer);
//output(with_RVA2008_1_0, named('with_RVA2008_1_0'));

RVB1003_0_0_score := Models.RVB1003_0_0(clam, iscalifornia);
// output(RVB1003_0_0_score, named('RVB1003_0_0_score'));
                             
with_RVB1003_0_0	:= join(with_RVA2008_1_0, RVB1003_0_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
...
RVC2004_1_0_score := Models.getCreditLuciModels( , attrv5, ,channel_inputs).RVC2004_1;
// output(RVC2004_1_0_score, named('RVC2004_1_0_score'));
                             
with_RVC2004_1_0 := join(with_RVC1805_2_0, RVC2004_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVC2004_1_0_score := right.score;
self.RVC2004_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVC2004_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVC2004_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVC2004_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self := left), keep(1), left outer);
// output(with_RVC2004_1_0, named('with_RVC2004_1_0'));


RVC2004_2_0_score := Models.getCreditLuciModels( , attrv5, ,channel_inputs).RVC2004_2;
// output(RVC2004_2_0_score, named('RVC2004_2_0_score'));
                             
with_RVC2004_2_0 := join(with_RVC2004_1_0, RVC2004_2_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVC2004_2_0_score := right.score;
self.RVC2004_2_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVC2004_2_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVC2004_2_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVC2004_2_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self := left), keep(1), left outer);
// output(with_RVC2004_2_0, named('with_RVC2004_2_0'));

RVC2004_3_0_score := Models.getCreditLuciModels( , attrv5, ,channel_inputs).RVC2004_3;
// output(RVC2004_3_0_score, named('RVC2004_3_0_score'));
                             
with_RVC2004_3_0 := join(with_RVC2004_2_0, RVC2004_3_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVC2004_3_0_score := right.score;
self.RVC2004_3_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVC2004_3_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVC2004_3_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVC2004_3_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self := left), keep(1), left outer);
// output(with_RVC2004_3_0, named('with_RVC2004_3_0'));


RVD1010_0_0_score := Models.RVD1010_0_0(UNGROUP(clam), iscalifornia);
// output(RVD1010_0_0_score, named('RVD1010_0_0_score'));
                             
with_RVD1010_0_0 := join(with_RVC2004_3_0, RVD1010_0_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
...
self.RVA1809_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVA1809_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVA1809_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVA1809_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self := left), keep(1), left outer);
// output(with_RVA1809_1_0, named('with_RVA1809_1_0'));
/* ================ */

/* ================ */
RVA1904_1_0_score := Models.RVA1904_1_0(clam,xmlPrescreenOptOut);
// output(RVA1904_1_0_score, named('RVA1904_1_0_score'));
                             
with_RVA1904_1_0 := join(with_RVA1809_1_0, RVA1904_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVA1904_1_0_score := right.score;
self.RVA1904_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVA1904_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVA1904_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVA1904_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self := left), keep(1), left outer);
...
/* ================ */
RVG1808_3_0_score := Models.RVG1808_3_0(clam,xmlPrescreenOptOut);
// output(RVG1808_3_0_score, named('RVG1808_3_0_score'));
with_RVG1808_3_0 := join(with_RVG1802_1_0, RVG1808_3_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVG1808_3_0_score := right.score;
self.RVG1808_3_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVG1808_3_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVG1808_3_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVG1808_3_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVG1808_3_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self := left), keep(1), left outer);
// output(with_RVG1808_3_0, named('with_RVG1808_3_0'));
/* ================ */

/* ================ */
RVG1808_1_0_score := Models.RVG1808_1_0(clam,xmlPrescreenOptOut);
// output(RVG1808_1_0_score, named('RVG1808_1_0_score'));
with_RVG1808_1_0 := join(with_RVG1808_3_0, RVG1808_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVG1808_1_0_score := right.score;
self.RVG1808_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVG1808_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVG1808_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVG1808_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVG1808_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self := left), keep(1), left outer);
// output(with_RVG1808_1_0, named('with_RVG1808_1_0'));
/* ================ */


/* ================ */
RVG1808_2_0_score := Models.RVG1808_2_0(clam,xmlPrescreenOptOut);
// output(RVG1808_2_0_score, named('RVG1808_2_0_score'));
with_RVG1808_2_0 := join(with_RVG1808_1_0, RVG1808_2_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVG1808_2_0_score := right.score;
self.RVG1808_2_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVG1808_2_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVG1808_2_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVG1808_2_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVG1808_2_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self := left), keep(1), left outer);
// output(with_RVG1808_2_0, named('with_RVG1808_2_0'));
/* ================ */

/* ================ */
RVG1809_1_0_score := Models.RVG1809_1_0(clam);
// output(RVG1809_1_0_score, named('RVG1809_1_0_score'));
with_RVG1809_1_0 := join(with_RVG1808_2_0, RVG1809_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVG1809_1_0_score := right.score;
self.RVG1809_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVG1809_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVG1809_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVG1809_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVG1809_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
self := left), keep(1), left outer);
// output(with_RVG1809_1_0, named('with_RVG1809_1_0'));
/* ================ */
...
with_RVG1610_1_0 := join(with_RVG1809_1_0, RVG1610_1_0_score,
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
...
left.seq=(unsigned)right.seq,
transform(Models.layout_Runway,
self.RVT2004_1_0_score := right.score;
self.RVT2004_1_0_reason1 := if(exclude_reasons, '',  right.ri[1].hri);
self.RVT2004_1_0_reason2 := if(exclude_reasons, '',  right.ri[2].hri);
self.RVT2004_1_0_reason3 := if(exclude_reasons, '',  right.ri[3].hri);
self.RVT2004_1_0_reason4 := if(exclude_reasons, '',  right.ri[4].hri);
self.RVT2004_1_0_reason5 := if(exclude_reasons, '',  right.ri[5].hri);
...
self.FP1704_1_0_score	:= if(model_environment in [1,3], left.FP1704_1_0_score	, '');
self.FP1704_1_0_reason1	:= if(model_environment in [1,3], left.FP1704_1_0_reason1	, '');
self.FP1704_1_0_reason2	:= if(model_environment in [1,3], left.FP1704_1_0_reason2	, '');
self.FP1704_1_0_reason3	:= if(model_environment in [1,3], left.FP1704_1_0_reason3	, '');
self.FP1704_1_0_reason4	:= if(model_environment in [1,3], left.FP1704_1_0_reason4	, '');
self.FP1704_1_0_reason5	:= if(model_environment in [1,3], left.FP1704_1_0_reason5	, '');
self.FP1704_1_0_reason6	:= if(model_environment in [1,3], left.FP1704_1_0_reason6	, '');
...
//=== Kohl's Custom Model (Online) ===
self.fp1907_1_0_score	:= if(model_environment in [1,3],   left.fp1907_1_0_score	, '');
self.fp1907_1_0_reason1	:= if(model_environment in [1,3], left.fp1907_1_0_reason1	, '');
self.fp1907_1_0_reason2	:= if(model_environment in [1,3], left.fp1907_1_0_reason2	, '');
self.fp1907_1_0_reason3	:= if(model_environment in [1,3], left.fp1907_1_0_reason3	, '');
self.fp1907_1_0_reason4	:= if(model_environment in [1,3], left.fp1907_1_0_reason4	, '');
self.fp1907_1_0_reason5	:= if(model_environment in [1,3], left.fp1907_1_0_reason5	, '');
self.fp1907_1_0_reason6	:= if(model_environment in [1,3], left.fp1907_1_0_reason6	, '');

//=== Kohl's Custom Model (Store) ===
self.fp1907_2_0_score	:= if(model_environment in [1,3],   left.fp1907_2_0_score	, '');
self.fp1907_2_0_reason1	:= if(model_environment in [1,3], left.fp1907_2_0_reason1	, '');
self.fp1907_2_0_reason2	:= if(model_environment in [1,3], left.fp1907_2_0_reason2	, '');
self.fp1907_2_0_reason3	:= if(model_environment in [1,3], left.fp1907_2_0_reason3	, '');
self.fp1907_2_0_reason4	:= if(model_environment in [1,3], left.fp1907_2_0_reason4	, '');
self.fp1907_2_0_reason5	:= if(model_environment in [1,3], left.fp1907_2_0_reason5	, '');
self.fp1907_2_0_reason6	:= if(model_environment in [1,3], left.fp1907_2_0_reason6	, '');
...
self.RVA2008_1_0_score	:= if(model_environment in [1,2], left.RVA2008_1_0_score	, '');
self.RVA2008_1_0_reason1	:= if(model_environment in [1,2], left.RVA2008_1_0_reason1	, '');
self.RVA2008_1_0_reason2	:= if(model_environment in [1,2], left.RVA2008_1_0_reason2	, '');
self.RVA2008_1_0_reason3	:= if(model_environment in [1,2], left.RVA2008_1_0_reason3	, '');
self.RVA2008_1_0_reason4	:= if(model_environment in [1,2], left.RVA2008_1_0_reason4	, '');
self.RVA2008_1_0_reason5	:= if(model_environment in [1,2], left.RVA2008_1_0_reason5  , '');
...
self.RVC2004_1_0_score	:= if(model_environment in [1,2], left.RVC2004_1_0_score	, '');
self.RVC2004_1_0_reason1	:= if(model_environment in [1,2], left.RVC2004_1_0_reason1	, '');
self.RVC2004_1_0_reason2	:= if(model_environment in [1,2], left.RVC2004_1_0_reason2	, '');
self.RVC2004_1_0_reason3	:= if(model_environment in [1,2], left.RVC2004_1_0_reason3	, '');
self.RVC2004_1_0_reason4	:= if(model_environment in [1,2], left.RVC2004_1_0_reason4	, '');
self.RVC2004_1_0_reason5	:= if(model_environment in [1,2], left.RVC2004_1_0_reason5	, '');

self.RVC2004_2_0_score	:= if(model_environment in [1,2], left.RVC2004_2_0_score	, '');
self.RVC2004_2_0_reason1	:= if(model_environment in [1,2], left.RVC2004_2_0_reason1	, '');
self.RVC2004_2_0_reason2	:= if(model_environment in [1,2], left.RVC2004_2_0_reason2	, '');
self.RVC2004_2_0_reason3	:= if(model_environment in [1,2], left.RVC2004_2_0_reason3	, '');
self.RVC2004_2_0_reason4	:= if(model_environment in [1,2], left.RVC2004_2_0_reason4	, '');
self.RVC2004_2_0_reason5	:= if(model_environment in [1,2], left.RVC2004_2_0_reason5	, '');

self.RVC2004_3_0_score	:= if(model_environment in [1,2], left.RVC2004_3_0_score	, '');
self.RVC2004_3_0_reason1	:= if(model_environment in [1,2], left.RVC2004_3_0_reason1	, '');
self.RVC2004_3_0_reason2	:= if(model_environment in [1,2], left.RVC2004_3_0_reason2	, '');
self.RVC2004_3_0_reason3	:= if(model_environment in [1,2], left.RVC2004_3_0_reason3	, '');
self.RVC2004_3_0_reason4	:= if(model_environment in [1,2], left.RVC2004_3_0_reason4	, '');
self.RVC2004_3_0_reason5	:= if(model_environment in [1,2], left.RVC2004_3_0_reason5	, '');
...
self.RVG1808_3_0_score	:= if(model_environment in [1,2], left.RVG1808_3_0_score	, '');
self.RVG1808_3_0_reason1	:= if(model_environment in [1,2], left.RVG1808_3_0_reason1	, '');
self.RVG1808_3_0_reason2	:= if(model_environment in [1,2], left.RVG1808_3_0_reason2	, '');
self.RVG1808_3_0_reason3	:= if(model_environment in [1,2], left.RVG1808_3_0_reason3	, '');
self.RVG1808_3_0_reason4	:= if(model_environment in [1,2], left.RVG1808_3_0_reason4	, '');
self.RVG1808_3_0_reason5	:= if(model_environment in [1,2], left.RVG1808_3_0_reason5	, '');

self.RVG1808_1_0_score	:= if(model_environment in [1,2], left.RVG1808_1_0_score	, '');
self.RVG1808_1_0_reason1	:= if(model_environment in [1,2], left.RVG1808_1_0_reason1	, '');
self.RVG1808_1_0_reason2	:= if(model_environment in [1,2], left.RVG1808_1_0_reason2	, '');
self.RVG1808_1_0_reason3	:= if(model_environment in [1,2], left.RVG1808_1_0_reason3	, '');
self.RVG1808_1_0_reason4	:= if(model_environment in [1,2], left.RVG1808_1_0_reason4	, '');
self.RVG1808_1_0_reason5	:= if(model_environment in [1,2], left.RVG1808_1_0_reason5	, '');

self.RVG1808_2_0_score	:= if(model_environment in [1,2], left.RVG1808_2_0_score	, '');
self.RVG1808_2_0_reason1	:= if(model_environment in [1,2], left.RVG1808_2_0_reason1	, '');
self.RVG1808_2_0_reason2	:= if(model_environment in [1,2], left.RVG1808_2_0_reason2	, '');
self.RVG1808_2_0_reason3	:= if(model_environment in [1,2], left.RVG1808_2_0_reason3	, '');
self.RVG1808_2_0_reason4	:= if(model_environment in [1,2], left.RVG1808_2_0_reason4	, '');
self.RVG1808_2_0_reason5	:= if(model_environment in [1,2], left.RVG1808_2_0_reason5	, '');

self.RVG1809_1_0_score	:= if(model_environment in [1,2], left.RVG1809_1_0_score	, '');
self.RVG1809_1_0_reason1	:= if(model_environment in [1,2], left.RVG1809_1_0_reason1	, '');
self.RVG1809_1_0_reason2	:= if(model_environment in [1,2], left.RVG1809_1_0_reason2	, '');
self.RVG1809_1_0_reason3	:= if(model_environment in [1,2], left.RVG1809_1_0_reason3	, '');
...
self.RVA1809_1_0_reason3	:= if(model_environment in [1,2], left.RVA1809_1_0_reason3	, '');
...
self.RVT2004_1_0_score	:= if(model_environment in [1,2], left.RVT2004_1_0_score	, '');
self.RVT2004_1_0_reason1	:= if(model_environment in [1,2], left.RVT2004_1_0_reason1	, '');
self.RVT2004_1_0_reason2	:= if(model_environment in [1,2], left.RVT2004_1_0_reason2	, '');
