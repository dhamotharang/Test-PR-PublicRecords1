...
export FP1403_2_0( dataset(Risk_Indicators.Layout_Boca_Shell) clam, integer1 num_reasons) := FUNCTION
...
Integer pts                           ;
Real odds                             ;
Integer FP1403_2_0_4                  ;
Integer FP1403_2_0_3                  ;
Integer FP1403_2_0_2                  ;
Integer FP1403_2_0_1                  ;
String FP1403_2_0                     ;
...
FP1403_2_0_4 := min(max(round(pts*(log(probScore/(1-probScore)) - log(odds))/log(2) + base),301),999);   /* Minimum is 301 because 300 is special override */

FP1403_2_0_3 := if(iv_VS002_SSN_Prior_DoB = '1', min(if(FP1403_2_0_4 = NULL, -NULL, FP1403_2_0_4), 300), FP1403_2_0_4);

FP1403_2_0_2 := if(iv_VS003_SSN_Invalid = '1', min(if(FP1403_2_0_3 = NULL, -NULL, FP1403_2_0_3), 300), FP1403_2_0_3);

FP1403_2_0_1 := if(iv_VS001_SSN_Deceased = '1', min(if(FP1403_2_0_2 = NULL, -NULL, FP1403_2_0_2), 300), FP1403_2_0_2);

FP1403_2_0   := if(nas_summary = 1, min(if(FP1403_2_0_1 = NULL, -NULL, FP1403_2_0_1), 300), FP1403_2_0_1);
	...
	self.pts                              := pts;
	self.odds                             := odds;
	self.FP1403_2_0_4                     := FP1403_2_0_4;
	self.FP1403_2_0_3                     := FP1403_2_0_3;
	self.FP1403_2_0_2                     := FP1403_2_0_2;
	self.FP1403_2_0_1                     := FP1403_2_0_1;
	self.FP1403_2_0                       := FP1403_2_0;

#end
	self.seq := le.seq;
	ritmp :=  Models.fraudpoint_reasons(le, blank_ip, num_reasons, include_criminal:=false, isFP1403_2_0:=true );
	reasons := Models.Common.checkFraudPointRC34((Integer)FP1403_2_0, ritmp, num_reasons);
	self.ri := reasons;
	self.score := (string)FP1403_2_0;
	self := [];
END;
