EXPORT Validate_RVS2005_0_1(reasonCodes=TRUE,landingZoneIP='Constants.LandingZoneIP',lzFilePathFolder='\'/data/LUCI/RVS2005_0_1/\'',
 ...
 Validate_Model := MODULE
    ...
    Layouts.StandLayouts xGetLUCIPointsAssignments(LUCI_Points_Assignments_Pre L) := TRANSFORM
        ...
        //Scores
        SELF.rawscore:= L.RVS2005_0_1_OVERALL_Score0;
        SELF.predscr:= (600 + -50 * ((SELF.rawscore - 1.1773331190837304 - -2.9444) / LN(2)));
        SELF.finalscore := L.RVS2005_0_1_Score;
        SELF.SOURCE := 'HPCC';
        SELF.stdrawscore  := (string)L.RVS2005_0_1_OVERALL_Score0;
        SELF.std_scr := (string)L.RVS2005_0_1_Score;
        #IF(reasonCodes)
            //Reason Codes
            SELF.STD_RC := L.RVS2005_0_1_Reasons;
            SELF.ReasonCode1 := L.RVS2005_0_1_Reasons[1];
            SELF.ReasonCode2 := L.RVS2005_0_1_Reasons[2];
            SELF.ReasonCode3 := L.RVS2005_0_1_Reasons[3];
            SELF.ReasonCode4 := L.RVS2005_0_1_Reasons[4];
            SELF.ReasonCode5 := L.RVS2005_0_1_Reasons[5];
    ...
    Layouts.AuditLayouts xGetLUCIAuditFile(LUCI_Points_Assignments_Pre L) := TRANSFORM
        #IF(reasonCodes)
            SELF.GROUPTYPE  := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[1]).GroupType;
            SELF.RCMessage1 := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[1]).Description;
            SELF.RCMessage2 := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[2]).Description;
            SELF.RCMessage3 := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[3]).Description;
            SELF.RCMessage4 := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[4]).Description;
            SELF.RCMessage5 := rvs2005_0_1.RCCodes(L.RVS2005_0_1_Reasons[5]).Description;
        ...
        #IF(reasonCodes)
    	    //Reason Codes
            //SELF.ReasonCode  := L.RVS2005_0_1_Reasons;
            SELF.ReasonCode1 := L.RVS2005_0_1_Reasons[1];
            SELF.ReasonCode2 := L.RVS2005_0_1_Reasons[2];
            SELF.ReasonCode3 := L.RVS2005_0_1_Reasons[3];
            SELF.ReasonCode4 := L.RVS2005_0_1_Reasons[4];
    ...
    DesprayAuditResult := rvs2005_0_1.FNDesprayCSV(LUCI_AuditResult, TempLogical('~LUCI::AuditFile::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_AuditFile'));
    DesprayComparision := rvs2005_0_1.FNDesprayCSV(DS_Comp, TempLogical('~LUCI::ComparisonFile:' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_ComparisonFile'));
    DesprayMismatches_SC := rvs2005_0_1.FNDesprayCSV(DS_Comp(TransactionID in mismatch_list_sc), TempLogical('~LUCI::Mismatches_SC::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_Mismatches_SC'));
    DesprayTNMismatches_SC := rvs2005_0_1.FNDesprayCSV(tnMismatches_sc_full, TempLogical('~LUCI::TerminalNodeMismatches_SC::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_TNMismatches_SC'));
    #IF(reasonCodes)
    DesprayMismatches_RC := rvs2005_0_1.FNDesprayCSV(DS_Comp(TransactionID in mismatch_list_rc), TempLogical('~LUCI::Mismatches_RC::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_Mismatches_RC'));
    DesprayTNMismatches_RC := rvs2005_0_1.FNDesprayCSV(tnMismatches_rc_full, TempLogical('~LUCI::TerminalNodeMismatches_RC::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_TNMismatches_RC'));
    #END
