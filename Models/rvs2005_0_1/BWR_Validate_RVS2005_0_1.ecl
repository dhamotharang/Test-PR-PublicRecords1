...
SHARED Layouts := rvs2005_0_1.z_layouts;
...
SHARED lzFilePathFolder  := '/data/LUCI/RVS2005_0_1/';
SHARED CSVSprayFile := '~fallen::in::rvs2005_0_1-validation-file.csv';
SHARED lzFilePath        := lzFilePathFolder + CSVSprayFile;
SHARED SprayCSVName      := '~fallen::in::rvs2005_0_1-validation-file.csv'; // Will set up by user if test file is a logical file.
...
SHARED isCSVFile := true;
  //rvs2005_0_1.FNSpray(LandingZoneIP, lzFilePath, SprayCSVName, CSVSpraySeparator, CSVSprayQuote);
/******************************************************************************\
...
SHARED RawInputSet := PROJECT(RawInputSet0, TRANSFORM(Layouts.Input_Layouts, SELF.do_RVS2005_0_1 := TRUE, SELF := LEFT));
