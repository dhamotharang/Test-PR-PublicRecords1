...
export FP1407_1_0( dataset(risk_indicators.Layout_Boca_Shell) clam,  integer1 num_reasons, string16 segment_in) := FUNCTION
//export FP1407_1_0( dataset(Models.fp1407_1_testlayout) clam,  integer1 num_reasons, string16 segment_in) := FUNCTION
...
fp1407_1_0 :=__common__( map(
    ov_cvi_0 or ov_ssn_deceased or ov_invalid_ssn or ov_prison_address or ov_ssn_issued_prior_to_dob or ov_no_lexid_found => 250,
    ov_cvi_10 and fp1407_1_1_1 > 550                                                                                      => 550,
                                                                                                                             fp1407_1_1_1));
...
pred :=__common__( if(prob1 > class_threshold, 1, pred_1));
	...
	reasons := Models.Common.checkFraudPointRC34(fp1407_1_0, ritmp, num_reasons);
	self.ri := reasons;
	self.score := (string)fp1407_1_0;
	self := [];
END;
