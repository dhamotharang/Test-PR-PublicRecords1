...
// Computations for components of score SCORECARD_model110
    ...
    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_range := WHICH(((REAL)le.p_addrcurrentownershipindex) >= -998 AND ((REAL)le.p_addrcurrentownershipindex) <= -998,((REAL)le.p_addrcurrentownershipindex) >= -1 AND ((REAL)le.p_addrcurrentownershipindex) <= -1,((REAL)le.p_addrcurrentownershipindex) >= -998 AND ((REAL)le.p_addrcurrentownershipindex) <= -998,((REAL)le.p_addrcurrentownershipindex) >= 999 AND ((REAL)le.p_addrcurrentownershipindex) <= 999,((REAL)le.p_addrcurrentownershipindex) >= -999999999 AND ((REAL)le.p_addrcurrentownershipindex) <= 0.5,((REAL)le.p_addrcurrentownershipindex) >= 0.5 AND ((REAL)le.p_addrcurrentownershipindex) <= 2.5,((REAL)le.p_addrcurrentownershipindex) >= 2.5 AND ((REAL)le.p_addrcurrentownershipindex) <= 3.5,((REAL)le.p_addrcurrentownershipindex) >= 3.5);
    REAL4 RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_range,0.0,0.0,0.0,0.0,0.241278264062402,0.00593506382761733,-0.422097965223441,-0.426452499208887,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_range,0.0 - 0.044169642,0.0 - 0.044169642,0.0 - 0.044169642,0.0 - 0.044169642,0.241278264062402 - 0.044169642,0.00593506382761733 - 0.044169642,-0.422097965223441 - 0.044169642,-0.426452499208887 - 0.044169642,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_range,'','A44','','','A44','A44','A44','A44','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_range := WHICH(le.L_ca_creditseeking >= -998 AND le.L_ca_creditseeking <= -998,le.L_ca_creditseeking >= -1 AND le.L_ca_creditseeking <= -1,le.L_ca_creditseeking >= -998 AND le.L_ca_creditseeking <= -998,le.L_ca_creditseeking >= 999 AND le.L_ca_creditseeking <= 999,le.L_ca_creditseeking >= -999999999 AND le.L_ca_creditseeking <= 0,le.L_ca_creditseeking >= 1 AND le.L_ca_creditseeking <= 1,le.L_ca_creditseeking >= 2 AND le.L_ca_creditseeking <= 2,le.L_ca_creditseeking >= 3 AND le.L_ca_creditseeking <= 3,le.L_ca_creditseeking >= 4 AND le.L_ca_creditseeking <= 4,le.L_ca_creditseeking >= 5 AND le.L_ca_creditseeking <= 5,le.L_ca_creditseeking >= 6 AND le.L_ca_creditseeking <= 6,le.L_ca_creditseeking >= 6);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_range,0.0,0.0,0.0,0.0,-0.362569357925149,0.0367915769388987,0.222011816622779,0.467339660305824,0.943890182033126,0.979326295061764,0.222011816622779,0.0367915769388987,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_range,0.0 - -0.145916024,0.0 - -0.145916024,0.0 - -0.145916024,0.0 - -0.145916024,-0.362569357925149 - -0.145916024,0.0367915769388987 - -0.145916024,0.222011816622779 - -0.145916024,0.467339660305824 - -0.145916024,0.943890182033126 - -0.145916024,0.979326295061764 - -0.145916024,0.222011816622779 - -0.145916024,0.0367915769388987 - -0.145916024,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_range,'','I60','','','I60','I60','I60','I60','I60','I60','C21','I61','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_range := WHICH(le.L_ca_addrchangeindex >= -998 AND le.L_ca_addrchangeindex <= -998,le.L_ca_addrchangeindex >= -1 AND le.L_ca_addrchangeindex <= -1,le.L_ca_addrchangeindex >= -998 AND le.L_ca_addrchangeindex <= -998,le.L_ca_addrchangeindex >= 999 AND le.L_ca_addrchangeindex <= 999,le.L_ca_addrchangeindex >= -999999999 AND le.L_ca_addrchangeindex <= 1.5,le.L_ca_addrchangeindex >= 1.5 AND le.L_ca_addrchangeindex <= 2.5,le.L_ca_addrchangeindex >= 2.5 AND le.L_ca_addrchangeindex <= 3.5,le.L_ca_addrchangeindex >= 3.5 AND le.L_ca_addrchangeindex <= 4.5,le.L_ca_addrchangeindex >= 4.5);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_range,0.0,0.0,0.0,0.0,-0.361445513556842,-0.0326651072762166,0.228542788688605,0.345993801395147,0.650067423161005,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_range,0.0 - -0.050522645,0.0 - -0.050522645,0.0 - -0.050522645,0.0 - -0.050522645,-0.361445513556842 - -0.050522645,-0.0326651072762166 - -0.050522645,0.228542788688605 - -0.050522645,0.345993801395147 - -0.050522645,0.650067423161005 - -0.050522645,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_range,'','C14','','','C14','C14','C14','C14','C14','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_range := WHICH(le.L_ca_nonderogindex_alt >= -998 AND le.L_ca_nonderogindex_alt <= -998,le.L_ca_nonderogindex_alt >= -1 AND le.L_ca_nonderogindex_alt <= -1,le.L_ca_nonderogindex_alt >= -998 AND le.L_ca_nonderogindex_alt <= -998,le.L_ca_nonderogindex_alt >= 999 AND le.L_ca_nonderogindex_alt <= 999,le.L_ca_nonderogindex_alt >= -999999999 AND le.L_ca_nonderogindex_alt <= 1.5,le.L_ca_nonderogindex_alt >= 1.5);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_range,0.0,0.0,0.0,0.0,0.269980986524245,-0.254808888546115,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_range,0.0 - 0.251102104,0.0 - 0.251102104,0.0 - 0.251102104,0.0 - 0.251102104,0.269980986524245 - 0.251102104,-0.254808888546115 - 0.251102104,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_range,'','C12','','','C12','C12','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_assetpropevercount_range := WHICH(((REAL)le.p_assetpropevercount) >= -998 AND ((REAL)le.p_assetpropevercount) <= -998,((REAL)le.p_assetpropevercount) >= -1 AND ((REAL)le.p_assetpropevercount) <= -1,((REAL)le.p_assetpropevercount) >= -998 AND ((REAL)le.p_assetpropevercount) <= -998,((REAL)le.p_assetpropevercount) >= 999 AND ((REAL)le.p_assetpropevercount) <= 999,((REAL)le.p_assetpropevercount) >= -999999999 AND ((REAL)le.p_assetpropevercount) <= 0.5,((REAL)le.p_assetpropevercount) >= 0.5 AND ((REAL)le.p_assetpropevercount) <= 1.5,((REAL)le.p_assetpropevercount) >= 1.5);
    REAL4 RVT2004_1_0_SCORECARD_model110_assetpropevercount_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_assetpropevercount_range,0.0,0.0,0.0,0.0,0.258573459164827,-0.146309609694865,-0.597848433083429,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_assetpropevercount_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_assetpropevercount_range,0.0 - 0.233084749,0.0 - 0.233084749,0.0 - 0.233084749,0.0 - 0.233084749,0.258573459164827 - 0.233084749,-0.146309609694865 - 0.233084749,-0.597848433083429 - 0.233084749,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_assetpropevercount_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_assetpropevercount_range,'','A41','','','A41','A41','A41','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_range := WHICH(le.L_addrprevioustimeoldest_alt >= -998 AND le.L_addrprevioustimeoldest_alt <= -998,le.L_addrprevioustimeoldest_alt >= -1 AND le.L_addrprevioustimeoldest_alt <= -1,le.L_addrprevioustimeoldest_alt >= -998 AND le.L_addrprevioustimeoldest_alt <= -998,le.L_addrprevioustimeoldest_alt >= 999 AND le.L_addrprevioustimeoldest_alt <= 999,le.L_addrprevioustimeoldest_alt >= -999999999 AND le.L_addrprevioustimeoldest_alt <= 96,le.L_addrprevioustimeoldest_alt >= 96 AND le.L_addrprevioustimeoldest_alt <= 132,le.L_addrprevioustimeoldest_alt >= 132 AND le.L_addrprevioustimeoldest_alt <= 204,le.L_addrprevioustimeoldest_alt >= 204 AND le.L_addrprevioustimeoldest_alt <= 240,le.L_addrprevioustimeoldest_alt >= 240);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_range,0.0,-0.192125399167892,0.0,0.0,0.195602970040618,0.129691677434657,0.0169316915846859,-0.0774303118296151,-0.377374107224287,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_range,0.0 - 0.006917638,-0.192125399167892 - 0.006917638,0.0 - 0.006917638,0.0 - 0.006917638,0.195602970040618 - 0.006917638,0.129691677434657 - 0.006917638,0.0169316915846859 - 0.006917638,-0.0774303118296151 - 0.006917638,-0.377374107224287 - 0.006917638,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_range,'','C13','','','C13','C13','C13','C13','C13','99999');

    UNSIGNED1 RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_range := WHICH(le.L_ca_derogseverityindex >= -998 AND le.L_ca_derogseverityindex <= -998,le.L_ca_derogseverityindex >= -1 AND le.L_ca_derogseverityindex <= -1,le.L_ca_derogseverityindex >= -998 AND le.L_ca_derogseverityindex <= -998,le.L_ca_derogseverityindex >= 999 AND le.L_ca_derogseverityindex <= 999,le.L_ca_derogseverityindex >= -999999999 AND le.L_ca_derogseverityindex <= 0,le.L_ca_derogseverityindex >= 1 AND le.L_ca_derogseverityindex <= 1,le.L_ca_derogseverityindex >= 2 AND le.L_ca_derogseverityindex <= 2,le.L_ca_derogseverityindex >= 3 AND le.L_ca_derogseverityindex <= 3,le.L_ca_derogseverityindex >= 4 AND le.L_ca_derogseverityindex <= 4,le.L_ca_derogseverityindex >= 5 AND le.L_ca_derogseverityindex <= 5,le.L_ca_derogseverityindex >= 6 AND le.L_ca_derogseverityindex <= 6,le.L_ca_derogseverityindex >= 7 AND le.L_ca_derogseverityindex <= 7,le.L_ca_derogseverityindex >= 7);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_score := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_range,0.0,0.0,0.0,0.0,-0.204450773503088,-0.129339415823904,0.331183108776348,0.331183108776348,0.475902823827432,0.475902823827432,0.475902823827432,0.331183108776348,0.331183108776348,0);
    REAL4 RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_contribution_best := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_range,0.0 - -0.17793609,0.0 - -0.17793609,0.0 - -0.17793609,0.0 - -0.17793609,-0.204450773503088 - -0.17793609,-0.129339415823904 - -0.17793609,0.331183108776348 - -0.17793609,0.331183108776348 - -0.17793609,0.475902823827432 - -0.17793609,0.475902823827432 - -0.17793609,0.475902823827432 - -0.17793609,0.331183108776348 - -0.17793609,0.331183108776348 - -0.17793609,0);
    STRING5 RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_reason := CHOOSE(RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_range,'','','','','','D34','D30','D30','D30','D30','D33','D33','D31','99999');
// Now compute values for score SCORECARD_model110
    REAL RVT2004_1_0_SCORECARD_model110_Score0 := -0.172921378314879 + RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_Score + RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_Score + RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_Score + RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_Score + RVT2004_1_0_SCORECARD_model110_assetpropevercount_Score + RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_Score + RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_Score;
    REAL RVT2004_1_0_SCORECARD_model110_Score1 := (700 + -40 * ((RVT2004_1_0_SCORECARD_model110_Score0 - 0 - LN(0.35685210312076)) / LN(2)));
    INTEGER2 RVT2004_1_0_SCORECARD_model110_Score := ROUND( MAP (  RVT2004_1_0_SCORECARD_model110_Score1 < 501 => 501, RVT2004_1_0_SCORECARD_model110_Score1 > 900 => 900,RVT2004_1_0_SCORECARD_model110_Score1));
    SELF.RVT2004_1_0_Score := RVT2004_1_0_SCORECARD_model110_Score;
    aggregateRCs := SORT(
      TABLE(
      DATASET([
        {RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_contribution_best,RVT2004_1_0_SCORECARD_model110_addrcurrentownershipindex_reason}
        ,{RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_contribution_best,RVT2004_1_0_SCORECARD_model110_L_ca_creditseeking_reason}
        ,{RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_contribution_best,RVT2004_1_0_SCORECARD_model110_L_ca_addrchangeindex_reason}
        ,{RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_contribution_best,RVT2004_1_0_SCORECARD_model110_L_ca_nonderogindex_alt_reason}
        ,{RVT2004_1_0_SCORECARD_model110_assetpropevercount_contribution_best,RVT2004_1_0_SCORECARD_model110_assetpropevercount_reason}
        ,{RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_contribution_best,RVT2004_1_0_SCORECARD_model110_L_addrprevioustimeoldest_alt_reason}
        ,{RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_contribution_best,RVT2004_1_0_SCORECARD_model110_L_ca_derogseverityindex_reason}
    ...
    SET OF STRING5 RVT2004_1_0_SCORECARD_model110_Reasons := RVT2004_1_0_SCORECARD_model110_Reasons_Best;
    SELF.RVT2004_1_0_Reasons := RVT2004_1_0_SCORECARD_model110_Reasons;
    SELF := le;
  END;
