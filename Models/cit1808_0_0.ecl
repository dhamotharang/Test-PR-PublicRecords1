...
IMPORT DueDiligence, Easi, Models, risk_indicators, riskwise, Std, ut;



EXPORT cit1808_0_0(DATASET(risk_indicators.Layout_Boca_Shell) clam) := FUNCTION
    ...
    Layout_Debug := RECORD
        ...
        DueDiligence.Citizenship.Layouts.ModelOutput_Layout; 
