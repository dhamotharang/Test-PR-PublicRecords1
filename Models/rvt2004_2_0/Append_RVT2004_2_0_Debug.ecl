EXPORT Append_RVT2004_2_0_Debug( infile,do_model=true,p_addrchangecount60month,p_addrcurrentownershipindex,p_addronfilecount,p_addrprevioustimeoldest,p_alertregulatorycondition,p_assetpropcurrentcount,p_assetpropeversoldcount,p_bankruptcystatus,p_confirmationsubjectfound,p_evictioncount,p_inquiryauto12month,p_inquirybanking12month,p_inquirycollections12month,p_inquiryshortterm12month,p_lienjudgmentcount,p_lienjudgmentsmallclaimscount,p_shorttermloanrequest,p_sourcenonderogcount,p_sourcenonderogcount06month,p_ssndeceased,p_subjectdeceased,p_subjectrecordtimeoldest) := FUNCTIONMACRO
  ...
  rres := RECORD
    ...
    rvt2004_2_0.Append_RVT2004_2_0_ModelLayouts.Prepare;
    rvt2004_2_0.Append_RVT2004_2_0_ModelLayouts.Debug;
  END;
...
// Computations for components of score SCORECARD_model47
    ...
    SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_range := WHICH(((REAL)le.p_addrprevioustimeoldest) >= -998 AND ((REAL)le.p_addrprevioustimeoldest) <= -998,((REAL)le.p_addrprevioustimeoldest) >= -1 AND ((REAL)le.p_addrprevioustimeoldest) <= -1,((REAL)le.p_addrprevioustimeoldest) >= -999999999 AND ((REAL)le.p_addrprevioustimeoldest) <= 6,((REAL)le.p_addrprevioustimeoldest) >= 6 AND ((REAL)le.p_addrprevioustimeoldest) <= 12,((REAL)le.p_addrprevioustimeoldest) >= 12 AND ((REAL)le.p_addrprevioustimeoldest) <= 24,((REAL)le.p_addrprevioustimeoldest) >= 24 AND ((REAL)le.p_addrprevioustimeoldest) <= 72,((REAL)le.p_addrprevioustimeoldest) >= 72 AND ((REAL)le.p_addrprevioustimeoldest) <= 96,((REAL)le.p_addrprevioustimeoldest) >= 96 AND ((REAL)le.p_addrprevioustimeoldest) <= 156,((REAL)le.p_addrprevioustimeoldest) >= 156 AND ((REAL)le.p_addrprevioustimeoldest) <= 228,((REAL)le.p_addrprevioustimeoldest) >= 228 AND ((REAL)le.p_addrprevioustimeoldest) <= 288,((REAL)le.p_addrprevioustimeoldest) >= 288);
    SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_range,0.0,-0.28084870461577,0.491375089074481,0.321048883673525,0.180121585542426,0.151031197731993,0.114801189635962,-0.0288430799118979,-0.0640308901228473,-0.255266542810333,-0.45962051977284,0);
    SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_range,0.0 - 0.016988448,-0.28084870461577 - 0.016988448,0.491375089074481 - 0.016988448,0.321048883673525 - 0.016988448,0.180121585542426 - 0.016988448,0.151031197731993 - 0.016988448,0.114801189635962 - 0.016988448,-0.0288430799118979 - 0.016988448,-0.0640308901228473 - 0.016988448,-0.255266542810333 - 0.016988448,-0.45962051977284 - 0.016988448,0);
    SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_range,'','C13','C13','C13','C13','C13','C13','C13','C13','C13','C13','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_range := WHICH(((REAL)le.p_assetpropeversoldcount) >= -998 AND ((REAL)le.p_assetpropeversoldcount) <= -998,((REAL)le.p_assetpropeversoldcount) >= -1 AND ((REAL)le.p_assetpropeversoldcount) <= -1,((REAL)le.p_assetpropeversoldcount) >= -999999999 AND ((REAL)le.p_assetpropeversoldcount) <= 0.5,((REAL)le.p_assetpropeversoldcount) >= 0.5 AND ((REAL)le.p_assetpropeversoldcount) <= 1.5,((REAL)le.p_assetpropeversoldcount) >= 1.5);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_range,0.0,0.0,0.338302614099309,-0.210498982583842,-0.538333965350616,0);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_range,0.0 - 0.256330125,0.0 - 0.256330125,0.338302614099309 - 0.256330125,-0.210498982583842 - 0.256330125,-0.538333965350616 - 0.256330125,0);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_range,'','','A45','','','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_range := WHICH(((REAL)le.p_addrcurrentownershipindex) >= -998 AND ((REAL)le.p_addrcurrentownershipindex) <= -998,((REAL)le.p_addrcurrentownershipindex) >= -1 AND ((REAL)le.p_addrcurrentownershipindex) <= -1,((REAL)le.p_addrcurrentownershipindex) >= -999999999 AND ((REAL)le.p_addrcurrentownershipindex) <= 0.5,((REAL)le.p_addrcurrentownershipindex) >= 0.5 AND ((REAL)le.p_addrcurrentownershipindex) <= 2.5,((REAL)le.p_addrcurrentownershipindex) >= 2.5 AND ((REAL)le.p_addrcurrentownershipindex) <= 3.5,((REAL)le.p_addrcurrentownershipindex) >= 3.5);
    SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_range,0.0,0.0,0.369840206147756,0.153617815307213,-0.11136892139623,-0.482905249758621,0);
    SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_range,0.0 - 0.032557624,0.0 - 0.032557624,0.369840206147756 - 0.032557624,0.153617815307213 - 0.032557624,-0.11136892139623 - 0.032557624,-0.482905249758621 - 0.032557624,0);
    SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_range,'','A44','A44','A44','A44','A44','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_range := WHICH(le.L_ca_creditseeking >= -998 AND le.L_ca_creditseeking <= -998,le.L_ca_creditseeking >= -1 AND le.L_ca_creditseeking <= -1,le.L_ca_creditseeking >= -999999999 AND le.L_ca_creditseeking <= 1,le.L_ca_creditseeking >= 2 AND le.L_ca_creditseeking <= 2,le.L_ca_creditseeking >= 3 AND le.L_ca_creditseeking <= 3,le.L_ca_creditseeking >= 4 AND le.L_ca_creditseeking <= 4,le.L_ca_creditseeking >= 5 AND le.L_ca_creditseeking <= 5,le.L_ca_creditseeking >= 6 AND le.L_ca_creditseeking <= 6,le.L_ca_creditseeking >= 7 AND le.L_ca_creditseeking <= 7,le.L_ca_creditseeking >= 7);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_range,0.0,0.0,-0.537997066263463,0.0548804249144252,0.190031718225198,0.650769565235421,1.00836443079308,1.18265340641186,0.190031718225198,0.0548804249144252,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_range,0.0 - -0.188809907,0.0 - -0.188809907,-0.537997066263463 - -0.188809907,0.0548804249144252 - -0.188809907,0.190031718225198 - -0.188809907,0.650769565235421 - -0.188809907,1.00836443079308 - -0.188809907,1.18265340641186 - -0.188809907,0.190031718225198 - -0.188809907,0.0548804249144252 - -0.188809907,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_range,'','I60','I60','I60','I60','I60','I60','I60','C21','I61','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_range := WHICH(le.L_ca_addrchangeindex >= -998 AND le.L_ca_addrchangeindex <= -998,le.L_ca_addrchangeindex >= -1 AND le.L_ca_addrchangeindex <= -1,le.L_ca_addrchangeindex >= -999999999 AND le.L_ca_addrchangeindex <= 2.5,le.L_ca_addrchangeindex >= 2.5 AND le.L_ca_addrchangeindex <= 4.5,le.L_ca_addrchangeindex >= 4.5 AND le.L_ca_addrchangeindex <= 5.5,le.L_ca_addrchangeindex >= 5.5);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_range,0.0,0.0,-0.052677852519793,0.0093886967604785,0.0857939935789934,0.187917227284159,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_range,0.0 - -0.005703807,0.0 - -0.005703807,-0.052677852519793 - -0.005703807,0.0093886967604785 - -0.005703807,0.0857939935789934 - -0.005703807,0.187917227284159 - -0.005703807,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_range,'','C14','C14','C14','C14','C14','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_range := WHICH(((REAL)le.p_assetpropcurrentcount) >= -998 AND ((REAL)le.p_assetpropcurrentcount) <= -998,((REAL)le.p_assetpropcurrentcount) >= -1 AND ((REAL)le.p_assetpropcurrentcount) <= -1,((REAL)le.p_assetpropcurrentcount) >= -999999999 AND ((REAL)le.p_assetpropcurrentcount) <= 0.5,((REAL)le.p_assetpropcurrentcount) >= 0.5 AND ((REAL)le.p_assetpropcurrentcount) <= 1.5,((REAL)le.p_assetpropcurrentcount) >= 1.5);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_range,0.0,0.0,0.343155403853238,-0.260918946043492,-0.33457231340859,0);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_range,0.0 - 0.149654754,0.0 - 0.149654754,0.343155403853238 - 0.149654754,-0.260918946043492 - 0.149654754,-0.33457231340859 - 0.149654754,0);
    SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_range,'','','A42','A42','A42','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_range := WHICH(le.L_ca_nonderogindex >= -998 AND le.L_ca_nonderogindex <= -998,le.L_ca_nonderogindex >= -1 AND le.L_ca_nonderogindex <= -1,le.L_ca_nonderogindex >= -999999999 AND le.L_ca_nonderogindex <= 2.5,le.L_ca_nonderogindex >= 2.5 AND le.L_ca_nonderogindex <= 3.5,le.L_ca_nonderogindex >= 3.5 AND le.L_ca_nonderogindex <= 4.5,le.L_ca_nonderogindex >= 4.5);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_range,0.0,0.0,0.224638954157977,0.0534093514829876,-0.248370773172574,-0.453675193810595,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_range,0.0 - 0.073420476,0.0 - 0.073420476,0.224638954157977 - 0.073420476,0.0534093514829876 - 0.073420476,-0.248370773172574 - 0.073420476,-0.453675193810595 - 0.073420476,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_range,'','C12','C12','C12','C12','C12','99999');

    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_range := WHICH(le.L_ca_derogseverityindex >= -998 AND le.L_ca_derogseverityindex <= -998,le.L_ca_derogseverityindex >= -1 AND le.L_ca_derogseverityindex <= -1,le.L_ca_derogseverityindex >= -999999999 AND le.L_ca_derogseverityindex <= 1,le.L_ca_derogseverityindex >= 2 AND le.L_ca_derogseverityindex <= 2,le.L_ca_derogseverityindex >= 3 AND le.L_ca_derogseverityindex <= 3,le.L_ca_derogseverityindex >= 4 AND le.L_ca_derogseverityindex <= 4,le.L_ca_derogseverityindex >= 5 AND le.L_ca_derogseverityindex <= 5,le.L_ca_derogseverityindex >= 6 AND le.L_ca_derogseverityindex <= 6,le.L_ca_derogseverityindex >= 7 AND le.L_ca_derogseverityindex <= 7,le.L_ca_derogseverityindex >= 7);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_score := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_range,0.0,0.0,-0.413793157156462,-0.0314225344056521,0.400599180681259,0.683351662414589,0.958117552563772,0.958117552563772,0.400599180681259,0.400599180681259,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_contribution_best := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_range,0.0 - -0.316279327,0.0 - -0.316279327,-0.413793157156462 - -0.316279327,-0.0314225344056521 - -0.316279327,0.400599180681259 - -0.316279327,0.683351662414589 - -0.316279327,0.958117552563772 - -0.316279327,0.958117552563772 - -0.316279327,0.400599180681259 - -0.316279327,0.400599180681259 - -0.316279327,0);
    SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_reason := CHOOSE(SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_range,'','','','D34','D30','D33','D30','D33','D34','D31','99999');
// Now compute values for score SCORECARD_model47
    SELF.RVT2004_2_0_SCORECARD_model47_Score0 := -1.58477952594377 + SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_Score + SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_Score + SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_Score + SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_Score + SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_Score + SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_Score + SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_Score + SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_Score;
    SELF.RVT2004_2_0_SCORECARD_model47_Score1 := (700 + -40 * ((SELF.RVT2004_2_0_SCORECARD_model47_Score0 - 0 - LN(0.35685210312076)) / LN(2)));
    SELF.RVT2004_2_0_SCORECARD_model47_Score := ROUND( MAP (  SELF.RVT2004_2_0_SCORECARD_model47_Score1 < 501 => 501, SELF.RVT2004_2_0_SCORECARD_model47_Score1 > 900 => 900,SELF.RVT2004_2_0_SCORECARD_model47_Score1));
    SELF.RVT2004_2_0_Score := SELF.RVT2004_2_0_SCORECARD_model47_Score;
    aggregateRCs := SORT(
      TABLE(
      DATASET([
        {SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_addrprevioustimeoldest_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_assetpropeversoldcount_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_addrcurrentownershipindex_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_L_ca_creditseeking_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_L_ca_addrchangeindex_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_assetpropcurrentcount_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_L_ca_nonderogindex_reason}
        ,{SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_contribution_best,SELF.RVT2004_2_0_SCORECARD_model47_L_ca_derogseverityindex_reason}
    ...
    SELF.RVT2004_2_0_SCORECARD_model47_Reasons := RVT2004_2_0_SCORECARD_model47_Reasons_Best;
    SELF.RVT2004_2_0_Reasons := SELF.RVT2004_2_0_SCORECARD_model47_Reasons;
    SELF := le;
  END;
