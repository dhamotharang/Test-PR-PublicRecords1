EXPORT Score_RVT2004_2_0(fullDebugOutput=FALSE,landingZoneIP='Constants.LandingZoneIP',lzFilePathFolder='\'/data/LUCI/RVT2004_2_0/\'',
 ...
 Score_Model := MODULE
    ...
    \******************************************************************************/
    #IF(fullDebugOutput)
    EXPORT LUCIresults := rvt2004_2_0.AppendAll_Debug(RawInputSet,do_RVT2004_2_0,addrchangecount60month,addrcurrentownershipindex,addronfilecount,addrprevioustimeoldest,alertregulatorycondition,assetpropcurrentcount,assetpropeversoldcount,bankruptcystatus,confirmationsubjectfound,evictioncount,inquiryauto12month,inquirybanking12month,inquirycollections12month,inquiryshortterm12month,lienjudgmentcount,lienjudgmentsmallclaimscount,shorttermloanrequest,sourcenonderogcount,sourcenonderogcount06month,ssndeceased,subjectdeceased,subjectrecordtimeoldest);
    #ELSE
    EXPORT LUCIresults := rvt2004_2_0.AppendAll(RawInputSet,do_RVT2004_2_0,addrchangecount60month,addrcurrentownershipindex,addronfilecount,addrprevioustimeoldest,alertregulatorycondition,assetpropcurrentcount,assetpropeversoldcount,bankruptcystatus,confirmationsubjectfound,evictioncount,inquiryauto12month,inquirybanking12month,inquirycollections12month,inquiryshortterm12month,lienjudgmentcount,lienjudgmentsmallclaimscount,shorttermloanrequest,sourcenonderogcount,sourcenonderogcount06month,ssndeceased,subjectdeceased,subjectrecordtimeoldest);
    #END
    ...
    #IF(deSpray)
    flatRCLayout := RECORD
        RECORDOF(LUCIresults) AND NOT [RVT2004_2_0_Reasons #IF(fullDebugOutput), RVT2004_2_0_SCORECARD_model47_Reasons #END];
        #IF(fullDebugOutput)
        STRING5 RVT2004_2_0_SCORECARD_model47_Reason_1;
        STRING5 RVT2004_2_0_SCORECARD_model47_Reason_2;
        STRING5 RVT2004_2_0_SCORECARD_model47_Reason_3;
        STRING5 RVT2004_2_0_SCORECARD_model47_Reason_4;
        STRING5 RVT2004_2_0_SCORECARD_model47_Reason_5;

        #END
        STRING5 RVT2004_2_0_Reason_1;
        STRING5 RVT2004_2_0_Reason_2;
        STRING5 RVT2004_2_0_Reason_3;
        STRING5 RVT2004_2_0_Reason_4;
        STRING5 RVT2004_2_0_Reason_5;

    END;

    flatRCLayout flattenRCs(LUCIresults le) := TRANSFORM
        #IF(fullDebugOutput)
        SELF.RVT2004_2_0_SCORECARD_model47_Reason_1 := le.RVT2004_2_0_SCORECARD_model47_Reasons[1];
        SELF.RVT2004_2_0_SCORECARD_model47_Reason_2 := le.RVT2004_2_0_SCORECARD_model47_Reasons[2];
        SELF.RVT2004_2_0_SCORECARD_model47_Reason_3 := le.RVT2004_2_0_SCORECARD_model47_Reasons[3];
        SELF.RVT2004_2_0_SCORECARD_model47_Reason_4 := le.RVT2004_2_0_SCORECARD_model47_Reasons[4];
        SELF.RVT2004_2_0_SCORECARD_model47_Reason_5 := le.RVT2004_2_0_SCORECARD_model47_Reasons[5];

        #END
        SELF.RVT2004_2_0_Reason_1 := le.RVT2004_2_0_Reasons[1];
        SELF.RVT2004_2_0_Reason_2 := le.RVT2004_2_0_Reasons[2];
        SELF.RVT2004_2_0_Reason_3 := le.RVT2004_2_0_Reasons[3];
        SELF.RVT2004_2_0_Reason_4 := le.RVT2004_2_0_Reasons[4];
        SELF.RVT2004_2_0_Reason_5 := le.RVT2004_2_0_Reasons[5];
    ...
    DesprayLUCIResult := rvt2004_2_0.FNDesprayCSV(LUCIresultsFlat, TempLogical('~LUCI::ScoreResultsFile::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_ScoreResultsFile'));
    #END
