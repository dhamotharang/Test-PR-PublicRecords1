EXPORT Validate_RVG2005_0_1(reasonCodes=TRUE,landingZoneIP='Constants.LandingZoneIP',lzFilePathFolder='\'/data/LUCI/RVG2005_0_1/\'',
 ...
 Validate_Model := MODULE
    IMPORT UT,STD;
    IMPORT RVG2005_0_1 AS LUCI_Model;
