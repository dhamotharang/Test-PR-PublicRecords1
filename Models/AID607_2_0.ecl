...
Layout_ModelOut doModel(clam le) := TRANSFORM
	...
	****************************************************************************************/
	...
	AID607_2_0 := -66.18864 + 2.026774 * fcra5 + -0.002135993 * fcra5 * fcra5 + 0.0000008836755 * fcra5 * fcra5 * fcra5;

	aid := map(fcra5 < 350 => 419,
			 fcra5 > 800 => 641,
			 AID607_2_0);
			 
	/****************************************************************************************
	* The following is wfsmodel.1 override code.
	****************************************************************************************/

	aid2 := if(le.ssn_verification.validation.dob_mismatch > 0 and aid > 635, (635 + (aid - 635)/5), aid);

	aid3 := if(le.ssn_verification.validation.deceased and aid2 > 609, round(700 + (aid2 - 609)/5), aid2);
