...
Layout_ModelOut doModel(clam le) := transform
	...
	/* Models */
     ...
     Fraud_Score_510_9 := map(Fraud_Score_510 <= 594 => 10,
						Fraud_Score_510 <= 612 => 20,
						Fraud_Score_510 <= 624 => 30,
						Fraud_Score_510 <= 632 => 40,
						Fraud_Score_510 <= 641 => 50,
						Fraud_Score_510 <= 650 => 60,
						Fraud_Score_510 <= 656 => 70,
						Fraud_Score_510 <= 679 => 80,
						90);


	SELF.score := (string)Fraud_Score_510_9;
	SELF.seq := le.seq;
	SELF.ri := [];
