...
export Healthcare_SocioEconomic_Core(isCoreRequestValid ,batch_in, DPPAPurpose_in, GLBPurpose_in, DataRestrictionMask_in, DataPermissionMask_in, Options_in, ofac_version_in, gateways_in_ds, CoreResults) := MACRO
	...
	unsigned1 ofac_version_ := ofac_version_in; //TODO: Pass OFACVersion value here
	...
	gateways_in := gateways_in_ds; //TODO: Pass Gateway.Configuration.Get() value here;
...
/* ***************************************
   ...
   *************************************** */
	...
	M1_SeRs_LUCI_results_base := HCSE_SERA_GBM_M1_V1_model_LUCI.AsResults(M1_SeRs_Model_Input).Base();
 	...
 	//TODO: Change Score precision to 4 digits and all associated layouts as part of MA release.
	...
	Results_OPTION_M := Models.Healthcare_SocioEconomic_Transforms_Core.Add_SEMA_Score_RD(SeMA_Inp_LexID_ADLScore, M0_SeMA_Results_RD,Models.Layouts_Healthcare_Core.Final_Output_Layout);
