EXPORT Score_RVC2004_3_0(fullDebugOutput=FALSE,landingZoneIP='Constants.LandingZoneIP',lzFilePathFolder='\'/data/LUCI/RVC2004_3_0/\'',
 ...
 Score_Model := MODULE
    ...
    \******************************************************************************/
    #IF(fullDebugOutput)
    EXPORT LUCIresults := rvc2004_3_0.AppendAll_Debug(RawInputSet,do_RVC2004_3_0,CollateralStatus,OutOfStatuteIndicator,addrinputlengthofres,addrprevioustimeoldest,bankruptcycount,confirmationsubjectfound,dayssince_LastPaymentDate,derogcount,inputprovidedphone,inquirycollections12month,ssndeceased,subjectdeceased);
    #ELSE
    EXPORT LUCIresults := rvc2004_3_0.AppendAll(RawInputSet,do_RVC2004_3_0,CollateralStatus,OutOfStatuteIndicator,addrinputlengthofres,addrprevioustimeoldest,bankruptcycount,confirmationsubjectfound,dayssince_LastPaymentDate,derogcount,inputprovidedphone,inquirycollections12month,ssndeceased,subjectdeceased);
    #END
    ...
    #IF(deSpray)
    flatRCLayout := RECORD
        RECORDOF(LUCIresults) AND NOT [RVC2004_3_0_Reasons #IF(fullDebugOutput), RVC2004_3_0_SCORECARD_model13_Reasons #END];
        #IF(fullDebugOutput)
        STRING5 RVC2004_3_0_SCORECARD_model13_Reason_1;
        STRING5 RVC2004_3_0_SCORECARD_model13_Reason_2;
        STRING5 RVC2004_3_0_SCORECARD_model13_Reason_3;
        STRING5 RVC2004_3_0_SCORECARD_model13_Reason_4;
        STRING5 RVC2004_3_0_SCORECARD_model13_Reason_5;

        #END
        STRING5 RVC2004_3_0_Reason_1;
        STRING5 RVC2004_3_0_Reason_2;
        STRING5 RVC2004_3_0_Reason_3;
        STRING5 RVC2004_3_0_Reason_4;
        STRING5 RVC2004_3_0_Reason_5;

    END;

    flatRCLayout flattenRCs(LUCIresults le) := TRANSFORM
        #IF(fullDebugOutput)
        SELF.RVC2004_3_0_SCORECARD_model13_Reason_1 := le.RVC2004_3_0_SCORECARD_model13_Reasons[1];
        SELF.RVC2004_3_0_SCORECARD_model13_Reason_2 := le.RVC2004_3_0_SCORECARD_model13_Reasons[2];
        SELF.RVC2004_3_0_SCORECARD_model13_Reason_3 := le.RVC2004_3_0_SCORECARD_model13_Reasons[3];
        SELF.RVC2004_3_0_SCORECARD_model13_Reason_4 := le.RVC2004_3_0_SCORECARD_model13_Reasons[4];
        SELF.RVC2004_3_0_SCORECARD_model13_Reason_5 := le.RVC2004_3_0_SCORECARD_model13_Reasons[5];

        #END
        SELF.RVC2004_3_0_Reason_1 := le.RVC2004_3_0_Reasons[1];
        SELF.RVC2004_3_0_Reason_2 := le.RVC2004_3_0_Reasons[2];
        SELF.RVC2004_3_0_Reason_3 := le.RVC2004_3_0_Reasons[3];
        SELF.RVC2004_3_0_Reason_4 := le.RVC2004_3_0_Reasons[4];
        SELF.RVC2004_3_0_Reason_5 := le.RVC2004_3_0_Reasons[5];
    ...
    DesprayLUCIResult := rvc2004_3_0.FNDesprayCSV(LUCIresultsFlat, TempLogical('~LUCI::ScoreResultsFile::' + ModelName), LandingZoneIP, lzDesprayFilePath('LUCI_' + ModelName + '_ScoreResultsFile'));
    #END
