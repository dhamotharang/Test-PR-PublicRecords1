...
SHARED Layouts := rvc2004_3_0.z_layouts;
...
SHARED CSVSprayFile := 'RVC2004_3_0_luci_validationfile.csv';
SHARED lzFilePath        := lzFilePathFolder + CSVSprayFile;
SHARED SprayCSVName      := '~fazetu01::rvc2004_3_0-validation-data.csv_thor'; // Will set up by user if test file is a logical file.
...
SHARED isCSVFile := FALSE;
  //rvc2004_3_0.FNSpray(LandingZoneIP, lzFilePath, SprayCSVName, CSVSpraySeparator, CSVSprayQuote);
/******************************************************************************\
...
SHARED RawInputSet := PROJECT(RawInputSet0, TRANSFORM(Layouts.Input_Layouts, SELF.do_RVC2004_3_0 := TRUE, SELF := LEFT));
