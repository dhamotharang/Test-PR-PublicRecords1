...
Command line options: -MScrubs_Corp2_Mapping_ME_Main -eC:\Users\butlersx\AppData\Local\Temp\TFRE709.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_ME_Main
FILENAME:In_ME
...
FIELDTYPE:invalid_corp_vendor:ENUM(23)
FIELDTYPE:invalid_state_origin:ENUM(ME)
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_status_cd:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_cd>0,recordorigin)
FIELDTYPE:invalid_status_desc:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_desc>0,recordorigin)
FIELDTYPE:invalid_orig_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_orig_org_structure_desc>0,recordorigin)
FIELDTYPE:invalid_numeric:ALLOW(0123456789)
FIELDTYPE:invalid_alpha:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_internalfield1:CUSTOM(Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_name_type_cd>0,recordorigin)
...
FIELD:corp_ln_name_type_cd:TYPE(STRING2):LIKE(invalid_type_cd):0,
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alpha):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alpha):0,0
