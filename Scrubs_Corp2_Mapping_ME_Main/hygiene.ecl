...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_corp_action_pending_cd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_action_pending_cd)));
    avelength_corp_action_pending_cd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_action_pending_cd)),h.corp_action_pending_cd<>(typeof(h.corp_action_pending_cd))'');
    ...
    maxlength_corp_comment := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_comment)));
    avelength_corp_comment := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_comment)),h.corp_comment<>(typeof(h.corp_comment))'');
    ...
    maxlength_corp_has_members := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_has_members)));
    avelength_corp_has_members := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_has_members)),h.corp_has_members<>(typeof(h.corp_has_members))'');
    populated_corp_has_vested_managers_pcnt := AVE(GROUP,IF(h.corp_has_vested_managers = (TYPEOF(h.corp_has_vested_managers))'',0,100));
    maxlength_corp_has_vested_managers := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_has_vested_managers)));
    avelength_corp_has_vested_managers := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_has_vested_managers)),h.corp_has_vested_managers<>(typeof(h.corp_has_vested_managers))'');
    ...
    maxlength_corp_is_non_profit_irs_approved := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_is_non_profit_irs_approved)));
    avelength_corp_is_non_profit_irs_approved := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_is_non_profit_irs_approved)),h.corp_is_non_profit_irs_approved<>(typeof(h.corp_is_non_profit_irs_approved))'');
    ...
    maxlength_corp_llc_managed_ind := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_llc_managed_ind)));
    avelength_corp_llc_managed_ind := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_llc_managed_ind)),h.corp_llc_managed_ind<>(typeof(h.corp_llc_managed_ind))'');
    ...
    maxlength_corp_merger_type_converted_to_cd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_type_converted_to_cd)));
    avelength_corp_merger_type_converted_to_cd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_merger_type_converted_to_cd)),h.corp_merger_type_converted_to_cd<>(typeof(h.corp_merger_type_converted_to_cd))'');
    ...
    maxlength_corp_name_reservation_desc := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_reservation_desc)));
    avelength_corp_name_reservation_desc := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_name_reservation_desc)),h.corp_name_reservation_desc<>(typeof(h.corp_name_reservation_desc))'');
    ...
    maxlength_corp_non_profit_irs_approved_purpose := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_non_profit_irs_approved_purpose)));
    avelength_corp_non_profit_irs_approved_purpose := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_non_profit_irs_approved_purpose)),h.corp_non_profit_irs_approved_purpose<>(typeof(h.corp_non_profit_irs_approved_purpose))'');
    ...
    maxlength_corp_non_profit_solicit_donations := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_non_profit_solicit_donations)));
    avelength_corp_non_profit_solicit_donations := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_non_profit_solicit_donations)),h.corp_non_profit_solicit_donations<>(typeof(h.corp_non_profit_solicit_donations))'');
    ...
    maxlength_corp_operating_agreement := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_operating_agreement)));
    avelength_corp_operating_agreement := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_operating_agreement)),h.corp_operating_agreement<>(typeof(h.corp_operating_agreement))'');
    ...
    maxlength_corp_termination_cd := MAX(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_termination_cd)));
    avelength_corp_termination_cd := AVE(GROUP,LENGTH(TRIM((SALT34.StrType)h.corp_termination_cd)),h.corp_termination_cd<>(typeof(h.corp_termination_cd))'');
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{25,'corp_address2_effective_date'}
      ...
      ,{38,'corp_status_date'}
      ,{39,'corp_standing'}
      ,{40,'corp_status_comment'}
      ,{41,'corp_ticker_symbol'}
      ,{42,'corp_stock_exchange'}
      ,{43,'corp_inc_state'}
      ,{44,'corp_inc_county'}
      ,{45,'corp_inc_date'}
      ,{46,'corp_anniversary_month'}
      ,{47,'corp_fed_tax_id'}
      ,{48,'corp_state_tax_id'}
      ,{49,'corp_term_exist_cd'}
      ,{50,'corp_term_exist_exp'}
      ,{51,'corp_term_exist_desc'}
      ,{52,'corp_foreign_domestic_ind'}
      ,{53,'corp_forgn_state_cd'}
      ,{54,'corp_forgn_state_desc'}
      ,{55,'corp_forgn_sos_charter_nbr'}
      ,{56,'corp_forgn_date'}
      ,{57,'corp_forgn_fed_tax_id'}
      ,{58,'corp_forgn_state_tax_id'}
      ,{59,'corp_forgn_term_exist_cd'}
      ,{60,'corp_forgn_term_exist_exp'}
      ,{61,'corp_forgn_term_exist_desc'}
      ,{62,'corp_orig_org_structure_cd'}
      ,{63,'corp_orig_org_structure_desc'}
      ,{64,'corp_for_profit_ind'}
      ,{65,'corp_public_or_private_ind'}
      ,{66,'corp_sic_code'}
      ,{67,'corp_naic_code'}
      ,{68,'corp_orig_bus_type_cd'}
      ,{69,'corp_orig_bus_type_desc'}
      ,{70,'corp_entity_desc'}
      ,{71,'corp_certificate_nbr'}
      ,{72,'corp_internal_nbr'}
      ,{73,'corp_previous_nbr'}
      ,{74,'corp_microfilm_nbr'}
      ,{75,'corp_amendments_filed'}
      ,{76,'corp_acts'}
      ,{77,'corp_partnership_ind'}
      ,{78,'corp_mfg_ind'}
      ,{79,'corp_addl_info'}
      ,{80,'corp_taxes'}
      ,{81,'corp_franchise_taxes'}
      ,{82,'corp_tax_program_cd'}
      ,{83,'corp_tax_program_desc'}
      ,{84,'corp_ra_full_name'}
      ,{85,'corp_ra_fname'}
      ,{86,'corp_ra_mname'}
      ,{87,'corp_ra_lname'}
      ,{88,'corp_ra_suffix'}
      ,{89,'corp_ra_title_cd'}
      ,{90,'corp_ra_title_desc'}
      ,{91,'corp_ra_fein'}
      ,{92,'corp_ra_ssn'}
      ,{93,'corp_ra_dob'}
      ,{94,'corp_ra_effective_date'}
      ,{95,'corp_ra_resign_date'}
      ,{96,'corp_ra_no_comp'}
      ,{97,'corp_ra_no_comp_igs'}
      ,{98,'corp_ra_addl_info'}
      ,{99,'corp_ra_address_type_cd'}
      ,{100,'corp_ra_address_type_desc'}
      ,{101,'corp_ra_address_line1'}
      ,{102,'corp_ra_address_line2'}
      ,{103,'corp_ra_address_line3'}
      ,{104,'corp_ra_phone_number'}
      ,{105,'corp_ra_phone_number_type_cd'}
      ,{106,'corp_ra_phone_number_type_desc'}
      ,{107,'corp_ra_fax_nbr'}
      ,{108,'corp_ra_email_address'}
      ,{109,'corp_ra_web_address'}
      ,{110,'corp_prep_addr1_line1'}
      ,{111,'corp_prep_addr1_last_line'}
      ,{112,'corp_prep_addr2_line1'}
      ,{113,'corp_prep_addr2_last_line'}
      ,{114,'ra_prep_addr_line1'}
      ,{115,'ra_prep_addr_last_line'}
      ,{116,'cont_filing_reference_nbr'}
      ,{117,'cont_filing_date'}
      ,{118,'cont_filing_cd'}
      ,{119,'cont_filing_desc'}
      ,{120,'cont_type_cd'}
      ,{121,'cont_type_desc'}
      ,{122,'cont_full_name'}
      ,{123,'cont_fname'}
      ...
      ,{125,'cont_lname'}
      ,{126,'cont_suffix'}
      ,{127,'cont_title1_desc'}
      ,{128,'cont_title2_desc'}
      ,{129,'cont_title3_desc'}
      ,{130,'cont_title4_desc'}
      ,{131,'cont_title5_desc'}
      ,{132,'cont_fein'}
      ,{133,'cont_ssn'}
      ,{134,'cont_dob'}
      ,{135,'cont_status_cd'}
      ,{136,'cont_status_desc'}
      ,{137,'cont_effective_date'}
      ,{138,'cont_effective_cd'}
      ,{139,'cont_effective_desc'}
      ,{140,'cont_addl_info'}
      ,{141,'cont_address_type_cd'}
      ,{142,'cont_address_type_desc'}
      ,{143,'cont_address_line1'}
      ,{144,'cont_address_line2'}
      ,{145,'cont_address_line3'}
      ,{146,'cont_address_effective_date'}
      ,{147,'cont_address_county'}
      ,{148,'cont_phone_number'}
      ,{149,'cont_phone_number_type_cd'}
      ,{150,'cont_phone_number_type_desc'}
      ,{151,'cont_fax_nbr'}
      ,{152,'cont_email_address'}
      ,{153,'cont_web_address'}
      ,{154,'corp_acres'}
      ,{155,'corp_action'}
      ,{156,'corp_action_date'}
      ,{157,'corp_action_employment_security_approval_date'}
      ,{158,'corp_action_pending_cd'}
      ,{159,'corp_action_pending_desc'}
      ,{160,'corp_action_statement_of_intent_date'}
      ,{161,'corp_action_tax_dept_approval_date'}
      ,{162,'corp_acts2'}
      ,{163,'corp_acts3'}
      ,{164,'corp_additional_principals'}
      ,{165,'corp_address_office_type'}
      ,{166,'corp_agent_assign_date'}
      ...
      ,{172,'corp_agent_id'}
      ,{173,'corp_agriculture_flag'}
      ,{174,'corp_authorized_partners'}
      ,{175,'corp_comment'}
      ,{176,'corp_consent_flag_for_protected_name'}
      ,{177,'corp_converted'}
      ,{178,'corp_converted_from'}
      ,{179,'corp_country_of_formation'}
      ,{180,'corp_date_of_organization_meeting'}
      ,{181,'corp_delayed_effective_date'}
      ,{182,'corp_directors_from_to'}
      ,{183,'corp_dissolved_date'}
      ,{184,'corp_farm_exemptions'}
      ,{185,'corp_farm_qual_date'}
      ,{186,'corp_farm_status_cd'}
      ,{187,'corp_farm_status_date'}
      ,{188,'corp_farm_status_desc'}
      ,{189,'corp_fiscal_year_month'}
      ,{190,'corp_foreign_fiduciary_capacity_in_state'}
      ,{191,'corp_governing_statute'}
      ,{192,'corp_has_members'}
      ,{193,'corp_has_vested_managers'}
      ,{194,'corp_home_incorporated_county'}
      ,{195,'corp_home_state_name'}
      ,{196,'corp_is_professional'}
      ,{197,'corp_is_non_profit_irs_approved'}
      ,{198,'corp_last_renewal_date'}
      ,{199,'corp_last_renewal_year'}
      ,{200,'corp_license_type'}
      ,{201,'corp_llc_managed_desc'}
      ,{202,'corp_llc_managed_ind'}
      ,{203,'corp_management_desc'}
      ,{204,'corp_management_type'}
      ,{205,'corp_manager_managed'}
      ,{206,'corp_merged_corporation_id'}
      ,{207,'corp_merged_fein'}
      ,{208,'corp_merger_allowed_flag'}
      ,{209,'corp_merger_date'}
      ,{210,'corp_merger_desc'}
      ,{211,'corp_merger_effective_date'}
      ,{212,'corp_merger_id'}
      ,{213,'corp_merger_indicator'}
      ,{214,'corp_merger_name'}
      ,{215,'corp_merger_type_converted_to_cd'}
      ,{216,'corp_merger_type_converted_to_desc'}
      ,{217,'corp_naics_desc'}
      ,{218,'corp_name_effective_date'}
      ,{219,'corp_name_reservation_date'}
      ,{220,'corp_name_reservation_desc'}
      ,{221,'corp_name_reservation_expiration_date'}
      ,{222,'corp_name_reservation_nbr'}
      ,{223,'corp_name_reservation_type'}
      ,{224,'corp_name_status_cd'}
      ,{225,'corp_name_status_date'}
      ,{226,'corp_name_status_desc'}
      ,{227,'corp_non_profit_irs_approved_purpose'}
      ,{228,'corp_non_profit_solicit_donations'}
      ,{229,'corp_nbr_of_amendments'}
      ,{230,'corp_nbr_of_initial_llc_members'}
      ,{231,'corp_nbr_of_partners'}
      ,{232,'corp_operating_agreement'}
      ,{233,'corp_opt_in_llc_act_desc'}
      ,{234,'corp_opt_in_llc_act_ind'}
      ,{235,'corp_organizational_comments'}
      ,{236,'corp_partner_contributions_total'}
      ,{237,'corp_partner_terms'}
      ,{238,'corp_percentage_voters_required_to_approve_amendments'}
      ,{239,'corp_profession'}
      ,{240,'corp_province'}
      ,{241,'corp_public_mutual_corporation'}
      ,{242,'corp_purpose'}
      ,{243,'corp_ra_required_flag'}
      ,{244,'corp_registered_counties'}
      ,{245,'corp_regulated_ind'}
      ,{246,'corp_renewal_date'}
      ...
      ,{284,'recordorigin'}
      ,{285,'internalfield1'}],SALT34.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_corp_status_desc((SALT34.StrType)le.corp_status_desc,(SALT34.StrType)le.recordorigin),
    ...
    Fields.InValid_corp_action_pending_cd((SALT34.StrType)le.corp_action_pending_cd),
    ...
    Fields.InValid_corp_comment((SALT34.StrType)le.corp_comment),
    ...
    Fields.InValid_corp_has_members((SALT34.StrType)le.corp_has_members),
    Fields.InValid_corp_has_vested_managers((SALT34.StrType)le.corp_has_vested_managers),
    ...
    Fields.InValid_corp_is_non_profit_irs_approved((SALT34.StrType)le.corp_is_non_profit_irs_approved),
    ...
    Fields.InValid_corp_llc_managed_ind((SALT34.StrType)le.corp_llc_managed_ind),
    ...
    Fields.InValid_corp_merger_type_converted_to_cd((SALT34.StrType)le.corp_merger_type_converted_to_cd),
    ...
    Fields.InValid_corp_name_reservation_desc((SALT34.StrType)le.corp_name_reservation_desc),
    ...
    Fields.InValid_corp_non_profit_irs_approved_purpose((SALT34.StrType)le.corp_non_profit_irs_approved_purpose),
    Fields.InValid_corp_non_profit_solicit_donations((SALT34.StrType)le.corp_non_profit_solicit_donations),
    ...
    Fields.InValid_corp_operating_agreement((SALT34.StrType)le.corp_operating_agreement),
    ...
    Fields.InValid_corp_termination_cd((SALT34.StrType)le.corp_termination_cd),
    ...
    Fields.InValid_internalfield1((SALT34.StrType)le.internalfield1,(SALT34.StrType)le.recordorigin),
    0);
