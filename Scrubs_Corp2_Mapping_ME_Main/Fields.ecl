IMPORT ut,SALT34;
IMPORT Scrubs,Scrubs_Corp2_Mapping_ME_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_Y_N','invalid_type_cd','invalid_type_desc','invalid_status_cd','invalid_status_desc','invalid_orig_org_structure_desc','invalid_numeric','invalid_alpha','invalid_internalfield1','invalid_recordorigin');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_charter_nbr' => 7,'invalid_Y_N' => 8,'invalid_type_cd' => 9,'invalid_type_desc' => 10,'invalid_status_cd' => 11,'invalid_status_desc' => 12,'invalid_orig_org_structure_desc' => 13,'invalid_numeric' => 14,'invalid_alpha' => 15,'invalid_internalfield1' => 16,'invalid_recordorigin' => 17,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['23']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('23'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['ME']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('ME'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_corp_status_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_org_structure_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_orig_org_structure_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_orig_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_orig_org_structure_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_internalfield1(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_internalfield1(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_internalfield1(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ME_Main.Functions.invalid_name_type_cd'),SALT34.HygieneErrors.Good);
...
EXPORT FieldNum(SALT34.StrType fn) := CASE(fn,'dt_vendor_first_reported' => 0,'dt_vendor_last_reported' => 1,'dt_first_seen' => 2,'dt_last_seen' => 3,'corp_ra_dt_first_seen' => 4,'corp_ra_dt_last_seen' => 5,'corp_key' => 6,'corp_supp_key' => 7,'corp_vendor' => 8,'corp_vendor_county' => 9,'corp_vendor_subcode' => 10,'corp_state_origin' => 11,'corp_process_date' => 12,'corp_orig_sos_charter_nbr' => 13,'corp_legal_name' => 14,'corp_ln_name_type_cd' => 15,'corp_ln_name_type_desc' => 16,'corp_supp_nbr' => 17,'corp_name_comment' => 18,'corp_address1_type_cd' => 19,'corp_address1_type_desc' => 20,'corp_address1_line1' => 21,'corp_address1_line2' => 22,'corp_address1_line3' => 23,'corp_address2_effective_date' => 24,'corp_phone_number' => 25,'corp_phone_number_type_cd' => 26,'corp_phone_number_type_desc' => 27,'corp_fax_nbr' => 28,'corp_email_address' => 29,'corp_web_address' => 30,'corp_filing_reference_nbr' => 31,'corp_filing_date' => 32,'corp_filing_cd' => 33,'corp_filing_desc' => 34,'corp_status_cd' => 35,'corp_status_desc' => 36,'corp_status_date' => 37,'corp_standing' => 38,'corp_status_comment' => 39,'corp_ticker_symbol' => 40,'corp_stock_exchange' => 41,'corp_inc_state' => 42,'corp_inc_county' => 43,'corp_inc_date' => 44,'corp_anniversary_month' => 45,'corp_fed_tax_id' => 46,'corp_state_tax_id' => 47,'corp_term_exist_cd' => 48,'corp_term_exist_exp' => 49,'corp_term_exist_desc' => 50,'corp_foreign_domestic_ind' => 51,'corp_forgn_state_cd' => 52,'corp_forgn_state_desc' => 53,'corp_forgn_sos_charter_nbr' => 54,'corp_forgn_date' => 55,'corp_forgn_fed_tax_id' => 56,'corp_forgn_state_tax_id' => 57,'corp_forgn_term_exist_cd' => 58,'corp_forgn_term_exist_exp' => 59,'corp_forgn_term_exist_desc' => 60,'corp_orig_org_structure_cd' => 61,'corp_orig_org_structure_desc' => 62,'corp_for_profit_ind' => 63,'corp_public_or_private_ind' => 64,'corp_sic_code' => 65,'corp_naic_code' => 66,'corp_orig_bus_type_cd' => 67,'corp_orig_bus_type_desc' => 68,'corp_entity_desc' => 69,'corp_certificate_nbr' => 70,'corp_internal_nbr' => 71,'corp_previous_nbr' => 72,'corp_microfilm_nbr' => 73,'corp_amendments_filed' => 74,'corp_acts' => 75,'corp_partnership_ind' => 76,'corp_mfg_ind' => 77,'corp_addl_info' => 78,'corp_taxes' => 79,'corp_franchise_taxes' => 80,'corp_tax_program_cd' => 81,'corp_tax_program_desc' => 82,'corp_ra_full_name' => 83,'corp_ra_fname' => 84,'corp_ra_mname' => 85,'corp_ra_lname' => 86,'corp_ra_suffix' => 87,'corp_ra_title_cd' => 88,'corp_ra_title_desc' => 89,'corp_ra_fein' => 90,'corp_ra_ssn' => 91,'corp_ra_dob' => 92,'corp_ra_effective_date' => 93,'corp_ra_resign_date' => 94,'corp_ra_no_comp' => 95,'corp_ra_no_comp_igs' => 96,'corp_ra_addl_info' => 97,'corp_ra_address_type_cd' => 98,'corp_ra_address_type_desc' => 99,'corp_ra_address_line1' => 100,'corp_ra_address_line2' => 101,'corp_ra_address_line3' => 102,'corp_ra_phone_number' => 103,'corp_ra_phone_number_type_cd' => 104,'corp_ra_phone_number_type_desc' => 105,'corp_ra_fax_nbr' => 106,'corp_ra_email_address' => 107,'corp_ra_web_address' => 108,'corp_prep_addr1_line1' => 109,'corp_prep_addr1_last_line' => 110,'corp_prep_addr2_line1' => 111,'corp_prep_addr2_last_line' => 112,'ra_prep_addr_line1' => 113,'ra_prep_addr_last_line' => 114,'cont_filing_reference_nbr' => 115,'cont_filing_date' => 116,'cont_filing_cd' => 117,'cont_filing_desc' => 118,'cont_type_cd' => 119,'cont_type_desc' => 120,'cont_full_name' => 121,'cont_fname' => 122,'cont_mname' => 123,'cont_lname' => 124,'cont_suffix' => 125,'cont_title1_desc' => 126,'cont_title2_desc' => 127,'cont_title3_desc' => 128,'cont_title4_desc' => 129,'cont_title5_desc' => 130,'cont_fein' => 131,'cont_ssn' => 132,'cont_dob' => 133,'cont_status_cd' => 134,'cont_status_desc' => 135,'cont_effective_date' => 136,'cont_effective_cd' => 137,'cont_effective_desc' => 138,'cont_addl_info' => 139,'cont_address_type_cd' => 140,'cont_address_type_desc' => 141,'cont_address_line1' => 142,'cont_address_line2' => 143,'cont_address_line3' => 144,'cont_address_effective_date' => 145,'cont_address_county' => 146,'cont_phone_number' => 147,'cont_phone_number_type_cd' => 148,'cont_phone_number_type_desc' => 149,'cont_fax_nbr' => 150,'cont_email_address' => 151,'cont_web_address' => 152,'corp_acres' => 153,'corp_action' => 154,'corp_action_date' => 155,'corp_action_employment_security_approval_date' => 156,'corp_action_pending_cd' => 157,'corp_action_pending_desc' => 158,'corp_action_statement_of_intent_date' => 159,'corp_action_tax_dept_approval_date' => 160,'corp_acts2' => 161,'corp_acts3' => 162,'corp_additional_principals' => 163,'corp_address_office_type' => 164,'corp_agent_assign_date' => 165,'corp_agent_commercial' => 166,'corp_agent_country' => 167,'corp_agent_county' => 168,'corp_agent_status_cd' => 169,'corp_agent_status_desc' => 170,'corp_agent_id' => 171,'corp_agriculture_flag' => 172,'corp_authorized_partners' => 173,'corp_comment' => 174,'corp_consent_flag_for_protected_name' => 175,'corp_converted' => 176,'corp_converted_from' => 177,'corp_country_of_formation' => 178,'corp_date_of_organization_meeting' => 179,'corp_delayed_effective_date' => 180,'corp_directors_from_to' => 181,'corp_dissolved_date' => 182,'corp_farm_exemptions' => 183,'corp_farm_qual_date' => 184,'corp_farm_status_cd' => 185,'corp_farm_status_date' => 186,'corp_farm_status_desc' => 187,'corp_fiscal_year_month' => 188,'corp_foreign_fiduciary_capacity_in_state' => 189,'corp_governing_statute' => 190,'corp_has_members' => 191,'corp_has_vested_managers' => 192,'corp_home_incorporated_county' => 193,'corp_home_state_name' => 194,'corp_is_professional' => 195,'corp_is_non_profit_irs_approved' => 196,'corp_last_renewal_date' => 197,'corp_last_renewal_year' => 198,'corp_license_type' => 199,'corp_llc_managed_desc' => 200,'corp_llc_managed_ind' => 201,'corp_management_desc' => 202,'corp_management_type' => 203,'corp_manager_managed' => 204,'corp_merged_corporation_id' => 205,'corp_merged_fein' => 206,'corp_merger_allowed_flag' => 207,'corp_merger_date' => 208,'corp_merger_desc' => 209,'corp_merger_effective_date' => 210,'corp_merger_id' => 211,'corp_merger_indicator' => 212,'corp_merger_name' => 213,'corp_merger_type_converted_to_cd' => 214,'corp_merger_type_converted_to_desc' => 215,'corp_naics_desc' => 216,'corp_name_effective_date' => 217,'corp_name_reservation_date' => 218,'corp_name_reservation_desc' => 219,'corp_name_reservation_expiration_date' => 220,'corp_name_reservation_nbr' => 221,'corp_name_reservation_type' => 222,'corp_name_status_cd' => 223,'corp_name_status_date' => 224,'corp_name_status_desc' => 225,'corp_non_profit_irs_approved_purpose' => 226,'corp_non_profit_solicit_donations' => 227,'corp_nbr_of_amendments' => 228,'corp_nbr_of_initial_llc_members' => 229,'corp_nbr_of_partners' => 230,'corp_operating_agreement' => 231,'corp_opt_in_llc_act_desc' => 232,'corp_opt_in_llc_act_ind' => 233,'corp_organizational_comments' => 234,'corp_partner_contributions_total' => 235,'corp_partner_terms' => 236,'corp_percentage_voters_required_to_approve_amendments' => 237,'corp_profession' => 238,'corp_province' => 239,'corp_public_mutual_corporation' => 240,'corp_purpose' => 241,'corp_ra_required_flag' => 242,'corp_registered_counties' => 243,'corp_regulated_ind' => 244,'corp_renewal_date' => 245,'corp_standing_other' => 246,'corp_survivor_corporation_id' => 247,'corp_tax_base' => 248,'corp_tax_standing' => 249,'corp_termination_cd' => 250,'corp_termination_desc' => 251,'corp_termination_date' => 252,'corp_trademark_business_mark_type' => 253,'corp_trademark_cancelled_date' => 254,'corp_trademark_class_desc1' => 255,'corp_trademark_class_desc2' => 256,'corp_trademark_class_desc3' => 257,'corp_trademark_class_desc4' => 258,'corp_trademark_class_desc5' => 259,'corp_trademark_class_desc6' => 260,'corp_trademark_classification_nbr' => 261,'corp_trademark_disclaimer1' => 262,'corp_trademark_disclaimer2' => 263,'corp_trademark_expiration_date' => 264,'corp_trademark_filing_date' => 265,'corp_trademark_first_use_date' => 266,'corp_trademark_first_use_date_in_state' => 267,'corp_trademark_keywords' => 268,'corp_trademark_logo' => 269,'corp_trademark_name_expiration_date' => 270,'corp_trademark_nbr' => 271,'corp_trademark_renewal_date' => 272,'corp_trademark_status' => 273,'corp_trademark_used_1' => 274,'corp_trademark_used_2' => 275,'corp_trademark_used_3' => 276,'cont_owner_percentage' => 277,'cont_country' => 278,'cont_country_mailing' => 279,'cont_nondislosure' => 280,'cont_prep_addr_line1' => 281,'cont_prep_addr_last_line' => 282,'recordorigin' => 283,'internalfield1' => 284,0);
...
EXPORT Make_corp_address1_line3(SALT34.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_corp_address1_line3(SALT34.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_corp_address1_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
...
EXPORT InValid_corp_status_cd(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_status_cd(s,recordorigin);
...
EXPORT InValid_corp_status_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_status_desc(s,recordorigin);
...
EXPORT Make_corp_foreign_domestic_ind(SALT34.StrType s0) := s0;
EXPORT InValid_corp_foreign_domestic_ind(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_corp_foreign_domestic_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_state_cd(SALT34.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_corp_forgn_state_cd(SALT34.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT34.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_corp_forgn_state_desc(SALT34.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
...
EXPORT Make_corp_orig_org_structure_desc(SALT34.StrType s0) := MakeFT_invalid_orig_org_structure_desc(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_orig_org_structure_desc(s,recordorigin);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_org_structure_desc(wh);
 
EXPORT Make_corp_for_profit_ind(SALT34.StrType s0) := s0;
EXPORT InValid_corp_for_profit_ind(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_country_of_formation(SALT34.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_corp_country_of_formation(SALT34.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_corp_country_of_formation(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
...
EXPORT InValid_internalfield1(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_internalfield1(s,recordorigin);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_ME_Main;
