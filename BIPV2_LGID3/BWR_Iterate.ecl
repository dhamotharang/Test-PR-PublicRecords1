...
#workunit('name','BIPV2_LGID3.BWR_Iterate - Internal Linking - SALT V3.11.3');
...
// SALT311.MAC_MatchSamplePatterns(BIPV2_LGID3.Keys(BIPV2_LGID3.In_LGID3).MatchSample,MatchPatterns,LGID31,LGID32,8,37-43);
