...
//    ,OUTPUT( dproj3                 ,NAMED('RecordMatches'              ),all)
    ,OUTPUT( topn(mtch       ,10,-Conf),NAMED('RecordMatches'             ))
    ,OUTPUT( topn(mtch_score ,10,-Conf),NAMED('RecordMatchesScoreOnly'    ))
//    ,OUTPUT( odl + odr              ,NAMED('Lgid3BothRecords'         ))
    ,OUTPUT(choosen( odl,100)                    ,NAMED('Lgid3OneRecords'          ))
    ,OUTPUT(choosen( odr,100)                    ,NAMED('Lgid3TwoRecords'          ))
