...
EXPORT UnderLinks_ChildRec := RECORD
  ...
  UNSIGNED4 id;
END;
EXPORT CorteraAccounts_ChildRec := RECORD
  SALT311.StrType Basis;
  UNSIGNED8 cnt;
  UNSIGNED4 id;
END;
...
EXPORT R := RECORD,MAXLENGTH(32000)
 UNSIGNED1 dummy;
  ...
  REAL4 CorteraAccounts_specificity;
  REAL4 CorteraAccounts_switch;
  REAL4 CorteraAccounts_maximum;
  DATASET(CorteraAccounts_ChildRec) nulls_CorteraAccounts {MAXCOUNT(100)};
