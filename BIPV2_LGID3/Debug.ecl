...
EXPORT layout_sample_matches sample_match_join(match_candidates(ih).layout_candidates le,match_candidates(ih).layout_candidates ri,UNSIGNED c=0,UNSIGNED outside=0) := TRANSFORM
  ...
  SELF.Lgid3IfHrchy_match_code := MAP(
		le.Lgid3IfHrchy_isnull OR ri.Lgid3IfHrchy_isnull => SALT30.MatchCode.OneSideNull,
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT30.Layout_FieldValueList) nodes_below_st_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) OriginalSeleId_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) OriginalOrgId_Values := DATASET([],SALT30.Layout_FieldValueList);
  ...
  DATASET(SALT30.Layout_FieldValueList) has_lgid_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) is_sele_level_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) is_org_level_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) is_ult_level_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) parent_proxid_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) sele_proxid_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) org_proxid_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) ultimate_proxid_Values := DATASET([],SALT30.Layout_FieldValueList);
  DATASET(SALT30.Layout_FieldValueList) levels_from_top_Values := DATASET([],SALT30.Layout_FieldValueList);
...
Layout_RolledEntity RollValues(Layout_RolledEntity le,Layout_RolledEntity ri) := TRANSFORM
  ...
  SELF.nodes_below_st_values := SALT30.fn_combine_fieldvaluelist(le.nodes_below_st_values,ri.nodes_below_st_values);
  SELF.OriginalSeleId_values := SALT30.fn_combine_fieldvaluelist(le.OriginalSeleId_values,ri.OriginalSeleId_values);
  SELF.OriginalOrgId_values := SALT30.fn_combine_fieldvaluelist(le.OriginalOrgId_values,ri.OriginalOrgId_values);
  ...
  SELF.has_lgid_values := SALT30.fn_combine_fieldvaluelist(le.has_lgid_values,ri.has_lgid_values);
  SELF.is_sele_level_values := SALT30.fn_combine_fieldvaluelist(le.is_sele_level_values,ri.is_sele_level_values);
  SELF.is_org_level_values := SALT30.fn_combine_fieldvaluelist(le.is_org_level_values,ri.is_org_level_values);
  SELF.is_ult_level_values := SALT30.fn_combine_fieldvaluelist(le.is_ult_level_values,ri.is_ult_level_values);
  SELF.parent_proxid_values := SALT30.fn_combine_fieldvaluelist(le.parent_proxid_values,ri.parent_proxid_values);
  SELF.sele_proxid_values := SALT30.fn_combine_fieldvaluelist(le.sele_proxid_values,ri.sele_proxid_values);
  SELF.org_proxid_values := SALT30.fn_combine_fieldvaluelist(le.org_proxid_values,ri.org_proxid_values);
  SELF.ultimate_proxid_values := SALT30.fn_combine_fieldvaluelist(le.ultimate_proxid_values,ri.ultimate_proxid_values);
  SELF.levels_from_top_values := SALT30.fn_combine_fieldvaluelist(le.levels_from_top_values,ri.levels_from_top_values);
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  ...
  SELF.nodes_below_st_Values := DATASET([{TRIM((SALT30.StrType)le.nodes_below_st)}],SALT30.Layout_FieldValueList);
  SELF.OriginalSeleId_Values := DATASET([{TRIM((SALT30.StrType)le.OriginalSeleId)}],SALT30.Layout_FieldValueList);
  SELF.OriginalOrgId_Values := DATASET([{TRIM((SALT30.StrType)le.OriginalOrgId)}],SALT30.Layout_FieldValueList);
  ...
  SELF.has_lgid_Values := DATASET([{TRIM((SALT30.StrType)le.has_lgid)}],SALT30.Layout_FieldValueList);
  SELF.is_sele_level_Values := DATASET([{TRIM((SALT30.StrType)le.is_sele_level)}],SALT30.Layout_FieldValueList);
  SELF.is_org_level_Values := DATASET([{TRIM((SALT30.StrType)le.is_org_level)}],SALT30.Layout_FieldValueList);
  SELF.is_ult_level_Values := DATASET([{TRIM((SALT30.StrType)le.is_ult_level)}],SALT30.Layout_FieldValueList);
  SELF.parent_proxid_Values := DATASET([{TRIM((SALT30.StrType)le.parent_proxid)}],SALT30.Layout_FieldValueList);
  SELF.sele_proxid_Values := DATASET([{TRIM((SALT30.StrType)le.sele_proxid)}],SALT30.Layout_FieldValueList);
  SELF.org_proxid_Values := DATASET([{TRIM((SALT30.StrType)le.org_proxid)}],SALT30.Layout_FieldValueList);
  SELF.ultimate_proxid_Values := DATASET([{TRIM((SALT30.StrType)le.ultimate_proxid)}],SALT30.Layout_FieldValueList);
  SELF.levels_from_top_Values := DATASET([{TRIM((SALT30.StrType)le.levels_from_top)}],SALT30.Layout_FieldValueList);
