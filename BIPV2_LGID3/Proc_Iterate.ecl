...
d := DATASET([{MM.PatchingError0,MM.DuplicateRids0,COUNT(BIPV2_LGID3.match_candidates(InFile).Unlinkables),COUNT(BIPV2_LGID3.specificities(InFile).Rejected_file)}],{INTEGER PatchingError0, INTEGER DuplicateRids0, UNSIGNED UnlinkableRecords0,UNSIGNED RecordsRejected0});
