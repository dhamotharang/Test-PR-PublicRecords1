...
#workunit('name','BIPV2_LGID3.BWR_Specificities - Specificities - SALT V3.11.3');
...
// IMPORT SALTTOOLS30;
// SpcPatch := SALTTOOLS30.mac_Patch_spcString(SpecMod.Specificities,BIPV2_LGID3.In_LGID3,BIPV2_LGID3.GenerationMod.spcString);
