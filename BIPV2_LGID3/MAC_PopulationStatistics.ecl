...
+    #IF( #TEXT(Input_cortera_id)='' )
      '' 
    #ELSE
        IF( le.Input_cortera_id = (TYPEOF(le.Input_cortera_id))'','',':cortera_id')
    #END
