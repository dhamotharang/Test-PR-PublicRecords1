...
BIPV2_LGID3.match_candidates(BFile).layout_candidates into(BIPV2_LGID3.Keys(BFile).Candidates le) := transform
  self := le;
end;
odl := project(choosen(BIPV2_LGID3.Keys(BFile).Candidates(LGID3=(unsigned)LGID3str),10000),into(left));
odr := project(choosen(BIPV2_LGID3.Keys(BFile).Candidates(LGID3=(unsigned)Pref_LGID3str),10000),into(left));
