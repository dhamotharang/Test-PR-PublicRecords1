IMPORT doxie, suppress, LN_PropertyV2_Services, FCRA, FFD, Gateway, iesp;
...
EXPORT SearchService_records (unsigned6 search_did=0,integer1
  ...
  FUNCTION
    ...
    ids_0 := LN_PropertyV2_Services.SearchService_ids();

    dids := dataset([{search_did}], doxie.layout_references);
    by_did := project(LN_PropertyV2_Services.Raw.get_fids_from_dids(dids,isFCRA),transform(LN_PropertyV2_Services.layouts.search_fid,
