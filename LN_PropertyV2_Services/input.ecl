...
export input := module
	...
	//other
	export boolean addressOnlySearch := if((fname_value = '' And lname_value = '' And mname_value = '' 
																					And ssn = '' And did = 0 And cname = '' 
																					AND bdid = 0 And faresID = '' And parcelID =''),true,false);
	
	//two party second person search.
	export boolean addressOnlySearch_2 := if((gm().entity2_firstname = '' And gm().entity2_lastname = '' And gm().entity2_middlename = '' 
																					and gm().entity2_unparsedfullname ='' And gm().entity2_ssn = '' And gm().entity2_did = '' And gm().entity2_companyname = '' 
																					AND gm().entity2_bdid = ''),true,false);																				
