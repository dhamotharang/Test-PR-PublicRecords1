...
#workunit('name','Scrubs_CanadianPhones.InfutorWP_BWR_Scrubs - Checking field validity in a file - SALT V3.11.11');
IMPORT Scrubs_CanadianPhones,SALT311;
infile := Scrubs_CanadianPhones.InfutorWP_In_CanadianPhones;
mod_scrubs := Scrubs_CanadianPhones.InfutorWP_Scrubs;
