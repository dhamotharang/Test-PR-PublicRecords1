...
mac_scramble_pii_v2( //** THE ORDER OF THE FIELD NAMES IS CRITICAL ***
      ...
      scrambled_file, 	//scrambled output data set attribute
		  ...
		  true,name1_bdid,		// BDID field name
		  true,name1_first,
		  true,name1_middle,
		  true,name1_last,
...
self:=l;
END;
export scramble_foreclosure1 := dedup(sort(project(scrambled_file,reformat(LEFT)),record),all);	// : persist('thor::persist::scramble_foreclosure_a');
