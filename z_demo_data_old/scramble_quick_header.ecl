...
//file_in:=demo_data.base_files.file_header_quick;
file_in:= dataset('~thor::base::demo_data_file_header_quick_prodcopy',header.Layout_Header ,flat);
...
export scramble_quick_header := dedup(sort(project(scrambled_file,reformat(LEFT)),record),all);