...
file_in:= dataset('~thor::base::demo_data_file_phonesplus_base_prodcopy',phonesplus.layoutCommonOut,flat);
...
export scramble_phonesplus_base := dedup(sort(scrambled1(company='' and lname<>'' and fname<>''),record),all);