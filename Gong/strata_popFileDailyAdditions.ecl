...
ds := Gong.File_Daily_Additions;

rPopulationStats_File_Daily_Additions
 :=
  record
...
tStats := table(ds,rPopulationStats_File_Daily_Additions,few);

strata.createXMLStats(tStats,'Gong Daily','data',ut.GetDate,'',resultsOut);
export strata_popFileDailyAdditions := resultsOut;