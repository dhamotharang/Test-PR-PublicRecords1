...
import ut,RoxieKeyBuild,DayBatchEda,EDA_VIA_XML,risk_indicators,doxie_cbrs, gong_v2, watchdog;
...
// Build clean name key for surnames
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_History_CleanName,'~thor_data400::key::gong_history_cleanname','~thor_data400::key::gong_history::'+rundate+'::cleanname',bk_clnname);
//cng - bug 38567
...
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(Gong.key_history_LinkIDs.key,'~thor_data400::key::gong_history_LinkIDs','~thor_data400::key::gong_history::'+rundate+'::LinkIDs',bk_LinkIDs);

RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Address,'~thor_data400::key::gong_history::fcra::@version@::address','~thor_data400::key::gong_history::fcra::'+rundate+'::address',bk_fcra_addr);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Phone,'~thor_data400::key::gong_history::fcra::@version@::phone','~thor_data400::key::gong_history::fcra::'+rundate+'::phone',bk_fcra_phone);								 
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Did,'~thor_data400::key::gong_history::fcra::@version@::did','~thor_data400::key::gong_history::fcra::'+rundate+'::did',bk_fcra_did);								 
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Hhid,'~thor_data400::key::gong_history::fcra::@version@::hhid','~thor_data400::key::gong_history::fcra::'+rundate+'::hhid',bk_fcra_hhid);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_BDID,'~thor_Data400::key::gong_history::fcra::@version@::bdid','~thor_data400::key::gong_history::fcra::'+rundate+'::bdid',bk_fcra_bdid);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Name,'~thor_data400::key::gong_history::fcra::@version@::name','~thor_data400::key::gong_history::fcra::'+rundate+'::name',bk_fcra_name);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_CompanyName,'~thor_data400::key::gong_history::fcra::@version@::companyname','~thor_data400::key::gong_history::fcra::'+rundate+'::companyname',bk_fcra_companyname);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.key_FCRA_history_zip_name,'~thor_data400::key::gong_history::fcra::@version@::zip_name','~thor_data400::key::gong_history::fcra::'+rundate+'::zip_name',bk_fcra_zip_name);					
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.key_FCRA_history_npa_nxx_line,'~thor_data400::key::gong_history::fcra::@version@::npa_nxx_line','~thor_data400::key::gong_history::fcra::'+rundate+'::npa_nxx_line',bk_fcra_npa_nxx_line);
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_History_Surname,'~thor_data400::key::gong_history::fcra::@version@::surnames','~thor_data400::key::gong_history::fcra::'+rundate+'::surnames',bk_fcra_surname);					
...
// cjs
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(gong.Key_FCRA_Business_Header_Phone_Table_Filtered_V2 ,'~thor_data400::key::business_header::filtered::fcra::@version@::hri::phone10_v2','~thor_data400::key::business_header::filtered::fcra::'+rundate+'::hri::phone10_v2',Build2ndFCRAkey5);
...
ut.MAC_SK_Move_v2('~thor_data400::key::gong_history_city_st_name','Q',mk_csn);
ut.MAC_SK_Move_v2('~thor_data400::key::gong_history_wild_name_zip','Q',mk_wnzip);
//
ut.MAC_SK_Move_v2('~thor_data400::key::gong_history_cleanname','Q',mk_clnname);

ut.MAC_SK_Move_v2('~thor_data400::key::gong_history_LinkIDs','Q',mk_LinkIDs);
...
ut.mac_sk_move('~thor_data400::key::gong_cn','Q',out12);
ut.mac_sk_move('~thor_data400::key::gong_cn_to_company','Q',out13);
...
mv1 := parallel(mv1_addr,mv1_phone,mv1_did,mv1_hhid,mv1_bdid,mv1_name,mv1_clnname,mv1_zip_name,mv1_npa_nxx_line,mv1_surname,mv1_wdtg,mv1_cmp_name,mv1_csn, mv1_wnzip, mv_did, mv_hhid, MoveKeyToBuilt6, mv_cn, mv_cn_to_company, mv1_linkids,/*MoveFCRAKeyToBuilt5,*/
			...
			,mv1_fcra_addr,mv1_fcra_phone,mv1_fcra_did,mv1_fcra_hhid,mv1_fcra_bdid,mv1_fcra_name,mv1_fcra_companyname,mv1_fcra_zip_name,mv1_fcra_npa_nxx_line,mv1_fcra_surname,mv1_fcra_wdtg
			);
...
mk := parallel(mk_addr,mk_phone,mk_did,mk_hhid,mk_bdid,mk_name,mk_clnname,mk_zip_name,mk_npa_nxx_line,mk_surname,mk_wdtg,mk_cmp_name,mk_csn,mk_wnzip,out1,out2,MoveKeyToQA2,out12,out13,mk_LinkIDs/*,MoveFCRAKeyToQA3*/
			,Move2ndFCRAKeyToQA3
			,mk_fcra_addr,mk_fcra_phone,mk_fcra_did,mk_fcra_hhid,mk_fcra_bdid,mk_fcra_name,mk_fcra_companyname,mk_fcra_zip_name,mk_fcra_npa_nxx_line,mk_fcra_surname,mk_fcra_wdtg
			);
