...
f := Gong.File_History_Full_Prepped_for_FCRA_Keys(name_last <> '');
...
surnames_all := distribute(f(listing_type_res = 'R' AND current_record_flag='Y' AND TRIM(name_last)<>'' AND TRIM(name_first)<>''
