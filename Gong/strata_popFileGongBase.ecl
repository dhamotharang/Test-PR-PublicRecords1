...
tStats := table(ds,rPopulationStats_File_GongBase,few);

strata.createXMLStats(tStats,'Gong','data',ut.GetDate,'',resultsOut);

export strata_popFileGongBase := resultsOut;