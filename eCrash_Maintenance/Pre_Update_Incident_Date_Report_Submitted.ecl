/*
One time BWR to expand Incident file layout with new field date_report_submitted.
*/
IMPORT Data_Services;
EXPORT Pre_Update_Incident_Date_Report_Submitted := FUNCTION
 ...
 END;
	...
	ds_incident := DATASET(Data_Services.foreign_prod+'thor_data400::in::ecrash::incidnt_raw_new'
		...
		OUTPUT(upd_incident_layout,,'~thor_data400::in::ecrash::incident_layout_change_date_report_submitted_'+workunit,overwrite,__compressed__,
					    csv(terminator('\n'), separator(','),quote('"'),maxlength(60000)));

		do_all :=  SEQUENTIAL(
														FileServices.StartSuperFileTransaction(),
														FileServices.AddSuperFile('~thor_data400::in::ecrash::incidnt_raw_new','~thor_data400::in::ecrash::incident_layout_change_date_report_submitted_'+workunit),
