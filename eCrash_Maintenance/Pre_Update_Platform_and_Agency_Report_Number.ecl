/*
One time BWR to expand Incident file layout with new fields Platform, Agency_Report_Number.
*/
IMPORT Data_Services;
EXPORT Pre_Update_Platform_and_Agency_Report_Number := FUNCTION
...
FLAccidents_Ecrash.Layout_Infiles.incident_new ExpandIncidentLayout(ds_incident L) := TRANSFORM
																																												SELF.Platform := '';
																																												SELF.Agency_Report_Number := '';
																																												SELF := L;
																																											END;
																									 
upd_incident_layout := PROJECT(ds_incident, ExpandIncidentLayout(LEFT));
		
OUTPUT(upd_incident_layout,,'~thor_data400::in::ecrash::incident_layout_change_Platform_and_Agency_Report_Number_'+workunit,overwrite,__compressed__,
			 csv(terminator('\n'), separator(','),quote('"'),maxlength(60000)));

do_all :=  SEQUENTIAL(
											FileServices.StartSuperFileTransaction(),
											FileServices.AddSuperFile('~thor_data400::in::ecrash::incidnt_raw_new','~thor_data400::in::ecrash::incident_layout_change_Platform_and_Agency_Report_Number_'+workunit),
