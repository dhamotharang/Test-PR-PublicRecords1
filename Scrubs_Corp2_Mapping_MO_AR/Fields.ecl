...
EXPORT SALT36.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_future_date','invalid_ar_type');
EXPORT FieldTypeNum(SALT36.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_date' => 5,'invalid_future_date' => 6,'invalid_ar_type' => 7,0);
...
EXPORT MakeFT_invalid_ar_type(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&.(),:'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_ar_type(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&.(),:'))));
EXPORT InValidMessageFT_invalid_ar_type(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars(' 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/-&.(),:'),SALT36.HygieneErrors.Good);
...
EXPORT Make_ar_year(SALT36.StrType s0) := s0;
EXPORT InValid_ar_year(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_year(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_mailed_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_mailed_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_mailed_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_due_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_due_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_due_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_filed_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_filed_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_filed_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_report_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_report_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_nbr(SALT36.StrType s0) := s0;
EXPORT InValid_ar_report_nbr(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_report_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_franchise_tax_paid_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_franchise_tax_paid_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_franchise_tax_paid_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_delinquent_dt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_delinquent_dt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_delinquent_dt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_tax_factor(SALT36.StrType s0) := s0;
EXPORT InValid_ar_tax_factor(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_tax_factor(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_tax_amount_paid(SALT36.StrType s0) := s0;
EXPORT InValid_ar_tax_amount_paid(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_tax_amount_paid(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_annual_report_cap(SALT36.StrType s0) := s0;
EXPORT InValid_ar_annual_report_cap(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_annual_report_cap(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_illinois_capital(SALT36.StrType s0) := s0;
EXPORT InValid_ar_illinois_capital(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_illinois_capital(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_roll(SALT36.StrType s0) := s0;
EXPORT InValid_ar_roll(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_roll(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_frame(SALT36.StrType s0) := s0;
EXPORT InValid_ar_frame(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_frame(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_extension(SALT36.StrType s0) := s0;
EXPORT InValid_ar_extension(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_extension(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_microfilm_nbr(SALT36.StrType s0) := s0;
EXPORT InValid_ar_microfilm_nbr(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_microfilm_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_comment(SALT36.StrType s0) := s0;
EXPORT InValid_ar_comment(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_type(SALT36.StrType s0) := MakeFT_invalid_ar_type(s0);
EXPORT InValid_ar_type(SALT36.StrType s) := InValidFT_invalid_ar_type(s);
EXPORT InValidMessage_ar_type(UNSIGNED1 wh) := InValidMessageFT_invalid_ar_type(wh);
 
EXPORT Make_ar_exempt(SALT36.StrType s0) := s0;
EXPORT InValid_ar_exempt(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_exempt(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_license_tax_amount(SALT36.StrType s0) := s0;
EXPORT InValid_ar_license_tax_amount(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_license_tax_amount(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_status(SALT36.StrType s0) := s0;
EXPORT InValid_ar_status(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_status(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_paid_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_paid_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_paid_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_prev_paid_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_prev_paid_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_prev_paid_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_prev_tax_factor(SALT36.StrType s0) := s0;
EXPORT InValid_ar_prev_tax_factor(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_prev_tax_factor(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_extension_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_extension_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_extension_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_mail_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_report_mail_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_report_mail_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_deliquent_report_mail_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_deliquent_report_mail_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_deliquent_report_mail_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_report_filed_date(SALT36.StrType s0) := s0;
EXPORT InValid_ar_report_filed_date(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_report_filed_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ar_year_and_month_due(SALT36.StrType s0) := s0;
EXPORT InValid_ar_year_and_month_due(SALT36.StrType s) := 0;
EXPORT InValidMessage_ar_year_and_month_due(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT36,Scrubs_Corp2_Mapping_MO_AR;
