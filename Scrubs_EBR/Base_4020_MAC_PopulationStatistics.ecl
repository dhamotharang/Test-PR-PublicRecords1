...
EXPORT Base_4020_MAC_PopulationStatistics(infile,Ref='',Input_powid = '',Input_proxid = '',Input_seleid = '',Input_orgid = '',Input_ultid = '',Input_bdid = '',Input_date_first_seen = '',Input_date_last_seen = '',Input_process_date_first_seen = '',Input_process_date_last_seen = '',Input_record_type = '',Input_process_date = '',Input_file_number = '',Input_segment_code = '',Input_sequence_number = '',Input_orig_date_filed_ymd = '',Input_type_code = '',Input_type_description = '',Input_action_code = '',Input_action_description = '',Input_document_number = '',Input_filing_location = '',Input_liability_amount = '',Input_tax_lien_code = '',Input_tax_lien_description = '',Input_date_filed = '',OutFile) := MACRO
...
+    #IF( #TEXT(Input_tax_lien_code)='' )
      '' 
    #ELSE
        IF( le.Input_tax_lien_code = (TYPEOF(le.Input_tax_lien_code))'','',':tax_lien_code')
    #END
 
+    #IF( #TEXT(Input_tax_lien_description)='' )
      '' 
    #ELSE
        IF( le.Input_tax_lien_description = (TYPEOF(le.Input_tax_lien_description))'','',':tax_lien_description')
    #END
