IMPORT SALT311,STD;
EXPORT Base_4020_hygiene(dataset(Base_4020_layout_EBR) h) := MODULE
...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_tax_lien_code_cnt := COUNT(GROUP,h.tax_lien_code <> (TYPEOF(h.tax_lien_code))'');
    populated_tax_lien_code_pcnt := AVE(GROUP,IF(h.tax_lien_code = (TYPEOF(h.tax_lien_code))'',0,100));
    maxlength_tax_lien_code := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.tax_lien_code)));
    avelength_tax_lien_code := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.tax_lien_code)),h.tax_lien_code<>(typeof(h.tax_lien_code))'');
    populated_tax_lien_description_cnt := COUNT(GROUP,h.tax_lien_description <> (TYPEOF(h.tax_lien_description))'');
    populated_tax_lien_description_pcnt := AVE(GROUP,IF(h.tax_lien_description = (TYPEOF(h.tax_lien_description))'',0,100));
    maxlength_tax_lien_description := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.tax_lien_description)));
    avelength_tax_lien_description := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.tax_lien_description)),h.tax_lien_description<>(typeof(h.tax_lien_description))'');
...
SHARED FldIds := DATASET([{1,'powid'}
      ...
      ,{23,'liability_amount'}
      ,{24,'tax_lien_code'}
      ,{25,'tax_lien_description'}
      ,{26,'date_filed'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Base_4020_Fields.InValid_powid((SALT311.StrType)le.powid),
    Base_4020_Fields.InValid_proxid((SALT311.StrType)le.proxid),
    Base_4020_Fields.InValid_seleid((SALT311.StrType)le.seleid),
    Base_4020_Fields.InValid_orgid((SALT311.StrType)le.orgid),
    Base_4020_Fields.InValid_ultid((SALT311.StrType)le.ultid),
    Base_4020_Fields.InValid_bdid((SALT311.StrType)le.bdid),
    Base_4020_Fields.InValid_date_first_seen((SALT311.StrType)le.date_first_seen),
    Base_4020_Fields.InValid_date_last_seen((SALT311.StrType)le.date_last_seen),
    Base_4020_Fields.InValid_process_date_first_seen((SALT311.StrType)le.process_date_first_seen),
    Base_4020_Fields.InValid_process_date_last_seen((SALT311.StrType)le.process_date_last_seen),
    Base_4020_Fields.InValid_record_type((SALT311.StrType)le.record_type),
    Base_4020_Fields.InValid_process_date((SALT311.StrType)le.process_date),
    Base_4020_Fields.InValid_file_number((SALT311.StrType)le.file_number),
    Base_4020_Fields.InValid_segment_code((SALT311.StrType)le.segment_code),
    Base_4020_Fields.InValid_sequence_number((SALT311.StrType)le.sequence_number),
    Base_4020_Fields.InValid_orig_date_filed_ymd((SALT311.StrType)le.orig_date_filed_ymd),
    Base_4020_Fields.InValid_type_code((SALT311.StrType)le.type_code),
    Base_4020_Fields.InValid_type_description((SALT311.StrType)le.type_description),
    Base_4020_Fields.InValid_action_code((SALT311.StrType)le.action_code),
    Base_4020_Fields.InValid_action_description((SALT311.StrType)le.action_description),
    Base_4020_Fields.InValid_document_number((SALT311.StrType)le.document_number),
    Base_4020_Fields.InValid_filing_location((SALT311.StrType)le.filing_location),
    Base_4020_Fields.InValid_liability_amount((SALT311.StrType)le.liability_amount),
    Base_4020_Fields.InValid_tax_lien_code((SALT311.StrType)le.tax_lien_code),
    Base_4020_Fields.InValid_tax_lien_description((SALT311.StrType)le.tax_lien_description),
    Base_4020_Fields.InValid_date_filed((SALT311.StrType)le.date_filed),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Base_4020_Fields.FieldName(TotalErrors.FieldNum);
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_4020_Fields.InValidMessage_powid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_date_first_seen(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_date_last_seen(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_process_date_first_seen(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_process_date_last_seen(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_record_type(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_file_number(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_segment_code(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_sequence_number(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_orig_date_filed_ymd(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_type_code(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_type_description(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_action_code(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_action_description(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_document_number(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_filing_location(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_liability_amount(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_tax_lien_code(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_tax_lien_description(TotalErrors.ErrorNum),Base_4020_Fields.InValidMessage_date_filed(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_EBR, Base_4020_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
