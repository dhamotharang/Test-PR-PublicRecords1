...
EXPORT Base_4010_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(Base_4010_Layout_EBR)
    ...
    UNSIGNED1 liability_amt_Invalid;
    UNSIGNED1 asset_amt_Invalid;
    UNSIGNED1 date_filed_Invalid;
  END;
  EXPORT  Bitmap_Layout := RECORD(Base_4010_Layout_EBR)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Base_4010_Layout_EBR) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.powid_Invalid := Base_4010_Fields.InValid_powid((SALT311.StrType)le.powid);
    SELF.proxid_Invalid := Base_4010_Fields.InValid_proxid((SALT311.StrType)le.proxid);
    SELF.seleid_Invalid := Base_4010_Fields.InValid_seleid((SALT311.StrType)le.seleid);
    SELF.orgid_Invalid := Base_4010_Fields.InValid_orgid((SALT311.StrType)le.orgid);
    SELF.ultid_Invalid := Base_4010_Fields.InValid_ultid((SALT311.StrType)le.ultid);
    SELF.bdid_Invalid := Base_4010_Fields.InValid_bdid((SALT311.StrType)le.bdid);
    SELF.date_first_seen_Invalid := Base_4010_Fields.InValid_date_first_seen((SALT311.StrType)le.date_first_seen);
    SELF.date_last_seen_Invalid := Base_4010_Fields.InValid_date_last_seen((SALT311.StrType)le.date_last_seen);
    SELF.process_date_first_seen_Invalid := Base_4010_Fields.InValid_process_date_first_seen((SALT311.StrType)le.process_date_first_seen);
    SELF.process_date_last_seen_Invalid := Base_4010_Fields.InValid_process_date_last_seen((SALT311.StrType)le.process_date_last_seen);
    SELF.record_type_Invalid := Base_4010_Fields.InValid_record_type((SALT311.StrType)le.record_type);
    SELF.process_date_Invalid := Base_4010_Fields.InValid_process_date((SALT311.StrType)le.process_date);
    SELF.file_number_Invalid := Base_4010_Fields.InValid_file_number((SALT311.StrType)le.file_number);
    SELF.segment_code_Invalid := Base_4010_Fields.InValid_segment_code((SALT311.StrType)le.segment_code);
    SELF.sequence_number_Invalid := Base_4010_Fields.InValid_sequence_number((SALT311.StrType)le.sequence_number);
    SELF.orig_date_filed_yymmdd_Invalid := Base_4010_Fields.InValid_orig_date_filed_yymmdd((SALT311.StrType)le.orig_date_filed_yymmdd);
    SELF.type_code_Invalid := Base_4010_Fields.InValid_type_code((SALT311.StrType)le.type_code);
    SELF.type_desc_Invalid := Base_4010_Fields.InValid_type_desc((SALT311.StrType)le.type_desc);
    SELF.action_code_Invalid := Base_4010_Fields.InValid_action_code((SALT311.StrType)le.action_code);
    SELF.action_desc_Invalid := Base_4010_Fields.InValid_action_desc((SALT311.StrType)le.action_desc);
    SELF.document_number_Invalid := Base_4010_Fields.InValid_document_number((SALT311.StrType)le.document_number);
    SELF.liability_amt_Invalid := Base_4010_Fields.InValid_liability_amt((SALT311.StrType)le.liability_amt);
    SELF.asset_amt_Invalid := Base_4010_Fields.InValid_asset_amt((SALT311.StrType)le.asset_amt);
    SELF.date_filed_Invalid := Base_4010_Fields.InValid_date_filed((SALT311.StrType)le.date_filed);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Base_4010_Layout_EBR);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.powid_Invalid << 0 ) + ( le.proxid_Invalid << 1 ) + ( le.seleid_Invalid << 2 ) + ( le.orgid_Invalid << 3 ) + ( le.ultid_Invalid << 4 ) + ( le.bdid_Invalid << 5 ) + ( le.date_first_seen_Invalid << 6 ) + ( le.date_last_seen_Invalid << 7 ) + ( le.process_date_first_seen_Invalid << 8 ) + ( le.process_date_last_seen_Invalid << 9 ) + ( le.record_type_Invalid << 10 ) + ( le.process_date_Invalid << 11 ) + ( le.file_number_Invalid << 12 ) + ( le.segment_code_Invalid << 14 ) + ( le.sequence_number_Invalid << 15 ) + ( le.orig_date_filed_yymmdd_Invalid << 16 ) + ( le.type_code_Invalid << 17 ) + ( le.type_desc_Invalid << 18 ) + ( le.action_code_Invalid << 19 ) + ( le.action_desc_Invalid << 20 ) + ( le.document_number_Invalid << 21 ) + ( le.liability_amt_Invalid << 22 ) + ( le.asset_amt_Invalid << 23 ) + ( le.date_filed_Invalid << 24 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Base_4010_Layout_EBR);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.liability_amt_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.asset_amt_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.date_filed_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  SummaryStats0 xAddErrSummary(SummaryStats0 le) := TRANSFORM
    SELF.FieldsChecked_WithErrors := IF(le.powid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.proxid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.seleid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.orgid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.ultid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bdid_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.process_date_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.process_date_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.record_type_ENUM_ErrorCount > 0, 1, 0) + IF(le.process_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.file_number_Total_ErrorCount > 0, 1, 0) + IF(le.segment_code_ENUM_ErrorCount > 0, 1, 0) + IF(le.sequence_number_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.orig_date_filed_yymmdd_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.type_code_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.type_desc_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.action_code_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.action_desc_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.document_number_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.liability_amt_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.asset_amt_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_filed_CUSTOM_ErrorCount > 0, 1, 0);
    SELF.FieldsChecked_NoErrors := NumFieldsWithRules - SELF.FieldsChecked_WithErrors;
    SELF.Rules_WithErrors := IF(le.powid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.proxid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.seleid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.orgid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.ultid_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.bdid_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.process_date_first_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.process_date_last_seen_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.record_type_ENUM_ErrorCount > 0, 1, 0) + IF(le.process_date_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.file_number_ALLOW_ErrorCount > 0, 1, 0) + IF(le.file_number_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.segment_code_ENUM_ErrorCount > 0, 1, 0) + IF(le.sequence_number_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.orig_date_filed_yymmdd_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.type_code_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.type_desc_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.action_code_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.action_desc_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.document_number_LENGTHS_ErrorCount > 0, 1, 0) + IF(le.liability_amt_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.asset_amt_CUSTOM_ErrorCount > 0, 1, 0) + IF(le.date_filed_CUSTOM_ErrorCount > 0, 1, 0);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.powid_Invalid,le.proxid_Invalid,le.seleid_Invalid,le.orgid_Invalid,le.ultid_Invalid,le.bdid_Invalid,le.date_first_seen_Invalid,le.date_last_seen_Invalid,le.process_date_first_seen_Invalid,le.process_date_last_seen_Invalid,le.record_type_Invalid,le.process_date_Invalid,le.file_number_Invalid,le.segment_code_Invalid,le.sequence_number_Invalid,le.orig_date_filed_yymmdd_Invalid,le.type_code_Invalid,le.type_desc_Invalid,le.action_code_Invalid,le.action_desc_Invalid,le.document_number_Invalid,le.liability_amt_Invalid,le.asset_amt_Invalid,le.date_filed_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Base_4010_Fields.InvalidMessage_powid(le.powid_Invalid),Base_4010_Fields.InvalidMessage_proxid(le.proxid_Invalid),Base_4010_Fields.InvalidMessage_seleid(le.seleid_Invalid),Base_4010_Fields.InvalidMessage_orgid(le.orgid_Invalid),Base_4010_Fields.InvalidMessage_ultid(le.ultid_Invalid),Base_4010_Fields.InvalidMessage_bdid(le.bdid_Invalid),Base_4010_Fields.InvalidMessage_date_first_seen(le.date_first_seen_Invalid),Base_4010_Fields.InvalidMessage_date_last_seen(le.date_last_seen_Invalid),Base_4010_Fields.InvalidMessage_process_date_first_seen(le.process_date_first_seen_Invalid),Base_4010_Fields.InvalidMessage_process_date_last_seen(le.process_date_last_seen_Invalid),Base_4010_Fields.InvalidMessage_record_type(le.record_type_Invalid),Base_4010_Fields.InvalidMessage_process_date(le.process_date_Invalid),Base_4010_Fields.InvalidMessage_file_number(le.file_number_Invalid),Base_4010_Fields.InvalidMessage_segment_code(le.segment_code_Invalid),Base_4010_Fields.InvalidMessage_sequence_number(le.sequence_number_Invalid),Base_4010_Fields.InvalidMessage_orig_date_filed_yymmdd(le.orig_date_filed_yymmdd_Invalid),Base_4010_Fields.InvalidMessage_type_code(le.type_code_Invalid),Base_4010_Fields.InvalidMessage_type_desc(le.type_desc_Invalid),Base_4010_Fields.InvalidMessage_action_code(le.action_code_Invalid),Base_4010_Fields.InvalidMessage_action_desc(le.action_desc_Invalid),Base_4010_Fields.InvalidMessage_document_number(le.document_number_Invalid),Base_4010_Fields.InvalidMessage_liability_amt(le.liability_amt_Invalid),Base_4010_Fields.InvalidMessage_asset_amt(le.asset_amt_Invalid),Base_4010_Fields.InvalidMessage_date_filed(le.date_filed_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.type_code_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.type_desc_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.action_code_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.action_desc_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.document_number_Invalid,'LENGTHS','UNKNOWN')
          ,CHOOSE(le.liability_amt_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.asset_amt_Invalid,'CUSTOM','UNKNOWN')
          ,CHOOSE(le.date_filed_Invalid,'CUSTOM','UNKNOWN'),'UNKNOWN'));
    SELF.FieldName := CHOOSE(c,'powid','proxid','seleid','orgid','ultid','bdid','date_first_seen','date_last_seen','process_date_first_seen','process_date_last_seen','record_type','process_date','file_number','segment_code','sequence_number','orig_date_filed_yymmdd','type_code','type_desc','action_code','action_desc','document_number','liability_amt','asset_amt','date_filed','UNKNOWN');
    SELF.FieldType := CHOOSE(c,'invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_numeric','invalid_dt_first_seen','invalid_pastdate','invalid_pastdate','invalid_pastdate','invalid_record_type','invalid_pastdate','invalid_file_number','invalid_segment','invalid_numeric_or_allzeros','invalid_dt_yymmdd','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_numeric_or_allzeros','invalid_numeric_or_allzeros','invalid_pastdate','UNKNOWN');
    SELF.FieldContents := CHOOSE(c,(SALT311.StrType)le.powid,(SALT311.StrType)le.proxid,(SALT311.StrType)le.seleid,(SALT311.StrType)le.orgid,(SALT311.StrType)le.ultid,(SALT311.StrType)le.bdid,(SALT311.StrType)le.date_first_seen,(SALT311.StrType)le.date_last_seen,(SALT311.StrType)le.process_date_first_seen,(SALT311.StrType)le.process_date_last_seen,(SALT311.StrType)le.record_type,(SALT311.StrType)le.process_date,(SALT311.StrType)le.file_number,(SALT311.StrType)le.segment_code,(SALT311.StrType)le.sequence_number,(SALT311.StrType)le.orig_date_filed_yymmdd,(SALT311.StrType)le.type_code,(SALT311.StrType)le.type_desc,(SALT311.StrType)le.action_code,(SALT311.StrType)le.action_desc,(SALT311.StrType)le.document_number,(SALT311.StrType)le.liability_amt,(SALT311.StrType)le.asset_amt,(SALT311.StrType)le.date_filed,'***SALTBUG***');
  END;
  EXPORT AllErrors := NORMALIZE(h,24,Into(LEFT,COUNTER));
   bv := TABLE(AllErrors,{FieldContents, FieldName, Cnt := COUNT(GROUP)},FieldContents, FieldName,MERGE);
  EXPORT BadValues := TOPN(bv,1000,-Cnt);
  // Particular form of stats required for Orbit
  EXPORT OrbitStats(UNSIGNED examples = 10, UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(), DATASET(Base_4010_Layout_EBR) prevDS = DATASET([], Base_4010_Layout_EBR), STRING10 Src='UNK'):= FUNCTION
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'type_code:invalid_mandatory:LENGTHS'
          ,'type_desc:invalid_mandatory:LENGTHS'
          ,'action_code:invalid_mandatory:LENGTHS'
          ,'action_desc:invalid_mandatory:LENGTHS'
          ,'document_number:invalid_mandatory:LENGTHS'
          ,'liability_amt:invalid_numeric_or_allzeros:CUSTOM'
          ,'asset_amt:invalid_numeric_or_allzeros:CUSTOM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Base_4010_Fields.InvalidMessage_powid(1)
          ,Base_4010_Fields.InvalidMessage_proxid(1)
          ,Base_4010_Fields.InvalidMessage_seleid(1)
          ,Base_4010_Fields.InvalidMessage_orgid(1)
          ,Base_4010_Fields.InvalidMessage_ultid(1)
          ,Base_4010_Fields.InvalidMessage_bdid(1)
          ,Base_4010_Fields.InvalidMessage_date_first_seen(1)
          ,Base_4010_Fields.InvalidMessage_date_last_seen(1)
          ,Base_4010_Fields.InvalidMessage_process_date_first_seen(1)
          ,Base_4010_Fields.InvalidMessage_process_date_last_seen(1)
          ,Base_4010_Fields.InvalidMessage_record_type(1)
          ,Base_4010_Fields.InvalidMessage_process_date(1)
          ,Base_4010_Fields.InvalidMessage_file_number(1),Base_4010_Fields.InvalidMessage_file_number(2)
          ,Base_4010_Fields.InvalidMessage_segment_code(1)
          ,Base_4010_Fields.InvalidMessage_sequence_number(1)
          ,Base_4010_Fields.InvalidMessage_orig_date_filed_yymmdd(1)
          ,Base_4010_Fields.InvalidMessage_type_code(1)
          ,Base_4010_Fields.InvalidMessage_type_desc(1)
          ,Base_4010_Fields.InvalidMessage_action_code(1)
          ,Base_4010_Fields.InvalidMessage_action_desc(1)
          ,Base_4010_Fields.InvalidMessage_document_number(1)
          ,Base_4010_Fields.InvalidMessage_liability_amt(1)
          ,Base_4010_Fields.InvalidMessage_asset_amt(1)
          ,Base_4010_Fields.InvalidMessage_date_filed(1)
          ,'Fields with errors'
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.type_code_LENGTHS_ErrorCount
          ,le.type_desc_LENGTHS_ErrorCount
          ,le.action_code_LENGTHS_ErrorCount
          ,le.action_desc_LENGTHS_ErrorCount
          ,le.document_number_LENGTHS_ErrorCount
          ,le.liability_amt_CUSTOM_ErrorCount
          ,le.asset_amt_CUSTOM_ErrorCount
    ...
    mod_hygiene := Base_4010_hygiene(PROJECT(h, Base_4010_Layout_EBR));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'liability_amt:' + getFieldTypeText(h.liability_amt) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ,'asset_amt:' + getFieldTypeText(h.asset_amt) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_liability_amt_cnt
          ,le.populated_asset_amt_cnt
      ...
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_liability_amt_pcnt
          ,le.populated_asset_amt_pcnt
  ...
  // record count stats
    ...
    mod_Delta := Base_4010_Delta(prevDS, PROJECT(h, Base_4010_Layout_EBR));
...
EXPORT StandardStats(DATASET(Base_4010_Layout_EBR) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_EBR, Base_4010_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
