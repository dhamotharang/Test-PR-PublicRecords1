IMPORT SALT311,STD;
EXPORT Base_7010_hygiene(dataset(Base_7010_layout_EBR) h) := MODULE
...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_data_print_line_cnt := COUNT(GROUP,h.data_print_line <> (TYPEOF(h.data_print_line))'');
    populated_data_print_line_pcnt := AVE(GROUP,IF(h.data_print_line = (TYPEOF(h.data_print_line))'',0,100));
    maxlength_data_print_line := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.data_print_line)));
    avelength_data_print_line := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.data_print_line)),h.data_print_line<>(typeof(h.data_print_line))'');
  END;
    T := TABLE(h,SummaryLayout);
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_powid_pcnt *   0.00 / 100 + T.Populated_proxid_pcnt *   0.00 / 100 + T.Populated_seleid_pcnt *   0.00 / 100 + T.Populated_orgid_pcnt *   0.00 / 100 + T.Populated_ultid_pcnt *   0.00 / 100 + T.Populated_bdid_pcnt *   0.00 / 100 + T.Populated_date_first_seen_pcnt *   0.00 / 100 + T.Populated_date_last_seen_pcnt *   0.00 / 100 + T.Populated_process_date_first_seen_pcnt *   0.00 / 100 + T.Populated_process_date_last_seen_pcnt *   0.00 / 100 + T.Populated_record_type_pcnt *   0.00 / 100 + T.Populated_process_date_pcnt *   0.00 / 100 + T.Populated_file_number_pcnt *   0.00 / 100 + T.Populated_segment_code_pcnt *   0.00 / 100 + T.Populated_sequence_number_pcnt *   0.00 / 100 + T.Populated_data_print_line_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
SHARED FldIds := DATASET([{1,'powid'}
      ...
      ,{14,'segment_code'}
      ,{15,'sequence_number'}
      ,{16,'data_print_line'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Base_7010_Fields.InValid_powid((SALT311.StrType)le.powid),
    Base_7010_Fields.InValid_proxid((SALT311.StrType)le.proxid),
    Base_7010_Fields.InValid_seleid((SALT311.StrType)le.seleid),
    Base_7010_Fields.InValid_orgid((SALT311.StrType)le.orgid),
    Base_7010_Fields.InValid_ultid((SALT311.StrType)le.ultid),
    Base_7010_Fields.InValid_bdid((SALT311.StrType)le.bdid),
    Base_7010_Fields.InValid_date_first_seen((SALT311.StrType)le.date_first_seen),
    Base_7010_Fields.InValid_date_last_seen((SALT311.StrType)le.date_last_seen),
    Base_7010_Fields.InValid_process_date_first_seen((SALT311.StrType)le.process_date_first_seen),
    Base_7010_Fields.InValid_process_date_last_seen((SALT311.StrType)le.process_date_last_seen),
    Base_7010_Fields.InValid_record_type((SALT311.StrType)le.record_type),
    Base_7010_Fields.InValid_process_date((SALT311.StrType)le.process_date),
    Base_7010_Fields.InValid_file_number((SALT311.StrType)le.file_number),
    Base_7010_Fields.InValid_segment_code((SALT311.StrType)le.segment_code),
    Base_7010_Fields.InValid_sequence_number((SALT311.StrType)le.sequence_number),
    Base_7010_Fields.InValid_data_print_line((SALT311.StrType)le.data_print_line),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Base_7010_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_numeric','invalid_dt_first_seen','invalid_pastdate','invalid_pastdate','invalid_pastdate','invalid_record_type','invalid_pastdate','invalid_file_number','invalid_segment','invalid_numeric_or_allzeros','invalid_mandatory');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_7010_Fields.InValidMessage_powid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_date_first_seen(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_date_last_seen(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_process_date_first_seen(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_process_date_last_seen(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_record_type(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_file_number(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_segment_code(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_sequence_number(TotalErrors.ErrorNum),Base_7010_Fields.InValidMessage_data_print_line(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_EBR, Base_7010_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
