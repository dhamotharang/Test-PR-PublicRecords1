...
IMPORT SALT311;
EXPORT Base_6000_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Base_6000';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,powid,proxid,seleid,orgid,ultid,bdid,date_first_seen,date_last_seen,process_date_first_seen,process_date_last_seen,record_type,process_date,file_number,segment_code,sequence_number,bus_code,bus_desc,inq_mm,inq_yy,inq_count';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_segment:ENUM(6000|6000)\n'
    + 'FIELDTYPE:invalid_file_number:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(9)\n'
    + 'FIELDTYPE:invalid_month:ENUM(01|02|03|04|05|06|07|08|09|10|11|12)\n'
    + 'FIELDTYPE:invalid_year:CUSTOM(Scrubs_EBR.Functions.fn_dt_yy>0)\n'
    + '\n'
    + '//------------------------------------------------------\n'
    ...
    + 'FIELD:bus_code:TYPE(STRING4):LIKE(invalid_numeric_or_allzeros):0,0\n'
    + 'FIELD:bus_desc:TYPE(STRING10):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:inq_mm:TYPE(STRING2):LIKE(invalid_month):0,0\n'
    + 'FIELD:inq_yy:TYPE(STRING2):LIKE(invalid_year):0,0\n'
    + 'FIELD:inq_count:TYPE(STRING3):LIKE(invalid_numeric_or_allzeros):0,0\n'
