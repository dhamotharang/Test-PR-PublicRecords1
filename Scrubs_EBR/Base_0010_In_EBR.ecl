...
dBase := dataset(dl_or_prod + 'thor_data400::base::ebr_0010_header_aid',EBR.Layout_0010_Header_Base_AID,thor);
	
	// Transform to flatten the file due to nested fields in the Base layout
	Scrubs_EBR.Base_0010_Layout_EBR trf(EBR.Layout_0010_Header_Base_AID l):= transform
  ...
  EXPORT Base_0010_In_EBR := project(dBase, trf(left));
