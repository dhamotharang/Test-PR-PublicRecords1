...
IMPORT SALT311;
EXPORT Base_2020_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Base_2020';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_segment:ENUM(2020|2020)\n'
    ...
    + 'FIELD:trend_mm:TYPE(STRING2):LIKE(invalid_month):0,0\n'
    + 'FIELD:trend_yy:TYPE(STRING2):LIKE(invalid_numeric_or_allzeros):0,0\n'
    + 'FIELD:dbt:TYPE(STRING3):LIKE(invalid_numeric_or_allzeros):0,0\n'
    + 'FIELD:acct_bal_mask:TYPE(STRING1):LIKE(invalid_mask):0,0\n'
    + 'FIELD:acct_bal:TYPE(STRING8):LIKE(invalid_numeric_or_allzeros):0,0\n'
    + 'FIELD:current_balance_pct:TYPE(STRING3):LIKE(invalid_numeric_or_allzeros):0,0\n'
