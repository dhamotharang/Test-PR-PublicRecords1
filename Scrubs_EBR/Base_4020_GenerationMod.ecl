...
IMPORT SALT311;
EXPORT Base_4020_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Base_4020';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_segment:ENUM(4020|4020)\n'
    + 'FIELDTYPE:invalid_file_number:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(9)\n'
    + 'FIELDTYPE:invalid_type_code:ENUM(02|03|04)\n'
    + 'FIELDTYPE:invalid_type_desc:ENUM(FED-TX-|STAT-TX-|CNTY-TX-)\n'
    + 'FIELDTYPE:invalid_action_code:ENUM(06|07)\n'
    + 'FIELDTYPE:invalid_action_desc:ENUM(LN|REL)\n'
    + 'FIELDTYPE:invalid_tax_lien_code:CUSTOM(Scrubs_EBR.Functions.fn_valid_tax_lien_code>0)\n'
    + 'FIELDTYPE:invalid_tax_lien_desc:CUSTOM(Scrubs_EBR.Functions.fn_valid_tax_lien_desc>0)\n'
    + '\n'
    + '//------------------------------------------------------\n'
    ...
    + 'FIELD:tax_lien_code:TYPE(STRING1):LIKE(invalid_tax_lien_code):0,0\n'
    + 'FIELD:tax_lien_description:TYPE(STRING50):LIKE(invalid_tax_lien_desc):0,0\n'
