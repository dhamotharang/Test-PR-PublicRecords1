...
EXPORT MakeFT_invalid_segment(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_segment(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['4020','4020']);
EXPORT InValidMessageFT_invalid_segment(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('4020|4020'),SALT311.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_type_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['02','03','04']);
EXPORT InValidMessageFT_invalid_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('02|03|04'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_type_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_type_desc(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['FED-TX-','STAT-TX-','CNTY-TX-']);
EXPORT InValidMessageFT_invalid_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('FED-TX-|STAT-TX-|CNTY-TX-'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_action_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_action_code(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['06','07']);
EXPORT InValidMessageFT_invalid_action_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('06|07'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_action_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_action_desc(SALT311.StrType s) := WHICH(((SALT311.StrType) s) NOT IN ['LN','REL']);
EXPORT InValidMessageFT_invalid_action_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.NotInEnum('LN|REL'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_tax_lien_code(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_lien_code(SALT311.StrType s) := WHICH(~Scrubs_EBR.Functions.fn_valid_tax_lien_code(s)>0);
EXPORT InValidMessageFT_invalid_tax_lien_code(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_EBR.Functions.fn_valid_tax_lien_code'),SALT311.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_tax_lien_desc(SALT311.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_lien_desc(SALT311.StrType s) := WHICH(~Scrubs_EBR.Functions.fn_valid_tax_lien_desc(s)>0);
EXPORT InValidMessageFT_invalid_tax_lien_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT311.HygieneErrors.CustomFail('Scrubs_EBR.Functions.fn_valid_tax_lien_desc'),SALT311.HygieneErrors.Good);
 
EXPORT SALT311.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'powid','proxid','seleid','orgid','ultid','bdid','date_first_seen','date_last_seen','process_date_first_seen','process_date_last_seen','record_type','process_date','file_number','segment_code','sequence_number','orig_date_filed_ymd','type_code','type_description','action_code','action_description','document_number','filing_location','liability_amount','tax_lien_code','tax_lien_description','date_filed');
EXPORT SALT311.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'powid','proxid','seleid','orgid','ultid','bdid','date_first_seen','date_last_seen','process_date_first_seen','process_date_last_seen','record_type','process_date','file_number','segment_code','sequence_number','orig_date_filed_ymd','type_code','type_description','action_code','action_description','document_number','filing_location','liability_amount','tax_lien_code','tax_lien_description','date_filed');
EXPORT FieldNum(SALT311.StrType fn) := CASE(fn,'powid' => 0,'proxid' => 1,'seleid' => 2,'orgid' => 3,'ultid' => 4,'bdid' => 5,'date_first_seen' => 6,'date_last_seen' => 7,'process_date_first_seen' => 8,'process_date_last_seen' => 9,'record_type' => 10,'process_date' => 11,'file_number' => 12,'segment_code' => 13,'sequence_number' => 14,'orig_date_filed_ymd' => 15,'type_code' => 16,'type_description' => 17,'action_code' => 18,'action_description' => 19,'document_number' => 20,'filing_location' => 21,'liability_amount' => 22,'tax_lien_code' => 23,'tax_lien_description' => 24,'date_filed' => 25,0);
EXPORT SET OF SALT311.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['LENGTHS'],['LENGTHS'],['LENGTHS'],['LENGTHS'],['LENGTHS'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['ENUM'],['CUSTOM'],['ALLOW','LENGTHS'],['ENUM'],['CUSTOM'],['CUSTOM'],['ENUM'],['ENUM'],['ENUM'],['ENUM'],['LENGTHS'],['LENGTHS'],['CUSTOM'],['CUSTOM'],['CUSTOM'],['CUSTOM'],[]);
...
EXPORT Make_orig_date_filed_ymd(SALT311.StrType s0) := MakeFT_invalid_dt_yymmdd(s0);
EXPORT InValid_orig_date_filed_ymd(SALT311.StrType s) := InValidFT_invalid_dt_yymmdd(s);
EXPORT InValidMessage_orig_date_filed_ymd(UNSIGNED1 wh) := InValidMessageFT_invalid_dt_yymmdd(wh);
...
EXPORT Make_type_description(SALT311.StrType s0) := MakeFT_invalid_type_desc(s0);
EXPORT InValid_type_description(SALT311.StrType s) := InValidFT_invalid_type_desc(s);
EXPORT InValidMessage_type_description(UNSIGNED1 wh) := InValidMessageFT_invalid_type_desc(wh);
...
EXPORT Make_action_description(SALT311.StrType s0) := MakeFT_invalid_action_desc(s0);
EXPORT InValid_action_description(SALT311.StrType s) := InValidFT_invalid_action_desc(s);
EXPORT InValidMessage_action_description(UNSIGNED1 wh) := InValidMessageFT_invalid_action_desc(wh);
...
EXPORT Make_liability_amount(SALT311.StrType s0) := MakeFT_invalid_numeric_or_allzeros(s0);
EXPORT InValid_liability_amount(SALT311.StrType s) := InValidFT_invalid_numeric_or_allzeros(s);
EXPORT InValidMessage_liability_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_numeric_or_allzeros(wh);
 
EXPORT Make_tax_lien_code(SALT311.StrType s0) := MakeFT_invalid_tax_lien_code(s0);
EXPORT InValid_tax_lien_code(SALT311.StrType s) := InValidFT_invalid_tax_lien_code(s);
EXPORT InValidMessage_tax_lien_code(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_lien_code(wh);
 
EXPORT Make_tax_lien_description(SALT311.StrType s0) := MakeFT_invalid_tax_lien_desc(s0);
EXPORT InValid_tax_lien_description(SALT311.StrType s) := InValidFT_invalid_tax_lien_desc(s);
EXPORT InValidMessage_tax_lien_description(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_lien_desc(wh);
...
#uniquename(dl)
  %dl% := RECORD
    ...
    BOOLEAN Diff_orig_date_filed_ymd;
    BOOLEAN Diff_type_code;
    BOOLEAN Diff_type_description;
    BOOLEAN Diff_action_code;
    BOOLEAN Diff_action_description;
    BOOLEAN Diff_document_number;
    BOOLEAN Diff_filing_location;
    BOOLEAN Diff_liability_amount;
    BOOLEAN Diff_tax_lien_code;
    BOOLEAN Diff_tax_lien_description;
...
#uniquename(fd)
  %dl% %fd%(in_left le,in_right ri) := TRANSFORM
    ...
    SELF.Diff_orig_date_filed_ymd := le.orig_date_filed_ymd <> ri.orig_date_filed_ymd;
    SELF.Diff_type_code := le.type_code <> ri.type_code;
    SELF.Diff_type_description := le.type_description <> ri.type_description;
    SELF.Diff_action_code := le.action_code <> ri.action_code;
    SELF.Diff_action_description := le.action_description <> ri.action_description;
    ...
    SELF.Diff_liability_amount := le.liability_amount <> ri.liability_amount;
    SELF.Diff_tax_lien_code := le.tax_lien_code <> ri.tax_lien_code;
    SELF.Diff_tax_lien_description := le.tax_lien_description <> ri.tax_lien_description;
    SELF.Diff_date_filed := le.date_filed <> ri.date_filed;
    SELF.Val := (SALT311.StrType)evaluate(le,pivot_exp);
    SELF.Num_Diffs := 0+ IF( SELF.Diff_powid,1,0)+ IF( SELF.Diff_proxid,1,0)+ IF( SELF.Diff_seleid,1,0)+ IF( SELF.Diff_orgid,1,0)+ IF( SELF.Diff_ultid,1,0)+ IF( SELF.Diff_bdid,1,0)+ IF( SELF.Diff_date_first_seen,1,0)+ IF( SELF.Diff_date_last_seen,1,0)+ IF( SELF.Diff_process_date_first_seen,1,0)+ IF( SELF.Diff_process_date_last_seen,1,0)+ IF( SELF.Diff_record_type,1,0)+ IF( SELF.Diff_process_date,1,0)+ IF( SELF.Diff_file_number,1,0)+ IF( SELF.Diff_segment_code,1,0)+ IF( SELF.Diff_sequence_number,1,0)+ IF( SELF.Diff_orig_date_filed_ymd,1,0)+ IF( SELF.Diff_type_code,1,0)+ IF( SELF.Diff_type_description,1,0)+ IF( SELF.Diff_action_code,1,0)+ IF( SELF.Diff_action_description,1,0)+ IF( SELF.Diff_document_number,1,0)+ IF( SELF.Diff_filing_location,1,0)+ IF( SELF.Diff_liability_amount,1,0)+ IF( SELF.Diff_tax_lien_code,1,0)+ IF( SELF.Diff_tax_lien_description,1,0)+ IF( SELF.Diff_date_filed,1,0);
  END;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_orig_date_filed_ymd := COUNT(GROUP,%Closest%.Diff_orig_date_filed_ymd);
    Count_Diff_type_code := COUNT(GROUP,%Closest%.Diff_type_code);
    Count_Diff_type_description := COUNT(GROUP,%Closest%.Diff_type_description);
    Count_Diff_action_code := COUNT(GROUP,%Closest%.Diff_action_code);
    Count_Diff_action_description := COUNT(GROUP,%Closest%.Diff_action_description);
    ...
    Count_Diff_liability_amount := COUNT(GROUP,%Closest%.Diff_liability_amount);
    Count_Diff_tax_lien_code := COUNT(GROUP,%Closest%.Diff_tax_lien_code);
    Count_Diff_tax_lien_description := COUNT(GROUP,%Closest%.Diff_tax_lien_description);
