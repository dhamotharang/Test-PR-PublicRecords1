IMPORT SALT311,STD;
EXPORT Base_4010_hygiene(dataset(Base_4010_layout_EBR) h) := MODULE
...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_liability_amt_cnt := COUNT(GROUP,h.liability_amt <> (TYPEOF(h.liability_amt))'');
    populated_liability_amt_pcnt := AVE(GROUP,IF(h.liability_amt = (TYPEOF(h.liability_amt))'',0,100));
    maxlength_liability_amt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.liability_amt)));
    avelength_liability_amt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.liability_amt)),h.liability_amt<>(typeof(h.liability_amt))'');
    populated_asset_amt_cnt := COUNT(GROUP,h.asset_amt <> (TYPEOF(h.asset_amt))'');
    populated_asset_amt_pcnt := AVE(GROUP,IF(h.asset_amt = (TYPEOF(h.asset_amt))'',0,100));
    maxlength_asset_amt := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.asset_amt)));
    avelength_asset_amt := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.asset_amt)),h.asset_amt<>(typeof(h.asset_amt))'');
...
SHARED FldIds := DATASET([{1,'powid'}
      ...
      ,{22,'liability_amt'}
      ,{23,'asset_amt'}
      ,{24,'date_filed'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Base_4010_Fields.InValid_powid((SALT311.StrType)le.powid),
    Base_4010_Fields.InValid_proxid((SALT311.StrType)le.proxid),
    Base_4010_Fields.InValid_seleid((SALT311.StrType)le.seleid),
    Base_4010_Fields.InValid_orgid((SALT311.StrType)le.orgid),
    Base_4010_Fields.InValid_ultid((SALT311.StrType)le.ultid),
    Base_4010_Fields.InValid_bdid((SALT311.StrType)le.bdid),
    Base_4010_Fields.InValid_date_first_seen((SALT311.StrType)le.date_first_seen),
    Base_4010_Fields.InValid_date_last_seen((SALT311.StrType)le.date_last_seen),
    Base_4010_Fields.InValid_process_date_first_seen((SALT311.StrType)le.process_date_first_seen),
    Base_4010_Fields.InValid_process_date_last_seen((SALT311.StrType)le.process_date_last_seen),
    Base_4010_Fields.InValid_record_type((SALT311.StrType)le.record_type),
    Base_4010_Fields.InValid_process_date((SALT311.StrType)le.process_date),
    Base_4010_Fields.InValid_file_number((SALT311.StrType)le.file_number),
    Base_4010_Fields.InValid_segment_code((SALT311.StrType)le.segment_code),
    Base_4010_Fields.InValid_sequence_number((SALT311.StrType)le.sequence_number),
    Base_4010_Fields.InValid_orig_date_filed_yymmdd((SALT311.StrType)le.orig_date_filed_yymmdd),
    Base_4010_Fields.InValid_type_code((SALT311.StrType)le.type_code),
    Base_4010_Fields.InValid_type_desc((SALT311.StrType)le.type_desc),
    Base_4010_Fields.InValid_action_code((SALT311.StrType)le.action_code),
    Base_4010_Fields.InValid_action_desc((SALT311.StrType)le.action_desc),
    Base_4010_Fields.InValid_document_number((SALT311.StrType)le.document_number),
    Base_4010_Fields.InValid_liability_amt((SALT311.StrType)le.liability_amt),
    Base_4010_Fields.InValid_asset_amt((SALT311.StrType)le.asset_amt),
    Base_4010_Fields.InValid_date_filed((SALT311.StrType)le.date_filed),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Base_4010_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_numeric','invalid_dt_first_seen','invalid_pastdate','invalid_pastdate','invalid_pastdate','invalid_record_type','invalid_pastdate','invalid_file_number','invalid_segment','invalid_numeric_or_allzeros','invalid_dt_yymmdd','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_mandatory','invalid_numeric_or_allzeros','invalid_numeric_or_allzeros','invalid_pastdate');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_4010_Fields.InValidMessage_powid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_proxid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_seleid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_orgid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_ultid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_bdid(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_date_first_seen(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_date_last_seen(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_process_date_first_seen(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_process_date_last_seen(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_record_type(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_file_number(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_segment_code(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_sequence_number(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_orig_date_filed_yymmdd(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_type_code(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_type_desc(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_action_code(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_action_desc(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_document_number(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_liability_amt(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_asset_amt(TotalErrors.ErrorNum),Base_4010_Fields.InValidMessage_date_filed(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_EBR, Base_4010_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
