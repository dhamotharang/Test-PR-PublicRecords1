...
IMPORT SALT311;
EXPORT Base_4510_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Base_4510';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_segment:ENUM(4510|4510)\n'
    + 'FIELDTYPE:invalid_file_number:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(9)\n'
    + 'FIELDTYPE:invalid_type_code:ENUM(08|08)\n'
    + 'FIELDTYPE:invalid_type_desc:ENUM(UCC-|UCC-)\n'
    + 'FIELDTYPE:invalid_action_code:CUSTOM(Scrubs_EBR.Functions.fn_valid_action_code>0)\n'
    + 'FIELDTYPE:invalid_action_desc:CUSTOM(Scrubs_EBR.Functions.fn_valid_action_desc>0)\n'
    + 'FIELDTYPE:invalid_coll_code:CUSTOM(Scrubs_EBR.Functions.fn_valid_4510_coll_code>0)\n'
    + 'FIELDTYPE:invalid_coll_desc:CUSTOM(Scrubs_EBR.Functions.fn_valid_4510_coll_desc>0)\n'
    ...
    + 'FIELD:type_code:TYPE(STRING2):LIKE(invalid_type_code):0,0\n'
    + 'FIELD:type_desc:TYPE(STRING10):LIKE(invalid_type_desc):0,0\n'
    ...
    + '// FIELD:addtnl_coll_codes:TYPE(STRING7):0,0\n'
    + '// FIELD:secured_party:TYPE(STRING60):0,0\n'
    + '// FIELD:assignee:TYPE(STRING60):0,0\n'
    + 'FIELD:orig_file_state_code:TYPE(STRING2):LIKE(invalid_state):0,0\n'
    + 'FIELD:orig_file_state_desc:TYPE(STRING20):LIKE(invalid_state_desc):0,0\n'
    + 'FIELD:orig_file_number:TYPE(STRING16):LIKE(invalid_mandatory):0,0\n'
