...
EXPORT Base_4030_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(Base_4030_Layout_EBR)
    ...
    UNSIGNED1 plaintiff_name_Invalid;
    UNSIGNED1 date_filed_Invalid;
  END;
  EXPORT  Bitmap_Layout := RECORD(Base_4030_Layout_EBR)
    UNSIGNED8 ScrubsBits1;
  END;
EXPORT FromNone(DATASET(Base_4030_Layout_EBR) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.powid_Invalid := Base_4030_Fields.InValid_powid((SALT311.StrType)le.powid);
    SELF.proxid_Invalid := Base_4030_Fields.InValid_proxid((SALT311.StrType)le.proxid);
    SELF.seleid_Invalid := Base_4030_Fields.InValid_seleid((SALT311.StrType)le.seleid);
    SELF.orgid_Invalid := Base_4030_Fields.InValid_orgid((SALT311.StrType)le.orgid);
    SELF.ultid_Invalid := Base_4030_Fields.InValid_ultid((SALT311.StrType)le.ultid);
    SELF.bdid_Invalid := Base_4030_Fields.InValid_bdid((SALT311.StrType)le.bdid);
    SELF.date_first_seen_Invalid := Base_4030_Fields.InValid_date_first_seen((SALT311.StrType)le.date_first_seen);
    SELF.date_last_seen_Invalid := Base_4030_Fields.InValid_date_last_seen((SALT311.StrType)le.date_last_seen);
    SELF.process_date_first_seen_Invalid := Base_4030_Fields.InValid_process_date_first_seen((SALT311.StrType)le.process_date_first_seen);
    SELF.process_date_last_seen_Invalid := Base_4030_Fields.InValid_process_date_last_seen((SALT311.StrType)le.process_date_last_seen);
    SELF.record_type_Invalid := Base_4030_Fields.InValid_record_type((SALT311.StrType)le.record_type);
    SELF.process_date_Invalid := Base_4030_Fields.InValid_process_date((SALT311.StrType)le.process_date);
    SELF.file_number_Invalid := Base_4030_Fields.InValid_file_number((SALT311.StrType)le.file_number);
    SELF.segment_code_Invalid := Base_4030_Fields.InValid_segment_code((SALT311.StrType)le.segment_code);
    SELF.sequence_number_Invalid := Base_4030_Fields.InValid_sequence_number((SALT311.StrType)le.sequence_number);
    SELF.orig_date_filed_ymd_Invalid := Base_4030_Fields.InValid_orig_date_filed_ymd((SALT311.StrType)le.orig_date_filed_ymd);
    SELF.type_code_Invalid := Base_4030_Fields.InValid_type_code((SALT311.StrType)le.type_code);
    SELF.type_description_Invalid := Base_4030_Fields.InValid_type_description((SALT311.StrType)le.type_description);
    SELF.action_code_Invalid := Base_4030_Fields.InValid_action_code((SALT311.StrType)le.action_code);
    SELF.action_description_Invalid := Base_4030_Fields.InValid_action_description((SALT311.StrType)le.action_description);
    SELF.document_number_Invalid := Base_4030_Fields.InValid_document_number((SALT311.StrType)le.document_number);
    SELF.filing_location_Invalid := Base_4030_Fields.InValid_filing_location((SALT311.StrType)le.filing_location);
    SELF.liability_amount_Invalid := Base_4030_Fields.InValid_liability_amount((SALT311.StrType)le.liability_amount);
    SELF.plaintiff_name_Invalid := Base_4030_Fields.InValid_plaintiff_name((SALT311.StrType)le.plaintiff_name);
    SELF.date_filed_Invalid := Base_4030_Fields.InValid_date_filed((SALT311.StrType)le.date_filed);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Base_4030_Layout_EBR);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.powid_Invalid << 0 ) + ( le.proxid_Invalid << 1 ) + ( le.seleid_Invalid << 2 ) + ( le.orgid_Invalid << 3 ) + ( le.ultid_Invalid << 4 ) + ( le.bdid_Invalid << 5 ) + ( le.date_first_seen_Invalid << 6 ) + ( le.date_last_seen_Invalid << 7 ) + ( le.process_date_first_seen_Invalid << 8 ) + ( le.process_date_last_seen_Invalid << 9 ) + ( le.record_type_Invalid << 10 ) + ( le.process_date_Invalid << 11 ) + ( le.file_number_Invalid << 12 ) + ( le.segment_code_Invalid << 14 ) + ( le.sequence_number_Invalid << 15 ) + ( le.orig_date_filed_ymd_Invalid << 16 ) + ( le.type_code_Invalid << 17 ) + ( le.type_description_Invalid << 18 ) + ( le.action_code_Invalid << 19 ) + ( le.action_description_Invalid << 20 ) + ( le.document_number_Invalid << 21 ) + ( le.filing_location_Invalid << 22 ) + ( le.liability_amount_Invalid << 23 ) + ( le.plaintiff_name_Invalid << 24 ) + ( le.date_filed_Invalid << 25 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,Base_4030_Layout_EBR);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.plaintiff_name_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.date_filed_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.powid_Invalid,le.proxid_Invalid,le.seleid_Invalid,le.orgid_Invalid,le.ultid_Invalid,le.bdid_Invalid,le.date_first_seen_Invalid,le.date_last_seen_Invalid,le.process_date_first_seen_Invalid,le.process_date_last_seen_Invalid,le.record_type_Invalid,le.process_date_Invalid,le.file_number_Invalid,le.segment_code_Invalid,le.sequence_number_Invalid,le.orig_date_filed_ymd_Invalid,le.type_code_Invalid,le.type_description_Invalid,le.action_code_Invalid,le.action_description_Invalid,le.document_number_Invalid,le.filing_location_Invalid,le.liability_amount_Invalid,le.plaintiff_name_Invalid,le.date_filed_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,Base_4030_Fields.InvalidMessage_powid(le.powid_Invalid),Base_4030_Fields.InvalidMessage_proxid(le.proxid_Invalid),Base_4030_Fields.InvalidMessage_seleid(le.seleid_Invalid),Base_4030_Fields.InvalidMessage_orgid(le.orgid_Invalid),Base_4030_Fields.InvalidMessage_ultid(le.ultid_Invalid),Base_4030_Fields.InvalidMessage_bdid(le.bdid_Invalid),Base_4030_Fields.InvalidMessage_date_first_seen(le.date_first_seen_Invalid),Base_4030_Fields.InvalidMessage_date_last_seen(le.date_last_seen_Invalid),Base_4030_Fields.InvalidMessage_process_date_first_seen(le.process_date_first_seen_Invalid),Base_4030_Fields.InvalidMessage_process_date_last_seen(le.process_date_last_seen_Invalid),Base_4030_Fields.InvalidMessage_record_type(le.record_type_Invalid),Base_4030_Fields.InvalidMessage_process_date(le.process_date_Invalid),Base_4030_Fields.InvalidMessage_file_number(le.file_number_Invalid),Base_4030_Fields.InvalidMessage_segment_code(le.segment_code_Invalid),Base_4030_Fields.InvalidMessage_sequence_number(le.sequence_number_Invalid),Base_4030_Fields.InvalidMessage_orig_date_filed_ymd(le.orig_date_filed_ymd_Invalid),Base_4030_Fields.InvalidMessage_type_code(le.type_code_Invalid),Base_4030_Fields.InvalidMessage_type_description(le.type_description_Invalid),Base_4030_Fields.InvalidMessage_action_code(le.action_code_Invalid),Base_4030_Fields.InvalidMessage_action_description(le.action_description_Invalid),Base_4030_Fields.InvalidMessage_document_number(le.document_number_Invalid),Base_4030_Fields.InvalidMessage_filing_location(le.filing_location_Invalid),Base_4030_Fields.InvalidMessage_liability_amount(le.liability_amount_Invalid),Base_4030_Fields.InvalidMessage_plaintiff_name(le.plaintiff_name_Invalid),Base_4030_Fields.InvalidMessage_date_filed(le.date_filed_Invalid),'UNKNOWN'));
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.plaintiff_name_Invalid,'LENGTHS','UNKNOWN')
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'plaintiff_name:invalid_mandatory:LENGTHS'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ,Base_4030_Fields.InvalidMessage_powid(1)
          ,Base_4030_Fields.InvalidMessage_proxid(1)
          ,Base_4030_Fields.InvalidMessage_seleid(1)
          ,Base_4030_Fields.InvalidMessage_orgid(1)
          ,Base_4030_Fields.InvalidMessage_ultid(1)
          ,Base_4030_Fields.InvalidMessage_bdid(1)
          ,Base_4030_Fields.InvalidMessage_date_first_seen(1)
          ,Base_4030_Fields.InvalidMessage_date_last_seen(1)
          ,Base_4030_Fields.InvalidMessage_process_date_first_seen(1)
          ,Base_4030_Fields.InvalidMessage_process_date_last_seen(1)
          ,Base_4030_Fields.InvalidMessage_record_type(1)
          ,Base_4030_Fields.InvalidMessage_process_date(1)
          ,Base_4030_Fields.InvalidMessage_file_number(1),Base_4030_Fields.InvalidMessage_file_number(2)
          ,Base_4030_Fields.InvalidMessage_segment_code(1)
          ,Base_4030_Fields.InvalidMessage_sequence_number(1)
          ,Base_4030_Fields.InvalidMessage_orig_date_filed_ymd(1)
          ,Base_4030_Fields.InvalidMessage_type_code(1)
          ,Base_4030_Fields.InvalidMessage_type_description(1)
          ,Base_4030_Fields.InvalidMessage_action_code(1)
          ,Base_4030_Fields.InvalidMessage_action_description(1)
          ,Base_4030_Fields.InvalidMessage_document_number(1)
          ,Base_4030_Fields.InvalidMessage_filing_location(1)
          ,Base_4030_Fields.InvalidMessage_liability_amount(1)
          ,Base_4030_Fields.InvalidMessage_plaintiff_name(1)
          ,Base_4030_Fields.InvalidMessage_date_filed(1)
          ,'Fields with errors'
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.plaintiff_name_LENGTHS_ErrorCount
    ...
    mod_hygiene := Base_4030_hygiene(PROJECT(h, Base_4030_Layout_EBR));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'plaintiff_name:' + getFieldTypeText(h.plaintiff_name) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_plaintiff_name_cnt
      ...
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_plaintiff_name_pcnt
  ...
  // record count stats
    ...
    mod_Delta := Base_4030_Delta(prevDS, PROJECT(h, Base_4030_Layout_EBR));
...
EXPORT StandardStats(DATASET(Base_4030_Layout_EBR) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_EBR, Base_4030_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
