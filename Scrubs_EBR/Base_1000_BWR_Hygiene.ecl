...
#workunit('name','Scrubs_EBR.Base_1000_BWR_Hygiene - Hygiene & Stats - SALT V3.11.4');
IMPORT Scrubs_EBR,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_EBR.Base_1000_In_EBR;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_EBR.Base_1000_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Base_1000_Layout_EBR'),NAMED('OptimizedLayout'));// File layout suggested by data
