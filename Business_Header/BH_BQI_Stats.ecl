...
// Add best address
Layout_BQI_Stats AddBestAddress(bs_all l, bb r) := transform
self.zip := r.zip;
...
Layout_BQI_Stats CombineStats(Layout_BQI_Stats l, layout_full_stat r) := transform
...
Layout_BQI_Stats ScoreAddr(Layout_BQI_Stats l) := TRANSFORM
