...
//MAC_CountSubFiles('~thor_data400::BASE::Business_Relatives', count(Business_Header.File_Business_Relatives), m10);
//MAC_CountSubFiles('~thor_data400::BASE::Business_Relatives_Group', count(Business_Header.File_Business_Relatives_Group), m11);
...
mysuperfiles := m1 + m2 + m3 + m4 + m5 + /* m6 + */ m7 +  m8 + m9 + /* m10 + m11 + */ m12 + m13 + m14 + m15 + m16 + m17;
