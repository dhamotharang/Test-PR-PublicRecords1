import prte_csv,Risk_Indicators;

laypl	:= PRTE_CSV.Business_Header.rthor_data400__key__business_header__search__bdid_pl;
dpl2	:= PRTE_CSV.Business_Header.dthor_data400__key__business_header__search__bdid_pl;

export prct_bdid_sic(
