import address, ut;
export fRecleanBusinessHeaders(dataset(Business_Header.Layout_Business_Header_Base) pInput) :=
function
	...
	layout_clean tparseAddressLines(Business_Header.Layout_Business_Header_Base l) :=
	transform
		self.address_line_1 := 
...
*/
	Business_Header.Layout_Business_Header_Base tBreakOutCleanedAddress(layout_clean l) :=
	transform
