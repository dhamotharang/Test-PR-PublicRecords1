...
module
	...
	export BuildSuccess := if(Flags.IsTesting, _Control.MyInfo.EmailAddressNotify, _Control.MyInfo.EmailAddressNotify + ';lbentley@seisint.com;jtolbert@seisint.com;GIRI.RAJULAPALLI@lexisnexis.com;Christopher.Brodeur@lexisnexisrisk.com');
