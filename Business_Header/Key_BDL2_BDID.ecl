...
export Key_BDL2_BDID := index(in_base_ded, {bdid}, {bdl}, data_services.data_location.prefix() + 'thor_data400::key::business_header.bdl2_bdid_' + business_header_ss.key_version);