...
import STD;
  ...
  shared doxie_build_file_fcra_header_building := 
    dataset('~ thor_data400::base::file_fcra_header_building_20180221',{doxie_build.file_fcra_header_building},thor);
  shared doxie_build_file_header_building := 
    dataset('~ thor_data400::base::file_header_building_20180221',{doxie_build.file_header_building},thor);
