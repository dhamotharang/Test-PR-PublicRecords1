...
Command line options: -MScrubs_Corp2_Mapping_IL_Main -eC:\Users\butlersx\AppData\Local\Temp\TFRF0E0.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IL_Main
FILENAME:In_IL
...
FIELDTYPE:invalid_corp_key:ALLOW(-C0123456789):LENGTHS(4..)
...
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_ln_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_corp_types:CUSTOM(Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_corp_types>0,recordorigin)
FIELDTYPE:invalid_orig_org_structure_desc:CUSTOM(Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_org_structure_desc>0,recordorigin)
FIELDTYPE:invalid_orig_bus_type_desc:CUSTOM(Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_bus_type_desc>0,recordorigin)
...
FIELD:corp_status_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_orig_org_structure_desc):0,0
...
FIELD:corp_orig_bus_type_desc:TYPE(STRING350):LIKE(invalid_orig_bus_type_desc):0,0
...
FIELD:corp_merger_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
...
FIELD:internalfield1:TYPE(STRING100):LIKE(invalid_corp_types):0,0
