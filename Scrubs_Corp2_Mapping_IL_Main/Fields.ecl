IMPORT ut,SALT34;
IMPORT Scrubs,Scrubs_Corp2_Mapping_IL_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_supp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_charter_nbr','invalid_ln_name_type_cd','invalid_ln_name_type_desc','invalid_corp_types','invalid_orig_org_structure_desc','invalid_orig_bus_type_desc','invalid_term_exist_cd','invalid_term_exist_desc','invalid_for_dom_ind','invalid_for_profit_ind','invalid_recordorigin','invalid_alphablankperiod','invalid_alphablank','invalid_alphadashblank','invalid_numeric','invalid_numblank');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_supp_key' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_charter_nbr' => 8,'invalid_ln_name_type_cd' => 9,'invalid_ln_name_type_desc' => 10,'invalid_corp_types' => 11,'invalid_orig_org_structure_desc' => 12,'invalid_orig_bus_type_desc' => 13,'invalid_term_exist_cd' => 14,'invalid_term_exist_desc' => 15,'invalid_for_dom_ind' => 16,'invalid_for_profit_ind' => 17,'invalid_recordorigin' => 18,'invalid_alphablankperiod' => 19,'invalid_alphablank' => 20,'invalid_alphadashblank' => 21,'invalid_numeric' => 22,'invalid_numblank' => 23,0);
 
EXPORT MakeFT_invalid_corp_key(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'-C0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'-C0123456789'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('-C0123456789'),SALT34.HygieneErrors.NotLength('4..'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_ln_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_cd(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_cd'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_ln_name_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_types(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_types(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_corp_types(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_corp_types(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_corp_types'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_org_structure_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_org_structure_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_org_structure_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_orig_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_org_structure_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_bus_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_bus_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_bus_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_orig_bus_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_IL_Main.Functions.invalid_orig_bus_type_desc'),SALT34.HygieneErrors.Good);
...
EXPORT Make_corp_status_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_status_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_status_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
EXPORT Make_corp_orig_bus_type_desc(SALT34.StrType s0) := MakeFT_invalid_orig_bus_type_desc(s0);
EXPORT InValid_corp_orig_bus_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_orig_bus_type_desc(s,recordorigin);
EXPORT InValidMessage_corp_orig_bus_type_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_orig_bus_type_desc(wh);
...
EXPORT Make_corp_merger_date(SALT34.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_merger_date(SALT34.StrType s) := InValidFT_invalid_future_date(s);
EXPORT InValidMessage_corp_merger_date(UNSIGNED1 wh) := InValidMessageFT_invalid_future_date(wh);
...
EXPORT Make_internalfield1(SALT34.StrType s0) := MakeFT_invalid_corp_types(s0);
EXPORT InValid_internalfield1(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_corp_types(s,recordorigin);
EXPORT InValidMessage_internalfield1(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_types(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_IL_Main;
