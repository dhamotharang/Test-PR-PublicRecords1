...
EXPORT Layouts := MODULE
 ...
 END;
	...
	EXPORT Sanction_Lookup_REC := RECORD
		UNSIGNED8	LNPID;
		STRING40	GroupKey;
		UNSIGNED6	SANC_ID;
		STRING		SRC;
  ...
  unsigned2 ultweight;
  unsigned8 lnpid;
  string clean_birthdate;
  string clean_lic1_begin_date;
  string clean_lic1_end_date;
  string clean_lic2_begin_date;
  string clean_lic2_end_date;
  string clean_lic3_begin_date;
  string clean_lic3_end_date;
  string clean_sanc1_date;
  string clean_date_of_death;
  string clean_last_update_date;
  string clean_abms_start_eff_date;
  string clean_abms_end_eff_date;
  string clean_dea_num1_deact_date;
  string clean_npi_deact_date;
  string clean_sanc1_rein_date;
  string clean_dea_num1_exp;
 END;
 
 EXPORT MPRD_FAC_REC := RECORD
	string38 group_key;
 ...
 END;
	...
	EXPORT underlink_rec := record
		unsigned8 LNPID;
		unsigned8 UnderLinkID;
	end;

	EXPORT watchdog_addr_rec := record	
		UNSIGNED8 DID;
		STRING9 SSN;
		UNSIGNED4 DOB;
		STRING1 VALID_SSN;
	...
	EXPORT Best_Data_Input := RECORD
		...
		STRING2   ST;
		STRING5   ZIP;
		STRING25	PROV_LIC_NBR;
		STRING2		PROV_LIC_STATE;
		STRING10	PROV_NPI_NUMBER;
		STRING10	PROV_DEA_NUMBER;
	END;
	...
	EXPORT Enclarity_Sanction_Code_Rec := RECORD
		string10 sanc_code;
		string100 sanc_desc;
		string2 src;
		unsigned4 dt_vendor_first_reported;
	...
	EXPORT Enclarity_Prov_Type_Rec := RECORD
	...
	EXPORT Layout_Sanctions := RECORD
		...
		boolean isreinstatement;
	END;

	EXPORT Sanction_Details := RECORD
	...
	EXPORT Sanction_Combined := RECORD
		Sanction_Input;
		Sanction_Details;
	END;
END;