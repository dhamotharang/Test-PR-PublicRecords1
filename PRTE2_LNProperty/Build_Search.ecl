...
self.name := choose(cnt, L.name1, L.name1, L.name1, L.name1, L.name2,L.name2,L.name2,L.name2);
...
self.nameasis := choose(cnt,L.name1,L.name1,L.name1, L.name1,
                            L.name2,L.name2,L.name2,L.name2);
