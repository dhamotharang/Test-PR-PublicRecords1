EXPORT macAppendPersonBestInfo(dIn, inLexid, inGlb, inDrm,
  ...
  IMPORT AppendPersonBestInfo, doxie, ut, ecl, Suppress;
  ...
  LOCAL dWatchdogNonGlbNonBlankV2 := ecl.macJoinKey(dupLexid, AppendPersonBestInfo.Keys.WatchdogNonGlbNonBlankV2Key,
    'KEYED((UNSIGNED)LEFT._searchDid=RIGHT.did)',
    'LEFT.did = (UNSIGNED)RIGHT._searchDid',
    UseIndexThreshold,,TRUE,1,,,,TRUE);
  LOCAL dWatchdogNonGlbNonBlank := ecl.macJoinKey(dupLexid, AppendPersonBestInfo.Keys.WatchdogNonGlbNonBlankKey,
    'KEYED((UNSIGNED)LEFT._searchDid=RIGHT.did)',
    'LEFT.did = (UNSIGNED)RIGHT._searchDid',
    UseIndexThreshold,,TRUE,1,,,,TRUE);
  LOCAL dWatchdogNonGlbV2 := ecl.macJoinKey(dupLexid, AppendPersonBestInfo.Keys.WatchdogNonGlbV2Key,
    'KEYED((UNSIGNED)LEFT._searchDid=RIGHT.did)',
    'LEFT.did = (UNSIGNED)RIGHT._searchDid',
    UseIndexThreshold,,TRUE,1,,,,TRUE);
  LOCAL dWatchdogNonGlb := ecl.macJoinKey(dupLexid, AppendPersonBestInfo.Keys.WatchdogNonGlbKey,
    'KEYED((UNSIGNED)LEFT._searchDid=RIGHT.did)',
    'LEFT.did = (UNSIGNED)RIGHT._searchDid',
    UseIndexThreshold,,TRUE,1,,,,TRUE);
  ...
  LOCAL dWatchdogNoMinors := JOIN(dWatchdog, AppendPersonBestInfo.Keys.MinorsHashKey, 
