...
#workunit('name','OPM.BWR_Ingest - Ingest - SALT V3.11.7');
IMPORT OPM,SALT311;
//If you are not ingesting as part of a header build you can use the below;
//Set incremental to TRUE to run an incremental ingest mode
MyDelta := DATASET([],OPM.Layout_Base);
ingestMod := OPM.Ingest(FALSE, MyDelta);
f_AllRecords := '~temp::record_sid::OPM::ingest::AllRecords';
f_ActiveRecords := '~temp::record_sid::OPM::ingest::ActiveRecords';
