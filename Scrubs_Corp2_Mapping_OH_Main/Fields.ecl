IMPORT ut,SALT34;
IMPORT Scrubs_Corp2_Mapping_OH_Main,Scrubs; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_flag_code','invalid_foreign_domestic_ind','invalid_numeric','invalid_alphablank','invalid_trademark_class','invalid_forgn_state_desc','invalid_recordorigin','invalid_status_code','invalid_agent_status_cd','invalid_license_type','invalid_name_type_cd','invalid_org_structure_cd');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_flag_code' => 8,'invalid_foreign_domestic_ind' => 9,'invalid_numeric' => 10,'invalid_alphablank' => 11,'invalid_trademark_class' => 12,'invalid_forgn_state_desc' => 13,'invalid_recordorigin' => 14,'invalid_status_code' => 15,'invalid_agent_status_cd' => 16,'invalid_license_type' => 17,'invalid_name_type_cd' => 18,'invalid_org_structure_cd' => 19,0);
...
EXPORT MakeFT_invalid_corp_key(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\',*\\&.!'))),~Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey(s)>0,~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\',*\\&.!'),SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey'),SALT34.HygieneErrors.NotLength('4..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter_nbr(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\',*\\&.!'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\',*\\&.!'))),~Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey(s)>0,~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -\',*\\&.!'),SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey'),SALT34.HygieneErrors.NotLength('1..'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['39']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('39'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['OH']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('OH'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_foreign_domestic_ind(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_foreign_domestic_ind(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['D','F',' ']);
EXPORT InValidMessageFT_invalid_foreign_domestic_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('D|F| '),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_trademark_class(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_trademark_class(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_trademark_class(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' -ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_code(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['A','C','D','H',' ']);
EXPORT InValidMessageFT_invalid_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('A|C|D|H| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_agent_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_agent_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['A','I',' ']);
EXPORT InValidMessageFT_invalid_agent_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('A|I| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_license_type(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_license_type(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['P','T',' ']);
EXPORT InValidMessageFT_invalid_license_type(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('P|T| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_cd(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_OH_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_OH_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_structure_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_structure_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_OH_Main.Functions.set_org_structure_cd);
EXPORT InValidMessageFT_invalid_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_OH_Main.Functions.set_org_structure_cd'),SALT34.HygieneErrors.Good);
...
EXPORT InValid_corp_ln_name_type_desc(SALT34.StrType s) := FALSE;
...
EXPORT Make_corp_status_cd(SALT34.StrType s0) := MakeFT_invalid_status_code(s0);
EXPORT InValid_corp_status_cd(SALT34.StrType s) := InValidFT_invalid_status_code(s);
EXPORT InValidMessage_corp_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_status_code(wh);
...
EXPORT Make_corp_term_exist_exp(SALT34.StrType s0) := MakeFT_invalid_numeric(s0);
EXPORT InValid_corp_term_exist_exp(SALT34.StrType s) := InValidFT_invalid_numeric(s);
...
EXPORT Make_corp_foreign_domestic_ind(SALT34.StrType s0) := MakeFT_invalid_foreign_domestic_ind(s0);
EXPORT InValid_corp_foreign_domestic_ind(SALT34.StrType s) := InValidFT_invalid_foreign_domestic_ind(s);
...
EXPORT Make_corp_agent_status_cd(SALT34.StrType s0) := MakeFT_invalid_agent_status_cd(s0);
EXPORT InValid_corp_agent_status_cd(SALT34.StrType s) := InValidFT_invalid_agent_status_cd(s);
EXPORT InValidMessage_corp_agent_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_agent_status_cd(wh);
...
EXPORT Make_corp_consent_flag_for_protected_name(SALT34.StrType s0) := MakeFT_invalid_flag_code(s0);
EXPORT InValid_corp_consent_flag_for_protected_name(SALT34.StrType s) := InValidFT_invalid_flag_code(s);
EXPORT InValidMessage_corp_consent_flag_for_protected_name(UNSIGNED1 wh) := InValidMessageFT_invalid_flag_code(wh);
...
EXPORT Make_corp_license_type(SALT34.StrType s0) := MakeFT_invalid_license_type(s0);
EXPORT InValid_corp_license_type(SALT34.StrType s) := InValidFT_invalid_license_type(s);
EXPORT InValidMessage_corp_license_type(UNSIGNED1 wh) := InValidMessageFT_invalid_license_type(wh);
...
EXPORT Make_corp_trademark_class_desc1(SALT34.StrType s0) := MakeFT_invalid_trademark_class(s0);
EXPORT InValid_corp_trademark_class_desc1(SALT34.StrType s) := InValidFT_invalid_trademark_class(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_OH_Main;
