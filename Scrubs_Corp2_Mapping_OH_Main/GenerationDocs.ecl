...
Command line options: -MScrubs_Corp2_Mapping_OH_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR5581.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_OH_Main
FILENAME:in_file
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -',*\&.!):LENGTHS(4..):CUSTOM(Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey > 0)
FIELDTYPE:invalid_charter_nbr:ALLOW(0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -',*\&.!):LENGTHS(1..):CUSTOM(Scrubs_Corp2_Mapping_OH_Main.Functions.fGetValidKey > 0)
FIELDTYPE:invalid_corp_vendor:ENUM(39)
FIELDTYPE:invalid_state_origin:ENUM(OH)
...
FIELDTYPE:invalid_trademark_class:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_forgn_state_desc:ALLOW( /.,&ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_status_code:ENUM(A|C|D|H| )
FIELDTYPE:invalid_agent_status_cd:ENUM(A|I| )
FIELDTYPE:invalid_license_type:ENUM(P|T| )
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_OH_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_OH_Main.Functions.set_org_structure_cd)
...
FIELD:corp_status_cd:TYPE(STRING8):LIKE(invalid_status_code):0,0
...
FIELD:corp_agent_status_cd:TYPE(STRING5):LIKE(invalid_agent_status_cd):0,0
...
FIELD:corp_consent_flag_for_protected_name:TYPE(STRING1):LIKE(invalid_flag_code):0,0
...
FIELD:corp_license_type:TYPE(STRING1):LIKE(invalid_license_type):0,0
...
FIELD:corp_trademark_class_desc1:TYPE(STRING250):LIKE(invalid_trademark_class):0,0
