export vehicle_coverage() := function
...
/////////////////////////	step	1	SELECT collumns
	...
	/////////////////////////	step	2	COUNT vehicles per state
	 ...
	 // ds_vehicle_cnt:=table(ds_dates, r_vehicle_cnt
						 ...
						 // ,Source_Code
						 // ,local)
						 // : persist('~thor_data400::persist::jbello_Reg_DATES_cnt')
						// ;
	...
	ds_vehicle_cnt := dataset('~thor_data400::persist::jbello_Reg_DATES_cnt',r_vehicle_cnt,flat);
	...
	ds_mthly_cnt:=table(ds_dates_normed
						...
						: persist('~thor_data400::persist::jbello_Reg_DATES_norm_mthly')
						;
	...
	ds_yrly_cnt:=table(ds_dates_normed
						,r_yrly_cnt
						,State_Origin
						,Source_Code
						,field
						...
						: persist('~thor_data400::persist::jbello_Reg_DATES_norm_yrly')
						;
	...
	ds_state_counts	:=	join(ds_state_stats1, ds_yrly_cnt
							...
							: persist('~thor_data400::persist::jbello_Reg_DATES_norm_stats')
							;
	...
	// ds_state_counts := dataset('~thor_data400::persist::jbello_Reg_DATES_norm_stats',r_state_counts,flat);
	...
	ds_mm:=table(ds_state_counts(
								...
								),r_mm,State_Origin,Source_Code,field);
	...
	ds_all:=join(ds_state_counts, ds_mm
					...
					: persist('~thor_data400::persist::jbello_Reg_DATES_norm_m1')
					;
	...
	ds_trimmedM2:=dedup(sort(ds_m2,State_Origin,Source_Code,field,YYYYMM,YYYYMM2),State_Origin,Source_Code,field,YYYYMM);
	///////////////////////////////////////////////////////////////////////////////
	r_m3:=record
		ds_trimmedM2;
		qstring6	YYYYMM3;
	...
	ds_trimmedM3:=dedup(sort(ds_m3,State_Origin,Source_Code,field,YYYYMM,YYYYMM2,YYYYMM3),State_Origin,Source_Code,field,YYYYMM);
	///////////////////////////////////////////////////////////////////////////////
	r_m4:=record
		ds_trimmedM3;
		qstring6	YYYYMM4;
	...
	ds_trimmedM4:=dedup(sort(ds_m4,State_Origin,Source_Code,field,YYYYMM,YYYYMM2,YYYYMM3,YYYYMM4),State_Origin,Source_Code,field,YYYYMM);
	///////////////////////////////////////////////////////////////////////////////
	r_m5:=record
		ds_trimmedM4;
		qstring6	YYYYMM5;
	...
	ds_trimmedM5:=dedup(sort(ds_m5,State_Origin,Source_Code,field,YYYYMM,YYYYMM2,YYYYMM3,YYYYMM4,YYYYMM5),State_Origin,Source_Code,field,YYYYMM);
	///////////////////////////////////////////////////////////////////////////////
	r_m6:=record
		ds_trimmedM5;
		qstring6	YYYYMM6;
	...
	ds_trimmedY11:=dedup
					...
					: persist('~thor_data400::persist::jbello_Reg_DATES_norm_y11')
					;
	///////////////////////////////////////////////////////////////////////////////
	// r_y11	:= RECORD
	  // string2 state_origin;
	  ...
	  // integer8 y11;
	 // END;
	// ds_trimmedY11 := dataset('~thor_data400::persist::jbello_Reg_DATES_norm_y11',r_y11,flat);
	...
	ds_srtd1:=sort(ds_TBLstats
						...
						// and abs(y10-y9)/y9 between 0 and ythreshld
						// and abs(y11-y10)/y10 between 0 and ythreshld
						and YYYYMM<>''
...
// output(ds_srtd1(State_Origin='UT',field='REG_EARLIEST_EFFECTIVE_DATE'));
// output(ds_srtd1(State_Origin='UT',field='REG_FIRST_DATE'));
// output(ds_srtd1(State_Origin='UT',field='REG_LATEST_EFFECTIVE_DATE'));
// output(ds_srtd1(State_Origin='UT',field='TTL_EARLIEST_ISSUE_DATE'));
// output(ds_srtd1(State_Origin='UT',field='TTL_LATEST_ISSUE_DATE'));

	ds_srtd2:=sort(ds_TBLstats
						(
							m1>=mthreshld
						// and m2>=mthreshld
						// and abs(y2-y1)/y1 < ythreshld
						and YYYYMM<>''
						and YYYYMM between bottomDate and topDate 
						and YYYYMM[5..6] between '01' and '12'
						)
...
// output(ds_srtd2(State_Origin='UT',field='REG_EARLIEST_EFFECTIVE_DATE'));
// output(ds_srtd2(State_Origin='UT',field='REG_FIRST_DATE'));
// output(ds_srtd2(State_Origin='UT',field='REG_LATEST_EFFECTIVE_DATE'));
// output(ds_srtd2(State_Origin='UT',field='TTL_EARLIEST_ISSUE_DATE'));
// output(ds_srtd2(State_Origin='UT',field='TTL_LATEST_ISSUE_DATE'));
	...
	ds_FinalReport:=rollup(ds_minmax2
						...
						: persist('~thor_data400::persist::jbello_vehicle_coverage')
						;
