...
EXPORT MakeFT_invalid_license_number(SALT37.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_license_number(SALT37.StrType s,SALT37.StrType license_state) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT37.StringFilter(s,' .-#*;/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'))),~ALC.Custom_Scrubs.fn_valid_mt_prof_license_no(s,license_state)<1);
EXPORT InValidMessageFT_invalid_license_number(UNSIGNED1 wh) := CHOOSE(wh,SALT37.HygieneErrors.NotInChars(' .-#*;/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'),SALT37.HygieneErrors.CustomFail('ALC.Custom_Scrubs.fn_valid_mt_prof_license_no'),SALT37.HygieneErrors.Good);
...
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'fname' => 0,'lname' => 1,'title' => 2,'company' => 3,'address1' => 4,'address2' => 5,'city' => 6,'state' => 7,'zip' => 8,'zip4' => 9,'cart' => 10,'bar' => 11,'gender' => 12,'country' => 13,'postal_cd' => 14,'dpv' => 15,'addr_type' => 16,'county_cd' => 17,'license_class' => 18,'license_state' => 19,'license_type' => 20,'msa' => 21,'nielsen_county_cd' => 22,'phone' => 23,'email' => 24,'list_id' => 25,'scno' => 26,'keycode' => 27,'custno' => 28,'license_no' => 29,'dob' => 30,'orig_date' => 31,'exp_date' => 32,'degree' => 33,'specialty' => 34,0);
...
EXPORT Make_license_class(SALT37.StrType s0) := MakeFT_invalid_numericpound(s0);
EXPORT InValid_license_class(SALT37.StrType s) := InValidFT_invalid_numericpound(s);
...
EXPORT InValid_license_no(SALT37.StrType s,SALT37.StrType license_state) := InValidFT_invalid_license_number(s,license_state);
EXPORT InValidMessage_license_no(UNSIGNED1 wh) := InValidMessageFT_invalid_license_number(wh);
 
EXPORT Make_dob(SALT37.StrType s0) := MakeFT_invalid_slashspace_date(s0);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT37,Scrubs_ALC_PROFESSIONALS;
