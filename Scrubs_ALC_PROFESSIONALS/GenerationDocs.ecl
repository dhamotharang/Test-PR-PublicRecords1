...
Command line options: -MScrubs_ALC_PROFESSIONALS -eC:\Users\metzmaaj\AppData\Local\Temp\TFRA51D.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_ALC_PROFESSIONALS
FILENAME:ALC_PROFESSIONALS
...
FIELDTYPE:invalid_slashspace_date:ALLOW(/ 0123456789)
...
FIELDTYPE:invalid_license_number:ALLOW( .-#*;/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789):CUSTOM(ALC.Custom_Scrubs.fn_valid_mt_prof_license_no<1,license_state)
...
FIELD:license_class:TYPE(STRING15):LIKE(invalid_numericpound):0,0
FIELD:license_state:TYPE(STRING50):LIKE(invalid_alpha):0,0
FIELD:license_type:TYPE(STRING255):LIKE(invalid_alphapound):0,0
...
FIELD:dob:TYPE(STRING20):LIKE(invalid_slashspace_date):0,0
FIELD:orig_date:TYPE(STRING20):LIKE(invalid_slashspace_date):0,0
FIELD:exp_date:TYPE(STRING20):LIKE(invalid_slashspace_date):0,0
