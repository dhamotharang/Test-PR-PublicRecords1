...
Command line options: -MScrubs_ALC_PROFESSIONALS -eC:\Users\metzmaaj\AppData\Local\Temp\TFRE100.tmp 
...
FIELDTYPE:invalid_slashOspace_date:ALLOW(/ O0123456789)
...
FIELD:orig_date:TYPE(STRING20):LIKE(invalid_slashOspace_date):0,0
FIELD:exp_date:TYPE(STRING20):LIKE(invalid_slashOspace_date):0,0
