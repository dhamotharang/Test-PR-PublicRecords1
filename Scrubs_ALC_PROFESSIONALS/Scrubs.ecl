...
EXPORT FromNone(DATASET(Layout_ALC_PROFESSIONALS) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.license_class_Invalid := Fields.InValid_license_class((SALT32.StrType)le.license_class);
    ...
    SELF.license_no_Invalid := Fields.InValid_license_no((SALT32.StrType)le.license_no,(SALT32.StrType)le.license_state);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT32.StrType)le.fname,(SALT32.StrType)le.lname,(SALT32.StrType)le.title,(SALT32.StrType)le.state,(SALT32.StrType)le.zip,(SALT32.StrType)le.zip4,(SALT32.StrType)le.cart,(SALT32.StrType)le.bar,(SALT32.StrType)le.gender,(SALT32.StrType)le.addr_type,(SALT32.StrType)le.county_cd,(SALT32.StrType)le.license_class,(SALT32.StrType)le.license_state,(SALT32.StrType)le.license_type,(SALT32.StrType)le.msa,(SALT32.StrType)le.nielsen_county_cd,(SALT32.StrType)le.phone,(SALT32.StrType)le.list_id,(SALT32.StrType)le.scno,(SALT32.StrType)le.custno,(SALT32.StrType)le.license_no,(SALT32.StrType)le.dob,(SALT32.StrType)le.orig_date,(SALT32.StrType)le.exp_date,'***SALTBUG***');
  END;
