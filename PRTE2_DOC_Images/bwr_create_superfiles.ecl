...
// Input Files
STD.File.CreateSuperFile('~thor_200::in::prte_hd_crim_off::lookup::superfile');
...
//Key Files
roxiekeybuild.mac_create_superkeyfiles_standard('~prte::criminal_images', '::key::criminal','matrix_images_did');
roxiekeybuild.mac_create_superkeyfiles_standard('~prte::criminal_images_v2', '::key::criminal', 'matrix_images_did');
