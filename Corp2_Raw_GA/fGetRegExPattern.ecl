export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords2	 	:= 'NO ADDR|NOTSET|NOT SET|DDRESS|DITTO|INSERT|N/A|NA|NONE GIVEN|NOT GIVEN';
	...
	export City := module
		...
		shared PatternInvalidWords1		:= '^SAME$|^SAME | SAME |NONE GIVEN|^NONE$|^NONE | NONE |UNKNOWN|NO ADDR|NOTSET|NOT SET|^N/A$|^NA$|NOT GIVEN';
	...
	export State := module
		...
		shared PatternInvalidWords1		:= '^XX|NO$|^UN|^FF|^NA|^U|NOTSET|NOT SET';
	...
	export Zip := module
		...
		shared PatternInvalidWords1		:= '^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |UNKNOWN';
		shared PatternInvalidWords2	 	:= 'DITTO||FOREIGN|INSERT|GEORGIA|NO ZIP';
		export InvalidWords						:= PatternInvalidWords1 + PatternInvalidWords2 ;
	end;
