...
export fn_ReportCount(SET OF STRING SetValidValues) := FUNCTION 
...
Header_source := dataset('~thor_data400::base::header_prod',PhilipMorris.Layout_Header,flat);
