...
export Send_Email(string pversion) := module
		...
		export BuildSuccess		:= fileservices.sendemail('saritha.myana@lexisnexis.com;' + _control.MyInfo.EmailAddressNotify,
																										SuccessSubject,
																										SuccessBody
																										);
		export BuildFailure		:= fileservices.sendemail('saritha.myana@lexisnexis.com;' + _control.MyInfo.EmailAddressNotify,
