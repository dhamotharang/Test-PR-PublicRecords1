...
slimrec add_doc(hygenics_crim.file_offenders_keybuilding le) :=
TRANSFORM
...
doc_added := PROJECT(hygenics_crim.file_offenders_keybuilding((integer)did != 0), add_doc(LEFT));
