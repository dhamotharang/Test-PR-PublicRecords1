import doxie_build, corrections, hygenics_search;
/*
dslayout := RECORD
...
ds := dataset('~thor400_20::persist::offenders_flagged', dslayout, flat);
*/
export File_Offenders := hygenics_crim.proc_build_DOC_offenders_flagged;
