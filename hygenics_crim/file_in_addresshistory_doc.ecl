...
addresshistory_ie :=  dataset(data_services.foreign_prod+'thor_200::in::crim::hd::doc_address_history_ie',
								      layout_in_addresshistory,
								      CSV(SEPARATOR('|'), TERMINATOR(['\n', '\r\n']), QUOTE('"'), MAXLENGTH(4096)))  (stringlib.StringToUpperCase(recordid[1..8])<>'RECORDID');// and StateCode in _include_states);
...
export file_in_addresshistory_doc := addresshistory +proj_addrhist_cw+proj_addrhist_ie;				