...
EXPORT Proc_FCRA_Field_Deprecation_Stats := FUNCTION
	...
	//DF-21868 Verify followings fields are cleared in thor_200::key::criminal_offenders::fcra::qa::did
	cnt_fcra_offenders := OUTPUT(strata.macf_pops(doxie_files.Key_Offenders(true),,,,,,FALSE,
																						 ['_3g_offender','ace_fips_county,ace_fips_st','age','case_type','citizenship','clean_errors',
																							...
																							'vop_offender','weight']));
	//DF-21868 Verify followings fields are cleared in thor_200::key::criminal_offenses::fcra::qa::offender_key
	cnt_fcra_offender_key := OUTPUT(strata.macf_pops(hygenics_crim.key_prep_offenses(true),,,,,,FALSE,
																						 ['add_off_cd','add_off_desc','adj_wthd','arr_date','arr_disp_cd','arr_disp_date',
																							...
																							'stc_desc_3','stc_desc_4','total_num_of_offenses']));
	//DF-21868 Verify followings fields are cleared in thor_200::key::criminal_punishment::fcra::qa::offender_key.punishment_type
	cnt_fcra_punishment_type := OUTPUT(strata.macf_pops(hygenics_crim.key_prep_punishment(true),,,,,,FALSE,
	...
	//DF-21868 Verify followings fields are cleared in thor_data400::key::corrections::fcra::court_offenses_public_qa
	cnt_fcra_courtoffenses := OUTPUT(strata.macf_pops(hygenics_crim.key_prep_courtoffenses(true),,,,,,FALSE,
	...
	//DF-21868 Verify followings fields are cleared in thor_data400::key::corrections::fcra::offenders_offenderkey_public_qa
	cnt_fcra_offenders_offenderkey := OUTPUT(strata.macf_pops(hygenics_crim.key_prep_offenders_OffenderKey(true),,,,,,FALSE,
