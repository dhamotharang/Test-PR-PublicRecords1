...
dedup_sort_result_common := 
                          dedup(sort(distribute(result_common,hash(offender_key)),
													      offender_key,source_file, vendor,off_date, arr_date,	num_of_counts,	 le_agency_desc,	le_agency_case_number,	 traffic_ticket_number, 	traffic_dl_no,		
																traffic_dl_st, arr_off_code,	arr_off_desc_1,	arr_off_desc_2,	arr_off_lev, arr_statute,	arr_statute_desc, arr_disp_date, arr_disp_code,	arr_disp_desc_1,		  
																arr_disp_desc_2,	court_case_number, court_desc,court_appeal_flag,	court_final_plea,court_off_code,	court_off_desc_1, court_off_desc_2,		  												 
