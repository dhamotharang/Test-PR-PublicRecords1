import ut,corrections,header_slimsort,watchdog,didville,fair_isaac,did_add,doxie_build,census_data,codes, hygenics_search;
...
o1a2 := join(o1a,codes.File_Codes_V3_In(file_name = 'GENERAL', field_name= 'STATE_LONG'),
		right.code = left.orig_state,
...
o1b := join(o1a2,Census_data.File_Fips2County, left.county_name != '' and 
		left.county_name = right.county_fips and 
...
dpostfinal := join(dpost2,codes.File_Codes_V3_In(file_name = 'CRIM_OFFENDER2'),
				right.field_name = 'DATA_TYPE' and 
				left.data_type = right.code,
				get_datasource(LEFT,RIGHT),left outer, lookup):persist('~thor_data400::persist::corrections_offenders_public');
