...
file_in_charge_ie :=  dataset(data_services.foreign_prod+'thor_200::in::crim::hd::aoc_charge_ie',
								      layout_in_charge,
								      CSV(SEPARATOR('|'), TERMINATOR(['\n', '\r\n']), QUOTE('"'), MAXLENGTH(4096)))  (stringlib.StringToUpperCase(recordid[1..8])<>'RECORDID');// and StateCode in _include_states);
...
export file_in_charge := file_in_charge_crim + proj_chg_cw + proj_chg_ie;