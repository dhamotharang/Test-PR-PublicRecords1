...
e_mail_success := fileservices.sendemail(
													'vani.chikte@lexisnexis.com;jtao@seisint.com;jmtao@hotmail.com',
...
retval := sequential(proc_build_DOC_bases, proc_build_DOC_keys(filedate),proc_AcceptSK_DOC_To_QA):
