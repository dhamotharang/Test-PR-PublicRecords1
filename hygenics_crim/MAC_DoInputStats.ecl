...
OUTPUt(choosen(offender, 200), named('Top_Offender'));
OUTPUt(choosen(sort(offender, -offender_key), 200), named('Bottom_Offender'));
OUTPUt(sample(offender, 8, 7), named('Random_Sample_Offender'));
OUTPUt(choosen(offenses, 200), named('Top_Offenses'));
OUTPUt(choosen(sort(offenses, -offender_key), 200), named('Bottom_Offenses'));
...
stat1 := table(offender, %process_date_short_layout%, process_date);
...
stat39 := table(offenses, %offender_key_short_layout2%, offender_key, few);
...
stat7 := table(offender, %case_filing_dt_short_layout%, case_filing_dt, few);
...
stat8 := table(offender, %pty_nm_short_layout%, pty_nm, few);
...
stat11 := table(offender, %orig_lname_short_layout%, orig_lname, few);
...
stat12 := table(offender, %orig_fname_short_layout%, orig_fname, few);
...
stat13 := table(offender, %orig_mname_short_layout%, orig_mname, few);
...
stat15 := table(offender, %id_num_short_layout%, id_num, few);
...
stat21 := table(offenses, %arr_date_short_layout%, arr_date, few);
...
stat23 := table(offenses, %arr_disp_desc_1_short_layout%, arr_disp_desc_1, few);
...
stat33 := table(offenses, %le_agency_cd_short_layout%, le_agency_cd, few);
...
#UNIQUENAME(court_off_desc_1_short_layout)
...
#UNIQUENAME(court_off_lev_short_layout)
...
#UNIQUENAME(court_disp_date_short_layout)
...
#UNIQUENAME(court_disp_desc_1_short_layout)
...
#UNIQUENAME(sent_jail_short_layout)
...
#UNIQUENAME(sent_court_cost_short_layout)
...
#UNIQUENAME(sent_court_fine_short_layout)
...
stat47 := dedup(sort(table(offenses, %sent_court_fine_short_layout%, sent_court_fine, few), record), record);

#UNIQUENAME(sent_susp_court_fine_short_layout)
...
#UNIQUENAME(sent_probation_short_layout)
...
#UNIQUENAME(street_address_1_short_layout)
...
#UNIQUENAME(street_address_2_short_layout)
...
#UNIQUENAME(street_address_3_short_layout)
...
#UNIQUENAME(street_address_4_short_layout)
...
#UNIQUENAME(street_address_5_short_layout)
...
#UNIQUENAME(off_date_short_layout)
...
#UNIQUENAME(court_case_number_short_layout)
...
#UNIQUENAME(court_statute_short_layout)
...
#UNIQUENAME(court_statute_desc_short_layout)
...
#UNIQUENAME(court_disp_code_short_layout)
...
output(choosen(sort(stat16, -dob),1000), named('STAT_Date_of_Birth')),
output(choosen(stat26, 1000), named('STAT_Race')),
output(choosen(stat17, 1000), named('STAT_Race_Description')),
output(choosen(stat18, 1000), named('STAT_Sex')),
output(choosen(stat27, 1000), named('STAT_Hair_Color')),
output(choosen(stat28, 1000), named('STAT_Hair_Color_Desc')),
output(choosen(stat29, 1000), named('STAT_Eye_Color')),
output(choosen(stat30, 1000), named('STAT_Eye_Color_Desc')),
output(choosen(stat31, 1000), named('STAT_Skin_Color')),
output(choosen(stat32, 1000), named('STAT_Skin_Color_Desc')),
output(choosen(stat35, 1000), named('STAT_Height')),
output(choosen(stat36, 1000), named('STAT_Weight')),
output(choosen(stat19, 1000), named('STAT_Party_Status_Description')),

output(choosen(stat20, 1000), named('STAT_Offense_Composition')),
output(choosen(stat40, 1000), named('STAT_Num_Of_Counts')),
output(choosen(stat33, 1000), named('STAT_Legal_Agency_Code')),
output(choosen(stat34, 1000), named('STAT_Legal_Agency_Desc')),
output(choosen(stat21, 1000), named('STAT_Arrest_Date')),
output(choosen(stat55, 1000), named('STAT_Offense_Date')),
output(choosen(stat22, 1000), named('STAT_Arrest_Offense_Description')),
output(choosen(stat37, 1000), named('STAT_Arrest_Offense_Level')),
output(choosen(stat38, 1000), named('STAT_Arrest_Statute')),
output(choosen(stat23, 1000), named('STAT_Arrest_Disposition_Description_1')),
output(choosen(stat24, 1000), named('STAT_Arrest_Disposition_Description_2')),
output(choosen(stat25, 1000), named('STAT_Arrest_Disposition_Date')),
output(choosen(stat56,1000), named('STAT_Court_Case_Number')),
output(choosen(stat41, 1000), named('STAT_court_off_desc_1')),
output(choosen(stat42, 1000), named('STAT_court_off_lev')),
output(choosen(stat57, 1000), named('STAT_Court_Statute')),
output(choosen(stat58, 1000), named('STAT_Court_Statute_Description')),
output(choosen(stat43, 1000), named('STAT_court_disp_date')),
output(choosen(stat59, 1000), named('STAT_court_disp_code')),
output(choosen(stat44, 1000), named('STAT_court_disp_desc_1')),
output(choosen(stat45, 1000), named('STAT_sent_jail')),
output(choosen(stat46, 1000), named('STAT_sent_court_cost')),
output(choosen(stat47, 1000), named('STAT_sent_court_fine')),
output(choosen(stat48, 1000), named('STAT_sent_susp_court_fine')),
output(choosen(stat49, 1000), named('STAT_sent_probation'))
);
ENDMACRO;