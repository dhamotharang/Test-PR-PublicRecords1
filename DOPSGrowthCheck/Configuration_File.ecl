...
export Configuration_File := dataset([
    {'FCRA_LiensV2Keys','liensv2.key_liens_main_ID_FCRA','key_liens_main_ID_FCRA','~thor_data400::key::liensv2::fcra::','::main::tmsid.rmsid','persistent_record_id','','','','','\'rmsid\',\'tmsid\',\'persistent_record_id\'','process_date','10'},
