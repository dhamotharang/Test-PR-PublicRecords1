IMPORT SALT38,STD;
EXPORT hygiene(dataset(layout_In_tn_conv) h) := MODULE
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_DL_TN_CONV, Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
