...
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_past_date','invalid_dl_nbr','invalid_action_code','invalid_lname','invalid_county_code');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'invalid_past_date' => 1,'invalid_dl_nbr' => 2,'invalid_action_code' => 3,'invalid_lname' => 4,'invalid_county_code' => 5,0);
