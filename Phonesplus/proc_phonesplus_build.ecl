...
e_mail_success := FileServices.sendemail('jason.allerdings@lexisnexis.com;fernando.henao@lexisnexis.com;julie.gardner@lexisnexis.com;qualityassurance@seisint.com;joseph.lezcano@lexisnexis.com;charleen.thompson@lexisnexis.com;aherzberg@lexisnexis.com','PHONESPLUS/QSENT '+ Phonesplus.version+' weekly sample available ','at ' + thorlib.WUID());
e_mail_failure := FileServices.sendemail('jason.allerdings@lexisnexis.com;fernando.henao@lexisnexis.com;julie.gardner@lexisnexis.com;joseph.lezcano@lexisnexis.com;charleen.thompson@lexisnexis.com; aherzberg@lexisnexis.com','Phonesplus/Qsent Build Failure',failmessage+'at ' + thorlib.WUID());

phonesplus_dops_update := sequential(RoxieKeybuild.updateversion('PhonesPlusKeys',Phonesplus.version,'jlezcano@seisint.com;jason.allerdings@lexisnexis.com',,'N'),
