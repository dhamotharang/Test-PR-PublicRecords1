...
ds := Phonesplus.file_phonesplus_base;

rPopulationStats_file_phonesplus_base
 :=
  record
...
tStats := table(ds,rPopulationStats_file_phonesplus_base,few);

strata.createXMLStats(tStats,'Phonesplus','data',Phonesplus.version,'',resultsOut);

export strata_popFilePhonesplusBase := resultsOut;