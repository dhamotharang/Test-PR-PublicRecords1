export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords2	 	:= '^SAME$| SAME |^NONE$|^NONE | NONE |UNKNOWN|^NA$|^N/A$';
	...
	export City := module
		...
		shared PatternInvalidWords1		:= '^SAME$| SAME |^NONE$|^NONE | NONE |UNKNOWN|NO ADDRESS';
	...
	export State := module
		...
		SHARED PatternInvalidWords1		:= '^XX$|^X$|^NA$|NONE LISTED|^NONE$|^NONE | NONE ';
	...
	export Zip := module
		...
		shared PatternInvalidWords1	 	:= '^SAME$| SAME |^NONE$|^NONE | NONE |UNKNOWN';
		export InvalidWords						:= PatternInvalidWords1;
	end;
	...
	export Country := module
		...
		shared PatternInvalidWords1	 	:= '^SAME$| SAME |^NONE$|^NONE | NONE |UNKNOWN|^XX$|^X$';
		export InvalidWords						:= PatternInvalidWords1;
	end;
