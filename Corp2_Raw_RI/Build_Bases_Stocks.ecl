...
EXPORT Build_Bases_Stocks(
	...
	tools.mac_WriteFile(Corp2_Raw_RI.Filenames(pversion).Base.Stocks.New, baseactions, Build_Stocks_Base);

	EXPORT All := IF(tools.fun_IsValidVersion(pversion),
									 Build_Stocks_Base,
									 OUTPUT('No Valid version parameter passed, skipping Corp2_Raw_RI.Build_Bases_Stocks attribute')
									 );
