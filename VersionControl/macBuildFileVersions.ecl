////////////////////////////////////////////////////////////////////////////////////////////
// -- macBuildFileVersions macro/module
// -- Parameters:
// -- 		pfilenameversions	-- result of call to NamingConventionUtilities.mBuildFilenameVersions  Example follows
...
// --
// -- 		export BaseFilenames	:= VersionControl.mBuildFilenameVersions('~thor_data400::base::BBB::@version@::Member',	'20060328');
// -- 		VersionControl.mBuildFileVersions(BaseFilenames,	bbb2.Layouts_Files.Base.Member, BaseFiles);
// --
...
export macBuildFileVersions( pfilenameversions
														,pLayout
														,pOutput
...
import lib_stringlib;
	...
	module
		...
		#else
		#if(pfiletype = 'CSV')
			shared fDataset(string name)			:= dataset(name, pLayout,			csv(
																						 QUOTE([pQuote])
