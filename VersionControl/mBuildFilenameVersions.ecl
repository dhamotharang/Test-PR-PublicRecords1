// called in Doxie.Proc_Doxie_Keys_All
 // -> Doxie.Keynames -> VersionControl.mBuildFilenameVersions (sandboxed to use nothor)
////////////////////////////////////////////////////////////////////////////////////////////
...
module
	...
	export fVersion	(string pversion) := 	if(regexfind('^[[:alpha:]]*$',pversion,nocase)
	...
	function
		...
		return 
		nothor(map( (not fileservices.superfileexists		(filename))
	...
	DATASET([
		...
		,(Grandfather)
		,(Delete)
		,(if(pNewTemplatefilename != '', pTemplatefilename,''))
	...
	dataset([
		...
		{(New), (dAll_superfilenames(name != '')), (Template), (TemplateNew), (pdate), (pnGenerations),regexfind('@version@', pTemplatefilename,nocase)}
