...
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_numeric','invalid_charter_nbr','invalid_alphablank','invalid_alphablankSp','invalid_alphaRequired','invalid_date','invalid_for_dom_ind','invalid_recordorigin','invalid_flag_code','invalid_name_type_code','invalid_status_desc');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_numeric' => 5,'invalid_charter_nbr' => 6,'invalid_alphablank' => 7,'invalid_alphablankSp' => 8,'invalid_alphaRequired' => 9,'invalid_date' => 10,'invalid_for_dom_ind' => 11,'invalid_recordorigin' => 12,'invalid_flag_code' => 13,'invalid_name_type_code' => 14,'invalid_status_desc' => 15,0);
 
EXPORT MakeFT_invalid_corp_key(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'-0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'-0123456789'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('-0123456789'),SALT35.HygieneErrors.NotLength('4..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['50']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('50'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['VT']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('VT'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_numeric(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_numeric(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_numeric(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.NotLength('1..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter_nbr(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'-0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'-0123456789'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('-0123456789'),SALT35.HygieneErrors.NotLength('1..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphablank(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphablank(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphablank(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphablankSp(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' ,ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphablankSp(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' ,ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_alphablankSp(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' ,ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_alphaRequired(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_alphaRequired(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_alphaRequired(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'),SALT35.HygieneErrors.NotLength('1..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_date(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_pastDate(s)>0,~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 8));
EXPORT InValidMessageFT_invalid_date(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT35.HygieneErrors.NotLength('0..8'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_for_dom_ind(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_for_dom_ind(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['D','F',' ']);
EXPORT InValidMessageFT_invalid_for_dom_ind(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('D|F| '),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_recordorigin(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_recordorigin(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['C','T']);
EXPORT InValidMessageFT_invalid_recordorigin(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('C|T'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_flag_code(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['Y','N',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Y|N| '),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT35.StrType s,SALT35.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_vt_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_vt_Main.Functions.invalid_name_type_code'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_status_desc(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_desc(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN Scrubs_Corp2_Mapping_vt_Main.Functions.set_valid_status_desc  );
EXPORT InValidMessageFT_invalid_status_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_vt_Main.Functions.set_valid_status_desc  '),SALT35.HygieneErrors.Good);
...
EXPORT FieldNum(SALT35.StrType fn) := CASE(fn,'dt_vendor_first_reported' => 0,'dt_vendor_last_reported' => 1,'dt_first_seen' => 2,'dt_last_seen' => 3,'corp_ra_dt_first_seen' => 4,'corp_ra_dt_last_seen' => 5,'corp_key' => 6,'corp_supp_key' => 7,'corp_vendor' => 8,'corp_vendor_county' => 9,'corp_vendor_subcode' => 10,'corp_state_origin' => 11,'corp_process_date' => 12,'corp_orig_sos_charter_nbr' => 13,'corp_legal_name' => 14,'corp_ln_name_type_cd' => 15,'corp_ln_name_type_desc' => 16,'corp_supp_nbr' => 17,'corp_name_comment' => 18,'corp_address1_type_cd' => 19,'corp_address1_type_desc' => 20,'corp_address1_line1' => 21,'corp_address1_line2' => 22,'corp_address1_line3' => 23,'corp_address1_effective_date' => 24,'corp_address2_type_cd' => 25,'corp_address2_type_desc' => 26,'corp_address2_line1' => 27,'corp_address2_line2' => 28,'corp_address2_line3' => 29,'corp_address2_effective_date' => 30,'corp_phone_number' => 31,'corp_phone_number_type_cd' => 32,'corp_phone_number_type_desc' => 33,'corp_fax_nbr' => 34,'corp_email_address' => 35,'corp_web_address' => 36,'corp_filing_reference_nbr' => 37,'corp_filing_date' => 38,'corp_filing_cd' => 39,'corp_filing_desc' => 40,'corp_status_cd' => 41,'corp_status_desc' => 42,'corp_status_date' => 43,'corp_standing' => 44,'corp_status_comment' => 45,'corp_ticker_symbol' => 46,'corp_stock_exchange' => 47,'corp_inc_state' => 48,'corp_inc_county' => 49,'corp_inc_date' => 50,'corp_anniversary_month' => 51,'corp_fed_tax_id' => 52,'corp_state_tax_id' => 53,'corp_term_exist_cd' => 54,'corp_term_exist_exp' => 55,'corp_term_exist_desc' => 56,'corp_foreign_domestic_ind' => 57,'corp_forgn_state_cd' => 58,'corp_forgn_state_desc' => 59,'corp_forgn_sos_charter_nbr' => 60,'corp_forgn_date' => 61,'corp_forgn_fed_tax_id' => 62,'corp_forgn_state_tax_id' => 63,'corp_forgn_term_exist_cd' => 64,'corp_forgn_term_exist_exp' => 65,'corp_forgn_term_exist_desc' => 66,'corp_orig_org_structure_cd' => 67,'corp_orig_org_structure_desc' => 68,'corp_for_profit_ind' => 69,'corp_public_or_private_ind' => 70,'corp_sic_code' => 71,'corp_naic_code' => 72,'corp_orig_bus_type_cd' => 73,'corp_orig_bus_type_desc' => 74,'corp_entity_desc' => 75,'corp_certificate_nbr' => 76,'corp_internal_nbr' => 77,'corp_previous_nbr' => 78,'corp_microfilm_nbr' => 79,'corp_amendments_filed' => 80,'corp_acts' => 81,'corp_partnership_ind' => 82,'corp_mfg_ind' => 83,'corp_addl_info' => 84,'corp_taxes' => 85,'corp_franchise_taxes' => 86,'corp_tax_program_cd' => 87,'corp_tax_program_desc' => 88,'corp_ra_full_name' => 89,'corp_ra_fname' => 90,'corp_ra_mname' => 91,'corp_ra_lname' => 92,'corp_ra_suffix' => 93,'corp_ra_title_cd' => 94,'corp_ra_title_desc' => 95,'corp_ra_fein' => 96,'corp_ra_ssn' => 97,'corp_ra_dob' => 98,'corp_ra_effective_date' => 99,'corp_ra_resign_date' => 100,'corp_ra_no_comp' => 101,'corp_ra_no_comp_igs' => 102,'corp_ra_addl_info' => 103,'corp_ra_address_type_cd' => 104,'corp_ra_address_type_desc' => 105,'corp_ra_address_line1' => 106,'corp_ra_address_line2' => 107,'corp_ra_address_line3' => 108,'corp_ra_phone_number' => 109,'corp_ra_phone_number_type_cd' => 110,'corp_ra_phone_number_type_desc' => 111,'corp_ra_fax_nbr' => 112,'corp_ra_email_address' => 113,'corp_ra_web_address' => 114,'corp_prep_addr1_line1' => 115,'corp_prep_addr1_last_line' => 116,'corp_prep_addr2_line1' => 117,'corp_prep_addr2_last_line' => 118,'ra_prep_addr_line1' => 119,'ra_prep_addr_last_line' => 120,'cont_filing_reference_nbr' => 121,'cont_filing_date' => 122,'cont_filing_cd' => 123,'cont_filing_desc' => 124,'cont_type_cd' => 125,'cont_type_desc' => 126,'cont_full_name' => 127,'cont_fname' => 128,'cont_mname' => 129,'cont_lname' => 130,'cont_suffix' => 131,'cont_title1_desc' => 132,'cont_title2_desc' => 133,'cont_title3_desc' => 134,'cont_title4_desc' => 135,'cont_title5_desc' => 136,'cont_fein' => 137,'cont_ssn' => 138,'cont_dob' => 139,'cont_status_cd' => 140,'cont_status_desc' => 141,'cont_effective_date' => 142,'cont_effective_cd' => 143,'cont_effective_desc' => 144,'cont_addl_info' => 145,'cont_address_type_cd' => 146,'cont_address_type_desc' => 147,'cont_address_line1' => 148,'cont_address_line2' => 149,'cont_address_line3' => 150,'cont_address_effective_date' => 151,'cont_address_county' => 152,'cont_phone_number' => 153,'cont_phone_number_type_cd' => 154,'cont_phone_number_type_desc' => 155,'cont_fax_nbr' => 156,'cont_email_address' => 157,'cont_web_address' => 158,'corp_acres' => 159,'corp_action' => 160,'corp_action_date' => 161,'corp_action_employment_security_approval_date' => 162,'corp_action_pending_cd' => 163,'corp_action_pending_desc' => 164,'corp_action_statement_of_intent_date' => 165,'corp_action_tax_dept_approval_date' => 166,'corp_acts2' => 167,'corp_acts3' => 168,'corp_additional_principals' => 169,'corp_address_office_type' => 170,'corp_agent_assign_date' => 171,'corp_agent_commercial' => 172,'corp_agent_country' => 173,'corp_agent_county' => 174,'corp_agent_status_cd' => 175,'corp_agent_status_desc' => 176,'corp_agent_id' => 177,'corp_agriculture_flag' => 178,'corp_authorized_partners' => 179,'corp_comment' => 180,'corp_consent_flag_for_protected_name' => 181,'corp_converted' => 182,'corp_converted_from' => 183,'corp_country_of_formation' => 184,'corp_date_of_organization_meeting' => 185,'corp_delayed_effective_date' => 186,'corp_directors_from_to' => 187,'corp_dissolved_date' => 188,'corp_farm_exemptions' => 189,'corp_farm_qual_date' => 190,'corp_farm_status_cd' => 191,'corp_farm_status_date' => 192,'corp_farm_status_desc' => 193,'corp_fiscal_year_month' => 194,'corp_foreign_fiduciary_capacity_in_state' => 195,'corp_governing_statute' => 196,'corp_has_members' => 197,'corp_has_vested_managers' => 198,'corp_home_incorporated_county' => 199,'corp_home_state_name' => 200,'corp_is_professional' => 201,'corp_is_non_profit_irs_approved' => 202,'corp_last_renewal_date' => 203,'corp_last_renewal_year' => 204,'corp_license_type' => 205,'corp_llc_managed_desc' => 206,'corp_llc_managed_ind' => 207,'corp_management_desc' => 208,'corp_management_type' => 209,'corp_manager_managed' => 210,'corp_merged_corporation_id' => 211,'corp_merged_fein' => 212,'corp_merger_allowed_flag' => 213,'corp_merger_date' => 214,'corp_merger_desc' => 215,'corp_merger_effective_date' => 216,'corp_merger_id' => 217,'corp_merger_indicator' => 218,'corp_merger_name' => 219,'corp_merger_type_converted_to_cd' => 220,'corp_merger_type_converted_to_desc' => 221,'corp_naics_desc' => 222,'corp_name_effective_date' => 223,'corp_name_reservation_date' => 224,'corp_name_reservation_desc' => 225,'corp_name_reservation_expiration_date' => 226,'corp_name_reservation_nbr' => 227,'corp_name_reservation_type' => 228,'corp_name_status_cd' => 229,'corp_name_status_date' => 230,'corp_name_status_desc' => 231,'corp_non_profit_irs_approved_purpose' => 232,'corp_non_profit_solicit_donations' => 233,'corp_nbr_of_amendments' => 234,'corp_nbr_of_initial_llc_members' => 235,'corp_nbr_of_partners' => 236,'corp_operating_agreement' => 237,'corp_opt_in_llc_act_desc' => 238,'corp_opt_in_llc_act_ind' => 239,'corp_organizational_comments' => 240,'corp_partner_contributions_total' => 241,'corp_partner_terms' => 242,'corp_percentage_voters_required_to_approve_amendments' => 243,'corp_profession' => 244,'corp_province' => 245,'corp_public_mutual_corporation' => 246,'corp_purpose' => 247,'corp_ra_required_flag' => 248,'corp_registered_counties' => 249,'corp_regulated_ind' => 250,'corp_renewal_date' => 251,'corp_standing_other' => 252,'corp_survivor_corporation_id' => 253,'corp_tax_base' => 254,'corp_tax_standing' => 255,'corp_termination_cd' => 256,'corp_termination_desc' => 257,'corp_termination_date' => 258,'corp_trademark_business_mark_type' => 259,'corp_trademark_cancelled_date' => 260,'corp_trademark_class_desc1' => 261,'corp_trademark_class_desc2' => 262,'corp_trademark_class_desc3' => 263,'corp_trademark_class_desc4' => 264,'corp_trademark_class_desc5' => 265,'corp_trademark_class_desc6' => 266,'corp_trademark_classification_nbr' => 267,'corp_trademark_disclaimer1' => 268,'corp_trademark_disclaimer2' => 269,'corp_trademark_expiration_date' => 270,'corp_trademark_filing_date' => 271,'corp_trademark_first_use_date' => 272,'corp_trademark_first_use_date_in_state' => 273,'corp_trademark_keywords' => 274,'corp_trademark_logo' => 275,'corp_trademark_name_expiration_date' => 276,'corp_trademark_nbr' => 277,'corp_trademark_renewal_date' => 278,'corp_trademark_status' => 279,'corp_trademark_used_1' => 280,'corp_trademark_used_2' => 281,'corp_trademark_used_3' => 282,'cont_owner_percentage' => 283,'cont_country' => 284,'cont_country_mailing' => 285,'cont_nondislosure' => 286,'cont_prep_addr_line1' => 287,'cont_prep_addr_last_line' => 288,'recordorigin' => 289,'internalfield1' => 290,0);
 
//Individual field level validation
 
EXPORT Make_dt_vendor_first_reported(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_dt_vendor_first_reported(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_dt_vendor_first_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_dt_vendor_last_reported(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_dt_vendor_last_reported(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_dt_vendor_last_reported(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_dt_first_seen(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_dt_first_seen(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_dt_first_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_dt_last_seen(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_dt_last_seen(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_dt_last_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_ra_dt_first_seen(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_ra_dt_first_seen(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_ra_dt_first_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_ra_dt_last_seen(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_ra_dt_last_seen(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_ra_dt_last_seen(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_key(SALT35.StrType s0) := MakeFT_invalid_corp_key(s0);
EXPORT InValid_corp_key(SALT35.StrType s) := InValidFT_invalid_corp_key(s);
EXPORT InValidMessage_corp_key(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_key(wh);
 
EXPORT Make_corp_supp_key(SALT35.StrType s0) := s0;
EXPORT InValid_corp_supp_key(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_supp_key(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_vendor(SALT35.StrType s0) := MakeFT_invalid_corp_vendor(s0);
EXPORT InValid_corp_vendor(SALT35.StrType s) := InValidFT_invalid_corp_vendor(s);
EXPORT InValidMessage_corp_vendor(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_vendor(wh);
 
EXPORT Make_corp_vendor_county(SALT35.StrType s0) := s0;
EXPORT InValid_corp_vendor_county(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_vendor_county(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_vendor_subcode(SALT35.StrType s0) := s0;
EXPORT InValid_corp_vendor_subcode(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_vendor_subcode(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_state_origin(SALT35.StrType s0) := MakeFT_invalid_state_origin(s0);
EXPORT InValid_corp_state_origin(SALT35.StrType s) := InValidFT_invalid_state_origin(s);
EXPORT InValidMessage_corp_state_origin(UNSIGNED1 wh) := InValidMessageFT_invalid_state_origin(wh);
 
EXPORT Make_corp_process_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_process_date(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_process_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_orig_sos_charter_nbr(SALT35.StrType s0) := MakeFT_invalid_charter_nbr(s0);
EXPORT InValid_corp_orig_sos_charter_nbr(SALT35.StrType s) := InValidFT_invalid_charter_nbr(s);
EXPORT InValidMessage_corp_orig_sos_charter_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_charter_nbr(wh);
 
EXPORT Make_corp_legal_name(SALT35.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_corp_legal_name(SALT35.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_corp_legal_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_corp_ln_name_type_cd(SALT35.StrType s0) := MakeFT_invalid_name_type_code(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT35.StrType s,SALT35.StrType recordorigin) := InValidFT_invalid_name_type_code(s,recordorigin);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_name_type_code(wh);
 
EXPORT Make_corp_ln_name_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ln_name_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ln_name_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_supp_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_supp_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_supp_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_comment(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_comment(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_line1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_line2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_line2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_line2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_line3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_line3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_line3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address1_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address1_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address1_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_line1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_line2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_line2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_line2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_line3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_line3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_line3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address2_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address2_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address2_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_phone_number(SALT35.StrType s0) := s0;
EXPORT InValid_corp_phone_number(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_phone_number(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_phone_number_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_phone_number_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_phone_number_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_phone_number_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_phone_number_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_phone_number_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_fax_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_fax_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_fax_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_email_address(SALT35.StrType s0) := s0;
EXPORT InValid_corp_email_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_email_address(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_web_address(SALT35.StrType s0) := s0;
EXPORT InValid_corp_web_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_web_address(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_filing_reference_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_filing_reference_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_filing_reference_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_filing_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_filing_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_filing_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_filing_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_filing_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_filing_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_filing_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_filing_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_filing_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_status_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_status_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_status_desc(SALT35.StrType s0) := MakeFT_invalid_status_desc(s0);
EXPORT InValid_corp_status_desc(SALT35.StrType s) := InValidFT_invalid_status_desc(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_status_desc(wh);
 
EXPORT Make_corp_status_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_status_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_standing(SALT35.StrType s0) := s0;
EXPORT InValid_corp_standing(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_standing(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_status_comment(SALT35.StrType s0) := s0;
EXPORT InValid_corp_status_comment(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_status_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ticker_symbol(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ticker_symbol(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ticker_symbol(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_stock_exchange(SALT35.StrType s0) := s0;
EXPORT InValid_corp_stock_exchange(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_stock_exchange(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_inc_state(SALT35.StrType s0) := MakeFT_invalid_state_origin(s0);
EXPORT InValid_corp_inc_state(SALT35.StrType s) := InValidFT_invalid_state_origin(s);
EXPORT InValidMessage_corp_inc_state(UNSIGNED1 wh) := InValidMessageFT_invalid_state_origin(wh);
 
EXPORT Make_corp_inc_county(SALT35.StrType s0) := s0;
EXPORT InValid_corp_inc_county(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_inc_county(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_inc_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_inc_date(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_inc_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_anniversary_month(SALT35.StrType s0) := s0;
EXPORT InValid_corp_anniversary_month(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_anniversary_month(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_fed_tax_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_fed_tax_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_fed_tax_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_state_tax_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_state_tax_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_state_tax_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_term_exist_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_term_exist_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_term_exist_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_term_exist_exp(SALT35.StrType s0) := s0;
EXPORT InValid_corp_term_exist_exp(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_term_exist_exp(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_term_exist_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_term_exist_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_term_exist_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_foreign_domestic_ind(SALT35.StrType s0) := MakeFT_invalid_for_dom_ind(s0);
EXPORT InValid_corp_foreign_domestic_ind(SALT35.StrType s) := InValidFT_invalid_for_dom_ind(s);
EXPORT InValidMessage_corp_foreign_domestic_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_for_dom_ind(wh);
 
EXPORT Make_corp_forgn_state_cd(SALT35.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_corp_forgn_state_cd(SALT35.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_corp_forgn_state_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
 
EXPORT Make_corp_forgn_state_desc(SALT35.StrType s0) := MakeFT_invalid_alphablankSp(s0);
EXPORT InValid_corp_forgn_state_desc(SALT35.StrType s) := InValidFT_invalid_alphablankSp(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablankSp(wh);
 
EXPORT Make_corp_forgn_sos_charter_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_sos_charter_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_sos_charter_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_forgn_date(SALT35.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_corp_forgn_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
 
EXPORT Make_corp_forgn_fed_tax_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_fed_tax_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_fed_tax_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_state_tax_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_state_tax_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_state_tax_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_term_exist_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_term_exist_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_term_exist_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_term_exist_exp(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_term_exist_exp(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_term_exist_exp(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_forgn_term_exist_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_forgn_term_exist_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_forgn_term_exist_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_orig_org_structure_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_orig_org_structure_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_orig_org_structure_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_for_profit_ind(SALT35.StrType s0) := MakeFT_invalid_flag_code(s0);
EXPORT InValid_corp_for_profit_ind(SALT35.StrType s) := InValidFT_invalid_flag_code(s);
EXPORT InValidMessage_corp_for_profit_ind(UNSIGNED1 wh) := InValidMessageFT_invalid_flag_code(wh);
 
EXPORT Make_corp_public_or_private_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_public_or_private_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_public_or_private_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_sic_code(SALT35.StrType s0) := s0;
EXPORT InValid_corp_sic_code(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_sic_code(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_naic_code(SALT35.StrType s0) := s0;
EXPORT InValid_corp_naic_code(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_naic_code(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_orig_bus_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_orig_bus_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_orig_bus_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_orig_bus_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_orig_bus_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_orig_bus_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_entity_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_entity_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_entity_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_certificate_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_certificate_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_certificate_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_internal_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_internal_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_internal_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_previous_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_previous_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_previous_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_microfilm_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_microfilm_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_microfilm_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_amendments_filed(SALT35.StrType s0) := s0;
EXPORT InValid_corp_amendments_filed(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_amendments_filed(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_acts(SALT35.StrType s0) := s0;
EXPORT InValid_corp_acts(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_acts(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_partnership_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_partnership_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_partnership_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_mfg_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_mfg_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_mfg_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_addl_info(SALT35.StrType s0) := s0;
EXPORT InValid_corp_addl_info(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_addl_info(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_taxes(SALT35.StrType s0) := s0;
EXPORT InValid_corp_taxes(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_taxes(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_franchise_taxes(SALT35.StrType s0) := s0;
EXPORT InValid_corp_franchise_taxes(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_franchise_taxes(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_tax_program_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_tax_program_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_tax_program_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_tax_program_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_tax_program_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_tax_program_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_full_name(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_full_name(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_full_name(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_fname(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_fname(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_fname(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_mname(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_mname(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_mname(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_lname(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_lname(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_lname(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_suffix(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_suffix(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_suffix(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_title_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_title_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_title_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_title_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_title_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_title_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_fein(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_fein(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_fein(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_ssn(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_ssn(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_ssn(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_dob(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_dob(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_dob(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_resign_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_resign_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_resign_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_no_comp(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_no_comp(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_no_comp(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_no_comp_igs(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_no_comp_igs(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_no_comp_igs(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_addl_info(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_addl_info(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_addl_info(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_address_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_address_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_address_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_address_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_address_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_address_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_address_line1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_address_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_address_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_address_line2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_address_line2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_address_line2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_address_line3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_address_line3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_address_line3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_phone_number(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_phone_number(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_phone_number(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_phone_number_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_phone_number_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_phone_number_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_phone_number_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_phone_number_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_phone_number_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_fax_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_fax_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_fax_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_email_address(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_email_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_email_address(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_web_address(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_web_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_web_address(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_prep_addr1_line1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_prep_addr1_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_prep_addr1_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_prep_addr1_last_line(SALT35.StrType s0) := s0;
EXPORT InValid_corp_prep_addr1_last_line(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_prep_addr1_last_line(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_prep_addr2_line1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_prep_addr2_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_prep_addr2_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_prep_addr2_last_line(SALT35.StrType s0) := s0;
EXPORT InValid_corp_prep_addr2_last_line(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_prep_addr2_last_line(UNSIGNED1 wh) := '';
 
EXPORT Make_ra_prep_addr_line1(SALT35.StrType s0) := s0;
EXPORT InValid_ra_prep_addr_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_ra_prep_addr_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_ra_prep_addr_last_line(SALT35.StrType s0) := s0;
EXPORT InValid_ra_prep_addr_last_line(SALT35.StrType s) := 0;
EXPORT InValidMessage_ra_prep_addr_last_line(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_filing_reference_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_cont_filing_reference_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_filing_reference_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_filing_date(SALT35.StrType s0) := s0;
EXPORT InValid_cont_filing_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_filing_date(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_filing_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_filing_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_filing_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_filing_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_filing_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_filing_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_full_name(SALT35.StrType s0) := s0;
EXPORT InValid_cont_full_name(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_full_name(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_fname(SALT35.StrType s0) := s0;
EXPORT InValid_cont_fname(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_fname(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_mname(SALT35.StrType s0) := s0;
EXPORT InValid_cont_mname(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_mname(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_lname(SALT35.StrType s0) := s0;
EXPORT InValid_cont_lname(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_lname(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_suffix(SALT35.StrType s0) := s0;
EXPORT InValid_cont_suffix(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_suffix(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_title1_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_title1_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_title1_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_title2_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_title2_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_title2_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_title3_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_title3_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_title3_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_title4_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_title4_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_title4_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_title5_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_title5_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_title5_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_fein(SALT35.StrType s0) := s0;
EXPORT InValid_cont_fein(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_fein(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_ssn(SALT35.StrType s0) := s0;
EXPORT InValid_cont_ssn(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_ssn(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_dob(SALT35.StrType s0) := s0;
EXPORT InValid_cont_dob(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_dob(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_status_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_status_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_status_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_status_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_cont_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_effective_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_effective_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_effective_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_effective_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_effective_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_effective_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_addl_info(SALT35.StrType s0) := s0;
EXPORT InValid_cont_addl_info(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_addl_info(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_line1(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_line2(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_line2(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_line2(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_line3(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_line3(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_line3(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_address_county(SALT35.StrType s0) := s0;
EXPORT InValid_cont_address_county(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_address_county(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_phone_number(SALT35.StrType s0) := s0;
EXPORT InValid_cont_phone_number(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_phone_number(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_phone_number_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_cont_phone_number_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_phone_number_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_phone_number_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_cont_phone_number_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_phone_number_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_fax_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_cont_fax_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_fax_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_email_address(SALT35.StrType s0) := s0;
EXPORT InValid_cont_email_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_email_address(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_web_address(SALT35.StrType s0) := s0;
EXPORT InValid_cont_web_address(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_web_address(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_acres(SALT35.StrType s0) := s0;
EXPORT InValid_corp_acres(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_acres(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_employment_security_approval_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_employment_security_approval_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_employment_security_approval_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_pending_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_pending_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_pending_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_pending_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_pending_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_pending_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_statement_of_intent_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_statement_of_intent_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_statement_of_intent_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_action_tax_dept_approval_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_action_tax_dept_approval_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_action_tax_dept_approval_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_acts2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_acts2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_acts2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_acts3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_acts3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_acts3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_additional_principals(SALT35.StrType s0) := s0;
EXPORT InValid_corp_additional_principals(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_additional_principals(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_address_office_type(SALT35.StrType s0) := s0;
EXPORT InValid_corp_address_office_type(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_address_office_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_assign_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_assign_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_assign_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_commercial(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_commercial(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_commercial(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_country(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_country(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_country(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_county(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_county(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_county(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_status_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_status_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_status_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_status_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agent_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agent_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agriculture_flag(SALT35.StrType s0) := s0;
EXPORT InValid_corp_agriculture_flag(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_agriculture_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_authorized_partners(SALT35.StrType s0) := s0;
EXPORT InValid_corp_authorized_partners(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_authorized_partners(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_comment(SALT35.StrType s0) := s0;
EXPORT InValid_corp_comment(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_comment(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_consent_flag_for_protected_name(SALT35.StrType s0) := s0;
EXPORT InValid_corp_consent_flag_for_protected_name(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_consent_flag_for_protected_name(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_converted(SALT35.StrType s0) := s0;
EXPORT InValid_corp_converted(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_converted(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_converted_from(SALT35.StrType s0) := s0;
EXPORT InValid_corp_converted_from(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_converted_from(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_country_of_formation(SALT35.StrType s0) := s0;
EXPORT InValid_corp_country_of_formation(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_country_of_formation(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_date_of_organization_meeting(SALT35.StrType s0) := s0;
EXPORT InValid_corp_date_of_organization_meeting(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_date_of_organization_meeting(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_delayed_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_delayed_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_delayed_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_directors_from_to(SALT35.StrType s0) := s0;
EXPORT InValid_corp_directors_from_to(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_directors_from_to(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_dissolved_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_dissolved_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_dissolved_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_farm_exemptions(SALT35.StrType s0) := s0;
EXPORT InValid_corp_farm_exemptions(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_farm_exemptions(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_farm_qual_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_farm_qual_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_farm_qual_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_farm_status_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_farm_status_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_farm_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_farm_status_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_farm_status_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_farm_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_farm_status_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_farm_status_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_farm_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_fiscal_year_month(SALT35.StrType s0) := s0;
EXPORT InValid_corp_fiscal_year_month(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_fiscal_year_month(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_foreign_fiduciary_capacity_in_state(SALT35.StrType s0) := s0;
EXPORT InValid_corp_foreign_fiduciary_capacity_in_state(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_foreign_fiduciary_capacity_in_state(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_governing_statute(SALT35.StrType s0) := s0;
EXPORT InValid_corp_governing_statute(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_governing_statute(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_members(SALT35.StrType s0) := s0;
EXPORT InValid_corp_has_members(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_has_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_has_vested_managers(SALT35.StrType s0) := s0;
EXPORT InValid_corp_has_vested_managers(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_has_vested_managers(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_home_incorporated_county(SALT35.StrType s0) := s0;
EXPORT InValid_corp_home_incorporated_county(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_home_incorporated_county(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_home_state_name(SALT35.StrType s0) := s0;
EXPORT InValid_corp_home_state_name(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_home_state_name(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_is_professional(SALT35.StrType s0) := s0;
EXPORT InValid_corp_is_professional(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_is_professional(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_is_non_profit_irs_approved(SALT35.StrType s0) := s0;
EXPORT InValid_corp_is_non_profit_irs_approved(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_is_non_profit_irs_approved(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_last_renewal_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_last_renewal_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_last_renewal_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_last_renewal_year(SALT35.StrType s0) := s0;
EXPORT InValid_corp_last_renewal_year(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_last_renewal_year(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_license_type(SALT35.StrType s0) := s0;
EXPORT InValid_corp_license_type(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_license_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_llc_managed_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_llc_managed_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_llc_managed_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_llc_managed_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_llc_managed_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_llc_managed_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_management_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_management_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_management_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_management_type(SALT35.StrType s0) := s0;
EXPORT InValid_corp_management_type(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_management_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_manager_managed(SALT35.StrType s0) := s0;
EXPORT InValid_corp_manager_managed(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_manager_managed(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merged_corporation_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merged_corporation_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merged_corporation_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merged_fein(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merged_fein(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merged_fein(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_allowed_flag(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_allowed_flag(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_allowed_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_indicator(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_indicator(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_indicator(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_name(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_name(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_name(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_type_converted_to_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_type_converted_to_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_type_converted_to_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_merger_type_converted_to_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_merger_type_converted_to_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_merger_type_converted_to_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_naics_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_naics_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_naics_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_effective_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_effective_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_effective_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_expiration_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_expiration_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_expiration_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_type(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_type(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_reservation_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_status_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_status_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_name_status_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_name_status_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_irs_approved_purpose(SALT35.StrType s0) := s0;
EXPORT InValid_corp_non_profit_irs_approved_purpose(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_non_profit_irs_approved_purpose(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_non_profit_solicit_donations(SALT35.StrType s0) := s0;
EXPORT InValid_corp_non_profit_solicit_donations(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_non_profit_solicit_donations(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_amendments(SALT35.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_amendments(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_amendments(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_initial_llc_members(SALT35.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_initial_llc_members(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_initial_llc_members(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_nbr_of_partners(SALT35.StrType s0) := s0;
EXPORT InValid_corp_nbr_of_partners(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_nbr_of_partners(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_operating_agreement(SALT35.StrType s0) := s0;
EXPORT InValid_corp_operating_agreement(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_operating_agreement(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_opt_in_llc_act_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_opt_in_llc_act_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_opt_in_llc_act_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_opt_in_llc_act_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_opt_in_llc_act_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_opt_in_llc_act_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_organizational_comments(SALT35.StrType s0) := s0;
EXPORT InValid_corp_organizational_comments(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_organizational_comments(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_partner_contributions_total(SALT35.StrType s0) := s0;
EXPORT InValid_corp_partner_contributions_total(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_partner_contributions_total(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_partner_terms(SALT35.StrType s0) := s0;
EXPORT InValid_corp_partner_terms(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_partner_terms(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_percentage_voters_required_to_approve_amendments(SALT35.StrType s0) := s0;
EXPORT InValid_corp_percentage_voters_required_to_approve_amendments(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_percentage_voters_required_to_approve_amendments(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_profession(SALT35.StrType s0) := s0;
EXPORT InValid_corp_profession(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_profession(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_province(SALT35.StrType s0) := s0;
EXPORT InValid_corp_province(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_province(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_public_mutual_corporation(SALT35.StrType s0) := s0;
EXPORT InValid_corp_public_mutual_corporation(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_public_mutual_corporation(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_purpose(SALT35.StrType s0) := s0;
EXPORT InValid_corp_purpose(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_purpose(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_ra_required_flag(SALT35.StrType s0) := s0;
EXPORT InValid_corp_ra_required_flag(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_ra_required_flag(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_registered_counties(SALT35.StrType s0) := s0;
EXPORT InValid_corp_registered_counties(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_registered_counties(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_regulated_ind(SALT35.StrType s0) := s0;
EXPORT InValid_corp_regulated_ind(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_regulated_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_renewal_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_renewal_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_renewal_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_standing_other(SALT35.StrType s0) := s0;
EXPORT InValid_corp_standing_other(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_standing_other(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_survivor_corporation_id(SALT35.StrType s0) := s0;
EXPORT InValid_corp_survivor_corporation_id(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_survivor_corporation_id(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_tax_base(SALT35.StrType s0) := s0;
EXPORT InValid_corp_tax_base(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_tax_base(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_tax_standing(SALT35.StrType s0) := s0;
EXPORT InValid_corp_tax_standing(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_tax_standing(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_termination_cd(SALT35.StrType s0) := s0;
EXPORT InValid_corp_termination_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_termination_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_termination_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_termination_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_termination_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_termination_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_termination_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_termination_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_business_mark_type(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_business_mark_type(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_business_mark_type(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_cancelled_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_cancelled_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_cancelled_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc4(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc4(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc4(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc5(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc5(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc5(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_desc6(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_desc6(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_class_desc6(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_classification_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_classification_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_classification_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_disclaimer1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_disclaimer1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_disclaimer1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_disclaimer2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_disclaimer2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_disclaimer2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_expiration_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_expiration_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_expiration_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_filing_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_filing_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_filing_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_first_use_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_first_use_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_first_use_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_first_use_date_in_state(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_first_use_date_in_state(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_first_use_date_in_state(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_keywords(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_keywords(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_keywords(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_logo(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_logo(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_logo(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_name_expiration_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_name_expiration_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_name_expiration_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_renewal_date(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_renewal_date(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_renewal_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_status(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_status(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_status(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_used_1(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_used_1(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_used_1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_used_2(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_used_2(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_used_2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_used_3(SALT35.StrType s0) := s0;
EXPORT InValid_corp_trademark_used_3(SALT35.StrType s) := 0;
EXPORT InValidMessage_corp_trademark_used_3(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_owner_percentage(SALT35.StrType s0) := s0;
EXPORT InValid_cont_owner_percentage(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_owner_percentage(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_country(SALT35.StrType s0) := s0;
EXPORT InValid_cont_country(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_country(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_country_mailing(SALT35.StrType s0) := s0;
EXPORT InValid_cont_country_mailing(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_country_mailing(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_nondislosure(SALT35.StrType s0) := s0;
EXPORT InValid_cont_nondislosure(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_nondislosure(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_prep_addr_line1(SALT35.StrType s0) := s0;
EXPORT InValid_cont_prep_addr_line1(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_prep_addr_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_prep_addr_last_line(SALT35.StrType s0) := s0;
EXPORT InValid_cont_prep_addr_last_line(SALT35.StrType s) := 0;
EXPORT InValidMessage_cont_prep_addr_last_line(UNSIGNED1 wh) := '';
 
EXPORT Make_recordorigin(SALT35.StrType s0) := MakeFT_invalid_recordorigin(s0);
EXPORT InValid_recordorigin(SALT35.StrType s) := InValidFT_invalid_recordorigin(s);
EXPORT InValidMessage_recordorigin(UNSIGNED1 wh) := InValidMessageFT_invalid_recordorigin(wh);
 
EXPORT Make_internalfield1(SALT35.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_internalfield1(SALT35.StrType s) := InValidFT_invalid_alphablank(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT35,Scrubs_Corp2_Mapping_VT_Main;
