...
Command line options: -MScrubs_Corp2_Mapping_VT_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR8C00.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_VT_Main
FILENAME:In_File
...
FIELDTYPE:invalid_corp_vendor:ENUM(50)
FIELDTYPE:invalid_state_origin:ENUM(VT)
...
FIELDTYPE:invalid_alphablankSp:ALLOW( ,ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_vt_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_status_desc:ENUM(Scrubs_Corp2_Mapping_vt_Main.Functions.set_valid_status_desc  )
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphablankSp):0,0
