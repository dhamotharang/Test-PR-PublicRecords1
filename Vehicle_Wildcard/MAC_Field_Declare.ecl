...
// unsigned4 lookupName(string lookFor)  := CHOOSEN (nameIndex (str=lookFor), 1)[1].i;
// unsigned4 lookupModel(string lookFor) := CHOOSEN (modelIndex(str=lookFor), 1)[1].i;
...
// vehicle_wildcard.MAC_SetConvert(_make, vehicle_wildcard.Make2Code, make_use, 'make_use')
