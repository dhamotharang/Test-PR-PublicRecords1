...
kStCityLFMName	:= BUILDINDEX(City_d1,{st,city_from_zip,lfm,(big_endian unsigned8 )__filepos},
								LN_property.base_key_name + 'property_search.st.city.lfmname_' + LN_Property.version_development, MOXIE);
...
kStCityCNFID	:= BUILDINDEX(City_d2,{st,city_from_zip,cn,fid,(big_endian unsigned8 )__filepos},
								LN_property.base_key_name + 'property_search.st.city.cn.fid_'+ LN_Property.version_development, MOXIE);
...
kStCityNameasis	:= BUILDINDEX(City_d3,{st,city_from_zip,nameasis,(big_endian unsigned8 )__filepos},
								LN_property.base_key_name + 'property_search.st.city.nameasis_'+ LN_Property.version_development, MOXIE);
