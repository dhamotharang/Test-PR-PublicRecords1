...
EXPORT Summary(SALT311.Str30Type  txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_cleanfulladdr_cnt := COUNT(GROUP,h.cleanfulladdr <> (TYPEOF(h.cleanfulladdr))'');
    populated_cleanfulladdr_pcnt := AVE(GROUP,IF(h.cleanfulladdr = (TYPEOF(h.cleanfulladdr))'',0,100));
    maxlength_cleanfulladdr := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.cleanfulladdr)));
    avelength_cleanfulladdr := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.cleanfulladdr)),h.cleanfulladdr<>(typeof(h.cleanfulladdr))'');
    ...
    populated_collegeupdate_cnt := COUNT(GROUP,h.collegeupdate <> (TYPEOF(h.collegeupdate))'');
    populated_collegeupdate_pcnt := AVE(GROUP,IF(h.collegeupdate = (TYPEOF(h.collegeupdate))'',0,100));
    maxlength_collegeupdate := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.collegeupdate)));
    avelength_collegeupdate := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.collegeupdate)),h.collegeupdate<>(typeof(h.collegeupdate))'');
  END;
    T := IF(Glob,TABLE(h,SummaryLayout),TABLE(h,SummaryLayout,cleancollegeid,FEW));
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_cleanaddr1_pcnt *   0.00 / 100 + T.Populated_cleanaddr2_pcnt *   0.00 / 100 + T.Populated_cleanattendancedte_pcnt *   0.00 / 100 + T.Populated_cleancity_pcnt *   0.00 / 100 + T.Populated_cleanstate_pcnt *   0.00 / 100 + T.Populated_cleanzip_pcnt *   0.00 / 100 + T.Populated_cleanzip4_pcnt *   0.00 / 100 + T.Populated_cleanfulladdr_pcnt *   0.00 / 100 + T.Populated_cleandob_pcnt *   0.00 / 100 + T.Populated_cleanupdatedte_pcnt *   0.00 / 100 + T.Populated_cleanemail_pcnt *   0.00 / 100 + T.Populated_append_email_username_pcnt *   0.00 / 100 + T.Populated_append_domain_pcnt *   0.00 / 100 + T.Populated_append_domain_type_pcnt *   0.00 / 100 + T.Populated_append_domain_root_pcnt *   0.00 / 100 + T.Populated_append_domain_ext_pcnt *   0.00 / 100 + T.Populated_append_is_tld_state_pcnt *   0.00 / 100 + T.Populated_append_is_tld_generic_pcnt *   0.00 / 100 + T.Populated_append_is_tld_country_pcnt *   0.00 / 100 + T.Populated_append_is_valid_domain_ext_pcnt *   0.00 / 100 + T.Populated_cleantitle_pcnt *   0.00 / 100 + T.Populated_cleanfirstname_pcnt *   0.00 / 100 + T.Populated_cleanmidname_pcnt *   0.00 / 100 + T.Populated_cleanlastname_pcnt *   0.00 / 100 + T.Populated_cleansuffixname_pcnt *   0.00 / 100 + T.Populated_cleanmajor_pcnt *   0.00 / 100 + T.Populated_cleanphone_pcnt *   0.00 / 100 + T.Populated_did_pcnt *   0.00 / 100 + T.Populated_process_date_pcnt *   0.00 / 100 + T.Populated_date_first_seen_pcnt *   0.00 / 100 + T.Populated_date_last_seen_pcnt *   0.00 / 100 + T.Populated_date_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_date_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_dateadded_pcnt *   0.00 / 100 + T.Populated_dateupdated_pcnt *   0.00 / 100 + T.Populated_studentid_pcnt *   0.00 / 100 + T.Populated_dartid_pcnt *   0.00 / 100 + T.Populated_collegeid_pcnt *   0.00 / 100 + T.Populated_projectsource_pcnt *   0.00 / 100 + T.Populated_collegestate_pcnt *   0.00 / 100 + T.Populated_college_pcnt *   0.00 / 100 + T.Populated_semester_pcnt *   0.00 / 100 + T.Populated_year_pcnt *   0.00 / 100 + T.Populated_firstname_pcnt *   0.00 / 100 + T.Populated_middlename_pcnt *   0.00 / 100 + T.Populated_lastname_pcnt *   0.00 / 100 + T.Populated_suffix_pcnt *   0.00 / 100 + T.Populated_major_pcnt *   0.00 / 100 + T.Populated_grade_pcnt *   0.00 / 100 + T.Populated_email_pcnt *   0.00 / 100 + T.Populated_dateofbirth_pcnt *   0.00 / 100 + T.Populated_dob_formatted_pcnt *   0.00 / 100 + T.Populated_attendancedate_pcnt *   0.00 / 100 + T.Populated_enrollmentstatus_pcnt *   0.00 / 100 + T.Populated_addresstype_pcnt *   0.00 / 100 + T.Populated_address_1_pcnt *   0.00 / 100 + T.Populated_address_2_pcnt *   0.00 / 100 + T.Populated_city_pcnt *   0.00 / 100 + T.Populated_state_pcnt *   0.00 / 100 + T.Populated_z5_pcnt *   0.00 / 100 + T.Populated_z4_pcnt *   0.00 / 100 + T.Populated_phonetyp_pcnt *   0.00 / 100 + T.Populated_phonenumber_pcnt *   0.00 / 100 + T.Populated_tier_pcnt *   0.00 / 100 + T.Populated_school_size_code_pcnt *   0.00 / 100 + T.Populated_competitive_code_pcnt *   0.00 / 100 + T.Populated_tuition_code_pcnt *   0.00 / 100 + T.Populated_title_pcnt *   0.00 / 100 + T.Populated_fname_pcnt *   0.00 / 100 + T.Populated_mname_pcnt *   0.00 / 100 + T.Populated_lname_pcnt *   0.00 / 100 + T.Populated_name_suffix_pcnt *   0.00 / 100 + T.Populated_name_score_pcnt *   0.00 / 100 + T.Populated_rawaid_pcnt *   0.00 / 100 + T.Populated_prim_range_pcnt *   0.00 / 100 + T.Populated_predir_pcnt *   0.00 / 100 + T.Populated_prim_name_pcnt *   0.00 / 100 + T.Populated_addr_suffix_pcnt *   0.00 / 100 + T.Populated_postdir_pcnt *   0.00 / 100 + T.Populated_unit_desig_pcnt *   0.00 / 100 + T.Populated_sec_range_pcnt *   0.00 / 100 + T.Populated_p_city_name_pcnt *   0.00 / 100 + T.Populated_v_city_name_pcnt *   0.00 / 100 + T.Populated_st_pcnt *   0.00 / 100 + T.Populated_zip_pcnt *   0.00 / 100 + T.Populated_zip4_pcnt *   0.00 / 100 + T.Populated_cart_pcnt *   0.00 / 100 + T.Populated_cr_sort_sz_pcnt *   0.00 / 100 + T.Populated_lot_pcnt *   0.00 / 100 + T.Populated_lot_order_pcnt *   0.00 / 100 + T.Populated_dpbc_pcnt *   0.00 / 100 + T.Populated_chk_digit_pcnt *   0.00 / 100 + T.Populated_rec_type_pcnt *   0.00 / 100 + T.Populated_county_pcnt *   0.00 / 100 + T.Populated_fips_state_pcnt *   0.00 / 100 + T.Populated_fips_county_pcnt *   0.00 / 100 + T.Populated_geo_lat_pcnt *   0.00 / 100 + T.Populated_geo_long_pcnt *   0.00 / 100 + T.Populated_msa_pcnt *   0.00 / 100 + T.Populated_geo_blk_pcnt *   0.00 / 100 + T.Populated_geo_match_pcnt *   0.00 / 100 + T.Populated_err_stat_pcnt *   0.00 / 100 + T.Populated_telephone_pcnt *   0.00 / 100 + T.Populated_tier2_pcnt *   0.00 / 100 + T.Populated_source_pcnt *   0.00 / 100 + T.Populated_key_pcnt *   0.00 / 100 + T.Populated_ssn_pcnt *   0.00 / 100 + T.Populated_historical_flag_pcnt *   0.00 / 100 + T.Populated_full_name_pcnt *   0.00 / 100 + T.Populated_college_class_pcnt *   0.00 / 100 + T.Populated_college_name_pcnt *   0.00 / 100 + T.Populated_ln_college_name_pcnt *   0.00 / 100 + T.Populated_college_major_pcnt *   0.00 / 100 + T.Populated_new_college_major_pcnt *   0.00 / 100 + T.Populated_college_code_pcnt *   0.00 / 100 + T.Populated_college_code_exploded_pcnt *   0.00 / 100 + T.Populated_college_type_pcnt *   0.00 / 100 + T.Populated_college_type_exploded_pcnt *   0.00 / 100 + T.Populated_file_type_pcnt *   0.00 / 100 + T.Populated_collegeupdate_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
EXPORT SourceCounts := Summary('SummaryBySource',FALSE);
  ...
  R T(SourceCounts le, SourceCounts ri) := TRANSFORM
    ...
    SELF.LinkingPotential := 0 + le.Populated_cleanaddr1_pcnt*ri.Populated_cleanaddr1_pcnt *   0.00 / 10000 + le.Populated_cleanaddr2_pcnt*ri.Populated_cleanaddr2_pcnt *   0.00 / 10000 + le.Populated_cleanattendancedte_pcnt*ri.Populated_cleanattendancedte_pcnt *   0.00 / 10000 + le.Populated_cleancity_pcnt*ri.Populated_cleancity_pcnt *   0.00 / 10000 + le.Populated_cleanstate_pcnt*ri.Populated_cleanstate_pcnt *   0.00 / 10000 + le.Populated_cleanzip_pcnt*ri.Populated_cleanzip_pcnt *   0.00 / 10000 + le.Populated_cleanzip4_pcnt*ri.Populated_cleanzip4_pcnt *   0.00 / 10000 + le.Populated_cleanfulladdr_pcnt*ri.Populated_cleanfulladdr_pcnt *   0.00 / 10000 + le.Populated_cleandob_pcnt*ri.Populated_cleandob_pcnt *   0.00 / 10000 + le.Populated_cleanupdatedte_pcnt*ri.Populated_cleanupdatedte_pcnt *   0.00 / 10000 + le.Populated_cleanemail_pcnt*ri.Populated_cleanemail_pcnt *   0.00 / 10000 + le.Populated_append_email_username_pcnt*ri.Populated_append_email_username_pcnt *   0.00 / 10000 + le.Populated_append_domain_pcnt*ri.Populated_append_domain_pcnt *   0.00 / 10000 + le.Populated_append_domain_type_pcnt*ri.Populated_append_domain_type_pcnt *   0.00 / 10000 + le.Populated_append_domain_root_pcnt*ri.Populated_append_domain_root_pcnt *   0.00 / 10000 + le.Populated_append_domain_ext_pcnt*ri.Populated_append_domain_ext_pcnt *   0.00 / 10000 + le.Populated_append_is_tld_state_pcnt*ri.Populated_append_is_tld_state_pcnt *   0.00 / 10000 + le.Populated_append_is_tld_generic_pcnt*ri.Populated_append_is_tld_generic_pcnt *   0.00 / 10000 + le.Populated_append_is_tld_country_pcnt*ri.Populated_append_is_tld_country_pcnt *   0.00 / 10000 + le.Populated_append_is_valid_domain_ext_pcnt*ri.Populated_append_is_valid_domain_ext_pcnt *   0.00 / 10000 + le.Populated_cleantitle_pcnt*ri.Populated_cleantitle_pcnt *   0.00 / 10000 + le.Populated_cleanfirstname_pcnt*ri.Populated_cleanfirstname_pcnt *   0.00 / 10000 + le.Populated_cleanmidname_pcnt*ri.Populated_cleanmidname_pcnt *   0.00 / 10000 + le.Populated_cleanlastname_pcnt*ri.Populated_cleanlastname_pcnt *   0.00 / 10000 + le.Populated_cleansuffixname_pcnt*ri.Populated_cleansuffixname_pcnt *   0.00 / 10000 + le.Populated_cleanmajor_pcnt*ri.Populated_cleanmajor_pcnt *   0.00 / 10000 + le.Populated_cleanphone_pcnt*ri.Populated_cleanphone_pcnt *   0.00 / 10000 + le.Populated_did_pcnt*ri.Populated_did_pcnt *   0.00 / 10000 + le.Populated_process_date_pcnt*ri.Populated_process_date_pcnt *   0.00 / 10000 + le.Populated_date_first_seen_pcnt*ri.Populated_date_first_seen_pcnt *   0.00 / 10000 + le.Populated_date_last_seen_pcnt*ri.Populated_date_last_seen_pcnt *   0.00 / 10000 + le.Populated_date_vendor_first_reported_pcnt*ri.Populated_date_vendor_first_reported_pcnt *   0.00 / 10000 + le.Populated_date_vendor_last_reported_pcnt*ri.Populated_date_vendor_last_reported_pcnt *   0.00 / 10000 + le.Populated_dateadded_pcnt*ri.Populated_dateadded_pcnt *   0.00 / 10000 + le.Populated_dateupdated_pcnt*ri.Populated_dateupdated_pcnt *   0.00 / 10000 + le.Populated_studentid_pcnt*ri.Populated_studentid_pcnt *   0.00 / 10000 + le.Populated_dartid_pcnt*ri.Populated_dartid_pcnt *   0.00 / 10000 + le.Populated_collegeid_pcnt*ri.Populated_collegeid_pcnt *   0.00 / 10000 + le.Populated_projectsource_pcnt*ri.Populated_projectsource_pcnt *   0.00 / 10000 + le.Populated_collegestate_pcnt*ri.Populated_collegestate_pcnt *   0.00 / 10000 + le.Populated_college_pcnt*ri.Populated_college_pcnt *   0.00 / 10000 + le.Populated_semester_pcnt*ri.Populated_semester_pcnt *   0.00 / 10000 + le.Populated_year_pcnt*ri.Populated_year_pcnt *   0.00 / 10000 + le.Populated_firstname_pcnt*ri.Populated_firstname_pcnt *   0.00 / 10000 + le.Populated_middlename_pcnt*ri.Populated_middlename_pcnt *   0.00 / 10000 + le.Populated_lastname_pcnt*ri.Populated_lastname_pcnt *   0.00 / 10000 + le.Populated_suffix_pcnt*ri.Populated_suffix_pcnt *   0.00 / 10000 + le.Populated_major_pcnt*ri.Populated_major_pcnt *   0.00 / 10000 + le.Populated_grade_pcnt*ri.Populated_grade_pcnt *   0.00 / 10000 + le.Populated_email_pcnt*ri.Populated_email_pcnt *   0.00 / 10000 + le.Populated_dateofbirth_pcnt*ri.Populated_dateofbirth_pcnt *   0.00 / 10000 + le.Populated_dob_formatted_pcnt*ri.Populated_dob_formatted_pcnt *   0.00 / 10000 + le.Populated_attendancedate_pcnt*ri.Populated_attendancedate_pcnt *   0.00 / 10000 + le.Populated_enrollmentstatus_pcnt*ri.Populated_enrollmentstatus_pcnt *   0.00 / 10000 + le.Populated_addresstype_pcnt*ri.Populated_addresstype_pcnt *   0.00 / 10000 + le.Populated_address_1_pcnt*ri.Populated_address_1_pcnt *   0.00 / 10000 + le.Populated_address_2_pcnt*ri.Populated_address_2_pcnt *   0.00 / 10000 + le.Populated_city_pcnt*ri.Populated_city_pcnt *   0.00 / 10000 + le.Populated_state_pcnt*ri.Populated_state_pcnt *   0.00 / 10000 + le.Populated_z5_pcnt*ri.Populated_z5_pcnt *   0.00 / 10000 + le.Populated_z4_pcnt*ri.Populated_z4_pcnt *   0.00 / 10000 + le.Populated_phonetyp_pcnt*ri.Populated_phonetyp_pcnt *   0.00 / 10000 + le.Populated_phonenumber_pcnt*ri.Populated_phonenumber_pcnt *   0.00 / 10000 + le.Populated_tier_pcnt*ri.Populated_tier_pcnt *   0.00 / 10000 + le.Populated_school_size_code_pcnt*ri.Populated_school_size_code_pcnt *   0.00 / 10000 + le.Populated_competitive_code_pcnt*ri.Populated_competitive_code_pcnt *   0.00 / 10000 + le.Populated_tuition_code_pcnt*ri.Populated_tuition_code_pcnt *   0.00 / 10000 + le.Populated_title_pcnt*ri.Populated_title_pcnt *   0.00 / 10000 + le.Populated_fname_pcnt*ri.Populated_fname_pcnt *   0.00 / 10000 + le.Populated_mname_pcnt*ri.Populated_mname_pcnt *   0.00 / 10000 + le.Populated_lname_pcnt*ri.Populated_lname_pcnt *   0.00 / 10000 + le.Populated_name_suffix_pcnt*ri.Populated_name_suffix_pcnt *   0.00 / 10000 + le.Populated_name_score_pcnt*ri.Populated_name_score_pcnt *   0.00 / 10000 + le.Populated_rawaid_pcnt*ri.Populated_rawaid_pcnt *   0.00 / 10000 + le.Populated_prim_range_pcnt*ri.Populated_prim_range_pcnt *   0.00 / 10000 + le.Populated_predir_pcnt*ri.Populated_predir_pcnt *   0.00 / 10000 + le.Populated_prim_name_pcnt*ri.Populated_prim_name_pcnt *   0.00 / 10000 + le.Populated_addr_suffix_pcnt*ri.Populated_addr_suffix_pcnt *   0.00 / 10000 + le.Populated_postdir_pcnt*ri.Populated_postdir_pcnt *   0.00 / 10000 + le.Populated_unit_desig_pcnt*ri.Populated_unit_desig_pcnt *   0.00 / 10000 + le.Populated_sec_range_pcnt*ri.Populated_sec_range_pcnt *   0.00 / 10000 + le.Populated_p_city_name_pcnt*ri.Populated_p_city_name_pcnt *   0.00 / 10000 + le.Populated_v_city_name_pcnt*ri.Populated_v_city_name_pcnt *   0.00 / 10000 + le.Populated_st_pcnt*ri.Populated_st_pcnt *   0.00 / 10000 + le.Populated_zip_pcnt*ri.Populated_zip_pcnt *   0.00 / 10000 + le.Populated_zip4_pcnt*ri.Populated_zip4_pcnt *   0.00 / 10000 + le.Populated_cart_pcnt*ri.Populated_cart_pcnt *   0.00 / 10000 + le.Populated_cr_sort_sz_pcnt*ri.Populated_cr_sort_sz_pcnt *   0.00 / 10000 + le.Populated_lot_pcnt*ri.Populated_lot_pcnt *   0.00 / 10000 + le.Populated_lot_order_pcnt*ri.Populated_lot_order_pcnt *   0.00 / 10000 + le.Populated_dpbc_pcnt*ri.Populated_dpbc_pcnt *   0.00 / 10000 + le.Populated_chk_digit_pcnt*ri.Populated_chk_digit_pcnt *   0.00 / 10000 + le.Populated_rec_type_pcnt*ri.Populated_rec_type_pcnt *   0.00 / 10000 + le.Populated_county_pcnt*ri.Populated_county_pcnt *   0.00 / 10000 + le.Populated_fips_state_pcnt*ri.Populated_fips_state_pcnt *   0.00 / 10000 + le.Populated_fips_county_pcnt*ri.Populated_fips_county_pcnt *   0.00 / 10000 + le.Populated_geo_lat_pcnt*ri.Populated_geo_lat_pcnt *   0.00 / 10000 + le.Populated_geo_long_pcnt*ri.Populated_geo_long_pcnt *   0.00 / 10000 + le.Populated_msa_pcnt*ri.Populated_msa_pcnt *   0.00 / 10000 + le.Populated_geo_blk_pcnt*ri.Populated_geo_blk_pcnt *   0.00 / 10000 + le.Populated_geo_match_pcnt*ri.Populated_geo_match_pcnt *   0.00 / 10000 + le.Populated_err_stat_pcnt*ri.Populated_err_stat_pcnt *   0.00 / 10000 + le.Populated_telephone_pcnt*ri.Populated_telephone_pcnt *   0.00 / 10000 + le.Populated_tier2_pcnt*ri.Populated_tier2_pcnt *   0.00 / 10000 + le.Populated_source_pcnt*ri.Populated_source_pcnt *   0.00 / 10000 + le.Populated_key_pcnt*ri.Populated_key_pcnt *   0.00 / 10000 + le.Populated_ssn_pcnt*ri.Populated_ssn_pcnt *   0.00 / 10000 + le.Populated_historical_flag_pcnt*ri.Populated_historical_flag_pcnt *   0.00 / 10000 + le.Populated_full_name_pcnt*ri.Populated_full_name_pcnt *   0.00 / 10000 + le.Populated_college_class_pcnt*ri.Populated_college_class_pcnt *   0.00 / 10000 + le.Populated_college_name_pcnt*ri.Populated_college_name_pcnt *   0.00 / 10000 + le.Populated_ln_college_name_pcnt*ri.Populated_ln_college_name_pcnt *   0.00 / 10000 + le.Populated_college_major_pcnt*ri.Populated_college_major_pcnt *   0.00 / 10000 + le.Populated_new_college_major_pcnt*ri.Populated_new_college_major_pcnt *   0.00 / 10000 + le.Populated_college_code_pcnt*ri.Populated_college_code_pcnt *   0.00 / 10000 + le.Populated_college_code_exploded_pcnt*ri.Populated_college_code_exploded_pcnt *   0.00 / 10000 + le.Populated_college_type_pcnt*ri.Populated_college_type_pcnt *   0.00 / 10000 + le.Populated_college_type_exploded_pcnt*ri.Populated_college_type_exploded_pcnt *   0.00 / 10000 + le.Populated_file_type_pcnt*ri.Populated_file_type_pcnt *   0.00 / 10000 + le.Populated_collegeupdate_pcnt*ri.Populated_collegeupdate_pcnt *   0.00 / 10000;
  END;
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  ...
  END;
SHARED Pairs0 := NORMALIZE(ENTH(h,Config.CorrelateSampleSize),120*120,IntoP(LEFT,COUNTER))(FldNo1<FldNo2);
SHARED FldIds := DATASET([{1,'cleanaddr1'}
      ...
      ,{10,'cleanupdatedte'}
      ,{11,'cleanemail'}
      ,{12,'append_email_username'}
      ,{13,'append_domain'}
      ,{14,'append_domain_type'}
      ,{15,'append_domain_root'}
      ,{16,'append_domain_ext'}
      ,{17,'append_is_tld_state'}
      ,{18,'append_is_tld_generic'}
      ,{19,'append_is_tld_country'}
      ,{20,'append_is_valid_domain_ext'}
      ,{21,'cleantitle'}
      ,{22,'cleanfirstname'}
      ,{23,'cleanmidname'}
      ,{24,'cleanlastname'}
      ...
      ,{30,'date_first_seen'}
      ,{31,'date_last_seen'}
      ,{32,'date_vendor_first_reported'}
      ,{33,'date_vendor_last_reported'}
      ,{34,'dateadded'}
      ,{35,'dateupdated'}
      ,{36,'studentid'}
      ,{37,'dartid'}
      ...
      ,{112,'ln_college_name'}
      ,{113,'college_major'}
      ,{114,'new_college_major'}
      ,{115,'college_code'}
      ,{116,'college_code_exploded'}
      ,{117,'college_type'}
      ,{118,'college_type_exploded'}
      ,{119,'file_type'}
      ,{120,'collegeupdate'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_cleanfulladdr((SALT311.StrType)le.cleanfulladdr),
    ...
    Fields.InValid_collegeupdate((SALT311.StrType)le.collegeupdate),
    0);
  SELF.FieldNum := IF(SELF.ErrorNum=0,SKIP,c); // Bail early to avoid creating record
  SELF.cleancollegeid := le.cleancollegeid;
END;
Errors := NORMALIZE(h,120,NoteErrors(LEFT,COUNTER));
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_address','invalid_address','Unknown','invalid_city','invalid_state','Unknown','Unknown','Unknown','invalid_date','invalid_date','invalid_email','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_name','invalid_name','invalid_name','invalid_name','Unknown','invalid_phone','Unknown','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','nums','nums','Unknown','Unknown','Unknown','invalid_college','invalid_semester','nums','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_date','invalid_date','Unknown','Unknown','invalid_addresstype','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_phonetyp','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_suffix','Unknown','Unknown','invalid_address','invalid_address','invalid_address','invalid_address','invalid_address','invalid_address','invalid_address','invalid_city','invalid_city','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_phone','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','invalid_MajorCode','invalid_NewMajorCode','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_cleanaddr1(TotalErrors.ErrorNum),Fields.InValidMessage_cleanaddr2(TotalErrors.ErrorNum),Fields.InValidMessage_cleanattendancedte(TotalErrors.ErrorNum),Fields.InValidMessage_cleancity(TotalErrors.ErrorNum),Fields.InValidMessage_cleanstate(TotalErrors.ErrorNum),Fields.InValidMessage_cleanzip(TotalErrors.ErrorNum),Fields.InValidMessage_cleanzip4(TotalErrors.ErrorNum),Fields.InValidMessage_cleanfulladdr(TotalErrors.ErrorNum),Fields.InValidMessage_cleandob(TotalErrors.ErrorNum),Fields.InValidMessage_cleanupdatedte(TotalErrors.ErrorNum),Fields.InValidMessage_cleanemail(TotalErrors.ErrorNum),Fields.InValidMessage_append_email_username(TotalErrors.ErrorNum),Fields.InValidMessage_append_domain(TotalErrors.ErrorNum),Fields.InValidMessage_append_domain_type(TotalErrors.ErrorNum),Fields.InValidMessage_append_domain_root(TotalErrors.ErrorNum),Fields.InValidMessage_append_domain_ext(TotalErrors.ErrorNum),Fields.InValidMessage_append_is_tld_state(TotalErrors.ErrorNum),Fields.InValidMessage_append_is_tld_generic(TotalErrors.ErrorNum),Fields.InValidMessage_append_is_tld_country(TotalErrors.ErrorNum),Fields.InValidMessage_append_is_valid_domain_ext(TotalErrors.ErrorNum),Fields.InValidMessage_cleantitle(TotalErrors.ErrorNum),Fields.InValidMessage_cleanfirstname(TotalErrors.ErrorNum),Fields.InValidMessage_cleanmidname(TotalErrors.ErrorNum),Fields.InValidMessage_cleanlastname(TotalErrors.ErrorNum),Fields.InValidMessage_cleansuffixname(TotalErrors.ErrorNum),Fields.InValidMessage_cleanmajor(TotalErrors.ErrorNum),Fields.InValidMessage_cleanphone(TotalErrors.ErrorNum),Fields.InValidMessage_did(TotalErrors.ErrorNum),Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Fields.InValidMessage_date_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_date_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_date_vendor_first_reported(TotalErrors.ErrorNum),Fields.InValidMessage_date_vendor_last_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dateadded(TotalErrors.ErrorNum),Fields.InValidMessage_dateupdated(TotalErrors.ErrorNum),Fields.InValidMessage_studentid(TotalErrors.ErrorNum),Fields.InValidMessage_dartid(TotalErrors.ErrorNum),Fields.InValidMessage_collegeid(TotalErrors.ErrorNum),Fields.InValidMessage_projectsource(TotalErrors.ErrorNum),Fields.InValidMessage_collegestate(TotalErrors.ErrorNum),Fields.InValidMessage_college(TotalErrors.ErrorNum),Fields.InValidMessage_semester(TotalErrors.ErrorNum),Fields.InValidMessage_year(TotalErrors.ErrorNum),Fields.InValidMessage_firstname(TotalErrors.ErrorNum),Fields.InValidMessage_middlename(TotalErrors.ErrorNum),Fields.InValidMessage_lastname(TotalErrors.ErrorNum),Fields.InValidMessage_suffix(TotalErrors.ErrorNum),Fields.InValidMessage_major(TotalErrors.ErrorNum),Fields.InValidMessage_grade(TotalErrors.ErrorNum),Fields.InValidMessage_email(TotalErrors.ErrorNum),Fields.InValidMessage_dateofbirth(TotalErrors.ErrorNum),Fields.InValidMessage_dob_formatted(TotalErrors.ErrorNum),Fields.InValidMessage_attendancedate(TotalErrors.ErrorNum),Fields.InValidMessage_enrollmentstatus(TotalErrors.ErrorNum),Fields.InValidMessage_addresstype(TotalErrors.ErrorNum),Fields.InValidMessage_address_1(TotalErrors.ErrorNum),Fields.InValidMessage_address_2(TotalErrors.ErrorNum),Fields.InValidMessage_city(TotalErrors.ErrorNum),Fields.InValidMessage_state(TotalErrors.ErrorNum),Fields.InValidMessage_z5(TotalErrors.ErrorNum),Fields.InValidMessage_z4(TotalErrors.ErrorNum),Fields.InValidMessage_phonetyp(TotalErrors.ErrorNum),Fields.InValidMessage_phonenumber(TotalErrors.ErrorNum),Fields.InValidMessage_tier(TotalErrors.ErrorNum),Fields.InValidMessage_school_size_code(TotalErrors.ErrorNum),Fields.InValidMessage_competitive_code(TotalErrors.ErrorNum),Fields.InValidMessage_tuition_code(TotalErrors.ErrorNum),Fields.InValidMessage_title(TotalErrors.ErrorNum),Fields.InValidMessage_fname(TotalErrors.ErrorNum),Fields.InValidMessage_mname(TotalErrors.ErrorNum),Fields.InValidMessage_lname(TotalErrors.ErrorNum),Fields.InValidMessage_name_suffix(TotalErrors.ErrorNum),Fields.InValidMessage_name_score(TotalErrors.ErrorNum),Fields.InValidMessage_rawaid(TotalErrors.ErrorNum),Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Fields.InValidMessage_predir(TotalErrors.ErrorNum),Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Fields.InValidMessage_addr_suffix(TotalErrors.ErrorNum),Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),Fields.InValidMessage_st(TotalErrors.ErrorNum),Fields.InValidMessage_zip(TotalErrors.ErrorNum),Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Fields.InValidMessage_cart(TotalErrors.ErrorNum),Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),Fields.InValidMessage_lot(TotalErrors.ErrorNum),Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),Fields.InValidMessage_dpbc(TotalErrors.ErrorNum),Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),Fields.InValidMessage_county(TotalErrors.ErrorNum),Fields.InValidMessage_fips_state(TotalErrors.ErrorNum),Fields.InValidMessage_fips_county(TotalErrors.ErrorNum),Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),Fields.InValidMessage_msa(TotalErrors.ErrorNum),Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),Fields.InValidMessage_err_stat(TotalErrors.ErrorNum),Fields.InValidMessage_telephone(TotalErrors.ErrorNum),Fields.InValidMessage_tier2(TotalErrors.ErrorNum),Fields.InValidMessage_source(TotalErrors.ErrorNum),Fields.InValidMessage_key(TotalErrors.ErrorNum),Fields.InValidMessage_ssn(TotalErrors.ErrorNum),Fields.InValidMessage_historical_flag(TotalErrors.ErrorNum),Fields.InValidMessage_full_name(TotalErrors.ErrorNum),Fields.InValidMessage_college_class(TotalErrors.ErrorNum),Fields.InValidMessage_college_name(TotalErrors.ErrorNum),Fields.InValidMessage_ln_college_name(TotalErrors.ErrorNum),Fields.InValidMessage_college_major(TotalErrors.ErrorNum),Fields.InValidMessage_new_college_major(TotalErrors.ErrorNum),Fields.InValidMessage_college_code(TotalErrors.ErrorNum),Fields.InValidMessage_college_code_exploded(TotalErrors.ErrorNum),Fields.InValidMessage_college_type(TotalErrors.ErrorNum),Fields.InValidMessage_college_type_exploded(TotalErrors.ErrorNum),Fields.InValidMessage_file_type(TotalErrors.ErrorNum),Fields.InValidMessage_collegeupdate(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
