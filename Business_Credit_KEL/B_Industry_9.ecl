...
EXPORT B_Industry_9(CFG_graph.FDCDataset __in = CFG_graph.FDCDefault, CFG_graph __cfg = CFG_graph) := MODULE
  ...
  SHARED __EE265021 := __ENH_Industry_10;
  EXPORT __ST240352_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST240352_Layout __ND265040__Project(B_Industry_10(__in,__cfg).__ST240611_Layout __PP264925) := TRANSFORM
    SELF.Is_Primary_ := __OP2(__PP264925._primary__industry__code__indicator_,=,__CN('Y'));
    SELF.Is_Valid_Code_ := MAP(__T(__PP264925.Is_S_I_C_Code_)=>__ECAST(KEL.typ.nbool,__AND(__OP2(__PP264925._classification__code_,>,__CN(0)),__OP2(__PP264925._classification__code_,<,__CN(10000)))),__T(__PP264925.Is_N_A_I_C_S_Code_)=>__ECAST(KEL.typ.nbool,__AND(__OP2(__PP264925._classification__code_,>,__CN(0)),__OP2(__PP264925._classification__code_,<,__CN(1000000)))),__ECAST(KEL.typ.nbool,__CN(FALSE)));
    SELF := __PP264925;
  END;
  EXPORT __ENH_Industry_9 := PROJECT(__EE265021,__ND265040__Project(LEFT));
END;
