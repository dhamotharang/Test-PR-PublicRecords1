...
EXPORT B_Business_Owner_3(CFG_graph.FDCDataset __in = CFG_graph.FDCDefault, CFG_graph __cfg = CFG_graph) := MODULE
  ...
  SHARED __EE506616 := __E_Business_Owner;
  ...
  END;
  SHARED __ST242425_Layout __ND506614__Project(E_Business_Owner(__in,__cfg).Layout __PP506522) := TRANSFORM
    SELF.Name_ := __FN1(TRIM,__PP506522._business__name_);
    SELF := __PP506522;
  END;
  EXPORT __ENH_Business_Owner_3 := PROJECT(__EE506616,__ND506614__Project(LEFT));
END;
