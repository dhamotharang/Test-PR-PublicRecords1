...
EXPORT E_Individual_Owner(CFG_graph.FDCDataset __in = CFG_graph.FDCDefault, CFG_graph __cfg = CFG_graph) := MODULE
  ...
  SHARED __Mapping := 'seq_num(UID),sbfe_contributor_number(_sbfe__contributor__number_:\'\'),contract_account_number(_contract__account__number_:\'\'),account_type_reported(_account__type__reported_:0),dt_first_seen(_dt__first__seen_:DATE),dt_last_seen(_dt__last__seen_:DATE),dt_vendor_first_reported(_dt__vendor__first__reported_:DATE),dt_vendor_last_reported(_dt__vendor__last__reported_:DATE),dt_datawarehouse_first_reported(_dt__datawarehouse__first__reported_:DATE),dt_datawarehouse_last_reported(_dt__datawarehouse__last__reported_:DATE),original_fname(_first__name_:\'\'),original_mname(_middle__name_:\'\'),original_lname(_last__name_:\'\'),original_suffix(_suffix_:\'\'),e_mail_address(_e__mail__address_:\'\'),guarantor_owner_indicator(_guarantor__owner__indicator_:0),relationship_to_business_indicator(_relationship__to__business__indicator_:\'\'),business_title(_business__title_:\'\'),percent_of_liability(_percent__of__liability_:0),percent_of_ownership(_percent__of__ownership_:0),source(_source_:\'\'),active(_active_)';
  ...
  EXPORT _first__name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,_first__name_);
  EXPORT _middle__name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,_middle__name_);
  EXPORT _last__name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,_last__name_);
  EXPORT _suffix__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,_suffix_);
  EXPORT _e__mail__address__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,_e__mail__address_);
