...
EXPORT E_Account(CFG_graph.FDCDataset __in = CFG_graph.FDCDefault, CFG_graph __cfg = CFG_graph) := MODULE
  ...
  SHARED __Mapping := 'acct_no(UID),seq(_seq_:\'\'),ultid(_ultid_:\'\'),orgid(_orgid_:\'\'),seleid(_seleid_:\'\'),proxid(_proxid_:\'\'),powid(_powid_:\'\'),empid(_empid_:\'\'),dotid(_dotid_:\'\'),ultscore(_ultscore_:\'\'),orgscore(_orgscore_:\'\'),selescore(_selescore_:\'\'),proxscore(_proxscore_:\'\'),powscore(_powscore_:\'\'),empscore(_empscore_:\'\'),dotscore(_dotscore_:\'\'),ultweight(_ultweight_:\'\'),orgweight(_orgweight_:\'\'),seleweight(_seleweight_:\'\'),proxweight(_proxweight_:\'\'),powweight(_powweight_:\'\'),empweight(_empweight_:\'\'),dotweight(_dotweight_:\'\'),dt_first_seen(_dt__first__seen_:DATE),dt_last_seen(_dt__last__seen_:DATE),dt_vendor_first_reported(_dt__vendor__first__reported_:DATE),dt_vendor_last_reported(_dt__vendor__last__reported_:DATE),dt_datawarehouse_first_reported(_dt__datawarehouse__first__reported_:DATE),dt_datawarehouse_last_reported(_dt__datawarehouse__last__reported_:DATE),did(_did_:\'\'),did_score(_did__score_:\'\')';
