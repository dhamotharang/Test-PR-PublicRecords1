...
raw_sanc_did_file := cnld_remap.Basefile_Sanctions;
...
export File_Sanctions_Cleaned_DIDed_dates := rollup(base_srt, left.sanc_id=right.sanc_id, roll_it(left, right), local) : persist('~thor_200::in::ingenix_remap::per_File_Sanctions_Cleaned_DIDed_dates');