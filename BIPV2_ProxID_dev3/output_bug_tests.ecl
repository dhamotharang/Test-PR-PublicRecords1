...
*/
dbase24  := BIPV2_ProxID_dev3.files('20130330_24').base.logical;
dbase27  := BIPV2_ProxID_dev3.files('20130330_27').base.logical;
dbase28  := BIPV2_ProxID_dev3.files('20130330_28').base.logical;
dbase29  := BIPV2_ProxID_dev3.files('20130330_29').base.logical;
dbase30  := BIPV2_ProxID_dev3.files('20130330_30').base.logical;
dbase31  := BIPV2_ProxID_dev3.files('20130330_31').base.logical;
dbase32  := BIPV2_ProxID_dev3.files('20130330_32').base.logical;
dbasenew := BIPV2_ProxID_dev3.files(pCombo).base.logical;
...
dagg24_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt24_Bug123149);
dagg27_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt27_Bug123149);
dagg28_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt28_Bug123149);
dagg29_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt29_Bug123149);
dagg30_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt30_Bug123149);
dagg31_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt31_Bug123149);
dagg32_Bug123149  := BIPV2_ProxID_dev3.AggregateProxidElements(dfilt32_Bug123149);
daggnew_Bug123149 := BIPV2_ProxID_dev3.AggregateProxidElements(dfiltnew_Bug123149);
...
dagg27_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase27_filt_Bug124743);
dagg28_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase28_filt_Bug124743);
dagg29_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase29_filt_Bug124743);
dagg30_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase30_filt_Bug124743);
dagg31_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase31_filt_Bug124743);
dagg32_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbase32_filt_Bug124743);
daggnew_Bug124743 := BIPV2_ProxID_dev3.AggregateProxidElements(dbasenew_filt_Bug124743);
...
dagg27_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase27_filt_CvrgIssues );
dagg28_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase28_filt_CvrgIssues );
dagg29_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase29_filt_CvrgIssues );
dagg30_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase30_filt_CvrgIssues );
dagg31_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase31_filt_CvrgIssues );
dagg32_filt_CvrgIssues  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase32_filt_CvrgIssues );
daggnew_filt_CvrgIssues := BIPV2_ProxID_dev3.AggregateProxidElements(dbasenew_filt_CvrgIssues); 
...
dagg27_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase27_filt_Bug124784 );
dagg28_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase28_filt_Bug124784 );
dagg29_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase29_filt_Bug124784 );
dagg30_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase30_filt_Bug124784 );
dagg31_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase31_filt_Bug124784 );
dagg32_filt_Bug124784  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase32_filt_Bug124784 );
daggnew_filt_Bug124784 := BIPV2_ProxID_dev3.AggregateProxidElements(dbasenew_filt_Bug124784); 
...
dagg27_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase27_filt_Bug_124768 );
dagg28_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase28_filt_Bug_124768 );
dagg29_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase29_filt_Bug_124768 );
dagg30_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase30_filt_Bug_124768 );
dagg31_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase31_filt_Bug_124768 );
dagg32_filt_Bug_124768  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase32_filt_Bug_124768 );
daggnew_filt_Bug_124768 := BIPV2_ProxID_dev3.AggregateProxidElements(dbasenew_filt_Bug_124768); 
...
dagg27_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase27_filt_Bug_124966 );
dagg28_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase28_filt_Bug_124966 );
dagg29_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase29_filt_Bug_124966 );
dagg30_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase30_filt_Bug_124966 );
dagg31_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase31_filt_Bug_124966 );
dagg32_filt_Bug_124966  := BIPV2_ProxID_dev3.AggregateProxidElements(dbase32_filt_Bug_124966 );
daggnew_filt_Bug_124966 := BIPV2_ProxID_dev3.AggregateProxidElements(dbasenew_filt_Bug_124966); 
