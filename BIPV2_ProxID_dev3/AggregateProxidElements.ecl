...
function
  ...
  ,pDataset.cnp_number,pDataset.cnp_btype
	,string address/*,string contact*/,pDataset.source,pDataset.active_duns_number,pDataset.active_enterprise_number
  ,string1 company_foreign_domestic,string foreign_corp_key,string domestic_corp_key,string fein,pdataset.company_phone
