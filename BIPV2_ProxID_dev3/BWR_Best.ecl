...
#workunit('name','BIPV2_ProxID_dev3.BWR_Best - BEST - SALT V2.5 Alpha 1');
...
// BIPV2_ProxID_dev3.Keys(BIPV2_ProxID_dev3.In_DOT_Base).BuildData;

// The statistics for the best (also builds all the persists)
BIPV2_ProxID_dev3.Best(BIPV2_ProxID_dev3.In_DOT_Base).Stats;
...
b := BIPV2_ProxID_dev3.Best(BIPV2_ProxID_dev3.In_DOT_Base); // Instantiate Best module
