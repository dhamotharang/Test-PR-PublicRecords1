...
rMoxieRecord	:= Watercraft.Layout_Moxie_Watercraft_Search;
...
Watercraft.Layout_Moxie_Watercraft_Search tPullFromMain(dSearchSort pSearch, dMainSort pMain)
 :=
  transform
...
export Out_Moxie_Search := output(dSearchAndMain,,'base::watercraft_moxie_search',overwrite);
