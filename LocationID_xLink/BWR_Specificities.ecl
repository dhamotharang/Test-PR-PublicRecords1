...
#workunit('name','LocationId_xLink.BWR_Specificities - Specificities - SALT V3.7.0');
IMPORT LocationId_xLink,SALT37;
SpecMod := LocationId_xLink.specificities(LocationId_xLink.File_LocationId);
...
// IMPORT SALTTOOLS30;
// SpcPatch := SALTTOOLS30.mac_Patch_spcString(SpecMod.Specificities,LocationId_xLink.File_LocationId,LocationId_xLink.GenerationMod.spcString);
