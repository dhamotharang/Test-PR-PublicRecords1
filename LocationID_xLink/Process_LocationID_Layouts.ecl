...
IMPORT SALT37;
export h := File_LocationId;//The input file
...
EXPORT ForeignKeyName_sf(string daliAddress) := '~foreign::' + daliAddress +'::'+KeyPrefix+'::'+'key::LocationId_xLink'+'::'+KeySuperfile+'::LocId::meow';
 
EXPORT ForeignKey(string daliAddress) := INDEX(h,{LocId},{h},ForeignKeyName_sf(daliAddress)); /*Process_LocationID_Layouts01*/
EXPORT Key := INDEX(h,{LocId},{h},KeyName_sf); /*Process_LocationID_Layouts01*/
EXPORT BuildKey(dataset(recordof(h)) inData) := INDEX(inData,{LocId},{inData},KeyName); /*Process_LocationID_Layouts01*/
...
EXPORT ForeignKeyIDHistoryName_sf(string daliAddress) := '~foreign::' + daliAddress +'::'+KeyPrefix+'::'+'key::LocationId_xLink'+'::'+KeySuperfile+'::LocId::sup::rid';
...
EXPORT ClearKeyIDHistorySuperFile := SEQUENTIAL(FileServices.CreateSuperFile(KeyIDHistoryName_sf,,TRUE),FileServices.ClearSuperFile(KeyIDHistoryName_sf));
  export sIDHist := TABLE(h,{LocId,rid},rid,LocId,MERGE);
 
EXPORT ForeignKeyIDHistory(string daliAddress) := INDEX(sIDHist,{rid},{sIDHist},ForeignKeyIDHistoryName_sf(daliAddress)); /*Process_LocationID_Layouts02*/
EXPORT KeyIDHistory := INDEX(sIDHist,{rid},{sIDHist},KeyIDHistoryName_sf); /*Process_LocationID_Layouts02*/
EXPORT BuildKeyIDHistory(dataset(recordof(sIDHist)) inHist) := INDEX(inHist,{rid},{inHist},KeyIDHistoryName); /*Process_LocationID_Layouts02*/
...
EXPORT BuildAll := PARALLEL(BUILDINDEX(BuildKey(h), OVERWRITE),BUILDINDEX(BuildKeyIDHistory(sIDHist), OVERWRITE)); /*Process_LocationID_Layouts03*/
...
EXPORT HardKeyMatch(InputLayout le) := le.v_city_name <> (TYPEOF(le.v_city_name))'' AND Fields.InValid_v_city_name((SALT37.StrType)le.v_city_name)=0 AND le.st <> (TYPEOF(le.st))'' AND Fields.InValid_st((SALT37.StrType)le.st)=0 AND le.prim_range <> (TYPEOF(le.prim_range))'' AND Fields.InValid_prim_range((SALT37.StrType)le.prim_range)=0 AND le.prim_name_derived <> (TYPEOF(le.prim_name_derived))'' AND Fields.InValid_prim_name_derived((SALT37.StrType)le.prim_name_derived)=0 OR le.zip5 <> (TYPEOF(le.zip5))'' AND Fields.InValid_zip5((SALT37.StrType)le.zip5)=0 AND le.prim_range <> (TYPEOF(le.prim_range))'' AND Fields.InValid_prim_range((SALT37.StrType)le.prim_range)=0 AND le.prim_name_derived <> (TYPEOF(le.prim_name_derived))'' AND Fields.InValid_prim_name_derived((SALT37.StrType)le.prim_name_derived)=0;
EXPORT LayoutScoredFetch := RECORD // Nulls required for linkpaths that do not have field
  ...
  INTEGER2 prim_name_derivedWeight := 0;
  INTEGER1 prim_name_derived_match_code := 0;
  TYPEOF(h.addr_suffix_derived) addr_suffix_derived := (TYPEOF(h.addr_suffix_derived))'';
  INTEGER2 addr_suffix_derivedWeight := 0;
  INTEGER1 addr_suffix_derived_match_code := 0;
  ...
  INTEGER2 err_statWeight := 0;
  INTEGER1 err_stat_match_code := 0;
...
EXPORT LayoutScoredFetch combine_scores(LayoutScoredFetch le,LayoutScoredFetch ri) := TRANSFORM
  ...
  BOOLEAN prim_name_derivedWeightForcedDown := IF ( isWeightForcedDown(le.prim_name_derivedWeight,ri.prim_name_derivedWeight,le.prim_name_derived_match_code,ri.prim_name_derived_match_code),TRUE,FALSE );
  SELF.prim_name_derivedWeight := IF ( isLeftWinner(le.prim_name_derivedWeight,ri.prim_name_derivedWeight,le.prim_name_derived_match_code,ri.prim_name_derived_match_code ), le.prim_name_derivedWeight, ri.prim_name_derivedWeight );
  SELF.prim_name_derived := IF ( isLeftWinner(le.prim_name_derivedWeight,ri.prim_name_derivedWeight,le.prim_name_derived_match_code,ri.prim_name_derived_match_code ), le.prim_name_derived, ri.prim_name_derived );
  SELF.prim_name_derived_match_code := IF ( isLeftWinner(le.prim_name_derivedWeight,ri.prim_name_derivedWeight,le.prim_name_derived_match_code,ri.prim_name_derived_match_code ), le.prim_name_derived_match_code, ri.prim_name_derived_match_code );
  BOOLEAN addr_suffix_derivedWeightForcedDown := IF ( isWeightForcedDown(le.addr_suffix_derivedWeight,ri.addr_suffix_derivedWeight,le.addr_suffix_derived_match_code,ri.addr_suffix_derived_match_code),TRUE,FALSE );
  SELF.addr_suffix_derivedWeight := IF ( isLeftWinner(le.addr_suffix_derivedWeight,ri.addr_suffix_derivedWeight,le.addr_suffix_derived_match_code,ri.addr_suffix_derived_match_code ), le.addr_suffix_derivedWeight, ri.addr_suffix_derivedWeight );
  SELF.addr_suffix_derived := IF ( isLeftWinner(le.addr_suffix_derivedWeight,ri.addr_suffix_derivedWeight,le.addr_suffix_derived_match_code,ri.addr_suffix_derived_match_code ), le.addr_suffix_derived, ri.addr_suffix_derived );
  SELF.addr_suffix_derived_match_code := IF ( isLeftWinner(le.addr_suffix_derivedWeight,ri.addr_suffix_derivedWeight,le.addr_suffix_derived_match_code,ri.addr_suffix_derived_match_code ), le.addr_suffix_derived_match_code, ri.addr_suffix_derived_match_code );
  ...
  BOOLEAN err_statWeightForcedDown := IF ( isWeightForcedDown(le.err_statWeight,ri.err_statWeight,le.err_stat_match_code,ri.err_stat_match_code),TRUE,FALSE );
  SELF.err_statWeight := IF ( isLeftWinner(le.err_statWeight,ri.err_statWeight,le.err_stat_match_code,ri.err_stat_match_code ), le.err_statWeight, ri.err_statWeight );
  SELF.err_stat := IF ( isLeftWinner(le.err_statWeight,ri.err_statWeight,le.err_stat_match_code,ri.err_stat_match_code ), le.err_stat, ri.err_stat );
  SELF.err_stat_match_code := IF ( isLeftWinner(le.err_statWeight,ri.err_statWeight,le.err_stat_match_code,ri.err_stat_match_code ), le.err_stat_match_code, ri.err_stat_match_code );
  ...
  INTEGER2 Weight := MAX(0,SELF.prim_rangeWeight) + MAX(0,SELF.predirWeight) + MAX(0,SELF.prim_name_derivedWeight) + MAX(0,SELF.addr_suffix_derivedWeight) + MAX(0,SELF.postdirWeight) + MAX(0,SELF.err_statWeight) + MAX(0,SELF.unit_desigWeight) + MAX(0,SELF.sec_rangeWeight) + MAX(0,SELF.v_city_nameWeight) + MAX(0,SELF.stWeight) + MAX(0,SELF.zip5Weight);
...
EXPORT ScoreSummary(DATASET(OutputLayout_Base) ds0) := FUNCTION
  ...
  R tosummary(ds le) := TRANSFORM
    SELF.Summary := IF(le.prim_rangeWeight = 0,'','|'+IF(le.prim_rangeWeight < 0,'-','')+'prim_range')+IF(le.predirWeight = 0,'','|'+IF(le.predirWeight < 0,'-','')+'predir')+IF(le.prim_name_derivedWeight = 0,'','|'+IF(le.prim_name_derivedWeight < 0,'-','')+'prim_name_derived')+IF(le.addr_suffix_derivedWeight = 0,'','|'+IF(le.addr_suffix_derivedWeight < 0,'-','')+'addr_suffix_derived')+IF(le.postdirWeight = 0,'','|'+IF(le.postdirWeight < 0,'-','')+'postdir')+IF(le.err_statWeight = 0,'','|'+IF(le.err_statWeight < 0,'-','')+'err_stat')+IF(le.unit_desigWeight = 0,'','|'+IF(le.unit_desigWeight < 0,'-','')+'unit_desig')+IF(le.sec_rangeWeight = 0,'','|'+IF(le.sec_rangeWeight < 0,'-','')+'sec_range')+IF(le.v_city_nameWeight = 0,'','|'+IF(le.v_city_nameWeight < 0,'-','')+'v_city_name')+IF(le.stWeight = 0,'','|'+IF(le.stWeight < 0,'-','')+'st')+IF(le.zip5Weight = 0,'','|'+IF(le.zip5Weight < 0,'-','')+'zip5');
  END;
...
aggregateRec := RECORD
  ...
  prim_name_derivedWeight := MAX(GROUP,IF( in_data.prim_name_derived_match_code=SALT37.MatchCode.ExactMatch, in_data.prim_name_derivedWeight,0 ));
  addr_suffix_derivedWeight := MAX(GROUP,IF( in_data.addr_suffix_derived_match_code=SALT37.MatchCode.ExactMatch, in_data.addr_suffix_derivedWeight,0 ));
  postdirWeight := MAX(GROUP,IF( in_data.postdir_match_code=SALT37.MatchCode.ExactMatch, in_data.postdirWeight,0 ));
  err_statWeight := MAX(GROUP,IF( in_data.err_stat_match_code=SALT37.MatchCode.ExactMatch, in_data.err_statWeight,0 ));
...
LayoutScoredFetch FixScores(LayoutScoredFetch le, aggregateRec ri) := TRANSFORM
  ...
  SELF.prim_name_derivedWeight := MAP( ri.prim_name_derivedWeight=0 OR le.prim_name_derived_match_code=SALT37.MatchCode.ExactMatch => le.prim_name_derivedWeight,MIN(le.prim_name_derivedWeight,ri.prim_name_derivedWeight-1) );
  SELF.addr_suffix_derivedWeight := MAP( ri.addr_suffix_derivedWeight=0 OR le.addr_suffix_derived_match_code=SALT37.MatchCode.ExactMatch => le.addr_suffix_derivedWeight,MIN(le.addr_suffix_derivedWeight,ri.addr_suffix_derivedWeight-1) );
  ...
  SELF.err_statWeight := MAP( ri.err_statWeight=0 OR le.err_stat_match_code=SALT37.MatchCode.ExactMatch => le.err_statWeight,MIN(le.err_statWeight,ri.err_statWeight-1) );
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT37.Layout_FieldValueList) prim_name_derived_Values := DATASET([],SALT37.Layout_FieldValueList);
  DATASET(SALT37.Layout_FieldValueList) addr_suffix_derived_Values := DATASET([],SALT37.Layout_FieldValueList);
...
SHARED RollEntities(dataset(Layout_RolledEntity) infile) := FUNCTION
  ...
  SELF.LocId := le.LocId;
    ...
    SELF.prim_name_derived_values := SALT37.fn_combine_fieldvaluelist(le.prim_name_derived_values,ri.prim_name_derived_values);
    SELF.addr_suffix_derived_values := SALT37.fn_combine_fieldvaluelist(le.addr_suffix_derived_values,ri.addr_suffix_derived_values);
  ...
  Layout_RolledEntity SortValues(Layout_RolledEntity le) := TRANSFORM
    ...
    SELF.prim_name_derived_values := SORT(le.prim_name_derived_values, -cnt, val, LOCAL);
    SELF.addr_suffix_derived_values := SORT(le.addr_suffix_derived_values, -cnt, val, LOCAL);
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  ...
  SELF.prim_name_derived_Values := IF ( (SALT37.StrType)le.prim_name_derived = '',DATASET([],SALT37.Layout_FieldValueList),DATASET([{TRIM((SALT37.StrType)le.prim_name_derived)}],SALT37.Layout_FieldValueList));
  SELF.addr_suffix_derived_Values := IF ( (SALT37.StrType)le.addr_suffix_derived = '',DATASET([],SALT37.Layout_FieldValueList),DATASET([{TRIM((SALT37.StrType)le.addr_suffix_derived)}],SALT37.Layout_FieldValueList));
  ...
  SELF.err_stat_Values := IF ( (SALT37.StrType)le.err_stat = '',DATASET([],SALT37.Layout_FieldValueList),DATASET([{TRIM((SALT37.StrType)le.err_stat)}],SALT37.Layout_FieldValueList));
