/*
	...
	Example:
	tools.mac_SetFields(DCAV2.Layouts.base.companies	,'rid',doesbdidexist);
...
export mac_SetFields(
	...
	,pForceLoadXml		= 'false'	// is output going to be used in a macro(then use set command), otherwise, just :=
