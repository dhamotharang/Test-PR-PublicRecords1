////////////////////////////////////////////////////////////////////////////////////////////
// -- macf_FilesInput macro/module
// -- Parameters:
// -- 	pfilenameversions	-- result of call to tools.mod_FilenamesInput  Example follows
// --		pLayout				    -- Record layout of input file
// --		pfiletype			    -- Type of file. flat, csv or Xml
...
// -- 		export InputFilenames	:= tools.mod_FilenamesInput('~thor_data400::in_rolling::BBB::@version@::Member');
// -- 		export InputFiles     := tools.macf_FilesInput(InputFilenames,	bbb2.Layouts_Files.Input.Member, 'listings/listing');
// -- 
