...
MakeSuperKeys ('~prte::key::poe::@version@::did');
MakeSuperKeys ('~prte::key::poe::@version@::source_hierarchy');

MakeSuperFiles ('~PRTE::BASE::poe@version@');

FileServices.CreateSuperFile ('~PRTE::IN::poe');
