...
typeof(doxie_files.key_proflic_bdid) get_by_bdid(prof_license.key_proflic_bdid L) := transform
	self := l;
end;

outf := project(doxie_files.key_proflic_bdid(bd = bdid_val), get_by_bdid(LEFT));
