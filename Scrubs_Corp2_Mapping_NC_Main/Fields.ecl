IMPORT ut,SALT35;
IMPORT Scrubs,Scrubs_Corp2_Mapping_NC_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_flag_code','invalid_name_type_cd','invalid_term_exist_cd','invalid_for_dom_ind','invalid_recordorigin','invalid_numeric','invalid_status_cd','invalid_fein','invalid_alphablank','invalid_fstate_desc','invalid_orig_org_structure_cd');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_flag_code' => 8,'invalid_name_type_cd' => 9,'invalid_term_exist_cd' => 10,'invalid_for_dom_ind' => 11,'invalid_recordorigin' => 12,'invalid_numeric' => 13,'invalid_status_cd' => 14,'invalid_fein' => 15,'invalid_alphablank' => 16,'invalid_fstate_desc' => 17,'invalid_orig_org_structure_cd' => 18,0);
...
EXPORT MakeFT_invalid_corp_key(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'))),~(LENGTH(TRIM(s)) >= 4));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-'),SALT35.HygieneErrors.NotLength('4..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter_nbr(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter_nbr(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'))),~(LENGTH(TRIM(s)) >= 0));
EXPORT InValidMessageFT_invalid_charter_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'),SALT35.HygieneErrors.NotLength('0..'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['37']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('37'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['NC']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('NC'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_date(SALT35.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_date(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_pastDate(s)>0);
EXPORT InValidMessageFT_invalid_date(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_future_date(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_future_date(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_GeneralDate(s)>0);
EXPORT InValidMessageFT_invalid_future_date(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.CustomFail('Scrubs.fn_valid_GeneralDate'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_cd(SALT35.StrType s,SALT35.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_NC_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NC_Main.Functions.invalid_name_type_code'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_term_exist_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_term_exist_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN ['D','P','N',' ']);
EXPORT InValidMessageFT_invalid_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('D|P|N| '),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_status_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_status_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_status_codes);
EXPORT InValidMessageFT_invalid_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_status_codes'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_fein(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_fein(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 9));
EXPORT InValidMessageFT_invalid_fein(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars('0123456789'),SALT35.HygieneErrors.NotLength('0,9'),SALT35.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_fstate_desc(SALT35.StrType s0) := FUNCTION
  s1 := SALT35.stringfilter(s0,' ,&ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_fstate_desc(SALT35.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT35.StringFilter(s,' ,&ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_fstate_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInChars(' ,&ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT35.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_orig_org_structure_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_orig_org_structure_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_org_codes);
EXPORT InValidMessageFT_invalid_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_org_codes'),SALT35.HygieneErrors.Good);
...
EXPORT Make_corp_ln_name_type_cd(SALT35.StrType s0) := MakeFT_invalid_name_type_cd(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT35.StrType s,SALT35.StrType recordorigin) := InValidFT_invalid_name_type_cd(s,recordorigin);
...
EXPORT Make_corp_address1_effective_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_address1_effective_date(SALT35.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_filing_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_filing_date(SALT35.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_status_cd(SALT35.StrType s0) := MakeFT_invalid_status_cd(s0);
EXPORT InValid_corp_status_cd(SALT35.StrType s) := InValidFT_invalid_status_cd(s);
EXPORT InValidMessage_corp_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_status_cd(wh);
 
EXPORT Make_corp_status_desc(SALT35.StrType s0) := s0;
EXPORT InValid_corp_status_desc(SALT35.StrType s) := 0;
...
EXPORT Make_corp_inc_date(SALT35.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_inc_date(SALT35.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT Make_corp_fed_tax_id(SALT35.StrType s0) := MakeFT_invalid_fein(s0);
EXPORT InValid_corp_fed_tax_id(SALT35.StrType s) := InValidFT_invalid_fein(s);
EXPORT InValidMessage_corp_fed_tax_id(UNSIGNED1 wh) := InValidMessageFT_invalid_fein(wh);
...
EXPORT Make_corp_term_exist_cd(SALT35.StrType s0) := MakeFT_invalid_term_exist_cd(s0);
EXPORT InValid_corp_term_exist_cd(SALT35.StrType s) := InValidFT_invalid_term_exist_cd(s);
...
EXPORT Make_corp_forgn_state_desc(SALT35.StrType s0) := MakeFT_invalid_fstate_desc(s0);
EXPORT InValid_corp_forgn_state_desc(SALT35.StrType s) := InValidFT_invalid_fstate_desc(s);
EXPORT InValidMessage_corp_forgn_state_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_fstate_desc(wh);
...
EXPORT Make_corp_forgn_date(SALT35.StrType s0) := MakeFT_invalid_future_date(s0);
EXPORT InValid_corp_forgn_date(SALT35.StrType s) := InValidFT_invalid_future_date(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT35.StrType s0) := MakeFT_invalid_orig_org_structure_cd(s0);
EXPORT InValid_corp_orig_org_structure_cd(SALT35.StrType s) := InValidFT_invalid_orig_org_structure_cd(s);
...
EXPORT Make_corp_agent_assign_date(SALT35.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_agent_assign_date(SALT35.StrType s) := InValidFT_invalid_date(s);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT35,Scrubs_Corp2_Mapping_NC_Main;
