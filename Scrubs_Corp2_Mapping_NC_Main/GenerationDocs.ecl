...
Command line options: -MScrubs_Corp2_Mapping_NC_Main -eC:\Users\myanasx\AppData\Local\Temp\TFRD7D4.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_NC_Main
FILENAME:in_file
...
FIELDTYPE:invalid_charter_nbr:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(0..)
FIELDTYPE:invalid_corp_vendor:ENUM(37)
FIELDTYPE:invalid_state_origin:ENUM(NC)
...
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_NC_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_term_exist_cd:ENUM(D|P|N| )
FIELDTYPE:invalid_for_dom_ind:ENUM(D|F| )
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_numeric:ALLOW(0123456789)
FIELDTYPE:invalid_status_cd:ENUM(Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_status_codes)
FIELDTYPE:invalid_fein:ALLOW(0123456789):LENGTHS(0,9)
FIELDTYPE:invalid_alphablank:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_fstate_desc:ALLOW( ,&ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_org_codes)
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_fstate_desc):0,0
