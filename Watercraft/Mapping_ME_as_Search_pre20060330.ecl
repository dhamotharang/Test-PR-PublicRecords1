...
Mapping_ME_as_Search_norm			:= normalize(hull_clean_in,5,search_mapping_format(left,counter));

export Mapping_ME_as_Search_pre20060330         := Mapping_ME_as_Search_norm(clean_pname <> '' or company_name <> '');
