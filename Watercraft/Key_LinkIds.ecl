...
EXPORT Key_LinkIds := MODULE
  //shared  base_recs 					:= Watercraft.File_Base_Search_Dev(source_code != 'W1');
  shared  base_recs 					:= Watercraft.File_Base_Search_Dev;
	export  out_logicalKeyName  := Watercraft.Cluster+'Key::watercraft_linkids_qa'; // linkids Key Super FileName
