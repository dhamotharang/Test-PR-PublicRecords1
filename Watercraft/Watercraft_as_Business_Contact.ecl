...
business_header.Layout_Business_Contact_Full tGetMatchingCompany(dWatercraftAsBusConPersons pPerson, dWatercraftAsBusConCompanies pCompany)
 :=
  transform
...
asbus := watercraft.Watercraft_as_Business_Header;
...
export Watercraft_as_Business_Contact
 ...
 :	persist ('persist::bushdr_watercraft_as_bus_con')
 ;
