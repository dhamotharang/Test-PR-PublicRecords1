...
export fn_Out_Base_Dev_Stats(string filedate):=function
...
STRATA.createXMLStats(tStats_main,  'Watercraft','Main',      filedate,'jtao@seisint.com',zPopulation_Stats_main,  'View','Population')
STRATA.createXMLStats(tStats_cg,    'Watercraft','CoastGuard',filedate,'jtao@seisint.com',zPopulation_Stats_cg,    'View','Population')
STRATA.createXMLStats(tStats_search,'Watercraft','SearchFile',filedate,'jtao@seisint.com',zPopulation_Stats_search,'View','Population')

STRATA.createAsHeaderStats(watercraft.Watercraft_as_Header(watercraft.File_Base_Search_Dev,watercraft.File_Base_Main_Dev),'Watercraft','Data',filedate,'jtao@seisint.com',zAs_Header_Stats)
STRATA.CreateAsBusinessHeaderStats(watercraft.fWatercraft_as_Business_Header(watercraft.File_Base_Search_Dev),'Watercraft','Data',filedate,'jtao@seisint.com',zRunAsBusinessHeaderStats)

return     parallel(zOrig_Stats_main
                    ,zOrig_Stats_cg
									  ,zOrig_Stats_search
