...
watercraft.Layout_Watercraft_Main_Base main_mapping_format(watercraft.file_CO_clean_in L) := transform
...
export Mapping_CO_as_Main := project(watercraft.file_CO_clean_in, main_mapping_format(left));
