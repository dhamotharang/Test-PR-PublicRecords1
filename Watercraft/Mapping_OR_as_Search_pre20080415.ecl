...
Layout_Watercraft_Search_Group_temp search_mapping_format_temp(watercraft.file_OR_clean_in_pre20080415 L, integer1 C)
 :=transform
...
Mapping_OR_as_Search_temp1 := normalize(Watercraft.file_OR_clean_in_pre20080415,5,search_mapping_format_temp(left,counter));
...
export Mapping_OR_as_Search_pre20080415	:= (normalize(Mapping_OR_as_Main_temp2,2,search_mapping_format(left,counter)))
