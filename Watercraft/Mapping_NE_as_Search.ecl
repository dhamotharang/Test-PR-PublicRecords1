...
Layout_NE_clean_temp main_mapping_temp(WATERCRAFT.file_NE_clean_in L, watercraft.file_MIC R)
...
Mapping_NE_as_Main_temp := join(WATERCRAFT.file_NE_clean_in, watercraft.file_MIC, trim(left.hull_id, left, right)[1..3] = right.MIC,
