...
Watercraft.Layout_Watercraft_Search_Group search_mapping_format(Watercraft.Layout_MI_clean_in L, integer1 C)
 :=
  transform
...
Mapping_MI_as_Search_norm			:= normalize(Watercraft.file_MI_clean_in,5,search_mapping_format(left,counter));
