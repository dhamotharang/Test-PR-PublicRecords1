...
Watercraft.Macro_Clean_Hull_ID(watercraft.file_IA_clean_in_pre20071011, watercraft.Layout_IA_clean_in_pre20071011,hull_clean_in)
...
export Mapping_IA_as_Main_pre20071011 := project(hull_clean_in, main_mapping_format(left));
