...
Watercraft.Macro_Clean_Hull_ID(watercraft.file_ME_clean_in_pre20080415, watercraft.Layout_ME_clean_in_pre20080415,hull_clean_in)
...
export Mapping_ME_as_Main_pre20080415 := project(hull_clean_in, main_mapping_format(left));
