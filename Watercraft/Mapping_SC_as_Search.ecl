...
Watercraft.Macro_Clean_Hull_ID(Watercraft.file_SC_clean_in, watercraft.Layout_SC_clean_in,hull_clean_in)
watercraft.Macro_Is_hull_id_in_MIC(hull_clean_in, watercraft.Layout_SC_clean_in, wDatasetwithflag)
...
Mapping_SC_as_Search_norm			:= normalize(wDatasetwithflag,5,search_mapping_format(left,counter));

export Mapping_sc_as_Search         := Mapping_SC_as_Search_norm(clean_pname <> '' or company_name <> '');
