...
Watercraft.Layout_IA_clean_in_pre20071011;
...
Layout_Watercraft_Search_Group_temp search_mapping_format_temp(Watercraft.Layout_IA_clean_in_pre20071011 L, integer1 C)
 :=transform
...
Mapping_IA_as_Search_temp := normalize(Watercraft.file_IA_clean_in_pre20071011,5,search_mapping_format_temp(left,counter));
...
export Mapping_IA_as_Search_pre20071011	:= (normalize(hull_clean_in,2,search_mapping_format(left,counter)))
