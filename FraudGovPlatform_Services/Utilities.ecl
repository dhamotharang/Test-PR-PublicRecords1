		...
		analytics_uids := PROJECT(ds_entityNameValue, 
												TRANSFORM(FraudGovPlatform_Services.Layouts.elementNidentity_uid_recs,
													uid := CASE(LEFT.entity_name,
																			...
																			Fragment_Types_const.DRIVERS_LICENSE_NUMBER_FRAGMENT => Entity_Type_Identifier._DLNUMBER + HASH64(LEFT.entity_value),
																			...
																			Fragment_Types_const.PHYSICAL_ADDRESS_FRAGMENT => Entity_Type_Identifier._PHYSICAL_ADDRESS + HASH64(regexfind('(.*)@@@(.*)$',LEFT.entity_value,1) + '|' + regexfind('(.*)@@@(.*)$',LEFT.entity_value,2)),
																			Fragment_Types_const.BANK_ACCOUNT_NUMBER_FRAGMENT => Entity_Type_Identifier._BANKACCOUNT + HASH64(regexfind('(.*)@@@(.*)$',LEFT.entity_value,1) + '|' + regexfind('(.*)@@@(.*)$',LEFT.entity_value,2)),
