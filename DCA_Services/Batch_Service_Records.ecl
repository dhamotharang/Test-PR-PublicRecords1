...
IMPORT Autokey_batch, BatchServices, Business_Header_SS, AutokeyB2, ut, DCA;
...
EXPORT Batch_Service_records( 
					DATASET(DCA_Services.layouts_batch.Batch_in) ds_batch_in_param = DATASET([], DCA_Services.layouts_batch.Batch_in), 
    ...
    // 2. Append bdids to records w/o one
		...
		by_BDID := 
			JOIN(
				bdid_batch_in(bdid != 0),
				//DCAV2.Keys().bdid.qa, Vern V2
				DCA.Key_DCA_BDID,
