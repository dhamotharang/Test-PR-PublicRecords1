...
export raw := module
  ...
  export business_risk.Layout_Input_Moxie_2
    ...
    export iesp.income_risk.t_IncomeRiskAssessmentReportResponse
      ...
      proflic_mod := project(mod_access, PersonReports.IParam.proflic, opt);
     ...
     iesp.income_risk.t_IncomeRiskAssessmentReportResponse
        ...
        self.ProfessionalLicenses := choosen(PersonReports.proflic_records(did_sample_ds, proflic_mod).proflicenses_v2, iesp.Constants.BR.MaxProfLicenses);
