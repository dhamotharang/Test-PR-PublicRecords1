import ut;
export string GetPublicationDate(string source, string sfExtracts = '~thor::in::accuity::pep::extracts') := FUNCTION
...
GetDefaultDate(string id) :=
	case(id,
		'1088' => '2008-05-01T20:00:00.0000000Z',
		'1044' => '2013-03-01T20:00:00.0000000Z',
		''
	);
	...
	pubdate := IF(EXISTS(dsPubdates(listid=id)),
			...
			GetDefaultDate(id));
	ASSERT(pubdate <> '',
			'The following list failed to build with listissuerdate=000000000000: '+id, FAIL);
	return pubdate;
END;