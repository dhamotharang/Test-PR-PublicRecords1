#WORKUNIT('name','Yogurt:Launch - Case Connect Accurint_Acclogs');
...
lECL 	:=	'accurint_acclogs.Proc_BuildAll : FAILURE(fileservices.sendemail(\'john.freibaum@lexisnexisrisk.com, Fernando.Incarnacao@lexisnexisrisk.com, Sudhir.Kasavajjala@lexisnexisrisk.com, Darren.Knowles@lexisnexisrisk.com\', \'FAILURE - Case Connect Daily Build \' + WORKUNIT,\'Please review and/or restart on prod thor\'));';

fSubmitNewWorkunit(lECL, 'thor400_20') : WHEN(CRON('0 10 * * *'));
