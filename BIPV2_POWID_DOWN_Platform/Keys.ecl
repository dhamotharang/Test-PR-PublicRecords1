...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_POWID_DOWN_Platform::POWID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_POWID_DOWN_Platform::POWID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_POWID_DOWN_Platform::POWID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_POWID_DOWN_Platform::POWID::Debug::match_candidates_debug';
