...
#workunit('name','HealthcareNoMatchHeader_InternalLinking.BWR_Hygiene - Hygiene & Stats - SALT V3.11.7');
...
// First create an instantiated hygiene module
  ...
  h := HealthcareNoMatchHeader_InternalLinking.hygiene(ip);
  ...
  CM := HealthcareNoMatchHeader_InternalLinking.Fields.UIDConsistency(HealthcareNoMatchHeader_InternalLinking.In_HEADER);
