...
/*HACK-O-MATIC*/EXPORT match_candidates(STRING pSrc, STRING pVersion =  (STRING)STD.Date.Today(), DATASET(layout_HEADER) ih) := MODULE
SHARED s := /*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).Specificities[1];
  h00 := HealthcareNoMatchHeader_InternalLinking./*HACK-O-MATIC*/BasicMatch(pSrc,pVersion,ih).input_file;
...
layout_candidates add_ST(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ST_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j19 := JOIN(h1,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ST_values_persisted),LEFT.ST=RIGHT.ST,add_ST(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
layout_candidates add_DOB_year(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_year_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j19000 := JOIN(j19,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_year_values_persisted),LEFT.DOB_year=RIGHT.DOB_year,add_DOB_year(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_DOB_month(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_month_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j19001 := JOIN(j19000,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_month_values_persisted),LEFT.DOB_month=RIGHT.DOB_month,add_DOB_month(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
layout_candidates add_DOB_day(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_day_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j19002 := JOIN(j19001,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).DOB_day_values_persisted),LEFT.DOB_day=RIGHT.DOB_day,add_DOB_day(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
layout_candidates add_SSN(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SSN_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  SELF.SSN_cnt := ri.cnt;
  ...
  SELF := le;
END;
j17 := JOIN(j19002,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SSN_values_persisted),LEFT.SSN=RIGHT.SSN,add_SSN(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
layout_candidates add_GENDER(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).GENDER_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j15 := JOIN(j17,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).GENDER_values_persisted),LEFT.GENDER=RIGHT.GENDER,add_GENDER(LEFT,RIGHT,TRUE),LOOKUP,FEW,LEFT OUTER);
layout_candidates add_LOCALE(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).LOCALE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j14 := JOIN(j15,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).LOCALE_values_persisted),LEFT.LOCALE=RIGHT.LOCALE,add_LOCALE(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_ZIP(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ZIP_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j13 := JOIN(j14,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ZIP_values_persisted),LEFT.ZIP=RIGHT.ZIP,add_ZIP(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_CITY_NAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).CITY_NAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
j12 := JOIN(j13,PULL(/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).CITY_NAME_values_persisted),LEFT.CITY_NAME=RIGHT.CITY_NAME,add_CITY_NAME(LEFT,RIGHT,TRUE),LOOKUP,LEFT OUTER);
layout_candidates add_SEC_RANGE(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SEC_RANGE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j12,s.nulls_SEC_RANGE,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SEC_RANGE_values_persisted,SEC_RANGE,SEC_RANGE_weight100,add_SEC_RANGE,j11);
layout_candidates add_FNAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).FNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j11,s.nulls_FNAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).FNAME_values_persisted,FNAME,FNAME_weight100,add_FNAME,j10);
layout_candidates add_PRIM_NAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).PRIM_NAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j10,s.nulls_PRIM_NAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).PRIM_NAME_values_persisted,PRIM_NAME,PRIM_NAME_weight100,add_PRIM_NAME,j9);
layout_candidates add_LNAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).LNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j9,s.nulls_LNAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).LNAME_values_persisted,LNAME,LNAME_weight100,add_LNAME,j8);
layout_candidates add_SUFFIX(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SUFFIX_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j8,s.nulls_SUFFIX,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).SUFFIX_values_persisted,SUFFIX,SUFFIX_weight100,add_SUFFIX,j7);
layout_candidates add_PRIM_RANGE(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).PRIM_RANGE_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j7,s.nulls_PRIM_RANGE,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).PRIM_RANGE_values_persisted,PRIM_RANGE,PRIM_RANGE_weight100,add_PRIM_RANGE,j6);
layout_candidates add_MNAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).MNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j6,s.nulls_MNAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).MNAME_values_persisted,MNAME,MNAME_weight100,add_MNAME,j5);
layout_candidates add_ADDRESS(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ADDRESS_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j5,s.nulls_ADDRESS,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ADDRESS_values_persisted,ADDRESS,ADDRESS_weight100,add_ADDRESS,j4);
layout_candidates add_ADDR1(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ADDR1_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j4,s.nulls_ADDR1,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).ADDR1_values_persisted,ADDR1,ADDR1_weight100,add_ADDR1,j3);
layout_candidates add_FULLNAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).FULLNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j3,s.nulls_FULLNAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).FULLNAME_values_persisted,FULLNAME,FULLNAME_weight100,add_FULLNAME,j2);
layout_candidates add_MAINNAME(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).MAINNAME_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT311.MAC_Choose_JoinType(j2,s.nulls_MAINNAME,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).MAINNAME_values_persisted,MAINNAME,MAINNAME_weight100,add_MAINNAME,j1);
layout_candidates add_LEXID(layout_candidates le,/*HACK-O-MATIC*/Specificities(pSrc,pVersion,ih).LEXID_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
...
TotalWeight_NoDedup := Annotated_NoDedup.LEXID_weight100 + Annotated_NoDedup.FULLNAME_weight100 + Annotated_NoDedup.ADDRESS_weight100 + Annotated_NoDedup.GENDER_weight100 + Annotated_NoDedup.SSN_weight100 + Annotated_NoDedup.DOB_year_weight100 + Annotated_NoDedup.DOB_month_weight100 + Annotated_NoDedup.DOB_day_weight100;
