...
/*HACK-O-MATIC*/EXPORT specificities( STRING  pSrc,
/*HACK-O-MATIC*/                      STRING  pVersion  = (STRING)STD.Date.Today(),
/*HACK-O-MATIC*/                      DATASET(layout_HEADER) ih) := MODULE
...
EXPORT SSN_values_persisted_temp := distance_computed : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::SSN',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  DOB_year_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,DOB_year) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::DOB_year',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT DOB_year_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::DOB_year',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  DOB_month_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,DOB_month) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::DOB_month',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT DOB_month_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::DOB_month',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  DOB_day_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,DOB_day) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::DOB_day',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT DOB_day_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::DOB_day',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  LEXID_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,LEXID) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::LEXID',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT LEXID_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::LEXID',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  SUFFIX_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,SUFFIX) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::SUFFIX',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT SUFFIX_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::SUFFIX',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  FNAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,FNAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::FNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT FNAME_values_persisted_temp := initial_specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::FNAME_temp',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  MNAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,MNAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::MNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT MNAME_values_persisted_temp := initial_specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::MNAME_temp',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  LNAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,LNAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::LNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT LNAME_values_persisted_temp := initial_specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::LNAME_temp',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  GENDER_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,GENDER) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::GENDER',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT GENDER_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::GENDER',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  PRIM_NAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,PRIM_NAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::PRIM_NAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT PRIM_NAME_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::PRIM_NAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  PRIM_RANGE_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,PRIM_RANGE) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::PRIM_RANGE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT PRIM_RANGE_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::PRIM_RANGE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  SEC_RANGE_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,SEC_RANGE) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::SEC_RANGE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT SEC_RANGE_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::SEC_RANGE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  CITY_NAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,CITY_NAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::CITY_NAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT CITY_NAME_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::CITY_NAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  ST_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,ST) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::ST',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ST_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::ST',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  ZIP_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,ZIP) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::ZIP',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ZIP_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::ZIP',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  DT_FIRST_SEEN_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,DT_FIRST_SEEN) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::DT_FIRST_SEEN',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT DT_FIRST_SEEN_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::DT_FIRST_SEEN',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  DT_LAST_SEEN_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,DT_LAST_SEEN) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::DT_LAST_SEEN',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT DT_LAST_SEEN_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::DT_LAST_SEEN',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  MAINNAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,MAINNAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::MAINNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT MAINNAME_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::MAINNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  ADDR1_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,ADDR1) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::ADDR1',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ADDR1_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::ADDR1',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  LOCALE_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,LOCALE) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::LOCALE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT LOCALE_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::LOCALE',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  ADDRESS_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,ADDRESS) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::ADDRESS',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
  ...
  SALT311.utMAC_Sequence_Records(with_id,id,sequenced)
  SALT311.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT ADDRESS_values_persisted_temp := specs_added : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'values::ADDRESS',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
 
EXPORT  FULLNAME_deduped := SALT311.MAC_Field_By_UID(input_file,nomatch_id,FULLNAME) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::FULLNAME',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire)); // Reduce to field values by UID
...
END;
SHARED uber_values_deduped := PROJECT(uber_values_deduped0,TRANSFORM(Layout_Uber_Plus_Spec,SELF.nomatch_id:=LEFT.uid,SELF:=LEFT)) : /*HACK-O-MATIC*/PERSIST(HealthcareNoMatchHeader_Ingest.Filenames(pSrc).lPersistTemplate+pVersion+'::'+'dedups::uber',EXPIRE(HealthcareNoMatchHeader_InternalLinking.Config.PersistExpire));
