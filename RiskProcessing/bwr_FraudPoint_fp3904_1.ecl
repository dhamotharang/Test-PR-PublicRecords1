#workunit('name','Fraudpoint-fp3904');
...
outputFile := '~jpyon::out::avon_1371_Fraudpoint_out';
...
layout_old_acct into_fdInput(f le, INTEGER c) := TRANSFORM
	...
	self.model := 'fp3904_1';	// set to blank if you don't want the new model
