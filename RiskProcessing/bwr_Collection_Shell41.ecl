#workunit('name','Collection Shell 4.1');
...
outfile_name := '~dvstemp::out::collection_shell41_premiere_2038_'+ thorlib.wuid();	// this will output your work unit number in your filename
...
risk_indicators.collection_shell_mod.collection_shell_layout_edina_v41 convertToEdina_v41(f le) := transform
