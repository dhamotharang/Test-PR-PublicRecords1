...
outputFile := '~khuls::out::ProfileBooster_';
...
string50  Custom_Model	              := 'PBM1803_0';                 // this will include the Mobility Score 
// string50  Custom_Model	              := '';
...
PB_input_batch := record
	...
	string50 	Custom_Model       	      := Custom_Model;
END;
