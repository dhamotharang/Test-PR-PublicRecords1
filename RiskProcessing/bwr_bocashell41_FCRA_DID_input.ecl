...
output_name := '~jbiesinger::out::ln_3639_fcra_bs_41_test';	// this will output your work unit number in your filename;
...
prescreen_score := models.RVP804_0_0(group(sort(project(roxie_results, transform(risk_indicators.Layout_Boca_Shell, self := left, self := [])), seq), seq));
