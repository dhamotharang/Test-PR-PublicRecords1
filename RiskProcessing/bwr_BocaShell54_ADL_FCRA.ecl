#workunit('name','ADL FCRA Bocashell 5.4');
...
IMPORT Risk_Indicators, RiskWise, riskprocessing, ut, Data_Services, _control;

unsigned record_limit :=  1000;    //number of records to read from input file; 0 means ALL
...
//===================  input-output files  ======================
// infile_name :=  Data_Services.foreign_prod+'tfuerstenberg::in::fico_4332_fullsample_in_pt25';
infile_name :=  '~foreign::' + _control.IPAddress.prod_thor_dali + '::' +'tfuerstenberg::in::fico_4332_fullsample_in_pt25';

outfile_name := '~khuls::out::adl_fcra54_' + thorlib.wuid();	// this will output your work unit number in your filename;
...
edina := Risk_Indicators.ToEdina_54_ADL(f, isFCRA, DataRestrictionMask, IntendedPurpose);
