...
//  Sandbox the following variable in Risk_Indicators.ToEdina_v50 includeADLFields := TRUE;   AND If you set this to TRUE, make sure you set it to TRUE in Risk_Indicators.Layout_Boca_Shell_Edina_v50!
...
outfile_name := '~mlwalklin::out::NonfcraBS50_ADL_Avenger_' + thorlib.wuid();	// this will output your work unit number in your filename;
...
roxieIP := RiskWise.Shortcuts.prod_batch_neutral; 		// FCRAbatch Roxie
