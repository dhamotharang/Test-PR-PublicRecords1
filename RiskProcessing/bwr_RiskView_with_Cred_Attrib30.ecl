...
output(final,,'~tfuerstenberg::out::rvattrib30_out',CSV(heading(single), quote('"')), overwrite);
output(final(errorcode<>''),,'~tfuerstenberg::out::citi_1914_rvattrib30_error',CSV(QUOTE('"')), overwrite);
