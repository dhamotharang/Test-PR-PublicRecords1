#workunit('name','ADL Bocashell30-nonfcra');
...
input_name := '~jpyon::in::sprint_pii_090709_subset_in';
output_name := '~tfuerstenberg::out::test_adl_bs_out_'+ thorlib.wuid();	// this will output your work unit number in your filename;
