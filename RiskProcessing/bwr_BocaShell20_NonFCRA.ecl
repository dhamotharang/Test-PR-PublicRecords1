...
//===================  input-output files  ======================
//infile_name  := ut.foreign_dataland+'dvstemp::in::walmart';
infile_name :=  '~jpyon::in::paro_7361_f_s_in_in';
outfile_name := '~dvstemp::out::paro_nonfcra_bs_2_out_' + thorlib.wuid();
...
x := RECORD
	...
	STRING100 errorcode;
END;	
f := dataset(outfile_name, x, csv(quote('"')));
