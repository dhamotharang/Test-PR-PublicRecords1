#workunit('name', 'Business_Shell_V21');
...
BusShellVersion := 21; //business shell version 21 is the most recent business shell version and should be the default version run (use bwr_business_shell_v2 for v2 by modeler request ONLY)

inputFileName := '~hmccarl::in::bshell_test_inputs';

outputFile := '~lweiner::out::business_shell_v21_results_' + ThorLib.wuid();
