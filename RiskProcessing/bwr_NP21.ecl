#workunit('name','NonFCRA-np21-process');
...
Scoring.Layout_NP2O_Soapcall into_NP2O_input(f le) := transform
	self.tribcode := 'np21';  // !! replace the tribcode here !!
...
output(s,,'~tfuerstenberg::out::bofa_807_file2_histdt_np21_out_tim',csv(heading(single), quote('"')), overwrite);
