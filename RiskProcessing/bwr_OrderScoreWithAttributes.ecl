/* *** Note that Netacuity is turned OFF *** needs to use Cert gateway  
But Model does use Netacuity! */
#workunit('name','Order Score With Attributes');
...
outfile_name := '~akoenen::out::test_order_score_attributes_out_'+ thorlib.wuid();	// this will output your work unit number in your filename
outfile_name_err:= '~akoenen::out::test_order_score_attributes_out::error:'+ thorlib.wuid();	// this will output your work unit number in your filename
outfile_name_miss :='~akoenen::out::test_order_score_attributes_out::misses:'+ thorlib.wuid();
//==============  Program uses Consumer Data Only  ====================
...
soapInput := soapInput_nonDist;//DISTRIBUTE (soapInput_nonDist, RANDOM());

output(count(soapInput), named('soapInputCnt'));
...
//attributes	
	identityV4     := le.Result.AttributeGroups(name='IdentityV4')[1].attributes;
	relationshipV4 := le.Result.AttributeGroups(name='RelationshipV4')[1].attributes;
	velocityV4     := le.Result.AttributeGroups(name='VelocityV4')[1].attributes;
	
	
	self.BillToAgeOldestRecord                 := IdentityV4[1].value;
	self.ShipToAgeOldestRecord                 := IdentityV4[2].value;
	self.BillToAgeNewestRecord                 := IdentityV4[3].value;
	self.ShipToAgeNewestRecord                 := IdentityV4[4].value;
	self.BillToRecentUpdate                    := IdentityV4[5].value;
	self.ShipToRecentUpdate                    := IdentityV4[6].value;
	self.BillToSrcsConfirmIDAddrCount          := IdentityV4[7].value;
	self.ShipToSrcsConfirmIDAddrCount          := IdentityV4[8].value;
	self.BillToVerificationFailure             := IdentityV4[9].value;
	self.ShipToVerificationFailure             := IdentityV4[10].value;
	self.BillToVerifiedName                    := IdentityV4[11].value;
	self.ShipToVerifiedName                    := IdentityV4[12].value;
	self.BillToVerifiedPhone                   := IdentityV4[13].value;
	self.ShipToVerifiedPhone                   := IdentityV4[14].value;
	self.BillToVerifiedAddress                 := IdentityV4[15].value;
	self.ShipToVerifiedAddress                 := IdentityV4[16].value;


	self.BillToAssetVerifiedIdentity           := IdentityV4[17].value;
	self.ShipToAssetVerifiedIdentity           := IdentityV4[18].value;
	self.BillToPropRealVerifiedIdentity        := IdentityV4[19].value;
	self.ShipToPropRealVerifiedIdentity        := IdentityV4[20].value;
	self.BillToPropRealSourceCount             := IdentityV4[21].value;
	self.ShipToPropRealSourceCount             := IdentityV4[22].value;
	self.BillToPropPersVerifiedIdentity        := IdentityV4[23].value;
	self.ShipToPropPersVerifiedIdentity        := IdentityV4[24].value;
	self.BillToPropPersSourceCount             := IdentityV4[25].value;
	self.ShipToPropPersSourceCount             := IdentityV4[26].value;
	self.BillToInferredMinimumAge              := IdentityV4[27].value;
	self.ShipToInferredMinimumAge              := IdentityV4[28].value;
	self.BillToAddrIdentityCount               := IdentityV4[29].value;
	self.ShipToAddrIdentityCount               := IdentityV4[30].value;
	self.BillToAddrPhoneCount                  := IdentityV4[31].value;
	self.ShipToAddrPhoneCount                  := IdentityV4[32].value;
	self.BillToAddrIdentityRecentCount         := IdentityV4[33].value;
	self.ShipToAddrIdentityRecentCount         := IdentityV4[34].value;
	self.BillToAddrPhoneRecentCount            := IdentityV4[35].value;
	self.ShipToAddrPhoneRecentCount            := IdentityV4[36].value;
	self.BillToPhoneIdentityCount              := IdentityV4[37].value;
	self.ShipToPhoneIdentityCount              := IdentityV4[38].value;
	self.BillToPhoneIdentityRecentCount        := IdentityV4[39].value;
	self.ShipToPhoneIdentityRecentCount        := IdentityV4[40].value;
	self.BillToAddrStability                   := IdentityV4[41].value;
	self.ShipToAddrStability                   := IdentityV4[42].value;
	self.BillToStatusMostRecent                := IdentityV4[43].value;
	self.ShipToStatusMostRecent                := IdentityV4[44].value;
	self.BillToAddrChangeCount03               := IdentityV4[45].value;
	self.ShipToAddrChangeCount03               := IdentityV4[46].value;
	self.BillToFraudDerogSeverityIndex         := IdentityV4[47].value;
	self.ShipToFraudDerogSeverityIndex         := IdentityV4[48].value;
	self.BillToDerogCount                      := IdentityV4[49].value;
	self.ShipToDerogCount                      := IdentityV4[50].value;
	self.BillToDerogRecentCount                := IdentityV4[51].value;
	self.ShipToDerogRecentCount                := IdentityV4[52].value;
	self.BillToDerogAge                        := IdentityV4[53].value;
	self.ShipToDerogAge                        := IdentityV4[54].value;
	self.BillToFelonyCount                     := IdentityV4[55].value;
	self.ShipToFelonyCount                     := IdentityV4[56].value;
	self.BillToFelonyAge                       := IdentityV4[57].value;
	self.ShipToFelonyAge                       := IdentityV4[58].value;
	self.BillToEvictionCount                   := IdentityV4[59].value;
	self.ShipToEvictionCount                   := IdentityV4[60].value;
	self.BillToEvictionAge                     := IdentityV4[61].value;
	self.ShipToEvictionAge                     := IdentityV4[62].value;
	self.BillToProfLicCount                    := IdentityV4[63].value;
	self.ShipToProfLicCount                    := IdentityV4[64].value;
	self.BillToPhoneMobile                     := IdentityV4[65].value;
	self.ShipToPhoneMobile                     := IdentityV4[66].value;
	self.BillToProfLicAge                      := IdentityV4[67].value;
	self.ShipToProfLicAge                      := IdentityV4[68].value;
	self.BillToPhoneEDAAgeOldestRecord         := IdentityV4[69].value;
	self.ShipToPhoneEDAAgeOldestRecord         := IdentityV4[70].value;
	self.BillToPhoneEDAAgeNewestRecord         := IdentityV4[71].value;
	self.ShipToPhoneEDAAgeNewestRecord         := IdentityV4[72].value;
	self.BillToPhoneOthAgeOldestRecord         := IdentityV4[73].value;
	self.ShipToPhoneOthAgeOldestRecord         := IdentityV4[74].value;
	self.BillToPhoneOthAgeNewestRecord         := IdentityV4[75].value;
	self.ShipToPhoneOthAgeNewestRecord         := IdentityV4[76].value;
	self.BillToAddrHighRisk                    := IdentityV4[77].value;
	self.ShipToAddrHighRisk                    := IdentityV4[78].value;
	self.BillToInputPhoneHighRisk              := IdentityV4[79].value;
	self.ShipToInputPhoneHighRisk              := IdentityV4[80].value;
	self.BillToInputPhoneProblems              := IdentityV4[81].value;
	self.ShipToInputPhoneProblems              := IdentityV4[82].value;
	self.BillToInputAddrProblems               := IdentityV4[83].value;
	self.ShipToInputAddrProblems               := IdentityV4[84].value;


	self.BillToShipToSameIdentity              := RelationshipV4[1].value;
	self.BillToShipToSameName                  := RelationshipV4[2].value;
	self.BillToShipToSameAddr                  := RelationshipV4[3].value;
	self.BillToFNameFoundEmail                 := RelationshipV4[4].value;
	self.ShipToFNameFoundEmail                 := RelationshipV4[5].value;
	self.BillToLNameFoundEmail                 := RelationshipV4[6].value;
	self.ShipToLNameFoundEmail                 := RelationshipV4[7].value;
	self.BillToPhoneBillToAddrDist             := RelationshipV4[8].value;
	self.ShipToPhoneShipToAddrDist             := RelationshipV4[9].value;
	self.BillToPhoneShipToAddrDist             := RelationshipV4[10].value;
	self.BillToShipToPhoneDist                 := RelationshipV4[11].value;
	self.BillToShipToAddrDist                  := RelationshipV4[12].value;
	self.BillToAddrShipToPhoneDist             := RelationshipV4[13].value;
	self.BillToShipToRelative                  := RelationshipV4[14].value;
	self.BillToShipToCommonRelative            := RelationshipV4[15].value;


	self.BillToSearchCBDAgeOldestRecord        := VelocityV4[1].value;
	self.ShipToSearchCBDAgeOldestRecord        := VelocityV4[2].value;
	self.BillToSearchCBDAgeNewestRecord        := VelocityV4[3].value;
	self.ShipToSearchCBDAgeNewestRecord        := VelocityV4[4].value;
	self.BillToSearchCBDCount                  := VelocityV4[5].value;
	self.ShipToSearchCBDCount                  := VelocityV4[6].value;
	self.BillToSearchCBDCount01                := VelocityV4[7].value;
	self.ShipToSearchCBDCount01                := VelocityV4[8].value;
	self.BillToSearchCBDIdentityAddr           := VelocityV4[9].value;
	self.ShipToSearchCBDIdentityAddr           := VelocityV4[10].value;
	self.BillToSearchCBDAddrIdentity           := VelocityV4[11].value;
	self.ShipToSearchCBDAddrIdentity           := VelocityV4[12].value;
	self.BillToSearchCBDIdentityPhone          := VelocityV4[13].value;
	self.ShipToSearchCBDIdentityPhone          := VelocityV4[14].value;
	self.BillToSearchOthAgeOldestRecord        := VelocityV4[15].value;
	self.ShipToSearchOthAgeOldestRecord        := VelocityV4[16].value;
	self.BillToSearchOthAgeNewestRecord        := VelocityV4[17].value;
	self.ShipToSearchOthAgeNewestRecord        := VelocityV4[18].value;
	self.BillToSearchOthCount                  := VelocityV4[19].value;
	self.ShipToSearchOthCount                  := VelocityV4[20].value;
	self.BillToSearchOthCount01                := VelocityV4[21].value;
	self.ShipToSearchOthCount01                := VelocityV4[22].value;
	self.BillToSearchLocateCount               := VelocityV4[23].value;
	self.ShipToSearchLocateCount               := VelocityV4[24].value;
	self.BillToSearchLocateCount01             := VelocityV4[25].value;
	self.ShipToSearchLocateCount01             := VelocityV4[26].value;
	self.BillToSearchRetailCount               := VelocityV4[27].value;
	self.ShipToSearchRetailCount               := VelocityV4[28].value;
	self.BillToSearchRetailCount01             := VelocityV4[29].value;
	self.ShipToSearchRetailCount01             := VelocityV4[30].value;
	self.BillToSearchOthAddrIdentity           := VelocityV4[31].value;
	self.ShipToSearchOthAddrIdentity           := VelocityV4[32].value;
...
output(count(soap_final_out),named('outputCnt'));
