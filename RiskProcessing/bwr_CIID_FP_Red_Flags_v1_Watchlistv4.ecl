import ut, risk_indicators, models, scoring, riskwise, iesp;
#workunit('name','Consumer IID-FP Process_V4Watchlist');
...
outputfile := '~mmarshik::out::ciid_out';
...
output(all_results,,outputfile,CSV(heading(single), quote('"')), overwrite);
output(all_results(errorcode<>''),,outputfile + '_error',CSV(QUOTE('"')), overwrite);