#workunit('name','Collection Shell');
...
//===================  input-output files  ======================
// infile_name := '~nmontpetit::in::coll_shell_pii_100604';
// infile_name := '~jpyon::in::ln_2038_f_s_in';
...
risk_indicators.collection_shell_mod.collection_shell_layout_edina convertToEdina(f le) := transform
