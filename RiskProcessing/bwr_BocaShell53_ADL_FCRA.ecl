#workunit('name','ADL FCRA Bocashell 5.3');
...
outfile_name := '~khuls::out::adl_fcra53_' + thorlib.wuid();	// this will output your work unit number in your filename;
...
edina := Risk_Indicators.ToEdina_53_ADL(f, isFCRA, DataRestrictionMask, IntendedPurpose);
