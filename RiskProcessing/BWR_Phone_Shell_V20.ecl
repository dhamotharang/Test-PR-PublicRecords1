...
#WORKUNIT('name', 'Phone_Shell V2.0');
...
PhoneShell_version := 20; // 21 for 2.1; A different script should be used for 1.0.

IncludeFPScores := TRUE; // Default is FALSE (for v1) or TRUE (for v2+). This is to match better when compared to running a 5.4 Boca Shell directly.
