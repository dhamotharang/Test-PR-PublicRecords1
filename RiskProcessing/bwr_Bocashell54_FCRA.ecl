#workunit('name','FCRA Bocashell 5.4 Process');
...
outfile_name := '~khuls::out::FCRA_Bocashell_54_script_test_' + thorlib.wuid();	// this will output your work unit number in your filename;
