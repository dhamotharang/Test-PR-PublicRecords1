...
// input := DATASET([
	...
	// {'05','','','','','','',U'è¨€æ˜Ž',U'èƒ¡','','','','','1976','6','5','','','34','','','',U'æ–—é—¨',U'è·¯',U'æ¢¦æ€¡è½©',U'5æ£Ÿ','','','505','','','',U'ç æµ·','','','',U'å¹¿ä¸œ','',U'é¦™æ´²','','','CN','87513544','','','','','','','','','','','440861896421345987',U'ç æµ·','',U'é¦™æ´²',U'å¹¿ä¸œ','','','','','','','','','','','','','','','','','','','','',FALSE,FALSE,FALSE,FALSE,FALSE,'','','',FALSE,FALSE,FALSE,FALSE,FALSE,0,'','','','','','','',''},
	...
	// {'09',U'å¥å¤ª','','','','','','',U'å±±æœ¬','','','','M','1980','12','7','','','','','',U'ï¼™ï¼ï¼ï¼ï¼’ï¼ï¼‘','','',U'æ—­ã‚±ä¸˜ï¼‘ï¼ï¼‘ï¼ï¼ï¼‘ï¼ï¼“ï¼ï¼–','','','','','','','','',U'å’Œå€‰ç”ºãƒ¨',U'ä¸ƒå°¾å¸‚','','','','',U'çŸ³å·çœŒ','100-8994','JP','845313','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',FALSE,FALSE,FALSE,FALSE,FALSE,'','','',FALSE,FALSE,FALSE,FALSE,FALSE,0,'','','','','','','',''},
	...
	// {'16','LUKAS','','','GRUBER','','','','','','','','','1988','8','4','','','','','','','DENKMASCHINENSTRASSE','','','3','','','','','','','ZÃœRICH','','','','','','','','8266','CH','948371694','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',FALSE,FALSE,FALSE,FALSE,FALSE,'','','',FALSE,FALSE,FALSE,FALSE,FALSE,0,'','','','','','','',''},
...
gateways := DATASET([
	...
	{'netacuity','http://rw_data_prod:Password01@gatewayprodesp.sc.seisint.com:7726/wsGateway','',[]}
