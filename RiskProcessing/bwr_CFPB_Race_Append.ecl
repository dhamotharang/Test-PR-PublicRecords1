...
census_surnames := dataset('~hmccarl::cfpb_race_proxy::census_surnames_lower',zz_cfpb_race_proxy.layouts.surnames_layout,csv(quote('"'))); 
///////////////////////////////////////////////////////////////////;
...
clean_name GetCleanLastName(dget_geo_codes l) := TRANSFORM 
	 ...
	 ln_clean_lname 		:= stringlib.stringtolowercase(if(ln_clean_name<>'', address.cleanNameFields(ln_clean_name).lname, ''));
