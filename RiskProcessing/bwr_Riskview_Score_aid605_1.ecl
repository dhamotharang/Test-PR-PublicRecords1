...
paramsA := dataset([{'Custom', 'aid605_1'},{'monthlyincome_value',le.TOTAL_NET_INCOME},{'numberofyearsemployed',le.EMPLOYMENT_YEARS},{'numberofmonthsemployed',le.EMPLOYMENT_MONTHS}], models.Layout_Parameters);	// use this for non-version1 models, also possibly change the scores that you call below
...
output(j_f,,'~jpyon::out::region_3035_aid605_1_out',CSV(heading(single), quote('"')), overwrite);
