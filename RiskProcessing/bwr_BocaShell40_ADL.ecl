#workunit('name','ADL Bocashell 4.0-nonfcra');
...
output_name := '~dvstemp::out::test_adl_bs40_out_'+ thorlib.wuid();	// this will output your work unit number in your filename;
...
adl_edina := join(roxie_results, p_f, left.seq=(unsigned)right.accountnumber, convertToEdina_v4(left, right));
output(choosen(adl_edina, eyeball), named('adl_edina'));
output(adl_edina,,output_name + '_edina_v4', csv(quote('"')),overwrite );