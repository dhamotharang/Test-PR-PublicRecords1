#workunit('name','ADL Bocashell 4.0-Fcra Prescreen Score');
...
output_name := '~dvstemp::out::adlfcra_chase_1139_'+ thorlib.wuid();	// this will output your work unit number in your filename;

roxieIP :=    	   RiskWise.Shortcuts.prod_batch_fcra;		// FCRA RoxieBatch prod
neutral_roxieIP := RiskWise.Shortcuts.prod_batch_neutral;	// RoxieBatch prod
