...
outputFile := '~akoenen::new::amex_8055_gcp_output1_sba_nonsbfe_new_model';
...
layout_flat_v1 flatten_v1(layout_soap le, SmallBusinessAnalyticsoutput ri) := TRANSFORM
 ...
 SLBO_Results := ri.Result.Models(TRIM(Name)='SLBO1702_0_2')[1];
	Model2 := IF(includeBusinessOnlyModel AND TRIM(SELF.Model1Name) <> 'SLBO1702_0_2', SLBO_Results, ri.Result.Models[2]);
