#workunit('name','NonFCRA BT-ST Bocashell 4.1 Process');
...
ox convertToEdina_v41(f le) := transform
...
output(edina,, outfile_name+'_edina_v41',CSV(QUOTE('"'),maxlength(8192)),overwrite);