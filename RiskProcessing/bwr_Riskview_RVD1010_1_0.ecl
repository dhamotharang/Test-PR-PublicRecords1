...
paramsR := dataset([{'Custom', 'rvd1010_1'}], models.Layout_Parameters);	// use this for non-version1 models, also possibly change the scores that you call below
...
ox normit(resu L, p_f R) := transform
	...
	retaModel1 := l.models[1].scores(description='RetailRVD10101');
	retaModel2 := l.models[2].scores(description='RetailRVD10101');
	retaModel3 := l.models[3].scores(description='RetailRVD10101');
	retaModel4 := l.models[4].scores(description='RetailRVD10101');
	retaModel5 := l.models[5].scores(description='RetailRVD10101');
	retaModel6 := l.models[6].scores(description='RetailRVD10101');
...
output(j_f,,'~jpyon::out::republic_2208_200k_RVD1010_1_out',CSV(heading(single), quote('"')), overwrite);
