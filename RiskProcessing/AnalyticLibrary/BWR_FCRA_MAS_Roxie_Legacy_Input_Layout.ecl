/* BWR_FCRA_MAS_Roxie_Legacy_Input_Layout */

IMPORT PublicRecords_KEL, RiskWise, SALT38, SALTRoutines, STD, gateway;
threads := 1;

roxieIP := RiskWise.Shortcuts.prod_batch_fcra; 
...
OutputFile := '~ak::out::PublicRecs::FCRA_AnalyticalLibrary_Legacy_Input_Layout_'+ ThorLib.wuid() ;
...
self.StreetAddressline1 := left.StreetAddress;
