...
Command line options: -MScrubs_DL_TX -eC:\Users\wolfkg\AppData\Local\Temp\TFRB1C3.tmp 
...
FIELDTYPE:invalid_trans_indicator:ENUM(D|U)
FIELDTYPE:invalid_card_type:ENUM(DL|ID)
FIELDTYPE:invalid_dl_number:LENGTHS(10):LIKE(invalid_numeric)
FIELDTYPE:invalid_name:CUSTOM(Scrubs_DL_TX.Functions.fn_valid_name>0,first_name,middle_name)
FIELDTYPE:invalid_past_date:LENGTHS(8):CUSTOM(Scrubs_DL_TX.Functions.fn_valid_past_date>0)
FIELDTYPE:invalid_state:CUSTOM(Scrubs_DL_TX.Functions.fn_verify_state>0)
FIELDTYPE:invalid_zip:LENGTHS(5):LIKE(invalid_numeric)
FIELDTYPE:invalid_zip4:LENGTHS(0,4):LIKE(invalid_numeric)
FIELDTYPE:invalid_date:LENGTHS(8):CUSTOM(Scrubs_DL_TX.Functions.fn_valid_date>0)
FIELDTYPE:invalid_name2:CUSTOM(Scrubs_DL_TX.Functions.fn_valid_name>0,fname,mname)
...
FIELDTYPE:invalid_record_type:LENGTHS(0,1,2):CUSTOM(Scrubs_DL_TX.Functions.fn_addr_rec_type>0)
...
FIELD:trans_indicator:TYPE(STRING1):LIKE(invalid_trans_indicator):0,0
FIELD:card_type:TYPE(STRING2):LIKE(invalid_card_type):0,0
FIELD:dl_number:TYPE(STRING10):LIKE(invalid_dl_number):0,0
FIELD:last_name:TYPE(STRING40):LIKE(invalid_name):0,0
FIELD:first_name:TYPE(STRING40):0,0
FIELD:middle_name:TYPE(STRING40):0,0
FIELD:suffix_name:TYPE(STRING5):0,0
FIELD:date_of_birth:TYPE(STRING8):LIKE(invalid_past_date):0,0
FIELD:street_addr1:TYPE(STRING32):LIKE(invalid_mandatory):0,0
FIELD:street_addr2:TYPE(STRING32):0,0
FIELD:city:TYPE(STRING33):LIKE(invalid_alpha_num):0,0
FIELD:in_state:TYPE(STRING2):LIKE(invalid_state):0,0
FIELD:zip:TYPE(STRING5):LIKE(invalid_zip):0,0
FIELD:in_zip4:TYPE(STRING4):LIKE(invalid_zip4):0,0
FIELD:issue_date:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:title:TYPE(STRING5):0,0
FIELD:fname:TYPE(STRING20):0,0
FIELD:mname:TYPE(STRING20):0,0
FIELD:lname:TYPE(STRING20):LIKE(invalid_name2):0,0
FIELD:suffix:TYPE(STRING5):0,0
FIELD:name_score:TYPE(STRING3):LIKE(invalid_numeric):0,0
