...
EXPORT RawProperty := MODULE
  ...
  FUNCTION
		...
		assessment_suppressed_recs := assessment_flag_recs(compliance_flags.isSuppressed);		
	...
	//-------deed-----------
		...
		deed_suppressed_recs := deed_flag_recs(compliance_flags.isSuppressed);		
		...
		property_search_suppressed_recs := property_search_flag_recs(compliance_flags.isSuppressed);		
