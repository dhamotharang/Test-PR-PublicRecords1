...
MODULE
  ...
  MODULE
    ...
    EXPORT UNSIGNED2 MaxAdvoPerAddress   := 100; 
    ...
    EXPORT UNSIGNED2 MaxCrimEvents       := 100;   
    ...
    EXPORT UNSIGNED2 MaxHuntersPerDID    := 350;  // ut.limits.HUNTERS_PER_DID
		...
		EXPORT UNSIGNED2 MaxInquiriesPerDID  := 1000; 
    EXPORT UNSIGNED1 MaxLiensPerDID      := 500;
    ...
    EXPORT UNSIGNED2 MaxOptOutPerDID     := 100;
