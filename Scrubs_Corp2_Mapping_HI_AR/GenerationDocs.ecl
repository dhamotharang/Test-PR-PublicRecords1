...
Command line options: -MScrubs_Corp2_Mapping_HI_AR -eC:\Users\butlersx\AppData\Local\Temp\TFRE72D.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_HI_AR
FILENAME:In_HI
...
FIELDTYPE:invalid_corp_key:ALLOW(-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(4..):CUSTOM(Scrubs_Corp2_Mapping_HI_AR.Functions.invalid_corp_key>0)
FIELDTYPE:invalid_charter_nbr:ALLOW( -ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789):LENGTHS(1..):CUSTOM(Scrubs_Corp2_Mapping_HI_AR.Functions.invalid_corp_sos_charter_nbr>0)
...
FIELD:ar_comment:TYPE(STRING350):LIKE(invalid_alphablank):0,0
FIELD:ar_type:TYPE(STRING60):0,0
FIELD:ar_exempt:TYPE(STRING1):0,0
FIELD:ar_license_tax_amount:TYPE(STRING20):0,0
FIELD:ar_status:TYPE(STRING50):LIKE(invalid_alphablank):0,0
