...
kf := dedup(sort(dataset('~thor_data400::base::override::fcra::qa::watercraft',fcra.layout_override_watercraft-[global_sid,record_sid],csv(separator('\t'),quote('\"'),terminator('\r\n')),opt),-flag_file_id),except flag_file_id,keep(1));
