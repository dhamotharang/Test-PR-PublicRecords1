...
kf := dedup(sort(distribute(dataset('~thor_data400::base::override::fcra::qa::liensv2_party',FCRA.Layout_Override_Liensv2_party,xml('liensv2_party/row'),opt),hash(tmsid)),tmsid,rmsid,-flag_file_id,local),except flag_file_id,keep(1),local);
