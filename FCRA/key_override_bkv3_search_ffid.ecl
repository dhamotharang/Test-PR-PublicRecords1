...
kfSearch := dedup(sort(dataset('~thor_data400::base::override::fcra::qa::bankrupt_search', FCRA.layout_search_ffid_v3,xml('bk_search/row'),opt),-flag_file_id),except flag_file_id,keep(1));
