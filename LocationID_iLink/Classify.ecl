...
SHARED TotalClusters := specificities(h).TotalClusters;
  ...
  v_city_name_tokens := PROJECT(specificities(h).v_city_name_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.v_city_name; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  st_tokens := PROJECT(specificities(h).st_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.st; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  zip5_tokens := PROJECT(specificities(h).zip5_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.zip5; SELF.TokenType := 4; SELF.Spc := LEFT.field_Specificity ));
  cntprimname_tokens := PROJECT(specificities(h).cntprimname_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.cntprimname; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  sec_range_tokens := PROJECT(specificities(h).sec_range_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.sec_range; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  postdir_tokens := PROJECT(specificities(h).postdir_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.postdir; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  predir_tokens := PROJECT(specificities(h).predir_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.predir; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  prim_name_tokens := PROJECT(specificities(h).prim_name_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.prim_name; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  err_stat_tokens := PROJECT(specificities(h).err_stat_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.err_stat; SELF.TokenType := 13; SELF.Spc := LEFT.field_Specificity ));
  addr_suffix_tokens := PROJECT(specificities(h).addr_suffix_values_persisted,TRANSFORM(SALT37.Layout_Classify_Token,SELF.TokenValue := (SALT37.StrType)LEFT.addr_suffix; SELF.TokenType := 14; SELF.Spc := LEFT.field_Specificity ));
SHARED all_tokens0 := prim_range_tokens + v_city_name_tokens + st_tokens + zip5_tokens + cntprimname_tokens + sec_range_tokens + postdir_tokens + predir_tokens + prim_name_tokens + err_stat_tokens + addr_suffix_tokens;
SHARED all_tokens := SALT37.fn_process_multitokens(all_tokens0);
 
EXPORT TokenKeyName := '~'+'key::LocationId_iLink::LocId::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::LocationId_iLink::LocId::Token::MultiTokenKey';
