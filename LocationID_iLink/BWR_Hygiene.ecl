...
#workunit('name','LocationId_iLink.BWR_Hygiene - Hygiene & Stats - SALT V3.7.0');
IMPORT LocationId_iLink,SALT37;
// First create an instantiated hygiene module
  infile := LocationId_iLink.In_LocationId;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := LocationId_iLink.Hygiene(ip);
  ...
  CM := LocationId_iLink.Fields.UIDConsistency(LocationId_iLink.In_LocationId);
