...
j54 := join(j53, archive54,
					...
					append_more_history(left, right),
						full outer, local);
archive55 := distribute(hist2021_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j55 := join(j54, archive55,
					...
					append_more_history(left, right),
						full outer, local);
archive56 := distribute(hist2021_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j56 := join(j55, archive56,
					...
					append_more_history(left, right),
						full outer, local);
archive57 := distribute(hist2021_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j57 := join(j56, archive57,
					...
					append_more_history(left, right),
						full outer, local);
archive58 := distribute(hist2022_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j58 := join(j57, archive58,
					...
					append_more_history(left, right),
						full outer, local);
archive59 := distribute(hist2022_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j59 := join(j58, archive59,
					...
					append_more_history(left, right),
						full outer, local);
archive60 := distribute(hist2022_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j60 := join(j59, archive60,
					...
					append_more_history(left, right),
						full outer, local);
archive61:= distribute(hist2022_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j61 := join(j60, archive60,
					...
					append_more_history(left, right),
						full outer, local);
archive62 := distribute(hist2023_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
...
archive63 := distribute(hist2023_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j63 := join(j62, archive63,
					...
					append_more_history(left, right),
						full outer, local);
archive64 := distribute(hist2023_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j64 := join(j63, archive64,
					...
					append_more_history(left, right),
						full outer, local);
archive65 := distribute(hist2023_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j65 := join(j64, archive65,
					...
					append_more_history(left, right),
						full outer, local);
archive66 := distribute(hist2024_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j66 := join(j65, archive66,
					...
					append_more_history(left, right),
						full outer, local);
archive67 := distribute(hist2024_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j67 := join(j66, archive67,
					...
					append_more_history(left, right),
						full outer, local);
archive68 := distribute(hist2024_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j68 := join(j67, archive68,
					...
					append_more_history(left, right),
						full outer, local);
archive69 := distribute(hist2024_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j69 := join(j68, archive69,
					...
					append_more_history(left, right),
						full outer, local);
archive70 := distribute(hist2025_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j70 := join(j69, archive70,
					...
					append_more_history(left, right),
						full outer, local);
archive71 := distribute(hist2025_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j71 := join(j70, archive71,
					...
					append_more_history(left, right),
						full outer, local);
archive72 := distribute(hist2025_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j72 := join(j71, archive72,
					...
					append_more_history(left, right),
						full outer, local);
archive73 := distribute(hist2025_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j73 := join(j72, archive73,
					...
					append_more_history(left, right),
						full outer, local);
archive74 := distribute(hist2026_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j74 := join(j73, archive74,
					...
					append_more_history(left, right),
						full outer, local);
archive75 := distribute(hist2026_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j75 := join(j74, archive75,
					...
					append_more_history(left, right),
						full outer, local);
archive76 := distribute(hist2026_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j76 := join(j75, archive76,
					...
					append_more_history(left, right),
						full outer, local);
archive77 := distribute(hist2026_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j77 := join(j76, archive77,
					...
					append_more_history(left, right),
						full outer, local);
archive78 := distribute(hist2027_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j78 := join(j77, archive78,
					...
					append_more_history(left, right),
						full outer, local);
archive79 := distribute(hist2027_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j79 := join(j78, archive79,
					...
					append_more_history(left, right),
						full outer, local);
archive80 := distribute(hist2027_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j80 := join(j79, archive80,
					...
					append_more_history(left, right),
						full outer, local);
archive81 := distribute(hist2027_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j81 := join(j80, archive81,
					...
					append_more_history(left, right),
						full outer, local);
archive82 := distribute(hist2028_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j82 := join(j81, archive82,
					...
					append_more_history(left, right),
						full outer, local);
archive83 := distribute(hist2028_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j83 := join(j82, archive83,
					...
					append_more_history(left, right),
						full outer, local);
archive84 := distribute(hist2028_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j84 := join(j83, archive84,
					...
					append_more_history(left, right),
						full outer, local);
archive85 := distribute(hist2028_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j85 := join(j84, archive85,
					...
					append_more_history(left, right),
						full outer, local);
archive86 := distribute(hist2029_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
...
archive87 := distribute(hist2029_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j87 := join(j86, archive87,
					...
					append_more_history(left, right),
						full outer, local);
archive88 := distribute(hist2029_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j88 := join(j87, archive88,
					...
					append_more_history(left, right),
						full outer, local);
archive89 := distribute(hist2029_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j89 := join(j88, archive89,
					...
					append_more_history(left, right),
						full outer, local);
archive90 := distribute(hist2030_q1, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j90 := join(j89, archive90,
					...
					append_more_history(left, right),
						full outer, local);
archive91 := distribute(hist2030_q2, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j91 := join(j90, archive91,
					...
					append_more_history(left, right),
						full outer, local);
archive92 := distribute(hist2030_q3, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j92 := join(j91, archive92,
					...
					append_more_history(left, right),
						full outer, local);
archive93 := distribute(hist2030_q4, hash(unformatted_apn,zip,prim_range,prim_name,predir,suffix,postdir,sec_range));	
j93 := join(j92, archive93,
						left.zip=right.zip and
						left.prim_range=right.prim_range and
						left.predir=right.predir and
						left.prim_name=right.prim_name and
