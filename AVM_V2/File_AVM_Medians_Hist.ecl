...
archive49 := distribute(hist2021_q1, hash(fips_geo_12));
j49 := join(j48, archive49,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive50 := distribute(hist2021_q2, hash(fips_geo_12));
j50 := join(j49, archive50,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive51 := distribute(hist2021_q3, hash(fips_geo_12));
j51 := join(j50, archive51,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive52 := distribute(hist2021_q4, hash(fips_geo_12));
j52 := join(j51, archive52,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive53 := distribute(hist2022_q1, hash(fips_geo_12));
j53 := join(j52, archive53,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive54 := distribute(hist2022_q2, hash(fips_geo_12));
j54 := join(j53, archive54,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive55 := distribute(hist2022_q3, hash(fips_geo_12));
...
archive56 := distribute(hist2022_q4, hash(fips_geo_12));
j56 := join(j54, archive56,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	
						
archive57 := distribute(hist2023_q1, hash(fips_geo_12));
j57 := join(j56, archive57,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	
archive58 := distribute(hist2023_q2, hash(fips_geo_12));
j58 := join(j57, archive58,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive59 := distribute(hist2023_q3, hash(fips_geo_12));
j59 := join(j58, archive59,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	
archive60 := distribute(hist2023_q4, hash(fips_geo_12));
j60 := join(j59, archive60,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive61 := distribute(hist2024_q1, hash(fips_geo_12));
j61 := join(j60, archive61,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive62 := distribute(hist2024_q2, hash(fips_geo_12));
j62 := join(j61, archive62,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive63 := distribute(hist2024_q3, hash(fips_geo_12));
j63 := join(j62, archive63,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive64 := distribute(hist2024_q4, hash(fips_geo_12));
j64 := join(j63, archive64,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive65 := distribute(hist2025_q1, hash(fips_geo_12));
j65 := join(j64, archive65,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive66 := distribute(hist2025_q2, hash(fips_geo_12));
j66 := join(j65, archive66,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive67 := distribute(hist2025_q3, hash(fips_geo_12));
j67 := join(j66, archive67,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive68 := distribute(hist2025_q4, hash(fips_geo_12));
j68 := join(j67, archive68,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive69 := distribute(hist2026_q1, hash(fips_geo_12));
j69 := join(j68, archive69,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive70 := distribute(hist2026_q2, hash(fips_geo_12));
j70 := join(j69, archive70,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive71 := distribute(hist2026_q3, hash(fips_geo_12));
j71 := join(j70, archive71,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive72 := distribute(hist2026_q4, hash(fips_geo_12));
j72 := join(j71, archive72,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive73 := distribute(hist2027_q1, hash(fips_geo_12));
j73 := join(j72, archive73,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive74 := distribute(hist2027_q2, hash(fips_geo_12));
j74 := join(j73, archive74,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive75 := distribute(hist2027_q3, hash(fips_geo_12));
j75 := join(j74, archive75,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive76 := distribute(hist2027_q4, hash(fips_geo_12));
j76 := join(j75, archive76,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive77 := distribute(hist2028_q1, hash(fips_geo_12));
j77 := join(j76, archive77,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive78 := distribute(hist2028_q2, hash(fips_geo_12));
j78 := join(j77, archive78,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);

archive79 := distribute(hist2028_q3, hash(fips_geo_12));
j79 := join(j78, archive79,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive80 := distribute(hist2028_q4, hash(fips_geo_12));
j80 := join(j79, archive80,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive81 := distribute(hist2029_q1, hash(fips_geo_12));
j81 := join(j80, archive81,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive82 := distribute(hist2029_q2, hash(fips_geo_12));
j82 := join(j81, archive82,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive83 := distribute(hist2029_q3, hash(fips_geo_12));
j83 := join(j82, archive83,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);

archive84 := distribute(hist2029_q4, hash(fips_geo_12));
j84 := join(j83, archive84,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive85 := distribute(hist2030_q1, hash(fips_geo_12));
j85 := join(j84, archive85,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive86 := distribute(hist2030_q2, hash(fips_geo_12));
j86 := join(j85, archive86,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive87 := distribute(hist2030_q3, hash(fips_geo_12));
j87 := join(j86, archive87,
						left.fips_geo_12=right.fips_geo_12,
					append_more_history(left, right),
						full outer, local);	

archive88 := distribute(hist2030_q4, hash(fips_geo_12));
