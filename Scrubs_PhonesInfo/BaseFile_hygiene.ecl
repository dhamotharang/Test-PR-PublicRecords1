...
EXPORT Summary(SALT38.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_reference_id := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.reference_id)));
    avelength_reference_id := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.reference_id)),h.reference_id<>(typeof(h.reference_id))'');
    ...
    maxlength_dt_first_reported := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.dt_first_reported)));
    avelength_dt_first_reported := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.dt_first_reported)),h.dt_first_reported<>(typeof(h.dt_first_reported))'');
    ...
    maxlength_dt_last_reported := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.dt_last_reported)));
    avelength_dt_last_reported := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.dt_last_reported)),h.dt_last_reported<>(typeof(h.dt_last_reported))'');
    ...
    maxlength_phonetype := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.phonetype)));
    avelength_phonetype := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.phonetype)),h.phonetype<>(typeof(h.phonetype))'');
    ...
    maxlength_reply_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.reply_code)));
    avelength_reply_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.reply_code)),h.reply_code<>(typeof(h.reply_code))'');
    ...
    maxlength_local_routing_number := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.local_routing_number)));
    avelength_local_routing_number := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.local_routing_number)),h.local_routing_number<>(typeof(h.local_routing_number))'');
    ...
    maxlength_account_owner := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.account_owner)));
    avelength_account_owner := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.account_owner)),h.account_owner<>(typeof(h.account_owner))'');
    ...
    maxlength_carrier_category := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.carrier_category)));
    avelength_carrier_category := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.carrier_category)),h.carrier_category<>(typeof(h.carrier_category))'');
    ...
    maxlength_local_area_transport_area := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.local_area_transport_area)));
    avelength_local_area_transport_area := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.local_area_transport_area)),h.local_area_transport_area<>(typeof(h.local_area_transport_area))'');
    ...
    maxlength_point_code := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.point_code)));
    avelength_point_code := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.point_code)),h.point_code<>(typeof(h.point_code))'');
    ...
    maxlength_porting_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.porting_time)));
    avelength_porting_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.porting_time)),h.porting_time<>(typeof(h.porting_time))'');
    ...
    maxlength_vendor_first_reported_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.vendor_first_reported_time)));
    avelength_vendor_first_reported_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.vendor_first_reported_time)),h.vendor_first_reported_time<>(typeof(h.vendor_first_reported_time))'');
    ...
    maxlength_vendor_last_reported_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.vendor_last_reported_time)));
    avelength_vendor_last_reported_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.vendor_last_reported_time)),h.vendor_last_reported_time<>(typeof(h.vendor_last_reported_time))'');
    ...
    maxlength_port_start_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.port_start_time)));
    avelength_port_start_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.port_start_time)),h.port_start_time<>(typeof(h.port_start_time))'');
    ...
    maxlength_port_end_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.port_end_time)));
    avelength_port_end_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.port_end_time)),h.port_end_time<>(typeof(h.port_end_time))'');
    ...
    maxlength_serv := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.serv)));
    avelength_serv := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.serv)),h.serv<>(typeof(h.serv))'');
    populated_line_cnt := COUNT(GROUP,h.line <> (TYPEOF(h.line))'');
    populated_line_pcnt := AVE(GROUP,IF(h.line = (TYPEOF(h.line))'',0,100));
    maxlength_line := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.line)));
    avelength_line := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.line)),h.line<>(typeof(h.line))'');
    ...
    maxlength_operator_fullname := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.operator_fullname)));
    avelength_operator_fullname := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.operator_fullname)),h.operator_fullname<>(typeof(h.operator_fullname))'');
    ...
    maxlength_number_in_service := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.number_in_service)));
    avelength_number_in_service := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.number_in_service)),h.number_in_service<>(typeof(h.number_in_service))'');
    ...
    maxlength_high_risk_indicator := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.high_risk_indicator)));
    avelength_high_risk_indicator := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.high_risk_indicator)),h.high_risk_indicator<>(typeof(h.high_risk_indicator))'');
    ...
    maxlength_prepaid := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.prepaid)));
    avelength_prepaid := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.prepaid)),h.prepaid<>(typeof(h.prepaid))'');
    ...
    maxlength_swap_start_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.swap_start_time)));
    avelength_swap_start_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.swap_start_time)),h.swap_start_time<>(typeof(h.swap_start_time))'');
    ...
    maxlength_swap_end_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.swap_end_time)));
    avelength_swap_end_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.swap_end_time)),h.swap_end_time<>(typeof(h.swap_end_time))'');
    ...
    maxlength_deact_start_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.deact_start_time)));
    avelength_deact_start_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.deact_start_time)),h.deact_start_time<>(typeof(h.deact_start_time))'');
    ...
    maxlength_deact_end_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.deact_end_time)));
    avelength_deact_end_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.deact_end_time)),h.deact_end_time<>(typeof(h.deact_end_time))'');
    ...
    maxlength_react_start_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.react_start_time)));
    avelength_react_start_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.react_start_time)),h.react_start_time<>(typeof(h.react_start_time))'');
    ...
    maxlength_react_end_time := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.react_end_time)));
    avelength_react_end_time := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.react_end_time)),h.react_end_time<>(typeof(h.react_end_time))'');
    ...
    maxlength_call_forward_dt := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.call_forward_dt)));
    avelength_call_forward_dt := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.call_forward_dt)),h.call_forward_dt<>(typeof(h.call_forward_dt))'');
    ...
    maxlength_caller_id := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.caller_id)));
    avelength_caller_id := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.caller_id)),h.caller_id<>(typeof(h.caller_id))'');
  END;
...
SALT38.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT38.StrType)le.reference_id),TRIM((SALT38.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.phonetype),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.country_code),TRIM((SALT38.StrType)le.dial_type),TRIM((SALT38.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT38.StrType)le.porting_dt), ''),TRIM((SALT38.StrType)le.porting_time),TRIM((SALT38.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT38.StrType)le.port_start_dt), ''),TRIM((SALT38.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT38.StrType)le.port_end_dt), ''),TRIM((SALT38.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT38.StrType)le.remove_port_dt), ''),TRIM((SALT38.StrType)le.is_ported),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid),TRIM((SALT38.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT38.StrType)le.swap_start_dt), ''),TRIM((SALT38.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT38.StrType)le.swap_end_dt), ''),TRIM((SALT38.StrType)le.swap_end_time),TRIM((SALT38.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT38.StrType)le.deact_start_dt), ''),TRIM((SALT38.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT38.StrType)le.deact_end_dt), ''),TRIM((SALT38.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT38.StrType)le.react_start_dt), ''),TRIM((SALT38.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT38.StrType)le.react_end_dt), ''),TRIM((SALT38.StrType)le.react_end_time),TRIM((SALT38.StrType)le.is_deact),TRIM((SALT38.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT38.StrType)le.call_forward_dt), ''),TRIM((SALT38.StrType)le.caller_id)));
  SELF.FldNo := C;
END;
...
SALT38.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 54);
  SELF.FldNo2 := 1 + (C % 54);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT38.StrType)le.reference_id),TRIM((SALT38.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.phonetype),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.country_code),TRIM((SALT38.StrType)le.dial_type),TRIM((SALT38.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT38.StrType)le.porting_dt), ''),TRIM((SALT38.StrType)le.porting_time),TRIM((SALT38.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT38.StrType)le.port_start_dt), ''),TRIM((SALT38.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT38.StrType)le.port_end_dt), ''),TRIM((SALT38.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT38.StrType)le.remove_port_dt), ''),TRIM((SALT38.StrType)le.is_ported),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid),TRIM((SALT38.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT38.StrType)le.swap_start_dt), ''),TRIM((SALT38.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT38.StrType)le.swap_end_dt), ''),TRIM((SALT38.StrType)le.swap_end_time),TRIM((SALT38.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT38.StrType)le.deact_start_dt), ''),TRIM((SALT38.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT38.StrType)le.deact_end_dt), ''),TRIM((SALT38.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT38.StrType)le.react_start_dt), ''),TRIM((SALT38.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT38.StrType)le.react_end_dt), ''),TRIM((SALT38.StrType)le.react_end_time),TRIM((SALT38.StrType)le.is_deact),TRIM((SALT38.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT38.StrType)le.call_forward_dt), ''),TRIM((SALT38.StrType)le.caller_id)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT38.StrType)le.reference_id),TRIM((SALT38.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.phonetype),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.country_code),TRIM((SALT38.StrType)le.dial_type),TRIM((SALT38.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT38.StrType)le.porting_dt), ''),TRIM((SALT38.StrType)le.porting_time),TRIM((SALT38.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT38.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT38.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT38.StrType)le.port_start_dt), ''),TRIM((SALT38.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT38.StrType)le.port_end_dt), ''),TRIM((SALT38.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT38.StrType)le.remove_port_dt), ''),TRIM((SALT38.StrType)le.is_ported),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid),TRIM((SALT38.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT38.StrType)le.swap_start_dt), ''),TRIM((SALT38.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT38.StrType)le.swap_end_dt), ''),TRIM((SALT38.StrType)le.swap_end_time),TRIM((SALT38.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT38.StrType)le.deact_start_dt), ''),TRIM((SALT38.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT38.StrType)le.deact_end_dt), ''),TRIM((SALT38.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT38.StrType)le.react_start_dt), ''),TRIM((SALT38.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT38.StrType)le.react_end_dt), ''),TRIM((SALT38.StrType)le.react_end_time),TRIM((SALT38.StrType)le.is_deact),TRIM((SALT38.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT38.StrType)le.call_forward_dt), ''),TRIM((SALT38.StrType)le.caller_id)));
  END;
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    BaseFile_Fields.InValid_reference_id((SALT38.StrType)le.reference_id),
    BaseFile_Fields.InValid_source((SALT38.StrType)le.source),
    BaseFile_Fields.InValid_dt_first_reported((SALT38.StrType)le.dt_first_reported),
    BaseFile_Fields.InValid_dt_last_reported((SALT38.StrType)le.dt_last_reported),
    BaseFile_Fields.InValid_phone((SALT38.StrType)le.phone),
    BaseFile_Fields.InValid_phonetype((SALT38.StrType)le.phonetype),
    BaseFile_Fields.InValid_reply_code((SALT38.StrType)le.reply_code),
    BaseFile_Fields.InValid_local_routing_number((SALT38.StrType)le.local_routing_number),
    BaseFile_Fields.InValid_account_owner((SALT38.StrType)le.account_owner),
    BaseFile_Fields.InValid_carrier_name((SALT38.StrType)le.carrier_name),
    BaseFile_Fields.InValid_carrier_category((SALT38.StrType)le.carrier_category),
    BaseFile_Fields.InValid_local_area_transport_area((SALT38.StrType)le.local_area_transport_area),
    BaseFile_Fields.InValid_point_code((SALT38.StrType)le.point_code),
    BaseFile_Fields.InValid_country_code((SALT38.StrType)le.country_code),
    BaseFile_Fields.InValid_dial_type((SALT38.StrType)le.dial_type),
    BaseFile_Fields.InValid_routing_code((SALT38.StrType)le.routing_code),
    BaseFile_Fields.InValid_porting_dt((SALT38.StrType)le.porting_dt),
    BaseFile_Fields.InValid_porting_time((SALT38.StrType)le.porting_time),
    BaseFile_Fields.InValid_country_abbr((SALT38.StrType)le.country_abbr),
    BaseFile_Fields.InValid_vendor_first_reported_dt((SALT38.StrType)le.vendor_first_reported_dt),
    BaseFile_Fields.InValid_vendor_first_reported_time((SALT38.StrType)le.vendor_first_reported_time),
    BaseFile_Fields.InValid_vendor_last_reported_dt((SALT38.StrType)le.vendor_last_reported_dt),
    BaseFile_Fields.InValid_vendor_last_reported_time((SALT38.StrType)le.vendor_last_reported_time),
    BaseFile_Fields.InValid_port_start_dt((SALT38.StrType)le.port_start_dt),
    BaseFile_Fields.InValid_port_start_time((SALT38.StrType)le.port_start_time),
    BaseFile_Fields.InValid_port_end_dt((SALT38.StrType)le.port_end_dt),
    BaseFile_Fields.InValid_port_end_time((SALT38.StrType)le.port_end_time),
    BaseFile_Fields.InValid_remove_port_dt((SALT38.StrType)le.remove_port_dt),
    BaseFile_Fields.InValid_is_ported((SALT38.StrType)le.is_ported),
    BaseFile_Fields.InValid_serv((SALT38.StrType)le.serv),
    BaseFile_Fields.InValid_line((SALT38.StrType)le.line),
    BaseFile_Fields.InValid_spid((SALT38.StrType)le.spid),
    BaseFile_Fields.InValid_operator_fullname((SALT38.StrType)le.operator_fullname),
    BaseFile_Fields.InValid_number_in_service((SALT38.StrType)le.number_in_service),
    BaseFile_Fields.InValid_high_risk_indicator((SALT38.StrType)le.high_risk_indicator),
    BaseFile_Fields.InValid_prepaid((SALT38.StrType)le.prepaid),
    BaseFile_Fields.InValid_phone_swap((SALT38.StrType)le.phone_swap),
    BaseFile_Fields.InValid_swap_start_dt((SALT38.StrType)le.swap_start_dt),
    BaseFile_Fields.InValid_swap_start_time((SALT38.StrType)le.swap_start_time),
    BaseFile_Fields.InValid_swap_end_dt((SALT38.StrType)le.swap_end_dt),
    BaseFile_Fields.InValid_swap_end_time((SALT38.StrType)le.swap_end_time),
    BaseFile_Fields.InValid_deact_code((SALT38.StrType)le.deact_code),
    BaseFile_Fields.InValid_deact_start_dt((SALT38.StrType)le.deact_start_dt),
    BaseFile_Fields.InValid_deact_start_time((SALT38.StrType)le.deact_start_time),
    BaseFile_Fields.InValid_deact_end_dt((SALT38.StrType)le.deact_end_dt),
    BaseFile_Fields.InValid_deact_end_time((SALT38.StrType)le.deact_end_time),
    BaseFile_Fields.InValid_react_start_dt((SALT38.StrType)le.react_start_dt),
    BaseFile_Fields.InValid_react_start_time((SALT38.StrType)le.react_start_time),
    BaseFile_Fields.InValid_react_end_dt((SALT38.StrType)le.react_end_dt),
    BaseFile_Fields.InValid_react_end_time((SALT38.StrType)le.react_end_time),
    BaseFile_Fields.InValid_is_deact((SALT38.StrType)le.is_deact),
    BaseFile_Fields.InValid_is_react((SALT38.StrType)le.is_react),
    BaseFile_Fields.InValid_call_forward_dt((SALT38.StrType)le.call_forward_dt),
    BaseFile_Fields.InValid_caller_id((SALT38.StrType)le.caller_id),
    0);
