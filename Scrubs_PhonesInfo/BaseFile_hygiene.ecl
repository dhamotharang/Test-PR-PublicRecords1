...
EXPORT Summary(SALT310.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_reference_id := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.reference_id)));
    avelength_reference_id := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.reference_id)),h.reference_id<>(typeof(h.reference_id))'');
    ...
    maxlength_source := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.source)));
    avelength_source := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.source)),h.source<>(typeof(h.source))'');
    ...
    maxlength_dt_first_reported := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.dt_first_reported)));
    avelength_dt_first_reported := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.dt_first_reported)),h.dt_first_reported<>(typeof(h.dt_first_reported))'');
    ...
    maxlength_dt_last_reported := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.dt_last_reported)));
    avelength_dt_last_reported := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.dt_last_reported)),h.dt_last_reported<>(typeof(h.dt_last_reported))'');
    populated_phone_cnt := COUNT(GROUP,h.phone <> (TYPEOF(h.phone))'');
    populated_phone_pcnt := AVE(GROUP,IF(h.phone = (TYPEOF(h.phone))'',0,100));
    maxlength_phone := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.phone)));
    avelength_phone := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.phone)),h.phone<>(typeof(h.phone))'');
    ...
    maxlength_phonetype := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.phonetype)));
    avelength_phonetype := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.phonetype)),h.phonetype<>(typeof(h.phonetype))'');
    ...
    maxlength_reply_code := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.reply_code)));
    avelength_reply_code := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.reply_code)),h.reply_code<>(typeof(h.reply_code))'');
    ...
    maxlength_local_routing_number := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.local_routing_number)));
    avelength_local_routing_number := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.local_routing_number)),h.local_routing_number<>(typeof(h.local_routing_number))'');
    ...
    maxlength_account_owner := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.account_owner)));
    avelength_account_owner := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.account_owner)),h.account_owner<>(typeof(h.account_owner))'');
    ...
    maxlength_carrier_name := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.carrier_name)));
    avelength_carrier_name := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.carrier_name)),h.carrier_name<>(typeof(h.carrier_name))'');
    ...
    maxlength_carrier_category := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.carrier_category)));
    avelength_carrier_category := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.carrier_category)),h.carrier_category<>(typeof(h.carrier_category))'');
    ...
    maxlength_local_area_transport_area := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.local_area_transport_area)));
    avelength_local_area_transport_area := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.local_area_transport_area)),h.local_area_transport_area<>(typeof(h.local_area_transport_area))'');
    ...
    maxlength_point_code := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.point_code)));
    avelength_point_code := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.point_code)),h.point_code<>(typeof(h.point_code))'');
    ...
    maxlength_country_code := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.country_code)));
    avelength_country_code := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.country_code)),h.country_code<>(typeof(h.country_code))'');
    ...
    maxlength_dial_type := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.dial_type)));
    avelength_dial_type := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.dial_type)),h.dial_type<>(typeof(h.dial_type))'');
    ...
    maxlength_routing_code := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.routing_code)));
    avelength_routing_code := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.routing_code)),h.routing_code<>(typeof(h.routing_code))'');
    ...
    maxlength_porting_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.porting_dt)));
    avelength_porting_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.porting_dt)),h.porting_dt<>(typeof(h.porting_dt))'');
    ...
    maxlength_porting_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.porting_time)));
    avelength_porting_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.porting_time)),h.porting_time<>(typeof(h.porting_time))'');
    ...
    maxlength_country_abbr := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.country_abbr)));
    avelength_country_abbr := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.country_abbr)),h.country_abbr<>(typeof(h.country_abbr))'');
    ...
    maxlength_vendor_first_reported_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_first_reported_dt)));
    avelength_vendor_first_reported_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_first_reported_dt)),h.vendor_first_reported_dt<>(typeof(h.vendor_first_reported_dt))'');
    ...
    maxlength_vendor_first_reported_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_first_reported_time)));
    avelength_vendor_first_reported_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_first_reported_time)),h.vendor_first_reported_time<>(typeof(h.vendor_first_reported_time))'');
    ...
    maxlength_vendor_last_reported_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_last_reported_dt)));
    avelength_vendor_last_reported_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_last_reported_dt)),h.vendor_last_reported_dt<>(typeof(h.vendor_last_reported_dt))'');
    ...
    maxlength_vendor_last_reported_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_last_reported_time)));
    avelength_vendor_last_reported_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.vendor_last_reported_time)),h.vendor_last_reported_time<>(typeof(h.vendor_last_reported_time))'');
    ...
    maxlength_port_start_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_start_dt)));
    avelength_port_start_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_start_dt)),h.port_start_dt<>(typeof(h.port_start_dt))'');
    ...
    maxlength_port_start_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_start_time)));
    avelength_port_start_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_start_time)),h.port_start_time<>(typeof(h.port_start_time))'');
    ...
    maxlength_port_end_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_end_dt)));
    avelength_port_end_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_end_dt)),h.port_end_dt<>(typeof(h.port_end_dt))'');
    ...
    maxlength_port_end_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_end_time)));
    avelength_port_end_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.port_end_time)),h.port_end_time<>(typeof(h.port_end_time))'');
    ...
    maxlength_remove_port_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.remove_port_dt)));
    avelength_remove_port_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.remove_port_dt)),h.remove_port_dt<>(typeof(h.remove_port_dt))'');
    ...
    maxlength_is_ported := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_ported)));
    avelength_is_ported := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_ported)),h.is_ported<>(typeof(h.is_ported))'');
    populated_serv_cnt := COUNT(GROUP,h.serv <> (TYPEOF(h.serv))'');
    populated_serv_pcnt := AVE(GROUP,IF(h.serv = (TYPEOF(h.serv))'',0,100));
    maxlength_serv := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.serv)));
    avelength_serv := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.serv)),h.serv<>(typeof(h.serv))'');
    populated_line_cnt := COUNT(GROUP,h.line <> (TYPEOF(h.line))'');
    populated_line_pcnt := AVE(GROUP,IF(h.line = (TYPEOF(h.line))'',0,100));
    maxlength_line := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.line)));
    avelength_line := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.line)),h.line<>(typeof(h.line))'');
    populated_spid_cnt := COUNT(GROUP,h.spid <> (TYPEOF(h.spid))'');
    populated_spid_pcnt := AVE(GROUP,IF(h.spid = (TYPEOF(h.spid))'',0,100));
    maxlength_spid := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.spid)));
    avelength_spid := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.spid)),h.spid<>(typeof(h.spid))'');
    ...
    maxlength_operator_fullname := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.operator_fullname)));
    avelength_operator_fullname := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.operator_fullname)),h.operator_fullname<>(typeof(h.operator_fullname))'');
    ...
    maxlength_number_in_service := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.number_in_service)));
    avelength_number_in_service := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.number_in_service)),h.number_in_service<>(typeof(h.number_in_service))'');
    ...
    maxlength_high_risk_indicator := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.high_risk_indicator)));
    avelength_high_risk_indicator := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.high_risk_indicator)),h.high_risk_indicator<>(typeof(h.high_risk_indicator))'');
    ...
    maxlength_prepaid := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.prepaid)));
    avelength_prepaid := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.prepaid)),h.prepaid<>(typeof(h.prepaid))'');
    ...
    maxlength_phone_swap := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.phone_swap)));
    avelength_phone_swap := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.phone_swap)),h.phone_swap<>(typeof(h.phone_swap))'');
    ...
    maxlength_swap_start_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_start_dt)));
    avelength_swap_start_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_start_dt)),h.swap_start_dt<>(typeof(h.swap_start_dt))'');
    ...
    maxlength_swap_start_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_start_time)));
    avelength_swap_start_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_start_time)),h.swap_start_time<>(typeof(h.swap_start_time))'');
    ...
    maxlength_swap_end_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_end_dt)));
    avelength_swap_end_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_end_dt)),h.swap_end_dt<>(typeof(h.swap_end_dt))'');
    ...
    maxlength_swap_end_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_end_time)));
    avelength_swap_end_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.swap_end_time)),h.swap_end_time<>(typeof(h.swap_end_time))'');
    ...
    maxlength_deact_code := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_code)));
    avelength_deact_code := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_code)),h.deact_code<>(typeof(h.deact_code))'');
    ...
    maxlength_deact_start_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_start_dt)));
    avelength_deact_start_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_start_dt)),h.deact_start_dt<>(typeof(h.deact_start_dt))'');
    ...
    maxlength_deact_start_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_start_time)));
    avelength_deact_start_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_start_time)),h.deact_start_time<>(typeof(h.deact_start_time))'');
    ...
    maxlength_deact_end_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_end_dt)));
    avelength_deact_end_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_end_dt)),h.deact_end_dt<>(typeof(h.deact_end_dt))'');
    ...
    maxlength_deact_end_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_end_time)));
    avelength_deact_end_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.deact_end_time)),h.deact_end_time<>(typeof(h.deact_end_time))'');
    ...
    maxlength_react_start_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_start_dt)));
    avelength_react_start_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_start_dt)),h.react_start_dt<>(typeof(h.react_start_dt))'');
    ...
    maxlength_react_start_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_start_time)));
    avelength_react_start_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_start_time)),h.react_start_time<>(typeof(h.react_start_time))'');
    ...
    maxlength_react_end_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_end_dt)));
    avelength_react_end_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_end_dt)),h.react_end_dt<>(typeof(h.react_end_dt))'');
    ...
    maxlength_react_end_time := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_end_time)));
    avelength_react_end_time := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.react_end_time)),h.react_end_time<>(typeof(h.react_end_time))'');
    ...
    maxlength_is_deact := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_deact)));
    avelength_is_deact := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_deact)),h.is_deact<>(typeof(h.is_deact))'');
    ...
    maxlength_is_react := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_react)));
    avelength_is_react := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.is_react)),h.is_react<>(typeof(h.is_react))'');
    ...
    maxlength_call_forward_dt := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.call_forward_dt)));
    avelength_call_forward_dt := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.call_forward_dt)),h.call_forward_dt<>(typeof(h.call_forward_dt))'');
    ...
    maxlength_caller_id := MAX(GROUP,LENGTH(TRIM((SALT310.StrType)h.caller_id)));
    avelength_caller_id := AVE(GROUP,LENGTH(TRIM((SALT310.StrType)h.caller_id)),h.caller_id<>(typeof(h.caller_id))'');
  END;
...
SALT310.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT310.StrType)le.reference_id),TRIM((SALT310.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT310.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT310.StrType)le.dt_last_reported), ''),TRIM((SALT310.StrType)le.phone),TRIM((SALT310.StrType)le.phonetype),TRIM((SALT310.StrType)le.reply_code),TRIM((SALT310.StrType)le.local_routing_number),TRIM((SALT310.StrType)le.account_owner),TRIM((SALT310.StrType)le.carrier_name),TRIM((SALT310.StrType)le.carrier_category),TRIM((SALT310.StrType)le.local_area_transport_area),TRIM((SALT310.StrType)le.point_code),TRIM((SALT310.StrType)le.country_code),TRIM((SALT310.StrType)le.dial_type),TRIM((SALT310.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT310.StrType)le.porting_dt), ''),TRIM((SALT310.StrType)le.porting_time),TRIM((SALT310.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT310.StrType)le.port_start_dt), ''),TRIM((SALT310.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT310.StrType)le.port_end_dt), ''),TRIM((SALT310.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT310.StrType)le.remove_port_dt), ''),TRIM((SALT310.StrType)le.is_ported),TRIM((SALT310.StrType)le.serv),TRIM((SALT310.StrType)le.line),TRIM((SALT310.StrType)le.spid),TRIM((SALT310.StrType)le.operator_fullname),TRIM((SALT310.StrType)le.number_in_service),TRIM((SALT310.StrType)le.high_risk_indicator),TRIM((SALT310.StrType)le.prepaid),TRIM((SALT310.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT310.StrType)le.swap_start_dt), ''),TRIM((SALT310.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT310.StrType)le.swap_end_dt), ''),TRIM((SALT310.StrType)le.swap_end_time),TRIM((SALT310.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT310.StrType)le.deact_start_dt), ''),TRIM((SALT310.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT310.StrType)le.deact_end_dt), ''),TRIM((SALT310.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT310.StrType)le.react_start_dt), ''),TRIM((SALT310.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT310.StrType)le.react_end_dt), ''),TRIM((SALT310.StrType)le.react_end_time),TRIM((SALT310.StrType)le.is_deact),TRIM((SALT310.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT310.StrType)le.call_forward_dt), ''),TRIM((SALT310.StrType)le.caller_id)));
  SELF.FldNo := C;
END;
SHARED FldInv0 := NORMALIZE(h,54,Into(LEFT,COUNTER));
// Move everything into 'pairs' form so processing can be done 'in library'
SALT310.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 54);
  SELF.FldNo2 := 1 + (C % 54);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT310.StrType)le.reference_id),TRIM((SALT310.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT310.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT310.StrType)le.dt_last_reported), ''),TRIM((SALT310.StrType)le.phone),TRIM((SALT310.StrType)le.phonetype),TRIM((SALT310.StrType)le.reply_code),TRIM((SALT310.StrType)le.local_routing_number),TRIM((SALT310.StrType)le.account_owner),TRIM((SALT310.StrType)le.carrier_name),TRIM((SALT310.StrType)le.carrier_category),TRIM((SALT310.StrType)le.local_area_transport_area),TRIM((SALT310.StrType)le.point_code),TRIM((SALT310.StrType)le.country_code),TRIM((SALT310.StrType)le.dial_type),TRIM((SALT310.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT310.StrType)le.porting_dt), ''),TRIM((SALT310.StrType)le.porting_time),TRIM((SALT310.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT310.StrType)le.port_start_dt), ''),TRIM((SALT310.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT310.StrType)le.port_end_dt), ''),TRIM((SALT310.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT310.StrType)le.remove_port_dt), ''),TRIM((SALT310.StrType)le.is_ported),TRIM((SALT310.StrType)le.serv),TRIM((SALT310.StrType)le.line),TRIM((SALT310.StrType)le.spid),TRIM((SALT310.StrType)le.operator_fullname),TRIM((SALT310.StrType)le.number_in_service),TRIM((SALT310.StrType)le.high_risk_indicator),TRIM((SALT310.StrType)le.prepaid),TRIM((SALT310.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT310.StrType)le.swap_start_dt), ''),TRIM((SALT310.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT310.StrType)le.swap_end_dt), ''),TRIM((SALT310.StrType)le.swap_end_time),TRIM((SALT310.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT310.StrType)le.deact_start_dt), ''),TRIM((SALT310.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT310.StrType)le.deact_end_dt), ''),TRIM((SALT310.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT310.StrType)le.react_start_dt), ''),TRIM((SALT310.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT310.StrType)le.react_end_dt), ''),TRIM((SALT310.StrType)le.react_end_time),TRIM((SALT310.StrType)le.is_deact),TRIM((SALT310.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT310.StrType)le.call_forward_dt), ''),TRIM((SALT310.StrType)le.caller_id)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT310.StrType)le.reference_id),TRIM((SALT310.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT310.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT310.StrType)le.dt_last_reported), ''),TRIM((SALT310.StrType)le.phone),TRIM((SALT310.StrType)le.phonetype),TRIM((SALT310.StrType)le.reply_code),TRIM((SALT310.StrType)le.local_routing_number),TRIM((SALT310.StrType)le.account_owner),TRIM((SALT310.StrType)le.carrier_name),TRIM((SALT310.StrType)le.carrier_category),TRIM((SALT310.StrType)le.local_area_transport_area),TRIM((SALT310.StrType)le.point_code),TRIM((SALT310.StrType)le.country_code),TRIM((SALT310.StrType)le.dial_type),TRIM((SALT310.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT310.StrType)le.porting_dt), ''),TRIM((SALT310.StrType)le.porting_time),TRIM((SALT310.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT310.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT310.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT310.StrType)le.port_start_dt), ''),TRIM((SALT310.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT310.StrType)le.port_end_dt), ''),TRIM((SALT310.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT310.StrType)le.remove_port_dt), ''),TRIM((SALT310.StrType)le.is_ported),TRIM((SALT310.StrType)le.serv),TRIM((SALT310.StrType)le.line),TRIM((SALT310.StrType)le.spid),TRIM((SALT310.StrType)le.operator_fullname),TRIM((SALT310.StrType)le.number_in_service),TRIM((SALT310.StrType)le.high_risk_indicator),TRIM((SALT310.StrType)le.prepaid),TRIM((SALT310.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT310.StrType)le.swap_start_dt), ''),TRIM((SALT310.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT310.StrType)le.swap_end_dt), ''),TRIM((SALT310.StrType)le.swap_end_time),TRIM((SALT310.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT310.StrType)le.deact_start_dt), ''),TRIM((SALT310.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT310.StrType)le.deact_end_dt), ''),TRIM((SALT310.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT310.StrType)le.react_start_dt), ''),TRIM((SALT310.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT310.StrType)le.react_end_dt), ''),TRIM((SALT310.StrType)le.react_end_time),TRIM((SALT310.StrType)le.is_deact),TRIM((SALT310.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT310.StrType)le.call_forward_dt), ''),TRIM((SALT310.StrType)le.caller_id)));
  END;
...
SHARED FldIds := DATASET([{1,'reference_id'}
      ...
      ,{52,'is_react'}
      ,{53,'call_forward_dt'}
      ,{54,'caller_id'}],SALT310.MAC_Character_Counts.Field_Identification);
EXPORT AllProfiles := SALT310.MAC_Character_Counts.FN_Profile(FldInv0,FldIds);
 
EXPORT SrcProfiles := SALT310.MAC_Character_Counts.Src_Profile(FldInv0,FldIds);
 
EXPORT Correlations := SALT310.MAC_Correlate.Fn_Profile(Pairs0,FldIds);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    BaseFile_Fields.InValid_reference_id((SALT310.StrType)le.reference_id),
    BaseFile_Fields.InValid_source((SALT310.StrType)le.source),
    BaseFile_Fields.InValid_dt_first_reported((SALT310.StrType)le.dt_first_reported),
    BaseFile_Fields.InValid_dt_last_reported((SALT310.StrType)le.dt_last_reported),
    BaseFile_Fields.InValid_phone((SALT310.StrType)le.phone),
    BaseFile_Fields.InValid_phonetype((SALT310.StrType)le.phonetype),
    BaseFile_Fields.InValid_reply_code((SALT310.StrType)le.reply_code),
    BaseFile_Fields.InValid_local_routing_number((SALT310.StrType)le.local_routing_number),
    BaseFile_Fields.InValid_account_owner((SALT310.StrType)le.account_owner),
    BaseFile_Fields.InValid_carrier_name((SALT310.StrType)le.carrier_name),
    BaseFile_Fields.InValid_carrier_category((SALT310.StrType)le.carrier_category),
    BaseFile_Fields.InValid_local_area_transport_area((SALT310.StrType)le.local_area_transport_area),
    BaseFile_Fields.InValid_point_code((SALT310.StrType)le.point_code),
    BaseFile_Fields.InValid_country_code((SALT310.StrType)le.country_code),
    BaseFile_Fields.InValid_dial_type((SALT310.StrType)le.dial_type),
    BaseFile_Fields.InValid_routing_code((SALT310.StrType)le.routing_code),
    BaseFile_Fields.InValid_porting_dt((SALT310.StrType)le.porting_dt),
    BaseFile_Fields.InValid_porting_time((SALT310.StrType)le.porting_time),
    BaseFile_Fields.InValid_country_abbr((SALT310.StrType)le.country_abbr),
    BaseFile_Fields.InValid_vendor_first_reported_dt((SALT310.StrType)le.vendor_first_reported_dt),
    BaseFile_Fields.InValid_vendor_first_reported_time((SALT310.StrType)le.vendor_first_reported_time),
    BaseFile_Fields.InValid_vendor_last_reported_dt((SALT310.StrType)le.vendor_last_reported_dt),
    BaseFile_Fields.InValid_vendor_last_reported_time((SALT310.StrType)le.vendor_last_reported_time),
    BaseFile_Fields.InValid_port_start_dt((SALT310.StrType)le.port_start_dt),
    BaseFile_Fields.InValid_port_start_time((SALT310.StrType)le.port_start_time),
    BaseFile_Fields.InValid_port_end_dt((SALT310.StrType)le.port_end_dt),
    BaseFile_Fields.InValid_port_end_time((SALT310.StrType)le.port_end_time),
    BaseFile_Fields.InValid_remove_port_dt((SALT310.StrType)le.remove_port_dt),
    BaseFile_Fields.InValid_is_ported((SALT310.StrType)le.is_ported),
    BaseFile_Fields.InValid_serv((SALT310.StrType)le.serv),
    BaseFile_Fields.InValid_line((SALT310.StrType)le.line),
    BaseFile_Fields.InValid_spid((SALT310.StrType)le.spid),
    BaseFile_Fields.InValid_operator_fullname((SALT310.StrType)le.operator_fullname),
    BaseFile_Fields.InValid_number_in_service((SALT310.StrType)le.number_in_service),
    BaseFile_Fields.InValid_high_risk_indicator((SALT310.StrType)le.high_risk_indicator),
    BaseFile_Fields.InValid_prepaid((SALT310.StrType)le.prepaid),
    BaseFile_Fields.InValid_phone_swap((SALT310.StrType)le.phone_swap),
    BaseFile_Fields.InValid_swap_start_dt((SALT310.StrType)le.swap_start_dt),
    BaseFile_Fields.InValid_swap_start_time((SALT310.StrType)le.swap_start_time),
    BaseFile_Fields.InValid_swap_end_dt((SALT310.StrType)le.swap_end_dt),
    BaseFile_Fields.InValid_swap_end_time((SALT310.StrType)le.swap_end_time),
    BaseFile_Fields.InValid_deact_code((SALT310.StrType)le.deact_code),
    BaseFile_Fields.InValid_deact_start_dt((SALT310.StrType)le.deact_start_dt),
    BaseFile_Fields.InValid_deact_start_time((SALT310.StrType)le.deact_start_time),
    BaseFile_Fields.InValid_deact_end_dt((SALT310.StrType)le.deact_end_dt),
    BaseFile_Fields.InValid_deact_end_time((SALT310.StrType)le.deact_end_time),
    BaseFile_Fields.InValid_react_start_dt((SALT310.StrType)le.react_start_dt),
    BaseFile_Fields.InValid_react_start_time((SALT310.StrType)le.react_start_time),
    BaseFile_Fields.InValid_react_end_dt((SALT310.StrType)le.react_end_dt),
    BaseFile_Fields.InValid_react_end_time((SALT310.StrType)le.react_end_time),
    BaseFile_Fields.InValid_is_deact((SALT310.StrType)le.is_deact),
    BaseFile_Fields.InValid_is_react((SALT310.StrType)le.is_react),
    BaseFile_Fields.InValid_call_forward_dt((SALT310.StrType)le.call_forward_dt),
    BaseFile_Fields.InValid_caller_id((SALT310.StrType)le.caller_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT310.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_PhonesInfo, BaseFile_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
 
  fieldPopulationOverall_Standard := IF(doSummaryGlobal, NORMALIZE(fieldPopulationOverall, COUNT(FldIds) * 6, xSummary(LEFT, COUNTER, myTimeStamp, 'all', 'all')));
  fieldPopulationOverall_TotalRecs_Standard := IF(doSummaryGlobal, SALT310.mod_StandardStatsTransforms.mac_hygieneTotalRecs(fieldPopulationOverall, myTimeStamp, 'all', FALSE, 'all'));
  allProfiles_Standard := IF(doAllProfiles, SALT310.mod_StandardStatsTransforms.hygieneAllProfiles(AllProfiles, myTimeStamp, 10, 'all'));
