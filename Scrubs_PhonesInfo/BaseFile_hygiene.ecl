...
EXPORT Summary(SALT39.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_phonetype := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.phonetype)));
    avelength_phonetype := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.phonetype)),h.phonetype<>(typeof(h.phonetype))'');
    ...
    maxlength_porting_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.porting_time)));
    avelength_porting_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.porting_time)),h.porting_time<>(typeof(h.porting_time))'');
    ...
    maxlength_vendor_first_reported_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.vendor_first_reported_time)));
    avelength_vendor_first_reported_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.vendor_first_reported_time)),h.vendor_first_reported_time<>(typeof(h.vendor_first_reported_time))'');
    ...
    maxlength_vendor_last_reported_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.vendor_last_reported_time)));
    avelength_vendor_last_reported_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.vendor_last_reported_time)),h.vendor_last_reported_time<>(typeof(h.vendor_last_reported_time))'');
    ...
    maxlength_port_start_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.port_start_time)));
    avelength_port_start_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.port_start_time)),h.port_start_time<>(typeof(h.port_start_time))'');
    ...
    maxlength_port_end_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.port_end_time)));
    avelength_port_end_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.port_end_time)),h.port_end_time<>(typeof(h.port_end_time))'');
    ...
    maxlength_phone_swap := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.phone_swap)));
    avelength_phone_swap := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.phone_swap)),h.phone_swap<>(typeof(h.phone_swap))'');
    ...
    maxlength_swap_start_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_start_dt)));
    avelength_swap_start_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_start_dt)),h.swap_start_dt<>(typeof(h.swap_start_dt))'');
    ...
    maxlength_swap_start_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_start_time)));
    avelength_swap_start_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_start_time)),h.swap_start_time<>(typeof(h.swap_start_time))'');
    ...
    maxlength_swap_end_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_end_dt)));
    avelength_swap_end_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_end_dt)),h.swap_end_dt<>(typeof(h.swap_end_dt))'');
    ...
    maxlength_swap_end_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_end_time)));
    avelength_swap_end_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.swap_end_time)),h.swap_end_time<>(typeof(h.swap_end_time))'');
    ...
    maxlength_deact_code := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_code)));
    avelength_deact_code := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_code)),h.deact_code<>(typeof(h.deact_code))'');
    ...
    maxlength_deact_start_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_start_dt)));
    avelength_deact_start_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_start_dt)),h.deact_start_dt<>(typeof(h.deact_start_dt))'');
    ...
    maxlength_deact_start_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_start_time)));
    avelength_deact_start_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_start_time)),h.deact_start_time<>(typeof(h.deact_start_time))'');
    ...
    maxlength_deact_end_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_end_dt)));
    avelength_deact_end_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_end_dt)),h.deact_end_dt<>(typeof(h.deact_end_dt))'');
    ...
    maxlength_deact_end_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_end_time)));
    avelength_deact_end_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.deact_end_time)),h.deact_end_time<>(typeof(h.deact_end_time))'');
    ...
    maxlength_react_start_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_start_dt)));
    avelength_react_start_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_start_dt)),h.react_start_dt<>(typeof(h.react_start_dt))'');
    ...
    maxlength_react_start_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_start_time)));
    avelength_react_start_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_start_time)),h.react_start_time<>(typeof(h.react_start_time))'');
    ...
    maxlength_react_end_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_end_dt)));
    avelength_react_end_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_end_dt)),h.react_end_dt<>(typeof(h.react_end_dt))'');
    ...
    maxlength_react_end_time := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_end_time)));
    avelength_react_end_time := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.react_end_time)),h.react_end_time<>(typeof(h.react_end_time))'');
    ...
    maxlength_is_deact := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_deact)));
    avelength_is_deact := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_deact)),h.is_deact<>(typeof(h.is_deact))'');
    ...
    maxlength_is_react := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_react)));
    avelength_is_react := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.is_react)),h.is_react<>(typeof(h.is_react))'');
    ...
    maxlength_call_forward_dt := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.call_forward_dt)));
    avelength_call_forward_dt := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.call_forward_dt)),h.call_forward_dt<>(typeof(h.call_forward_dt))'');
    ...
    maxlength_caller_id := MAX(GROUP,LENGTH(TRIM((SALT39.StrType)h.caller_id)));
    avelength_caller_id := AVE(GROUP,LENGTH(TRIM((SALT39.StrType)h.caller_id)),h.caller_id<>(typeof(h.caller_id))'');
  END;
...
SALT39.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT39.StrType)le.reference_id),TRIM((SALT39.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT39.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT39.StrType)le.dt_last_reported), ''),TRIM((SALT39.StrType)le.phone),TRIM((SALT39.StrType)le.phonetype),TRIM((SALT39.StrType)le.reply_code),TRIM((SALT39.StrType)le.local_routing_number),TRIM((SALT39.StrType)le.account_owner),TRIM((SALT39.StrType)le.carrier_name),TRIM((SALT39.StrType)le.carrier_category),TRIM((SALT39.StrType)le.local_area_transport_area),TRIM((SALT39.StrType)le.point_code),TRIM((SALT39.StrType)le.country_code),TRIM((SALT39.StrType)le.dial_type),TRIM((SALT39.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT39.StrType)le.porting_dt), ''),TRIM((SALT39.StrType)le.porting_time),TRIM((SALT39.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT39.StrType)le.port_start_dt), ''),TRIM((SALT39.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT39.StrType)le.port_end_dt), ''),TRIM((SALT39.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT39.StrType)le.remove_port_dt), ''),TRIM((SALT39.StrType)le.is_ported),TRIM((SALT39.StrType)le.serv),TRIM((SALT39.StrType)le.line),TRIM((SALT39.StrType)le.spid),TRIM((SALT39.StrType)le.operator_fullname),TRIM((SALT39.StrType)le.number_in_service),TRIM((SALT39.StrType)le.high_risk_indicator),TRIM((SALT39.StrType)le.prepaid),TRIM((SALT39.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT39.StrType)le.swap_start_dt), ''),TRIM((SALT39.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT39.StrType)le.swap_end_dt), ''),TRIM((SALT39.StrType)le.swap_end_time),TRIM((SALT39.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT39.StrType)le.deact_start_dt), ''),TRIM((SALT39.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT39.StrType)le.deact_end_dt), ''),TRIM((SALT39.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT39.StrType)le.react_start_dt), ''),TRIM((SALT39.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT39.StrType)le.react_end_dt), ''),TRIM((SALT39.StrType)le.react_end_time),TRIM((SALT39.StrType)le.is_deact),TRIM((SALT39.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT39.StrType)le.call_forward_dt), ''),TRIM((SALT39.StrType)le.caller_id)));
  SELF.FldNo := C;
END;
...
SALT39.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 54);
  SELF.FldNo2 := 1 + (C % 54);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT39.StrType)le.reference_id),TRIM((SALT39.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT39.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT39.StrType)le.dt_last_reported), ''),TRIM((SALT39.StrType)le.phone),TRIM((SALT39.StrType)le.phonetype),TRIM((SALT39.StrType)le.reply_code),TRIM((SALT39.StrType)le.local_routing_number),TRIM((SALT39.StrType)le.account_owner),TRIM((SALT39.StrType)le.carrier_name),TRIM((SALT39.StrType)le.carrier_category),TRIM((SALT39.StrType)le.local_area_transport_area),TRIM((SALT39.StrType)le.point_code),TRIM((SALT39.StrType)le.country_code),TRIM((SALT39.StrType)le.dial_type),TRIM((SALT39.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT39.StrType)le.porting_dt), ''),TRIM((SALT39.StrType)le.porting_time),TRIM((SALT39.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT39.StrType)le.port_start_dt), ''),TRIM((SALT39.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT39.StrType)le.port_end_dt), ''),TRIM((SALT39.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT39.StrType)le.remove_port_dt), ''),TRIM((SALT39.StrType)le.is_ported),TRIM((SALT39.StrType)le.serv),TRIM((SALT39.StrType)le.line),TRIM((SALT39.StrType)le.spid),TRIM((SALT39.StrType)le.operator_fullname),TRIM((SALT39.StrType)le.number_in_service),TRIM((SALT39.StrType)le.high_risk_indicator),TRIM((SALT39.StrType)le.prepaid),TRIM((SALT39.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT39.StrType)le.swap_start_dt), ''),TRIM((SALT39.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT39.StrType)le.swap_end_dt), ''),TRIM((SALT39.StrType)le.swap_end_time),TRIM((SALT39.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT39.StrType)le.deact_start_dt), ''),TRIM((SALT39.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT39.StrType)le.deact_end_dt), ''),TRIM((SALT39.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT39.StrType)le.react_start_dt), ''),TRIM((SALT39.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT39.StrType)le.react_end_dt), ''),TRIM((SALT39.StrType)le.react_end_time),TRIM((SALT39.StrType)le.is_deact),TRIM((SALT39.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT39.StrType)le.call_forward_dt), ''),TRIM((SALT39.StrType)le.caller_id)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT39.StrType)le.reference_id),TRIM((SALT39.StrType)le.source),IF (le.dt_first_reported <> 0,TRIM((SALT39.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT39.StrType)le.dt_last_reported), ''),TRIM((SALT39.StrType)le.phone),TRIM((SALT39.StrType)le.phonetype),TRIM((SALT39.StrType)le.reply_code),TRIM((SALT39.StrType)le.local_routing_number),TRIM((SALT39.StrType)le.account_owner),TRIM((SALT39.StrType)le.carrier_name),TRIM((SALT39.StrType)le.carrier_category),TRIM((SALT39.StrType)le.local_area_transport_area),TRIM((SALT39.StrType)le.point_code),TRIM((SALT39.StrType)le.country_code),TRIM((SALT39.StrType)le.dial_type),TRIM((SALT39.StrType)le.routing_code),IF (le.porting_dt <> 0,TRIM((SALT39.StrType)le.porting_dt), ''),TRIM((SALT39.StrType)le.porting_time),TRIM((SALT39.StrType)le.country_abbr),IF (le.vendor_first_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_first_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_first_reported_time),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT39.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT39.StrType)le.vendor_last_reported_time),IF (le.port_start_dt <> 0,TRIM((SALT39.StrType)le.port_start_dt), ''),TRIM((SALT39.StrType)le.port_start_time),IF (le.port_end_dt <> 0,TRIM((SALT39.StrType)le.port_end_dt), ''),TRIM((SALT39.StrType)le.port_end_time),IF (le.remove_port_dt <> 0,TRIM((SALT39.StrType)le.remove_port_dt), ''),TRIM((SALT39.StrType)le.is_ported),TRIM((SALT39.StrType)le.serv),TRIM((SALT39.StrType)le.line),TRIM((SALT39.StrType)le.spid),TRIM((SALT39.StrType)le.operator_fullname),TRIM((SALT39.StrType)le.number_in_service),TRIM((SALT39.StrType)le.high_risk_indicator),TRIM((SALT39.StrType)le.prepaid),TRIM((SALT39.StrType)le.phone_swap),IF (le.swap_start_dt <> 0,TRIM((SALT39.StrType)le.swap_start_dt), ''),TRIM((SALT39.StrType)le.swap_start_time),IF (le.swap_end_dt <> 0,TRIM((SALT39.StrType)le.swap_end_dt), ''),TRIM((SALT39.StrType)le.swap_end_time),TRIM((SALT39.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT39.StrType)le.deact_start_dt), ''),TRIM((SALT39.StrType)le.deact_start_time),IF (le.deact_end_dt <> 0,TRIM((SALT39.StrType)le.deact_end_dt), ''),TRIM((SALT39.StrType)le.deact_end_time),IF (le.react_start_dt <> 0,TRIM((SALT39.StrType)le.react_start_dt), ''),TRIM((SALT39.StrType)le.react_start_time),IF (le.react_end_dt <> 0,TRIM((SALT39.StrType)le.react_end_dt), ''),TRIM((SALT39.StrType)le.react_end_time),TRIM((SALT39.StrType)le.is_deact),TRIM((SALT39.StrType)le.is_react),IF (le.call_forward_dt <> 0,TRIM((SALT39.StrType)le.call_forward_dt), ''),TRIM((SALT39.StrType)le.caller_id)));
  END;
...
SHARED FldIds := DATASET([{1,'reference_id'}
      ...
      ,{52,'is_react'}
      ,{53,'call_forward_dt'}
      ,{54,'caller_id'}],SALT39.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    BaseFile_Fields.InValid_reference_id((SALT39.StrType)le.reference_id),
    BaseFile_Fields.InValid_source((SALT39.StrType)le.source),
    BaseFile_Fields.InValid_dt_first_reported((SALT39.StrType)le.dt_first_reported),
    BaseFile_Fields.InValid_dt_last_reported((SALT39.StrType)le.dt_last_reported),
    BaseFile_Fields.InValid_phone((SALT39.StrType)le.phone),
    BaseFile_Fields.InValid_phonetype((SALT39.StrType)le.phonetype),
    BaseFile_Fields.InValid_reply_code((SALT39.StrType)le.reply_code),
    BaseFile_Fields.InValid_local_routing_number((SALT39.StrType)le.local_routing_number),
    BaseFile_Fields.InValid_account_owner((SALT39.StrType)le.account_owner),
    BaseFile_Fields.InValid_carrier_name((SALT39.StrType)le.carrier_name),
    BaseFile_Fields.InValid_carrier_category((SALT39.StrType)le.carrier_category),
    BaseFile_Fields.InValid_local_area_transport_area((SALT39.StrType)le.local_area_transport_area),
    BaseFile_Fields.InValid_point_code((SALT39.StrType)le.point_code),
    BaseFile_Fields.InValid_country_code((SALT39.StrType)le.country_code),
    BaseFile_Fields.InValid_dial_type((SALT39.StrType)le.dial_type),
    BaseFile_Fields.InValid_routing_code((SALT39.StrType)le.routing_code),
    BaseFile_Fields.InValid_porting_dt((SALT39.StrType)le.porting_dt),
    BaseFile_Fields.InValid_porting_time((SALT39.StrType)le.porting_time),
    BaseFile_Fields.InValid_country_abbr((SALT39.StrType)le.country_abbr),
    BaseFile_Fields.InValid_vendor_first_reported_dt((SALT39.StrType)le.vendor_first_reported_dt),
    BaseFile_Fields.InValid_vendor_first_reported_time((SALT39.StrType)le.vendor_first_reported_time),
    BaseFile_Fields.InValid_vendor_last_reported_dt((SALT39.StrType)le.vendor_last_reported_dt),
    BaseFile_Fields.InValid_vendor_last_reported_time((SALT39.StrType)le.vendor_last_reported_time),
    BaseFile_Fields.InValid_port_start_dt((SALT39.StrType)le.port_start_dt),
    BaseFile_Fields.InValid_port_start_time((SALT39.StrType)le.port_start_time),
    BaseFile_Fields.InValid_port_end_dt((SALT39.StrType)le.port_end_dt),
    BaseFile_Fields.InValid_port_end_time((SALT39.StrType)le.port_end_time),
    BaseFile_Fields.InValid_remove_port_dt((SALT39.StrType)le.remove_port_dt),
    BaseFile_Fields.InValid_is_ported((SALT39.StrType)le.is_ported),
    BaseFile_Fields.InValid_serv((SALT39.StrType)le.serv),
    BaseFile_Fields.InValid_line((SALT39.StrType)le.line),
    BaseFile_Fields.InValid_spid((SALT39.StrType)le.spid),
    BaseFile_Fields.InValid_operator_fullname((SALT39.StrType)le.operator_fullname),
    BaseFile_Fields.InValid_number_in_service((SALT39.StrType)le.number_in_service),
    BaseFile_Fields.InValid_high_risk_indicator((SALT39.StrType)le.high_risk_indicator),
    BaseFile_Fields.InValid_prepaid((SALT39.StrType)le.prepaid),
    BaseFile_Fields.InValid_phone_swap((SALT39.StrType)le.phone_swap),
    BaseFile_Fields.InValid_swap_start_dt((SALT39.StrType)le.swap_start_dt),
    BaseFile_Fields.InValid_swap_start_time((SALT39.StrType)le.swap_start_time),
    BaseFile_Fields.InValid_swap_end_dt((SALT39.StrType)le.swap_end_dt),
    BaseFile_Fields.InValid_swap_end_time((SALT39.StrType)le.swap_end_time),
    BaseFile_Fields.InValid_deact_code((SALT39.StrType)le.deact_code),
    BaseFile_Fields.InValid_deact_start_dt((SALT39.StrType)le.deact_start_dt),
    BaseFile_Fields.InValid_deact_start_time((SALT39.StrType)le.deact_start_time),
    BaseFile_Fields.InValid_deact_end_dt((SALT39.StrType)le.deact_end_dt),
    BaseFile_Fields.InValid_deact_end_time((SALT39.StrType)le.deact_end_time),
    BaseFile_Fields.InValid_react_start_dt((SALT39.StrType)le.react_start_dt),
    BaseFile_Fields.InValid_react_start_time((SALT39.StrType)le.react_start_time),
    BaseFile_Fields.InValid_react_end_dt((SALT39.StrType)le.react_end_dt),
    BaseFile_Fields.InValid_react_end_time((SALT39.StrType)le.react_end_time),
    BaseFile_Fields.InValid_is_deact((SALT39.StrType)le.is_deact),
    BaseFile_Fields.InValid_is_react((SALT39.StrType)le.is_react),
    BaseFile_Fields.InValid_call_forward_dt((SALT39.StrType)le.call_forward_dt),
    BaseFile_Fields.InValid_caller_id((SALT39.StrType)le.caller_id),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_PhonesInfo, BaseFile_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
