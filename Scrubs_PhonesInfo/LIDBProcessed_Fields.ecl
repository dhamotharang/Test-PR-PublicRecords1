...
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Num','Invalid_AccOwn','Invalid_RefID','Invalid_Char','Invalid_Binary','Invalid_Num_In_Service','Invalid_Line_Serv');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'Invalid_Num' => 1,'Invalid_AccOwn' => 2,'Invalid_RefID' => 3,'Invalid_Char' => 4,'Invalid_Binary' => 5,'Invalid_Num_In_Service' => 6,'Invalid_Line_Serv' => 7,0);
...
EXPORT MakeFT_Invalid_AccOwn(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'ABHGCDFE0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_AccOwn(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'ABHGCDFE0123456789 '))));
EXPORT InValidMessageFT_Invalid_AccOwn(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('ABHGCDFE0123456789 '),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_Char(SALT33.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Char(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 \\()&-.,/-#@\'!*'))));
EXPORT InValidMessageFT_Invalid_Char(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 \\()&-.,/-#@\'!*'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_Binary(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'1 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Binary(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'1 '))));
EXPORT InValidMessageFT_Invalid_Binary(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('1 '),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_Num_In_Service(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Num_In_Service(SALT33.StrType s) := WHICH(((SALT33.StrType) s) NOT IN ['1A','2A','3A','4A','7A','10A','12A','1I','2I','3I','4I','7I','10I','12I','U',' ']);
EXPORT InValidMessageFT_Invalid_Num_In_Service(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInEnum('1A|2A|3A|4A|7A|10A|12A|1I|2I|3I|4I|7I|10I|12I|U| '),SALT33.HygieneErrors.Good);
EXPORT MakeFT_Invalid_Line_Serv(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Line_Serv(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123 '))));
EXPORT InValidMessageFT_Invalid_Line_Serv(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123 '),SALT33.HygieneErrors.Good);
...
EXPORT Make_dt_first_reported(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_dt_first_reported(SALT33.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_dt_first_reported(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
EXPORT Make_dt_last_reported(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_dt_last_reported(SALT33.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_account_owner(SALT33.StrType s0) := MakeFT_Invalid_AccOwn(s0);
EXPORT InValid_account_owner(SALT33.StrType s) := InValidFT_Invalid_AccOwn(s);
...
EXPORT Make_local_area_transport_area(SALT33.StrType s0) := s0;
EXPORT InValid_local_area_transport_area(SALT33.StrType s) := FALSE;
...
EXPORT Make_serv(SALT33.StrType s0) := MakeFT_Invalid_Line_Serv(s0);
EXPORT InValid_serv(SALT33.StrType s) := InValidFT_Invalid_Line_Serv(s);
EXPORT InValidMessage_serv(UNSIGNED1 wh) := InValidMessageFT_Invalid_Line_Serv(wh);
EXPORT Make_line(SALT33.StrType s0) := MakeFT_Invalid_Line_Serv(s0);
EXPORT InValid_line(SALT33.StrType s) := InValidFT_Invalid_Line_Serv(s);
...
EXPORT Make_activation_dt(SALT33.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_activation_dt(SALT33.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_high_risk_indicator(SALT33.StrType s0) := MakeFT_Invalid_Binary(s0);
EXPORT InValid_high_risk_indicator(SALT33.StrType s) := InValidFT_Invalid_Binary(s);
EXPORT InValidMessage_high_risk_indicator(UNSIGNED1 wh) := InValidMessageFT_Invalid_Binary(wh);
EXPORT Make_prepaid(SALT33.StrType s0) := MakeFT_Invalid_Binary(s0);
EXPORT InValid_prepaid(SALT33.StrType s) := InValidFT_Invalid_Binary(s);
