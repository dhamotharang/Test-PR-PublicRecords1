...
#workunit('name','Scrubs_PhonesInfo.PhonesTransactionMain_BWR_Scrubs - Checking field validity in a file - SALT V3.11.11');
IMPORT Scrubs_PhonesInfo,SALT311;
infile := Scrubs_PhonesInfo.PhonesTransactionMain_In_PhonesInfo;
mod_scrubs := Scrubs_PhonesInfo.PhonesTransactionMain_Scrubs;
