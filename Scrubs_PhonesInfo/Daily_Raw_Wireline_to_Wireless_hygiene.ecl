...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Daily_Raw_Wireline_to_Wireless_Fields.InValid_phone((SALT31.StrType)le.phone),
    Daily_Raw_Wireline_to_Wireless_Fields.InValid_lf((SALT31.StrType)le.lf),
    Daily_Raw_Wireline_to_Wireless_Fields.InValid_filename((SALT31.StrType)le.filename),
    0);
