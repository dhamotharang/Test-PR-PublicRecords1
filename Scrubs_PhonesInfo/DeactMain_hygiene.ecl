...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_filedate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.filedate)));
    avelength_filedate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.filedate)),h.filedate<>(typeof(h.filedate))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.vendor_first_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_first_reported_dt), ''),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT33.StrType)le.action_code),TRIM((SALT33.StrType)le.timestamp),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.phone_swap),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.carrier_name),TRIM((SALT33.StrType)le.filedate),IF (le.swap_start_dt <> 0,TRIM((SALT33.StrType)le.swap_start_dt), ''),IF (le.swap_end_dt <> 0,TRIM((SALT33.StrType)le.swap_end_dt), ''),TRIM((SALT33.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT33.StrType)le.deact_start_dt), ''),IF (le.deact_end_dt <> 0,TRIM((SALT33.StrType)le.deact_end_dt), ''),IF (le.react_start_dt <> 0,TRIM((SALT33.StrType)le.react_start_dt), ''),IF (le.react_end_dt <> 0,TRIM((SALT33.StrType)le.react_end_dt), ''),TRIM((SALT33.StrType)le.is_react),TRIM((SALT33.StrType)le.is_deact),IF (le.porting_dt <> 0,TRIM((SALT33.StrType)le.porting_dt), '')));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 19);
  SELF.FldNo2 := 1 + (C % 19);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,IF (le.vendor_first_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_first_reported_dt), ''),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT33.StrType)le.action_code),TRIM((SALT33.StrType)le.timestamp),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.phone_swap),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.carrier_name),TRIM((SALT33.StrType)le.filedate),IF (le.swap_start_dt <> 0,TRIM((SALT33.StrType)le.swap_start_dt), ''),IF (le.swap_end_dt <> 0,TRIM((SALT33.StrType)le.swap_end_dt), ''),TRIM((SALT33.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT33.StrType)le.deact_start_dt), ''),IF (le.deact_end_dt <> 0,TRIM((SALT33.StrType)le.deact_end_dt), ''),IF (le.react_start_dt <> 0,TRIM((SALT33.StrType)le.react_start_dt), ''),IF (le.react_end_dt <> 0,TRIM((SALT33.StrType)le.react_end_dt), ''),TRIM((SALT33.StrType)le.is_react),TRIM((SALT33.StrType)le.is_deact),IF (le.porting_dt <> 0,TRIM((SALT33.StrType)le.porting_dt), '')));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,IF (le.vendor_first_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_first_reported_dt), ''),IF (le.vendor_last_reported_dt <> 0,TRIM((SALT33.StrType)le.vendor_last_reported_dt), ''),TRIM((SALT33.StrType)le.action_code),TRIM((SALT33.StrType)le.timestamp),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.phone_swap),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.carrier_name),TRIM((SALT33.StrType)le.filedate),IF (le.swap_start_dt <> 0,TRIM((SALT33.StrType)le.swap_start_dt), ''),IF (le.swap_end_dt <> 0,TRIM((SALT33.StrType)le.swap_end_dt), ''),TRIM((SALT33.StrType)le.deact_code),IF (le.deact_start_dt <> 0,TRIM((SALT33.StrType)le.deact_start_dt), ''),IF (le.deact_end_dt <> 0,TRIM((SALT33.StrType)le.deact_end_dt), ''),IF (le.react_start_dt <> 0,TRIM((SALT33.StrType)le.react_start_dt), ''),IF (le.react_end_dt <> 0,TRIM((SALT33.StrType)le.react_end_dt), ''),TRIM((SALT33.StrType)le.is_react),TRIM((SALT33.StrType)le.is_deact),IF (le.porting_dt <> 0,TRIM((SALT33.StrType)le.porting_dt), '')));
  END;
...
SHARED FldIds := DATASET([{1,'vendor_first_reported_dt'}
      ...
      ,{17,'is_react'}
      ,{18,'is_deact'}
      ,{19,'porting_dt'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    DeactMain_Fields.InValid_vendor_first_reported_dt((SALT33.StrType)le.vendor_first_reported_dt),
    DeactMain_Fields.InValid_vendor_last_reported_dt((SALT33.StrType)le.vendor_last_reported_dt),
    DeactMain_Fields.InValid_action_code((SALT33.StrType)le.action_code),
    DeactMain_Fields.InValid_timestamp((SALT33.StrType)le.timestamp),
    DeactMain_Fields.InValid_phone((SALT33.StrType)le.phone),
    DeactMain_Fields.InValid_phone_swap((SALT33.StrType)le.phone_swap),
    DeactMain_Fields.InValid_filename((SALT33.StrType)le.filename),
    DeactMain_Fields.InValid_carrier_name((SALT33.StrType)le.carrier_name),
    DeactMain_Fields.InValid_filedate((SALT33.StrType)le.filedate),
    DeactMain_Fields.InValid_swap_start_dt((SALT33.StrType)le.swap_start_dt),
    DeactMain_Fields.InValid_swap_end_dt((SALT33.StrType)le.swap_end_dt),
    DeactMain_Fields.InValid_deact_code((SALT33.StrType)le.deact_code),
    DeactMain_Fields.InValid_deact_start_dt((SALT33.StrType)le.deact_start_dt),
    DeactMain_Fields.InValid_deact_end_dt((SALT33.StrType)le.deact_end_dt),
    DeactMain_Fields.InValid_react_start_dt((SALT33.StrType)le.react_start_dt),
    DeactMain_Fields.InValid_react_end_dt((SALT33.StrType)le.react_end_dt),
    DeactMain_Fields.InValid_is_react((SALT33.StrType)le.is_react),
    DeactMain_Fields.InValid_is_deact((SALT33.StrType)le.is_deact),
    DeactMain_Fields.InValid_porting_dt((SALT33.StrType)le.porting_dt),
    0);
