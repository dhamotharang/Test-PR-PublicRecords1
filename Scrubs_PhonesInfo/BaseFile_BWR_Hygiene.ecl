...
#workunit('name','Scrubs_PhonesInfo.BaseFile_BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'BaseFile_Layout_PhonesInfo'),NAMED('OptimizedLayout'));// File layout suggested by data
