...
EXPORT FromNone(DATASET(BaseFile_Layout_PhonesInfo) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.source_Invalid := BaseFile_Fields.InValid_source((SALT310.StrType)le.source);
    SELF.dt_first_reported_Invalid := BaseFile_Fields.InValid_dt_first_reported((SALT310.StrType)le.dt_first_reported);
    SELF.dt_last_reported_Invalid := BaseFile_Fields.InValid_dt_last_reported((SALT310.StrType)le.dt_last_reported);
    SELF.phone_Invalid := BaseFile_Fields.InValid_phone((SALT310.StrType)le.phone);
    SELF.phonetype_Invalid := BaseFile_Fields.InValid_phonetype((SALT310.StrType)le.phonetype);
    SELF.reply_code_Invalid := BaseFile_Fields.InValid_reply_code((SALT310.StrType)le.reply_code);
    SELF.local_routing_number_Invalid := BaseFile_Fields.InValid_local_routing_number((SALT310.StrType)le.local_routing_number);
    SELF.account_owner_Invalid := BaseFile_Fields.InValid_account_owner((SALT310.StrType)le.account_owner);
    SELF.carrier_category_Invalid := BaseFile_Fields.InValid_carrier_category((SALT310.StrType)le.carrier_category);
    SELF.local_area_transport_area_Invalid := BaseFile_Fields.InValid_local_area_transport_area((SALT310.StrType)le.local_area_transport_area);
    SELF.country_code_Invalid := BaseFile_Fields.InValid_country_code((SALT310.StrType)le.country_code);
    SELF.dial_type_Invalid := BaseFile_Fields.InValid_dial_type((SALT310.StrType)le.dial_type);
    SELF.routing_code_Invalid := BaseFile_Fields.InValid_routing_code((SALT310.StrType)le.routing_code);
    SELF.porting_dt_Invalid := BaseFile_Fields.InValid_porting_dt((SALT310.StrType)le.porting_dt);
    SELF.porting_time_Invalid := BaseFile_Fields.InValid_porting_time((SALT310.StrType)le.porting_time);
    SELF.country_abbr_Invalid := BaseFile_Fields.InValid_country_abbr((SALT310.StrType)le.country_abbr);
    SELF.vendor_first_reported_dt_Invalid := BaseFile_Fields.InValid_vendor_first_reported_dt((SALT310.StrType)le.vendor_first_reported_dt);
    SELF.vendor_first_reported_time_Invalid := BaseFile_Fields.InValid_vendor_first_reported_time((SALT310.StrType)le.vendor_first_reported_time);
    SELF.vendor_last_reported_dt_Invalid := BaseFile_Fields.InValid_vendor_last_reported_dt((SALT310.StrType)le.vendor_last_reported_dt);
    SELF.vendor_last_reported_time_Invalid := BaseFile_Fields.InValid_vendor_last_reported_time((SALT310.StrType)le.vendor_last_reported_time);
    SELF.port_start_dt_Invalid := BaseFile_Fields.InValid_port_start_dt((SALT310.StrType)le.port_start_dt);
    SELF.port_start_time_Invalid := BaseFile_Fields.InValid_port_start_time((SALT310.StrType)le.port_start_time);
    SELF.port_end_dt_Invalid := BaseFile_Fields.InValid_port_end_dt((SALT310.StrType)le.port_end_dt);
    SELF.port_end_time_Invalid := BaseFile_Fields.InValid_port_end_time((SALT310.StrType)le.port_end_time);
    SELF.remove_port_dt_Invalid := BaseFile_Fields.InValid_remove_port_dt((SALT310.StrType)le.remove_port_dt);
    SELF.serv_Invalid := BaseFile_Fields.InValid_serv((SALT310.StrType)le.serv);
    SELF.line_Invalid := BaseFile_Fields.InValid_line((SALT310.StrType)le.line);
    SELF.spid_Invalid := BaseFile_Fields.InValid_spid((SALT310.StrType)le.spid);
    SELF.operator_fullname_Invalid := BaseFile_Fields.InValid_operator_fullname((SALT310.StrType)le.operator_fullname);
    SELF.number_in_service_Invalid := BaseFile_Fields.InValid_number_in_service((SALT310.StrType)le.number_in_service);
    SELF.high_risk_indicator_Invalid := BaseFile_Fields.InValid_high_risk_indicator((SALT310.StrType)le.high_risk_indicator);
    SELF.prepaid_Invalid := BaseFile_Fields.InValid_prepaid((SALT310.StrType)le.prepaid);
    SELF.phone_swap_Invalid := BaseFile_Fields.InValid_phone_swap((SALT310.StrType)le.phone_swap);
    SELF.swap_start_dt_Invalid := BaseFile_Fields.InValid_swap_start_dt((SALT310.StrType)le.swap_start_dt);
    SELF.swap_start_time_Invalid := BaseFile_Fields.InValid_swap_start_time((SALT310.StrType)le.swap_start_time);
    SELF.swap_end_dt_Invalid := BaseFile_Fields.InValid_swap_end_dt((SALT310.StrType)le.swap_end_dt);
    SELF.swap_end_time_Invalid := BaseFile_Fields.InValid_swap_end_time((SALT310.StrType)le.swap_end_time);
    SELF.deact_code_Invalid := BaseFile_Fields.InValid_deact_code((SALT310.StrType)le.deact_code);
    SELF.deact_start_dt_Invalid := BaseFile_Fields.InValid_deact_start_dt((SALT310.StrType)le.deact_start_dt);
    SELF.deact_start_time_Invalid := BaseFile_Fields.InValid_deact_start_time((SALT310.StrType)le.deact_start_time);
    SELF.deact_end_dt_Invalid := BaseFile_Fields.InValid_deact_end_dt((SALT310.StrType)le.deact_end_dt);
    SELF.deact_end_time_Invalid := BaseFile_Fields.InValid_deact_end_time((SALT310.StrType)le.deact_end_time);
    SELF.react_start_dt_Invalid := BaseFile_Fields.InValid_react_start_dt((SALT310.StrType)le.react_start_dt);
    SELF.react_start_time_Invalid := BaseFile_Fields.InValid_react_start_time((SALT310.StrType)le.react_start_time);
    SELF.react_end_dt_Invalid := BaseFile_Fields.InValid_react_end_dt((SALT310.StrType)le.react_end_dt);
    SELF.react_end_time_Invalid := BaseFile_Fields.InValid_react_end_time((SALT310.StrType)le.react_end_time);
    SELF.is_deact_Invalid := BaseFile_Fields.InValid_is_deact((SALT310.StrType)le.is_deact);
    SELF.is_react_Invalid := BaseFile_Fields.InValid_is_react((SALT310.StrType)le.is_react);
    SELF.call_forward_dt_Invalid := BaseFile_Fields.InValid_call_forward_dt((SALT310.StrType)le.call_forward_dt);
    SELF.caller_id_Invalid := BaseFile_Fields.InValid_caller_id((SALT310.StrType)le.caller_id);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT310.StrType)le.source,(SALT310.StrType)le.dt_first_reported,(SALT310.StrType)le.dt_last_reported,(SALT310.StrType)le.phone,(SALT310.StrType)le.phonetype,(SALT310.StrType)le.reply_code,(SALT310.StrType)le.local_routing_number,(SALT310.StrType)le.account_owner,(SALT310.StrType)le.carrier_category,(SALT310.StrType)le.local_area_transport_area,(SALT310.StrType)le.country_code,(SALT310.StrType)le.dial_type,(SALT310.StrType)le.routing_code,(SALT310.StrType)le.porting_dt,(SALT310.StrType)le.porting_time,(SALT310.StrType)le.country_abbr,(SALT310.StrType)le.vendor_first_reported_dt,(SALT310.StrType)le.vendor_first_reported_time,(SALT310.StrType)le.vendor_last_reported_dt,(SALT310.StrType)le.vendor_last_reported_time,(SALT310.StrType)le.port_start_dt,(SALT310.StrType)le.port_start_time,(SALT310.StrType)le.port_end_dt,(SALT310.StrType)le.port_end_time,(SALT310.StrType)le.remove_port_dt,(SALT310.StrType)le.serv,(SALT310.StrType)le.line,(SALT310.StrType)le.spid,(SALT310.StrType)le.operator_fullname,(SALT310.StrType)le.number_in_service,(SALT310.StrType)le.high_risk_indicator,(SALT310.StrType)le.prepaid,(SALT310.StrType)le.phone_swap,(SALT310.StrType)le.swap_start_dt,(SALT310.StrType)le.swap_start_time,(SALT310.StrType)le.swap_end_dt,(SALT310.StrType)le.swap_end_time,(SALT310.StrType)le.deact_code,(SALT310.StrType)le.deact_start_dt,(SALT310.StrType)le.deact_start_time,(SALT310.StrType)le.deact_end_dt,(SALT310.StrType)le.deact_end_time,(SALT310.StrType)le.react_start_dt,(SALT310.StrType)le.react_start_time,(SALT310.StrType)le.react_end_dt,(SALT310.StrType)le.react_end_time,(SALT310.StrType)le.is_deact,(SALT310.StrType)le.is_react,(SALT310.StrType)le.call_forward_dt,(SALT310.StrType)le.caller_id,'***SALTBUG***');
  END;
...
EXPORT StandardStats(DATASET(BaseFile_Layout_PhonesInfo) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT310.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_PhonesInfo, BaseFile_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
