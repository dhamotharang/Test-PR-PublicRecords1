...
#workunit('name','Scrubs_PhonesInfo.PhonesTransactionMain2_BWR_Hygiene - Hygiene & Stats - SALT V3.11.11');
IMPORT Scrubs_PhonesInfo,SALT311;
// First create an instantiated hygiene module
  infile := Scrubs_PhonesInfo.PhonesTransactionMain2_In_PhonesInfo;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_PhonesInfo.PhonesTransactionMain2_hygiene(ip);
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'PhonesTransactionMain2_Layout_PhonesInfo'),NAMED('OptimizedLayout'));// File layout suggested by data
