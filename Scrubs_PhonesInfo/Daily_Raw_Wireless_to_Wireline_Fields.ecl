...
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Phone','Invalid_Filename');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'Invalid_Phone' => 1,'Invalid_Filename' => 2,0);
...
EXPORT SALT38.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'phone','lf','filename');
EXPORT SALT38.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'phone','lf','filename');
EXPORT FieldNum(SALT38.StrType fn) := CASE(fn,'phone' => 0,'lf' => 1,'filename' => 2,0);
