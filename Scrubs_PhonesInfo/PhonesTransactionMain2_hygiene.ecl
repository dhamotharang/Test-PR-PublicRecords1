IMPORT SALT311,STD;
EXPORT PhonesTransactionMain2_hygiene(dataset(PhonesTransactionMain2_layout_PhonesInfo) h) := MODULE
...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_alt_spid_cnt := COUNT(GROUP,h.alt_spid <> (TYPEOF(h.alt_spid))'');
    populated_alt_spid_pcnt := AVE(GROUP,IF(h.alt_spid = (TYPEOF(h.alt_spid))'',0,100));
    maxlength_alt_spid := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.alt_spid)));
    avelength_alt_spid := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.alt_spid)),h.alt_spid<>(typeof(h.alt_spid))'');
    populated_lalt_spid_cnt := COUNT(GROUP,h.lalt_spid <> (TYPEOF(h.lalt_spid))'');
    populated_lalt_spid_pcnt := AVE(GROUP,IF(h.lalt_spid = (TYPEOF(h.lalt_spid))'',0,100));
    maxlength_lalt_spid := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.lalt_spid)));
    avelength_lalt_spid := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.lalt_spid)),h.lalt_spid<>(typeof(h.lalt_spid))'');
...
SHARED FldIds := DATASET([{1,'phone'}
      ...
      ,{22,'lalt_spid'}
      ,{23,'global_sid'}
      ,{24,'record_sid'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    PhonesTransactionMain2_Fields.InValid_phone((SALT311.StrType)le.phone),
    PhonesTransactionMain2_Fields.InValid_source((SALT311.StrType)le.source),
    PhonesTransactionMain2_Fields.InValid_transaction_code((SALT311.StrType)le.transaction_code),
    PhonesTransactionMain2_Fields.InValid_transaction_start_dt((SALT311.StrType)le.transaction_start_dt),
    PhonesTransactionMain2_Fields.InValid_transaction_start_time((SALT311.StrType)le.transaction_start_time),
    PhonesTransactionMain2_Fields.InValid_transaction_end_dt((SALT311.StrType)le.transaction_end_dt),
    PhonesTransactionMain2_Fields.InValid_transaction_end_time((SALT311.StrType)le.transaction_end_time),
    PhonesTransactionMain2_Fields.InValid_transaction_count((SALT311.StrType)le.transaction_count),
    PhonesTransactionMain2_Fields.InValid_vendor_first_reported_dt((SALT311.StrType)le.vendor_first_reported_dt),
    PhonesTransactionMain2_Fields.InValid_vendor_first_reported_time((SALT311.StrType)le.vendor_first_reported_time),
    PhonesTransactionMain2_Fields.InValid_vendor_last_reported_dt((SALT311.StrType)le.vendor_last_reported_dt),
    PhonesTransactionMain2_Fields.InValid_vendor_last_reported_time((SALT311.StrType)le.vendor_last_reported_time),
    PhonesTransactionMain2_Fields.InValid_country_code((SALT311.StrType)le.country_code),
    PhonesTransactionMain2_Fields.InValid_country_abbr((SALT311.StrType)le.country_abbr),
    PhonesTransactionMain2_Fields.InValid_routing_code((SALT311.StrType)le.routing_code),
    PhonesTransactionMain2_Fields.InValid_dial_type((SALT311.StrType)le.dial_type),
    PhonesTransactionMain2_Fields.InValid_spid((SALT311.StrType)le.spid),
    PhonesTransactionMain2_Fields.InValid_carrier_name((SALT311.StrType)le.carrier_name),
    PhonesTransactionMain2_Fields.InValid_phone_swap((SALT311.StrType)le.phone_swap),
    PhonesTransactionMain2_Fields.InValid_ocn((SALT311.StrType)le.ocn),
    PhonesTransactionMain2_Fields.InValid_alt_spid((SALT311.StrType)le.alt_spid),
    PhonesTransactionMain2_Fields.InValid_lalt_spid((SALT311.StrType)le.lalt_spid),
    PhonesTransactionMain2_Fields.InValid_global_sid((SALT311.StrType)le.global_sid),
    PhonesTransactionMain2_Fields.InValid_record_sid((SALT311.StrType)le.record_sid),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := PhonesTransactionMain2_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_Num','Invalid_Src','Invalid_TransCode','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_Num','Invalid_CountryCode','Invalid_CountryAbbr','Invalid_Num','Invalid_DialTypeCode','Invalid_AlphaNum','Unknown','Invalid_Num','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_AlphaNum','Invalid_Num','Invalid_Num');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,PhonesTransactionMain2_Fields.InValidMessage_phone(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_source(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_code(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_start_dt(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_start_time(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_end_dt(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_end_time(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_transaction_count(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_vendor_first_reported_dt(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_vendor_first_reported_time(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_vendor_last_reported_dt(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_vendor_last_reported_time(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_country_code(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_country_abbr(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_routing_code(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_dial_type(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_spid(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_carrier_name(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_phone_swap(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_ocn(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_alt_spid(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_lalt_spid(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_global_sid(TotalErrors.ErrorNum),PhonesTransactionMain2_Fields.InValidMessage_record_sid(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_PhonesInfo, PhonesTransactionMain2_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
