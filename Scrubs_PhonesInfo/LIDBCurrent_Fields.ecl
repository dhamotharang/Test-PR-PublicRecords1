...
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_RefID','Invalid_Num');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'Invalid_RefID' => 1,'Invalid_Num' => 2,0);
...
EXPORT SALT38.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'reference_id','phone');
EXPORT SALT38.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'reference_id','phone');
EXPORT FieldNum(SALT38.StrType fn) := CASE(fn,'reference_id' => 0,'phone' => 1,0);
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW'],['ALLOW'],[]);
