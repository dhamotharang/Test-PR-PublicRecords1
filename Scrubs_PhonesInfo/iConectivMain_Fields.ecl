...
EXPORT SALT38.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Num','Invalid_Num_Blank','Invalid_DCT','Invalid_TOS','Invalid_Port_Date','Invalid_ISO2','Invalid_Filename');
EXPORT FieldTypeNum(SALT38.StrType fn) := CASE(fn,'Invalid_Num' => 1,'Invalid_Num_Blank' => 2,'Invalid_DCT' => 3,'Invalid_TOS' => 4,'Invalid_Port_Date' => 5,'Invalid_ISO2' => 6,'Invalid_Filename' => 7,0);
...
EXPORT SALT38.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'country_code','phone','dial_type','spid','service_provider','service_type','routing_code','porting_dt','country_abbr','filename','file_dt_time','vendor_first_reported_dt','vendor_last_reported_dt','port_start_dt','port_end_dt','remove_port_dt','is_ported');
EXPORT SALT38.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'country_code','phone','dial_type','spid','service_provider','service_type','routing_code','porting_dt','country_abbr','filename','file_dt_time','vendor_first_reported_dt','vendor_last_reported_dt','port_start_dt','port_end_dt','remove_port_dt','is_ported');
EXPORT FieldNum(SALT38.StrType fn) := CASE(fn,'country_code' => 0,'phone' => 1,'dial_type' => 2,'spid' => 3,'service_provider' => 4,'service_type' => 5,'routing_code' => 6,'porting_dt' => 7,'country_abbr' => 8,'filename' => 9,'file_dt_time' => 10,'vendor_first_reported_dt' => 11,'vendor_last_reported_dt' => 12,'port_start_dt' => 13,'port_end_dt' => 14,'remove_port_dt' => 15,'is_ported' => 16,0);
EXPORT SET OF SALT38.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],[],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],[],[]);
...
EXPORT Make_service_provider(SALT38.StrType s0) := s0;
EXPORT InValid_service_provider(SALT38.StrType s) := 0;
...
EXPORT Make_file_dt_time(SALT38.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_file_dt_time(SALT38.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_port_start_dt(SALT38.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_start_dt(SALT38.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_start_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);


EXPORT Make_port_end_dt(SALT38.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_end_dt(SALT38.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);


EXPORT Make_remove_port_dt(SALT38.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_remove_port_dt(SALT38.StrType s) := InValidFT_Invalid_Num(s);
