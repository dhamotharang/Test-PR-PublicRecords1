...
EXPORT SALT310.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Phone','Invalid_Source','Invalid_Date','Invalid_Future_Date','Invalid_Phone_Type','Invalid_Num','Invalid_Num_Blank','Invalid_Char','Invalid_State','Invalid_Dial_Type','Invalid_ISO2','Invalid_Zero_Three','Invalid_Deact','Invalid_Num_In_Service','Invalid_YN');
EXPORT FieldTypeNum(SALT310.StrType fn) := CASE(fn,'Invalid_Phone' => 1,'Invalid_Source' => 2,'Invalid_Date' => 3,'Invalid_Future_Date' => 4,'Invalid_Phone_Type' => 5,'Invalid_Num' => 6,'Invalid_Num_Blank' => 7,'Invalid_Char' => 8,'Invalid_State' => 9,'Invalid_Dial_Type' => 10,'Invalid_ISO2' => 11,'Invalid_Zero_Three' => 12,'Invalid_Deact' => 13,'Invalid_Num_In_Service' => 14,'Invalid_YN' => 15,0);
...
EXPORT MakeFT_Invalid_Source(SALT310.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Source(SALT310.StrType s) := WHICH(((SALT310.StrType) s) NOT IN ['PX','PK','PJ','PO','PB'],~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_Invalid_Source(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInEnum('PX|PK|PJ|PO|PB'),SALT310.HygieneErrors.NotLength('1..'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Date(SALT310.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Date(SALT310.StrType s) := WHICH(~Scrubs.fn_valid_date(s)>0);
...
EXPORT MakeFT_Invalid_Future_Date(SALT310.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Future_Date(SALT310.StrType s) := WHICH(~Scrubs.fn_valid_date(s,'future')>0);
EXPORT InValidMessageFT_Invalid_Future_Date(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.CustomFail('Scrubs.fn_valid_date'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Phone_Type(SALT310.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Phone_Type(SALT310.StrType s) := WHICH(((SALT310.StrType) s) NOT IN ['LC','CL',' ']);
EXPORT InValidMessageFT_Invalid_Phone_Type(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInEnum('LC|CL| '),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Num(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Num(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'0123456789'))));
EXPORT InValidMessageFT_Invalid_Num(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('0123456789'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Num_Blank(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'0123456789 \\t '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Num_Blank(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'0123456789 \\t '))));
EXPORT InValidMessageFT_Invalid_Num_Blank(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('0123456789 \\t '),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Char(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .-:*&/_;\'"()!+,@|#'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Char(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .-:*&/_;\'"()!+,@|#'))));
EXPORT InValidMessageFT_Invalid_Char(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .-:*&/_;\'"()!+,@|#'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_State(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_State(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))));
EXPORT InValidMessageFT_Invalid_State(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Dial_Type(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'TBN '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Dial_Type(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'TBN '))));
EXPORT InValidMessageFT_Invalid_Dial_Type(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('TBN '),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_ISO2(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_ISO2(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_Invalid_ISO2(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Zero_Three(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'0123'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Zero_Three(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'0123'))));
EXPORT InValidMessageFT_Invalid_Zero_Three(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('0123'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Deact(SALT310.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Deact(SALT310.StrType s) := WHICH(((SALT310.StrType) s) NOT IN ['DE','SU',' ']);
EXPORT InValidMessageFT_Invalid_Deact(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInEnum('DE|SU| '),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Num_In_Service(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'0123456789AIU'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Num_In_Service(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'0123456789AIU'))));
EXPORT InValidMessageFT_Invalid_Num_In_Service(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('0123456789AIU'),SALT310.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_YN(SALT310.StrType s0) := FUNCTION
  s1 := SALT310.stringfilter(s0,'PYN0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_YN(SALT310.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT310.StringFilter(s,'PYN0123456789 '))));
EXPORT InValidMessageFT_Invalid_YN(UNSIGNED1 wh) := CHOOSE(wh,SALT310.HygieneErrors.NotInChars('PYN0123456789 '),SALT310.HygieneErrors.Good);
...
EXPORT Make_reference_id(SALT310.StrType s0) := s0;
EXPORT InValid_reference_id(SALT310.StrType s) := 0;
EXPORT InValidMessage_reference_id(UNSIGNED1 wh) := '';
 
EXPORT Make_source(SALT310.StrType s0) := MakeFT_Invalid_Source(s0);
EXPORT InValid_source(SALT310.StrType s) := InValidFT_Invalid_Source(s);
EXPORT InValidMessage_source(UNSIGNED1 wh) := InValidMessageFT_Invalid_Source(wh);
 
EXPORT Make_dt_first_reported(SALT310.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_dt_first_reported(SALT310.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_dt_first_reported(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_dt_last_reported(SALT310.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_dt_last_reported(SALT310.StrType s) := InValidFT_Invalid_Date(s);
...
EXPORT Make_phonetype(SALT310.StrType s0) := MakeFT_Invalid_Phone_Type(s0);
EXPORT InValid_phonetype(SALT310.StrType s) := InValidFT_Invalid_Phone_Type(s);
EXPORT InValidMessage_phonetype(UNSIGNED1 wh) := InValidMessageFT_Invalid_Phone_Type(wh);
 
EXPORT Make_reply_code(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_reply_code(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_reply_code(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_local_routing_number(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_local_routing_number(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_local_routing_number(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_account_owner(SALT310.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_account_owner(SALT310.StrType s) := InValidFT_Invalid_Char(s);
...
EXPORT Make_carrier_category(SALT310.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_carrier_category(SALT310.StrType s) := InValidFT_Invalid_Char(s);
EXPORT InValidMessage_carrier_category(UNSIGNED1 wh) := InValidMessageFT_Invalid_Char(wh);
 
EXPORT Make_local_area_transport_area(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_local_area_transport_area(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_local_area_transport_area(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_point_code(SALT310.StrType s0) := s0;
EXPORT InValid_point_code(SALT310.StrType s) := 0;
EXPORT InValidMessage_point_code(UNSIGNED1 wh) := '';
 
EXPORT Make_country_code(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_country_code(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_country_code(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_dial_type(SALT310.StrType s0) := MakeFT_Invalid_Dial_Type(s0);
EXPORT InValid_dial_type(SALT310.StrType s) := InValidFT_Invalid_Dial_Type(s);
EXPORT InValidMessage_dial_type(UNSIGNED1 wh) := InValidMessageFT_Invalid_Dial_Type(wh);
 
EXPORT Make_routing_code(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_routing_code(SALT310.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_porting_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_porting_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_porting_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_country_abbr(SALT310.StrType s0) := MakeFT_Invalid_ISO2(s0);
EXPORT InValid_country_abbr(SALT310.StrType s) := InValidFT_Invalid_ISO2(s);
...
EXPORT Make_vendor_first_reported_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_vendor_first_reported_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_vendor_last_reported_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_vendor_last_reported_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_vendor_last_reported_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_port_start_dt(SALT310.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_port_start_dt(SALT310.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_port_start_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_port_start_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_start_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_port_end_dt(SALT310.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_port_end_dt(SALT310.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_port_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_port_end_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_end_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_end_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_remove_port_dt(SALT310.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_remove_port_dt(SALT310.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_remove_port_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_is_ported(SALT310.StrType s0) := s0;
EXPORT InValid_is_ported(SALT310.StrType s) := 0;
EXPORT InValidMessage_is_ported(UNSIGNED1 wh) := '';
 
EXPORT Make_serv(SALT310.StrType s0) := MakeFT_Invalid_Zero_Three(s0);
EXPORT InValid_serv(SALT310.StrType s) := InValidFT_Invalid_Zero_Three(s);
EXPORT InValidMessage_serv(UNSIGNED1 wh) := InValidMessageFT_Invalid_Zero_Three(wh);
 
EXPORT Make_line(SALT310.StrType s0) := MakeFT_Invalid_Zero_Three(s0);
EXPORT InValid_line(SALT310.StrType s) := InValidFT_Invalid_Zero_Three(s);
EXPORT InValidMessage_line(UNSIGNED1 wh) := InValidMessageFT_Invalid_Zero_Three(wh);
 
EXPORT Make_spid(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_spid(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_spid(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_operator_fullname(SALT310.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_operator_fullname(SALT310.StrType s) := InValidFT_Invalid_Char(s);
EXPORT InValidMessage_operator_fullname(UNSIGNED1 wh) := InValidMessageFT_Invalid_Char(wh);
 
EXPORT Make_number_in_service(SALT310.StrType s0) := MakeFT_Invalid_Num_In_Service(s0);
EXPORT InValid_number_in_service(SALT310.StrType s) := InValidFT_Invalid_Num_In_Service(s);
EXPORT InValidMessage_number_in_service(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num_In_Service(wh);
 
EXPORT Make_high_risk_indicator(SALT310.StrType s0) := MakeFT_Invalid_YN(s0);
EXPORT InValid_high_risk_indicator(SALT310.StrType s) := InValidFT_Invalid_YN(s);
EXPORT InValidMessage_high_risk_indicator(UNSIGNED1 wh) := InValidMessageFT_Invalid_YN(wh);
 
EXPORT Make_prepaid(SALT310.StrType s0) := MakeFT_Invalid_YN(s0);
EXPORT InValid_prepaid(SALT310.StrType s) := InValidFT_Invalid_YN(s);
...
EXPORT Make_swap_start_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_swap_start_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_swap_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_swap_end_dt(SALT310.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_swap_end_dt(SALT310.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_swap_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_swap_end_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_swap_end_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_swap_end_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_deact_code(SALT310.StrType s0) := MakeFT_Invalid_Deact(s0);
EXPORT InValid_deact_code(SALT310.StrType s) := InValidFT_Invalid_Deact(s);
...
EXPORT Make_deact_start_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_deact_start_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_deact_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_deact_end_dt(SALT310.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_deact_end_dt(SALT310.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_deact_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_deact_end_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_deact_end_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_react_start_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_react_start_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_react_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_react_end_dt(SALT310.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_react_end_dt(SALT310.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_react_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_react_end_time(SALT310.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_react_end_time(SALT310.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_call_forward_dt(SALT310.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_call_forward_dt(SALT310.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_call_forward_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_caller_id(SALT310.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_caller_id(SALT310.StrType s) := InValidFT_Invalid_Char(s);
