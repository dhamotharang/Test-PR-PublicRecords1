...
EXPORT SALT39.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Phone','Invalid_Source','Invalid_Date','Invalid_Future_Date','Invalid_Phone_Type','Invalid_Num','Invalid_Num_Blank','Invalid_Char','Invalid_State','Invalid_Dial_Type','Invalid_ISO2','Invalid_Zero_Three','Invalid_Deact','Invalid_Num_In_Service','Invalid_YN');
EXPORT FieldTypeNum(SALT39.StrType fn) := CASE(fn,'Invalid_Phone' => 1,'Invalid_Source' => 2,'Invalid_Date' => 3,'Invalid_Future_Date' => 4,'Invalid_Phone_Type' => 5,'Invalid_Num' => 6,'Invalid_Num_Blank' => 7,'Invalid_Char' => 8,'Invalid_State' => 9,'Invalid_Dial_Type' => 10,'Invalid_ISO2' => 11,'Invalid_Zero_Three' => 12,'Invalid_Deact' => 13,'Invalid_Num_In_Service' => 14,'Invalid_YN' => 15,0);
...
EXPORT MakeFT_Invalid_Source(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Source(SALT39.StrType s) := WHICH(((SALT39.StrType) s) NOT IN ['PX','PK','PJ','PO','PB'],~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_Invalid_Source(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInEnum('PX|PK|PJ|PO|PB'),SALT39.HygieneErrors.NotLength('1..'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_Phone_Type(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Phone_Type(SALT39.StrType s) := WHICH(((SALT39.StrType) s) NOT IN ['LC','CL',' ']);
EXPORT InValidMessageFT_Invalid_Phone_Type(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInEnum('LC|CL| '),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_Char(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Char(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .-:*&/_;\'"()!+,@|#'))));
EXPORT InValidMessageFT_Invalid_Char(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .-:*&/_;\'"()!+,@|#'),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_State(SALT39.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_State(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))));
EXPORT InValidMessageFT_Invalid_State(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Dial_Type(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'TBN '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Dial_Type(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'TBN '))));
EXPORT InValidMessageFT_Invalid_Dial_Type(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('TBN '),SALT39.HygieneErrors.Good);
...
EXPORT MakeFT_Invalid_Zero_Three(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'0123'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Zero_Three(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123'))));
EXPORT InValidMessageFT_Invalid_Zero_Three(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('0123'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Deact(SALT39.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_Deact(SALT39.StrType s) := WHICH(((SALT39.StrType) s) NOT IN ['DE','SU',' ']);
EXPORT InValidMessageFT_Invalid_Deact(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInEnum('DE|SU| '),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_Num_In_Service(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'0123456789AIU'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_Num_In_Service(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'0123456789AIU'))));
EXPORT InValidMessageFT_Invalid_Num_In_Service(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('0123456789AIU'),SALT39.HygieneErrors.Good);
 
EXPORT MakeFT_Invalid_YN(SALT39.StrType s0) := FUNCTION
  s1 := SALT39.stringfilter(s0,'PYN0123456789 '); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_Invalid_YN(SALT39.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT39.StringFilter(s,'PYN0123456789 '))));
EXPORT InValidMessageFT_Invalid_YN(UNSIGNED1 wh) := CHOOSE(wh,SALT39.HygieneErrors.NotInChars('PYN0123456789 '),SALT39.HygieneErrors.Good);
...
EXPORT SALT39.StrType FlatName(UNSIGNED2 i) := CHOOSE(i,'reference_id','source','dt_first_reported','dt_last_reported','phone','phonetype','reply_code','local_routing_number','account_owner','carrier_name','carrier_category','local_area_transport_area','point_code','country_code','dial_type','routing_code','porting_dt','porting_time','country_abbr','vendor_first_reported_dt','vendor_first_reported_time','vendor_last_reported_dt','vendor_last_reported_time','port_start_dt','port_start_time','port_end_dt','port_end_time','remove_port_dt','is_ported','serv','line','spid','operator_fullname','number_in_service','high_risk_indicator','prepaid','phone_swap','swap_start_dt','swap_start_time','swap_end_dt','swap_end_time','deact_code','deact_start_dt','deact_start_time','deact_end_dt','deact_end_time','react_start_dt','react_start_time','react_end_dt','react_end_time','is_deact','is_react','call_forward_dt','caller_id');
...
EXPORT SET OF SALT39.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,[],['ENUM','LENGTHS'],['CUSTOM'],['CUSTOM'],['ALLOW'],['ENUM'],['ALLOW'],['ALLOW'],['ALLOW'],[],['ALLOW'],['ALLOW'],[],['ALLOW'],['ALLOW'],['ALLOW'],['CUSTOM'],['ALLOW'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],[],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['ENUM'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['CUSTOM'],['ALLOW'],['ALLOW'],['ALLOW'],['CUSTOM'],['ALLOW'],[]);
...
EXPORT Make_reference_id(SALT39.StrType s0) := s0;
EXPORT InValid_reference_id(SALT39.StrType s) := 0;
...
EXPORT Make_phonetype(SALT39.StrType s0) := MakeFT_Invalid_Phone_Type(s0);
EXPORT InValid_phonetype(SALT39.StrType s) := InValidFT_Invalid_Phone_Type(s);
...
EXPORT Make_account_owner(SALT39.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_account_owner(SALT39.StrType s) := InValidFT_Invalid_Char(s);
...
EXPORT Make_local_area_transport_area(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_local_area_transport_area(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_dial_type(SALT39.StrType s0) := MakeFT_Invalid_Dial_Type(s0);
EXPORT InValid_dial_type(SALT39.StrType s) := InValidFT_Invalid_Dial_Type(s);
EXPORT InValidMessage_dial_type(UNSIGNED1 wh) := InValidMessageFT_Invalid_Dial_Type(wh);
 
EXPORT Make_routing_code(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_routing_code(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_porting_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_porting_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_vendor_first_reported_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_vendor_first_reported_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_vendor_last_reported_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_vendor_last_reported_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_vendor_last_reported_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_port_start_dt(SALT39.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_port_start_dt(SALT39.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_port_start_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_port_start_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_start_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_port_end_dt(SALT39.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_port_end_dt(SALT39.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_port_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_port_end_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_port_end_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_port_end_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_remove_port_dt(SALT39.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_remove_port_dt(SALT39.StrType s) := InValidFT_Invalid_Future_Date(s);
...
EXPORT Make_serv(SALT39.StrType s0) := MakeFT_Invalid_Zero_Three(s0);
EXPORT InValid_serv(SALT39.StrType s) := InValidFT_Invalid_Zero_Three(s);
EXPORT InValidMessage_serv(UNSIGNED1 wh) := InValidMessageFT_Invalid_Zero_Three(wh);
 
EXPORT Make_line(SALT39.StrType s0) := MakeFT_Invalid_Zero_Three(s0);
EXPORT InValid_line(SALT39.StrType s) := InValidFT_Invalid_Zero_Three(s);
...
EXPORT Make_high_risk_indicator(SALT39.StrType s0) := MakeFT_Invalid_YN(s0);
EXPORT InValid_high_risk_indicator(SALT39.StrType s) := InValidFT_Invalid_YN(s);
EXPORT InValidMessage_high_risk_indicator(UNSIGNED1 wh) := InValidMessageFT_Invalid_YN(wh);
 
EXPORT Make_prepaid(SALT39.StrType s0) := MakeFT_Invalid_YN(s0);
EXPORT InValid_prepaid(SALT39.StrType s) := InValidFT_Invalid_YN(s);
...
EXPORT Make_swap_start_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_swap_start_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_swap_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_swap_end_dt(SALT39.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_swap_end_dt(SALT39.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_swap_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_swap_end_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_swap_end_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_swap_end_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_deact_code(SALT39.StrType s0) := MakeFT_Invalid_Deact(s0);
EXPORT InValid_deact_code(SALT39.StrType s) := InValidFT_Invalid_Deact(s);
...
EXPORT Make_deact_start_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_deact_start_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_deact_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_deact_end_dt(SALT39.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_deact_end_dt(SALT39.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_deact_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_deact_end_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_deact_end_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_react_start_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_react_start_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
EXPORT InValidMessage_react_start_time(UNSIGNED1 wh) := InValidMessageFT_Invalid_Num(wh);
 
EXPORT Make_react_end_dt(SALT39.StrType s0) := MakeFT_Invalid_Future_Date(s0);
EXPORT InValid_react_end_dt(SALT39.StrType s) := InValidFT_Invalid_Future_Date(s);
EXPORT InValidMessage_react_end_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Future_Date(wh);
 
EXPORT Make_react_end_time(SALT39.StrType s0) := MakeFT_Invalid_Num(s0);
EXPORT InValid_react_end_time(SALT39.StrType s) := InValidFT_Invalid_Num(s);
...
EXPORT Make_call_forward_dt(SALT39.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_call_forward_dt(SALT39.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_call_forward_dt(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
 
EXPORT Make_caller_id(SALT39.StrType s0) := MakeFT_Invalid_Char(s0);
EXPORT InValid_caller_id(SALT39.StrType s) := InValidFT_Invalid_Char(s);
