...
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Num','Invalid_Char','Invalid_AccOwn','Invalid_RefID');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'Invalid_Num' => 1,'Invalid_Char' => 2,'Invalid_AccOwn' => 3,'Invalid_RefID' => 4,0);
...
EXPORT SALT33.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'reference_id','phone','reply_code','local_routing_number','account_owner','carrier_name','carrier_category','local_area_transport_area','point_code');
EXPORT FieldNum(SALT33.StrType fn) := CASE(fn,'reference_id' => 0,'phone' => 1,'reply_code' => 2,'local_routing_number' => 3,'account_owner' => 4,'carrier_name' => 5,'carrier_category' => 6,'local_area_transport_area' => 7,'point_code' => 8,0);
