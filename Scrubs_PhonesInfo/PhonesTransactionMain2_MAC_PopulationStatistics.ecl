...
+    #IF( #TEXT(Input_alt_spid)='' )
      '' 
    #ELSE
        IF( le.Input_alt_spid = (TYPEOF(le.Input_alt_spid))'','',':alt_spid')
    #END
 
+    #IF( #TEXT(Input_lalt_spid)='' )
      '' 
    #ELSE
        IF( le.Input_lalt_spid = (TYPEOF(le.Input_lalt_spid))'','',':lalt_spid')
    #END
