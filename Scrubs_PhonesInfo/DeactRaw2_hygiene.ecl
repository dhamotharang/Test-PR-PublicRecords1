...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_msisdn := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdn)));
    avelength_msisdn := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdn)),h.msisdn<>(typeof(h.msisdn))'');
    ...
    maxlength_timestamp := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.timestamp)));
    avelength_timestamp := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.timestamp)),h.timestamp<>(typeof(h.timestamp))'');
    ...
    maxlength_changeid := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.changeid)));
    avelength_changeid := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.changeid)),h.changeid<>(typeof(h.changeid))'');
    ...
    maxlength_operatorid := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.operatorid)));
    avelength_operatorid := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.operatorid)),h.operatorid<>(typeof(h.operatorid))'');
    ...
    maxlength_msisdneid := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdneid)));
    avelength_msisdneid := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdneid)),h.msisdneid<>(typeof(h.msisdneid))'');
    ...
    maxlength_msisdnnew := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdnnew)));
    avelength_msisdnnew := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.msisdnnew)),h.msisdnnew<>(typeof(h.msisdnnew))'');
...
SALT311.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT311.StrType)le.msisdn),TRIM((SALT311.StrType)le.timestamp),TRIM((SALT311.StrType)le.changeid),TRIM((SALT311.StrType)le.operatorid),TRIM((SALT311.StrType)le.msisdneid),TRIM((SALT311.StrType)le.msisdnnew),TRIM((SALT311.StrType)le.filename)));
  SELF.FldNo := C;
END;
...
SALT311.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 7);
  SELF.FldNo2 := 1 + (C % 7);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT311.StrType)le.msisdn),TRIM((SALT311.StrType)le.timestamp),TRIM((SALT311.StrType)le.changeid),TRIM((SALT311.StrType)le.operatorid),TRIM((SALT311.StrType)le.msisdneid),TRIM((SALT311.StrType)le.msisdnnew),TRIM((SALT311.StrType)le.filename)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT311.StrType)le.msisdn),TRIM((SALT311.StrType)le.timestamp),TRIM((SALT311.StrType)le.changeid),TRIM((SALT311.StrType)le.operatorid),TRIM((SALT311.StrType)le.msisdneid),TRIM((SALT311.StrType)le.msisdnnew),TRIM((SALT311.StrType)le.filename)));
  END;
...
SHARED FldIds := DATASET([{1,'msisdn'}
      ...
      ,{5,'msisdneid'}
      ,{6,'msisdnnew'}
      ,{7,'filename'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    DeactRaw2_Fields.InValid_msisdn((SALT311.StrType)le.msisdn),
    DeactRaw2_Fields.InValid_timestamp((SALT311.StrType)le.timestamp),
    DeactRaw2_Fields.InValid_changeid((SALT311.StrType)le.changeid),
    DeactRaw2_Fields.InValid_operatorid((SALT311.StrType)le.operatorid),
    DeactRaw2_Fields.InValid_msisdneid((SALT311.StrType)le.msisdneid),
    DeactRaw2_Fields.InValid_msisdnnew((SALT311.StrType)le.msisdnnew),
    DeactRaw2_Fields.InValid_filename((SALT311.StrType)le.filename),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_PhonesInfo, DeactRaw2_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
