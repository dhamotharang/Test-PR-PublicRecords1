...
EXPORT Summary(SALT38.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_activation_dt := MAX(GROUP,LENGTH(TRIM((SALT38.StrType)h.activation_dt)));
    avelength_activation_dt := AVE(GROUP,LENGTH(TRIM((SALT38.StrType)h.activation_dt)),h.activation_dt<>(typeof(h.activation_dt))'');
...
SALT38.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT38.StrType)le.reference_id),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),IF (le.activation_dt <> 0,TRIM((SALT38.StrType)le.activation_dt), ''),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid)));
  SELF.FldNo := C;
END;
...
SALT38.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 19);
  SELF.FldNo2 := 1 + (C % 19);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT38.StrType)le.reference_id),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),IF (le.activation_dt <> 0,TRIM((SALT38.StrType)le.activation_dt), ''),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT38.StrType)le.reference_id),IF (le.dt_first_reported <> 0,TRIM((SALT38.StrType)le.dt_first_reported), ''),IF (le.dt_last_reported <> 0,TRIM((SALT38.StrType)le.dt_last_reported), ''),TRIM((SALT38.StrType)le.phone),TRIM((SALT38.StrType)le.reply_code),TRIM((SALT38.StrType)le.local_routing_number),TRIM((SALT38.StrType)le.account_owner),TRIM((SALT38.StrType)le.carrier_name),TRIM((SALT38.StrType)le.carrier_category),TRIM((SALT38.StrType)le.local_area_transport_area),TRIM((SALT38.StrType)le.point_code),TRIM((SALT38.StrType)le.serv),TRIM((SALT38.StrType)le.line),TRIM((SALT38.StrType)le.spid),TRIM((SALT38.StrType)le.operator_fullname),IF (le.activation_dt <> 0,TRIM((SALT38.StrType)le.activation_dt), ''),TRIM((SALT38.StrType)le.number_in_service),TRIM((SALT38.StrType)le.high_risk_indicator),TRIM((SALT38.StrType)le.prepaid)));
  END;
...
SHARED FldIds := DATASET([{1,'reference_id'}
      ...
      ,{19,'prepaid'}],SALT38.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    LIDBProcessed_Fields.InValid_reference_id((SALT38.StrType)le.reference_id),
    LIDBProcessed_Fields.InValid_dt_first_reported((SALT38.StrType)le.dt_first_reported),
    LIDBProcessed_Fields.InValid_dt_last_reported((SALT38.StrType)le.dt_last_reported),
    LIDBProcessed_Fields.InValid_phone((SALT38.StrType)le.phone),
    LIDBProcessed_Fields.InValid_reply_code((SALT38.StrType)le.reply_code),
    LIDBProcessed_Fields.InValid_local_routing_number((SALT38.StrType)le.local_routing_number),
    LIDBProcessed_Fields.InValid_account_owner((SALT38.StrType)le.account_owner),
    LIDBProcessed_Fields.InValid_carrier_name((SALT38.StrType)le.carrier_name),
    LIDBProcessed_Fields.InValid_carrier_category((SALT38.StrType)le.carrier_category),
    LIDBProcessed_Fields.InValid_local_area_transport_area((SALT38.StrType)le.local_area_transport_area),
    LIDBProcessed_Fields.InValid_point_code((SALT38.StrType)le.point_code),
    LIDBProcessed_Fields.InValid_serv((SALT38.StrType)le.serv),
    LIDBProcessed_Fields.InValid_line((SALT38.StrType)le.line),
    LIDBProcessed_Fields.InValid_spid((SALT38.StrType)le.spid),
    LIDBProcessed_Fields.InValid_operator_fullname((SALT38.StrType)le.operator_fullname),
    LIDBProcessed_Fields.InValid_activation_dt((SALT38.StrType)le.activation_dt),
    LIDBProcessed_Fields.InValid_number_in_service((SALT38.StrType)le.number_in_service),
    LIDBProcessed_Fields.InValid_high_risk_indicator((SALT38.StrType)le.high_risk_indicator),
    LIDBProcessed_Fields.InValid_prepaid((SALT38.StrType)le.prepaid),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_PhonesInfo, LIDBProcessed_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
