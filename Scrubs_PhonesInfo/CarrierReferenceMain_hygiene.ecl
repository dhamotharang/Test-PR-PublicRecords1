...
SHARED FldIds := DATASET([{1,'dt_first_reported'}
      ...
      ,{9,'line'}
      ,{10,'prepaid'}
      ,{11,'high_risk_indicator'}
      ,{12,'activation_dt'}
      ,{13,'number_in_service'}
      ,{14,'spid'}
      ,{15,'operator_full_name'}
      ,{16,'is_current'}
      ,{17,'override_file'}
      ,{18,'data_type'}
      ,{19,'ocn_state'}
      ...
      ,{76,'append_rawaid'}
      ,{77,'address_type'}
      ,{78,'privacy_indicator'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    CarrierReferenceMain_Fields.InValid_name((SALT311.StrType)le.name),
