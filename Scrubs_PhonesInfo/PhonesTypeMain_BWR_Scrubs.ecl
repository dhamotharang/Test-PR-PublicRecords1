...
#workunit('name','Scrubs_PhonesInfo.PhonesTypeMain_BWR_Scrubs - Checking field validity in a file - SALT V3.11.11');
IMPORT Scrubs_PhonesInfo,SALT311;
infile := Scrubs_PhonesInfo.PhonesTypeMain_In_PhonesInfo;
mod_scrubs := Scrubs_PhonesInfo.PhonesTypeMain_Scrubs;
