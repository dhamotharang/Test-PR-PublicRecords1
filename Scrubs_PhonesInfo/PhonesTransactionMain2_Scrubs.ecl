IMPORT SALT311,STD;
EXPORT PhonesTransactionMain2_Scrubs := MODULE
...
// The module to handle the case where no scrubs exist
  ...
  EXPORT Expanded_Layout := RECORD(PhonesTransactionMain2_Layout_PhonesInfo)
    ...
    UNSIGNED1 alt_spid_Invalid;
    UNSIGNED1 lalt_spid_Invalid;
    UNSIGNED1 global_sid_Invalid;
    UNSIGNED1 record_sid_Invalid;
  END;
  EXPORT  Bitmap_Layout := RECORD(PhonesTransactionMain2_Layout_PhonesInfo)
    UNSIGNED8 ScrubsBits1;
  END;
  EXPORT Rule_Layout := RECORD(PhonesTransactionMain2_Layout_PhonesInfo)
  ...
  SHARED toRuleDesc(UNSIGNED c) := CHOOSE(c
          ...
          ,'alt_spid:Invalid_AlphaNum:ALLOW'
          ,'lalt_spid:Invalid_AlphaNum:ALLOW'
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ,PhonesTransactionMain2_Fields.InvalidMessage_phone(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_source(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_code(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_start_dt(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_start_time(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_end_dt(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_end_time(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_transaction_count(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_vendor_first_reported_dt(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_vendor_first_reported_time(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_vendor_last_reported_dt(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_vendor_last_reported_time(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_country_code(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_country_abbr(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_routing_code(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_dial_type(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_spid(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_phone_swap(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_ocn(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_alt_spid(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_lalt_spid(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_global_sid(1)
          ,PhonesTransactionMain2_Fields.InvalidMessage_record_sid(1)
          ,'Fields with errors'
...
EXPORT FromNone(DATASET(PhonesTransactionMain2_Layout_PhonesInfo) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.phone_Invalid := PhonesTransactionMain2_Fields.InValid_phone((SALT311.StrType)le.phone);
    SELF.source_Invalid := PhonesTransactionMain2_Fields.InValid_source((SALT311.StrType)le.source);
    SELF.transaction_code_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_code((SALT311.StrType)le.transaction_code);
    SELF.transaction_start_dt_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_start_dt((SALT311.StrType)le.transaction_start_dt);
    SELF.transaction_start_time_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_start_time((SALT311.StrType)le.transaction_start_time);
    SELF.transaction_end_dt_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_end_dt((SALT311.StrType)le.transaction_end_dt);
    SELF.transaction_end_time_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_end_time((SALT311.StrType)le.transaction_end_time);
    SELF.transaction_count_Invalid := PhonesTransactionMain2_Fields.InValid_transaction_count((SALT311.StrType)le.transaction_count);
    SELF.vendor_first_reported_dt_Invalid := PhonesTransactionMain2_Fields.InValid_vendor_first_reported_dt((SALT311.StrType)le.vendor_first_reported_dt);
    SELF.vendor_first_reported_time_Invalid := PhonesTransactionMain2_Fields.InValid_vendor_first_reported_time((SALT311.StrType)le.vendor_first_reported_time);
    SELF.vendor_last_reported_dt_Invalid := PhonesTransactionMain2_Fields.InValid_vendor_last_reported_dt((SALT311.StrType)le.vendor_last_reported_dt);
    SELF.vendor_last_reported_time_Invalid := PhonesTransactionMain2_Fields.InValid_vendor_last_reported_time((SALT311.StrType)le.vendor_last_reported_time);
    SELF.country_code_Invalid := PhonesTransactionMain2_Fields.InValid_country_code((SALT311.StrType)le.country_code);
    SELF.country_abbr_Invalid := PhonesTransactionMain2_Fields.InValid_country_abbr((SALT311.StrType)le.country_abbr);
    SELF.routing_code_Invalid := PhonesTransactionMain2_Fields.InValid_routing_code((SALT311.StrType)le.routing_code);
    SELF.dial_type_Invalid := PhonesTransactionMain2_Fields.InValid_dial_type((SALT311.StrType)le.dial_type);
    SELF.spid_Invalid := PhonesTransactionMain2_Fields.InValid_spid((SALT311.StrType)le.spid);
    SELF.phone_swap_Invalid := PhonesTransactionMain2_Fields.InValid_phone_swap((SALT311.StrType)le.phone_swap);
    SELF.ocn_Invalid := PhonesTransactionMain2_Fields.InValid_ocn((SALT311.StrType)le.ocn);
    SELF.alt_spid_Invalid := PhonesTransactionMain2_Fields.InValid_alt_spid((SALT311.StrType)le.alt_spid);
    SELF.lalt_spid_Invalid := PhonesTransactionMain2_Fields.InValid_lalt_spid((SALT311.StrType)le.lalt_spid);
    SELF.global_sid_Invalid := PhonesTransactionMain2_Fields.InValid_global_sid((SALT311.StrType)le.global_sid);
    SELF.record_sid_Invalid := PhonesTransactionMain2_Fields.InValid_record_sid((SALT311.StrType)le.record_sid);
    SELF := le;
  END;
  EXPORT ExpandedInfile := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),PhonesTransactionMain2_Layout_PhonesInfo);
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.phone_Invalid << 0 ) + ( le.source_Invalid << 1 ) + ( le.transaction_code_Invalid << 2 ) + ( le.transaction_start_dt_Invalid << 3 ) + ( le.transaction_start_time_Invalid << 4 ) + ( le.transaction_end_dt_Invalid << 5 ) + ( le.transaction_end_time_Invalid << 6 ) + ( le.transaction_count_Invalid << 7 ) + ( le.vendor_first_reported_dt_Invalid << 8 ) + ( le.vendor_first_reported_time_Invalid << 9 ) + ( le.vendor_last_reported_dt_Invalid << 10 ) + ( le.vendor_last_reported_time_Invalid << 11 ) + ( le.country_code_Invalid << 12 ) + ( le.country_abbr_Invalid << 13 ) + ( le.routing_code_Invalid << 14 ) + ( le.dial_type_Invalid << 15 ) + ( le.spid_Invalid << 16 ) + ( le.phone_swap_Invalid << 17 ) + ( le.ocn_Invalid << 18 ) + ( le.alt_spid_Invalid << 19 ) + ( le.lalt_spid_Invalid << 20 ) + ( le.global_sid_Invalid << 21 ) + ( le.record_sid_Invalid << 22 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  EXPORT Infile := PROJECT(h,PhonesTransactionMain2_Layout_PhonesInfo);
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.alt_spid_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.lalt_spid_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.global_sid_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.record_sid_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    alt_spid_ALLOW_ErrorCount := COUNT(GROUP,h.alt_spid_Invalid=1);
    lalt_spid_ALLOW_ErrorCount := COUNT(GROUP,h.lalt_spid_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    UNSIGNED1 ErrNum := CHOOSE(c,le.phone_Invalid,le.source_Invalid,le.transaction_code_Invalid,le.transaction_start_dt_Invalid,le.transaction_start_time_Invalid,le.transaction_end_dt_Invalid,le.transaction_end_time_Invalid,le.transaction_count_Invalid,le.vendor_first_reported_dt_Invalid,le.vendor_first_reported_time_Invalid,le.vendor_last_reported_dt_Invalid,le.vendor_last_reported_time_Invalid,le.country_code_Invalid,le.country_abbr_Invalid,le.routing_code_Invalid,le.dial_type_Invalid,le.spid_Invalid,le.phone_swap_Invalid,le.ocn_Invalid,le.alt_spid_Invalid,le.lalt_spid_Invalid,le.global_sid_Invalid,le.record_sid_Invalid,100);
    SELF.ErrorMessage := IF ( ErrNum = 0, SKIP, CHOOSE(c,PhonesTransactionMain2_Fields.InvalidMessage_phone(le.phone_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_source(le.source_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_code(le.transaction_code_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_start_dt(le.transaction_start_dt_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_start_time(le.transaction_start_time_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_end_dt(le.transaction_end_dt_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_end_time(le.transaction_end_time_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_transaction_count(le.transaction_count_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_vendor_first_reported_dt(le.vendor_first_reported_dt_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_vendor_first_reported_time(le.vendor_first_reported_time_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_vendor_last_reported_dt(le.vendor_last_reported_dt_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_vendor_last_reported_time(le.vendor_last_reported_time_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_country_code(le.country_code_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_country_abbr(le.country_abbr_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_routing_code(le.routing_code_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_dial_type(le.dial_type_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_spid(le.spid_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_phone_swap(le.phone_swap_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_ocn(le.ocn_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_alt_spid(le.alt_spid_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_lalt_spid(le.lalt_spid_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_global_sid(le.global_sid_Invalid),PhonesTransactionMain2_Fields.InvalidMessage_record_sid(le.record_sid_Invalid),'UNKNOWN'));
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.alt_spid_ALLOW_ErrorCount
          ,le.lalt_spid_ALLOW_ErrorCount
    ...
    mod_hygiene := PhonesTransactionMain2_hygiene(PROJECT(h, PhonesTransactionMain2_Layout_PhonesInfo));
    ...
    SALT311.ScrubsOrbitLayout xNormHygieneStats(hygiene_summaryStats le, UNSIGNED c, STRING suffix) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'alt_spid:' + getFieldTypeText(h.alt_spid) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
          ,'lalt_spid:' + getFieldTypeText(h.lalt_spid) + IF(TRIM(le.txt) > '', '_' + TRIM(le.txt), '') + ':' + suffix
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.populated_alt_spid_cnt
          ,le.populated_lalt_spid_cnt
      ...
      SELF.rulepcnt := CHOOSE(c
          ...
          ,le.populated_alt_spid_pcnt
          ,le.populated_lalt_spid_pcnt
  ...
  // record count stats
    ...
    mod_Delta := PhonesTransactionMain2_Delta(prevDS, PROJECT(h, PhonesTransactionMain2_Layout_PhonesInfo));
...
EXPORT StandardStats(DATASET(PhonesTransactionMain2_Layout_PhonesInfo) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  myTimeStamp := (UNSIGNED6)SALT311.Fn_Now('YYYYMMDDHHMMSS') : INDEPENDENT;
  expandedFile := FromNone(inFile).ExpandedInfile;
  mod_fromexpandedOverall := FromExpanded(expandedFile);
  scrubsSummaryOverall := mod_fromexpandedOverall.SummaryStats;
 
  SALT311.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_PhonesInfo, PhonesTransactionMain2_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
