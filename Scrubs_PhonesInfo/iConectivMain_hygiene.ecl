...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_service_provider := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.service_provider)));
    avelength_service_provider := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.service_provider)),h.service_provider<>(typeof(h.service_provider))'');
    populated_service_type_pcnt := AVE(GROUP,IF(h.service_type = (TYPEOF(h.service_type))'',0,100));
    maxlength_service_type := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.service_type)));
    avelength_service_type := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.service_type)),h.service_type<>(typeof(h.service_type))'');
    ...
    maxlength_file_dt_time := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.file_dt_time)));
    avelength_file_dt_time := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.file_dt_time)),h.file_dt_time<>(typeof(h.file_dt_time))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.country_code),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.dial_type),TRIM((SALT33.StrType)le.spid),TRIM((SALT33.StrType)le.service_provider),TRIM((SALT33.StrType)le.service_type),TRIM((SALT33.StrType)le.routing_code),TRIM((SALT33.StrType)le.porting_dt),TRIM((SALT33.StrType)le.country_abbr),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.file_dt_time),TRIM((SALT33.StrType)le.vendor_first_reported_dt),TRIM((SALT33.StrType)le.vendor_last_reported_dt),TRIM((SALT33.StrType)le.port_start_dt),TRIM((SALT33.StrType)le.port_end_dt),TRIM((SALT33.StrType)le.remove_port_dt),TRIM((SALT33.StrType)le.is_ported)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 17);
  SELF.FldNo2 := 1 + (C % 17);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.country_code),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.dial_type),TRIM((SALT33.StrType)le.spid),TRIM((SALT33.StrType)le.service_provider),TRIM((SALT33.StrType)le.service_type),TRIM((SALT33.StrType)le.routing_code),TRIM((SALT33.StrType)le.porting_dt),TRIM((SALT33.StrType)le.country_abbr),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.file_dt_time),TRIM((SALT33.StrType)le.vendor_first_reported_dt),TRIM((SALT33.StrType)le.vendor_last_reported_dt),TRIM((SALT33.StrType)le.port_start_dt),TRIM((SALT33.StrType)le.port_end_dt),TRIM((SALT33.StrType)le.remove_port_dt),TRIM((SALT33.StrType)le.is_ported)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.country_code),TRIM((SALT33.StrType)le.phone),TRIM((SALT33.StrType)le.dial_type),TRIM((SALT33.StrType)le.spid),TRIM((SALT33.StrType)le.service_provider),TRIM((SALT33.StrType)le.service_type),TRIM((SALT33.StrType)le.routing_code),TRIM((SALT33.StrType)le.porting_dt),TRIM((SALT33.StrType)le.country_abbr),TRIM((SALT33.StrType)le.filename),TRIM((SALT33.StrType)le.file_dt_time),TRIM((SALT33.StrType)le.vendor_first_reported_dt),TRIM((SALT33.StrType)le.vendor_last_reported_dt),TRIM((SALT33.StrType)le.port_start_dt),TRIM((SALT33.StrType)le.port_end_dt),TRIM((SALT33.StrType)le.remove_port_dt),TRIM((SALT33.StrType)le.is_ported)));
  END;
...
SHARED FldIds := DATASET([{1,'country_code'}
      ...
      ,{15,'port_end_dt'}
      ,{16,'remove_port_dt'}
      ,{17,'is_ported'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    iConectivMain_Fields.InValid_country_code((SALT33.StrType)le.country_code),
    iConectivMain_Fields.InValid_phone((SALT33.StrType)le.phone),
    iConectivMain_Fields.InValid_dial_type((SALT33.StrType)le.dial_type),
    iConectivMain_Fields.InValid_spid((SALT33.StrType)le.spid),
    iConectivMain_Fields.InValid_service_provider((SALT33.StrType)le.service_provider),
    iConectivMain_Fields.InValid_service_type((SALT33.StrType)le.service_type),
    iConectivMain_Fields.InValid_routing_code((SALT33.StrType)le.routing_code),
    iConectivMain_Fields.InValid_porting_dt((SALT33.StrType)le.porting_dt),
    iConectivMain_Fields.InValid_country_abbr((SALT33.StrType)le.country_abbr),
    iConectivMain_Fields.InValid_filename((SALT33.StrType)le.filename),
    iConectivMain_Fields.InValid_file_dt_time((SALT33.StrType)le.file_dt_time),
    iConectivMain_Fields.InValid_vendor_first_reported_dt((SALT33.StrType)le.vendor_first_reported_dt),
    iConectivMain_Fields.InValid_vendor_last_reported_dt((SALT33.StrType)le.vendor_last_reported_dt),
    iConectivMain_Fields.InValid_port_start_dt((SALT33.StrType)le.port_start_dt),
    iConectivMain_Fields.InValid_port_end_dt((SALT33.StrType)le.port_end_dt),
    iConectivMain_Fields.InValid_remove_port_dt((SALT33.StrType)le.remove_port_dt),
    iConectivMain_Fields.InValid_is_ported((SALT33.StrType)le.is_ported),
    0);
