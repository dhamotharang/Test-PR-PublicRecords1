EXPORT MAC_PopulationStatistics(infile,Ref='',Input_reference_id = '',Input_dt_first_reported = '',Input_dt_last_reported = '',Input_phone = '',Input_reply_code = '',Input_local_routing_number = '',Input_account_owner = '',Input_carrier_name = '',Input_carrier_category = '',Input_local_area_transport_area = '',Input_point_code = '',Input_serv = '',Input_line = '',Input_spid = '',Input_operator_fullname = '',Input_activation_dt = '',Input_number_in_service = '',Input_high_risk_indicator = '',Input_prepaid = '',OutFile) := MACRO
