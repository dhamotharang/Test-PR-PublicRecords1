...
EXPORT FromNone(DATASET(In_Port_Daily_Layout_PhonesInfo) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    SELF.action_code_Invalid := In_Port_Daily_Fields.InValid_action_code((SALT38.StrType)le.action_code);
    SELF.country_code_Invalid := In_Port_Daily_Fields.InValid_country_code((SALT38.StrType)le.country_code);
    SELF.phone_Invalid := In_Port_Daily_Fields.InValid_phone((SALT38.StrType)le.phone);
    SELF.dial_type_Invalid := In_Port_Daily_Fields.InValid_dial_type((SALT38.StrType)le.dial_type);
    SELF.spid_Invalid := In_Port_Daily_Fields.InValid_spid((SALT38.StrType)le.spid);
    SELF.service_type_Invalid := In_Port_Daily_Fields.InValid_service_type((SALT38.StrType)le.service_type);
    SELF.routing_code_Invalid := In_Port_Daily_Fields.InValid_routing_code((SALT38.StrType)le.routing_code);
    SELF.porting_dt_Invalid := In_Port_Daily_Fields.InValid_porting_dt((SALT38.StrType)le.porting_dt);
    SELF.country_abbr_Invalid := In_Port_Daily_Fields.InValid_country_abbr((SALT38.StrType)le.country_abbr);
    SELF.filename_Invalid := In_Port_Daily_Fields.InValid_filename((SALT38.StrType)le.filename);
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT38.StrType)le.action_code,(SALT38.StrType)le.country_code,(SALT38.StrType)le.phone,(SALT38.StrType)le.dial_type,(SALT38.StrType)le.spid,(SALT38.StrType)le.service_type,(SALT38.StrType)le.routing_code,(SALT38.StrType)le.porting_dt,(SALT38.StrType)le.country_abbr,(SALT38.StrType)le.filename,'***SALTBUG***');
  END;
...
EXPORT StandardStats(DATASET(In_Port_Daily_Layout_PhonesInfo) inFile, BOOLEAN doErrorOverall = TRUE) := FUNCTION
  ...
  SALT38.mod_StandardStatsTransforms.mac_scrubsSummaryStatsFieldErrTransform(Scrubs_PhonesInfo, In_Port_Daily_Fields, 'RECORDOF(scrubsSummaryOverall)', '');
