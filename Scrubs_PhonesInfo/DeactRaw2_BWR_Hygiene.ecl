...
#workunit('name','Scrubs_Phonesinfo.DeactRaw2_BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'DeactRaw2_Layout_Phonesinfo'),NAMED('OptimizedLayout'));// File layout suggested by data
