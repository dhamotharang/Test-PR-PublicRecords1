...
#workunit('name','Scrubs_PhonesInfo.DeactRaw2_BWR_Hygiene - Hygiene & Stats - SALT V3.11.11');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'DeactRaw2_Layout_PhonesInfo'),NAMED('OptimizedLayout'));// File layout suggested by data
