IMPORT doxie, Foreclosure_Services, Residency_Services, STD, ut;

EXPORT fn_getForeclosure(DATASET(doxie.layout_references_acctno) ds_in_acctnos_dids) := FUNCTION
  ...
  // Project input onto layout needed by Foreclosure_Services.Raw.byDIDs, also stripping off the acctno
	...
	ds_forec_raw_recs := Foreclosure_Services.Raw.GetRawRecs(ds_fids);
