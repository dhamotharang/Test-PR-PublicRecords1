...
// export Key_VerificationOfOccupancy := index(newtable,{dataset_name,hashvalue}, {newtable}, Data_Services.foreign_dataland+'thor_data400::key::testseed::qa::verificationofoccupancy');
