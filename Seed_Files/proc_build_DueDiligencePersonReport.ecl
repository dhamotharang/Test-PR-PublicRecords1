...
EXPORT proc_build_DueDiligencePersonReport(STRING fileDate) := FUNCTION
    ...
    //Build keys
    buildPersonKeys := Seed_Files.proc_build_DueDiligencePersonReport_Keys(fileDate);
    build_keys := buildPersonKeys.allkeys;
    build_prte_keys := buildPersonKeys.prtekeys;
