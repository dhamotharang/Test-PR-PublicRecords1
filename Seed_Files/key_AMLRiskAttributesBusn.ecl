...
// export key_AMLRiskAttributesBusn := index(newtable,{dataset_name,hashvalue}, {newtable},  ut.foreign_dataland + 'thor_data400::key::testseed::qa::amlriskattributesBusn_test');
