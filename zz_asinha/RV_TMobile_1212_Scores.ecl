#workunit('name','T-Mobile 1212 Score');

import risk_indicators, ut, ashirey, scoring_project_Macros, scoring_project_pip;

eyeball := 25;

input_layout := scoring_project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_T_mobile_RVT1212_1_V4_Global_Layout;
...
basefilename := '~scoringqa::out::fcra::riskview_xml_t_mobile_rvt1212_1_v4_20160201_crim_exp_phase3_fcra_baseline';
testfilename := '~scoringqa::out::fcra::riskview_xml_t_mobile_rvt1212_1_v4_20160201_crim_exp_phase3_fcra_second';
pii_name := scoring_project_pip.Input_Sample_Names.RV_Scores_XML_Tmobile_rvt1212_1_infile;
...
OUTPUT(count(j1), NAMED('Decrease_222_Count'));
OUTPUT(count(j2), NAMED('Increase_222_count'));
OUTPUT(CHOOSEN(j1, 25), named('Decrease_222'));
OUTPUT(CHOOSEN(j2, 25), named('Increase_222'));
