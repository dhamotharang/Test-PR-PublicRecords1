...
basefilename := '~scoringqa::out::fcra::riskview_xml_santander_rva1304_1_v3_20160201_crim_exp_phase3_fcra_baseline';   // 1 for score 1, 2 for score 2
testfilename := '~scoringqa::out::fcra::riskview_xml_santander_rva1304_1_v3_20160201_crim_exp_phase3_fcra_second';  
...
scoring_project_pip.CROSSTAB_MACRO(flatten_baseline, flatten_second, ['acctno'], 'RV_score_auto');