...
//*
 ...
 dBase:=PROJECT(PRTE2_BIPV2_BusHeader.CommonBase.ds_xlink, TRANSFORM(PRTE2_BIPV2_BusHeader.CommonBase.Layout, SELF:=LEFT, SELF:=[]));
// dBase:=PRTE2_BIPV2_BusHeader.CommonBase.DS_OMNI(prod);
...
dBaseFile:=dWithCnpName+dAdditionalCity:PERSIST('~prte::persist::PRTE2_BIPV2_BusHeader::file_bizhead',EXPIRE(60));
