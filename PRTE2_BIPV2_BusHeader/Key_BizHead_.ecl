...
SALT33.Layout_Uber_Plus IntoInversion(h le,unsigned2 c) := TRANSFORM
  SELF.word := CHOOSE(c,(SALT33.StrType)le.parent_proxid,(SALT33.StrType)le.sele_proxid,(SALT33.StrType)le.org_proxid,(SALT33.StrType)le.ultimate_proxid,(SALT33.StrType)le.has_lgid,(SALT33.StrType)le.empid,(SALT33.StrType)le.source,(SALT33.StrType)le.source_record_id,(SALT33.StrType)le.source_docid,BizLinkFull.Fields.Make_company_name((SALT33.StrType)le.company_name),BizLinkFull.Fields.Make_company_name_prefix((SALT33.StrType)le.company_name_prefix),'',(SALT33.StrType)le.cnp_number,(SALT33.StrType)le.cnp_btype,(SALT33.StrType)le.cnp_lowv,(SALT33.StrType)le.company_phone,(SALT33.StrType)le.company_phone_3,(SALT33.StrType)le.company_phone_3_ex,(SALT33.StrType)le.company_phone_7,(SALT33.StrType)le.company_fein,(SALT33.StrType)le.company_sic_code1,(SALT33.StrType)le.active_duns_number,(SALT33.StrType)le.prim_range,BizLinkFull.Fields.Make_prim_name((SALT33.StrType)le.prim_name),BizLinkFull.Fields.Make_sec_range((SALT33.StrType)le.sec_range),BizLinkFull.Fields.Make_city((SALT33.StrType)le.city),BizLinkFull.Fields.Make_city_clean((SALT33.StrType)le.city_clean),BizLinkFull.Fields.Make_st((SALT33.StrType)le.st),BizLinkFull.Fields.Make_zip((SALT33.StrType)le.zip),'',(SALT33.StrType)le.isContact,(SALT33.StrType)le.contact_did,(SALT33.StrType)le.title,BizLinkFull.Fields.Make_fname((SALT33.StrType)le.fname),BizLinkFull.Fields.Make_fname_preferred((SALT33.StrType)le.fname_preferred),BizLinkFull.Fields.Make_mname((SALT33.StrType)le.mname),BizLinkFull.Fields.Make_lname((SALT33.StrType)le.lname),BizLinkFull.Fields.Make_name_suffix((SALT33.StrType)le.name_suffix),(SALT33.StrType)le.contact_ssn,BizLinkFull.Fields.Make_contact_email((SALT33.StrType)le.contact_email),(SALT33.StrType)le.sele_flag,(SALT33.StrType)le.org_flag,(SALT33.StrType)le.ult_flag,(SALT33.StrType)le.fallback_value,SKIP,SKIP,SKIP);
  SELF.field := c;
  SELF.uid := le.proxid
END;
