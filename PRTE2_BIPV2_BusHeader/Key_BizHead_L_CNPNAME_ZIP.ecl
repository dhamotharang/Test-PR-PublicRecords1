...
EXPORT CanSearch(PRTE2_BIPV2_BusHeader.Process_Biz_Layouts.InputLayout le) := le.cnp_name <> (TYPEOF(le.cnp_name))'' AND BizLinkFull.Fields.InValid_cnp_name((SALT311.StrType)le.cnp_name)=0 AND EXISTS(le.zip_cases);
KeyRec := RECORDOF(Key);
