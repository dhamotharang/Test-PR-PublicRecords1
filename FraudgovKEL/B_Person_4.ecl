...
EXPORT B_Person_4 := MODULE
  ...
  SHARED __EE130948 := __ENH_Person_5;
  SHARED __EE131475 := __ENH_Event_5;
  SHARED __EE133374 := __EE131475(__EE131475.In_Customer_Population_ = 1);
  SHARED __EE131473 := __E_Person_Event;
  SHARED __EE138601 := __EE131473(__NN(__EE131473.Subject_) AND __NN(__EE131473.Transaction_));
  SHARED __ST134610_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC138619(B_Event_5.__ST42149_Layout __EE133374, E_Person_Event.Layout __EE138601) := __EEQP(__EE138601.Transaction_,__EE133374.UID);
  __ST134610_Layout __JT138619(B_Event_5.__ST42149_Layout __l, E_Person_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE138620 := JOIN(__EE138601,__EE133374,__JC138619(RIGHT,LEFT),__JT138619(RIGHT,LEFT),INNER,SMART);
  SHARED __ST132813_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST132813_Layout __ND138823__Project(__ST134610_Layout __PP138621) := TRANSFORM
    SELF.UID := __PP138621.Subject__1_;
    SELF._r_Customer_ := __PP138621._r_Customer__1_;
    SELF.Subject_ := __PP138621.Subject__1_;
    SELF.Event_Date_ := __PP138621.Event_Date__1_;
    SELF.U_I_D__1_ := __PP138621.UID;
    SELF._r_Customer__1_ := __PP138621._r_Customer_;
    SELF.Subject__1_ := __PP138621.Subject_;
    SELF.Event_Date__1_ := __PP138621.Event_Date_;
    SELF := __PP138621;
  END;
  SHARED __EE139580 := PROJECT(__EE138620,__ND138823__Project(LEFT));
  SHARED __ST133213_Layout := RECORD
    KEL.typ.ntyp(E_Person.Typ) UID;
    KEL.typ.nint Deceased_To_Event_Year_Diff_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE139594 := PROJECT(__EE139580,__ST133213_Layout);
  SHARED __ST133228_Layout := RECORD
    KEL.typ.nint M_A_X___Deceased_To_Event_Year_Diff_;
    KEL.typ.ntyp(E_Person.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE139610 := PROJECT(__CLEANANDDO(__EE139594,TABLE(__EE139594,{KEL.Aggregates.MaxNG(__EE139594.Deceased_To_Event_Year_Diff_) M_A_X___Deceased_To_Event_Year_Diff_,UID},UID,MERGE)),__ST133228_Layout);
  SHARED __ST135584_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC139616(B_Person_5.__ST42464_Layout __EE130948, __ST133228_Layout __EE139610) := __EEQP(__EE130948.UID,__EE139610.UID);
  __ST135584_Layout __JT139616(B_Person_5.__ST42464_Layout __l, __ST133228_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE139617 := JOIN(__EE130948,__EE139610,__JC139616(LEFT,RIGHT),__JT139616(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST41536_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.ndataset(E_Person.Source_Customers_Layout) Source_Customers_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST41536_Layout __ND140106__Project(__ST135584_Layout __PP139618) := TRANSFORM
    SELF.Death_Prior_To_All_Events_ := MAP(__T(__OP2(__PP139618.Deceased_Event_Percent_,=,__CN(1)))=>1,0);
    SELF.Max_Deceased_To_Event_Diff_ := __PP139618.M_A_X___Deceased_To_Event_Year_Diff_;
    SELF := __PP139618;
  END;
  EXPORT __ENH_Person_4 := PROJECT(__EE139617,__ND140106__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_4',EXPIRE(7));
END;
