...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE4110050 := __E_Person_S_S_N;
  SHARED __EE4110033 := __ENH_Person;
  SHARED __ST4110068_Layout := RECORD
  ...
  END;
  __JC4110065(E_Person_S_S_N.Layout __EE4110050, B_Person.__ST66581_Layout __EE4110033) := __EEQP(__EE4110050.Subject_,__EE4110033.UID);
  __ST4110068_Layout __JT4110065(E_Person_S_S_N.Layout __l, B_Person.__ST66581_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4110066 := JOIN(__EE4110050,__EE4110033,__JC4110065(LEFT,RIGHT),__JT4110065(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4110021 := __ENH_Social_Security_Number;
  SHARED __ST4110343_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4111149(__ST4110068_Layout __EE4110066, B_Social_Security_Number.__ST68181_Layout __EE4110021) := __EEQP(__EE4110066.Social_,__EE4110021.UID);
  __ST4110343_Layout __JT4111149(__ST4110068_Layout __l, B_Social_Security_Number.__ST68181_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4111150 := JOIN(__EE4110066,__EE4110021,__JC4111149(LEFT,RIGHT),__JT4111149(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4110006 := __E_Customer;
  SHARED __ST4110784_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4111151(__ST4110343_Layout __EE4111150, E_Customer.Layout __EE4110006) := __EEQP(__EE4111150._r_Customer_,__EE4110006.UID);
  __ST4110784_Layout __JT4111151(__ST4110343_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4111152 := JOIN(__EE4111150,__EE4110006,__JC4111151(LEFT,RIGHT),__JT4111151(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44532_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44532_Layout __ND4111141__Project(__ST4110784_Layout __PP4111140) := TRANSFORM
    SELF.Source_Customer_ := __PP4111140._r_Customer_;
    SELF.Customer_Id_ := __PP4111140.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4111140.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4111140.Entity_Context_Uid__1_;
    SELF := __PP4111140;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4111152,__ND4111141__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44532_Layout));
END;
