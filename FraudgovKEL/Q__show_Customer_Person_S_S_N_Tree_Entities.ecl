...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE4620215 := __E_Person_S_S_N;
  SHARED __EE4620198 := __ENH_Person;
  SHARED __ST4620233_Layout := RECORD
  ...
  END;
  __JC4620230(E_Person_S_S_N.Layout __EE4620215, B_Person.__ST69802_Layout __EE4620198) := __EEQP(__EE4620215.Subject_,__EE4620198.UID);
  __ST4620233_Layout __JT4620230(E_Person_S_S_N.Layout __l, B_Person.__ST69802_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4620231 := JOIN(__EE4620215,__EE4620198,__JC4620230(LEFT,RIGHT),__JT4620230(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4620186 := __ENH_Social_Security_Number;
  SHARED __ST4620508_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4621315(__ST4620233_Layout __EE4620231, B_Social_Security_Number.__ST71402_Layout __EE4620186) := __EEQP(__EE4620231.Social_,__EE4620186.UID);
  __ST4620508_Layout __JT4621315(__ST4620233_Layout __l, B_Social_Security_Number.__ST71402_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4621316 := JOIN(__EE4620231,__EE4620186,__JC4621315(LEFT,RIGHT),__JT4621315(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4620171 := __E_Customer;
  SHARED __ST4620949_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4621317(__ST4620508_Layout __EE4621316, E_Customer.Layout __EE4620171) := __EEQP(__EE4621316._r_Customer_,__EE4620171.UID);
  __ST4620949_Layout __JT4621317(__ST4620508_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4621318 := JOIN(__EE4621316,__EE4620171,__JC4621317(LEFT,RIGHT),__JT4621317(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST46636_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46636_Layout __ND4621307__Project(__ST4620949_Layout __PP4621306) := TRANSFORM
    SELF.Source_Customer_ := __PP4621306._r_Customer_;
    SELF.Customer_Id_ := __PP4621306.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4621306.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4621306.Entity_Context_Uid__1_;
    SELF := __PP4621306;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4621318,__ND4621307__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST46636_Layout));
END;
