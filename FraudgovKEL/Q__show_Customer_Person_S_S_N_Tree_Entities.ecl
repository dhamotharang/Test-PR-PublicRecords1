...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE4365315 := __E_Person_S_S_N;
  SHARED __EE4365298 := __ENH_Person;
  SHARED __ST4365333_Layout := RECORD
  ...
  END;
  __JC4365330(E_Person_S_S_N.Layout __EE4365315, B_Person.__ST69802_Layout __EE4365298) := __EEQP(__EE4365315.Subject_,__EE4365298.UID);
  __ST4365333_Layout __JT4365330(E_Person_S_S_N.Layout __l, B_Person.__ST69802_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4365331 := JOIN(__EE4365315,__EE4365298,__JC4365330(LEFT,RIGHT),__JT4365330(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4365286 := __ENH_Social_Security_Number;
  SHARED __ST4365608_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4366415(__ST4365333_Layout __EE4365331, B_Social_Security_Number.__ST71402_Layout __EE4365286) := __EEQP(__EE4365331.Social_,__EE4365286.UID);
  __ST4365608_Layout __JT4366415(__ST4365333_Layout __l, B_Social_Security_Number.__ST71402_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4366416 := JOIN(__EE4365331,__EE4365286,__JC4366415(LEFT,RIGHT),__JT4366415(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4365271 := __E_Customer;
  SHARED __ST4366049_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4366417(__ST4365608_Layout __EE4366416, E_Customer.Layout __EE4365271) := __EEQP(__EE4366416._r_Customer_,__EE4365271.UID);
  __ST4366049_Layout __JT4366417(__ST4365608_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4366418 := JOIN(__EE4366416,__EE4365271,__JC4366417(LEFT,RIGHT),__JT4366417(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST46636_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46636_Layout __ND4366407__Project(__ST4366049_Layout __PP4366406) := TRANSFORM
    SELF.Source_Customer_ := __PP4366406._r_Customer_;
    SELF.Customer_Id_ := __PP4366406.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4366406.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4366406.Entity_Context_Uid__1_;
    SELF := __PP4366406;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4366418,__ND4366407__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST46636_Layout));
END;
