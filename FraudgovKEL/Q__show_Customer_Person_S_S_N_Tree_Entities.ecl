...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE2751776 := __E_Person_S_S_N;
  SHARED __EE2751759 := __ENH_Person;
  SHARED __ST2751794_Layout := RECORD
  ...
  END;
  __JC2751791(E_Person_S_S_N.Layout __EE2751776, B_Person.__ST52826_Layout __EE2751759) := __EEQP(__EE2751776.Subject_,__EE2751759.UID);
  __ST2751794_Layout __JT2751791(E_Person_S_S_N.Layout __l, B_Person.__ST52826_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2751792 := JOIN(__EE2751776,__EE2751759,__JC2751791(LEFT,RIGHT),__JT2751791(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2751747 := __ENH_Social_Security_Number;
  SHARED __ST2752108_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2752984(__ST2751794_Layout __EE2751792, B_Social_Security_Number.__ST54265_Layout __EE2751747) := __EEQP(__EE2751792.Social_,__EE2751747.UID);
  __ST2752108_Layout __JT2752984(__ST2751794_Layout __l, B_Social_Security_Number.__ST54265_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2752985 := JOIN(__EE2751792,__EE2751747,__JC2752984(LEFT,RIGHT),__JT2752984(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2751732 := __E_Customer;
  SHARED __ST2752585_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2752986(__ST2752108_Layout __EE2752985, E_Customer.Layout __EE2751732) := __EEQP(__EE2752985._r_Customer_,__EE2751732.UID);
  __ST2752585_Layout __JT2752986(__ST2752108_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2752987 := JOIN(__EE2752985,__EE2751732,__JC2752986(LEFT,RIGHT),__JT2752986(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST35754_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST35754_Layout __ND2752976__Project(__ST2752585_Layout __PP2752975) := TRANSFORM
    SELF.Source_Customer_ := __PP2752975._r_Customer_;
    SELF.Customer_Id_ := __PP2752975.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2752975.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2752975.Entity_Context_Uid__1_;
    SELF := __PP2752975;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2752987,__ND2752976__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST35754_Layout));
END;
