...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE4662526 := __E_Person_S_S_N;
  SHARED __EE4662509 := __ENH_Person;
  SHARED __ST4662544_Layout := RECORD
  ...
  END;
  __JC4662541(E_Person_S_S_N.Layout __EE4662526, B_Person.__ST69071_Layout __EE4662509) := __EEQP(__EE4662526.Subject_,__EE4662509.UID);
  __ST4662544_Layout __JT4662541(E_Person_S_S_N.Layout __l, B_Person.__ST69071_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4662542 := JOIN(__EE4662526,__EE4662509,__JC4662541(LEFT,RIGHT),__JT4662541(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4662497 := __ENH_Social_Security_Number;
  SHARED __ST4662819_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4663626(__ST4662544_Layout __EE4662542, B_Social_Security_Number.__ST70613_Layout __EE4662497) := __EEQP(__EE4662542.Social_,__EE4662497.UID);
  __ST4662819_Layout __JT4663626(__ST4662544_Layout __l, B_Social_Security_Number.__ST70613_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4663627 := JOIN(__EE4662542,__EE4662497,__JC4663626(LEFT,RIGHT),__JT4663626(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4662482 := __E_Customer;
  SHARED __ST4663260_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4663628(__ST4662819_Layout __EE4663627, E_Customer.Layout __EE4662482) := __EEQP(__EE4663627._r_Customer_,__EE4662482.UID);
  __ST4663260_Layout __JT4663628(__ST4662819_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4663629 := JOIN(__EE4663627,__EE4662482,__JC4663628(LEFT,RIGHT),__JT4663628(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST46017_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46017_Layout __ND4663618__Project(__ST4663260_Layout __PP4663617) := TRANSFORM
    SELF.Source_Customer_ := __PP4663617._r_Customer_;
    SELF.Customer_Id_ := __PP4663617.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4663617.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4663617.Entity_Context_Uid__1_;
    SELF := __PP4663617;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4663629,__ND4663618__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST46017_Layout));
END;
