...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE1233924 := __E_Person_S_S_N;
  SHARED __EE1233907 := __ENH_Person;
  SHARED __ST1233942_Layout := RECORD
  ...
  END;
  __JC1233939(E_Person_S_S_N.Layout __EE1233924, B_Person.__ST28512_Layout __EE1233907) := __EEQP(__EE1233924.Subject_,__EE1233907.UID);
  __ST1233942_Layout __JT1233939(E_Person_S_S_N.Layout __l, B_Person.__ST28512_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1233940 := JOIN(__EE1233924,__EE1233907,__JC1233939(LEFT,RIGHT),__JT1233939(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1233895 := __ENH_Social_Security_Number;
  SHARED __ST1234226_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1235030(__ST1233942_Layout __EE1233940, B_Social_Security_Number.__ST29655_Layout __EE1233895) := __EEQP(__EE1233940.Social_,__EE1233895.UID);
  __ST1234226_Layout __JT1235030(__ST1233942_Layout __l, B_Social_Security_Number.__ST29655_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1235031 := JOIN(__EE1233940,__EE1233895,__JC1235030(LEFT,RIGHT),__JT1235030(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1233880 := __E_Customer;
  SHARED __ST1234667_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1235032(__ST1234226_Layout __EE1235031, E_Customer.Layout __EE1233880) := __EEQP(__EE1235031._r_Customer_,__EE1233880.UID);
  __ST1234667_Layout __JT1235032(__ST1234226_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1235033 := JOIN(__EE1235031,__EE1233880,__JC1235032(LEFT,RIGHT),__JT1235032(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST20022_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20022_Layout __ND1235022__Project(__ST1234667_Layout __PP1235021) := TRANSFORM
    SELF.Source_Customer_ := __PP1235021._r_Customer_;
    SELF.Customer_Id_ := __PP1235021.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1235021.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1235021.Entity_Context_Uid__1_;
    SELF := __PP1235021;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1235033,__ND1235022__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST20022_Layout));
END;
