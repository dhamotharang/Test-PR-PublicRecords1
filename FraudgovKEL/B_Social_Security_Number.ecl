...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE3888853 := __ENH_Social_Security_Number_1;
  SHARED __EE3893348 := __ENH_Event_1;
  SHARED __EE3893346 := __E_Ssn_Event;
  SHARED __EE3945511 := __EE3893346(__NN(__EE3893346.Social_) AND __NN(__EE3893346.Transaction_));
  SHARED __ST3936254_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3945529(B_Event_1.__ST76927_Layout __EE3893348, E_Ssn_Event.Layout __EE3945511) := __EEQP(__EE3945511.Transaction_,__EE3893348.UID);
  __ST3936254_Layout __JT3945529(B_Event_1.__ST76927_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3945530 := JOIN(__EE3945511,__EE3893348,__JC3945529(RIGHT,LEFT),__JT3945529(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3932728_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3932728_Layout __ND3946221__Project(__ST3936254_Layout __PP3945531) := TRANSFORM
    SELF.UID := __PP3945531.Social_;
    SELF._r_Customer_ := __PP3945531._r_Customer__1_;
    SELF.Event_Date_ := __PP3945531.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3945531.UID;
    SELF.Event_Date__1_ := __PP3945531.Event_Date_;
    SELF._r_Customer__1_ := __PP3945531._r_Customer_;
    SELF := __PP3945531;
  END;
  SHARED __EE3948946 := PROJECT(__EE3945530,__ND3946221__Project(LEFT));
  SHARED __ST3934165_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3934165_Layout __ND3949727__Project(__ST3932728_Layout __PP3948947) := TRANSFORM
    SELF.Exp1_ := __PP3948947.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP3948947.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP3948947.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP3948947.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP3948947.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP3948947.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP3948947.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP3948947.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP3948947.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP3948947.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP3948947.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP3948947.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP3948947.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP3948947.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP3948947.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP3948947.Event_Age_,<,__CN(2)),__CN(__PP3948947.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP3948947.Event_Age_,<,__CN(366));
    SELF := __PP3948947;
  END;
  SHARED __EE3949754 := PROJECT(__EE3948946,__ND3949727__Project(LEFT));
  SHARED __ST3934268_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3949863 := PROJECT(__CLEANANDDO(__EE3949754,TABLE(__EE3949754,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3949754.Exp1_),KEL.Aggregates.MinNG(__EE3949754.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3949754.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3949754.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3949754.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3949754.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3949754.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3949754.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3949754.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3949754.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3949754.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3949754.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3949754.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3949754.Exp13_),KEL.Aggregates.MaxNG(__EE3949754.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3949754.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE3949754.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE3949754.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE3949754.Exp17_)),UID},UID,MERGE)),__ST3934268_Layout);
  SHARED __ST3939682_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3949869(B_Social_Security_Number_1.__ST80235_Layout __EE3888853, __ST3934268_Layout __EE3949863) := __EEQP(__EE3888853.UID,__EE3949863.UID);
  __ST3939682_Layout __JT3949869(B_Social_Security_Number_1.__ST80235_Layout __l, __ST3934268_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3949945 := JOIN(__EE3888853,__EE3949863,__JC3949869(LEFT,RIGHT),__JT3949869(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3876148 := __ENH_Customer_1;
  SHARED __ST3940163_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3949951(__ST3939682_Layout __EE3949945, B_Customer_1.__ST68903_Layout __EE3876148) := __EEQP(__EE3949945._r_Customer_,__EE3876148.UID);
  __ST3940163_Layout __JT3949951(__ST3939682_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3950049 := JOIN(__EE3949945,__EE3876148,__JC3949951(LEFT,RIGHT),__JT3949951(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST67603_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST67603_Layout __ND3950054__Project(__ST3940163_Layout __PP3950050) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3950050.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP3950050.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP3950050.Identity_Count_ > 2=>1,0);
    __BS3950234 := __T(__PP3950050.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3950234(__T(__OP2(__T(__PP3950050.Source_Customers_)._r_Source_Customer_,=,__PP3950050._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP3950050.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP3950050.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3950050.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3950050.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3950050.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP3950050.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3950050.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3950050.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3950050.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3950050.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3950050.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3950050;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE3950049,__ND3950054__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE4093508 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4093508._r_Customer_;
    __EE4093508.Source_Customers_;
    __EE4093508.Ssn_;
    __EE4093508.Otto_S_S_N_Id_;
    __EE4093508.Ssn_Formatted_;
    __EE4093508._v2__divssnidentitycountnew_;
    __EE4093508.Deceased_Date_;
    __EE4093508.Deceased_Date_Of_Birth_;
    __EE4093508.Deceased_First_;
    __EE4093508.Deceased_Middle_;
    __EE4093508.Deceased_Last_;
    __EE4093508.Deceased_Match_Code_;
    __EE4093508._isdeepdive_;
    __EE4093508._county__death_;
    __EE4093508.Deceased_Ssn_;
    __EE4093508._state__death__flag_;
    __EE4093508._death__rec__src_;
    __EE4093508._state__death__id_;
    __EE4093508.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE4093508.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4093508.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE4093508.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE4093508.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4093508.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4093508.Aot_Id_Act_Cnt_Ev_;
    __EE4093508.Aot_Id_Act_Cnt30_D_;
    __EE4093508.Aot_Add_Act_Cnt_Ev_;
    __EE4093508.Aot_Add_Act_Cnt30_D_;
    __EE4093508.Aot_Non_St_Act_Cnt_Ev_;
    __EE4093508.Aot_Non_St_Act_Cnt30_D_;
    __EE4093508.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4093508.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4093508.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4093508.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4093508.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4093508.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE4093508.Customer_Id_;
    __EE4093508.Industry_Type_;
    __EE4093508.Source_Customer_Count_;
    __EE4093508.Entity_Context_Uid_;
    __EE4093508.Entity_Type_;
    __EE4093508.Label_;
    __EE4093508.In_Customer_Population_;
    __EE4093508.Dt_First_Seen_;
    __EE4093508.Dt_Last_Seen_;
    __EE4093508.Last_Record_Id_;
    __EE4093508.Identity_Count_;
    __EE4093508.Identity_Count_Gt2_;
    __EE4093508.Event_Count_;
    __EE4093508.Kr_High_Risk_Flag_;
    __EE4093508.Kr_Medium_Risk_Flag_;
    __EE4093508.Kr_Low_Risk_Flag_;
    __EE4093508.Kr_Flag_;
    __EE4093508.Safe_Flag_;
    __EE4093508.Contributor_Safe_Flag_;
    __EE4093508.Last_Event_Date_;
    __EE4093508.Kr_Last_Event_Date_;
    __EE4093508.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4093508.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4093508.Kr_Ssn100_Flag_;
    __EE4093508.Kr_Ssn101_Flag_;
    __EE4093508.Kr_Ssn103_Flag_;
    __EE4093508.Kr_Ssn104_Flag_;
    __EE4093508.Kr_Ssn105_Flag_;
    __EE4093508.Kr_Ssn190_Flag_;
    __EE4093508.Kr_Ssn191_Flag_;
    __EE4093508.Kr_Ssn192_Flag_;
    __EE4093508.Kr_Ssn193_Flag_;
    __EE4093508.Vl_Event1_All_Count_;
    __EE4093508.Vl_Event7_All_Count_;
    __EE4093508.Vl_Event30_All_Day_Count_;
    __EE4093508.Vl_Event365_All_Day_Count_;
    __EE4093508.Vl_Event7_All_Active_Flag_;
    __EE4093508.Vl_Event30_All_Active_Flag_;
    __EE4093508.Vl_Event1_Count_;
    __EE4093508.Vl_Event7_Count_;
    __EE4093508.Vl_Event30_Count_;
    __EE4093508.Vl_Event365_Count_;
    __EE4093508.Vl_Event7_Active_Flag_;
    __EE4093508.Vl_Event30_Active_Flag_;
    __EE4093508.Date_First_Seen_;
    __EE4093508.Date_Last_Seen_;
    __EE4093508.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE4093508,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4093510_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST67603_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
