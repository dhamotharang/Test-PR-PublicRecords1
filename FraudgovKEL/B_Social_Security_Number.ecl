...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1182234 := __ENH_Social_Security_Number_1;
  SHARED __EE1225166 := __E_Ssn_Event;
  SHARED __EE1225173 := __EE1225166(__NN(__EE1225166.Social_));
  SHARED __ST1218268_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Ssn_Event_ := 0;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1225164 := PROJECT(__CLEANANDDO(__EE1225173,TABLE(__EE1225173,{KEL.typ.int C_O_U_N_T___Ssn_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Social_Security_Number.Typ) UID := __EE1225173.Social_},Social_,MERGE)),__ST1218268_Layout);
  SHARED __ST1220638_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1225193(B_Social_Security_Number_1.__ST37280_Layout __EE1182234, __ST1218268_Layout __EE1225164) := __EEQP(__EE1182234.UID,__EE1225164.UID);
  __ST1220638_Layout __JT1225193(B_Social_Security_Number_1.__ST37280_Layout __l, __ST1218268_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1225194 := JOIN(__EE1182234,__EE1225164,__JC1225193(LEFT,RIGHT),__JT1225193(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1225177 := __ENH_Event_1;
  SHARED __EE1229899 := __EE1225166;
  SHARED __EE1229912 := __EE1229899(__NN(__EE1229899.Social_) AND __NN(__EE1229899.Transaction_));
  SHARED __ST1218706_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1229918(B_Event_1.__ST35754_Layout __EE1225177, E_Ssn_Event.Layout __EE1229912) := __EEQP(__EE1229912.Transaction_,__EE1225177.UID);
  __ST1218706_Layout __JT1229918(B_Event_1.__ST35754_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1229919 := JOIN(__EE1229912,__EE1225177,__JC1229918(RIGHT,LEFT),__JT1229918(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1215804_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1215804_Layout __ND1230312__Project(__ST1218706_Layout __PP1229920) := TRANSFORM
    SELF.UID := __PP1229920.Social_;
    SELF._r_Customer_ := __PP1229920._r_Customer__1_;
    SELF.Event_Date_ := __PP1229920.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1229920.UID;
    SELF.Event_Date__1_ := __PP1229920.Event_Date_;
    SELF._r_Customer__1_ := __PP1229920._r_Customer_;
    SELF := __PP1229920;
  END;
  SHARED __EE1231837 := PROJECT(__EE1229919,__ND1230312__Project(LEFT));
  SHARED __ST1216672_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1216672_Layout __ND1232646__Project(__ST1215804_Layout __PP1231838) := TRANSFORM
    SELF.Exp1_ := __PP1231838.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1231838.Hri06_Flag_ = 1;
    SELF.Exp3_ := __PP1231838.Hri26_Flag_ = 1;
    SELF.Exp4_ := __PP1231838.Hri29_Flag_ = 1;
    SELF.Exp5_ := __PP1231838.Hri38_Flag_ = 1;
    SELF.Exp6_ := __PP1231838.Hri71_Flag_ = 1;
    SELF.Exp7_ := __PP1231838.Hri_It_Flag_ = 1;
    SELF.Exp8_ := __PP1231838.Hri_Mi_Flag_ = 1;
    SELF.Exp9_ := __PP1231838.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp10_ := __PP1231838.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp11_ := __PP1231838.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp12_ := __PP1231838.Kr_Ssn100_Flag_ = 1;
    SELF.Exp13_ := __PP1231838.Kr_Ssn101_Flag_ = 1;
    SELF.Exp14_ := __PP1231838.Kr_Ssn103_Flag_ = 1;
    SELF.Exp15_ := __PP1231838.Kr_Ssn104_Flag_ = 1;
    SELF.Exp16_ := __PP1231838.Kr_Ssn105_Flag_ = 1;
    SELF.Exp17_ := __PP1231838.Kr_Ssn190_Flag_ = 1;
    SELF.Exp18_ := __PP1231838.Kr_Ssn191_Flag_ = 1;
    SELF.Exp19_ := __PP1231838.Kr_Ssn192_Flag_ = 1;
    SELF.Exp20_ := __PP1231838.Kr_Ssn193_Flag_ = 1;
    SELF.Exp21_ := __PP1231838.Safe_Flag_ = 1;
    SELF.Exp22_ := __OP2(__PP1231838.Event_Age_,<,__CN(2));
    SELF.Exp23_ := __AND(__OP2(__PP1231838.Event_Age_,<,__CN(2)),__CN(__PP1231838.In_Customer_Population_ = 1));
    SELF.Exp24_ := __OP2(__PP1231838.Event_Age_,<,__CN(366));
    SELF := __PP1231838;
  END;
  SHARED __EE1232680 := PROJECT(__EE1231837,__ND1232646__Project(LEFT));
  SHARED __ST1216813_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1232829 := PROJECT(__CLEANANDDO(__EE1232680,TABLE(__EE1232680,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1232680.Exp1_),KEL.Aggregates.MinNG(__EE1232680.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1232680.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1232680.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1232680.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1232680.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1232680.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1232680.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1232680.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1232680.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1232680.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1232680.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1232680.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1232680.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1232680.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1232680.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1232680.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1232680.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1232680.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1232680.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1232680.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1232680.Exp20_),KEL.Aggregates.MaxNG(__EE1232680.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1232680.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__T(__EE1232680.Exp22_)),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__T(__EE1232680.Exp23_)),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__T(__EE1232680.Exp24_)),UID},UID,MERGE)),__ST1216813_Layout);
  SHARED __ST1220961_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1232835(__ST1220638_Layout __EE1225194, __ST1216813_Layout __EE1232829) := __EEQP(__EE1225194.UID,__EE1232829.UID);
  __ST1220961_Layout __JT1232835(__ST1220638_Layout __l, __ST1216813_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1232903 := JOIN(__EE1225194,__EE1232829,__JC1232835(LEFT,RIGHT),__JT1232835(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1170586 := __ENH_Customer_1;
  SHARED __ST1221403_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1232909(__ST1220961_Layout __EE1232903, B_Customer_1.__ST32738_Layout __EE1170586) := __EEQP(__EE1232903._r_Customer_,__EE1170586.UID);
  __ST1221403_Layout __JT1232909(__ST1220961_Layout __l, B_Customer_1.__ST32738_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1232999 := JOIN(__EE1232903,__EE1170586,__JC1232909(LEFT,RIGHT),__JT1232909(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST32058_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32058_Layout __ND1233004__Project(__ST1221403_Layout __PP1233000) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1233000.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1233000.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Event_Count_ := __PP1233000.C_O_U_N_T___Ssn_Event_;
    SELF.Hri06_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri26_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri29_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri38_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri71_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_It_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1233000.Identity_Count_ > 2=>1,0);
    __BS1233163 := __T(__PP1233000.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1233163(__T(__OP2(__T(__PP1233000.Source_Customers_)._r_Source_Customer_,=,__PP1233000._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1233000.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1233000.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1233000.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1233000.C_O_U_N_T___Exp1__21_;
    SELF.Vl_Event1_Count_ := __PP1233000.C_O_U_N_T___Exp1__22_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1233000.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1233000.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1233000.C_O_U_N_T___Exp1__23_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1233000.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1233000.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1233000;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1232999,__ND1233004__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1379774 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1379774._r_Customer_;
    __EE1379774.Source_Customers_;
    __EE1379774.Ssn_;
    __EE1379774.Otto_S_S_N_Id_;
    __EE1379774.Ssn_Formatted_;
    __EE1379774._v2__divssnidentitycountnew_;
    __EE1379774.Deceased_Date_;
    __EE1379774.Deceased_Date_Of_Birth_;
    __EE1379774.Deceased_First_;
    __EE1379774.Deceased_Middle_;
    __EE1379774.Deceased_Last_;
    __EE1379774.Deceased_Match_Code_;
    __EE1379774._isdeepdive_;
    __EE1379774._county__death_;
    __EE1379774.Deceased_Ssn_;
    __EE1379774._state__death__flag_;
    __EE1379774._death__rec__src_;
    __EE1379774._state__death__id_;
    __EE1379774.Customer_Id_;
    __EE1379774.Industry_Type_;
    __EE1379774.Source_Customer_Count_;
    __EE1379774.Entity_Context_Uid_;
    __EE1379774.Entity_Type_;
    __EE1379774.Label_;
    __EE1379774.In_Customer_Population_;
    __EE1379774.Dt_First_Seen_;
    __EE1379774.Dt_Last_Seen_;
    __EE1379774.Last_Record_Id_;
    __EE1379774.Identity_Count_;
    __EE1379774.Identity_Count_Gt2_;
    __EE1379774.Event_Count_;
    __EE1379774.Hri06_Flag_;
    __EE1379774.Hri26_Flag_;
    __EE1379774.Hri29_Flag_;
    __EE1379774.Hri38_Flag_;
    __EE1379774.Hri71_Flag_;
    __EE1379774.Hri_It_Flag_;
    __EE1379774.Hri_Mi_Flag_;
    __EE1379774.Kr_High_Risk_Flag_;
    __EE1379774.Kr_Medium_Risk_Flag_;
    __EE1379774.Kr_Low_Risk_Flag_;
    __EE1379774.Kr_Flag_;
    __EE1379774.Safe_Flag_;
    __EE1379774.Contributor_Safe_Flag_;
    __EE1379774.Last_Event_Date_;
    __EE1379774.Kr_Last_Event_Date_;
    __EE1379774.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1379774.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1379774.Kr_Ssn100_Flag_;
    __EE1379774.Kr_Ssn101_Flag_;
    __EE1379774.Kr_Ssn103_Flag_;
    __EE1379774.Kr_Ssn104_Flag_;
    __EE1379774.Kr_Ssn105_Flag_;
    __EE1379774.Kr_Ssn190_Flag_;
    __EE1379774.Kr_Ssn191_Flag_;
    __EE1379774.Kr_Ssn192_Flag_;
    __EE1379774.Kr_Ssn193_Flag_;
    __EE1379774.Vl_Event1_All_Count_;
    __EE1379774.Vl_Event7_All_Count_;
    __EE1379774.Vl_Event30_All_Day_Count_;
    __EE1379774.Vl_Event365_All_Day_Count_;
    __EE1379774.Vl_Event7_All_Active_Flag_;
    __EE1379774.Vl_Event30_All_Active_Flag_;
    __EE1379774.Vl_Event1_Count_;
    __EE1379774.Vl_Event7_Count_;
    __EE1379774.Vl_Event30_Count_;
    __EE1379774.Vl_Event365_Count_;
    __EE1379774.Vl_Event7_Active_Flag_;
    __EE1379774.Vl_Event30_Active_Flag_;
    __EE1379774.Date_First_Seen_;
    __EE1379774.Date_Last_Seen_;
    __EE1379774.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1379774,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1379776_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST32058_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
