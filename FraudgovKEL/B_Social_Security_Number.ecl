...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE2162885 := __ENH_Social_Security_Number_1;
  SHARED __EE2166501 := __ENH_Event_1;
  SHARED __EE2166499 := __E_Ssn_Event;
  SHARED __EE2207123 := __EE2166499(__NN(__EE2166499.Social_) AND __NN(__EE2166499.Transaction_));
  SHARED __ST2199684_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2207141(B_Event_1.__ST52980_Layout __EE2166501, E_Ssn_Event.Layout __EE2207123) := __EEQP(__EE2207123.Transaction_,__EE2166501.UID);
  __ST2199684_Layout __JT2207141(B_Event_1.__ST52980_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2207142 := JOIN(__EE2207123,__EE2166501,__JC2207141(RIGHT,LEFT),__JT2207141(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2196818_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2196818_Layout __ND2207674__Project(__ST2199684_Layout __PP2207143) := TRANSFORM
    SELF.UID := __PP2207143.Social_;
    SELF._r_Customer_ := __PP2207143._r_Customer__1_;
    SELF.Event_Date_ := __PP2207143.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2207143.UID;
    SELF.Event_Date__1_ := __PP2207143.Event_Date_;
    SELF._r_Customer__1_ := __PP2207143._r_Customer_;
    SELF := __PP2207143;
  END;
  SHARED __EE2209763 := PROJECT(__EE2207142,__ND2207674__Project(LEFT));
  SHARED __ST2197937_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2197937_Layout __ND2210472__Project(__ST2196818_Layout __PP2209764) := TRANSFORM
    SELF.Exp1_ := __PP2209764.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2209764.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP2209764.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP2209764.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP2209764.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP2209764.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP2209764.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP2209764.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP2209764.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP2209764.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP2209764.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP2209764.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP2209764.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP2209764.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP2209764.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP2209764.Event_Age_,<,__CN(2)),__CN(__PP2209764.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP2209764.Event_Age_,<,__CN(366));
    SELF := __PP2209764;
  END;
  SHARED __EE2210499 := PROJECT(__EE2209763,__ND2210472__Project(LEFT));
  SHARED __ST2198040_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2210608 := PROJECT(__CLEANANDDO(__EE2210499,TABLE(__EE2210499,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2210499.Exp1_),KEL.Aggregates.MinNG(__EE2210499.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2210499.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2210499.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2210499.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2210499.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2210499.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2210499.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2210499.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2210499.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2210499.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2210499.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2210499.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2210499.Exp13_),KEL.Aggregates.MaxNG(__EE2210499.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2210499.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2210499.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2210499.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2210499.Exp17_)),UID},UID,MERGE)),__ST2198040_Layout);
  SHARED __ST2202317_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2210614(B_Social_Security_Number_1.__ST55384_Layout __EE2162885, __ST2198040_Layout __EE2210608) := __EEQP(__EE2162885.UID,__EE2210608.UID);
  __ST2202317_Layout __JT2210614(B_Social_Security_Number_1.__ST55384_Layout __l, __ST2198040_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2210678 := JOIN(__EE2162885,__EE2210608,__JC2210614(LEFT,RIGHT),__JT2210614(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2152736 := __ENH_Customer_1;
  SHARED __ST2202738_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2210684(__ST2202317_Layout __EE2210678, B_Customer_1.__ST47427_Layout __EE2152736) := __EEQP(__EE2210678._r_Customer_,__EE2152736.UID);
  __ST2202738_Layout __JT2210684(__ST2202317_Layout __l, B_Customer_1.__ST47427_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2210770 := JOIN(__EE2210678,__EE2152736,__JC2210684(LEFT,RIGHT),__JT2210684(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46525_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46525_Layout __ND2210775__Project(__ST2202738_Layout __PP2210771) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2210771.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP2210771.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP2210771.Identity_Count_ > 2=>1,0);
    __BS2210919 := __T(__PP2210771.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2210919(__T(__OP2(__T(__PP2210771.Source_Customers_)._r_Source_Customer_,=,__PP2210771._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2210771.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP2210771.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2210771.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2210771.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2210771.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2210771.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2210771.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2210771.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2210771.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2210771.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2210771.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2210771;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE2210770,__ND2210775__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE2343905 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2343905._r_Customer_;
    __EE2343905.Source_Customers_;
    __EE2343905.Ssn_;
    __EE2343905.Otto_S_S_N_Id_;
    __EE2343905.Ssn_Formatted_;
    __EE2343905._v2__divssnidentitycountnew_;
    __EE2343905.Deceased_Date_;
    __EE2343905.Deceased_Date_Of_Birth_;
    __EE2343905.Deceased_First_;
    __EE2343905.Deceased_Middle_;
    __EE2343905.Deceased_Last_;
    __EE2343905.Deceased_Match_Code_;
    __EE2343905._isdeepdive_;
    __EE2343905._county__death_;
    __EE2343905.Deceased_Ssn_;
    __EE2343905._state__death__flag_;
    __EE2343905._death__rec__src_;
    __EE2343905._state__death__id_;
    __EE2343905.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE2343905.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2343905.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE2343905.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE2343905.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2343905.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2343905.Customer_Id_;
    __EE2343905.Industry_Type_;
    __EE2343905.Source_Customer_Count_;
    __EE2343905.Entity_Context_Uid_;
    __EE2343905.Entity_Type_;
    __EE2343905.Label_;
    __EE2343905.In_Customer_Population_;
    __EE2343905.Dt_First_Seen_;
    __EE2343905.Dt_Last_Seen_;
    __EE2343905.Last_Record_Id_;
    __EE2343905.Identity_Count_;
    __EE2343905.Identity_Count_Gt2_;
    __EE2343905.Event_Count_;
    __EE2343905.Kr_High_Risk_Flag_;
    __EE2343905.Kr_Medium_Risk_Flag_;
    __EE2343905.Kr_Low_Risk_Flag_;
    __EE2343905.Kr_Flag_;
    __EE2343905.Safe_Flag_;
    __EE2343905.Contributor_Safe_Flag_;
    __EE2343905.Last_Event_Date_;
    __EE2343905.Kr_Last_Event_Date_;
    __EE2343905.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2343905.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2343905.Kr_Ssn100_Flag_;
    __EE2343905.Kr_Ssn101_Flag_;
    __EE2343905.Kr_Ssn103_Flag_;
    __EE2343905.Kr_Ssn104_Flag_;
    __EE2343905.Kr_Ssn105_Flag_;
    __EE2343905.Kr_Ssn190_Flag_;
    __EE2343905.Kr_Ssn191_Flag_;
    __EE2343905.Kr_Ssn192_Flag_;
    __EE2343905.Kr_Ssn193_Flag_;
    __EE2343905.Vl_Event1_All_Count_;
    __EE2343905.Vl_Event7_All_Count_;
    __EE2343905.Vl_Event30_All_Day_Count_;
    __EE2343905.Vl_Event365_All_Day_Count_;
    __EE2343905.Vl_Event7_All_Active_Flag_;
    __EE2343905.Vl_Event30_All_Active_Flag_;
    __EE2343905.Vl_Event1_Count_;
    __EE2343905.Vl_Event7_Count_;
    __EE2343905.Vl_Event30_Count_;
    __EE2343905.Vl_Event365_Count_;
    __EE2343905.Vl_Event7_Active_Flag_;
    __EE2343905.Vl_Event30_Active_Flag_;
    __EE2343905.Date_First_Seen_;
    __EE2343905.Date_Last_Seen_;
    __EE2343905.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE2343905,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2343907_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST46525_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
