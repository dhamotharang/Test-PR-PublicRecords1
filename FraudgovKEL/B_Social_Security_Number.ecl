...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE3982417 := __ENH_Social_Security_Number_1;
  SHARED __EE3986658 := __ENH_Event_1;
  SHARED __EE3986656 := __E_Ssn_Event;
  SHARED __EE4033309 := __EE3986656(__NN(__EE3986656.Social_) AND __NN(__EE3986656.Transaction_));
  SHARED __ST4024415_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4033327(B_Event_1.__ST77589_Layout __EE3986658, E_Ssn_Event.Layout __EE4033309) := __EEQP(__EE4033309.Transaction_,__EE3986658.UID);
  __ST4024415_Layout __JT4033327(B_Event_1.__ST77589_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4033328 := JOIN(__EE4033309,__EE3986658,__JC4033327(RIGHT,LEFT),__JT4033327(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4021021_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4021021_Layout __ND4034002__Project(__ST4024415_Layout __PP4033329) := TRANSFORM
    SELF.UID := __PP4033329.Social_;
    SELF._r_Customer_ := __PP4033329._r_Customer__1_;
    SELF.Event_Date_ := __PP4033329.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4033329.UID;
    SELF.Event_Date__1_ := __PP4033329.Event_Date_;
    SELF._r_Customer__1_ := __PP4033329._r_Customer_;
    SELF := __PP4033329;
  END;
  SHARED __EE4036659 := PROJECT(__EE4033328,__ND4034002__Project(LEFT));
  SHARED __ST4022417_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4022417_Layout __ND4036664__Project(__ST4021021_Layout __PP4036660) := TRANSFORM
    SELF.Exp1_ := __PP4036660.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4036660.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4036660.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4036660.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP4036660.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP4036660.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp6_ := __PP4036660.Kr_Ssn100_Flag_ = 1;
    SELF.Exp7_ := __PP4036660.Kr_Ssn101_Flag_ = 1;
    SELF.Exp8_ := __PP4036660.Kr_Ssn103_Flag_ = 1;
    SELF.Exp9_ := __PP4036660.Kr_Ssn104_Flag_ = 1;
    SELF.Exp10_ := __PP4036660.Kr_Ssn105_Flag_ = 1;
    SELF.Exp11_ := __PP4036660.Kr_Ssn190_Flag_ = 1;
    SELF.Exp12_ := __PP4036660.Kr_Ssn191_Flag_ = 1;
    SELF.Exp13_ := __PP4036660.Kr_Ssn192_Flag_ = 1;
    SELF.Exp14_ := __PP4036660.Kr_Ssn193_Flag_ = 1;
    SELF.Exp15_ := __PP4036660.Safe_Flag_ = 1;
    SELF := __PP4036660;
  END;
  SHARED __EE4036751 := PROJECT(__EE4036659,__ND4036664__Project(LEFT));
  SHARED __ST4022510_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4036847 := PROJECT(__CLEANANDDO(__EE4036751,TABLE(__EE4036751,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4036751.Exp1_),KEL.Aggregates.MinNG(__EE4036751.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4036751.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4036751.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4036751.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4036751.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4036751.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4036751.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4036751.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4036751.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4036751.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4036751.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4036751.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4036751.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4036751.Exp14_),KEL.Aggregates.MaxNG(__EE4036751.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4036751.Exp15_),UID},UID,MERGE)),__ST4022510_Layout);
  SHARED __ST4027758_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4036853(B_Social_Security_Number_1.__ST80601_Layout __EE3982417, __ST4022510_Layout __EE4036847) := __EEQP(__EE3982417.UID,__EE4036847.UID);
  __ST4027758_Layout __JT4036853(B_Social_Security_Number_1.__ST80601_Layout __l, __ST4022510_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4036854 := JOIN(__EE3982417,__EE4036847,__JC4036853(LEFT,RIGHT),__JT4036853(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3964923 := __ENH_Customer_1;
  SHARED __ST4028201_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4036931(__ST4027758_Layout __EE4036854, B_Customer_1.__ST69381_Layout __EE3964923) := __EEQP(__EE4036854._r_Customer_,__EE3964923.UID);
  __ST4028201_Layout __JT4036931(__ST4027758_Layout __l, B_Customer_1.__ST69381_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4036932 := JOIN(__EE4036854,__EE3964923,__JC4036931(LEFT,RIGHT),__JT4036931(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST68181_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST68181_Layout __ND4037377__Project(__ST4028201_Layout __PP4036933) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4036933.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP4036933.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4036933.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4036933.Identity_Count_ > 2=>1,0);
    __BS4037212 := __T(__PP4036933.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4037212(__T(__OP2(__T(__PP4036933.Source_Customers_)._r_Source_Customer_,=,__PP4036933._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4036933.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP4036933.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP4036933.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4036933.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4036933.Source_Customers_);
    SELF := __PP4036933;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE4036932,__ND4037377__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE4161269 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4161269._r_Customer_;
    __EE4161269.Source_Customers_;
    __EE4161269.Ssn_;
    __EE4161269.Otto_S_S_N_Id_;
    __EE4161269.Ssn_Formatted_;
    __EE4161269._v2__divssnidentitycountnew_;
    __EE4161269.Deceased_Date_;
    __EE4161269.Deceased_Date_Of_Birth_;
    __EE4161269.Deceased_First_;
    __EE4161269.Deceased_Middle_;
    __EE4161269.Deceased_Last_;
    __EE4161269.Deceased_Match_Code_;
    __EE4161269._isdeepdive_;
    __EE4161269._county__death_;
    __EE4161269.Deceased_Ssn_;
    __EE4161269._state__death__flag_;
    __EE4161269._death__rec__src_;
    __EE4161269._state__death__id_;
    __EE4161269.Aot_Act_Cnt_Ev_;
    __EE4161269.Aot_Src1_Act_Cnt_Ev_;
    __EE4161269.Aot_Src1_Act_Only_Flag_;
    __EE4161269.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE4161269.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4161269.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE4161269.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE4161269.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4161269.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4161269.Aot_Id_Act_Cnt_Ev_;
    __EE4161269.Aot_Id_Act_Cnt30_D_;
    __EE4161269.Aot_Add_Act_Cnt_Ev_;
    __EE4161269.Aot_Add_Act_Cnt30_D_;
    __EE4161269.Aot_Non_St_Act_Cnt_Ev_;
    __EE4161269.Aot_Non_St_Act_Cnt30_D_;
    __EE4161269.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4161269.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4161269.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4161269.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4161269.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4161269.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE4161269.Customer_Id_;
    __EE4161269.Industry_Type_;
    __EE4161269.Source_Customer_Count_;
    __EE4161269.Entity_Context_Uid_;
    __EE4161269.Entity_Type_;
    __EE4161269.Label_;
    __EE4161269.In_Customer_Population_;
    __EE4161269.Dt_First_Seen_;
    __EE4161269.Dt_Last_Seen_;
    __EE4161269.Id_Activity_Dt_First_Seen_;
    __EE4161269.Id_Activity_Dt_Last_Seen_;
    __EE4161269.Last_Record_Id_;
    __EE4161269.Identity_Count_;
    __EE4161269.Identity_Count_Gt2_;
    __EE4161269.Event_Count_;
    __EE4161269.Kr_High_Risk_Flag_;
    __EE4161269.Kr_Medium_Risk_Flag_;
    __EE4161269.Kr_Low_Risk_Flag_;
    __EE4161269.Kr_Flag_;
    __EE4161269.Safe_Flag_;
    __EE4161269.Contributor_Safe_Flag_;
    __EE4161269.Last_Event_Date_;
    __EE4161269.Kr_Last_Event_Date_;
    __EE4161269.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4161269.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4161269.Kr_Ssn100_Flag_;
    __EE4161269.Kr_Ssn101_Flag_;
    __EE4161269.Kr_Ssn103_Flag_;
    __EE4161269.Kr_Ssn104_Flag_;
    __EE4161269.Kr_Ssn105_Flag_;
    __EE4161269.Kr_Ssn190_Flag_;
    __EE4161269.Kr_Ssn191_Flag_;
    __EE4161269.Kr_Ssn192_Flag_;
    __EE4161269.Kr_Ssn193_Flag_;
    __EE4161269.Date_First_Seen_;
    __EE4161269.Date_Last_Seen_;
    __EE4161269.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE4161269,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4161271_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST68181_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
