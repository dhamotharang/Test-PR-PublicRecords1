...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1194560 := __ENH_Social_Security_Number_1;
  SHARED __EE1197676 := __ENH_Event_1;
  SHARED __EE1197674 := __E_Ssn_Event;
  SHARED __EE1236952 := __EE1197674(__NN(__EE1197674.Social_) AND __NN(__EE1197674.Transaction_));
  SHARED __ST1230653_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1236970(B_Event_1.__ST35904_Layout __EE1197676, E_Ssn_Event.Layout __EE1236952) := __EEQP(__EE1236952.Transaction_,__EE1197676.UID);
  __ST1230653_Layout __JT1236970(B_Event_1.__ST35904_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1236971 := JOIN(__EE1236952,__EE1197676,__JC1236970(RIGHT,LEFT),__JT1236970(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1228125_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1228125_Layout __ND1237364__Project(__ST1230653_Layout __PP1236972) := TRANSFORM
    SELF.UID := __PP1236972.Social_;
    SELF._r_Customer_ := __PP1236972._r_Customer__1_;
    SELF.Event_Date_ := __PP1236972.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1236972.UID;
    SELF.Event_Date__1_ := __PP1236972.Event_Date_;
    SELF._r_Customer__1_ := __PP1236972._r_Customer_;
    SELF := __PP1236972;
  END;
  SHARED __EE1238889 := PROJECT(__EE1236971,__ND1237364__Project(LEFT));
  SHARED __ST1228993_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1228993_Layout __ND1239696__Project(__ST1228125_Layout __PP1238890) := TRANSFORM
    SELF.Exp1_ := __PP1238890.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1238890.Hri06_Flag_ = 1;
    SELF.Exp3_ := __PP1238890.Hri26_Flag_ = 1;
    SELF.Exp4_ := __PP1238890.Hri29_Flag_ = 1;
    SELF.Exp5_ := __PP1238890.Hri38_Flag_ = 1;
    SELF.Exp6_ := __PP1238890.Hri71_Flag_ = 1;
    SELF.Exp7_ := __PP1238890.Hri_It_Flag_ = 1;
    SELF.Exp8_ := __PP1238890.Hri_Mi_Flag_ = 1;
    SELF.Exp9_ := __PP1238890.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp10_ := __PP1238890.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp11_ := __PP1238890.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp12_ := __PP1238890.Kr_Ssn100_Flag_ = 1;
    SELF.Exp13_ := __PP1238890.Kr_Ssn101_Flag_ = 1;
    SELF.Exp14_ := __PP1238890.Kr_Ssn103_Flag_ = 1;
    SELF.Exp15_ := __PP1238890.Kr_Ssn104_Flag_ = 1;
    SELF.Exp16_ := __PP1238890.Kr_Ssn105_Flag_ = 1;
    SELF.Exp17_ := __PP1238890.Kr_Ssn190_Flag_ = 1;
    SELF.Exp18_ := __PP1238890.Kr_Ssn191_Flag_ = 1;
    SELF.Exp19_ := __PP1238890.Kr_Ssn192_Flag_ = 1;
    SELF.Exp20_ := __PP1238890.Kr_Ssn193_Flag_ = 1;
    SELF.Exp21_ := __PP1238890.Safe_Flag_ = 1;
    SELF.Exp22_ := __OP2(__PP1238890.Event_Age_,<,__CN(2));
    SELF.Exp23_ := __AND(__OP2(__PP1238890.Event_Age_,<,__CN(2)),__CN(__PP1238890.In_Customer_Population_ = 1));
    SELF.Exp24_ := __OP2(__PP1238890.Event_Age_,<,__CN(366));
    SELF := __PP1238890;
  END;
  SHARED __EE1239730 := PROJECT(__EE1238889,__ND1239696__Project(LEFT));
  SHARED __ST1229134_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1239879 := PROJECT(__CLEANANDDO(__EE1239730,TABLE(__EE1239730,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1239730.Exp1_),KEL.Aggregates.MinNG(__EE1239730.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1239730.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1239730.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1239730.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1239730.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1239730.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1239730.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1239730.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1239730.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1239730.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1239730.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1239730.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1239730.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1239730.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1239730.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1239730.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1239730.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1239730.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1239730.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1239730.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1239730.Exp20_),KEL.Aggregates.MaxNG(__EE1239730.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1239730.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__T(__EE1239730.Exp22_)),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__T(__EE1239730.Exp23_)),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__T(__EE1239730.Exp24_)),UID},UID,MERGE)),__ST1229134_Layout);
  SHARED __ST1232585_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1239885(B_Social_Security_Number_1.__ST37438_Layout __EE1194560, __ST1229134_Layout __EE1239879) := __EEQP(__EE1194560.UID,__EE1239879.UID);
  __ST1232585_Layout __JT1239885(B_Social_Security_Number_1.__ST37438_Layout __l, __ST1229134_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1239952 := JOIN(__EE1194560,__EE1239879,__JC1239885(LEFT,RIGHT),__JT1239885(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1182926 := __ENH_Customer_1;
  SHARED __ST1233026_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1239958(__ST1232585_Layout __EE1239952, B_Customer_1.__ST32882_Layout __EE1182926) := __EEQP(__EE1239952._r_Customer_,__EE1182926.UID);
  __ST1233026_Layout __JT1239958(__ST1232585_Layout __l, B_Customer_1.__ST32882_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1240047 := JOIN(__EE1239952,__EE1182926,__JC1239958(LEFT,RIGHT),__JT1239958(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST32196_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32196_Layout __ND1240052__Project(__ST1233026_Layout __PP1240048) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1240048.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1240048.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Hri06_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri26_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri29_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri38_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri71_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_It_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1240048.Identity_Count_ > 2=>1,0);
    __BS1240211 := __T(__PP1240048.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1240211(__T(__OP2(__T(__PP1240048.Source_Customers_)._r_Source_Customer_,=,__PP1240048._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1240048.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1240048.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1240048.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1240048.C_O_U_N_T___Exp1__21_;
    SELF.Vl_Event1_Count_ := __PP1240048.C_O_U_N_T___Exp1__22_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1240048.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1240048.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1240048.C_O_U_N_T___Exp1__23_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1240048.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1240048.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1240048;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1240047,__ND1240052__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1387777 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1387777._r_Customer_;
    __EE1387777.Source_Customers_;
    __EE1387777.Ssn_;
    __EE1387777.Otto_S_S_N_Id_;
    __EE1387777.Ssn_Formatted_;
    __EE1387777._v2__divssnidentitycountnew_;
    __EE1387777.Deceased_Date_;
    __EE1387777.Deceased_Date_Of_Birth_;
    __EE1387777.Deceased_First_;
    __EE1387777.Deceased_Middle_;
    __EE1387777.Deceased_Last_;
    __EE1387777.Deceased_Match_Code_;
    __EE1387777._isdeepdive_;
    __EE1387777._county__death_;
    __EE1387777.Deceased_Ssn_;
    __EE1387777._state__death__flag_;
    __EE1387777._death__rec__src_;
    __EE1387777._state__death__id_;
    __EE1387777.Customer_Id_;
    __EE1387777.Industry_Type_;
    __EE1387777.Source_Customer_Count_;
    __EE1387777.Entity_Context_Uid_;
    __EE1387777.Entity_Type_;
    __EE1387777.Label_;
    __EE1387777.In_Customer_Population_;
    __EE1387777.Dt_First_Seen_;
    __EE1387777.Dt_Last_Seen_;
    __EE1387777.Last_Record_Id_;
    __EE1387777.Identity_Count_;
    __EE1387777.Identity_Count_Gt2_;
    __EE1387777.Event_Count_;
    __EE1387777.Hri06_Flag_;
    __EE1387777.Hri26_Flag_;
    __EE1387777.Hri29_Flag_;
    __EE1387777.Hri38_Flag_;
    __EE1387777.Hri71_Flag_;
    __EE1387777.Hri_It_Flag_;
    __EE1387777.Hri_Mi_Flag_;
    __EE1387777.Kr_High_Risk_Flag_;
    __EE1387777.Kr_Medium_Risk_Flag_;
    __EE1387777.Kr_Low_Risk_Flag_;
    __EE1387777.Kr_Flag_;
    __EE1387777.Safe_Flag_;
    __EE1387777.Contributor_Safe_Flag_;
    __EE1387777.Last_Event_Date_;
    __EE1387777.Kr_Last_Event_Date_;
    __EE1387777.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1387777.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1387777.Kr_Ssn100_Flag_;
    __EE1387777.Kr_Ssn101_Flag_;
    __EE1387777.Kr_Ssn103_Flag_;
    __EE1387777.Kr_Ssn104_Flag_;
    __EE1387777.Kr_Ssn105_Flag_;
    __EE1387777.Kr_Ssn190_Flag_;
    __EE1387777.Kr_Ssn191_Flag_;
    __EE1387777.Kr_Ssn192_Flag_;
    __EE1387777.Kr_Ssn193_Flag_;
    __EE1387777.Vl_Event1_All_Count_;
    __EE1387777.Vl_Event7_All_Count_;
    __EE1387777.Vl_Event30_All_Day_Count_;
    __EE1387777.Vl_Event365_All_Day_Count_;
    __EE1387777.Vl_Event7_All_Active_Flag_;
    __EE1387777.Vl_Event30_All_Active_Flag_;
    __EE1387777.Vl_Event1_Count_;
    __EE1387777.Vl_Event7_Count_;
    __EE1387777.Vl_Event30_Count_;
    __EE1387777.Vl_Event365_Count_;
    __EE1387777.Vl_Event7_Active_Flag_;
    __EE1387777.Vl_Event30_Active_Flag_;
    __EE1387777.Date_First_Seen_;
    __EE1387777.Date_Last_Seen_;
    __EE1387777.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1387777,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1387779_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST32196_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
