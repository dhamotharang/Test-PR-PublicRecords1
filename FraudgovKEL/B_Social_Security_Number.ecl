...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE2216757 := __ENH_Social_Security_Number_1;
  SHARED __EE2220438 := __ENH_Event_1;
  SHARED __EE2220436 := __E_Ssn_Event;
  SHARED __EE2261983 := __EE2220436(__NN(__EE2220436.Social_) AND __NN(__EE2220436.Transaction_));
  SHARED __ST2254414_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2262001(B_Event_1.__ST53045_Layout __EE2220438, E_Ssn_Event.Layout __EE2261983) := __EEQP(__EE2261983.Transaction_,__EE2220438.UID);
  __ST2254414_Layout __JT2262001(B_Event_1.__ST53045_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2262002 := JOIN(__EE2261983,__EE2220438,__JC2262001(RIGHT,LEFT),__JT2262001(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2251496_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2251496_Layout __ND2262547__Project(__ST2254414_Layout __PP2262003) := TRANSFORM
    SELF.UID := __PP2262003.Social_;
    SELF._r_Customer_ := __PP2262003._r_Customer__1_;
    SELF.Event_Date_ := __PP2262003.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2262003.UID;
    SELF.Event_Date__1_ := __PP2262003.Event_Date_;
    SELF._r_Customer__1_ := __PP2262003._r_Customer_;
    SELF := __PP2262003;
  END;
  SHARED __EE2264688 := PROJECT(__EE2262002,__ND2262547__Project(LEFT));
  SHARED __ST2252641_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2252641_Layout __ND2265397__Project(__ST2251496_Layout __PP2264689) := TRANSFORM
    SELF.Exp1_ := __PP2264689.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2264689.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP2264689.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP2264689.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP2264689.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP2264689.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP2264689.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP2264689.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP2264689.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP2264689.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP2264689.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP2264689.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP2264689.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP2264689.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP2264689.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP2264689.Event_Age_,<,__CN(2)),__CN(__PP2264689.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP2264689.Event_Age_,<,__CN(366));
    SELF := __PP2264689;
  END;
  SHARED __EE2265424 := PROJECT(__EE2264688,__ND2265397__Project(LEFT));
  SHARED __ST2252744_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2265533 := PROJECT(__CLEANANDDO(__EE2265424,TABLE(__EE2265424,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2265424.Exp1_),KEL.Aggregates.MinNG(__EE2265424.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2265424.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2265424.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2265424.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2265424.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2265424.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2265424.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2265424.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2265424.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2265424.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2265424.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2265424.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2265424.Exp13_),KEL.Aggregates.MaxNG(__EE2265424.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2265424.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2265424.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2265424.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2265424.Exp17_)),UID},UID,MERGE)),__ST2252744_Layout);
  SHARED __ST2257112_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2265539(B_Social_Security_Number_1.__ST55462_Layout __EE2216757, __ST2252744_Layout __EE2265533) := __EEQP(__EE2216757.UID,__EE2265533.UID);
  __ST2257112_Layout __JT2265539(B_Social_Security_Number_1.__ST55462_Layout __l, __ST2252744_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2265603 := JOIN(__EE2216757,__EE2265533,__JC2265539(LEFT,RIGHT),__JT2265539(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2206400 := __ENH_Customer_1;
  SHARED __ST2257533_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2265609(__ST2257112_Layout __EE2265603, B_Customer_1.__ST47479_Layout __EE2206400) := __EEQP(__EE2265603._r_Customer_,__EE2206400.UID);
  __ST2257533_Layout __JT2265609(__ST2257112_Layout __l, B_Customer_1.__ST47479_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2265695 := JOIN(__EE2265603,__EE2206400,__JC2265609(LEFT,RIGHT),__JT2265609(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46577_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46577_Layout __ND2265700__Project(__ST2257533_Layout __PP2265696) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2265696.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP2265696.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP2265696.Identity_Count_ > 2=>1,0);
    __BS2265844 := __T(__PP2265696.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2265844(__T(__OP2(__T(__PP2265696.Source_Customers_)._r_Source_Customer_,=,__PP2265696._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2265696.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP2265696.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2265696.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2265696.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2265696.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2265696.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2265696.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2265696.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2265696.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2265696.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2265696.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2265696;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE2265695,__ND2265700__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE2398869 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2398869._r_Customer_;
    __EE2398869.Source_Customers_;
    __EE2398869.Ssn_;
    __EE2398869.Otto_S_S_N_Id_;
    __EE2398869.Ssn_Formatted_;
    __EE2398869._v2__divssnidentitycountnew_;
    __EE2398869.Deceased_Date_;
    __EE2398869.Deceased_Date_Of_Birth_;
    __EE2398869.Deceased_First_;
    __EE2398869.Deceased_Middle_;
    __EE2398869.Deceased_Last_;
    __EE2398869.Deceased_Match_Code_;
    __EE2398869._isdeepdive_;
    __EE2398869._county__death_;
    __EE2398869.Deceased_Ssn_;
    __EE2398869._state__death__flag_;
    __EE2398869._death__rec__src_;
    __EE2398869._state__death__id_;
    __EE2398869.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE2398869.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2398869.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE2398869.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE2398869.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2398869.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2398869.Customer_Id_;
    __EE2398869.Industry_Type_;
    __EE2398869.Source_Customer_Count_;
    __EE2398869.Entity_Context_Uid_;
    __EE2398869.Entity_Type_;
    __EE2398869.Label_;
    __EE2398869.In_Customer_Population_;
    __EE2398869.Dt_First_Seen_;
    __EE2398869.Dt_Last_Seen_;
    __EE2398869.Last_Record_Id_;
    __EE2398869.Identity_Count_;
    __EE2398869.Identity_Count_Gt2_;
    __EE2398869.Event_Count_;
    __EE2398869.Kr_High_Risk_Flag_;
    __EE2398869.Kr_Medium_Risk_Flag_;
    __EE2398869.Kr_Low_Risk_Flag_;
    __EE2398869.Kr_Flag_;
    __EE2398869.Safe_Flag_;
    __EE2398869.Contributor_Safe_Flag_;
    __EE2398869.Last_Event_Date_;
    __EE2398869.Kr_Last_Event_Date_;
    __EE2398869.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2398869.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2398869.Kr_Ssn100_Flag_;
    __EE2398869.Kr_Ssn101_Flag_;
    __EE2398869.Kr_Ssn103_Flag_;
    __EE2398869.Kr_Ssn104_Flag_;
    __EE2398869.Kr_Ssn105_Flag_;
    __EE2398869.Kr_Ssn190_Flag_;
    __EE2398869.Kr_Ssn191_Flag_;
    __EE2398869.Kr_Ssn192_Flag_;
    __EE2398869.Kr_Ssn193_Flag_;
    __EE2398869.Vl_Event1_All_Count_;
    __EE2398869.Vl_Event7_All_Count_;
    __EE2398869.Vl_Event30_All_Day_Count_;
    __EE2398869.Vl_Event365_All_Day_Count_;
    __EE2398869.Vl_Event7_All_Active_Flag_;
    __EE2398869.Vl_Event30_All_Active_Flag_;
    __EE2398869.Vl_Event1_Count_;
    __EE2398869.Vl_Event7_Count_;
    __EE2398869.Vl_Event30_Count_;
    __EE2398869.Vl_Event365_Count_;
    __EE2398869.Vl_Event7_Active_Flag_;
    __EE2398869.Vl_Event30_Active_Flag_;
    __EE2398869.Date_First_Seen_;
    __EE2398869.Date_Last_Seen_;
    __EE2398869.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE2398869,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2398871_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST46577_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
