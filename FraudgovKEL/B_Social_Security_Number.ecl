...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE4532346 := __ENH_Social_Security_Number_1;
  SHARED __EE4536715 := __ENH_Event_1;
  SHARED __EE4536713 := __E_Ssn_Event;
  SHARED __EE4585368 := __EE4536713(__NN(__EE4536713.Social_) AND __NN(__EE4536713.Transaction_));
  SHARED __ST4576084_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4585386(B_Event_1.__ST80086_Layout __EE4536715, E_Ssn_Event.Layout __EE4585368) := __EEQP(__EE4585368.Transaction_,__EE4536715.UID);
  __ST4576084_Layout __JT4585386(B_Event_1.__ST80086_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4585387 := JOIN(__EE4585368,__EE4536715,__JC4585386(RIGHT,LEFT),__JT4585386(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4572470_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4572470_Layout __ND4586113__Project(__ST4576084_Layout __PP4585388) := TRANSFORM
    SELF.UID := __PP4585388.Social_;
    SELF._r_Customer_ := __PP4585388._r_Customer__1_;
    SELF.Event_Date_ := __PP4585388.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4585388.UID;
    SELF.Event_Date__1_ := __PP4585388.Event_Date_;
    SELF._r_Customer__1_ := __PP4585388._r_Customer_;
    SELF := __PP4585388;
  END;
  SHARED __EE4588906 := PROJECT(__EE4585387,__ND4586113__Project(LEFT));
  SHARED __ST4573982_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4573982_Layout __ND4588911__Project(__ST4572470_Layout __PP4588907) := TRANSFORM
    SELF.Exp1_ := __PP4588907.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4588907.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4588907.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4588907.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP4588907.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP4588907.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp6_ := __PP4588907.Kr_Ssn100_Flag_ = 1;
    SELF.Exp7_ := __PP4588907.Kr_Ssn101_Flag_ = 1;
    SELF.Exp8_ := __PP4588907.Kr_Ssn103_Flag_ = 1;
    SELF.Exp9_ := __PP4588907.Kr_Ssn104_Flag_ = 1;
    SELF.Exp10_ := __PP4588907.Kr_Ssn105_Flag_ = 1;
    SELF.Exp11_ := __PP4588907.Kr_Ssn190_Flag_ = 1;
    SELF.Exp12_ := __PP4588907.Kr_Ssn191_Flag_ = 1;
    SELF.Exp13_ := __PP4588907.Kr_Ssn192_Flag_ = 1;
    SELF.Exp14_ := __PP4588907.Kr_Ssn193_Flag_ = 1;
    SELF.Exp15_ := __PP4588907.Safe_Flag_ = 1;
    SELF := __PP4588907;
  END;
  SHARED __EE4588998 := PROJECT(__EE4588906,__ND4588911__Project(LEFT));
  SHARED __ST4574075_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4589094 := PROJECT(__CLEANANDDO(__EE4588998,TABLE(__EE4588998,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4588998.Exp1_),KEL.Aggregates.MinNG(__EE4588998.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4588998.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4588998.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4588998.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4588998.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4588998.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4588998.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4588998.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4588998.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4588998.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4588998.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4588998.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4588998.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4588998.Exp14_),KEL.Aggregates.MaxNG(__EE4588998.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4588998.Exp15_),UID},UID,MERGE)),__ST4574075_Layout);
  SHARED __ST4579627_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4589100(B_Social_Security_Number_1.__ST83022_Layout __EE4532346, __ST4574075_Layout __EE4589094) := __EEQP(__EE4532346.UID,__EE4589094.UID);
  __ST4579627_Layout __JT4589100(B_Social_Security_Number_1.__ST83022_Layout __l, __ST4574075_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4589101 := JOIN(__EE4532346,__EE4589094,__JC4589100(LEFT,RIGHT),__JT4589100(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4514108 := __ENH_Customer_1;
  SHARED __ST4580070_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4589178(__ST4579627_Layout __EE4589101, B_Customer_1.__ST71756_Layout __EE4514108) := __EEQP(__EE4589101._r_Customer_,__EE4514108.UID);
  __ST4580070_Layout __JT4589178(__ST4579627_Layout __l, B_Customer_1.__ST71756_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4589179 := JOIN(__EE4589101,__EE4514108,__JC4589178(LEFT,RIGHT),__JT4589178(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST70613_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST70613_Layout __ND4589625__Project(__ST4580070_Layout __PP4589180) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4589180.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP4589180.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4589180.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4589180.Identity_Count_ > 2=>1,0);
    __BS4589460 := __T(__PP4589180.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4589460(__T(__OP2(__T(__PP4589180.Source_Customers_)._r_Source_Customer_,=,__PP4589180._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4589180.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP4589180.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP4589180.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4589180.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4589180.Source_Customers_);
    SELF := __PP4589180;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE4589179,__ND4589625__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE4712858 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4712858._r_Customer_;
    __EE4712858.Source_Customers_;
    __EE4712858.Ssn_;
    __EE4712858.Otto_S_S_N_Id_;
    __EE4712858.Ssn_Formatted_;
    __EE4712858._v2__divssnidentitycountnew_;
    __EE4712858.Deceased_Date_;
    __EE4712858.Deceased_Date_Of_Birth_;
    __EE4712858.Deceased_First_;
    __EE4712858.Deceased_Middle_;
    __EE4712858.Deceased_Last_;
    __EE4712858.Deceased_Match_Code_;
    __EE4712858._isdeepdive_;
    __EE4712858._county__death_;
    __EE4712858.Deceased_Ssn_;
    __EE4712858._state__death__flag_;
    __EE4712858._death__rec__src_;
    __EE4712858._state__death__id_;
    __EE4712858.Aot_Act_Cnt_Ev_;
    __EE4712858.Aot_Src1_Act_Cnt_Ev_;
    __EE4712858.Aot_Src1_Act_Only_Flag_;
    __EE4712858.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE4712858.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4712858.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE4712858.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE4712858.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4712858.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4712858.Aot_Id_Act_Cnt_Ev_;
    __EE4712858.Aot_Id_Act_Cnt30_D_;
    __EE4712858.Aot_Add_Act_Cnt_Ev_;
    __EE4712858.Aot_Add_Act_Cnt30_D_;
    __EE4712858.Aot_Non_St_Act_Cnt_Ev_;
    __EE4712858.Aot_Non_St_Act_Cnt30_D_;
    __EE4712858.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4712858.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4712858.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4712858.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4712858.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4712858.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE4712858.Customer_Id_;
    __EE4712858.Industry_Type_;
    __EE4712858.Source_Customer_Count_;
    __EE4712858.Entity_Context_Uid_;
    __EE4712858.Entity_Type_;
    __EE4712858.Label_;
    __EE4712858.In_Customer_Population_;
    __EE4712858.Dt_First_Seen_;
    __EE4712858.Dt_Last_Seen_;
    __EE4712858.Id_Activity_Dt_First_Seen_;
    __EE4712858.Id_Activity_Dt_Last_Seen_;
    __EE4712858.Last_Record_Id_;
    __EE4712858.Identity_Count_;
    __EE4712858.Identity_Count_Gt2_;
    __EE4712858.Event_Count_;
    __EE4712858.Kr_High_Risk_Flag_;
    __EE4712858.Kr_Medium_Risk_Flag_;
    __EE4712858.Kr_Low_Risk_Flag_;
    __EE4712858.Kr_Flag_;
    __EE4712858.Safe_Flag_;
    __EE4712858.Contributor_Safe_Flag_;
    __EE4712858.Last_Event_Date_;
    __EE4712858.Kr_Last_Event_Date_;
    __EE4712858.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4712858.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4712858.Kr_Ssn100_Flag_;
    __EE4712858.Kr_Ssn101_Flag_;
    __EE4712858.Kr_Ssn103_Flag_;
    __EE4712858.Kr_Ssn104_Flag_;
    __EE4712858.Kr_Ssn105_Flag_;
    __EE4712858.Kr_Ssn190_Flag_;
    __EE4712858.Kr_Ssn191_Flag_;
    __EE4712858.Kr_Ssn192_Flag_;
    __EE4712858.Kr_Ssn193_Flag_;
    __EE4712858.Date_First_Seen_;
    __EE4712858.Date_Last_Seen_;
    __EE4712858.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE4712858,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4712860_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST70613_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
