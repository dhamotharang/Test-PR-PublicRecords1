...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1138670 := __ENH_Social_Security_Number_1;
  SHARED __EE1141719 := __ENH_Event_1;
  SHARED __EE1141717 := __E_Ssn_Event;
  SHARED __EE1174510 := __EE1141717(__NN(__EE1141717.Social_) AND __NN(__EE1141717.Transaction_));
  SHARED __ST1168259_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1174528(B_Event_1.__ST33354_Layout __EE1141719, E_Ssn_Event.Layout __EE1174510) := __EEQP(__EE1174510.Transaction_,__EE1141719.UID);
  __ST1168259_Layout __JT1174528(B_Event_1.__ST33354_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1174529 := JOIN(__EE1174510,__EE1141719,__JC1174528(RIGHT,LEFT),__JT1174528(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1165823_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1165823_Layout __ND1174952__Project(__ST1168259_Layout __PP1174530) := TRANSFORM
    SELF.UID := __PP1174530.Social_;
    SELF._r_Customer_ := __PP1174530._r_Customer__1_;
    SELF.Event_Date_ := __PP1174530.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1174530.UID;
    SELF.Event_Date__1_ := __PP1174530.Event_Date_;
    SELF._r_Customer__1_ := __PP1174530._r_Customer_;
    SELF := __PP1174530;
  END;
  SHARED __EE1176605 := PROJECT(__EE1174529,__ND1174952__Project(LEFT));
  SHARED __ST1166728_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1166728_Layout __ND1177283__Project(__ST1165823_Layout __PP1176606) := TRANSFORM
    SELF.Exp1_ := __PP1176606.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1176606.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP1176606.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP1176606.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP1176606.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP1176606.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP1176606.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP1176606.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP1176606.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP1176606.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP1176606.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP1176606.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP1176606.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP1176606.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP1176606.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP1176606.Event_Age_,<,__CN(2)),__CN(__PP1176606.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP1176606.Event_Age_,<,__CN(366));
    SELF := __PP1176606;
  END;
  SHARED __EE1177310 := PROJECT(__EE1176605,__ND1177283__Project(LEFT));
  SHARED __ST1166834_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1177424 := PROJECT(__CLEANANDDO(__EE1177310,TABLE(__EE1177310,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1177310.Exp1_),KEL.Aggregates.MinNG(__EE1177310.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1177310.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1177310.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1177310.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1177310.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1177310.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1177310.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1177310.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1177310.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1177310.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1177310.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1177310.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1177310.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1177310.Exp13_),KEL.Aggregates.MaxNG(__EE1177310.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1177310.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1177310.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1177310.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE1177310.Exp17_)),UID},UID,MERGE)),__ST1166834_Layout);
  SHARED __ST1170347_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1177430(B_Social_Security_Number_1.__ST34772_Layout __EE1138670, __ST1166834_Layout __EE1177424) := __EEQP(__EE1138670.UID,__EE1177424.UID);
  __ST1170347_Layout __JT1177430(B_Social_Security_Number_1.__ST34772_Layout __l, __ST1166834_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1177488 := JOIN(__EE1138670,__EE1177424,__JC1177430(LEFT,RIGHT),__JT1177430(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1126933 := __ENH_Customer_1;
  SHARED __ST1170738_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1177494(__ST1170347_Layout __EE1177488, B_Customer_1.__ST30513_Layout __EE1126933) := __EEQP(__EE1177488._r_Customer_,__EE1126933.UID);
  __ST1170738_Layout __JT1177494(__ST1170347_Layout __l, B_Customer_1.__ST30513_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1177574 := JOIN(__EE1177488,__EE1126933,__JC1177494(LEFT,RIGHT),__JT1177494(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST29899_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29899_Layout __ND1177579__Project(__ST1170738_Layout __PP1177575) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1177575.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1177575.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP1177575.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP1177575.Identity_Count_ > 2=>1,0);
    __BS1177705 := __T(__PP1177575.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1177705(__T(__OP2(__T(__PP1177575.Source_Customers_)._r_Source_Customer_,=,__PP1177575._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP1177575.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP1177575.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1177575.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1177575.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1177575.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP1177575.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1177575.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1177575.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1177575.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1177575.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1177575.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1177575;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1177574,__ND1177579__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1299223 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1299223._r_Customer_;
    __EE1299223.Source_Customers_;
    __EE1299223.Ssn_;
    __EE1299223.Otto_S_S_N_Id_;
    __EE1299223.Ssn_Formatted_;
    __EE1299223._v2__divssnidentitycountnew_;
    __EE1299223.Deceased_Date_;
    __EE1299223.Deceased_Date_Of_Birth_;
    __EE1299223.Deceased_First_;
    __EE1299223.Deceased_Middle_;
    __EE1299223.Deceased_Last_;
    __EE1299223.Deceased_Match_Code_;
    __EE1299223._isdeepdive_;
    __EE1299223._county__death_;
    __EE1299223.Deceased_Ssn_;
    __EE1299223._state__death__flag_;
    __EE1299223._death__rec__src_;
    __EE1299223._state__death__id_;
    __EE1299223.Customer_Id_;
    __EE1299223.Industry_Type_;
    __EE1299223.Source_Customer_Count_;
    __EE1299223.Entity_Context_Uid_;
    __EE1299223.Entity_Type_;
    __EE1299223.Label_;
    __EE1299223.In_Customer_Population_;
    __EE1299223.Dt_First_Seen_;
    __EE1299223.Dt_Last_Seen_;
    __EE1299223.Last_Record_Id_;
    __EE1299223.Identity_Count_;
    __EE1299223.Identity_Count_Gt2_;
    __EE1299223.Event_Count_;
    __EE1299223.Kr_High_Risk_Flag_;
    __EE1299223.Kr_Medium_Risk_Flag_;
    __EE1299223.Kr_Low_Risk_Flag_;
    __EE1299223.Kr_Flag_;
    __EE1299223.Safe_Flag_;
    __EE1299223.Contributor_Safe_Flag_;
    __EE1299223.Last_Event_Date_;
    __EE1299223.Kr_Last_Event_Date_;
    __EE1299223.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1299223.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1299223.Kr_Ssn100_Flag_;
    __EE1299223.Kr_Ssn101_Flag_;
    __EE1299223.Kr_Ssn103_Flag_;
    __EE1299223.Kr_Ssn104_Flag_;
    __EE1299223.Kr_Ssn105_Flag_;
    __EE1299223.Kr_Ssn190_Flag_;
    __EE1299223.Kr_Ssn191_Flag_;
    __EE1299223.Kr_Ssn192_Flag_;
    __EE1299223.Kr_Ssn193_Flag_;
    __EE1299223.Vl_Event1_All_Count_;
    __EE1299223.Vl_Event7_All_Count_;
    __EE1299223.Vl_Event30_All_Day_Count_;
    __EE1299223.Vl_Event365_All_Day_Count_;
    __EE1299223.Vl_Event7_All_Active_Flag_;
    __EE1299223.Vl_Event30_All_Active_Flag_;
    __EE1299223.Vl_Event1_Count_;
    __EE1299223.Vl_Event7_Count_;
    __EE1299223.Vl_Event30_Count_;
    __EE1299223.Vl_Event365_Count_;
    __EE1299223.Vl_Event7_Active_Flag_;
    __EE1299223.Vl_Event30_Active_Flag_;
    __EE1299223.Date_First_Seen_;
    __EE1299223.Date_Last_Seen_;
    __EE1299223.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1299223,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1299225_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST29899_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
