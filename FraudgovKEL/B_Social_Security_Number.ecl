...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE4104282 := __ENH_Social_Security_Number_1;
  SHARED __EE4108873 := __ENH_Event_1;
  SHARED __EE4108871 := __E_Ssn_Event;
  SHARED __EE4163875 := __EE4108871(__NN(__EE4108871.Social_) AND __NN(__EE4108871.Transaction_));
  SHARED __ST4154411_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4163893(B_Event_1.__ST78136_Layout __EE4108873, E_Ssn_Event.Layout __EE4163875) := __EEQP(__EE4163875.Transaction_,__EE4108873.UID);
  __ST4154411_Layout __JT4163893(B_Event_1.__ST78136_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4163894 := JOIN(__EE4163875,__EE4108873,__JC4163893(RIGHT,LEFT),__JT4163893(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4150813_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4150813_Layout __ND4164593__Project(__ST4154411_Layout __PP4163895) := TRANSFORM
    SELF.UID := __PP4163895.Social_;
    SELF._r_Customer_ := __PP4163895._r_Customer__1_;
    SELF.Event_Date_ := __PP4163895.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4163895.UID;
    SELF.Event_Date__1_ := __PP4163895.Event_Date_;
    SELF._r_Customer__1_ := __PP4163895._r_Customer_;
    SELF := __PP4163895;
  END;
  SHARED __EE4167350 := PROJECT(__EE4163894,__ND4164593__Project(LEFT));
  SHARED __ST4152272_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4152272_Layout __ND4168174__Project(__ST4150813_Layout __PP4167351) := TRANSFORM
    SELF.Exp1_ := __PP4167351.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4167351.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4167351.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4167351.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP4167351.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP4167351.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp6_ := __PP4167351.Kr_Ssn100_Flag_ = 1;
    SELF.Exp7_ := __PP4167351.Kr_Ssn101_Flag_ = 1;
    SELF.Exp8_ := __PP4167351.Kr_Ssn103_Flag_ = 1;
    SELF.Exp9_ := __PP4167351.Kr_Ssn104_Flag_ = 1;
    SELF.Exp10_ := __PP4167351.Kr_Ssn105_Flag_ = 1;
    SELF.Exp11_ := __PP4167351.Kr_Ssn190_Flag_ = 1;
    SELF.Exp12_ := __PP4167351.Kr_Ssn191_Flag_ = 1;
    SELF.Exp13_ := __PP4167351.Kr_Ssn192_Flag_ = 1;
    SELF.Exp14_ := __PP4167351.Kr_Ssn193_Flag_ = 1;
    SELF.Exp15_ := __PP4167351.Safe_Flag_ = 1;
    SELF.Exp16_ := __OP2(__PP4167351.Event_Age_,<,__CN(2));
    SELF.Exp17_ := __AND(__OP2(__PP4167351.Event_Age_,<,__CN(2)),__CN(__PP4167351.In_Customer_Population_ = 1));
    SELF.Exp18_ := __OP2(__PP4167351.Event_Age_,<,__CN(366));
    SELF := __PP4167351;
  END;
  SHARED __EE4168202 := PROJECT(__EE4167350,__ND4168174__Project(LEFT));
  SHARED __ST4152380_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4168316 := PROJECT(__CLEANANDDO(__EE4168202,TABLE(__EE4168202,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4168202.Exp1_),KEL.Aggregates.MaxNG(__EE4168202.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE4168202.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4168202.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4168202.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4168202.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4168202.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4168202.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4168202.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4168202.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4168202.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4168202.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4168202.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4168202.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4168202.Exp14_),KEL.Aggregates.MaxNG(__EE4168202.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4168202.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE4168202.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE4168202.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE4168202.Exp18_)),UID},UID,MERGE)),__ST4152380_Layout);
  SHARED __ST4157879_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4168322(B_Social_Security_Number_1.__ST81548_Layout __EE4104282, __ST4152380_Layout __EE4168316) := __EEQP(__EE4104282.UID,__EE4168316.UID);
  __ST4157879_Layout __JT4168322(B_Social_Security_Number_1.__ST81548_Layout __l, __ST4152380_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4168403 := JOIN(__EE4104282,__EE4168316,__JC4168322(LEFT,RIGHT),__JT4168322(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4085863 := __ENH_Customer_1;
  SHARED __ST4158385_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4168409(__ST4157879_Layout __EE4168403, B_Customer_1.__ST69954_Layout __EE4085863) := __EEQP(__EE4168403._r_Customer_,__EE4085863.UID);
  __ST4158385_Layout __JT4168409(__ST4157879_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4168512 := JOIN(__EE4168403,__EE4085863,__JC4168409(LEFT,RIGHT),__JT4168409(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST68600_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST68600_Layout __ND4168517__Project(__ST4158385_Layout __PP4168513) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP4168513.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP4168513.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4168513.M_I_N___Event_Date__1_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4168513.Identity_Count_ > 2=>1,0);
    __BS4168712 := __T(__PP4168513.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4168712(__T(__OP2(__T(__PP4168513.Source_Customers_)._r_Source_Customer_,=,__PP4168513._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP4168513.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP4168513.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP4168513.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4168513.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4168513.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP4168513.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4168513.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4168513.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4168513.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4168513.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP4168513.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP4168513;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE4168512,__ND4168517__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE4315638 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4315638._r_Customer_;
    __EE4315638.Source_Customers_;
    __EE4315638.Ssn_;
    __EE4315638.Otto_S_S_N_Id_;
    __EE4315638.Ssn_Formatted_;
    __EE4315638._v2__divssnidentitycountnew_;
    __EE4315638.Deceased_Date_;
    __EE4315638.Deceased_Date_Of_Birth_;
    __EE4315638.Deceased_First_;
    __EE4315638.Deceased_Middle_;
    __EE4315638.Deceased_Last_;
    __EE4315638.Deceased_Match_Code_;
    __EE4315638._isdeepdive_;
    __EE4315638._county__death_;
    __EE4315638.Deceased_Ssn_;
    __EE4315638._state__death__flag_;
    __EE4315638._death__rec__src_;
    __EE4315638._state__death__id_;
    __EE4315638.Aot_Act_Cnt_Ev_;
    __EE4315638.Aot_Src1_Act_Cnt_Ev_;
    __EE4315638.Aot_Src1_Act_Only_Flag_;
    __EE4315638.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE4315638.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4315638.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE4315638.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE4315638.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4315638.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4315638.Aot_Id_Act_Cnt_Ev_;
    __EE4315638.Aot_Id_Act_Cnt30_D_;
    __EE4315638.Aot_Add_Act_Cnt_Ev_;
    __EE4315638.Aot_Add_Act_Cnt30_D_;
    __EE4315638.Aot_Non_St_Act_Cnt_Ev_;
    __EE4315638.Aot_Non_St_Act_Cnt30_D_;
    __EE4315638.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4315638.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4315638.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4315638.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4315638.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4315638.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE4315638.Customer_Id_;
    __EE4315638.Industry_Type_;
    __EE4315638.Source_Customer_Count_;
    __EE4315638.Entity_Context_Uid_;
    __EE4315638.Entity_Type_;
    __EE4315638.Label_;
    __EE4315638.In_Customer_Population_;
    __EE4315638.Dt_First_Seen_;
    __EE4315638.Dt_Last_Seen_;
    __EE4315638.Id_Activity_Dt_First_Seen_;
    __EE4315638.Id_Activity_Dt_Last_Seen_;
    __EE4315638.Last_Record_Id_;
    __EE4315638.Identity_Count_;
    __EE4315638.Identity_Count_Gt2_;
    __EE4315638.Event_Count_;
    __EE4315638.Kr_High_Risk_Flag_;
    __EE4315638.Kr_Medium_Risk_Flag_;
    __EE4315638.Kr_Low_Risk_Flag_;
    __EE4315638.Kr_Flag_;
    __EE4315638.Safe_Flag_;
    __EE4315638.Contributor_Safe_Flag_;
    __EE4315638.Last_Event_Date_;
    __EE4315638.Kr_Last_Event_Date_;
    __EE4315638.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4315638.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4315638.Kr_Ssn100_Flag_;
    __EE4315638.Kr_Ssn101_Flag_;
    __EE4315638.Kr_Ssn103_Flag_;
    __EE4315638.Kr_Ssn104_Flag_;
    __EE4315638.Kr_Ssn105_Flag_;
    __EE4315638.Kr_Ssn190_Flag_;
    __EE4315638.Kr_Ssn191_Flag_;
    __EE4315638.Kr_Ssn192_Flag_;
    __EE4315638.Kr_Ssn193_Flag_;
    __EE4315638.Vl_Event1_All_Count_;
    __EE4315638.Vl_Event7_All_Count_;
    __EE4315638.Vl_Event30_All_Day_Count_;
    __EE4315638.Vl_Event365_All_Day_Count_;
    __EE4315638.Vl_Event7_All_Active_Flag_;
    __EE4315638.Vl_Event30_All_Active_Flag_;
    __EE4315638.Vl_Event1_Count_;
    __EE4315638.Vl_Event7_Count_;
    __EE4315638.Vl_Event30_Count_;
    __EE4315638.Vl_Event365_Count_;
    __EE4315638.Vl_Event7_Active_Flag_;
    __EE4315638.Vl_Event30_Active_Flag_;
    __EE4315638.Date_First_Seen_;
    __EE4315638.Date_Last_Seen_;
    __EE4315638.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE4315638,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4315640_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST68600_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
