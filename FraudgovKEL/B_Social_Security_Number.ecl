...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1125348 := __ENH_Social_Security_Number_1;
  SHARED __EE1128367 := __ENH_Event_1;
  SHARED __EE1128365 := __E_Ssn_Event;
  SHARED __EE1160733 := __EE1128365(__NN(__EE1128365.Social_) AND __NN(__EE1128365.Transaction_));
  SHARED __ST1154541_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1160751(B_Event_1.__ST33316_Layout __EE1128367, E_Ssn_Event.Layout __EE1160733) := __EEQP(__EE1160733.Transaction_,__EE1128367.UID);
  __ST1154541_Layout __JT1160751(B_Event_1.__ST33316_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1160752 := JOIN(__EE1160733,__EE1128367,__JC1160751(RIGHT,LEFT),__JT1160751(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1152129_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1152129_Layout __ND1161169__Project(__ST1154541_Layout __PP1160753) := TRANSFORM
    SELF.UID := __PP1160753.Social_;
    SELF._r_Customer_ := __PP1160753._r_Customer__1_;
    SELF.Event_Date_ := __PP1160753.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1160753.UID;
    SELF.Event_Date__1_ := __PP1160753.Event_Date_;
    SELF._r_Customer__1_ := __PP1160753._r_Customer_;
    SELF := __PP1160753;
  END;
  SHARED __EE1162798 := PROJECT(__EE1160752,__ND1161169__Project(LEFT));
  SHARED __ST1153022_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1153022_Layout __ND1163477__Project(__ST1152129_Layout __PP1162799) := TRANSFORM
    SELF.Exp1_ := __PP1162799.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1162799.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP1162799.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP1162799.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP1162799.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP1162799.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP1162799.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP1162799.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP1162799.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP1162799.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP1162799.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP1162799.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP1162799.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP1162799.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP1162799.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP1162799.Event_Age_,<,__CN(2)),__CN(__PP1162799.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP1162799.Event_Age_,<,__CN(366));
    SELF := __PP1162799;
  END;
  SHARED __EE1163504 := PROJECT(__EE1162798,__ND1163477__Project(LEFT));
  SHARED __ST1153128_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1163618 := PROJECT(__CLEANANDDO(__EE1163504,TABLE(__EE1163504,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1163504.Exp1_),KEL.Aggregates.MinNG(__EE1163504.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1163504.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1163504.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1163504.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1163504.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1163504.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1163504.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1163504.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1163504.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1163504.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1163504.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1163504.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1163504.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1163504.Exp13_),KEL.Aggregates.MaxNG(__EE1163504.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1163504.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1163504.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1163504.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE1163504.Exp17_)),UID},UID,MERGE)),__ST1153128_Layout);
  SHARED __ST1156599_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1163624(B_Social_Security_Number_1.__ST34743_Layout __EE1125348, __ST1153128_Layout __EE1163618) := __EEQP(__EE1125348.UID,__EE1163618.UID);
  __ST1156599_Layout __JT1163624(B_Social_Security_Number_1.__ST34743_Layout __l, __ST1153128_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1163683 := JOIN(__EE1125348,__EE1163618,__JC1163624(LEFT,RIGHT),__JT1163624(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1113756 := __ENH_Customer_1;
  SHARED __ST1156990_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1163689(__ST1156599_Layout __EE1163683, B_Customer_1.__ST30473_Layout __EE1113756) := __EEQP(__EE1163683._r_Customer_,__EE1113756.UID);
  __ST1156990_Layout __JT1163689(__ST1156599_Layout __l, B_Customer_1.__ST30473_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1163770 := JOIN(__EE1163683,__EE1113756,__JC1163689(LEFT,RIGHT),__JT1163689(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST29851_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29851_Layout __ND1163775__Project(__ST1156990_Layout __PP1163771) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1163771.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1163771.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP1163771.Identity_Count_ > 2=>1,0);
    __BS1163899 := __T(__PP1163771.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1163899(__T(__OP2(__T(__PP1163771.Source_Customers_)._r_Source_Customer_,=,__PP1163771._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP1163771.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP1163771.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1163771.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1163771.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1163771.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP1163771.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1163771.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1163771.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1163771.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1163771.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1163771.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1163771;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1163770,__ND1163775__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1284390 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1284390._r_Customer_;
    __EE1284390.Source_Customers_;
    __EE1284390.Ssn_;
    __EE1284390.Otto_S_S_N_Id_;
    __EE1284390.Ssn_Formatted_;
    __EE1284390._v2__divssnidentitycountnew_;
    __EE1284390.Deceased_Date_;
    __EE1284390.Deceased_Date_Of_Birth_;
    __EE1284390.Deceased_First_;
    __EE1284390.Deceased_Middle_;
    __EE1284390.Deceased_Last_;
    __EE1284390.Deceased_Match_Code_;
    __EE1284390._isdeepdive_;
    __EE1284390._county__death_;
    __EE1284390.Deceased_Ssn_;
    __EE1284390._state__death__flag_;
    __EE1284390._death__rec__src_;
    __EE1284390._state__death__id_;
    __EE1284390.Customer_Id_;
    __EE1284390.Industry_Type_;
    __EE1284390.Source_Customer_Count_;
    __EE1284390.Entity_Context_Uid_;
    __EE1284390.Entity_Type_;
    __EE1284390.Label_;
    __EE1284390.In_Customer_Population_;
    __EE1284390.Dt_First_Seen_;
    __EE1284390.Dt_Last_Seen_;
    __EE1284390.Last_Record_Id_;
    __EE1284390.Identity_Count_;
    __EE1284390.Identity_Count_Gt2_;
    __EE1284390.Event_Count_;
    __EE1284390.Kr_High_Risk_Flag_;
    __EE1284390.Kr_Medium_Risk_Flag_;
    __EE1284390.Kr_Low_Risk_Flag_;
    __EE1284390.Kr_Flag_;
    __EE1284390.Safe_Flag_;
    __EE1284390.Contributor_Safe_Flag_;
    __EE1284390.Last_Event_Date_;
    __EE1284390.Kr_Last_Event_Date_;
    __EE1284390.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1284390.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1284390.Kr_Ssn100_Flag_;
    __EE1284390.Kr_Ssn101_Flag_;
    __EE1284390.Kr_Ssn103_Flag_;
    __EE1284390.Kr_Ssn104_Flag_;
    __EE1284390.Kr_Ssn105_Flag_;
    __EE1284390.Kr_Ssn190_Flag_;
    __EE1284390.Kr_Ssn191_Flag_;
    __EE1284390.Kr_Ssn192_Flag_;
    __EE1284390.Kr_Ssn193_Flag_;
    __EE1284390.Vl_Event1_All_Count_;
    __EE1284390.Vl_Event7_All_Count_;
    __EE1284390.Vl_Event30_All_Day_Count_;
    __EE1284390.Vl_Event365_All_Day_Count_;
    __EE1284390.Vl_Event7_All_Active_Flag_;
    __EE1284390.Vl_Event30_All_Active_Flag_;
    __EE1284390.Vl_Event1_Count_;
    __EE1284390.Vl_Event7_Count_;
    __EE1284390.Vl_Event30_Count_;
    __EE1284390.Vl_Event365_Count_;
    __EE1284390.Vl_Event7_Active_Flag_;
    __EE1284390.Vl_Event30_Active_Flag_;
    __EE1284390.Date_First_Seen_;
    __EE1284390.Date_Last_Seen_;
    __EE1284390.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1284390,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1284392_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST29851_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
