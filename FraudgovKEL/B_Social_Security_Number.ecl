...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1170474 := __ENH_Social_Security_Number_1;
  SHARED __EE1173590 := __ENH_Event_1;
  SHARED __EE1173588 := __E_Ssn_Event;
  SHARED __EE1212866 := __EE1173588(__NN(__EE1173588.Social_) AND __NN(__EE1173588.Transaction_));
  SHARED __ST1206567_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1212884(B_Event_1.__ST35830_Layout __EE1173590, E_Ssn_Event.Layout __EE1212866) := __EEQP(__EE1212866.Transaction_,__EE1173590.UID);
  __ST1206567_Layout __JT1212884(B_Event_1.__ST35830_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1212885 := JOIN(__EE1212866,__EE1173590,__JC1212884(RIGHT,LEFT),__JT1212884(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1204039_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1204039_Layout __ND1213278__Project(__ST1206567_Layout __PP1212886) := TRANSFORM
    SELF.UID := __PP1212886.Social_;
    SELF._r_Customer_ := __PP1212886._r_Customer__1_;
    SELF.Event_Date_ := __PP1212886.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1212886.UID;
    SELF.Event_Date__1_ := __PP1212886.Event_Date_;
    SELF._r_Customer__1_ := __PP1212886._r_Customer_;
    SELF := __PP1212886;
  END;
  SHARED __EE1214803 := PROJECT(__EE1212885,__ND1213278__Project(LEFT));
  SHARED __ST1204907_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1204907_Layout __ND1215610__Project(__ST1204039_Layout __PP1214804) := TRANSFORM
    SELF.Exp1_ := __PP1214804.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1214804.Hri06_Flag_ = 1;
    SELF.Exp3_ := __PP1214804.Hri26_Flag_ = 1;
    SELF.Exp4_ := __PP1214804.Hri29_Flag_ = 1;
    SELF.Exp5_ := __PP1214804.Hri38_Flag_ = 1;
    SELF.Exp6_ := __PP1214804.Hri71_Flag_ = 1;
    SELF.Exp7_ := __PP1214804.Hri_It_Flag_ = 1;
    SELF.Exp8_ := __PP1214804.Hri_Mi_Flag_ = 1;
    SELF.Exp9_ := __PP1214804.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp10_ := __PP1214804.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp11_ := __PP1214804.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp12_ := __PP1214804.Kr_Ssn100_Flag_ = 1;
    SELF.Exp13_ := __PP1214804.Kr_Ssn101_Flag_ = 1;
    SELF.Exp14_ := __PP1214804.Kr_Ssn103_Flag_ = 1;
    SELF.Exp15_ := __PP1214804.Kr_Ssn104_Flag_ = 1;
    SELF.Exp16_ := __PP1214804.Kr_Ssn105_Flag_ = 1;
    SELF.Exp17_ := __PP1214804.Kr_Ssn190_Flag_ = 1;
    SELF.Exp18_ := __PP1214804.Kr_Ssn191_Flag_ = 1;
    SELF.Exp19_ := __PP1214804.Kr_Ssn192_Flag_ = 1;
    SELF.Exp20_ := __PP1214804.Kr_Ssn193_Flag_ = 1;
    SELF.Exp21_ := __PP1214804.Safe_Flag_ = 1;
    SELF.Exp22_ := __OP2(__PP1214804.Event_Age_,<,__CN(2));
    SELF.Exp23_ := __AND(__OP2(__PP1214804.Event_Age_,<,__CN(2)),__CN(__PP1214804.In_Customer_Population_ = 1));
    SELF.Exp24_ := __OP2(__PP1214804.Event_Age_,<,__CN(366));
    SELF := __PP1214804;
  END;
  SHARED __EE1215644 := PROJECT(__EE1214803,__ND1215610__Project(LEFT));
  SHARED __ST1205048_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1215793 := PROJECT(__CLEANANDDO(__EE1215644,TABLE(__EE1215644,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1215644.Exp1_),KEL.Aggregates.MinNG(__EE1215644.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1215644.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1215644.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1215644.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1215644.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1215644.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1215644.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1215644.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1215644.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1215644.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1215644.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1215644.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1215644.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1215644.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1215644.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1215644.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1215644.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1215644.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1215644.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1215644.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1215644.Exp20_),KEL.Aggregates.MaxNG(__EE1215644.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1215644.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__T(__EE1215644.Exp22_)),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__T(__EE1215644.Exp23_)),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__T(__EE1215644.Exp24_)),UID},UID,MERGE)),__ST1205048_Layout);
  SHARED __ST1208499_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1215799(B_Social_Security_Number_1.__ST37364_Layout __EE1170474, __ST1205048_Layout __EE1215793) := __EEQP(__EE1170474.UID,__EE1215793.UID);
  __ST1208499_Layout __JT1215799(B_Social_Security_Number_1.__ST37364_Layout __l, __ST1205048_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1215866 := JOIN(__EE1170474,__EE1215793,__JC1215799(LEFT,RIGHT),__JT1215799(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1158840 := __ENH_Customer_1;
  SHARED __ST1208940_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1215872(__ST1208499_Layout __EE1215866, B_Customer_1.__ST32808_Layout __EE1158840) := __EEQP(__EE1215866._r_Customer_,__EE1158840.UID);
  __ST1208940_Layout __JT1215872(__ST1208499_Layout __l, B_Customer_1.__ST32808_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1215961 := JOIN(__EE1215866,__EE1158840,__JC1215872(LEFT,RIGHT),__JT1215872(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST32122_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32122_Layout __ND1215966__Project(__ST1208940_Layout __PP1215962) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1215962.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1215962.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Hri06_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri26_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri29_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri38_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri71_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_It_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1215962.Identity_Count_ > 2=>1,0);
    __BS1216125 := __T(__PP1215962.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1216125(__T(__OP2(__T(__PP1215962.Source_Customers_)._r_Source_Customer_,=,__PP1215962._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1215962.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1215962.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1215962.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1215962.C_O_U_N_T___Exp1__21_;
    SELF.Vl_Event1_Count_ := __PP1215962.C_O_U_N_T___Exp1__22_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1215962.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1215962.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1215962.C_O_U_N_T___Exp1__23_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1215962.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1215962.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1215962;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1215961,__ND1215966__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1362717 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1362717._r_Customer_;
    __EE1362717.Source_Customers_;
    __EE1362717.Ssn_;
    __EE1362717.Otto_S_S_N_Id_;
    __EE1362717.Ssn_Formatted_;
    __EE1362717._v2__divssnidentitycountnew_;
    __EE1362717.Deceased_Date_;
    __EE1362717.Deceased_Date_Of_Birth_;
    __EE1362717.Deceased_First_;
    __EE1362717.Deceased_Middle_;
    __EE1362717.Deceased_Last_;
    __EE1362717.Deceased_Match_Code_;
    __EE1362717._isdeepdive_;
    __EE1362717._county__death_;
    __EE1362717.Deceased_Ssn_;
    __EE1362717._state__death__flag_;
    __EE1362717._death__rec__src_;
    __EE1362717._state__death__id_;
    __EE1362717.Customer_Id_;
    __EE1362717.Industry_Type_;
    __EE1362717.Source_Customer_Count_;
    __EE1362717.Entity_Context_Uid_;
    __EE1362717.Entity_Type_;
    __EE1362717.Label_;
    __EE1362717.In_Customer_Population_;
    __EE1362717.Dt_First_Seen_;
    __EE1362717.Dt_Last_Seen_;
    __EE1362717.Last_Record_Id_;
    __EE1362717.Identity_Count_;
    __EE1362717.Identity_Count_Gt2_;
    __EE1362717.Event_Count_;
    __EE1362717.Hri06_Flag_;
    __EE1362717.Hri26_Flag_;
    __EE1362717.Hri29_Flag_;
    __EE1362717.Hri38_Flag_;
    __EE1362717.Hri71_Flag_;
    __EE1362717.Hri_It_Flag_;
    __EE1362717.Hri_Mi_Flag_;
    __EE1362717.Kr_High_Risk_Flag_;
    __EE1362717.Kr_Medium_Risk_Flag_;
    __EE1362717.Kr_Low_Risk_Flag_;
    __EE1362717.Kr_Flag_;
    __EE1362717.Safe_Flag_;
    __EE1362717.Contributor_Safe_Flag_;
    __EE1362717.Last_Event_Date_;
    __EE1362717.Kr_Last_Event_Date_;
    __EE1362717.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1362717.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1362717.Kr_Ssn100_Flag_;
    __EE1362717.Kr_Ssn101_Flag_;
    __EE1362717.Kr_Ssn103_Flag_;
    __EE1362717.Kr_Ssn104_Flag_;
    __EE1362717.Kr_Ssn105_Flag_;
    __EE1362717.Kr_Ssn190_Flag_;
    __EE1362717.Kr_Ssn191_Flag_;
    __EE1362717.Kr_Ssn192_Flag_;
    __EE1362717.Kr_Ssn193_Flag_;
    __EE1362717.Vl_Event1_All_Count_;
    __EE1362717.Vl_Event7_All_Count_;
    __EE1362717.Vl_Event30_All_Day_Count_;
    __EE1362717.Vl_Event365_All_Day_Count_;
    __EE1362717.Vl_Event7_All_Active_Flag_;
    __EE1362717.Vl_Event30_All_Active_Flag_;
    __EE1362717.Vl_Event1_Count_;
    __EE1362717.Vl_Event7_Count_;
    __EE1362717.Vl_Event30_Count_;
    __EE1362717.Vl_Event365_Count_;
    __EE1362717.Vl_Event7_Active_Flag_;
    __EE1362717.Vl_Event30_Active_Flag_;
    __EE1362717.Date_First_Seen_;
    __EE1362717.Date_Last_Seen_;
    __EE1362717.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1362717,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1362719_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST32122_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
