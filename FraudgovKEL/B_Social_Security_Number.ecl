...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1162209 := __ENH_Social_Security_Number_1;
  SHARED __EE1205804 := __E_Ssn_Event;
  SHARED __EE1205811 := __EE1205804(__NN(__EE1205804.Social_));
  SHARED __ST1198928_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Ssn_Event_ := 0;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1205802 := PROJECT(__CLEANANDDO(__EE1205811,TABLE(__EE1205811,{KEL.typ.int C_O_U_N_T___Ssn_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Social_Security_Number.Typ) UID := __EE1205811.Social_},Social_,MERGE)),__ST1198928_Layout);
  SHARED __ST1201277_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1205831(B_Social_Security_Number_1.__ST36682_Layout __EE1162209, __ST1198928_Layout __EE1205802) := __EEQP(__EE1162209.UID,__EE1205802.UID);
  __ST1201277_Layout __JT1205831(B_Social_Security_Number_1.__ST36682_Layout __l, __ST1198928_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1205832 := JOIN(__EE1162209,__EE1205802,__JC1205831(LEFT,RIGHT),__JT1205831(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1205815 := __ENH_Event_1;
  SHARED __EE1210512 := __EE1205804;
  SHARED __EE1210525 := __EE1210512(__NN(__EE1210512.Social_) AND __NN(__EE1210512.Transaction_));
  SHARED __ST1199375_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1210531(B_Event_1.__ST35236_Layout __EE1205815, E_Ssn_Event.Layout __EE1210525) := __EEQP(__EE1210525.Transaction_,__EE1205815.UID);
  __ST1199375_Layout __JT1210531(B_Event_1.__ST35236_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1210532 := JOIN(__EE1210525,__EE1205815,__JC1210531(RIGHT,LEFT),__JT1210531(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1196465_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1196465_Layout __ND1210919__Project(__ST1199375_Layout __PP1210533) := TRANSFORM
    SELF.UID := __PP1210533.Social_;
    SELF._r_Customer_ := __PP1210533._r_Customer__1_;
    SELF.Event_Date_ := __PP1210533.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1210533.UID;
    SELF.Event_Date__1_ := __PP1210533.Event_Date_;
    SELF._r_Customer__1_ := __PP1210533._r_Customer_;
    SELF := __PP1210533;
  END;
  SHARED __EE1212420 := PROJECT(__EE1210532,__ND1210919__Project(LEFT));
  SHARED __ST1197328_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1197328_Layout __ND1213243__Project(__ST1196465_Layout __PP1212421) := TRANSFORM
    SELF.Exp1_ := __PP1212421.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1212421.Hri06_Flag_ = 1;
    SELF.Exp3_ := __PP1212421.Hri26_Flag_ = 1;
    SELF.Exp4_ := __PP1212421.Hri29_Flag_ = 1;
    SELF.Exp5_ := __PP1212421.Hri38_Flag_ = 1;
    SELF.Exp6_ := __PP1212421.Hri71_Flag_ = 1;
    SELF.Exp7_ := __PP1212421.Hri_It_Flag_ = 1;
    SELF.Exp8_ := __PP1212421.Hri_Mi_Flag_ = 1;
    SELF.Exp9_ := __PP1212421.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp10_ := __PP1212421.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp11_ := __PP1212421.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp12_ := __PP1212421.Kr_Ssn100_Flag_ = 1;
    SELF.Exp13_ := __PP1212421.Kr_Ssn101_Flag_ = 1;
    SELF.Exp14_ := __PP1212421.Kr_Ssn103_Flag_ = 1;
    SELF.Exp15_ := __PP1212421.Kr_Ssn104_Flag_ = 1;
    SELF.Exp16_ := __PP1212421.Kr_Ssn105_Flag_ = 1;
    SELF.Exp17_ := __PP1212421.Kr_Ssn190_Flag_ = 1;
    SELF.Exp18_ := __PP1212421.Kr_Ssn191_Flag_ = 1;
    SELF.Exp19_ := __PP1212421.Kr_Ssn192_Flag_ = 1;
    SELF.Exp20_ := __PP1212421.Kr_Ssn193_Flag_ = 1;
    SELF.Exp21_ := __PP1212421.Safe_Flag_ = 1;
    SELF.Exp22_ := __OP2(__PP1212421.Age_,<,__CN(2));
    SELF.Exp23_ := __AND(__OP2(__PP1212421.Age_,<,__CN(2)),__CN(__PP1212421.In_Customer_Population_ = 1));
    SELF.Exp24_ := __OP2(__PP1212421.Age_,<,__CN(366));
    SELF.Exp25_ := __AND(__OP2(__PP1212421.Age_,<,__CN(366)),__CN(__PP1212421.In_Customer_Population_ = 1));
    SELF := __PP1212421;
  END;
  SHARED __EE1213282 := PROJECT(__EE1212420,__ND1213243__Project(LEFT));
  SHARED __ST1197474_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1213437 := PROJECT(__CLEANANDDO(__EE1213282,TABLE(__EE1213282,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1213282.Exp1_),KEL.Aggregates.MinNG(__EE1213282.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1213282.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1213282.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1213282.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1213282.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1213282.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1213282.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1213282.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1213282.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1213282.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1213282.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1213282.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1213282.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1213282.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1213282.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1213282.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1213282.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1213282.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1213282.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1213282.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1213282.Exp20_),KEL.Aggregates.MaxNG(__EE1213282.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1213282.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__T(__EE1213282.Exp22_)),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__T(__EE1213282.Exp23_)),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__T(__EE1213282.Exp24_)),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__T(__EE1213282.Exp25_)),UID},UID,MERGE)),__ST1197474_Layout);
  SHARED __ST1201598_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1213443(__ST1201277_Layout __EE1205832, __ST1197474_Layout __EE1213437) := __EEQP(__EE1205832.UID,__EE1213437.UID);
  __ST1201598_Layout __JT1213443(__ST1201277_Layout __l, __ST1197474_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1213510 := JOIN(__EE1205832,__EE1213437,__JC1213443(LEFT,RIGHT),__JT1213443(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1150602 := __ENH_Customer_1;
  SHARED __ST1202041_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1213516(__ST1201598_Layout __EE1213510, B_Customer_1.__ST32268_Layout __EE1150602) := __EEQP(__EE1213510._r_Customer_,__EE1150602.UID);
  __ST1202041_Layout __JT1213516(__ST1201598_Layout __l, B_Customer_1.__ST32268_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1213605 := JOIN(__EE1213510,__EE1150602,__JC1213516(LEFT,RIGHT),__JT1213516(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST31629_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31629_Layout __ND1213610__Project(__ST1202041_Layout __PP1213606) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1213606.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1213606.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Event_Count_ := __PP1213606.C_O_U_N_T___Ssn_Event_;
    SELF.Hri06_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri26_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri29_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri38_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri71_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_It_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1213606.Identity_Count_ > 2=>1,0);
    __BS1213769 := __T(__PP1213606.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1213769(__T(__OP2(__T(__PP1213606.Source_Customers_)._r_Source_Customer_,=,__PP1213606._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP1213606.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1213606.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1213606.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1213606.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1213606.C_O_U_N_T___Exp1__21_;
    SELF.Vl_Event1_Count_ := __PP1213606.C_O_U_N_T___Exp1__22_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1213606.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1213606.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1213606.C_O_U_N_T___Exp1__23_;
    SELF.Vl_Event365_Count_ := __PP1213606.C_O_U_N_T___Exp1__24_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1213606.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1213606.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1213606;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1213605,__ND1213610__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1360810 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1360810._r_Customer_;
    __EE1360810.Source_Customers_;
    __EE1360810.Ssn_;
    __EE1360810.Otto_S_S_N_Id_;
    __EE1360810.Ssn_Formatted_;
    __EE1360810._v2__divssnidentitycountnew_;
    __EE1360810.Deceased_Date_;
    __EE1360810.Deceased_Date_Of_Birth_;
    __EE1360810.Deceased_First_;
    __EE1360810.Deceased_Middle_;
    __EE1360810.Deceased_Last_;
    __EE1360810.Deceased_Match_Code_;
    __EE1360810._isdeepdive_;
    __EE1360810._county__death_;
    __EE1360810.Deceased_Ssn_;
    __EE1360810._state__death__flag_;
    __EE1360810._death__rec__src_;
    __EE1360810._state__death__id_;
    __EE1360810.Customer_Id_;
    __EE1360810.Industry_Type_;
    __EE1360810.Source_Customer_Count_;
    __EE1360810.Entity_Context_Uid_;
    __EE1360810.Entity_Type_;
    __EE1360810.Label_;
    __EE1360810.In_Customer_Population_;
    __EE1360810.Dt_First_Seen_;
    __EE1360810.Dt_Last_Seen_;
    __EE1360810.Last_Record_Id_;
    __EE1360810.Identity_Count_;
    __EE1360810.Identity_Count_Gt2_;
    __EE1360810.Event_Count_;
    __EE1360810.Hri06_Flag_;
    __EE1360810.Hri26_Flag_;
    __EE1360810.Hri29_Flag_;
    __EE1360810.Hri38_Flag_;
    __EE1360810.Hri71_Flag_;
    __EE1360810.Hri_It_Flag_;
    __EE1360810.Hri_Mi_Flag_;
    __EE1360810.Kr_High_Risk_Flag_;
    __EE1360810.Kr_Medium_Risk_Flag_;
    __EE1360810.Kr_Low_Risk_Flag_;
    __EE1360810.Kr_Flag_;
    __EE1360810.Safe_Flag_;
    __EE1360810.Contributor_Safe_Flag_;
    __EE1360810.Last_Event_Date_;
    __EE1360810.Kr_Last_Event_Date_;
    __EE1360810.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1360810.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1360810.Kr_Ssn100_Flag_;
    __EE1360810.Kr_Ssn101_Flag_;
    __EE1360810.Kr_Ssn103_Flag_;
    __EE1360810.Kr_Ssn104_Flag_;
    __EE1360810.Kr_Ssn105_Flag_;
    __EE1360810.Kr_Ssn190_Flag_;
    __EE1360810.Kr_Ssn191_Flag_;
    __EE1360810.Kr_Ssn192_Flag_;
    __EE1360810.Kr_Ssn193_Flag_;
    __EE1360810.Vl_Event1_All_Count_;
    __EE1360810.Vl_Event7_All_Count_;
    __EE1360810.Vl_Event30_All_Day_Count_;
    __EE1360810.Vl_Event365_All_Day_Count_;
    __EE1360810.Vl_Event7_All_Active_Flag_;
    __EE1360810.Vl_Event30_All_Active_Flag_;
    __EE1360810.Vl_Event1_Count_;
    __EE1360810.Vl_Event7_Count_;
    __EE1360810.Vl_Event30_Count_;
    __EE1360810.Vl_Event365_Count_;
    __EE1360810.Vl_Event7_Active_Flag_;
    __EE1360810.Vl_Event30_Active_Flag_;
    __EE1360810.Date_First_Seen_;
    __EE1360810.Date_Last_Seen_;
    __EE1360810.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE1360810,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1360812_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST31629_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
