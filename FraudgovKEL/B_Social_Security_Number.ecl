...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE2155337 := __ENH_Social_Security_Number_1;
  SHARED __EE2158943 := __ENH_Event_1;
  SHARED __EE2158941 := __E_Ssn_Event;
  SHARED __EE2199423 := __EE2158941(__NN(__EE2158941.Social_) AND __NN(__EE2158941.Transaction_));
  SHARED __ST2192004_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2199441(B_Event_1.__ST52969_Layout __EE2158943, E_Ssn_Event.Layout __EE2199423) := __EEQP(__EE2199423.Transaction_,__EE2158943.UID);
  __ST2192004_Layout __JT2199441(B_Event_1.__ST52969_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2199442 := JOIN(__EE2199423,__EE2158943,__JC2199441(RIGHT,LEFT),__JT2199441(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2189146_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2189146_Layout __ND2199972__Project(__ST2192004_Layout __PP2199443) := TRANSFORM
    SELF.UID := __PP2199443.Social_;
    SELF._r_Customer_ := __PP2199443._r_Customer__1_;
    SELF.Event_Date_ := __PP2199443.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2199443.UID;
    SELF.Event_Date__1_ := __PP2199443.Event_Date_;
    SELF._r_Customer__1_ := __PP2199443._r_Customer_;
    SELF := __PP2199443;
  END;
  SHARED __EE2202053 := PROJECT(__EE2199442,__ND2199972__Project(LEFT));
  SHARED __ST2190261_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2190261_Layout __ND2202762__Project(__ST2189146_Layout __PP2202054) := TRANSFORM
    SELF.Exp1_ := __PP2202054.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2202054.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP2202054.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP2202054.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP2202054.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP2202054.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP2202054.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP2202054.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP2202054.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP2202054.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP2202054.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP2202054.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP2202054.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP2202054.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP2202054.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP2202054.Event_Age_,<,__CN(2)),__CN(__PP2202054.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP2202054.Event_Age_,<,__CN(366));
    SELF := __PP2202054;
  END;
  SHARED __EE2202789 := PROJECT(__EE2202053,__ND2202762__Project(LEFT));
  SHARED __ST2190364_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2202898 := PROJECT(__CLEANANDDO(__EE2202789,TABLE(__EE2202789,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2202789.Exp1_),KEL.Aggregates.MinNG(__EE2202789.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2202789.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2202789.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2202789.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2202789.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2202789.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2202789.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2202789.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2202789.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2202789.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2202789.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2202789.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2202789.Exp13_),KEL.Aggregates.MaxNG(__EE2202789.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2202789.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2202789.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2202789.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2202789.Exp17_)),UID},UID,MERGE)),__ST2190364_Layout);
  SHARED __ST2194627_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2202904(B_Social_Security_Number_1.__ST55371_Layout __EE2155337, __ST2190364_Layout __EE2202898) := __EEQP(__EE2155337.UID,__EE2202898.UID);
  __ST2194627_Layout __JT2202904(B_Social_Security_Number_1.__ST55371_Layout __l, __ST2190364_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2202968 := JOIN(__EE2155337,__EE2202898,__JC2202904(LEFT,RIGHT),__JT2202904(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2145220 := __ENH_Customer_1;
  SHARED __ST2195048_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2202974(__ST2194627_Layout __EE2202968, B_Customer_1.__ST47418_Layout __EE2145220) := __EEQP(__EE2202968._r_Customer_,__EE2145220.UID);
  __ST2195048_Layout __JT2202974(__ST2194627_Layout __l, B_Customer_1.__ST47418_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2203060 := JOIN(__EE2202968,__EE2145220,__JC2202974(LEFT,RIGHT),__JT2202974(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46516_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46516_Layout __ND2203065__Project(__ST2195048_Layout __PP2203061) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2203061.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP2203061.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP2203061.Identity_Count_ > 2=>1,0);
    __BS2203209 := __T(__PP2203061.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2203209(__T(__OP2(__T(__PP2203061.Source_Customers_)._r_Source_Customer_,=,__PP2203061._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2203061.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP2203061.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2203061.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2203061.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2203061.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2203061.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2203061.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2203061.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2203061.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2203061.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2203061.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2203061;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE2203060,__ND2203065__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE2336126 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2336126._r_Customer_;
    __EE2336126.Source_Customers_;
    __EE2336126.Ssn_;
    __EE2336126.Otto_S_S_N_Id_;
    __EE2336126.Ssn_Formatted_;
    __EE2336126._v2__divssnidentitycountnew_;
    __EE2336126.Deceased_Date_;
    __EE2336126.Deceased_Date_Of_Birth_;
    __EE2336126.Deceased_First_;
    __EE2336126.Deceased_Middle_;
    __EE2336126.Deceased_Last_;
    __EE2336126.Deceased_Match_Code_;
    __EE2336126._isdeepdive_;
    __EE2336126._county__death_;
    __EE2336126.Deceased_Ssn_;
    __EE2336126._state__death__flag_;
    __EE2336126._death__rec__src_;
    __EE2336126._state__death__id_;
    __EE2336126.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE2336126.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2336126.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE2336126.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE2336126.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2336126.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2336126.Customer_Id_;
    __EE2336126.Industry_Type_;
    __EE2336126.Source_Customer_Count_;
    __EE2336126.Entity_Context_Uid_;
    __EE2336126.Entity_Type_;
    __EE2336126.Label_;
    __EE2336126.In_Customer_Population_;
    __EE2336126.Dt_First_Seen_;
    __EE2336126.Dt_Last_Seen_;
    __EE2336126.Last_Record_Id_;
    __EE2336126.Identity_Count_;
    __EE2336126.Identity_Count_Gt2_;
    __EE2336126.Event_Count_;
    __EE2336126.Kr_High_Risk_Flag_;
    __EE2336126.Kr_Medium_Risk_Flag_;
    __EE2336126.Kr_Low_Risk_Flag_;
    __EE2336126.Kr_Flag_;
    __EE2336126.Safe_Flag_;
    __EE2336126.Contributor_Safe_Flag_;
    __EE2336126.Last_Event_Date_;
    __EE2336126.Kr_Last_Event_Date_;
    __EE2336126.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2336126.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2336126.Kr_Ssn100_Flag_;
    __EE2336126.Kr_Ssn101_Flag_;
    __EE2336126.Kr_Ssn103_Flag_;
    __EE2336126.Kr_Ssn104_Flag_;
    __EE2336126.Kr_Ssn105_Flag_;
    __EE2336126.Kr_Ssn190_Flag_;
    __EE2336126.Kr_Ssn191_Flag_;
    __EE2336126.Kr_Ssn192_Flag_;
    __EE2336126.Kr_Ssn193_Flag_;
    __EE2336126.Vl_Event1_All_Count_;
    __EE2336126.Vl_Event7_All_Count_;
    __EE2336126.Vl_Event30_All_Day_Count_;
    __EE2336126.Vl_Event365_All_Day_Count_;
    __EE2336126.Vl_Event7_All_Active_Flag_;
    __EE2336126.Vl_Event30_All_Active_Flag_;
    __EE2336126.Vl_Event1_Count_;
    __EE2336126.Vl_Event7_Count_;
    __EE2336126.Vl_Event30_Count_;
    __EE2336126.Vl_Event365_Count_;
    __EE2336126.Vl_Event7_Active_Flag_;
    __EE2336126.Vl_Event30_Active_Flag_;
    __EE2336126.Date_First_Seen_;
    __EE2336126.Date_Last_Seen_;
    __EE2336126.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE2336126,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2336128_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST46516_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
