...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE1124369 := __ENH_Social_Security_Number_1;
  SHARED __EE1127383 := __ENH_Event_1;
  SHARED __EE1127381 := __E_Ssn_Event;
  SHARED __EE1159682 := __EE1127381(__NN(__EE1127381.Social_) AND __NN(__EE1127381.Transaction_));
  SHARED __ST1153496_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1159700(B_Event_1.__ST33177_Layout __EE1127383, E_Ssn_Event.Layout __EE1159682) := __EEQP(__EE1159682.Transaction_,__EE1127383.UID);
  __ST1153496_Layout __JT1159700(B_Event_1.__ST33177_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1159701 := JOIN(__EE1159682,__EE1127383,__JC1159700(RIGHT,LEFT),__JT1159700(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1151088_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1151088_Layout __ND1160117__Project(__ST1153496_Layout __PP1159702) := TRANSFORM
    SELF.UID := __PP1159702.Social_;
    SELF._r_Customer_ := __PP1159702._r_Customer__1_;
    SELF.Event_Date_ := __PP1159702.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1159702.UID;
    SELF.Event_Date__1_ := __PP1159702.Event_Date_;
    SELF._r_Customer__1_ := __PP1159702._r_Customer_;
    SELF := __PP1159702;
  END;
  SHARED __EE1161742 := PROJECT(__EE1159701,__ND1160117__Project(LEFT));
  SHARED __ST1151979_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1151979_Layout __ND1162423__Project(__ST1151088_Layout __PP1161743) := TRANSFORM
    SELF.Exp1_ := __PP1161743.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1161743.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP1161743.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP1161743.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP1161743.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP1161743.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP1161743.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP1161743.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP1161743.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP1161743.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP1161743.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP1161743.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP1161743.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP1161743.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP1161743.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP1161743.Event_Age_,<,__CN(2)),__CN(__PP1161743.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP1161743.Event_Age_,<,__CN(366));
    SELF := __PP1161743;
  END;
  SHARED __EE1162450 := PROJECT(__EE1161742,__ND1162423__Project(LEFT));
  SHARED __ST1152085_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1162564 := PROJECT(__CLEANANDDO(__EE1162450,TABLE(__EE1162450,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1162450.Exp1_),KEL.Aggregates.MinNG(__EE1162450.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1162450.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1162450.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1162450.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1162450.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1162450.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1162450.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1162450.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1162450.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1162450.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1162450.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1162450.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1162450.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1162450.Exp13_),KEL.Aggregates.MaxNG(__EE1162450.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1162450.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1162450.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1162450.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE1162450.Exp17_)),UID},UID,MERGE)),__ST1152085_Layout);
  SHARED __ST1155549_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1162570(B_Social_Security_Number_1.__ST34618_Layout __EE1124369, __ST1152085_Layout __EE1162564) := __EEQP(__EE1124369.UID,__EE1162564.UID);
  __ST1155549_Layout __JT1162570(B_Social_Security_Number_1.__ST34618_Layout __l, __ST1152085_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1162630 := JOIN(__EE1124369,__EE1162564,__JC1162570(LEFT,RIGHT),__JT1162570(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1112801 := __ENH_Customer_1;
  SHARED __ST1155941_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1162636(__ST1155549_Layout __EE1162630, B_Customer_1.__ST30331_Layout __EE1112801) := __EEQP(__EE1162630._r_Customer_,__EE1112801.UID);
  __ST1155941_Layout __JT1162636(__ST1155549_Layout __l, B_Customer_1.__ST30331_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1162718 := JOIN(__EE1162630,__EE1112801,__JC1162636(LEFT,RIGHT),__JT1162636(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST29655_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29655_Layout __ND1162723__Project(__ST1155941_Layout __PP1162719) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1162719.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1162719.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP1162719.Identity_Count_ > 2=>1,0);
    __BS1162847 := __T(__PP1162719.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1162847(__T(__OP2(__T(__PP1162719.Source_Customers_)._r_Source_Customer_,=,__PP1162719._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1162719.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1162719.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1162719.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1162719.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP1162719.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1162719.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1162719.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1162719.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1162719.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1162719.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1162719;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE1162718,__ND1162723__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE1283099 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __E