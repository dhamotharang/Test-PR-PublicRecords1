...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE3226744 := __ENH_Social_Security_Number_1;
  SHARED __EE3231109 := __ENH_Event_1;
  SHARED __EE3231107 := __E_Ssn_Event;
  SHARED __EE3281426 := __EE3231107(__NN(__EE3231107.Social_) AND __NN(__EE3231107.Transaction_));
  SHARED __ST3272429_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3281444(B_Event_1.__ST73836_Layout __EE3231109, E_Ssn_Event.Layout __EE3281426) := __EEQP(__EE3281426.Transaction_,__EE3231109.UID);
  __ST3272429_Layout __JT3281444(B_Event_1.__ST73836_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3281445 := JOIN(__EE3281426,__EE3231109,__JC3281444(RIGHT,LEFT),__JT3281444(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3269007_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3269007_Layout __ND3282110__Project(__ST3272429_Layout __PP3281446) := TRANSFORM
    SELF.UID := __PP3281446.Social_;
    SELF._r_Customer_ := __PP3281446._r_Customer__1_;
    SELF.Event_Date_ := __PP3281446.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3281446.UID;
    SELF.Event_Date__1_ := __PP3281446.Event_Date_;
    SELF._r_Customer__1_ := __PP3281446._r_Customer_;
    SELF := __PP3281446;
  END;
  SHARED __EE3284731 := PROJECT(__EE3281445,__ND3282110__Project(LEFT));
  SHARED __ST3270392_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3270392_Layout __ND3285512__Project(__ST3269007_Layout __PP3284732) := TRANSFORM
    SELF.Exp1_ := __PP3284732.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP3284732.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp3_ := __PP3284732.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP3284732.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP3284732.Kr_Ssn100_Flag_ = 1;
    SELF.Exp6_ := __PP3284732.Kr_Ssn101_Flag_ = 1;
    SELF.Exp7_ := __PP3284732.Kr_Ssn103_Flag_ = 1;
    SELF.Exp8_ := __PP3284732.Kr_Ssn104_Flag_ = 1;
    SELF.Exp9_ := __PP3284732.Kr_Ssn105_Flag_ = 1;
    SELF.Exp10_ := __PP3284732.Kr_Ssn190_Flag_ = 1;
    SELF.Exp11_ := __PP3284732.Kr_Ssn191_Flag_ = 1;
    SELF.Exp12_ := __PP3284732.Kr_Ssn192_Flag_ = 1;
    SELF.Exp13_ := __PP3284732.Kr_Ssn193_Flag_ = 1;
    SELF.Exp14_ := __PP3284732.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP3284732.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP3284732.Event_Age_,<,__CN(2)),__CN(__PP3284732.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP3284732.Event_Age_,<,__CN(366));
    SELF := __PP3284732;
  END;
  SHARED __EE3285539 := PROJECT(__EE3284731,__ND3285512__Project(LEFT));
  SHARED __ST3270495_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3285648 := PROJECT(__CLEANANDDO(__EE3285539,TABLE(__EE3285539,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3285539.Exp1_),KEL.Aggregates.MinNG(__EE3285539.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3285539.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3285539.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3285539.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3285539.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3285539.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3285539.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3285539.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3285539.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3285539.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3285539.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3285539.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3285539.Exp13_),KEL.Aggregates.MaxNG(__EE3285539.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3285539.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE3285539.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE3285539.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE3285539.Exp17_)),UID},UID,MERGE)),__ST3270495_Layout);
  SHARED __ST3275727_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3285654(B_Social_Security_Number_1.__ST77118_Layout __EE3226744, __ST3270495_Layout __EE3285648) := __EEQP(__EE3226744.UID,__EE3285648.UID);
  __ST3275727_Layout __JT3285654(B_Social_Security_Number_1.__ST77118_Layout __l, __ST3270495_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3285730 := JOIN(__EE3226744,__EE3285648,__JC3285654(LEFT,RIGHT),__JT3285654(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3214455 := __ENH_Customer_1;
  SHARED __ST3276208_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3285736(__ST3275727_Layout __EE3285730, B_Customer_1.__ST66213_Layout __EE3214455) := __EEQP(__EE3285730._r_Customer_,__EE3214455.UID);
  __ST3276208_Layout __JT3285736(__ST3275727_Layout __l, B_Customer_1.__ST66213_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3285834 := JOIN(__EE3285730,__EE3214455,__JC3285736(LEFT,RIGHT),__JT3285736(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST64913_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST64913_Layout __ND3285839__Project(__ST3276208_Layout __PP3285835) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3285835.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP3285835.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Identity_Count_Gt2_ := MAP(__PP3285835.Identity_Count_ > 2=>1,0);
    __BS3286019 := __T(__PP3285835.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3286019(__T(__OP2(__T(__PP3285835.Source_Customers_)._r_Source_Customer_,=,__PP3285835._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP3285835.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP3285835.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3285835.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3285835.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3285835.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP3285835.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3285835.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3285835.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3285835.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3285835.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3285835.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3285835;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE3285834,__ND3285839__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE3429002 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE3429002._r_Customer_;
    __EE3429002.Source_Customers_;
    __EE3429002.Ssn_;
    __EE3429002.Otto_S_S_N_Id_;
    __EE3429002.Ssn_Formatted_;
    __EE3429002._v2__divssnidentitycountnew_;
    __EE3429002.Deceased_Date_;
    __EE3429002.Deceased_Date_Of_Birth_;
    __EE3429002.Deceased_First_;
    __EE3429002.Deceased_Middle_;
    __EE3429002.Deceased_Last_;
    __EE3429002.Deceased_Match_Code_;
    __EE3429002._isdeepdive_;
    __EE3429002._county__death_;
    __EE3429002.Deceased_Ssn_;
    __EE3429002._state__death__flag_;
    __EE3429002._death__rec__src_;
    __EE3429002._state__death__id_;
    __EE3429002.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE3429002.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE3429002.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE3429002.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE3429002.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE3429002.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE3429002.Aot_Id_Act_Cnt_Ev_;
    __EE3429002.Aot_Id_Act_Cnt30_D_;
    __EE3429002.Aot_Add_Act_Cnt_Ev_;
    __EE3429002.Aot_Add_Act_Cnt30_D_;
    __EE3429002.Aot_Non_St_Act_Cnt_Ev_;
    __EE3429002.Aot_Non_St_Act_Cnt30_D_;
    __EE3429002.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE3429002.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE3429002.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE3429002.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE3429002.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE3429002.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE3429002.Customer_Id_;
    __EE3429002.Industry_Type_;
    __EE3429002.Source_Customer_Count_;
    __EE3429002.Entity_Context_Uid_;
    __EE3429002.Entity_Type_;
    __EE3429002.Label_;
    __EE3429002.In_Customer_Population_;
    __EE3429002.Dt_First_Seen_;
    __EE3429002.Dt_Last_Seen_;
    __EE3429002.Last_Record_Id_;
    __EE3429002.Identity_Count_;
    __EE3429002.Identity_Count_Gt2_;
    __EE3429002.Event_Count_;
    __EE3429002.Kr_High_Risk_Flag_;
    __EE3429002.Kr_Medium_Risk_Flag_;
    __EE3429002.Kr_Low_Risk_Flag_;
    __EE3429002.Kr_Flag_;
    __EE3429002.Safe_Flag_;
    __EE3429002.Contributor_Safe_Flag_;
    __EE3429002.Last_Event_Date_;
    __EE3429002.Kr_Last_Event_Date_;
    __EE3429002.Kr_Event_After_Last_Known_Risk_Count_;
    __EE3429002.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE3429002.Kr_Ssn100_Flag_;
    __EE3429002.Kr_Ssn101_Flag_;
    __EE3429002.Kr_Ssn103_Flag_;
    __EE3429002.Kr_Ssn104_Flag_;
    __EE3429002.Kr_Ssn105_Flag_;
    __EE3429002.Kr_Ssn190_Flag_;
    __EE3429002.Kr_Ssn191_Flag_;
    __EE3429002.Kr_Ssn192_Flag_;
    __EE3429002.Kr_Ssn193_Flag_;
    __EE3429002.Vl_Event1_All_Count_;
    __EE3429002.Vl_Event7_All_Count_;
    __EE3429002.Vl_Event30_All_Day_Count_;
    __EE3429002.Vl_Event365_All_Day_Count_;
    __EE3429002.Vl_Event7_All_Active_Flag_;
    __EE3429002.Vl_Event30_All_Active_Flag_;
    __EE3429002.Vl_Event1_Count_;
    __EE3429002.Vl_Event7_Count_;
    __EE3429002.Vl_Event30_Count_;
    __EE3429002.Vl_Event365_Count_;
    __EE3429002.Vl_Event7_Active_Flag_;
    __EE3429002.Vl_Event30_Active_Flag_;
    __EE3429002.Date_First_Seen_;
    __EE3429002.Date_Last_Seen_;
    __EE3429002.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE3429002,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST3429004_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST64913_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
