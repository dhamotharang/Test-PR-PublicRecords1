...
IMPORT B_Customer_1,B_Customer_4,B_Event_1,B_Social_Security_Number_1,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number,E_Ssn_Event FROM FraudgovKEL;
...
EXPORT B_Social_Security_Number := MODULE
  ...
  SHARED __EE4618007 := __ENH_Social_Security_Number_1;
  SHARED __EE4622723 := __ENH_Event_1;
  SHARED __EE4622721 := __E_Ssn_Event;
  SHARED __EE4679575 := __EE4622721(__NN(__EE4622721.Social_) AND __NN(__EE4622721.Transaction_));
  SHARED __ST4669861_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4679593(B_Event_1.__ST83458_Layout __EE4622723, E_Ssn_Event.Layout __EE4679575) := __EEQP(__EE4679575.Transaction_,__EE4622723.UID);
  __ST4669861_Layout __JT4679593(B_Event_1.__ST83458_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4679594 := JOIN(__EE4679575,__EE4622723,__JC4679593(RIGHT,LEFT),__JT4679593(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4666163_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4666163_Layout __ND4680318__Project(__ST4669861_Layout __PP4679595) := TRANSFORM
    SELF.UID := __PP4679595.Social_;
    SELF._r_Customer_ := __PP4679595._r_Customer__1_;
    SELF.Event_Date_ := __PP4679595.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4679595.UID;
    SELF.Event_Date__1_ := __PP4679595.Event_Date_;
    SELF._r_Customer__1_ := __PP4679595._r_Customer_;
    SELF := __PP4679595;
  END;
  SHARED __EE4683175 := PROJECT(__EE4679594,__ND4680318__Project(LEFT));
  SHARED __ST4667672_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4667672_Layout __ND4683999__Project(__ST4666163_Layout __PP4683176) := TRANSFORM
    SELF.Exp1_ := __PP4683176.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4683176.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4683176.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4683176.Kr_High_Risk_Ssn_Flag_ = 1;
    SELF.Exp4_ := __PP4683176.Kr_Low_Risk_Ssn_Flag_ = 1;
    SELF.Exp5_ := __PP4683176.Kr_Medium_Risk_Ssn_Flag_ = 1;
    SELF.Exp6_ := __PP4683176.Kr_Ssn100_Flag_ = 1;
    SELF.Exp7_ := __PP4683176.Kr_Ssn101_Flag_ = 1;
    SELF.Exp8_ := __PP4683176.Kr_Ssn103_Flag_ = 1;
    SELF.Exp9_ := __PP4683176.Kr_Ssn104_Flag_ = 1;
    SELF.Exp10_ := __PP4683176.Kr_Ssn105_Flag_ = 1;
    SELF.Exp11_ := __PP4683176.Kr_Ssn190_Flag_ = 1;
    SELF.Exp12_ := __PP4683176.Kr_Ssn191_Flag_ = 1;
    SELF.Exp13_ := __PP4683176.Kr_Ssn192_Flag_ = 1;
    SELF.Exp14_ := __PP4683176.Kr_Ssn193_Flag_ = 1;
    SELF.Exp15_ := __PP4683176.Safe_Flag_ = 1;
    SELF.Exp16_ := __OP2(__PP4683176.Event_Age_,<,__CN(2));
    SELF.Exp17_ := __AND(__OP2(__PP4683176.Event_Age_,<,__CN(2)),__CN(__PP4683176.In_Customer_Population_ = 1));
    SELF.Exp18_ := __OP2(__PP4683176.Event_Age_,<,__CN(366));
    SELF := __PP4683176;
  END;
  SHARED __EE4684027 := PROJECT(__EE4683175,__ND4683999__Project(LEFT));
  SHARED __ST4667780_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4684141 := PROJECT(__CLEANANDDO(__EE4684027,TABLE(__EE4684027,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4684027.Exp1_),KEL.Aggregates.MinNG(__EE4684027.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4684027.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4684027.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4684027.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4684027.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4684027.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4684027.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4684027.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4684027.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4684027.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4684027.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4684027.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4684027.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4684027.Exp14_),KEL.Aggregates.MaxNG(__EE4684027.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4684027.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE4684027.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE4684027.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE4684027.Exp18_)),UID},UID,MERGE)),__ST4667780_Layout);
  SHARED __ST4673454_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4684147(B_Social_Security_Number_1.__ST86799_Layout __EE4618007, __ST4667780_Layout __EE4684141) := __EEQP(__EE4618007.UID,__EE4684141.UID);
  __ST4673454_Layout __JT4684147(B_Social_Security_Number_1.__ST86799_Layout __l, __ST4667780_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4684228 := JOIN(__EE4618007,__EE4684141,__JC4684147(LEFT,RIGHT),__JT4684147(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4598988 := __ENH_Customer_1;
  SHARED __ST4673960_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4684234(__ST4673454_Layout __EE4684228, B_Customer_1.__ST74526_Layout __EE4598988) := __EEQP(__EE4684228._r_Customer_,__EE4598988.UID);
  __ST4673960_Layout __JT4684234(__ST4673454_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4684337 := JOIN(__EE4684228,__EE4598988,__JC4684234(LEFT,RIGHT),__JT4684234(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST73196_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST73196_Layout __ND4684342__Project(__ST4673960_Layout __PP4684338) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4684338.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP4684338.Otto_S_S_N_Id_);
    SELF.Entity_Type_ := 15;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4684338.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4684338.Identity_Count_ > 2=>1,0);
    __BS4684537 := __T(__PP4684338.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4684537(__T(__OP2(__T(__PP4684338.Source_Customers_)._r_Source_Customer_,=,__PP4684338._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Ssn100_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Ssn101_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Ssn103_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ssn104_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ssn105_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ssn190_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ssn191_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ssn192_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ssn193_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP4684338.Ssn_Formatted_;
    SELF.Last_Event_Date_ := __PP4684338.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4684338.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4684338.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4684338.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP4684338.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4684338.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4684338.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4684338.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4684338.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP4684338.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP4684338;
  END;
  EXPORT __ENH_Social_Security_Number := PROJECT(__EE4684337,__ND4684342__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Social_Security_Number::Annotated',EXPIRE(7));
  SHARED __EE4829943 := __ENH_Social_Security_Number;
  SHARED IDX_Social_Security_Number_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4829943._r_Customer_;
    __EE4829943.Source_Customers_;
    __EE4829943.Ssn_;
    __EE4829943.Otto_S_S_N_Id_;
    __EE4829943.Ssn_Formatted_;
    __EE4829943._v2__divssnidentitycountnew_;
    __EE4829943.Deceased_Date_;
    __EE4829943.Deceased_Date_Of_Birth_;
    __EE4829943.Deceased_First_;
    __EE4829943.Deceased_Middle_;
    __EE4829943.Deceased_Last_;
    __EE4829943.Deceased_Match_Code_;
    __EE4829943._isdeepdive_;
    __EE4829943._county__death_;
    __EE4829943.Deceased_Ssn_;
    __EE4829943._state__death__flag_;
    __EE4829943._death__rec__src_;
    __EE4829943._state__death__id_;
    __EE4829943.Aot_Act_Cnt_Ev_;
    __EE4829943.Aot_Src1_Act_Cnt_Ev_;
    __EE4829943.Aot_Src1_Act_Only_Flag_;
    __EE4829943.Aot_Ssn_Kr_Act_Cnt_Ev_;
    __EE4829943.Aot_Ssn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4829943.Aot_Ssn_Kr_Act_Old_Dt_Ev_;
    __EE4829943.Aot_Ssn_Kr_Act_New_Dt_Ev_;
    __EE4829943.Aot_Ssn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4829943.Aot_Ssn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4829943.Aot_Id_Act_Cnt_Ev_;
    __EE4829943.Aot_Id_Act_Cnt30_D_;
    __EE4829943.Aot_Add_Act_Cnt_Ev_;
    __EE4829943.Aot_Add_Act_Cnt30_D_;
    __EE4829943.Aot_Non_St_Act_Cnt_Ev_;
    __EE4829943.Aot_Non_St_Act_Cnt30_D_;
    __EE4829943.Aot_Ssn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4829943.Aot_Ssn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4829943.Aot_Ssn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4829943.Aot_Id_Curr_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4829943.Aot_Id_Hist_Prof_Usng_Ssn_Cnt_Ev_;
    __EE4829943.Aot_Id_Usng_Ssn_Cnt_Ev_;
    __EE4829943.Customer_Id_;
    __EE4829943.Industry_Type_;
    __EE4829943.Source_Customer_Count_;
    __EE4829943.Entity_Context_Uid_;
    __EE4829943.Entity_Type_;
    __EE4829943.Label_;
    __EE4829943.In_Customer_Population_;
    __EE4829943.Dt_First_Seen_;
    __EE4829943.Dt_Last_Seen_;
    __EE4829943.Id_Activity_Dt_First_Seen_;
    __EE4829943.Id_Activity_Dt_Last_Seen_;
    __EE4829943.Last_Record_Id_;
    __EE4829943.Identity_Count_;
    __EE4829943.Identity_Count_Gt2_;
    __EE4829943.Event_Count_;
    __EE4829943.Kr_High_Risk_Flag_;
    __EE4829943.Kr_Medium_Risk_Flag_;
    __EE4829943.Kr_Low_Risk_Flag_;
    __EE4829943.Kr_Flag_;
    __EE4829943.Safe_Flag_;
    __EE4829943.Contributor_Safe_Flag_;
    __EE4829943.Last_Event_Date_;
    __EE4829943.Kr_Last_Event_Date_;
    __EE4829943.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4829943.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4829943.Kr_Ssn100_Flag_;
    __EE4829943.Kr_Ssn101_Flag_;
    __EE4829943.Kr_Ssn103_Flag_;
    __EE4829943.Kr_Ssn104_Flag_;
    __EE4829943.Kr_Ssn105_Flag_;
    __EE4829943.Kr_Ssn190_Flag_;
    __EE4829943.Kr_Ssn191_Flag_;
    __EE4829943.Kr_Ssn192_Flag_;
    __EE4829943.Kr_Ssn193_Flag_;
    __EE4829943.Vl_Event1_All_Count_;
    __EE4829943.Vl_Event7_All_Count_;
    __EE4829943.Vl_Event30_All_Day_Count_;
    __EE4829943.Vl_Event365_All_Day_Count_;
    __EE4829943.Vl_Event7_All_Active_Flag_;
    __EE4829943.Vl_Event30_All_Active_Flag_;
    __EE4829943.Vl_Event1_Count_;
    __EE4829943.Vl_Event7_Count_;
    __EE4829943.Vl_Event30_Count_;
    __EE4829943.Vl_Event365_Count_;
    __EE4829943.Vl_Event7_Active_Flag_;
    __EE4829943.Vl_Event30_Active_Flag_;
    __EE4829943.Date_First_Seen_;
    __EE4829943.Date_Last_Seen_;
    __EE4829943.__RecordCount;
  END;
  SHARED IDX_Social_Security_Number_UID_Projected := PROJECT(__EE4829943,TRANSFORM(IDX_Social_Security_Number_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4829945_Layout := RECORDOF(IDX_Social_Security_Number_UID);
  EXPORT IDX_Social_Security_Number_UID_Wrapped := PROJECT(IDX_Social_Security_Number_UID,TRANSFORM(__ST73196_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
