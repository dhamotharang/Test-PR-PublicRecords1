...
IMPORT B_Event_2,B_Internet_Protocol_2,B_Internet_Protocol_4,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Internet_Protocol_Event,E_Person,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Internet_Protocol_1 := MODULE
  ...
  SHARED __EE365091 := __ENH_Internet_Protocol_2;
  SHARED __EE365500 := __ENH_Event_2;
  SHARED __EE380663 := __EE365500;
  SHARED __EE365498 := __E_Internet_Protocol_Event;
  SHARED __EE379715 := __EE365498(__NN(__EE365498.Transaction_) AND __NN(__EE365498.Ip_));
  SHARED __EE380666 := __EE379715;
  SHARED __ST373572_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC380677(B_Event_2.__ST37859_Layout __EE380663, E_Internet_Protocol_Event.Layout __EE380666) := __EEQP(__EE380666.Transaction_,__EE380663.UID);
  __ST373572_Layout __JT380677(B_Event_2.__ST37859_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE380678 := JOIN(__EE380666,__EE380663,__JC380677(RIGHT,LEFT),__JT380677(RIGHT,LEFT),INNER,HASH);
  SHARED __ST371731_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST371731_Layout __ND380901__Project(__ST373572_Layout __PP380679) := TRANSFORM
    SELF.UID := __PP380679.Ip_;
    SELF._r_Customer_ := __PP380679._r_Customer__1_;
    SELF.Event_Date_ := __PP380679.Event_Date__1_;
    SELF.U_I_D__1_ := __PP380679.UID;
    SELF.Event_Date__1_ := __PP380679.Event_Date_;
    SELF._r_Customer__1_ := __PP380679._r_Customer_;
    SELF := __PP380679;
  END;
  SHARED __EE381746 := PROJECT(__EE380678,__ND380901__Project(LEFT));
  SHARED __ST372198_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST372198_Layout __ND382370__Project(__ST371731_Layout __PP381747) := TRANSFORM
    SELF.Exp1_ := __PP381747.Kr_Ip_Flag_ = 1;
    SELF.Exp2_ := __OP2(__PP381747.Age_,<,__CN(31));
    SELF.Exp3_ := __AND(__OP2(__PP381747.Age_,<,__CN(31)),__CN(__PP381747.In_Customer_Population_ = 1));
    SELF.Exp4_ := __OP2(__PP381747.Age_,<,__CN(8));
    SELF.Exp5_ := __AND(__OP2(__PP381747.Age_,<,__CN(8)),__CN(__PP381747.In_Customer_Population_ = 1));
    SELF := __PP381747;
  END;
  SHARED __EE382389 := PROJECT(__EE381746,__ND382370__Project(LEFT));
  SHARED __ST372238_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE382434 := PROJECT(__CLEANANDDO(__EE382389,TABLE(__EE382389,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE382389.Exp1_),KEL.Aggregates.MaxNG(__EE382389.Record_Id_) M_A_X___Record_Id_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__T(__EE382389.Exp2_)),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__T(__EE382389.Exp3_)),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__T(__EE382389.Exp4_)),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__T(__EE382389.Exp5_)),UID},UID,MERGE)),__ST372238_Layout);
  SHARED __ST374656_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC382440(B_Internet_Protocol_4.__ST41320_Layout __EE365091, __ST372238_Layout __EE382434) := __EEQP(__EE365091.UID,__EE382434.UID);
  __ST374656_Layout __JT382440(B_Internet_Protocol_4.__ST41320_Layout __l, __ST372238_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE382527 := JOIN(__EE365091,__EE382434,__JC382440(LEFT,RIGHT),__JT382440(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST373053_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    KEL.typ.ntyp(E_Event.Typ) Transaction_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC379727(E_Internet_Protocol_Event.Layout __EE379715, B_Event_2.__ST37859_Layout __EE365500) := __EEQP(__EE379715.Transaction_,__EE365500.UID);
  __ST373053_Layout __JT379727(E_Internet_Protocol_Event.Layout __l, B_Event_2.__ST37859_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE379728 := JOIN(__EE379715,__EE365500,__JC379727(LEFT,RIGHT),__JT379727(LEFT,RIGHT),INNER,HASH);
  SHARED __EE365454 := __EE365091;
  __JC379962(__ST373053_Layout __EE379728, B_Internet_Protocol_4.__ST41320_Layout __EE365454) := __EEQP(__EE365454.UID,__EE379728.Ip_) AND __T(__AND(__EEQ(__EE365454.UID,__EE379728.Ip_),__OP2(__EE379728.Event_Date__1_,>,__EE365454.Kr_Last_Event_Date_)));
  SHARED __EE379963 := JOIN(__EE379728,__EE365454,__JC379962(LEFT,RIGHT),TRANSFORM(__ST373053_Layout,SELF:=LEFT),HASH,KEEP(1));
  SHARED __ST365540_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE380203 := PROJECT(__EE379963,TRANSFORM(__ST365540_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT));
  SHARED __ST365564_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Internet_Protocol_Event_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE380216 := PROJECT(__CLEANANDDO(__EE380203,TABLE(__EE380203,{KEL.typ.int C_O_U_N_T___Internet_Protocol_Event_ := COUNT(GROUP),UID},UID,MERGE)),__ST365564_Layout);
  SHARED __ST375105_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC382533(__ST374656_Layout __EE382527, __ST365564_Layout __EE380216) := __EEQP(__EE382527.UID,__EE380216.UID);
  __ST375105_Layout __JT382533(__ST374656_Layout __l, __ST365564_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE382622 := JOIN(__EE382527,__EE380216,__JC382533(LEFT,RIGHT),__JT382533(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST35769_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST35769_Layout __ND382627__Project(__ST375105_Layout __PP382623) := TRANSFORM
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP382623.Otto_Ip_Address_Id_);
    SELF.Kr_Event_After_Last_Known_Risk_Count_ := __PP382623.C_O_U_N_T___Internet_Protocol_Event_;
    SELF.Kr_Flag_ := MAP(__PP382623.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Label_ := __PP382623.Ip_Address_;
    SELF.Last_Record_Id_ := __PP382623.M_A_X___Record_Id_;
    SELF.Vl_Event30_All_Day_Count_ := __PP382623.C_O_U_N_T___Exp1__1_;
    SELF.Vl_Event30_Count_ := __PP382623.C_O_U_N_T___Exp1__2_;
    SELF.Vl_Event7_All_Count_ := __PP382623.C_O_U_N_T___Exp1__3_;
    SELF.Vl_Event7_Count_ := __PP382623.C_O_U_N_T___Exp1__4_;
    SELF := __PP382623;
  END;
  EXPORT __ENH_Internet_Protocol_1 := PROJECT(__EE382622,__ND382627__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated_1',EXPIRE(7));
END;
