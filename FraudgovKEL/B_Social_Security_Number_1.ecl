...
EXPORT B_Social_Security_Number_1 := MODULE
  ...
  SHARED __EE459045 := __ENH_Social_Security_Number_2;
  SHARED __EE470634 := __ENH_Event_2;
  SHARED __EE470632 := __E_Ssn_Event;
  SHARED __EE471684 := __EE470632(__NN(__EE470632.Social_) AND __NN(__EE470632.Transaction_));
  SHARED __ST467438_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC471702(B_Event_2.__ST38500_Layout __EE470634, E_Ssn_Event.Layout __EE471684) := __EEQP(__EE471684.Transaction_,__EE470634.UID);
  __ST467438_Layout __JT471702(B_Event_2.__ST38500_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE471703 := JOIN(__EE471684,__EE470634,__JC471702(RIGHT,LEFT),__JT471702(RIGHT,LEFT),INNER,HASH);
  SHARED __ST466163_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST466163_Layout __ND471931__Project(__ST467438_Layout __PP471704) := TRANSFORM
    SELF.UID := __PP471704.Social_;
    SELF._r_Customer_ := __PP471704._r_Customer__1_;
    SELF.Event_Date_ := __PP471704.Event_Date__1_;
    SELF.U_I_D__1_ := __PP471704.UID;
    SELF.Event_Date__1_ := __PP471704.Event_Date_;
    SELF._r_Customer__1_ := __PP471704._r_Customer_;
    SELF := __PP471704;
  END;
  SHARED __EE472796 := PROJECT(__EE471703,__ND471931__Project(LEFT));
  SHARED __ST466647_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST466647_Layout __ND473128__Project(__ST466163_Layout __PP472797) := TRANSFORM
    SELF.Exp1_ := __PP472797.Kr_Ssn_Flag_ = 1;
    SELF.Exp2_ := __OP2(__PP472797.Event_Age_,<,__CN(31));
    SELF.Exp3_ := __AND(__OP2(__PP472797.Event_Age_,<,__CN(31)),__CN(__PP472797.In_Customer_Population_ = 1));
    SELF.Exp4_ := __AND(__OP2(__PP472797.Event_Age_,<,__CN(366)),__CN(__PP472797.In_Customer_Population_ = 1));
    SELF.Exp5_ := __OP2(__PP472797.Event_Age_,<,__CN(8));
    SELF.Exp6_ := __AND(__OP2(__PP472797.Event_Age_,<,__CN(8)),__CN(__PP472797.In_Customer_Population_ = 1));
    SELF := __PP472797;
  END;
  SHARED __EE473152 := PROJECT(__EE472796,__ND473128__Project(LEFT));
  SHARED __ST466692_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE473203 := PROJECT(__CLEANANDDO(__EE473152,TABLE(__EE473152,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE473152.Exp1_),KEL.Aggregates.MaxNG(__EE473152.Record_Id_) M_A_X___Record_Id_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__T(__EE473152.Exp2_)),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__T(__EE473152.Exp3_)),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__T(__EE473152.Exp4_)),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__T(__EE473152.Exp5_)),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__T(__EE473152.Exp6_)),UID},UID,MERGE)),__ST466692_Layout);
  SHARED __ST468547_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC473209(B_Social_Security_Number_2.__ST39344_Layout __EE459045, __ST466692_Layout __EE473203) := __EEQP(__EE459045.UID,__EE473203.UID);
  __ST468547_Layout __JT473209(B_Social_Security_Number_2.__ST39344_Layout __l, __ST466692_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE473244 := JOIN(__EE459045,__EE473203,__JC473209(LEFT,RIGHT),__JT473209(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE470609 := __E_Person_S_S_N;
  SHARED __EE470616 := __EE470609(__NN(__EE470609.Social_));
  SHARED __ST459310_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE470630 := PROJECT(TABLE(PROJECT(__EE470616,TRANSFORM(__ST459310_Layout,SELF.UID := LEFT.Social_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST459310_Layout);
  SHARED __ST459328_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_S_S_N_ := 0;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE470607 := PROJECT(__CLEANANDDO(__EE470630,TABLE(__EE470630,{KEL.typ.int C_O_U_N_T___Person_S_S_N_ := COUNT(GROUP),UID},UID,MERGE)),__ST459328_Layout);
  SHARED __ST468742_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC473250(__ST468547_Layout __EE473244, __ST459328_Layout __EE470607) := __EEQP(__EE473244.UID,__EE470607.UID);
  __ST468742_Layout __JT473250(__ST468547_Layout __l, __ST459328_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE473287 := JOIN(__EE473244,__EE470607,__JC473250(LEFT,RIGHT),__JT473250(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST37280_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST37280_Layout __ND473292__Project(__ST468742_Layout __PP473288) := TRANSFORM
    SELF.Entity_Context_Uid_ := __OP2(__CN('_15'),+,__PP473288.Otto_S_S_N_Id_);
    SELF.Identity_Count_ := __PP473288.C_O_U_N_T___Person_S_S_N_;
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP473288.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_Flag_ := MAP(__PP473288.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Label_ := __PP473288.Ssn_Formatted_;
    SELF.Last_Record_Id_ := __PP473288.M_A_X___Record_Id_;
    SELF.Vl_Event30_All_Day_Count_ := __PP473288.C_O_U_N_T___Exp1__1_;
    SELF.Vl_Event30_Count_ := __PP473288.C_O_U_N_T___Exp1__2_;
    SELF.Vl_Event365_Count_ := __PP473288.C_O_U_N_T___Exp1__3_;
    SELF.Vl_Event7_All_Count_ := __PP473288.C_O_U_N_T___Exp1__4_;
    SELF.Vl_Event7_Count_ := __PP473288.C_O_U_N_T___Exp1__5_;
    SELF := __PP473288;
  END;
  EXPORT __ENH_Social_Security_Number_1 := PROJECT(__EE473287,__ND473292__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated_1',EXPIRE(7));
END;
