...
IMPORT B_Event_5,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Person_Event,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Event_4 := MODULE
  ...
  SHARED __EE211221 := __ENH_Event_5;
  SHARED __EE227047 := __EE211221;
  SHARED __EE227045 := __E_Person_Event;
  SHARED __EE227054 := __EE227045(__NN(__EE227045.Transaction_));
  __JC227063(B_Event_5.__ST78284_Layout __EE227047, E_Person_Event.Layout __EE227054) := __EEQP(__EE227054.Transaction_,__EE227047.UID);
  SHARED __EE227064 := JOIN(__EE227047,__EE227054,__JC227063(LEFT,RIGHT),TRANSFORM(B_Event_5.__ST78284_Layout,SELF:=LEFT),HASH,KEEP(1));
  SHARED __ST214923_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __EE227082 := PROJECT(__EE227064,__ST214923_Layout);
  SHARED __ST214946_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST214946_Layout __ND222384__Project(__ST214923_Layout __PP222380) := TRANSFORM
    SELF.Exp1_ := NOT (__PP222380.T1_L___Bc_Shll_Lex_Id_Matches_Inp_Flag_ = -99997);
    SELF.Exp2_ := NOT (__PP222380.T1_L___Lex_Id_Seen_Flag_ = -99997);
    SELF := __PP222380;
  END;
  SHARED __EE222401 := PROJECT(__EE227082,__ND222384__Project(LEFT));
  SHARED __ST214966_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE227007 := PROJECT(__CLEANANDDO(__EE222401,TABLE(__EE222401,{KEL.typ.int C_O_U_N_T___Event_ := COUNT(GROUP,__EE222401.Exp1_),KEL.typ.int C_O_U_N_T___Event__1_ := COUNT(GROUP,__EE222401.Exp2_),UID},UID,MERGE)),__ST214966_Layout);
  SHARED __ST216658_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC227091(B_Event_5.__ST78284_Layout __EE211221, __ST214966_Layout __EE227007) := __EEQP(__EE211221.UID,__EE227007.UID);
  __ST216658_Layout __JT227091(B_Event_5.__ST78284_Layout __l, __ST214966_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE227092 := JOIN(__EE211221,__EE227007,__JC227091(LEFT,RIGHT),__JT227091(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE227009 := __EE211221;
  SHARED __ST215859_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __ST215859_Layout __JT227020(B_Event_5.__ST78284_Layout __l, E_Event.Event_Types_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE227021 := NORMALIZE(__EE227009,__T(LEFT.Event_Types_),__JT227020(LEFT,RIGHT));
  SHARED __ST213079_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Event_Type_;
    KEL.typ.ndataset(E_Event.Event_Types_Layout) Event_Types_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE227043 := PROJECT(__EE227021,__ST213079_Layout);
  SHARED __ST213108_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    KEL.typ.nbool Exp2_;
    KEL.typ.nbool Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST213108_Layout __ND227097__Project(__ST213079_Layout __PP227093) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP227093.Event_Type_,IN,__CN(['100','191']));
    SELF.Exp2_ := __OP2(__PP227093.Event_Type_,IN,__CN(['103','104','105','190','193']));
    SELF.Exp3_ := __OP2(__PP227093.Event_Type_,IN,__CN(['101','192']));
    SELF := __PP227093;
  END;
  SHARED __EE227132 := PROJECT(__EE227043,__ND227097__Project(LEFT));
  SHARED __ST213133_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE227164 := PROJECT(__CLEANANDDO(__EE227132,TABLE(__EE227132,{KEL.typ.int C_O_U_N_T___Event_Types_ := COUNT(GROUP,__T(__EE227132.Exp1_)),KEL.typ.int C_O_U_N_T___Event_Types__1_ := COUNT(GROUP,__T(__EE227132.Exp2_)),KEL.typ.int C_O_U_N_T___Event_Types__2_ := COUNT(GROUP,__T(__EE227132.Exp3_)),UID},UID,MERGE)),__ST213133_Layout);
  SHARED __ST218719_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC227173(__ST216658_Layout __EE227092, __ST213133_Layout __EE227164) := __EEQP(__EE227092.UID,__EE227164.UID);
  __ST218719_Layout __JT227173(__ST216658_Layout __l, __ST213133_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE227174 := JOIN(__EE227092,__EE227164,__JC227173(LEFT,RIGHT),__JT227173(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST75852_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST75852_Layout __ND225281__Project(__ST218719_Layout __PP225277) := TRANSFORM
    SELF.Kr_High_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP225277.C_O_U_N_T___Event_Types_),<>,__CN(0)))=>1,0);
    SELF.Kr_Identity_Flag_ := MAP(__PP225277.Kr_High_Risk_Identity_Flag_ = 1 OR __PP225277.Kr_Medium_Risk_Identity_Flag_ = 1 OR __PP225277.Kr_Low_Risk_Identity_Flag_ = 1=>1,0);
    SELF.Kr_Low_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP225277.C_O_U_N_T___Event_Types__1_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP225277.C_O_U_N_T___Event_Types__2_),<>,__CN(0)))=>1,0);
    SELF.T15___Ssn_Is_Kr_Flag_ := MAP(__PP225277.T15___Ssn_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Ssn_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Ssn_Status_Code_Echo_),IN,__CN(['100','101','190','191','192','193'])))=>1, -99997);
    SELF.T16___Phn_Is_Kr_Flag_ := MAP(__PP225277.T16___Phn_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Phn_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Phn_Status_Code_Echo_),IN,__CN(['400','401','402','490','491','492','493'])))=>1, -99997);
    SELF.T16___Phn_Is_Safe_Flag_ := MAP(__PP225277.T16___Phn_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 2=> -99998,__T(__OP2(__PP225277.T___Phn_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__PP225277.T___Phn_Status_Code_Echo_,IN,__CN([5400,5401,5490])))=>1, -99997);
    SELF.T17___Email_Is_Kr_Flag_ := MAP(__PP225277.T17___Email_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Email_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Email_Status_Code_Echo_),IN,__CN(['500','501','502','590','591','592','593'])))=>1, -99997);
    SELF.T18___Ip_Addr_Is_Kr_Flag_ := MAP(__PP225277.T18___Ip_Addr_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Ip_Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Ip_Addr_Status_Code_Echo_),IN,__CN(['600','601','602','603','604','605','1000','1001','1090','1091','1092','1093'])))=>1, -99997);
    SELF.T18___Ip_Addr_Is_Safe_Flag_ := MAP(__PP225277.T18___Ip_Addr_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 2=> -99998,__T(__OP2(__PP225277.T___Ip_Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__PP225277.T___Ip_Addr_Status_Code_Echo_,IN,__CN([5600,5601,5690])))=>1, -99997);
    SELF.T19___Bnk_Acct_Is_Kr_Flag_ := MAP(__PP225277.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Bnk_Acct_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Bnk_Acct_Status_Code_Echo_),IN,__CN(['800','801','802','890','891','892','893'])))=>1, -99997);
    SELF.T1_L___Id_Is_Bc_Shll_Hit_Flag_ := MAP(__PP225277.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP225277.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP225277.T___Src_Class_Type_ < 4=> -99998, NOT (__PP225277.C_O_U_N_T___Event_ <> 0) OR NOT (__PP225277.C_O_U_N_T___Event__1_ <> 0)=> -99997,__PP225277.T1_L___Bc_Shll_Lex_Id_Matches_Inp_Flag_ = 1 AND __PP225277.T1_L___Lex_Id_Seen_Flag_ = 1=>1,0);
    SELF.T1___Id_Is_Kr_Flag_ := MAP(__PP225277.T1___Lex_Id_Pop_Flag_ = 0 AND __PP225277.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__PP225277.T1___Id_Is_Kr_Gen_Frd_Flag_ = -99997=>0,__PP225277.T1___Id_Is_Kr_Gen_Frd_Flag_ = 1 OR __PP225277.T1___Id_Is_Kr_Stol_Id_Flag_ = 1 OR __PP225277.T1___Id_Is_Kr_App_Frd_Flag_ = 1 OR __PP225277.T1___Id_Is_Kr_Oth_Frd_Flag_ = 1=>1,0);
    SELF.T20___Dl_Is_Kr_Flag_ := MAP(__PP225277.T20___Dl_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Dl_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Dl_Status_Code_Echo_),IN,__CN(['200','201','202','203','204','290','291','292','293'])))=>1, -99997);
    SELF.T9___Addr_Is_Kr_Flag_ := MAP(__PP225277.T9___Addr_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 3=> -99998,__T(__OP2(__PP225277.T___Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__CAST(KEL.typ.str,__PP225277.T___Addr_Status_Code_Echo_),IN,__CN(['300','301','302','303','390','391','392','393'])))=>1, -99997);
    SELF.T9___Addr_Is_Safe_Flag_ := MAP(__PP225277.T9___Addr_Pop_Flag_ = 0=> -99999,__PP225277.T___Src_Class_Type_ <> 2=> -99998,__T(__OP2(__PP225277.T___Addr_Status_Code_Echo_,=,__CN(-99997)))=>0,__T(__OP2(__PP225277.T___Addr_Status_Code_Echo_,IN,__CN([5300,5301,5302,5303,5390])))=>1, -99997);
    SELF.T___In_Agency_Flag_ := MAP(__T(__OP2(__PP225277._r_Source_Customer_,<>,__PP225277._r_Customer_))=>0,1);
    SELF := __PP225277;
  END;
  EXPORT __ENH_Event_4 := PROJECT(__EE227174,__ND225281__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_4',EXPIRE(7));
END;
