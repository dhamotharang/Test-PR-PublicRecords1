...
EXPORT B_Event_4 := MODULE
  ...
  SHARED __EE112450 := __ENH_Event_5;
  SHARED __EE113065 := __EE112450;
  SHARED __ST114027_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __ST114027_Layout __JT114024(B_Event_5.__ST42149_Layout __l, E_Event.Event_Types_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE114025 := NORMALIZE(__EE113065,__T(LEFT.Event_Types_),__JT114024(LEFT,RIGHT));
  SHARED __ST113311_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Event_Type_;
    KEL.typ.ndataset(E_Event.Event_Types_Layout) Event_Types_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE114245 := PROJECT(__EE114025,__ST113311_Layout);
  SHARED __ST113340_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    KEL.typ.nbool Exp2_;
    KEL.typ.nbool Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST113340_Layout __ND116042__Project(__ST113311_Layout __PP116014) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP116014.Event_Type_,IN,__CN(['10000','10001','10002','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12005','12006','12007','13000','13001','13002','13003','13004','13005','13006','13007','1400','14901']));
    SELF.Exp2_ := __OP2(__PP116014.Event_Type_,IN,__CN(['14900','14903']));
    SELF.Exp3_ := __OP2(__PP116014.Event_Type_,IN,__CN(['10003','10004','14001','14902']));
    SELF := __PP116014;
  END;
  SHARED __EE116052 := PROJECT(__EE114245,__ND116042__Project(LEFT));
  SHARED __ST113365_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE117078 := PROJECT(__CLEANANDDO(__EE116052,TABLE(__EE116052,{KEL.typ.int C_O_U_N_T___Event_Types_ := COUNT(GROUP,__T(__EE116052.Exp1_)),KEL.typ.int C_O_U_N_T___Event_Types__1_ := COUNT(GROUP,__T(__EE116052.Exp2_)),KEL.typ.int C_O_U_N_T___Event_Types__2_ := COUNT(GROUP,__T(__EE116052.Exp3_)),UID},UID,MERGE)),__ST113365_Layout);
  SHARED __ST114252_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC117087(B_Event_5.__ST42149_Layout __EE112450, __ST113365_Layout __EE117078) := __EEQP(__EE112450.UID,__EE117078.UID);
  __ST114252_Layout __JT117087(B_Event_5.__ST42149_Layout __l, __ST113365_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE117088 := JOIN(__EE112450,__EE117078,__JC117087(LEFT,RIGHT),__JT117087(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST41034_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST41034_Layout __ND116287__Project(__ST114252_Layout __PP116283) := TRANSFORM
    SELF.Kr_High_Risk_Identity_Flag_ := MAP(__PP116283.Kr_Identity_Risk_ = 1 OR __T(__OP2(__CN(__PP116283.C_O_U_N_T___Event_Types_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Identity_Flag_ := MAP(__T(__OP2(__CN(__PP116283.C_O_U_N_T___Event_Types__1_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Identity_Flag_ := MAP(__T(__OP2(__CN(__PP116283.C_O_U_N_T___Event_Types__2_),<>,__CN(0)))=>1,0);
    SELF := __PP116283;
  END;
  EXPORT __ENH_Event_4 := PROJECT(__EE117088,__ND116287__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_4',EXPIRE(7));
END;
