...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE2678983 := PROJECT(B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped,E_Person_S_S_N.Layout);
  SHARED __EE2678986 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2591456_Layout := RECORD
  ...
  END;
  __JC2678994(E_Person_S_S_N.Layout __EE2678983, B_Person.__ST45521_Layout __EE2678986) := __EEQP(__EE2678983.Subject_,__EE2678986.UID);
  __ST2591456_Layout __JT2678994(E_Person_S_S_N.Layout __l, B_Person.__ST45521_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2678995 := JOIN(__EE2678983,__EE2678986,__JC2678994(LEFT,RIGHT),__JT2678994(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2679265 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST2591770_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2679273(__ST2591456_Layout __EE2678995, B_Social_Security_Number.__ST46960_Layout __EE2679265) := __EEQP(__EE2678995.Social_,__EE2679265.UID);
  __ST2591770_Layout __JT2679273(__ST2591456_Layout __l, B_Social_Security_Number.__ST46960_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2679274 := JOIN(__EE2678995,__EE2679265,__JC2679273(LEFT,RIGHT),__JT2679273(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2680127 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2592247_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2680141(__ST2591770_Layout __EE2679274, E_Customer.Layout __EE2680127) := __EEQP(__EE2679274._r_Customer_,__EE2680127.UID);
  __ST2592247_Layout __JT2680141(__ST2591770_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2680504 := JOIN(__EE2679274,__EE2680127,__JC2680141(LEFT,RIGHT),__JT2680141(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2591361_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2591361_Layout __ND2680858__Project(__ST2592247_Layout __PP2680505) := TRANSFORM
    SELF.Source_Customer_ := __PP2680505._r_Customer_;
    SELF.Customer_Id_ := __PP2680505.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2680505.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2680505.Entity_Context_Uid__1_;
    SELF := __PP2680505;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2680504,__ND2680858__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2591361_Layout));
END;
