...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE4353461 := PROJECT(B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped,E_Person_S_S_N.Layout);
  SHARED __EE4353464 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4257543_Layout := RECORD
  ...
  END;
  __JC4353472(E_Person_S_S_N.Layout __EE4353461, B_Person.__ST66421_Layout __EE4353464) := __EEQP(__EE4353461.Subject_,__EE4353464.UID);
  __ST4257543_Layout __JT4353472(E_Person_S_S_N.Layout __l, B_Person.__ST66421_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4353473 := JOIN(__EE4353461,__EE4353464,__JC4353472(LEFT,RIGHT),__JT4353472(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4353765 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST4257881_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4353773(__ST4257543_Layout __EE4353473, B_Social_Security_Number.__ST68283_Layout __EE4353765) := __EEQP(__EE4353473.Social_,__EE4353765.UID);
  __ST4257881_Layout __JT4353773(__ST4257543_Layout __l, B_Social_Security_Number.__ST68283_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4353774 := JOIN(__EE4353473,__EE4353765,__JC4353773(LEFT,RIGHT),__JT4353773(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4354715 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4258412_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4354729(__ST4257881_Layout __EE4353774, E_Customer.Layout __EE4354715) := __EEQP(__EE4353774._r_Customer_,__EE4354715.UID);
  __ST4258412_Layout __JT4354729(__ST4257881_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4355128 := JOIN(__EE4353774,__EE4354715,__JC4354729(LEFT,RIGHT),__JT4354729(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4257448_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4257448_Layout __ND4355518__Project(__ST4258412_Layout __PP4355129) := TRANSFORM
    SELF.Source_Customer_ := __PP4355129._r_Customer_;
    SELF.Customer_Id_ := __PP4355129.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4355129.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4355129.Entity_Context_Uid__1_;
    SELF := __PP4355129;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4355128,__ND4355518__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4257448_Layout));
END;
