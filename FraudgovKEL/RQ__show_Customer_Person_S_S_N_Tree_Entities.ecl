...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE4405035 := PROJECT(B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped,E_Person_S_S_N.Layout);
  SHARED __EE4405038 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4307635_Layout := RECORD
  ...
  END;
  __JC4405046(E_Person_S_S_N.Layout __EE4405035, B_Person.__ST66766_Layout __EE4405038) := __EEQP(__EE4405035.Subject_,__EE4405038.UID);
  __ST4307635_Layout __JT4405046(E_Person_S_S_N.Layout __l, B_Person.__ST66766_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4405047 := JOIN(__EE4405035,__EE4405038,__JC4405046(LEFT,RIGHT),__JT4405046(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4405342 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST4307976_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4405350(__ST4307635_Layout __EE4405047, B_Social_Security_Number.__ST68660_Layout __EE4405342) := __EEQP(__EE4405047.Social_,__EE4405342.UID);
  __ST4307976_Layout __JT4405350(__ST4307635_Layout __l, B_Social_Security_Number.__ST68660_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4405351 := JOIN(__EE4405047,__EE4405342,__JC4405350(LEFT,RIGHT),__JT4405350(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4406310 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4308519_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4406324(__ST4307976_Layout __EE4405351, E_Customer.Layout __EE4406310) := __EEQP(__EE4405351._r_Customer_,__EE4406310.UID);
  __ST4308519_Layout __JT4406324(__ST4307976_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4406729 := JOIN(__EE4405351,__EE4406310,__JC4406324(LEFT,RIGHT),__JT4406324(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4307540_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4307540_Layout __ND4407125__Project(__ST4308519_Layout __PP4406730) := TRANSFORM
    SELF.Source_Customer_ := __PP4406730._r_Customer_;
    SELF.Customer_Id_ := __PP4406730.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4406730.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4406730.Entity_Context_Uid__1_;
    SELF := __PP4406730;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4406729,__ND4407125__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4307540_Layout));
END;
