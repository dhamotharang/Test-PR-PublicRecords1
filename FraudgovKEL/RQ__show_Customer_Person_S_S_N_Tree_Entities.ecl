...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE4233990 := PROJECT(B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped,E_Person_S_S_N.Layout);
  SHARED __EE4233993 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4152561_Layout := RECORD
  ...
  END;
  __JC4234001(E_Person_S_S_N.Layout __EE4233990, B_Person.__ST66581_Layout __EE4233993) := __EEQP(__EE4233990.Subject_,__EE4233993.UID);
  __ST4152561_Layout __JT4234001(E_Person_S_S_N.Layout __l, B_Person.__ST66581_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4234002 := JOIN(__EE4233990,__EE4233993,__JC4234001(LEFT,RIGHT),__JT4234001(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4234231 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST4152836_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4234239(__ST4152561_Layout __EE4234002, B_Social_Security_Number.__ST68181_Layout __EE4234231) := __EEQP(__EE4234002.Social_,__EE4234231.UID);
  __ST4152836_Layout __JT4234239(__ST4152561_Layout __l, B_Social_Security_Number.__ST68181_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4234240 := JOIN(__EE4234002,__EE4234231,__JC4234239(LEFT,RIGHT),__JT4234239(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4235019 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4153277_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4235033(__ST4152836_Layout __EE4234240, E_Customer.Layout __EE4235019) := __EEQP(__EE4234240._r_Customer_,__EE4235019.UID);
  __ST4153277_Layout __JT4235033(__ST4152836_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4235360 := JOIN(__EE4234240,__EE4235019,__JC4235033(LEFT,RIGHT),__JT4235033(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4152466_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4152466_Layout __ND4235678__Project(__ST4153277_Layout __PP4235361) := TRANSFORM
    SELF.Source_Customer_ := __PP4235361._r_Customer_;
    SELF.Customer_Id_ := __PP4235361.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4235361.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4235361.Entity_Context_Uid__1_;
    SELF := __PP4235361;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4235360,__ND4235678__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4152466_Layout));
END;
