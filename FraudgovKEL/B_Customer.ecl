...
EXPORT B_Customer := MODULE
  ...
  SHARED __EE2562278 := __ENH_Customer_1;
  SHARED __EE2562874 := __ENH_Person_1;
  SHARED __EE2562872 := __E_Customer_Person;
  SHARED __EE2572175 := __EE2562872(__NN(__EE2562872._r_Customer_) AND __NN(__EE2562872.Subject_));
  SHARED __ST2566939_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2572199(B_Person_1.__ST83106_Layout __EE2562874, E_Customer_Person.Layout __EE2572175) := __EEQP(__EE2572175.Subject_,__EE2562874.UID);
  __ST2566939_Layout __JT2572199(B_Person_1.__ST83106_Layout __l, E_Customer_Person.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2572200 := JOIN(__EE2572175,__EE2562874,__JC2572199(RIGHT,LEFT),__JT2572199(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2563586_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2563586_Layout __ND2572372__Project(__ST2566939_Layout __PP2572201) := TRANSFORM
    SELF.UID := __PP2572201._r_Customer__1_;
    SELF._r_Customer_ := __PP2572201._r_Customer__1_;
    SELF.U_I_D__1_ := __PP2572201.UID;
    SELF._r_Customer__1_ := __PP2572201._r_Customer_;
    SELF := __PP2572201;
  END;
  SHARED __EE2572911 := PROJECT(__EE2572200,__ND2572372__Project(LEFT));
  SHARED __ST2563943_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2563943_Layout __ND2572916__Project(__ST2563586_Layout __PP2572912) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2572912.Address_Count_);
    SELF.Exp2_ := __CN(__PP2572912.Event_Count_);
    SELF := __PP2572912;
  END;
  SHARED __EE2572931 := PROJECT(__EE2572911,__ND2572916__Project(LEFT));
  SHARED __EE2573147 := __EE2572931;
  SHARED __ST2566201_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  __ST2566201_WeightLayout := {KEL.typ.int M_E_D_I_A_N___Address_Count_,KEL.typ.int M_E_D_I_A_N___Event_Count_};
  __ST2566201_WeightLayout __ST2566201_WeightCalc(KEL.Aggregates.RankedFieldN __r) := TRANSFORM
  ...
  END;
  __ST2566201_Layout __ST2566201_Normalize(__ST2566201_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  __RK2573155 := KEL.Aggregates.RankingGroupedSmall2(__EE2573147,'Exp1_,Exp2_','UID',__ST2566201_WeightLayout,__ST2566201_Layout,__ST2566201_WeightCalc,__ST2566201_Normalize,TRUE,FALSE,TRUE);
  SHARED __EE2573170 := __RK2573155;
  SHARED __ST2568406_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2573176(B_Customer_1.__ST72603_Layout __EE2562278, __ST2566201_Layout __EE2573170) := __EEQP(__EE2562278.UID,__EE2573170.UID);
  __ST2568406_Layout __JT2573176(B_Customer_1.__ST72603_Layout __l, __ST2566201_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2573177 := JOIN(__EE2562278,__EE2573170,__JC2573176(LEFT,RIGHT),__JT2573176(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2563963_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2572952 := PROJECT(__CLEANANDDO(__EE2572931,TABLE(__EE2572931,{KEL.Aggregates.AveNG(__EE2572931.Exp1_) A_V_E___Address_Count_,KEL.Aggregates.AveNG(__EE2572931.Exp2_) A_V_E___Event_Count_,UID},UID,MERGE)),__ST2563963_Layout);
  SHARED __ST2568589_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Customer_Id_;
    KEL.typ.nint Industry_Type_;
    KEL.typ.nunk _ind__type__description_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2573212(__ST2568406_Layout __EE2573177, __ST2563963_Layout __EE2572952) := __EEQP(__EE2573177.UID,__EE2572952.UID);
  __ST2568589_Layout __JT2573212(__ST2568406_Layout __l, __ST2563963_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2573213 := JOIN(__EE2573177,__EE2572952,__JC2573212(LEFT,RIGHT),__JT2573212(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST48533_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST48533_Layout __ND2573250__Project(__ST2568589_Layout __PP2573214) := TRANSFORM
    SELF.All_Deceased_Matched_Percent_ := __PP2573214.All_Deceased_Matched_Person_Count_ / __PP2573214.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2573214.All_Deceased_Person_Count_ / __PP2573214.All_Person_Count_;
    SELF.All_High_Frequency_Address_Percent_ := __PP2573214.All_High_Frequency_Address_Count_ / __PP2573214.All_Address_Count_;
    SELF.Deceased_Person_Percent_ := __PP2573214.Deceased_Person_Count_ / __PP2573214.Person_Count_;
    SELF.High_Frequency_Address_Percent_ := __PP2573214.High_Frequency_Address_Count_ / __PP2573214.Address_Count_;
    SELF.Person_Address_Count_Average_ := __PP2573214.A_V_E___Address_Count_;
    SELF.Person_Address_Count_Median_ := __PP2573214.M_E_D_I_A_N___Address_Count_;
    SELF.Person_Event_Count_Average_ := __PP2573214.A_V_E___Event_Count_;
    SELF.Person_Event_Count_Median_ := __PP2573214.M_E_D_I_A_N___Event_Count_;
    SELF := __PP2573214;
  END;
  EXPORT __ENH_Customer := PROJECT(__EE2573213,__ND2573250__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Customer::Annotated',EXPIRE(7));
  SHARED __EE4415286 := __ENH_Customer;
  SHARED IDX_Customer_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4415286.Customer_Id_;
    __EE4415286.Industry_Type_;
    __EE4415286._ind__type__description_;
    __EE4415286.States_;
    __EE4415286.Person_Count_;
    __EE4415286.All_Person_Count_;
    __EE4415286.Deceased_Person_Count_;
    __EE4415286.Deceased_Person_Percent_;
    __EE4415286.All_Deceased_Person_Count_;
    __EE4415286.All_Deceased_Person_Percent_;
    __EE4415286.All_Deceased_Matched_Person_Count_;
    __EE4415286.All_Deceased_Matched_Percent_;
    __EE4415286.Address_Count_;
    __EE4415286.All_Address_Count_;
    __EE4415286.High_Frequency_Address_Count_;
    __EE4415286.All_High_Frequency_Address_Count_;
    __EE4415286.High_Frequency_Address_Percent_;
    __EE4415286.All_High_Frequency_Address_Percent_;
    __EE4415286.Person_Event_Count_Average_;
    __EE4415286.Person_Event_Count_Median_;
    __EE4415286.Person_Address_Count_Average_;
    __EE4415286.Person_Address_Count_Median_;
    __EE4415286.Jurisdiction_State_Top_;
    __EE4415286.Jurisdiction_State_;
    __EE4415286.Event_Date_Max_;
    __EE4415286.Date_First_Seen_;
    __EE4415286.Date_Last_Seen_;
    __EE4415286.__RecordCount;
  END;
  SHARED IDX_Customer_UID_Projected := PROJECT(__EE4415286,TRANSFORM(IDX_Customer_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4415288_Layout := RECORDOF(IDX_Customer_UID);
