...
EXPORT B_Address_3 := MODULE
  ...
  SHARED __EE444244 := __ENH_Address_4;
  SHARED __EE459318 := __E_Person_Address;
  SHARED __EE459325 := __EE459318(__NN(__EE459318.Location_));
  SHARED __ST454019_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE459339 := PROJECT(TABLE(PROJECT(__EE459325,TRANSFORM(__ST454019_Layout,SELF.UID := LEFT.Location_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST454019_Layout);
  SHARED __ST454037_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Address_ := 0;
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE459305 := PROJECT(__CLEANANDDO(__EE459339,TABLE(__EE459339,{KEL.typ.int C_O_U_N_T___Person_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST454037_Layout);
  SHARED __ST456280_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC459348(B_Address_4.__ST87585_Layout __EE444244, __ST454037_Layout __EE459305) := __EEQP(__EE444244.UID,__EE459305.UID);
  __ST456280_Layout __JT459348(B_Address_4.__ST87585_Layout __l, __ST454037_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE459349 := JOIN(__EE444244,__EE459305,__JC459348(LEFT,RIGHT),__JT459348(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE459309 := __ENH_Event_4;
  SHARED __EE459307 := __E_Address_Event;
  SHARED __EE461062 := __EE459307(__NN(__EE459307.Location_) AND __NN(__EE459307.Transaction_));
  SHARED __ST454283_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC461080(B_Event_4.__ST90131_Layout __EE459309, E_Address_Event.Layout __EE461062) := __EEQP(__EE461062.Transaction_,__EE459309.UID);
  __ST454283_Layout __JT461080(B_Event_4.__ST90131_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE461081 := JOIN(__EE461062,__EE459309,__JC461080(RIGHT,LEFT),__JT461080(RIGHT,LEFT),INNER,HASH);
  SHARED __ST452067_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST452067_Layout __ND461487__Project(__ST454283_Layout __PP461082) := TRANSFORM
    SELF.UID := __PP461082.Location__1_;
    SELF._r_Customer_ := __PP461082._r_Customer__1_;
    SELF.Location_ := __PP461082.Location__1_;
    SELF.Event_Date_ := __PP461082.Event_Date__1_;
    SELF.U_I_D__1_ := __PP461082.UID;
    SELF._r_Customer__1_ := __PP461082._r_Customer_;
    SELF.Location__1_ := __PP461082.Location_;
    SELF.Event_Date__1_ := __PP461082.Event_Date_;
    SELF := __PP461082;
  END;
  SHARED __EE463064 := PROJECT(__EE461081,__ND461487__Project(LEFT));
  SHARED __ST452895_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST452895_Layout __ND463069__Project(__ST452067_Layout __PP463065) := TRANSFORM
    SELF.Exp1_ := IF(__PP463065.T___In_Agency_Flag_ = 1 AND __PP463065.T9___Addr_Is_Kr_Flag_ = 1,__ECAST(KEL.typ.nkdate,__PP463065.T___Act_Dt_Echo_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp2_ := __PP463065.T___In_Agency_Flag_ = 0 AND __PP463065.T9___Addr_Is_Kr_Flag_ = 1;
    SELF.Exp3_ := __PP463065.T___In_Agency_Flag_ = 1 AND __PP463065.T9___Addr_Is_Safe_Flag_ = 1;
    SELF := __PP463065;
  END;
  SHARED __EE463108 := PROJECT(__EE463064,__ND463069__Project(LEFT));
  SHARED __ST452925_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE463139 := PROJECT(__CLEANANDDO(__EE463108,TABLE(__EE463108,{KEL.Aggregates.MaxNG(__EE463108.Exp1_) M_A_X___T___Act_Dt_Echo_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE463108.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE463108.Exp3_),KEL.Aggregates.MaxNG(__EE463108.Event_Date__1_) M_A_X___Event_Date__1_,UID},UID,MERGE)),__ST452925_Layout);
  SHARED __ST456504_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC463145(__ST456280_Layout __EE459349, __ST452925_Layout __EE463139) := __EEQP(__EE459349.UID,__EE463139.UID);
  __ST456504_Layout __JT463145(__ST456280_Layout __l, __ST452925_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE463146 := JOIN(__EE459349,__EE463139,__JC463145(LEFT,RIGHT),__JT463145(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST83312_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST83312_Layout __ND463198__Project(__ST456504_Layout __PP463147) := TRANSFORM
    SELF.Aot_Addr_Kr_Act_New_Dt_Ev_ := __PP463147.M_A_X___T___Act_Dt_Echo_;
    SELF.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_ := MIN(__PP463147.C_O_U_N_T___Exp1_,9999);
    SELF.Aot_Addr_Safe_Act_Cnt_Ev_ := MIN(__PP463147.C_O_U_N_T___Exp1__1_,9999);
    SELF.Dt_Last_Seen_ := __PP463147.M_A_X___Event_Date__1_;
    SELF.Identity_Count_ := __PP463147.C_O_U_N_T___Person_Address_;
    SELF := __PP463147;
  END;
  EXPORT __ENH_Address_3 := PROJECT(__EE463146,__ND463198__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated_3',EXPIRE(7));
END;
