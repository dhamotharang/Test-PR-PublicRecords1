...
EXPORT B_Person_Phone := MODULE
  ...
  SHARED __EE3144770 := __E_Person_Phone;
  EXPORT __ST63473_Layout := RECORD
  ...
  END;
  SHARED __ST63473_Layout __ND3144804__Project(E_Person_Phone.Layout __PP3144665) := TRANSFORM
    __EE3144703 := __PP3144665.Event_Dates_;
    SELF.Dt_First_Seen_ := KEL.Aggregates.MinNN(__EE3144703,__T(__EE3144703).Event_Date_);
    __EE3144732 := __PP3144665.Event_Dates_;
    SELF.Dt_Last_Seen_ := KEL.Aggregates.MaxNN(__EE3144732,__T(__EE3144732).Event_Date_);
    SELF := __PP3144665;
  END;
  EXPORT __ENH_Person_Phone := PROJECT(__EE3144770,__ND3144804__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person_Phone::Annotated',EXPIRE(7));
  SHARED __EE3429434 := __ENH_Person_Phone;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE3429434(__NN(__EE3429434.Phone_Number_));
  ...
  EXPORT __ST3429436_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
  EXPORT IDX_Person_Phone_Phone_Number__Wrapped := PROJECT(IDX_Person_Phone_Phone_Number_,TRANSFORM(__ST63473_Layout,SELF.Phone_Number_ := __CN(LEFT.Phone_Number_),SELF:=LEFT));
