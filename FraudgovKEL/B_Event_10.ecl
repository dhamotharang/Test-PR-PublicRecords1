...
EXPORT B_Event_10 := MODULE
  ...
  SHARED __EE113461 := __ENH_Event_11;
  EXPORT __ST107384_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST107384_Layout __ND114078__Project(B_Event_11.__ST107996_Layout __PP111936) := TRANSFORM
