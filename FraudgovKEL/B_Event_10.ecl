...
EXPORT B_Event_10 := MODULE
  ...
  SHARED __EE117225 := __ENH_Event_11;
  EXPORT __ST111148_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST111148_Layout __ND117842__Project(B_Event_11.__ST111760_Layout __PP115700) := TRANSFORM
    SELF.T___Src_Class_Type_ := MAP(__T(__OP2(__PP115700.T___Src_Type_,=,__CN(-99997)))=> -99997,__T(__OP2(__PP115700.T___Src_Type_,IN,__CN([6,14])))=>0,__T(__OP2(__PP115700.T___Src_Type_,IN,__CN([4,8,11])))=>1,__T(__OP2(__PP115700.T___Src_Type_,IN,__CN([3,7])))=>2,__T(__OP2(__PP115700.T___Src_Type_,IN,__CN([2,5])))=>3,4);
    SELF := __PP115700;
  END;
  EXPORT __ENH_Event_10 := PROJECT(__EE117225,__ND117842__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Event::Annotated_10',EXPIRE(7));
END;
