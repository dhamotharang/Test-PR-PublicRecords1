...
EXPORT B_Event_7 := MODULE
  ...
  SHARED __EE127336 := __ENH_Event_8;
  EXPORT __ST102914_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST102914_Layout __ND128032__Project(B_Event_8.__ST104147_Layout __PP125314) := TRANSFORM
    SELF.Deceased_ := MAP(__T(__FN1(KEL.Routines.IsValidDate,__PP125314.Deceased_Date_))=>1,0);
    SELF.Deceased_Dob_Match_ := MAP(__T(__OP2(__PP125314.Deceased_Date_Of_Birth_,=,__PP125314.Date_Of_Birth_))=>1,0);
    SELF.Deceased_Name_Match_ := MAP(__T(__AND(__OP2(__PP125314.First_Name_,=,__PP125314.Deceased_First_),__OP2(__PP125314.Last_Name_,=,__PP125314.Deceased_Last_)))=>1,0);
    SELF.T15___Ssn_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP125314.T___Inp_Cln_Ssn_Echo_,<=,__CAST(KEL.typ.str,__CN(-99997))),__OP2(__FN1(LENGTH,__PP125314.T___Inp_Cln_Ssn_Echo_),<,__CN(9))))=>0,1);
    SELF.T16___Phn_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP125314.T___Inp_Cln_Phn_Echo_,IN,__CN(['-99999','-99998','-99997'])),__OP2(__FN1(LENGTH,__PP125314.T___Inp_Cln_Phn_Echo_),<,__CN(10))))=>0,1);
    SELF.T17___Email_Pop_Flag_ := MAP(__T(__OR(__OR(__OP2(__FN3(KEL.Routines.Word,__PP125314.Email_Address_,__CN(1),__CN('@')),=,__CN('')),__OP2(__FN3(KEL.Routines.Word,__PP125314.Email_Address_,__CN(2),__CN('@')),=,__CN(''))),__OP2(__PP125314.T___Inp_Cln_Email_Echo_,=,__CAST(KEL.typ.str,__CN(-99999)))))=>0,1);
    SELF.T18___Ip_Addr_Pop_Flag_ := MAP(__T(__OP2(__PP125314.T___Inp_Cln_Ip_Addr_Echo_,IN,__CN(['-99999','-99998','-99997'])))=>0,1);
    SELF.T19___Bnk_Acct_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP125314.T___Inp_Cln_Bnk_Acct_Echo_,IN,__CN(['-99999','-99998'])),__OP2(__PP125314.T___Inp_Cln_Bnk_Acct_Rtg_Echo_,IN,__CN(['-99999','-99998']))))=>0,1);
    SELF.T1___Id_Is_Kr_App_Frd_Flag_ := MAP(__PP125314.T1___Lex_Id_Pop_Flag_ = 0 AND __PP125314.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP125314.T___Src_Class_Type_ <> 3=> -99998,__PP125314.Id_Kr_Code_Flag_ = 0=> -99997,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019'])),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019']))),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10002','10003','11003','11005','11017','11018','11019']))))=>1,0);
    SELF.T1___Id_Is_Kr_Gen_Frd_Flag_ := MAP(__PP125314.T1___Lex_Id_Pop_Flag_ = 0 AND __PP125314.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP125314.T___Src_Class_Type_ <> 3=> -99998,__PP125314.Id_Kr_Code_Flag_ = 0=> -99997,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10005','10006','10007','11000','11001','11002','11004','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007'])),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10005','10006','10007','11000','11001','11002','11004','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10005','10006','10007','11000','11001','11002','11004','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))))=>1,0);
    SELF.T1___Id_Is_Kr_Oth_Frd_Flag_ := MAP(__PP125314.T1___Lex_Id_Pop_Flag_ = 0 AND __PP125314.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP125314.T___Src_Class_Type_ <> 3=> -99998,__PP125314.Id_Kr_Code_Flag_ = 0=> -99997,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903'])),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903']))),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['14900','14901','14902','14903']))))=>1,0);
    SELF.T1___Id_Is_Kr_Stol_Id_Flag_ := MAP(__PP125314.T1___Lex_Id_Pop_Flag_ = 0 AND __PP125314.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP125314.T___Src_Class_Type_ <> 3=> -99998,__PP125314.Id_Kr_Code_Flag_ = 0=> -99997,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10000','10001','10004'])),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10000','10001','10004']))),__OP2(__CAST(KEL.typ.str,__PP125314.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10000','10001','10004']))))=>1,0);
    SELF.T20___Dl_Pop_Flag_ := MAP(__T(__OR(__OP2(__PP125314.T___Inp_Cln_Dl_Echo_,IN,__CN(['-99999','-99998','-99997'])),__OP2(__PP125314.T___Inp_Cln_Dl_St_Echo_,IN,__CN(['-99999','-99998','-99997']))))=>0,1);
    SELF.T9___Addr_Pop_Flag_ := MAP(__T(__OR(__AND(__AND(__OP2(__PP125314.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP125314.T___Inp_Cln_Addr_City_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__OP2(__PP125314.T___Inp_Cln_Addr_St_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999)))),__AND(__OP2(__PP125314.T___Inp_Cln_Addr_Prim_Nm_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))),__OP2(__PP125314.T___Inp_Cln_Addr_Zip5_Echo_,<>,__CAST(KEL.typ.str,__CN(-99999))))))=>1,0);
    SELF.T___Addr_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._physical__address__risk__code_),=,__CN('')),__NT(__PP125314._physical__address__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._physical__address__risk__code_));
    SELF.T___Bnk_Acct_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._bank__account__1__risk__code_),=,__CN('')),__NT(__PP125314._bank__account__1__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._bank__account__1__risk__code_));
    SELF.T___Dl_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._drivers__license__risk__code_),=,__CN('')),__NT(__PP125314._drivers__license__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._drivers__license__risk__code_));
    SELF.T___Email_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._email__address__risk__code_),=,__CN('')),__NT(__PP125314._email__address__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._email__address__risk__code_));
    SELF.T___Ip_Addr_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._ip__address__fraud__code_),=,__CN('')),__NT(__PP125314._ip__address__fraud__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._ip__address__fraud__code_));
    SELF.T___Is_Bc_Shll_Hit_Flag_ := MAP(__T(__OP2(__PP125314.Bocashell_Hit_,=,__CN(TRUE)))=>1,0);
    SELF.T___Phn_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._phone__risk__code_),=,__CN('')),__NT(__PP125314._phone__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._phone__risk__code_));
    SELF.T___Ssn_Status_Code_Echo_ := MAP(__PP125314.T___Src_Class_Type_ <> 2 AND __PP125314.T___Src_Class_Type_ <> 3 AND __PP125314.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP125314._ssn__risk__code_),=,__CN('')),__NT(__PP125314._ssn__risk__code_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP125314._ssn__risk__code_));
    SELF := __PP125314;
  END;
  EXPORT __ENH_Event_7 := PROJECT(__EE127336,__ND128032__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_7',EXPIRE(7));
END;
