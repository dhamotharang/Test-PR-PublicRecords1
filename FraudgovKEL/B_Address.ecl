...
EXPORT B_Address := MODULE
  ...
  SHARED __EE1516458 := __ENH_Address_1;
  SHARED __EE1520101 := __ENH_Event_1;
  SHARED __EE1520103 := __E_Address_Event;
  SHARED __EE1564306 := __EE1520103(__NN(__EE1520103.Location_) AND __NN(__EE1520103.Transaction_));
  SHARED __ST1555342_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1564324(B_Event_1.__ST53480_Layout __EE1520101, E_Address_Event.Layout __EE1564306) := __EEQP(__EE1564306.Transaction_,__EE1520101.UID);
  __ST1555342_Layout __JT1564324(B_Event_1.__ST53480_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1564325 := JOIN(__EE1564306,__EE1520101,__JC1564324(RIGHT,LEFT),__JT1564324(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1552116_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1552116_Layout __ND1564920__Project(__ST1555342_Layout __PP1564326) := TRANSFORM
    SELF.UID := __PP1564326.Location__1_;
    SELF.U_I_D__1_ := __PP1564326.UID;
    SELF := __PP1564326;
  END;
  SHARED __EE1567253 := PROJECT(__EE1564325,__ND1564920__Project(LEFT));
  SHARED __ST1553363_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1553363_Layout __ND1568298__Project(__ST1552116_Layout __PP1567254) := TRANSFORM
    SELF.Exp1_ := __CN(__PP1567254.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP1567254.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP1567254.Address_Is_Vacant_);
    SELF.Exp4_ := __PP1567254.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP1567254.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP1567254.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP1567254.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP1567254.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP1567254.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP1567254.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP1567254.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP1567254.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP1567254.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP1567254.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP1567254.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP1567254.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP1567254.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP1567254.Event_Age_,<,__CN(2)),__CN(__PP1567254.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP1567254.Event_Age_,<,__CN(366));
    SELF := __PP1567254;
  END;
  SHARED __EE1568327 := PROJECT(__EE1567253,__ND1568298__Project(LEFT));
  SHARED __ST1553476_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1568446 := PROJECT(__CLEANANDDO(__EE1568327,TABLE(__EE1568327,{KEL.Aggregates.MaxNG(__EE1568327.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE1568327.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE1568327.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1568327.Exp4_),KEL.Aggregates.MinNG(__EE1568327.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1568327.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1568327.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1568327.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1568327.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1568327.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1568327.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1568327.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1568327.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1568327.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1568327.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1568327.Exp15_),KEL.Aggregates.MaxNG(__EE1568327.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1568327.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1568327.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1568327.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1568327.Exp19_)),UID},UID,MERGE)),__ST1553476_Layout);
  SHARED __ST1558282_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1568452(B_Address_1.__ST47409_Layout __EE1516458, __ST1553476_Layout __EE1568446) := __EEQP(__EE1516458.UID,__EE1568446.UID);
  __ST1558282_Layout __JT1568452(B_Address_1.__ST47409_Layout __l, __ST1553476_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1568546 := JOIN(__EE1516458,__EE1568446,__JC1568452(LEFT,RIGHT),__JT1568452(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1505298 := __ENH_Customer_1;
  SHARED __ST1558974_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1568552(__ST1558282_Layout __EE1568546, B_Customer_1.__ST47866_Layout __EE1505298) := __EEQP(__EE1568546._r_Customer_,__EE1505298.UID);
  __ST1558974_Layout __JT1568552(__ST1558282_Layout __l, B_Customer_1.__ST47866_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1568674 := JOIN(__EE1568546,__EE1505298,__JC1568552(LEFT,RIGHT),__JT1568552(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST31956_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31956_Layout __ND1568679__Project(__ST1558974_Layout __PP1568675) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP1568675.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP1568675.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP1568675.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP1568675.All_Deceased_Match_Person_Count_ / __PP1568675.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP1568675.All_Deceased_Person_Count_ / __PP1568675.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP1568675.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP1568675.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP1568675.Deceased_Match_Person_Count_ / __PP1568675.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP1568675.Deceased_Person_Count_ / __PP1568675.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP1568675.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP1568675.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP1568675.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP1568675.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP1568675.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1568675.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP1568675.State_,<>,__PP1568675.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1568675.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1568675.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1568675.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP1568675.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP1568675.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP1568675.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1568675.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1568675.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1568675.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1568675.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1568675.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1568675;
  END;
  EXPORT __ENH_Address := PROJECT(__EE1568674,__ND1568679__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE2603791 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2603791._r_Customer_;
    __EE2603791.Source_Customers_;
    __EE2603791._addresspobox_;
    __EE2603791._addresscmra_;
    __EE2603791.Otto_Address_Id_;
    __EE2603791.Primary_Range_;
    __EE2603791.Predirectional_;
    __EE2603791.Primary_Name_;
    __EE2603791.Suffix_;
    __EE2603791.Postdirectional_;
    __EE2603791.Unit_Designation_;
    __EE2603791.Secondary_Range_;
    __EE2603791.Postal_City_;
    __EE2603791.Vanity_City_;
    __EE2603791.State_;
    __EE2603791.Zip_;
    __EE2603791.Zip4_;
    __EE2603791.Carrier_Route_Number_;
    __EE2603791.Carrier_Route_Sortation_At_Z_I_P_;
    __EE2603791.Line_Of_Travel_;
    __EE2603791.Line_Of_Travel_Order_;
    __EE2603791.Delivery_Point_Barcode_;
    __EE2603791.Delivery_Point_Barcode_Check_Digit_;
    __EE2603791.Type_Code_;
    __EE2603791.County_;
    __EE2603791.Latitude_;
    __EE2603791.Longitude_;
    __EE2603791.Metropolitan_Statistical_Area_;
    __EE2603791.Geo_Block_;
    __EE2603791.Geo_Match_;
    __EE2603791.A_C_E_Cleaner_Error_Code_;
    __EE2603791._is_Additional_;
    __EE2603791.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE2603791.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2603791.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2603791.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE2603791.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2603791.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2603791.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE2603791.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2603791.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE2603791.Customer_Id_;
    __EE2603791.Industry_Type_;
    __EE2603791.In_Customer_Population_;
    __EE2603791.Source_Customer_Count_;
    __EE2603791.Full_Address_;
    __EE2603791.Street_Address_;
    __EE2603791.Entity_Context_Uid_;
    __EE2603791.Entity_Type_;
    __EE2603791.Dt_First_Seen_;
    __EE2603791.Dt_Last_Seen_;
    __EE2603791.Last_Record_Id_;
    __EE2603791.Not_In_Jurisdiction_State_;
    __EE2603791.Invalid_Address_;
    __EE2603791.Address_Is_Vacant_;
    __EE2603791.Address_Is_Cmra_;
    __EE2603791.Address_Is_Po_Box_;
    __EE2603791.Event_Count_;
    __EE2603791.Identity_Count_;
    __EE2603791.High_Frequency_Flag_;
    __EE2603791.All_Person_Count_;
    __EE2603791.All_High_Frequency_Flag_;
    __EE2603791.Deceased_Person_Count_;
    __EE2603791.Deceased_Person_Percent_;
    __EE2603791.All_Deceased_Person_Count_;
    __EE2603791.All_Deceased_Person_Percent_;
    __EE2603791.Deceased_Match_Person_Count_;
    __EE2603791.Deceased_Match_Person_Percent_;
    __EE2603791.All_Deceased_Match_Person_Count_;
    __EE2603791.All_Deceased_Match_Person_Percent_;
    __EE2603791.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2603791.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2603791.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE2603791.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2603791.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2603791.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE2603791.Vl_Event1_All_Count_;
    __EE2603791.Vl_Event7_All_Count_;
    __EE2603791.Vl_Event30_All_Day_Count_;
    __EE2603791.Vl_Event365_All_Day_Count_;
    __EE2603791.Vl_Event7_All_Active_Flag_;
    __EE2603791.Vl_Event30_All_Active_Flag_;
    __EE2603791.Vl_Event1_Count_;
    __EE2603791.Vl_Event7_Count_;
    __EE2603791.Vl_Event30_Count_;
    __EE2603791.Vl_Event365_Count_;
    __EE2603791.Vl_Event7_Active_Flag_;
    __EE2603791.Vl_Event30_Active_Flag_;
    __EE2603791.Kr_High_Risk_Flag_;
    __EE2603791.Kr_Medium_Risk_Flag_;
    __EE2603791.Kr_Low_Risk_Flag_;
    __EE2603791.Kr_Flag_;
    __EE2603791.Safe_Flag_;
    __EE2603791.Contributor_Safe_Flag_;
    __EE2603791.Kr_Addr300_Flag_;
    __EE2603791.Kr_Addr301_Flag_;
    __EE2603791.Kr_Addr302_Flag_;
    __EE2603791.Kr_Addr303_Flag_;
    __EE2603791.Kr_Addr390_Flag_;
    __EE2603791.Kr_Addr391_Flag_;
    __EE2603791.Kr_Addr392_Flag_;
    __EE2603791.Kr_Addr393_Flag_;
    __EE2603791.Last_Event_Date_;
    __EE2603791.Kr_Last_Event_Date_;
    __EE2603791.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2603791.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2603791.Date_First_Seen_;
    __EE2603791.Date_Last_Seen_;
    __EE2603791.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE2603791,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2603793_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST31956_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
