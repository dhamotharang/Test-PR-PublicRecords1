...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2374481 := __ENH_Address_1;
  SHARED __EE2378688 := __ENH_Event_1;
  SHARED __EE2378690 := __E_Address_Event;
  SHARED __EE2432607 := __EE2378690(__NN(__EE2378690.Location_) AND __NN(__EE2378690.Transaction_));
  SHARED __ST2422245_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2432625(B_Event_1.__ST78198_Layout __EE2378688, E_Address_Event.Layout __EE2432607) := __EEQP(__EE2432607.Transaction_,__EE2378688.UID);
  __ST2422245_Layout __JT2432625(B_Event_1.__ST78198_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2432626 := JOIN(__EE2432607,__EE2378688,__JC2432625(RIGHT,LEFT),__JT2432625(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2418531_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2418531_Layout __ND2433327__Project(__ST2422245_Layout __PP2432627) := TRANSFORM
    SELF.UID := __PP2432627.Location__1_;
    SELF.U_I_D__1_ := __PP2432627.UID;
    SELF := __PP2432627;
  END;
  SHARED __EE2436084 := PROJECT(__EE2432626,__ND2433327__Project(LEFT));
  SHARED __ST2419996_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2419996_Layout __ND2437244__Project(__ST2418531_Layout __PP2436085) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2436085.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2436085.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2436085.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2436085.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := IF(__PP2436085.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2436085.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp6_ := __PP2436085.Kr_Addr300_Flag_ = 1;
    SELF.Exp7_ := __PP2436085.Kr_Addr301_Flag_ = 1;
    SELF.Exp8_ := __PP2436085.Kr_Addr302_Flag_ = 1;
    SELF.Exp9_ := __PP2436085.Kr_Addr303_Flag_ = 1;
    SELF.Exp10_ := __PP2436085.Kr_Addr390_Flag_ = 1;
    SELF.Exp11_ := __PP2436085.Kr_Addr391_Flag_ = 1;
    SELF.Exp12_ := __PP2436085.Kr_Addr392_Flag_ = 1;
    SELF.Exp13_ := __PP2436085.Kr_Addr393_Flag_ = 1;
    SELF.Exp14_ := __PP2436085.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2436085.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2436085.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp17_ := __PP2436085.Safe_Flag_ = 1;
    SELF.Exp18_ := __OP2(__PP2436085.Event_Age_,<,__CN(2));
    SELF.Exp19_ := __AND(__OP2(__PP2436085.Event_Age_,<,__CN(2)),__CN(__PP2436085.In_Customer_Population_ = 1));
    SELF.Exp20_ := __OP2(__PP2436085.Event_Age_,<,__CN(366));
    SELF := __PP2436085;
  END;
  SHARED __EE2437274 := PROJECT(__EE2436084,__ND2437244__Project(LEFT));
  SHARED __ST2420114_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2437398 := PROJECT(__CLEANANDDO(__EE2437274,TABLE(__EE2437274,{KEL.Aggregates.MaxNG(__EE2437274.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2437274.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2437274.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2437274.Exp4_),KEL.Aggregates.MinNG(__EE2437274.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2437274.Exp5_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2437274.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2437274.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2437274.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2437274.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2437274.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2437274.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2437274.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2437274.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2437274.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2437274.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2437274.Exp16_),KEL.Aggregates.MaxNG(__EE2437274.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2437274.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2437274.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2437274.Exp19_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2437274.Exp20_)),UID},UID,MERGE)),__ST2420114_Layout);
  SHARED __ST2425715_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2437404(B_Address_1.__ST69323_Layout __EE2374481, __ST2420114_Layout __EE2437398) := __EEQP(__EE2374481.UID,__EE2437398.UID);
  __ST2425715_Layout __JT2437404(B_Address_1.__ST69323_Layout __l, __ST2420114_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2437515 := JOIN(__EE2374481,__EE2437398,__JC2437404(LEFT,RIGHT),__JT2437404(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2356027 := __ENH_Customer_1;
  SHARED __ST2426492_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2437521(__ST2425715_Layout __EE2437515, B_Customer_1.__ST70014_Layout __EE2356027) := __EEQP(__EE2437515._r_Customer_,__EE2356027.UID);
  __ST2426492_Layout __JT2437521(__ST2425715_Layout __l, B_Customer_1.__ST70014_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2437660 := JOIN(__EE2437515,__EE2356027,__JC2437521(LEFT,RIGHT),__JT2437521(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46104_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46104_Layout __ND2437665__Project(__ST2426492_Layout __PP2437661) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2437661.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2437661.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2437661.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2437661.All_Deceased_Match_Person_Count_ / __PP2437661.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2437661.All_Deceased_Person_Count_ / __PP2437661.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2437661.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2437661.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2437661.Deceased_Match_Person_Count_ / __PP2437661.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2437661.Deceased_Person_Count_ / __PP2437661.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2437661.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2437661.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2437661.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2437661.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Id_Activity_Dt_First_Seen_ := __PP2437661.M_I_N___Event_Date__2_;
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2437661.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2437661.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2437661.State_,<>,__PP2437661.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2437661.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2437661.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2437661.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2437661.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP2437661.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP2437661.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2437661.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2437661.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2437661.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2437661.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2437661.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2437661;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2437660,__ND2437665__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE4316263 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4316263._r_Customer_;
    __EE4316263.Source_Customers_;
    __EE4316263._addresspobox_;
    __EE4316263._addresscmra_;
    __EE4316263.Otto_Address_Id_;
    __EE4316263.Primary_Range_;
    __EE4316263.Predirectional_;
    __EE4316263.Primary_Name_;
    __EE4316263.Suffix_;
    __EE4316263.Postdirectional_;
    __EE4316263.Unit_Designation_;
    __EE4316263.Secondary_Range_;
    __EE4316263.Postal_City_;
    __EE4316263.Vanity_City_;
    __EE4316263.State_;
    __EE4316263.Zip_;
    __EE4316263.Zip4_;
    __EE4316263.Carrier_Route_Number_;
    __EE4316263.Carrier_Route_Sortation_At_Z_I_P_;
    __EE4316263.Line_Of_Travel_;
    __EE4316263.Line_Of_Travel_Order_;
    __EE4316263.Delivery_Point_Barcode_;
    __EE4316263.Delivery_Point_Barcode_Check_Digit_;
    __EE4316263.Type_Code_;
    __EE4316263.County_;
    __EE4316263.Latitude_;
    __EE4316263.Longitude_;
    __EE4316263.Metropolitan_Statistical_Area_;
    __EE4316263.Geo_Block_;
    __EE4316263.Geo_Match_;
    __EE4316263.A_C_E_Cleaner_Error_Code_;
    __EE4316263._is_Additional_;
    __EE4316263.Aot_Act_Cnt_Ev_;
    __EE4316263.Aot_Src1_Act_Cnt_Ev_;
    __EE4316263.Aot_Src1_Act_Only_Flag_;
    __EE4316263.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE4316263.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4316263.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4316263.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE4316263.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4316263.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4316263.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE4316263.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4316263.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE4316263.Aot_Id_Act_Cnt_Ev_;
    __EE4316263.Aot_Id_Act_Cnt30_D_;
    __EE4316263.Ao_T_Add_Act_Cnt_Ev_;
    __EE4316263.Ao_T_Add_Act_Cnt30_D_;
    __EE4316263.Aot_Non_St_Act_Cnt_Ev_;
    __EE4316263.Aot_Non_St_Act_Cnt30_D_;
    __EE4316263.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4316263.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4316263.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4316263.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE4316263.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE4316263.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE4316263.Customer_Id_;
    __EE4316263.Industry_Type_;
    __EE4316263.In_Customer_Population_;
    __EE4316263.Source_Customer_Count_;
    __EE4316263.Full_Address_;
    __EE4316263.Street_Address_;
    __EE4316263.Entity_Context_Uid_;
    __EE4316263.Entity_Type_;
    __EE4316263.Dt_First_Seen_;
    __EE4316263.Dt_Last_Seen_;
    __EE4316263.Id_Activity_Dt_First_Seen_;
    __EE4316263.Id_Activity_Dt_Last_Seen_;
    __EE4316263.Last_Record_Id_;
    __EE4316263.Not_In_Jurisdiction_State_;
    __EE4316263.Invalid_Address_;
    __EE4316263.Address_Is_Vacant_;
    __EE4316263.Address_Is_Cmra_;
    __EE4316263.Address_Is_Po_Box_;
    __EE4316263.Event_Count_;
    __EE4316263.Identity_Count_;
    __EE4316263.High_Frequency_Flag_;
    __EE4316263.All_Person_Count_;
    __EE4316263.All_High_Frequency_Flag_;
    __EE4316263.Deceased_Person_Count_;
    __EE4316263.Deceased_Person_Percent_;
    __EE4316263.All_Deceased_Person_Count_;
    __EE4316263.All_Deceased_Person_Percent_;
    __EE4316263.Deceased_Match_Person_Count_;
    __EE4316263.Deceased_Match_Person_Percent_;
    __EE4316263.All_Deceased_Match_Person_Count_;
    __EE4316263.All_Deceased_Match_Person_Percent_;
    __EE4316263.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4316263.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4316263.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4316263.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4316263.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4316263.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4316263.Vl_Event1_All_Count_;
    __EE4316263.Vl_Event7_All_Count_;
    __EE4316263.Vl_Event30_All_Day_Count_;
    __EE4316263.Vl_Event365_All_Day_Count_;
    __EE4316263.Vl_Event7_All_Active_Flag_;
    __EE4316263.Vl_Event30_All_Active_Flag_;
    __EE4316263.Vl_Event1_Count_;
    __EE4316263.Vl_Event7_Count_;
    __EE4316263.Vl_Event30_Count_;
    __EE4316263.Vl_Event365_Count_;
    __EE4316263.Vl_Event7_Active_Flag_;
    __EE4316263.Vl_Event30_Active_Flag_;
    __EE4316263.Kr_High_Risk_Flag_;
    __EE4316263.Kr_Medium_Risk_Flag_;
    __EE4316263.Kr_Low_Risk_Flag_;
    __EE4316263.Kr_Flag_;
    __EE4316263.Safe_Flag_;
    __EE4316263.Contributor_Safe_Flag_;
    __EE4316263.Kr_Addr300_Flag_;
    __EE4316263.Kr_Addr301_Flag_;
    __EE4316263.Kr_Addr302_Flag_;
    __EE4316263.Kr_Addr303_Flag_;
    __EE4316263.Kr_Addr390_Flag_;
    __EE4316263.Kr_Addr391_Flag_;
    __EE4316263.Kr_Addr392_Flag_;
    __EE4316263.Kr_Addr393_Flag_;
    __EE4316263.Last_Event_Date_;
    __EE4316263.Kr_Last_Event_Date_;
    __EE4316263.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4316263.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4316263.Date_First_Seen_;
    __EE4316263.Date_Last_Seen_;
    __EE4316263.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4316263,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4316265_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST46104_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
