...
EXPORT B_Address := MODULE
  ...
  SHARED __EE550507 := __ENH_Address_1;
  SHARED __EE553427 := __ENH_Event_1;
  SHARED __EE553429 := __E_Address_Event;
  SHARED __EE585926 := __EE553429(__NN(__EE553429.Location_) AND __NN(__EE553429.Transaction_));
  SHARED __ST578808_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC585944(B_Event_1.__ST33354_Layout __EE553427, E_Address_Event.Layout __EE585926) := __EEQP(__EE585926.Transaction_,__EE553427.UID);
  __ST578808_Layout __JT585944(B_Event_1.__ST33354_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE585945 := JOIN(__EE585926,__EE553427,__JC585944(RIGHT,LEFT),__JT585944(RIGHT,LEFT),INNER,HASH);
  SHARED __ST576262_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST576262_Layout __ND586370__Project(__ST578808_Layout __PP585946) := TRANSFORM
    SELF.UID := __PP585946.Location__1_;
    SELF.U_I_D__1_ := __PP585946.UID;
    SELF := __PP585946;
  END;
  SHARED __EE588023 := PROJECT(__EE585945,__ND586370__Project(LEFT));
  SHARED __ST577173_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST577173_Layout __ND589019__Project(__ST576262_Layout __PP588024) := TRANSFORM
    SELF.Exp1_ := __CN(__PP588024.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP588024.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP588024.Address_Is_Vacant_);
    SELF.Exp4_ := __PP588024.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP588024.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP588024.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP588024.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP588024.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP588024.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP588024.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP588024.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP588024.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP588024.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP588024.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP588024.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP588024.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP588024.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP588024.Event_Age_,<,__CN(2)),__CN(__PP588024.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP588024.Event_Age_,<,__CN(366));
    SELF := __PP588024;
  END;
  SHARED __EE589048 := PROJECT(__EE588023,__ND589019__Project(LEFT));
  SHARED __ST577289_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE589172 := PROJECT(__CLEANANDDO(__EE589048,TABLE(__EE589048,{KEL.Aggregates.MaxNG(__EE589048.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE589048.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE589048.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE589048.Exp4_),KEL.Aggregates.MinNG(__EE589048.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE589048.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE589048.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE589048.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE589048.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE589048.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE589048.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE589048.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE589048.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE589048.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE589048.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE589048.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE589048.Exp15_),KEL.Aggregates.MaxNG(__EE589048.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE589048.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE589048.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE589048.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE589048.Exp19_)),UID},UID,MERGE)),__ST577289_Layout);
  SHARED __ST580898_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC589178(B_Address_1.__ST30187_Layout __EE550507, __ST577289_Layout __EE589172) := __EEQP(__EE550507.UID,__EE589172.UID);
  __ST580898_Layout __JT589178(B_Address_1.__ST30187_Layout __l, __ST577289_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE589263 := JOIN(__EE550507,__EE589172,__JC589178(LEFT,RIGHT),__JT589178(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE538738 := __ENH_Customer_1;
  SHARED __ST581545_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC589269(__ST580898_Layout __EE589263, B_Customer_1.__ST30513_Layout __EE538738) := __EEQP(__EE589263._r_Customer_,__EE538738.UID);
  __ST581545_Layout __JT589269(__ST580898_Layout __l, B_Customer_1.__ST30513_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE589382 := JOIN(__EE589263,__EE538738,__JC589269(LEFT,RIGHT),__JT589269(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST20938_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20938_Layout __ND589387__Project(__ST581545_Layout __PP589383) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP589383.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP589383.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP589383.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP589383.All_Deceased_Match_Person_Count_ / __PP589383.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP589383.All_Deceased_Person_Count_ / __PP589383.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP589383.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP589383.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP589383.Deceased_Match_Person_Count_ / __PP589383.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP589383.Deceased_Person_Count_ / __PP589383.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP589383.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP589383.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP589383.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP589383.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP589383.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP589383.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP589383.M_A_X___Event_Date__2_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP589383.State_,<>,__PP589383.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP589383.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP589383.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP589383.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP589383.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP589383.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP589383.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP589383.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP589383.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP589383.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP589383.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP589383.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP589383;
  END;
  EXPORT __ENH_Address := PROJECT(__EE589382,__ND589387__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE1298010 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1298010._r_Customer_;
    __EE1298010.Source_Customers_;
    __EE1298010._addresspobox_;
    __EE1298010._addresscmra_;
    __EE1298010.Otto_Address_Id_;
    __EE1298010.Primary_Range_;
    __EE1298010.Predirectional_;
    __EE1298010.Primary_Name_;
    __EE1298010.Suffix_;
    __EE1298010.Postdirectional_;
    __EE1298010.Unit_Designation_;
    __EE1298010.Secondary_Range_;
    __EE1298010.Postal_City_;
    __EE1298010.Vanity_City_;
    __EE1298010.State_;
    __EE1298010.Zip_;
    __EE1298010.Zip4_;
    __EE1298010.Carrier_Route_Number_;
    __EE1298010.Carrier_Route_Sortation_At_Z_I_P_;
    __EE1298010.Line_Of_Travel_;
    __EE1298010.Line_Of_Travel_Order_;
    __EE1298010.Delivery_Point_Barcode_;
    __EE1298010.Delivery_Point_Barcode_Check_Digit_;
    __EE1298010.Type_Code_;
    __EE1298010.County_;
    __EE1298010.Latitude_;
    __EE1298010.Longitude_;
    __EE1298010.Metropolitan_Statistical_Area_;
    __EE1298010.Geo_Block_;
    __EE1298010.Geo_Match_;
    __EE1298010.A_C_E_Cleaner_Error_Code_;
    __EE1298010._is_Additional_;
    __EE1298010.Customer_Id_;
    __EE1298010.Industry_Type_;
    __EE1298010.In_Customer_Population_;
    __EE1298010.Source_Customer_Count_;
    __EE1298010.Full_Address_;
    __EE1298010.Street_Address_;
    __EE1298010.Entity_Context_Uid_;
    __EE1298010.Entity_Type_;
    __EE1298010.Dt_First_Seen_;
    __EE1298010.Dt_Last_Seen_;
    __EE1298010.Last_Record_Id_;
    __EE1298010.Not_In_Jurisdiction_State_;
    __EE1298010.Invalid_Address_;
    __EE1298010.Address_Is_Vacant_;
    __EE1298010.Address_Is_Cmra_;
    __EE1298010.Address_Is_Po_Box_;
    __EE1298010.Event_Count_;
    __EE1298010.Identity_Count_;
    __EE1298010.High_Frequency_Flag_;
    __EE1298010.All_Person_Count_;
    __EE1298010.All_High_Frequency_Flag_;
    __EE1298010.Deceased_Person_Count_;
    __EE1298010.Deceased_Person_Percent_;
    __EE1298010.All_Deceased_Person_Count_;
    __EE1298010.All_Deceased_Person_Percent_;
    __EE1298010.Deceased_Match_Person_Count_;
    __EE1298010.Deceased_Match_Person_Percent_;
    __EE1298010.All_Deceased_Match_Person_Count_;
    __EE1298010.All_Deceased_Match_Person_Percent_;
    __EE1298010.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1298010.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1298010.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE1298010.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1298010.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1298010.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE1298010.Vl_Event1_All_Count_;
    __EE1298010.Vl_Event7_All_Count_;
    __EE1298010.Vl_Event30_All_Day_Count_;
    __EE1298010.Vl_Event365_All_Day_Count_;
    __EE1298010.Vl_Event7_All_Active_Flag_;
    __EE1298010.Vl_Event30_All_Active_Flag_;
    __EE1298010.Vl_Event1_Count_;
    __EE1298010.Vl_Event7_Count_;
    __EE1298010.Vl_Event30_Count_;
    __EE1298010.Vl_Event365_Count_;
    __EE1298010.Vl_Event7_Active_Flag_;
    __EE1298010.Vl_Event30_Active_Flag_;
    __EE1298010.Kr_High_Risk_Flag_;
    __EE1298010.Kr_Medium_Risk_Flag_;
    __EE1298010.Kr_Low_Risk_Flag_;
    __EE1298010.Kr_Flag_;
    __EE1298010.Safe_Flag_;
    __EE1298010.Contributor_Safe_Flag_;
    __EE1298010.Kr_Addr300_Flag_;
    __EE1298010.Kr_Addr301_Flag_;
    __EE1298010.Kr_Addr302_Flag_;
    __EE1298010.Kr_Addr303_Flag_;
    __EE1298010.Kr_Addr390_Flag_;
    __EE1298010.Kr_Addr391_Flag_;
    __EE1298010.Kr_Addr392_Flag_;
    __EE1298010.Kr_Addr393_Flag_;
    __EE1298010.Last_Event_Date_;
    __EE1298010.Kr_Last_Event_Date_;
    __EE1298010.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1298010.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1298010.Date_First_Seen_;
    __EE1298010.Date_Last_Seen_;
    __EE1298010.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE1298010,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1298012_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST20938_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
