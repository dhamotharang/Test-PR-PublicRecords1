...
EXPORT B_Address := MODULE
  ...
  SHARED __EE1513453 := __ENH_Address_1;
  SHARED __EE1517092 := __ENH_Event_1;
  SHARED __EE1517094 := __E_Address_Event;
  SHARED __EE1561229 := __EE1517094(__NN(__EE1517094.Location_) AND __NN(__EE1517094.Transaction_));
  SHARED __ST1552275_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1561247(B_Event_1.__ST53475_Layout __EE1517092, E_Address_Event.Layout __EE1561229) := __EEQP(__EE1561229.Transaction_,__EE1517092.UID);
  __ST1552275_Layout __JT1561247(B_Event_1.__ST53475_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1561248 := JOIN(__EE1561229,__EE1517092,__JC1561247(RIGHT,LEFT),__JT1561247(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1549053_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1549053_Layout __ND1561842__Project(__ST1552275_Layout __PP1561249) := TRANSFORM
    SELF.UID := __PP1561249.Location__1_;
    SELF.U_I_D__1_ := __PP1561249.UID;
    SELF := __PP1561249;
  END;
  SHARED __EE1564171 := PROJECT(__EE1561248,__ND1561842__Project(LEFT));
  SHARED __ST1550298_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1550298_Layout __ND1565216__Project(__ST1549053_Layout __PP1564172) := TRANSFORM
    SELF.Exp1_ := __CN(__PP1564172.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP1564172.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP1564172.Address_Is_Vacant_);
    SELF.Exp4_ := __PP1564172.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP1564172.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP1564172.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP1564172.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP1564172.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP1564172.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP1564172.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP1564172.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP1564172.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP1564172.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP1564172.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP1564172.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP1564172.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP1564172.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP1564172.Event_Age_,<,__CN(2)),__CN(__PP1564172.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP1564172.Event_Age_,<,__CN(366));
    SELF := __PP1564172;
  END;
  SHARED __EE1565245 := PROJECT(__EE1564171,__ND1565216__Project(LEFT));
  SHARED __ST1550411_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1565364 := PROJECT(__CLEANANDDO(__EE1565245,TABLE(__EE1565245,{KEL.Aggregates.MaxNG(__EE1565245.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE1565245.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE1565245.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1565245.Exp4_),KEL.Aggregates.MinNG(__EE1565245.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1565245.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1565245.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1565245.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1565245.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1565245.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1565245.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1565245.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1565245.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1565245.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1565245.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1565245.Exp15_),KEL.Aggregates.MaxNG(__EE1565245.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1565245.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1565245.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1565245.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1565245.Exp19_)),UID},UID,MERGE)),__ST1550411_Layout);
  SHARED __ST1555210_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1565370(B_Address_1.__ST47405_Layout __EE1513453, __ST1550411_Layout __EE1565364) := __EEQP(__EE1513453.UID,__EE1565364.UID);
  __ST1555210_Layout __JT1565370(B_Address_1.__ST47405_Layout __l, __ST1550411_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1565464 := JOIN(__EE1513453,__EE1565364,__JC1565370(LEFT,RIGHT),__JT1565370(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1502309 := __ENH_Customer_1;
  SHARED __ST1555902_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1565470(__ST1555210_Layout __EE1565464, B_Customer_1.__ST47862_Layout __EE1502309) := __EEQP(__EE1565464._r_Customer_,__EE1502309.UID);
  __ST1555902_Layout __JT1565470(__ST1555210_Layout __l, B_Customer_1.__ST47862_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1565592 := JOIN(__EE1565464,__EE1502309,__JC1565470(LEFT,RIGHT),__JT1565470(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST31954_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31954_Layout __ND1565597__Project(__ST1555902_Layout __PP1565593) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP1565593.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP1565593.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP1565593.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP1565593.All_Deceased_Match_Person_Count_ / __PP1565593.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP1565593.All_Deceased_Person_Count_ / __PP1565593.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP1565593.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP1565593.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP1565593.Deceased_Match_Person_Count_ / __PP1565593.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP1565593.Deceased_Person_Count_ / __PP1565593.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP1565593.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP1565593.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP1565593.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP1565593.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP1565593.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1565593.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP1565593.State_,<>,__PP1565593.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1565593.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1565593.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1565593.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP1565593.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP1565593.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP1565593.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1565593.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1565593.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1565593.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1565593.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1565593.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1565593;
  END;
  EXPORT __ENH_Address := PROJECT(__EE1565592,__ND1565597__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE2599844 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2599844._r_Customer_;
    __EE2599844.Source_Customers_;
    __EE2599844._addresspobox_;
    __EE2599844._addresscmra_;
    __EE2599844.Otto_Address_Id_;
    __EE2599844.Primary_Range_;
    __EE2599844.Predirectional_;
    __EE2599844.Primary_Name_;
    __EE2599844.Suffix_;
    __EE2599844.Postdirectional_;
    __EE2599844.Unit_Designation_;
    __EE2599844.Secondary_Range_;
    __EE2599844.Postal_City_;
    __EE2599844.Vanity_City_;
    __EE2599844.State_;
    __EE2599844.Zip_;
    __EE2599844.Zip4_;
    __EE2599844.Carrier_Route_Number_;
    __EE2599844.Carrier_Route_Sortation_At_Z_I_P_;
    __EE2599844.Line_Of_Travel_;
    __EE2599844.Line_Of_Travel_Order_;
    __EE2599844.Delivery_Point_Barcode_;
    __EE2599844.Delivery_Point_Barcode_Check_Digit_;
    __EE2599844.Type_Code_;
    __EE2599844.County_;
    __EE2599844.Latitude_;
    __EE2599844.Longitude_;
    __EE2599844.Metropolitan_Statistical_Area_;
    __EE2599844.Geo_Block_;
    __EE2599844.Geo_Match_;
    __EE2599844.A_C_E_Cleaner_Error_Code_;
    __EE2599844._is_Additional_;
    __EE2599844.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE2599844.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2599844.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2599844.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE2599844.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2599844.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2599844.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE2599844.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2599844.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE2599844.Customer_Id_;
    __EE2599844.Industry_Type_;
    __EE2599844.In_Customer_Population_;
    __EE2599844.Source_Customer_Count_;
    __EE2599844.Full_Address_;
    __EE2599844.Street_Address_;
    __EE2599844.Entity_Context_Uid_;
    __EE2599844.Entity_Type_;
    __EE2599844.Dt_First_Seen_;
    __EE2599844.Dt_Last_Seen_;
    __EE2599844.Last_Record_Id_;
    __EE2599844.Not_In_Jurisdiction_State_;
    __EE2599844.Invalid_Address_;
    __EE2599844.Address_Is_Vacant_;
    __EE2599844.Address_Is_Cmra_;
    __EE2599844.Address_Is_Po_Box_;
    __EE2599844.Event_Count_;
    __EE2599844.Identity_Count_;
    __EE2599844.High_Frequency_Flag_;
    __EE2599844.All_Person_Count_;
    __EE2599844.All_High_Frequency_Flag_;
    __EE2599844.Deceased_Person_Count_;
    __EE2599844.Deceased_Person_Percent_;
    __EE2599844.All_Deceased_Person_Count_;
    __EE2599844.All_Deceased_Person_Percent_;
    __EE2599844.Deceased_Match_Person_Count_;
    __EE2599844.Deceased_Match_Person_Percent_;
    __EE2599844.All_Deceased_Match_Person_Count_;
    __EE2599844.All_Deceased_Match_Person_Percent_;
    __EE2599844.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2599844.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2599844.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE2599844.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2599844.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2599844.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE2599844.Vl_Event1_All_Count_;
    __EE2599844.Vl_Event7_All_Count_;
    __EE2599844.Vl_Event30_All_Day_Count_;
    __EE2599844.Vl_Event365_All_Day_Count_;
    __EE2599844.Vl_Event7_All_Active_Flag_;
    __EE2599844.Vl_Event30_All_Active_Flag_;
    __EE2599844.Vl_Event1_Count_;
    __EE2599844.Vl_Event7_Count_;
    __EE2599844.Vl_Event30_Count_;
    __EE2599844.Vl_Event365_Count_;
    __EE2599844.Vl_Event7_Active_Flag_;
    __EE2599844.Vl_Event30_Active_Flag_;
    __EE2599844.Kr_High_Risk_Flag_;
    __EE2599844.Kr_Medium_Risk_Flag_;
    __EE2599844.Kr_Low_Risk_Flag_;
    __EE2599844.Kr_Flag_;
    __EE2599844.Safe_Flag_;
    __EE2599844.Contributor_Safe_Flag_;
    __EE2599844.Kr_Addr300_Flag_;
    __EE2599844.Kr_Addr301_Flag_;
    __EE2599844.Kr_Addr302_Flag_;
    __EE2599844.Kr_Addr303_Flag_;
    __EE2599844.Kr_Addr390_Flag_;
    __EE2599844.Kr_Addr391_Flag_;
    __EE2599844.Kr_Addr392_Flag_;
    __EE2599844.Kr_Addr393_Flag_;
    __EE2599844.Last_Event_Date_;
    __EE2599844.Kr_Last_Event_Date_;
    __EE2599844.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2599844.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2599844.Date_First_Seen_;
    __EE2599844.Date_Last_Seen_;
    __EE2599844.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE2599844,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2599846_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST31954_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
