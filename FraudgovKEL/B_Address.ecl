...
EXPORT B_Address := MODULE
  ...
  SHARED __EE543022 := __ENH_Address_1;
  SHARED __EE545918 := __ENH_Event_1;
  SHARED __EE545920 := __E_Address_Event;
  SHARED __EE578010 := __EE545920(__NN(__EE545920.Location_) AND __NN(__EE545920.Transaction_));
  ...
  END;
  __JC578028(B_Event_1.__ST33316_Layout __EE545918, E_Address_Event.Layout __EE578010) := __EEQP(__EE578010.Transaction_,__EE545918.UID);
  __ST570951_Layout __JT578028(B_Event_1.__ST33316_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE578029 := JOIN(__EE578010,__EE545918,__JC578028(RIGHT,LEFT),__JT578028(RIGHT,LEFT),INNER,HASH);
  SHARED __ST568429_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST568429_Layout __ND578448__Project(__ST570951_Layout __PP578030) := TRANSFORM
    SELF.UID := __PP578030.Location__1_;
    SELF.U_I_D__1_ := __PP578030.UID;
    SELF := __PP578030;
  END;
  SHARED __EE580077 := PROJECT(__EE578029,__ND578448__Project(LEFT));
  SHARED __ST569328_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST569328_Layout __ND581074__Project(__ST568429_Layout __PP580078) := TRANSFORM
    SELF.Exp1_ := __CN(__PP580078.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP580078.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP580078.Address_Is_Vacant_);
    SELF.Exp4_ := __PP580078.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP580078.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP580078.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP580078.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP580078.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP580078.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP580078.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP580078.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP580078.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP580078.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP580078.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP580078.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP580078.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP580078.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP580078.Event_Age_,<,__CN(2)),__CN(__PP580078.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP580078.Event_Age_,<,__CN(366));
    SELF := __PP580078;
  END;
  SHARED __EE581103 := PROJECT(__EE580077,__ND581074__Project(LEFT));
  SHARED __ST569444_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE581227 := PROJECT(__CLEANANDDO(__EE581103,TABLE(__EE581103,{KEL.Aggregates.MaxNG(__EE581103.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE581103.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE581103.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE581103.Exp4_),KEL.Aggregates.MinNG(__EE581103.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE581103.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE581103.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE581103.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE581103.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE581103.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE581103.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE581103.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE581103.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE581103.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE581103.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE581103.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE581103.Exp15_),KEL.Aggregates.MaxNG(__EE581103.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE581103.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE581103.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE581103.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE581103.Exp19_)),UID},UID,MERGE)),__ST569444_Layout);
  SHARED __ST573011_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC581233(B_Address_1.__ST30142_Layout __EE543022, __ST569444_Layout __EE581227) := __EEQP(__EE543022.UID,__EE581227.UID);
  __ST573011_Layout __JT581233(B_Address_1.__ST30142_Layout __l, __ST569444_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE581319 := JOIN(__EE543022,__EE581227,__JC581233(LEFT,RIGHT),__JT581233(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE531398 := __ENH_Customer_1;
  SHARED __ST573658_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC581325(__ST573011_Layout __EE581319, B_Customer_1.__ST30473_Layout __EE531398) := __EEQP(__EE581319._r_Customer_,__EE531398.UID);
  __ST573658_Layout __JT581325(__ST573011_Layout __l, B_Customer_1.__ST30473_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE581439 := JOIN(__EE581319,__EE531398,__JC581325(LEFT,RIGHT),__JT581325(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST20910_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20910_Layout __ND581444__Project(__ST573658_Layout __PP581440) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP581440.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP581440.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP581440.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP581440.All_Deceased_Match_Person_Count_ / __PP581440.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP581440.All_Deceased_Person_Count_ / __PP581440.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP581440.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP581440.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP581440.Deceased_Match_Person_Count_ / __PP581440.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP581440.Deceased_Person_Count_ / __PP581440.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP581440.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP581440.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP581440.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP581440.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP581440.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP581440.M_A_X___Event_Date__2_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP581440.State_,<>,__PP581440.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP581440.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP581440.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581440.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP581440.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP581440.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP581440.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP581440.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP581440.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP581440.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP581440.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP581440.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP581440;
  END;
  EXPORT __ENH_Address := PROJECT(__EE581439,__ND581444__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE1285017 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1285017._r_Customer_;
    __EE1285017.Source_Customers_;
    __EE1285017._addresspobox_;
    __EE1285017._addresscmra_;
    __EE1285017.Otto_Address_Id_;
    __EE1285017.Primary_Range_;
    __EE1285017.Predirectional_;
    __EE1285017.Primary_Name_;
    __EE1285017.Suffix_;
    __EE1285017.Postdirectional_;
    __EE1285017.Unit_Designation_;
    __EE1285017.Secondary_Range_;
    __EE1285017.Postal_City_;
    __EE1285017.Vanity_City_;
    __EE1285017.State_;
    __EE1285017.Zip_;
    __EE1285017.Zip4_;
    __EE1285017.Carrier_Route_Number_;
    __EE1285017.Carrier_Route_Sortation_At_Z_I_P_;
    __EE1285017.Line_Of_Travel_;
    __EE1285017.Line_Of_Travel_Order_;
    __EE1285017.Delivery_Point_Barcode_;
    __EE1285017.Delivery_Point_Barcode_Check_Digit_;
    __EE1285017.Type_Code_;
    __EE1285017.County_;
    __EE1285017.Latitude_;
    __EE1285017.Longitude_;
    __EE1285017.Metropolitan_Statistical_Area_;
    __EE1285017.Geo_Block_;
    __EE1285017.Geo_Match_;
    __EE1285017.A_C_E_Cleaner_Error_Code_;
    __EE1285017._is_Additional_;
    __EE1285017.Customer_Id_;
    __EE1285017.Industry_Type_;
    __EE1285017.In_Customer_Population_;
    __EE1285017.Source_Customer_Count_;
    __EE1285017.Full_Address_;
    __EE1285017.Street_Address_;
    __EE1285017.Entity_Context_Uid_;
    __EE1285017.Entity_Type_;
    __EE1285017.Dt_First_Seen_;
    __EE1285017.Dt_Last_Seen_;
    __EE1285017.Last_Record_Id_;
    __EE1285017.Not_In_Jurisdiction_State_;
    __EE1285017.Invalid_Address_;
    __EE1285017.Address_Is_Vacant_;
    __EE1285017.Address_Is_Cmra_;
    __EE1285017.Address_Is_Po_Box_;
    __EE1285017.Event_Count_;
    __EE1285017.Identity_Count_;
    __EE1285017.High_Frequency_Flag_;
    __EE1285017.All_Person_Count_;
    __EE1285017.All_High_Frequency_Flag_;
    __EE1285017.Deceased_Person_Count_;
    __EE1285017.Deceased_Person_Percent_;
    __EE1285017.All_Deceased_Person_Count_;
    __EE1285017.All_Deceased_Person_Percent_;
    __EE1285017.Deceased_Match_Person_Count_;
    __EE1285017.Deceased_Match_Person_Percent_;
    __EE1285017.All_Deceased_Match_Person_Count_;
    __EE1285017.All_Deceased_Match_Person_Percent_;
    __EE1285017.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1285017.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1285017.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE1285017.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1285017.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1285017.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE1285017.Vl_Event1_All_Count_;
    __EE1285017.Vl_Event7_All_Count_;
    __EE1285017.Vl_Event30_All_Day_Count_;
    __EE1285017.Vl_Event365_All_Day_Count_;
    __EE1285017.Vl_Event7_All_Active_Flag_;
    __EE1285017.Vl_Event30_All_Active_Flag_;
    __EE1285017.Vl_Event1_Count_;
    __EE1285017.Vl_Event7_Count_;
    __EE1285017.Vl_Event30_Count_;
    __EE1285017.Vl_Event365_Count_;
    __EE1285017.Vl_Event7_Active_Flag_;
    __EE1285017.Vl_Event30_Active_Flag_;
    __EE1285017.Kr_High_Risk_Flag_;
    __EE1285017.Kr_Medium_Risk_Flag_;
    __EE1285017.Kr_Low_Risk_Flag_;
    __EE1285017.Kr_Flag_;
    __EE1285017.Safe_Flag_;
    __EE1285017.Contributor_Safe_Flag_;
    __EE1285017.Kr_Addr300_Flag_;
    __EE1285017.Kr_Addr301_Flag_;
    __EE1285017.Kr_Addr302_Flag_;
    __EE1285017.Kr_Addr303_Flag_;
    __EE1285017.Kr_Addr390_Flag_;
    __EE1285017.Kr_Addr391_Flag_;
    __EE1285017.Kr_Addr392_Flag_;
    __EE1285017.Kr_Addr393_Flag_;
    __EE1285017.Last_Event_Date_;
    __EE1285017.Kr_Last_Event_Date_;
    __EE1285017.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1285017.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1285017.Date_First_Seen_;
    __EE1285017.Date_Last_Seen_;
    __EE1285017.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE1285017,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1285019_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST20910_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
