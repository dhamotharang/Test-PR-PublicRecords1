...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2617005 := __ENH_Address_1;
  SHARED __EE2620961 := __ENH_Event_1;
  SHARED __EE2620963 := __E_Address_Event;
  SHARED __EE2668534 := __EE2620963(__NN(__EE2620963.Location_) AND __NN(__EE2620963.Transaction_));
  SHARED __ST2658340_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2668552(B_Event_1.__ST80086_Layout __EE2620961, E_Address_Event.Layout __EE2668534) := __EEQP(__EE2668534.Transaction_,__EE2620961.UID);
  __ST2658340_Layout __JT2668552(B_Event_1.__ST80086_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2668553 := JOIN(__EE2668534,__EE2620961,__JC2668552(RIGHT,LEFT),__JT2668552(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2654610_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2654610_Layout __ND2669281__Project(__ST2658340_Layout __PP2668554) := TRANSFORM
    SELF.UID := __PP2668554.Location__1_;
    SELF.U_I_D__1_ := __PP2668554.UID;
    SELF := __PP2668554;
  END;
  SHARED __EE2672074 := PROJECT(__EE2668553,__ND2669281__Project(LEFT));
  SHARED __ST2656128_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2656128_Layout __ND2672079__Project(__ST2654610_Layout __PP2672075) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2672075.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2672075.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2672075.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2672075.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := IF(__PP2672075.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2672075.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp6_ := __PP2672075.Kr_Addr300_Flag_ = 1;
    SELF.Exp7_ := __PP2672075.Kr_Addr301_Flag_ = 1;
    SELF.Exp8_ := __PP2672075.Kr_Addr302_Flag_ = 1;
    SELF.Exp9_ := __PP2672075.Kr_Addr303_Flag_ = 1;
    SELF.Exp10_ := __PP2672075.Kr_Addr390_Flag_ = 1;
    SELF.Exp11_ := __PP2672075.Kr_Addr391_Flag_ = 1;
    SELF.Exp12_ := __PP2672075.Kr_Addr392_Flag_ = 1;
    SELF.Exp13_ := __PP2672075.Kr_Addr393_Flag_ = 1;
    SELF.Exp14_ := __PP2672075.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2672075.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2672075.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp17_ := __PP2672075.Safe_Flag_ = 1;
    SELF := __PP2672075;
  END;
  SHARED __EE2672176 := PROJECT(__EE2672074,__ND2672079__Project(LEFT));
  SHARED __ST2656231_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2672282 := PROJECT(__CLEANANDDO(__EE2672176,TABLE(__EE2672176,{KEL.Aggregates.MaxNG(__EE2672176.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2672176.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2672176.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2672176.Exp4_),KEL.Aggregates.MinNG(__EE2672176.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2672176.Exp5_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2672176.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2672176.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2672176.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2672176.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2672176.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2672176.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2672176.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2672176.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2672176.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2672176.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2672176.Exp16_),KEL.Aggregates.MaxNG(__EE2672176.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2672176.Exp17_),UID},UID,MERGE)),__ST2656231_Layout);
  SHARED __ST2661885_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2672288(B_Address_1.__ST71169_Layout __EE2617005, __ST2656231_Layout __EE2672282) := __EEQP(__EE2617005.UID,__EE2672282.UID);
  __ST2661885_Layout __JT2672288(B_Address_1.__ST71169_Layout __l, __ST2656231_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2672289 := JOIN(__EE2617005,__EE2672282,__JC2672288(LEFT,RIGHT),__JT2672288(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2598732 := __ENH_Customer_1;
  SHARED __ST2662599_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2672396(__ST2661885_Layout __EE2672289, B_Customer_1.__ST71756_Layout __EE2598732) := __EEQP(__EE2672289._r_Customer_,__EE2598732.UID);
  __ST2662599_Layout __JT2672396(__ST2661885_Layout __l, B_Customer_1.__ST71756_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2672397 := JOIN(__EE2672289,__EE2598732,__JC2672396(LEFT,RIGHT),__JT2672396(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46977_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46977_Layout __ND2673129__Project(__ST2662599_Layout __PP2672398) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2672398.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2672398.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2672398.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2672398.All_Deceased_Match_Person_Count_ / __PP2672398.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2672398.All_Deceased_Person_Count_ / __PP2672398.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2672398.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2672398.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2672398.Deceased_Match_Person_Count_ / __PP2672398.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2672398.Deceased_Person_Count_ / __PP2672398.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2672398.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2672398.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2672398.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2672398.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Id_Activity_Dt_First_Seen_ := __PP2672398.M_I_N___Event_Date__2_;
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2672398.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP2672398.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2672398.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2672398.State_,<>,__PP2672398.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2672398.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2672398.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2672398.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2672398.Secondary_Range_))))))))))))))));
    SELF := __PP2672398;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2672397,__ND2673129__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE4712126 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4712126._r_Customer_;
    __EE4712126.Source_Customers_;
    __EE4712126._addresspobox_;
    __EE4712126._addresscmra_;
    __EE4712126.Otto_Address_Id_;
    __EE4712126.Primary_Range_;
    __EE4712126.Predirectional_;
    __EE4712126.Primary_Name_;
    __EE4712126.Suffix_;
    __EE4712126.Postdirectional_;
    __EE4712126.Unit_Designation_;
    __EE4712126.Secondary_Range_;
    __EE4712126.Postal_City_;
    __EE4712126.Vanity_City_;
    __EE4712126.State_;
    __EE4712126.Zip_;
    __EE4712126.Zip4_;
    __EE4712126.Carrier_Route_Number_;
    __EE4712126.Carrier_Route_Sortation_At_Z_I_P_;
    __EE4712126.Line_Of_Travel_;
    __EE4712126.Line_Of_Travel_Order_;
    __EE4712126.Delivery_Point_Barcode_;
    __EE4712126.Delivery_Point_Barcode_Check_Digit_;
    __EE4712126.Type_Code_;
    __EE4712126.County_;
    __EE4712126.Latitude_;
    __EE4712126.Longitude_;
    __EE4712126.Metropolitan_Statistical_Area_;
    __EE4712126.Geo_Block_;
    __EE4712126.Geo_Match_;
    __EE4712126.A_C_E_Cleaner_Error_Code_;
    __EE4712126._is_Additional_;
    __EE4712126.Aot_Act_Cnt_Ev_;
    __EE4712126.Aot_Src1_Act_Cnt_Ev_;
    __EE4712126.Aot_Src1_Act_Only_Flag_;
    __EE4712126.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE4712126.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4712126.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4712126.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE4712126.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4712126.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4712126.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE4712126.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4712126.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE4712126.Aot_Id_Act_Cnt_Ev_;
    __EE4712126.Aot_Id_Act_Cnt30_D_;
    __EE4712126.Ao_T_Add_Act_Cnt_Ev_;
    __EE4712126.Ao_T_Add_Act_Cnt30_D_;
    __EE4712126.Aot_Non_St_Act_Cnt_Ev_;
    __EE4712126.Aot_Non_St_Act_Cnt30_D_;
    __EE4712126.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4712126.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4712126.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4712126.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE4712126.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE4712126.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE4712126.Customer_Id_;
    __EE4712126.Industry_Type_;
    __EE4712126.In_Customer_Population_;
    __EE4712126.Source_Customer_Count_;
    __EE4712126.Full_Address_;
    __EE4712126.Street_Address_;
    __EE4712126.Entity_Context_Uid_;
    __EE4712126.Entity_Type_;
    __EE4712126.Dt_First_Seen_;
    __EE4712126.Dt_Last_Seen_;
    __EE4712126.Id_Activity_Dt_First_Seen_;
    __EE4712126.Id_Activity_Dt_Last_Seen_;
    __EE4712126.Last_Record_Id_;
    __EE4712126.Not_In_Jurisdiction_State_;
    __EE4712126.Invalid_Address_;
    __EE4712126.Address_Is_Vacant_;
    __EE4712126.Address_Is_Cmra_;
    __EE4712126.Address_Is_Po_Box_;
    __EE4712126.Event_Count_;
    __EE4712126.Identity_Count_;
    __EE4712126.High_Frequency_Flag_;
    __EE4712126.All_Person_Count_;
    __EE4712126.All_High_Frequency_Flag_;
    __EE4712126.Deceased_Person_Count_;
    __EE4712126.Deceased_Person_Percent_;
    __EE4712126.All_Deceased_Person_Count_;
    __EE4712126.All_Deceased_Person_Percent_;
    __EE4712126.Deceased_Match_Person_Count_;
    __EE4712126.Deceased_Match_Person_Percent_;
    __EE4712126.All_Deceased_Match_Person_Count_;
    __EE4712126.All_Deceased_Match_Person_Percent_;
    __EE4712126.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4712126.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4712126.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4712126.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4712126.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4712126.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4712126.Kr_High_Risk_Flag_;
    __EE4712126.Kr_Medium_Risk_Flag_;
    __EE4712126.Kr_Low_Risk_Flag_;
    __EE4712126.Kr_Flag_;
    __EE4712126.Safe_Flag_;
    __EE4712126.Contributor_Safe_Flag_;
    __EE4712126.Kr_Addr300_Flag_;
    __EE4712126.Kr_Addr301_Flag_;
    __EE4712126.Kr_Addr302_Flag_;
    __EE4712126.Kr_Addr303_Flag_;
    __EE4712126.Kr_Addr390_Flag_;
    __EE4712126.Kr_Addr391_Flag_;
    __EE4712126.Kr_Addr392_Flag_;
    __EE4712126.Kr_Addr393_Flag_;
    __EE4712126.Last_Event_Date_;
    __EE4712126.Kr_Last_Event_Date_;
    __EE4712126.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4712126.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4712126.Date_First_Seen_;
    __EE4712126.Date_Last_Seen_;
    __EE4712126.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4712126,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4712128_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST46977_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
