...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2298458 := __ENH_Address_1;
  SHARED __EE2302577 := __ENH_Event_1;
  SHARED __EE2302579 := __E_Address_Event;
  SHARED __EE2353686 := __EE2302579(__NN(__EE2302579.Location_) AND __NN(__EE2302579.Transaction_));
  SHARED __ST2343526_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2353704(B_Event_1.__ST76927_Layout __EE2302577, E_Address_Event.Layout __EE2353686) := __EEQP(__EE2353686.Transaction_,__EE2302577.UID);
  __ST2343526_Layout __JT2353704(B_Event_1.__ST76927_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2353705 := JOIN(__EE2353686,__EE2302577,__JC2353704(RIGHT,LEFT),__JT2353704(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2339884_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2339884_Layout __ND2354398__Project(__ST2343526_Layout __PP2353706) := TRANSFORM
    SELF.UID := __PP2353706.Location__1_;
    SELF.U_I_D__1_ := __PP2353706.UID;
    SELF := __PP2353706;
  END;
  SHARED __EE2357123 := PROJECT(__EE2353705,__ND2354398__Project(LEFT));
  SHARED __ST2341327_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2341327_Layout __ND2358240__Project(__ST2339884_Layout __PP2357124) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2357124.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2357124.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2357124.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2357124.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP2357124.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP2357124.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP2357124.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP2357124.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP2357124.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP2357124.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP2357124.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP2357124.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP2357124.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP2357124.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2357124.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2357124.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP2357124.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP2357124.Event_Age_,<,__CN(2)),__CN(__PP2357124.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP2357124.Event_Age_,<,__CN(366));
    SELF := __PP2357124;
  END;
  SHARED __EE2358269 := PROJECT(__EE2357123,__ND2358240__Project(LEFT));
  SHARED __ST2341440_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2358388 := PROJECT(__CLEANANDDO(__EE2358269,TABLE(__EE2358269,{KEL.Aggregates.MaxNG(__EE2358269.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2358269.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2358269.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2358269.Exp4_),KEL.Aggregates.MinNG(__EE2358269.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2358269.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2358269.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2358269.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2358269.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2358269.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2358269.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2358269.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2358269.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2358269.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2358269.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2358269.Exp15_),KEL.Aggregates.MaxNG(__EE2358269.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2358269.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2358269.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2358269.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2358269.Exp19_)),UID},UID,MERGE)),__ST2341440_Layout);
  SHARED __ST2346956_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2358394(B_Address_1.__ST68241_Layout __EE2298458, __ST2341440_Layout __EE2358388) := __EEQP(__EE2298458.UID,__EE2358388.UID);
  __ST2346956_Layout __JT2358394(B_Address_1.__ST68241_Layout __l, __ST2341440_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2358500 := JOIN(__EE2298458,__EE2358388,__JC2358394(LEFT,RIGHT),__JT2358394(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2285718 := __ENH_Customer_1;
  SHARED __ST2347708_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2358506(__ST2346956_Layout __EE2358500, B_Customer_1.__ST68903_Layout __EE2285718) := __EEQP(__EE2358500._r_Customer_,__EE2285718.UID);
  __ST2347708_Layout __JT2358506(__ST2346956_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2358640 := JOIN(__EE2358500,__EE2285718,__JC2358506(LEFT,RIGHT),__JT2358506(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST45405_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45405_Layout __ND2358645__Project(__ST2347708_Layout __PP2358641) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2358641.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2358641.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2358641.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2358641.All_Deceased_Match_Person_Count_ / __PP2358641.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2358641.All_Deceased_Person_Count_ / __PP2358641.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2358641.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2358641.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2358641.Deceased_Match_Person_Count_ / __PP2358641.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2358641.Deceased_Person_Count_ / __PP2358641.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2358641.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2358641.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2358641.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2358641.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2358641.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2358641.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2358641.State_,<>,__PP2358641.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2358641.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2358641.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2358641.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2358641.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP2358641.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP2358641.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2358641.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2358641.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2358641.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2358641.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2358641.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2358641;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2358640,__ND2358645__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE4093711 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4093711._r_Customer_;
    __EE4093711.Source_Customers_;
    __EE4093711._addresspobox_;
    __EE4093711._addresscmra_;
    __EE4093711.Otto_Address_Id_;
    __EE4093711.Primary_Range_;
    __EE4093711.Predirectional_;
    __EE4093711.Primary_Name_;
    __EE4093711.Suffix_;
    __EE4093711.Postdirectional_;
    __EE4093711.Unit_Designation_;
    __EE4093711.Secondary_Range_;
    __EE4093711.Postal_City_;
    __EE4093711.Vanity_City_;
    __EE4093711.State_;
    __EE4093711.Zip_;
    __EE4093711.Zip4_;
    __EE4093711.Carrier_Route_Number_;
    __EE4093711.Carrier_Route_Sortation_At_Z_I_P_;
    __EE4093711.Line_Of_Travel_;
    __EE4093711.Line_Of_Travel_Order_;
    __EE4093711.Delivery_Point_Barcode_;
    __EE4093711.Delivery_Point_Barcode_Check_Digit_;
    __EE4093711.Type_Code_;
    __EE4093711.County_;
    __EE4093711.Latitude_;
    __EE4093711.Longitude_;
    __EE4093711.Metropolitan_Statistical_Area_;
    __EE4093711.Geo_Block_;
    __EE4093711.Geo_Match_;
    __EE4093711.A_C_E_Cleaner_Error_Code_;
    __EE4093711._is_Additional_;
    __EE4093711.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE4093711.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4093711.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4093711.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE4093711.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4093711.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4093711.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE4093711.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4093711.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE4093711.Aot_Id_Act_Cnt_Ev_;
    __EE4093711.Aot_Id_Act_Cnt30_D_;
    __EE4093711.Ao_T_Add_Act_Cnt_Ev_;
    __EE4093711.Ao_T_Add_Act_Cnt30_D_;
    __EE4093711.Aot_Non_St_Act_Cnt_Ev_;
    __EE4093711.Aot_Non_St_Act_Cnt30_D_;
    __EE4093711.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4093711.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4093711.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4093711.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE4093711.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE4093711.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE4093711.Customer_Id_;
    __EE4093711.Industry_Type_;
    __EE4093711.In_Customer_Population_;
    __EE4093711.Source_Customer_Count_;
    __EE4093711.Full_Address_;
    __EE4093711.Street_Address_;
    __EE4093711.Entity_Context_Uid_;
    __EE4093711.Entity_Type_;
    __EE4093711.Dt_First_Seen_;
    __EE4093711.Dt_Last_Seen_;
    __EE4093711.Last_Record_Id_;
    __EE4093711.Not_In_Jurisdiction_State_;
    __EE4093711.Invalid_Address_;
    __EE4093711.Address_Is_Vacant_;
    __EE4093711.Address_Is_Cmra_;
    __EE4093711.Address_Is_Po_Box_;
    __EE4093711.Event_Count_;
    __EE4093711.Identity_Count_;
    __EE4093711.High_Frequency_Flag_;
    __EE4093711.All_Person_Count_;
    __EE4093711.All_High_Frequency_Flag_;
    __EE4093711.Deceased_Person_Count_;
    __EE4093711.Deceased_Person_Percent_;
    __EE4093711.All_Deceased_Person_Count_;
    __EE4093711.All_Deceased_Person_Percent_;
    __EE4093711.Deceased_Match_Person_Count_;
    __EE4093711.Deceased_Match_Person_Percent_;
    __EE4093711.All_Deceased_Match_Person_Count_;
    __EE4093711.All_Deceased_Match_Person_Percent_;
    __EE4093711.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4093711.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4093711.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4093711.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4093711.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4093711.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4093711.Vl_Event1_All_Count_;
    __EE4093711.Vl_Event7_All_Count_;
    __EE4093711.Vl_Event30_All_Day_Count_;
    __EE4093711.Vl_Event365_All_Day_Count_;
    __EE4093711.Vl_Event7_All_Active_Flag_;
    __EE4093711.Vl_Event30_All_Active_Flag_;
    __EE4093711.Vl_Event1_Count_;
    __EE4093711.Vl_Event7_Count_;
    __EE4093711.Vl_Event30_Count_;
    __EE4093711.Vl_Event365_Count_;
    __EE4093711.Vl_Event7_Active_Flag_;
    __EE4093711.Vl_Event30_Active_Flag_;
    __EE4093711.Kr_High_Risk_Flag_;
    __EE4093711.Kr_Medium_Risk_Flag_;
    __EE4093711.Kr_Low_Risk_Flag_;
    __EE4093711.Kr_Flag_;
    __EE4093711.Safe_Flag_;
    __EE4093711.Contributor_Safe_Flag_;
    __EE4093711.Kr_Addr300_Flag_;
    __EE4093711.Kr_Addr301_Flag_;
    __EE4093711.Kr_Addr302_Flag_;
    __EE4093711.Kr_Addr303_Flag_;
    __EE4093711.Kr_Addr390_Flag_;
    __EE4093711.Kr_Addr391_Flag_;
    __EE4093711.Kr_Addr392_Flag_;
    __EE4093711.Kr_Addr393_Flag_;
    __EE4093711.Last_Event_Date_;
    __EE4093711.Kr_Last_Event_Date_;
    __EE4093711.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4093711.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4093711.Date_First_Seen_;
    __EE4093711.Date_Last_Seen_;
    __EE4093711.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4093711,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4093713_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST45405_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
