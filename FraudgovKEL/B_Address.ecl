...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2682358 := __ENH_Address_1;
  SHARED __EE2686314 := __ENH_Event_1;
  SHARED __EE2686316 := __E_Address_Event;
  SHARED __EE2733887 := __EE2686316(__NN(__EE2686316.Location_) AND __NN(__EE2686316.Transaction_));
  SHARED __ST2723693_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2733905(B_Event_1.__ST80990_Layout __EE2686314, E_Address_Event.Layout __EE2733887) := __EEQP(__EE2733887.Transaction_,__EE2686314.UID);
  __ST2723693_Layout __JT2733905(B_Event_1.__ST80990_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2733906 := JOIN(__EE2733887,__EE2686314,__JC2733905(RIGHT,LEFT),__JT2733905(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2719963_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2719963_Layout __ND2734634__Project(__ST2723693_Layout __PP2733907) := TRANSFORM
    SELF.UID := __PP2733907.Location__1_;
    SELF.U_I_D__1_ := __PP2733907.UID;
    SELF := __PP2733907;
  END;
  SHARED __EE2737427 := PROJECT(__EE2733906,__ND2734634__Project(LEFT));
  SHARED __ST2721481_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2721481_Layout __ND2737432__Project(__ST2719963_Layout __PP2737428) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2737428.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2737428.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2737428.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2737428.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := IF(__PP2737428.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2737428.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp6_ := __PP2737428.Kr_Addr300_Flag_ = 1;
    SELF.Exp7_ := __PP2737428.Kr_Addr301_Flag_ = 1;
    SELF.Exp8_ := __PP2737428.Kr_Addr302_Flag_ = 1;
    SELF.Exp9_ := __PP2737428.Kr_Addr303_Flag_ = 1;
    SELF.Exp10_ := __PP2737428.Kr_Addr390_Flag_ = 1;
    SELF.Exp11_ := __PP2737428.Kr_Addr391_Flag_ = 1;
    SELF.Exp12_ := __PP2737428.Kr_Addr392_Flag_ = 1;
    SELF.Exp13_ := __PP2737428.Kr_Addr393_Flag_ = 1;
    SELF.Exp14_ := __PP2737428.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2737428.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2737428.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp17_ := __PP2737428.Safe_Flag_ = 1;
    SELF := __PP2737428;
  END;
  SHARED __EE2737529 := PROJECT(__EE2737427,__ND2737432__Project(LEFT));
  SHARED __ST2721584_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2737635 := PROJECT(__CLEANANDDO(__EE2737529,TABLE(__EE2737529,{KEL.Aggregates.MaxNG(__EE2737529.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2737529.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2737529.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2737529.Exp4_),KEL.Aggregates.MinNG(__EE2737529.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2737529.Exp5_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2737529.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2737529.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2737529.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2737529.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2737529.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2737529.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2737529.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2737529.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2737529.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2737529.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2737529.Exp16_),KEL.Aggregates.MaxNG(__EE2737529.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2737529.Exp17_),UID},UID,MERGE)),__ST2721584_Layout);
  SHARED __ST2727238_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2737641(B_Address_1.__ST71988_Layout __EE2682358, __ST2721584_Layout __EE2737635) := __EEQP(__EE2682358.UID,__EE2737635.UID);
  __ST2727238_Layout __JT2737641(B_Address_1.__ST71988_Layout __l, __ST2721584_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2737642 := JOIN(__EE2682358,__EE2737635,__JC2737641(LEFT,RIGHT),__JT2737641(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2664085 := __ENH_Customer_1;
  SHARED __ST2727952_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2737749(__ST2727238_Layout __EE2737642, B_Customer_1.__ST72603_Layout __EE2664085) := __EEQP(__EE2737642._r_Customer_,__EE2664085.UID);
  __ST2727952_Layout __JT2737749(__ST2727238_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2737750 := JOIN(__EE2737642,__EE2664085,__JC2737749(LEFT,RIGHT),__JT2737749(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST47626_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47626_Layout __ND2738482__Project(__ST2727952_Layout __PP2737751) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2737751.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2737751.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2737751.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2737751.All_Deceased_Match_Person_Count_ / __PP2737751.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2737751.All_Deceased_Person_Count_ / __PP2737751.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2737751.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2737751.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2737751.Deceased_Match_Person_Count_ / __PP2737751.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2737751.Deceased_Person_Count_ / __PP2737751.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2737751.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2737751.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2737751.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2737751.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2737751.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Id_Activity_Dt_First_Seen_ := __PP2737751.M_I_N___Event_Date__2_;
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2737751.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP2737751.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2737751.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2737751.State_,<>,__PP2737751.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2737751.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2737751.Source_Customers_);
  ...
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4670403._r_Customer_;
    __EE4670403.Source_Customers_;
    __EE4670403._addresspobox_;
    __EE4670403._addresscmra_;
    __EE4670403.Otto_Address_Id_;
    __EE4670403.Primary_Range_;
    __EE4670403.Predirectional_;
    __EE4670403.Primary_Name_;
    __EE4670403.Suffix_;
    __EE4670403.Postdirectional_;
    __EE4670403.Unit_Designation_;
    __EE4670403.Secondary_Range_;
    __EE4670403.Postal_City_;
    __EE4670403.Vanity_City_;
    __EE4670403.State_;
    __EE4670403.Zip_;
    __EE4670403.Zip4_;
    __EE4670403.Carrier_Route_Number_;
    __EE4670403.Carrier_Route_Sortation_At_Z_I_P_;
    __EE4670403.Line_Of_Travel_;
    __EE4670403.Line_Of_Travel_Order_;
    __EE4670403.Delivery_Point_Barcode_;
    __EE4670403.Delivery_Point_Barcode_Check_Digit_;
    __EE4670403.Type_Code_;
    __EE4670403.County_;
    __EE4670403.Latitude_;
    __EE4670403.Longitude_;
    __EE4670403.Metropolitan_Statistical_Area_;
    __EE4670403.Geo_Block_;
    __EE4670403.Geo_Match_;
    __EE4670403.A_C_E_Cleaner_Error_Code_;
    __EE4670403._is_Additional_;
    __EE4670403.Aot_Act_Cnt_Ev_;
    __EE4670403.Aot_Src1_Act_Cnt_Ev_;
    __EE4670403.Aot_Src1_Act_Only_Flag_;
    __EE4670403.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE4670403.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4670403.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4670403.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE4670403.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4670403.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4670403.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE4670403.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4670403.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE4670403.Aot_Id_Act_Cnt_Ev_;
    __EE4670403.Aot_Id_Act_Cnt30_D_;
    __EE4670403.Ao_T_Add_Act_Cnt_Ev_;
    __EE4670403.Ao_T_Add_Act_Cnt30_D_;
    __EE4670403.Aot_Non_St_Act_Cnt_Ev_;
    __EE4670403.Aot_Non_St_Act_Cnt30_D_;
    __EE4670403.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4670403.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4670403.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4670403.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE4670403.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE4670403.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE4670403.Customer_Id_;
    __EE4670403.Industry_Type_;
    __EE4670403.In_Customer_Population_;
    __EE4670403.Source_Customer_Count_;
    __EE4670403.Full_Address_;
    __EE4670403.Street_Address_;
    __EE4670403.Entity_Context_Uid_;
    __EE4670403.Entity_Type_;
    __EE4670403.Dt_First_Seen_;
    __EE4670403.Dt_Last_Seen_;
    __EE4670403.Id_Activity_Dt_First_Seen_;
    __EE4670403.Id_Activity_Dt_Last_Seen_;
    __EE4670403.Last_Record_Id_;
    __EE4670403.Not_In_Jurisdiction_State_;
    __EE4670403.Invalid_Address_;
    __EE4670403.Address_Is_Vacant_;
    __EE4670403.Address_Is_Cmra_;
    __EE4670403.Address_Is_Po_Box_;
    __EE4670403.Event_Count_;
    __EE4670403.Identity_Count_;
    __EE4670403.High_Frequency_Flag_;
    __EE4670403.All_Person_Count_;
    __EE4670403.All_High_Frequency_Flag_;
    __EE4670403.Deceased_Person_Count_;
    __EE4670403.Deceased_Person_Percent_;
    __EE4670403.All_Deceased_Person_Count_;
    __EE4670403.All_Deceased_Person_Percent_;
    __EE4670403.Deceased_Match_Person_Count_;
    __EE4670403.Deceased_Match_Person_Percent_;
    __EE4670403.All_Deceased_Match_Person_Count_;
    __EE4670403.All_Deceased_Match_Person_Percent_;
    __EE4670403.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4670403.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4670403.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4670403.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4670403.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4670403.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4670403.Kr_High_Risk_Flag_;
    __EE4670403.Kr_Medium_Risk_Flag_;
    __EE4670403.Kr_Low_Risk_Flag_;
    __EE4670403.Kr_Flag_;
    __EE4670403.Safe_Flag_;
    __EE4670403.Contributor_Safe_Flag_;
    __EE4670403.Kr_Addr300_Flag_;
    __EE4670403.Kr_Addr301_Flag_;
    __EE4670403.Kr_Addr302_Flag_;
    __EE4670403.Kr_Addr303_Flag_;
    __EE4670403.Kr_Addr390_Flag_;
    __EE4670403.Kr_Addr391_Flag_;
    __EE4670403.Kr_Addr392_Flag_;
    __EE4670403.Kr_Addr393_Flag_;
    __EE4670403.Last_Event_Date_;
    __EE4670403.Kr_Last_Event_Date_;
    __EE4670403.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4670403.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4670403.Date_First_Seen_;
    __EE4670403.Date_Last_Seen_;
    __EE4670403.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4670403,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4670405_Layout := RECORDOF(IDX_Address_UID);
