...
EXPORT B_Address := MODULE
  ...
  SHARED __EE1598926 := __ENH_Address_1;
  SHARED __EE1602765 := __ENH_Event_1;
  SHARED __EE1602767 := __E_Address_Event;
  SHARED __EE1650302 := __EE1602767(__NN(__EE1602767.Location_) AND __NN(__EE1602767.Transaction_));
  SHARED __ST1640848_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1650320(B_Event_1.__ST61957_Layout __EE1602765, E_Address_Event.Layout __EE1650302) := __EEQP(__EE1650302.Transaction_,__EE1602765.UID);
  __ST1640848_Layout __JT1650320(B_Event_1.__ST61957_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1650321 := JOIN(__EE1650302,__EE1602765,__JC1650320(RIGHT,LEFT),__JT1650320(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1637426_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1637426_Layout __ND1650965__Project(__ST1640848_Layout __PP1650322) := TRANSFORM
    SELF.UID := __PP1650322.Location__1_;
    SELF.U_I_D__1_ := __PP1650322.UID;
    SELF := __PP1650322;
  END;
  SHARED __EE1653494 := PROJECT(__EE1650321,__ND1650965__Project(LEFT));
  SHARED __ST1638771_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1638771_Layout __ND1654539__Project(__ST1637426_Layout __PP1653495) := TRANSFORM
    SELF.Exp1_ := __CN(__PP1653495.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP1653495.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP1653495.Address_Is_Vacant_);
    SELF.Exp4_ := __PP1653495.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP1653495.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP1653495.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP1653495.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP1653495.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP1653495.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP1653495.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP1653495.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP1653495.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP1653495.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP1653495.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP1653495.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP1653495.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP1653495.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP1653495.Event_Age_,<,__CN(2)),__CN(__PP1653495.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP1653495.Event_Age_,<,__CN(366));
    SELF := __PP1653495;
  END;
  SHARED __EE1654568 := PROJECT(__EE1653494,__ND1654539__Project(LEFT));
  SHARED __ST1638884_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1654687 := PROJECT(__CLEANANDDO(__EE1654568,TABLE(__EE1654568,{KEL.Aggregates.MaxNG(__EE1654568.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE1654568.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE1654568.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1654568.Exp4_),KEL.Aggregates.MinNG(__EE1654568.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1654568.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1654568.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1654568.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1654568.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1654568.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1654568.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1654568.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1654568.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1654568.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1654568.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1654568.Exp15_),KEL.Aggregates.MaxNG(__EE1654568.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1654568.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1654568.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1654568.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1654568.Exp19_)),UID},UID,MERGE)),__ST1638884_Layout);
  SHARED __ST1644033_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1654693(B_Address_1.__ST54710_Layout __EE1598926, __ST1638884_Layout __EE1654687) := __EEQP(__EE1598926.UID,__EE1654687.UID);
  __ST1644033_Layout __JT1654693(B_Address_1.__ST54710_Layout __l, __ST1638884_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1654787 := JOIN(__EE1598926,__EE1654687,__JC1654693(LEFT,RIGHT),__JT1654693(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1586982 := __ENH_Customer_1;
  SHARED __ST1644725_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1654793(__ST1644033_Layout __EE1654787, B_Customer_1.__ST55167_Layout __EE1586982) := __EEQP(__EE1654787._r_Customer_,__EE1586982.UID);
  __ST1644725_Layout __JT1654793(__ST1644033_Layout __l, B_Customer_1.__ST55167_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1654915 := JOIN(__EE1654787,__EE1586982,__JC1654793(LEFT,RIGHT),__JT1654793(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST36643_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST36643_Layout __ND1654920__Project(__ST1644725_Layout __PP1654916) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP1654916.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP1654916.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP1654916.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP1654916.All_Deceased_Match_Person_Count_ / __PP1654916.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP1654916.All_Deceased_Person_Count_ / __PP1654916.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP1654916.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP1654916.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP1654916.Deceased_Match_Person_Count_ / __PP1654916.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP1654916.Deceased_Person_Count_ / __PP1654916.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP1654916.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP1654916.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP1654916.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP1654916.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP1654916.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1654916.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP1654916.State_,<>,__PP1654916.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1654916.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1654916.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP1654916.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP1654916.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP1654916.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP1654916.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1654916.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1654916.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1654916.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1654916.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1654916.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1654916;
  END;
  EXPORT __ENH_Address := PROJECT(__EE1654915,__ND1654920__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE2805260 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2805260._r_Customer_;
    __EE2805260.Source_Customers_;
    __EE2805260._addresspobox_;
    __EE2805260._addresscmra_;
    __EE2805260.Otto_Address_Id_;
    __EE2805260.Primary_Range_;
    __EE2805260.Predirectional_;
    __EE2805260.Primary_Name_;
    __EE2805260.Suffix_;
    __EE2805260.Postdirectional_;
    __EE2805260.Unit_Designation_;
    __EE2805260.Secondary_Range_;
    __EE2805260.Postal_City_;
    __EE2805260.Vanity_City_;
    __EE2805260.State_;
    __EE2805260.Zip_;
    __EE2805260.Zip4_;
    __EE2805260.Carrier_Route_Number_;
    __EE2805260.Carrier_Route_Sortation_At_Z_I_P_;
    __EE2805260.Line_Of_Travel_;
    __EE2805260.Line_Of_Travel_Order_;
    __EE2805260.Delivery_Point_Barcode_;
    __EE2805260.Delivery_Point_Barcode_Check_Digit_;
    __EE2805260.Type_Code_;
    __EE2805260.County_;
    __EE2805260.Latitude_;
    __EE2805260.Longitude_;
    __EE2805260.Metropolitan_Statistical_Area_;
    __EE2805260.Geo_Block_;
    __EE2805260.Geo_Match_;
    __EE2805260.A_C_E_Cleaner_Error_Code_;
    __EE2805260._is_Additional_;
    __EE2805260.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE2805260.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2805260.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2805260.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE2805260.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2805260.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2805260.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE2805260.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2805260.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE2805260.Customer_Id_;
    __EE2805260.Industry_Type_;
    __EE2805260.In_Customer_Population_;
    __EE2805260.Source_Customer_Count_;
    __EE2805260.Full_Address_;
    __EE2805260.Street_Address_;
    __EE2805260.Entity_Context_Uid_;
    __EE2805260.Entity_Type_;
    __EE2805260.Dt_First_Seen_;
    __EE2805260.Dt_Last_Seen_;
    __EE2805260.Last_Record_Id_;
    __EE2805260.Not_In_Jurisdiction_State_;
    __EE2805260.Invalid_Address_;
    __EE2805260.Address_Is_Vacant_;
    __EE2805260.Address_Is_Cmra_;
    __EE2805260.Address_Is_Po_Box_;
    __EE2805260.Event_Count_;
    __EE2805260.Identity_Count_;
    __EE2805260.High_Frequency_Flag_;
    __EE2805260.All_Person_Count_;
    __EE2805260.All_High_Frequency_Flag_;
    __EE2805260.Deceased_Person_Count_;
    __EE2805260.Deceased_Person_Percent_;
    __EE2805260.All_Deceased_Person_Count_;
    __EE2805260.All_Deceased_Person_Percent_;
    __EE2805260.Deceased_Match_Person_Count_;
    __EE2805260.Deceased_Match_Person_Percent_;
    __EE2805260.All_Deceased_Match_Person_Count_;
    __EE2805260.All_Deceased_Match_Person_Percent_;
    __EE2805260.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2805260.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2805260.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE2805260.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE2805260.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE2805260.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE2805260.Vl_Event1_All_Count_;
    __EE2805260.Vl_Event7_All_Count_;
    __EE2805260.Vl_Event30_All_Day_Count_;
    __EE2805260.Vl_Event365_All_Day_Count_;
    __EE2805260.Vl_Event7_All_Active_Flag_;
    __EE2805260.Vl_Event30_All_Active_Flag_;
    __EE2805260.Vl_Event1_Count_;
    __EE2805260.Vl_Event7_Count_;
    __EE2805260.Vl_Event30_Count_;
    __EE2805260.Vl_Event365_Count_;
    __EE2805260.Vl_Event7_Active_Flag_;
    __EE2805260.Vl_Event30_Active_Flag_;
    __EE2805260.Kr_High_Risk_Flag_;
    __EE2805260.Kr_Medium_Risk_Flag_;
    __EE2805260.Kr_Low_Risk_Flag_;
    __EE2805260.Kr_Flag_;
    __EE2805260.Safe_Flag_;
    __EE2805260.Contributor_Safe_Flag_;
    __EE2805260.Kr_Addr300_Flag_;
    __EE2805260.Kr_Addr301_Flag_;
    __EE2805260.Kr_Addr302_Flag_;
    __EE2805260.Kr_Addr303_Flag_;
    __EE2805260.Kr_Addr390_Flag_;
    __EE2805260.Kr_Addr391_Flag_;
    __EE2805260.Kr_Addr392_Flag_;
    __EE2805260.Kr_Addr393_Flag_;
    __EE2805260.Last_Event_Date_;
    __EE2805260.Kr_Last_Event_Date_;
    __EE2805260.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2805260.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2805260.Date_First_Seen_;
    __EE2805260.Date_Last_Seen_;
    __EE2805260.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE2805260,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2805262_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST36643_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
