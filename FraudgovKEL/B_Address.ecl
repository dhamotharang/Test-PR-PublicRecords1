...
IMPORT B_Address_1,B_Customer_1,B_Customer_4,B_Event_1,E_Address,E_Address_Event,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number,FN_Graph FROM FraudgovKEL;
...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2525739 := __ENH_Address_1;
  SHARED __EE2530046 := __ENH_Event_1;
  SHARED __EE2530048 := __E_Address_Event;
  SHARED __EE2585740 := __EE2530048(__NN(__EE2530048.Location_) AND __NN(__EE2530048.Transaction_));
  SHARED __ST2575128_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2585758(B_Event_1.__ST83458_Layout __EE2530046, E_Address_Event.Layout __EE2585740) := __EEQP(__EE2585740.Transaction_,__EE2530046.UID);
  __ST2575128_Layout __JT2585758(B_Event_1.__ST83458_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2585759 := JOIN(__EE2585740,__EE2530046,__JC2585758(RIGHT,LEFT),__JT2585758(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2571314_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2571314_Layout __ND2586485__Project(__ST2575128_Layout __PP2585760) := TRANSFORM
    SELF.UID := __PP2585760.Location__1_;
    SELF.U_I_D__1_ := __PP2585760.UID;
    SELF := __PP2585760;
  END;
  SHARED __EE2589342 := PROJECT(__EE2585759,__ND2586485__Project(LEFT));
  SHARED __ST2572829_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2572829_Layout __ND2590502__Project(__ST2571314_Layout __PP2589343) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2589343.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2589343.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2589343.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2589343.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := IF(__PP2589343.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2589343.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp6_ := __PP2589343.Kr_Addr300_Flag_ = 1;
    SELF.Exp7_ := __PP2589343.Kr_Addr301_Flag_ = 1;
    SELF.Exp8_ := __PP2589343.Kr_Addr302_Flag_ = 1;
    SELF.Exp9_ := __PP2589343.Kr_Addr303_Flag_ = 1;
    SELF.Exp10_ := __PP2589343.Kr_Addr390_Flag_ = 1;
    SELF.Exp11_ := __PP2589343.Kr_Addr391_Flag_ = 1;
    SELF.Exp12_ := __PP2589343.Kr_Addr392_Flag_ = 1;
    SELF.Exp13_ := __PP2589343.Kr_Addr393_Flag_ = 1;
    SELF.Exp14_ := __PP2589343.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2589343.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2589343.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp17_ := __PP2589343.Safe_Flag_ = 1;
    SELF.Exp18_ := __OP2(__PP2589343.Event_Age_,<,__CN(2));
    SELF.Exp19_ := __AND(__OP2(__PP2589343.Event_Age_,<,__CN(2)),__CN(__PP2589343.In_Customer_Population_ = 1));
    SELF.Exp20_ := __OP2(__PP2589343.Event_Age_,<,__CN(366));
    SELF := __PP2589343;
  END;
  SHARED __EE2590532 := PROJECT(__EE2589342,__ND2590502__Project(LEFT));
  SHARED __ST2572947_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2590656 := PROJECT(__CLEANANDDO(__EE2590532,TABLE(__EE2590532,{KEL.Aggregates.MaxNG(__EE2590532.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2590532.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2590532.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2590532.Exp4_),KEL.Aggregates.MinNG(__EE2590532.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2590532.Exp5_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2590532.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2590532.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2590532.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2590532.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2590532.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2590532.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2590532.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2590532.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2590532.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2590532.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2590532.Exp16_),KEL.Aggregates.MaxNG(__EE2590532.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2590532.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2590532.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2590532.Exp19_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2590532.Exp20_)),UID},UID,MERGE)),__ST2572947_Layout);
  SHARED __ST2578723_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2590662(B_Address_1.__ST73847_Layout __EE2525739, __ST2572947_Layout __EE2590656) := __EEQP(__EE2525739.UID,__EE2590656.UID);
  __ST2578723_Layout __JT2590662(B_Address_1.__ST73847_Layout __l, __ST2572947_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2590773 := JOIN(__EE2525739,__EE2590656,__JC2590662(LEFT,RIGHT),__JT2590662(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2506685 := __ENH_Customer_1;
  SHARED __ST2579500_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2590779(__ST2578723_Layout __EE2590773, B_Customer_1.__ST74526_Layout __EE2506685) := __EEQP(__EE2590773._r_Customer_,__EE2506685.UID);
  __ST2579500_Layout __JT2590779(__ST2578723_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2590918 := JOIN(__EE2590773,__EE2506685,__JC2590779(LEFT,RIGHT),__JT2590779(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST48973_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST48973_Layout __ND2590923__Project(__ST2579500_Layout __PP2590919) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2590919.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2590919.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2590919.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2590919.All_Deceased_Match_Person_Count_ / __PP2590919.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2590919.All_Deceased_Person_Count_ / __PP2590919.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2590919.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2590919.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2590919.Deceased_Match_Person_Count_ / __PP2590919.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2590919.Deceased_Person_Count_ / __PP2590919.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2590919.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2590919.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2590919.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2590919.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Id_Activity_Dt_First_Seen_ := __PP2590919.M_I_N___Event_Date__2_;
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2590919.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2590919.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2590919.State_,<>,__PP2590919.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2590919.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2590919.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2590919.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2590919.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP2590919.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP2590919.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2590919.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2590919.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2590919.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2590919.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2590919.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2590919;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2590918,__ND2590923__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE4830037 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE
    __EE4830037.Address_Is_Cmra_;
    __EE4830037.Address_Is_Po_Box_;
    __EE4830037.Event_Count_;
    __EE4830037.Identity_Count_;
    __EE4830037.High_Frequency_Flag_;
    __EE4830037.All_Person_Count_;
    __EE4830037.All_High_Frequency_Flag_;
    __EE4830037.Deceased_Person_Count_;
    __EE4830037.Deceased_Person_Percent_;
    __EE4830037.All_Deceased_Person_Count_;
    __EE4830037.All_Deceased_Person_Percent_;
    __EE4830037.Deceased_Match_Person_Count_;
    __EE4830037.Deceased_Match_Person_Percent_;
    __EE4830037.All_Deceased_Match_Person_Count_;
    __EE4830037.All_Deceased_Match_Person_Percent_;
    __EE4830037.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4830037.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4830037.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4830037.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4830037.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4830037.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4830037.Vl_Event1_All_Count_;
    __EE4830037.Vl_Event7_All_Count_;
    __EE4830037.Vl_Event30_All_Day_Count_;
    __EE4830037.Vl_Event365_All_Day_Count_;
    __EE4830037.Vl_Event7_All_Active_Flag_;
    __EE4830037.Vl_Event30_All_Active_Flag_;
    __EE4830037.Vl_Event1_Count_;
    __EE4830037.Vl_Event7_Count_;
    __EE4830037.Vl_Event30_Count_;
    __EE4830037.Vl_Event365_Count_;
    __EE4830037.Vl_Event7_Active_Flag_;
    __EE4830037.Vl_Event30_Active_Flag_;
    __EE4830037.Kr_High_Risk_Flag_;
    __EE4830037.Kr_Medium_Risk_Flag_;
    __EE4830037.Kr_Low_Risk_Flag_;
    __EE4830037.Kr_Flag_;
    __EE4830037.Safe_Flag_;
    __EE4830037.Contributor_Safe_Flag_;
    __EE4830037.Kr_Addr300_Flag_;
    __EE4830037.Kr_Addr301_Flag_;
    __EE4830037.Kr_Addr302_Flag_;
    __EE4830037.Kr_Addr303_Flag_;
    __EE4830037.Kr_Addr390_Flag_;
    __EE4830037.Kr_Addr391_Flag_;
    __EE4830037.Kr_Addr392_Flag_;
    __EE4830037.Kr_Addr393_Flag_;
    __EE4830037.Last_Event_Date_;
    __EE4830037.Kr_Last_Event_Date_;
    __EE4830037.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4830037.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4830037.Date_First_Seen_;
    __EE4830037.Date_Last_Seen_;
    __EE4830037.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4830037,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  EXPORT IDX_Address_UID_Name := '~key::KEL::FraudgovKEL::Address::UID';
  ...
  EXPORT __ST4830039_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST48973_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
