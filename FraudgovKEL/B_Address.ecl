...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2089801 := __ENH_Address_1;
  SHARED __EE2093816 := __ENH_Event_1;
  SHARED __EE2093818 := __E_Address_Event;
  SHARED __EE2143157 := __EE2093818(__NN(__EE2093818.Location_) AND __NN(__EE2093818.Transaction_));
  SHARED __ST2133257_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2143175(B_Event_1.__ST73836_Layout __EE2093816, E_Address_Event.Layout __EE2143157) := __EEQP(__EE2143157.Transaction_,__EE2093816.UID);
  __ST2133257_Layout __JT2143175(B_Event_1.__ST73836_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2143176 := JOIN(__EE2143157,__EE2093816,__JC2143175(RIGHT,LEFT),__JT2143175(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2129719_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2129719_Layout __ND2143843__Project(__ST2133257_Layout __PP2143177) := TRANSFORM
    SELF.UID := __PP2143177.Location__1_;
    SELF.U_I_D__1_ := __PP2143177.UID;
    SELF := __PP2143177;
  END;
  SHARED __EE2146464 := PROJECT(__EE2143176,__ND2143843__Project(LEFT));
  SHARED __ST2131110_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2131110_Layout __ND2147581__Project(__ST2129719_Layout __PP2146465) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2146465.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2146465.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2146465.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2146465.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP2146465.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP2146465.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP2146465.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP2146465.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP2146465.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP2146465.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP2146465.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP2146465.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP2146465.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP2146465.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2146465.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2146465.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP2146465.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP2146465.Event_Age_,<,__CN(2)),__CN(__PP2146465.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP2146465.Event_Age_,<,__CN(366));
    SELF := __PP2146465;
  END;
  SHARED __EE2147610 := PROJECT(__EE2146464,__ND2147581__Project(LEFT));
  SHARED __ST2131223_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2147729 := PROJECT(__CLEANANDDO(__EE2147610,TABLE(__EE2147610,{KEL.Aggregates.MaxNG(__EE2147610.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2147610.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2147610.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2147610.Exp4_),KEL.Aggregates.MinNG(__EE2147610.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2147610.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2147610.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2147610.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2147610.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2147610.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2147610.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2147610.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2147610.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2147610.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2147610.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2147610.Exp15_),KEL.Aggregates.MaxNG(__EE2147610.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2147610.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2147610.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2147610.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2147610.Exp19_)),UID},UID,MERGE)),__ST2131223_Layout);
  SHARED __ST2136557_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2147735(B_Address_1.__ST65551_Layout __EE2089801, __ST2131223_Layout __EE2147729) := __EEQP(__EE2089801.UID,__EE2147729.UID);
  __ST2136557_Layout __JT2147735(B_Address_1.__ST65551_Layout __l, __ST2131223_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2147841 := JOIN(__EE2089801,__EE2147729,__JC2147735(LEFT,RIGHT),__JT2147735(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2077477 := __ENH_Customer_1;
  SHARED __ST2137309_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2147847(__ST2136557_Layout __EE2147841, B_Customer_1.__ST66213_Layout __EE2077477) := __EEQP(__EE2147841._r_Customer_,__EE2077477.UID);
  __ST2137309_Layout __JT2147847(__ST2136557_Layout __l, B_Customer_1.__ST66213_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2147981 := JOIN(__EE2147841,__EE2077477,__JC2147847(LEFT,RIGHT),__JT2147847(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43698_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43698_Layout __ND2147986__Project(__ST2137309_Layout __PP2147982) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2147982.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2147982.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2147982.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2147982.All_Deceased_Match_Person_Count_ / __PP2147982.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2147982.All_Deceased_Person_Count_ / __PP2147982.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2147982.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2147982.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2147982.Deceased_Match_Person_Count_ / __PP2147982.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2147982.Deceased_Person_Count_ / __PP2147982.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2147982.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2147982.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2147982.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2147982.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2147982.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2147982.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2147982.State_,<>,__PP2147982.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2147982.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2147982.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2147982.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2147982.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP2147982.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP2147982.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2147982.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2147982.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2147982.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2147982.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2147982.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2147982;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2147981,__ND2147986__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE3429849 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE3429849._r_Customer_;
    __EE3429849.Source_Customers_;
    __EE3429849._addresspobox_;
    __EE3429849._addresscmra_;
    __EE3429849.Otto_Address_Id_;
    __EE3429849.Primary_Range_;
    __EE3429849.Predirectional_;
    __EE3429849.Primary_Name_;
    __EE3429849.Suffix_;
    __EE3429849.Postdirectional_;
    __EE3429849.Unit_Designation_;
    __EE3429849.Secondary_Range_;
    __EE3429849.Postal_City_;
    __EE3429849.Vanity_City_;
    __EE3429849.State_;
    __EE3429849.Zip_;
    __EE3429849.Zip4_;
    __EE3429849.Carrier_Route_Number_;
    __EE3429849.Carrier_Route_Sortation_At_Z_I_P_;
    __EE3429849.Line_Of_Travel_;
    __EE3429849.Line_Of_Travel_Order_;
    __EE3429849.Delivery_Point_Barcode_;
    __EE3429849.Delivery_Point_Barcode_Check_Digit_;
    __EE3429849.Type_Code_;
    __EE3429849.County_;
    __EE3429849.Latitude_;
    __EE3429849.Longitude_;
    __EE3429849.Metropolitan_Statistical_Area_;
    __EE3429849.Geo_Block_;
    __EE3429849.Geo_Match_;
    __EE3429849.A_C_E_Cleaner_Error_Code_;
    __EE3429849._is_Additional_;
    __EE3429849.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE3429849.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE3429849.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE3429849.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE3429849.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE3429849.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE3429849.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE3429849.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE3429849.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE3429849.Aot_Id_Act_Cnt_Ev_;
    __EE3429849.Aot_Id_Act_Cnt30_D_;
    __EE3429849.Ao_T_Add_Act_Cnt_Ev_;
    __EE3429849.Ao_T_Add_Act_Cnt30_D_;
    __EE3429849.Aot_Non_St_Act_Cnt_Ev_;
    __EE3429849.Aot_Non_St_Act_Cnt30_D_;
    __EE3429849.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE3429849.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE3429849.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE3429849.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE3429849.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE3429849.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE3429849.Customer_Id_;
    __EE3429849.Industry_Type_;
    __EE3429849.In_Customer_Population_;
    __EE3429849.Source_Customer_Count_;
    __EE3429849.Full_Address_;
    __EE3429849.Street_Address_;
    __EE3429849.Entity_Context_Uid_;
    __EE3429849.Entity_Type_;
    __EE3429849.Dt_First_Seen_;
    __EE3429849.Dt_Last_Seen_;
    __EE3429849.Last_Record_Id_;
    __EE3429849.Not_In_Jurisdiction_State_;
    __EE3429849.Invalid_Address_;
    __EE3429849.Address_Is_Vacant_;
    __EE3429849.Address_Is_Cmra_;
    __EE3429849.Address_Is_Po_Box_;
    __EE3429849.Event_Count_;
    __EE3429849.Identity_Count_;
    __EE3429849.High_Frequency_Flag_;
    __EE3429849.All_Person_Count_;
    __EE3429849.All_High_Frequency_Flag_;
    __EE3429849.Deceased_Person_Count_;
    __EE3429849.Deceased_Person_Percent_;
    __EE3429849.All_Deceased_Person_Count_;
    __EE3429849.All_Deceased_Person_Percent_;
    __EE3429849.Deceased_Match_Person_Count_;
    __EE3429849.Deceased_Match_Person_Percent_;
    __EE3429849.All_Deceased_Match_Person_Count_;
    __EE3429849.All_Deceased_Match_Person_Percent_;
    __EE3429849.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE3429849.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE3429849.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE3429849.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE3429849.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE3429849.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE3429849.Vl_Event1_All_Count_;
    __EE3429849.Vl_Event7_All_Count_;
    __EE3429849.Vl_Event30_All_Day_Count_;
    __EE3429849.Vl_Event365_All_Day_Count_;
    __EE3429849.Vl_Event7_All_Active_Flag_;
    __EE3429849.Vl_Event30_All_Active_Flag_;
    __EE3429849.Vl_Event1_Count_;
    __EE3429849.Vl_Event7_Count_;
    __EE3429849.Vl_Event30_Count_;
    __EE3429849.Vl_Event365_Count_;
    __EE3429849.Vl_Event7_Active_Flag_;
    __EE3429849.Vl_Event30_Active_Flag_;
    __EE3429849.Kr_High_Risk_Flag_;
    __EE3429849.Kr_Medium_Risk_Flag_;
    __EE3429849.Kr_Low_Risk_Flag_;
    __EE3429849.Kr_Flag_;
    __EE3429849.Safe_Flag_;
    __EE3429849.Contributor_Safe_Flag_;
    __EE3429849.Kr_Addr300_Flag_;
    __EE3429849.Kr_Addr301_Flag_;
    __EE3429849.Kr_Addr302_Flag_;
    __EE3429849.Kr_Addr303_Flag_;
    __EE3429849.Kr_Addr390_Flag_;
    __EE3429849.Kr_Addr391_Flag_;
    __EE3429849.Kr_Addr392_Flag_;
    __EE3429849.Kr_Addr393_Flag_;
    __EE3429849.Last_Event_Date_;
    __EE3429849.Kr_Last_Event_Date_;
    __EE3429849.Kr_Event_After_Last_Known_Risk_Count_;
    __EE3429849.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE3429849.Date_First_Seen_;
    __EE3429849.Date_Last_Seen_;
    __EE3429849.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE3429849,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST3429851_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST43698_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
