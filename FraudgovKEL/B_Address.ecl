...
EXPORT B_Address := MODULE
  ...
  SHARED __EE2317890 := __ENH_Address_1;
  SHARED __EE2321730 := __ENH_Event_1;
  SHARED __EE2321732 := __E_Address_Event;
  SHARED __EE2367323 := __EE2321732(__NN(__EE2321732.Location_) AND __NN(__EE2321732.Transaction_));
  SHARED __ST2357529_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2367341(B_Event_1.__ST77514_Layout __EE2321730, E_Address_Event.Layout __EE2367323) := __EEQP(__EE2367323.Transaction_,__EE2321730.UID);
  __ST2357529_Layout __JT2367341(B_Event_1.__ST77514_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2367342 := JOIN(__EE2367323,__EE2321730,__JC2367341(RIGHT,LEFT),__JT2367341(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2354023_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2354023_Layout __ND2368017__Project(__ST2357529_Layout __PP2367343) := TRANSFORM
    SELF.UID := __PP2367343.Location__1_;
    SELF.U_I_D__1_ := __PP2367343.UID;
    SELF := __PP2367343;
  END;
  SHARED __EE2370670 := PROJECT(__EE2367342,__ND2368017__Project(LEFT));
  SHARED __ST2355423_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2355423_Layout __ND2370675__Project(__ST2354023_Layout __PP2370671) := TRANSFORM
    SELF.Exp1_ := __CN(__PP2370671.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP2370671.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP2370671.Address_Is_Vacant_);
    SELF.Exp4_ := __PP2370671.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := IF(__PP2370671.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2370671.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp6_ := __PP2370671.Kr_Addr300_Flag_ = 1;
    SELF.Exp7_ := __PP2370671.Kr_Addr301_Flag_ = 1;
    SELF.Exp8_ := __PP2370671.Kr_Addr302_Flag_ = 1;
    SELF.Exp9_ := __PP2370671.Kr_Addr303_Flag_ = 1;
    SELF.Exp10_ := __PP2370671.Kr_Addr390_Flag_ = 1;
    SELF.Exp11_ := __PP2370671.Kr_Addr391_Flag_ = 1;
    SELF.Exp12_ := __PP2370671.Kr_Addr392_Flag_ = 1;
    SELF.Exp13_ := __PP2370671.Kr_Addr393_Flag_ = 1;
    SELF.Exp14_ := __PP2370671.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP2370671.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP2370671.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp17_ := __PP2370671.Safe_Flag_ = 1;
    SELF := __PP2370671;
  END;
  SHARED __EE2370772 := PROJECT(__EE2370670,__ND2370675__Project(LEFT));
  SHARED __ST2355526_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2370878 := PROJECT(__CLEANANDDO(__EE2370772,TABLE(__EE2370772,{KEL.Aggregates.MaxNG(__EE2370772.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE2370772.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE2370772.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2370772.Exp4_),KEL.Aggregates.MinNG(__EE2370772.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2370772.Exp5_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2370772.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2370772.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2370772.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2370772.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2370772.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2370772.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2370772.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2370772.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2370772.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2370772.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2370772.Exp16_),KEL.Aggregates.MaxNG(__EE2370772.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2370772.Exp17_),UID},UID,MERGE)),__ST2355526_Layout);
  SHARED __ST2360869_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2370884(B_Address_1.__ST68718_Layout __EE2317890, __ST2355526_Layout __EE2370878) := __EEQP(__EE2317890.UID,__EE2370878.UID);
  __ST2360869_Layout __JT2370884(B_Address_1.__ST68718_Layout __l, __ST2355526_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2370885 := JOIN(__EE2317890,__EE2370878,__JC2370884(LEFT,RIGHT),__JT2370884(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2300385 := __ENH_Customer_1;
  SHARED __ST2361583_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    B_Customer_4.__NS188525_Layout Jurisdiction_State_Top_;
    KEL.typ.int Person_Count_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2370992(__ST2360869_Layout __EE2370885, B_Customer_1.__ST69332_Layout __EE2300385) := __EEQP(__EE2370885._r_Customer_,__EE2300385.UID);
  __ST2361583_Layout __JT2370992(__ST2360869_Layout __l, B_Customer_1.__ST69332_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2370993 := JOIN(__EE2370885,__EE2300385,__JC2370992(LEFT,RIGHT),__JT2370992(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST45489_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45489_Layout __ND2371724__Project(__ST2361583_Layout __PP2370994) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP2370994.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP2370994.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP2370994.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP2370994.All_Deceased_Match_Person_Count_ / __PP2370994.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP2370994.All_Deceased_Person_Count_ / __PP2370994.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP2370994.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP2370994.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP2370994.Deceased_Match_Person_Count_ / __PP2370994.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP2370994.Deceased_Person_Count_ / __PP2370994.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP2370994.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_09'),+,__PP2370994.Otto_Address_Id_);
    SELF.Entity_Type_ := 9;
    SELF.Full_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Secondary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Vanity_City_),+,__CN(' ')),+,__FN1(TRIM,__PP2370994.State_)))))))))))))))))));
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP2370994.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Id_Activity_Dt_First_Seen_ := __PP2370994.M_I_N___Event_Date__2_;
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP2370994.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP2370994.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP2370994.M_A_X___Event_Date__1_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP2370994.State_,<>,__PP2370994.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2370994.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2370994.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP2370994.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP2370994.Secondary_Range_))))))))))))))));
    SELF := __PP2370994;
  END;
  EXPORT __ENH_Address := PROJECT(__EE2370993,__ND2371724__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE4261008 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4261008._r_Customer_;
    __EE4261008.Source_Customers_;
    __EE4261008._addresspobox_;
    __EE4261008._addresscmra_;
    __EE4261008.Otto_Address_Id_;
    __EE4261008.Primary_Range_;
    __EE4261008.Predirectional_;
    __EE4261008.Primary_Name_;
    __EE4261008.Suffix_;
    __EE4261008.Postdirectional_;
    __EE4261008.Unit_Designation_;
    __EE4261008.Secondary_Range_;
    __EE4261008.Postal_City_;
    __EE4261008.Vanity_City_;
    __EE4261008.State_;
    __EE4261008.Zip_;
    __EE4261008.Zip4_;
    __EE4261008.Carrier_Route_Number_;
    __EE4261008.Carrier_Route_Sortation_At_Z_I_P_;
    __EE4261008.Line_Of_Travel_;
    __EE4261008.Line_Of_Travel_Order_;
    __EE4261008.Delivery_Point_Barcode_;
    __EE4261008.Delivery_Point_Barcode_Check_Digit_;
    __EE4261008.Type_Code_;
    __EE4261008.County_;
    __EE4261008.Latitude_;
    __EE4261008.Longitude_;
    __EE4261008.Metropolitan_Statistical_Area_;
    __EE4261008.Geo_Block_;
    __EE4261008.Geo_Match_;
    __EE4261008.A_C_E_Cleaner_Error_Code_;
    __EE4261008._is_Additional_;
    __EE4261008.Aot_Act_Cnt_Ev_;
    __EE4261008.Aot_Src1_Act_Cnt_Ev_;
    __EE4261008.Aot_Src1_Act_Only_Flag_;
    __EE4261008.Aot_Addr_Kr_Act_Cnt_Ev_;
    __EE4261008.Aot_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4261008.Aot_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4261008.Aot_Addr_Kr_Act_New_Dt_Ev_;
    __EE4261008.Aot_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4261008.Aot_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4261008.Aot_Addr_Safe_Act_Cnt_Ev_;
    __EE4261008.Aot_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4261008.Aot_Addr_Safe_Act_New_Dt_Ev_;
    __EE4261008.Aot_Id_Act_Cnt_Ev_;
    __EE4261008.Aot_Id_Act_Cnt30_D_;
    __EE4261008.Ao_T_Add_Act_Cnt_Ev_;
    __EE4261008.Ao_T_Add_Act_Cnt30_D_;
    __EE4261008.Aot_Non_St_Act_Cnt_Ev_;
    __EE4261008.Aot_Non_St_Act_Cnt30_D_;
    __EE4261008.Aot_Addr_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4261008.Aot_Addr_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4261008.Aot_Addr_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4261008.Aot_Id_Curr_Prof_Usng_Addr_Cnt_Ev_;
    __EE4261008.Aot_Id_Hist_Prof_Usng_Addr_Cnt_Ev_;
    __EE4261008.Aot_Id_Usng_Addr_Cnt_Ev_;
    __EE4261008.Customer_Id_;
    __EE4261008.Industry_Type_;
    __EE4261008.In_Customer_Population_;
    __EE4261008.Source_Customer_Count_;
    __EE4261008.Full_Address_;
    __EE4261008.Street_Address_;
    __EE4261008.Entity_Context_Uid_;
    __EE4261008.Entity_Type_;
    __EE4261008.Dt_First_Seen_;
    __EE4261008.Dt_Last_Seen_;
    __EE4261008.Id_Activity_Dt_First_Seen_;
    __EE4261008.Id_Activity_Dt_Last_Seen_;
    __EE4261008.Last_Record_Id_;
    __EE4261008.Not_In_Jurisdiction_State_;
    __EE4261008.Invalid_Address_;
    __EE4261008.Address_Is_Vacant_;
    __EE4261008.Address_Is_Cmra_;
    __EE4261008.Address_Is_Po_Box_;
    __EE4261008.Event_Count_;
    __EE4261008.Identity_Count_;
    __EE4261008.High_Frequency_Flag_;
    __EE4261008.All_Person_Count_;
    __EE4261008.All_High_Frequency_Flag_;
    __EE4261008.Deceased_Person_Count_;
    __EE4261008.Deceased_Person_Percent_;
    __EE4261008.All_Deceased_Person_Count_;
    __EE4261008.All_Deceased_Person_Percent_;
    __EE4261008.Deceased_Match_Person_Count_;
    __EE4261008.Deceased_Match_Person_Percent_;
    __EE4261008.All_Deceased_Match_Person_Count_;
    __EE4261008.All_Deceased_Match_Person_Percent_;
    __EE4261008.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4261008.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4261008.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE4261008.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE4261008.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE4261008.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE4261008.Kr_High_Risk_Flag_;
    __EE4261008.Kr_Medium_Risk_Flag_;
    __EE4261008.Kr_Low_Risk_Flag_;
    __EE4261008.Kr_Flag_;
    __EE4261008.Safe_Flag_;
    __EE4261008.Contributor_Safe_Flag_;
    __EE4261008.Kr_Addr300_Flag_;
    __EE4261008.Kr_Addr301_Flag_;
    __EE4261008.Kr_Addr302_Flag_;
    __EE4261008.Kr_Addr303_Flag_;
    __EE4261008.Kr_Addr390_Flag_;
    __EE4261008.Kr_Addr391_Flag_;
    __EE4261008.Kr_Addr392_Flag_;
    __EE4261008.Kr_Addr393_Flag_;
    __EE4261008.Last_Event_Date_;
    __EE4261008.Kr_Last_Event_Date_;
    __EE4261008.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4261008.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4261008.Date_First_Seen_;
    __EE4261008.Date_Last_Seen_;
    __EE4261008.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE4261008,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4261010_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST45489_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
