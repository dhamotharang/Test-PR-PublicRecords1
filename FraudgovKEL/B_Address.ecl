...
EXPORT B_Address := MODULE
  ...
  SHARED __EE543204 := __ENH_Address_1;
  SHARED __EE546096 := __ENH_Event_1;
  SHARED __EE546098 := __E_Address_Event;
  SHARED __EE577974 := __EE546098(__NN(__EE546098.Location_) AND __NN(__EE546098.Transaction_));
  SHARED __ST571071_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC577992(B_Event_1.__ST33177_Layout __EE546096, E_Address_Event.Layout __EE577974) := __EEQP(__EE577974.Transaction_,__EE546096.UID);
  __ST571071_Layout __JT577992(B_Event_1.__ST33177_Layout __l, E_Address_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE577993 := JOIN(__EE577974,__EE546096,__JC577992(RIGHT,LEFT),__JT577992(RIGHT,LEFT),INNER,HASH);
  SHARED __ST568553_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST568553_Layout __ND578411__Project(__ST571071_Layout __PP577994) := TRANSFORM
    SELF.UID := __PP577994.Location__1_;
    SELF.U_I_D__1_ := __PP577994.UID;
    SELF := __PP577994;
  END;
  SHARED __EE580036 := PROJECT(__EE577993,__ND578411__Project(LEFT));
  SHARED __ST569450_Layout := RECORD
    KEL.typ.ntyp(E_Address.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.nint Exp2_;
    KEL.typ.nint Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST569450_Layout __ND580985__Project(__ST568553_Layout __PP580037) := TRANSFORM
    SELF.Exp1_ := __CN(__PP580037.Address_Is_Cmra_);
    SELF.Exp2_ := __CN(__PP580037.Address_Is_Po_Box_);
    SELF.Exp3_ := __CN(__PP580037.Address_Is_Vacant_);
    SELF.Exp4_ := __PP580037.Contributor_Safe_Flag_ = 1;
    SELF.Exp5_ := __PP580037.Kr_Addr300_Flag_ = 1;
    SELF.Exp6_ := __PP580037.Kr_Addr301_Flag_ = 1;
    SELF.Exp7_ := __PP580037.Kr_Addr302_Flag_ = 1;
    SELF.Exp8_ := __PP580037.Kr_Addr303_Flag_ = 1;
    SELF.Exp9_ := __PP580037.Kr_Addr390_Flag_ = 1;
    SELF.Exp10_ := __PP580037.Kr_Addr391_Flag_ = 1;
    SELF.Exp11_ := __PP580037.Kr_Addr392_Flag_ = 1;
    SELF.Exp12_ := __PP580037.Kr_Addr393_Flag_ = 1;
    SELF.Exp13_ := __PP580037.Kr_High_Risk_Address_Flag_ = 1;
    SELF.Exp14_ := __PP580037.Kr_Low_Risk_Address_Flag_ = 1;
    SELF.Exp15_ := __PP580037.Kr_Medium_Risk_Address_Flag_ = 1;
    SELF.Exp16_ := __PP580037.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP580037.Event_Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP580037.Event_Age_,<,__CN(2)),__CN(__PP580037.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP580037.Event_Age_,<,__CN(366));
    SELF := __PP580037;
  END;
  SHARED __EE581014 := PROJECT(__EE580036,__ND580985__Project(LEFT));
  SHARED __ST569566_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE581138 := PROJECT(__CLEANANDDO(__EE581014,TABLE(__EE581014,{KEL.Aggregates.MaxNG(__EE581014.Exp1_) M_A_X___Address_Is_Cmra_,KEL.Aggregates.MaxNG(__EE581014.Exp2_) M_A_X___Address_Is_Po_Box_,KEL.Aggregates.MaxNG(__EE581014.Exp3_) M_A_X___Address_Is_Vacant_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE581014.Exp4_),KEL.Aggregates.MinNG(__EE581014.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE581014.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE581014.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE581014.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE581014.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE581014.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE581014.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE581014.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE581014.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE581014.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE581014.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE581014.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE581014.Exp15_),KEL.Aggregates.MaxNG(__EE581014.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE581014.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE581014.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE581014.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE581014.Exp19_)),UID},UID,MERGE)),__ST569566_Layout);
  SHARED __ST573126_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC581144(B_Address_1.__ST29997_Layout __EE543204, __ST569566_Layout __EE581138) := __EEQP(__EE543204.UID,__EE581138.UID);
  __ST573126_Layout __JT581144(B_Address_1.__ST29997_Layout __l, __ST569566_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE581231 := JOIN(__EE543204,__EE581138,__JC581144(LEFT,RIGHT),__JT581144(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE531654 := __ENH_Customer_1;
  SHARED __ST573724_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC581237(__ST573126_Layout __EE581231, B_Customer_1.__ST30331_Layout __EE531654) := __EEQP(__EE581231._r_Customer_,__EE531654.UID);
  __ST573724_Layout __JT581237(__ST573126_Layout __l, B_Customer_1.__ST30331_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE581352 := JOIN(__EE581231,__EE531654,__JC581237(LEFT,RIGHT),__JT581237(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST20764_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Address.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nbool _addresspobox_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20764_Layout __ND581357__Project(__ST573724_Layout __PP581353) := TRANSFORM
    SELF.Address_Is_Cmra_ := __PP581353.M_A_X___Address_Is_Cmra_;
    SELF.Address_Is_Po_Box_ := __PP581353.M_A_X___Address_Is_Po_Box_;
    SELF.Address_Is_Vacant_ := __PP581353.M_A_X___Address_Is_Vacant_;
    SELF.All_Deceased_Match_Person_Percent_ := __PP581353.All_Deceased_Match_Person_Count_ / __PP581353.All_Person_Count_;
    SELF.All_Deceased_Person_Percent_ := __PP581353.All_Deceased_Person_Count_ / __PP581353.All_Person_Count_;
    SELF.All_High_Frequency_Flag_ := MAP(__PP581353.All_Person_Count_ >= 20=>1,0);
    SELF.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_ := MAP(__PP581353.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Contributor_Safe_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Deceased_Match_Person_Percent_ := __PP581353.Deceased_Match_Person_Count_ / __PP581353.Identity_Count_;
    SELF.Deceased_Person_Percent_ := __PP581353.Deceased_Person_Count_ / __PP581353.Identity_Count_;
    SELF.Dt_First_Seen_ := __PP581353.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP581353.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 9;
    SELF.High_Risk_Death_Prior_To_All_Events_Percent_Flag_ := MAP(__PP581353.High_Risk_Death_Prior_To_All_Events_Person_Percent_ > 0.1=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP581353.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Addr300_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Addr301_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Addr302_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Addr303_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Addr390_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Addr391_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Addr392_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Addr393_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP581353.M_A_X___Event_Date__2_;
    SELF.Not_In_Jurisdiction_State_ := MAP(__T(__OP2(__PP581353.State_,<>,__PP581353.Jurisdiction_State_))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP581353.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP581353.Source_Customers_);
    SELF.Street_Address_ := FN_Graph.FN_Clean_Spaces(__ECAST(KEL.typ.nstr,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Primary_Range_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Predirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Primary_Name_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Suffix_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Postdirectional_),+,__CN(' ')),+,__FN1(TRIM,__OP2(__OP2(__FN1(TRIM,__PP581353.Unit_Designation_),+,__CN(' ')),+,__FN1(TRIM,__FN1(TRIM,__PP581353.Secondary_Range_))))))))))))))));
    SELF.Vl_Event1_All_Count_ := __PP581353.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event1_Count_ := __PP581353.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP581353.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP581353.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP581353.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP581353.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP581353.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP581353;
  END;
  EXPORT __ENH_Address := PROJECT(__EE581352,__ND581357__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Address::Annotated',EXPIRE(7));
  SHARED __EE1284351 := __ENH_Address;
  SHARED IDX_Address_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1284351._r_Customer_;
    __EE1284351.Source_Customers_;
    __EE1284351._addresspobox_;
    __EE1284351._addresscmra_;
    __EE1284351.Otto_Address_Id_;
    __EE1284351.Primary_Range_;
    __EE1284351.Predirectional_;
    __EE1284351.Primary_Name_;
    __EE1284351.Suffix_;
    __EE1284351.Postdirectional_;
    __EE1284351.Unit_Designation_;
    __EE1284351.Secondary_Range_;
    __EE1284351.Postal_City_;
    __EE1284351.Vanity_City_;
    __EE1284351.State_;
    __EE1284351.Zip_;
    __EE1284351.Zip4_;
    __EE1284351.Carrier_Route_Number_;
    __EE1284351.Carrier_Route_Sortation_At_Z_I_P_;
    __EE1284351.Line_Of_Travel_;
    __EE1284351.Line_Of_Travel_Order_;
    __EE1284351.Delivery_Point_Barcode_;
    __EE1284351.Delivery_Point_Barcode_Check_Digit_;
    __EE1284351.Type_Code_;
    __EE1284351.County_;
    __EE1284351.Latitude_;
    __EE1284351.Longitude_;
    __EE1284351.Metropolitan_Statistical_Area_;
    __EE1284351.Geo_Block_;
    __EE1284351.Geo_Match_;
    __EE1284351.A_C_E_Cleaner_Error_Code_;
    __EE1284351._is_Additional_;
    __EE1284351.Customer_Id_;
    __EE1284351.Industry_Type_;
    __EE1284351.In_Customer_Population_;
    __EE1284351.Source_Customer_Count_;
    __EE1284351.Full_Address_;
    __EE1284351.Street_Address_;
    __EE1284351.Entity_Context_Uid_;
    __EE1284351.Entity_Type_;
    __EE1284351.Dt_First_Seen_;
    __EE1284351.Dt_Last_Seen_;
    __EE1284351.Last_Record_Id_;
    __EE1284351.Not_In_Jurisdiction_State_;
    __EE1284351.Invalid_Address_;
    __EE1284351.Address_Is_Vacant_;
    __EE1284351.Address_Is_Cmra_;
    __EE1284351.Address_Is_Po_Box_;
    __EE1284351.Event_Count_;
    __EE1284351.Identity_Count_;
    __EE1284351.High_Frequency_Flag_;
    __EE1284351.All_Person_Count_;
    __EE1284351.All_High_Frequency_Flag_;
    __EE1284351.Deceased_Person_Count_;
    __EE1284351.Deceased_Person_Percent_;
    __EE1284351.All_Deceased_Person_Count_;
    __EE1284351.All_Deceased_Person_Percent_;
    __EE1284351.Deceased_Match_Person_Count_;
    __EE1284351.Deceased_Match_Person_Percent_;
    __EE1284351.All_Deceased_Match_Person_Count_;
    __EE1284351.All_Deceased_Match_Person_Percent_;
    __EE1284351.High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1284351.High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1284351.High_Risk_Death_Prior_To_All_Events_Percent_Flag_;
    __EE1284351.All_High_Risk_Death_Prior_To_All_Events_Person_Count_;
    __EE1284351.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_;
    __EE1284351.All_High_Risk_Death_Prior_To_All_Events_Person_Percent_Flag_;
    __EE1284351.Vl_Event1_All_Count_;
    __EE1284351.Vl_Event7_All_Count_;
    __EE1284351.Vl_Event30_All_Day_Count_;
    __EE1284351.Vl_Event365_All_Day_Count_;
    __EE1284351.Vl_Event7_All_Active_Flag_;
    __EE1284351.Vl_Event30_All_Active_Flag_;
    __EE1284351.Vl_Event1_Count_;
    __EE1284351.Vl_Event7_Count_;
    __EE1284351.Vl_Event30_Count_;
    __EE1284351.Vl_Event365_Count_;
    __EE1284351.Vl_Event7_Active_Flag_;
    __EE1284351.Vl_Event30_Active_Flag_;
    __EE1284351.Kr_High_Risk_Flag_;
    __EE1284351.Kr_Medium_Risk_Flag_;
    __EE1284351.Kr_Low_Risk_Flag_;
    __EE1284351.Kr_Flag_;
    __EE1284351.Safe_Flag_;
    __EE1284351.Contributor_Safe_Flag_;
    __EE1284351.Kr_Addr300_Flag_;
    __EE1284351.Kr_Addr301_Flag_;
    __EE1284351.Kr_Addr302_Flag_;
    __EE1284351.Kr_Addr303_Flag_;
    __EE1284351.Kr_Addr390_Flag_;
    __EE1284351.Kr_Addr391_Flag_;
    __EE1284351.Kr_Addr392_Flag_;
    __EE1284351.Kr_Addr393_Flag_;
    __EE1284351.Last_Event_Date_;
    __EE1284351.Kr_Last_Event_Date_;
    __EE1284351.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1284351.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1284351.Date_First_Seen_;
    __EE1284351.Date_Last_Seen_;
    __EE1284351.__RecordCount;
  END;
  SHARED IDX_Address_UID_Projected := PROJECT(__EE1284351,TRANSFORM(IDX_Address_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1284353_Layout := RECORDOF(IDX_Address_UID);
  EXPORT IDX_Address_UID_Wrapped := PROJECT(IDX_Address_UID,TRANSFORM(__ST20764_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
