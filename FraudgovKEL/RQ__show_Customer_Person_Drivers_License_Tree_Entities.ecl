...
EXPORT RQ__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  SHARED __EE4935639 := PROJECT(B_Person_Drivers_License.IDX_Person_Drivers_License_License__Wrapped,E_Person_Drivers_License.Layout);
  SHARED __EE4935642 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4828633_Layout := RECORD
  ...
  END;
  __JC4935650(E_Person_Drivers_License.Layout __EE4935639, B_Person.__ST71326_Layout __EE4935642) := __EEQP(__EE4935639.Subject_,__EE4935642.UID);
  __ST4828633_Layout __JT4935650(E_Person_Drivers_License.Layout __l, B_Person.__ST71326_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4935651 := JOIN(__EE4935639,__EE4935642,__JC4935650(LEFT,RIGHT),__JT4935650(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4935946 := B_Drivers_License.IDX_Drivers_License_UID_Wrapped;
  SHARED __ST4828974_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4935954(__ST4828633_Layout __EE4935651, B_Drivers_License.__ST50702_Layout __EE4935946) := __EEQP(__EE4935651.License_,__EE4935946.UID);
  __ST4828974_Layout __JT4935954(__ST4828633_Layout __l, B_Drivers_License.__ST50702_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4935955 := JOIN(__EE4935651,__EE4935946,__JC4935954(LEFT,RIGHT),__JT4935954(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4936864 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4829480_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4936878(__ST4828974_Layout __EE4935955, E_Customer.Layout __EE4936864) := __EEQP(__EE4935955._r_Customer_,__EE4936864.UID);
  __ST4829480_Layout __JT4936878(__ST4828974_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4937270 := JOIN(__EE4935955,__EE4936864,__JC4936878(LEFT,RIGHT),__JT4936878(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4828538_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4828538_Layout __ND4937653__Project(__ST4829480_Layout __PP4937271) := TRANSFORM
    SELF.Source_Customer_ := __PP4937271._r_Customer_;
    SELF.Customer_Id_ := __PP4937271.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4937271.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4937271.Entity_Context_Uid__1_;
    SELF := __PP4937271;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4937270,__ND4937653__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4828538_Layout));
END;
