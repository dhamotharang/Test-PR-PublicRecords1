...
EXPORT RQ__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  SHARED __EE2900276 := PROJECT(B_Person_Drivers_License.IDX_Person_Drivers_License_License__Wrapped,E_Person_Drivers_License.Layout);
  SHARED __EE2900279 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2804023_Layout := RECORD
  ...
  END;
  __JC2900287(E_Person_Drivers_License.Layout __EE2900276, B_Person.__ST52826_Layout __EE2900279) := __EEQP(__EE2900276.Subject_,__EE2900279.UID);
  __ST2804023_Layout __JT2900287(E_Person_Drivers_License.Layout __l, B_Person.__ST52826_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2900288 := JOIN(__EE2900276,__EE2900279,__JC2900287(LEFT,RIGHT),__JT2900287(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2900558 := B_Drivers_License.IDX_Drivers_License_UID_Wrapped;
  SHARED __ST2804337_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2900566(__ST2804023_Layout __EE2900288, B_Drivers_License.__ST37942_Layout __EE2900558) := __EEQP(__EE2900288.License_,__EE2900558.UID);
  __ST2804337_Layout __JT2900566(__ST2804023_Layout __l, B_Drivers_License.__ST37942_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2900567 := JOIN(__EE2900288,__EE2900558,__JC2900566(LEFT,RIGHT),__JT2900566(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2901370 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2804777_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2901384(__ST2804337_Layout __EE2900567, E_Customer.Layout __EE2901370) := __EEQP(__EE2900567._r_Customer_,__EE2901370.UID);
  __ST2804777_Layout __JT2901384(__ST2804337_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2901734 := JOIN(__EE2900567,__EE2901370,__JC2901384(LEFT,RIGHT),__JT2901384(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2803928_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2803928_Layout __ND2902075__Project(__ST2804777_Layout __PP2901735) := TRANSFORM
    SELF.Source_Customer_ := __PP2901735._r_Customer_;
    SELF.Customer_Id_ := __PP2901735.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2901735.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2901735.Entity_Context_Uid__1_;
    SELF := __PP2901735;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2901734,__ND2902075__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2803928_Layout));
END;
