...
EXPORT RQ__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  SHARED __EE1467093 := PROJECT(B_Person_Drivers_License.IDX_Person_Drivers_License_License__Wrapped,E_Person_Drivers_License.Layout);
  SHARED __EE1467096 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1359323_Layout := RECORD
  ...
  END;
  __JC1467104(E_Person_Drivers_License.Layout __EE1467093, B_Person.__ST30234_Layout __EE1467096) := __EEQP(__EE1467093.Subject_,__EE1467096.UID);
  __ST1359323_Layout __JT1467104(E_Person_Drivers_License.Layout __l, B_Person.__ST30234_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1467105 := JOIN(__EE1467093,__EE1467096,__JC1467104(LEFT,RIGHT),__JT1467104(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1467435 := B_Drivers_License.IDX_Drivers_License_UID_Wrapped;
  SHARED __ST1359697_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1467443(__ST1359323_Layout __EE1467105, B_Drivers_License.__ST23464_Layout __EE1467435) := __EEQP(__EE1467105.License_,__EE1467435.UID);
  __ST1359697_Layout __JT1467443(__ST1359323_Layout __l, B_Drivers_License.__ST23464_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1467444 := JOIN(__EE1467105,__EE1467435,__JC1467443(LEFT,RIGHT),__JT1467443(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1468363 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1360197_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1468377(__ST1359697_Layout __EE1467444, E_Customer.Layout __EE1468363) := __EEQP(__EE1467444._r_Customer_,__EE1468363.UID);
  __ST1360197_Layout __JT1468377(__ST1359697_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1468783 := JOIN(__EE1467444,__EE1468363,__JC1468377(LEFT,RIGHT),__JT1468377(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1359228_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1359228_Layout __ND1469180__Project(__ST1360197_Layout __PP1468784) := TRANSFORM
    SELF.Source_Customer_ := __PP1468784._r_Customer_;
    SELF.Customer_Id_ := __PP1468784.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1468784.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1468784.Entity_Context_Uid__1_;
    SELF := __PP1468784;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1468783,__ND1469180__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1359228_Layout));
END;
