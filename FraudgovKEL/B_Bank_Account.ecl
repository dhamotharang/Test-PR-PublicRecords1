...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2428457 := __ENH_Bank_Account_1;
  SHARED __EE2432853 := __ENH_Event_1;
  SHARED __EE2432851 := __E_Bank_Account_Event;
  SHARED __EE2483318 := __EE2432851(__NN(__EE2432851.Account_) AND __NN(__EE2432851.Transaction_));
  SHARED __ST2473703_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2483336(B_Event_1.__ST77751_Layout __EE2432853, E_Bank_Account_Event.Layout __EE2483318) := __EEQP(__EE2483318.Transaction_,__EE2432853.UID);
  __ST2473703_Layout __JT2483336(B_Event_1.__ST77751_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2483337 := JOIN(__EE2483318,__EE2432853,__JC2483336(RIGHT,LEFT),__JT2483336(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2470217_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2470217_Layout __ND2484029__Project(__ST2473703_Layout __PP2483338) := TRANSFORM
    SELF.UID := __PP2483338.Account_;
    SELF._r_Customer_ := __PP2483338._r_Customer__1_;
    SELF.Event_Date_ := __PP2483338.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2483338.UID;
    SELF.Event_Date__1_ := __PP2483338.Event_Date_;
    SELF._r_Customer__1_ := __PP2483338._r_Customer_;
    SELF := __PP2483338;
  END;
  SHARED __EE2486758 := PROJECT(__EE2483337,__ND2484029__Project(LEFT));
  SHARED __ST2471656_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2471656_Layout __ND2487571__Project(__ST2470217_Layout __PP2486759) := TRANSFORM
    SELF.Exp1_ := __PP2486759.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2486759.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2486759.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2486759.Kr_Bnk800_Flag_ = 1;
    SELF.Exp4_ := __PP2486759.Kr_Bnk801_Flag_ = 1;
    SELF.Exp5_ := __PP2486759.Kr_Bnk802_Flag_ = 1;
    SELF.Exp6_ := __PP2486759.Kr_Bnk890_Flag_ = 1;
    SELF.Exp7_ := __PP2486759.Kr_Bnk891_Flag_ = 1;
    SELF.Exp8_ := __PP2486759.Kr_Bnk892_Flag_ = 1;
    SELF.Exp9_ := __PP2486759.Kr_Bnk893_Flag_ = 1;
    SELF.Exp10_ := __PP2486759.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2486759.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2486759.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp13_ := __PP2486759.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2486759.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2486759.Event_Age_,<,__CN(2)),__CN(__PP2486759.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2486759.Event_Age_,<,__CN(366));
    SELF := __PP2486759;
  END;
  SHARED __EE2487597 := PROJECT(__EE2486758,__ND2487571__Project(LEFT));
  SHARED __ST2471754_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2487701 := PROJECT(__CLEANANDDO(__EE2487597,TABLE(__EE2487597,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2487597.Exp1_),KEL.Aggregates.MinNG(__EE2487597.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2487597.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2487597.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2487597.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2487597.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2487597.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2487597.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2487597.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2487597.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2487597.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2487597.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2487597.Exp12_),KEL.Aggregates.MaxNG(__EE2487597.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2487597.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2487597.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2487597.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2487597.Exp16_)),UID},UID,MERGE)),__ST2471754_Layout);
  SHARED __ST2477136_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2487707(B_Bank_Account_1.__ST69469_Layout __EE2428457, __ST2471754_Layout __EE2487701) := __EEQP(__EE2428457.UID,__EE2487701.UID);
  __ST2477136_Layout __JT2487707(B_Bank_Account_1.__ST69469_Layout __l, __ST2471754_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2487771 := JOIN(__EE2428457,__EE2487701,__JC2487707(LEFT,RIGHT),__JT2487707(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2410409 := __ENH_Customer_1;
  SHARED __ST2477560_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2487777(__ST2477136_Layout __EE2487771, B_Customer_1.__ST69603_Layout __EE2410409) := __EEQP(__EE2487771._r_Customer_,__EE2410409.UID);
  __ST2477560_Layout __JT2487777(__ST2477136_Layout __l, B_Customer_1.__ST69603_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2487863 := JOIN(__EE2487771,__EE2410409,__JC2487777(LEFT,RIGHT),__JT2487777(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2410266 := __ENH_Bank_1;
  SHARED __ST2478007_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2487869(__ST2477560_Layout __EE2487863, B_Bank_2.__ST81439_Layout __EE2410266) := __EEQP(__EE2487863._r_Bank_,__EE2410266.UID);
  __ST2478007_Layout __JT2487869(__ST2477560_Layout __l, B_Bank_2.__ST81439_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2487974 := JOIN(__EE2487863,__EE2410266,__JC2487869(LEFT,RIGHT),__JT2487869(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46658_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46658_Layout __ND2487979__Project(__ST2478007_Layout __PP2487975) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2487975.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2487975.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2487975.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2487975.Identity_Count_ > 2=>1,0);
    __BS2488130 := __T(__PP2487975.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2488130(__T(__OP2(__T(__PP2487975.Source_Customers_)._r_Source_Customer_,=,__PP2487975._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2487975.Account_Number_;
    SELF.Last_Event_Date_ := __PP2487975.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2487975.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2487975.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2487975.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2487975.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2487975.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2487975.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2487975.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2487975.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2487975.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2487975;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2487974,__ND2487979__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4265842 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4265842._r_Customer_;
    __EE4265842.Source_Customers_;
    __EE4265842._r_Bank_;
    __EE4265842.Account_Number_;
    __EE4265842.Otto_Bank_Account_Id_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4265842.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4265842.Aot_Id_Act_Cnt_Ev_;
    __EE4265842.Aot_Id_Act_Cnt30_D_;
    __EE4265842.Aot_Add_Act_Cnt_Ev_;
    __EE4265842.Aot_Add_Act_Cnt30_D_;
    __EE4265842.Aot_Non_St_Act_Cnt_Ev_;
    __EE4265842.Aot_Non_St_Act_Cnt30_D_;
    __EE4265842.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4265842.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4265842.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4265842.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4265842.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4265842.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4265842.Customer_Id_;
    __EE4265842.Industry_Type_;
    __EE4265842.Source_Customer_Count_;
    __EE4265842.Entity_Context_Uid_;
    __EE4265842.Entity_Type_;
    __EE4265842.Label_;
    __EE4265842.Abbreviated_Bankname_;
    __EE4265842.In_Customer_Population_;
    __EE4265842.Dt_First_Seen_;
    __EE4265842.Dt_Last_Seen_;
    __EE4265842.Id_Activity_Dt_First_Seen_;
    __EE4265842.Id_Activity_Dt_Last_Seen_;
    __EE4265842.Last_Record_Id_;
    __EE4265842.Identity_Count_;
    __EE4265842.Identity_Count_Gt2_;
    __EE4265842.Event_Count_;
    __EE4265842.High_Risk_Routing_;
    __EE4265842.Kr_High_Risk_Flag_;
    __EE4265842.Kr_Medium_Risk_Flag_;
    __EE4265842.Kr_Low_Risk_Flag_;
    __EE4265842.Kr_Flag_;
    __EE4265842.Safe_Flag_;
    __EE4265842.Contributor_Safe_Flag_;
    __EE4265842.Last_Event_Date_;
    __EE4265842.Kr_Last_Event_Date_;
    __EE4265842.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4265842.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4265842.Kr_Bnk800_Flag_;
    __EE4265842.Kr_Bnk801_Flag_;
    __EE4265842.Kr_Bnk802_Flag_;
    __EE4265842.Kr_Bnk890_Flag_;
    __EE4265842.Kr_Bnk891_Flag_;
    __EE4265842.Kr_Bnk892_Flag_;
    __EE4265842.Kr_Bnk893_Flag_;
    __EE4265842.Vl_Event1_All_Count_;
    __EE4265842.Vl_Event7_All_Count_;
    __EE4265842.Vl_Event30_All_Day_Count_;
    __EE4265842.Vl_Event365_All_Day_Count_;
    __EE4265842.Vl_Event7_All_Active_Flag_;
    __EE4265842.Vl_Event30_All_Active_Flag_;
    __EE4265842.Vl_Event1_Count_;
    __EE4265842.Vl_Event7_Count_;
    __EE4265842.Vl_Event30_Count_;
    __EE4265842.Vl_Event365_Count_;
    __EE4265842.Vl_Event7_Active_Flag_;
    __EE4265842.Vl_Event30_Active_Flag_;
    __EE4265842.Date_First_Seen_;
    __EE4265842.Date_Last_Seen_;
    __EE4265842.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4265842,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4265844_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST46658_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
