...
IMPORT B_Bank_Account_1,B_Customer_1,B_Customer_4,B_Event_1,E_Address,E_Bank,E_Bank_Account,E_Bank_Account_Event,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE563324 := __ENH_Bank_Account_1;
  SHARED __EE594297 := __E_Bank_Account_Event;
  SHARED __EE594304 := __EE594297(__NN(__EE594297.Account_));
  SHARED __ST588180_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Bank_Account_Event_ := 0;
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE594295 := PROJECT(__CLEANANDDO(__EE594304,TABLE(__EE594304,{KEL.typ.int C_O_U_N_T___Bank_Account_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Bank_Account.Typ) UID := __EE594304.Account_},Account_,MERGE)),__ST588180_Layout);
  SHARED __ST590465_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC594324(B_Bank_Account_1.__ST32622_Layout __EE563324, __ST588180_Layout __EE594295) := __EEQP(__EE563324.UID,__EE594295.UID);
  __ST590465_Layout __JT594324(B_Bank_Account_1.__ST32622_Layout __l, __ST588180_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE594325 := JOIN(__EE563324,__EE594295,__JC594324(LEFT,RIGHT),__JT594324(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE594308 := __ENH_Event_1;
  SHARED __EE598683 := __EE594297;
  SHARED __EE598696 := __EE598683(__NN(__EE598683.Account_) AND __NN(__EE598683.Transaction_));
  SHARED __ST588533_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC598702(B_Event_1.__ST35754_Layout __EE594308, E_Bank_Account_Event.Layout __EE598696) := __EEQP(__EE598696.Transaction_,__EE594308.UID);
  __ST588533_Layout __JT598702(B_Event_1.__ST35754_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE598703 := JOIN(__EE598696,__EE594308,__JC598702(RIGHT,LEFT),__JT598702(RIGHT,LEFT),INNER,HASH);
  SHARED __ST585963_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST585963_Layout __ND599096__Project(__ST588533_Layout __PP598704) := TRANSFORM
    SELF.UID := __PP598704.Account_;
    SELF._r_Customer_ := __PP598704._r_Customer__1_;
    SELF.Event_Date_ := __PP598704.Event_Date__1_;
    SELF.U_I_D__1_ := __PP598704.UID;
    SELF.Event_Date__1_ := __PP598704.Event_Date_;
    SELF._r_Customer__1_ := __PP598704._r_Customer_;
    SELF := __PP598704;
  END;
  SHARED __EE600621 := PROJECT(__EE598703,__ND599096__Project(LEFT));
  SHARED __ST586804_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST586804_Layout __ND601202__Project(__ST585963_Layout __PP600622) := TRANSFORM
    SELF.Exp1_ := __PP600622.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP600622.Kr_Bnk800_Flag_ = 1;
    SELF.Exp3_ := __PP600622.Kr_Bnk801_Flag_ = 1;
    SELF.Exp4_ := __PP600622.Kr_Bnk802_Flag_ = 1;
    SELF.Exp5_ := __PP600622.Kr_Bnk890_Flag_ = 1;
    SELF.Exp6_ := __PP600622.Kr_Bnk891_Flag_ = 1;
    SELF.Exp7_ := __PP600622.Kr_Bnk892_Flag_ = 1;
    SELF.Exp8_ := __PP600622.Kr_Bnk893_Flag_ = 1;
    SELF.Exp9_ := __PP600622.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp10_ := __PP600622.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP600622.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP600622.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP600622.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP600622.Event_Age_,<,__CN(2)),__CN(__PP600622.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP600622.Event_Age_,<,__CN(366));
    SELF := __PP600622;
  END;
  SHARED __EE601227 := PROJECT(__EE600621,__ND601202__Project(LEFT));
  SHARED __ST586900_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE601331 := PROJECT(__CLEANANDDO(__EE601227,TABLE(__EE601227,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE601227.Exp1_),KEL.Aggregates.MinNG(__EE601227.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE601227.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE601227.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE601227.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE601227.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE601227.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE601227.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE601227.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE601227.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE601227.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE601227.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE601227.Exp11_),KEL.Aggregates.MaxNG(__EE601227.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE601227.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE601227.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE601227.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE601227.Exp15_)),UID},UID,MERGE)),__ST586900_Layout);
  SHARED __ST590715_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC601337(__ST590465_Layout __EE594325, __ST586900_Layout __EE601331) := __EEQP(__EE594325.UID,__EE601331.UID);
  __ST590715_Layout __JT601337(__ST590465_Layout __l, __ST586900_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE601385 := JOIN(__EE594325,__EE601331,__JC601337(LEFT,RIGHT),__JT601337(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE552549 := __ENH_Customer_1;
  SHARED __ST591039_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC601391(__ST590715_Layout __EE601385, B_Customer_1.__ST32738_Layout __EE552549) := __EEQP(__EE601385._r_Customer_,__EE552549.UID);
  __ST591039_Layout __JT601391(__ST590715_Layout __l, B_Customer_1.__ST32738_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE601461 := JOIN(__EE601385,__EE552549,__JC601391(LEFT,RIGHT),__JT601391(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST23132_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST23132_Layout __ND601466__Project(__ST591039_Layout __PP601462) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP601462.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP601462.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 19;
    SELF.Event_Count_ := __PP601462.C_O_U_N_T___Bank_Account_Event_;
    SELF.Identity_Count_Gt2_ := MAP(__PP601462.Identity_Count_ > 2=>1,0);
    __BS601555 := __T(__PP601462.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS601555(__T(__OP2(__T(__PP601462.Source_Customers_)._r_Source_Customer_,=,__PP601462._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP601462.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP601462.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP601462.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP601462.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP601462.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP601462.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP601462.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP601462.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP601462.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP601462.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP601462;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE601461,__ND601466__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE1379510 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1379510._r_Customer_;
    __EE1379510.Source_Customers_;
    __EE1379510._r_Bank_;
    __EE1379510.Account_Number_;
    __EE1379510.Otto_Bank_Account_Id_;
    __EE1379510.Customer_Id_;
    __EE1379510.Industry_Type_;
    __EE1379510.Source_Customer_Count_;
    __EE1379510.Entity_Context_Uid_;
    __EE1379510.Entity_Type_;
    __EE1379510.Label_;
    __EE1379510.Abbreviated_Bankname_;
    __EE1379510.In_Customer_Population_;
    __EE1379510.Dt_First_Seen_;
    __EE1379510.Dt_Last_Seen_;
    __EE1379510.Last_Record_Id_;
    __EE1379510.Identity_Count_;
    __EE1379510.Identity_Count_Gt2_;
    __EE1379510.Event_Count_;
    __EE1379510.High_Risk_Routing_;
    __EE1379510.Kr_High_Risk_Flag_;
    __EE1379510.Kr_Medium_Risk_Flag_;
    __EE1379510.Kr_Low_Risk_Flag_;
    __EE1379510.Kr_Flag_;
    __EE1379510.Safe_Flag_;
    __EE1379510.Contributor_Safe_Flag_;
    __EE1379510.Last_Event_Date_;
    __EE1379510.Kr_Last_Event_Date_;
    __EE1379510.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1379510.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1379510.Kr_Bnk800_Flag_;
    __EE1379510.Kr_Bnk801_Flag_;
    __EE1379510.Kr_Bnk802_Flag_;
    __EE1379510.Kr_Bnk890_Flag_;
    __EE1379510.Kr_Bnk891_Flag_;
    __EE1379510.Kr_Bnk892_Flag_;
    __EE1379510.Kr_Bnk893_Flag_;
    __EE1379510.Vl_Event1_All_Count_;
    __EE1379510.Vl_Event7_All_Count_;
    __EE1379510.Vl_Event30_All_Day_Count_;
    __EE1379510.Vl_Event365_All_Day_Count_;
    __EE1379510.Vl_Event7_All_Active_Flag_;
    __EE1379510.Vl_Event30_All_Active_Flag_;
    __EE1379510.Vl_Event1_Count_;
    __EE1379510.Vl_Event7_Count_;
    __EE1379510.Vl_Event30_Count_;
    __EE1379510.Vl_Event365_Count_;
    __EE1379510.Vl_Event7_Active_Flag_;
    __EE1379510.Vl_Event30_Active_Flag_;
    __EE1379510.Date_First_Seen_;
    __EE1379510.Date_Last_Seen_;
    __EE1379510.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE1379510,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1379512_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST23132_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
