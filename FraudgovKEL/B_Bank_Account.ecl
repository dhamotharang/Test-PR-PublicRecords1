...
IMPORT B_Bank_1,B_Bank_2,B_Bank_Account_1,B_Customer_1,B_Customer_5,B_Event_1,E_Address,E_Bank,E_Bank_Account,E_Bank_Account_Event,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2504186 := __ENH_Bank_Account_1;
  SHARED __EE2508429 := __ENH_Event_1;
  SHARED __EE2508427 := __E_Bank_Account_Event;
  SHARED __EE2553014 := __EE2508427(__NN(__EE2508427.Account_) AND __NN(__EE2508427.Transaction_));
  SHARED __ST2543504_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2553032(B_Event_1.__ST80990_Layout __EE2508429, E_Bank_Account_Event.Layout __EE2553014) := __EEQP(__EE2553014.Transaction_,__EE2508429.UID);
  __ST2543504_Layout __JT2553032(B_Event_1.__ST80990_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2553033 := JOIN(__EE2553014,__EE2508429,__JC2553032(RIGHT,LEFT),__JT2553032(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2539968_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2539968_Layout __ND2553759__Project(__ST2543504_Layout __PP2553034) := TRANSFORM
    SELF.UID := __PP2553034.Account_;
    SELF._r_Customer_ := __PP2553034._r_Customer__1_;
    SELF.Event_Date_ := __PP2553034.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2553034.UID;
    SELF.Event_Date__1_ := __PP2553034.Event_Date_;
    SELF._r_Customer__1_ := __PP2553034._r_Customer_;
    SELF := __PP2553034;
  END;
  SHARED __EE2556552 := PROJECT(__EE2553033,__ND2553759__Project(LEFT));
  SHARED __ST2541474_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2541474_Layout __ND2556557__Project(__ST2539968_Layout __PP2556553) := TRANSFORM
    SELF.Exp1_ := __PP2556553.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2556553.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2556553.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2556553.Kr_Bnk800_Flag_ = 1;
    SELF.Exp4_ := __PP2556553.Kr_Bnk801_Flag_ = 1;
    SELF.Exp5_ := __PP2556553.Kr_Bnk802_Flag_ = 1;
    SELF.Exp6_ := __PP2556553.Kr_Bnk890_Flag_ = 1;
    SELF.Exp7_ := __PP2556553.Kr_Bnk891_Flag_ = 1;
    SELF.Exp8_ := __PP2556553.Kr_Bnk892_Flag_ = 1;
    SELF.Exp9_ := __PP2556553.Kr_Bnk893_Flag_ = 1;
    SELF.Exp10_ := __PP2556553.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2556553.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2556553.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp13_ := __PP2556553.Safe_Flag_ = 1;
    SELF := __PP2556553;
  END;
  SHARED __EE2556634 := PROJECT(__EE2556552,__ND2556557__Project(LEFT));
  SHARED __ST2541557_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2556720 := PROJECT(__CLEANANDDO(__EE2556634,TABLE(__EE2556634,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2556634.Exp1_),KEL.Aggregates.MinNG(__EE2556634.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2556634.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2556634.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2556634.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2556634.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2556634.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2556634.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2556634.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2556634.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2556634.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2556634.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2556634.Exp12_),KEL.Aggregates.MaxNG(__EE2556634.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2556634.Exp13_),UID},UID,MERGE)),__ST2541557_Layout);
  SHARED __ST2547047_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2556726(B_Bank_Account_1.__ST72471_Layout __EE2504186, __ST2541557_Layout __EE2556720) := __EEQP(__EE2504186.UID,__EE2556720.UID);
  __ST2547047_Layout __JT2556726(B_Bank_Account_1.__ST72471_Layout __l, __ST2541557_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2556727 := JOIN(__EE2504186,__EE2556720,__JC2556726(LEFT,RIGHT),__JT2556726(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2486148 := __ENH_Customer_1;
  SHARED __ST2547423_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2556790(__ST2547047_Layout __EE2556727, B_Customer_1.__ST72603_Layout __EE2486148) := __EEQP(__EE2556727._r_Customer_,__EE2486148.UID);
  __ST2547423_Layout __JT2556790(__ST2547047_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2556791 := JOIN(__EE2556727,__EE2486148,__JC2556790(LEFT,RIGHT),__JT2556790(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2485999 := __ENH_Bank_1;
  SHARED __ST2547823_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2556877(__ST2547423_Layout __EE2556791, B_Bank_2.__ST84393_Layout __EE2485999) := __EEQP(__EE2556791._r_Bank_,__EE2485999.UID);
  __ST2547823_Layout __JT2556877(__ST2547423_Layout __l, B_Bank_2.__ST84393_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2556878 := JOIN(__EE2556791,__EE2485999,__JC2556877(LEFT,RIGHT),__JT2556877(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST48341_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST48341_Layout __ND2557273__Project(__ST2547823_Layout __PP2556879) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2556879.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2556879.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2556879.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2556879.Identity_Count_ > 2=>1,0);
    __BS2557129 := __T(__PP2556879.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2557129(__T(__OP2(__T(__PP2556879.Source_Customers_)._r_Source_Customer_,=,__PP2556879._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP2556879.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2556879.Account_Number_;
    SELF.Last_Event_Date_ := __PP2556879.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2556879.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2556879.Source_Customers_);
    SELF := __PP2556879;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2556878,__ND2557273__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4415148 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4415148._r_Customer_;
    __EE4415148.Source_Customers_;
    __EE4415148._r_Bank_;
    __EE4415148.Account_Number_;
    __EE4415148.Otto_Bank_Account_Id_;
    __EE4415148.Aot_Act_Cnt_Ev_;
    __EE4415148.Aot_Src1_Act_Cnt_Ev_;
    __EE4415148.Aot_Src1_Act_Only_Flag_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4415148.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4415148.Aot_Id_Act_Cnt_Ev_;
    __EE4415148.Aot_Id_Act_Cnt30_D_;
    __EE4415148.Aot_Add_Act_Cnt_Ev_;
    __EE4415148.Aot_Add_Act_Cnt30_D_;
    __EE4415148.Aot_Non_St_Act_Cnt_Ev_;
    __EE4415148.Aot_Non_St_Act_Cnt30_D_;
    __EE4415148.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4415148.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4415148.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4415148.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4415148.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4415148.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4415148.Customer_Id_;
    __EE4415148.Industry_Type_;
    __EE4415148.Source_Customer_Count_;
    __EE4415148.Entity_Context_Uid_;
    __EE4415148.Entity_Type_;
    __EE4415148.Label_;
    __EE4415148.Abbreviated_Bankname_;
    __EE4415148.In_Customer_Population_;
    __EE4415148.Dt_First_Seen_;
    __EE4415148.Dt_Last_Seen_;
    __EE4415148.Id_Activity_Dt_First_Seen_;
    __EE4415148.Id_Activity_Dt_Last_Seen_;
    __EE4415148.Last_Record_Id_;
    __EE4415148.Identity_Count_;
    __EE4415148.Identity_Count_Gt2_;
    __EE4415148.Event_Count_;
    __EE4415148.High_Risk_Routing_;
    __EE4415148.Kr_High_Risk_Flag_;
    __EE4415148.Kr_Medium_Risk_Flag_;
    __EE4415148.Kr_Low_Risk_Flag_;
    __EE4415148.Kr_Flag_;
    __EE4415148.Safe_Flag_;
    __EE4415148.Contributor_Safe_Flag_;
    __EE4415148.Last_Event_Date_;
    __EE4415148.Kr_Last_Event_Date_;
    __EE4415148.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4415148.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4415148.Kr_Bnk800_Flag_;
    __EE4415148.Kr_Bnk801_Flag_;
    __EE4415148.Kr_Bnk802_Flag_;
    __EE4415148.Kr_Bnk890_Flag_;
    __EE4415148.Kr_Bnk891_Flag_;
    __EE4415148.Kr_Bnk892_Flag_;
    __EE4415148.Kr_Bnk893_Flag_;
    __EE4415148.Date_First_Seen_;
    __EE4415148.Date_Last_Seen_;
    __EE4415148.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4415148,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4415150_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST48341_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
