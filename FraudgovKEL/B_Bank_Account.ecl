...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2163030 := __ENH_Bank_Account_1;
  SHARED __EE2167256 := __ENH_Event_1;
  SHARED __EE2167254 := __E_Bank_Account_Event;
  SHARED __EE2213767 := __EE2167254(__NN(__EE2167254.Account_) AND __NN(__EE2167254.Transaction_));
  SHARED __ST2204504_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2213785(B_Event_1.__ST73836_Layout __EE2167256, E_Bank_Account_Event.Layout __EE2213767) := __EEQP(__EE2213767.Transaction_,__EE2167256.UID);
  __ST2204504_Layout __JT2213785(B_Event_1.__ST73836_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2213786 := JOIN(__EE2213767,__EE2167256,__JC2213785(RIGHT,LEFT),__JT2213785(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2201160_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2201160_Layout __ND2214451__Project(__ST2204504_Layout __PP2213787) := TRANSFORM
    SELF.UID := __PP2213787.Account_;
    SELF._r_Customer_ := __PP2213787._r_Customer__1_;
    SELF.Event_Date_ := __PP2213787.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2213787.UID;
    SELF.Event_Date__1_ := __PP2213787.Event_Date_;
    SELF._r_Customer__1_ := __PP2213787._r_Customer_;
    SELF := __PP2213787;
  END;
  SHARED __EE2217072 := PROJECT(__EE2213786,__ND2214451__Project(LEFT));
  SHARED __ST2202539_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2202539_Layout __ND2217858__Project(__ST2201160_Layout __PP2217073) := TRANSFORM
    SELF.Exp1_ := __PP2217073.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2217073.Kr_Bnk800_Flag_ = 1;
    SELF.Exp3_ := __PP2217073.Kr_Bnk801_Flag_ = 1;
    SELF.Exp4_ := __PP2217073.Kr_Bnk802_Flag_ = 1;
    SELF.Exp5_ := __PP2217073.Kr_Bnk890_Flag_ = 1;
    SELF.Exp6_ := __PP2217073.Kr_Bnk891_Flag_ = 1;
    SELF.Exp7_ := __PP2217073.Kr_Bnk892_Flag_ = 1;
    SELF.Exp8_ := __PP2217073.Kr_Bnk893_Flag_ = 1;
    SELF.Exp9_ := __PP2217073.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp10_ := __PP2217073.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2217073.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2217073.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2217073.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2217073.Event_Age_,<,__CN(2)),__CN(__PP2217073.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2217073.Event_Age_,<,__CN(366));
    SELF := __PP2217073;
  END;
  SHARED __EE2217883 := PROJECT(__EE2217072,__ND2217858__Project(LEFT));
  SHARED __ST2202632_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2217982 := PROJECT(__CLEANANDDO(__EE2217883,TABLE(__EE2217883,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2217883.Exp1_),KEL.Aggregates.MinNG(__EE2217883.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2217883.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2217883.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2217883.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2217883.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2217883.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2217883.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2217883.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2217883.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2217883.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2217883.Exp11_),KEL.Aggregates.MaxNG(__EE2217883.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2217883.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2217883.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2217883.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2217883.Exp15_)),UID},UID,MERGE)),__ST2202632_Layout);
  SHARED __ST2207802_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2217988(B_Bank_Account_1.__ST66080_Layout __EE2163030, __ST2202632_Layout __EE2217982) := __EEQP(__EE2163030.UID,__EE2217982.UID);
  __ST2207802_Layout __JT2217988(B_Bank_Account_1.__ST66080_Layout __l, __ST2202632_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2218050 := JOIN(__EE2163030,__EE2217982,__JC2217988(LEFT,RIGHT),__JT2217988(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2150941 := __ENH_Customer_1;
  SHARED __ST2208216_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2218056(__ST2207802_Layout __EE2218050, B_Customer_1.__ST66213_Layout __EE2150941) := __EEQP(__EE2218050._r_Customer_,__EE2150941.UID);
  __ST2208216_Layout __JT2218056(__ST2207802_Layout __l, B_Customer_1.__ST66213_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2218140 := JOIN(__EE2218050,__EE2150941,__JC2218056(LEFT,RIGHT),__JT2218056(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2150798 := __ENH_Bank_1;
  SHARED __ST2208653_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2218146(__ST2208216_Layout __EE2218140, B_Bank_2.__ST77438_Layout __EE2150798) := __EEQP(__EE2218140._r_Bank_,__EE2150798.UID);
  __ST2208653_Layout __JT2218146(__ST2208216_Layout __l, B_Bank_2.__ST77438_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2218249 := JOIN(__EE2218140,__EE2150798,__JC2218146(LEFT,RIGHT),__JT2218146(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST44499_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44499_Layout __ND2218254__Project(__ST2208653_Layout __PP2218250) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2218250.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2218250.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Identity_Count_Gt2_ := MAP(__PP2218250.Identity_Count_ > 2=>1,0);
    __BS2218399 := __T(__PP2218250.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2218399(__T(__OP2(__T(__PP2218250.Source_Customers_)._r_Source_Customer_,=,__PP2218250._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2218250.Account_Number_;
    SELF.Last_Event_Date_ := __PP2218250.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2218250.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2218250.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2218250.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2218250.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2218250.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2218250.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2218250.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2218250.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2218250.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2218250;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2218249,__ND2218254__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE3427878 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE3427878._r_Customer_;
    __EE3427878.Source_Customers_;
    __EE3427878._r_Bank_;
    __EE3427878.Account_Number_;
    __EE3427878.Otto_Bank_Account_Id_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE3427878.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE3427878.Aot_Id_Act_Cnt_Ev_;
    __EE3427878.Aot_Id_Act_Cnt30_D_;
    __EE3427878.Aot_Add_Act_Cnt_Ev_;
    __EE3427878.Aot_Add_Act_Cnt30_D_;
    __EE3427878.Aot_Non_St_Act_Cnt_Ev_;
    __EE3427878.Aot_Non_St_Act_Cnt30_D_;
    __EE3427878.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE3427878.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE3427878.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE3427878.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE3427878.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE3427878.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE3427878.Customer_Id_;
    __EE3427878.Industry_Type_;
    __EE3427878.Source_Customer_Count_;
    __EE3427878.Entity_Context_Uid_;
    __EE3427878.Entity_Type_;
    __EE3427878.Label_;
    __EE3427878.Abbreviated_Bankname_;
    __EE3427878.In_Customer_Population_;
    __EE3427878.Dt_First_Seen_;
    __EE3427878.Dt_Last_Seen_;
    __EE3427878.Last_Record_Id_;
    __EE3427878.Identity_Count_;
    __EE3427878.Identity_Count_Gt2_;
    __EE3427878.Event_Count_;
    __EE3427878.High_Risk_Routing_;
    __EE3427878.Kr_High_Risk_Flag_;
    __EE3427878.Kr_Medium_Risk_Flag_;
    __EE3427878.Kr_Low_Risk_Flag_;
    __EE3427878.Kr_Flag_;
    __EE3427878.Safe_Flag_;
    __EE3427878.Contributor_Safe_Flag_;
    __EE3427878.Last_Event_Date_;
    __EE3427878.Kr_Last_Event_Date_;
    __EE3427878.Kr_Event_After_Last_Known_Risk_Count_;
    __EE3427878.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE3427878.Kr_Bnk800_Flag_;
    __EE3427878.Kr_Bnk801_Flag_;
    __EE3427878.Kr_Bnk802_Flag_;
    __EE3427878.Kr_Bnk890_Flag_;
    __EE3427878.Kr_Bnk891_Flag_;
    __EE3427878.Kr_Bnk892_Flag_;
    __EE3427878.Kr_Bnk893_Flag_;
    __EE3427878.Vl_Event1_All_Count_;
    __EE3427878.Vl_Event7_All_Count_;
    __EE3427878.Vl_Event30_All_Day_Count_;
    __EE3427878.Vl_Event365_All_Day_Count_;
    __EE3427878.Vl_Event7_All_Active_Flag_;
    __EE3427878.Vl_Event30_All_Active_Flag_;
    __EE3427878.Vl_Event1_Count_;
    __EE3427878.Vl_Event7_Count_;
    __EE3427878.Vl_Event30_Count_;
    __EE3427878.Vl_Event365_Count_;
    __EE3427878.Vl_Event7_Active_Flag_;
    __EE3427878.Vl_Event30_Active_Flag_;
    __EE3427878.Date_First_Seen_;
    __EE3427878.Date_Last_Seen_;
    __EE3427878.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE3427878,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST3427880_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST44499_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
