...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2458867 := __ENH_Bank_Account_1;
  SHARED __EE2463319 := __ENH_Event_1;
  SHARED __EE2463317 := __E_Bank_Account_Event;
  SHARED __EE2514341 := __EE2463317(__NN(__EE2463317.Account_) AND __NN(__EE2463317.Transaction_));
  SHARED __ST2504581_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2514359(B_Event_1.__ST78136_Layout __EE2463319, E_Bank_Account_Event.Layout __EE2514341) := __EEQP(__EE2514341.Transaction_,__EE2463319.UID);
  __ST2504581_Layout __JT2514359(B_Event_1.__ST78136_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2514360 := JOIN(__EE2514341,__EE2463319,__JC2514359(RIGHT,LEFT),__JT2514359(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2501061_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2501061_Layout __ND2515059__Project(__ST2504581_Layout __PP2514361) := TRANSFORM
    SELF.UID := __PP2514361.Account_;
    SELF._r_Customer_ := __PP2514361._r_Customer__1_;
    SELF.Event_Date_ := __PP2514361.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2514361.UID;
    SELF.Event_Date__1_ := __PP2514361.Event_Date_;
    SELF._r_Customer__1_ := __PP2514361._r_Customer_;
    SELF := __PP2514361;
  END;
  SHARED __EE2517816 := PROJECT(__EE2514360,__ND2515059__Project(LEFT));
  SHARED __ST2502514_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2502514_Layout __ND2518650__Project(__ST2501061_Layout __PP2517817) := TRANSFORM
    SELF.Exp1_ := __PP2517817.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2517817.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2517817.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2517817.Kr_Bnk800_Flag_ = 1;
    SELF.Exp4_ := __PP2517817.Kr_Bnk801_Flag_ = 1;
    SELF.Exp5_ := __PP2517817.Kr_Bnk802_Flag_ = 1;
    SELF.Exp6_ := __PP2517817.Kr_Bnk890_Flag_ = 1;
    SELF.Exp7_ := __PP2517817.Kr_Bnk891_Flag_ = 1;
    SELF.Exp8_ := __PP2517817.Kr_Bnk892_Flag_ = 1;
    SELF.Exp9_ := __PP2517817.Kr_Bnk893_Flag_ = 1;
    SELF.Exp10_ := __PP2517817.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2517817.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2517817.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp13_ := __PP2517817.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2517817.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2517817.Event_Age_,<,__CN(2)),__CN(__PP2517817.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2517817.Event_Age_,<,__CN(366));
    SELF := __PP2517817;
  END;
  SHARED __EE2518676 := PROJECT(__EE2517816,__ND2518650__Project(LEFT));
  SHARED __ST2502612_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2518780 := PROJECT(__CLEANANDDO(__EE2518676,TABLE(__EE2518676,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2518676.Exp1_),KEL.Aggregates.MaxNG(__EE2518676.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE2518676.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2518676.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2518676.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2518676.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2518676.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2518676.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2518676.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2518676.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2518676.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2518676.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2518676.Exp12_),KEL.Aggregates.MaxNG(__EE2518676.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2518676.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2518676.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2518676.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2518676.Exp16_)),UID},UID,MERGE)),__ST2502612_Layout);
  SHARED __ST2508049_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2518786(B_Bank_Account_1.__ST69817_Layout __EE2458867, __ST2502612_Layout __EE2518780) := __EEQP(__EE2458867.UID,__EE2518780.UID);
  __ST2508049_Layout __JT2518786(B_Bank_Account_1.__ST69817_Layout __l, __ST2502612_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2518853 := JOIN(__EE2458867,__EE2518780,__JC2518786(LEFT,RIGHT),__JT2518786(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2440648 := __ENH_Customer_1;
  SHARED __ST2508488_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2518859(__ST2508049_Layout __EE2518853, B_Customer_1.__ST69954_Layout __EE2440648) := __EEQP(__EE2518853._r_Customer_,__EE2440648.UID);
  __ST2508488_Layout __JT2518859(__ST2508049_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2518948 := JOIN(__EE2518853,__EE2440648,__JC2518859(LEFT,RIGHT),__JT2518859(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2440499 := __ENH_Bank_1;
  SHARED __ST2508950_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2518954(__ST2508488_Layout __EE2518948, B_Bank_2.__ST81910_Layout __EE2440499) := __EEQP(__EE2518948._r_Bank_,__EE2440499.UID);
  __ST2508950_Layout __JT2518954(__ST2508488_Layout __l, B_Bank_2.__ST81910_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2519062 := JOIN(__EE2518948,__EE2440499,__JC2518954(LEFT,RIGHT),__JT2518954(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46898_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46898_Layout __ND2519067__Project(__ST2508950_Layout __PP2519063) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP2519063.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2519063.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2519063.M_I_N___Event_Date__1_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2519063.Identity_Count_ > 2=>1,0);
    __BS2519227 := __T(__PP2519063.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2519227(__T(__OP2(__T(__PP2519063.Source_Customers_)._r_Source_Customer_,=,__PP2519063._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2519063.Account_Number_;
    SELF.Last_Event_Date_ := __PP2519063.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP2519063.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2519063.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2519063.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2519063.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2519063.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2519063.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2519063.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2519063.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2519063.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2519063;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2519062,__ND2519067__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4315814 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4315814._r_Customer_;
    __EE4315814.Source_Customers_;
    __EE4315814._r_Bank_;
    __EE4315814.Account_Number_;
    __EE4315814.Otto_Bank_Account_Id_;
    __EE4315814.Aot_Act_Cnt_Ev_;
    __EE4315814.Aot_Src1_Act_Cnt_Ev_;
    __EE4315814.Aot_Src1_Act_Only_Flag_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4315814.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4315814.Aot_Id_Act_Cnt_Ev_;
    __EE4315814.Aot_Id_Act_Cnt30_D_;
    __EE4315814.Aot_Add_Act_Cnt_Ev_;
    __EE4315814.Aot_Add_Act_Cnt30_D_;
    __EE4315814.Aot_Non_St_Act_Cnt_Ev_;
    __EE4315814.Aot_Non_St_Act_Cnt30_D_;
    __EE4315814.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4315814.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4315814.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4315814.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4315814.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4315814.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4315814.Customer_Id_;
    __EE4315814.Industry_Type_;
    __EE4315814.Source_Customer_Count_;
    __EE4315814.Entity_Context_Uid_;
    __EE4315814.Entity_Type_;
    __EE4315814.Label_;
    __EE4315814.Abbreviated_Bankname_;
    __EE4315814.In_Customer_Population_;
    __EE4315814.Dt_First_Seen_;
    __EE4315814.Dt_Last_Seen_;
    __EE4315814.Id_Activity_Dt_First_Seen_;
    __EE4315814.Id_Activity_Dt_Last_Seen_;
    __EE4315814.Last_Record_Id_;
    __EE4315814.Identity_Count_;
    __EE4315814.Identity_Count_Gt2_;
    __EE4315814.Event_Count_;
    __EE4315814.High_Risk_Routing_;
    __EE4315814.Kr_High_Risk_Flag_;
    __EE4315814.Kr_Medium_Risk_Flag_;
    __EE4315814.Kr_Low_Risk_Flag_;
    __EE4315814.Kr_Flag_;
    __EE4315814.Safe_Flag_;
    __EE4315814.Contributor_Safe_Flag_;
    __EE4315814.Last_Event_Date_;
    __EE4315814.Kr_Last_Event_Date_;
    __EE4315814.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4315814.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4315814.Kr_Bnk800_Flag_;
    __EE4315814.Kr_Bnk801_Flag_;
    __EE4315814.Kr_Bnk802_Flag_;
    __EE4315814.Kr_Bnk890_Flag_;
    __EE4315814.Kr_Bnk891_Flag_;
    __EE4315814.Kr_Bnk892_Flag_;
    __EE4315814.Kr_Bnk893_Flag_;
    __EE4315814.Vl_Event1_All_Count_;
    __EE4315814.Vl_Event7_All_Count_;
    __EE4315814.Vl_Event30_All_Day_Count_;
    __EE4315814.Vl_Event365_All_Day_Count_;
    __EE4315814.Vl_Event7_All_Active_Flag_;
    __EE4315814.Vl_Event30_All_Active_Flag_;
    __EE4315814.Vl_Event1_Count_;
    __EE4315814.Vl_Event7_Count_;
    __EE4315814.Vl_Event30_Count_;
    __EE4315814.Vl_Event365_Count_;
    __EE4315814.Vl_Event7_Active_Flag_;
    __EE4315814.Vl_Event30_Active_Flag_;
    __EE4315814.Date_First_Seen_;
    __EE4315814.Date_Last_Seen_;
    __EE4315814.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4315814,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4315816_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST46898_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
