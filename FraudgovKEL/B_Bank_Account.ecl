...
IMPORT B_Bank_1,B_Bank_2,B_Bank_Account_1,B_Customer_1,B_Customer_4,B_Event_1,E_Address,E_Bank,E_Bank_Account,E_Bank_Account_Event,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2612883 := __ENH_Bank_Account_1;
  SHARED __EE2617460 := __ENH_Event_1;
  SHARED __EE2617458 := __E_Bank_Account_Event;
  SHARED __EE2670182 := __EE2617458(__NN(__EE2617458.Account_) AND __NN(__EE2617458.Transaction_));
  SHARED __ST2660172_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2670200(B_Event_1.__ST83458_Layout __EE2617460, E_Bank_Account_Event.Layout __EE2670182) := __EEQP(__EE2670182.Transaction_,__EE2617460.UID);
  __ST2660172_Layout __JT2670200(B_Event_1.__ST83458_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2670201 := JOIN(__EE2670182,__EE2617460,__JC2670200(RIGHT,LEFT),__JT2670200(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2656552_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2656552_Layout __ND2670925__Project(__ST2660172_Layout __PP2670202) := TRANSFORM
    SELF.UID := __PP2670202.Account_;
    SELF._r_Customer_ := __PP2670202._r_Customer__1_;
    SELF.Event_Date_ := __PP2670202.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2670202.UID;
    SELF.Event_Date__1_ := __PP2670202.Event_Date_;
    SELF._r_Customer__1_ := __PP2670202._r_Customer_;
    SELF := __PP2670202;
  END;
  SHARED __EE2673782 := PROJECT(__EE2670201,__ND2670925__Project(LEFT));
  SHARED __ST2658055_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2658055_Layout __ND2674616__Project(__ST2656552_Layout __PP2673783) := TRANSFORM
    SELF.Exp1_ := __PP2673783.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2673783.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2673783.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2673783.Kr_Bnk800_Flag_ = 1;
    SELF.Exp4_ := __PP2673783.Kr_Bnk801_Flag_ = 1;
    SELF.Exp5_ := __PP2673783.Kr_Bnk802_Flag_ = 1;
    SELF.Exp6_ := __PP2673783.Kr_Bnk890_Flag_ = 1;
    SELF.Exp7_ := __PP2673783.Kr_Bnk891_Flag_ = 1;
    SELF.Exp8_ := __PP2673783.Kr_Bnk892_Flag_ = 1;
    SELF.Exp9_ := __PP2673783.Kr_Bnk893_Flag_ = 1;
    SELF.Exp10_ := __PP2673783.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2673783.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2673783.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp13_ := __PP2673783.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2673783.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2673783.Event_Age_,<,__CN(2)),__CN(__PP2673783.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2673783.Event_Age_,<,__CN(366));
    SELF := __PP2673783;
  END;
  SHARED __EE2674642 := PROJECT(__EE2673782,__ND2674616__Project(LEFT));
  SHARED __ST2658153_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2674746 := PROJECT(__CLEANANDDO(__EE2674642,TABLE(__EE2674642,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2674642.Exp1_),KEL.Aggregates.MinNG(__EE2674642.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2674642.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2674642.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2674642.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2674642.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2674642.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2674642.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2674642.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2674642.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2674642.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2674642.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2674642.Exp12_),KEL.Aggregates.MaxNG(__EE2674642.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2674642.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2674642.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2674642.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2674642.Exp16_)),UID},UID,MERGE)),__ST2658153_Layout);
  SHARED __ST2663765_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2674752(B_Bank_Account_1.__ST74389_Layout __EE2612883, __ST2658153_Layout __EE2674746) := __EEQP(__EE2612883.UID,__EE2674746.UID);
  __ST2663765_Layout __JT2674752(B_Bank_Account_1.__ST74389_Layout __l, __ST2658153_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2674819 := JOIN(__EE2612883,__EE2674746,__JC2674752(LEFT,RIGHT),__JT2674752(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2594064 := __ENH_Customer_1;
  SHARED __ST2664204_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2674825(__ST2663765_Layout __EE2674819, B_Customer_1.__ST74526_Layout __EE2594064) := __EEQP(__EE2674819._r_Customer_,__EE2594064.UID);
  __ST2664204_Layout __JT2674825(__ST2663765_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2674914 := JOIN(__EE2674819,__EE2594064,__JC2674825(LEFT,RIGHT),__JT2674825(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2593915 := __ENH_Bank_1;
  SHARED __ST2664666_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2674920(__ST2664204_Layout __EE2674914, B_Bank_2.__ST87153_Layout __EE2593915) := __EEQP(__EE2674914._r_Bank_,__EE2593915.UID);
  __ST2664666_Layout __JT2674920(__ST2664204_Layout __l, B_Bank_2.__ST87153_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2675028 := JOIN(__EE2674914,__EE2593915,__JC2674920(LEFT,RIGHT),__JT2674920(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST49796_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST49796_Layout __ND2675033__Project(__ST2664666_Layout __PP2675029) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2675029.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2675029.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2675029.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2675029.Identity_Count_ > 2=>1,0);
    __BS2675193 := __T(__PP2675029.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2675193(__T(__OP2(__T(__PP2675029.Source_Customers_)._r_Source_Customer_,=,__PP2675029._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2675029.Account_Number_;
    SELF.Last_Event_Date_ := __PP2675029.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2675029.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2675029.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2675029.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2675029.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2675029.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2675029.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2675029.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2675029.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2675029.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2675029;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2675028,__ND2675033__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4832128 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4832128._r_Customer_;
    __EE4832128.Source_Customers_;
    __EE4832128._r_Bank_;
    __EE4832128.Account_Number_;
    __EE4832128.Otto_Bank_Account_Id_;
    __EE4832128.Aot_Act_Cnt_Ev_;
    __EE4832128.Aot_Src1_Act_Cnt_Ev_;
    __EE4832128.Aot_Src1_Act_Only_Flag_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4832128.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4832128.Aot_Id_Act_Cnt_Ev_;
    __EE4832128.Aot_Id_Act_Cnt30_D_;
    __EE4832128.Aot_Add_Act_Cnt_Ev_;
    __EE4832128.Aot_Add_Act_Cnt30_D_;
    __EE4832128.Aot_Non_St_Act_Cnt_Ev_;
    __EE4832128.Aot_Non_St_Act_Cnt30_D_;
    __EE4832128.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4832128.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4832128.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4832128.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4832128.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4832128.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4832128.Customer_Id_;
    __EE4832128.Industry_Type_;
    __EE4832128.Source_Customer_Count_;
    __EE4832128.Entity_Context_Uid_;
    __EE4832128.Entity_Type_;
    __EE4832128.Label_;
    __EE4832128.Abbreviated_Bankname_;
    __EE4832128.In_Customer_Population_;
    __EE4832128.Dt_First_Seen_;
    __EE4832128.Dt_Last_Seen_;
    __EE4832128.Id_Activity_Dt_First_Seen_;
    __EE4832128.Id_Activity_Dt_Last_Seen_;
    __EE4832128.Last_Record_Id_;
    __EE4832128.Identity_Count_;
    __EE4832128.Identity_Count_Gt2_;
    __EE4832128.Event_Count_;
    __EE4832128.High_Risk_Routing_;
    __EE4832128.Kr_High_Risk_Flag_;
    __EE4832128.Kr_Medium_Risk_Flag_;
    __EE4832128.Kr_Low_Risk_Flag_;
    __EE4832128.Kr_Flag_;
    __EE4832128.Safe_Flag_;
    __EE4832128.Contributor_Safe_Flag_;
    __EE4832128.Last_Event_Date_;
    __EE4832128.Kr_Last_Event_Date_;
    __EE4832128.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4832128.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4832128.Kr_Bnk800_Flag_;
    __EE4832128.Kr_Bnk801_Flag_;
    __EE4832128.Kr_Bnk802_Flag_;
    __EE4832128.Kr_Bnk890_Flag_;
    __EE4832128.Kr_Bnk891_Flag_;
    __EE4832128.Kr_Bnk892_Flag_;
    __EE4832128.Kr_Bnk893_Flag_;
    __EE4832128.Vl_Event1_All_Count_;
    __EE4832128.Vl_Event7_All_Count_;
    __EE4832128.Vl_Event30_All_Day_Count_;
    __EE4832128.Vl_Event365_All_Day_Count_;
    __EE4832128.Vl_Event7_All_Active_Flag_;
    __EE4832128.Vl_Event30_All_Active_Flag_;
    __EE4832128.Vl_Event1_Count_;
    __EE4832128.Vl_Event7_Count_;
    __EE4832128.Vl_Event30_Count_;
    __EE4832128.Vl_Event365_Count_;
    __EE4832128.Vl_Event7_Active_Flag_;
    __EE4832128.Vl_Event30_Active_Flag_;
    __EE4832128.Date_First_Seen_;
    __EE4832128.Date_Last_Seen_;
    __EE4832128.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4832128,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  EXPORT IDX_Bank_Account_UID_Name := '~key::KEL::FraudgovKEL::Bank_Account::UID';
  ...
  EXPORT __ST4832130_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST49796_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
