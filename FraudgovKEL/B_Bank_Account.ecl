...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2458975 := __ENH_Bank_Account_1;
  SHARED __EE2463427 := __ENH_Event_1;
  SHARED __EE2463425 := __E_Bank_Account_Event;
  SHARED __EE2514449 := __EE2463425(__NN(__EE2463425.Account_) AND __NN(__EE2463425.Transaction_));
  SHARED __ST2504689_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2514467(B_Event_1.__ST78198_Layout __EE2463427, E_Bank_Account_Event.Layout __EE2514449) := __EEQP(__EE2514449.Transaction_,__EE2463427.UID);
  __ST2504689_Layout __JT2514467(B_Event_1.__ST78198_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2514468 := JOIN(__EE2514449,__EE2463427,__JC2514467(RIGHT,LEFT),__JT2514467(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2501169_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2501169_Layout __ND2515167__Project(__ST2504689_Layout __PP2514469) := TRANSFORM
    SELF.UID := __PP2514469.Account_;
    SELF._r_Customer_ := __PP2514469._r_Customer__1_;
    SELF.Event_Date_ := __PP2514469.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2514469.UID;
    SELF.Event_Date__1_ := __PP2514469.Event_Date_;
    SELF._r_Customer__1_ := __PP2514469._r_Customer_;
    SELF := __PP2514469;
  END;
  SHARED __EE2517924 := PROJECT(__EE2514468,__ND2515167__Project(LEFT));
  SHARED __ST2502622_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2502622_Layout __ND2518758__Project(__ST2501169_Layout __PP2517925) := TRANSFORM
    SELF.Exp1_ := __PP2517925.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2517925.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2517925.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2517925.Kr_Bnk800_Flag_ = 1;
    SELF.Exp4_ := __PP2517925.Kr_Bnk801_Flag_ = 1;
    SELF.Exp5_ := __PP2517925.Kr_Bnk802_Flag_ = 1;
    SELF.Exp6_ := __PP2517925.Kr_Bnk890_Flag_ = 1;
    SELF.Exp7_ := __PP2517925.Kr_Bnk891_Flag_ = 1;
    SELF.Exp8_ := __PP2517925.Kr_Bnk892_Flag_ = 1;
    SELF.Exp9_ := __PP2517925.Kr_Bnk893_Flag_ = 1;
    SELF.Exp10_ := __PP2517925.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2517925.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2517925.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp13_ := __PP2517925.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2517925.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2517925.Event_Age_,<,__CN(2)),__CN(__PP2517925.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2517925.Event_Age_,<,__CN(366));
    SELF := __PP2517925;
  END;
  SHARED __EE2518784 := PROJECT(__EE2517924,__ND2518758__Project(LEFT));
  SHARED __ST2502720_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2518888 := PROJECT(__CLEANANDDO(__EE2518784,TABLE(__EE2518784,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2518784.Exp1_),KEL.Aggregates.MinNG(__EE2518784.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2518784.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2518784.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2518784.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2518784.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2518784.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2518784.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2518784.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2518784.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2518784.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2518784.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2518784.Exp12_),KEL.Aggregates.MaxNG(__EE2518784.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2518784.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2518784.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2518784.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2518784.Exp16_)),UID},UID,MERGE)),__ST2502720_Layout);
  SHARED __ST2508157_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2518894(B_Bank_Account_1.__ST69877_Layout __EE2458975, __ST2502720_Layout __EE2518888) := __EEQP(__EE2458975.UID,__EE2518888.UID);
  __ST2508157_Layout __JT2518894(B_Bank_Account_1.__ST69877_Layout __l, __ST2502720_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2518961 := JOIN(__EE2458975,__EE2518888,__JC2518894(LEFT,RIGHT),__JT2518894(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2440756 := __ENH_Customer_1;
  SHARED __ST2508596_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2518967(__ST2508157_Layout __EE2518961, B_Customer_1.__ST70014_Layout __EE2440756) := __EEQP(__EE2518961._r_Customer_,__EE2440756.UID);
  __ST2508596_Layout __JT2518967(__ST2508157_Layout __l, B_Customer_1.__ST70014_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2519056 := JOIN(__EE2518961,__EE2440756,__JC2518967(LEFT,RIGHT),__JT2518967(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2440607 := __ENH_Bank_1;
  SHARED __ST2509058_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2519062(__ST2508596_Layout __EE2519056, B_Bank_2.__ST81972_Layout __EE2440607) := __EEQP(__EE2519056._r_Bank_,__EE2440607.UID);
  __ST2509058_Layout __JT2519062(__ST2508596_Layout __l, B_Bank_2.__ST81972_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2519170 := JOIN(__EE2519056,__EE2440607,__JC2519062(LEFT,RIGHT),__JT2519062(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46939_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46939_Layout __ND2519175__Project(__ST2509058_Layout __PP2519171) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2519171.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2519171.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2519171.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2519171.Identity_Count_ > 2=>1,0);
    __BS2519335 := __T(__PP2519171.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2519335(__T(__OP2(__T(__PP2519171.Source_Customers_)._r_Source_Customer_,=,__PP2519171._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2519171.Account_Number_;
    SELF.Last_Event_Date_ := __PP2519171.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2519171.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2519171.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2519171.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2519171.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2519171.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2519171.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2519171.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2519171.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2519171.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2519171;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2519170,__ND2519175__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4316182 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4316182._r_Customer_;
    __EE4316182.Source_Customers_;
    __EE4316182._r_Bank_;
    __EE4316182.Account_Number_;
    __EE4316182.Otto_Bank_Account_Id_;
    __EE4316182.Aot_Act_Cnt_Ev_;
    __EE4316182.Aot_Src1_Act_Cnt_Ev_;
    __EE4316182.Aot_Src1_Act_Only_Flag_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4316182.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4316182.Aot_Id_Act_Cnt_Ev_;
    __EE4316182.Aot_Id_Act_Cnt30_D_;
    __EE4316182.Aot_Add_Act_Cnt_Ev_;
    __EE4316182.Aot_Add_Act_Cnt30_D_;
    __EE4316182.Aot_Non_St_Act_Cnt_Ev_;
    __EE4316182.Aot_Non_St_Act_Cnt30_D_;
    __EE4316182.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4316182.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4316182.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4316182.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4316182.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4316182.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4316182.Customer_Id_;
    __EE4316182.Industry_Type_;
    __EE4316182.Source_Customer_Count_;
    __EE4316182.Entity_Context_Uid_;
    __EE4316182.Entity_Type_;
    __EE4316182.Label_;
    __EE4316182.Abbreviated_Bankname_;
    __EE4316182.In_Customer_Population_;
    __EE4316182.Dt_First_Seen_;
    __EE4316182.Dt_Last_Seen_;
    __EE4316182.Id_Activity_Dt_First_Seen_;
    __EE4316182.Id_Activity_Dt_Last_Seen_;
    __EE4316182.Last_Record_Id_;
    __EE4316182.Identity_Count_;
    __EE4316182.Identity_Count_Gt2_;
    __EE4316182.Event_Count_;
    __EE4316182.High_Risk_Routing_;
    __EE4316182.Kr_High_Risk_Flag_;
    __EE4316182.Kr_Medium_Risk_Flag_;
    __EE4316182.Kr_Low_Risk_Flag_;
    __EE4316182.Kr_Flag_;
    __EE4316182.Safe_Flag_;
    __EE4316182.Contributor_Safe_Flag_;
    __EE4316182.Last_Event_Date_;
    __EE4316182.Kr_Last_Event_Date_;
    __EE4316182.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4316182.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4316182.Kr_Bnk800_Flag_;
    __EE4316182.Kr_Bnk801_Flag_;
    __EE4316182.Kr_Bnk802_Flag_;
    __EE4316182.Kr_Bnk890_Flag_;
    __EE4316182.Kr_Bnk891_Flag_;
    __EE4316182.Kr_Bnk892_Flag_;
    __EE4316182.Kr_Bnk893_Flag_;
    __EE4316182.Vl_Event1_All_Count_;
    __EE4316182.Vl_Event7_All_Count_;
    __EE4316182.Vl_Event30_All_Day_Count_;
    __EE4316182.Vl_Event365_All_Day_Count_;
    __EE4316182.Vl_Event7_All_Active_Flag_;
    __EE4316182.Vl_Event30_All_Active_Flag_;
    __EE4316182.Vl_Event1_Count_;
    __EE4316182.Vl_Event7_Count_;
    __EE4316182.Vl_Event30_Count_;
    __EE4316182.Vl_Event365_Count_;
    __EE4316182.Vl_Event7_Active_Flag_;
    __EE4316182.Vl_Event30_Active_Flag_;
    __EE4316182.Date_First_Seen_;
    __EE4316182.Date_Last_Seen_;
    __EE4316182.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4316182,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4316184_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST46939_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
