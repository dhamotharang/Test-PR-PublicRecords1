...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE1669370 := __ENH_Bank_Account_1;
  SHARED __EE1673397 := __ENH_Event_1;
  SHARED __EE1673395 := __E_Bank_Account_Event;
  SHARED __EE1718089 := __EE1673395(__NN(__EE1673395.Account_) AND __NN(__EE1673395.Transaction_));
  SHARED __ST1709356_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1718107(B_Event_1.__ST61957_Layout __EE1673397, E_Bank_Account_Event.Layout __EE1718089) := __EEQP(__EE1718089.Transaction_,__EE1673397.UID);
  __ST1709356_Layout __JT1718107(B_Event_1.__ST61957_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1718108 := JOIN(__EE1718089,__EE1673397,__JC1718107(RIGHT,LEFT),__JT1718107(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1706128_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1706128_Layout __ND1718750__Project(__ST1709356_Layout __PP1718109) := TRANSFORM
    SELF.UID := __PP1718109.Account_;
    SELF._r_Customer_ := __PP1718109._r_Customer__1_;
    SELF.Event_Date_ := __PP1718109.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1718109.UID;
    SELF.Event_Date__1_ := __PP1718109.Event_Date_;
    SELF._r_Customer__1_ := __PP1718109._r_Customer_;
    SELF := __PP1718109;
  END;
  SHARED __EE1721279 := PROJECT(__EE1718108,__ND1718750__Project(LEFT));
  SHARED __ST1707461_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1707461_Layout __ND1721981__Project(__ST1706128_Layout __PP1721280) := TRANSFORM
    SELF.Exp1_ := __PP1721280.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1721280.Kr_Bnk800_Flag_ = 1;
    SELF.Exp3_ := __PP1721280.Kr_Bnk801_Flag_ = 1;
    SELF.Exp4_ := __PP1721280.Kr_Bnk802_Flag_ = 1;
    SELF.Exp5_ := __PP1721280.Kr_Bnk890_Flag_ = 1;
    SELF.Exp6_ := __PP1721280.Kr_Bnk891_Flag_ = 1;
    SELF.Exp7_ := __PP1721280.Kr_Bnk892_Flag_ = 1;
    SELF.Exp8_ := __PP1721280.Kr_Bnk893_Flag_ = 1;
    SELF.Exp9_ := __PP1721280.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp10_ := __PP1721280.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP1721280.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP1721280.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1721280.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1721280.Event_Age_,<,__CN(2)),__CN(__PP1721280.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1721280.Event_Age_,<,__CN(366));
    SELF := __PP1721280;
  END;
  SHARED __EE1722006 := PROJECT(__EE1721279,__ND1721981__Project(LEFT));
  SHARED __ST1707554_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1722105 := PROJECT(__CLEANANDDO(__EE1722006,TABLE(__EE1722006,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1722006.Exp1_),KEL.Aggregates.MinNG(__EE1722006.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1722006.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1722006.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1722006.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1722006.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1722006.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1722006.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1722006.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1722006.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1722006.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1722006.Exp11_),KEL.Aggregates.MaxNG(__EE1722006.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1722006.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1722006.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1722006.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1722006.Exp15_)),UID},UID,MERGE)),__ST1707554_Layout);
  SHARED __ST1712539_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1722111(B_Bank_Account_1.__ST55046_Layout __EE1669370, __ST1707554_Layout __EE1722105) := __EEQP(__EE1669370.UID,__EE1722105.UID);
  __ST1712539_Layout __JT1722111(B_Bank_Account_1.__ST55046_Layout __l, __ST1707554_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1722161 := JOIN(__EE1669370,__EE1722105,__JC1722111(LEFT,RIGHT),__JT1722111(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1657661 := __ENH_Customer_1;
  SHARED __ST1712893_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1722167(__ST1712539_Layout __EE1722161, B_Customer_1.__ST55167_Layout __EE1657661) := __EEQP(__EE1722161._r_Customer_,__EE1657661.UID);
  __ST1712893_Layout __JT1722167(__ST1712539_Layout __l, B_Customer_1.__ST55167_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1722239 := JOIN(__EE1722161,__EE1657661,__JC1722167(LEFT,RIGHT),__JT1722167(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1657542 := __ENH_Bank_1;
  SHARED __ST1713270_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1722245(__ST1712893_Layout __EE1722239, B_Bank_2.__ST64725_Layout __EE1657542) := __EEQP(__EE1722239._r_Bank_,__EE1657542.UID);
  __ST1713270_Layout __JT1722245(__ST1712893_Layout __l, B_Bank_2.__ST64725_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1722336 := JOIN(__EE1722239,__EE1657542,__JC1722245(LEFT,RIGHT),__JT1722245(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST37251_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST37251_Layout __ND1722341__Project(__ST1713270_Layout __PP1722337) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1722337.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP1722337.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Identity_Count_Gt2_ := MAP(__PP1722337.Identity_Count_ > 2=>1,0);
    __BS1722450 := __T(__PP1722337.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1722450(__T(__OP2(__T(__PP1722337.Source_Customers_)._r_Source_Customer_,=,__PP1722337._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1722337.Account_Number_;
    SELF.Last_Event_Date_ := __PP1722337.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1722337.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1722337.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1722337.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1722337.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1722337.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1722337.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1722337.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1722337.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1722337.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1722337;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE1722336,__ND1722341__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE2805790 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2805790._r_Customer_;
    __EE2805790.Source_Customers_;
    __EE2805790._r_Bank_;
    __EE2805790.Account_Number_;
    __EE2805790.Otto_Bank_Account_Id_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2805790.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2805790.Customer_Id_;
    __EE2805790.Industry_Type_;
    __EE2805790.Source_Customer_Count_;
    __EE2805790.Entity_Context_Uid_;
    __EE2805790.Entity_Type_;
    __EE2805790.Label_;
    __EE2805790.Abbreviated_Bankname_;
    __EE2805790.In_Customer_Population_;
    __EE2805790.Dt_First_Seen_;
    __EE2805790.Dt_Last_Seen_;
    __EE2805790.Last_Record_Id_;
    __EE2805790.Identity_Count_;
    __EE2805790.Identity_Count_Gt2_;
    __EE2805790.Event_Count_;
    __EE2805790.High_Risk_Routing_;
    __EE2805790.Kr_High_Risk_Flag_;
    __EE2805790.Kr_Medium_Risk_Flag_;
    __EE2805790.Kr_Low_Risk_Flag_;
    __EE2805790.Kr_Flag_;
    __EE2805790.Safe_Flag_;
    __EE2805790.Contributor_Safe_Flag_;
    __EE2805790.Last_Event_Date_;
    __EE2805790.Kr_Last_Event_Date_;
    __EE2805790.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2805790.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2805790.Kr_Bnk800_Flag_;
    __EE2805790.Kr_Bnk801_Flag_;
    __EE2805790.Kr_Bnk802_Flag_;
    __EE2805790.Kr_Bnk890_Flag_;
    __EE2805790.Kr_Bnk891_Flag_;
    __EE2805790.Kr_Bnk892_Flag_;
    __EE2805790.Kr_Bnk893_Flag_;
    __EE2805790.Vl_Event1_All_Count_;
    __EE2805790.Vl_Event7_All_Count_;
    __EE2805790.Vl_Event30_All_Day_Count_;
    __EE2805790.Vl_Event365_All_Day_Count_;
    __EE2805790.Vl_Event7_All_Active_Flag_;
    __EE2805790.Vl_Event30_All_Active_Flag_;
    __EE2805790.Vl_Event1_Count_;
    __EE2805790.Vl_Event7_Count_;
    __EE2805790.Vl_Event30_Count_;
    __EE2805790.Vl_Event365_Count_;
    __EE2805790.Vl_Event7_Active_Flag_;
    __EE2805790.Vl_Event30_Active_Flag_;
    __EE2805790.Date_First_Seen_;
    __EE2805790.Date_Last_Seen_;
    __EE2805790.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE2805790,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2805792_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST37251_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
