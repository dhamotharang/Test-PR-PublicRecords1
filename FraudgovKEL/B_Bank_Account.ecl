...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE2374157 := __ENH_Bank_Account_1;
  SHARED __EE2378513 := __ENH_Event_1;
  SHARED __EE2378511 := __E_Bank_Account_Event;
  SHARED __EE2426714 := __EE2378511(__NN(__EE2378511.Account_) AND __NN(__EE2378511.Transaction_));
  SHARED __ST2417191_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2426732(B_Event_1.__ST76927_Layout __EE2378513, E_Bank_Account_Event.Layout __EE2426714) := __EEQP(__EE2426714.Transaction_,__EE2378513.UID);
  __ST2417191_Layout __JT2426732(B_Event_1.__ST76927_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2426733 := JOIN(__EE2426714,__EE2378513,__JC2426732(RIGHT,LEFT),__JT2426732(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2413743_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2413743_Layout __ND2427424__Project(__ST2417191_Layout __PP2426734) := TRANSFORM
    SELF.UID := __PP2426734.Account_;
    SELF._r_Customer_ := __PP2426734._r_Customer__1_;
    SELF.Event_Date_ := __PP2426734.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2426734.UID;
    SELF.Event_Date__1_ := __PP2426734.Event_Date_;
    SELF._r_Customer__1_ := __PP2426734._r_Customer_;
    SELF := __PP2426734;
  END;
  SHARED __EE2430149 := PROJECT(__EE2426733,__ND2427424__Project(LEFT));
  SHARED __ST2415174_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2415174_Layout __ND2430935__Project(__ST2413743_Layout __PP2430150) := TRANSFORM
    SELF.Exp1_ := __PP2430150.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2430150.Kr_Bnk800_Flag_ = 1;
    SELF.Exp3_ := __PP2430150.Kr_Bnk801_Flag_ = 1;
    SELF.Exp4_ := __PP2430150.Kr_Bnk802_Flag_ = 1;
    SELF.Exp5_ := __PP2430150.Kr_Bnk890_Flag_ = 1;
    SELF.Exp6_ := __PP2430150.Kr_Bnk891_Flag_ = 1;
    SELF.Exp7_ := __PP2430150.Kr_Bnk892_Flag_ = 1;
    SELF.Exp8_ := __PP2430150.Kr_Bnk893_Flag_ = 1;
    SELF.Exp9_ := __PP2430150.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp10_ := __PP2430150.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP2430150.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP2430150.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2430150.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2430150.Event_Age_,<,__CN(2)),__CN(__PP2430150.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2430150.Event_Age_,<,__CN(366));
    SELF := __PP2430150;
  END;
  SHARED __EE2430960 := PROJECT(__EE2430149,__ND2430935__Project(LEFT));
  SHARED __ST2415267_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2431059 := PROJECT(__CLEANANDDO(__EE2430960,TABLE(__EE2430960,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2430960.Exp1_),KEL.Aggregates.MinNG(__EE2430960.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2430960.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2430960.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2430960.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2430960.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2430960.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2430960.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2430960.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2430960.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2430960.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2430960.Exp11_),KEL.Aggregates.MaxNG(__EE2430960.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2430960.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2430960.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2430960.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2430960.Exp15_)),UID},UID,MERGE)),__ST2415267_Layout);
  SHARED __ST2420619_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2431065(B_Bank_Account_1.__ST68770_Layout __EE2374157, __ST2415267_Layout __EE2431059) := __EEQP(__EE2374157.UID,__EE2431059.UID);
  __ST2420619_Layout __JT2431065(B_Bank_Account_1.__ST68770_Layout __l, __ST2415267_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2431127 := JOIN(__EE2374157,__EE2431059,__JC2431065(LEFT,RIGHT),__JT2431065(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2361652 := __ENH_Customer_1;
  SHARED __ST2421033_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2431133(__ST2420619_Layout __EE2431127, B_Customer_1.__ST68903_Layout __EE2361652) := __EEQP(__EE2431127._r_Customer_,__EE2361652.UID);
  __ST2421033_Layout __JT2431133(__ST2420619_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2431217 := JOIN(__EE2431127,__EE2361652,__JC2431133(LEFT,RIGHT),__JT2431133(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2361509 := __ENH_Bank_1;
  SHARED __ST2421470_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2431223(__ST2421033_Layout __EE2431217, B_Bank_2.__ST80569_Layout __EE2361509) := __EEQP(__EE2431217._r_Bank_,__EE2361509.UID);
  __ST2421470_Layout __JT2431223(__ST2421033_Layout __l, B_Bank_2.__ST80569_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2431326 := JOIN(__EE2431217,__EE2361509,__JC2431223(LEFT,RIGHT),__JT2431223(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46206_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46206_Layout __ND2431331__Project(__ST2421470_Layout __PP2431327) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2431327.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_19'),+,__PP2431327.Otto_Bank_Account_Id_);
    SELF.Entity_Type_ := 19;
    SELF.Identity_Count_Gt2_ := MAP(__PP2431327.Identity_Count_ > 2=>1,0);
    __BS2431476 := __T(__PP2431327.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2431476(__T(__OP2(__T(__PP2431327.Source_Customers_)._r_Source_Customer_,=,__PP2431327._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2431327.Account_Number_;
    SELF.Last_Event_Date_ := __PP2431327.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2431327.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2431327.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2431327.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2431327.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2431327.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2431327.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2431327.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2431327.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2431327.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2431327;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE2431326,__ND2431331__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE4092150 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4092150._r_Customer_;
    __EE4092150.Source_Customers_;
    __EE4092150._r_Bank_;
    __EE4092150.Account_Number_;
    __EE4092150.Otto_Bank_Account_Id_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_Cnt_Ev_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_Shrd_Cnt_Ev_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_Old_Dt_Ev_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_New_Dt_Ev_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4092150.Aot_Bnk_Acct_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4092150.Aot_Id_Act_Cnt_Ev_;
    __EE4092150.Aot_Id_Act_Cnt30_D_;
    __EE4092150.Aot_Add_Act_Cnt_Ev_;
    __EE4092150.Aot_Add_Act_Cnt30_D_;
    __EE4092150.Aot_Non_St_Act_Cnt_Ev_;
    __EE4092150.Aot_Non_St_Act_Cnt30_D_;
    __EE4092150.Aot_Bk_Ac_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4092150.Aot_Bk_Ac_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4092150.Aot_Bk_Ac_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4092150.Aot_Id_Curr_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4092150.Aot_Id_Hist_Prof_Usng_Bk_Ac_Cnt_Ev_;
    __EE4092150.Aot_Id_Using_Bnk_Acct_Cnt_Ev_;
    __EE4092150.Customer_Id_;
    __EE4092150.Industry_Type_;
    __EE4092150.Source_Customer_Count_;
    __EE4092150.Entity_Context_Uid_;
    __EE4092150.Entity_Type_;
    __EE4092150.Label_;
    __EE4092150.Abbreviated_Bankname_;
    __EE4092150.In_Customer_Population_;
    __EE4092150.Dt_First_Seen_;
    __EE4092150.Dt_Last_Seen_;
    __EE4092150.Last_Record_Id_;
    __EE4092150.Identity_Count_;
    __EE4092150.Identity_Count_Gt2_;
    __EE4092150.Event_Count_;
    __EE4092150.High_Risk_Routing_;
    __EE4092150.Kr_High_Risk_Flag_;
    __EE4092150.Kr_Medium_Risk_Flag_;
    __EE4092150.Kr_Low_Risk_Flag_;
    __EE4092150.Kr_Flag_;
    __EE4092150.Safe_Flag_;
    __EE4092150.Contributor_Safe_Flag_;
    __EE4092150.Last_Event_Date_;
    __EE4092150.Kr_Last_Event_Date_;
    __EE4092150.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4092150.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4092150.Kr_Bnk800_Flag_;
    __EE4092150.Kr_Bnk801_Flag_;
    __EE4092150.Kr_Bnk802_Flag_;
    __EE4092150.Kr_Bnk890_Flag_;
    __EE4092150.Kr_Bnk891_Flag_;
    __EE4092150.Kr_Bnk892_Flag_;
    __EE4092150.Kr_Bnk893_Flag_;
    __EE4092150.Vl_Event1_All_Count_;
    __EE4092150.Vl_Event7_All_Count_;
    __EE4092150.Vl_Event30_All_Day_Count_;
    __EE4092150.Vl_Event365_All_Day_Count_;
    __EE4092150.Vl_Event7_All_Active_Flag_;
    __EE4092150.Vl_Event30_All_Active_Flag_;
    __EE4092150.Vl_Event1_Count_;
    __EE4092150.Vl_Event7_Count_;
    __EE4092150.Vl_Event30_Count_;
    __EE4092150.Vl_Event365_Count_;
    __EE4092150.Vl_Event7_Active_Flag_;
    __EE4092150.Vl_Event30_Active_Flag_;
    __EE4092150.Date_First_Seen_;
    __EE4092150.Date_Last_Seen_;
    __EE4092150.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE4092150,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4092152_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST46206_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
