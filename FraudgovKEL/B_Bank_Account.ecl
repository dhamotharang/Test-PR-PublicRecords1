...
EXPORT B_Bank_Account := MODULE
  ...
  SHARED __EE558178 := __ENH_Bank_Account_1;
  SHARED __EE590453 := __E_Bank_Account_Event;
  SHARED __EE590460 := __EE590453(__NN(__EE590453.Account_));
  SHARED __ST583889_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Bank_Account_Event_ := 0;
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE590451 := PROJECT(__CLEANANDDO(__EE590460,TABLE(__EE590460,{KEL.typ.int C_O_U_N_T___Bank_Account_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Bank_Account.Typ) UID := __EE590460.Account_},Account_,MERGE)),__ST583889_Layout);
  SHARED __ST586156_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC590480(B_Bank_Account_1.__ST32155_Layout __EE558178, __ST583889_Layout __EE590451) := __EEQP(__EE558178.UID,__EE590451.UID);
  __ST586156_Layout __JT590480(B_Bank_Account_1.__ST32155_Layout __l, __ST583889_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE590481 := JOIN(__EE558178,__EE590451,__JC590480(LEFT,RIGHT),__JT590480(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE590464 := __ENH_Event_1;
  SHARED __EE594914 := __EE590453;
  SHARED __EE594927 := __EE594914(__NN(__EE594914.Account_) AND __NN(__EE594914.Transaction_));
  SHARED __ST584254_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC594933(B_Event_1.__ST35236_Layout __EE590464, E_Bank_Account_Event.Layout __EE594927) := __EEQP(__EE594927.Transaction_,__EE590464.UID);
  __ST584254_Layout __JT594933(B_Event_1.__ST35236_Layout __l, E_Bank_Account_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE594934 := JOIN(__EE594927,__EE590464,__JC594933(RIGHT,LEFT),__JT594933(RIGHT,LEFT),INNER,HASH);
  SHARED __ST581669_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST581669_Layout __ND595321__Project(__ST584254_Layout __PP594935) := TRANSFORM
    SELF.UID := __PP594935.Account_;
    SELF._r_Customer_ := __PP594935._r_Customer__1_;
    SELF.Event_Date_ := __PP594935.Event_Date__1_;
    SELF.U_I_D__1_ := __PP594935.UID;
    SELF.Event_Date__1_ := __PP594935.Event_Date_;
    SELF._r_Customer__1_ := __PP594935._r_Customer_;
    SELF := __PP594935;
  END;
  SHARED __EE596822 := PROJECT(__EE594934,__ND595321__Project(LEFT));
  SHARED __ST582505_Layout := RECORD
    KEL.typ.ntyp(E_Bank_Account.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST582505_Layout __ND597508__Project(__ST581669_Layout __PP596823) := TRANSFORM
    SELF.Exp1_ := __PP596823.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP596823.Kr_Bnk800_Flag_ = 1;
    SELF.Exp3_ := __PP596823.Kr_Bnk801_Flag_ = 1;
    SELF.Exp4_ := __PP596823.Kr_Bnk802_Flag_ = 1;
    SELF.Exp5_ := __PP596823.Kr_Bnk890_Flag_ = 1;
    SELF.Exp6_ := __PP596823.Kr_Bnk891_Flag_ = 1;
    SELF.Exp7_ := __PP596823.Kr_Bnk892_Flag_ = 1;
    SELF.Exp8_ := __PP596823.Kr_Bnk893_Flag_ = 1;
    SELF.Exp9_ := __PP596823.Kr_High_Risk_Bank_Flag_ = 1;
    SELF.Exp10_ := __PP596823.Kr_Low_Risk_Bank_Flag_ = 1;
    SELF.Exp11_ := __PP596823.Kr_Medium_Risk_Bank_Flag_ = 1;
    SELF.Exp12_ := __PP596823.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP596823.Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP596823.Age_,<,__CN(2)),__CN(__PP596823.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP596823.Age_,<,__CN(366));
    SELF.Exp16_ := __AND(__OP2(__PP596823.Age_,<,__CN(366)),__CN(__PP596823.In_Customer_Population_ = 1));
    SELF := __PP596823;
  END;
  SHARED __EE597538 := PROJECT(__EE596822,__ND597508__Project(LEFT));
  SHARED __ST582606_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE597648 := PROJECT(__CLEANANDDO(__EE597538,TABLE(__EE597538,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE597538.Exp1_),KEL.Aggregates.MinNG(__EE597538.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE597538.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE597538.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE597538.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE597538.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE597538.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE597538.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE597538.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE597538.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE597538.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE597538.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE597538.Exp11_),KEL.Aggregates.MaxNG(__EE597538.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE597538.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE597538.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE597538.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE597538.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE597538.Exp16_)),UID},UID,MERGE)),__ST582606_Layout);
  SHARED __ST586406_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC597654(__ST586156_Layout __EE590481, __ST582606_Layout __EE597648) := __EEQP(__EE590481.UID,__EE597648.UID);
  __ST586406_Layout __JT597654(__ST586156_Layout __l, __ST582606_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE597700 := JOIN(__EE590481,__EE597648,__JC597654(LEFT,RIGHT),__JT597654(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE547443 := __ENH_Customer_1;
  SHARED __ST586733_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC597706(__ST586406_Layout __EE597700, B_Customer_1.__ST32268_Layout __EE547443) := __EEQP(__EE597700._r_Customer_,__EE547443.UID);
  __ST586733_Layout __JT597706(__ST586406_Layout __l, B_Customer_1.__ST32268_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE597774 := JOIN(__EE597700,__EE547443,__JC597706(LEFT,RIGHT),__JT597706(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE547336 := __ENH_Bank_1;
  SHARED __ST587083_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Bank_Account.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Bank.Typ) _r_Bank_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC597780(__ST586733_Layout __EE597774, B_Bank_2.__ST36872_Layout __EE547336) := __EEQP(__EE597774._r_Bank_,__EE547336.UID);
  __ST587083_Layout __JT597780(__ST586733_Layout __l, B_Bank_2.__ST36872_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE597867 := JOIN(__EE597774,__EE547336,__JC597780(LEFT,RIGHT),__JT597780(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST22865_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST22865_Layout __ND597872__Project(__ST587083_Layout __PP597868) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP597868.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP597868.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 19;
    SELF.Event_Count_ := __PP597868.C_O_U_N_T___Bank_Account_Event_;
    SELF.Identity_Count_Gt2_ := MAP(__PP597868.Identity_Count_ > 2=>1,0);
    __BS597961 := __T(__PP597868.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS597961(__T(__OP2(__T(__PP597868.Source_Customers_)._r_Source_Customer_,=,__PP597868._r_Customer_))))=>1,0);
    SELF.Kr_Bnk800_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Bnk801_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Bnk802_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Bnk890_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Bnk891_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Bnk892_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Bnk893_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP597868.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP597868.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP597868.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP597868.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP597868.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP597868.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP597868.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP597868.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP597868.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event365_Count_ := __PP597868.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP597868.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP597868.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP597868;
  END;
  EXPORT __ENH_Bank_Account := PROJECT(__EE597867,__ND597872__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank_Account::Annotated',EXPIRE(7));
  SHARED __EE1360752 := __ENH_Bank_Account;
  SHARED IDX_Bank_Account_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1360752._r_Customer_;
    __EE1360752.Source_Customers_;
    __EE1360752._r_Bank_;
    __EE1360752.Account_Number_;
    __EE1360752.Otto_Bank_Account_Id_;
    __EE1360752.Customer_Id_;
    __EE1360752.Industry_Type_;
    __EE1360752.Source_Customer_Count_;
    __EE1360752.Entity_Context_Uid_;
    __EE1360752.Entity_Type_;
    __EE1360752.Label_;
    __EE1360752.Abbreviated_Bankname_;
    __EE1360752.In_Customer_Population_;
    __EE1360752.Dt_First_Seen_;
    __EE1360752.Dt_Last_Seen_;
    __EE1360752.Last_Record_Id_;
    __EE1360752.Identity_Count_;
    __EE1360752.Identity_Count_Gt2_;
    __EE1360752.Event_Count_;
    __EE1360752.High_Risk_Routing_;
    __EE1360752.Kr_High_Risk_Flag_;
    __EE1360752.Kr_Medium_Risk_Flag_;
    __EE1360752.Kr_Low_Risk_Flag_;
    __EE1360752.Kr_Flag_;
    __EE1360752.Safe_Flag_;
    __EE1360752.Contributor_Safe_Flag_;
    __EE1360752.Last_Event_Date_;
    __EE1360752.Kr_Last_Event_Date_;
    __EE1360752.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1360752.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1360752.Kr_Bnk800_Flag_;
    __EE1360752.Kr_Bnk801_Flag_;
    __EE1360752.Kr_Bnk802_Flag_;
    __EE1360752.Kr_Bnk890_Flag_;
    __EE1360752.Kr_Bnk891_Flag_;
    __EE1360752.Kr_Bnk892_Flag_;
    __EE1360752.Kr_Bnk893_Flag_;
    __EE1360752.Vl_Event1_All_Count_;
    __EE1360752.Vl_Event7_All_Count_;
    __EE1360752.Vl_Event30_All_Day_Count_;
    __EE1360752.Vl_Event365_All_Day_Count_;
    __EE1360752.Vl_Event7_All_Active_Flag_;
    __EE1360752.Vl_Event30_All_Active_Flag_;
    __EE1360752.Vl_Event1_Count_;
    __EE1360752.Vl_Event7_Count_;
    __EE1360752.Vl_Event30_Count_;
    __EE1360752.Vl_Event365_Count_;
    __EE1360752.Vl_Event7_Active_Flag_;
    __EE1360752.Vl_Event30_Active_Flag_;
    __EE1360752.Date_First_Seen_;
    __EE1360752.Date_Last_Seen_;
    __EE1360752.__RecordCount;
  END;
  SHARED IDX_Bank_Account_UID_Projected := PROJECT(__EE1360752,TRANSFORM(IDX_Bank_Account_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1360754_Layout := RECORDOF(IDX_Bank_Account_UID);
  EXPORT IDX_Bank_Account_UID_Wrapped := PROJECT(IDX_Bank_Account_UID,TRANSFORM(__ST22865_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
