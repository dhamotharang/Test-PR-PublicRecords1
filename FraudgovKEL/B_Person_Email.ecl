...
EXPORT B_Person_Email := MODULE
  ...
  SHARED __EE4397989 := __E_Person_Email;
  ...
  END;
  SHARED __ST70081_Layout __ND4398023__Project(E_Person_Email.Layout __PP4397884) := TRANSFORM
    __EE4397922 := __PP4397884.Event_Dates_;
    SELF.Dt_First_Seen_ := KEL.Aggregates.MinNN(__EE4397922,__T(__EE4397922).Event_Date_);
    __EE4397951 := __PP4397884.Event_Dates_;
  ...
  EXPORT __ST4669729_Layout := RECORDOF(IDX_Person_Email_Emailof_);
