...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE407265 := __E_Bank;
  EXPORT __ST53330_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST53330_Layout __ND407300__Project(E_Bank.Layout __PP407187) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP407187.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP407187;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE407265,__ND407300__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
