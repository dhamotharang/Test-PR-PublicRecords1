...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE634929 := __E_Bank;
  EXPORT __ST83353_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST83353_Layout __ND634964__Project(E_Bank.Layout __PP634851) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP634851.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP634851;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE634929,__ND634964__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
