...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE468571 := __E_Bank;
  EXPORT __ST56199_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST56199_Layout __ND468606__Project(E_Bank.Layout __PP468493) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP468493.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP468493;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE468571,__ND468606__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
