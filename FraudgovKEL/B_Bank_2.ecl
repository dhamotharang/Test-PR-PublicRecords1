...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE450440 := __E_Bank;
  EXPORT __ST56080_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST56080_Layout __ND450475__Project(E_Bank.Layout __PP450362) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP450362.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP450362;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE450440,__ND450475__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
