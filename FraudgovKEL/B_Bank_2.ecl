...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE410182 := __E_Bank;
  EXPORT __ST55638_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST55638_Layout __ND410217__Project(E_Bank.Layout __PP410104) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP410104.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP410104;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE410182,__ND410217__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
