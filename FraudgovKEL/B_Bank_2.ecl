...
EXPORT B_Bank_2 := MODULE
  ...
  END;
  SHARED __ST37566_Layout __ND205975__Project(E_Bank.Layout __PP205862) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP205862.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP205862;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE205940,__ND205975__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
