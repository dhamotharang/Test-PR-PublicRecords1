...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE226425 := __E_Bank;
  EXPORT __ST34972_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST34972_Layout __ND226460__Project(E_Bank.Layout __PP226347) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP226347.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP226347;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE226425,__ND226460__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
