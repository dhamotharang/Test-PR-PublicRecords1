...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE186104 := __E_Bank;
  EXPORT __ST36872_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST36872_Layout __ND186139__Project(E_Bank.Layout __PP186026) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP186026.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP186026;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE186104,__ND186139__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
