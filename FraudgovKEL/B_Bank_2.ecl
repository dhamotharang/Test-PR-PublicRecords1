...
EXPORT B_Bank_2 := MODULE
  ...
  SHARED __EE408273 := __E_Bank;
  EXPORT __ST55625_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST55625_Layout __ND408308__Project(E_Bank.Layout __PP408195) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP408195.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP408195;
  END;
  EXPORT __ENH_Bank_2 := PROJECT(__EE408273,__ND408308__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Bank::Annotated_2',EXPIRE(7));
END;
