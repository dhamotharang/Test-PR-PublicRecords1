...
IMPORT B_Person_4,E_Address,E_Customer,E_Person FROM FraudgovKEL;
IMPORT * FROM KEL011.Null;
EXPORT B_Person_3 := MODULE
  SHARED VIRTUAL TYPEOF(B_Person_4.__ENH_Person_4) __ENH_Person_4 := B_Person_4.__ENH_Person_4;
  SHARED __EE177077 := __ENH_Person_4;
  EXPORT __ST40102_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST40102_Layout __ND178226__Project(B_Person_4.__ST41536_Layout __PP176490) := TRANSFORM
    SELF.High_Risk_Death_Prior_To_All_Events_ := MAP(__T(__AND(__CN(__PP176490.Death_Prior_To_All_Events_ = 1),__OP2(__PP176490.Max_Deceased_To_Event_Diff_,<,__CN(-4))))=>1,0);
    __BS176921 := __T(__PP176490.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS176921(__T(__OP2(__T(__PP176490.Source_Customers_)._r_Source_Customer_,=,__PP176490._r_Customer_))))=>1,0);
    SELF := __PP176490;
  END;
  EXPORT __ENH_Person_3 := PROJECT(__EE177077,__ND178226__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_3',EXPIRE(7));
END;
