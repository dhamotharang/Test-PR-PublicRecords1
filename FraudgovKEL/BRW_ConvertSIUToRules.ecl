...
{'1', 'Identity05', 'Potentially Incarcerated', 'T1L_IDCurrIncarcFlag=1', 3},
{'1', 'Identity06', 'Activity after death', 'T1L_IDDtOfDeathAftIDActFlagEv=1', 3},
{'1', 'Identity07', 'Potentially Deceased', 'T1L_IDDeceasedFlag=1', 3},
{'1', 'Identity08', 'SSN issued before DOB', 'T1_SSNPriorDOBFlag=1', 3},
{'1', 'Identity09', 'Compromised', 'T1_StolIDFlag=1,T1_MinorWLexIDFlag=0', 3},
{'1', 'Identity10', 'Manipulated', 'T1_ManipIDFlag=1,T1_MinorWLexIDFlag=0', 3},
{'1', 'Identity11', 'Synthetic', 'T1_SynthIDFlag=1,T1_MinorWLexIDFlag=0', 3},
{'1', 'Identity12', 'Address out of agency state', 'T1L_CurrAddrNotInAgcyJurStFlag=1', 2},
{'1', 'Identity13', 'DL out of agency state', 'T1L_BestDLNotInAgcyJurStFlag=1', 2},
{'1', 'Identity14', 'Low source counts', 'T1L_HdrSrcCatCntLwFlag=1', 2},
{'1', 'Identity15', 'Minor with public records', 'T1_MinorWLexIDFlag=1', 1},
{'1', 'Identity16', 'Adult records missing', 'T1_AdultIDNotSeenFlag=1', 3},
{'1', 'Identity17', 'Minor with public records, Manipulated', 'T1_MinorWLexIDFlag=1, T1_ManipIDFlag=1', 2},
{'1', 'Identity18', 'Minor with public records, Synthetic', 'T1_MinorWLexIDFlag=1, T1_SynthIDFlag=1', 2},
{'1', 'Identity19', 'Minor with public records, Compromised', 'T1_MinorWLexIDFlag=1, T1_StolIDFlag=1', 2}
...
output(NormRules,,'~fraudgov::in::20200701::configrules', CSV(QUOTE('"'), HEADING(SINGLE), TERMINATOR('r\n')), overwrite);
