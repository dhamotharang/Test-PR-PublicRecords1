...
EXPORT B_Person_Drivers_License := MODULE
  ...
  SHARED __EE4142907 := __E_Person_Drivers_License;
  ...
  END;
  SHARED __ST70058_Layout __ND4142941__Project(E_Person_Drivers_License.Layout __PP4142802) := TRANSFORM
    __EE4142840 := __PP4142802.Event_Dates_;
    SELF.Dt_First_Seen_ := KEL.Aggregates.MinNN(__EE4142840,__T(__EE4142840).Event_Date_);
    __EE4142869 := __PP4142802.Event_Dates_;
    SELF.Dt_Last_Seen_ := KEL.Aggregates.MaxNN(__EE4142869,__T(__EE4142869).Event_Date_);
    SELF := __PP4142802;
  END;
  EXPORT __ENH_Person_Drivers_License := PROJECT(__EE4142907,__ND4142941__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person_Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE4414841 := __ENH_Person_Drivers_License;
  SHARED __IDX_Person_Drivers_License_License__Filtered := __EE4414841(__NN(__EE4414841.License_));
  ...
  EXPORT __ST4414843_Layout := RECORDOF(IDX_Person_Drivers_License_License_);
