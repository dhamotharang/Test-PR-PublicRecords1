...
EXPORT B_Person_Drivers_License := MODULE
  ...
  SHARED __ST70058_Layout __ND4397841__Project(E_Person_Drivers_License.Layout __PP4397702) := TRANSFORM
    ...
    SELF := __PP4397702;
  END;
  EXPORT __ENH_Person_Drivers_License := PROJECT(__EE4397807,__ND4397841__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person_Drivers_License::Annotated',EXPIRE(7));
