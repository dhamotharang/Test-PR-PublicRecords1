...
EXPORT B_Person_Drivers_License := MODULE
  ...
  SHARED __ST67028_Layout __ND4004439__Project(E_Person_Drivers_License.Layout __PP4004300) := TRANSFORM
    ...
    SELF := __PP4004300;
  END;
  EXPORT __ENH_Person_Drivers_License := PROJECT(__EE4004405,__ND4004439__Project(LEFT)) : PERSIST('~fraudgov::tempKEL::FraudgovKEL::Person_Drivers_License::Annotated',EXPIRE(7));
