...
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE2675821 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE2675824 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2590112_Layout := RECORD
  ...
  END;
  __JC2675832(E_Person_Address.Layout __EE2675821, B_Person.__ST45521_Layout __EE2675824) := __EEQP(__EE2675821.Subject_,__EE2675824.UID);
  __ST2590112_Layout __JT2675832(E_Person_Address.Layout __l, B_Person.__ST45521_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2675833 := JOIN(__EE2675821,__EE2675824,__JC2675832(LEFT,RIGHT),__JT2675832(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2676103 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST2590426_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2676111(__ST2590112_Layout __EE2675833, B_Address.__ST31954_Layout __EE2676103) := __EEQP(__EE2675833.Location_,__EE2676103.UID);
  __ST2590426_Layout __JT2676111(__ST2590112_Layout __l, B_Address.__ST31954_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2676112 := JOIN(__EE2675833,__EE2676103,__JC2676111(LEFT,RIGHT),__JT2676111(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2677015 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2590915_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2677029(__ST2590426_Layout __EE2676112, E_Customer.Layout __EE2677015) := __EEQP(__EE2676112._r_Customer_,__EE2677015.UID);
  __ST2590915_Layout __JT2677029(__ST2590426_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2677430 := JOIN(__EE2676112,__EE2677015,__JC2677029(LEFT,RIGHT),__JT2677029(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2590017_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2590017_Layout __ND2677822__Project(__ST2590915_Layout __PP2677431) := TRANSFORM
    SELF.Source_Customer_ := __PP2677431._r_Customer_;
    SELF.Customer_Id_ := __PP2677431.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2677431.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2677431.Entity_Context_Uid__1_;
    SELF := __PP2677431;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2677430,__ND2677822__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2590017_Layout));
END;
