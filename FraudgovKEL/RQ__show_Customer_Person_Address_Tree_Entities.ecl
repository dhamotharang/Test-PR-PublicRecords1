...
IMPORT B_Address,B_Customer,B_Customer_4,B_Person,B_Person_1,B_Person_2,B_Person_Address,E_Address,E_Customer,E_Person,E_Person_Address FROM FraudgovKEL;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE1471409 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1471412 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1376089_Layout := RECORD
  ...
  END;
  __JC1471420(E_Person_Address.Layout __EE1471409, B_Person.__ST30803_Layout __EE1471412) := __EEQP(__EE1471409.Subject_,__EE1471412.UID);
  __ST1376089_Layout __JT1471420(E_Person_Address.Layout __l, B_Person.__ST30803_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1471421 := JOIN(__EE1471409,__EE1471412,__JC1471420(LEFT,RIGHT),__JT1471420(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1471749 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1376461_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1471757(__ST1376089_Layout __EE1471421, B_Address.__ST22728_Layout __EE1471749) := __EEQP(__EE1471421.Location_,__EE1471749.UID);
  __ST1376461_Layout __JT1471757(__ST1376089_Layout __l, B_Address.__ST22728_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1471758 := JOIN(__EE1471421,__EE1471749,__JC1471757(LEFT,RIGHT),__JT1471757(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1472803 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1377032_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1472817(__ST1376461_Layout __EE1471758, E_Customer.Layout __EE1472803) := __EEQP(__EE1471758._r_Customer_,__EE1472803.UID);
  __ST1377032_Layout __JT1472817(__ST1376461_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1473278 := JOIN(__EE1471758,__EE1472803,__JC1472817(LEFT,RIGHT),__JT1472817(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1375994_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1375994_Layout __ND1473730__Project(__ST1377032_Layout __PP1473279) := TRANSFORM
    SELF.Source_Customer_ := __PP1473279._r_Customer_;
    SELF.Customer_Id_ := __PP1473279.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1473279.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1473279.Entity_Context_Uid__1_;
    SELF := __PP1473279;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1473278,__ND1473730__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1375994_Layout));
END;
