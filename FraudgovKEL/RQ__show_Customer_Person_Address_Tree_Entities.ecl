...
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE1367409 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1367412 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1289703_Layout := RECORD
  ...
  END;
  __JC1367420(E_Person_Address.Layout __EE1367409, B_Person.__ST28756_Layout __EE1367412) := __EEQP(__EE1367409.Subject_,__EE1367412.UID);
  __ST1289703_Layout __JT1367420(E_Person_Address.Layout __l, B_Person.__ST28756_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1367421 := JOIN(__EE1367409,__EE1367412,__JC1367420(LEFT,RIGHT),__JT1367420(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1367661 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1289987_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1367669(__ST1289703_Layout __EE1367421, B_Address.__ST20938_Layout __EE1367661) := __EEQP(__EE1367421.Location_,__EE1367661.UID);
  __ST1289987_Layout __JT1367669(__ST1289703_Layout __l, B_Address.__ST20938_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1367670 := JOIN(__EE1367421,__EE1367661,__JC1367669(LEFT,RIGHT),__JT1367669(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1368495 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1290437_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1368509(__ST1289987_Layout __EE1367670, E_Customer.Layout __EE1368495) := __EEQP(__EE1367670._r_Customer_,__EE1368495.UID);
  __ST1290437_Layout __JT1368509(__ST1289987_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1368871 := JOIN(__EE1367670,__EE1368495,__JC1368509(LEFT,RIGHT),__JT1368509(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1289608_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1289608_Layout __ND1369224__Project(__ST1290437_Layout __PP1368872) := TRANSFORM
    SELF.Source_Customer_ := __PP1368872._r_Customer_;
    SELF.Customer_Id_ := __PP1368872.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1368872.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1368872.Entity_Context_Uid__1_;
    SELF := __PP1368872;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1368871,__ND1369224__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1289608_Layout));
END;
