...
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE1352661 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1352664 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1274793_Layout := RECORD
  ...
  END;
  __JC1352672(E_Person_Address.Layout __EE1352661, B_Person.__ST28512_Layout __EE1352664) := __EEQP(__EE1352661.Subject_,__EE1352664.UID);
  __ST1274793_Layout __JT1352672(E_Person_Address.Layout __l, B_Person.__ST28512_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1352673 := JOIN(__EE1352661,__EE1352664,__JC1352672(LEFT,RIGHT),__JT1352672(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1352913 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1275077_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1352921(__ST1274793_Layout __EE1352673, B_Address.__ST20764_Layout __EE1352913) := __EEQP(__EE1352673.Location_,__EE1352913.UID);
  __ST1275077_Layout __JT1352921(__ST1274793_Layout __l, B_Address.__ST20764_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1352922 := JOIN(__EE1352673,__EE1352913,__JC1352921(LEFT,RIGHT),__JT1352921(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1353747 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1275527_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1353761(__ST1275077_Layout __EE1352922, E_Customer.Layout __EE1353747) := __EEQP(__EE1352922._r_Customer_,__EE1353747.UID);
  __ST1275527_Layout __JT1353761(__ST1275077_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1354123 := JOIN(__EE1352922,__EE1353747,__JC1353761(LEFT,RIGHT),__JT1353761(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1274698_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1274698_Layout __ND1354476__Project(__ST1275527_Layout __PP1354124) := TRANSFORM
    SELF.Source_Customer_ := __PP1354124._r_Customer_;
    SELF.Customer_Id_ := __PP1354124.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1354124.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1354124.Entity_Context_Uid__1_;
    SELF := __PP1354124;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1354123,__ND1354476__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1274698_Layout));
END;
