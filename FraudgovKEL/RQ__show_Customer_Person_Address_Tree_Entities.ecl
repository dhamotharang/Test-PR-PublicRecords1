...
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE1353714 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1353717 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1275845_Layout := RECORD
  ...
  END;
  __JC1353725(E_Person_Address.Layout __EE1353714, B_Person.__ST28708_Layout __EE1353717) := __EEQP(__EE1353714.Subject_,__EE1353717.UID);
  __ST1275845_Layout __JT1353725(E_Person_Address.Layout __l, B_Person.__ST28708_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1353726 := JOIN(__EE1353714,__EE1353717,__JC1353725(LEFT,RIGHT),__JT1353725(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1353966 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1276129_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1353974(__ST1275845_Layout __EE1353726, B_Address.__ST20910_Layout __EE1353966) := __EEQP(__EE1353726.Location_,__EE1353966.UID);
  __ST1276129_Layout __JT1353974(__ST1275845_Layout __l, B_Address.__ST20910_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1353975 := JOIN(__EE1353726,__EE1353966,__JC1353974(LEFT,RIGHT),__JT1353974(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1354800 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1276579_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1354814(__ST1276129_Layout __EE1353975, E_Customer.Layout __EE1354800) := __EEQP(__EE1353975._r_Customer_,__EE1354800.UID);
  __ST1276579_Layout __JT1354814(__ST1276129_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1355176 := JOIN(__EE1353975,__EE1354800,__JC1354814(LEFT,RIGHT),__JT1354814(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1275750_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1275750_Layout __ND1355529__Project(__ST1276579_Layout __PP1355177) := TRANSFORM
    SELF.Source_Customer_ := __PP1355177._r_Customer_;
    SELF.Customer_Id_ := __PP1355177.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1355177.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1355177.Entity_Context_Uid__1_;
    SELF := __PP1355177;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1355176,__ND1355529__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1275750_Layout));
END;
