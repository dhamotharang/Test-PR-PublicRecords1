...
EXPORT B_Event_5 := MODULE
  ...
  SHARED __EE145649 := __ENH_Event_6;
  EXPORT __ST99163_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST99163_Layout __ND146375__Project(B_Event_6.__ST101563_Layout __PP143794) := TRANSFORM
    SELF.Deceased_To_Event_Year_Diff_ := MAP(__PP143794.Deceased_Match_ = 1=>__ECAST(KEL.typ.nint,__FN2(KEL.Routines.YearsBetween,__PP143794.Event_Date_,__PP143794.Deceased_Date_)),__ECAST(KEL.typ.nint,__CN(0)));
    SELF.Kr_Identity_Risk_ := MAP(__T(__OR(__OR(__OP2(__PP143794._name__risk__code_,<>,__CN(0)),__OP2(__PP143794._dob__risk__code_,<>,__CN(0))),__OP2(__PP143794._identity__risk__code_,<>,__CN(0))))=>1,0);
    SELF.T1_L___Bc_Shll_Lex_Id_Matches_Inp_Flag_ := MAP(__PP143794.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP143794.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP143794.T___Src_Class_Type_ < 4=> -99998,__T(__OP2(__PP143794.T___Bc_Shll_Lex_Id_Echo_,=,__CN(0)))=> -99997,__T(__OP2(__PP143794.T___Bc_Shll_Lex_Id_Echo_,=,__PP143794.T___Person_Uid_Echo_))=>1,0);
    SELF.T1_L___Lex_Id_Seen_Flag_ := MAP(__PP143794.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP143794.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP143794.T___Src_Class_Type_ < 4=> -99998,__T(__OP2(__PP143794.T___Bc_Shll_Lex_Id_Echo_,=,__CN(0)))=> -99997,__T(__OP2(__PP143794._truedid_,=,__CN(TRUE)))=>1,0);
    SELF.T___Act_Dt_Echo_ := __PP143794.Event_Date_;
    SELF := __PP143794;
  END;
  EXPORT __ENH_Event_5 := PROJECT(__EE145649,__ND146375__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Event::Annotated_5',EXPIRE(7));
END;
