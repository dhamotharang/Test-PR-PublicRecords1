...
EXPORT B_Event_5 := MODULE
  ...
  SHARED __EE146291 := __ENH_Event_6;
  SHARED __EE151579 := __E_Person_Event;
  SHARED __EE152100 := __EE151579(__NN(__EE151579.Transaction_));
  SHARED __EE158915 := __EE146291;
  SHARED __EE161342 := __EE158915(__T(__NOT(__OP2(__EE158915.T___Bc_Shll_Lex_Id_Echo_,=,__CN(-99997)))));
  __JC161348(E_Person_Event.Layout __EE152100, B_Event_6.__ST101096_Layout __EE161342) := __EEQP(__EE152100.Transaction_,__EE161342.UID);
  SHARED __EE161354 := JOIN(__EE152100,__EE161342,__JC161348(LEFT,RIGHT),TRANSFORM(E_Person_Event.Layout,SELF:=LEFT),HASH,KEEP(1));
  SHARED __ST151615_Layout := RECORD
    KEL.typ.ntyp(E_Event.Typ) UID;
    KEL.typ.bool Exp1_ := FALSE;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST151615_Layout __ND161359__Project(E_Person_Event.Layout __PP161355) := TRANSFORM
    SELF.UID := __PP161355.Transaction_;
    SELF.Exp1_ := TRUE;
    SELF := __PP161355;
  END;
  SHARED __EE161366 := PROJECT(TABLE(PROJECT(__EE161354,__ND161359__Project(LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Exp1_},UID,Exp1_,MERGE),__ST151615_Layout);
  SHARED __ST151636_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE164019 := PROJECT(__CLEANANDDO(__EE161366,TABLE(__EE161366,{KEL.typ.int C_O_U_N_T___Event_ := COUNT(GROUP),KEL.typ.int C_O_U_N_T___Event__1_ := COUNT(GROUP),UID},UID,MERGE)),__ST151636_Layout);
  SHARED __ST152974_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC164028(B_Event_6.__ST101096_Layout __EE146291, __ST151636_Layout __EE164019) := __EEQP(__EE146291.UID,__EE164019.UID);
  __ST152974_Layout __JT164028(B_Event_6.__ST101096_Layout __l, __ST151636_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE164029 := JOIN(__EE146291,__EE164019,__JC164028(LEFT,RIGHT),__JT164028(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE148123 := __EE146291;
  SHARED __ST152555_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __ST152555_Layout __JT152552(B_Event_6.__ST101096_Layout __l, E_Event.Event_Types_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE152553 := NORMALIZE(__EE148123,__T(LEFT.Event_Types_),__JT152552(LEFT,RIGHT));
  SHARED __ST149431_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Event_Type_;
    KEL.typ.ndataset(E_Event.Event_Types_Layout) Event_Types_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE152965 := PROJECT(__EE152553,__ST149431_Layout);
  SHARED __ST149514_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    KEL.typ.nbool Exp2_;
    KEL.typ.nbool Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST149514_Layout __ND164034__Project(__ST149431_Layout __PP164030) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP164030.Event_Type_,IN,__CN(['301','302','303','391']));
    SELF.Exp2_ := __OP2(__PP164030.Event_Type_,IN,__CN(['800','891']));
    SELF.Exp3_ := __OP2(__PP164030.Event_Type_,IN,__CN(['203','291']));
    SELF.Exp4_ := __OP2(__PP164030.Event_Type_,IN,__CN(['500','501','591']));
    SELF.Exp5_ := __OP2(__PP164030.Event_Type_,IN,__CN(['10000','10001','10002','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12005','12006','12007','13000','13001','13002','13003','13004','13005','13006','13007','1400','14901']));
    SELF.Exp6_ := __OP2(__PP164030.Event_Type_,IN,__CN(['601','602','605','691','1000','1091']));
    SELF.Exp7_ := __OP2(__PP164030.Event_Type_,IN,__CN(['400','402','491']));
    SELF.Exp8_ := __OP2(__PP164030.Event_Type_,IN,__CN(['390','393']));
    SELF.Exp9_ := __OP2(__PP164030.Event_Type_,IN,__CN(['893','890']));
    SELF.Exp10_ := __OP2(__PP164030.Event_Type_,IN,__CN(['200','201','290','293']));
    SELF.Exp11_ := __OP2(__PP164030.Event_Type_,IN,__CN(['590','593']));
    SELF.Exp12_ := __OP2(__PP164030.Event_Type_,IN,__CN(['14900','14903']));
    SELF.Exp13_ := __OP2(__PP164030.Event_Type_,IN,__CN(['690','693','1090','1093']));
    SELF.Exp14_ := __OP2(__PP164030.Event_Type_,IN,__CN(['490','493']));
    SELF.Exp15_ := __OP2(__PP164030.Event_Type_,IN,__CN(['300','392']));
    SELF.Exp16_ := __OP2(__PP164030.Event_Type_,IN,__CN(['801','802','892']));
    SELF.Exp17_ := __OP2(__PP164030.Event_Type_,IN,__CN(['202','204','292']));
    SELF.Exp18_ := __OP2(__PP164030.Event_Type_,IN,__CN(['502','592']));
    SELF.Exp19_ := __OP2(__PP164030.Event_Type_,IN,__CN(['10003','10004','14001','14902']));
    SELF.Exp20_ := __OP2(__PP164030.Event_Type_,IN,__CN(['600','603','604','692','1001','1092']));
    SELF.Exp21_ := __OP2(__PP164030.Event_Type_,IN,__CN(['401','492']));
    SELF := __PP164030;
  END;
  SHARED __EE164290 := PROJECT(__EE152965,__ND164034__Project(LEFT));
  SHARED __ST149629_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE164448 := PROJECT(__CLEANANDDO(__EE164290,TABLE(__EE164290,{KEL.typ.int C_O_U_N_T___Event_Types_ := COUNT(GROUP,__T(__EE164290.Exp1_)),KEL.typ.int C_O_U_N_T___Event_Types__1_ := COUNT(GROUP,__T(__EE164290.Exp2_)),KEL.typ.int C_O_U_N_T___Event_Types__2_ := COUNT(GROUP,__T(__EE164290.Exp3_)),KEL.typ.int C_O_U_N_T___Event_Types__3_ := COUNT(GROUP,__T(__EE164290.Exp4_)),KEL.typ.int C_O_U_N_T___Event_Types__4_ := COUNT(GROUP,__T(__EE164290.Exp5_)),KEL.typ.int C_O_U_N_T___Event_Types__5_ := COUNT(GROUP,__T(__EE164290.Exp6_)),KEL.typ.int C_O_U_N_T___Event_Types__6_ := COUNT(GROUP,__T(__EE164290.Exp7_)),KEL.typ.int C_O_U_N_T___Event_Types__7_ := COUNT(GROUP,__T(__EE164290.Exp8_)),KEL.typ.int C_O_U_N_T___Event_Types__8_ := COUNT(GROUP,__T(__EE164290.Exp9_)),KEL.typ.int C_O_U_N_T___Event_Types__9_ := COUNT(GROUP,__T(__EE164290.Exp10_)),KEL.typ.int C_O_U_N_T___Event_Types__10_ := COUNT(GROUP,__T(__EE164290.Exp11_)),KEL.typ.int C_O_U_N_T___Event_Types__11_ := COUNT(GROUP,__T(__EE164290.Exp12_)),KEL.typ.int C_O_U_N_T___Event_Types__12_ := COUNT(GROUP,__T(__EE164290.Exp13_)),KEL.typ.int C_O_U_N_T___Event_Types__13_ := COUNT(GROUP,__T(__EE164290.Exp14_)),KEL.typ.int C_O_U_N_T___Event_Types__14_ := COUNT(GROUP,__T(__EE164290.Exp15_)),KEL.typ.int C_O_U_N_T___Event_Types__15_ := COUNT(GROUP,__T(__EE164290.Exp16_)),KEL.typ.int C_O_U_N_T___Event_Types__16_ := COUNT(GROUP,__T(__EE164290.Exp17_)),KEL.typ.int C_O_U_N_T___Event_Types__17_ := COUNT(GROUP,__T(__EE164290.Exp18_)),KEL.typ.int C_O_U_N_T___Event_Types__18_ := COUNT(GROUP,__T(__EE164290.Exp19_)),KEL.typ.int C_O_U_N_T___Event_Types__19_ := COUNT(GROUP,__T(__EE164290.Exp20_)),KEL.typ.int C_O_U_N_T___Event_Types__20_ := COUNT(GROUP,__T(__EE164290.Exp21_)),UID},UID,MERGE)),__ST149629_Layout);
  SHARED __ST154886_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC164457(__ST152974_Layout __EE164029, __ST149629_Layout __EE164448) := __EEQP(__EE164029.UID,__EE164448.UID);
  __ST154886_Layout __JT164457(__ST152974_Layout __l, __ST149629_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE164458 := JOIN(__EE164029,__EE164448,__JC164457(LEFT,RIGHT),__JT164457(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST98630_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST98630_Layout __ND162353__Project(__ST154886_Layout __PP162349) := TRANSFORM
    SELF.Deceased_To_Event_Year_Diff_ := MAP(__PP162349.Deceased_Match_ = 1=>__ECAST(KEL.typ.nint,__FN2(KEL.Routines.YearsBetween,__PP162349.Event_Date_,__PP162349.Deceased_Date_)),__ECAST(KEL.typ.nint,__CN(0)));
    SELF.Kr_High_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__1_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__2_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__3_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Identity_Flag_ := MAP(__PP162349.Kr_Identity_Risk_ = 1 OR __T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__4_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__5_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__6_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__7_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__8_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__9_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__10_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Identity_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__11_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__12_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__13_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__14_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__15_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__16_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__17_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Identity_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__18_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__19_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP162349.C_O_U_N_T___Event_Types__20_),<>,__CN(0)))=>1,0);
    SELF.T1_L___Bc_Shll_Lex_Id_Matches_Inp_Flag_ := MAP(__PP162349.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP162349.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP162349.T___Src_Class_Type_ < 4=> -99998, NOT (__PP162349.C_O_U_N_T___Event_ <> 0)=> -99997,__T(__OP2(__PP162349.T___Bc_Shll_Lex_Id_Echo_,=,__PP162349.T___Person_Uid_Echo_))=>1,0);
    SELF.T1_L___Lex_Id_Seen_Flag_ := MAP(__PP162349.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP162349.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP162349.T___Src_Class_Type_ < 4=> -99998, NOT (__PP162349.C_O_U_N_T___Event__1_ <> 0)=> -99997,__T(__OP2(__PP162349._truedid_,=,__CN(TRUE)))=>1,0);
    SELF.T___Act_Dt_Echo_ := __PP162349.Event_Date_;
    SELF := __PP162349;
  END;
  EXPORT __ENH_Event_5 := PROJECT(__EE164458,__ND162353__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_5',EXPIRE(7));
END;
