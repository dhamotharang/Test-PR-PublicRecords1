...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE4925981 := PROJECT(B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped,E_Person_Phone.Layout);
  SHARED __EE4925984 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4824474_Layout := RECORD
  ...
  END;
  __JC4925992(E_Person_Phone.Layout __EE4925981, B_Person.__ST71326_Layout __EE4925984) := __EEQP(__EE4925981.Subject_,__EE4925984.UID);
  __ST4824474_Layout __JT4925992(E_Person_Phone.Layout __l, B_Person.__ST71326_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4925993 := JOIN(__EE4925981,__EE4925984,__JC4925992(LEFT,RIGHT),__JT4925992(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4926288 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST4824815_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4926296(__ST4824474_Layout __EE4925993, B_Phone.__ST72436_Layout __EE4926288) := __EEQP(__EE4925993.Phone_Number_,__EE4926288.UID);
  __ST4824815_Layout __JT4926296(__ST4824474_Layout __l, B_Phone.__ST72436_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4926297 := JOIN(__EE4925993,__EE4926288,__JC4926296(LEFT,RIGHT),__JT4926296(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4927210 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4825324_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4927224(__ST4824815_Layout __EE4926297, E_Customer.Layout __EE4927210) := __EEQP(__EE4926297._r_Customer_,__EE4927210.UID);
  __ST4825324_Layout __JT4927224(__ST4824815_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4927617 := JOIN(__EE4926297,__EE4927210,__JC4927224(LEFT,RIGHT),__JT4927224(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4824379_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4824379_Layout __ND4928001__Project(__ST4825324_Layout __PP4927618) := TRANSFORM
    SELF.Source_Customer_ := __PP4927618._r_Customer_;
    SELF.Customer_Id_ := __PP4927618.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4927618.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4927618.Entity_Context_Uid__1_;
    SELF := __PP4927618;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4927617,__ND4928001__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4824379_Layout));
END;
