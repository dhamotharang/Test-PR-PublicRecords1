...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE1482355 := PROJECT(B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped,E_Person_Phone.Layout);
  SHARED __EE1482358 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1380691_Layout := RECORD
  ...
  END;
  __JC1482366(E_Person_Phone.Layout __EE1482355, B_Person.__ST30803_Layout __EE1482358) := __EEQP(__EE1482355.Subject_,__EE1482358.UID);
  __ST1380691_Layout __JT1482366(E_Person_Phone.Layout __l, B_Person.__ST30803_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1482367 := JOIN(__EE1482355,__EE1482358,__JC1482366(LEFT,RIGHT),__JT1482366(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1482695 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST1381063_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1482703(__ST1380691_Layout __EE1482367, B_Phone.__ST31676_Layout __EE1482695) := __EEQP(__EE1482367.Phone_Number_,__EE1482695.UID);
  __ST1381063_Layout __JT1482703(__ST1380691_Layout __l, B_Phone.__ST31676_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1482704 := JOIN(__EE1482367,__EE1482695,__JC1482703(LEFT,RIGHT),__JT1482703(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1483633 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1381573_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1483647(__ST1381063_Layout __EE1482704, E_Customer.Layout __EE1483633) := __EEQP(__EE1482704._r_Customer_,__EE1483633.UID);
  __ST1381573_Layout __JT1483647(__ST1381063_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1484053 := JOIN(__EE1482704,__EE1483633,__JC1483647(LEFT,RIGHT),__JT1483647(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1380596_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1380596_Layout __ND1484450__Project(__ST1381573_Layout __PP1484054) := TRANSFORM
    SELF.Source_Customer_ := __PP1484054._r_Customer_;
    SELF.Customer_Id_ := __PP1484054.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1484054.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1484054.Entity_Context_Uid__1_;
    SELF := __PP1484054;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1484053,__ND1484450__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1380596_Layout));
END;
