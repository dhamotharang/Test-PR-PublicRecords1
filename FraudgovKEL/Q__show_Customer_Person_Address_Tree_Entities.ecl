...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE4251366 := __E_Person_Address;
  SHARED __EE4251349 := __ENH_Person;
  SHARED __ST4251384_Layout := RECORD
  ...
  END;
  __JC4251381(E_Person_Address.Layout __EE4251366, B_Person.__ST66706_Layout __EE4251349) := __EEQP(__EE4251366.Subject_,__EE4251349.UID);
  __ST4251384_Layout __JT4251381(E_Person_Address.Layout __l, B_Person.__ST66706_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4251382 := JOIN(__EE4251366,__EE4251349,__JC4251381(LEFT,RIGHT),__JT4251381(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4251337 := __ENH_Address;
  SHARED __ST4251725_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4252757(__ST4251384_Layout __EE4251382, B_Address.__ST46063_Layout __EE4251337) := __EEQP(__EE4251382.Location_,__EE4251337.UID);
  __ST4251725_Layout __JT4252757(__ST4251384_Layout __l, B_Address.__ST46063_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4252758 := JOIN(__EE4251382,__EE4251337,__JC4252757(LEFT,RIGHT),__JT4252757(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4251322 := __E_Customer;
  SHARED __ST4252276_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4252759(__ST4251725_Layout __EE4252758, E_Customer.Layout __EE4251322) := __EEQP(__EE4252758._r_Customer_,__EE4251322.UID);
  __ST4252276_Layout __JT4252759(__ST4251725_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4252760 := JOIN(__EE4252758,__EE4251322,__JC4252759(LEFT,RIGHT),__JT4252759(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44945_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44945_Layout __ND4252749__Project(__ST4252276_Layout __PP4252748) := TRANSFORM
    SELF.Source_Customer_ := __PP4252748._r_Customer_;
    SELF.Customer_Id_ := __PP4252748.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4252748.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4252748.Entity_Context_Uid__1_;
    SELF := __PP4252748;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4252760,__ND4252749__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44945_Layout));
END;
