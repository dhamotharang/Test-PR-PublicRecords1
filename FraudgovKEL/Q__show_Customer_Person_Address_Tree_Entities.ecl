...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE2542373 := __E_Person_Address;
  SHARED __EE2542356 := __ENH_Person;
  SHARED __ST2542391_Layout := RECORD
  ...
  END;
  __JC2542388(E_Person_Address.Layout __EE2542373, B_Person.__ST45521_Layout __EE2542356) := __EEQP(__EE2542373.Subject_,__EE2542356.UID);
  __ST2542391_Layout __JT2542388(E_Person_Address.Layout __l, B_Person.__ST45521_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2542389 := JOIN(__EE2542373,__EE2542356,__JC2542388(LEFT,RIGHT),__JT2542388(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2542344 := __ENH_Address;
  SHARED __ST2542705_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2543631(__ST2542391_Layout __EE2542389, B_Address.__ST31954_Layout __EE2542344) := __EEQP(__EE2542389.Location_,__EE2542344.UID);
  __ST2542705_Layout __JT2543631(__ST2542391_Layout __l, B_Address.__ST31954_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2543632 := JOIN(__EE2542389,__EE2542344,__JC2543631(LEFT,RIGHT),__JT2543631(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2542329 := __E_Customer;
  SHARED __ST2543194_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2543633(__ST2542705_Layout __EE2543632, E_Customer.Layout __EE2542329) := __EEQP(__EE2543632._r_Customer_,__EE2542329.UID);
  __ST2543194_Layout __JT2543633(__ST2542705_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2543634 := JOIN(__EE2543632,__EE2542329,__JC2543633(LEFT,RIGHT),__JT2543633(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST31045_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31045_Layout __ND2543623__Project(__ST2543194_Layout __PP2543622) := TRANSFORM
    SELF.Source_Customer_ := __PP2543622._r_Customer_;
    SELF.Customer_Id_ := __PP2543622.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2543622.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2543622.Entity_Context_Uid__1_;
    SELF := __PP2543622;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2543634,__ND2543623__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST31045_Layout));
END;
