...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE2465597 := __E_Person_Address;
  SHARED __EE2465580 := __ENH_Person;
  SHARED __ST2465615_Layout := RECORD
  ...
  END;
  __JC2465612(E_Person_Address.Layout __EE2465597, B_Person.__ST45444_Layout __EE2465580) := __EEQP(__EE2465597.Subject_,__EE2465580.UID);
  __ST2465615_Layout __JT2465612(E_Person_Address.Layout __l, B_Person.__ST45444_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2465613 := JOIN(__EE2465597,__EE2465580,__JC2465612(LEFT,RIGHT),__JT2465612(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2465568 := __ENH_Address;
  SHARED __ST2465929_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2466855(__ST2465615_Layout __EE2465613, B_Address.__ST31913_Layout __EE2465568) := __EEQP(__EE2465613.Location_,__EE2465568.UID);
  __ST2465929_Layout __JT2466855(__ST2465615_Layout __l, B_Address.__ST31913_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2466856 := JOIN(__EE2465613,__EE2465568,__JC2466855(LEFT,RIGHT),__JT2466855(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2465553 := __E_Customer;
  SHARED __ST2466418_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2466857(__ST2465929_Layout __EE2466856, E_Customer.Layout __EE2465553) := __EEQP(__EE2466856._r_Customer_,__EE2465553.UID);
  __ST2466418_Layout __JT2466857(__ST2465929_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2466858 := JOIN(__EE2466856,__EE2465553,__JC2466857(LEFT,RIGHT),__JT2466857(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST31004_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31004_Layout __ND2466847__Project(__ST2466418_Layout __PP2466846) := TRANSFORM
    SELF.Source_Customer_ := __PP2466846._r_Customer_;
    SELF.Customer_Id_ := __PP2466846.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2466846.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2466846.Entity_Context_Uid__1_;
    SELF := __PP2466846;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2466858,__ND2466847__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST31004_Layout));
END;
