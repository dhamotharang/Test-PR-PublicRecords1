...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE3366667 := __E_Person_Address;
  SHARED __EE3366650 := __ENH_Person;
  SHARED __ST3366685_Layout := RECORD
  ...
  END;
  __JC3366682(E_Person_Address.Layout __EE3366667, B_Person.__ST63087_Layout __EE3366650) := __EEQP(__EE3366667.Subject_,__EE3366650.UID);
  __ST3366685_Layout __JT3366682(E_Person_Address.Layout __l, B_Person.__ST63087_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3366683 := JOIN(__EE3366667,__EE3366650,__JC3366682(LEFT,RIGHT),__JT3366682(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3366638 := __ENH_Address;
  SHARED __ST3367021_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3368023(__ST3366685_Layout __EE3366683, B_Address.__ST43698_Layout __EE3366638) := __EEQP(__EE3366683.Location_,__EE3366638.UID);
  __ST3367021_Layout __JT3368023(__ST3366685_Layout __l, B_Address.__ST43698_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3368024 := JOIN(__EE3366683,__EE3366638,__JC3368023(LEFT,RIGHT),__JT3368023(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3366623 := __E_Customer;
  SHARED __ST3367552_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3368025(__ST3367021_Layout __EE3368024, E_Customer.Layout __EE3366623) := __EEQP(__EE3368024._r_Customer_,__EE3366623.UID);
  __ST3367552_Layout __JT3368025(__ST3367021_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3368026 := JOIN(__EE3368024,__EE3366623,__JC3368025(LEFT,RIGHT),__JT3368025(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST42608_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST42608_Layout __ND3368015__Project(__ST3367552_Layout __PP3368014) := TRANSFORM
    SELF.Source_Customer_ := __PP3368014._r_Customer_;
    SELF.Customer_Id_ := __PP3368014.Customer_Id__2_;
    SELF.Industry_Type_ := __PP3368014.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP3368014.Entity_Context_Uid__1_;
    SELF := __PP3368014;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE3368026,__ND3368015__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST42608_Layout));
END;
