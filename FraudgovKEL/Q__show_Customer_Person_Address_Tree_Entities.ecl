...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE4253386 := __E_Person_Address;
  SHARED __EE4253369 := __ENH_Person;
  SHARED __ST4253404_Layout := RECORD
  ...
  END;
  __JC4253401(E_Person_Address.Layout __EE4253386, B_Person.__ST66766_Layout __EE4253369) := __EEQP(__EE4253386.Subject_,__EE4253369.UID);
  __ST4253404_Layout __JT4253401(E_Person_Address.Layout __l, B_Person.__ST66766_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4253402 := JOIN(__EE4253386,__EE4253369,__JC4253401(LEFT,RIGHT),__JT4253401(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4253357 := __ENH_Address;
  SHARED __ST4253745_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4254777(__ST4253404_Layout __EE4253402, B_Address.__ST46104_Layout __EE4253357) := __EEQP(__EE4253402.Location_,__EE4253357.UID);
  __ST4253745_Layout __JT4254777(__ST4253404_Layout __l, B_Address.__ST46104_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4254778 := JOIN(__EE4253402,__EE4253357,__JC4254777(LEFT,RIGHT),__JT4254777(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4253342 := __E_Customer;
  SHARED __ST4254296_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4254779(__ST4253745_Layout __EE4254778, E_Customer.Layout __EE4253342) := __EEQP(__EE4254778._r_Customer_,__EE4253342.UID);
  __ST4254296_Layout __JT4254779(__ST4253745_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4254780 := JOIN(__EE4254778,__EE4253342,__JC4254779(LEFT,RIGHT),__JT4254779(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44986_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44986_Layout __ND4254769__Project(__ST4254296_Layout __PP4254768) := TRANSFORM
    SELF.Source_Customer_ := __PP4254768._r_Customer_;
    SELF.Customer_Id_ := __PP4254768.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4254768.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4254768.Entity_Context_Uid__1_;
    SELF := __PP4254768;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4254780,__ND4254769__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44986_Layout));
END;
