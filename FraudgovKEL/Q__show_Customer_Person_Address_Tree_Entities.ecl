...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE1322722 := __E_Person_Address;
  SHARED __EE1322705 := __ENH_Person;
  SHARED __ST1322740_Layout := RECORD
  ...
  END;
  __JC1322737(E_Person_Address.Layout __EE1322722, B_Person.__ST30803_Layout __EE1322705) := __EEQP(__EE1322722.Subject_,__EE1322705.UID);
  __ST1322740_Layout __JT1322737(E_Person_Address.Layout __l, B_Person.__ST30803_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1322738 := JOIN(__EE1322722,__EE1322705,__JC1322737(LEFT,RIGHT),__JT1322737(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1322693 := __ENH_Address;
  SHARED __ST1323112_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1324180(__ST1322740_Layout __EE1322738, B_Address.__ST22728_Layout __EE1322693) := __EEQP(__EE1322738.Location_,__EE1322693.UID);
  __ST1323112_Layout __JT1324180(__ST1322740_Layout __l, B_Address.__ST22728_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1324181 := JOIN(__EE1322738,__EE1322693,__JC1324180(LEFT,RIGHT),__JT1324180(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1322678 := __E_Customer;
  SHARED __ST1323683_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1324182(__ST1323112_Layout __EE1324181, E_Customer.Layout __EE1322678) := __EEQP(__EE1324181._r_Customer_,__EE1322678.UID);
  __ST1323683_Layout __JT1324182(__ST1323112_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1324183 := JOIN(__EE1324181,__EE1322678,__JC1324182(LEFT,RIGHT),__JT1324182(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21834_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21834_Layout __ND1324172__Project(__ST1323683_Layout __PP1324171) := TRANSFORM
    SELF.Source_Customer_ := __PP1324171._r_Customer_;
    SELF.Customer_Id_ := __PP1324171.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1324171.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1324171.Entity_Context_Uid__1_;
    SELF := __PP1324171;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1324183,__ND1324172__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21834_Layout));
END;
