...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE1298636 := __E_Person_Address;
  SHARED __EE1298619 := __ENH_Person;
  SHARED __ST1298654_Layout := RECORD
  ...
  END;
  __JC1298651(E_Person_Address.Layout __EE1298636, B_Person.__ST30729_Layout __EE1298619) := __EEQP(__EE1298636.Subject_,__EE1298619.UID);
  __ST1298654_Layout __JT1298651(E_Person_Address.Layout __l, B_Person.__ST30729_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1298652 := JOIN(__EE1298636,__EE1298619,__JC1298651(LEFT,RIGHT),__JT1298651(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1298607 := __ENH_Address;
  SHARED __ST1299026_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1300094(__ST1298654_Layout __EE1298652, B_Address.__ST22672_Layout __EE1298607) := __EEQP(__EE1298652.Location_,__EE1298607.UID);
  __ST1299026_Layout __JT1300094(__ST1298654_Layout __l, B_Address.__ST22672_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1300095 := JOIN(__EE1298652,__EE1298607,__JC1300094(LEFT,RIGHT),__JT1300094(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1298592 := __E_Customer;
  SHARED __ST1299597_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1300096(__ST1299026_Layout __EE1300095, E_Customer.Layout __EE1298592) := __EEQP(__EE1300095._r_Customer_,__EE1298592.UID);
  __ST1299597_Layout __JT1300096(__ST1299026_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1300097 := JOIN(__EE1300095,__EE1298592,__JC1300096(LEFT,RIGHT),__JT1300096(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21779_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21779_Layout __ND1300086__Project(__ST1299597_Layout __PP1300085) := TRANSFORM
    SELF.Source_Customer_ := __PP1300085._r_Customer_;
    SELF.Customer_Id_ := __PP1300085.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1300085.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1300085.Entity_Context_Uid__1_;
    SELF := __PP1300085;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1300097,__ND1300086__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21779_Layout));
END;
