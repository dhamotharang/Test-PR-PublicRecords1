...
EXPORT B_Event_9 := MODULE
  ...
  SHARED __EE72513 := __E_Event;
  EXPORT __ST70912_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST70912_Layout __ND72976__Project(E_Event.Layout __PP71369) := TRANSFORM
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP71369._rin__source_,<=,__CN(0)),__OP2(__PP71369._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP71369._rin__source_));
    SELF := __PP71369;
  END;
  EXPORT __ENH_Event_9 := PROJECT(__EE72513,__ND72976__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_9',EXPIRE(7));
END;
