...
EXPORT B_Event_9 := MODULE
  ...
  SHARED __EE69501 := __E_Event;
  EXPORT __ST67900_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST67900_Layout __ND69964__Project(E_Event.Layout __PP68357) := TRANSFORM
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP68357._rin__source_,<=,__CN(0)),__OP2(__PP68357._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP68357._rin__source_));
    SELF := __PP68357;
  END;
  EXPORT __ENH_Event_9 := PROJECT(__EE69501,__ND69964__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_9',EXPIRE(7));
END;
