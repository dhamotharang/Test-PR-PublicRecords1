...
EXPORT B_Event_9 := MODULE
  ...
  SHARED __EE116900 := __ENH_Event_10;
  EXPORT __ST106734_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST106734_Layout __ND117519__Project(B_Event_10.__ST107384_Layout __PP115297) := TRANSFORM
    SELF.No_Lex_Id_ := MAP(__T(__OP2(__PP115297.Lex_Id_,>,__CN(900000000000)))=>1,0);
    SELF.T___Evt_Type1_Status_Code_Echo_ := MAP(__PP115297.T___Src_Class_Type_ <> 2 AND __PP115297.T___Src_Class_Type_ <> 3 AND __PP115297.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP115297._event__type__1_),=,__CN('')),__NT(__PP115297._event__type__1_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP115297._event__type__1_));
    SELF.T___Evt_Type2_Status_Code_Echo_ := MAP(__PP115297.T___Src_Class_Type_ <> 2 AND __PP115297.T___Src_Class_Type_ <> 3 AND __PP115297.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP115297._event__type__2_),=,__CN('')),__NT(__PP115297._event__type__2_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP115297._event__type__2_));
    SELF.T___Evt_Type3_Status_Code_Echo_ := MAP(__PP115297.T___Src_Class_Type_ <> 2 AND __PP115297.T___Src_Class_Type_ <> 3 AND __PP115297.T___Src_Class_Type_ <> 0=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OR(__OP2(__CAST(KEL.typ.str,__PP115297._event__type__3_),=,__CN('')),__NT(__PP115297._event__type__3_)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP115297._event__type__3_));
