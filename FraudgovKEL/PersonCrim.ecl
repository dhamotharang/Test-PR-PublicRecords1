...
//EXPORT PersonCrim  := JOIN(FraudgovKEL.CustomerLexId, PersonCrimPrep, LEFT.did=(INTEGER)RIGHT.did, TRANSFORM({LEFT.AssociatedCustomerFileInfo, RECORDOF(RIGHT)}, SELF := RIGHT, SELF := LEFT), HASH, KEEP(1));
