...
EXPORT Q__show_Customer_Ip_Address_Entities := MODULE
  ...
  SHARED __EE1300486 := __ENH_Internet_Protocol;
  SHARED __EE1300434 := __E_Customer;
  SHARED __ST1300511_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1300743(B_Internet_Protocol.__ST28696_Layout __EE1300486, E_Customer.Layout __EE1300434) := __EEQP(__EE1300486._r_Customer_,__EE1300434.UID);
  __ST1300511_Layout __JT1300743(B_Internet_Protocol.__ST28696_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1300744 := JOIN(__EE1300486,__EE1300434,__JC1300743(LEFT,RIGHT),__JT1300743(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21559_Layout := RECORD
