...
EXPORT Q__show_Customer_Ip_Address_Entities := MODULE
  ...
  SHARED __EE4746436 := __ENH_Internet_Protocol;
  SHARED __EE4746384 := __E_Customer;
  SHARED __ST4746461_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4746719(B_Internet_Protocol.__ST69217_Layout __EE4746436, E_Customer.Layout __EE4746384) := __EEQP(__EE4746436._r_Customer_,__EE4746384.UID);
  __ST4746461_Layout __JT4746719(B_Internet_Protocol.__ST69217_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4746720 := JOIN(__EE4746436,__EE4746384,__JC4746719(LEFT,RIGHT),__JT4746719(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST47592_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47592_Layout __ND4746701__Project(__ST4746461_Layout __PP4746700) := TRANSFORM
    SELF.Source_Customer_ := __PP4746700._r_Customer_;
    SELF.Customer_Id_ := __PP4746700.Customer_Id__1_;
    SELF.Industry_Type_ := __PP4746700.Industry_Type__1_;
    SELF.Person_Count_ := __PP4746700.Identity_Count_;
    SELF := __PP4746700;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4746720,__ND4746701__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_},Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_,MERGE),__ST47592_Layout));
END;
