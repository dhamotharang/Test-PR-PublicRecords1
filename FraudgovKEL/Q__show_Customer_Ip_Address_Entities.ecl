...
EXPORT Q__show_Customer_Ip_Address_Entities := MODULE
  ...
  SHARED __EE1213514 := __ENH_Internet_Protocol;
  SHARED __EE1213462 := __E_Customer;
  SHARED __ST1213539_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1213771(B_Internet_Protocol.__ST26986_Layout __EE1213514, E_Customer.Layout __EE1213462) := __EEQP(__EE1213514._r_Customer_,__EE1213462.UID);
  __ST1213539_Layout __JT1213771(B_Internet_Protocol.__ST26986_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1213772 := JOIN(__EE1213514,__EE1213462,__JC1213771(LEFT,RIGHT),__JT1213771(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST19727_Layout := RECORD
