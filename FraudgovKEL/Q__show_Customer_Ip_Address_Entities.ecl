...
EXPORT Q__show_Customer_Ip_Address_Entities := MODULE
  ...
  SHARED __EE1214566 := __ENH_Internet_Protocol;
  SHARED __EE1214514 := __E_Customer;
  ...
  END;
  __JC1214823(B_Internet_Protocol.__ST27182_Layout __EE1214566, E_Customer.Layout __EE1214514) := __EEQP(__EE1214566._r_Customer_,__EE1214514.UID);
  __ST1214591_Layout __JT1214823(B_Internet_Protocol.__ST27182_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1214824 := JOIN(__EE1214566,__EE1214514,__JC1214823(LEFT,RIGHT),__JT1214823(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST19873_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST19873_Layout __ND1214805__Project(__ST1214591_Layout __PP1214804) := TRANSFORM
    SELF.Source_Customer_ := __PP1214804._r_Customer_;
    SELF.Customer_Id_ := __PP1214804.Customer_Id__1_;
    SELF.Industry_Type_ := __PP1214804.Industry_Type__1_;
    SELF.Person_Count_ := __PP1214804.Identity_Count_;
    SELF := __PP1214804;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1214824,__ND1214805__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_},Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_,MERGE),__ST19873_Layout));
END;
