...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE845524 := __ENH_Internet_Protocol_1;
  SHARED __EE899870 := __E_Person_Ip_Address;
  SHARED __EE899877 := __EE899870(__NN(__EE899870.Ip_));
  SHARED __ST890883_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE899891 := PROJECT(TABLE(PROJECT(__EE899877,TRANSFORM(__ST890883_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST890883_Layout);
  SHARED __ST890901_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE899857 := PROJECT(__CLEANANDDO(__EE899891,TABLE(__EE899891,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST890901_Layout);
  SHARED __ST893510_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC899900(B_Internet_Protocol_1.__ST33895_Layout __EE845524, __ST890901_Layout __EE899857) := __EEQP(__EE845524.UID,__EE899857.UID);
  __ST893510_Layout __JT899900(B_Internet_Protocol_1.__ST33895_Layout __l, __ST890901_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE899901 := JOIN(__EE845524,__EE899857,__JC899900(LEFT,RIGHT),__JT899900(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE899861 := __ENH_Event_1;
  SHARED __EE899859 := __E_Internet_Protocol_Event;
  SHARED __EE901986 := __EE899859(__NN(__EE899859.Ip_) AND __NN(__EE899859.Transaction_));
  SHARED __ST891450_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC902004(B_Event_1.__ST33316_Layout __EE899861, E_Internet_Protocol_Event.Layout __EE901986) := __EEQP(__EE901986.Transaction_,__EE899861.UID);
  __ST891450_Layout __JT902004(B_Event_1.__ST33316_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE902005 := JOIN(__EE901986,__EE899861,__JC902004(RIGHT,LEFT),__JT902004(RIGHT,LEFT),INNER,HASH);
  SHARED __ST888113_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST888113_Layout __ND902422__Project(__ST891450_Layout __PP902006) := TRANSFORM
    SELF.UID := __PP902006.Ip_;
    SELF._r_Customer_ := __PP902006._r_Customer__1_;
    SELF.Event_Date_ := __PP902006.Event_Date__1_;
    SELF.U_I_D__1_ := __PP902006.UID;
    SELF.Event_Date__1_ := __PP902006.Event_Date_;
    SELF._r_Customer__1_ := __PP902006._r_Customer_;
    SELF := __PP902006;
  END;
  SHARED __EE904051 := PROJECT(__EE902005,__ND902422__Project(LEFT));
  SHARED __ST889042_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST889042_Layout __ND905358__Project(__ST888113_Layout __PP904052) := TRANSFORM
    SELF.Exp1_ := __PP904052.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP904052.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP904052.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP904052.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP904052.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP904052.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP904052.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP904052.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP904052.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP904052.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP904052.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP904052.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP904052.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP904052.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP904052.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP904052.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP904052.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP904052.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP904052.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP904052.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP904052.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP904052.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP904052.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP904052.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP904052.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP904052.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP904052.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP904052.Event_Age_,<,__CN(2)),__CN(__PP904052.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP904052.Event_Age_,<,__CN(366));
    SELF := __PP904052;
  END;
  SHARED __EE905397 := PROJECT(__EE904051,__ND905358__Project(LEFT));
  SHARED __ST889208_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE905571 := PROJECT(__CLEANANDDO(__EE905397,TABLE(__EE905397,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE905397.Exp1_),KEL.Aggregates.MinNG(__EE905397.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE905397.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE905397.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE905397.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE905397.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE905397.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE905397.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE905397.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE905397.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE905397.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE905397.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE905397.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE905397.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE905397.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE905397.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE905397.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE905397.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE905397.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE905397.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE905397.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE905397.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE905397.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE905397.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE905397.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE905397.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE905397.Exp25_),KEL.Aggregates.MaxNG(__EE905397.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE905397.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE905397.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE905397.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE905397.Exp29_)),UID},UID,MERGE)),__ST889208_Layout);
  SHARED __ST894106_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC905577(__ST893510_Layout __EE899901, __ST889208_Layout __EE905571) := __EEQP(__EE899901.UID,__EE905571.UID);
  __ST894106_Layout __JT905577(__ST893510_Layout __l, __ST889208_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE905703 := JOIN(__EE899901,__EE905571,__JC905577(LEFT,RIGHT),__JT905577(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE832679 := __ENH_Customer_1;
  SHARED __ST894846_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC905709(__ST894106_Layout __EE905703, B_Customer_1.__ST30473_Layout __EE832679) := __EEQP(__EE905703._r_Customer_,__EE832679.UID);
  __ST894846_Layout __JT905709(__ST894106_Layout __l, B_Customer_1.__ST30473_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE905857 := JOIN(__EE905703,__EE832679,__JC905709(LEFT,RIGHT),__JT905709(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST27182_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST27182_Layout __ND905862__Project(__ST894846_Layout __PP905858) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP905858.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP905858.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP905858.C_O_U_N_T___Person_Ip_Address_;
    __BS906155 := __T(__PP905858.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS906155(__T(__OP2(__T(__PP905858.Source_Customers_)._r_Source_Customer_,=,__PP905858._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP905858.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP905858.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP905858.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP905858.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP905858.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP905858.Ip_Address_;
    SELF.Last_Event_Date_ := __PP905858.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP905858.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP905858.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP905858.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP905858.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP905858.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP905858.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP905858.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP905858.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP905858.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP905858;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE905857,__ND905862__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE1285123 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1285123._r_Customer_;
    __EE1285123.Source_Customers_;
    __EE1285123.Ip_Address_;
    __EE1285123.Otto_Ip_Address_Id_;
    __EE1285123._host_;
    __EE1285123._alias_;
    __EE1285123._location_;
    __EE1285123._ip__address_;
    __EE1285123._ip__address__date_;
    __EE1285123._version_;
    __EE1285123._class_;
    __EE1285123._subnet__mask_;
    __EE1285123._reserved_;
    __EE1285123._isp_;
    __EE1285123._v2__validationipproblems_;
    __EE1285123._v2__ipstate_;
    __EE1285123._v2__ipcountry_;
    __EE1285123._v2__ipcontinent_;
    __EE1285123._iprngbeg_;
    __EE1285123._iprngend_;
    __EE1285123._edgecountry_;
    __EE1285123._edgeregion_;
    __EE1285123._edgecity_;
    __EE1285123._edgeconnspeed_;
    __EE1285123._edgemetrocode_;
    __EE1285123._edgelatitude_;
    __EE1285123._edgelongitude_;
    __EE1285123._edgepostalcode_;
    __EE1285123._edgecountrycode_;
    __EE1285123._edgeregioncode_;
    __EE1285123._edgecitycode_;
    __EE1285123._edgecontinentcode_;
    __EE1285123._edgetwolettercountry_;
    __EE1285123._edgeinternalcode_;
    __EE1285123._edgeareacodes_;
    __EE1285123._edgecountryconf_;
    __EE1285123._edgeregionconf_;
    __EE1285123._edgecitycong_;
    __EE1285123._edgepostalconf_;
    __EE1285123._edgegmtoffset_;
    __EE1285123._edgeindst_;
    __EE1285123._siccode_;
    __EE1285123._domainname_;
    __EE1285123._ispname_;
    __EE1285123._homebiztype_;
    __EE1285123._asn_;
    __EE1285123._asnname_;
    __EE1285123._primarylang_;
    __EE1285123._secondarylang_;
    __EE1285123._proxytype_;
    __EE1285123._proxydescription_;
    __EE1285123._isanisp_;
    __EE1285123._companyname_;
    __EE1285123._ranks_;
    __EE1285123._households_;
    __EE1285123._women_;
    __EE1285123._women18to34_;
    __EE1285123._women35to49_;
    __EE1285123._men_;
    __EE1285123._men18to34_;
    __EE1285123._men35to49_;
    __EE1285123._teens_;
    __EE1285123._kids_;
    __EE1285123._naicscode_;
    __EE1285123._cbsacode_;
    __EE1285123._cbsatitle_;
    __EE1285123._cbsatype_;
    __EE1285123._csacode_;
    __EE1285123._csatitle_;
    __EE1285123._mdcode_;
    __EE1285123._mdtitle_;
    __EE1285123._organizationname_;
    __EE1285123.Customer_Id_;
    __EE1285123.Industry_Type_;
    __EE1285123.Source_Customer_Count_;
    __EE1285123.Entity_Context_Uid_;
    __EE1285123.Label_;
    __EE1285123.Entity_Type_;
    __EE1285123.In_Customer_Population_;
    __EE1285123.Dt_First_Seen_;
    __EE1285123.Dt_Last_Seen_;
    __EE1285123.Last_Record_Id_;
    __EE1285123.Identity_Count_;
    __EE1285123.Event_Count_;
    __EE1285123.Ip_Not_Us_;
    __EE1285123.Ip_Vpn_;
    __EE1285123.Ip_High_Risk_City_;
    __EE1285123.Ip_Hosted_;
    __EE1285123.Ip_Tor_;
    __EE1285123.Kr_High_Risk_Flag_;
    __EE1285123.Kr_Medium_Risk_Flag_;
    __EE1285123.Kr_Low_Risk_Flag_;
    __EE1285123.Kr_Flag_;
    __EE1285123.Safe_Flag_;
    __EE1285123.Contributor_Safe_Flag_;
    __EE1285123.Kr_Ip600_Flag_;
    __EE1285123.Kr_Ip601_Flag_;
    __EE1285123.Kr_Ip602_Flag_;
    __EE1285123.Kr_Ip603_Flag_;
    __EE1285123.Kr_Ip604_Flag_;
    __EE1285123.Kr_Ip605_Flag_;
    __EE1285123.Kr_Ip690_Flag_;
    __EE1285123.Kr_Ip691_Flag_;
    __EE1285123.Kr_Ip692_Flag_;
    __EE1285123.Kr_Ip693_Flag_;
    __EE1285123.Kr_Ip1000_Flag_;
    __EE1285123.Kr_Ip1001_Flag_;
    __EE1285123.Kr_Ip1090_Flag_;
    __EE1285123.Kr_Ip1091_Flag_;
    __EE1285123.Kr_Ip1092_Flag_;
    __EE1285123.Kr_Ip1093_Flag_;
    __EE1285123.Last_Event_Date_;
    __EE1285123.Kr_Last_Event_Date_;
    __EE1285123.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1285123.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1285123.Vl_Event1_All_Count_;
    __EE1285123.Vl_Event7_All_Count_;
    __EE1285123.Vl_Event30_All_Day_Count_;
    __EE1285123.Vl_Event365_All_Day_Count_;
    __EE1285123.Vl_Event7_All_Active_Flag_;
    __EE1285123.Vl_Event30_All_Active_Flag_;
    __EE1285123.Vl_Event1_Count_;
    __EE1285123.Vl_Event7_Count_;
    __EE1285123.Vl_Event30_Count_;
    __EE1285123.Vl_Event365_Count_;
    __EE1285123.Vl_Event7_Active_Flag_;
    __EE1285123.Vl_Event30_Active_Flag_;
    __EE1285123.Date_First_Seen_;
    __EE1285123.Date_Last_Seen_;
    __EE1285123.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE1285123,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1285125_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST27182_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
