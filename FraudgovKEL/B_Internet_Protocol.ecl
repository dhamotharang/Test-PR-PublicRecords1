...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE3642143 := __ENH_Internet_Protocol_1;
  SHARED __EE3731165 := __E_Person_Ip_Address;
  SHARED __EE3731172 := __EE3731165(__NN(__EE3731165.Ip_));
  SHARED __ST3718609_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3731186 := PROJECT(TABLE(PROJECT(__EE3731172,TRANSFORM(__ST3718609_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST3718609_Layout);
  SHARED __ST3718627_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3731152 := PROJECT(__CLEANANDDO(__EE3731186,TABLE(__EE3731186,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST3718627_Layout);
  SHARED __ST3722706_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3731195(B_Internet_Protocol_1.__ST79347_Layout __EE3642143, __ST3718627_Layout __EE3731152) := __EEQP(__EE3642143.UID,__EE3731152.UID);
  __ST3722706_Layout __JT3731195(B_Internet_Protocol_1.__ST79347_Layout __l, __ST3718627_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3731196 := JOIN(__EE3642143,__EE3731152,__JC3731195(LEFT,RIGHT),__JT3731195(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3731156 := __ENH_Event_1;
  SHARED __EE3731154 := __E_Internet_Protocol_Event;
  SHARED __EE3734419 := __EE3731154(__NN(__EE3731154.Ip_) AND __NN(__EE3731154.Transaction_));
  SHARED __ST3719236_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3734437(B_Event_1.__ST78136_Layout __EE3731156, E_Internet_Protocol_Event.Layout __EE3734419) := __EEQP(__EE3734419.Transaction_,__EE3731156.UID);
  __ST3719236_Layout __JT3734437(B_Event_1.__ST78136_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3734438 := JOIN(__EE3734419,__EE3731156,__JC3734437(RIGHT,LEFT),__JT3734437(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3714655_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3714655_Layout __ND3735137__Project(__ST3719236_Layout __PP3734439) := TRANSFORM
    SELF.UID := __PP3734439.Ip_;
    SELF._r_Customer_ := __PP3734439._r_Customer__1_;
    SELF.Event_Date_ := __PP3734439.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3734439.UID;
    SELF.Event_Date__1_ := __PP3734439.Event_Date_;
    SELF._r_Customer__1_ := __PP3734439._r_Customer_;
    SELF := __PP3734439;
  END;
  SHARED __EE3737894 := PROJECT(__EE3734438,__ND3735137__Project(LEFT));
  SHARED __ST3716150_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3716150_Layout __ND3739389__Project(__ST3714655_Layout __PP3737895) := TRANSFORM
    SELF.Exp1_ := __PP3737895.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP3737895.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP3737895.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP3737895.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP3737895.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP3737895.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP3737895.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP3737895.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP3737895.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP3737895.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP3737895.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP3737895.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP3737895.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP3737895.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP3737895.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP3737895.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP3737895.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP3737895.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP3737895.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP3737895.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP3737895.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP3737895.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP3737895.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP3737895.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP3737895.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP3737895.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP3737895.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP3737895.Safe_Flag_ = 1;
    SELF.Exp28_ := __OP2(__PP3737895.Event_Age_,<,__CN(2));
    SELF.Exp29_ := __AND(__OP2(__PP3737895.Event_Age_,<,__CN(2)),__CN(__PP3737895.In_Customer_Population_ = 1));
    SELF.Exp30_ := __OP2(__PP3737895.Event_Age_,<,__CN(366));
    SELF := __PP3737895;
  END;
  SHARED __EE3739429 := PROJECT(__EE3737894,__ND3739389__Project(LEFT));
  SHARED __ST3716318_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3739603 := PROJECT(__CLEANANDDO(__EE3739429,TABLE(__EE3739429,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3739429.Exp1_),KEL.Aggregates.MaxNG(__EE3739429.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE3739429.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3739429.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3739429.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3739429.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3739429.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3739429.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3739429.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3739429.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3739429.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3739429.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3739429.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3739429.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3739429.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3739429.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE3739429.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE3739429.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE3739429.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE3739429.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE3739429.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE3739429.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE3739429.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE3739429.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE3739429.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE3739429.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE3739429.Exp26_),KEL.Aggregates.MaxNG(__EE3739429.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE3739429.Exp27_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE3739429.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE3739429.Exp29_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE3739429.Exp30_)),UID},UID,MERGE)),__ST3716318_Layout);
  SHARED __ST3723432_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3739609(__ST3722706_Layout __EE3731196, __ST3716318_Layout __EE3739603) := __EEQP(__EE3731196.UID,__EE3739603.UID);
  __ST3723432_Layout __JT3739609(__ST3722706_Layout __l, __ST3716318_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3739760 := JOIN(__EE3731196,__EE3739603,__JC3739609(LEFT,RIGHT),__JT3739609(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3622468 := __ENH_Customer_1;
  SHARED __ST3724302_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3739766(__ST3723432_Layout __EE3739760, B_Customer_1.__ST69954_Layout __EE3622468) := __EEQP(__EE3739760._r_Customer_,__EE3622468.UID);
  __ST3724302_Layout __JT3739766(__ST3723432_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3739939 := JOIN(__EE3739760,__EE3622468,__JC3739766(LEFT,RIGHT),__JT3739766(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST64537_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST64537_Layout __ND3739944__Project(__ST3724302_Layout __PP3739940) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP3739940.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP3739940.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP3739940.M_I_N___Event_Date__1_;
    SELF.Identity_Count_ := __PP3739940.C_O_U_N_T___Person_Ip_Address_;
    __BS3740317 := __T(__PP3739940.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3740317(__T(__OP2(__T(__PP3739940.Source_Customers_)._r_Source_Customer_,=,__PP3739940._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP3739940.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP3739940.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP3739940.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP3739940.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP3739940.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP3739940.Ip_Address_;
    SELF.Last_Event_Date_ := __PP3739940.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP3739940.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3739940.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3739940.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP3739940.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3739940.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3739940.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3739940.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3739940.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3739940.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3739940;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE3739939,__ND3739944__Project(LEFT)) : PERSIST('~fraudgov::tempKEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4314306 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4314306._r_Customer_;
    __EE4314306.Source_Customers_;
    __EE4314306.Ip_Address_;
    __EE4314306.Otto_Ip_Address_Id_;
    __EE4314306._host_;
    __EE4314306._alias_;
    __EE4314306._location_;
    __EE4314306._ip__address_;
    __EE4314306._ip__address__date_;
    __EE4314306._version_;
    __EE4314306._class_;
    __EE4314306._subnet__mask_;
    __EE4314306._reserved_;
    __EE4314306._isp_;
    __EE4314306._v2__validationipproblems_;
    __EE4314306._v2__ipstate_;
    __EE4314306._v2__ipcountry_;
    __EE4314306._v2__ipcontinent_;
    __EE4314306._iprngbeg_;
    __EE4314306._iprngend_;
    __EE4314306._edgecountry_;
    __EE4314306._edgeregion_;
    __EE4314306._edgecity_;
    __EE4314306._edgeconnspeed_;
    __EE4314306._edgemetrocode_;
    __EE4314306._edgelatitude_;
    __EE4314306._edgelongitude_;
    __EE4314306._edgepostalcode_;
    __EE4314306._edgecountrycode_;
    __EE4314306._edgeregioncode_;
    __EE4314306._edgecitycode_;
    __EE4314306._edgecontinentcode_;
    __EE4314306._edgetwolettercountry_;
    __EE4314306._edgeinternalcode_;
    __EE4314306._edgeareacodes_;
    __EE4314306._edgecountryconf_;
    __EE4314306._edgeregionconf_;
    __EE4314306._edgecitycong_;
    __EE4314306._edgepostalconf_;
    __EE4314306._edgegmtoffset_;
    __EE4314306._edgeindst_;
    __EE4314306._siccode_;
    __EE4314306._domainname_;
    __EE4314306._ispname_;
    __EE4314306._homebiztype_;
    __EE4314306._asn_;
    __EE4314306._asnname_;
    __EE4314306._primarylang_;
    __EE4314306._secondarylang_;
    __EE4314306._proxytype_;
    __EE4314306._proxydescription_;
    __EE4314306._isanisp_;
    __EE4314306._companyname_;
    __EE4314306._ranks_;
    __EE4314306._households_;
    __EE4314306._women_;
    __EE4314306._women18to34_;
    __EE4314306._women35to49_;
    __EE4314306._men_;
    __EE4314306._men18to34_;
    __EE4314306._men35to49_;
    __EE4314306._teens_;
    __EE4314306._kids_;
    __EE4314306._naicscode_;
    __EE4314306._cbsacode_;
    __EE4314306._cbsatitle_;
    __EE4314306._cbsatype_;
    __EE4314306._csacode_;
    __EE4314306._csatitle_;
    __EE4314306._mdcode_;
    __EE4314306._mdtitle_;
    __EE4314306._organizationname_;
    __EE4314306.Aot_Act_Cnt_Ev_;
    __EE4314306.Aot_Src1_Act_Cnt_Ev_;
    __EE4314306.Aot_Src1_Act_Only_Flag_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4314306.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4314306.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4314306.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4314306.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4314306.Aot_Id_Act_Cnt_Ev_;
    __EE4314306.Aot_Id_Act_Cnt30_D_;
    __EE4314306.Aot_Add_Act_Cnt_Ev_;
    __EE4314306.Aot_Add_Act_Cnt30_D_;
    __EE4314306.Aot_Non_St_Act_Cnt_Ev_;
    __EE4314306.Aot_Non_St_Act_Cnt30_D_;
    __EE4314306.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4314306.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4314306.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4314306.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4314306.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4314306.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4314306.Customer_Id_;
    __EE4314306.Industry_Type_;
    __EE4314306.Source_Customer_Count_;
    __EE4314306.Entity_Context_Uid_;
    __EE4314306.Label_;
    __EE4314306.Entity_Type_;
    __EE4314306.In_Customer_Population_;
    __EE4314306.Dt_First_Seen_;
    __EE4314306.Dt_Last_Seen_;
    __EE4314306.Id_Activity_Dt_First_Seen_;
    __EE4314306.Id_Activity_Dt_Last_Seen_;
    __EE4314306.Last_Record_Id_;
    __EE4314306.Identity_Count_;
    __EE4314306.Event_Count_;
    __EE4314306.Ip_Not_Us_;
    __EE4314306.Ip_Vpn_;
    __EE4314306.Ip_High_Risk_City_;
    __EE4314306.Ip_Hosted_;
    __EE4314306.Ip_Tor_;
    __EE4314306.Kr_High_Risk_Flag_;
    __EE4314306.Kr_Medium_Risk_Flag_;
    __EE4314306.Kr_Low_Risk_Flag_;
    __EE4314306.Kr_Flag_;
    __EE4314306.Safe_Flag_;
    __EE4314306.Contributor_Safe_Flag_;
    __EE4314306.Kr_Ip600_Flag_;
    __EE4314306.Kr_Ip601_Flag_;
    __EE4314306.Kr_Ip602_Flag_;
    __EE4314306.Kr_Ip603_Flag_;
    __EE4314306.Kr_Ip604_Flag_;
    __EE4314306.Kr_Ip605_Flag_;
    __EE4314306.Kr_Ip690_Flag_;
    __EE4314306.Kr_Ip691_Flag_;
    __EE4314306.Kr_Ip692_Flag_;
    __EE4314306.Kr_Ip693_Flag_;
    __EE4314306.Kr_Ip1000_Flag_;
    __EE4314306.Kr_Ip1001_Flag_;
    __EE4314306.Kr_Ip1090_Flag_;
    __EE4314306.Kr_Ip1091_Flag_;
    __EE4314306.Kr_Ip1092_Flag_;
    __EE4314306.Kr_Ip1093_Flag_;
    __EE4314306.Last_Event_Date_;
    __EE4314306.Kr_Last_Event_Date_;
    __EE4314306.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4314306.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4314306.Vl_Event1_All_Count_;
    __EE4314306.Vl_Event7_All_Count_;
    __EE4314306.Vl_Event30_All_Day_Count_;
    __EE4314306.Vl_Event365_All_Day_Count_;
    __EE4314306.Vl_Event7_All_Active_Flag_;
    __EE4314306.Vl_Event30_All_Active_Flag_;
    __EE4314306.Vl_Event1_Count_;
    __EE4314306.Vl_Event7_Count_;
    __EE4314306.Vl_Event30_Count_;
    __EE4314306.Vl_Event365_Count_;
    __EE4314306.Vl_Event7_Active_Flag_;
    __EE4314306.Vl_Event30_Active_Flag_;
    __EE4314306.Date_First_Seen_;
    __EE4314306.Date_Last_Seen_;
    __EE4314306.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4314306,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4314308_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST64537_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
