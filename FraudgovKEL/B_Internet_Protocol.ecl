...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE4141918 := __ENH_Internet_Protocol_1;
  SHARED __EE4233815 := __E_Person_Ip_Address;
  SHARED __EE4233822 := __EE4233815(__NN(__EE4233815.Ip_));
  SHARED __ST4221009_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4233836 := PROJECT(TABLE(PROJECT(__EE4233822,TRANSFORM(__ST4221009_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST4221009_Layout);
  SHARED __ST4221027_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4233802 := PROJECT(__CLEANANDDO(__EE4233836,TABLE(__EE4233836,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST4221027_Layout);
  SHARED __ST4225231_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4233845(B_Internet_Protocol_1.__ST84682_Layout __EE4141918, __ST4221027_Layout __EE4233802) := __EEQP(__EE4141918.UID,__EE4233802.UID);
  __ST4225231_Layout __JT4233845(B_Internet_Protocol_1.__ST84682_Layout __l, __ST4221027_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4233846 := JOIN(__EE4141918,__EE4233802,__JC4233845(LEFT,RIGHT),__JT4233845(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4233806 := __ENH_Event_1;
  SHARED __EE4233804 := __E_Internet_Protocol_Event;
  SHARED __EE4237169 := __EE4233804(__NN(__EE4233804.Ip_) AND __NN(__EE4233804.Transaction_));
  SHARED __ST4221636_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4237187(B_Event_1.__ST83458_Layout __EE4233806, E_Internet_Protocol_Event.Layout __EE4237169) := __EEQP(__EE4237169.Transaction_,__EE4233806.UID);
  __ST4221636_Layout __JT4237187(B_Event_1.__ST83458_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4237188 := JOIN(__EE4237169,__EE4233806,__JC4237187(RIGHT,LEFT),__JT4237187(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4216955_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4216955_Layout __ND4237912__Project(__ST4221636_Layout __PP4237189) := TRANSFORM
    SELF.UID := __PP4237189.Ip_;
    SELF._r_Customer_ := __PP4237189._r_Customer__1_;
    SELF.Event_Date_ := __PP4237189.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4237189.UID;
    SELF.Event_Date__1_ := __PP4237189.Event_Date_;
    SELF._r_Customer__1_ := __PP4237189._r_Customer_;
    SELF := __PP4237189;
  END;
  SHARED __EE4240769 := PROJECT(__EE4237188,__ND4237912__Project(LEFT));
  SHARED __ST4218500_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4218500_Layout __ND4242264__Project(__ST4216955_Layout __PP4240770) := TRANSFORM
    SELF.Exp1_ := __PP4240770.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4240770.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4240770.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4240770.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP4240770.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP4240770.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP4240770.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP4240770.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP4240770.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP4240770.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP4240770.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP4240770.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP4240770.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP4240770.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP4240770.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP4240770.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP4240770.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP4240770.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP4240770.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP4240770.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP4240770.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP4240770.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP4240770.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP4240770.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP4240770.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP4240770.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP4240770.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP4240770.Safe_Flag_ = 1;
    SELF.Exp28_ := __OP2(__PP4240770.Event_Age_,<,__CN(2));
    SELF.Exp29_ := __AND(__OP2(__PP4240770.Event_Age_,<,__CN(2)),__CN(__PP4240770.In_Customer_Population_ = 1));
    SELF.Exp30_ := __OP2(__PP4240770.Event_Age_,<,__CN(366));
    SELF := __PP4240770;
  END;
  SHARED __EE4242304 := PROJECT(__EE4240769,__ND4242264__Project(LEFT));
  SHARED __ST4218668_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4242478 := PROJECT(__CLEANANDDO(__EE4242304,TABLE(__EE4242304,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4242304.Exp1_),KEL.Aggregates.MinNG(__EE4242304.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4242304.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4242304.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4242304.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4242304.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4242304.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4242304.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4242304.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4242304.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4242304.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4242304.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4242304.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4242304.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4242304.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4242304.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE4242304.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE4242304.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE4242304.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE4242304.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE4242304.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE4242304.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE4242304.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE4242304.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE4242304.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE4242304.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE4242304.Exp26_),KEL.Aggregates.MaxNG(__EE4242304.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE4242304.Exp27_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE4242304.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE4242304.Exp29_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE4242304.Exp30_)),UID},UID,MERGE)),__ST4218668_Layout);
  SHARED __ST4225957_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4242484(__ST4225231_Layout __EE4233846, __ST4218668_Layout __EE4242478) := __EEQP(__EE4233846.UID,__EE4242478.UID);
  __ST4225957_Layout __JT4242484(__ST4225231_Layout __l, __ST4218668_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4242635 := JOIN(__EE4233846,__EE4242478,__JC4242484(LEFT,RIGHT),__JT4242484(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4121643 := __ENH_Customer_1;
  SHARED __ST4226827_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4242641(__ST4225957_Layout __EE4242635, B_Customer_1.__ST74526_Layout __EE4121643) := __EEQP(__EE4242635._r_Customer_,__EE4121643.UID);
  __ST4226827_Layout __JT4242641(__ST4225957_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4242814 := JOIN(__EE4242635,__EE4121643,__JC4242641(LEFT,RIGHT),__JT4242641(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST69217_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST69217_Layout __ND4242819__Project(__ST4226827_Layout __PP4242815) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4242815.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP4242815.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4242815.M_I_N___Event_Date__2_;
    SELF.Identity_Count_ := __PP4242815.C_O_U_N_T___Person_Ip_Address_;
    __BS4243192 := __T(__PP4242815.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4243192(__T(__OP2(__T(__PP4242815.Source_Customers_)._r_Source_Customer_,=,__PP4242815._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP4242815.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP4242815.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP4242815.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP4242815.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP4242815.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP4242815.Ip_Address_;
    SELF.Last_Event_Date_ := __PP4242815.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4242815.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4242815.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4242815.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP4242815.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4242815.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4242815.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4242815.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4242815.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP4242815.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP4242815;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE4242814,__ND4242819__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4831936 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4831936._r_Customer_;
    __EE4831936.Source_Customers_;
    __EE4831936.Ip_Address_;
    __EE4831936.Otto_Ip_Address_Id_;
    __EE4831936._host_;
    __EE4831936._alias_;
    __EE4831936._location_;
    __EE4831936._ip__address_;
    __EE4831936._ip__address__date_;
    __EE4831936._version_;
    __EE4831936._class_;
    __EE4831936._subnet__mask_;
    __EE4831936._reserved_;
    __EE4831936._isp_;
    __EE4831936._v2__validationipproblems_;
    __EE4831936._v2__ipstate_;
    __EE4831936._v2__ipcountry_;
    __EE4831936._v2__ipcontinent_;
    __EE4831936._iprngbeg_;
    __EE4831936._iprngend_;
    __EE4831936._edgecountry_;
    __EE4831936._edgeregion_;
    __EE4831936._edgecity_;
    __EE4831936._edgeconnspeed_;
    __EE4831936._edgemetrocode_;
    __EE4831936._edgelatitude_;
    __EE4831936._edgelongitude_;
    __EE4831936._edgepostalcode_;
    __EE4831936._edgecountrycode_;
    __EE4831936._edgeregioncode_;
    __EE4831936._edgecitycode_;
    __EE4831936._edgecontinentcode_;
    __EE4831936._edgetwolettercountry_;
    __EE4831936._edgeinternalcode_;
    __EE4831936._edgeareacodes_;
    __EE4831936._edgecountryconf_;
    __EE4831936._edgeregionconf_;
    __EE4831936._edgecitycong_;
    __EE4831936._edgepostalconf_;
    __EE4831936._edgegmtoffset_;
    __EE4831936._edgeindst_;
    __EE4831936._siccode_;
    __EE4831936._domainname_;
    __EE4831936._ispname_;
    __EE4831936._homebiztype_;
    __EE4831936._asn_;
    __EE4831936._asnname_;
    __EE4831936._primarylang_;
    __EE4831936._secondarylang_;
    __EE4831936._proxytype_;
    __EE4831936._proxydescription_;
    __EE4831936._isanisp_;
    __EE4831936._companyname_;
    __EE4831936._ranks_;
    __EE4831936._households_;
    __EE4831936._women_;
    __EE4831936._women18to34_;
    __EE4831936._women35to49_;
    __EE4831936._men_;
    __EE4831936._men18to34_;
    __EE4831936._men35to49_;
    __EE4831936._teens_;
    __EE4831936._kids_;
    __EE4831936._naicscode_;
    __EE4831936._cbsacode_;
    __EE4831936._cbsatitle_;
    __EE4831936._cbsatype_;
    __EE4831936._csacode_;
    __EE4831936._csatitle_;
    __EE4831936._mdcode_;
    __EE4831936._mdtitle_;
    __EE4831936._organizationname_;
    __EE4831936.Aot_Act_Cnt_Ev_;
    __EE4831936.Aot_Src1_Act_Cnt_Ev_;
    __EE4831936.Aot_Src1_Act_Only_Flag_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4831936.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4831936.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4831936.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4831936.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4831936.Aot_Id_Act_Cnt_Ev_;
    __EE4831936.Aot_Id_Act_Cnt30_D_;
    __EE4831936.Aot_Add_Act_Cnt_Ev_;
    __EE4831936.Aot_Add_Act_Cnt30_D_;
    __EE4831936.Aot_Non_St_Act_Cnt_Ev_;
    __EE4831936.Aot_Non_St_Act_Cnt30_D_;
    __EE4831936.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4831936.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4831936.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4831936.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4831936.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4831936.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4831936.Customer_Id_;
    __EE4831936.Industry_Type_;
    __EE4831936.Source_Customer_Count_;
    __EE4831936.Entity_Context_Uid_;
    __EE4831936.Label_;
    __EE4831936.Entity_Type_;
    __EE4831936.In_Customer_Population_;
    __EE4831936.Dt_First_Seen_;
    __EE4831936.Dt_Last_Seen_;
    __EE4831936.Id_Activity_Dt_First_Seen_;
    __EE4831936.Id_Activity_Dt_Last_Seen_;
    __EE4831936.Last_Record_Id_;
    __EE4831936.Identity_Count_;
    __EE4831936.Event_Count_;
    __EE4831936.Ip_Not_Us_;
    __EE4831936.Ip_Vpn_;
    __EE4831936.Ip_High_Risk_City_;
    __EE4831936.Ip_Hosted_;
    __EE4831936.Ip_Tor_;
    __EE4831936.Kr_High_Risk_Flag_;
    __EE4831936.Kr_Medium_Risk_Flag_;
    __EE4831936.Kr_Low_Risk_Flag_;
    __EE4831936.Kr_Flag_;
    __EE4831936.Safe_Flag_;
    __EE4831936.Contributor_Safe_Flag_;
    __EE4831936.Kr_Ip600_Flag_;
    __EE4831936.Kr_Ip601_Flag_;
    __EE4831936.Kr_Ip602_Flag_;
    __EE4831936.Kr_Ip603_Flag_;
    __EE4831936.Kr_Ip604_Flag_;
    __EE4831936.Kr_Ip605_Flag_;
    __EE4831936.Kr_Ip690_Flag_;
    __EE4831936.Kr_Ip691_Flag_;
    __EE4831936.Kr_Ip692_Flag_;
    __EE4831936.Kr_Ip693_Flag_;
    __EE4831936.Kr_Ip1000_Flag_;
    __EE4831936.Kr_Ip1001_Flag_;
    __EE4831936.Kr_Ip1090_Flag_;
    __EE4831936.Kr_Ip1091_Flag_;
    __EE4831936.Kr_Ip1092_Flag_;
    __EE4831936.Kr_Ip1093_Flag_;
    __EE4831936.Last_Event_Date_;
    __EE4831936.Kr_Last_Event_Date_;
    __EE4831936.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4831936.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4831936.Vl_Event1_All_Count_;
    __EE4831936.Vl_Event7_All_Count_;
    __EE4831936.Vl_Event30_All_Day_Count_;
    __EE4831936.Vl_Event365_All_Day_Count_;
    __EE4831936.Vl_Event7_All_Active_Flag_;
    __EE4831936.Vl_Event30_All_Active_Flag_;
    __EE4831936.Vl_Event1_Count_;
    __EE4831936.Vl_Event7_Count_;
    __EE4831936.Vl_Event30_Count_;
    __EE4831936.Vl_Event365_Count_;
    __EE4831936.Vl_Event7_Active_Flag_;
    __EE4831936.Vl_Event30_Active_Flag_;
    __EE4831936.Date_First_Seen_;
    __EE4831936.Date_Last_Seen_;
    __EE4831936.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4831936,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4831938_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST69217_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
