...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE855739 := __ENH_Internet_Protocol_1;
  SHARED __EE910754 := __E_Person_Ip_Address;
  SHARED __EE910761 := __EE910754(__NN(__EE910754.Ip_));
  SHARED __ST901710_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE910775 := PROJECT(TABLE(PROJECT(__EE910761,TRANSFORM(__ST901710_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST901710_Layout);
  SHARED __ST901728_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE910741 := PROJECT(__CLEANANDDO(__EE910775,TABLE(__EE910775,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST901728_Layout);
  SHARED __ST904367_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC910784(B_Internet_Protocol_1.__ST33936_Layout __EE855739, __ST901728_Layout __EE910741) := __EEQP(__EE855739.UID,__EE910741.UID);
  __ST904367_Layout __JT910784(B_Internet_Protocol_1.__ST33936_Layout __l, __ST901728_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE910785 := JOIN(__EE855739,__EE910741,__JC910784(LEFT,RIGHT),__JT910784(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE910745 := __ENH_Event_1;
  SHARED __EE910743 := __E_Internet_Protocol_Event;
  SHARED __EE912894 := __EE910743(__NN(__EE910743.Ip_) AND __NN(__EE910743.Transaction_));
  SHARED __ST902277_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC912912(B_Event_1.__ST33354_Layout __EE910745, E_Internet_Protocol_Event.Layout __EE912894) := __EEQP(__EE912894.Transaction_,__EE910745.UID);
  __ST902277_Layout __JT912912(B_Event_1.__ST33354_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE912913 := JOIN(__EE912894,__EE910745,__JC912912(RIGHT,LEFT),__JT912912(RIGHT,LEFT),INNER,HASH);
  SHARED __ST898916_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST898916_Layout __ND913336__Project(__ST902277_Layout __PP912914) := TRANSFORM
    SELF.UID := __PP912914.Ip_;
    SELF._r_Customer_ := __PP912914._r_Customer__1_;
    SELF.Event_Date_ := __PP912914.Event_Date__1_;
    SELF.U_I_D__1_ := __PP912914.UID;
    SELF.Event_Date__1_ := __PP912914.Event_Date_;
    SELF._r_Customer__1_ := __PP912914._r_Customer_;
    SELF := __PP912914;
  END;
  SHARED __EE914989 := PROJECT(__EE912913,__ND913336__Project(LEFT));
  SHARED __ST899857_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST899857_Layout __ND916294__Project(__ST898916_Layout __PP914990) := TRANSFORM
    SELF.Exp1_ := __PP914990.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP914990.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP914990.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP914990.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP914990.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP914990.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP914990.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP914990.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP914990.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP914990.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP914990.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP914990.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP914990.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP914990.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP914990.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP914990.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP914990.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP914990.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP914990.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP914990.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP914990.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP914990.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP914990.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP914990.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP914990.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP914990.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP914990.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP914990.Event_Age_,<,__CN(2)),__CN(__PP914990.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP914990.Event_Age_,<,__CN(366));
    SELF := __PP914990;
  END;
  SHARED __EE916333 := PROJECT(__EE914989,__ND916294__Project(LEFT));
  SHARED __ST900023_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE916507 := PROJECT(__CLEANANDDO(__EE916333,TABLE(__EE916333,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE916333.Exp1_),KEL.Aggregates.MinNG(__EE916333.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE916333.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE916333.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE916333.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE916333.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE916333.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE916333.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE916333.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE916333.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE916333.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE916333.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE916333.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE916333.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE916333.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE916333.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE916333.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE916333.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE916333.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE916333.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE916333.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE916333.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE916333.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE916333.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE916333.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE916333.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE916333.Exp25_),KEL.Aggregates.MaxNG(__EE916333.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE916333.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE916333.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE916333.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE916333.Exp29_)),UID},UID,MERGE)),__ST900023_Layout);
  SHARED __ST904963_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC916513(__ST904367_Layout __EE910785, __ST900023_Layout __EE916507) := __EEQP(__EE910785.UID,__EE916507.UID);
  __ST904963_Layout __JT916513(__ST904367_Layout __l, __ST900023_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE916638 := JOIN(__EE910785,__EE916507,__JC916513(LEFT,RIGHT),__JT916513(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE842749 := __ENH_Customer_1;
  SHARED __ST905703_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC916644(__ST904963_Layout __EE916638, B_Customer_1.__ST30513_Layout __EE842749) := __EEQP(__EE916638._r_Customer_,__EE842749.UID);
  __ST905703_Layout __JT916644(__ST904963_Layout __l, B_Customer_1.__ST30513_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE916791 := JOIN(__EE916638,__EE842749,__JC916644(LEFT,RIGHT),__JT916644(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST27230_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST27230_Layout __ND916796__Project(__ST905703_Layout __PP916792) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP916792.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP916792.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP916792.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP916792.C_O_U_N_T___Person_Ip_Address_;
    __BS917091 := __T(__PP916792.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS917091(__T(__OP2(__T(__PP916792.Source_Customers_)._r_Source_Customer_,=,__PP916792._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP916792.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP916792.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP916792.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP916792.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP916792.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP916792.Ip_Address_;
    SELF.Last_Event_Date_ := __PP916792.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP916792.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP916792.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP916792.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP916792.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP916792.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP916792.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP916792.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP916792.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP916792.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP916792;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE916791,__ND916796__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE1299308 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1299308._r_Customer_;
    __EE1299308.Source_Customers_;
    __EE1299308.Ip_Address_;
    __EE1299308.Otto_Ip_Address_Id_;
    __EE1299308._host_;
    __EE1299308._alias_;
    __EE1299308._location_;
    __EE1299308._ip__address_;
    __EE1299308._ip__address__date_;
    __EE1299308._version_;
    __EE1299308._class_;
    __EE1299308._subnet__mask_;
    __EE1299308._reserved_;
    __EE1299308._isp_;
    __EE1299308._v2__validationipproblems_;
    __EE1299308._v2__ipstate_;
    __EE1299308._v2__ipcountry_;
    __EE1299308._v2__ipcontinent_;
    __EE1299308._iprngbeg_;
    __EE1299308._iprngend_;
    __EE1299308._edgecountry_;
    __EE1299308._edgeregion_;
    __EE1299308._edgecity_;
    __EE1299308._edgeconnspeed_;
    __EE1299308._edgemetrocode_;
    __EE1299308._edgelatitude_;
    __EE1299308._edgelongitude_;
    __EE1299308._edgepostalcode_;
    __EE1299308._edgecountrycode_;
    __EE1299308._edgeregioncode_;
    __EE1299308._edgecitycode_;
    __EE1299308._edgecontinentcode_;
    __EE1299308._edgetwolettercountry_;
    __EE1299308._edgeinternalcode_;
    __EE1299308._edgeareacodes_;
    __EE1299308._edgecountryconf_;
    __EE1299308._edgeregionconf_;
    __EE1299308._edgecitycong_;
    __EE1299308._edgepostalconf_;
    __EE1299308._edgegmtoffset_;
    __EE1299308._edgeindst_;
    __EE1299308._siccode_;
    __EE1299308._domainname_;
    __EE1299308._ispname_;
    __EE1299308._homebiztype_;
    __EE1299308._asn_;
    __EE1299308._asnname_;
    __EE1299308._primarylang_;
    __EE1299308._secondarylang_;
    __EE1299308._proxytype_;
    __EE1299308._proxydescription_;
    __EE1299308._isanisp_;
    __EE1299308._companyname_;
    __EE1299308._ranks_;
    __EE1299308._households_;
    __EE1299308._women_;
    __EE1299308._women18to34_;
    __EE1299308._women35to49_;
    __EE1299308._men_;
    __EE1299308._men18to34_;
    __EE1299308._men35to49_;
    __EE1299308._teens_;
    __EE1299308._kids_;
    __EE1299308._naicscode_;
    __EE1299308._cbsacode_;
    __EE1299308._cbsatitle_;
    __EE1299308._cbsatype_;
    __EE1299308._csacode_;
    __EE1299308._csatitle_;
    __EE1299308._mdcode_;
    __EE1299308._mdtitle_;
    __EE1299308._organizationname_;
    __EE1299308.Customer_Id_;
    __EE1299308.Industry_Type_;
    __EE1299308.Source_Customer_Count_;
    __EE1299308.Entity_Context_Uid_;
    __EE1299308.Label_;
    __EE1299308.Entity_Type_;
    __EE1299308.In_Customer_Population_;
    __EE1299308.Dt_First_Seen_;
    __EE1299308.Dt_Last_Seen_;
    __EE1299308.Last_Record_Id_;
    __EE1299308.Identity_Count_;
    __EE1299308.Event_Count_;
    __EE1299308.Ip_Not_Us_;
    __EE1299308.Ip_Vpn_;
    __EE1299308.Ip_High_Risk_City_;
    __EE1299308.Ip_Hosted_;
    __EE1299308.Ip_Tor_;
    __EE1299308.Kr_High_Risk_Flag_;
    __EE1299308.Kr_Medium_Risk_Flag_;
    __EE1299308.Kr_Low_Risk_Flag_;
    __EE1299308.Kr_Flag_;
    __EE1299308.Safe_Flag_;
    __EE1299308.Contributor_Safe_Flag_;
    __EE1299308.Kr_Ip600_Flag_;
    __EE1299308.Kr_Ip601_Flag_;
    __EE1299308.Kr_Ip602_Flag_;
    __EE1299308.Kr_Ip603_Flag_;
    __EE1299308.Kr_Ip604_Flag_;
    __EE1299308.Kr_Ip605_Flag_;
    __EE1299308.Kr_Ip690_Flag_;
    __EE1299308.Kr_Ip691_Flag_;
    __EE1299308.Kr_Ip692_Flag_;
    __EE1299308.Kr_Ip693_Flag_;
    __EE1299308.Kr_Ip1000_Flag_;
    __EE1299308.Kr_Ip1001_Flag_;
    __EE1299308.Kr_Ip1090_Flag_;
    __EE1299308.Kr_Ip1091_Flag_;
    __EE1299308.Kr_Ip1092_Flag_;
    __EE1299308.Kr_Ip1093_Flag_;
    __EE1299308.Last_Event_Date_;
    __EE1299308.Kr_Last_Event_Date_;
    __EE1299308.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1299308.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1299308.Vl_Event1_All_Count_;
    __EE1299308.Vl_Event7_All_Count_;
    __EE1299308.Vl_Event30_All_Day_Count_;
    __EE1299308.Vl_Event365_All_Day_Count_;
    __EE1299308.Vl_Event7_All_Active_Flag_;
    __EE1299308.Vl_Event30_All_Active_Flag_;
    __EE1299308.Vl_Event1_Count_;
    __EE1299308.Vl_Event7_Count_;
    __EE1299308.Vl_Event30_Count_;
    __EE1299308.Vl_Event365_Count_;
    __EE1299308.Vl_Event7_Active_Flag_;
    __EE1299308.Vl_Event30_Active_Flag_;
    __EE1299308.Date_First_Seen_;
    __EE1299308.Date_Last_Seen_;
    __EE1299308.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE1299308,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1299310_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST27230_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
