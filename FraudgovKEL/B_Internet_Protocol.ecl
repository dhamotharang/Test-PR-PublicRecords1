...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE2807103 := __ENH_Internet_Protocol_1;
  SHARED __EE2889955 := __E_Person_Ip_Address;
  SHARED __EE2889962 := __EE2889955(__NN(__EE2889955.Ip_));
  SHARED __ST2877909_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2889976 := PROJECT(TABLE(PROJECT(__EE2889962,TRANSFORM(__ST2877909_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST2877909_Layout);
  SHARED __ST2877927_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2889942 := PROJECT(__CLEANANDDO(__EE2889976,TABLE(__EE2889976,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST2877927_Layout);
  SHARED __ST2881818_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2889985(B_Internet_Protocol_1.__ST74992_Layout __EE2807103, __ST2877927_Layout __EE2889942) := __EEQP(__EE2807103.UID,__EE2889942.UID);
  __ST2881818_Layout __JT2889985(B_Internet_Protocol_1.__ST74992_Layout __l, __ST2877927_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2889986 := JOIN(__EE2807103,__EE2889942,__JC2889985(LEFT,RIGHT),__JT2889985(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2889946 := __ENH_Event_1;
  SHARED __EE2889944 := __E_Internet_Protocol_Event;
  SHARED __EE2893057 := __EE2889944(__NN(__EE2889944.Ip_) AND __NN(__EE2889944.Transaction_));
  SHARED __ST2878518_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2893075(B_Event_1.__ST73836_Layout __EE2889946, E_Internet_Protocol_Event.Layout __EE2893057) := __EEQP(__EE2893057.Transaction_,__EE2889946.UID);
  __ST2878518_Layout __JT2893075(B_Event_1.__ST73836_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2893076 := JOIN(__EE2893057,__EE2889946,__JC2893075(RIGHT,LEFT),__JT2893075(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2874123_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2874123_Layout __ND2893741__Project(__ST2878518_Layout __PP2893077) := TRANSFORM
    SELF.UID := __PP2893077.Ip_;
    SELF._r_Customer_ := __PP2893077._r_Customer__1_;
    SELF.Event_Date_ := __PP2893077.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2893077.UID;
    SELF.Event_Date__1_ := __PP2893077.Event_Date_;
    SELF._r_Customer__1_ := __PP2893077._r_Customer_;
    SELF := __PP2893077;
  END;
  SHARED __EE2896362 := PROJECT(__EE2893076,__ND2893741__Project(LEFT));
  SHARED __ST2875544_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2875544_Layout __ND2897810__Project(__ST2874123_Layout __PP2896363) := TRANSFORM
    SELF.Exp1_ := __PP2896363.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2896363.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP2896363.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP2896363.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP2896363.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP2896363.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP2896363.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP2896363.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP2896363.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP2896363.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP2896363.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP2896363.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP2896363.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP2896363.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP2896363.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP2896363.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP2896363.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP2896363.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP2896363.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP2896363.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP2896363.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP2896363.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP2896363.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP2896363.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP2896363.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP2896363.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP2896363.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP2896363.Event_Age_,<,__CN(2)),__CN(__PP2896363.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP2896363.Event_Age_,<,__CN(366));
    SELF := __PP2896363;
  END;
  SHARED __EE2897849 := PROJECT(__EE2896362,__ND2897810__Project(LEFT));
  SHARED __ST2875707_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2898018 := PROJECT(__CLEANANDDO(__EE2897849,TABLE(__EE2897849,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2897849.Exp1_),KEL.Aggregates.MinNG(__EE2897849.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2897849.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2897849.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2897849.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2897849.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2897849.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2897849.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2897849.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2897849.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2897849.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2897849.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2897849.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2897849.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2897849.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE2897849.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE2897849.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE2897849.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE2897849.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE2897849.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE2897849.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE2897849.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE2897849.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE2897849.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE2897849.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE2897849.Exp25_),KEL.Aggregates.MaxNG(__EE2897849.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE2897849.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE2897849.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE2897849.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE2897849.Exp29_)),UID},UID,MERGE)),__ST2875707_Layout);
  SHARED __ST2882522_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2898024(__ST2881818_Layout __EE2889986, __ST2875707_Layout __EE2898018) := __EEQP(__EE2889986.UID,__EE2898018.UID);
  __ST2882522_Layout __JT2898024(__ST2881818_Layout __l, __ST2875707_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2898170 := JOIN(__EE2889986,__EE2898018,__JC2898024(LEFT,RIGHT),__JT2898024(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2793558 := __ENH_Customer_1;
  SHARED __ST2883367_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2898176(__ST2882522_Layout __EE2898170, B_Customer_1.__ST66213_Layout __EE2793558) := __EEQP(__EE2898170._r_Customer_,__EE2793558.UID);
  __ST2883367_Layout __JT2898176(__ST2882522_Layout __l, B_Customer_1.__ST66213_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2898344 := JOIN(__EE2898170,__EE2793558,__JC2898176(LEFT,RIGHT),__JT2898176(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST60952_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST60952_Layout __ND2898349__Project(__ST2883367_Layout __PP2898345) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2898345.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP2898345.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP2898345.C_O_U_N_T___Person_Ip_Address_;
    __BS2898707 := __T(__PP2898345.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2898707(__T(__OP2(__T(__PP2898345.Source_Customers_)._r_Source_Customer_,=,__PP2898345._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP2898345.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP2898345.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP2898345.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP2898345.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP2898345.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP2898345.Ip_Address_;
    SELF.Last_Event_Date_ := __PP2898345.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2898345.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2898345.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2898345.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP2898345.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2898345.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2898345.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2898345.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2898345.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2898345.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2898345;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE2898344,__ND2898349__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE3429574 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE3429574._r_Customer_;
    __EE3429574.Source_Customers_;
    __EE3429574.Ip_Address_;
    __EE3429574.Otto_Ip_Address_Id_;
    __EE3429574._host_;
    __EE3429574._alias_;
    __EE3429574._location_;
    __EE3429574._ip__address_;
    __EE3429574._ip__address__date_;
    __EE3429574._version_;
    __EE3429574._class_;
    __EE3429574._subnet__mask_;
    __EE3429574._reserved_;
    __EE3429574._isp_;
    __EE3429574._v2__validationipproblems_;
    __EE3429574._v2__ipstate_;
    __EE3429574._v2__ipcountry_;
    __EE3429574._v2__ipcontinent_;
    __EE3429574._iprngbeg_;
    __EE3429574._iprngend_;
    __EE3429574._edgecountry_;
    __EE3429574._edgeregion_;
    __EE3429574._edgecity_;
    __EE3429574._edgeconnspeed_;
    __EE3429574._edgemetrocode_;
    __EE3429574._edgelatitude_;
    __EE3429574._edgelongitude_;
    __EE3429574._edgepostalcode_;
    __EE3429574._edgecountrycode_;
    __EE3429574._edgeregioncode_;
    __EE3429574._edgecitycode_;
    __EE3429574._edgecontinentcode_;
    __EE3429574._edgetwolettercountry_;
    __EE3429574._edgeinternalcode_;
    __EE3429574._edgeareacodes_;
    __EE3429574._edgecountryconf_;
    __EE3429574._edgeregionconf_;
    __EE3429574._edgecitycong_;
    __EE3429574._edgepostalconf_;
    __EE3429574._edgegmtoffset_;
    __EE3429574._edgeindst_;
    __EE3429574._siccode_;
    __EE3429574._domainname_;
    __EE3429574._ispname_;
    __EE3429574._homebiztype_;
    __EE3429574._asn_;
    __EE3429574._asnname_;
    __EE3429574._primarylang_;
    __EE3429574._secondarylang_;
    __EE3429574._proxytype_;
    __EE3429574._proxydescription_;
    __EE3429574._isanisp_;
    __EE3429574._companyname_;
    __EE3429574._ranks_;
    __EE3429574._households_;
    __EE3429574._women_;
    __EE3429574._women18to34_;
    __EE3429574._women35to49_;
    __EE3429574._men_;
    __EE3429574._men18to34_;
    __EE3429574._men35to49_;
    __EE3429574._teens_;
    __EE3429574._kids_;
    __EE3429574._naicscode_;
    __EE3429574._cbsacode_;
    __EE3429574._cbsatitle_;
    __EE3429574._cbsatype_;
    __EE3429574._csacode_;
    __EE3429574._csatitle_;
    __EE3429574._mdcode_;
    __EE3429574._mdtitle_;
    __EE3429574._organizationname_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE3429574.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE3429574.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE3429574.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE3429574.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE3429574.Aot_Id_Act_Cnt_Ev_;
    __EE3429574.Aot_Id_Act_Cnt30_D_;
    __EE3429574.Aot_Add_Act_Cnt_Ev_;
    __EE3429574.Aot_Add_Act_Cnt30_D_;
    __EE3429574.Aot_Non_St_Act_Cnt_Ev_;
    __EE3429574.Aot_Non_St_Act_Cnt30_D_;
    __EE3429574.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE3429574.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE3429574.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE3429574.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE3429574.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE3429574.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE3429574.Customer_Id_;
    __EE3429574.Industry_Type_;
    __EE3429574.Source_Customer_Count_;
    __EE3429574.Entity_Context_Uid_;
    __EE3429574.Label_;
    __EE3429574.Entity_Type_;
    __EE3429574.In_Customer_Population_;
    __EE3429574.Dt_First_Seen_;
    __EE3429574.Dt_Last_Seen_;
    __EE3429574.Last_Record_Id_;
    __EE3429574.Identity_Count_;
    __EE3429574.Event_Count_;
    __EE3429574.Ip_Not_Us_;
    __EE3429574.Ip_Vpn_;
    __EE3429574.Ip_High_Risk_City_;
    __EE3429574.Ip_Hosted_;
    __EE3429574.Ip_Tor_;
    __EE3429574.Kr_High_Risk_Flag_;
    __EE3429574.Kr_Medium_Risk_Flag_;
    __EE3429574.Kr_Low_Risk_Flag_;
    __EE3429574.Kr_Flag_;
    __EE3429574.Safe_Flag_;
    __EE3429574.Contributor_Safe_Flag_;
    __EE3429574.Kr_Ip600_Flag_;
    __EE3429574.Kr_Ip601_Flag_;
    __EE3429574.Kr_Ip602_Flag_;
    __EE3429574.Kr_Ip603_Flag_;
    __EE3429574.Kr_Ip604_Flag_;
    __EE3429574.Kr_Ip605_Flag_;
    __EE3429574.Kr_Ip690_Flag_;
    __EE3429574.Kr_Ip691_Flag_;
    __EE3429574.Kr_Ip692_Flag_;
    __EE3429574.Kr_Ip693_Flag_;
    __EE3429574.Kr_Ip1000_Flag_;
    __EE3429574.Kr_Ip1001_Flag_;
    __EE3429574.Kr_Ip1090_Flag_;
    __EE3429574.Kr_Ip1091_Flag_;
    __EE3429574.Kr_Ip1092_Flag_;
    __EE3429574.Kr_Ip1093_Flag_;
    __EE3429574.Last_Event_Date_;
    __EE3429574.Kr_Last_Event_Date_;
    __EE3429574.Kr_Event_After_Last_Known_Risk_Count_;
    __EE3429574.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE3429574.Vl_Event1_All_Count_;
    __EE3429574.Vl_Event7_All_Count_;
    __EE3429574.Vl_Event30_All_Day_Count_;
    __EE3429574.Vl_Event365_All_Day_Count_;
    __EE3429574.Vl_Event7_All_Active_Flag_;
    __EE3429574.Vl_Event30_All_Active_Flag_;
    __EE3429574.Vl_Event1_Count_;
    __EE3429574.Vl_Event7_Count_;
    __EE3429574.Vl_Event30_Count_;
    __EE3429574.Vl_Event365_Count_;
    __EE3429574.Vl_Event7_Active_Flag_;
    __EE3429574.Vl_Event30_Active_Flag_;
    __EE3429574.Date_First_Seen_;
    __EE3429574.Date_Last_Seen_;
    __EE3429574.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE3429574,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST3429576_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST60952_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
