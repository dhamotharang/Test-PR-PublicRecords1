...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE3644163 := __ENH_Internet_Protocol_1;
  SHARED __EE3733185 := __E_Person_Ip_Address;
  SHARED __EE3733192 := __EE3733185(__NN(__EE3733185.Ip_));
  SHARED __ST3720629_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3733206 := PROJECT(TABLE(PROJECT(__EE3733192,TRANSFORM(__ST3720629_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST3720629_Layout);
  SHARED __ST3720647_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3733172 := PROJECT(__CLEANANDDO(__EE3733206,TABLE(__EE3733206,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST3720647_Layout);
  SHARED __ST3724726_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3733215(B_Internet_Protocol_1.__ST79409_Layout __EE3644163, __ST3720647_Layout __EE3733172) := __EEQP(__EE3644163.UID,__EE3733172.UID);
  __ST3724726_Layout __JT3733215(B_Internet_Protocol_1.__ST79409_Layout __l, __ST3720647_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3733216 := JOIN(__EE3644163,__EE3733172,__JC3733215(LEFT,RIGHT),__JT3733215(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3733176 := __ENH_Event_1;
  SHARED __EE3733174 := __E_Internet_Protocol_Event;
  SHARED __EE3736439 := __EE3733174(__NN(__EE3733174.Ip_) AND __NN(__EE3733174.Transaction_));
  SHARED __ST3721256_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3736457(B_Event_1.__ST78198_Layout __EE3733176, E_Internet_Protocol_Event.Layout __EE3736439) := __EEQP(__EE3736439.Transaction_,__EE3733176.UID);
  __ST3721256_Layout __JT3736457(B_Event_1.__ST78198_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3736458 := JOIN(__EE3736439,__EE3733176,__JC3736457(RIGHT,LEFT),__JT3736457(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3716675_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3716675_Layout __ND3737157__Project(__ST3721256_Layout __PP3736459) := TRANSFORM
    SELF.UID := __PP3736459.Ip_;
    SELF._r_Customer_ := __PP3736459._r_Customer__1_;
    SELF.Event_Date_ := __PP3736459.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3736459.UID;
    SELF.Event_Date__1_ := __PP3736459.Event_Date_;
    SELF._r_Customer__1_ := __PP3736459._r_Customer_;
    SELF := __PP3736459;
  END;
  SHARED __EE3739914 := PROJECT(__EE3736458,__ND3737157__Project(LEFT));
  SHARED __ST3718170_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3718170_Layout __ND3741409__Project(__ST3716675_Layout __PP3739915) := TRANSFORM
    SELF.Exp1_ := __PP3739915.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP3739915.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP3739915.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP3739915.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP3739915.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP3739915.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP3739915.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP3739915.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP3739915.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP3739915.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP3739915.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP3739915.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP3739915.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP3739915.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP3739915.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP3739915.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP3739915.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP3739915.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP3739915.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP3739915.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP3739915.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP3739915.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP3739915.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP3739915.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP3739915.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP3739915.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP3739915.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP3739915.Safe_Flag_ = 1;
    SELF.Exp28_ := __OP2(__PP3739915.Event_Age_,<,__CN(2));
    SELF.Exp29_ := __AND(__OP2(__PP3739915.Event_Age_,<,__CN(2)),__CN(__PP3739915.In_Customer_Population_ = 1));
    SELF.Exp30_ := __OP2(__PP3739915.Event_Age_,<,__CN(366));
    SELF := __PP3739915;
  END;
  SHARED __EE3741449 := PROJECT(__EE3739914,__ND3741409__Project(LEFT));
  SHARED __ST3718338_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3741623 := PROJECT(__CLEANANDDO(__EE3741449,TABLE(__EE3741449,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3741449.Exp1_),KEL.Aggregates.MinNG(__EE3741449.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE3741449.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3741449.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3741449.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3741449.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3741449.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3741449.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3741449.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3741449.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3741449.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3741449.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3741449.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3741449.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3741449.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3741449.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE3741449.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE3741449.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE3741449.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE3741449.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE3741449.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE3741449.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE3741449.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE3741449.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE3741449.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE3741449.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE3741449.Exp26_),KEL.Aggregates.MaxNG(__EE3741449.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE3741449.Exp27_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE3741449.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE3741449.Exp29_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE3741449.Exp30_)),UID},UID,MERGE)),__ST3718338_Layout);
  SHARED __ST3725452_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3741629(__ST3724726_Layout __EE3733216, __ST3718338_Layout __EE3741623) := __EEQP(__EE3733216.UID,__EE3741623.UID);
  __ST3725452_Layout __JT3741629(__ST3724726_Layout __l, __ST3718338_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3741780 := JOIN(__EE3733216,__EE3741623,__JC3741629(LEFT,RIGHT),__JT3741629(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3624488 := __ENH_Customer_1;
  SHARED __ST3726322_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3741786(__ST3725452_Layout __EE3741780, B_Customer_1.__ST70014_Layout __EE3624488) := __EEQP(__EE3741780._r_Customer_,__EE3624488.UID);
  __ST3726322_Layout __JT3741786(__ST3725452_Layout __l, B_Customer_1.__ST70014_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3741959 := JOIN(__EE3741780,__EE3624488,__JC3741786(LEFT,RIGHT),__JT3741786(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST64597_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST64597_Layout __ND3741964__Project(__ST3726322_Layout __PP3741960) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3741960.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP3741960.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP3741960.M_I_N___Event_Date__2_;
    SELF.Identity_Count_ := __PP3741960.C_O_U_N_T___Person_Ip_Address_;
    __BS3742337 := __T(__PP3741960.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3742337(__T(__OP2(__T(__PP3741960.Source_Customers_)._r_Source_Customer_,=,__PP3741960._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP3741960.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP3741960.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP3741960.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP3741960.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP3741960.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP3741960.Ip_Address_;
    SELF.Last_Event_Date_ := __PP3741960.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3741960.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3741960.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3741960.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP3741960.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3741960.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3741960.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3741960.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3741960.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3741960.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3741960;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE3741959,__ND3741964__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4316433 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE
New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4316433.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4316433.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4316433.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4316433.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4316433.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4316433.Customer_Id_;
    __EE4316433.Industry_Type_;
    __EE4316433.Source_Customer_Count_;
    __EE4316433.Entity_Context_Uid_;
    __EE4316433.Label_;
    __EE4316433.Entity_Type_;
    __EE4316433.In_Customer_Population_;
    __EE4316433.Dt_First_Seen_;
    __EE4316433.Dt_Last_Seen_;
    __EE4316433.Id_Activity_Dt_First_Seen_;
    __EE4316433.Id_Activity_Dt_Last_Seen_;
    __EE4316433.Last_Record_Id_;
    __EE4316433.Identity_Count_;
    __EE4316433.Event_Count_;
    __EE4316433.Ip_Not_Us_;
    __EE4316433.Ip_Vpn_;
    __EE4316433.Ip_High_Risk_City_;
    __EE4316433.Ip_Hosted_;
    __EE4316433.Ip_Tor_;
    __EE4316433.Kr_High_Risk_Flag_;
    __EE4316433.Kr_Medium_Risk_Flag_;
    __EE4316433.Kr_Low_Risk_Flag_;
    __EE4316433.Kr_Flag_;
    __EE4316433.Safe_Flag_;
    __EE4316433.Contributor_Safe_Flag_;
    __EE4316433.Kr_Ip600_Flag_;
    __EE4316433.Kr_Ip601_Flag_;
    __EE4316433.Kr_Ip602_Flag_;
    __EE4316433.Kr_Ip603_Flag_;
    __EE4316433.Kr_Ip604_Flag_;
    __EE4316433.Kr_Ip605_Flag_;
    __EE4316433.Kr_Ip690_Flag_;
    __EE4316433.Kr_Ip691_Flag_;
    __EE4316433.Kr_Ip692_Flag_;
    __EE4316433.Kr_Ip693_Flag_;
    __EE4316433.Kr_Ip1000_Flag_;
    __EE4316433.Kr_Ip1001_Flag_;
    __EE4316433.Kr_Ip1090_Flag_;
    __EE4316433.Kr_Ip1091_Flag_;
    __EE4316433.Kr_Ip1092_Flag_;
    __EE4316433.Kr_Ip1093_Flag_;
    __EE4316433.Last_Event_Date_;
    __EE4316433.Kr_Last_Event_Date_;
    __EE4316433.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4316433.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4316433.Vl_Event1_All_Count_;
    __EE4316433.Vl_Event7_All_Count_;
    __EE4316433.Vl_Event30_All_Day_Count_;
    __EE4316433.Vl_Event365_All_Day_Count_;
    __EE4316433.Vl_Event7_All_Active_Flag_;
    __EE4316433.Vl_Event30_All_Active_Flag_;
    __EE4316433.Vl_Event1_Count_;
    __EE4316433.Vl_Event7_Count_;
    __EE4316433.Vl_Event30_Count_;
    __EE4316433.Vl_Event365_Count_;
    __EE4316433.Vl_Event7_Active_Flag_;
    __EE4316433.Vl_Event30_Active_Flag_;
    __EE4316433.Date_First_Seen_;
    __EE4316433.Date_Last_Seen_;
    __EE4316433.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4316433,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4316435_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST64597_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
