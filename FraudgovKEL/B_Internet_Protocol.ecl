...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE1824223 := __ENH_Internet_Protocol_1;
  SHARED __EE1891511 := __E_Person_Ip_Address;
  SHARED __EE1891518 := __EE1891511(__NN(__EE1891511.Ip_));
  SHARED __ST1881151_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1891532 := PROJECT(TABLE(PROJECT(__EE1891518,TRANSFORM(__ST1881151_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST1881151_Layout);
  SHARED __ST1881169_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1891498 := PROJECT(__CLEANANDDO(__EE1891532,TABLE(__EE1891532,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST1881169_Layout);
  SHARED __ST1884361_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1891541(B_Internet_Protocol_1.__ST53809_Layout __EE1824223, __ST1881169_Layout __EE1891498) := __EEQP(__EE1824223.UID,__EE1891498.UID);
  __ST1884361_Layout __JT1891541(B_Internet_Protocol_1.__ST53809_Layout __l, __ST1881169_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1891542 := JOIN(__EE1824223,__EE1891498,__JC1891541(LEFT,RIGHT),__JT1891541(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1891502 := __ENH_Event_1;
  SHARED __EE1891500 := __E_Internet_Protocol_Event;
  SHARED __EE1894073 := __EE1891500(__NN(__EE1891500.Ip_) AND __NN(__EE1891500.Transaction_));
  SHARED __ST1881736_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1894091(B_Event_1.__ST52969_Layout __EE1891502, E_Internet_Protocol_Event.Layout __EE1894073) := __EEQP(__EE1894073.Transaction_,__EE1891502.UID);
  __ST1881736_Layout __JT1894091(B_Event_1.__ST52969_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1894092 := JOIN(__EE1894073,__EE1891502,__JC1894091(RIGHT,LEFT),__JT1894091(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1877929_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1877929_Layout __ND1894622__Project(__ST1881736_Layout __PP1894093) := TRANSFORM
    SELF.UID := __PP1894093.Ip_;
    SELF._r_Customer_ := __PP1894093._r_Customer__1_;
    SELF.Event_Date_ := __PP1894093.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1894093.UID;
    SELF.Event_Date__1_ := __PP1894093.Event_Date_;
    SELF._r_Customer__1_ := __PP1894093._r_Customer_;
    SELF := __PP1894093;
  END;
  SHARED __EE1896703 := PROJECT(__EE1894092,__ND1894622__Project(LEFT));
  SHARED __ST1879080_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1879080_Layout __ND1898067__Project(__ST1877929_Layout __PP1896704) := TRANSFORM
    SELF.Exp1_ := __PP1896704.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1896704.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP1896704.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP1896704.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP1896704.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP1896704.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP1896704.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP1896704.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP1896704.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP1896704.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP1896704.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP1896704.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP1896704.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP1896704.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP1896704.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP1896704.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP1896704.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP1896704.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP1896704.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP1896704.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP1896704.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP1896704.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP1896704.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP1896704.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP1896704.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP1896704.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP1896704.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP1896704.Event_Age_,<,__CN(2)),__CN(__PP1896704.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP1896704.Event_Age_,<,__CN(366));
    SELF := __PP1896704;
  END;
  SHARED __EE1898106 := PROJECT(__EE1896703,__ND1898067__Project(LEFT));
  SHARED __ST1879243_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1898275 := PROJECT(__CLEANANDDO(__EE1898106,TABLE(__EE1898106,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1898106.Exp1_),KEL.Aggregates.MinNG(__EE1898106.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1898106.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1898106.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1898106.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1898106.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1898106.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1898106.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1898106.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1898106.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1898106.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1898106.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1898106.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1898106.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1898106.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1898106.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1898106.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1898106.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1898106.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1898106.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1898106.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1898106.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE1898106.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE1898106.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE1898106.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE1898106.Exp25_),KEL.Aggregates.MaxNG(__EE1898106.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE1898106.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE1898106.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE1898106.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE1898106.Exp29_)),UID},UID,MERGE)),__ST1879243_Layout);
  SHARED __ST1885005_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1898281(__ST1884361_Layout __EE1891542, __ST1879243_Layout __EE1898275) := __EEQP(__EE1891542.UID,__EE1898275.UID);
  __ST1885005_Layout __JT1898281(__ST1884361_Layout __l, __ST1879243_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1898415 := JOIN(__EE1891542,__EE1898275,__JC1898281(LEFT,RIGHT),__JT1898281(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1812850 := __ENH_Customer_1;
  SHARED __ST1885790_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1898421(__ST1885005_Layout __EE1898415, B_Customer_1.__ST47418_Layout __EE1812850) := __EEQP(__EE1898415._r_Customer_,__EE1812850.UID);
  __ST1885790_Layout __JT1898421(__ST1885005_Layout __l, B_Customer_1.__ST47418_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1898577 := JOIN(__EE1898415,__EE1812850,__JC1898421(LEFT,RIGHT),__JT1898421(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43136_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43136_Layout __ND1898582__Project(__ST1885790_Layout __PP1898578) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1898578.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP1898578.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP1898578.C_O_U_N_T___Person_Ip_Address_;
    __BS1898904 := __T(__PP1898578.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1898904(__T(__OP2(__T(__PP1898578.Source_Customers_)._r_Source_Customer_,=,__PP1898578._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP1898578.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP1898578.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP1898578.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP1898578.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP1898578.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP1898578.Ip_Address_;
    SELF.Last_Event_Date_ := __PP1898578.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1898578.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1898578.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1898578.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP1898578.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1898578.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1898578.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1898578.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1898578.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1898578.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1898578;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE1898577,__ND1898582__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2334491 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2334491._r_Customer_;
    __EE2334491.Source_Customers_;
    __EE2334491.Ip_Address_;
    __EE2334491.Otto_Ip_Address_Id_;
    __EE2334491._host_;
    __EE2334491._alias_;
    __EE2334491._location_;
    __EE2334491._ip__address_;
    __EE2334491._ip__address__date_;
    __EE2334491._version_;
    __EE2334491._class_;
    __EE2334491._subnet__mask_;
    __EE2334491._reserved_;
    __EE2334491._isp_;
    __EE2334491._v2__validationipproblems_;
    __EE2334491._v2__ipstate_;
    __EE2334491._v2__ipcountry_;
    __EE2334491._v2__ipcontinent_;
    __EE2334491._iprngbeg_;
    __EE2334491._iprngend_;
    __EE2334491._edgecountry_;
    __EE2334491._edgeregion_;
    __EE2334491._edgecity_;
    __EE2334491._edgeconnspeed_;
    __EE2334491._edgemetrocode_;
    __EE2334491._edgelatitude_;
    __EE2334491._edgelongitude_;
    __EE2334491._edgepostalcode_;
    __EE2334491._edgecountrycode_;
    __EE2334491._edgeregioncode_;
    __EE2334491._edgecitycode_;
    __EE2334491._edgecontinentcode_;
    __EE2334491._edgetwolettercountry_;
    __EE2334491._edgeinternalcode_;
    __EE2334491._edgeareacodes_;
    __EE2334491._edgecountryconf_;
    __EE2334491._edgeregionconf_;
    __EE2334491._edgecitycong_;
    __EE2334491._edgepostalconf_;
    __EE2334491._edgegmtoffset_;
    __EE2334491._edgeindst_;
    __EE2334491._siccode_;
    __EE2334491._domainname_;
    __EE2334491._ispname_;
    __EE2334491._homebiztype_;
    __EE2334491._asn_;
    __EE2334491._asnname_;
    __EE2334491._primarylang_;
    __EE2334491._secondarylang_;
    __EE2334491._proxytype_;
    __EE2334491._proxydescription_;
    __EE2334491._isanisp_;
    __EE2334491._companyname_;
    __EE2334491._ranks_;
    __EE2334491._households_;
    __EE2334491._women_;
    __EE2334491._women18to34_;
    __EE2334491._women35to49_;
    __EE2334491._men_;
    __EE2334491._men18to34_;
    __EE2334491._men35to49_;
    __EE2334491._teens_;
    __EE2334491._kids_;
    __EE2334491._naicscode_;
    __EE2334491._cbsacode_;
    __EE2334491._cbsatitle_;
    __EE2334491._cbsatype_;
    __EE2334491._csacode_;
    __EE2334491._csatitle_;
    __EE2334491._mdcode_;
    __EE2334491._mdtitle_;
    __EE2334491._organizationname_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2334491.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2334491.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2334491.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2334491.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2334491.Customer_Id_;
    __EE2334491.Industry_Type_;
    __EE2334491.Source_Customer_Count_;
    __EE2334491.Entity_Context_Uid_;
    __EE2334491.Label_;
    __EE2334491.Entity_Type_;
    __EE2334491.In_Customer_Population_;
    __EE2334491.Dt_First_Seen_;
    __EE2334491.Dt_Last_Seen_;
    __EE2334491.Last_Record_Id_;
    __EE2334491.Identity_Count_;
    __EE2334491.Event_Count_;
    __EE2334491.Ip_Not_Us_;
    __EE2334491.Ip_Vpn_;
    __EE2334491.Ip_High_Risk_City_;
    __EE2334491.Ip_Hosted_;
    __EE2334491.Ip_Tor_;
    __EE2334491.Kr_High_Risk_Flag_;
    __EE2334491.Kr_Medium_Risk_Flag_;
    __EE2334491.Kr_Low_Risk_Flag_;
    __EE2334491.Kr_Flag_;
    __EE2334491.Safe_Flag_;
    __EE2334491.Contributor_Safe_Flag_;
    __EE2334491.Kr_Ip600_Flag_;
    __EE2334491.Kr_Ip601_Flag_;
    __EE2334491.Kr_Ip602_Flag_;
    __EE2334491.Kr_Ip603_Flag_;
    __EE2334491.Kr_Ip604_Flag_;
    __EE2334491.Kr_Ip605_Flag_;
    __EE2334491.Kr_Ip690_Flag_;
    __EE2334491.Kr_Ip691_Flag_;
    __EE2334491.Kr_Ip692_Flag_;
    __EE2334491.Kr_Ip693_Flag_;
    __EE2334491.Kr_Ip1000_Flag_;
    __EE2334491.Kr_Ip1001_Flag_;
    __EE2334491.Kr_Ip1090_Flag_;
    __EE2334491.Kr_Ip1091_Flag_;
    __EE2334491.Kr_Ip1092_Flag_;
    __EE2334491.Kr_Ip1093_Flag_;
    __EE2334491.Last_Event_Date_;
    __EE2334491.Kr_Last_Event_Date_;
    __EE2334491.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2334491.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2334491.Vl_Event1_All_Count_;
    __EE2334491.Vl_Event7_All_Count_;
    __EE2334491.Vl_Event30_All_Day_Count_;
    __EE2334491.Vl_Event365_All_Day_Count_;
    __EE2334491.Vl_Event7_All_Active_Flag_;
    __EE2334491.Vl_Event30_All_Active_Flag_;
    __EE2334491.Vl_Event1_Count_;
    __EE2334491.Vl_Event7_Count_;
    __EE2334491.Vl_Event30_Count_;
    __EE2334491.Vl_Event365_Count_;
    __EE2334491.Vl_Event7_Active_Flag_;
    __EE2334491.Vl_Event30_Active_Flag_;
    __EE2334491.Date_First_Seen_;
    __EE2334491.Date_Last_Seen_;
    __EE2334491.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2334491,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2334493_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST43136_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
