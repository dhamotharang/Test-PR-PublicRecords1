...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE2052273 := __ENH_Internet_Protocol_1;
  SHARED __EE2126505 := __E_Person_Ip_Address;
  SHARED __EE2126512 := __EE2126505(__NN(__EE2126505.Ip_));
  SHARED __ST2115525_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2126526 := PROJECT(TABLE(PROJECT(__EE2126512,TRANSFORM(__ST2115525_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST2115525_Layout);
  SHARED __ST2115543_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2126492 := PROJECT(__CLEANANDDO(__EE2126526,TABLE(__EE2126526,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST2115543_Layout);
  SHARED __ST2119045_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2126535(B_Internet_Protocol_1.__ST54377_Layout __EE2052273, __ST2115543_Layout __EE2126492) := __EEQP(__EE2052273.UID,__EE2126492.UID);
  __ST2119045_Layout __JT2126535(B_Internet_Protocol_1.__ST54377_Layout __l, __ST2115543_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2126536 := JOIN(__EE2052273,__EE2126492,__JC2126535(LEFT,RIGHT),__JT2126535(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2126496 := __ENH_Event_1;
  SHARED __EE2126494 := __E_Internet_Protocol_Event;
  SHARED __EE2129315 := __EE2126494(__NN(__EE2126494.Ip_) AND __NN(__EE2126494.Transaction_));
  SHARED __ST2116110_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2129333(B_Event_1.__ST53475_Layout __EE2126496, E_Internet_Protocol_Event.Layout __EE2129315) := __EEQP(__EE2129315.Transaction_,__EE2126496.UID);
  __ST2116110_Layout __JT2129333(B_Event_1.__ST53475_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2129334 := JOIN(__EE2129315,__EE2126496,__JC2129333(RIGHT,LEFT),__JT2129333(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2112055_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2112055_Layout __ND2129926__Project(__ST2116110_Layout __PP2129335) := TRANSFORM
    SELF.UID := __PP2129335.Ip_;
    SELF._r_Customer_ := __PP2129335._r_Customer__1_;
    SELF.Event_Date_ := __PP2129335.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2129335.UID;
    SELF.Event_Date__1_ := __PP2129335.Event_Date_;
    SELF._r_Customer__1_ := __PP2129335._r_Customer_;
    SELF := __PP2129335;
  END;
  SHARED __EE2132255 := PROJECT(__EE2129334,__ND2129926__Project(LEFT));
  SHARED __ST2113330_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2113330_Layout __ND2133619__Project(__ST2112055_Layout __PP2132256) := TRANSFORM
    SELF.Exp1_ := __PP2132256.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2132256.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP2132256.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP2132256.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP2132256.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP2132256.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP2132256.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP2132256.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP2132256.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP2132256.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP2132256.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP2132256.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP2132256.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP2132256.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP2132256.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP2132256.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP2132256.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP2132256.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP2132256.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP2132256.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP2132256.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP2132256.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP2132256.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP2132256.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP2132256.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP2132256.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP2132256.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP2132256.Event_Age_,<,__CN(2)),__CN(__PP2132256.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP2132256.Event_Age_,<,__CN(366));
    SELF := __PP2132256;
  END;
  SHARED __EE2133658 := PROJECT(__EE2132255,__ND2133619__Project(LEFT));
  SHARED __ST2113493_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2133827 := PROJECT(__CLEANANDDO(__EE2133658,TABLE(__EE2133658,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2133658.Exp1_),KEL.Aggregates.MinNG(__EE2133658.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2133658.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2133658.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2133658.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2133658.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2133658.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2133658.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2133658.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2133658.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2133658.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2133658.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2133658.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2133658.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2133658.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE2133658.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE2133658.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE2133658.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE2133658.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE2133658.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE2133658.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE2133658.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE2133658.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE2133658.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE2133658.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE2133658.Exp25_),KEL.Aggregates.MaxNG(__EE2133658.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE2133658.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE2133658.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE2133658.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE2133658.Exp29_)),UID},UID,MERGE)),__ST2113493_Layout);
  SHARED __ST2119689_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2133833(__ST2119045_Layout __EE2126536, __ST2113493_Layout __EE2133827) := __EEQP(__EE2126536.UID,__EE2133827.UID);
  __ST2119689_Layout __JT2133833(__ST2119045_Layout __l, __ST2113493_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2133967 := JOIN(__EE2126536,__EE2133827,__JC2133833(LEFT,RIGHT),__JT2133833(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2039908 := __ENH_Customer_1;
  SHARED __ST2120474_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2133973(__ST2119689_Layout __EE2133967, B_Customer_1.__ST47862_Layout __EE2039908) := __EEQP(__EE2133967._r_Customer_,__EE2039908.UID);
  __ST2120474_Layout __JT2133973(__ST2119689_Layout __l, B_Customer_1.__ST47862_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2134129 := JOIN(__EE2133967,__EE2039908,__JC2133973(LEFT,RIGHT),__JT2133973(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43580_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43580_Layout __ND2134134__Project(__ST2120474_Layout __PP2134130) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2134130.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP2134130.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP2134130.C_O_U_N_T___Person_Ip_Address_;
    __BS2134456 := __T(__PP2134130.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2134456(__T(__OP2(__T(__PP2134130.Source_Customers_)._r_Source_Customer_,=,__PP2134130._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP2134130.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP2134130.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP2134130.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP2134130.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP2134130.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP2134130.Ip_Address_;
    SELF.Last_Event_Date_ := __PP2134130.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2134130.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2134130.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2134130.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP2134130.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2134130.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2134130.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2134130.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2134130.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2134130.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2134130;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE2134129,__ND2134134__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2599087 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2599087._r_Customer_;
    __EE2599087.Source_Customers_;
    __EE2599087.Ip_Address_;
    __EE2599087.Otto_Ip_Address_Id_;
    __EE2599087._host_;
    __EE2599087._alias_;
    __EE2599087._location_;
    __EE2599087._ip__address_;
    __EE2599087._ip__address__date_;
    __EE2599087._version_;
    __EE2599087._class_;
    __EE2599087._subnet__mask_;
    __EE2599087._reserved_;
    __EE2599087._isp_;
    __EE2599087._v2__validationipproblems_;
    __EE2599087._v2__ipstate_;
    __EE2599087._v2__ipcountry_;
    __EE2599087._v2__ipcontinent_;
    __EE2599087._iprngbeg_;
    __EE2599087._iprngend_;
    __EE2599087._edgecountry_;
    __EE2599087._edgeregion_;
    __EE2599087._edgecity_;
    __EE2599087._edgeconnspeed_;
    __EE2599087._edgemetrocode_;
    __EE2599087._edgelatitude_;
    __EE2599087._edgelongitude_;
    __EE2599087._edgepostalcode_;
    __EE2599087._edgecountrycode_;
    __EE2599087._edgeregioncode_;
    __EE2599087._edgecitycode_;
    __EE2599087._edgecontinentcode_;
    __EE2599087._edgetwolettercountry_;
    __EE2599087._edgeinternalcode_;
    __EE2599087._edgeareacodes_;
    __EE2599087._edgecountryconf_;
    __EE2599087._edgeregionconf_;
    __EE2599087._edgecitycong_;
    __EE2599087._edgepostalconf_;
    __EE2599087._edgegmtoffset_;
    __EE2599087._edgeindst_;
    __EE2599087._siccode_;
    __EE2599087._domainname_;
    __EE2599087._ispname_;
    __EE2599087._homebiztype_;
    __EE2599087._asn_;
    __EE2599087._asnname_;
    __EE2599087._primarylang_;
    __EE2599087._secondarylang_;
    __EE2599087._proxytype_;
    __EE2599087._proxydescription_;
    __EE2599087._isanisp_;
    __EE2599087._companyname_;
    __EE2599087._ranks_;
    __EE2599087._households_;
    __EE2599087._women_;
    __EE2599087._women18to34_;
    __EE2599087._women35to49_;
    __EE2599087._men_;
    __EE2599087._men18to34_;
    __EE2599087._men35to49_;
    __EE2599087._teens_;
    __EE2599087._kids_;
    __EE2599087._naicscode_;
    __EE2599087._cbsacode_;
    __EE2599087._cbsatitle_;
    __EE2599087._cbsatype_;
    __EE2599087._csacode_;
    __EE2599087._csatitle_;
    __EE2599087._mdcode_;
    __EE2599087._mdtitle_;
    __EE2599087._organizationname_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2599087.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2599087.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2599087.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2599087.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2599087.Customer_Id_;
    __EE2599087.Industry_Type_;
    __EE2599087.Source_Customer_Count_;
    __EE2599087.Entity_Context_Uid_;
    __EE2599087.Label_;
    __EE2599087.Entity_Type_;
    __EE2599087.In_Customer_Population_;
    __EE2599087.Dt_First_Seen_;
    __EE2599087.Dt_Last_Seen_;
    __EE2599087.Last_Record_Id_;
    __EE2599087.Identity_Count_;
    __EE2599087.Event_Count_;
    __EE2599087.Ip_Not_Us_;
    __EE2599087.Ip_Vpn_;
    __EE2599087.Ip_High_Risk_City_;
    __EE2599087.Ip_Hosted_;
    __EE2599087.Ip_Tor_;
    __EE2599087.Kr_High_Risk_Flag_;
    __EE2599087.Kr_Medium_Risk_Flag_;
    __EE2599087.Kr_Low_Risk_Flag_;
    __EE2599087.Kr_Flag_;
    __EE2599087.Safe_Flag_;
    __EE2599087.Contributor_Safe_Flag_;
    __EE2599087.Kr_Ip600_Flag_;
    __EE2599087.Kr_Ip601_Flag_;
    __EE2599087.Kr_Ip602_Flag_;
    __EE2599087.Kr_Ip603_Flag_;
    __EE2599087.Kr_Ip604_Flag_;
    __EE2599087.Kr_Ip605_Flag_;
    __EE2599087.Kr_Ip690_Flag_;
    __EE2599087.Kr_Ip691_Flag_;
    __EE2599087.Kr_Ip692_Flag_;
    __EE2599087.Kr_Ip693_Flag_;
    __EE2599087.Kr_Ip1000_Flag_;
    __EE2599087.Kr_Ip1001_Flag_;
    __EE2599087.Kr_Ip1090_Flag_;
    __EE2599087.Kr_Ip1091_Flag_;
    __EE2599087.Kr_Ip1092_Flag_;
    __EE2599087.Kr_Ip1093_Flag_;
    __EE2599087.Last_Event_Date_;
    __EE2599087.Kr_Last_Event_Date_;
    __EE2599087.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2599087.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2599087.Vl_Event1_All_Count_;
    __EE2599087.Vl_Event7_All_Count_;
    __EE2599087.Vl_Event30_All_Day_Count_;
    __EE2599087.Vl_Event365_All_Day_Count_;
    __EE2599087.Vl_Event7_All_Active_Flag_;
    __EE2599087.Vl_Event30_All_Active_Flag_;
    __EE2599087.Vl_Event1_Count_;
    __EE2599087.Vl_Event7_Count_;
    __EE2599087.Vl_Event30_Count_;
    __EE2599087.Vl_Event365_Count_;
    __EE2599087.Vl_Event7_Active_Flag_;
    __EE2599087.Vl_Event30_Active_Flag_;
    __EE2599087.Date_First_Seen_;
    __EE2599087.Date_Last_Seen_;
    __EE2599087.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2599087,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2599089_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST43580_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
