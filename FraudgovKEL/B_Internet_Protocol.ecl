...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE3601456 := __ENH_Internet_Protocol_1;
  SHARED __EE3689562 := __E_Person_Ip_Address;
  SHARED __EE3689569 := __EE3689562(__NN(__EE3689562.Ip_));
  SHARED __ST3677160_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3689583 := PROJECT(TABLE(PROJECT(__EE3689569,TRANSFORM(__ST3677160_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST3677160_Layout);
  SHARED __ST3677178_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3689549 := PROJECT(__CLEANANDDO(__EE3689583,TABLE(__EE3689583,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST3677178_Layout);
  SHARED __ST3681216_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3689592(B_Internet_Protocol_1.__ST78942_Layout __EE3601456, __ST3677178_Layout __EE3689549) := __EEQP(__EE3601456.UID,__EE3689549.UID);
  __ST3681216_Layout __JT3689592(B_Internet_Protocol_1.__ST78942_Layout __l, __ST3677178_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3689593 := JOIN(__EE3601456,__EE3689549,__JC3689592(LEFT,RIGHT),__JT3689592(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3689553 := __ENH_Event_1;
  SHARED __EE3689551 := __E_Internet_Protocol_Event;
  SHARED __EE3692788 := __EE3689551(__NN(__EE3689551.Ip_) AND __NN(__EE3689551.Transaction_));
  SHARED __ST3677781_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3692806(B_Event_1.__ST77751_Layout __EE3689553, E_Internet_Protocol_Event.Layout __EE3692788) := __EEQP(__EE3692788.Transaction_,__EE3689553.UID);
  __ST3677781_Layout __JT3692806(B_Event_1.__ST77751_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3692807 := JOIN(__EE3692788,__EE3689553,__JC3692806(RIGHT,LEFT),__JT3692806(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3673240_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3673240_Layout __ND3693499__Project(__ST3677781_Layout __PP3692808) := TRANSFORM
    SELF.UID := __PP3692808.Ip_;
    SELF._r_Customer_ := __PP3692808._r_Customer__1_;
    SELF.Event_Date_ := __PP3692808.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3692808.UID;
    SELF.Event_Date__1_ := __PP3692808.Event_Date_;
    SELF._r_Customer__1_ := __PP3692808._r_Customer_;
    SELF := __PP3692808;
  END;
  SHARED __EE3696228 := PROJECT(__EE3692807,__ND3693499__Project(LEFT));
  SHARED __ST3674721_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3674721_Layout __ND3697702__Project(__ST3673240_Layout __PP3696229) := TRANSFORM
    SELF.Exp1_ := __PP3696229.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP3696229.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP3696229.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP3696229.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP3696229.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP3696229.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP3696229.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP3696229.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP3696229.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP3696229.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP3696229.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP3696229.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP3696229.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP3696229.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP3696229.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP3696229.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP3696229.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP3696229.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP3696229.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP3696229.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP3696229.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP3696229.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP3696229.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP3696229.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP3696229.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP3696229.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP3696229.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP3696229.Safe_Flag_ = 1;
    SELF.Exp28_ := __OP2(__PP3696229.Event_Age_,<,__CN(2));
    SELF.Exp29_ := __AND(__OP2(__PP3696229.Event_Age_,<,__CN(2)),__CN(__PP3696229.In_Customer_Population_ = 1));
    SELF.Exp30_ := __OP2(__PP3696229.Event_Age_,<,__CN(366));
    SELF := __PP3696229;
  END;
  SHARED __EE3697742 := PROJECT(__EE3696228,__ND3697702__Project(LEFT));
  SHARED __ST3674889_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3697916 := PROJECT(__CLEANANDDO(__EE3697742,TABLE(__EE3697742,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3697742.Exp1_),KEL.Aggregates.MinNG(__EE3697742.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE3697742.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3697742.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3697742.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3697742.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3697742.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3697742.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3697742.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3697742.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3697742.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3697742.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3697742.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3697742.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3697742.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3697742.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE3697742.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE3697742.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE3697742.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE3697742.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE3697742.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE3697742.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE3697742.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE3697742.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE3697742.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE3697742.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE3697742.Exp26_),KEL.Aggregates.MaxNG(__EE3697742.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE3697742.Exp27_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE3697742.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE3697742.Exp29_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE3697742.Exp30_)),UID},UID,MERGE)),__ST3674889_Layout);
  SHARED __ST3681927_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3697922(__ST3681216_Layout __EE3689593, __ST3674889_Layout __EE3697916) := __EEQP(__EE3689593.UID,__EE3697916.UID);
  __ST3681927_Layout __JT3697922(__ST3681216_Layout __l, __ST3674889_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3698070 := JOIN(__EE3689593,__EE3697916,__JC3697922(LEFT,RIGHT),__JT3697922(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3581952 := __ENH_Customer_1;
  SHARED __ST3682782_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3698076(__ST3681927_Layout __EE3698070, B_Customer_1.__ST69603_Layout __EE3581952) := __EEQP(__EE3698070._r_Customer_,__EE3581952.UID);
  __ST3682782_Layout __JT3698076(__ST3681927_Layout __l, B_Customer_1.__ST69603_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3698246 := JOIN(__EE3698070,__EE3581952,__JC3698076(LEFT,RIGHT),__JT3698076(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST64268_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST64268_Layout __ND3698251__Project(__ST3682782_Layout __PP3698247) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3698247.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP3698247.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP3698247.M_I_N___Event_Date__2_;
    SELF.Identity_Count_ := __PP3698247.C_O_U_N_T___Person_Ip_Address_;
    __BS3698615 := __T(__PP3698247.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3698615(__T(__OP2(__T(__PP3698247.Source_Customers_)._r_Source_Customer_,=,__PP3698247._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP3698247.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP3698247.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP3698247.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP3698247.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP3698247.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP3698247.Ip_Address_;
    SELF.Last_Event_Date_ := __PP3698247.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3698247.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3698247.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3698247.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP3698247.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3698247.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3698247.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3698247.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3698247.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3698247.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3698247;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE3698246,__ND3698251__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4265920 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4265920._r_Customer_;
    __EE4265920.Source_Customers_;
    __EE4265920.Ip_Address_;
    __EE4265920.Otto_Ip_Address_Id_;
    __EE4265920._host_;
    __EE4265920._alias_;
    __EE4265920._location_;
    __EE4265920._ip__address_;
    __EE4265920._ip__address__date_;
    __EE4265920._version_;
    __EE4265920._class_;
    __EE4265920._subnet__mask_;
    __EE4265920._reserved_;
    __EE4265920._isp_;
    __EE4265920._v2__validationipproblems_;
    __EE4265920._v2__ipstate_;
    __EE4265920._v2__ipcountry_;
    __EE4265920._v2__ipcontinent_;
    __EE4265920._iprngbeg_;
    __EE4265920._iprngend_;
    __EE4265920._edgecountry_;
    __EE4265920._edgeregion_;
    __EE4265920._edgecity_;
    __EE4265920._edgeconnspeed_;
    __EE4265920._edgemetrocode_;
    __EE4265920._edgelatitude_;
    __EE4265920._edgelongitude_;
    __EE4265920._edgepostalcode_;
    __EE4265920._edgecountrycode_;
    __EE4265920._edgeregioncode_;
    __EE4265920._edgecitycode_;
    __EE4265920._edgecontinentcode_;
    __EE4265920._edgetwolettercountry_;
    __EE4265920._edgeinternalcode_;
    __EE4265920._edgeareacodes_;
    __EE4265920._edgecountryconf_;
    __EE4265920._edgeregionconf_;
    __EE4265920._edgecitycong_;
    __EE4265920._edgepostalconf_;
    __EE4265920._edgegmtoffset_;
    __EE4265920._edgeindst_;
    __EE4265920._siccode_;
    __EE4265920._domainname_;
    __EE4265920._ispname_;
    __EE4265920._homebiztype_;
    __EE4265920._asn_;
    __EE4265920._asnname_;
    __EE4265920._primarylang_;
    __EE4265920._secondarylang_;
    __EE4265920._proxytype_;
    __EE4265920._proxydescription_;
    __EE4265920._isanisp_;
    __EE4265920._companyname_;
    __EE4265920._ranks_;
    __EE4265920._households_;
    __EE4265920._women_;
    __EE4265920._women18to34_;
    __EE4265920._women35to49_;
    __EE4265920._men_;
    __EE4265920._men18to34_;
    __EE4265920._men35to49_;
    __EE4265920._teens_;
    __EE4265920._kids_;
    __EE4265920._naicscode_;
    __EE4265920._cbsacode_;
    __EE4265920._cbsatitle_;
    __EE4265920._cbsatype_;
    __EE4265920._csacode_;
    __EE4265920._csatitle_;
    __EE4265920._mdcode_;
    __EE4265920._mdtitle_;
    __EE4265920._organizationname_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4265920.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4265920.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4265920.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4265920.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4265920.Aot_Id_Act_Cnt_Ev_;
    __EE4265920.Aot_Id_Act_Cnt30_D_;
    __EE4265920.Aot_Add_Act_Cnt_Ev_;
    __EE4265920.Aot_Add_Act_Cnt30_D_;
    __EE4265920.Aot_Non_St_Act_Cnt_Ev_;
    __EE4265920.Aot_Non_St_Act_Cnt30_D_;
    __EE4265920.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4265920.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4265920.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4265920.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4265920.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4265920.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4265920.Customer_Id_;
    __EE4265920.Industry_Type_;
    __EE4265920.Source_Customer_Count_;
    __EE4265920.Entity_Context_Uid_;
    __EE4265920.Label_;
    __EE4265920.Entity_Type_;
    __EE4265920.In_Customer_Population_;
    __EE4265920.Dt_First_Seen_;
    __EE4265920.Dt_Last_Seen_;
    __EE4265920.Id_Activity_Dt_First_Seen_;
    __EE4265920.Id_Activity_Dt_Last_Seen_;
    __EE4265920.Last_Record_Id_;
    __EE4265920.Identity_Count_;
    __EE4265920.Event_Count_;
    __EE4265920.Ip_Not_Us_;
    __EE4265920.Ip_Vpn_;
    __EE4265920.Ip_High_Risk_City_;
    __EE4265920.Ip_Hosted_;
    __EE4265920.Ip_Tor_;
    __EE4265920.Kr_High_Risk_Flag_;
    __EE4265920.Kr_Medium_Risk_Flag_;
    __EE4265920.Kr_Low_Risk_Flag_;
    __EE4265920.Kr_Flag_;
    __EE4265920.Safe_Flag_;
    __EE4265920.Contributor_Safe_Flag_;
    __EE4265920.Kr_Ip600_Flag_;
    __EE4265920.Kr_Ip601_Flag_;
    __EE4265920.Kr_Ip602_Flag_;
    __EE4265920.Kr_Ip603_Flag_;
    __EE4265920.Kr_Ip604_Flag_;
    __EE4265920.Kr_Ip605_Flag_;
    __EE4265920.Kr_Ip690_Flag_;
    __EE4265920.Kr_Ip691_Flag_;
    __EE4265920.Kr_Ip692_Flag_;
    __EE4265920.Kr_Ip693_Flag_;
    __EE4265920.Kr_Ip1000_Flag_;
    __EE4265920.Kr_Ip1001_Flag_;
    __EE4265920.Kr_Ip1090_Flag_;
    __EE4265920.Kr_Ip1091_Flag_;
    __EE4265920.Kr_Ip1092_Flag_;
    __EE4265920.Kr_Ip1093_Flag_;
    __EE4265920.Last_Event_Date_;
    __EE4265920.Kr_Last_Event_Date_;
    __EE4265920.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4265920.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4265920.Vl_Event1_All_Count_;
    __EE4265920.Vl_Event7_All_Count_;
    __EE4265920.Vl_Event30_All_Day_Count_;
    __EE4265920.Vl_Event365_All_Day_Count_;
    __EE4265920.Vl_Event7_All_Active_Flag_;
    __EE4265920.Vl_Event30_All_Active_Flag_;
    __EE4265920.Vl_Event1_Count_;
    __EE4265920.Vl_Event7_Count_;
    __EE4265920.Vl_Event30_Count_;
    __EE4265920.Vl_Event365_Count_;
    __EE4265920.Vl_Event7_Active_Flag_;
    __EE4265920.Vl_Event30_Active_Flag_;
    __EE4265920.Date_First_Seen_;
    __EE4265920.Date_Last_Seen_;
    __EE4265920.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4265920,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4265922_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST64268_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
