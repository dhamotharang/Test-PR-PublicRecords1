...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE1986099 := __ENH_Internet_Protocol_1;
  SHARED __EE2058315 := __E_Person_Ip_Address;
  SHARED __EE2058322 := __EE2058315(__NN(__EE2058315.Ip_));
  SHARED __ST2047515_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2058336 := PROJECT(TABLE(PROJECT(__EE2058322,TRANSFORM(__ST2047515_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST2047515_Layout);
  SHARED __ST2047533_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2058302 := PROJECT(__CLEANANDDO(__EE2058336,TABLE(__EE2058336,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST2047533_Layout);
  SHARED __ST2050945_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2058345(B_Internet_Protocol_1.__ST54264_Layout __EE1986099, __ST2047533_Layout __EE2058302) := __EEQP(__EE1986099.UID,__EE2058302.UID);
  __ST2050945_Layout __JT2058345(B_Internet_Protocol_1.__ST54264_Layout __l, __ST2047533_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2058346 := JOIN(__EE1986099,__EE2058302,__JC2058345(LEFT,RIGHT),__JT2058345(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2058306 := __ENH_Event_1;
  SHARED __EE2058304 := __E_Internet_Protocol_Event;
  SHARED __EE2061053 := __EE2058304(__NN(__EE2058304.Ip_) AND __NN(__EE2058304.Transaction_));
  SHARED __ST2048100_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2061071(B_Event_1.__ST53380_Layout __EE2058306, E_Internet_Protocol_Event.Layout __EE2061053) := __EEQP(__EE2061053.Transaction_,__EE2058306.UID);
  __ST2048100_Layout __JT2061071(B_Event_1.__ST53380_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2061072 := JOIN(__EE2061053,__EE2058306,__JC2061071(RIGHT,LEFT),__JT2061071(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2044117_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2044117_Layout __ND2061646__Project(__ST2048100_Layout __PP2061073) := TRANSFORM
    SELF.UID := __PP2061073.Ip_;
    SELF._r_Customer_ := __PP2061073._r_Customer__1_;
    SELF.Event_Date_ := __PP2061073.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2061073.UID;
    SELF.Event_Date__1_ := __PP2061073.Event_Date_;
    SELF._r_Customer__1_ := __PP2061073._r_Customer_;
    SELF := __PP2061073;
  END;
  SHARED __EE2063903 := PROJECT(__EE2061072,__ND2061646__Project(LEFT));
  SHARED __ST2045356_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2045356_Layout __ND2065267__Project(__ST2044117_Layout __PP2063904) := TRANSFORM
    SELF.Exp1_ := __PP2063904.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2063904.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP2063904.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP2063904.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP2063904.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP2063904.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP2063904.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP2063904.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP2063904.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP2063904.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP2063904.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP2063904.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP2063904.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP2063904.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP2063904.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP2063904.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP2063904.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP2063904.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP2063904.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP2063904.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP2063904.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP2063904.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP2063904.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP2063904.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP2063904.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP2063904.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP2063904.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP2063904.Event_Age_,<,__CN(2)),__CN(__PP2063904.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP2063904.Event_Age_,<,__CN(366));
    SELF := __PP2063904;
  END;
  SHARED __EE2065306 := PROJECT(__EE2063903,__ND2065267__Project(LEFT));
  SHARED __ST2045519_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2065475 := PROJECT(__CLEANANDDO(__EE2065306,TABLE(__EE2065306,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2065306.Exp1_),KEL.Aggregates.MinNG(__EE2065306.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2065306.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2065306.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2065306.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2065306.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2065306.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2065306.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2065306.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2065306.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2065306.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2065306.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2065306.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2065306.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2065306.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE2065306.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE2065306.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE2065306.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE2065306.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE2065306.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE2065306.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE2065306.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE2065306.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE2065306.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE2065306.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE2065306.Exp25_),KEL.Aggregates.MaxNG(__EE2065306.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE2065306.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE2065306.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE2065306.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE2065306.Exp29_)),UID},UID,MERGE)),__ST2045519_Layout);
  SHARED __ST2051589_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2065481(__ST2050945_Layout __EE2058346, __ST2045519_Layout __EE2065475) := __EEQP(__EE2058346.UID,__EE2065475.UID);
  __ST2051589_Layout __JT2065481(__ST2050945_Layout __l, __ST2045519_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2065615 := JOIN(__EE2058346,__EE2065475,__JC2065481(LEFT,RIGHT),__JT2065481(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1974022 := __ENH_Customer_1;
  SHARED __ST2052374_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2065621(__ST2051589_Layout __EE2065615, B_Customer_1.__ST47785_Layout __EE1974022) := __EEQP(__EE2065615._r_Customer_,__EE1974022.UID);
  __ST2052374_Layout __JT2065621(__ST2051589_Layout __l, B_Customer_1.__ST47785_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2065777 := JOIN(__EE2065615,__EE1974022,__JC2065621(LEFT,RIGHT),__JT2065621(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43503_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43503_Layout __ND2065782__Project(__ST2052374_Layout __PP2065778) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2065778.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP2065778.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP2065778.C_O_U_N_T___Person_Ip_Address_;
    __BS2066104 := __T(__PP2065778.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2066104(__T(__OP2(__T(__PP2065778.Source_Customers_)._r_Source_Customer_,=,__PP2065778._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP2065778.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP2065778.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP2065778.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP2065778.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP2065778.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP2065778.Ip_Address_;
    SELF.Last_Event_Date_ := __PP2065778.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2065778.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2065778.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2065778.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP2065778.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2065778.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2065778.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2065778.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2065778.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2065778.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2065778;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE2065777,__ND2065782__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2523360 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2523360._r_Customer_;
    __EE2523360.Source_Customers_;
    __EE2523360.Ip_Address_;
    __EE2523360.Otto_Ip_Address_Id_;
    __EE2523360._host_;
    __EE2523360._alias_;
    __EE2523360._location_;
    __EE2523360._ip__address_;
    __EE2523360._ip__address__date_;
    __EE2523360._version_;
    __EE2523360._class_;
    __EE2523360._subnet__mask_;
    __EE2523360._reserved_;
    __EE2523360._isp_;
    __EE2523360._v2__validationipproblems_;
    __EE2523360._v2__ipstate_;
    __EE2523360._v2__ipcountry_;
    __EE2523360._v2__ipcontinent_;
    __EE2523360._iprngbeg_;
    __EE2523360._iprngend_;
    __EE2523360._edgecountry_;
    __EE2523360._edgeregion_;
    __EE2523360._edgecity_;
    __EE2523360._edgeconnspeed_;
    __EE2523360._edgemetrocode_;
    __EE2523360._edgelatitude_;
    __EE2523360._edgelongitude_;
    __EE2523360._edgepostalcode_;
    __EE2523360._edgecountrycode_;
    __EE2523360._edgeregioncode_;
    __EE2523360._edgecitycode_;
    __EE2523360._edgecontinentcode_;
    __EE2523360._edgetwolettercountry_;
    __EE2523360._edgeinternalcode_;
    __EE2523360._edgeareacodes_;
    __EE2523360._edgecountryconf_;
    __EE2523360._edgeregionconf_;
    __EE2523360._edgecitycong_;
    __EE2523360._edgepostalconf_;
    __EE2523360._edgegmtoffset_;
    __EE2523360._edgeindst_;
    __EE2523360._siccode_;
    __EE2523360._domainname_;
    __EE2523360._ispname_;
    __EE2523360._homebiztype_;
    __EE2523360._asn_;
    __EE2523360._asnname_;
    __EE2523360._primarylang_;
    __EE2523360._secondarylang_;
    __EE2523360._proxytype_;
    __EE2523360._proxydescription_;
    __EE2523360._isanisp_;
    __EE2523360._companyname_;
    __EE2523360._ranks_;
    __EE2523360._households_;
    __EE2523360._women_;
    __EE2523360._women18to34_;
    __EE2523360._women35to49_;
    __EE2523360._men_;
    __EE2523360._men18to34_;
    __EE2523360._men35to49_;
    __EE2523360._teens_;
    __EE2523360._kids_;
    __EE2523360._naicscode_;
    __EE2523360._cbsacode_;
    __EE2523360._cbsatitle_;
    __EE2523360._cbsatype_;
    __EE2523360._csacode_;
    __EE2523360._csatitle_;
    __EE2523360._mdcode_;
    __EE2523360._mdtitle_;
    __EE2523360._organizationname_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2523360.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2523360.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2523360.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2523360.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2523360.Customer_Id_;
    __EE2523360.Industry_Type_;
    __EE2523360.Source_Customer_Count_;
    __EE2523360.Entity_Context_Uid_;
    __EE2523360.Label_;
    __EE2523360.Entity_Type_;
    __EE2523360.In_Customer_Population_;
    __EE2523360.Dt_First_Seen_;
    __EE2523360.Dt_Last_Seen_;
    __EE2523360.Last_Record_Id_;
    __EE2523360.Identity_Count_;
    __EE2523360.Event_Count_;
    __EE2523360.Ip_Not_Us_;
    __EE2523360.Ip_Vpn_;
    __EE2523360.Ip_High_Risk_City_;
    __EE2523360.Ip_Hosted_;
    __EE2523360.Ip_Tor_;
    __EE2523360.Kr_High_Risk_Flag_;
    __EE2523360.Kr_Medium_Risk_Flag_;
    __EE2523360.Kr_Low_Risk_Flag_;
    __EE2523360.Kr_Flag_;
    __EE2523360.Safe_Flag_;
    __EE2523360.Contributor_Safe_Flag_;
    __EE2523360.Kr_Ip600_Flag_;
    __EE2523360.Kr_Ip601_Flag_;
    __EE2523360.Kr_Ip602_Flag_;
    __EE2523360.Kr_Ip603_Flag_;
    __EE2523360.Kr_Ip604_Flag_;
    __EE2523360.Kr_Ip605_Flag_;
    __EE2523360.Kr_Ip690_Flag_;
    __EE2523360.Kr_Ip691_Flag_;
    __EE2523360.Kr_Ip692_Flag_;
    __EE2523360.Kr_Ip693_Flag_;
    __EE2523360.Kr_Ip1000_Flag_;
    __EE2523360.Kr_Ip1001_Flag_;
    __EE2523360.Kr_Ip1090_Flag_;
    __EE2523360.Kr_Ip1091_Flag_;
    __EE2523360.Kr_Ip1092_Flag_;
    __EE2523360.Kr_Ip1093_Flag_;
    __EE2523360.Last_Event_Date_;
    __EE2523360.Kr_Last_Event_Date_;
    __EE2523360.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2523360.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2523360.Vl_Event1_All_Count_;
    __EE2523360.Vl_Event7_All_Count_;
    __EE2523360.Vl_Event30_All_Day_Count_;
    __EE2523360.Vl_Event365_All_Day_Count_;
    __EE2523360.Vl_Event7_All_Active_Flag_;
    __EE2523360.Vl_Event30_All_Active_Flag_;
    __EE2523360.Vl_Event1_Count_;
    __EE2523360.Vl_Event7_Count_;
    __EE2523360.Vl_Event30_Count_;
    __EE2523360.Vl_Event365_Count_;
    __EE2523360.Vl_Event7_Active_Flag_;
    __EE2523360.Vl_Event30_Active_Flag_;
    __EE2523360.Date_First_Seen_;
    __EE2523360.Date_Last_Seen_;
    __EE2523360.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2523360,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2523362_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST43503_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
