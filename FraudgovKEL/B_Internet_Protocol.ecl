...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE1885388 := __ENH_Internet_Protocol_1;
  SHARED __EE1954580 := __E_Person_Ip_Address;
  SHARED __EE1954587 := __EE1954580(__NN(__EE1954580.Ip_));
  SHARED __ST1944050_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1954601 := PROJECT(TABLE(PROJECT(__EE1954587,TRANSFORM(__ST1944050_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST1944050_Layout);
  SHARED __ST1944068_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1954567 := PROJECT(__CLEANANDDO(__EE1954601,TABLE(__EE1954601,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST1944068_Layout);
  SHARED __ST1947345_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1954610(B_Internet_Protocol_1.__ST53914_Layout __EE1885388, __ST1944068_Layout __EE1954567) := __EEQP(__EE1885388.UID,__EE1954567.UID);
  __ST1947345_Layout __JT1954610(B_Internet_Protocol_1.__ST53914_Layout __l, __ST1944068_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1954611 := JOIN(__EE1885388,__EE1954567,__JC1954610(LEFT,RIGHT),__JT1954610(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1954571 := __ENH_Event_1;
  SHARED __EE1954569 := __E_Internet_Protocol_Event;
  SHARED __EE1957210 := __EE1954569(__NN(__EE1954569.Ip_) AND __NN(__EE1954569.Transaction_));
  SHARED __ST1944635_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1957228(B_Event_1.__ST53057_Layout __EE1954571, E_Internet_Protocol_Event.Layout __EE1957210) := __EEQP(__EE1957210.Transaction_,__EE1954571.UID);
  __ST1944635_Layout __JT1957228(B_Event_1.__ST53057_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1957229 := JOIN(__EE1957210,__EE1954571,__JC1957228(RIGHT,LEFT),__JT1957228(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1940760_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1940760_Layout __ND1957776__Project(__ST1944635_Layout __PP1957230) := TRANSFORM
    SELF.UID := __PP1957230.Ip_;
    SELF._r_Customer_ := __PP1957230._r_Customer__1_;
    SELF.Event_Date_ := __PP1957230.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1957230.UID;
    SELF.Event_Date__1_ := __PP1957230.Event_Date_;
    SELF._r_Customer__1_ := __PP1957230._r_Customer_;
    SELF := __PP1957230;
  END;
  SHARED __EE1959925 := PROJECT(__EE1957229,__ND1957776__Project(LEFT));
  SHARED __ST1941945_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1941945_Layout __ND1961289__Project(__ST1940760_Layout __PP1959926) := TRANSFORM
    SELF.Exp1_ := __PP1959926.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1959926.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP1959926.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP1959926.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP1959926.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP1959926.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP1959926.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP1959926.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP1959926.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP1959926.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP1959926.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP1959926.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP1959926.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP1959926.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP1959926.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP1959926.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP1959926.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP1959926.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP1959926.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP1959926.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP1959926.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP1959926.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP1959926.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP1959926.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP1959926.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP1959926.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP1959926.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP1959926.Event_Age_,<,__CN(2)),__CN(__PP1959926.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP1959926.Event_Age_,<,__CN(366));
    SELF := __PP1959926;
  END;
  SHARED __EE1961328 := PROJECT(__EE1959925,__ND1961289__Project(LEFT));
  SHARED __ST1942108_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1961497 := PROJECT(__CLEANANDDO(__EE1961328,TABLE(__EE1961328,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1961328.Exp1_),KEL.Aggregates.MinNG(__EE1961328.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1961328.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1961328.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1961328.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1961328.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1961328.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1961328.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1961328.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1961328.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1961328.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1961328.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1961328.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1961328.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1961328.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1961328.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1961328.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1961328.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1961328.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1961328.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1961328.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1961328.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE1961328.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE1961328.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE1961328.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE1961328.Exp25_),KEL.Aggregates.MaxNG(__EE1961328.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE1961328.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE1961328.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE1961328.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE1961328.Exp29_)),UID},UID,MERGE)),__ST1942108_Layout);
  SHARED __ST1947989_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1961503(__ST1947345_Layout __EE1954611, __ST1942108_Layout __EE1961497) := __EEQP(__EE1954611.UID,__EE1961497.UID);
  __ST1947989_Layout __JT1961503(__ST1947345_Layout __l, __ST1942108_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1961637 := JOIN(__EE1954611,__EE1961497,__JC1961503(LEFT,RIGHT),__JT1961503(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1873743 := __ENH_Customer_1;
  SHARED __ST1948774_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1961643(__ST1947989_Layout __EE1961637, B_Customer_1.__ST47489_Layout __EE1873743) := __EEQP(__EE1961637._r_Customer_,__EE1873743.UID);
  __ST1948774_Layout __JT1961643(__ST1947989_Layout __l, B_Customer_1.__ST47489_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1961799 := JOIN(__EE1961637,__EE1873743,__JC1961643(LEFT,RIGHT),__JT1961643(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43207_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43207_Layout __ND1961804__Project(__ST1948774_Layout __PP1961800) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1961800.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP1961800.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP1961800.C_O_U_N_T___Person_Ip_Address_;
    __BS1962126 := __T(__PP1961800.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1962126(__T(__OP2(__T(__PP1961800.Source_Customers_)._r_Source_Customer_,=,__PP1961800._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP1961800.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP1961800.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP1961800.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP1961800.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP1961800.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP1961800.Ip_Address_;
    SELF.Last_Event_Date_ := __PP1961800.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1961800.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1961800.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __P
Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2407159.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2407159.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2407159.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2407159.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2407159.Customer_Id_;
    __EE2407159.Industry_Type_;
    __EE2407159.Source_Customer_Count_;
    __EE2407159.Entity_Context_Uid_;
    __EE2407159.Label_;
    __EE2407159.Entity_Type_;
    __EE2407159.In_Customer_Population_;
    __EE2407159.Dt_First_Seen_;
    __EE2407159.Dt_Last_Seen_;
    __EE2407159.Last_Record_Id_;
    __EE2407159.Identity_Count_;
    __EE2407159.Event_Count_;
    __EE2407159.Ip_Not_Us_;
    __EE2407159.Ip_Vpn_;
    __EE2407159.Ip_High_Risk_City_;
    __EE2407159.Ip_Hosted_;
    __EE2407159.Ip_Tor_;
    __EE2407159.Kr_High_Risk_Flag_;
    __EE2407159.Kr_Medium_Risk_Flag_;
    __EE2407159.Kr_Low_Risk_Flag_;
    __EE2407159.Kr_Flag_;
    __EE2407159.Safe_Flag_;
    __EE2407159.Contributor_Safe_Flag_;
    __EE2407159.Kr_Ip600_Flag_;
    __EE2407159.Kr_Ip601_Flag_;
    __EE2407159.Kr_Ip602_Flag_;
    __EE2407159.Kr_Ip603_Flag_;
    __EE2407159.Kr_Ip604_Flag_;
    __EE2407159.Kr_Ip605_Flag_;
    __EE2407159.Kr_Ip690_Flag_;
    __EE2407159.Kr_Ip691_Flag_;
    __EE2407159.Kr_Ip692_Flag_;
    __EE2407159.Kr_Ip693_Flag_;
    __EE2407159.Kr_Ip1000_Flag_;
    __EE2407159.Kr_Ip1001_Flag_;
    __EE2407159.Kr_Ip1090_Flag_;
    __EE2407159.Kr_Ip1091_Flag_;
    __EE2407159.Kr_Ip1092_Flag_;
    __EE2407159.Kr_Ip1093_Flag_;
    __EE2407159.Last_Event_Date_;
    __EE2407159.Kr_Last_Event_Date_;
    __EE2407159.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2407159.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2407159.Vl_Event1_All_Count_;
    __EE2407159.Vl_Event7_All_Count_;
    __EE2407159.Vl_Event30_All_Day_Count_;
    __EE2407159.Vl_Event365_All_Day_Count_;
    __EE2407159.Vl_Event7_All_Active_Flag_;
    __EE2407159.Vl_Event30_All_Active_Flag_;
    __EE2407159.Vl_Event1_Count_;
    __EE2407159.Vl_Event7_Count_;
    __EE2407159.Vl_Event30_Count_;
    __EE2407159.Vl_Event365_Count_;
    __EE2407159.Vl_Event7_Active_Flag_;
    __EE2407159.Vl_Event30_Active_Flag_;
    __EE2407159.Date_First_Seen_;
    __EE2407159.Date_Last_Seen_;
    __EE2407159.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2407159,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2407161_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST43207_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
