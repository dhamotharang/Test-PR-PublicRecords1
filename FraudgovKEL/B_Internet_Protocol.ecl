...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE1878053 := __ENH_Internet_Protocol_1;
  SHARED __EE1947021 := __E_Person_Ip_Address;
  SHARED __EE1947028 := __EE1947021(__NN(__EE1947021.Ip_));
  SHARED __ST1936511_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1947042 := PROJECT(TABLE(PROJECT(__EE1947028,TRANSFORM(__ST1936511_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST1936511_Layout);
  SHARED __ST1936529_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1947008 := PROJECT(__CLEANANDDO(__EE1947042,TABLE(__EE1947042,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST1936529_Layout);
  SHARED __ST1939796_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1947051(B_Internet_Protocol_1.__ST53900_Layout __EE1878053, __ST1936529_Layout __EE1947008) := __EEQP(__EE1878053.UID,__EE1947008.UID);
  __ST1939796_Layout __JT1947051(B_Internet_Protocol_1.__ST53900_Layout __l, __ST1936529_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1947052 := JOIN(__EE1878053,__EE1947008,__JC1947051(LEFT,RIGHT),__JT1947051(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1947012 := __ENH_Event_1;
  SHARED __EE1947010 := __E_Internet_Protocol_Event;
  SHARED __EE1949643 := __EE1947010(__NN(__EE1947010.Ip_) AND __NN(__EE1947010.Transaction_));
  SHARED __ST1937096_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1949661(B_Event_1.__ST53045_Layout __EE1947012, E_Internet_Protocol_Event.Layout __EE1949643) := __EEQP(__EE1949643.Transaction_,__EE1947012.UID);
  __ST1937096_Layout __JT1949661(B_Event_1.__ST53045_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1949662 := JOIN(__EE1949643,__EE1947012,__JC1949661(RIGHT,LEFT),__JT1949661(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1933229_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1933229_Layout __ND1950207__Project(__ST1937096_Layout __PP1949663) := TRANSFORM
    SELF.UID := __PP1949663.Ip_;
    SELF._r_Customer_ := __PP1949663._r_Customer__1_;
    SELF.Event_Date_ := __PP1949663.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1949663.UID;
    SELF.Event_Date__1_ := __PP1949663.Event_Date_;
    SELF._r_Customer__1_ := __PP1949663._r_Customer_;
    SELF := __PP1949663;
  END;
  SHARED __EE1952348 := PROJECT(__EE1949662,__ND1950207__Project(LEFT));
  SHARED __ST1934410_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1934410_Layout __ND1953712__Project(__ST1933229_Layout __PP1952349) := TRANSFORM
    SELF.Exp1_ := __PP1952349.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1952349.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP1952349.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP1952349.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP1952349.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP1952349.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP1952349.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP1952349.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP1952349.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP1952349.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP1952349.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP1952349.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP1952349.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP1952349.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP1952349.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP1952349.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP1952349.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP1952349.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP1952349.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP1952349.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP1952349.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP1952349.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP1952349.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP1952349.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP1952349.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP1952349.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP1952349.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP1952349.Event_Age_,<,__CN(2)),__CN(__PP1952349.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP1952349.Event_Age_,<,__CN(366));
    SELF := __PP1952349;
  END;
  SHARED __EE1953751 := PROJECT(__EE1952348,__ND1953712__Project(LEFT));
  SHARED __ST1934573_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1953920 := PROJECT(__CLEANANDDO(__EE1953751,TABLE(__EE1953751,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1953751.Exp1_),KEL.Aggregates.MinNG(__EE1953751.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1953751.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1953751.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1953751.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1953751.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1953751.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1953751.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1953751.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1953751.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1953751.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1953751.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1953751.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1953751.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1953751.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1953751.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1953751.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1953751.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1953751.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1953751.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1953751.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1953751.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE1953751.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE1953751.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE1953751.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE1953751.Exp25_),KEL.Aggregates.MaxNG(__EE1953751.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE1953751.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE1953751.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE1953751.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE1953751.Exp29_)),UID},UID,MERGE)),__ST1934573_Layout);
  SHARED __ST1940440_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1953926(__ST1939796_Layout __EE1947052, __ST1934573_Layout __EE1953920) := __EEQP(__EE1947052.UID,__EE1953920.UID);
  __ST1940440_Layout __JT1953926(__ST1939796_Layout __l, __ST1934573_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1954060 := JOIN(__EE1947052,__EE1953920,__JC1953926(LEFT,RIGHT),__JT1953926(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1866440 := __ENH_Customer_1;
  SHARED __ST1941225_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1954066(__ST1940440_Layout __EE1954060, B_Customer_1.__ST47479_Layout __EE1866440) := __EEQP(__EE1954060._r_Customer_,__EE1866440.UID);
  __ST1941225_Layout __JT1954066(__ST1940440_Layout __l, B_Customer_1.__ST47479_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1954222 := JOIN(__EE1954060,__EE1866440,__JC1954066(LEFT,RIGHT),__JT1954066(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST43197_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST43197_Layout __ND1954227__Project(__ST1941225_Layout __PP1954223) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1954223.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP1954223.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP1954223.C_O_U_N_T___Person_Ip_Address_;
    __BS1954549 := __T(__PP1954223.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1954549(__T(__OP2(__T(__PP1954223.Source_Customers_)._r_Source_Customer_,=,__PP1954223._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP1954223.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP1954223.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP1954223.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP1954223.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP1954223.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP1954223.Ip_Address_;
    SELF.Last_Event_Date_ := __PP1954223.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1954223.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1954223.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1954223.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP1954223.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1954223.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1954223.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1954223.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1954223.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1954223.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1954223;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE1954222,__ND1954227__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2397778 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2397778._r_Customer_;
    __EE2397778.Source_Customers_;
    __EE2397778.Ip_Address_;
    __EE2397778.Otto_Ip_Address_Id_;
    __EE2397778._host_;
    __EE2397778._alias_;
    __EE2397778._location_;
    __EE2397778._ip__address_;
    __EE2397778._ip__address__date_;
    __EE2397778._version_;
    __EE2397778._class_;
    __EE2397778._subnet__mask_;
    __EE2397778._reserved_;
    __EE2397778._isp_;
    __EE2397778._v2__validationipproblems_;
    __EE2397778._v2__ipstate_;
    __EE2397778._v2__ipcountry_;
    __EE2397778._v2__ipcontinent_;
    __EE2397778._iprngbeg_;
    __EE2397778._iprngend_;
    __EE2397778._edgecountry_;
    __EE2397778._edgeregion_;
    __EE2397778._edgecity_;
    __EE2397778._edgeconnspeed_;
    __EE2397778._edgemetrocode_;
    __EE2397778._edgelatitude_;
    __EE2397778._edgelongitude_;
    __EE2397778._edgepostalcode_;
    __EE2397778._edgecountrycode_;
    __EE2397778._edgeregioncode_;
    __EE2397778._edgecitycode_;
    __EE2397778._edgecontinentcode_;
    __EE2397778._edgetwolettercountry_;
    __EE2397778._edgeinternalcode_;
    __EE2397778._edgeareacodes_;
    __EE2397778._edgecountryconf_;
    __EE2397778._edgeregionconf_;
    __EE2397778._edgecitycong_;
    __EE2397778._edgepostalconf_;
    __EE2397778._edgegmtoffset_;
    __EE2397778._edgeindst_;
    __EE2397778._siccode_;
    __EE2397778._domainname_;
    __EE2397778._ispname_;
    __EE2397778._homebiztype_;
    __EE2397778._asn_;
    __EE2397778._asnname_;
    __EE2397778._primarylang_;
    __EE2397778._secondarylang_;
    __EE2397778._proxytype_;
    __EE2397778._proxydescription_;
    __EE2397778._isanisp_;
    __EE2397778._companyname_;
    __EE2397778._ranks_;
    __EE2397778._households_;
    __EE2397778._women_;
    __EE2397778._women18to34_;
    __EE2397778._women35to49_;
    __EE2397778._men_;
    __EE2397778._men18to34_;
    __EE2397778._men35to49_;
    __EE2397778._teens_;
    __EE2397778._kids_;
    __EE2397778._naicscode_;
    __EE2397778._cbsacode_;
    __EE2397778._cbsatitle_;
    __EE2397778._cbsatype_;
    __EE2397778._csacode_;
    __EE2397778._csatitle_;
    __EE2397778._mdcode_;
    __EE2397778._mdtitle_;
    __EE2397778._organizationname_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2397778.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2397778.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2397778.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2397778.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2397778.Customer_Id_;
    __EE2397778.Industry_Type_;
    __EE2397778.Source_Customer_Count_;
    __EE2397778.Entity_Context_Uid_;
    __EE2397778.Label_;
    __EE2397778.Entity_Type_;
    __EE2397778.In_Customer_Population_;
    __EE2397778.Dt_First_Seen_;
    __EE2397778.Dt_Last_Seen_;
    __EE2397778.Last_Record_Id_;
    __EE2397778.Identity_Count_;
    __EE2397778.Event_Count_;
    __EE2397778.Ip_Not_Us_;
    __EE2397778.Ip_Vpn_;
    __EE2397778.Ip_High_Risk_City_;
    __EE2397778.Ip_Hosted_;
    __EE2397778.Ip_Tor_;
    __EE2397778.Kr_High_Risk_Flag_;
    __EE2397778.Kr_Medium_Risk_Flag_;
    __EE2397778.Kr_Low_Risk_Flag_;
    __EE2397778.Kr_Flag_;
    __EE2397778.Safe_Flag_;
    __EE2397778.Contributor_Safe_Flag_;
    __EE2397778.Kr_Ip600_Flag_;
    __EE2397778.Kr_Ip601_Flag_;
    __EE2397778.Kr_Ip602_Flag_;
    __EE2397778.Kr_Ip603_Flag_;
    __EE2397778.Kr_Ip604_Flag_;
    __EE2397778.Kr_Ip605_Flag_;
    __EE2397778.Kr_Ip690_Flag_;
    __EE2397778.Kr_Ip691_Flag_;
    __EE2397778.Kr_Ip692_Flag_;
    __EE2397778.Kr_Ip693_Flag_;
    __EE2397778.Kr_Ip1000_Flag_;
    __EE2397778.Kr_Ip1001_Flag_;
    __EE2397778.Kr_Ip1090_Flag_;
    __EE2397778.Kr_Ip1091_Flag_;
    __EE2397778.Kr_Ip1092_Flag_;
    __EE2397778.Kr_Ip1093_Flag_;
    __EE2397778.Last_Event_Date_;
    __EE2397778.Kr_Last_Event_Date_;
    __EE2397778.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2397778.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2397778.Vl_Event1_All_Count_;
    __EE2397778.Vl_Event7_All_Count_;
    __EE2397778.Vl_Event30_All_Day_Count_;
    __EE2397778.Vl_Event365_All_Day_Count_;
    __EE2397778.Vl_Event7_All_Active_Flag_;
    __EE2397778.Vl_Event30_All_Active_Flag_;
    __EE2397778.Vl_Event1_Count_;
    __EE2397778.Vl_Event7_Count_;
    __EE2397778.Vl_Event30_Count_;
    __EE2397778.Vl_Event365_Count_;
    __EE2397778.Vl_Event7_Active_Flag_;
    __EE2397778.Vl_Event30_Active_Flag_;
    __EE2397778.Date_First_Seen_;
    __EE2397778.Date_Last_Seen_;
    __EE2397778.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2397778,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2397780_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST43197_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
