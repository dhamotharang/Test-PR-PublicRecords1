...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE2228932 := __ENH_Internet_Protocol_1;
  SHARED __EE2308764 := __E_Person_Ip_Address;
  SHARED __EE2308771 := __EE2308764(__NN(__EE2308764.Ip_));
  SHARED __ST2297284_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2308785 := PROJECT(TABLE(PROJECT(__EE2308771,TRANSFORM(__ST2297284_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST2297284_Layout);
  SHARED __ST2297302_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2308751 := PROJECT(__CLEANANDDO(__EE2308785,TABLE(__EE2308785,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST2297302_Layout);
  SHARED __ST2301054_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2308794(B_Internet_Protocol_1.__ST62909_Layout __EE2228932, __ST2297302_Layout __EE2308751) := __EEQP(__EE2228932.UID,__EE2308751.UID);
  __ST2301054_Layout __JT2308794(B_Internet_Protocol_1.__ST62909_Layout __l, __ST2297302_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2308795 := JOIN(__EE2228932,__EE2308751,__JC2308794(LEFT,RIGHT),__JT2308794(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2308755 := __ENH_Event_1;
  SHARED __EE2308753 := __E_Internet_Protocol_Event;
  SHARED __EE2311774 := __EE2308753(__NN(__EE2308753.Ip_) AND __NN(__EE2308753.Transaction_));
  SHARED __ST2297869_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2311792(B_Event_1.__ST61957_Layout __EE2308755, E_Internet_Protocol_Event.Layout __EE2311774) := __EEQP(__EE2311774.Transaction_,__EE2308755.UID);
  __ST2297869_Layout __JT2311792(B_Event_1.__ST61957_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2311793 := JOIN(__EE2311774,__EE2308755,__JC2311792(RIGHT,LEFT),__JT2311792(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2293614_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2293614_Layout __ND2312435__Project(__ST2297869_Layout __PP2311794) := TRANSFORM
    SELF.UID := __PP2311794.Ip_;
    SELF._r_Customer_ := __PP2311794._r_Customer__1_;
    SELF.Event_Date_ := __PP2311794.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2311794.UID;
    SELF.Event_Date__1_ := __PP2311794.Event_Date_;
    SELF._r_Customer__1_ := __PP2311794._r_Customer_;
    SELF := __PP2311794;
  END;
  SHARED __EE2314964 := PROJECT(__EE2311793,__ND2312435__Project(LEFT));
  SHARED __ST2294989_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2294989_Layout __ND2316328__Project(__ST2293614_Layout __PP2314965) := TRANSFORM
    SELF.Exp1_ := __PP2314965.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2314965.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP2314965.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP2314965.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP2314965.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP2314965.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP2314965.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP2314965.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP2314965.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP2314965.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP2314965.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP2314965.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP2314965.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP2314965.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP2314965.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP2314965.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP2314965.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP2314965.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP2314965.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP2314965.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP2314965.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP2314965.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP2314965.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP2314965.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP2314965.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP2314965.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP2314965.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP2314965.Event_Age_,<,__CN(2)),__CN(__PP2314965.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP2314965.Event_Age_,<,__CN(366));
    SELF := __PP2314965;
  END;
  SHARED __EE2316367 := PROJECT(__EE2314964,__ND2316328__Project(LEFT));
  SHARED __ST2295152_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2316536 := PROJECT(__CLEANANDDO(__EE2316367,TABLE(__EE2316367,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2316367.Exp1_),KEL.Aggregates.MinNG(__EE2316367.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2316367.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2316367.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2316367.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2316367.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2316367.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2316367.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2316367.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2316367.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2316367.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2316367.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2316367.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2316367.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2316367.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE2316367.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE2316367.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE2316367.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE2316367.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE2316367.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE2316367.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE2316367.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE2316367.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE2316367.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE2316367.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE2316367.Exp25_),KEL.Aggregates.MaxNG(__EE2316367.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE2316367.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE2316367.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE2316367.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE2316367.Exp29_)),UID},UID,MERGE)),__ST2295152_Layout);
  SHARED __ST2301698_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2316542(__ST2301054_Layout __EE2308795, __ST2295152_Layout __EE2316536) := __EEQP(__EE2308795.UID,__EE2316536.UID);
  __ST2301698_Layout __JT2316542(__ST2301054_Layout __l, __ST2295152_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2316676 := JOIN(__EE2308795,__EE2316536,__JC2316542(LEFT,RIGHT),__JT2316542(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2215767 := __ENH_Customer_1;
  SHARED __ST2302483_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2316682(__ST2301698_Layout __EE2316676, B_Customer_1.__ST55167_Layout __EE2215767) := __EEQP(__EE2316676._r_Customer_,__EE2215767.UID);
  __ST2302483_Layout __JT2316682(__ST2301698_Layout __l, B_Customer_1.__ST55167_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2316838 := JOIN(__EE2316676,__EE2215767,__JC2316682(LEFT,RIGHT),__JT2316682(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST50885_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST50885_Layout __ND2316843__Project(__ST2302483_Layout __PP2316839) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2316839.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP2316839.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP2316839.C_O_U_N_T___Person_Ip_Address_;
    __BS2317165 := __T(__PP2316839.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2317165(__T(__OP2(__T(__PP2316839.Source_Customers_)._r_Source_Customer_,=,__PP2316839._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP2316839.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP2316839.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP2316839.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP2316839.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP2316839.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP2316839.Ip_Address_;
    SELF.Last_Event_Date_ := __PP2316839.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2316839.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2316839.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2316839.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP2316839.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2316839.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2316839.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2316839.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2316839.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2316839.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2316839;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE2316838,__ND2316843__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2805645 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2805645._r_Customer_;
    __EE2805645.Source_Customers_;
    __EE2805645.Ip_Address_;
    __EE2805645.Otto_Ip_Address_Id_;
    __EE2805645._host_;
    __EE2805645._alias_;
    __EE2805645._location_;
    __EE2805645._ip__address_;
    __EE2805645._ip__address__date_;
    __EE2805645._version_;
    __EE2805645._class_;
    __EE2805645._subnet__mask_;
    __EE2805645._reserved_;
    __EE2805645._isp_;
    __EE2805645._v2__validationipproblems_;
    __EE2805645._v2__ipstate_;
    __EE2805645._v2__ipcountry_;
    __EE2805645._v2__ipcontinent_;
    __EE2805645._iprngbeg_;
    __EE2805645._iprngend_;
    __EE2805645._edgecountry_;
    __EE2805645._edgeregion_;
    __EE2805645._edgecity_;
    __EE2805645._edgeconnspeed_;
    __EE2805645._edgemetrocode_;
    __EE2805645._edgelatitude_;
    __EE2805645._edgelongitude_;
    __EE2805645._edgepostalcode_;
    __EE2805645._edgecountrycode_;
    __EE2805645._edgeregioncode_;
    __EE2805645._edgecitycode_;
    __EE2805645._edgecontinentcode_;
    __EE2805645._edgetwolettercountry_;
    __EE2805645._edgeinternalcode_;
    __EE2805645._edgeareacodes_;
    __EE2805645._edgecountryconf_;
    __EE2805645._edgeregionconf_;
    __EE2805645._edgecitycong_;
    __EE2805645._edgepostalconf_;
    __EE2805645._edgegmtoffset_;
    __EE2805645._edgeindst_;
    __EE2805645._siccode_;
    __EE2805645._domainname_;
    __EE2805645._ispname_;
    __EE2805645._homebiztype_;
    __EE2805645._asn_;
    __EE2805645._asnname_;
    __EE2805645._primarylang_;
    __EE2805645._secondarylang_;
    __EE2805645._proxytype_;
    __EE2805645._proxydescription_;
    __EE2805645._isanisp_;
    __EE2805645._companyname_;
    __EE2805645._ranks_;
    __EE2805645._households_;
    __EE2805645._women_;
    __EE2805645._women18to34_;
    __EE2805645._women35to49_;
    __EE2805645._men_;
    __EE2805645._men18to34_;
    __EE2805645._men35to49_;
    __EE2805645._teens_;
    __EE2805645._kids_;
    __EE2805645._naicscode_;
    __EE2805645._cbsacode_;
    __EE2805645._cbsatitle_;
    __EE2805645._cbsatype_;
    __EE2805645._csacode_;
    __EE2805645._csatitle_;
    __EE2805645._mdcode_;
    __EE2805645._mdtitle_;
    __EE2805645._organizationname_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2805645.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2805645.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE2805645.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE2805645.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE2805645.Customer_Id_;
    __EE2805645.Industry_Type_;
    __EE2805645.Source_Customer_Count_;
    __EE2805645.Entity_Context_Uid_;
    __EE2805645.Label_;
    __EE2805645.Entity_Type_;
    __EE2805645.In_Customer_Population_;
    __EE2805645.Dt_First_Seen_;
    __EE2805645.Dt_Last_Seen_;
    __EE2805645.Last_Record_Id_;
    __EE2805645.Identity_Count_;
    __EE2805645.Event_Count_;
    __EE2805645.Ip_Not_Us_;
    __EE2805645.Ip_Vpn_;
    __EE2805645.Ip_High_Risk_City_;
    __EE2805645.Ip_Hosted_;
    __EE2805645.Ip_Tor_;
    __EE2805645.Kr_High_Risk_Flag_;
    __EE2805645.Kr_Medium_Risk_Flag_;
    __EE2805645.Kr_Low_Risk_Flag_;
    __EE2805645.Kr_Flag_;
    __EE2805645.Safe_Flag_;
    __EE2805645.Contributor_Safe_Flag_;
    __EE2805645.Kr_Ip600_Flag_;
    __EE2805645.Kr_Ip601_Flag_;
    __EE2805645.Kr_Ip602_Flag_;
    __EE2805645.Kr_Ip603_Flag_;
    __EE2805645.Kr_Ip604_Flag_;
    __EE2805645.Kr_Ip605_Flag_;
    __EE2805645.Kr_Ip690_Flag_;
    __EE2805645.Kr_Ip691_Flag_;
    __EE2805645.Kr_Ip692_Flag_;
    __EE2805645.Kr_Ip693_Flag_;
    __EE2805645.Kr_Ip1000_Flag_;
    __EE2805645.Kr_Ip1001_Flag_;
    __EE2805645.Kr_Ip1090_Flag_;
    __EE2805645.Kr_Ip1091_Flag_;
    __EE2805645.Kr_Ip1092_Flag_;
    __EE2805645.Kr_Ip1093_Flag_;
    __EE2805645.Last_Event_Date_;
    __EE2805645.Kr_Last_Event_Date_;
    __EE2805645.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2805645.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2805645.Vl_Event1_All_Count_;
    __EE2805645.Vl_Event7_All_Count_;
    __EE2805645.Vl_Event30_All_Day_Count_;
    __EE2805645.Vl_Event365_All_Day_Count_;
    __EE2805645.Vl_Event7_All_Active_Flag_;
    __EE2805645.Vl_Event30_All_Active_Flag_;
    __EE2805645.Vl_Event1_Count_;
    __EE2805645.Vl_Event7_Count_;
    __EE2805645.Vl_Event30_Count_;
    __EE2805645.Vl_Event365_Count_;
    __EE2805645.Vl_Event7_Active_Flag_;
    __EE2805645.Vl_Event30_Active_Flag_;
    __EE2805645.Date_First_Seen_;
    __EE2805645.Date_Last_Seen_;
    __EE2805645.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2805645,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2805647_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST50885_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
