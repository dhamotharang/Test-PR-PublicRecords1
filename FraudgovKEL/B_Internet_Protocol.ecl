...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE845057 := __ENH_Internet_Protocol_1;
  SHARED __EE899298 := __E_Person_Ip_Address;
  SHARED __EE899305 := __EE899298(__NN(__EE899298.Ip_));
  SHARED __ST890314_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE899319 := PROJECT(TABLE(PROJECT(__EE899305,TRANSFORM(__ST890314_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST890314_Layout);
  SHARED __ST890332_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE899285 := PROJECT(__CLEANANDDO(__EE899319,TABLE(__EE899319,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST890332_Layout);
  SHARED __ST892936_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC899328(B_Internet_Protocol_1.__ST33756_Layout __EE845057, __ST890332_Layout __EE899285) := __EEQP(__EE845057.UID,__EE899285.UID);
  __ST892936_Layout __JT899328(B_Internet_Protocol_1.__ST33756_Layout __l, __ST890332_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE899329 := JOIN(__EE845057,__EE899285,__JC899328(LEFT,RIGHT),__JT899328(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE899289 := __ENH_Event_1;
  SHARED __EE899287 := __E_Internet_Protocol_Event;
  SHARED __EE901410 := __EE899287(__NN(__EE899287.Ip_) AND __NN(__EE899287.Transaction_));
  SHARED __ST890881_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC901428(B_Event_1.__ST33177_Layout __EE899289, E_Internet_Protocol_Event.Layout __EE901410) := __EEQP(__EE901410.Transaction_,__EE899289.UID);
  __ST890881_Layout __JT901428(B_Event_1.__ST33177_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE901429 := JOIN(__EE901410,__EE899289,__JC901428(RIGHT,LEFT),__JT901428(RIGHT,LEFT),INNER,HASH);
  SHARED __ST887548_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST887548_Layout __ND901845__Project(__ST890881_Layout __PP901430) := TRANSFORM
    SELF.UID := __PP901430.Ip_;
    SELF._r_Customer_ := __PP901430._r_Customer__1_;
    SELF.Event_Date_ := __PP901430.Event_Date__1_;
    SELF.U_I_D__1_ := __PP901430.UID;
    SELF.Event_Date__1_ := __PP901430.Event_Date_;
    SELF._r_Customer__1_ := __PP901430._r_Customer_;
    SELF := __PP901430;
  END;
  SHARED __EE903470 := PROJECT(__EE901429,__ND901845__Project(LEFT));
  SHARED __ST888475_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST888475_Layout __ND904780__Project(__ST887548_Layout __PP903471) := TRANSFORM
    SELF.Exp1_ := __PP903471.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP903471.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP903471.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP903471.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP903471.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP903471.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP903471.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP903471.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP903471.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP903471.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP903471.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP903471.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP903471.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP903471.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP903471.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP903471.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP903471.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP903471.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP903471.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP903471.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP903471.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP903471.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP903471.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP903471.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP903471.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP903471.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP903471.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP903471.Event_Age_,<,__CN(2)),__CN(__PP903471.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP903471.Event_Age_,<,__CN(366));
    SELF := __PP903471;
  END;
  SHARED __EE904819 := PROJECT(__EE903470,__ND904780__Project(LEFT));
  SHARED __ST888641_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE904993 := PROJECT(__CLEANANDDO(__EE904819,TABLE(__EE904819,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE904819.Exp1_),KEL.Aggregates.MinNG(__EE904819.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE904819.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE904819.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE904819.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE904819.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE904819.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE904819.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE904819.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE904819.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE904819.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE904819.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE904819.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE904819.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE904819.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE904819.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE904819.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE904819.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE904819.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE904819.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE904819.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE904819.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE904819.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE904819.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE904819.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE904819.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE904819.Exp25_),KEL.Aggregates.MaxNG(__EE904819.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE904819.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE904819.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE904819.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE904819.Exp29_)),UID},UID,MERGE)),__ST888641_Layout);
  SHARED __ST893533_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC904999(__ST892936_Layout __EE899329, __ST888641_Layout __EE904993) := __EEQP(__EE899329.UID,__EE904993.UID);
  __ST893533_Layout __JT904999(__ST892936_Layout __l, __ST888641_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE905126 := JOIN(__EE899329,__EE904993,__JC904999(LEFT,RIGHT),__JT904999(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE832236 := __ENH_Customer_1;
  SHARED __ST894274_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC905132(__ST893533_Layout __EE905126, B_Customer_1.__ST30331_Layout __EE832236) := __EEQP(__EE905126._r_Customer_,__EE832236.UID);
  __ST894274_Layout __JT905132(__ST893533_Layout __l, B_Customer_1.__ST30331_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE905281 := JOIN(__EE905126,__EE832236,__JC905132(LEFT,RIGHT),__JT905132(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST26986_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST26986_Layout __ND905286__Project(__ST894274_Layout __PP905282) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP905282.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP905282.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP905282.C_O_U_N_T___Person_Ip_Address_;
    __BS905579 := __T(__PP905282.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS905579(__T(__OP2(__T(__PP905282.Source_Customers_)._r_Source_Customer_,=,__PP905282._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP905282.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP905282.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP905282.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP905282.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP905282.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP905282.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP905282.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP905282.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP905282.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP905282.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP905282.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP905282.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP905282.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP905282.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP905282.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP905282;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE905281,__ND905286__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE1283602 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1283602._r_Customer_;
    __EE1283602.Source_Customers_;
    __EE1283602.Ip_Address_;
    __EE1283602.Otto_Ip_Address_Id_;
    __EE1283602._host_;
    __EE1283602._alias_;
    __EE1283602._location_;
    __EE1283602._ip__address_;
    __EE1283602._ip__address__date_;
    __EE1283602._version_;
    __EE1283602._class_;
    __EE1283602._subnet__mask_;
    __EE1283602._reserved_;
    __EE1283602._isp_;
    __EE1283602._v2__validationipproblems_;
    __EE1283602._v2__ipstate_;
    __EE1283602._v2__ipcountry_;
    __EE1283602._v2__ipcontinent_;
    __EE1283602._iprngbeg_;
    __EE1283602._iprngend_;
    __EE1283602._edgecountry_;
    __EE1283602._edgeregion_;
    __EE1283602._edgecity_;
    __EE1283602._edgeconnspeed_;
    __EE1283602._edgemetrocode_;
    __EE1283602._edgelatitude_;
    __EE1283602._edgelongitude_;
    __EE1283602._edgepostalcode_;
    __EE1283602._edgecountrycode_;
    __EE1283602._edgeregioncode_;
    __EE1283602._edgecitycode_;
    __EE1283602._edgecontinentcode_;
    __EE1283602._edgetwolettercountry_;
    __EE1283602._edgeinternalcode_;
    __EE1283602._edgeareacodes_;
    __EE1283602._edgecountryconf_;
    __EE1283602._edgeregionconf_;
    __EE1283602._edgecitycong_;
    __EE1283602._edgepostalconf_;
    __EE1283602._edgegmtoffset_;
    __EE1283602._edgeindst_;
    __EE1283602._siccode_;
    __EE1283602._domainname_;
    __EE1283602._ispname_;
    __EE1283602._homebiztype_;
    __EE1283602._asn_;
    __EE1283602._asnname_;
    __EE1283602._primarylang_;
    __EE1283602._secondarylang_;
    __EE1283602._proxytype_;
    __EE1283602._proxydescription_;
    __EE1283602._isanisp_;
    __EE1283602._companyname_;
    __EE1283602._ranks_;
    __EE1283602._households_;
    __EE1283602._women_;
    __EE1283602._women18to34_;
    __EE1283602._women35to49_;
    __EE1283602._men_;
    __EE1283602._men18to34_;
    __EE1283602._men35to49_;
    __EE1283602._teens_;
    __EE1283602._kids_;
    __EE1283602._naicscode_;
    __EE1283602._cbsacode_;
    __EE1283602._cbsatitle_;
    __EE1283602._cbsatype_;
    __EE1283602._csacode_;
    __EE1283602._csatitle_;
    __EE1283602._mdcode_;
    __EE1283602._mdtitle_;
    __EE1283602._organizationname_;
    __EE1283602.Customer_Id_;
    __EE1283602.Industry_Type_;
    __EE1283602.Source_Customer_Count_;
    __EE1283602.Entity_Context_Uid_;
    __EE1283602.Label_;
    __EE1283602.Entity_Type_;
    __EE1283602.In_Customer_Population_;
    __EE1283602.Dt_First_Seen_;
    __EE1283602.Dt_Last_Seen_;
    __EE1283602.Last_Record_Id_;
    __EE1283602.Identity_Count_;
    __EE1283602.Event_Count_;
    __EE1283602.Ip_Not_Us_;
    __EE1283602.Ip_Vpn_;
    __EE1283602.Ip_High_Risk_City_;
    __EE1283602.Ip_Hosted_;
    __EE1283602.Ip_Tor_;
    __EE1283602.Kr_High_Risk_Flag_;
    __EE1283602.Kr_Medium_Risk_Flag_;
    __EE1283602.Kr_Low_Risk_Flag_;
    __EE1283602.Kr_Flag_;
    __EE1283602.Safe_Flag_;
    __EE1283602.Contributor_Safe_Flag_;
    __EE1283602.Kr_Ip600_Flag_;
    __EE1283602.Kr_Ip601_Flag_;
    __EE1283602.Kr_Ip602_Flag_;
    __EE1283602.Kr_Ip603_Flag_;
    __EE1283602.Kr_Ip604_Flag_;
    __EE1283602.Kr_Ip605_Flag_;
    __EE1283602.Kr_Ip690_Flag_;
    __EE1283602.Kr_Ip691_Flag_;
    __EE1283602.Kr_Ip692_Flag_;
    __EE1283602.Kr_Ip693_Flag_;
    __EE1283602.Kr_Ip1000_Flag_;
    __EE1283602.Kr_Ip1001_Flag_;
    __EE1283602.Kr_Ip1090_Flag_;
    __EE1283602.Kr_Ip1091_Flag_;
    __EE1283602.Kr_Ip1092_Flag_;
    __EE1283602.Kr_Ip1093_Flag_;
    __EE1283602.Last_Event_Date_;
    __EE1283602.Kr_Last_Event_Date_;
    __EE1283602.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1283602.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1283602.Vl_Event1_All_Count_;
    __EE1283602.Vl_Event7_All_Count_;
    __EE1283602.Vl_Event30_All_Day_Count_;
    __EE1283602.Vl_Event365_All_Day_Count_;
    __EE1283602.Vl_Event7_All_Active_Flag_;
    __EE1283602.Vl_Event30_All_Active_Flag_;
    __EE1283602.Vl_Event1_Count_;
    __EE1283602.Vl_Event7_Count_;
    __EE1283602.Vl_Event30_Count_;
    __EE1283602.Vl_Event365_Count_;
    __EE1283602.Vl_Event7_Active_Flag_;
    __EE1283602.Vl_Event30_Active_Flag_;
    __EE1283602.Date_First_Seen_;
    __EE1283602.Date_Last_Seen_;
    __EE1283602.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE1283602,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1283604_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST26986_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
