...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE4170760 := __ENH_Internet_Protocol_1;
  SHARED __EE4253176 := __E_Person_Ip_Address;
  SHARED __EE4253183 := __EE4253176(__NN(__EE4253176.Ip_));
  SHARED __ST4240894_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4253197 := PROJECT(TABLE(PROJECT(__EE4253183,TRANSFORM(__ST4240894_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST4240894_Layout);
  SHARED __ST4240912_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4253163 := PROJECT(__CLEANANDDO(__EE4253197,TABLE(__EE4253197,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST4240912_Layout);
  SHARED __ST4245023_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4253206(B_Internet_Protocol_1.__ST82163_Layout __EE4170760, __ST4240912_Layout __EE4253163) := __EEQP(__EE4170760.UID,__EE4253163.UID);
  __ST4245023_Layout __JT4253206(B_Internet_Protocol_1.__ST82163_Layout __l, __ST4240912_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4253207 := JOIN(__EE4170760,__EE4253163,__JC4253206(LEFT,RIGHT),__JT4253206(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4253167 := __ENH_Event_1;
  SHARED __EE4253165 := __E_Internet_Protocol_Event;
  SHARED __EE4256425 := __EE4253165(__NN(__EE4253165.Ip_) AND __NN(__EE4253165.Transaction_));
  SHARED __ST4241478_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4256443(B_Event_1.__ST80990_Layout __EE4253167, E_Internet_Protocol_Event.Layout __EE4256425) := __EEQP(__EE4256425.Transaction_,__EE4253167.UID);
  __ST4241478_Layout __JT4256443(B_Event_1.__ST80990_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4256444 := JOIN(__EE4256425,__EE4253167,__JC4256443(RIGHT,LEFT),__JT4256443(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4236905_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4236905_Layout __ND4257170__Project(__ST4241478_Layout __PP4256445) := TRANSFORM
    SELF.UID := __PP4256445.Ip_;
    SELF._r_Customer_ := __PP4256445._r_Customer__1_;
    SELF.Event_Date_ := __PP4256445.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4256445.UID;
    SELF.Event_Date__1_ := __PP4256445.Event_Date_;
    SELF._r_Customer__1_ := __PP4256445._r_Customer_;
    SELF := __PP4256445;
  END;
  SHARED __EE4259963 := PROJECT(__EE4256444,__ND4257170__Project(LEFT));
  SHARED __ST4238453_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4238453_Layout __ND4259968__Project(__ST4236905_Layout __PP4259964) := TRANSFORM
    SELF.Exp1_ := __PP4259964.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4259964.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4259964.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4259964.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP4259964.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP4259964.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP4259964.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP4259964.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP4259964.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP4259964.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP4259964.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP4259964.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP4259964.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP4259964.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP4259964.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP4259964.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP4259964.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP4259964.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP4259964.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP4259964.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP4259964.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP4259964.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP4259964.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP4259964.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP4259964.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP4259964.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP4259964.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP4259964.Safe_Flag_ = 1;
    SELF := __PP4259964;
  END;
  SHARED __EE4260115 := PROJECT(__EE4259963,__ND4259968__Project(LEFT));
  SHARED __ST4238606_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4260271 := PROJECT(__CLEANANDDO(__EE4260115,TABLE(__EE4260115,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4260115.Exp1_),KEL.Aggregates.MinNG(__EE4260115.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4260115.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4260115.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4260115.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4260115.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4260115.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4260115.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4260115.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4260115.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4260115.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4260115.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4260115.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4260115.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE4260115.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE4260115.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE4260115.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE4260115.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE4260115.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE4260115.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE4260115.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE4260115.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE4260115.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE4260115.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE4260115.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE4260115.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE4260115.Exp26_),KEL.Aggregates.MaxNG(__EE4260115.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE4260115.Exp27_),UID},UID,MERGE)),__ST4238606_Layout);
  SHARED __ST4245695_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4260277(__ST4245023_Layout __EE4253207, __ST4238606_Layout __EE4260271) := __EEQP(__EE4253207.UID,__EE4260271.UID);
  __ST4245695_Layout __JT4260277(__ST4245023_Layout __l, __ST4238606_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4260278 := JOIN(__EE4253207,__EE4260271,__JC4260277(LEFT,RIGHT),__JT4260277(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4151266 := __ENH_Customer_1;
  SHARED __ST4246502_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4260425(__ST4245695_Layout __EE4260278, B_Customer_1.__ST72603_Layout __EE4151266) := __EEQP(__EE4260278._r_Customer_,__EE4151266.UID);
  __ST4246502_Layout __JT4260425(__ST4245695_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4260426 := JOIN(__EE4260278,__EE4151266,__JC4260425(LEFT,RIGHT),__JT4260425(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST68443_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST68443_Layout __ND4261347__Project(__ST4246502_Layout __PP4260427) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4260427.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP4260427.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4260427.M_I_N___Event_Date__2_;
    SELF.Identity_Count_ := __PP4260427.C_O_U_N_T___Person_Ip_Address_;
    __BS4260955 := __T(__PP4260427.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4260955(__T(__OP2(__T(__PP4260427.Source_Customers_)._r_Source_Customer_,=,__PP4260427._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP4260427.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP4260427.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP4260427.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP4260427.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP4260427.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4260427.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP4260427.Ip_Address_;
    SELF.Last_Event_Date_ := __PP4260427.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4260427.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
  ...
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4670225._r_Customer_;
    __EE4670225.Source_Customers_;
    __EE4670225.Ip_Address_;
    __EE4670225.Otto_Ip_Address_Id_;
    __EE4670225._host_;
    __EE4670225._alias_;
    __EE4670225._location_;
    __EE4670225._ip__address_;
    __EE4670225._ip__address__date_;
    __EE4670225._version_;
    __EE4670225._class_;
    __EE4670225._subnet__mask_;
    __EE4670225._reserved_;
    __EE4670225._isp_;
    __EE4670225._v2__validationipproblems_;
    __EE4670225._v2__ipstate_;
    __EE4670225._v2__ipcountry_;
    __EE4670225._v2__ipcontinent_;
    __EE4670225._iprngbeg_;
    __EE4670225._iprngend_;
    __EE4670225._edgecountry_;
    __EE4670225._edgeregion_;
    __EE4670225._edgecity_;
    __EE4670225._edgeconnspeed_;
    __EE4670225._edgemetrocode_;
    __EE4670225._edgelatitude_;
    __EE4670225._edgelongitude_;
    __EE4670225._edgepostalcode_;
    __EE4670225._edgecountrycode_;
    __EE4670225._edgeregioncode_;
    __EE4670225._edgecitycode_;
    __EE4670225._edgecontinentcode_;
    __EE4670225._edgetwolettercountry_;
    __EE4670225._edgeinternalcode_;
    __EE4670225._edgeareacodes_;
    __EE4670225._edgecountryconf_;
    __EE4670225._edgeregionconf_;
    __EE4670225._edgecitycong_;
    __EE4670225._edgepostalconf_;
    __EE4670225._edgegmtoffset_;
    __EE4670225._edgeindst_;
    __EE4670225._siccode_;
    __EE4670225._domainname_;
    __EE4670225._ispname_;
    __EE4670225._homebiztype_;
    __EE4670225._asn_;
    __EE4670225._asnname_;
    __EE4670225._primarylang_;
    __EE4670225._secondarylang_;
    __EE4670225._proxytype_;
    __EE4670225._proxydescription_;
    __EE4670225._isanisp_;
    __EE4670225._companyname_;
    __EE4670225._ranks_;
    __EE4670225._households_;
    __EE4670225._women_;
    __EE4670225._women18to34_;
    __EE4670225._women35to49_;
    __EE4670225._men_;
    __EE4670225._men18to34_;
    __EE4670225._men35to49_;
    __EE4670225._teens_;
    __EE4670225._kids_;
    __EE4670225._naicscode_;
    __EE4670225._cbsacode_;
    __EE4670225._cbsatitle_;
    __EE4670225._cbsatype_;
    __EE4670225._csacode_;
    __EE4670225._csatitle_;
    __EE4670225._mdcode_;
    __EE4670225._mdtitle_;
    __EE4670225._organizationname_;
    __EE4670225.Aot_Act_Cnt_Ev_;
    __EE4670225.Aot_Src1_Act_Cnt_Ev_;
    __EE4670225.Aot_Src1_Act_Only_Flag_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4670225.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4670225.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4670225.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4670225.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4670225.Aot_Id_Act_Cnt_Ev_;
    __EE4670225.Aot_Id_Act_Cnt30_D_;
    __EE4670225.Aot_Add_Act_Cnt_Ev_;
    __EE4670225.Aot_Add_Act_Cnt30_D_;
    __EE4670225.Aot_Non_St_Act_Cnt_Ev_;
    __EE4670225.Aot_Non_St_Act_Cnt30_D_;
    __EE4670225.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4670225.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4670225.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4670225.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4670225.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4670225.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4670225.Customer_Id_;
    __EE4670225.Industry_Type_;
    __EE4670225.Source_Customer_Count_;
    __EE4670225.Entity_Context_Uid_;
    __EE4670225.Label_;
    __EE4670225.Entity_Type_;
    __EE4670225.In_Customer_Population_;
    __EE4670225.Dt_First_Seen_;
    __EE4670225.Dt_Last_Seen_;
    __EE4670225.Id_Activity_Dt_First_Seen_;
    __EE4670225.Id_Activity_Dt_Last_Seen_;
    __EE4670225.Last_Record_Id_;
    __EE4670225.Identity_Count_;
    __EE4670225.Event_Count_;
    __EE4670225.Ip_Not_Us_;
    __EE4670225.Ip_Vpn_;
    __EE4670225.Ip_High_Risk_City_;
    __EE4670225.Ip_Hosted_;
    __EE4670225.Ip_Tor_;
    __EE4670225.Kr_High_Risk_Flag_;
    __EE4670225.Kr_Medium_Risk_Flag_;
    __EE4670225.Kr_Low_Risk_Flag_;
    __EE4670225.Kr_Flag_;
    __EE4670225.Safe_Flag_;
    __EE4670225.Contributor_Safe_Flag_;
    __EE4670225.Kr_Ip600_Flag_;
    __EE4670225.Kr_Ip601_Flag_;
    __EE4670225.Kr_Ip602_Flag_;
    __EE4670225.Kr_Ip603_Flag_;
    __EE4670225.Kr_Ip604_Flag_;
    __EE4670225.Kr_Ip605_Flag_;
    __EE4670225.Kr_Ip690_Flag_;
    __EE4670225.Kr_Ip691_Flag_;
    __EE4670225.Kr_Ip692_Flag_;
    __EE4670225.Kr_Ip693_Flag_;
    __EE4670225.Kr_Ip1000_Flag_;
    __EE4670225.Kr_Ip1001_Flag_;
    __EE4670225.Kr_Ip1090_Flag_;
    __EE4670225.Kr_Ip1091_Flag_;
    __EE4670225.Kr_Ip1092_Flag_;
    __EE4670225.Kr_Ip1093_Flag_;
    __EE4670225.Last_Event_Date_;
    __EE4670225.Kr_Last_Event_Date_;
    __EE4670225.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4670225.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4670225.Date_First_Seen_;
    __EE4670225.Date_Last_Seen_;
    __EE4670225.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4670225,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4670227_Layout := RECORDOF(IDX_Internet_Protocol_UID);
