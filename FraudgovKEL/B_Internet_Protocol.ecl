...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE3455562 := __ENH_Internet_Protocol_1;
  SHARED __EE3541326 := __E_Person_Ip_Address;
  SHARED __EE3541333 := __EE3541326(__NN(__EE3541326.Ip_));
  SHARED __ST3529020_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3541347 := PROJECT(TABLE(PROJECT(__EE3541333,TRANSFORM(__ST3529020_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST3529020_Layout);
  SHARED __ST3529038_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3541313 := PROJECT(__CLEANANDDO(__EE3541347,TABLE(__EE3541347,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST3529038_Layout);
  ...
  END;
  __JC3541356(B_Internet_Protocol_1.__ST78109_Layout __EE3455562, __ST3529038_Layout __EE3541313) := __EEQP(__EE3455562.UID,__EE3541313.UID);
  __ST3533059_Layout __JT3541356(B_Internet_Protocol_1.__ST78109_Layout __l, __ST3529038_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3541357 := JOIN(__EE3455562,__EE3541313,__JC3541356(LEFT,RIGHT),__JT3541356(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3541317 := __ENH_Event_1;
  SHARED __EE3541315 := __E_Internet_Protocol_Event;
  SHARED __EE3544532 := __EE3541315(__NN(__EE3541315.Ip_) AND __NN(__EE3541315.Transaction_));
  SHARED __ST3529629_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3544550(B_Event_1.__ST76927_Layout __EE3541317, E_Internet_Protocol_Event.Layout __EE3544532) := __EEQP(__EE3544532.Transaction_,__EE3541317.UID);
  __ST3529629_Layout __JT3544550(B_Event_1.__ST76927_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3544551 := JOIN(__EE3544532,__EE3541317,__JC3544550(RIGHT,LEFT),__JT3544550(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3525130_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3525130_Layout __ND3545242__Project(__ST3529629_Layout __PP3544552) := TRANSFORM
    SELF.UID := __PP3544552.Ip_;
    SELF._r_Customer_ := __PP3544552._r_Customer__1_;
    SELF.Event_Date_ := __PP3544552.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3544552.UID;
    SELF.Event_Date__1_ := __PP3544552.Event_Date_;
    SELF._r_Customer__1_ := __PP3544552._r_Customer_;
    SELF := __PP3544552;
  END;
  SHARED __EE3547967 := PROJECT(__EE3544551,__ND3545242__Project(LEFT));
  SHARED __ST3526603_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3526603_Layout __ND3549415__Project(__ST3525130_Layout __PP3547968) := TRANSFORM
    SELF.Exp1_ := __PP3547968.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP3547968.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP3547968.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP3547968.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP3547968.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP3547968.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP3547968.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP3547968.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP3547968.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP3547968.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP3547968.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP3547968.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP3547968.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP3547968.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP3547968.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP3547968.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP3547968.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP3547968.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP3547968.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP3547968.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP3547968.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP3547968.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP3547968.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP3547968.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP3547968.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP3547968.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP3547968.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP3547968.Event_Age_,<,__CN(2)),__CN(__PP3547968.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP3547968.Event_Age_,<,__CN(366));
    SELF := __PP3547968;
  END;
  SHARED __EE3549454 := PROJECT(__EE3547967,__ND3549415__Project(LEFT));
  SHARED __ST3526766_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3549623 := PROJECT(__CLEANANDDO(__EE3549454,TABLE(__EE3549454,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3549454.Exp1_),KEL.Aggregates.MinNG(__EE3549454.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3549454.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3549454.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3549454.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3549454.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3549454.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3549454.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3549454.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3549454.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3549454.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3549454.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3549454.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3549454.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3549454.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE3549454.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE3549454.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE3549454.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE3549454.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE3549454.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE3549454.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE3549454.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE3549454.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE3549454.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE3549454.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE3549454.Exp25_),KEL.Aggregates.MaxNG(__EE3549454.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE3549454.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE3549454.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE3549454.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE3549454.Exp29_)),UID},UID,MERGE)),__ST3526766_Layout);
  SHARED __ST3533763_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3549629(__ST3533059_Layout __EE3541357, __ST3526766_Layout __EE3549623) := __EEQP(__EE3541357.UID,__EE3549623.UID);
  __ST3533763_Layout __JT3549629(__ST3533059_Layout __l, __ST3526766_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3549775 := JOIN(__EE3541357,__EE3549623,__JC3549629(LEFT,RIGHT),__JT3549629(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3441601 := __ENH_Customer_1;
  SHARED __ST3534608_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3549781(__ST3533763_Layout __EE3549775, B_Customer_1.__ST68903_Layout __EE3441601) := __EEQP(__EE3549775._r_Customer_,__EE3441601.UID);
  __ST3534608_Layout __JT3549781(__ST3533763_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3549949 := JOIN(__EE3549775,__EE3441601,__JC3549781(LEFT,RIGHT),__JT3549781(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST63642_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST63642_Layout __ND3549954__Project(__ST3534608_Layout __PP3549950) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3549950.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP3549950.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP3549950.C_O_U_N_T___Person_Ip_Address_;
    __BS3550312 := __T(__PP3549950.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3550312(__T(__OP2(__T(__PP3549950.Source_Customers_)._r_Source_Customer_,=,__PP3549950._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP3549950.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP3549950.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP3549950.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP3549950.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP3549950.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP3549950.Ip_Address_;
    SELF.Last_Event_Date_ := __PP3549950.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3549950.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3549950.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3549950.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP3549950.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3549950.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3549950.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3549950.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3549950.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3549950.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3549950;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE3549949,__ND3549954__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4094209 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4094209._r_Customer_;
    __EE4094209.Source_Customers_;
    __EE4094209.Ip_Address_;
    __EE4094209.Otto_Ip_Address_Id_;
    __EE4094209._host_;
    __EE4094209._alias_;
    __EE4094209._location_;
    __EE4094209._ip__address_;
    __EE4094209._ip__address__date_;
    __EE4094209._version_;
    __EE4094209._class_;
    __EE4094209._subnet__mask_;
    __EE4094209._reserved_;
    __EE4094209._isp_;
    __EE4094209._v2__validationipproblems_;
    __EE4094209._v2__ipstate_;
    __EE4094209._v2__ipcountry_;
    __EE4094209._v2__ipcontinent_;
    __EE4094209._iprngbeg_;
    __EE4094209._iprngend_;
    __EE4094209._edgecountry_;
    __EE4094209._edgeregion_;
    __EE4094209._edgecity_;
    __EE4094209._edgeconnspeed_;
    __EE4094209._edgemetrocode_;
    __EE4094209._edgelatitude_;
    __EE4094209._edgelongitude_;
    __EE4094209._edgepostalcode_;
    __EE4094209._edgecountrycode_;
    __EE4094209._edgeregioncode_;
    __EE4094209._edgecitycode_;
    __EE4094209._edgecontinentcode_;
    __EE4094209._edgetwolettercountry_;
    __EE4094209._edgeinternalcode_;
    __EE4094209._edgeareacodes_;
    __EE4094209._edgecountryconf_;
    __EE4094209._edgeregionconf_;
    __EE4094209._edgecitycong_;
    __EE4094209._edgepostalconf_;
    __EE4094209._edgegmtoffset_;
    __EE4094209._edgeindst_;
    __EE4094209._siccode_;
    __EE4094209._domainname_;
    __EE4094209._ispname_;
    __EE4094209._homebiztype_;
    __EE4094209._asn_;
    __EE4094209._asnname_;
    __EE4094209._primarylang_;
    __EE4094209._secondarylang_;
    __EE4094209._proxytype_;
    __EE4094209._proxydescription_;
    __EE4094209._isanisp_;
    __EE4094209._companyname_;
    __EE4094209._ranks_;
    __EE4094209._households_;
    __EE4094209._women_;
    __EE4094209._women18to34_;
    __EE4094209._women35to49_;
    __EE4094209._men_;
    __EE4094209._men18to34_;
    __EE4094209._men35to49_;
    __EE4094209._teens_;
    __EE4094209._kids_;
    __EE4094209._naicscode_;
    __EE4094209._cbsacode_;
    __EE4094209._cbsatitle_;
    __EE4094209._cbsatype_;
    __EE4094209._csacode_;
    __EE4094209._csatitle_;
    __EE4094209._mdcode_;
    __EE4094209._mdtitle_;
    __EE4094209._organizationname_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4094209.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4094209.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4094209.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4094209.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4094209.Aot_Id_Act_Cnt_Ev_;
    __EE4094209.Aot_Id_Act_Cnt30_D_;
    __EE4094209.Aot_Add_Act_Cnt_Ev_;
    __EE4094209.Aot_Add_Act_Cnt30_D_;
    __EE4094209.Aot_Non_St_Act_Cnt_Ev_;
    __EE4094209.Aot_Non_St_Act_Cnt30_D_;
    __EE4094209.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4094209.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4094209.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4094209.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4094209.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4094209.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4094209.Customer_Id_;
    __EE4094209.Industry_Type_;
    __EE4094209.Source_Customer_Count_;
    __EE4094209.Entity_Context_Uid_;
    __EE4094209.Label_;
    __EE4094209.Entity_Type_;
    __EE4094209.In_Customer_Population_;
    __EE4094209.Dt_First_Seen_;
    __EE4094209.Dt_Last_Seen_;
    __EE4094209.Last_Record_Id_;
    __EE4094209.Identity_Count_;
    __EE4094209.Event_Count_;
    __EE4094209.Ip_Not_Us_;
    __EE4094209.Ip_Vpn_;
    __EE4094209.Ip_High_Risk_City_;
    __EE4094209.Ip_Hosted_;
    __EE4094209.Ip_Tor_;
    __EE4094209.Kr_High_Risk_Flag_;
    __EE4094209.Kr_Medium_Risk_Flag_;
    __EE4094209.Kr_Low_Risk_Flag_;
    __EE4094209.Kr_Flag_;
    __EE4094209.Safe_Flag_;
    __EE4094209.Contributor_Safe_Flag_;
    __EE4094209.Kr_Ip600_Flag_;
    __EE4094209.Kr_Ip601_Flag_;
    __EE4094209.Kr_Ip602_Flag_;
    __EE4094209.Kr_Ip603_Flag_;
    __EE4094209.Kr_Ip604_Flag_;
    __EE4094209.Kr_Ip605_Flag_;
    __EE4094209.Kr_Ip690_Flag_;
    __EE4094209.Kr_Ip691_Flag_;
    __EE4094209.Kr_Ip692_Flag_;
    __EE4094209.Kr_Ip693_Flag_;
    __EE4094209.Kr_Ip1000_Flag_;
    __EE4094209.Kr_Ip1001_Flag_;
    __EE4094209.Kr_Ip1090_Flag_;
    __EE4094209.Kr_Ip1091_Flag_;
    __EE4094209.Kr_Ip1092_Flag_;
    __EE4094209.Kr_Ip1093_Flag_;
    __EE4094209.Last_Event_Date_;
    __EE4094209.Kr_Last_Event_Date_;
    __EE4094209.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4094209.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4094209.Vl_Event1_All_Count_;
    __EE4094209.Vl_Event7_All_Count_;
    __EE4094209.Vl_Event30_All_Day_Count_;
    __EE4094209.Vl_Event365_All_Day_Count_;
    __EE4094209.Vl_Event7_All_Active_Flag_;
    __EE4094209.Vl_Event30_All_Active_Flag_;
    __EE4094209.Vl_Event1_Count_;
    __EE4094209.Vl_Event7_Count_;
    __EE4094209.Vl_Event30_Count_;
    __EE4094209.Vl_Event365_Count_;
    __EE4094209.Vl_Event7_Active_Flag_;
    __EE4094209.Vl_Event30_Active_Flag_;
    __EE4094209.Date_First_Seen_;
    __EE4094209.Date_Last_Seen_;
    __EE4094209.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4094209,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4094211_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST63642_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
