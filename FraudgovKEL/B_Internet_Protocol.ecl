...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE3675768 := __ENH_Internet_Protocol_1;
  SHARED __EE3755046 := __E_Person_Ip_Address;
  SHARED __EE3755053 := __EE3755046(__NN(__EE3755046.Ip_));
  SHARED __ST3743154_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3755067 := PROJECT(TABLE(PROJECT(__EE3755053,TRANSFORM(__ST3743154_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST3743154_Layout);
  SHARED __ST3743172_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3755033 := PROJECT(__CLEANANDDO(__EE3755067,TABLE(__EE3755067,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST3743172_Layout);
  SHARED __ST3747083_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3755076(B_Internet_Protocol_1.__ST78710_Layout __EE3675768, __ST3743172_Layout __EE3755033) := __EEQP(__EE3675768.UID,__EE3755033.UID);
  __ST3747083_Layout __JT3755076(B_Internet_Protocol_1.__ST78710_Layout __l, __ST3743172_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3755077 := JOIN(__EE3675768,__EE3755033,__JC3755076(LEFT,RIGHT),__JT3755076(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3755037 := __ENH_Event_1;
  SHARED __EE3755035 := __E_Internet_Protocol_Event;
  SHARED __EE3758159 := __EE3755035(__NN(__EE3755035.Ip_) AND __NN(__EE3755035.Transaction_));
  SHARED __ST3743738_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3758177(B_Event_1.__ST77589_Layout __EE3755037, E_Internet_Protocol_Event.Layout __EE3758159) := __EEQP(__EE3758159.Transaction_,__EE3755037.UID);
  __ST3743738_Layout __JT3758177(B_Event_1.__ST77589_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3758178 := JOIN(__EE3758159,__EE3755037,__JC3758177(RIGHT,LEFT),__JT3758177(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3739385_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3739385_Layout __ND3758852__Project(__ST3743738_Layout __PP3758179) := TRANSFORM
    SELF.UID := __PP3758179.Ip_;
    SELF._r_Customer_ := __PP3758179._r_Customer__1_;
    SELF.Event_Date_ := __PP3758179.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3758179.UID;
    SELF.Event_Date__1_ := __PP3758179.Event_Date_;
    SELF._r_Customer__1_ := __PP3758179._r_Customer_;
    SELF := __PP3758179;
  END;
  SHARED __EE3761509 := PROJECT(__EE3758178,__ND3758852__Project(LEFT));
  SHARED __ST3740817_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3740817_Layout __ND3761514__Project(__ST3739385_Layout __PP3761510) := TRANSFORM
    SELF.Exp1_ := __PP3761510.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP3761510.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP3761510.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP3761510.Ip_High_Risk_City_ = 1;
    SELF.Exp4_ := __PP3761510.Ip_Hosted_ = 1;
    SELF.Exp5_ := __PP3761510.Ip_Not_Us_ = 1;
    SELF.Exp6_ := __PP3761510.Ip_Tor_ = 1;
    SELF.Exp7_ := __PP3761510.Ip_Vpn_ = 1;
    SELF.Exp8_ := __PP3761510.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp9_ := __PP3761510.Kr_Ip1000_Flag_ = 1;
    SELF.Exp10_ := __PP3761510.Kr_Ip1001_Flag_ = 1;
    SELF.Exp11_ := __PP3761510.Kr_Ip1090_Flag_ = 1;
    SELF.Exp12_ := __PP3761510.Kr_Ip1091_Flag_ = 1;
    SELF.Exp13_ := __PP3761510.Kr_Ip1092_Flag_ = 1;
    SELF.Exp14_ := __PP3761510.Kr_Ip1093_Flag_ = 1;
    SELF.Exp15_ := __PP3761510.Kr_Ip600_Flag_ = 1;
    SELF.Exp16_ := __PP3761510.Kr_Ip601_Flag_ = 1;
    SELF.Exp17_ := __PP3761510.Kr_Ip602_Flag_ = 1;
    SELF.Exp18_ := __PP3761510.Kr_Ip603_Flag_ = 1;
    SELF.Exp19_ := __PP3761510.Kr_Ip604_Flag_ = 1;
    SELF.Exp20_ := __PP3761510.Kr_Ip605_Flag_ = 1;
    SELF.Exp21_ := __PP3761510.Kr_Ip690_Flag_ = 1;
    SELF.Exp22_ := __PP3761510.Kr_Ip691_Flag_ = 1;
    SELF.Exp23_ := __PP3761510.Kr_Ip692_Flag_ = 1;
    SELF.Exp24_ := __PP3761510.Kr_Ip693_Flag_ = 1;
    SELF.Exp25_ := __PP3761510.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP3761510.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp27_ := __PP3761510.Safe_Flag_ = 1;
    SELF := __PP3761510;
  END;
  SHARED __EE3761661 := PROJECT(__EE3761509,__ND3761514__Project(LEFT));
  SHARED __ST3740970_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3761817 := PROJECT(__CLEANANDDO(__EE3761661,TABLE(__EE3761661,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3761661.Exp1_),KEL.Aggregates.MinNG(__EE3761661.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE3761661.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3761661.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3761661.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3761661.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3761661.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3761661.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3761661.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3761661.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3761661.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3761661.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3761661.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3761661.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE3761661.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE3761661.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE3761661.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE3761661.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE3761661.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE3761661.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE3761661.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE3761661.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE3761661.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE3761661.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE3761661.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE3761661.Exp25_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE3761661.Exp26_),KEL.Aggregates.MaxNG(__EE3761661.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE3761661.Exp27_),UID},UID,MERGE)),__ST3740970_Layout);
  SHARED __ST3747755_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3761823(__ST3747083_Layout __EE3755077, __ST3740970_Layout __EE3761817) := __EEQP(__EE3755077.UID,__EE3761817.UID);
  __ST3747755_Layout __JT3761823(__ST3747083_Layout __l, __ST3740970_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3761824 := JOIN(__EE3755077,__EE3761817,__JC3761823(LEFT,RIGHT),__JT3761823(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3657018 := __ENH_Customer_1;
  SHARED __ST3748562_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3761971(__ST3747755_Layout __EE3761824, B_Customer_1.__ST69381_Layout __EE3657018) := __EEQP(__EE3761824._r_Customer_,__EE3657018.UID);
  __ST3748562_Layout __JT3761971(__ST3747755_Layout __l, B_Customer_1.__ST69381_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3761972 := JOIN(__EE3761824,__EE3657018,__JC3761971(LEFT,RIGHT),__JT3761971(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST65222_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST65222_Layout __ND3762892__Project(__ST3748562_Layout __PP3761973) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3761973.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP3761973.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Id_Activity_Dt_First_Seen_ := __PP3761973.M_I_N___Event_Date__2_;
    SELF.Identity_Count_ := __PP3761973.C_O_U_N_T___Person_Ip_Address_;
    __BS3762500 := __T(__PP3761973.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3762500(__T(__OP2(__T(__PP3761973.Source_Customers_)._r_Source_Customer_,=,__PP3761973._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP3761973.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP3761973.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP3761973.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP3761973.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP3761973.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP3761973.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP3761973.Ip_Address_;
    SELF.Last_Event_Date_ := __PP3761973.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3761973.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3761973.Source_Customers_);
    SELF := __PP3761973;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE3761972,__ND3762892__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE4160017 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4160017._r_Customer_;
    __EE4160017.Source_Customers_;
    __EE4160017.Ip_Address_;
    __EE4160017.Otto_Ip_Address_Id_;
    __EE4160017._host_;
    __EE4160017._alias_;
    __EE4160017._location_;
    __EE4160017._ip__address_;
    __EE4160017._ip__address__date_;
    __EE4160017._version_;
    __EE4160017._class_;
    __EE4160017._subnet__mask_;
    __EE4160017._reserved_;
    __EE4160017._isp_;
    __EE4160017._v2__validationipproblems_;
    __EE4160017._v2__ipstate_;
    __EE4160017._v2__ipcountry_;
    __EE4160017._v2__ipcontinent_;
    __EE4160017._iprngbeg_;
    __EE4160017._iprngend_;
    __EE4160017._edgecountry_;
    __EE4160017._edgeregion_;
    __EE4160017._edgecity_;
    __EE4160017._edgeconnspeed_;
    __EE4160017._edgemetrocode_;
    __EE4160017._edgelatitude_;
    __EE4160017._edgelongitude_;
    __EE4160017._edgepostalcode_;
    __EE4160017._edgecountrycode_;
    __EE4160017._edgeregioncode_;
    __EE4160017._edgecitycode_;
    __EE4160017._edgecontinentcode_;
    __EE4160017._edgetwolettercountry_;
    __EE4160017._edgeinternalcode_;
    __EE4160017._edgeareacodes_;
    __EE4160017._edgecountryconf_;
    __EE4160017._edgeregionconf_;
    __EE4160017._edgecitycong_;
    __EE4160017._edgepostalconf_;
    __EE4160017._edgegmtoffset_;
    __EE4160017._edgeindst_;
    __EE4160017._siccode_;
    __EE4160017._domainname_;
    __EE4160017._ispname_;
    __EE4160017._homebiztype_;
    __EE4160017._asn_;
    __EE4160017._asnname_;
    __EE4160017._primarylang_;
    __EE4160017._secondarylang_;
    __EE4160017._proxytype_;
    __EE4160017._proxydescription_;
    __EE4160017._isanisp_;
    __EE4160017._companyname_;
    __EE4160017._ranks_;
    __EE4160017._households_;
    __EE4160017._women_;
    __EE4160017._women18to34_;
    __EE4160017._women35to49_;
    __EE4160017._men_;
    __EE4160017._men18to34_;
    __EE4160017._men35to49_;
    __EE4160017._teens_;
    __EE4160017._kids_;
    __EE4160017._naicscode_;
    __EE4160017._cbsacode_;
    __EE4160017._cbsatitle_;
    __EE4160017._cbsatype_;
    __EE4160017._csacode_;
    __EE4160017._csatitle_;
    __EE4160017._mdcode_;
    __EE4160017._mdtitle_;
    __EE4160017._organizationname_;
    __EE4160017.Aot_Act_Cnt_Ev_;
    __EE4160017.Aot_Src1_Act_Cnt_Ev_;
    __EE4160017.Aot_Src1_Act_Only_Flag_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4160017.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4160017.Aot_Ip_Addr_Safe_Act_Cnt_Ev_;
    __EE4160017.Aot_Ip_Addr_Safe_Act_Old_Dt_Ev_;
    __EE4160017.Aot_Ip_Addr_Safe_Act_New_Dt_Ev_;
    __EE4160017.Aot_Id_Act_Cnt_Ev_;
    __EE4160017.Aot_Id_Act_Cnt30_D_;
    __EE4160017.Aot_Add_Act_Cnt_Ev_;
    __EE4160017.Aot_Add_Act_Cnt30_D_;
    __EE4160017.Aot_Non_St_Act_Cnt_Ev_;
    __EE4160017.Aot_Non_St_Act_Cnt30_D_;
    __EE4160017.Aot_Ip_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4160017.Aot_Ip_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4160017.Aot_Ip_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4160017.Aot_Id_Curr_Prof_Usng_Ip_Cnt_Ev_;
    __EE4160017.Aot_Id_Hist_Prof_Usng_Ip_Cnt_Ev_;
    __EE4160017.Aot_Id_Usng_Ip_Addr_Cnt_Ev_;
    __EE4160017.Customer_Id_;
    __EE4160017.Industry_Type_;
    __EE4160017.Source_Customer_Count_;
    __EE4160017.Entity_Context_Uid_;
    __EE4160017.Label_;
    __EE4160017.Entity_Type_;
    __EE4160017.In_Customer_Population_;
    __EE4160017.Dt_First_Seen_;
    __EE4160017.Dt_Last_Seen_;
    __EE4160017.Id_Activity_Dt_First_Seen_;
    __EE4160017.Id_Activity_Dt_Last_Seen_;
    __EE4160017.Last_Record_Id_;
    __EE4160017.Identity_Count_;
    __EE4160017.Event_Count_;
    __EE4160017.Ip_Not_Us_;
    __EE4160017.Ip_Vpn_;
    __EE4160017.Ip_High_Risk_City_;
    __EE4160017.Ip_Hosted_;
    __EE4160017.Ip_Tor_;
    __EE4160017.Kr_High_Risk_Flag_;
    __EE4160017.Kr_Medium_Risk_Flag_;
    __EE4160017.Kr_Low_Risk_Flag_;
    __EE4160017.Kr_Flag_;
    __EE4160017.Safe_Flag_;
    __EE4160017.Contributor_Safe_Flag_;
    __EE4160017.Kr_Ip600_Flag_;
    __EE4160017.Kr_Ip601_Flag_;
    __EE4160017.Kr_Ip602_Flag_;
    __EE4160017.Kr_Ip603_Flag_;
    __EE4160017.Kr_Ip604_Flag_;
    __EE4160017.Kr_Ip605_Flag_;
    __EE4160017.Kr_Ip690_Flag_;
    __EE4160017.Kr_Ip691_Flag_;
    __EE4160017.Kr_Ip692_Flag_;
    __EE4160017.Kr_Ip693_Flag_;
    __EE4160017.Kr_Ip1000_Flag_;
    __EE4160017.Kr_Ip1001_Flag_;
    __EE4160017.Kr_Ip1090_Flag_;
    __EE4160017.Kr_Ip1091_Flag_;
    __EE4160017.Kr_Ip1092_Flag_;
    __EE4160017.Kr_Ip1093_Flag_;
    __EE4160017.Last_Event_Date_;
    __EE4160017.Kr_Last_Event_Date_;
    __EE4160017.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4160017.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4160017.Date_First_Seen_;
    __EE4160017.Date_Last_Seen_;
    __EE4160017.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE4160017,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4160019_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST65222_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
