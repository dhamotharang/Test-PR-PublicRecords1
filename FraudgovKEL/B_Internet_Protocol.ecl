...
EXPORT B_Internet_Protocol := MODULE
  ...
  SHARED __EE1772048 := __ENH_Internet_Protocol_1;
  SHARED __EE1838329 := __E_Person_Ip_Address;
  SHARED __EE1838336 := __EE1838329(__NN(__EE1838329.Ip_));
  SHARED __ST1828133_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1838350 := PROJECT(TABLE(PROJECT(__EE1838336,TRANSFORM(__ST1828133_Layout,SELF.UID := LEFT.Ip_,SELF := LEFT)),{KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),UID,Subject_},UID,Subject_,MERGE),__ST1828133_Layout);
  SHARED __ST1828151_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := 0;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1838316 := PROJECT(__CLEANANDDO(__EE1838350,TABLE(__EE1838350,{KEL.typ.int C_O_U_N_T___Person_Ip_Address_ := COUNT(GROUP),UID},UID,MERGE)),__ST1828151_Layout);
  SHARED __ST1831297_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1838359(B_Internet_Protocol_1.__ST51571_Layout __EE1772048, __ST1828151_Layout __EE1838316) := __EEQP(__EE1772048.UID,__EE1838316.UID);
  __ST1831297_Layout __JT1838359(B_Internet_Protocol_1.__ST51571_Layout __l, __ST1828151_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1838360 := JOIN(__EE1772048,__EE1838316,__JC1838359(LEFT,RIGHT),__JT1838359(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1838320 := __ENH_Event_1;
  SHARED __EE1838318 := __E_Internet_Protocol_Event;
  SHARED __EE1840859 := __EE1838318(__NN(__EE1838318.Ip_) AND __NN(__EE1838318.Transaction_));
  SHARED __ST1828712_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1840877(B_Event_1.__ST50776_Layout __EE1838320, E_Internet_Protocol_Event.Layout __EE1840859) := __EEQP(__EE1840859.Transaction_,__EE1838320.UID);
  __ST1828712_Layout __JT1840877(B_Event_1.__ST50776_Layout __l, E_Internet_Protocol_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1840878 := JOIN(__EE1840859,__EE1838320,__JC1840877(RIGHT,LEFT),__JT1840877(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1824949_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1824949_Layout __ND1841400__Project(__ST1828712_Layout __PP1840879) := TRANSFORM
    SELF.UID := __PP1840879.Ip_;
    SELF._r_Customer_ := __PP1840879._r_Customer__1_;
    SELF.Event_Date_ := __PP1840879.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1840879.UID;
    SELF.Event_Date__1_ := __PP1840879.Event_Date_;
    SELF._r_Customer__1_ := __PP1840879._r_Customer_;
    SELF := __PP1840879;
  END;
  SHARED __EE1843449 := PROJECT(__EE1840878,__ND1841400__Project(LEFT));
  SHARED __ST1826084_Layout := RECORD
    KEL.typ.ntyp(E_Internet_Protocol.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1826084_Layout __ND1844792__Project(__ST1824949_Layout __PP1843450) := TRANSFORM
    SELF.Exp1_ := __PP1843450.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1843450.Ip_High_Risk_City_ = 1;
    SELF.Exp3_ := __PP1843450.Ip_Hosted_ = 1;
    SELF.Exp4_ := __PP1843450.Ip_Not_Us_ = 1;
    SELF.Exp5_ := __PP1843450.Ip_Tor_ = 1;
    SELF.Exp6_ := __PP1843450.Ip_Vpn_ = 1;
    SELF.Exp7_ := __PP1843450.Kr_High_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp8_ := __PP1843450.Kr_Ip1000_Flag_ = 1;
    SELF.Exp9_ := __PP1843450.Kr_Ip1001_Flag_ = 1;
    SELF.Exp10_ := __PP1843450.Kr_Ip1090_Flag_ = 1;
    SELF.Exp11_ := __PP1843450.Kr_Ip1091_Flag_ = 1;
    SELF.Exp12_ := __PP1843450.Kr_Ip1092_Flag_ = 1;
    SELF.Exp13_ := __PP1843450.Kr_Ip1093_Flag_ = 1;
    SELF.Exp14_ := __PP1843450.Kr_Ip600_Flag_ = 1;
    SELF.Exp15_ := __PP1843450.Kr_Ip601_Flag_ = 1;
    SELF.Exp16_ := __PP1843450.Kr_Ip602_Flag_ = 1;
    SELF.Exp17_ := __PP1843450.Kr_Ip603_Flag_ = 1;
    SELF.Exp18_ := __PP1843450.Kr_Ip604_Flag_ = 1;
    SELF.Exp19_ := __PP1843450.Kr_Ip605_Flag_ = 1;
    SELF.Exp20_ := __PP1843450.Kr_Ip690_Flag_ = 1;
    SELF.Exp21_ := __PP1843450.Kr_Ip691_Flag_ = 1;
    SELF.Exp22_ := __PP1843450.Kr_Ip692_Flag_ = 1;
    SELF.Exp23_ := __PP1843450.Kr_Ip693_Flag_ = 1;
    SELF.Exp24_ := __PP1843450.Kr_Low_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp25_ := __PP1843450.Kr_Medium_Risk_Ip_Address_Flag_ = 1;
    SELF.Exp26_ := __PP1843450.Safe_Flag_ = 1;
    SELF.Exp27_ := __OP2(__PP1843450.Event_Age_,<,__CN(2));
    SELF.Exp28_ := __AND(__OP2(__PP1843450.Event_Age_,<,__CN(2)),__CN(__PP1843450.In_Customer_Population_ = 1));
    SELF.Exp29_ := __OP2(__PP1843450.Event_Age_,<,__CN(366));
    SELF := __PP1843450;
  END;
  SHARED __EE1844831 := PROJECT(__EE1843449,__ND1844792__Project(LEFT));
  SHARED __ST1826247_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1845000 := PROJECT(__CLEANANDDO(__EE1844831,TABLE(__EE1844831,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1844831.Exp1_),KEL.Aggregates.MinNG(__EE1844831.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1844831.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1844831.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1844831.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1844831.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1844831.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1844831.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1844831.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1844831.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1844831.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1844831.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1844831.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1844831.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1844831.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1844831.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1844831.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1844831.Exp17_),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1844831.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__EE1844831.Exp19_),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__EE1844831.Exp20_),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__EE1844831.Exp21_),KEL.typ.int C_O_U_N_T___Exp1__21_ := COUNT(GROUP,__EE1844831.Exp22_),KEL.typ.int C_O_U_N_T___Exp1__22_ := COUNT(GROUP,__EE1844831.Exp23_),KEL.typ.int C_O_U_N_T___Exp1__23_ := COUNT(GROUP,__EE1844831.Exp24_),KEL.typ.int C_O_U_N_T___Exp1__24_ := COUNT(GROUP,__EE1844831.Exp25_),KEL.Aggregates.MaxNG(__EE1844831.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__25_ := COUNT(GROUP,__EE1844831.Exp26_),KEL.typ.int C_O_U_N_T___Exp1__26_ := COUNT(GROUP,__T(__EE1844831.Exp27_)),KEL.typ.int C_O_U_N_T___Exp1__27_ := COUNT(GROUP,__T(__EE1844831.Exp28_)),KEL.typ.int C_O_U_N_T___Exp1__28_ := COUNT(GROUP,__T(__EE1844831.Exp29_)),UID},UID,MERGE)),__ST1826247_Layout);
  SHARED __ST1831926_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1845006(__ST1831297_Layout __EE1838360, __ST1826247_Layout __EE1845000) := __EEQP(__EE1838360.UID,__EE1845000.UID);
  __ST1831926_Layout __JT1845006(__ST1831297_Layout __l, __ST1826247_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1845137 := JOIN(__EE1838360,__EE1845000,__JC1845006(LEFT,RIGHT),__JT1845006(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1760806 := __ENH_Customer_1;
  SHARED __ST1832696_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1845143(__ST1831926_Layout __EE1845137, B_Customer_1.__ST45514_Layout __EE1760806) := __EEQP(__EE1845137._r_Customer_,__EE1760806.UID);
  __ST1832696_Layout __JT1845143(__ST1831926_Layout __l, B_Customer_1.__ST45514_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1845296 := JOIN(__EE1845137,__EE1760806,__JC1845143(LEFT,RIGHT),__JT1845143(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST41315_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST41315_Layout __ND1845301__Project(__ST1832696_Layout __PP1845297) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1845297.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_18'),+,__PP1845297.Otto_Ip_Address_Id_);
    SELF.Entity_Type_ := 18;
    SELF.Identity_Count_ := __PP1845297.C_O_U_N_T___Person_Ip_Address_;
    __BS1845614 := __T(__PP1845297.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1845614(__T(__OP2(__T(__PP1845297.Source_Customers_)._r_Source_Customer_,=,__PP1845297._r_Customer_))))=>1,0);
    SELF.Ip_High_Risk_City_ := MAP(__PP1845297.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Ip_Hosted_ := MAP(__PP1845297.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Ip_Not_Us_ := MAP(__PP1845297.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Ip_Tor_ := MAP(__PP1845297.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Ip_Vpn_ := MAP(__PP1845297.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Ip1000_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Ip1001_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Ip1090_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Ip1091_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Ip1092_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Ip1093_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Ip600_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Ip601_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Ip602_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Ip603_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Kr_Ip604_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Kr_Ip605_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__18_ <> 0=>1,0);
    SELF.Kr_Ip690_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__19_ <> 0=>1,0);
    SELF.Kr_Ip691_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__20_ <> 0=>1,0);
    SELF.Kr_Ip692_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__21_ <> 0=>1,0);
    SELF.Kr_Ip693_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__22_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__23_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__24_ <> 0=>1,0);
    SELF.Label_ := __PP1845297.Ip_Address_;
    SELF.Last_Event_Date_ := __PP1845297.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1845297.C_O_U_N_T___Exp1__25_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1845297.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1845297.C_O_U_N_T___Exp1__26_;
    SELF.Vl_Event1_Count_ := __PP1845297.C_O_U_N_T___Exp1__27_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1845297.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1845297.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1845297.C_O_U_N_T___Exp1__28_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1845297.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1845297.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1845297;
  END;
  EXPORT __ENH_Internet_Protocol := PROJECT(__EE1845296,__ND1845301__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Internet_Protocol::Annotated',EXPIRE(7));
  SHARED __EE2277768 := __ENH_Internet_Protocol;
  SHARED IDX_Internet_Protocol_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2277768._r_Customer_;
    __EE2277768.Source_Customers_;
    __EE2277768.Ip_Address_;
    __EE2277768.Otto_Ip_Address_Id_;
    __EE2277768._host_;
    __EE2277768._alias_;
    __EE2277768._location_;
    __EE2277768._ip__address_;
    __EE2277768._ip__address__date_;
    __EE2277768._version_;
    __EE2277768._class_;
    __EE2277768._subnet__mask_;
    __EE2277768._reserved_;
    __EE2277768._isp_;
    __EE2277768._v2__validationipproblems_;
    __EE2277768._v2__ipstate_;
    __EE2277768._v2__ipcountry_;
    __EE2277768._v2__ipcontinent_;
    __EE2277768._iprngbeg_;
    __EE2277768._iprngend_;
    __EE2277768._edgecountry_;
    __EE2277768._edgeregion_;
    __EE2277768._edgecity_;
    __EE2277768._edgeconnspeed_;
    __EE2277768._edgemetrocode_;
    __EE2277768._edgelatitude_;
    __EE2277768._edgelongitude_;
    __EE2277768._edgepostalcode_;
    __EE2277768._edgecountrycode_;
    __EE2277768._edgeregioncode_;
    __EE2277768._edgecitycode_;
    __EE2277768._edgecontinentcode_;
    __EE2277768._edgetwolettercountry_;
    __EE2277768._edgeinternalcode_;
    __EE2277768._edgeareacodes_;
    __EE2277768._edgecountryconf_;
    __EE2277768._edgeregionconf_;
    __EE2277768._edgecitycong_;
    __EE2277768._edgepostalconf_;
    __EE2277768._edgegmtoffset_;
    __EE2277768._edgeindst_;
    __EE2277768._siccode_;
    __EE2277768._domainname_;
    __EE2277768._ispname_;
    __EE2277768._homebiztype_;
    __EE2277768._asn_;
    __EE2277768._asnname_;
    __EE2277768._primarylang_;
    __EE2277768._secondarylang_;
    __EE2277768._proxytype_;
    __EE2277768._proxydescription_;
    __EE2277768._isanisp_;
    __EE2277768._companyname_;
    __EE2277768._ranks_;
    __EE2277768._households_;
    __EE2277768._women_;
    __EE2277768._women18to34_;
    __EE2277768._women35to49_;
    __EE2277768._men_;
    __EE2277768._men18to34_;
    __EE2277768._men35to49_;
    __EE2277768._teens_;
    __EE2277768._kids_;
    __EE2277768._naicscode_;
    __EE2277768._cbsacode_;
    __EE2277768._cbsatitle_;
    __EE2277768._cbsatype_;
    __EE2277768._csacode_;
    __EE2277768._csatitle_;
    __EE2277768._mdcode_;
    __EE2277768._mdtitle_;
    __EE2277768._organizationname_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_Cnt_Ev_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_Shrd_Cnt_Ev_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_Old_Dt_Ev_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_New_Dt_Ev_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2277768.Aot_Ip_Addr_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2277768.Customer_Id_;
    __EE2277768.Industry_Type_;
    __EE2277768.Source_Customer_Count_;
    __EE2277768.Entity_Context_Uid_;
    __EE2277768.Label_;
    __EE2277768.Entity_Type_;
    __EE2277768.In_Customer_Population_;
    __EE2277768.Dt_First_Seen_;
    __EE2277768.Dt_Last_Seen_;
    __EE2277768.Last_Record_Id_;
    __EE2277768.Identity_Count_;
    __EE2277768.Event_Count_;
    __EE2277768.Ip_Not_Us_;
    __EE2277768.Ip_Vpn_;
    __EE2277768.Ip_High_Risk_City_;
    __EE2277768.Ip_Hosted_;
    __EE2277768.Ip_Tor_;
    __EE2277768.Kr_High_Risk_Flag_;
    __EE2277768.Kr_Medium_Risk_Flag_;
    __EE2277768.Kr_Low_Risk_Flag_;
    __EE2277768.Kr_Flag_;
    __EE2277768.Safe_Flag_;
    __EE2277768.Contributor_Safe_Flag_;
    __EE2277768.Kr_Ip600_Flag_;
    __EE2277768.Kr_Ip601_Flag_;
    __EE2277768.Kr_Ip602_Flag_;
    __EE2277768.Kr_Ip603_Flag_;
    __EE2277768.Kr_Ip604_Flag_;
    __EE2277768.Kr_Ip605_Flag_;
    __EE2277768.Kr_Ip690_Flag_;
    __EE2277768.Kr_Ip691_Flag_;
    __EE2277768.Kr_Ip692_Flag_;
    __EE2277768.Kr_Ip693_Flag_;
    __EE2277768.Kr_Ip1000_Flag_;
    __EE2277768.Kr_Ip1001_Flag_;
    __EE2277768.Kr_Ip1090_Flag_;
    __EE2277768.Kr_Ip1091_Flag_;
    __EE2277768.Kr_Ip1092_Flag_;
    __EE2277768.Kr_Ip1093_Flag_;
    __EE2277768.Last_Event_Date_;
    __EE2277768.Kr_Last_Event_Date_;
    __EE2277768.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2277768.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2277768.Vl_Event1_All_Count_;
    __EE2277768.Vl_Event7_All_Count_;
    __EE2277768.Vl_Event30_All_Day_Count_;
    __EE2277768.Vl_Event365_All_Day_Count_;
    __EE2277768.Vl_Event7_All_Active_Flag_;
    __EE2277768.Vl_Event30_All_Active_Flag_;
    __EE2277768.Vl_Event1_Count_;
    __EE2277768.Vl_Event7_Count_;
    __EE2277768.Vl_Event30_Count_;
    __EE2277768.Vl_Event365_Count_;
    __EE2277768.Vl_Event7_Active_Flag_;
    __EE2277768.Vl_Event30_Active_Flag_;
    __EE2277768.Date_First_Seen_;
    __EE2277768.Date_Last_Seen_;
    __EE2277768.__RecordCount;
  END;
  SHARED IDX_Internet_Protocol_UID_Projected := PROJECT(__EE2277768,TRANSFORM(IDX_Internet_Protocol_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2277770_Layout := RECORDOF(IDX_Internet_Protocol_UID);
  EXPORT IDX_Internet_Protocol_UID_Wrapped := PROJECT(IDX_Internet_Protocol_UID,TRANSFORM(__ST41315_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
