...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE2356450 := __E_Person_Bank_Account;
  SHARED __EE2356433 := __ENH_Person;
  SHARED __ST2356468_Layout := RECORD
  ...
  END;
  __JC2356465(E_Person_Bank_Account.Layout __EE2356450, B_Person.__ST45138_Layout __EE2356433) := __EEQP(__EE2356450.Subject_,__EE2356433.UID);
  __ST2356468_Layout __JT2356465(E_Person_Bank_Account.Layout __l, B_Person.__ST45138_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2356466 := JOIN(__EE2356450,__EE2356433,__JC2356465(LEFT,RIGHT),__JT2356465(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2356421 := __ENH_Bank_Account;
  SHARED __ST2356782_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2357608(__ST2356468_Layout __EE2356466, B_Bank_Account.__ST32316_Layout __EE2356421) := __EEQP(__EE2356466.Account_,__EE2356421.UID);
  __ST2356782_Layout __JT2357608(__ST2356468_Layout __l, B_Bank_Account.__ST32316_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2357609 := JOIN(__EE2356466,__EE2356421,__JC2357608(LEFT,RIGHT),__JT2357608(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2356406 := __E_Customer;
  SHARED __ST2357222_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2357610(__ST2356782_Layout __EE2357609, E_Customer.Layout __EE2356406) := __EEQP(__EE2357609._r_Customer_,__EE2356406.UID);
  __ST2357222_Layout __JT2357610(__ST2356782_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2357611 := JOIN(__EE2357609,__EE2356406,__JC2357610(LEFT,RIGHT),__JT2357610(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST30899_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST30899_Layout __ND2357600__Project(__ST2357222_Layout __PP2357599) := TRANSFORM
    SELF.Source_Customer_ := __PP2357599._r_Customer_;
    SELF.Customer_Id_ := __PP2357599.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2357599.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2357599.Entity_Context_Uid__1_;
    SELF := __PP2357599;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2357611,__ND2357600__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST30899_Layout));
END;
