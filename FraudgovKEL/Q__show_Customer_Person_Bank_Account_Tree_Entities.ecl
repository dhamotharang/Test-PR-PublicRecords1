...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE1334081 := __E_Person_Bank_Account;
  SHARED __EE1334064 := __ENH_Person;
  SHARED __ST1334099_Layout := RECORD
  ...
  END;
  __JC1334096(E_Person_Bank_Account.Layout __EE1334081, B_Person.__ST30665_Layout __EE1334064) := __EEQP(__EE1334081.Subject_,__EE1334064.UID);
  __ST1334099_Layout __JT1334096(E_Person_Bank_Account.Layout __l, B_Person.__ST30665_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1334097 := JOIN(__EE1334081,__EE1334064,__JC1334096(LEFT,RIGHT),__JT1334096(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1334052 := __ENH_Bank_Account;
  SHARED __ST1334471_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1335401(__ST1334099_Layout __EE1334097, B_Bank_Account.__ST23132_Layout __EE1334052) := __EEQP(__EE1334097.Account_,__EE1334052.UID);
  __ST1334471_Layout __JT1335401(__ST1334099_Layout __l, B_Bank_Account.__ST23132_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1335402 := JOIN(__EE1334097,__EE1334052,__JC1335401(LEFT,RIGHT),__JT1335401(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1334037 := __E_Customer;
  SHARED __ST1334963_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1335403(__ST1334471_Layout __EE1335402, E_Customer.Layout __EE1334037) := __EEQP(__EE1335402._r_Customer_,__EE1334037.UID);
  __ST1334963_Layout __JT1335403(__ST1334471_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1335404 := JOIN(__EE1335402,__EE1334037,__JC1335403(LEFT,RIGHT),__JT1335403(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21839_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21839_Layout __ND1335393__Project(__ST1334963_Layout __PP1335392) := TRANSFORM
    SELF.Source_Customer_ := __PP1335392._r_Customer_;
    SELF.Customer_Id_ := __PP1335392.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1335392.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1335392.Entity_Context_Uid__1_;
    SELF := __PP1335392;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1335404,__ND1335393__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21839_Layout));
END;
