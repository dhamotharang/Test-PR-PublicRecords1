...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE4221630 := __E_Person_Bank_Account;
  SHARED __EE4221613 := __ENH_Person;
  SHARED __ST4221648_Layout := RECORD
  ...
  END;
  __JC4221645(E_Person_Bank_Account.Layout __EE4221630, B_Person.__ST66421_Layout __EE4221613) := __EEQP(__EE4221630.Subject_,__EE4221613.UID);
  __ST4221648_Layout __JT4221645(E_Person_Bank_Account.Layout __l, B_Person.__ST66421_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4221646 := JOIN(__EE4221630,__EE4221613,__JC4221645(LEFT,RIGHT),__JT4221645(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4221601 := __ENH_Bank_Account;
  SHARED __ST4221986_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4222904(__ST4221648_Layout __EE4221646, B_Bank_Account.__ST46658_Layout __EE4221601) := __EEQP(__EE4221646.Account_,__EE4221601.UID);
  __ST4221986_Layout __JT4222904(__ST4221648_Layout __l, B_Bank_Account.__ST46658_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4222905 := JOIN(__EE4221646,__EE4221601,__JC4222904(LEFT,RIGHT),__JT4222904(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4221586 := __E_Customer;
  SHARED __ST4222480_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4222906(__ST4221986_Layout __EE4222905, E_Customer.Layout __EE4221586) := __EEQP(__EE4222905._r_Customer_,__EE4221586.UID);
  __ST4222480_Layout __JT4222906(__ST4221986_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4222907 := JOIN(__EE4222905,__EE4221586,__JC4222906(LEFT,RIGHT),__JT4222906(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44833_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44833_Layout __ND4222896__Project(__ST4222480_Layout __PP4222895) := TRANSFORM
    SELF.Source_Customer_ := __PP4222895._r_Customer_;
    SELF.Customer_Id_ := __PP4222895.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4222895.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4222895.Entity_Context_Uid__1_;
    SELF := __PP4222895;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4222907,__ND4222896__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44833_Layout));
END;
