...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE1316996 := __E_Person_Bank_Account;
  SHARED __EE1316979 := __ENH_Person;
  SHARED __ST1317014_Layout := RECORD
  ...
  END;
  __JC1317011(E_Person_Bank_Account.Layout __EE1316996, B_Person.__ST30729_Layout __EE1316979) := __EEQP(__EE1316996.Subject_,__EE1316979.UID);
  __ST1317014_Layout __JT1317011(E_Person_Bank_Account.Layout __l, B_Person.__ST30729_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1317012 := JOIN(__EE1316996,__EE1316979,__JC1317011(LEFT,RIGHT),__JT1317011(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1316967 := __ENH_Bank_Account;
  SHARED __ST1317386_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1318316(__ST1317014_Layout __EE1317012, B_Bank_Account.__ST23172_Layout __EE1316967) := __EEQP(__EE1317012.Account_,__EE1316967.UID);
  __ST1317386_Layout __JT1318316(__ST1317014_Layout __l, B_Bank_Account.__ST23172_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1318317 := JOIN(__EE1317012,__EE1316967,__JC1318316(LEFT,RIGHT),__JT1318316(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1316952 := __E_Customer;
  SHARED __ST1317878_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1318318(__ST1317386_Layout __EE1318317, E_Customer.Layout __EE1316952) := __EEQP(__EE1318317._r_Customer_,__EE1316952.UID);
  __ST1317878_Layout __JT1318318(__ST1317386_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1318319 := JOIN(__EE1318317,__EE1316952,__JC1318318(LEFT,RIGHT),__JT1318318(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21879_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21879_Layout __ND1318308__Project(__ST1317878_Layout __PP1318307) := TRANSFORM
    SELF.Source_Customer_ := __PP1318307._r_Customer_;
    SELF.Customer_Id_ := __PP1318307.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1318307.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1318307.Entity_Context_Uid__1_;
    SELF := __PP1318307;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1318319,__ND1318308__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21879_Layout));
END;
