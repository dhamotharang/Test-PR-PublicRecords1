...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE2236175 := __E_Person_Bank_Account;
  SHARED __EE2236158 := __ENH_Person;
  SHARED __ST2236193_Layout := RECORD
  ...
  END;
  __JC2236190(E_Person_Bank_Account.Layout __EE2236175, B_Person.__ST43253_Layout __EE2236158) := __EEQP(__EE2236175.Subject_,__EE2236158.UID);
  __ST2236193_Layout __JT2236190(E_Person_Bank_Account.Layout __l, B_Person.__ST43253_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2236191 := JOIN(__EE2236175,__EE2236158,__JC2236190(LEFT,RIGHT),__JT2236190(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2236146 := __ENH_Bank_Account;
  SHARED __ST2236507_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2237333(__ST2236193_Layout __EE2236191, B_Bank_Account.__ST31055_Layout __EE2236146) := __EEQP(__EE2236191.Account_,__EE2236146.UID);
  __ST2236507_Layout __JT2237333(__ST2236193_Layout __l, B_Bank_Account.__ST31055_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2237334 := JOIN(__EE2236191,__EE2236146,__JC2237333(LEFT,RIGHT),__JT2237333(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2236131 := __E_Customer;
  SHARED __ST2236947_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2237335(__ST2236507_Layout __EE2237334, E_Customer.Layout __EE2236131) := __EEQP(__EE2237334._r_Customer_,__EE2236131.UID);
  __ST2236947_Layout __JT2237335(__ST2236507_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2237336 := JOIN(__EE2237334,__EE2236131,__JC2237335(LEFT,RIGHT),__JT2237335(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST29678_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29678_Layout __ND2237325__Project(__ST2236947_Layout __PP2237324) := TRANSFORM
    SELF.Source_Customer_ := __PP2237324._r_Customer_;
    SELF.Customer_Id_ := __PP2237324.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2237324.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2237324.Entity_Context_Uid__1_;
    SELF := __PP2237324;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2237336,__ND2237325__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST29678_Layout));
END;
