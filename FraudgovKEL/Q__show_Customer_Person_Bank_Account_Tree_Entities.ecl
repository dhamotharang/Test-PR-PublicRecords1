...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE2364963 := __E_Person_Bank_Account;
  SHARED __EE2364946 := __ENH_Person;
  SHARED __ST2364981_Layout := RECORD
  ...
  END;
  __JC2364978(E_Person_Bank_Account.Layout __EE2364963, B_Person.__ST45148_Layout __EE2364946) := __EEQP(__EE2364963.Subject_,__EE2364946.UID);
  __ST2364981_Layout __JT2364978(E_Person_Bank_Account.Layout __l, B_Person.__ST45148_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2364979 := JOIN(__EE2364963,__EE2364946,__JC2364978(LEFT,RIGHT),__JT2364978(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2364934 := __ENH_Bank_Account;
  SHARED __ST2365295_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2366121(__ST2364981_Layout __EE2364979, B_Bank_Account.__ST32322_Layout __EE2364934) := __EEQP(__EE2364979.Account_,__EE2364934.UID);
  __ST2365295_Layout __JT2366121(__ST2364981_Layout __l, B_Bank_Account.__ST32322_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2366122 := JOIN(__EE2364979,__EE2364934,__JC2366121(LEFT,RIGHT),__JT2366121(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2364919 := __E_Customer;
  SHARED __ST2365735_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2366123(__ST2365295_Layout __EE2366122, E_Customer.Layout __EE2364919) := __EEQP(__EE2366122._r_Customer_,__EE2364919.UID);
  __ST2365735_Layout __JT2366123(__ST2365295_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2366124 := JOIN(__EE2366122,__EE2364919,__JC2366123(LEFT,RIGHT),__JT2366123(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST30905_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST30905_Layout __ND2366113__Project(__ST2365735_Layout __PP2366112) := TRANSFORM
    SELF.Source_Customer_ := __PP2366112._r_Customer_;
    SELF.Customer_Id_ := __PP2366112.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2366112.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2366112.Entity_Context_Uid__1_;
    SELF := __PP2366112;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2366124,__ND2366113__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST30905_Layout));
END;
