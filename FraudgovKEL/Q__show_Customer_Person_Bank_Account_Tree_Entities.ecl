...
IMPORT B_Bank_Account,B_Person,B_Person_1,B_Person_2,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Person,E_Person_Bank_Account FROM FraudgovKEL;
...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE1341082 := __E_Person_Bank_Account;
  SHARED __EE1341065 := __ENH_Person;
  SHARED __ST1341100_Layout := RECORD
  ...
  END;
  __JC1341097(E_Person_Bank_Account.Layout __EE1341082, B_Person.__ST30803_Layout __EE1341065) := __EEQP(__EE1341082.Subject_,__EE1341065.UID);
  __ST1341100_Layout __JT1341097(E_Person_Bank_Account.Layout __l, B_Person.__ST30803_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1341098 := JOIN(__EE1341082,__EE1341065,__JC1341097(LEFT,RIGHT),__JT1341097(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1341053 := __ENH_Bank_Account;
  SHARED __ST1341472_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1342402(__ST1341100_Layout __EE1341098, B_Bank_Account.__ST23228_Layout __EE1341053) := __EEQP(__EE1341098.Account_,__EE1341053.UID);
  __ST1341472_Layout __JT1342402(__ST1341100_Layout __l, B_Bank_Account.__ST23228_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1342403 := JOIN(__EE1341098,__EE1341053,__JC1342402(LEFT,RIGHT),__JT1342402(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1341038 := __E_Customer;
  SHARED __ST1341964_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1342404(__ST1341472_Layout __EE1342403, E_Customer.Layout __EE1341038) := __EEQP(__EE1342403._r_Customer_,__EE1341038.UID);
  __ST1341964_Layout __JT1342404(__ST1341472_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1342405 := JOIN(__EE1342403,__EE1341038,__JC1342404(LEFT,RIGHT),__JT1342404(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21934_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21934_Layout __ND1342394__Project(__ST1341964_Layout __PP1342393) := TRANSFORM
    SELF.Source_Customer_ := __PP1342393._r_Customer_;
    SELF.Customer_Id_ := __PP1342393.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1342393.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1342393.Entity_Context_Uid__1_;
    SELF := __PP1342393;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1342405,__ND1342394__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21934_Layout));
END;
