...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE4674032 := __E_Person_Bank_Account;
  SHARED __EE4674015 := __ENH_Person;
  SHARED __ST4674050_Layout := RECORD
  ...
  END;
  __JC4674047(E_Person_Bank_Account.Layout __EE4674032, B_Person.__ST69071_Layout __EE4674015) := __EEQP(__EE4674032.Subject_,__EE4674015.UID);
  __ST4674050_Layout __JT4674047(E_Person_Bank_Account.Layout __l, B_Person.__ST69071_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4674048 := JOIN(__EE4674032,__EE4674015,__JC4674047(LEFT,RIGHT),__JT4674047(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4674003 := __ENH_Bank_Account;
  SHARED __ST4674325_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4675082(__ST4674050_Layout __EE4674048, B_Bank_Account.__ST47664_Layout __EE4674003) := __EEQP(__EE4674048.Account_,__EE4674003.UID);
  __ST4674325_Layout __JT4675082(__ST4674050_Layout __l, B_Bank_Account.__ST47664_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4675083 := JOIN(__EE4674048,__EE4674003,__JC4675082(LEFT,RIGHT),__JT4675082(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4673988 := __E_Customer;
  SHARED __ST4674729_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4675084(__ST4674325_Layout __EE4675083, E_Customer.Layout __EE4673988) := __EEQP(__EE4675083._r_Customer_,__EE4673988.UID);
  __ST4674729_Layout __JT4675084(__ST4674325_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4675085 := JOIN(__EE4675083,__EE4673988,__JC4675084(LEFT,RIGHT),__JT4675084(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST46097_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46097_Layout __ND4675074__Project(__ST4674729_Layout __PP4675073) := TRANSFORM
    SELF.Source_Customer_ := __PP4675073._r_Customer_;
    SELF.Customer_Id_ := __PP4675073.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4675073.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4675073.Entity_Context_Uid__1_;
    SELF := __PP4675073;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4675085,__ND4675074__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST46097_Layout));
END;
