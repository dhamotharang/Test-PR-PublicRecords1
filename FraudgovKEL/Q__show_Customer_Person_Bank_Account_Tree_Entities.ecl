...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE4785079 := __E_Person_Bank_Account;
  SHARED __EE4785062 := __ENH_Person;
  SHARED __ST4785097_Layout := RECORD
  ...
  END;
  __JC4785094(E_Person_Bank_Account.Layout __EE4785079, B_Person.__ST71326_Layout __EE4785062) := __EEQP(__EE4785079.Subject_,__EE4785062.UID);
  __ST4785097_Layout __JT4785094(E_Person_Bank_Account.Layout __l, B_Person.__ST71326_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4785095 := JOIN(__EE4785079,__EE4785062,__JC4785094(LEFT,RIGHT),__JT4785094(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4785050 := __ENH_Bank_Account;
  SHARED __ST4785438_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4786374(__ST4785097_Layout __EE4785095, B_Bank_Account.__ST49796_Layout __EE4785050) := __EEQP(__EE4785095.Account_,__EE4785050.UID);
  __ST4785438_Layout __JT4786374(__ST4785097_Layout __l, B_Bank_Account.__ST49796_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4786375 := JOIN(__EE4785095,__EE4785050,__JC4786374(LEFT,RIGHT),__JT4786374(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4785035 := __E_Customer;
  SHARED __ST4785944_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4786376(__ST4785438_Layout __EE4786375, E_Customer.Layout __EE4785035) := __EEQP(__EE4786375._r_Customer_,__EE4785035.UID);
  __ST4785944_Layout __JT4786376(__ST4785438_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4786377 := JOIN(__EE4786375,__EE4785035,__JC4786376(LEFT,RIGHT),__JT4786376(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST47967_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47967_Layout __ND4786366__Project(__ST4785944_Layout __PP4786365) := TRANSFORM
    SELF.Source_Customer_ := __PP4786365._r_Customer_;
    SELF.Customer_Id_ := __PP4786365.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4786365.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4786365.Entity_Context_Uid__1_;
    SELF := __PP4786365;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4786377,__ND4786366__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST47967_Layout));
END;
