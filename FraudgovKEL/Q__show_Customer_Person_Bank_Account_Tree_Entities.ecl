...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE4121544 := __E_Person_Bank_Account;
  SHARED __EE4121527 := __ENH_Person;
  SHARED __ST4121562_Layout := RECORD
  ...
  END;
  __JC4121559(E_Person_Bank_Account.Layout __EE4121544, B_Person.__ST66581_Layout __EE4121527) := __EEQP(__EE4121544.Subject_,__EE4121527.UID);
  __ST4121562_Layout __JT4121559(E_Person_Bank_Account.Layout __l, B_Person.__ST66581_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4121560 := JOIN(__EE4121544,__EE4121527,__JC4121559(LEFT,RIGHT),__JT4121559(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4121515 := __ENH_Bank_Account;
  SHARED __ST4121837_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4122593(__ST4121562_Layout __EE4121560, B_Bank_Account.__ST46237_Layout __EE4121515) := __EEQP(__EE4121560.Account_,__EE4121515.UID);
  __ST4121837_Layout __JT4122593(__ST4121562_Layout __l, B_Bank_Account.__ST46237_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4122594 := JOIN(__EE4121560,__EE4121515,__JC4122593(LEFT,RIGHT),__JT4122593(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4121500 := __E_Customer;
  SHARED __ST4122241_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4122595(__ST4121837_Layout __EE4122594, E_Customer.Layout __EE4121500) := __EEQP(__EE4122594._r_Customer_,__EE4121500.UID);
  __ST4122241_Layout __JT4122595(__ST4121837_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4122596 := JOIN(__EE4122594,__EE4121500,__JC4122595(LEFT,RIGHT),__JT4122595(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44612_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44612_Layout __ND4122585__Project(__ST4122241_Layout __PP4122584) := TRANSFORM
    SELF.Source_Customer_ := __PP4122584._r_Customer_;
    SELF.Customer_Id_ := __PP4122584.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4122584.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4122584.Entity_Context_Uid__1_;
    SELF := __PP4122584;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4122596,__ND4122585__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44612_Layout));
END;
