...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE1315194 := __E_Person_Bank_Account;
  SHARED __EE1315177 := __ENH_Person;
  SHARED __ST1315212_Layout := RECORD
  ...
  END;
  __JC1315209(E_Person_Bank_Account.Layout __EE1315194, B_Person.__ST30234_Layout __EE1315177) := __EEQP(__EE1315194.Subject_,__EE1315177.UID);
  __ST1315212_Layout __JT1315209(E_Person_Bank_Account.Layout __l, B_Person.__ST30234_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1315210 := JOIN(__EE1315194,__EE1315177,__JC1315209(LEFT,RIGHT),__JT1315209(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1315165 := __ENH_Bank_Account;
  SHARED __ST1315586_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1316520(__ST1315212_Layout __EE1315210, B_Bank_Account.__ST22865_Layout __EE1315165) := __EEQP(__EE1315210.Account_,__EE1315165.UID);
  __ST1315586_Layout __JT1316520(__ST1315212_Layout __l, B_Bank_Account.__ST22865_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1316521 := JOIN(__EE1315210,__EE1315165,__JC1316520(LEFT,RIGHT),__JT1316520(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1315150 := __E_Customer;
  SHARED __ST1316080_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1316522(__ST1315586_Layout __EE1316521, E_Customer.Layout __EE1315150) := __EEQP(__EE1316521._r_Customer_,__EE1315150.UID);
  __ST1316080_Layout __JT1316522(__ST1315586_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1316523 := JOIN(__EE1316521,__EE1315150,__JC1316522(LEFT,RIGHT),__JT1316522(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST21572_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21572_Layout __ND1316512__Project(__ST1316080_Layout __PP1316511) := TRANSFORM
    SELF.Source_Customer_ := __PP1316511._r_Customer_;
    SELF.Customer_Id_ := __PP1316511.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1316511.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1316511.Entity_Context_Uid__1_;
    SELF := __PP1316511;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1316523,__ND1316512__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST21572_Layout));
END;
