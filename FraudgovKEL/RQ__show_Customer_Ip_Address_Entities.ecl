...
EXPORT RQ__show_Customer_Ip_Address_Entities := MODULE
  SHARED __EE4332117 := B_Internet_Protocol.IDX_Internet_Protocol_UID_Wrapped;
  SHARED __EE4332383 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4250170_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4332397(B_Internet_Protocol.__ST64268_Layout __EE4332117, E_Customer.Layout __EE4332383) := __EEQP(__EE4332117._r_Customer_,__EE4332383.UID);
  __ST4250170_Layout __JT4332397(B_Internet_Protocol.__ST64268_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4332608 := JOIN(__EE4332117,__EE4332383,__JC4332397(LEFT,RIGHT),__JT4332397(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4250030_Layout := RECORD
