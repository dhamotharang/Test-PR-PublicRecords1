...
EXPORT RQ__show_Customer_Ip_Address_Entities := MODULE
  SHARED __EE4769060 := B_Internet_Protocol.IDX_Internet_Protocol_UID_Wrapped;
  SHARED __EE4769321 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4698654_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4769336(B_Internet_Protocol.__ST67752_Layout __EE4769060, E_Customer.Layout __EE4769321) := __EEQP(__EE4769060._r_Customer_,__EE4769321.UID);
  __ST4698654_Layout __JT4769336(B_Internet_Protocol.__ST67752_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4769539 := JOIN(__EE4769060,__EE4769321,__JC4769336(LEFT,RIGHT),__JT4769336(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4698514_Layout := RECORD
