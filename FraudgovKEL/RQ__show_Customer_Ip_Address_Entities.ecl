...
EXPORT RQ__show_Customer_Ip_Address_Entities := MODULE
  SHARED __EE4471848 := B_Internet_Protocol.IDX_Internet_Protocol_UID_Wrapped;
  SHARED __EE4472109 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4401443_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4472124(B_Internet_Protocol.__ST68443_Layout __EE4471848, E_Customer.Layout __EE4472109) := __EEQP(__EE4471848._r_Customer_,__EE4472109.UID);
  __ST4401443_Layout __JT4472124(B_Internet_Protocol.__ST68443_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4472327 := JOIN(__EE4471848,__EE4472109,__JC4472124(LEFT,RIGHT),__JT4472124(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4401303_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4401303_Layout __ND4472491__Project(__ST4401443_Layout __PP4472328) := TRANSFORM
    SELF.Source_Customer_ := __PP4472328._r_Customer_;
    SELF.Customer_Id_ := __PP4472328.Customer_Id__1_;
    SELF.Industry_Type_ := __PP4472328.Industry_Type__1_;
    SELF.Person_Count_ := __PP4472328.Identity_Count_;
    SELF := __PP4472328;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4472327,__ND4472491__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_},Source_Customer_,Customer_Id_,Industry_Type_,Entity_Context_Uid_,Label_,Entity_Type_,Person_Count_,In_Customer_Population_,Contributor_Safe_Flag_,Safe_Flag_,Dt_First_Seen_,Dt_Last_Seen_,Kr_High_Risk_Flag_,Kr_Medium_Risk_Flag_,Kr_Low_Risk_Flag_,MERGE),__ST4401303_Layout));
END;
