...
EXPORT Q__show_Customer_Person_Ip_Tree_Entities := MODULE
  ...
  SHARED __EE2226669 := __E_Person_Ip_Address;
  SHARED __EE2226652 := __ENH_Person;
  SHARED __ST2226687_Layout := RECORD
  ...
  END;
  __JC2226684(E_Person_Ip_Address.Layout __EE2226669, B_Person.__ST43253_Layout __EE2226652) := __EEQP(__EE2226669.Subject_,__EE2226652.UID);
  __ST2226687_Layout __JT2226684(E_Person_Ip_Address.Layout __l, B_Person.__ST43253_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2226685 := JOIN(__EE2226669,__EE2226652,__JC2226684(LEFT,RIGHT),__JT2226684(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2226640 := __ENH_Internet_Protocol;
  SHARED __ST2227001_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2227993(__ST2226687_Layout __EE2226685, B_Internet_Protocol.__ST41315_Layout __EE2226640) := __EEQP(__EE2226685.Ip_,__EE2226640.UID);
  __ST2227001_Layout __JT2227993(__ST2226687_Layout __l, B_Internet_Protocol.__ST41315_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2227994 := JOIN(__EE2226685,__EE2226640,__JC2227993(LEFT,RIGHT),__JT2227993(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2226625 := __E_Customer;
  SHARED __ST2227529_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2227995(__ST2227001_Layout __EE2227994, E_Customer.Layout __EE2226625) := __EEQP(__EE2227994._r_Customer_,__EE2226625.UID);
  __ST2227529_Layout __JT2227995(__ST2227001_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2227996 := JOIN(__EE2227994,__EE2226625,__JC2227995(LEFT,RIGHT),__JT2227995(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST29618_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29618_Layout __ND2227985__Project(__ST2227529_Layout __PP2227984) := TRANSFORM
    SELF.Source_Customer_ := __PP2227984._r_Customer_;
    SELF.Customer_Id_ := __PP2227984.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2227984.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2227984.Entity_Context_Uid__1_;
    SELF := __PP2227984;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2227996,__ND2227985__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST29618_Layout));
END;
