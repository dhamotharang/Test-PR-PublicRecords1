...
EXPORT Q__show_Customer_Person_Ip_Tree_Entities := MODULE
  ...
  SHARED __EE4037958 := __E_Person_Ip_Address;
  SHARED __EE4037941 := __ENH_Person;
  SHARED __ST4037976_Layout := RECORD
  ...
  END;
  __JC4037973(E_Person_Ip_Address.Layout __EE4037958, B_Person.__ST65777_Layout __EE4037941) := __EEQP(__EE4037958.Subject_,__EE4037941.UID);
  __ST4037976_Layout __JT4037973(E_Person_Ip_Address.Layout __l, B_Person.__ST65777_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4037974 := JOIN(__EE4037958,__EE4037941,__JC4037973(LEFT,RIGHT),__JT4037973(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4037929 := __ENH_Internet_Protocol;
  SHARED __ST4038312_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4039390(__ST4037976_Layout __EE4037974, B_Internet_Protocol.__ST63642_Layout __EE4037929) := __EEQP(__EE4037974.Ip_,__EE4037929.UID);
  __ST4038312_Layout __JT4039390(__ST4037976_Layout __l, B_Internet_Protocol.__ST63642_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4039391 := JOIN(__EE4037974,__EE4037929,__JC4039390(LEFT,RIGHT),__JT4039390(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4037914 := __E_Customer;
  SHARED __ST4038889_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4039392(__ST4038312_Layout __EE4039391, E_Customer.Layout __EE4037914) := __EEQP(__EE4039391._r_Customer_,__EE4037914.UID);
  __ST4038889_Layout __JT4039392(__ST4038312_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4039393 := JOIN(__EE4039391,__EE4037914,__JC4039392(LEFT,RIGHT),__JT4039392(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44355_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44355_Layout __ND4039382__Project(__ST4038889_Layout __PP4039381) := TRANSFORM
    SELF.Source_Customer_ := __PP4039381._r_Customer_;
    SELF.Customer_Id_ := __PP4039381.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4039381.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4039381.Entity_Context_Uid__1_;
    SELF := __PP4039381;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4039393,__ND4039382__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44355_Layout));
END;
