...
EXPORT Q__show_Customer_Person_Ip_Tree_Entities := MODULE
  ...
  SHARED __EE4211146 := __E_Person_Ip_Address;
  SHARED __EE4211129 := __ENH_Person;
  SHARED __ST4211164_Layout := RECORD
  ...
  END;
  __JC4211161(E_Person_Ip_Address.Layout __EE4211146, B_Person.__ST66421_Layout __EE4211129) := __EEQP(__EE4211146.Subject_,__EE4211129.UID);
  __ST4211164_Layout __JT4211161(E_Person_Ip_Address.Layout __l, B_Person.__ST66421_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4211162 := JOIN(__EE4211146,__EE4211129,__JC4211161(LEFT,RIGHT),__JT4211161(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4211117 := __ENH_Internet_Protocol;
  SHARED __ST4211502_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4212592(__ST4211164_Layout __EE4211162, B_Internet_Protocol.__ST64268_Layout __EE4211117) := __EEQP(__EE4211162.Ip_,__EE4211117.UID);
  __ST4211502_Layout __JT4212592(__ST4211164_Layout __l, B_Internet_Protocol.__ST64268_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4212593 := JOIN(__EE4211162,__EE4211117,__JC4212592(LEFT,RIGHT),__JT4212592(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4211102 := __E_Customer;
  SHARED __ST4212087_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4212594(__ST4211502_Layout __EE4212593, E_Customer.Layout __EE4211102) := __EEQP(__EE4212593._r_Customer_,__EE4211102.UID);
  __ST4212087_Layout __JT4212594(__ST4211502_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4212595 := JOIN(__EE4212593,__EE4211102,__JC4212594(LEFT,RIGHT),__JT4212594(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44773_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44773_Layout __ND4212584__Project(__ST4212087_Layout __PP4212583) := TRANSFORM
    SELF.Source_Customer_ := __PP4212583._r_Customer_;
    SELF.Customer_Id_ := __PP4212583.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4212583.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4212583.Entity_Context_Uid__1_;
    SELF := __PP4212583;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4212595,__ND4212584__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44773_Layout));
END;
