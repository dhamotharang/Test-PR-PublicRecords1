...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE1248188 := __E_Person_Drivers_License;
  SHARED __EE1248171 := __ENH_Person;
  SHARED __ST1248206_Layout := RECORD
  ...
  END;
  __JC1248203(E_Person_Drivers_License.Layout __EE1248188, B_Person.__ST28512_Layout __EE1248171) := __EEQP(__EE1248188.Subject_,__EE1248171.UID);
  __ST1248206_Layout __JT1248203(E_Person_Drivers_License.Layout __l, B_Person.__ST28512_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1248204 := JOIN(__EE1248188,__EE1248171,__JC1248203(LEFT,RIGHT),__JT1248203(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1248159 := __ENH_Drivers_License;
  SHARED __ST1248490_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1249244(__ST1248206_Layout __EE1248204, B_Drivers_License.__ST21828_Layout __EE1248159) := __EEQP(__EE1248204.License_,__EE1248159.UID);
  __ST1248490_Layout __JT1249244(__ST1248206_Layout __l, B_Drivers_License.__ST21828_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1249245 := JOIN(__EE1248204,__EE1248159,__JC1249244(LEFT,RIGHT),__JT1249244(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1248144 := __E_Customer;
  SHARED __ST1248894_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1249246(__ST1248490_Layout __EE1249245, E_Customer.Layout __EE1248144) := __EEQP(__EE1249245._r_Customer_,__EE1248144.UID);
  __ST1248894_Layout __JT1249246(__ST1248490_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1249247 := JOIN(__EE1249245,__EE1248144,__JC1249246(LEFT,RIGHT),__JT1249246(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST20122_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20122_Layout __ND1249236__Project(__ST1248894_Layout __PP1249235) := TRANSFORM
    SELF.Source_Customer_ := __PP1249235._r_Customer_;
    SELF.Customer_Id_ := __PP1249235.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1249235.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1249235.Entity_Context_Uid__1_;
    SELF := __PP1249235;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1249247,__ND1249236__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST20122_Layout));
END;
