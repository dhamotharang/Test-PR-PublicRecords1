...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE2561347 := __E_Person_Drivers_License;
  SHARED __EE2561330 := __ENH_Person;
  SHARED __ST2561365_Layout := RECORD
  ...
  END;
  __JC2561362(E_Person_Drivers_License.Layout __EE2561347, B_Person.__ST45521_Layout __EE2561330) := __EEQP(__EE2561347.Subject_,__EE2561330.UID);
  __ST2561365_Layout __JT2561362(E_Person_Drivers_License.Layout __l, B_Person.__ST45521_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2561363 := JOIN(__EE2561347,__EE2561330,__JC2561362(LEFT,RIGHT),__JT2561362(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2561318 := __ENH_Drivers_License;
  SHARED __ST2561679_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2562505(__ST2561365_Layout __EE2561363, B_Drivers_License.__ST33253_Layout __EE2561318) := __EEQP(__EE2561363.License_,__EE2561318.UID);
  __ST2561679_Layout __JT2562505(__ST2561365_Layout __l, B_Drivers_License.__ST33253_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2562506 := JOIN(__EE2561363,__EE2561318,__JC2562505(LEFT,RIGHT),__JT2562505(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2561303 := __E_Customer;
  SHARED __ST2562119_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2562507(__ST2561679_Layout __EE2562506, E_Customer.Layout __EE2561303) := __EEQP(__EE2562506._r_Customer_,__EE2561303.UID);
  __ST2562119_Layout __JT2562507(__ST2561679_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2562508 := JOIN(__EE2562506,__EE2561303,__JC2562507(LEFT,RIGHT),__JT2562507(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST31165_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31165_Layout __ND2562497__Project(__ST2562119_Layout __PP2562496) := TRANSFORM
    SELF.Source_Customer_ := __PP2562496._r_Customer_;
    SELF.Customer_Id_ := __PP2562496.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2562496.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2562496.Entity_Context_Uid__1_;
    SELF := __PP2562496;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2562508,__ND2562497__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST31165_Layout));
END;
