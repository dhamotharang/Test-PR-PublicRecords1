...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE4274592 := __E_Person_Drivers_License;
  SHARED __EE4274575 := __ENH_Person;
  SHARED __ST4274610_Layout := RECORD
  ...
  END;
  __JC4274607(E_Person_Drivers_License.Layout __EE4274592, B_Person.__ST66766_Layout __EE4274575) := __EEQP(__EE4274592.Subject_,__EE4274575.UID);
  __ST4274610_Layout __JT4274607(E_Person_Drivers_License.Layout __l, B_Person.__ST66766_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4274608 := JOIN(__EE4274592,__EE4274575,__JC4274607(LEFT,RIGHT),__JT4274607(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4274563 := __ENH_Drivers_License;
  SHARED __ST4274951_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4275887(__ST4274610_Layout __EE4274608, B_Drivers_License.__ST47857_Layout __EE4274563) := __EEQP(__EE4274608.License_,__EE4274563.UID);
  __ST4274951_Layout __JT4275887(__ST4274610_Layout __l, B_Drivers_License.__ST47857_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4275888 := JOIN(__EE4274608,__EE4274563,__JC4275887(LEFT,RIGHT),__JT4275887(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4274548 := __E_Customer;
  SHARED __ST4275457_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4275889(__ST4274951_Layout __EE4275888, E_Customer.Layout __EE4274548) := __EEQP(__EE4275888._r_Customer_,__EE4274548.UID);
  __ST4275457_Layout __JT4275889(__ST4274951_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4275890 := JOIN(__EE4275888,__EE4274548,__JC4275889(LEFT,RIGHT),__JT4275889(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST45106_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45106_Layout __ND4275879__Project(__ST4275457_Layout __PP4275878) := TRANSFORM
    SELF.Source_Customer_ := __PP4275878._r_Customer_;
    SELF.Customer_Id_ := __PP4275878.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4275878.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4275878.Entity_Context_Uid__1_;
    SELF := __PP4275878;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4275890,__ND4275879__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST45106_Layout));
END;
