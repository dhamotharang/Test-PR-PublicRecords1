...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE2359444 := __E_Person_Drivers_License;
  SHARED __EE2359427 := __ENH_Person;
  SHARED __ST2359462_Layout := RECORD
  ...
  END;
  __JC2359459(E_Person_Drivers_License.Layout __EE2359444, B_Person.__ST45138_Layout __EE2359427) := __EEQP(__EE2359444.Subject_,__EE2359427.UID);
  __ST2359462_Layout __JT2359459(E_Person_Drivers_License.Layout __l, B_Person.__ST45138_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2359460 := JOIN(__EE2359444,__EE2359427,__JC2359459(LEFT,RIGHT),__JT2359459(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2359415 := __ENH_Drivers_License;
  SHARED __ST2359776_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2360602(__ST2359462_Layout __EE2359460, B_Drivers_License.__ST33007_Layout __EE2359415) := __EEQP(__EE2359460.License_,__EE2359415.UID);
  __ST2359776_Layout __JT2360602(__ST2359462_Layout __l, B_Drivers_License.__ST33007_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2360603 := JOIN(__EE2359460,__EE2359415,__JC2360602(LEFT,RIGHT),__JT2360602(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2359400 := __E_Customer;
  SHARED __ST2360216_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2360604(__ST2359776_Layout __EE2360603, E_Customer.Layout __EE2359400) := __EEQP(__EE2360603._r_Customer_,__EE2359400.UID);
  __ST2360216_Layout __JT2360604(__ST2359776_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2360605 := JOIN(__EE2360603,__EE2359400,__JC2360604(LEFT,RIGHT),__JT2360604(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST30919_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST30919_Layout __ND2360594__Project(__ST2360216_Layout __PP2360593) := TRANSFORM
    SELF.Source_Customer_ := __PP2360593._r_Customer_;
    SELF.Customer_Id_ := __PP2360593.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2360593.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2360593.Entity_Context_Uid__1_;
    SELF := __PP2360593;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2360605,__ND2360594__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST30919_Layout));
END;
