...
EXPORT RQ__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  SHARED __EE4500526 := PROJECT(B_Person_Bank_Account.IDX_Person_Bank_Account_Account__Wrapped,E_Person_Bank_Account.Layout);
  SHARED __EE4500529 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4412654_Layout := RECORD
  ...
  END;
  __JC4500537(E_Person_Bank_Account.Layout __EE4500526, B_Person.__ST69802_Layout __EE4500529) := __EEQP(__EE4500526.Subject_,__EE4500529.UID);
  __ST4412654_Layout __JT4500537(E_Person_Bank_Account.Layout __l, B_Person.__ST69802_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4500538 := JOIN(__EE4500526,__EE4500529,__JC4500537(LEFT,RIGHT),__JT4500537(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4500767 := B_Bank_Account.IDX_Bank_Account_UID_Wrapped;
  SHARED __ST4412929_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4500775(__ST4412654_Layout __EE4500538, B_Bank_Account.__ST48341_Layout __EE4500767) := __EEQP(__EE4500538.Account_,__EE4500767.UID);
  __ST4412929_Layout __JT4500775(__ST4412654_Layout __l, B_Bank_Account.__ST48341_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4500776 := JOIN(__EE4500538,__EE4500767,__JC4500775(LEFT,RIGHT),__JT4500775(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4501509 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4413333_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4501524(__ST4412929_Layout __EE4500776, E_Customer.Layout __EE4501509) := __EEQP(__EE4500776._r_Customer_,__EE4501509.UID);
  __ST4413333_Layout __JT4501524(__ST4412929_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4501839 := JOIN(__EE4500776,__EE4501509,__JC4501524(LEFT,RIGHT),__JT4501524(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4412559_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4412559_Layout __ND4502145__Project(__ST4413333_Layout __PP4501840) := TRANSFORM
    SELF.Source_Customer_ := __PP4501840._r_Customer_;
    SELF.Customer_Id_ := __PP4501840.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4501840.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4501840.Entity_Context_Uid__1_;
    SELF := __PP4501840;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4501839,__ND4502145__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4412559_Layout));
END;
