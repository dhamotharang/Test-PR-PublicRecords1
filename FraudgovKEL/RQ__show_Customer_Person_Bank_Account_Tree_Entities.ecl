...
EXPORT RQ__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  SHARED __EE4244894 := PROJECT(B_Person_Bank_Account.IDX_Person_Bank_Account_Account__Wrapped,E_Person_Bank_Account.Layout);
  SHARED __EE4244897 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST4157339_Layout := RECORD
  ...
  END;
  __JC4244905(E_Person_Bank_Account.Layout __EE4244894, B_Person.__ST66581_Layout __EE4244897) := __EEQP(__EE4244894.Subject_,__EE4244897.UID);
  __ST4157339_Layout __JT4244905(E_Person_Bank_Account.Layout __l, B_Person.__ST66581_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4244906 := JOIN(__EE4244894,__EE4244897,__JC4244905(LEFT,RIGHT),__JT4244905(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4245135 := B_Bank_Account.IDX_Bank_Account_UID_Wrapped;
  SHARED __ST4157614_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4245143(__ST4157339_Layout __EE4244906, B_Bank_Account.__ST46237_Layout __EE4245135) := __EEQP(__EE4244906.Account_,__EE4245135.UID);
  __ST4157614_Layout __JT4245143(__ST4157339_Layout __l, B_Bank_Account.__ST46237_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4245144 := JOIN(__EE4244906,__EE4245135,__JC4245143(LEFT,RIGHT),__JT4245143(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4245873 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST4158018_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4245887(__ST4157614_Layout __EE4245144, E_Customer.Layout __EE4245873) := __EEQP(__EE4245144._r_Customer_,__EE4245873.UID);
  __ST4158018_Layout __JT4245887(__ST4157614_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4246201 := JOIN(__EE4245144,__EE4245873,__JC4245887(LEFT,RIGHT),__JT4245887(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST4157244_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST4157244_Layout __ND4246506__Project(__ST4158018_Layout __PP4246202) := TRANSFORM
    SELF.Source_Customer_ := __PP4246202._r_Customer_;
    SELF.Customer_Id_ := __PP4246202.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4246202.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4246202.Entity_Context_Uid__1_;
    SELF := __PP4246202;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4246201,__ND4246506__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST4157244_Layout));
END;
