...
EXPORT B_Phone_3 := MODULE
  ...
  SHARED __EE696244 := __ENH_Phone_4;
  SHARED __EE698458 := __ENH_Event_4;
  SHARED __EE698456 := __E_Phone_Event;
  SHARED __EE713665 := __EE698456(__NN(__EE698456.Phone_Number_) AND __NN(__EE698456.Transaction_));
  SHARED __ST709071_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC713683(B_Event_4.__ST95445_Layout __EE698458, E_Phone_Event.Layout __EE713665) := __EEQP(__EE713665.Transaction_,__EE698458.UID);
  __ST709071_Layout __JT713683(B_Event_4.__ST95445_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE713684 := JOIN(__EE713665,__EE698458,__JC713683(RIGHT,LEFT),__JT713683(RIGHT,LEFT),INNER,HASH);
  SHARED __ST707099_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST707099_Layout __ND714098__Project(__ST709071_Layout __PP713685) := TRANSFORM
    SELF.UID := __PP713685.Phone_Number__1_;
    SELF._r_Customer_ := __PP713685._r_Customer__1_;
    SELF.Phone_Number_ := __PP713685.Phone_Number__1_;
    SELF.Event_Date_ := __PP713685.Event_Date__1_;
    SELF.U_I_D__1_ := __PP713685.UID;
    SELF.Event_Date__1_ := __PP713685.Event_Date_;
    SELF.Phone_Number__1_ := __PP713685.Phone_Number_;
    SELF._r_Customer__1_ := __PP713685._r_Customer_;
    SELF := __PP713685;
  END;
  SHARED __EE715707 := PROJECT(__EE713684,__ND714098__Project(LEFT));
  SHARED __ST707952_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST707952_Layout __ND715712__Project(__ST707099_Layout __PP715708) := TRANSFORM
    SELF.Exp1_ := IF(__PP715708.T___In_Agency_Flag_ = 1 AND __PP715708.T16___Phn_Is_Kr_Flag_ = 1,__ECAST(KEL.typ.nkdate,__PP715708.T___Act_Dt_Echo_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp2_ := __PP715708.T___In_Agency_Flag_ = 0 AND __PP715708.T16___Phn_Is_Kr_Flag_ = 1;
    SELF.Exp3_ := __PP715708.T___In_Agency_Flag_ = 1 AND __PP715708.T16___Phn_Is_Safe_Flag_ = 1;
    SELF.Exp4_ := __PP715708.T___Src_Class_Type_ < 2;
    SELF.Exp5_ := IF(__PP715708.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP715708.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF := __PP715708;
  END;
  SHARED __EE715764 := PROJECT(__EE715707,__ND715712__Project(LEFT));
  SHARED __ST707993_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE715807 := PROJECT(__CLEANANDDO(__EE715764,TABLE(__EE715764,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP),KEL.Aggregates.MaxNG(__EE715764.Exp1_) M_A_X___T___Act_Dt_Echo_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE715764.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE715764.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE715764.Exp4_),KEL.Aggregates.MaxNG(__EE715764.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MaxNG(__EE715764.Exp5_) M_A_X___Event_Date__2_,UID},UID,MERGE)),__ST707993_Layout);
  SHARED __ST711106_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC715813(B_Phone_4.__ST96320_Layout __EE696244, __ST707993_Layout __EE715807) := __EEQP(__EE696244.UID,__EE715807.UID);
  __ST711106_Layout __JT715813(B_Phone_4.__ST96320_Layout __l, __ST707993_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE715814 := JOIN(__EE696244,__EE715807,__JC715813(LEFT,RIGHT),__JT715813(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST92592_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST92592_Layout __ND715840__Project(__ST711106_Layout __PP715815) := TRANSFORM
    SELF.Aot_Act_Cnt_Ev_ := __PP715815.C_O_U_N_T___Exp1_;
    SELF.Aot_Phn_Kr_Act_New_Dt_Ev_ := __PP715815.M_A_X___T___Act_Dt_Echo_;
    SELF.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_ := MIN(__PP715815.C_O_U_N_T___Exp1__1_,9999);
    SELF.Aot_Phn_Safe_Act_Cnt_Ev_ := MIN(__PP715815.C_O_U_N_T___Exp1__2_,9999);
    SELF.Aot_Src1_Act_Cnt_Ev_ := __PP715815.C_O_U_N_T___Exp1__3_;
    SELF.Dt_Last_Seen_ := __PP715815.M_A_X___Event_Date__1_;
    SELF.Id_Activity_Dt_Last_Seen_ := __PP715815.M_A_X___Event_Date__2_;
    SELF := __PP715815;
  END;
  EXPORT __ENH_Phone_3 := PROJECT(__EE715814,__ND715840__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated_3',EXPIRE(7));
END;
