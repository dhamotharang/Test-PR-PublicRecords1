...
EXPORT B_Event_3 := MODULE
  ...
  SHARED __EE279088 := __ENH_Event_4;
  SHARED __EE278546 := __ENH_Phone_4;
  SHARED __ST279724_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC279721(B_Event_4.__ST62628_Layout __EE279088, B_Phone_4.__ST63300_Layout __EE278546) := __EEQP(__EE279088._r_Phone_,__EE278546.UID);
  __ST279724_Layout __JT279721(B_Event_4.__ST62628_Layout __l, B_Phone_4.__ST63300_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE279722 := JOIN(__EE279088,__EE278546,__JC279721(LEFT,RIGHT),__JT279721(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278578 := __ENH_Internet_Protocol_4;
  SHARED __ST281355_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292590(__ST279724_Layout __EE279722, B_Internet_Protocol_4.__ST63029_Layout __EE278578) := __EEQP(__EE279722._r_Internet_Protocol_,__EE278578.UID);
  __ST281355_Layout __JT292590(__ST279724_Layout __l, B_Internet_Protocol_4.__ST63029_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE292591 := JOIN(__EE279722,__EE278578,__JC292590(LEFT,RIGHT),__JT292590(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278562 := __ENH_Email_4;
  SHARED __ST283172_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292592(__ST281355_Layout __EE292591, B_Email_4.__ST60887_Layout __EE278562) := __EEQP(__EE292591._r_Email_,__EE278562.UID);
  __ST283172_Layout __JT292592(__ST281355_Layout __l, B_Email_4.__ST60887_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE292593 := JOIN(__EE292591,__EE278562,__JC292592(LEFT,RIGHT),__JT292592(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278610 := __ENH_Drivers_License_4;
  SHARED __ST284899_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292594(__ST283172_Layout __EE292593, B_Drivers_License_4.__ST60849_Layout __EE278610) := __EEQP(__EE292593._r_Drivers_License_,__EE278610.UID);
  __ST284899_Layout __JT292594(__ST283172_Layout __l, B_Drivers_License_4.__ST60849_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE292595 := JOIN(__EE292593,__EE278610,__JC292594(LEFT,RIGHT),__JT292594(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278594 := __ENH_Bank_Account_4;
  SHARED __ST286631_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292596(__ST284899_Layout __EE292595, B_Bank_Account_4.__ST60790_Layout __EE278594) := __EEQP(__EE292595._r_Bank_Account_,__EE278594.UID);
  __ST286631_Layout __JT292596(__ST284899_Layout __l, B_Bank_Account_4.__ST60790_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE292597 := JOIN(__EE292595,__EE278594,__JC292596(LEFT,RIGHT),__JT292596(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278530 := __ENH_Address_4;
  SHARED __ST288368_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292598(__ST286631_Layout __EE292597, B_Address_4.__ST60727_Layout __EE278530) := __EEQP(__EE292597.Location_,__EE278530.UID);
  __ST288368_Layout __JT292598(__ST286631_Layout __l, B_Address_4.__ST60727_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE292599 := JOIN(__EE292597,__EE278530,__JC292598(LEFT,RIGHT),__JT292598(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE278515 := __ENH_Customer_4;
  SHARED __ST290195_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC292600(__ST288368_Layout __EE292599, B_Customer_4.__ST60814_Layout __EE278515) := __EEQP(__EE292599._r_Customer_,__EE278515.UID);
  __ST290195_Layout __JT292600(__ST288368_Layout __l, B_Customer_4.__ST60814_Layout __r) := TRANSFORM
    SELF.U_I_D__7_ := __r.UID;
    SELF.Customer_Id__1_ := __r.Customer_Id_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE292601 := JOIN(__EE292599,__EE278515,__JC292600(LEFT,RIGHT),__JT292600(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST59679_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST59679_Layout __ND295418__Project(__ST290195_Layout __PP291965) := TRANSFORM
    SELF.Demo_Customer_ := __OP2(__CAST(KEL.typ.str,__PP291965.Customer_Id__1_),IN,__CN(['248283691','248283681','248283671']));
    SELF.Kr_Event_After_Known_Risk_ := MAP(__T(__OR(__OR(__OR(__OR(__OR(__OP2(__PP291965.Kr_Last_Event_Date__5_,<,__PP291965.Event_Date_),__OP2(__PP291965.Kr_Last_Event_Date_,<,__PP291965.Event_Date_)),__OP2(__PP291965.Kr_Last_Event_Date__2_,<,__PP291965.Event_Date_)),__OP2(__PP291965.Kr_Last_Event_Date__1_,<,__PP291965.Event_Date_)),__OP2(__PP291965.Kr_Last_Event_Date__4_,<,__PP291965.Event_Date_)),__OP2(__PP291965.Kr_Last_Event_Date__3_,<,__PP291965.Event_Date_)))=>1,0);
    SELF := __PP291965;
  END;
  EXPORT __ENH_Event_3 := PROJECT(__EE292601,__ND295418__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_3',EXPIRE(7));
END;
