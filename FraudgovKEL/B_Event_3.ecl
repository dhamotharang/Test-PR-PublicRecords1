...
IMPORT B_Customer_4,B_Event_4,B_Person_4,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Event_3 := MODULE
  ...
  SHARED __EE454994 := __ENH_Event_4;
  SHARED __EE457324 := __EE454994;
  SHARED __ST460025_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __ST460025_Layout __JT460022(B_Event_4.__ST94142_Layout __l, E_Event.Event_Types_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE460023 := NORMALIZE(__EE457324,__T(LEFT.Event_Types_),__JT460022(LEFT,RIGHT));
  SHARED __ST458632_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Event_Type_;
    KEL.typ.ndataset(E_Event.Event_Types_Layout) Event_Types_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE460430 := PROJECT(__EE460023,__ST458632_Layout);
  SHARED __ST458715_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    KEL.typ.nbool Exp2_;
    KEL.typ.nbool Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST458715_Layout __ND469507__Project(__ST458632_Layout __PP468385) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP468385.Event_Type_,IN,__CN(['301','302','303','391']));
    SELF.Exp2_ := __OP2(__PP468385.Event_Type_,IN,__CN(['800','891']));
    SELF.Exp3_ := __OP2(__PP468385.Event_Type_,IN,__CN(['203','291']));
    SELF.Exp4_ := __OP2(__PP468385.Event_Type_,IN,__CN(['500','501','591']));
    SELF.Exp5_ := __OP2(__PP468385.Event_Type_,IN,__CN(['601','602','605','691','1000','1091']));
    SELF.Exp6_ := __OP2(__PP468385.Event_Type_,IN,__CN(['400','402','491']));
    SELF.Exp7_ := __OP2(__PP468385.Event_Type_,IN,__CN(['100','191']));
    SELF.Exp8_ := __OP2(__PP468385.Event_Type_,IN,__CN(['390','393']));
    SELF.Exp9_ := __OP2(__PP468385.Event_Type_,IN,__CN(['893','890']));
    SELF.Exp10_ := __OP2(__PP468385.Event_Type_,IN,__CN(['200','201','290','293']));
    SELF.Exp11_ := __OP2(__PP468385.Event_Type_,IN,__CN(['590','593']));
    SELF.Exp12_ := __OP2(__PP468385.Event_Type_,IN,__CN(['690','693','1090','1093']));
    SELF.Exp13_ := __OP2(__PP468385.Event_Type_,IN,__CN(['490','493']));
    SELF.Exp14_ := __OP2(__PP468385.Event_Type_,IN,__CN(['103','104','105','190','193']));
    SELF.Exp15_ := __OP2(__PP468385.Event_Type_,IN,__CN(['300','392']));
    SELF.Exp16_ := __OP2(__PP468385.Event_Type_,IN,__CN(['801','802','892']));
    SELF.Exp17_ := __OP2(__PP468385.Event_Type_,IN,__CN(['202','204','292']));
    SELF.Exp18_ := __OP2(__PP468385.Event_Type_,IN,__CN(['502','592']));
    SELF.Exp19_ := __OP2(__PP468385.Event_Type_,IN,__CN(['600','603','604','692','1001','1092']));
    SELF.Exp20_ := __OP2(__PP468385.Event_Type_,IN,__CN(['401','492']));
    SELF.Exp21_ := __OP2(__PP468385.Event_Type_,IN,__CN(['101','192']));
    SELF := __PP468385;
  END;
  SHARED __EE469571 := PROJECT(__EE460430,__ND469507__Project(LEFT));
  SHARED __ST458830_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE473202 := PROJECT(__CLEANANDDO(__EE469571,TABLE(__EE469571,{KEL.typ.int C_O_U_N_T___Event_Types_ := COUNT(GROUP,__T(__EE469571.Exp1_)),KEL.typ.int C_O_U_N_T___Event_Types__1_ := COUNT(GROUP,__T(__EE469571.Exp2_)),KEL.typ.int C_O_U_N_T___Event_Types__2_ := COUNT(GROUP,__T(__EE469571.Exp3_)),KEL.typ.int C_O_U_N_T___Event_Types__3_ := COUNT(GROUP,__T(__EE469571.Exp4_)),KEL.typ.int C_O_U_N_T___Event_Types__4_ := COUNT(GROUP,__T(__EE469571.Exp5_)),KEL.typ.int C_O_U_N_T___Event_Types__5_ := COUNT(GROUP,__T(__EE469571.Exp6_)),KEL.typ.int C_O_U_N_T___Event_Types__6_ := COUNT(GROUP,__T(__EE469571.Exp7_)),KEL.typ.int C_O_U_N_T___Event_Types__7_ := COUNT(GROUP,__T(__EE469571.Exp8_)),KEL.typ.int C_O_U_N_T___Event_Types__8_ := COUNT(GROUP,__T(__EE469571.Exp9_)),KEL.typ.int C_O_U_N_T___Event_Types__9_ := COUNT(GROUP,__T(__EE469571.Exp10_)),KEL.typ.int C_O_U_N_T___Event_Types__10_ := COUNT(GROUP,__T(__EE469571.Exp11_)),KEL.typ.int C_O_U_N_T___Event_Types__11_ := COUNT(GROUP,__T(__EE469571.Exp12_)),KEL.typ.int C_O_U_N_T___Event_Types__12_ := COUNT(GROUP,__T(__EE469571.Exp13_)),KEL.typ.int C_O_U_N_T___Event_Types__13_ := COUNT(GROUP,__T(__EE469571.Exp14_)),KEL.typ.int C_O_U_N_T___Event_Types__14_ := COUNT(GROUP,__T(__EE469571.Exp15_)),KEL.typ.int C_O_U_N_T___Event_Types__15_ := COUNT(GROUP,__T(__EE469571.Exp16_)),KEL.typ.int C_O_U_N_T___Event_Types__16_ := COUNT(GROUP,__T(__EE469571.Exp17_)),KEL.typ.int C_O_U_N_T___Event_Types__17_ := COUNT(GROUP,__T(__EE469571.Exp18_)),KEL.typ.int C_O_U_N_T___Event_Types__18_ := COUNT(GROUP,__T(__EE469571.Exp19_)),KEL.typ.int C_O_U_N_T___Event_Types__19_ := COUNT(GROUP,__T(__EE469571.Exp20_)),KEL.typ.int C_O_U_N_T___Event_Types__20_ := COUNT(GROUP,__T(__EE469571.Exp21_)),UID},UID,MERGE)),__ST458830_Layout);
  SHARED __ST460437_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC473211(B_Event_4.__ST94142_Layout __EE454994, __ST458830_Layout __EE473202) := __EEQP(__EE454994.UID,__EE473202.UID);
  __ST460437_Layout __JT473211(B_Event_4.__ST94142_Layout __l, __ST458830_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE473212 := JOIN(__EE454994,__EE473202,__JC473211(LEFT,RIGHT),__JT473211(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE453364 := __ENH_Person_4;
  SHARED __ST462739_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC473221(__ST460437_Layout __EE473212, B_Person_4.__ST94852_Layout __EE453364) := __EEQP(__EE473212.Subject_,__EE453364.UID);
  __ST462739_Layout __JT473221(__ST460437_Layout __l, B_Person_4.__ST94852_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE473222 := JOIN(__EE473212,__EE453364,__JC473221(LEFT,RIGHT),__JT473221(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE453351 := __ENH_Customer_4;
  SHARED __ST465161_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC473231(__ST462739_Layout __EE473222, B_Customer_4.__ST91942_Layout __EE453351) := __EEQP(__EE473222._r_Customer_,__EE453351.UID);
  __ST465161_Layout __JT473231(__ST462739_Layout __l, B_Customer_4.__ST91942_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE473232 := JOIN(__EE473222,__EE453351,__JC473231(LEFT,RIGHT),__JT473231(LEFT,RIGHT),LEFT OUTER,MANY LOOKUP);
  EXPORT __ST90584_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST90584_Layout __ND471134__Project(__ST465161_Layout __PP471130) := TRANSFORM
    SELF.Demo_Customer_ := __OP2(__CAST(KEL.typ.str,__PP471130.Customer_Id_),IN,__CN(['248283691','248283681','248283671']));
    SELF.Id_Is_Last_Event_Id_ := MAP(__T(__OP2(__PP471130.Last_Record_Id_,=,__PP471130.Record_Id_))=>1,0);
    SELF.Kr_High_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__1_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__2_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__3_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__4_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__5_),<>,__CN(0)))=>1,0);
    SELF.Kr_High_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__6_),<>,__CN(0)))=>1,0);
    SELF.Kr_Identity_Flag_ := MAP(__PP471130.Kr_High_Risk_Identity_Flag_ = 1 OR __PP471130.Kr_Medium_Risk_Identity_Flag_ = 1 OR __PP471130.Kr_Low_Risk_Identity_Flag_ = 1=>1,0);
    SELF.Kr_Low_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__7_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__8_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__9_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__10_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__11_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__12_),<>,__CN(0)))=>1,0);
    SELF.Kr_Low_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__13_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__14_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Bank_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__15_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Dl_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__16_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Email_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__17_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Ip_Address_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__18_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Phone_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__19_),<>,__CN(0)))=>1,0);
    SELF.Kr_Medium_Risk_Ssn_Flag_ := MAP(__T(__OP2(__CN(__PP471130.C_O_U_N_T___Event_Types__20_),<>,__CN(0)))=>1,0);
    SELF.P15___Aot_Ssn_Kr_Act_Flag_Ev_ := MAP(__PP471130.T15___Ssn_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P15___Aot_Ssn_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P15___Aot_Ssn_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P16___Aot_Phn_Kr_Act_Flag_Ev_ := MAP(__PP471130.T16___Phn_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P16___Aot_Phn_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P16___Aot_Phn_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P17___Aot_Email_Kr_Act_Flag_Ev_ := MAP(__PP471130.T17___Email_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P17___Aot_Email_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P17___Aot_Email_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P18___Aot_Ip_Addr_Kr_Act_Flag_Ev_ := MAP(__PP471130.T18___Ip_Addr_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P18___Aot_Ip_Addr_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P18___Aot_Ip_Addr_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P19___Aot_Bnk_Acct_Kr_Act_Flag_Ev_ := MAP(__PP471130.T19___Bnk_Acct_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P19___Aot_Bnk_Acct_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P19___Aot_Bnk_Acct_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P1___Aot_Id_Kr_Act_Flag_Ev_ := MAP(__PP471130.T1___Lex_Id_Pop_Flag_ = 0 AND __PP471130.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P1___Aot_Id_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P1___Aot_Id_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P1___Aot_Src1_Act_Only_Flag_ := __PP471130.Aot_Src1_Act_Only_Flag_;
    SELF.P20___Aot_Dl_Kr_Act_Flag_Ev_ := MAP(__PP471130.T20___Dl_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P20___Aot_Dl_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P20___Aot_Dl_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.P9___Aot_Addr_Kr_Act_Flag_Ev_ := MAP(__PP471130.T9___Addr_Pop_Flag_ = 0=> -99999,__PP471130.T___Src_Class_Type_ < 2=> -99998,__PP471130.P9___Aot_Addr_Kr_Act_Cnt_Ev_ = -99997=> -99997,__PP471130.P9___Aot_Addr_Kr_Act_Cnt_Ev_ > 0=>1,0);
    SELF.T1_L___Best_First_Nm_Echo_ := MAP(__PP471130.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP471130.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP471130.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP471130._best__fname_,=,__CN('')),__NT(__PP471130._best__fname_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP471130._best__fname_));
    SELF.T1_L___Best_Last_Nm_Echo_ := MAP(__PP471130.T1___Lex_Id_Pop_Flag_ = 0=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__PP471130.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP471130.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99998))),__T(__OR(__OP2(__PP471130._best__lname_,=,__CN('')),__NT(__PP471130._best__lname_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99997))),__ECAST(KEL.typ.nstr,__PP471130._best__lname_));
    SELF.T1_L___Id_Deceased_Flag_ := MAP(__PP471130.T1___Lex_Id_Pop_Flag_ = 0=> -99999,__PP471130.T1_L___Id_Is_Bc_Shll_Hit_Flag_ < 1 OR __PP471130.T___Src_Class_Type_ < 4=> -99998,__T(__NT(__PP471130._diddeceased_))=> -99997,__T(__OP2(__PP471130._diddeceased_,=,__CN(TRUE)))=>1,0);
    SELF.T___Inp_Cln_Dob_Echo_ := MAP(__T(__NT(__PP471130.Date_Of_Birth_))=>__ECAST(KEL.typ.nint,__CN(-99999)),__ECAST(KEL.typ.nint,__ECAST(KEL.typ.nint,__PP471130.Date_Of_Birth_)));
    SELF.T___Inp_Cln_First_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP471130.First_Name_,=,__CN('')),__NT(__PP471130.First_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP471130.First_Name_));
    SELF.T___Inp_Cln_Last_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP471130.Last_Name_,=,__CN('')),__NT(__PP471130.Last_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP471130.Last_Name_));
    SELF := __PP471130;
  END;
  EXPORT __ENH_Event_3 := PROJECT(__EE473232,__ND471134__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Event::Annotated_3',EXPIRE(7));
END;
