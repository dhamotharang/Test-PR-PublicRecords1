...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE2233149 := __E_Person_Email;
  SHARED __EE2233132 := __ENH_Person;
  SHARED __ST2233167_Layout := RECORD
  ...
  END;
  __JC2233164(E_Person_Email.Layout __EE2233149, B_Person.__ST43253_Layout __EE2233132) := __EEQP(__EE2233149.Subject_,__EE2233132.UID);
  __ST2233167_Layout __JT2233164(E_Person_Email.Layout __l, B_Person.__ST43253_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2233165 := JOIN(__EE2233149,__EE2233132,__JC2233164(LEFT,RIGHT),__JT2233164(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2233120 := __ENH_Email;
  SHARED __ST2233481_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2234319(__ST2233167_Layout __EE2233165, B_Email.__ST32271_Layout __EE2233120) := __EEQP(__EE2233165.Emailof_,__EE2233120.UID);
  __ST2233481_Layout __JT2234319(__ST2233167_Layout __l, B_Email.__ST32271_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2234320 := JOIN(__EE2233165,__EE2233120,__JC2234319(LEFT,RIGHT),__JT2234319(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2233105 := __E_Customer;
  SHARED __ST2233927_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2234321(__ST2233481_Layout __EE2234320, E_Customer.Layout __EE2233105) := __EEQP(__EE2234320._r_Customer_,__EE2233105.UID);
  __ST2233927_Layout __JT2234321(__ST2233481_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2234322 := JOIN(__EE2234320,__EE2233105,__JC2234321(LEFT,RIGHT),__JT2234321(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST29658_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29658_Layout __ND2234311__Project(__ST2233927_Layout __PP2234310) := TRANSFORM
    SELF.Source_Customer_ := __PP2234310._r_Customer_;
    SELF.Customer_Id_ := __PP2234310.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2234310.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2234310.Entity_Context_Uid__1_;
    SELF := __PP2234310;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2234322,__ND2234311__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST29658_Layout));
END;
