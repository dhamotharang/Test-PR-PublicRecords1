...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE1257630 := __E_Person_Email;
  SHARED __EE1257613 := __ENH_Person;
  SHARED __ST1257648_Layout := RECORD
  ...
  END;
  __JC1257645(E_Person_Email.Layout __EE1257630, B_Person.__ST28756_Layout __EE1257613) := __EEQP(__EE1257630.Subject_,__EE1257613.UID);
  __ST1257648_Layout __JT1257645(E_Person_Email.Layout __l, B_Person.__ST28756_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1257646 := JOIN(__EE1257630,__EE1257613,__JC1257645(LEFT,RIGHT),__JT1257645(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1257601 := __ENH_Email;
  SHARED __ST1257932_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1258698(__ST1257648_Layout __EE1257646, B_Email.__ST22411_Layout __EE1257601) := __EEQP(__EE1257646.Emailof_,__EE1257601.UID);
  __ST1257932_Layout __JT1258698(__ST1257648_Layout __l, B_Email.__ST22411_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1258699 := JOIN(__EE1257646,__EE1257601,__JC1258698(LEFT,RIGHT),__JT1258698(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1257586 := __E_Customer;
  SHARED __ST1258342_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1258700(__ST1257932_Layout __EE1258699, E_Customer.Layout __EE1257586) := __EEQP(__EE1258699._r_Customer_,__EE1257586.UID);
  __ST1258342_Layout __JT1258700(__ST1257932_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1258701 := JOIN(__EE1258699,__EE1257586,__JC1258700(LEFT,RIGHT),__JT1258700(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST20256_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST20256_Layout __ND1258690__Project(__ST1258342_Layout __PP1258689) := TRANSFORM
    SELF.Source_Customer_ := __PP1258689._r_Customer_;
    SELF.Customer_Id_ := __PP1258689.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1258689.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1258689.Entity_Context_Uid__1_;
    SELF := __PP1258689;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1258701,__ND1258690__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST20256_Layout));
END;
