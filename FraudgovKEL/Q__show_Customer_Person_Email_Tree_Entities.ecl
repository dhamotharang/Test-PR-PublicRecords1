...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE4118816 := __E_Person_Email;
  SHARED __EE4118799 := __ENH_Person;
  SHARED __ST4118834_Layout := RECORD
  ...
  END;
  __JC4118831(E_Person_Email.Layout __EE4118816, B_Person.__ST66581_Layout __EE4118799) := __EEQP(__EE4118816.Subject_,__EE4118799.UID);
  __ST4118834_Layout __JT4118831(E_Person_Email.Layout __l, B_Person.__ST66581_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4118832 := JOIN(__EE4118816,__EE4118799,__JC4118831(LEFT,RIGHT),__JT4118831(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4118787 := __ENH_Email;
  SHARED __ST4119109_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4119877(__ST4118834_Layout __EE4118832, B_Email.__ST47667_Layout __EE4118787) := __EEQP(__EE4118832.Emailof_,__EE4118787.UID);
  __ST4119109_Layout __JT4119877(__ST4118834_Layout __l, B_Email.__ST47667_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4119878 := JOIN(__EE4118832,__EE4118787,__JC4119877(LEFT,RIGHT),__JT4119877(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4118772 := __E_Customer;
  SHARED __ST4119519_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4119879(__ST4119109_Layout __EE4119878, E_Customer.Layout __EE4118772) := __EEQP(__EE4119878._r_Customer_,__EE4118772.UID);
  __ST4119519_Layout __JT4119879(__ST4119109_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4119880 := JOIN(__EE4119878,__EE4118772,__JC4119879(LEFT,RIGHT),__JT4119879(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44592_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44592_Layout __ND4119869__Project(__ST4119519_Layout __PP4119868) := TRANSFORM
    SELF.Source_Customer_ := __PP4119868._r_Customer_;
    SELF.Customer_Id_ := __PP4119868.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4119868.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4119868.Entity_Context_Uid__1_;
    SELF := __PP4119868;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4119880,__ND4119869__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44592_Layout));
END;
