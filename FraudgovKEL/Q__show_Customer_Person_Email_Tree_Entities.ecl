...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE4374090 := __E_Person_Email;
  SHARED __EE4374073 := __ENH_Person;
  SHARED __ST4374108_Layout := RECORD
  ...
  END;
  __JC4374105(E_Person_Email.Layout __EE4374090, B_Person.__ST69802_Layout __EE4374073) := __EEQP(__EE4374090.Subject_,__EE4374073.UID);
  __ST4374108_Layout __JT4374105(E_Person_Email.Layout __l, B_Person.__ST69802_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4374106 := JOIN(__EE4374090,__EE4374073,__JC4374105(LEFT,RIGHT),__JT4374105(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4374061 := __ENH_Email;
  SHARED __ST4374383_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4375152(__ST4374108_Layout __EE4374106, B_Email.__ST49773_Layout __EE4374061) := __EEQP(__EE4374106.Emailof_,__EE4374061.UID);
  __ST4374383_Layout __JT4375152(__ST4374108_Layout __l, B_Email.__ST49773_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4375153 := JOIN(__EE4374106,__EE4374061,__JC4375152(LEFT,RIGHT),__JT4375152(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4374046 := __E_Customer;
  SHARED __ST4374793_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4375154(__ST4374383_Layout __EE4375153, E_Customer.Layout __EE4374046) := __EEQP(__EE4375153._r_Customer_,__EE4374046.UID);
  __ST4374793_Layout __JT4375154(__ST4374383_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4375155 := JOIN(__EE4375153,__EE4374046,__JC4375154(LEFT,RIGHT),__JT4375154(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST46696_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46696_Layout __ND4375144__Project(__ST4374793_Layout __PP4375143) := TRANSFORM
    SELF.Source_Customer_ := __PP4375143._r_Customer_;
    SELF.Customer_Id_ := __PP4375143.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4375143.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4375143.Entity_Context_Uid__1_;
    SELF := __PP4375143;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4375155,__ND4375144__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST46696_Layout));
END;
