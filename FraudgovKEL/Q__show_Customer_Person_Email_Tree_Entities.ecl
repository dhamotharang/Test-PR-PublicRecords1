...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE2478551 := __E_Person_Email;
  SHARED __EE2478534 := __ENH_Person;
  SHARED __ST2478569_Layout := RECORD
  ...
  END;
  __JC2478566(E_Person_Email.Layout __EE2478551, B_Person.__ST45444_Layout __EE2478534) := __EEQP(__EE2478551.Subject_,__EE2478534.UID);
  __ST2478569_Layout __JT2478566(E_Person_Email.Layout __l, B_Person.__ST45444_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2478567 := JOIN(__EE2478551,__EE2478534,__JC2478566(LEFT,RIGHT),__JT2478566(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2478522 := __ENH_Email;
  SHARED __ST2478883_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2479721(__ST2478569_Layout __EE2478567, B_Email.__ST33737_Layout __EE2478522) := __EEQP(__EE2478567.Emailof_,__EE2478522.UID);
  __ST2478883_Layout __JT2479721(__ST2478569_Layout __l, B_Email.__ST33737_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2479722 := JOIN(__EE2478567,__EE2478522,__JC2479721(LEFT,RIGHT),__JT2479721(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2478507 := __E_Customer;
  SHARED __ST2479329_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2479723(__ST2478883_Layout __EE2479722, E_Customer.Layout __EE2478507) := __EEQP(__EE2479722._r_Customer_,__EE2478507.UID);
  __ST2479329_Layout __JT2479723(__ST2478883_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2479724 := JOIN(__EE2479722,__EE2478507,__JC2479723(LEFT,RIGHT),__JT2479723(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST31084_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31084_Layout __ND2479713__Project(__ST2479329_Layout __PP2479712) := TRANSFORM
    SELF.Source_Customer_ := __PP2479712._r_Customer_;
    SELF.Customer_Id_ := __PP2479712.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2479712.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2479712.Entity_Context_Uid__1_;
    SELF := __PP2479712;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2479724,__ND2479713__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST31084_Layout));
END;
