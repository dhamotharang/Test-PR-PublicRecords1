...
EXPORT B_Person_S_S_N := MODULE
  ...
  SHARED __EE4143635 := __E_Person_S_S_N;
  ...
  END;
  SHARED __ST70150_Layout __ND4143669__Project(E_Person_S_S_N.Layout __PP4143530) := TRANSFORM
    __EE4143568 := __PP4143530.Event_Dates_;
    SELF.Dt_First_Seen_ := KEL.Aggregates.MinNN(__EE4143568,__T(__EE4143568).Event_Date_);
    __EE4143597 := __PP4143530.Event_Dates_;
    SELF.Dt_Last_Seen_ := KEL.Aggregates.MaxNN(__EE4143597,__T(__EE4143597).Event_Date_);
    SELF := __PP4143530;
  END;
  EXPORT __ENH_Person_S_S_N := PROJECT(__EE4143635,__ND4143669__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person_S_S_N::Annotated',EXPIRE(7));
  SHARED __EE4415104 := __ENH_Person_S_S_N;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE4415104(__NN(__EE4415104.Social_));
  ...
  EXPORT __ST4415106_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
