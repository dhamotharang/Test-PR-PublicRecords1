...
IMPORT B_Event_3,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Social_Security_Number,E_Ssn_Event FROM FraudgovKEL;
...
EXPORT B_Social_Security_Number_2 := MODULE
  ...
  SHARED __EE217350 := __E_Social_Security_Number;
  SHARED __EE217819 := __ENH_Event_3;
  SHARED __EE219723 := __EE217819(__EE217819.Kr_High_Risk_Ssn_Flag_ = 1 OR __EE217819.Kr_Medium_Risk_Ssn_Flag_ = 1 OR __EE217819.Kr_Low_Risk_Ssn_Flag_ = 1);
  SHARED __EE217817 := __E_Ssn_Event;
  SHARED __EE223273 := __EE217817(__NN(__EE217817.Social_) AND __NN(__EE217817.Transaction_));
  SHARED __ST220832_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC223291(B_Event_3.__ST39572_Layout __EE219723, E_Ssn_Event.Layout __EE223273) := __EEQP(__EE223273.Transaction_,__EE219723.UID);
  __ST220832_Layout __JT223291(B_Event_3.__ST39572_Layout __l, E_Ssn_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE223292 := JOIN(__EE223273,__EE219723,__JC223291(RIGHT,LEFT),__JT223291(RIGHT,LEFT),INNER,SMART);
  SHARED __ST219230_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST219230_Layout __ND223502__Project(__ST220832_Layout __PP223293) := TRANSFORM
    SELF.UID := __PP223293.Social_;
    SELF._r_Customer_ := __PP223293._r_Customer__1_;
    SELF.Event_Date_ := __PP223293.Event_Date__1_;
    SELF.U_I_D__1_ := __PP223293.UID;
    SELF._r_Customer__1_ := __PP223293._r_Customer_;
    SELF.Event_Date__1_ := __PP223293.Event_Date_;
    SELF := __PP223293;
  END;
  SHARED __EE224295 := PROJECT(__EE223292,__ND223502__Project(LEFT));
  SHARED __ST219648_Layout := RECORD
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.nkdate Event_Date__1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE224309 := PROJECT(__EE224295,__ST219648_Layout);
  SHARED __ST219663_Layout := RECORD
    KEL.typ.nkdate M_A_X___Event_Date__1_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE224325 := PROJECT(__CLEANANDDO(__EE224309,TABLE(__EE224309,{KEL.Aggregates.MaxNG(__EE224309.Event_Date__1_) M_A_X___Event_Date__1_,UID},UID,MERGE)),__ST219663_Layout);
  SHARED __ST221849_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC224331(E_Social_Security_Number.Layout __EE217350, __ST219663_Layout __EE224325) := __EEQP(__EE217350.UID,__EE224325.UID);
  __ST221849_Layout __JT224331(E_Social_Security_Number.Layout __l, __ST219663_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE224332 := JOIN(__EE217350,__EE224325,__JC224331(LEFT,RIGHT),__JT224331(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST38663_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Social_Security_Number.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nunk Ssn_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ENH_Social_Security_Number_2 := PROJECT(__EE224332,TRANSFORM(__ST38663_Layout,SELF.Kr_Last_Event_Date_ := LEFT.M_A_X___Event_Date__1_,SELF := LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Social_Security_Number::Annotated_2',EXPIRE(7));
END;
