...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE188354 := __ENH_Event_3;
  SHARED __EE187912 := __ENH_Customer_3;
  SHARED __ST189222_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC189219(B_Event_3.__ST39572_Layout __EE188354, B_Customer_3.__ST38836_Layout __EE187912) := __EEQP(__EE188354._r_Customer_,__EE187912.UID);
  __ST189222_Layout __JT189219(B_Event_3.__ST39572_Layout __l, B_Customer_3.__ST38836_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE189220 := JOIN(__EE188354,__EE187912,__JC189219(LEFT,RIGHT),__JT189219(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE187899 := __ENH_Address_3;
  SHARED __ST190413_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC192713(__ST189222_Layout __EE189220, B_Address_3.__ST38743_Layout __EE187899) := __EEQP(__EE189220.Location_,__EE187899.UID);
  __ST190413_Layout __JT192713(__ST189222_Layout __l, B_Address_3.__ST38743_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE192714 := JOIN(__EE189220,__EE187899,__JC192713(LEFT,RIGHT),__JT192713(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST37859_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST37859_Layout __ND192976__Project(__ST190413_Layout __PP191643) := TRANSFORM
    SELF.Address_Is_Cmra_ := MAP(__T(__OP2(__PP191643._advo__dropindicator_,=,__CN('C')))=>1,0);
    SELF.Address_Out_Of_State_ := MAP(__T(__OP2(__PP191643.State_,<>,__PP191643.Jurisdiction_State_))=>1,0);
    SELF.Age_ := IF(__T(__PP191643.Demo_Customer_),__ECAST(KEL.typ.nint,__FN2(KEL.Routines.DaysBetween,__PP191643.Event_Date_,__CN(KEL.Routines.DateFromParts(2018,4,7)))),__ECAST(KEL.typ.nint,__FN2(KEL.Routines.DaysBetween,__PP191643.Event_Date_,__PP191643.Event_Date_Max_)));
    __BS191264 := __T(__PP191643.Hri_List_);
    SELF.Hri11_Flag_ := MAP(EXISTS(__BS191264(__T(__FN2(KEL.Routines.Contains,__T(__PP191643.Hri_List_).Hri_,__CN('|11|')))))=>1,0);
    SELF.Invalid_Address_ := MAP(__T(__OP2(__PP191643.A_C_E_Cleaner_Error_Code_,IN,__CN(['E101','E212','E213','E214','E216','E302','E412','E413','E420','E421','E422','E423','E425','E427','E428','E429','E430','E431','E439','E500','E501','E502','E503','E504','E505','E600'])))=>1,0);
    SELF.Kr_Address_Flag_ := MAP(__PP191643.Kr_High_Risk_Address_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Address_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Address_Flag_ = 1=>1,0);
    SELF.Kr_Bank_Flag_ := MAP(__PP191643.Kr_High_Risk_Bank_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Bank_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Bank_Flag_ = 1=>1,0);
    SELF.Kr_Dl_Flag_ := MAP(__PP191643.Kr_High_Risk_Dl_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Dl_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Dl_Flag_ = 1=>1,0);
    SELF.Kr_Email_Flag_ := MAP(__PP191643.Kr_High_Risk_Email_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Email_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Email_Flag_ = 1=>1,0);
    SELF.Kr_Ip_Flag_ := MAP(__PP191643.Kr_High_Risk_Ip_Address_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Ip_Address_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Ip_Address_Flag_ = 1=>1,0);
    SELF.Kr_Phone_Flag_ := MAP(__PP191643.Kr_High_Risk_Phone_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Phone_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Phone_Flag_ = 1=>1,0);
    SELF.Kr_Ssn_Flag_ := MAP(__PP191643.Kr_High_Risk_Ssn_Flag_ = 1 OR __PP191643.Kr_Medium_Risk_Ssn_Flag_ = 1 OR __PP191643.Kr_Low_Risk_Ssn_Flag_ = 1=>1,0);
    SELF.Safe_Flag_ := MAP(__T(__AND(__CN(__PP191643.In_Customer_Population_ = 1),__OP2(__PP191643.Confidence__that__activity__was__deceitful__id_,=,__CN(3))))=>1,0);
    SELF := __PP191643;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE192714,__ND192976__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_2',EXPIRE(7));
END;
