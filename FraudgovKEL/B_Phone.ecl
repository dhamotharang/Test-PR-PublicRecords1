...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE3817212 := __ENH_Phone_1;
  SHARED __EE3821571 := __ENH_Event_1;
  SHARED __EE3821569 := __E_Phone_Event;
  SHARED __EE3869216 := __EE3821569(__NN(__EE3821569.Phone_Number_) AND __NN(__EE3821569.Transaction_));
  SHARED __ST3860247_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3869234(B_Event_1.__ST76927_Layout __EE3821571, E_Phone_Event.Layout __EE3869216) := __EEQP(__EE3869216.Transaction_,__EE3821571.UID);
  __ST3860247_Layout __JT3869234(B_Event_1.__ST76927_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3869235 := JOIN(__EE3869216,__EE3821571,__JC3869234(RIGHT,LEFT),__JT3869234(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3856801_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3856801_Layout __ND3869928__Project(__ST3860247_Layout __PP3869236) := TRANSFORM
    SELF.UID := __PP3869236.Phone_Number__1_;
    SELF._r_Customer_ := __PP3869236._r_Customer__1_;
    SELF.Phone_Number_ := __PP3869236.Phone_Number__1_;
    SELF.Event_Date_ := __PP3869236.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3869236.UID;
    SELF.Event_Date__1_ := __PP3869236.Event_Date_;
    SELF.Phone_Number__1_ := __PP3869236.Phone_Number_;
    SELF._r_Customer__1_ := __PP3869236._r_Customer_;
    SELF := __PP3869236;
  END;
  SHARED __EE3872653 := PROJECT(__EE3869235,__ND3869928__Project(LEFT));
  SHARED __ST3858232_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3858232_Layout __ND3873338__Project(__ST3856801_Layout __PP3872654) := TRANSFORM
    SELF.Exp1_ := __PP3872654.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP3872654.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP3872654.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP3872654.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP3872654.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP3872654.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP3872654.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP3872654.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP3872654.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP3872654.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP3872654.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP3872654.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP3872654.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP3872654.Event_Age_,<,__CN(2)),__CN(__PP3872654.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP3872654.Event_Age_,<,__CN(366));
    SELF := __PP3872654;
  END;
  SHARED __EE3873363 := PROJECT(__EE3872653,__ND3873338__Project(LEFT));
  SHARED __ST3858325_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3873462 := PROJECT(__CLEANANDDO(__EE3873363,TABLE(__EE3873363,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3873363.Exp1_),KEL.Aggregates.MinNG(__EE3873363.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3873363.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3873363.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3873363.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3873363.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3873363.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3873363.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3873363.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3873363.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3873363.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3873363.Exp11_),KEL.Aggregates.MaxNG(__EE3873363.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3873363.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE3873363.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE3873363.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE3873363.Exp15_)),UID},UID,MERGE)),__ST3858325_Layout);
  SHARED __ST3863677_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3873468(B_Phone_1.__ST79779_Layout __EE3817212, __ST3858325_Layout __EE3873462) := __EEQP(__EE3817212.UID,__EE3873462.UID);
  __ST3863677_Layout __JT3873468(B_Phone_1.__ST79779_Layout __l, __ST3858325_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3873532 := JOIN(__EE3817212,__EE3873462,__JC3873468(LEFT,RIGHT),__JT3873468(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3804709 := __ENH_Customer_1;
  SHARED __ST3864094_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3873538(__ST3863677_Layout __EE3873532, B_Customer_1.__ST68903_Layout __EE3804709) := __EEQP(__EE3873532._r_Customer_,__EE3804709.UID);
  __ST3864094_Layout __JT3873538(__ST3863677_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3873624 := JOIN(__EE3873532,__EE3804709,__JC3873538(LEFT,RIGHT),__JT3873538(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST66865_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST66865_Layout __ND3873629__Project(__ST3864094_Layout __PP3873625) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3873625.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP3873625.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP3873625.Identity_Count_ > 2=>1,0);
    __BS3873777 := __T(__PP3873625.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3873777(__T(__OP2(__T(__PP3873625.Source_Customers_)._r_Source_Customer_,=,__PP3873625._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP3873625.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP3873625.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3873625.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3873625.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP3873625.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP3873625.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP3873625.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP3873625.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP3873625.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP3873625.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP3873625.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP3873625;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE3873624,__ND3873629__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4093431 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4093431._r_Customer_;
    __EE4093431.Source_Customers_;
    __EE4093431.Phone_Formatted_;
    __EE4093431.Phone_Number_;
    __EE4093431._is_Cell_Phone_;
    __EE4093431.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4093431.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4093431.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4093431.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4093431.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4093431.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4093431.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4093431.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4093431.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4093431.Aot_Id_Act_Cnt_Ev_;
    __EE4093431.Aot_Id_Act_Cnt30_D_;
    __EE4093431.Aot_Add_Act_Cnt_Ev_;
    __EE4093431.Aot_Add_Act_Cnt30_D_;
    __EE4093431.Aot_Non_St_Act_Cnt_Ev_;
    __EE4093431.Aot_Non_St_Act_Cnt30_D_;
    __EE4093431.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4093431.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4093431.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4093431.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4093431.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4093431.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4093431.Customer_Id_;
    __EE4093431.Industry_Type_;
    __EE4093431.Source_Customer_Count_;
    __EE4093431.Entity_Context_Uid_;
    __EE4093431.Entity_Type_;
    __EE4093431.Label_;
    __EE4093431.In_Customer_Population_;
    __EE4093431.Dt_First_Seen_;
    __EE4093431.Dt_Last_Seen_;
    __EE4093431.Last_Record_Id_;
    __EE4093431.Identity_Count_;
    __EE4093431.Identity_Count_Gt2_;
    __EE4093431.Event_Count_;
    __EE4093431.Kr_High_Risk_Flag_;
    __EE4093431.Kr_Medium_Risk_Flag_;
    __EE4093431.Kr_Low_Risk_Flag_;
    __EE4093431.Kr_Flag_;
    __EE4093431.Safe_Flag_;
    __EE4093431.Contributor_Safe_Flag_;
    __EE4093431.Last_Event_Date_;
    __EE4093431.Kr_Last_Event_Date_;
    __EE4093431.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4093431.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4093431.Kr_Phn400_Flag_;
    __EE4093431.Kr_Phn401_Flag_;
    __EE4093431.Kr_Phn402_Flag_;
    __EE4093431.Kr_Phn490_Flag_;
    __EE4093431.Kr_Phn491_Flag_;
    __EE4093431.Kr_Phn492_Flag_;
    __EE4093431.Kr_Phn493_Flag_;
    __EE4093431.Vl_Event1_All_Count_;
    __EE4093431.Vl_Event7_All_Count_;
    __EE4093431.Vl_Event30_All_Day_Count_;
    __EE4093431.Vl_Event365_All_Day_Count_;
    __EE4093431.Vl_Event7_All_Active_Flag_;
    __EE4093431.Vl_Event30_All_Active_Flag_;
    __EE4093431.Vl_Event1_Count_;
    __EE4093431.Vl_Event7_Count_;
    __EE4093431.Vl_Event30_Count_;
    __EE4093431.Vl_Event365_Count_;
    __EE4093431.Vl_Event7_Active_Flag_;
    __EE4093431.Vl_Event30_Active_Flag_;
    __EE4093431.Date_First_Seen_;
    __EE4093431.Date_Last_Seen_;
    __EE4093431.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4093431,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4093433_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST66865_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
