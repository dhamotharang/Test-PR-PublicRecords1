...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE1122700 := __ENH_Phone_1;
  SHARED __EE1161323 := __E_Phone_Event;
  SHARED __EE1161330 := __EE1161323(__NN(__EE1161323.Phone_Number_));
  SHARED __ST1154924_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Phone_Event_ := 0;
    KEL.typ.ntyp(E_Phone.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1161321 := PROJECT(__CLEANANDDO(__EE1161330,TABLE(__EE1161330,{KEL.typ.int C_O_U_N_T___Phone_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Phone.Typ) UID := __EE1161330.Phone_Number_},Phone_Number_,MERGE)),__ST1154924_Layout);
  SHARED __ST1157249_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1161350(B_Phone_1.__ST37134_Layout __EE1122700, __ST1154924_Layout __EE1161321) := __EEQP(__EE1122700.UID,__EE1161321.UID);
  __ST1157249_Layout __JT1161350(B_Phone_1.__ST37134_Layout __l, __ST1154924_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1161351 := JOIN(__EE1122700,__EE1161321,__JC1161350(LEFT,RIGHT),__JT1161350(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1161334 := __ENH_Event_1;
  SHARED __EE1165877 := __EE1161323;
  SHARED __EE1165890 := __EE1165877(__NN(__EE1165877.Phone_Number_) AND __NN(__EE1165877.Transaction_));
  SHARED __ST1155315_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1165896(B_Event_1.__ST35754_Layout __EE1161334, E_Phone_Event.Layout __EE1165890) := __EEQP(__EE1165890.Transaction_,__EE1161334.UID);
  __ST1155315_Layout __JT1165896(B_Event_1.__ST35754_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1165897 := JOIN(__EE1165890,__EE1161334,__JC1165896(RIGHT,LEFT),__JT1165896(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1152561_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1152561_Layout __ND1166292__Project(__ST1155315_Layout __PP1165898) := TRANSFORM
    SELF.UID := __PP1165898.Phone_Number__1_;
    SELF._r_Customer_ := __PP1165898._r_Customer__1_;
    SELF.Phone_Number_ := __PP1165898.Phone_Number__1_;
    SELF.Event_Date_ := __PP1165898.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1165898.UID;
    SELF.Event_Date__1_ := __PP1165898.Event_Date_;
    SELF.Phone_Number__1_ := __PP1165898.Phone_Number_;
    SELF._r_Customer__1_ := __PP1165898._r_Customer_;
    SELF := __PP1165898;
  END;
  SHARED __EE1167817 := PROJECT(__EE1165897,__ND1166292__Project(LEFT));
  SHARED __ST1153420_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1153420_Layout __ND1168494__Project(__ST1152561_Layout __PP1167818) := TRANSFORM
    SELF.Exp1_ := __PP1167818.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1167818.Hri07_Flag_ = 1;
    SELF.Exp3_ := __PP1167818.Hri08_Flag_ = 1;
    SELF.Exp4_ := __PP1167818.Hri15_Flag_ = 1;
    SELF.Exp5_ := __PP1167818.Hri27_Flag_ = 1;
    SELF.Exp6_ := __PP1167818.Hri31_Flag_ = 1;
    SELF.Exp7_ := __PP1167818.Hri_Mi_Flag_ = 1;
    SELF.Exp8_ := __PP1167818.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp9_ := __PP1167818.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp10_ := __PP1167818.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp11_ := __PP1167818.Kr_Phn400_Flag_ = 1;
    SELF.Exp12_ := __PP1167818.Kr_Phn401_Flag_ = 1;
    SELF.Exp13_ := __PP1167818.Kr_Phn402_Flag_ = 1;
    SELF.Exp14_ := __PP1167818.Kr_Phn490_Flag_ = 1;
    SELF.Exp15_ := __PP1167818.Kr_Phn491_Flag_ = 1;
    SELF.Exp16_ := __PP1167818.Kr_Phn492_Flag_ = 1;
    SELF.Exp17_ := __PP1167818.Kr_Phn493_Flag_ = 1;
    SELF.Exp18_ := __PP1167818.Safe_Flag_ = 1;
    SELF.Exp19_ := __OP2(__PP1167818.Event_Age_,<,__CN(2));
    SELF.Exp20_ := __AND(__OP2(__PP1167818.Event_Age_,<,__CN(2)),__CN(__PP1167818.In_Customer_Population_ = 1));
    SELF.Exp21_ := __OP2(__PP1167818.Event_Age_,<,__CN(366));
    SELF := __PP1167818;
  END;
  SHARED __EE1168525 := PROJECT(__EE1167817,__ND1168494__Project(LEFT));
  SHARED __ST1153546_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1168659 := PROJECT(__CLEANANDDO(__EE1168525,TABLE(__EE1168525,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1168525.Exp1_),KEL.Aggregates.MinNG(__EE1168525.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1168525.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1168525.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1168525.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1168525.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1168525.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1168525.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1168525.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1168525.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1168525.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1168525.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1168525.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1168525.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1168525.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1168525.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1168525.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1168525.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1168525.Exp17_),KEL.Aggregates.MaxNG(__EE1168525.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1168525.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__T(__EE1168525.Exp19_)),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__T(__EE1168525.Exp20_)),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__T(__EE1168525.Exp21_)),UID},UID,MERGE)),__ST1153546_Layout);
  SHARED __ST1157501_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1168665(__ST1157249_Layout __EE1161351, __ST1153546_Layout __EE1168659) := __EEQP(__EE1161351.UID,__EE1168659.UID);
  __ST1157501_Layout __JT1168665(__ST1157249_Layout __l, __ST1153546_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1168717 := JOIN(__EE1161351,__EE1168659,__JC1168665(LEFT,RIGHT),__JT1168665(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1111353 := __ENH_Customer_1;
  SHARED __ST1157857_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1168723(__ST1157501_Layout __EE1168717, B_Customer_1.__ST32738_Layout __EE1111353) := __EEQP(__EE1168717._r_Customer_,__EE1111353.UID);
  __ST1157857_Layout __JT1168723(__ST1157501_Layout __l, B_Customer_1.__ST32738_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1168797 := JOIN(__EE1168717,__EE1111353,__JC1168723(LEFT,RIGHT),__JT1168723(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST31538_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31538_Layout __ND1168802__Project(__ST1157857_Layout __PP1168798) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1168798.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1168798.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 16;
    SELF.Event_Count_ := __PP1168798.C_O_U_N_T___Phone_Event_;
    SELF.Hri07_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri08_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri15_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri27_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri31_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1168798.Identity_Count_ > 2=>1,0);
    __BS1168915 := __T(__PP1168798.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1168915(__T(__OP2(__T(__PP1168798.Source_Customers_)._r_Source_Customer_,=,__PP1168798._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1168798.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1168798.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1168798.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1168798.C_O_U_N_T___Exp1__18_;
    SELF.Vl_Event1_Count_ := __PP1168798.C_O_U_N_T___Exp1__19_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1168798.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1168798.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1168798.C_O_U_N_T___Exp1__20_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1168798.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1168798.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1168798;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE1168797,__ND1168802__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE1379568 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1379568._r_Customer_;
    __EE1379568.Source_Customers_;
    __EE1379568.Phone_Formatted_;
    __EE1379568.Phone_Number_;
    __EE1379568._is_Cell_Phone_;
    __EE1379568.Customer_Id_;
    __EE1379568.Industry_Type_;
    __EE1379568.Source_Customer_Count_;
    __EE1379568.Entity_Context_Uid_;
    __EE1379568.Entity_Type_;
    __EE1379568.Label_;
    __EE1379568.In_Customer_Population_;
    __EE1379568.Dt_First_Seen_;
    __EE1379568.Dt_Last_Seen_;
    __EE1379568.Last_Record_Id_;
    __EE1379568.Identity_Count_;
    __EE1379568.Identity_Count_Gt2_;
    __EE1379568.Event_Count_;
    __EE1379568.Hri_Mi_Flag_;
    __EE1379568.Hri07_Flag_;
    __EE1379568.Hri08_Flag_;
    __EE1379568.Hri15_Flag_;
    __EE1379568.Hri27_Flag_;
    __EE1379568.Hri31_Flag_;
    __EE1379568.Kr_High_Risk_Flag_;
    __EE1379568.Kr_Medium_Risk_Flag_;
    __EE1379568.Kr_Low_Risk_Flag_;
    __EE1379568.Kr_Flag_;
    __EE1379568.Safe_Flag_;
    __EE1379568.Contributor_Safe_Flag_;
    __EE1379568.Last_Event_Date_;
    __EE1379568.Kr_Last_Event_Date_;
    __EE1379568.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1379568.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1379568.Kr_Phn400_Flag_;
    __EE1379568.Kr_Phn401_Flag_;
    __EE1379568.Kr_Phn402_Flag_;
    __EE1379568.Kr_Phn490_Flag_;
    __EE1379568.Kr_Phn491_Flag_;
    __EE1379568.Kr_Phn492_Flag_;
    __EE1379568.Kr_Phn493_Flag_;
    __EE1379568.Vl_Event1_All_Count_;
    __EE1379568.Vl_Event7_All_Count_;
    __EE1379568.Vl_Event30_All_Day_Count_;
    __EE1379568.Vl_Event365_All_Day_Count_;
    __EE1379568.Vl_Event7_All_Active_Flag_;
    __EE1379568.Vl_Event30_All_Active_Flag_;
    __EE1379568.Vl_Event1_Count_;
    __EE1379568.Vl_Event7_Count_;
    __EE1379568.Vl_Event30_Count_;
    __EE1379568.Vl_Event365_Count_;
    __EE1379568.Vl_Event7_Active_Flag_;
    __EE1379568.Vl_Event30_Active_Flag_;
    __EE1379568.Date_First_Seen_;
    __EE1379568.Date_Last_Seen_;
    __EE1379568.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE1379568,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1379570_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST31538_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
