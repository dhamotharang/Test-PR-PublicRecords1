...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4417036 := __ENH_Phone_1;
  SHARED __EE4421281 := __ENH_Event_1;
  SHARED __EE4421279 := __E_Phone_Event;
  SHARED __EE4465350 := __EE4421279(__NN(__EE4421279.Phone_Number_) AND __NN(__EE4421279.Transaction_));
  SHARED __ST4456354_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4465368(B_Event_1.__ST80990_Layout __EE4421281, E_Phone_Event.Layout __EE4465350) := __EEQP(__EE4465350.Transaction_,__EE4421281.UID);
  __ST4456354_Layout __JT4465368(B_Event_1.__ST80990_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4465369 := JOIN(__EE4465350,__EE4421281,__JC4465368(RIGHT,LEFT),__JT4465368(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4452820_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4452820_Layout __ND4466097__Project(__ST4456354_Layout __PP4465370) := TRANSFORM
    SELF.UID := __PP4465370.Phone_Number__1_;
    SELF._r_Customer_ := __PP4465370._r_Customer__1_;
    SELF.Phone_Number_ := __PP4465370.Phone_Number__1_;
    SELF.Event_Date_ := __PP4465370.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4465370.UID;
    SELF.Event_Date__1_ := __PP4465370.Event_Date_;
    SELF.Phone_Number__1_ := __PP4465370.Phone_Number_;
    SELF._r_Customer__1_ := __PP4465370._r_Customer_;
    SELF := __PP4465370;
  END;
  SHARED __EE4468890 := PROJECT(__EE4465369,__ND4466097__Project(LEFT));
  SHARED __ST4454326_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4454326_Layout __ND4468895__Project(__ST4452820_Layout __PP4468891) := TRANSFORM
    SELF.Exp1_ := __PP4468891.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4468891.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4468891.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4468891.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4468891.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4468891.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4468891.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4468891.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4468891.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4468891.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4468891.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4468891.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4468891.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4468891.Safe_Flag_ = 1;
    SELF := __PP4468891;
  END;
  SHARED __EE4468972 := PROJECT(__EE4468890,__ND4468895__Project(LEFT));
  SHARED __ST4454409_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4469058 := PROJECT(__CLEANANDDO(__EE4468972,TABLE(__EE4468972,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4468972.Exp1_),KEL.Aggregates.MinNG(__EE4468972.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4468972.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4468972.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4468972.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4468972.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4468972.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4468972.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4468972.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4468972.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4468972.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4468972.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4468972.Exp12_),KEL.Aggregates.MaxNG(__EE4468972.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4468972.Exp13_),UID},UID,MERGE)),__ST4454409_Layout);
  SHARED __ST4459899_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4469064(B_Phone_1.__ST83644_Layout __EE4417036, __ST4454409_Layout __EE4469058) := __EEQP(__EE4417036.UID,__EE4469058.UID);
  __ST4459899_Layout __JT4469064(B_Phone_1.__ST83644_Layout __l, __ST4454409_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4469065 := JOIN(__EE4417036,__EE4469058,__JC4469064(LEFT,RIGHT),__JT4469064(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4399000 := __ENH_Customer_1;
  SHARED __ST4460278_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4469130(__ST4459899_Layout __EE4469065, B_Customer_1.__ST72603_Layout __EE4399000) := __EEQP(__EE4469065._r_Customer_,__EE4399000.UID);
  __ST4460278_Layout __JT4469130(__ST4459899_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4469131 := JOIN(__EE4469065,__EE4399000,__JC4469130(LEFT,RIGHT),__JT4469130(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST70750_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST70750_Layout __ND4469513__Project(__ST4460278_Layout __PP4469132) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4469132.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4469132.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4469132.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4469132.Identity_Count_ > 2=>1,0);
    __BS4469368 := __T(__PP4469132.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4469368(__T(__OP2(__T(__PP4469132.Source_Customers_)._r_Source_Customer_,=,__PP4469132._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4469132.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4469132.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4469132.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4469132.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
  ...
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4671891._r_Customer_;
    __EE4671891.Source_Customers_;
    __EE4671891.Phone_Formatted_;
    __EE4671891.Phone_Number_;
    __EE4671891._is_Cell_Phone_;
    __EE4671891.Aot_Act_Cnt_Ev_;
    __EE4671891.Aot_Src1_Act_Cnt_Ev_;
    __EE4671891.Aot_Src1_Act_Only_Flag_;
    __EE4671891.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4671891.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4671891.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4671891.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4671891.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4671891.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4671891.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4671891.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4671891.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4671891.Aot_Id_Act_Cnt_Ev_;
    __EE4671891.Aot_Id_Act_Cnt30_D_;
    __EE4671891.Aot_Add_Act_Cnt_Ev_;
    __EE4671891.Aot_Add_Act_Cnt30_D_;
    __EE4671891.Aot_Non_St_Act_Cnt_Ev_;
    __EE4671891.Aot_Non_St_Act_Cnt30_D_;
    __EE4671891.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4671891.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4671891.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4671891.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4671891.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4671891.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4671891.Customer_Id_;
    __EE4671891.Industry_Type_;
    __EE4671891.Source_Customer_Count_;
    __EE4671891.Entity_Context_Uid_;
    __EE4671891.Entity_Type_;
    __EE4671891.Label_;
    __EE4671891.In_Customer_Population_;
    __EE4671891.Dt_First_Seen_;
    __EE4671891.Dt_Last_Seen_;
    __EE4671891.Id_Activity_Dt_First_Seen_;
    __EE4671891.Id_Activity_Dt_Last_Seen_;
    __EE4671891.Last_Record_Id_;
    __EE4671891.Identity_Count_;
    __EE4671891.Identity_Count_Gt2_;
    __EE4671891.Event_Count_;
    __EE4671891.Kr_High_Risk_Flag_;
    __EE4671891.Kr_Medium_Risk_Flag_;
    __EE4671891.Kr_Low_Risk_Flag_;
    __EE4671891.Kr_Flag_;
    __EE4671891.Safe_Flag_;
    __EE4671891.Contributor_Safe_Flag_;
    __EE4671891.Last_Event_Date_;
    __EE4671891.Kr_Last_Event_Date_;
    __EE4671891.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4671891.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4671891.Kr_Phn400_Flag_;
    __EE4671891.Kr_Phn401_Flag_;
    __EE4671891.Kr_Phn402_Flag_;
    __EE4671891.Kr_Phn490_Flag_;
    __EE4671891.Kr_Phn491_Flag_;
    __EE4671891.Kr_Phn492_Flag_;
    __EE4671891.Kr_Phn493_Flag_;
    __EE4671891.Date_First_Seen_;
    __EE4671891.Date_Last_Seen_;
    __EE4671891.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4671891,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4671893_Layout := RECORDOF(IDX_Phone_UID);
