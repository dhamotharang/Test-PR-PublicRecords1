...
IMPORT B_Customer_1,B_Customer_4,B_Event_1,B_Phone_1,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Phone_Event,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4534982 := __ENH_Phone_1;
  SHARED __EE4539562 := __ENH_Event_1;
  SHARED __EE4539560 := __E_Phone_Event;
  SHARED __EE4591698 := __EE4539560(__NN(__EE4539560.Phone_Number_) AND __NN(__EE4539560.Transaction_));
  SHARED __ST4582272_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4591716(B_Event_1.__ST83458_Layout __EE4539562, E_Phone_Event.Layout __EE4591698) := __EEQP(__EE4591698.Transaction_,__EE4539562.UID);
  __ST4582272_Layout __JT4591716(B_Event_1.__ST83458_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4591717 := JOIN(__EE4591698,__EE4539562,__JC4591716(RIGHT,LEFT),__JT4591716(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4578654_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4578654_Layout __ND4592443__Project(__ST4582272_Layout __PP4591718) := TRANSFORM
    SELF.UID := __PP4591718.Phone_Number__1_;
    SELF._r_Customer_ := __PP4591718._r_Customer__1_;
    SELF.Phone_Number_ := __PP4591718.Phone_Number__1_;
    SELF.Event_Date_ := __PP4591718.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4591718.UID;
    SELF.Event_Date__1_ := __PP4591718.Event_Date_;
    SELF.Phone_Number__1_ := __PP4591718.Phone_Number_;
    SELF._r_Customer__1_ := __PP4591718._r_Customer_;
    SELF := __PP4591718;
  END;
  SHARED __EE4595300 := PROJECT(__EE4591717,__ND4592443__Project(LEFT));
  SHARED __ST4580157_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4580157_Layout __ND4596028__Project(__ST4578654_Layout __PP4595301) := TRANSFORM
    SELF.Exp1_ := __PP4595301.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4595301.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4595301.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4595301.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4595301.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4595301.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4595301.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4595301.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4595301.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4595301.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4595301.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4595301.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4595301.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4595301.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP4595301.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP4595301.Event_Age_,<,__CN(2)),__CN(__PP4595301.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP4595301.Event_Age_,<,__CN(366));
    SELF := __PP4595301;
  END;
  SHARED __EE4596054 := PROJECT(__EE4595300,__ND4596028__Project(LEFT));
  SHARED __ST4580255_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4596158 := PROJECT(__CLEANANDDO(__EE4596054,TABLE(__EE4596054,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4596054.Exp1_),KEL.Aggregates.MinNG(__EE4596054.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4596054.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4596054.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4596054.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4596054.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4596054.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4596054.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4596054.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4596054.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4596054.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4596054.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4596054.Exp12_),KEL.Aggregates.MaxNG(__EE4596054.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4596054.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE4596054.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE4596054.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE4596054.Exp16_)),UID},UID,MERGE)),__ST4580255_Layout);
  SHARED __ST4585867_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4596164(B_Phone_1.__ST86330_Layout __EE4534982, __ST4580255_Layout __EE4596158) := __EEQP(__EE4534982.UID,__EE4596158.UID);
  __ST4585867_Layout __JT4596164(B_Phone_1.__ST86330_Layout __l, __ST4580255_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4596233 := JOIN(__EE4534982,__EE4596158,__JC4596164(LEFT,RIGHT),__JT4596164(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4516165 := __ENH_Customer_1;
  SHARED __ST4586309_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4596239(__ST4585867_Layout __EE4596233, B_Customer_1.__ST74526_Layout __EE4516165) := __EEQP(__EE4596233._r_Customer_,__EE4516165.UID);
  __ST4586309_Layout __JT4596239(__ST4585867_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4596330 := JOIN(__EE4596233,__EE4516165,__JC4596239(LEFT,RIGHT),__JT4596239(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST72436_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST72436_Layout __ND4596335__Project(__ST4586309_Layout __PP4596331) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4596331.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4596331.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4596331.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4596331.Identity_Count_ > 2=>1,0);
    __BS4596498 := __T(__PP4596331.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4596498(__T(__OP2(__T(__PP4596331.Source_Customers_)._r_Source_Customer_,=,__PP4596331._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4596331.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4596331.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4596331.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4596331.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4596331.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP4596331.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4596331.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4596331.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4596331.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4596331.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP4596331.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP4596331;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE4596330,__ND4596335__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4830278 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4830278._r_Customer_;
    __EE4830278.Source_Customers_;
    __EE4830278.Phone_Formatted_;
    __EE4830278.Phone_Number_;
    __EE4830278._is_Cell_Phone_;
    __EE4830278.Aot_Act_Cnt_Ev_;
    __EE4830278.Aot_Src1_Act_Cnt_Ev_;
    __EE4830278.Aot_Src1_Act_Only_Flag_;
    __EE4830278.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4830278.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4830278.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4830278.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4830278.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4830278.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4830278.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4830278.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4830278.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4830278.Aot_Id_Act_Cnt_Ev_;
    __EE4830278.Aot_Id_Act_Cnt30_D_;
    __EE4830278.Aot_Add_Act_Cnt_Ev_;
    __EE4830278.Aot_Add_Act_Cnt30_D_;
    __EE4830278.Aot_Non_St_Act_Cnt_Ev_;
    __EE4830278.Aot_Non_St_Act_Cnt30_D_;
    __EE4830278.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4830278.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4830278.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4830278.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4830278.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4830278.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4830278.Customer_Id_;
    __EE4830278.Industry_Type_;
    __EE4830278.Source_Customer_Count_;
    __EE4830278.Entity_Context_Uid_;
    __EE4830278.Entity_Type_;
    __EE4830278.Label_;
    __EE4830278.In_Customer_Population_;
    __EE4830278.Dt_First_Seen_;
    __EE4830278.Dt_Last_Seen_;
    __EE4830278.Id_Activity_Dt_First_Seen_;
    __EE4830278.Id_Activity_Dt_Last_Seen_;
    __EE4830278.Last_Record_Id_;
    __EE4830278.Identity_Count_;
    __EE4830278.Identity_Count_Gt2_;
    __EE4830278.Event_Count_;
    __EE4830278.Kr_High_Risk_Flag_;
    __EE4830278.Kr_Medium_Risk_Flag_;
    __EE4830278.Kr_Low_Risk_Flag_;
    __EE4830278.Kr_Flag_;
    __EE4830278.Safe_Flag_;
    __EE4830278.Contributor_Safe_Flag_;
    __EE4830278.Last_Event_Date_;
    __EE4830278.Kr_Last_Event_Date_;
    __EE4830278.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4830278.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4830278.Kr_Phn400_Flag_;
    __EE4830278.Kr_Phn401_Flag_;
    __EE4830278.Kr_Phn402_Flag_;
    __EE4830278.Kr_Phn490_Flag_;
    __EE4830278.Kr_Phn491_Flag_;
    __EE4830278.Kr_Phn492_Flag_;
    __EE4830278.Kr_Phn493_Flag_;
    __EE4830278.Vl_Event1_All_Count_;
    __EE4830278.Vl_Event7_All_Count_;
    __EE4830278.Vl_Event30_All_Day_Count_;
    __EE4830278.Vl_Event365_All_Day_Count_;
    __EE4830278.Vl_Event7_All_Active_Flag_;
    __EE4830278.Vl_Event30_All_Active_Flag_;
    __EE4830278.Vl_Event1_Count_;
    __EE4830278.Vl_Event7_Count_;
    __EE4830278.Vl_Event30_Count_;
    __EE4830278.Vl_Event365_Count_;
    __EE4830278.Vl_Event7_Active_Flag_;
    __EE4830278.Vl_Event30_Active_Flag_;
    __EE4830278.Date_First_Seen_;
    __EE4830278.Date_Last_Seen_;
    __EE4830278.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4830278,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  EXPORT IDX_Phone_UID_Name := '~key::KEL::FraudgovKEL::Phone::UID';
  ...
  EXPORT __ST4830280_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST72436_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
