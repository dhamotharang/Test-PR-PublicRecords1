...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE2167467 := __ENH_Phone_1;
  SHARED __EE2171022 := __ENH_Event_1;
  SHARED __EE2171020 := __E_Phone_Event;
  SHARED __EE2209055 := __EE2171020(__NN(__EE2171020.Phone_Number_) AND __NN(__EE2171020.Transaction_));
  ...
  END;
  __JC2209073(B_Event_1.__ST53057_Layout __EE2171022, E_Phone_Event.Layout __EE2209055) := __EEQP(__EE2209055.Transaction_,__EE2171022.UID);
  __ST2201754_Layout __JT2209073(B_Event_1.__ST53057_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2209074 := JOIN(__EE2209055,__EE2171022,__JC2209073(RIGHT,LEFT),__JT2209073(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2198908_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2198908_Layout __ND2209623__Project(__ST2201754_Layout __PP2209075) := TRANSFORM
    SELF.UID := __PP2209075.Phone_Number__1_;
    SELF._r_Customer_ := __PP2209075._r_Customer__1_;
    SELF.Phone_Number_ := __PP2209075.Phone_Number__1_;
    SELF.Event_Date_ := __PP2209075.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2209075.UID;
    SELF.Event_Date__1_ := __PP2209075.Event_Date_;
    SELF.Phone_Number__1_ := __PP2209075.Phone_Number_;
    SELF._r_Customer__1_ := __PP2209075._r_Customer_;
    SELF := __PP2209075;
  END;
  SHARED __EE2211772 := PROJECT(__EE2209074,__ND2209623__Project(LEFT));
  SHARED __ST2200051_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2200051_Layout __ND2212385__Project(__ST2198908_Layout __PP2211773) := TRANSFORM
    SELF.Exp1_ := __PP2211773.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2211773.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP2211773.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP2211773.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP2211773.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP2211773.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP2211773.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP2211773.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP2211773.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP2211773.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP2211773.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP2211773.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2211773.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2211773.Event_Age_,<,__CN(2)),__CN(__PP2211773.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2211773.Event_Age_,<,__CN(366));
    SELF := __PP2211773;
  END;
  SHARED __EE2212410 := PROJECT(__EE2211772,__ND2212385__Project(LEFT));
  SHARED __ST2200144_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2212509 := PROJECT(__CLEANANDDO(__EE2212410,TABLE(__EE2212410,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2212410.Exp1_),KEL.Aggregates.MinNG(__EE2212410.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2212410.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2212410.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2212410.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2212410.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2212410.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2212410.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2212410.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2212410.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2212410.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2212410.Exp11_),KEL.Aggregates.MaxNG(__EE2212410.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2212410.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2212410.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2212410.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2212410.Exp15_)),UID},UID,MERGE)),__ST2200144_Layout);
  SHARED __ST2204464_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2212515(B_Phone_1.__ST55209_Layout __EE2167467, __ST2200144_Layout __EE2212509) := __EEQP(__EE2167467.UID,__EE2212509.UID);
  __ST2204464_Layout __JT2212515(B_Phone_1.__ST55209_Layout __l, __ST2200144_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2212567 := JOIN(__EE2167467,__EE2212509,__JC2212515(LEFT,RIGHT),__JT2212515(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2157280 := __ENH_Customer_1;
  SHARED __ST2204821_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2212573(__ST2204464_Layout __EE2212567, B_Customer_1.__ST47489_Layout __EE2157280) := __EEQP(__EE2212567._r_Customer_,__EE2157280.UID);
  __ST2204821_Layout __JT2212573(__ST2204464_Layout __l, B_Customer_1.__ST47489_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2212647 := JOIN(__EE2212567,__EE2157280,__JC2212573(LEFT,RIGHT),__JT2212573(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46038_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46038_Layout __ND2212652__Project(__ST2204821_Layout __PP2212648) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2212648.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP2212648.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP2212648.Identity_Count_ > 2=>1,0);
    __BS2212764 := __T(__PP2212648.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2212764(__T(__OP2(__T(__PP2212648.Source_Customers_)._r_Source_Customer_,=,__PP2212648._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2212648.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP2212648.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2212648.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2212648.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2212648.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2212648.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2212648.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2212648.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2212648.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2212648.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2212648.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2212648;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE2212647,__ND2212652__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE2407304 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2407304._r_Customer_;
    __EE2407304.Source_Customers_;
    __EE2407304.Phone_Formatted_;
    __EE2407304.Phone_Number_;
    __EE2407304._is_Cell_Phone_;
    __EE2407304.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE2407304.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2407304.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE2407304.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE2407304.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2407304.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2407304.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE2407304.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE2407304.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE2407304.Customer_Id_;
    __EE2407304.Industry_Type_;
    __EE2407304.Source_Customer_Count_;
    __EE2407304.Entity_Context_Uid_;
    __EE2407304.Entity_Type_;
    __EE2407304.Label_;
    __EE2407304.In_Customer_Population_;
    __EE2407304.Dt_First_Seen_;
    __EE2407304.Dt_Last_Seen_;
    __EE2407304.Last_Record_Id_;
    __EE2407304.Identity_Count_;
    __EE2407304.Identity_Count_Gt2_;
    __EE2407304.Event_Count_;
    __EE2407304.Kr_High_Risk_Flag_;
    __EE2407304.Kr_Medium_Risk_Flag_;
    __EE2407304.Kr_Low_Risk_Flag_;
    __EE2407304.Kr_Flag_;
    __EE2407304.Safe_Flag_;
    __EE2407304.Contributor_Safe_Flag_;
    __EE2407304.Last_Event_Date_;
    __EE2407304.Kr_Last_Event_Date_;
    __EE2407304.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2407304.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2407304.Kr_Phn400_Flag_;
    __EE2407304.Kr_Phn401_Flag_;
    __EE2407304.Kr_Phn402_Flag_;
    __EE2407304.Kr_Phn490_Flag_;
    __EE2407304.Kr_Phn491_Flag_;
    __EE2407304.Kr_Phn492_Flag_;
    __EE2407304.Kr_Phn493_Flag_;
    __EE2407304.Vl_Event1_All_Count_;
    __EE2407304.Vl_Event7_All_Count_;
    __EE2407304.Vl_Event30_All_Day_Count_;
    __EE2407304.Vl_Event365_All_Day_Count_;
    __EE2407304.Vl_Event7_All_Active_Flag_;
    __EE2407304.Vl_Event30_All_Active_Flag_;
    __EE2407304.Vl_Event1_Count_;
    __EE2407304.Vl_Event7_Count_;
    __EE2407304.Vl_Event30_Count_;
    __EE2407304.Vl_Event365_Count_;
    __EE2407304.Vl_Event7_Active_Flag_;
    __EE2407304.Vl_Event30_Active_Flag_;
    __EE2407304.Date_First_Seen_;
    __EE2407304.Date_Last_Seen_;
    __EE2407304.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE2407304,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2407306_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST46038_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
