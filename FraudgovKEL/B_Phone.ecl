...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4023857 := __ENH_Phone_1;
  SHARED __EE4028312 := __ENH_Event_1;
  SHARED __EE4028310 := __E_Phone_Event;
  SHARED __EE4078748 := __EE4028310(__NN(__EE4028310.Phone_Number_) AND __NN(__EE4028310.Transaction_));
  SHARED __ST4069572_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4078766(B_Event_1.__ST78136_Layout __EE4028312, E_Phone_Event.Layout __EE4078748) := __EEQP(__EE4078748.Transaction_,__EE4028312.UID);
  __ST4069572_Layout __JT4078766(B_Event_1.__ST78136_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4078767 := JOIN(__EE4078748,__EE4028312,__JC4078766(RIGHT,LEFT),__JT4078766(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4066054_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4066054_Layout __ND4079468__Project(__ST4069572_Layout __PP4078768) := TRANSFORM
    SELF.UID := __PP4078768.Phone_Number__1_;
    SELF._r_Customer_ := __PP4078768._r_Customer__1_;
    SELF.Phone_Number_ := __PP4078768.Phone_Number__1_;
    SELF.Event_Date_ := __PP4078768.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4078768.UID;
    SELF.Event_Date__1_ := __PP4078768.Event_Date_;
    SELF.Phone_Number__1_ := __PP4078768.Phone_Number_;
    SELF._r_Customer__1_ := __PP4078768._r_Customer_;
    SELF := __PP4078768;
  END;
  SHARED __EE4082225 := PROJECT(__EE4078767,__ND4079468__Project(LEFT));
  SHARED __ST4067507_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4067507_Layout __ND4082953__Project(__ST4066054_Layout __PP4082226) := TRANSFORM
    SELF.Exp1_ := __PP4082226.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4082226.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4082226.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4082226.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4082226.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4082226.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4082226.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4082226.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4082226.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4082226.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4082226.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4082226.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4082226.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4082226.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP4082226.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP4082226.Event_Age_,<,__CN(2)),__CN(__PP4082226.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP4082226.Event_Age_,<,__CN(366));
    SELF := __PP4082226;
  END;
  SHARED __EE4082979 := PROJECT(__EE4082225,__ND4082953__Project(LEFT));
  SHARED __ST4067605_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4083083 := PROJECT(__CLEANANDDO(__EE4082979,TABLE(__EE4082979,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4082979.Exp1_),KEL.Aggregates.MaxNG(__EE4082979.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE4082979.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4082979.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4082979.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4082979.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4082979.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4082979.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4082979.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4082979.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4082979.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4082979.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4082979.Exp12_),KEL.Aggregates.MaxNG(__EE4082979.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4082979.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE4082979.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE4082979.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE4082979.Exp16_)),UID},UID,MERGE)),__ST4067605_Layout);
  SHARED __ST4073042_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4083089(B_Phone_1.__ST81067_Layout __EE4023857, __ST4067605_Layout __EE4083083) := __EEQP(__EE4023857.UID,__EE4083083.UID);
  __ST4073042_Layout __JT4083089(B_Phone_1.__ST81067_Layout __l, __ST4067605_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4083158 := JOIN(__EE4023857,__EE4083083,__JC4083089(LEFT,RIGHT),__JT4083089(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4005640 := __ENH_Customer_1;
  SHARED __ST4073484_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4083164(__ST4073042_Layout __EE4083158, B_Customer_1.__ST69954_Layout __EE4005640) := __EEQP(__EE4083158._r_Customer_,__EE4005640.UID);
  __ST4073484_Layout __JT4083164(__ST4073042_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4083255 := JOIN(__EE4083158,__EE4005640,__JC4083164(LEFT,RIGHT),__JT4083164(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST67828_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST67828_Layout __ND4083260__Project(__ST4073484_Layout __PP4083256) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP4083256.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4083256.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4083256.M_I_N___Event_Date__1_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4083256.Identity_Count_ > 2=>1,0);
    __BS4083423 := __T(__PP4083256.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4083423(__T(__OP2(__T(__PP4083256.Source_Customers_)._r_Source_Customer_,=,__PP4083256._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4083256.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4083256.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP4083256.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4083256.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4083256.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP4083256.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4083256.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4083256.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4083256.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4083256.Vl_Event7_Count_ > 0=>1,0);
  ...
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4314468._r_Customer_;
    __EE4314468.Source_Customers_;
    __EE4314468.Phone_Formatted_;
    __EE4314468.Phone_Number_;
    __EE4314468._is_Cell_Phone_;
    __EE4314468.Aot_Act_Cnt_Ev_;
    __EE4314468.Aot_Src1_Act_Cnt_Ev_;
    __EE4314468.Aot_Src1_Act_Only_Flag_;
    __EE4314468.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4314468.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4314468.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4314468.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4314468.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4314468.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4314468.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4314468.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4314468.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4314468.Aot_Id_Act_Cnt_Ev_;
    __EE4314468.Aot_Id_Act_Cnt30_D_;
    __EE4314468.Aot_Add_Act_Cnt_Ev_;
    __EE4314468.Aot_Add_Act_Cnt30_D_;
    __EE4314468.Aot_Non_St_Act_Cnt_Ev_;
    __EE4314468.Aot_Non_St_Act_Cnt30_D_;
    __EE4314468.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4314468.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4314468.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4314468.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4314468.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4314468.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4314468.Customer_Id_;
    __EE4314468.Industry_Type_;
    __EE4314468.Source_Customer_Count_;
    __EE4314468.Entity_Context_Uid_;
    __EE4314468.Entity_Type_;
    __EE4314468.Label_;
    __EE4314468.In_Customer_Population_;
    __EE4314468.Dt_First_Seen_;
    __EE4314468.Dt_Last_Seen_;
    __EE4314468.Id_Activity_Dt_First_Seen_;
    __EE4314468.Id_Activity_Dt_Last_Seen_;
    __EE4314468.Last_Record_Id_;
    __EE4314468.Identity_Count_;
    __EE4314468.Identity_Count_Gt2_;
    __EE4314468.Event_Count_;
    __EE4314468.Kr_High_Risk_Flag_;
    __EE4314468.Kr_Medium_Risk_Flag_;
    __EE4314468.Kr_Low_Risk_Flag_;
    __EE4314468.Kr_Flag_;
    __EE4314468.Safe_Flag_;
    __EE4314468.Contributor_Safe_Flag_;
    __EE4314468.Last_Event_Date_;
    __EE4314468.Kr_Last_Event_Date_;
    __EE4314468.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4314468.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4314468.Kr_Phn400_Flag_;
    __EE4314468.Kr_Phn401_Flag_;
    __EE4314468.Kr_Phn402_Flag_;
    __EE4314468.Kr_Phn490_Flag_;
    __EE4314468.Kr_Phn491_Flag_;
    __EE4314468.Kr_Phn492_Flag_;
    __EE4314468.Kr_Phn493_Flag_;
    __EE4314468.Vl_Event1_All_Count_;
    __EE4314468.Vl_Event7_All_Count_;
    __EE4314468.Vl_Event30_All_Day_Count_;
    __EE4314468.Vl_Event365_All_Day_Count_;
    __EE4314468.Vl_Event7_All_Active_Flag_;
    __EE4314468.Vl_Event30_All_Active_Flag_;
    __EE4314468.Vl_Event1_Count_;
    __EE4314468.Vl_Event7_Count_;
    __EE4314468.Vl_Event30_Count_;
    __EE4314468.Vl_Event365_Count_;
    __EE4314468.Vl_Event7_Active_Flag_;
    __EE4314468.Vl_Event30_Active_Flag_;
    __EE4314468.Date_First_Seen_;
    __EE4314468.Date_Last_Seen_;
    __EE4314468.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4314468,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4314470_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST67828_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
