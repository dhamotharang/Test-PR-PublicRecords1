...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE1115998 := __ENH_Phone_1;
  SHARED __EE1118924 := __ENH_Event_1;
  SHARED __EE1118922 := __E_Phone_Event;
  SHARED __EE1154169 := __EE1118922(__NN(__EE1118922.Phone_Number_) AND __NN(__EE1118922.Transaction_));
  SHARED __ST1148266_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1154187(B_Event_1.__ST35830_Layout __EE1118924, E_Phone_Event.Layout __EE1154169) := __EEQP(__EE1154169.Transaction_,__EE1118924.UID);
  __ST1148266_Layout __JT1154187(B_Event_1.__ST35830_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1154188 := JOIN(__EE1154169,__EE1118924,__JC1154187(RIGHT,LEFT),__JT1154187(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1145854_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1145854_Layout __ND1154583__Project(__ST1148266_Layout __PP1154189) := TRANSFORM
    SELF.UID := __PP1154189.Phone_Number__1_;
    SELF._r_Customer_ := __PP1154189._r_Customer__1_;
    SELF.Phone_Number_ := __PP1154189.Phone_Number__1_;
    SELF.Event_Date_ := __PP1154189.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1154189.UID;
    SELF.Event_Date__1_ := __PP1154189.Event_Date_;
    SELF.Phone_Number__1_ := __PP1154189.Phone_Number_;
    SELF._r_Customer__1_ := __PP1154189._r_Customer_;
    SELF := __PP1154189;
  END;
  SHARED __EE1156108 := PROJECT(__EE1154188,__ND1154583__Project(LEFT));
  SHARED __ST1146713_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1146713_Layout __ND1156783__Project(__ST1145854_Layout __PP1156109) := TRANSFORM
    SELF.Exp1_ := __PP1156109.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1156109.Hri07_Flag_ = 1;
    SELF.Exp3_ := __PP1156109.Hri08_Flag_ = 1;
    SELF.Exp4_ := __PP1156109.Hri15_Flag_ = 1;
    SELF.Exp5_ := __PP1156109.Hri27_Flag_ = 1;
    SELF.Exp6_ := __PP1156109.Hri31_Flag_ = 1;
    SELF.Exp7_ := __PP1156109.Hri_Mi_Flag_ = 1;
    SELF.Exp8_ := __PP1156109.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp9_ := __PP1156109.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp10_ := __PP1156109.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp11_ := __PP1156109.Kr_Phn400_Flag_ = 1;
    SELF.Exp12_ := __PP1156109.Kr_Phn401_Flag_ = 1;
    SELF.Exp13_ := __PP1156109.Kr_Phn402_Flag_ = 1;
    SELF.Exp14_ := __PP1156109.Kr_Phn490_Flag_ = 1;
    SELF.Exp15_ := __PP1156109.Kr_Phn491_Flag_ = 1;
    SELF.Exp16_ := __PP1156109.Kr_Phn492_Flag_ = 1;
    SELF.Exp17_ := __PP1156109.Kr_Phn493_Flag_ = 1;
    SELF.Exp18_ := __PP1156109.Safe_Flag_ = 1;
    SELF.Exp19_ := __OP2(__PP1156109.Event_Age_,<,__CN(2));
    SELF.Exp20_ := __AND(__OP2(__PP1156109.Event_Age_,<,__CN(2)),__CN(__PP1156109.In_Customer_Population_ = 1));
    SELF.Exp21_ := __OP2(__PP1156109.Event_Age_,<,__CN(366));
    SELF := __PP1156109;
  END;
  SHARED __EE1156814 := PROJECT(__EE1156108,__ND1156783__Project(LEFT));
  SHARED __ST1146839_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1156948 := PROJECT(__CLEANANDDO(__EE1156814,TABLE(__EE1156814,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1156814.Exp1_),KEL.Aggregates.MinNG(__EE1156814.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1156814.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1156814.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1156814.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1156814.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1156814.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1156814.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1156814.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1156814.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1156814.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1156814.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1156814.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1156814.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1156814.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1156814.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE1156814.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE1156814.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__EE1156814.Exp17_),KEL.Aggregates.MaxNG(__EE1156814.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__EE1156814.Exp18_),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__T(__EE1156814.Exp19_)),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__T(__EE1156814.Exp20_)),KEL.typ.int C_O_U_N_T___Exp1__20_ := COUNT(GROUP,__T(__EE1156814.Exp21_)),UID},UID,MERGE)),__ST1146839_Layout);
  SHARED __ST1150200_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1156954(B_Phone_1.__ST37215_Layout __EE1115998, __ST1146839_Layout __EE1156948) := __EEQP(__EE1115998.UID,__EE1156948.UID);
  __ST1150200_Layout __JT1156954(B_Phone_1.__ST37215_Layout __l, __ST1146839_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1157005 := JOIN(__EE1115998,__EE1156948,__JC1156954(LEFT,RIGHT),__JT1156954(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1104665 := __ENH_Customer_1;
  SHARED __ST1150555_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1157011(__ST1150200_Layout __EE1157005, B_Customer_1.__ST32808_Layout __EE1104665) := __EEQP(__EE1157005._r_Customer_,__EE1104665.UID);
  __ST1150555_Layout __JT1157011(__ST1150200_Layout __l, B_Customer_1.__ST32808_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1157084 := JOIN(__EE1157005,__EE1104665,__JC1157011(LEFT,RIGHT),__JT1157011(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST31602_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31602_Layout __ND1157089__Project(__ST1150555_Layout __PP1157085) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1157085.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1157085.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 16;
    SELF.Hri07_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri08_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Hri15_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Hri27_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Hri31_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Hri_Mi_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP1157085.Identity_Count_ > 2=>1,0);
    __BS1157202 := __T(__PP1157085.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1157202(__T(__OP2(__T(__PP1157085.Source_Customers_)._r_Source_Customer_,=,__PP1157085._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__16_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP1157085.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1157085.C_O_U_N_T___Exp1__17_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1157085.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1157085.C_O_U_N_T___Exp1__18_;
    SELF.Vl_Event1_Count_ := __PP1157085.C_O_U_N_T___Exp1__19_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1157085.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1157085.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1157085.C_O_U_N_T___Exp1__20_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1157085.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1157085.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1157085;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE1157084,__ND1157089__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE1362823 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1362823._r_Customer_;
    __EE1362823.Source_Customers_;
    __EE1362823.Phone_Formatted_;
    __EE1362823.Phone_Number_;
    __EE1362823._is_Cell_Phone_;
    __EE1362823.Customer_Id_;
    __EE1362823.Industry_Type_;
    __EE1362823.Source_Customer_Count_;
    __EE1362823.Entity_Context_Uid_;
    __EE1362823.Entity_Type_;
    __EE1362823.Label_;
    __EE1362823.In_Customer_Population_;
    __EE1362823.Dt_First_Seen_;
    __EE1362823.Dt_Last_Seen_;
    __EE1362823.Last_Record_Id_;
    __EE1362823.Identity_Count_;
    __EE1362823.Identity_Count_Gt2_;
    __EE1362823.Event_Count_;
    __EE1362823.Hri_Mi_Flag_;
    __EE1362823.Hri07_Flag_;
    __EE1362823.Hri08_Flag_;
    __EE1362823.Hri15_Flag_;
    __EE1362823.Hri27_Flag_;
    __EE1362823.Hri31_Flag_;
    __EE1362823.Kr_High_Risk_Flag_;
    __EE1362823.Kr_Medium_Risk_Flag_;
    __EE1362823.Kr_Low_Risk_Flag_;
    __EE1362823.Kr_Flag_;
    __EE1362823.Safe_Flag_;
    __EE1362823.Contributor_Safe_Flag_;
    __EE1362823.Last_Event_Date_;
    __EE1362823.Kr_Last_Event_Date_;
    __EE1362823.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1362823.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1362823.Kr_Phn400_Flag_;
    __EE1362823.Kr_Phn401_Flag_;
    __EE1362823.Kr_Phn402_Flag_;
    __EE1362823.Kr_Phn490_Flag_;
    __EE1362823.Kr_Phn491_Flag_;
    __EE1362823.Kr_Phn492_Flag_;
    __EE1362823.Kr_Phn493_Flag_;
    __EE1362823.Vl_Event1_All_Count_;
    __EE1362823.Vl_Event7_All_Count_;
    __EE1362823.Vl_Event30_All_Day_Count_;
    __EE1362823.Vl_Event365_All_Day_Count_;
    __EE1362823.Vl_Event7_All_Active_Flag_;
    __EE1362823.Vl_Event30_All_Active_Flag_;
    __EE1362823.Vl_Event1_Count_;
    __EE1362823.Vl_Event7_Count_;
    __EE1362823.Vl_Event30_Count_;
    __EE1362823.Vl_Event365_Count_;
    __EE1362823.Vl_Event7_Active_Flag_;
    __EE1362823.Vl_Event30_Active_Flag_;
    __EE1362823.Date_First_Seen_;
    __EE1362823.Date_Last_Seen_;
    __EE1362823.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE1362823,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1362825_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST31602_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
