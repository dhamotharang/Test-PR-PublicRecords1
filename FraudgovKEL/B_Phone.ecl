...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE3912418 := __ENH_Phone_1;
  SHARED __EE3916535 := __ENH_Event_1;
  SHARED __EE3916533 := __E_Phone_Event;
  SHARED __EE3958770 := __EE3916533(__NN(__EE3916533.Phone_Number_) AND __NN(__EE3916533.Transaction_));
  SHARED __ST3950164_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC3958788(B_Event_1.__ST77589_Layout __EE3916535, E_Phone_Event.Layout __EE3958770) := __EEQP(__EE3958770.Transaction_,__EE3916535.UID);
  __ST3950164_Layout __JT3958788(B_Event_1.__ST77589_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3958789 := JOIN(__EE3958770,__EE3916535,__JC3958788(RIGHT,LEFT),__JT3958788(RIGHT,LEFT),INNER,HASH);
  SHARED __ST3946850_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3946850_Layout __ND3959465__Project(__ST3950164_Layout __PP3958790) := TRANSFORM
    SELF.UID := __PP3958790.Phone_Number__1_;
    SELF._r_Customer_ := __PP3958790._r_Customer__1_;
    SELF.Phone_Number_ := __PP3958790.Phone_Number__1_;
    SELF.Event_Date_ := __PP3958790.Event_Date__1_;
    SELF.U_I_D__1_ := __PP3958790.UID;
    SELF.Event_Date__1_ := __PP3958790.Event_Date_;
    SELF.Phone_Number__1_ := __PP3958790.Phone_Number_;
    SELF._r_Customer__1_ := __PP3958790._r_Customer_;
    SELF := __PP3958790;
  END;
  SHARED __EE3962122 := PROJECT(__EE3958789,__ND3959465__Project(LEFT));
  SHARED __ST3948240_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST3948240_Layout __ND3962127__Project(__ST3946850_Layout __PP3962123) := TRANSFORM
    SELF.Exp1_ := __PP3962123.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP3962123.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP3962123.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP3962123.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP3962123.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP3962123.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP3962123.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP3962123.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP3962123.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP3962123.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP3962123.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP3962123.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP3962123.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP3962123.Safe_Flag_ = 1;
    SELF := __PP3962123;
  END;
  SHARED __EE3962204 := PROJECT(__EE3962122,__ND3962127__Project(LEFT));
  SHARED __ST3948323_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE3962290 := PROJECT(__CLEANANDDO(__EE3962204,TABLE(__EE3962204,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE3962204.Exp1_),KEL.Aggregates.MinNG(__EE3962204.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE3962204.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE3962204.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE3962204.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE3962204.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE3962204.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE3962204.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE3962204.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE3962204.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE3962204.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE3962204.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE3962204.Exp12_),KEL.Aggregates.MaxNG(__EE3962204.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE3962204.Exp13_),UID},UID,MERGE)),__ST3948323_Layout);
  SHARED __ST3953509_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3962296(B_Phone_1.__ST80191_Layout __EE3912418, __ST3948323_Layout __EE3962290) := __EEQP(__EE3912418.UID,__EE3962290.UID);
  __ST3953509_Layout __JT3962296(B_Phone_1.__ST80191_Layout __l, __ST3948323_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3962297 := JOIN(__EE3912418,__EE3962290,__JC3962296(LEFT,RIGHT),__JT3962296(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3895126 := __ENH_Customer_1;
  SHARED __ST3953888_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3962362(__ST3953509_Layout __EE3962297, B_Customer_1.__ST69381_Layout __EE3895126) := __EEQP(__EE3962297._r_Customer_,__EE3895126.UID);
  __ST3953888_Layout __JT3962362(__ST3953509_Layout __l, B_Customer_1.__ST69381_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3962363 := JOIN(__EE3962297,__EE3895126,__JC3962362(LEFT,RIGHT),__JT3962362(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST67529_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST67529_Layout __ND3962744__Project(__ST3953888_Layout __PP3962364) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP3962364.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP3962364.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP3962364.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP3962364.Identity_Count_ > 2=>1,0);
    __BS3962599 := __T(__PP3962364.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS3962599(__T(__OP2(__T(__PP3962364.Source_Customers_)._r_Source_Customer_,=,__PP3962364._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP3962364.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP3962364.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP3962364.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP3962364.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP3962364.Source_Customers_);
    SELF := __PP3962364;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE3962363,__ND3962744__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4159510 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4159510._r_Customer_;
    __EE4159510.Source_Customers_;
    __EE4159510.Phone_Formatted_;
    __EE4159510.Phone_Number_;
    __EE4159510._is_Cell_Phone_;
    __EE4159510.Aot_Act_Cnt_Ev_;
    __EE4159510.Aot_Src1_Act_Cnt_Ev_;
    __EE4159510.Aot_Src1_Act_Only_Flag_;
    __EE4159510.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4159510.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4159510.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4159510.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4159510.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4159510.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4159510.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4159510.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4159510.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4159510.Aot_Id_Act_Cnt_Ev_;
    __EE4159510.Aot_Id_Act_Cnt30_D_;
    __EE4159510.Aot_Add_Act_Cnt_Ev_;
    __EE4159510.Aot_Add_Act_Cnt30_D_;
    __EE4159510.Aot_Non_St_Act_Cnt_Ev_;
    __EE4159510.Aot_Non_St_Act_Cnt30_D_;
    __EE4159510.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4159510.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4159510.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4159510.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4159510.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4159510.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4159510.Customer_Id_;
    __EE4159510.Industry_Type_;
    __EE4159510.Source_Customer_Count_;
    __EE4159510.Entity_Context_Uid_;
    __EE4159510.Entity_Type_;
    __EE4159510.Label_;
    __EE4159510.In_Customer_Population_;
    __EE4159510.Dt_First_Seen_;
    __EE4159510.Dt_Last_Seen_;
    __EE4159510.Id_Activity_Dt_First_Seen_;
    __EE4159510.Id_Activity_Dt_Last_Seen_;
    __EE4159510.Last_Record_Id_;
    __EE4159510.Identity_Count_;
    __EE4159510.Identity_Count_Gt2_;
    __EE4159510.Event_Count_;
    __EE4159510.Kr_High_Risk_Flag_;
    __EE4159510.Kr_Medium_Risk_Flag_;
    __EE4159510.Kr_Low_Risk_Flag_;
    __EE4159510.Kr_Flag_;
    __EE4159510.Safe_Flag_;
    __EE4159510.Contributor_Safe_Flag_;
    __EE4159510.Last_Event_Date_;
    __EE4159510.Kr_Last_Event_Date_;
    __EE4159510.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4159510.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4159510.Kr_Phn400_Flag_;
    __EE4159510.Kr_Phn401_Flag_;
    __EE4159510.Kr_Phn402_Flag_;
    __EE4159510.Kr_Phn490_Flag_;
    __EE4159510.Kr_Phn491_Flag_;
    __EE4159510.Kr_Phn492_Flag_;
    __EE4159510.Kr_Phn493_Flag_;
    __EE4159510.Date_First_Seen_;
    __EE4159510.Date_Last_Seen_;
    __EE4159510.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4159510,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4159512_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST67529_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
