...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE2043616 := __ENH_Phone_1;
  SHARED __EE2047025 := __ENH_Event_1;
  SHARED __EE2047023 := __E_Phone_Event;
  SHARED __EE2083370 := __EE2047023(__NN(__EE2047023.Phone_Number_) AND __NN(__EE2047023.Transaction_));
  SHARED __ST2076376_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2083388(B_Event_1.__ST50776_Layout __EE2047025, E_Phone_Event.Layout __EE2083370) := __EEQP(__EE2083370.Transaction_,__EE2047025.UID);
  __ST2076376_Layout __JT2083388(B_Event_1.__ST50776_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2083389 := JOIN(__EE2083370,__EE2047025,__JC2083388(RIGHT,LEFT),__JT2083388(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2073636_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2073636_Layout __ND2083913__Project(__ST2076376_Layout __PP2083390) := TRANSFORM
    SELF.UID := __PP2083390.Phone_Number__1_;
    SELF._r_Customer_ := __PP2083390._r_Customer__1_;
    SELF.Phone_Number_ := __PP2083390.Phone_Number__1_;
    SELF.Event_Date_ := __PP2083390.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2083390.UID;
    SELF.Event_Date__1_ := __PP2083390.Event_Date_;
    SELF.Phone_Number__1_ := __PP2083390.Phone_Number_;
    SELF._r_Customer__1_ := __PP2083390._r_Customer_;
    SELF := __PP2083390;
  END;
  SHARED __EE2085962 := PROJECT(__EE2083389,__ND2083913__Project(LEFT));
  SHARED __ST2074729_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2074729_Layout __ND2086557__Project(__ST2073636_Layout __PP2085963) := TRANSFORM
    SELF.Exp1_ := __PP2085963.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2085963.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP2085963.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP2085963.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP2085963.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP2085963.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP2085963.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP2085963.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP2085963.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP2085963.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP2085963.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP2085963.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2085963.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2085963.Event_Age_,<,__CN(2)),__CN(__PP2085963.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2085963.Event_Age_,<,__CN(366));
    SELF := __PP2085963;
  END;
  SHARED __EE2086582 := PROJECT(__EE2085962,__ND2086557__Project(LEFT));
  SHARED __ST2074822_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2086681 := PROJECT(__CLEANANDDO(__EE2086582,TABLE(__EE2086582,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2086582.Exp1_),KEL.Aggregates.MinNG(__EE2086582.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2086582.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2086582.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2086582.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2086582.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2086582.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2086582.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2086582.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2086582.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2086582.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2086582.Exp11_),KEL.Aggregates.MaxNG(__EE2086582.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2086582.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2086582.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2086582.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2086582.Exp15_)),UID},UID,MERGE)),__ST2074822_Layout);
  SHARED __ST2078961_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2086687(B_Phone_1.__ST52826_Layout __EE2043616, __ST2074822_Layout __EE2086681) := __EEQP(__EE2043616.UID,__EE2086681.UID);
  __ST2078961_Layout __JT2086687(B_Phone_1.__ST52826_Layout __l, __ST2074822_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2086736 := JOIN(__EE2043616,__EE2086681,__JC2086687(LEFT,RIGHT),__JT2086687(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2033832 := __ENH_Customer_1;
  SHARED __ST2079303_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2086742(__ST2078961_Layout __EE2086736, B_Customer_1.__ST45514_Layout __EE2033832) := __EEQP(__EE2086736._r_Customer_,__EE2033832.UID);
  __ST2079303_Layout __JT2086742(__ST2078961_Layout __l, B_Customer_1.__ST45514_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2086813 := JOIN(__EE2086736,__EE2033832,__JC2086742(LEFT,RIGHT),__JT2086742(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST44106_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44106_Layout __ND2086818__Project(__ST2079303_Layout __PP2086814) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2086814.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP2086814.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP2086814.Identity_Count_ > 2=>1,0);
    __BS2086921 := __T(__PP2086814.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2086921(__T(__OP2(__T(__PP2086814.Source_Customers_)._r_Source_Customer_,=,__PP2086814._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2086814.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP2086814.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2086814.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2086814.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2086814.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2086814.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2086814.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2086814.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2086814.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2086814.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2086814.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2086814;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE2086813,__ND2086818__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE2277542 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2277542._r_Customer_;
    __EE2277542.Source_Customers_;
    __EE2277542.Phone_Formatted_;
    __EE2277542.Phone_Number_;
    __EE2277542._is_Cell_Phone_;
    __EE2277542.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE2277542.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2277542.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE2277542.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE2277542.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2277542.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2277542.Customer_Id_;
    __EE2277542.Industry_Type_;
    __EE2277542.Source_Customer_Count_;
    __EE2277542.Entity_Context_Uid_;
    __EE2277542.Entity_Type_;
    __EE2277542.Label_;
    __EE2277542.In_Customer_Population_;
    __EE2277542.Dt_First_Seen_;
    __EE2277542.Dt_Last_Seen_;
    __EE2277542.Last_Record_Id_;
    __EE2277542.Identity_Count_;
    __EE2277542.Identity_Count_Gt2_;
    __EE2277542.Event_Count_;
    __EE2277542.Kr_High_Risk_Flag_;
    __EE2277542.Kr_Medium_Risk_Flag_;
    __EE2277542.Kr_Low_Risk_Flag_;
    __EE2277542.Kr_Flag_;
    __EE2277542.Safe_Flag_;
    __EE2277542.Contributor_Safe_Flag_;
    __EE2277542.Last_Event_Date_;
    __EE2277542.Kr_Last_Event_Date_;
    __EE2277542.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2277542.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2277542.Kr_Phn400_Flag_;
    __EE2277542.Kr_Phn401_Flag_;
    __EE2277542.Kr_Phn402_Flag_;
    __EE2277542.Kr_Phn490_Flag_;
    __EE2277542.Kr_Phn491_Flag_;
    __EE2277542.Kr_Phn492_Flag_;
    __EE2277542.Kr_Phn493_Flag_;
    __EE2277542.Vl_Event1_All_Count_;
    __EE2277542.Vl_Event7_All_Count_;
    __EE2277542.Vl_Event30_All_Day_Count_;
    __EE2277542.Vl_Event365_All_Day_Count_;
    __EE2277542.Vl_Event7_All_Active_Flag_;
    __EE2277542.Vl_Event30_All_Active_Flag_;
    __EE2277542.Vl_Event1_Count_;
    __EE2277542.Vl_Event7_Count_;
    __EE2277542.Vl_Event30_Count_;
    __EE2277542.Vl_Event365_Count_;
    __EE2277542.Vl_Event7_Active_Flag_;
    __EE2277542.Vl_Event30_Active_Flag_;
    __EE2277542.Date_First_Seen_;
    __EE2277542.Date_Last_Seen_;
    __EE2277542.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE2277542,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2277544_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST44106_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
