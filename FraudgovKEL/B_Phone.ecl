...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE2550246 := __ENH_Phone_1;
  SHARED __EE2554276 := __ENH_Event_1;
  SHARED __EE2554274 := __E_Phone_Event;
  SHARED __EE2598484 := __EE2554274(__NN(__EE2554274.Phone_Number_) AND __NN(__EE2554274.Transaction_));
  SHARED __ST2590233_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2598502(B_Event_1.__ST61957_Layout __EE2554276, E_Phone_Event.Layout __EE2598484) := __EEQP(__EE2598484.Transaction_,__EE2554276.UID);
  __ST2590233_Layout __JT2598502(B_Event_1.__ST61957_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2598503 := JOIN(__EE2598484,__EE2554276,__JC2598502(RIGHT,LEFT),__JT2598502(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2587007_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2587007_Layout __ND2599147__Project(__ST2590233_Layout __PP2598504) := TRANSFORM
    SELF.UID := __PP2598504.Phone_Number__1_;
    SELF._r_Customer_ := __PP2598504._r_Customer__1_;
    SELF.Phone_Number_ := __PP2598504.Phone_Number__1_;
    SELF.Event_Date_ := __PP2598504.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2598504.UID;
    SELF.Event_Date__1_ := __PP2598504.Event_Date_;
    SELF.Phone_Number__1_ := __PP2598504.Phone_Number_;
    SELF._r_Customer__1_ := __PP2598504._r_Customer_;
    SELF := __PP2598504;
  END;
  SHARED __EE2601676 := PROJECT(__EE2598503,__ND2599147__Project(LEFT));
  SHARED __ST2588340_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2588340_Layout __ND2602289__Project(__ST2587007_Layout __PP2601677) := TRANSFORM
    SELF.Exp1_ := __PP2601677.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2601677.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP2601677.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP2601677.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP2601677.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP2601677.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP2601677.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP2601677.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP2601677.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP2601677.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP2601677.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP2601677.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2601677.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2601677.Event_Age_,<,__CN(2)),__CN(__PP2601677.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2601677.Event_Age_,<,__CN(366));
    SELF := __PP2601677;
  END;
  SHARED __EE2602314 := PROJECT(__EE2601676,__ND2602289__Project(LEFT));
  SHARED __ST2588433_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2602413 := PROJECT(__CLEANANDDO(__EE2602314,TABLE(__EE2602314,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2602314.Exp1_),KEL.Aggregates.MinNG(__EE2602314.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2602314.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2602314.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2602314.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2602314.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2602314.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2602314.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2602314.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2602314.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2602314.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2602314.Exp11_),KEL.Aggregates.MaxNG(__EE2602314.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2602314.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2602314.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2602314.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2602314.Exp15_)),UID},UID,MERGE)),__ST2588433_Layout);
  SHARED __ST2593418_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2602419(B_Phone_1.__ST64204_Layout __EE2550246, __ST2588433_Layout __EE2602413) := __EEQP(__EE2550246.UID,__EE2602413.UID);
  __ST2593418_Layout __JT2602419(B_Phone_1.__ST64204_Layout __l, __ST2588433_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2602471 := JOIN(__EE2550246,__EE2602413,__JC2602419(LEFT,RIGHT),__JT2602419(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2538539 := __ENH_Customer_1;
  SHARED __ST2593775_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2602477(__ST2593418_Layout __EE2602471, B_Customer_1.__ST55167_Layout __EE2538539) := __EEQP(__EE2602471._r_Customer_,__EE2538539.UID);
  __ST2593775_Layout __JT2602477(__ST2593418_Layout __l, B_Customer_1.__ST55167_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2602551 := JOIN(__EE2602471,__EE2538539,__JC2602477(LEFT,RIGHT),__JT2602477(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST53716_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST53716_Layout __ND2602556__Project(__ST2593775_Layout __PP2602552) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2602552.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP2602552.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP2602552.Identity_Count_ > 2=>1,0);
    __BS2602668 := __T(__PP2602552.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2602668(__T(__OP2(__T(__PP2602552.Source_Customers_)._r_Source_Customer_,=,__PP2602552._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2602552.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP2602552.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2602552.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2602552.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2602552.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2602552.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2602552.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2602552.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2602552.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2602552.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2602552.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2602552;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE2602551,__ND2602556__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE2805475 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2805475._r_Customer_;
    __EE2805475.Source_Customers_;
    __EE2805475.Phone_Formatted_;
    __EE2805475.Phone_Number_;
    __EE2805475._is_Cell_Phone_;
    __EE2805475.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE2805475.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2805475.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE2805475.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE2805475.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2805475.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2805475.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE2805475.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE2805475.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE2805475.Customer_Id_;
    __EE2805475.Industry_Type_;
    __EE2805475.Source_Customer_Count_;
    __EE2805475.Entity_Context_Uid_;
    __EE2805475.Entity_Type_;
    __EE2805475.Label_;
    __EE2805475.In_Customer_Population_;
    __EE2805475.Dt_First_Seen_;
    __EE2805475.Dt_Last_Seen_;
    __EE2805475.Last_Record_Id_;
    __EE2805475.Identity_Count_;
    __EE2805475.Identity_Count_Gt2_;
    __EE2805475.Event_Count_;
    __EE2805475.Kr_High_Risk_Flag_;
    __EE2805475.Kr_Medium_Risk_Flag_;
    __EE2805475.Kr_Low_Risk_Flag_;
    __EE2805475.Kr_Flag_;
    __EE2805475.Safe_Flag_;
    __EE2805475.Contributor_Safe_Flag_;
    __EE2805475.Last_Event_Date_;
    __EE2805475.Kr_Last_Event_Date_;
    __EE2805475.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2805475.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2805475.Kr_Phn400_Flag_;
    __EE2805475.Kr_Phn401_Flag_;
    __EE2805475.Kr_Phn402_Flag_;
    __EE2805475.Kr_Phn490_Flag_;
    __EE2805475.Kr_Phn491_Flag_;
    __EE2805475.Kr_Phn492_Flag_;
    __EE2805475.Kr_Phn493_Flag_;
    __EE2805475.Vl_Event1_All_Count_;
    __EE2805475.Vl_Event7_All_Count_;
    __EE2805475.Vl_Event30_All_Day_Count_;
    __EE2805475.Vl_Event365_All_Day_Count_;
    __EE2805475.Vl_Event7_All_Active_Flag_;
    __EE2805475.Vl_Event30_All_Active_Flag_;
    __EE2805475.Vl_Event1_Count_;
    __EE2805475.Vl_Event7_Count_;
    __EE2805475.Vl_Event30_Count_;
    __EE2805475.Vl_Event365_Count_;
    __EE2805475.Vl_Event7_Active_Flag_;
    __EE2805475.Vl_Event30_Active_Flag_;
    __EE2805475.Date_First_Seen_;
    __EE2805475.Date_Last_Seen_;
    __EE2805475.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE2805475,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2805477_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST53716_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
