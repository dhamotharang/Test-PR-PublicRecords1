...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE2106643 := __ENH_Phone_1;
  SHARED __EE2110123 := __ENH_Event_1;
  SHARED __EE2110121 := __E_Phone_Event;
  SHARED __EE2147181 := __EE2110121(__NN(__EE2110121.Phone_Number_) AND __NN(__EE2110121.Transaction_));
  SHARED __ST2140030_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2147199(B_Event_1.__ST52980_Layout __EE2110123, E_Phone_Event.Layout __EE2147181) := __EEQP(__EE2147181.Transaction_,__EE2110123.UID);
  __ST2140030_Layout __JT2147199(B_Event_1.__ST52980_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2147200 := JOIN(__EE2147181,__EE2110123,__JC2147199(RIGHT,LEFT),__JT2147199(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2137244_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2137244_Layout __ND2147734__Project(__ST2140030_Layout __PP2147201) := TRANSFORM
    SELF.UID := __PP2147201.Phone_Number__1_;
    SELF._r_Customer_ := __PP2147201._r_Customer__1_;
    SELF.Phone_Number_ := __PP2147201.Phone_Number__1_;
    SELF.Event_Date_ := __PP2147201.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2147201.UID;
    SELF.Event_Date__1_ := __PP2147201.Event_Date_;
    SELF.Phone_Number__1_ := __PP2147201.Phone_Number_;
    SELF._r_Customer__1_ := __PP2147201._r_Customer_;
    SELF := __PP2147201;
  END;
  SHARED __EE2149823 := PROJECT(__EE2147200,__ND2147734__Project(LEFT));
  SHARED __ST2138357_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2138357_Layout __ND2150436__Project(__ST2137244_Layout __PP2149824) := TRANSFORM
    SELF.Exp1_ := __PP2149824.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2149824.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP2149824.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP2149824.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP2149824.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP2149824.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP2149824.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP2149824.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP2149824.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP2149824.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP2149824.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP2149824.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2149824.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2149824.Event_Age_,<,__CN(2)),__CN(__PP2149824.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2149824.Event_Age_,<,__CN(366));
    SELF := __PP2149824;
  END;
  SHARED __EE2150461 := PROJECT(__EE2149823,__ND2150436__Project(LEFT));
  SHARED __ST2138450_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2150560 := PROJECT(__CLEANANDDO(__EE2150461,TABLE(__EE2150461,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2150461.Exp1_),KEL.Aggregates.MinNG(__EE2150461.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2150461.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2150461.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2150461.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2150461.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2150461.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2150461.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2150461.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2150461.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2150461.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2150461.Exp11_),KEL.Aggregates.MaxNG(__EE2150461.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2150461.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2150461.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2150461.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2150461.Exp15_)),UID},UID,MERGE)),__ST2138450_Layout);
  SHARED __ST2142665_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2150566(B_Phone_1.__ST55117_Layout __EE2106643, __ST2138450_Layout __EE2150560) := __EEQP(__EE2106643.UID,__EE2150560.UID);
  __ST2142665_Layout __JT2150566(B_Phone_1.__ST55117_Layout __l, __ST2138450_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2150618 := JOIN(__EE2106643,__EE2150560,__JC2150566(LEFT,RIGHT),__JT2150566(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2096696 := __ENH_Customer_1;
  SHARED __ST2143022_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2150624(__ST2142665_Layout __EE2150618, B_Customer_1.__ST47427_Layout __EE2096696) := __EEQP(__EE2150618._r_Customer_,__EE2096696.UID);
  __ST2143022_Layout __JT2150624(__ST2142665_Layout __l, B_Customer_1.__ST47427_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2150698 := JOIN(__EE2150618,__EE2096696,__JC2150624(LEFT,RIGHT),__JT2150624(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST45976_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45976_Layout __ND2150703__Project(__ST2143022_Layout __PP2150699) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2150699.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP2150699.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP2150699.Identity_Count_ > 2=>1,0);
    __BS2150815 := __T(__PP2150699.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2150815(__T(__OP2(__T(__PP2150699.Source_Customers_)._r_Source_Customer_,=,__PP2150699._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2150699.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP2150699.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2150699.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2150699.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2150699.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2150699.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2150699.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2150699.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2150699.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2150699.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2150699.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2150699;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE2150698,__ND2150703__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE2342972 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2342972._r_Customer_;
    __EE2342972.Source_Customers_;
    __EE2342972.Phone_Formatted_;
    __EE2342972.Phone_Number_;
    __EE2342972._is_Cell_Phone_;
    __EE2342972.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE2342972.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2342972.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE2342972.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE2342972.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2342972.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2342972.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE2342972.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE2342972.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE2342972.Customer_Id_;
    __EE2342972.Industry_Type_;
    __EE2342972.Source_Customer_Count_;
    __EE2342972.Entity_Context_Uid_;
    __EE2342972.Entity_Type_;
    __EE2342972.Label_;
    __EE2342972.In_Customer_Population_;
    __EE2342972.Dt_First_Seen_;
    __EE2342972.Dt_Last_Seen_;
    __EE2342972.Last_Record_Id_;
    __EE2342972.Identity_Count_;
    __EE2342972.Identity_Count_Gt2_;
    __EE2342972.Event_Count_;
    __EE2342972.Kr_High_Risk_Flag_;
    __EE2342972.Kr_Medium_Risk_Flag_;
    __EE2342972.Kr_Low_Risk_Flag_;
    __EE2342972.Kr_Flag_;
    __EE2342972.Safe_Flag_;
    __EE2342972.Contributor_Safe_Flag_;
    __EE2342972.Last_Event_Date_;
    __EE2342972.Kr_Last_Event_Date_;
    __EE2342972.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2342972.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2342972.Kr_Phn400_Flag_;
    __EE2342972.Kr_Phn401_Flag_;
    __EE2342972.Kr_Phn402_Flag_;
    __EE2342972.Kr_Phn490_Flag_;
    __EE2342972.Kr_Phn491_Flag_;
    __EE2342972.Kr_Phn492_Flag_;
    __EE2342972.Kr_Phn493_Flag_;
    __EE2342972.Vl_Event1_All_Count_;
    __EE2342972.Vl_Event7_All_Count_;
    __EE2342972.Vl_Event30_All_Day_Count_;
    __EE2342972.Vl_Event365_All_Day_Count_;
    __EE2342972.Vl_Event7_All_Active_Flag_;
    __EE2342972.Vl_Event30_All_Active_Flag_;
    __EE2342972.Vl_Event1_Count_;
    __EE2342972.Vl_Event7_Count_;
    __EE2342972.Vl_Event30_Count_;
    __EE2342972.Vl_Event365_Count_;
    __EE2342972.Vl_Event7_Active_Flag_;
    __EE2342972.Vl_Event30_Active_Flag_;
    __EE2342972.Date_First_Seen_;
    __EE2342972.Date_Last_Seen_;
    __EE2342972.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE2342972,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2342974_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST45976_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
