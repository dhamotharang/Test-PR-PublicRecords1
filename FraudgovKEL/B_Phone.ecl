...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4162136 := __ENH_Phone_1;
  SHARED __EE4166381 := __ENH_Event_1;
  SHARED __EE4166379 := __E_Phone_Event;
  SHARED __EE4210450 := __EE4166379(__NN(__EE4166379.Phone_Number_) AND __NN(__EE4166379.Transaction_));
  SHARED __ST4201454_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4210468(B_Event_1.__ST80990_Layout __EE4166381, E_Phone_Event.Layout __EE4210450) := __EEQP(__EE4210450.Transaction_,__EE4166381.UID);
  __ST4201454_Layout __JT4210468(B_Event_1.__ST80990_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4210469 := JOIN(__EE4210450,__EE4166381,__JC4210468(RIGHT,LEFT),__JT4210468(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4197920_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4197920_Layout __ND4211197__Project(__ST4201454_Layout __PP4210470) := TRANSFORM
    SELF.UID := __PP4210470.Phone_Number__1_;
    SELF._r_Customer_ := __PP4210470._r_Customer__1_;
    SELF.Phone_Number_ := __PP4210470.Phone_Number__1_;
    SELF.Event_Date_ := __PP4210470.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4210470.UID;
    SELF.Event_Date__1_ := __PP4210470.Event_Date_;
    SELF.Phone_Number__1_ := __PP4210470.Phone_Number_;
    SELF._r_Customer__1_ := __PP4210470._r_Customer_;
    SELF := __PP4210470;
  END;
  SHARED __EE4213990 := PROJECT(__EE4210469,__ND4211197__Project(LEFT));
  SHARED __ST4199426_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4199426_Layout __ND4213995__Project(__ST4197920_Layout __PP4213991) := TRANSFORM
    SELF.Exp1_ := __PP4213991.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4213991.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4213991.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4213991.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4213991.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4213991.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4213991.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4213991.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4213991.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4213991.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4213991.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4213991.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4213991.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4213991.Safe_Flag_ = 1;
    SELF := __PP4213991;
  END;
  SHARED __EE4214072 := PROJECT(__EE4213990,__ND4213995__Project(LEFT));
  SHARED __ST4199509_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4214158 := PROJECT(__CLEANANDDO(__EE4214072,TABLE(__EE4214072,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4214072.Exp1_),KEL.Aggregates.MinNG(__EE4214072.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4214072.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4214072.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4214072.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4214072.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4214072.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4214072.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4214072.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4214072.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4214072.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4214072.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4214072.Exp12_),KEL.Aggregates.MaxNG(__EE4214072.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4214072.Exp13_),UID},UID,MERGE)),__ST4199509_Layout);
  SHARED __ST4204999_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4214164(B_Phone_1.__ST83644_Layout __EE4162136, __ST4199509_Layout __EE4214158) := __EEQP(__EE4162136.UID,__EE4214158.UID);
  __ST4204999_Layout __JT4214164(B_Phone_1.__ST83644_Layout __l, __ST4199509_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4214165 := JOIN(__EE4162136,__EE4214158,__JC4214164(LEFT,RIGHT),__JT4214164(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4144100 := __ENH_Customer_1;
  SHARED __ST4205378_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4214230(__ST4204999_Layout __EE4214165, B_Customer_1.__ST72603_Layout __EE4144100) := __EEQP(__EE4214165._r_Customer_,__EE4144100.UID);
  __ST4205378_Layout __JT4214230(__ST4204999_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4214231 := JOIN(__EE4214165,__EE4144100,__JC4214230(LEFT,RIGHT),__JT4214230(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST70750_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST70750_Layout __ND4214613__Project(__ST4205378_Layout __PP4214232) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4214232.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4214232.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4214232.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4214232.Identity_Count_ > 2=>1,0);
    __BS4214468 := __T(__PP4214232.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4214468(__T(__OP2(__T(__PP4214232.Source_Customers_)._r_Source_Customer_,=,__PP4214232._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4214232.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4214232.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4214232.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4214232.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4214232.Source_Customers_);
    SELF := __PP4214232;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE4214231,__ND4214613__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4416991 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4416991._r_Customer_;
    __EE4416991.Source_Customers_;
    __EE4416991.Phone_Formatted_;
    __EE4416991.Phone_Number_;
    __EE4416991._is_Cell_Phone_;
    __EE4416991.Aot_Act_Cnt_Ev_;
    __EE4416991.Aot_Src1_Act_Cnt_Ev_;
    __EE4416991.Aot_Src1_Act_Only_Flag_;
    __EE4416991.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4416991.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4416991.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4416991.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4416991.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4416991.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4416991.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4416991.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4416991.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4416991.Aot_Id_Act_Cnt_Ev_;
    __EE4416991.Aot_Id_Act_Cnt30_D_;
    __EE4416991.Aot_Add_Act_Cnt_Ev_;
    __EE4416991.Aot_Add_Act_Cnt30_D_;
    __EE4416991.Aot_Non_St_Act_Cnt_Ev_;
    __EE4416991.Aot_Non_St_Act_Cnt30_D_;
    __EE4416991.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4416991.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4416991.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4416991.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4416991.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4416991.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4416991.Customer_Id_;
    __EE4416991.Industry_Type_;
    __EE4416991.Source_Customer_Count_;
    __EE4416991.Entity_Context_Uid_;
    __EE4416991.Entity_Type_;
    __EE4416991.Label_;
    __EE4416991.In_Customer_Population_;
    __EE4416991.Dt_First_Seen_;
    __EE4416991.Dt_Last_Seen_;
    __EE4416991.Id_Activity_Dt_First_Seen_;
    __EE4416991.Id_Activity_Dt_Last_Seen_;
    __EE4416991.Last_Record_Id_;
    __EE4416991.Identity_Count_;
    __EE4416991.Identity_Count_Gt2_;
    __EE4416991.Event_Count_;
    __EE4416991.Kr_High_Risk_Flag_;
    __EE4416991.Kr_Medium_Risk_Flag_;
    __EE4416991.Kr_Low_Risk_Flag_;
    __EE4416991.Kr_Flag_;
    __EE4416991.Safe_Flag_;
    __EE4416991.Contributor_Safe_Flag_;
    __EE4416991.Last_Event_Date_;
    __EE4416991.Kr_Last_Event_Date_;
    __EE4416991.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4416991.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4416991.Kr_Phn400_Flag_;
    __EE4416991.Kr_Phn401_Flag_;
    __EE4416991.Kr_Phn402_Flag_;
    __EE4416991.Kr_Phn490_Flag_;
    __EE4416991.Kr_Phn491_Flag_;
    __EE4416991.Kr_Phn492_Flag_;
    __EE4416991.Kr_Phn493_Flag_;
    __EE4416991.Date_First_Seen_;
    __EE4416991.Date_Last_Seen_;
    __EE4416991.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4416991,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4416993_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST70750_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
