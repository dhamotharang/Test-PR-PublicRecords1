...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4023861 := __ENH_Phone_1;
  SHARED __EE4028316 := __ENH_Event_1;
  SHARED __EE4028314 := __E_Phone_Event;
  SHARED __EE4078752 := __EE4028314(__NN(__EE4028314.Phone_Number_) AND __NN(__EE4028314.Transaction_));
  SHARED __ST4069576_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4078770(B_Event_1.__ST78140_Layout __EE4028316, E_Phone_Event.Layout __EE4078752) := __EEQP(__EE4078752.Transaction_,__EE4028316.UID);
  __ST4069576_Layout __JT4078770(B_Event_1.__ST78140_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4078771 := JOIN(__EE4078752,__EE4028316,__JC4078770(RIGHT,LEFT),__JT4078770(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4066058_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4066058_Layout __ND4079472__Project(__ST4069576_Layout __PP4078772) := TRANSFORM
    SELF.UID := __PP4078772.Phone_Number__1_;
    SELF._r_Customer_ := __PP4078772._r_Customer__1_;
    SELF.Phone_Number_ := __PP4078772.Phone_Number__1_;
    SELF.Event_Date_ := __PP4078772.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4078772.UID;
    SELF.Event_Date__1_ := __PP4078772.Event_Date_;
    SELF.Phone_Number__1_ := __PP4078772.Phone_Number_;
    SELF._r_Customer__1_ := __PP4078772._r_Customer_;
    SELF := __PP4078772;
  END;
  SHARED __EE4082229 := PROJECT(__EE4078771,__ND4079472__Project(LEFT));
  SHARED __ST4067511_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4067511_Layout __ND4082957__Project(__ST4066058_Layout __PP4082230) := TRANSFORM
    SELF.Exp1_ := __PP4082230.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4082230.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4082230.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4082230.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4082230.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4082230.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4082230.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4082230.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4082230.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4082230.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4082230.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4082230.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4082230.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4082230.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP4082230.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP4082230.Event_Age_,<,__CN(2)),__CN(__PP4082230.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP4082230.Event_Age_,<,__CN(366));
    SELF := __PP4082230;
  END;
  SHARED __EE4082983 := PROJECT(__EE4082229,__ND4082957__Project(LEFT));
  SHARED __ST4067609_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4083087 := PROJECT(__CLEANANDDO(__EE4082983,TABLE(__EE4082983,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4082983.Exp1_),KEL.Aggregates.MaxNG(__EE4082983.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE4082983.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4082983.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4082983.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4082983.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4082983.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4082983.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4082983.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4082983.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4082983.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4082983.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4082983.Exp12_),KEL.Aggregates.MaxNG(__EE4082983.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4082983.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE4082983.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE4082983.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE4082983.Exp16_)),UID},UID,MERGE)),__ST4067609_Layout);
  SHARED __ST4073046_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4083093(B_Phone_1.__ST81071_Layout __EE4023861, __ST4067609_Layout __EE4083087) := __EEQP(__EE4023861.UID,__EE4083087.UID);
  __ST4073046_Layout __JT4083093(B_Phone_1.__ST81071_Layout __l, __ST4067609_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4083162 := JOIN(__EE4023861,__EE4083087,__JC4083093(LEFT,RIGHT),__JT4083093(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4005644 := __ENH_Customer_1;
  SHARED __ST4073488_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4083168(__ST4073046_Layout __EE4083162, B_Customer_1.__ST69958_Layout __EE4005644) := __EEQP(__EE4083162._r_Customer_,__EE4005644.UID);
  __ST4073488_Layout __JT4083168(__ST4073046_Layout __l, B_Customer_1.__ST69958_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4083259 := JOIN(__EE4083162,__EE4005644,__JC4083168(LEFT,RIGHT),__JT4083168(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST67832_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST67832_Layout __ND4083264__Project(__ST4073488_Layout __PP4083260) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP4083260.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4083260.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4083260.M_I_N___Event_Date__1_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4083260.Identity_Count_ > 2=>1,0);
    __BS4083427 := __T(__PP4083260.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4083427(__T(__OP2(__T(__PP4083260.Source_Customers_)._r_Source_Customer_,=,__PP4083260._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4083260.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4083260.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP4083260.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4083260.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP4083260.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP4083260.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP4083260.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP4083260.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP4083260.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP4083260.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP4083260.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP4083260;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE4083259,__ND4083264__Project(LEFT)) : PERSIST('~fraudgov::tempKEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4314852 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4314852._r_Customer_;
    __EE4314852.Source_Customers_;
    __EE4314852.Phone_Formatted_;
    __EE4314852.Phone_Number_;
    __EE4314852._is_Cell_Phone_;
    __EE4314852.Aot_Act_Cnt_Ev_;
    __EE4314852.Aot_Src1_Act_Cnt_Ev_;
    __EE4314852.Aot_Src1_Act_Only_Flag_;
    __EE4314852.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4314852.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4314852.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4314852.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4314852.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4314852.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4314852.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4314852.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4314852.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4314852.Aot_Id_Act_Cnt_Ev_;
    __EE4314852.Aot_Id_Act_Cnt30_D_;
    __EE4314852.Aot_Add_Act_Cnt_Ev_;
    __EE4314852.Aot_Add_Act_Cnt30_D_;
    __EE4314852.Aot_Non_St_Act_Cnt_Ev_;
    __EE4314852.Aot_Non_St_Act_Cnt30_D_;
    __EE4314852.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4314852.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4314852.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4314852.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4314852.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4314852.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4314852.Customer_Id_;
    __EE4314852.Industry_Type_;
    __EE4314852.Source_Customer_Count_;
    __EE4314852.Entity_Context_Uid_;
    __EE4314852.Entity_Type_;
    __EE4314852.Label_;
    __EE4314852.In_Customer_Population_;
    __EE4314852.Dt_First_Seen_;
    __EE4314852.Dt_Last_Seen_;
    __EE4314852.Id_Activity_Dt_First_Seen_;
    __EE4314852.Id_Activity_Dt_Last_Seen_;
    __EE4314852.Last_Record_Id_;
    __EE4314852.Identity_Count_;
    __EE4314852.Identity_Count_Gt2_;
    __EE4314852.Event_Count_;
    __EE4314852.Kr_High_Risk_Flag_;
    __EE4314852.Kr_Medium_Risk_Flag_;
    __EE4314852.Kr_Low_Risk_Flag_;
    __EE4314852.Kr_Flag_;
    __EE4314852.Safe_Flag_;
    __EE4314852.Contributor_Safe_Flag_;
    __EE4314852.Last_Event_Date_;
    __EE4314852.Kr_Last_Event_Date_;
    __EE4314852.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4314852.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4314852.Kr_Phn400_Flag_;
    __EE4314852.Kr_Phn401_Flag_;
    __EE4314852.Kr_Phn402_Flag_;
    __EE4314852.Kr_Phn490_Flag_;
    __EE4314852.Kr_Phn491_Flag_;
    __EE4314852.Kr_Phn492_Flag_;
    __EE4314852.Kr_Phn493_Flag_;
    __EE4314852.Vl_Event1_All_Count_;
    __EE4314852.Vl_Event7_All_Count_;
    __EE4314852.Vl_Event30_All_Day_Count_;
    __EE4314852.Vl_Event365_All_Day_Count_;
    __EE4314852.Vl_Event7_All_Active_Flag_;
    __EE4314852.Vl_Event30_All_Active_Flag_;
    __EE4314852.Vl_Event1_Count_;
    __EE4314852.Vl_Event7_Count_;
    __EE4314852.Vl_Event30_Count_;
    __EE4314852.Vl_Event365_Count_;
    __EE4314852.Vl_Event7_Active_Flag_;
    __EE4314852.Vl_Event30_Active_Flag_;
    __EE4314852.Date_First_Seen_;
    __EE4314852.Date_Last_Seen_;
    __EE4314852.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4314852,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4314854_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST67832_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
