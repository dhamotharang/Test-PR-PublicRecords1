...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE2099281 := __ENH_Phone_1;
  SHARED __EE2102751 := __ENH_Event_1;
  SHARED __EE2102749 := __E_Phone_Event;
  SHARED __EE2139679 := __EE2102749(__NN(__EE2102749.Phone_Number_) AND __NN(__EE2102749.Transaction_));
  SHARED __ST2132548_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2139697(B_Event_1.__ST52969_Layout __EE2102751, E_Phone_Event.Layout __EE2139679) := __EEQP(__EE2139679.Transaction_,__EE2102751.UID);
  __ST2132548_Layout __JT2139697(B_Event_1.__ST52969_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2139698 := JOIN(__EE2139679,__EE2102751,__JC2139697(RIGHT,LEFT),__JT2139697(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2129770_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2129770_Layout __ND2140230__Project(__ST2132548_Layout __PP2139699) := TRANSFORM
    SELF.UID := __PP2139699.Phone_Number__1_;
    SELF._r_Customer_ := __PP2139699._r_Customer__1_;
    SELF.Phone_Number_ := __PP2139699.Phone_Number__1_;
    SELF.Event_Date_ := __PP2139699.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2139699.UID;
    SELF.Event_Date__1_ := __PP2139699.Event_Date_;
    SELF.Phone_Number__1_ := __PP2139699.Phone_Number_;
    SELF._r_Customer__1_ := __PP2139699._r_Customer_;
    SELF := __PP2139699;
  END;
  SHARED __EE2142311 := PROJECT(__EE2139698,__ND2140230__Project(LEFT));
  SHARED __ST2130879_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2130879_Layout __ND2142924__Project(__ST2129770_Layout __PP2142312) := TRANSFORM
    SELF.Exp1_ := __PP2142312.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2142312.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP2142312.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP2142312.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP2142312.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP2142312.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP2142312.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP2142312.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP2142312.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP2142312.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP2142312.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP2142312.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2142312.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2142312.Event_Age_,<,__CN(2)),__CN(__PP2142312.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2142312.Event_Age_,<,__CN(366));
    SELF := __PP2142312;
  END;
  SHARED __EE2142949 := PROJECT(__EE2142311,__ND2142924__Project(LEFT));
  SHARED __ST2130972_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2143048 := PROJECT(__CLEANANDDO(__EE2142949,TABLE(__EE2142949,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2142949.Exp1_),KEL.Aggregates.MinNG(__EE2142949.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2142949.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2142949.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2142949.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2142949.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2142949.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2142949.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2142949.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2142949.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2142949.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2142949.Exp11_),KEL.Aggregates.MaxNG(__EE2142949.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2142949.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2142949.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2142949.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2142949.Exp15_)),UID},UID,MERGE)),__ST2130972_Layout);
  SHARED __ST2135173_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2143054(B_Phone_1.__ST55104_Layout __EE2099281, __ST2130972_Layout __EE2143048) := __EEQP(__EE2099281.UID,__EE2143048.UID);
  __ST2135173_Layout __JT2143054(B_Phone_1.__ST55104_Layout __l, __ST2130972_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2143106 := JOIN(__EE2099281,__EE2143048,__JC2143054(LEFT,RIGHT),__JT2143054(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2089366 := __ENH_Customer_1;
  SHARED __ST2135530_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2143112(__ST2135173_Layout __EE2143106, B_Customer_1.__ST47418_Layout __EE2089366) := __EEQP(__EE2143106._r_Customer_,__EE2089366.UID);
  __ST2135530_Layout __JT2143112(__ST2135173_Layout __l, B_Customer_1.__ST47418_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2143186 := JOIN(__EE2143106,__EE2089366,__JC2143112(LEFT,RIGHT),__JT2143112(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST45967_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45967_Layout __ND2143191__Project(__ST2135530_Layout __PP2143187) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2143187.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP2143187.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP2143187.Identity_Count_ > 2=>1,0);
    __BS2143303 := __T(__PP2143187.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2143303(__T(__OP2(__T(__PP2143187.Source_Customers_)._r_Source_Customer_,=,__PP2143187._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2143187.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP2143187.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2143187.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2143187.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2143187.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2143187.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2143187.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2143187.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2143187.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2143187.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2143187.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2143187;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE2143186,__ND2143191__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE2336033 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2336033._r_Customer_;
    __EE2336033.Source_Customers_;
    __EE2336033.Phone_Formatted_;
    __EE2336033.Phone_Number_;
    __EE2336033._is_Cell_Phone_;
    __EE2336033.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE2336033.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE2336033.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE2336033.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE2336033.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2336033.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2336033.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE2336033.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE2336033.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE2336033.Customer_Id_;
    __EE2336033.Industry_Type_;
    __EE2336033.Source_Customer_Count_;
    __EE2336033.Entity_Context_Uid_;
    __EE2336033.Entity_Type_;
    __EE2336033.Label_;
    __EE2336033.In_Customer_Population_;
    __EE2336033.Dt_First_Seen_;
    __EE2336033.Dt_Last_Seen_;
    __EE2336033.Last_Record_Id_;
    __EE2336033.Identity_Count_;
    __EE2336033.Identity_Count_Gt2_;
    __EE2336033.Event_Count_;
    __EE2336033.Kr_High_Risk_Flag_;
    __EE2336033.Kr_Medium_Risk_Flag_;
    __EE2336033.Kr_Low_Risk_Flag_;
    __EE2336033.Kr_Flag_;
    __EE2336033.Safe_Flag_;
    __EE2336033.Contributor_Safe_Flag_;
    __EE2336033.Last_Event_Date_;
    __EE2336033.Kr_Last_Event_Date_;
    __EE2336033.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2336033.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2336033.Kr_Phn400_Flag_;
    __EE2336033.Kr_Phn401_Flag_;
    __EE2336033.Kr_Phn402_Flag_;
    __EE2336033.Kr_Phn490_Flag_;
    __EE2336033.Kr_Phn491_Flag_;
    __EE2336033.Kr_Phn492_Flag_;
    __EE2336033.Kr_Phn493_Flag_;
    __EE2336033.Vl_Event1_All_Count_;
    __EE2336033.Vl_Event7_All_Count_;
    __EE2336033.Vl_Event30_All_Day_Count_;
    __EE2336033.Vl_Event365_All_Day_Count_;
    __EE2336033.Vl_Event7_All_Active_Flag_;
    __EE2336033.Vl_Event30_All_Active_Flag_;
    __EE2336033.Vl_Event1_Count_;
    __EE2336033.Vl_Event7_Count_;
    __EE2336033.Vl_Event30_Count_;
    __EE2336033.Vl_Event365_Count_;
    __EE2336033.Vl_Event7_Active_Flag_;
    __EE2336033.Vl_Event30_Active_Flag_;
    __EE2336033.Date_First_Seen_;
    __EE2336033.Date_Last_Seen_;
    __EE2336033.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE2336033,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2336035_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST45967_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
