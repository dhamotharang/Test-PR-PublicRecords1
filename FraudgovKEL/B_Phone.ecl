...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE1089600 := __ENH_Phone_1;
  SHARED __EE1092492 := __ENH_Event_1;
  SHARED __EE1092490 := __E_Phone_Event;
  SHARED __EE1122310 := __EE1092490(__NN(__EE1092490.Phone_Number_) AND __NN(__EE1092490.Transaction_));
  SHARED __ST1116404_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1122328(B_Event_1.__ST33354_Layout __EE1092492, E_Phone_Event.Layout __EE1122310) := __EEQP(__EE1122310.Transaction_,__EE1092492.UID);
  __ST1116404_Layout __JT1122328(B_Event_1.__ST33354_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1122329 := JOIN(__EE1122310,__EE1092492,__JC1122328(RIGHT,LEFT),__JT1122328(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1114054_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1114054_Layout __ND1122754__Project(__ST1116404_Layout __PP1122330) := TRANSFORM
    SELF.UID := __PP1122330.Phone_Number__1_;
    SELF._r_Customer_ := __PP1122330._r_Customer__1_;
    SELF.Phone_Number_ := __PP1122330.Phone_Number__1_;
    SELF.Event_Date_ := __PP1122330.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1122330.UID;
    SELF.Event_Date__1_ := __PP1122330.Event_Date_;
    SELF.Phone_Number__1_ := __PP1122330.Phone_Number_;
    SELF._r_Customer__1_ := __PP1122330._r_Customer_;
    SELF := __PP1122330;
  END;
  SHARED __EE1124407 := PROJECT(__EE1122329,__ND1122754__Project(LEFT));
  SHARED __ST1114953_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1114953_Layout __ND1124971__Project(__ST1114054_Layout __PP1124408) := TRANSFORM
    SELF.Exp1_ := __PP1124408.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1124408.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp3_ := __PP1124408.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP1124408.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP1124408.Kr_Phn400_Flag_ = 1;
    SELF.Exp6_ := __PP1124408.Kr_Phn401_Flag_ = 1;
    SELF.Exp7_ := __PP1124408.Kr_Phn402_Flag_ = 1;
    SELF.Exp8_ := __PP1124408.Kr_Phn490_Flag_ = 1;
    SELF.Exp9_ := __PP1124408.Kr_Phn491_Flag_ = 1;
    SELF.Exp10_ := __PP1124408.Kr_Phn492_Flag_ = 1;
    SELF.Exp11_ := __PP1124408.Kr_Phn493_Flag_ = 1;
    SELF.Exp12_ := __PP1124408.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1124408.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1124408.Event_Age_,<,__CN(2)),__CN(__PP1124408.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1124408.Event_Age_,<,__CN(366));
    SELF := __PP1124408;
  END;
  SHARED __EE1124996 := PROJECT(__EE1124407,__ND1124971__Project(LEFT));
  SHARED __ST1115049_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1125100 := PROJECT(__CLEANANDDO(__EE1124996,TABLE(__EE1124996,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1124996.Exp1_),KEL.Aggregates.MinNG(__EE1124996.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE1124996.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1124996.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1124996.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1124996.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1124996.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1124996.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1124996.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1124996.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1124996.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1124996.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1124996.Exp11_),KEL.Aggregates.MaxNG(__EE1124996.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1124996.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1124996.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1124996.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1124996.Exp15_)),UID},UID,MERGE)),__ST1115049_Layout);
  SHARED __ST1118494_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1125106(B_Phone_1.__ST34629_Layout __EE1089600, __ST1115049_Layout __EE1125100) := __EEQP(__EE1089600.UID,__EE1125100.UID);
  __ST1118494_Layout __JT1125106(B_Phone_1.__ST34629_Layout __l, __ST1115049_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1125149 := JOIN(__EE1089600,__EE1125100,__JC1125106(LEFT,RIGHT),__JT1125106(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1078068 := __ENH_Customer_1;
  SHARED __ST1118806_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1125155(__ST1118494_Layout __EE1125149, B_Customer_1.__ST30513_Layout __EE1078068) := __EEQP(__EE1125149._r_Customer_,__EE1078068.UID);
  __ST1118806_Layout __JT1125155(__ST1118494_Layout __l, B_Customer_1.__ST30513_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1125220 := JOIN(__EE1125149,__EE1078068,__JC1125155(LEFT,RIGHT),__JT1125155(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST29469_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST29469_Layout __ND1125225__Project(__ST1118806_Layout __PP1125221) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1125221.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP1125221.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP1125221.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Identity_Count_Gt2_ := MAP(__PP1125221.Identity_Count_ > 2=>1,0);
    __BS1125310 := __T(__PP1125221.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1125310(__T(__OP2(__T(__PP1125221.Source_Customers_)._r_Source_Customer_,=,__PP1125221._r_Customer_))))=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1125221.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP1125221.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP1125221.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1125221.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1125221.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1125221.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1125221.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1125221.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1125221.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1125221.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1125221.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1125221;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE1125220,__ND1125225__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE1298741 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1298741._r_Customer_;
    __EE1298741.Source_Customers_;
    __EE1298741.Phone_Formatted_;
    __EE1298741.Phone_Number_;
    __EE1298741._is_Cell_Phone_;
    __EE1298741.Customer_Id_;
    __EE1298741.Industry_Type_;
    __EE1298741.Source_Customer_Count_;
    __EE1298741.Entity_Context_Uid_;
    __EE1298741.Entity_Type_;
    __EE1298741.Label_;
    __EE1298741.In_Customer_Population_;
    __EE1298741.Dt_First_Seen_;
    __EE1298741.Dt_Last_Seen_;
    __EE1298741.Last_Record_Id_;
    __EE1298741.Identity_Count_;
    __EE1298741.Identity_Count_Gt2_;
    __EE1298741.Event_Count_;
    __EE1298741.Kr_High_Risk_Flag_;
    __EE1298741.Kr_Medium_Risk_Flag_;
    __EE1298741.Kr_Low_Risk_Flag_;
    __EE1298741.Kr_Flag_;
    __EE1298741.Safe_Flag_;
    __EE1298741.Contributor_Safe_Flag_;
    __EE1298741.Last_Event_Date_;
    __EE1298741.Kr_Last_Event_Date_;
    __EE1298741.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1298741.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1298741.Kr_Phn400_Flag_;
    __EE1298741.Kr_Phn401_Flag_;
    __EE1298741.Kr_Phn402_Flag_;
    __EE1298741.Kr_Phn490_Flag_;
    __EE1298741.Kr_Phn491_Flag_;
    __EE1298741.Kr_Phn492_Flag_;
    __EE1298741.Kr_Phn493_Flag_;
    __EE1298741.Vl_Event1_All_Count_;
    __EE1298741.Vl_Event7_All_Count_;
    __EE1298741.Vl_Event30_All_Day_Count_;
    __EE1298741.Vl_Event365_All_Day_Count_;
    __EE1298741.Vl_Event7_All_Active_Flag_;
    __EE1298741.Vl_Event30_All_Active_Flag_;
    __EE1298741.Vl_Event1_Count_;
    __EE1298741.Vl_Event7_Count_;
    __EE1298741.Vl_Event30_Count_;
    __EE1298741.Vl_Event365_Count_;
    __EE1298741.Vl_Event7_Active_Flag_;
    __EE1298741.Vl_Event30_Active_Flag_;
    __EE1298741.Date_First_Seen_;
    __EE1298741.Date_Last_Seen_;
    __EE1298741.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE1298741,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1298743_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST29469_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
