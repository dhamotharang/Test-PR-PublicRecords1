...
IMPORT B_Customer_1,B_Customer_5,B_Event_1,B_Phone_1,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone,E_Phone_Event,E_Social_Security_Number FROM FraudgovKEL;
...
EXPORT B_Phone := MODULE
  ...
  SHARED __EE4459347 := __ENH_Phone_1;
  SHARED __EE4463592 := __ENH_Event_1;
  SHARED __EE4463590 := __E_Phone_Event;
  SHARED __EE4507661 := __EE4463590(__NN(__EE4463590.Phone_Number_) AND __NN(__EE4463590.Transaction_));
  SHARED __ST4498665_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC4507679(B_Event_1.__ST80086_Layout __EE4463592, E_Phone_Event.Layout __EE4507661) := __EEQP(__EE4507661.Transaction_,__EE4463592.UID);
  __ST4498665_Layout __JT4507679(B_Event_1.__ST80086_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4507680 := JOIN(__EE4507661,__EE4463592,__JC4507679(RIGHT,LEFT),__JT4507679(RIGHT,LEFT),INNER,HASH);
  SHARED __ST4495131_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4495131_Layout __ND4508408__Project(__ST4498665_Layout __PP4507681) := TRANSFORM
    SELF.UID := __PP4507681.Phone_Number__1_;
    SELF._r_Customer_ := __PP4507681._r_Customer__1_;
    SELF.Phone_Number_ := __PP4507681.Phone_Number__1_;
    SELF.Event_Date_ := __PP4507681.Event_Date__1_;
    SELF.U_I_D__1_ := __PP4507681.UID;
    SELF.Event_Date__1_ := __PP4507681.Event_Date_;
    SELF.Phone_Number__1_ := __PP4507681.Phone_Number_;
    SELF._r_Customer__1_ := __PP4507681._r_Customer_;
    SELF := __PP4507681;
  END;
  SHARED __EE4511201 := PROJECT(__EE4507680,__ND4508408__Project(LEFT));
  SHARED __ST4496637_Layout := RECORD
    KEL.typ.ntyp(E_Phone.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST4496637_Layout __ND4511206__Project(__ST4495131_Layout __PP4511202) := TRANSFORM
    SELF.Exp1_ := __PP4511202.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP4511202.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP4511202.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP4511202.Kr_High_Risk_Phone_Flag_ = 1;
    SELF.Exp4_ := __PP4511202.Kr_Low_Risk_Phone_Flag_ = 1;
    SELF.Exp5_ := __PP4511202.Kr_Medium_Risk_Phone_Flag_ = 1;
    SELF.Exp6_ := __PP4511202.Kr_Phn400_Flag_ = 1;
    SELF.Exp7_ := __PP4511202.Kr_Phn401_Flag_ = 1;
    SELF.Exp8_ := __PP4511202.Kr_Phn402_Flag_ = 1;
    SELF.Exp9_ := __PP4511202.Kr_Phn490_Flag_ = 1;
    SELF.Exp10_ := __PP4511202.Kr_Phn491_Flag_ = 1;
    SELF.Exp11_ := __PP4511202.Kr_Phn492_Flag_ = 1;
    SELF.Exp12_ := __PP4511202.Kr_Phn493_Flag_ = 1;
    SELF.Exp13_ := __PP4511202.Safe_Flag_ = 1;
    SELF := __PP4511202;
  END;
  SHARED __EE4511283 := PROJECT(__EE4511201,__ND4511206__Project(LEFT));
  SHARED __ST4496720_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE4511369 := PROJECT(__CLEANANDDO(__EE4511283,TABLE(__EE4511283,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE4511283.Exp1_),KEL.Aggregates.MinNG(__EE4511283.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE4511283.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE4511283.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE4511283.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE4511283.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE4511283.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE4511283.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE4511283.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE4511283.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE4511283.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE4511283.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE4511283.Exp12_),KEL.Aggregates.MaxNG(__EE4511283.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE4511283.Exp13_),UID},UID,MERGE)),__ST4496720_Layout);
  SHARED __ST4502210_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4511375(B_Phone_1.__ST82640_Layout __EE4459347, __ST4496720_Layout __EE4511369) := __EEQP(__EE4459347.UID,__EE4511369.UID);
  __ST4502210_Layout __JT4511375(B_Phone_1.__ST82640_Layout __l, __ST4496720_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4511376 := JOIN(__EE4459347,__EE4511369,__JC4511375(LEFT,RIGHT),__JT4511375(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4441311 := __ENH_Customer_1;
  SHARED __ST4502589_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4511441(__ST4502210_Layout __EE4511376, B_Customer_1.__ST71756_Layout __EE4441311) := __EEQP(__EE4511376._r_Customer_,__EE4441311.UID);
  __ST4502589_Layout __JT4511441(__ST4502210_Layout __l, B_Customer_1.__ST71756_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4511442 := JOIN(__EE4511376,__EE4441311,__JC4511441(LEFT,RIGHT),__JT4511441(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST69989_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Phone.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Phone_Formatted_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST69989_Layout __ND4511824__Project(__ST4502589_Layout __PP4511443) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP4511443.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_16'),+,__PP4511443.Phone_Number_);
    SELF.Entity_Type_ := 16;
    SELF.Id_Activity_Dt_First_Seen_ := __PP4511443.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP4511443.Identity_Count_ > 2=>1,0);
    __BS4511679 := __T(__PP4511443.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS4511679(__T(__OP2(__T(__PP4511443.Source_Customers_)._r_Source_Customer_,=,__PP4511443._r_Customer_))))=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP4511443.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Phn400_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Phn401_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Phn402_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Phn490_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Phn491_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Phn492_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Phn493_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP4511443.Phone_Formatted_;
    SELF.Last_Event_Date_ := __PP4511443.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP4511443.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP4511443.Source_Customers_);
    SELF := __PP4511443;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE4511442,__ND4511824__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Phone::Annotated',EXPIRE(7));
  SHARED __EE4712954 := __ENH_Phone;
  SHARED IDX_Phone_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4712954._r_Customer_;
    __EE4712954.Source_Customers_;
    __EE4712954.Phone_Formatted_;
    __EE4712954.Phone_Number_;
    __EE4712954._is_Cell_Phone_;
    __EE4712954.Aot_Act_Cnt_Ev_;
    __EE4712954.Aot_Src1_Act_Cnt_Ev_;
    __EE4712954.Aot_Src1_Act_Only_Flag_;
    __EE4712954.Aot_Phn_Kr_Act_Cnt_Ev_;
    __EE4712954.Aot_Phn_Kr_Act_Shrd_Cnt_Ev_;
    __EE4712954.Aot_Phn_Kr_Act_Old_Dt_Ev_;
    __EE4712954.Aot_Phn_Kr_Act_New_Dt_Ev_;
    __EE4712954.Aot_Phn_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4712954.Aot_Phn_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4712954.Aot_Phn_Safe_Act_Cnt_Ev_;
    __EE4712954.Aot_Phn_Safe_Act_Old_Dt_Ev_;
    __EE4712954.Aot_Phn_Safe_Act_New_Dt_Ev_;
    __EE4712954.Aot_Id_Act_Cnt_Ev_;
    __EE4712954.Aot_Id_Act_Cnt30_D_;
    __EE4712954.Aot_Add_Act_Cnt_Ev_;
    __EE4712954.Aot_Add_Act_Cnt30_D_;
    __EE4712954.Aot_Non_St_Act_Cnt_Ev_;
    __EE4712954.Aot_Non_St_Act_Cnt30_D_;
    __EE4712954.Aot_Phn_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4712954.Aot_Phn_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4712954.Aot_Phn_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4712954.Aot_Id_Curr_Prof_Usng_Phn_Cnt_Ev_;
    __EE4712954.Aot_Id_Hist_Prof_Usng_Phn_Cnt_Ev_;
    __EE4712954.Aot_Id_Usng_Phn_Cnt_Ev_;
    __EE4712954.Customer_Id_;
    __EE4712954.Industry_Type_;
    __EE4712954.Source_Customer_Count_;
    __EE4712954.Entity_Context_Uid_;
    __EE4712954.Entity_Type_;
    __EE4712954.Label_;
    __EE4712954.In_Customer_Population_;
    __EE4712954.Dt_First_Seen_;
    __EE4712954.Dt_Last_Seen_;
    __EE4712954.Id_Activity_Dt_First_Seen_;
    __EE4712954.Id_Activity_Dt_Last_Seen_;
    __EE4712954.Last_Record_Id_;
    __EE4712954.Identity_Count_;
    __EE4712954.Identity_Count_Gt2_;
    __EE4712954.Event_Count_;
    __EE4712954.Kr_High_Risk_Flag_;
    __EE4712954.Kr_Medium_Risk_Flag_;
    __EE4712954.Kr_Low_Risk_Flag_;
    __EE4712954.Kr_Flag_;
    __EE4712954.Safe_Flag_;
    __EE4712954.Contributor_Safe_Flag_;
    __EE4712954.Last_Event_Date_;
    __EE4712954.Kr_Last_Event_Date_;
    __EE4712954.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4712954.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4712954.Kr_Phn400_Flag_;
    __EE4712954.Kr_Phn401_Flag_;
    __EE4712954.Kr_Phn402_Flag_;
    __EE4712954.Kr_Phn490_Flag_;
    __EE4712954.Kr_Phn491_Flag_;
    __EE4712954.Kr_Phn492_Flag_;
    __EE4712954.Kr_Phn493_Flag_;
    __EE4712954.Date_First_Seen_;
    __EE4712954.Date_Last_Seen_;
    __EE4712954.__RecordCount;
  END;
  SHARED IDX_Phone_UID_Projected := PROJECT(__EE4712954,TRANSFORM(IDX_Phone_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4712956_Layout := RECORDOF(IDX_Phone_UID);
  EXPORT IDX_Phone_UID_Wrapped := PROJECT(IDX_Phone_UID,TRANSFORM(__ST69989_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
