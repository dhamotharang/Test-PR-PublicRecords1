...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE4778299 := __E_Person_Phone;
  SHARED __EE4778282 := __ENH_Person;
  SHARED __ST4778317_Layout := RECORD
  ...
  END;
  __JC4778314(E_Person_Phone.Layout __EE4778299, B_Person.__ST71326_Layout __EE4778282) := __EEQP(__EE4778299.Subject_,__EE4778282.UID);
  __ST4778317_Layout __JT4778314(E_Person_Phone.Layout __l, B_Person.__ST71326_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4778315 := JOIN(__EE4778299,__EE4778282,__JC4778314(LEFT,RIGHT),__JT4778314(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4778270 := __ENH_Phone;
  SHARED __ST4778658_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4779598(__ST4778317_Layout __EE4778315, B_Phone.__ST72436_Layout __EE4778270) := __EEQP(__EE4778315.Phone_Number_,__EE4778270.UID);
  __ST4778658_Layout __JT4779598(__ST4778317_Layout __l, B_Phone.__ST72436_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4779599 := JOIN(__EE4778315,__EE4778270,__JC4779598(LEFT,RIGHT),__JT4779598(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4778255 := __E_Customer;
  SHARED __ST4779167_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4779600(__ST4778658_Layout __EE4779599, E_Customer.Layout __EE4778255) := __EEQP(__EE4779599._r_Customer_,__EE4778255.UID);
  __ST4779167_Layout __JT4779600(__ST4778658_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4779601 := JOIN(__EE4779599,__EE4778255,__JC4779600(LEFT,RIGHT),__JT4779600(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST47927_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47927_Layout __ND4779590__Project(__ST4779167_Layout __PP4779589) := TRANSFORM
    SELF.Source_Customer_ := __PP4779589._r_Customer_;
    SELF.Customer_Id_ := __PP4779589.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4779589.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4779589.Entity_Context_Uid__1_;
    SELF := __PP4779589;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4779601,__ND4779590__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST47927_Layout));
END;
