...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE2475545 := __E_Person_Phone;
  SHARED __EE2475528 := __ENH_Person;
  SHARED __ST2475563_Layout := RECORD
  ...
  END;
  __JC2475560(E_Person_Phone.Layout __EE2475545, B_Person.__ST45444_Layout __EE2475528) := __EEQP(__EE2475545.Subject_,__EE2475528.UID);
  __ST2475563_Layout __JT2475560(E_Person_Phone.Layout __l, B_Person.__ST45444_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2475561 := JOIN(__EE2475545,__EE2475528,__JC2475560(LEFT,RIGHT),__JT2475560(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2475516 := __ENH_Phone;
  SHARED __ST2475877_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2476707(__ST2475563_Layout __EE2475561, B_Phone.__ST46334_Layout __EE2475516) := __EEQP(__EE2475561.Phone_Number_,__EE2475516.UID);
  __ST2475877_Layout __JT2476707(__ST2475563_Layout __l, B_Phone.__ST46334_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2476708 := JOIN(__EE2475561,__EE2475516,__JC2476707(LEFT,RIGHT),__JT2476707(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2475501 := __E_Customer;
  SHARED __ST2476320_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2476709(__ST2475877_Layout __EE2476708, E_Customer.Layout __EE2475501) := __EEQP(__EE2476708._r_Customer_,__EE2475501.UID);
  __ST2476320_Layout __JT2476709(__ST2475877_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2476710 := JOIN(__EE2476708,__EE2475501,__JC2476709(LEFT,RIGHT),__JT2476709(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST31064_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31064_Layout __ND2476699__Project(__ST2476320_Layout __PP2476698) := TRANSFORM
    SELF.Source_Customer_ := __PP2476698._r_Customer_;
    SELF.Customer_Id_ := __PP2476698.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2476698.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2476698.Entity_Context_Uid__1_;
    SELF := __PP2476698;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2476710,__ND2476699__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST31064_Layout));
END;
