...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE4041742 := __E_Person_Phone;
  SHARED __EE4041725 := __ENH_Person;
  SHARED __ST4041760_Layout := RECORD
  ...
  END;
  __JC4041757(E_Person_Phone.Layout __EE4041742, B_Person.__ST65777_Layout __EE4041725) := __EEQP(__EE4041742.Subject_,__EE4041725.UID);
  __ST4041760_Layout __JT4041757(E_Person_Phone.Layout __l, B_Person.__ST65777_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4041758 := JOIN(__EE4041742,__EE4041725,__JC4041757(LEFT,RIGHT),__JT4041757(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4041713 := __ENH_Phone;
  SHARED __ST4042096_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4043006(__ST4041760_Layout __EE4041758, B_Phone.__ST66865_Layout __EE4041713) := __EEQP(__EE4041758.Phone_Number_,__EE4041713.UID);
  __ST4042096_Layout __JT4043006(__ST4041760_Layout __l, B_Phone.__ST66865_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4043007 := JOIN(__EE4041758,__EE4041713,__JC4043006(LEFT,RIGHT),__JT4043006(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4041698 := __E_Customer;
  SHARED __ST4042585_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4043008(__ST4042096_Layout __EE4043007, E_Customer.Layout __EE4041698) := __EEQP(__EE4043007._r_Customer_,__EE4041698.UID);
  __ST4042585_Layout __JT4043008(__ST4042096_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4043009 := JOIN(__EE4043007,__EE4041698,__JC4043008(LEFT,RIGHT),__JT4043008(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44375_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44375_Layout __ND4042998__Project(__ST4042585_Layout __PP4042997) := TRANSFORM
    SELF.Source_Customer_ := __PP4042997._r_Customer_;
    SELF.Customer_Id_ := __PP4042997.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4042997.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4042997.Entity_Context_Uid__1_;
    SELF := __PP4042997;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4043009,__ND4042998__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44375_Layout));
END;
