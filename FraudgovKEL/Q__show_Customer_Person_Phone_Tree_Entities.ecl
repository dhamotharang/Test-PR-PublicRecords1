...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE4371379 := __E_Person_Phone;
  SHARED __EE4371362 := __ENH_Person;
  SHARED __ST4371397_Layout := RECORD
  ...
  END;
  __JC4371394(E_Person_Phone.Layout __EE4371379, B_Person.__ST69802_Layout __EE4371362) := __EEQP(__EE4371379.Subject_,__EE4371362.UID);
  __ST4371397_Layout __JT4371394(E_Person_Phone.Layout __l, B_Person.__ST69802_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4371395 := JOIN(__EE4371379,__EE4371362,__JC4371394(LEFT,RIGHT),__JT4371394(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4371350 := __ENH_Phone;
  SHARED __ST4371672_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4372433(__ST4371397_Layout __EE4371395, B_Phone.__ST70750_Layout __EE4371350) := __EEQP(__EE4371395.Phone_Number_,__EE4371350.UID);
  __ST4371672_Layout __JT4372433(__ST4371397_Layout __l, B_Phone.__ST70750_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4372434 := JOIN(__EE4371395,__EE4371350,__JC4372433(LEFT,RIGHT),__JT4372433(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4371335 := __E_Customer;
  SHARED __ST4372079_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4372435(__ST4371672_Layout __EE4372434, E_Customer.Layout __EE4371335) := __EEQP(__EE4372434._r_Customer_,__EE4371335.UID);
  __ST4372079_Layout __JT4372435(__ST4371672_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4372436 := JOIN(__EE4372434,__EE4371335,__JC4372435(LEFT,RIGHT),__JT4372435(LEFT,RIGHT),LEFT OUTER,HASH);
