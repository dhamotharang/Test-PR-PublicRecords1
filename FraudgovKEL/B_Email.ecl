...
EXPORT B_Email := MODULE
  ...
  SHARED __EE2669619 := __ENH_Email_1;
  SHARED __EE2673888 := __ENH_Event_1;
  SHARED __EE2673886 := __E_Email_Event;
  SHARED __EE2718116 := __EE2673886(__NN(__EE2673886.Emailof_) AND __NN(__EE2673886.Transaction_));
  SHARED __ST2708969_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2718134(B_Event_1.__ST80990_Layout __EE2673888, E_Email_Event.Layout __EE2718116) := __EEQP(__EE2718116.Transaction_,__EE2673888.UID);
  __ST2708969_Layout __JT2718134(B_Event_1.__ST80990_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2718135 := JOIN(__EE2718116,__EE2673888,__JC2718134(RIGHT,LEFT),__JT2718134(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2705427_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2705427_Layout __ND2718861__Project(__ST2708969_Layout __PP2718136) := TRANSFORM
    SELF.UID := __PP2718136.Emailof_;
    SELF._r_Customer_ := __PP2718136._r_Customer__1_;
    SELF.Event_Date_ := __PP2718136.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2718136.UID;
    SELF.Event_Date__1_ := __PP2718136.Event_Date_;
    SELF._r_Customer__1_ := __PP2718136._r_Customer_;
    SELF := __PP2718136;
  END;
  SHARED __EE2721654 := PROJECT(__EE2718135,__ND2718861__Project(LEFT));
  SHARED __ST2706933_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2706933_Layout __ND2721659__Project(__ST2705427_Layout __PP2721655) := TRANSFORM
    SELF.Exp1_ := __PP2721655.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2721655.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2721655.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2721655.Kr_Eml500_Flag_ = 1;
    SELF.Exp4_ := __PP2721655.Kr_Eml501_Flag_ = 1;
    SELF.Exp5_ := __PP2721655.Kr_Eml502_Flag_ = 1;
    SELF.Exp6_ := __PP2721655.Kr_Eml590_Flag_ = 1;
    SELF.Exp7_ := __PP2721655.Kr_Eml591_Flag_ = 1;
    SELF.Exp8_ := __PP2721655.Kr_Eml592_Flag_ = 1;
    SELF.Exp9_ := __PP2721655.Kr_Eml593_Flag_ = 1;
    SELF.Exp10_ := __PP2721655.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP2721655.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP2721655.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp13_ := __PP2721655.Safe_Flag_ = 1;
    SELF := __PP2721655;
  END;
  SHARED __EE2721736 := PROJECT(__EE2721654,__ND2721659__Project(LEFT));
  SHARED __ST2707016_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2721822 := PROJECT(__CLEANANDDO(__EE2721736,TABLE(__EE2721736,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2721736.Exp1_),KEL.Aggregates.MinNG(__EE2721736.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2721736.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2721736.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2721736.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2721736.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2721736.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2721736.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2721736.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2721736.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2721736.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2721736.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2721736.Exp12_),KEL.Aggregates.MaxNG(__EE2721736.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2721736.Exp13_),UID},UID,MERGE)),__ST2707016_Layout);
  SHARED __ST2712512_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2721828(B_Email_1.__ST73390_Layout __EE2669619, __ST2707016_Layout __EE2721822) := __EEQP(__EE2669619.UID,__EE2721822.UID);
  __ST2712512_Layout __JT2721828(B_Email_1.__ST73390_Layout __l, __ST2707016_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2721829 := JOIN(__EE2669619,__EE2721822,__JC2721828(LEFT,RIGHT),__JT2721828(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2651573 := __ENH_Customer_1;
  SHARED __ST2712917_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2721898(__ST2712512_Layout __EE2721829, B_Customer_1.__ST72603_Layout __EE2651573) := __EEQP(__EE2721829._r_Customer_,__EE2651573.UID);
  __ST2712917_Layout __JT2721898(__ST2712512_Layout __l, B_Customer_1.__ST72603_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2721899 := JOIN(__EE2721829,__EE2651573,__JC2721898(LEFT,RIGHT),__JT2721898(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST49773_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST49773_Layout __ND2722297__Project(__ST2712917_Layout __PP2721900) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2721900.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP2721900.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2721900.M_I_N___Event_Date__2_;
    __BS2722140 := __T(__PP2721900.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2722140(__T(__OP2(__T(__PP2721900.Source_Customers_)._r_Source_Customer_,=,__PP2721900._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP2721900.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2721900.Email_Address_;
    SELF.Last_Event_Date_ := __PP2721900.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP2721900.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP2721900.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2721900.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2721900.Source_Customers_);
    SELF := __PP2721900;
  END;
  EXPORT __ENH_Email := PROJECT(__EE2721899,__ND2722297__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE4415637 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4415637._r_Customer_;
    __EE4415637.Source_Customers_;
    __EE4415637.Email_Address_;
    __EE4415637.Otto_Email_Id_;
    __EE4415637.Details_;
    __EE4415637.Email_Last_Domain_;
    __EE4415637._isdisposableemail_;
    __EE4415637.Aot_Act_Cnt_Ev_;
    __EE4415637.Aot_Src1_Act_Cnt_Ev_;
    __EE4415637.Aot_Src1_Act_Only_Flag_;
    __EE4415637.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE4415637.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE4415637.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE4415637.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE4415637.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4415637.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4415637.Aot_Id_Act_Cnt_Ev_;
    __EE4415637.Aot_Id_Act_Cnt30_D_;
    __EE4415637.Aot_Add_Act_Cnt_Ev_;
    __EE4415637.Aot_Add_Act_Cnt30_D_;
    __EE4415637.Aot_Non_St_Act_Cnt_Ev_;
    __EE4415637.Aot_Non_St_Act_Cnt30_D_;
    __EE4415637.Aot_Eml_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4415637.Aot_Eml_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4415637.Aot_Eml_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4415637.Aot_Id_Curr_Prof_Usng_Eml_Cnt_Ev_;
    __EE4415637.Aot_Id_Hist_Prof_Usng_Eml_Cnt_Ev_;
    __EE4415637.Aot_Id_Usng_Email_Cnt_Ev_;
    __EE4415637.Customer_Id_;
    __EE4415637.Industry_Type_;
    __EE4415637.Source_Customer_Count_;
    __EE4415637.Entity_Context_Uid_;
    __EE4415637.Entity_Type_;
    __EE4415637.Label_;
    __EE4415637.In_Customer_Population_;
    __EE4415637.Dt_First_Seen_;
    __EE4415637.Dt_Last_Seen_;
    __EE4415637.Id_Activity_Dt_First_Seen_;
    __EE4415637.Id_Activity_Dt_Last_Seen_;
    __EE4415637.Last_Record_Id_;
    __EE4415637.Identity_Count_;
    __EE4415637.Identity_Count_Gt2_;
    __EE4415637.Event_Count_;
    __EE4415637.Not_Safe_Last_Domain_Gt2_;
    __EE4415637.Kr_High_Risk_Flag_;
    __EE4415637.Kr_Medium_Risk_Flag_;
    __EE4415637.Kr_Low_Risk_Flag_;
    __EE4415637.Kr_Flag_;
    __EE4415637.Safe_Flag_;
    __EE4415637.Contributor_Safe_Flag_;
    __EE4415637.Last_Event_Date_;
    __EE4415637.Kr_Last_Event_Date_;
    __EE4415637.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4415637.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4415637.Kr_Eml500_Flag_;
    __EE4415637.Kr_Eml501_Flag_;
    __EE4415637.Kr_Eml502_Flag_;
    __EE4415637.Kr_Eml590_Flag_;
    __EE4415637.Kr_Eml591_Flag_;
    __EE4415637.Kr_Eml592_Flag_;
    __EE4415637.Kr_Eml593_Flag_;
    __EE4415637.Date_First_Seen_;
    __EE4415637.Date_Last_Seen_;
    __EE4415637.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE4415637,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4415639_Layout := RECORDOF(IDX_Email_UID);
