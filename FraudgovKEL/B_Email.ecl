...
EXPORT B_Email := MODULE
  ...
  SHARED __EE1661447 := __ENH_Email_1;
  SHARED __EE1665165 := __ENH_Event_1;
  SHARED __EE1665163 := __E_Email_Event;
  SHARED __EE1705107 := __EE1665163(__NN(__EE1665163.Emailof_) AND __NN(__EE1665163.Transaction_));
  SHARED __ST1697390_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1705125(B_Event_1.__ST53380_Layout __EE1665165, E_Email_Event.Layout __EE1705107) := __EEQP(__EE1705107.Transaction_,__EE1665165.UID);
  __ST1697390_Layout __JT1705125(B_Event_1.__ST53380_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1705126 := JOIN(__EE1705107,__EE1665165,__JC1705125(RIGHT,LEFT),__JT1705125(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1694428_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1694428_Layout __ND1705700__Project(__ST1697390_Layout __PP1705127) := TRANSFORM
    SELF.UID := __PP1705127.Emailof_;
    SELF._r_Customer_ := __PP1705127._r_Customer__1_;
    SELF.Event_Date_ := __PP1705127.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1705127.UID;
    SELF.Event_Date__1_ := __PP1705127.Event_Date_;
    SELF._r_Customer__1_ := __PP1705127._r_Customer_;
    SELF := __PP1705127;
  END;
  SHARED __EE1707957 := PROJECT(__EE1705126,__ND1705700__Project(LEFT));
  SHARED __ST1695625_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1695625_Layout __ND1708590__Project(__ST1694428_Layout __PP1707958) := TRANSFORM
    SELF.Exp1_ := __PP1707958.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1707958.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP1707958.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP1707958.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP1707958.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP1707958.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP1707958.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP1707958.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP1707958.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP1707958.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP1707958.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP1707958.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1707958.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1707958.Event_Age_,<,__CN(2)),__CN(__PP1707958.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1707958.Event_Age_,<,__CN(366));
    SELF := __PP1707958;
  END;
  SHARED __EE1708615 := PROJECT(__EE1707957,__ND1708590__Project(LEFT));
  SHARED __ST1695718_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1708714 := PROJECT(__CLEANANDDO(__EE1708615,TABLE(__EE1708615,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1708615.Exp1_),KEL.Aggregates.MinNG(__EE1708615.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1708615.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1708615.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1708615.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1708615.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1708615.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1708615.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1708615.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1708615.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1708615.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1708615.Exp11_),KEL.Aggregates.MaxNG(__EE1708615.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1708615.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1708615.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1708615.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1708615.Exp15_)),UID},UID,MERGE)),__ST1695718_Layout);
  SHARED __ST1700233_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1708720(B_Email_1.__ST48287_Layout __EE1661447, __ST1695718_Layout __EE1708714) := __EEQP(__EE1661447.UID,__EE1708714.UID);
  __ST1700233_Layout __JT1708720(B_Email_1.__ST48287_Layout __l, __ST1695718_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1708776 := JOIN(__EE1661447,__EE1708714,__JC1708720(LEFT,RIGHT),__JT1708720(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1650818 := __ENH_Customer_1;
  SHARED __ST1700616_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1708782(__ST1700233_Layout __EE1708776, B_Customer_1.__ST47785_Layout __EE1650818) := __EEQP(__EE1708776._r_Customer_,__EE1650818.UID);
  __ST1700616_Layout __JT1708782(__ST1700233_Layout __l, B_Customer_1.__ST47785_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1708860 := JOIN(__EE1708776,__EE1650818,__JC1708782(LEFT,RIGHT),__JT1708782(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST33737_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33737_Layout __ND1708865__Project(__ST1700616_Layout __PP1708861) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1708861.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP1708861.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS1708977 := __T(__PP1708861.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1708977(__T(__OP2(__T(__PP1708861.Source_Customers_)._r_Source_Customer_,=,__PP1708861._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1708861.Email_Address_;
    SELF.Last_Event_Date_ := __PP1708861.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP1708861.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP1708861.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1708861.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1708861.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1708861.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1708861.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1708861.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1708861.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1708861.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1708861.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1708861.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1708861;
  END;
  EXPORT __ENH_Email := PROJECT(__EE1708860,__ND1708865__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE2523928 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2523928._r_Customer_;
    __EE2523928.Source_Customers_;
    __EE2523928.Email_Address_;
    __EE2523928.Otto_Email_Id_;
    __EE2523928.Details_;
    __EE2523928.Email_Last_Domain_;
    __EE2523928._isdisposableemail_;
    __EE2523928.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE2523928.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE2523928.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE2523928.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE2523928.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2523928.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2523928.Customer_Id_;
    __EE2523928.Industry_Type_;
    __EE2523928.Source_Customer_Count_;
    __EE2523928.Entity_Context_Uid_;
    __EE2523928.Entity_Type_;
    __EE2523928.Label_;
    __EE2523928.In_Customer_Population_;
    __EE2523928.Dt_First_Seen_;
    __EE2523928.Dt_Last_Seen_;
    __EE2523928.Last_Record_Id_;
    __EE2523928.Identity_Count_;
    __EE2523928.Identity_Count_Gt2_;
    __EE2523928.Event_Count_;
    __EE2523928.Not_Safe_Last_Domain_Gt2_;
    __EE2523928.Kr_High_Risk_Flag_;
    __EE2523928.Kr_Medium_Risk_Flag_;
    __EE2523928.Kr_Low_Risk_Flag_;
    __EE2523928.Kr_Flag_;
    __EE2523928.Safe_Flag_;
    __EE2523928.Contributor_Safe_Flag_;
    __EE2523928.Last_Event_Date_;
    __EE2523928.Kr_Last_Event_Date_;
    __EE2523928.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2523928.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2523928.Kr_Eml500_Flag_;
    __EE2523928.Kr_Eml501_Flag_;
    __EE2523928.Kr_Eml502_Flag_;
    __EE2523928.Kr_Eml590_Flag_;
    __EE2523928.Kr_Eml591_Flag_;
    __EE2523928.Kr_Eml592_Flag_;
    __EE2523928.Kr_Eml593_Flag_;
    __EE2523928.Vl_Event1_All_Count_;
    __EE2523928.Vl_Event7_All_Count_;
    __EE2523928.Vl_Event30_All_Day_Count_;
    __EE2523928.Vl_Event365_All_Day_Count_;
    __EE2523928.Vl_Event7_All_Active_Flag_;
    __EE2523928.Vl_Event30_All_Active_Flag_;
    __EE2523928.Vl_Event1_Count_;
    __EE2523928.Vl_Event7_Count_;
    __EE2523928.Vl_Event30_Count_;
    __EE2523928.Vl_Event365_Count_;
    __EE2523928.Vl_Event7_Active_Flag_;
    __EE2523928.Vl_Event30_Active_Flag_;
    __EE2523928.Date_First_Seen_;
    __EE2523928.Date_Last_Seen_;
    __EE2523928.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE2523928,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2523930_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST33737_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
