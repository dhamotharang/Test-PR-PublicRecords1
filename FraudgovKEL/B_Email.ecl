...
EXPORT B_Email := MODULE
  ...
  SHARED __EE1522388 := __ENH_Email_1;
  SHARED __EE1525896 := __ENH_Event_1;
  SHARED __EE1525894 := __E_Email_Event;
  SHARED __EE1563108 := __EE1525894(__NN(__EE1525894.Emailof_) AND __NN(__EE1525894.Transaction_));
  SHARED __ST1555811_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1563126(B_Event_1.__ST52980_Layout __EE1525896, E_Email_Event.Layout __EE1563108) := __EEQP(__EE1563108.Transaction_,__EE1525896.UID);
  __ST1555811_Layout __JT1563126(B_Event_1.__ST52980_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1563127 := JOIN(__EE1563108,__EE1525896,__JC1563126(RIGHT,LEFT),__JT1563126(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1553017_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1553017_Layout __ND1563659__Project(__ST1555811_Layout __PP1563128) := TRANSFORM
    SELF.UID := __PP1563128.Emailof_;
    SELF._r_Customer_ := __PP1563128._r_Customer__1_;
    SELF.Event_Date_ := __PP1563128.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1563128.UID;
    SELF.Event_Date__1_ := __PP1563128.Event_Date_;
    SELF._r_Customer__1_ := __PP1563128._r_Customer_;
    SELF := __PP1563128;
  END;
  SHARED __EE1565748 := PROJECT(__EE1563127,__ND1563659__Project(LEFT));
  SHARED __ST1554130_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1554130_Layout __ND1566381__Project(__ST1553017_Layout __PP1565749) := TRANSFORM
    SELF.Exp1_ := __PP1565749.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1565749.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP1565749.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP1565749.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP1565749.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP1565749.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP1565749.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP1565749.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP1565749.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP1565749.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP1565749.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP1565749.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1565749.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1565749.Event_Age_,<,__CN(2)),__CN(__PP1565749.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1565749.Event_Age_,<,__CN(366));
    SELF := __PP1565749;
  END;
  SHARED __EE1566406 := PROJECT(__EE1565748,__ND1566381__Project(LEFT));
  SHARED __ST1554223_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1566505 := PROJECT(__CLEANANDDO(__EE1566406,TABLE(__EE1566406,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1566406.Exp1_),KEL.Aggregates.MinNG(__EE1566406.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1566406.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1566406.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1566406.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1566406.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1566406.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1566406.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1566406.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1566406.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1566406.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1566406.Exp11_),KEL.Aggregates.MaxNG(__EE1566406.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1566406.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1566406.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1566406.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1566406.Exp15_)),UID},UID,MERGE)),__ST1554223_Layout);
  SHARED __ST1558444_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1566511(B_Email_1.__ST47929_Layout __EE1522388, __ST1554223_Layout __EE1566505) := __EEQP(__EE1522388.UID,__EE1566505.UID);
  __ST1558444_Layout __JT1566511(B_Email_1.__ST47929_Layout __l, __ST1554223_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1566567 := JOIN(__EE1522388,__EE1566505,__JC1566511(LEFT,RIGHT),__JT1566511(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1512431 := __ENH_Customer_1;
  SHARED __ST1558827_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1566573(__ST1558444_Layout __EE1566567, B_Customer_1.__ST47427_Layout __EE1512431) := __EEQP(__EE1566567._r_Customer_,__EE1512431.UID);
  __ST1558827_Layout __JT1566573(__ST1558444_Layout __l, B_Customer_1.__ST47427_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1566651 := JOIN(__EE1566567,__EE1512431,__JC1566573(LEFT,RIGHT),__JT1566573(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST33506_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33506_Layout __ND1566656__Project(__ST1558827_Layout __PP1566652) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1566652.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP1566652.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS1566768 := __T(__PP1566652.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1566768(__T(__OP2(__T(__PP1566652.Source_Customers_)._r_Source_Customer_,=,__PP1566652._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1566652.Email_Address_;
    SELF.Last_Event_Date_ := __PP1566652.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP1566652.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP1566652.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1566652.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1566652.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1566652.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1566652.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1566652.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1566652.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1566652.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1566652.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1566652.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1566652;
  END;
  EXPORT __ENH_Email := PROJECT(__EE1566651,__ND1566656__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE2342271 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2342271._r_Customer_;
    __EE2342271.Source_Customers_;
    __EE2342271.Email_Address_;
    __EE2342271.Otto_Email_Id_;
    __EE2342271.Details_;
    __EE2342271.Email_Last_Domain_;
    __EE2342271._isdisposableemail_;
    __EE2342271.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE2342271.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE2342271.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE2342271.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE2342271.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2342271.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2342271.Customer_Id_;
    __EE2342271.Industry_Type_;
    __EE2342271.Source_Customer_Count_;
    __EE2342271.Entity_Context_Uid_;
    __EE2342271.Entity_Type_;
    __EE2342271.Label_;
    __EE2342271.In_Customer_Population_;
    __EE2342271.Dt_First_Seen_;
    __EE2342271.Dt_Last_Seen_;
    __EE2342271.Last_Record_Id_;
    __EE2342271.Identity_Count_;
    __EE2342271.Identity_Count_Gt2_;
    __EE2342271.Event_Count_;
    __EE2342271.Not_Safe_Last_Domain_Gt2_;
    __EE2342271.Kr_High_Risk_Flag_;
    __EE2342271.Kr_Medium_Risk_Flag_;
    __EE2342271.Kr_Low_Risk_Flag_;
    __EE2342271.Kr_Flag_;
    __EE2342271.Safe_Flag_;
    __EE2342271.Contributor_Safe_Flag_;
    __EE2342271.Last_Event_Date_;
    __EE2342271.Kr_Last_Event_Date_;
    __EE2342271.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2342271.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2342271.Kr_Eml500_Flag_;
    __EE2342271.Kr_Eml501_Flag_;
    __EE2342271.Kr_Eml502_Flag_;
    __EE2342271.Kr_Eml590_Flag_;
    __EE2342271.Kr_Eml591_Flag_;
    __EE2342271.Kr_Eml592_Flag_;
    __EE2342271.Kr_Eml593_Flag_;
    __EE2342271.Vl_Event1_All_Count_;
    __EE2342271.Vl_Event7_All_Count_;
    __EE2342271.Vl_Event30_All_Day_Count_;
    __EE2342271.Vl_Event365_All_Day_Count_;
    __EE2342271.Vl_Event7_All_Active_Flag_;
    __EE2342271.Vl_Event30_All_Active_Flag_;
    __EE2342271.Vl_Event1_Count_;
    __EE2342271.Vl_Event7_Count_;
    __EE2342271.Vl_Event30_Count_;
    __EE2342271.Vl_Event365_Count_;
    __EE2342271.Vl_Event7_Active_Flag_;
    __EE2342271.Vl_Event30_Active_Flag_;
    __EE2342271.Date_First_Seen_;
    __EE2342271.Date_Last_Seen_;
    __EE2342271.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE2342271,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2342273_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST33506_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
