...
EXPORT B_Email := MODULE
  ...
  SHARED __EE1721003 := __ENH_Email_1;
  SHARED __EE1724811 := __ENH_Event_1;
  SHARED __EE1724809 := __E_Email_Event;
  SHARED __EE1765923 := __EE1724809(__NN(__EE1724809.Emailof_) AND __NN(__EE1724809.Transaction_));
  SHARED __ST1758026_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1765941(B_Event_1.__ST53475_Layout __EE1724811, E_Email_Event.Layout __EE1765923) := __EEQP(__EE1765923.Transaction_,__EE1724811.UID);
  __ST1758026_Layout __JT1765941(B_Event_1.__ST53475_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1765942 := JOIN(__EE1765923,__EE1724811,__JC1765941(RIGHT,LEFT),__JT1765941(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1754992_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1754992_Layout __ND1766534__Project(__ST1758026_Layout __PP1765943) := TRANSFORM
    SELF.UID := __PP1765943.Emailof_;
    SELF._r_Customer_ := __PP1765943._r_Customer__1_;
    SELF.Event_Date_ := __PP1765943.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1765943.UID;
    SELF.Event_Date__1_ := __PP1765943.Event_Date_;
    SELF._r_Customer__1_ := __PP1765943._r_Customer_;
    SELF := __PP1765943;
  END;
  SHARED __EE1768863 := PROJECT(__EE1765942,__ND1766534__Project(LEFT));
  SHARED __ST1756225_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1756225_Layout __ND1769496__Project(__ST1754992_Layout __PP1768864) := TRANSFORM
    SELF.Exp1_ := __PP1768864.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1768864.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP1768864.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP1768864.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP1768864.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP1768864.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP1768864.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP1768864.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP1768864.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP1768864.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP1768864.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP1768864.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1768864.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1768864.Event_Age_,<,__CN(2)),__CN(__PP1768864.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1768864.Event_Age_,<,__CN(366));
    SELF := __PP1768864;
  END;
  SHARED __EE1769521 := PROJECT(__EE1768863,__ND1769496__Project(LEFT));
  SHARED __ST1756318_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1769620 := PROJECT(__CLEANANDDO(__EE1769521,TABLE(__EE1769521,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1769521.Exp1_),KEL.Aggregates.MinNG(__EE1769521.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1769521.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1769521.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1769521.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1769521.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1769521.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1769521.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1769521.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1769521.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1769521.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1769521.Exp11_),KEL.Aggregates.MaxNG(__EE1769521.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1769521.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1769521.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1769521.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1769521.Exp15_)),UID},UID,MERGE)),__ST1756318_Layout);
  SHARED __ST1760959_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1769626(B_Email_1.__ST48364_Layout __EE1721003, __ST1756318_Layout __EE1769620) := __EEQP(__EE1721003.UID,__EE1769620.UID);
  __ST1760959_Layout __JT1769626(B_Email_1.__ST48364_Layout __l, __ST1756318_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1769682 := JOIN(__EE1721003,__EE1769620,__JC1769626(LEFT,RIGHT),__JT1769626(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1710086 := __ENH_Customer_1;
  SHARED __ST1761342_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1769688(__ST1760959_Layout __EE1769682, B_Customer_1.__ST47862_Layout __EE1710086) := __EEQP(__EE1769682._r_Customer_,__EE1710086.UID);
  __ST1761342_Layout __JT1769688(__ST1760959_Layout __l, B_Customer_1.__ST47862_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1769766 := JOIN(__EE1769682,__EE1710086,__JC1769688(LEFT,RIGHT),__JT1769688(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST33778_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33778_Layout __ND1769771__Project(__ST1761342_Layout __PP1769767) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1769767.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP1769767.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS1769883 := __T(__PP1769767.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1769883(__T(__OP2(__T(__PP1769767.Source_Customers_)._r_Source_Customer_,=,__PP1769767._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1769767.Email_Address_;
    SELF.Last_Event_Date_ := __PP1769767.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP1769767.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP1769767.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1769767.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1769767.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1769767.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1769767.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1769767.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1769767.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1769767.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1769767.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1769767.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1769767;
  END;
  EXPORT __ENH_Email := PROJECT(__EE1769766,__ND1769771__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE2599710 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2599710._r_Customer_;
    __EE2599710.Source_Customers_;
    __EE2599710.Email_Address_;
    __EE2599710.Otto_Email_Id_;
    __EE2599710.Details_;
    __EE2599710.Email_Last_Domain_;
    __EE2599710._isdisposableemail_;
    __EE2599710.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE2599710.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE2599710.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE2599710.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE2599710.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2599710.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2599710.Customer_Id_;
    __EE2599710.Industry_Type_;
    __EE2599710.Source_Customer_Count_;
    __EE2599710.Entity_Context_Uid_;
    __EE2599710.Entity_Type_;
    __EE2599710.Label_;
    __EE2599710.In_Customer_Population_;
    __EE2599710.Dt_First_Seen_;
    __EE2599710.Dt_Last_Seen_;
    __EE2599710.Last_Record_Id_;
    __EE2599710.Identity_Count_;
    __EE2599710.Identity_Count_Gt2_;
    __EE2599710.Event_Count_;
    __EE2599710.Not_Safe_Last_Domain_Gt2_;
    __EE2599710.Kr_High_Risk_Flag_;
    __EE2599710.Kr_Medium_Risk_Flag_;
    __EE2599710.Kr_Low_Risk_Flag_;
    __EE2599710.Kr_Flag_;
    __EE2599710.Safe_Flag_;
    __EE2599710.Contributor_Safe_Flag_;
    __EE2599710.Last_Event_Date_;
    __EE2599710.Kr_Last_Event_Date_;
    __EE2599710.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2599710.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2599710.Kr_Eml500_Flag_;
    __EE2599710.Kr_Eml501_Flag_;
    __EE2599710.Kr_Eml502_Flag_;
    __EE2599710.Kr_Eml590_Flag_;
    __EE2599710.Kr_Eml591_Flag_;
    __EE2599710.Kr_Eml592_Flag_;
    __EE2599710.Kr_Eml593_Flag_;
    __EE2599710.Vl_Event1_All_Count_;
    __EE2599710.Vl_Event7_All_Count_;
    __EE2599710.Vl_Event30_All_Day_Count_;
    __EE2599710.Vl_Event365_All_Day_Count_;
    __EE2599710.Vl_Event7_All_Active_Flag_;
    __EE2599710.Vl_Event30_All_Active_Flag_;
    __EE2599710.Vl_Event1_Count_;
    __EE2599710.Vl_Event7_Count_;
    __EE2599710.Vl_Event30_Count_;
    __EE2599710.Vl_Event365_Count_;
    __EE2599710.Vl_Event7_Active_Flag_;
    __EE2599710.Vl_Event30_Active_Flag_;
    __EE2599710.Date_First_Seen_;
    __EE2599710.Date_Last_Seen_;
    __EE2599710.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE2599710,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2599712_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST33778_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
