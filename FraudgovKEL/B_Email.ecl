...
EXPORT B_Email := MODULE
  ...
  SHARED __EE2542955 := __ENH_Email_1;
  SHARED __EE2547377 := __ENH_Event_1;
  SHARED __EE2547375 := __E_Email_Event;
  SHARED __EE2597374 := __EE2547375(__NN(__EE2547375.Emailof_) AND __NN(__EE2547375.Transaction_));
  SHARED __ST2588175_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2597392(B_Event_1.__ST76927_Layout __EE2547377, E_Email_Event.Layout __EE2597374) := __EEQP(__EE2597374.Transaction_,__EE2547377.UID);
  __ST2588175_Layout __JT2597392(B_Event_1.__ST76927_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2597393 := JOIN(__EE2597374,__EE2547377,__JC2597392(RIGHT,LEFT),__JT2597392(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2584687_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2584687_Layout __ND2598084__Project(__ST2588175_Layout __PP2597394) := TRANSFORM
    SELF.UID := __PP2597394.Emailof_;
    SELF._r_Customer_ := __PP2597394._r_Customer__1_;
    SELF.Event_Date_ := __PP2597394.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2597394.UID;
    SELF.Event_Date__1_ := __PP2597394.Event_Date_;
    SELF._r_Customer__1_ := __PP2597394._r_Customer_;
    SELF := __PP2597394;
  END;
  SHARED __EE2600809 := PROJECT(__EE2597393,__ND2598084__Project(LEFT));
  SHARED __ST2586124_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2586124_Layout __ND2601539__Project(__ST2584687_Layout __PP2600810) := TRANSFORM
    SELF.Exp1_ := __PP2600810.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2600810.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2600810.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2600810.Kr_Eml500_Flag_ = 1;
    SELF.Exp4_ := __PP2600810.Kr_Eml501_Flag_ = 1;
    SELF.Exp5_ := __PP2600810.Kr_Eml502_Flag_ = 1;
    SELF.Exp6_ := __PP2600810.Kr_Eml590_Flag_ = 1;
    SELF.Exp7_ := __PP2600810.Kr_Eml591_Flag_ = 1;
    SELF.Exp8_ := __PP2600810.Kr_Eml592_Flag_ = 1;
    SELF.Exp9_ := __PP2600810.Kr_Eml593_Flag_ = 1;
    SELF.Exp10_ := __PP2600810.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP2600810.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP2600810.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp13_ := __PP2600810.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2600810.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2600810.Event_Age_,<,__CN(2)),__CN(__PP2600810.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2600810.Event_Age_,<,__CN(366));
    SELF := __PP2600810;
  END;
  SHARED __EE2601565 := PROJECT(__EE2600809,__ND2601539__Project(LEFT));
  SHARED __ST2586222_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2601669 := PROJECT(__CLEANANDDO(__EE2601565,TABLE(__EE2601565,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2601565.Exp1_),KEL.Aggregates.MinNG(__EE2601565.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2601565.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2601565.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2601565.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2601565.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2601565.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2601565.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2601565.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2601565.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2601565.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2601565.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2601565.Exp12_),KEL.Aggregates.MaxNG(__EE2601565.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2601565.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2601565.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2601565.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2601565.Exp16_)),UID},UID,MERGE)),__ST2586222_Layout);
  SHARED __ST2591603_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2601675(B_Email_1.__ST69787_Layout __EE2542955, __ST2586222_Layout __EE2601669) := __EEQP(__EE2542955.UID,__EE2601669.UID);
  __ST2591603_Layout __JT2601675(B_Email_1.__ST69787_Layout __l, __ST2586222_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2601745 := JOIN(__EE2542955,__EE2601669,__JC2601675(LEFT,RIGHT),__JT2601675(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2524923 := __ENH_Customer_1;
  SHARED __ST2592056_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2601751(__ST2591603_Layout __EE2601745, B_Customer_1.__ST68903_Layout __EE2524923) := __EEQP(__EE2601745._r_Customer_,__EE2524923.UID);
  __ST2592056_Layout __JT2601751(__ST2591603_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2601843 := JOIN(__EE2601745,__EE2524923,__JC2601751(LEFT,RIGHT),__JT2601751(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST47824_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47824_Layout __ND2601848__Project(__ST2592056_Layout __PP2601844) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2601844.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP2601844.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2601844.M_I_N___Event_Date__2_;
    __BS2602002 := __T(__PP2601844.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2602002(__T(__OP2(__T(__PP2601844.Source_Customers_)._r_Source_Customer_,=,__PP2601844._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2601844.Email_Address_;
    SELF.Last_Event_Date_ := __PP2601844.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP2601844.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP2601844.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2601844.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2601844.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2601844.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2601844.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2601844.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2601844.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2601844.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2601844.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2601844.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2601844;
  END;
  EXPORT __ENH_Email := PROJECT(__EE2601843,__ND2601848__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE4093627 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4093627._r_Customer_;
    __EE4093627.Source_Customers_;
    __EE4093627.Email_Address_;
    __EE4093627.Otto_Email_Id_;
    __EE4093627.Details_;
    __EE4093627.Email_Last_Domain_;
    __EE4093627._isdisposableemail_;
    __EE4093627.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE4093627.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE4093627.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE4093627.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE4093627.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4093627.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4093627.Aot_Id_Act_Cnt_Ev_;
    __EE4093627.Aot_Id_Act_Cnt30_D_;
    __EE4093627.Aot_Add_Act_Cnt_Ev_;
    __EE4093627.Aot_Add_Act_Cnt30_D_;
    __EE4093627.Aot_Non_St_Act_Cnt_Ev_;
    __EE4093627.Aot_Non_St_Act_Cnt30_D_;
    __EE4093627.Aot_Eml_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4093627.Aot_Eml_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4093627.Aot_Eml_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4093627.Aot_Id_Curr_Prof_Usng_Eml_Cnt_Ev_;
    __EE4093627.Aot_Id_Hist_Prof_Usng_Eml_Cnt_Ev_;
    __EE4093627.Aot_Id_Usng_Email_Cnt_Ev_;
    __EE4093627.Customer_Id_;
    __EE4093627.Industry_Type_;
    __EE4093627.Source_Customer_Count_;
    __EE4093627.Entity_Context_Uid_;
    __EE4093627.Entity_Type_;
    __EE4093627.Label_;
    __EE4093627.In_Customer_Population_;
    __EE4093627.Dt_First_Seen_;
    __EE4093627.Dt_Last_Seen_;
    __EE4093627.Id_Activity_Dt_First_Seen_;
    __EE4093627.Id_Activity_Dt_Last_Seen_;
    __EE4093627.Last_Record_Id_;
    __EE4093627.Identity_Count_;
    __EE4093627.Identity_Count_Gt2_;
    __EE4093627.Event_Count_;
    __EE4093627.Not_Safe_Last_Domain_Gt2_;
    __EE4093627.Kr_High_Risk_Flag_;
    __EE4093627.Kr_Medium_Risk_Flag_;
    __EE4093627.Kr_Low_Risk_Flag_;
    __EE4093627.Kr_Flag_;
    __EE4093627.Safe_Flag_;
    __EE4093627.Contributor_Safe_Flag_;
    __EE4093627.Last_Event_Date_;
    __EE4093627.Kr_Last_Event_Date_;
    __EE4093627.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4093627.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4093627.Kr_Eml500_Flag_;
    __EE4093627.Kr_Eml501_Flag_;
    __EE4093627.Kr_Eml502_Flag_;
    __EE4093627.Kr_Eml590_Flag_;
    __EE4093627.Kr_Eml591_Flag_;
    __EE4093627.Kr_Eml592_Flag_;
    __EE4093627.Kr_Eml593_Flag_;
    __EE4093627.Vl_Event1_All_Count_;
    __EE4093627.Vl_Event7_All_Count_;
    __EE4093627.Vl_Event30_All_Day_Count_;
    __EE4093627.Vl_Event365_All_Day_Count_;
    __EE4093627.Vl_Event7_All_Active_Flag_;
    __EE4093627.Vl_Event30_All_Active_Flag_;
    __EE4093627.Vl_Event1_Count_;
    __EE4093627.Vl_Event7_Count_;
    __EE4093627.Vl_Event30_Count_;
    __EE4093627.Vl_Event365_Count_;
    __EE4093627.Vl_Event7_Active_Flag_;
    __EE4093627.Vl_Event30_Active_Flag_;
    __EE4093627.Date_First_Seen_;
    __EE4093627.Date_Last_Seen_;
    __EE4093627.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE4093627,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4093629_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST47824_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
