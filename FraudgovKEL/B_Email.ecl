...
EXPORT B_Email := MODULE
  ...
  SHARED __EE2321310 := __ENH_Email_1;
  SHARED __EE2325567 := __ENH_Event_1;
  SHARED __EE2325565 := __E_Email_Event;
  SHARED __EE2371688 := __EE2325565(__NN(__EE2325565.Emailof_) AND __NN(__EE2325565.Transaction_));
  SHARED __ST2362821_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2371706(B_Event_1.__ST73836_Layout __EE2325567, E_Email_Event.Layout __EE2371688) := __EEQP(__EE2371688.Transaction_,__EE2325567.UID);
  __ST2362821_Layout __JT2371706(B_Event_1.__ST73836_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2371707 := JOIN(__EE2371688,__EE2325567,__JC2371706(RIGHT,LEFT),__JT2371706(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2359471_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2359471_Layout __ND2372372__Project(__ST2362821_Layout __PP2371708) := TRANSFORM
    SELF.UID := __PP2371708.Emailof_;
    SELF._r_Customer_ := __PP2371708._r_Customer__1_;
    SELF.Event_Date_ := __PP2371708.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2371708.UID;
    SELF.Event_Date__1_ := __PP2371708.Event_Date_;
    SELF._r_Customer__1_ := __PP2371708._r_Customer_;
    SELF := __PP2371708;
  END;
  SHARED __EE2374993 := PROJECT(__EE2371707,__ND2372372__Project(LEFT));
  SHARED __ST2360850_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2360850_Layout __ND2375698__Project(__ST2359471_Layout __PP2374994) := TRANSFORM
    SELF.Exp1_ := __PP2374994.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2374994.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP2374994.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP2374994.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP2374994.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP2374994.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP2374994.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP2374994.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP2374994.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP2374994.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP2374994.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP2374994.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP2374994.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP2374994.Event_Age_,<,__CN(2)),__CN(__PP2374994.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP2374994.Event_Age_,<,__CN(366));
    SELF := __PP2374994;
  END;
  SHARED __EE2375723 := PROJECT(__EE2374993,__ND2375698__Project(LEFT));
  SHARED __ST2360943_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2375822 := PROJECT(__CLEANANDDO(__EE2375723,TABLE(__EE2375723,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2375723.Exp1_),KEL.Aggregates.MinNG(__EE2375723.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2375723.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2375723.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2375723.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2375723.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2375723.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2375723.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2375723.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2375723.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2375723.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2375723.Exp11_),KEL.Aggregates.MaxNG(__EE2375723.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2375723.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2375723.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2375723.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2375723.Exp15_)),UID},UID,MERGE)),__ST2360943_Layout);
  SHARED __ST2366119_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2375828(B_Email_1.__ST67089_Layout __EE2321310, __ST2360943_Layout __EE2375822) := __EEQP(__EE2321310.UID,__EE2375822.UID);
  __ST2366119_Layout __JT2375828(B_Email_1.__ST67089_Layout __l, __ST2360943_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2375896 := JOIN(__EE2321310,__EE2375822,__JC2375828(LEFT,RIGHT),__JT2375828(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2309213 := __ENH_Customer_1;
  SHARED __ST2366562_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2375902(__ST2366119_Layout __EE2375896, B_Customer_1.__ST66213_Layout __EE2309213) := __EEQP(__EE2375896._r_Customer_,__EE2309213.UID);
  __ST2366562_Layout __JT2375902(__ST2366119_Layout __l, B_Customer_1.__ST66213_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2375992 := JOIN(__EE2375896,__EE2309213,__JC2375902(LEFT,RIGHT),__JT2375902(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST46101_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST46101_Layout __ND2375997__Project(__ST2366562_Layout __PP2375993) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2375993.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP2375993.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS2376145 := __T(__PP2375993.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2376145(__T(__OP2(__T(__PP2375993.Source_Customers_)._r_Source_Customer_,=,__PP2375993._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2375993.Email_Address_;
    SELF.Last_Event_Date_ := __PP2375993.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP2375993.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP2375993.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2375993.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2375993.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2375993.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2375993.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2375993.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2375993.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2375993.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2375993.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2375993.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2375993;
  END;
  EXPORT __ENH_Email := PROJECT(__EE2375992,__ND2375997__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE3429492 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE3429492._r_Customer_;
    __EE3429492.Source_Customers_;
    __EE3429492.Email_Address_;
    __EE3429492.Otto_Email_Id_;
    __EE3429492.Details_;
    __EE3429492.Email_Last_Domain_;
    __EE3429492._isdisposableemail_;
    __EE3429492.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE3429492.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE3429492.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE3429492.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE3429492.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE3429492.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE3429492.Aot_Id_Act_Cnt_Ev_;
    __EE3429492.Aot_Id_Act_Cnt30_D_;
    __EE3429492.Aot_Add_Act_Cnt_Ev_;
    __EE3429492.Aot_Add_Act_Cnt30_D_;
    __EE3429492.Aot_Non_St_Act_Cnt_Ev_;
    __EE3429492.Aot_Non_St_Act_Cnt30_D_;
    __EE3429492.Aot_Eml_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE3429492.Aot_Eml_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE3429492.Aot_Eml_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE3429492.Aot_Id_Curr_Prof_Usng_Eml_Cnt_Ev_;
    __EE3429492.Aot_Id_Hist_Prof_Usng_Eml_Cnt_Ev_;
    __EE3429492.Aot_Id_Usng_Email_Cnt_Ev_;
    __EE3429492.Customer_Id_;
    __EE3429492.Industry_Type_;
    __EE3429492.Source_Customer_Count_;
    __EE3429492.Entity_Context_Uid_;
    __EE3429492.Entity_Type_;
    __EE3429492.Label_;
    __EE3429492.In_Customer_Population_;
    __EE3429492.Dt_First_Seen_;
    __EE3429492.Dt_Last_Seen_;
    __EE3429492.Last_Record_Id_;
    __EE3429492.Identity_Count_;
    __EE3429492.Identity_Count_Gt2_;
    __EE3429492.Event_Count_;
    __EE3429492.Not_Safe_Last_Domain_Gt2_;
    __EE3429492.Kr_High_Risk_Flag_;
    __EE3429492.Kr_Medium_Risk_Flag_;
    __EE3429492.Kr_Low_Risk_Flag_;
    __EE3429492.Kr_Flag_;
    __EE3429492.Safe_Flag_;
    __EE3429492.Contributor_Safe_Flag_;
    __EE3429492.Last_Event_Date_;
    __EE3429492.Kr_Last_Event_Date_;
    __EE3429492.Kr_Event_After_Last_Known_Risk_Count_;
    __EE3429492.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE3429492.Kr_Eml500_Flag_;
    __EE3429492.Kr_Eml501_Flag_;
    __EE3429492.Kr_Eml502_Flag_;
    __EE3429492.Kr_Eml590_Flag_;
    __EE3429492.Kr_Eml591_Flag_;
    __EE3429492.Kr_Eml592_Flag_;
    __EE3429492.Kr_Eml593_Flag_;
    __EE3429492.Vl_Event1_All_Count_;
    __EE3429492.Vl_Event7_All_Count_;
    __EE3429492.Vl_Event30_All_Day_Count_;
    __EE3429492.Vl_Event365_All_Day_Count_;
    __EE3429492.Vl_Event7_All_Active_Flag_;
    __EE3429492.Vl_Event30_All_Active_Flag_;
    __EE3429492.Vl_Event1_Count_;
    __EE3429492.Vl_Event7_Count_;
    __EE3429492.Vl_Event30_Count_;
    __EE3429492.Vl_Event365_Count_;
    __EE3429492.Vl_Event7_Active_Flag_;
    __EE3429492.Vl_Event30_Active_Flag_;
    __EE3429492.Date_First_Seen_;
    __EE3429492.Date_Last_Seen_;
    __EE3429492.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE3429492,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST3429494_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST46101_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
