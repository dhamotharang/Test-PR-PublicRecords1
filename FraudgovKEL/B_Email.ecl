...
EXPORT B_Email := MODULE
  ...
  SHARED __EE2640140 := __ENH_Email_1;
  SHARED __EE2644623 := __ENH_Event_1;
  SHARED __EE2644621 := __E_Email_Event;
  SHARED __EE2695230 := __EE2644621(__NN(__EE2644621.Emailof_) AND __NN(__EE2644621.Transaction_));
  SHARED __ST2685891_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2695248(B_Event_1.__ST78136_Layout __EE2644623, E_Email_Event.Layout __EE2695230) := __EEQP(__EE2695230.Transaction_,__EE2644623.UID);
  __ST2685891_Layout __JT2695248(B_Event_1.__ST78136_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2695249 := JOIN(__EE2695230,__EE2644623,__JC2695248(RIGHT,LEFT),__JT2695248(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2682365_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2682365_Layout __ND2695948__Project(__ST2685891_Layout __PP2695250) := TRANSFORM
    SELF.UID := __PP2695250.Emailof_;
    SELF._r_Customer_ := __PP2695250._r_Customer__1_;
    SELF.Event_Date_ := __PP2695250.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2695250.UID;
    SELF.Event_Date__1_ := __PP2695250.Event_Date_;
    SELF._r_Customer__1_ := __PP2695250._r_Customer_;
    SELF := __PP2695250;
  END;
  SHARED __EE2698705 := PROJECT(__EE2695249,__ND2695948__Project(LEFT));
  SHARED __ST2683818_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2683818_Layout __ND2699453__Project(__ST2682365_Layout __PP2698706) := TRANSFORM
    SELF.Exp1_ := __PP2698706.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2698706.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2698706.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2698706.Kr_Eml500_Flag_ = 1;
    SELF.Exp4_ := __PP2698706.Kr_Eml501_Flag_ = 1;
    SELF.Exp5_ := __PP2698706.Kr_Eml502_Flag_ = 1;
    SELF.Exp6_ := __PP2698706.Kr_Eml590_Flag_ = 1;
    SELF.Exp7_ := __PP2698706.Kr_Eml591_Flag_ = 1;
    SELF.Exp8_ := __PP2698706.Kr_Eml592_Flag_ = 1;
    SELF.Exp9_ := __PP2698706.Kr_Eml593_Flag_ = 1;
    SELF.Exp10_ := __PP2698706.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP2698706.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP2698706.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp13_ := __PP2698706.Safe_Flag_ = 1;
    SELF.Exp14_ := __OP2(__PP2698706.Event_Age_,<,__CN(2));
    SELF.Exp15_ := __AND(__OP2(__PP2698706.Event_Age_,<,__CN(2)),__CN(__PP2698706.In_Customer_Population_ = 1));
    SELF.Exp16_ := __OP2(__PP2698706.Event_Age_,<,__CN(366));
    SELF := __PP2698706;
  END;
  SHARED __EE2699479 := PROJECT(__EE2698705,__ND2699453__Project(LEFT));
  SHARED __ST2683916_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2699583 := PROJECT(__CLEANANDDO(__EE2699479,TABLE(__EE2699479,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2699479.Exp1_),KEL.Aggregates.MaxNG(__EE2699479.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE2699479.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2699479.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2699479.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2699479.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2699479.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2699479.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2699479.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2699479.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2699479.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2699479.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2699479.Exp12_),KEL.Aggregates.MaxNG(__EE2699479.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2699479.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE2699479.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE2699479.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2699479.Exp16_)),UID},UID,MERGE)),__ST2683916_Layout);
  SHARED __ST2689359_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2699589(B_Email_1.__ST70876_Layout __EE2640140, __ST2683916_Layout __EE2699583) := __EEQP(__EE2640140.UID,__EE2699583.UID);
  __ST2689359_Layout __JT2699589(B_Email_1.__ST70876_Layout __l, __ST2683916_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2699662 := JOIN(__EE2640140,__EE2699583,__JC2699589(LEFT,RIGHT),__JT2699589(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2621913 := __ENH_Customer_1;
  SHARED __ST2689827_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2699668(__ST2689359_Layout __EE2699662, B_Customer_1.__ST69954_Layout __EE2621913) := __EEQP(__EE2699662._r_Customer_,__EE2621913.UID);
  __ST2689827_Layout __JT2699668(__ST2689359_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2699763 := JOIN(__EE2699662,__EE2621913,__JC2699668(LEFT,RIGHT),__JT2699668(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST48568_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST48568_Layout __ND2699768__Project(__ST2689827_Layout __PP2699764) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP2699764.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP2699764.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2699764.M_I_N___Event_Date__1_;
    __BS2699931 := __T(__PP2699764.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2699931(__T(__OP2(__T(__PP2699764.Source_Customers_)._r_Source_Customer_,=,__PP2699764._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP2699764.Email_Address_;
    SELF.Last_Event_Date_ := __PP2699764.M_A_X___Event_Date__2_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP2699764.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP2699764.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP2699764.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2699764.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2699764.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP2699764.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2699764.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2699764.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2699764.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2699764.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2699764.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2699764;
  END;
  EXPORT __ENH_Email := PROJECT(__EE2699763,__ND2699768__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE4314219 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4314219._r_Customer_;
    __EE4314219.Source_Customers_;
    __EE4314219.Email_Address_;
    __EE4314219.Otto_Email_Id_;
    __EE4314219.Details_;
    __EE4314219.Email_Last_Domain_;
    __EE4314219._isdisposableemail_;
    __EE4314219.Aot_Act_Cnt_Ev_;
    __EE4314219.Aot_Src1_Act_Cnt_Ev_;
    __EE4314219.Aot_Src1_Act_Only_Flag_;
    __EE4314219.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE4314219.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE4314219.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE4314219.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE4314219.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4314219.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4314219.Aot_Id_Act_Cnt_Ev_;
    __EE4314219.Aot_Id_Act_Cnt30_D_;
    __EE4314219.Aot_Add_Act_Cnt_Ev_;
    __EE4314219.Aot_Add_Act_Cnt30_D_;
    __EE4314219.Aot_Non_St_Act_Cnt_Ev_;
    __EE4314219.Aot_Non_St_Act_Cnt30_D_;
    __EE4314219.Aot_Eml_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4314219.Aot_Eml_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4314219.Aot_Eml_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4314219.Aot_Id_Curr_Prof_Usng_Eml_Cnt_Ev_;
    __EE4314219.Aot_Id_Hist_Prof_Usng_Eml_Cnt_Ev_;
    __EE4314219.Aot_Id_Usng_Email_Cnt_Ev_;
    __EE4314219.Customer_Id_;
    __EE4314219.Industry_Type_;
    __EE4314219.Source_Customer_Count_;
    __EE4314219.Entity_Context_Uid_;
    __EE4314219.Entity_Type_;
    __EE4314219.Label_;
    __EE4314219.In_Customer_Population_;
    __EE4314219.Dt_First_Seen_;
    __EE4314219.Dt_Last_Seen_;
    __EE4314219.Id_Activity_Dt_First_Seen_;
    __EE4314219.Id_Activity_Dt_Last_Seen_;
    __EE4314219.Last_Record_Id_;
    __EE4314219.Identity_Count_;
    __EE4314219.Identity_Count_Gt2_;
    __EE4314219.Event_Count_;
    __EE4314219.Not_Safe_Last_Domain_Gt2_;
    __EE4314219.Kr_High_Risk_Flag_;
    __EE4314219.Kr_Medium_Risk_Flag_;
    __EE4314219.Kr_Low_Risk_Flag_;
    __EE4314219.Kr_Flag_;
    __EE4314219.Safe_Flag_;
    __EE4314219.Contributor_Safe_Flag_;
    __EE4314219.Last_Event_Date_;
    __EE4314219.Kr_Last_Event_Date_;
    __EE4314219.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4314219.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4314219.Kr_Eml500_Flag_;
    __EE4314219.Kr_Eml501_Flag_;
    __EE4314219.Kr_Eml502_Flag_;
    __EE4314219.Kr_Eml590_Flag_;
    __EE4314219.Kr_Eml591_Flag_;
    __EE4314219.Kr_Eml592_Flag_;
    __EE4314219.Kr_Eml593_Flag_;
    __EE4314219.Vl_Event1_All_Count_;
    __EE4314219.Vl_Event7_All_Count_;
    __EE4314219.Vl_Event30_All_Day_Count_;
    __EE4314219.Vl_Event365_All_Day_Count_;
    __EE4314219.Vl_Event7_All_Active_Flag_;
    __EE4314219.Vl_Event30_All_Active_Flag_;
    __EE4314219.Vl_Event1_Count_;
    __EE4314219.Vl_Event7_Count_;
    __EE4314219.Vl_Event30_Count_;
    __EE4314219.Vl_Event365_Count_;
    __EE4314219.Vl_Event7_Active_Flag_;
    __EE4314219.Vl_Event30_Active_Flag_;
    __EE4314219.Date_First_Seen_;
    __EE4314219.Date_Last_Seen_;
    __EE4314219.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE4314219,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4314221_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST48568_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
