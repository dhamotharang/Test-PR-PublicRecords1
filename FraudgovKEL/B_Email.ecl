...
EXPORT B_Email := MODULE
  ...
  SHARED __EE1572007 := __ENH_Email_1;
  SHARED __EE1575590 := __ENH_Event_1;
  SHARED __EE1575588 := __E_Email_Event;
  SHARED __EE1613777 := __EE1575588(__NN(__EE1575588.Emailof_) AND __NN(__EE1575588.Transaction_));
  SHARED __ST1606330_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1613795(B_Event_1.__ST53057_Layout __EE1575590, E_Email_Event.Layout __EE1613777) := __EEQP(__EE1613777.Transaction_,__EE1575590.UID);
  __ST1606330_Layout __JT1613795(B_Event_1.__ST53057_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1613796 := JOIN(__EE1613777,__EE1575590,__JC1613795(RIGHT,LEFT),__JT1613795(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1603476_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1603476_Layout __ND1614343__Project(__ST1606330_Layout __PP1613797) := TRANSFORM
    SELF.UID := __PP1613797.Emailof_;
    SELF._r_Customer_ := __PP1613797._r_Customer__1_;
    SELF.Event_Date_ := __PP1613797.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1613797.UID;
    SELF.Event_Date__1_ := __PP1613797.Event_Date_;
    SELF._r_Customer__1_ := __PP1613797._r_Customer_;
    SELF := __PP1613797;
  END;
  SHARED __EE1616492 := PROJECT(__EE1613796,__ND1614343__Project(LEFT));
  SHARED __ST1604619_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1604619_Layout __ND1617125__Project(__ST1603476_Layout __PP1616493) := TRANSFORM
    SELF.Exp1_ := __PP1616493.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1616493.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP1616493.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP1616493.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP1616493.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP1616493.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP1616493.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP1616493.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP1616493.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP1616493.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP1616493.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP1616493.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1616493.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1616493.Event_Age_,<,__CN(2)),__CN(__PP1616493.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1616493.Event_Age_,<,__CN(366));
    SELF := __PP1616493;
  END;
  SHARED __EE1617150 := PROJECT(__EE1616492,__ND1617125__Project(LEFT));
  SHARED __ST1604712_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1617249 := PROJECT(__CLEANANDDO(__EE1617150,TABLE(__EE1617150,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1617150.Exp1_),KEL.Aggregates.MinNG(__EE1617150.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1617150.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1617150.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1617150.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1617150.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1617150.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1617150.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1617150.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1617150.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1617150.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1617150.Exp11_),KEL.Aggregates.MaxNG(__EE1617150.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1617150.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1617150.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1617150.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1617150.Exp15_)),UID},UID,MERGE)),__ST1604712_Layout);
  SHARED __ST1609038_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1617255(B_Email_1.__ST47991_Layout __EE1572007, __ST1604712_Layout __EE1617249) := __EEQP(__EE1572007.UID,__EE1617249.UID);
  __ST1609038_Layout __JT1617255(B_Email_1.__ST47991_Layout __l, __ST1604712_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1617311 := JOIN(__EE1572007,__EE1617249,__JC1617255(LEFT,RIGHT),__JT1617255(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1561810 := __ENH_Customer_1;
  SHARED __ST1609421_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1617317(__ST1609038_Layout __EE1617311, B_Customer_1.__ST47489_Layout __EE1561810) := __EEQP(__EE1617311._r_Customer_,__EE1561810.UID);
  __ST1609421_Layout __JT1617317(__ST1609038_Layout __l, B_Customer_1.__ST47489_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1617395 := JOIN(__EE1617311,__EE1561810,__JC1617317(LEFT,RIGHT),__JT1617317(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST33538_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33538_Layout __ND1617400__Project(__ST1609421_Layout __PP1617396) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1617396.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP1617396.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS1617512 := __T(__PP1617396.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1617512(__T(__OP2(__T(__PP1617396.Source_Customers_)._r_Source_Customer_,=,__PP1617396._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1617396.Email_Address_;
    SELF.Last_Event_Date_ := __PP1617396.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP1617396.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP1617396.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1617396.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1617396.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1617396.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1617396.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1617396.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1617396.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1617396.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1617396.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1617396.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1617396;
  END;
  EXPORT __ENH_Email := PROJECT(__EE1617395,__ND1617400__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE2406694 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2406694._r_Customer_;
    __EE2406694.Source_Customers_;
    __EE2406694.Email_Address_;
    __EE2406694.Otto_Email_Id_;
    __EE2406694.Details_;
    __EE2406694.Email_Last_Domain_;
    __EE2406694._isdisposableemail_;
    __EE2406694.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE2406694.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE2406694.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE2406694.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE2406694.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2406694.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2406694.Customer_Id_;
    __EE2406694.Industry_Type_;
    __EE2406694.Source_Customer_Count_;
    __EE2406694.Entity_Context_Uid_;
    __EE2406694.Entity_Type_;
    __EE2406694.Label_;
    __EE2406694.In_Customer_Population_;
    __EE2406694.Dt_First_Seen_;
    __EE2406694.Dt_Last_Seen_;
    __EE2406694.Last_Record_Id_;
    __EE2406694.Identity_Count_;
    __EE2406694.Identity_Count_Gt2_;
    __EE2406694.Event_Count_;
    __EE2406694.Not_Safe_Last_Domain_Gt2_;
    __EE2406694.Kr_High_Risk_Flag_;
    __EE2406694.Kr_Medium_Risk_Flag_;
    __EE2406694.Kr_Low_Risk_Flag_;
    __EE2406694.Kr_Flag_;
    __EE2406694.Safe_Flag_;
    __EE2406694.Contributor_Safe_Flag_;
    __EE2406694.Last_Event_Date_;
    __EE2406694.Kr_Last_Event_Date_;
    __EE2406694.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2406694.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2406694.Kr_Eml500_Flag_;
    __EE2406694.Kr_Eml501_Flag_;
    __EE2406694.Kr_Eml502_Flag_;
    __EE2406694.Kr_Eml590_Flag_;
    __EE2406694.Kr_Eml591_Flag_;
    __EE2406694.Kr_Eml592_Flag_;
    __EE2406694.Kr_Eml593_Flag_;
    __EE2406694.Vl_Event1_All_Count_;
    __EE2406694.Vl_Event7_All_Count_;
    __EE2406694.Vl_Event30_All_Day_Count_;
    __EE2406694.Vl_Event365_All_Day_Count_;
    __EE2406694.Vl_Event7_All_Active_Flag_;
    __EE2406694.Vl_Event30_All_Active_Flag_;
    __EE2406694.Vl_Event1_Count_;
    __EE2406694.Vl_Event7_Count_;
    __EE2406694.Vl_Event30_Count_;
    __EE2406694.Vl_Event365_Count_;
    __EE2406694.Vl_Event7_Active_Flag_;
    __EE2406694.Vl_Event30_Active_Flag_;
    __EE2406694.Date_First_Seen_;
    __EE2406694.Date_Last_Seen_;
    __EE2406694.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE2406694,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2406696_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST33538_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
