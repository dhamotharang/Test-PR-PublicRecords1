...
EXPORT B_Email := MODULE
  ...
  SHARED __EE1565360 := __ENH_Email_1;
  SHARED __EE1568933 := __ENH_Event_1;
  SHARED __EE1568931 := __E_Email_Event;
  SHARED __EE1606990 := __EE1568931(__NN(__EE1568931.Emailof_) AND __NN(__EE1568931.Transaction_));
  SHARED __ST1599563_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1607008(B_Event_1.__ST53045_Layout __EE1568933, E_Email_Event.Layout __EE1606990) := __EEQP(__EE1606990.Transaction_,__EE1568933.UID);
  __ST1599563_Layout __JT1607008(B_Event_1.__ST53045_Layout __l, E_Email_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1607009 := JOIN(__EE1606990,__EE1568933,__JC1607008(RIGHT,LEFT),__JT1607008(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1596717_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1596717_Layout __ND1607554__Project(__ST1599563_Layout __PP1607010) := TRANSFORM
    SELF.UID := __PP1607010.Emailof_;
    SELF._r_Customer_ := __PP1607010._r_Customer__1_;
    SELF.Event_Date_ := __PP1607010.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1607010.UID;
    SELF.Event_Date__1_ := __PP1607010.Event_Date_;
    SELF._r_Customer__1_ := __PP1607010._r_Customer_;
    SELF := __PP1607010;
  END;
  SHARED __EE1609695 := PROJECT(__EE1607009,__ND1607554__Project(LEFT));
  SHARED __ST1597856_Layout := RECORD
    KEL.typ.ntyp(E_Email.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1597856_Layout __ND1610328__Project(__ST1596717_Layout __PP1609696) := TRANSFORM
    SELF.Exp1_ := __PP1609696.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1609696.Kr_Eml500_Flag_ = 1;
    SELF.Exp3_ := __PP1609696.Kr_Eml501_Flag_ = 1;
    SELF.Exp4_ := __PP1609696.Kr_Eml502_Flag_ = 1;
    SELF.Exp5_ := __PP1609696.Kr_Eml590_Flag_ = 1;
    SELF.Exp6_ := __PP1609696.Kr_Eml591_Flag_ = 1;
    SELF.Exp7_ := __PP1609696.Kr_Eml592_Flag_ = 1;
    SELF.Exp8_ := __PP1609696.Kr_Eml593_Flag_ = 1;
    SELF.Exp9_ := __PP1609696.Kr_High_Risk_Email_Flag_ = 1;
    SELF.Exp10_ := __PP1609696.Kr_Low_Risk_Email_Flag_ = 1;
    SELF.Exp11_ := __PP1609696.Kr_Medium_Risk_Email_Flag_ = 1;
    SELF.Exp12_ := __PP1609696.Safe_Flag_ = 1;
    SELF.Exp13_ := __OP2(__PP1609696.Event_Age_,<,__CN(2));
    SELF.Exp14_ := __AND(__OP2(__PP1609696.Event_Age_,<,__CN(2)),__CN(__PP1609696.In_Customer_Population_ = 1));
    SELF.Exp15_ := __OP2(__PP1609696.Event_Age_,<,__CN(366));
    SELF := __PP1609696;
  END;
  SHARED __EE1610353 := PROJECT(__EE1609695,__ND1610328__Project(LEFT));
  SHARED __ST1597949_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1610452 := PROJECT(__CLEANANDDO(__EE1610353,TABLE(__EE1610353,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1610353.Exp1_),KEL.Aggregates.MinNG(__EE1610353.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1610353.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1610353.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1610353.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1610353.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1610353.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1610353.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1610353.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1610353.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1610353.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1610353.Exp11_),KEL.Aggregates.MaxNG(__EE1610353.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1610353.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__T(__EE1610353.Exp13_)),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__T(__EE1610353.Exp14_)),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1610353.Exp15_)),UID},UID,MERGE)),__ST1597949_Layout);
  SHARED __ST1602261_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1610458(B_Email_1.__ST47981_Layout __EE1565360, __ST1597949_Layout __EE1610452) := __EEQP(__EE1565360.UID,__EE1610452.UID);
  __ST1602261_Layout __JT1610458(B_Email_1.__ST47981_Layout __l, __ST1597949_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1610514 := JOIN(__EE1565360,__EE1610452,__JC1610458(LEFT,RIGHT),__JT1610458(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1555195 := __ENH_Customer_1;
  SHARED __ST1602644_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1610520(__ST1602261_Layout __EE1610514, B_Customer_1.__ST47479_Layout __EE1555195) := __EEQP(__EE1610514._r_Customer_,__EE1555195.UID);
  __ST1602644_Layout __JT1610520(__ST1602261_Layout __l, B_Customer_1.__ST47479_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1610598 := JOIN(__EE1610514,__EE1555195,__JC1610520(LEFT,RIGHT),__JT1610520(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST33532_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Email.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Email_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33532_Layout __ND1610603__Project(__ST1602644_Layout __PP1610599) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1610599.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_17'),+,__PP1610599.Otto_Email_Id_);
    SELF.Entity_Type_ := 17;
    __BS1610715 := __T(__PP1610599.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1610715(__T(__OP2(__T(__PP1610599.Source_Customers_)._r_Source_Customer_,=,__PP1610599._r_Customer_))))=>1,0);
    SELF.Kr_Eml500_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Eml501_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Eml502_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Eml590_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Eml591_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Eml592_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Eml593_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Label_ := __PP1610599.Email_Address_;
    SELF.Last_Event_Date_ := __PP1610599.M_A_X___Event_Date__1_;
    SELF.Not_Safe_Last_Domain_Gt2_ := MAP(__T(__AND(__OP2(__PP1610599.Email_Last_Domain_,IN,__CN(['GOV','ORG'])),__CN(__PP1610599.Identity_Count_Gt2_ = 1)))=>1,0);
    SELF.Safe_Flag_ := MAP(__PP1610599.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1610599.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1610599.C_O_U_N_T___Exp1__12_;
    SELF.Vl_Event1_Count_ := __PP1610599.C_O_U_N_T___Exp1__13_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1610599.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1610599.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1610599.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1610599.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1610599.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1610599;
  END;
  EXPORT __ENH_Email := PROJECT(__EE1610598,__ND1610603__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Email::Annotated',EXPIRE(7));
  SHARED __EE2397222 := __ENH_Email;
  SHARED IDX_Email_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2397222._r_Customer_;
    __EE2397222.Source_Customers_;
    __EE2397222.Email_Address_;
    __EE2397222.Otto_Email_Id_;
    __EE2397222.Details_;
    __EE2397222.Email_Last_Domain_;
    __EE2397222._isdisposableemail_;
    __EE2397222.Aot_Email_Kr_Act_Cnt_Ev_;
    __EE2397222.Aot_Email_Kr_Act_Shrd_Cnt_Ev_;
    __EE2397222.Aot_Email_Kr_Act_Old_Dt_Ev_;
    __EE2397222.Aot_Email_Kr_Act_New_Dt_Ev_;
    __EE2397222.Aot_Email_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2397222.Aot_Email_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2397222.Customer_Id_;
    __EE2397222.Industry_Type_;
    __EE2397222.Source_Customer_Count_;
    __EE2397222.Entity_Context_Uid_;
    __EE2397222.Entity_Type_;
    __EE2397222.Label_;
    __EE2397222.In_Customer_Population_;
    __EE2397222.Dt_First_Seen_;
    __EE2397222.Dt_Last_Seen_;
    __EE2397222.Last_Record_Id_;
    __EE2397222.Identity_Count_;
    __EE2397222.Identity_Count_Gt2_;
    __EE2397222.Event_Count_;
    __EE2397222.Not_Safe_Last_Domain_Gt2_;
    __EE2397222.Kr_High_Risk_Flag_;
    __EE2397222.Kr_Medium_Risk_Flag_;
    __EE2397222.Kr_Low_Risk_Flag_;
    __EE2397222.Kr_Flag_;
    __EE2397222.Safe_Flag_;
    __EE2397222.Contributor_Safe_Flag_;
    __EE2397222.Last_Event_Date_;
    __EE2397222.Kr_Last_Event_Date_;
    __EE2397222.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2397222.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2397222.Kr_Eml500_Flag_;
    __EE2397222.Kr_Eml501_Flag_;
    __EE2397222.Kr_Eml502_Flag_;
    __EE2397222.Kr_Eml590_Flag_;
    __EE2397222.Kr_Eml591_Flag_;
    __EE2397222.Kr_Eml592_Flag_;
    __EE2397222.Kr_Eml593_Flag_;
    __EE2397222.Vl_Event1_All_Count_;
    __EE2397222.Vl_Event7_All_Count_;
    __EE2397222.Vl_Event30_All_Day_Count_;
    __EE2397222.Vl_Event365_All_Day_Count_;
    __EE2397222.Vl_Event7_All_Active_Flag_;
    __EE2397222.Vl_Event30_All_Active_Flag_;
    __EE2397222.Vl_Event1_Count_;
    __EE2397222.Vl_Event7_Count_;
    __EE2397222.Vl_Event30_Count_;
    __EE2397222.Vl_Event365_Count_;
    __EE2397222.Vl_Event7_Active_Flag_;
    __EE2397222.Vl_Event30_Active_Flag_;
    __EE2397222.Date_First_Seen_;
    __EE2397222.Date_Last_Seen_;
    __EE2397222.__RecordCount;
  END;
  SHARED IDX_Email_UID_Projected := PROJECT(__EE2397222,TRANSFORM(IDX_Email_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2397224_Layout := RECORDOF(IDX_Email_UID);
  EXPORT IDX_Email_UID_Wrapped := PROJECT(IDX_Email_UID,TRANSFORM(__ST33532_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
