...
EXPORT B_Internet_Protocol_2 := MODULE
  ...
  SHARED __EE1024353 := __ENH_Internet_Protocol_3;
  SHARED __EE1024800 := __EE1024353;
  SHARED __EE1026956 := __E_Internet_Protocol_Event;
  SHARED __EE1049822 := __EE1026956(__NN(__EE1026956.Transaction_) AND __NN(__EE1026956.Ip_));
  SHARED __EE1026958 := __ENH_Event_3;
  SHARED __ST1039901_Layout := RECORD
  ...
  END;
  __JC1049834(E_Internet_Protocol_Event.Layout __EE1049822, B_Event_3.__ST90584_Layout __EE1026958) := __EEQP(__EE1049822.Transaction_,__EE1026958.UID);
  __ST1039901_Layout __JT1049834(E_Internet_Protocol_Event.Layout __l, B_Event_3.__ST90584_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1049835 := JOIN(__EE1049822,__EE1026958,__JC1049834(LEFT,RIGHT),__JT1049834(LEFT,RIGHT),INNER,HASH);
  SHARED __ST1041595_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1050271(B_Internet_Protocol_3.__ST91142_Layout __EE1024800, __ST1039901_Layout __EE1049835) := __EEQP(__EE1024800.UID,__EE1049835.Ip_);
  __ST1041595_Layout __JT1050271(B_Internet_Protocol_3.__ST91142_Layout __l, __ST1039901_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    ...
    SELF := __r;
  END;
  SHARED __EE1050272 := JOIN(__EE1049835,__EE1024800,__JC1050271(RIGHT,LEFT),__JT1050271(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1038588_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1038588_Layout __ND1050898__Project(__ST1041595_Layout __PP1050273) := TRANSFORM
    SELF._r_Customer_ := __PP1050273._r_Customer__1_;
    SELF.Ip_Address_ := __PP1050273.Ip_Address__1_;
    SELF.Otto_Ip_Address_Id_ := __PP1050273.Otto_Ip_Address_Id__1_;
    SELF._asn_ := __PP1050273._asn__1_;
    SELF._asnname_ := __PP1050273._asnname__1_;
    SELF._cbsacode_ := __PP1050273._cbsacode__1_;
    SELF._cbsatitle_ := __PP1050273._cbsatitle__1_;
    SELF._cbsatype_ := __PP1050273._cbsatype__1_;
    SELF._companyname_ := __PP1050273._companyname__1_;
    SELF._csacode_ := __PP1050273._csacode__1_;
    SELF._csatitle_ := __PP1050273._csatitle__1_;
    SELF._domainname_ := __PP1050273._domainname__1_;
    SELF._edgeareacodes_ := __PP1050273._edgeareacodes__1_;
    SELF._edgecity_ := __PP1050273._edgecity__1_;
    SELF._edgecitycode_ := __PP1050273._edgecitycode__1_;
    SELF._edgecitycong_ := __PP1050273._edgecitycong__1_;
    SELF._edgeconnspeed_ := __PP1050273._edgeconnspeed__1_;
    SELF._edgecontinentcode_ := __PP1050273._edgecontinentcode__1_;
    SELF._edgecountry_ := __PP1050273._edgecountry__1_;
    SELF._edgecountrycode_ := __PP1050273._edgecountrycode__1_;
    SELF._edgecountryconf_ := __PP1050273._edgecountryconf__1_;
    SELF._edgegmtoffset_ := __PP1050273._edgegmtoffset__1_;
    SELF._edgeindst_ := __PP1050273._edgeindst__1_;
    SELF._edgeinternalcode_ := __PP1050273._edgeinternalcode__1_;
    SELF._edgelatitude_ := __PP1050273._edgelatitude__1_;
    SELF._edgelongitude_ := __PP1050273._edgelongitude__1_;
    SELF._edgemetrocode_ := __PP1050273._edgemetrocode__1_;
    SELF._edgepostalcode_ := __PP1050273._edgepostalcode__1_;
    SELF._edgepostalconf_ := __PP1050273._edgepostalconf__1_;
    SELF._edgeregion_ := __PP1050273._edgeregion__1_;
    SELF._edgeregioncode_ := __PP1050273._edgeregioncode__1_;
    SELF._edgeregionconf_ := __PP1050273._edgeregionconf__1_;
    SELF._edgetwolettercountry_ := __PP1050273._edgetwolettercountry__1_;
    SELF._homebiztype_ := __PP1050273._homebiztype__1_;
    SELF._households_ := __PP1050273._households__1_;
    SELF._iprngbeg_ := __PP1050273._iprngbeg__1_;
    SELF._iprngend_ := __PP1050273._iprngend__1_;
    SELF._isanisp_ := __PP1050273._isanisp__1_;
    SELF._ispname_ := __PP1050273._ispname__1_;
    SELF._kids_ := __PP1050273._kids__1_;
    SELF._mdcode_ := __PP1050273._mdcode__1_;
    SELF._mdtitle_ := __PP1050273._mdtitle__1_;
    SELF._men_ := __PP1050273._men__1_;
    SELF._men18to34_ := __PP1050273._men18to34__1_;
    SELF._men35to49_ := __PP1050273._men35to49__1_;
    SELF._naicscode_ := __PP1050273._naicscode__1_;
    SELF._organizationname_ := __PP1050273._organizationname__1_;
    SELF._primarylang_ := __PP1050273._primarylang__1_;
    SELF._proxydescription_ := __PP1050273._proxydescription__1_;
    SELF._proxytype_ := __PP1050273._proxytype__1_;
    SELF._r_Customer__1_ := __PP1050273._r_Customer__2_;
    SELF._ranks_ := __PP1050273._ranks__1_;
    SELF._secondarylang_ := __PP1050273._secondarylang__1_;
    SELF._siccode_ := __PP1050273._siccode__1_;
    SELF._teens_ := __PP1050273._teens__1_;
    SELF._women_ := __PP1050273._women__1_;
    SELF._women18to34_ := __PP1050273._women18to34__1_;
    SELF._women35to49_ := __PP1050273._women35to49__1_;
    SELF := __PP1050273;
  END;
  SHARED __EE1052583 := PROJECT(__EE1050272,__ND1050898__Project(LEFT));
  SHARED __ST1039497_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1039497_Layout __ND1053153__Project(__ST1038588_Layout __PP1052584) := TRANSFORM
    SELF.Exp1_ := __AND(__OP2(__PP1052584.Act_Age_,>,__CN(0)),__CN(__PP1052584.T___Src_Class_Type_ = 4));
    SELF.Exp2_ := IF(__PP1052584.Kr_High_Risk_Ip_Address_Flag_ = 1 OR __PP1052584.Kr_Medium_Risk_Ip_Address_Flag_ = 1 OR __PP1052584.Kr_Low_Risk_Ip_Address_Flag_ = 1,__ECAST(KEL.typ.nkdate,__PP1052584.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := NOT (__PP1052584.T___Src_Class_Type_ IN [2,3]);
    SELF.Exp4_ := IF(__T(__AND(__CN(__PP1052584.T___Src_Class_Type_ IN [2,3]),__OP2(__PP1052584.Event_Date__1_,=,__PP1052584.Dt_Last_Seen_))),__ECAST(KEL.typ.nint,__PP1052584.Record_Id_),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
    SELF.Exp5_ := IF(__T(__AND(__CN(__PP1052584.T___Src_Class_Type_ = 4),__OP2(__PP1052584.Event_Date__1_,=,__PP1052584.Id_Activity_Dt_Last_Seen_))),__ECAST(KEL.typ.nint,__PP1052584.Record_Id_),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
    SELF := __PP1052584;
  END;
  SHARED __EE1053167 := PROJECT(__EE1052583,__ND1053153__Project(LEFT));
  SHARED __ST1039532_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1053204 := PROJECT(__CLEANANDDO(__EE1053167,TABLE(__EE1053167,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__T(__EE1053167.Exp1_)),KEL.Aggregates.MaxNG(__EE1053167.Exp2_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Event_ := COUNT(GROUP,__EE1053167.Exp3_),KEL.Aggregates.MaxNG(__EE1053167.Exp4_) M_A_X___Record_Id_,KEL.Aggregates.MaxNG(__EE1053167.Exp5_) M_A_X___Record_Id__1_,UID},UID,MERGE)),__ST1039532_Layout);
  SHARED __ST1043919_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1053210(B_Internet_Protocol_3.__ST91142_Layout __EE1024353, __ST1039532_Layout __EE1053204) := __EEQP(__EE1024353.UID,__EE1053204.UID);
  __ST1043919_Layout __JT1053210(B_Internet_Protocol_3.__ST91142_Layout __l, __ST1039532_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1053303 := JOIN(__EE1024353,__EE1053204,__JC1053210(LEFT,RIGHT),__JT1053210(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST86564_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Internet_Protocol.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr Ip_Address_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST86564_Layout __ND1053308__Project(__ST1043919_Layout __PP1053304) := TRANSFORM
    SELF.Aot_Id_Act_Cnt_Ev_ := MIN(__PP1053304.C_O_U_N_T___Exp1_,999);
    SELF.Aot_Src1_Act_Only_Flag_ := __PP1053304.Aot_Act_Cnt_Ev_ = __PP1053304.Aot_Src1_Act_Cnt_Ev_;
    SELF.Kr_Last_Event_Date_ := __PP1053304.M_A_X___Event_Date__1_;
    SELF.Last_Record_Id_ := MAP(NOT (__PP1053304.C_O_U_N_T___Event_ <> 0)=>__ECAST(KEL.typ.nint,__PP1053304.M_A_X___Record_Id_),__ECAST(KEL.typ.nint,__PP1053304.M_A_X___Record_Id__1_));
    SELF := __PP1053304;
  END;
  EXPORT __ENH_Internet_Protocol_2 := PROJECT(__EE1053303,__ND1053308__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Internet_Protocol::Annotated_2',EXPIRE(7));
END;
