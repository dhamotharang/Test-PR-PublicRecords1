...
EXPORT B_Person_5 := MODULE
  ...
  SHARED __EE64875 := __ENH_Person_6;
  SHARED __EE65433 := __ENH_Event_6;
  SHARED __EE67610 := __EE65433(__EE65433.In_Customer_Population_ = 1);
  SHARED __EE65431 := __E_Person_Event;
  SHARED __EE72470 := __EE65431(__NN(__EE65431.Subject_) AND __NN(__EE65431.Transaction_));
  SHARED __ST68935_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC72488(B_Event_6.__ST41376_Layout __EE67610, E_Person_Event.Layout __EE72470) := __EEQP(__EE72470.Transaction_,__EE67610.UID);
  __ST68935_Layout __JT72488(B_Event_6.__ST41376_Layout __l, E_Person_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE72489 := JOIN(__EE72470,__EE67610,__JC72488(RIGHT,LEFT),__JT72488(RIGHT,LEFT),INNER,SMART);
  SHARED __ST67029_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST67029_Layout __ND72726__Project(__ST68935_Layout __PP72490) := TRANSFORM
    SELF.UID := __PP72490.Subject__1_;
    SELF._r_Customer_ := __PP72490._r_Customer__1_;
    SELF.Subject_ := __PP72490.Subject__1_;
    SELF.Event_Date_ := __PP72490.Event_Date__1_;
    SELF.U_I_D__1_ := __PP72490.UID;
    SELF._r_Customer__1_ := __PP72490._r_Customer_;
    SELF.Subject__1_ := __PP72490.Subject_;
    SELF.Event_Date__1_ := __PP72490.Event_Date_;
    SELF := __PP72490;
  END;
  SHARED __EE73627 := PROJECT(__EE72489,__ND72726__Project(LEFT));
  SHARED __ST67494_Layout := RECORD
    KEL.typ.ntyp(E_Person.Typ) UID;
    KEL.typ.nint Exp1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE73642 := PROJECT(__EE73627,TRANSFORM(__ST67494_Layout,SELF.Exp1_ := __CN(LEFT.Deceased_Prior_To_Event_),SELF := LEFT));
  SHARED __ST67509_Layout := RECORD
    KEL.typ.nfloat A_V_E___Deceased_Prior_To_Event_;
    KEL.typ.ntyp(E_Person.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE73658 := PROJECT(__CLEANANDDO(__EE73642,TABLE(__EE73642,{KEL.Aggregates.AveNG(__EE73642.Exp1_) A_V_E___Deceased_Prior_To_Event_,UID},UID,MERGE)),__ST67509_Layout);
  SHARED __ST70085_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC73664(B_Person_7.__ST42270_Layout __EE64875, __ST67509_Layout __EE73658) := __EEQP(__EE64875.UID,__EE73658.UID);
  __ST70085_Layout __JT73664(B_Person_7.__ST42270_Layout __l, __ST67509_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE73665 := JOIN(__EE64875,__EE73658,__JC73664(LEFT,RIGHT),__JT73664(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST41023_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.ndataset(E_Person.Source_Customers_Layout) Source_Customers_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ENH_Person_5 := PROJECT(__EE73665,TRANSFORM(__ST41023_Layout,SELF.Deceased_Event_Percent_ := LEFT.A_V_E___Deceased_Prior_To_Event_,SELF := LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_5',EXPIRE(7));
END;
