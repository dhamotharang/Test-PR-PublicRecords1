...
tempFinal := DATASET('~foreign::10.173.14.201::temp::fraudgov', RECORDOF(Final), THOR);//(did in Set_incarcerated OR did in Set_deceased or did % 100000 = 1 or OttoAddressId in Set_Addresses);
