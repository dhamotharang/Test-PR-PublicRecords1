...
EXPORT E_Event := MODULE
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Event','FraudgovKEL.fraudgovshared','best_flags.fname',COUNT(__d0(__NL(_best__fname_))),COUNT(__d0(__NN(_best__fname_)))},
    {'Event','FraudgovKEL.fraudgovshared','best_flags.lname',COUNT(__d0(__NL(_best__lname_))),COUNT(__d0(__NN(_best__lname_)))},
    {'Event','FraudgovKEL.fraudgovshared','best_flags.ssn',COUNT(__d0(__NL(_best__ssn_))),COUNT(__d0(__NN(_best__ssn_)))},
    ...
    {'Event','FraudgovKEL.fraudgovshared','address_verification.address_history_1.st',COUNT(__d0(__NL(_add__curr__st_))),COUNT(__d0(__NN(_add__curr__st_)))},
    {'Event','FraudgovKEL.fraudgovshared','address_verification.address_history_1.zip5',COUNT(__d0(__NL(_add__curr__zip5_))),COUNT(__d0(__NN(_add__curr__zip5_)))},
    {'Event','FraudgovKEL.fraudgovshared','address_verification.address_history_1.county',COUNT(__d0(__NL(_add__curr__county_))),COUNT(__d0(__NN(_add__curr__county_)))},
    {'Event','FraudgovKEL.fraudgovshared','address_verification.address_history_1.geo_blk',COUNT(__d0(__NL(_add__curr__geo__blk_))),COUNT(__d0(__NN(_add__curr__geo__blk_)))},
