...
EXPORT B_Person_2 := MODULE
  ...
  SHARED __EE649681 := __ENH_Person_3;
  SHARED __EE649683 := __EE649681;
  SHARED __EE649685 := __E_Person_Event;
  SHARED __EE652910 := __EE649685(__NN(__EE649685.Transaction_) AND __NN(__EE649685.Subject_));
  SHARED __EE649687 := __ENH_Event_3;
  SHARED __ST640416_Layout := RECORD
  ...
  END;
  __JC652922(E_Person_Event.Layout __EE652910, B_Event_3.__ST59679_Layout __EE649687) := __EEQP(__EE652910.Transaction_,__EE649687.UID);
  __ST640416_Layout __JT652922(E_Person_Event.Layout __l, B_Event_3.__ST59679_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE652923 := JOIN(__EE652910,__EE649687,__JC652922(LEFT,RIGHT),__JT652922(LEFT,RIGHT),INNER,HASH);
  SHARED __ST641687_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC653255(B_Person_3.__ST60426_Layout __EE649683, __ST640416_Layout __EE652923) := __EEQP(__EE649683.UID,__EE652923.Subject_);
  __ST641687_Layout __JT653255(B_Person_3.__ST60426_Layout __l, __ST640416_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    ...
    SELF := __r;
  END;
  SHARED __EE653256 := JOIN(__EE652923,__EE649683,__JC653255(RIGHT,LEFT),__JT653255(RIGHT,LEFT),INNER,HASH);
  SHARED __EE655598 := __EE653256;
  SHARED __ST640120_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE655638 := PROJECT(__EE655598,TRANSFORM(__ST640120_Layout,SELF._r_Customer_ := LEFT._r_Customer__1_,SELF := LEFT));
  SHARED __ST640154_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST640154_Layout __ND655643__Project(__ST640120_Layout __PP655639) := TRANSFORM
    SELF.Exp1_ := __PP655639.Kr_Event_After_Known_Risk_ = 1;
    SELF.Exp2_ := __OP2(__PP655639.Event_Date__1_,>,__PP655639.Kr_Last_Event_Date_);
    SELF := __PP655639;
  END;
  SHARED __EE655660 := PROJECT(__EE655638,__ND655643__Project(LEFT));
  SHARED __ST640174_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE656184 := PROJECT(__CLEANANDDO(__EE655660,TABLE(__EE655660,{KEL.typ.int C_O_U_N_T___Person_Event_ := COUNT(GROUP,__EE655660.Exp1_),KEL.typ.int C_O_U_N_T___Person_Event__1_ := COUNT(GROUP,__T(__EE655660.Exp2_)),UID},UID,MERGE)),__ST640174_Layout);
  SHARED __ST644256_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.ndataset(E_Person.Source_Customers_Layout) Source_Customers_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC656190(B_Person_3.__ST60426_Layout __EE649681, __ST640174_Layout __EE656184) := __EEQP(__EE649681.UID,__EE656184.UID);
  __ST644256_Layout __JT656190(B_Person_3.__ST60426_Layout __l, __ST640174_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE656274 := JOIN(__EE649681,__EE656184,__JC656190(LEFT,RIGHT),__JT656190(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST638651_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST638651_Layout __ND653700__Project(__ST641687_Layout __PP653257) := TRANSFORM
    SELF._r_Customer_ := __PP653257._r_Customer__1_;
    SELF._r_Customer__1_ := __PP653257._r_Customer__2_;
    SELF._rin__source_ := __PP653257._rin__source__1_;
    SELF.Lex_Id_ := __PP653257.Lex_Id__1_;
    SELF.Deceased_Date_ := __PP653257.Deceased_Date__1_;
    SELF.Deceased_Date_Of_Birth_ := __PP653257.Deceased_Date_Of_Birth__1_;
    SELF.Deceased_First_ := __PP653257.Deceased_First__1_;
    SELF.Deceased_Middle_ := __PP653257.Deceased_Middle__1_;
    SELF.Deceased_Last_ := __PP653257.Deceased_Last__1_;
    SELF.Deceased_Match_Code_ := __PP653257.Deceased_Match_Code__1_;
    SELF._isdeepdive_ := __PP653257._isdeepdive__1_;
    SELF._county__death_ := __PP653257._county__death__1_;
    SELF.Deceased_Ssn_ := __PP653257.Deceased_Ssn__1_;
    SELF._state__death__flag_ := __PP653257._state__death__flag__1_;
    SELF._death__rec__src_ := __PP653257._death__rec__src__1_;
    SELF._state__death__id_ := __PP653257._state__death__id__1_;
    SELF._curr__incar__flag_ := __PP653257._curr__incar__flag__1_;
    SELF._name__ssn__dob__match_ := __PP653257._name__ssn__dob__match__1_;
    SELF.Deceased_ := __PP653257.Deceased__1_;
    SELF.Deceased_Dob_Match_ := __PP653257.Deceased_Dob_Match__1_;
    SELF.Deceased_Match_ := __PP653257.Deceased_Match__1_;
    SELF.Deceased_Name_Match_ := __PP653257.Deceased_Name_Match__1_;
    SELF.In_Customer_Population_ := __PP653257.In_Customer_Population__1_;
    SELF := __PP653257;
  END;
  SHARED __EE654957 := PROJECT(__EE653256,__ND653700__Project(LEFT));
  SHARED __ST639348_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Exp1_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST639348_Layout __ND656279__Project(__ST638651_Layout __PP654958) := TRANSFORM
    SELF.Exp1_ := __CN(__PP654958.Deceased_Prior_To_Event_);
    SELF.Exp2_ := __PP654958.T___In_Agency_Flag_ = 1 AND __PP654958.T1___Id_Is_Kr_App_Frd_Flag_ = 1;
    SELF.Exp3_ := __PP654958.T___In_Agency_Flag_ = 0 AND __PP654958.T1___Id_Is_Kr_App_Frd_Flag_ = 1;
    SELF.Exp4_ := __PP654958.Kr_High_Risk_Identity_Flag_ = 1;
    SELF.Exp5_ := __PP654958.Kr_Medium_Risk_Identity_Flag_ = 1;
    SELF.Exp6_ := NOT (__PP654958.T___Src_Class_Type_ IN [2,3]);
    SELF.Exp7_ := IF(__T(__AND(__CN(__PP654958.T___Src_Class_Type_ IN [2,3]),__OP2(__PP654958.Event_Date__1_,=,__PP654958.Dt_Last_Seen_))),__ECAST(KEL.typ.nint,__PP654958.Record_Id_),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
    SELF.Exp8_ := IF(__T(__AND(__CN(__PP654958.T___Src_Class_Type_ = 4),__OP2(__PP654958.Event_Date__1_,=,__PP654958.Dt_Last_Seen_))),__ECAST(KEL.typ.nint,__PP654958.Record_Id_),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
    SELF := __PP654958;
  END;
  SHARED __EE656293 := PROJECT(__EE654957,__ND656279__Project(LEFT));
  SHARED __ST639398_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE656344 := PROJECT(__CLEANANDDO(__EE656293,TABLE(__EE656293,{KEL.Aggregates.AveNG(__EE656293.Exp1_) A_V_E___Deceased_Prior_To_Event_,KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE656293.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE656293.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE656293.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE656293.Exp5_),KEL.typ.int C_O_U_N_T___Event_ := COUNT(GROUP,__EE656293.Exp6_),KEL.Aggregates.MaxNG(__EE656293.Exp7_) M_A_X___Record_Id_,KEL.Aggregates.MaxNG(__EE656293.Exp8_) M_A_X___Record_Id__1_,UID},UID,MERGE)),__ST639398_Layout);
  SHARED __ST644699_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.ndataset(E_Person.Source_Customers_Layout) Source_Customers_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC656352(__ST644256_Layout __EE656274, __ST639398_Layout __EE656344) := __EEQP(__EE656274.UID,__EE656344.UID);
  __ST644699_Layout __JT656352(__ST644256_Layout __l, __ST639398_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE656445 := JOIN(__EE656274,__EE656344,__JC656352(LEFT,RIGHT),__JT656352(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST57190_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.ndataset(E_Person.Source_Customers_Layout) Source_Customers_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST57190_Layout __ND656450__Project(__ST644699_Layout __PP656446) := TRANSFORM
    SELF.All_Deceased_Event_Percent_ := __PP656446.A_V_E___Deceased_Prior_To_Event_;
    SELF.Aot_Id_Kr_App_Frd_Act_Cnt_Ev_ := MIN(__PP656446.C_O_U_N_T___Exp1_,9999);
    SELF.Aot_Id_Kr_App_Frd_Act_Shrd_Cnt_Ev_ := MIN(__PP656446.C_O_U_N_T___Exp1__1_,9999);
    __EE656612 := __PP656446.Reported_Date_Of_Birth_;
    SELF.Date_Of_Birth_ := KEL.Aggregates.MaxNN(__EE656612,__T(__EE656612).Date_Of_Birth_);
    SELF.Kr_Event_After_Known_Risk_Count_ := __PP656446.C_O_U_N_T___Person_Event_;
    SELF.Kr_Event_After_Last_Known_Risk_Count_ := __PP656446.C_O_U_N_T___Person_Event__1_;
    SELF.Kr_High_Risk_Flag_ := MAP(__PP656446.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP656446.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Last_Record_Id_ := MAP(NOT (__PP656446.C_O_U_N_T___Event_ <> 0)=>__ECAST(KEL.typ.nint,__PP656446.M_A_X___Record_Id_),__ECAST(KEL.typ.nint,__PP656446.M_A_X___Record_Id__1_));
    SELF := __PP656446;
  END;
  EXPORT __ENH_Person_2 := PROJECT(__EE656445,__ND656450__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_2',EXPIRE(7));
END;
