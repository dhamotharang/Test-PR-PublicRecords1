...
EXPORT B_Phone_4 := MODULE
  ...
  EXPORT __ST96258_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ENH_Phone_4 := PROJECT(__EE453919,TRANSFORM(__ST96258_Layout,SELF.Kr_Last_Event_Date_ := LEFT.M_A_X___Event_Date__1_,SELF := LEFT)) : PERSIST('~fraudgov::tempKEL::FraudgovKEL::Phone::Annotated_4',EXPIRE(7));
END;
