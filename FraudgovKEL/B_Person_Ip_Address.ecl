...
EXPORT B_Person_Ip_Address := MODULE
  ...
  SHARED __EE4143271 := __E_Person_Ip_Address;
  ...
  END;
  SHARED __ST70104_Layout __ND4143305__Project(E_Person_Ip_Address.Layout __PP4143166) := TRANSFORM
    __EE4143204 := __PP4143166.Event_Dates_;
    SELF.Dt_First_Seen_ := KEL.Aggregates.MinNN(__EE4143204,__T(__EE4143204).Event_Date_);
    __EE4143233 := __PP4143166.Event_Dates_;
    SELF.Dt_Last_Seen_ := KEL.Aggregates.MaxNN(__EE4143233,__T(__EE4143233).Event_Date_);
    SELF := __PP4143166;
  END;
  EXPORT __ENH_Person_Ip_Address := PROJECT(__EE4143271,__ND4143305__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person_Ip_Address::Annotated',EXPIRE(7));
  SHARED __EE4415090 := __ENH_Person_Ip_Address;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE4415090(__NN(__EE4415090.Ip_));
  ...
  EXPORT __ST4415092_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
