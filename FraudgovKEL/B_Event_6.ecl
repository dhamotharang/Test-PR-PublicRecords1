...
EXPORT B_Event_6 := MODULE
  ...
  SHARED __EE96842 := __ENH_Event_7;
  SHARED __EE96267 := __ENH_Person_7;
  SHARED __ST97489_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC97486(B_Event_7.__ST80580_Layout __EE96842, B_Person_7.__ST80955_Layout __EE96267) := __EEQP(__EE96842.Subject_,__EE96267.UID);
  __ST97489_Layout __JT97486(B_Event_7.__ST80580_Layout __l, B_Person_7.__ST80955_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE97487 := JOIN(__EE96842,__EE96267,__JC97486(LEFT,RIGHT),__JT97486(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE96435 := __E_Drivers_License;
  SHARED __ST99382_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC101893(__ST97489_Layout __EE97487, E_Drivers_License.Layout __EE96435) := __EEQP(__EE97487._r_Drivers_License_,__EE96435.UID);
  __ST99382_Layout __JT101893(__ST97489_Layout __l, E_Drivers_License.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE101894 := JOIN(__EE97487,__EE96435,__JC101893(LEFT,RIGHT),__JT101893(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST79645_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST79645_Layout __ND102282__Project(__ST99382_Layout __PP101250) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP101250.Deceased_ = 1 AND __PP101250.Deceased_Name_Match_ = 1 AND __PP101250.Deceased_Dob_Match_ = 1=>1,0);
    SELF.Deceased_Prior_To_Event_ := MAP(__T(__AND(__CN(__PP101250.Deceased_Match_ = 1),__OP2(__PP101250.Deceased_Date__1_,<,__PP101250.Event_Date_)))=>1,0);
    SELF.In_Customer_Population_ := MAP(__T(__OP2(__PP101250._r_Source_Customer_,=,__PP101250._r_Customer_))=>1,0);
    SELF.Kr_Identity_Risk_ := MAP(__T(__OR(__OR(__OP2(__PP101250._name__risk__code_,<>,__CN(0)),__OP2(__PP101250._dob__risk__code_,<>,__CN(0))),__OP2(__PP101250._identity__risk__code_,<>,__CN(0))))=>1,0);
    SELF.T1___Id_Is_Kr_Gen_Frd_Flag_ := MAP(__PP101250.T1___Lex_Id_Pop_Flag_ = 0 AND __PP101250.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP101250.T___Src_Class_Type_ <> 3=> -99998,__T(__AND(__AND(__OP2(__PP101250.T___Evt_Type1_Status_Code_Echo_,=,__CN(-99997)),__OP2(__PP101250.T___Evt_Type2_Status_Code_Echo_,=,__CN(-99997))),__OP2(__PP101250.T___Evt_Type3_Status_Code_Echo_,=,__CN(-99997))))=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP101250.T___Evt_Type1_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007'])),__OP2(__CAST(KEL.typ.str,__PP101250.T___Evt_Type2_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))),__OP2(__CAST(KEL.typ.str,__PP101250.T___Evt_Type3_Status_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))))=>1, -99997);
    SELF.T___Bc_Shll_Lex_Id_Echo_ := MAP(__PP101250.T___Is_Bc_Shll_Hit_Flag_ < 1 OR __PP101250.T___Src_Class_Type_ < 4=>__ECAST(KEL.typ.nint,__CN(-99998)),__T(__OP2(__PP101250.Lex_Id_,=,__CN(0)))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP101250.Lex_Id_));
    SELF.T___Inp_Cln_Addr_City_Echo_ := MAP(__T(__OR(__OP2(__PP101250.Postal_City_,=,__CN('')),__NT(__PP101250.Postal_City_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Postal_City_));
    SELF.T___Inp_Cln_Addr_Prim_Nm_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP101250.Primary_Name_,=,__CN('')),__NT(__PP101250.Primary_Name_)),__OP2(__PP101250.Location_,=,__CN(0))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Primary_Name_));
    SELF.T___Inp_Cln_Addr_St_Echo_ := MAP(__T(__OR(__OP2(__PP101250.State_,=,__CN('')),__NT(__PP101250.State_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.State_));
    SELF.T___Inp_Cln_Addr_Zip5_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP101250.Zip_,=,__CN('')),__NT(__PP101250.Zip_)),__OP2(__PP101250.Zip_,=,__CAST(KEL.typ.str,__CN(0)))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Zip_));
    SELF.T___Inp_Cln_Bnk_Acct_Echo_ := MAP(__T(__OR(__OP2(__PP101250.Account_Number_,=,__CN('')),__NT(__PP101250.Account_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Account_Number_));
    SELF.T___Inp_Cln_Bnk_Acct_Rtg_Echo_ := MAP(__T(__OR(__OP2(__PP101250.Routing_Number_,=,__CN('')),__NT(__PP101250.Routing_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Routing_Number_));
    SELF.T___Inp_Cln_Dl_Echo_ := MAP(__T(__OR(__OP2(__PP101250.License_Number_,=,__CN('')),__NT(__PP101250.License_Number__1_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.License_Number__1_));
    SELF.T___Inp_Cln_Dl_St_Echo_ := MAP(__T(__OR(__OP2(__PP101250.License_State_,=,__CN('')),__NT(__PP101250.License_State_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.License_State_));
    SELF.T___Inp_Cln_Email_Echo_ := MAP(__T(__OR(__OP2(__PP101250.Email_Address_,=,__CN('')),__NT(__PP101250.Email_Address_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Email_Address_));
    SELF.T___Inp_Cln_Ip_Addr_Echo_ := MAP(__T(__OR(__OP2(__PP101250.Ip_Address_,=,__CN('')),__NT(__PP101250.Ip_Address_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP101250.Ip_Address_));
    SELF.T___Inp_Cln_Phn_Echo_ := MAP(__T(__OR(__OR(__OR(__OP2(__PP101250.Phone_Number_,=,__CN('')),__NT(__PP101250.Phone_Number_)),__OP2(__PP101250.Phone_Number_,=,__CN('0000000000'))),__FN2(KEL.Routines.StartsWith,__PP101250.Phone_Number_,__CN('0'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP101250.Phone_Number_)));
    SELF.T___Inp_Cln_Ssn_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP101250.Ssn_,=,__CN('')),__NT(__PP101250.Ssn_)),__OP2(__PP101250.Ssn_,=,__CN('000000000'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP101250.Ssn_)));
    SELF := __PP101250;
  END;
  EXPORT __ENH_Event_6 := PROJECT(__EE101894,__ND102282__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_6',EXPIRE(7));
END;
