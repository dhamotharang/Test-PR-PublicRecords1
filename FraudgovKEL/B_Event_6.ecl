...
EXPORT B_Event_6 := MODULE
  ...
  SHARED __EE80033 := __ENH_Event_7;
  SHARED __EE79565 := __ENH_Person_7;
  SHARED __ST80553_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC80550(B_Event_7.__ST66645_Layout __EE80033, B_Person_7.__ST66956_Layout __EE79565) := __EEQP(__EE80033.Subject_,__EE79565.UID);
  __ST80553_Layout __JT80550(B_Event_7.__ST66645_Layout __l, B_Person_7.__ST66956_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE80551 := JOIN(__EE80033,__EE79565,__JC80550(LEFT,RIGHT),__JT80550(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE79712 := __E_Drivers_License;
  SHARED __ST82088_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC85620(__ST80553_Layout __EE80551, E_Drivers_License.Layout __EE79712) := __EEQP(__EE80551._r_Drivers_License_,__EE79712.UID);
  __ST82088_Layout __JT85620(__ST80553_Layout __l, E_Drivers_License.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE85621 := JOIN(__EE80551,__EE79712,__JC85620(LEFT,RIGHT),__JT85620(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  SHARED __EE79535 := __E_Customer;
  SHARED __ST83602_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC85622(__ST82088_Layout __EE85621, E_Customer.Layout __EE79535) := __EEQP(__EE85621._r_Customer_,__EE79535.UID);
  __ST83602_Layout __JT85622(__ST82088_Layout __l, E_Customer.Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE85623 := JOIN(__EE85621,__EE79535,__JC85622(LEFT,RIGHT),__JT85622(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST65877_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Customer.Typ) _r_Source_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST65877_Layout __ND86263__Project(__ST83602_Layout __PP85107) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP85107.Deceased_ = 1 AND __PP85107.Deceased_Name_Match_ = 1 AND __PP85107.Deceased_Dob_Match_ = 1=>1,0);
    SELF.Deceased_Prior_To_Event_ := MAP(__T(__AND(__CN(__PP85107.Deceased_Match_ = 1),__OP2(__PP85107.Deceased_Date__1_,<,__PP85107.Event_Date_)))=>1,0);
    SELF.In_Customer_Population_ := MAP(__T(__OP2(__PP85107._r_Source_Customer_,=,__PP85107._r_Customer_))=>1,0);
    SELF.Kr_Identity_Risk_ := MAP(__T(__OR(__OR(__OP2(__PP85107._name__risk__code_,<>,__CN(0)),__OP2(__PP85107._dob__risk__code_,<>,__CN(0))),__OP2(__PP85107._identity__risk__code_,<>,__CN(0))))=>1,0);
    SELF.T1___Id_Is_Kr_Gen_Frd_Flag_ := MAP(__PP85107.T1___Lex_Id_Pop_Flag_ = 0 AND __PP85107.T1___Rin_Id_Pop_Flag_ = 0=> -99999,__PP85107.T___Src_Class_Type_ <> 3=> -99998,__T(__AND(__AND(__OP2(__PP85107.T___Evt_Type1_Kr_Code_Echo_,=,__CN(-99997)),__OP2(__PP85107.T___Evt_Type2_Kr_Code_Echo_,=,__CN(-99997))),__OP2(__PP85107.T___Evt_Type3_Kr_Code_Echo_,=,__CN(-99997))))=>0,__T(__OR(__OR(__OP2(__CAST(KEL.typ.str,__PP85107.T___Evt_Type1_Kr_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007'])),__OP2(__CAST(KEL.typ.str,__PP85107.T___Evt_Type2_Kr_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))),__OP2(__CAST(KEL.typ.str,__PP85107.T___Evt_Type3_Kr_Code_Echo_),IN,__CN(['10000','10001','10002','10003','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12006','12007','13000','13001','13002','13003','13005','13006','13007']))))=>1, -99997);
    SELF.T___Inp_Cln_Addr_City_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Postal_City_,=,__CN('')),__NT(__PP85107.Postal_City_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Postal_City_));
    SELF.T___Inp_Cln_Addr_Prim_Nm_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Primary_Name_,=,__CN('')),__NT(__PP85107.Primary_Name_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Primary_Name_));
    SELF.T___Inp_Cln_Addr_St_Echo_ := MAP(__T(__OR(__OP2(__PP85107.State_,=,__CN('')),__NT(__PP85107.State_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.State_));
    SELF.T___Inp_Cln_Addr_Zip5_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Zip_,=,__CN('')),__NT(__PP85107.Zip_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Zip_));
    SELF.T___Inp_Cln_Bnk_Acct_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Account_Number_,=,__CN('')),__NT(__PP85107.Account_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Account_Number_));
    SELF.T___Inp_Cln_Bnk_Acct_Rtg_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Routing_Number_,=,__CN('')),__NT(__PP85107.Routing_Number_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Routing_Number_));
    SELF.T___Inp_Cln_Dl_Echo_ := MAP(__T(__OR(__OP2(__PP85107.License_Number_,=,__CN('')),__NT(__PP85107.License_Number__1_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.License_Number__1_));
    SELF.T___Inp_Cln_Dl_St_Echo_ := MAP(__T(__OR(__OP2(__PP85107.License_State_,=,__CN('')),__NT(__PP85107.License_State_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.License_State_));
    SELF.T___Inp_Cln_Ip_Addr_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Ip_Address_,=,__CN('')),__NT(__PP85107.Ip_Address_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Ip_Address_));
    SELF.T___Inp_Cln_Phn_Echo_ := MAP(__T(__OR(__OR(__OP2(__PP85107.Phone_Number_,=,__CN('')),__NT(__PP85107.Phone_Number_)),__OP2(__PP85107.Phone_Number_,=,__CN('0000000000'))))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Phone_Number_));
    SELF.T___Inp_Cln_Ssn_Echo_ := MAP(__T(__OR(__OP2(__PP85107.Ssn_,=,__CN('')),__NT(__PP85107.Ssn_)))=>__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(-99999))),__ECAST(KEL.typ.nstr,__PP85107.Ssn_));
    SELF := __PP85107;
  END;
  EXPORT __ENH_Event_6 := PROJECT(__EE85623,__ND86263__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Event::Annotated_6',EXPIRE(7));
END;
