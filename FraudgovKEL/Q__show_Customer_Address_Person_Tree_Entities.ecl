...
EXPORT Q__show_Customer_Address_Person_Tree_Entities := MODULE
  ...
  SHARED __EE4656552 := __E_Person_Address;
  SHARED __EE4656535 := __ENH_Person;
  SHARED __ST4656570_Layout := RECORD
  ...
  END;
  __JC4656567(E_Person_Address.Layout __EE4656552, B_Person.__ST69071_Layout __EE4656535) := __EEQP(__EE4656552.Subject_,__EE4656535.UID);
  __ST4656570_Layout __JT4656567(E_Person_Address.Layout __l, B_Person.__ST69071_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4656568 := JOIN(__EE4656552,__EE4656535,__JC4656567(LEFT,RIGHT),__JT4656567(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4656523 := __ENH_Address;
  SHARED __ST4656845_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4657698(__ST4656570_Layout __EE4656568, B_Address.__ST46977_Layout __EE4656523) := __EEQP(__EE4656568.Location_,__EE4656523.UID);
  __ST4656845_Layout __JT4657698(__ST4656570_Layout __l, B_Address.__ST46977_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4657699 := JOIN(__EE4656568,__EE4656523,__JC4657698(LEFT,RIGHT),__JT4657698(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4656508 := __E_Customer;
  SHARED __ST4657294_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4657700(__ST4656845_Layout __EE4657699, E_Customer.Layout __EE4656508) := __EEQP(__EE4657699._r_Customer_,__EE4656508.UID);
  __ST4657294_Layout __JT4657700(__ST4656845_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4657701 := JOIN(__EE4657699,__EE4656508,__JC4657700(LEFT,RIGHT),__JT4657700(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST45977_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST45977_Layout __ND4657690__Project(__ST4657294_Layout __PP4657689) := TRANSFORM
    SELF.Source_Customer_ := __PP4657689._r_Customer_;
    SELF.Customer_Id_ := __PP4657689.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4657689.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4657689.Entity_Context_Uid__1_;
    SELF := __PP4657689;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4657701,__ND4657690__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST45977_Layout));
END;
