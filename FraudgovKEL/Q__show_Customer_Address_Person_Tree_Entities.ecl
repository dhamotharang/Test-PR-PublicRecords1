...
EXPORT Q__show_Customer_Address_Person_Tree_Entities := MODULE
  ...
  SHARED __EE4200496 := __E_Person_Address;
  SHARED __EE4200479 := __ENH_Person;
  SHARED __ST4200514_Layout := RECORD
  ...
  END;
  __JC4200511(E_Person_Address.Layout __EE4200496, B_Person.__ST66421_Layout __EE4200479) := __EEQP(__EE4200496.Subject_,__EE4200479.UID);
  __ST4200514_Layout __JT4200511(E_Person_Address.Layout __l, B_Person.__ST66421_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE4200512 := JOIN(__EE4200496,__EE4200479,__JC4200511(LEFT,RIGHT),__JT4200511(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4200467 := __ENH_Address;
  SHARED __ST4200852_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4201866(__ST4200514_Layout __EE4200512, B_Address.__ST45839_Layout __EE4200467) := __EEQP(__EE4200512.Location_,__EE4200467.UID);
  __ST4200852_Layout __JT4201866(__ST4200514_Layout __l, B_Address.__ST45839_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4201867 := JOIN(__EE4200512,__EE4200467,__JC4201866(LEFT,RIGHT),__JT4201866(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE4200452 := __E_Customer;
  SHARED __ST4201391_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC4201868(__ST4200852_Layout __EE4201867, E_Customer.Layout __EE4200452) := __EEQP(__EE4201867._r_Customer_,__EE4200452.UID);
  __ST4201391_Layout __JT4201868(__ST4200852_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE4201869 := JOIN(__EE4201867,__EE4200452,__JC4201868(LEFT,RIGHT),__JT4201868(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST44713_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST44713_Layout __ND4201858__Project(__ST4201391_Layout __PP4201857) := TRANSFORM
    SELF.Source_Customer_ := __PP4201857._r_Customer_;
    SELF.Customer_Id_ := __PP4201857.Customer_Id__2_;
    SELF.Industry_Type_ := __PP4201857.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP4201857.Entity_Context_Uid__1_;
    SELF := __PP4201857;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4201869,__ND4201858__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST44713_Layout));
END;
