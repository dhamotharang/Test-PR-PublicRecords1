...
EXPORT B_Person_Person := MODULE
  SHARED __EE1379852 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1379852(__NN(__EE1379852.From_Person_));
  ...
  EXPORT __ST1379854_Layout := RECORDOF(IDX_Person_Person_From_Person_);
