...
EXPORT B_Person_Person := MODULE
  SHARED __EE3429448 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE3429448(__NN(__EE3429448.From_Person_));
  ...
  EXPORT __ST3429450_Layout := RECORDOF(IDX_Person_Person_From_Person_);
