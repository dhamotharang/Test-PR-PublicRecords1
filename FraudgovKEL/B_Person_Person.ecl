...
EXPORT B_Person_Person := MODULE
  SHARED __EE2398825 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2398825(__NN(__EE2398825.From_Person_));
  ...
  EXPORT __ST2398827_Layout := RECORDOF(IDX_Person_Person_From_Person_);
