...
EXPORT B_Person_Person := MODULE
  SHARED __EE2406841 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2406841(__NN(__EE2406841.From_Person_));
  ...
  EXPORT __ST2406843_Layout := RECORDOF(IDX_Person_Person_From_Person_);
