...
EXPORT B_Person_Person := MODULE
  SHARED __EE4415118 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4415118(__NN(__EE4415118.From_Person_));
  ...
  EXPORT __ST4415120_Layout := RECORDOF(IDX_Person_Person_From_Person_);
