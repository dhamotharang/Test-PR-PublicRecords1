...
EXPORT B_Person_Person := MODULE
  SHARED __EE2599959 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2599959(__NN(__EE2599959.From_Person_));
  ...
  EXPORT __ST2599961_Layout := RECORDOF(IDX_Person_Person_From_Person_);
