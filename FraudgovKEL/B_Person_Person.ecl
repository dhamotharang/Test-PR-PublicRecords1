...
EXPORT B_Person_Person := MODULE
  SHARED __EE4832098 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4832098(__NN(__EE4832098.From_Person_));
  ...
  EXPORT __ST4832100_Layout := RECORDOF(IDX_Person_Person_From_Person_);
