...
EXPORT B_Person_Person := MODULE
  SHARED __EE2805445 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2805445(__NN(__EE2805445.From_Person_));
  ...
  EXPORT __ST2805447_Layout := RECORDOF(IDX_Person_Person_From_Person_);
