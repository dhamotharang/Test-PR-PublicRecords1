...
EXPORT B_Person_Person := MODULE
  SHARED __EE1360644 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1360644(__NN(__EE1360644.From_Person_));
  ...
  EXPORT __ST1360646_Layout := RECORDOF(IDX_Person_Person_From_Person_);
