...
EXPORT B_Person_Person := MODULE
  SHARED __EE4093597 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4093597(__NN(__EE4093597.From_Person_));
  ...
  EXPORT __ST4093599_Layout := RECORDOF(IDX_Person_Person_From_Person_);
