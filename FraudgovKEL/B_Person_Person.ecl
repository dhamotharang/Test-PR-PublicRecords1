...
EXPORT B_Person_Person := MODULE
  SHARED __EE4267427 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4267427(__NN(__EE4267427.From_Person_));
  ...
  EXPORT __ST4267429_Layout := RECORDOF(IDX_Person_Person_From_Person_);
