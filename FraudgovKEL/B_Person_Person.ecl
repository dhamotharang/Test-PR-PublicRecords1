...
EXPORT B_Person_Person := MODULE
  SHARED __EE2343861 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2343861(__NN(__EE2343861.From_Person_));
  ...
  EXPORT __ST2343863_Layout := RECORDOF(IDX_Person_Person_From_Person_);
