...
EXPORT B_Person_Person := MODULE
  SHARED __EE1283041 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1283041(__NN(__EE1283041.From_Person_));
  ...
  EXPORT __ST1283043_Layout := RECORDOF(IDX_Person_Person_From_Person_);
