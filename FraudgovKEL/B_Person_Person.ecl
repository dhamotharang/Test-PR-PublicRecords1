...
EXPORT B_Person_Person := MODULE
  SHARED __EE1363541 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1363541(__NN(__EE1363541.From_Person_));
  ...
  EXPORT __ST1363543_Layout := RECORDOF(IDX_Person_Person_From_Person_);
