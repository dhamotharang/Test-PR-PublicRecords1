...
EXPORT B_Person_Person := MODULE
  SHARED __EE4712593 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4712593(__NN(__EE4712593.From_Person_));
  ...
  EXPORT __ST4712595_Layout := RECORDOF(IDX_Person_Person_From_Person_);
