...
EXPORT B_Person_Person := MODULE
  SHARED __EE2277435 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2277435(__NN(__EE2277435.From_Person_));
  ...
  EXPORT __ST2277437_Layout := RECORDOF(IDX_Person_Person_From_Person_);
