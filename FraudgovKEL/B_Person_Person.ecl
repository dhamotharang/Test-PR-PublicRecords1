...
EXPORT B_Person_Person := MODULE
  SHARED __EE1285292 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1285292(__NN(__EE1285292.From_Person_));
  ...
  EXPORT __ST1285294_Layout := RECORDOF(IDX_Person_Person_From_Person_);
