...
EXPORT B_Person_Person := MODULE
  SHARED __EE2603906 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2603906(__NN(__EE2603906.From_Person_));
  ...
  EXPORT __ST2603908_Layout := RECORDOF(IDX_Person_Person_From_Person_);
