...
EXPORT B_Person_Person := MODULE
  SHARED __EE4317880 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4317880(__NN(__EE4317880.From_Person_));
  ...
  EXPORT __ST4317882_Layout := RECORDOF(IDX_Person_Person_From_Person_);
