...
EXPORT B_Person_Person := MODULE
  SHARED __EE4315784 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE4315784(__NN(__EE4315784.From_Person_));
  ...
  EXPORT __ST4315786_Layout := RECORDOF(IDX_Person_Person_From_Person_);
