...
EXPORT B_Person_Person := MODULE
  SHARED __EE1387157 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1387157(__NN(__EE1387157.From_Person_));
  ...
  EXPORT __ST1387159_Layout := RECORDOF(IDX_Person_Person_From_Person_);
