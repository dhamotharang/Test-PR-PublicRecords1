...
EXPORT B_Person_Person := MODULE
  SHARED __EE2336236 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2336236(__NN(__EE2336236.From_Person_));
  ...
  EXPORT __ST2336238_Layout := RECORDOF(IDX_Person_Person_From_Person_);
