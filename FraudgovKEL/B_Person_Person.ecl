...
EXPORT B_Person_Person := MODULE
  SHARED __EE1298697 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE1298697(__NN(__EE1298697.From_Person_));
  ...
  EXPORT __ST1298699_Layout := RECORDOF(IDX_Person_Person_From_Person_);
