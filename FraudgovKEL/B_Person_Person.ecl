...
EXPORT B_Person_Person := MODULE
  SHARED __EE2523251 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE2523251(__NN(__EE2523251.From_Person_));
  ...
  EXPORT __ST2523253_Layout := RECORDOF(IDX_Person_Person_From_Person_);
