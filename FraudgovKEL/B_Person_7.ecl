...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE46398 := __ENH_Person_8;
  EXPORT __ST42270_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST42270_Layout __ND46853__Project(B_Person_8.__ST42399_Layout __PP46087) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP46087.Deceased_ = 1 AND __PP46087.Deceased_Name_Match_ = 1 AND __PP46087.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP46087;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE46398,__ND46853__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_7',EXPIRE(7));
END;
