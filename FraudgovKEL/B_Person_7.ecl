...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE129578 := __ENH_Person_8;
  EXPORT __ST103331_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST103331_Layout __ND130033__Project(B_Person_8.__ST104528_Layout __PP129267) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP129267.Deceased_ = 1 AND __PP129267.Deceased_Name_Match_ = 1 AND __PP129267.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP129267;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE129578,__ND130033__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_7',EXPIRE(7));
END;
