...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE46400 := __ENH_Person_8;
  EXPORT __ST43279_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST43279_Layout __ND47156__Project(B_Person_8.__ST43494_Layout __PP45874) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP45874.Deceased_ = 1 AND __PP45874.Deceased_Name_Match_ = 1 AND __PP45874.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP45874;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE46400,__ND47156__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_7',EXPIRE(7));
END;
