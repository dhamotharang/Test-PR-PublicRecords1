...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE46527 := __ENH_Person_8;
  EXPORT __ST42389_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST42389_Layout __ND46982__Project(B_Person_8.__ST42518_Layout __PP46216) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP46216.Deceased_ = 1 AND __PP46216.Deceased_Name_Match_ = 1 AND __PP46216.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP46216;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE46527,__ND46982__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_7',EXPIRE(7));
END;
