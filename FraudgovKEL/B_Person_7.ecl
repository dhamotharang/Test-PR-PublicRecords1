...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE94043 := __ENH_Person_8;
  EXPORT __ST80955_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST80955_Layout __ND94498__Project(B_Person_8.__ST81729_Layout __PP93732) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP93732.Deceased_ = 1 AND __PP93732.Deceased_Name_Match_ = 1 AND __PP93732.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP93732;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE94043,__ND94498__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Person::Annotated_7',EXPIRE(7));
END;
