...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE1442407 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1442410 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1348883_Layout := RECORD
  ...
  END;
  __JC1442418(E_Person_Address.Layout __EE1442407, B_Person.__ST30234_Layout __EE1442410) := __EEQP(__EE1442407.Subject_,__EE1442410.UID);
  __ST1348883_Layout __JT1442418(E_Person_Address.Layout __l, B_Person.__ST30234_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1442419 := JOIN(__EE1442407,__EE1442410,__JC1442418(LEFT,RIGHT),__JT1442418(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1442749 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1349257_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1442757(__ST1348883_Layout __EE1442419, B_Address.__ST22365_Layout __EE1442749) := __EEQP(__EE1442419.Location_,__EE1442749.UID);
  __ST1349257_Layout __JT1442757(__ST1348883_Layout __l, B_Address.__ST22365_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1442758 := JOIN(__EE1442419,__EE1442749,__JC1442757(LEFT,RIGHT),__JT1442757(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1443807 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1349830_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1443821(__ST1349257_Layout __EE1442758, E_Customer.Layout __EE1443807) := __EEQP(__EE1442758._r_Customer_,__EE1443807.UID);
  __ST1349830_Layout __JT1443821(__ST1349257_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1444284 := JOIN(__EE1442758,__EE1443807,__JC1443821(LEFT,RIGHT),__JT1443821(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1348788_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1348788_Layout __ND1444738__Project(__ST1349830_Layout __PP1444285) := TRANSFORM
    SELF.Source_Customer_ := __PP1444285._r_Customer_;
    SELF.Customer_Id_ := __PP1444285.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1444285.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1444285.Entity_Context_Uid__1_;
    SELF := __PP1444285;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1444284,__ND1444738__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1348788_Layout));
END;
