...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE1349793 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE1349796 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST1273557_Layout := RECORD
  ...
  END;
  __JC1349804(E_Person_Address.Layout __EE1349793, B_Person.__ST28512_Layout __EE1349796) := __EEQP(__EE1349793.Subject_,__EE1349796.UID);
  __ST1273557_Layout __JT1349804(E_Person_Address.Layout __l, B_Person.__ST28512_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1349805 := JOIN(__EE1349793,__EE1349796,__JC1349804(LEFT,RIGHT),__JT1349804(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1350045 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST1273841_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1350053(__ST1273557_Layout __EE1349805, B_Address.__ST20764_Layout __EE1350045) := __EEQP(__EE1349805.Location_,__EE1350045.UID);
  __ST1273841_Layout __JT1350053(__ST1273557_Layout __l, B_Address.__ST20764_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1350054 := JOIN(__EE1349805,__EE1350045,__JC1350053(LEFT,RIGHT),__JT1350053(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1350879 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST1274291_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1350893(__ST1273841_Layout __EE1350054, E_Customer.Layout __EE1350879) := __EEQP(__EE1350054._r_Customer_,__EE1350879.UID);
  __ST1274291_Layout __JT1350893(__ST1273841_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1351255 := JOIN(__EE1350054,__EE1350879,__JC1350893(LEFT,RIGHT),__JT1350893(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST1273462_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST1273462_Layout __ND1351608__Project(__ST1274291_Layout __PP1351256) := TRANSFORM
    SELF.Source_Customer_ := __PP1351256._r_Customer_;
    SELF.Customer_Id_ := __PP1351256.Customer_Id__2_;
    SELF.Industry_Type_ := __PP1351256.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP1351256.Entity_Context_Uid__1_;
    SELF := __PP1351256;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE1351255,__ND1351608__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST1273462_Layout));
END;
