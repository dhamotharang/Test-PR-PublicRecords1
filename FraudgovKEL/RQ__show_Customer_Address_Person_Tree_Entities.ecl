...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE2595865 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE2595868 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2511992_Layout := RECORD
  ...
  END;
  __JC2595876(E_Person_Address.Layout __EE2595865, B_Person.__ST45444_Layout __EE2595868) := __EEQP(__EE2595865.Subject_,__EE2595868.UID);
  __ST2511992_Layout __JT2595876(E_Person_Address.Layout __l, B_Person.__ST45444_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2595877 := JOIN(__EE2595865,__EE2595868,__JC2595876(LEFT,RIGHT),__JT2595876(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2596147 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST2512306_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2596155(__ST2511992_Layout __EE2595877, B_Address.__ST31913_Layout __EE2596147) := __EEQP(__EE2595877.Location_,__EE2596147.UID);
  __ST2512306_Layout __JT2596155(__ST2511992_Layout __l, B_Address.__ST31913_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2596156 := JOIN(__EE2595877,__EE2596147,__JC2596155(LEFT,RIGHT),__JT2596155(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2597059 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2512795_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2597073(__ST2512306_Layout __EE2596156, E_Customer.Layout __EE2597059) := __EEQP(__EE2596156._r_Customer_,__EE2597059.UID);
  __ST2512795_Layout __JT2597073(__ST2512306_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2597474 := JOIN(__EE2596156,__EE2597059,__JC2597073(LEFT,RIGHT),__JT2597073(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2511897_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2511897_Layout __ND2597866__Project(__ST2512795_Layout __PP2597475) := TRANSFORM
    SELF.Source_Customer_ := __PP2597475._r_Customer_;
    SELF.Customer_Id_ := __PP2597475.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2597475.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2597475.Entity_Context_Uid__1_;
    SELF := __PP2597475;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2597474,__ND2597866__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2511897_Layout));
END;
