...
EXPORT B_Event_11 := MODULE
  ...
  SHARED __EE113879 := __E_Event;
  EXPORT __ST111760_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST111760_Layout __ND114490__Project(E_Event.Layout __PP112365) := TRANSFORM
    SELF.T___Src_Type_ := MAP(__T(__OR(__OP2(__PP112365._rin__source_,<=,__CN(0)),__OP2(__PP112365._rin__source_,>,__CN(15))))=>__ECAST(KEL.typ.nint,__CN(-99997)),__ECAST(KEL.typ.nint,__PP112365._rin__source_));
    SELF := __PP112365;
  END;
  EXPORT __ENH_Event_11 := PROJECT(__EE113879,__ND114490__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Event::Annotated_11',EXPIRE(7));
END;
