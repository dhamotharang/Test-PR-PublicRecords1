...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE2555581 := __ENH_Drivers_License_1;
  SHARED __EE2560081 := __ENH_Event_1;
  SHARED __EE2560079 := __E_Drivers_License_Event;
  SHARED __EE2614810 := __EE2560079(__NN(__EE2560079.Licence_) AND __NN(__EE2560079.Transaction_));
  SHARED __ST2605593_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2614828(B_Event_1.__ST78136_Layout __EE2560081, E_Drivers_License_Event.Layout __EE2614810) := __EEQP(__EE2614810.Transaction_,__EE2560081.UID);
  __ST2605593_Layout __JT2614828(B_Event_1.__ST78136_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2614829 := JOIN(__EE2614810,__EE2560081,__JC2614828(RIGHT,LEFT),__JT2614828(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2602021_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2602021_Layout __ND2615528__Project(__ST2605593_Layout __PP2614830) := TRANSFORM
    SELF.UID := __PP2614830.Licence_;
    SELF._r_Customer_ := __PP2614830._r_Customer__1_;
    SELF.Event_Date_ := __PP2614830.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2614830.UID;
    SELF.Event_Date__1_ := __PP2614830.Event_Date_;
    SELF._r_Customer__1_ := __PP2614830._r_Customer_;
    SELF := __PP2614830;
  END;
  SHARED __EE2618285 := PROJECT(__EE2614829,__ND2615528__Project(LEFT));
  SHARED __ST2603480_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2603480_Layout __ND2619031__Project(__ST2602021_Layout __PP2618286) := TRANSFORM
    SELF.Exp1_ := __PP2618286.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2618286.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2618286.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2618286.Kr_Dl200_Flag_ = 1;
    SELF.Exp4_ := __PP2618286.Kr_Dl201_Flag_ = 1;
    SELF.Exp5_ := __PP2618286.Kr_Dl202_Flag_ = 1;
    SELF.Exp6_ := __PP2618286.Kr_Dl203_Flag_ = 1;
    SELF.Exp7_ := __PP2618286.Kr_Dl204_Flag_ = 1;
    SELF.Exp8_ := __PP2618286.Kr_Dl290_Flag_ = 1;
    SELF.Exp9_ := __PP2618286.Kr_Dl291_Flag_ = 1;
    SELF.Exp10_ := __PP2618286.Kr_Dl292_Flag_ = 1;
    SELF.Exp11_ := __PP2618286.Kr_Dl293_Flag_ = 1;
    SELF.Exp12_ := __PP2618286.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp13_ := __PP2618286.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP2618286.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp15_ := __PP2618286.Safe_Flag_ = 1;
    SELF.Exp16_ := __OP2(__PP2618286.Event_Age_,<,__CN(2));
    SELF.Exp17_ := __AND(__OP2(__PP2618286.Event_Age_,<,__CN(2)),__CN(__PP2618286.In_Customer_Population_ = 1));
    SELF.Exp18_ := __OP2(__PP2618286.Event_Age_,<,__CN(366));
    SELF := __PP2618286;
  END;
  SHARED __EE2619059 := PROJECT(__EE2618285,__ND2619031__Project(LEFT));
  SHARED __ST2603588_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2619173 := PROJECT(__CLEANANDDO(__EE2619059,TABLE(__EE2619059,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2619059.Exp1_),KEL.Aggregates.MaxNG(__EE2619059.Event_Date__1_) M_A_X___Event_Date__1_,KEL.Aggregates.MinNG(__EE2619059.Exp2_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2619059.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2619059.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2619059.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2619059.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2619059.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2619059.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2619059.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2619059.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2619059.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2619059.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2619059.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2619059.Exp14_),KEL.Aggregates.MaxNG(__EE2619059.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2619059.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2619059.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2619059.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2619059.Exp18_)),UID},UID,MERGE)),__ST2603588_Layout);
  SHARED __ST2609061_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2619179(B_Drivers_License_1.__ST70399_Layout __EE2555581, __ST2603588_Layout __EE2619173) := __EEQP(__EE2555581.UID,__EE2619173.UID);
  __ST2609061_Layout __JT2619179(B_Drivers_License_1.__ST70399_Layout __l, __ST2603588_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2619247 := JOIN(__EE2555581,__EE2619173,__JC2619179(LEFT,RIGHT),__JT2619179(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2537175 := __ENH_Customer_1;
  SHARED __ST2609502_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2619253(__ST2609061_Layout __EE2619247, B_Customer_1.__ST69954_Layout __EE2537175) := __EEQP(__EE2619247._r_Customer_,__EE2537175.UID);
  __ST2609502_Layout __JT2619253(__ST2609061_Layout __l, B_Customer_1.__ST69954_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2619343 := JOIN(__EE2619247,__EE2537175,__JC2619253(LEFT,RIGHT),__JT2619253(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST47816_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47816_Layout __ND2619348__Project(__ST2609502_Layout __PP2619344) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_Last_Seen_ := __PP2619344.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_20'),+,__PP2619344.Otto_Drivers_License_Id_);
    SELF.Entity_Type_ := 20;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2619344.M_I_N___Event_Date__1_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2619344.Identity_Count_ > 2=>1,0);
    __BS2619504 := __T(__PP2619344.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2619504(__T(__OP2(__T(__PP2619344.Source_Customers_)._r_Source_Customer_,=,__PP2619344._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2619344.License_Number_;
    SELF.Last_Event_Date_ := __PP2619344.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP2619344.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2619344.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2619344.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2619344.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2619344.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2619344.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2619344.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2619344.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2619344.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2619344;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE2619343,__ND2619348__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE4316196 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4316196._r_Customer_;
    __EE4316196.Source_Customers_;
    __EE4316196.License_Number_;
    __EE4316196.State_;
    __EE4316196.Otto_Drivers_License_Id_;
    __EE4316196.Aot_Act_Cnt_Ev_;
    __EE4316196.Aot_Src1_Act_Cnt_Ev_;
    __EE4316196.Aot_Src1_Act_Only_Flag_;
    __EE4316196.Aot_Dl_Kr_Act_Cnt_Ev_;
    __EE4316196.Aot_Dl_Kr_Act_Shrd_Cnt_Ev_;
    __EE4316196.Aot_Dl_Kr_Act_Old_Dt_Ev_;
    __EE4316196.Aot_Dl_Kr_Act_New_Dt_Ev_;
    __EE4316196.Aot_Dl_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4316196.Aot_Dl_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4316196.Aot_Id_Act_Cnt_Ev_;
    __EE4316196.Aot_Id_Act_Cnt30_D_;
    __EE4316196.Aot_Add_Act_Cnt_Ev_;
    __EE4316196.Aot_Add_Act_Cnt30_D_;
    __EE4316196.Aot_Non_St_Act_Cnt_Ev_;
    __EE4316196.Aot_Non_St_Act_Cnt30_D_;
    __EE4316196.Aot_Dl_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4316196.Aot_Dl_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4316196.Aot_Dl_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4316196.Aot_Id_Curr_Prof_Usng_Dl_Cnt_Ev_;
    __EE4316196.Aot_Id_Hist_Prof_Usng_Dl_Cnt_Ev_;
    __EE4316196.Aot_Id_Usng_Dl_Cnt_Ev_;
    __EE4316196.Customer_Id_;
    __EE4316196.Industry_Type_;
    __EE4316196.Source_Customer_Count_;
    __EE4316196.Entity_Context_Uid_;
    __EE4316196.Entity_Type_;
    __EE4316196.Label_;
    __EE4316196.In_Customer_Population_;
    __EE4316196.Dt_First_Seen_;
    __EE4316196.Dt_Last_Seen_;
    __EE4316196.Id_Activity_Dt_First_Seen_;
    __EE4316196.Id_Activity_Dt_Last_Seen_;
    __EE4316196.Last_Record_Id_;
    __EE4316196.Identity_Count_;
    __EE4316196.Identity_Count_Gt2_;
    __EE4316196.Event_Count_;
    __EE4316196.Kr_High_Risk_Flag_;
    __EE4316196.Kr_Medium_Risk_Flag_;
    __EE4316196.Kr_Low_Risk_Flag_;
    __EE4316196.Kr_Flag_;
    __EE4316196.Safe_Flag_;
    __EE4316196.Contributor_Safe_Flag_;
    __EE4316196.Last_Event_Date_;
    __EE4316196.Kr_Last_Event_Date_;
    __EE4316196.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4316196.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4316196.Kr_Dl200_Flag_;
    __EE4316196.Kr_Dl201_Flag_;
    __EE4316196.Kr_Dl202_Flag_;
    __EE4316196.Kr_Dl203_Flag_;
    __EE4316196.Kr_Dl204_Flag_;
    __EE4316196.Kr_Dl290_Flag_;
    __EE4316196.Kr_Dl291_Flag_;
    __EE4316196.Kr_Dl292_Flag_;
    __EE4316196.Kr_Dl293_Flag_;
    __EE4316196.Vl_Event1_All_Count_;
    __EE4316196.Vl_Event7_All_Count_;
    __EE4316196.Vl_Event30_All_Day_Count_;
    __EE4316196.Vl_Event365_All_Day_Count_;
    __EE4316196.Vl_Event7_All_Active_Flag_;
    __EE4316196.Vl_Event30_All_Active_Flag_;
    __EE4316196.Vl_Event1_Count_;
    __EE4316196.Vl_Event7_Count_;
    __EE4316196.Vl_Event30_Count_;
    __EE4316196.Vl_Event365_Count_;
    __EE4316196.Vl_Event7_Active_Flag_;
    __EE4316196.Vl_Event30_Active_Flag_;
    __EE4316196.Date_First_Seen_;
    __EE4316196.Date_Last_Seen_;
    __EE4316196.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE4316196,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4316198_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST47816_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
