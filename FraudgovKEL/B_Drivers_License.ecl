...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE664353 := __ENH_Drivers_License_1;
  SHARED __EE667311 := __ENH_Event_1;
  SHARED __EE667309 := __E_Drivers_License_Event;
  SHARED __EE699829 := __EE667309(__NN(__EE667309.Licence_) AND __NN(__EE667309.Transaction_));
  SHARED __ST693825_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC699847(B_Event_1.__ST33354_Layout __EE667311, E_Drivers_License_Event.Layout __EE699829) := __EEQP(__EE699829.Transaction_,__EE667311.UID);
  __ST693825_Layout __JT699847(B_Event_1.__ST33354_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE699848 := JOIN(__EE699829,__EE667311,__JC699847(RIGHT,LEFT),__JT699847(RIGHT,LEFT),INNER,HASH);
  SHARED __ST691415_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST691415_Layout __ND700271__Project(__ST693825_Layout __PP699849) := TRANSFORM
    SELF.UID := __PP699849.Licence_;
    SELF._r_Customer_ := __PP699849._r_Customer__1_;
    SELF.Event_Date_ := __PP699849.Event_Date__1_;
    SELF.U_I_D__1_ := __PP699849.UID;
    SELF.Event_Date__1_ := __PP699849.Event_Date_;
    SELF._r_Customer__1_ := __PP699849._r_Customer_;
    SELF := __PP699849;
  END;
  SHARED __EE701924 := PROJECT(__EE699848,__ND700271__Project(LEFT));
  SHARED __ST692320_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST692320_Layout __ND702524__Project(__ST691415_Layout __PP701925) := TRANSFORM
    SELF.Exp1_ := __PP701925.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP701925.Kr_Dl200_Flag_ = 1;
    SELF.Exp3_ := __PP701925.Kr_Dl201_Flag_ = 1;
    SELF.Exp4_ := __PP701925.Kr_Dl202_Flag_ = 1;
    SELF.Exp5_ := __PP701925.Kr_Dl203_Flag_ = 1;
    SELF.Exp6_ := __PP701925.Kr_Dl204_Flag_ = 1;
    SELF.Exp7_ := __PP701925.Kr_Dl290_Flag_ = 1;
    SELF.Exp8_ := __PP701925.Kr_Dl291_Flag_ = 1;
    SELF.Exp9_ := __PP701925.Kr_Dl292_Flag_ = 1;
    SELF.Exp10_ := __PP701925.Kr_Dl293_Flag_ = 1;
    SELF.Exp11_ := __PP701925.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp12_ := __PP701925.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp13_ := __PP701925.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP701925.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP701925.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP701925.Event_Age_,<,__CN(2)),__CN(__PP701925.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP701925.Event_Age_,<,__CN(366));
    SELF := __PP701925;
  END;
  SHARED __EE702551 := PROJECT(__EE701924,__ND702524__Project(LEFT));
  SHARED __ST692426_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE702665 := PROJECT(__CLEANANDDO(__EE702551,TABLE(__EE702551,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE702551.Exp1_),KEL.Aggregates.MinNG(__EE702551.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE702551.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE702551.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE702551.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE702551.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE702551.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE702551.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE702551.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE702551.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE702551.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE702551.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE702551.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE702551.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE702551.Exp13_),KEL.Aggregates.MaxNG(__EE702551.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE702551.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE702551.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE702551.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE702551.Exp17_)),UID},UID,MERGE)),__ST692426_Layout);
  SHARED __ST695913_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC702671(B_Drivers_License_1.__ST30642_Layout __EE664353, __ST692426_Layout __EE702665) := __EEQP(__EE664353.UID,__EE702665.UID);
  __ST695913_Layout __JT702671(B_Drivers_License_1.__ST30642_Layout __l, __ST692426_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE702716 := JOIN(__EE664353,__EE702665,__JC702671(LEFT,RIGHT),__JT702671(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE652629 := __ENH_Customer_1;
  SHARED __ST696239_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC702722(__ST695913_Layout __EE702716, B_Customer_1.__ST30513_Layout __EE652629) := __EEQP(__EE702716._r_Customer_,__EE652629.UID);
  __ST696239_Layout __JT702722(__ST695913_Layout __l, B_Customer_1.__ST30513_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE702789 := JOIN(__EE702716,__EE652629,__JC702722(LEFT,RIGHT),__JT702722(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST22002_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST22002_Layout __ND702794__Project(__ST696239_Layout __PP702790) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP702790.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP702790.M_A_X___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_20'),+,__PP702790.Otto_Drivers_License_Id_);
    SELF.Entity_Type_ := 20;
    SELF.Identity_Count_Gt2_ := MAP(__PP702790.Identity_Count_ > 2=>1,0);
    __BS702881 := __T(__PP702790.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS702881(__T(__OP2(__T(__PP702790.Source_Customers_)._r_Source_Customer_,=,__PP702790._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP702790.License_Number_;
    SELF.Last_Event_Date_ := __PP702790.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP702790.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP702790.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP702790.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP702790.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP702790.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP702790.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP702790.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP702790.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP702790.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP702790;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE702789,__ND702794__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE1298797 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1298797._r_Customer_;
    __EE1298797.Source_Customers_;
    __EE1298797.License_Number_;
    __EE1298797.State_;
    __EE1298797.Otto_Drivers_License_Id_;
    __EE1298797.Customer_Id_;
    __EE1298797.Industry_Type_;
    __EE1298797.Source_Customer_Count_;
    __EE1298797.Entity_Context_Uid_;
    __EE1298797.Entity_Type_;
    __EE1298797.Label_;
    __EE1298797.In_Customer_Population_;
    __EE1298797.Dt_First_Seen_;
    __EE1298797.Dt_Last_Seen_;
    __EE1298797.Last_Record_Id_;
    __EE1298797.Identity_Count_;
    __EE1298797.Identity_Count_Gt2_;
    __EE1298797.Event_Count_;
    __EE1298797.Kr_High_Risk_Flag_;
    __EE1298797.Kr_Medium_Risk_Flag_;
    __EE1298797.Kr_Low_Risk_Flag_;
    __EE1298797.Kr_Flag_;
    __EE1298797.Safe_Flag_;
    __EE1298797.Contributor_Safe_Flag_;
    __EE1298797.Last_Event_Date_;
    __EE1298797.Kr_Last_Event_Date_;
    __EE1298797.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1298797.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1298797.Kr_Dl200_Flag_;
    __EE1298797.Kr_Dl201_Flag_;
    __EE1298797.Kr_Dl202_Flag_;
    __EE1298797.Kr_Dl203_Flag_;
    __EE1298797.Kr_Dl204_Flag_;
    __EE1298797.Kr_Dl290_Flag_;
    __EE1298797.Kr_Dl291_Flag_;
    __EE1298797.Kr_Dl292_Flag_;
    __EE1298797.Kr_Dl293_Flag_;
    __EE1298797.Vl_Event1_All_Count_;
    __EE1298797.Vl_Event7_All_Count_;
    __EE1298797.Vl_Event30_All_Day_Count_;
    __EE1298797.Vl_Event365_All_Day_Count_;
    __EE1298797.Vl_Event7_All_Active_Flag_;
    __EE1298797.Vl_Event30_All_Active_Flag_;
    __EE1298797.Vl_Event1_Count_;
    __EE1298797.Vl_Event7_Count_;
    __EE1298797.Vl_Event30_Count_;
    __EE1298797.Vl_Event365_Count_;
    __EE1298797.Vl_Event7_Active_Flag_;
    __EE1298797.Vl_Event30_Active_Flag_;
    __EE1298797.Date_First_Seen_;
    __EE1298797.Date_Last_Seen_;
    __EE1298797.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE1298797,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1298799_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST22002_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
