...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE625947 := __ENH_Drivers_License_1;
  SHARED __EE662747 := __E_Drivers_License_Event;
  SHARED __EE662754 := __EE662747(__NN(__EE662747.Licence_));
  SHARED __ST656484_Layout := RECORD
    KEL.typ.int C_O_U_N_T___Drivers_License_Event_ := 0;
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE662745 := PROJECT(__CLEANANDDO(__EE662754,TABLE(__EE662754,{KEL.typ.int C_O_U_N_T___Drivers_License_Event_ := COUNT(GROUP),KEL.typ.ntyp(E_Drivers_License.Typ) UID := __EE662754.Licence_},Licence_,MERGE)),__ST656484_Layout);
  SHARED __ST658772_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC662774(B_Drivers_License_1.__ST32382_Layout __EE625947, __ST656484_Layout __EE662745) := __EEQP(__EE625947.UID,__EE662745.UID);
  __ST658772_Layout __JT662774(B_Drivers_License_1.__ST32382_Layout __l, __ST656484_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE662775 := JOIN(__EE625947,__EE662745,__JC662774(LEFT,RIGHT),__JT662774(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE662758 := __ENH_Event_1;
  SHARED __EE667214 := __EE662747;
  SHARED __EE667227 := __EE667214(__NN(__EE667214.Licence_) AND __NN(__EE667214.Transaction_));
  SHARED __ST656870_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC667233(B_Event_1.__ST35236_Layout __EE662758, E_Drivers_License_Event.Layout __EE667227) := __EEQP(__EE667227.Transaction_,__EE662758.UID);
  __ST656870_Layout __JT667233(B_Event_1.__ST35236_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE667234 := JOIN(__EE667227,__EE662758,__JC667233(RIGHT,LEFT),__JT667233(RIGHT,LEFT),INNER,HASH);
  SHARED __ST654172_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Drivers_License.Typ) Licence_;
    KEL.typ.nkdate Event_Date_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST654172_Layout __ND667621__Project(__ST656870_Layout __PP667235) := TRANSFORM
    SELF.UID := __PP667235.Licence_;
    SELF._r_Customer_ := __PP667235._r_Customer__1_;
    SELF.Event_Date_ := __PP667235.Event_Date__1_;
    SELF.U_I_D__1_ := __PP667235.UID;
    SELF.Event_Date__1_ := __PP667235.Event_Date_;
    SELF._r_Customer__1_ := __PP667235._r_Customer_;
    SELF := __PP667235;
  END;
  SHARED __EE669122 := PROJECT(__EE667234,__ND667621__Project(LEFT));
  SHARED __ST655020_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST655020_Layout __ND669777__Project(__ST654172_Layout __PP669123) := TRANSFORM
    SELF.Exp1_ := __PP669123.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP669123.Hri41_Flag_ = 1;
    SELF.Exp3_ := __PP669123.Hri_Df_Flag_ = 1;
    SELF.Exp4_ := __PP669123.Kr_Dl200_Flag_ = 1;
    SELF.Exp5_ := __PP669123.Kr_Dl201_Flag_ = 1;
    SELF.Exp6_ := __PP669123.Kr_Dl202_Flag_ = 1;
    SELF.Exp7_ := __PP669123.Kr_Dl203_Flag_ = 1;
    SELF.Exp8_ := __PP669123.Kr_Dl204_Flag_ = 1;
    SELF.Exp9_ := __PP669123.Kr_Dl290_Flag_ = 1;
    SELF.Exp10_ := __PP669123.Kr_Dl291_Flag_ = 1;
    SELF.Exp11_ := __PP669123.Kr_Dl292_Flag_ = 1;
    SELF.Exp12_ := __PP669123.Kr_Dl293_Flag_ = 1;
    SELF.Exp13_ := __PP669123.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP669123.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp15_ := __PP669123.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp16_ := __PP669123.Safe_Flag_ = 1;
    SELF.Exp17_ := __OP2(__PP669123.Age_,<,__CN(2));
    SELF.Exp18_ := __AND(__OP2(__PP669123.Age_,<,__CN(2)),__CN(__PP669123.In_Customer_Population_ = 1));
    SELF.Exp19_ := __OP2(__PP669123.Age_,<,__CN(366));
    SELF.Exp20_ := __AND(__OP2(__PP669123.Age_,<,__CN(366)),__CN(__PP669123.In_Customer_Population_ = 1));
    SELF := __PP669123;
  END;
  SHARED __EE669811 := PROJECT(__EE669122,__ND669777__Project(LEFT));
  SHARED __ST655141_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE669941 := PROJECT(__CLEANANDDO(__EE669811,TABLE(__EE669811,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE669811.Exp1_),KEL.Aggregates.MinNG(__EE669811.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MaxNG(__EE669811.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE669811.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE669811.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE669811.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE669811.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE669811.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE669811.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE669811.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE669811.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE669811.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE669811.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE669811.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE669811.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE669811.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__EE669811.Exp15_),KEL.Aggregates.MaxNG(__EE669811.Event_Date__1_) M_A_X___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__EE669811.Exp16_),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE669811.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__17_ := COUNT(GROUP,__T(__EE669811.Exp18_)),KEL.typ.int C_O_U_N_T___Exp1__18_ := COUNT(GROUP,__T(__EE669811.Exp19_)),KEL.typ.int C_O_U_N_T___Exp1__19_ := COUNT(GROUP,__T(__EE669811.Exp20_)),UID},UID,MERGE)),__ST655141_Layout);
  SHARED __ST659018_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC669947(__ST658772_Layout __EE662775, __ST655141_Layout __EE669941) := __EEQP(__EE662775.UID,__EE669941.UID);
  __ST659018_Layout __JT669947(__ST658772_Layout __l, __ST655141_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE669996 := JOIN(__EE662775,__EE669941,__JC669947(LEFT,RIGHT),__JT669947(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE614833 := __ENH_Customer_1;
  SHARED __ST659361_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC670002(__ST659018_Layout __EE669996, B_Customer_1.__ST32268_Layout __EE614833) := __EEQP(__EE669996._r_Customer_,__EE614833.UID);
  __ST659361_Layout __JT670002(__ST659018_Layout __l, B_Customer_1.__ST32268_Layout __r) := TRANSFORM
    SELF.U_I_D__3_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE670073 := JOIN(__EE669996,__EE614833,__JC670002(LEFT,RIGHT),__JT670002(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST23464_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST23464_Layout __ND670078__Project(__ST659361_Layout __PP670074) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP670074.M_I_N___Event_Date__1_;
    SELF.Dt_Last_Seen_ := __PP670074.M_A_X___Event_Date__1_;
    SELF.Entity_Type_ := 20;
    SELF.Event_Count_ := __PP670074.C_O_U_N_T___Drivers_License_Event_;
    SELF.Hri41_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Hri_Df_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Identity_Count_Gt2_ := MAP(__PP670074.Identity_Count_ > 2=>1,0);
    __BS670173 := __T(__PP670074.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS670173(__T(__OP2(__T(__PP670074.Source_Customers_)._r_Source_Customer_,=,__PP670074._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Event_After_Last_Known_Risk_Flag_ := MAP(__PP670074.Kr_Event_After_Last_Known_Risk_Count_ > 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__14_ <> 0=>1,0);
    SELF.Last_Event_Date_ := __PP670074.M_A_X___Event_Date__2_;
    SELF.Safe_Flag_ := MAP(__PP670074.C_O_U_N_T___Exp1__15_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP670074.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP670074.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event1_Count_ := __PP670074.C_O_U_N_T___Exp1__17_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP670074.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP670074.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP670074.C_O_U_N_T___Exp1__18_;
    SELF.Vl_Event365_Count_ := __PP670074.C_O_U_N_T___Exp1__19_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP670074.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP670074.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP670074;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE670073,__ND670078__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE1360940 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE1360940._r_Customer_;
    __EE1360940.Source_Customers_;
    __EE1360940.License_Number_;
    __EE1360940.State_;
    __EE1360940.Otto_Drivers_License_Id_;
    __EE1360940.Customer_Id_;
    __EE1360940.Industry_Type_;
    __EE1360940.Source_Customer_Count_;
    __EE1360940.Entity_Context_Uid_;
    __EE1360940.Entity_Type_;
    __EE1360940.Label_;
    __EE1360940.In_Customer_Population_;
    __EE1360940.Dt_First_Seen_;
    __EE1360940.Dt_Last_Seen_;
    __EE1360940.Last_Record_Id_;
    __EE1360940.Identity_Count_;
    __EE1360940.Identity_Count_Gt2_;
    __EE1360940.Event_Count_;
    __EE1360940.Hri41_Flag_;
    __EE1360940.Hri_Df_Flag_;
    __EE1360940.Kr_High_Risk_Flag_;
    __EE1360940.Kr_Medium_Risk_Flag_;
    __EE1360940.Kr_Low_Risk_Flag_;
    __EE1360940.Kr_Flag_;
    __EE1360940.Safe_Flag_;
    __EE1360940.Contributor_Safe_Flag_;
    __EE1360940.Last_Event_Date_;
    __EE1360940.Kr_Last_Event_Date_;
    __EE1360940.Kr_Event_After_Last_Known_Risk_Count_;
    __EE1360940.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE1360940.Kr_Dl200_Flag_;
    __EE1360940.Kr_Dl201_Flag_;
    __EE1360940.Kr_Dl202_Flag_;
    __EE1360940.Kr_Dl203_Flag_;
    __EE1360940.Kr_Dl204_Flag_;
    __EE1360940.Kr_Dl290_Flag_;
    __EE1360940.Kr_Dl291_Flag_;
    __EE1360940.Kr_Dl292_Flag_;
    __EE1360940.Kr_Dl293_Flag_;
    __EE1360940.Vl_Event1_All_Count_;
    __EE1360940.Vl_Event7_All_Count_;
    __EE1360940.Vl_Event30_All_Day_Count_;
    __EE1360940.Vl_Event365_All_Day_Count_;
    __EE1360940.Vl_Event7_All_Active_Flag_;
    __EE1360940.Vl_Event30_All_Active_Flag_;
    __EE1360940.Vl_Event1_Count_;
    __EE1360940.Vl_Event7_Count_;
    __EE1360940.Vl_Event30_Count_;
    __EE1360940.Vl_Event365_Count_;
    __EE1360940.Vl_Event7_Active_Flag_;
    __EE1360940.Vl_Event30_Active_Flag_;
    __EE1360940.Date_First_Seen_;
    __EE1360940.Date_Last_Seen_;
    __EE1360940.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE1360940,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST1360942_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST23464_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
