...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE2461702 := __ENH_Drivers_License_1;
  SHARED __EE2466106 := __ENH_Event_1;
  SHARED __EE2466104 := __E_Drivers_License_Event;
  SHARED __EE2517996 := __EE2466104(__NN(__EE2466104.Licence_) AND __NN(__EE2466104.Transaction_));
  SHARED __ST2508986_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2518014(B_Event_1.__ST76927_Layout __EE2466106, E_Drivers_License_Event.Layout __EE2517996) := __EEQP(__EE2517996.Transaction_,__EE2466106.UID);
  __ST2508986_Layout __JT2518014(B_Event_1.__ST76927_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2518015 := JOIN(__EE2517996,__EE2466106,__JC2518014(RIGHT,LEFT),__JT2518014(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2505486_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2505486_Layout __ND2518706__Project(__ST2508986_Layout __PP2518016) := TRANSFORM
    SELF.UID := __PP2518016.Licence_;
    SELF._r_Customer_ := __PP2518016._r_Customer__1_;
    SELF.Event_Date_ := __PP2518016.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2518016.UID;
    SELF.Event_Date__1_ := __PP2518016.Event_Date_;
    SELF._r_Customer__1_ := __PP2518016._r_Customer_;
    SELF := __PP2518016;
  END;
  SHARED __EE2521431 := PROJECT(__EE2518015,__ND2518706__Project(LEFT));
  SHARED __ST2506923_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2506923_Layout __ND2522134__Project(__ST2505486_Layout __PP2521432) := TRANSFORM
    SELF.Exp1_ := __PP2521432.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP2521432.Kr_Dl200_Flag_ = 1;
    SELF.Exp3_ := __PP2521432.Kr_Dl201_Flag_ = 1;
    SELF.Exp4_ := __PP2521432.Kr_Dl202_Flag_ = 1;
    SELF.Exp5_ := __PP2521432.Kr_Dl203_Flag_ = 1;
    SELF.Exp6_ := __PP2521432.Kr_Dl204_Flag_ = 1;
    SELF.Exp7_ := __PP2521432.Kr_Dl290_Flag_ = 1;
    SELF.Exp8_ := __PP2521432.Kr_Dl291_Flag_ = 1;
    SELF.Exp9_ := __PP2521432.Kr_Dl292_Flag_ = 1;
    SELF.Exp10_ := __PP2521432.Kr_Dl293_Flag_ = 1;
    SELF.Exp11_ := __PP2521432.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp12_ := __PP2521432.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp13_ := __PP2521432.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP2521432.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP2521432.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP2521432.Event_Age_,<,__CN(2)),__CN(__PP2521432.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP2521432.Event_Age_,<,__CN(366));
    SELF := __PP2521432;
  END;
  SHARED __EE2522161 := PROJECT(__EE2521431,__ND2522134__Project(LEFT));
  SHARED __ST2507026_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2522270 := PROJECT(__CLEANANDDO(__EE2522161,TABLE(__EE2522161,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2522161.Exp1_),KEL.Aggregates.MinNG(__EE2522161.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2522161.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2522161.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2522161.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2522161.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2522161.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2522161.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2522161.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2522161.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2522161.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2522161.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2522161.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2522161.Exp13_),KEL.Aggregates.MaxNG(__EE2522161.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2522161.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2522161.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2522161.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2522161.Exp17_)),UID},UID,MERGE)),__ST2507026_Layout);
  SHARED __ST2512414_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2522276(B_Drivers_License_1.__ST69327_Layout __EE2461702, __ST2507026_Layout __EE2522270) := __EEQP(__EE2461702.UID,__EE2522270.UID);
  __ST2512414_Layout __JT2522276(B_Drivers_License_1.__ST69327_Layout __l, __ST2507026_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2522339 := JOIN(__EE2461702,__EE2522270,__JC2522276(LEFT,RIGHT),__JT2522276(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2449010 := __ENH_Customer_1;
  SHARED __ST2512830_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2522345(__ST2512414_Layout __EE2522339, B_Customer_1.__ST68903_Layout __EE2449010) := __EEQP(__EE2522339._r_Customer_,__EE2449010.UID);
  __ST2512830_Layout __JT2522345(__ST2512414_Layout __l, B_Customer_1.__ST68903_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2522430 := JOIN(__EE2522339,__EE2449010,__JC2522345(LEFT,RIGHT),__JT2522345(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST47090_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST47090_Layout __ND2522435__Project(__ST2512830_Layout __PP2522431) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2522431.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_20'),+,__PP2522431.Otto_Drivers_License_Id_);
    SELF.Entity_Type_ := 20;
    SELF.Identity_Count_Gt2_ := MAP(__PP2522431.Identity_Count_ > 2=>1,0);
    __BS2522576 := __T(__PP2522431.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2522576(__T(__OP2(__T(__PP2522431.Source_Customers_)._r_Source_Customer_,=,__PP2522431._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2522431.License_Number_;
    SELF.Last_Event_Date_ := __PP2522431.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2522431.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2522431.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2522431.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2522431.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2522431.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2522431.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2522431.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2522431.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2522431.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2522431;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE2522430,__ND2522435__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE4092226 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4092226._r_Customer_;
    __EE4092226.Source_Customers_;
    __EE4092226.License_Number_;
    __EE4092226.State_;
    __EE4092226.Otto_Drivers_License_Id_;
    __EE4092226.Aot_Dl_Kr_Act_Cnt_Ev_;
    __EE4092226.Aot_Dl_Kr_Act_Shrd_Cnt_Ev_;
    __EE4092226.Aot_Dl_Kr_Act_Old_Dt_Ev_;
    __EE4092226.Aot_Dl_Kr_Act_New_Dt_Ev_;
    __EE4092226.Aot_Dl_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4092226.Aot_Dl_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4092226.Aot_Id_Act_Cnt_Ev_;
    __EE4092226.Aot_Id_Act_Cnt30_D_;
    __EE4092226.Aot_Add_Act_Cnt_Ev_;
    __EE4092226.Aot_Add_Act_Cnt30_D_;
    __EE4092226.Aot_Non_St_Act_Cnt_Ev_;
    __EE4092226.Aot_Non_St_Act_Cnt30_D_;
    __EE4092226.Aot_Dl_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4092226.Aot_Dl_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4092226.Aot_Dl_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4092226.Aot_Id_Curr_Prof_Usng_Dl_Cnt_Ev_;
    __EE4092226.Aot_Id_Hist_Prof_Usng_Dl_Cnt_Ev_;
    __EE4092226.Aot_Id_Usng_Dl_Cnt_Ev_;
    __EE4092226.Customer_Id_;
    __EE4092226.Industry_Type_;
    __EE4092226.Source_Customer_Count_;
    __EE4092226.Entity_Context_Uid_;
    __EE4092226.Entity_Type_;
    __EE4092226.Label_;
    __EE4092226.In_Customer_Population_;
    __EE4092226.Dt_First_Seen_;
    __EE4092226.Dt_Last_Seen_;
    __EE4092226.Last_Record_Id_;
    __EE4092226.Identity_Count_;
    __EE4092226.Identity_Count_Gt2_;
    __EE4092226.Event_Count_;
    __EE4092226.Kr_High_Risk_Flag_;
    __EE4092226.Kr_Medium_Risk_Flag_;
    __EE4092226.Kr_Low_Risk_Flag_;
    __EE4092226.Kr_Flag_;
    __EE4092226.Safe_Flag_;
    __EE4092226.Contributor_Safe_Flag_;
    __EE4092226.Last_Event_Date_;
    __EE4092226.Kr_Last_Event_Date_;
    __EE4092226.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4092226.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4092226.Kr_Dl200_Flag_;
    __EE4092226.Kr_Dl201_Flag_;
    __EE4092226.Kr_Dl202_Flag_;
    __EE4092226.Kr_Dl203_Flag_;
    __EE4092226.Kr_Dl204_Flag_;
    __EE4092226.Kr_Dl290_Flag_;
    __EE4092226.Kr_Dl291_Flag_;
    __EE4092226.Kr_Dl292_Flag_;
    __EE4092226.Kr_Dl293_Flag_;
    __EE4092226.Vl_Event1_All_Count_;
    __EE4092226.Vl_Event7_All_Count_;
    __EE4092226.Vl_Event30_All_Day_Count_;
    __EE4092226.Vl_Event365_All_Day_Count_;
    __EE4092226.Vl_Event7_All_Active_Flag_;
    __EE4092226.Vl_Event30_All_Active_Flag_;
    __EE4092226.Vl_Event1_Count_;
    __EE4092226.Vl_Event7_Count_;
    __EE4092226.Vl_Event30_Count_;
    __EE4092226.Vl_Event365_Count_;
    __EE4092226.Vl_Event7_Active_Flag_;
    __EE4092226.Vl_Event30_Active_Flag_;
    __EE4092226.Date_First_Seen_;
    __EE4092226.Date_Last_Seen_;
    __EE4092226.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE4092226,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4092228_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST47090_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
