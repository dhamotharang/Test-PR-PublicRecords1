...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE1456638 := __ENH_Drivers_License_1;
  SHARED __EE1460153 := __ENH_Event_1;
  SHARED __EE1460151 := __E_Drivers_License_Event;
  SHARED __EE1500360 := __EE1460151(__NN(__EE1460151.Licence_) AND __NN(__EE1460151.Transaction_));
  SHARED __ST1493188_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1500378(B_Event_1.__ST52969_Layout __EE1460153, E_Drivers_License_Event.Layout __EE1500360) := __EEQP(__EE1500360.Transaction_,__EE1460153.UID);
  __ST1493188_Layout __JT1500378(B_Event_1.__ST52969_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1500379 := JOIN(__EE1500360,__EE1460153,__JC1500378(RIGHT,LEFT),__JT1500378(RIGHT,LEFT),INNER,HASH);
  SHARED __ST1490356_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1490356_Layout __ND1500909__Project(__ST1493188_Layout __PP1500380) := TRANSFORM
    SELF.UID := __PP1500380.Licence_;
    SELF._r_Customer_ := __PP1500380._r_Customer__1_;
    SELF.Event_Date_ := __PP1500380.Event_Date__1_;
    SELF.U_I_D__1_ := __PP1500380.UID;
    SELF.Event_Date__1_ := __PP1500380.Event_Date_;
    SELF._r_Customer__1_ := __PP1500380._r_Customer_;
    SELF := __PP1500380;
  END;
  SHARED __EE1502990 := PROJECT(__EE1500379,__ND1500909__Project(LEFT));
  SHARED __ST1491471_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST1491471_Layout __ND1503621__Project(__ST1490356_Layout __PP1502991) := TRANSFORM
    SELF.Exp1_ := __PP1502991.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := __PP1502991.Kr_Dl200_Flag_ = 1;
    SELF.Exp3_ := __PP1502991.Kr_Dl201_Flag_ = 1;
    SELF.Exp4_ := __PP1502991.Kr_Dl202_Flag_ = 1;
    SELF.Exp5_ := __PP1502991.Kr_Dl203_Flag_ = 1;
    SELF.Exp6_ := __PP1502991.Kr_Dl204_Flag_ = 1;
    SELF.Exp7_ := __PP1502991.Kr_Dl290_Flag_ = 1;
    SELF.Exp8_ := __PP1502991.Kr_Dl291_Flag_ = 1;
    SELF.Exp9_ := __PP1502991.Kr_Dl292_Flag_ = 1;
    SELF.Exp10_ := __PP1502991.Kr_Dl293_Flag_ = 1;
    SELF.Exp11_ := __PP1502991.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp12_ := __PP1502991.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp13_ := __PP1502991.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP1502991.Safe_Flag_ = 1;
    SELF.Exp15_ := __OP2(__PP1502991.Event_Age_,<,__CN(2));
    SELF.Exp16_ := __AND(__OP2(__PP1502991.Event_Age_,<,__CN(2)),__CN(__PP1502991.In_Customer_Population_ = 1));
    SELF.Exp17_ := __OP2(__PP1502991.Event_Age_,<,__CN(366));
    SELF := __PP1502991;
  END;
  SHARED __EE1503648 := PROJECT(__EE1502990,__ND1503621__Project(LEFT));
  SHARED __ST1491574_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE1503757 := PROJECT(__CLEANANDDO(__EE1503648,TABLE(__EE1503648,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE1503648.Exp1_),KEL.Aggregates.MinNG(__EE1503648.Event_Date__1_) M_I_N___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE1503648.Exp2_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE1503648.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE1503648.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE1503648.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE1503648.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE1503648.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE1503648.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE1503648.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE1503648.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE1503648.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE1503648.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE1503648.Exp13_),KEL.Aggregates.MaxNG(__EE1503648.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE1503648.Exp14_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE1503648.Exp15_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE1503648.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE1503648.Exp17_)),UID},UID,MERGE)),__ST1491574_Layout);
  SHARED __ST1495811_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1503763(B_Drivers_License_1.__ST47661_Layout __EE1456638, __ST1491574_Layout __EE1503757) := __EEQP(__EE1456638.UID,__EE1503757.UID);
  __ST1495811_Layout __JT1503763(B_Drivers_License_1.__ST47661_Layout __l, __ST1491574_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1503814 := JOIN(__EE1456638,__EE1503757,__JC1503763(LEFT,RIGHT),__JT1503763(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE1446534 := __ENH_Customer_1;
  SHARED __ST1496167_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1503820(__ST1495811_Layout __EE1503814, B_Customer_1.__ST47418_Layout __EE1446534) := __EEQP(__EE1503814._r_Customer_,__EE1446534.UID);
  __ST1496167_Layout __JT1503820(__ST1495811_Layout __l, B_Customer_1.__ST47418_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1503893 := JOIN(__EE1503814,__EE1446534,__JC1503820(LEFT,RIGHT),__JT1503820(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST32976_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32976_Layout __ND1503898__Project(__ST1496167_Layout __PP1503894) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP1503894.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_20'),+,__PP1503894.Otto_Drivers_License_Id_);
    SELF.Entity_Type_ := 20;
    SELF.Identity_Count_Gt2_ := MAP(__PP1503894.Identity_Count_ > 2=>1,0);
    __BS1504003 := __T(__PP1503894.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS1504003(__T(__OP2(__T(__PP1503894.Source_Customers_)._r_Source_Customer_,=,__PP1503894._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP1503894.License_Number_;
    SELF.Last_Event_Date_ := __PP1503894.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP1503894.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP1503894.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP1503894.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP1503894.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP1503894.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP1503894.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP1503894.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP1503894.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP1503894.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP1503894;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE1503893,__ND1503898__Project(LEFT)) : PERSIST('~temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE2334678 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE2334678._r_Customer_;
    __EE2334678.Source_Customers_;
    __EE2334678.License_Number_;
    __EE2334678.State_;
    __EE2334678.Otto_Drivers_License_Id_;
    __EE2334678.Aot_Dl_Kr_Act_Cnt_Ev_;
    __EE2334678.Aot_Dl_Kr_Act_Shrd_Cnt_Ev_;
    __EE2334678.Aot_Dl_Kr_Act_Old_Dt_Ev_;
    __EE2334678.Aot_Dl_Kr_Act_New_Dt_Ev_;
    __EE2334678.Aot_Dl_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE2334678.Aot_Dl_Kr_Act_Shrd_New_Dt_Ev_;
    __EE2334678.Customer_Id_;
    __EE2334678.Industry_Type_;
    __EE2334678.Source_Customer_Count_;
    __EE2334678.Entity_Context_Uid_;
    __EE2334678.Entity_Type_;
    __EE2334678.Label_;
    __EE2334678.In_Customer_Population_;
    __EE2334678.Dt_First_Seen_;
    __EE2334678.Dt_Last_Seen_;
    __EE2334678.Last_Record_Id_;
    __EE2334678.Identity_Count_;
    __EE2334678.Identity_Count_Gt2_;
    __EE2334678.Event_Count_;
    __EE2334678.Kr_High_Risk_Flag_;
    __EE2334678.Kr_Medium_Risk_Flag_;
    __EE2334678.Kr_Low_Risk_Flag_;
    __EE2334678.Kr_Flag_;
    __EE2334678.Safe_Flag_;
    __EE2334678.Contributor_Safe_Flag_;
    __EE2334678.Last_Event_Date_;
    __EE2334678.Kr_Last_Event_Date_;
    __EE2334678.Kr_Event_After_Last_Known_Risk_Count_;
    __EE2334678.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE2334678.Kr_Dl200_Flag_;
    __EE2334678.Kr_Dl201_Flag_;
    __EE2334678.Kr_Dl202_Flag_;
    __EE2334678.Kr_Dl203_Flag_;
    __EE2334678.Kr_Dl204_Flag_;
    __EE2334678.Kr_Dl290_Flag_;
    __EE2334678.Kr_Dl291_Flag_;
    __EE2334678.Kr_Dl292_Flag_;
    __EE2334678.Kr_Dl293_Flag_;
    __EE2334678.Vl_Event1_All_Count_;
    __EE2334678.Vl_Event7_All_Count_;
    __EE2334678.Vl_Event30_All_Day_Count_;
    __EE2334678.Vl_Event365_All_Day_Count_;
    __EE2334678.Vl_Event7_All_Active_Flag_;
    __EE2334678.Vl_Event30_All_Active_Flag_;
    __EE2334678.Vl_Event1_Count_;
    __EE2334678.Vl_Event7_Count_;
    __EE2334678.Vl_Event30_Count_;
    __EE2334678.Vl_Event365_Count_;
    __EE2334678.Vl_Event7_Active_Flag_;
    __EE2334678.Vl_Event30_Active_Flag_;
    __EE2334678.Date_First_Seen_;
    __EE2334678.Date_Last_Seen_;
    __EE2334678.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE2334678,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST2334680_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST32976_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
