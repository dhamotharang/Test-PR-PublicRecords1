...
EXPORT B_Drivers_License := MODULE
  ...
  SHARED __EE2712197 := __ENH_Drivers_License_1;
  SHARED __EE2716822 := __ENH_Event_1;
  SHARED __EE2716820 := __E_Drivers_License_Event;
  SHARED __EE2773401 := __EE2716820(__NN(__EE2716820.Licence_) AND __NN(__EE2716820.Transaction_));
  SHARED __ST2763934_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2773419(B_Event_1.__ST83458_Layout __EE2716822, E_Drivers_License_Event.Layout __EE2773401) := __EEQP(__EE2773401.Transaction_,__EE2716822.UID);
  __ST2763934_Layout __JT2773419(B_Event_1.__ST83458_Layout __l, E_Drivers_License_Event.Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF.Event_Date__1_ := __r.Event_Date_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2773420 := JOIN(__EE2773401,__EE2716822,__JC2773419(RIGHT,LEFT),__JT2773419(RIGHT,LEFT),INNER,HASH);
  SHARED __ST2760262_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2760262_Layout __ND2774144__Project(__ST2763934_Layout __PP2773421) := TRANSFORM
    SELF.UID := __PP2773421.Licence_;
    SELF._r_Customer_ := __PP2773421._r_Customer__1_;
    SELF.Event_Date_ := __PP2773421.Event_Date__1_;
    SELF.U_I_D__1_ := __PP2773421.UID;
    SELF.Event_Date__1_ := __PP2773421.Event_Date_;
    SELF._r_Customer__1_ := __PP2773421._r_Customer_;
    SELF := __PP2773421;
  END;
  SHARED __EE2777001 := PROJECT(__EE2773420,__ND2774144__Project(LEFT));
  SHARED __ST2761771_Layout := RECORD
    KEL.typ.ntyp(E_Drivers_License.Typ) UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST2761771_Layout __ND2777747__Project(__ST2760262_Layout __PP2777002) := TRANSFORM
    SELF.Exp1_ := __PP2777002.Contributor_Safe_Flag_ = 1;
    SELF.Exp2_ := IF(__PP2777002.T___Src_Class_Type_ = 4,__ECAST(KEL.typ.nkdate,__PP2777002.Event_Date__1_),__ECAST(KEL.typ.nkdate,__N(KEL.typ.kdate)));
    SELF.Exp3_ := __PP2777002.Kr_Dl200_Flag_ = 1;
    SELF.Exp4_ := __PP2777002.Kr_Dl201_Flag_ = 1;
    SELF.Exp5_ := __PP2777002.Kr_Dl202_Flag_ = 1;
    SELF.Exp6_ := __PP2777002.Kr_Dl203_Flag_ = 1;
    SELF.Exp7_ := __PP2777002.Kr_Dl204_Flag_ = 1;
    SELF.Exp8_ := __PP2777002.Kr_Dl290_Flag_ = 1;
    SELF.Exp9_ := __PP2777002.Kr_Dl291_Flag_ = 1;
    SELF.Exp10_ := __PP2777002.Kr_Dl292_Flag_ = 1;
    SELF.Exp11_ := __PP2777002.Kr_Dl293_Flag_ = 1;
    SELF.Exp12_ := __PP2777002.Kr_High_Risk_Dl_Flag_ = 1;
    SELF.Exp13_ := __PP2777002.Kr_Low_Risk_Dl_Flag_ = 1;
    SELF.Exp14_ := __PP2777002.Kr_Medium_Risk_Dl_Flag_ = 1;
    SELF.Exp15_ := __PP2777002.Safe_Flag_ = 1;
    SELF.Exp16_ := __OP2(__PP2777002.Event_Age_,<,__CN(2));
    SELF.Exp17_ := __AND(__OP2(__PP2777002.Event_Age_,<,__CN(2)),__CN(__PP2777002.In_Customer_Population_ = 1));
    SELF.Exp18_ := __OP2(__PP2777002.Event_Age_,<,__CN(366));
    SELF := __PP2777002;
  END;
  SHARED __EE2777775 := PROJECT(__EE2777001,__ND2777747__Project(LEFT));
  SHARED __ST2761879_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2777889 := PROJECT(__CLEANANDDO(__EE2777775,TABLE(__EE2777775,{KEL.typ.int C_O_U_N_T___Exp1_ := COUNT(GROUP,__EE2777775.Exp1_),KEL.Aggregates.MinNG(__EE2777775.Event_Date__1_) M_I_N___Event_Date__1_,KEL.Aggregates.MinNG(__EE2777775.Exp2_) M_I_N___Event_Date__2_,KEL.typ.int C_O_U_N_T___Exp1__1_ := COUNT(GROUP,__EE2777775.Exp3_),KEL.typ.int C_O_U_N_T___Exp1__2_ := COUNT(GROUP,__EE2777775.Exp4_),KEL.typ.int C_O_U_N_T___Exp1__3_ := COUNT(GROUP,__EE2777775.Exp5_),KEL.typ.int C_O_U_N_T___Exp1__4_ := COUNT(GROUP,__EE2777775.Exp6_),KEL.typ.int C_O_U_N_T___Exp1__5_ := COUNT(GROUP,__EE2777775.Exp7_),KEL.typ.int C_O_U_N_T___Exp1__6_ := COUNT(GROUP,__EE2777775.Exp8_),KEL.typ.int C_O_U_N_T___Exp1__7_ := COUNT(GROUP,__EE2777775.Exp9_),KEL.typ.int C_O_U_N_T___Exp1__8_ := COUNT(GROUP,__EE2777775.Exp10_),KEL.typ.int C_O_U_N_T___Exp1__9_ := COUNT(GROUP,__EE2777775.Exp11_),KEL.typ.int C_O_U_N_T___Exp1__10_ := COUNT(GROUP,__EE2777775.Exp12_),KEL.typ.int C_O_U_N_T___Exp1__11_ := COUNT(GROUP,__EE2777775.Exp13_),KEL.typ.int C_O_U_N_T___Exp1__12_ := COUNT(GROUP,__EE2777775.Exp14_),KEL.Aggregates.MaxNG(__EE2777775.Event_Date__1_) M_A_X___Event_Date__1_,KEL.typ.int C_O_U_N_T___Exp1__13_ := COUNT(GROUP,__EE2777775.Exp15_),KEL.typ.int C_O_U_N_T___Exp1__14_ := COUNT(GROUP,__T(__EE2777775.Exp16_)),KEL.typ.int C_O_U_N_T___Exp1__15_ := COUNT(GROUP,__T(__EE2777775.Exp17_)),KEL.typ.int C_O_U_N_T___Exp1__16_ := COUNT(GROUP,__T(__EE2777775.Exp18_)),UID},UID,MERGE)),__ST2761879_Layout);
  SHARED __ST2767527_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2777895(B_Drivers_License_1.__ST74959_Layout __EE2712197, __ST2761879_Layout __EE2777889) := __EEQP(__EE2712197.UID,__EE2777889.UID);
  __ST2767527_Layout __JT2777895(B_Drivers_License_1.__ST74959_Layout __l, __ST2761879_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2777963 := JOIN(__EE2712197,__EE2777889,__JC2777895(LEFT,RIGHT),__JT2777895(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2693191 := __ENH_Customer_1;
  SHARED __ST2767968_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2777969(__ST2767527_Layout __EE2777963, B_Customer_1.__ST74526_Layout __EE2693191) := __EEQP(__EE2777963._r_Customer_,__EE2693191.UID);
  __ST2767968_Layout __JT2777969(__ST2767527_Layout __l, B_Customer_1.__ST74526_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2778059 := JOIN(__EE2777963,__EE2693191,__JC2777969(LEFT,RIGHT),__JT2777969(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST50702_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Drivers_License.Source_Customers_Layout) Source_Customers_;
    KEL.typ.nstr License_Number_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST50702_Layout __ND2778064__Project(__ST2767968_Layout __PP2778060) := TRANSFORM
    SELF.Contributor_Safe_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1_ <> 0=>1,0);
    SELF.Dt_First_Seen_ := __PP2778060.M_I_N___Event_Date__1_;
    SELF.Entity_Context_Uid_ := __OP2(__CN('_20'),+,__PP2778060.Otto_Drivers_License_Id_);
    SELF.Entity_Type_ := 20;
    SELF.Id_Activity_Dt_First_Seen_ := __PP2778060.M_I_N___Event_Date__2_;
    SELF.Identity_Count_Gt2_ := MAP(__PP2778060.Identity_Count_ > 2=>1,0);
    __BS2778220 := __T(__PP2778060.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS2778220(__T(__OP2(__T(__PP2778060.Source_Customers_)._r_Source_Customer_,=,__PP2778060._r_Customer_))))=>1,0);
    SELF.Kr_Dl200_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__1_ <> 0=>1,0);
    SELF.Kr_Dl201_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__2_ <> 0=>1,0);
    SELF.Kr_Dl202_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__3_ <> 0=>1,0);
    SELF.Kr_Dl203_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__4_ <> 0=>1,0);
    SELF.Kr_Dl204_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__5_ <> 0=>1,0);
    SELF.Kr_Dl290_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__6_ <> 0=>1,0);
    SELF.Kr_Dl291_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__7_ <> 0=>1,0);
    SELF.Kr_Dl292_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__8_ <> 0=>1,0);
    SELF.Kr_Dl293_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__9_ <> 0=>1,0);
    SELF.Kr_High_Risk_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__10_ <> 0=>1,0);
    SELF.Kr_Low_Risk_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__11_ <> 0=>1,0);
    SELF.Kr_Medium_Risk_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__12_ <> 0=>1,0);
    SELF.Label_ := __PP2778060.License_Number_;
    SELF.Last_Event_Date_ := __PP2778060.M_A_X___Event_Date__1_;
    SELF.Safe_Flag_ := MAP(__PP2778060.C_O_U_N_T___Exp1__13_ <> 0=>1,0);
    SELF.Source_Customer_Count_ := KEL.Aggregates.CountN(__PP2778060.Source_Customers_);
    SELF.Vl_Event1_All_Count_ := __PP2778060.C_O_U_N_T___Exp1__14_;
    SELF.Vl_Event1_Count_ := __PP2778060.C_O_U_N_T___Exp1__15_;
    SELF.Vl_Event30_Active_Flag_ := MAP(__PP2778060.Vl_Event30_Count_ > 0=>1,0);
    SELF.Vl_Event30_All_Active_Flag_ := MAP(__PP2778060.Vl_Event30_All_Day_Count_ > 0=>1,0);
    SELF.Vl_Event365_All_Day_Count_ := __PP2778060.C_O_U_N_T___Exp1__16_;
    SELF.Vl_Event7_Active_Flag_ := MAP(__PP2778060.Vl_Event7_Count_ > 0=>1,0);
    SELF.Vl_Event7_All_Active_Flag_ := MAP(__PP2778060.Vl_Event7_All_Count_ > 0=>1,0);
    SELF := __PP2778060;
  END;
  EXPORT __ENH_Drivers_License := PROJECT(__EE2778059,__ND2778064__Project(LEFT)) : PERSIST('~fraudgov::temp::KEL::FraudgovKEL::Drivers_License::Annotated',EXPIRE(7));
  SHARED __EE4830169 := __ENH_Drivers_License;
  SHARED IDX_Drivers_License_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE4830169._r_Customer_;
    __EE4830169.Source_Customers_;
    __EE4830169.License_Number_;
    __EE4830169.State_;
    __EE4830169.Otto_Drivers_License_Id_;
    __EE4830169.Aot_Act_Cnt_Ev_;
    __EE4830169.Aot_Src1_Act_Cnt_Ev_;
    __EE4830169.Aot_Src1_Act_Only_Flag_;
    __EE4830169.Aot_Dl_Kr_Act_Cnt_Ev_;
    __EE4830169.Aot_Dl_Kr_Act_Shrd_Cnt_Ev_;
    __EE4830169.Aot_Dl_Kr_Act_Old_Dt_Ev_;
    __EE4830169.Aot_Dl_Kr_Act_New_Dt_Ev_;
    __EE4830169.Aot_Dl_Kr_Act_Shrd_Old_Dt_Ev_;
    __EE4830169.Aot_Dl_Kr_Act_Shrd_New_Dt_Ev_;
    __EE4830169.Aot_Id_Act_Cnt_Ev_;
    __EE4830169.Aot_Id_Act_Cnt30_D_;
    __EE4830169.Aot_Add_Act_Cnt_Ev_;
    __EE4830169.Aot_Add_Act_Cnt30_D_;
    __EE4830169.Aot_Non_St_Act_Cnt_Ev_;
    __EE4830169.Aot_Non_St_Act_Cnt30_D_;
    __EE4830169.Aot_Dl_New_Kr_Aft_Id_Act_Cnt_Ev_;
    __EE4830169.Aot_Dl_New_Kr_Aft_Add_Act_Cnt_Ev_;
    __EE4830169.Aot_Dl_New_Kr_Aft_Non_St_Act_Cnt_Ev_;
    __EE4830169.Aot_Id_Curr_Prof_Usng_Dl_Cnt_Ev_;
    __EE4830169.Aot_Id_Hist_Prof_Usng_Dl_Cnt_Ev_;
    __EE4830169.Aot_Id_Usng_Dl_Cnt_Ev_;
    __EE4830169.Customer_Id_;
    __EE4830169.Industry_Type_;
    __EE4830169.Source_Customer_Count_;
    __EE4830169.Entity_Context_Uid_;
    __EE4830169.Entity_Type_;
    __EE4830169.Label_;
    __EE4830169.In_Customer_Population_;
    __EE4830169.Dt_First_Seen_;
    __EE4830169.Dt_Last_Seen_;
    __EE4830169.Id_Activity_Dt_First_Seen_;
    __EE4830169.Id_Activity_Dt_Last_Seen_;
    __EE4830169.Last_Record_Id_;
    __EE4830169.Identity_Count_;
    __EE4830169.Identity_Count_Gt2_;
    __EE4830169.Event_Count_;
    __EE4830169.Kr_High_Risk_Flag_;
    __EE4830169.Kr_Medium_Risk_Flag_;
    __EE4830169.Kr_Low_Risk_Flag_;
    __EE4830169.Kr_Flag_;
    __EE4830169.Safe_Flag_;
    __EE4830169.Contributor_Safe_Flag_;
    __EE4830169.Last_Event_Date_;
    __EE4830169.Kr_Last_Event_Date_;
    __EE4830169.Kr_Event_After_Last_Known_Risk_Count_;
    __EE4830169.Kr_Event_After_Last_Known_Risk_Flag_;
    __EE4830169.Kr_Dl200_Flag_;
    __EE4830169.Kr_Dl201_Flag_;
    __EE4830169.Kr_Dl202_Flag_;
    __EE4830169.Kr_Dl203_Flag_;
    __EE4830169.Kr_Dl204_Flag_;
    __EE4830169.Kr_Dl290_Flag_;
    __EE4830169.Kr_Dl291_Flag_;
    __EE4830169.Kr_Dl292_Flag_;
    __EE4830169.Kr_Dl293_Flag_;
    __EE4830169.Vl_Event1_All_Count_;
    __EE4830169.Vl_Event7_All_Count_;
    __EE4830169.Vl_Event30_All_Day_Count_;
    __EE4830169.Vl_Event365_All_Day_Count_;
    __EE4830169.Vl_Event7_All_Active_Flag_;
    __EE4830169.Vl_Event30_All_Active_Flag_;
    __EE4830169.Vl_Event1_Count_;
    __EE4830169.Vl_Event7_Count_;
    __EE4830169.Vl_Event30_Count_;
    __EE4830169.Vl_Event365_Count_;
    __EE4830169.Vl_Event7_Active_Flag_;
    __EE4830169.Vl_Event30_Active_Flag_;
    __EE4830169.Date_First_Seen_;
    __EE4830169.Date_Last_Seen_;
    __EE4830169.__RecordCount;
  END;
  SHARED IDX_Drivers_License_UID_Projected := PROJECT(__EE4830169,TRANSFORM(IDX_Drivers_License_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST4830171_Layout := RECORDOF(IDX_Drivers_License_UID);
  EXPORT IDX_Drivers_License_UID_Wrapped := PROJECT(IDX_Drivers_License_UID,TRANSFORM(__ST50702_Layout,SELF.UID := __CN(LEFT.UID),SELF:=LEFT));
