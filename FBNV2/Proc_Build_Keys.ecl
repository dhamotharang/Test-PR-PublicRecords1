...
Keys := parallel(key1,key2,key5,key6,key7,key8,key9,key10);
...
Move_keys := parallel(mv1, mv2, mv5, mv6, mv7, mv8, mv9,mv10 );	
...
To_qa    :=parallel(toq1, toq2,  toq5, toq6, toq7, toq8, toq9,toq10);	
