...
Output(Header_Counts.st_Addy_Rec, Named('Count_Address_PerLExid')); // Most common address across different lexids 
Output(Header_Counts.st_Crosstab_Dob, Named('Most_Common_Dob')); // Most common dob across all records
Output(Header_Counts.S_Crosstab_dob, Named('Dobs_Without_Blanks')); // Most common dob across different lexids (non-blanks)
Output(Header_Counts.S_Crosstab_dobMMDD, Named('Dobs_Without_No_blanksMMDD')); // Most common dob with only month and day
Output(Header_Counts.S_Sample_RecSlim, Named('Count_of_BlankDobsYYYYMMDD')); // Count of blank dob across file
...
Output(Header_Counts.CountedBlankDobs, Named('Counted_Blank_Dobs')); // Count of dob with blank day
Output(Header_Counts.RecSlim_x);
