import BatchServices, FFD, hygenics_crim, STD;

EXPORT Transforms := MODULE

	export CriminalRecords_BatchService.Layouts.batch_int makeOutputOffenses(recordof(CriminalRecords_BatchService.Layouts.batch_int_offenses) L, 
																																					 DATASET(recordof(CriminalRecords_BatchService.Layouts.batch_int_offenses)) R) := TRANSFORM
			SELF.output_type := 'F';
      ...
      SELF.offense_category_6 := temp_off_cat6;
		...
		export CriminalRecords_BatchService.Layouts.batch_int makeCourtOffenseOutput(RECORDOF(CriminalRecords_BatchService.Layouts.batch_int_court_offense) L, 
      ...
      SELF.offense_category_6 := temp_off_cat6;
		...
		export CriminalRecords_BatchService.Layouts.batch_int makePunishmentOutput(recordof(CriminalRecords_BatchService.Layouts.batch_int_punishment) L, 
																																							 DATASET(recordof(CriminalRecords_BatchService.Layouts.batch_int_punishment)) R) := TRANSFORM
