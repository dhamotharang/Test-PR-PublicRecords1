IMPORT SALT32,std;
EXPORT match_methods(DATASET(layout_ALC_ACCOUNTANTS) ih) := MODULE
...
EXPORT match_job_code(TYPEOF(h.job_code) L, TYPEOF(h.job_code) R, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT32.MatchCode.ExactMatch,
    SALT32.MatchCode.NoMatch),
  MAP(L = R => SALT32.MatchCode.ExactMatch, SALT32.MatchCode.NoMatch)
);
...
EXPORT match_number_of_employees(TYPEOF(h.number_of_employees) L, TYPEOF(h.number_of_employees) R, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT32.MatchCode.ExactMatch,
    SALT32.MatchCode.NoMatch),
  MAP(L = R => SALT32.MatchCode.ExactMatch, SALT32.MatchCode.NoMatch)
);
...
EXPORT match_company_type(TYPEOF(h.company_type) L, TYPEOF(h.company_type) R, BOOLEAN RequiredField = FALSE) := IF(~RequiredField,
   MAP(L = R => SALT32.MatchCode.ExactMatch,
    SALT32.MatchCode.NoMatch),
  MAP(L = R => SALT32.MatchCode.ExactMatch, SALT32.MatchCode.NoMatch)
);
