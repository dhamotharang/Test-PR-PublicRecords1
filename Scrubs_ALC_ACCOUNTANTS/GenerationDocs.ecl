...
Command line options: -MScrubs_ALC_ACCOUNTANTS -eC:\Users\metzmaaj\AppData\Local\Temp\TFR718A.tmp 
...
FIELD:orig_date:TYPE(STRING20):LIKE(invalid_slashO_date):0,0
FIELD:exp_date:TYPE(STRING20):LIKE(invalid_slashO_date):0,0
