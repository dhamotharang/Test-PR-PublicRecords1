...
Command line options: -MScrubs_ALC_ACCOUNTANTS -eC:\Users\metzmaaj\AppData\Local\Temp\TFR94B3.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_ALC_ACCOUNTANTS
FILENAME:ALC_ACCOUNTANTS
...
FIELDTYPE:invalid_alphaspaceperiod:ALLOW( .ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz)
...
FIELDTYPE:invalid_job_code:ALLOW(#14)
FIELDTYPE:invalid_company_type:ENUM(2|3|4|6|7|8|A|B|E|F|G|H|I| )
FIELDTYPE:invalid_license_number:ALLOW( .-ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789):CUSTOM(ALC.Custom_Scrubs.fn_valid_mt_acct_license_no<1,state)
...
FIELD:job_code:TYPE(STRING50):LIKE(invalid_job_code):0,0
FIELD:nielsen_county_cd:TYPE(STRING1):LIKE(invalid_alphanumeric):0,0
FIELD:number_of_employees:TYPE(STRING7):LIKE(invalid_numeric):0,0
FIELD:msa:TYPE(STRING4):LIKE(invalid_numeric):0,0
FIELD:source_code:TYPE(STRING100):0,0
FIELD:company_type:TYPE(STRING4):LIKE(invalid_company_type):0,0
FIELD:phone:TYPE(STRING10):LIKE(invalid_numeric):0,0
...
FIELD:orig_date:TYPE(STRING20):LIKE(invalid_slash_date):0,0
FIELD:exp_date:TYPE(STRING20):LIKE(invalid_slash_date):0,0
FIELD:degree:TYPE(STRING20):LIKE(invalid_alphaspaceperiod):0,0
