...
// The module to handle the case where no scrubs exist
  ...
  EXPORT NumRulesFromRecordType := 24;
  ...
  END;
  EXPORT Rule_Layout := RECORD(Layout_Property_Assessor)
