...
EXPORT MakeFT_invalid_apn(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,' _-.,/:&()*0123456789:;ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '); // Only allow valid symbols
  s2 := SALT33.stringcleanspaces( SALT33.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_invalid_apn(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,' _-.,/:&()*0123456789:;ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '))),~(LENGTH(TRIM(s)) >= 1));
EXPORT InValidMessageFT_invalid_apn(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars(' _-.,/:&()*0123456789:;ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz '),SALT33.HygieneErrors.NotLength('1..'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_csz(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,' ,-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 '); // Only allow valid symbols
  s2 := SALT33.stringcleanspaces( SALT33.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_invalid_csz(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,' ,-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 '))));
EXPORT InValidMessageFT_invalid_csz(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars(' ,-ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 '),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_year(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_year(SALT33.StrType s) := WHICH(~Scrubs_LN_PropertyV2_Assessor.fn_valid_year(s)>0);
EXPORT InValidMessageFT_invalid_year(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('Scrubs_LN_PropertyV2_Assessor.fn_valid_year'),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_phone(SALT33.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_phone(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 10));
EXPORT InValidMessageFT_invalid_phone(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789'),SALT33.HygieneErrors.NotLength('0..10'),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_tax_amount(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123456789.'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_tax_amount(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789.'))));
EXPORT InValidMessageFT_invalid_tax_amount(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789.'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_state_num(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_state_num(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789'))),~(1 <= (INTEGER4)s AND (INTEGER4)s <= 78),~(LENGTH(TRIM(s)) = 2));
EXPORT InValidMessageFT_invalid_state_num(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789'),SALT33.HygieneErrors.NotInRange('1,78'),SALT33.HygieneErrors.NotLength('2'),SALT33.HygieneErrors.Good);
...
EXPORT MakeFT_invalud_document_number(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/-&\' -.'); // Only allow valid symbols
  s2 := SALT33.stringcleanspaces( SALT33.stringsubstituteout(s1,' -.',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_invalud_document_number(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/-&\' -.'))));
EXPORT InValidMessageFT_invalud_document_number(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789/-&\' -.'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_land_use(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_land_use(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'LAND_USE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_land_use(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_ownership_rights_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ownership_rights_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'OWNER_OWNERSHIP_RIGHTS_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_ownership_rights_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_relationship_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_relationship_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'OWNER_RELATIONSHIP_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_relationship_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_name_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'ASSESSEE_NAME_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_second_name_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_second_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'SECOND_ASSESSEE_NAME_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_second_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_mail_care_of_name_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mail_care_of_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'MAIL_CARE_OF_NAME_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_mail_care_of_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_record_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_record_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'RECORD_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_record_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_legal_lot_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_legal_lot_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'LEGAL_LOT_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_legal_lot_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_ownership_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ownership_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'OWNERSHIP_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_ownership_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_new_record_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_new_record_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'NEW_RECORD_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_new_record_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_sale_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_sale_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'SALE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_sale_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_prior_sales_price_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_prior_sales_price_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'PRIOR_SALES_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_prior_sales_price_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_mortgage_loan_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mortgage_loan_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'MORTGAGE_LOAN_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_mortgage_loan_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_mortgage_lender_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_mortgage_lender_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'MORTGAGE_LENDER_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_mortgage_lender_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_tax_exemption1_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_exemption1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'TAX_EXEMPTION1_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_tax_exemption1_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_tax_exemption2_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_exemption2_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'TAX_EXEMPTION2_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_tax_exemption2_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_tax_exemption3_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_exemption3_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'TAX_EXEMPTION3_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_tax_exemption3_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_tax_exemption4_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_tax_exemption4_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'TAX_EXEMPTION4_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_tax_exemption4_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_no_of_stories(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,'0123456789.AB+'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_no_of_stories(SALT33.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,'0123456789.AB+'))),~(LENGTH(TRIM(s)) >= 0 AND LENGTH(TRIM(s)) <= 5));
EXPORT InValidMessageFT_invalid_no_of_stories(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars('0123456789.AB+'),SALT33.HygieneErrors.NotLength('0..5'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_garage_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_garage_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'GARAGE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_garage_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_pool_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_pool_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'POOL_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_pool_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_exterior_walls_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_exterior_walls_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'EXTERIOR_WALLS','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_exterior_walls_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_roof_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_roof_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'ROOF_TYPE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_roof_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_heating_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_heating_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'HEATING','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_heating_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_heating_fuel_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_heating_fuel_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'FUEL','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_heating_fuel_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_air_conditioning_type_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_air_conditioning_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'AIR_CONDITIONING_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_air_conditioning_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_class_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_class_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_CLASS_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_class_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_site_influence1_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_site_influence1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'LOCATION_INFLUENCE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_site_influence1_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_amenities1_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_amenities1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'AMENITIES1_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_amenities1_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_amenities2_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_amenities2_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'AMENITIES2_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_amenities2_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_amenities3_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_amenities3_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'AMENITIES3_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_amenities3_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_amenities4_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_amenities4_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'AMENITIES4_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_amenities4_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_other_buildings1_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_other_buildings1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BLDG_IMPV_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_other_buildings1_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_fireplace_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_fireplace_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'FIREPLACE_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_fireplace_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_property_address_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_property_address_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'PROPERTY_ADDRESS_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_property_address_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_floor_cover_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_floor_cover_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'FLOOR_COVER','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_floor_cover_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_quality_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_quality_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'QUALITY','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_quality_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_document_type_code(SALT33.StrType s0) := FUNCTION
  s1 := SALT33.stringfilter(s0,' -.:ABCDEFGHIJKLMNOPQRSTUVWXYZ/():,&\'- '); // Only allow valid symbols
  s2 := SALT33.stringcleanspaces( SALT33.stringsubstituteout(s1,' ',' ') ); // Insert spaces but avoid doubles
  RETURN  s2;
END;
EXPORT InValidFT_invalid_document_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT33.StringFilter(s,' -.:ABCDEFGHIJKLMNOPQRSTUVWXYZ/():,&\'- '))),~fn_valid_codesv3_property(s,vendor_source_flag,'DOCUMENT_TYPE_CODE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_document_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.NotInChars(' -.:ABCDEFGHIJKLMNOPQRSTUVWXYZ/():,&\'- '),SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_basement_code(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_basement_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BASEMENT_FINISH','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_basement_code(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_SQ_FEET_IND','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area1_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area1_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA1_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area1_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area2_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area2_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA2_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area2_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area3_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area3_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA3_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area3_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area4_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area4_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA4_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area4_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area5_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area5_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA5_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area5_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area6_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area6_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA6_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area6_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_building_area7_indicator(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_building_area7_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'BUILDING_AREA7_INDICATOR','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_building_area7_indicator(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
EXPORT MakeFT_invalid_construction_type(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_construction_type(SALT33.StrType s,SALT33.StrType vendor_source_flag) := WHICH(~fn_valid_codesv3_property(s,vendor_source_flag,'CONSTRUCTION_TYPE','FARES_2580')>0);
EXPORT InValidMessageFT_invalid_construction_type(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('fn_valid_codesv3_property'),SALT33.HygieneErrors.Good);
...
EXPORT Make_vendor_source_flag(SALT33.StrType s0) := s0;
EXPORT InValid_vendor_source_flag(SALT33.StrType s) := FALSE;
...
EXPORT Make_state_code(SALT33.StrType s0) := MakeFT_invalid_state_code(s0);
EXPORT InValid_state_code(SALT33.StrType s) := InValidFT_invalid_state_code(s);
...
EXPORT Make_old_apn(SALT33.StrType s0) := s0;
EXPORT InValid_old_apn(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_old_apn(UNSIGNED1 wh) := '';
EXPORT Make_apna_or_pin_number(SALT33.StrType s0) := MakeFT_invalid_apn(s0);
EXPORT InValid_apna_or_pin_number(SALT33.StrType s) := InValidFT_invalid_apn(s);
EXPORT InValidMessage_apna_or_pin_number(UNSIGNED1 wh) := InValidMessageFT_invalid_apn(wh);
EXPORT Make_fares_unformatted_apn(SALT33.StrType s0) := s0;
EXPORT InValid_fares_unformatted_apn(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_fares_unformatted_apn(UNSIGNED1 wh) := '';
EXPORT Make_duplicate_apn_multiple_address_id(SALT33.StrType s0) := s0;
EXPORT InValid_duplicate_apn_multiple_address_id(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_duplicate_apn_multiple_address_id(UNSIGNED1 wh) := '';
EXPORT Make_assessee_name(SALT33.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_assessee_name(SALT33.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_assessee_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_second_assessee_name(SALT33.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_second_assessee_name(SALT33.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_second_assessee_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_assessee_ownership_rights_code(SALT33.StrType s0) := MakeFT_invalid_ownership_rights_code(s0);
EXPORT InValid_assessee_ownership_rights_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_ownership_rights_code(s,vendor_source_flag);
EXPORT InValidMessage_assessee_ownership_rights_code(UNSIGNED1 wh) := InValidMessageFT_invalid_ownership_rights_code(wh);
EXPORT Make_assessee_relationship_code(SALT33.StrType s0) := MakeFT_invalid_relationship_code(s0);
EXPORT InValid_assessee_relationship_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_relationship_code(s,vendor_source_flag);
EXPORT InValidMessage_assessee_relationship_code(UNSIGNED1 wh) := InValidMessageFT_invalid_relationship_code(wh);
EXPORT Make_assessee_phone_number(SALT33.StrType s0) := MakeFT_invalid_phone(s0);
EXPORT InValid_assessee_phone_number(SALT33.StrType s) := InValidFT_invalid_phone(s);
EXPORT InValidMessage_assessee_phone_number(UNSIGNED1 wh) := InValidMessageFT_invalid_phone(wh);
EXPORT Make_tax_account_number(SALT33.StrType s0) := s0;
EXPORT InValid_tax_account_number(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_tax_account_number(UNSIGNED1 wh) := '';
EXPORT Make_contract_owner(SALT33.StrType s0) := s0;
EXPORT InValid_contract_owner(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_contract_owner(UNSIGNED1 wh) := '';
EXPORT Make_assessee_name_type_code(SALT33.StrType s0) := MakeFT_invalid_name_type_code(s0);
EXPORT InValid_assessee_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_name_type_code(s,vendor_source_flag);
EXPORT InValidMessage_assessee_name_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_name_type_code(wh);
EXPORT Make_second_assessee_name_type_code(SALT33.StrType s0) := MakeFT_invalid_second_name_type_code(s0);
EXPORT InValid_second_assessee_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_second_name_type_code(s,vendor_source_flag);
EXPORT InValidMessage_second_assessee_name_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_second_name_type_code(wh);
EXPORT Make_mail_care_of_name_type_code(SALT33.StrType s0) := MakeFT_invalid_mail_care_of_name_type_code(s0);
EXPORT InValid_mail_care_of_name_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_mail_care_of_name_type_code(s,vendor_source_flag);
EXPORT InValidMessage_mail_care_of_name_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_mail_care_of_name_type_code(wh);
EXPORT Make_mailing_care_of_name(SALT33.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_mailing_care_of_name(SALT33.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_mailing_care_of_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_mailing_full_street_address(SALT33.StrType s0) := MakeFT_invalid_address(s0);
EXPORT InValid_mailing_full_street_address(SALT33.StrType s) := InValidFT_invalid_address(s);
...
EXPORT Make_mailing_city_state_zip(SALT33.StrType s0) := MakeFT_invalid_csz(s0);
EXPORT InValid_mailing_city_state_zip(SALT33.StrType s) := InValidFT_invalid_csz(s);
...
EXPORT Make_property_unit_number(SALT33.StrType s0) := MakeFT_invalid_address(s0);
EXPORT InValid_property_unit_number(SALT33.StrType s) := InValidFT_invalid_address(s);
EXPORT InValidMessage_property_unit_number(UNSIGNED1 wh) := InValidMessageFT_invalid_address(wh);
EXPORT Make_property_city_state_zip(SALT33.StrType s0) := MakeFT_invalid_csz(s0);
EXPORT InValid_property_city_state_zip(SALT33.StrType s) := InValidFT_invalid_csz(s);
EXPORT InValidMessage_property_city_state_zip(UNSIGNED1 wh) := InValidMessageFT_invalid_csz(wh);
EXPORT Make_property_country_code(SALT33.StrType s0) := s0;
EXPORT InValid_property_country_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_property_country_code(UNSIGNED1 wh) := '';
EXPORT Make_property_address_code(SALT33.StrType s0) := MakeFT_invalid_property_address_code(s0);
EXPORT InValid_property_address_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_property_address_code(s,vendor_source_flag);
...
EXPORT Make_legal_phase_number(SALT33.StrType s0) := s0;
EXPORT InValid_legal_phase_number(SALT33.StrType s) := FALSE;
...
EXPORT Make_legal_assessor_map_ref(SALT33.StrType s0) := s0;
EXPORT InValid_legal_assessor_map_ref(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_legal_assessor_map_ref(UNSIGNED1 wh) := '';
EXPORT Make_census_tract(SALT33.StrType s0) := s0;
EXPORT InValid_census_tract(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_census_tract(UNSIGNED1 wh) := '';
EXPORT Make_record_type_code(SALT33.StrType s0) := MakeFT_invalid_record_type_code(s0);
EXPORT InValid_record_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_record_type_code(s,vendor_source_flag);
EXPORT InValidMessage_record_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_record_type_code(wh);
EXPORT Make_ownership_type_code(SALT33.StrType s0) := MakeFT_invalid_ownership_type_code(s0);
EXPORT InValid_ownership_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_ownership_type_code(s,vendor_source_flag);
EXPORT InValidMessage_ownership_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_ownership_type_code(wh);
EXPORT Make_new_record_type_code(SALT33.StrType s0) := MakeFT_invalid_new_record_type_code(s0);
EXPORT InValid_new_record_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_new_record_type_code(s,vendor_source_flag);
EXPORT InValidMessage_new_record_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_new_record_type_code(wh);
EXPORT Make_state_land_use_code(SALT33.StrType s0) := s0;
EXPORT InValid_state_land_use_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_state_land_use_code(UNSIGNED1 wh) := '';
EXPORT Make_county_land_use_code(SALT33.StrType s0) := s0;
EXPORT InValid_county_land_use_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_county_land_use_code(UNSIGNED1 wh) := '';
EXPORT Make_county_land_use_description(SALT33.StrType s0) := s0;
EXPORT InValid_county_land_use_description(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_county_land_use_description(UNSIGNED1 wh) := '';
EXPORT Make_standardized_land_use_code(SALT33.StrType s0) := MakeFT_invalid_land_use(s0);
EXPORT InValid_standardized_land_use_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_land_use(s,vendor_source_flag);
EXPORT InValidMessage_standardized_land_use_code(UNSIGNED1 wh) := InValidMessageFT_invalid_land_use(wh);
EXPORT Make_timeshare_code(SALT33.StrType s0) := s0;
EXPORT InValid_timeshare_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_timeshare_code(UNSIGNED1 wh) := '';
EXPORT Make_zoning(SALT33.StrType s0) := s0;
EXPORT InValid_zoning(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_zoning(UNSIGNED1 wh) := '';
EXPORT Make_owner_occupied(SALT33.StrType s0) := s0;
EXPORT InValid_owner_occupied(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_owner_occupied(UNSIGNED1 wh) := '';
EXPORT Make_recorder_document_number(SALT33.StrType s0) := s0;
EXPORT InValid_recorder_document_number(SALT33.StrType s) := FALSE;
...
EXPORT Make_transfer_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_transfer_date(SALT33.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_sale_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_sale_date(SALT33.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_sale_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_document_type(SALT33.StrType s0) := MakeFT_invalid_document_type_code(s0);
EXPORT InValid_document_type(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_document_type_code(s,vendor_source_flag);
EXPORT InValidMessage_document_type(UNSIGNED1 wh) := InValidMessageFT_invalid_document_type_code(wh);
EXPORT Make_sales_price(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_sales_price(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_sales_price(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_sales_price_code(SALT33.StrType s0) := MakeFT_invalid_sale_code(s0);
EXPORT InValid_sales_price_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_sale_code(s,vendor_source_flag);
EXPORT InValidMessage_sales_price_code(UNSIGNED1 wh) := InValidMessageFT_invalid_sale_code(wh);
EXPORT Make_mortgage_loan_amount(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_mortgage_loan_amount(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_mortgage_loan_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_mortgage_loan_type_code(SALT33.StrType s0) := MakeFT_invalid_mortgage_loan_type_code(s0);
EXPORT InValid_mortgage_loan_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_mortgage_loan_type_code(s,vendor_source_flag);
EXPORT InValidMessage_mortgage_loan_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_mortgage_loan_type_code(wh);
EXPORT Make_mortgage_lender_name(SALT33.StrType s0) := MakeFT_invalid_alpha(s0);
EXPORT InValid_mortgage_lender_name(SALT33.StrType s) := InValidFT_invalid_alpha(s);
EXPORT InValidMessage_mortgage_lender_name(UNSIGNED1 wh) := InValidMessageFT_invalid_alpha(wh);
EXPORT Make_mortgage_lender_type_code(SALT33.StrType s0) := MakeFT_invalid_mortgage_lender_type_code(s0);
EXPORT InValid_mortgage_lender_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_mortgage_lender_type_code(s,vendor_source_flag);
EXPORT InValidMessage_mortgage_lender_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_mortgage_lender_type_code(wh);
EXPORT Make_prior_transfer_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_prior_transfer_date(SALT33.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_prior_transfer_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_prior_recording_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_prior_recording_date(SALT33.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_prior_recording_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_prior_sales_price(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_prior_sales_price(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_prior_sales_price(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_prior_sales_price_code(SALT33.StrType s0) := MakeFT_invalid_prior_sales_price_code(s0);
EXPORT InValid_prior_sales_price_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_prior_sales_price_code(s,vendor_source_flag);
EXPORT InValidMessage_prior_sales_price_code(UNSIGNED1 wh) := InValidMessageFT_invalid_prior_sales_price_code(wh);
EXPORT Make_assessed_land_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_assessed_land_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_assessed_land_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_assessed_improvement_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_assessed_improvement_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_assessed_improvement_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_assessed_total_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_assessed_total_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_assessed_total_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_assessed_value_year(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_assessed_value_year(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_assessed_value_year(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_market_land_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_market_land_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_market_land_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_market_improvement_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_market_improvement_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_market_improvement_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_market_total_value(SALT33.StrType s0) := MakeFT_invalid_prop_amount(s0);
EXPORT InValid_market_total_value(SALT33.StrType s) := InValidFT_invalid_prop_amount(s);
EXPORT InValidMessage_market_total_value(UNSIGNED1 wh) := InValidMessageFT_invalid_prop_amount(wh);
EXPORT Make_market_value_year(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_market_value_year(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_market_value_year(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_homestead_homeowner_exemption(SALT33.StrType s0) := s0;
EXPORT InValid_homestead_homeowner_exemption(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_homestead_homeowner_exemption(UNSIGNED1 wh) := '';
EXPORT Make_tax_exemption1_code(SALT33.StrType s0) := MakeFT_invalid_tax_exemption1_code(s0);
EXPORT InValid_tax_exemption1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_tax_exemption1_code(s,vendor_source_flag);
EXPORT InValidMessage_tax_exemption1_code(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_exemption1_code(wh);
EXPORT Make_tax_exemption2_code(SALT33.StrType s0) := MakeFT_invalid_tax_exemption2_code(s0);
EXPORT InValid_tax_exemption2_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_tax_exemption2_code(s,vendor_source_flag);
EXPORT InValidMessage_tax_exemption2_code(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_exemption2_code(wh);
EXPORT Make_tax_exemption3_code(SALT33.StrType s0) := MakeFT_invalid_tax_exemption3_code(s0);
EXPORT InValid_tax_exemption3_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_tax_exemption3_code(s,vendor_source_flag);
EXPORT InValidMessage_tax_exemption3_code(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_exemption3_code(wh);
EXPORT Make_tax_exemption4_code(SALT33.StrType s0) := MakeFT_invalid_tax_exemption4_code(s0);
EXPORT InValid_tax_exemption4_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_tax_exemption4_code(s,vendor_source_flag);
EXPORT InValidMessage_tax_exemption4_code(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_exemption4_code(wh);
EXPORT Make_tax_rate_code_area(SALT33.StrType s0) := s0;
EXPORT InValid_tax_rate_code_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_tax_rate_code_area(UNSIGNED1 wh) := '';
EXPORT Make_tax_amount(SALT33.StrType s0) := MakeFT_invalid_tax_amount(s0);
EXPORT InValid_tax_amount(SALT33.StrType s) := InValidFT_invalid_tax_amount(s);
EXPORT InValidMessage_tax_amount(UNSIGNED1 wh) := InValidMessageFT_invalid_tax_amount(wh);
EXPORT Make_tax_year(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_tax_year(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_tax_year(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_tax_delinquent_year(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_tax_delinquent_year(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_tax_delinquent_year(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_school_tax_district1(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district1(UNSIGNED1 wh) := '';
EXPORT Make_school_tax_district1_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district1_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district1_indicator(UNSIGNED1 wh) := '';
EXPORT Make_school_tax_district2(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district2(UNSIGNED1 wh) := '';
EXPORT Make_school_tax_district2_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district2_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district2_indicator(UNSIGNED1 wh) := '';
EXPORT Make_school_tax_district3(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district3(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district3(UNSIGNED1 wh) := '';
EXPORT Make_school_tax_district3_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_school_tax_district3_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_school_tax_district3_indicator(UNSIGNED1 wh) := '';
EXPORT Make_lot_size(SALT33.StrType s0) := s0;
EXPORT InValid_lot_size(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_lot_size(UNSIGNED1 wh) := '';
EXPORT Make_lot_size_acres(SALT33.StrType s0) := s0;
EXPORT InValid_lot_size_acres(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_lot_size_acres(UNSIGNED1 wh) := '';
EXPORT Make_lot_size_frontage_feet(SALT33.StrType s0) := s0;
EXPORT InValid_lot_size_frontage_feet(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_lot_size_frontage_feet(UNSIGNED1 wh) := '';
EXPORT Make_lot_size_depth_feet(SALT33.StrType s0) := s0;
EXPORT InValid_lot_size_depth_feet(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_lot_size_depth_feet(UNSIGNED1 wh) := '';
EXPORT Make_land_acres(SALT33.StrType s0) := s0;
EXPORT InValid_land_acres(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_land_acres(UNSIGNED1 wh) := '';
EXPORT Make_land_square_footage(SALT33.StrType s0) := s0;
EXPORT InValid_land_square_footage(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_land_square_footage(UNSIGNED1 wh) := '';
EXPORT Make_land_dimensions(SALT33.StrType s0) := s0;
EXPORT InValid_land_dimensions(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_land_dimensions(UNSIGNED1 wh) := '';
EXPORT Make_building_area(SALT33.StrType s0) := s0;
EXPORT InValid_building_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area(UNSIGNED1 wh) := '';
EXPORT Make_building_area_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area_indicator(s0);
EXPORT InValid_building_area_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area_indicator(wh);
EXPORT Make_building_area1(SALT33.StrType s0) := s0;
EXPORT InValid_building_area1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area1(UNSIGNED1 wh) := '';
EXPORT Make_building_area1_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area1_indicator(s0);
EXPORT InValid_building_area1_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area1_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area1_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area1_indicator(wh);
EXPORT Make_building_area2(SALT33.StrType s0) := s0;
EXPORT InValid_building_area2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area2(UNSIGNED1 wh) := '';
EXPORT Make_building_area2_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area2_indicator(s0);
EXPORT InValid_building_area2_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area2_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area2_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area2_indicator(wh);
EXPORT Make_building_area3(SALT33.StrType s0) := s0;
EXPORT InValid_building_area3(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area3(UNSIGNED1 wh) := '';
EXPORT Make_building_area3_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area3_indicator(s0);
EXPORT InValid_building_area3_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area3_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area3_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area3_indicator(wh);
EXPORT Make_building_area4(SALT33.StrType s0) := s0;
EXPORT InValid_building_area4(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area4(UNSIGNED1 wh) := '';
EXPORT Make_building_area4_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area4_indicator(s0);
EXPORT InValid_building_area4_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area4_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area4_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area4_indicator(wh);
EXPORT Make_building_area5(SALT33.StrType s0) := s0;
EXPORT InValid_building_area5(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area5(UNSIGNED1 wh) := '';
EXPORT Make_building_area5_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area5_indicator(s0);
EXPORT InValid_building_area5_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area5_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area5_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area5_indicator(wh);
EXPORT Make_building_area6(SALT33.StrType s0) := s0;
EXPORT InValid_building_area6(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area6(UNSIGNED1 wh) := '';
EXPORT Make_building_area6_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area6_indicator(s0);
EXPORT InValid_building_area6_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area6_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area6_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area6_indicator(wh);
EXPORT Make_building_area7(SALT33.StrType s0) := s0;
EXPORT InValid_building_area7(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_area7(UNSIGNED1 wh) := '';
EXPORT Make_building_area7_indicator(SALT33.StrType s0) := MakeFT_invalid_building_area7_indicator(s0);
EXPORT InValid_building_area7_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_area7_indicator(s,vendor_source_flag);
EXPORT InValidMessage_building_area7_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_building_area7_indicator(wh);
EXPORT Make_year_built(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_year_built(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_year_built(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_effective_year_built(SALT33.StrType s0) := MakeFT_invalid_year(s0);
EXPORT InValid_effective_year_built(SALT33.StrType s) := InValidFT_invalid_year(s);
EXPORT InValidMessage_effective_year_built(UNSIGNED1 wh) := InValidMessageFT_invalid_year(wh);
EXPORT Make_no_of_buildings(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_buildings(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_buildings(UNSIGNED1 wh) := '';
EXPORT Make_no_of_stories(SALT33.StrType s0) := MakeFT_invalid_no_of_stories(s0);
EXPORT InValid_no_of_stories(SALT33.StrType s) := InValidFT_invalid_no_of_stories(s);
EXPORT InValidMessage_no_of_stories(UNSIGNED1 wh) := InValidMessageFT_invalid_no_of_stories(wh);
EXPORT Make_no_of_units(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_units(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_units(UNSIGNED1 wh) := '';
EXPORT Make_no_of_rooms(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_rooms(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_rooms(UNSIGNED1 wh) := '';
EXPORT Make_no_of_bedrooms(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_bedrooms(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_bedrooms(UNSIGNED1 wh) := '';
EXPORT Make_no_of_baths(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_baths(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_baths(UNSIGNED1 wh) := '';
EXPORT Make_no_of_partial_baths(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_partial_baths(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_partial_baths(UNSIGNED1 wh) := '';
EXPORT Make_no_of_plumbing_fixtures(SALT33.StrType s0) := s0;
EXPORT InValid_no_of_plumbing_fixtures(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_no_of_plumbing_fixtures(UNSIGNED1 wh) := '';
EXPORT Make_garage_type_code(SALT33.StrType s0) := MakeFT_invalid_garage_type_code(s0);
EXPORT InValid_garage_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_garage_type_code(s,vendor_source_flag);
EXPORT InValidMessage_garage_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_garage_type_code(wh);
EXPORT Make_parking_no_of_cars(SALT33.StrType s0) := s0;
EXPORT InValid_parking_no_of_cars(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_parking_no_of_cars(UNSIGNED1 wh) := '';
EXPORT Make_pool_code(SALT33.StrType s0) := MakeFT_invalid_pool_code(s0);
EXPORT InValid_pool_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_pool_code(s,vendor_source_flag);
EXPORT InValidMessage_pool_code(UNSIGNED1 wh) := InValidMessageFT_invalid_pool_code(wh);
EXPORT Make_style_code(SALT33.StrType s0) := s0;
EXPORT InValid_style_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_style_code(UNSIGNED1 wh) := '';
EXPORT Make_type_construction_code(SALT33.StrType s0) := MakeFT_invalid_construction_type(s0);
EXPORT InValid_type_construction_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_construction_type(s,vendor_source_flag);
EXPORT InValidMessage_type_construction_code(UNSIGNED1 wh) := InValidMessageFT_invalid_construction_type(wh);
EXPORT Make_foundation_code(SALT33.StrType s0) := s0;
EXPORT InValid_foundation_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_foundation_code(UNSIGNED1 wh) := '';
EXPORT Make_building_quality_code(SALT33.StrType s0) := MakeFT_invalid_building_quality_code(s0);
EXPORT InValid_building_quality_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_quality_code(s,vendor_source_flag);
EXPORT InValidMessage_building_quality_code(UNSIGNED1 wh) := InValidMessageFT_invalid_building_quality_code(wh);
EXPORT Make_building_condition_code(SALT33.StrType s0) := s0;
EXPORT InValid_building_condition_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_building_condition_code(UNSIGNED1 wh) := '';
EXPORT Make_exterior_walls_code(SALT33.StrType s0) := MakeFT_invalid_exterior_walls_code(s0);
EXPORT InValid_exterior_walls_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_exterior_walls_code(s,vendor_source_flag);
EXPORT InValidMessage_exterior_walls_code(UNSIGNED1 wh) := InValidMessageFT_invalid_exterior_walls_code(wh);
EXPORT Make_interior_walls_code(SALT33.StrType s0) := s0;
EXPORT InValid_interior_walls_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_interior_walls_code(UNSIGNED1 wh) := '';
EXPORT Make_roof_cover_code(SALT33.StrType s0) := s0;
EXPORT InValid_roof_cover_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_roof_cover_code(UNSIGNED1 wh) := '';
EXPORT Make_roof_type_code(SALT33.StrType s0) := MakeFT_invalid_roof_type_code(s0);
EXPORT InValid_roof_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_roof_type_code(s,vendor_source_flag);
EXPORT InValidMessage_roof_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_roof_type_code(wh);
EXPORT Make_floor_cover_code(SALT33.StrType s0) := MakeFT_invalid_floor_cover_code(s0);
EXPORT InValid_floor_cover_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_floor_cover_code(s,vendor_source_flag);
EXPORT InValidMessage_floor_cover_code(UNSIGNED1 wh) := InValidMessageFT_invalid_floor_cover_code(wh);
EXPORT Make_water_code(SALT33.StrType s0) := s0;
EXPORT InValid_water_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_water_code(UNSIGNED1 wh) := '';
EXPORT Make_sewer_code(SALT33.StrType s0) := s0;
EXPORT InValid_sewer_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_sewer_code(UNSIGNED1 wh) := '';
EXPORT Make_heating_code(SALT33.StrType s0) := MakeFT_invalid_heating_code(s0);
EXPORT InValid_heating_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_heating_code(s,vendor_source_flag);
EXPORT InValidMessage_heating_code(UNSIGNED1 wh) := InValidMessageFT_invalid_heating_code(wh);
EXPORT Make_heating_fuel_type_code(SALT33.StrType s0) := MakeFT_invalid_heating_fuel_type_code(s0);
EXPORT InValid_heating_fuel_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_heating_fuel_type_code(s,vendor_source_flag);
EXPORT InValidMessage_heating_fuel_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_heating_fuel_type_code(wh);
EXPORT Make_air_conditioning_code(SALT33.StrType s0) := s0;
EXPORT InValid_air_conditioning_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_air_conditioning_code(UNSIGNED1 wh) := '';
EXPORT Make_air_conditioning_type_code(SALT33.StrType s0) := MakeFT_invalid_air_conditioning_type_code(s0);
EXPORT InValid_air_conditioning_type_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_air_conditioning_type_code(s,vendor_source_flag);
EXPORT InValidMessage_air_conditioning_type_code(UNSIGNED1 wh) := InValidMessageFT_invalid_air_conditioning_type_code(wh);
EXPORT Make_elevator(SALT33.StrType s0) := s0;
EXPORT InValid_elevator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_elevator(UNSIGNED1 wh) := '';
EXPORT Make_fireplace_indicator(SALT33.StrType s0) := MakeFT_invalid_fireplace_indicator(s0);
EXPORT InValid_fireplace_indicator(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_fireplace_indicator(s,vendor_source_flag);
EXPORT InValidMessage_fireplace_indicator(UNSIGNED1 wh) := InValidMessageFT_invalid_fireplace_indicator(wh);
EXPORT Make_fireplace_number(SALT33.StrType s0) := s0;
EXPORT InValid_fireplace_number(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_fireplace_number(UNSIGNED1 wh) := '';
EXPORT Make_basement_code(SALT33.StrType s0) := MakeFT_invalid_basement_code(s0);
EXPORT InValid_basement_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_basement_code(s,vendor_source_flag);
EXPORT InValidMessage_basement_code(UNSIGNED1 wh) := InValidMessageFT_invalid_basement_code(wh);
EXPORT Make_building_class_code(SALT33.StrType s0) := MakeFT_invalid_building_class_code(s0);
EXPORT InValid_building_class_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_building_class_code(s,vendor_source_flag);
EXPORT InValidMessage_building_class_code(UNSIGNED1 wh) := InValidMessageFT_invalid_building_class_code(wh);
EXPORT Make_site_influence1_code(SALT33.StrType s0) := MakeFT_invalid_site_influence1_code(s0);
EXPORT InValid_site_influence1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_site_influence1_code(s,vendor_source_flag);
EXPORT InValidMessage_site_influence1_code(UNSIGNED1 wh) := InValidMessageFT_invalid_site_influence1_code(wh);
EXPORT Make_site_influence2_code(SALT33.StrType s0) := s0;
EXPORT InValid_site_influence2_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_site_influence2_code(UNSIGNED1 wh) := '';
EXPORT Make_site_influence3_code(SALT33.StrType s0) := s0;
EXPORT InValid_site_influence3_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_site_influence3_code(UNSIGNED1 wh) := '';
EXPORT Make_site_influence4_code(SALT33.StrType s0) := s0;
EXPORT InValid_site_influence4_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_site_influence4_code(UNSIGNED1 wh) := '';
EXPORT Make_site_influence5_code(SALT33.StrType s0) := s0;
EXPORT InValid_site_influence5_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_site_influence5_code(UNSIGNED1 wh) := '';
EXPORT Make_amenities1_code(SALT33.StrType s0) := MakeFT_invalid_amenities1_code(s0);
EXPORT InValid_amenities1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_amenities1_code(s,vendor_source_flag);
EXPORT InValidMessage_amenities1_code(UNSIGNED1 wh) := InValidMessageFT_invalid_amenities1_code(wh);
EXPORT Make_amenities2_code(SALT33.StrType s0) := MakeFT_invalid_amenities2_code(s0);
EXPORT InValid_amenities2_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_amenities2_code(s,vendor_source_flag);
EXPORT InValidMessage_amenities2_code(UNSIGNED1 wh) := InValidMessageFT_invalid_amenities2_code(wh);
EXPORT Make_amenities3_code(SALT33.StrType s0) := MakeFT_invalid_amenities3_code(s0);
EXPORT InValid_amenities3_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_amenities3_code(s,vendor_source_flag);
EXPORT InValidMessage_amenities3_code(UNSIGNED1 wh) := InValidMessageFT_invalid_amenities3_code(wh);
EXPORT Make_amenities4_code(SALT33.StrType s0) := MakeFT_invalid_amenities4_code(s0);
EXPORT InValid_amenities4_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_amenities4_code(s,vendor_source_flag);
EXPORT InValidMessage_amenities4_code(UNSIGNED1 wh) := InValidMessageFT_invalid_amenities4_code(wh);
EXPORT Make_amenities5_code(SALT33.StrType s0) := s0;
EXPORT InValid_amenities5_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities5_code(UNSIGNED1 wh) := '';
EXPORT Make_amenities2_code1(SALT33.StrType s0) := s0;
EXPORT InValid_amenities2_code1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities2_code1(UNSIGNED1 wh) := '';
EXPORT Make_amenities2_code2(SALT33.StrType s0) := s0;
EXPORT InValid_amenities2_code2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities2_code2(UNSIGNED1 wh) := '';
EXPORT Make_amenities2_code3(SALT33.StrType s0) := s0;
EXPORT InValid_amenities2_code3(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities2_code3(UNSIGNED1 wh) := '';
EXPORT Make_amenities2_code4(SALT33.StrType s0) := s0;
EXPORT InValid_amenities2_code4(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities2_code4(UNSIGNED1 wh) := '';
EXPORT Make_amenities2_code5(SALT33.StrType s0) := s0;
EXPORT InValid_amenities2_code5(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_amenities2_code5(UNSIGNED1 wh) := '';
EXPORT Make_extra_features1_area(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features1_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features1_area(UNSIGNED1 wh) := '';
EXPORT Make_extra_features1_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features1_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features1_indicator(UNSIGNED1 wh) := '';
EXPORT Make_extra_features2_area(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features2_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features2_area(UNSIGNED1 wh) := '';
EXPORT Make_extra_features2_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features2_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features2_indicator(UNSIGNED1 wh) := '';
EXPORT Make_extra_features3_area(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features3_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features3_area(UNSIGNED1 wh) := '';
EXPORT Make_extra_features3_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features3_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features3_indicator(UNSIGNED1 wh) := '';
EXPORT Make_extra_features4_area(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features4_area(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features4_area(UNSIGNED1 wh) := '';
EXPORT Make_extra_features4_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_extra_features4_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_extra_features4_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_buildings1_code(SALT33.StrType s0) := MakeFT_invalid_other_buildings1_code(s0);
EXPORT InValid_other_buildings1_code(SALT33.StrType s,SALT33.StrType vendor_source_flag) := InValidFT_invalid_other_buildings1_code(s,vendor_source_flag);
EXPORT InValidMessage_other_buildings1_code(UNSIGNED1 wh) := InValidMessageFT_invalid_other_buildings1_code(wh);
EXPORT Make_other_buildings2_code(SALT33.StrType s0) := s0;
EXPORT InValid_other_buildings2_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_buildings2_code(UNSIGNED1 wh) := '';
EXPORT Make_other_buildings3_code(SALT33.StrType s0) := s0;
EXPORT InValid_other_buildings3_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_buildings3_code(UNSIGNED1 wh) := '';
EXPORT Make_other_buildings4_code(SALT33.StrType s0) := s0;
EXPORT InValid_other_buildings4_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_buildings4_code(UNSIGNED1 wh) := '';
EXPORT Make_other_buildings5_code(SALT33.StrType s0) := s0;
EXPORT InValid_other_buildings5_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_buildings5_code(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building1_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building1_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building1_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building2_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building2_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building2_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building3_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building3_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building3_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building4_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building4_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building4_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building5_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building5_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building5_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building_area1(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building_area1(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building_area1(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building_area2(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building_area2(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building_area2(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building_area3(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building_area3(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building_area3(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building_area4(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building_area4(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building_area4(UNSIGNED1 wh) := '';
EXPORT Make_other_impr_building_area5(SALT33.StrType s0) := s0;
EXPORT InValid_other_impr_building_area5(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_impr_building_area5(UNSIGNED1 wh) := '';
EXPORT Make_topograpy_code(SALT33.StrType s0) := s0;
EXPORT InValid_topograpy_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_topograpy_code(UNSIGNED1 wh) := '';
EXPORT Make_neighborhood_code(SALT33.StrType s0) := s0;
EXPORT InValid_neighborhood_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_neighborhood_code(UNSIGNED1 wh) := '';
EXPORT Make_condo_project_or_building_name(SALT33.StrType s0) := s0;
EXPORT InValid_condo_project_or_building_name(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_condo_project_or_building_name(UNSIGNED1 wh) := '';
EXPORT Make_assessee_name_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_assessee_name_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_assessee_name_indicator(UNSIGNED1 wh) := '';
EXPORT Make_second_assessee_name_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_second_assessee_name_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_second_assessee_name_indicator(UNSIGNED1 wh) := '';
EXPORT Make_other_rooms_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_other_rooms_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_other_rooms_indicator(UNSIGNED1 wh) := '';
EXPORT Make_mail_care_of_name_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_mail_care_of_name_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_mail_care_of_name_indicator(UNSIGNED1 wh) := '';
EXPORT Make_comments(SALT33.StrType s0) := s0;
EXPORT InValid_comments(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_comments(UNSIGNED1 wh) := '';
EXPORT Make_tape_cut_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_tape_cut_date(SALT33.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_tape_cut_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_certification_date(SALT33.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_certification_date(SALT33.StrType s) := InValidFT_invalid_date(s);
EXPORT InValidMessage_certification_date(UNSIGNED1 wh) := InValidMessageFT_invalid_date(wh);
EXPORT Make_edition_number(SALT33.StrType s0) := s0;
EXPORT InValid_edition_number(SALT33.StrType s) := FALSE;
...
EXPORT Make_ln_mailing_country_code(SALT33.StrType s0) := s0;
EXPORT InValid_ln_mailing_country_code(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_mailing_country_code(UNSIGNED1 wh) := '';
EXPORT Make_ln_property_name(SALT33.StrType s0) := s0;
EXPORT InValid_ln_property_name(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_property_name(UNSIGNED1 wh) := '';
EXPORT Make_ln_property_name_type(SALT33.StrType s0) := s0;
EXPORT InValid_ln_property_name_type(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_property_name_type(UNSIGNED1 wh) := '';
EXPORT Make_ln_land_use_category(SALT33.StrType s0) := s0;
EXPORT InValid_ln_land_use_category(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_land_use_category(UNSIGNED1 wh) := '';
EXPORT Make_ln_lot(SALT33.StrType s0) := s0;
EXPORT InValid_ln_lot(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_lot(UNSIGNED1 wh) := '';
EXPORT Make_ln_block(SALT33.StrType s0) := s0;
EXPORT InValid_ln_block(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_block(UNSIGNED1 wh) := '';
EXPORT Make_ln_unit(SALT33.StrType s0) := s0;
EXPORT InValid_ln_unit(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_unit(UNSIGNED1 wh) := '';
EXPORT Make_ln_subfloor(SALT33.StrType s0) := s0;
EXPORT InValid_ln_subfloor(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_subfloor(UNSIGNED1 wh) := '';
EXPORT Make_ln_floor_cover(SALT33.StrType s0) := s0;
EXPORT InValid_ln_floor_cover(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_floor_cover(UNSIGNED1 wh) := '';
EXPORT Make_ln_mobile_home_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_ln_mobile_home_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_mobile_home_indicator(UNSIGNED1 wh) := '';
EXPORT Make_ln_condo_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_ln_condo_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_condo_indicator(UNSIGNED1 wh) := '';
EXPORT Make_ln_property_tax_exemption(SALT33.StrType s0) := s0;
EXPORT InValid_ln_property_tax_exemption(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_property_tax_exemption(UNSIGNED1 wh) := '';
EXPORT Make_ln_veteran_status(SALT33.StrType s0) := s0;
EXPORT InValid_ln_veteran_status(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_veteran_status(UNSIGNED1 wh) := '';
EXPORT Make_ln_old_apn_indicator(SALT33.StrType s0) := s0;
EXPORT InValid_ln_old_apn_indicator(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_ln_old_apn_indicator(UNSIGNED1 wh) := '';
EXPORT Make_fips(SALT33.StrType s0) := MakeFT_invalid_fips(s0);
EXPORT InValid_fips(SALT33.StrType s) := InValidFT_invalid_fips(s);
