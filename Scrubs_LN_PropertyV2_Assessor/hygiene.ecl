...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    txt;
    Source := MAX(GROUP,h.fips_code);    NumberOfRecords := COUNT(GROUP);
    populated_ln_fares_id_pcnt := AVE(GROUP,IF(h.ln_fares_id = (TYPEOF(h.ln_fares_id))'',0,100));
    maxlength_ln_fares_id := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_fares_id)));
    avelength_ln_fares_id := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_fares_id)),h.ln_fares_id<>(typeof(h.ln_fares_id))'');
    ...
    maxlength_vendor_source_flag := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.vendor_source_flag)));
    avelength_vendor_source_flag := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.vendor_source_flag)),h.vendor_source_flag<>(typeof(h.vendor_source_flag))'');
    populated_current_record_pcnt := AVE(GROUP,IF(h.current_record = (TYPEOF(h.current_record))'',0,100));
    maxlength_current_record := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.current_record)));
    avelength_current_record := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.current_record)),h.current_record<>(typeof(h.current_record))'');
    populated_fips_code_pcnt := AVE(GROUP,IF(h.fips_code = (TYPEOF(h.fips_code))'',0,100));
    maxlength_fips_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fips_code)));
    avelength_fips_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fips_code)),h.fips_code<>(typeof(h.fips_code))'');
    populated_state_code_pcnt := AVE(GROUP,IF(h.state_code = (TYPEOF(h.state_code))'',0,100));
    maxlength_state_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_code)));
    avelength_state_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_code)),h.state_code<>(typeof(h.state_code))'');
    ...
    maxlength_old_apn := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.old_apn)));
    avelength_old_apn := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.old_apn)),h.old_apn<>(typeof(h.old_apn))'');
    populated_apna_or_pin_number_pcnt := AVE(GROUP,IF(h.apna_or_pin_number = (TYPEOF(h.apna_or_pin_number))'',0,100));
    maxlength_apna_or_pin_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.apna_or_pin_number)));
    avelength_apna_or_pin_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.apna_or_pin_number)),h.apna_or_pin_number<>(typeof(h.apna_or_pin_number))'');
    populated_fares_unformatted_apn_pcnt := AVE(GROUP,IF(h.fares_unformatted_apn = (TYPEOF(h.fares_unformatted_apn))'',0,100));
    maxlength_fares_unformatted_apn := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fares_unformatted_apn)));
    avelength_fares_unformatted_apn := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fares_unformatted_apn)),h.fares_unformatted_apn<>(typeof(h.fares_unformatted_apn))'');
    ...
    maxlength_duplicate_apn_multiple_address_id := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.duplicate_apn_multiple_address_id)));
    avelength_duplicate_apn_multiple_address_id := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.duplicate_apn_multiple_address_id)),h.duplicate_apn_multiple_address_id<>(typeof(h.duplicate_apn_multiple_address_id))'');
    populated_assessee_name_pcnt := AVE(GROUP,IF(h.assessee_name = (TYPEOF(h.assessee_name))'',0,100));
    maxlength_assessee_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name)));
    avelength_assessee_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name)),h.assessee_name<>(typeof(h.assessee_name))'');
    populated_second_assessee_name_pcnt := AVE(GROUP,IF(h.second_assessee_name = (TYPEOF(h.second_assessee_name))'',0,100));
    maxlength_second_assessee_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name)));
    avelength_second_assessee_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name)),h.second_assessee_name<>(typeof(h.second_assessee_name))'');
    ...
    maxlength_assessee_ownership_rights_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_ownership_rights_code)));
    avelength_assessee_ownership_rights_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_ownership_rights_code)),h.assessee_ownership_rights_code<>(typeof(h.assessee_ownership_rights_code))'');
    ...
    maxlength_assessee_relationship_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_relationship_code)));
    avelength_assessee_relationship_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_relationship_code)),h.assessee_relationship_code<>(typeof(h.assessee_relationship_code))'');
    populated_assessee_phone_number_pcnt := AVE(GROUP,IF(h.assessee_phone_number = (TYPEOF(h.assessee_phone_number))'',0,100));
    maxlength_assessee_phone_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_phone_number)));
    avelength_assessee_phone_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_phone_number)),h.assessee_phone_number<>(typeof(h.assessee_phone_number))'');
    populated_tax_account_number_pcnt := AVE(GROUP,IF(h.tax_account_number = (TYPEOF(h.tax_account_number))'',0,100));
    maxlength_tax_account_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_account_number)));
    avelength_tax_account_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_account_number)),h.tax_account_number<>(typeof(h.tax_account_number))'');
    populated_contract_owner_pcnt := AVE(GROUP,IF(h.contract_owner = (TYPEOF(h.contract_owner))'',0,100));
    maxlength_contract_owner := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contract_owner)));
    avelength_contract_owner := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contract_owner)),h.contract_owner<>(typeof(h.contract_owner))'');
    populated_assessee_name_type_code_pcnt := AVE(GROUP,IF(h.assessee_name_type_code = (TYPEOF(h.assessee_name_type_code))'',0,100));
    maxlength_assessee_name_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name_type_code)));
    avelength_assessee_name_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name_type_code)),h.assessee_name_type_code<>(typeof(h.assessee_name_type_code))'');
    ...
    maxlength_second_assessee_name_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name_type_code)));
    avelength_second_assessee_name_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name_type_code)),h.second_assessee_name_type_code<>(typeof(h.second_assessee_name_type_code))'');
    ...
    maxlength_mail_care_of_name_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mail_care_of_name_type_code)));
    avelength_mail_care_of_name_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mail_care_of_name_type_code)),h.mail_care_of_name_type_code<>(typeof(h.mail_care_of_name_type_code))'');
    populated_mailing_care_of_name_pcnt := AVE(GROUP,IF(h.mailing_care_of_name = (TYPEOF(h.mailing_care_of_name))'',0,100));
    maxlength_mailing_care_of_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_care_of_name)));
    avelength_mailing_care_of_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_care_of_name)),h.mailing_care_of_name<>(typeof(h.mailing_care_of_name))'');
    ...
    maxlength_mailing_full_street_address := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_full_street_address)));
    avelength_mailing_full_street_address := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_full_street_address)),h.mailing_full_street_address<>(typeof(h.mailing_full_street_address))'');
    populated_mailing_unit_number_pcnt := AVE(GROUP,IF(h.mailing_unit_number = (TYPEOF(h.mailing_unit_number))'',0,100));
    maxlength_mailing_unit_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_unit_number)));
    avelength_mailing_unit_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_unit_number)),h.mailing_unit_number<>(typeof(h.mailing_unit_number))'');
    populated_mailing_city_state_zip_pcnt := AVE(GROUP,IF(h.mailing_city_state_zip = (TYPEOF(h.mailing_city_state_zip))'',0,100));
    maxlength_mailing_city_state_zip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_city_state_zip)));
    avelength_mailing_city_state_zip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mailing_city_state_zip)),h.mailing_city_state_zip<>(typeof(h.mailing_city_state_zip))'');
    ...
    maxlength_property_full_street_address := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_full_street_address)));
    avelength_property_full_street_address := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_full_street_address)),h.property_full_street_address<>(typeof(h.property_full_street_address))'');
    populated_property_unit_number_pcnt := AVE(GROUP,IF(h.property_unit_number = (TYPEOF(h.property_unit_number))'',0,100));
    maxlength_property_unit_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_unit_number)));
    avelength_property_unit_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_unit_number)),h.property_unit_number<>(typeof(h.property_unit_number))'');
    populated_property_city_state_zip_pcnt := AVE(GROUP,IF(h.property_city_state_zip = (TYPEOF(h.property_city_state_zip))'',0,100));
    maxlength_property_city_state_zip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_city_state_zip)));
    avelength_property_city_state_zip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_city_state_zip)),h.property_city_state_zip<>(typeof(h.property_city_state_zip))'');
    populated_property_country_code_pcnt := AVE(GROUP,IF(h.property_country_code = (TYPEOF(h.property_country_code))'',0,100));
    maxlength_property_country_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_country_code)));
    avelength_property_country_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_country_code)),h.property_country_code<>(typeof(h.property_country_code))'');
    populated_property_address_code_pcnt := AVE(GROUP,IF(h.property_address_code = (TYPEOF(h.property_address_code))'',0,100));
    maxlength_property_address_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_code)));
    avelength_property_address_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.property_address_code)),h.property_address_code<>(typeof(h.property_address_code))'');
    populated_legal_lot_code_pcnt := AVE(GROUP,IF(h.legal_lot_code = (TYPEOF(h.legal_lot_code))'',0,100));
    maxlength_legal_lot_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_lot_code)));
    avelength_legal_lot_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_lot_code)),h.legal_lot_code<>(typeof(h.legal_lot_code))'');
    populated_legal_lot_number_pcnt := AVE(GROUP,IF(h.legal_lot_number = (TYPEOF(h.legal_lot_number))'',0,100));
    maxlength_legal_lot_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_lot_number)));
    avelength_legal_lot_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_lot_number)),h.legal_lot_number<>(typeof(h.legal_lot_number))'');
    populated_legal_land_lot_pcnt := AVE(GROUP,IF(h.legal_land_lot = (TYPEOF(h.legal_land_lot))'',0,100));
    maxlength_legal_land_lot := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_land_lot)));
    avelength_legal_land_lot := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_land_lot)),h.legal_land_lot<>(typeof(h.legal_land_lot))'');
    ...
    maxlength_legal_section := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_section)));
    avelength_legal_section := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_section)),h.legal_section<>(typeof(h.legal_section))'');
    populated_legal_district_pcnt := AVE(GROUP,IF(h.legal_district = (TYPEOF(h.legal_district))'',0,100));
    maxlength_legal_district := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_district)));
    avelength_legal_district := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_district)),h.legal_district<>(typeof(h.legal_district))'');
    populated_legal_unit_pcnt := AVE(GROUP,IF(h.legal_unit = (TYPEOF(h.legal_unit))'',0,100));
    maxlength_legal_unit := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_unit)));
    avelength_legal_unit := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_unit)),h.legal_unit<>(typeof(h.legal_unit))'');
    ...
    maxlength_legal_city_municipality_township := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_city_municipality_township)));
    avelength_legal_city_municipality_township := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_city_municipality_township)),h.legal_city_municipality_township<>(typeof(h.legal_city_municipality_township))'');
    populated_legal_subdivision_name_pcnt := AVE(GROUP,IF(h.legal_subdivision_name = (TYPEOF(h.legal_subdivision_name))'',0,100));
    maxlength_legal_subdivision_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_subdivision_name)));
    avelength_legal_subdivision_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_subdivision_name)),h.legal_subdivision_name<>(typeof(h.legal_subdivision_name))'');
    populated_legal_phase_number_pcnt := AVE(GROUP,IF(h.legal_phase_number = (TYPEOF(h.legal_phase_number))'',0,100));
    maxlength_legal_phase_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_phase_number)));
    avelength_legal_phase_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_phase_number)),h.legal_phase_number<>(typeof(h.legal_phase_number))'');
    populated_legal_tract_number_pcnt := AVE(GROUP,IF(h.legal_tract_number = (TYPEOF(h.legal_tract_number))'',0,100));
    maxlength_legal_tract_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_tract_number)));
    avelength_legal_tract_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_tract_number)),h.legal_tract_number<>(typeof(h.legal_tract_number))'');
    populated_legal_sec_twn_rng_mer_pcnt := AVE(GROUP,IF(h.legal_sec_twn_rng_mer = (TYPEOF(h.legal_sec_twn_rng_mer))'',0,100));
    maxlength_legal_sec_twn_rng_mer := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_sec_twn_rng_mer)));
    avelength_legal_sec_twn_rng_mer := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_sec_twn_rng_mer)),h.legal_sec_twn_rng_mer<>(typeof(h.legal_sec_twn_rng_mer))'');
    populated_legal_brief_description_pcnt := AVE(GROUP,IF(h.legal_brief_description = (TYPEOF(h.legal_brief_description))'',0,100));
    maxlength_legal_brief_description := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_brief_description)));
    avelength_legal_brief_description := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_brief_description)),h.legal_brief_description<>(typeof(h.legal_brief_description))'');
    populated_legal_assessor_map_ref_pcnt := AVE(GROUP,IF(h.legal_assessor_map_ref = (TYPEOF(h.legal_assessor_map_ref))'',0,100));
    maxlength_legal_assessor_map_ref := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_assessor_map_ref)));
    avelength_legal_assessor_map_ref := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.legal_assessor_map_ref)),h.legal_assessor_map_ref<>(typeof(h.legal_assessor_map_ref))'');
    populated_census_tract_pcnt := AVE(GROUP,IF(h.census_tract = (TYPEOF(h.census_tract))'',0,100));
    maxlength_census_tract := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.census_tract)));
    avelength_census_tract := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.census_tract)),h.census_tract<>(typeof(h.census_tract))'');
    populated_record_type_code_pcnt := AVE(GROUP,IF(h.record_type_code = (TYPEOF(h.record_type_code))'',0,100));
    maxlength_record_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.record_type_code)));
    avelength_record_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.record_type_code)),h.record_type_code<>(typeof(h.record_type_code))'');
    populated_ownership_type_code_pcnt := AVE(GROUP,IF(h.ownership_type_code = (TYPEOF(h.ownership_type_code))'',0,100));
    maxlength_ownership_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ownership_type_code)));
    avelength_ownership_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ownership_type_code)),h.ownership_type_code<>(typeof(h.ownership_type_code))'');
    populated_new_record_type_code_pcnt := AVE(GROUP,IF(h.new_record_type_code = (TYPEOF(h.new_record_type_code))'',0,100));
    maxlength_new_record_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.new_record_type_code)));
    avelength_new_record_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.new_record_type_code)),h.new_record_type_code<>(typeof(h.new_record_type_code))'');
    populated_state_land_use_code_pcnt := AVE(GROUP,IF(h.state_land_use_code = (TYPEOF(h.state_land_use_code))'',0,100));
    maxlength_state_land_use_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_land_use_code)));
    avelength_state_land_use_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.state_land_use_code)),h.state_land_use_code<>(typeof(h.state_land_use_code))'');
    populated_county_land_use_code_pcnt := AVE(GROUP,IF(h.county_land_use_code = (TYPEOF(h.county_land_use_code))'',0,100));
    maxlength_county_land_use_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_land_use_code)));
    avelength_county_land_use_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_land_use_code)),h.county_land_use_code<>(typeof(h.county_land_use_code))'');
    ...
    maxlength_county_land_use_description := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_land_use_description)));
    avelength_county_land_use_description := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.county_land_use_description)),h.county_land_use_description<>(typeof(h.county_land_use_description))'');
    ...
    maxlength_standardized_land_use_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.standardized_land_use_code)));
    avelength_standardized_land_use_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.standardized_land_use_code)),h.standardized_land_use_code<>(typeof(h.standardized_land_use_code))'');
    populated_timeshare_code_pcnt := AVE(GROUP,IF(h.timeshare_code = (TYPEOF(h.timeshare_code))'',0,100));
    maxlength_timeshare_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.timeshare_code)));
    avelength_timeshare_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.timeshare_code)),h.timeshare_code<>(typeof(h.timeshare_code))'');
    populated_zoning_pcnt := AVE(GROUP,IF(h.zoning = (TYPEOF(h.zoning))'',0,100));
    maxlength_zoning := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.zoning)));
    avelength_zoning := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.zoning)),h.zoning<>(typeof(h.zoning))'');
    populated_owner_occupied_pcnt := AVE(GROUP,IF(h.owner_occupied = (TYPEOF(h.owner_occupied))'',0,100));
    maxlength_owner_occupied := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.owner_occupied)));
    avelength_owner_occupied := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.owner_occupied)),h.owner_occupied<>(typeof(h.owner_occupied))'');
    populated_recorder_document_number_pcnt := AVE(GROUP,IF(h.recorder_document_number = (TYPEOF(h.recorder_document_number))'',0,100));
    maxlength_recorder_document_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_document_number)));
    avelength_recorder_document_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_document_number)),h.recorder_document_number<>(typeof(h.recorder_document_number))'');
    populated_recorder_book_number_pcnt := AVE(GROUP,IF(h.recorder_book_number = (TYPEOF(h.recorder_book_number))'',0,100));
    maxlength_recorder_book_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_book_number)));
    avelength_recorder_book_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_book_number)),h.recorder_book_number<>(typeof(h.recorder_book_number))'');
    populated_recorder_page_number_pcnt := AVE(GROUP,IF(h.recorder_page_number = (TYPEOF(h.recorder_page_number))'',0,100));
    maxlength_recorder_page_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_page_number)));
    avelength_recorder_page_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.recorder_page_number)),h.recorder_page_number<>(typeof(h.recorder_page_number))'');
    populated_transfer_date_pcnt := AVE(GROUP,IF(h.transfer_date = (TYPEOF(h.transfer_date))'',0,100));
    maxlength_transfer_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.transfer_date)));
    avelength_transfer_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.transfer_date)),h.transfer_date<>(typeof(h.transfer_date))'');
    populated_recording_date_pcnt := AVE(GROUP,IF(h.recording_date = (TYPEOF(h.recording_date))'',0,100));
    maxlength_recording_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.recording_date)));
    avelength_recording_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.recording_date)),h.recording_date<>(typeof(h.recording_date))'');
    populated_sale_date_pcnt := AVE(GROUP,IF(h.sale_date = (TYPEOF(h.sale_date))'',0,100));
    maxlength_sale_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sale_date)));
    avelength_sale_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sale_date)),h.sale_date<>(typeof(h.sale_date))'');
    populated_document_type_pcnt := AVE(GROUP,IF(h.document_type = (TYPEOF(h.document_type))'',0,100));
    maxlength_document_type := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_type)));
    avelength_document_type := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.document_type)),h.document_type<>(typeof(h.document_type))'');
    populated_sales_price_pcnt := AVE(GROUP,IF(h.sales_price = (TYPEOF(h.sales_price))'',0,100));
    maxlength_sales_price := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sales_price)));
    avelength_sales_price := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sales_price)),h.sales_price<>(typeof(h.sales_price))'');
    populated_sales_price_code_pcnt := AVE(GROUP,IF(h.sales_price_code = (TYPEOF(h.sales_price_code))'',0,100));
    maxlength_sales_price_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sales_price_code)));
    avelength_sales_price_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sales_price_code)),h.sales_price_code<>(typeof(h.sales_price_code))'');
    populated_mortgage_loan_amount_pcnt := AVE(GROUP,IF(h.mortgage_loan_amount = (TYPEOF(h.mortgage_loan_amount))'',0,100));
    maxlength_mortgage_loan_amount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_loan_amount)));
    avelength_mortgage_loan_amount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_loan_amount)),h.mortgage_loan_amount<>(typeof(h.mortgage_loan_amount))'');
    populated_mortgage_loan_type_code_pcnt := AVE(GROUP,IF(h.mortgage_loan_type_code = (TYPEOF(h.mortgage_loan_type_code))'',0,100));
    maxlength_mortgage_loan_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_loan_type_code)));
    avelength_mortgage_loan_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_loan_type_code)),h.mortgage_loan_type_code<>(typeof(h.mortgage_loan_type_code))'');
    populated_mortgage_lender_name_pcnt := AVE(GROUP,IF(h.mortgage_lender_name = (TYPEOF(h.mortgage_lender_name))'',0,100));
    maxlength_mortgage_lender_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_lender_name)));
    avelength_mortgage_lender_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_lender_name)),h.mortgage_lender_name<>(typeof(h.mortgage_lender_name))'');
    ...
    maxlength_mortgage_lender_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_lender_type_code)));
    avelength_mortgage_lender_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mortgage_lender_type_code)),h.mortgage_lender_type_code<>(typeof(h.mortgage_lender_type_code))'');
    populated_prior_transfer_date_pcnt := AVE(GROUP,IF(h.prior_transfer_date = (TYPEOF(h.prior_transfer_date))'',0,100));
    maxlength_prior_transfer_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_transfer_date)));
    avelength_prior_transfer_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_transfer_date)),h.prior_transfer_date<>(typeof(h.prior_transfer_date))'');
    populated_prior_recording_date_pcnt := AVE(GROUP,IF(h.prior_recording_date = (TYPEOF(h.prior_recording_date))'',0,100));
    maxlength_prior_recording_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_recording_date)));
    avelength_prior_recording_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_recording_date)),h.prior_recording_date<>(typeof(h.prior_recording_date))'');
    populated_prior_sales_price_pcnt := AVE(GROUP,IF(h.prior_sales_price = (TYPEOF(h.prior_sales_price))'',0,100));
    maxlength_prior_sales_price := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_sales_price)));
    avelength_prior_sales_price := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_sales_price)),h.prior_sales_price<>(typeof(h.prior_sales_price))'');
    populated_prior_sales_price_code_pcnt := AVE(GROUP,IF(h.prior_sales_price_code = (TYPEOF(h.prior_sales_price_code))'',0,100));
    maxlength_prior_sales_price_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_sales_price_code)));
    avelength_prior_sales_price_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prior_sales_price_code)),h.prior_sales_price_code<>(typeof(h.prior_sales_price_code))'');
    populated_assessed_land_value_pcnt := AVE(GROUP,IF(h.assessed_land_value = (TYPEOF(h.assessed_land_value))'',0,100));
    maxlength_assessed_land_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_land_value)));
    avelength_assessed_land_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_land_value)),h.assessed_land_value<>(typeof(h.assessed_land_value))'');
    ...
    maxlength_assessed_improvement_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_improvement_value)));
    avelength_assessed_improvement_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_improvement_value)),h.assessed_improvement_value<>(typeof(h.assessed_improvement_value))'');
    populated_assessed_total_value_pcnt := AVE(GROUP,IF(h.assessed_total_value = (TYPEOF(h.assessed_total_value))'',0,100));
    maxlength_assessed_total_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_total_value)));
    avelength_assessed_total_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_total_value)),h.assessed_total_value<>(typeof(h.assessed_total_value))'');
    populated_assessed_value_year_pcnt := AVE(GROUP,IF(h.assessed_value_year = (TYPEOF(h.assessed_value_year))'',0,100));
    maxlength_assessed_value_year := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_value_year)));
    avelength_assessed_value_year := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessed_value_year)),h.assessed_value_year<>(typeof(h.assessed_value_year))'');
    populated_market_land_value_pcnt := AVE(GROUP,IF(h.market_land_value = (TYPEOF(h.market_land_value))'',0,100));
    maxlength_market_land_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_land_value)));
    avelength_market_land_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_land_value)),h.market_land_value<>(typeof(h.market_land_value))'');
    populated_market_improvement_value_pcnt := AVE(GROUP,IF(h.market_improvement_value = (TYPEOF(h.market_improvement_value))'',0,100));
    maxlength_market_improvement_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_improvement_value)));
    avelength_market_improvement_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_improvement_value)),h.market_improvement_value<>(typeof(h.market_improvement_value))'');
    populated_market_total_value_pcnt := AVE(GROUP,IF(h.market_total_value = (TYPEOF(h.market_total_value))'',0,100));
    maxlength_market_total_value := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_total_value)));
    avelength_market_total_value := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_total_value)),h.market_total_value<>(typeof(h.market_total_value))'');
    populated_market_value_year_pcnt := AVE(GROUP,IF(h.market_value_year = (TYPEOF(h.market_value_year))'',0,100));
    maxlength_market_value_year := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_value_year)));
    avelength_market_value_year := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.market_value_year)),h.market_value_year<>(typeof(h.market_value_year))'');
    ...
    maxlength_homestead_homeowner_exemption := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.homestead_homeowner_exemption)));
    avelength_homestead_homeowner_exemption := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.homestead_homeowner_exemption)),h.homestead_homeowner_exemption<>(typeof(h.homestead_homeowner_exemption))'');
    populated_tax_exemption1_code_pcnt := AVE(GROUP,IF(h.tax_exemption1_code = (TYPEOF(h.tax_exemption1_code))'',0,100));
    maxlength_tax_exemption1_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption1_code)));
    avelength_tax_exemption1_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption1_code)),h.tax_exemption1_code<>(typeof(h.tax_exemption1_code))'');
    populated_tax_exemption2_code_pcnt := AVE(GROUP,IF(h.tax_exemption2_code = (TYPEOF(h.tax_exemption2_code))'',0,100));
    maxlength_tax_exemption2_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption2_code)));
    avelength_tax_exemption2_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption2_code)),h.tax_exemption2_code<>(typeof(h.tax_exemption2_code))'');
    populated_tax_exemption3_code_pcnt := AVE(GROUP,IF(h.tax_exemption3_code = (TYPEOF(h.tax_exemption3_code))'',0,100));
    maxlength_tax_exemption3_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption3_code)));
    avelength_tax_exemption3_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption3_code)),h.tax_exemption3_code<>(typeof(h.tax_exemption3_code))'');
    populated_tax_exemption4_code_pcnt := AVE(GROUP,IF(h.tax_exemption4_code = (TYPEOF(h.tax_exemption4_code))'',0,100));
    maxlength_tax_exemption4_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption4_code)));
    avelength_tax_exemption4_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_exemption4_code)),h.tax_exemption4_code<>(typeof(h.tax_exemption4_code))'');
    populated_tax_rate_code_area_pcnt := AVE(GROUP,IF(h.tax_rate_code_area = (TYPEOF(h.tax_rate_code_area))'',0,100));
    maxlength_tax_rate_code_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_rate_code_area)));
    avelength_tax_rate_code_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_rate_code_area)),h.tax_rate_code_area<>(typeof(h.tax_rate_code_area))'');
    populated_tax_amount_pcnt := AVE(GROUP,IF(h.tax_amount = (TYPEOF(h.tax_amount))'',0,100));
    maxlength_tax_amount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_amount)));
    avelength_tax_amount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_amount)),h.tax_amount<>(typeof(h.tax_amount))'');
    populated_tax_year_pcnt := AVE(GROUP,IF(h.tax_year = (TYPEOF(h.tax_year))'',0,100));
    maxlength_tax_year := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_year)));
    avelength_tax_year := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_year)),h.tax_year<>(typeof(h.tax_year))'');
    populated_tax_delinquent_year_pcnt := AVE(GROUP,IF(h.tax_delinquent_year = (TYPEOF(h.tax_delinquent_year))'',0,100));
    maxlength_tax_delinquent_year := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_delinquent_year)));
    avelength_tax_delinquent_year := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tax_delinquent_year)),h.tax_delinquent_year<>(typeof(h.tax_delinquent_year))'');
    populated_school_tax_district1_pcnt := AVE(GROUP,IF(h.school_tax_district1 = (TYPEOF(h.school_tax_district1))'',0,100));
    maxlength_school_tax_district1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district1)));
    avelength_school_tax_district1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district1)),h.school_tax_district1<>(typeof(h.school_tax_district1))'');
    ...
    maxlength_school_tax_district1_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district1_indicator)));
    avelength_school_tax_district1_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district1_indicator)),h.school_tax_district1_indicator<>(typeof(h.school_tax_district1_indicator))'');
    populated_school_tax_district2_pcnt := AVE(GROUP,IF(h.school_tax_district2 = (TYPEOF(h.school_tax_district2))'',0,100));
    maxlength_school_tax_district2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district2)));
    avelength_school_tax_district2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district2)),h.school_tax_district2<>(typeof(h.school_tax_district2))'');
    ...
    maxlength_school_tax_district2_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district2_indicator)));
    avelength_school_tax_district2_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district2_indicator)),h.school_tax_district2_indicator<>(typeof(h.school_tax_district2_indicator))'');
    populated_school_tax_district3_pcnt := AVE(GROUP,IF(h.school_tax_district3 = (TYPEOF(h.school_tax_district3))'',0,100));
    maxlength_school_tax_district3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district3)));
    avelength_school_tax_district3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district3)),h.school_tax_district3<>(typeof(h.school_tax_district3))'');
    ...
    maxlength_school_tax_district3_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district3_indicator)));
    avelength_school_tax_district3_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.school_tax_district3_indicator)),h.school_tax_district3_indicator<>(typeof(h.school_tax_district3_indicator))'');
    populated_lot_size_pcnt := AVE(GROUP,IF(h.lot_size = (TYPEOF(h.lot_size))'',0,100));
    maxlength_lot_size := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size)));
    avelength_lot_size := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size)),h.lot_size<>(typeof(h.lot_size))'');
    populated_lot_size_acres_pcnt := AVE(GROUP,IF(h.lot_size_acres = (TYPEOF(h.lot_size_acres))'',0,100));
    maxlength_lot_size_acres := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_acres)));
    avelength_lot_size_acres := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_acres)),h.lot_size_acres<>(typeof(h.lot_size_acres))'');
    populated_lot_size_frontage_feet_pcnt := AVE(GROUP,IF(h.lot_size_frontage_feet = (TYPEOF(h.lot_size_frontage_feet))'',0,100));
    maxlength_lot_size_frontage_feet := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_frontage_feet)));
    avelength_lot_size_frontage_feet := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_frontage_feet)),h.lot_size_frontage_feet<>(typeof(h.lot_size_frontage_feet))'');
    populated_lot_size_depth_feet_pcnt := AVE(GROUP,IF(h.lot_size_depth_feet = (TYPEOF(h.lot_size_depth_feet))'',0,100));
    maxlength_lot_size_depth_feet := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_depth_feet)));
    avelength_lot_size_depth_feet := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.lot_size_depth_feet)),h.lot_size_depth_feet<>(typeof(h.lot_size_depth_feet))'');
    populated_land_acres_pcnt := AVE(GROUP,IF(h.land_acres = (TYPEOF(h.land_acres))'',0,100));
    maxlength_land_acres := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_acres)));
    avelength_land_acres := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_acres)),h.land_acres<>(typeof(h.land_acres))'');
    populated_land_square_footage_pcnt := AVE(GROUP,IF(h.land_square_footage = (TYPEOF(h.land_square_footage))'',0,100));
    maxlength_land_square_footage := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_square_footage)));
    avelength_land_square_footage := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_square_footage)),h.land_square_footage<>(typeof(h.land_square_footage))'');
    populated_land_dimensions_pcnt := AVE(GROUP,IF(h.land_dimensions = (TYPEOF(h.land_dimensions))'',0,100));
    maxlength_land_dimensions := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_dimensions)));
    avelength_land_dimensions := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.land_dimensions)),h.land_dimensions<>(typeof(h.land_dimensions))'');
    populated_building_area_pcnt := AVE(GROUP,IF(h.building_area = (TYPEOF(h.building_area))'',0,100));
    maxlength_building_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area)));
    avelength_building_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area)),h.building_area<>(typeof(h.building_area))'');
    populated_building_area_indicator_pcnt := AVE(GROUP,IF(h.building_area_indicator = (TYPEOF(h.building_area_indicator))'',0,100));
    maxlength_building_area_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area_indicator)));
    avelength_building_area_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area_indicator)),h.building_area_indicator<>(typeof(h.building_area_indicator))'');
    populated_building_area1_pcnt := AVE(GROUP,IF(h.building_area1 = (TYPEOF(h.building_area1))'',0,100));
    maxlength_building_area1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area1)));
    avelength_building_area1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area1)),h.building_area1<>(typeof(h.building_area1))'');
    populated_building_area1_indicator_pcnt := AVE(GROUP,IF(h.building_area1_indicator = (TYPEOF(h.building_area1_indicator))'',0,100));
    maxlength_building_area1_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area1_indicator)));
    avelength_building_area1_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area1_indicator)),h.building_area1_indicator<>(typeof(h.building_area1_indicator))'');
    populated_building_area2_pcnt := AVE(GROUP,IF(h.building_area2 = (TYPEOF(h.building_area2))'',0,100));
    maxlength_building_area2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area2)));
    avelength_building_area2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area2)),h.building_area2<>(typeof(h.building_area2))'');
    populated_building_area2_indicator_pcnt := AVE(GROUP,IF(h.building_area2_indicator = (TYPEOF(h.building_area2_indicator))'',0,100));
    maxlength_building_area2_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area2_indicator)));
    avelength_building_area2_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area2_indicator)),h.building_area2_indicator<>(typeof(h.building_area2_indicator))'');
    populated_building_area3_pcnt := AVE(GROUP,IF(h.building_area3 = (TYPEOF(h.building_area3))'',0,100));
    maxlength_building_area3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area3)));
    avelength_building_area3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area3)),h.building_area3<>(typeof(h.building_area3))'');
    populated_building_area3_indicator_pcnt := AVE(GROUP,IF(h.building_area3_indicator = (TYPEOF(h.building_area3_indicator))'',0,100));
    maxlength_building_area3_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area3_indicator)));
    avelength_building_area3_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area3_indicator)),h.building_area3_indicator<>(typeof(h.building_area3_indicator))'');
    populated_building_area4_pcnt := AVE(GROUP,IF(h.building_area4 = (TYPEOF(h.building_area4))'',0,100));
    maxlength_building_area4 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area4)));
    avelength_building_area4 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area4)),h.building_area4<>(typeof(h.building_area4))'');
    populated_building_area4_indicator_pcnt := AVE(GROUP,IF(h.building_area4_indicator = (TYPEOF(h.building_area4_indicator))'',0,100));
    maxlength_building_area4_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area4_indicator)));
    avelength_building_area4_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area4_indicator)),h.building_area4_indicator<>(typeof(h.building_area4_indicator))'');
    populated_building_area5_pcnt := AVE(GROUP,IF(h.building_area5 = (TYPEOF(h.building_area5))'',0,100));
    maxlength_building_area5 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area5)));
    avelength_building_area5 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area5)),h.building_area5<>(typeof(h.building_area5))'');
    populated_building_area5_indicator_pcnt := AVE(GROUP,IF(h.building_area5_indicator = (TYPEOF(h.building_area5_indicator))'',0,100));
    maxlength_building_area5_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area5_indicator)));
    avelength_building_area5_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area5_indicator)),h.building_area5_indicator<>(typeof(h.building_area5_indicator))'');
    populated_building_area6_pcnt := AVE(GROUP,IF(h.building_area6 = (TYPEOF(h.building_area6))'',0,100));
    maxlength_building_area6 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area6)));
    avelength_building_area6 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area6)),h.building_area6<>(typeof(h.building_area6))'');
    populated_building_area6_indicator_pcnt := AVE(GROUP,IF(h.building_area6_indicator = (TYPEOF(h.building_area6_indicator))'',0,100));
    maxlength_building_area6_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area6_indicator)));
    avelength_building_area6_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area6_indicator)),h.building_area6_indicator<>(typeof(h.building_area6_indicator))'');
    populated_building_area7_pcnt := AVE(GROUP,IF(h.building_area7 = (TYPEOF(h.building_area7))'',0,100));
    maxlength_building_area7 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area7)));
    avelength_building_area7 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area7)),h.building_area7<>(typeof(h.building_area7))'');
    populated_building_area7_indicator_pcnt := AVE(GROUP,IF(h.building_area7_indicator = (TYPEOF(h.building_area7_indicator))'',0,100));
    maxlength_building_area7_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area7_indicator)));
    avelength_building_area7_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_area7_indicator)),h.building_area7_indicator<>(typeof(h.building_area7_indicator))'');
    populated_year_built_pcnt := AVE(GROUP,IF(h.year_built = (TYPEOF(h.year_built))'',0,100));
    maxlength_year_built := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.year_built)));
    avelength_year_built := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.year_built)),h.year_built<>(typeof(h.year_built))'');
    populated_effective_year_built_pcnt := AVE(GROUP,IF(h.effective_year_built = (TYPEOF(h.effective_year_built))'',0,100));
    maxlength_effective_year_built := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.effective_year_built)));
    avelength_effective_year_built := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.effective_year_built)),h.effective_year_built<>(typeof(h.effective_year_built))'');
    populated_no_of_buildings_pcnt := AVE(GROUP,IF(h.no_of_buildings = (TYPEOF(h.no_of_buildings))'',0,100));
    maxlength_no_of_buildings := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_buildings)));
    avelength_no_of_buildings := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_buildings)),h.no_of_buildings<>(typeof(h.no_of_buildings))'');
    populated_no_of_stories_pcnt := AVE(GROUP,IF(h.no_of_stories = (TYPEOF(h.no_of_stories))'',0,100));
    maxlength_no_of_stories := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_stories)));
    avelength_no_of_stories := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_stories)),h.no_of_stories<>(typeof(h.no_of_stories))'');
    populated_no_of_units_pcnt := AVE(GROUP,IF(h.no_of_units = (TYPEOF(h.no_of_units))'',0,100));
    maxlength_no_of_units := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_units)));
    avelength_no_of_units := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_units)),h.no_of_units<>(typeof(h.no_of_units))'');
    populated_no_of_rooms_pcnt := AVE(GROUP,IF(h.no_of_rooms = (TYPEOF(h.no_of_rooms))'',0,100));
    maxlength_no_of_rooms := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_rooms)));
    avelength_no_of_rooms := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_rooms)),h.no_of_rooms<>(typeof(h.no_of_rooms))'');
    populated_no_of_bedrooms_pcnt := AVE(GROUP,IF(h.no_of_bedrooms = (TYPEOF(h.no_of_bedrooms))'',0,100));
    maxlength_no_of_bedrooms := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_bedrooms)));
    avelength_no_of_bedrooms := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_bedrooms)),h.no_of_bedrooms<>(typeof(h.no_of_bedrooms))'');
    populated_no_of_baths_pcnt := AVE(GROUP,IF(h.no_of_baths = (TYPEOF(h.no_of_baths))'',0,100));
    maxlength_no_of_baths := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_baths)));
    avelength_no_of_baths := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_baths)),h.no_of_baths<>(typeof(h.no_of_baths))'');
    populated_no_of_partial_baths_pcnt := AVE(GROUP,IF(h.no_of_partial_baths = (TYPEOF(h.no_of_partial_baths))'',0,100));
    maxlength_no_of_partial_baths := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_partial_baths)));
    avelength_no_of_partial_baths := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_partial_baths)),h.no_of_partial_baths<>(typeof(h.no_of_partial_baths))'');
    populated_no_of_plumbing_fixtures_pcnt := AVE(GROUP,IF(h.no_of_plumbing_fixtures = (TYPEOF(h.no_of_plumbing_fixtures))'',0,100));
    maxlength_no_of_plumbing_fixtures := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_plumbing_fixtures)));
    avelength_no_of_plumbing_fixtures := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.no_of_plumbing_fixtures)),h.no_of_plumbing_fixtures<>(typeof(h.no_of_plumbing_fixtures))'');
    populated_garage_type_code_pcnt := AVE(GROUP,IF(h.garage_type_code = (TYPEOF(h.garage_type_code))'',0,100));
    maxlength_garage_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.garage_type_code)));
    avelength_garage_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.garage_type_code)),h.garage_type_code<>(typeof(h.garage_type_code))'');
    populated_parking_no_of_cars_pcnt := AVE(GROUP,IF(h.parking_no_of_cars = (TYPEOF(h.parking_no_of_cars))'',0,100));
    maxlength_parking_no_of_cars := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.parking_no_of_cars)));
    avelength_parking_no_of_cars := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.parking_no_of_cars)),h.parking_no_of_cars<>(typeof(h.parking_no_of_cars))'');
    populated_pool_code_pcnt := AVE(GROUP,IF(h.pool_code = (TYPEOF(h.pool_code))'',0,100));
    maxlength_pool_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.pool_code)));
    avelength_pool_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.pool_code)),h.pool_code<>(typeof(h.pool_code))'');
    populated_style_code_pcnt := AVE(GROUP,IF(h.style_code = (TYPEOF(h.style_code))'',0,100));
    maxlength_style_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.style_code)));
    avelength_style_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.style_code)),h.style_code<>(typeof(h.style_code))'');
    populated_type_construction_code_pcnt := AVE(GROUP,IF(h.type_construction_code = (TYPEOF(h.type_construction_code))'',0,100));
    maxlength_type_construction_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.type_construction_code)));
    avelength_type_construction_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.type_construction_code)),h.type_construction_code<>(typeof(h.type_construction_code))'');
    populated_foundation_code_pcnt := AVE(GROUP,IF(h.foundation_code = (TYPEOF(h.foundation_code))'',0,100));
    maxlength_foundation_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.foundation_code)));
    avelength_foundation_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.foundation_code)),h.foundation_code<>(typeof(h.foundation_code))'');
    populated_building_quality_code_pcnt := AVE(GROUP,IF(h.building_quality_code = (TYPEOF(h.building_quality_code))'',0,100));
    maxlength_building_quality_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_quality_code)));
    avelength_building_quality_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_quality_code)),h.building_quality_code<>(typeof(h.building_quality_code))'');
    populated_building_condition_code_pcnt := AVE(GROUP,IF(h.building_condition_code = (TYPEOF(h.building_condition_code))'',0,100));
    maxlength_building_condition_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_condition_code)));
    avelength_building_condition_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_condition_code)),h.building_condition_code<>(typeof(h.building_condition_code))'');
    populated_exterior_walls_code_pcnt := AVE(GROUP,IF(h.exterior_walls_code = (TYPEOF(h.exterior_walls_code))'',0,100));
    maxlength_exterior_walls_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.exterior_walls_code)));
    avelength_exterior_walls_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.exterior_walls_code)),h.exterior_walls_code<>(typeof(h.exterior_walls_code))'');
    populated_interior_walls_code_pcnt := AVE(GROUP,IF(h.interior_walls_code = (TYPEOF(h.interior_walls_code))'',0,100));
    maxlength_interior_walls_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.interior_walls_code)));
    avelength_interior_walls_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.interior_walls_code)),h.interior_walls_code<>(typeof(h.interior_walls_code))'');
    populated_roof_cover_code_pcnt := AVE(GROUP,IF(h.roof_cover_code = (TYPEOF(h.roof_cover_code))'',0,100));
    maxlength_roof_cover_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.roof_cover_code)));
    avelength_roof_cover_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.roof_cover_code)),h.roof_cover_code<>(typeof(h.roof_cover_code))'');
    populated_roof_type_code_pcnt := AVE(GROUP,IF(h.roof_type_code = (TYPEOF(h.roof_type_code))'',0,100));
    maxlength_roof_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.roof_type_code)));
    avelength_roof_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.roof_type_code)),h.roof_type_code<>(typeof(h.roof_type_code))'');
    populated_floor_cover_code_pcnt := AVE(GROUP,IF(h.floor_cover_code = (TYPEOF(h.floor_cover_code))'',0,100));
    maxlength_floor_cover_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.floor_cover_code)));
    avelength_floor_cover_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.floor_cover_code)),h.floor_cover_code<>(typeof(h.floor_cover_code))'');
    populated_water_code_pcnt := AVE(GROUP,IF(h.water_code = (TYPEOF(h.water_code))'',0,100));
    maxlength_water_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.water_code)));
    avelength_water_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.water_code)),h.water_code<>(typeof(h.water_code))'');
    populated_sewer_code_pcnt := AVE(GROUP,IF(h.sewer_code = (TYPEOF(h.sewer_code))'',0,100));
    maxlength_sewer_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.sewer_code)));
    avelength_sewer_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.sewer_code)),h.sewer_code<>(typeof(h.sewer_code))'');
    populated_heating_code_pcnt := AVE(GROUP,IF(h.heating_code = (TYPEOF(h.heating_code))'',0,100));
    maxlength_heating_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.heating_code)));
    avelength_heating_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.heating_code)),h.heating_code<>(typeof(h.heating_code))'');
    populated_heating_fuel_type_code_pcnt := AVE(GROUP,IF(h.heating_fuel_type_code = (TYPEOF(h.heating_fuel_type_code))'',0,100));
    maxlength_heating_fuel_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.heating_fuel_type_code)));
    avelength_heating_fuel_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.heating_fuel_type_code)),h.heating_fuel_type_code<>(typeof(h.heating_fuel_type_code))'');
    populated_air_conditioning_code_pcnt := AVE(GROUP,IF(h.air_conditioning_code = (TYPEOF(h.air_conditioning_code))'',0,100));
    maxlength_air_conditioning_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.air_conditioning_code)));
    avelength_air_conditioning_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.air_conditioning_code)),h.air_conditioning_code<>(typeof(h.air_conditioning_code))'');
    ...
    maxlength_air_conditioning_type_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.air_conditioning_type_code)));
    avelength_air_conditioning_type_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.air_conditioning_type_code)),h.air_conditioning_type_code<>(typeof(h.air_conditioning_type_code))'');
    populated_elevator_pcnt := AVE(GROUP,IF(h.elevator = (TYPEOF(h.elevator))'',0,100));
    maxlength_elevator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.elevator)));
    avelength_elevator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.elevator)),h.elevator<>(typeof(h.elevator))'');
    populated_fireplace_indicator_pcnt := AVE(GROUP,IF(h.fireplace_indicator = (TYPEOF(h.fireplace_indicator))'',0,100));
    maxlength_fireplace_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fireplace_indicator)));
    avelength_fireplace_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fireplace_indicator)),h.fireplace_indicator<>(typeof(h.fireplace_indicator))'');
    populated_fireplace_number_pcnt := AVE(GROUP,IF(h.fireplace_number = (TYPEOF(h.fireplace_number))'',0,100));
    maxlength_fireplace_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fireplace_number)));
    avelength_fireplace_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fireplace_number)),h.fireplace_number<>(typeof(h.fireplace_number))'');
    populated_basement_code_pcnt := AVE(GROUP,IF(h.basement_code = (TYPEOF(h.basement_code))'',0,100));
    maxlength_basement_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.basement_code)));
    avelength_basement_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.basement_code)),h.basement_code<>(typeof(h.basement_code))'');
    populated_building_class_code_pcnt := AVE(GROUP,IF(h.building_class_code = (TYPEOF(h.building_class_code))'',0,100));
    maxlength_building_class_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_class_code)));
    avelength_building_class_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.building_class_code)),h.building_class_code<>(typeof(h.building_class_code))'');
    populated_site_influence1_code_pcnt := AVE(GROUP,IF(h.site_influence1_code = (TYPEOF(h.site_influence1_code))'',0,100));
    maxlength_site_influence1_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence1_code)));
    avelength_site_influence1_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence1_code)),h.site_influence1_code<>(typeof(h.site_influence1_code))'');
    populated_site_influence2_code_pcnt := AVE(GROUP,IF(h.site_influence2_code = (TYPEOF(h.site_influence2_code))'',0,100));
    maxlength_site_influence2_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence2_code)));
    avelength_site_influence2_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence2_code)),h.site_influence2_code<>(typeof(h.site_influence2_code))'');
    populated_site_influence3_code_pcnt := AVE(GROUP,IF(h.site_influence3_code = (TYPEOF(h.site_influence3_code))'',0,100));
    maxlength_site_influence3_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence3_code)));
    avelength_site_influence3_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence3_code)),h.site_influence3_code<>(typeof(h.site_influence3_code))'');
    populated_site_influence4_code_pcnt := AVE(GROUP,IF(h.site_influence4_code = (TYPEOF(h.site_influence4_code))'',0,100));
    maxlength_site_influence4_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence4_code)));
    avelength_site_influence4_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence4_code)),h.site_influence4_code<>(typeof(h.site_influence4_code))'');
    populated_site_influence5_code_pcnt := AVE(GROUP,IF(h.site_influence5_code = (TYPEOF(h.site_influence5_code))'',0,100));
    maxlength_site_influence5_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence5_code)));
    avelength_site_influence5_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.site_influence5_code)),h.site_influence5_code<>(typeof(h.site_influence5_code))'');
    populated_amenities1_code_pcnt := AVE(GROUP,IF(h.amenities1_code = (TYPEOF(h.amenities1_code))'',0,100));
    maxlength_amenities1_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities1_code)));
    avelength_amenities1_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities1_code)),h.amenities1_code<>(typeof(h.amenities1_code))'');
    populated_amenities2_code_pcnt := AVE(GROUP,IF(h.amenities2_code = (TYPEOF(h.amenities2_code))'',0,100));
    maxlength_amenities2_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code)));
    avelength_amenities2_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code)),h.amenities2_code<>(typeof(h.amenities2_code))'');
    populated_amenities3_code_pcnt := AVE(GROUP,IF(h.amenities3_code = (TYPEOF(h.amenities3_code))'',0,100));
    maxlength_amenities3_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities3_code)));
    avelength_amenities3_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities3_code)),h.amenities3_code<>(typeof(h.amenities3_code))'');
    populated_amenities4_code_pcnt := AVE(GROUP,IF(h.amenities4_code = (TYPEOF(h.amenities4_code))'',0,100));
    maxlength_amenities4_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities4_code)));
    avelength_amenities4_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities4_code)),h.amenities4_code<>(typeof(h.amenities4_code))'');
    populated_amenities5_code_pcnt := AVE(GROUP,IF(h.amenities5_code = (TYPEOF(h.amenities5_code))'',0,100));
    maxlength_amenities5_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities5_code)));
    avelength_amenities5_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities5_code)),h.amenities5_code<>(typeof(h.amenities5_code))'');
    populated_amenities2_code1_pcnt := AVE(GROUP,IF(h.amenities2_code1 = (TYPEOF(h.amenities2_code1))'',0,100));
    maxlength_amenities2_code1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code1)));
    avelength_amenities2_code1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code1)),h.amenities2_code1<>(typeof(h.amenities2_code1))'');
    populated_amenities2_code2_pcnt := AVE(GROUP,IF(h.amenities2_code2 = (TYPEOF(h.amenities2_code2))'',0,100));
    maxlength_amenities2_code2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code2)));
    avelength_amenities2_code2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code2)),h.amenities2_code2<>(typeof(h.amenities2_code2))'');
    populated_amenities2_code3_pcnt := AVE(GROUP,IF(h.amenities2_code3 = (TYPEOF(h.amenities2_code3))'',0,100));
    maxlength_amenities2_code3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code3)));
    avelength_amenities2_code3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code3)),h.amenities2_code3<>(typeof(h.amenities2_code3))'');
    populated_amenities2_code4_pcnt := AVE(GROUP,IF(h.amenities2_code4 = (TYPEOF(h.amenities2_code4))'',0,100));
    maxlength_amenities2_code4 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code4)));
    avelength_amenities2_code4 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code4)),h.amenities2_code4<>(typeof(h.amenities2_code4))'');
    populated_amenities2_code5_pcnt := AVE(GROUP,IF(h.amenities2_code5 = (TYPEOF(h.amenities2_code5))'',0,100));
    maxlength_amenities2_code5 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code5)));
    avelength_amenities2_code5 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.amenities2_code5)),h.amenities2_code5<>(typeof(h.amenities2_code5))'');
    populated_extra_features1_area_pcnt := AVE(GROUP,IF(h.extra_features1_area = (TYPEOF(h.extra_features1_area))'',0,100));
    maxlength_extra_features1_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features1_area)));
    avelength_extra_features1_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features1_area)),h.extra_features1_area<>(typeof(h.extra_features1_area))'');
    ...
    maxlength_extra_features1_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features1_indicator)));
    avelength_extra_features1_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features1_indicator)),h.extra_features1_indicator<>(typeof(h.extra_features1_indicator))'');
    populated_extra_features2_area_pcnt := AVE(GROUP,IF(h.extra_features2_area = (TYPEOF(h.extra_features2_area))'',0,100));
    maxlength_extra_features2_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features2_area)));
    avelength_extra_features2_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features2_area)),h.extra_features2_area<>(typeof(h.extra_features2_area))'');
    ...
    maxlength_extra_features2_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features2_indicator)));
    avelength_extra_features2_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features2_indicator)),h.extra_features2_indicator<>(typeof(h.extra_features2_indicator))'');
    populated_extra_features3_area_pcnt := AVE(GROUP,IF(h.extra_features3_area = (TYPEOF(h.extra_features3_area))'',0,100));
    maxlength_extra_features3_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features3_area)));
    avelength_extra_features3_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features3_area)),h.extra_features3_area<>(typeof(h.extra_features3_area))'');
    ...
    maxlength_extra_features3_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features3_indicator)));
    avelength_extra_features3_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features3_indicator)),h.extra_features3_indicator<>(typeof(h.extra_features3_indicator))'');
    populated_extra_features4_area_pcnt := AVE(GROUP,IF(h.extra_features4_area = (TYPEOF(h.extra_features4_area))'',0,100));
    maxlength_extra_features4_area := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features4_area)));
    avelength_extra_features4_area := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features4_area)),h.extra_features4_area<>(typeof(h.extra_features4_area))'');
    ...
    maxlength_extra_features4_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features4_indicator)));
    avelength_extra_features4_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.extra_features4_indicator)),h.extra_features4_indicator<>(typeof(h.extra_features4_indicator))'');
    populated_other_buildings1_code_pcnt := AVE(GROUP,IF(h.other_buildings1_code = (TYPEOF(h.other_buildings1_code))'',0,100));
    maxlength_other_buildings1_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings1_code)));
    avelength_other_buildings1_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings1_code)),h.other_buildings1_code<>(typeof(h.other_buildings1_code))'');
    populated_other_buildings2_code_pcnt := AVE(GROUP,IF(h.other_buildings2_code = (TYPEOF(h.other_buildings2_code))'',0,100));
    maxlength_other_buildings2_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings2_code)));
    avelength_other_buildings2_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings2_code)),h.other_buildings2_code<>(typeof(h.other_buildings2_code))'');
    populated_other_buildings3_code_pcnt := AVE(GROUP,IF(h.other_buildings3_code = (TYPEOF(h.other_buildings3_code))'',0,100));
    maxlength_other_buildings3_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings3_code)));
    avelength_other_buildings3_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings3_code)),h.other_buildings3_code<>(typeof(h.other_buildings3_code))'');
    populated_other_buildings4_code_pcnt := AVE(GROUP,IF(h.other_buildings4_code = (TYPEOF(h.other_buildings4_code))'',0,100));
    maxlength_other_buildings4_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings4_code)));
    avelength_other_buildings4_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings4_code)),h.other_buildings4_code<>(typeof(h.other_buildings4_code))'');
    populated_other_buildings5_code_pcnt := AVE(GROUP,IF(h.other_buildings5_code = (TYPEOF(h.other_buildings5_code))'',0,100));
    maxlength_other_buildings5_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings5_code)));
    avelength_other_buildings5_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_buildings5_code)),h.other_buildings5_code<>(typeof(h.other_buildings5_code))'');
    ...
    maxlength_other_impr_building1_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building1_indicator)));
    avelength_other_impr_building1_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building1_indicator)),h.other_impr_building1_indicator<>(typeof(h.other_impr_building1_indicator))'');
    ...
    maxlength_other_impr_building2_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building2_indicator)));
    avelength_other_impr_building2_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building2_indicator)),h.other_impr_building2_indicator<>(typeof(h.other_impr_building2_indicator))'');
    ...
    maxlength_other_impr_building3_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building3_indicator)));
    avelength_other_impr_building3_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building3_indicator)),h.other_impr_building3_indicator<>(typeof(h.other_impr_building3_indicator))'');
    ...
    maxlength_other_impr_building4_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building4_indicator)));
    avelength_other_impr_building4_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building4_indicator)),h.other_impr_building4_indicator<>(typeof(h.other_impr_building4_indicator))'');
    ...
    maxlength_other_impr_building5_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building5_indicator)));
    avelength_other_impr_building5_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building5_indicator)),h.other_impr_building5_indicator<>(typeof(h.other_impr_building5_indicator))'');
    ...
    maxlength_other_impr_building_area1 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area1)));
    avelength_other_impr_building_area1 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area1)),h.other_impr_building_area1<>(typeof(h.other_impr_building_area1))'');
    ...
    maxlength_other_impr_building_area2 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area2)));
    avelength_other_impr_building_area2 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area2)),h.other_impr_building_area2<>(typeof(h.other_impr_building_area2))'');
    ...
    maxlength_other_impr_building_area3 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area3)));
    avelength_other_impr_building_area3 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area3)),h.other_impr_building_area3<>(typeof(h.other_impr_building_area3))'');
    ...
    maxlength_other_impr_building_area4 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area4)));
    avelength_other_impr_building_area4 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area4)),h.other_impr_building_area4<>(typeof(h.other_impr_building_area4))'');
    ...
    maxlength_other_impr_building_area5 := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area5)));
    avelength_other_impr_building_area5 := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_impr_building_area5)),h.other_impr_building_area5<>(typeof(h.other_impr_building_area5))'');
    populated_topograpy_code_pcnt := AVE(GROUP,IF(h.topograpy_code = (TYPEOF(h.topograpy_code))'',0,100));
    maxlength_topograpy_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.topograpy_code)));
    avelength_topograpy_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.topograpy_code)),h.topograpy_code<>(typeof(h.topograpy_code))'');
    populated_neighborhood_code_pcnt := AVE(GROUP,IF(h.neighborhood_code = (TYPEOF(h.neighborhood_code))'',0,100));
    maxlength_neighborhood_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.neighborhood_code)));
    avelength_neighborhood_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.neighborhood_code)),h.neighborhood_code<>(typeof(h.neighborhood_code))'');
    ...
    maxlength_condo_project_or_building_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.condo_project_or_building_name)));
    avelength_condo_project_or_building_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.condo_project_or_building_name)),h.condo_project_or_building_name<>(typeof(h.condo_project_or_building_name))'');
    populated_assessee_name_indicator_pcnt := AVE(GROUP,IF(h.assessee_name_indicator = (TYPEOF(h.assessee_name_indicator))'',0,100));
    maxlength_assessee_name_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name_indicator)));
    avelength_assessee_name_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.assessee_name_indicator)),h.assessee_name_indicator<>(typeof(h.assessee_name_indicator))'');
    ...
    maxlength_second_assessee_name_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name_indicator)));
    avelength_second_assessee_name_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.second_assessee_name_indicator)),h.second_assessee_name_indicator<>(typeof(h.second_assessee_name_indicator))'');
    populated_other_rooms_indicator_pcnt := AVE(GROUP,IF(h.other_rooms_indicator = (TYPEOF(h.other_rooms_indicator))'',0,100));
    maxlength_other_rooms_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_rooms_indicator)));
    avelength_other_rooms_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.other_rooms_indicator)),h.other_rooms_indicator<>(typeof(h.other_rooms_indicator))'');
    ...
    maxlength_mail_care_of_name_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.mail_care_of_name_indicator)));
    avelength_mail_care_of_name_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.mail_care_of_name_indicator)),h.mail_care_of_name_indicator<>(typeof(h.mail_care_of_name_indicator))'');
    populated_comments_pcnt := AVE(GROUP,IF(h.comments = (TYPEOF(h.comments))'',0,100));
    maxlength_comments := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.comments)));
    avelength_comments := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.comments)),h.comments<>(typeof(h.comments))'');
    populated_tape_cut_date_pcnt := AVE(GROUP,IF(h.tape_cut_date = (TYPEOF(h.tape_cut_date))'',0,100));
    maxlength_tape_cut_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.tape_cut_date)));
    avelength_tape_cut_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.tape_cut_date)),h.tape_cut_date<>(typeof(h.tape_cut_date))'');
    populated_certification_date_pcnt := AVE(GROUP,IF(h.certification_date = (TYPEOF(h.certification_date))'',0,100));
    maxlength_certification_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.certification_date)));
    avelength_certification_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.certification_date)),h.certification_date<>(typeof(h.certification_date))'');
    populated_edition_number_pcnt := AVE(GROUP,IF(h.edition_number = (TYPEOF(h.edition_number))'',0,100));
    maxlength_edition_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.edition_number)));
    avelength_edition_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.edition_number)),h.edition_number<>(typeof(h.edition_number))'');
    populated_prop_addr_propagated_ind_pcnt := AVE(GROUP,IF(h.prop_addr_propagated_ind = (TYPEOF(h.prop_addr_propagated_ind))'',0,100));
    maxlength_prop_addr_propagated_ind := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.prop_addr_propagated_ind)));
    avelength_prop_addr_propagated_ind := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.prop_addr_propagated_ind)),h.prop_addr_propagated_ind<>(typeof(h.prop_addr_propagated_ind))'');
    populated_ln_ownership_rights_pcnt := AVE(GROUP,IF(h.ln_ownership_rights = (TYPEOF(h.ln_ownership_rights))'',0,100));
    maxlength_ln_ownership_rights := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_ownership_rights)));
    avelength_ln_ownership_rights := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_ownership_rights)),h.ln_ownership_rights<>(typeof(h.ln_ownership_rights))'');
    populated_ln_relationship_type_pcnt := AVE(GROUP,IF(h.ln_relationship_type = (TYPEOF(h.ln_relationship_type))'',0,100));
    maxlength_ln_relationship_type := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_relationship_type)));
    avelength_ln_relationship_type := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_relationship_type)),h.ln_relationship_type<>(typeof(h.ln_relationship_type))'');
    populated_ln_mailing_country_code_pcnt := AVE(GROUP,IF(h.ln_mailing_country_code = (TYPEOF(h.ln_mailing_country_code))'',0,100));
    maxlength_ln_mailing_country_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_mailing_country_code)));
    avelength_ln_mailing_country_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_mailing_country_code)),h.ln_mailing_country_code<>(typeof(h.ln_mailing_country_code))'');
    populated_ln_property_name_pcnt := AVE(GROUP,IF(h.ln_property_name = (TYPEOF(h.ln_property_name))'',0,100));
    maxlength_ln_property_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_name)));
    avelength_ln_property_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_name)),h.ln_property_name<>(typeof(h.ln_property_name))'');
    populated_ln_property_name_type_pcnt := AVE(GROUP,IF(h.ln_property_name_type = (TYPEOF(h.ln_property_name_type))'',0,100));
    maxlength_ln_property_name_type := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_name_type)));
    avelength_ln_property_name_type := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_name_type)),h.ln_property_name_type<>(typeof(h.ln_property_name_type))'');
    populated_ln_land_use_category_pcnt := AVE(GROUP,IF(h.ln_land_use_category = (TYPEOF(h.ln_land_use_category))'',0,100));
    maxlength_ln_land_use_category := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_land_use_category)));
    avelength_ln_land_use_category := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_land_use_category)),h.ln_land_use_category<>(typeof(h.ln_land_use_category))'');
    populated_ln_lot_pcnt := AVE(GROUP,IF(h.ln_lot = (TYPEOF(h.ln_lot))'',0,100));
    maxlength_ln_lot := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_lot)));
    avelength_ln_lot := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_lot)),h.ln_lot<>(typeof(h.ln_lot))'');
    populated_ln_block_pcnt := AVE(GROUP,IF(h.ln_block = (TYPEOF(h.ln_block))'',0,100));
    maxlength_ln_block := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_block)));
    avelength_ln_block := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_block)),h.ln_block<>(typeof(h.ln_block))'');
    populated_ln_unit_pcnt := AVE(GROUP,IF(h.ln_unit = (TYPEOF(h.ln_unit))'',0,100));
    maxlength_ln_unit := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_unit)));
    avelength_ln_unit := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_unit)),h.ln_unit<>(typeof(h.ln_unit))'');
    populated_ln_subfloor_pcnt := AVE(GROUP,IF(h.ln_subfloor = (TYPEOF(h.ln_subfloor))'',0,100));
    maxlength_ln_subfloor := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_subfloor)));
    avelength_ln_subfloor := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_subfloor)),h.ln_subfloor<>(typeof(h.ln_subfloor))'');
    populated_ln_floor_cover_pcnt := AVE(GROUP,IF(h.ln_floor_cover = (TYPEOF(h.ln_floor_cover))'',0,100));
    maxlength_ln_floor_cover := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_floor_cover)));
    avelength_ln_floor_cover := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_floor_cover)),h.ln_floor_cover<>(typeof(h.ln_floor_cover))'');
    populated_ln_mobile_home_indicator_pcnt := AVE(GROUP,IF(h.ln_mobile_home_indicator = (TYPEOF(h.ln_mobile_home_indicator))'',0,100));
    maxlength_ln_mobile_home_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_mobile_home_indicator)));
    avelength_ln_mobile_home_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_mobile_home_indicator)),h.ln_mobile_home_indicator<>(typeof(h.ln_mobile_home_indicator))'');
    populated_ln_condo_indicator_pcnt := AVE(GROUP,IF(h.ln_condo_indicator = (TYPEOF(h.ln_condo_indicator))'',0,100));
    maxlength_ln_condo_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_condo_indicator)));
    avelength_ln_condo_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_condo_indicator)),h.ln_condo_indicator<>(typeof(h.ln_condo_indicator))'');
    ...
    maxlength_ln_property_tax_exemption := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_tax_exemption)));
    avelength_ln_property_tax_exemption := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_property_tax_exemption)),h.ln_property_tax_exemption<>(typeof(h.ln_property_tax_exemption))'');
    populated_ln_veteran_status_pcnt := AVE(GROUP,IF(h.ln_veteran_status = (TYPEOF(h.ln_veteran_status))'',0,100));
    maxlength_ln_veteran_status := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_veteran_status)));
    avelength_ln_veteran_status := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_veteran_status)),h.ln_veteran_status<>(typeof(h.ln_veteran_status))'');
    populated_ln_old_apn_indicator_pcnt := AVE(GROUP,IF(h.ln_old_apn_indicator = (TYPEOF(h.ln_old_apn_indicator))'',0,100));
    maxlength_ln_old_apn_indicator := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_old_apn_indicator)));
    avelength_ln_old_apn_indicator := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ln_old_apn_indicator)),h.ln_old_apn_indicator<>(typeof(h.ln_old_apn_indicator))'');
    populated_fips_pcnt := AVE(GROUP,IF(h.fips = (TYPEOF(h.fips))'',0,100));
    maxlength_fips := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fips)));
    avelength_fips := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fips)),h.fips<>(typeof(h.fips))'');
  END;
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state_code),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.old_apn),TRIM((SALT33.StrType)le.apna_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.duplicate_apn_multiple_address_id),TRIM((SALT33.StrType)le.assessee_name),TRIM((SALT33.StrType)le.second_assessee_name),TRIM((SALT33.StrType)le.assessee_ownership_rights_code),TRIM((SALT33.StrType)le.assessee_relationship_code),TRIM((SALT33.StrType)le.assessee_phone_number),TRIM((SALT33.StrType)le.tax_account_number),TRIM((SALT33.StrType)le.contract_owner),TRIM((SALT33.StrType)le.assessee_name_type_code),TRIM((SALT33.StrType)le.second_assessee_name_type_code),TRIM((SALT33.StrType)le.mail_care_of_name_type_code),TRIM((SALT33.StrType)le.mailing_care_of_name),TRIM((SALT33.StrType)le.mailing_full_street_address),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_city_state_zip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_unit_number),TRIM((SALT33.StrType)le.property_city_state_zip),TRIM((SALT33.StrType)le.property_country_code),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.legal_assessor_map_ref),TRIM((SALT33.StrType)le.census_tract),TRIM((SALT33.StrType)le.record_type_code),TRIM((SALT33.StrType)le.ownership_type_code),TRIM((SALT33.StrType)le.new_record_type_code),TRIM((SALT33.StrType)le.state_land_use_code),TRIM((SALT33.StrType)le.county_land_use_code),TRIM((SALT33.StrType)le.county_land_use_description),TRIM((SALT33.StrType)le.standardized_land_use_code),TRIM((SALT33.StrType)le.timeshare_code),TRIM((SALT33.StrType)le.zoning),TRIM((SALT33.StrType)le.owner_occupied),TRIM((SALT33.StrType)le.recorder_document_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.transfer_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.sale_date),TRIM((SALT33.StrType)le.document_type),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.mortgage_loan_amount),TRIM((SALT33.StrType)le.mortgage_loan_type_code),TRIM((SALT33.StrType)le.mortgage_lender_name),TRIM((SALT33.StrType)le.mortgage_lender_type_code),TRIM((SALT33.StrType)le.prior_transfer_date),TRIM((SALT33.StrType)le.prior_recording_date),TRIM((SALT33.StrType)le.prior_sales_price),TRIM((SALT33.StrType)le.prior_sales_price_code),TRIM((SALT33.StrType)le.assessed_land_value),TRIM((SALT33.StrType)le.assessed_improvement_value),TRIM((SALT33.StrType)le.assessed_total_value),TRIM((SALT33.StrType)le.assessed_value_year),TRIM((SALT33.StrType)le.market_land_value),TRIM((SALT33.StrType)le.market_improvement_value),TRIM((SALT33.StrType)le.market_total_value),TRIM((SALT33.StrType)le.market_value_year),TRIM((SALT33.StrType)le.homestead_homeowner_exemption),TRIM((SALT33.StrType)le.tax_exemption1_code),TRIM((SALT33.StrType)le.tax_exemption2_code),TRIM((SALT33.StrType)le.tax_exemption3_code),TRIM((SALT33.StrType)le.tax_exemption4_code),TRIM((SALT33.StrType)le.tax_rate_code_area),TRIM((SALT33.StrType)le.tax_amount),TRIM((SALT33.StrType)le.tax_year),TRIM((SALT33.StrType)le.tax_delinquent_year),TRIM((SALT33.StrType)le.school_tax_district1),TRIM((SALT33.StrType)le.school_tax_district1_indicator),TRIM((SALT33.StrType)le.school_tax_district2),TRIM((SALT33.StrType)le.school_tax_district2_indicator),TRIM((SALT33.StrType)le.school_tax_district3),TRIM((SALT33.StrType)le.school_tax_district3_indicator),TRIM((SALT33.StrType)le.lot_size),TRIM((SALT33.StrType)le.lot_size_acres),TRIM((SALT33.StrType)le.lot_size_frontage_feet),TRIM((SALT33.StrType)le.lot_size_depth_feet),TRIM((SALT33.StrType)le.land_acres),TRIM((SALT33.StrType)le.land_square_footage),TRIM((SALT33.StrType)le.land_dimensions),TRIM((SALT33.StrType)le.building_area),TRIM((SALT33.StrType)le.building_area_indicator),TRIM((SALT33.StrType)le.building_area1),TRIM((SALT33.StrType)le.building_area1_indicator),TRIM((SALT33.StrType)le.building_area2),TRIM((SALT33.StrType)le.building_area2_indicator),TRIM((SALT33.StrType)le.building_area3),TRIM((SALT33.StrType)le.building_area3_indicator),TRIM((SALT33.StrType)le.building_area4),TRIM((SALT33.StrType)le.building_area4_indicator),TRIM((SALT33.StrType)le.building_area5),TRIM((SALT33.StrType)le.building_area5_indicator),TRIM((SALT33.StrType)le.building_area6),TRIM((SALT33.StrType)le.building_area6_indicator),TRIM((SALT33.StrType)le.building_area7),TRIM((SALT33.StrType)le.building_area7_indicator),TRIM((SALT33.StrType)le.year_built),TRIM((SALT33.StrType)le.effective_year_built),TRIM((SALT33.StrType)le.no_of_buildings),TRIM((SALT33.StrType)le.no_of_stories),TRIM((SALT33.StrType)le.no_of_units),TRIM((SALT33.StrType)le.no_of_rooms),TRIM((SALT33.StrType)le.no_of_bedrooms),TRIM((SALT33.StrType)le.no_of_baths),TRIM((SALT33.StrType)le.no_of_partial_baths),TRIM((SALT33.StrType)le.no_of_plumbing_fixtures),TRIM((SALT33.StrType)le.garage_type_code),TRIM((SALT33.StrType)le.parking_no_of_cars),TRIM((SALT33.StrType)le.pool_code),TRIM((SALT33.StrType)le.style_code),TRIM((SALT33.StrType)le.type_construction_code),TRIM((SALT33.StrType)le.foundation_code),TRIM((SALT33.StrType)le.building_quality_code),TRIM((SALT33.StrType)le.building_condition_code),TRIM((SALT33.StrType)le.exterior_walls_code),TRIM((SALT33.StrType)le.interior_walls_code),TRIM((SALT33.StrType)le.roof_cover_code),TRIM((SALT33.StrType)le.roof_type_code),TRIM((SALT33.StrType)le.floor_cover_code),TRIM((SALT33.StrType)le.water_code),TRIM((SALT33.StrType)le.sewer_code),TRIM((SALT33.StrType)le.heating_code),TRIM((SALT33.StrType)le.heating_fuel_type_code),TRIM((SALT33.StrType)le.air_conditioning_code),TRIM((SALT33.StrType)le.air_conditioning_type_code),TRIM((SALT33.StrType)le.elevator),TRIM((SALT33.StrType)le.fireplace_indicator),TRIM((SALT33.StrType)le.fireplace_number),TRIM((SALT33.StrType)le.basement_code),TRIM((SALT33.StrType)le.building_class_code),TRIM((SALT33.StrType)le.site_influence1_code),TRIM((SALT33.StrType)le.site_influence2_code),TRIM((SALT33.StrType)le.site_influence3_code),TRIM((SALT33.StrType)le.site_influence4_code),TRIM((SALT33.StrType)le.site_influence5_code),TRIM((SALT33.StrType)le.amenities1_code),TRIM((SALT33.StrType)le.amenities2_code),TRIM((SALT33.StrType)le.amenities3_code),TRIM((SALT33.StrType)le.amenities4_code),TRIM((SALT33.StrType)le.amenities5_code),TRIM((SALT33.StrType)le.amenities2_code1),TRIM((SALT33.StrType)le.amenities2_code2),TRIM((SALT33.StrType)le.amenities2_code3),TRIM((SALT33.StrType)le.amenities2_code4),TRIM((SALT33.StrType)le.amenities2_code5),TRIM((SALT33.StrType)le.extra_features1_area),TRIM((SALT33.StrType)le.extra_features1_indicator),TRIM((SALT33.StrType)le.extra_features2_area),TRIM((SALT33.StrType)le.extra_features2_indicator),TRIM((SALT33.StrType)le.extra_features3_area),TRIM((SALT33.StrType)le.extra_features3_indicator),TRIM((SALT33.StrType)le.extra_features4_area),TRIM((SALT33.StrType)le.extra_features4_indicator),TRIM((SALT33.StrType)le.other_buildings1_code),TRIM((SALT33.StrType)le.other_buildings2_code),TRIM((SALT33.StrType)le.other_buildings3_code),TRIM((SALT33.StrType)le.other_buildings4_code),TRIM((SALT33.StrType)le.other_buildings5_code),TRIM((SALT33.StrType)le.other_impr_building1_indicator),TRIM((SALT33.StrType)le.other_impr_building2_indicator),TRIM((SALT33.StrType)le.other_impr_building3_indicator),TRIM((SALT33.StrType)le.other_impr_building4_indicator),TRIM((SALT33.StrType)le.other_impr_building5_indicator),TRIM((SALT33.StrType)le.other_impr_building_area1),TRIM((SALT33.StrType)le.other_impr_building_area2),TRIM((SALT33.StrType)le.other_impr_building_area3),TRIM((SALT33.StrType)le.other_impr_building_area4),TRIM((SALT33.StrType)le.other_impr_building_area5),TRIM((SALT33.StrType)le.topograpy_code),TRIM((SALT33.StrType)le.neighborhood_code),TRIM((SALT33.StrType)le.condo_project_or_building_name),TRIM((SALT33.StrType)le.assessee_name_indicator),TRIM((SALT33.StrType)le.second_assessee_name_indicator),TRIM((SALT33.StrType)le.other_rooms_indicator),TRIM((SALT33.StrType)le.mail_care_of_name_indicator),TRIM((SALT33.StrType)le.comments),TRIM((SALT33.StrType)le.tape_cut_date),TRIM((SALT33.StrType)le.certification_date),TRIM((SALT33.StrType)le.edition_number),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_mailing_country_code),TRIM((SALT33.StrType)le.ln_property_name),TRIM((SALT33.StrType)le.ln_property_name_type),TRIM((SALT33.StrType)le.ln_land_use_category),TRIM((SALT33.StrType)le.ln_lot),TRIM((SALT33.StrType)le.ln_block),TRIM((SALT33.StrType)le.ln_unit),TRIM((SALT33.StrType)le.ln_subfloor),TRIM((SALT33.StrType)le.ln_floor_cover),TRIM((SALT33.StrType)le.ln_mobile_home_indicator),TRIM((SALT33.StrType)le.ln_condo_indicator),TRIM((SALT33.StrType)le.ln_property_tax_exemption),TRIM((SALT33.StrType)le.ln_veteran_status),TRIM((SALT33.StrType)le.ln_old_apn_indicator),TRIM((SALT33.StrType)le.fips)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 219);
  SELF.FldNo2 := 1 + (C % 219);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state_code),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.old_apn),TRIM((SALT33.StrType)le.apna_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.duplicate_apn_multiple_address_id),TRIM((SALT33.StrType)le.assessee_name),TRIM((SALT33.StrType)le.second_assessee_name),TRIM((SALT33.StrType)le.assessee_ownership_rights_code),TRIM((SALT33.StrType)le.assessee_relationship_code),TRIM((SALT33.StrType)le.assessee_phone_number),TRIM((SALT33.StrType)le.tax_account_number),TRIM((SALT33.StrType)le.contract_owner),TRIM((SALT33.StrType)le.assessee_name_type_code),TRIM((SALT33.StrType)le.second_assessee_name_type_code),TRIM((SALT33.StrType)le.mail_care_of_name_type_code),TRIM((SALT33.StrType)le.mailing_care_of_name),TRIM((SALT33.StrType)le.mailing_full_street_address),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_city_state_zip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_unit_number),TRIM((SALT33.StrType)le.property_city_state_zip),TRIM((SALT33.StrType)le.property_country_code),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.legal_assessor_map_ref),TRIM((SALT33.StrType)le.census_tract),TRIM((SALT33.StrType)le.record_type_code),TRIM((SALT33.StrType)le.ownership_type_code),TRIM((SALT33.StrType)le.new_record_type_code),TRIM((SALT33.StrType)le.state_land_use_code),TRIM((SALT33.StrType)le.county_land_use_code),TRIM((SALT33.StrType)le.county_land_use_description),TRIM((SALT33.StrType)le.standardized_land_use_code),TRIM((SALT33.StrType)le.timeshare_code),TRIM((SALT33.StrType)le.zoning),TRIM((SALT33.StrType)le.owner_occupied),TRIM((SALT33.StrType)le.recorder_document_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.transfer_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.sale_date),TRIM((SALT33.StrType)le.document_type),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.mortgage_loan_amount),TRIM((SALT33.StrType)le.mortgage_loan_type_code),TRIM((SALT33.StrType)le.mortgage_lender_name),TRIM((SALT33.StrType)le.mortgage_lender_type_code),TRIM((SALT33.StrType)le.prior_transfer_date),TRIM((SALT33.StrType)le.prior_recording_date),TRIM((SALT33.StrType)le.prior_sales_price),TRIM((SALT33.StrType)le.prior_sales_price_code),TRIM((SALT33.StrType)le.assessed_land_value),TRIM((SALT33.StrType)le.assessed_improvement_value),TRIM((SALT33.StrType)le.assessed_total_value),TRIM((SALT33.StrType)le.assessed_value_year),TRIM((SALT33.StrType)le.market_land_value),TRIM((SALT33.StrType)le.market_improvement_value),TRIM((SALT33.StrType)le.market_total_value),TRIM((SALT33.StrType)le.market_value_year),TRIM((SALT33.StrType)le.homestead_homeowner_exemption),TRIM((SALT33.StrType)le.tax_exemption1_code),TRIM((SALT33.StrType)le.tax_exemption2_code),TRIM((SALT33.StrType)le.tax_exemption3_code),TRIM((SALT33.StrType)le.tax_exemption4_code),TRIM((SALT33.StrType)le.tax_rate_code_area),TRIM((SALT33.StrType)le.tax_amount),TRIM((SALT33.StrType)le.tax_year),TRIM((SALT33.StrType)le.tax_delinquent_year),TRIM((SALT33.StrType)le.school_tax_district1),TRIM((SALT33.StrType)le.school_tax_district1_indicator),TRIM((SALT33.StrType)le.school_tax_district2),TRIM((SALT33.StrType)le.school_tax_district2_indicator),TRIM((SALT33.StrType)le.school_tax_district3),TRIM((SALT33.StrType)le.school_tax_district3_indicator),TRIM((SALT33.StrType)le.lot_size),TRIM((SALT33.StrType)le.lot_size_acres),TRIM((SALT33.StrType)le.lot_size_frontage_feet),TRIM((SALT33.StrType)le.lot_size_depth_feet),TRIM((SALT33.StrType)le.land_acres),TRIM((SALT33.StrType)le.land_square_footage),TRIM((SALT33.StrType)le.land_dimensions),TRIM((SALT33.StrType)le.building_area),TRIM((SALT33.StrType)le.building_area_indicator),TRIM((SALT33.StrType)le.building_area1),TRIM((SALT33.StrType)le.building_area1_indicator),TRIM((SALT33.StrType)le.building_area2),TRIM((SALT33.StrType)le.building_area2_indicator),TRIM((SALT33.StrType)le.building_area3),TRIM((SALT33.StrType)le.building_area3_indicator),TRIM((SALT33.StrType)le.building_area4),TRIM((SALT33.StrType)le.building_area4_indicator),TRIM((SALT33.StrType)le.building_area5),TRIM((SALT33.StrType)le.building_area5_indicator),TRIM((SALT33.StrType)le.building_area6),TRIM((SALT33.StrType)le.building_area6_indicator),TRIM((SALT33.StrType)le.building_area7),TRIM((SALT33.StrType)le.building_area7_indicator),TRIM((SALT33.StrType)le.year_built),TRIM((SALT33.StrType)le.effective_year_built),TRIM((SALT33.StrType)le.no_of_buildings),TRIM((SALT33.StrType)le.no_of_stories),TRIM((SALT33.StrType)le.no_of_units),TRIM((SALT33.StrType)le.no_of_rooms),TRIM((SALT33.StrType)le.no_of_bedrooms),TRIM((SALT33.StrType)le.no_of_baths),TRIM((SALT33.StrType)le.no_of_partial_baths),TRIM((SALT33.StrType)le.no_of_plumbing_fixtures),TRIM((SALT33.StrType)le.garage_type_code),TRIM((SALT33.StrType)le.parking_no_of_cars),TRIM((SALT33.StrType)le.pool_code),TRIM((SALT33.StrType)le.style_code),TRIM((SALT33.StrType)le.type_construction_code),TRIM((SALT33.StrType)le.foundation_code),TRIM((SALT33.StrType)le.building_quality_code),TRIM((SALT33.StrType)le.building_condition_code),TRIM((SALT33.StrType)le.exterior_walls_code),TRIM((SALT33.StrType)le.interior_walls_code),TRIM((SALT33.StrType)le.roof_cover_code),TRIM((SALT33.StrType)le.roof_type_code),TRIM((SALT33.StrType)le.floor_cover_code),TRIM((SALT33.StrType)le.water_code),TRIM((SALT33.StrType)le.sewer_code),TRIM((SALT33.StrType)le.heating_code),TRIM((SALT33.StrType)le.heating_fuel_type_code),TRIM((SALT33.StrType)le.air_conditioning_code),TRIM((SALT33.StrType)le.air_conditioning_type_code),TRIM((SALT33.StrType)le.elevator),TRIM((SALT33.StrType)le.fireplace_indicator),TRIM((SALT33.StrType)le.fireplace_number),TRIM((SALT33.StrType)le.basement_code),TRIM((SALT33.StrType)le.building_class_code),TRIM((SALT33.StrType)le.site_influence1_code),TRIM((SALT33.StrType)le.site_influence2_code),TRIM((SALT33.StrType)le.site_influence3_code),TRIM((SALT33.StrType)le.site_influence4_code),TRIM((SALT33.StrType)le.site_influence5_code),TRIM((SALT33.StrType)le.amenities1_code),TRIM((SALT33.StrType)le.amenities2_code),TRIM((SALT33.StrType)le.amenities3_code),TRIM((SALT33.StrType)le.amenities4_code),TRIM((SALT33.StrType)le.amenities5_code),TRIM((SALT33.StrType)le.amenities2_code1),TRIM((SALT33.StrType)le.amenities2_code2),TRIM((SALT33.StrType)le.amenities2_code3),TRIM((SALT33.StrType)le.amenities2_code4),TRIM((SALT33.StrType)le.amenities2_code5),TRIM((SALT33.StrType)le.extra_features1_area),TRIM((SALT33.StrType)le.extra_features1_indicator),TRIM((SALT33.StrType)le.extra_features2_area),TRIM((SALT33.StrType)le.extra_features2_indicator),TRIM((SALT33.StrType)le.extra_features3_area),TRIM((SALT33.StrType)le.extra_features3_indicator),TRIM((SALT33.StrType)le.extra_features4_area),TRIM((SALT33.StrType)le.extra_features4_indicator),TRIM((SALT33.StrType)le.other_buildings1_code),TRIM((SALT33.StrType)le.other_buildings2_code),TRIM((SALT33.StrType)le.other_buildings3_code),TRIM((SALT33.StrType)le.other_buildings4_code),TRIM((SALT33.StrType)le.other_buildings5_code),TRIM((SALT33.StrType)le.other_impr_building1_indicator),TRIM((SALT33.StrType)le.other_impr_building2_indicator),TRIM((SALT33.StrType)le.other_impr_building3_indicator),TRIM((SALT33.StrType)le.other_impr_building4_indicator),TRIM((SALT33.StrType)le.other_impr_building5_indicator),TRIM((SALT33.StrType)le.other_impr_building_area1),TRIM((SALT33.StrType)le.other_impr_building_area2),TRIM((SALT33.StrType)le.other_impr_building_area3),TRIM((SALT33.StrType)le.other_impr_building_area4),TRIM((SALT33.StrType)le.other_impr_building_area5),TRIM((SALT33.StrType)le.topograpy_code),TRIM((SALT33.StrType)le.neighborhood_code),TRIM((SALT33.StrType)le.condo_project_or_building_name),TRIM((SALT33.StrType)le.assessee_name_indicator),TRIM((SALT33.StrType)le.second_assessee_name_indicator),TRIM((SALT33.StrType)le.other_rooms_indicator),TRIM((SALT33.StrType)le.mail_care_of_name_indicator),TRIM((SALT33.StrType)le.comments),TRIM((SALT33.StrType)le.tape_cut_date),TRIM((SALT33.StrType)le.certification_date),TRIM((SALT33.StrType)le.edition_number),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_mailing_country_code),TRIM((SALT33.StrType)le.ln_property_name),TRIM((SALT33.StrType)le.ln_property_name_type),TRIM((SALT33.StrType)le.ln_land_use_category),TRIM((SALT33.StrType)le.ln_lot),TRIM((SALT33.StrType)le.ln_block),TRIM((SALT33.StrType)le.ln_unit),TRIM((SALT33.StrType)le.ln_subfloor),TRIM((SALT33.StrType)le.ln_floor_cover),TRIM((SALT33.StrType)le.ln_mobile_home_indicator),TRIM((SALT33.StrType)le.ln_condo_indicator),TRIM((SALT33.StrType)le.ln_property_tax_exemption),TRIM((SALT33.StrType)le.ln_veteran_status),TRIM((SALT33.StrType)le.ln_old_apn_indicator),TRIM((SALT33.StrType)le.fips)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.ln_fares_id),TRIM((SALT33.StrType)le.process_date),TRIM((SALT33.StrType)le.vendor_source_flag),TRIM((SALT33.StrType)le.current_record),TRIM((SALT33.StrType)le.fips_code),TRIM((SALT33.StrType)le.state_code),TRIM((SALT33.StrType)le.county_name),TRIM((SALT33.StrType)le.old_apn),TRIM((SALT33.StrType)le.apna_or_pin_number),TRIM((SALT33.StrType)le.fares_unformatted_apn),TRIM((SALT33.StrType)le.duplicate_apn_multiple_address_id),TRIM((SALT33.StrType)le.assessee_name),TRIM((SALT33.StrType)le.second_assessee_name),TRIM((SALT33.StrType)le.assessee_ownership_rights_code),TRIM((SALT33.StrType)le.assessee_relationship_code),TRIM((SALT33.StrType)le.assessee_phone_number),TRIM((SALT33.StrType)le.tax_account_number),TRIM((SALT33.StrType)le.contract_owner),TRIM((SALT33.StrType)le.assessee_name_type_code),TRIM((SALT33.StrType)le.second_assessee_name_type_code),TRIM((SALT33.StrType)le.mail_care_of_name_type_code),TRIM((SALT33.StrType)le.mailing_care_of_name),TRIM((SALT33.StrType)le.mailing_full_street_address),TRIM((SALT33.StrType)le.mailing_unit_number),TRIM((SALT33.StrType)le.mailing_city_state_zip),TRIM((SALT33.StrType)le.property_full_street_address),TRIM((SALT33.StrType)le.property_unit_number),TRIM((SALT33.StrType)le.property_city_state_zip),TRIM((SALT33.StrType)le.property_country_code),TRIM((SALT33.StrType)le.property_address_code),TRIM((SALT33.StrType)le.legal_lot_code),TRIM((SALT33.StrType)le.legal_lot_number),TRIM((SALT33.StrType)le.legal_land_lot),TRIM((SALT33.StrType)le.legal_block),TRIM((SALT33.StrType)le.legal_section),TRIM((SALT33.StrType)le.legal_district),TRIM((SALT33.StrType)le.legal_unit),TRIM((SALT33.StrType)le.legal_city_municipality_township),TRIM((SALT33.StrType)le.legal_subdivision_name),TRIM((SALT33.StrType)le.legal_phase_number),TRIM((SALT33.StrType)le.legal_tract_number),TRIM((SALT33.StrType)le.legal_sec_twn_rng_mer),TRIM((SALT33.StrType)le.legal_brief_description),TRIM((SALT33.StrType)le.legal_assessor_map_ref),TRIM((SALT33.StrType)le.census_tract),TRIM((SALT33.StrType)le.record_type_code),TRIM((SALT33.StrType)le.ownership_type_code),TRIM((SALT33.StrType)le.new_record_type_code),TRIM((SALT33.StrType)le.state_land_use_code),TRIM((SALT33.StrType)le.county_land_use_code),TRIM((SALT33.StrType)le.county_land_use_description),TRIM((SALT33.StrType)le.standardized_land_use_code),TRIM((SALT33.StrType)le.timeshare_code),TRIM((SALT33.StrType)le.zoning),TRIM((SALT33.StrType)le.owner_occupied),TRIM((SALT33.StrType)le.recorder_document_number),TRIM((SALT33.StrType)le.recorder_book_number),TRIM((SALT33.StrType)le.recorder_page_number),TRIM((SALT33.StrType)le.transfer_date),TRIM((SALT33.StrType)le.recording_date),TRIM((SALT33.StrType)le.sale_date),TRIM((SALT33.StrType)le.document_type),TRIM((SALT33.StrType)le.sales_price),TRIM((SALT33.StrType)le.sales_price_code),TRIM((SALT33.StrType)le.mortgage_loan_amount),TRIM((SALT33.StrType)le.mortgage_loan_type_code),TRIM((SALT33.StrType)le.mortgage_lender_name),TRIM((SALT33.StrType)le.mortgage_lender_type_code),TRIM((SALT33.StrType)le.prior_transfer_date),TRIM((SALT33.StrType)le.prior_recording_date),TRIM((SALT33.StrType)le.prior_sales_price),TRIM((SALT33.StrType)le.prior_sales_price_code),TRIM((SALT33.StrType)le.assessed_land_value),TRIM((SALT33.StrType)le.assessed_improvement_value),TRIM((SALT33.StrType)le.assessed_total_value),TRIM((SALT33.StrType)le.assessed_value_year),TRIM((SALT33.StrType)le.market_land_value),TRIM((SALT33.StrType)le.market_improvement_value),TRIM((SALT33.StrType)le.market_total_value),TRIM((SALT33.StrType)le.market_value_year),TRIM((SALT33.StrType)le.homestead_homeowner_exemption),TRIM((SALT33.StrType)le.tax_exemption1_code),TRIM((SALT33.StrType)le.tax_exemption2_code),TRIM((SALT33.StrType)le.tax_exemption3_code),TRIM((SALT33.StrType)le.tax_exemption4_code),TRIM((SALT33.StrType)le.tax_rate_code_area),TRIM((SALT33.StrType)le.tax_amount),TRIM((SALT33.StrType)le.tax_year),TRIM((SALT33.StrType)le.tax_delinquent_year),TRIM((SALT33.StrType)le.school_tax_district1),TRIM((SALT33.StrType)le.school_tax_district1_indicator),TRIM((SALT33.StrType)le.school_tax_district2),TRIM((SALT33.StrType)le.school_tax_district2_indicator),TRIM((SALT33.StrType)le.school_tax_district3),TRIM((SALT33.StrType)le.school_tax_district3_indicator),TRIM((SALT33.StrType)le.lot_size),TRIM((SALT33.StrType)le.lot_size_acres),TRIM((SALT33.StrType)le.lot_size_frontage_feet),TRIM((SALT33.StrType)le.lot_size_depth_feet),TRIM((SALT33.StrType)le.land_acres),TRIM((SALT33.StrType)le.land_square_footage),TRIM((SALT33.StrType)le.land_dimensions),TRIM((SALT33.StrType)le.building_area),TRIM((SALT33.StrType)le.building_area_indicator),TRIM((SALT33.StrType)le.building_area1),TRIM((SALT33.StrType)le.building_area1_indicator),TRIM((SALT33.StrType)le.building_area2),TRIM((SALT33.StrType)le.building_area2_indicator),TRIM((SALT33.StrType)le.building_area3),TRIM((SALT33.StrType)le.building_area3_indicator),TRIM((SALT33.StrType)le.building_area4),TRIM((SALT33.StrType)le.building_area4_indicator),TRIM((SALT33.StrType)le.building_area5),TRIM((SALT33.StrType)le.building_area5_indicator),TRIM((SALT33.StrType)le.building_area6),TRIM((SALT33.StrType)le.building_area6_indicator),TRIM((SALT33.StrType)le.building_area7),TRIM((SALT33.StrType)le.building_area7_indicator),TRIM((SALT33.StrType)le.year_built),TRIM((SALT33.StrType)le.effective_year_built),TRIM((SALT33.StrType)le.no_of_buildings),TRIM((SALT33.StrType)le.no_of_stories),TRIM((SALT33.StrType)le.no_of_units),TRIM((SALT33.StrType)le.no_of_rooms),TRIM((SALT33.StrType)le.no_of_bedrooms),TRIM((SALT33.StrType)le.no_of_baths),TRIM((SALT33.StrType)le.no_of_partial_baths),TRIM((SALT33.StrType)le.no_of_plumbing_fixtures),TRIM((SALT33.StrType)le.garage_type_code),TRIM((SALT33.StrType)le.parking_no_of_cars),TRIM((SALT33.StrType)le.pool_code),TRIM((SALT33.StrType)le.style_code),TRIM((SALT33.StrType)le.type_construction_code),TRIM((SALT33.StrType)le.foundation_code),TRIM((SALT33.StrType)le.building_quality_code),TRIM((SALT33.StrType)le.building_condition_code),TRIM((SALT33.StrType)le.exterior_walls_code),TRIM((SALT33.StrType)le.interior_walls_code),TRIM((SALT33.StrType)le.roof_cover_code),TRIM((SALT33.StrType)le.roof_type_code),TRIM((SALT33.StrType)le.floor_cover_code),TRIM((SALT33.StrType)le.water_code),TRIM((SALT33.StrType)le.sewer_code),TRIM((SALT33.StrType)le.heating_code),TRIM((SALT33.StrType)le.heating_fuel_type_code),TRIM((SALT33.StrType)le.air_conditioning_code),TRIM((SALT33.StrType)le.air_conditioning_type_code),TRIM((SALT33.StrType)le.elevator),TRIM((SALT33.StrType)le.fireplace_indicator),TRIM((SALT33.StrType)le.fireplace_number),TRIM((SALT33.StrType)le.basement_code),TRIM((SALT33.StrType)le.building_class_code),TRIM((SALT33.StrType)le.site_influence1_code),TRIM((SALT33.StrType)le.site_influence2_code),TRIM((SALT33.StrType)le.site_influence3_code),TRIM((SALT33.StrType)le.site_influence4_code),TRIM((SALT33.StrType)le.site_influence5_code),TRIM((SALT33.StrType)le.amenities1_code),TRIM((SALT33.StrType)le.amenities2_code),TRIM((SALT33.StrType)le.amenities3_code),TRIM((SALT33.StrType)le.amenities4_code),TRIM((SALT33.StrType)le.amenities5_code),TRIM((SALT33.StrType)le.amenities2_code1),TRIM((SALT33.StrType)le.amenities2_code2),TRIM((SALT33.StrType)le.amenities2_code3),TRIM((SALT33.StrType)le.amenities2_code4),TRIM((SALT33.StrType)le.amenities2_code5),TRIM((SALT33.StrType)le.extra_features1_area),TRIM((SALT33.StrType)le.extra_features1_indicator),TRIM((SALT33.StrType)le.extra_features2_area),TRIM((SALT33.StrType)le.extra_features2_indicator),TRIM((SALT33.StrType)le.extra_features3_area),TRIM((SALT33.StrType)le.extra_features3_indicator),TRIM((SALT33.StrType)le.extra_features4_area),TRIM((SALT33.StrType)le.extra_features4_indicator),TRIM((SALT33.StrType)le.other_buildings1_code),TRIM((SALT33.StrType)le.other_buildings2_code),TRIM((SALT33.StrType)le.other_buildings3_code),TRIM((SALT33.StrType)le.other_buildings4_code),TRIM((SALT33.StrType)le.other_buildings5_code),TRIM((SALT33.StrType)le.other_impr_building1_indicator),TRIM((SALT33.StrType)le.other_impr_building2_indicator),TRIM((SALT33.StrType)le.other_impr_building3_indicator),TRIM((SALT33.StrType)le.other_impr_building4_indicator),TRIM((SALT33.StrType)le.other_impr_building5_indicator),TRIM((SALT33.StrType)le.other_impr_building_area1),TRIM((SALT33.StrType)le.other_impr_building_area2),TRIM((SALT33.StrType)le.other_impr_building_area3),TRIM((SALT33.StrType)le.other_impr_building_area4),TRIM((SALT33.StrType)le.other_impr_building_area5),TRIM((SALT33.StrType)le.topograpy_code),TRIM((SALT33.StrType)le.neighborhood_code),TRIM((SALT33.StrType)le.condo_project_or_building_name),TRIM((SALT33.StrType)le.assessee_name_indicator),TRIM((SALT33.StrType)le.second_assessee_name_indicator),TRIM((SALT33.StrType)le.other_rooms_indicator),TRIM((SALT33.StrType)le.mail_care_of_name_indicator),TRIM((SALT33.StrType)le.comments),TRIM((SALT33.StrType)le.tape_cut_date),TRIM((SALT33.StrType)le.certification_date),TRIM((SALT33.StrType)le.edition_number),TRIM((SALT33.StrType)le.prop_addr_propagated_ind),TRIM((SALT33.StrType)le.ln_ownership_rights),TRIM((SALT33.StrType)le.ln_relationship_type),TRIM((SALT33.StrType)le.ln_mailing_country_code),TRIM((SALT33.StrType)le.ln_property_name),TRIM((SALT33.StrType)le.ln_property_name_type),TRIM((SALT33.StrType)le.ln_land_use_category),TRIM((SALT33.StrType)le.ln_lot),TRIM((SALT33.StrType)le.ln_block),TRIM((SALT33.StrType)le.ln_unit),TRIM((SALT33.StrType)le.ln_subfloor),TRIM((SALT33.StrType)le.ln_floor_cover),TRIM((SALT33.StrType)le.ln_mobile_home_indicator),TRIM((SALT33.StrType)le.ln_condo_indicator),TRIM((SALT33.StrType)le.ln_property_tax_exemption),TRIM((SALT33.StrType)le.ln_veteran_status),TRIM((SALT33.StrType)le.ln_old_apn_indicator),TRIM((SALT33.StrType)le.fips)));
  END;
...
SHARED FldIds := DATASET([{1,'ln_fares_id'}
      ...
      ,{219,'fips'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Fields.InValid_ln_fares_id((SALT33.StrType)le.ln_fares_id),
    Fields.InValid_process_date((SALT33.StrType)le.process_date),
    Fields.InValid_vendor_source_flag((SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_current_record((SALT33.StrType)le.current_record),
    Fields.InValid_fips_code((SALT33.StrType)le.fips_code),
    Fields.InValid_state_code((SALT33.StrType)le.state_code),
    Fields.InValid_county_name((SALT33.StrType)le.county_name),
    Fields.InValid_old_apn((SALT33.StrType)le.old_apn),
    Fields.InValid_apna_or_pin_number((SALT33.StrType)le.apna_or_pin_number),
    Fields.InValid_fares_unformatted_apn((SALT33.StrType)le.fares_unformatted_apn),
    Fields.InValid_duplicate_apn_multiple_address_id((SALT33.StrType)le.duplicate_apn_multiple_address_id),
    Fields.InValid_assessee_name((SALT33.StrType)le.assessee_name),
    Fields.InValid_second_assessee_name((SALT33.StrType)le.second_assessee_name),
    Fields.InValid_assessee_ownership_rights_code((SALT33.StrType)le.assessee_ownership_rights_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_assessee_relationship_code((SALT33.StrType)le.assessee_relationship_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_assessee_phone_number((SALT33.StrType)le.assessee_phone_number),
    Fields.InValid_tax_account_number((SALT33.StrType)le.tax_account_number),
    Fields.InValid_contract_owner((SALT33.StrType)le.contract_owner),
    Fields.InValid_assessee_name_type_code((SALT33.StrType)le.assessee_name_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_second_assessee_name_type_code((SALT33.StrType)le.second_assessee_name_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_mail_care_of_name_type_code((SALT33.StrType)le.mail_care_of_name_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_mailing_care_of_name((SALT33.StrType)le.mailing_care_of_name),
    Fields.InValid_mailing_full_street_address((SALT33.StrType)le.mailing_full_street_address),
    Fields.InValid_mailing_unit_number((SALT33.StrType)le.mailing_unit_number),
    Fields.InValid_mailing_city_state_zip((SALT33.StrType)le.mailing_city_state_zip),
    Fields.InValid_property_full_street_address((SALT33.StrType)le.property_full_street_address),
    Fields.InValid_property_unit_number((SALT33.StrType)le.property_unit_number),
    Fields.InValid_property_city_state_zip((SALT33.StrType)le.property_city_state_zip),
    Fields.InValid_property_country_code((SALT33.StrType)le.property_country_code),
    Fields.InValid_property_address_code((SALT33.StrType)le.property_address_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_legal_lot_code((SALT33.StrType)le.legal_lot_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_legal_lot_number((SALT33.StrType)le.legal_lot_number),
    Fields.InValid_legal_land_lot((SALT33.StrType)le.legal_land_lot),
    Fields.InValid_legal_block((SALT33.StrType)le.legal_block),
    Fields.InValid_legal_section((SALT33.StrType)le.legal_section),
    Fields.InValid_legal_district((SALT33.StrType)le.legal_district),
    Fields.InValid_legal_unit((SALT33.StrType)le.legal_unit),
    Fields.InValid_legal_city_municipality_township((SALT33.StrType)le.legal_city_municipality_township),
    Fields.InValid_legal_subdivision_name((SALT33.StrType)le.legal_subdivision_name),
    Fields.InValid_legal_phase_number((SALT33.StrType)le.legal_phase_number),
    Fields.InValid_legal_tract_number((SALT33.StrType)le.legal_tract_number),
    Fields.InValid_legal_sec_twn_rng_mer((SALT33.StrType)le.legal_sec_twn_rng_mer),
    Fields.InValid_legal_brief_description((SALT33.StrType)le.legal_brief_description),
    Fields.InValid_legal_assessor_map_ref((SALT33.StrType)le.legal_assessor_map_ref),
    Fields.InValid_census_tract((SALT33.StrType)le.census_tract),
    Fields.InValid_record_type_code((SALT33.StrType)le.record_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_ownership_type_code((SALT33.StrType)le.ownership_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_new_record_type_code((SALT33.StrType)le.new_record_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_state_land_use_code((SALT33.StrType)le.state_land_use_code),
    Fields.InValid_county_land_use_code((SALT33.StrType)le.county_land_use_code),
    Fields.InValid_county_land_use_description((SALT33.StrType)le.county_land_use_description),
    Fields.InValid_standardized_land_use_code((SALT33.StrType)le.standardized_land_use_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_timeshare_code((SALT33.StrType)le.timeshare_code),
    Fields.InValid_zoning((SALT33.StrType)le.zoning),
    Fields.InValid_owner_occupied((SALT33.StrType)le.owner_occupied),
    Fields.InValid_recorder_document_number((SALT33.StrType)le.recorder_document_number),
    Fields.InValid_recorder_book_number((SALT33.StrType)le.recorder_book_number),
    Fields.InValid_recorder_page_number((SALT33.StrType)le.recorder_page_number),
    Fields.InValid_transfer_date((SALT33.StrType)le.transfer_date),
    Fields.InValid_recording_date((SALT33.StrType)le.recording_date),
    Fields.InValid_sale_date((SALT33.StrType)le.sale_date),
    Fields.InValid_document_type((SALT33.StrType)le.document_type,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_sales_price((SALT33.StrType)le.sales_price),
    Fields.InValid_sales_price_code((SALT33.StrType)le.sales_price_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_mortgage_loan_amount((SALT33.StrType)le.mortgage_loan_amount),
    Fields.InValid_mortgage_loan_type_code((SALT33.StrType)le.mortgage_loan_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_mortgage_lender_name((SALT33.StrType)le.mortgage_lender_name),
    Fields.InValid_mortgage_lender_type_code((SALT33.StrType)le.mortgage_lender_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_prior_transfer_date((SALT33.StrType)le.prior_transfer_date),
    Fields.InValid_prior_recording_date((SALT33.StrType)le.prior_recording_date),
    Fields.InValid_prior_sales_price((SALT33.StrType)le.prior_sales_price),
    Fields.InValid_prior_sales_price_code((SALT33.StrType)le.prior_sales_price_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_assessed_land_value((SALT33.StrType)le.assessed_land_value),
    Fields.InValid_assessed_improvement_value((SALT33.StrType)le.assessed_improvement_value),
    Fields.InValid_assessed_total_value((SALT33.StrType)le.assessed_total_value),
    Fields.InValid_assessed_value_year((SALT33.StrType)le.assessed_value_year),
    Fields.InValid_market_land_value((SALT33.StrType)le.market_land_value),
    Fields.InValid_market_improvement_value((SALT33.StrType)le.market_improvement_value),
    Fields.InValid_market_total_value((SALT33.StrType)le.market_total_value),
    Fields.InValid_market_value_year((SALT33.StrType)le.market_value_year),
    Fields.InValid_homestead_homeowner_exemption((SALT33.StrType)le.homestead_homeowner_exemption),
    Fields.InValid_tax_exemption1_code((SALT33.StrType)le.tax_exemption1_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_tax_exemption2_code((SALT33.StrType)le.tax_exemption2_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_tax_exemption3_code((SALT33.StrType)le.tax_exemption3_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_tax_exemption4_code((SALT33.StrType)le.tax_exemption4_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_tax_rate_code_area((SALT33.StrType)le.tax_rate_code_area),
    Fields.InValid_tax_amount((SALT33.StrType)le.tax_amount),
    Fields.InValid_tax_year((SALT33.StrType)le.tax_year),
    Fields.InValid_tax_delinquent_year((SALT33.StrType)le.tax_delinquent_year),
    Fields.InValid_school_tax_district1((SALT33.StrType)le.school_tax_district1),
    Fields.InValid_school_tax_district1_indicator((SALT33.StrType)le.school_tax_district1_indicator),
    Fields.InValid_school_tax_district2((SALT33.StrType)le.school_tax_district2),
    Fields.InValid_school_tax_district2_indicator((SALT33.StrType)le.school_tax_district2_indicator),
    Fields.InValid_school_tax_district3((SALT33.StrType)le.school_tax_district3),
    Fields.InValid_school_tax_district3_indicator((SALT33.StrType)le.school_tax_district3_indicator),
    Fields.InValid_lot_size((SALT33.StrType)le.lot_size),
    Fields.InValid_lot_size_acres((SALT33.StrType)le.lot_size_acres),
    Fields.InValid_lot_size_frontage_feet((SALT33.StrType)le.lot_size_frontage_feet),
    Fields.InValid_lot_size_depth_feet((SALT33.StrType)le.lot_size_depth_feet),
    Fields.InValid_land_acres((SALT33.StrType)le.land_acres),
    Fields.InValid_land_square_footage((SALT33.StrType)le.land_square_footage),
    Fields.InValid_land_dimensions((SALT33.StrType)le.land_dimensions),
    Fields.InValid_building_area((SALT33.StrType)le.building_area),
    Fields.InValid_building_area_indicator((SALT33.StrType)le.building_area_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area1((SALT33.StrType)le.building_area1),
    Fields.InValid_building_area1_indicator((SALT33.StrType)le.building_area1_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area2((SALT33.StrType)le.building_area2),
    Fields.InValid_building_area2_indicator((SALT33.StrType)le.building_area2_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area3((SALT33.StrType)le.building_area3),
    Fields.InValid_building_area3_indicator((SALT33.StrType)le.building_area3_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area4((SALT33.StrType)le.building_area4),
    Fields.InValid_building_area4_indicator((SALT33.StrType)le.building_area4_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area5((SALT33.StrType)le.building_area5),
    Fields.InValid_building_area5_indicator((SALT33.StrType)le.building_area5_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area6((SALT33.StrType)le.building_area6),
    Fields.InValid_building_area6_indicator((SALT33.StrType)le.building_area6_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_area7((SALT33.StrType)le.building_area7),
    Fields.InValid_building_area7_indicator((SALT33.StrType)le.building_area7_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_year_built((SALT33.StrType)le.year_built),
    Fields.InValid_effective_year_built((SALT33.StrType)le.effective_year_built),
    Fields.InValid_no_of_buildings((SALT33.StrType)le.no_of_buildings),
    Fields.InValid_no_of_stories((SALT33.StrType)le.no_of_stories),
    Fields.InValid_no_of_units((SALT33.StrType)le.no_of_units),
    Fields.InValid_no_of_rooms((SALT33.StrType)le.no_of_rooms),
    Fields.InValid_no_of_bedrooms((SALT33.StrType)le.no_of_bedrooms),
    Fields.InValid_no_of_baths((SALT33.StrType)le.no_of_baths),
    Fields.InValid_no_of_partial_baths((SALT33.StrType)le.no_of_partial_baths),
    Fields.InValid_no_of_plumbing_fixtures((SALT33.StrType)le.no_of_plumbing_fixtures),
    Fields.InValid_garage_type_code((SALT33.StrType)le.garage_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_parking_no_of_cars((SALT33.StrType)le.parking_no_of_cars),
    Fields.InValid_pool_code((SALT33.StrType)le.pool_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_style_code((SALT33.StrType)le.style_code),
    Fields.InValid_type_construction_code((SALT33.StrType)le.type_construction_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_foundation_code((SALT33.StrType)le.foundation_code),
    Fields.InValid_building_quality_code((SALT33.StrType)le.building_quality_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_condition_code((SALT33.StrType)le.building_condition_code),
    Fields.InValid_exterior_walls_code((SALT33.StrType)le.exterior_walls_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_interior_walls_code((SALT33.StrType)le.interior_walls_code),
    Fields.InValid_roof_cover_code((SALT33.StrType)le.roof_cover_code),
    Fields.InValid_roof_type_code((SALT33.StrType)le.roof_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_floor_cover_code((SALT33.StrType)le.floor_cover_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_water_code((SALT33.StrType)le.water_code),
    Fields.InValid_sewer_code((SALT33.StrType)le.sewer_code),
    Fields.InValid_heating_code((SALT33.StrType)le.heating_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_heating_fuel_type_code((SALT33.StrType)le.heating_fuel_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_air_conditioning_code((SALT33.StrType)le.air_conditioning_code),
    Fields.InValid_air_conditioning_type_code((SALT33.StrType)le.air_conditioning_type_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_elevator((SALT33.StrType)le.elevator),
    Fields.InValid_fireplace_indicator((SALT33.StrType)le.fireplace_indicator,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_fireplace_number((SALT33.StrType)le.fireplace_number),
    Fields.InValid_basement_code((SALT33.StrType)le.basement_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_building_class_code((SALT33.StrType)le.building_class_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_site_influence1_code((SALT33.StrType)le.site_influence1_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_site_influence2_code((SALT33.StrType)le.site_influence2_code),
    Fields.InValid_site_influence3_code((SALT33.StrType)le.site_influence3_code),
    Fields.InValid_site_influence4_code((SALT33.StrType)le.site_influence4_code),
    Fields.InValid_site_influence5_code((SALT33.StrType)le.site_influence5_code),
    Fields.InValid_amenities1_code((SALT33.StrType)le.amenities1_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_amenities2_code((SALT33.StrType)le.amenities2_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_amenities3_code((SALT33.StrType)le.amenities3_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_amenities4_code((SALT33.StrType)le.amenities4_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_amenities5_code((SALT33.StrType)le.amenities5_code),
    Fields.InValid_amenities2_code1((SALT33.StrType)le.amenities2_code1),
    Fields.InValid_amenities2_code2((SALT33.StrType)le.amenities2_code2),
    Fields.InValid_amenities2_code3((SALT33.StrType)le.amenities2_code3),
    Fields.InValid_amenities2_code4((SALT33.StrType)le.amenities2_code4),
    Fields.InValid_amenities2_code5((SALT33.StrType)le.amenities2_code5),
    Fields.InValid_extra_features1_area((SALT33.StrType)le.extra_features1_area),
    Fields.InValid_extra_features1_indicator((SALT33.StrType)le.extra_features1_indicator),
    Fields.InValid_extra_features2_area((SALT33.StrType)le.extra_features2_area),
    Fields.InValid_extra_features2_indicator((SALT33.StrType)le.extra_features2_indicator),
    Fields.InValid_extra_features3_area((SALT33.StrType)le.extra_features3_area),
    Fields.InValid_extra_features3_indicator((SALT33.StrType)le.extra_features3_indicator),
    Fields.InValid_extra_features4_area((SALT33.StrType)le.extra_features4_area),
    Fields.InValid_extra_features4_indicator((SALT33.StrType)le.extra_features4_indicator),
    Fields.InValid_other_buildings1_code((SALT33.StrType)le.other_buildings1_code,(SALT33.StrType)le.vendor_source_flag),
    Fields.InValid_other_buildings2_code((SALT33.StrType)le.other_buildings2_code),
    Fields.InValid_other_buildings3_code((SALT33.StrType)le.other_buildings3_code),
    Fields.InValid_other_buildings4_code((SALT33.StrType)le.other_buildings4_code),
    Fields.InValid_other_buildings5_code((SALT33.StrType)le.other_buildings5_code),
    Fields.InValid_other_impr_building1_indicator((SALT33.StrType)le.other_impr_building1_indicator),
    Fields.InValid_other_impr_building2_indicator((SALT33.StrType)le.other_impr_building2_indicator),
    Fields.InValid_other_impr_building3_indicator((SALT33.StrType)le.other_impr_building3_indicator),
    Fields.InValid_other_impr_building4_indicator((SALT33.StrType)le.other_impr_building4_indicator),
    Fields.InValid_other_impr_building5_indicator((SALT33.StrType)le.other_impr_building5_indicator),
    Fields.InValid_other_impr_building_area1((SALT33.StrType)le.other_impr_building_area1),
    Fields.InValid_other_impr_building_area2((SALT33.StrType)le.other_impr_building_area2),
    Fields.InValid_other_impr_building_area3((SALT33.StrType)le.other_impr_building_area3),
    Fields.InValid_other_impr_building_area4((SALT33.StrType)le.other_impr_building_area4),
    Fields.InValid_other_impr_building_area5((SALT33.StrType)le.other_impr_building_area5),
    Fields.InValid_topograpy_code((SALT33.StrType)le.topograpy_code),
    Fields.InValid_neighborhood_code((SALT33.StrType)le.neighborhood_code),
    Fields.InValid_condo_project_or_building_name((SALT33.StrType)le.condo_project_or_building_name),
    Fields.InValid_assessee_name_indicator((SALT33.StrType)le.assessee_name_indicator),
    Fields.InValid_second_assessee_name_indicator((SALT33.StrType)le.second_assessee_name_indicator),
    Fields.InValid_other_rooms_indicator((SALT33.StrType)le.other_rooms_indicator),
    Fields.InValid_mail_care_of_name_indicator((SALT33.StrType)le.mail_care_of_name_indicator),
    Fields.InValid_comments((SALT33.StrType)le.comments),
    Fields.InValid_tape_cut_date((SALT33.StrType)le.tape_cut_date),
    Fields.InValid_certification_date((SALT33.StrType)le.certification_date),
    Fields.InValid_edition_number((SALT33.StrType)le.edition_number),
    Fields.InValid_prop_addr_propagated_ind((SALT33.StrType)le.prop_addr_propagated_ind),
    Fields.InValid_ln_ownership_rights((SALT33.StrType)le.ln_ownership_rights),
    Fields.InValid_ln_relationship_type((SALT33.StrType)le.ln_relationship_type),
    Fields.InValid_ln_mailing_country_code((SALT33.StrType)le.ln_mailing_country_code),
    Fields.InValid_ln_property_name((SALT33.StrType)le.ln_property_name),
    Fields.InValid_ln_property_name_type((SALT33.StrType)le.ln_property_name_type),
    Fields.InValid_ln_land_use_category((SALT33.StrType)le.ln_land_use_category),
    Fields.InValid_ln_lot((SALT33.StrType)le.ln_lot),
    Fields.InValid_ln_block((SALT33.StrType)le.ln_block),
    Fields.InValid_ln_unit((SALT33.StrType)le.ln_unit),
    Fields.InValid_ln_subfloor((SALT33.StrType)le.ln_subfloor),
    Fields.InValid_ln_floor_cover((SALT33.StrType)le.ln_floor_cover),
    Fields.InValid_ln_mobile_home_indicator((SALT33.StrType)le.ln_mobile_home_indicator),
    Fields.InValid_ln_condo_indicator((SALT33.StrType)le.ln_condo_indicator),
    Fields.InValid_ln_property_tax_exemption((SALT33.StrType)le.ln_property_tax_exemption),
    Fields.InValid_ln_veteran_status((SALT33.StrType)le.ln_veteran_status),
    Fields.InValid_ln_old_apn_indicator((SALT33.StrType)le.ln_old_apn_indicator),
    Fields.InValid_fips((SALT33.StrType)le.fips),
    0);
...
//Compute field consistencies between sources
  SALT33.mac_srcfrequency_outliers(h,standardized_land_use_code,fips_code,standardized_land_use_code_outliers)
  SALT33.mac_srcfrequency_outliers(h,document_type,fips_code,document_type_outliers)
  SALT33.mac_srcfrequency_outliers(h,sales_price,fips_code,sales_price_outliers)
  SALT33.mac_srcfrequency_outliers(h,mortgage_loan_type_code,fips_code,mortgage_loan_type_code_outliers)
EXPORT AllOutliers := standardized_land_use_code_outliers + document_type_outliers + sales_price_outliers + mortgage_loan_type_code_outliers;
END;
