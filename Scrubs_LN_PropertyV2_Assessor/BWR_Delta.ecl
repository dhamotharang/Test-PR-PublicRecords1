...
#workunit('name','Scrubs_LN_PropertyV2_Assessor.BWR_Delta - Finding the Delta of Two Files - SALT V3.11.0');
IMPORT Scrubs_LN_PropertyV2_Assessor,SALT311;
FilePrev := DATASET([], Layout_Property_Assessor);
FileNew := DATASET([], Layout_Property_Assessor);
