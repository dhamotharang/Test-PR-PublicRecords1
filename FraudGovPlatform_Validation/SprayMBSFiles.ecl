...
function
  ...
  MAC_FilesToSprayHHID(pFilenameMBSFdnHHID , FraudShared.Filenames(pversion).Input.MBSFdnHHID , FilesToSprayMBSFdnHHID );
	...
	return sequential(
		...
		, if(not FraudShared._Flags.FileExists.Input.MBSFdnHHID or pOverwrite , 		STD.File.SwapSuperFile(fraudshared.filenames().input.MBSFdnHHID.used,fraudshared.filenames().input.MBSFdnHHID.sprayed))
		, if(not FraudShared._Flags.FileExists.Input.MBSmarketAppend or pOverwrite , 	STD.File.SwapSuperFile(fraudshared.filenames().input.MBSmarketAppend.used,fraudshared.filenames().input.MBSmarketAppend.sprayed))
