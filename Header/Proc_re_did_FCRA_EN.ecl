...
PromoteSupers.MAC_SF_BuildProcess(d_did,'~thor_data400::base::fcra::experiancred',re_did_It,numgenerations:='2',pCompress:=true,pVersion:=Header.version_build);
...
EXPORT Proc_re_did_FCRA_EN:= sequential(
																				re_did_It
																				,input_clear
																				,input_set
																				);