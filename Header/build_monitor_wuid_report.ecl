...
Emailrecepients := _control.MyInfo.EmailAddressNotify; // i.e. me !
...
lemail := STD.System.Email.SendEmail(
				Emailrecepients ,							// recipientAddress
...
EXPORT build_monitor_wuid_report := go;