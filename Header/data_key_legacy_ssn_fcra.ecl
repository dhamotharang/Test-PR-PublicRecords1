...
//export Key_FCRA_legacy_ssn := INDEX(records((unsigned)ssn>0), {records},ut.Data_Location.Person_header + 'thor_data400::key::header_0::FCRA::header.legacy_ssn_' + doxie.version_superkey,opt);
export data_key_legacy_ssn_fcra := records;
