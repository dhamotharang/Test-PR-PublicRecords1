...
header.Layout_Header t_fix_dobs(head0 le) := transform
 ...
 string4 v_yy := (string4)((string8)v_dob)[1..4];
 string2 v_mm := (string2)((string8)v_dob)[5..6];
 string2 v_dd := (string2)((string8)v_dob)[7..8];
 
 string2 v_28_days_or_leap_yr := if(Std.Date.IsLeapYear((integer)v_yy)=true,'29','28');
