...
weekly_file  := dataset('~thor400_84::in::eq_weekly',rec_weekly,flat);
...
export file_header_in_weekly := project(weekly_file,t_append_dt(left)) : persist('persist::eq_weekly_with_as_of_date');