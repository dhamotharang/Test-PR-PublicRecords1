...
html := header.mac_convertDs.toHTML(s_c_rpt,src,src_desc,newHr_cnt,prev_nbm_cnt,nbm_cnt,nbm_pct_of_newHr,pct_nbm_change,nbm_change,nbm_change_pct_of_newHr,abs_nbm_change_pct_of_newHr,prod_cnt,nbm_pct_prod_cnt);
