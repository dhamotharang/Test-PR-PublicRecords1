...
EXPORT MoveToQA :=sequential(
    ...
    ,nothor(apply(ld,           update_supers(  ver(nm,'qa'    ,'thor_data400'), ver(nm,filedate,'thor_data400'))))
    ,nothor(apply(ld,           update_supers(  ver(nm,'qa'    ,'thor400_44'  ), ver(nm,filedate,'thor_data400'))))
    ,nothor(apply(ld,           update_supers(  ver(nm,'qa'    ,'thor400_36'  ), ver(nm,filedate,'thor_data400'))))
