...
SHARED orbit_update_entries(boolean isCreate, string skipPackage='000') := function
    ...
    RETURN sequential(
                        if(skipPackage[1]='0',Orbit3.Proc_Orbit3_CreateBuild('Show PersonXLAB_Inc', filedate, 'N', skipcreatebuild, skipupdatebuild, true, Header.email_list.BocaDevelopers)),
