...
Key1a	:= BUILDINDEX(did_records,,'~thor_data400::key::moxie.eq_header.did.key',moxie,overwrite);
...
Key1b	:= BUILDINDEX(ssn_records,{ssn,fname,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.ssn.fname.key',moxie,overwrite);
...
Key1c	:= BUILDINDEX(st_lfmname_recs,{lfmname,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.lfmname.key',moxie,overwrite);
Key1d	:= BUILDINDEX(st_lfmname_recs,{st,lfmname,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.st.lfmname.key',moxie,overwrite);
Key1e	:= BUILDINDEX(st_lfmname_recs,{zip,lfmname,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.zip.lfmname.key',moxie,overwrite);
Key1f	:= BUILDINDEX(st_lfmname_recs,{phone7,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.phone7.key',moxie,overwrite);
Key1g	:= BUILDINDEX(st_lfmname_recs,{st,phone7,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.st.phone7.key',moxie,overwrite);
Key1h	:= BUILDINDEX(st_lfmname_recs,{phone7,area_code,st,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.phone7.area_code.st.key',moxie,overwrite);
Key1l	:= BUILDINDEX(st_lfmname_recs,{ssn5,lfmname,(big_endian unsigned8 )__filepos},'~thor_data400::key::moxie.eq_header.ssn5.lfmname.key',moxie,overwrite);

export moxie_quick_header_keys_Part_1 :=
  parallel(
			   Key1a
			  ,Key1b
			  ,Key1c
