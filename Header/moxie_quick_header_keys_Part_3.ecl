...
Key3c	:= BUILDINDEX(dob_duped,{dob_year,dob_month,dph_lname,lfmname,(big_endian unsigned8 )__filepos},
		   '~thor_data400::key::moxie.eq_header.dob_year.dob_month.dph_lname.lfmname.key',moxie,overwrite);

//Key #15
Key3d	:= BUILDINDEX(dob_duped,{st,dob_year,dob_month,dph_lname,lfmname,(big_endian unsigned8 )__filepos},
		   '~thor_data400::key::moxie.eq_header.st.dob_year.dob_month.dph_lname.lfmname.key',moxie,overwrite);
...
Key3b	:= BUILDINDEX(key_10_records,,'~thor_data400::key::moxie.eq_header.zip.street_name.prim_range.lfmname.ssn.key',moxie,overwrite);
...
//Key #16
Key3e	:= BUILDINDEX(short_ssn_records,,'~thor_data400::key::moxie.eq_header.ssn4.lfmname.key',moxie,overwrite);

export moxie_quick_header_keys_Part_3 :=
  parallel(
			  Key3b
			  ,Key3c
			  ,Key3d
