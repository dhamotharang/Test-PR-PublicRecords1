string_rec := record
	...
	string1     src;
	string1     src2;
	//Changed so that the layout matches the layout that the file was written with
	//string2     src;
...
export file_eq_out_plus := dataset('~thor_data400::out::eq_header',string_rec,flat);