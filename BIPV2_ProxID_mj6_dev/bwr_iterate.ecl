...
#workunit('name','BIPV2_ProxID_mj6_dev.BWR_Iterate - Internal Linking - SALT V3.0 B1');
IMPORT BIPV2_ProxID_mj6_dev,SALT30;
IMPORT SALTTOOLS30;
//BIPV2_ProxID_mj6_dev.Specificities(BIPV2_ProxID_mj6_dev.In_DOT_Base).Build; // Used to create callibration keys
...
P := BIPV2_ProxID_mj6_dev.Proc_Iterate('1'); // Change '1' for later iterations
...
//SALT30.MAC_MatchSamplePatterns(BIPV2_ProxID_mj6_dev.Keys(BIPV2_ProxID_mj6_dev.In_DOT_Base).MatchSample,MatchPatterns,Proxid1,Proxid2,8,35-41);
...
//ConfThreshold:=38;
//ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_ProxID_mj6_dev.Keys(BIPV2_ProxID_mj6_dev.In_DOT_Base).MatchSample,BIPV2_ProxID_mj6_dev.Keys(BIPV2_ProxID_mj6_dev.In_DOT_Base).Candidates,BIPV2_ProxID_mj6_dev.In_DOT_Base,Proxid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
