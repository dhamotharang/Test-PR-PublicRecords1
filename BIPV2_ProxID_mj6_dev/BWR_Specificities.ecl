...
#workunit('name','BIPV2_ProxID_mj6_dev.BWR_Specificities - Specificities - SALT V3.0 B1');
IMPORT BIPV2_ProxID_mj6_dev,SALT30;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_ProxID_mj6_dev.specificities(BIPV2_ProxID_mj6_dev.In_DOT_Base);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_ProxID_mj6_dev.<your_spc_attribute>',BIPV2_ProxID_mj6_dev.In_DOT_Base);
