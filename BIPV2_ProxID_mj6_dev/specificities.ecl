...
EXPORT input_file := h0 : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have Proxid specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.Proxid;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,Proxid,LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::Cluster_Sizes',EXPIRE(Config.PersistExpire));
EXPORT TotalClusters := COUNT(ClusterSizes);
 
SHARED  cnp_name_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,cnp_name) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::cnp_name',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  cnp_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,cnp_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::cnp_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  active_duns_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_duns_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::active_duns_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  active_enterprise_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_enterprise_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::active_enterprise_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  active_domestic_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,active_domestic_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::active_domestic_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  hist_enterprise_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_enterprise_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::hist_enterprise_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  hist_duns_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_duns_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::hist_duns_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  hist_domestic_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,hist_domestic_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::hist_domestic_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  foreign_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,foreign_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::foreign_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  unk_corp_key_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,unk_corp_key) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::unk_corp_key',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  ebr_file_number_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,ebr_file_number) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::ebr_file_number',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  company_fein_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_fein) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::company_fein',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  company_phone_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_phone) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::company_phone',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  prim_range_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,prim_range) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::prim_range',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  prim_name_derived_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,prim_name_derived) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::prim_name_derived',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  sec_range_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,sec_range) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::sec_range',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  v_city_name_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,v_city_name) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::v_city_name',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  st_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,st) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::st',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  zip_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,zip) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::zip',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  company_csz_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_csz) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::company_csz',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  company_addr1_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_addr1) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::company_addr1',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
SHARED  company_address_deduped := SALT30.MAC_Field_By_UID(input_file,Proxid,company_address) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::dedups::company_address',EXPIRE(Config.PersistExpire)); // Reduce to field values by UID
...
EXPORT cnp_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::cnp_name';
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::cnp_number';
...
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::active_duns_number';
...
EXPORT active_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::active_enterprise_number';
...
EXPORT active_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::active_domestic_corp_key';
...
EXPORT hist_enterprise_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::hist_enterprise_number';
...
EXPORT hist_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::hist_duns_number';
...
EXPORT hist_domestic_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::hist_domestic_corp_key';
...
EXPORT foreign_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::foreign_corp_key';
...
EXPORT unk_corp_keyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::unk_corp_key';
...
EXPORT ebr_file_numberValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::ebr_file_number';
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::company_fein';
...
EXPORT company_phoneValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::company_phone';
...
EXPORT prim_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::prim_range';
...
EXPORT prim_name_derivedValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::prim_name_derived';
...
EXPORT sec_rangeValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::sec_range';
...
EXPORT v_city_nameValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::v_city_name';
...
EXPORT stValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::st';
...
EXPORT zipValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::zip';
...
EXPORT company_cszValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::company_csz';
...
EXPORT company_addr1ValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::company_addr1';
...
EXPORT company_addressValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::company_address';
...
EXPORT company_address_specificity := ol;
  ...
  END;
  t := TABLE(infile,r);
SHARED ForeignCorpkey_attributes := DEDUP( SORT( DISTRIBUTE( t, Proxid ), Proxid, Basis, LOCAL), Proxid, Basis, LOCAL) : PERSIST('~temp::Proxid::BIPV2_ProxID_mj6_dev::values::ForeignCorpkey',EXPIRE(Config.PersistExpire));
...
EXPORT ForeignCorpkeyValuesIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Word::ForeignCorpkey';
...
EXPORT SpecIndexKeyName := '~'+'key::BIPV2_ProxID_mj6_dev::Proxid::Specificities';
