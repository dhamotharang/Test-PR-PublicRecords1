...
ATTRIBUTEFILE:ForeignCorpkey:NAMED(BIPV2_ProxID_mj6_dev.file_Foreign_Corpkey):VALUES(company_charter_number<company_inc_state):FORCE(--,ALL):IDFIELD(Proxid):20,0
*/
/*
