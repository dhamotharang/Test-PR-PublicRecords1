...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_date_type_cd','invalid_date_type_desc','invalid_filing_type_cd');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_date_type_cd' => 8,'invalid_date_type_desc' => 9,'invalid_filing_type_cd' => 10,0);
...
EXPORT MakeFT_invalid_date_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['FIL','MERG']);
EXPORT InValidMessageFT_invalid_date_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('FIL|MERG'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_date_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_date_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['FILING','MERGER']);
EXPORT InValidMessageFT_invalid_date_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('FILING|MERGER'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_filing_type_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_type_cd(SALT32.StrType s) := WHICH(~Scrubs_Corp2_Mapping_VA_Event.Functions.ValidEventFilingTypeCD(s)>0);
EXPORT InValidMessageFT_invalid_filing_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_VA_Event.Functions.ValidEventFilingTypeCD'),SALT32.HygieneErrors.Good);
...
EXPORT Make_event_filing_date(SALT32.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_event_filing_date(SALT32.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_event_filing_cd(SALT32.StrType s0) := MakeFT_invalid_filing_type_cd(s0);
EXPORT InValid_event_filing_cd(SALT32.StrType s) := InValidFT_invalid_filing_type_cd(s);
EXPORT InValidMessage_event_filing_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_type_cd(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_VA_Event;
