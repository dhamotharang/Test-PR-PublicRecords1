export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1 	:= '(NONE *(SAME *AS  *ABOVE)|^SAME$|^SAME | SAME |^XX|SEE DOCUMENT|NONE PROVIDED|NONE  *GIVEN.*|UNDER  *NONE|^NONE$|^NONE | NONE |UNKNOWN)';
	...
	export LastName := module
		...
		shared PatternInvalidWords1		:= 'NONE SHOWN|SAME AS ABOVE|^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |UNKNOWN';
		export InvalidWords						:= PatternInvalidWords1;
	end;
