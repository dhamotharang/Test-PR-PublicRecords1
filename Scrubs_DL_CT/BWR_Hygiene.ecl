...
#workunit('name','Scrubs_DL_CT.BWR_Hygiene - Hygiene & Stats - SALT V3.11.7');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'Layout_In_CT'),NAMED('OptimizedLayout'));// File layout suggested by data
