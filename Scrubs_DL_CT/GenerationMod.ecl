...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_alphanum_sp:ALLOW( 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ/)\n'
    ...
    + 'FIELDTYPE:invalid_endorsements:ENUM(A|AP|F|FM|FNP|FNPT|FP|M|MN|MNPS|MNPST|MNT|MPV|MQ|MT|MV|N|NP|NPT|NPV|NT|P|PS|PSTX|PV|Q|T|V|X|)\n'
    + 'FIELDTYPE:invalid_restrictions:ENUM(B|M|BM|CE|LN|K|LM|E|N|KM|BKM|BCE|)\n'
    ...
    + 'FIELD:lastname:TYPE(STRING16):LIKE(invalid_name):0,0\n'
    + 'FIELD:firstname:TYPE(STRING14):0,0\n'
    + 'FIELD:middleinitial:TYPE(STRING1):0,0\n'
    ...
    + 'FIELD:resiaddrstreet:TYPE(STRING35):LIKE(invalid_alphanum_sp):0,0\n'
    + 'FIELD:residencycity:TYPE(STRING20):LIKE(invalid_alpha_blank):0,0\n'
    + 'FIELD:residencystate:TYPE(STRING2):LIKE(invalid_state):0,0\n'
    + 'FIELD:residencyzip:TYPE(STRING9):LIKE(invalid_zip):0,0\n'
    + 'FIELD:mailaddrstreet:TYPE(STRING35):LIKE(invalid_alphanum_sp):0,0\n'
    + 'FIELD:mailingcity:TYPE(STRING20):LIKE(invalid_alpha_blank):0,0\n'
