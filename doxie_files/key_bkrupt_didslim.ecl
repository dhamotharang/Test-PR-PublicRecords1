...
export key_bkrupt_didslim := index(dedp_f,{unsigned6 s_did := (unsigned)debtor_did}, {court_code, case_number}, '~thor_Data400::key::bankrupt_didslim_' + doxie.Version_SuperKey);