...
export Key_Bocashell_Liens_and_Evictions := index(liens_and_evictions_slimmed, {did}, {liens_and_evictions_slimmed}, '~thor_data400::key::liensv2::bocashell_liens_and_evictions_did_' + doxie.Version_SuperKey);