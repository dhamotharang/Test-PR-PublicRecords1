...
EXPORT parser_netacuity := MODULE
    ...
    EXPORT NetAcuityOptOuts(DATASET(riskwise.Layout_IPAI) input_ds, Doxie.IDataAccess mod_access) := FUNCTION
        ...
        suppressed_ds := Suppress.MAC_SuppressSource(ds_with_sourceid, mod_access);
