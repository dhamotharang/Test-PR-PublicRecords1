//Last known applicable WUID is W20060810-155626
...
output(min_date_stats(orig_state='ID'),NAMED('ID_Min_Dates'),all);
output(max_date_stats(orig_state='ID'),NAMED('ID_Max_Dates'),all);

output(min_date_stats(orig_state='KY'),NAMED('KY_Min_Dates'),all);
output(max_date_stats(orig_state='KY'),NAMED('KY_Max_Dates'),all);

output(min_date_stats(orig_state='MN'),NAMED('MN_Min_Dates'),all);
output(max_date_stats(orig_state='MN'),NAMED('MN_Max_Dates'),all);

output(min_date_stats(orig_state='MO'),NAMED('MO_Min_Dates'),all);
output(max_date_stats(orig_state='MO'),NAMED('MO_Max_Dates'),all);

output(min_date_stats(orig_state='MS'),NAMED('MS_Min_Dates'),all);
output(max_date_stats(orig_state='MS'),NAMED('MS_Max_Dates'),all);

output(min_date_stats(orig_state='MT'),NAMED('MT_Min_Dates'),all);
output(max_date_stats(orig_state='MT'),NAMED('MT_Max_Dates'),all);

output(min_date_stats(orig_state='ND'),NAMED('ND_Min_Dates'),all);
output(max_date_stats(orig_state='ND'),NAMED('ND_Max_Dates'),all);

output(min_date_stats(orig_state='NE'),NAMED('NE_Min_Dates'),all);
output(max_date_stats(orig_state='NE'),NAMED('NE_Max_Dates'),all);

output(min_date_stats(orig_state='NM'),NAMED('NM_Min_Dates'),all);
output(max_date_stats(orig_state='NM'),NAMED('NM_Max_Dates'),all);
