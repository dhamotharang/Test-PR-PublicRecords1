IMPORT BIPV2, BIPV2_Best, BIPV2_Build, BIPV2_Company_Names, BusinessBatch_BIP,
...
EXPORT GetCorps(DATASET(BusinessBatch_BIP.Layouts.LinkIdsWithAcctNo) dLinkIDsWithAcctNo,                  								   
  ...
  FUNCTION
    ...
    dContactsMark := 
      BIPV2_Build.key_contact_linkids.kFetchMarketing(dLinkIds,BIPV2.IDconstants.Fetch_Level_SELEID);
