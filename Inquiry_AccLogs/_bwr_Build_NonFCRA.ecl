#WORKUNIT('name','Launch - Inquiry NonFCRA Weekly');
#OPTION('multiplePersistInstances',true)



/* This attribute launches a soapcall that will run once a day for - Inquiry NonFCRA Weekly;
...
lECL 	:=	'inquiry_acclogs.ProcBuildHistoryKeys() : FAILURE(fileservices.sendemail(\'Jose.Bello@lexisnexis.com,Sudhir.Kasavajjala@lexisnexis.com, cecelie.guyton@lexisnexis.com,john.freibaum@lexisnexis.com, Jenny.Huang@lexisnexis.com, Wenhong.Ma@lexisnexis.com, Randy.Reyes@lexisnexis.com\', \'FAILURE - Inquiry NonFCRA Weekly \' + WORKUNIT,\'Please review and/or restart on prod thor\'));';

fSubmitNewWorkunit(lECL, 'thor400_20') : WHEN(CRON('0 15 * * 7')); //run around noon on sunday. no earlier.
