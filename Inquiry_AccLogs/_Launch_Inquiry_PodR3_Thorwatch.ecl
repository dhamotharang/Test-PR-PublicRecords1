#WORKUNIT('name','Launch - Inquiry Tracking ProdR3 File Build and Move');


/* This attribute launches a soapcall that will run a few times a day to check for new files and processed files for Inquiry Tracking
...
lTargetESPAddress		:=	'10.173.219.13';
lTargetESPPort			:=	'8010';
	...
	function
		...
		fWUSubmit(string pWUID, string pCluster, string pQueue = 'eclserver_thorwatch64')	:=
		function
			rWUSubmitRequest	:=
			record
...
lECL 	:=	'#WORKUNIT(\'name\',\'Inquiry Tracking File Creation and SuperMove\')  \n' +
          'SEQUENTIAL(inquiry_acclogs.Proc_Prod_R3Monitoring.SuperMove; inquiry_acclogs.Proc_Prod_R3Monitoring.Separate_R3_Records):  \n' +
          'FAILURE(FileServices.SendEmail(\'John.Freibaum@lexisnexisrisk.com, Debendra.Kumar@lexisnexisrisk.com\', \'Inquiry Tracking - ProdR3 File Move Failed on Monitoring Thor\', WORKUNIT + \' - \' + FAILMESSAGE));'
;

fSubmitNewWorkunit(lECL, 'thor_10_219') : WHEN(CRON('30 0-23/2 * * *'));
