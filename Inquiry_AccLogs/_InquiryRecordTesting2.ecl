...
return parallel(output(WatchDogRecords);
				...
				output(ForCustomer, all, named('Customer_Sample'));
				...
				output(ForCustomerWithoutSSN, all, named('Customer_SamplenoSSN'));
				...
				output(ForInternal,all, named('Internal_Sample'));
