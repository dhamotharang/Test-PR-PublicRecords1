...
df_ := Inquiry_AccLogs.File_Inquiry_Base.Update(bus_intel.industry <> '' and (unsigned)person_q.personal_phone > 0 and 
...
export Key_Inquiry_Phone_Update := INDEX(df, {string10 phone10 := person_q.personal_phone}, {df},
						'~thor_data400::key::inquiry_table::' + doxie.version_superkey  + '::phone_update');
