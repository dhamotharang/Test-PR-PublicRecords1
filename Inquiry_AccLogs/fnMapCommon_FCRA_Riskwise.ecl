...
export fnMapCommon_FCRA_Riskwise := module
...
inputfile := distribute(choosen(inquiry_acclogs.File_FCRA_Riskwise_Logs
...
inquiry_acclogs.File_MBSApp(normInputFile, 'RISKWISE', 'Y', mbs_outfile)
