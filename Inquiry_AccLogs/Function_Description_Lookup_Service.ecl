...
keyed(s_product_id=stringlib.stringtouppercase(trim(input_ProductID))) and
keyed(s_transaction_type=stringlib.stringtouppercase(trim(input_transaction_type))) and
keyed(s_function_name=stringlib.stringtouppercase(trim(input_Function_Name))) 
), 1);
