...
cid 	:= dataset(Data_Services.foreign_logs + 'thor100_21::base::inquiry::' + bdate + '::' + edate + '::cid', Inquiry_AccLogs.Layout.Common_ThorAdditions, thor, opt)
(source='BATCH' or source='ACCURINT');

nocid := dataset(Data_Services.foreign_logs + 'thor100_21::base::inquiry::'+bdate+'::'+edate+'::nocid', Inquiry_AccLogs.Layout.Common_ThorAdditions, thor, opt);
