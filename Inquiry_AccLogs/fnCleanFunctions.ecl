...
,'PROPERTY & CASUALTY'
,'PROVIDER OTHERPROVIDER SYSTEM VENDOR'
,'PUB SECT - OTHER'
,'PUBLIC SAFETY'
...
,'SM-GENERAL PAYER'
,'SM-HEALTHCARE'
,'SM-HOSPITAL & HEALTH SYSTEMS'
,'SM-LIFE SCIENCES OTHER'
,'SM-PROVIDER OTHER'
