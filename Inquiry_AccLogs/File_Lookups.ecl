...
export File_Lookups :=  module
	...
	raw_finance_table := project(dataset(Data_Services.foreign_logs + 'thor100_21::in::mbs::finance_master', Inquiry_AccLogs.Layout_MBS_Finance.update_, csv(separator('\t'), quote('"'))),
	transform(Inquiry_AccLogs.Layout_MBS_Finance.old_, //self.sub_acct_id := if(regexfind('[0-9]+', left.subaccount_id),left.subaccount_id, ''), 
 ...
 export finance_table_ := project(raw_finance_table, transform(Inquiry_AccLogs.Layout_MBS_Finance.common,
																															self.hash_company_id_finance := Inquiry_AccLogs.fnHashIDField(stringlib.stringtouppercase(if(regexfind('[a-zA-Z]', left.sub_acct_id[1..2]), 
  ...
  export finance_table := Inquiry_AccLogs.fn_patch_finance_table(finance_table_);
  ...
  export inquiry_info_appends := dataset([
	...
	// export inquiry_exceptions := dataset([{'8116091'},
																			// {'14068'},
																			// {'14868'},
																			// {'778061'},
																			// {'888401'},
