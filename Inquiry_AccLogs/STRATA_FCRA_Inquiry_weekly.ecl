...
export STRATA_FCRA_Inquiry_weekly(string filedate, boolean omit_output_to_screen = true) := function 

ds :=dataset(ut.foreign_prod+'persist::inquiry::fcra_base', inquiry_acclogs.Layout.Common_ThorAdditions_FCRA, thor);
...
tStats := table(ds,rSTRATA_Inquiry_Daily_Tracking, ds.search_info.transaction_type, search_info.function_description, few);

strata.createXMLStats(tStats,'Inquiry_Tracking_Weekly_FCRA','data',filedate,'',resultsOut,,,,,omit_output_to_screen);
return resultsOut;
end;
