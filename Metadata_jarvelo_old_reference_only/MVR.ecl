...
dVehicles := vehlic.File_Base_Vehicles_Dev(orig_state='CO');

/////////////////

rDate1WithYear := record dVehicles.orig_state;

       string8 YEAR := dVehicles.REGISTRATION_EFFECTIVE_DATE[1..8];
...
rDate2WithYear := record dVehicles.orig_state;
       ...
       string8 YEAR := dVehicles.TITLE_ISSUE_DATE[1..8];
