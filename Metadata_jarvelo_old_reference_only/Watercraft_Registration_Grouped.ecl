export Watercraft_Registration_Grouped := 'todo';
...
rDate1WithYear
 ...
 :=
      ...
      string4 YEAR := dWatercraft.registration_date[1..4];
...
output(sort(dTable1,state_origin,YEAR),all,named('registration_date'));
