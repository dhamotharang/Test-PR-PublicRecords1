IMPORT SALT311,STD;
EXPORT hygiene(dataset(layout_Cortera_Tradeline) h) := MODULE
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Cortera_Tradeline, Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
