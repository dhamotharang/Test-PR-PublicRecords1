...
EXPORT Quarantine_Test(string pversion='') := FUNCTION
	...
	orbit_summary_missing 	:= orbit_summary_rulepcnt_gt_threshold(rulepcnt>=orbit_threshold_missing and STD.Str.find(ruledesc,':POP',1)=0 and STD.Str.find(ruledesc,':SUMMARY',1)=0);
