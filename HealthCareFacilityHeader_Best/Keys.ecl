...
EXPORT SpecificitiesDebugKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::HealthCareFacilityHeader_Best::LNPID::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
EXPORT MatchHistoryKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::History::Match';
  MH := MatchHistoryFile;
...
EXPORT InDataKeyName := '~'+'key::HealthCareFacilityHeader_Best::LNPID::Datafile::in_data';
