...
#workunit('name','HealthCareFacilityHeader_Best.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT HealthCareFacilityHeader_Best,SALT30;
// First create an instantiated hygiene module
  infile := HealthCareFacilityHeader_Best.In_HealthFacility;
  h := HealthCareFacilityHeader_Best.Hygiene(infile);
  ...
  CM := HealthCareFacilityHeader_Best.Fields.UIDConsistency(HealthCareFacilityHeader_Best.In_HealthFacility);
...
//  OUTPUT(CM.RID_TwoParents,NAMED('TwoparentsRID'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,SRC,DT_FIRST_SEEN,Examples),NAMED('DT_FIRST_SEENBySRC'));
  //  OUTPUT(SALT30.MAC_CrossTab(infile,SRC,DT_LAST_SEEN,Examples),NAMED('DT_LAST_SEENBySRC'));
  //  OUTPUT(SALT30.MAC_CrossTab(infile,SRC,DT_LIC_EXPIRATION,Examples),NAMED('DT_LIC_EXPIRATIONBySRC'));
  //  OUTPUT(SALT30.MAC_CrossTab(infile,SRC,DT_DEA_EXPIRATION,Examples),NAMED('DT_DEA_EXPIRATIONBySRC'));
