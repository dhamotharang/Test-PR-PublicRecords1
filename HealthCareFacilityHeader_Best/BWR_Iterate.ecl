...
#workunit('name','HealthCareFacilityHeader_Best.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
...
P := HealthCareFacilityHeader_Best.Proc_Iterate('1'); // Change '1' for later iterations
...
SALT30.MAC_MatchSamplePatterns(HealthCareFacilityHeader_Best.Keys(HealthCareFacilityHeader_Best.In_HealthFacility).MatchSample,MatchPatterns,LNPID1,LNPID2,8,42-48);
...
ConfThreshold:=45;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(HealthCareFacilityHeader_Best.Keys(HealthCareFacilityHeader_Best.In_HealthFacility).MatchSample,HealthCareFacilityHeader_Best.Keys(HealthCareFacilityHeader_Best.In_HealthFacility).Candidates,HealthCareFacilityHeader_Best.In_HealthFacility,LNPID,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
