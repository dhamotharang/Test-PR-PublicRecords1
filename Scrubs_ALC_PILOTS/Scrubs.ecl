...
EXPORT FromNone(DATASET(Layout_ALC_PILOTS) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.cert_lvl_Invalid := Fields.InValid_cert_lvl((SALT37.StrType)le.cert_lvl);
    SELF.cert_type_Invalid := Fields.InValid_cert_type((SALT37.StrType)le.cert_type);
    SELF.cert_type_secondary_Invalid := Fields.InValid_cert_type_secondary((SALT37.StrType)le.cert_type_secondary);
    ...
    SELF.rating_Invalid := Fields.InValid_rating((SALT37.StrType)le.rating);
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT37.StrType)le.fname,(SALT37.StrType)le.lname,(SALT37.StrType)le.title,(SALT37.StrType)le.state,(SALT37.StrType)le.zip,(SALT37.StrType)le.zip4,(SALT37.StrType)le.cart,(SALT37.StrType)le.bar,(SALT37.StrType)le.gender,(SALT37.StrType)le.addr_type,(SALT37.StrType)le.cert_lvl,(SALT37.StrType)le.cert_type,(SALT37.StrType)le.cert_type_secondary,(SALT37.StrType)le.county_cd,(SALT37.StrType)le.msa,(SALT37.StrType)le.nielsen_county_cd,(SALT37.StrType)le.rating,(SALT37.StrType)le.phone,(SALT37.StrType)le.list_id,(SALT37.StrType)le.scno,(SALT37.StrType)le.custno,'***SALTBUG***');
  END;
