...
EXPORT SALT37.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_addr_type','invalid_alpha','invalid_alphanumeric','invalid_alphanumericpound','invalid_alphapound','invalid_alphaspace','invalid_alphaspacequote','invalid_gender','invalid_numeric','invalid_numericpound');
...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'fname','lname','title','company','address1','address2','city','state','zip','zip4','cart','bar','gender','country','postal_cd','dpv','addr_type','cert_lvl','cert_type','cert_type_secondary','county_cd','msa','nielsen_county_cd','rating','phone','list_id','scno','keycode','custno');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'fname' => 0,'lname' => 1,'title' => 2,'company' => 3,'address1' => 4,'address2' => 5,'city' => 6,'state' => 7,'zip' => 8,'zip4' => 9,'cart' => 10,'bar' => 11,'gender' => 12,'country' => 13,'postal_cd' => 14,'dpv' => 15,'addr_type' => 16,'cert_lvl' => 17,'cert_type' => 18,'cert_type_secondary' => 19,'county_cd' => 20,'msa' => 21,'nielsen_county_cd' => 22,'rating' => 23,'phone' => 24,'list_id' => 25,'scno' => 26,'keycode' => 27,'custno' => 28,0);
...
EXPORT Make_cert_lvl(SALT37.StrType s0) := MakeFT_invalid_alphapound(s0);
EXPORT InValid_cert_lvl(SALT37.StrType s) := InValidFT_invalid_alphapound(s);
EXPORT InValidMessage_cert_lvl(UNSIGNED1 wh) := InValidMessageFT_invalid_alphapound(wh);
 
EXPORT Make_cert_type(SALT37.StrType s0) := MakeFT_invalid_alphapound(s0);
EXPORT InValid_cert_type(SALT37.StrType s) := InValidFT_invalid_alphapound(s);
EXPORT InValidMessage_cert_type(UNSIGNED1 wh) := InValidMessageFT_invalid_alphapound(wh);
 
EXPORT Make_cert_type_secondary(SALT37.StrType s0) := MakeFT_invalid_alphanumericpound(s0);
EXPORT InValid_cert_type_secondary(SALT37.StrType s) := InValidFT_invalid_alphanumericpound(s);
...
EXPORT Make_rating(SALT37.StrType s0) := MakeFT_invalid_numericpound(s0);
EXPORT InValid_rating(SALT37.StrType s) := InValidFT_invalid_numericpound(s);
