...
Export equifax_layout:=RECORD
  ...
  unsigned4 clean_date_created;
  unsigned4 clean_extract_date;
  unsigned4 clean_record_update_refresh_date;
  unsigned4 clean_dead_date;
  unsigned4 clean_expiration_date;
  unsigned4 clean_certexp1_date;
  unsigned4 clean_certexp2_date;
  unsigned4 clean_certexp3_date;
  unsigned4 clean_certexp4_date;
  unsigned4 clean_certexp5_date;
  unsigned4 clean_certexp6_date;
  unsigned4 clean_certexp7_date;
  unsigned4 clean_certexp8_date;
  unsigned4 clean_certexp9_date;
  unsigned4 clean_certexp10_date;
  ...
  unsigned8 contact_raw_aid;
  unsigned8 contact_ace_aid;
