/*--SOAP--
  ...
  <part name="Relationship_Lookback_Months"    type="unsignedInt"/>
	<part name="Relatives_Key"            type="xsd:string"/>SecondDegreeFlag,ThirdDegreeFlag
  <part name="Second_Degree_Relationships"  type="xsd:boolean"    cols="1"  rows="1" />
  <part name="Third_Degree_Relationships"   type="xsd:boolean"    cols="1"  rows="1" />
  </message>
*/
...
EXPORT service_GetRelationship() := FUNCTION
  ...
  '<p>Returns the relatives of a given DID.</p>'
  ));
