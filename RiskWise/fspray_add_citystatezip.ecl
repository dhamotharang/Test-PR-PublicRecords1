...
return SEQUENTIAL(
FileServices.SprayFixed(_control.IPAddress.bctlpedata11,'/data/data_build_1/citystatezip/data/'+filedate+'/ctystate.txt',129,'thor400_44','~thor_data400::in::usps::'+filedate+'::citystatezip',-1,,,true,true,true);
