...
/* **********************************************
   ...
   **********************************************/
	...
	Industry_Search := Inquiry_AccLogs.Key_Inquiry_industry_use_vertical(FALSE)(s_company_id = CompanyID and s_product_id = (String)Risk_Reporting.ProductID.RiskWise__RiskWiseMainIT1O);
/* ************* End Scout Fields **************/
...
Deltabase_Logging_prep := project(final, transform(Risk_Reporting.Layouts.LOG_Deltabase_Layout_Record,
																								 ...
																								 self.o_score_1    := map(map_score1 = 1 => (Integer)left.score,
																																					...
																																					map_score1 = 3 => (Integer)left.score3,
																																														0),
