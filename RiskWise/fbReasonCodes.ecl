...
export fbReasonCodes( layout, cnt, OFAC, inCalif, employ_months, appl_income ) := MACRO

CHOOSEN(
	IF(inCalif, DATASET([{'35',risk_indicators.getHRIDesc('35')}],risk_indicators.Layout_Desc)) &
	IF(inCalif, DATASET([{'00',''},{'00',''},{'00',''},{'00',''},{'00',''}],risk_indicators.Layout_Desc)) &
	...
	IF(Risk_Indicators.rcSet.isCodeU1(appl_income, 2100), DATASET([{'U1',risk_indicators.getHRIDesc('U1')}],risk_indicators.Layout_Desc)) &
	...
	IF(Risk_Indicators.rcSet.isCodeU2(employ_months, 12), DATASET([{'U2',risk_indicators.getHRIDesc('U2')}],risk_indicators.Layout_Desc)) &
