...
//--
  ...
  export gw_delta_prod := dataset( [{'delta_inquiry','http://delta_iid_api_user:2rch%40p1$$@10.176.69.151:7909/WsDeltaBase/preparedsql'}], risk_indicators.layout_gateways_in );
	export gw_threatmetrix := dataset([{'threatmetrix_test', 'https://rw_score_dev:Password01@espcertvip.risk.regn.net:7426/WsGatewayEx/?ver_=2.28'}], Risk_Indicators.Layout_Gateways_In);
	export gw_insurancephoneheader := dataset([{'insurancephoneheader','https://api_prod_gw_roxie:g0h3%40t2x@espprodvip.risk.regn.net:7726/WsGatewayEx/?ver_=1.87'}], risk_indicators.Layout_Gateways_In);
