...
/* **********************************************
   ...
   **********************************************/
	...
	Industry_Search := Inquiry_AccLogs.Key_Inquiry_industry_use_vertical(FALSE)(s_company_id = CompanyID and s_product_id = (String)Risk_Reporting.ProductID.RiskWise__RiskWiseMainPRIO);
/* ************* End Scout Fields **************/
...
Deltabase_Logging_prep := project(finalAnswer, transform(Risk_Reporting.Layouts.LOG_Deltabase_Layout_Record,
																								 ...
																								 self.o_score_1  := (Integer)left.frdriskscore,
																								 self.o_score_2  := (Integer)left.estincome,
