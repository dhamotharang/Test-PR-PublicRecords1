...
export cdReasonCodesCon( /*Risk_Indicators.Layout_Output*/ layout, cnt, ip_eddo, billTo, IBICID ) := MACRO
...
CHOOSEN(
	...
	// there is no workphone on shipto but I will return anyway for no apparent reason
