// this set is the replace for fdReasoncodesWith38 in st. cloud.  gets called by the sdbo product family
export Bus_fdReasoncodes (layout, cnt, OFAC) := MACRO
...
CHOOSEN(
	...
	IF(Risk_Indicators.rcSet.isCode38(layout.altlast, layout.socscount, layout.lastcount, layout.altlast2, layout.correctlast<>''),
	...
	IF(Risk_Indicators.rcSet.isCode34(layout.combo_lastcount, layout.combo_addrcount, layout.combo_hphonecount, layout.combo_ssncount, layout.phone10, layout.ssn),
	...
	IF(Risk_Indicators.rcSet.isCode11(layout.addrvalflag, layout.in_streetAddress, layout.in_city, layout.in_state, layout.in_zipCode),
	...
	IF(Risk_Indicators.rcSet.isCode01(layout.fname, layout.lname, layout.ssn, layout.phone10, layout.in_streetAddress),
	...
	IF(Risk_Indicators.rcSet.isCode43(layout.bansflag, layout.firstcount, layout.lastcount, layout.addrcount),
			DATASET([{'43',risk_indicators.getHRIDesc('43')}],risk_indicators.Layout_Desc)) &				    
