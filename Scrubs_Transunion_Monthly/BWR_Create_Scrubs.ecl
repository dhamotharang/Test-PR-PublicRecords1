// create folder "Scrubs_Transunion_Monthly"
// Add thie BWR_Create_Scrubs
// Create "In_File"
...
// create orbit probile prior to submit the report (you can use the output of default profile rules (W20160126-131838)
IMPORT SALT32;
#WORKUNIT('name','PersonHeader Scrubs_Transunion_Monthly');
#OPTION('multiplePersistInstances',FALSE);
// ********************************************************************************************
// Configuration																		<-- STEP 0 (setup only)
IMPORT Scrubs_Transunion_Monthly as S;
F := Scrubs_Transunion_Monthly.In_File: independent;		// input file
o := 'Scrubs_Transunion_Monthly';		// orbit profile
v := '20160407';									// orbit report version (for submission)
// ********************************************************************************************
// Generates default specification file            	<-- STEP 1 (setup only)
SALT32.MAC_Default_SPC(F, output_spc); 
gen_init_spec_file := output(choosen(output_spc,500)); // W20160405-153845
// ********************************************************************************************
...
p := h.allprofiles;
gen_hyg_report := sequential(                // W20160405-155442
