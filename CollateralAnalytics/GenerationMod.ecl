...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,global_sid,process_date,date_first_seen,date_last_seen,date_vendor_first_reported,date_vendor_last_reported,ca_id,mls_geo_full_address,mls_geo_city,mls_geo_state,mls_geo_zip_code,ca_assessed_improvements,ca_assessed_land,ca_assessed_val,ca_assessment_perc_replacement_value,ca_avm_high,ca_avm_low,ca_avm_value,ca_building_percent,ca_fsd_score,ca_land_price_implied_replacement_value,ca_market_condition,ca_most_recent_loan,ca_most_recent_sale_price,ca_original_loan_1st_loan_amt,ca_original_purchase_loan_amt,ca_original_purchase_loan_date,ca_refi_1st_loan_amt,ca_refi_date,ca_sold_date_1,ca_sold_price_1,mls_air_conditioning_type,mls_air_conditioning_code,mls_apn,mls_bath_total,mls_baths_full,mls_baths_partial,mls_bedrooms,mls_block_number,mls_building_square_footage,mls_construction_type,mls_construction_code,mls_dom,mls_exterior_wall_type,mls_exterior_wall_code,mls_fireplace_type,mls_fireplace_code,mls_fireplace_yn,mls_first_floor_square_footage,mls_flood_zone_panel,mls_floor_type,mls_floor_code,mls_foundation,mls_fuel_type,mls_fuel_code,mls_garage,mls_geo_county,mls_geo_fips,mls_geo_lat,mls_geo_lon,mls_heating,mls_interest_rate_type_code,mls_list_date_1,mls_list_dt,mls_list_price,mls_list_price_1,mls_living_area,mls_loan_amount,mls_loan_type_code,mls_lot_depth_footage,mls_lot_number,mls_lot_size,mls_lot_size_acre,mls_mortgage_company_name,mls_nbr_stories,mls_neighborhood,mls_number_of_bath_fixtures,mls_number_of_fireplaces,mls_number_of_rooms,mls_number_of_units,mls_parking_type,mls_parking_code,mls_pool_type,mls_pool_code,mls_pool_yn,mls_prop_style,mls_property_condition,mls_property_type,mls_property_code,mls_roof_cover,mls_sale_date_pr,mls_sale_price_pr,mls_sale_type_code,mls_second_loan_amount,mls_sewer,mls_sold_date,mls_sold_price,mls_tax_amount,mls_tax_year,mls_water,mls_year_built,mls_zoning,mls_remarks,rawaid,prim_range,predir,prim_name,addr_suffix,postdir,unit_desig,sec_range,p_city_name,v_city_name,st,zip,zip4,cart,cr_sort_sz,lot,lot_order,dbpc,chk_digit,rec_type,county,geo_lat,geo_long,msa,geo_blk,geo_match,err_stat';
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:mls_geo_full_address:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_geo_city:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_geo_state:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_geo_zip_code:DERIVED:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:mls_air_conditioning_code:DERIVED:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:mls_construction_code:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_dom:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_exterior_wall_type:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_exterior_wall_code:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_fireplace_type:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_fireplace_code:DERIVED:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:mls_floor_code:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_foundation:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_fuel_type:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_fuel_code:DERIVED:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:mls_parking_code:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_pool_type:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:mls_pool_code:DERIVED:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:mls_property_code:DERIVED:TYPE(STRING):0,0\n'
