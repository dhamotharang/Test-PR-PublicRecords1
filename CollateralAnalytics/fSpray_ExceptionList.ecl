...
FilesToSpray := DATASET([
		...
		//	
		{
			...
			pFilename,
			0, 																				//	record_size
			CollateralAnalytics.Filenames(pVersionDate).exceptioninput.new(pVersionDate),	//	Thor_filename_template
			[ {CollateralAnalytics.Filenames(pVersionDate).exceptioninput.sprayed	}	],		//	dSuperfilenames
