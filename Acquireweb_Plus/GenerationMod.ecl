...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Acquireweb_Plus';
  ...
  EXPORT spc_FILENAME := 'Acquireweb_Business';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:RCID';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,awid,firstname,lastname,title,companyname,address1,address2,city,state,zip,zip4,emailid,email,ipaddress,did,did_score,aid,clean_title,clean_fname,clean_mname,clean_lname,clean_name_suffix,clean_cname,clean_prim_range,clean_predir,clean_prim_name,clean_addr_suffix,clean_postdir,clean_unit_desig,clean_sec_range,clean_p_city_name,clean_v_city_name,clean_st,clean_zip,clean_zip4,clean_cart,clean_cr_sort_sz,clean_lot,clean_lot_order,clean_dbpc,clean_chk_digit,clean_rec_type,clean_county,clean_geo_lat,clean_geo_long,clean_msa,clean_geo_blk,clean_geo_match,clean_err_stat,date_first_seen,date_last_seen,date_vendor_first_reported,date_vendor_last_reported,current_rec,source,dotid,dotscore,dotweight,empid,empscore,empweight,powid,powscore,powweight,proxid,proxscore,proxweight,seleid,selescore,seleweight,orgid,orgscore,orgweight,ultid,ultscore,ultweight';
  ...
  EXPORT spcString :=
    '//SALT:  _SPC;\n'
    + 'OPTIONS:-gn\n'
    + 'MODULE:Acquireweb_Plus\n'
    + 'FILENAME:Acquireweb_Business\n'
    + '\n'
    + '//IDFIELD:EXISTS:AWID\n'
    + 'RIDFIELD:RCID:GENERATE\n'
    + 'INGESTFILE:Business_update:NAMED(Acquireweb_Plus.prep_business_ingest)\n'
    + '\n'
    + 'FIELD:awid:TYPE(STRING):0,0\n'
    + 'FIELD:firstname:TYPE(STRING):0,0\n'
    + 'FIELD:lastname:TYPE(STRING):0,0\n'
    + 'FIELD:title:DERIVED:TYPE(STRING):0,0\n'
    + 'FIELD:companyname:TYPE(STRING):0,0\n'
    ...
    + 'FIELD:source:DERIVED:TYPE(STRING):0,0\n'
