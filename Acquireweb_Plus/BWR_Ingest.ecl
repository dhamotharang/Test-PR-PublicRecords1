...
#workunit('name','Acquireweb_Plus.BWR_Ingest - Ingest - SALT V3.11.4');
IMPORT Acquireweb_Plus,SALT311;
//If you are not ingesting as part of a header build you can use the below;
//Set incremental to TRUE to run an incremental ingest mode
MyDelta := DATASET([],Acquireweb_Plus.Layout_Acquireweb_Business);
ingestMod := Acquireweb_Plus.Ingest(FALSE, MyDelta);
f_AllRecords := '~temp::RCID::Acquireweb_Plus::ingest::AllRecords';
f_ActiveRecords := '~temp::RCID::Acquireweb_Plus::ingest::ActiveRecords';
