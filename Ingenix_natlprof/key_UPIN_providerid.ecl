...
file_in := ingenix_natlprof.File_in_ProviderUPIN;
...
export key_UPIN_providerid := index(sort_id_base, 
                                {unsigned6 l_providerid := (unsigned6)providerid},{sort_id_base},
				            data_services.data_location.prefix() + 'thor_data400::key::ingenix_UPIN_providerid_' + Doxie.Version_SuperKey);
