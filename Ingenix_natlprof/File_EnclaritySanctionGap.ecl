...
fAppendLnpid(DATASET(MyNewLayout) pDataset) := FUNCTION
...
dsAppendLnpid := fAppendLnpid(newFile) : PERSIST('~thor400_data::persist::INGENIXSanctionGap_with_LNPID');

//Need LNPID Key
//Need AutoKeys
//Need Business Name Key
//Need Tin Key 
//Need License Number + License State Key

EXPORT File_EnclaritySanctionGap := dsAppendLnpid;