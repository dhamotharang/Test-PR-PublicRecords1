...
output(choosen(counts, 500)) : persist('persist::coverage::oshair::counts');
...
output(choosen(stat, 500)) : persist('persist::coverage::oshair::stat');
///////////////////////////////////////////////////////////////////////////////////////////////
layout_stdev := record
// stat.source_file;
stat.state_origin;
...
output(choosen(p_stat, 500)) : persist('persist::coverage::oshair::p_stat');
///////////////////////////////////////////////////////////////////////////////////////////////
layout_ctRec :=  record
// stat.source_file;
stat.state_origin;
...
output(choosen(ctRecstat, 500)) : persist('persist::coverage::oshair::ctRecStat');
...
output(choosen(statOut2, 500)) : persist('persist::coverage::oshair::statOut2');
...
output(choosen(sumSquared, 500)) : persist('persist::coverage::oshair::SumSquared');
...
output(choosen(statout3, 500)) : persist('persist::coverage::oshair::statOut3');
...
stdev := sort(table(f_statout3,layout_startDate,state_origin,few),state_origin);
output(choosen(stdev, 500)) : persist('persist::coverage::oshair::stDev');