...
SALT33.mac_prop_field(with_props(cnp_name NOT IN SET(s.nulls_cnp_name,cnp_name)),cnp_name,DOTid,cnp_name_props); // For every DID find the best FULL cnp_name
SHARED ForeignCorpkey_prop1 := JOIN(ForeignCorpkey_prop0,cnp_name_props,left.DOTid=right.DOTid,LOCAL);
 
SALT33.mac_prop_field(with_props(corp_legal_name NOT IN SET(s.nulls_corp_legal_name,corp_legal_name)),corp_legal_name,DOTid,corp_legal_name_props); // For every DID find the best FULL corp_legal_name
...
SALT33.mac_prop_field(with_props(cnp_number NOT IN SET(s.nulls_cnp_number,cnp_number)),cnp_number,DOTid,cnp_number_props); // For every DID find the best FULL cnp_number
SHARED ForeignCorpkey_prop3 := JOIN(ForeignCorpkey_prop2,cnp_number_props,left.DOTid=right.DOTid,LEFT OUTER,LOCAL);
 
SALT33.mac_prop_field(with_props(cnp_btype NOT IN SET(s.nulls_cnp_btype,cnp_btype)),cnp_btype,DOTid,cnp_btype_props); // For every DID find the best FULL cnp_btype
...
SALT33.mac_prop_field(with_props(company_fein NOT IN SET(s.nulls_company_fein,company_fein)),company_fein,DOTid,company_fein_props); // For every DID find the best FULL company_fein
...
SALT33.mac_prop_field(with_props(active_duns_number NOT IN SET(s.nulls_active_duns_number,active_duns_number)),active_duns_number,DOTid,active_duns_number_props); // For every DID find the best FULL active_duns_number
...
SALT33.mac_prop_field(with_props(active_enterprise_number NOT IN SET(s.nulls_active_enterprise_number,active_enterprise_number)),active_enterprise_number,DOTid,active_enterprise_number_props); // For every DID find the best FULL active_enterprise_number
...
SALT33.mac_prop_field(with_props(active_domestic_corp_key NOT IN SET(s.nulls_active_domestic_corp_key,active_domestic_corp_key)),active_domestic_corp_key,DOTid,active_domestic_corp_key_props); // For every DID find the best FULL active_domestic_corp_key
...
SALT33.mac_prop_field(with_props(prim_range NOT IN SET(s.nulls_prim_range,prim_range)),prim_range,DOTid,prim_range_props); // For every DID find the best FULL prim_range
...
SALT33.mac_prop_field(with_props(prim_name NOT IN SET(s.nulls_prim_name,prim_name)),prim_name,DOTid,prim_name_props); // For every DID find the best FULL prim_name
...
SALT33.mac_prop_field(with_props(sec_range NOT IN SET(s.nulls_sec_range,sec_range)),sec_range,DOTid,sec_range_props); // For every DID find the best FULL sec_range
...
SALT33.mac_prop_field(with_props(st NOT IN SET(s.nulls_st,st)),st,DOTid,st_props); // For every DID find the best FULL st
SHARED ForeignCorpkey_prop10 := JOIN(ForeignCorpkey_prop9,st_props,left.DOTid=right.DOTid,LOCAL);
 
SALT33.mac_prop_field(with_props(isContact NOT IN SET(s.nulls_isContact,isContact)),isContact,DOTid,isContact_props); // For every DID find the best FULL isContact
SHARED ForeignCorpkey_prop11 := JOIN(ForeignCorpkey_prop10,isContact_props,left.DOTid=right.DOTid,LEFT OUTER,LOCAL);
 
SALT33.mac_prop_field_init(with_props(fname NOT IN SET(s.nulls_fname,fname)),fname,DOTid,fname_props); // For every DID find the best FULL fname
SHARED ForeignCorpkey_prop12 := JOIN(ForeignCorpkey_prop11,fname_props,left.DOTid=right.DOTid,LOCAL);
 
SALT33.mac_prop_field_init(with_props(mname NOT IN SET(s.nulls_mname,mname)),mname,DOTid,mname_props); // For every DID find the best FULL mname
...
SALT33.mac_prop_field(with_props(lname NOT IN SET(s.nulls_lname,lname)),lname,DOTid,lname_props); // For every DID find the best FULL lname
SHARED ForeignCorpkey_prop14 := JOIN(ForeignCorpkey_prop13,lname_props,left.DOTid=right.DOTid,LOCAL);
 
SALT33.mac_prop_field(with_props(name_suffix NOT IN SET(s.nulls_name_suffix,name_suffix)),name_suffix,DOTid,name_suffix_props); // For every DID find the best FULL name_suffix
...
pj28 do_computes(pj28 le) := TRANSFORM
  ...
  SELF := le;
END;
SHARED propogated := PROJECT(pj28,do_computes(left)) : PERSIST('~temp::DOTid::BIPV2_DOTID::mc_props::DOT',EXPIRE(Config.PersistExpire)); // to allow to 'jump' over an exported value
...
layout_candidates add_name_suffix(layout_candidates le,Specificities(ih).name_suffix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j20,s.nulls_name_suffix,Specificities(ih).name_suffix_values_persisted,name_suffix,name_suffix_weight100,add_name_suffix,j19);
layout_candidates add_fname(layout_candidates le,Specificities(ih).fname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j19,s.nulls_fname,Specificities(ih).fname_values_persisted,fname,fname_weight100,add_fname,j18);
layout_candidates add_mname(layout_candidates le,Specificities(ih).mname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j18,s.nulls_mname,Specificities(ih).mname_values_persisted,mname,mname_weight100,add_mname,j17);
layout_candidates add_lname(layout_candidates le,Specificities(ih).lname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j17,s.nulls_lname,Specificities(ih).lname_values_persisted,lname,lname_weight100,add_lname,j16);
layout_candidates add_v_city_name(layout_candidates le,Specificities(ih).v_city_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j16,s.nulls_v_city_name,Specificities(ih).v_city_name_values_persisted,v_city_name,v_city_name_weight100,add_v_city_name,j15);
layout_candidates add_sec_range(layout_candidates le,Specificities(ih).sec_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j15,s.nulls_sec_range,Specificities(ih).sec_range_values_persisted,sec_range,sec_range_weight100,add_sec_range,j14);
...
layout_candidates add_csz(layout_candidates le,Specificities(ih).csz_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j13,s.nulls_csz,Specificities(ih).csz_values_persisted,csz,csz_weight100,add_csz,j12);
layout_candidates add_zip(layout_candidates le,Specificities(ih).zip_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j12,s.nulls_zip,Specificities(ih).zip_values_persisted,zip,zip_weight100,add_zip,j11);
layout_candidates add_cnp_number(layout_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j11,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_cnp_number,j10);
layout_candidates add_prim_name(layout_candidates le,Specificities(ih).prim_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j10,s.nulls_prim_name,Specificities(ih).prim_name_values_persisted,prim_name,prim_name_weight100,add_prim_name,j9);
layout_candidates add_addr1(layout_candidates le,Specificities(ih).addr1_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j9,s.nulls_addr1,Specificities(ih).addr1_values_persisted,addr1,addr1_weight100,add_addr1,j8);
layout_candidates add_active_duns_number(layout_candidates le,Specificities(ih).active_duns_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j8,s.nulls_active_duns_number,Specificities(ih).active_duns_number_values_persisted,active_duns_number,active_duns_number_weight100,add_active_duns_number,j7);
layout_candidates add_address(layout_candidates le,Specificities(ih).address_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j7,s.nulls_address,Specificities(ih).address_values_persisted,address,address_weight100,add_address,j6);
layout_candidates add_corp_legal_name(layout_candidates le,Specificities(ih).corp_legal_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF.corp_legal_name := IF( ri.field_specificity<>0 or ri.word<>'',SELF.corp_legal_name_weight100+' '+ri.word,SALT33.Fn_WordBag_AppendSpecs_Fake(le.corp_legal_name, s.corp_legal_name_specificity) );// Copy in annotated wordstring
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j6,s.nulls_corp_legal_name,Specificities(ih).corp_legal_name_values_persisted,corp_legal_name,corp_legal_name_weight100,add_corp_legal_name,j5);
layout_candidates add_cnp_name(layout_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j5,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_cnp_name,j4);
layout_candidates add_active_domestic_corp_key(layout_candidates le,Specificities(ih).active_domestic_corp_key_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j4,s.nulls_active_domestic_corp_key,Specificities(ih).active_domestic_corp_key_values_persisted,active_domestic_corp_key,active_domestic_corp_key_weight100,add_active_domestic_corp_key,j3);
layout_candidates add_active_enterprise_number(layout_candidates le,Specificities(ih).active_enterprise_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j3,s.nulls_active_enterprise_number,Specificities(ih).active_enterprise_number_values_persisted,active_enterprise_number,active_enterprise_number_weight100,add_active_enterprise_number,j2);
layout_candidates add_company_fein(layout_candidates le,Specificities(ih).company_fein_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j2,s.nulls_company_fein,Specificities(ih).company_fein_values_persisted,company_fein,company_fein_weight100,add_company_fein,j1);
layout_candidates add_contact_ssn(layout_candidates le,Specificities(ih).contact_ssn_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(j1,s.nulls_contact_ssn,Specificities(ih).contact_ssn_values_persisted,contact_ssn,contact_ssn_weight100,add_contact_ssn,j0);
//Using HASH(did) to get smoother distribution
SHARED Annotated := DISTRIBUTE(j0,hash(DOTid)) : PERSIST('~temp::DOTid::BIPV2_DOTID::mc',EXPIRE(Config.PersistExpire)); // Distributed for keybuild case
...
layout_ForeignCorpkey_candidates add_ForeignCorpkey_company_fein(layout_ForeignCorpkey_candidates le,Specificities(ih).company_fein_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(ForeignCorpkey_pp,s.nulls_company_fein,Specificities(ih).company_fein_values_persisted,company_fein,company_fein_weight100,add_ForeignCorpkey_company_fein,jForeignCorpkey_1);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_active_enterprise_number(layout_ForeignCorpkey_candidates le,Specificities(ih).active_enterprise_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_1,s.nulls_active_enterprise_number,Specificities(ih).active_enterprise_number_values_persisted,active_enterprise_number,active_enterprise_number_weight100,add_ForeignCorpkey_active_enterprise_number,jForeignCorpkey_2);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_active_domestic_corp_key(layout_ForeignCorpkey_candidates le,Specificities(ih).active_domestic_corp_key_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_2,s.nulls_active_domestic_corp_key,Specificities(ih).active_domestic_corp_key_values_persisted,active_domestic_corp_key,active_domestic_corp_key_weight100,add_ForeignCorpkey_active_domestic_corp_key,jForeignCorpkey_3);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_cnp_name(layout_ForeignCorpkey_candidates le,Specificities(ih).cnp_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_3,s.nulls_cnp_name,Specificities(ih).cnp_name_values_persisted,cnp_name,cnp_name_weight100,add_ForeignCorpkey_cnp_name,jForeignCorpkey_4);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_corp_legal_name(layout_ForeignCorpkey_candidates le,Specificities(ih).corp_legal_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_4,s.nulls_corp_legal_name,Specificities(ih).corp_legal_name_values_persisted,corp_legal_name,corp_legal_name_weight100,add_ForeignCorpkey_corp_legal_name,jForeignCorpkey_5);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_prim_name(layout_ForeignCorpkey_candidates le,Specificities(ih).prim_name_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_5,s.nulls_prim_name,Specificities(ih).prim_name_values_persisted,prim_name,prim_name_weight100,add_ForeignCorpkey_prim_name,jForeignCorpkey_9);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_cnp_number(layout_ForeignCorpkey_candidates le,Specificities(ih).cnp_number_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_9,s.nulls_cnp_number,Specificities(ih).cnp_number_values_persisted,cnp_number,cnp_number_weight100,add_ForeignCorpkey_cnp_number,jForeignCorpkey_10);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_prim_range(layout_ForeignCorpkey_candidates le,Specificities(ih).prim_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_10,s.nulls_prim_range,Specificities(ih).prim_range_values_persisted,prim_range,prim_range_weight100,add_ForeignCorpkey_prim_range,jForeignCorpkey_13);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_sec_range(layout_ForeignCorpkey_candidates le,Specificities(ih).sec_range_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_13,s.nulls_sec_range,Specificities(ih).sec_range_values_persisted,sec_range,sec_range_weight100,add_ForeignCorpkey_sec_range,jForeignCorpkey_14);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_lname(layout_ForeignCorpkey_candidates le,Specificities(ih).lname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_14,s.nulls_lname,Specificities(ih).lname_values_persisted,lname,lname_weight100,add_ForeignCorpkey_lname,jForeignCorpkey_16);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_mname(layout_ForeignCorpkey_candidates le,Specificities(ih).mname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_16,s.nulls_mname,Specificities(ih).mname_values_persisted,mname,mname_weight100,add_ForeignCorpkey_mname,jForeignCorpkey_17);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_fname(layout_ForeignCorpkey_candidates le,Specificities(ih).fname_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_17,s.nulls_fname,Specificities(ih).fname_values_persisted,fname,fname_weight100,add_ForeignCorpkey_fname,jForeignCorpkey_18);
layout_ForeignCorpkey_candidates add_ForeignCorpkey_name_suffix(layout_ForeignCorpkey_candidates le,Specificities(ih).name_suffix_values_persisted ri,BOOLEAN patch_default) := TRANSFORM
  ...
  SELF := le;
END;
SALT33.MAC_Choose_JoinType(jForeignCorpkey_18,s.nulls_name_suffix,Specificities(ih).name_suffix_values_persisted,name_suffix,name_suffix_weight100,add_ForeignCorpkey_name_suffix,jForeignCorpkey_19);
...
EXPORT ForeignCorpkey_candidates := jForeignCorpkey_22 : PERSIST('~temp::DOTid::BIPV2_DOTID::mc::ForeignCorpkey',EXPIRE(Config.PersistExpire));
