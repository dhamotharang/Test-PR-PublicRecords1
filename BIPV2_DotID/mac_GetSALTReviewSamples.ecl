...
iter := '25';
#workunit('name','BIPV2_DOTID Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;
kmtch      := index(BIPV2_DOTID.Keys(BIPV2_DOTID.In_DOT).MatchSample ,BIPV2_DOTID.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_DOTID.In_DOT)
