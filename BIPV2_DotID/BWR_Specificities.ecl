...
#workunit('name','BIPV2_DOTID.BWR_Specificities - Specificities - SALT V3.3.0');
IMPORT BIPV2_DOTID,SALT33;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_DOTID.specificities(BIPV2_DOTID.In_DOT);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_DOTID.<your_spc_attribute>',BIPV2_DOTID.In_DOT);
