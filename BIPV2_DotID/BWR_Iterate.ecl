...
#workunit('name','BIPV2_DOTID.BWR_Iterate - Internal Linking - SALT V3.3.0');
IMPORT BIPV2_DOTID,SALT33;
IMPORT SALTTOOLS30;
//BIPV2_DOTID.Specificities(BIPV2_DOTID.In_DOT).Build; // Used to create calibration keys
...
P := BIPV2_DOTID.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT33.MAC_MatchSamplePatterns(BIPV2_DOTID.Keys(BIPV2_DOTID.In_DOT).MatchSample,MatchPatterns,DOTid1,DOTid2,8,36-42);
...
// ConfThreshold:=39;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_DOTID.Keys(BIPV2_DOTID.In_DOT).MatchSample,BIPV2_DOTID.Keys(BIPV2_DOTID.In_DOT).Candidates,BIPV2_DOTID.In_DOT,DOTid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
