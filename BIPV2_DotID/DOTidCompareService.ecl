...
odl := PROJECT(CHOOSEN(BIPV2_DOTID.Keys(BFile).Candidates(DOTid=DOTidone),100000),BIPV2_DOTID.match_candidates(BFile).layout_candidates);
odr := PROJECT(CHOOSEN(BIPV2_DOTID.Keys(BFile).Candidates(DOTid=DOTidTwo),100000),BIPV2_DOTID.match_candidates(BFile).layout_candidates);
...
BIPV2_DOTID.match_candidates(BFile).layout_attribute_matches ainto(BIPV2_DOTID.Keys(BFile).Attribute_Matches le) := TRANSFORM
  SELF := le;
END;
am := PROJECT(BIPV2_DOTID.Keys(BFile).Attribute_Matches(DOTid1=DOTidone,DOTid2=DOTidtwo)+BIPV2_DOTID.Keys(BFile).Attribute_Matches(DOTid1=DOTidtwo,DOTid2=DOTidone),ainto(LEFT));
