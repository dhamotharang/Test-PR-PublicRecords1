...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_active_enterprise_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_enterprise_number)));
    avelength_active_enterprise_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_enterprise_number)),h.active_enterprise_number<>(typeof(h.active_enterprise_number))'');
    ...
    maxlength_corp_legal_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.corp_legal_name)));
    avelength_corp_legal_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.corp_legal_name)),h.corp_legal_name<>(typeof(h.corp_legal_name))'');
    ...
    maxlength_cnp_translated := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_translated)));
    avelength_cnp_translated := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_translated)),h.cnp_translated<>(typeof(h.cnp_translated))'');
    populated_cnp_classid_pcnt := AVE(GROUP,IF(h.cnp_classid = (TYPEOF(h.cnp_classid))'',0,100));
    maxlength_cnp_classid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_classid)));
    avelength_cnp_classid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cnp_classid)),h.cnp_classid<>(typeof(h.cnp_classid))'');
    ...
    maxlength_contact_phone := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_phone)));
    avelength_contact_phone := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_phone)),h.contact_phone<>(typeof(h.contact_phone))'');
    ...
    maxlength_contact_job_title_raw := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_job_title_raw)));
    avelength_contact_job_title_raw := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_job_title_raw)),h.contact_job_title_raw<>(typeof(h.contact_job_title_raw))'');
    populated_company_department_pcnt := AVE(GROUP,IF(h.company_department = (TYPEOF(h.company_department))'',0,100));
    maxlength_company_department := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_department)));
    avelength_company_department := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_department)),h.company_department<>(typeof(h.company_department))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.DOTid;
  SELF.Src := le.source;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.active_enterprise_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.corp_legal_name),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.cnp_translated),TRIM((SALT33.StrType)le.cnp_classid),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.contact_phone),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.contact_job_title_raw),TRIM((SALT33.StrType)le.company_department),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 33);
  SELF.FldNo2 := 1 + (C % 33);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.active_enterprise_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.corp_legal_name),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.cnp_translated),TRIM((SALT33.StrType)le.cnp_classid),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.contact_phone),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.contact_job_title_raw),TRIM((SALT33.StrType)le.company_department),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.isContact),TRIM((SALT33.StrType)le.contact_ssn),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.active_enterprise_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.corp_legal_name),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.cnp_lowv),TRIM((SALT33.StrType)le.cnp_translated),TRIM((SALT33.StrType)le.cnp_classid),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.company_phone),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.contact_phone),TRIM((SALT33.StrType)le.contact_email),TRIM((SALT33.StrType)le.contact_job_title_raw),TRIM((SALT33.StrType)le.company_department),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  END;
...
SHARED FldIds := DATASET([{1,'cnp_number'}
      ...
      ,{32,'dt_first_seen'}
      ,{33,'dt_last_seen'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_active_enterprise_number((SALT33.StrType)le.active_enterprise_number),
    ...
    Fields.InValid_corp_legal_name((SALT33.StrType)le.corp_legal_name),
    0, // Uncleanable field
    ...
    Fields.InValid_cnp_translated((SALT33.StrType)le.cnp_translated),
    Fields.InValid_cnp_classid((SALT33.StrType)le.cnp_classid),
    ...
    Fields.InValid_contact_phone((SALT33.StrType)le.contact_phone),
    Fields.InValid_contact_email((SALT33.StrType)le.contact_email),
    Fields.InValid_contact_job_title_raw((SALT33.StrType)le.contact_job_title_raw),
    Fields.InValid_company_department((SALT33.StrType)le.company_department),
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'Unknown','Unknown','Unknown','alpha','Unknown','number','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','number','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','cname','Unknown','Unknown','upper','Unknown','Unknown','Unknown','Unknown');
...
//Compute field consistencies between sources
  ...
  SALT33.mac_srcfrequency_outliers(h,sec_range,source,sec_range_outliers)
  SALT33.mac_srcfrequency_outliers(h,st,source,st_outliers)
  SALT33.mac_srcfrequency_outliers(h,v_city_name,source,v_city_name_outliers)
...
EXPORT ClusterCounts := SALT33.MOD_ClusterStats.Counts(h,DOTid);
EXPORT ClusterSrc := SALT33.MOD_ClusterStats.Sources(h,DOTid,source);
END;
