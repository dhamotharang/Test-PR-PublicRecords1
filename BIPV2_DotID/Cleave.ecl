...
SHARED h := PROJECT(h0,TRANSFORM({h0,SALT33.UIDType copy_DOTid},SELF.copy_DOTid:=LEFT.DOTid, SELF:=LEFT));
...
SHARED Candidates_cnp_number := Candidates_cnp_number_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Candidates_cnp_number',EXPIRE(Config.PersistExpire));
 
EXPORT Candidates_cnp_numberKeyName := '~'+'key::BIPV2_DOTID::DOTid::Candidates_cnp_number';
 
EXPORT Candidates_cnp_number_Idx := INDEX(Candidates_cnp_number,{DOTid},{Candidates_cnp_number},Candidates_cnp_numberKeyName);
SHARED Possibles_cnp_number := Possibles_cnp_number_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Possibles_cnp_number',EXPIRE(Config.PersistExpire));
 
EXPORT Possibles_cnp_numberKeyName := '~'+'key::BIPV2_DOTID::DOTid::Possibles_cnp_number';
...
EXPORT CleaveBy_cnp_number(DATASET(RECORDOF(h)) inp) := FUNCTION
  ...
  R := RECORD
    inp;
    SALT33.UIDType __Shadow; // Track old during processing
...
SHARED Candidates_active_enterprise_number := Candidates_active_enterprise_number_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Candidates_active_enterprise_number',EXPIRE(Config.PersistExpire));
 
EXPORT Candidates_active_enterprise_numberKeyName := '~'+'key::BIPV2_DOTID::DOTid::Candidates_active_enterprise_number';
...
SHARED Possibles_active_enterprise_number := Possibles_active_enterprise_number_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Possibles_active_enterprise_number',EXPIRE(Config.PersistExpire));
 
EXPORT Possibles_active_enterprise_numberKeyName := '~'+'key::BIPV2_DOTID::DOTid::Possibles_active_enterprise_number';
...
SHARED Candidates_active_domestic_corp_key := Candidates_active_domestic_corp_key_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Candidates_active_domestic_corp_key',EXPIRE(Config.PersistExpire));
 
EXPORT Candidates_active_domestic_corp_keyKeyName := '~'+'key::BIPV2_DOTID::DOTid::Candidates_active_domestic_corp_key';
...
SHARED Possibles_active_domestic_corp_key := Possibles_active_domestic_corp_key_ni : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::Possibles_active_domestic_corp_key',EXPIRE(Config.PersistExpire));
 
EXPORT Possibles_active_domestic_corp_keyKeyName := '~'+'key::BIPV2_DOTID::DOTid::Possibles_active_domestic_corp_key';
...
EXPORT input_file := input_file_np : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::input_file',EXPIRE(Config.PersistExpire));
...
EXPORT patch_file := patch_file_np : PERSIST('~temp::DOTid::BIPV2_DOTID::Cleave::patch_file',EXPIRE(Config.PersistExpire));
