...
EXPORT Layout_Sample_Matches := RECORD(match_candidates(ih).Layout_Matches)
  ...
  SALT33.StrType   Matching_Attributes := ''; // Keys from attribute files which match
...
EXPORT layout_sample_matches sample_match_join(match_candidates(ih).layout_candidates le,match_candidates(ih).layout_candidates ri,UNSIGNED c=0,UNSIGNED outside=0) := TRANSFORM
  ...
  SELF.rcid1 := le.rcid;
  SELF.rcid2 := ri.rcid;
  SELF.DateOverlap := SALT33.fn_ComputeDateOverlap(((UNSIGNED)le.dt_first_seen),((UNSIGNED)le.dt_last_seen),((UNSIGNED)ri.dt_first_seen),((UNSIGNED)ri.dt_last_seen));
  ...
  SELF.contact_ssn_score := MAP(
                        ...
                        SALT33.WithinEditNew(le.contact_ssn,le.contact_ssn_len,ri.contact_ssn,ri.contact_ssn_len,1,0) => SALT33.fn_fuzzy_specificity(le.contact_ssn_weight100,le.contact_ssn_cnt, le.contact_ssn_e1_cnt,ri.contact_ssn_weight100,ri.contact_ssn_cnt,ri.contact_ssn_e1_cnt),
                        le.contact_ssn_Right4 = ri.contact_ssn_Right4 => SALT33.fn_fuzzy_specificity(le.contact_ssn_weight100,le.contact_ssn_cnt, le.contact_ssn_Right4_cnt,ri.contact_ssn_weight100,ri.contact_ssn_cnt,ri.contact_ssn_Right4_cnt),
  ...
  SELF.active_enterprise_number_match_code := MAP(
		le.active_enterprise_number_isnull OR ri.active_enterprise_number_isnull => SALT33.MatchCode.OneSideNull,
  ...
  INTEGER2 active_enterprise_number_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.active_enterprise_number_weight100,s.active_enterprise_number_switch));
  ...
  SELF.active_domestic_corp_key_match_code := MAP(
		le.active_domestic_corp_key_isnull OR ri.active_domestic_corp_key_isnull => SALT33.MatchCode.OneSideNull,
  ...
  INTEGER2 active_domestic_corp_key_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.active_domestic_corp_key_weight100,s.active_domestic_corp_key_switch));
  ...
  INTEGER2 cnp_name_score_temp := MAP(
                        ...
                        SALT33.WithinEditNew(le.cnp_name,le.cnp_name_len,ri.cnp_name,ri.cnp_name_len,1,0) => SALT33.fn_fuzzy_specificity(le.cnp_name_weight100,le.cnp_name_cnt, le.cnp_name_e1_cnt,ri.cnp_name_weight100,ri.cnp_name_cnt,ri.cnp_name_e1_cnt),
                        SALT33.Fn_Fail_Scale(le.cnp_name_weight100,s.cnp_name_switch));
  ...
  SELF.corp_legal_name_match_code := MAP(
		le.corp_legal_name_isnull OR ri.corp_legal_name_isnull => SALT33.MatchCode.OneSideNull,
  ...
  SELF.active_duns_number_match_code := MAP(
		le.active_duns_number_isnull OR ri.active_duns_number_isnull => SALT33.MatchCode.OneSideNull,
  ...
  SELF.active_duns_number_score := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.active_duns_number_weight100,s.active_duns_number_switch));
  SELF.addr1_match_code := MAP(
		(le.addr1_isnull OR le.prim_range_isnull AND le.prim_name_isnull AND le.sec_range_isnull) OR (ri.addr1_isnull OR ri.prim_range_isnull AND ri.prim_name_isnull AND ri.sec_range_isnull) => SALT33.MatchCode.OneSideNull,
		address_score_pre > 0 => SALT33.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.csz_match_code := MAP(
		(le.csz_isnull OR le.v_city_name_isnull AND le.st_isnull AND le.zip_isnull) OR (ri.csz_isnull OR ri.v_city_name_isnull AND ri.st_isnull AND ri.zip_isnull) OR le.csz_weight100 = 0 => SALT33.MatchCode.OneSideNull,
		address_score_pre > 0 => SALT33.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.sec_range_match_code := MAP(
		...
		addr1_score_pre > 0 OR address_score_pre > 0 => SALT33.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  INTEGER2 sec_range_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.sec_range_weight100,s.sec_range_switch))*IF(addr1_score_scale=0,1,addr1_score_scale)*IF(address_score_scale=0,1,address_score_scale);
  SELF.left_v_city_name := le.v_city_name;
  SELF.right_v_city_name := ri.v_city_name;
  SELF.v_city_name_match_code := MAP(
		le.v_city_name_isnull OR ri.v_city_name_isnull => SALT33.MatchCode.OneSideNull,
		csz_score_pre > 0 OR address_score_pre > 0 => SALT33.MatchCode.ParentInvolved, // Ancestor has found solution so child keeps quiet
  ...
  SELF.v_city_name_score := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.v_city_name_weight100,s.v_city_name_switch))*IF(csz_score_scale=0,1,csz_score_scale)*IF(address_score_scale=0,1,address_score_scale);
  ...
  INTEGER2 lname_score_temp := MAP(
                        ...
                        le.lname = ri.lname OR SALT33.HyphenMatch(le.lname,ri.lname,3)<=2  => MIN(le.lname_weight100,ri.lname_weight100),
                        SALT33.WithinEditNew(le.lname,le.lname_len,ri.lname,ri.lname_len,1,0) => SALT33.fn_fuzzy_specificity(le.lname_weight100,le.lname_cnt, le.lname_e1_cnt,ri.lname_weight100,ri.lname_cnt,ri.lname_e1_cnt),
  ...
  INTEGER2 mname_score_temp := MAP(
                        ...
                        SALT33.WithinEditNew(le.mname,le.mname_len,ri.mname,ri.mname_len,1,0) => SALT33.fn_fuzzy_specificity(le.mname_weight100,le.mname_cnt, le.mname_e1_cnt,ri.mname_weight100,ri.mname_cnt,ri.mname_e1_cnt),
  ...
  INTEGER2 fname_score_temp := MAP(
                        ...
                        le.fname_PreferredName = ri.fname_PreferredName => SALT33.fn_fuzzy_specificity(le.fname_weight100,le.fname_cnt, le.fname_PreferredName_cnt,ri.fname_weight100,ri.fname_cnt,ri.fname_PreferredName_cnt),
  ...
  INTEGER2 prim_range_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.prim_range_weight100,s.prim_range_switch))*IF(addr1_score_scale=0,1,addr1_score_scale)*IF(address_score_scale=0,1,address_score_scale);
  ...
  INTEGER2 prim_name_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.prim_name_weight100,s.prim_name_switch))*IF(addr1_score_scale=0,1,addr1_score_scale)*IF(address_score_scale=0,1,address_score_scale);
  SELF.left_st := le.st;
  SELF.right_st := ri.st;
  ...
  INTEGER2 st_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.st_weight100,s.st_switch))*IF(csz_score_scale=0,1,csz_score_scale)*IF(address_score_scale=0,1,address_score_scale);
  ...
  SELF.zip_score := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.zip_weight100,s.zip_switch))*IF(csz_score_scale=0,1,csz_score_scale)*IF(address_score_scale=0,1,address_score_scale);
...
// Compute the score for the concept addr1
  INTEGER2 addr1_score_ext := SALT33.ClipScore(MAX(addr1_score_pre,0) + self.prim_range_score + self.prim_name_score + self.sec_range_score + MAX(address_score_pre,0));// Score in surrounding context
...
// Compute the score for the concept csz
  INTEGER2 csz_score_ext := SALT33.ClipScore(MAX(csz_score_pre,0) + self.v_city_name_score + self.st_score + self.zip_score + MAX(address_score_pre,0));// Score in surrounding context
...
// Compute the score for the concept address
  INTEGER2 address_score_ext := SALT33.ClipScore(MAX(address_score_pre,0)+ SELF.addr1_score + self.prim_range_score + self.prim_name_score + self.sec_range_score+ SELF.csz_score + self.v_city_name_score + self.st_score + self.zip_score);// Score in surrounding context
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT33.Layout_FieldValueList) active_enterprise_number_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) active_domestic_corp_key_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) cnp_name_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) corp_legal_name_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) address_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) active_duns_number_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) lname_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) mname_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) fname_Values := DATASET([],SALT33.Layout_FieldValueList);
  ...
  DATASET(SALT33.Layout_FieldValueList) cnp_translated_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) cnp_classid_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) company_bdid_Values := DATASET([],SALT33.Layout_FieldValueList);
  ...
  DATASET(SALT33.Layout_FieldValueList) contact_phone_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) contact_email_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) contact_job_title_raw_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) company_department_Values := DATASET([],SALT33.Layout_FieldValueList);
...
SHARED RollEntities(dataset(Layout_RolledEntity) infile) := FUNCTION
  ...
  SELF.DOTid := le.DOTid;
    ...
    SELF.active_enterprise_number_values := SALT33.fn_combine_fieldvaluelist(le.active_enterprise_number_values,ri.active_enterprise_number_values);
    SELF.active_domestic_corp_key_values := SALT33.fn_combine_fieldvaluelist(le.active_domestic_corp_key_values,ri.active_domestic_corp_key_values);
    SELF.cnp_name_values := SALT33.fn_combine_fieldvaluelist(le.cnp_name_values,ri.cnp_name_values);
    SELF.corp_legal_name_values := SALT33.fn_combine_fieldvaluelist(le.corp_legal_name_values,ri.corp_legal_name_values);
    SELF.address_values := SALT33.fn_combine_fieldvaluelist(le.address_values,ri.address_values);
    ...
    SELF.lname_values := SALT33.fn_combine_fieldvaluelist(le.lname_values,ri.lname_values);
    SELF.mname_values := SALT33.fn_combine_fieldvaluelist(le.mname_values,ri.mname_values);
    SELF.fname_values := SALT33.fn_combine_fieldvaluelist(le.fname_values,ri.fname_values);
    ...
    SELF.cnp_translated_values := SALT33.fn_combine_fieldvaluelist(le.cnp_translated_values,ri.cnp_translated_values);
    SELF.cnp_classid_values := SALT33.fn_combine_fieldvaluelist(le.cnp_classid_values,ri.cnp_classid_values);
    SELF.company_bdid_values := SALT33.fn_combine_fieldvaluelist(le.company_bdid_values,ri.company_bdid_values);
    ...
    SELF.contact_phone_values := SALT33.fn_combine_fieldvaluelist(le.contact_phone_values,ri.contact_phone_values);
    SELF.contact_email_values := SALT33.fn_combine_fieldvaluelist(le.contact_email_values,ri.contact_email_values);
    SELF.contact_job_title_raw_values := SALT33.fn_combine_fieldvaluelist(le.contact_job_title_raw_values,ri.contact_job_title_raw_values);
    SELF.company_department_values := SALT33.fn_combine_fieldvaluelist(le.company_department_values,ri.company_department_values);
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  ...
  SELF.active_enterprise_number_Values := IF ( (le.active_enterprise_number  IN SET(s.nulls_active_enterprise_number,active_enterprise_number) OR le.active_enterprise_number = (TYPEOF(le.active_enterprise_number))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.active_enterprise_number)}],SALT33.Layout_FieldValueList));
  SELF.active_domestic_corp_key_Values := IF ( (le.active_domestic_corp_key  IN SET(s.nulls_active_domestic_corp_key,active_domestic_corp_key) OR le.active_domestic_corp_key = (TYPEOF(le.active_domestic_corp_key))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.active_domestic_corp_key)}],SALT33.Layout_FieldValueList));
  ...
  SELF.corp_legal_name_Values := IF ( (le.corp_legal_name  IN SET(s.nulls_corp_legal_name,corp_legal_name) OR le.corp_legal_name = (TYPEOF(le.corp_legal_name))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.corp_legal_name)}],SALT33.Layout_FieldValueList));
  self.address_Values := IF ( (le.prim_range  IN SET(s.nulls_prim_range,prim_range) OR le.prim_range = (TYPEOF(le.prim_range))'') AND (le.prim_name  IN SET(s.nulls_prim_name,prim_name) OR le.prim_name = (TYPEOF(le.prim_name))'') AND (le.sec_range  IN SET(s.nulls_sec_range,sec_range) OR le.sec_range = (TYPEOF(le.sec_range))'') AND (le.v_city_name  IN SET(s.nulls_v_city_name,v_city_name) OR le.v_city_name = (TYPEOF(le.v_city_name))'') AND (le.st  IN SET(s.nulls_st,st) OR le.st = (TYPEOF(le.st))'') AND (le.zip  IN SET(s.nulls_zip,zip) OR le.zip = (TYPEOF(le.zip))''),dataset([],SALT33.Layout_FieldValueList),dataset([{TRIM((SALT33.StrType)le.prim_range) + ' ' + TRIM((SALT33.StrType)le.prim_name) + ' ' + TRIM((SALT33.StrType)le.sec_range) + ' ' + TRIM((SALT33.StrType)le.v_city_name) + ' ' + TRIM((SALT33.StrType)le.st) + ' ' + TRIM((SALT33.StrType)le.zip)}],SALT33.Layout_FieldValueList));
  SELF.active_duns_number_Values := IF ( (le.active_duns_number  IN SET(s.nulls_active_duns_number,active_duns_number) OR le.active_duns_number = (TYPEOF(le.active_duns_number))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.active_duns_number)}],SALT33.Layout_FieldValueList));
  SELF.lname_Values := IF ( (le.lname  IN SET(s.nulls_lname,lname) OR le.lname = (TYPEOF(le.lname))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.lname)}],SALT33.Layout_FieldValueList));
  SELF.mname_Values := IF ( (le.mname  IN SET(s.nulls_mname,mname) OR le.mname = (TYPEOF(le.mname))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.mname)}],SALT33.Layout_FieldValueList));
  SELF.fname_Values := IF ( (le.fname  IN SET(s.nulls_fname,fname) OR le.fname = (TYPEOF(le.fname))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.fname)}],SALT33.Layout_FieldValueList));
  ...
  SELF.cnp_lowv_Values := DATASET([{TRIM((SALT33.StrType)le.cnp_lowv)}],SALT33.Layout_FieldValueList);
  SELF.cnp_translated_Values := DATASET([{TRIM((SALT33.StrType)le.cnp_translated)}],SALT33.Layout_FieldValueList);
  SELF.cnp_classid_Values := DATASET([{TRIM((SALT33.StrType)le.cnp_classid)}],SALT33.Layout_FieldValueList);
  SELF.company_bdid_Values := DATASET([{TRIM((SALT33.StrType)le.company_bdid)}],SALT33.Layout_FieldValueList);
  SELF.company_phone_Values := DATASET([{TRIM((SALT33.StrType)le.company_phone)}],SALT33.Layout_FieldValueList);
  SELF.company_name_Values := DATASET([{TRIM((SALT33.StrType)le.company_name)}],SALT33.Layout_FieldValueList);
  SELF.title_Values := DATASET([{TRIM((SALT33.StrType)le.title)}],SALT33.Layout_FieldValueList);
  SELF.contact_phone_Values := DATASET([{TRIM((SALT33.StrType)le.contact_phone)}],SALT33.Layout_FieldValueList);
  SELF.contact_email_Values := DATASET([{TRIM((SALT33.StrType)le.contact_email)}],SALT33.Layout_FieldValueList);
  SELF.contact_job_title_raw_Values := DATASET([{TRIM((SALT33.StrType)le.contact_job_title_raw)}],SALT33.Layout_FieldValueList);
  SELF.company_department_Values := DATASET([{TRIM((SALT33.StrType)le.company_department)}],SALT33.Layout_FieldValueList);
  SELF.dt_first_seen_Values := DATASET([{TRIM((SALT33.StrType)le.dt_first_seen)}],SALT33.Layout_FieldValueList);
  SELF.dt_last_seen_Values := DATASET([{TRIM((SALT33.StrType)le.dt_last_seen)}],SALT33.Layout_FieldValueList);
END;
...
Layout_Chubbies0 NoteSize(Layout_Chubbies0 le) := TRANSFORM
  ...
  SELF.active_enterprise_number_size := SALT33.Fn_SwitchSpec(s.active_enterprise_number_switch,count(le.active_enterprise_number_values));
  SELF.active_domestic_corp_key_size := SALT33.Fn_SwitchSpec(s.active_domestic_corp_key_switch,count(le.active_domestic_corp_key_values));
  SELF.cnp_name_size := SALT33.Fn_SwitchSpec(s.cnp_name_switch,count(le.cnp_name_values));
  SELF.corp_legal_name_size := SALT33.Fn_SwitchSpec(s.corp_legal_name_switch,count(le.corp_legal_name_values));
  SELF.address_size := SALT33.Fn_SwitchSpec(s.address_switch,count(le.address_values));
  SELF.active_duns_number_size := SALT33.Fn_SwitchSpec(s.active_duns_number_switch,count(le.active_duns_number_values));
  SELF.lname_size := SALT33.Fn_SwitchSpec(s.lname_switch,count(le.lname_values));
  SELF.mname_size := SALT33.Fn_SwitchSpec(s.mname_switch,count(le.mname_values));
  SELF.fname_size := SALT33.Fn_SwitchSpec(s.fname_switch,count(le.fname_values));
