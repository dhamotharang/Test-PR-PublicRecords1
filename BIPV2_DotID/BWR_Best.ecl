...
#workunit('name','BIPV2_DOTID.BWR_Best - BEST - SALT V2.4 Beta 2');
IMPORT BIPV2_DOTID,SALT24;
...
BIPV2_DOTID.Best(BIPV2_DOTID.In_DOT).Stats;
...
b := BIPV2_DOTID.Best(BIPV2_DOTID.In_DOT); // Instantiate Best module
