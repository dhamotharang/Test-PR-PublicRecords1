...
#workunit('name','BIPV2_POWID_Down.BWR_Iterate - Internal Linking - SALT V3.5.2');
IMPORT BIPV2_POWID_Down,SALT35;
IMPORT SALTTOOLS30;
//BIPV2_POWID_Down.Specificities(BIPV2_POWID_Down.In_POWID_Down).Build; // Used to create calibration keys
...
P := BIPV2_POWID_Down.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT35.MAC_MatchSamplePatterns(BIPV2_POWID_Down.Keys(BIPV2_POWID_Down.In_POWID_Down).MatchSample,MatchPatterns,POWID1,POWID2,8,35-41);
...
// ConfThreshold:=38;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_POWID_Down.Keys(BIPV2_POWID_Down.In_POWID_Down).MatchSample,BIPV2_POWID_Down.Keys(BIPV2_POWID_Down.In_POWID_Down).Candidates,BIPV2_POWID_Down.In_POWID_Down,POWID,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
