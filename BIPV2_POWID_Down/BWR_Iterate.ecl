...
#workunit('name','BIPV2_POWID_Down.BWR_Iterate - Internal Linking - SALT V2.7 Gold');
IMPORT BIPV2_POWID_Down,SALT27;
//BIPV2_POWID_Down.Specificities(BIPV2_POWID_Down.In_POWID_Down).Build; // Used to create callibration keys
...
BIPV2_POWID_Down.Proc_Iterate('1').DoAll; // Change '1' for subsequent iterations
//BIPV2_POWID_Down.Proc_Iterate('1').DoAllAgain; // Use this version to re-run an iteration
