...
Command line options: -MBIPV2_POWID_Down -eC:\Users\sunhar01\AppData\Local\Temp\TFRB33B.tmp 
File being processed :-
OPTIONS:-gh -ga -p2 -gs2 
MODULE:BIPV2_POWID_Down  
FILENAME:POWID_Down 
...
//Based on Todd's suggestion (email HACK:NOSLICE in upper-level BIP modules), upper level linking should remove the slice
HACK:NOSLICE 
// ------------------------------------
...
This process was told to produce 3 nines of accuracy on a population of 275408224 with  3688224512 records.
