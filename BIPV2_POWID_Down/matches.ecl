...
SHARED all_mjs := o;
export All_Matches := all_mjs : PERSIST('~temp::BIPV2_POWID_Down_POWID_POWID_Down_all_m'); // To by used by rcid and POWID
import bipv2_tools;
BIPV2_Tools.mac_avoid_transitives(All_Matches,POWID1,POWID2,Conf,DateOverlap,Rule,o);
export PossibleMatches := o : PERSIST('~temp::BIPV2_POWID_Down_POWID_POWID_Down_mt');
SALT27.mac_get_BestPerRecord( All_Matches,rcid1,POWID1,rcid2,POWID2,o );
EXPORT BestPerRecord := o : PERSIST('~temp::BIPV2_POWID_Down_POWID_POWID_Down_mr');
...
EXPORT ClusterLinkages := o1 : PERSIST('~temp::BIPV2_POWID_Down_POWID_POWID_Down_clu');
