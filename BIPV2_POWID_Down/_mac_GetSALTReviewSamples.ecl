...
iter := '25';
#workunit('name','BIPV2_POWID_Down Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_POWID_Down.Keys(BIPV2_POWID_Down.In_POWID_Down).MatchSample ,BIPV2_POWID_Down.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT _mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_POWID_Down.In_POWID_Down)
