Import Data_Services, uccv2,text_search;
	...
	ret := dataset(Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::persist::uccv2::boolean',text_ucc_flat,thor);
...
export Key_Boolean_Map := index(tmsid_map,{src,doc},{tmsid},Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::uccv2::qa::docref.tmsid');
