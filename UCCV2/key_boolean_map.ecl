import uccv2,text_search;
	...
	ret := dataset('~thor_data400::persist::uccv2::boolean',text_ucc_flat,thor);
...
export Key_Boolean_Map := index(if(fileservices.fileexists('~thor_data400::persist::uccv2::boolean'),
																		tmsid_map,read_ret),{src,doc},{tmsid},'~thor_data400::key::uccv2::qa::docref.tmsid');
