...
dDedup                               := dedup(dMainBase+dfile,except process_date,vendor_entry_date,vendor_upd_date,rmsid, ALL);
AddRecordID := uccv2.fnAddPersistentRecordID_Main(dDedup);



export Proc_Build_IL_Main_base      :=	AddRecordID;