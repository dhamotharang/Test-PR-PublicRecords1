...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_process_date_pcnt *   0.00 / 100 + T.Populated_record_type_pcnt *   0.00 / 100 + T.Populated_clean_company_name_pcnt *   0.00 / 100 + T.Populated_clean_telephone_num_pcnt *   0.00 / 100 + T.Populated_state_pcnt *   0.00 / 100 + T.Populated_zip_code5_pcnt *   0.00 / 100 + T.Populated_mail_score_pcnt *   0.00 / 100 + T.Populated_name_gender_pcnt *   0.00 / 100 + T.Populated_web_address_pcnt *   0.00 / 100 + T.Populated_sic8_1_pcnt *   0.00 / 100 + T.Populated_sic8_2_pcnt *   0.00 / 100 + T.Populated_sic8_3_pcnt *   0.00 / 100 + T.Populated_sic8_4_pcnt *   0.00 / 100 + T.Populated_sic6_1_pcnt *   0.00 / 100 + T.Populated_sic6_2_pcnt *   0.00 / 100 + T.Populated_sic6_3_pcnt *   0.00 / 100 + T.Populated_sic6_4_pcnt *   0.00 / 100 + T.Populated_sic6_5_pcnt *   0.00 / 100 + T.Populated_database_site_id_pcnt *   0.00 / 100 + T.Populated_database_individual_id_pcnt *   0.00 / 100 + T.Populated_email_pcnt *   0.00 / 100 + T.Populated_email_present_flag_pcnt *   0.00 / 100 + T.Populated_site_source1_pcnt *   0.00 / 100 + T.Populated_site_source2_pcnt *   0.00 / 100 + T.Populated_site_source3_pcnt *   0.00 / 100 + T.Populated_site_source4_pcnt *   0.00 / 100 + T.Populated_site_source5_pcnt *   0.00 / 100 + T.Populated_site_source6_pcnt *   0.00 / 100 + T.Populated_site_source7_pcnt *   0.00 / 100 + T.Populated_site_source8_pcnt *   0.00 / 100 + T.Populated_site_source9_pcnt *   0.00 / 100 + T.Populated_site_source10_pcnt *   0.00 / 100 + T.Populated_individual_source1_pcnt *   0.00 / 100 + T.Populated_individual_source2_pcnt *   0.00 / 100 + T.Populated_individual_source3_pcnt *   0.00 / 100 + T.Populated_individual_source4_pcnt *   0.00 / 100 + T.Populated_individual_source5_pcnt *   0.00 / 100 + T.Populated_individual_source6_pcnt *   0.00 / 100 + T.Populated_individual_source7_pcnt *   0.00 / 100 + T.Populated_individual_source8_pcnt *   0.00 / 100 + T.Populated_individual_source9_pcnt *   0.00 / 100 + T.Populated_individual_source10_pcnt *   0.00 / 100 + T.Populated_email_status_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_process_date,le.maxlength_record_type,le.maxlength_clean_company_name,le.maxlength_clean_telephone_num,le.maxlength_state,le.maxlength_zip_code5,le.maxlength_mail_score,le.maxlength_name_gender,le.maxlength_web_address,le.maxlength_sic8_1,le.maxlength_sic8_2,le.maxlength_sic8_3,le.maxlength_sic8_4,le.maxlength_sic6_1,le.maxlength_sic6_2,le.maxlength_sic6_3,le.maxlength_sic6_4,le.maxlength_sic6_5,le.maxlength_database_site_id,le.maxlength_database_individual_id,le.maxlength_email,le.maxlength_email_present_flag,le.maxlength_site_source1,le.maxlength_site_source2,le.maxlength_site_source3,le.maxlength_site_source4,le.maxlength_site_source5,le.maxlength_site_source6,le.maxlength_site_source7,le.maxlength_site_source8,le.maxlength_site_source9,le.maxlength_site_source10,le.maxlength_individual_source1,le.maxlength_individual_source2,le.maxlength_individual_source3,le.maxlength_individual_source4,le.maxlength_individual_source5,le.maxlength_individual_source6,le.maxlength_individual_source7,le.maxlength_individual_source8,le.maxlength_individual_source9,le.maxlength_individual_source10,le.maxlength_email_status);
