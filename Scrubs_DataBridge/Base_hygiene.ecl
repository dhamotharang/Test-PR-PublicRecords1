...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_process_date_pcnt *   0.00 / 100 + T.Populated_record_type_pcnt *   0.00 / 100 + T.Populated_clean_company_name_pcnt *   0.00 / 100 + T.Populated_clean_telephone_num_pcnt *   0.00 / 100 + T.Populated_state_pcnt *   0.00 / 100 + T.Populated_zip_pcnt *   0.00 / 100 + T.Populated_mail_score_pcnt *   0.00 / 100 + T.Populated_name_gender_pcnt *   0.00 / 100 + T.Populated_web_address_pcnt *   0.00 / 100 + T.Populated_sic8_1_pcnt *   0.00 / 100 + T.Populated_sic8_2_pcnt *   0.00 / 100 + T.Populated_sic8_3_pcnt *   0.00 / 100 + T.Populated_sic8_4_pcnt *   0.00 / 100 + T.Populated_sic6_1_pcnt *   0.00 / 100 + T.Populated_sic6_2_pcnt *   0.00 / 100 + T.Populated_sic6_3_pcnt *   0.00 / 100 + T.Populated_sic6_4_pcnt *   0.00 / 100 + T.Populated_sic6_5_pcnt *   0.00 / 100 + T.Populated_database_site_id_pcnt *   0.00 / 100 + T.Populated_database_individual_id_pcnt *   0.00 / 100 + T.Populated_email_pcnt *   0.00 / 100 + T.Populated_email_present_flag_pcnt *   0.00 / 100 + T.Populated_site_source1_pcnt *   0.00 / 100 + T.Populated_site_source2_pcnt *   0.00 / 100 + T.Populated_site_source3_pcnt *   0.00 / 100 + T.Populated_site_source4_pcnt *   0.00 / 100 + T.Populated_site_source5_pcnt *   0.00 / 100 + T.Populated_site_source6_pcnt *   0.00 / 100 + T.Populated_site_source7_pcnt *   0.00 / 100 + T.Populated_site_source8_pcnt *   0.00 / 100 + T.Populated_site_source9_pcnt *   0.00 / 100 + T.Populated_site_source10_pcnt *   0.00 / 100 + T.Populated_individual_source1_pcnt *   0.00 / 100 + T.Populated_individual_source2_pcnt *   0.00 / 100 + T.Populated_individual_source3_pcnt *   0.00 / 100 + T.Populated_individual_source4_pcnt *   0.00 / 100 + T.Populated_individual_source5_pcnt *   0.00 / 100 + T.Populated_individual_source6_pcnt *   0.00 / 100 + T.Populated_individual_source7_pcnt *   0.00 / 100 + T.Populated_individual_source8_pcnt *   0.00 / 100 + T.Populated_individual_source9_pcnt *   0.00 / 100 + T.Populated_individual_source10_pcnt *   0.00 / 100 + T.Populated_email_status_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
SHARED FldIds := DATASET([{1,'dt_first_seen'}
      ...
      ,{22,'sic6_5'}
      ,{23,'database_site_id'}
      ,{24,'database_individual_id'}
      ,{25,'email'}
      ,{26,'email_present_flag'}
      ,{27,'site_source1'}
      ,{28,'site_source2'}
      ,{29,'site_source3'}
      ,{30,'site_source4'}
      ...
      ,{35,'site_source9'}
      ,{36,'site_source10'}
      ,{37,'individual_source1'}
      ,{38,'individual_source2'}
      ,{39,'individual_source3'}
      ,{40,'individual_source4'}
      ,{41,'individual_source5'}
      ,{42,'individual_source6'}
      ,{43,'individual_source7'}
      ,{44,'individual_source8'}
      ,{45,'individual_source9'}
      ,{46,'individual_source10'}
      ,{47,'email_status'}],SALT311.MAC_Character_Counts.Field_Identification);
