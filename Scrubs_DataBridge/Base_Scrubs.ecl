...
EXPORT FromNone(DATASET(Base_Layout_DataBridge) h) := MODULE
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.dt_first_seen_Invalid << 0 ) + ( le.dt_last_seen_Invalid << 1 ) + ( le.dt_vendor_first_reported_Invalid << 2 ) + ( le.dt_vendor_last_reported_Invalid << 3 ) + ( le.process_date_Invalid << 4 ) + ( le.record_type_Invalid << 5 ) + ( le.clean_company_name_Invalid << 6 ) + ( le.clean_telephone_num_Invalid << 7 ) + ( le.state_Invalid << 8 ) + ( le.zip_Invalid << 9 ) + ( le.mail_score_Invalid << 10 ) + ( le.name_gender_Invalid << 11 ) + ( le.web_address_Invalid << 12 ) + ( le.sic8_1_Invalid << 13 ) + ( le.sic8_2_Invalid << 14 ) + ( le.sic8_3_Invalid << 15 ) + ( le.sic8_4_Invalid << 16 ) + ( le.sic6_1_Invalid << 17 ) + ( le.sic6_2_Invalid << 18 ) + ( le.sic6_3_Invalid << 19 ) + ( le.sic6_4_Invalid << 20 ) + ( le.sic6_5_Invalid << 21 ) + ( le.database_site_id_Invalid << 22 ) + ( le.database_individual_id_Invalid << 23 ) + ( le.email_Invalid << 24 ) + ( le.email_present_flag_Invalid << 25 ) + ( le.site_source1_Invalid << 26 ) + ( le.site_source2_Invalid << 27 ) + ( le.site_source3_Invalid << 28 ) + ( le.site_source4_Invalid << 29 ) + ( le.site_source5_Invalid << 30 ) + ( le.site_source6_Invalid << 31 ) + ( le.site_source7_Invalid << 32 ) + ( le.site_source8_Invalid << 33 ) + ( le.site_source9_Invalid << 34 ) + ( le.site_source10_Invalid << 35 ) + ( le.individual_source1_Invalid << 36 ) + ( le.individual_source2_Invalid << 37 ) + ( le.individual_source3_Invalid << 38 ) + ( le.individual_source4_Invalid << 39 ) + ( le.individual_source5_Invalid << 40 ) + ( le.individual_source6_Invalid << 41 ) + ( le.individual_source7_Invalid << 42 ) + ( le.individual_source8_Invalid << 43 ) + ( le.individual_source9_Invalid << 44 ) + ( le.individual_source10_Invalid << 45 ) + ( le.email_status_Invalid << 46 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.database_site_id_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.database_individual_id_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.email_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.email_present_flag_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.site_source1_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.site_source2_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.site_source3_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.site_source4_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.site_source5_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.site_source6_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.site_source7_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.site_source8_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.site_source9_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.site_source10_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.individual_source1_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.individual_source2_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.individual_source3_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.individual_source4_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.individual_source5_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.individual_source6_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.individual_source7_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.individual_source8_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.individual_source9_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.individual_source10_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.email_status_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldType := CHOOSE(c,'invalid_pastdate','invalid_pastdate','invalid_pastdate','invalid_pastdate','invalid_generaldate','invalid_record_type','invalid_mandatory','invalid_phone','invalid_st','invalid_zip5','invalid_mail_score','invalid_gender_code','invalid_url','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_sic','invalid_numeric','invalid_numeric','invalid_email','invalid_email_present_flag','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_source_code','invalid_email_status','UNKNOWN');
