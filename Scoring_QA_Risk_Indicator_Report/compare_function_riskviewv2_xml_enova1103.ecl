EXPORT compare_function_riskviewv2_xml_enova1103(route,current_dt,previous_dt) := functionmacro



file1:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_V4_XML_ENOVA_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_ENOVA_rvg1103_0_V4_Global_Layout,
...
file2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_V4_XML_ENOVA_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_ENOVA_rvg1103_0_V4_Global_Layout,
         	                                        ...
         	                                        left.field_name = right.field_name and
            									                      ...
            									                      // left.Count1 = right.Count1
      																							,transform(	compare_layout, 
																										self.file_version:='fcra_rvscores_v2_enova',
																										self.mode:='xml',
