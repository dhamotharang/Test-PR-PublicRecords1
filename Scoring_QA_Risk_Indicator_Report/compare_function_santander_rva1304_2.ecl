EXPORT compare_function_santander_rva1304_2(route,current_dt,previous_dt) := functionmacro




file1:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_Santander_1304_2_outfile + previous_dt,Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_Santander_RVA1304_2_V3_Global_Layout,
...
file2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_Santander_1304_2_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_Santander_RVA1304_2_V3_Global_Layout,
         	                                        ...
         	                                        left.field_name = right.field_name and
            									                      ...
            									                      // left.Count1 = right.Count1
      																							,transform(	compare_layout, 
																										self.file_version:='santander_rva1304_2',
																										self.mode:='xml',
