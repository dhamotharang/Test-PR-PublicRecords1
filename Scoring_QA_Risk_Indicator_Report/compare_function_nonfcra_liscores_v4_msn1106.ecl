EXPORT compare_function_nonfcra_liscores_v4_msn1106(route,current_dt,previous_dt)  :=  functionmacro





file1:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.LI_Scores_V4_XML_Generic_msn1106_0_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_V4_Generic_MSN1210_1_Global_Layout,
...
file2:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.LI_Scores_V4_XML_Generic_msn1106_0_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.NONFCRA_LeadIntegrity_V4_Generic_MSN1210_1_Global_Layout,
...
DS2:=join(file2,aa,left.acctno=right.acctno,inner);
				...
				Scoring_QA_Risk_Indicator_Report.functions.count_function(DS1,'rc1',c13);
      	Scoring_QA_Risk_Indicator_Report.functions.count_function(DS1,'rc2',c14);
      	Scoring_QA_Risk_Indicator_Report.functions.count_function(DS1,'rc3',c15);
				Scoring_QA_Risk_Indicator_Report.functions.count_function(DS1,'rc4',c16);
...
Scoring_QA_Risk_Indicator_Report.functions.count_function1(tr,'reason_code',tr_1);
			...
			//////////////////////////////////////////////////////////////////
				...
				Scoring_QA_Risk_Indicator_Report.functions.count_function(DS2,'rc1',cc13);
      	Scoring_QA_Risk_Indicator_Report.functions.count_function(DS2,'rc2',cc14);
      	Scoring_QA_Risk_Indicator_Report.functions.count_function(DS2,'rc3',cc15);
				Scoring_QA_Risk_Indicator_Report.functions.count_function(DS2,'rc4',cc16);
