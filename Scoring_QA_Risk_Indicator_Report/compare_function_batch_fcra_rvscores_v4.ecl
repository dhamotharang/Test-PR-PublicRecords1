EXPORT compare_function_batch_fcra_rvscores_v4(route,current_dt,previous_dt) := functionmacro
...
file1:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_V4_BATCH_Generic_outfile + previous_dt,Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_Generic_allflagships_V4_Global_Layout,



thor),(integer)acctno);
file2:= distribute(dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_V4_BATCH_Generic_outfile +current_dt,Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_Generic_allflagships_V4_Global_Layout,
