EXPORT compare_function_t_mobile_rvt1210_1_cust_rec(route,current_dt,previous_dt)  :=  functionmacro




file1:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_Tmobile_rvt1210_1_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_T_mobile_RVT1210_1_v4_Global_Layout,
...
file2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_Tmobile_rvt1210_1_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_T_mobile_RVT1210_1_v4_Global_Layout,
