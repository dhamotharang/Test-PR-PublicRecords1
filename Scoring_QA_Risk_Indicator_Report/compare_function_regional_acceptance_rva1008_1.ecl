EXPORT compare_function_regional_acceptance_rva1008_1(route,current_dt,previous_dt) := functionmacro




file1:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_RegionalAcceptance_RVA1008_1_outfile + previous_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_RegionalAcceptance_RVA1008_1_V4_Global_Layout	,

thor);



file2:= dataset(route + scoring_project_pip.Output_Sample_Names.RV_Scores_XML_RegionalAcceptance_RVA1008_1_outfile + current_dt, Scoring_Project_Macros.Global_Output_Layouts.FCRA_RiskView_XML_RegionalAcceptance_RVA1008_1_V4_Global_Layout,
         	                                        ...
         	                                        left.field_name = right.field_name and
            									                      ...
            									                      // left.Count1 = right.Count1
      																							,transform(	compare_layout, 
																										self.file_version:='regional_acceptance_rva1008_1',
																										self.mode:='xml',
