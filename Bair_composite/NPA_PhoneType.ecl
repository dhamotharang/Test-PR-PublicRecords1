...
import Risk_Indicators, Gong_Neustar,data_services,Cellphone;
...
//------------------------------------------------------------------------------------------------
%tds%   := DATASET(data_services.Data_location.Prefix('TDS')+'thor_data400::base::tdsdata',Risk_Indicators.Layout_Telcordia_tds,flat);
