IMPORT UT,STD,LUCI;
IMPORT HCSE_SETC_V3_LOB_MODEL AS LUCI_Model;
SHARED Constants := LUCI.Constants;
SHARED Layouts := HCSE_SETC_V3_LOB_MODEL.z_layouts;
...
SHARED SprayCSVName      := '~HCSE_SETC_V3_LOB_MODEL::' + (STRING)STD.Date.Today() + '::' + ModelName +'_from_csv'; // Will set up by user if test file is a logical file.
