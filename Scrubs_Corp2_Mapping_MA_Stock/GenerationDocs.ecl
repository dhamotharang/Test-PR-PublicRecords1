...
Command line options: -MScrubs_Corp2_Mapping_MA_Stock -eC:\Users\butlersx\AppData\Local\Temp\TFRCCCE.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_MA_Stock
FILENAME:In_MA
...
FIELD:stock_class:TYPE(STRING20):LIKE(invalid_alphablank):0,0
FIELD:stock_shares_issued:TYPE(STRING15):LIKE(invalid_numericblank):0,0
FIELD:stock_authorized_nbr:TYPE(STRING50):LIKE(invalid_numericblank):0,0
FIELD:stock_par_value:TYPE(STRING15):LIKE(invalid_numericperiodblank):0,0
