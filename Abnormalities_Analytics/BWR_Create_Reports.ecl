...
Import Abnormalities_Analytics.Files;
Import Abnormalities_Analytics.Watchdog_Match_Report;
Import Abnormalities_Analytics.Analytics_Report;
...
Output($.Analytics_Report.st_Crosstab_Dob, Named('HighCount_Dob')); // Most common dob across all records
Output($.Analytics_Report.S_Crosstab_dob, Named('Dobs_Without_No_Blanks')); // Most common dob across different lexids (non-blanks)
Output($.Analytics_Report.S_Crosstab_dobMMDD, Named('Dobs_Without_No_blanksMMDD')); // Most common dob with only month and day
Output($.Analytics_Report.S_Sample_RecSlim, Named('Count_of_BlankDobs')); // Count of blank dob across file
