...
//join main to addr
address_attributes.layouts.vehicles	get_vehicles(vehicle_current l,vehicle_main r)	:= transform
...
export file_vehicles	:=	distribute(vehicle_slim,random());
