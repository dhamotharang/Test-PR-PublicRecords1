...
export Mapping_Search_Criteria_Region_5 (string filedate):= function

//WORLDCHECK NORTH AMERICA
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='5');
	...
	File_In_Subcat 	:= dataset([{
							...
							,0
							,'Entity'
							,'892E16AE-D67F-46d1-BB0A-91C38813958F'
							,'WORLDCHECK NORTH AMERICA'
							,'WorldCheck - Non-US Countries in North America'
							,'13'
							,'False'
							,''
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_5_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_5_search::'+filedate+'.xml', XML('MYROW', 
