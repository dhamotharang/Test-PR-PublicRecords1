...
export Normalize_and_Rollup_IDs(dataset(Layout_WorldCheck_Premium) in_f):= function
...
//POPULATE SSNs ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
	...
	// Normalize the SSN values
	ds_NormSSNNames := NORMALIZE(MyParsedSSN
                            ,1
							,trfSSNName(left));
...
ds_reformPassport 	:= Normalize_Passports(in_f);

///////////////////////////////////////////////////////////////////////////////////////////////////////////////

//Concat SSNs and Passports
concatID := ds_reformSSN + ds_reformPassport : persist('~thor_200::persist::worldcheck::all_ids');
