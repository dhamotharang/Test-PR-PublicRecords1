...
export Mapping_Search_Criteria_Region_3 (string filedate):= function
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='3');
	...
	File_In_Subcat 	:= dataset([{
							...
							,0
							,'Entity'
							,'76CF185E-DF42-4907-AC38-D9A0C26ED5A6'
							,'WORLDCHECK EUROPE'
							,'WorldCheck - European Countries'
							,'11'
							,'False'
							,''
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_3_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_3_search::'+filedate+'.xml', XML('MYROW', 
