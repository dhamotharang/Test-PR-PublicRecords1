...
despray_pp_entity	:= fileservices.Despray('~thor_data200::base::worldcheck_bridger::premium_plus_entity::'+filedate+'.xml', _Control.IPAddress.edata11, '/bdb_82/wcb/output/'+filedate+'/worldcheck_premium_plus_entity.xml',,,,true);

//despray_pp_entity	:= fileservices.Despray('~thor_data200::base::worldcheck_bridger::premium_plus_entity::'+filedate+'.xml', _Control.IPAddress.edata12, '/data_999/world_check_bridger/premium_plus_output/'+filedate+'/worldcheck_premium_plus_entity.xml',,,,true);
