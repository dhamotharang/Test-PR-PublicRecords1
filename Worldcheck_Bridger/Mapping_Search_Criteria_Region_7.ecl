...
export Mapping_Search_Criteria_Region_7 (string filedate):= function
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='7');
	...
	File_In_Subcat 	:= dataset([{
							...
							,0
							,'Entity'
							,'5020BB3F-292A-4fb7-92C3-9FAB8FF3A6A7'
							,'WORLDCHECK UNKNOWN'
							,'WorldCheck - Unknown'
							,'15'
							,'False'
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_7_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_7_search::'+filedate+'.xml', XML('MYROW', 
