...
export Mapping_Search_Criteria_Region_6 (string filedate):= function

//WORLDCHECK SOUTH AMERICA
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='6');
	...
	File_In_Subcat	 := dataset([{
							...
							,0
							,'Entity'
							,'5B1CA18F-E868-423c-B5AD-3F61E2F53C57'
							,'WORLDCHECK SOUTH AMERICA'
							,'WorldCheck - South America'
							,'14'
							,'False'
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_6_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_6_search::'+filedate+'.xml', XML('MYROW', 
