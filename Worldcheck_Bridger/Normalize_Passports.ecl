...
export normalize_passports(dataset(Layout_WorldCheck_Premium) in_f):= function
...
////////// Begin parsing and normalizing Passports/////////
	...
	ds_NormPassportNames := NORMALIZE(MyParsedPassport
								,1
								,trfPassportName(left));
...
ds_reformPassport := project(ds_NormPassportNames, PassportTran(left)) : persist('~thor_200::persist::worldcheck::normalized_passports');
