...
export Mapping_Search_Criteria_Region_4 (string filedate):= function

//WORLDCHECK MIDDLE EAST
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='4');
	...
	File_In_Subcat 	:= dataset([{
							...
							,0
							,'Entity'
							,'988EDE95-EE8D-458f-8554-63C28E089FAC'
							,'WORLDCHECK MIDDLE EAST'
							,'WorldCheck - Middle East Region'
							,'12'
							,'False'
							,''
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_4_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_4_search::'+filedate+'.xml', XML('MYROW', 
