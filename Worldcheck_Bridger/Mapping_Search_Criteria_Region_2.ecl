...
export Mapping_Search_Criteria_Region_2 (string filedate) := function
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='2');
	...
	File_In_Subcat := dataset([{
							...
							,0
							,'Entity'
							,'1D2D7E49-F191-46b5-80C7-6AD941B640C0'
							,'WORLDCHECK ASIA'
							,'WorldCheck - Asia, Australia, and Island Countries'
							,'10'
							,'False'
							,''
...
p_Build 	:= project(slimInfo, t_Build(left)):persist('~thor_data200::persist::worldcheck_bridger::region_2_search::'+filedate);
	
return 	output(p_Build,,'~thor_data200::base::worldcheck_bridger::region_2_search::'+filedate+'.xml', XML('MYROW', 
