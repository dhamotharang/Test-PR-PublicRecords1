...
export Out_File_Premium_Plus_Entity_Stats_Population (string filedate) := function
...
dsMain := dataset('~thor_200::persist::worldcheck::premium_plus_mapping_dedup', dsLayoutMain, flat);
...
//KEYWORDS//////////////////////////////////////////////////////////////////////
	...
	joinMainCompLinkTosAddrAddInfoIDKeyword := sort(join(joinMainCompLinkTosAddrAddInfoID, dsKeywordStat,
													left.category = right.category,
													addMainCompLinkTosAddrAddInfoIDKeywordTran(left, right), left outer), category):persist('~thor_200::persist::worldcheck::entity_stat_'+filedate);
