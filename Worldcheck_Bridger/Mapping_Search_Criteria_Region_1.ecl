...
export Mapping_Search_Criteria_Region_1 (string filedate):= function
...
//Country -------------------------------------------------------------------------
	...
	ds_country_1 := Worldcheck_Bridger.File_In_Country(Region_id='1');
	...
	File_In_Subcat 	:= dataset([{
							...
							,0
							,'Entity'
							,'8D6D7816-0201-4a96-A9B1-06392529DA6B'
							,'WORLDCHECK AFRICA'
							,'World Check - African Continent'
							,'9'
							,'False'
							,''
	...
	//output(reform_ds, named('reform_ds_1'));
