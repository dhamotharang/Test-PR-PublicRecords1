...
SHARED FldIds := DATASET([{1,'ssn'}
      ...
      ,{13,'permanent_flag'}
      ,{14,'opt_back_in'}
      ,{15,'date_yyyymmdd'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    DID_SSN_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    DID_SSN_Fields.InValid_did((SALT311.StrType)le.did),
    DID_SSN_Fields.InValid_source_flag((SALT311.StrType)le.source_flag),
    DID_SSN_Fields.InValid_julian_date((SALT311.StrType)le.julian_date),
    DID_SSN_Fields.InValid_inname_first((SALT311.StrType)le.inname_first),
    DID_SSN_Fields.InValid_inname_last((SALT311.StrType)le.inname_last),
    DID_SSN_Fields.InValid_address((SALT311.StrType)le.address),
    DID_SSN_Fields.InValid_city((SALT311.StrType)le.city),
    DID_SSN_Fields.InValid_state((SALT311.StrType)le.state),
    DID_SSN_Fields.InValid_zip5((SALT311.StrType)le.zip5),
    DID_SSN_Fields.InValid_did_score((SALT311.StrType)le.did_score),
    DID_SSN_Fields.InValid_ssn_append((SALT311.StrType)le.ssn_append),
    DID_SSN_Fields.InValid_permanent_flag((SALT311.StrType)le.permanent_flag),
    DID_SSN_Fields.InValid_opt_back_in((SALT311.StrType)le.opt_back_in),
    DID_SSN_Fields.InValid_date_yyyymmdd((SALT311.StrType)le.date_yyyymmdd),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_FCRA_Opt_Out, DID_SSN_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
