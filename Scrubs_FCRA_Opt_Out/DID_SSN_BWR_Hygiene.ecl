...
#workunit('name','Scrubs_FCRA_Opt_Out.DID_SSN_BWR_Hygiene - Hygiene & Stats - SALT V3.11.9');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT311.MAC_Character_Counts.EclRecord(p,'DID_SSN_Layout_FCRA_Opt_Out'),NAMED('OptimizedLayout'));// File layout suggested by data
