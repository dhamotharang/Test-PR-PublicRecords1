...
EXPORT Address_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_SSN_append:ALLOW(0123456789-xX):LENGTHS(9..11)\n'
    ...
    + 'FIELD:prim_range:LIKE(Invalid_Blank):TYPE(STRING10):0,0\n'
    + 'FIELD:prim_name:LIKE(Invalid_Blank):TYPE(STRING28):0,0\n'
