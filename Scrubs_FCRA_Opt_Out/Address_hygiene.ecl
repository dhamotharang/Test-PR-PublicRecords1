...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_source_flag := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.source_flag)));
    avelength_source_flag := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.source_flag)),h.source_flag<>(typeof(h.source_flag))'');
    ...
    maxlength_julian_date := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.julian_date)));
    avelength_julian_date := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.julian_date)),h.julian_date<>(typeof(h.julian_date))'');
    ...
    maxlength_inname_first := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.inname_first)));
    avelength_inname_first := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.inname_first)),h.inname_first<>(typeof(h.inname_first))'');
    ...
    maxlength_inname_last := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.inname_last)));
    avelength_inname_last := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.inname_last)),h.inname_last<>(typeof(h.inname_last))'');
    ...
    maxlength_ssn_append := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.ssn_append)));
    avelength_ssn_append := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.ssn_append)),h.ssn_append<>(typeof(h.ssn_append))'');
    ...
    maxlength_permanent_flag := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.permanent_flag)));
    avelength_permanent_flag := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.permanent_flag)),h.permanent_flag<>(typeof(h.permanent_flag))'');
    ...
    maxlength_opt_back_in := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.opt_back_in)));
    avelength_opt_back_in := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.opt_back_in)),h.opt_back_in<>(typeof(h.opt_back_in))'');
    ...
    maxlength_date_yyyymmdd := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.date_yyyymmdd)));
    avelength_date_yyyymmdd := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.date_yyyymmdd)),h.date_yyyymmdd<>(typeof(h.date_yyyymmdd))'');
  END;
...
SHARED FldIds := DATASET([{1,'z5'}
      ...
      ,{17,'permanent_flag'}
      ,{18,'opt_back_in'}
      ,{19,'date_yyyymmdd'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Address_Fields.InValid_z5((SALT311.StrType)le.z5),
    Address_Fields.InValid_prim_range((SALT311.StrType)le.prim_range),
    Address_Fields.InValid_prim_name((SALT311.StrType)le.prim_name),
    Address_Fields.InValid_sec_range((SALT311.StrType)le.sec_range),
    Address_Fields.InValid_ssn((SALT311.StrType)le.ssn),
    Address_Fields.InValid_did((SALT311.StrType)le.did),
    Address_Fields.InValid_source_flag((SALT311.StrType)le.source_flag),
    Address_Fields.InValid_julian_date((SALT311.StrType)le.julian_date),
    Address_Fields.InValid_inname_first((SALT311.StrType)le.inname_first),
    Address_Fields.InValid_inname_last((SALT311.StrType)le.inname_last),
    Address_Fields.InValid_address((SALT311.StrType)le.address),
    Address_Fields.InValid_city((SALT311.StrType)le.city),
    Address_Fields.InValid_state((SALT311.StrType)le.state),
    Address_Fields.InValid_zip5((SALT311.StrType)le.zip5),
    Address_Fields.InValid_did_score((SALT311.StrType)le.did_score),
    Address_Fields.InValid_ssn_append((SALT311.StrType)le.ssn_append),
    Address_Fields.InValid_permanent_flag((SALT311.StrType)le.permanent_flag),
    Address_Fields.InValid_opt_back_in((SALT311.StrType)le.opt_back_in),
    Address_Fields.InValid_date_yyyymmdd((SALT311.StrType)le.date_yyyymmdd),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_FCRA_Opt_Out, Address_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
