...
EXPORT Functions := MODULE
	...
	EXPORT GetVelocityRules(STRING fraudPlatform) := FUNCTION

		rulesFraudGov := DATASET([
		...
		rules := IF(FraudPlatform = FraudGovPlatform_Services.Constants.FRAUDPLATFORM, rulesFraudGov, rulesFDN);
