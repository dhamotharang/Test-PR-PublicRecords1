...
lECL 	:=	'#WORKUNIT(\'name\', \'AVB - Relatives Input\');\nRelative_AVB.proc_OutputRelativeFile();';

fSubmitNewWorkunit(lECL, 'thor400_64') : WHEN(CRON('30 9 * * *')); //Everyday at 5:30/4:30PM, check for new file.
