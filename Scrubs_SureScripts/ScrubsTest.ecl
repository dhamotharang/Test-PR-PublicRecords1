...
/*******************************************************************************/
datasetName	:=	'surescripts';
filedate		:=	'20150813';	//	Build Date
myEmail			:=	'Ashok.Kumar@lexisnexis.com';
scopename		:=	'base';//'SureScripts'; // 'base'
...
MAC_Scrubs_Report(BuildDate,myFolder,myFile)	:=	MACRO
	...
	GenerateAlertsCSVTemplate	:=	Scrubs.OrbitProfileStats(myFolder,'Scrubs',Orbit_stats,BuildDate,scope_datasetName,'20').ProfileAlertsTemplate;
...
scope 			:=	TRIM(scopename,ALL);
inFileName	:=	IF(scope<>'',scope+'_In_'+scope,'In_'+datasetName);
