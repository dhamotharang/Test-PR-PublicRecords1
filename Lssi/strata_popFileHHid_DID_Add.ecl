import ut,strata;
export strata_popFileHHid_DID_Add (string filedate) := function
ds := Lssi.File_Hhid_Did_Add;

rPopulationStats_File_Hhid_Did_Add
 :=
  record
...
tStats := table(ds,rPopulationStats_File_Hhid_Did_Add,few);

strata.createXMLStats(tStats,'LSSI Daily Additions: Customer Data','data',filedate,'',resultsOut);
return resultsout;
