import ut, doxie;
export proc_build_lssi_update_keys(string filedate) := 
function
...
bk1 := sequential(
	  buildindex(doxie.key_lssi_did_add,'~thor_data400::key::lssi::'+filedate+'::did_add',overwrite),
	  ...
	  FileServices.AddSuperFile('~thor_data400::key::lssi_did_add_built', 
						   '~thor_data400::key::lssi::'+filedate+'::did_add'));

bk2 := sequential(
       buildindex(doxie.key_lssi_hhid_add,'~thor_data400::key::lssi::'+filedate+'::hhid_add',overwrite),
	  ...
	  FileServices.AddSuperFile('~thor_data400::key::lssi_hhid_add_built', 
						   '~thor_data400::key::lssi::'+filedate+'::hhid_add'));

bk3 := sequential(
       buildindex(doxie.key_lssi_remove,'~thor_data400::key::lssi::'+filedate+'::remove',overwrite,few),
	  ...
	  FileServices.AddSuperFile('~thor_data400::key::lssi_remove_built', 
						   '~thor_data400::key::lssi::'+filedate+'::remove'));
...
return sequential(pre1,pre2,full1,full2,post1,post2,move1);
