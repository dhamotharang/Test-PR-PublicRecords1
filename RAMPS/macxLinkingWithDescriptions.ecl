...
END;
 ...
 xlinkResultsPrep1 := ecl.macFieldRename(xlinkResultsPrep, in_prefix, 'prefix_',,TRUE);
 xlinkResultsPrep2 := ecl.macFieldRename(xlinkResultsPrep1, in_prefix + '_xadl2_', 'xadl2_',,TRUE);
 xlinkResultsPrep3 := ecl.macFieldRename(xlinkResultsPrep2, in_prefix + '_xlink_', 'xlink_',,TRUE);
