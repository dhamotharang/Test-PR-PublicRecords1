...
function
	...
	VersionControl.macBuildNewLogicalKeyWithName(Key_DID_FCRA						,keyName.fcra.Did_FCRA.New			,Build_Key4);
	...
	keygroupnames := 
			...
			//+ keyName.companyname_domain.dAll_filenames    //*** Jira# DF-28405, PAW - Remove Deprecated Key
	...
	build_keys :=
		parallel(
			...
			,Build_Key2
			,Build_Key3
			//,Build_Key4  //*** Jira# DF-28405, PAW - Remove Deprecated Key
			,Build_Key4
			,Build_LinkIDs
		);
