// Generate standard terasort datafile for Graysort benchmark

unsigned8 numrecs := 1000000000000/CLUSTERSIZE : stored('numrecs');   // rows per node
...
OUTPUT(outdata,,'nhtest::terasort100',overwrite);
