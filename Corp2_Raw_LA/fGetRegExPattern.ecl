export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1	 	:= 'NAME NOT AVAILABLE|NO STREET LISTED|NONE DESIGNATED|NONE GIVEN|NONE LISTED|NO STREET LISTED|NO ADDRESS LISTED|NO ADDRESS GIVEN|NO STREET ADDRESS LISTED|';
		shared PatternInvalidWords2	 	:= 'NO STRRET ADDRESS|NO STREET ADDRESS GIVEN|NONE APPOINTED|NO STREET ADDRESS|NO STREET|LISTED|NONE';
	...
	export City := module
		...
		shared PatternInvalidWords1	 	:= 'NO CITY ADDRESS|^N(\\/)*A$|^NONE|SAME *(AS)*|^AS|UNKNOWN|UNKNONW|NKNOWN';	
