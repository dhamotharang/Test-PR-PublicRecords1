...
Command line options: -MScrubs_Corp2_Mapping_WY_Stock -eC:\Users\butlersx\AppData\Local\Temp\TFR681B.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_WY_Stock
FILENAME:In_WY
...
FIELDTYPE:invalid_stock_type:ENUM(COMMON|PREFERRED|)
FIELDTYPE:invalid_shares:ALLOW( .,0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_stock_par_value:CUSTOM(Scrubs_Corp2_Mapping_WY_Stock.Functions.invalid_stock_par_value>0)
FIELDTYPE:invalid_stock_addl_info:ALLOW( :ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:stock_addl_info:TYPE(STRING250):LIKE(invalid_stock_addl_info):0,0
