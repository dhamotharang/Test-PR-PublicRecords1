...
tokens := GlobalWatchLists.Build_TokenFile_Name_V4;
...
LayoutName	:=	GlobalWatchLists.Layout_GlobalWatchLists_V4.LayoutNameIndex	or	GlobalWatchLists.Layout_GlobalWatchLists_V4.LayoutName;
...
dNames	:=	project(dNamesNorm,LayoutName);
...
export	key_GlobalWatchLists_TokenNames_V4	:=	INDEX(tokensWithNames,
																									{tkn, ListID},
																									{tokensWithNames},
																								 GlobalWatchLists.constants.Cluster	+	'key::globalwatchlists::'	+	doxie.Version_SuperKey	+	'::token_names'); 