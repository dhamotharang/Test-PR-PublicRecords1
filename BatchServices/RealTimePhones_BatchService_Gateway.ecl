import iesp, doxie_raw, gateway;

in_layout := BatchServices.Layouts.RTPhones.rec_batch_RTPhones_input;

EXPORT RealTimePhones_BatchService_Gateway(dataset(in_layout) f_in, 
  ...
  // add rows to matchup with the original requests	
	...
	flat_out batchit(frecs LE, frecs RI) := transform
	  ...
	  self.acctno := L.acctno ;
		self.ssn := L.ssn;
	  self.phone :=  L.phone ;                            
		self.name :=   StringLib.StringCleanSpaces(L.lname + ' ' + L.fname + ' '+ L.mname);
		self.callerid_name :=  L.listed_name  ;
		self.address :=  	StringLib.StringCleanSpaces(L.prim_range+ ' ' + 
											L.predir +' ' + 
											L.prim_name +' ' + 
											L.suffix + ' ' + 
											L.postdir + ' ' + 
    ...
    line_type(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.DataSource,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.DataSource);
		self.line_type :=  line_type('C');
    phone_line_status(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.StatusCode_Desc,
																	CorP = 'P' and r.phone = '' => '',
    ...
    non_published(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.NonPublished,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.NonPublished );
		self.non_published :=  non_published('C');
		ported(string1 CorP) := CASE(map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.portingcode,
																	CorP = 'P' and r.phone = '' => '',
    ...
    operating_company_name(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.name,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.name );
		self.operating_company_name :=  operating_company_name('C') ;
    operating_company_affiliated_to(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.AffiliatedTo,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.AffiliatedTo );
		self.operating_company_affiliated_to  := operating_company_affiliated_to('C');
		operating_company_address(string1 CorP) := map (CorP = 'C' and r.phone <> '' => StringLib.StringCleanSpaces(r.RealTimePhone_Ext.OperatingCompany.address.StreetNumber+ ' ' + 
																	...
																	CorP = 'P' and r.phone = '' => '',
																	StringLib.StringCleanSpaces(L.RealTimePhone_Ext.OperatingCompany.address.StreetNumber+ ' ' + 
    ...
    operating_company_city(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.address.city,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.address.city );
		self.operating_company_city :=  operating_company_city('C');
    operating_company_state(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.address.state,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.address.state );
		self.operating_company_state :=  operating_company_state('C');
    operating_company_zip(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.address.zip5 + 
    ...
    operating_company_phone(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.PhoneInfo.PhoneNPA +
    ...
    operating_company_fax(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.PhoneInfo.FaxNPA +
    ...
    operating_company_contact(string1 CorP) := map (CorP = 'C' and r.phone <> '' => if (length(trim(R.RealTimePhone_Ext.OperatingCompany.contact.name.fullname)) > 0 ,
    ...
    company_contact_email(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.contact.email,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.contact.email );
		self.company_contact_email :=  company_contact_email('C');
    company_contact_address(string1 CorP) := map (CorP = 'C' and r.phone <> '' => StringLib.StringCleanSpaces(R.RealTimePhone_Ext.OperatingCompany.contact.address.StreetNumber+ ' ' + 
																	...
																	CorP = 'P' and r.phone = '' => '',
																	StringLib.StringCleanSpaces(L.RealTimePhone_Ext.OperatingCompany.contact.address.StreetNumber+ ' ' + 
    ...
    company_contact_city (string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.contact.address.city,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.contact.address.city);
		self.company_contact_city :=  company_contact_city('C') ;
    company_contact_state(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.contact.address.state ,
																	CorP = 'P' and r.phone = '' => '',
																	L.RealTimePhone_Ext.OperatingCompany.contact.address.state );
		self.company_contact_state :=  company_contact_state('C') ;
    company_contact_zip(string1 CorP) := map (CorP = 'C' and r.phone <> '' => R.RealTimePhone_Ext.OperatingCompany.contact.address.zip5 +
  ...
  Recs_join_ten := join(frecs,frecs2_ten, left.phone = right.phone and
																			left.fname = right.fname and
																			left.lname = right.lname and
																			left.prim_name = right.prim_name and
																			left.prim_range = right.prim_name, batchit(LEFT,right), full outer);
