...
IMPORT BatchServices, BankruptcyV3_Services, BankruptcyV3, Data_Services, dx_Banko;
...
export BkReport_BatchService(useCannedRecs = 'false') :=
    ...
    ds_moxie_court_from_full_case :=
      JOIN(ds_moxie_court, dx_banko.Key_Banko_courtcode_fullcasenumber(Data_Services.data_env.iNonFCRA),
