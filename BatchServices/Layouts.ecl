IMPORT Appriss, DCA, Doxie, LN_PropertyV2_Services, USAbizV2_Services, 
       YellowPages, AutoKey_Batch, BankruptcyV3_Services, uccv2_services, courtLink, Entiera,
			 JailBooking_Services, DriversV2_Services, Corrections, BIPV2;
...
EXPORT Layouts := MODULE
  ...
  unsigned integer6 inbdid;
	...
	EXPORT Email := Module
	  EXPORT rec_results_raw := record		 
		  layout_batch_common_acct;
			Entiera.Layouts.Base_For_Indexes and not[Clean_name, Clean_Address];
      string5  title;					
			string20 fname;					
			string20 mname;					
			string20 lname;					
		...
		export rec_results_autokey_plus := RECORD
		  layout_batch_common_acct;
			Entiera.All_Entiera_Layouts.Entiera_Autokey_layout;				
		end;
	END;
	...
	EXPORT JailBooking := Module
	  EXPORT layout_inJailBookingBatch := RECORD
		   STRING30		Alien_Number;					  //(pass thru)
			 STRING25	  FBI_Number;
			 STRING30		State_ID_Number;				
			 STRING8    Min_Booking_Date;
			 STRING8    Max_Booking_Date;
			 Autokey_batch.Layouts.rec_inBatchMaster
		END;
	  EXPORT layout_fbi_acct := record
      doxie.layout_inBatchMaster.acctno;
      Appriss.Layout_Base_Bookings.FBI_NBR;
    END;
    EXPORT layout_state_id := record
      doxie.layout_inBatchMaster.acctno;
      Appriss.Layout_Base_Bookings.state_id;
    END;
	  EXPORT layout_dlnumber := record
      doxie.layout_inBatchMaster.acctno;
      Appriss.Layout_Base_Bookings.DLNUMBER;
    END;		
		EXPORT rec_acctnos_fids := RECORD
			layout_batch_common_acct;
			INTEGER search_status      :=  0;
			STRING10  matchCode          := '';
			Appriss.Layout_Base_Bookings.BOOKING_SID; // sid == string15 booking id
			boolean isDeepDive;
		END;

    EXPORT match_reasons := RECORD
		  boolean   isDeepDive;
	    layout_batch_common_acct;
		  INTEGER   error_code := 0;
			string20  join_state_id_nbr := '';
			string20  join_dl := '';
			string20 	join_fbi_nbr :='';
			string20 	join_fl_name_dob :='';
			string20 	join_fl_name_ssn :='';
			string20  join_fl_name_addr := '';
			string20 	join_linkid :='';
		END;
		EXPORT rec_input_and_matchcodes := RECORD
			match_reasons;
			STRING8   _Min_Booking_Date;
			STRING8   _Max_Booking_Date;
			STRING 		_Last_name;
			STRING 		_First_name;
			STRING 		_Middle_Name; 
			STRING9 	_SSN ;
			STRING8 	_DOB;
			STRING30	_Alien_Number;		   
			STRING30	_State_ID_Number;
			STRING25	_FBI_Number;
			STRING25	_DL_Number;
			string10  _prim_range;
			string2   _predir;
			string28  _prim_name;
			...
			string2   _st;
			string5   _z5;
			string10  _prim_range_cln;
			string2   _predir_cln;
			string28  _prim_name_cln;
			string4   _addr_suffix_cln;
			string2   _postdir_cln;
			string10  _unit_desig_cln;
			string8   _sec_range_cln;
			string25  _p_city_name_cln;
			string2   _st_cln;
			string5   _z5_cln;
			Appriss.Layout_Base_Bookings.booking_sid; // sid == string15 booking id
		END;
   export	rec_ds_ak:= RECORD  //autokey record structure Appriss.Key_Appriss_Autokey_Payload
...
//		string DID_str;
	...
	END;
                                  //change this to rec_input_and_matchcodes - booking_sid for debugging
		EXPORT layout_joins := RECORD(match_reasons)
			Appriss.Layout_Base_Bookings AND NOT [MARKS_SCARS_TATOOS],
			TypeOf(Appriss.Layout_Base_Bookings.MARKS_SCARS_TATOOS) marks_scars_tattoos;
		END;
		EXPORT out_normalized := RECORD
		  unsigned2 record_penalty;
		  layout_joins;
			DATASET(JailBooking_Services.Layouts.bookingCharges) charges  {MAXCOUNT(BatchServices.Constants.JailBooking.MAX_CHARGES_OUT)}; 
		END;
		EXPORT out_flat := RECORD(out_normalized - charges)
			string15  charge1_booking_sid;
			String5   charge1_site_id ;
      String5   charge1_agency ;
	    string15  charge1_agencykey;		
		  integer8  charge1_charge_seq;
		  string5   charge1_charge_cnt;
			string50  charge1_charge;
			string100 charge1_description;
			string10  charge1_charge_dt;
			string10  charge1_court_dt;
			string5   charge1_key_severity;
			string15  charge1_bond_amt;
			string20  charge1_disposition_dt;
			string100 charge1_disposition_text;
			string35  charge1_ncic_offense_class_txt;
			string20  charge1_ncic_offense_cd;
			string50  charge1_bond_type_txt;
			string15  charge2_booking_sid;
			String5   charge2_site_id ;
      String5   charge2_agency ;
	    string15  charge2_agencykey;		
		  integer8  charge2_charge_seq;
		  string5   charge2_charge_cnt;
			string50  charge2_charge;
			string100 charge2_description;
			string10  charge2_charge_dt;
			string10  charge2_court_dt;
			string5   charge2_key_severity;
			string15  charge2_bond_amt;
			string20  charge2_disposition_dt;
			string100 charge2_disposition_text;
			string35  charge2_ncic_offense_class_txt;
			string20  charge2_ncic_offense_cd;
			string50  charge2_bond_type_txt;
			string15  charge3_booking_sid;
			String5   charge3_site_id ;
      String5   charge3_agency ;
	    string15  charge3_agencykey;		
		  integer8  charge3_charge_seq;
		  string5   charge3_charge_cnt;
			string50  charge3_charge;
			string100 charge3_description;
			string10  charge3_charge_dt;
			string10  charge3_court_dt;
			string5   charge3_key_severity;
			string15  charge3_bond_amt;
			string20  charge3_disposition_dt;
			string100 charge3_disposition_text;
			string35  charge3_ncic_offense_class_txt;
			string20  charge3_ncic_offense_cd;
			string50  charge3_bond_type_txt;
			string15  charge4_booking_sid;
			String5   charge4_site_id ;
      String5   charge4_agency ;
	    string15  charge4_agencykey;		
		  integer8  charge4_charge_seq;
		  string5   charge4_charge_cnt;
			string50  charge4_charge;
			string100 charge4_description;
			string10  charge4_charge_dt;
			string10  charge4_court_dt;
			string5   charge4_key_severity;
			string15  charge4_bond_amt;
			string20  charge4_disposition_dt;
			string100 charge4_disposition_text;
			string35  charge4_ncic_offense_class_txt;
			string20  charge4_ncic_offense_cd;
			string50  charge4_bond_type_txt;
			string15  charge5_booking_sid;
			String5   charge5_site_id ;
      String5   charge5_agency ;
	    string15  charge5_agencykey;		
		  integer8  charge5_charge_seq;
		  string5   charge5_charge_cnt;
			string50  charge5_charge;
			string100 charge5_description;
			string10  charge5_charge_dt;
			string10  charge5_court_dt;
			string5   charge5_key_severity;
			string15  charge5_bond_amt;
			string20  charge5_disposition_dt;
			string100 charge5_disposition_text;
			string35  charge5_ncic_offense_class_txt;
			string20  charge5_ncic_offense_cd;
			string50  charge5_bond_type_txt;			

   END;
	END;//END OF JAILBOOKING MODULE	
