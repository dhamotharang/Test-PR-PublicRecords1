...
//////////////////////////////////////////////////////////
  ...
  ds_flat_property_recs := if(isFCRA, FFD.Mac.ApplyConsumerAlertsBatch(ds_flat_sorted_recs, alert_flags, StatementsAndDisputes, BatchServices.layout_Property_Batch_out_pre, inFFDOptionsMask),
	                             ds_flat_sorted_recs);
