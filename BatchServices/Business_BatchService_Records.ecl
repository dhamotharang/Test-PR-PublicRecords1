...
IMPORT BatchServices, Business_Header_SS, DCA, Doxie_cbrs, YellowPages, ut, Business_Header, STD;

EXPORT Business_BatchService_Records(BOOLEAN useCannedRecs = FALSE) :=
	FUNCTION
		...
		add_DCA_data := JOIN(out_res_acctno,DCA.Key_DCA_BDID,
			keyed (left.bdid = right.bdid),
			transform({recordof(out_res_acctno);boolean appended := false;},
				self.appended     := right.bdid != 0,
				self.level        := right.level,
				self.root         := right.root,
				self.sub          := right.sub,
				self.parent_number:= right.parent_number,
				self.sic_cd       := right.sic1,
				self.sic_desc     := STD.Str.ToUpperCase(right.text1),
				self.sales        := right.sales,
				self.earnings     := right.earnings,
				self.num_employees:= right.emp_num,
				self.email        := right.e_mail,
				self.url          := right.url,
				self.executive_1_name  := STD.Str.ToUpperCase(right.name_1),
				self.executive_1_title := STD.Str.ToUpperCase(right.title_1),
				self.executive_2_name  := STD.Str.ToUpperCase(right.name_2),
				self.executive_2_title := STD.Str.ToUpperCase(right.title_2),
				self.executive_3_name  := STD.Str.ToUpperCase(right.name_3),
				self.executive_3_title := STD.Str.ToUpperCase(right.title_3),
				self.executive_4_name  := STD.Str.ToUpperCase(right.name_4),
				self.executive_4_title := STD.Str.ToUpperCase(right.title_4),
				self.executive_5_name  := STD.Str.ToUpperCase(right.name_5),
				self.executive_5_title := STD.Str.ToUpperCase(right.title_5),
				self.executive_6_name  := STD.Str.ToUpperCase(right.name_6),
				self.executive_6_title := STD.Str.ToUpperCase(right.title_6),
				self.executive_7_name  := STD.Str.ToUpperCase(right.name_7),
				self.executive_7_title := STD.Str.ToUpperCase(right.title_7),
				self.executive_8_name  := STD.Str.ToUpperCase(right.name_8),
				self.executive_8_title := STD.Str.ToUpperCase(right.title_8),
				self.executive_9_name  := STD.Str.ToUpperCase(right.name_9),
				self.executive_9_title := STD.Str.ToUpperCase(right.title_9),
				self.executive_10_name  := STD.Str.ToUpperCase(right.name_10),
				self.executive_10_title := STD.Str.ToUpperCase(right.title_10),
				self.secondary_sic_1_cd   := right.sic2,
				self.secondary_sic_1_desc := STD.Str.ToUpperCase(right.text2),
				self.secondary_sic_2_cd   := right.sic3,
				self.secondary_sic_2_desc := STD.Str.ToUpperCase(right.text3),
				self.secondary_sic_3_cd   := right.sic4,
				self.secondary_sic_3_desc := STD.Str.ToUpperCase(right.text4),
				self.secondary_sic_4_cd   := right.sic5,
				self.secondary_sic_4_desc := STD.Str.ToUpperCase(right.text5),
				self := left),
			keep(1), limit (ut.limits.MAX_DCA_PER_BDID),
			left outer);
