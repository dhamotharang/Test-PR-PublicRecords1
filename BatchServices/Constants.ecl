...
EXPORT Constants := MODULE
  ...
  // CFP=CompaniesForPerson Batch Service (new as of June 2010)
    ...
    // 2020-06-23, RR-19188 - Next 8 lines were added for new IPv6 key related coding changes
    EXPORT string1 colon         := ':';
    EXPORT string2 double_colon  := '::';
    EXPORT string1 period        := '.';
    EXPORT unsigned1 max_hextets := 8; // the maximum number of hextets in a full IPv6 format ip address is 8
    EXPORT string1 one_zero      := '0';
    EXPORT string2 two_zeroes    := '00';
    EXPORT string3 three_zeroes  := '000';   
    EXPORT string4 four_zeroes   := '0000';
