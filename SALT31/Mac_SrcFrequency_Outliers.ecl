EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT31.Str30Type fieldname := #TEXT(infield);
	  SALT31.StrType fieldvalue {maxlength(200000)} := (SALT31.StrType)infile.infield ;
		SALT31.StrType src {maxlength(30)} := infile.srcfield ;
