...
EXPORT Summary(SALT31.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_providertype_pcnt := AVE(GROUP,IF(h.providertype = (TYPEOF(h.providertype))'',0,100));
    maxlength_providertype := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.providertype)));
    avelength_providertype := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.providertype)),h.providertype<>(typeof(h.providertype))'');
    ...
    populated_speciality_pcnt := AVE(GROUP,IF(h.speciality = (TYPEOF(h.speciality))'',0,100));
    maxlength_speciality := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.speciality)));
    avelength_speciality := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.speciality)),h.speciality<>(typeof(h.speciality))'');
    ...
    maxlength_address1 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.address1)));
    avelength_address1 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.address1)),h.address1<>(typeof(h.address1))'');
    populated_address2_pcnt := AVE(GROUP,IF(h.address2 = (TYPEOF(h.address2))'',0,100));
    maxlength_address2 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.address2)));
    avelength_address2 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.address2)),h.address2<>(typeof(h.address2))'');
    populated_address3_pcnt := AVE(GROUP,IF(h.address3 = (TYPEOF(h.address3))'',0,100));
    maxlength_address3 := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.address3)));
    avelength_address3 := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.address3)),h.address3<>(typeof(h.address3))'');
    populated_officecity_pcnt := AVE(GROUP,IF(h.officecity = (TYPEOF(h.officecity))'',0,100));
    maxlength_officecity := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.officecity)));
    avelength_officecity := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.officecity)),h.officecity<>(typeof(h.officecity))'');
    populated_officestate_pcnt := AVE(GROUP,IF(h.officestate = (TYPEOF(h.officestate))'',0,100));
    maxlength_officestate := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.officestate)));
    avelength_officestate := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.officestate)),h.officestate<>(typeof(h.officestate))'');
    populated_officezipcode_pcnt := AVE(GROUP,IF(h.officezipcode = (TYPEOF(h.officezipcode))'',0,100));
    maxlength_officezipcode := MAX(GROUP,LENGTH(TRIM((SALT31.StrType)h.officezipcode)));
    avelength_officezipcode := AVE(GROUP,LENGTH(TRIM((SALT31.StrType)h.officezipcode)),h.officezipcode<>(typeof(h.officezipcode))'');
...
SHARED FldIds := DATASET([{1,'did'}
      ...
      ,{89,'ultid'}
      ,{90,'ultscore'}
      ,{91,'ultweight'}],SALT31.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_license_number((SALT31.StrType)le.license_number),
    Fields.InValid_npi((SALT31.StrType)le.npi),
    Fields.InValid_providertype((SALT31.StrType)le.providertype),
    Fields.InValid_name((SALT31.StrType)le.name),
    Fields.InValid_speciality((SALT31.StrType)le.speciality),
    Fields.InValid_status((SALT31.StrType)le.status),
    Fields.InValid_address1((SALT31.StrType)le.address1),
    Fields.InValid_address2((SALT31.StrType)le.address2),
    Fields.InValid_address3((SALT31.StrType)le.address3),
    Fields.InValid_officecity((SALT31.StrType)le.officecity),
    Fields.InValid_officestate((SALT31.StrType)le.officestate),
    Fields.InValid_officezipcode((SALT31.StrType)le.officezipcode),
