...
+    #IF( #TEXT(Input_data_state)='' )
    ...
    #END
+    #IF( #TEXT(Input_provider_name)='' )
      '' 
    #ELSE
        IF( le.Input_provider_name = (TYPEOF(le.Input_provider_name))'','',':provider_name')
    #END
...
+    #IF( #TEXT(Input_providertype)='' )
      '' 
    #ELSE
        IF( le.Input_providertype = (TYPEOF(le.Input_providertype))'','',':providertype')
    #END
+    #IF( #TEXT(Input_name)='' )
      '' 
    #ELSE
    ...
    #END
+    #IF( #TEXT(Input_speciality)='' )
      '' 
    #ELSE
        IF( le.Input_speciality = (TYPEOF(le.Input_speciality))'','',':speciality')
    #END
...
+    #IF( #TEXT(Input_address3)='' )
    ...
    #END
+    #IF( #TEXT(Input_officecity)='' )
      '' 
    #ELSE
        IF( le.Input_officecity = (TYPEOF(le.Input_officecity))'','',':officecity')
    #END
+    #IF( #TEXT(Input_officestate)='' )
      '' 
    #ELSE
        IF( le.Input_officestate = (TYPEOF(le.Input_officestate))'','',':officestate')
    #END
+    #IF( #TEXT(Input_officezipcode)='' )
      '' 
    #ELSE
        IF( le.Input_officezipcode = (TYPEOF(le.Input_officezipcode))'','',':officezipcode')
    #END
