...
export _blank := '';
		...
		Condition_1_Reject_DS := EmptyExceptionDS + SSN_Rej_Row + Name_First_Rej_Row+ Name_Last_Rej_Row;;
		// Condition_1_Reject_DS;
		Condition_2_Reject_DS := EmptyExceptionDS + Name_First_Rej_Row + Name_Last_Rej_Row + street_addr_Rej_Row + p_City_name_Rej_Row+ Z5_Rej_Row + ST_name_Rej_Row;
