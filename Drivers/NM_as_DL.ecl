...
//lCombined_NM_Input := Drivers.File_NM_Full;

Drivers.Layout_DL lTransform_NM_To_Common(Drivers.File_NM_Full pInput)
 := transform
	...
	self.orig_expiration_date		:= (unsigned4)pInput.orig_Expire_Date; //expiration_date is derived, doesn't get orig data
