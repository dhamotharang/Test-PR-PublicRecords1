...
EXPORT Summary(SALT34.Str30Type txt) := FUNCTION
  ...
  R1 := RECORD
    UNSIGNED LinkingPotential :=  + T.Populated_dt_vendor_first_reported_pcnt *   0.00 / 100 + T.Populated_dt_vendor_last_reported_pcnt *   0.00 / 100 + T.Populated_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_first_seen_pcnt *   0.00 / 100 + T.Populated_corp_ra_dt_last_seen_pcnt *   0.00 / 100 + T.Populated_corp_process_date_pcnt *   0.00 / 100 + T.Populated_corp_filing_date_pcnt *   0.00 / 100 + T.Populated_corp_status_date_pcnt *   0.00 / 100 + T.Populated_corp_inc_date_pcnt *   0.00 / 100 + T.Populated_corp_forgn_date_pcnt *   0.00 / 100 + T.Populated_corp_ra_resign_date_pcnt *   0.00 / 100 + T.Populated_corp_merger_date_pcnt *   0.00 / 100 + T.Populated_corp_merger_effective_date_pcnt *   0.00 / 100 + T.Populated_corp_name_reservation_date_pcnt *   0.00 / 100 + T.Populated_corp_name_reservation_expiration_date_pcnt *   0.00 / 100 + T.Populated_corp_name_status_date_pcnt *   0.00 / 100 + T.Populated_corp_key_pcnt *   0.00 / 100 + T.Populated_corp_orig_sos_charter_nbr_pcnt *   0.00 / 100 + T.Populated_corp_vendor_pcnt *   0.00 / 100 + T.Populated_corp_state_origin_pcnt *   0.00 / 100 + T.Populated_corp_inc_state_pcnt *   0.00 / 100 + T.Populated_corp_legal_name_pcnt *   0.00 / 100 + T.Populated_corp_forgn_state_desc_pcnt *   0.00 / 100 + T.Populated_cont_country_pcnt *   0.00 / 100 + T.Populated_corp_agent_country_pcnt *   0.00 / 100 + T.Populated_recordorigin_pcnt *   0.00 / 100 + T.Populated_corp_ln_name_type_cd_pcnt *   0.00 / 100 + T.Populated_corp_status_cd_pcnt *   0.00 / 100 + T.Populated_corp_name_status_cd_pcnt *   0.00 / 100 + T.Populated_corp_orig_org_structure_cd_pcnt *   0.00 / 100 + T.Populated_corp_orig_bus_type_cd_pcnt *   0.00 / 100;
    T;
  END;
  RETURN TABLE(T,R1);
END;
...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_vendor_first_reported_pcnt,le.populated_dt_vendor_last_reported_pcnt,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_corp_ra_dt_first_seen_pcnt,le.populated_corp_ra_dt_last_seen_pcnt,le.populated_corp_process_date_pcnt,le.populated_corp_filing_date_pcnt,le.populated_corp_status_date_pcnt,le.populated_corp_inc_date_pcnt,le.populated_corp_forgn_date_pcnt,le.populated_corp_ra_resign_date_pcnt,le.populated_corp_merger_date_pcnt,le.populated_corp_merger_effective_date_pcnt,le.populated_corp_name_reservation_date_pcnt,le.populated_corp_name_reservation_expiration_date_pcnt,le.populated_corp_name_status_date_pcnt,le.populated_corp_key_pcnt,le.populated_corp_orig_sos_charter_nbr_pcnt,le.populated_corp_vendor_pcnt,le.populated_corp_state_origin_pcnt,le.populated_corp_inc_state_pcnt,le.populated_corp_legal_name_pcnt,le.populated_corp_forgn_state_desc_pcnt,le.populated_cont_country_pcnt,le.populated_corp_agent_country_pcnt,le.populated_recordorigin_pcnt,le.populated_corp_ln_name_type_cd_pcnt,le.populated_corp_status_cd_pcnt,le.populated_corp_name_status_cd_pcnt,le.populated_corp_orig_org_structure_cd_pcnt,le.populated_corp_orig_bus_type_cd_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_corp_ra_dt_first_seen,le.maxlength_corp_ra_dt_last_seen,le.maxlength_corp_process_date,le.maxlength_corp_filing_date,le.maxlength_corp_status_date,le.maxlength_corp_inc_date,le.maxlength_corp_forgn_date,le.maxlength_corp_ra_resign_date,le.maxlength_corp_merger_date,le.maxlength_corp_merger_effective_date,le.maxlength_corp_name_reservation_date,le.maxlength_corp_name_reservation_expiration_date,le.maxlength_corp_name_status_date,le.maxlength_corp_key,le.maxlength_corp_orig_sos_charter_nbr,le.maxlength_corp_vendor,le.maxlength_corp_state_origin,le.maxlength_corp_inc_state,le.maxlength_corp_legal_name,le.maxlength_corp_forgn_state_desc,le.maxlength_cont_country,le.maxlength_corp_agent_country,le.maxlength_recordorigin,le.maxlength_corp_ln_name_type_cd,le.maxlength_corp_status_cd,le.maxlength_corp_name_status_cd,le.maxlength_corp_orig_org_structure_cd,le.maxlength_corp_orig_bus_type_cd);
  SELF.avelength := CHOOSE(C,le.avelength_dt_vendor_first_reported,le.avelength_dt_vendor_last_reported,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_corp_ra_dt_first_seen,le.avelength_corp_ra_dt_last_seen,le.avelength_corp_process_date,le.avelength_corp_filing_date,le.avelength_corp_status_date,le.avelength_corp_inc_date,le.avelength_corp_forgn_date,le.avelength_corp_ra_resign_date,le.avelength_corp_merger_date,le.avelength_corp_merger_effective_date,le.avelength_corp_name_reservation_date,le.avelength_corp_name_reservation_expiration_date,le.avelength_corp_name_status_date,le.avelength_corp_key,le.avelength_corp_orig_sos_charter_nbr,le.avelength_corp_vendor,le.avelength_corp_state_origin,le.avelength_corp_inc_state,le.avelength_corp_legal_name,le.avelength_corp_forgn_state_desc,le.avelength_cont_country,le.avelength_corp_agent_country,le.avelength_recordorigin,le.avelength_corp_ln_name_type_cd,le.avelength_corp_status_cd,le.avelength_corp_name_status_cd,le.avelength_corp_orig_org_structure_cd,le.avelength_corp_orig_bus_type_cd);
END;
...
SALT34.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.dt_vendor_first_reported <> 0,TRIM((SALT34.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT34.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_first_seen <> 0,TRIM((SALT34.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT34.StrType)le.dt_last_seen), ''),IF (le.corp_ra_dt_first_seen <> 0,TRIM((SALT34.StrType)le.corp_ra_dt_first_seen), ''),IF (le.corp_ra_dt_last_seen <> 0,TRIM((SALT34.StrType)le.corp_ra_dt_last_seen), ''),TRIM((SALT34.StrType)le.corp_process_date),TRIM((SALT34.StrType)le.corp_filing_date),TRIM((SALT34.StrType)le.corp_status_date),TRIM((SALT34.StrType)le.corp_inc_date),TRIM((SALT34.StrType)le.corp_forgn_date),TRIM((SALT34.StrType)le.corp_ra_resign_date),TRIM((SALT34.StrType)le.corp_merger_date),TRIM((SALT34.StrType)le.corp_merger_effective_date),TRIM((SALT34.StrType)le.corp_name_reservation_date),TRIM((SALT34.StrType)le.corp_name_reservation_expiration_date),TRIM((SALT34.StrType)le.corp_name_status_date),TRIM((SALT34.StrType)le.corp_key),TRIM((SALT34.StrType)le.corp_orig_sos_charter_nbr),TRIM((SALT34.StrType)le.corp_vendor),TRIM((SALT34.StrType)le.corp_state_origin),TRIM((SALT34.StrType)le.corp_inc_state),TRIM((SALT34.StrType)le.corp_legal_name),TRIM((SALT34.StrType)le.corp_forgn_state_desc),TRIM((SALT34.StrType)le.cont_country),TRIM((SALT34.StrType)le.corp_agent_country),TRIM((SALT34.StrType)le.recordorigin),TRIM((SALT34.StrType)le.corp_ln_name_type_cd),TRIM((SALT34.StrType)le.corp_status_cd),TRIM((SALT34.StrType)le.corp_name_status_cd),TRIM((SALT34.StrType)le.corp_orig_org_structure_cd),TRIM((SALT34.StrType)le.corp_orig_bus_type_cd)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{10,'corp_inc_date'}
      ,{11,'corp_forgn_date'}
      ,{12,'corp_ra_resign_date'}
      ,{13,'corp_merger_date'}
      ,{14,'corp_merger_effective_date'}
      ,{15,'corp_name_reservation_date'}
      ,{16,'corp_name_reservation_expiration_date'}
      ,{17,'corp_name_status_date'}
      ,{18,'corp_key'}
      ,{19,'corp_orig_sos_charter_nbr'}
      ,{20,'corp_vendor'}
      ,{21,'corp_state_origin'}
      ,{22,'corp_inc_state'}
      ,{23,'corp_legal_name'}
      ,{24,'corp_forgn_state_desc'}
      ,{25,'cont_country'}
      ,{26,'corp_agent_country'}
      ,{27,'recordorigin'}
      ,{28,'corp_ln_name_type_cd'}
      ,{29,'corp_status_cd'}
      ,{30,'corp_name_status_cd'}
      ,{31,'corp_orig_org_structure_cd'}
      ,{32,'corp_orig_bus_type_cd'}],SALT34.MAC_Character_Counts.Field_Identification);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_corp_key','invalid_charter','invalid_corp_vendor','invalid_state_origin','invalid_state_origin','invalid_mandatory','invalid_alphablankperiod','invalid_alphablankperiod','invalid_alphablankperiod','Unknown','invalid_name_type_cd','invalid_status_cd','invalid_status_cd','invalid_orig_org_structure_cd','invalid_bus_type_cd');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_process_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_filing_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_status_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_resign_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_effective_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_name_reservation_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_name_reservation_expiration_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_name_status_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_sos_charter_nbr(TotalErrors.ErrorNum),Fields.InValidMessage_corp_vendor(TotalErrors.ErrorNum),Fields.InValidMessage_corp_state_origin(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_state(TotalErrors.ErrorNum),Fields.InValidMessage_corp_legal_name(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_state_desc(TotalErrors.ErrorNum),Fields.InValidMessage_cont_country(TotalErrors.ErrorNum),Fields.InValidMessage_corp_agent_country(TotalErrors.ErrorNum),Fields.InValidMessage_recordorigin(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ln_name_type_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_status_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_name_status_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_org_structure_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_bus_type_cd(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
