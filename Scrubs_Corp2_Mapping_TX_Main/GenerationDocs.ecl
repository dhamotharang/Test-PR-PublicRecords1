...
Command line options: -MScrubs_Corp2_Mapping_TX_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR6875.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_TX_Main
FILENAME:In_TX
...
FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(4..13)
FIELDTYPE:invalid_corp_vendor:ENUM(48)
FIELDTYPE:invalid_state_origin:ENUM(TX)
FIELDTYPE:invalid_charter:ALLOW(0123456789):LENGTHS(1..10)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_TX_Main.Functions.invalid_name_type_code>0,recordOrigin)
FIELDTYPE:invalid_status_cd:ENUM(set_valid_status_cd)
FIELDTYPE:invalid_orig_org_structure_cd:ENUM(set_valid_structure_cd)
