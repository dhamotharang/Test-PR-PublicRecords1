...
export params := interface(AutoStandardI.InterfaceTranslator.application_type_val.params)
  ...
  shared header_quick.layout_records byDids(Dataset (doxie.layout_references) in_dids,
  ...
  export  COA_services.Layouts.rawrec getMasterRec(Dataset (dx_header.layout_header) in_recs,
                                                   params in_mod,
