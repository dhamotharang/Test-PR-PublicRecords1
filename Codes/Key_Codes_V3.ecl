...
export key_codes_v3 := index(file_codes_v3_in,
                             ...
                             data_services.data_location.prefix() + 'thor_data400::key::codes_v3_'+doxie.Version_SuperKey, HINT(forceRemoteDisabled(true)));  //adding HINT to help with performance of Thor workunits
#END;
