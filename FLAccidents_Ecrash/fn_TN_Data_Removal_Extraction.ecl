...
EXPORT fn_TN_Data_Removal_Extraction(STRING Pdate = (STRING) STD.Date.CurrentDate(TRUE)) := FUNCTION
...
//Incident input file 
 incident := dataset(Data_Services.foreign_prod+'thor_data400::in::ecrash::incidnt_raw_new'
  ...
  tn_incident := incident(loss_state_abbr = 'TN' AND creation_date < '2019-04-01' AND work_type_id = '0'
                         AND source_id IN ['TM','TF'] AND agency_id NOT IN ['1627940','1626500','1629790','1521612']) :PERSIST('~THOR::BASE::PERSIST::ECRASH::TN_DATA_REMOVAL::INCIDENT', EXPIRE(30));
	...
	unq_tn_incident := DEDUP(SORT(d_tn_incident, incident_id, -(sent_to_hpcc_datetime), LOCAL), incident_id, LOCAL)  :PERSIST('~THOR::BASE::PERSIST::ECRASH::TN_DATA_REMOVAL::UNIQUE_INCIDENTS', EXPIRE(30));
