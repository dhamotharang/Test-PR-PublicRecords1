...
EXPORT fn_SendEmail(
       STRING BuildName, // Name of Build
			 ...
			 UNSIGNED1 EmailType = Constants_MBSAgency.EMAIL_TYPE_SUCCESS // Email Type
			 )	:= FUNCTION
...
//      @BILLING : 2
// ###########################################################################
	EmailTypeSuccess := Constants_MBSAgency.EMAIL_TYPE_SUCCESS;
	EmailTypeFailure := Constants_MBSAgency.EMAIL_TYPE_FAILURE;
	EmailTypeBilling := Constants_MBSAgency.EMAIL_TYPE_BILLING;
