/*
One time BWR to expand base file layout father version with new field Releasable.
*/
IMPORT Data_Services, PromoteSupers;
EXPORT Update_Base_Releasable := FUNCTION
 ...
 END;
	...
	ds_Base := DATASET(Data_Services.foreign_prod+'thor_data400::base::ecrash', Lay, THOR);
