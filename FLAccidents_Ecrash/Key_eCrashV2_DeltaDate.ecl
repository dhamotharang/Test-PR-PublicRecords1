...
MaxDate := MAX(pull(FLAccidents_Ecrash.key_EcrashV2_accnbrv1)(report_code in ['EA','TM','TF'] and work_type_id not in ['2','3'] and trim(report_type_id,all) in ['A','DE']),(integer)date_vendor_last_reported);
