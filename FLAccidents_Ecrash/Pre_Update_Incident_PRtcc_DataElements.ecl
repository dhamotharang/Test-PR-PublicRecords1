/*
One time BWR to expand Incident file layout with new PRtcc fields.
*/
IMPORT Data_Services;
EXPORT Pre_Update_Incident_PRtcc_DataElements := FUNCTION
 ...
 OUTPUT(upd_incident_layout,,'~thor_data400::in::ecrash::incident_layout_change_prtcc_'+workunit,overwrite,__compressed__,
				csv(terminator('\n'), separator(','),quote('"'),maxlength(60000)));

 do_all :=  SEQUENTIAL(
												FileServices.StartSuperFileTransaction(),
												FileServices.AddSuperFile('~thor_data400::in::ecrash::incidnt_raw_new','~thor_data400::in::ecrash::incident_layout_change_prtcc_'+workunit),
