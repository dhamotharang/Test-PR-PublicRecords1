...
EXPORT As_Ingenix (STRING filedate, boolean pUseProd = true) := MODULE
		...
		EXPORT Sanctions_All := dedup(prep3,record,all) :persist('~thor400_data::persist::Facility_Sanctions_All2');

		//////////////////////////////////////////////////////////
		// Sanctioned_facilities_Bdid
		//////////////////////////////////////////////////////////

		outlayout  := {Ingenix_NatlProf.layout_sanctions_bdid, unsigned6 lnpid};
