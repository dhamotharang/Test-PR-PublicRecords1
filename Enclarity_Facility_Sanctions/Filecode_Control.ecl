...
EXPORT Filecode_Control(string filedate, boolean pUseProd = false) := MODULE
	...
	EXPORT cumulative_filecodes	:= [
								...
								'SNC_MAF2','SNC_MAF3','SNC_MDF3','SNC_MEF1','SNC_MIF1','SNC_MNF4','SNC_NCF1','SNC_NCF5','SNC_NEF2','SNC_NMF3',
								'SNC_NVF3','SNC_NYF3','SNC_OHF3','SNC_OKF3','SNC_PAF3','SNC_RIF1','SNC_TNF2','SNC_TXF2','SNC_TXF4','SNC_TXF5',
								'SNC_UTF1','SNC_UTF2','SNC_VAF1','SNC_VTF2','SNC_VTF3','SNC_WIF1','SNC_WYF1'];
	...
	EXPORT fullrefresh_filecodes:= [
								...
								'SNC_NHF2','SNC_NHF3','SNC_NJF3','SNC_NVF1','SNC_NYF1','SNC_NYF2' ,'SNC_OHF1','SNC_ORF3','SNC_PAF1','SNC_PAF2',
								'SNC_SCF2','SNC_SCF3','SNC_TNF1','SNC-WAF1'];
