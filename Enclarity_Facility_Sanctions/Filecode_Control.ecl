...
EXPORT Filecode_Control(string filedate, boolean pUseProd = false) := MODULE
	...
	EXPORT cumulative_filecodes	:= [
								...
								'SNC_MAF2','SNC_MAF3','SNC_MDF3','SNC_MEF1','SNC_MIF1','SNC_MNF4','SNC_NCF1','SNC_NCF5','SNC_NMF3','SNC_NVF3',
								'SNC_NYF3','SNC_OHF3','SNC_OKF3','SNC_RIF1','SNC_TNF2','SNC_TXF2','SNC_TXF4','SNC_TXF5','SNC_UTF1','SNC_VAF1',
								'SNC_VTF2','SNC_VTF3','SNC_WIF1','SNC_WYF1'];
