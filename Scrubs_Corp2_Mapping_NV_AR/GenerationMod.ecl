...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_NV_AR';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_NV_AR\n'
    + 'FILENAME:In_NV\n'
    ...
    + 'FIELDTYPE:invalid_ar_type:CUSTOM(Scrubs_Corp2_Mapping_NV_AR.Functions.ValidActionTypes>0)\n'
    + 'FIELDTYPE:invalid_future_date:ALLOW(0123456789):CUSTOM(Scrubs.fn_valid_GeneralDate>0)\n'
    + 'FIELDTYPE:invalid_rptnbr:ALLOW( -.,ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789)\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
    ...
    + 'FIELD:ar_report_nbr:TYPE(STRING30):LIKE(invalid_rptnbr):0,0\n'
