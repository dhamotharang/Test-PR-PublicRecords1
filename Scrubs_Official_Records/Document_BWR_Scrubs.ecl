...
#workunit('name','Scrubs_Official_Records.Document_BWR_Scrubs - Checking field validity in a file - SALT V3.11.4');
IMPORT Scrubs_Official_Records,SALT311;
infile := Scrubs_Official_Records.Document_In_Official_Records;
mod_scrubs := Scrubs_Official_Records.Document_Scrubs;
