...
/* 
	move_type may be
		'QM' for movement from BUILT to QA, BUILT1 to BUILT, BUILT2 to BUILT1, etc
	...
	map(	  %built_count% = %qa_count% and
		...
		sequential(
				...
				FileServices.AddSuperFile(%father%, %qa%,, true),
					...
					FileServices.AddSuperFile(%difffather%, %diffqa%,, true),
				#end
				...
				FileServices.RemoveOwnedSubFiles(%delete%,true), 
				#if(diffing)
					FileServices.RemoveOwnedSubFiles(%diffdelete%,true),
				#end
