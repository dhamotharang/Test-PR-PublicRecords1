...
module
	...
	function
		...
		transform
			...
			self.prim_range		:= l.Clean_best_address.prim_range	;
			self.prim_name		:= l.Clean_best_address.prim_name		;
			self.sec_range		:= l.Clean_best_address.sec_range		;
			self.zip5				 	:= l.Clean_best_address.zip					;
			self.state				:= l.Clean_best_address.st					;
	...
	function
		...
		transform
			...
			self.company_name	:= l.rawfields.Organization_Name_Primary	;
			self.prim_range		:= l.Clean_best_address.prim_range				;
			self.prim_name		:= l.Clean_best_address.prim_name					;
			self.zip5					:= l.Clean_best_address.zip								;
			self.sec_range		:= l.Clean_best_address.sec_range					;
