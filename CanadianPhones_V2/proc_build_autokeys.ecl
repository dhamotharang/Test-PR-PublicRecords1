...
BASE_NAME := CanadianPhones_V2.Constants.FILE_NAME_MASK;
...
createSuperAutoFiles () := FUNCTION
  return PARALLEL (createVersion ('built'), createVersion ('qa'), createVersion ('father'), createVersion ('Grandfather'));
END;
...
// ===========================================================================
  ...
  RoxieKeyBuild.Mac_SK_BuildProcess_v2_local (key_fdids, '',
    '~thor_data400::key::canadianwp_v2::'+filedate+'::fdids', bld_fdid);
				 
// ===========================================================================
// ============================ BUILD AUTOKEYS ===============================
// ===========================================================================
  base := file_cwp_with_fdid;
...
akmod := module(AutokeyB2.Fn_Build.params)
	...
	export set of string1 L_build_skip_set 		:= CanadianPhones_V2.Constants.skip_set;
end;	
...
// ========================================================================
  ...
  RoxieKeyBuild.Mac_SK_Move_to_Built_v2('~thor_data400::key::canadianwp_v2::fdids',
	   '~thor_data400::key::canadianwp_v2::'+filedate+'::fdids',mv_fdid_to_blt);

  PromoteSupers.MAC_SK_Move_v2('~thor_data400::key::canadianwp_v2::fdids', 'Q', mv_fdid_to_qa);
