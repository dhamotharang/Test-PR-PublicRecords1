IMPORT Ut, hms_kop_trgt_harv,HealthCare_Provider_Header;

EXPORT fAppendLnpid(DATASET(hms_kop_trgt_harv.Layouts.layout_base) pDataset) := FUNCTION
												...
												inFields := MODULE(HealthCare_Provider_Header.IxLinkInput)
																				...
																				EXPORT Input_LIC_TYPE              := 'stlic_type';
																				...
																				EXPORT Input_NPI_NUMBER            := 'npi';
																				EXPORT Input_UPIN                  := '';
																				EXPORT Input_DEA_NUMBER            := 'dea1';
																				EXPORT Input_LIC_STATE             := 'stlic_state';
																				EXPORT Input_LIC_NBR               := 'stlic_number';
																				EXPORT Input_SSN                   := '';
																				EXPORT Input_DOB                   := 'date_born';
												END;
			...
			RETURN PROJECT(results, hms_kop_trgt_harv.Layouts.layout_base);
END;