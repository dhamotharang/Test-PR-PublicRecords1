IMPORT Business_Header, ut, business_risk,doxie_cbrs, roxiekeybuild,VersionControl;

export proc_build_Business_Header_Keys(

	 string pversion
	,dataset(Business_Header.Layout_BH_Best					)	pBH_Best										= Business_Header.BestAll				()
	,dataset(Layout_CompanyName_SS									)	pCompanyName								= CompanyName										()
	,dataset(Layout_CompanyName_Address_SS					)	pCompanyName_Address				= CompanyName_Address						()
	,dataset(Layout_CompanyName_Address_Broad_SS    ) pCompanyName_Address_Broad	= CompanyName_Address_Broad			()
	,dataset(Layout_CompanyName_Phone_SS						)	pCompanyName_Phone					= CompanyName_Phone							()
	,dataset(Layout_CompanyName_FEIN_SS							)	pCompanyName_FEIN						= CompanyName_FEIN							()
	,dataset(Business_Header.Layout_BH_Super_Group	)	pBH_Super_Group							= Business_Header.BH_Super_Group()
...
module
	...
	VersionControl.macBuildNewLogicalFile( names.CompanynameAddress.new			,pCompanyName_Address				,Build_Slimsort_CN_Address_File				);
	VersionControl.macBuildNewLogicalFile( names.CompanynameAddressBroad.new,pCompanyName_Address_Broad	,Build_Slimsort_CN_Address_Broad_File	);
	...
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_CompanyName											,keyname.Base.CompanynameBdidCnBdids.New	,Build_Base_CompanynameBdidCnBdids_Key	);
	VersionControl.macBuildNewLogicalKeyWithName(Key_BH_CompanyName_Unlimited									,keyname.Base.Companyname.New							,Build_Base_Companyname_Key							);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Addr_pr_pn_sr_st									,keyname.Base.AddrPrPnSrSt.New						,Build_Base_AddrPrPnSrSt_Key						);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Addr_pr_pn_zip										,keyname.Base.AddrPrPnZip.New							,Build_Base_AddrPrPnZip_Key							);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Addr_st													,keyname.Base.AddrSt.New									,Build_Base_AddrSt_Key									);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Addr_zip													,keyname.Base.AddrZip.New									,Build_Base_AddrZip_Key									);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Phone														,keyname.Base.Phone.New										,Build_Base_Phone_Key										);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_FEIN															,keyname.Base.Fein.New										,Build_Base_Fein_Key										);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_Source														,keyname.Base.Src.New											,Build_Base_Src_Key											);
	VersionControl.macBuildNewLogicalKeyWithName(Key_Prep_BH_BDID															,keyname.Base.Bdid.New										,Build_Base_Bdid_Key										);
	VersionControl.macBuildNewLogicalKeyWithName(Key_BH_BDID_pl																,keyname.Base.BdidPl.New									,Build_Base_BdidPl_Key									);
	...
	sequential(
		...
		,business_header.promote(pversion,'best').new2built
