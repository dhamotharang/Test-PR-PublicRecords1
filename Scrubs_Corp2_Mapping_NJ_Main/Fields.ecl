...
EXPORT SALT32.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_name_type_code','invalid_name_type_desc','invalid_forgn_dom_code','invalid_corp_status_code','invalid_corp_orig_org_structure_cd','invalid_flag_code','invalid_country','invalid_charter','invalid_date','invalid_optional_date','invalid_alphablank');
EXPORT FieldTypeNum(SALT32.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_name_type_code' => 5,'invalid_name_type_desc' => 6,'invalid_forgn_dom_code' => 7,'invalid_corp_status_code' => 8,'invalid_corp_orig_org_structure_cd' => 9,'invalid_flag_code' => 10,'invalid_country' => 11,'invalid_charter' => 12,'invalid_date' => 13,'invalid_optional_date' => 14,'invalid_alphablank' => 15,0);
 
EXPORT MakeFT_invalid_corp_key(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'0123456789-'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_corp_key(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'0123456789-'))),~(LENGTH(TRIM(s)) = 13));
EXPORT InValidMessageFT_invalid_corp_key(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('0123456789-'),SALT32.HygieneErrors.NotLength('13'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_vendor(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['34']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('34'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['NJ']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('NJ'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_name_type_code(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['01']);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('01'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['LEGAL']);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('LEGAL'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_corp_status_code(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_status_code(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['ACT','CAN','CGN','DBB','DIS','DLC','DPC','DPP','DRV','DTM','DWA','EVP','EXP','MRG','RAT','REV','RIN','RPP','RST','TDR','TRM','VPC','WTD','WTH','WTM','XFR','XNP','XPG']);
EXPORT InValidMessageFT_invalid_corp_status_code(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('ACT|CAN|CGN|DBB|DIS|DLC|DPC|DPP|DRV|DTM|DWA|EVP|EXP|MRG|RAT|REV|RIN|RPP|RST|TDR|TRM|VPC|WTD|WTH|WTM|XFR|XNP|XPG'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_orig_org_structure_cd(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_orig_org_structure_cd(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['AUT','DB','DP','FGP','FLC','FLP','FR','GP','LF','LLC','LLP','LP','NF','NJR','NP','PA']);
EXPORT InValidMessageFT_invalid_corp_orig_org_structure_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('AUT|DB|DP|FGP|FLC|FLP|FR|GP|LF|LLC|LLP|LP|NF|NJR|NP|PA'),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_flag_code(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['Y','N',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('Y|N| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_country(SALT32.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_country(SALT32.StrType s) := WHICH(((SALT32.StrType) s) NOT IN ['US',' ']);
EXPORT InValidMessageFT_invalid_country(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInEnum('US| '),SALT32.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_charter(SALT32.StrType s0) := FUNCTION
  s1 := SALT32.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_charter(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'0123456789'))),~(LENGTH(TRIM(s)) = 10));
EXPORT InValidMessageFT_invalid_charter(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('0123456789'),SALT32.HygieneErrors.NotLength('10'),SALT32.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_optional_date(SALT32.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_optional_date(SALT32.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT32.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_pastDate(s)>0,~(LENGTH(TRIM(s)) = 0 OR LENGTH(TRIM(s)) = 8));
EXPORT InValidMessageFT_invalid_optional_date(UNSIGNED1 wh) := CHOOSE(wh,SALT32.HygieneErrors.NotInChars('0123456789'),SALT32.HygieneErrors.CustomFail('Scrubs.fn_valid_pastDate'),SALT32.HygieneErrors.NotLength('0,8'),SALT32.HygieneErrors.Good);
...
EXPORT InValid_corp_ln_name_type_cd(SALT32.StrType s) := InValidFT_invalid_name_type_code(s);
...
EXPORT Make_corp_address1_line3(SALT32.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_corp_address1_line3(SALT32.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_corp_address1_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
...
EXPORT Make_corp_status_cd(SALT32.StrType s0) := MakeFT_invalid_corp_status_code(s0);
EXPORT InValid_corp_status_cd(SALT32.StrType s) := InValidFT_invalid_corp_status_code(s);
EXPORT InValidMessage_corp_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_corp_status_code(wh);
 
EXPORT Make_corp_status_desc(SALT32.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_corp_status_desc(SALT32.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_corp_status_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_corp_status_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_status_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_standing(SALT32.StrType s0) := s0;
EXPORT InValid_corp_standing(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_standing(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_status_comment(SALT32.StrType s0) := s0;
EXPORT InValid_corp_status_comment(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_inc_county(SALT32.StrType s0) := s0;
EXPORT InValid_corp_inc_county(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_term_exist_cd(SALT32.StrType s0) := s0;
EXPORT InValid_corp_term_exist_cd(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_term_exist_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_term_exist_exp(SALT32.StrType s0) := s0;
EXPORT InValid_corp_term_exist_exp(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_term_exist_exp(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_term_exist_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_term_exist_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_forgn_state_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_forgn_state_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_orig_org_structure_desc(SALT32.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_corp_orig_org_structure_desc(SALT32.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_corp_orig_org_structure_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
 
EXPORT Make_corp_for_profit_ind(SALT32.StrType s0) := MakeFT_invalid_flag_code(s0);
EXPORT InValid_corp_for_profit_ind(SALT32.StrType s) := InValidFT_invalid_flag_code(s);
...
EXPORT Make_corp_ra_full_name(SALT32.StrType s0) := MakeFT_invalid_mandatory(s0);
EXPORT InValid_corp_ra_full_name(SALT32.StrType s) := InValidFT_invalid_mandatory(s);
EXPORT InValidMessage_corp_ra_full_name(UNSIGNED1 wh) := InValidMessageFT_invalid_mandatory(wh);
...
EXPORT Make_corp_ra_effective_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_ra_effective_date(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_ra_address_type_desc(SALT32.StrType s0) := s0;
EXPORT InValid_corp_ra_address_type_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_ra_address_line3(SALT32.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_corp_ra_address_line3(SALT32.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_corp_ra_address_line3(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
...
EXPORT Make_cont_filing_date(SALT32.StrType s0) := s0;
EXPORT InValid_cont_filing_date(SALT32.StrType s) := FALSE;
...
EXPORT Make_cont_filing_desc(SALT32.StrType s0) := s0;
EXPORT InValid_cont_filing_desc(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_cont_filing_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_type_cd(SALT32.StrType s0) := s0;
EXPORT InValid_cont_type_cd(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_cont_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_cont_type_desc(SALT32.StrType s0) := s0;
EXPORT InValid_cont_type_desc(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_action_pending_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_action_pending_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_additonal_info(SALT32.StrType s0) := s0;
EXPORT InValid_corp_additonal_info(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_additonal_info(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_agent_commericial(SALT32.StrType s0) := s0;
EXPORT InValid_corp_agent_commericial(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_agent_commericial(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_agent_status(SALT32.StrType s0) := s0;
EXPORT InValid_corp_agent_status(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_agent_status(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agent_status_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_agent_status_description(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_agent_status_description(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_agents_id(SALT32.StrType s0) := s0;
EXPORT InValid_corp_agents_id(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_agents_id(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_country_of_formation(SALT32.StrType s0) := s0;
EXPORT InValid_corp_country_of_formation(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_farm_status(SALT32.StrType s0) := s0;
EXPORT InValid_corp_farm_status(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_farm_status(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_llc_managed_ind(SALT32.StrType s0) := s0;
EXPORT InValid_corp_llc_managed_ind(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_llc_managed_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_management_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_management_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_merger_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_merger_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_merger_type_converted_to_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_merger_type_converted_to_description(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_merger_type_converted_to_description(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_naics_code(SALT32.StrType s0) := s0;
EXPORT InValid_corp_naics_code(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_naics_code(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_naics_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_naics_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_name_reservation_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_name_reservation_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_expiration_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_expiration_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_name_reservation_expiration_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_reservation_number(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_reservation_number(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_name_status_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_status_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_name_status_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_name_status_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_name_status_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_number_of_ammendments(SALT32.StrType s0) := s0;
EXPORT InValid_corp_number_of_ammendments(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_number_of_ammendments(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_opt_in_llc_act_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_opt_in_llc_act_description(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_percentage_voters_required_to_approve_ammendments(SALT32.StrType s0) := s0;
EXPORT InValid_corp_percentage_voters_required_to_approve_ammendments(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_percentage_voters_required_to_approve_ammendments(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_termination_description(SALT32.StrType s0) := s0;
EXPORT InValid_corp_termination_description(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_termination_description(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_terminiation_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_terminiation_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_terminiation_date(UNSIGNED1 wh) := '';
...
EXPORT Make_corp_trademark_first_use_date(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_first_use_date(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_first_use_date(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_first_use_date_in_state(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_first_use_date_in_state(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_trademark_class_description1(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description1(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_class_description1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_description2(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description2(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_class_description2(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_description3(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description3(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_class_description3(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_description4(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description4(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_class_description4(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_description5(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description5(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_trademark_class_description5(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_trademark_class_description6(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_class_description6(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_trademark_status(SALT32.StrType s0) := s0;
EXPORT InValid_corp_trademark_status(SALT32.StrType s) := FALSE;
...
EXPORT Make_cont_country(SALT32.StrType s0) := s0;
EXPORT InValid_cont_country(SALT32.StrType s) := FALSE;
...
EXPORT Make_corp_prep_addr_line1(SALT32.StrType s0) := s0;
EXPORT InValid_corp_prep_addr_line1(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_corp_prep_addr_line1(UNSIGNED1 wh) := '';
 
EXPORT Make_corp_prep_addr_last_line(SALT32.StrType s0) := s0;
EXPORT InValid_corp_prep_addr_last_line(SALT32.StrType s) := FALSE;
...
EXPORT Make_record_type(SALT32.StrType s0) := s0;
EXPORT InValid_record_type(SALT32.StrType s) := FALSE;
EXPORT InValidMessage_record_type(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT32,Scrubs_Corp2_Mapping_NJ_Main;
...
#uniquename(dl)
  %dl% := RECORD
    ...
    BOOLEAN Diff_corp_additonal_info;
    BOOLEAN Diff_corp_address_office_type;
    BOOLEAN Diff_corp_agent_commericial;
    BOOLEAN Diff_corp_agent_country;
    BOOLEAN Diff_corp_agent_county;
    BOOLEAN Diff_corp_agent_status;
    BOOLEAN Diff_corp_agent_status_description;
    BOOLEAN Diff_corp_agents_id;
    ...
    BOOLEAN Diff_corp_number_of_ammendments;
    ...
    BOOLEAN Diff_corp_percentage_voters_required_to_approve_ammendments;
    ...
    BOOLEAN Diff_corp_terminiation_date;
...
#uniquename(fd)
  %dl% %fd%(in_left le,in_right ri) := TRANSFORM
    ...
    SELF.Diff_corp_additonal_info := le.corp_additonal_info <> ri.corp_additonal_info;
    SELF.Diff_corp_address_office_type := le.corp_address_office_type <> ri.corp_address_office_type;
    SELF.Diff_corp_agent_commericial := le.corp_agent_commericial <> ri.corp_agent_commericial;
    ...
    SELF.Diff_corp_agent_status := le.corp_agent_status <> ri.corp_agent_status;
    SELF.Diff_corp_agent_status_description := le.corp_agent_status_description <> ri.corp_agent_status_description;
    SELF.Diff_corp_agents_id := le.corp_agents_id <> ri.corp_agents_id;
    ...
    SELF.Diff_corp_farm_status := le.corp_farm_status <> ri.corp_farm_status;
    ...
    SELF.Diff_corp_naics_code := le.corp_naics_code <> ri.corp_naics_code;
    ...
    SELF.Diff_corp_number_of_ammendments := le.corp_number_of_ammendments <> ri.corp_number_of_ammendments;
    ...
    SELF.Diff_corp_percentage_voters_required_to_approve_ammendments := le.corp_percentage_voters_required_to_approve_ammendments <> ri.corp_percentage_voters_required_to_approve_ammendments;
    ...
    SELF.Diff_corp_terminiation_date := le.corp_terminiation_date <> ri.corp_terminiation_date;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_corp_additonal_info := COUNT(GROUP,%Closest%.Diff_corp_additonal_info);
    Count_Diff_corp_address_office_type := COUNT(GROUP,%Closest%.Diff_corp_address_office_type);
    Count_Diff_corp_agent_commericial := COUNT(GROUP,%Closest%.Diff_corp_agent_commericial);
    ...
    Count_Diff_corp_agent_status := COUNT(GROUP,%Closest%.Diff_corp_agent_status);
    Count_Diff_corp_agent_status_description := COUNT(GROUP,%Closest%.Diff_corp_agent_status_description);
    Count_Diff_corp_agents_id := COUNT(GROUP,%Closest%.Diff_corp_agents_id);
    ...
    Count_Diff_corp_farm_status := COUNT(GROUP,%Closest%.Diff_corp_farm_status);
    ...
    Count_Diff_corp_naics_code := COUNT(GROUP,%Closest%.Diff_corp_naics_code);
    ...
    Count_Diff_corp_number_of_ammendments := COUNT(GROUP,%Closest%.Diff_corp_number_of_ammendments);
    ...
    Count_Diff_corp_percentage_voters_required_to_approve_ammendments := COUNT(GROUP,%Closest%.Diff_corp_percentage_voters_required_to_approve_ammendments);
    ...
    Count_Diff_corp_terminiation_date := COUNT(GROUP,%Closest%.Diff_corp_terminiation_date);
