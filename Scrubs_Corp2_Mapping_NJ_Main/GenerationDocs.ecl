...
Command line options: -MScrubs_Corp2_Mapping_NJ_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR289B.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_NJ_Main
FILENAME:In_NJ
...
FIELDTYPE:invalid_corp_vendor:ENUM(34)
FIELDTYPE:invalid_state_origin:ENUM(NJ)
FIELDTYPE:invalid_mandatory:LENGTHS(1..)
FIELDTYPE:invalid_name_type_code:ENUM(01)
FIELDTYPE:invalid_name_type_desc:ENUM(LEGAL)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F)
FIELDTYPE:invalid_corp_status_code:ENUM(ACT|CAN|CGN|DBB|DIS|DLC|DPC|DPP|DRV|DTM|DWA|EVP|EXP|MRG|RAT|REV|RIN|RPP|RST|TDR|TRM|VPC|WTD|WTH|WTM|XFR|XNP|XPG)
FIELDTYPE:invalid_corp_orig_org_structure_cd:ENUM(AUT|DB|DP|FGP|FLC|FLP|FR|GP|LF|LLC|LLP|LP|NF|NJR|NP|PA)
FIELDTYPE:invalid_flag_code:ENUM(Y|N| )
FIELDTYPE:invalid_country:ENUM(US| )
...
FIELDTYPE:invalid_optional_date:ALLOW(0123456789):LENGTHS(0,8):CUSTOM(Scrubs.fn_valid_pastDate>0)
...
FIELD:corp_address1_line3:TYPE(STRING70):LIKE(invalid_country):0,0
...
FIELD:corp_status_desc:TYPE(STRING60):LIKE(invalid_mandatory):0,0
...
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):LIKE(invalid_mandatory):0,0
...
FIELD:corp_ra_address_line3:TYPE(STRING70):LIKE(invalid_country):0,0
...
// Fields below here are not being used for NJ
...
FIELD:corp_agent_commericial:TYPE(STRING1):0,0
...
FIELD:corp_agents_id:TYPE(STRING8):0,0
...
FIELD:corp_farm_status:TYPE(STRING1):0,0
