...
+    #IF( #TEXT(Input_corp_action_pending_code)='' )
      '' 
    #ELSE
        IF( le.Input_corp_action_pending_code = (TYPEOF(le.Input_corp_action_pending_code))'','',':corp_action_pending_code')
    #END
 
+    #IF( #TEXT(Input_corp_action_pending_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_action_pending_description = (TYPEOF(le.Input_corp_action_pending_description))'','',':corp_action_pending_description')
    #END
...
+    #IF( #TEXT(Input_corp_additonal_info)='' )
      '' 
    #ELSE
        IF( le.Input_corp_additonal_info = (TYPEOF(le.Input_corp_additonal_info))'','',':corp_additonal_info')
    #END
...
+    #IF( #TEXT(Input_corp_agent_commericial)='' )
      '' 
    #ELSE
        IF( le.Input_corp_agent_commericial = (TYPEOF(le.Input_corp_agent_commericial))'','',':corp_agent_commericial')
    #END
...
+    #IF( #TEXT(Input_corp_agent_status)='' )
      '' 
    #ELSE
        IF( le.Input_corp_agent_status = (TYPEOF(le.Input_corp_agent_status))'','',':corp_agent_status')
    #END
 
+    #IF( #TEXT(Input_corp_agent_status_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_agent_status_description = (TYPEOF(le.Input_corp_agent_status_description))'','',':corp_agent_status_description')
    #END
 
+    #IF( #TEXT(Input_corp_agents_id)='' )
      '' 
    #ELSE
        IF( le.Input_corp_agents_id = (TYPEOF(le.Input_corp_agents_id))'','',':corp_agents_id')
    #END
...
+    #IF( #TEXT(Input_corp_cmt)='' )
      '' 
    #ELSE
        IF( le.Input_corp_cmt = (TYPEOF(le.Input_corp_cmt))'','',':corp_cmt')
    #END
...
+    #IF( #TEXT(Input_corp_farm_status)='' )
      '' 
    #ELSE
        IF( le.Input_corp_farm_status = (TYPEOF(le.Input_corp_farm_status))'','',':corp_farm_status')
    #END
...
+    #IF( #TEXT(Input_corp_hasmembers)='' )
      '' 
    #ELSE
        IF( le.Input_corp_hasmembers = (TYPEOF(le.Input_corp_hasmembers))'','',':corp_hasmembers')
    #END
 
+    #IF( #TEXT(Input_corp_hasvestedmanagers)='' )
      '' 
    #ELSE
        IF( le.Input_corp_hasvestedmanagers = (TYPEOF(le.Input_corp_hasvestedmanagers))'','',':corp_hasvestedmanagers')
    #END
...
+    #IF( #TEXT(Input_corp_isnonprofitirsapproved)='' )
      '' 
    #ELSE
        IF( le.Input_corp_isnonprofitirsapproved = (TYPEOF(le.Input_corp_isnonprofitirsapproved))'','',':corp_isnonprofitirsapproved')
    #END
...
+    #IF( #TEXT(Input_corp_management_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_management_description = (TYPEOF(le.Input_corp_management_description))'','',':corp_management_description')
    #END
...
+    #IF( #TEXT(Input_corp_merger_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_merger_description = (TYPEOF(le.Input_corp_merger_description))'','',':corp_merger_description')
    #END
...
+    #IF( #TEXT(Input_corp_merger_type_converted_to_code)='' )
      '' 
    #ELSE
        IF( le.Input_corp_merger_type_converted_to_code = (TYPEOF(le.Input_corp_merger_type_converted_to_code))'','',':corp_merger_type_converted_to_code')
    #END
 
+    #IF( #TEXT(Input_corp_merger_type_converted_to_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_merger_type_converted_to_description = (TYPEOF(le.Input_corp_merger_type_converted_to_description))'','',':corp_merger_type_converted_to_description')
    #END
 
+    #IF( #TEXT(Input_corp_naics_code)='' )
      '' 
    #ELSE
        IF( le.Input_corp_naics_code = (TYPEOF(le.Input_corp_naics_code))'','',':corp_naics_code')
    #END
 
+    #IF( #TEXT(Input_corp_naics_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_naics_description = (TYPEOF(le.Input_corp_naics_description))'','',':corp_naics_description')
    #END
...
+    #IF( #TEXT(Input_corp_name_reservation_number)='' )
      '' 
    #ELSE
        IF( le.Input_corp_name_reservation_number = (TYPEOF(le.Input_corp_name_reservation_number))'','',':corp_name_reservation_number')
    #END
...
+    #IF( #TEXT(Input_corp_name_status_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_name_status_description = (TYPEOF(le.Input_corp_name_status_description))'','',':corp_name_status_description')
    #END
 
+    #IF( #TEXT(Input_corp_nonprofitirsapprovedpurpose)='' )
      '' 
    #ELSE
        IF( le.Input_corp_nonprofitirsapprovedpurpose = (TYPEOF(le.Input_corp_nonprofitirsapprovedpurpose))'','',':corp_nonprofitirsapprovedpurpose')
    #END
 
+    #IF( #TEXT(Input_corp_nonprofitsolicitdonations)='' )
      '' 
    #ELSE
        IF( le.Input_corp_nonprofitsolicitdonations = (TYPEOF(le.Input_corp_nonprofitsolicitdonations))'','',':corp_nonprofitsolicitdonations')
    #END
 
+    #IF( #TEXT(Input_corp_number_of_ammendments)='' )
      '' 
    #ELSE
        IF( le.Input_corp_number_of_ammendments = (TYPEOF(le.Input_corp_number_of_ammendments))'','',':corp_number_of_ammendments')
    #END
 
+    #IF( #TEXT(Input_corp_number_of_initial_llc_members)='' )
      '' 
    #ELSE
        IF( le.Input_corp_number_of_initial_llc_members = (TYPEOF(le.Input_corp_number_of_initial_llc_members))'','',':corp_number_of_initial_llc_members')
    #END
 
+    #IF( #TEXT(Input_corp_number_of_partners)='' )
      '' 
    #ELSE
        IF( le.Input_corp_number_of_partners = (TYPEOF(le.Input_corp_number_of_partners))'','',':corp_number_of_partners')
    #END
 
+    #IF( #TEXT(Input_corp_operatingagreement)='' )
      '' 
    #ELSE
        IF( le.Input_corp_operatingagreement = (TYPEOF(le.Input_corp_operatingagreement))'','',':corp_operatingagreement')
    #END
 
+    #IF( #TEXT(Input_corp_opt_in_llc_act_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_opt_in_llc_act_description = (TYPEOF(le.Input_corp_opt_in_llc_act_description))'','',':corp_opt_in_llc_act_description')
    #END
...
+    #IF( #TEXT(Input_corp_original_business_type)='' )
      '' 
    #ELSE
        IF( le.Input_corp_original_business_type = (TYPEOF(le.Input_corp_original_business_type))'','',':corp_original_business_type')
    #END
...
+    #IF( #TEXT(Input_corp_percentage_voters_required_to_approve_ammendments)='' )
      '' 
    #ELSE
        IF( le.Input_corp_percentage_voters_required_to_approve_ammendments = (TYPEOF(le.Input_corp_percentage_voters_required_to_approve_ammendments))'','',':corp_percentage_voters_required_to_approve_ammendments')
    #END
...
+    #IF( #TEXT(Input_corp_termination_code)='' )
      '' 
    #ELSE
        IF( le.Input_corp_termination_code = (TYPEOF(le.Input_corp_termination_code))'','',':corp_termination_code')
    #END
 
+    #IF( #TEXT(Input_corp_termination_description)='' )
      '' 
    #ELSE
        IF( le.Input_corp_termination_description = (TYPEOF(le.Input_corp_termination_description))'','',':corp_termination_description')
    #END
 
+    #IF( #TEXT(Input_corp_terminiation_date)='' )
      '' 
    #ELSE
        IF( le.Input_corp_terminiation_date = (TYPEOF(le.Input_corp_terminiation_date))'','',':corp_terminiation_date')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_classification_number)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_classification_number = (TYPEOF(le.Input_corp_trademark_classification_number))'','',':corp_trademark_classification_number')
    #END
...
+    #IF( #TEXT(Input_corp_trademark_class_description1)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description1 = (TYPEOF(le.Input_corp_trademark_class_description1))'','',':corp_trademark_class_description1')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_class_description2)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description2 = (TYPEOF(le.Input_corp_trademark_class_description2))'','',':corp_trademark_class_description2')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_class_description3)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description3 = (TYPEOF(le.Input_corp_trademark_class_description3))'','',':corp_trademark_class_description3')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_class_description4)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description4 = (TYPEOF(le.Input_corp_trademark_class_description4))'','',':corp_trademark_class_description4')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_class_description5)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description5 = (TYPEOF(le.Input_corp_trademark_class_description5))'','',':corp_trademark_class_description5')
    #END
 
+    #IF( #TEXT(Input_corp_trademark_class_description6)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_class_description6 = (TYPEOF(le.Input_corp_trademark_class_description6))'','',':corp_trademark_class_description6')
    #END
...
+    #IF( #TEXT(Input_corp_trademark_number)='' )
      '' 
    #ELSE
        IF( le.Input_corp_trademark_number = (TYPEOF(le.Input_corp_trademark_number))'','',':corp_trademark_number')
    #END
