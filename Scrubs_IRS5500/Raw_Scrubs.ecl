...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 97;
  EXPORT NumRulesFromFieldType := 97;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 97;
  ...
  EXPORT Expanded_Layout := RECORD(Raw_Layout_IRS5500)
    ...
    UNSIGNED1 spons_dfe_ein_Invalid;
...
EXPORT FromNone(DATASET(Raw_Layout_IRS5500) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.spons_dfe_ein_Invalid := Raw_Fields.InValid_spons_dfe_ein((SALT311.StrType)le.spons_dfe_ein);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.ack_id_Invalid << 0 ) + ( le.form_plan_year_begin_date_Invalid << 1 ) + ( le.form_tax_prd_Invalid << 2 ) + ( le.type_plan_entity_cd_Invalid << 3 ) + ( le.type_dfe_plan_entity_cd_Invalid << 4 ) + ( le.initial_filing_ind_Invalid << 5 ) + ( le.amended_ind_Invalid << 6 ) + ( le.final_filing_ind_Invalid << 7 ) + ( le.short_plan_yr_ind_Invalid << 8 ) + ( le.collective_bargain_ind_Invalid << 9 ) + ( le.f5558_application_filed_ind_Invalid << 10 ) + ( le.ext_automatic_ind_Invalid << 11 ) + ( le.dfvc_program_ind_Invalid << 12 ) + ( le.ext_special_ind_Invalid << 13 ) + ( le.plan_name_Invalid << 14 ) + ( le.spons_dfe_pn_Invalid << 15 ) + ( le.plan_eff_date_Invalid << 16 ) + ( le.sponsor_dfe_name_Invalid << 17 ) + ( le.spons_dfe_dba_name_Invalid << 18 ) + ( le.spons_dfe_care_of_name_Invalid << 19 ) + ( le.spons_dfe_mail_us_address1_Invalid << 20 ) + ( le.spons_dfe_mail_us_city_Invalid << 21 ) + ( le.spons_dfe_mail_us_state_Invalid << 22 ) + ( le.spons_dfe_mail_us_zip_Invalid << 23 ) + ( le.spons_dfe_mail_foreign_addr1_Invalid << 24 ) + ( le.spons_dfe_mail_foreign_city_Invalid << 25 ) + ( le.spons_dfe_mail_forgn_prov_st_Invalid << 26 ) + ( le.spons_dfe_mail_foreign_cntry_Invalid << 27 ) + ( le.spons_dfe_mail_forgn_postal_cd_Invalid << 28 ) + ( le.spons_dfe_loc_us_address1_Invalid << 29 ) + ( le.spons_dfe_loc_us_city_Invalid << 30 ) + ( le.spons_dfe_loc_us_state_Invalid << 31 ) + ( le.spons_dfe_loc_us_zip_Invalid << 32 ) + ( le.spons_dfe_loc_foreign_address1_Invalid << 33 ) + ( le.spons_dfe_loc_foreign_city_Invalid << 34 ) + ( le.spons_dfe_loc_forgn_prov_st_Invalid << 35 ) + ( le.spons_dfe_loc_foreign_cntry_Invalid << 36 ) + ( le.spons_dfe_loc_forgn_postal_cd_Invalid << 37 ) + ( le.spons_dfe_ein_Invalid << 38 ) + ( le.spons_dfe_phone_num_Invalid << 39 ) + ( le.business_code_Invalid << 40 ) + ( le.admin_name_Invalid << 41 ) + ( le.admin_care_of_name_Invalid << 42 ) + ( le.admin_us_address1_Invalid << 43 ) + ( le.admin_us_city_Invalid << 44 ) + ( le.admin_us_state_Invalid << 45 ) + ( le.admin_us_zip_Invalid << 46 ) + ( le.admin_foreign_address1_Invalid << 47 ) + ( le.admin_foreign_city_Invalid << 48 ) + ( le.admin_foreign_prov_state_Invalid << 49 ) + ( le.admin_foreign_cntry_Invalid << 50 ) + ( le.admin_foreign_postal_cd_Invalid << 51 ) + ( le.admin_ein_Invalid << 52 ) + ( le.admin_phone_num_Invalid << 53 ) + ( le.last_rpt_spons_name_Invalid << 54 ) + ( le.last_rpt_spons_ein_Invalid << 55 ) + ( le.last_rpt_plan_num_Invalid << 56 ) + ( le.admin_signed_date_Invalid << 57 ) + ( le.admin_signed_name_Invalid << 58 ) + ( le.spons_signed_date_Invalid << 59 ) + ( le.spons_signed_name_Invalid << 60 ) + ( le.dfe_signed_date_Invalid << 61 ) + ( le.dfe_signed_name_Invalid << 62 ) + ( le.tot_partcp_boy_cnt_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.tot_active_partcp_cnt_Invalid << 0 ) + ( le.rtd_sep_partcp_rcvg_cnt_Invalid << 1 ) + ( le.rtd_sep_partcp_fut_cnt_Invalid << 2 ) + ( le.subtl_act_rtd_sep_cnt_Invalid << 3 ) + ( le.benef_rcvg_bnft_cnt_Invalid << 4 ) + ( le.tot_act_rtd_sep_benef_cnt_Invalid << 5 ) + ( le.partcp_account_bal_cnt_Invalid << 6 ) + ( le.sep_partcp_partl_vstd_cnt_Invalid << 7 ) + ( le.contrib_emplrs_cnt_Invalid << 8 ) + ( le.type_pension_bnft_code_Invalid << 9 ) + ( le.type_welfare_bnft_code_Invalid << 10 ) + ( le.funding_insurance_ind_Invalid << 11 ) + ( le.funding_sec412_ind_Invalid << 12 ) + ( le.funding_trust_ind_Invalid << 13 ) + ( le.funding_gen_asset_ind_Invalid << 14 ) + ( le.benefit_insurance_ind_Invalid << 15 ) + ( le.benefit_sec412_ind_Invalid << 16 ) + ( le.benefit_trust_ind_Invalid << 17 ) + ( le.benefit_gen_asset_ind_Invalid << 18 ) + ( le.sch_r_attached_ind_Invalid << 19 ) + ( le.sch_mb_attached_ind_Invalid << 20 ) + ( le.sch_sb_attached_ind_Invalid << 21 ) + ( le.sch_h_attached_ind_Invalid << 22 ) + ( le.sch_i_attached_ind_Invalid << 23 ) + ( le.sch_a_attached_ind_Invalid << 24 ) + ( le.num_sch_a_attached_cnt_Invalid << 25 ) + ( le.sch_c_attached_ind_Invalid << 26 ) + ( le.sch_d_attached_ind_Invalid << 27 ) + ( le.sch_g_attached_ind_Invalid << 28 ) + ( le.filing_status_Invalid << 29 ) + ( le.date_received_Invalid << 30 ) + ( le.admin_phone_num_foreign_Invalid << 31 ) + ( le.spons_dfe_phone_num_foreign_Invalid << 32 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.spons_dfe_ein_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.spons_dfe_phone_num_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.business_code_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.admin_name_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.admin_care_of_name_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.admin_us_address1_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.admin_us_city_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.admin_us_state_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.admin_us_zip_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.admin_foreign_address1_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.admin_foreign_city_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.admin_foreign_prov_state_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.admin_foreign_cntry_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.admin_foreign_postal_cd_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.admin_ein_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.admin_phone_num_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.last_rpt_spons_name_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.last_rpt_spons_ein_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.last_rpt_plan_num_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.admin_signed_date_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.admin_signed_name_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.spons_signed_date_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.spons_signed_name_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.dfe_signed_date_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.dfe_signed_name_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.tot_partcp_boy_cnt_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.tot_active_partcp_cnt_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.rtd_sep_partcp_rcvg_cnt_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.rtd_sep_partcp_fut_cnt_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.subtl_act_rtd_sep_cnt_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.benef_rcvg_bnft_cnt_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.tot_act_rtd_sep_benef_cnt_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.partcp_account_bal_cnt_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.sep_partcp_partl_vstd_cnt_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.contrib_emplrs_cnt_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.type_pension_bnft_code_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.type_welfare_bnft_code_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.funding_insurance_ind_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.funding_sec412_ind_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.funding_trust_ind_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.funding_gen_asset_ind_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.benefit_insurance_ind_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.benefit_sec412_ind_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.benefit_trust_ind_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.benefit_gen_asset_ind_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.sch_r_attached_ind_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.sch_mb_attached_ind_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.sch_sb_attached_ind_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.sch_h_attached_ind_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.sch_i_attached_ind_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.sch_a_attached_ind_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.num_sch_a_attached_cnt_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.sch_c_attached_ind_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.sch_d_attached_ind_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.sch_g_attached_ind_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.filing_status_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.date_received_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.admin_phone_num_foreign_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.spons_dfe_phone_num_foreign_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    spons_dfe_ein_CUSTOM_ErrorCount := COUNT(GROUP,h.spons_dfe_ein_Invalid=1);
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.spons_dfe_ein_Invalid,'CUSTOM','UNKNOWN')
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'spons_dfe_ein:invalid_numeric:CUSTOM'
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Raw_Fields.InvalidMessage_spons_dfe_ein(1)
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.spons_dfe_ein_CUSTOM_ErrorCount
