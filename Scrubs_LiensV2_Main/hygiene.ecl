IMPORT ut,SALT30;
EXPORT hygiene(dataset(layout_Liens_Main) h) := MODULE
...
EXPORT Summary(SALT30.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_record_code := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.record_code)));
    avelength_record_code := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.record_code)),h.record_code<>(typeof(h.record_code))'');
    populated_date_vendor_removed_pcnt := AVE(GROUP,IF(h.date_vendor_removed = (TYPEOF(h.date_vendor_removed))'',0,100));
    maxlength_date_vendor_removed := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.date_vendor_removed)));
    avelength_date_vendor_removed := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.date_vendor_removed)),h.date_vendor_removed<>(typeof(h.date_vendor_removed))'');
    ...
    maxlength_filing_state := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_state)));
    avelength_filing_state := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_state)),h.filing_state<>(typeof(h.filing_state))'');
    populated_orig_filing_number_pcnt := AVE(GROUP,IF(h.orig_filing_number = (TYPEOF(h.orig_filing_number))'',0,100));
    maxlength_orig_filing_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_number)));
    avelength_orig_filing_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_number)),h.orig_filing_number<>(typeof(h.orig_filing_number))'');
    populated_orig_filing_type_pcnt := AVE(GROUP,IF(h.orig_filing_type = (TYPEOF(h.orig_filing_type))'',0,100));
    maxlength_orig_filing_type := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_type)));
    avelength_orig_filing_type := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_type)),h.orig_filing_type<>(typeof(h.orig_filing_type))'');
    ...
    maxlength_orig_filing_time := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_time)));
    avelength_orig_filing_time := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_filing_time)),h.orig_filing_time<>(typeof(h.orig_filing_time))'');
    ...
    maxlength_filing_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_number)));
    avelength_filing_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_number)),h.filing_number<>(typeof(h.filing_number))'');
    populated_filing_type_desc_pcnt := AVE(GROUP,IF(h.filing_type_desc = (TYPEOF(h.filing_type_desc))'',0,100));
    maxlength_filing_type_desc := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_type_desc)));
    avelength_filing_type_desc := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_type_desc)),h.filing_type_desc<>(typeof(h.filing_type_desc))'');
    populated_filing_date_pcnt := AVE(GROUP,IF(h.filing_date = (TYPEOF(h.filing_date))'',0,100));
    maxlength_filing_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_date)));
    avelength_filing_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_date)),h.filing_date<>(typeof(h.filing_date))'');
    populated_filing_time_pcnt := AVE(GROUP,IF(h.filing_time = (TYPEOF(h.filing_time))'',0,100));
    maxlength_filing_time := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_time)));
    avelength_filing_time := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_time)),h.filing_time<>(typeof(h.filing_time))'');
    populated_vendor_entry_date_pcnt := AVE(GROUP,IF(h.vendor_entry_date = (TYPEOF(h.vendor_entry_date))'',0,100));
    maxlength_vendor_entry_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.vendor_entry_date)));
    avelength_vendor_entry_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.vendor_entry_date)),h.vendor_entry_date<>(typeof(h.vendor_entry_date))'');
    populated_judge_pcnt := AVE(GROUP,IF(h.judge = (TYPEOF(h.judge))'',0,100));
    maxlength_judge := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.judge)));
    avelength_judge := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.judge)),h.judge<>(typeof(h.judge))'');
    populated_case_title_pcnt := AVE(GROUP,IF(h.case_title = (TYPEOF(h.case_title))'',0,100));
    maxlength_case_title := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.case_title)));
    avelength_case_title := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.case_title)),h.case_title<>(typeof(h.case_title))'');
    populated_filing_book_pcnt := AVE(GROUP,IF(h.filing_book = (TYPEOF(h.filing_book))'',0,100));
    maxlength_filing_book := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_book)));
    avelength_filing_book := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_book)),h.filing_book<>(typeof(h.filing_book))'');
    populated_filing_page_pcnt := AVE(GROUP,IF(h.filing_page = (TYPEOF(h.filing_page))'',0,100));
    maxlength_filing_page := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_page)));
    avelength_filing_page := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.filing_page)),h.filing_page<>(typeof(h.filing_page))'');
    populated_release_date_pcnt := AVE(GROUP,IF(h.release_date = (TYPEOF(h.release_date))'',0,100));
    maxlength_release_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.release_date)));
    avelength_release_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.release_date)),h.release_date<>(typeof(h.release_date))'');
    populated_amount_pcnt := AVE(GROUP,IF(h.amount = (TYPEOF(h.amount))'',0,100));
    maxlength_amount := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.amount)));
    avelength_amount := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.amount)),h.amount<>(typeof(h.amount))'');
    populated_eviction_pcnt := AVE(GROUP,IF(h.eviction = (TYPEOF(h.eviction))'',0,100));
    maxlength_eviction := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.eviction)));
    avelength_eviction := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.eviction)),h.eviction<>(typeof(h.eviction))'');
    populated_satisifaction_type_pcnt := AVE(GROUP,IF(h.satisifaction_type = (TYPEOF(h.satisifaction_type))'',0,100));
    maxlength_satisifaction_type := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.satisifaction_type)));
    avelength_satisifaction_type := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.satisifaction_type)),h.satisifaction_type<>(typeof(h.satisifaction_type))'');
    populated_judg_satisfied_date_pcnt := AVE(GROUP,IF(h.judg_satisfied_date = (TYPEOF(h.judg_satisfied_date))'',0,100));
    maxlength_judg_satisfied_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.judg_satisfied_date)));
    avelength_judg_satisfied_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.judg_satisfied_date)),h.judg_satisfied_date<>(typeof(h.judg_satisfied_date))'');
    populated_judg_vacated_date_pcnt := AVE(GROUP,IF(h.judg_vacated_date = (TYPEOF(h.judg_vacated_date))'',0,100));
    maxlength_judg_vacated_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.judg_vacated_date)));
    avelength_judg_vacated_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.judg_vacated_date)),h.judg_vacated_date<>(typeof(h.judg_vacated_date))'');
    populated_tax_code_pcnt := AVE(GROUP,IF(h.tax_code = (TYPEOF(h.tax_code))'',0,100));
    maxlength_tax_code := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.tax_code)));
    avelength_tax_code := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.tax_code)),h.tax_code<>(typeof(h.tax_code))'');
    populated_irs_serial_number_pcnt := AVE(GROUP,IF(h.irs_serial_number = (TYPEOF(h.irs_serial_number))'',0,100));
    maxlength_irs_serial_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.irs_serial_number)));
    avelength_irs_serial_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.irs_serial_number)),h.irs_serial_number<>(typeof(h.irs_serial_number))'');
    populated_effective_date_pcnt := AVE(GROUP,IF(h.effective_date = (TYPEOF(h.effective_date))'',0,100));
    maxlength_effective_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.effective_date)));
    avelength_effective_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.effective_date)),h.effective_date<>(typeof(h.effective_date))'');
    populated_lapse_date_pcnt := AVE(GROUP,IF(h.lapse_date = (TYPEOF(h.lapse_date))'',0,100));
    maxlength_lapse_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.lapse_date)));
    avelength_lapse_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.lapse_date)),h.lapse_date<>(typeof(h.lapse_date))'');
    populated_accident_date_pcnt := AVE(GROUP,IF(h.accident_date = (TYPEOF(h.accident_date))'',0,100));
    maxlength_accident_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.accident_date)));
    avelength_accident_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.accident_date)),h.accident_date<>(typeof(h.accident_date))'');
    populated_sherrif_indc_pcnt := AVE(GROUP,IF(h.sherrif_indc = (TYPEOF(h.sherrif_indc))'',0,100));
    maxlength_sherrif_indc := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.sherrif_indc)));
    avelength_sherrif_indc := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.sherrif_indc)),h.sherrif_indc<>(typeof(h.sherrif_indc))'');
    populated_expiration_date_pcnt := AVE(GROUP,IF(h.expiration_date = (TYPEOF(h.expiration_date))'',0,100));
    maxlength_expiration_date := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.expiration_date)));
    avelength_expiration_date := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.expiration_date)),h.expiration_date<>(typeof(h.expiration_date))'');
    populated_agency_pcnt := AVE(GROUP,IF(h.agency = (TYPEOF(h.agency))'',0,100));
    maxlength_agency := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency)));
    avelength_agency := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency)),h.agency<>(typeof(h.agency))'');
    populated_agency_city_pcnt := AVE(GROUP,IF(h.agency_city = (TYPEOF(h.agency_city))'',0,100));
    maxlength_agency_city := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_city)));
    avelength_agency_city := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_city)),h.agency_city<>(typeof(h.agency_city))'');
    populated_agency_state_pcnt := AVE(GROUP,IF(h.agency_state = (TYPEOF(h.agency_state))'',0,100));
    maxlength_agency_state := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_state)));
    avelength_agency_state := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_state)),h.agency_state<>(typeof(h.agency_state))'');
    populated_agency_county_pcnt := AVE(GROUP,IF(h.agency_county = (TYPEOF(h.agency_county))'',0,100));
    maxlength_agency_county := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_county)));
    avelength_agency_county := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.agency_county)),h.agency_county<>(typeof(h.agency_county))'');
    populated_legal_lot_pcnt := AVE(GROUP,IF(h.legal_lot = (TYPEOF(h.legal_lot))'',0,100));
    maxlength_legal_lot := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_lot)));
    avelength_legal_lot := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_lot)),h.legal_lot<>(typeof(h.legal_lot))'');
    populated_legal_block_pcnt := AVE(GROUP,IF(h.legal_block = (TYPEOF(h.legal_block))'',0,100));
    maxlength_legal_block := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_block)));
    avelength_legal_block := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_block)),h.legal_block<>(typeof(h.legal_block))'');
    populated_legal_borough_pcnt := AVE(GROUP,IF(h.legal_borough = (TYPEOF(h.legal_borough))'',0,100));
    maxlength_legal_borough := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_borough)));
    avelength_legal_borough := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.legal_borough)),h.legal_borough<>(typeof(h.legal_borough))'');
    populated_certificate_number_pcnt := AVE(GROUP,IF(h.certificate_number = (TYPEOF(h.certificate_number))'',0,100));
    maxlength_certificate_number := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.certificate_number)));
    avelength_certificate_number := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.certificate_number)),h.certificate_number<>(typeof(h.certificate_number))'');
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.tmsid),TRIM((SALT30.StrType)le.rmsid),TRIM((SALT30.StrType)le.orig_rmsid),TRIM((SALT30.StrType)le.process_date),TRIM((SALT30.StrType)le.record_code),TRIM((SALT30.StrType)le.date_vendor_removed),TRIM((SALT30.StrType)le.filing_jurisdiction),TRIM((SALT30.StrType)le.filing_state),TRIM((SALT30.StrType)le.orig_filing_number),TRIM((SALT30.StrType)le.orig_filing_type),TRIM((SALT30.StrType)le.orig_filing_date),TRIM((SALT30.StrType)le.orig_filing_time),TRIM((SALT30.StrType)le.case_number),TRIM((SALT30.StrType)le.filing_number),TRIM((SALT30.StrType)le.filing_type_desc),TRIM((SALT30.StrType)le.filing_date),TRIM((SALT30.StrType)le.filing_time),TRIM((SALT30.StrType)le.vendor_entry_date),TRIM((SALT30.StrType)le.judge),TRIM((SALT30.StrType)le.case_title),TRIM((SALT30.StrType)le.filing_book),TRIM((SALT30.StrType)le.filing_page),TRIM((SALT30.StrType)le.release_date),TRIM((SALT30.StrType)le.amount),TRIM((SALT30.StrType)le.eviction),TRIM((SALT30.StrType)le.satisifaction_type),TRIM((SALT30.StrType)le.judg_satisfied_date),TRIM((SALT30.StrType)le.judg_vacated_date),TRIM((SALT30.StrType)le.tax_code),TRIM((SALT30.StrType)le.irs_serial_number),TRIM((SALT30.StrType)le.effective_date),TRIM((SALT30.StrType)le.lapse_date),TRIM((SALT30.StrType)le.accident_date),TRIM((SALT30.StrType)le.sherrif_indc),TRIM((SALT30.StrType)le.expiration_date),TRIM((SALT30.StrType)le.agency),TRIM((SALT30.StrType)le.agency_city),TRIM((SALT30.StrType)le.agency_state),TRIM((SALT30.StrType)le.agency_county),TRIM((SALT30.StrType)le.legal_lot),TRIM((SALT30.StrType)le.legal_block),TRIM((SALT30.StrType)le.legal_borough),TRIM((SALT30.StrType)le.certificate_number),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_file)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 45);
  SELF.FldNo2 := 1 + (C % 45);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.tmsid),TRIM((SALT30.StrType)le.rmsid),TRIM((SALT30.StrType)le.orig_rmsid),TRIM((SALT30.StrType)le.process_date),TRIM((SALT30.StrType)le.record_code),TRIM((SALT30.StrType)le.date_vendor_removed),TRIM((SALT30.StrType)le.filing_jurisdiction),TRIM((SALT30.StrType)le.filing_state),TRIM((SALT30.StrType)le.orig_filing_number),TRIM((SALT30.StrType)le.orig_filing_type),TRIM((SALT30.StrType)le.orig_filing_date),TRIM((SALT30.StrType)le.orig_filing_time),TRIM((SALT30.StrType)le.case_number),TRIM((SALT30.StrType)le.filing_number),TRIM((SALT30.StrType)le.filing_type_desc),TRIM((SALT30.StrType)le.filing_date),TRIM((SALT30.StrType)le.filing_time),TRIM((SALT30.StrType)le.vendor_entry_date),TRIM((SALT30.StrType)le.judge),TRIM((SALT30.StrType)le.case_title),TRIM((SALT30.StrType)le.filing_book),TRIM((SALT30.StrType)le.filing_page),TRIM((SALT30.StrType)le.release_date),TRIM((SALT30.StrType)le.amount),TRIM((SALT30.StrType)le.eviction),TRIM((SALT30.StrType)le.satisifaction_type),TRIM((SALT30.StrType)le.judg_satisfied_date),TRIM((SALT30.StrType)le.judg_vacated_date),TRIM((SALT30.StrType)le.tax_code),TRIM((SALT30.StrType)le.irs_serial_number),TRIM((SALT30.StrType)le.effective_date),TRIM((SALT30.StrType)le.lapse_date),TRIM((SALT30.StrType)le.accident_date),TRIM((SALT30.StrType)le.sherrif_indc),TRIM((SALT30.StrType)le.expiration_date),TRIM((SALT30.StrType)le.agency),TRIM((SALT30.StrType)le.agency_city),TRIM((SALT30.StrType)le.agency_state),TRIM((SALT30.StrType)le.agency_county),TRIM((SALT30.StrType)le.legal_lot),TRIM((SALT30.StrType)le.legal_block),TRIM((SALT30.StrType)le.legal_borough),TRIM((SALT30.StrType)le.certificate_number),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_file)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.tmsid),TRIM((SALT30.StrType)le.rmsid),TRIM((SALT30.StrType)le.orig_rmsid),TRIM((SALT30.StrType)le.process_date),TRIM((SALT30.StrType)le.record_code),TRIM((SALT30.StrType)le.date_vendor_removed),TRIM((SALT30.StrType)le.filing_jurisdiction),TRIM((SALT30.StrType)le.filing_state),TRIM((SALT30.StrType)le.orig_filing_number),TRIM((SALT30.StrType)le.orig_filing_type),TRIM((SALT30.StrType)le.orig_filing_date),TRIM((SALT30.StrType)le.orig_filing_time),TRIM((SALT30.StrType)le.case_number),TRIM((SALT30.StrType)le.filing_number),TRIM((SALT30.StrType)le.filing_type_desc),TRIM((SALT30.StrType)le.filing_date),TRIM((SALT30.StrType)le.filing_time),TRIM((SALT30.StrType)le.vendor_entry_date),TRIM((SALT30.StrType)le.judge),TRIM((SALT30.StrType)le.case_title),TRIM((SALT30.StrType)le.filing_book),TRIM((SALT30.StrType)le.filing_page),TRIM((SALT30.StrType)le.release_date),TRIM((SALT30.StrType)le.amount),TRIM((SALT30.StrType)le.eviction),TRIM((SALT30.StrType)le.satisifaction_type),TRIM((SALT30.StrType)le.judg_satisfied_date),TRIM((SALT30.StrType)le.judg_vacated_date),TRIM((SALT30.StrType)le.tax_code),TRIM((SALT30.StrType)le.irs_serial_number),TRIM((SALT30.StrType)le.effective_date),TRIM((SALT30.StrType)le.lapse_date),TRIM((SALT30.StrType)le.accident_date),TRIM((SALT30.StrType)le.sherrif_indc),TRIM((SALT30.StrType)le.expiration_date),TRIM((SALT30.StrType)le.agency),TRIM((SALT30.StrType)le.agency_city),TRIM((SALT30.StrType)le.agency_state),TRIM((SALT30.StrType)le.agency_county),TRIM((SALT30.StrType)le.legal_lot),TRIM((SALT30.StrType)le.legal_block),TRIM((SALT30.StrType)le.legal_borough),TRIM((SALT30.StrType)le.certificate_number),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_file)));
  END;
...
SHARED FldIds := DATASET([{1,'tmsid'}
      ...
      ,{45,'source_file'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_record_code((SALT30.StrType)le.record_code),
    Fields.InValid_date_vendor_removed((SALT30.StrType)le.date_vendor_removed),
    Fields.InValid_filing_jurisdiction((SALT30.StrType)le.filing_jurisdiction),
    Fields.InValid_filing_state((SALT30.StrType)le.filing_state),
    Fields.InValid_orig_filing_number((SALT30.StrType)le.orig_filing_number),
    Fields.InValid_orig_filing_type((SALT30.StrType)le.orig_filing_type),
    Fields.InValid_orig_filing_date((SALT30.StrType)le.orig_filing_date),
    Fields.InValid_orig_filing_time((SALT30.StrType)le.orig_filing_time),
    Fields.InValid_case_number((SALT30.StrType)le.case_number),
    Fields.InValid_filing_number((SALT30.StrType)le.filing_number),
    Fields.InValid_filing_type_desc((SALT30.StrType)le.filing_type_desc),
    Fields.InValid_filing_date((SALT30.StrType)le.filing_date),
    Fields.InValid_filing_time((SALT30.StrType)le.filing_time),
    Fields.InValid_vendor_entry_date((SALT30.StrType)le.vendor_entry_date),
    Fields.InValid_judge((SALT30.StrType)le.judge),
    Fields.InValid_case_title((SALT30.StrType)le.case_title),
    Fields.InValid_filing_book((SALT30.StrType)le.filing_book),
    Fields.InValid_filing_page((SALT30.StrType)le.filing_page),
    Fields.InValid_release_date((SALT30.StrType)le.release_date),
    Fields.InValid_amount((SALT30.StrType)le.amount),
    Fields.InValid_eviction((SALT30.StrType)le.eviction),
    Fields.InValid_satisifaction_type((SALT30.StrType)le.satisifaction_type),
    Fields.InValid_judg_satisfied_date((SALT30.StrType)le.judg_satisfied_date),
    Fields.InValid_judg_vacated_date((SALT30.StrType)le.judg_vacated_date),
    Fields.InValid_tax_code((SALT30.StrType)le.tax_code),
    Fields.InValid_irs_serial_number((SALT30.StrType)le.irs_serial_number),
    Fields.InValid_effective_date((SALT30.StrType)le.effective_date),
    Fields.InValid_lapse_date((SALT30.StrType)le.lapse_date),
    Fields.InValid_accident_date((SALT30.StrType)le.accident_date),
    Fields.InValid_sherrif_indc((SALT30.StrType)le.sherrif_indc),
    Fields.InValid_expiration_date((SALT30.StrType)le.expiration_date),
    Fields.InValid_agency((SALT30.StrType)le.agency),
    Fields.InValid_agency_city((SALT30.StrType)le.agency_city),
    Fields.InValid_agency_state((SALT30.StrType)le.agency_state),
    Fields.InValid_agency_county((SALT30.StrType)le.agency_county),
    Fields.InValid_legal_lot((SALT30.StrType)le.legal_lot),
    Fields.InValid_legal_block((SALT30.StrType)le.legal_block),
    Fields.InValid_legal_borough((SALT30.StrType)le.legal_borough),
    Fields.InValid_certificate_number((SALT30.StrType)le.certificate_number),
...
PrettyErrorTotals := RECORD
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_tmsid(TotalErrors.ErrorNum),Fields.InValidMessage_rmsid(TotalErrors.ErrorNum),Fields.InValidMessage_orig_rmsid(TotalErrors.ErrorNum),Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Fields.InValidMessage_record_code(TotalErrors.ErrorNum),Fields.InValidMessage_date_vendor_removed(TotalErrors.ErrorNum),Fields.InValidMessage_filing_jurisdiction(TotalErrors.ErrorNum),Fields.InValidMessage_filing_state(TotalErrors.ErrorNum),Fields.InValidMessage_orig_filing_number(TotalErrors.ErrorNum),Fields.InValidMessage_orig_filing_type(TotalErrors.ErrorNum),Fields.InValidMessage_orig_filing_date(TotalErrors.ErrorNum),Fields.InValidMessage_orig_filing_time(TotalErrors.ErrorNum),Fields.InValidMessage_case_number(TotalErrors.ErrorNum),Fields.InValidMessage_filing_number(TotalErrors.ErrorNum),Fields.InValidMessage_filing_type_desc(TotalErrors.ErrorNum),Fields.InValidMessage_filing_date(TotalErrors.ErrorNum),Fields.InValidMessage_filing_time(TotalErrors.ErrorNum),Fields.InValidMessage_vendor_entry_date(TotalErrors.ErrorNum),Fields.InValidMessage_judge(TotalErrors.ErrorNum),Fields.InValidMessage_case_title(TotalErrors.ErrorNum),Fields.InValidMessage_filing_book(TotalErrors.ErrorNum),Fields.InValidMessage_filing_page(TotalErrors.ErrorNum),Fields.InValidMessage_release_date(TotalErrors.ErrorNum),Fields.InValidMessage_amount(TotalErrors.ErrorNum),Fields.InValidMessage_eviction(TotalErrors.ErrorNum),Fields.InValidMessage_satisifaction_type(TotalErrors.ErrorNum),Fields.InValidMessage_judg_satisfied_date(TotalErrors.ErrorNum),Fields.InValidMessage_judg_vacated_date(TotalErrors.ErrorNum),Fields.InValidMessage_tax_code(TotalErrors.ErrorNum),Fields.InValidMessage_irs_serial_number(TotalErrors.ErrorNum),Fields.InValidMessage_effective_date(TotalErrors.ErrorNum),Fields.InValidMessage_lapse_date(TotalErrors.ErrorNum),Fields.InValidMessage_accident_date(TotalErrors.ErrorNum),Fields.InValidMessage_sherrif_indc(TotalErrors.ErrorNum),Fields.InValidMessage_expiration_date(TotalErrors.ErrorNum),Fields.InValidMessage_agency(TotalErrors.ErrorNum),Fields.InValidMessage_agency_city(TotalErrors.ErrorNum),Fields.InValidMessage_agency_state(TotalErrors.ErrorNum),Fields.InValidMessage_agency_county(TotalErrors.ErrorNum),Fields.InValidMessage_legal_lot(TotalErrors.ErrorNum),Fields.InValidMessage_legal_block(TotalErrors.ErrorNum),Fields.InValidMessage_legal_borough(TotalErrors.ErrorNum),Fields.InValidMessage_certificate_number(TotalErrors.ErrorNum),Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum),Fields.InValidMessage_source_file(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
