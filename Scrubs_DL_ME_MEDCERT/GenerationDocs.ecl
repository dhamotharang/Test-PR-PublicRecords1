...
Command line options: -MScrubs_DL_ME_MEDCERT -eC:\Users\myanasx\AppData\Local\Temp\TFR91E5.tmp 
...
FIELDTYPE:invalid_orig_lname:CUSTOM(Scrubs_DL_ME_MEDCERT.functions.fn_chk_people_names>0,clean_name_first)
FIELDTYPE:invalid_orig_fname:CUSTOM(Scrubs_DL_ME_MEDCERT.functions.fn_chk_people_names>0,Clean_name_last)
...
FIELDTYPE:invalid_orig_photo:ALLOW(N|Y|Z)
...
FIELDTYPE:invalid_clean_postdir:ALLOW(E|N|S|W)
