...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.clean_name_first),
    Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.Clean_name_last),
