...
EXPORT FromNone(DATASET(Layout_In_ME_MEDCERT) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.orig_lname_Invalid := Fields.InValid_orig_lname((SALT38.StrType)le.orig_lname,(SALT38.StrType)le.clean_name_first);
    SELF.orig_fname_Invalid := Fields.InValid_orig_fname((SALT38.StrType)le.orig_fname,(SALT38.StrType)le.Clean_name_last);
