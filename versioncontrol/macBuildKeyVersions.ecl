...
// -- 	versioncontrol.mBuildKeyVersions(base_files.built, {bdid}, {record_type}, Bdidkeynames, Key_files);
// -- 
...
export macBuildKeyVersions(pDataset, pKeyfields, pPayload, pfilenameversions,  pOutput) :=
macro
	
	export pOutput := 
	module
		
		shared fKey(string name)	:= index(pDataset, pKeyfields,	pPayload,	name);
