...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_EMPID_DOWN_Platform::EmpID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_EMPID_DOWN_Platform::EmpID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_EMPID_DOWN_Platform::EmpID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_EMPID_DOWN_Platform::EmpID::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::BIPV2_EMPID_DOWN_Platform::EmpID::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_EMPID_DOWN_Platform::EmpID::History::Match';
  MH := MatchHistoryFile;
...
EXPORT RelationshipKeys := PARALLEL(BUILDINDEX(Candidates, OVERWRITE),BUILDINDEX(MatchHistoryKey, OVERWRITE));
END;
