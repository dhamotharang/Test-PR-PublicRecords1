...
#workunit('name','BIPV2_EMPID_DOWN_Platform.BWR_Specificities - Specificities - SALT V3.2.0');
IMPORT BIPV2_EMPID_DOWN_Platform,SALT32;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_EMPID_DOWN_Platform.specificities(BIPV2_EMPID_DOWN_Platform.In_EmpID);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_EMPID_DOWN_Platform.<your_spc_attribute>',BIPV2_EMPID_DOWN_Platform.In_EmpID);
