...
// BIPV2_EMPID_DOWN_Platform.Cleave(BIPV2_EMPID_DOWN_Platform.In_EmpID).BuildAll;
//---------------------------------------------------------------------------------------------
  Und := BIPV2_EMPID_DOWN_Platform.Underlinks(BIPV2_EMPID_DOWN_Platform.In_EmpID); // Create underlink module
