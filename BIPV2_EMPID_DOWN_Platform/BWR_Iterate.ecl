...
#workunit('name','BIPV2_EMPID_DOWN_Platform.BWR_Iterate - Internal Linking - SALT V3.2.0');
...
P := BIPV2_EMPID_DOWN_Platform.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT32.MAC_MatchSamplePatterns(BIPV2_EMPID_DOWN_Platform.Keys(BIPV2_EMPID_DOWN_Platform.In_EmpID).MatchSample,MatchPatterns,EmpID1,EmpID2,8,57-63);
...
// ConfThreshold:=60;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_EMPID_DOWN_Platform.Keys(BIPV2_EMPID_DOWN_Platform.In_EmpID).MatchSample,BIPV2_EMPID_DOWN_Platform.Keys(BIPV2_EMPID_DOWN_Platform.In_EmpID).Candidates,BIPV2_EMPID_DOWN_Platform.In_EmpID,EmpID,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
