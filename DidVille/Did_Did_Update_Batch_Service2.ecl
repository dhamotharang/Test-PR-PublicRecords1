...
<message name="DID_Did_Update_Batch_Service">
  ...
  <part name="DataRestrictionMask" type="xsd:string"/>
	...
	<part name="IgnoreStability" type="xsd:boolean"/> 
...
out_format := didville.layout_did_update_out2;
...
didville.MAC_BestAppend(j2a,'BEST_ALL','',0,glb,j3,false,doxie.DataRestriction.fixed_DRM,,,,,appType,,industryClass)
