...
best_from_func_w_permission_check := didville.BestAddress.best_recs(header_recs_w_permission_check,
  did,
  mod_access,
  input_zip,
  prange_value,
...
if(
	...
	didville.BestAddress.best_recs(header_recs_wo_permission_check,
  did,
  mod_access_unrestricted,
  input_zip,
  prange_value,
  fi_value,
  li_value));
