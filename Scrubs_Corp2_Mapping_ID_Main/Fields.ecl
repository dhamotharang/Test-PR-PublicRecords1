...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_forgn_dom_code','invalid_flag_code','invalid_name_type_code','invalid_name_type_desc','invalid_mandatory','invalid_charter','invalid_date','invalid_agent_status_cd','invalid_Corp_status_cd','invalid_Cont_status_cd','invalid_org_struc_cd','invalid_recordorigin','invalid_alphablank','invalid_org_structure_desc','invalid_title1_desc','invalid_country','invalid_State_Desc');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_forgn_dom_code' => 4,'invalid_flag_code' => 5,'invalid_name_type_code' => 6,'invalid_name_type_desc' => 7,'invalid_mandatory' => 8,'invalid_charter' => 9,'invalid_date' => 10,'invalid_agent_status_cd' => 11,'invalid_Corp_status_cd' => 12,'invalid_Cont_status_cd' => 13,'invalid_org_struc_cd' => 14,'invalid_recordorigin' => 15,'invalid_alphablank' => 16,'invalid_org_structure_desc' => 17,'invalid_title1_desc' => 18,'invalid_country' => 19,'invalid_State_Desc' => 20,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['16']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('16'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['ID']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('ID'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_flag_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_flag_code(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['N','Y',' ']);
EXPORT InValidMessageFT_invalid_flag_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('N|Y| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_code(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_code(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_code(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_code'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_name_type_desc(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_desc(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_name_type_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_desc'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_agent_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_agent_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_ID_Main.Functions.Agent_Status_Codes);
EXPORT InValidMessageFT_invalid_agent_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_ID_Main.Functions.Agent_Status_Codes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_Corp_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_Corp_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_ID_Main.Functions.Corp_Status_Codes);
EXPORT InValidMessageFT_invalid_Corp_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_ID_Main.Functions.Corp_Status_Codes'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_Cont_status_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_Cont_status_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN ['A','C','D','P','R',' ']);
EXPORT InValidMessageFT_invalid_Cont_status_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('A|C|D|P|R| '),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_org_struc_cd(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_org_struc_cd(SALT34.StrType s) := WHICH(((SALT34.StrType) s) NOT IN Scrubs_Corp2_Mapping_ID_Main.Functions.Org_Struc_Codes);
EXPORT InValidMessageFT_invalid_org_struc_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_ID_Main.Functions.Org_Struc_Codes'),SALT34.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_org_structure_desc(SALT34.StrType s0) := FUNCTION
  ...
  RETURN  s1;
END;
EXPORT InValidFT_invalid_org_structure_desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' ,.-ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_org_structure_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' ,.-ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_title1_desc(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' /ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_title1_desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' /ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_title1_desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' /ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_country(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' `().ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_country(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' `().ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_country(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' `().ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_State_Desc(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' ()&ABCDEFGHIJKLMNOPQRSTUVWXYZ'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_State_Desc(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' ()&ABCDEFGHIJKLMNOPQRSTUVWXYZ'))));
EXPORT InValidMessageFT_invalid_State_Desc(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' ()&ABCDEFGHIJKLMNOPQRSTUVWXYZ'),SALT34.HygieneErrors.Good);
...
EXPORT InValid_corp_ln_name_type_desc(SALT34.StrType s,SALT34.StrType recordorigin) := InValidFT_invalid_name_type_desc(s,recordorigin);
...
EXPORT Make_corp_forgn_state_desc(SALT34.StrType s0) := MakeFT_invalid_State_Desc(s0);
EXPORT InValid_corp_forgn_state_desc(SALT34.StrType s) := InValidFT_invalid_State_Desc(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT34.StrType s0) := MakeFT_invalid_org_struc_cd(s0);
EXPORT InValid_corp_orig_org_structure_cd(SALT34.StrType s) := InValidFT_invalid_org_struc_cd(s);
EXPORT InValidMessage_corp_orig_org_structure_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_org_struc_cd(wh);
...
EXPORT Make_cont_title1_desc(SALT34.StrType s0) := MakeFT_invalid_title1_desc(s0);
EXPORT InValid_cont_title1_desc(SALT34.StrType s) := InValidFT_invalid_title1_desc(s);
EXPORT InValidMessage_cont_title1_desc(UNSIGNED1 wh) := InValidMessageFT_invalid_title1_desc(wh);
...
EXPORT Make_cont_status_cd(SALT34.StrType s0) := MakeFT_invalid_Cont_status_cd(s0);
EXPORT InValid_cont_status_cd(SALT34.StrType s) := InValidFT_invalid_Cont_status_cd(s);
EXPORT InValidMessage_cont_status_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_Cont_status_cd(wh);
...
EXPORT Make_InternalField1(SALT34.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_InternalField1(SALT34.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_InternalField1(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
 
EXPORT Make_InternalField2(SALT34.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_InternalField2(SALT34.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_InternalField2(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_ID_Main;
