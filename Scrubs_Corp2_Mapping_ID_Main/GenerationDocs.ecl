...
Command line options: -MScrubs_Corp2_Mapping_ID_Main -eC:\Users\mireleaa\AppData\Local\Temp\TFR2957.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_ID_Main
FILENAME:in_file
...
FIELDTYPE:invalid_corp_vendor:ENUM(16|16)
FIELDTYPE:invalid_state_origin:ENUM(ID|ID)
FIELDTYPE:invalid_name_type_code:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.Name_Type_Codes)
FIELDTYPE:invalid_name_type_desc:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.Name_Type_Descs)
FIELDTYPE:invalid_status:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.status_Descs)
...
FIELDTYPE:invalid_exp_date:CUSTOM(Scrubs.fn_valid_GeneralDate>0)
FIELDTYPE:invalid_term_exist_cd:ENUM(P| )
FIELDTYPE:invalid_term_exist_desc:ENUM(PERPETUAL| )
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_flag_code:ENUM(N| )
FIELDTYPE:invalid_management:ENUM(Y| )
FIELDTYPE:invalid_recordorigin:ENUM(C|C)
FIELDTYPE:invalid_month:ENUM(JANUARY|FEBRUARY|MARCH|APRIL|MAY|JUNE|JULY|AUGUST|SEPT|OCTOBER|NOVEMBER|DECEMBER| )
...
FIELDTYPE:invalid_org_structure_desc:ALLOW( -()ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_name_reservation_expiration_date:TYPE(STRING8):LIKE(invalid_exp_date):0,0
FIELD:corp_orig_bus_type_desc:TYPE(STRING350):LIKE(invalid_alphablankcomma):0,0
FIELD:corp_management_desc:TYPE(STRING50):LIKE(invalid_management):0,0
FIELD:corp_fiscal_year_month:TYPE(STRING8):LIKE(invalid_month):0,0
FIELD:corp_agent_county:TYPE(STRING20):LIKE(invalid_alphablank):0,0
FIELD:InternalField1:TYPE(STRING100):LIKE(invalid_alphablank):0,0
FIELD:InternalField2:TYPE(STRING100):LIKE(invalid_alphablank):0,0
FIELD:InternalField3:TYPE(STRING100):LIKE(invalid_alphablank):0,0
FIELD:recordorigin:TYPE(STRING1):LIKE(invalid_recordorigin):0,0
 
// Fields below here are not being scrubbed
//-------------------------------------------
