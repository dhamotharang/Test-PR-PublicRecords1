...
Command line options: -MScrubs_Corp2_Mapping_ID_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR9FC8.tmp 
...
FIELDTYPE:invalid_corp_vendor:ENUM(16)
FIELDTYPE:invalid_state_origin:ENUM(ID)
FIELDTYPE:invalid_forgn_dom_code:ENUM(D|F| )
FIELDTYPE:invalid_flag_code:ENUM(N|Y| )
FIELDTYPE:invalid_name_type_code:CUSTOM(Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_code>0,recordorigin)
FIELDTYPE:invalid_name_type_desc:CUSTOM(Scrubs_Corp2_Mapping_ID_Main.Functions.invalid_name_type_desc>0,recordorigin)
...
FIELDTYPE:invalid_agent_status_cd:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.Agent_Status_Codes)
FIELDTYPE:invalid_Corp_status_cd:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.Corp_Status_Codes)
FIELDTYPE:invalid_Cont_status_cd:ENUM(A|C|D|P|R| )
FIELDTYPE:invalid_org_struc_cd:ENUM(Scrubs_Corp2_Mapping_ID_Main.Functions.Org_Struc_Codes)
...
FIELDTYPE:invalid_title1_desc:ALLOW( /ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_orig_org_structure_cd:TYPE(STRING8):LIKE(invalid_org_struc_cd):0,0
...
FIELD:cont_title1_desc:TYPE(STRING60):LIKE(invalid_title1_desc):0,0
...
FIELD:corp_agent_status_cd:TYPE(STRING2):LIKE(invalid_agent_status_cd):0,0
...
FIELD:InternalField1:TYPE(STRING100):LIKE(invalid_country):0,0
FIELD:InternalField2:TYPE(STRING100):LIKE(invalid_country):0,0
