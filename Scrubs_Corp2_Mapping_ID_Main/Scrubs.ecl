...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.cont_title1_desc_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.cont_status_cd_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.corp_agent_status_cd_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.recordorigin_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.InternalField1_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.InternalField2_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF := le;
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'cont_title1_desc:invalid_title1_desc:ALLOW'
          ,'cont_status_cd:invalid_Cont_status_cd:ENUM'
          ,'corp_agent_status_cd:invalid_agent_status_cd:ENUM'
          ,'recordorigin:invalid_recordorigin:ENUM'
          ,'InternalField1:invalid_country:ALLOW'
          ,'InternalField2:invalid_country:ALLOW','UNKNOWN');
      ...
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.InternalField2_ALLOW_ErrorCount,0);
      SELF.rulepcnt := 100 * CHOOSE(c
          ...
          ,le.recordorigin_ENUM_ErrorCount
          ,le.InternalField1_ALLOW_ErrorCount
          ,le.InternalField2_ALLOW_ErrorCount,0) / le.TotalCnt + 0.5;
    END;
