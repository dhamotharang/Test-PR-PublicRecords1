...
EXPORT Constants() := module
	...
	export vVaultGroup := 'thor400_dev01';//'analyt_thor400_90_a';
															//,'analyt_thor400_90_dev');
	
	export vVaultTargetCluster := 'thor400_sta_eclcc';//'analyt_thor400_90_dev';
	
		
	export vVaultHthorCluster := 'hthor_sta_eclcc';
															//,'hthor');//'analyt_thor400_90_dev';
	export vVaultDali := 'dataland_dali.br.seisint.com';//'10.194.90.202';
