...
EXPORT MEOW_xIDL(DATASET(Process_xIDL_Layouts().InputLayout) in, BOOLEAN MultiRec = FALSE,SET OF SALT37.UIDType ButNot=[], UNSIGNED2 aBlockLimit=0) := MODULE /*HACK*/
...
END;
  ...
  SALT37.MAC_External_AddPcnt(RR3,Process_xIDL_Layouts().LayoutScoredFetch,Results,Process_xIDL_Layouts().OutputLayout,29,RR4);/*HACK*/
...
Config.WithinEditN(le.FNAME,0,ri.FNAME,0,Config.FNAME_LENGTH_EDIT2, 0) /*HACK*/ => SALT37.HeaderSearchMatchCode.FuzzyMatch,metaphonelib.DMetaPhone1(le.FNAME)=metaphonelib.DMetaPhone1(ri.FNAME) => SALT37.HeaderSearchMatchCode.FuzzyMatch,SALT37.HeaderSearchMatchCode.NoMatch);
...
Config.WithinEditN(le.LNAME,0,ri.LNAME,0,Config.LNAME_LENGTH_EDIT2, 0)/*HACK*/ => SALT37.HeaderSearchMatchCode.FuzzyMatch,metaphonelib.DMetaPhone1(le.LNAME)=metaphonelib.DMetaPhone1(ri.LNAME) => SALT37.HeaderSearchMatchCode.FuzzyMatch,SALT37.HeaderSearchMatchCode.NoMatch);
...
Config.WithinEditN(le.PRIM_NAME,0,ri.PRIM_NAME,0,1, 0) => SALT37.HeaderSearchMatchCode.FuzzyMatch,SALT37.HeaderSearchMatchCode.NoMatch);
    ...
    SELF.Match_DL_NBR := MAP ( ri.DL_NBR = (TYPEOF(ri.DL_NBR))'' => SALT37.HeaderSearchMatchCode.NoSearchCriteria, le.DL_NBR = (TYPEOF(ri.DL_NBR))'' => SALT37.HeaderSearchMatchCode.BlankField, ri.DL_NBR = le.DL_NBR => SALT37.HeaderSearchMatchCode.Match,SALT37.HeaderSearchMatchCode.NoMatch);
...
// If there are any simple prop fields; they can be applied here
  ...
  DSAfter_SRC := SALT37.MAC_Field_Prop_Do(DSAfter_PHONE,SRC,DID);
...
// Need to calculate lengths for EDIT fields
  ...
  SELF.keys_tried := MAP(
        ...
        LinkPathName = 'ZIP_PR' =>  + IF (Key_InsuranceHeader_ZIP_PR().CanSearch(le),1 << 6,0),
        LinkPathName = 'SRC_RID' =>  + IF (Key_InsuranceHeader_SRC_RID().CanSearch(le),1 << 7,0),
        LinkPathName = 'DLN' =>  + IF (Key_InsuranceHeader_DLN().CanSearch(le),1 << 8,0),
        LinkPathName = 'PH' =>  + IF (Key_InsuranceHeader_PH().CanSearch(le),1 << 9,0),
        LinkPathName = 'LFZ' =>  + IF (Key_InsuranceHeader_LFZ().CanSearch(le),1 << 10,0),
        LinkPathName = 'RELATIVE' =>  + IF (Key_InsuranceHeader_RELATIVE().CanSearch(le),1 << 11,0),0);
  fetchResults := MAP(
        LinkPathName = 'NAME' => IF(Key_InsuranceHeader_NAME().CanSearch(le),SORTED(Key_InsuranceHeader_NAME(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_ST := le.ST,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_MNAME := le.MNAME,param_MNAME_len := MNAME_len,param_SSN5 := le.SSN5,param_SSN5_len := SSN5_len,param_SSN4 := le.SSN4,param_SSN4_len := SSN4_len,param_PRIM_RANGE := le.PRIM_RANGE,param_PRIM_RANGE_len := PRIM_RANGE_len,param_PRIM_NAME := le.PRIM_NAME,param_PRIM_NAME_len := PRIM_NAME_len,param_SEC_RANGE := le.SEC_RANGE,param_CITY := le.CITY,param_DOB := (UNSIGNED4)le.DOB,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'ADDRESS' => IF(Key_InsuranceHeader_ADDRESS().CanSearch(le),SORTED(Key_InsuranceHeader_ADDRESS(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_PRIM_RANGE := le.PRIM_RANGE,param_PRIM_RANGE_len := PRIM_RANGE_len,param_PRIM_NAME := le.PRIM_NAME,param_PRIM_NAME_len := PRIM_NAME_len,param_ZIP := le.ZIP,param_SEC_RANGE := le.SEC_RANGE,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_MNAME := le.MNAME,param_MNAME_len := MNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_CITY := le.CITY,param_ST := le.ST,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_DOB := (UNSIGNED4)le.DOB,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'SSN' => IF(Key_InsuranceHeader_SSN().CanSearch(le),SORTED(Key_InsuranceHeader_SSN(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_SSN5 := le.SSN5,param_SSN5_len := SSN5_len,param_SSN4 := le.SSN4,param_SSN4_len := SSN4_len,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_MNAME := le.MNAME,param_MNAME_len := MNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_CITY := le.CITY,param_ST := le.ST,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_DOB := (UNSIGNED4)le.DOB,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'SSN4' => IF(Key_InsuranceHeader_SSN4().CanSearch(le),SORTED(Key_InsuranceHeader_SSN4(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_SSN4 := le.SSN4,param_SSN4_len := SSN4_len,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_DOB := (UNSIGNED4)le.DOB,param_SSN5 := le.SSN5,param_SSN5_len := SSN5_len,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'DOB' => IF(Key_InsuranceHeader_DOB().CanSearch(le),SORTED(Key_InsuranceHeader_DOB(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_DOB := (UNSIGNED4)le.DOB,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_MNAME := le.MNAME,param_MNAME_len := MNAME_len,param_ST := le.ST,param_CITY := le.CITY,param_SSN5 := le.SSN5,param_SSN5_len := SSN5_len,param_SSN4 := le.SSN4,param_SSN4_len := SSN4_len,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'ZIP_PR' => IF(Key_InsuranceHeader_ZIP_PR().CanSearch(le),SORTED(Key_InsuranceHeader_ZIP_PR(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_ZIP := le.ZIP,param_PRIM_RANGE := le.PRIM_RANGE,param_PRIM_RANGE_len := PRIM_RANGE_len,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_PRIM_NAME := le.PRIM_NAME,param_PRIM_NAME_len := PRIM_NAME_len,param_SEC_RANGE := le.SEC_RANGE,param_CITY := le.CITY,param_ST := le.ST,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_DOB := (UNSIGNED4)le.DOB,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'SRC_RID' => IF(Key_InsuranceHeader_SRC_RID().CanSearch(le)#IF (InsuranceHeader_xLink.Environment.isCurrentAlpha) 
		  ,SORTED(Key_InsuranceHeader_SRC_RID().ScoredDIDFetch(param_SRC := le.SRC,param_SOURCE_RID := le.SOURCE_RID,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_DOB := (UNSIGNED4)le.DOB,param_CITY := le.CITY,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_ST := le.ST,param_disableForce := In_disableForce),DID) 
		#END/*HACK*/,DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
        LinkPathName = 'DLN' => IF(Key_InsuranceHeader_DLN().CanSearch(le),SORTED(Key_InsuranceHeader_DLN(, aBlockLimit /*HACK*/ ).ScoredDIDFetch(param_DL_NBR := le.DL_NBR,param_DL_STATE := le.DL_STATE,param_FNAME := le.FNAME,param_FNAME_len := FNAME_len,param_MNAME := le.MNAME,param_MNAME_len := MNAME_len,param_LNAME := le.LNAME,param_LNAME_len := LNAME_len,param_SSN5 := le.SSN5,param_SSN5_len := SSN5_len,param_SSN4 := le.SSN4,param_SSN4_len := SSN4_len,param_DERIVED_GENDER := le.DERIVED_GENDER,param_SNAME := le.SNAME,param_DOB := (UNSIGNED4)le.DOB,param_disableForce := In_disableForce),DID),DATASET([],Process_xIDL_Layouts().LayoutScoredFetch)),
