...
EXPORT Summary(SALT37.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_SSN5 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.SSN5)));
    avelength_SSN5 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.SSN5)),h.SSN5<>(typeof(h.SSN5))'');
    populated_SSN4_pcnt := AVE(GROUP,IF(h.SSN4 = (TYPEOF(h.SSN4))'',0,100));
    maxlength_SSN4 := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.SSN4)));
    avelength_SSN4 := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.SSN4)),h.SSN4<>(typeof(h.SSN4))'');
    ...
    maxlength_SOURCE_RID := MAX(GROUP,LENGTH(TRIM((SALT37.StrType)h.SOURCE_RID)));
    avelength_SOURCE_RID := AVE(GROUP,LENGTH(TRIM((SALT37.StrType)h.SOURCE_RID)),h.SOURCE_RID<>(typeof(h.SOURCE_RID))'');
...
SALT37.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.DID;
  SELF.Src := le.SRC;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT37.StrType)le.SNAME),TRIM((SALT37.StrType)le.FNAME),TRIM((SALT37.StrType)le.MNAME),TRIM((SALT37.StrType)le.LNAME),TRIM((SALT37.StrType)le.DERIVED_GENDER),TRIM((SALT37.StrType)le.PRIM_RANGE),TRIM((SALT37.StrType)le.PRIM_NAME),TRIM((SALT37.StrType)le.SEC_RANGE),TRIM((SALT37.StrType)le.CITY),TRIM((SALT37.StrType)le.ST),TRIM((SALT37.StrType)le.ZIP),TRIM((SALT37.StrType)le.SSN5),TRIM((SALT37.StrType)le.SSN4),TRIM((SALT37.StrType)le.DOB),TRIM((SALT37.StrType)le.PHONE),TRIM((SALT37.StrType)le.DL_STATE),TRIM((SALT37.StrType)le.DL_NBR),TRIM((SALT37.StrType)le.SRC),TRIM((SALT37.StrType)le.SOURCE_RID),TRIM((SALT37.StrType)le.DT_FIRST_SEEN),TRIM((SALT37.StrType)le.DT_LAST_SEEN),TRIM((SALT37.StrType)le.DT_EFFECTIVE_FIRST),TRIM((SALT37.StrType)le.DT_EFFECTIVE_LAST)));
  SELF.FldNo := C;
END;
...
SALT37.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 23);
  SELF.FldNo2 := 1 + (C % 23);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT37.StrType)le.SNAME),TRIM((SALT37.StrType)le.FNAME),TRIM((SALT37.StrType)le.MNAME),TRIM((SALT37.StrType)le.LNAME),TRIM((SALT37.StrType)le.DERIVED_GENDER),TRIM((SALT37.StrType)le.PRIM_RANGE),TRIM((SALT37.StrType)le.PRIM_NAME),TRIM((SALT37.StrType)le.SEC_RANGE),TRIM((SALT37.StrType)le.CITY),TRIM((SALT37.StrType)le.ST),TRIM((SALT37.StrType)le.ZIP),TRIM((SALT37.StrType)le.SSN5),TRIM((SALT37.StrType)le.SSN4),TRIM((SALT37.StrType)le.DOB),TRIM((SALT37.StrType)le.PHONE),TRIM((SALT37.StrType)le.DL_STATE),TRIM((SALT37.StrType)le.DL_NBR),TRIM((SALT37.StrType)le.SRC),TRIM((SALT37.StrType)le.SOURCE_RID),TRIM((SALT37.StrType)le.DT_FIRST_SEEN),TRIM((SALT37.StrType)le.DT_LAST_SEEN),TRIM((SALT37.StrType)le.DT_EFFECTIVE_FIRST),TRIM((SALT37.StrType)le.DT_EFFECTIVE_LAST)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT37.StrType)le.SNAME),TRIM((SALT37.StrType)le.FNAME),TRIM((SALT37.StrType)le.MNAME),TRIM((SALT37.StrType)le.LNAME),TRIM((SALT37.StrType)le.DERIVED_GENDER),TRIM((SALT37.StrType)le.PRIM_RANGE),TRIM((SALT37.StrType)le.PRIM_NAME),TRIM((SALT37.StrType)le.SEC_RANGE),TRIM((SALT37.StrType)le.CITY),TRIM((SALT37.StrType)le.ST),TRIM((SALT37.StrType)le.ZIP),TRIM((SALT37.StrType)le.SSN5),TRIM((SALT37.StrType)le.SSN4),TRIM((SALT37.StrType)le.DOB),TRIM((SALT37.StrType)le.PHONE),TRIM((SALT37.StrType)le.DL_STATE),TRIM((SALT37.StrType)le.DL_NBR),TRIM((SALT37.StrType)le.SRC),TRIM((SALT37.StrType)le.SOURCE_RID),TRIM((SALT37.StrType)le.DT_FIRST_SEEN),TRIM((SALT37.StrType)le.DT_LAST_SEEN),TRIM((SALT37.StrType)le.DT_EFFECTIVE_FIRST),TRIM((SALT37.StrType)le.DT_EFFECTIVE_LAST)));
  END;
...
SHARED FldIds := DATASET([{1,'SNAME'}
      ...
      ,{23,'DT_EFFECTIVE_LAST'}],SALT37.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_SSN5((SALT37.StrType)le.SSN5),
    Fields.InValid_SSN4((SALT37.StrType)le.SSN4),
    ...
    Fields.InValid_SOURCE_RID((SALT37.StrType)le.SOURCE_RID),
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','NUMBER','DEFAULT','DEFAULT','DEFAULT','NUMBER','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','DEFAULT','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown','Unknown');
