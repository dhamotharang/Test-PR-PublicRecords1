...
EXPORT CustTest_Files(STRING fileVersion) := MODULE
  ...
  export location := Data_Services.Data_Location.Prefix('IDL_Header');
	...
	EXPORT header0_super	:= prefix + '::' + KeySuperfile + '::' + 'header_relative';
	EXPORT header1_super	:= prefix + '::' + KeySuperfile + '::' + 'header_vin';
	...
	EXPORT src_rid_super	:= prefix + '::' + KeySuperfile + '::' + 'DID::Refs::SRC_RID';
	...
	EXPORT vin_super := prefix + '::' + KeySuperfile + '::' + 'DID::Refs::VIN';
 ...
 EXPORT vin_father			:= prefix + '::' + keyFather + '::' + 'DID::Refs::VIN';
	...
	EXPORT src_rid_logical	:= prtePrefix + '::' + buildDate + '::' + 'DID::Refs::SRC_RID';
