...
EXPORT Header_xlinking_Service() := MACRO
  #WEBSERVICE(FIELDS(
	...
	'ST', 'ZIP', 'SSN', 'DOB', 'PHONE', 'DL_STATE', 'DL_NBR', 'fname2', 'lname2', 'VIN', 'RID', 'DID', 'SortBy',
 ...
 finalRes1 := join(dsNorm, allRecs, left.did=right.inputDid, transform(finalLayout, 
  ...
  FieldNumber(SALT311.StrType fn) := CASE(fn,'NAME_SUFFIX' => 1,'FNAME' => 2,'MNAME' => 3,'LNAME' => 4, 
 ...
 OUTPUT(pm.Data_0,NAMED('Relatives'));
 OUTPUT(pm.Data_1,NAMED('VIN'));
