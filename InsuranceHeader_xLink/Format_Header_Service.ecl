...
function Append_ServiceName()
{
  ...
  var items = xmlDoc.getElementsByTagName("EspBinding");
   ...
   orequest.send(null);
	...
	<!--<tr>
	<td>Aleida</td>
  <td>window.parent.location.href.split('/')[0]</td>
	<td>window.parent.location.href.split('/')[2]</td>
	</tr>-->
	</table>
	</div>
	<br/>
	...
	<xsl:for-each select="Row">	
              ...
              <xsl:if test="position()=1"> 
                    ...
                    <b><xsl:value-of select="name()"/></b>
						...
						<!-- WRITING DATA ROWS-->
						<tr onMouseDown="HighLightTR(this, event);">
                		...
                		<xsl:variable name="cell_id">
								...
								<td valign="top" style="border-width: 1px;" onMouseDown="HighLightTD(this, event);">  
