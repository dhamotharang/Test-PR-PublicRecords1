...
EXPORT CustTest_Proc_GoExternal(STRING fileVersion) := FUNCTION
	...
	BK12    := 	if(~fileservices.fileexists(modCustTestFile.dobf),		BUILDINDEX(Key_InsuranceHeader_DOBF().Key, 	modCustTestFile.dobf_logical,OVERWRITE));
	RETURN SEQUENTIAL(buildSpec,
										PARALLEL(BaseK,BK0,BK1,BK2,BK3,BK4,BK5,
										BK6,BK7,BK8,BK9,BK10,BK11,B12)
