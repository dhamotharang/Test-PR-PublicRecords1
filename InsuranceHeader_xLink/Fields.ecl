...
EXPORT SALT37.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'SNAME','FNAME','MNAME','LNAME','DERIVED_GENDER','PRIM_RANGE','PRIM_NAME','SEC_RANGE','CITY','ST','ZIP','SSN5','SSN4','DOB','PHONE','DL_STATE','DL_NBR','SRC','SOURCE_RID','DT_FIRST_SEEN','DT_LAST_SEEN','DT_EFFECTIVE_FIRST','DT_EFFECTIVE_LAST','MAINNAME','FULLNAME','ADDR1','LOCALE','ADDRESS','fname2','lname2');
EXPORT FieldNum(SALT37.StrType fn) := CASE(fn,'SNAME' => 0,'FNAME' => 1,'MNAME' => 2,'LNAME' => 3,'DERIVED_GENDER' => 4,'PRIM_RANGE' => 5,'PRIM_NAME' => 6,'SEC_RANGE' => 7,'CITY' => 8,'ST' => 9,'ZIP' => 10,'SSN5' => 11,'SSN4' => 12,'DOB' => 13,'PHONE' => 14,'DL_STATE' => 15,'DL_NBR' => 16,'SRC' => 17,'SOURCE_RID' => 18,'DT_FIRST_SEEN' => 19,'DT_LAST_SEEN' => 20,'DT_EFFECTIVE_FIRST' => 21,'DT_EFFECTIVE_LAST' => 22,'MAINNAME' => 23,'FULLNAME' => 24,'ADDR1' => 25,'LOCALE' => 26,'ADDRESS' => 27,'fname2' => 28,'lname2' => 29,0);
...
EXPORT Make_SSN5(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_SSN5(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_SSN5(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_SSN4(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_SSN4(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_DL_STATE(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DL_STATE(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_SOURCE_RID(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_SOURCE_RID(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_DT_EFFECTIVE_FIRST(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DT_EFFECTIVE_FIRST(SALT37.StrType s) := InValidFT_DEFAULT(s);
EXPORT InValidMessage_DT_EFFECTIVE_FIRST(UNSIGNED1 wh) := InValidMessageFT_DEFAULT(wh);
 
EXPORT Make_DT_EFFECTIVE_LAST(SALT37.StrType s0) := MakeFT_DEFAULT(s0);
EXPORT InValid_DT_EFFECTIVE_LAST(SALT37.StrType s) := InValidFT_DEFAULT(s);
...
EXPORT Make_fname2(SALT37.StrType s0) := s0;
EXPORT InValid_fname2(SALT37.StrType s) := 0;
EXPORT InValidMessage_fname2(UNSIGNED1 wh) := '';
 
EXPORT Make_lname2(SALT37.StrType s0) := s0;
EXPORT InValid_lname2(SALT37.StrType s) := 0;
