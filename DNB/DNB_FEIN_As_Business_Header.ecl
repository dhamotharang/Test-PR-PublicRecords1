...
dnb_fein_base := dnb.File_DNB_FEIN_In(zip <> '');
...
dnb_clean_rollup := ROLLUP(dnb_clean_sort,
                    ...
                    LOCAL) : PERSIST('TEMP::DNB_FEIN_Company_Rollup');

EXPORT DNB_FEIN_As_Business_Header := dnb_clean_rollup(vendor_id <> '' and vendor_id <> '000000000');