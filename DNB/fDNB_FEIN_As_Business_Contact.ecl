...
export fDNB_FEIN_As_Business_Contact(dataset(Layout_DNB_FEIN_In) pInput) :=
function
	...
	dnb_fein_contacts := pInput(DB_CHIEF_EXECUTIVE_TITLE <> '', zip <> '');

	Business_Header.Layout_Business_Contact_Full_New Translate_DNB_to_BCF(Layout_DNB_FEIN_In l, unsigned1 ntyp) := TRANSFORM
	...
	Business_Header.Layout_Business_Contact_Full_New PropagateDunsNumber(Business_Header.Layout_Business_Contact_Full_New l, Business_Header.Layout_Business_Contact_Full_New r) := transform
	...
	Business_Header.Layout_Business_Contact_Full_New AppendDunsNumber(Business_Header.Layout_Business_Contact_Full_New l, layout_dnb_slim r) := transform
	...
	return dnb_contacts_combined_all((integer)name_score < 3, Business_Header.CheckPersonName(fname, mname, lname, name_suffix));
