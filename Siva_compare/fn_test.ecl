EXPORT fn_test(d1,d2, first_key,  second_key,  third_key, compare_file_name, pview_file_name  ) := functionmacro

siva_compare.MAC_compare_file_layouts_1(d1, d2, outfile1);
siva_compare.MAC_compare_file_layouts_2(d1, d2, outfile2 );
