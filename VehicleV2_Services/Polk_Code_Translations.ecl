...
EXPORT string RealTimePermissibleUse (string RealTimePermissibleUse):=
		...
		MAP(trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'GOVERNMENT' 						=> '1A',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'LAWENFORCEMENT' 				=> '1L',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'PARKING' 								=> '1P',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'VERIFYFRAUDORDEBT' 			=> '2',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'LITIGATION' 						=> '3',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'INSURANCECLAIMS' 			  => '4C',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'INSURANCEUNDERWRITING'  => '4U',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'TOWEDANDIMPOUNDED' 		  => '5',
				trim(stringlib.stringtouppercase(RealTimePermissibleUse)) =  'PRIVATETOLL' 					  => '6',
				'');
