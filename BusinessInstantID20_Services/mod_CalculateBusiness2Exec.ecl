	...
	MODULE
		...
		SHARED BusinessInstantID20_Services.Layouts.Business2ExecLayout business_to_exec_indices := 
			TRANSFORM
				...
				SELF.Seq                 := le.Seq;
				SELF.bus2exec_index_rep1 := IF( _AuthRep1_Exists, (STRING2)((INTEGER)_bus2exec_index_rep1 DIV 10 * 10), '' );
				SELF.bus2exec_desc_rep1  := IF( _AuthRep1_Exists, _bus2exec_desc_rep1, '' );
				SELF.bus2exec_index_rep2 := IF( _AuthRep2_Exists, (STRING2)((INTEGER)_bus2exec_index_rep2 DIV 10 * 10), '' );
				SELF.bus2exec_desc_rep2  := IF( _AuthRep2_Exists, _bus2exec_desc_rep2, '' );
				SELF.bus2exec_index_rep3 := IF( _AuthRep3_Exists, (STRING2)((INTEGER)_bus2exec_index_rep3 DIV 10 * 10), '' );
				SELF.bus2exec_desc_rep3  := IF( _AuthRep3_Exists, _bus2exec_desc_rep3, '' );
				SELF.bus2exec_index_rep4 := IF( _AuthRep4_Exists, (STRING2)((INTEGER)_bus2exec_index_rep4 DIV 10 * 10), '' );
				SELF.bus2exec_desc_rep4  := IF( _AuthRep4_Exists, _bus2exec_desc_rep4, '' );
				SELF.bus2exec_index_rep5 := IF( _AuthRep5_Exists, (STRING2)((INTEGER)_bus2exec_index_rep5 DIV 10 * 10), '' );
		...
		SHARED rw_business_to_exec_indices := ROW( business_to_exec_indices );
		
		SHARED rw_null_business_to_exec := ROW( null_business_to_exec );
		
		SHARED doesNotMeetMinimumInputRequirements := 
			  BusinessInstantID20_Services.fn_DoesNotMeetMinInputBusinessReqs( le ) OR
				le.Input.InputCheckAuthRepFirstName = '0' OR 
				le.Input.InputCheckAuthRepLastName = '0';

		EXPORT _e2b_rep1_name_on_file_f        := e2b_rep1_name_on_file IN ['1','3'];
		EXPORT _e2b_rep1_name_on_file_l        := e2b_rep1_name_on_file IN ['2','3'];  																			
		EXPORT _e2b_rep1_paw_match             := e2b_rep1_paw_match = '2';   

		EXPORT _e2b_rep1_idsearch_name_f       := e2b_rep1_idsearch_name = '1';
		EXPORT _e2b_rep1_idsearch_name_l       := e2b_rep1_idsearch_name = '1';    
		EXPORT _e2b_rep1_idsearch_addr         := e2b_rep1_idsearch_addr = '1';  
		EXPORT _e2b_rep1_idsearch_ssn          := e2b_rep1_idsearch_ssn = '1';
		
		EXPORT _e2b_rep1_match_bus_file_first  := e2b_rep1_match_bus_file_first = '1';
		EXPORT _e2b_rep1_match_bus_file_last   := e2b_rep1_match_bus_file_last = '1';    
		EXPORT _e2b_rep1_match_bus_file_addr   := e2b_rep1_match_bus_file_addr = '1';  
		EXPORT _e2b_rep1_match_bus_file_phn    := e2b_rep1_match_bus_file_phn = '1';
		EXPORT _e2b_rep1_match_bus_file_fein   := e2b_rep1_match_bus_file_fein = '1';
		
		EXPORT _e2b_rep1_match_bus_in_first    := e2b_rep1_match_bus_in_first = '1';
		EXPORT _e2b_rep1_match_bus_in_last     := e2b_rep1_match_bus_in_last = '1';    
		EXPORT _e2b_rep1_match_bus_in_addr     := e2b_rep1_match_bus_in_addr = '1';  
		EXPORT _e2b_rep1_match_bus_in_phn      := in_bus_phone10 = in_rep1_phone10;
		EXPORT _e2b_rep1_match_bus_in_fein     := TRIM(in_bus_fein) != '' AND TRIM(in_bus_fein) = TRIM(in_rep1_ssn); 
		
		EXPORT _sbfe_e2b_rep1_name_on_file_f   := sbfe_e2b_rep1_name_on_file IN ['1','3'];
		EXPORT _sbfe_e2b_rep1_name_on_file_l   := sbfe_e2b_rep1_name_on_file IN ['2','3'];    
		EXPORT _sbfe_e2b_rep1_addr_on_file     := sbfe_e2b_rep1_addr_on_file = '1';  
		EXPORT _sbfe_e2b_rep1_ssn_on_file      := sbfe_e2b_rep1_ssn_on_file = '1'; 
		
		EXPORT bus2exec_desc_rep1_key          := (STRING2)_bus2exec_index_rep1;
		EXPORT bus2execindex_rep1              := (STRING2)((INTEGER)_bus2exec_index_rep1 DIV 10 * 10);
		
		EXPORT rw_result := IF( doesNotMeetMinimumInputRequirements, rw_null_business_to_exec, rw_business_to_exec_indices );
