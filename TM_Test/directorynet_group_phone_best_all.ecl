...
dn_group_init := directorynet_did_to_business_all(bdid <> 0 and bus_best_phone = '');
dn_other := directorynet_did_to_business_all(not(bdid <> 0 and bus_best_phone = ''));
...
export directorynet_group_phone_best_all := dn_phone_append + dn_other : persist('TMTEST::directorynet_group_phone_best_all');