...
amex_merchant_init := project(TM_Test.amex_merchant_mktapp_filtered,
...
export amex_merchant_business_append := amex_merchant_business_append_sort : persist('TMTEST::amex_merchant_business_append');