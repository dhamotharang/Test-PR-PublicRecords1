...
Layout_Amex_Merchant_Out InitOut(amex_merchant_business_append l) := transform
...
amex_merchant_out_init := project(amex_merchant_business_append, InitOut(left));
...
// Dedup Employees
emp_init := amex_merchant_employee_mktapp_filtered;
...
export amex_merchant_outfile_mktapp_filtered := amex_merchant_out_append_emp_sort : persist('TMTEST::amex_merchant_out_mktapp');