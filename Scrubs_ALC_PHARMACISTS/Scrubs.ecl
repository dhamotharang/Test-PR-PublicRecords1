...
EXPORT FromNone(DATASET(Layout_ALC_PHARMACISTS) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.fax_Invalid := Fields.InValid_fax((SALT32.StrType)le.fax);
