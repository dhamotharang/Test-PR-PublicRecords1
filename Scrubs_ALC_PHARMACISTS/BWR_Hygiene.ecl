...
#workunit('name','Scrubs_ALC_PHARMACISTS.BWR_Hygiene - Hygiene & Stats - SALT V3.7.1');
IMPORT Scrubs_ALC_PHARMACISTS,SALT37;
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT37.MAC_Character_Counts.EclRecord(p,'Layout_ALC_PHARMACISTS'),NAMED('OptimizedLayout'));// File layout suggested by data
