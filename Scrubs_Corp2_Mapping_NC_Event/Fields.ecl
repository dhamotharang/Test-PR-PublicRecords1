...
EXPORT SALT35.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_filing_cd');
EXPORT FieldTypeNum(SALT35.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_date' => 5,'invalid_filing_cd' => 6,0);
...
EXPORT MakeFT_invalid_filing_cd(SALT35.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_filing_cd(SALT35.StrType s) := WHICH(((SALT35.StrType) s) NOT IN Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_Event_codes);
EXPORT InValidMessageFT_invalid_filing_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT35.HygieneErrors.NotInEnum('Scrubs_Corp2_Mapping_NC_Main.Functions.set_valid_Event_codes'),SALT35.HygieneErrors.Good);
...
EXPORT Make_event_filing_reference_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_filing_reference_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_filing_reference_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_amendment_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_amendment_nbr(SALT35.StrType s) := 0;
...
EXPORT Make_event_date_type_cd(SALT35.StrType s0) := s0;
EXPORT InValid_event_date_type_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_date_type_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_date_type_desc(SALT35.StrType s0) := s0;
EXPORT InValid_event_date_type_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_date_type_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_filing_cd(SALT35.StrType s0) := MakeFT_invalid_filing_cd(s0);
EXPORT InValid_event_filing_cd(SALT35.StrType s) := InValidFT_invalid_filing_cd(s);
EXPORT InValidMessage_event_filing_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_filing_cd(wh);
 
EXPORT Make_event_filing_desc(SALT35.StrType s0) := s0;
EXPORT InValid_event_filing_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_filing_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_corp_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_corp_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr_cd(SALT35.StrType s0) := s0;
EXPORT InValid_event_corp_nbr_cd(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_corp_nbr_cd(UNSIGNED1 wh) := '';
 
EXPORT Make_event_corp_nbr_desc(SALT35.StrType s0) := s0;
EXPORT InValid_event_corp_nbr_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_corp_nbr_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_roll(SALT35.StrType s0) := s0;
EXPORT InValid_event_roll(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_roll(UNSIGNED1 wh) := '';
 
EXPORT Make_event_frame(SALT35.StrType s0) := s0;
EXPORT InValid_event_frame(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_frame(UNSIGNED1 wh) := '';
 
EXPORT Make_event_start(SALT35.StrType s0) := s0;
EXPORT InValid_event_start(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_start(UNSIGNED1 wh) := '';
 
EXPORT Make_event_end(SALT35.StrType s0) := s0;
EXPORT InValid_event_end(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_end(UNSIGNED1 wh) := '';
 
EXPORT Make_event_microfilm_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_microfilm_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_microfilm_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_desc(SALT35.StrType s0) := s0;
EXPORT InValid_event_desc(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_desc(UNSIGNED1 wh) := '';
 
EXPORT Make_event_revocation_comment1(SALT35.StrType s0) := s0;
EXPORT InValid_event_revocation_comment1(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_revocation_comment1(UNSIGNED1 wh) := '';
 
EXPORT Make_event_revocation_comment2(SALT35.StrType s0) := s0;
EXPORT InValid_event_revocation_comment2(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_revocation_comment2(UNSIGNED1 wh) := '';
 
EXPORT Make_event_book_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_book_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_book_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_page_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_page_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_page_nbr(UNSIGNED1 wh) := '';
 
EXPORT Make_event_certification_nbr(SALT35.StrType s0) := s0;
EXPORT InValid_event_certification_nbr(SALT35.StrType s) := 0;
EXPORT InValidMessage_event_certification_nbr(UNSIGNED1 wh) := '';
 
// This macro will compute and count field level differences based upon a pivot expression
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT35,Scrubs_Corp2_Mapping_NC_Event;
