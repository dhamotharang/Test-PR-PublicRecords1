...
EXPORT Summary(SALT35.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_event_filing_reference_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_reference_nbr)));
    avelength_event_filing_reference_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_reference_nbr)),h.event_filing_reference_nbr<>(typeof(h.event_filing_reference_nbr))'');
    populated_event_amendment_nbr_pcnt := AVE(GROUP,IF(h.event_amendment_nbr = (TYPEOF(h.event_amendment_nbr))'',0,100));
    maxlength_event_amendment_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_amendment_nbr)));
    avelength_event_amendment_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_amendment_nbr)),h.event_amendment_nbr<>(typeof(h.event_amendment_nbr))'');
    ...
    maxlength_event_date_type_cd := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_date_type_cd)));
    avelength_event_date_type_cd := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_date_type_cd)),h.event_date_type_cd<>(typeof(h.event_date_type_cd))'');
    populated_event_date_type_desc_pcnt := AVE(GROUP,IF(h.event_date_type_desc = (TYPEOF(h.event_date_type_desc))'',0,100));
    maxlength_event_date_type_desc := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_date_type_desc)));
    avelength_event_date_type_desc := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_date_type_desc)),h.event_date_type_desc<>(typeof(h.event_date_type_desc))'');
    populated_event_filing_cd_pcnt := AVE(GROUP,IF(h.event_filing_cd = (TYPEOF(h.event_filing_cd))'',0,100));
    maxlength_event_filing_cd := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_cd)));
    avelength_event_filing_cd := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_cd)),h.event_filing_cd<>(typeof(h.event_filing_cd))'');
    populated_event_filing_desc_pcnt := AVE(GROUP,IF(h.event_filing_desc = (TYPEOF(h.event_filing_desc))'',0,100));
    maxlength_event_filing_desc := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_desc)));
    avelength_event_filing_desc := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_filing_desc)),h.event_filing_desc<>(typeof(h.event_filing_desc))'');
    populated_event_corp_nbr_pcnt := AVE(GROUP,IF(h.event_corp_nbr = (TYPEOF(h.event_corp_nbr))'',0,100));
    maxlength_event_corp_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr)));
    avelength_event_corp_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr)),h.event_corp_nbr<>(typeof(h.event_corp_nbr))'');
    populated_event_corp_nbr_cd_pcnt := AVE(GROUP,IF(h.event_corp_nbr_cd = (TYPEOF(h.event_corp_nbr_cd))'',0,100));
    maxlength_event_corp_nbr_cd := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr_cd)));
    avelength_event_corp_nbr_cd := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr_cd)),h.event_corp_nbr_cd<>(typeof(h.event_corp_nbr_cd))'');
    populated_event_corp_nbr_desc_pcnt := AVE(GROUP,IF(h.event_corp_nbr_desc = (TYPEOF(h.event_corp_nbr_desc))'',0,100));
    maxlength_event_corp_nbr_desc := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr_desc)));
    avelength_event_corp_nbr_desc := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_corp_nbr_desc)),h.event_corp_nbr_desc<>(typeof(h.event_corp_nbr_desc))'');
    populated_event_roll_pcnt := AVE(GROUP,IF(h.event_roll = (TYPEOF(h.event_roll))'',0,100));
    maxlength_event_roll := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_roll)));
    avelength_event_roll := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_roll)),h.event_roll<>(typeof(h.event_roll))'');
    populated_event_frame_pcnt := AVE(GROUP,IF(h.event_frame = (TYPEOF(h.event_frame))'',0,100));
    maxlength_event_frame := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_frame)));
    avelength_event_frame := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_frame)),h.event_frame<>(typeof(h.event_frame))'');
    populated_event_start_pcnt := AVE(GROUP,IF(h.event_start = (TYPEOF(h.event_start))'',0,100));
    maxlength_event_start := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_start)));
    avelength_event_start := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_start)),h.event_start<>(typeof(h.event_start))'');
    populated_event_end_pcnt := AVE(GROUP,IF(h.event_end = (TYPEOF(h.event_end))'',0,100));
    maxlength_event_end := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_end)));
    avelength_event_end := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_end)),h.event_end<>(typeof(h.event_end))'');
    populated_event_microfilm_nbr_pcnt := AVE(GROUP,IF(h.event_microfilm_nbr = (TYPEOF(h.event_microfilm_nbr))'',0,100));
    maxlength_event_microfilm_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_microfilm_nbr)));
    avelength_event_microfilm_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_microfilm_nbr)),h.event_microfilm_nbr<>(typeof(h.event_microfilm_nbr))'');
    populated_event_desc_pcnt := AVE(GROUP,IF(h.event_desc = (TYPEOF(h.event_desc))'',0,100));
    maxlength_event_desc := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_desc)));
    avelength_event_desc := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_desc)),h.event_desc<>(typeof(h.event_desc))'');
    ...
    maxlength_event_revocation_comment1 := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_revocation_comment1)));
    avelength_event_revocation_comment1 := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_revocation_comment1)),h.event_revocation_comment1<>(typeof(h.event_revocation_comment1))'');
    ...
    maxlength_event_revocation_comment2 := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_revocation_comment2)));
    avelength_event_revocation_comment2 := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_revocation_comment2)),h.event_revocation_comment2<>(typeof(h.event_revocation_comment2))'');
    populated_event_book_nbr_pcnt := AVE(GROUP,IF(h.event_book_nbr = (TYPEOF(h.event_book_nbr))'',0,100));
    maxlength_event_book_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_book_nbr)));
    avelength_event_book_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_book_nbr)),h.event_book_nbr<>(typeof(h.event_book_nbr))'');
    populated_event_page_nbr_pcnt := AVE(GROUP,IF(h.event_page_nbr = (TYPEOF(h.event_page_nbr))'',0,100));
    maxlength_event_page_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_page_nbr)));
    avelength_event_page_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_page_nbr)),h.event_page_nbr<>(typeof(h.event_page_nbr))'');
    populated_event_certification_nbr_pcnt := AVE(GROUP,IF(h.event_certification_nbr = (TYPEOF(h.event_certification_nbr))'',0,100));
    maxlength_event_certification_nbr := MAX(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_certification_nbr)));
    avelength_event_certification_nbr := AVE(GROUP,LENGTH(TRIM((SALT35.StrType)h.event_certification_nbr)),h.event_certification_nbr<>(typeof(h.event_certification_nbr))'');
  END;
...
SALT35.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT35.StrType)le.corp_key),TRIM((SALT35.StrType)le.corp_supp_key),TRIM((SALT35.StrType)le.corp_vendor),TRIM((SALT35.StrType)le.corp_vendor_county),TRIM((SALT35.StrType)le.corp_vendor_subcode),TRIM((SALT35.StrType)le.corp_state_origin),TRIM((SALT35.StrType)le.corp_process_date),TRIM((SALT35.StrType)le.corp_sos_charter_nbr),TRIM((SALT35.StrType)le.event_filing_reference_nbr),TRIM((SALT35.StrType)le.event_amendment_nbr),TRIM((SALT35.StrType)le.event_filing_date),TRIM((SALT35.StrType)le.event_date_type_cd),TRIM((SALT35.StrType)le.event_date_type_desc),TRIM((SALT35.StrType)le.event_filing_cd),TRIM((SALT35.StrType)le.event_filing_desc),TRIM((SALT35.StrType)le.event_corp_nbr),TRIM((SALT35.StrType)le.event_corp_nbr_cd),TRIM((SALT35.StrType)le.event_corp_nbr_desc),TRIM((SALT35.StrType)le.event_roll),TRIM((SALT35.StrType)le.event_frame),TRIM((SALT35.StrType)le.event_start),TRIM((SALT35.StrType)le.event_end),TRIM((SALT35.StrType)le.event_microfilm_nbr),TRIM((SALT35.StrType)le.event_desc),TRIM((SALT35.StrType)le.event_revocation_comment1),TRIM((SALT35.StrType)le.event_revocation_comment2),TRIM((SALT35.StrType)le.event_book_nbr),TRIM((SALT35.StrType)le.event_page_nbr),TRIM((SALT35.StrType)le.event_certification_nbr)));
  SELF.FldNo := C;
END;
...
SALT35.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 29);
  SELF.FldNo2 := 1 + (C % 29);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT35.StrType)le.corp_key),TRIM((SALT35.StrType)le.corp_supp_key),TRIM((SALT35.StrType)le.corp_vendor),TRIM((SALT35.StrType)le.corp_vendor_county),TRIM((SALT35.StrType)le.corp_vendor_subcode),TRIM((SALT35.StrType)le.corp_state_origin),TRIM((SALT35.StrType)le.corp_process_date),TRIM((SALT35.StrType)le.corp_sos_charter_nbr),TRIM((SALT35.StrType)le.event_filing_reference_nbr),TRIM((SALT35.StrType)le.event_amendment_nbr),TRIM((SALT35.StrType)le.event_filing_date),TRIM((SALT35.StrType)le.event_date_type_cd),TRIM((SALT35.StrType)le.event_date_type_desc),TRIM((SALT35.StrType)le.event_filing_cd),TRIM((SALT35.StrType)le.event_filing_desc),TRIM((SALT35.StrType)le.event_corp_nbr),TRIM((SALT35.StrType)le.event_corp_nbr_cd),TRIM((SALT35.StrType)le.event_corp_nbr_desc),TRIM((SALT35.StrType)le.event_roll),TRIM((SALT35.StrType)le.event_frame),TRIM((SALT35.StrType)le.event_start),TRIM((SALT35.StrType)le.event_end),TRIM((SALT35.StrType)le.event_microfilm_nbr),TRIM((SALT35.StrType)le.event_desc),TRIM((SALT35.StrType)le.event_revocation_comment1),TRIM((SALT35.StrType)le.event_revocation_comment2),TRIM((SALT35.StrType)le.event_book_nbr),TRIM((SALT35.StrType)le.event_page_nbr),TRIM((SALT35.StrType)le.event_certification_nbr)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT35.StrType)le.corp_key),TRIM((SALT35.StrType)le.corp_supp_key),TRIM((SALT35.StrType)le.corp_vendor),TRIM((SALT35.StrType)le.corp_vendor_county),TRIM((SALT35.StrType)le.corp_vendor_subcode),TRIM((SALT35.StrType)le.corp_state_origin),TRIM((SALT35.StrType)le.corp_process_date),TRIM((SALT35.StrType)le.corp_sos_charter_nbr),TRIM((SALT35.StrType)le.event_filing_reference_nbr),TRIM((SALT35.StrType)le.event_amendment_nbr),TRIM((SALT35.StrType)le.event_filing_date),TRIM((SALT35.StrType)le.event_date_type_cd),TRIM((SALT35.StrType)le.event_date_type_desc),TRIM((SALT35.StrType)le.event_filing_cd),TRIM((SALT35.StrType)le.event_filing_desc),TRIM((SALT35.StrType)le.event_corp_nbr),TRIM((SALT35.StrType)le.event_corp_nbr_cd),TRIM((SALT35.StrType)le.event_corp_nbr_desc),TRIM((SALT35.StrType)le.event_roll),TRIM((SALT35.StrType)le.event_frame),TRIM((SALT35.StrType)le.event_start),TRIM((SALT35.StrType)le.event_end),TRIM((SALT35.StrType)le.event_microfilm_nbr),TRIM((SALT35.StrType)le.event_desc),TRIM((SALT35.StrType)le.event_revocation_comment1),TRIM((SALT35.StrType)le.event_revocation_comment2),TRIM((SALT35.StrType)le.event_book_nbr),TRIM((SALT35.StrType)le.event_page_nbr),TRIM((SALT35.StrType)le.event_certification_nbr)));
  END;
...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{27,'event_book_nbr'}
      ,{28,'event_page_nbr'}
      ,{29,'event_certification_nbr'}],SALT35.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_event_filing_reference_nbr((SALT35.StrType)le.event_filing_reference_nbr),
    Fields.InValid_event_amendment_nbr((SALT35.StrType)le.event_amendment_nbr),
    Fields.InValid_event_filing_date((SALT35.StrType)le.event_filing_date),
    Fields.InValid_event_date_type_cd((SALT35.StrType)le.event_date_type_cd),
    Fields.InValid_event_date_type_desc((SALT35.StrType)le.event_date_type_desc),
    Fields.InValid_event_filing_cd((SALT35.StrType)le.event_filing_cd),
    Fields.InValid_event_filing_desc((SALT35.StrType)le.event_filing_desc),
    Fields.InValid_event_corp_nbr((SALT35.StrType)le.event_corp_nbr),
    Fields.InValid_event_corp_nbr_cd((SALT35.StrType)le.event_corp_nbr_cd),
    Fields.InValid_event_corp_nbr_desc((SALT35.StrType)le.event_corp_nbr_desc),
    Fields.InValid_event_roll((SALT35.StrType)le.event_roll),
    Fields.InValid_event_frame((SALT35.StrType)le.event_frame),
    Fields.InValid_event_start((SALT35.StrType)le.event_start),
    Fields.InValid_event_end((SALT35.StrType)le.event_end),
    Fields.InValid_event_microfilm_nbr((SALT35.StrType)le.event_microfilm_nbr),
    Fields.InValid_event_desc((SALT35.StrType)le.event_desc),
    Fields.InValid_event_revocation_comment1((SALT35.StrType)le.event_revocation_comment1),
    Fields.InValid_event_revocation_comment2((SALT35.StrType)le.event_revocation_comment2),
    Fields.InValid_event_book_nbr((SALT35.StrType)le.event_book_nbr),
    Fields.InValid_event_page_nbr((SALT35.StrType)le.event_page_nbr),
    Fields.InValid_event_certification_nbr((SALT35.StrType)le.event_certification_nbr),
    0);
