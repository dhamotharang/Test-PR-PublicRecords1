...
IMPORT SALT311;
EXPORT AccidentAbstract_Raw_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'AccidentAbstract_Raw';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_FILENAME := 'AccidentAbstract_Raw_in_OSHAIR';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,summary_nr,line_nr';
