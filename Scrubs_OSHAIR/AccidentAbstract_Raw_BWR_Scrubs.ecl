...
#workunit('name','Scrubs_OSHAIR.AccidentAbstract_Raw_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_OSHAIR,SALT311;
infile := Scrubs_OSHAIR.AccidentAbstract_Raw_In_AccidentAbstract_Raw_in_OSHAIR;
mod_scrubs := Scrubs_OSHAIR.AccidentAbstract_Raw_Scrubs;
