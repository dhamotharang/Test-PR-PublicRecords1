...
#workunit('name','Scrubs_OSHAIR.StrategicCodes_Raw_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_OSHAIR,SALT311;
infile := Scrubs_OSHAIR.StrategicCodes_Raw_In_StrategicCodes_Raw_In_OSHAIR;
mod_scrubs := Scrubs_OSHAIR.StrategicCodes_Raw_Scrubs;
