...
SHARED FldIds := DATASET([{1,'activity_nr'}
      ...
      ,{32,'case_mod_year'}
      ,{33,'close_conf_year'}
      ,{34,'close_case_year'}],SALT311.MAC_Character_Counts.Field_Identification);
