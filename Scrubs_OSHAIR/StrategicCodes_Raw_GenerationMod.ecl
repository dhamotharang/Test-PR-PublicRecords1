...
IMPORT SALT311;
EXPORT StrategicCodes_Raw_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'StrategicCodes_Raw';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spc_FILENAME := 'StrategicCodes_Raw_In_OSHAIR';
  EXPORT spc_INGESTSTATUS := '';
  EXPORT spc_EXTERNAL_MAPPING := 'UniqueID:';
  EXPORT spc_EXTERNAL_BATCH_PARAM := ',/* MY_ */,activity_nr,prog_type';
