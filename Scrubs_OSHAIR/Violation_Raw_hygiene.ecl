...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_numeric','invalid_alpha_numeric','Invalid_X','Invalid_viol_type','invalid_date_time','invalid_date_future','invalid_numeric_or_period','invalid_numeric_or_period','invalid_date_time','invalid_date_future','invalid_numeric_blank','invalid_numeric_blank','Invalid_rec','invalid_numeric_blank','Invalid_X','invalid_alpha_blank','invalid_numeric_blank','invalid_date_time','invalid_numeric_or_period','invalid_date_ccyymm','invalid_date_ccyymm','invalid_alpha_numeric','invalid_alpha_numeric','invalid_alpha_numeric','invalid_alpha_numeric','invalid_alpha_numeric');
