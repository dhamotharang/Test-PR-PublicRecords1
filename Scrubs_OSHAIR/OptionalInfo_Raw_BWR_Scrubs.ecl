...
#workunit('name','Scrubs_OSHAIR.OptionalInfo_Raw_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_OSHAIR,SALT311;
infile := Scrubs_OSHAIR.OptionalInfo_Raw_In_OptionalInfo_Raw_In_OSHAIR;
mod_scrubs := Scrubs_OSHAIR.OptionalInfo_Raw_Scrubs;
