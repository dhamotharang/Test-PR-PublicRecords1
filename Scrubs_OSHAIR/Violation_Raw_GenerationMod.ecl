...
EXPORT Violation_Raw_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:issuance_date:TYPE(STRING10):LIKE(invalid_date_time):0,0\n'
    ...
    + 'FIELD:contest_date:TYPE(STRING10):LIKE(invalid_date_time):0,0\n'
    ...
    + 'FIELD:fta_issuance_date:TYPE(STRING8):LIKE(invalid_date_time):0,0\n'
    ...
    + 'FIELD:hazsub1:TYPE(STRING4):LIKE(invalid_alpha_numeric):0,0\n'
    + 'FIELD:hazsub2:TYPE(STRING4):LIKE(invalid_alpha_numeric):0,0\n'
    + 'FIELD:hazsub3:TYPE(STRING4):LIKE(invalid_alpha_numeric):0,0\n'
    + 'FIELD:hazsub4:TYPE(STRING4):LIKE(invalid_alpha_numeric):0,0\n'
    + 'FIELD:hazsub5:TYPE(STRING4):LIKE(invalid_alpha_numeric):0,0'
    ;
