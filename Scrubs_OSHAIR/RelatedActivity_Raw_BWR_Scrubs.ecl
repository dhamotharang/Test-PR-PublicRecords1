...
#workunit('name','Scrubs_OSHAIR.RelatedActivity_Raw_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_OSHAIR,SALT311;
infile := Scrubs_OSHAIR.RelatedActivity_Raw_In_RelatedActivity_Raw_In_OSHAIR;
mod_scrubs := Scrubs_OSHAIR.RelatedActivity_Raw_Scrubs;
