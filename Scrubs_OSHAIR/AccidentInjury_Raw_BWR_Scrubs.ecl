...
#workunit('name','Scrubs_OSHAIR.AccidentInjury_Raw_BWR_Scrubs - Checking field validity in a file - SALT V3.11.8');
IMPORT Scrubs_OSHAIR,SALT311;
infile := Scrubs_OSHAIR.AccidentInjury_Raw_In_AccidentInjury_Raw_in_OSHAIR;
mod_scrubs := Scrubs_OSHAIR.AccidentInjury_Raw_Scrubs;
