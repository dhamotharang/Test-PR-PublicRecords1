...
Command line options: -MScrubs_Corp2_Mapping_NH_Stock -eC:\Users\mattel01\AppData\Local\Temp\TFR7EC3.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_NH_Stock
FILENAME:In_NH
...
FIELDTYPE:invalid_stock_class:CUSTOM(Scrubs_Corp2_Mapping_NH_Stock.Functions.valid_stock_class_type_desc>0)
FIELDTYPE:invalid_stock_shares_issued:ALLOW( 0123456789)
...
FIELD:stock_class:TYPE(STRING20):LIKE(invalid_stock_class):0,0
FIELD:stock_shares_issued:TYPE(STRING15):LIKE(invalid_stock_shares_issued):0,0
