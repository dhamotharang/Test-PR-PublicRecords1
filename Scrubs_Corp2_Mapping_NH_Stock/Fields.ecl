...
EXPORT SALT34.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_charter_nbr','invalid_stock_class','invalid_stock_shares_issued','invalid_stock_authorized_nbr','invalid_stock_par_value');
EXPORT FieldTypeNum(SALT34.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_corp_vendor' => 2,'invalid_state_origin' => 3,'invalid_mandatory' => 4,'invalid_date' => 5,'invalid_charter_nbr' => 6,'invalid_stock_class' => 7,'invalid_stock_shares_issued' => 8,'invalid_stock_authorized_nbr' => 9,'invalid_stock_par_value' => 10,0);
...
EXPORT MakeFT_invalid_stock_class(SALT34.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_stock_class(SALT34.StrType s) := WHICH(~Scrubs_Corp2_Mapping_NH_Stock.Functions.valid_stock_class_type_desc(s)>0);
EXPORT InValidMessageFT_invalid_stock_class(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_NH_Stock.Functions.valid_stock_class_type_desc'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_stock_shares_issued(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' 0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_stock_shares_issued(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' 0123456789'))));
EXPORT InValidMessageFT_invalid_stock_shares_issued(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' 0123456789'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_stock_authorized_nbr(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' 0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_stock_authorized_nbr(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' 0123456789'))));
EXPORT InValidMessageFT_invalid_stock_authorized_nbr(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' 0123456789'),SALT34.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_stock_par_value(SALT34.StrType s0) := FUNCTION
  s1 := SALT34.stringfilter(s0,' .0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_stock_par_value(SALT34.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT34.StringFilter(s,' .0123456789'))));
EXPORT InValidMessageFT_invalid_stock_par_value(UNSIGNED1 wh) := CHOOSE(wh,SALT34.HygieneErrors.NotInChars(' .0123456789'),SALT34.HygieneErrors.Good);
...
EXPORT Make_stock_shares_issued(SALT34.StrType s0) := MakeFT_invalid_stock_shares_issued(s0);
EXPORT InValid_stock_shares_issued(SALT34.StrType s) := InValidFT_invalid_stock_shares_issued(s);
EXPORT InValidMessage_stock_shares_issued(UNSIGNED1 wh) := InValidMessageFT_invalid_stock_shares_issued(wh);
 
EXPORT Make_stock_authorized_nbr(SALT34.StrType s0) := MakeFT_invalid_stock_authorized_nbr(s0);
EXPORT InValid_stock_authorized_nbr(SALT34.StrType s) := InValidFT_invalid_stock_authorized_nbr(s);
EXPORT InValidMessage_stock_authorized_nbr(UNSIGNED1 wh) := InValidMessageFT_invalid_stock_authorized_nbr(wh);
 
EXPORT Make_stock_par_value(SALT34.StrType s0) := MakeFT_invalid_stock_par_value(s0);
EXPORT InValid_stock_par_value(SALT34.StrType s) := InValidFT_invalid_stock_par_value(s);
...
EXPORT Make_stock_change_ind(SALT34.StrType s0) := s0;
EXPORT InValid_stock_change_ind(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_stock_change_ind(UNSIGNED1 wh) := '';
 
EXPORT Make_stock_change_date(SALT34.StrType s0) := s0;
EXPORT InValid_stock_change_date(SALT34.StrType s) := FALSE;
...
EXPORT Make_stock_change_in_cap(SALT34.StrType s0) := s0;
EXPORT InValid_stock_change_in_cap(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_stock_change_in_cap(UNSIGNED1 wh) := '';
 
EXPORT Make_stock_tax_capital(SALT34.StrType s0) := s0;
EXPORT InValid_stock_tax_capital(SALT34.StrType s) := FALSE;
EXPORT InValidMessage_stock_tax_capital(UNSIGNED1 wh) := '';
 
EXPORT Make_stock_total_capital(SALT34.StrType s0) := s0;
EXPORT InValid_stock_total_capital(SALT34.StrType s) := FALSE;
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT34,Scrubs_Corp2_Mapping_NH_Stock;
