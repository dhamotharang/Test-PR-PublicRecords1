...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELD:casenumber:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:memberstate:TYPE(STRING):LIKE(Invalid_State):0,0\n'
    ...
    + 'FIELD:aidinstrument:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    ...
    + 'FIELD:relatedcaseinformation1:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:relatedcasenumber2:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:relatedcaseinformation2:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:relatedcasenumber3:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:relatedcaseinformation3:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:relatedcasenumber4:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:relatedcaseinformation4:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:relatedcasenumber5:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:relatedcaseinformation5:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    ...
    + 'FIELD:publicationpriorjournal:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:publicationpriorjournaldate:TYPE(STRING):LIKE(Invalid_Date):0,0\n'
    + 'FIELD:econactid:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:economicactivity:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:compeventid:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    + 'FIELD:eventdate:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:eventdoctype:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    + 'FIELD:eventdocument:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    ...
    + 'FIELD:eu_country_code:TYPE(STRING):LIKE(Invalid_No):0,0\n'
    ;
