...
IMPORT SALT311;
EXPORT Base_Nixie_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_NAMESCOPE := 'Base_Nixie';
  EXPORT spc_PROCESS := '';
  ...
  EXPORT spcString :=
    ...
    + '\n'
    + 'FIELDTYPE:invalid_dept_code:CUSTOM(Scrubs_SKA.Functions.fn_alpha_opt>0,3)\n'
    + 'FIELDTYPE:invalid_dept_expl:CUSTOM(Scrubs_SKA.Functions.fn_str1_xor_str2>0,dept_code)\n'
    ...
    + 'FIELDTYPE:invalid_area_code:CUSTOM(Scrubs_SKA.Functions.fn_numeric>0,3)\n'
    + 'FIELDTYPE:invalid_number:CUSTOM(Scrubs_SKA.Functions.fn_numeric_opt>0,7)\n'
    ...
    + 'FIELD:first_name:TYPE(STRING15):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:middle:TYPE(STRING1):0,0\n'
    + 'FIELD:last_name:TYPE(STRING15):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:t1:TYPE(STRING35):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:dept_code:TYPE(STRING3):LIKE(invalid_dept_code):0,0\n'
    ...
    + 'FIELD:dept_file:TYPE(STRING40):0,0\n'
    + 'FIELD:company1:TYPE(STRING31):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:address1:TYPE(STRING31):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:city:TYPE(STRING17):LIKE(invalid_mandatory):0,0\n'
    + 'FIELD:state:TYPE(STRING2):LIKE(invalid_state):0,0\n'
    + 'FIELD:zip:TYPE(STRING10):LIKE(invalid_zip):0,0\n'
    + 'FIELD:area_code:TYPE(STRING3):LIKE(invalid_area_code):0,0\n'
    + 'FIELD:number:TYPE(STRING8):LIKE(invalid_number):0,0\n'
    + 'FIELD:persid:TYPE(STRING10):LIKE(invalid_numeric):0,0\n'
    + 'FIELD:nixie_date:TYPE(STRING10):LIKE(invalid_pastdate8):0,0\n'
