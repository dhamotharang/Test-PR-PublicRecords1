...
SpcShiftR := RECORD
  ...
  integer2 cnp_name_switch_shift0 := ROUND(1000*Specificities[1].cnp_name_switch - 278);
  ...
  integer2 company_charter_number_switch_shift0 := ROUND(1000*Specificities[1].company_charter_number_switch - 47);
  integer1 company_fein_shift0 := ROUND(Specificities[1].company_fein_specificity - 27);
  integer2 company_fein_switch_shift0 := ROUND(1000*Specificities[1].company_fein_switch - 160);
  integer1 prim_range_shift0 := ROUND(Specificities[1].prim_range_specificity - 13);
  integer2 prim_range_switch_shift0 := ROUND(1000*Specificities[1].prim_range_switch - 138);
  integer1 prim_name_shift0 := ROUND(Specificities[1].prim_name_specificity - 15);
  integer2 prim_name_switch_shift0 := ROUND(1000*Specificities[1].prim_name_switch - 167);
  integer1 postdir_shift0 := ROUND(Specificities[1].postdir_specificity - 7);
  integer2 postdir_switch_shift0 := ROUND(1000*Specificities[1].postdir_switch - 54);
  integer1 sec_range_shift0 := ROUND(Specificities[1].sec_range_specificity - 12);
  integer2 sec_range_switch_shift0 := ROUND(1000*Specificities[1].sec_range_switch - 199);
  integer1 v_city_name_shift0 := ROUND(Specificities[1].v_city_name_specificity - 11);
  integer2 v_city_name_switch_shift0 := ROUND(1000*Specificities[1].v_city_name_switch - 99);
  integer1 st_shift0 := ROUND(Specificities[1].st_specificity - 5);
  integer2 st_switch_shift0 := ROUND(1000*Specificities[1].st_switch - 21);
  integer1 active_duns_number_shift0 := ROUND(Specificities[1].active_duns_number_specificity - 28);
  integer2 active_duns_number_switch_shift0 := ROUND(1000*Specificities[1].active_duns_number_switch - 43);
  integer1 active_enterprise_number_shift0 := ROUND(Specificities[1].active_enterprise_number_specificity - 28);
  integer2 active_enterprise_number_switch_shift0 := ROUND(1000*Specificities[1].active_enterprise_number_switch - 39);
  integer1 source_shift0 := ROUND(Specificities[1].source_specificity - 4);
  integer2 source_switch_shift0 := ROUND(1000*Specificities[1].source_switch - 686);
  integer1 source_record_id_shift0 := ROUND(Specificities[1].source_record_id_specificity - 27);
  integer2 source_record_id_switch_shift0 := ROUND(1000*Specificities[1].source_record_id_switch - 900);
  integer1 fname_shift0 := ROUND(Specificities[1].fname_specificity - 11);
  integer2 fname_switch_shift0 := ROUND(1000*Specificities[1].fname_switch - 470);
  integer1 mname_shift0 := ROUND(Specificities[1].mname_specificity - 8);
  integer2 mname_switch_shift0 := ROUND(1000*Specificities[1].mname_switch - 316);
  integer1 lname_shift0 := ROUND(Specificities[1].lname_specificity - 16);
  integer2 lname_switch_shift0 := ROUND(1000*Specificities[1].lname_switch - 355);
  integer1 contact_ssn_shift0 := ROUND(Specificities[1].contact_ssn_specificity - 27);
  integer2 contact_ssn_switch_shift0 := ROUND(1000*Specificities[1].contact_ssn_switch - 143);
  integer1 contact_phone_shift0 := ROUND(Specificities[1].contact_phone_specificity - 27);
  integer2 contact_phone_switch_shift0 := ROUND(1000*Specificities[1].contact_phone_switch - 216);
  integer1 contact_email_username_shift0 := ROUND(Specificities[1].contact_email_username_specificity - 27);
  integer2 contact_email_username_switch_shift0 := ROUND(1000*Specificities[1].contact_email_username_switch - 201);
  END;
