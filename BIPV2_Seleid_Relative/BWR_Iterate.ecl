...
#workunit('name','BIPV2_Seleid_Relative.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
...
SALT30.MAC_MatchSamplePatterns(BIPV2_Seleid_Relative.Keys(BIPV2_Seleid_Relative.In_Base).MatchSample,MatchPatterns,Seleid1,Seleid2,8,38-44);
