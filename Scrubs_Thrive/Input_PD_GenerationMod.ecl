...
EXPORT Input_PD_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + '//-------------------------\n'
    + 'FIELDTYPE:invalid_fname:ALLOW(AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz-.\' )\n'
    + 'FIELDTYPE:invalid_mname:ALLOW(AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz )\n'
    + 'FIELDTYPE:invalid_lname:ALLOW(1234AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz-.\' )\n'
    + 'FIELDTYPE:invalid_addr:ALLOW(0123456789AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz-.\'#/ ):CUSTOM(Scrubs_Thrive.Functions.fn_invalid_addr >0)\n'
    + 'FIELDTYPE:invalid_city:ALLOW(AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz-.\' )\n'
