IMPORT PRTE2_SexOffender, data_services, sexoffender;
...
EXPORT Constants := MODULE
		...
		// DF-21920 Blank out following fields in prte::key::sexoffender::fcra::spkpublic_qa
		export fields_to_clear_spkpublic := sexoffender.Constants.fields_to_clear_spkpublic;
...
*/
	...
	// DF-21920 Blank out following fields in prte::key::sexoffender::fcra::offenses_public_qa
	export fields_to_clear_offenses_public := sexoffender.Constants.fields_to_clear_offenses_public;
	/*'arrest_date,arrest_warrant,conviction_date,conviction_jurisdiction,court,court_case_number,offense_category,' +
