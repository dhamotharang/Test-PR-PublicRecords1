EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT30.Str30Type fieldname := #TEXT(infield);
	  SALT30.StrType fieldvalue {maxlength(200000)} := (SALT30.StrType)infile.infield ;
		SALT30.StrType src {maxlength(30)} := infile.srcfield ;
