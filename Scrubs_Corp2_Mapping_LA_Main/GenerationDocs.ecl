Generated by SALT V3.2 Beta 1
Command line options: -MScrubs_Corp2_Mapping_LA_Main -eC:\Users\butlersx\AppData\Local\Temp\TFR34DB.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_LA_Main
FILENAME:In_LA
...
FIELDTYPE:invalid_corp_vendor:ENUM(22)
FIELDTYPE:invalid_state_origin:ENUM(LA)
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_LA_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_cont_type_cd:ENUM(01|02|I|T| )
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_LA_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
FIELDTYPE:invalid_org_structure_cd:CUSTOM(Scrubs_Corp2_Mapping_LA_Main.Functions.invalid_org_structure_cd>0)
FIELDTYPE:invalid_addr_type_cd:ENUM(B| ):LENGTHS(1,0)
FIELDTYPE:invalid_addr_type_desc:ENUM(BUSINESS| )
FIELDTYPE:invalid_term_exist_cd:ENUM(D|P| )
FIELDTYPE:invalid_for_dom_ind:ENUM(F|D| )
FIELDTYPE:invalid_recordorigin:ENUM(C|T)
FIELDTYPE:invalid_alphablank:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alphablankspec:ALLOW(/.,ABCDEFGHIJKLMNOPQRSTUVWXYZ )
...
FIELD:corp_ln_name_type_cd:TYPE(STRING2):LIKE(invalid_type_cd):0,0
FIELD:corp_ln_name_type_desc:TYPE(STRING30):LIKE(invalid_type_desc):0,0
...
FIELD:corp_standing:TYPE(STRING1):LIKE(invalid_Y_N):0,0
FIELD:corp_status_comment:TYPE(STRING350):LIKE(invalid_alphablankspec):0,0
...
FIELD:corp_inc_county:TYPE(STRING30):LIKE(invalid_alphablank):0,0
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphablankspec):0,0
...
FIELD:corp_orig_org_structure_cd:TYPE(STRING8):LIKE(invalid_org_structure_cd):0,0
FIELD:corp_orig_org_structure_desc:TYPE(STRING60):0,0
FIELD:corp_for_profit_ind:TYPE(STRING1):LIKE(invalid_Y_N):0,0
...
FIELD:corp_ra_address_type_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
...
FIELD:cont_filing_desc:TYPE(STRING60):LIKE(invalid_alphablank):0,0
...
FIELD:corp_country_of_formation:TYPE(STRING50):LIKE(invalid_alphablankspec):0,0
...
FIELD:corp_name_reservation_date:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:corp_name_reservation_expiration_date:TYPE(STRING8):LIKE(invalid_future_date):0,0
FIELD:corp_name_reservation_nbr:TYPE(STRING32):LIKE(invalid_numblank):0,0
FIELD:corp_name_reservation_type:TYPE(STRING100):0,0
FIELD:corp_name_status_cd:TYPE(STRING5):0,0
FIELD:corp_name_status_date:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:corp_name_status_desc:TYPE(STRING50):LIKE(invalid_alphablank):0,0
...
FIELD:corp_trademark_first_use_date:TYPE(STRING8):LIKE(invalid_date):0,0
FIELD:corp_trademark_first_use_date_in_state:TYPE(STRING8):LIKE(invalid_date):0,0
...
FIELD:corp_trademark_status:TYPE(STRING1):LIKE(invalid_alphablank):0,0
...
FIELD:cont_country:TYPE(STRING50):LIKE(invalid_alphablankspec):0,0
