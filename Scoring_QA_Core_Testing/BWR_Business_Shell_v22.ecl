...
inputFileName := '~scoringqa::in::business_shell_v22_exphone_input::exphn_sba_sbfe_dev_85k_in.csv';

outputFile := '~scoringqa::out::business_shell_v22_exphone_after' + ThorLib.wuid();
