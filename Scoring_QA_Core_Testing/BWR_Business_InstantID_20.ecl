...
recordsToRun := 5; // Set to 0 (zero) to run all records.
eyeball      := 10;
threads      := 2;
...
inputFile := // ut.foreign_prod + 'jpyon::in::rbs_1179_bus_bus_con_f_s_in';
		 ut.foreign_prod + 'akoenen::out::business_instantid2_saot_20171001-20180201__w20180201-112332.csv';
outputFile := '~scoringqa::out::expphone_CoreTest_Before' + FilenameSuffix + ThorLib.wuid();
...
ds_input := 
	IF(
		...
		CHOOSEN(DATASET(inputFile, layout, thor), recordsToRun )
	);
