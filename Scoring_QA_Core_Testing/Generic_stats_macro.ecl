EXPORT Generic_stats_macro := (ds, at_name) := FUNCTIONMACRO

	// Attributes in which don't use <blank>, -1 in calculating stats.  Use this when zero is a valid response.  eg Number of loans can be 0-99
