EXPORT Core_Testing_Errors(String filetag) := FUNCTION
...
Chase_BNK4_xml_outfile_name := '~ScoringQA::out::NONFCRA::BNK4_xml_chase_BD3605_0_' + DateRan + '_' + filetag;
Chase_BNK4_batch_outFile_name := '~ScoringQA::out::NONFCRA::BNK4_batch_chase_BD3605_0_' + DateRan + '_' + filetag;
Chase_PIO2_xml_outFile_name := '~ScoringQA::out::NONFCRA::PI02_xml_chase_FP3710_0_' + DateRan + '_' + filetag;
Chase_PIO2_batch_outFile_name := '~ScoringQA::out::NONFCRA::PI02_batch_chase_FP3710_0_' + DateRan + '_' + filetag;
Chase_CBBL_outfile_name := '~ScoringQA::out::NONFCRA::cbbl_xml_chase_' + DateRan + '_' + filetag;
// Chase_CBBL_outfile_name_FPScore_ONLY := '~ScoringQA::out::NONFCRA::cbbl_xml_chase_FPScore_ONLY_' + DateRan + '_' + filetag;
CapitalOne_batch_outfile_name := '~ScoringQA::out::NONFCRA::ITA_batch_CapitalOne_attributes_v3_' + DateRan + '_' + filetag;
bbuy_outFile_Name := '~ScoringQA::out::NONFCRA::ChargebackDefender_xml_BestBuy_CDN1109_1_' + DateRan + '_' + filetag;
li_v4_scores_batch_outFile_name := '~ScoringQA::out::NONFCRA::leadintegrity_batch_generic_msn1106_0_v4_' + DateRan + '_' + filetag;
li_v4_attributes_batch_outFile_name := '~ScoringQA::out::NONFCRA::leadintegrity_batch_generic_attributes_v4_' + DateRan + '_' + filetag;
li_v4_scores_xml_outFile_name := '~ScoringQA::out::NONFCRA::leadintegrity_xml_generic_msn1106_0_v4_' + DateRan + '_' + filetag;
li_v4_attributes_xml_outFile_name := '~ScoringQA::out::NONFCRA::leadintegrity_xml_generic_attributes_v4_' + DateRan + '_' + filetag;
chase_BIID_batch_outfile_name := '~ScoringQA::out::NONFCRA::businessinstantid_batch_Chase_' + DateRan + '_' + filetag;
biid_xml_outFile_name := '~ScoringQA::out::NONFCRA::businessinstantid_xml_generic_' + DateRan + '_' + filetag;
biid_batch_outFile_name := '~ScoringQA::out::NONFCRA::businessinstantid_batch_generic_' + DateRan + '_' + filetag;
iid_xml_outfile_name := '~ScoringQA::out::NONFCRA::instantid_xml_generic_' + DateRan + '_' + filetag;
iid_batch_outfile_name := '~ScoringQA::out::NONFCRA::instantid_batch_generic_' + DateRan + '_' + filetag;
// FP_XML_outfile_name := '~ScoringQA::out::NONFCRA::fraudpoint_xml_generic_fp1109_0_v2_' + DateRan + '_' + filetag;
// FP_BATCH_outfile_name := '~ScoringQA::out::NONFCRA::fraudpoint_batch_generic_fp1109_0_v2_' + DateRan + '_' + filetag;
FP_V2_XML_American_Express_FP1109_0_outfile_name := '~ScoringQA::out::NONFCRA::fraudpoint_xml_American_Express_fp1109_0_v201_' + DateRan + '_' + filetag ;
FP_V3_XML_Generic_FP31505_0_outfile_name := '~ScoringQA::out::NONFCRA::fraudpoint_xml_generic_fp31505_0_v3_flsd_' + DateRan + '_' + filetag;
PB_capone_outfile_name := '~ScoringQA::out::NONFCRA::Profile_Booster_Batch_CapitalOne_attributes_v1_'+ DateRan + '_' + filetag;

//********************** FCRA ******************************

Experian_RVA_30_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_Experian_attributes_v3_' + DateRan + '_' + filetag;
Experian_RVA_30_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_batch_Experian_attributes_v3_' + DateRan + '_' + filetag;
CapitalOne_RVAttributes_V3_outfile_name := '~ScoringQA::out::FCRA::RiskView_Batch_Capitalone_attributes_v3_' + DateRan + '_' + filetag;
CapitalOne_RVAttributes_V2_outfile_name := '~ScoringQA::out::FCRA::RiskView_Batch_Capitalone_attributes_V2_' + DateRan + '_' + filetag;
CapitalOne_RVAttributes_V5_outfile_name := '~ScoringQA::out::FCRA::RiskView_Batch_Capitalone_attributes_v5_' + DateRan + '_' + filetag;
CreditAcceptanceCorp_RV2_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_creditacceptancecorp_attributes_v2_' + DateRan + '_' + filetag;
T_Mobile_RVT1212_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_T_mobile_RVT1212_1_v4_' + DateRan + '_' + filetag;
T_Mobile_RVT1210_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_T_mobile_RVT1210_1_v4_' + DateRan + '_' + filetag;
Santander_RVA1304_1_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_Santander_RVA1304_1_v3_' + DateRan + '_' + filetag;
Santander_RVA1304_2_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_Santander_RVA1304_2_v3_' + DateRan + '_' + filetag;
RV_V3_ENOVA_XML_Scores_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_enova_rvg1103_0_v4_' + DateRan + '_' + filetag;
RV_Scores_V4_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_generic_allflagships_v4_' + DateRan + '_' + filetag;
RV_Scores_V3_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_generic_allflagships_v3_' + DateRan + '_' + filetag;
RV_Attributes_V4_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_generic_attributes_v4_' + DateRan + '_' + filetag;
RV_Attributes_V3_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_generic_attributes_v3_' + DateRan + '_' + filetag;
RV_Attributes_V3_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_batch_generic_attributes_v3_' + DateRan + '_' + filetag;
RV_Attributes_V4_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_batch_generic_attributes_v4_' + DateRan + '_' + filetag;
RV_Scores_V4_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_batch_generic_allflagships_v4_' + DateRan + '_' + filetag;
RV_Scores_V3_BATCH_outfile_name := '~ScoringQA::out::FCRA::RiskView_batch_generic_allflagships_v3_' + DateRan + '_' + filetag;
Regional_Acceptance_RVA1008_1_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_RegionalAcceptance_RVA1008_1_v4_' + DateRan + '_' + filetag;
RV_Scores_Attributes_V5_XML_outfile_name := '~ScoringQA::out::FCRA::RiskView_xml_generic_allflagships_attributes_v5_' + DateRan + '_' + filetag;
// RV_Scores_Attributes_V5_XML_Generic_prescreen_outfile := '~ScoringQA::out::FCRA::RiskView_xml_generic_allflagships_attributes_v5_prescreen_' + DateRan + '_' + filetag;  //removed in favor of Capone v5 prescreen


//************************ SHELLS ***************
																	
bocashell_41_fcra_outfile_name := '~scoringqa::out::bs_41_fcra_NO_EDINA_' + DateRan + '_' + filetag;
bocashell_41_nonfcra_outfile_name := '~scoringqa::out::bs_41_nonfcra_NO_EDINA_' + DateRan + '_' + filetag;
bocashell_50_fcra_outfile_name := '~scoringqa::out::bs_50_FCRA_NO_EDINA_' + DateRan + '_' + filetag;
bocashell_50_nonfcra_outfile_name := '~scoringqa::out::bs_50_nonFCRA_NO_EDINA_' + DateRan + '_' + filetag;

AddressShell_Attributes_V1_BATCH_Generic_outfile := '~ScoringQA::out::AddressShell_V1_Batch_Generic_' + DateRan + '_' + filetag;
BusinessShell_outfile_name := '~ScoringQA::out::NONFCRA::BusinessShell_xml_generic_attributes_v2_' + DateRan + '_' + filetag;
PhoneShell_outfile_name := '~ScoringQA::out::phone_shell_' + DateRan + '_' + filetag;
...
Appended_Table := Output(table(Filtered_Appended_ds, {Product; RecordCount; ErrorCount := count(group); errorcode}, Product, errorcode), Named('Roxie_Errors'));
