EXPORT RV_Scores_Attributes_V3_XML_DRM_DPM_In (fcraroxie_IP, neutralroxie_IP, Thread, Timeout, Retry, Input_file_name,  Output_file_name, records_ToRun, In_DRM, in_DPM ):= FUNCTIONMACRO
