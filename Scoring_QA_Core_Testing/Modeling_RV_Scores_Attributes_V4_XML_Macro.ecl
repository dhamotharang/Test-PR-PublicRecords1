EXPORT Modeling_RV_Scores_Attributes_V4_XML_Macro(fcraroxie_IP, neutralroxie_IP, Thread, Timeout, Retry, Input_file_name, Output_file_name1_score, Output_file_name2_attr, records_ToRun):= FUNCTIONMACRO
...
Global_output_lay2:= RECORD	 
	...
	output(ds_slim,, outfile_name2+'CSV_COPY', CSV(heading(single), quote('"')), overwrite);
