...
OutputFile := '~akoenen::out::phone_shell::New::NoGateways';
...
ScoringModelName := 'PHONESCORE_V2';//'PHONESCORE_V2' = OLD phone model; // Set to BLANK to turn off the scoring model
...
// QSentV2_TransUnion_Gateway_URL := riskwise.shortcuts.QSentV2_TransUnion_Gateway_URL;
