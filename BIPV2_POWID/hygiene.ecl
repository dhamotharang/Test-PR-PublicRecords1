...
EXPORT Summary(SALT33.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_RID_If_Big_Biz := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.RID_If_Big_Biz)));
    avelength_RID_If_Big_Biz := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.RID_If_Big_Biz)),h.RID_If_Big_Biz<>(typeof(h.RID_If_Big_Biz))'');
    ...
    maxlength_num_legal_names := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_legal_names)));
    avelength_num_legal_names := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_legal_names)),h.num_legal_names<>(typeof(h.num_legal_names))'');
    populated_num_incs_pcnt := AVE(GROUP,IF(h.num_incs = (TYPEOF(h.num_incs))'',0,100));
    maxlength_num_incs := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_incs)));
    avelength_num_incs := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.num_incs)),h.num_incs<>(typeof(h.num_incs))'');
    populated_nodes_total_pcnt := AVE(GROUP,IF(h.nodes_total = (TYPEOF(h.nodes_total))'',0,100));
    maxlength_nodes_total := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.nodes_total)));
    avelength_nodes_total := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.nodes_total)),h.nodes_total<>(typeof(h.nodes_total))'');
    ...
    maxlength_company_inc_state := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_inc_state)));
    avelength_company_inc_state := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_inc_state)),h.company_inc_state<>(typeof(h.company_inc_state))'');
    populated_company_charter_number_pcnt := AVE(GROUP,IF(h.company_charter_number = (TYPEOF(h.company_charter_number))'',0,100));
    maxlength_company_charter_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_charter_number)));
    avelength_company_charter_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_charter_number)),h.company_charter_number<>(typeof(h.company_charter_number))'');
    ...
    maxlength_hist_duns_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hist_duns_number)));
    avelength_hist_duns_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hist_duns_number)),h.hist_duns_number<>(typeof(h.hist_duns_number))'');
    populated_active_domestic_corp_key_pcnt := AVE(GROUP,IF(h.active_domestic_corp_key = (TYPEOF(h.active_domestic_corp_key))'',0,100));
    maxlength_active_domestic_corp_key := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_domestic_corp_key)));
    avelength_active_domestic_corp_key := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.active_domestic_corp_key)),h.active_domestic_corp_key<>(typeof(h.active_domestic_corp_key))'');
    populated_hist_domestic_corp_key_pcnt := AVE(GROUP,IF(h.hist_domestic_corp_key = (TYPEOF(h.hist_domestic_corp_key))'',0,100));
    maxlength_hist_domestic_corp_key := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.hist_domestic_corp_key)));
    avelength_hist_domestic_corp_key := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.hist_domestic_corp_key)),h.hist_domestic_corp_key<>(typeof(h.hist_domestic_corp_key))'');
    populated_foreign_corp_key_pcnt := AVE(GROUP,IF(h.foreign_corp_key = (TYPEOF(h.foreign_corp_key))'',0,100));
    maxlength_foreign_corp_key := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.foreign_corp_key)));
    avelength_foreign_corp_key := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.foreign_corp_key)),h.foreign_corp_key<>(typeof(h.foreign_corp_key))'');
    populated_unk_corp_key_pcnt := AVE(GROUP,IF(h.unk_corp_key = (TYPEOF(h.unk_corp_key))'',0,100));
    maxlength_unk_corp_key := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.unk_corp_key)));
    avelength_unk_corp_key := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.unk_corp_key)),h.unk_corp_key<>(typeof(h.unk_corp_key))'');
    ...
    maxlength_company_name_type_derived := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name_type_derived)));
    avelength_company_name_type_derived := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_name_type_derived)),h.company_name_type_derived<>(typeof(h.company_name_type_derived))'');
    populated_company_bdid_pcnt := AVE(GROUP,IF(h.company_bdid = (TYPEOF(h.company_bdid))'',0,100));
    maxlength_company_bdid := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_bdid)));
    avelength_company_bdid := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.company_bdid)),h.company_bdid<>(typeof(h.company_bdid))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.id := le.POWID;
  SELF.Src := le.source;
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.RID_If_Big_Biz),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.num_legal_names),TRIM((SALT33.StrType)le.num_incs),TRIM((SALT33.StrType)le.nodes_total),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.company_inc_state),TRIM((SALT33.StrType)le.company_charter_number),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.hist_duns_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.hist_domestic_corp_key),TRIM((SALT33.StrType)le.foreign_corp_key),TRIM((SALT33.StrType)le.unk_corp_key),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.company_name_type_derived),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 28);
  SELF.FldNo2 := 1 + (C % 28);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.RID_If_Big_Biz),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.num_legal_names),TRIM((SALT33.StrType)le.num_incs),TRIM((SALT33.StrType)le.nodes_total),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.company_inc_state),TRIM((SALT33.StrType)le.company_charter_number),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.hist_duns_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.hist_domestic_corp_key),TRIM((SALT33.StrType)le.foreign_corp_key),TRIM((SALT33.StrType)le.unk_corp_key),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.company_name_type_derived),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.RID_If_Big_Biz),TRIM((SALT33.StrType)le.cnp_name),TRIM((SALT33.StrType)le.company_name),TRIM((SALT33.StrType)le.cnp_number),TRIM((SALT33.StrType)le.zip),TRIM((SALT33.StrType)le.num_legal_names),TRIM((SALT33.StrType)le.num_incs),TRIM((SALT33.StrType)le.nodes_total),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.company_inc_state),TRIM((SALT33.StrType)le.company_charter_number),TRIM((SALT33.StrType)le.active_duns_number),TRIM((SALT33.StrType)le.hist_duns_number),TRIM((SALT33.StrType)le.active_domestic_corp_key),TRIM((SALT33.StrType)le.hist_domestic_corp_key),TRIM((SALT33.StrType)le.foreign_corp_key),TRIM((SALT33.StrType)le.unk_corp_key),TRIM((SALT33.StrType)le.company_fein),TRIM((SALT33.StrType)le.cnp_btype),TRIM((SALT33.StrType)le.company_name_type_derived),TRIM((SALT33.StrType)le.company_bdid),TRIM((SALT33.StrType)le.dt_first_seen),TRIM((SALT33.StrType)le.dt_last_seen)));
  END;
...
SHARED FldIds := DATASET([{1,'prim_range'}
      ...
      ,{26,'company_bdid'}
      ,{27,'dt_first_seen'}
      ,{28,'dt_last_seen'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_RID_If_Big_Biz((SALT33.StrType)le.RID_If_Big_Biz),
    ...
    Fields.InValid_num_legal_names((SALT33.StrType)le.num_legal_names),
    Fields.InValid_num_incs((SALT33.StrType)le.num_incs),
    Fields.InValid_nodes_total((SALT33.StrType)le.nodes_total),
    ...
    Fields.InValid_company_inc_state((SALT33.StrType)le.company_inc_state),
    Fields.InValid_company_charter_number((SALT33.StrType)le.company_charter_number),
    Fields.InValid_active_duns_number((SALT33.StrType)le.active_duns_number),
    Fields.InValid_hist_duns_number((SALT33.StrType)le.hist_duns_number),
    Fields.InValid_active_domestic_corp_key((SALT33.StrType)le.active_domestic_corp_key),
    Fields.InValid_hist_domestic_corp_key((SALT33.StrType)le.hist_domestic_corp_key),
    Fields.InValid_foreign_corp_key((SALT33.StrType)le.foreign_corp_key),
    Fields.InValid_unk_corp_key((SALT33.StrType)le.unk_corp_key),
    Fields.InValid_company_fein((SALT33.StrType)le.company_fein),
    Fields.InValid_cnp_btype((SALT33.StrType)le.cnp_btype),
    Fields.InValid_company_name_type_derived((SALT33.StrType)le.company_name_type_derived),
    Fields.InValid_company_bdid((SALT33.StrType)le.company_bdid),
...
//Compute field consistencies between sources
  SALT33.mac_srcfrequency_outliers(h,company_name,source,company_name_outliers)
  SALT33.mac_srcfrequency_outliers(h,cnp_number,source,cnp_number_outliers)
  SALT33.mac_srcfrequency_outliers(h,prim_range,source,prim_range_outliers)
  SALT33.mac_srcfrequency_outliers(h,prim_name,source,prim_name_outliers)
  SALT33.mac_srcfrequency_outliers(h,zip,source,zip_outliers)
...
EXPORT ClusterCounts := SALT33.MOD_ClusterStats.Counts(h,POWID);
EXPORT ClusterSrc := SALT33.MOD_ClusterStats.Sources(h,POWID,source);
END;
