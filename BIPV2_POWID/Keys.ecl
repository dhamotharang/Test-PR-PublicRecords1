...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_POWID::POWID::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_POWID::POWID::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_POWID::POWID::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_POWID::POWID::Debug::match_candidates_debug';
...
EXPORT AttributeMatchesKeyName := '~'+'key::BIPV2_POWID::POWID::Datafile::attribute_matches';
...
EXPORT MatchHistoryName := '~keep::BIPV2_POWID::POWID::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_POWID::POWID::History::Match';
  MH := MatchHistoryFile;
