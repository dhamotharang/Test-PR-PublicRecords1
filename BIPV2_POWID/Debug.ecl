...
EXPORT layout_sample_matches sample_match_join(match_candidates(ih).layout_candidates le,match_candidates(ih).layout_candidates ri,UNSIGNED c=0,UNSIGNED outside=0) := TRANSFORM
  ...
  SELF.RID_If_Big_Biz_match_code := MAP(
		le.RID_If_Big_Biz_isnull OR ri.RID_If_Big_Biz_isnull => SALT33.MatchCode.OneSideNull,
  ...
  INTEGER2 RID_If_Big_Biz_score_temp := MAP(
                        ...
                        SALT33.Fn_Fail_Scale(le.RID_If_Big_Biz_weight100,s.RID_If_Big_Biz_switch));
  ...
  INTEGER2 cnp_name_score_temp := MAP(
                        ...
                        SALT33.MatchBagOfWords(le.cnp_name,ri.cnp_name,31744,0));
  ...
  INTEGER2 company_name_score_temp := MAP(
                        ...
                        SALT33.MatchBagOfWords(le.company_name,ri.company_name,2128912,1));
...
EXPORT Layout_RolledEntity := RECORD,MAXLENGTH(63000)
  ...
  DATASET(SALT33.Layout_FieldValueList) RID_If_Big_Biz_Values := DATASET([],SALT33.Layout_FieldValueList);
  ...
  DATASET(SALT33.Layout_FieldValueList) num_legal_names_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) num_incs_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) nodes_total_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) zip4_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) sec_range_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) v_city_name_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) st_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) company_inc_state_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) company_charter_number_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) active_duns_number_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) hist_duns_number_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) active_domestic_corp_key_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) hist_domestic_corp_key_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) foreign_corp_key_Values := DATASET([],SALT33.Layout_FieldValueList);
  DATASET(SALT33.Layout_FieldValueList) unk_corp_key_Values := DATASET([],SALT33.Layout_FieldValueList);
  ...
  DATASET(SALT33.Layout_FieldValueList) company_name_type_derived_Values := DATASET([],SALT33.Layout_FieldValueList);
...
SHARED RollEntities(dataset(Layout_RolledEntity) infile) := FUNCTION
  ...
  SELF.POWID := le.POWID;
    ...
    SELF.RID_If_Big_Biz_values := SALT33.fn_combine_fieldvaluelist(le.RID_If_Big_Biz_values,ri.RID_If_Big_Biz_values);
    ...
    SELF.num_legal_names_values := SALT33.fn_combine_fieldvaluelist(le.num_legal_names_values,ri.num_legal_names_values);
    SELF.num_incs_values := SALT33.fn_combine_fieldvaluelist(le.num_incs_values,ri.num_incs_values);
    SELF.nodes_total_values := SALT33.fn_combine_fieldvaluelist(le.nodes_total_values,ri.nodes_total_values);
    SELF.zip4_values := SALT33.fn_combine_fieldvaluelist(le.zip4_values,ri.zip4_values);
    SELF.sec_range_values := SALT33.fn_combine_fieldvaluelist(le.sec_range_values,ri.sec_range_values);
    SELF.v_city_name_values := SALT33.fn_combine_fieldvaluelist(le.v_city_name_values,ri.v_city_name_values);
    SELF.st_values := SALT33.fn_combine_fieldvaluelist(le.st_values,ri.st_values);
    SELF.company_inc_state_values := SALT33.fn_combine_fieldvaluelist(le.company_inc_state_values,ri.company_inc_state_values);
    SELF.company_charter_number_values := SALT33.fn_combine_fieldvaluelist(le.company_charter_number_values,ri.company_charter_number_values);
    ...
    SELF.hist_duns_number_values := SALT33.fn_combine_fieldvaluelist(le.hist_duns_number_values,ri.hist_duns_number_values);
    ...
    SELF.hist_domestic_corp_key_values := SALT33.fn_combine_fieldvaluelist(le.hist_domestic_corp_key_values,ri.hist_domestic_corp_key_values);
    SELF.foreign_corp_key_values := SALT33.fn_combine_fieldvaluelist(le.foreign_corp_key_values,ri.foreign_corp_key_values);
    SELF.unk_corp_key_values := SALT33.fn_combine_fieldvaluelist(le.unk_corp_key_values,ri.unk_corp_key_values);
    ...
    SELF.company_name_type_derived_values := SALT33.fn_combine_fieldvaluelist(le.company_name_type_derived_values,ri.company_name_type_derived_values);
...
Layout_RolledEntity into(in_data le) := TRANSFORM
  SELF.POWID := le.POWID;
  SELF.prim_range_Values := IF ( (le.prim_range  IN SET(s.nulls_prim_range,prim_range) OR le.prim_range = (TYPEOF(le.prim_range))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.prim_range)}],SALT33.Layout_FieldValueList));
  SELF.prim_name_Values := IF ( (le.prim_name  IN SET(s.nulls_prim_name,prim_name) OR le.prim_name = (TYPEOF(le.prim_name))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.prim_name)}],SALT33.Layout_FieldValueList));
  SELF.RID_If_Big_Biz_Values := IF ( (le.RID_If_Big_Biz  IN SET(s.nulls_RID_If_Big_Biz,RID_If_Big_Biz) OR le.RID_If_Big_Biz = (TYPEOF(le.RID_If_Big_Biz))''),DATASET([],SALT33.Layout_FieldValueList),DATASET([{TRIM((SALT33.StrType)le.RID_If_Big_Biz)}],SALT33.Layout_FieldValueList));
  ...
  SELF.num_legal_names_Values := DATASET([{TRIM((SALT33.StrType)le.num_legal_names)}],SALT33.Layout_FieldValueList);
  SELF.num_incs_Values := DATASET([{TRIM((SALT33.StrType)le.num_incs)}],SALT33.Layout_FieldValueList);
  SELF.nodes_total_Values := DATASET([{TRIM((SALT33.StrType)le.nodes_total)}],SALT33.Layout_FieldValueList);
  SELF.zip4_Values := DATASET([{TRIM((SALT33.StrType)le.zip4)}],SALT33.Layout_FieldValueList);
  SELF.sec_range_Values := DATASET([{TRIM((SALT33.StrType)le.sec_range)}],SALT33.Layout_FieldValueList);
  SELF.v_city_name_Values := DATASET([{TRIM((SALT33.StrType)le.v_city_name)}],SALT33.Layout_FieldValueList);
  SELF.st_Values := DATASET([{TRIM((SALT33.StrType)le.st)}],SALT33.Layout_FieldValueList);
  SELF.company_inc_state_Values := DATASET([{TRIM((SALT33.StrType)le.company_inc_state)}],SALT33.Layout_FieldValueList);
  SELF.company_charter_number_Values := DATASET([{TRIM((SALT33.StrType)le.company_charter_number)}],SALT33.Layout_FieldValueList);
  SELF.active_duns_number_Values := DATASET([{TRIM((SALT33.StrType)le.active_duns_number)}],SALT33.Layout_FieldValueList);
  SELF.hist_duns_number_Values := DATASET([{TRIM((SALT33.StrType)le.hist_duns_number)}],SALT33.Layout_FieldValueList);
  SELF.active_domestic_corp_key_Values := DATASET([{TRIM((SALT33.StrType)le.active_domestic_corp_key)}],SALT33.Layout_FieldValueList);
  SELF.hist_domestic_corp_key_Values := DATASET([{TRIM((SALT33.StrType)le.hist_domestic_corp_key)}],SALT33.Layout_FieldValueList);
  SELF.foreign_corp_key_Values := DATASET([{TRIM((SALT33.StrType)le.foreign_corp_key)}],SALT33.Layout_FieldValueList);
  SELF.unk_corp_key_Values := DATASET([{TRIM((SALT33.StrType)le.unk_corp_key)}],SALT33.Layout_FieldValueList);
  SELF.company_fein_Values := DATASET([{TRIM((SALT33.StrType)le.company_fein)}],SALT33.Layout_FieldValueList);
  SELF.cnp_btype_Values := DATASET([{TRIM((SALT33.StrType)le.cnp_btype)}],SALT33.Layout_FieldValueList);
  SELF.company_name_type_derived_Values := DATASET([{TRIM((SALT33.StrType)le.company_name_type_derived)}],SALT33.Layout_FieldValueList);
...
Layout_Chubbies0 NoteSize(Layout_Chubbies0 le) := TRANSFORM
  SELF.prim_range_size := SALT33.Fn_SwitchSpec(s.prim_range_switch,count(le.prim_range_values));
  SELF.prim_name_size := SALT33.Fn_SwitchSpec(s.prim_name_switch,count(le.prim_name_values));
  SELF.RID_If_Big_Biz_size := SALT33.Fn_SwitchSpec(s.RID_If_Big_Biz_switch,count(le.RID_If_Big_Biz_values));
