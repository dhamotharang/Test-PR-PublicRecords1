...
#workunit('name','BIPV2_POWID.BWR_Iterate - Internal Linking - SALT V3.3.0');
IMPORT BIPV2_POWID,SALT33;
IMPORT SALTTOOLS30;
//BIPV2_POWID.Specificities(BIPV2_POWID.In_POWID).Build; // Used to create calibration keys
...
P := BIPV2_POWID.Proc_Iterate('1'); // Change '1' for later iterations
...
// SALT33.MAC_MatchSamplePatterns(BIPV2_POWID.Keys(BIPV2_POWID.In_POWID).MatchSample,MatchPatterns,POWID1,POWID2,8,35-41);
...
// ConfThreshold:=38;
// ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_POWID.Keys(BIPV2_POWID.In_POWID).MatchSample,BIPV2_POWID.Keys(BIPV2_POWID.In_POWID).Candidates,BIPV2_POWID.In_POWID,POWID,ConfThreshold,NumSamplesPerReviewer,Reviewers);
// ReviewSamples;
