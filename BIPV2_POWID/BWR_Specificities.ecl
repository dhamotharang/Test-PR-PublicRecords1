...
#workunit('name','BIPV2_POWID.BWR_Specificities - Specificities - SALT V3.3.0');
IMPORT BIPV2_POWID,SALT33;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_POWID.specificities(BIPV2_POWID.In_POWID);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_POWID.<your_spc_attribute>',BIPV2_POWID.In_POWID);
