...
iter := '25';
#workunit('name','BIPV2_powid Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_powid.Keys(BIPV2_powid.In_powid).MatchSample ,BIPV2_powid.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_powid.In_powid)
