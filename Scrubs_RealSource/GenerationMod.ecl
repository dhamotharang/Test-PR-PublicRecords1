...
EXPORT GenerationMod := MODULE(SALT38.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_name:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ\'):SPACES( -.()\'&_`/):LENGTHS(0..)\n'
    + 'FIELDTYPE:invalid_suffix:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\'):SPACES( -.()\'&_`/):LENGTHS(0..)\n'
    + 'FIELDTYPE:invalid_zip:ALLOW(0123456789):LENGTHS(0..5)\n'
    ...
    + 'FIELD:zipplus4:LIKE(invalid_zip):TYPE(STRING4):0,0\n'
