...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_name','invalid_name','invalid_name','invalid_name','invalid_alnum','invalid_alpha','invalid_state','invalid_zip','invalid_zip','invalid_phone','invalid_date','Unknown','Unknown','invalid_date','Unknown');
