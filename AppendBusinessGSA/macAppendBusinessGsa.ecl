EXPORT macAppendBusinessGsa(dIn, InUltID, InOrgId, InSeleId, InProxId,
  ...
  IMPORT AppendBusinessGSA, hipie_ecl, GSA;
  ...
  LOCAL dBipGsaProx := hipie_ecl.macJoinKey(dDeduped, GSA.Key_GSA_LinkIDs.Key,
  ...
  LOCAL dBipGsaSele := hipie_ecl.macJoinKey(dSeleDeduped, GSA.Key_GSA_LinkIDs.Key, 
