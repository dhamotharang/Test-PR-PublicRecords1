...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE27207 := __ENH_Criminal_Offense_3;
  EXPORT __ST19641_Layout := RECORD
  ...
  END;
  EXPORT __ST19594_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST19641_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST19594_Layout __ND27971__Project(B_Criminal_Offense_3(__in,__cfg).__ST20501_Layout __PP26743) := TRANSFORM
    __EE26978 := __PP26743.Offense_Charges_;
    __ST19641_Layout __ND27950__Project(B_Criminal_Offense_3(__in,__cfg).__ST20548_Layout __PP27426) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP27426.Data_Type_,=,__CN(5));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP27426.Dismissed_Charges_),__NOT(__OP2(__PP27426.Offense_Score_,=,__CN('F'))));
      SELF := __PP27426;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE26978,__ND27950__Project(LEFT));
    SELF := __PP26743;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE27207,__ND27971__Project(LEFT));
END;
