...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7342222 := __ENH_Criminal_Offense_3;
  ...
  EXPORT __ST223127_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST223174_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223127_Layout __ND7342642__Project(B_Criminal_Offense_3(__in,__cfg).__ST240199_Layout __PP7342223) := TRANSFORM
    __EE7342383 := __PP7342223.Offense_Charges_;
    __ST223174_Layout __ND7342621__Project(B_Criminal_Offense_3(__in,__cfg).__ST240246_Layout __PP7342384) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP7342384.Data_Type_,=,__CN('5'));
      SELF := __PP7342384;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE7342383,__ND7342621__Project(LEFT));
    SELF := __PP7342223;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE7342222,__ND7342642__Project(LEFT));
END;
