...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE679621 := __ENH_Criminal_Offense_3;
  EXPORT __ST93165_Layout := RECORD
  ...
  END;
  EXPORT __ST93118_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST93165_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST93118_Layout __ND680269__Project(B_Criminal_Offense_3(__in,__cfg).__ST99989_Layout __PP679175) := TRANSFORM
    __EE679402 := __PP679175.Offense_Charges_;
    __ST93165_Layout __ND680247__Project(B_Criminal_Offense_3(__in,__cfg).__ST100036_Layout __PP679625) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP679625.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP679625.Dismissed_Charges_),__NOT(__OP2(__PP679625.Offense_Score_,=,__CN('F'))));
      SELF := __PP679625;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE679402,__ND680247__Project(LEFT));
    SELF := __PP679175;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE679621,__ND680269__Project(LEFT));
END;
