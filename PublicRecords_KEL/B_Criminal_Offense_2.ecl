...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE24208 := __ENH_Criminal_Offense_3;
  EXPORT __ST18201_Layout := RECORD
  ...
  END;
  EXPORT __ST18154_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST18201_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST18154_Layout __ND24972__Project(B_Criminal_Offense_3(__in,__cfg).__ST18926_Layout __PP23744) := TRANSFORM
    __EE23979 := __PP23744.Offense_Charges_;
    __ST18201_Layout __ND24951__Project(B_Criminal_Offense_3(__in,__cfg).__ST18973_Layout __PP24427) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP24427.Data_Type_,=,__CN(5));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP24427.Dismissed_Charges_),__NOT(__OP2(__PP24427.Offense_Score_,=,__CN('F'))));
      SELF := __PP24427;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE23979,__ND24951__Project(LEFT));
    SELF := __PP23744;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE24208,__ND24972__Project(LEFT));
END;
