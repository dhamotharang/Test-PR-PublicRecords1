...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE30824 := __ENH_Criminal_Offense_3;
  EXPORT __ST21194_Layout := RECORD
  ...
  END;
  EXPORT __ST21147_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST21194_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21147_Layout __ND31588__Project(B_Criminal_Offense_3(__in,__cfg).__ST22333_Layout __PP30360) := TRANSFORM
    __EE30595 := __PP30360.Offense_Charges_;
    __ST21194_Layout __ND31567__Project(B_Criminal_Offense_3(__in,__cfg).__ST22380_Layout __PP31043) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP31043.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP31043.Dismissed_Charges_),__NOT(__OP2(__PP31043.Offense_Score_,=,__CN('F'))));
      SELF := __PP31043;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE30595,__ND31567__Project(LEFT));
    SELF := __PP30360;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE30824,__ND31588__Project(LEFT));
END;
