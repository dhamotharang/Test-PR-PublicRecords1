...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE30684 := __ENH_Criminal_Offense_3;
  EXPORT __ST21054_Layout := RECORD
  ...
  END;
  EXPORT __ST21007_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST21054_Layout) Offense_Charges_;
  ...
  SHARED __ST21007_Layout __ND31448__Project(B_Criminal_Offense_3(__in,__cfg).__ST22193_Layout __PP30220) := TRANSFORM
    ...
    __ST21054_Layout __ND31427__Project(B_Criminal_Offense_3(__in,__cfg).__ST22240_Layout __PP30903) := TRANSFORM
      ...
      SELF := __PP30903;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE30455,__ND31427__Project(LEFT));
    SELF := __PP30220;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE30684,__ND31448__Project(LEFT));
END;
