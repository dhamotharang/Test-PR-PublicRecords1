...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE25841 := __ENH_Criminal_Offense_3;
  EXPORT __ST19225_Layout := RECORD
  ...
  END;
  EXPORT __ST19178_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST19225_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST19178_Layout __ND26605__Project(B_Criminal_Offense_3(__in,__cfg).__ST20009_Layout __PP25377) := TRANSFORM
    __EE25612 := __PP25377.Offense_Charges_;
    __ST19225_Layout __ND26584__Project(B_Criminal_Offense_3(__in,__cfg).__ST20056_Layout __PP26060) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP26060.Data_Type_,=,__CN(5));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP26060.Dismissed_Charges_),__NOT(__OP2(__PP26060.Offense_Score_,=,__CN('F'))));
      SELF := __PP26060;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE25612,__ND26584__Project(LEFT));
    SELF := __PP25377;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE25841,__ND26605__Project(LEFT));
END;
