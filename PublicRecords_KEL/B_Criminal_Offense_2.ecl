...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4526295 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST157384_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST157431_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157384_Layout __ND4526623__Project(B_Criminal_Offense_3(__in,__cfg).__ST169991_Layout __PP4526296) := TRANSFORM
    __EE4526456 := __PP4526296.Offense_Charges_;
    __ST157431_Layout __ND4526605__Project(B_Criminal_Offense_3(__in,__cfg).__ST170038_Layout __PP4526457) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP4526457.Data_Type_,=,__CN('5'));
      SELF := __PP4526457;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE4526456,__ND4526605__Project(LEFT));
    SELF := __PP4526296;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE4526295,__ND4526623__Project(LEFT));
END;
