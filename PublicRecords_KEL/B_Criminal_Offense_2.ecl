...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6146724 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST207164_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST207211_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207164_Layout __ND6147132__Project(B_Criminal_Offense_3(__in,__cfg).__ST223304_Layout __PP6146725) := TRANSFORM
    __EE6146885 := __PP6146725.Offense_Charges_;
    __ST207211_Layout __ND6147113__Project(B_Criminal_Offense_3(__in,__cfg).__ST223351_Layout __PP6146886) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP6146886.Data_Type_,=,__CN('5'));
      SELF := __PP6146886;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE6146885,__ND6147113__Project(LEFT));
    SELF := __PP6146725;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE6146724,__ND6147132__Project(LEFT));
END;
