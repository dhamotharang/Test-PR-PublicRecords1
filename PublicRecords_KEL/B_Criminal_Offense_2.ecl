...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE34899 := __ENH_Criminal_Offense_3;
  EXPORT __ST23846_Layout := RECORD
  ...
  END;
  EXPORT __ST23799_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST23846_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST23799_Layout __ND35664__Project(B_Criminal_Offense_3(__in,__cfg).__ST25056_Layout __PP34434) := TRANSFORM
    __EE34669 := __PP34434.Offense_Charges_;
    __ST23846_Layout __ND35643__Project(B_Criminal_Offense_3(__in,__cfg).__ST25103_Layout __PP35119) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP35119.Data_Type_,=,__CN('5'));
      SELF.Is_Criminal_Count_ := __NOT(__PP35119.Dismissed_Charges_);
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP35119.Dismissed_Charges_),__NOT(__OP2(__PP35119.Offense_Score_,=,__CN('F'))));
      SELF := __PP35119;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE34669,__ND35643__Project(LEFT));
    SELF := __PP34434;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE34899,__ND35664__Project(LEFT));
END;
