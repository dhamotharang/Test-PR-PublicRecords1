...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6794632 := __ENH_Criminal_Offense_3;
  EXPORT __ST210760_Layout := RECORD
  ...
  END;
  EXPORT __ST210713_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210760_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210713_Layout __ND6795040__Project(B_Criminal_Offense_3(__in,__cfg).__ST227353_Layout __PP6794633) := TRANSFORM
    __EE6794793 := __PP6794633.Offense_Charges_;
    __ST210760_Layout __ND6795021__Project(B_Criminal_Offense_3(__in,__cfg).__ST227400_Layout __PP6794794) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP6794794.Data_Type_,=,__CN('5'));
      SELF := __PP6794794;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE6794793,__ND6795021__Project(LEFT));
    SELF := __PP6794633;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE6794632,__ND6795040__Project(LEFT));
END;
