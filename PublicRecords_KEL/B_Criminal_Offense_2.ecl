...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE525980 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST81208_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST81255_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST81208_Layout __ND526727__Project(B_Criminal_Offense_3(__in,__cfg).__ST87538_Layout __PP525516) := TRANSFORM
    __EE525751 := __PP525516.Offense_Charges_;
    __ST81255_Layout __ND526706__Project(B_Criminal_Offense_3(__in,__cfg).__ST87585_Layout __PP525984) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP525984.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP525984.Dismissed_Charges_),__NOT(__OP2(__PP525984.Offense_Score_,=,__CN('F'))));
      SELF := __PP525984;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE525751,__ND526706__Project(LEFT));
    SELF := __PP525516;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE525980,__ND526727__Project(LEFT));
END;
