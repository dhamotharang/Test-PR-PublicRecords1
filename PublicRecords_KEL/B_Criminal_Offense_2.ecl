...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7337933 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST223055_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST223102_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223055_Layout __ND7338341__Project(B_Criminal_Offense_3(__in,__cfg).__ST240114_Layout __PP7337934) := TRANSFORM
    __EE7338094 := __PP7337934.Offense_Charges_;
    __ST223102_Layout __ND7338322__Project(B_Criminal_Offense_3(__in,__cfg).__ST240161_Layout __PP7338095) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP7338095.Data_Type_,=,__CN('5'));
      SELF := __PP7338095;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE7338094,__ND7338322__Project(LEFT));
    SELF := __PP7337934;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE7337933,__ND7338341__Project(LEFT));
END;
