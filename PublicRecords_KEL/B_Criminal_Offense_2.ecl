...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE24317 := __ENH_Criminal_Offense_3;
  EXPORT __ST18300_Layout := RECORD
  ...
  END;
  EXPORT __ST18253_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST18300_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST18253_Layout __ND25081__Project(B_Criminal_Offense_3(__in,__cfg).__ST19035_Layout __PP23853) := TRANSFORM
    __EE24088 := __PP23853.Offense_Charges_;
    __ST18300_Layout __ND25060__Project(B_Criminal_Offense_3(__in,__cfg).__ST19082_Layout __PP24536) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP24536.Data_Type_,=,__CN(5));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP24536.Dismissed_Charges_),__NOT(__OP2(__PP24536.Offense_Score_,=,__CN('F'))));
      SELF := __PP24536;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE24088,__ND25060__Project(LEFT));
    SELF := __PP23853;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE24317,__ND25081__Project(LEFT));
END;
