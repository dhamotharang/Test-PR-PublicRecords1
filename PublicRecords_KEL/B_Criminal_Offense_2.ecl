...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE66235 := __ENH_Criminal_Offense_3;
  EXPORT __ST30714_Layout := RECORD
  ...
  END;
  EXPORT __ST30667_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST30714_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST30667_Layout __ND66999__Project(B_Criminal_Offense_3(__in,__cfg).__ST32618_Layout __PP65771) := TRANSFORM
    __EE66006 := __PP65771.Offense_Charges_;
    __ST30714_Layout __ND66978__Project(B_Criminal_Offense_3(__in,__cfg).__ST32665_Layout __PP66454) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP66454.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP66454.Dismissed_Charges_),__NOT(__OP2(__PP66454.Offense_Score_,=,__CN('F'))));
      SELF := __PP66454;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE66006,__ND66978__Project(LEFT));
    SELF := __PP65771;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE66235,__ND66999__Project(LEFT));
END;
