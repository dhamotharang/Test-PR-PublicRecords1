...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE24218 := __ENH_Criminal_Offense_3;
  EXPORT __ST18210_Layout := RECORD
  ...
  END;
  EXPORT __ST18163_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST18210_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST18163_Layout __ND24982__Project(B_Criminal_Offense_3(__in,__cfg).__ST18931_Layout __PP23754) := TRANSFORM
    __EE23989 := __PP23754.Offense_Charges_;
    __ST18210_Layout __ND24961__Project(B_Criminal_Offense_3(__in,__cfg).__ST18978_Layout __PP24437) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP24437.Data_Type_,=,__CN(5));
      SELF.Is_Non_Felony_Records_ := __AND(__NOT(__PP24437.Dismissed_Charges_),__NOT(__OP2(__PP24437.Offense_Score_,=,__CN('F'))));
      SELF := __PP24437;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE23989,__ND24961__Project(LEFT));
    SELF := __PP23754;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE24218,__ND24982__Project(LEFT));
END;
