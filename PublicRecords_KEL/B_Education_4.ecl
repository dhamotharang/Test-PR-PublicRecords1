...
IMPORT KEL15 AS KEL;
IMPORT B_Education_5,B_Education_8,CFG_Compile,E_Education FROM PublicRecords_KEL;
...
EXPORT B_Education_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6829809 := __ENH_Education_5;
  EXPORT __ENH_Education_4 := __EE6829809;
END;
