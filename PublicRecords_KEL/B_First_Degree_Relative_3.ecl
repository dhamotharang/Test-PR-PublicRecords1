...
EXPORT B_First_Degree_Relative_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5511017 := __ENH_First_Degree_Relative_4;
  EXPORT __ST928255_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_3 := PROJECT(__EE5511017,__ST928255_Layout);
END;
