...
EXPORT B_First_Degree_Relative_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5508046 := __ENH_First_Degree_Relative_4;
  EXPORT __ST927854_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_3 := PROJECT(__EE5508046,__ST927854_Layout);
END;
