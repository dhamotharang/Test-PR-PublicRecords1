...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Thor(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE6237560 := __ENH_Person;
  SHARED __EE6237649 := __EE6237560(__T(__OP2(__EE6237560.UID,=,__CN(__PLexID_in))));
  SHARED __ST97039_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE6237649,TRANSFORM(__ST97039_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
