...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE309174 := __E_Input_B_I_I;
  EXPORT __ST254665_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST254665_Layout __ND4779152__Project(E_Input_B_I_I(__in,__cfg).Layout __PP308833) := TRANSFORM
    __CC13313 := '-99999';
    __CC13318 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP308833.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13313)),__ECAST(KEL.typ.nstr,__PP308833.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13318)));
    SELF := __PP308833;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE309174,__ND4779152__Project(LEFT));
END;
