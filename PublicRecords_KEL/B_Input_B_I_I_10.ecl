...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE309649 := __E_Input_B_I_I;
  EXPORT __ST255187_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST255187_Layout __ND4787400__Project(E_Input_B_I_I(__in,__cfg).Layout __PP309308) := TRANSFORM
    __CC13338 := '-99999';
    __CC13343 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP309308.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13338)),__ECAST(KEL.typ.nstr,__PP309308.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13343)));
    SELF := __PP309308;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE309649,__ND4787400__Project(LEFT));
END;
