...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE318065 := __E_Input_B_I_I;
  ...
  END;
  SHARED __ST262993_Layout __ND5021146__Project(E_Input_B_I_I(__in,__cfg).Layout __PP317724) := TRANSFORM
    __CC13364 := '-99999';
    __CC13369 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP317724.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13364)),__ECAST(KEL.typ.nstr,__PP317724.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13369)));
    SELF := __PP317724;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE318065,__ND5021146__Project(LEFT));
END;
