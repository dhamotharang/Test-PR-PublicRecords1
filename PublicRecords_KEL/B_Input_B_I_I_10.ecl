...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE373119 := __E_Input_B_I_I;
  EXPORT __ST278589_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST278589_Layout __ND5556396__Project(E_Input_B_I_I(__in,__cfg).Layout __PP372778) := TRANSFORM
    __CC13600 := '-99999';
    __CC13605 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP372778.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13600)),__ECAST(KEL.typ.nstr,__PP372778.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13605)));
    SELF := __PP372778;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE373119,__ND5556396__Project(LEFT));
END;
