...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE324464 := __E_Input_B_I_I;
  EXPORT __ST265097_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST265097_Layout __ND5052865__Project(E_Input_B_I_I(__in,__cfg).Layout __PP324123) := TRANSFORM
    __CC13477 := '-99999';
    __CC13482 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP324123.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13477)),__ECAST(KEL.typ.nstr,__PP324123.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13482)));
    SELF := __PP324123;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE324464,__ND5052865__Project(LEFT));
END;
