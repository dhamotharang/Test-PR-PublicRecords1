...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE317106 := __E_Input_B_I_I;
  EXPORT __ST259090_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST259090_Layout __ND4628000__Project(E_Input_B_I_I(__in,__cfg).Layout __PP316765) := TRANSFORM
    __CC13594 := '-99999';
    __CC13599 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP316765.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13594)),__ECAST(KEL.typ.nstr,__PP316765.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13599)));
    SELF := __PP316765;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE317106,__ND4628000__Project(LEFT));
END;
