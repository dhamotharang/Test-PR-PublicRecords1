...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE373098 := __E_Input_B_I_I;
  EXPORT __ST278568_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST278568_Layout __ND5524589__Project(E_Input_B_I_I(__in,__cfg).Layout __PP372757) := TRANSFORM
    __CC13579 := '-99999';
    __CC13584 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP372757.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13579)),__ECAST(KEL.typ.nstr,__PP372757.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13584)));
    SELF := __PP372757;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE373098,__ND5524589__Project(LEFT));
END;
