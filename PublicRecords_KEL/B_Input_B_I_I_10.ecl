...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE319755 := __E_Input_B_I_I;
  EXPORT __ST264679_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST264679_Layout __ND5045508__Project(E_Input_B_I_I(__in,__cfg).Layout __PP319414) := TRANSFORM
    __CC13407 := '-99999';
    __CC13412 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP319414.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13407)),__ECAST(KEL.typ.nstr,__PP319414.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13412)));
    SELF := __PP319414;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE319755,__ND5045508__Project(LEFT));
END;
