...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11781463 := __ENH_Tradeline_1;
  EXPORT __ST179018_Layout := RECORD
  ...
  END;
  EXPORT __ST179011_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST179018_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179011_Layout __ND11781806__Project(B_Tradeline_1(__in,__cfg).__ST206857_Layout __PP11781464) := TRANSFORM
    __EE11781510 := __PP11781464.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11781510),__ST179018_Layout),__NL(__EE11781510));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11781464.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13315));
    __CC44053 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11781464.Newest_Record_Age_In_Days_,<=,__CN(__CC44053));
    SELF := __PP11781464;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11781463,__ND11781806__Project(LEFT));
END;
