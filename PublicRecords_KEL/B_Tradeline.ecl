...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11311530 := __ENH_Tradeline_1;
  EXPORT __ST173353_Layout := RECORD
  ...
  EXPORT __ST173346_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST173353_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173346_Layout __ND11311873__Project(B_Tradeline_1(__in,__cfg).__ST199894_Layout __PP11311531) := TRANSFORM
    __EE11311577 := __PP11311531.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11311577),__ST173353_Layout),__NL(__EE11311577));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11311531.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13108));
    __CC41922 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11311531.Newest_Record_Age_In_Days_,<=,__CN(__CC41922));
    SELF := __PP11311531;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11311530,__ND11311873__Project(LEFT));
END;
