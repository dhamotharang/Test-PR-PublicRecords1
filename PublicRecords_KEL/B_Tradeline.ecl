...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6438703 := __ENH_Tradeline_1;
  EXPORT __ST127768_Layout := RECORD
  ...
  END;
  EXPORT __ST127761_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST127768_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST127761_Layout __ND6438982__Project(B_Tradeline_1(__in,__cfg).__ST148267_Layout __PP6438704) := TRANSFORM
    __EE6438750 := __PP6438704.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE6438750),__ST127768_Layout),__NL(__EE6438750));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP6438704.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC10898));
    __CC28319 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP6438704.Newest_Record_Age_In_Days_,<=,__CN(__CC28319));
    SELF := __PP6438704;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE6438703,__ND6438982__Project(LEFT));
END;
