...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12049349 := __ENH_Tradeline_1;
  EXPORT __ST168359_Layout := RECORD
  ...
  END;
  EXPORT __ST168352_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST168359_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168352_Layout __ND12049692__Project(B_Tradeline_1(__in,__cfg).__ST194307_Layout __PP12049350) := TRANSFORM
    __EE12049396 := __PP12049350.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE12049396),__ST168359_Layout),__NL(__EE12049396));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP12049350.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13078));
    __CC40124 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP12049350.Newest_Record_Age_In_Days_,<=,__CN(__CC40124));
    SELF := __PP12049350;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE12049349,__ND12049692__Project(LEFT));
END;
