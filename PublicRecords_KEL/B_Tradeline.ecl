...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12129432 := __ENH_Tradeline_1;
  EXPORT __ST185780_Layout := RECORD
  ...
  END;
  EXPORT __ST185773_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST185780_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185773_Layout __ND12129775__Project(B_Tradeline_1(__in,__cfg).__ST213575_Layout __PP12129433) := TRANSFORM
    __EE12129479 := __PP12129433.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE12129479),__ST185780_Layout),__NL(__EE12129479));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP12129433.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13315));
    __CC43086 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP12129433.Newest_Record_Age_In_Days_,<=,__CN(__CC43086));
    SELF := __PP12129433;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE12129432,__ND12129775__Project(LEFT));
END;
