...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE15034950 := __ENH_Tradeline_1;
  EXPORT __ST185801_Layout := RECORD
  ...
  END;
  EXPORT __ST185794_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST185801_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185794_Layout __ND15035293__Project(B_Tradeline_1(__in,__cfg).__ST213596_Layout __PP15034951) := TRANSFORM
    __EE15034997 := __PP15034951.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE15034997),__ST185801_Layout),__NL(__EE15034997));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP15034951.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13336));
    __CC43107 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP15034951.Newest_Record_Age_In_Days_,<=,__CN(__CC43107));
    SELF := __PP15034951;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE15034950,__ND15035293__Project(LEFT));
END;
