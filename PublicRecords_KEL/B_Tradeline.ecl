...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11753165 := __ENH_Tradeline_1;
  EXPORT __ST178745_Layout := RECORD
  ...
  END;
  EXPORT __ST178738_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST178745_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST178738_Layout __ND11753508__Project(B_Tradeline_1(__in,__cfg).__ST206563_Layout __PP11753166) := TRANSFORM
    __EE11753212 := __PP11753166.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11753212),__ST178745_Layout),__NL(__EE11753212));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11753166.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13315));
    __CC43953 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11753166.Newest_Record_Age_In_Days_,<=,__CN(__CC43953));
    SELF := __PP11753166;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11753165,__ND11753508__Project(LEFT));
END;
