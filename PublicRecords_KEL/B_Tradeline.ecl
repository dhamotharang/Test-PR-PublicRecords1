...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6199541 := __ENH_Tradeline_1;
  EXPORT __ST134124_Layout := RECORD
  ...
  END;
  EXPORT __ST134117_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST134124_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST134117_Layout __ND6199820__Project(B_Tradeline_1(__in,__cfg).__ST155813_Layout __PP6199542) := TRANSFORM
    __EE6199588 := __PP6199542.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE6199588),__ST134124_Layout),__NL(__EE6199588));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP6199542.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC10318));
    __CC30088 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP6199542.Newest_Record_Age_In_Days_,<=,__CN(__CC30088));
    SELF := __PP6199542;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE6199541,__ND6199820__Project(LEFT));
END;
