...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11549720 := __ENH_Tradeline_1;
  ...
  EXPORT __ST167974_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST167981_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167974_Layout __ND11550063__Project(B_Tradeline_1(__in,__cfg).__ST193827_Layout __PP11549721) := TRANSFORM
    __EE11549767 := __PP11549721.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11549767),__ST167981_Layout),__NL(__EE11549767));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11549721.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13090));
    __CC40223 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11549721.Newest_Record_Age_In_Days_,<=,__CN(__CC40223));
    SELF := __PP11549721;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11549720,__ND11550063__Project(LEFT));
END;
