...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9606871 := __ENH_Tradeline_1;
  EXPORT __ST171595_Layout := RECORD
  ...
  EXPORT __ST171588_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST171595_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171588_Layout __ND9607214__Project(B_Tradeline_1(__in,__cfg).__ST197781_Layout __PP9606872) := TRANSFORM
    __EE9606918 := __PP9606872.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9606918),__ST171595_Layout),__NL(__EE9606918));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP9606872.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13330));
    __CC41024 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP9606872.Newest_Record_Age_In_Days_,<=,__CN(__CC41024));
    SELF := __PP9606872;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE9606871,__ND9607214__Project(LEFT));
END;
