...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11953926 := __ENH_Tradeline_1;
  EXPORT __ST181546_Layout := RECORD
  ...
  END;
  EXPORT __ST181539_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST181546_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181539_Layout __ND11954269__Project(B_Tradeline_1(__in,__cfg).__ST209627_Layout __PP11953927) := TRANSFORM
    __EE11953973 := __PP11953927.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11953973),__ST181546_Layout),__NL(__EE11953973));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11953927.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13278));
    __CC44968 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11953927.Newest_Record_Age_In_Days_,<=,__CN(__CC44968));
    SELF := __PP11953927;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11953926,__ND11954269__Project(LEFT));
END;
