...
EXPORT B_Tradeline(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11547827 := __ENH_Tradeline_1;
  EXPORT __ST167985_Layout := RECORD
  ...
  END;
  EXPORT __ST167978_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST167985_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167978_Layout __ND11548170__Project(B_Tradeline_1(__in,__cfg).__ST193817_Layout __PP11547828) := TRANSFORM
    __EE11547874 := __PP11547828.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE11547874),__ST167985_Layout),__NL(__EE11547874));
    ...
    SELF.Filing_Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP11547828.Trade_Date_),__ECAST(KEL.typ.nkdate,__CC13090));
    __CC40225 := 730;
    SELF.Is_Active2_Y_ := __OP2(__PP11547828.Newest_Record_Age_In_Days_,<=,__CN(__CC40225));
    SELF := __PP11547828;
  END;
  EXPORT __ENH_Tradeline := PROJECT(__EE11547827,__ND11548170__Project(LEFT));
END;
