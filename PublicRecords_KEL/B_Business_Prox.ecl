...
EXPORT B_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9324874 := __ENH_Business_Prox_1;
  EXPORT __ST132986_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST132986_Layout __ND9325906__Project(B_Business_Prox_1(__in,__cfg).__ST178105_Layout __PP9324875) := TRANSFORM
    __CC13714 := '-99999';
    __CC13719 := '-99998';
    SELF.B_P___Best_Addr_City_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nstr,__CN(__CC13714)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Address_.Best_Vanity_City_),__OP2(__PP9324875.Only_Best_Business_Prox_Address_.Best_Vanity_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13719)),__ECAST(KEL.typ.nstr,__PP9324875.Only_Best_Business_Prox_Address_.Best_Vanity_City_));
    SELF.B_P___Best_Addr_City_Post_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nstr,__CN(__CC13714)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Address_.Best_Postal_City_),__OP2(__PP9324875.Only_Best_Business_Prox_Address_.Best_Postal_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13719)),__ECAST(KEL.typ.nstr,__PP9324875.Only_Best_Business_Prox_Address_.Best_Postal_City_));
    __CC13717 := -99999;
    __CC13722 := -99998;
    SELF.B_P___Best_Addr_Loc_I_D_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nint,__CN(__CC13717)),__T(__OP2(__PP9324875.Business_Prox_Location_I_D_,=,__CN(0)))=>__ECAST(KEL.typ.nint,__CN(__CC13722)),__ECAST(KEL.typ.nint,__PP9324875.Business_Prox_Location_I_D_));
    SELF.B_P___Best_Addr_St_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nstr,__CN(__CC13714)),__T(__OR(__NT(__PP9324875.Best_Prox_Address_),__OP2(__PP9324875.Best_Prox_Address_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13719)),__ECAST(KEL.typ.nstr,__PP9324875.Best_Prox_Address_));
    SELF.B_P___Best_Addr_State_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nstr,__CN(__CC13714)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Address_.Best_State_),__OP2(__PP9324875.Only_Best_Business_Prox_Address_.Best_State_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13719)),__ECAST(KEL.typ.nstr,__PP9324875.Only_Best_Business_Prox_Address_.Best_State_));
    SELF.B_P___Best_Addr_Zip_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13714))))=>__ECAST(KEL.typ.nstr,__CN(__CC13714)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Address_.Best_Zip5_),__OP2(__CAST(KEL.typ.str,__PP9324875.Only_Best_Business_Prox_Address_.Best_Zip5_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13719)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP9324875.Only_Best_Business_Prox_Address_.Best_Zip5_,__CN(5),__CN(1))));
    __CC13710 := '-99999';
    __CC13712 := '-99998';
    SELF.B_P___Best_Name_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13710))))=>__ECAST(KEL.typ.nstr,__CN(__CC13710)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Name_.Best_Company_Name_),__OP2(__PP9324875.Only_Best_Business_Prox_Name_.Best_Company_Name_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13712)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN__fn_Remove_Special_Chars(__ECAST(KEL.typ.nstr,__PP9324875.Only_Best_Business_Prox_Name_.Best_Company_Name_),__ECAST(KEL.typ.nstr,__CN('')))));
    __CC13728 := '-99999';
    __CC13730 := '-99998';
    SELF.B_P___Best_Phone_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13728))))=>__ECAST(KEL.typ.nstr,__CN(__CC13728)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Phone_.Best_Phone_),__OP2(__PP9324875.Only_Best_Business_Prox_Phone_.Best_Phone_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13730)),__ECAST(KEL.typ.nstr,__PP9324875.Only_Best_Business_Prox_Phone_.Best_Phone_));
    __CC13724 := '-99999';
    __CC13726 := '-99998';
    SELF.B_P___Best_T_I_N_ := MAP(__T(__OR(__CN(__PP9324875.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP9324875.Prox_I_D_),=,__CN(__CC13724))))=>__ECAST(KEL.typ.nstr,__CN(__CC13724)),__T(__OR(__NT(__PP9324875.Only_Best_Business_Prox_Tin_.Best_T_I_N_),__OP2(__CAST(KEL.typ.str,__PP9324875.Only_Best_Business_Prox_Tin_.Best_T_I_N_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13726)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP9324875.Only_Best_Business_Prox_Tin_.Best_T_I_N_,__CN(9),__CN(1))));
    SELF := __PP9324875;
  END;
  EXPORT __ENH_Business_Prox := PROJECT(__EE9324874,__ND9325906__Project(LEFT));
END;
