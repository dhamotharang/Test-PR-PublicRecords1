...
EXPORT B_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8069170 := __ENH_Business_Prox_1;
  EXPORT __ST127113_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST127113_Layout __ND8070202__Project(B_Business_Prox_1(__in,__cfg).__ST169698_Layout __PP8069171) := TRANSFORM
    __CC13461 := '-99999';
    __CC13466 := '-99998';
    SELF.B_P___Best_Addr_City_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nstr,__CN(__CC13461)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Address_.Best_Vanity_City_),__OP2(__PP8069171.Only_Best_Business_Prox_Address_.Best_Vanity_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13466)),__ECAST(KEL.typ.nstr,__PP8069171.Only_Best_Business_Prox_Address_.Best_Vanity_City_));
    SELF.B_P___Best_Addr_City_Post_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nstr,__CN(__CC13461)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Address_.Best_Postal_City_),__OP2(__PP8069171.Only_Best_Business_Prox_Address_.Best_Postal_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13466)),__ECAST(KEL.typ.nstr,__PP8069171.Only_Best_Business_Prox_Address_.Best_Postal_City_));
    __CC13464 := -99999;
    __CC13469 := -99998;
    SELF.B_P___Best_Addr_Loc_I_D_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nint,__CN(__CC13464)),__T(__OP2(__PP8069171.Business_Prox_Location_I_D_,=,__CN(0)))=>__ECAST(KEL.typ.nint,__CN(__CC13469)),__ECAST(KEL.typ.nint,__PP8069171.Business_Prox_Location_I_D_));
    SELF.B_P___Best_Addr_St_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nstr,__CN(__CC13461)),__T(__OR(__NT(__PP8069171.Best_Prox_Address_),__OP2(__PP8069171.Best_Prox_Address_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13466)),__ECAST(KEL.typ.nstr,__PP8069171.Best_Prox_Address_));
    SELF.B_P___Best_Addr_State_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nstr,__CN(__CC13461)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Address_.Best_State_),__OP2(__PP8069171.Only_Best_Business_Prox_Address_.Best_State_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13466)),__ECAST(KEL.typ.nstr,__PP8069171.Only_Best_Business_Prox_Address_.Best_State_));
    SELF.B_P___Best_Addr_Zip_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13461))))=>__ECAST(KEL.typ.nstr,__CN(__CC13461)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Address_.Best_Zip5_),__OP2(__CAST(KEL.typ.str,__PP8069171.Only_Best_Business_Prox_Address_.Best_Zip5_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13466)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP8069171.Only_Best_Business_Prox_Address_.Best_Zip5_,__CN(5),__CN(1))));
    __CC13457 := '-99999';
    __CC13459 := '-99998';
    SELF.B_P___Best_Name_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13457))))=>__ECAST(KEL.typ.nstr,__CN(__CC13457)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Name_.Best_Company_Name_),__OP2(__PP8069171.Only_Best_Business_Prox_Name_.Best_Company_Name_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13459)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN__fn_Remove_Special_Chars(__ECAST(KEL.typ.nstr,__PP8069171.Only_Best_Business_Prox_Name_.Best_Company_Name_),__ECAST(KEL.typ.nstr,__CN('')))));
    __CC13475 := '-99999';
    __CC13477 := '-99998';
    SELF.B_P___Best_Phone_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13475))))=>__ECAST(KEL.typ.nstr,__CN(__CC13475)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Phone_.Best_Phone_),__OP2(__PP8069171.Only_Best_Business_Prox_Phone_.Best_Phone_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13477)),__ECAST(KEL.typ.nstr,__PP8069171.Only_Best_Business_Prox_Phone_.Best_Phone_));
    __CC13471 := '-99999';
    __CC13473 := '-99998';
    SELF.B_P___Best_T_I_N_ := MAP(__T(__OR(__CN(__PP8069171.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP8069171.Prox_I_D_),=,__CN(__CC13471))))=>__ECAST(KEL.typ.nstr,__CN(__CC13471)),__T(__OR(__NT(__PP8069171.Only_Best_Business_Prox_Tin_.Best_T_I_N_),__OP2(__CAST(KEL.typ.str,__PP8069171.Only_Best_Business_Prox_Tin_.Best_T_I_N_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP8069171.Only_Best_Business_Prox_Tin_.Best_T_I_N_,__CN(9),__CN(1))));
    SELF := __PP8069171;
  END;
  EXPORT __ENH_Business_Prox := PROJECT(__EE8069170,__ND8070202__Project(LEFT));
END;
