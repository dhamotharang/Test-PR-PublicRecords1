...
EXPORT B_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7955939 := __ENH_Business_Prox_1;
  EXPORT __ST127024_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST127024_Layout __ND7956971__Project(B_Business_Prox_1(__in,__cfg).__ST169326_Layout __PP7955940) := TRANSFORM
    __CC13473 := '-99999';
    __CC13478 := '-99998';
    SELF.B_P___Best_Addr_City_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Address_.Best_Vanity_City_),__OP2(__PP7955940.Only_Best_Business_Prox_Address_.Best_Vanity_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13478)),__ECAST(KEL.typ.nstr,__PP7955940.Only_Best_Business_Prox_Address_.Best_Vanity_City_));
    SELF.B_P___Best_Addr_City_Post_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Address_.Best_Postal_City_),__OP2(__PP7955940.Only_Best_Business_Prox_Address_.Best_Postal_City_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13478)),__ECAST(KEL.typ.nstr,__PP7955940.Only_Best_Business_Prox_Address_.Best_Postal_City_));
    __CC13476 := -99999;
    __CC13481 := -99998;
    SELF.B_P___Best_Addr_Loc_I_D_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nint,__CN(__CC13476)),__T(__OP2(__PP7955940.Business_Prox_Location_I_D_,=,__CN(0)))=>__ECAST(KEL.typ.nint,__CN(__CC13481)),__ECAST(KEL.typ.nint,__PP7955940.Business_Prox_Location_I_D_));
    SELF.B_P___Best_Addr_St_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__T(__OR(__NT(__PP7955940.Best_Prox_Address_),__OP2(__PP7955940.Best_Prox_Address_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13478)),__ECAST(KEL.typ.nstr,__PP7955940.Best_Prox_Address_));
    SELF.B_P___Best_Addr_State_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Address_.Best_State_),__OP2(__PP7955940.Only_Best_Business_Prox_Address_.Best_State_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13478)),__ECAST(KEL.typ.nstr,__PP7955940.Only_Best_Business_Prox_Address_.Best_State_));
    SELF.B_P___Best_Addr_Zip_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13473))))=>__ECAST(KEL.typ.nstr,__CN(__CC13473)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Address_.Best_Zip5_),__OP2(__CAST(KEL.typ.str,__PP7955940.Only_Best_Business_Prox_Address_.Best_Zip5_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13478)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP7955940.Only_Best_Business_Prox_Address_.Best_Zip5_,__CN(5),__CN(1))));
    __CC13469 := '-99999';
    __CC13471 := '-99998';
    SELF.B_P___Best_Name_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13469))))=>__ECAST(KEL.typ.nstr,__CN(__CC13469)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Name_.Best_Company_Name_),__OP2(__PP7955940.Only_Best_Business_Prox_Name_.Best_Company_Name_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13471)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN__fn_Remove_Special_Chars(__ECAST(KEL.typ.nstr,__PP7955940.Only_Best_Business_Prox_Name_.Best_Company_Name_),__ECAST(KEL.typ.nstr,__CN('')))));
    __CC13487 := '-99999';
    __CC13489 := '-99998';
    SELF.B_P___Best_Phone_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13487))))=>__ECAST(KEL.typ.nstr,__CN(__CC13487)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Phone_.Best_Phone_),__OP2(__PP7955940.Only_Best_Business_Prox_Phone_.Best_Phone_,=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13489)),__ECAST(KEL.typ.nstr,__PP7955940.Only_Best_Business_Prox_Phone_.Best_Phone_));
    __CC13483 := '-99999';
    __CC13485 := '-99998';
    SELF.B_P___Best_T_I_N_ := MAP(__T(__OR(__CN(__PP7955940.B___Lex_I_D_Loc_Seen_Flag_ = '0'),__OP2(__CAST(KEL.typ.str,__PP7955940.Prox_I_D_),=,__CN(__CC13483))))=>__ECAST(KEL.typ.nstr,__CN(__CC13483)),__T(__OR(__NT(__PP7955940.Only_Best_Business_Prox_Tin_.Best_T_I_N_),__OP2(__CAST(KEL.typ.str,__PP7955940.Only_Best_Business_Prox_Tin_.Best_T_I_N_),=,__CN(''))))=>__ECAST(KEL.typ.nstr,__CN(__CC13485)),__ECAST(KEL.typ.nstr,__FN3(INTFORMAT,__PP7955940.Only_Best_Business_Prox_Tin_.Best_T_I_N_,__CN(9),__CN(1))));
    SELF := __PP7955940;
  END;
  EXPORT __ENH_Business_Prox := PROJECT(__EE7955939,__ND7956971__Project(LEFT));
END;
