...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE349519 := __E_Lien_Judgment;
  EXPORT __ST280460_Layout := RECORD
  ...
  END;
  EXPORT __ST280455_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST280460_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST280455_Layout __ND349828__Project(E_Lien_Judgment(__in,__cfg).Layout __PP349761) := TRANSFORM
    __EE349367 := __PP349761.Filing_;
    __ST280460_Layout __ND349764__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP349763) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP349761.T_M_S_I_D_;
      SELF := __PP349763;
    END;
    SELF.Filing_ := __PROJECT(__EE349367,__ND349764__Project(LEFT));
    SELF := __PP349761;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE349519,__ND349828__Project(LEFT));
END;
