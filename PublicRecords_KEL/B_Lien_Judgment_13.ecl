...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE328769 := __E_Lien_Judgment;
  EXPORT __ST265276_Layout := RECORD
  ...
  END;
  EXPORT __ST265271_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST265276_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265271_Layout __ND329078__Project(E_Lien_Judgment(__in,__cfg).Layout __PP329011) := TRANSFORM
    __EE328617 := __PP329011.Filing_;
    __ST265276_Layout __ND329014__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP329013) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP329011.T_M_S_I_D_;
      SELF := __PP329013;
    END;
    SELF.Filing_ := __PROJECT(__EE328617,__ND329014__Project(LEFT));
    SELF := __PP329011;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE328769,__ND329078__Project(LEFT));
END;
