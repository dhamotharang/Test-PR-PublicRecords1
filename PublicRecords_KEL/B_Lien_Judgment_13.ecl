...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE327175 := __E_Lien_Judgment;
  EXPORT __ST263865_Layout := RECORD
  ...
  END;
  EXPORT __ST263860_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST263865_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263860_Layout __ND327484__Project(E_Lien_Judgment(__in,__cfg).Layout __PP327417) := TRANSFORM
    __EE327023 := __PP327417.Filing_;
    __ST263865_Layout __ND327420__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP327419) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP327417.T_M_S_I_D_;
      SELF := __PP327419;
    END;
    SELF.Filing_ := __PROJECT(__EE327023,__ND327420__Project(LEFT));
    SELF := __PP327417;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE327175,__ND327484__Project(LEFT));
END;
