...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE346040 := __E_Lien_Judgment;
  EXPORT __ST277433_Layout := RECORD
  ...
  END;
  EXPORT __ST277428_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST277433_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST277428_Layout __ND346349__Project(E_Lien_Judgment(__in,__cfg).Layout __PP346282) := TRANSFORM
    __EE345888 := __PP346282.Filing_;
    __ST277433_Layout __ND346285__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP346284) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP346282.T_M_S_I_D_;
      SELF := __PP346284;
    END;
    SELF.Filing_ := __PROJECT(__EE345888,__ND346285__Project(LEFT));
    SELF := __PP346282;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE346040,__ND346349__Project(LEFT));
END;
