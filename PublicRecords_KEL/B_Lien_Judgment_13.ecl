...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE293565 := __E_Lien_Judgment;
  EXPORT __ST260794_Layout := RECORD
  ...
  END;
  EXPORT __ST260789_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST260794_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260789_Layout __ND293874__Project(E_Lien_Judgment(__in,__cfg).Layout __PP293807) := TRANSFORM
    __EE293413 := __PP293807.Filing_;
    __ST260794_Layout __ND293810__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP293809) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP293807.T_M_S_I_D_;
      SELF := __PP293809;
    END;
    SELF.Filing_ := __PROJECT(__EE293413,__ND293810__Project(LEFT));
    SELF := __PP293807;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE293565,__ND293874__Project(LEFT));
END;
