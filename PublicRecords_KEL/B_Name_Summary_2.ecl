...
EXPORT B_Name_Summary_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6488820 := __ENH_Name_Summary_3;
  SHARED __EE6488822 := __ENH_Input_P_I_I_3;
  SHARED __ST1501107_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr First_Name_;
    KEL.typ.nstr Last_Name_;
    KEL.typ.nkdate Date_Of_Birth_;
    KEL.typ.nint Record_Count_;
    KEL.typ.ndataset(B_Name_Summary_3(__in,__cfg).__ST221249_Layout) Data_Sources_;
  ...
  END;
  __JC6488831(B_Name_Summary_3(__in,__cfg).__ST221242_Layout __EE6488820, B_Input_P_I_I_3(__in,__cfg).__ST932298_Layout __EE6488822) := __EEQP(__EE6488820.P_I_I_,__EE6488822.UID);
  __ST1501107_Layout __JT6488831(B_Name_Summary_3(__in,__cfg).__ST221242_Layout __l, B_Input_P_I_I_3(__in,__cfg).__ST932298_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Last_Name__1_ := __r.Last_Name_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE6488993 := JOIN(__EE6488820,__EE6488822,__JC6488831(LEFT,RIGHT),__JT6488831(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST205556_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST205549_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr First_Name_;
    KEL.typ.nstr Last_Name_;
    KEL.typ.nkdate Date_Of_Birth_;
    KEL.typ.nint Record_Count_;
    KEL.typ.ndataset(__ST205556_Layout) Data_Sources_;
    KEL.typ.ndataset(B_Name_Summary_3(__in,__cfg).__ST76528_Layout) Name_Summary_Source_List_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST205549_Layout __ND6488781__Project(__ST1501107_Layout __PP6487932) := TRANSFORM
    __EE6488996 := __PP6487932.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6488996),__ST205556_Layout),__NL(__EE6488996));
    __EE6488775 := __PP6487932.Name_Summary_Source_List_;
    __CC13720 := '-99997';
    __BS6488750 := __T(__EE6488775);
    __EE6488779 := __BN(TOPN(__BS6488750(__NN(__OP2(__T(__EE6488775).Source_Date_First_Seen_,=,__CN(__CC13720))) AND __NN(IF(__T(__OP2(__T(__EE6488775).Source_Date_First_Seen_,=,__CN(__CC13720))),__ECAST(KEL.typ.nstr,__T(__EE6488775).Source_Date_Last_Seen_),__ECAST(KEL.typ.nstr,__T(__EE6488775).Source_Date_First_Seen_))) AND __NN(__T(__EE6488775).Translated_Source_Code_)),1000,__T(__OP2(__T(__EE6488775).Source_Date_First_Seen_,=,__CN(__CC13720))),__T(IF(__T(__OP2(__T(__EE6488775).Source_Date_First_Seen_,=,__CN(__CC13720))),__ECAST(KEL.typ.nstr,__T(__EE6488775).Source_Date_Last_Seen_),__ECAST(KEL.typ.nstr,__T(__EE6488775).Source_Date_First_Seen_))),__T(__T(__EE6488775).Translated_Source_Code_)),__NL(__EE6488775));
    SELF.Name_Summary_Source_List_Sorted_ := __EE6488779;
    SELF.P___Inp_Cln_D_O_B_ := __PP6487932.Input_D_O_B_Clean_Value_;
    SELF.P___Inp_Cln_Name_First_ := __PP6487932.Input_First_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Last_ := __PP6487932.Input_Last_Name_Clean_Value_;
    SELF := __PP6487932;
  END;
  EXPORT __ENH_Name_Summary_2 := PROJECT(__EE6488993,__ND6488781__Project(LEFT));
END;
