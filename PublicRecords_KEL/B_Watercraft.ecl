...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE492758 := __E_Watercraft;
  EXPORT __ST30880_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST30880_Layout __ND492830__Project(E_Watercraft(__in,__cfg).Layout __PP492675) := TRANSFORM
    ...
    SELF := __PP492675;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE492758,__ND492830__Project(LEFT));
END;
