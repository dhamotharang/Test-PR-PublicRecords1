...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE794326 := __E_Watercraft;
  EXPORT __ST48094_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST48094_Layout __ND794398__Project(E_Watercraft(__in,__cfg).Layout __PP794243) := TRANSFORM
    ...
    SELF := __PP794243;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE794326,__ND794398__Project(LEFT));
END;
