...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1424581 := __E_Watercraft;
  EXPORT __ST60618_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST60618_Layout __ND1424653__Project(E_Watercraft(__in,__cfg).Layout __PP1424498) := TRANSFORM
    ...
    SELF := __PP1424498;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE1424581,__ND1424653__Project(LEFT));
END;
