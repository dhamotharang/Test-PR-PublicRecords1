...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1930308 := __E_Watercraft;
  EXPORT __ST76314_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST76314_Layout __ND1930351__Project(E_Watercraft(__in,__cfg).Layout __PP1930246) := TRANSFORM
    ...
    SELF := __PP1930246;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE1930308,__ND1930351__Project(LEFT));
END;
