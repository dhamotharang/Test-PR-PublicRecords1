...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE800043 := __E_Watercraft;
  EXPORT __ST48439_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST48439_Layout __ND800115__Project(E_Watercraft(__in,__cfg).Layout __PP799960) := TRANSFORM
    ...
    SELF := __PP799960;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE800043,__ND800115__Project(LEFT));
END;
