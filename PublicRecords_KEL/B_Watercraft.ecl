...
EXPORT B_Watercraft(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE440590 := __E_Watercraft;
  EXPORT __ST27530_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST27530_Layout __ND440662__Project(E_Watercraft(__in,__cfg).Layout __PP440507) := TRANSFORM
    ...
    SELF := __PP440507;
  END;
  EXPORT __ENH_Watercraft := PROJECT(__EE440590,__ND440662__Project(LEFT));
END;
