...
EXPORT B_Input_B_I_I_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE198229 := __ENH_Input_B_I_I_2;
  SHARED __EE198838 := __ENH_Input_P_I_I_2;
  SHARED __EE198836 := __E_Input_B_I_I_Input_P_I_I;
  SHARED __EE204644 := __EE198836(__NN(__EE198836.B_I_I_) AND __NN(__EE198836.P_I_I_));
  SHARED __ST202049_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC204662(B_Input_P_I_I_2(__in,__cfg).__ST35801_Layout __EE198838, E_Input_B_I_I_Input_P_I_I(__in,__cfg).Layout __EE204644) := __EEQP(__EE204644.P_I_I_,__EE198838.UID);
  __ST202049_Layout __JT204662(B_Input_P_I_I_2(__in,__cfg).__ST35801_Layout __l, E_Input_B_I_I_Input_P_I_I(__in,__cfg).Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE204663 := JOIN(__EE204644,__EE198838,__JC204662(RIGHT,LEFT),__JT204662(RIGHT,LEFT),INNER,MANY LOOKUP);
  SHARED __ST201125_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST201125_Layout __ND204767__Project(__ST202049_Layout __PP204664) := TRANSFORM
    SELF.UID := __PP204664.B_I_I_;
    SELF.U_I_D__1_ := __PP204664.UID;
    SELF := __PP204664;
  END;
  SHARED __EE205164 := PROJECT(__EE204663,__ND204767__Project(LEFT));
  SHARED __ST201362_Layout := RECORD
    KEL.typ.ntyp(E_Input_B_I_I().Typ) UID;
    KEL.typ.nuid Exp1_;
    KEL.typ.nuid Exp2_;
    KEL.typ.nuid Exp3_;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST201362_Layout __ND205873__Project(__ST201125_Layout __PP205165) := TRANSFORM
    SELF.Exp1_ := IF(__T(__OP2(__PP205165.Rep_Number_,=,__CN(1))),__ECAST(KEL.typ.nuid,__PP205165.U_I_D__1_),__ECAST(KEL.typ.nuid,__N(KEL.typ.uid)));
    SELF.Exp2_ := IF(__T(__OP2(__PP205165.Rep_Number_,=,__CN(2))),__ECAST(KEL.typ.nuid,__PP205165.U_I_D__1_),__ECAST(KEL.typ.nuid,__N(KEL.typ.uid)));
    SELF.Exp3_ := IF(__T(__OP2(__PP205165.Rep_Number_,=,__CN(3))),__ECAST(KEL.typ.nuid,__PP205165.U_I_D__1_),__ECAST(KEL.typ.nuid,__N(KEL.typ.uid)));
    SELF.Exp4_ := IF(__T(__OP2(__PP205165.Rep_Number_,=,__CN(4))),__ECAST(KEL.typ.nuid,__PP205165.U_I_D__1_),__ECAST(KEL.typ.nuid,__N(KEL.typ.uid)));
    SELF.Exp5_ := IF(__T(__OP2(__PP205165.Rep_Number_,=,__CN(5))),__ECAST(KEL.typ.nuid,__PP205165.U_I_D__1_),__ECAST(KEL.typ.nuid,__N(KEL.typ.uid)));
    SELF := __PP205165;
  END;
  SHARED __EE205893 := PROJECT(__EE205164,__ND205873__Project(LEFT));
  SHARED __ST201397_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE205929 := PROJECT(__CLEANANDDO(__EE205893,TABLE(__EE205893,{KEL.Aggregates.MaxNG(__EE205893.Exp1_) O_N_L_Y___U_I_D_,KEL.Aggregates.MaxNG(__EE205893.Exp2_) O_N_L_Y___U_I_D__1_,KEL.Aggregates.MaxNG(__EE205893.Exp3_) O_N_L_Y___U_I_D__2_,KEL.Aggregates.MaxNG(__EE205893.Exp4_) O_N_L_Y___U_I_D__3_,KEL.Aggregates.MaxNG(__EE205893.Exp5_) O_N_L_Y___U_I_D__4_,UID},UID,MERGE)),__ST201397_Layout);
  SHARED __ST202561_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC205935(B_Input_B_I_I_2(__in,__cfg).__ST35178_Layout __EE198229, __ST201397_Layout __EE205929) := __EEQP(__EE198229.UID,__EE205929.UID);
  __ST202561_Layout __JT205935(B_Input_B_I_I_2(__in,__cfg).__ST35178_Layout __l, __ST201397_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE206018 := JOIN(__EE198229,__EE205929,__JC205935(LEFT,RIGHT),__JT205935(LEFT,RIGHT),LEFT OUTER,MANY LOOKUP);
  EXPORT __ST32213_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Business().Typ) Company_;
    KEL.typ.nint Bus_Input_U_I_D_Append_;
    KEL.typ.nint Input_Lex_I_D_Bus_Extended_Family_Echo_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32213_Layout __ND206023__Project(__ST202561_Layout __PP206019) := TRANSFORM
    SELF.Auth_Rep1_ := __PP206019.O_N_L_Y___U_I_D_;
    SELF.Auth_Rep2_ := __PP206019.O_N_L_Y___U_I_D__1_;
    SELF.Auth_Rep3_ := __PP206019.O_N_L_Y___U_I_D__2_;
    SELF.Auth_Rep4_ := __PP206019.O_N_L_Y___U_I_D__3_;
    SELF.Auth_Rep5_ := __PP206019.O_N_L_Y___U_I_D__4_;
    __CC3175 := '-99999';
    __CC3180 := '-99998';
    SELF.Bus_Input_Addr_Status_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Addr_Status_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Addr_Type_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Addr_Type_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Alternate_Name_Clean_Value_ := FN_Compile.FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Alternate_Name_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Alternate_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)));
    SELF.Bus_Input_County_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_County_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Email_Clean_Value_ := FN_Compile.FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Email_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Email_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)));
    SELF.Bus_Input_Full_Address_Clean_Value_ := MAP(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC3175)),__T(__OR(__OP2(__PP206019.Bus_Input_Street_Clean_Pop_Value_,=,__CN('0')),__PP206019.Clean_City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC3180)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP206019.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Prim_Range_Clean_),+,__CN(' ')))),+,IF(__T(__OP2(__PP206019.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Pre_Dir_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Prim_Name_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Addr_Suffix_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Post_Dir_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Unit_Desig_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Sec_Range_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_City_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_City_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_State_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_State_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Zip5_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP206019.Bus_Input_Zip5_Clean_),+,__CN(' '))))),+,IF(__T(__OP2(__PP206019.Bus_Input_Zip4_Clean_Value_,=,__CN(__CC3180))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP206019.Bus_Input_Zip4_Clean_))))));
    SELF.Bus_Input_Geoblock_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Geoblock_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Latitude_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Latitude_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Longitude_Clean_Value_ := IF(__T(__OR(__CN(__PP206019.Addr_Not_Populated_),__PP206019.City_State_Zip_Not_Populated_)),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Longitude_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)))));
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile.FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Name_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)));
    SELF.Bus_Input_Phone_Clean_Value_ := FN_Compile.FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Phone_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_Phone_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)));
    SELF.Bus_Input_T_I_N_Clean_Value_ := FN_Compile.FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_T_I_N_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3175)),__ECAST(KEL.typ.nstr,__PP206019.Bus_Input_T_I_N_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3180)));
    SELF := __PP206019;
  END;
  EXPORT __ENH_Input_B_I_I_1 := PROJECT(__EE206018,__ND206023__Project(LEFT));
END;
