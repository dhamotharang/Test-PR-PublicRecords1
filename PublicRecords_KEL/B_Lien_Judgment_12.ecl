...
EXPORT B_Lien_Judgment_12(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE238017 := __E_Lien_Judgment;
  EXPORT __ST211939_Layout := RECORD
  ...
  END;
  EXPORT __ST211934_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST211939_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211934_Layout __ND238326__Project(E_Lien_Judgment(__in,__cfg).Layout __PP238259) := TRANSFORM
    __EE237865 := __PP238259.Filing_;
    __ST211939_Layout __ND238262__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP238261) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP238259.T_M_S_I_D_;
      SELF := __PP238261;
    END;
    SELF.Filing_ := __PROJECT(__EE237865,__ND238262__Project(LEFT));
    SELF := __PP238259;
  END;
  EXPORT __ENH_Lien_Judgment_12 := PROJECT(__EE238017,__ND238326__Project(LEFT));
END;
