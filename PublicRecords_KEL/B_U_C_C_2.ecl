...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8102035 := __ENH_U_C_C_3;
  EXPORT __ST338678_Layout := RECORD
  ...
  END;
  EXPORT __ST338674_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST338678_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST338674_Layout __ND8102040__Project(B_U_C_C_3(__in,__cfg).__ST338501_Layout __PP8102036) := TRANSFORM
    __EE8102078 := __PP8102036.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8102078),__ST338678_Layout),__NL(__EE8102078));
    SELF := __PP8102036;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8102035,__ND8102040__Project(LEFT));
END;
