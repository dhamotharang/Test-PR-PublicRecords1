...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6952313 := __ENH_U_C_C_3;
  EXPORT __ST292739_Layout := RECORD
  ...
  END;
  EXPORT __ST292735_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST292739_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST292735_Layout __ND6952318__Project(B_U_C_C_3(__in,__cfg).__ST292562_Layout __PP6952314) := TRANSFORM
    __EE6952356 := __PP6952314.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6952356),__ST292739_Layout),__NL(__EE6952356));
    SELF := __PP6952314;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE6952313,__ND6952318__Project(LEFT));
END;
