...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7603858 := __ENH_U_C_C_3;
  EXPORT __ST283216_Layout := RECORD
  ...
  END;
  EXPORT __ST283212_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST283216_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST283212_Layout __ND7603863__Project(B_U_C_C_3(__in,__cfg).__ST283039_Layout __PP7603859) := TRANSFORM
    __EE7603901 := __PP7603859.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7603901),__ST283216_Layout),__NL(__EE7603901));
    SELF := __PP7603859;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7603858,__ND7603863__Project(LEFT));
END;
