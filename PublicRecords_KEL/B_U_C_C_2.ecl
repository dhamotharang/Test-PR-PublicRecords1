...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8122655 := __ENH_U_C_C_3;
  EXPORT __ST330686_Layout := RECORD
  ...
  END;
  EXPORT __ST330682_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST330686_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST330682_Layout __ND8122660__Project(B_U_C_C_3(__in,__cfg).__ST330509_Layout __PP8122656) := TRANSFORM
    __EE8122698 := __PP8122656.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8122698),__ST330686_Layout),__NL(__EE8122698));
    SELF := __PP8122656;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8122655,__ND8122660__Project(LEFT));
END;
