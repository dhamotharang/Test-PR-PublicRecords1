...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7242730 := __ENH_U_C_C_3;
  EXPORT __ST271614_Layout := RECORD
  ...
  END;
  EXPORT __ST271610_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST271614_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST271610_Layout __ND7242735__Project(B_U_C_C_3(__in,__cfg).__ST271437_Layout __PP7242731) := TRANSFORM
    __EE7242773 := __PP7242731.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7242773),__ST271614_Layout),__NL(__EE7242773));
    SELF := __PP7242731;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7242730,__ND7242735__Project(LEFT));
END;
