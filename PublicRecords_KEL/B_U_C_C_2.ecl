...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7574897 := __ENH_U_C_C_3;
  ...
  EXPORT __ST273668_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273668_Layout __ND7574902__Project(B_U_C_C_3(__in,__cfg).__ST273495_Layout __PP7574898) := TRANSFORM
    __EE7574940 := __PP7574898.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7574940),__ST273672_Layout),__NL(__EE7574940));
    SELF := __PP7574898;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7574897,__ND7574902__Project(LEFT));
END;
