...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7358537 := __ENH_U_C_C_3;
  ...
  END;
  EXPORT __ST268066_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST268070_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST268066_Layout __ND7358542__Project(B_U_C_C_3(__in,__cfg).__ST267893_Layout __PP7358538) := TRANSFORM
    __EE7358580 := __PP7358538.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7358580),__ST268070_Layout),__NL(__EE7358580));
    SELF := __PP7358538;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7358537,__ND7358542__Project(LEFT));
END;
