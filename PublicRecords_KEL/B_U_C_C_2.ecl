...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4655119 := __ENH_U_C_C_3;
  EXPORT __ST231693_Layout := RECORD
  ...
  END;
  EXPORT __ST231689_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST231693_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231689_Layout __ND4655124__Project(B_U_C_C_3(__in,__cfg).__ST231516_Layout __PP4655120) := TRANSFORM
    __EE4655162 := __PP4655120.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4655162),__ST231693_Layout),__NL(__EE4655162));
    SELF := __PP4655120;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE4655119,__ND4655124__Project(LEFT));
END;
