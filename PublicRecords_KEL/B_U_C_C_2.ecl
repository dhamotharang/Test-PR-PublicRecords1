...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8287531 := __ENH_U_C_C_3;
  EXPORT __ST320378_Layout := RECORD
  ...
  END;
  EXPORT __ST320374_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST320378_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST320374_Layout __ND8287536__Project(B_U_C_C_3(__in,__cfg).__ST320201_Layout __PP8287532) := TRANSFORM
    __EE8287574 := __PP8287532.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8287574),__ST320378_Layout),__NL(__EE8287574));
    SELF := __PP8287532;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8287531,__ND8287536__Project(LEFT));
END;
