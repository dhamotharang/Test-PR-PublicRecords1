...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8037262 := __ENH_U_C_C_3;
  EXPORT __ST307225_Layout := RECORD
  ...
  END;
  EXPORT __ST307221_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST307225_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST307221_Layout __ND8037267__Project(B_U_C_C_3(__in,__cfg).__ST307048_Layout __PP8037263) := TRANSFORM
    __EE8037305 := __PP8037263.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8037305),__ST307225_Layout),__NL(__EE8037305));
    SELF := __PP8037263;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8037262,__ND8037267__Project(LEFT));
END;
