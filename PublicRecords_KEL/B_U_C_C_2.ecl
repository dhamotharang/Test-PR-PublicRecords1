...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7243833 := __ENH_U_C_C_3;
  EXPORT __ST273015_Layout := RECORD
  ...
  END;
  EXPORT __ST273011_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273015_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273011_Layout __ND7243838__Project(B_U_C_C_3(__in,__cfg).__ST272838_Layout __PP7243834) := TRANSFORM
    __EE7243876 := __PP7243834.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7243876),__ST273015_Layout),__NL(__EE7243876));
    SELF := __PP7243834;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7243833,__ND7243838__Project(LEFT));
END;
