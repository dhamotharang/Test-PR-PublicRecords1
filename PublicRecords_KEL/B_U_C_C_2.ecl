...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8319338 := __ENH_U_C_C_3;
  EXPORT __ST347229_Layout := RECORD
  ...
  END;
  EXPORT __ST347225_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST347229_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST347225_Layout __ND8319343__Project(B_U_C_C_3(__in,__cfg).__ST347052_Layout __PP8319339) := TRANSFORM
    __EE8319381 := __PP8319339.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8319381),__ST347229_Layout),__NL(__EE8319381));
    SELF := __PP8319339;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8319338,__ND8319343__Project(LEFT));
END;
