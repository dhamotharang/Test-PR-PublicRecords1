...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8252074 := __ENH_U_C_C_3;
  EXPORT __ST312651_Layout := RECORD
  ...
  END;
  EXPORT __ST312647_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST312651_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST312647_Layout __ND8252079__Project(B_U_C_C_3(__in,__cfg).__ST312474_Layout __PP8252075) := TRANSFORM
    __EE8252117 := __PP8252075.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8252117),__ST312651_Layout),__NL(__EE8252117));
    SELF := __PP8252075;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8252074,__ND8252079__Project(LEFT));
END;
