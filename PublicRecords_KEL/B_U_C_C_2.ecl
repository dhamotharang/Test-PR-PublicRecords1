...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8215207 := __ENH_U_C_C_3;
  EXPORT __ST314403_Layout := RECORD
  ...
  END;
  EXPORT __ST314399_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST314403_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST314399_Layout __ND8215212__Project(B_U_C_C_3(__in,__cfg).__ST314226_Layout __PP8215208) := TRANSFORM
    __EE8215250 := __PP8215208.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8215250),__ST314403_Layout),__NL(__EE8215250));
    SELF := __PP8215208;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8215207,__ND8215212__Project(LEFT));
END;
