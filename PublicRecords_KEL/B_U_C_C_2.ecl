...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7755778 := __ENH_U_C_C_3;
  EXPORT __ST326335_Layout := RECORD
  ...
  EXPORT __ST326331_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST326335_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST326331_Layout __ND7755783__Project(B_U_C_C_3(__in,__cfg).__ST326158_Layout __PP7755779) := TRANSFORM
    __EE7755821 := __PP7755779.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7755821),__ST326335_Layout),__NL(__EE7755821));
    SELF := __PP7755779;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7755778,__ND7755783__Project(LEFT));
END;
