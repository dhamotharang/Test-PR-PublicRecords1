...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9307669 := __ENH_U_C_C_3;
  EXPORT __ST371427_Layout := RECORD
  ...
  END;
  EXPORT __ST371423_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST371427_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST371423_Layout __ND9307674__Project(B_U_C_C_3(__in,__cfg).__ST371250_Layout __PP9307670) := TRANSFORM
    __EE9307712 := __PP9307670.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9307712),__ST371427_Layout),__NL(__EE9307712));
    SELF := __PP9307670;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE9307669,__ND9307674__Project(LEFT));
END;
