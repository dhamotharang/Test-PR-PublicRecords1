...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2093168 := __ENH_U_C_C_3;
  EXPORT __ST137629_Layout := RECORD
  ...
  END;
  EXPORT __ST137625_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST137629_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST137625_Layout __ND2093435__Project(B_U_C_C_3(__in,__cfg).__ST148117_Layout __PP2092905) := TRANSFORM
    __EE2092978 := __PP2092905.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2092978,__ST137629_Layout);
    SELF := __PP2092905;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2093168,__ND2093435__Project(LEFT));
END;
