...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7241440 := __ENH_U_C_C_3;
  ...
  END;
  EXPORT __ST267271_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST267275_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267271_Layout __ND7241445__Project(B_U_C_C_3(__in,__cfg).__ST267098_Layout __PP7241441) := TRANSFORM
    __EE7241483 := __PP7241441.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7241483),__ST267275_Layout),__NL(__EE7241483));
    SELF := __PP7241441;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7241440,__ND7241445__Project(LEFT));
END;
