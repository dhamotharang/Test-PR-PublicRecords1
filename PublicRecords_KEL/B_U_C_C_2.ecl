...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7615446 := __ENH_U_C_C_3;
  EXPORT __ST300083_Layout := RECORD
  ...
  END;
  EXPORT __ST300079_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST300083_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST300079_Layout __ND7615451__Project(B_U_C_C_3(__in,__cfg).__ST299906_Layout __PP7615447) := TRANSFORM
    __EE7615489 := __PP7615447.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7615489),__ST300083_Layout),__NL(__EE7615489));
    SELF := __PP7615447;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7615446,__ND7615451__Project(LEFT));
END;
