...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7782863 := __ENH_U_C_C_3;
  EXPORT __ST298309_Layout := RECORD
  ...
  END;
  EXPORT __ST298305_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST298309_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST298305_Layout __ND7782868__Project(B_U_C_C_3(__in,__cfg).__ST298132_Layout __PP7782864) := TRANSFORM
    __EE7782906 := __PP7782864.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7782906),__ST298309_Layout),__NL(__EE7782906));
    SELF := __PP7782864;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7782863,__ND7782868__Project(LEFT));
END;
