...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7615416 := __ENH_U_C_C_3;
  EXPORT __ST290915_Layout := RECORD
  ...
  END;
  EXPORT __ST290911_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST290915_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST290911_Layout __ND7615421__Project(B_U_C_C_3(__in,__cfg).__ST290738_Layout __PP7615417) := TRANSFORM
    __EE7615459 := __PP7615417.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7615459),__ST290915_Layout),__NL(__EE7615459));
    SELF := __PP7615417;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7615416,__ND7615421__Project(LEFT));
END;
