...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8889824 := __ENH_U_C_C_3;
  EXPORT __ST334230_Layout := RECORD
  ...
  END;
  EXPORT __ST334226_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST334230_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST334226_Layout __ND8889829__Project(B_U_C_C_3(__in,__cfg).__ST334053_Layout __PP8889825) := TRANSFORM
    __EE8889867 := __PP8889825.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8889867),__ST334230_Layout),__NL(__EE8889867));
    SELF := __PP8889825;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE8889824,__ND8889829__Project(LEFT));
END;
