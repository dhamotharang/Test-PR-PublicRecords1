...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7243828 := __ENH_U_C_C_3;
  EXPORT __ST265379_Layout := RECORD
  ...
  END;
  EXPORT __ST265375_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST265379_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265375_Layout __ND7243833__Project(B_U_C_C_3(__in,__cfg).__ST265202_Layout __PP7243829) := TRANSFORM
    __EE7243871 := __PP7243829.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7243871),__ST265379_Layout),__NL(__EE7243871));
    SELF := __PP7243829;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE7243828,__ND7243833__Project(LEFT));
END;
