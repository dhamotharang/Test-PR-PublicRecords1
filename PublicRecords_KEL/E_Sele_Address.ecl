...
IMPORT CFG_Compile,E_Address,E_Business_Org,E_Business_Sele,E_Business_Ult,E_Geo_Link,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT E_Sele_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d0(Vault_Date_First_Seen_=0)),COUNT(__d0(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d1(Vault_Date_First_Seen_=0)),COUNT(__d1(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d2(Vault_Date_First_Seen_=0)),COUNT(__d2(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d3(Vault_Date_First_Seen_=0)),COUNT(__d3(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d4(Vault_Date_First_Seen_=0)),COUNT(__d4(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d5(Vault_Date_First_Seen_=0)),COUNT(__d5(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d6(Vault_Date_First_Seen_=0)),COUNT(__d6(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d7(Vault_Date_First_Seen_=0)),COUNT(__d7(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d8(Vault_Date_First_Seen_=0)),COUNT(__d8(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d9(Vault_Date_First_Seen_=0)),COUNT(__d9(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d10(Vault_Date_First_Seen_=0)),COUNT(__d10(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d11(Vault_Date_First_Seen_=0)),COUNT(__d11(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d12(Vault_Date_First_Seen_=0)),COUNT(__d12(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d13(Vault_Date_First_Seen_=0)),COUNT(__d13(Vault_Date_First_Seen_!=0))},
    ...
    {'SeleAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d14(Vault_Date_First_Seen_=0)),COUNT(__d14(Vault_Date_First_Seen_!=0))},
