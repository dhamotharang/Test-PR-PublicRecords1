...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1(SET OF KEL.typ.uid __PLexIDs, KEL.typ.kdate __PArchiveDate, UNSIGNED1 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE408554 := __ENH_Person;
  SHARED __EE412400 := __EE408554(__T(__OP2(__EE408554.UID,IN,__CN(__PLexIDs))));
  SHARED __ST17418_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15718_Layout) Dt_Of_Bks_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15736_Layout) Dt_Of_Bks_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15754_Layout) Dt_Of_Bks_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15935_Layout) Ch_For_Bks_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15962_Layout) Ch_For_Bks_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST15989_Layout) Ch_For_Bks_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST16648_Layout) Disp_Of_Bks_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST16672_Layout) Disp_Of_Bks_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST16696_Layout) Disp_Of_Bks_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST17167_Layout) Type_Of_Bks_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST17201_Layout) Type_Of_Bks_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST17235_Layout) Type_Of_Bks_List10_Y_;
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE412400,TRANSFORM(__ST17418_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
