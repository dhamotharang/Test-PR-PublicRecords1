...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1(SET OF KEL.typ.uid __PLexIDs, KEL.typ.kdate __PArchiveDate, UNSIGNED1 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE144530 := __ENH_Person;
  SHARED __EE145123 := __EE144530(__T(__OP2(__EE144530.UID,IN,__CN(__PLexIDs))));
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE145123,TRANSFORM(__ST12652_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
