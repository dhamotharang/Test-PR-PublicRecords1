...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4945403 := __ENH_U_C_C_8;
  EXPORT __ST251107_Layout := RECORD
  ...
  EXPORT __ST251103_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251107_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251103_Layout __ND4945408__Project(B_U_C_C_8(__in,__cfg).__ST253501_Layout __PP4945404) := TRANSFORM
    __EE4945443 := __PP4945404.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4945443),__ST251107_Layout),__NL(__EE4945443));
    SELF := __PP4945404;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4945403,__ND4945408__Project(LEFT));
END;
