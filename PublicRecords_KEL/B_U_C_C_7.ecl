...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5267181 := __ENH_U_C_C_8;
  EXPORT __ST257354_Layout := RECORD
  ...
  END;
  EXPORT __ST257350_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST257354_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST257350_Layout __ND5267186__Project(B_U_C_C_8(__in,__cfg).__ST259954_Layout __PP5267182) := TRANSFORM
    __EE5267221 := __PP5267182.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5267221),__ST257354_Layout),__NL(__EE5267221));
    SELF := __PP5267182;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5267181,__ND5267186__Project(LEFT));
END;
