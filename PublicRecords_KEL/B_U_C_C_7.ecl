...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5522688 := __ENH_U_C_C_8;
  EXPORT __ST272011_Layout := RECORD
  ...
  END;
  EXPORT __ST272007_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST272011_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST272007_Layout __ND5522693__Project(B_U_C_C_8(__in,__cfg).__ST274701_Layout __PP5522689) := TRANSFORM
    __EE5522728 := __PP5522689.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5522728),__ST272011_Layout),__NL(__EE5522728));
    SELF := __PP5522689;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5522688,__ND5522693__Project(LEFT));
END;
