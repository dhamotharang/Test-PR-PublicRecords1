...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4828414 := __ENH_U_C_C_8;
  EXPORT __ST249901_Layout := RECORD
  ...
  EXPORT __ST249897_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST249901_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249897_Layout __ND4828419__Project(B_U_C_C_8(__in,__cfg).__ST252295_Layout __PP4828415) := TRANSFORM
    __EE4828454 := __PP4828415.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4828454),__ST249901_Layout),__NL(__EE4828454));
    SELF := __PP4828415;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4828414,__ND4828419__Project(LEFT));
END;
