...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5450859 := __ENH_U_C_C_8;
  EXPORT __ST263827_Layout := RECORD
  ...
  END;
  EXPORT __ST263823_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST263827_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263823_Layout __ND5450864__Project(B_U_C_C_8(__in,__cfg).__ST266456_Layout __PP5450860) := TRANSFORM
    __EE5450899 := __PP5450860.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5450899),__ST263827_Layout),__NL(__EE5450899));
    SELF := __PP5450860;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5450859,__ND5450864__Project(LEFT));
END;
