...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5294132 := __ENH_U_C_C_8;
  EXPORT __ST258765_Layout := RECORD
  ...
  END;
  EXPORT __ST258761_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258765_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258761_Layout __ND5294137__Project(B_U_C_C_8(__in,__cfg).__ST261365_Layout __PP5294133) := TRANSFORM
    __EE5294172 := __PP5294133.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5294172),__ST258765_Layout),__NL(__EE5294172));
    SELF := __PP5294133;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5294132,__ND5294137__Project(LEFT));
END;
