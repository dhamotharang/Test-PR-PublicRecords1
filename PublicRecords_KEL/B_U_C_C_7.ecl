...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4822450 := __ENH_U_C_C_8;
  EXPORT __ST250059_Layout := RECORD
  ...
  END;
  EXPORT __ST250055_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250059_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250055_Layout __ND4822455__Project(B_U_C_C_8(__in,__cfg).__ST252453_Layout __PP4822451) := TRANSFORM
    __EE4822490 := __PP4822451.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4822490),__ST250059_Layout),__NL(__EE4822490));
    SELF := __PP4822451;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4822450,__ND4822455__Project(LEFT));
END;
