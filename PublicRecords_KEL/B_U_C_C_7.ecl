...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4827727 := __ENH_U_C_C_8;
  EXPORT __ST250093_Layout := RECORD
  ...
  END;
  EXPORT __ST250089_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250093_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250089_Layout __ND4827732__Project(B_U_C_C_8(__in,__cfg).__ST252487_Layout __PP4827728) := TRANSFORM
    __EE4827767 := __PP4827728.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4827767),__ST250093_Layout),__NL(__EE4827767));
    SELF := __PP4827728;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4827727,__ND4827732__Project(LEFT));
END;
