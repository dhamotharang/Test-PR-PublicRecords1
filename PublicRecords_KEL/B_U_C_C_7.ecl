...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5070867 := __ENH_U_C_C_8;
  EXPORT __ST258097_Layout := RECORD
  ...
  END;
  EXPORT __ST258093_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258097_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258093_Layout __ND5070872__Project(B_U_C_C_8(__in,__cfg).__ST260758_Layout __PP5070868) := TRANSFORM
    __EE5070907 := __PP5070868.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5070907),__ST258097_Layout),__NL(__EE5070907));
    SELF := __PP5070868;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5070867,__ND5070872__Project(LEFT));
END;
