...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4829835 := __ENH_U_C_C_8;
  EXPORT __ST250556_Layout := RECORD
  ...
  END;
  EXPORT __ST250552_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250556_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250552_Layout __ND4829840__Project(B_U_C_C_8(__in,__cfg).__ST252950_Layout __PP4829836) := TRANSFORM
    __EE4829875 := __PP4829836.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4829875),__ST250556_Layout),__NL(__EE4829875));
    SELF := __PP4829836;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4829835,__ND4829840__Project(LEFT));
END;
