...
EXPORT B_U_C_C_7(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED VIRTUAL TYPEOF(B_U_C_C_8(__cfg).__ENH_U_C_C_8) __ENH_U_C_C_8 := B_U_C_C_8(__cfg).__ENH_U_C_C_8;
  SHARED __EE5268398 := __ENH_U_C_C_8;
  ...
  EXPORT __ST258732_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258736_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258732_Layout __ND5268403__Project(B_U_C_C_8(__cfg).__ST261336_Layout __PP5268399) := TRANSFORM
    __EE5268438 := __PP5268399.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5268438),__ST258736_Layout),__NL(__EE5268438));
    SELF := __PP5268399;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5268398,__ND5268403__Project(LEFT));
END;
