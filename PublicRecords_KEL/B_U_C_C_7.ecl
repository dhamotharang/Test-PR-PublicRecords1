...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5580543 := __ENH_U_C_C_8;
  EXPORT __ST273628_Layout := RECORD
  ...
  END;
  EXPORT __ST273624_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273628_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273624_Layout __ND5580548__Project(B_U_C_C_8(__in,__cfg).__ST276320_Layout __PP5580544) := TRANSFORM
    __EE5580583 := __PP5580544.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5580583),__ST273628_Layout),__NL(__EE5580583));
    SELF := __PP5580544;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5580543,__ND5580548__Project(LEFT));
END;
