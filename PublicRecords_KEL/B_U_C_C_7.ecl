...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3533059 := __ENH_U_C_C_8;
  EXPORT __ST203842_Layout := RECORD
  ...
  END;
  EXPORT __ST203838_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST203842_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST203838_Layout __ND3533064__Project(B_U_C_C_8(__in,__cfg).__ST205969_Layout __PP3533060) := TRANSFORM
    __EE3533099 := __PP3533060.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3533099),__ST203842_Layout),__NL(__EE3533099));
    SELF := __PP3533060;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE3533059,__ND3533064__Project(LEFT));
END;
