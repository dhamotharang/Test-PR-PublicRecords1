...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5612350 := __ENH_U_C_C_8;
  EXPORT __ST273649_Layout := RECORD
  ...
  END;
  EXPORT __ST273645_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273649_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273645_Layout __ND5612355__Project(B_U_C_C_8(__in,__cfg).__ST276341_Layout __PP5612351) := TRANSFORM
    __EE5612390 := __PP5612351.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5612390),__ST273649_Layout),__NL(__EE5612390));
    SELF := __PP5612351;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5612350,__ND5612355__Project(LEFT));
END;
