...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5583395 := __ENH_U_C_C_8;
  EXPORT __ST274047_Layout := RECORD
  ...
  END;
  EXPORT __ST274043_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST274047_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST274043_Layout __ND5583400__Project(B_U_C_C_8(__in,__cfg).__ST276739_Layout __PP5583396) := TRANSFORM
    __EE5583435 := __PP5583396.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5583435),__ST274047_Layout),__NL(__EE5583435));
    SELF := __PP5583396;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5583395,__ND5583400__Project(LEFT));
END;
