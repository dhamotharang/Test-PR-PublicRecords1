...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4830698 := __ENH_U_C_C_8;
  EXPORT __ST250581_Layout := RECORD
  ...
  END;
  EXPORT __ST250577_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250581_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250577_Layout __ND4830703__Project(B_U_C_C_8(__in,__cfg).__ST252975_Layout __PP4830699) := TRANSFORM
    __EE4830738 := __PP4830699.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4830738),__ST250581_Layout),__NL(__EE4830738));
    SELF := __PP4830699;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4830698,__ND4830703__Project(LEFT));
END;
