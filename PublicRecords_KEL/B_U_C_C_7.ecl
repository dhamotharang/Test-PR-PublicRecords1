...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5102594 := __ENH_U_C_C_8;
  EXPORT __ST260163_Layout := RECORD
  ...
  END;
  EXPORT __ST260159_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST260163_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260159_Layout __ND5102599__Project(B_U_C_C_8(__in,__cfg).__ST262828_Layout __PP5102595) := TRANSFORM
    __EE5102634 := __PP5102595.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5102634),__ST260163_Layout),__NL(__EE5102634));
    SELF := __PP5102595;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5102594,__ND5102599__Project(LEFT));
END;
