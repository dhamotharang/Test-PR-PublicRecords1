...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5102624 := __ENH_U_C_C_8;
  EXPORT __ST260193_Layout := RECORD
  ...
  END;
  EXPORT __ST260189_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST260193_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260189_Layout __ND5102629__Project(B_U_C_C_8(__in,__cfg).__ST262858_Layout __PP5102625) := TRANSFORM
    __EE5102664 := __PP5102625.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5102664),__ST260193_Layout),__NL(__EE5102664));
    SELF := __PP5102625;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5102624,__ND5102629__Project(LEFT));
END;
