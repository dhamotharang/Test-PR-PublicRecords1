...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4830693 := __ENH_U_C_C_8;
  EXPORT __ST250576_Layout := RECORD
  ...
  END;
  EXPORT __ST250572_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250576_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250572_Layout __ND4830698__Project(B_U_C_C_8(__in,__cfg).__ST252970_Layout __PP4830694) := TRANSFORM
    __EE4830733 := __PP4830694.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4830733),__ST250576_Layout),__NL(__EE4830733));
    SELF := __PP4830694;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4830693,__ND4830698__Project(LEFT));
END;
