...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4671629 := __ENH_U_C_C_8;
  EXPORT __ST254436_Layout := RECORD
  ...
  END;
  EXPORT __ST254432_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST254436_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254432_Layout __ND4671634__Project(B_U_C_C_8(__in,__cfg).__ST256856_Layout __PP4671630) := TRANSFORM
    __EE4671669 := __PP4671630.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4671669),__ST254436_Layout),__NL(__EE4671669));
    SELF := __PP4671630;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE4671629,__ND4671634__Project(LEFT));
END;
