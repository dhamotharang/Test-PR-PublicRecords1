...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3544679 := __ENH_U_C_C_8;
  EXPORT __ST206573_Layout := RECORD
  ...
  END;
  EXPORT __ST206569_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST206573_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST206569_Layout __ND3544684__Project(B_U_C_C_8(__in,__cfg).__ST208702_Layout __PP3544680) := TRANSFORM
    __EE3544719 := __PP3544680.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3544719),__ST206573_Layout),__NL(__EE3544719));
    SELF := __PP3544680;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE3544679,__ND3544684__Project(LEFT));
END;
