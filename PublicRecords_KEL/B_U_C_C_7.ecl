...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5095267 := __ENH_U_C_C_8;
  EXPORT __ST259775_Layout := RECORD
  ...
  EXPORT __ST259771_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST259775_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST259771_Layout __ND5095272__Project(B_U_C_C_8(__in,__cfg).__ST262440_Layout __PP5095268) := TRANSFORM
    __EE5095307 := __PP5095268.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5095307),__ST259775_Layout),__NL(__EE5095307));
    SELF := __PP5095268;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE5095267,__ND5095272__Project(LEFT));
END;
