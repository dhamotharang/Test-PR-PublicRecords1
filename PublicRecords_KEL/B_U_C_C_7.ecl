...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3532117 := __ENH_U_C_C_8;
  EXPORT __ST195430_Layout := RECORD
  ...
  END;
  EXPORT __ST195426_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST195430_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195426_Layout __ND3532122__Project(B_U_C_C_8(__in,__cfg).__ST197492_Layout __PP3532118) := TRANSFORM
    __EE3532157 := __PP3532118.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3532157),__ST195430_Layout),__NL(__EE3532157));
    SELF := __PP3532118;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE3532117,__ND3532122__Project(LEFT));
END;
