...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6849881 := __ENH_Inquiry_3;
  EXPORT __ST282405_Layout := RECORD
  ...
  END;
  EXPORT __ST282378_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST282405_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST282378_Layout __ND6849886__Project(B_Inquiry_3(__in,__cfg).__ST282146_Layout __PP6849882) := TRANSFORM
    __EE6849956 := __PP6849882.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6849956),__ST282405_Layout),__NL(__EE6849956));
    SELF := __PP6849882;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6849881,__ND6849886__Project(LEFT));
END;
