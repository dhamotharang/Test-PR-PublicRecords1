...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6877891 := __ENH_Inquiry_3;
  EXPORT __ST284215_Layout := RECORD
  ...
  END;
  EXPORT __ST284188_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST284215_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST284188_Layout __ND6877896__Project(B_Inquiry_3(__in,__cfg).__ST283956_Layout __PP6877892) := TRANSFORM
    __EE6877966 := __PP6877892.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6877966),__ST284215_Layout),__NL(__EE6877966));
    SELF := __PP6877892;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6877891,__ND6877896__Project(LEFT));
END;
