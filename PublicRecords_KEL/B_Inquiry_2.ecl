...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6487524 := __ENH_Inquiry_3;
  ...
  END;
  EXPORT __ST285071_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST285098_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST285071_Layout __ND6487529__Project(B_Inquiry_3(__in,__cfg).__ST284839_Layout __PP6487525) := TRANSFORM
    __EE6487599 := __PP6487525.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6487599),__ST285098_Layout),__NL(__EE6487599));
    SELF := __PP6487525;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6487524,__ND6487529__Project(LEFT));
END;
