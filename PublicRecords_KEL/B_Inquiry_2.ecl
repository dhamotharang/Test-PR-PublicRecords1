...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6487519 := __ENH_Inquiry_3;
  ...
  END;
  EXPORT __ST266093_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST266120_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266093_Layout __ND6487524__Project(B_Inquiry_3(__in,__cfg).__ST265861_Layout __PP6487520) := TRANSFORM
    __EE6487594 := __PP6487520.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6487594),__ST266120_Layout),__NL(__EE6487594));
    SELF := __PP6487520;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6487519,__ND6487524__Project(LEFT));
END;
