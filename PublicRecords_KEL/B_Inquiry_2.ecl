...
EXPORT B_Inquiry_2(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED VIRTUAL TYPEOF(B_Inquiry_3(__cfg).__ENH_Inquiry_3) __ENH_Inquiry_3 := B_Inquiry_3(__cfg).__ENH_Inquiry_3;
  SHARED __EE6958020 := __ENH_Inquiry_3;
  EXPORT __ST298350_Layout := RECORD
  ...
  END;
  EXPORT __ST298323_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST298350_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST298323_Layout __ND6958025__Project(B_Inquiry_3(__cfg).__ST298091_Layout __PP6958021) := TRANSFORM
    __EE6958095 := __PP6958021.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6958095),__ST298350_Layout),__NL(__EE6958095));
    SELF := __PP6958021;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6958020,__ND6958025__Project(LEFT));
END;
