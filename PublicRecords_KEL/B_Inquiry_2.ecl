...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6956316 := __ENH_Inquiry_3;
  EXPORT __ST309927_Layout := RECORD
  ...
  END;
  EXPORT __ST309900_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST309927_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST309900_Layout __ND6956321__Project(B_Inquiry_3(__in,__cfg).__ST309668_Layout __PP6956317) := TRANSFORM
    __EE6956391 := __PP6956317.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6956391),__ST309927_Layout),__NL(__EE6956391));
    SELF := __PP6956317;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6956316,__ND6956321__Project(LEFT));
END;
