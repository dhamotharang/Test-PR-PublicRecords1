...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7301547 := __ENH_Inquiry_3;
  EXPORT __ST309826_Layout := RECORD
  ...
  END;
  EXPORT __ST309799_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST309826_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST309799_Layout __ND7301552__Project(B_Inquiry_3(__in,__cfg).__ST309568_Layout __PP7301548) := TRANSFORM
    __EE7301623 := __PP7301548.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE7301623),__ST309826_Layout),__NL(__EE7301623));
    SELF := __PP7301548;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE7301547,__ND7301552__Project(LEFT));
END;
