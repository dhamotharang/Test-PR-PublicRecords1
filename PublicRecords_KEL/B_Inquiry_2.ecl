...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6983401 := __ENH_Inquiry_3;
  EXPORT __ST327854_Layout := RECORD
  ...
  END;
  EXPORT __ST327827_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST327854_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST327827_Layout __ND6983406__Project(B_Inquiry_3(__in,__cfg).__ST327595_Layout __PP6983402) := TRANSFORM
    __EE6983476 := __PP6983402.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE6983476),__ST327854_Layout),__NL(__EE6983476));
    SELF := __PP6983402;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE6983401,__ND6983406__Project(LEFT));
END;
