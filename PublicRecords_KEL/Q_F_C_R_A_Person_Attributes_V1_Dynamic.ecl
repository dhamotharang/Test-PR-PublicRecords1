...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE12063044 := __ENH_Person;
  SHARED __EE12067813 := __EE12063044(__T(__OP2(__EE12063044.UID,=,__CN(__PLexID_in))));
  SHARED __ST98281_Layout := RECORD
  ...
  END;
  SHARED __ST98281_Layout __ND12067818__Project(B_Person(__in,__cfg_Local).__ST164640_Layout __PP12067814) := TRANSFORM
    SELF.Lex_I_D_ := __PP12067814.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP12067814.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF := __PP12067814;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12067813,__ND12067818__Project(LEFT)));
