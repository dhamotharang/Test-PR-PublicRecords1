...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE12354191 := __ENH_Person;
  SHARED __EE12359232 := __EE12354191(__T(__OP2(__EE12354191.UID,=,__CN(__PLexID_in))));
  SHARED __ST102690_Layout := RECORD
  ...
  END;
  SHARED __ST102690_Layout __ND12359237__Project(B_Person(__cfg_Local).__ST170352_Layout __PP12359233) := TRANSFORM
    SELF.Lex_I_D_ := __PP12359233.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP12359233.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Cnt_Ev_ := __PP12359233.P_L___Ver_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_List_Ev_ := __PP12359233.P_L___Ver_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Emrg_Dt_List_Ev_ := __PP12359233.P_L___Ver_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Last_Dt_List_Ev_ := __PP12359233.P_L___Ver_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Old_Dt_Ev_ := __PP12359233.P_L___Ver_Src_Old_Dt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_New_Dt_Ev_ := __PP12359233.P_L___Ver_Src_New_Dt_Ev_F_C_R_A_;
    SELF.P___Lex_I_D_Rstd_Only_Flag_ := __PP12359233.P___Lex_I_D_Rstd_Only_Flag_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Cnt_Ev_ := __PP12359233.P_L___Ver_Name_First_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_List_Ev_ := __PP12359233.P_L___Ver_Name_First_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_ := __PP12359233.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_ := __PP12359233.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Cnt_Ev_ := __PP12359233.P_L___Ver_Name_Last_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_List_Ev_ := __PP12359233.P_L___Ver_Name_Last_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_ := __PP12359233.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_ := __PP12359233.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Cnt_Ev_ := __PP12359233.P_L___Ver_S_S_N_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_List_Ev_ := __PP12359233.P_L___Ver_S_S_N_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_ := __PP12359233.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_ := __PP12359233.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF := __PP12359233;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12359232,__ND12359237__Project(LEFT)));
