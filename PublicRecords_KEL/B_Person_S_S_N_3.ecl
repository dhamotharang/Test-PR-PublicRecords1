...
EXPORT B_Person_S_S_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7973484 := __ENH_Person_S_S_N_4;
  EXPORT __ST332848_Layout := RECORD
  ...
  END;
  EXPORT __ST332840_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST332848_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST332840_Layout __ND7973489__Project(B_Person_S_S_N_4(__in,__cfg).__ST332797_Layout __PP7973485) := TRANSFORM
    __EE7973504 := __PP7973485.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7973504),__ST332848_Layout),__NL(__EE7973504));
    SELF := __PP7973485;
  END;
  EXPORT __ENH_Person_S_S_N_3 := PROJECT(__EE7973484,__ND7973489__Project(LEFT));
END;
