...
EXPORT B_Sele_T_I_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4940840 := __ENH_Sele_T_I_N_6;
  EXPORT __ST242638_Layout := RECORD
  ...
  EXPORT __ST242629_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242638_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242629_Layout __ND4940845__Project(B_Sele_T_I_N_6(__in,__cfg).__ST247294_Layout __PP4940841) := TRANSFORM
    __EE4940870 := __PP4940841.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4940870),__ST242638_Layout),__NL(__EE4940870));
    SELF := __PP4940841;
  END;
  EXPORT __ENH_Sele_T_I_N_5 := PROJECT(__EE4940840,__ND4940845__Project(LEFT));
END;
