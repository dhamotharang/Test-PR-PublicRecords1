...
EXPORT B_Sele_T_I_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4939977 := __ENH_Sele_T_I_N_6;
  ...
  END;
  EXPORT __ST242604_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242613_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242604_Layout __ND4939982__Project(B_Sele_T_I_N_6(__in,__cfg).__ST247269_Layout __PP4939978) := TRANSFORM
    __EE4940007 := __PP4939978.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4940007),__ST242613_Layout),__NL(__EE4940007));
    SELF := __PP4939978;
  END;
  EXPORT __ENH_Sele_T_I_N_5 := PROJECT(__EE4939977,__ND4939982__Project(LEFT));
END;
