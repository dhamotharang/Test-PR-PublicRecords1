...
EXPORT B_Sele_T_I_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5223953 := __ENH_Sele_T_I_N_6;
  EXPORT __ST251735_Layout := RECORD
  ...
  EXPORT __ST251726_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251735_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251726_Layout __ND5223958__Project(B_Sele_T_I_N_6(__in,__cfg).__ST256565_Layout __PP5223954) := TRANSFORM
    __EE5223983 := __PP5223954.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5223983),__ST251735_Layout),__NL(__EE5223983));
    SELF := __PP5223954;
  END;
  EXPORT __ENH_Sele_T_I_N_5 := PROJECT(__EE5223953,__ND5223958__Project(LEFT));
END;
