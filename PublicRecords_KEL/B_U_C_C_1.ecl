...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9007211 := __ENH_U_C_C_2;
  EXPORT __ST339755_Layout := RECORD
  ...
  END;
  EXPORT __ST339751_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST339755_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST339751_Layout __ND9007216__Project(B_U_C_C_2(__in,__cfg).__ST339578_Layout __PP9007212) := TRANSFORM
    __EE9007254 := __PP9007212.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9007254),__ST339755_Layout),__NL(__EE9007254));
    SELF := __PP9007212;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9007211,__ND9007216__Project(LEFT));
END;
