...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7954087 := __ENH_U_C_C_2;
  EXPORT __ST265552_Layout := RECORD
  ...
  END;
  EXPORT __ST265548_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST265552_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265548_Layout __ND7954092__Project(B_U_C_C_2(__in,__cfg).__ST265375_Layout __PP7954088) := TRANSFORM
    __EE7954130 := __PP7954088.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7954130),__ST265552_Layout),__NL(__EE7954130));
    SELF := __PP7954088;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE7954087,__ND7954092__Project(LEFT));
END;
