...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8548271 := __ENH_U_C_C_2;
  EXPORT __ST298482_Layout := RECORD
  ...
  END;
  EXPORT __ST298478_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST298482_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST298478_Layout __ND8548276__Project(B_U_C_C_2(__in,__cfg).__ST298305_Layout __PP8548272) := TRANSFORM
    __EE8548314 := __PP8548272.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8548314),__ST298482_Layout),__NL(__EE8548314));
    SELF := __PP8548272;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE8548271,__ND8548276__Project(LEFT));
END;
