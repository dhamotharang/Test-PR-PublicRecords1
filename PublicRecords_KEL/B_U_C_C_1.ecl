...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10291504 := __ENH_U_C_C_2;
  EXPORT __ST334403_Layout := RECORD
  ...
  END;
  EXPORT __ST334399_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST334403_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST334399_Layout __ND10291509__Project(B_U_C_C_2(__in,__cfg).__ST334226_Layout __PP10291505) := TRANSFORM
    __EE10291547 := __PP10291505.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE10291547),__ST334403_Layout),__NL(__EE10291547));
    SELF := __PP10291505;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE10291504,__ND10291509__Project(LEFT));
END;
