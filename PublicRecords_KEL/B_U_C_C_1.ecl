...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8444061 := __ENH_U_C_C_2;
  EXPORT __ST283389_Layout := RECORD
  ...
  END;
  EXPORT __ST283385_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST283389_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST283385_Layout __ND8444066__Project(B_U_C_C_2(__in,__cfg).__ST283212_Layout __PP8444062) := TRANSFORM
    __EE8444104 := __PP8444062.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8444104),__ST283389_Layout),__NL(__EE8444104));
    SELF := __PP8444062;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE8444061,__ND8444066__Project(LEFT));
END;
