...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8384401 := __ENH_U_C_C_2;
  ...
  END;
  EXPORT __ST273841_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273845_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273841_Layout __ND8384406__Project(B_U_C_C_2(__in,__cfg).__ST273668_Layout __PP8384402) := TRANSFORM
    __EE8384444 := __PP8384402.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8384444),__ST273845_Layout),__NL(__EE8384444));
    SELF := __PP8384402;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE8384401,__ND8384406__Project(LEFT));
END;
