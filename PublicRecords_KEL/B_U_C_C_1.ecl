...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7952515 := __ENH_U_C_C_2;
  EXPORT __ST271787_Layout := RECORD
  ...
  END;
  EXPORT __ST271783_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST271787_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST271783_Layout __ND7952520__Project(B_U_C_C_2(__in,__cfg).__ST271610_Layout __PP7952516) := TRANSFORM
    __EE7952558 := __PP7952516.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7952558),__ST271787_Layout),__NL(__EE7952558));
    SELF := __PP7952516;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE7952515,__ND7952520__Project(LEFT));
END;
