...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7954092 := __ENH_U_C_C_2;
  EXPORT __ST273188_Layout := RECORD
  ...
  END;
  EXPORT __ST273184_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273188_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273184_Layout __ND7954097__Project(B_U_C_C_2(__in,__cfg).__ST273011_Layout __PP7954093) := TRANSFORM
    __EE7954135 := __PP7954093.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7954135),__ST273188_Layout),__NL(__EE7954135));
    SELF := __PP7954093;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE7954092,__ND7954097__Project(LEFT));
END;
