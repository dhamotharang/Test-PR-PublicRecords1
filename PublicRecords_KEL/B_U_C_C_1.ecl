...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9324343 := __ENH_U_C_C_2;
  EXPORT __ST334994_Layout := RECORD
  ...
  END;
  EXPORT __ST334990_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST334994_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST334990_Layout __ND9324348__Project(B_U_C_C_2(__in,__cfg).__ST334817_Layout __PP9324344) := TRANSFORM
    __EE9324386 := __PP9324344.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9324386),__ST334994_Layout),__NL(__EE9324386));
    SELF := __PP9324344;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9324343,__ND9324348__Project(LEFT));
END;
