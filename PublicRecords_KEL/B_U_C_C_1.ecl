...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9719437 := __ENH_U_C_C_2;
  EXPORT __ST347402_Layout := RECORD
  ...
  END;
  EXPORT __ST347398_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST347402_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST347398_Layout __ND9719442__Project(B_U_C_C_2(__in,__cfg).__ST347225_Layout __PP9719438) := TRANSFORM
    __EE9719480 := __PP9719438.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9719480),__ST347402_Layout),__NL(__EE9719480));
    SELF := __PP9719438;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9719437,__ND9719442__Project(LEFT));
END;
