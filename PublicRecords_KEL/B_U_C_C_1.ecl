...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9493313 := __ENH_U_C_C_2;
  EXPORT __ST340885_Layout := RECORD
  ...
  END;
  EXPORT __ST340881_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST340885_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST340881_Layout __ND9493318__Project(B_U_C_C_2(__in,__cfg).__ST340708_Layout __PP9493314) := TRANSFORM
    __EE9493356 := __PP9493314.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9493356),__ST340885_Layout),__NL(__EE9493356));
    SELF := __PP9493314;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9493313,__ND9493318__Project(LEFT));
END;
