...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9556794 := __ENH_U_C_C_2;
  EXPORT __ST312824_Layout := RECORD
  ...
  END;
  EXPORT __ST312820_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST312824_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST312820_Layout __ND9556799__Project(B_U_C_C_2(__in,__cfg).__ST312647_Layout __PP9556795) := TRANSFORM
    __EE9556837 := __PP9556795.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9556837),__ST312824_Layout),__NL(__EE9556837));
    SELF := __PP9556795;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9556794,__ND9556799__Project(LEFT));
END;
