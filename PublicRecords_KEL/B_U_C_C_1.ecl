...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8109654 := __ENH_U_C_C_2;
  EXPORT __ST292912_Layout := RECORD
  ...
  END;
  EXPORT __ST292908_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST292912_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST292908_Layout __ND8109659__Project(B_U_C_C_2(__in,__cfg).__ST292735_Layout __PP8109655) := TRANSFORM
    __EE8109697 := __PP8109655.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8109697),__ST292912_Layout),__NL(__EE8109697));
    SELF := __PP8109655;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE8109654,__ND8109659__Project(LEFT));
END;
