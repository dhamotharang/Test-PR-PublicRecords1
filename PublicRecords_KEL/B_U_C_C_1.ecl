...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8067323 := __ENH_U_C_C_2;
  EXPORT __ST268243_Layout := RECORD
  ...
  END;
  EXPORT __ST268239_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST268243_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST268239_Layout __ND8067328__Project(B_U_C_C_2(__in,__cfg).__ST268066_Layout __PP8067324) := TRANSFORM
    __EE8067366 := __PP8067324.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE8067366),__ST268243_Layout),__NL(__EE8067366));
    SELF := __PP8067324;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE8067323,__ND8067328__Project(LEFT));
END;
