...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10852076 := __ENH_U_C_C_2;
  EXPORT __ST371600_Layout := RECORD
  ...
  END;
  EXPORT __ST371596_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST371600_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST371596_Layout __ND10852081__Project(B_U_C_C_2(__in,__cfg).__ST371423_Layout __PP10852077) := TRANSFORM
    __EE10852119 := __PP10852077.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE10852119),__ST371600_Layout),__NL(__EE10852119));
    SELF := __PP10852077;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE10852076,__ND10852081__Project(LEFT));
END;
