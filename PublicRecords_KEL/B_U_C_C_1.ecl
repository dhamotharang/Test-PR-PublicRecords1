...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9322757 := __ENH_U_C_C_2;
  EXPORT __ST307398_Layout := RECORD
  ...
  END;
  EXPORT __ST307394_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST307398_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST307394_Layout __ND9322762__Project(B_U_C_C_2(__in,__cfg).__ST307221_Layout __PP9322758) := TRANSFORM
    __EE9322800 := __PP9322758.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9322800),__ST307398_Layout),__NL(__EE9322800));
    SELF := __PP9322758;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9322757,__ND9322762__Project(LEFT));
END;
