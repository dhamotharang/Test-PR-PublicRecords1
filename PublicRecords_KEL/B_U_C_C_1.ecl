...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7947013 := __ENH_U_C_C_2;
  EXPORT __ST272433_Layout := RECORD
  ...
  EXPORT __ST272429_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST272433_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST272429_Layout __ND7947018__Project(B_U_C_C_2(__in,__cfg).__ST272256_Layout __PP7947014) := TRANSFORM
    __EE7947056 := __PP7947014.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE7947056),__ST272433_Layout),__NL(__EE7947056));
    SELF := __PP7947014;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE7947013,__ND7947018__Project(LEFT));
END;
