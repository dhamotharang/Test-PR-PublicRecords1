...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9608584 := __ENH_U_C_C_2;
  EXPORT __ST314576_Layout := RECORD
  ...
  END;
  EXPORT __ST314572_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST314576_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST314572_Layout __ND9608589__Project(B_U_C_C_2(__in,__cfg).__ST314399_Layout __PP9608585) := TRANSFORM
    __EE9608627 := __PP9608585.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9608627),__ST314576_Layout),__NL(__EE9608627));
    SELF := __PP9608585;
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE9608584,__ND9608589__Project(LEFT));
END;
