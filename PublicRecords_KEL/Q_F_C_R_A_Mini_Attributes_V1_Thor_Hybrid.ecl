...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE12858014 := __ENH_Person;
  SHARED __EE12859982 := __EE12858014(__T(__OP2(__EE12858014.UID,=,__CN(__PLexID_in))));
  SHARED __ST127477_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12859982,TRANSFORM(__ST127477_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
