...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11376078 := __ENH_Person;
  SHARED __EE11377944 := __EE11376078(__T(__OP2(__EE11376078.UID,=,__CN(__PLexID_in))));
  SHARED __ST126786_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11377944,TRANSFORM(__ST126786_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
