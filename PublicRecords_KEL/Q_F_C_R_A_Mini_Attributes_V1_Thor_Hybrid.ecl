...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11466426 := __ENH_Person;
  SHARED __EE11468292 := __EE11466426(__T(__OP2(__EE11466426.UID,=,__CN(__PLexID_in))));
  SHARED __ST127970_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11468292,TRANSFORM(__ST127970_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
