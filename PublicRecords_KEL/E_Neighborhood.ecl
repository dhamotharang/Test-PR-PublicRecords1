...
EXPORT E_Neighborhood(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping := 'fips_geolink(DEFAULT:UID),did(DEFAULT:Some_Person_:0),aveoccupantowned(DEFAULT:Ave_Occupant_Owned_:0),cntoccupantowned(DEFAULT:Cnt_Occupant_Owned_:0),avebuildingage(DEFAULT:Ave_Building_Age_:0),cntbuildingage(DEFAULT:Cnt_Building_Age_:0),avepurchaseamount(DEFAULT:Ave_Purchase_Amount_:0),cntpurchaseamount(DEFAULT:Cnt_Purchase_Amount_:0),avepurchaseage(DEFAULT:Ave_Purchase_Age_:0),cntpurchaseage(DEFAULT:Cnt_Purchase_Age_:0),avemortgageamount(DEFAULT:Ave_Mortgage_Amount_:0),cntmortgageamount(DEFAULT:Cnt_Mortgage_Amount_:0),avemortgageage(DEFAULT:Ave_Mortgage_Age_:0),cntmortgageage(DEFAULT:Cnt_Mortgage_Age_:0),aveassessedamount(DEFAULT:Ave_Assessed_Amount_:0),cntassessedamount(DEFAULT:Cnt_Assessed_Amount_:0),avebuildingarea(DEFAULT:Ave_Building_Area_:0),cntbuildingarea(DEFAULT:Cnt_Building_Area_:0),avepricepersf(DEFAULT:Ave_Price_Per_Sf_:0),cntpricepersf(DEFAULT:Cnt_Price_Per_Sf_:0),avenoofbuildingscount(DEFAULT:Ave_No_Of_Buildings_Count_:0),cntnoofbuildingscount(DEFAULT:Cnt_No_Of_Buildings_Count_:0),avenoofstoriescount(DEFAULT:Ave_No_Of_Stories_Count_:0),cntnoofstoriescount(DEFAULT:Cnt_No_Of_Stories_Count_:0),avenoofroomscount(DEFAULT:Ave_No_Of_Rooms_Count_:0),cntnoofroomscount(DEFAULT:Cnt_No_Of_Rooms_Count_:0),avenoofbedroomscount(DEFAULT:Ave_No_Of_Bedrooms_Count_:0),cntnoofbedroomscount(DEFAULT:Cnt_No_Of_Bedrooms_Count_:0),avenoofbathscount(DEFAULT:Ave_No_Of_Baths_Count_:0),cntnoofbathscount(DEFAULT:Cnt_No_Of_Baths_Count_:0),avenoofpartialbathscount(DEFAULT:Ave_No_Of_Partial_Baths_Count_:0),cntnoofpartialbathscount(DEFAULT:Cnt_No_Of_Partial_Baths_Count_:0),aveparkingnoofcars(DEFAULT:Ave_Parking_No_Of_Cars_:0),cntparkingnoofcars(DEFAULT:Cnt_Parking_No_Of_Cars_:0),totalpropertycount(DEFAULT:Total_Property_Count_:0),neighborhoodvacantproperties(DEFAULT:Neighborhood_Vacant_Properties_:0),neighborhoodbusinesscount(DEFAULT:Neighborhood_Business_Count_:0),neighborhoodsfdcount(DEFAULT:Neighborhood_Sfd_Count_:0),neighborhoodmfdcount(DEFAULT:Neighborhood_Mfd_Count_:0),neighborhoodcollegeaddrcount(DEFAULT:Neighborhood_Collegeaddr_Count_:0),neighborhoodseasonaladdrcount(DEFAULT:Neighborhood_Seasonaladdr_Count_:0),neighborhoodpropertycount(DEFAULT:Neighborhood_Property_Count_:0),foreclosuregeo12index(DEFAULT:Foreclosure_Geo12_Index_:0.0),foreclosurefipsindex(DEFAULT:Foreclosure_Fips_Index_:0.0),foreclosurepropertycount(DEFAULT:Foreclosure_Property_Count_:0),foreclosurecount(DEFAULT:Foreclosure_Count_:0),occupants(DEFAULT:Occupants_:0),occupants1year(DEFAULT:Occupants1_Year_:0),occupants2years(DEFAULT:Occupants2_Years_:0),occupants3years(DEFAULT:Occupants3_Years_:0),occupants4years(DEFAULT:Occupants4_Years_:0),occupants5years(DEFAULT:Occupants5_Years_:0),turnover1yearin(DEFAULT:Turnover1_Year_In_:0),turnover1yearout(DEFAULT:Turnover1_Year_Out_:0),turnover2yearsin(DEFAULT:Turnover2_Years_In_:0),turnover2yearsout(DEFAULT:Turnover2_Years_Out_:0),turnover3yearsin(DEFAULT:Turnover3_Years_In_:0),turnover3yearsout(DEFAULT:Turnover3_Years_Out_:0),turnover4yearsin(DEFAULT:Turnover4_Years_In_:0),turnover4yearsout(DEFAULT:Turnover4_Years_Out_:0),turnover5yearsin(DEFAULT:Turnover5_Years_In_:0),turnover5yearsout(DEFAULT:Turnover5_Years_Out_:0),crimes(DEFAULT:Crimes_:0),crimes1year(DEFAULT:Crimes1_Year_:0),crimes2years(DEFAULT:Crimes2_Years_:0),crimes3years(DEFAULT:Crimes3_Years_:0),crimes4years(DEFAULT:Crimes4_Years_:0),crimes5years(DEFAULT:Crimes5_Years_:0),foreclosures(DEFAULT:Foreclosures_:0),foreclosures1year(DEFAULT:Foreclosures1_Year_:0),foreclosures2years(DEFAULT:Foreclosures2_Years_:0),foreclosures3years(DEFAULT:Foreclosures3_Years_:0),foreclosures4years(DEFAULT:Foreclosures4_Years_:0),foreclosures5years(DEFAULT:Foreclosures5_Years_:0),sexoffenders(DEFAULT:Sex_Offenders_:0),sexoffenders1year(DEFAULT:Sex_Offenders1_Year_:0),sexoffenders2years(DEFAULT:Sex_Offenders2_Years_:0),sexoffenders3years(DEFAULT:Sex_Offenders3_Years_:0),sexoffenders4years(DEFAULT:Sex_Offenders4_Years_:0),sexoffenders5years(DEFAULT:Sex_Offenders5_Years_:0),historydate(DEFAULT:History_Date_:DATE),medianvaluation(DEFAULT:Median_Valuation_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH)';
  ...
  Layout Neighborhood__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.History_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),History_Date_,Median_Valuation_},History_Date_,Median_Valuation_),History_Layout)(__NN(History_Date_) OR __NN(Median_Valuation_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Neighborhood','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    ...
    {'Neighborhood','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d0(Date_Vendor_First_Reported_=0)),COUNT(__d0(Date_Vendor_First_Reported_!=0))},
    {'Neighborhood','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d0(Date_Vendor_Last_Reported_=0)),COUNT(__d0(Date_Vendor_Last_Reported_!=0))}]
