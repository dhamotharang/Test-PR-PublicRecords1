...
EXPORT E_Input_B_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT B___Inp_Lex_I_D_Ult__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Lex_I_D_Ult_);
  EXPORT B___Inp_Lex_I_D_Org__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Lex_I_D_Org_);
  EXPORT B___Inp_Lex_I_D_Legal__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Lex_I_D_Legal_);
  EXPORT B___Inp_Lex_I_D_Site__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Lex_I_D_Site_);
  EXPORT B___Inp_Lex_I_D_Loc__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Lex_I_D_Loc_);
  EXPORT B___Inp_Name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Name_);
  EXPORT B___Inp_Alt_Name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Alt_Name_);
  EXPORT B___Inp_Addr_Line1__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Addr_Line1_);
  EXPORT B___Inp_Addr_City__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Addr_City_);
  EXPORT B___Inp_Addr_State__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Addr_State_);
  EXPORT B___Inp_Addr_Zip__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Addr_Zip_);
  EXPORT B___Inp_Phone__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Phone_);
  EXPORT Business_T_I_N__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,Business_T_I_N_);
  EXPORT B___Inp_I_P_Addr__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_I_P_Addr_);
  EXPORT B___Inp_U_R_L__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_U_R_L_);
  EXPORT B___Inp_Email__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Email_);
  EXPORT B___Inp_S_I_C_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_S_I_C_Code_);
  EXPORT B___Inp_N_A_I_C_S_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_N_A_I_C_S_Code_);
  EXPORT B___Inp_T_I_N__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_T_I_N_);
  EXPORT B___Inp_Arch_Dt__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Arch_Dt_);
  EXPORT B___Lex_I_D_Ult__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Ult_);
  EXPORT B___Lex_I_D_Org__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Org_);
  EXPORT B___Lex_I_D_Legal__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Legal_);
  EXPORT B___Lex_I_D_Site__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Site_);
  EXPORT B___Lex_I_D_Loc__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Loc_);
  EXPORT B___Lex_I_D_Legal_Score__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Legal_Score_);
  EXPORT B___Lex_I_D_Legal_Wgt__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Lex_I_D_Legal_Wgt_);
  EXPORT B___Inp_Cln_Name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Name_);
  EXPORT B___Inp_Cln_Alt_Name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Alt_Name_);
  EXPORT B___Inp_Cln_Addr_Prim_Rng__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Prim_Rng_);
  EXPORT B___Inp_Cln_Addr_Pre_Dir__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Pre_Dir_);
  EXPORT B___Inp_Cln_Addr_Prim_Name__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Prim_Name_);
  EXPORT B___Inp_Cln_Addr_Sffx__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Sffx_);
  EXPORT B___Inp_Cln_Addr_Post_Dir__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Post_Dir_);
  EXPORT B___Inp_Cln_Addr_Unit_Desig__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Unit_Desig_);
  EXPORT B___Inp_Cln_Addr_Sec_Rng__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Sec_Rng_);
  EXPORT B___Inp_Cln_Addr_City__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_City_);
  EXPORT B___Inp_Cln_Addr_State__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_State_);
  EXPORT B___Inp_Cln_Addr_Zip5__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Zip5_);
  EXPORT B___Inp_Cln_Addr_Zip4__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Zip4_);
  EXPORT B___Inp_Cln_Addr_Lat__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Lat_);
  EXPORT B___Inp_Cln_Addr_Lng__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Lng_);
  EXPORT B___Inp_Cln_Addr_Cnty__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Cnty_);
  EXPORT B___Inp_Cln_Addr_Geo__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Geo_);
  EXPORT B___Inp_Cln_Addr_Type__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Type_);
  EXPORT B___Inp_Cln_Addr_Status__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Addr_Status_);
  EXPORT B___Inp_Cln_Phone__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Phone_);
  EXPORT B___Inp_Cln_Email__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Email_);
  EXPORT B___Inp_Cln_T_I_N__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_T_I_N_);
  EXPORT B___Inp_Cln_Arch_Dt__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,B___Inp_Cln_Arch_Dt_);
