...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6433293 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST234209_Layout := RECORD
  ...
  END;
  EXPORT __ST234171_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST234209_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234171_Layout __ND6433298__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST245108_Layout __PP6433294) := TRANSFORM
    __EE6433347 := __PP6433294.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6433347),__ST234209_Layout),__NL(__EE6433347));
    SELF := __PP6433294;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6433293,__ND6433298__Project(LEFT));
END;
