...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6532082 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST231459_Layout := RECORD
  ...
  END;
  EXPORT __ST231421_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST231459_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231421_Layout __ND6532087__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST242404_Layout __PP6532083) := TRANSFORM
    __EE6532136 := __PP6532083.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6532136),__ST231459_Layout),__NL(__EE6532136));
    SELF := __PP6532083;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6532082,__ND6532087__Project(LEFT));
END;
