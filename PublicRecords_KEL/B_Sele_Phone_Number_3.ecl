...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6064016 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST225668_Layout := RECORD
  ...
  END;
  EXPORT __ST225630_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST225668_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225630_Layout __ND6064021__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST236294_Layout __PP6064017) := TRANSFORM
    __EE6064070 := __PP6064017.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6064070),__ST225668_Layout),__NL(__EE6064070));
    SELF := __PP6064017;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6064016,__ND6064021__Project(LEFT));
END;
