...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6422766 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST233854_Layout := RECORD
  ...
  END;
  EXPORT __ST233816_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST233854_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST233816_Layout __ND6422771__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST244732_Layout __PP6422767) := TRANSFORM
    __EE6422820 := __PP6422767.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6422820),__ST233854_Layout),__NL(__EE6422820));
    SELF := __PP6422767;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6422766,__ND6422771__Project(LEFT));
END;
