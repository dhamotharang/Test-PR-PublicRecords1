...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6064021 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST225673_Layout := RECORD
  ...
  END;
  EXPORT __ST225635_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST225673_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225635_Layout __ND6064026__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST236299_Layout __PP6064022) := TRANSFORM
    __EE6064075 := __PP6064022.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6064075),__ST225673_Layout),__NL(__EE6064075));
    SELF := __PP6064022;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6064021,__ND6064026__Project(LEFT));
END;
