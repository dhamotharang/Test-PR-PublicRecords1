...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7982954 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST261621_Layout := RECORD
  ...
  END;
  EXPORT __ST261583_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST261621_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST261583_Layout __ND7982959__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST273394_Layout __PP7982955) := TRANSFORM
    __EE7983008 := __PP7982955.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7983008),__ST261621_Layout),__NL(__EE7983008));
    SELF := __PP7982955;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE7982954,__ND7982959__Project(LEFT));
END;
