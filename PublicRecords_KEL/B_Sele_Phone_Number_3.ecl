...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6969770 := __ENH_Sele_Phone_Number_4;
  ...
  END;
  EXPORT __ST247080_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST247118_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247080_Layout __ND6969775__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST258289_Layout __PP6969771) := TRANSFORM
    __EE6969824 := __PP6969771.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6969824),__ST247118_Layout),__NL(__EE6969824));
    SELF := __PP6969771;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6969770,__ND6969775__Project(LEFT));
END;
