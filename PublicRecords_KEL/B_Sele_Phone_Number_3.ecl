...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6752210 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST237288_Layout := RECORD
  ...
  END;
  EXPORT __ST237250_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST237288_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST237250_Layout __ND6752215__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST248420_Layout __PP6752211) := TRANSFORM
    __EE6752264 := __PP6752211.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6752264),__ST237288_Layout),__NL(__EE6752264));
    SELF := __PP6752211;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6752210,__ND6752215__Project(LEFT));
END;
