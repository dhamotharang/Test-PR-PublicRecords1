...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6903366 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST245442_Layout := RECORD
  ...
  END;
  EXPORT __ST245404_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245442_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245404_Layout __ND6903371__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST256589_Layout __PP6903367) := TRANSFORM
    __EE6903420 := __PP6903367.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6903420),__ST245442_Layout),__NL(__EE6903420));
    SELF := __PP6903367;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6903366,__ND6903371__Project(LEFT));
END;
