...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6061733 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST224993_Layout := RECORD
  ...
  END;
  EXPORT __ST224955_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST224993_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224955_Layout __ND6061738__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST235619_Layout __PP6061734) := TRANSFORM
    __EE6061787 := __PP6061734.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6061787),__ST224993_Layout),__NL(__EE6061787));
    SELF := __PP6061734;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6061733,__ND6061738__Project(LEFT));
END;
