...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6559128 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST232861_Layout := RECORD
  ...
  END;
  EXPORT __ST232823_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST232861_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST232823_Layout __ND6559133__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST243807_Layout __PP6559129) := TRANSFORM
    __EE6559182 := __PP6559129.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6559182),__ST232861_Layout),__NL(__EE6559182));
    SELF := __PP6559129;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6559128,__ND6559133__Project(LEFT));
END;
