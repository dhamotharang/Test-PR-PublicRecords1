...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6060836 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST225185_Layout := RECORD
  ...
  END;
  EXPORT __ST225147_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST225185_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225147_Layout __ND6060841__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST235811_Layout __PP6060837) := TRANSFORM
    __EE6060890 := __PP6060837.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6060890),__ST225185_Layout),__NL(__EE6060890));
    SELF := __PP6060837;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6060836,__ND6060841__Project(LEFT));
END;
