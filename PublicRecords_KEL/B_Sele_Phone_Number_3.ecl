...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6396279 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST232277_Layout := RECORD
  ...
  EXPORT __ST232239_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST232277_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST232239_Layout __ND6396284__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST243079_Layout __PP6396280) := TRANSFORM
    __EE6396333 := __PP6396280.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6396333),__ST232277_Layout),__NL(__EE6396333));
    SELF := __PP6396280;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6396279,__ND6396284__Project(LEFT));
END;
