...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7553924 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST255117_Layout := RECORD
  ...
  END;
  EXPORT __ST255079_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST255117_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255079_Layout __ND7553929__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST266820_Layout __PP7553925) := TRANSFORM
    __EE7553978 := __PP7553925.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7553978),__ST255117_Layout),__NL(__EE7553978));
    SELF := __PP7553925;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE7553924,__ND7553929__Project(LEFT));
END;
