...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6844328 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST238865_Layout := RECORD
  ...
  END;
  EXPORT __ST238827_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST238865_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST238827_Layout __ND6844333__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST249978_Layout __PP6844329) := TRANSFORM
    __EE6844382 := __PP6844329.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6844382),__ST238865_Layout),__NL(__EE6844382));
    SELF := __PP6844329;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6844328,__ND6844333__Project(LEFT));
END;
