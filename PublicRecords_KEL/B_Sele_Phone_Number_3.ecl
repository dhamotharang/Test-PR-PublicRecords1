...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6433323 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST234239_Layout := RECORD
  ...
  END;
  EXPORT __ST234201_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST234239_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234201_Layout __ND6433328__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST245138_Layout __PP6433324) := TRANSFORM
    __EE6433377 := __PP6433324.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6433377),__ST234239_Layout),__NL(__EE6433377));
    SELF := __PP6433324;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6433323,__ND6433328__Project(LEFT));
END;
