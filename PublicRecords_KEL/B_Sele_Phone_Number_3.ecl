...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5776460 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST229506_Layout := RECORD
  ...
  END;
  EXPORT __ST229468_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST229506_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST229468_Layout __ND5776465__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST240091_Layout __PP5776461) := TRANSFORM
    __EE5776514 := __PP5776461.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5776514),__ST229506_Layout),__NL(__EE5776514));
    SELF := __PP5776461;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE5776460,__ND5776465__Project(LEFT));
END;
