...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1114870 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST147341_Layout := RECORD
  ...
  END;
  EXPORT __ST147303_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST147341_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Date_Vendor_First_Reported_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST147303_Layout __ND1115136__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST155897_Layout __PP1114683) := TRANSFORM
    __EE1114803 := __PP1114683.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE1114803,__ST147341_Layout);
    SELF := __PP1114683;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE1114870,__ND1115136__Project(LEFT));
END;
