...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6828647 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST244118_Layout := RECORD
  ...
  END;
  EXPORT __ST244080_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST244118_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST244080_Layout __ND6828652__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST255231_Layout __PP6828648) := TRANSFORM
    __EE6828701 := __PP6828648.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6828701),__ST244118_Layout),__NL(__EE6828701));
    SELF := __PP6828648;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE6828647,__ND6828652__Project(LEFT));
END;
