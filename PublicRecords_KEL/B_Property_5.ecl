...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE577707 := __E_Property;
  ...
  END;
  EXPORT __ST248382_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST248400_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248382_Layout __ND577945__Project(E_Property(__in,__cfg).Layout __PP577518) := TRANSFORM
    __EE577588 := __PP577518.Automated_Valuation_Model_;
    __ST248400_Layout __ND577865__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP577861) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP577861.Date_First_Seen_);
      SELF := __PP577861;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE577588,__ND577865__Project(LEFT));
    SELF := __PP577518;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE577707,__ND577945__Project(LEFT));
END;
