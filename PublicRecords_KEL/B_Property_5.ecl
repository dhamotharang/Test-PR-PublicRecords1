...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE447273 := __E_Property;
  EXPORT __ST187812_Layout := RECORD
  ...
  END;
  EXPORT __ST187794_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST187812_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST187794_Layout __ND447511__Project(E_Property(__in,__cfg).Layout __PP447084) := TRANSFORM
    __EE447154 := __PP447084.Automated_Valuation_Model_;
    __ST187812_Layout __ND447431__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP447427) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP447427.Date_First_Seen_);
      SELF := __PP447427;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE447154,__ND447431__Project(LEFT));
    SELF := __PP447084;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE447273,__ND447511__Project(LEFT));
END;
