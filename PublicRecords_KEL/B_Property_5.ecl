...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE606460 := __E_Property;
  EXPORT __ST264408_Layout := RECORD
  ...
  END;
  EXPORT __ST264390_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST264408_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264390_Layout __ND606698__Project(E_Property(__in,__cfg).Layout __PP606271) := TRANSFORM
    __EE606341 := __PP606271.Automated_Valuation_Model_;
    __ST264408_Layout __ND606618__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP606614) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP606614.Date_First_Seen_);
      SELF := __PP606614;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE606341,__ND606618__Project(LEFT));
    SELF := __PP606271;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE606460,__ND606698__Project(LEFT));
END;
