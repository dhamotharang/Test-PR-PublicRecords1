...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE508040 := __E_Property;
  EXPORT __ST241349_Layout := RECORD
  ...
  END;
  EXPORT __ST241331_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST241349_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST241331_Layout __ND508278__Project(E_Property(__in,__cfg).Layout __PP507851) := TRANSFORM
    __EE507921 := __PP507851.Automated_Valuation_Model_;
    __ST241349_Layout __ND508198__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP508194) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP508194.Date_First_Seen_);
      SELF := __PP508194;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE507921,__ND508198__Project(LEFT));
    SELF := __PP507851;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE508040,__ND508278__Project(LEFT));
END;
