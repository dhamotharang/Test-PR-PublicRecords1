...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE516115 := __E_Property;
  EXPORT __ST245843_Layout := RECORD
  ...
  END;
  EXPORT __ST245825_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST245843_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245825_Layout __ND516353__Project(E_Property(__in,__cfg).Layout __PP515926) := TRANSFORM
    __EE515996 := __PP515926.Automated_Valuation_Model_;
    __ST245843_Layout __ND516273__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP516269) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP516269.Date_First_Seen_);
      SELF := __PP516269;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE515996,__ND516273__Project(LEFT));
    SELF := __PP515926;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE516115,__ND516353__Project(LEFT));
END;
