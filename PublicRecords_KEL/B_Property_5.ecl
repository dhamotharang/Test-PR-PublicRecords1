...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE537409 := __E_Property;
  ...
  EXPORT __ST251078_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251096_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251078_Layout __ND537647__Project(E_Property(__in,__cfg).Layout __PP537220) := TRANSFORM
    __EE537290 := __PP537220.Automated_Valuation_Model_;
    __ST251096_Layout __ND537567__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP537563) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP537563.Date_First_Seen_);
      SELF := __PP537563;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE537290,__ND537567__Project(LEFT));
    SELF := __PP537220;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE537409,__ND537647__Project(LEFT));
END;
