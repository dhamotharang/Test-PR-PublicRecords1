...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE601214 := __E_Property;
  EXPORT __ST257597_Layout := RECORD
  ...
  END;
  EXPORT __ST257579_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST257597_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST257579_Layout __ND601452__Project(E_Property(__in,__cfg).Layout __PP601025) := TRANSFORM
    __EE601095 := __PP601025.Automated_Valuation_Model_;
    __ST257597_Layout __ND601372__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP601368) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP601368.Date_First_Seen_);
      SELF := __PP601368;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE601095,__ND601372__Project(LEFT));
    SELF := __PP601025;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE601214,__ND601452__Project(LEFT));
END;
