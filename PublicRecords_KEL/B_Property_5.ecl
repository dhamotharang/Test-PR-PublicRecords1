...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE644903 := __E_Property;
  EXPORT __ST279910_Layout := RECORD
  ...
  END;
  EXPORT __ST279892_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST279910_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST279892_Layout __ND645141__Project(E_Property(__in,__cfg).Layout __PP644714) := TRANSFORM
    __EE644784 := __PP644714.Automated_Valuation_Model_;
    __ST279910_Layout __ND645061__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP645057) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP645057.Date_First_Seen_);
      SELF := __PP645057;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE644784,__ND645061__Project(LEFT));
    SELF := __PP644714;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE644903,__ND645141__Project(LEFT));
END;
