...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE645632 := __E_Property;
  EXPORT __ST273233_Layout := RECORD
  ...
  END;
  EXPORT __ST273215_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST273233_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273215_Layout __ND645870__Project(E_Property(__in,__cfg).Layout __PP645443) := TRANSFORM
    __EE645513 := __PP645443.Automated_Valuation_Model_;
    __ST273233_Layout __ND645790__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP645786) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP645786.Date_First_Seen_);
      SELF := __PP645786;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE645513,__ND645790__Project(LEFT));
    SELF := __PP645443;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE645632,__ND645870__Project(LEFT));
END;
