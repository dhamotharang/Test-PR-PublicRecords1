...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE604578 := __E_Property;
  ...
  END;
  EXPORT __ST260465_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST260483_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260465_Layout __ND604816__Project(E_Property(__in,__cfg).Layout __PP604389) := TRANSFORM
    __EE604459 := __PP604389.Automated_Valuation_Model_;
    __ST260483_Layout __ND604736__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP604732) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP604732.Date_First_Seen_);
      SELF := __PP604732;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE604459,__ND604736__Project(LEFT));
    SELF := __PP604389;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE604578,__ND604816__Project(LEFT));
END;
