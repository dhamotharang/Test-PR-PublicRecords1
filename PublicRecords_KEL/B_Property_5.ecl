...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE604207 := __E_Property;
  ...
  END;
  EXPORT __ST262761_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST262779_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST262761_Layout __ND604445__Project(E_Property(__in,__cfg).Layout __PP604018) := TRANSFORM
    __EE604088 := __PP604018.Automated_Valuation_Model_;
    __ST262779_Layout __ND604365__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP604361) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP604361.Date_First_Seen_);
      SELF := __PP604361;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE604088,__ND604365__Project(LEFT));
    SELF := __PP604018;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE604207,__ND604445__Project(LEFT));
END;
