...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE579348 := __E_Property;
  EXPORT __ST249807_Layout := RECORD
  ...
  END;
  EXPORT __ST249789_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST249807_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249789_Layout __ND579586__Project(E_Property(__in,__cfg).Layout __PP579159) := TRANSFORM
    __EE579229 := __PP579159.Automated_Valuation_Model_;
    __ST249807_Layout __ND579506__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP579502) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP579502.Date_First_Seen_);
      SELF := __PP579502;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE579229,__ND579506__Project(LEFT));
    SELF := __PP579159;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE579348,__ND579586__Project(LEFT));
END;
