...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE530751 := __E_Property;
  EXPORT __ST249038_Layout := RECORD
  ...
  END;
  EXPORT __ST249020_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST249038_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249020_Layout __ND530989__Project(E_Property(__in,__cfg).Layout __PP530562) := TRANSFORM
    __EE530632 := __PP530562.Automated_Valuation_Model_;
    __ST249038_Layout __ND530909__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP530905) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP530905.Date_First_Seen_);
      SELF := __PP530905;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE530632,__ND530909__Project(LEFT));
    SELF := __PP530562;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE530751,__ND530989__Project(LEFT));
END;
