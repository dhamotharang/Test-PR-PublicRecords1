...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE600017 := __E_Property;
  EXPORT __ST261401_Layout := RECORD
  ...
  END;
  EXPORT __ST261383_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST261401_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST261383_Layout __ND600255__Project(E_Property(__in,__cfg).Layout __PP599828) := TRANSFORM
    __EE599898 := __PP599828.Automated_Valuation_Model_;
    __ST261401_Layout __ND600175__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP600171) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP600171.Date_First_Seen_);
      SELF := __PP600171;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE599898,__ND600175__Project(LEFT));
    SELF := __PP599828;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE600017,__ND600255__Project(LEFT));
END;
