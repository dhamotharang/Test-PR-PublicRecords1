...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE508726 := __E_Property;
  EXPORT __ST242029_Layout := RECORD
  ...
  END;
  EXPORT __ST242011_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST242029_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242011_Layout __ND508964__Project(E_Property(__in,__cfg).Layout __PP508537) := TRANSFORM
    __EE508607 := __PP508537.Automated_Valuation_Model_;
    __ST242029_Layout __ND508884__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP508880) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP508880.Date_First_Seen_);
      SELF := __PP508880;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE508607,__ND508884__Project(LEFT));
    SELF := __PP508537;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE508726,__ND508964__Project(LEFT));
END;
