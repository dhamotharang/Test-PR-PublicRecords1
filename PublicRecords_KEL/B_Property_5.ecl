...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE508245 := __E_Property;
  EXPORT __ST241507_Layout := RECORD
  ...
  END;
  EXPORT __ST241489_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST241507_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST241489_Layout __ND508483__Project(E_Property(__in,__cfg).Layout __PP508056) := TRANSFORM
    __EE508126 := __PP508056.Automated_Valuation_Model_;
    __ST241507_Layout __ND508403__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP508399) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP508399.Date_First_Seen_);
      SELF := __PP508399;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE508126,__ND508403__Project(LEFT));
    SELF := __PP508056;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE508245,__ND508483__Project(LEFT));
END;
