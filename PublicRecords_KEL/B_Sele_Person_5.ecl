...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5223570 := __ENH_Sele_Person_6;
  EXPORT __ST251591_Layout := RECORD
  ...
  END;
  SHARED __ST251591_Layout __ND5223693__Project(B_Sele_Person_6(__in,__cfg).__ST256431_Layout __PP5223571) := TRANSFORM
    __CC58949 := 730;
    SELF.Two_Years_ := __OP2(__PP5223571.Age_In_Days_,<=,__CN(__CC58949));
    SELF := __PP5223571;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5223570,__ND5223693__Project(LEFT));
END;
