...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4937486 := __ENH_Sele_Person_6;
  ...
  END;
  SHARED __ST242006_Layout __ND4937609__Project(B_Sele_Person_6(__in,__cfg).__ST246672_Layout __PP4937487) := TRANSFORM
    __CC56501 := 730;
    SELF.Two_Years_ := __OP2(__PP4937487.Age_In_Days_,<=,__CN(__CC56501));
    SELF := __PP4937487;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE4937486,__ND4937609__Project(LEFT));
END;
