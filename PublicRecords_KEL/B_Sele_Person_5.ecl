...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5593567 := __ENH_Sele_Person_6;
  EXPORT __ST261866_Layout := RECORD
  ...
  END;
  SHARED __ST261866_Layout __ND5593690__Project(B_Sele_Person_6(__in,__cfg).__ST266809_Layout __PP5593568) := TRANSFORM
    __CC59228 := 730;
    SELF.Two_Years_ := __OP2(__PP5593568.Age_In_Days_,<=,__CN(__CC59228));
    SELF := __PP5593568;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5593567,__ND5593690__Project(LEFT));
END;
