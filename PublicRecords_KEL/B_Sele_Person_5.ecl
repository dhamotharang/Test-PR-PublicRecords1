...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5223540 := __ENH_Sele_Person_6;
  EXPORT __ST251561_Layout := RECORD
  ...
  END;
  SHARED __ST251561_Layout __ND5223663__Project(B_Sele_Person_6(__in,__cfg).__ST256401_Layout __PP5223541) := TRANSFORM
    __CC58919 := 730;
    SELF.Two_Years_ := __OP2(__PP5223541.Age_In_Days_,<=,__CN(__CC58919));
    SELF := __PP5223541;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5223540,__ND5223663__Project(LEFT));
END;
