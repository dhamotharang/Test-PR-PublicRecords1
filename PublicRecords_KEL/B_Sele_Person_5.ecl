...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5397004 := __ENH_Sele_Person_6;
  EXPORT __ST248865_Layout := RECORD
  ...
  END;
  SHARED __ST248865_Layout __ND5397127__Project(B_Sele_Person_6(__in,__cfg).__ST253685_Layout __PP5397005) := TRANSFORM
    __CC56823 := 730;
    SELF.Two_Years_ := __OP2(__PP5397005.Age_In_Days_,<=,__CN(__CC56823));
    SELF := __PP5397005;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5397004,__ND5397127__Project(LEFT));
END;
