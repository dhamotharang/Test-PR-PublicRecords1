...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5712753 := __ENH_Sele_Person_6;
  EXPORT __ST264864_Layout := RECORD
  ...
  END;
  SHARED __ST264864_Layout __ND5712876__Project(B_Sele_Person_6(__in,__cfg).__ST269822_Layout __PP5712754) := TRANSFORM
    __CC59611 := 730;
    SELF.Two_Years_ := __OP2(__PP5712754.Age_In_Days_,<=,__CN(__CC59611));
    SELF := __PP5712754;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5712753,__ND5712876__Project(LEFT));
END;
