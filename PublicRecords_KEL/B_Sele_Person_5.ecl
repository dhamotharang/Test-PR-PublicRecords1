...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5609248 := __ENH_Sele_Person_6;
  EXPORT __ST256613_Layout := RECORD
  ...
  END;
  SHARED __ST256613_Layout __ND5609371__Project(B_Sele_Person_6(__in,__cfg).__ST261556_Layout __PP5609249) := TRANSFORM
    __CC58986 := 730;
    SELF.Two_Years_ := __OP2(__PP5609249.Age_In_Days_,<=,__CN(__CC58986));
    SELF := __PP5609249;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5609248,__ND5609371__Project(LEFT));
END;
