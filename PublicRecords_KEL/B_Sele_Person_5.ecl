...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5216189 := __ENH_Sele_Person_6;
  ...
  END;
  SHARED __ST251173_Layout __ND5216312__Project(B_Sele_Person_6(__in,__cfg).__ST256013_Layout __PP5216190) := TRANSFORM
    __CC58813 := 730;
    SELF.Two_Years_ := __OP2(__PP5216190.Age_In_Days_,<=,__CN(__CC58813));
    SELF := __PP5216190;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE5216189,__ND5216312__Project(LEFT));
END;
