...
EXPORT B_Bankruptcy_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE14143 := __E_Bankruptcy;
  EXPORT __ST13669_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST13669_Layout __ND14759__Project(E_Bankruptcy(__in,__cfg).Layout __PP13831) := TRANSFORM
    ...
    SELF := __PP13831;
  END;
  EXPORT __ENH_Bankruptcy_5 := PROJECT(__EE14143,__ND14759__Project(LEFT));
END;
