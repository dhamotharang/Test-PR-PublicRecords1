...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8539850 := __ENH_Sele_Person_2;
  EXPORT __ST199525_Layout := RECORD
  ...
  END;
  SHARED __ST199525_Layout __ND8539999__Project(B_Sele_Person_2(__in,__cfg).__ST218099_Layout __PP8539851) := TRANSFORM
    __CC13684 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP8539851.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP8539851.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF := __PP8539851;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE8539850,__ND8539999__Project(LEFT));
END;
