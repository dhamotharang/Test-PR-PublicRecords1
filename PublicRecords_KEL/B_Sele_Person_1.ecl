...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10282957 := __ENH_Sele_Person_2;
  EXPORT __ST218783_Layout := RECORD
  ...
  END;
  SHARED __ST218783_Layout __ND10283106__Project(B_Sele_Person_2(__in,__cfg).__ST239129_Layout __PP10282958) := TRANSFORM
    __CC13894 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP10282958.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP10282958.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13894)));
    SELF := __PP10282958;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE10282957,__ND10283106__Project(LEFT));
END;
