...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7941565 := __ENH_Sele_Person_2;
  EXPORT __ST192335_Layout := RECORD
  ...
  END;
  SHARED __ST192335_Layout __ND7941714__Project(B_Sele_Person_2(__in,__cfg).__ST210552_Layout __PP7941566) := TRANSFORM
    __CC13655 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP7941566.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP7941566.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13655)));
    SELF := __PP7941566;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE7941565,__ND7941714__Project(LEFT));
END;
