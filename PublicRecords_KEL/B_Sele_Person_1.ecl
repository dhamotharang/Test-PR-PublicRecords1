...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9315796 := __ENH_Sele_Person_2;
  EXPORT __ST203238_Layout := RECORD
  ...
  END;
  SHARED __ST203238_Layout __ND9315945__Project(B_Sele_Person_2(__in,__cfg).__ST222143_Layout __PP9315797) := TRANSFORM
    __CC13924 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP9315797.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP9315797.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13924)));
    SELF := __PP9315797;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE9315796,__ND9315945__Project(LEFT));
END;
