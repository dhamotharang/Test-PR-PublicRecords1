...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8375980 := __ENH_Sele_Person_2;
  EXPORT __ST199067_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Sele_Person_3(__in,__cfg).__ST1181385_Layout) Relatives_;
  ...
  END;
  SHARED __ST199067_Layout __ND8376129__Project(B_Sele_Person_2(__in,__cfg).__ST217592_Layout __PP8375981) := TRANSFORM
    __CC13706 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP8375981.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP8375981.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13706)));
    SELF := __PP8375981;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE8375980,__ND8376129__Project(LEFT));
END;
