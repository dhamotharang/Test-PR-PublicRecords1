...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8058902 := __ENH_Sele_Person_2;
  ...
  END;
  SHARED __ST193480_Layout __ND8059051__Project(B_Sele_Person_2(__in,__cfg).__ST211731_Layout __PP8058903) := TRANSFORM
    __CC13668 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP8058903.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP8058903.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13668)));
    SELF := __PP8058903;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE8058902,__ND8059051__Project(LEFT));
END;
