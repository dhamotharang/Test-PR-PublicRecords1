...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7945666 := __ENH_Sele_Person_2;
  EXPORT __ST192995_Layout := RECORD
  ...
  END;
  SHARED __ST192995_Layout __ND7945815__Project(B_Sele_Person_2(__in,__cfg).__ST211227_Layout __PP7945667) := TRANSFORM
    __CC13675 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP7945667.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP7945667.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13675)));
    SELF := __PP7945667;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE7945666,__ND7945815__Project(LEFT));
END;
