...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5497609 := __ENH_Sele_Person_2;
  ...
  END;
  SHARED __ST147439_Layout __ND5497723__Project(B_Sele_Person_2(__in,__cfg).__ST162033_Layout __PP5497610) := TRANSFORM
    __CC11382 := '-99997';
    SELF.Assoc_Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP5497610.Assoc_Fs_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP5497610.Assoc_Fs_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC11382)));
    SELF := __PP5497610;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE5497609,__ND5497723__Project(LEFT));
END;
