...
ResultSet := 
				...
				XPATH('publicrecords_kel.MAS_Business_nonFCRA_ServiceResponse/Results/Result/Dataset[@name=\'MasterResults\']/Row'),
				RETRY(2), TIMEOUT(300),
				PARALLEL(threads), 
				onFail(myFail(LEFT)));
...
Passed_with_Extras := 
	JOIN(inDataRecs, Passed, LEFT.AccountNumber = RIGHT.B_InpAcct, 
