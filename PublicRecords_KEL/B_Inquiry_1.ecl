...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7636249 := __ENH_Inquiry_2;
  EXPORT __ST285330_Layout := RECORD
  ...
  END;
  EXPORT __ST285303_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST285330_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST285303_Layout __ND7636254__Project(B_Inquiry_2(__in,__cfg).__ST285071_Layout __PP7636250) := TRANSFORM
    __EE7636324 := __PP7636250.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE7636324),__ST285330_Layout),__NL(__EE7636324));
    SELF := __PP7636250;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE7636249,__ND7636254__Project(LEFT));
END;
