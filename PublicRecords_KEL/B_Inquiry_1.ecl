...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8796839 := __ENH_Inquiry_2;
  EXPORT __ST316419_Layout := RECORD
  ...
  END;
  EXPORT __ST316392_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST316419_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST316392_Layout __ND8796844__Project(B_Inquiry_2(__in,__cfg).__ST316159_Layout __PP8796840) := TRANSFORM
    __EE8796915 := __PP8796840.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE8796915),__ST316419_Layout),__NL(__EE8796915));
    SELF := __PP8796840;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE8796839,__ND8796844__Project(LEFT));
END;
