...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8039723 := __ENH_Inquiry_2;
  EXPORT __ST282637_Layout := RECORD
  ...
  END;
  EXPORT __ST282610_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST282637_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST282610_Layout __ND8039728__Project(B_Inquiry_2(__in,__cfg).__ST282378_Layout __PP8039724) := TRANSFORM
    __EE8039798 := __PP8039724.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE8039798),__ST282637_Layout),__NL(__EE8039798));
    SELF := __PP8039724;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE8039723,__ND8039728__Project(LEFT));
END;
