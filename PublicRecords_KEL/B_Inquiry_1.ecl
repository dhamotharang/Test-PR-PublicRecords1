...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9741580 := __ENH_Inquiry_2;
  EXPORT __ST335581_Layout := RECORD
  ...
  END;
  EXPORT __ST335554_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST335581_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST335554_Layout __ND9741585__Project(B_Inquiry_2(__in,__cfg).__ST335321_Layout __PP9741581) := TRANSFORM
    __EE9741656 := __PP9741581.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE9741656),__ST335581_Layout),__NL(__EE9741656));
    SELF := __PP9741581;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE9741580,__ND9741585__Project(LEFT));
END;
