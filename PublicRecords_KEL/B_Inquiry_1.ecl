...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7636244 := __ENH_Inquiry_2;
  EXPORT __ST266352_Layout := RECORD
  ...
  END;
  EXPORT __ST266325_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST266352_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266325_Layout __ND7636249__Project(B_Inquiry_2(__in,__cfg).__ST266093_Layout __PP7636245) := TRANSFORM
    __EE7636319 := __PP7636245.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE7636319),__ST266352_Layout),__NL(__EE7636319));
    SELF := __PP7636245;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE7636244,__ND7636249__Project(LEFT));
END;
