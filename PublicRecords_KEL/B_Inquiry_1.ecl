...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8613631 := __ENH_Inquiry_2;
  EXPORT __ST345356_Layout := RECORD
  ...
  END;
  EXPORT __ST345329_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST345356_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST345329_Layout __ND8613636__Project(B_Inquiry_2(__in,__cfg).__ST345098_Layout __PP8613632) := TRANSFORM
    __EE8613707 := __PP8613632.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE8613707),__ST345356_Layout),__NL(__EE8613707));
    SELF := __PP8613632;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE8613631,__ND8613636__Project(LEFT));
END;
