...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7632518 := __ENH_Inquiry_2;
  EXPORT __ST266793_Layout := RECORD
  ...
  EXPORT __ST266766_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST266793_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266766_Layout __ND7632523__Project(B_Inquiry_2(__in,__cfg).__ST266534_Layout __PP7632519) := TRANSFORM
    __EE7632593 := __PP7632519.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE7632593),__ST266793_Layout),__NL(__EE7632593));
    SELF := __PP7632519;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE7632518,__ND7632523__Project(LEFT));
END;
