...
EXPORT B_Bankruptcy_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE16193 := __ENH_Bankruptcy_3;
  EXPORT __ST11130_Layout := RECORD
  ...
  END;
  EXPORT __ST11123_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST11130_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST11123_Layout __ND16932__Project(B_Bankruptcy_3(__in,__cfg).__ST11499_Layout __PP15811) := TRANSFORM
    __EE15932 := __PP15811.Records_;
    __ST11130_Layout __ND16904__Project(B_Bankruptcy_3(__in,__cfg).__ST11506_Layout __PP16435) := TRANSFORM
      SELF.Filing_Age_In_Days_ := FN_Compile.FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP16435.Last_Seen_Record_Date_),__ECAST(KEL.typ.nkdate,__CN(__PP15811.Boca_Shell_History_Date_)));
      SELF.Is_Debtor_ := __OP2(__PP16435.Name_Type_,IN,__CN(['D']));
      SELF := __PP16435;
    END;
    SELF.Records_ := __PROJECT(__EE15932,__ND16904__Project(LEFT));
    SELF := __PP15811;
  END;
  EXPORT __ENH_Bankruptcy_2 := PROJECT(__EE16193,__ND16932__Project(LEFT));
END;
