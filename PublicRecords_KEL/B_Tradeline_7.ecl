...
EXPORT B_Tradeline_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5462236 := __ENH_Tradeline_8;
  EXPORT __ST270448_Layout := RECORD
  ...
  END;
  EXPORT __ST270441_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST270448_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST270441_Layout __ND5462488__Project(B_Tradeline_8(__in,__cfg).__ST273136_Layout __PP5462237) := TRANSFORM
    __EE5462270 := __PP5462237.Records_;
    __ST270448_Layout __ND5462463__Project(B_Tradeline_8(__in,__cfg).__ST273143_Layout __PP5462271) := TRANSFORM
      SELF.Is_Two_Year_Full_Record_ := __AND(__OP2(__PP5462271.Record_Date_,<,__PP5462237.Current_Date_First_Of_Month_),__OP2(__PP5462271.Record_Date_,>=,__PP5462237.Two_Year_Full_Date_));
      SELF.Other_Segment_ := __NOT(__OR(__OR(__OR(__PP5462271.Carrier_Segment_,__PP5462271.Fleet_Segment_),__PP5462271.Materials_Segment_),__PP5462271.Operations_Segment_));
      ...
      SELF.Record_Age_In_Days1_Y_ := IF(__T(__PP5462271.Is1_Y_Record_),__ECAST(KEL.typ.nint,FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP5462271.Record_Date_),__ECAST(KEL.typ.nkdate,__FN4(KEL.Routines.AdjustCalendar,__CC13327,__CN(-1),__CN(0),__CN(0))))),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
      SELF := __PP5462271;
    END;
    SELF.Records_ := __PROJECT(__EE5462270,__ND5462463__Project(LEFT));
    SELF := __PP5462237;
  END;
  EXPORT __ENH_Tradeline_7 := PROJECT(__EE5462236,__ND5462488__Project(LEFT));
END;
