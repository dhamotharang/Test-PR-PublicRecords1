...
EXPORT B_Tradeline_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4822135 := __ENH_Tradeline_8;
  EXPORT __ST249896_Layout := RECORD
  ...
  END;
  EXPORT __ST249889_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST249896_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249889_Layout __ND4822387__Project(B_Tradeline_8(__in,__cfg).__ST252290_Layout __PP4822136) := TRANSFORM
    __EE4822169 := __PP4822136.Records_;
    __ST249896_Layout __ND4822362__Project(B_Tradeline_8(__in,__cfg).__ST252297_Layout __PP4822170) := TRANSFORM
      SELF.Is_Two_Year_Full_Record_ := __AND(__OP2(__PP4822170.Record_Date_,<,__PP4822136.Current_Date_First_Of_Month_),__OP2(__PP4822170.Record_Date_,>=,__PP4822136.Two_Year_Full_Date_));
      SELF.Other_Segment_ := __NOT(__OR(__OR(__OR(__PP4822170.Carrier_Segment_,__PP4822170.Fleet_Segment_),__PP4822170.Materials_Segment_),__PP4822170.Operations_Segment_));
