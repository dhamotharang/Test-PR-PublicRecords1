...
EXPORT B_Tradeline_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4828099 := __ENH_Tradeline_8;
  EXPORT __ST249738_Layout := RECORD
  ...
  END;
  EXPORT __ST249731_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST249738_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249731_Layout __ND4828351__Project(B_Tradeline_8(__in,__cfg).__ST252132_Layout __PP4828100) := TRANSFORM
    __EE4828133 := __PP4828100.Records_;
    __ST249738_Layout __ND4828326__Project(B_Tradeline_8(__in,__cfg).__ST252139_Layout __PP4828134) := TRANSFORM
      SELF.Is_Two_Year_Full_Record_ := __AND(__OP2(__PP4828134.Record_Date_,<,__PP4828100.Current_Date_First_Of_Month_),__OP2(__PP4828134.Record_Date_,>=,__PP4828100.Two_Year_Full_Date_));
      SELF.Other_Segment_ := __NOT(__OR(__OR(__OR(__PP4828134.Carrier_Segment_,__PP4828134.Fleet_Segment_),__PP4828134.Materials_Segment_),__PP4828134.Operations_Segment_));
      ...
      SELF.Record_Age_In_Days1_Y_ := IF(__T(__PP4828134.Is1_Y_Record_),__ECAST(KEL.typ.nint,FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP4828134.Record_Date_),__ECAST(KEL.typ.nkdate,__FN4(KEL.Routines.AdjustCalendar,__CC13065,__CN(-1),__CN(0),__CN(0))))),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
      SELF := __PP4828134;
    END;
    SELF.Records_ := __PROJECT(__EE4828133,__ND4828326__Project(LEFT));
    SELF := __PP4828100;
  END;
  EXPORT __ENH_Tradeline_7 := PROJECT(__EE4828099,__ND4828351__Project(LEFT));
END;
