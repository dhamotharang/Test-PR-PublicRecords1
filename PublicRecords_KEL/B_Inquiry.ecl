...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11526443 := __ENH_Inquiry_1;
  EXPORT __ST173187_Layout := RECORD
  ...
  END;
  EXPORT __ST173160_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST173187_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173160_Layout __ND11526448__Project(B_Inquiry_1(__in,__cfg).__ST335554_Layout __PP11526444) := TRANSFORM
    __EE11526519 := __PP11526444.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE11526519),__ST173187_Layout),__NL(__EE11526519));
    SELF := __PP11526444;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE11526443,__ND11526448__Project(LEFT));
END;
