...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9151686 := __ENH_Inquiry_1;
  EXPORT __ST158552_Layout := RECORD
  ...
  EXPORT __ST158525_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST158552_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158525_Layout __ND9151691__Project(B_Inquiry_1(__in,__cfg).__ST278080_Layout __PP9151687) := TRANSFORM
    __EE9151761 := __PP9151687.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE9151761),__ST158552_Layout),__NL(__EE9151761));
    SELF := __PP9151687;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE9151686,__ND9151691__Project(LEFT));
END;
