...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE333171 := __E_Inquiry;
  EXPORT __ST27913_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST27913_Layout __ND333221__Project(E_Inquiry(__in,__cfg).Layout __PP333062) := TRANSFORM
    ...
    SELF := __PP333062;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE333171,__ND333221__Project(LEFT));
END;
