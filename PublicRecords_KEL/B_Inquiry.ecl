...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1464814 := __E_Inquiry;
  ...
  END;
  SHARED __ST71132_Layout __ND1464864__Project(E_Inquiry(__in,__cfg).Layout __PP1464705) := TRANSFORM
    ...
    SELF := __PP1464705;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE1464814,__ND1464864__Project(LEFT));
END;
