...
IMPORT KEL12 AS KEL;
IMPORT CFG_Compile,E_Inquiry,FN_Compile FROM $;
...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1523415 := __E_Inquiry;
  ...
  END;
  SHARED __ST76050_Layout __ND1523465__Project(E_Inquiry(__in,__cfg).Layout __PP1523306) := TRANSFORM
    ...
    SELF := __PP1523306;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE1523415,__ND1523465__Project(LEFT));
END;
