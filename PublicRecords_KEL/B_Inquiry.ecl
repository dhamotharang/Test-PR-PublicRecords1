...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10189576 := __ENH_Inquiry_1;
  EXPORT __ST165945_Layout := RECORD
  ...
  EXPORT __ST165918_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST165945_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST165918_Layout __ND10189581__Project(B_Inquiry_1(__in,__cfg).__ST345329_Layout __PP10189577) := TRANSFORM
    __EE10189652 := __PP10189577.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE10189652),__ST165945_Layout),__NL(__EE10189652));
    SELF := __PP10189577;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE10189576,__ND10189581__Project(LEFT));
END;
