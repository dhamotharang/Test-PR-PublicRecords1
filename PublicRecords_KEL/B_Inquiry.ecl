...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8601523 := __ENH_Inquiry_1;
  EXPORT __ST152707_Layout := RECORD
  ...
  END;
  EXPORT __ST152680_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST152707_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST152680_Layout __ND8601528__Project(B_Inquiry_1(__in,__cfg).__ST266325_Layout __PP8601524) := TRANSFORM
    __EE8601598 := __PP8601524.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE8601598),__ST152707_Layout),__NL(__EE8601598));
    SELF := __PP8601524;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE8601523,__ND8601528__Project(LEFT));
END;
