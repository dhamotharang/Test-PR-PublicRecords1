...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10304959 := __ENH_Inquiry_1;
  EXPORT __ST166784_Layout := RECORD
  ...
  END;
  EXPORT __ST166757_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST166784_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166757_Layout __ND10304964__Project(B_Inquiry_1(__in,__cfg).__ST331888_Layout __PP10304960) := TRANSFORM
    __EE10305035 := __PP10304960.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE10305035),__ST166784_Layout),__NL(__EE10305035));
    SELF := __PP10304960;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE10304959,__ND10304964__Project(LEFT));
END;
