...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9702758 := __ENH_Inquiry_1;
  EXPORT __ST161194_Layout := RECORD
  ...
  EXPORT __ST161167_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST161194_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161167_Layout __ND9702763__Project(B_Inquiry_1(__in,__cfg).__ST310030_Layout __PP9702759) := TRANSFORM
    __EE9702834 := __PP9702759.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE9702834),__ST161194_Layout),__NL(__EE9702834));
    SELF := __PP9702759;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE9702758,__ND9702763__Project(LEFT));
END;
