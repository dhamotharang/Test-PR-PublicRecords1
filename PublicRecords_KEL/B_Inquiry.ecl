...
EXPORT B_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9151656 := __ENH_Inquiry_1;
  EXPORT __ST158522_Layout := RECORD
  ...
  END;
  EXPORT __ST158495_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST158522_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158495_Layout __ND9151661__Project(B_Inquiry_1(__in,__cfg).__ST291861_Layout __PP9151657) := TRANSFORM
    __EE9151731 := __PP9151657.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE9151731),__ST158522_Layout),__NL(__EE9151731));
    SELF := __PP9151657;
  END;
  EXPORT __ENH_Inquiry := PROJECT(__EE9151656,__ND9151661__Project(LEFT));
END;
