...
EXPORT E_House_Hold_Phone(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault((UNSIGNED)hhid != 0 AND (UNSIGNED)phone != 0);
  ...
  EXPORT NullCounts := DATASET([
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','phone',COUNT(__d0(__NL(Phone_Number_))),COUNT(__d0(__NN(Phone_Number_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','hhid',COUNT(__d0(__NL(Household_))),COUNT(__d0(__NN(Household_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','PriorAreaCode',COUNT(__d0(__NL(Prior_Area_Code_))),COUNT(__d0(__NN(Prior_Area_Code_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','CurrentFlag',COUNT(__d0(__NL(Current_Flag_))),COUNT(__d0(__NN(Current_Flag_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','BusinessFlag',COUNT(__d0(__NL(Business_Flag_))),COUNT(__d0(__NN(Business_Flag_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','PublishCode',COUNT(__d0(__NL(Publish_Code_))),COUNT(__d0(__NN(Publish_Code_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','ListingType',COUNT(__d0(__NL(Listing_Type_))),COUNT(__d0(__NN(Listing_Type_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','IsActive',COUNT(__d0(__NL(Is_Active_))),COUNT(__d0(__NN(Is_Active_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','OmitIndicator',COUNT(__d0(__NL(Omit_Indicator_))),COUNT(__d0(__NN(Omit_Indicator_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','NoSolicitCode',COUNT(__d0(__NL(No_Solicit_Code_))),COUNT(__d0(__NN(No_Solicit_Code_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','RecordType',COUNT(__d0(__NL(Record_Type_))),COUNT(__d0(__NN(Record_Type_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','PhoneType',COUNT(__d0(__NL(Phone_Type_))),COUNT(__d0(__NN(Phone_Type_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','ValidationFlag',COUNT(__d0(__NL(Validation_Flag_))),COUNT(__d0(__NN(Validation_Flag_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','ValidationDate',COUNT(__d0(__NL(Validation_Date_))),COUNT(__d0(__NN(Validation_Date_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','ConfidenceScore',COUNT(__d0(__NL(Confidence_Score_))),COUNT(__d0(__NN(Confidence_Score_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','IverIndicator',COUNT(__d0(__NL(Iver_Indicator_))),COUNT(__d0(__NN(Iver_Indicator_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','SourceFile',COUNT(__d0(__NL(Source_File_))),COUNT(__d0(__NN(Source_File_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','OriginalSource',COUNT(__d0(__NL(Original_Source_))),COUNT(__d0(__NN(Original_Source_)))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'HouseHoldPhone','PublicRecords_KEL.Files.NonFCRA.Doxie__Key_Header_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
