...
EXPORT B_Sele_T_I_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6834343 := __ENH_Sele_T_I_N_4;
  ...
  END;
  EXPORT __ST240502_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST240502_Layout __ND6834348__Project(B_Sele_T_I_N_4(__in,__cfg).__ST251684_Layout __PP6834344) := TRANSFORM
    __EE6834373 := __PP6834344.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6834373),__ST240511_Layout),__NL(__EE6834373));
    SELF := __PP6834344;
  END;
  EXPORT __ENH_Sele_T_I_N_3 := PROJECT(__EE6834343,__ND6834348__Project(LEFT));
END;
