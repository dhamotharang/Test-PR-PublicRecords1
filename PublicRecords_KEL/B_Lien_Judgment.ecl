...
IMPORT KEL15 AS KEL;
IMPORT B_Lien_Judgment_1,B_Lien_Judgment_14,CFG_Compile,E_Lien_Judgment FROM PublicRecords_KEL;
...
EXPORT B_Lien_Judgment(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10949290 := __ENH_Lien_Judgment_1;
  EXPORT __ENH_Lien_Judgment := __EE10949290;
END;
