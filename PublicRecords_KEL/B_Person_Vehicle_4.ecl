...
EXPORT B_Person_Vehicle_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE279981 := __E_Person_Vehicle;
  EXPORT __ST106012_Layout := RECORD
  ...
  END;
  SHARED __ST106012_Layout __ND280210__Project(E_Person_Vehicle(__in,__cfg).Layout __PP279807) := TRANSFORM
    ...
    SELF := __PP279807;
  END;
  EXPORT __ENH_Person_Vehicle_4 := PROJECT(__EE279981,__ND280210__Project(LEFT));
END;
