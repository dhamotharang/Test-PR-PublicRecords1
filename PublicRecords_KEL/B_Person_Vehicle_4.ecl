...
IMPORT KEL12 AS KEL;
IMPORT CFG_Compile,E_Person,E_Person_Vehicle,E_Vehicle,FN_Compile FROM $;
...
EXPORT B_Person_Vehicle_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE293699 := __E_Person_Vehicle;
  EXPORT __ST112001_Layout := RECORD
  ...
  END;
  SHARED __ST112001_Layout __ND293928__Project(E_Person_Vehicle(__in,__cfg).Layout __PP293525) := TRANSFORM
    ...
    SELF := __PP293525;
  END;
  EXPORT __ENH_Person_Vehicle_4 := PROJECT(__EE293699,__ND293928__Project(LEFT));
END;
