...
EXPORT B_Criminal_Punishment(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE281313 := __E_Criminal_Punishment;
  EXPORT __ST24725_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST24725_Layout __ND281597__Project(E_Criminal_Punishment(__in,__cfg).Layout __PP281082) := TRANSFORM
    ...
    SELF := __PP281082;
  END;
  EXPORT __ENH_Criminal_Punishment := PROJECT(__EE281313,__ND281597__Project(LEFT));
END;
