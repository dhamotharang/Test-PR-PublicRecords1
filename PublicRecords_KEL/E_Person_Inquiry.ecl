...
EXPORT E_Person_Inquiry(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d0_KELfiltered := PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault((UNSIGNED)person_q.appended_adl <> 0);
  SHARED __d0_Transaction__Layout := RECORD
    RECORDOF(__d0_KELfiltered);
    KEL.typ.uid Transaction_;
  END;
  SHARED __d0_Missing_Transaction__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_KELfiltered,'search_info.transaction_id,search_info.sequence_number','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault');
  ...
  SHARED __d0 := __SourceFilter(KEL.FromFlat.Convert(__d0_Prefiltered,InLayout,__Mapping0,'PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault'));
  ...
  EXPORT __d1_KELfiltered := PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault((UNSIGNED)person_q.appended_adl <> 0);
  SHARED __d1_Transaction__Layout := RECORD
    RECORDOF(__d1_KELfiltered);
    KEL.typ.uid Transaction_;
  END;
  SHARED __d1_Missing_Transaction__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d1_KELfiltered,'search_info.transaction_id,search_info.sequence_number','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault');
  ...
  SHARED __d1 := __SourceFilter(KEL.FromFlat.Convert(__d1_Prefiltered,InLayout,__Mapping1,'PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault'));
  ...
  EXPORT NullCounts := DATASET([
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','person_q.appended_adl',COUNT(__d0(__NL(Subject_))),COUNT(__d0(__NN(Subject_)))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','Transaction',COUNT(__d0(__NL(Transaction_))),COUNT(__d0(__NN(Transaction_)))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','search_info.transaction_id',COUNT(__d0(__NL(Transaction_I_D_))),COUNT(__d0(__NN(Transaction_I_D_)))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','search_info.sequence_number',COUNT(__d0(__NL(Sequence_Number_))),COUNT(__d0(__NN(Sequence_Number_)))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','Src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'PersonInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_Did_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','person_q.appended_adl',COUNT(__d1(__NL(Subject_))),COUNT(__d1(__NN(Subject_)))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','Transaction',COUNT(__d1(__NL(Transaction_))),COUNT(__d1(__NN(Transaction_)))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','search_info.transaction_id',COUNT(__d1(__NL(Transaction_I_D_))),COUNT(__d1(__NN(Transaction_I_D_)))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','search_info.sequence_number',COUNT(__d1(__NL(Sequence_Number_))),COUNT(__d1(__NN(Sequence_Number_)))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','Src',COUNT(__d1(__NL(Source_))),COUNT(__d1(__NN(Source_)))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','Archive_Date',COUNT(__d1(Archive___Date_=0)),COUNT(__d1(Archive___Date_!=0))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','DateFirstSeen',COUNT(__d1(Date_First_Seen_=0)),COUNT(__d1(Date_First_Seen_!=0))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','DateLastSeen',COUNT(__d1(Date_Last_Seen_=0)),COUNT(__d1(Date_Last_Seen_!=0))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','HybridArchiveDate',COUNT(__d1(Hybrid_Archive_Date_=0)),COUNT(__d1(Hybrid_Archive_Date_!=0))},
    {'PersonInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_DID_Vault','VaultDateLastSeen',COUNT(__d1(Vault_Date_Last_Seen_=0)),COUNT(__d1(Vault_Date_Last_Seen_!=0))}]
