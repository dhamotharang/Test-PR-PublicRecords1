...
EXPORT E_S_S_N_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping := 'social(Social_:0),Location_(Location_:0),primaryrange(Primary_Range_:\'\'),predirectional(Predirectional_:\'\'),primaryname(Primary_Name_:\'\'),suffix(Suffix_:\'\'),postdirectional(Postdirectional_:\'\'),secondaryrange(Secondary_Range_:\'\'),zip5(Z_I_P5_:0),source(Source_:\'\'),datefirstseen(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH)';
  ...
  SHARED __Mapping0 := 'ssn(Social_:0),Location_(Location_:0),prim_range(Primary_Range_:\'\'),predir(Predirectional_:\'\'),prim_name(Primary_Name_:\'\'),suffix(Suffix_:\'\'),postdir(Postdirectional_:\'\'),sec_range(Secondary_Range_:\'\'),zip(Z_I_P5_:0),src(Source_:\'\'),dt_first_seen(Date_First_Seen_:EPOCH:Date_First_Seen_0Rule),dt_last_seen(Date_Last_Seen_:EPOCH:Date_Last_Seen_0Rule),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping1 := 'ssn(Social_:0),Location_(Location_:0),prim_range(Primary_Range_:\'\'),predir(Predirectional_:\'\'),prim_name(Primary_Name_:\'\'),suffix(Suffix_:\'\'),postdir(Postdirectional_:\'\'),sec_range(Secondary_Range_:\'\'),zip(Z_I_P5_:0),src(Source_:\'\'),dt_first_seen(Date_First_Seen_:EPOCH:Date_First_Seen_1Rule),dt_last_seen(Date_Last_Seen_:EPOCH:Date_Last_Seen_1Rule),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping2 := 'ssn(Social_:0),Location_(Location_:0),prim_range(Primary_Range_:\'\'),predir(Predirectional_:\'\'),prim_name(Primary_Name_:\'\'),addr_suffix(Suffix_:\'\'),postdir(Postdirectional_:\'\'),sec_range(Secondary_Range_:\'\'),zip5(Z_I_P5_:0),src(Source_:\'\'),earliest_offense_date(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'ssn(Social_:0),Location_(Location_:0),prim_range(Primary_Range_:\'\'),predir(Predirectional_:\'\'),prim_name(Primary_Name_:\'\'),addr_suffix(Suffix_:\'\'),postdir(Postdirectional_:\'\'),sec_range(Secondary_Range_:\'\'),zip(Z_I_P5_:0),date_first_seen(Date_First_Seen_:EPOCH),date_last_seen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'SSNAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addr_suffix',COUNT(__d2(__NL(Suffix_))),COUNT(__d2(__NN(Suffix_)))},
    ...
    {'SSNAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','zip5',COUNT(__d2(__NL(Z_I_P5_))),COUNT(__d2(__NN(Z_I_P5_)))},
    ...
    {'SSNAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addr_suffix',COUNT(__d3(__NL(Suffix_))),COUNT(__d3(__NN(Suffix_)))},
