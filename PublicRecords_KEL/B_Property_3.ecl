...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6745753 := __ENH_Property_4;
  EXPORT __ST236391_Layout := RECORD
  ...
  END;
  EXPORT __ST236373_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST236391_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236373_Layout __ND6745758__Project(B_Property_4(__in,__cfg).__ST247739_Layout __PP6745754) := TRANSFORM
    __EE6745798 := __PP6745754.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6745798),__ST236391_Layout),__NL(__EE6745798));
    SELF := __PP6745754;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6745753,__ND6745758__Project(LEFT));
END;
