...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6054463 := __ENH_Property_4;
  EXPORT __ST224300_Layout := RECORD
  ...
  END;
  EXPORT __ST224282_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST224300_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224282_Layout __ND6054468__Project(B_Property_4(__in,__cfg).__ST235142_Layout __PP6054464) := TRANSFORM
    __EE6054508 := __PP6054464.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6054508),__ST224300_Layout),__NL(__EE6054508));
    SELF := __PP6054464;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6054463,__ND6054468__Project(LEFT));
END;
