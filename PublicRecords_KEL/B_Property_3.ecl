...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6963243 := __ENH_Property_4;
  EXPORT __ST246221_Layout := RECORD
  ...
  END;
  EXPORT __ST246203_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST246221_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246203_Layout __ND6963248__Project(B_Property_4(__in,__cfg).__ST257608_Layout __PP6963244) := TRANSFORM
    __EE6963288 := __PP6963244.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6963288),__ST246221_Layout),__NL(__EE6963288));
    SELF := __PP6963244;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6963243,__ND6963248__Project(LEFT));
END;
