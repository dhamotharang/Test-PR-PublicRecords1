...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4011944 := __ENH_Property_4;
  EXPORT __ST172792_Layout := RECORD
  ...
  END;
  EXPORT __ST172774_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST172792_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172774_Layout __ND4011949__Project(B_Property_4(__in,__cfg).__ST182152_Layout __PP4011945) := TRANSFORM
    __EE4011988 := __PP4011945.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE4011988),__ST172792_Layout),__NL(__EE4011988));
    SELF := __PP4011945;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE4011944,__ND4011949__Project(LEFT));
END;
