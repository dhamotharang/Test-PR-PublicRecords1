...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4080524 := __ENH_Property_4;
  EXPORT __ST181540_Layout := RECORD
  ...
  END;
  EXPORT __ST181522_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST181540_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181522_Layout __ND4080529__Project(B_Property_4(__in,__cfg).__ST191019_Layout __PP4080525) := TRANSFORM
    __EE4080568 := __PP4080525.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE4080568),__ST181540_Layout),__NL(__EE4080568));
    SELF := __PP4080525;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE4080524,__ND4080529__Project(LEFT));
END;
