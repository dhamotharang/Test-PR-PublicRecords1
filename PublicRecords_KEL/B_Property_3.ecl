...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7547409 := __ENH_Property_4;
  EXPORT __ST254220_Layout := RECORD
  ...
  END;
  EXPORT __ST254202_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST254220_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254202_Layout __ND7547414__Project(B_Property_4(__in,__cfg).__ST266139_Layout __PP7547410) := TRANSFORM
    __EE7547454 := __PP7547410.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7547454),__ST254220_Layout),__NL(__EE7547454));
    SELF := __PP7547410;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE7547409,__ND7547414__Project(LEFT));
END;
