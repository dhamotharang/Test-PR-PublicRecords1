...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6958954 := __ENH_Property_4;
  EXPORT __ST246134_Layout := RECORD
  ...
  EXPORT __ST246116_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST246134_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246116_Layout __ND6958959__Project(B_Property_4(__in,__cfg).__ST257508_Layout __PP6958955) := TRANSFORM
    __EE6958999 := __PP6958955.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6958999),__ST246134_Layout),__NL(__EE6958999));
    SELF := __PP6958955;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6958954,__ND6958959__Project(LEFT));
END;
