...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4094047 := __ENH_Property_4;
  EXPORT __ST184170_Layout := RECORD
  ...
  EXPORT __ST184152_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST184170_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184152_Layout __ND4094052__Project(B_Property_4(__in,__cfg).__ST193684_Layout __PP4094048) := TRANSFORM
    __EE4094091 := __PP4094048.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE4094091),__ST184170_Layout),__NL(__EE4094091));
    SELF := __PP4094048;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE4094047,__ND4094052__Project(LEFT));
END;
