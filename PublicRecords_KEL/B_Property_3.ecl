...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6172410 := __ENH_Property_4;
  ...
  END;
  EXPORT __ST225296_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST225314_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225296_Layout __ND6172415__Project(B_Property_4(__in,__cfg).__ST236156_Layout __PP6172411) := TRANSFORM
    __EE6172455 := __PP6172411.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6172455),__ST225314_Layout),__NL(__EE6172455));
    SELF := __PP6172411;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6172410,__ND6172415__Project(LEFT));
END;
