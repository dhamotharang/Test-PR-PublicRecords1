...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6822132 := __ENH_Property_4;
  ...
  END;
  EXPORT __ST243215_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST243233_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243215_Layout __ND6822137__Project(B_Property_4(__in,__cfg).__ST254562_Layout __PP6822133) := TRANSFORM
    __EE6822177 := __PP6822133.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6822177),__ST243233_Layout),__NL(__EE6822177));
    SELF := __PP6822133;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6822132,__ND6822137__Project(LEFT));
END;
