...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6747339 := __ENH_Property_4;
  EXPORT __ST236361_Layout := RECORD
  ...
  END;
  EXPORT __ST236343_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST236361_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236343_Layout __ND6747344__Project(B_Property_4(__in,__cfg).__ST247709_Layout __PP6747340) := TRANSFORM
    __EE6747384 := __PP6747340.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6747384),__ST236361_Layout),__NL(__EE6747384));
    SELF := __PP6747340;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6747339,__ND6747344__Project(LEFT));
END;
