...
EXPORT B_Property_3(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED VIRTUAL TYPEOF(B_Property_4(__cfg).__ENH_Property_4) __ENH_Property_4 := B_Property_4(__cfg).__ENH_Property_4;
  SHARED __EE6527449 := __ENH_Property_4;
  EXPORT __ST231930_Layout := RECORD
  ...
  END;
  EXPORT __ST231912_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST231930_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231912_Layout __ND6527454__Project(B_Property_4(__cfg).__ST243104_Layout __PP6527450) := TRANSFORM
    __EE6527494 := __PP6527450.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6527494),__ST231930_Layout),__NL(__EE6527494));
    SELF := __PP6527450;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6527449,__ND6527454__Project(LEFT));
END;
