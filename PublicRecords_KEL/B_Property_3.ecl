...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7976175 := __ENH_Property_4;
  EXPORT __ST260724_Layout := RECORD
  ...
  END;
  EXPORT __ST260706_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST260724_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260706_Layout __ND7976180__Project(B_Property_4(__in,__cfg).__ST272713_Layout __PP7976176) := TRANSFORM
    __EE7976220 := __PP7976176.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7976220),__ST260724_Layout),__NL(__EE7976220));
    SELF := __PP7976176;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE7976175,__ND7976180__Project(LEFT));
END;
