...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6389812 := __ENH_Property_4;
  EXPORT __ST231392_Layout := RECORD
  ...
  END;
  EXPORT __ST231374_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST231392_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231374_Layout __ND6389817__Project(B_Property_4(__in,__cfg).__ST242410_Layout __PP6389813) := TRANSFORM
    __EE6389857 := __PP6389813.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6389857),__ST231392_Layout),__NL(__EE6389857));
    SELF := __PP6389813;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6389812,__ND6389817__Project(LEFT));
END;
