...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6426814 := __ENH_Property_4;
  ...
  END;
  EXPORT __ST233336_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST233354_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST233336_Layout __ND6426819__Project(B_Property_4(__in,__cfg).__ST244469_Layout __PP6426815) := TRANSFORM
    __EE6426859 := __PP6426815.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6426859),__ST233354_Layout),__NL(__EE6426859));
    SELF := __PP6426815;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6426814,__ND6426819__Project(LEFT));
END;
