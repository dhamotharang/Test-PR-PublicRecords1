...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6837813 := __ENH_Property_4;
  EXPORT __ST237980_Layout := RECORD
  ...
  END;
  EXPORT __ST237962_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST237980_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST237962_Layout __ND6837818__Project(B_Property_4(__in,__cfg).__ST249309_Layout __PP6837814) := TRANSFORM
    __EE6837858 := __PP6837814.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6837858),__ST237980_Layout),__NL(__EE6837858));
    SELF := __PP6837814;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6837813,__ND6837818__Project(LEFT));
END;
