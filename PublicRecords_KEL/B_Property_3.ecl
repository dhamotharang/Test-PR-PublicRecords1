...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6990761 := __ENH_Property_4;
  EXPORT __ST246155_Layout := RECORD
  ...
  EXPORT __ST246137_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST246155_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246137_Layout __ND6990766__Project(B_Property_4(__in,__cfg).__ST257529_Layout __PP6990762) := TRANSFORM
    __EE6990806 := __PP6990762.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6990806),__ST246155_Layout),__NL(__EE6990806));
    SELF := __PP6990762;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6990761,__ND6990766__Project(LEFT));
END;
