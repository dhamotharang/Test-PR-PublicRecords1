...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6807156 := __ENH_Property_4;
  EXPORT __ST239155_Layout := RECORD
  ...
  END;
  EXPORT __ST239137_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST239155_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST239137_Layout __ND6807161__Project(B_Property_4(__in,__cfg).__ST250522_Layout __PP6807157) := TRANSFORM
    __EE6807201 := __PP6807157.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6807201),__ST239155_Layout),__NL(__EE6807201));
    SELF := __PP6807157;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6807156,__ND6807161__Project(LEFT));
END;
