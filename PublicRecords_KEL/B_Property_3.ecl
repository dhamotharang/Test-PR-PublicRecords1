...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5770021 := __ENH_Property_4;
  EXPORT __ST228619_Layout := RECORD
  ...
  END;
  EXPORT __ST228601_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST228619_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST228601_Layout __ND5770026__Project(B_Property_4(__in,__cfg).__ST239420_Layout __PP5770022) := TRANSFORM
    __EE5770066 := __PP5770022.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE5770066),__ST228619_Layout),__NL(__EE5770066));
    SELF := __PP5770022;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE5770021,__ND5770026__Project(LEFT));
END;
