...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6049412 := __ENH_Property_4;
  EXPORT __ST224266_Layout := RECORD
  ...
  END;
  EXPORT __ST224248_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST224266_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224248_Layout __ND6049417__Project(B_Property_4(__in,__cfg).__ST235108_Layout __PP6049413) := TRANSFORM
    __EE6049457 := __PP6049413.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6049457),__ST224266_Layout),__NL(__EE6049457));
    SELF := __PP6049413;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6049412,__ND6049417__Project(LEFT));
END;
