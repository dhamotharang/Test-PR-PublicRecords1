...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6552749 := __ENH_Property_4;
  EXPORT __ST231976_Layout := RECORD
  ...
  END;
  EXPORT __ST231958_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST231976_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231958_Layout __ND6552754__Project(B_Property_4(__in,__cfg).__ST243138_Layout __PP6552750) := TRANSFORM
    __EE6552794 := __PP6552750.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6552794),__ST231976_Layout),__NL(__EE6552794));
    SELF := __PP6552750;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6552749,__ND6552754__Project(LEFT));
END;
