...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6057648 := __ENH_Property_4;
  EXPORT __ST224788_Layout := RECORD
  ...
  END;
  EXPORT __ST224770_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST224788_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224770_Layout __ND6057653__Project(B_Property_4(__in,__cfg).__ST235630_Layout __PP6057649) := TRANSFORM
    __EE6057693 := __PP6057649.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6057693),__ST224788_Layout),__NL(__EE6057693));
    SELF := __PP6057649;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6057648,__ND6057653__Project(LEFT));
END;
