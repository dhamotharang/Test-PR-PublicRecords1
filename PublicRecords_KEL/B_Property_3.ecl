...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6896851 := __ENH_Property_4;
  EXPORT __ST244547_Layout := RECORD
  ...
  END;
  EXPORT __ST244529_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST244547_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST244529_Layout __ND6896856__Project(B_Property_4(__in,__cfg).__ST255910_Layout __PP6896852) := TRANSFORM
    __EE6896896 := __PP6896852.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6896896),__ST244547_Layout),__NL(__EE6896896));
    SELF := __PP6896852;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6896851,__ND6896856__Project(LEFT));
END;
