...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6525703 := __ENH_Property_4;
  EXPORT __ST230574_Layout := RECORD
  ...
  END;
  EXPORT __ST230556_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST230574_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST230556_Layout __ND6525708__Project(B_Property_4(__in,__cfg).__ST241735_Layout __PP6525704) := TRANSFORM
    __EE6525748 := __PP6525704.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6525748),__ST230574_Layout),__NL(__EE6525748));
    SELF := __PP6525704;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6525703,__ND6525708__Project(LEFT));
END;
