...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6416287 := __ENH_Property_4;
  EXPORT __ST232969_Layout := RECORD
  ...
  END;
  EXPORT __ST232951_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST232969_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST232951_Layout __ND6416292__Project(B_Property_4(__in,__cfg).__ST244063_Layout __PP6416288) := TRANSFORM
    __EE6416332 := __PP6416288.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6416332),__ST232969_Layout),__NL(__EE6416332));
    SELF := __PP6416288;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE6416287,__ND6416292__Project(LEFT));
END;
