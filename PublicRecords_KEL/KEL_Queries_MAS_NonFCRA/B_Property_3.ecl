...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4686901 := __ENH_Property_4;
  EXPORT __ST186770_Layout := RECORD
  ...
  END;
  EXPORT __ST186752_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST186770_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186752_Layout __ND4686906__Project(B_Property_4(__in,__cfg).__ST191500_Layout __PP4686902) := TRANSFORM
    __EE4686946 := __PP4686902.Automated_Valuation_Model_;
    __ST186770_Layout __ND4686951__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP4686947) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP4686947.Date_First_Seen_);
      SELF := __PP4686947;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE4686946,__ND4686951__Project(LEFT));
    SELF := __PP4686902;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE4686901,__ND4686906__Project(LEFT));
END;
