...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1920856 := __ENH_Property_4;
  EXPORT __ST177651_Layout := RECORD
  ...
  EXPORT __ST177633_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST177651_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177633_Layout __ND1920861__Project(B_Property_4(__in,__cfg).__ST181039_Layout __PP1920857) := TRANSFORM
    __EE1920901 := __PP1920857.Automated_Valuation_Model_;
    __ST177651_Layout __ND1920906__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP1920902) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP1920902.Date_First_Seen_);
      SELF := __PP1920902;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE1920901,__ND1920906__Project(LEFT));
    SELF := __PP1920857;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE1920856,__ND1920861__Project(LEFT));
END;
