...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1904355 := __ENH_Property_4;
  EXPORT __ST171740_Layout := RECORD
  ...
  END;
  EXPORT __ST171722_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST171740_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171722_Layout __ND1904360__Project(B_Property_4(__in,__cfg).__ST175120_Layout __PP1904356) := TRANSFORM
    __EE1904400 := __PP1904356.Automated_Valuation_Model_;
    __ST171740_Layout __ND1904405__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP1904401) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP1904401.Date_First_Seen_);
      SELF := __PP1904401;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE1904400,__ND1904405__Project(LEFT));
    SELF := __PP1904356;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE1904355,__ND1904360__Project(LEFT));
END;
