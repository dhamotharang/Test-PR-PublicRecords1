...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5495395 := __ENH_Property_4;
  EXPORT __ST196214_Layout := RECORD
  ...
  EXPORT __ST196196_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST196214_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST196196_Layout __ND5495400__Project(B_Property_4(__in,__cfg).__ST201604_Layout __PP5495396) := TRANSFORM
    __EE5495440 := __PP5495396.Automated_Valuation_Model_;
    __ST196214_Layout __ND5495445__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP5495441) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP5495441.Date_First_Seen_);
      SELF := __PP5495441;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE5495440,__ND5495445__Project(LEFT));
    SELF := __PP5495396;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE5495395,__ND5495400__Project(LEFT));
END;
