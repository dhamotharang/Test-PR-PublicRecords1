...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_2,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Person_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8284009 := __ENH_Person_Address_2;
  ...
  END;
  EXPORT __ST178024_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST178080_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST178024_Layout __ND8284014__Project(B_Person_Address_2(__in,__cfg).__ST249356_Layout __PP8284010) := TRANSFORM
    __EE8284113 := __PP8284010.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8284113),__ST178080_Layout),__NL(__EE8284113));
    SELF := __PP8284010;
  END;
  EXPORT __ENH_Person_Address_1 := PROJECT(__EE8284009,__ND8284014__Project(LEFT));
END;
