...
EXPORT B_Phone_Summary_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2545862 := __ENH_Phone_Summary_3;
  SHARED __EE2545864 := __ENH_Input_P_I_I_3;
  SHARED __ST765967_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474362_Layout) Translated_Address_Sources_;
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474373_Layout) Translated_D_O_B_Sources_;
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474382_Layout) Translated_Last_Name_Sources_;
  ...
  END;
  __JC2545873(B_Phone_Summary_3(__in,__cfg).__ST168282_Layout __EE2545862, B_Input_P_I_I_3(__in,__cfg).__ST165383_Layout __EE2545864) := __EEQP(__EE2545862.P_I_I_,__EE2545864.UID);
  __ST765967_Layout __JT2545873(B_Phone_Summary_3(__in,__cfg).__ST168282_Layout __l, B_Input_P_I_I_3(__in,__cfg).__ST165383_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2546103 := JOIN(__EE2545862,__EE2545864,__JC2545873(LEFT,RIGHT),__JT2545873(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST81771_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST81266_Layout := RECORD
    KEL.typ.nstr Source_;
    KEL.typ.nstr My_Date_First_Seen_;
    KEL.typ.nstr My_Date_Last_Seen_;
    KEL.typ.epoch Archive___Date_ := 0;
  ...
  EXPORT __ST81494_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST163543_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Phone10_;
    KEL.typ.ndataset(E_Phone_Summary(__in,__cfg).Address_Header_Summary_Layout) Address_Header_Summary_;
    KEL.typ.ndataset(B_Phone_Summary_6(__in,__cfg).__ST176521_Layout) Address_Summary_;
    ...
    KEL.typ.nstr P___Inp_Cln_Name_Last_;
    KEL.typ.nstr P___Inp_Cln_Phone_Home_;
    KEL.typ.ndataset(__ST81771_Layout) Sorted_Address_Translated_Source_List_;
    KEL.typ.ndataset(__ST81266_Layout) Sorted_D_O_B_Translated_Source_List_;
    KEL.typ.ndataset(__ST81494_Layout) Sorted_Last_Name_Translated_Source_List_;
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474362_Layout) Translated_Address_Sources_;
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474373_Layout) Translated_D_O_B_Sources_;
    KEL.typ.ndataset(B_Phone_Summary_3(__in,__cfg).__ST474382_Layout) Translated_Last_Name_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163543_Layout __ND2545677__Project(__ST765967_Layout __PP2544135) := TRANSFORM
    __EE2545650 := __PP2544135.Translated_Address_Sources_;
    __BS2545651 := __T(__EE2545650);
    __EE2545671 := __BS2545651(__T(__AND(__OP2(__T(__EE2545650).Primary_Name_,=,__PP2544135.P___Inp_Cln_Addr_Prim_Name_),__AND(__OP2(__T(__EE2545650).Primary_Range_,=,__PP2544135.P___Inp_Cln_Addr_Prim_Rng_),__OP2(__T(__EE2545650).Zip_,=,__PP2544135.P___Inp_Cln_Addr_Zip5_)))));
    __EE2545675 := TOPN(__EE2545671(__NN(__EE2545671.My_Date_First_Seen_) AND __NN(__EE2545671.Source_)),99999,__T(__EE2545671.My_Date_First_Seen_),__T(__EE2545671.Source_),__T(Primary_Name_),__T(Primary_Range_),__T(Zip_));
    SELF.Sorted_Address_Translated_Source_List_ := __FILTER(__CN(PROJECT(TABLE(PROJECT(__EE2545675,__ST81771_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Source_,My_Date_First_Seen_,My_Date_Last_Seen_},Source_,My_Date_First_Seen_,My_Date_Last_Seen_,MERGE),__ST81771_Layout)),__NN(Source_) OR __NN(My_Date_First_Seen_) OR __NN(My_Date_Last_Seen_));
    __EE2545710 := __PP2544135.Translated_D_O_B_Sources_;
    __BS2545711 := __T(__EE2545710);
    __EE2545722 := __BS2545711(__T(__OP2(__FN2(KEL.Routines.DateToString,__T(__EE2545710).Date_Of_Birth_,__CN('%Y%m%d')),=,__PP2544135.P___Inp_Cln_D_O_B_)));
    __EE2545726 := TOPN(__EE2545722(__NN(__EE2545722.My_Date_First_Seen_) AND __NN(__EE2545722.Source_)),99999,__T(__EE2545722.My_Date_First_Seen_),__T(__EE2545722.Source_),__T(Date_Of_Birth_));
    SELF.Sorted_D_O_B_Translated_Source_List_ := __FILTER(__CN(PROJECT(TABLE(PROJECT(__EE2545726,__ST81266_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Source_,My_Date_First_Seen_,My_Date_Last_Seen_},Source_,My_Date_First_Seen_,My_Date_Last_Seen_,MERGE),__ST81266_Layout)),__NN(Source_) OR __NN(My_Date_First_Seen_) OR __NN(My_Date_Last_Seen_));
    __EE2545760 := __PP2544135.Translated_Last_Name_Sources_;
    __BS2545761 := __T(__EE2545760);
    __EE2545769 := __BS2545761(__T(__OP2(__T(__EE2545760).Last_Name_,=,__PP2544135.P___Inp_Cln_Name_Last_)));
    __EE2545773 := TOPN(__EE2545769(__NN(__EE2545769.My_Date_First_Seen_) AND __NN(__EE2545769.Source_)),99999,__T(__EE2545769.My_Date_First_Seen_),__T(__EE2545769.Source_),__T(Last_Name_));
    SELF.Sorted_Last_Name_Translated_Source_List_ := __FILTER(__CN(PROJECT(TABLE(PROJECT(__EE2545773,__ST81494_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Source_,My_Date_First_Seen_,My_Date_Last_Seen_},Source_,My_Date_First_Seen_,My_Date_Last_Seen_,MERGE),__ST81494_Layout)),__NN(Source_) OR __NN(My_Date_First_Seen_) OR __NN(My_Date_Last_Seen_));
    SELF := __PP2544135;
  END;
  EXPORT __ENH_Phone_Summary_2 := PROJECT(__EE2546103,__ND2545677__Project(LEFT));
END;
