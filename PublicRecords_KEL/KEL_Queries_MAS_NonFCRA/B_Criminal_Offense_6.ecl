...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3974574 := __ENH_Criminal_Offense_7;
  EXPORT __ST195173_Layout := RECORD
  ...
  END;
  EXPORT __ST195126_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST195173_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195126_Layout __ND3974494__Project(B_Criminal_Offense_7(__in,__cfg).__ST197294_Layout __PP3973942) := TRANSFORM
    __EE3974577 := __PP3973942.Offense_Charges_;
    __ST195173_Layout __ND3974452__Project(B_Criminal_Offense_7(__in,__cfg).__ST197341_Layout __PP3974103) := TRANSFORM
      __EE3974447 := __PP3973942.Offense_Charges_;
      SELF.Criminal_Date_ := KEL.Aggregates.MinNN(__EE3974447,KEL.Routines.CastStringToDate(__T(__EE3974447).Valid_Date_));
      SELF.Dismissed_Charges_ := __OR(IF(__T(__NT(__PP3973942.Court_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP3973942.Court_Disposition_Description_,=,__CN('DISMISSED')))),IF(__T(__NT(__PP3973942.Court_Additional_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP3973942.Court_Additional_Disposition_Description_,=,__CN('DISMISSED')))));
      SELF := __PP3974103;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE3974577,__ND3974452__Project(LEFT));
    SELF := __PP3973942;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE3974574,__ND3974494__Project(LEFT));
END;
