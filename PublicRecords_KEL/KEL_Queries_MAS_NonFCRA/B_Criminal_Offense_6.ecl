...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1619376 := __ENH_Criminal_Offense_7;
  EXPORT __ST181265_Layout := RECORD
  ...
  END;
  EXPORT __ST181218_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST181265_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181218_Layout __ND1619754__Project(B_Criminal_Offense_7(__in,__cfg).__ST183012_Layout __PP1619377) := TRANSFORM
    __EE1619537 := __PP1619377.Offense_Charges_;
    __ST181265_Layout __ND1619741__Project(B_Criminal_Offense_7(__in,__cfg).__ST183059_Layout __PP1619538) := TRANSFORM
      __CC13974 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1619538.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1619538.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13974)));
      SELF := __PP1619538;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1619537,__ND1619741__Project(LEFT));
    SELF := __PP1619377;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1619376,__ND1619754__Project(LEFT));
END;
