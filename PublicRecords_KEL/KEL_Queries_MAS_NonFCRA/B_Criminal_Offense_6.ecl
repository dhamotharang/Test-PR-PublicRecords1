...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1598994 := __ENH_Criminal_Offense_7;
  EXPORT __ST174074_Layout := RECORD
  ...
  END;
  EXPORT __ST174027_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST174074_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174027_Layout __ND1599372__Project(B_Criminal_Offense_7(__in,__cfg).__ST175813_Layout __PP1598995) := TRANSFORM
    __EE1599155 := __PP1598995.Offense_Charges_;
    __ST174074_Layout __ND1599359__Project(B_Criminal_Offense_7(__in,__cfg).__ST175860_Layout __PP1599156) := TRANSFORM
      __CC14097 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1599156.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1599156.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14097)));
      SELF := __PP1599156;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1599155,__ND1599359__Project(LEFT));
    SELF := __PP1598995;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1598994,__ND1599372__Project(LEFT));
END;
