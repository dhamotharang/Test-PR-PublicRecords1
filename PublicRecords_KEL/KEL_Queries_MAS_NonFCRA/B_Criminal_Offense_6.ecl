...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1597719 := __ENH_Criminal_Offense_7;
  ...
  EXPORT __ST175052_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST175099_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175052_Layout __ND1598097__Project(B_Criminal_Offense_7(__in,__cfg).__ST176846_Layout __PP1597720) := TRANSFORM
    __EE1597880 := __PP1597720.Offense_Charges_;
    __ST175099_Layout __ND1598084__Project(B_Criminal_Offense_7(__in,__cfg).__ST176893_Layout __PP1597881) := TRANSFORM
      __CC13968 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1597881.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1597881.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13968)));
      SELF := __PP1597881;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1597880,__ND1598084__Project(LEFT));
    SELF := __PP1597720;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1597719,__ND1598097__Project(LEFT));
END;
