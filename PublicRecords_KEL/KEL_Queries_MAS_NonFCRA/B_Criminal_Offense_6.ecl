...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1601906 := __ENH_Criminal_Offense_7;
  EXPORT __ST184077_Layout := RECORD
  ...
  END;
  EXPORT __ST184030_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST184077_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184030_Layout __ND1601826__Project(B_Criminal_Offense_7(__in,__cfg).__ST185692_Layout __PP1601274) := TRANSFORM
    __EE1601909 := __PP1601274.Offense_Charges_;
    __ST184077_Layout __ND1601784__Project(B_Criminal_Offense_7(__in,__cfg).__ST185739_Layout __PP1601435) := TRANSFORM
      __EE1601779 := __PP1601274.Offense_Charges_;
      SELF.Criminal_Date_ := KEL.Aggregates.MinNN(__EE1601779,KEL.Routines.CastStringToDate(__T(__EE1601779).Valid_Date_));
      SELF.Dismissed_Charges_ := __OR(IF(__T(__NT(__PP1601274.Court_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1601274.Court_Disposition_Description_,=,__CN('DISMISSED')))),IF(__T(__NT(__PP1601274.Court_Additional_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1601274.Court_Additional_Disposition_Description_,=,__CN('DISMISSED')))));
      SELF := __PP1601435;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1601909,__ND1601784__Project(LEFT));
    SELF := __PP1601274;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1601906,__ND1601826__Project(LEFT));
END;
