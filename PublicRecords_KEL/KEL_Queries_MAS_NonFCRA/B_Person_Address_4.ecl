...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_5,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Person_Address_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4918460 := __ENH_Person_Address_5;
  EXPORT __ST248972_Layout := RECORD
  ...
  EXPORT __ST248916_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST248972_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248916_Layout __ND4918465__Project(B_Person_Address_5(__in,__cfg).__ST248696_Layout __PP4918461) := TRANSFORM
    __EE4918566 := __PP4918461.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4918566),__ST248972_Layout),__NL(__EE4918566));
    SELF := __PP4918461;
  END;
  EXPORT __ENH_Person_Address_4 := PROJECT(__EE4918460,__ND4918465__Project(LEFT));
END;
