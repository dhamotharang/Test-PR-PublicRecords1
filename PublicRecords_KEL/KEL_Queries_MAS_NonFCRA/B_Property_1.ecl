...
IMPORT KEL15 AS KEL;
IMPORT B_Property_2,CFG_Compile,E_Property,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6489339 := __ENH_Property_2;
  EXPORT __ST171249_Layout := RECORD
  ...
  EXPORT __ST171231_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST171249_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171231_Layout __ND6489344__Project(B_Property_2(__in,__cfg).__ST180067_Layout __PP6489340) := TRANSFORM
    __EE6489383 := __PP6489340.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE6489383),__ST171249_Layout),__NL(__EE6489383));
    SELF := __PP6489340;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE6489339,__ND6489344__Project(LEFT));
END;
