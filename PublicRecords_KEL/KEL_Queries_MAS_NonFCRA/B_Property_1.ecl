...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8286877 := __ENH_Property_2;
  EXPORT __ST179040_Layout := RECORD
  ...
  END;
  EXPORT __ST179022_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST179040_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179022_Layout __ND8286882__Project(B_Property_2(__in,__cfg).__ST188704_Layout __PP8286878) := TRANSFORM
    __EE8286921 := __PP8286878.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8286921),__ST179040_Layout),__NL(__EE8286921));
    SELF := __PP8286878;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8286877,__ND8286882__Project(LEFT));
END;
