...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1919488 := __ENH_Criminal_Offense_3;
  EXPORT __ST164925_Layout := RECORD
  ...
  END;
  EXPORT __ST164878_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST164925_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST164878_Layout __ND1919906__Project(B_Criminal_Offense_3(__in,__cfg).__ST170218_Layout __PP1919489) := TRANSFORM
    __EE1919649 := __PP1919489.Offense_Charges_;
    __ST164925_Layout __ND1919883__Project(B_Criminal_Offense_3(__in,__cfg).__ST170265_Layout __PP1919650) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP1919650.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP1919650.Dismissed_Charges_),__NOT(__OP2(__PP1919650.Offense_Score_,=,__CN('F'))));
      SELF := __PP1919650;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1919649,__ND1919883__Project(LEFT));
    SELF := __PP1919489;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE1919488,__ND1919906__Project(LEFT));
END;
