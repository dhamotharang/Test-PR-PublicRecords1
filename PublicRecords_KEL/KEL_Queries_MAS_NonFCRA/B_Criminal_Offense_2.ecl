...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1909074 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST163258_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST163305_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163258_Layout __ND1909492__Project(B_Criminal_Offense_3(__in,__cfg).__ST168594_Layout __PP1909075) := TRANSFORM
    __EE1909235 := __PP1909075.Offense_Charges_;
    __ST163305_Layout __ND1909469__Project(B_Criminal_Offense_3(__in,__cfg).__ST168641_Layout __PP1909236) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP1909236.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP1909236.Dismissed_Charges_),__NOT(__OP2(__PP1909236.Offense_Score_,=,__CN('F'))));
      SELF := __PP1909236;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1909235,__ND1909469__Project(LEFT));
    SELF := __PP1909075;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE1909074,__ND1909492__Project(LEFT));
END;
