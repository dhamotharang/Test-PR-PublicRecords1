...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4693042 := __ENH_Criminal_Offense_3;
  EXPORT __ST172808_Layout := RECORD
  ...
  END;
  EXPORT __ST172761_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST172808_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172761_Layout __ND4693499__Project(B_Criminal_Offense_3(__in,__cfg).__ST181519_Layout __PP4693043) := TRANSFORM
    __EE4693203 := __PP4693043.Offense_Charges_;
    __ST172808_Layout __ND4693464__Project(B_Criminal_Offense_3(__in,__cfg).__ST181566_Layout __PP4693204) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP4693204.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP4693204.Dismissed_Charges_),__OP2(__PP4693204.Offense_Score_,=,__CN('M'))),__OP2(__PP4693204.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP4693204.Traffic_Flag_,=,__CN('N')));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP4693204.Dismissed_Charges_),__NOT(__OP2(__PP4693204.Offense_Score_,=,__CN('F'))));
      SELF := __PP4693204;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE4693203,__ND4693464__Project(LEFT));
    SELF := __PP4693043;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE4693042,__ND4693499__Project(LEFT));
END;
