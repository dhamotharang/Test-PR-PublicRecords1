...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2069585 := __ENH_Criminal_Offense_3;
  EXPORT __ST165611_Layout := RECORD
  ...
  END;
  EXPORT __ST165564_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST165611_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST165564_Layout __ND2070003__Project(B_Criminal_Offense_3(__in,__cfg).__ST171139_Layout __PP2069586) := TRANSFORM
    __EE2069746 := __PP2069586.Offense_Charges_;
    __ST165611_Layout __ND2069980__Project(B_Criminal_Offense_3(__in,__cfg).__ST171186_Layout __PP2069747) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP2069747.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP2069747.Dismissed_Charges_),__NOT(__OP2(__PP2069747.Offense_Score_,=,__CN('F'))));
      SELF := __PP2069747;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE2069746,__ND2069980__Project(LEFT));
    SELF := __PP2069586;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE2069585,__ND2070003__Project(LEFT));
END;
