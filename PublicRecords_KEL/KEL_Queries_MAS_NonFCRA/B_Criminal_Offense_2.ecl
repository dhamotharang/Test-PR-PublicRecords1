...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2005118 := __ENH_Criminal_Offense_3;
  EXPORT __ST158525_Layout := RECORD
  ...
  END;
  EXPORT __ST158478_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST158525_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158478_Layout __ND2005536__Project(B_Criminal_Offense_3(__in,__cfg).__ST164039_Layout __PP2005119) := TRANSFORM
    __EE2005279 := __PP2005119.Offense_Charges_;
    __ST158525_Layout __ND2005513__Project(B_Criminal_Offense_3(__in,__cfg).__ST164086_Layout __PP2005280) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP2005280.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP2005280.Dismissed_Charges_),__NOT(__OP2(__PP2005280.Offense_Score_,=,__CN('F'))));
      SELF := __PP2005280;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE2005279,__ND2005513__Project(LEFT));
    SELF := __PP2005119;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE2005118,__ND2005536__Project(LEFT));
END;
