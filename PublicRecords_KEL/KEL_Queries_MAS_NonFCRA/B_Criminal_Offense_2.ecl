...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2004293 := __ENH_Criminal_Offense_3;
  EXPORT __ST159540_Layout := RECORD
  ...
  END;
  EXPORT __ST159493_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159540_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159493_Layout __ND2004711__Project(B_Criminal_Offense_3(__in,__cfg).__ST165040_Layout __PP2004294) := TRANSFORM
    __EE2004454 := __PP2004294.Offense_Charges_;
    __ST159540_Layout __ND2004688__Project(B_Criminal_Offense_3(__in,__cfg).__ST165087_Layout __PP2004455) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP2004455.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP2004455.Dismissed_Charges_),__NOT(__OP2(__PP2004455.Offense_Score_,=,__CN('F'))));
      SELF := __PP2004455;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE2004454,__ND2004688__Project(LEFT));
    SELF := __PP2004294;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE2004293,__ND2004711__Project(LEFT));
END;
