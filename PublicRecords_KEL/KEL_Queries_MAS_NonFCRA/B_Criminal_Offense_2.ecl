...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1919675 := __ENH_Criminal_Offense_3;
  EXPORT __ST163480_Layout := RECORD
  ...
  END;
  EXPORT __ST163433_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST163480_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163433_Layout __ND1920093__Project(B_Criminal_Offense_3(__in,__cfg).__ST168773_Layout __PP1919676) := TRANSFORM
    __EE1919836 := __PP1919676.Offense_Charges_;
    __ST163480_Layout __ND1920070__Project(B_Criminal_Offense_3(__in,__cfg).__ST168820_Layout __PP1919837) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP1919837.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP1919837.Dismissed_Charges_),__NOT(__OP2(__PP1919837.Offense_Score_,=,__CN('F'))));
      SELF := __PP1919837;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1919836,__ND1920070__Project(LEFT));
    SELF := __PP1919676;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE1919675,__ND1920093__Project(LEFT));
END;
