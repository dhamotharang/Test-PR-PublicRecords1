...
EXPORT B_Bankruptcy_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4692966 := __ENH_Bankruptcy_3;
  EXPORT __ST708690_Layout := RECORD
  ...
  END;
  EXPORT __ST172509_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    ...
    KEL.typ.ndataset(__ST708690_Layout) Best_Child_Record_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172509_Layout __ND4692923__Project(B_Bankruptcy_3(__in,__cfg).__ST181294_Layout __PP4692517) := TRANSFORM
    __EE4692921 := __PP4692517.Best_Child_Record_;
    __ST708690_Layout __ND4692836__Project(B_Bankruptcy_3(__in,__cfg).__ST462215_Layout __PP4692575) := TRANSFORM
      SELF.Chapter13_ := __OP2(__PP4692575.Original_Chapter_,=,__CN('13'));
      SELF.Chapter7_ := __OP2(__PP4692575.Original_Chapter_,=,__CN('7'));
      SELF.Chapter_Type_ := __OP2(__PP4692575.Original_Chapter_,IN,__CN(['7','11','12','13','15']));
      SELF.Is_Disposed_ := __NOT(__NT(__PP4692575.Disposition_));
      SELF := __PP4692575;
    END;
    SELF.Best_Child_Record_ := __PROJECT(__EE4692921,__ND4692836__Project(LEFT));
    SELF := __PP4692517;
  END;
  EXPORT __ENH_Bankruptcy_2 := PROJECT(__EE4692966,__ND4692923__Project(LEFT));
END;
