...
IMPORT KEL16 AS KEL;
IMPORT B_Property_Event_2,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Property_Event_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3345218 := __ENH_Property_Event_2;
  EXPORT __ENH_Property_Event_1 := __EE3345218;
END;
