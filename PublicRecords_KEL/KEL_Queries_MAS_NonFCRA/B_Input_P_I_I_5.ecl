...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_6,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4766507 := __ENH_Input_P_I_I_6;
  EXPORT __ST221649_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST221649_Layout __ND4767236__Project(B_Input_P_I_I_6(__in,__cfg).__ST221031_Layout __PP4766508) := TRANSFORM
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_Zip5_));
    __CC13660 := '-99999';
    __CC13665 := '-99998';
    SELF.Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP4766508.P___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__AND(__CN(__PP4766508.P___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP4766508.P___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__AND(__CN(__PP4766508.P___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP4766508.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__AND(__CN(__PP4766508.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP4766508.Addr_Not_Populated_),__PP4766508.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Name_Not_Populated_ := IF(FN_Compile(__cfg).FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__PP4766508.P___Inp_Name_Last_)),TRUE,FALSE);
    SELF.P___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP4766508.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13660)),__ECAST(KEL.typ.nstr,__CN(__CC13665)));
    SELF.P___Inp_Val_Name_Bogus_Flag_ := MAP(__T(__AND(__AND(__OP2(__PP4766508.Input_First_Name_Value_,=,__CN(__CC13660)),__OP2(__PP4766508.Input_Middle_Name_Value_,=,__CN(__CC13660))),__OP2(__PP4766508.Input_Last_Name_Value_,=,__CN(__CC13660))))=>__CC13660,__T(__OP2(FN_Compile(__cfg).FN__fn_Bogus_Names(__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP4766508.P___Inp_Name_First_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP4766508.Input_Middle_Name_Value_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP4766508.Input_Last_Name_Value_))),=,__CAST(KEL.typ.str,__CN(1))))=>(KEL.typ.str)1,(KEL.typ.str)0);
    SELF := __PP4766508;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE4766507,__ND4767236__Project(LEFT));
END;
