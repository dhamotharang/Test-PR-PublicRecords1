...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2567542 := __ENH_Property_3;
  EXPORT __ST167538_Layout := RECORD
  ...
  END;
  EXPORT __ST167520_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST167538_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167520_Layout __ND2567547__Project(B_Property_3(__in,__cfg).__ST171911_Layout __PP2567543) := TRANSFORM
    __EE2567587 := __PP2567543.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2567587),__ST167538_Layout),__NL(__EE2567587));
    SELF := __PP2567543;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2567542,__ND2567547__Project(LEFT));
END;
