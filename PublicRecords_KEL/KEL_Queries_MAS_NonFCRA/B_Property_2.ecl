...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2554013 := __ENH_Property_3;
  EXPORT __ST168177_Layout := RECORD
  ...
  END;
  EXPORT __ST168159_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST168177_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168159_Layout __ND2554018__Project(B_Property_3(__in,__cfg).__ST172540_Layout __PP2554014) := TRANSFORM
    __EE2554058 := __PP2554014.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2554058),__ST168177_Layout),__NL(__EE2554058));
    SELF := __PP2554014;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2554013,__ND2554018__Project(LEFT));
END;
