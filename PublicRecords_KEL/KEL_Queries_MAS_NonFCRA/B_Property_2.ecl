...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2567355 := __ENH_Property_3;
  EXPORT __ST168983_Layout := RECORD
  ...
  END;
  EXPORT __ST168965_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST168983_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168965_Layout __ND2567360__Project(B_Property_3(__in,__cfg).__ST173356_Layout __PP2567356) := TRANSFORM
    __EE2567400 := __PP2567356.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2567400),__ST168983_Layout),__NL(__EE2567400));
    SELF := __PP2567356;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2567355,__ND2567360__Project(LEFT));
END;
