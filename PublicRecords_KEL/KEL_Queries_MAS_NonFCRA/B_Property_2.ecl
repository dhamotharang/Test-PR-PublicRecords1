...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2546464 := __ENH_Property_3;
  EXPORT __ST162771_Layout := RECORD
  ...
  END;
  EXPORT __ST162753_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST162771_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162753_Layout __ND2546469__Project(B_Property_3(__in,__cfg).__ST167494_Layout __PP2546465) := TRANSFORM
    __EE2546509 := __PP2546465.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2546509),__ST162771_Layout),__NL(__EE2546509));
    SELF := __PP2546465;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2546464,__ND2546469__Project(LEFT));
END;
