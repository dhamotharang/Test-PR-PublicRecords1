...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2568029 := __ENH_Property_3;
  EXPORT __ST169657_Layout := RECORD
  ...
  END;
  EXPORT __ST169639_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169657_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169639_Layout __ND2568034__Project(B_Property_3(__in,__cfg).__ST174030_Layout __PP2568030) := TRANSFORM
    __EE2568074 := __PP2568030.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2568074),__ST169657_Layout),__NL(__EE2568074));
    SELF := __PP2568030;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2568029,__ND2568034__Project(LEFT));
END;
