...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2573819 := __ENH_Property_3;
  EXPORT __ST173260_Layout := RECORD
  ...
  END;
  EXPORT __ST173242_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST173260_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173242_Layout __ND2573824__Project(B_Property_3(__in,__cfg).__ST177633_Layout __PP2573820) := TRANSFORM
    __EE2573864 := __PP2573820.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE2573864),__ST173260_Layout),__NL(__EE2573864));
    SELF := __PP2573820;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE2573819,__ND2573824__Project(LEFT));
END;
