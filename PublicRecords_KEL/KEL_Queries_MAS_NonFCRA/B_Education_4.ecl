...
IMPORT KEL16 AS KEL;
IMPORT B_Education_5,B_Education_7,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Education_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1663606 := __ENH_Education_5;
  EXPORT __ENH_Education_4 := __EE1663606;
END;
