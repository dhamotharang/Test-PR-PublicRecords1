...
IMPORT KEL16 AS KEL;
IMPORT B_Education_6,B_Education_8,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Education_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1616166 := __ENH_Education_6;
  EXPORT __ENH_Education_5 := __EE1616166;
END;
