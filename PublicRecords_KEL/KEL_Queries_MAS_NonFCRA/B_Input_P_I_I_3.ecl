...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_4,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4161551 := __ENH_Input_P_I_I_4;
  EXPORT __ST182008_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182008_Layout __ND4161556__Project(B_Input_P_I_I_4(__in,__cfg).__ST188165_Layout __PP4161552) := TRANSFORM
    SELF.P___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP4161552.P___Inp_Addr_State_));
    SELF := __PP4161552;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE4161551,__ND4161556__Project(LEFT));
END;
