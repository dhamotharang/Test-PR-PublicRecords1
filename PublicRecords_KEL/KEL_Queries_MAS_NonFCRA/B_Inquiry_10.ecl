...
EXPORT B_Inquiry_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1564454 := __E_Inquiry;
  EXPORT __ST183090_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST183090_Layout __ND1564387__Project(E_Inquiry(__in,__cfg).Layout __PP216939) := TRANSFORM
    __EE1564380 := __PP216939.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE1564380))[1].Sub_Market_,'');
    SELF := __PP216939;
  END;
  EXPORT __ENH_Inquiry_10 := PROJECT(__EE1564454,__ND1564387__Project(LEFT));
END;
