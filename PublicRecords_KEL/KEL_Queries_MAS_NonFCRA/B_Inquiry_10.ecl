...
EXPORT B_Inquiry_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1564493 := __E_Inquiry;
  EXPORT __ST183135_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST183135_Layout __ND1564426__Project(E_Inquiry(__in,__cfg).Layout __PP216984) := TRANSFORM
    __EE1564419 := __PP216984.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE1564419))[1].Sub_Market_,'');
    SELF := __PP216984;
  END;
  EXPORT __ENH_Inquiry_10 := PROJECT(__EE1564493,__ND1564426__Project(LEFT));
END;
