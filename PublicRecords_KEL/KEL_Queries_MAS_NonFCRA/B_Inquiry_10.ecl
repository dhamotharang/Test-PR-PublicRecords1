...
EXPORT B_Inquiry_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1563675 := __E_Inquiry;
  EXPORT __ST182317_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182317_Layout __ND1563608__Project(E_Inquiry(__in,__cfg).Layout __PP216166) := TRANSFORM
    __EE1563601 := __PP216166.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE1563601))[1].Sub_Market_,'');
    SELF := __PP216166;
  END;
  EXPORT __ENH_Inquiry_10 := PROJECT(__EE1563675,__ND1563608__Project(LEFT));
END;
