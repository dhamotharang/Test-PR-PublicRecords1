...
EXPORT B_Inquiry_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1570938 := __E_Inquiry;
  EXPORT __ST182528_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182528_Layout __ND1570871__Project(E_Inquiry(__in,__cfg).Layout __PP216487) := TRANSFORM
    __EE1570864 := __PP216487.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE1570864))[1].Sub_Market_,'');
    SELF := __PP216487;
  END;
  EXPORT __ENH_Inquiry_10 := PROJECT(__EE1570938,__ND1570871__Project(LEFT));
END;
