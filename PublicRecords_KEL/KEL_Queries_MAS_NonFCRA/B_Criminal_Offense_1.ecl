...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2573305 := __ENH_Criminal_Offense_2;
  EXPORT __ST158731_Layout := RECORD
  ...
  END;
  EXPORT __ST158684_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST158731_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158684_Layout __ND2573310__Project(B_Criminal_Offense_2(__in,__cfg).__ST165552_Layout __PP2573306) := TRANSFORM
    __EE2573466 := __PP2573306.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2573466,__ST158731_Layout);
    SELF := __PP2573306;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2573305,__ND2573310__Project(LEFT));
END;
