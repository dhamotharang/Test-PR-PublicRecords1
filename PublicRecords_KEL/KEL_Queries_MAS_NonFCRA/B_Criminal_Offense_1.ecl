...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5492659 := __ENH_Criminal_Offense_2;
  EXPORT __ST159100_Layout := RECORD
  ...
  END;
  EXPORT __ST159053_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159100_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159053_Layout __ND5492664__Project(B_Criminal_Offense_2(__in,__cfg).__ST172761_Layout __PP5492660) := TRANSFORM
    __EE5492820 := __PP5492660.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE5492820,__ST159100_Layout);
    SELF := __PP5492660;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE5492659,__ND5492664__Project(LEFT));
END;
