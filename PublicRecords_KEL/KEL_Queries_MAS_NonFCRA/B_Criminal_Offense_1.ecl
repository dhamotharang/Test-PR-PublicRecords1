...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2559250 := __ENH_Criminal_Offense_2;
  EXPORT __ST157214_Layout := RECORD
  ...
  END;
  EXPORT __ST157167_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST157214_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157167_Layout __ND2559255__Project(B_Criminal_Offense_2(__in,__cfg).__ST164031_Layout __PP2559251) := TRANSFORM
    __EE2559411 := __PP2559251.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2559411,__ST157214_Layout);
    SELF := __PP2559251;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2559250,__ND2559255__Project(LEFT));
END;
