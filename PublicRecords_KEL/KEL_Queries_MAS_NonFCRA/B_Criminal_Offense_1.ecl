...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2579095 := __ENH_Criminal_Offense_2;
  EXPORT __ST162332_Layout := RECORD
  ...
  END;
  EXPORT __ST162285_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST162332_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162285_Layout __ND2579100__Project(B_Criminal_Offense_2(__in,__cfg).__ST169153_Layout __PP2579096) := TRANSFORM
    __EE2579256 := __PP2579096.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2579256,__ST162332_Layout);
    SELF := __PP2579096;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2579095,__ND2579100__Project(LEFT));
END;
