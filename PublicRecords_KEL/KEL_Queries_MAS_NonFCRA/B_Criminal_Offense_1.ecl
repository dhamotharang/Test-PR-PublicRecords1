...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6391542 := __ENH_Criminal_Offense_2;
  ...
  END;
  EXPORT __ST165248_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST165295_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST165248_Layout __ND6391547__Project(B_Criminal_Offense_2(__in,__cfg).__ST180552_Layout __PP6391543) := TRANSFORM
    __EE6391703 := __PP6391543.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE6391703,__ST165295_Layout);
    SELF := __PP6391543;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE6391542,__ND6391547__Project(LEFT));
END;
