...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2550819 := __ENH_Criminal_Offense_2;
  EXPORT __ST151272_Layout := RECORD
  ...
  END;
  EXPORT __ST151225_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST151272_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151225_Layout __ND2550824__Project(B_Criminal_Offense_2(__in,__cfg).__ST158478_Layout __PP2550820) := TRANSFORM
    __EE2550980 := __PP2550820.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2550980,__ST151272_Layout);
    SELF := __PP2550820;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2550819,__ND2550824__Project(LEFT));
END;
