...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2558471 := __ENH_Criminal_Offense_2;
  EXPORT __ST156441_Layout := RECORD
  ...
  END;
  EXPORT __ST156394_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST156441_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156394_Layout __ND2558476__Project(B_Criminal_Offense_2(__in,__cfg).__ST163258_Layout __PP2558472) := TRANSFORM
    __EE2558632 := __PP2558472.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2558632,__ST156441_Layout);
    SELF := __PP2558472;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2558471,__ND2558476__Project(LEFT));
END;
