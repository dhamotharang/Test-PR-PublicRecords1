...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE228004 := __E_Criminal_Offense;
  EXPORT __ST186900_Layout := RECORD
  ...
  END;
  EXPORT __ST186853_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST186900_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186853_Layout __ND228636__Project(E_Criminal_Offense(__in,__cfg).Layout __PP227599) := TRANSFORM
    __EE227824 := __PP227599.Offense_Charges_;
    __ST186900_Layout __ND228259__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP228255) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP228255.Date_First_Seen_);
      SELF := __PP228255;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE227824,__ND228259__Project(LEFT));
    SELF := __PP227599;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE228004,__ND228636__Project(LEFT));
END;
