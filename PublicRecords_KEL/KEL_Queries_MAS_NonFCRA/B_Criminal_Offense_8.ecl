...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE222262 := __E_Criminal_Offense;
  EXPORT __ST181176_Layout := RECORD
  ...
  END;
  EXPORT __ST181129_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST181176_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181129_Layout __ND222894__Project(E_Criminal_Offense(__in,__cfg).Layout __PP221857) := TRANSFORM
    __EE222082 := __PP221857.Offense_Charges_;
    __ST181176_Layout __ND222517__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP222513) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP222513.Date_First_Seen_);
      SELF := __PP222513;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE222082,__ND222517__Project(LEFT));
    SELF := __PP221857;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE222262,__ND222894__Project(LEFT));
END;
