...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE304035 := __E_Criminal_Offense;
  EXPORT __ST210197_Layout := RECORD
  ...
  END;
  EXPORT __ST210150_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210197_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210150_Layout __ND304667__Project(E_Criminal_Offense(__in,__cfg).Layout __PP303630) := TRANSFORM
    __EE303855 := __PP303630.Offense_Charges_;
    __ST210197_Layout __ND304290__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP304286) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP304286.Date_First_Seen_);
      SELF := __PP304286;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE303855,__ND304290__Project(LEFT));
    SELF := __PP303630;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE304035,__ND304667__Project(LEFT));
END;
