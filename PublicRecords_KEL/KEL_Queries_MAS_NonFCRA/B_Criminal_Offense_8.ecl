...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE222759 := __E_Criminal_Offense;
  EXPORT __ST181783_Layout := RECORD
  ...
  END;
  EXPORT __ST181736_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST181783_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181736_Layout __ND223391__Project(E_Criminal_Offense(__in,__cfg).Layout __PP222354) := TRANSFORM
    __EE222579 := __PP222354.Offense_Charges_;
    __ST181783_Layout __ND223014__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP223010) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP223010.Date_First_Seen_);
      SELF := __PP223010;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE222579,__ND223014__Project(LEFT));
    SELF := __PP222354;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE222759,__ND223391__Project(LEFT));
END;
