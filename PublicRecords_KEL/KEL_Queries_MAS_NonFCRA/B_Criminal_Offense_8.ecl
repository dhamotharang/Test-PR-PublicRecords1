...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE270646 := __E_Criminal_Offense;
  EXPORT __ST198695_Layout := RECORD
  ...
  EXPORT __ST198648_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST198695_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST198648_Layout __ND271278__Project(E_Criminal_Offense(__in,__cfg).Layout __PP270241) := TRANSFORM
    __EE270466 := __PP270241.Offense_Charges_;
    __ST198695_Layout __ND270901__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP270897) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP270897.Date_First_Seen_);
      SELF := __PP270897;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE270466,__ND270901__Project(LEFT));
    SELF := __PP270241;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE270646,__ND271278__Project(LEFT));
END;
