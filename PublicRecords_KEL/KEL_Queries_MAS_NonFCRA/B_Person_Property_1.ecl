...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3201212 := __ENH_Person_Property_2;
  SHARED __EE3201215 := __ENH_Property_2;
  SHARED __ST1266191_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST162771_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3201223(B_Person_Property_2(__in,__cfg).__ST162126_Layout __EE3201212, B_Property_2(__in,__cfg).__ST162753_Layout __EE3201215) := __EEQP(__EE3201212.Prop_,__EE3201215.UID);
  __ST1266191_Layout __JT3201223(B_Person_Property_2(__in,__cfg).__ST162126_Layout __l, B_Property_2(__in,__cfg).__ST162753_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3201224 := JOIN(__EE3201212,__EE3201215,__JC3201223(LEFT,RIGHT),__JT3201223(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST156711_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156711_Layout __ND3201338__Project(__ST1266191_Layout __PP3201225) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3201225.Is_Business_Address_ AND __PP3201225.Is_Ever_Owned_;
    SELF := __PP3201225;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3201224,__ND3201338__Project(LEFT));
END;
