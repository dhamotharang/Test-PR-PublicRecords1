...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3196084 := __ENH_Person_Property_2;
  SHARED __EE3196087 := __ENH_Property_2;
  SHARED __ST1264842_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST163794_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3196095(B_Person_Property_2(__in,__cfg).__ST163149_Layout __EE3196084, B_Property_2(__in,__cfg).__ST163776_Layout __EE3196087) := __EEQP(__EE3196084.Prop_,__EE3196087.UID);
  __ST1264842_Layout __JT3196095(B_Person_Property_2(__in,__cfg).__ST163149_Layout __l, B_Property_2(__in,__cfg).__ST163776_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3196096 := JOIN(__EE3196084,__EE3196087,__JC3196095(LEFT,RIGHT),__JT3196095(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST157748_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157748_Layout __ND3196210__Project(__ST1264842_Layout __PP3196097) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3196097.Is_Business_Address_ AND __PP3196097.Is_Ever_Owned_;
    SELF := __PP3196097;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3196096,__ND3196210__Project(LEFT));
END;
