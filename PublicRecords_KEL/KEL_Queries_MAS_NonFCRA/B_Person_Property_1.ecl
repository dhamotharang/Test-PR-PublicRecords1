...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3298978 := __ENH_Person_Property_2;
  SHARED __EE3298981 := __ENH_Property_2;
  SHARED __ST1329061_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST173260_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3298989(B_Person_Property_2(__in,__cfg).__ST172678_Layout __EE3298978, B_Property_2(__in,__cfg).__ST173242_Layout __EE3298981) := __EEQP(__EE3298978.Prop_,__EE3298981.UID);
  __ST1329061_Layout __JT3298989(B_Person_Property_2(__in,__cfg).__ST172678_Layout __l, B_Property_2(__in,__cfg).__ST173242_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3298990 := JOIN(__EE3298978,__EE3298981,__JC3298989(LEFT,RIGHT),__JT3298989(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST167517_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167517_Layout __ND3299104__Project(__ST1329061_Layout __PP3298991) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3298991.Is_Business_Address_ AND __PP3298991.Is_Ever_Owned_;
    SELF := __PP3298991;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3298990,__ND3299104__Project(LEFT));
END;
