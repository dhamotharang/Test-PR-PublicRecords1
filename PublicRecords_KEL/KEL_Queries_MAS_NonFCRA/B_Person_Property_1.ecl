...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3292105 := __ENH_Person_Property_2;
  SHARED __EE3292108 := __ENH_Property_2;
  SHARED __ST1324060_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST168983_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3292116(B_Person_Property_2(__in,__cfg).__ST168401_Layout __EE3292105, B_Property_2(__in,__cfg).__ST168965_Layout __EE3292108) := __EEQP(__EE3292105.Prop_,__EE3292108.UID);
  __ST1324060_Layout __JT3292116(B_Person_Property_2(__in,__cfg).__ST168401_Layout __l, B_Property_2(__in,__cfg).__ST168965_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3292117 := JOIN(__EE3292105,__EE3292108,__JC3292116(LEFT,RIGHT),__JT3292116(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST163242_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163242_Layout __ND3292231__Project(__ST1324060_Layout __PP3292118) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3292118.Is_Business_Address_ AND __PP3292118.Is_Ever_Owned_;
    SELF := __PP3292118;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3292117,__ND3292231__Project(LEFT));
END;
