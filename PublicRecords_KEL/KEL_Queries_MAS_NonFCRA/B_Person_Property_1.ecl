...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3343024 := __ENH_Person_Property_2;
  SHARED __EE3343027 := __ENH_Property_2;
  SHARED __ST1329539_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST169893_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3343035(B_Person_Property_2(__in,__cfg).__ST169248_Layout __EE3343024, B_Property_2(__in,__cfg).__ST169875_Layout __EE3343027) := __EEQP(__EE3343024.Prop_,__EE3343027.UID);
  __ST1329539_Layout __JT3343035(B_Person_Property_2(__in,__cfg).__ST169248_Layout __l, B_Property_2(__in,__cfg).__ST169875_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3343036 := JOIN(__EE3343024,__EE3343027,__JC3343035(LEFT,RIGHT),__JT3343035(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST163819_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163819_Layout __ND3343150__Project(__ST1329539_Layout __PP3343037) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3343037.Is_Business_Address_ AND __PP3343037.Is_Ever_Owned_;
    SELF := __PP3343037;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3343036,__ND3343150__Project(LEFT));
END;
