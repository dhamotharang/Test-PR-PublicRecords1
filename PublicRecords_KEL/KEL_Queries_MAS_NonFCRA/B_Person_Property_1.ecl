...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3292779 := __ENH_Person_Property_2;
  SHARED __EE3292782 := __ENH_Property_2;
  SHARED __ST1324734_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST169657_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC3292790(B_Person_Property_2(__in,__cfg).__ST169075_Layout __EE3292779, B_Property_2(__in,__cfg).__ST169639_Layout __EE3292782) := __EEQP(__EE3292779.Prop_,__EE3292782.UID);
  __ST1324734_Layout __JT3292790(B_Person_Property_2(__in,__cfg).__ST169075_Layout __l, B_Property_2(__in,__cfg).__ST169639_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3292791 := JOIN(__EE3292779,__EE3292782,__JC3292790(LEFT,RIGHT),__JT3292790(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST163916_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163916_Layout __ND3292905__Project(__ST1324734_Layout __PP3292792) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP3292792.Is_Business_Address_ AND __PP3292792.Is_Ever_Owned_;
    SELF := __PP3292792;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE3292791,__ND3292905__Project(LEFT));
END;
