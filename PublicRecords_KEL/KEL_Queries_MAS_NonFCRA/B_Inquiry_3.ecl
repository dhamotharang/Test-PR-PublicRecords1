...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1714433 := __ENH_Inquiry_4;
  EXPORT __ST191578_Layout := RECORD
  ...
  EXPORT __ST191551_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST191578_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191551_Layout __ND1714438__Project(B_Inquiry_4(__in,__cfg).__ST173393_Layout __PP1714434) := TRANSFORM
    __EE1714502 := __PP1714434.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1714502),__ST191578_Layout),__NL(__EE1714502));
    SELF := __PP1714434;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE1714433,__ND1714438__Project(LEFT));
END;
