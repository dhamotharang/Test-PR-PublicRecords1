...
EXPORT B_Education_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2573077 := __ENH_Education_2;
  EXPORT __ST158124_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST158124_Layout __ND2573209__Project(B_Education_8(__in,__cfg).__ST182677_Layout __PP2573078) := TRANSFORM
    __BS2573120 := __T(__PP2573078.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS2573120(__T(__OP2(__T(__PP2573078.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP2573078;
  END;
  EXPORT __ENH_Education_1 := PROJECT(__EE2573077,__ND2573209__Project(LEFT));
END;
