...
EXPORT B_Education_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2558917 := __ENH_Education_2;
  EXPORT __ST156508_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST156508_Layout __ND2559049__Project(B_Education_8(__in,__cfg).__ST181021_Layout __PP2558918) := TRANSFORM
    __BS2558960 := __T(__PP2558918.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS2558960(__T(__OP2(__T(__PP2558918.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP2558918;
  END;
  EXPORT __ENH_Education_1 := PROJECT(__EE2558917,__ND2559049__Project(LEFT));
END;
