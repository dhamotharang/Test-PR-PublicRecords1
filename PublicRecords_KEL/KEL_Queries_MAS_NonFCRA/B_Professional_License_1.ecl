...
IMPORT KEL16 AS KEL;
IMPORT B_Professional_License_2,CFG_Compile,E_Professional_License FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Professional_License_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3203211 := __ENH_Professional_License_2;
  EXPORT __ST157211_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  EXPORT __ENH_Professional_License_1 := PROJECT(__EE3203211,__ST157211_Layout);
END;
