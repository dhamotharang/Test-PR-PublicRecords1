...
EXPORT B_Person_S_S_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4041584 := __ENH_Person_S_S_N_6;
  EXPORT __ST226304_Layout := RECORD
  ...
  END;
  EXPORT __ST226296_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST226304_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST226296_Layout __ND4041589__Project(B_Person_S_S_N_6(__in,__cfg).__ST226253_Layout __PP4041585) := TRANSFORM
    __EE4041604 := __PP4041585.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4041604),__ST226304_Layout),__NL(__EE4041604));
    SELF := __PP4041585;
  END;
  EXPORT __ENH_Person_S_S_N_5 := PROJECT(__EE4041584,__ND4041589__Project(LEFT));
END;
