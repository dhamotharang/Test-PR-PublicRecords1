...
EXPORT B_Person_S_S_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4803664 := __ENH_Person_S_S_N_6;
  EXPORT __ST234253_Layout := RECORD
  ...
  END;
  EXPORT __ST234245_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST234253_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234245_Layout __ND4803669__Project(B_Person_S_S_N_6(__in,__cfg).__ST234202_Layout __PP4803665) := TRANSFORM
    __EE4803684 := __PP4803665.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4803684),__ST234253_Layout),__NL(__EE4803684));
    SELF := __PP4803665;
  END;
  EXPORT __ENH_Person_S_S_N_5 := PROJECT(__EE4803664,__ND4803669__Project(LEFT));
END;
