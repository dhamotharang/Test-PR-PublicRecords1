...
IMPORT KEL16 AS KEL;
IMPORT B_Person_Accident_6,B_Person_Accident_7,CFG_Compile,E_Accident,E_Person,E_Person_Accident FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Person_Accident_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1633906 := __ENH_Person_Accident_6;
  EXPORT __ENH_Person_Accident_5 := __EE1633906;
END;
