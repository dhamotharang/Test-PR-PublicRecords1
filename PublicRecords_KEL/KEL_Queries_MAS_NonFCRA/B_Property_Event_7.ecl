...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4723416 := __ENH_Property_Event_8;
  EXPORT __ST209947_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST209947_Layout __ND4723421__Project(B_Property_Event_8(__in,__cfg).__ST211531_Layout __PP4723417) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP4723417.Date_Last_Seen_);
    SELF := __PP4723417;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE4723416,__ND4723421__Project(LEFT));
END;
