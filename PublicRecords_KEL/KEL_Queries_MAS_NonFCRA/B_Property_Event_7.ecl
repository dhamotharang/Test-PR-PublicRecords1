...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1618537 := __ENH_Property_Event_8;
  EXPORT __ST183964_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST183964_Layout __ND1618542__Project(B_Property_Event_8(__in,__cfg).__ST185102_Layout __PP1618538) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1618538.Date_Last_Seen_);
    SELF := __PP1618538;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1618537,__ND1618542__Project(LEFT));
END;
