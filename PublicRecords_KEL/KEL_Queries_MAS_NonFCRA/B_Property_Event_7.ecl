...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1595636 := __ENH_Property_Event_8;
  EXPORT __ST180902_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST180902_Layout __ND1595641__Project(B_Property_Event_8(__in,__cfg).__ST182080_Layout __PP1595637) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1595637.Date_Last_Seen_);
    SELF := __PP1595637;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1595636,__ND1595641__Project(LEFT));
END;
