...
IMPORT KEL15 AS KEL;
IMPORT B_Property_Event_8,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3973108 := __ENH_Property_Event_8;
  EXPORT __ST198445_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST198445_Layout __ND3973113__Project(B_Property_Event_8(__in,__cfg).__ST199531_Layout __PP3973109) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP3973109.Date_Last_Seen_);
    SELF := __PP3973109;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE3973108,__ND3973113__Project(LEFT));
END;
