...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1588179 := __ENH_Property_Event_8;
  EXPORT __ST180691_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST180691_Layout __ND1588184__Project(B_Property_Event_8(__in,__cfg).__ST181869_Layout __PP1588180) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1588180.Date_Last_Seen_);
    SELF := __PP1588180;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1588179,__ND1588184__Project(LEFT));
END;
