...
EXPORT B_Address_Summary_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2571069 := __ENH_Address_Summary_2;
  SHARED __EE2571072 := __ENH_Input_P_I_I_2;
  SHARED __ST805454_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST163086_Layout) Name_Summary_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST163094_Layout) Date_Of_Birth_Summary_;
  ...
  END;
  __JC2571428(B_Address_Summary_2(__in,__cfg).__ST163080_Layout __EE2571069, B_Input_P_I_I_2(__in,__cfg).__ST163738_Layout __EE2571072) := __EEQP(__EE2571069.P_I_I_,__EE2571072.UID);
  __ST805454_Layout __JT2571428(B_Address_Summary_2(__in,__cfg).__ST163080_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST163738_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2571429 := JOIN(__EE2571069,__EE2571072,__JC2571428(LEFT,RIGHT),__JT2571428(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST156310_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST156318_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST156304_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(__ST156310_Layout) Name_Summary_;
    KEL.typ.ndataset(__ST156318_Layout) Date_Of_Birth_Summary_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST86197_Layout) Address_Summary_Source_List_Sorted_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST86380_Layout) D_O_B_Source_List_Sorted_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Name_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Rng_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156304_Layout __ND2572062__Project(__ST805454_Layout __PP2571082) := TRANSFORM
    __EE2571319 := __PP2571082.Name_Summary_;
    SELF.Name_Summary_ := __BN(PROJECT(__T(__EE2571319),__ST156310_Layout),__NL(__EE2571319));
    __EE2571347 := __PP2571082.Date_Of_Birth_Summary_;
    SELF.Date_Of_Birth_Summary_ := __BN(PROJECT(__T(__EE2571347),__ST156318_Layout),__NL(__EE2571347));
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP2571082.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP2571082.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP2571082.Input_Zip5_Clean_Value_;
    SELF.Src_W_Inp_A_D_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2571082.D_O_B_Source_List_Sorted_))));
    SELF.Src_W_Inp_F_L_A_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2571082.Address_Summary_Source_List_Sorted_))));
    SELF := __PP2571082;
  END;
  EXPORT __ENH_Address_Summary_1 := PROJECT(__EE2571429,__ND2572062__Project(LEFT));
END;
