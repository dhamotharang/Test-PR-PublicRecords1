...
EXPORT B_Address_Summary_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2557540 := __ENH_Address_Summary_2;
  SHARED __EE2557543 := __ENH_Input_P_I_I_2;
  SHARED __ST801163_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST163729_Layout) Name_Summary_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST163737_Layout) Date_Of_Birth_Summary_;
  ...
  END;
  __JC2557899(B_Address_Summary_2(__in,__cfg).__ST163723_Layout __EE2557540, B_Input_P_I_I_2(__in,__cfg).__ST164381_Layout __EE2557543) := __EEQP(__EE2557540.P_I_I_,__EE2557543.UID);
  __ST801163_Layout __JT2557899(B_Address_Summary_2(__in,__cfg).__ST163723_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST164381_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2557900 := JOIN(__EE2557540,__EE2557543,__JC2557899(LEFT,RIGHT),__JT2557899(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST156957_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST156965_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST156951_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(__ST156957_Layout) Name_Summary_;
    KEL.typ.ndataset(__ST156965_Layout) Date_Of_Birth_Summary_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST86604_Layout) Address_Summary_Source_List_Sorted_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST86787_Layout) D_O_B_Source_List_Sorted_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Name_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Rng_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156951_Layout __ND2558533__Project(__ST801163_Layout __PP2557553) := TRANSFORM
    __EE2557790 := __PP2557553.Name_Summary_;
    SELF.Name_Summary_ := __BN(PROJECT(__T(__EE2557790),__ST156957_Layout),__NL(__EE2557790));
    __EE2557818 := __PP2557553.Date_Of_Birth_Summary_;
    SELF.Date_Of_Birth_Summary_ := __BN(PROJECT(__T(__EE2557818),__ST156965_Layout),__NL(__EE2557818));
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP2557553.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP2557553.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP2557553.Input_Zip5_Clean_Value_;
    SELF.Src_W_Inp_A_D_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2557553.D_O_B_Source_List_Sorted_))));
    SELF.Src_W_Inp_F_L_A_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2557553.Address_Summary_Source_List_Sorted_))));
    SELF := __PP2557553;
  END;
  EXPORT __ENH_Address_Summary_1 := PROJECT(__EE2557900,__ND2558533__Project(LEFT));
END;
