...
EXPORT B_Address_Summary_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2577346 := __ENH_Address_Summary_2;
  SHARED __EE2577349 := __ENH_Input_P_I_I_2;
  SHARED __ST811831_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST168806_Layout) Name_Summary_;
    KEL.typ.ndataset(B_Address_Summary_2(__in,__cfg).__ST168814_Layout) Date_Of_Birth_Summary_;
  ...
  END;
  __JC2577705(B_Address_Summary_2(__in,__cfg).__ST168800_Layout __EE2577346, B_Input_P_I_I_2(__in,__cfg).__ST169458_Layout __EE2577349) := __EEQP(__EE2577346.P_I_I_,__EE2577349.UID);
  __ST811831_Layout __JT2577705(B_Address_Summary_2(__in,__cfg).__ST168800_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST169458_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2577706 := JOIN(__EE2577346,__EE2577349,__JC2577705(LEFT,RIGHT),__JT2577705(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST162030_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST162038_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST162024_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Name_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Zip_;
    KEL.typ.ndataset(__ST162030_Layout) Name_Summary_;
    KEL.typ.ndataset(__ST162038_Layout) Date_Of_Birth_Summary_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST89278_Layout) Address_Summary_Source_List_Sorted_;
    KEL.typ.ndataset(B_Address_Summary_3(__in,__cfg).__ST89461_Layout) D_O_B_Source_List_Sorted_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Name_;
    KEL.typ.nstr P___Inp_Cln_Addr_Prim_Rng_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162024_Layout __ND2578339__Project(__ST811831_Layout __PP2577359) := TRANSFORM
    __EE2577596 := __PP2577359.Name_Summary_;
    SELF.Name_Summary_ := __BN(PROJECT(__T(__EE2577596),__ST162030_Layout),__NL(__EE2577596));
    __EE2577624 := __PP2577359.Date_Of_Birth_Summary_;
    SELF.Date_Of_Birth_Summary_ := __BN(PROJECT(__T(__EE2577624),__ST162038_Layout),__NL(__EE2577624));
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP2577359.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP2577359.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP2577359.Input_Zip5_Clean_Value_;
    SELF.Src_W_Inp_A_D_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2577359.D_O_B_Source_List_Sorted_))));
    SELF.Src_W_Inp_F_L_A_List_No_Data_ := __NOT(__CN(EXISTS(__T(__PP2577359.Address_Summary_Source_List_Sorted_))));
    SELF := __PP2577359;
  END;
  EXPORT __ENH_Address_Summary_1 := PROJECT(__EE2577706,__ND2578339__Project(LEFT));
END;
