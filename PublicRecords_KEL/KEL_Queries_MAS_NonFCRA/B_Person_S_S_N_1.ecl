...
EXPORT B_Person_S_S_N_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8285329 := __ENH_Person_S_S_N_2;
  EXPORT __ST178485_Layout := RECORD
  ...
  END;
  EXPORT __ST178477_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST178485_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST178477_Layout __ND8285334__Project(B_Person_S_S_N_2(__in,__cfg).__ST234403_Layout __PP8285330) := TRANSFORM
    __EE8285350 := __PP8285330.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8285350),__ST178485_Layout),__NL(__EE8285350));
    SELF := __PP8285330;
  END;
  EXPORT __ENH_Person_S_S_N_1 := PROJECT(__EE8285329,__ND8285334__Project(LEFT));
END;
