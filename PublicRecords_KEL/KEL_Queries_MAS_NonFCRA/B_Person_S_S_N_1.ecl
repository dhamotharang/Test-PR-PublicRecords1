...
EXPORT B_Person_S_S_N_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6487791 := __ENH_Person_S_S_N_2;
  EXPORT __ST170694_Layout := RECORD
  ...
  END;
  EXPORT __ST170686_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST170694_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170686_Layout __ND6487796__Project(B_Person_S_S_N_2(__in,__cfg).__ST226434_Layout __PP6487792) := TRANSFORM
    __EE6487812 := __PP6487792.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6487812),__ST170694_Layout),__NL(__EE6487812));
    SELF := __PP6487792;
  END;
  EXPORT __ENH_Person_S_S_N_1 := PROJECT(__EE6487791,__ND6487796__Project(LEFT));
END;
