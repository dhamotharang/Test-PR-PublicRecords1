...
IMPORT KEL16 AS KEL;
IMPORT B_Property_Event_6,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Property_Event_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1654910 := __ENH_Property_Event_6;
  EXPORT __ENH_Property_Event_5 := __EE1654910;
END;
