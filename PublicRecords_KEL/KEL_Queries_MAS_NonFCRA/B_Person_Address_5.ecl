...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_6,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
IMPORT * FROM KEL15.Null;
EXPORT B_Person_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4789875 := __ENH_Person_Address_6;
  EXPORT __ST248752_Layout := RECORD
  ...
  END;
  EXPORT __ST248696_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST248752_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248696_Layout __ND4789880__Project(B_Person_Address_6(__in,__cfg).__ST233656_Layout __PP4789876) := TRANSFORM
    __EE4789981 := __PP4789876.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4789981),__ST248752_Layout),__NL(__EE4789981));
    SELF := __PP4789876;
  END;
  EXPORT __ENH_Person_Address_5 := PROJECT(__EE4789875,__ND4789880__Project(LEFT));
END;
