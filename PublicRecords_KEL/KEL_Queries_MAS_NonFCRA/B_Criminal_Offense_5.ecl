...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1615520 := __ENH_Criminal_Offense_6;
  EXPORT __ST177400_Layout := RECORD
  ...
  END;
  EXPORT __ST177353_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST177400_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177353_Layout __ND1615525__Project(B_Criminal_Offense_6(__in,__cfg).__ST179751_Layout __PP1615521) := TRANSFORM
    __EE1615681 := __PP1615521.Offense_Charges_;
    __ST177400_Layout __ND1615686__Project(B_Criminal_Offense_6(__in,__cfg).__ST179798_Layout __PP1615682) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1615682.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13114));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP1615682.Dismissed_Charges_);
      SELF := __PP1615682;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1615681,__ND1615686__Project(LEFT));
    SELF := __PP1615521;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE1615520,__ND1615525__Project(LEFT));
END;
