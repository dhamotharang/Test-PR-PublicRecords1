...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1608972 := __ENH_Criminal_Offense_6;
  ...
  EXPORT __ST176531_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST176578_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST176531_Layout __ND1608977__Project(B_Criminal_Offense_6(__in,__cfg).__ST178925_Layout __PP1608973) := TRANSFORM
    __EE1609133 := __PP1608973.Offense_Charges_;
    __ST176578_Layout __ND1609138__Project(B_Criminal_Offense_6(__in,__cfg).__ST178972_Layout __PP1609134) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1609134.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13192));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP1609134.Dismissed_Charges_);
      SELF := __PP1609134;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1609133,__ND1609138__Project(LEFT));
    SELF := __PP1608973;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE1608972,__ND1608977__Project(LEFT));
END;
