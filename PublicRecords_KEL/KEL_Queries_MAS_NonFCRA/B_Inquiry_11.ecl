...
EXPORT B_Inquiry_11(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3943177 := __E_Inquiry;
  EXPORT __ST200800_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST200800_Layout __ND3943110__Project(E_Inquiry(__in,__cfg).Layout __PP256931) := TRANSFORM
    __EE3943103 := __PP256931.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE3943103))[1].Sub_Market_,'');
    SELF := __PP256931;
  END;
  EXPORT __ENH_Inquiry_11 := PROJECT(__EE3943177,__ND3943110__Project(LEFT));
END;
