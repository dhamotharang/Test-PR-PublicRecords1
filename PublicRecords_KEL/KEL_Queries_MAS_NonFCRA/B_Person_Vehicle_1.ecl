...
EXPORT B_Person_Vehicle_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3276097 := __ENH_Person_Vehicle_2;
  EXPORT __ST162499_Layout := RECORD
  ...
  END;
  SHARED __ST162499_Layout __ND3276261__Project(B_Person_Vehicle_2(__in,__cfg).__ST167684_Layout __PP3276098) := TRANSFORM
    ...
    __CC13763 := 3652;
    SELF.Seen___In___Last___Ten___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP3276098.Date_Last_Seen_Capped_,__CC13267),<=,__CN(__CC13763));
    __CC13765 := 730;
    SELF.Seen___In___Last___Two___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP3276098.Date_Last_Seen_Capped_,__CC13267),<=,__CN(__CC13765));
    SELF := __PP3276098;
  END;
  EXPORT __ENH_Person_Vehicle_1 := PROJECT(__EE3276097,__ND3276261__Project(LEFT));
END;
