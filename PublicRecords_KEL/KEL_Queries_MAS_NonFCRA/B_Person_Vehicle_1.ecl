...
EXPORT B_Person_Vehicle_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3276136 := __ENH_Person_Vehicle_2;
  EXPORT __ST162544_Layout := RECORD
  ...
  END;
  SHARED __ST162544_Layout __ND3276300__Project(B_Person_Vehicle_2(__in,__cfg).__ST167729_Layout __PP3276137) := TRANSFORM
    ...
    __CC13808 := 3652;
    SELF.Seen___In___Last___Ten___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP3276137.Date_Last_Seen_Capped_,__CC13312),<=,__CN(__CC13808));
    __CC13810 := 730;
    SELF.Seen___In___Last___Two___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP3276137.Date_Last_Seen_Capped_,__CC13312),<=,__CN(__CC13810));
    SELF := __PP3276137;
  END;
  EXPORT __ENH_Person_Vehicle_1 := PROJECT(__EE3276136,__ND3276300__Project(LEFT));
END;
