...
EXPORT B_Person_S_S_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5492816 := __ENH_Person_S_S_N_4;
  EXPORT __ST234358_Layout := RECORD
  ...
  END;
  EXPORT __ST234350_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST234358_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234350_Layout __ND5492821__Project(B_Person_S_S_N_4(__in,__cfg).__ST234297_Layout __PP5492817) := TRANSFORM
    __EE5492837 := __PP5492817.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5492837),__ST234358_Layout),__NL(__EE5492837));
    SELF := __PP5492817;
  END;
  EXPORT __ENH_Person_S_S_N_3 := PROJECT(__EE5492816,__ND5492821__Project(LEFT));
END;
