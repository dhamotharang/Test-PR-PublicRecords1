...
EXPORT B_Person_S_S_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4684433 := __ENH_Person_S_S_N_4;
  EXPORT __ST226390_Layout := RECORD
  ...
  END;
  EXPORT __ST226382_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST226390_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST226382_Layout __ND4684438__Project(B_Person_S_S_N_4(__in,__cfg).__ST226339_Layout __PP4684434) := TRANSFORM
    __EE4684453 := __PP4684434.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4684453),__ST226390_Layout),__NL(__EE4684453));
    SELF := __PP4684434;
  END;
  EXPORT __ENH_Person_S_S_N_3 := PROJECT(__EE4684433,__ND4684438__Project(LEFT));
END;
