...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1713617 := __ENH_Criminal_Offense_4;
  EXPORT __ST170939_Layout := RECORD
  ...
  END;
  EXPORT __ST170892_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST170939_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170892_Layout __ND1714037__Project(B_Criminal_Offense_4(__in,__cfg).__ST174856_Layout __PP1713618) := TRANSFORM
    __EE1713778 := __PP1713618.Offense_Charges_;
    __ST170939_Layout __ND1714019__Project(B_Criminal_Offense_4(__in,__cfg).__ST174903_Layout __PP1713779) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1713779.Dismissed_Charges_),IF(__T(__NT(__PP1713779.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1713779.Offense_Score_,=,__CN('F'))))),__OP2(__PP1713779.Offender_Level_,=,__CN('4')));
      SELF := __PP1713779;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1713778,__ND1714019__Project(LEFT));
    SELF := __PP1713618;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1713617,__ND1714037__Project(LEFT));
END;
