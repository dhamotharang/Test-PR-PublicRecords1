...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1718770 := __ENH_Criminal_Offense_4;
  ...
  END;
  EXPORT __ST174495_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST174542_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174495_Layout __ND1719190__Project(B_Criminal_Offense_4(__in,__cfg).__ST178459_Layout __PP1718771) := TRANSFORM
    __EE1718931 := __PP1718771.Offense_Charges_;
    __ST174542_Layout __ND1719172__Project(B_Criminal_Offense_4(__in,__cfg).__ST178506_Layout __PP1718932) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1718932.Dismissed_Charges_),IF(__T(__NT(__PP1718932.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1718932.Offense_Score_,=,__CN('F'))))),__OP2(__PP1718932.Offender_Level_,=,__CN('4')));
      SELF := __PP1718932;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1718931,__ND1719172__Project(LEFT));
    SELF := __PP1718771;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1718770,__ND1719190__Project(LEFT));
END;
