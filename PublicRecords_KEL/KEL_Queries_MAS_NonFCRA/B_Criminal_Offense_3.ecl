...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1705441 := __ENH_Criminal_Offense_4;
  EXPORT __ST169459_Layout := RECORD
  ...
  END;
  EXPORT __ST169412_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169459_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169412_Layout __ND1705861__Project(B_Criminal_Offense_4(__in,__cfg).__ST173366_Layout __PP1705442) := TRANSFORM
    __EE1705602 := __PP1705442.Offense_Charges_;
    __ST169459_Layout __ND1705843__Project(B_Criminal_Offense_4(__in,__cfg).__ST173413_Layout __PP1705603) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1705603.Dismissed_Charges_),IF(__T(__NT(__PP1705603.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1705603.Offense_Score_,=,__CN('F'))))),__OP2(__PP1705603.Offender_Level_,=,__CN('4')));
      SELF := __PP1705603;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1705602,__ND1705843__Project(LEFT));
    SELF := __PP1705442;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1705441,__ND1705861__Project(LEFT));
END;
