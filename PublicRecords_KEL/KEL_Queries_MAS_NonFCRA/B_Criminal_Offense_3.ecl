...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1705402 := __ENH_Criminal_Offense_4;
  EXPORT __ST169414_Layout := RECORD
  ...
  END;
  EXPORT __ST169367_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169414_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169367_Layout __ND1705822__Project(B_Criminal_Offense_4(__in,__cfg).__ST173321_Layout __PP1705403) := TRANSFORM
    __EE1705563 := __PP1705403.Offense_Charges_;
    __ST169414_Layout __ND1705804__Project(B_Criminal_Offense_4(__in,__cfg).__ST173368_Layout __PP1705564) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1705564.Dismissed_Charges_),IF(__T(__NT(__PP1705564.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1705564.Offense_Score_,=,__CN('F'))))),__OP2(__PP1705564.Offender_Level_,=,__CN('4')));
      SELF := __PP1705564;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1705563,__ND1705804__Project(LEFT));
    SELF := __PP1705403;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1705402,__ND1705822__Project(LEFT));
END;
