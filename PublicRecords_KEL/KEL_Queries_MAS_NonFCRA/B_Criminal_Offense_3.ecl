...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1713130 := __ENH_Criminal_Offense_4;
  EXPORT __ST168820_Layout := RECORD
  ...
  EXPORT __ST168773_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST168820_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168773_Layout __ND1713550__Project(B_Criminal_Offense_4(__in,__cfg).__ST172737_Layout __PP1713131) := TRANSFORM
    __EE1713291 := __PP1713131.Offense_Charges_;
    __ST168820_Layout __ND1713532__Project(B_Criminal_Offense_4(__in,__cfg).__ST172784_Layout __PP1713292) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1713292.Dismissed_Charges_),IF(__T(__NT(__PP1713292.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1713292.Offense_Score_,=,__CN('F'))))),__OP2(__PP1713292.Offender_Level_,=,__CN('4')));
      SELF := __PP1713292;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1713291,__ND1713532__Project(LEFT));
    SELF := __PP1713131;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1713130,__ND1713550__Project(LEFT));
END;
