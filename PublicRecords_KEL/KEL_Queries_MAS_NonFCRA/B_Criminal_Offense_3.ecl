...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1704623 := __ENH_Criminal_Offense_4;
  EXPORT __ST168641_Layout := RECORD
  ...
  END;
  EXPORT __ST168594_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST168641_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168594_Layout __ND1705043__Project(B_Criminal_Offense_4(__in,__cfg).__ST172548_Layout __PP1704624) := TRANSFORM
    __EE1704784 := __PP1704624.Offense_Charges_;
    __ST168641_Layout __ND1705025__Project(B_Criminal_Offense_4(__in,__cfg).__ST172595_Layout __PP1704785) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1704785.Dismissed_Charges_),IF(__T(__NT(__PP1704785.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1704785.Offense_Score_,=,__CN('F'))))),__OP2(__PP1704785.Offender_Level_,=,__CN('4')));
      SELF := __PP1704785;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1704784,__ND1705025__Project(LEFT));
    SELF := __PP1704624;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1704623,__ND1705043__Project(LEFT));
END;
