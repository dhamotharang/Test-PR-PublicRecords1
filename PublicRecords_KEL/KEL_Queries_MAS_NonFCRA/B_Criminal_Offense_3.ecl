...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1712943 := __ENH_Criminal_Offense_4;
  EXPORT __ST170265_Layout := RECORD
  ...
  END;
  EXPORT __ST170218_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST170265_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170218_Layout __ND1713363__Project(B_Criminal_Offense_4(__in,__cfg).__ST174182_Layout __PP1712944) := TRANSFORM
    __EE1713104 := __PP1712944.Offense_Charges_;
    __ST170265_Layout __ND1713345__Project(B_Criminal_Offense_4(__in,__cfg).__ST174229_Layout __PP1713105) := TRANSFORM
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP1713105.Dismissed_Charges_),IF(__T(__NT(__PP1713105.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1713105.Offense_Score_,=,__CN('F'))))),__OP2(__PP1713105.Offender_Level_,=,__CN('4')));
      SELF := __PP1713105;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1713104,__ND1713345__Project(LEFT));
    SELF := __PP1712944;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1712943,__ND1713363__Project(LEFT));
END;
