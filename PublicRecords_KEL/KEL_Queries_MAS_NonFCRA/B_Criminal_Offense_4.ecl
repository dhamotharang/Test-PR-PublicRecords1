...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4805875 := __ENH_Criminal_Offense_5;
  EXPORT __ST197251_Layout := RECORD
  ...
  EXPORT __ST197204_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST197251_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197204_Layout __ND4805880__Project(B_Criminal_Offense_5(__in,__cfg).__ST202279_Layout __PP4805876) := TRANSFORM
    __EE4806036 := __PP4805876.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE4806036),__ST197251_Layout),__NL(__EE4806036));
    SELF := __PP4805876;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE4805875,__ND4805880__Project(LEFT));
END;
