...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1663147 := __ENH_Criminal_Offense_5;
  EXPORT __ST169425_Layout := RECORD
  ...
  END;
  EXPORT __ST169378_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169425_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169378_Layout __ND1663152__Project(B_Criminal_Offense_5(__in,__cfg).__ST172625_Layout __PP1663148) := TRANSFORM
    __EE1663308 := __PP1663148.Offense_Charges_;
    __ST169425_Layout __ND1663313__Project(B_Criminal_Offense_5(__in,__cfg).__ST172672_Layout __PP1663309) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1663309.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13186));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP1663309.Dismissed_Charges_);
      SELF := __PP1663309;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1663308,__ND1663313__Project(LEFT));
    SELF := __PP1663148;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1663147,__ND1663152__Project(LEFT));
END;
