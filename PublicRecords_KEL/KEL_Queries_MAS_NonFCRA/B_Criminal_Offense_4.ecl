...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4043778 := __ENH_Criminal_Offense_5;
  EXPORT __ST187807_Layout := RECORD
  ...
  END;
  EXPORT __ST187760_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST187807_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST187760_Layout __ND4043783__Project(B_Criminal_Offense_5(__in,__cfg).__ST192175_Layout __PP4043779) := TRANSFORM
    __EE4043939 := __PP4043779.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE4043939),__ST187807_Layout),__NL(__EE4043939));
    SELF := __PP4043779;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE4043778,__ND4043783__Project(LEFT));
END;
