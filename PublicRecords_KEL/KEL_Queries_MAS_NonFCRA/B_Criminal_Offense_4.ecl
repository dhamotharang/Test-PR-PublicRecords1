...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1664062 := __ENH_Criminal_Offense_5;
  EXPORT __ST168416_Layout := RECORD
  ...
  END;
  EXPORT __ST168369_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST168416_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168369_Layout __ND1664067__Project(B_Criminal_Offense_5(__in,__cfg).__ST171608_Layout __PP1664063) := TRANSFORM
    __EE1664223 := __PP1664063.Offense_Charges_;
    __ST168416_Layout __ND1664228__Project(B_Criminal_Offense_5(__in,__cfg).__ST171655_Layout __PP1664224) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1664224.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13315));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP1664224.Dismissed_Charges_);
      SELF := __PP1664224;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1664223,__ND1664228__Project(LEFT));
    SELF := __PP1664063;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1664062,__ND1664067__Project(LEFT));
END;
