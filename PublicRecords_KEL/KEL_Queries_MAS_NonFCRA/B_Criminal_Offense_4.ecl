...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1648397 := __ENH_Criminal_Offense_5;
  EXPORT __ST172595_Layout := RECORD
  ...
  EXPORT __ST172548_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST172595_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172548_Layout __ND1648402__Project(B_Criminal_Offense_5(__in,__cfg).__ST175713_Layout __PP1648398) := TRANSFORM
    __EE1648558 := __PP1648398.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1648558),__ST172595_Layout),__NL(__EE1648558));
    SELF := __PP1648398;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1648397,__ND1648402__Project(LEFT));
END;
