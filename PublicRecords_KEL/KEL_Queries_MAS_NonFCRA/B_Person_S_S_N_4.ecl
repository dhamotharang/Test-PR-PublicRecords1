...
EXPORT B_Person_S_S_N_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1741129 := __ENH_Person_S_S_N_5;
  ...
  END;
  EXPORT __ST177864_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST177872_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177864_Layout __ND1741134__Project(B_Person_S_S_N_5(__in,__cfg).__ST180616_Layout __PP1741130) := TRANSFORM
    __EE1741149 := __PP1741130.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1741149),__ST177872_Layout),__NL(__EE1741149));
    SELF := __PP1741130;
  END;
  EXPORT __ENH_Person_S_S_N_4 := PROJECT(__EE1741129,__ND1741134__Project(LEFT));
END;
