...
EXPORT B_Person_S_S_N_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4147506 := __ENH_Person_S_S_N_5;
  EXPORT __ST226347_Layout := RECORD
  ...
  END;
  EXPORT __ST226339_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST226347_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST226339_Layout __ND4147511__Project(B_Person_S_S_N_5(__in,__cfg).__ST226296_Layout __PP4147507) := TRANSFORM
    __EE4147526 := __PP4147507.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4147526),__ST226347_Layout),__NL(__EE4147526));
    SELF := __PP4147507;
  END;
  EXPORT __ENH_Person_S_S_N_4 := PROJECT(__EE4147506,__ND4147511__Project(LEFT));
END;
