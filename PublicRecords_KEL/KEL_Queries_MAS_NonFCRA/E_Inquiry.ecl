...
EXPORT E_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d0(__NL(Date_Of_Birth_Padded_))),COUNT(__d0(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d1(__NL(Date_Of_Birth_Padded_))),COUNT(__d1(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d2(__NL(Date_Of_Birth_Padded_))),COUNT(__d2(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d3(__NL(Date_Of_Birth_Padded_))),COUNT(__d3(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d4(__NL(Date_Of_Birth_Padded_))),COUNT(__d4(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d5(__NL(Date_Of_Birth_Padded_))),COUNT(__d5(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d6(__NL(Date_Of_Birth_Padded_))),COUNT(__d6(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d7(__NL(Date_Of_Birth_Padded_))),COUNT(__d7(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d8(__NL(Date_Of_Birth_Padded_))),COUNT(__d8(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d9(__NL(Date_Of_Birth_Padded_))),COUNT(__d9(__NN(Date_Of_Birth_Padded_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthPadded',COUNT(__d11(__NL(Date_Of_Birth_Padded_))),COUNT(__d11(__NN(Date_Of_Birth_Padded_)))},
