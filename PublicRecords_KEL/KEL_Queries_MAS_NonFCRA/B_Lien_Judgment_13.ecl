...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE209097 := __E_Lien_Judgment;
  EXPORT __ST182979_Layout := RECORD
  ...
  END;
  EXPORT __ST182974_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST182979_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST182974_Layout __ND209406__Project(E_Lien_Judgment(__in,__cfg).Layout __PP209339) := TRANSFORM
    __EE208945 := __PP209339.Filing_;
    __ST182979_Layout __ND209342__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP209341) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP209339.T_M_S_I_D_;
      SELF := __PP209341;
    END;
    SELF.Filing_ := __PROJECT(__EE208945,__ND209342__Project(LEFT));
    SELF := __PP209339;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE209097,__ND209406__Project(LEFT));
END;
