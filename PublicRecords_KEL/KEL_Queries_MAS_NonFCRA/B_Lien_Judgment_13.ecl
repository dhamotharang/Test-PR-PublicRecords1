...
EXPORT B_Lien_Judgment_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE213044 := __E_Lien_Judgment;
  EXPORT __ST186372_Layout := RECORD
  ...
  END;
  EXPORT __ST186367_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST186372_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186367_Layout __ND213353__Project(E_Lien_Judgment(__in,__cfg).Layout __PP213286) := TRANSFORM
    __EE212892 := __PP213286.Filing_;
    __ST186372_Layout __ND213289__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP213288) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP213286.T_M_S_I_D_;
      SELF := __PP213288;
    END;
    SELF.Filing_ := __PROJECT(__EE212892,__ND213289__Project(LEFT));
    SELF := __PP213286;
  END;
  EXPORT __ENH_Lien_Judgment_13 := PROJECT(__EE213044,__ND213353__Project(LEFT));
END;
