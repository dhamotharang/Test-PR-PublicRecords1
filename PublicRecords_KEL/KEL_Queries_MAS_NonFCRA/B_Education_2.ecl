...
IMPORT KEL16 AS KEL;
IMPORT B_Education_3,B_Education_8,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1910461 := __ENH_Education_3;
  EXPORT __ENH_Education_2 := __EE1910461;
END;
