...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2070154 := __ENH_Education_3;
  EXPORT __ST200602_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST200602_Layout __ND2070286__Project(B_Education_7(__in,__cfg).__ST183115_Layout __PP2070155) := TRANSFORM
    __BS2070197 := __T(__PP2070155.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS2070197(__T(__OP2(__T(__PP2070155.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP2070155;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE2070154,__ND2070286__Project(LEFT));
END;
