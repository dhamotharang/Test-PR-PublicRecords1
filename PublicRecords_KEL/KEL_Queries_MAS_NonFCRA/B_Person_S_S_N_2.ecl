...
EXPORT B_Person_S_S_N_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6383107 := __ENH_Person_S_S_N_3;
  EXPORT __ST234411_Layout := RECORD
  ...
  END;
  EXPORT __ST234403_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST234411_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234403_Layout __ND6383112__Project(B_Person_S_S_N_3(__in,__cfg).__ST234350_Layout __PP6383108) := TRANSFORM
    __EE6383128 := __PP6383108.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6383128),__ST234411_Layout),__NL(__EE6383128));
    SELF := __PP6383108;
  END;
  EXPORT __ENH_Person_S_S_N_2 := PROJECT(__EE6383107,__ND6383112__Project(LEFT));
END;
