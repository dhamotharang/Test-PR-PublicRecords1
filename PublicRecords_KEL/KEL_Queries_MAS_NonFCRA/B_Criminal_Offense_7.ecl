...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4703910 := __ENH_Criminal_Offense_8;
  EXPORT __ST208316_Layout := RECORD
  ...
  END;
  EXPORT __ST208269_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST208316_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208269_Layout __ND4704288__Project(B_Criminal_Offense_8(__in,__cfg).__ST210150_Layout __PP4703911) := TRANSFORM
    __EE4704071 := __PP4703911.Offense_Charges_;
    __ST208316_Layout __ND4704275__Project(B_Criminal_Offense_8(__in,__cfg).__ST210197_Layout __PP4704072) := TRANSFORM
      __CC14097 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP4704072.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP4704072.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14097)));
      SELF := __PP4704072;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE4704071,__ND4704275__Project(LEFT));
    SELF := __PP4703911;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE4703910,__ND4704288__Project(LEFT));
END;
