...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3955216 := __ENH_Criminal_Offense_8;
  EXPORT __ST197341_Layout := RECORD
  ...
  END;
  EXPORT __ST197294_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST197341_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197294_Layout __ND3955594__Project(B_Criminal_Offense_8(__in,__cfg).__ST198648_Layout __PP3955217) := TRANSFORM
    __EE3955377 := __PP3955217.Offense_Charges_;
    __ST197341_Layout __ND3955581__Project(B_Criminal_Offense_8(__in,__cfg).__ST198695_Layout __PP3955378) := TRANSFORM
      __CC13860 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP3955378.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP3955378.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13860)));
      SELF := __PP3955378;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE3955377,__ND3955581__Project(LEFT));
    SELF := __PP3955217;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE3955216,__ND3955594__Project(LEFT));
END;
