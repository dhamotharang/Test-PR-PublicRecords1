...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1583226 := __ENH_Criminal_Offense_8;
  EXPORT __ST185739_Layout := RECORD
  ...
  END;
  EXPORT __ST185692_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST185739_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185692_Layout __ND1583604__Project(B_Criminal_Offense_8(__in,__cfg).__ST186853_Layout __PP1583227) := TRANSFORM
    __EE1583387 := __PP1583227.Offense_Charges_;
    __ST185739_Layout __ND1583591__Project(B_Criminal_Offense_8(__in,__cfg).__ST186900_Layout __PP1583388) := TRANSFORM
      __CC14121 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1583388.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1583388.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14121)));
      SELF := __PP1583388;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1583387,__ND1583591__Project(LEFT));
    SELF := __PP1583227;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE1583226,__ND1583604__Project(LEFT));
END;
