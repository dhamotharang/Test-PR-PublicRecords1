...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1578241 := __ENH_Criminal_Offense_8;
  EXPORT __ST181460_Layout := RECORD
  ...
  END;
  EXPORT __ST181413_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST181460_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181413_Layout __ND1578619__Project(B_Criminal_Offense_8(__in,__cfg).__ST182574_Layout __PP1578242) := TRANSFORM
    __EE1578402 := __PP1578242.Offense_Charges_;
    __ST181460_Layout __ND1578606__Project(B_Criminal_Offense_8(__in,__cfg).__ST182621_Layout __PP1578403) := TRANSFORM
      __CC13896 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1578403.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1578403.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13896)));
      SELF := __PP1578403;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1578402,__ND1578606__Project(LEFT));
    SELF := __PP1578242;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE1578241,__ND1578619__Project(LEFT));
END;
