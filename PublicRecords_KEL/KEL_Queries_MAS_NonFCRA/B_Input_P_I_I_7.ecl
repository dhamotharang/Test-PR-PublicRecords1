...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_8,B_Input_P_I_I_9,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Input_P_I_I_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4704437 := __ENH_Input_P_I_I_8;
  EXPORT __ST220517_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST220517_Layout __ND4705029__Project(B_Input_P_I_I_9(__in,__cfg).__ST211936_Layout __PP4704438) := TRANSFORM
    __CC13660 := '-99999';
    __CC13665 := '-99998';
    SELF.Input_Post_Direction_Clean_Value_ := MAP(__PP4704438.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4704438.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4704438.P___Inp_Cln_Addr_Post_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Unit_Desig_Clean_Value_ := MAP(__PP4704438.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4704438.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4704438.P___Inp_Cln_Addr_Unit_Desig_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF := __PP4704438;
  END;
  EXPORT __ENH_Input_P_I_I_7 := PROJECT(__EE4704437,__ND4705029__Project(LEFT));
END;
