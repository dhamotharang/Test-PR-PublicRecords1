...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1709018 := __ENH_Person_Property_5;
  EXPORT __ST181572_Layout := RECORD
  ...
  END;
  SHARED __ST181572_Layout __ND1709023__Project(B_Person_Property_5(__in,__cfg).__ST180546_Layout __PP1709019) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1709019.Property_Is_Owned_Assessment_ OR __PP1709019.Property_Is_Owned_Deed_) AND NOT (__PP1709019.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1709019.Property_Purchase_Date_Last_Seen_Capped_,__CC13274);
    SELF := __PP1709019;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1709018,__ND1709023__Project(LEFT));
END;
