...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1698703 := __ENH_Person_Property_5;
  EXPORT __ST187107_Layout := RECORD
  ...
  END;
  SHARED __ST187107_Layout __ND1698708__Project(B_Person_Property_5(__in,__cfg).__ST184166_Layout __PP1698704) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1698704.Property_Is_Owned_Assessment_ OR __PP1698704.Property_Is_Owned_Deed_) AND NOT (__PP1698704.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1698704.Property_Purchase_Date_Last_Seen_Capped_,__CC13229);
    SELF := __PP1698704;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1698703,__ND1698708__Project(LEFT));
END;
