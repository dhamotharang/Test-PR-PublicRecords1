...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1707210 := __ENH_Person_Property_5;
  EXPORT __ST185824_Layout := RECORD
  ...
  END;
  SHARED __ST185824_Layout __ND1707215__Project(B_Person_Property_5(__in,__cfg).__ST184385_Layout __PP1707211) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1707211.Property_Is_Owned_Assessment_ OR __PP1707211.Property_Is_Owned_Deed_) AND NOT (__PP1707211.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1707211.Property_Purchase_Date_Last_Seen_Capped_,__CC13202);
    SELF := __PP1707211;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1707210,__ND1707215__Project(LEFT));
END;
