...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1712850 := __ENH_Person_Property_5;
  ...
  END;
  SHARED __ST193062_Layout __ND1712855__Project(B_Person_Property_5(__in,__cfg).__ST190109_Layout __PP1712851) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1712851.Property_Is_Owned_Assessment_ OR __PP1712851.Property_Is_Owned_Deed_) AND NOT (__PP1712851.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1712851.Property_Purchase_Date_Last_Seen_Capped_,__CC13427);
    SELF := __PP1712851;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1712850,__ND1712855__Project(LEFT));
END;
