...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4147240 := __ENH_Person_Property_5;
  ...
  END;
  SHARED __ST191104_Layout __ND4147245__Project(B_Person_Property_5(__in,__cfg).__ST194414_Layout __PP4147241) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP4147241.Property_Is_Owned_Assessment_ OR __PP4147241.Property_Is_Owned_Deed_) AND NOT (__PP4147241.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP4147241.Property_Purchase_Date_Last_Seen_Capped_,__CC13330);
    SELF := __PP4147241;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE4147240,__ND4147245__Project(LEFT));
END;
