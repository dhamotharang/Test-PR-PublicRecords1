...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1699521 := __ENH_Person_Property_5;
  EXPORT __ST187925_Layout := RECORD
  ...
  END;
  SHARED __ST187925_Layout __ND1699526__Project(B_Person_Property_5(__in,__cfg).__ST184984_Layout __PP1699522) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1699522.Property_Is_Owned_Assessment_ OR __PP1699522.Property_Is_Owned_Deed_) AND NOT (__PP1699522.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1699522.Property_Purchase_Date_Last_Seen_Capped_,__CC13280);
    SELF := __PP1699522;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1699521,__ND1699526__Project(LEFT));
END;
