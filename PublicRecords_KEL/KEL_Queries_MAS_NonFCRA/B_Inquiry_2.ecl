...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2071037 := __ENH_Inquiry_3;
  EXPORT __ST166130_Layout := RECORD
  ...
  END;
  EXPORT __ST166103_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST166130_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166103_Layout __ND2071042__Project(B_Inquiry_3(__in,__cfg).__ST190424_Layout __PP2071038) := TRANSFORM
    __EE2071099 := __PP2071038.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE2071099),__ST166130_Layout),__NL(__EE2071099));
    SELF := __PP2071038;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE2071037,__ND2071042__Project(LEFT));
END;
