...
EXPORT B_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911169 := __ENH_Inquiry_3;
  EXPORT __ST164599_Layout := RECORD
  ...
  END;
  EXPORT __ST164572_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST164599_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST164572_Layout __ND1911174__Project(B_Inquiry_3(__in,__cfg).__ST188102_Layout __PP1911170) := TRANSFORM
    __EE1911231 := __PP1911170.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1911231),__ST164599_Layout),__NL(__EE1911231));
    SELF := __PP1911170;
  END;
  EXPORT __ENH_Inquiry_2 := PROJECT(__EE1911169,__ND1911174__Project(LEFT));
END;
