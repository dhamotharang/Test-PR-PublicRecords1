...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1710605 := __ENH_Person_Inquiry_5;
  EXPORT __ST330013_Layout := RECORD
  ...
  EXPORT __ST170460_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170460_Layout __ND1710591__Project(B_Person_Inquiry_5(__in,__cfg).__ST173175_Layout __PP1710305) := TRANSFORM
    __EE1710589 := __PP1710305.Gather_Inquiries_;
    __ST330013_Layout __ND1710540__Project(B_Person_Inquiry_5(__in,__cfg).__ST274963_Layout __PP1710330) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP1710330.Is_Banking_ OR __PP1710330.Is_Auto_Srch_ OR __PP1710330.Is_Retail_ OR __PP1710330.Is_Mortgage_ OR __PP1710330.Is_Utility_ OR __PP1710330.Is_Prepaid_Card_ OR __PP1710330.Is_Communications_ OR __PP1710330.Is_Student_Loan_ OR __PP1710330.Is_Retail_Payment_ OR __PP1710330.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP1710330.Valid_Inquiries_,__CN(__PP1710330.Is_Retail_));
      SELF := __PP1710330;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE1710589,__ND1710540__Project(LEFT));
    SELF := __PP1710305;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE1710605,__ND1710591__Project(LEFT));
END;
