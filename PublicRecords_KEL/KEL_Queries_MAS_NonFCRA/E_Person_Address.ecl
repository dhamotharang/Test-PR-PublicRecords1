...
IMPORT CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT E_Person_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT InLayout := RECORD
    ...
    KEL.typ.nint Bureau_Source_Count_;
    KEL.typ.nint Source_Count_;
  ...
  SHARED __Mapping2 := 'appended_lexid(OVERRIDE:Subject_:0),Location_(DEFAULT:Location_:0),prim_range(OVERRIDE:Primary_Range_:\'\'),predir(OVERRIDE:Predirectional_:\'\'),prim_name(OVERRIDE:Primary_Name_:\'\'),addr_suffix(OVERRIDE:Suffix_:\'\'),postdir(OVERRIDE:Postdirectional_:\'\'),unitdesignation(DEFAULT:Unit_Designation_),secondaryrange(DEFAULT:Secondary_Range_:\'\'),postalcity(DEFAULT:Postal_City_),state(DEFAULT:State_),zip(OVERRIDE:Z_I_P5_:0),zip4(DEFAULT:Z_I_P4_),addressrank(DEFAULT:Address_Rank_:0),insurancesourcecount(DEFAULT:Insurance_Source_Count_:0),propertysourcecount(DEFAULT:Property_Source_Count_:0),utilitysourcecount(DEFAULT:Utility_Source_Count_:0),vehiclesourcecount(DEFAULT:Vehicle_Source_Count_:0),dlsourcecount(DEFAULT:D_L_Source_Count_:0),votersourcecount(DEFAULT:Voter_Source_Count_:0),addresstype(DEFAULT:Address_Type_:\'\'),addressstatus(DEFAULT:Address_Status_:\'\'),statecode(DEFAULT:State_Code_:\'\'),countycode(DEFAULT:County_Code_:\'\'),latitude(DEFAULT:Latitude_:\'\'),longitude(DEFAULT:Longitude_:\'\'),Geo_Link_I_D_(DEFAULT:Geo_Link_I_D_:0),geoblk(DEFAULT:Geo_Blk_:\'\'),geommatch(DEFAULT:Geo_Mmatch_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),isbest(DEFAULT:Is_Best_),addressrankbest(DEFAULT:Address_Rank_Best_:0),bureausourcecount(DEFAULT:Bureau_Source_Count_:0),sourcecount(DEFAULT:Source_Count_:0),rankaddressstatus(DEFAULT:Rank_Address_Status_:\'\'),rectype(DEFAULT:Rec_Type_:\'\'),src(OVERRIDE:Source_:\'\'),archive_date(OVERRIDE:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'did(OVERRIDE:Subject_:0),Location_(DEFAULT:Location_:0),prim_range(OVERRIDE:Primary_Range_:\'\'),predir(OVERRIDE:Predirectional_:\'\'),prim_name(OVERRIDE:Primary_Name_:\'\'),addr_suffix(OVERRIDE:Suffix_:\'\'),postdir(OVERRIDE:Postdirectional_:\'\'),unit_desig(OVERRIDE:Unit_Designation_),sec_range(OVERRIDE:Secondary_Range_:\'\'),v_city_name(OVERRIDE:Postal_City_),st(OVERRIDE:State_),zip(OVERRIDE:Z_I_P5_:0),zip4(OVERRIDE:Z_I_P4_),addr_ind(OVERRIDE:Address_Rank_:0),insurance_src_cnt_total(OVERRIDE:Insurance_Source_Count_:0),property_src_cnt_total(OVERRIDE:Property_Source_Count_:0),utility_src_cnt_total(OVERRIDE:Utility_Source_Count_:0),vehicle_src_cnt_total(OVERRIDE:Vehicle_Source_Count_:0),dl_src_cnt_total(OVERRIDE:D_L_Source_Count_:0),voter_src_cnt_total(OVERRIDE:Voter_Source_Count_:0),addresstype(OVERRIDE:Address_Type_:\'\'),err_stat(OVERRIDE:Address_Status_:\'\'),statecode(OVERRIDE:State_Code_:\'\'),county(OVERRIDE:County_Code_:\'\'),geo_lat(OVERRIDE:Latitude_:\'\'),geo_long(OVERRIDE:Longitude_:\'\'),Geo_Link_I_D_(OVERRIDE:Geo_Link_I_D_:0),geo_blk(OVERRIDE:Geo_Blk_:\'\'),geo_match(OVERRIDE:Geo_Mmatch_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),fdnindicator(DEFAULT:F_D_N_Indicator_),best_addr_ind(OVERRIDE:Is_Best_),best_addr_rank(OVERRIDE:Address_Rank_Best_:0),bureau_src_cnt_total(OVERRIDE:Bureau_Source_Count_:0),src_cnt_total(OVERRIDE:Source_Count_:0),addressstatus(OVERRIDE:Rank_Address_Status_:\'\'),rec_type_aid(OVERRIDE:Rec_Type_:\'\'),src(OVERRIDE:Source_:\'\'),archive_date(OVERRIDE:Archive___Date_:EPOCH),dt_first_seen_pr(OVERRIDE:Date_First_Seen_:EPOCH),dt_last_seen_pr(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_3Rule),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  EXPORT __d3_KELfiltered := __d3_Norm((STRING28)prim_name != '' AND (UNSIGNED)zip != 0 AND (UNSIGNED)did != 0);
  SHARED __d3_Location__Layout := RECORD
    RECORDOF(__d3_KELfiltered);
    KEL.typ.uid Location_;
  END;
  SHARED __d3_Missing_Location__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d3_KELfiltered,'prim_range,predir,prim_name,addr_suffix,postdir,zip,sec_range','__in');
  SHARED __d3_Location__Mapped := IF(__d3_Missing_Location__UIDComponents = 'prim_range,predir,prim_name,addr_suffix,postdir,zip,sec_range',PROJECT(__d3_KELfiltered,TRANSFORM(__d3_Location__Layout,SELF.Location_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d3_KELfiltered,__d3_Missing_Location__UIDComponents),E_Address(__in,__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.addr_suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.zip) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d3_Location__Layout,SELF.Location_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  ...
  SHARED __Mapping5 := 'appended_lexid(OVERRIDE:Subject_:0),Location_(DEFAULT:Location_:0),prim_range(OVERRIDE:Primary_Range_:\'\'),predir(OVERRIDE:Predirectional_:\'\'),prim_name(OVERRIDE:Primary_Name_:\'\'),addr_suffix(OVERRIDE:Suffix_:\'\'),postdir(OVERRIDE:Postdirectional_:\'\'),unitdesignation(DEFAULT:Unit_Designation_),secondaryrange(DEFAULT:Secondary_Range_:\'\'),postalcity(DEFAULT:Postal_City_),state(DEFAULT:State_),zip(OVERRIDE:Z_I_P5_:0),zip4(DEFAULT:Z_I_P4_),addressrank(DEFAULT:Address_Rank_:0),insurancesourcecount(DEFAULT:Insurance_Source_Count_:0),propertysourcecount(DEFAULT:Property_Source_Count_:0),utilitysourcecount(DEFAULT:Utility_Source_Count_:0),vehiclesourcecount(DEFAULT:Vehicle_Source_Count_:0),dlsourcecount(DEFAULT:D_L_Source_Count_:0),votersourcecount(DEFAULT:Voter_Source_Count_:0),addresstype(DEFAULT:Address_Type_:\'\'),addressstatus(DEFAULT:Address_Status_:\'\'),statecode(DEFAULT:State_Code_:\'\'),countycode(DEFAULT:County_Code_:\'\'),latitude(DEFAULT:Latitude_:\'\'),longitude(DEFAULT:Longitude_:\'\'),Geo_Link_I_D_(DEFAULT:Geo_Link_I_D_:0),geoblk(DEFAULT:Geo_Blk_:\'\'),geommatch(DEFAULT:Geo_Mmatch_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),isbest(DEFAULT:Is_Best_),addressrankbest(DEFAULT:Address_Rank_Best_:0),bureausourcecount(DEFAULT:Bureau_Source_Count_:0),sourcecount(DEFAULT:Source_Count_:0),rankaddressstatus(DEFAULT:Rank_Address_Status_:\'\'),rectype(DEFAULT:Rec_Type_:\'\'),src(OVERRIDE:Source_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  Layout Person_Address__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Address_Rank_Details_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Address_Rank_,Is_Best_,Address_Rank_Best_,Source_Count_,Bureau_Source_Count_,Insurance_Source_Count_,Property_Source_Count_,Utility_Source_Count_,Vehicle_Source_Count_,D_L_Source_Count_,Voter_Source_Count_,Address_Type_},Address_Rank_,Is_Best_,Address_Rank_Best_,Source_Count_,Bureau_Source_Count_,Insurance_Source_Count_,Property_Source_Count_,Utility_Source_Count_,Vehicle_Source_Count_,D_L_Source_Count_,Voter_Source_Count_,Address_Type_),Address_Rank_Details_Layout)(__NN(Address_Rank_) OR __NN(Is_Best_) OR __NN(Address_Rank_Best_) OR __NN(Source_Count_) OR __NN(Bureau_Source_Count_) OR __NN(Insurance_Source_Count_) OR __NN(Property_Source_Count_) OR __NN(Utility_Source_Count_) OR __NN(Vehicle_Source_Count_) OR __NN(D_L_Source_Count_) OR __NN(Voter_Source_Count_) OR __NN(Address_Type_)));
    SELF.Address_Hierarchy_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Address_Rank_,Is_Best_,Address_Rank_Best_,Address_Type_,Address_Status_,Rank_Address_Status_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Unit_Designation_,Secondary_Range_,Postal_City_,State_,Z_I_P5_,Z_I_P4_,Rec_Type_,State_Code_,County_Code_,Latitude_,Longitude_,Geo_Blk_,Geo_Mmatch_,Geo_Link_I_D_},Address_Rank_,Is_Best_,Address_Rank_Best_,Address_Type_,Address_Status_,Rank_Address_Status_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Unit_Designation_,Secondary_Range_,Postal_City_,State_,Z_I_P5_,Z_I_P4_,Rec_Type_,State_Code_,County_Code_,Latitude_,Longitude_,Geo_Blk_,Geo_Mmatch_,Geo_Link_I_D_),Address_Hierarchy_Layout)(__NN(Address_Rank_) OR __NN(Is_Best_) OR __NN(Address_Rank_Best_) OR __NN(Address_Type_) OR __NN(Address_Status_) OR __NN(Rank_Address_Status_) OR __NN(Primary_Range_) OR __NN(Predirectional_) OR __NN(Primary_Name_) OR __NN(Suffix_) OR __NN(Postdirectional_) OR __NN(Unit_Designation_) OR __NN(Secondary_Range_) OR __NN(Postal_City_) OR __NN(State_) OR __NN(Z_I_P5_) OR __NN(Z_I_P4_) OR __NN(Rec_Type_) OR __NN(State_Code_) OR __NN(County_Code_) OR __NN(Latitude_) OR __NN(Longitude_) OR __NN(Geo_Blk_) OR __NN(Geo_Mmatch_) OR __NN(Geo_Link_I_D_)));
    SELF.Data_Sources_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),Source_,Header_Hit_Flag_,Is_Best_,F_D_N_Indicator_},Source_,Header_Hit_Flag_,Is_Best_,F_D_N_Indicator_),Data_Sources_Layout)(__NN(Source_) OR __NN(Header_Hit_Flag_) OR __NN(Is_Best_) OR __NN(F_D_N_Indicator_)));
  ...
  Layout Person_Address__Single_Rollup(InLayout __r) := TRANSFORM
    ...
    SELF.Data_Sources_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Data_Sources_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,NMAX),SELF:=LEFT))(__NN(Source_) OR __NN(Header_Hit_Flag_) OR __NN(Is_Best_) OR __NN(F_D_N_Indicator_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsBest',COUNT(__d0(__NL(Is_Best_))),COUNT(__d0(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressRankBest',COUNT(__d0(__NL(Address_Rank_Best_))),COUNT(__d0(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BureauSourceCount',COUNT(__d0(__NL(Bureau_Source_Count_))),COUNT(__d0(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceCount',COUNT(__d0(__NL(Source_Count_))),COUNT(__d0(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RankAddressStatus',COUNT(__d0(__NL(Rank_Address_Status_))),COUNT(__d0(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d0(__NL(Rec_Type_))),COUNT(__d0(__NN(Rec_Type_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsBest',COUNT(__d1(__NL(Is_Best_))),COUNT(__d1(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressRankBest',COUNT(__d1(__NL(Address_Rank_Best_))),COUNT(__d1(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BureauSourceCount',COUNT(__d1(__NL(Bureau_Source_Count_))),COUNT(__d1(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceCount',COUNT(__d1(__NL(Source_Count_))),COUNT(__d1(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RankAddressStatus',COUNT(__d1(__NL(Rank_Address_Status_))),COUNT(__d1(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d1(__NL(Rec_Type_))),COUNT(__d1(__NN(Rec_Type_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsBest',COUNT(__d2(__NL(Is_Best_))),COUNT(__d2(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressRankBest',COUNT(__d2(__NL(Address_Rank_Best_))),COUNT(__d2(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BureauSourceCount',COUNT(__d2(__NL(Bureau_Source_Count_))),COUNT(__d2(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceCount',COUNT(__d2(__NL(Source_Count_))),COUNT(__d2(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RankAddressStatus',COUNT(__d2(__NL(Rank_Address_Status_))),COUNT(__d2(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d2(__NL(Rec_Type_))),COUNT(__d2(__NN(Rec_Type_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addr_ind',COUNT(__d3(__NL(Address_Rank_))),COUNT(__d3(__NN(Address_Rank_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','insurance_src_cnt_total',COUNT(__d3(__NL(Insurance_Source_Count_))),COUNT(__d3(__NN(Insurance_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','property_src_cnt_total',COUNT(__d3(__NL(Property_Source_Count_))),COUNT(__d3(__NN(Property_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','utility_src_cnt_total',COUNT(__d3(__NL(Utility_Source_Count_))),COUNT(__d3(__NN(Utility_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','vehicle_src_cnt_total',COUNT(__d3(__NL(Vehicle_Source_Count_))),COUNT(__d3(__NN(Vehicle_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dl_src_cnt_total',COUNT(__d3(__NL(D_L_Source_Count_))),COUNT(__d3(__NN(D_L_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','voter_src_cnt_total',COUNT(__d3(__NL(Voter_Source_Count_))),COUNT(__d3(__NN(Voter_Source_Count_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','best_addr_ind',COUNT(__d3(__NL(Is_Best_))),COUNT(__d3(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','best_addr_rank',COUNT(__d3(__NL(Address_Rank_Best_))),COUNT(__d3(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','bureau_src_cnt_total',COUNT(__d3(__NL(Bureau_Source_Count_))),COUNT(__d3(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','src_cnt_total',COUNT(__d3(__NL(Source_Count_))),COUNT(__d3(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addressstatus',COUNT(__d3(__NL(Rank_Address_Status_))),COUNT(__d3(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec_type_aid',COUNT(__d3(__NL(Rec_Type_))),COUNT(__d3(__NN(Rec_Type_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsBest',COUNT(__d4(__NL(Is_Best_))),COUNT(__d4(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressRankBest',COUNT(__d4(__NL(Address_Rank_Best_))),COUNT(__d4(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BureauSourceCount',COUNT(__d4(__NL(Bureau_Source_Count_))),COUNT(__d4(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceCount',COUNT(__d4(__NL(Source_Count_))),COUNT(__d4(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RankAddressStatus',COUNT(__d4(__NL(Rank_Address_Status_))),COUNT(__d4(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d4(__NL(Rec_Type_))),COUNT(__d4(__NN(Rec_Type_)))},
    ...
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsBest',COUNT(__d5(__NL(Is_Best_))),COUNT(__d5(__NN(Is_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressRankBest',COUNT(__d5(__NL(Address_Rank_Best_))),COUNT(__d5(__NN(Address_Rank_Best_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BureauSourceCount',COUNT(__d5(__NL(Bureau_Source_Count_))),COUNT(__d5(__NN(Bureau_Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceCount',COUNT(__d5(__NL(Source_Count_))),COUNT(__d5(__NN(Source_Count_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RankAddressStatus',COUNT(__d5(__NL(Rank_Address_Status_))),COUNT(__d5(__NN(Rank_Address_Status_)))},
    {'PersonAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RecType',COUNT(__d5(__NL(Rec_Type_))),COUNT(__d5(__NN(Rec_Type_)))},
