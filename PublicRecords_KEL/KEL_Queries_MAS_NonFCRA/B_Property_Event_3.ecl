...
IMPORT KEL15 AS KEL;
IMPORT B_Property_Event_4,B_Property_Event_6,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_NonFCRA;
...
EXPORT B_Property_Event_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5495597 := __ENH_Property_Event_4;
  EXPORT __ENH_Property_Event_3 := __EE5495597;
END;
