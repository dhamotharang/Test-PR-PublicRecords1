...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE226438 := __E_Property_Event;
  EXPORT __ST177895_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST177895_Layout __ND226506__Project(E_Property_Event(__in,__cfg).Layout __PP226101) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP226101.Date_First_Seen_);
    SELF := __PP226101;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE226438,__ND226506__Project(LEFT));
END;
