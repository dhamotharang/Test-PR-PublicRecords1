...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE230466 := __E_Property_Event;
  EXPORT __ST182080_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182080_Layout __ND230534__Project(E_Property_Event(__in,__cfg).Layout __PP230129) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP230129.Date_First_Seen_);
    SELF := __PP230129;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE230466,__ND230534__Project(LEFT));
END;
