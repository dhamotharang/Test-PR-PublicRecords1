...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE227583 := __E_Property_Event;
  EXPORT __ST178936_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST178936_Layout __ND227651__Project(E_Property_Event(__in,__cfg).Layout __PP227246) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP227246.Date_First_Seen_);
    SELF := __PP227246;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE227583,__ND227651__Project(LEFT));
END;
