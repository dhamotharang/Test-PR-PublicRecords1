...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE230918 := __E_Property_Event;
  EXPORT __ST182642_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182642_Layout __ND230986__Project(E_Property_Event(__in,__cfg).Layout __PP230581) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP230581.Date_First_Seen_);
    SELF := __PP230581;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE230918,__ND230986__Project(LEFT));
END;
