...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE230145 := __E_Property_Event;
  EXPORT __ST181869_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST181869_Layout __ND230213__Project(E_Property_Event(__in,__cfg).Layout __PP229808) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP229808.Date_First_Seen_);
    SELF := __PP229808;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE230145,__ND230213__Project(LEFT));
END;
