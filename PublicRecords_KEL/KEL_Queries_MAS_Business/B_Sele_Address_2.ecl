...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2864942 := __ENH_Sele_Address_3;
  EXPORT __ST189730_Layout := RECORD
  ...
  END;
  EXPORT __ST189674_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST189730_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST189674_Layout __ND2864947__Project(B_Sele_Address_3(__in,__cfg).__ST199079_Layout __PP2864943) := TRANSFORM
    __EE2865037 := __PP2864943.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2865037),__ST189730_Layout),__NL(__EE2865037));
    SELF := __PP2864943;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2864942,__ND2864947__Project(LEFT));
END;
