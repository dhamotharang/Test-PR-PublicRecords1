...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2867398 := __ENH_Sele_Address_3;
  EXPORT __ST178977_Layout := RECORD
  ...
  END;
  EXPORT __ST178921_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST178977_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST178921_Layout __ND2867403__Project(B_Sele_Address_3(__in,__cfg).__ST188547_Layout __PP2867399) := TRANSFORM
    __EE2867493 := __PP2867399.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2867493),__ST178977_Layout),__NL(__EE2867493));
    SELF := __PP2867399;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2867398,__ND2867403__Project(LEFT));
END;
