...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2871750 := __ENH_Sele_Address_3;
  EXPORT __ST195797_Layout := RECORD
  ...
  END;
  EXPORT __ST195741_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST195797_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195741_Layout __ND2871755__Project(B_Sele_Address_3(__in,__cfg).__ST205148_Layout __PP2871751) := TRANSFORM
    __EE2871845 := __PP2871751.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2871845),__ST195797_Layout),__NL(__EE2871845));
    SELF := __PP2871751;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2871750,__ND2871755__Project(LEFT));
END;
