...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2865813 := __ENH_Sele_Address_3;
  EXPORT __ST189901_Layout := RECORD
  ...
  END;
  EXPORT __ST189845_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST189901_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST189845_Layout __ND2865818__Project(B_Sele_Address_3(__in,__cfg).__ST199252_Layout __PP2865814) := TRANSFORM
    __EE2865908 := __PP2865814.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2865908),__ST189901_Layout),__NL(__EE2865908));
    SELF := __PP2865814;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2865813,__ND2865818__Project(LEFT));
END;
