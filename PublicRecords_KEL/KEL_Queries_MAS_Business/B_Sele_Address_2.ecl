...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2862069 := __ENH_Sele_Address_3;
  EXPORT __ST184582_Layout := RECORD
  ...
  END;
  EXPORT __ST184526_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST184582_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184526_Layout __ND2862074__Project(B_Sele_Address_3(__in,__cfg).__ST194120_Layout __PP2862070) := TRANSFORM
    __EE2862164 := __PP2862070.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2862164),__ST184582_Layout),__NL(__EE2862164));
    SELF := __PP2862070;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2862069,__ND2862074__Project(LEFT));
END;
