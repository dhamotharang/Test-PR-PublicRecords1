...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2868061 := __ENH_Sele_Address_3;
  EXPORT __ST190574_Layout := RECORD
  ...
  END;
  EXPORT __ST190518_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST190574_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190518_Layout __ND2868066__Project(B_Sele_Address_3(__in,__cfg).__ST200112_Layout __PP2868062) := TRANSFORM
    __EE2868156 := __PP2868062.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2868156),__ST190574_Layout),__NL(__EE2868156));
    SELF := __PP2868062;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE2868061,__ND2868066__Project(LEFT));
END;
