...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1885498 := __ENH_U_C_C_10;
  EXPORT __ST222260_Layout := RECORD
  ...
  END;
  EXPORT __ST222256_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST222260_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST222256_Layout __ND1885461__Project(B_U_C_C_10(__in,__cfg).__ST222986_Layout __PP1885170) := TRANSFORM
    __EE1885501 := __PP1885170.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1885501),__ST222260_Layout),__NL(__EE1885501));
    __EE1885456 := __PP1885170.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1885456))[1].R_M_S_I_D_;
    SELF := __PP1885170;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1885498,__ND1885461__Project(LEFT));
END;
