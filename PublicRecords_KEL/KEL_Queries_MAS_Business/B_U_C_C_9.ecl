...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1883169 := __ENH_U_C_C_10;
  ...
  END;
  EXPORT __ST219961_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219965_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219961_Layout __ND1883132__Project(B_U_C_C_10(__in,__cfg).__ST220691_Layout __PP1882841) := TRANSFORM
    __EE1883172 := __PP1882841.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1883172),__ST219965_Layout),__NL(__EE1883172));
    __EE1883127 := __PP1882841.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1883127))[1].R_M_S_I_D_;
    SELF := __PP1882841;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1883169,__ND1883132__Project(LEFT));
END;
