...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1883481 := __ENH_U_C_C_10;
  EXPORT __ST220578_Layout := RECORD
  ...
  END;
  EXPORT __ST220574_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST220578_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST220574_Layout __ND1883444__Project(B_U_C_C_10(__in,__cfg).__ST221304_Layout __PP1883153) := TRANSFORM
    __EE1883484 := __PP1883153.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1883484),__ST220578_Layout),__NL(__EE1883484));
    __EE1883439 := __PP1883153.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1883439))[1].R_M_S_I_D_;
    SELF := __PP1883153;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1883481,__ND1883444__Project(LEFT));
END;
