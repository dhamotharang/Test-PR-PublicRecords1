...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1884824 := __ENH_U_C_C_10;
  EXPORT __ST221586_Layout := RECORD
  ...
  END;
  EXPORT __ST221582_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST221586_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221582_Layout __ND1884787__Project(B_U_C_C_10(__in,__cfg).__ST222312_Layout __PP1884496) := TRANSFORM
    __EE1884827 := __PP1884496.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1884827),__ST221586_Layout),__NL(__EE1884827));
    __EE1884782 := __PP1884496.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1884782))[1].R_M_S_I_D_;
    SELF := __PP1884496;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1884824,__ND1884787__Project(LEFT));
END;
