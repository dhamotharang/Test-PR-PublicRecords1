...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1882624 := __ENH_U_C_C_10;
  EXPORT __ST219784_Layout := RECORD
  ...
  END;
  EXPORT __ST219780_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219784_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219780_Layout __ND1882587__Project(B_U_C_C_10(__in,__cfg).__ST220510_Layout __PP1882296) := TRANSFORM
    __EE1882627 := __PP1882296.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1882627),__ST219784_Layout),__NL(__EE1882627));
    __EE1882582 := __PP1882296.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1882582))[1].R_M_S_I_D_;
    SELF := __PP1882296;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1882624,__ND1882587__Project(LEFT));
END;
