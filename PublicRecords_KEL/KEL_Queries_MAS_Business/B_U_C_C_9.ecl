...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1889099 := __ENH_U_C_C_10;
  EXPORT __ST225861_Layout := RECORD
  ...
  END;
  EXPORT __ST225857_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST225861_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225857_Layout __ND1889062__Project(B_U_C_C_10(__in,__cfg).__ST226587_Layout __PP1888771) := TRANSFORM
    __EE1889102 := __PP1888771.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1889102),__ST225861_Layout),__NL(__EE1889102));
    __EE1889057 := __PP1888771.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1889057))[1].R_M_S_I_D_;
    SELF := __PP1888771;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1889099,__ND1889062__Project(LEFT));
END;
