...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2507198 := __ENH_Sele_Property_4;
  EXPORT __ST188866_Layout := RECORD
  ...
  END;
  SHARED __ST188866_Layout __ND2507203__Project(B_Sele_Property_4(__in,__cfg).__ST196727_Layout __PP2507199) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP2507199.Property_Is_Owned_Assessment_ OR __PP2507199.Property_Is_Owned_Deed_) AND NOT (__PP2507199.Property_Is_Sold_);
    SELF := __PP2507199;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE2507198,__ND2507203__Project(LEFT));
END;
