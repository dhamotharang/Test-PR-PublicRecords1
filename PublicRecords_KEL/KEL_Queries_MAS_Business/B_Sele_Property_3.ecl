...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2508385 := __ENH_Sele_Property_4;
  EXPORT __ST200431_Layout := RECORD
  ...
  END;
  SHARED __ST200431_Layout __ND2508390__Project(B_Sele_Property_4(__in,__cfg).__ST208261_Layout __PP2508386) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP2508386.Property_Is_Owned_Assessment_ OR __PP2508386.Property_Is_Owned_Deed_) AND NOT (__PP2508386.Property_Is_Sold_);
    SELF := __PP2508386;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE2508385,__ND2508390__Project(LEFT));
END;
