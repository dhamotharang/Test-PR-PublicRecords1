...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2506082 := __ENH_Sele_Property_4;
  EXPORT __ST200204_Layout := RECORD
  ...
  END;
  SHARED __ST200204_Layout __ND2506087__Project(B_Sele_Property_4(__in,__cfg).__ST208013_Layout __PP2506083) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP2506083.Property_Is_Owned_Assessment_ OR __PP2506083.Property_Is_Owned_Deed_) AND NOT (__PP2506083.Property_Is_Sold_);
    SELF := __PP2506083;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE2506082,__ND2506087__Project(LEFT));
END;
