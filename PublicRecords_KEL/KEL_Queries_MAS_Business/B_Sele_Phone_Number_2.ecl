...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2862561 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST184750_Layout := RECORD
  ...
  END;
  EXPORT __ST184712_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST184750_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184712_Layout __ND2862566__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST194317_Layout __PP2862562) := TRANSFORM
    __EE2862614 := __PP2862562.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2862614),__ST184750_Layout),__NL(__EE2862614));
    SELF := __PP2862562;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2862561,__ND2862566__Project(LEFT));
END;
