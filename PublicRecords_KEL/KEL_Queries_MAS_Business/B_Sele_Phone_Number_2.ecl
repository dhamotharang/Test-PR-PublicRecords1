...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2868553 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST190742_Layout := RECORD
  ...
  EXPORT __ST190704_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST190742_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190704_Layout __ND2868558__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST200309_Layout __PP2868554) := TRANSFORM
    __EE2868606 := __PP2868554.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2868606),__ST190742_Layout),__NL(__EE2868606));
    SELF := __PP2868554;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2868553,__ND2868558__Project(LEFT));
END;
