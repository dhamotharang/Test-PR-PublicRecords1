...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2866589 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST183749_Layout := RECORD
  ...
  END;
  EXPORT __ST183711_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST183749_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183711_Layout __ND2866594__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST193330_Layout __PP2866590) := TRANSFORM
    __EE2866642 := __PP2866590.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2866642),__ST183749_Layout),__NL(__EE2866642));
    SELF := __PP2866590;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2866589,__ND2866594__Project(LEFT));
END;
