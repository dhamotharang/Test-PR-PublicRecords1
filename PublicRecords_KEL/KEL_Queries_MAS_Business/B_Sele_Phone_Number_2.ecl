...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2866245 := __ENH_Sele_Phone_Number_3;
  ...
  END;
  EXPORT __ST190625_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST190663_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190625_Layout __ND2866250__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST200037_Layout __PP2866246) := TRANSFORM
    __EE2866298 := __PP2866246.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2866298),__ST190663_Layout),__NL(__EE2866298));
    SELF := __PP2866246;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2866245,__ND2866250__Project(LEFT));
END;
