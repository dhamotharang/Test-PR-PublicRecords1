...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2865434 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST189898_Layout := RECORD
  ...
  END;
  EXPORT __ST189860_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST189898_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST189860_Layout __ND2865439__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST199276_Layout __PP2865435) := TRANSFORM
    __EE2865487 := __PP2865435.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2865487),__ST189898_Layout),__NL(__EE2865487));
    SELF := __PP2865435;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2865434,__ND2865439__Project(LEFT));
END;
