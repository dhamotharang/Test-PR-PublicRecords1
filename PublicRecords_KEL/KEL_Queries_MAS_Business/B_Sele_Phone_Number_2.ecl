...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2867890 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST179145_Layout := RECORD
  ...
  END;
  EXPORT __ST179107_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST179145_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179107_Layout __ND2867895__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST188744_Layout __PP2867891) := TRANSFORM
    __EE2867943 := __PP2867891.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2867943),__ST179145_Layout),__NL(__EE2867943));
    SELF := __PP2867891;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE2867890,__ND2867895__Project(LEFT));
END;
