...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1941197 := __ENH_U_C_C_7;
  EXPORT __ST204871_Layout := RECORD
  ...
  END;
  EXPORT __ST204867_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST204871_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST204867_Layout __ND1941202__Project(B_U_C_C_7(__in,__cfg).__ST207082_Layout __PP1941198) := TRANSFORM
    __EE1941237 := __PP1941198.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1941237),__ST204871_Layout),__NL(__EE1941237));
    SELF := __PP1941198;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE1941197,__ND1941202__Project(LEFT));
END;
