...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1941932 := __ENH_U_C_C_7;
  EXPORT __ST215288_Layout := RECORD
  ...
  END;
  EXPORT __ST215284_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST215288_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST215284_Layout __ND1941937__Project(B_U_C_C_7(__in,__cfg).__ST217489_Layout __PP1941933) := TRANSFORM
    __EE1941972 := __PP1941933.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1941972),__ST215288_Layout),__NL(__EE1941972));
    SELF := __PP1941933;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE1941932,__ND1941937__Project(LEFT));
END;
