...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1942743 := __ENH_U_C_C_7;
  EXPORT __ST216037_Layout := RECORD
  ...
  END;
  EXPORT __ST216033_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST216037_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216033_Layout __ND1942748__Project(B_U_C_C_7(__in,__cfg).__ST218238_Layout __PP1942744) := TRANSFORM
    __EE1942783 := __PP1942744.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1942783),__ST216037_Layout),__NL(__EE1942783));
    SELF := __PP1942744;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE1942743,__ND1942748__Project(LEFT));
END;
