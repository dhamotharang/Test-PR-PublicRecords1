...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1942788 := __ENH_U_C_C_7;
  EXPORT __ST216082_Layout := RECORD
  ...
  END;
  EXPORT __ST216078_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST216082_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216078_Layout __ND1942793__Project(B_U_C_C_7(__in,__cfg).__ST218283_Layout __PP1942789) := TRANSFORM
    __EE1942828 := __PP1942789.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1942828),__ST216082_Layout),__NL(__EE1942828));
    SELF := __PP1942789;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE1942788,__ND1942793__Project(LEFT));
END;
