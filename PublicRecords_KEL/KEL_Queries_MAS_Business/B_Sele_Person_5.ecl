...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1988289 := __ENH_Sele_Person_6;
  EXPORT __ST212146_Layout := RECORD
  ...
  END;
  SHARED __ST212146_Layout __ND1988412__Project(B_Sele_Person_6(__in,__cfg).__ST215515_Layout __PP1988290) := TRANSFORM
    __CC65269 := 730;
    SELF.Two_Years_ := __OP2(__PP1988290.Age_In_Days_,<=,__CN(__CC65269));
    SELF := __PP1988290;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE1988289,__ND1988412__Project(LEFT));
END;
