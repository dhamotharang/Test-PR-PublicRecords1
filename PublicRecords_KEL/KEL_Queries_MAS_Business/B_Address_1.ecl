...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2901979 := __ENH_Address_2;
  EXPORT __ST166763_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST166763_Layout __ND2902381__Project(B_Address_2(__in,__cfg).__ST180102_Layout __PP2901980) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP2901980.Is_P_O_Box_Zip_,__CN(__PP2901980.Is_P_O_Box_A_D_V_O_));
    SELF := __PP2901980;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE2901979,__ND2902381__Project(LEFT));
END;
