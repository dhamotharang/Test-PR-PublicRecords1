...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2902850 := __ENH_Address_2;
  EXPORT __ST166934_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST166934_Layout __ND2903252__Project(B_Address_2(__in,__cfg).__ST180273_Layout __PP2902851) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP2902851.Is_P_O_Box_Zip_,__CN(__PP2902851.Is_P_O_Box_A_D_V_O_));
    SELF := __PP2902851;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE2902850,__ND2903252__Project(LEFT));
END;
