...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2124568 := __ENH_U_C_C_5;
  ...
  END;
  EXPORT __ST208565_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST208569_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208565_Layout __ND2124806__Project(B_U_C_C_5(__in,__cfg).__ST212783_Layout __PP2124569) := TRANSFORM
    __EE2124610 := __PP2124569.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2124610),__ST208569_Layout),__NL(__EE2124610));
    SELF.Terminated_Filing_ := __OP2(__PP2124569.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP2124569;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE2124568,__ND2124806__Project(LEFT));
END;
