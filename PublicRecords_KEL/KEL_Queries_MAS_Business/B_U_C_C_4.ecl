...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2124530 := __ENH_U_C_C_5;
  EXPORT __ST207985_Layout := RECORD
  ...
  END;
  EXPORT __ST207981_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST207985_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207981_Layout __ND2124768__Project(B_U_C_C_5(__in,__cfg).__ST212207_Layout __PP2124531) := TRANSFORM
    __EE2124572 := __PP2124531.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2124572),__ST207985_Layout),__NL(__EE2124572));
    SELF.Terminated_Filing_ := __OP2(__PP2124531.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP2124531;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE2124530,__ND2124768__Project(LEFT));
END;
