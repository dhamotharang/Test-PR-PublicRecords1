...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2120311 := __ENH_U_C_C_5;
  EXPORT __ST202870_Layout := RECORD
  ...
  END;
  EXPORT __ST202866_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST202870_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST202866_Layout __ND2120549__Project(B_U_C_C_5(__in,__cfg).__ST207092_Layout __PP2120312) := TRANSFORM
    __EE2120353 := __PP2120312.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2120353),__ST202870_Layout),__NL(__EE2120353));
    SELF.Terminated_Filing_ := __OP2(__PP2120312.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP2120312;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE2120311,__ND2120549__Project(LEFT));
END;
