...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2130460 := __ENH_U_C_C_5;
  EXPORT __ST213881_Layout := RECORD
  ...
  END;
  EXPORT __ST213877_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST213881_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213877_Layout __ND2130698__Project(B_U_C_C_5(__in,__cfg).__ST218103_Layout __PP2130461) := TRANSFORM
    __EE2130502 := __PP2130461.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2130502),__ST213881_Layout),__NL(__EE2130502));
    SELF.Terminated_Filing_ := __OP2(__PP2130461.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP2130461;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE2130460,__ND2130698__Project(LEFT));
END;
