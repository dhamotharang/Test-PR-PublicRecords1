...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2126859 := __ENH_U_C_C_5;
  EXPORT __ST210280_Layout := RECORD
  ...
  END;
  EXPORT __ST210276_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST210280_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210276_Layout __ND2127097__Project(B_U_C_C_5(__in,__cfg).__ST214502_Layout __PP2126860) := TRANSFORM
    __EE2126901 := __PP2126860.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2126901),__ST210280_Layout),__NL(__EE2126901));
    SELF.Terminated_Filing_ := __OP2(__PP2126860.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP2126860;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE2126859,__ND2127097__Project(LEFT));
END;
