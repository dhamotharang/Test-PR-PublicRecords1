...
EXPORT B_Sele_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1948106 := __ENH_Sele_U_C_C_7;
  EXPORT __ST221057_Layout := RECORD
  ...
  END;
  EXPORT __ST221049_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST221057_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221049_Layout __ND1948211__Project(B_Sele_U_C_C_7(__in,__cfg).__ST223259_Layout __PP1948107) := TRANSFORM
    __EE1948142 := __PP1948107.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1948142),__ST221057_Layout),__NL(__EE1948142));
    SELF.Is_Filing_ := IF(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__FN1(TRIM,__PP1948107.Filtered_Party_Type_)),IN,__CN(['D','S','C','A']))),TRUE,FALSE);
    SELF := __PP1948107;
  END;
  EXPORT __ENH_Sele_U_C_C_6 := PROJECT(__EE1948106,__ND1948211__Project(LEFT));
END;
