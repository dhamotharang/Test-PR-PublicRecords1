...
EXPORT B_Tradeline_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE271373 := __E_Tradeline;
  EXPORT __ST222167_Layout := RECORD
  ...
  END;
  EXPORT __ST222160_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST222167_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST222160_Layout __ND271591__Project(E_Tradeline(__in,__cfg).Layout __PP271202) := TRANSFORM
    __EE271249 := __PP271202.Records_;
    __ST222167_Layout __ND271497__Project(E_Tradeline(__in,__cfg).Records_Layout __PP271493) := TRANSFORM
      SELF.Record_Date_ := KEL.era.ToDate(__PP271493.Date_First_Seen_);
      SELF := __PP271493;
    END;
    SELF.Records_ := __PROJECT(__EE271249,__ND271497__Project(LEFT));
    ...
    SELF := __PP271202;
  END;
  EXPORT __ENH_Tradeline_10 := PROJECT(__EE271373,__ND271591__Project(LEFT));
END;
