...
EXPORT B_Tradeline_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE270619 := __E_Tradeline;
  EXPORT __ST221419_Layout := RECORD
  ...
  END;
  EXPORT __ST221412_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST221419_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221412_Layout __ND270837__Project(E_Tradeline(__in,__cfg).Layout __PP270448) := TRANSFORM
    __EE270495 := __PP270448.Records_;
    __ST221419_Layout __ND270743__Project(E_Tradeline(__in,__cfg).Records_Layout __PP270739) := TRANSFORM
      SELF.Record_Date_ := KEL.era.ToDate(__PP270739.Date_First_Seen_);
      SELF := __PP270739;
    END;
    SELF.Records_ := __PROJECT(__EE270495,__ND270743__Project(LEFT));
    ...
    SELF := __PP270448;
  END;
  EXPORT __ENH_Tradeline_10 := PROJECT(__EE270619,__ND270837__Project(LEFT));
END;
