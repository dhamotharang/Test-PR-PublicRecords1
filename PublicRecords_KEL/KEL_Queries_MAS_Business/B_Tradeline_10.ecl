...
EXPORT B_Tradeline_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE269746 := __E_Tradeline;
  EXPORT __ST220546_Layout := RECORD
  ...
  END;
  EXPORT __ST220539_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST220546_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST220539_Layout __ND269964__Project(E_Tradeline(__in,__cfg).Layout __PP269575) := TRANSFORM
    __EE269622 := __PP269575.Records_;
    __ST220546_Layout __ND269870__Project(E_Tradeline(__in,__cfg).Records_Layout __PP269866) := TRANSFORM
      SELF.Record_Date_ := KEL.era.ToDate(__PP269866.Date_First_Seen_);
      SELF := __PP269866;
    END;
    SELF.Records_ := __PROJECT(__EE269622,__ND269870__Project(LEFT));
    ...
    SELF := __PP269575;
  END;
  EXPORT __ENH_Tradeline_10 := PROJECT(__EE269746,__ND269964__Project(LEFT));
END;
