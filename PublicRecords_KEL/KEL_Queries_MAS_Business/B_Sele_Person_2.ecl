...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2872057 := __ENH_Sele_Person_3;
  EXPORT __ST195869_Layout := RECORD
  ...
  END;
  SHARED __ST195869_Layout __ND2872062__Project(B_Sele_Person_3(__in,__cfg).__ST205287_Layout __PP2872058) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP2872058.Assoc_Fs_Date_,__CC13555);
    SELF := __PP2872058;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE2872057,__ND2872062__Project(LEFT));
END;
