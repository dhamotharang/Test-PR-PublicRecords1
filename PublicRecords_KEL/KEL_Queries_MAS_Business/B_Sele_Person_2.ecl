...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2862376 := __ENH_Sele_Person_3;
  EXPORT __ST184654_Layout := RECORD
  ...
  END;
  SHARED __ST184654_Layout __ND2862381__Project(B_Sele_Person_3(__in,__cfg).__ST194259_Layout __PP2862377) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP2862377.Assoc_Fs_Date_,__CC13402);
    SELF := __PP2862377;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE2862376,__ND2862381__Project(LEFT));
END;
