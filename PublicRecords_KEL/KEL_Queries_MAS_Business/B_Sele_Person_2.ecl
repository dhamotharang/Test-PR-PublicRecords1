...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2865249 := __ENH_Sele_Person_3;
  EXPORT __ST189802_Layout := RECORD
  ...
  END;
  SHARED __ST189802_Layout __ND2865254__Project(B_Sele_Person_3(__in,__cfg).__ST199218_Layout __PP2865250) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP2865250.Assoc_Fs_Date_,__CC13357);
    SELF := __PP2865250;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE2865249,__ND2865254__Project(LEFT));
END;
