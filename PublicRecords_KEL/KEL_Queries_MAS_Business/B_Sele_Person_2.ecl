...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2868456 := __ENH_Sele_Person_3;
  EXPORT __ST192268_Layout := RECORD
  ...
  END;
  SHARED __ST192268_Layout __ND2868461__Project(B_Sele_Person_3(__in,__cfg).__ST201686_Layout __PP2868457) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP2868457.Assoc_Fs_Date_,__CC13546);
    SELF := __PP2868457;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE2868456,__ND2868461__Project(LEFT));
END;
