...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2866060 := __ENH_Sele_Person_3;
  EXPORT __ST190567_Layout := RECORD
  ...
  END;
  SHARED __ST190567_Layout __ND2866065__Project(B_Sele_Person_3(__in,__cfg).__ST199979_Layout __PP2866061) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP2866061.Assoc_Fs_Date_,__CC13363);
    SELF := __PP2866061;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE2866060,__ND2866065__Project(LEFT));
END;
