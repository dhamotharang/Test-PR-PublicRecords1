...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1990349 := __ENH_U_C_C_6;
  EXPORT __ST212832_Layout := RECORD
  ...
  END;
  EXPORT __ST212828_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST212832_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212828_Layout __ND1990311__Project(B_U_C_C_6(__in,__cfg).__ST216078_Layout __PP1990011) := TRANSFORM
    __EE1990352 := __PP1990011.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1990352),__ST212832_Layout),__NL(__EE1990352));
    __EE1990306 := __PP1990011.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE1990306),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP1990011;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE1990349,__ND1990311__Project(LEFT));
END;
