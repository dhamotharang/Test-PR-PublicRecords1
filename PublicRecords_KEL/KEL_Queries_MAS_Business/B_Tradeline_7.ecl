...
EXPORT B_Tradeline_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911211 := __ENH_Tradeline_8;
  EXPORT __ST219132_Layout := RECORD
  ...
  END;
  EXPORT __ST219125_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST219132_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219125_Layout __ND1911463__Project(B_Tradeline_8(__in,__cfg).__ST220504_Layout __PP1911212) := TRANSFORM
    __EE1911245 := __PP1911212.Records_;
    __ST219132_Layout __ND1911438__Project(B_Tradeline_8(__in,__cfg).__ST220511_Layout __PP1911246) := TRANSFORM
      SELF.Is_Two_Year_Full_Record_ := __AND(__OP2(__PP1911246.Record_Date_,<,__PP1911212.Current_Date_First_Of_Month_),__OP2(__PP1911246.Record_Date_,>=,__PP1911212.Two_Year_Full_Date_));
      SELF.Other_Segment_ := __NOT(__OR(__OR(__OR(__PP1911246.Carrier_Segment_,__PP1911246.Fleet_Segment_),__PP1911246.Materials_Segment_),__PP1911246.Operations_Segment_));
