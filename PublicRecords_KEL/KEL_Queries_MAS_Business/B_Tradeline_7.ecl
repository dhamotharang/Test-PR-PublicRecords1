...
EXPORT B_Tradeline_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911527 := __ENH_Tradeline_8;
  EXPORT __ST218384_Layout := RECORD
  ...
  END;
  EXPORT __ST218377_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST218384_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218377_Layout __ND1911779__Project(B_Tradeline_8(__in,__cfg).__ST219756_Layout __PP1911528) := TRANSFORM
    __EE1911561 := __PP1911528.Records_;
    __ST218384_Layout __ND1911754__Project(B_Tradeline_8(__in,__cfg).__ST219763_Layout __PP1911562) := TRANSFORM
      SELF.Is_Two_Year_Full_Record_ := __AND(__OP2(__PP1911562.Record_Date_,<,__PP1911528.Current_Date_First_Of_Month_),__OP2(__PP1911562.Record_Date_,>=,__PP1911528.Two_Year_Full_Date_));
      SELF.Other_Segment_ := __NOT(__OR(__OR(__OR(__PP1911562.Carrier_Segment_,__PP1911562.Fleet_Segment_),__PP1911562.Materials_Segment_),__PP1911562.Operations_Segment_));
      ...
      SELF.Record_Age_In_Days1_Y_ := IF(__T(__PP1911562.Is1_Y_Record_),__ECAST(KEL.typ.nint,FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1911562.Record_Date_),__ECAST(KEL.typ.nkdate,__FN4(KEL.Routines.AdjustCalendar,__CC13288,__CN(-1),__CN(0),__CN(0))))),__ECAST(KEL.typ.nint,__N(KEL.typ.int)));
      SELF := __PP1911562;
    END;
    SELF.Records_ := __PROJECT(__EE1911561,__ND1911754__Project(LEFT));
    SELF := __PP1911528;
  END;
  EXPORT __ENH_Tradeline_7 := PROJECT(__EE1911527,__ND1911779__Project(LEFT));
END;
