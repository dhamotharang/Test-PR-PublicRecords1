...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2125358 := __ENH_Sele_U_C_C_5;
  EXPORT __ST208420_Layout := RECORD
  ...
  END;
  EXPORT __ST208412_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST208420_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208412_Layout __ND2125363__Project(B_Sele_U_C_C_5(__in,__cfg).__ST212673_Layout __PP2125359) := TRANSFORM
    __EE2125396 := __PP2125359.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2125396),__ST208420_Layout),__NL(__EE2125396));
    SELF := __PP2125359;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2125358,__ND2125363__Project(LEFT));
END;
