...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2122812 := __ENH_Sele_U_C_C_5;
  EXPORT __ST207370_Layout := RECORD
  ...
  END;
  EXPORT __ST207362_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST207370_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207362_Layout __ND2122817__Project(B_Sele_U_C_C_5(__in,__cfg).__ST211619_Layout __PP2122813) := TRANSFORM
    __EE2122850 := __PP2122813.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2122850),__ST207370_Layout),__NL(__EE2122850));
    SELF := __PP2122813;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2122812,__ND2122817__Project(LEFT));
END;
