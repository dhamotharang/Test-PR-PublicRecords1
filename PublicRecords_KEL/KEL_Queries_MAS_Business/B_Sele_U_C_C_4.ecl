...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119366 := __ENH_Sele_U_C_C_5;
  EXPORT __ST202428_Layout := RECORD
  ...
  END;
  EXPORT __ST202420_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST202428_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST202420_Layout __ND2119371__Project(B_Sele_U_C_C_5(__in,__cfg).__ST206681_Layout __PP2119367) := TRANSFORM
    __EE2119404 := __PP2119367.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2119404),__ST202428_Layout),__NL(__EE2119404));
    SELF := __PP2119367;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2119366,__ND2119371__Project(LEFT));
END;
