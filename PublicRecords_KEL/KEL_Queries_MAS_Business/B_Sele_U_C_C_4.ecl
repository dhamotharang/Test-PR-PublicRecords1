...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2123668 := __ENH_Sele_U_C_C_5;
  EXPORT __ST208172_Layout := RECORD
  ...
  END;
  EXPORT __ST208164_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST208172_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208164_Layout __ND2123673__Project(B_Sele_U_C_C_5(__in,__cfg).__ST212417_Layout __PP2123669) := TRANSFORM
    __EE2123706 := __PP2123669.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2123706),__ST208172_Layout),__NL(__EE2123706));
    SELF := __PP2123669;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2123668,__ND2123673__Project(LEFT));
END;
