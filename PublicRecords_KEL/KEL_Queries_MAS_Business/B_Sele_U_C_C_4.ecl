...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2123623 := __ENH_Sele_U_C_C_5;
  EXPORT __ST208127_Layout := RECORD
  ...
  END;
  EXPORT __ST208119_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST208127_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208119_Layout __ND2123628__Project(B_Sele_U_C_C_5(__in,__cfg).__ST212372_Layout __PP2123624) := TRANSFORM
    __EE2123661 := __PP2123624.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2123661),__ST208127_Layout),__NL(__EE2123661));
    SELF := __PP2123624;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2123623,__ND2123628__Project(LEFT));
END;
