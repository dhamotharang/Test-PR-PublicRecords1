...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2129515 := __ENH_Sele_U_C_C_5;
  EXPORT __ST213439_Layout := RECORD
  ...
  END;
  EXPORT __ST213431_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST213439_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213431_Layout __ND2129520__Project(B_Sele_U_C_C_5(__in,__cfg).__ST217692_Layout __PP2129516) := TRANSFORM
    __EE2129553 := __PP2129516.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2129553),__ST213439_Layout),__NL(__EE2129553));
    SELF := __PP2129516;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2129515,__ND2129520__Project(LEFT));
END;
