...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2122794 := __ENH_Sele_U_C_C_5;
  EXPORT __ST201455_Layout := RECORD
  ...
  END;
  EXPORT __ST201447_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST201455_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201447_Layout __ND2122799__Project(B_Sele_U_C_C_5(__in,__cfg).__ST205722_Layout __PP2122795) := TRANSFORM
    __EE2122832 := __PP2122795.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2122832),__ST201455_Layout),__NL(__EE2122832));
    SELF := __PP2122795;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2122794,__ND2122799__Project(LEFT));
END;
