...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2125240 := __ENH_Sele_U_C_C_5;
  EXPORT __ST209164_Layout := RECORD
  ...
  END;
  EXPORT __ST209156_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST209164_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST209156_Layout __ND2125245__Project(B_Sele_U_C_C_5(__in,__cfg).__ST213417_Layout __PP2125241) := TRANSFORM
    __EE2125278 := __PP2125241.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2125278),__ST209164_Layout),__NL(__EE2125278));
    SELF := __PP2125241;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2125240,__ND2125245__Project(LEFT));
END;
