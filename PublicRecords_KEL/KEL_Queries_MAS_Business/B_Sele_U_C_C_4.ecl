...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2123281 := __ENH_Sele_U_C_C_5;
  ...
  END;
  EXPORT __ST196878_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST196886_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST196878_Layout __ND2123286__Project(B_Sele_U_C_C_5(__in,__cfg).__ST201170_Layout __PP2123282) := TRANSFORM
    __EE2123319 := __PP2123282.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2123319),__ST196886_Layout),__NL(__EE2123319));
    SELF := __PP2123282;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE2123281,__ND2123286__Project(LEFT));
END;
