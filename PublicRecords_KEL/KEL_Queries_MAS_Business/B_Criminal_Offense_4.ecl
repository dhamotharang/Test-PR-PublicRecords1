...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2114558 := __ENH_Criminal_Offense_5;
  EXPORT __ST206044_Layout := RECORD
  ...
  END;
  EXPORT __ST205997_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST206044_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST205997_Layout __ND2114965__Project(B_Criminal_Offense_5(__in,__cfg).__ST210639_Layout __PP2114559) := TRANSFORM
    __EE2114719 := __PP2114559.Offense_Charges_;
    __ST206044_Layout __ND2114947__Project(B_Criminal_Offense_5(__in,__cfg).__ST210686_Layout __PP2114720) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP2114720.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13192));
      SELF.Is_Felony_Non_F_C_R_A_ := __AND(__AND(__NOT(__PP2114720.Dismissed_Charges_),IF(__T(__NT(__PP2114720.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP2114720.Offense_Score_,=,__CN('F'))))),__OP2(__PP2114720.Offender_Level_,=,__CN('4')));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP2114720.Dismissed_Charges_),__NOT(__OP2(__PP2114720.Offense_Score_,=,__CN('F'))));
      SELF := __PP2114720;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE2114719,__ND2114947__Project(LEFT));
    SELF := __PP2114559;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE2114558,__ND2114965__Project(LEFT));
END;
