...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE269957 := __E_Input_B_I_I;
  EXPORT __ST220932_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST220932_Layout __ND1878588__Project(E_Input_B_I_I(__in,__cfg).Layout __PP269616) := TRANSFORM
    __CC13507 := '-99999';
    __CC13512 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP269616.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13507)),__ECAST(KEL.typ.nstr,__PP269616.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13512)));
    SELF := __PP269616;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE269957,__ND1878588__Project(LEFT));
END;
