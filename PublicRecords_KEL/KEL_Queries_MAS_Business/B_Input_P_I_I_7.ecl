...
EXPORT B_Input_P_I_I_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE322655 := __E_Input_P_I_I;
  ...
  END;
  SHARED __ST222803_Layout __ND1910631__Project(E_Input_P_I_I(__in,__cfg).Layout __PP321975) := TRANSFORM
    SELF.P___Inp_Addr_ := __OP2(IF(__T(__NT(__PP321975.P___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP321975.P___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP321975.P___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP321975.P___Inp_Addr_Line2_)));
    SELF := __PP321975;
  END;
  EXPORT __ENH_Input_P_I_I_7 := PROJECT(__EE322655,__ND1910631__Project(LEFT));
END;
