...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119484 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST207932_Layout := RECORD
  ...
  EXPORT __ST207894_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST207932_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207894_Layout __ND2119489__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST212253_Layout __PP2119485) := TRANSFORM
    __EE2119538 := __PP2119485.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2119538),__ST207932_Layout),__NL(__EE2119538));
    SELF := __PP2119485;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2119484,__ND2119489__Project(LEFT));
END;
