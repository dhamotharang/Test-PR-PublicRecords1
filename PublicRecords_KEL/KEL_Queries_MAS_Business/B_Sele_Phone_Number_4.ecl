...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2121056 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST208924_Layout := RECORD
  ...
  END;
  EXPORT __ST208886_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST208924_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208886_Layout __ND2121061__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST213253_Layout __PP2121057) := TRANSFORM
    __EE2121110 := __PP2121057.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2121110),__ST208924_Layout),__NL(__EE2121110));
    SELF := __PP2121057;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2121056,__ND2121061__Project(LEFT));
END;
