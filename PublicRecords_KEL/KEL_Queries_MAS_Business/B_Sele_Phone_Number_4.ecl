...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119439 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST207887_Layout := RECORD
  ...
  END;
  EXPORT __ST207849_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST207887_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207849_Layout __ND2119444__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST212208_Layout __PP2119440) := TRANSFORM
    __EE2119493 := __PP2119440.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2119493),__ST207887_Layout),__NL(__EE2119493));
    SELF := __PP2119440;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2119439,__ND2119444__Project(LEFT));
END;
