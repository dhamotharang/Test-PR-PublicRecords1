...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119401 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST207303_Layout := RECORD
  ...
  END;
  EXPORT __ST207265_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST207303_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207265_Layout __ND2119406__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST211632_Layout __PP2119402) := TRANSFORM
    __EE2119455 := __PP2119402.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2119455),__ST207303_Layout),__NL(__EE2119455));
    SELF := __PP2119402;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2119401,__ND2119406__Project(LEFT));
END;
