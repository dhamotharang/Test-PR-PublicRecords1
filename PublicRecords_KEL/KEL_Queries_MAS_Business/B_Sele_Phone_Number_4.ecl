...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119097 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST196646_Layout := RECORD
  ...
  END;
  EXPORT __ST196608_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST196646_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST196608_Layout __ND2119102__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST201006_Layout __PP2119098) := TRANSFORM
    __EE2119151 := __PP2119098.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2119151),__ST196646_Layout),__NL(__EE2119151));
    SELF := __PP2119098;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2119097,__ND2119102__Project(LEFT));
END;
