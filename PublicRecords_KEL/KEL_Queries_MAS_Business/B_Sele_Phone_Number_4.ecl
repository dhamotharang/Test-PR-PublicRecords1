...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2118610 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST201215_Layout := RECORD
  ...
  END;
  EXPORT __ST201177_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST201215_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201177_Layout __ND2118615__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST205558_Layout __PP2118611) := TRANSFORM
    __EE2118664 := __PP2118611.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2118664),__ST201215_Layout),__NL(__EE2118664));
    SELF := __PP2118611;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE2118610,__ND2118615__Project(LEFT));
END;
