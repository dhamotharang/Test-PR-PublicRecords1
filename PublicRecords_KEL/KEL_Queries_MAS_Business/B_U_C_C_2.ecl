...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2901691 := __ENH_U_C_C_3;
  EXPORT __ST190842_Layout := RECORD
  ...
  END;
  EXPORT __ST190838_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST190842_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190838_Layout __ND2901696__Project(B_U_C_C_3(__in,__cfg).__ST200089_Layout __PP2901692) := TRANSFORM
    __EE2901733 := __PP2901692.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2901733,__ST190842_Layout);
    SELF := __PP2901692;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2901691,__ND2901696__Project(LEFT));
END;
