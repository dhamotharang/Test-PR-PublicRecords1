...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2904147 := __ENH_U_C_C_3;
  EXPORT __ST180089_Layout := RECORD
  ...
  EXPORT __ST180085_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST180089_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180085_Layout __ND2904152__Project(B_U_C_C_3(__in,__cfg).__ST189557_Layout __PP2904148) := TRANSFORM
    __EE2904189 := __PP2904148.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2904189,__ST180089_Layout);
    SELF := __PP2904148;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2904147,__ND2904152__Project(LEFT));
END;
