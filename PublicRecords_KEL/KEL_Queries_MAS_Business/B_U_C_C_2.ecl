...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2902846 := __ENH_U_C_C_3;
  EXPORT __ST184693_Layout := RECORD
  ...
  END;
  EXPORT __ST184689_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST184693_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184689_Layout __ND2902851__Project(B_U_C_C_3(__in,__cfg).__ST194143_Layout __PP2902847) := TRANSFORM
    __EE2902888 := __PP2902847.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2902888,__ST184693_Layout);
    SELF := __PP2902847;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2902846,__ND2902851__Project(LEFT));
END;
