...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2898818 := __ENH_U_C_C_3;
  EXPORT __ST185694_Layout := RECORD
  ...
  END;
  EXPORT __ST185690_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST185694_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185690_Layout __ND2898823__Project(B_U_C_C_3(__in,__cfg).__ST195130_Layout __PP2898819) := TRANSFORM
    __EE2898860 := __PP2898819.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2898860,__ST185694_Layout);
    SELF := __PP2898819;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2898818,__ND2898823__Project(LEFT));
END;
