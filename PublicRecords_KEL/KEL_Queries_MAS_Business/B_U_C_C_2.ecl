...
EXPORT B_U_C_C_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2902562 := __ENH_U_C_C_3;
  EXPORT __ST191013_Layout := RECORD
  ...
  END;
  EXPORT __ST191009_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST191013_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191009_Layout __ND2902567__Project(B_U_C_C_3(__in,__cfg).__ST200262_Layout __PP2902563) := TRANSFORM
    __EE2902604 := __PP2902563.Sub_Filing_;
    SELF.Sub_Filing_ := __PROJECT(__EE2902604,__ST191013_Layout);
    SELF := __PP2902563;
  END;
  EXPORT __ENH_U_C_C_2 := PROJECT(__EE2902562,__ND2902567__Project(LEFT));
END;
