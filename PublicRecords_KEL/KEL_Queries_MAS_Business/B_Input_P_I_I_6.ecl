...
EXPORT B_Input_P_I_I_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1936236 := __ENH_Input_P_I_I_7;
  EXPORT __ST220238_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST220238_Layout __ND1936241__Project(B_Input_P_I_I_7(__in,__cfg).__ST222803_Layout __PP1936237) := TRANSFORM
    SELF.Addr_Not_Populated_ := FN_Compile(__cfg).FN_Is_Not_Enough_To_Clean(__ECAST(KEL.typ.nstr,__PP1936237.P___Inp_Addr_));
    SELF.City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1936237.P___Inp_Addr_City_),__ECAST(KEL.typ.nstr,__PP1936237.P___Inp_Addr_State_),__ECAST(KEL.typ.nstr,__PP1936237.P___Inp_Addr_Zip_));
    SELF := __PP1936237;
  END;
  EXPORT __ENH_Input_P_I_I_6 := PROJECT(__EE1936236,__ND1936241__Project(LEFT));
END;
