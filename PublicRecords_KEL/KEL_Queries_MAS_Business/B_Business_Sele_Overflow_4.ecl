...
EXPORT B_Business_Sele_Overflow_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2109648 := __ENH_Business_Sele_Overflow_5;
  ...
  END;
  SHARED __ST200024_Layout __ND2110019__Project(B_Business_Sele_Overflow_5(__in,__cfg).__ST204697_Layout __PP2109649) := TRANSFORM
    __CC13362 := KEL.Routines.MinN(FN_Compile(__cfg).FN_G_E_T_B_U_I_L_D_D_A_T_E(__ECAST(KEL.typ.nstr,__CN('Corp_build_version'))),__CN(__cfg.CurrentDate));
    SELF.S_O_S_Dom_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2109649.S_O_S_Dom_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13362);
    SELF.S_O_S_Dom_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2109649.S_O_S_Dom_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13362);
    SELF.S_O_S_Filing_Total_Count_ := __PP2109649.S_O_S_Domestic_Filing_Count_ + __PP2109649.S_O_S_Foreign_Filing_Count_;
    SELF.S_O_S_Frgn_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2109649.S_O_S_Frgn_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13362);
    SELF.S_O_S_Frgn_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2109649.S_O_S_Frgn_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13362);
    SELF := __PP2109649;
  END;
  EXPORT __ENH_Business_Sele_Overflow_4 := PROJECT(__EE2109648,__ND2110019__Project(LEFT));
END;
