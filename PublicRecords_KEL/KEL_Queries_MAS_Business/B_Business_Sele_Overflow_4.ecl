...
EXPORT B_Business_Sele_Overflow_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2115640 := __ENH_Business_Sele_Overflow_5;
  EXPORT __ST206016_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST206016_Layout __ND2116011__Project(B_Business_Sele_Overflow_5(__in,__cfg).__ST210689_Layout __PP2115641) := TRANSFORM
    ...
    SELF.S_O_S_Dom_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2115641.S_O_S_Dom_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13368);
    SELF.S_O_S_Dom_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2115641.S_O_S_Dom_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13368);
    SELF.S_O_S_Filing_Total_Count_ := __PP2115641.S_O_S_Domestic_Filing_Count_ + __PP2115641.S_O_S_Foreign_Filing_Count_;
    SELF.S_O_S_Frgn_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2115641.S_O_S_Frgn_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13368);
    SELF.S_O_S_Frgn_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP2115641.S_O_S_Frgn_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC13368);
    SELF := __PP2115641;
  END;
  EXPORT __ENH_Business_Sele_Overflow_4 := PROJECT(__EE2115640,__ND2116011__Project(LEFT));
END;
