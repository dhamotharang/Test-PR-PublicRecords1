...
EXPORT B_Lien_Judgment_12(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE260128 := __E_Lien_Judgment;
  EXPORT __ST226894_Layout := RECORD
  ...
  END;
  EXPORT __ST226889_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST226894_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST226889_Layout __ND260437__Project(E_Lien_Judgment(__in,__cfg).Layout __PP260370) := TRANSFORM
    __EE259976 := __PP260370.Filing_;
    __ST226894_Layout __ND260373__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP260372) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP260370.T_M_S_I_D_;
      SELF := __PP260372;
    END;
    SELF.Filing_ := __PROJECT(__EE259976,__ND260373__Project(LEFT));
    SELF := __PP260370;
  END;
  EXPORT __ENH_Lien_Judgment_12 := PROJECT(__EE260128,__ND260437__Project(LEFT));
END;
