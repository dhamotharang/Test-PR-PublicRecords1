...
EXPORT B_Lien_Judgment_12(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE254794 := __E_Lien_Judgment;
  EXPORT __ST221566_Layout := RECORD
  ...
  END;
  EXPORT __ST221561_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST221566_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221561_Layout __ND255103__Project(E_Lien_Judgment(__in,__cfg).Layout __PP255036) := TRANSFORM
    __EE254642 := __PP255036.Filing_;
    __ST221566_Layout __ND255039__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP255038) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP255036.T_M_S_I_D_;
      SELF := __PP255038;
    END;
    SELF.Filing_ := __PROJECT(__EE254642,__ND255039__Project(LEFT));
    SELF := __PP255036;
  END;
  EXPORT __ENH_Lien_Judgment_12 := PROJECT(__EE254794,__ND255103__Project(LEFT));
END;
