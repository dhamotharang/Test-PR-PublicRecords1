...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2502217 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST194355_Layout := RECORD
  ...
  END;
  EXPORT __ST194317_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST194355_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST194317_Layout __ND2502222__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST202150_Layout __PP2502218) := TRANSFORM
    __EE2502270 := __PP2502218.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2502270,__ST194355_Layout);
    SELF := __PP2502218;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2502217,__ND2502222__Project(LEFT));
END;
