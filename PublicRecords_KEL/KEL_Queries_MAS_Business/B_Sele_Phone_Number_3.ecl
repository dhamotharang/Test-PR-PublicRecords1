...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2505861 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST200075_Layout := RECORD
  ...
  END;
  EXPORT __ST200037_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200075_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200037_Layout __ND2505866__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST207849_Layout __PP2505862) := TRANSFORM
    __EE2505914 := __PP2505862.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2505914,__ST200075_Layout);
    SELF := __PP2505862;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2505861,__ND2505866__Project(LEFT));
END;
