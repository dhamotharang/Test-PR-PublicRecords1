...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2511809 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST205383_Layout := RECORD
  ...
  END;
  EXPORT __ST205345_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST205383_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST205345_Layout __ND2511814__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST213161_Layout __PP2511810) := TRANSFORM
    __EE2511862 := __PP2511810.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2511862,__ST205383_Layout);
    SELF := __PP2511810;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2511809,__ND2511814__Project(LEFT));
END;
