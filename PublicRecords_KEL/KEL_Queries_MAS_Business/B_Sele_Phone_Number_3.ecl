...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2507022 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST188782_Layout := RECORD
  ...
  END;
  EXPORT __ST188744_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST188782_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST188744_Layout __ND2507027__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST196608_Layout __PP2507023) := TRANSFORM
    __EE2507075 := __PP2507023.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2507075,__ST188782_Layout);
    SELF := __PP2507023;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2507022,__ND2507027__Project(LEFT));
END;
