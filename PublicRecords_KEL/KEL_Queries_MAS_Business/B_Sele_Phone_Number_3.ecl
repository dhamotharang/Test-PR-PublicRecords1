...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2505879 := __ENH_Sele_Phone_Number_4;
  ...
  END;
  EXPORT __ST199449_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST199487_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST199449_Layout __ND2505884__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST207265_Layout __PP2505880) := TRANSFORM
    __EE2505932 := __PP2505880.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2505932,__ST199487_Layout);
    SELF := __PP2505880;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2505879,__ND2505884__Project(LEFT));
END;
