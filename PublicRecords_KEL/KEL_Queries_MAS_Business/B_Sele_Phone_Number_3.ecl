...
IMPORT KEL16 AS KEL;
IMPORT B_Sele_Phone_Number_4,CFG_Compile,E_Business_Org,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Phone,E_Sele_Phone_Number FROM PublicRecords_KEL.KEL_Queries_MAS_Business;
...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2506170 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST193368_Layout := RECORD
  ...
  END;
  EXPORT __ST193330_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST193368_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST193330_Layout __ND2506175__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST201177_Layout __PP2506171) := TRANSFORM
    __EE2506223 := __PP2506171.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2506223,__ST193368_Layout);
    SELF := __PP2506171;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2506170,__ND2506175__Project(LEFT));
END;
