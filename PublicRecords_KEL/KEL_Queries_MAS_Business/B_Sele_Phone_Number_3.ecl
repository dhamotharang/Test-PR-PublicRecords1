...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2505906 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST200120_Layout := RECORD
  ...
  END;
  EXPORT __ST200082_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200120_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200082_Layout __ND2505911__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST207894_Layout __PP2505907) := TRANSFORM
    __EE2505959 := __PP2505907.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2505959,__ST200120_Layout);
    SELF := __PP2505907;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2505906,__ND2505911__Project(LEFT));
END;
