...
IMPORT KEL16 AS KEL;
IMPORT B_Input_P_I_I_6,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_Business;
...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1985208 := __ENH_Input_P_I_I_6;
  EXPORT __ST210574_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST210574_Layout __ND1985826__Project(B_Input_P_I_I_6(__in,__cfg).__ST214165_Layout __PP1985209) := TRANSFORM
    __CC13486 := '-99999';
    __CC13491 := '-99998';
    SELF.Input_Address_Suffix_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Sffx_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Post_Direction_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Post_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Pre_Direction_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Pre_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Primary_Name_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Prim_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Primary_Range_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Prim_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Secondary_Range_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Sec_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF.Input_Unit_Desig_Clean_Value_ := MAP(__PP1985209.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13486)),__T(__PP1985209.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13491)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985209.P___Inp_Cln_Addr_Unit_Desig_),__ECAST(KEL.typ.nstr,__CN(__CC13491)))));
    SELF := __PP1985209;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE1985208,__ND1985826__Project(LEFT));
END;
