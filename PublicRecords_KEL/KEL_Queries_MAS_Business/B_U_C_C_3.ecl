...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2507836 := __ENH_U_C_C_4;
  EXPORT __ST200266_Layout := RECORD
  ...
  END;
  EXPORT __ST200262_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST200266_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200262_Layout __ND2508075__Project(B_U_C_C_4(__in,__cfg).__ST207981_Layout __PP2507837) := TRANSFORM
    __EE2507878 := __PP2507837.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2507878),__ST200266_Layout),__NL(__EE2507878));
    SELF.Active_Status_ := __OP2(__PP2507837.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP2507837;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE2507836,__ND2508075__Project(LEFT));
END;
