...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2507007 := __ENH_U_C_C_4;
  EXPORT __ST200093_Layout := RECORD
  ...
  EXPORT __ST200089_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200093_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200089_Layout __ND2507246__Project(B_U_C_C_4(__in,__cfg).__ST207808_Layout __PP2507008) := TRANSFORM
    __EE2507049 := __PP2507008.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2507049),__ST200093_Layout),__NL(__EE2507049));
    SELF.Active_Status_ := __OP2(__PP2507008.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP2507008;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE2507007,__ND2507246__Project(LEFT));
END;
