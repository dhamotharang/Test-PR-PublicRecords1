...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2904158 := __ENH_Tradeline_3;
  EXPORT __ST192450_Layout := RECORD
  ...
  END;
  EXPORT __ST192443_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST192450_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192443_Layout __ND2904102__Project(B_Tradeline_3(__in,__cfg).__ST201690_Layout __PP2903549) := TRANSFORM
    __EE2904161 := __PP2903549.Records_;
    __ST192450_Layout __ND2904022__Project(B_Tradeline_3(__in,__cfg).__ST201697_Layout __PP2903590) := TRANSFORM
      __EE2904015 := __PP2903549.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP2903549.Is_Active_,__OP2(__PP2903590.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE2904015,__T(__EE2904015).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP2903590.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP2903590.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP2903590.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP2903590.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP2903590;
    END;
    SELF.Records_ := __PROJECT(__EE2904161,__ND2904022__Project(LEFT));
    SELF := __PP2903549;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE2904158,__ND2904102__Project(LEFT));
END;
