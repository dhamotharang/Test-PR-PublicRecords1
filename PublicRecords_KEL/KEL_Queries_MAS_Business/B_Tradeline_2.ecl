...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2902481 := __ENH_Tradeline_3;
  EXPORT __ST191468_Layout := RECORD
  ...
  END;
  EXPORT __ST191461_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST191468_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191461_Layout __ND2902425__Project(B_Tradeline_3(__in,__cfg).__ST200702_Layout __PP2901872) := TRANSFORM
    __EE2902484 := __PP2901872.Records_;
    __ST191468_Layout __ND2902345__Project(B_Tradeline_3(__in,__cfg).__ST200709_Layout __PP2901913) := TRANSFORM
      __EE2902338 := __PP2901872.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP2901872.Is_Active_,__OP2(__PP2901913.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE2902338,__T(__EE2902338).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP2901913.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP2901913.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP2901913.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP2901913.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP2901913;
    END;
    SELF.Records_ := __PROJECT(__EE2902484,__ND2902345__Project(LEFT));
    SELF := __PP2901872;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE2902481,__ND2902425__Project(LEFT));
END;
