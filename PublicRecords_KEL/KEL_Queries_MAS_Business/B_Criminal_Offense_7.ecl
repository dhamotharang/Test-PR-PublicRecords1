...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE314769 := __E_Criminal_Offense;
  EXPORT __ST217063_Layout := RECORD
  ...
  END;
  EXPORT __ST217016_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST217063_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217016_Layout __ND315401__Project(E_Criminal_Offense(__in,__cfg).Layout __PP314364) := TRANSFORM
    __EE314589 := __PP314364.Offense_Charges_;
    __ST217063_Layout __ND315024__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP315020) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP315020.Date_First_Seen_);
      SELF := __PP315020;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE314589,__ND315024__Project(LEFT));
    SELF := __PP314364;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE314769,__ND315401__Project(LEFT));
END;
