...
IMPORT KEL16 AS KEL;
IMPORT CFG_Compile,E_Criminal_Offense FROM PublicRecords_KEL.KEL_Queries_MAS_Business;
...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE314156 := __E_Criminal_Offense;
  EXPORT __ST216450_Layout := RECORD
  ...
  END;
  EXPORT __ST216403_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST216450_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216403_Layout __ND314788__Project(E_Criminal_Offense(__in,__cfg).Layout __PP313751) := TRANSFORM
    __EE313976 := __PP313751.Offense_Charges_;
    __ST216450_Layout __ND314411__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP314407) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP314407.Date_First_Seen_);
      SELF := __PP314407;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE313976,__ND314411__Project(LEFT));
    SELF := __PP313751;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE314156,__ND314788__Project(LEFT));
END;
