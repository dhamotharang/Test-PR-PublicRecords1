...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE314724 := __E_Criminal_Offense;
  EXPORT __ST217018_Layout := RECORD
  ...
  END;
  EXPORT __ST216971_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST217018_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216971_Layout __ND315356__Project(E_Criminal_Offense(__in,__cfg).Layout __PP314319) := TRANSFORM
    __EE314544 := __PP314319.Offense_Charges_;
    __ST217018_Layout __ND314979__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP314975) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP314975.Date_First_Seen_);
      SELF := __PP314975;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE314544,__ND314979__Project(LEFT));
    SELF := __PP314319;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE314724,__ND315356__Project(LEFT));
END;
