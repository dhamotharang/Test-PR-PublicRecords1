...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE313975 := __E_Criminal_Offense;
  ...
  END;
  EXPORT __ST216222_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST216269_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216222_Layout __ND314607__Project(E_Criminal_Offense(__in,__cfg).Layout __PP313570) := TRANSFORM
    __EE313795 := __PP313570.Offense_Charges_;
    __ST216269_Layout __ND314230__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP314226) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP314226.Date_First_Seen_);
      SELF := __PP314226;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE313795,__ND314230__Project(LEFT));
    SELF := __PP313570;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE313975,__ND314607__Project(LEFT));
END;
