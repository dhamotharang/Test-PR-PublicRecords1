...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE315783 := __E_Criminal_Offense;
  ...
  EXPORT __ST218024_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218071_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218024_Layout __ND316415__Project(E_Criminal_Offense(__in,__cfg).Layout __PP315378) := TRANSFORM
    __EE315603 := __PP315378.Offense_Charges_;
    __ST218071_Layout __ND316038__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP316034) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP316034.Date_First_Seen_);
      SELF := __PP316034;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE315603,__ND316038__Project(LEFT));
    SELF := __PP315378;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE315783,__ND316415__Project(LEFT));
END;
