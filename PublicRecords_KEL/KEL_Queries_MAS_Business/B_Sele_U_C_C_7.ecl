...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1909529 := __ENH_Sele_U_C_C_8;
  EXPORT __ST217371_Layout := RECORD
  ...
  END;
  EXPORT __ST217363_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST217371_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217363_Layout __ND1909507__Project(B_Sele_U_C_C_8(__in,__cfg).__ST295957_Layout __PP1909374) := TRANSFORM
    __EE1909532 := __PP1909374.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1909532),__ST217371_Layout),__NL(__EE1909532));
    __EE1909502 := __PP1909374.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE1909502))[1].Party_Type_;
    SELF := __PP1909374;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE1909529,__ND1909507__Project(LEFT));
END;
