...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911858 := __ENH_Sele_U_C_C_8;
  EXPORT __ST219666_Layout := RECORD
  ...
  END;
  EXPORT __ST219658_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219666_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219658_Layout __ND1911836__Project(B_Sele_U_C_C_8(__in,__cfg).__ST298258_Layout __PP1911703) := TRANSFORM
    __EE1911861 := __PP1911703.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1911861),__ST219666_Layout),__NL(__EE1911861));
    __EE1911831 := __PP1911703.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE1911831))[1].Party_Type_;
    SELF := __PP1911703;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE1911858,__ND1911836__Project(LEFT));
END;
