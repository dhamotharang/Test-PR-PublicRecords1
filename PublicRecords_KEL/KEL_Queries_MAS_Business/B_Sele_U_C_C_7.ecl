...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1909796 := __ENH_Sele_U_C_C_8;
  EXPORT __ST217939_Layout := RECORD
  ...
  END;
  EXPORT __ST217931_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST217939_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217931_Layout __ND1909774__Project(B_Sele_U_C_C_8(__in,__cfg).__ST296525_Layout __PP1909641) := TRANSFORM
    __EE1909799 := __PP1909641.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1909799),__ST217939_Layout),__NL(__EE1909799));
    __EE1909769 := __PP1909641.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE1909769))[1].Party_Type_;
    SELF := __PP1909641;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE1909796,__ND1909774__Project(LEFT));
END;
