...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1915459 := __ENH_Sele_U_C_C_8;
  EXPORT __ST223267_Layout := RECORD
  ...
  END;
  EXPORT __ST223259_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST223267_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223259_Layout __ND1915437__Project(B_Sele_U_C_C_8(__in,__cfg).__ST301859_Layout __PP1915304) := TRANSFORM
    __EE1915462 := __PP1915304.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1915462),__ST223267_Layout),__NL(__EE1915462));
    __EE1915432 := __PP1915304.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE1915432))[1].Party_Type_;
    SELF := __PP1915304;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE1915459,__ND1915437__Project(LEFT));
END;
