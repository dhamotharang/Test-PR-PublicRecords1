...
EXPORT B_Input_B_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1981068 := __ENH_Input_B_I_I_6;
  EXPORT __ST218968_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST218968_Layout __ND1981516__Project(B_Input_B_I_I_6(__in,__cfg).__ST218535_Layout __PP1981069) := TRANSFORM
    __CC13546 := '-99999';
    __CC13551 := '-99998';
    SELF.B___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP1981069.Bus_Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13546)),__ECAST(KEL.typ.nstr,__CN(__CC13551)));
    SELF.Bus_Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP1981069.B___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13546)),__T(__AND(__CN(__PP1981069.B___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13551)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13551)))));
    SELF.Bus_Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP1981069.B___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13546)),__T(__AND(__CN(__PP1981069.B___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13551)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13551)))));
    SELF.Bus_Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP1981069.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13546)),__T(__AND(__CN(__PP1981069.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13551)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13551)))));
    SELF.Bus_Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP1981069.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13546)),__T(__AND(__CN(__PP1981069.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1981069.Addr_Not_Populated_),__PP1981069.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13551)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13551)))));
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP1981069.B___Inp_Cln_Addr_Zip5_));
    SELF := __PP1981069;
  END;
  EXPORT __ENH_Input_B_I_I_5 := PROJECT(__EE1981068,__ND1981516__Project(LEFT));
END;
