...
IMPORT KEL16 AS KEL;
IMPORT B_Input_B_I_I_6,CFG_Compile,E_Business_Org,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_Business;
...
EXPORT B_Input_B_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1985338 := __ENH_Input_B_I_I_6;
  EXPORT __ST228968_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST228968_Layout __ND1985786__Project(B_Input_B_I_I_6(__in,__cfg).__ST228535_Layout __PP1985339) := TRANSFORM
    __CC13507 := '-99999';
    __CC13512 := '-99998';
    SELF.B___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP1985339.Bus_Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13507)),__ECAST(KEL.typ.nstr,__CN(__CC13512)));
    SELF.Bus_Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985339.B___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13507)),__T(__AND(__CN(__PP1985339.B___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13512)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13512)))));
    SELF.Bus_Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985339.B___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13507)),__T(__AND(__CN(__PP1985339.B___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13512)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13512)))));
    SELF.Bus_Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985339.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13507)),__T(__AND(__CN(__PP1985339.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13512)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13512)))));
    SELF.Bus_Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985339.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13507)),__T(__AND(__CN(__PP1985339.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1985339.Addr_Not_Populated_),__PP1985339.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13512)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13512)))));
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP1985339.B___Inp_Cln_Addr_Zip5_));
    SELF := __PP1985339;
  END;
  EXPORT __ENH_Input_B_I_I_5 := PROJECT(__EE1985338,__ND1985786__Project(LEFT));
END;
