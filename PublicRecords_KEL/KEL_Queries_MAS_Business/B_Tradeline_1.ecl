...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3223903 := __ENH_Tradeline_2;
  EXPORT __ST181701_Layout := RECORD
  ...
  END;
  EXPORT __ST181694_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST181701_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181694_Layout __ND3223908__Project(B_Tradeline_2(__in,__cfg).__ST192443_Layout __PP3223904) := TRANSFORM
    __EE3223933 := __PP3223904.Records_;
    SELF.Records_ := __PROJECT(__EE3223933,__ST181701_Layout);
    SELF := __PP3223904;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE3223903,__ND3223908__Project(LEFT));
END;
