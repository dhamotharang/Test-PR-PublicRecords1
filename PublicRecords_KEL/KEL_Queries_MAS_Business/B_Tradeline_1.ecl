...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3218497 := __ENH_Tradeline_2;
  EXPORT __ST174728_Layout := RECORD
  ...
  END;
  EXPORT __ST174721_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST174728_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174721_Layout __ND3218502__Project(B_Tradeline_2(__in,__cfg).__ST185503_Layout __PP3218498) := TRANSFORM
    __EE3218527 := __PP3218498.Records_;
    SELF.Records_ := __PROJECT(__EE3218527,__ST174728_Layout);
    SELF := __PP3218498;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE3218497,__ND3218502__Project(LEFT));
END;
