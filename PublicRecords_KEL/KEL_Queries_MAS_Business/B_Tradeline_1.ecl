...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3222181 := __ENH_Tradeline_2;
  EXPORT __ST180680_Layout := RECORD
  ...
  END;
  EXPORT __ST180673_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST180680_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180673_Layout __ND3222186__Project(B_Tradeline_2(__in,__cfg).__ST191416_Layout __PP3222182) := TRANSFORM
    __EE3222211 := __PP3222182.Records_;
    SELF.Records_ := __PROJECT(__EE3222211,__ST180680_Layout);
    SELF := __PP3222182;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE3222181,__ND3222186__Project(LEFT));
END;
