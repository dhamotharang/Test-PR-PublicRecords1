...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1905850 := __ENH_U_C_C_8;
  EXPORT __ST212555_Layout := RECORD
  ...
  END;
  EXPORT __ST212551_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST212555_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212551_Layout __ND1905855__Project(B_U_C_C_8(__in,__cfg).__ST213927_Layout __PP1905851) := TRANSFORM
    __EE1905890 := __PP1905851.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1905890),__ST212555_Layout),__NL(__EE1905890));
    SELF := __PP1905851;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1905850,__ND1905855__Project(LEFT));
END;
