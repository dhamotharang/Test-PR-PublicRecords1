...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1915801 := __ENH_U_C_C_8;
  EXPORT __ST223570_Layout := RECORD
  ...
  EXPORT __ST223566_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST223570_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223566_Layout __ND1915806__Project(B_U_C_C_8(__in,__cfg).__ST224942_Layout __PP1915802) := TRANSFORM
    __EE1915841 := __PP1915802.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1915841),__ST223570_Layout),__NL(__EE1915841));
    SELF := __PP1915802;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1915801,__ND1915806__Project(LEFT));
END;
