...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1912200 := __ENH_U_C_C_8;
  EXPORT __ST219969_Layout := RECORD
  ...
  EXPORT __ST219965_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219969_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219965_Layout __ND1912205__Project(B_U_C_C_8(__in,__cfg).__ST221341_Layout __PP1912201) := TRANSFORM
    __EE1912240 := __PP1912201.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1912240),__ST219969_Layout),__NL(__EE1912240));
    SELF := __PP1912201;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1912200,__ND1912205__Project(LEFT));
END;
