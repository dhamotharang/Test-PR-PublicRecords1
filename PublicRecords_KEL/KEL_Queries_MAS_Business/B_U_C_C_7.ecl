...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1908255 := __ENH_U_C_C_8;
  EXPORT __ST211602_Layout := RECORD
  ...
  END;
  EXPORT __ST211598_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST211602_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211598_Layout __ND1908260__Project(B_U_C_C_8(__in,__cfg).__ST212974_Layout __PP1908256) := TRANSFORM
    __EE1908295 := __PP1908256.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1908295),__ST211602_Layout),__NL(__EE1908295));
    SELF := __PP1908256;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1908255,__ND1908260__Project(LEFT));
END;
