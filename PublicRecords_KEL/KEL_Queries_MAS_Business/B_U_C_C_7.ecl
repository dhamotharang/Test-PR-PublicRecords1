...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911842 := __ENH_U_C_C_8;
  EXPORT __ST218547_Layout := RECORD
  ...
  EXPORT __ST218543_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218547_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218543_Layout __ND1911847__Project(B_U_C_C_8(__in,__cfg).__ST219919_Layout __PP1911843) := TRANSFORM
    __EE1911882 := __PP1911843.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1911882),__ST218547_Layout),__NL(__EE1911882));
    SELF := __PP1911843;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1911842,__ND1911847__Project(LEFT));
END;
