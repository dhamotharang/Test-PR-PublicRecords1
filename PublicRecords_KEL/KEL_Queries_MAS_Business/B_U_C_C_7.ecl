...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1908056 := __ENH_U_C_C_8;
  EXPORT __ST207086_Layout := RECORD
  ...
  END;
  EXPORT __ST207082_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST207086_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207082_Layout __ND1908061__Project(B_U_C_C_8(__in,__cfg).__ST208458_Layout __PP1908057) := TRANSFORM
    __EE1908096 := __PP1908057.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1908096),__ST207086_Layout),__NL(__EE1908096));
    SELF := __PP1908057;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1908056,__ND1908061__Project(LEFT));
END;
