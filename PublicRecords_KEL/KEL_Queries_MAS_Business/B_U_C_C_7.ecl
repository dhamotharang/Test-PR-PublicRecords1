...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1911526 := __ENH_U_C_C_8;
  EXPORT __ST219295_Layout := RECORD
  ...
  END;
  EXPORT __ST219291_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219295_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219291_Layout __ND1911531__Project(B_U_C_C_8(__in,__cfg).__ST220667_Layout __PP1911527) := TRANSFORM
    __EE1911566 := __PP1911527.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1911566),__ST219295_Layout),__NL(__EE1911566));
    SELF := __PP1911527;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE1911526,__ND1911531__Project(LEFT));
END;
