...
EXPORT B_U_C_C_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3221906 := __ENH_U_C_C_2;
  EXPORT __ST173822_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(B_U_C_C_2(__in,__cfg).__ST184693_Layout) Sub_Filing_;
  ...
  END;
  EXPORT __ENH_U_C_C_1 := PROJECT(__EE3221906,__ST173822_Layout);
END;
