...
IMPORT KEL16 AS KEL;
IMPORT B_Education_4,B_Education_7,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_Business;
...
EXPORT B_Education_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2492478 := __ENH_Education_4;
  EXPORT __ENH_Education_3 := __EE2492478;
END;
