...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1899822 := __ENH_U_C_C_9;
  EXPORT __ST219923_Layout := RECORD
  ...
  END;
  EXPORT __ST219919_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219923_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219919_Layout __ND1899827__Project(B_U_C_C_9(__in,__cfg).__ST220834_Layout __PP1899823) := TRANSFORM
    __EE1899862 := __PP1899823.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1899862),__ST219923_Layout),__NL(__EE1899862));
    SELF := __PP1899823;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1899822,__ND1899827__Project(LEFT));
END;
