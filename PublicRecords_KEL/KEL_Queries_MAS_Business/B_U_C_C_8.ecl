...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1897851 := __ENH_U_C_C_9;
  EXPORT __ST219050_Layout := RECORD
  ...
  END;
  EXPORT __ST219046_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219050_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219046_Layout __ND1897856__Project(B_U_C_C_9(__in,__cfg).__ST219961_Layout __PP1897852) := TRANSFORM
    __EE1897891 := __PP1897852.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1897891),__ST219050_Layout),__NL(__EE1897891));
    SELF := __PP1897852;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1897851,__ND1897856__Project(LEFT));
END;
