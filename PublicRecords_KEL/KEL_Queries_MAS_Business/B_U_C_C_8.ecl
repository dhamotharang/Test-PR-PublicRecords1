...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1898118 := __ENH_U_C_C_9;
  EXPORT __ST219618_Layout := RECORD
  ...
  EXPORT __ST219614_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219618_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219614_Layout __ND1898123__Project(B_U_C_C_9(__in,__cfg).__ST220529_Layout __PP1898119) := TRANSFORM
    __EE1898158 := __PP1898119.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1898158),__ST219618_Layout),__NL(__EE1898158));
    SELF := __PP1898119;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1898118,__ND1898123__Project(LEFT));
END;
