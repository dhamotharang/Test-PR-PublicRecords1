...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1897306 := __ENH_U_C_C_9;
  EXPORT __ST218869_Layout := RECORD
  ...
  END;
  EXPORT __ST218865_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST218869_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218865_Layout __ND1897311__Project(B_U_C_C_9(__in,__cfg).__ST219780_Layout __PP1897307) := TRANSFORM
    __EE1897346 := __PP1897307.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1897346),__ST218869_Layout),__NL(__EE1897346));
    SELF := __PP1897307;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1897306,__ND1897311__Project(LEFT));
END;
