...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1903781 := __ENH_U_C_C_9;
  EXPORT __ST224946_Layout := RECORD
  ...
  END;
  EXPORT __ST224942_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST224946_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224942_Layout __ND1903786__Project(B_U_C_C_9(__in,__cfg).__ST225857_Layout __PP1903782) := TRANSFORM
    __EE1903821 := __PP1903782.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1903821),__ST224946_Layout),__NL(__EE1903821));
    SELF := __PP1903782;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1903781,__ND1903786__Project(LEFT));
END;
