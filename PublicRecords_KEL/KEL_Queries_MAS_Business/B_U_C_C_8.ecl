...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1898163 := __ENH_U_C_C_9;
  EXPORT __ST219663_Layout := RECORD
  ...
  END;
  EXPORT __ST219659_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST219663_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219659_Layout __ND1898168__Project(B_U_C_C_9(__in,__cfg).__ST220574_Layout __PP1898164) := TRANSFORM
    __EE1898203 := __PP1898164.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1898203),__ST219663_Layout),__NL(__EE1898203));
    SELF := __PP1898164;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1898163,__ND1898168__Project(LEFT));
END;
