...
EXPORT B_U_C_C_13(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE254333 := __E_U_C_C;
  EXPORT __ST221752_Layout := RECORD
  ...
  EXPORT __ST221748_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST221752_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221748_Layout __ND254562__Project(E_U_C_C(__in,__cfg).Layout __PP254161) := TRANSFORM
    __EE254192 := __PP254161.Sub_Filing_;
    __ST221752_Layout __ND254460__Project(E_U_C_C(__in,__cfg).Sub_Filing_Layout __PP254456) := TRANSFORM
      SELF.Max_Filing_Date_ := KEL.Routines.MaxN(__PP254456.Filing_Date_,__PP254456.Original_Filing_Date_);
      SELF := __PP254456;
    END;
    SELF.Sub_Filing_ := __PROJECT(__EE254192,__ND254460__Project(LEFT));
    SELF := __PP254161;
  END;
  EXPORT __ENH_U_C_C_13 := PROJECT(__EE254333,__ND254562__Project(LEFT));
END;
