...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2493639 := __ENH_Input_P_I_I_4;
  EXPORT __ST199313_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST199313_Layout __ND2494396__Project(B_Input_P_I_I_4(__in,__cfg).__ST207207_Layout __PP2493640) := TRANSFORM
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_Zip5_));
    __CC13537 := '-99999';
    __CC13542 := '-99998';
    SELF.Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP2493640.P___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13537)),__T(__AND(__CN(__PP2493640.P___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13542)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13542)))));
    SELF.Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP2493640.P___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13537)),__T(__AND(__CN(__PP2493640.P___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13542)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13542)))));
    SELF.Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP2493640.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13537)),__T(__AND(__CN(__PP2493640.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13542)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13542)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP2493640.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13537)),__T(__AND(__CN(__PP2493640.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP2493640.Addr_Not_Populated_),__PP2493640.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13542)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13542)))));
    SELF.Name_Not_Populated_ := IF(FN_Compile(__cfg).FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__PP2493640.P___Inp_Name_Last_)),TRUE,FALSE);
    SELF.P___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP2493640.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13537)),__ECAST(KEL.typ.nstr,__CN(__CC13542)));
    SELF.P___Inp_Val_Name_Bogus_Flag_ := MAP(__T(__AND(__AND(__OP2(__PP2493640.Input_First_Name_Value_,=,__CN(__CC13537)),__OP2(__PP2493640.Input_Middle_Name_Value_,=,__CN(__CC13537))),__OP2(__PP2493640.Input_Last_Name_Value_,=,__CN(__CC13537))))=>__CC13537,__T(__OP2(FN_Compile(__cfg).FN__fn_Bogus_Names(__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP2493640.P___Inp_Name_First_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP2493640.Input_Middle_Name_Value_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP2493640.Input_Last_Name_Value_))),=,__CAST(KEL.typ.str,__CN(1))))=>(KEL.typ.str)1,(KEL.typ.str)0);
    SELF := __PP2493640;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE2493639,__ND2494396__Project(LEFT));
END;
