...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1929120 := __ENH_Criminal_Offense_7;
  EXPORT __ST213815_Layout := RECORD
  ...
  END;
  EXPORT __ST213768_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST213815_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213768_Layout __ND1929493__Project(B_Criminal_Offense_7(__in,__cfg).__ST216403_Layout __PP1929121) := TRANSFORM
    __EE1929281 := __PP1929121.Offense_Charges_;
    __ST213815_Layout __ND1929481__Project(B_Criminal_Offense_7(__in,__cfg).__ST216450_Layout __PP1929282) := TRANSFORM
      __CC13896 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1929282.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1929282.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13896)));
      SELF := __PP1929282;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1929281,__ND1929481__Project(LEFT));
    SELF := __PP1929121;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1929120,__ND1929493__Project(LEFT));
END;
