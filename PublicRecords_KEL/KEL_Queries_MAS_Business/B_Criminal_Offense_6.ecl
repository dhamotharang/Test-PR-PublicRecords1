...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1935050 := __ENH_Criminal_Offense_7;
  EXPORT __ST219711_Layout := RECORD
  ...
  END;
  EXPORT __ST219664_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST219711_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219664_Layout __ND1935423__Project(B_Criminal_Offense_7(__in,__cfg).__ST222299_Layout __PP1935051) := TRANSFORM
    __EE1935211 := __PP1935051.Offense_Charges_;
    __ST219711_Layout __ND1935411__Project(B_Criminal_Offense_7(__in,__cfg).__ST222346_Layout __PP1935212) := TRANSFORM
      __CC14121 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1935212.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1935212.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14121)));
      SELF := __PP1935212;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1935211,__ND1935411__Project(LEFT));
    SELF := __PP1935051;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1935050,__ND1935423__Project(LEFT));
END;
