...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1929387 := __ENH_Criminal_Offense_7;
  EXPORT __ST214391_Layout := RECORD
  ...
  END;
  EXPORT __ST214344_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST214391_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST214344_Layout __ND1929760__Project(B_Criminal_Offense_7(__in,__cfg).__ST216971_Layout __PP1929388) := TRANSFORM
    __EE1929548 := __PP1929388.Offense_Charges_;
    __ST214391_Layout __ND1929748__Project(B_Criminal_Offense_7(__in,__cfg).__ST217018_Layout __PP1929549) := TRANSFORM
      __CC13929 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1929549.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1929549.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13929)));
      SELF := __PP1929549;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1929548,__ND1929748__Project(LEFT));
    SELF := __PP1929388;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1929387,__ND1929760__Project(LEFT));
END;
