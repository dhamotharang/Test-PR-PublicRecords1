...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1929432 := __ENH_Criminal_Offense_7;
  EXPORT __ST214436_Layout := RECORD
  ...
  END;
  EXPORT __ST214389_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST214436_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST214389_Layout __ND1929805__Project(B_Criminal_Offense_7(__in,__cfg).__ST217016_Layout __PP1929433) := TRANSFORM
    __EE1929593 := __PP1929433.Offense_Charges_;
    __ST214436_Layout __ND1929793__Project(B_Criminal_Offense_7(__in,__cfg).__ST217063_Layout __PP1929594) := TRANSFORM
      __CC13974 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1929594.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1929594.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13974)));
      SELF := __PP1929594;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1929593,__ND1929793__Project(LEFT));
    SELF := __PP1929433;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1929432,__ND1929805__Project(LEFT));
END;
