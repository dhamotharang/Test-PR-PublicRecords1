...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1931091 := __ENH_Criminal_Offense_7;
  EXPORT __ST214695_Layout := RECORD
  ...
  END;
  EXPORT __ST214648_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST214695_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST214648_Layout __ND1931469__Project(B_Criminal_Offense_7(__in,__cfg).__ST217276_Layout __PP1931092) := TRANSFORM
    __EE1931252 := __PP1931092.Offense_Charges_;
    __ST214695_Layout __ND1931456__Project(B_Criminal_Offense_7(__in,__cfg).__ST217323_Layout __PP1931253) := TRANSFORM
      __CC13974 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1931253.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1931253.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13974)));
      SELF := __PP1931253;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1931252,__ND1931456__Project(LEFT));
    SELF := __PP1931092;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1931091,__ND1931469__Project(LEFT));
END;
