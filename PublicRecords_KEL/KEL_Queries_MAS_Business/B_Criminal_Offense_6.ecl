...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1928575 := __ENH_Criminal_Offense_7;
  EXPORT __ST213638_Layout := RECORD
  ...
  END;
  EXPORT __ST213591_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST213638_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213591_Layout __ND1928948__Project(B_Criminal_Offense_7(__in,__cfg).__ST216222_Layout __PP1928576) := TRANSFORM
    __EE1928736 := __PP1928576.Offense_Charges_;
    __ST213638_Layout __ND1928936__Project(B_Criminal_Offense_7(__in,__cfg).__ST216269_Layout __PP1928737) := TRANSFORM
      __CC13923 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1928737.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1928737.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13923)));
      SELF := __PP1928737;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1928736,__ND1928936__Project(LEFT));
    SELF := __PP1928576;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1928575,__ND1928948__Project(LEFT));
END;
