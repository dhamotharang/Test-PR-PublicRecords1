...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1925099 := __ENH_Criminal_Offense_7;
  EXPORT __ST208703_Layout := RECORD
  ...
  END;
  EXPORT __ST208656_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST208703_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208656_Layout __ND1925477__Project(B_Criminal_Offense_7(__in,__cfg).__ST211284_Layout __PP1925100) := TRANSFORM
    __EE1925260 := __PP1925100.Offense_Charges_;
    __ST208703_Layout __ND1925464__Project(B_Criminal_Offense_7(__in,__cfg).__ST211331_Layout __PP1925261) := TRANSFORM
      __CC13968 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1925261.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1925261.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13968)));
      SELF := __PP1925261;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1925260,__ND1925464__Project(LEFT));
    SELF := __PP1925100;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1925099,__ND1925477__Project(LEFT));
END;
