...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3216742 := __ENH_Sele_Phone_Number_2;
  ...
  END;
  EXPORT __ST180126_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST180164_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180126_Layout __ND3216747__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST190704_Layout __PP3216743) := TRANSFORM
    __EE3216795 := __PP3216743.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3216795),__ST180164_Layout),__NL(__EE3216795));
    SELF := __PP3216743;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3216742,__ND3216747__Project(LEFT));
END;
