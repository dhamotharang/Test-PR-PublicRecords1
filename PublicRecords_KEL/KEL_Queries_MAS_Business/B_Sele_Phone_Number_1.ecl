...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3210750 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST174172_Layout := RECORD
  ...
  EXPORT __ST174134_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST174172_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174134_Layout __ND3210755__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST184712_Layout __PP3210751) := TRANSFORM
    __EE3210803 := __PP3210751.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3210803),__ST174172_Layout),__NL(__EE3210803));
    SELF := __PP3210751;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3210750,__ND3210755__Project(LEFT));
END;
