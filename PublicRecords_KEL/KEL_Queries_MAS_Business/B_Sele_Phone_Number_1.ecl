...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3214494 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST179526_Layout := RECORD
  ...
  END;
  EXPORT __ST179488_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST179526_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179488_Layout __ND3214499__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST190031_Layout __PP3214495) := TRANSFORM
    __EE3214547 := __PP3214495.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3214547),__ST179526_Layout),__NL(__EE3214547));
    SELF := __PP3214495;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3214494,__ND3214499__Project(LEFT));
END;
