...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3216830 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST181819_Layout := RECORD
  ...
  END;
  EXPORT __ST181781_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST181819_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181781_Layout __ND3216835__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST192326_Layout __PP3216831) := TRANSFORM
    __EE3216883 := __PP3216831.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3216883),__ST181819_Layout),__NL(__EE3216883));
    SELF := __PP3216831;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3216830,__ND3216835__Project(LEFT));
END;
