...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3216156 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST181145_Layout := RECORD
  ...
  END;
  EXPORT __ST181107_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST181145_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181107_Layout __ND3216161__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST191652_Layout __PP3216157) := TRANSFORM
    __EE3216209 := __PP3216157.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3216209),__ST181145_Layout),__NL(__EE3216209));
    SELF := __PP3216157;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3216156,__ND3216161__Project(LEFT));
END;
