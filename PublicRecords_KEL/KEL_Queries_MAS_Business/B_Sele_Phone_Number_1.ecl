...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3220431 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST185420_Layout := RECORD
  ...
  END;
  EXPORT __ST185382_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST185420_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185382_Layout __ND3220436__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST195927_Layout __PP3220432) := TRANSFORM
    __EE3220484 := __PP3220432.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3220484),__ST185420_Layout),__NL(__EE3220484));
    SELF := __PP3220432;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE3220431,__ND3220436__Project(LEFT));
END;
