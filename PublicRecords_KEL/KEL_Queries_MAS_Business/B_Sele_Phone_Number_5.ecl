...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1990756 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST213965_Layout := RECORD
  ...
  END;
  EXPORT __ST213927_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST213965_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213927_Layout __ND1990761__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST217303_Layout __PP1990757) := TRANSFORM
    __EE1990810 := __PP1990757.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1990810),__ST213965_Layout),__NL(__EE1990810));
    SELF := __PP1990757;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1990756,__ND1990761__Project(LEFT));
END;
