...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1987670 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST211493_Layout := RECORD
  ...
  END;
  EXPORT __ST211455_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211493_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211455_Layout __ND1987675__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST214827_Layout __PP1987671) := TRANSFORM
    __EE1987724 := __PP1987671.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1987724),__ST211493_Layout),__NL(__EE1987724));
    SELF := __PP1987671;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1987670,__ND1987675__Project(LEFT));
END;
