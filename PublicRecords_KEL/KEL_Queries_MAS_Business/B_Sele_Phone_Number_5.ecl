...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1988526 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST212291_Layout := RECORD
  ...
  END;
  EXPORT __ST212253_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST212291_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212253_Layout __ND1988531__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST215621_Layout __PP1988527) := TRANSFORM
    __EE1988580 := __PP1988527.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1988580),__ST212291_Layout),__NL(__EE1988580));
    SELF := __PP1988527;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1988526,__ND1988531__Project(LEFT));
END;
