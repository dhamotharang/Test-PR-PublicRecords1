...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1988427 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST211670_Layout := RECORD
  ...
  EXPORT __ST211632_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211670_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211632_Layout __ND1988432__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST215008_Layout __PP1988428) := TRANSFORM
    __EE1988481 := __PP1988428.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1988481),__ST211670_Layout),__NL(__EE1988481));
    SELF := __PP1988428;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1988427,__ND1988432__Project(LEFT));
END;
