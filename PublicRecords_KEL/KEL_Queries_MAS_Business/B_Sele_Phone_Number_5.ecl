...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1990082 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST213291_Layout := RECORD
  ...
  END;
  EXPORT __ST213253_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST213291_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213253_Layout __ND1990087__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST216629_Layout __PP1990083) := TRANSFORM
    __EE1990136 := __PP1990083.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1990136),__ST213291_Layout),__NL(__EE1990136));
    SELF := __PP1990083;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1990082,__ND1990087__Project(LEFT));
END;
