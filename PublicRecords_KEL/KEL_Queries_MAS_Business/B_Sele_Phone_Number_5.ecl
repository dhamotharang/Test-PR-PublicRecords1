...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1988481 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST212246_Layout := RECORD
  ...
  END;
  EXPORT __ST212208_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST212246_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212208_Layout __ND1988486__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST215576_Layout __PP1988482) := TRANSFORM
    __EE1988535 := __PP1988482.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1988535),__ST212246_Layout),__NL(__EE1988535));
    SELF := __PP1988482;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1988481,__ND1988486__Project(LEFT));
END;
