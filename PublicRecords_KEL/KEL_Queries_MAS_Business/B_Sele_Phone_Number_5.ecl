...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1984211 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST206555_Layout := RECORD
  ...
  END;
  EXPORT __ST206517_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST206555_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST206517_Layout __ND1984216__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST209889_Layout __PP1984212) := TRANSFORM
    __EE1984265 := __PP1984212.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1984265),__ST206555_Layout),__NL(__EE1984265));
    SELF := __PP1984212;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1984211,__ND1984216__Project(LEFT));
END;
