...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1994357 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST217566_Layout := RECORD
  ...
  END;
  EXPORT __ST217528_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST217566_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217528_Layout __ND1994362__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST220904_Layout __PP1994358) := TRANSFORM
    __EE1994411 := __PP1994358.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1994411),__ST217566_Layout),__NL(__EE1994411));
    SELF := __PP1994358;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1994357,__ND1994362__Project(LEFT));
END;
