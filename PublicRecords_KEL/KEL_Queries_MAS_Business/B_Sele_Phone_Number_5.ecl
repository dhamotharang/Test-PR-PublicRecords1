...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1987214 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST201044_Layout := RECORD
  ...
  END;
  EXPORT __ST201006_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST201044_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201006_Layout __ND1987219__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST204410_Layout __PP1987215) := TRANSFORM
    __EE1987268 := __PP1987215.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1987268),__ST201044_Layout),__NL(__EE1987268));
    SELF := __PP1987215;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1987214,__ND1987219__Project(LEFT));
END;
