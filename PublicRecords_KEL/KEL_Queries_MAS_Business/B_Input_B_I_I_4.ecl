...
EXPORT B_Input_B_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2117345 := __ENH_Input_B_I_I_5;
  EXPORT __ST226810_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST226810_Layout __ND2117822__Project(B_Input_B_I_I_5(__in,__cfg).__ST226250_Layout __PP2117346) := TRANSFORM
    SELF.At_Position_ := FN_Compile(__cfg).FN_Find_Last_String_Instance(__ECAST(KEL.typ.nstr,__PP2117346.B___Inp_Email_),__ECAST(KEL.typ.nstr,__CN('@')));
    __CC13690 := '-99999';
    __CC13695 := '-99998';
    SELF.Bus_Input_Full_Address_Clean_Value_ := MAP(__T(__OR(__CN(__PP2117346.Addr_Not_Populated_),__PP2117346.City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13690)),__T(__OR(__OP2(__PP2117346.B___Inp_Cln_Addr_St_Flag_Value_,=,__CN('0')),__PP2117346.Clean_City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13695)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP2117346.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Sec_Rng_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_City_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_City_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_State_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_State_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Zip5_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Zip5_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2117346.Bus_Input_Zip4_Clean_Value_,=,__CN(__CC13695))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP2117346.B___Inp_Cln_Addr_Zip4_))))));
    SELF := __PP2117346;
  END;
  EXPORT __ENH_Input_B_I_I_4 := PROJECT(__EE2117345,__ND2117822__Project(LEFT));
END;
