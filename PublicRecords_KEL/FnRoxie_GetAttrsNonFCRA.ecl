EXPORT FnRoxie_GetAttrsNonFCRA(DATASET(PublicRecords_KEL.ECL_Functions.Input_Layout) InputData,
...
//options.BestPIIAppend must call mini FDC
	...
	MiniAttributesWOptOuts := MiniAttributes;//FCRA prescreen optouts 
	...
	PersonAttributes := PublicRecords_KEL.Library.LIB_NonFCRAPersonAttributes_Function(MiniAttributeInputRecords, FDCDataset, Options);
	//input consumer	
	//nonFCRA consumer
