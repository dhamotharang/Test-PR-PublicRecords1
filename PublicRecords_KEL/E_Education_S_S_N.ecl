...
EXPORT E_Education_S_S_N(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping := 'edu(Edu_:0),social(Social_:0),source(Source_:\'\'),datefirstseen(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH)';
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'EducationSSN','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Social',COUNT(__d0(__NL(Social_))),COUNT(__d0(__NN(Social_)))},
