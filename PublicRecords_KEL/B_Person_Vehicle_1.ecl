...
EXPORT B_Person_Vehicle_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7938418 := __ENH_Person_Vehicle_2;
  EXPORT __ST190741_Layout := RECORD
  ...
  END;
  SHARED __ST190741_Layout __ND7938586__Project(B_Person_Vehicle_2(__in,__cfg).__ST209185_Layout __PP7938419) := TRANSFORM
    ...
    __CC13405 := 3652;
    SELF.Seen___In___Last___Ten___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP7938419.Date_Last_Seen_Capped_,__CC13089),<=,__CN(__CC13405));
    __CC13407 := 730;
    SELF.Seen___In___Last___Two___Years_ := __OP2(__FN2(KEL.Routines.DaysBetween,__PP7938419.Date_Last_Seen_Capped_,__CC13089),<=,__CN(__CC13407));
    __CC13403 := '-99997';
    SELF.Vehicle_Max_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP7938419.Date_Last_Seen_Capped_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP7938419.Date_Last_Seen_Capped_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13403)));
    SELF := __PP7938419;
  END;
  EXPORT __ENH_Person_Vehicle_1 := PROJECT(__EE7938418,__ND7938586__Project(LEFT));
END;
