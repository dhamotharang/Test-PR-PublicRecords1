...
EXPORT B_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5889790 := __ENH_Inquiry_5;
  EXPORT __ST254930_Layout := RECORD
  ...
  END;
  EXPORT __ST254903_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST254930_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254903_Layout __ND5890163__Project(B_Inquiry_9(__in,__cfg).__ST277208_Layout __PP5889791) := TRANSFORM
    __EE5889866 := __PP5889791.Person_Info_;
    __ST254930_Layout __ND5889871__Project(E_Inquiry(__in,__cfg).Person_Info_Layout __PP5889867) := TRANSFORM
      SELF.Transaction_I_D_ := __PP5889791.Transaction_I_D_;
      SELF := __PP5889867;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5889866,__ND5889871__Project(LEFT));
    ...
    SELF.Is_Valid_Velocity_Inquiry_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP5889791.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP5889791.Is_Collection_))),__CN(NOT (__PP5889791.Is_Batch_Monitoring_Method_))),__PP5889791.Is_Product_Code_Ok_),__CN(NOT (__PP5889791.Inquiry_Function_Description_ IN __CC34768))),__CN(NOT (__PP5889791.Inquiry_Industry_ IN __CC34736))),__PP5889791.Is_Fcra_Ok_);
    SELF.Is_Valid_Velocity_Inquiry_Non_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__OP2(__PP5889791.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP5889791.Is_Collection_))),__CN(NOT (__PP5889791.Is_Batch_Monitoring_Method_))),__PP5889791.Is_Product_Code_Ok_),__CN(NOT (__PP5889791.Inquiry_Function_Description_ IN __CC34768))),__PP5889791.Is_Non_Fcra_Ok_);
    SELF := __PP5889791;
  END;
  EXPORT __ENH_Inquiry_4 := PROJECT(__EE5889790,__ND5890163__Project(LEFT));
END;
