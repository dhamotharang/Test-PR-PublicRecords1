...
EXPORT B_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5555144 := __ENH_Inquiry_5;
  EXPORT __ST240607_Layout := RECORD
  ...
  END;
  EXPORT __ST240580_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST240607_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST240580_Layout __ND5555511__Project(B_Inquiry_9(__in,__cfg).__ST262210_Layout __PP5555145) := TRANSFORM
    __EE5555219 := __PP5555145.Person_Info_;
    __ST240607_Layout __ND5555224__Project(E_Inquiry(__in,__cfg).Person_Info_Layout __PP5555220) := TRANSFORM
      SELF.Transaction_I_D_ := __PP5555145.Transaction_I_D_;
      SELF := __PP5555220;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5555219,__ND5555224__Project(LEFT));
    __CC32421 := [1,2,7];
    ...
    SELF.Is_Valid_Velocity_Inquiry_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP5555145.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP5555145.Is_Collection_))),__CN(NOT (__PP5555145.Is_Batch_Monitoring_Method_))),__OP2(__PP5555145.Inquiry_Product_Code_,IN,__CN(__CC32421))),__CN(NOT (__PP5555145.Inquiry_Function_Description_ IN __CC32434))),__CN(NOT (__PP5555145.Inquiry_Industry_ IN __CC32397))),__PP5555145.Is_Fcra_Ok_);
    SELF.Is_Valid_Velocity_Inquiry_Non_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__OP2(__PP5555145.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP5555145.Is_Collection_))),__CN(NOT (__PP5555145.Is_Batch_Monitoring_Method_))),__OP2(__PP5555145.Inquiry_Product_Code_,IN,__CN(__CC32421))),__CN(NOT (__PP5555145.Inquiry_Function_Description_ IN __CC32434))),__PP5555145.Is_Non_Fcra_Ok_);
    SELF := __PP5555145;
  END;
  EXPORT __ENH_Inquiry_4 := PROJECT(__EE5555144,__ND5555511__Project(LEFT));
END;
