...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11317337 := __ENH_Person;
  SHARED __EE11322690 := __EE11317337(__T(__OP2(__EE11317337.UID,=,__CN(__PLexID_in))));
  SHARED __ST99851_Layout := RECORD
  ...
  END;
  SHARED __ST99851_Layout __ND11322695__Project(B_Person(__in,__cfg_Local).__ST169897_Layout __PP11322691) := TRANSFORM
    SELF.Lex_I_D_ := __PP11322691.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP11322691.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    SELF := __PP11322691;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11322690,__ND11322695__Project(LEFT)));
