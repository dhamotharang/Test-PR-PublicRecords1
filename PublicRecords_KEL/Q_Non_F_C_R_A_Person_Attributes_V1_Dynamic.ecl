...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11555452 := __ENH_Person;
  SHARED __EE11560577 := __EE11555452(__T(__OP2(__EE11555452.UID,=,__CN(__PLexID_in))));
  SHARED __ST96386_Layout := RECORD
  ...
  END;
  SHARED __ST96386_Layout __ND11560582__Project(B_Person(__in,__cfg_Local).__ST164582_Layout __PP11560578) := TRANSFORM
    SELF.Lex_I_D_ := __PP11560578.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP11560578.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    SELF := __PP11560578;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11560577,__ND11560582__Project(LEFT)));
