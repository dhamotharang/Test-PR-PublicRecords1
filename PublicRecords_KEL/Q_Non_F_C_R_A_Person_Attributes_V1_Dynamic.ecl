...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE9612617 := __ENH_Person;
  SHARED __EE9617434 := __EE9612617(__T(__OP2(__EE9612617.UID,=,__CN(__PLexID_in))));
  SHARED __ST98764_Layout := RECORD
  ...
  END;
  SHARED __ST98764_Layout __ND9617439__Project(B_Person(__in,__cfg_Local).__ST168221_Layout __PP9617435) := TRANSFORM
    SELF.Lex_I_D_ := __PP9617435.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP9617435.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    ...
    SELF := __PP9617435;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE9617434,__ND9617439__Project(LEFT)));
