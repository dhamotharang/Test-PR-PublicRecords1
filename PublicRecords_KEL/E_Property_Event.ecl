...
EXPORT E_Property_Event(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __d0_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d0_UID_Mapped := JOIN(__d0_KELfiltered,Lookup,TRIM((STRING)LEFT.ln_fares_id) = RIGHT.KeyVal,TRANSFORM(__d0_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  SHARED __d0_Prop__Layout := RECORD
    RECORDOF(__d0_UID_Mapped);
    KEL.typ.uid Prop_;
  END;
  SHARED __d0_Prop__Mapped := JOIN(KEL.Intake.AppendNonExistUidComponents(__d0_UID_Mapped,'prim_range,predir,prim_name,suffix,postdir,zip,sec_range','__in'),E_Property(__in,__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.zip) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d0_Prop__Layout,SELF.Prop_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH);
  ...
  SHARED __d1_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d1_UID_Mapped := JOIN(__d1_KELfiltered,Lookup,TRIM((STRING)LEFT.ln_fares_id) = RIGHT.KeyVal,TRANSFORM(__d1_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  SHARED __d1_Prop__Layout := RECORD
    RECORDOF(__d1_UID_Mapped);
    KEL.typ.uid Prop_;
  END;
  SHARED __d1_Prop__Mapped := JOIN(KEL.Intake.AppendNonExistUidComponents(__d1_UID_Mapped,'prim_range,predir,prim_name,suffix,postdir,zip,sec_range','__in'),E_Property(__in,__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.zip) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d1_Prop__Layout,SELF.Prop_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH);
  ...
  SHARED __d2_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d2_UID_Mapped := JOIN(__d2_KELfiltered,Lookup,TRIM((STRING)LEFT.ln_fares_id) = RIGHT.KeyVal,TRANSFORM(__d2_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  SHARED __d2_Prop__Layout := RECORD
    RECORDOF(__d2_UID_Mapped);
    KEL.typ.uid Prop_;
  END;
  SHARED __d2_Prop__Mapped := JOIN(KEL.Intake.AppendNonExistUidComponents(__d2_UID_Mapped,'prim_range,predir,prim_name,suffix,postdir,zip,sec_range','__in'),E_Property(__in,__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.zip) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d2_Prop__Layout,SELF.Prop_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH);
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','prim_range',COUNT(__d0(__NL(Primary_Range_))),COUNT(__d0(__NN(Primary_Range_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','predir',COUNT(__d0(__NL(Predirectional_))),COUNT(__d0(__NN(Predirectional_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','prim_name',COUNT(__d0(__NL(Primary_Name_))),COUNT(__d0(__NN(Primary_Name_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','suffix',COUNT(__d0(__NL(Suffix_))),COUNT(__d0(__NN(Suffix_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','postdir',COUNT(__d0(__NL(Postdirectional_))),COUNT(__d0(__NN(Postdirectional_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','zip',COUNT(__d0(__NL(Z_I_P5_))),COUNT(__d0(__NN(Z_I_P5_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sec_range',COUNT(__d0(__NL(Secondary_Range_))),COUNT(__d0(__NN(Secondary_Range_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_first_reported',COUNT(__d0(__NL(Date_Vendor_First_Reported_))),COUNT(__d0(__NN(Date_Vendor_First_Reported_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_last_reported',COUNT(__d0(__NL(Date_Vendor_Last_Reported_))),COUNT(__d0(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','prim_range',COUNT(__d1(__NL(Primary_Range_))),COUNT(__d1(__NN(Primary_Range_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','predir',COUNT(__d1(__NL(Predirectional_))),COUNT(__d1(__NN(Predirectional_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','prim_name',COUNT(__d1(__NL(Primary_Name_))),COUNT(__d1(__NN(Primary_Name_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','suffix',COUNT(__d1(__NL(Suffix_))),COUNT(__d1(__NN(Suffix_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','postdir',COUNT(__d1(__NL(Postdirectional_))),COUNT(__d1(__NN(Postdirectional_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','zip',COUNT(__d1(__NL(Z_I_P5_))),COUNT(__d1(__NN(Z_I_P5_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sec_range',COUNT(__d1(__NL(Secondary_Range_))),COUNT(__d1(__NN(Secondary_Range_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_first_reported',COUNT(__d1(__NL(Date_Vendor_First_Reported_))),COUNT(__d1(__NN(Date_Vendor_First_Reported_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_last_reported',COUNT(__d1(__NL(Date_Vendor_Last_Reported_))),COUNT(__d1(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','tax_exemption_code',COUNT(__d1(__NL(Tax_Exemption_Code_))),COUNT(__d1(__NN(Tax_Exemption_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','tax_exemption_code_counter',COUNT(__d1(__NL(Tax_Exemption_Code_Counter_))),COUNT(__d1(__NN(Tax_Exemption_Code_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','school_tax_district',COUNT(__d1(__NL(School_Tax_District_))),COUNT(__d1(__NN(School_Tax_District_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','school_tax_district_indicator',COUNT(__d1(__NL(School_Tax_District_Indicator_))),COUNT(__d1(__NN(School_Tax_District_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','school_tax_district_counter',COUNT(__d1(__NL(School_Tax_District_Counter_))),COUNT(__d1(__NN(School_Tax_District_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','building_area_counter',COUNT(__d1(__NL(Building_Area_Counter_))),COUNT(__d1(__NN(Building_Area_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','site_influence_code',COUNT(__d1(__NL(Site_Influence_Code_))),COUNT(__d1(__NN(Site_Influence_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','site_influence_counter',COUNT(__d1(__NL(Site_Influence_Counter_))),COUNT(__d1(__NN(Site_Influence_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','amenity_code',COUNT(__d1(__NL(Amenity_Code_))),COUNT(__d1(__NN(Amenity_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','amenity_counter',COUNT(__d1(__NL(Amenity_Counter_))),COUNT(__d1(__NN(Amenity_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','extra_features_area',COUNT(__d1(__NL(Extra_Feature_Area_))),COUNT(__d1(__NN(Extra_Feature_Area_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','extra_features_indicator',COUNT(__d1(__NL(Extra_Feature_Indicator_))),COUNT(__d1(__NN(Extra_Feature_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','extra_features_counter',COUNT(__d1(__NL(Extra_Feature_Counter_))),COUNT(__d1(__NN(Extra_Feature_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','other_building_code',COUNT(__d1(__NL(Other_Building_Code_))),COUNT(__d1(__NN(Other_Building_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','other_building_counter',COUNT(__d1(__NL(Other_Building_Counter_))),COUNT(__d1(__NN(Other_Building_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','other_impr_building_ind',COUNT(__d1(__NL(Other_Important_Building_Indicator_))),COUNT(__d1(__NN(Other_Important_Building_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','other_impr_building_area',COUNT(__d1(__NL(Other_Important_Building_Area_))),COUNT(__d1(__NN(Other_Important_Building_Area_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','other_impr_building_counter',COUNT(__d1(__NL(Other_Important_Building_Counter_))),COUNT(__d1(__NN(Other_Important_Building_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_first_reported',COUNT(__d2(__NL(Date_Vendor_First_Reported_))),COUNT(__d2(__NN(Date_Vendor_First_Reported_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_last_reported',COUNT(__d2(__NL(Date_Vendor_Last_Reported_))),COUNT(__d2(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','TaxExemptionCode',COUNT(__d2(__NL(Tax_Exemption_Code_))),COUNT(__d2(__NN(Tax_Exemption_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','TaxExemptionCodeCounter',COUNT(__d2(__NL(Tax_Exemption_Code_Counter_))),COUNT(__d2(__NN(Tax_Exemption_Code_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SchoolTaxDistrict',COUNT(__d2(__NL(School_Tax_District_))),COUNT(__d2(__NN(School_Tax_District_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SchoolTaxDistrictIndicator',COUNT(__d2(__NL(School_Tax_District_Indicator_))),COUNT(__d2(__NN(School_Tax_District_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SchoolTaxDistrictCounter',COUNT(__d2(__NL(School_Tax_District_Counter_))),COUNT(__d2(__NN(School_Tax_District_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','BuildingAreaCounter',COUNT(__d2(__NL(Building_Area_Counter_))),COUNT(__d2(__NN(Building_Area_Counter_)))},
    ...
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SiteInfluenceCode',COUNT(__d2(__NL(Site_Influence_Code_))),COUNT(__d2(__NN(Site_Influence_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SiteInfluenceCounter',COUNT(__d2(__NL(Site_Influence_Counter_))),COUNT(__d2(__NN(Site_Influence_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AmenityCode',COUNT(__d2(__NL(Amenity_Code_))),COUNT(__d2(__NN(Amenity_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AmenityCounter',COUNT(__d2(__NL(Amenity_Counter_))),COUNT(__d2(__NN(Amenity_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ExtraFeatureArea',COUNT(__d2(__NL(Extra_Feature_Area_))),COUNT(__d2(__NN(Extra_Feature_Area_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ExtraFeatureIndicator',COUNT(__d2(__NL(Extra_Feature_Indicator_))),COUNT(__d2(__NN(Extra_Feature_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ExtraFeatureCounter',COUNT(__d2(__NL(Extra_Feature_Counter_))),COUNT(__d2(__NN(Extra_Feature_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OtherBuildingCode',COUNT(__d2(__NL(Other_Building_Code_))),COUNT(__d2(__NN(Other_Building_Code_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OtherBuildingCounter',COUNT(__d2(__NL(Other_Building_Counter_))),COUNT(__d2(__NN(Other_Building_Counter_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OtherImportantBuildingIndicator',COUNT(__d2(__NL(Other_Important_Building_Indicator_))),COUNT(__d2(__NN(Other_Important_Building_Indicator_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OtherImportantBuildingArea',COUNT(__d2(__NL(Other_Important_Building_Area_))),COUNT(__d2(__NN(Other_Important_Building_Area_)))},
    {'PropertyEvent','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OtherImportantBuildingCounter',COUNT(__d2(__NL(Other_Important_Building_Counter_))),COUNT(__d2(__NN(Other_Important_Building_Counter_)))},
