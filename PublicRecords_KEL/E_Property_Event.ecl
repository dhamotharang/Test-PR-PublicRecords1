...
EXPORT E_Property_Event(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT Is_Additional_Fares_Deed__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Is_Additional_Fares_Deed_);
  ...
  EXPORT Fares_Owner_Et_Al_Indicator__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Owner_Et_Al_Indicator_);
  EXPORT Fares_Owner_Relationship_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Owner_Relationship_Code_);
  EXPORT Fares_Owner_Relationship_Type__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Owner_Relationship_Type_);
  EXPORT Fares_Match_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Match_Code_);
  EXPORT Fares_Document_Year__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Document_Year_);
  EXPORT Fares_Corporate_Indicator__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Corporate_Indicator_);
  EXPORT Fares_Transaction_Type__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Transaction_Type_);
  EXPORT Fares_Lender_Address__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Lender_Address_);
  EXPORT Fares_Sales_Transaction_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Sales_Transaction_Code_);
  EXPORT Fares_Residential_Model_Ind__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Residential_Model_Ind_);
  EXPORT Fares_Mortgage_Deed_Type__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Mortgage_Deed_Type_);
  EXPORT Fares_Mortgage_Term_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Mortgage_Term_Code_);
  EXPORT Fares_Mortgage_Term__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Mortgage_Term_);
  EXPORT Fares_Mortgage_Assumption_Amount__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Mortgage_Assumption_Amount_);
  EXPORT Fares_Second_Mortgage_Loan_Type_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Second_Mortgage_Loan_Type_Code_);
  EXPORT Fares_Second_Deed_Type__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Second_Deed_Type_);
  EXPORT Fares_Absentee_Indicator__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Absentee_Indicator_);
  EXPORT Fares_Partial_Interest_Indicator__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Partial_Interest_Indicator_);
  EXPORT Fares_Primary_Category_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Primary_Category_Code_);
  EXPORT Fares_Private_Party_Lender__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Private_Party_Lender_);
  EXPORT Fares_Construction_Loan__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Construction_Loan_);
  EXPORT Fares_Resale_New_Construction__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Resale_New_Construction_);
  EXPORT Fares_Inter_Family__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Inter_Family_);
  EXPORT Fares_Cash_Mortgage_Purchase__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Cash_Mortgage_Purchase_);
  EXPORT Fares_Building_Square_Feet__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Building_Square_Feet_);
  EXPORT Fares_Foreclosure__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Foreclosure_);
  EXPORT Fares_Refincance_Flag__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Refincance_Flag_);
  EXPORT Fares_Equity_Flag__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Equity_Flag_);
  EXPORT Fares_Iris_A_P_N__SingleValue_Invalid := KEL.Intake.DetectMultipleValuesOnResult(Result,Fares_Iris_A_P_N_);
