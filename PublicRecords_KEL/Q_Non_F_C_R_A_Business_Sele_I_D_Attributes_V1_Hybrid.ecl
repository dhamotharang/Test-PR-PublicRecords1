...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputBII)) __PInputBIIDataset, KEL.typ.kdate __PP_InpClnArchDt, KEL.typ.kdate __PRunDateToMimic, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE12214009 := __ENH_Business_Sele;
  SHARED __EE12217435 := __EE12214009(__T(__AND(__OP2(__EE12214009.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12214009.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12214009.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST135928_Layout := RECORD
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Phone_Result,NAMED('DBG_E_Phone_Result_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid')),
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_10,NAMED('DBG_E_Input_P_I_I_Intermediate_10_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_7,NAMED('DBG_E_Criminal_Offense_Intermediate_7_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_6,NAMED('DBG_E_Criminal_Offense_Intermediate_6_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid')),
    ...
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Hybrid')),
