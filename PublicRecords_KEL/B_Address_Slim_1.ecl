...
EXPORT B_Address_Slim_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8123800 := __ENH_Address_Slim_2;
  SHARED __EE8123802 := __ENH_Input_P_I_I_2;
  SHARED __ST2098145_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(B_Address_Slim_3(__in,__cfg).__ST77355_Layout) Address_N_A_I_C_S_List_;
    KEL.typ.ndataset(B_Address_Slim_3(__in,__cfg).__ST77355_Layout) Address_N_A_I_C_S_Sorted_List_;
    KEL.typ.ndataset(B_Address_Slim_3(__in,__cfg).__ST77262_Layout) Address_S_I_C_List_;
    KEL.typ.ndataset(B_Address_Slim_3(__in,__cfg).__ST77262_Layout) Address_S_I_C_Sorted_List_;
  ...
  END;
  __JC8123811(B_Address_Slim_2(__in,__cfg).__ST206236_Layout __EE8123800, B_Input_P_I_I_2(__in,__cfg).__ST289580_Layout __EE8123802) := __EEQP(__EE8123800.P_I_I_,__EE8123802.UID);
  __ST2098145_Layout __JT8123811(B_Address_Slim_2(__in,__cfg).__ST206236_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST289580_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Z_I_P5__1_ := __r.Z_I_P5_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE8124095 := JOIN(__EE8123800,__EE8123802,__JC8123811(LEFT,RIGHT),__JT8123811(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST179131_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    KEL.typ.nstr Primary_Name_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179131_Layout __ND8123685__Project(__ST2098145_Layout __PP8122257) := TRANSFORM
    __EE8123675 := __PP8122257.Address_N_A_I_C_S_Sorted_List_;
    SELF.Address_N_A_I_C_S_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE8123675,LEFT.High_Risk_N_A_I_C_S_,__CN('|')),__CN('922140')));
    __EE8123697 := __PP8122257.Address_S_I_C_Sorted_List_;
    SELF.Address_S_I_C_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE8123697,LEFT.High_Risk_S_I_C_,__CN('|')),__CN('9223')));
    __BS8123717 := __T(__PP8122257.Address_N_A_I_C_S_Sorted_List_);
    SELF.N_A_I_C_S_List_Not_Foind_ := __OR(__NOT(__CN(EXISTS(__T(__PP8122257.Address_N_A_I_C_S_Sorted_List_)))),__CN(NOT EXISTS(__BS8123717(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP8122257.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_),=,__CN('')),__NT(__T(__PP8122257.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_))))))));
    SELF.P___Cln_Addr_Full_Flag_ := __PP8122257.P___Inp_Cln_Addr_Full_Flag_Value_;
    __BS8123746 := __T(__PP8122257.Address_S_I_C_Sorted_List_);
    SELF.S_I_C_List_Not_Found_ := __OR(__NOT(__CN(EXISTS(__T(__PP8122257.Address_S_I_C_Sorted_List_)))),__CN(NOT EXISTS(__BS8123746(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP8122257.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_),=,__CN('')),__NT(__T(__PP8122257.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_))))))));
    SELF := __PP8122257;
  END;
  EXPORT __ENH_Address_Slim_1 := PROJECT(__EE8124095,__ND8123685__Project(LEFT));
END;
