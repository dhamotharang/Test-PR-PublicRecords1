...
EXPORT B_Address_Slim_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7618399 := __ENH_Address_Slim_2;
  SHARED __EE7618401 := __ENH_Input_P_I_I_2;
  SHARED __ST1959554_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC7618410(B_Address_Slim_2(__in,__cfg).__ST202108_Layout __EE7618399, B_Input_P_I_I_2(__in,__cfg).__ST277213_Layout __EE7618401) := __EEQP(__EE7618399.P_I_I_,__EE7618401.UID);
  __ST1959554_Layout __JT7618410(B_Address_Slim_2(__in,__cfg).__ST202108_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST277213_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Z_I_P5__1_ := __r.Z_I_P5_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE7618694 := JOIN(__EE7618399,__EE7618401,__JC7618410(LEFT,RIGHT),__JT7618410(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST175415_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    KEL.typ.nstr Primary_Name_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175415_Layout __ND7618284__Project(__ST1959554_Layout __PP7616856) := TRANSFORM
    __EE7618274 := __PP7616856.Address_N_A_I_C_S_Sorted_List_;
    SELF.Address_N_A_I_C_S_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE7618274,LEFT.High_Risk_N_A_I_C_S_,__CN('|')),__CN('922140')));
    __EE7618296 := __PP7616856.Address_S_I_C_Sorted_List_;
    SELF.Address_S_I_C_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE7618296,LEFT.High_Risk_S_I_C_,__CN('|')),__CN('9223')));
    __BS7618316 := __T(__PP7616856.Address_N_A_I_C_S_Sorted_List_);
    SELF.N_A_I_C_S_List_Not_Foind_ := __OR(__NOT(__CN(EXISTS(__T(__PP7616856.Address_N_A_I_C_S_Sorted_List_)))),__CN(NOT EXISTS(__BS7618316(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP7616856.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_),=,__CN('')),__NT(__T(__PP7616856.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_))))))));
    SELF.P___Cln_Addr_Full_Flag_ := __PP7616856.P___Inp_Cln_Addr_Full_Flag_Value_;
    __BS7618345 := __T(__PP7616856.Address_S_I_C_Sorted_List_);
    SELF.S_I_C_List_Not_Found_ := __OR(__NOT(__CN(EXISTS(__T(__PP7616856.Address_S_I_C_Sorted_List_)))),__CN(NOT EXISTS(__BS7618345(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP7616856.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_),=,__CN('')),__NT(__T(__PP7616856.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_))))))));
    SELF := __PP7616856;
  END;
  EXPORT __ENH_Address_Slim_1 := PROJECT(__EE7618694,__ND7618284__Project(LEFT));
END;
