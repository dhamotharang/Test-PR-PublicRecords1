...
EXPORT B_Address_Slim_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7606829 := __ENH_Address_Slim_2;
  SHARED __EE7606831 := __ENH_Input_P_I_I_2;
  SHARED __ST1953209_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC7606840(B_Address_Slim_2(__in,__cfg).__ST201801_Layout __EE7606829, B_Input_P_I_I_2(__in,__cfg).__ST212680_Layout __EE7606831) := __EEQP(__EE7606829.P_I_I_,__EE7606831.UID);
  __ST1953209_Layout __JT7606840(B_Address_Slim_2(__in,__cfg).__ST201801_Layout __l, B_Input_P_I_I_2(__in,__cfg).__ST212680_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Z_I_P5__1_ := __r.Z_I_P5_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE7607121 := JOIN(__EE7606829,__EE7606831,__JC7606840(LEFT,RIGHT),__JT7606840(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST175128_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175128_Layout __ND7606714__Project(__ST1953209_Layout __PP7605298) := TRANSFORM
    __EE7606704 := __PP7605298.Address_N_A_I_C_S_Sorted_List_;
    SELF.Address_N_A_I_C_S_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE7606704,LEFT.High_Risk_N_A_I_C_S_,__CN('|')),__CN('922140')));
    __EE7606726 := __PP7605298.Address_S_I_C_Sorted_List_;
    SELF.Address_S_I_C_Not_Contains_ := __NOT(__FN2(KEL.Routines.Contains,KEL.Aggregates.ConcatNN(__EE7606726,LEFT.High_Risk_S_I_C_,__CN('|')),__CN('9223')));
    __BS7606746 := __T(__PP7605298.Address_N_A_I_C_S_Sorted_List_);
    SELF.N_A_I_C_S_List_Not_Foind_ := __OR(__NOT(__CN(EXISTS(__T(__PP7605298.Address_N_A_I_C_S_Sorted_List_)))),__CN(NOT EXISTS(__BS7606746(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP7605298.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_),=,__CN('')),__NT(__T(__PP7605298.Address_N_A_I_C_S_Sorted_List_).High_Risk_N_A_I_C_S_))))))));
    SELF.P___Cln_Addr_Full_Flag_ := __PP7605298.P___Inp_Cln_Addr_Full_Flag_Value_;
    __BS7606775 := __T(__PP7605298.Address_S_I_C_Sorted_List_);
    SELF.S_I_C_List_Not_Found_ := __OR(__NOT(__CN(EXISTS(__T(__PP7605298.Address_S_I_C_Sorted_List_)))),__CN(NOT EXISTS(__BS7606775(__T(__NOT(__OR(__OP2(__CAST(KEL.typ.str,__T(__PP7605298.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_),=,__CN('')),__NT(__T(__PP7605298.Address_S_I_C_Sorted_List_).High_Risk_S_I_C_))))))));
    SELF := __PP7605298;
  END;
  EXPORT __ENH_Address_Slim_1 := PROJECT(__EE7607121,__ND7606714__Project(LEFT));
END;
