...
EXPORT B_Sele_Vehicle_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE281305 := __E_Sele_Vehicle;
  EXPORT __ST106171_Layout := RECORD
  ...
  END;
  SHARED __ST106171_Layout __ND281621__Project(E_Sele_Vehicle(__in,__cfg).Layout __PP281093) := TRANSFORM
    ...
    SELF := __PP281093;
  END;
  EXPORT __ENH_Sele_Vehicle_4 := PROJECT(__EE281305,__ND281621__Project(LEFT));
END;
