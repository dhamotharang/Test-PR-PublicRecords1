...
EXPORT B_Sele_Vehicle_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE222616 := __E_Sele_Vehicle;
  EXPORT __ST93206_Layout := RECORD
  ...
  END;
  SHARED __ST93206_Layout __ND222992__Project(E_Sele_Vehicle(__in,__cfg).Layout __PP222374) := TRANSFORM
    ...
    SELF := __PP222374;
  END;
  EXPORT __ENH_Sele_Vehicle_4 := PROJECT(__EE222616,__ND222992__Project(LEFT));
END;
