...
EXPORT B_Sele_Vehicle_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE221213 := __E_Sele_Vehicle;
  EXPORT __ST91780_Layout := RECORD
  ...
  END;
  SHARED __ST91780_Layout __ND221589__Project(E_Sele_Vehicle(__in,__cfg).Layout __PP220971) := TRANSFORM
    ...
    SELF := __PP220971;
  END;
  EXPORT __ENH_Sele_Vehicle_4 := PROJECT(__EE221213,__ND221589__Project(LEFT));
END;
