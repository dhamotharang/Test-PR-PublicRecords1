...
EXPORT E_Criminal_Offender(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping1 := 'UID(DEFAULT:UID),offender_key(OVERRIDE:Offender_Key_:\'\'),sourcefile(DEFAULT:Source_File_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),citizenship(DEFAULT:Citizenship_:\'\'),haircolor(DEFAULT:Hair_Color_:\'\'),eyecolor(DEFAULT:Eye_Color_:\'\'),skincolor(DEFAULT:Skin_Color_:\'\'),height(DEFAULT:Height_:0),weight(DEFAULT:Weight_:0),status(DEFAULT:Status_:\'\'),currentincarceratedflag(DEFAULT:Current_Incarcerated_Flag_:\'\'),currentparoleflag(DEFAULT:Current_Parole_Flag_:\'\'),currentprobationflag(DEFAULT:Current_Probation_Flag_:\'\'),datatype(DEFAULT:Data_Type_:0),datasource(DEFAULT:Data_Source_:\'\'),num_of_counts(OVERRIDE:Number_Of_Offense_Counts_:0),source(DEFAULT:Source_:\'\'),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  Layout Criminal_Offender__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Sources_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Source_File_,Data_Type_,Data_Source_,Source_State_},Source_File_,Data_Type_,Data_Source_,Source_State_),Sources_Layout)(__NN(Source_File_) OR __NN(Data_Type_) OR __NN(Data_Source_) OR __NN(Source_State_)));
    ...
    SELF.Current_Status_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Status_,Current_Incarcerated_Flag_,Current_Parole_Flag_,Current_Probation_Flag_},Status_,Current_Incarcerated_Flag_,Current_Parole_Flag_,Current_Probation_Flag_),Current_Status_Layout)(__NN(Status_) OR __NN(Current_Incarcerated_Flag_) OR __NN(Current_Parole_Flag_) OR __NN(Current_Probation_Flag_)));
    SELF.Number_Of_Offense_Counts_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Number_Of_Offense_Counts_},Number_Of_Offense_Counts_),Number_Of_Offense_Counts_Layout)(__NN(Number_Of_Offense_Counts_)));
  ...
  Layout Criminal_Offender__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Sources_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Sources_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF:=LEFT))(__NN(Source_File_) OR __NN(Data_Type_) OR __NN(Data_Source_) OR __NN(Source_State_)));
    SELF.Current_Status_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Current_Status_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF:=LEFT))(__NN(Status_) OR __NN(Current_Incarcerated_Flag_) OR __NN(Current_Parole_Flag_) OR __NN(Current_Probation_Flag_)));
