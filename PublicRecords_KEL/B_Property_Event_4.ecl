...
IMPORT KEL13 AS KEL;
IMPORT B_Property_Event_5,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code,FN_Compile FROM PublicRecords_KEL;
...
EXPORT B_Property_Event_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3698436 := __ENH_Property_Event_5;
  ...
  END;
  SHARED __ST182503_Layout __ND3698441__Project(B_Property_Event_5(__in,__cfg).__ST188141_Layout __PP3698437) := TRANSFORM
    ...
    SELF.Age_Helper_ := __FN2(KEL.Routines.DaysBetween,__PP3698437.Property_Event_Date_First_Seen_,__CC10882);
    SELF := __PP3698437;
  END;
  EXPORT __ENH_Property_Event_4 := PROJECT(__EE3698436,__ND3698441__Project(LEFT));
END;
