...
EXPORT B_Sele_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE938356 := __E_Sele_Bankruptcy;
  EXPORT __ST74744_Layout := RECORD
  ...
  END;
  SHARED __ST74744_Layout __ND938378__Project(E_Sele_Bankruptcy(__in,__cfg).Layout __PP938317) := TRANSFORM
    ...
    SELF := __PP938317;
  END;
  EXPORT __ENH_Sele_Bankruptcy_1 := PROJECT(__EE938356,__ND938378__Project(LEFT));
END;
