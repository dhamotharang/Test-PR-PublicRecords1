...
EXPORT E_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __d4_Trim := PROJECT(__in.Dataset_Doxie_Files__Key_Offenders,TRANSFORM(__Trimmed,SELF.KeyVal:=TRIM((STRING)LEFT.offender_key)));
  ...
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Doxie_Files__Key_Offenders_Invalid := __d4_UID_Mapped(UID = 0);
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Doxie_Files__Key_Offenders_Invalid),COUNT(__d4)},
    ...
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','case_court',COUNT(__d4(__NL(Court_Description_))),COUNT(__d4(__NN(Court_Description_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','case_date',COUNT(__d4(__NL(Case_Date_))),COUNT(__d4(__NN(Case_Date_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','case_type_desc',COUNT(__d4(__NL(Case_Type_Description_))),COUNT(__d4(__NN(Case_Type_Description_)))},
    ...
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','county_of_origin',COUNT(__d4(__NL(County_Of_Source_))),COUNT(__d4(__NN(County_Of_Source_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dle_num',COUNT(__d4(__NL(Department_Of_Law_Enforcement_Number_))),COUNT(__d4(__NN(Department_Of_Law_Enforcement_Number_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','fbi_num',COUNT(__d4(__NL(Federal_Bureau_Of_Investigations_Number_))),COUNT(__d4(__NN(Federal_Bureau_Of_Investigations_Number_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','doc_num',COUNT(__d4(__NL(Inmate_Number_))),COUNT(__d4(__NN(Inmate_Number_)))},
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','id_num',COUNT(__d4(__NL(State_Identification_Number_Assigned_))),COUNT(__d4(__NN(State_Identification_Number_Assigned_)))},
    ...
    {'CriminalOffense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','src',COUNT(__d4(__NL(Source_))),COUNT(__d4(__NN(Source_)))},
