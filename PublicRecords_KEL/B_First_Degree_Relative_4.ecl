...
EXPORT B_First_Degree_Relative_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6829813 := __ENH_First_Degree_Relative_5;
  EXPORT __ST775394_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_4 := PROJECT(__EE6829813,__ST775394_Layout);
END;
