...
EXPORT B_First_Degree_Relative_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5553441 := __ENH_First_Degree_Relative_5;
  EXPORT __ST707799_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_4 := PROJECT(__EE5553441,__ST707799_Layout);
END;
