...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7203774 := __ENH_Property_3;
  EXPORT __ST210371_Layout := RECORD
  ...
  END;
  EXPORT __ST210353_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210371_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210353_Layout __ND7203779__Project(B_Property_3(__in,__cfg).__ST224765_Layout __PP7203775) := TRANSFORM
    __EE7203819 := __PP7203775.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7203819),__ST210371_Layout),__NL(__EE7203819));
    SELF := __PP7203775;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7203774,__ND7203779__Project(LEFT));
END;
