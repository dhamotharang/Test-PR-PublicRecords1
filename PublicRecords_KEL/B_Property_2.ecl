...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7203779 := __ENH_Property_3;
  EXPORT __ST210376_Layout := RECORD
  ...
  END;
  EXPORT __ST210358_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210376_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210358_Layout __ND7203784__Project(B_Property_3(__in,__cfg).__ST224770_Layout __PP7203780) := TRANSFORM
    __EE7203824 := __PP7203780.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7203824),__ST210376_Layout),__NL(__EE7203824));
    SELF := __PP7203780;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7203779,__ND7203784__Project(LEFT));
END;
