...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7742809 := __ENH_Property_3;
  EXPORT __ST217243_Layout := RECORD
  ...
  END;
  EXPORT __ST217225_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST217243_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217225_Layout __ND7742814__Project(B_Property_3(__in,__cfg).__ST231958_Layout __PP7742810) := TRANSFORM
    __EE7742854 := __PP7742810.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7742854),__ST217243_Layout),__NL(__EE7742854));
    SELF := __PP7742810;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7742809,__ND7742814__Project(LEFT));
END;
