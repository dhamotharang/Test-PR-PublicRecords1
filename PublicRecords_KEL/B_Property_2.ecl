...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7996475 := __ENH_Property_3;
  EXPORT __ST221305_Layout := RECORD
  ...
  END;
  EXPORT __ST221287_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST221305_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221287_Layout __ND7996480__Project(B_Property_3(__in,__cfg).__ST236373_Layout __PP7996476) := TRANSFORM
    __EE7996520 := __PP7996476.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7996520),__ST221305_Layout),__NL(__EE7996520));
    SELF := __PP7996476;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7996475,__ND7996480__Project(LEFT));
END;
