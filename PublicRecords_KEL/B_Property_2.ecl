...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8278394 := __ENH_Property_3;
  EXPORT __ST230957_Layout := RECORD
  ...
  END;
  EXPORT __ST230939_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST230957_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST230939_Layout __ND8278399__Project(B_Property_3(__in,__cfg).__ST246137_Layout __PP8278395) := TRANSFORM
    __EE8278439 := __PP8278395.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8278439),__ST230957_Layout),__NL(__EE8278439));
    SELF := __PP8278395;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8278394,__ND8278399__Project(LEFT));
END;
