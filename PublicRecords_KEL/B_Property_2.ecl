...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7202676 := __ENH_Property_3;
  EXPORT __ST210351_Layout := RECORD
  ...
  END;
  EXPORT __ST210333_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210351_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210333_Layout __ND7202681__Project(B_Property_3(__in,__cfg).__ST224745_Layout __PP7202677) := TRANSFORM
    __EE7202721 := __PP7202677.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7202721),__ST210351_Layout),__NL(__EE7202721));
    SELF := __PP7202677;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7202676,__ND7202681__Project(LEFT));
END;
