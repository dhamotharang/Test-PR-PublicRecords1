...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8064855 := __ENH_Property_3;
  EXPORT __ST228173_Layout := RECORD
  ...
  END;
  EXPORT __ST228155_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST228173_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST228155_Layout __ND8064860__Project(B_Property_3(__in,__cfg).__ST243215_Layout __PP8064856) := TRANSFORM
    __EE8064900 := __PP8064856.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8064900),__ST228173_Layout),__NL(__EE8064900));
    SELF := __PP8064856;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8064855,__ND8064860__Project(LEFT));
END;
