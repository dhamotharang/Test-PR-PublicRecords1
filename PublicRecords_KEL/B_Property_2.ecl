...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4698050 := __ENH_Property_3;
  EXPORT __ST161088_Layout := RECORD
  ...
  END;
  EXPORT __ST161070_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST161088_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161070_Layout __ND4698055__Project(B_Property_3(__in,__cfg).__ST172774_Layout __PP4698051) := TRANSFORM
    __EE4698094 := __PP4698051.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE4698094),__ST161088_Layout),__NL(__EE4698094));
    SELF := __PP4698051;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE4698050,__ND4698055__Project(LEFT));
END;
