...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7318528 := __ENH_Property_3;
  EXPORT __ST210883_Layout := RECORD
  ...
  END;
  EXPORT __ST210865_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST210883_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210865_Layout __ND7318533__Project(B_Property_3(__in,__cfg).__ST225296_Layout __PP7318529) := TRANSFORM
    __EE7318573 := __PP7318529.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7318573),__ST210883_Layout),__NL(__EE7318573));
    SELF := __PP7318529;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7318528,__ND7318533__Project(LEFT));
END;
