...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8246587 := __ENH_Property_3;
  EXPORT __ST230936_Layout := RECORD
  ...
  END;
  EXPORT __ST230918_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST230936_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST230918_Layout __ND8246592__Project(B_Property_3(__in,__cfg).__ST246116_Layout __PP8246588) := TRANSFORM
    __EE8246632 := __PP8246588.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8246632),__ST230936_Layout),__NL(__EE8246632));
    SELF := __PP8246588;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8246587,__ND8246592__Project(LEFT));
END;
