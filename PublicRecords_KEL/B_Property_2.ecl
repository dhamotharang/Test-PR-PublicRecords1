...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8080536 := __ENH_Property_3;
  EXPORT __ST222920_Layout := RECORD
  ...
  END;
  EXPORT __ST222902_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST222920_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST222902_Layout __ND8080541__Project(B_Property_3(__in,__cfg).__ST237962_Layout __PP8080537) := TRANSFORM
    __EE8080581 := __PP8080537.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8080581),__ST222920_Layout),__NL(__EE8080581));
    SELF := __PP8080537;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8080536,__ND8080541__Project(LEFT));
END;
