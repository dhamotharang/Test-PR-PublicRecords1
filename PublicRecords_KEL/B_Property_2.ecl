...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7534658 := __ENH_Property_3;
  ...
  END;
  EXPORT __ST216718_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST216736_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216718_Layout __ND7534663__Project(B_Property_3(__in,__cfg).__ST231374_Layout __PP7534659) := TRANSFORM
    __EE7534703 := __PP7534659.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7534703),__ST216736_Layout),__NL(__EE7534703));
    SELF := __PP7534659;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7534658,__ND7534663__Project(LEFT));
END;
