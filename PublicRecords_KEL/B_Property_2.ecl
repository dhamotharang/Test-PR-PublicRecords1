...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7575165 := __ENH_Property_3;
  EXPORT __ST218548_Layout := RECORD
  ...
  END;
  EXPORT __ST218530_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST218548_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218530_Layout __ND7575170__Project(B_Property_3(__in,__cfg).__ST233336_Layout __PP7575166) := TRANSFORM
    __EE7575210 := __PP7575166.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7575210),__ST218548_Layout),__NL(__EE7575210));
    SELF := __PP7575166;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7575165,__ND7575170__Project(LEFT));
END;
