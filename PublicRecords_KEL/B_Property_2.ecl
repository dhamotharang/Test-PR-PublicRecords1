...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8061248 := __ENH_Property_3;
  EXPORT __ST223963_Layout := RECORD
  ...
  END;
  EXPORT __ST223945_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST223963_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223945_Layout __ND8061253__Project(B_Property_3(__in,__cfg).__ST239137_Layout __PP8061249) := TRANSFORM
    __EE8061293 := __PP8061249.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8061293),__ST223963_Layout),__NL(__EE8061293));
    SELF := __PP8061249;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8061248,__ND8061253__Project(LEFT));
END;
