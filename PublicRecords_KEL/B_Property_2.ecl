...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4608533 := __ENH_Property_3;
  EXPORT __ST169388_Layout := RECORD
  ...
  END;
  EXPORT __ST169370_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169388_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169370_Layout __ND4608538__Project(B_Property_3(__in,__cfg).__ST181522_Layout __PP4608534) := TRANSFORM
    __EE4608577 := __PP4608534.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE4608577),__ST169388_Layout),__NL(__EE4608577));
    SELF := __PP4608534;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE4608533,__ND4608538__Project(LEFT));
END;
