...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7575135 := __ENH_Property_3;
  ...
  EXPORT __ST218500_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218518_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218500_Layout __ND7575140__Project(B_Property_3(__in,__cfg).__ST233306_Layout __PP7575136) := TRANSFORM
    __EE7575180 := __PP7575136.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7575180),__ST218518_Layout),__NL(__EE7575180));
    SELF := __PP7575136;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7575135,__ND7575140__Project(LEFT));
END;
