...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8174276 := __ENH_Property_3;
  EXPORT __ST229430_Layout := RECORD
  ...
  END;
  EXPORT __ST229412_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST229430_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST229412_Layout __ND8174281__Project(B_Property_3(__in,__cfg).__ST244529_Layout __PP8174277) := TRANSFORM
    __EE8174321 := __PP8174277.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8174321),__ST229430_Layout),__NL(__EE8174321));
    SELF := __PP8174277;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE8174276,__ND8174281__Project(LEFT));
END;
