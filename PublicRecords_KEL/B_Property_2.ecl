...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7563605 := __ENH_Property_3;
  EXPORT __ST218189_Layout := RECORD
  ...
  EXPORT __ST218171_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218189_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218171_Layout __ND7563610__Project(B_Property_3(__in,__cfg).__ST232951_Layout __PP7563606) := TRANSFORM
    __EE7563650 := __PP7563606.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7563650),__ST218189_Layout),__NL(__EE7563650));
    SELF := __PP7563606;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE7563605,__ND7563610__Project(LEFT));
END;
