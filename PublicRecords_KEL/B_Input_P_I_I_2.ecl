...
EXPORT B_Input_P_I_I_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE21660 := __E_Input_P_I_I;
  EXPORT __ST15562_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST15562_Layout __ND21658__Project(E_Input_P_I_I(__in,__cfg).Layout __PP21168) := TRANSFORM
    SELF.Addr_Not_Populated_ := IF(FN_Compile.FN_Addr_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP21168.Input_Street_Echo_),__ECAST(KEL.typ.nstr,__PP21168.Input_City_Echo_),__ECAST(KEL.typ.nstr,__PP21168.Input_State_Echo_),__ECAST(KEL.typ.nstr,__PP21168.Input_Zip_Echo_)),TRUE,FALSE);
    SELF.Name_Not_Populated_ := IF(FN_Compile.FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP21168.Input_First_Name_Echo_),__ECAST(KEL.typ.nstr,__PP21168.Input_Middle_Name_Echo_),__ECAST(KEL.typ.nstr,__PP21168.Input_Last_Name_Echo_)),TRUE,FALSE);
    SELF := __PP21168;
  END;
  EXPORT __ENH_Input_P_I_I_2 := PROJECT(__EE21660,__ND21658__Project(LEFT));
END;
