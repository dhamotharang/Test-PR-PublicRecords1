...
EXPORT B_Input_P_I_I_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE24662 := __E_Input_P_I_I;
  EXPORT __ST16411_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST16411_Layout __ND24660__Project(E_Input_P_I_I(__in,__cfg).Layout __PP24170) := TRANSFORM
    SELF.Addr_Not_Populated_ := IF(FN_Compile.FN_Addr_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP24170.Input_Street_Echo_),__ECAST(KEL.typ.nstr,__PP24170.Input_City_Echo_),__ECAST(KEL.typ.nstr,__PP24170.Input_State_Echo_),__ECAST(KEL.typ.nstr,__PP24170.Input_Zip_Echo_)),TRUE,FALSE);
    SELF.Name_Not_Populated_ := IF(FN_Compile.FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP24170.Input_First_Name_Echo_),__ECAST(KEL.typ.nstr,__PP24170.Input_Middle_Name_Echo_),__ECAST(KEL.typ.nstr,__PP24170.Input_Last_Name_Echo_)),TRUE,FALSE);
    SELF := __PP24170;
  END;
  EXPORT __ENH_Input_P_I_I_2 := PROJECT(__EE24662,__ND24660__Project(LEFT));
END;
