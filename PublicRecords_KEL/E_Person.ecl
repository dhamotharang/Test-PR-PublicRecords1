...
EXPORT E_Person(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping3 := 'did(OVERRIDE:UID),title(DEFAULT:Title_),fname(OVERRIDE:First_Name_),mname(OVERRIDE:Middle_Name_),lname(OVERRIDE:Last_Name_),name_suffix(OVERRIDE:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),dob(OVERRIDE:Date_Of_Birth_:DATE),dateofdeath(DEFAULT:Date_Of_Death_:DATE),gender(DEFAULT:Gender_:\'\'),race(OVERRIDE:Race_:\'\'),race_desc(OVERRIDE:Race_Description_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),fdnindicator(DEFAULT:F_D_N_Indicator_),src(OVERRIDE:Source_:\'\'),purchprocessdate(DEFAULT:Purch_Process_Date_:DATE),purchhistoryflag(DEFAULT:Purch_History_Flag_:\'\'),purchnewamt(DEFAULT:Purch_New_Amt_:0),purchtotal(DEFAULT:Purch_Total_:0),purchcount(DEFAULT:Purch_Count_:0),purchnewagemonths(DEFAULT:Purch_New_Age_Months_:0),purcholdagemonths(DEFAULT:Purch_Old_Age_Months_:0),purchitemcount(DEFAULT:Purch_Item_Count_:0),purchamtavg(DEFAULT:Purch_Amt_Avg_:0),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),fcra_date(OVERRIDE:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping5 := 's_did(OVERRIDE:UID),title(DEFAULT:Title_),firstname(DEFAULT:First_Name_),middlename(DEFAULT:Middle_Name_),lastname(DEFAULT:Last_Name_),namesuffix(DEFAULT:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),dateofbirth(DEFAULT:Date_Of_Birth_:DATE),dateofdeath(DEFAULT:Date_Of_Death_:DATE),gender(DEFAULT:Gender_:\'\'),race(DEFAULT:Race_:\'\'),racedescription(DEFAULT:Race_Description_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),fdnindicator(DEFAULT:F_D_N_Indicator_),src(OVERRIDE:Source_:\'\'),purchprocessdate(DEFAULT:Purch_Process_Date_:DATE),purchhistoryflag(DEFAULT:Purch_History_Flag_:\'\'),purchnewamt(DEFAULT:Purch_New_Amt_:0),purchtotal(DEFAULT:Purch_Total_:0),purchcount(DEFAULT:Purch_Count_:0),purchnewagemonths(DEFAULT:Purch_New_Age_Months_:0),purcholdagemonths(DEFAULT:Purch_Old_Age_Months_:0),purchitemcount(DEFAULT:Purch_Item_Count_:0),purchamtavg(DEFAULT:Purch_Amt_Avg_:0),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),date_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_5Rule),date_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_5Rule),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping12 := 'appended_lexid(OVERRIDE:UID),title(DEFAULT:Title_),first_name(OVERRIDE:First_Name_),middle_name(OVERRIDE:Middle_Name_),last_name(OVERRIDE:Last_Name_),namesuffix(DEFAULT:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),dob(OVERRIDE:Date_Of_Birth_:DATE),dateofdeath(DEFAULT:Date_Of_Death_:DATE),gender(DEFAULT:Gender_:\'\'),race(DEFAULT:Race_:\'\'),racedescription(DEFAULT:Race_Description_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),src(OVERRIDE:Source_:\'\'),purchprocessdate(DEFAULT:Purch_Process_Date_:DATE),purchhistoryflag(DEFAULT:Purch_History_Flag_:\'\'),purchnewamt(DEFAULT:Purch_New_Amt_:0),purchtotal(DEFAULT:Purch_Total_:0),purchcount(DEFAULT:Purch_Count_:0),purchnewagemonths(DEFAULT:Purch_New_Age_Months_:0),purcholdagemonths(DEFAULT:Purch_Old_Age_Months_:0),purchitemcount(DEFAULT:Purch_Item_Count_:0),purchamtavg(DEFAULT:Purch_Amt_Avg_:0),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  SHARED InLayout __Mapping12_Transform(InLayout __r) := TRANSFORM
    SELF.F_D_N_Indicator_ := __CN(TRUE);
    SELF := __r;
  END;
  SHARED __d12_Norm := NORMALIZE(__in,LEFT.Dataset_fraudpoint3__Key_DID,TRANSFORM(RECORDOF(__in.Dataset_fraudpoint3__Key_DID),SELF:=RIGHT));
  EXPORT __d12_KELfiltered := __d12_Norm((unsigned)appended_lexid !=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_fraudpoint3__Key_DID_Invalid := __d12_KELfiltered((KEL.typ.uid)appended_lexid = 0);
  SHARED __d12_Prefiltered := __d12_KELfiltered((KEL.typ.uid)appended_lexid <> 0);
  ...
  SHARED Date_First_Seen_13Rule(STRING a) := MAP(KEL.Routines.IsValidDate((KEL.typ.kdate)(a[1..8]))=>a[1..8],KEL.Routines.IsValidDate((KEL.typ.kdate)(a[1..6]+'01'))=>a[1..6]+'01',KEL.Routines.IsValidDate((KEL.typ.kdate)(a[1..4]+'0101'))=>a[1..4]+'0101','0');
  SHARED __Mapping13 := 'did(OVERRIDE:UID),title(DEFAULT:Title_),firstname(DEFAULT:First_Name_),middlename(DEFAULT:Middle_Name_),lastname(DEFAULT:Last_Name_),namesuffix(DEFAULT:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),dateofbirth(DEFAULT:Date_Of_Birth_:DATE),dateofdeath(DEFAULT:Date_Of_Death_:DATE),gender(DEFAULT:Gender_:\'\'),race(DEFAULT:Race_:\'\'),racedescription(DEFAULT:Race_Description_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),fdnindicator(DEFAULT:F_D_N_Indicator_),src(OVERRIDE:Source_:\'\'),purchprocessdate(DEFAULT:Purch_Process_Date_:DATE),purchhistoryflag(DEFAULT:Purch_History_Flag_:\'\'),purchnewamt(DEFAULT:Purch_New_Amt_:0),purchtotal(DEFAULT:Purch_Total_:0),purchcount(DEFAULT:Purch_Count_:0),purchnewagemonths(DEFAULT:Purch_New_Age_Months_:0),purcholdagemonths(DEFAULT:Purch_Old_Age_Months_:0),purchitemcount(DEFAULT:Purch_Item_Count_:0),purchamtavg(DEFAULT:Purch_Amt_Avg_:0),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(OVERRIDE:Home_State_:\'\'),source_state(OVERRIDE:Source_State_:\'\'),isresident(OVERRIDE:Is_Resident_),ishunting(OVERRIDE:Is_Hunting_),isfishing(OVERRIDE:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),datelicense(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_13Rule),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  SHARED InLayout __Mapping13_Transform(InLayout __r) := TRANSFORM
    SELF.Is_Hunt_Fish_ := __CN(TRUE);
    SELF := __r;
  END;
  SHARED __d13_Norm := NORMALIZE(__in,LEFT.Dataset_eMerges__Key_HuntFish_Rid,TRANSFORM(RECORDOF(__in.Dataset_eMerges__Key_HuntFish_Rid),SELF:=RIGHT));
  EXPORT __d13_KELfiltered := __d13_Norm((unsigned)did!=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__Key_HuntFish_Rid_Invalid := __d13_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED InLayout __Mapping14_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __d14_Norm := NORMALIZE(__in,LEFT.Dataset_eMerges__key_ccw_rid,TRANSFORM(RECORDOF(__in.Dataset_eMerges__key_ccw_rid),SELF:=RIGHT));
  EXPORT __d14_KELfiltered := __d14_Norm((unsigned)did!=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__key_ccw_rid_Invalid := __d14_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED __Mapping15 := 'did(OVERRIDE:UID),title(DEFAULT:Title_),firstname(DEFAULT:First_Name_),middlename(DEFAULT:Middle_Name_),lastname(DEFAULT:Last_Name_),namesuffix(DEFAULT:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),dateofbirth(DEFAULT:Date_Of_Birth_:DATE),dateofdeath(DEFAULT:Date_Of_Death_:DATE),gender(DEFAULT:Gender_:\'\'),race(DEFAULT:Race_:\'\'),racedescription(DEFAULT:Race_Description_:\'\'),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),fdnindicator(DEFAULT:F_D_N_Indicator_),src(OVERRIDE:Source_:\'\'),purchprocessdate(DEFAULT:Purch_Process_Date_:DATE),purchhistoryflag(DEFAULT:Purch_History_Flag_:\'\'),purchnewamt(DEFAULT:Purch_New_Amt_:0),purchtotal(DEFAULT:Purch_Total_:0),purchcount(DEFAULT:Purch_Count_:0),purchnewagemonths(DEFAULT:Purch_New_Age_Months_:0),purcholdagemonths(DEFAULT:Purch_Old_Age_Months_:0),purchitemcount(DEFAULT:Purch_Item_Count_:0),purchamtavg(DEFAULT:Purch_Amt_Avg_:0),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),employer(OVERRIDE:Employer_:\'\'),pay_frequency(OVERRIDE:Pay_Frequency_:\'\'),income(OVERRIDE:Income_:0),archive_date(DEFAULT:Archive___Date_:EPOCH),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH),dt_vendor_first_reported(OVERRIDE:Date_Vendor_First_Reported_:EPOCH),dt_vendor_last_reported(OVERRIDE:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  SHARED __d15_Norm := NORMALIZE(__in,LEFT.Dataset_Thrive__Key___Did_QA,TRANSFORM(RECORDOF(__in.Dataset_Thrive__Key___Did_QA),SELF:=RIGHT));
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Thrive__Key___Did_QA_Invalid := __d15_Norm((KEL.typ.uid)did = 0);
  SHARED __d15_Prefiltered := __d15_Norm((KEL.typ.uid)did <> 0);
  ...
  Layout Person__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Consumer_Statement_Flags_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Statement_I_D_,Statement_Type_,Data_Group_,Content_,Corrected_Flag_,Consumer_Statement_Flag_,Dispute_Flag_,Security_Freeze_,Security_Alert_,Negative_Alert_,I_D_Theft_Flag_,Legal_Hold_Alert_},Statement_I_D_,Statement_Type_,Data_Group_,Content_,Corrected_Flag_,Consumer_Statement_Flag_,Dispute_Flag_,Security_Freeze_,Security_Alert_,Negative_Alert_,I_D_Theft_Flag_,Legal_Hold_Alert_),Consumer_Statement_Flags_Layout)(__NN(Statement_I_D_) OR __NN(Statement_Type_) OR __NN(Data_Group_) OR __NN(Content_) OR __NN(Corrected_Flag_) OR __NN(Consumer_Statement_Flag_) OR __NN(Dispute_Flag_) OR __NN(Security_Freeze_) OR __NN(Security_Alert_) OR __NN(Negative_Alert_) OR __NN(I_D_Theft_Flag_) OR __NN(Legal_Hold_Alert_)));
    SELF.Thrive_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Employer_,Pay_Frequency_,Income_,Source_},Employer_,Pay_Frequency_,Income_,Source_),Thrive_Layout)(__NN(Employer_) OR __NN(Pay_Frequency_) OR __NN(Income_) OR __NN(Source_)));
  ...
  Layout Person__Single_Rollup(InLayout __r) := TRANSFORM
    ...
    SELF.Consumer_Statement_Flags_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Consumer_Statement_Flags_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Statement_I_D_) OR __NN(Statement_Type_) OR __NN(Data_Group_) OR __NN(Content_) OR __NN(Corrected_Flag_) OR __NN(Consumer_Statement_Flag_) OR __NN(Dispute_Flag_) OR __NN(Security_Freeze_) OR __NN(Security_Alert_) OR __NN(Negative_Alert_) OR __NN(I_D_Theft_Flag_) OR __NN(Legal_Hold_Alert_)));
    SELF.Thrive_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Thrive_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Employer_) OR __NN(Pay_Frequency_) OR __NN(Income_) OR __NN(Source_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Negative_Alert',COUNT(__d2(__NL(Negative_Alert_))),COUNT(__d2(__NN(Negative_Alert_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_fraudpoint3__Key_DID_Invalid),COUNT(__d12)},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Title',COUNT(__d12(__NL(Title_))),COUNT(__d12(__NN(Title_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','first_name',COUNT(__d12(__NL(First_Name_))),COUNT(__d12(__NN(First_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','middle_name',COUNT(__d12(__NL(Middle_Name_))),COUNT(__d12(__NN(Middle_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','last_name',COUNT(__d12(__NL(Last_Name_))),COUNT(__d12(__NN(Last_Name_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__Key_HuntFish_Rid_Invalid),COUNT(__d13)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','source_state',COUNT(__d13(__NL(Source_State_))),COUNT(__d13(__NN(Source_State_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__key_ccw_rid_Invalid),COUNT(__d14)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsHuntFish',COUNT(__d14(__NL(Is_Hunt_Fish_))),COUNT(__d14(__NN(Is_Hunt_Fish_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwpermnum',COUNT(__d14(__NL(Permit_Number_))),COUNT(__d14(__NN(Permit_Number_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwpermtype',COUNT(__d14(__NL(Weapon_Permits_Type_))),COUNT(__d14(__NN(Weapon_Permits_Type_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwregdate',COUNT(__d14(__NL(Weapon_Registration_Date_))),COUNT(__d14(__NN(Weapon_Registration_Date_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwexpdate',COUNT(__d14(__NL(Weapon_Expiration_Date_))),COUNT(__d14(__NN(Weapon_Expiration_Date_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SourceState',COUNT(__d14(__NL(Source_State_))),COUNT(__d14(__NN(Source_State_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d14(Date_Vendor_First_Reported_=0)),COUNT(__d14(Date_Vendor_First_Reported_!=0))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d14(Date_Vendor_Last_Reported_=0)),COUNT(__d14(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d14(Vault_Date_First_Seen_=0)),COUNT(__d14(Vault_Date_First_Seen_!=0))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Thrive__Key___Did_QA_Invalid),COUNT(__d15)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IsCCW',COUNT(__d15(__NL(Is_C_C_W_))),COUNT(__d15(__NN(Is_C_C_W_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','PermitNumber',COUNT(__d15(__NL(Permit_Number_))),COUNT(__d15(__NN(Permit_Number_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','WeaponPermitsType',COUNT(__d15(__NL(Weapon_Permits_Type_))),COUNT(__d15(__NN(Weapon_Permits_Type_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','WeaponRegistrationDate',COUNT(__d15(__NL(Weapon_Registration_Date_))),COUNT(__d15(__NN(Weapon_Registration_Date_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','WeaponExpirationDate',COUNT(__d15(__NL(Weapon_Expiration_Date_))),COUNT(__d15(__NN(Weapon_Expiration_Date_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','pay_frequency',COUNT(__d15(__NL(Pay_Frequency_))),COUNT(__d15(__NN(Pay_Frequency_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d15(Date_Vendor_First_Reported_=0)),COUNT(__d15(Date_Vendor_First_Reported_!=0))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d15(Date_Vendor_Last_Reported_=0)),COUNT(__d15(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d15(Vault_Date_First_Seen_=0)),COUNT(__d15(Vault_Date_First_Seen_!=0))},
