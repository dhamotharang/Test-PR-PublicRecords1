...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5255272 := __ENH_U_C_C_10;
  EXPORT __ST263183_Layout := RECORD
  ...
  END;
  EXPORT __ST263179_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST263183_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263179_Layout __ND5255235__Project(B_U_C_C_10(__in,__cfg).__ST264522_Layout __PP5254944) := TRANSFORM
    __EE5255275 := __PP5254944.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5255275),__ST263183_Layout),__NL(__EE5255275));
    __EE5255230 := __PP5254944.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5255230))[1].R_M_S_I_D_;
    SELF := __PP5254944;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5255272,__ND5255235__Project(LEFT));
END;
