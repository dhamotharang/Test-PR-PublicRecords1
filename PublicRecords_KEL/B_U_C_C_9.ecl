...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5468903 := __ENH_U_C_C_10;
  EXPORT __ST271118_Layout := RECORD
  ...
  END;
  EXPORT __ST271114_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST271118_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST271114_Layout __ND5468866__Project(B_U_C_C_10(__in,__cfg).__ST272469_Layout __PP5468575) := TRANSFORM
    __EE5468906 := __PP5468575.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5468906),__ST271118_Layout),__NL(__EE5468906));
    __EE5468861 := __PP5468575.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5468861))[1].R_M_S_I_D_;
    SELF := __PP5468575;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5468903,__ND5468866__Project(LEFT));
END;
