...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5228321 := __ENH_U_C_C_10;
  EXPORT __ST261772_Layout := RECORD
  ...
  END;
  EXPORT __ST261768_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST261772_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST261768_Layout __ND5228284__Project(B_U_C_C_10(__in,__cfg).__ST263111_Layout __PP5227993) := TRANSFORM
    __EE5228324 := __PP5227993.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5228324),__ST261772_Layout),__NL(__EE5228324));
    __EE5228279 := __PP5227993.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5228279))[1].R_M_S_I_D_;
    SELF := __PP5227993;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5228321,__ND5228284__Project(LEFT));
END;
