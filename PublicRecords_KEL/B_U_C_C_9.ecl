...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4642146 := __ENH_U_C_C_10;
  EXPORT __ST258691_Layout := RECORD
  ...
  END;
  EXPORT __ST258687_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258691_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258687_Layout __ND4642109__Project(B_U_C_C_10(__in,__cfg).__ST260040_Layout __PP4641818) := TRANSFORM
    __EE4642149 := __PP4641818.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4642149),__ST258691_Layout),__NL(__EE4642149));
    __EE4642104 := __PP4641818.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE4642104))[1].R_M_S_I_D_;
    SELF := __PP4641818;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE4642146,__ND4642109__Project(LEFT));
END;
