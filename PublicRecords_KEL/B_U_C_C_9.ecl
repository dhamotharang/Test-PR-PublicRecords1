...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4793188 := __ENH_U_C_C_10;
  ...
  END;
  EXPORT __ST254262_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST254266_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254262_Layout __ND4793151__Project(B_U_C_C_10(__in,__cfg).__ST255604_Layout __PP4792860) := TRANSFORM
    __EE4793191 := __PP4792860.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4793191),__ST254266_Layout),__NL(__EE4793191));
    __EE4793146 := __PP4792860.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE4793146))[1].R_M_S_I_D_;
    SELF := __PP4792860;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE4793188,__ND4793151__Project(LEFT));
END;
