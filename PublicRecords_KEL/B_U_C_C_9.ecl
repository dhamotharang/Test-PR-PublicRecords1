...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5060198 := __ENH_U_C_C_10;
  EXPORT __ST264280_Layout := RECORD
  ...
  END;
  EXPORT __ST264276_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST264280_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264276_Layout __ND5060161__Project(B_U_C_C_10(__in,__cfg).__ST265809_Layout __PP5059870) := TRANSFORM
    __EE5060201 := __PP5059870.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5060201),__ST264280_Layout),__NL(__EE5060201));
    __EE5060156 := __PP5059870.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5060156))[1].R_M_S_I_D_;
    SELF := __PP5059870;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5060198,__ND5060161__Project(LEFT));
END;
