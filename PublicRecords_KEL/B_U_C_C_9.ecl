...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6490819 := __ENH_U_C_C_10;
  EXPORT __ST293613_Layout := RECORD
  ...
  END;
  EXPORT __ST293609_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST293613_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST293609_Layout __ND6490782__Project(B_U_C_C_10(__in,__cfg).__ST294644_Layout __PP6490491) := TRANSFORM
    __EE6490822 := __PP6490491.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6490822),__ST293613_Layout),__NL(__EE6490822));
    __EE6490777 := __PP6490491.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE6490777))[1].R_M_S_I_D_;
    SELF := __PP6490491;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE6490819,__ND6490782__Project(LEFT));
END;
