...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5572658 := __ENH_U_C_C_10;
  EXPORT __ST278190_Layout := RECORD
  ...
  END;
  EXPORT __ST278186_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST278190_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST278186_Layout __ND5572621__Project(B_U_C_C_10(__in,__cfg).__ST279725_Layout __PP5572330) := TRANSFORM
    __EE5572661 := __PP5572330.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5572661),__ST278190_Layout),__NL(__EE5572661));
    __EE5572616 := __PP5572330.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5572616))[1].R_M_S_I_D_;
    SELF := __PP5572330;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5572658,__ND5572621__Project(LEFT));
END;
