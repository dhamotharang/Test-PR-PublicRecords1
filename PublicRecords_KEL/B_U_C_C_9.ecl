...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5489270 := __ENH_U_C_C_10;
  EXPORT __ST271420_Layout := RECORD
  ...
  END;
  EXPORT __ST271416_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST271420_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST271416_Layout __ND5489233__Project(B_U_C_C_10(__in,__cfg).__ST272771_Layout __PP5488942) := TRANSFORM
    __EE5489273 := __PP5488942.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5489273),__ST271420_Layout),__NL(__EE5489273));
    __EE5489228 := __PP5488942.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5489228))[1].R_M_S_I_D_;
    SELF := __PP5488942;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5489270,__ND5489233__Project(LEFT));
END;
