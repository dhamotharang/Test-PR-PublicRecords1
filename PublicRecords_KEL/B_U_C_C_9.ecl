...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5483033 := __ENH_U_C_C_10;
  EXPORT __ST276548_Layout := RECORD
  ...
  END;
  EXPORT __ST276544_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST276548_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST276544_Layout __ND5482996__Project(B_U_C_C_10(__in,__cfg).__ST278081_Layout __PP5482705) := TRANSFORM
    __EE5483036 := __PP5482705.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5483036),__ST276548_Layout),__NL(__EE5483036));
    __EE5482991 := __PP5482705.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5482991))[1].R_M_S_I_D_;
    SELF := __PP5482705;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5483033,__ND5482996__Project(LEFT));
END;
