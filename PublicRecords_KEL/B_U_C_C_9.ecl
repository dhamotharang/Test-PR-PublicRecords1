...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4916141 := __ENH_U_C_C_10;
  EXPORT __ST255314_Layout := RECORD
  ...
  EXPORT __ST255310_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST255314_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255310_Layout __ND4916104__Project(B_U_C_C_10(__in,__cfg).__ST256652_Layout __PP4915813) := TRANSFORM
    __EE4916144 := __PP4915813.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4916144),__ST255314_Layout),__NL(__EE4916144));
    __EE4916099 := __PP4915813.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE4916099))[1].R_M_S_I_D_;
    SELF := __PP4915813;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE4916141,__ND4916104__Project(LEFT));
END;
