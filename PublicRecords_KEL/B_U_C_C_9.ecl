...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4799152 := __ENH_U_C_C_10;
  EXPORT __ST254108_Layout := RECORD
  ...
  END;
  EXPORT __ST254104_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST254108_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254104_Layout __ND4799115__Project(B_U_C_C_10(__in,__cfg).__ST255446_Layout __PP4798824) := TRANSFORM
    __EE4799155 := __PP4798824.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4799155),__ST254108_Layout),__NL(__EE4799155));
    __EE4799110 := __PP4798824.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE4799110))[1].R_M_S_I_D_;
    SELF := __PP4798824;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE4799152,__ND4799115__Project(LEFT));
END;
