...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE257596 := __ENH_U_C_C_10;
  EXPORT __ST170136_Layout := RECORD
  ...
  EXPORT __ST170132_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST170136_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170132_Layout __ND257559__Project(B_U_C_C_10(__in,__cfg).__ST170952_Layout __PP256893) := TRANSFORM
    __EE257599 := __PP256893.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE257599),__ST170136_Layout),__NL(__EE257599));
    __EE257554 := __PP256893.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE257554))[1].R_M_S_I_D_;
    SELF := __PP256893;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE257596,__ND257559__Project(LEFT));
END;
