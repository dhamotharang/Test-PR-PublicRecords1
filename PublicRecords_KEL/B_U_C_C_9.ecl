...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6135788 := __ENH_U_C_C_10;
  EXPORT __ST287726_Layout := RECORD
  ...
  EXPORT __ST287722_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST287726_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST287722_Layout __ND6135751__Project(B_U_C_C_10(__in,__cfg).__ST289115_Layout __PP6135460) := TRANSFORM
    __EE6135791 := __PP6135460.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6135791),__ST287726_Layout),__NL(__EE6135791));
    __EE6135746 := __PP6135460.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE6135746))[1].R_M_S_I_D_;
    SELF := __PP6135460;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE6135788,__ND6135751__Project(LEFT));
END;
