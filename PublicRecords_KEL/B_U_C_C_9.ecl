...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5438623 := __ENH_U_C_C_10;
  EXPORT __ST269893_Layout := RECORD
  ...
  END;
  EXPORT __ST269889_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST269893_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST269889_Layout __ND5438586__Project(B_U_C_C_10(__in,__cfg).__ST271426_Layout __PP5438295) := TRANSFORM
    __EE5438626 := __PP5438295.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5438626),__ST269893_Layout),__NL(__EE5438626));
    __EE5438581 := __PP5438295.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5438581))[1].R_M_S_I_D_;
    SELF := __PP5438295;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5438623,__ND5438586__Project(LEFT));
END;
