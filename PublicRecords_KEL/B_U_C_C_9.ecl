...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5540851 := __ENH_U_C_C_10;
  EXPORT __ST278169_Layout := RECORD
  ...
  END;
  EXPORT __ST278165_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST278169_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST278165_Layout __ND5540814__Project(B_U_C_C_10(__in,__cfg).__ST279704_Layout __PP5540523) := TRANSFORM
    __EE5540854 := __PP5540523.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5540854),__ST278169_Layout),__NL(__EE5540854));
    __EE5540809 := __PP5540523.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5540809))[1].R_M_S_I_D_;
    SELF := __PP5540523;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5540851,__ND5540814__Project(LEFT));
END;
