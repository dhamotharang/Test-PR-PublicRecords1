...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5035822 := __ENH_U_C_C_10;
  EXPORT __ST262594_Layout := RECORD
  ...
  END;
  EXPORT __ST262590_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST262594_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST262590_Layout __ND5035785__Project(B_U_C_C_10(__in,__cfg).__ST264119_Layout __PP5035494) := TRANSFORM
    __EE5035825 := __PP5035494.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5035825),__ST262594_Layout),__NL(__EE5035825));
    __EE5035780 := __PP5035494.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5035780))[1].R_M_S_I_D_;
    SELF := __PP5035494;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5035822,__ND5035785__Project(LEFT));
END;
