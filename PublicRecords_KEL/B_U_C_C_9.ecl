...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5543559 := __ENH_U_C_C_10;
  EXPORT __ST278588_Layout := RECORD
  ...
  END;
  EXPORT __ST278584_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST278588_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST278584_Layout __ND5543522__Project(B_U_C_C_10(__in,__cfg).__ST280123_Layout __PP5543231) := TRANSFORM
    __EE5543562 := __PP5543231.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5543562),__ST278588_Layout),__NL(__EE5543562));
    __EE5543517 := __PP5543231.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5543517))[1].R_M_S_I_D_;
    SELF := __PP5543231;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5543559,__ND5543522__Project(LEFT));
END;
