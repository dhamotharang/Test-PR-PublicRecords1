...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5615966 := __ENH_U_C_C_10;
  EXPORT __ST274306_Layout := RECORD
  ...
  END;
  EXPORT __ST274302_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST274306_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST274302_Layout __ND5615929__Project(B_U_C_C_10(__in,__cfg).__ST275657_Layout __PP5615638) := TRANSFORM
    __EE5615969 := __PP5615638.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5615969),__ST274306_Layout),__NL(__EE5615969));
    __EE5615924 := __PP5615638.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE5615924))[1].R_M_S_I_D_;
    SELF := __PP5615638;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE5615966,__ND5615929__Project(LEFT));
END;
