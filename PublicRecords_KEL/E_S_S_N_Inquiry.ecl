...
IMPORT CFG_Compile,E_Inquiry,E_Social_Security_Number FROM PublicRecords_KEL;
IMPORT * FROM KEL15.Null;
EXPORT E_S_S_N_Inquiry(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __d1 := __SourceFilter(KEL.FromFlat.Convert(__d1_Prefiltered,InLayout,__Mapping1,'PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault'));
  ...
  EXPORT Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __PostFilter := __GroupedFilter(GROUP(InData,S_S_N_,Transaction_,Transaction_I_D_,Sequence_Number_,ALL));
  S_S_N_Inquiry_Group := __PostFilter;
  Layout S_S_N_Inquiry__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF := __r;
  END;
  Layout S_S_N_Inquiry__Single_Rollup(InLayout __r) := TRANSFORM
  ...
  EXPORT S_S_N__Orphan := JOIN(InData(__NN(S_S_N_)),E_Social_Security_Number(__cfg).__Result,__EEQP(LEFT.S_S_N_, RIGHT.UID),TRANSFORM(InLayout,SELF := LEFT,SELF:=[]),LEFT ONLY, HASH);
  ...
  EXPORT SanityCheck := DATASET([{COUNT(S_S_N__Orphan),COUNT(Transaction__Orphan)}],{KEL.typ.int S_S_N__Orphan,KEL.typ.int Transaction__Orphan});
  EXPORT NullCounts := DATASET([
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','SSN',COUNT(__d0(__NL(S_S_N_))),COUNT(__d0(__NN(S_S_N_)))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','Transaction',COUNT(__d0(__NL(Transaction_))),COUNT(__d0(__NN(Transaction_)))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','search_info.transaction_id',COUNT(__d0(__NL(Transaction_I_D_))),COUNT(__d0(__NN(Transaction_I_D_)))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','search_info.sequence_number',COUNT(__d0(__NL(Sequence_Number_))),COUNT(__d0(__NN(Sequence_Number_)))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','Src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'SSNInquiry','PublicRecords_KEL.files.NonFCRA.Inquiry_AccLogs__Inquiry_ALL_SSN_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','SSN',COUNT(__d1(__NL(S_S_N_))),COUNT(__d1(__NN(S_S_N_)))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','Transaction',COUNT(__d1(__NL(Transaction_))),COUNT(__d1(__NN(Transaction_)))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','search_info.transaction_id',COUNT(__d1(__NL(Transaction_I_D_))),COUNT(__d1(__NN(Transaction_I_D_)))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','search_info.sequence_number',COUNT(__d1(__NL(Sequence_Number_))),COUNT(__d1(__NN(Sequence_Number_)))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','Src',COUNT(__d1(__NL(Source_))),COUNT(__d1(__NN(Source_)))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','Archive_Date',COUNT(__d1(Archive___Date_=0)),COUNT(__d1(Archive___Date_!=0))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','DateFirstSeen',COUNT(__d1(Date_First_Seen_=0)),COUNT(__d1(Date_First_Seen_!=0))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','DateLastSeen',COUNT(__d1(Date_Last_Seen_=0)),COUNT(__d1(Date_Last_Seen_!=0))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','HybridArchiveDate',COUNT(__d1(Hybrid_Archive_Date_=0)),COUNT(__d1(Hybrid_Archive_Date_!=0))},
    {'SSNInquiry','PublicRecords_KEL.Files.FCRA.Inquiry_AccLogs__Key_FCRA_SSN_Vault','VaultDateLastSeen',COUNT(__d1(Vault_Date_Last_Seen_=0)),COUNT(__d1(Vault_Date_Last_Seen_!=0))}]
