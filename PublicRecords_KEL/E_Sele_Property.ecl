...
IMPORT CFG_Compile,E_Business_Org,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Property,E_Zip_Code FROM PublicRecords_KEL;
IMPORT * FROM KEL15.Null;
EXPORT E_Sele_Property(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault(ultid != 0 AND orgid != 0 AND seleid != 0 AND (STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0);
  ...
  SHARED __d0_Prop__Layout := RECORD
    ...
    KEL.typ.uid Prop_;
  END;
  SHARED __d0_Missing_Prop__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_Legal__Mapped,'prim_range,predir,prim_name,suffix,postdir,zip,sec_range','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault');
  SHARED __d0_Prop__Mapped := IF(__d0_Missing_Prop__UIDComponents = 'prim_range,predir,prim_name,suffix,postdir,zip,sec_range',PROJECT(__d0_Legal__Mapped,TRANSFORM(__d0_Prop__Layout,SELF.Prop_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d0_Legal__Mapped,__d0_Missing_Prop__UIDComponents),E_Property(__cfg).Lookup,TRIM((STRING)LEFT.prim_range) + '|' + TRIM((STRING)LEFT.predir) + '|' + TRIM((STRING)LEFT.prim_name) + '|' + TRIM((STRING)LEFT.suffix) + '|' + TRIM((STRING)LEFT.postdir) + '|' + TRIM((STRING)LEFT.zip) + '|' + TRIM((STRING)LEFT.sec_range) = RIGHT.KeyVal,TRANSFORM(__d0_Prop__Layout,SELF.Prop_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  ...
  EXPORT NullCounts := DATASET([
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','Legal',COUNT(__d0(__NL(Legal_))),COUNT(__d0(__NN(Legal_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','Prop',COUNT(__d0(__NL(Prop_))),COUNT(__d0(__NN(Prop_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','ultid',COUNT(__d0(__NL(Ult_I_D_))),COUNT(__d0(__NN(Ult_I_D_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','orgid',COUNT(__d0(__NL(Org_I_D_))),COUNT(__d0(__NN(Org_I_D_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','seleid',COUNT(__d0(__NL(Sele_I_D_))),COUNT(__d0(__NN(Sele_I_D_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','prim_range',COUNT(__d0(__NL(Primary_Range_))),COUNT(__d0(__NN(Primary_Range_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','predir',COUNT(__d0(__NL(Predirectional_))),COUNT(__d0(__NN(Predirectional_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','prim_name',COUNT(__d0(__NL(Primary_Name_))),COUNT(__d0(__NN(Primary_Name_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','suffix',COUNT(__d0(__NL(Suffix_))),COUNT(__d0(__NN(Suffix_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','postdir',COUNT(__d0(__NL(Postdirectional_))),COUNT(__d0(__NN(Postdirectional_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','unit_desig',COUNT(__d0(__NL(Unit_Designation_))),COUNT(__d0(__NN(Unit_Designation_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','sec_range',COUNT(__d0(__NL(Secondary_Range_))),COUNT(__d0(__NN(Secondary_Range_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','p_city_name',COUNT(__d0(__NL(Postal_City_))),COUNT(__d0(__NN(Postal_City_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','v_city_name',COUNT(__d0(__NL(Vanity_City_))),COUNT(__d0(__NN(Vanity_City_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','st',COUNT(__d0(__NL(State_))),COUNT(__d0(__NN(State_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','zip',COUNT(__d0(__NL(Z_I_P5_))),COUNT(__d0(__NN(Z_I_P5_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','vendor_source_flag',COUNT(__d0(__NL(Vendor_Source_Code_))),COUNT(__d0(__NN(Vendor_Source_Code_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'SeleProperty','PublicRecords_KEL.Files.NonFCRA.LN_PropertyV2__key_search_fid_vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
