...
EXPORT B_First_Degree_Relative_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8370512 := __ENH_First_Degree_Relative_2;
  EXPORT __ST2579774_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_1 := PROJECT(__EE8370512,__ST2579774_Layout);
END;
