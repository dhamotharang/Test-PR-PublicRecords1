...
EXPORT B_First_Degree_Relative_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7559287 := __ENH_First_Degree_Relative_2;
  EXPORT __ST2339275_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_1 := PROJECT(__EE7559287,__ST2339275_Layout);
END;
