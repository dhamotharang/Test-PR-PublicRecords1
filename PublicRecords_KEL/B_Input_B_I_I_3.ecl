...
EXPORT B_Input_B_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE427207 := __ENH_Input_B_I_I_4;
  EXPORT __ST100339_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST100339_Layout __ND427359__Project(B_Input_B_I_I_4(__in,__cfg).__ST105512_Layout __PP426694) := TRANSFORM
    SELF.B___Inp_Addr_City_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP426694.B___Inp_Addr_City_));
    SELF.B___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP426694.B___Inp_Addr_State_));
    SELF.B___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP426694.B___Inp_Addr_Zip_));
    __CC8925 := '-99999';
    __CC8930 := '-99998';
    SELF.Bus_Input_Street_Clean_Value_ := MAP(__PP426694.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC8925)),__T(__AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP426694.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC8930)),__OP2(__PP426694.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC8930))),__OP2(__PP426694.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC8930))),__OP2(__PP426694.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC8930))),__OP2(__PP426694.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC8930))),__OP2(__PP426694.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC8930))),__OP2(__PP426694.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC8930))))=>__ECAST(KEL.typ.nstr,__CN(__CC8930)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP426694.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP426694.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP426694.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP426694.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP426694.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP426694.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP426694.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC8930))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP426694.B___Inp_Cln_Addr_Sec_Rng_))))));
    SELF.Email_Domain_ := __FN1(KEL.Routines.ToUpperCase,__FN3(KEL.Routines.SubStr2,__PP426694.B___Inp_Email_,__OP2(__PP426694.At_Position_,+,__CN(1)),__FN1(LENGTH,__PP426694.B___Inp_Email_)));
    SELF.Email_Username_ := __FN1(KEL.Routines.ToUpperCase,__FN3(KEL.Routines.SubStr2,__PP426694.B___Inp_Email_,__CN(1),__OP2(__PP426694.At_Position_,-,__CN(1))));
    SELF := __PP426694;
  END;
  EXPORT __ENH_Input_B_I_I_3 := PROJECT(__EE427207,__ND427359__Project(LEFT));
END;
