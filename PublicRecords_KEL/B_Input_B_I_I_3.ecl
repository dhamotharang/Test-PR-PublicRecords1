...
EXPORT B_Input_B_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5511071 := __ENH_Input_B_I_I_4;
  ...
  END;
  SHARED __ST220025_Layout __ND5511467__Project(B_Input_B_I_I_4(__in,__cfg).__ST232502_Layout __PP5511072) := TRANSFORM
    __CC13333 := '-99999';
    __CC13338 := '-99998';
    SELF.B___Inp_Cln_Addr_Full_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP5511072.Bus_Input_Full_Address_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13333)),__ECAST(KEL.typ.nstr,__CN(__CC13338)));
    SELF.Email_Domain_ := __FN1(KEL.Routines.ToUpperCase,__FN3(KEL.Routines.SubStr2,__PP5511072.B___Inp_Email_,__OP2(__PP5511072.At_Position_,+,__CN(1)),__FN1(LENGTH,__PP5511072.B___Inp_Email_)));
    SELF.Email_Username_ := __FN1(KEL.Routines.ToUpperCase,__FN3(KEL.Routines.SubStr2,__PP5511072.B___Inp_Email_,__CN(1),__OP2(__PP5511072.At_Position_,-,__CN(1))));
    SELF := __PP5511072;
  END;
  EXPORT __ENH_Input_B_I_I_3 := PROJECT(__EE5511071,__ND5511467__Project(LEFT));
END;
