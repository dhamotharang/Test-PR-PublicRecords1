...
EXPORT B_Aircraft_Owner_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE135269 := __E_Aircraft_Owner;
  EXPORT __ST87868_Layout := RECORD
  ...
  END;
  SHARED __ST87868_Layout __ND135297__Project(E_Aircraft_Owner(__in,__cfg).Layout __PP135215) := TRANSFORM
    ...
    SELF := __PP135215;
  END;
  EXPORT __ENH_Aircraft_Owner_4 := PROJECT(__EE135269,__ND135297__Project(LEFT));
END;
