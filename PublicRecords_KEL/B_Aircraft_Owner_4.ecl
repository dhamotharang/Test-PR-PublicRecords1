...
EXPORT B_Aircraft_Owner_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE136812 := __E_Aircraft_Owner;
  ...
  END;
  SHARED __ST89278_Layout __ND136840__Project(E_Aircraft_Owner(__in,__cfg).Layout __PP136758) := TRANSFORM
    ...
    SELF := __PP136758;
  END;
  EXPORT __ENH_Aircraft_Owner_4 := PROJECT(__EE136812,__ND136840__Project(LEFT));
END;
