...
EXPORT B_Aircraft_Owner_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE172257 := __E_Aircraft_Owner;
  EXPORT __ST101791_Layout := RECORD
  ...
  END;
  SHARED __ST101791_Layout __ND172285__Project(E_Aircraft_Owner(__in,__cfg).Layout __PP172203) := TRANSFORM
    ...
    SELF := __PP172203;
  END;
  EXPORT __ENH_Aircraft_Owner_4 := PROJECT(__EE172257,__ND172285__Project(LEFT));
END;
