...
//Foreclosure sanity checks
IF(RunAll OR RunSanityCheckSummary,OUTPUT(E_Foreclosure().SanityCheck,NAMED('E_Foreclosure_SanityCheck')));
IF(RunAll OR RunInvalidSingleValues,OUTPUT(E_Foreclosure().Foreclosure_I_D__SingleValue_Invalid,NAMED('E_Foreclosure_Foreclosure_I_D__SingleValue_Invalid')));
IF(RunAll OR RunFast OR RunUidSourceCounts,OUTPUT(E_Foreclosure().UIDSourceCounts,NAMED('E_Foreclosure_UIDSourceCounts')));
IF(RunAll OR RunFast OR RunUidSourceCounts,OUTPUT(E_Foreclosure().TopSourcedUIDs(TopNUids),NAMED('E_Foreclosure_TopSourcedUIDs')));
IF(RunAll OR RunFast OR RunUidSourceCounts,OUTPUT(E_Foreclosure().UIDSourceDistribution,NAMED('E_Foreclosure_UIDSourceDistribution')));
IF(RunAll OR RunFast OR RunNullCounts,OUTPUT(E_Foreclosure().NullCounts,NAMED('E_Foreclosure_NullCounts')));
...
//PersonForeclosure sanity checks
IF(RunAll OR RunSanityCheckSummary,OUTPUT(E_Person_Foreclosure().SanityCheck,NAMED('E_Person_Foreclosure_SanityCheck')));
IF(RunAll OR RunFast OR RunNullCounts,OUTPUT(E_Person_Foreclosure().NullCounts,NAMED('E_Person_Foreclosure_NullCounts')));

//ForeclosureAddress sanity checks
IF(RunAll OR RunSanityCheckSummary,OUTPUT(E_Foreclosure_Address().SanityCheck,NAMED('E_Foreclosure_Address_SanityCheck')));
IF(RunAll OR RunFast OR RunNullCounts,OUTPUT(E_Foreclosure_Address().NullCounts,NAMED('E_Foreclosure_Address_NullCounts')));
