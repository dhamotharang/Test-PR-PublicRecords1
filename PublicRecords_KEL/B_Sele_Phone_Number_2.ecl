...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7746420 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST218206_Layout := RECORD
  ...
  END;
  EXPORT __ST218168_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218206_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218168_Layout __ND7746425__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST232823_Layout __PP7746421) := TRANSFORM
    __EE7746474 := __PP7746421.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7746474),__ST218206_Layout),__NL(__EE7746474));
    SELF := __PP7746421;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7746420,__ND7746425__Project(LEFT));
END;
