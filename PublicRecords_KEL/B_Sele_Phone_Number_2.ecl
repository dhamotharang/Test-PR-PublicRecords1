...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8250438 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST231911_Layout := RECORD
  ...
  END;
  EXPORT __ST231873_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST231911_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231873_Layout __ND8250443__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST246993_Layout __PP8250439) := TRANSFORM
    __EE8250492 := __PP8250439.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8250492),__ST231911_Layout),__NL(__EE8250492));
    SELF := __PP8250439;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8250438,__ND8250443__Project(LEFT));
END;
