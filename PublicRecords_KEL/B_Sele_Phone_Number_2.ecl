...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4698640 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST162140_Layout := RECORD
  ...
  END;
  EXPORT __ST162102_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST162140_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162102_Layout __ND4698645__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST173808_Layout __PP4698641) := TRANSFORM
    __EE4698694 := __PP4698641.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4698694),__ST162140_Layout),__NL(__EE4698694));
    SELF := __PP4698641;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE4698640,__ND4698645__Project(LEFT));
END;
