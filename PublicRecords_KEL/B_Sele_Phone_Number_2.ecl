...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8852731 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST239236_Layout := RECORD
  ...
  END;
  EXPORT __ST239198_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST239236_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST239198_Layout __ND8852736__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST255079_Layout __PP8852732) := TRANSFORM
    __EE8852785 := __PP8852732.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8852785),__ST239236_Layout),__NL(__EE8852785));
    SELF := __PP8852732;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8852731,__ND8852736__Project(LEFT));
END;
