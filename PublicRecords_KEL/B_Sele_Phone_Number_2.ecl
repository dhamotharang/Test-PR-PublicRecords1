...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7578973 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST219481_Layout := RECORD
  ...
  END;
  EXPORT __ST219443_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219481_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219443_Layout __ND7578978__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST234171_Layout __PP7578974) := TRANSFORM
    __EE7579027 := __PP7578974.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7579027),__ST219481_Layout),__NL(__EE7579027));
    SELF := __PP7578974;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7578973,__ND7578978__Project(LEFT));
END;
