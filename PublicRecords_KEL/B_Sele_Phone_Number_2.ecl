...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7203362 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST210833_Layout := RECORD
  ...
  END;
  EXPORT __ST210795_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST210833_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210795_Layout __ND7203367__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST225147_Layout __PP7203363) := TRANSFORM
    __EE7203416 := __PP7203363.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7203416),__ST210833_Layout),__NL(__EE7203416));
    SELF := __PP7203363;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7203362,__ND7203367__Project(LEFT));
END;
