...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8282245 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST231932_Layout := RECORD
  ...
  END;
  EXPORT __ST231894_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST231932_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231894_Layout __ND8282250__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST247014_Layout __PP8282246) := TRANSFORM
    __EE8282299 := __PP8282246.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8282299),__ST231932_Layout),__NL(__EE8282299));
    SELF := __PP8282246;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8282245,__ND8282250__Project(LEFT));
END;
