...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7719335 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST216805_Layout := RECORD
  ...
  END;
  EXPORT __ST216767_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST216805_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216767_Layout __ND7719340__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST231421_Layout __PP7719336) := TRANSFORM
    __EE7719389 := __PP7719336.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7719389),__ST216805_Layout),__NL(__EE7719389));
    SELF := __PP7719336;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7719335,__ND7719340__Project(LEFT));
END;
