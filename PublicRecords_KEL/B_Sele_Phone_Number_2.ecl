...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8214981 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST228122_Layout := RECORD
  ...
  END;
  EXPORT __ST228084_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST228122_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST228084_Layout __ND8214986__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST243202_Layout __PP8214982) := TRANSFORM
    __EE8215035 := __PP8214982.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8215035),__ST228122_Layout),__NL(__EE8215035));
    SELF := __PP8214982;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8214981,__ND8214986__Project(LEFT));
END;
