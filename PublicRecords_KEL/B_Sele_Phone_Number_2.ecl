...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6915545 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST215210_Layout := RECORD
  ...
  END;
  EXPORT __ST215172_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST215210_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST215172_Layout __ND6915550__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST229468_Layout __PP6915546) := TRANSFORM
    __EE6915599 := __PP6915546.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6915599),__ST215210_Layout),__NL(__EE6915599));
    SELF := __PP6915546;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE6915545,__ND6915550__Project(LEFT));
END;
