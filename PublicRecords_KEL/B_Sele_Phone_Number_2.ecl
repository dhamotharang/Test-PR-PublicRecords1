...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8254903 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST231985_Layout := RECORD
  ...
  END;
  EXPORT __ST231947_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST231985_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231947_Layout __ND8254908__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST247080_Layout __PP8254904) := TRANSFORM
    __EE8254957 := __PP8254904.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8254957),__ST231985_Layout),__NL(__EE8254957));
    SELF := __PP8254904;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8254903,__ND8254908__Project(LEFT));
END;
