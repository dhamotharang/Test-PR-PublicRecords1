...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9270576 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST245964_Layout := RECORD
  ...
  END;
  EXPORT __ST245926_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245964_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245926_Layout __ND9270581__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST261583_Layout __PP9270577) := TRANSFORM
    __EE9270630 := __PP9270577.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9270630),__ST245964_Layout),__NL(__EE9270630));
    SELF := __PP9270577;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE9270576,__ND9270581__Project(LEFT));
END;
