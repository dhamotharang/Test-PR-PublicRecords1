...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4611296 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST170353_Layout := RECORD
  ...
  END;
  EXPORT __ST170315_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST170353_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170315_Layout __ND4611301__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST182389_Layout __PP4611297) := TRANSFORM
    __EE4611350 := __PP4611297.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4611350),__ST170353_Layout),__NL(__EE4611350));
    SELF := __PP4611297;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE4611296,__ND4611301__Project(LEFT));
END;
