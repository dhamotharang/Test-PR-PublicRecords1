...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7579003 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST219511_Layout := RECORD
  ...
  END;
  EXPORT __ST219473_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219511_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219473_Layout __ND7579008__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST234201_Layout __PP7579004) := TRANSFORM
    __EE7579057 := __PP7579004.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7579057),__ST219511_Layout),__NL(__EE7579057));
    SELF := __PP7579004;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7579003,__ND7579008__Project(LEFT));
END;
