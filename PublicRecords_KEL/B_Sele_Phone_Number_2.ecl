...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8178114 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST230403_Layout := RECORD
  ...
  END;
  EXPORT __ST230365_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST230403_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST230365_Layout __ND8178119__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST245404_Layout __PP8178115) := TRANSFORM
    __EE8178168 := __PP8178115.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8178168),__ST230403_Layout),__NL(__EE8178168));
    SELF := __PP8178115;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8178114,__ND8178119__Project(LEFT));
END;
