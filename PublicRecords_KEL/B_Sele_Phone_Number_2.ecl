...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7207390 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST211339_Layout := RECORD
  ...
  END;
  EXPORT __ST211301_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211339_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211301_Layout __ND7207395__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST225635_Layout __PP7207391) := TRANSFORM
    __EE7207444 := __PP7207391.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7207444),__ST211339_Layout),__NL(__EE7207444));
    SELF := __PP7207391;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7207390,__ND7207395__Project(LEFT));
END;
