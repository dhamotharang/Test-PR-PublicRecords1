...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7204997 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST210659_Layout := RECORD
  ...
  END;
  EXPORT __ST210621_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST210659_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210621_Layout __ND7205002__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST224955_Layout __PP7204998) := TRANSFORM
    __EE7205051 := __PP7204998.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7205051),__ST210659_Layout),__NL(__EE7205051));
    SELF := __PP7204998;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7204997,__ND7205002__Project(LEFT));
END;
