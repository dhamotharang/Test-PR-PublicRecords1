...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8068693 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST229136_Layout := RECORD
  ...
  END;
  EXPORT __ST229098_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST229136_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST229098_Layout __ND8068698__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST244080_Layout __PP8068694) := TRANSFORM
    __EE8068747 := __PP8068694.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8068747),__ST229136_Layout),__NL(__EE8068747));
    SELF := __PP8068694;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8068693,__ND8068698__Project(LEFT));
END;
