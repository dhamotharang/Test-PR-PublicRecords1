...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4625760 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST172817_Layout := RECORD
  ...
  END;
  EXPORT __ST172779_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST172817_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172779_Layout __ND4625765__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST185003_Layout __PP4625761) := TRANSFORM
    __EE4625814 := __PP4625761.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4625814),__ST172817_Layout),__NL(__EE4625814));
    SELF := __PP4625761;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE4625760,__ND4625765__Project(LEFT));
END;
