...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8084374 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST223883_Layout := RECORD
  ...
  END;
  EXPORT __ST223845_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST223883_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223845_Layout __ND8084379__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST238827_Layout __PP8084375) := TRANSFORM
    __EE8084428 := __PP8084375.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8084428),__ST223883_Layout),__NL(__EE8084428));
    SELF := __PP8084375;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8084374,__ND8084379__Project(LEFT));
END;
