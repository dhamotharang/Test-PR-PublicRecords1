...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7198333 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST210793_Layout := RECORD
  ...
  END;
  EXPORT __ST210755_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST210793_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210755_Layout __ND7198338__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST225113_Layout __PP7198334) := TRANSFORM
    __EE7198387 := __PP7198334.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7198387),__ST210793_Layout),__NL(__EE7198387));
    SELF := __PP7198334;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7198333,__ND7198338__Project(LEFT));
END;
