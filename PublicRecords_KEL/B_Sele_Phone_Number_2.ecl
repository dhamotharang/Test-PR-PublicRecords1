...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7322094 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST211838_Layout := RECORD
  ...
  END;
  EXPORT __ST211800_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211838_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211800_Layout __ND7322099__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST226161_Layout __PP7322095) := TRANSFORM
    __EE7322148 := __PP7322095.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7322148),__ST211838_Layout),__NL(__EE7322148));
    SELF := __PP7322095;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7322094,__ND7322099__Project(LEFT));
END;
