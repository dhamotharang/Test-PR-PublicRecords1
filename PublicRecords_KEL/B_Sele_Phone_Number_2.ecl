...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7206287 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST211314_Layout := RECORD
  ...
  END;
  EXPORT __ST211276_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211314_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211276_Layout __ND7206292__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST225610_Layout __PP7206288) := TRANSFORM
    __EE7206341 := __PP7206288.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7206341),__ST211314_Layout),__NL(__EE7206341));
    SELF := __PP7206288;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7206287,__ND7206292__Project(LEFT));
END;
