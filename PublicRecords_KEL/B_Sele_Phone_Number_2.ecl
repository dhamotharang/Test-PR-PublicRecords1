...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1915841 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST136684_Layout := RECORD
  ...
  END;
  EXPORT __ST136646_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST136684_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Date_Vendor_First_Reported_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST136646_Layout __ND1916107__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST147303_Layout __PP1915654) := TRANSFORM
    __EE1915774 := __PP1915654.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1915774),__ST136684_Layout),__NL(__EE1915774));
    SELF := __PP1915654;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE1915841,__ND1916107__Project(LEFT));
END;
