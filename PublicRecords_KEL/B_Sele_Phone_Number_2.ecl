...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7567415 := __ENH_Sele_Phone_Number_3;
  EXPORT __ST219152_Layout := RECORD
  ...
  END;
  EXPORT __ST219114_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219152_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219114_Layout __ND7567420__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST233816_Layout __PP7567416) := TRANSFORM
    __EE7567469 := __PP7567416.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7567469),__ST219152_Layout),__NL(__EE7567469));
    SELF := __PP7567416;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE7567415,__ND7567420__Project(LEFT));
END;
