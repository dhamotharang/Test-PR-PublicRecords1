...
EXPORT B_Sele_Phone_Number_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8001755 := __ENH_Sele_Phone_Number_3;
  ...
  END;
  EXPORT __ST222212_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST222250_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST222212_Layout __ND8001760__Project(B_Sele_Phone_Number_3(__in,__cfg).__ST237220_Layout __PP8001756) := TRANSFORM
    __EE8001809 := __PP8001756.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8001809),__ST222250_Layout),__NL(__EE8001809));
    SELF := __PP8001756;
  END;
  EXPORT __ENH_Sele_Phone_Number_2 := PROJECT(__EE8001755,__ND8001760__Project(LEFT));
END;
