...
EXPORT B_U_C_C_3(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED VIRTUAL TYPEOF(B_U_C_C_4(__cfg).__ENH_U_C_C_4) __ENH_U_C_C_4 := B_U_C_C_4(__cfg).__ENH_U_C_C_4;
  SHARED __EE6535825 := __ENH_U_C_C_4;
  EXPORT __ST327046_Layout := RECORD
  ...
  END;
  EXPORT __ST327042_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST327046_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST327042_Layout __ND6536068__Project(B_U_C_C_4(__cfg).__ST244489_Layout __PP6535826) := TRANSFORM
    __EE6535868 := __PP6535826.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6535868),__ST327046_Layout),__NL(__EE6535868));
    SELF.Active_Status_ := __OP2(__PP6535826.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6535826;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6535825,__ND6536068__Project(LEFT));
END;
