...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6815610 := __ENH_U_C_C_4;
  EXPORT __ST338505_Layout := RECORD
  ...
  END;
  EXPORT __ST338501_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST338505_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST338501_Layout __ND6815853__Project(B_U_C_C_4(__in,__cfg).__ST251919_Layout __PP6815611) := TRANSFORM
    __EE6815653 := __PP6815611.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6815653),__ST338505_Layout),__NL(__EE6815653));
    SELF.Active_Status_ := __OP2(__PP6815611.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6815611;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6815610,__ND6815853__Project(LEFT));
END;
