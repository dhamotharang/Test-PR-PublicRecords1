...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6971767 := __ENH_U_C_C_4;
  EXPORT __ST337841_Layout := RECORD
  ...
  END;
  EXPORT __ST337837_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST337841_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST337837_Layout __ND6972010__Project(B_U_C_C_4(__in,__cfg).__ST259005_Layout __PP6971768) := TRANSFORM
    __EE6971810 := __PP6971768.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6971810),__ST337841_Layout),__NL(__EE6971810));
    SELF.Active_Status_ := __OP2(__PP6971768.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6971768;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6971767,__ND6972010__Project(LEFT));
END;
