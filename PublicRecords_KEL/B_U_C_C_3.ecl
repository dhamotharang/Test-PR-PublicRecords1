...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6435320 := __ENH_U_C_C_4;
  EXPORT __ST299910_Layout := RECORD
  ...
  END;
  EXPORT __ST299906_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST299910_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST299906_Layout __ND6435563__Project(B_U_C_C_4(__in,__cfg).__ST245854_Layout __PP6435321) := TRANSFORM
    __EE6435363 := __PP6435321.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6435363),__ST299910_Layout),__NL(__EE6435363));
    SELF.Active_Status_ := __OP2(__PP6435321.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6435321;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6435320,__ND6435563__Project(LEFT));
END;
