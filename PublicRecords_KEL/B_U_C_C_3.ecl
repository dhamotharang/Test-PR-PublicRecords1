...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5778457 := __ENH_U_C_C_4;
  EXPORT __ST292566_Layout := RECORD
  ...
  END;
  EXPORT __ST292562_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST292566_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST292562_Layout __ND5778700__Project(B_U_C_C_4(__in,__cfg).__ST240807_Layout __PP5778458) := TRANSFORM
    __EE5778500 := __PP5778458.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5778500),__ST292566_Layout),__NL(__EE5778500));
    SELF.Active_Status_ := __OP2(__PP5778458.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP5778458;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE5778457,__ND5778700__Project(LEFT));
END;
