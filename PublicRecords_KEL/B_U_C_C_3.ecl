...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6835977 := __ENH_U_C_C_4;
  EXPORT __ST330513_Layout := RECORD
  ...
  END;
  EXPORT __ST330509_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST330513_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST330509_Layout __ND6836220__Project(B_U_C_C_4(__in,__cfg).__ST252221_Layout __PP6835978) := TRANSFORM
    __EE6836020 := __PP6835978.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6836020),__ST330513_Layout),__NL(__EE6836020));
    SELF.Active_Status_ := __OP2(__PP6835978.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6835978;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6835977,__ND6836220__Project(LEFT));
END;
