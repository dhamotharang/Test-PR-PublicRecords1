...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4018894 := __ENH_U_C_C_4;
  EXPORT __ST224653_Layout := RECORD
  ...
  END;
  EXPORT __ST224649_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST224653_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224649_Layout __ND4019086__Project(B_U_C_C_4(__in,__cfg).__ST183866_Layout __PP4018895) := TRANSFORM
    __EE4018937 := __PP4018895.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4018937),__ST224653_Layout),__NL(__EE4018937));
    SELF.Active_Status_ := __OP2(__PP4018895.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP4018895;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE4018894,__ND4019086__Project(LEFT));
END;
