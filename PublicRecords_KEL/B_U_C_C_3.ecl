...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6754207 := __ENH_U_C_C_4;
  EXPORT __ST307052_Layout := RECORD
  ...
  END;
  EXPORT __ST307048_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST307052_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST307048_Layout __ND6754450__Project(B_U_C_C_4(__in,__cfg).__ST249136_Layout __PP6754208) := TRANSFORM
    __EE6754250 := __PP6754208.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6754250),__ST307052_Layout),__NL(__EE6754250));
    SELF.Active_Status_ := __OP2(__PP6754208.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6754208;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6754207,__ND6754450__Project(LEFT));
END;
