...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6180780 := __ENH_U_C_C_4;
  EXPORT __ST267897_Layout := RECORD
  ...
  END;
  EXPORT __ST267893_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST267897_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267893_Layout __ND6181023__Project(B_U_C_C_4(__in,__cfg).__ST237541_Layout __PP6180781) := TRANSFORM
    __EE6180823 := __PP6180781.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6180823),__ST267897_Layout),__NL(__EE6180823));
    SELF.Active_Status_ := __OP2(__PP6180781.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6180781;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6180780,__ND6181023__Project(LEFT));
END;
