...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6905363 := __ENH_U_C_C_4;
  EXPORT __ST314230_Layout := RECORD
  ...
  END;
  EXPORT __ST314226_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST314230_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST314226_Layout __ND6905606__Project(B_U_C_C_4(__in,__cfg).__ST257305_Layout __PP6905364) := TRANSFORM
    __EE6905406 := __PP6905364.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6905406),__ST314230_Layout),__NL(__EE6905406));
    SELF.Active_Status_ := __OP2(__PP6905364.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6905364;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6905363,__ND6905606__Project(LEFT));
END;
