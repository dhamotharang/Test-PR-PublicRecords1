...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6062833 := __ENH_U_C_C_4;
  EXPORT __ST272087_Layout := RECORD
  ...
  END;
  EXPORT __ST272083_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST272087_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST272083_Layout __ND6063076__Project(B_U_C_C_4(__in,__cfg).__ST236527_Layout __PP6062834) := TRANSFORM
    __EE6062876 := __PP6062834.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6062876),__ST272087_Layout),__NL(__EE6062876));
    SELF.Active_Status_ := __OP2(__PP6062834.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6062834;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6062833,__ND6063076__Project(LEFT));
END;
