...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6755793 := __ENH_U_C_C_4;
  EXPORT __ST334648_Layout := RECORD
  ...
  END;
  EXPORT __ST334644_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST334648_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST334644_Layout __ND6756036__Project(B_U_C_C_4(__in,__cfg).__ST249106_Layout __PP6755794) := TRANSFORM
    __EE6755836 := __PP6755794.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6755836),__ST334648_Layout),__NL(__EE6755836));
    SELF.Active_Status_ := __OP2(__PP6755794.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6755794;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6755793,__ND6756036__Project(LEFT));
END;
