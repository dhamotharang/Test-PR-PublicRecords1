...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6065155 := __ENH_U_C_C_4;
  EXPORT __ST271441_Layout := RECORD
  ...
  END;
  EXPORT __ST271437_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST271441_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST271437_Layout __ND6065398__Project(B_U_C_C_4(__in,__cfg).__ST236990_Layout __PP6065156) := TRANSFORM
    __EE6065198 := __PP6065156.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6065198),__ST271441_Layout),__NL(__EE6065198));
    SELF.Active_Status_ := __OP2(__PP6065156.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6065156;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6065155,__ND6065398__Project(LEFT));
END;
