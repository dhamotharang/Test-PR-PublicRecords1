...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6057782 := __ENH_U_C_C_4;
  EXPORT __ST267143_Layout := RECORD
  ...
  END;
  EXPORT __ST267139_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST267143_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267139_Layout __ND6058025__Project(B_U_C_C_4(__in,__cfg).__ST236493_Layout __PP6057783) := TRANSFORM
    __EE6057825 := __PP6057783.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6057825),__ST267143_Layout),__NL(__EE6057825));
    SELF.Active_Status_ := __OP2(__PP6057783.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6057783;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6057782,__ND6058025__Project(LEFT));
END;
