...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6999285 := __ENH_U_C_C_4;
  EXPORT __ST347056_Layout := RECORD
  ...
  END;
  EXPORT __ST347052_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST347056_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST347052_Layout __ND6999528__Project(B_U_C_C_4(__in,__cfg).__ST258926_Layout __PP6999286) := TRANSFORM
    __EE6999328 := __PP6999286.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6999328),__ST347056_Layout),__NL(__EE6999328));
    SELF.Active_Status_ := __OP2(__PP6999286.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6999286;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6999285,__ND6999528__Project(LEFT));
END;
