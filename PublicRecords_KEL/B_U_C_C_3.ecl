...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1119212 := __ENH_U_C_C_4;
  EXPORT __ST148121_Layout := RECORD
  ...
  END;
  EXPORT __ST148117_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST148121_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST148117_Layout __ND1119519__Project(B_U_C_C_4(__in,__cfg).__ST156614_Layout __PP1118943) := TRANSFORM
    __EE1119016 := __PP1118943.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1119016),__ST148121_Layout),__NL(__EE1119016));
    SELF.Active_Status_ := __OP2(__PP1118943.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP1118943;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE1119212,__ND1119519__Project(LEFT));
END;
