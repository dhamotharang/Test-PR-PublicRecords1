...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6066013 := __ENH_U_C_C_4;
  EXPORT __ST265206_Layout := RECORD
  ...
  END;
  EXPORT __ST265202_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST265206_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265202_Layout __ND6066256__Project(B_U_C_C_4(__in,__cfg).__ST237010_Layout __PP6066014) := TRANSFORM
    __EE6066056 := __PP6066014.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6066056),__ST265206_Layout),__NL(__EE6066056));
    SELF.Active_Status_ := __OP2(__PP6066014.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6066014;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6066013,__ND6066256__Project(LEFT));
END;
