...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6435290 := __ENH_U_C_C_4;
  EXPORT __ST290742_Layout := RECORD
  ...
  END;
  EXPORT __ST290738_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST290742_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST290738_Layout __ND6435533__Project(B_U_C_C_4(__in,__cfg).__ST245824_Layout __PP6435291) := TRANSFORM
    __EE6435333 := __PP6435291.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6435333),__ST290742_Layout),__NL(__EE6435333));
    SELF.Active_Status_ := __OP2(__PP6435291.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6435291;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6435290,__ND6435533__Project(LEFT));
END;
