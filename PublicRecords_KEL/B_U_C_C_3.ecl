...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6063730 := __ENH_U_C_C_4;
  EXPORT __ST267102_Layout := RECORD
  ...
  EXPORT __ST267098_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST267102_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267098_Layout __ND6063973__Project(B_U_C_C_4(__in,__cfg).__ST236335_Layout __PP6063731) := TRANSFORM
    __EE6063773 := __PP6063731.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6063773),__ST267102_Layout),__NL(__EE6063773));
    SELF.Active_Status_ := __OP2(__PP6063731.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP6063731;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE6063730,__ND6063973__Project(LEFT));
END;
