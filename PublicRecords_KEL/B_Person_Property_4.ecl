...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5422375 := __ENH_Person_Property_5;
  EXPORT __ST244067_Layout := RECORD
  ...
  END;
  SHARED __ST244067_Layout __ND5422380__Project(B_Person_Property_5(__in,__cfg).__ST250826_Layout __PP5422376) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5422376.Property_Is_Owned_Assessment_ OR __PP5422376.Property_Is_Owned_Deed_) AND NOT (__PP5422376.Property_Is_Sold_);
    SELF := __PP5422376;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5422375,__ND5422380__Project(LEFT));
END;
