...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5422405 := __ENH_Person_Property_5;
  EXPORT __ST244097_Layout := RECORD
  ...
  END;
  SHARED __ST244097_Layout __ND5422410__Project(B_Person_Property_5(__in,__cfg).__ST250856_Layout __PP5422406) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5422406.Property_Is_Owned_Assessment_ OR __PP5422406.Property_Is_Owned_Deed_) AND NOT (__PP5422406.Property_Is_Sold_);
    SELF := __PP5422406;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5422405,__ND5422410__Project(LEFT));
END;
