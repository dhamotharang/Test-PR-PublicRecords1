...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5577092 := __ENH_Person_Property_5;
  EXPORT __ST241347_Layout := RECORD
  ...
  END;
  SHARED __ST241347_Layout __ND5577097__Project(B_Person_Property_5(__in,__cfg).__ST248114_Layout __PP5577093) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5577093.Property_Is_Owned_Assessment_ OR __PP5577093.Property_Is_Owned_Deed_) AND NOT (__PP5577093.Property_Is_Sold_);
    SELF := __PP5577093;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5577092,__ND5577097__Project(LEFT));
END;
