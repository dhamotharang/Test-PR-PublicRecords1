...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5604138 := __ENH_Person_Property_5;
  EXPORT __ST242750_Layout := RECORD
  ...
  END;
  SHARED __ST242750_Layout __ND5604143__Project(B_Person_Property_5(__in,__cfg).__ST249521_Layout __PP5604139) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5604139.Property_Is_Owned_Assessment_ OR __PP5604139.Property_Is_Owned_Deed_) AND NOT (__PP5604139.Property_Is_Sold_);
    SELF := __PP5604139;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5604138,__ND5604143__Project(LEFT));
END;
