...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5850181 := __ENH_Person_Property_5;
  ...
  END;
  SHARED __ST255507_Layout __ND5850186__Project(B_Person_Property_5(__in,__cfg).__ST262479_Layout __PP5850182) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5850182.Property_Is_Owned_Assessment_ OR __PP5850182.Property_Is_Owned_Deed_) AND NOT (__PP5850182.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP5850182.Property_Purchase_Date_Last_Seen_Capped_,__CC13322);
    SELF := __PP5850182;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5850181,__ND5850186__Project(LEFT));
END;
