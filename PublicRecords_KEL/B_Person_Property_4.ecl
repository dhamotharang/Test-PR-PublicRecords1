...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5970548 := __ENH_Person_Property_5;
  EXPORT __ST253306_Layout := RECORD
  ...
  END;
  SHARED __ST253306_Layout __ND5970553__Project(B_Person_Property_5(__in,__cfg).__ST260182_Layout __PP5970549) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5970549.Property_Is_Owned_Assessment_ OR __PP5970549.Property_Is_Owned_Deed_) AND NOT (__PP5970549.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP5970549.Property_Purchase_Date_Last_Seen_Capped_,__CC13270);
    SELF := __PP5970549;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5970548,__ND5970553__Project(LEFT));
END;
