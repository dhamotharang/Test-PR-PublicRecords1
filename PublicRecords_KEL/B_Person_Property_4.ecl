...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5765911 := __ENH_Person_Property_5;
  EXPORT __ST247305_Layout := RECORD
  ...
  END;
  SHARED __ST247305_Layout __ND5765916__Project(B_Person_Property_5(__in,__cfg).__ST254181_Layout __PP5765912) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5765912.Property_Is_Owned_Assessment_ OR __PP5765912.Property_Is_Owned_Deed_) AND NOT (__PP5765912.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP5765912.Property_Purchase_Date_Last_Seen_Capped_,__CC13307);
    SELF := __PP5765912;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5765911,__ND5765916__Project(LEFT));
END;
