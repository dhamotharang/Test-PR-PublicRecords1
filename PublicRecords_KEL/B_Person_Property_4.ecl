...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6942103 := __ENH_Person_Property_5;
  EXPORT __ST272297_Layout := RECORD
  ...
  END;
  SHARED __ST272297_Layout __ND6942108__Project(B_Person_Property_5(__in,__cfg).__ST279597_Layout __PP6942104) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6942104.Property_Is_Owned_Assessment_ OR __PP6942104.Property_Is_Owned_Deed_) AND NOT (__PP6942104.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP6942104.Property_Purchase_Date_Last_Seen_Capped_,__CC13331);
    SELF := __PP6942104;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE6942103,__ND6942108__Project(LEFT));
END;
