...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6539336 := __ENH_Person_Property_5;
  EXPORT __ST265735_Layout := RECORD
  ...
  END;
  SHARED __ST265735_Layout __ND6539341__Project(B_Person_Property_5(__in,__cfg).__ST272932_Layout __PP6539337) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6539337.Property_Is_Owned_Assessment_ OR __PP6539337.Property_Is_Owned_Deed_) AND NOT (__PP6539337.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP6539337.Property_Purchase_Date_Last_Seen_Capped_,__CC13272);
    SELF := __PP6539337;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE6539336,__ND6539341__Project(LEFT));
END;
