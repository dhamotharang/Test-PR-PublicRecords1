...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5940099 := __ENH_Person_Property_5;
  EXPORT __ST257125_Layout := RECORD
  ...
  END;
  SHARED __ST257125_Layout __ND5940104__Project(B_Person_Property_5(__in,__cfg).__ST264107_Layout __PP5940100) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP5940100.Property_Is_Owned_Assessment_ OR __PP5940100.Property_Is_Owned_Deed_) AND NOT (__PP5940100.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP5940100.Property_Purchase_Date_Last_Seen_Capped_,__CC13328);
    SELF := __PP5940100;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE5940099,__ND5940104__Project(LEFT));
END;
