...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_10,B_Input_P_I_I_12,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Input_P_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4645347 := __ENH_Input_P_I_I_10;
  EXPORT __ST209634_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST209634_Layout __ND4645931__Project(B_Input_P_I_I_12(__in,__cfg).__ST213426_Layout __PP4645348) := TRANSFORM
    __CC13665 := '-99998';
    __CC13660 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP4645348.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP4645348.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13660)),__ECAST(KEL.typ.nstr,__PP4645348.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF := __PP4645348;
  END;
  EXPORT __ENH_Input_P_I_I_9 := PROJECT(__EE4645347,__ND4645931__Project(LEFT));
END;
