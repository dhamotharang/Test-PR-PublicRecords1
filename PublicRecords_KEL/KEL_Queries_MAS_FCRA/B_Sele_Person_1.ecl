...
EXPORT B_Sele_Person_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6418140 := __ENH_Sele_Person_2;
  EXPORT __ST171968_Layout := RECORD
  ...
  END;
  SHARED __ST171968_Layout __ND6418254__Project(B_Sele_Person_2(__in,__cfg).__ST179892_Layout __PP6418141) := TRANSFORM
    __CC64027 := 730;
    SELF.Two_Years_ := __OP2(__PP6418141.Age_In_Days_,<=,__CN(__CC64027));
    SELF := __PP6418141;
  END;
  EXPORT __ENH_Sele_Person_1 := PROJECT(__EE6418140,__ND6418254__Project(LEFT));
END;
