...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE10445639 := __ENH_Person;
  EXPORT Res0 := __UNWRAP(__EE10445639);
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_14,NAMED('DBG_E_Input_P_I_I_Intermediate_14_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_14,NAMED('DBG_E_Lien_Judgment_Intermediate_14_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_13,NAMED('DBG_E_Input_P_I_I_Intermediate_13_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_13_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_12,NAMED('DBG_E_Input_P_I_I_Intermediate_12_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Person_Intermediate_12,NAMED('DBG_E_Person_Intermediate_12_Q_Index_Build_Entity')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_11,NAMED('DBG_E_Input_P_I_I_Intermediate_11_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_10,NAMED('DBG_E_Input_P_I_I_Intermediate_10_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_10,NAMED('DBG_E_Person_Address_Intermediate_10_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_9,NAMED('DBG_E_Person_Address_Intermediate_9_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Education_Intermediate_8,NAMED('DBG_E_Education_Intermediate_8_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_8,NAMED('DBG_E_Person_Address_Intermediate_8_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_7,NAMED('DBG_E_Criminal_Offense_Intermediate_7_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_7,NAMED('DBG_E_Person_Address_Intermediate_7_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_7,NAMED('DBG_E_Person_S_S_N_Intermediate_7_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_6,NAMED('DBG_E_Criminal_Offense_Intermediate_6_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_6,NAMED('DBG_E_Person_Address_Intermediate_6_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_5,NAMED('DBG_E_Address_Property_Intermediate_5_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_5,NAMED('DBG_E_Person_Address_Intermediate_5_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_4,NAMED('DBG_E_Address_Property_Intermediate_4_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_4,NAMED('DBG_E_Person_Address_Intermediate_4_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_3,NAMED('DBG_E_Address_Property_Intermediate_3_Q_Index_Build_Entity')),
    ...
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Index_Build_Entity')),
