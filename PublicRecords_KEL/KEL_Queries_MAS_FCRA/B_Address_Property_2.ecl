...
IMPORT KEL15 AS KEL;
IMPORT B_Address_Property_3,CFG_Compile,E_Address,E_Address_Property,E_Geo_Link,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Address_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4631492 := __ENH_Address_Property_3;
  EXPORT __ENH_Address_Property_2 := __EE4631492;
END;
