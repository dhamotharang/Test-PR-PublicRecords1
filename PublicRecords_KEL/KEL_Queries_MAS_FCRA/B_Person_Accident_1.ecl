...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Accident_2,B_Person_Accident_8,CFG_Compile,E_Accident,E_Person,E_Person_Accident FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Accident_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8219887 := __ENH_Person_Accident_2;
  EXPORT __ENH_Person_Accident_1 := __EE8219887;
END;
