...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_3,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6314176 := __ENH_Person_Address_3;
  EXPORT __ST233352_Layout := RECORD
  ...
  END;
  EXPORT __ST233296_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST233352_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST233296_Layout __ND6314181__Project(B_Person_Address_3(__in,__cfg).__ST233076_Layout __PP6314177) := TRANSFORM
    __EE6314282 := __PP6314177.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6314282),__ST233352_Layout),__NL(__EE6314282));
    SELF := __PP6314177;
  END;
  EXPORT __ENH_Person_Address_2 := PROJECT(__EE6314176,__ND6314181__Project(LEFT));
END;
