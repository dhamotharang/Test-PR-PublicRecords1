...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1093796 := __ENH_Criminal_Offense_7;
  EXPORT __ST172624_Layout := RECORD
  ...
  END;
  EXPORT __ST172577_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST172624_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST172577_Layout __ND1093716__Project(B_Criminal_Offense_7(__in,__cfg).__ST173691_Layout __PP1093164) := TRANSFORM
    __EE1093799 := __PP1093164.Offense_Charges_;
    __ST172624_Layout __ND1093674__Project(B_Criminal_Offense_7(__in,__cfg).__ST173738_Layout __PP1093325) := TRANSFORM
      __EE1093669 := __PP1093164.Offense_Charges_;
      SELF.Criminal_Date_ := KEL.Aggregates.MinNN(__EE1093669,KEL.Routines.CastStringToDate(__T(__EE1093669).Valid_Date_));
      SELF.Dismissed_Charges_ := __OR(IF(__T(__NT(__PP1093164.Court_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1093164.Court_Disposition_Description_,=,__CN('DISMISSED')))),IF(__T(__NT(__PP1093164.Court_Additional_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1093164.Court_Additional_Disposition_Description_,=,__CN('DISMISSED')))));
      SELF := __PP1093325;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1093799,__ND1093674__Project(LEFT));
    SELF := __PP1093164;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1093796,__ND1093716__Project(LEFT));
END;
