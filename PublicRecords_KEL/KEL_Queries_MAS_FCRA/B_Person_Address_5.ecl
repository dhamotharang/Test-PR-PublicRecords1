...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_6,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4747224 := __ENH_Person_Address_6;
  EXPORT __ST232692_Layout := RECORD
  ...
  END;
  EXPORT __ST232636_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST232692_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST232636_Layout __ND4747229__Project(B_Person_Address_6(__in,__cfg).__ST224336_Layout __PP4747225) := TRANSFORM
    __EE4747330 := __PP4747225.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4747330),__ST232692_Layout),__NL(__EE4747330));
    SELF := __PP4747225;
  END;
  EXPORT __ENH_Person_Address_5 := PROJECT(__EE4747224,__ND4747229__Project(LEFT));
END;
