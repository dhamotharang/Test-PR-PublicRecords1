...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1080561 := __ENH_Criminal_Offense_8;
  EXPORT __ST178017_Layout := RECORD
  ...
  END;
  EXPORT __ST177970_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST178017_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177970_Layout __ND1080939__Project(B_Criminal_Offense_8(__in,__cfg).__ST178916_Layout __PP1080562) := TRANSFORM
    __EE1080722 := __PP1080562.Offense_Charges_;
    __ST178017_Layout __ND1080926__Project(B_Criminal_Offense_8(__in,__cfg).__ST178963_Layout __PP1080723) := TRANSFORM
      __CC14121 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1080723.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1080723.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14121)));
      SELF := __PP1080723;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1080722,__ND1080926__Project(LEFT));
    SELF := __PP1080562;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE1080561,__ND1080939__Project(LEFT));
END;
