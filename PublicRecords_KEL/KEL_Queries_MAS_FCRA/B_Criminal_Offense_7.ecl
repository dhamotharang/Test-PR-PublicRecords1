...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3910504 := __ENH_Criminal_Offense_8;
  EXPORT __ST194644_Layout := RECORD
  ...
  END;
  EXPORT __ST194597_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST194644_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST194597_Layout __ND3910882__Project(B_Criminal_Offense_8(__in,__cfg).__ST195951_Layout __PP3910505) := TRANSFORM
    __EE3910665 := __PP3910505.Offense_Charges_;
    __ST194644_Layout __ND3910869__Project(B_Criminal_Offense_8(__in,__cfg).__ST195998_Layout __PP3910666) := TRANSFORM
      __CC13860 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP3910666.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP3910666.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13860)));
      SELF := __PP3910666;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE3910665,__ND3910869__Project(LEFT));
    SELF := __PP3910505;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE3910504,__ND3910882__Project(LEFT));
END;
