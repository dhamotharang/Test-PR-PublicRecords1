...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4661509 := __ENH_Criminal_Offense_8;
  EXPORT __ST206014_Layout := RECORD
  ...
  END;
  EXPORT __ST205967_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST206014_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST205967_Layout __ND4661887__Project(B_Criminal_Offense_8(__in,__cfg).__ST207848_Layout __PP4661510) := TRANSFORM
    __EE4661670 := __PP4661510.Offense_Charges_;
    __ST206014_Layout __ND4661874__Project(B_Criminal_Offense_8(__in,__cfg).__ST207895_Layout __PP4661671) := TRANSFORM
      __CC14097 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP4661671.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP4661671.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14097)));
      SELF := __PP4661671;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE4661670,__ND4661874__Project(LEFT));
    SELF := __PP4661510;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE4661509,__ND4661887__Project(LEFT));
END;
