...
IMPORT KEL16 AS KEL;
IMPORT B_Criminal_Offense_8,CFG_Compile,E_Criminal_Offense FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1068096 := __ENH_Criminal_Offense_8;
  EXPORT __ST171867_Layout := RECORD
  ...
  END;
  EXPORT __ST171820_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST171867_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171820_Layout __ND1068474__Project(B_Criminal_Offense_8(__in,__cfg).__ST172762_Layout __PP1068097) := TRANSFORM
    __EE1068257 := __PP1068097.Offense_Charges_;
    __ST171867_Layout __ND1068461__Project(B_Criminal_Offense_8(__in,__cfg).__ST172809_Layout __PP1068258) := TRANSFORM
      __CC13923 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1068258.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1068258.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13923)));
      SELF := __PP1068258;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1068257,__ND1068461__Project(LEFT));
    SELF := __PP1068097;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE1068096,__ND1068474__Project(LEFT));
END;
