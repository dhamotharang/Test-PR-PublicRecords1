...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Property_2,B_Person_Property_7,B_Property_2,B_Property_3,CFG_Compile,E_Person,E_Person_Property,E_Person_Property_Event,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8220430 := __ENH_Person_Property_2;
  SHARED __EE8220433 := __ENH_Property_2;
  SHARED __ST2964989_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST188361_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC8220441(B_Person_Property_2(__in,__cfg).__ST188006_Layout __EE8220430, B_Property_2(__in,__cfg).__ST188343_Layout __EE8220433) := __EEQP(__EE8220430.Prop_,__EE8220433.UID);
  __ST2964989_Layout __JT8220441(B_Person_Property_2(__in,__cfg).__ST188006_Layout __l, B_Property_2(__in,__cfg).__ST188343_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE8220442 := JOIN(__EE8220430,__EE8220433,__JC8220441(LEFT,RIGHT),__JT8220441(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST179273_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST179273_Layout __ND8220565__Project(__ST2964989_Layout __PP8220443) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP8220443.Is_Business_Address_ AND __PP8220443.Is_Ever_Owned_;
    SELF := __PP8220443;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE8220442,__ND8220565__Project(LEFT));
END;
