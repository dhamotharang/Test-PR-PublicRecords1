...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6416186 := __ENH_Person_Property_2;
  SHARED __EE6416189 := __ENH_Property_2;
  SHARED __ST2319311_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST179715_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC6416197(B_Person_Property_2(__in,__cfg).__ST179360_Layout __EE6416186, B_Property_2(__in,__cfg).__ST179697_Layout __EE6416189) := __EEQP(__EE6416186.Prop_,__EE6416189.UID);
  __ST2319311_Layout __JT6416197(B_Person_Property_2(__in,__cfg).__ST179360_Layout __l, B_Property_2(__in,__cfg).__ST179697_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE6416198 := JOIN(__EE6416186,__EE6416189,__JC6416197(LEFT,RIGHT),__JT6416197(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST171482_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171482_Layout __ND6416321__Project(__ST2319311_Layout __PP6416199) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP6416199.Is_Business_Address_ AND __PP6416199.Is_Ever_Owned_;
    SELF := __PP6416199;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE6416198,__ND6416321__Project(LEFT));
END;
