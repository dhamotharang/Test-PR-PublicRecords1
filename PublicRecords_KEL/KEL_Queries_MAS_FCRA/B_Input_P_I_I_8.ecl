...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE219647 := __E_Input_P_I_I;
  EXPORT __ST179189_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST179189_Layout __ND1075598__Project(E_Input_P_I_I(__in,__cfg).Layout __PP218969) := TRANSFORM
    __CC13689 := '-99998';
    __CC13684 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP218969.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13689)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP218969.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,__PP218969.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13689)))));
    SELF := __PP218969;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE219647,__ND1075598__Project(LEFT));
END;
