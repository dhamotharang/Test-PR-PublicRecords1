...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE213686 := __E_Input_P_I_I;
  EXPORT __ST173246_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST173246_Layout __ND1068660__Project(E_Input_P_I_I(__in,__cfg).Layout __PP213008) := TRANSFORM
    __CC13464 := '-99998';
    __CC13459 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP213008.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13464)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP213008.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13459)),__ECAST(KEL.typ.nstr,__PP213008.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13464)))));
    SELF := __PP213008;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE213686,__ND1068660__Project(LEFT));
END;
