...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE214114 := __E_Input_P_I_I;
  ...
  END;
  SHARED __ST173808_Layout __ND1063912__Project(E_Input_P_I_I(__in,__cfg).Layout __PP213436) := TRANSFORM
    __CC13497 := '-99998';
    __CC13492 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP213436.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13497)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP213436.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13492)),__ECAST(KEL.typ.nstr,__PP213436.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13497)))));
    SELF := __PP213436;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE214114,__ND1063912__Project(LEFT));
END;
