...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE216024 := __E_Input_P_I_I;
  EXPORT __ST175584_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST175584_Layout __ND1071484__Project(E_Input_P_I_I(__in,__cfg).Layout __PP215346) := TRANSFORM
    __CC13680 := '-99998';
    __CC13675 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP215346.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13680)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP215346.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13675)),__ECAST(KEL.typ.nstr,__PP215346.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13680)))));
    SELF := __PP215346;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE216024,__ND1071484__Project(LEFT));
END;
