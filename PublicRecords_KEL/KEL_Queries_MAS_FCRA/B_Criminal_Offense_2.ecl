...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1254460 := __ENH_Criminal_Offense_3;
  EXPORT __ST160136_Layout := RECORD
  ...
  END;
  EXPORT __ST160089_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST160136_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160089_Layout __ND1254882__Project(B_Criminal_Offense_3(__in,__cfg).__ST163944_Layout __PP1254461) := TRANSFORM
    __EE1254621 := __PP1254461.Offense_Charges_;
    __ST160136_Layout __ND1254864__Project(B_Criminal_Offense_3(__in,__cfg).__ST163991_Layout __PP1254622) := TRANSFORM
      SELF.Is_Non_Felony_Records_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP1254622.Dismissed_Charges_),__OP2(__PP1254622.Offense_Score_,=,__CN('M'))),__OP2(__PP1254622.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP1254622.Traffic_Flag_,=,__CN('N')));
      SELF := __PP1254622;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1254621,__ND1254864__Project(LEFT));
    SELF := __PP1254461;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE1254460,__ND1254882__Project(LEFT));
END;
