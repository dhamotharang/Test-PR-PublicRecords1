...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Inquiry_5,CFG_Compile,E_Inquiry,E_Person,E_Person_Inquiry FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4099348 := __ENH_Person_Inquiry_5;
  EXPORT __ST432691_Layout := RECORD
  ...
  EXPORT __ST189139_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST189139_Layout __ND4099334__Project(B_Person_Inquiry_5(__in,__cfg).__ST192018_Layout __PP4099048) := TRANSFORM
    __EE4099332 := __PP4099048.Gather_Inquiries_;
    __ST432691_Layout __ND4099283__Project(B_Person_Inquiry_5(__in,__cfg).__ST343316_Layout __PP4099073) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP4099073.Is_Banking_ OR __PP4099073.Is_Auto_Srch_ OR __PP4099073.Is_Retail_ OR __PP4099073.Is_Mortgage_ OR __PP4099073.Is_Utility_ OR __PP4099073.Is_Prepaid_Card_ OR __PP4099073.Is_Communications_ OR __PP4099073.Is_Student_Loan_ OR __PP4099073.Is_Retail_Payment_ OR __PP4099073.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP4099073.Valid_Inquiries_,__CN(__PP4099073.Is_Retail_));
      SELF := __PP4099073;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE4099332,__ND4099283__Project(LEFT));
    SELF := __PP4099048;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE4099348,__ND4099334__Project(LEFT));
END;
