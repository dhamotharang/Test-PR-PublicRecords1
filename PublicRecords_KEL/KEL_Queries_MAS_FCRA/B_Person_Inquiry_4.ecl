...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4874804 := __ENH_Person_Inquiry_5;
  EXPORT __ST491865_Layout := RECORD
  ...
  EXPORT __ST199331_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST491865_Layout) Gather_Inquiries_;
    KEL.typ.timestamp Archive___Date_ := 0;
    KEL.typ.timestamp Date_First_Seen_ := 0;
    KEL.typ.timestamp Date_Last_Seen_ := 0;
    KEL.typ.timestamp Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST199331_Layout __ND4874790__Project(B_Person_Inquiry_5(__in,__cfg).__ST202713_Layout __PP4874504) := TRANSFORM
    __EE4874788 := __PP4874504.Gather_Inquiries_;
    __ST491865_Layout __ND4874739__Project(B_Person_Inquiry_5(__in,__cfg).__ST393212_Layout __PP4874529) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP4874529.Is_Banking_ OR __PP4874529.Is_Auto_Srch_ OR __PP4874529.Is_Retail_ OR __PP4874529.Is_Mortgage_ OR __PP4874529.Is_Utility_ OR __PP4874529.Is_Prepaid_Card_ OR __PP4874529.Is_Communications_ OR __PP4874529.Is_Student_Loan_ OR __PP4874529.Is_Retail_Payment_ OR __PP4874529.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP4874529.Valid_Inquiries_,__CN(__PP4874529.Is_Retail_));
      SELF := __PP4874529;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE4874788,__ND4874739__Project(LEFT));
    SELF := __PP4874504;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE4874804,__ND4874790__Project(LEFT));
END;
