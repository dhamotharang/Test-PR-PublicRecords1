...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Inquiry_3,CFG_Compile,E_Inquiry,E_Person,E_Person_Inquiry FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Inquiry_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5409190 := __ENH_Person_Inquiry_3;
  EXPORT __ST179070_Layout := RECORD
  ...
  END;
  EXPORT __ENH_Person_Inquiry_2 := PROJECT(__EE5409190,__ST179070_Layout);
END;
