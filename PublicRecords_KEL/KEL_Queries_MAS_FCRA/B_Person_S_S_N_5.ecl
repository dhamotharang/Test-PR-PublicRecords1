...
EXPORT B_Person_S_S_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4761013 := __ENH_Person_S_S_N_6;
  EXPORT __ST246896_Layout := RECORD
  ...
  END;
  EXPORT __ST246888_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST246896_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246888_Layout __ND4761018__Project(B_Person_S_S_N_6(__in,__cfg).__ST246845_Layout __PP4761014) := TRANSFORM
    __EE4761033 := __PP4761014.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4761033),__ST246896_Layout),__NL(__EE4761033));
    SELF := __PP4761014;
  END;
  EXPORT __ENH_Person_S_S_N_5 := PROJECT(__EE4761013,__ND4761018__Project(LEFT));
END;
