...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_13,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
IMPORT * FROM KEL15.Null;
EXPORT B_Input_P_I_I_12(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4634667 := __ENH_Input_P_I_I_13;
  EXPORT __ST213426_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST213426_Layout __ND4635305__Project(B_Input_P_I_I_13(__in,__cfg).__ST212586_Layout __PP4634668) := TRANSFORM
    __CC13660 := '-99999';
    __CC13665 := '-99998';
    SELF.Input_Address_Suffix_Clean_Value_ := MAP(__PP4634668.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4634668.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Sffx_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_City_Post_Clean_Value_ := MAP(__T(__AND(__CN(__PP4634668.P___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP4634668.Addr_Not_Populated_),__PP4634668.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__AND(__CN(__PP4634668.P___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP4634668.Addr_Not_Populated_),__PP4634668.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_City_Post_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Pre_Direction_Clean_Value_ := MAP(__PP4634668.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4634668.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Pre_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Primary_Name_Clean_Value_ := MAP(__PP4634668.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4634668.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Prim_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Primary_Range_Clean_Value_ := MAP(__PP4634668.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4634668.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Prim_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Secondary_Range_Clean_Value_ := MAP(__PP4634668.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__PP4634668.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Sec_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP4634668.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP4634668.Addr_Not_Populated_),__PP4634668.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13660)),__T(__AND(__CN(__PP4634668.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP4634668.Addr_Not_Populated_),__PP4634668.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4634668.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))));
    SELF := __PP4634668;
  END;
  EXPORT __ENH_Input_P_I_I_12 := PROJECT(__EE4634667,__ND4635305__Project(LEFT));
END;
