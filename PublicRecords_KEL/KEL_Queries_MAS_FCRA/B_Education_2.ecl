...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1262365 := __ENH_Education_3;
  EXPORT __ST178455_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST178455_Layout __ND1262497__Project(B_Education_7(__in,__cfg).__ST166794_Layout __PP1262366) := TRANSFORM
    __BS1262408 := __T(__PP1262366.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS1262408(__T(__OP2(__T(__PP1262366.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP1262366;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE1262365,__ND1262497__Project(LEFT));
END;
