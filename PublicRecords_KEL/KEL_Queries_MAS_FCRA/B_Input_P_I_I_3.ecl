...
IMPORT KEL15 AS KEL;
IMPORT B_Input_P_I_I_4,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code,FN_Compile FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4109470 := __ENH_Input_P_I_I_4;
  EXPORT __ST181090_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST181090_Layout __ND4110067__Project(B_Input_P_I_I_4(__in,__cfg).__ST186485_Layout __PP4109471) := TRANSFORM
    SELF.Addr_Not_Populated_ := FN_Compile(__cfg).FN_Is_Not_Enough_To_Clean(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_));
    SELF.City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_City_),__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_State_),__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_Zip_));
    __CC13592 := '-99998';
    __CC13587 := '-99999';
    SELF.Input_First_Name_Clean_Value_ := MAP(__PP4109471.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13592)),__ECAST(KEL.typ.nstr,IF(__PP4109471.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13587)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Cln_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13592)))))));
    SELF.Input_Last_Name_Clean_Value_ := MAP(__PP4109471.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13592)),__ECAST(KEL.typ.nstr,IF(__PP4109471.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13587)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Cln_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13592)))))));
    SELF.P___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_State_));
    SELF.P___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP4109471.P___Inp_Addr_Zip_));
    SELF := __PP4109471;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE4109470,__ND4110067__Project(LEFT));
END;
