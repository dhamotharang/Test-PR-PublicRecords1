...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4884983 := __ENH_Input_P_I_I_4;
  EXPORT __ST190118_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST190118_Layout __ND4885640__Project(B_Input_P_I_I_4(__in,__cfg).__ST196369_Layout __PP4884984) := TRANSFORM
    __CC13665 := '-99998';
    __CC13660 := '-99999';
    SELF.Input_First_Name_Clean_Value_ := MAP(__PP4884984.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,IF(__PP4884984.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13660)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4884984.P___Inp_Cln_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))))));
    SELF.Input_Last_Name_Clean_Value_ := MAP(__PP4884984.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13665)),__ECAST(KEL.typ.nstr,IF(__PP4884984.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13660)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP4884984.P___Inp_Cln_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13665)))))));
    SELF := __PP4884984;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE4884983,__ND4885640__Project(LEFT));
END;
