...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1169497 := __ENH_Input_P_I_I_4;
  EXPORT __ST165974_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST165974_Layout __ND1170089__Project(B_Input_P_I_I_4(__in,__cfg).__ST182097_Layout __PP1169498) := TRANSFORM
    SELF.Addr_Not_Populated_ := FN_Compile(__cfg).FN_Is_Not_Enough_To_Clean(__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Addr_));
    SELF.City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Addr_City_),__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Addr_State_),__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Addr_Zip_));
    __CC13464 := '-99998';
    __CC13459 := '-99999';
    SELF.Input_First_Name_Clean_Value_ := MAP(__PP1169498.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13464)),__ECAST(KEL.typ.nstr,IF(__PP1169498.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13459)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Cln_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13464)))))));
    SELF.Input_Last_Name_Clean_Value_ := MAP(__PP1169498.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13464)),__ECAST(KEL.typ.nstr,IF(__PP1169498.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13459)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Cln_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13464)))))));
    SELF.P___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1169498.P___Inp_Addr_Zip_));
    SELF := __PP1169498;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE1169497,__ND1170089__Project(LEFT));
END;
