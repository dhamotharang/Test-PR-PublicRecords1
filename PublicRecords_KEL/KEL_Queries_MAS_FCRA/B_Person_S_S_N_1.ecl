...
EXPORT B_Person_S_S_N_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6416967 := __ENH_Person_S_S_N_2;
  EXPORT __ST171567_Layout := RECORD
  ...
  END;
  EXPORT __ST171559_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST171567_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171559_Layout __ND6416972__Project(B_Person_S_S_N_2(__in,__cfg).__ST223653_Layout __PP6416968) := TRANSFORM
    __EE6416988 := __PP6416968.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6416988),__ST171567_Layout),__NL(__EE6416988));
    SELF := __PP6416968;
  END;
  EXPORT __ENH_Person_S_S_N_1 := PROJECT(__EE6416967,__ND6416972__Project(LEFT));
END;
