...
IMPORT KEL16 AS KEL;
IMPORT B_Input_P_I_I_2,CFG_Compile,E_Address,E_Address_Slim,E_Address_Summary,E_Email,E_Geo_Link,E_Name_Summary,E_Person,E_Phone,E_Phone_Summary,E_Property,E_S_S_N_Summary,E_Social_Security_Number,E_Surname,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Input_P_I_I_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1537566 := __ENH_Input_P_I_I_2;
  EXPORT __ST156321_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST156321_Layout __ND1537571__Project(B_Input_P_I_I_2(__in,__cfg).__ST161106_Layout __PP1537567) := TRANSFORM
    ...
    __CC13537 := '-99999';
    __CC13542 := '-99998';
    SELF.P___Inp_Cln_Arch_Dt_F1_Y_ := MAP(__PP1537567.P___Inp_Cln_Arch_Dt_Flag_Value_ <> '1'=>__CC13537,__PP1537567.C_U_R_R_E_N_T___D_A_T_E__1_Y_E_A_R_S_ > KEL.Routines.Today()=>__CC13542,KEL.Routines.DateToString(__PP1537567.C_U_R_R_E_N_T___D_A_T_E__1_Y_E_A_R_S_,'%Y%m%d'));
    SELF := __PP1537567;
  END;
  EXPORT __ENH_Input_P_I_I_1 := PROJECT(__EE1537566,__ND1537571__Project(LEFT));
END;
