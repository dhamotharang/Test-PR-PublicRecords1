...
EXPORT B_Property_Event_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1102811 := __ENH_Property_Event_7;
  EXPORT __ST171815_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST171815_Layout __ND1103165__Project(B_Property_Event_7(__in,__cfg).__ST172746_Layout __PP1102812) := TRANSFORM
    ...
    SELF.Is_Current_Assessment_Record_ := __AND(__PP1102812.Is_Assessment_,__OP2(FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,KEL.era.ToDate(__PP1102812.Date_First_Seen_)),__ECAST(KEL.typ.nkdate,__CC13202)),<=,__CN(1)));
    ...
    SELF.Property_Purchase_Record_ := __OR(__OP2(__PP1102812.Document_Type_Code_,IN,__CN(__CC72814)),__OP2(__PP1102812.Sale_Price_,>,__CN(0)));
    SELF := __PP1102812;
  END;
  EXPORT __ENH_Property_Event_6 := PROJECT(__EE1102811,__ND1103165__Project(LEFT));
END;
