...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1085271 := __ENH_Property_Event_8;
  ...
  END;
  SHARED __ST173353_Layout __ND1085276__Project(B_Property_Event_8(__in,__cfg).__ST174377_Layout __PP1085272) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1085272.Date_Last_Seen_);
    SELF := __PP1085272;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1085271,__ND1085276__Project(LEFT));
END;
