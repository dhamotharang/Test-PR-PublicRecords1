...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1093320 := __ENH_Property_Event_8;
  EXPORT __ST174561_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST174561_Layout __ND1093325__Project(B_Property_Event_8(__in,__cfg).__ST175392_Layout __PP1093321) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1093321.Date_Last_Seen_);
    SELF := __PP1093321;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1093320,__ND1093325__Project(LEFT));
END;
