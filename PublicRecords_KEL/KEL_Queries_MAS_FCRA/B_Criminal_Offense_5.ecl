...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1110682 := __ENH_Criminal_Offense_6;
  EXPORT __ST175037_Layout := RECORD
  ...
  EXPORT __ST174990_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST175037_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174990_Layout __ND1111097__Project(B_Criminal_Offense_6(__in,__cfg).__ST176856_Layout __PP1110683) := TRANSFORM
    __EE1110843 := __PP1110683.Offense_Charges_;
    __ST175037_Layout __ND1111080__Project(B_Criminal_Offense_6(__in,__cfg).__ST176903_Layout __PP1110844) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1110844.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13339));
      SELF.Is_Criminal_Count_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP1110844.Dismissed_Charges_),__OP2(__PP1110844.Offense_Score_,IN,__CN(['M','F']))),__OP2(__PP1110844.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP1110844.Traffic_Flag_,=,__CN('N')));
      SELF := __PP1110844;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1110843,__ND1111080__Project(LEFT));
    SELF := __PP1110683;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE1110682,__ND1111097__Project(LEFT));
END;
