...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4723398 := __ENH_Criminal_Offense_6;
  ...
  END;
  EXPORT __ST200293_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST200340_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200293_Layout __ND4723819__Project(B_Criminal_Offense_6(__in,__cfg).__ST203488_Layout __PP4723399) := TRANSFORM
    __EE4723559 := __PP4723399.Offense_Charges_;
    __ST200340_Layout __ND4723801__Project(B_Criminal_Offense_6(__in,__cfg).__ST203535_Layout __PP4723560) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP4723560.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13315));
      SELF.Is_Criminal_Count_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP4723560.Dismissed_Charges_),__OP2(__PP4723560.Offense_Score_,IN,__CN(['M','F']))),__OP2(__PP4723560.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP4723560.Traffic_Flag_,=,__CN('N')));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP4723560.Dismissed_Charges_);
      SELF := __PP4723560;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE4723559,__ND4723801__Project(LEFT));
    SELF := __PP4723399;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE4723398,__ND4723819__Project(LEFT));
END;
