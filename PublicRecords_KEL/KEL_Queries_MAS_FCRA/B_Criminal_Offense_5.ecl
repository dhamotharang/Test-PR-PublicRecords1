...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3968010 := __ENH_Criminal_Offense_6;
  EXPORT __ST190138_Layout := RECORD
  ...
  END;
  EXPORT __ST190091_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST190138_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190091_Layout __ND3968431__Project(B_Criminal_Offense_6(__in,__cfg).__ST192793_Layout __PP3968011) := TRANSFORM
    __EE3968171 := __PP3968011.Offense_Charges_;
    __ST190138_Layout __ND3968413__Project(B_Criminal_Offense_6(__in,__cfg).__ST192840_Layout __PP3968172) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP3968172.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13242));
      SELF.Is_Criminal_Count_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP3968172.Dismissed_Charges_),__OP2(__PP3968172.Offense_Score_,IN,__CN(['M','F']))),__OP2(__PP3968172.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP3968172.Traffic_Flag_,=,__CN('N')));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP3968172.Dismissed_Charges_);
      SELF := __PP3968172;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE3968171,__ND3968413__Project(LEFT));
    SELF := __PP3968011;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE3968010,__ND3968431__Project(LEFT));
END;
