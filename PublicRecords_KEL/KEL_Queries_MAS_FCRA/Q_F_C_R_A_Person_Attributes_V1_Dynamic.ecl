...
IMPORT B_Address_2,B_Address_3,B_Address_Property_3,B_Address_Property_4,B_Address_Property_5,B_Aircraft_Owner_1,B_Aircraft_Owner_2,B_Aircraft_Owner_3,B_Bankruptcy_1,B_Bankruptcy_2,B_Bankruptcy_3,B_Bankruptcy_4,B_Bankruptcy_5,B_Bankruptcy_6,B_Bankruptcy_7,B_Bankruptcy_8,B_Bankruptcy_9,B_Criminal_Offense_1,B_Criminal_Offense_2,B_Criminal_Offense_3,B_Criminal_Offense_4,B_Criminal_Offense_5,B_Criminal_Offense_6,B_Criminal_Offense_7,B_Criminal_Offense_8,B_Education_1,B_Education_2,B_Education_3,B_Education_4,B_Education_5,B_Education_6,B_Education_7,B_Education_8,B_Email_2,B_Email_3,B_Input_P_I_I_1,B_Input_P_I_I_10,B_Input_P_I_I_11,B_Input_P_I_I_12,B_Input_P_I_I_13,B_Input_P_I_I_14,B_Input_P_I_I_2,B_Input_P_I_I_3,B_Input_P_I_I_4,B_Input_P_I_I_5,B_Input_P_I_I_6,B_Input_P_I_I_7,B_Input_P_I_I_8,B_Input_P_I_I_9,B_Inquiry_10,B_Inquiry_11,B_Inquiry_3,B_Inquiry_4,B_Inquiry_5,B_Inquiry_6,B_Inquiry_7,B_Inquiry_8,B_Inquiry_9,B_Lien_Judgment_14,B_Person,B_Person_1,B_Person_10,B_Person_11,B_Person_12,B_Person_2,B_Person_3,B_Person_4,B_Person_5,B_Person_6,B_Person_7,B_Person_8,B_Person_9,B_Person_Accident_8,B_Person_Address_10,B_Person_Address_3,B_Person_Address_4,B_Person_Address_5,B_Person_Address_6,B_Person_Address_7,B_Person_Address_8,B_Person_Address_9,B_Person_Inquiry_3,B_Person_Inquiry_4,B_Person_Inquiry_5,B_Person_Inquiry_6,B_Person_Inquiry_7,B_Person_Inquiry_8,B_Person_Lien_Judgment_13,B_Person_Property_1,B_Person_Property_2,B_Person_Property_3,B_Person_Property_4,B_Person_Property_5,B_Person_Property_6,B_Person_Property_7,B_Person_Property_8,B_Person_S_S_N_1,B_Person_S_S_N_2,B_Person_S_S_N_3,B_Person_S_S_N_4,B_Person_S_S_N_5,B_Person_S_S_N_6,B_Person_S_S_N_7,B_Person_Vehicle_1,B_Person_Vehicle_2,B_Person_Vehicle_3,B_Professional_License_1,B_Professional_License_2,B_Professional_License_3,B_Professional_License_4,B_Professional_License_5,B_Property_2,B_Property_3,B_Property_4,B_Property_Event_1,B_Property_Event_2,B_Property_Event_3,B_Property_Event_4,B_Property_Event_5,B_Property_Event_6,B_Property_Event_7,B_Property_Event_8,B_Sele_Person_1,B_Sele_Person_2,B_Sele_Person_3,B_Watercraft_Owner_1,B_Watercraft_Owner_2,B_Watercraft_Owner_3,CFG_Compile,E_Accident,E_Address,E_Address_Inquiry,E_Address_Property,E_Address_Slim,E_Address_Summary,E_Aircraft,E_Aircraft_Owner,E_Bankruptcy,E_Criminal_Offense,E_Education,E_Email,E_Geo_Link,E_Household,E_Household_Member,E_Input_P_I_I,E_Inquiry,E_Lien_Judgment,E_Name_Summary,E_Person,E_Person_Accident,E_Person_Address,E_Person_Bankruptcy,E_Person_Education,E_Person_Email,E_Person_Inquiry,E_Person_Lien_Judgment,E_Person_Offenses,E_Person_Property,E_Person_Property_Event,E_Person_S_S_N,E_Person_Vehicle,E_Phone,E_Phone_Summary,E_Professional_License,E_Professional_License_Person,E_Property,E_Property_Event,E_S_S_N_Summary,E_Sele_Person,E_Social_Security_Number,E_Surname,E_Utility,E_Utility_Person,E_Vehicle,E_Watercraft,E_Watercraft_Owner,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  END;
  SHARED B_Person_Address_10_Local := MODULE(B_Person_Address_10(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_11(__in,__cfg_Local).__ENH_Person_11) __ENH_Person_11 := B_Person_11_Local.__ENH_Person_11;
  ...
  END;
  SHARED B_Person_Address_9_Local := MODULE(B_Person_Address_9(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_10(__in,__cfg_Local).__ENH_Person_10) __ENH_Person_10 := B_Person_10_Local.__ENH_Person_10;
    SHARED TYPEOF(B_Person_Address_10(__in,__cfg_Local).__ENH_Person_Address_10) __ENH_Person_Address_10 := B_Person_Address_10_Local.__ENH_Person_Address_10;
  END;
  ...
  SHARED B_Person_8_Local := MODULE(B_Person_8(__in,__cfg_Local))
    ...
    SHARED TYPEOF(B_Person_Address_9(__in,__cfg_Local).__ENH_Person_Address_9) __ENH_Person_Address_9 := B_Person_Address_9_Local.__ENH_Person_Address_9;
  END;
  ...
  END;
  SHARED B_Person_Address_8_Local := MODULE(B_Person_Address_8(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_9(__in,__cfg_Local).__ENH_Person_Address_9) __ENH_Person_Address_9 := B_Person_Address_9_Local.__ENH_Person_Address_9;
  END;
  ...
  END;
  SHARED B_Person_Address_7_Local := MODULE(B_Person_Address_7(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_8(__in,__cfg_Local).__ENH_Person_Address_8) __ENH_Person_Address_8 := B_Person_Address_8_Local.__ENH_Person_Address_8;
  END;
  ...
  END;
  SHARED B_Person_Address_6_Local := MODULE(B_Person_Address_6(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_7(__in,__cfg_Local).__ENH_Person_Address_7) __ENH_Person_Address_7 := B_Person_Address_7_Local.__ENH_Person_Address_7;
  END;
  ...
  SHARED B_Person_5_Local := MODULE(B_Person_5(__in,__cfg_Local))
    ...
    SHARED TYPEOF(B_Person_Address_6(__in,__cfg_Local).__ENH_Person_Address_6) __ENH_Person_Address_6 := B_Person_Address_6_Local.__ENH_Person_Address_6;
    SHARED TYPEOF(E_Person_Bankruptcy(__in,__cfg_Local).__Result) __E_Person_Bankruptcy := E_Person_Bankruptcy_Filtered.__Result;
  END;
  SHARED B_Person_Address_5_Local := MODULE(B_Person_Address_5(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_6(__in,__cfg_Local).__ENH_Person_Address_6) __ENH_Person_Address_6 := B_Person_Address_6_Local.__ENH_Person_Address_6;
  END;
  ...
  SHARED B_Person_4_Local := MODULE(B_Person_4(__in,__cfg_Local))
    ...
    SHARED TYPEOF(B_Person_Address_5(__in,__cfg_Local).__ENH_Person_Address_5) __ENH_Person_Address_5 := B_Person_Address_5_Local.__ENH_Person_Address_5;
    SHARED TYPEOF(E_Person_Bankruptcy(__in,__cfg_Local).__Result) __E_Person_Bankruptcy := E_Person_Bankruptcy_Filtered.__Result;
  ...
  END;
  SHARED B_Person_Address_4_Local := MODULE(B_Person_Address_4(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_5(__in,__cfg_Local).__ENH_Person_Address_5) __ENH_Person_Address_5 := B_Person_Address_5_Local.__ENH_Person_Address_5;
  END;
  ...
  SHARED B_Person_Address_3_Local := MODULE(B_Person_Address_3(__in,__cfg_Local))
    SHARED TYPEOF(B_Person_Address_4(__in,__cfg_Local).__ENH_Person_Address_4) __ENH_Person_Address_4 := B_Person_Address_4_Local.__ENH_Person_Address_4;
  END;
  ...
  SHARED __EE10433030 := __ENH_Person;
  SHARED __EE10440289 := __EE10433030(__T(__OP2(__EE10433030.UID,=,__CN(__PLexID_in))));
  SHARED __ST94902_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST89595_Layout) Crim_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89616_Layout) Banko_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89639_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89662_Layout) L_T_D7_Y_List_;
  ...
  END;
  SHARED __ST94902_Layout __ND10440294__Project(B_Person(__in,__cfg_Local).__ST163497_Layout __PP10440290) := TRANSFORM
    SELF.Lex_I_D_ := __PP10440290.UID;
    SELF.P___Lex_I_D_Seen_Flag_ := __PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_;
    __CC14174 := '-99999';
    SELF.P___Lex_I_D_Is_Deceased_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P___Lex_I_D_Is_Deceased_Flag_);
    __CC14172 := -99999;
    SELF.P_L___Ast_Veh_Air_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Veh_Air_Cnt_Ev_);
    SELF.P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Air_Emrg_New_Dt_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Air_Emrg_Old_Dt_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_New_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Veh_Air_Emrg_New_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_Old_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Veh_Air_Emrg_Old_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Veh_Wtr_Cnt_Ev_);
    SELF.P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Wtr_Emrg_New_Dt_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Veh_Wtr_Emrg_Old_Dt_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_New_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Veh_Wtr_Emrg_New_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_Old_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Veh_Wtr_Emrg_Old_Msnc_Ev_));
    SELF.P_L___Drg_Crim_Fel_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Fel_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Fel_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Fel_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Fel_New_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Fel_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Fel_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Fel_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Fel_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Fel_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Fel_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Fel_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Fel_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Nfel_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Nfel_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Nfel_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Nfel_New_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Nfel_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Nfel_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Nfel_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Nfel_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Nfel_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Nfel_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Nfel_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Nfel_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Crim_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_New_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Crim_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Severity_Indx7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Severity_Indx7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Behavior_Indx7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Crim_Behavior_Indx7_Y_F_C_R_A_));
    SELF.P_L___Drg_Bk_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dt_List1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Dt_List1_Y_));
    SELF.P_L___Drg_Bk_Dt_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Dt_List7_Y_));
    SELF.P_L___Drg_Bk_Dt_List10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Dt_List10_Y_));
    SELF.P_L___Drg_Bk_New_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Dt1_Y_));
    SELF.P_L___Drg_Bk_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Dt7_Y_));
    SELF.P_L___Drg_Bk_New_Dt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Dt10_Y_));
    SELF.P_L___Drg_Bk_Old_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Old_Dt1_Y_));
    SELF.P_L___Drg_Bk_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Old_Dt7_Y_));
    SELF.P_L___Drg_Bk_Old_Dt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Old_Dt10_Y_));
    SELF.P_L___Drg_Bk_New_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_New_Msnc1_Y_));
    SELF.P_L___Drg_Bk_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_New_Msnc7_Y_));
    SELF.P_L___Drg_Bk_New_Msnc10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_New_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_Old_Msnc1_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_Old_Msnc7_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Bk_Old_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Ch_List1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Ch_List1_Y_));
    SELF.P_L___Drg_Bk_Ch_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Ch_List7_Y_));
    SELF.P_L___Drg_Bk_Ch_List10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Ch_List10_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Ch_Type1_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Ch_Type7_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Ch_Type10_Y_));
    SELF.P_L___Drg_Bk_Ch7_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch7_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Ch7_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch7_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Ch7_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch7_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch13_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch13_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Ch13_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Updt_New_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Dt1_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Dt7_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Dt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Dt10_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Msnc1_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Msnc7_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Updt_New_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Disp_List1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Disp_List1_Y_));
    SELF.P_L___Drg_Bk_Disp_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Disp_List7_Y_));
    SELF.P_L___Drg_Bk_Disp_List10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Disp_List10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Type1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Type7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Type10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Dt1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Dt7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Dt10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Msnc1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Msnc7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_New_Disp_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Disp_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Disp_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Disp_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Disp_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Disp_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Disp_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsms_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsms_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsms_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsch_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsch_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Bk_Dsch_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Type_List1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Type_List1_Y_));
    SELF.P_L___Drg_Bk_Type_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Type_List7_Y_));
    SELF.P_L___Drg_Bk_Type_List10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Type_List10_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Bus_Flag1_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Bus_Flag7_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Bk_Bus_Flag10_Y_));
    SELF.P_L___Drg_Bk_Severity_Indx10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Drg_Bk_Severity_Indx10_Y_);
    SELF.P_L___Prof_Lic_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prof_Lic_Flag_Ev_);
    SELF.P_L___Prof_Lic_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Prof_Lic_Cnt_Ev_);
    SELF.P_L___Prof_Lic_Issue_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Issue_Dt_List_Ev_));
    SELF.P_L___Prof_Lic_Exp_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Exp_Dt_List_Ev_));
    SELF.P_L___Prof_Lic_Indx_By_Lic_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Indx_By_Lic_List_Ev_));
    SELF.P_L___Prof_Lic_Actv_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prof_Lic_Actv_Flag_);
    SELF.P_L___Prof_Lic_Actv_New_Issue_Dt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Issue_Dt_));
    SELF.P_L___Prof_Lic_Actv_New_Exp_Dt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Exp_Dt_));
    SELF.P_L___Prof_Lic_Actv_New_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Type_));
    SELF.P_L___Prof_Lic_Actv_New_Title_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Title_Type_));
    SELF.P_L___Prof_Lic_Actv_New_Indx_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Indx_));
    SELF.P_L___Prof_Lic_Actv_New_Src_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prof_Lic_Actv_New_Src_Type_));
    SELF.P_L___Curr_Addr_Full_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Full_);
    SELF.P_L___Curr_Addr_Loc_I_D_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Curr_Addr_Loc_I_D_));
    SELF.P_L___Prev_Addr_Full_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Full_);
    SELF.P_L___Prev_Addr_Loc_I_D_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Prev_Addr_Loc_I_D_));
    SELF.P_L___Curr_Addr_Cnty_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Cnty_);
    SELF.P_L___Curr_Addr_Geo_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Geo_);
    SELF.P_L___Curr_Addr_Lat_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Lat_);
    SELF.P_L___Curr_Addr_Lng_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Lng_);
    SELF.P_L___Curr_Addr_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Type_);
    SELF.P_L___Curr_Addr_Status_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Curr_Addr_Status_);
    SELF.P_L___Prev_Addr_Cnty_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Cnty_);
    SELF.P_L___Prev_Addr_Geo_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Geo_);
    SELF.P_L___Prev_Addr_Lat_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Lat_);
    SELF.P_L___Prev_Addr_Lng_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Lng_);
    SELF.P_L___Prev_Addr_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Type_);
    SELF.P_L___Prev_Addr_Status_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Prev_Addr_Status_);
    SELF.P_L___Curr_Addr_Is_Vacant_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Vacant_Flag_);
    SELF.P_L___Curr_Addr_Is_Throwback_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Throwback_Flag_);
    SELF.P_L___Curr_Addr_Seasonal_Type_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Seasonal_Type_);
    SELF.P_L___Curr_Addr_Is_D_N_D_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_D_N_D_Flag_);
    SELF.P_L___Curr_Addr_Is_College_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_College_Flag_);
    SELF.P_L___Curr_Addr_Is_C_M_R_A_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_C_M_R_A_Flag_);
    SELF.P_L___Curr_Addr_Is_Simp_Addr_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Simp_Addr_Flag_);
    SELF.P_L___Curr_Addr_Is_Drop_Delivery_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Drop_Delivery_Flag_);
    SELF.P_L___Curr_Addr_Is_Business_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Business_Flag_);
    SELF.P_L___Curr_Addr_Is_Multi_Unit_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Multi_Unit_Flag_);
    SELF.P_L___Curr_Addr_Is_Apt_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Curr_Addr_Is_Apt_Flag_);
    SELF.P_L___Addr_Hist_On_File_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Addr_Hist_On_File_Flag_);
    SELF.P_L___Addr_Emrg_Cnt3_M_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt3_M_);
    SELF.P_L___Addr_Emrg_Cnt6_M_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt6_M_);
    SELF.P_L___Addr_Emrg_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt1_Y_);
    SELF.P_L___Addr_Emrg_Cnt2_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt2_Y_);
    SELF.P_L___Addr_Emrg_Cnt3_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt3_Y_);
    SELF.P_L___Addr_Emrg_Cnt5_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt5_Y_);
    SELF.P_L___Addr_Emrg_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt7_Y_);
    SELF.P_L___Addr_Emrg_Cnt10_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt10_Y_);
    SELF.P_L___Addr_Emrg_Cnt15_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Addr_Emrg_Cnt15_Y_);
    SELF.P_L___Best_Name_First_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Best_Name_First_));
    SELF.P_L___Best_Name_Mid_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Best_Name_Mid_));
    SELF.P_L___Best_Name_Last_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Best_Name_Last_));
    SELF.P_L___Best_S_S_N_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Best_S_S_N_));
    SELF.P_L___Best_D_O_B_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Best_D_O_B_));
    SELF.P_L___Best_D_O_B_Age_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Best_D_O_B_Age_));
    SELF.P_L___Prev_Addr_Is_Simp_Addr_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Prev_Addr_Is_Simp_Addr_Flag_);
    SELF.P_L___Prev_Addr_Is_Business_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Prev_Addr_Is_Business_Flag_);
    SELF.P_L___Drg_Judg_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Judg_Cnt7_Y_);
    SELF.P_L___Drg_L_T_D_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_L_T_D_Cnt7_Y_);
    SELF.P_L___Drg_L_T_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_L_T_D_Cnt1_Y_);
    SELF.P_L___Drg_L_T_D_Amt_Tot7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_L_T_D_Amt_Tot7_Y_);
    SELF.P_L___Drg_L_T_D_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_L_T_D_New_Dt7_Y_));
    SELF.P_L___Drg_L_T_D_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_L_T_D_Old_Dt7_Y_));
    SELF.P_L___Drg_L_T_D_Amt_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_L_T_D_Amt_List7_Y_));
    SELF.P_L___Drg_L_T_D_Dt_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_L_T_D_Dt_List7_Y_));
    SELF.P_L___Drg_L_T_D_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_L_T_D_New_Msnc7_Y_));
    SELF.P_L___Drg_L_T_D_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_L_T_D_Old_Msnc7_Y_));
    SELF.P_L___Drg_Lien_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Lien_Cnt7_Y_);
    ...
    SELF.P_L___Drg_Ln_J_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Ln_J_Cnt7_Y_);
    SELF.P_L___Drg_Ln_J_Amt_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Ln_J_Amt_List7_Y_));
    SELF.P_L___Drg_Ln_J_Dt_List7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Ln_J_Dt_List7_Y_));
    SELF.P_L___Drg_Ln_J_New_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Ln_J_New_Dt7_Y_));
    SELF.P_L___Drg_Ln_J_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Ln_J_New_Msnc7_Y_));
    SELF.P_L___Drg_Ln_J_Old_Dt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Drg_Ln_J_Old_Dt7_Y_));
    SELF.P_L___Drg_Ln_J_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Ln_J_Old_Msnc7_Y_));
    SELF.P_L___Drg_Cnt7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Drg_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Old_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_New_Msnc7_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Drg_New_Msnc7_Y_F_C_R_A_));
    SELF.Crim_List_ := __PP10440290.Crim_List_F_C_R_A_;
    SELF.P_L___Edu_Rec_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Edu_Rec_Flag_Ev_);
    SELF.P_L___Edu_Src_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Src_List_Ev_));
    SELF.P_L___Edu_H_S_Rec_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Edu_H_S_Rec_Flag_Ev_);
    SELF.P_L___Edu_Coll_Rec_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Edu_Coll_Rec_Flag_Ev_);
    SELF.P_L___Edu_Coll_Src_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_Emrg_Dt_List_Ev_));
    SELF.P_L___Edu_Coll_Src_Last_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_Last_Dt_List_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_New_Rec_Old_Dt_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_New_Rec_New_Dt_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_Old_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_New_Rec_Old_Msnc_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_New_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Src_New_Rec_New_Msnc_Ev_));
    SELF.P_L___Edu_Coll_Rec_Span_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Edu_Coll_Rec_Span_Ev_));
    SELF.P_L___Email_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Email_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Email_Flag_Ev_F_C_R_A_));
    SELF.P_L___Email_Free_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Email_Free_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_I_S_P_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Email_I_S_P_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Edu_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Email_Edu_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Corp_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Email_Corp_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Ast_Prop_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Cnt_Ev_);
    SELF.P_L___Ast_Prop_New_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_New_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Old_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Old_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Curr_Cnt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Curr_Cnt_);
    SELF.P_L___Ast_Prop_Flag_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Flag_Ev_));
    SELF.P_L___Ast_Prop_Curr_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Curr_Flag_));
    SELF.P_L___Ast_Prop_Ownership_Indx_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Ownership_Indx_));
    SELF.P_L___Ast_Prop_Curr_W_Mkt_Val_Cnt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Curr_W_Mkt_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_Mkt_Val_List_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Curr_Mkt_Val_List_));
    SELF.P_L___Ast_Prop_Curr_W_Tax_Val_Cnt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Curr_W_Tax_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_Tax_Val_List_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Curr_Tax_Val_List_));
    SELF.P_L___Ast_Prop_Curr_Tax_Val_Tot_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Curr_Tax_Val_Tot_);
    SELF.P_L___Ast_Prop_Curr_W_A_V_M_Val_Cnt_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Curr_W_A_V_M_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_List_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Curr_A_V_M_Val_List_));
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_Tot_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Curr_A_V_M_Val_Tot_));
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_Avg_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nfloat,__CAST(KEL.typ.float,__CN(__CC14172))),__ECAST(KEL.typ.nfloat,__PP10440290.P_L___Ast_Prop_Curr_A_V_M_Val_Avg_));
    SELF.P_L___Ast_Prop_Purch_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Purch_Cnt_Ev_);
    SELF.P_L___Ast_Prop_Purch_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Purch_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Purch_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Purch_New_Dt_Ev_));
    SELF.P_L___Ast_Prop_Purch_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Purch_Old_Dt_Ev_));
    SELF.P_L___Ast_Prop_Purch_New_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Purch_New_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Purch_Old_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14172))),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Purch_Old_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Purch_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Purch_Cnt1_Y_);
    SELF.P_L___Ast_Prop_Purch_Cnt5_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Purch_Cnt5_Y_);
    SELF.P_L___Ast_Prop_Sale_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Sale_Cnt_Ev_);
    SELF.P_L___Ast_Prop_Sale_Amt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Sale_Amt_List_Ev_));
    SELF.P_L___Ast_Prop_Sale_Tot_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ast_Prop_Sale_Tot_Ev_);
    SELF.P_L___Ast_Prop_Sale_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Sale_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Sale_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Sale_New_Dt_Ev_));
    SELF.P_L___Ast_Prop_Sale_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ast_Prop_Sale_Old_Dt_Ev_));
    SELF.P_L___Ast_Prop_Sale_New_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Sale_New_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Sale_Old_Msnc_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ast_Prop_Sale_Old_Msnc_Ev_));
    SELF.P_L___Inq_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Inq_Per_Lex_I_D_Cnt1_Y_);
    SELF.P_L___Inq_S_S_N_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_S_S_N_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Addr_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Addr_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_L_Name_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_L_Name_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_F_Name_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_F_Name_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Phone_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Phone_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_D_O_B_Per_Lex_I_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_D_O_B_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_A_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_A_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_S_D_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_S_D_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_P_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_P_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_P_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_P_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_P_S_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_P_S_Cnt1_Y_));
    SELF.P_L___S_T_L_Cnt1_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___S_T_L_Cnt1_Y_));
    SELF.P_L___S_T_L_Cnt2_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___S_T_L_Cnt2_Y_));
    SELF.P_L___S_T_L_Cnt5_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___S_T_L_Cnt5_Y_));
    SELF.P_L___S_T_L_Dt_List5_Y_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___S_T_L_Dt_List5_Y_));
    SELF.P_L___Ver_Src_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14172,__PP10440290.P_L___Ver_Src_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Ver_Src_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Last_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Old_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Src_Old_Dt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_New_Dt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Src_New_Dt_Ev_F_C_R_A_));
    SELF.P___Lex_I_D_Rstd_Only_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P___Lex_I_D_Rstd_Only_Flag_F_C_R_A_);
    SELF.P_L___Ver_Name_First_Src_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ver_Name_First_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_First_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ver_Name_Last_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_Last_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Cnt_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Ver_S_S_N_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_S_S_N_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14174)),__ECAST(KEL.typ.nstr,__PP10440290.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Alrt_Corrected_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_Corrected_Flag_);
    SELF.P_L___Alrt_Cons_Statement_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_Cons_Statement_Flag_);
    SELF.P_L___Alrt_Dispute_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_Dispute_Flag_);
    SELF.P_L___Alrt_Security_Freeze_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_Security_Freeze_Flag_);
    SELF.P_L___Alrt_Security_Alert_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_Security_Alert_Flag_);
    SELF.P_L___Alrt_I_D_Theft_Flag_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14174,__PP10440290.P_L___Alrt_I_D_Theft_Flag_);
    SELF.P_L___Emrg_Age_ := IF(__PP10440290.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14172)),__ECAST(KEL.typ.nint,__PP10440290.P_L___Emrg_Age_));
    SELF := __PP10440290;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE10440289,__ND10440294__Project(LEFT)));
  ...
  EXPORT DBG_E_Person_Address_Intermediate_10 := __UNWRAP(B_Person_Address_10_Local.__ENH_Person_Address_10);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_9 := __UNWRAP(B_Person_Address_9_Local.__ENH_Person_Address_9);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_8 := __UNWRAP(B_Person_Address_8_Local.__ENH_Person_Address_8);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_7 := __UNWRAP(B_Person_Address_7_Local.__ENH_Person_Address_7);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_6 := __UNWRAP(B_Person_Address_6_Local.__ENH_Person_Address_6);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_5 := __UNWRAP(B_Person_Address_5_Local.__ENH_Person_Address_5);
  ...
  EXPORT DBG_E_Person_Address_Intermediate_4 := __UNWRAP(B_Person_Address_4_Local.__ENH_Person_Address_4);
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_14,NAMED('DBG_E_Input_P_I_I_Intermediate_14_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_14,NAMED('DBG_E_Lien_Judgment_Intermediate_14_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_13,NAMED('DBG_E_Input_P_I_I_Intermediate_13_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_13_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_12,NAMED('DBG_E_Input_P_I_I_Intermediate_12_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_12,NAMED('DBG_E_Person_Intermediate_12_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_11,NAMED('DBG_E_Input_P_I_I_Intermediate_11_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_10,NAMED('DBG_E_Person_Address_Intermediate_10_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_9,NAMED('DBG_E_Bankruptcy_Intermediate_9_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_9,NAMED('DBG_E_Person_Address_Intermediate_9_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_8,NAMED('DBG_E_Person_Address_Intermediate_8_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_7,NAMED('DBG_E_Person_Address_Intermediate_7_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_7,NAMED('DBG_E_Person_S_S_N_Intermediate_7_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_6,NAMED('DBG_E_Person_Address_Intermediate_6_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_5,NAMED('DBG_E_Address_Property_Intermediate_5_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_5,NAMED('DBG_E_Person_Address_Intermediate_5_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_4,NAMED('DBG_E_Address_Property_Intermediate_4_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Address_Intermediate_4,NAMED('DBG_E_Person_Address_Intermediate_4_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_3,NAMED('DBG_E_Address_Property_Intermediate_3_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Sele_Person_Intermediate_2,NAMED('DBG_E_Sele_Person_Intermediate_2_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Sele_Person_Intermediate_1,NAMED('DBG_E_Sele_Person_Intermediate_1_Q_F_C_R_A_Person_Attributes_V1_Dynamic')),
