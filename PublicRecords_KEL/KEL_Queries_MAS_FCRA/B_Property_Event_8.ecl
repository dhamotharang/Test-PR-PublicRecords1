...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE311220 := __E_Property_Event;
  EXPORT __ST209229_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST209229_Layout __ND311288__Project(E_Property_Event(__in,__cfg).Layout __PP310883) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP310883.Date_First_Seen_);
    SELF := __PP310883;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE311220,__ND311288__Project(LEFT));
END;
