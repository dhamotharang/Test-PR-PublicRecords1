...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE275096 := __E_Property_Event;
  EXPORT __ST196834_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST196834_Layout __ND275164__Project(E_Property_Event(__in,__cfg).Layout __PP274759) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP274759.Date_First_Seen_);
    SELF := __PP274759;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE275096,__ND275164__Project(LEFT));
END;
