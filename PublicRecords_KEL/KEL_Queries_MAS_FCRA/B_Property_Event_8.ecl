...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE219198 := __E_Property_Event;
  ...
  END;
  SHARED __ST175434_Layout __ND219266__Project(E_Property_Event(__in,__cfg).Layout __PP218861) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP218861.Date_First_Seen_);
    SELF := __PP218861;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE219198,__ND219266__Project(LEFT));
END;
