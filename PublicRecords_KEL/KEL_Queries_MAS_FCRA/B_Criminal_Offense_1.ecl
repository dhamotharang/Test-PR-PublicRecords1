...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1545670 := __ENH_Criminal_Offense_2;
  EXPORT __ST155420_Layout := RECORD
  ...
  END;
  EXPORT __ST155373_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155420_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155373_Layout __ND1545675__Project(B_Criminal_Offense_2(__in,__cfg).__ST160089_Layout __PP1545671) := TRANSFORM
    __EE1545831 := __PP1545671.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1545831,__ST155420_Layout);
    SELF := __PP1545671;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1545670,__ND1545675__Project(LEFT));
END;
