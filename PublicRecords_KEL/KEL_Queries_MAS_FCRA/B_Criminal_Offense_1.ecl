...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1548494 := __ENH_Criminal_Offense_2;
  EXPORT __ST157758_Layout := RECORD
  ...
  END;
  EXPORT __ST157711_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST157758_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157711_Layout __ND1548499__Project(B_Criminal_Offense_2(__in,__cfg).__ST162427_Layout __PP1548495) := TRANSFORM
    __EE1548655 := __PP1548495.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1548655,__ST157758_Layout);
    SELF := __PP1548495;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1548494,__ND1548499__Project(LEFT));
END;
