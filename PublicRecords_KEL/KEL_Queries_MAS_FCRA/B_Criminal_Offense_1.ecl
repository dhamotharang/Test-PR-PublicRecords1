...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1513239 := __ENH_Criminal_Offense_2;
  EXPORT __ST149653_Layout := RECORD
  ...
  END;
  EXPORT __ST149606_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST149653_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST149606_Layout __ND1513244__Project(B_Criminal_Offense_2(__in,__cfg).__ST154537_Layout __PP1513240) := TRANSFORM
    __EE1513400 := __PP1513240.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1513400,__ST149653_Layout);
    SELF := __PP1513240;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1513239,__ND1513244__Project(LEFT));
END;
