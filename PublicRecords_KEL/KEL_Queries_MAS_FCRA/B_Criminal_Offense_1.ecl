...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1553448 := __ENH_Criminal_Offense_2;
  EXPORT __ST161359_Layout := RECORD
  ...
  END;
  EXPORT __ST161312_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST161359_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161312_Layout __ND1553453__Project(B_Criminal_Offense_2(__in,__cfg).__ST166028_Layout __PP1553449) := TRANSFORM
    __EE1553609 := __PP1553449.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1553609,__ST161359_Layout);
    SELF := __PP1553449;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1553448,__ND1553453__Project(LEFT));
END;
