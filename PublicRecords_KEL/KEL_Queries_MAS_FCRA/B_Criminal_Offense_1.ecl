...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1547826 := __ENH_Criminal_Offense_2;
  EXPORT __ST157084_Layout := RECORD
  ...
  EXPORT __ST157037_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST157084_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157037_Layout __ND1547831__Project(B_Criminal_Offense_2(__in,__cfg).__ST161753_Layout __PP1547827) := TRANSFORM
    __EE1547987 := __PP1547827.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1547987,__ST157084_Layout);
    SELF := __PP1547827;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1547826,__ND1547831__Project(LEFT));
END;
