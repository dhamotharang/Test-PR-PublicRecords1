...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1536113 := __ENH_Criminal_Offense_2;
  EXPORT __ST155249_Layout := RECORD
  ...
  END;
  EXPORT __ST155202_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155249_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155202_Layout __ND1536118__Project(B_Criminal_Offense_2(__in,__cfg).__ST159914_Layout __PP1536114) := TRANSFORM
    __EE1536274 := __PP1536114.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1536274,__ST155249_Layout);
    SELF := __PP1536114;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1536113,__ND1536118__Project(LEFT));
END;
