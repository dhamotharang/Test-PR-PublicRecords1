...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1512269 := __ENH_Criminal_Offense_2;
  ...
  END;
  EXPORT __ST150643_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST150690_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST150643_Layout __ND1512274__Project(B_Criminal_Offense_2(__in,__cfg).__ST155560_Layout __PP1512270) := TRANSFORM
    __EE1512430 := __PP1512270.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1512430,__ST150690_Layout);
    SELF := __PP1512270;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1512269,__ND1512274__Project(LEFT));
END;
