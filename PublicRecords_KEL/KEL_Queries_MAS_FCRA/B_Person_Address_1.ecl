...
IMPORT KEL15 AS KEL;
IMPORT B_Person_Address_2,CFG_Compile,E_Address,E_Geo_Link,E_Person,E_Person_Address,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Person_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8219891 := __ENH_Person_Address_2;
  EXPORT __ST178953_Layout := RECORD
  ...
  END;
  EXPORT __ST178897_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST178953_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST178897_Layout __ND8219896__Project(B_Person_Address_2(__in,__cfg).__ST233296_Layout __PP8219892) := TRANSFORM
    __EE8219995 := __PP8219892.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8219995),__ST178953_Layout),__NL(__EE8219995));
    SELF := __PP8219892;
  END;
  EXPORT __ENH_Person_Address_1 := PROJECT(__EE8219891,__ND8219896__Project(LEFT));
END;
