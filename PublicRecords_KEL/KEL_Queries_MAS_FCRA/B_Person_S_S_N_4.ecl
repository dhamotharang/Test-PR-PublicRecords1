...
EXPORT B_Person_S_S_N_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4099658 := __ENH_Person_S_S_N_5;
  EXPORT __ST223566_Layout := RECORD
  ...
  END;
  EXPORT __ST223558_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST223566_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223558_Layout __ND4099663__Project(B_Person_S_S_N_5(__in,__cfg).__ST223515_Layout __PP4099659) := TRANSFORM
    __EE4099678 := __PP4099659.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4099678),__ST223566_Layout),__NL(__EE4099678));
    SELF := __PP4099659;
  END;
  EXPORT __ENH_Person_S_S_N_4 := PROJECT(__EE4099658,__ND4099663__Project(LEFT));
END;
