...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1162566 := __ENH_Inquiry_4;
  ...
  END;
  EXPORT __ST181188_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST181215_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181188_Layout __ND1162571__Project(B_Inquiry_4(__in,__cfg).__ST178526_Layout __PP1162567) := TRANSFORM
    __EE1162635 := __PP1162567.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1162635),__ST181215_Layout),__NL(__EE1162635));
    SELF := __PP1162567;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE1162566,__ND1162571__Project(LEFT));
END;
