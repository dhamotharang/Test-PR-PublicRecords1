...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4110358 := __ENH_Inquiry_4;
  EXPORT __ST181371_Layout := RECORD
  ...
  END;
  EXPORT __ST181344_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST181371_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST181344_Layout __ND4110363__Project(B_Inquiry_4(__in,__cfg).__ST186761_Layout __PP4110359) := TRANSFORM
    __EE4110432 := __PP4110359.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE4110432),__ST181371_Layout),__NL(__EE4110432));
    SELF := __PP4110359;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE4110358,__ND4110363__Project(LEFT));
END;
