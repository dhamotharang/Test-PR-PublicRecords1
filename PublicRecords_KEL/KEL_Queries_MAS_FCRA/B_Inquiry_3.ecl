...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1161787 := __ENH_Inquiry_4;
  EXPORT __ST183931_Layout := RECORD
  ...
  END;
  EXPORT __ST183904_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST183931_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183904_Layout __ND1161792__Project(B_Inquiry_4(__in,__cfg).__ST178823_Layout __PP1161788) := TRANSFORM
    __EE1161856 := __PP1161788.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1161856),__ST183931_Layout),__NL(__EE1161856));
    SELF := __PP1161788;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE1161787,__ND1161792__Project(LEFT));
END;
