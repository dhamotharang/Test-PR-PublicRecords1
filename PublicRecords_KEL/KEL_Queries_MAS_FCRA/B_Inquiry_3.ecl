...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1168222 := __ENH_Inquiry_4;
  EXPORT __ST184259_Layout := RECORD
  ...
  END;
  EXPORT __ST184232_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST184259_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184232_Layout __ND1168227__Project(B_Inquiry_4(__in,__cfg).__ST180492_Layout __PP1168223) := TRANSFORM
    __EE1168291 := __PP1168223.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1168291),__ST184259_Layout),__NL(__EE1168291));
    SELF := __PP1168223;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE1168222,__ND1168227__Project(LEFT));
END;
