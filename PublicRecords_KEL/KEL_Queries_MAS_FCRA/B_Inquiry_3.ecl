...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4885965 := __ENH_Inquiry_4;
  EXPORT __ST190416_Layout := RECORD
  ...
  END;
  EXPORT __ST190389_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST190416_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190389_Layout __ND4885970__Project(B_Inquiry_4(__in,__cfg).__ST196666_Layout __PP4885966) := TRANSFORM
    __EE4886039 := __PP4885966.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE4886039),__ST190416_Layout),__NL(__EE4886039));
    SELF := __PP4885966;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE4885965,__ND4885970__Project(LEFT));
END;
