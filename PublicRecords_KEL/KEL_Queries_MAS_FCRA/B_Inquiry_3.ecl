...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1175664 := __ENH_Inquiry_4;
  EXPORT __ST190169_Layout := RECORD
  ...
  END;
  EXPORT __ST190142_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST190169_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190142_Layout __ND1175669__Project(B_Inquiry_4(__in,__cfg).__ST185021_Layout __PP1175665) := TRANSFORM
    __EE1175733 := __PP1175665.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE1175733),__ST190169_Layout),__NL(__EE1175733));
    SELF := __PP1175665;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE1175664,__ND1175669__Project(LEFT));
END;
