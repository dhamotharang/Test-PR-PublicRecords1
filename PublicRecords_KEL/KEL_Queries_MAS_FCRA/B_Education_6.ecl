...
IMPORT KEL15 AS KEL;
IMPORT B_Education_7,B_Education_8,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Education_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4682566 := __ENH_Education_7;
  EXPORT __ENH_Education_6 := __EE4682566;
END;
