...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1535995 := __ENH_Property_3;
  EXPORT __ST163825_Layout := RECORD
  ...
  END;
  EXPORT __ST163807_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST163825_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163807_Layout __ND1536000__Project(B_Property_3(__in,__cfg).__ST166851_Layout __PP1535996) := TRANSFORM
    __EE1536039 := __PP1535996.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1536039),__ST163825_Layout),__NL(__EE1536039));
    SELF := __PP1535996;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1535995,__ND1536000__Project(LEFT));
END;
