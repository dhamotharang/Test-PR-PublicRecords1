...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1552506 := __ENH_Property_3;
  EXPORT __ST169127_Layout := RECORD
  ...
  END;
  EXPORT __ST169109_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169127_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169109_Layout __ND1552511__Project(B_Property_3(__in,__cfg).__ST172163_Layout __PP1552507) := TRANSFORM
    __EE1552550 := __PP1552507.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1552550),__ST169127_Layout),__NL(__EE1552550));
    SELF := __PP1552507;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1552506,__ND1552511__Project(LEFT));
END;
