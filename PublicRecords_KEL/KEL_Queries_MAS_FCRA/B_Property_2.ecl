...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1512232 := __ENH_Property_3;
  EXPORT __ST157660_Layout := RECORD
  ...
  END;
  EXPORT __ST157642_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST157660_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157642_Layout __ND1512237__Project(B_Property_3(__in,__cfg).__ST160961_Layout __PP1512233) := TRANSFORM
    __EE1512276 := __PP1512233.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1512276),__ST157660_Layout),__NL(__EE1512276));
    SELF := __PP1512233;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1512232,__ND1512237__Project(LEFT));
END;
