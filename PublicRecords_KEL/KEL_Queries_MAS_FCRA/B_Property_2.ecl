...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1547552 := __ENH_Property_3;
  EXPORT __ST165524_Layout := RECORD
  ...
  END;
  EXPORT __ST165506_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST165524_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST165506_Layout __ND1547557__Project(B_Property_3(__in,__cfg).__ST168560_Layout __PP1547553) := TRANSFORM
    __EE1547596 := __PP1547553.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1547596),__ST165524_Layout),__NL(__EE1547596));
    SELF := __PP1547553;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1547552,__ND1547557__Project(LEFT));
END;
