...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1535950 := __ENH_Property_3;
  EXPORT __ST163780_Layout := RECORD
  ...
  END;
  EXPORT __ST163762_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST163780_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST163762_Layout __ND1535955__Project(B_Property_3(__in,__cfg).__ST166806_Layout __PP1535951) := TRANSFORM
    __EE1535994 := __PP1535951.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1535994),__ST163780_Layout),__NL(__EE1535994));
    SELF := __PP1535951;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1535950,__ND1535955__Project(LEFT));
END;
