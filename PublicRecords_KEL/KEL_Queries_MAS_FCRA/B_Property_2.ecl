...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1535171 := __ENH_Property_3;
  EXPORT __ST163007_Layout := RECORD
  ...
  END;
  EXPORT __ST162989_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST163007_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162989_Layout __ND1535176__Project(B_Property_3(__in,__cfg).__ST166033_Layout __PP1535172) := TRANSFORM
    __EE1535215 := __PP1535172.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE1535215),__ST163007_Layout),__NL(__EE1535215));
    SELF := __PP1535172;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE1535171,__ND1535176__Project(LEFT));
END;
