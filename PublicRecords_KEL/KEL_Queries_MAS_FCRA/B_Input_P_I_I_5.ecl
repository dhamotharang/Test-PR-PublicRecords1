...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1106468 := __ENH_Input_P_I_I_6;
  EXPORT __ST181761_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST181761_Layout __ND1107020__Project(B_Input_P_I_I_8(__in,__cfg).__ST174910_Layout __PP1106469) := TRANSFORM
    __CC13459 := '-99999';
    SELF.Input_First_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1106469.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13459)));
    SELF.Input_Last_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1106469.P___Inp_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13459)));
    SELF.Input_Middle_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1106469.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__CN(__CC13459)));
    SELF := __PP1106469;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE1106468,__ND1107020__Project(LEFT));
END;
