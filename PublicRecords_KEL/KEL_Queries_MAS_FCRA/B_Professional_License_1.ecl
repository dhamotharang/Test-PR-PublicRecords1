...
IMPORT KEL15 AS KEL;
IMPORT B_Professional_License_2,B_Professional_License_4,CFG_Compile,E_Professional_License FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Professional_License_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8221581 := __ENH_Professional_License_2;
  EXPORT __ST179492_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  EXPORT __ENH_Professional_License_1 := PROJECT(__EE8221581,__ST179492_Layout);
END;
