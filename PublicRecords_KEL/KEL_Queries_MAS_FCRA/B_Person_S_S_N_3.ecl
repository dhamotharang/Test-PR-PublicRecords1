...
EXPORT B_Person_S_S_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4629504 := __ENH_Person_S_S_N_4;
  ...
  EXPORT __ST223601_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST223609_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST223601_Layout __ND4629509__Project(B_Person_S_S_N_4(__in,__cfg).__ST223558_Layout __PP4629505) := TRANSFORM
    __EE4629524 := __PP4629505.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4629524),__ST223609_Layout),__NL(__EE4629524));
    SELF := __PP4629505;
  END;
  EXPORT __ENH_Person_S_S_N_3 := PROJECT(__EE4629504,__ND4629509__Project(LEFT));
END;
