...
EXPORT B_Person_S_S_N_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5443574 := __ENH_Person_S_S_N_4;
  EXPORT __ST247001_Layout := RECORD
  ...
  EXPORT __ST246993_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST247001_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246993_Layout __ND5443579__Project(B_Person_S_S_N_4(__in,__cfg).__ST246940_Layout __PP5443575) := TRANSFORM
    __EE5443595 := __PP5443575.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5443595),__ST247001_Layout),__NL(__EE5443595));
    SELF := __PP5443575;
  END;
  EXPORT __ENH_Person_S_S_N_3 := PROJECT(__EE5443574,__ND5443579__Project(LEFT));
END;
