...
IMPORT KEL16 AS KEL;
IMPORT B_Watercraft_Owner_2,CFG_Compile,E_Person,E_Watercraft,E_Watercraft_Owner FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Watercraft_Owner_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2094166 := __ENH_Watercraft_Owner_2;
  EXPORT __ST154985_Layout := RECORD
  ...
  END;
  EXPORT __ENH_Watercraft_Owner_1 := PROJECT(__EE2094166,__ST154985_Layout);
END;
