...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1168007 := __ENH_Person_Property_5;
  EXPORT __ST182862_Layout := RECORD
  ...
  END;
  SHARED __ST182862_Layout __ND1168012__Project(B_Person_Property_5(__in,__cfg).__ST178582_Layout __PP1168008) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1168008.Property_Is_Owned_Assessment_ OR __PP1168008.Property_Is_Owned_Deed_) AND NOT (__PP1168008.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1168008.Property_Purchase_Date_Last_Seen_Capped_,__CC13418);
    SELF := __PP1168008;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1168007,__ND1168012__Project(LEFT));
END;
