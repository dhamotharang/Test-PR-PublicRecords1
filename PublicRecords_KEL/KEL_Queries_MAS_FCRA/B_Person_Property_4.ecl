...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1159527 := __ENH_Person_Property_5;
  EXPORT __ST177173_Layout := RECORD
  ...
  END;
  SHARED __ST177173_Layout __ND1159532__Project(B_Person_Property_5(__in,__cfg).__ST176949_Layout __PP1159528) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1159528.Property_Is_Owned_Assessment_ OR __PP1159528.Property_Is_Owned_Deed_) AND NOT (__PP1159528.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1159528.Property_Purchase_Date_Last_Seen_Capped_,__CC13235);
    SELF := __PP1159528;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1159527,__ND1159532__Project(LEFT));
END;
