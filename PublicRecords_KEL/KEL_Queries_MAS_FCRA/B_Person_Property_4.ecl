...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1147053 := __ENH_Person_Property_5;
  EXPORT __ST174797_Layout := RECORD
  ...
  END;
  SHARED __ST174797_Layout __ND1147058__Project(B_Person_Property_5(__in,__cfg).__ST171069_Layout __PP1147054) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1147054.Property_Is_Owned_Assessment_ OR __PP1147054.Property_Is_Owned_Deed_) AND NOT (__PP1147054.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1147054.Property_Purchase_Date_Last_Seen_Capped_,__CC13403);
    SELF := __PP1147054;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1147053,__ND1147058__Project(LEFT));
END;
