...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4099392 := __ENH_Person_Property_5;
  ...
  END;
  SHARED __ST189378_Layout __ND4099397__Project(B_Person_Property_5(__in,__cfg).__ST192246_Layout __PP4099393) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP4099393.Property_Is_Owned_Assessment_ OR __PP4099393.Property_Is_Owned_Deed_) AND NOT (__PP4099393.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP4099393.Property_Purchase_Date_Last_Seen_Capped_,__CC13330);
    SELF := __PP4099393;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE4099392,__ND4099397__Project(LEFT));
END;
