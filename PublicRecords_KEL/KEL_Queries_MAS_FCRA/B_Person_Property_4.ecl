...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4874848 := __ENH_Person_Property_5;
  EXPORT __ST199570_Layout := RECORD
  ...
  END;
  SHARED __ST199570_Layout __ND4874853__Project(B_Person_Property_5(__in,__cfg).__ST202941_Layout __PP4874849) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP4874849.Property_Is_Owned_Assessment_ OR __PP4874849.Property_Is_Owned_Deed_) AND NOT (__PP4874849.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP4874849.Property_Purchase_Date_Last_Seen_Capped_,__CC13403);
    SELF := __PP4874849;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE4874848,__ND4874853__Project(LEFT));
END;
