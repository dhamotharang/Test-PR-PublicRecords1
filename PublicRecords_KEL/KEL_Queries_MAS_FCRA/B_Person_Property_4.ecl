...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1172625 := __ENH_Person_Property_5;
  EXPORT __ST185278_Layout := RECORD
  ...
  END;
  SHARED __ST185278_Layout __ND1172630__Project(B_Person_Property_5(__in,__cfg).__ST181409_Layout __PP1172626) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1172626.Property_Is_Owned_Assessment_ OR __PP1172626.Property_Is_Owned_Deed_) AND NOT (__PP1172626.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1172626.Property_Purchase_Date_Last_Seen_Capped_,__CC13427);
    SELF := __PP1172626;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1172625,__ND1172630__Project(LEFT));
END;
