...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1146664 := __ENH_Criminal_Offense_4;
  EXPORT __ST159507_Layout := RECORD
  ...
  END;
  EXPORT __ST159460_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159507_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159460_Layout __ND1147096__Project(B_Criminal_Offense_4(__in,__cfg).__ST162501_Layout __PP1146665) := TRANSFORM
    __EE1146825 := __PP1146665.Offense_Charges_;
    __ST159507_Layout __ND1147078__Project(B_Criminal_Offense_4(__in,__cfg).__ST162548_Layout __PP1146826) := TRANSFORM
      SELF.Is_Felony_F_C_R_A_ := __AND(__AND(__AND(__AND(__NOT(__PP1146826.Dismissed_Charges_),IF(__T(__NT(__PP1146826.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1146826.Offense_Score_,=,__CN('F'))))),__NT(__PP1146826.Offender_Level_)),__OP2(__PP1146826.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP1146826.Traffic_Flag_,=,__CN('N')));
      SELF := __PP1146826;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1146825,__ND1147078__Project(LEFT));
    SELF := __PP1146665;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1146664,__ND1147096__Project(LEFT));
END;
