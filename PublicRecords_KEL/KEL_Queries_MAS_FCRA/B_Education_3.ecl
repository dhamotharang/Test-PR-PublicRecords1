...
EXPORT B_Education_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4109190 := __ENH_Education_4;
  EXPORT __ST180768_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST180768_Layout __ND4109322__Project(B_Education_8(__in,__cfg).__ST196054_Layout __PP4109191) := TRANSFORM
    __BS4109233 := __T(__PP4109191.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS4109233(__T(__OP2(__T(__PP4109191.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP4109191;
  END;
  EXPORT __ENH_Education_3 := PROJECT(__EE4109190,__ND4109322__Project(LEFT));
END;
