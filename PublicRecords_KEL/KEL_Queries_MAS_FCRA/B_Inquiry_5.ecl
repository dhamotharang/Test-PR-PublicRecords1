...
IMPORT KEL15 AS KEL;
IMPORT B_Inquiry_6,B_Inquiry_9,CFG_Compile,E_Inquiry FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Inquiry_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3969392 := __ENH_Inquiry_6;
  EXPORT __ENH_Inquiry_5 := __EE3969392;
END;
