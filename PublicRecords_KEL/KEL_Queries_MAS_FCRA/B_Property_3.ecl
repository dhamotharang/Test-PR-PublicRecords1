...
IMPORT KEL15 AS KEL;
IMPORT B_Property_4,CFG_Compile,E_Property,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5443895 := __ENH_Property_4;
  EXPORT __ST195026_Layout := RECORD
  ...
  END;
  EXPORT __ST195008_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST195026_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195008_Layout __ND5443900__Project(B_Property_4(__in,__cfg).__ST199792_Layout __PP5443896) := TRANSFORM
    __EE5443940 := __PP5443896.Automated_Valuation_Model_;
    __ST195026_Layout __ND5443945__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP5443941) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP5443941.Date_First_Seen_);
      SELF := __PP5443941;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE5443940,__ND5443945__Project(LEFT));
    SELF := __PP5443896;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE5443895,__ND5443900__Project(LEFT));
END;
