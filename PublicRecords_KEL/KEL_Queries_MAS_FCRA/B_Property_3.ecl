...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE369380 := __E_Property;
  EXPORT __ST161996_Layout := RECORD
  ...
  END;
  EXPORT __ST161978_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST161996_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161978_Layout __ND369618__Project(E_Property(__in,__cfg).Layout __PP369191) := TRANSFORM
    __EE369261 := __PP369191.Automated_Valuation_Model_;
    __ST161996_Layout __ND369538__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP369534) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP369534.Date_First_Seen_);
      SELF := __PP369534;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE369261,__ND369538__Project(LEFT));
    SELF := __PP369191;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE369380,__ND369618__Project(LEFT));
END;
