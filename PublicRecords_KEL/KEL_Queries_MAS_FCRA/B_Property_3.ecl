...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE380604 := __E_Property;
  ...
  END;
  EXPORT __ST166851_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST166869_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166851_Layout __ND380842__Project(E_Property(__in,__cfg).Layout __PP380415) := TRANSFORM
    __EE380485 := __PP380415.Automated_Valuation_Model_;
    __ST166869_Layout __ND380762__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP380758) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP380758.Date_First_Seen_);
      SELF := __PP380758;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE380485,__ND380762__Project(LEFT));
    SELF := __PP380415;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE380604,__ND380842__Project(LEFT));
END;
