...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE387811 := __E_Property;
  EXPORT __ST168113_Layout := RECORD
  ...
  END;
  EXPORT __ST168095_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST168113_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168095_Layout __ND388049__Project(E_Property(__in,__cfg).Layout __PP387622) := TRANSFORM
    __EE387692 := __PP387622.Automated_Valuation_Model_;
    __ST168113_Layout __ND387969__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP387965) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP387965.Date_First_Seen_);
      SELF := __PP387965;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE387692,__ND387969__Project(LEFT));
    SELF := __PP387622;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE387811,__ND388049__Project(LEFT));
END;
