...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE369051 := __E_Property;
  EXPORT __ST160979_Layout := RECORD
  ...
  END;
  EXPORT __ST160961_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST160979_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160961_Layout __ND369289__Project(E_Property(__in,__cfg).Layout __PP368862) := TRANSFORM
    __EE368932 := __PP368862.Automated_Valuation_Model_;
    __ST160979_Layout __ND369209__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP369205) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP369205.Date_First_Seen_);
      SELF := __PP369205;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE368932,__ND369209__Project(LEFT));
    SELF := __PP368862;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE369051,__ND369289__Project(LEFT));
END;
