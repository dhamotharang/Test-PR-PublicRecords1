...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4629819 := __ENH_Property_4;
  EXPORT __ST185534_Layout := RECORD
  ...
  END;
  EXPORT __ST185516_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST185534_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST185516_Layout __ND4629824__Project(B_Property_4(__in,__cfg).__ST189590_Layout __PP4629820) := TRANSFORM
    __EE4629864 := __PP4629820.Automated_Valuation_Model_;
    __ST185534_Layout __ND4629869__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP4629865) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP4629865.Date_First_Seen_);
      SELF := __PP4629865;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE4629864,__ND4629869__Project(LEFT));
    SELF := __PP4629820;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE4629819,__ND4629824__Project(LEFT));
END;
