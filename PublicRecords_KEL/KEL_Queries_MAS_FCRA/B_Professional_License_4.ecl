...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1147391 := __ENH_Professional_License_5;
  EXPORT __ST163319_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST163319_Layout __ND1147575__Project(B_Professional_License_5(__in,__cfg).__ST165214_Layout __PP1147392) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP1147392.Max_Expire_Date_,>,__PP1147392.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP1147392.License_Number_,<>,__CN('')),__OR(__OP2(__PP1147392.Max_Issue_Date_,<,__PP1147392.B_U_I_L_D___D_A_T_E_),__NT(__PP1147392.Max_Issue_Date_)));
    SELF := __PP1147392;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE1147391,__ND1147575__Project(LEFT));
END;
