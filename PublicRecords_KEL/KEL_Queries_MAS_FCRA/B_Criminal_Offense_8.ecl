...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE212210 := __E_Criminal_Offense;
  EXPORT __ST173582_Layout := RECORD
  ...
  END;
  EXPORT __ST173535_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST173582_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173535_Layout __ND212842__Project(E_Criminal_Offense(__in,__cfg).Layout __PP211805) := TRANSFORM
    __EE212030 := __PP211805.Offense_Charges_;
    __ST173582_Layout __ND212465__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP212461) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP212461.Date_First_Seen_);
      SELF := __PP212461;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE212030,__ND212465__Project(LEFT));
    SELF := __PP211805;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE212210,__ND212842__Project(LEFT));
END;
