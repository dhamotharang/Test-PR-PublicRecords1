...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE212255 := __E_Criminal_Offense;
  EXPORT __ST173627_Layout := RECORD
  ...
  END;
  EXPORT __ST173580_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST173627_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173580_Layout __ND212887__Project(E_Criminal_Offense(__in,__cfg).Layout __PP211850) := TRANSFORM
    __EE212075 := __PP211850.Offense_Charges_;
    __ST173627_Layout __ND212510__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP212506) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP212506.Date_First_Seen_);
      SELF := __PP212506;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE212075,__ND212510__Project(LEFT));
    SELF := __PP211850;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE212255,__ND212887__Project(LEFT));
END;
