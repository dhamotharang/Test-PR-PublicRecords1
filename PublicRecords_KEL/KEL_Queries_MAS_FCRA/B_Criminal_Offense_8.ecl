...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE213446 := __E_Criminal_Offense;
  ...
  END;
  EXPORT __ST174637_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST174684_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174637_Layout __ND214078__Project(E_Criminal_Offense(__in,__cfg).Layout __PP213041) := TRANSFORM
    __EE213266 := __PP213041.Offense_Charges_;
    __ST174684_Layout __ND213701__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP213697) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP213697.Date_First_Seen_);
      SELF := __PP213697;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE213266,__ND213701__Project(LEFT));
    SELF := __PP213041;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE213446,__ND214078__Project(LEFT));
END;
