...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE301684 := __E_Criminal_Offense;
  EXPORT __ST207895_Layout := RECORD
  ...
  END;
  EXPORT __ST207848_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST207895_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207848_Layout __ND302316__Project(E_Criminal_Offense(__in,__cfg).Layout __PP301279) := TRANSFORM
    __EE301504 := __PP301279.Offense_Charges_;
    __ST207895_Layout __ND301939__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP301935) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP301935.Date_First_Seen_);
      SELF := __PP301935;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE301504,__ND301939__Project(LEFT));
    SELF := __PP301279;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE301684,__ND302316__Project(LEFT));
END;
