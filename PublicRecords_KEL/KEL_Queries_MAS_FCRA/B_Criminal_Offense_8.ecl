...
EXPORT B_Criminal_Offense_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE267873 := __E_Criminal_Offense;
  EXPORT __ST195998_Layout := RECORD
  ...
  END;
  EXPORT __ST195951_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST195998_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195951_Layout __ND268505__Project(E_Criminal_Offense(__in,__cfg).Layout __PP267468) := TRANSFORM
    __EE267693 := __PP267468.Offense_Charges_;
    __ST195998_Layout __ND268128__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP268124) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP268124.Date_First_Seen_);
      SELF := __PP268124;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE267693,__ND268128__Project(LEFT));
    SELF := __PP267468;
  END;
  EXPORT __ENH_Criminal_Offense_8 := PROJECT(__EE267873,__ND268505__Project(LEFT));
END;
