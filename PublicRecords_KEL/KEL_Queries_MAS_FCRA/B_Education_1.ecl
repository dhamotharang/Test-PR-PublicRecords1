...
EXPORT B_Education_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1553898 := __ENH_Education_2;
  EXPORT __ST161427_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST161427_Layout __ND1554030__Project(B_Education_8(__in,__cfg).__ST179019_Layout __PP1553899) := TRANSFORM
    __BS1553941 := __T(__PP1553899.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS1553941(__T(__OP2(__T(__PP1553899.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP1553899;
  END;
  EXPORT __ENH_Education_1 := PROJECT(__EE1553898,__ND1554030__Project(LEFT));
END;
