...
EXPORT B_Education_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1548276 := __ENH_Education_2;
  EXPORT __ST157152_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST157152_Layout __ND1548408__Project(B_Education_8(__in,__cfg).__ST174740_Layout __PP1548277) := TRANSFORM
    __BS1548319 := __T(__PP1548277.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS1548319(__T(__OP2(__T(__PP1548277.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP1548277;
  END;
  EXPORT __ENH_Education_1 := PROJECT(__EE1548276,__ND1548408__Project(LEFT));
END;
