...
IMPORT KEL16 AS KEL;
IMPORT B_Education_2,CFG_Compile,E_Education FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Education_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1513694 := __ENH_Education_2;
  EXPORT __ENH_Education_1 := __EE1513694;
END;
