...
EXPORT B_Person_S_S_N_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6325333 := __ENH_Person_S_S_N_3;
  EXPORT __ST247054_Layout := RECORD
  ...
  END;
  EXPORT __ST247046_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST247054_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247046_Layout __ND6325338__Project(B_Person_S_S_N_3(__in,__cfg).__ST246993_Layout __PP6325334) := TRANSFORM
    __EE6325354 := __PP6325334.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6325354),__ST247054_Layout),__NL(__EE6325354));
    SELF := __PP6325334;
  END;
  EXPORT __ENH_Person_S_S_N_2 := PROJECT(__EE6325333,__ND6325338__Project(LEFT));
END;
