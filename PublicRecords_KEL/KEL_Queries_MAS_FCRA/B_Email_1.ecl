...
IMPORT KEL15 AS KEL;
IMPORT B_Email_2,B_Email_3,CFG_Compile,E_Email FROM PublicRecords_KEL.KEL_Queries_MAS_FCRA;
...
EXPORT B_Email_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6328116 := __ENH_Email_2;
  EXPORT __ENH_Email_1 := __EE6328116;
END;
