...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1123237 := __ENH_Criminal_Offense_5;
  EXPORT __ST166554_Layout := RECORD
  ...
  END;
  EXPORT __ST166507_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST166554_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166507_Layout __ND1123242__Project(B_Criminal_Offense_5(__in,__cfg).__ST168852_Layout __PP1123238) := TRANSFORM
    __EE1123398 := __PP1123238.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1123398),__ST166554_Layout),__NL(__EE1123398));
    SELF := __PP1123238;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1123237,__ND1123242__Project(LEFT));
END;
