...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1124016 := __ENH_Criminal_Offense_5;
  EXPORT __ST167327_Layout := RECORD
  ...
  END;
  EXPORT __ST167280_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST167327_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167280_Layout __ND1124021__Project(B_Criminal_Offense_5(__in,__cfg).__ST169625_Layout __PP1124017) := TRANSFORM
    __EE1124177 := __PP1124017.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1124177),__ST167327_Layout),__NL(__EE1124177));
    SELF := __PP1124017;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1124016,__ND1124021__Project(LEFT));
END;
