...
EXPORT Q_Non_F_C_R_A_Mini_Attributes_V1(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA100 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE6452231 := __ENH_Person;
  SHARED __EE6452388 := __EE6452231(__T(__OP2(__EE6452231.UID,IN,__CN(__PLexID_in))));
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE6452388,TRANSFORM(__ST91076_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
