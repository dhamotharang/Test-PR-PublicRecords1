...
IMPORT CFG_Compile,E_Business_Org,E_Business_Prox,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Person,E_Surname FROM PublicRecords_KEL;
IMPORT * FROM KEL15.Null;
EXPORT E_Prox_Person(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED InLayout __Mapping0_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault((UNSIGNED)contact_did > 0 AND (UNSIGNED)proxid<>0);
  ...
  END;
  SHARED __d0_Missing_Last_Name__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_Business_Location__Mapped,'contact_name.lname','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault');
  SHARED __d0_Last_Name__Mapped := IF(__d0_Missing_Last_Name__UIDComponents = 'contact_name.lname',PROJECT(__d0_Business_Location__Mapped,TRANSFORM(__d0_Last_Name__Layout,SELF.Last_Name_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d0_Business_Location__Mapped,__d0_Missing_Last_Name__UIDComponents),E_Surname(__cfg).Lookup,TRIM((STRING)LEFT.contact_name.lname) = RIGHT.KeyVal,TRANSFORM(__d0_Last_Name__Layout,SELF.Last_Name_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  ...
  EXPORT NullCounts := DATASET([
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','BusinessLocation',COUNT(__d0(__NL(Business_Location_))),COUNT(__d0(__NN(Business_Location_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_did',COUNT(__d0(__NL(Contact_))),COUNT(__d0(__NN(Contact_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','JobTitle',COUNT(__d0(__NL(Job_Title_))),COUNT(__d0(__NN(Job_Title_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','Status',COUNT(__d0(__NL(Contact_Status_))),COUNT(__d0(__NN(Contact_Status_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_name.fname',COUNT(__d0(__NL(Contact_First_Name_))),COUNT(__d0(__NN(Contact_First_Name_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_name.mname',COUNT(__d0(__NL(Contact_Middle_Name_))),COUNT(__d0(__NN(Contact_Middle_Name_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','LastName',COUNT(__d0(__NL(Last_Name_))),COUNT(__d0(__NN(Last_Name_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_name.lname',COUNT(__d0(__NL(Contact_Last_Name_))),COUNT(__d0(__NN(Contact_Last_Name_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_name.name_suffix',COUNT(__d0(__NL(Contact_Name_Suffix_))),COUNT(__d0(__NN(Contact_Name_Suffix_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_ssn',COUNT(__d0(__NL(Contact_S_S_N_))),COUNT(__d0(__NN(Contact_S_S_N_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_phone',COUNT(__d0(__NL(Contact_Phone_Number_))),COUNT(__d0(__NN(Contact_Phone_Number_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_score',COUNT(__d0(__NL(Contact_Score_))),COUNT(__d0(__NN(Contact_Score_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_type_derived',COUNT(__d0(__NL(Contact_Type_))),COUNT(__d0(__NN(Contact_Type_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_email',COUNT(__d0(__NL(Contact_Email_))),COUNT(__d0(__NN(Contact_Email_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_email_username',COUNT(__d0(__NL(Contact_Email_Username_))),COUNT(__d0(__NN(Contact_Email_Username_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','contact_email_domain',COUNT(__d0(__NL(Contact_Email_Domain_))),COUNT(__d0(__NN(Contact_Email_Domain_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','executive_ind',COUNT(__d0(__NL(Is_Executive_))),COUNT(__d0(__NN(Is_Executive_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','executive_ind_order',COUNT(__d0(__NL(Executive_Order_))),COUNT(__d0(__NN(Executive_Order_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','source',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'ProxPerson','PublicRecords_KEL.Files.NonFCRA.BIPV2_Build__key_contact_linkids_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
