...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE24990 := __ENH_Input_P_I_I_4;
  EXPORT __ST20218_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST20218_Layout __ND25064__Project(B_Input_P_I_I_4(__in,__cfg).__ST20538_Layout __PP24613) := TRANSFORM
    __CC2994 := '-99';
    __CC2999 := '-98';
    SELF.Input_Address_Suffix_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Address_Suffix_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Post_Direction_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Post_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Pre_Direction_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Pre_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Primary_Name_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Primary_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Primary_Range_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Primary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Secondary_Range_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Secondary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Input_Unit_Desig_Clean_Value_ := IF(__PP24613.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC2994)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP24613.Input_Unit_Desig_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC2999)))));
    SELF.Name_Not_Populated_ := IF(FN_Compile.FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP24613.Input_First_Name_Echo_),__ECAST(KEL.typ.nstr,__PP24613.Input_Middle_Name_Echo_),__ECAST(KEL.typ.nstr,__PP24613.Input_Last_Name_Echo_)),TRUE,FALSE);
    SELF := __PP24613;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE24990,__ND25064__Project(LEFT));
END;
