...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE235832 := __ENH_Input_P_I_I_4;
  EXPORT __ST65981_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST65981_Layout __ND235934__Project(B_Input_P_I_I_4(__in,__cfg).__ST69836_Layout __PP235302) := TRANSFORM
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile.FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP235302.Input_City_Clean_),__ECAST(KEL.typ.nstr,__PP235302.Input_State_Clean_),__ECAST(KEL.typ.nstr,__PP235302.Input_Zip5_Clean_));
    __CC3752 := '-99999';
    __CC3757 := '-99998';
    SELF.Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP235302.Input_City_Echo_Pop_Value_ = '0'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3752)),__T(__AND(__CN(__PP235302.Input_City_Echo_Pop_Value_ = '1'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3757)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP235302.Input_City_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3757)))));
    SELF.Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP235302.Input_State_Echo_Pop_Value_ = '0'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3752)),__T(__AND(__CN(__PP235302.Input_State_Echo_Pop_Value_ = '1'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3757)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP235302.Input_State_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3757)))));
    SELF.Input_Street_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP235302.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3752)),__ECAST(KEL.typ.nstr,__CN(__CC3757)));
    SELF.Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP235302.Input_Zip_Echo_Pop_Value_ = '0'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3752)),__T(__AND(__CN(__PP235302.Input_Zip_Echo_Pop_Value_ = '1'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3757)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP235302.Input_Zip4_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3757)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP235302.Input_Zip_Echo_Pop_Value_ = '0'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3752)),__T(__AND(__CN(__PP235302.Input_Zip_Echo_Pop_Value_ = '1'),__OR(__CN(__PP235302.Addr_Not_Populated_),__PP235302.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3757)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP235302.Input_Zip5_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3757)))));
    SELF.Name_Not_Populated_ := IF(FN_Compile.FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP235302.Input_First_Name_Echo_),__ECAST(KEL.typ.nstr,__PP235302.Input_Middle_Name_Echo_),__ECAST(KEL.typ.nstr,__PP235302.Input_Last_Name_Echo_)),TRUE,FALSE);
    SELF := __PP235302;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE235832,__ND235934__Project(LEFT));
END;
