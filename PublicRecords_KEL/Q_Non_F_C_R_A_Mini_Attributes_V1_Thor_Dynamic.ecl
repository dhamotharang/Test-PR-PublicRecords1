...
EXPORT Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Dynamic(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11603008 := __ENH_Person;
  SHARED __EE11604992 := __EE11603008(__T(__OP2(__EE11603008.UID,=,__CN(__PLexID_in))));
  SHARED __ST126866_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11604992,TRANSFORM(__ST126866_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
