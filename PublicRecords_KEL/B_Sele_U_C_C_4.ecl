...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5923262 := __ENH_Sele_U_C_C_5;
  EXPORT __ST258567_Layout := RECORD
  ...
  END;
  EXPORT __ST258559_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258567_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258559_Layout __ND5923267__Project(B_Sele_U_C_C_5(__in,__cfg).__ST265203_Layout __PP5923263) := TRANSFORM
    __EE5923300 := __PP5923263.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5923300),__ST258567_Layout),__NL(__EE5923300));
    SELF := __PP5923263;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5923262,__ND5923267__Project(LEFT));
END;
