...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5433275 := __ENH_Sele_U_C_C_5;
  EXPORT __ST245386_Layout := RECORD
  ...
  END;
  EXPORT __ST245378_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245386_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245378_Layout __ND5433280__Project(B_Sele_U_C_C_5(__in,__cfg).__ST251787_Layout __PP5433276) := TRANSFORM
    __EE5433313 := __PP5433276.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5433313),__ST245386_Layout),__NL(__EE5433313));
    SELF := __PP5433276;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5433275,__ND5433280__Project(LEFT));
END;
