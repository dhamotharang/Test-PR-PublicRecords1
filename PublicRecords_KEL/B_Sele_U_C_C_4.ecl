...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5425561 := __ENH_Sele_U_C_C_5;
  EXPORT __ST245010_Layout := RECORD
  ...
  END;
  EXPORT __ST245002_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245010_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245002_Layout __ND5425566__Project(B_Sele_U_C_C_5(__in,__cfg).__ST251399_Layout __PP5425562) := TRANSFORM
    __EE5425599 := __PP5425562.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5425599),__ST245010_Layout),__NL(__EE5425599));
    SELF := __PP5425562;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5425561,__ND5425566__Project(LEFT));
END;
