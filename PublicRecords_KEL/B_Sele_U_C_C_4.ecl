...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5433305 := __ENH_Sele_U_C_C_5;
  EXPORT __ST245416_Layout := RECORD
  ...
  END;
  EXPORT __ST245408_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245416_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245408_Layout __ND5433310__Project(B_Sele_U_C_C_5(__in,__cfg).__ST251817_Layout __PP5433306) := TRANSFORM
    __EE5433343 := __PP5433306.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5433343),__ST245416_Layout),__NL(__EE5433343));
    SELF := __PP5433306;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5433305,__ND5433310__Project(LEFT));
END;
