...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5854947 := __ENH_Sele_U_C_C_5;
  EXPORT __ST251783_Layout := RECORD
  ...
  END;
  EXPORT __ST251775_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251783_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251775_Layout __ND5854952__Project(B_Sele_U_C_C_5(__in,__cfg).__ST258300_Layout __PP5854948) := TRANSFORM
    __EE5854985 := __PP5854948.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5854985),__ST251783_Layout),__NL(__EE5854985));
    SELF := __PP5854948;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5854947,__ND5854952__Project(LEFT));
END;
