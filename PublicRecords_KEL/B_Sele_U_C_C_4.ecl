...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5799954 := __ENH_Sele_U_C_C_5;
  EXPORT __ST255509_Layout := RECORD
  ...
  END;
  EXPORT __ST255501_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST255509_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255501_Layout __ND5799959__Project(B_Sele_U_C_C_5(__in,__cfg).__ST262092_Layout __PP5799955) := TRANSFORM
    __EE5799992 := __PP5799955.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5799992),__ST255509_Layout),__NL(__EE5799992));
    SELF := __PP5799955;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5799954,__ND5799959__Project(LEFT));
END;
