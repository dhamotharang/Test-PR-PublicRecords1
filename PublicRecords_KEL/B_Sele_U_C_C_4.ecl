...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5126031 := __ENH_Sele_U_C_C_5;
  EXPORT __ST236055_Layout := RECORD
  ...
  END;
  EXPORT __ST236047_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236055_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236047_Layout __ND5126036__Project(B_Sele_U_C_C_5(__in,__cfg).__ST242198_Layout __PP5126032) := TRANSFORM
    __EE5126069 := __PP5126032.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5126069),__ST236055_Layout),__NL(__EE5126069));
    SELF := __PP5126032;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5126031,__ND5126036__Project(LEFT));
END;
