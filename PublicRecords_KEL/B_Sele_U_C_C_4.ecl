...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5815635 := __ENH_Sele_U_C_C_5;
  EXPORT __ST250256_Layout := RECORD
  ...
  END;
  EXPORT __ST250248_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST250256_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250248_Layout __ND5815640__Project(B_Sele_U_C_C_5(__in,__cfg).__ST256839_Layout __PP5815636) := TRANSFORM
    __EE5815673 := __PP5815636.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5815673),__ST250256_Layout),__NL(__EE5815673));
    SELF := __PP5815636;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5815635,__ND5815640__Project(LEFT));
END;
