...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5613886 := __ENH_Sele_U_C_C_5;
  EXPORT __ST244085_Layout := RECORD
  ...
  END;
  EXPORT __ST244077_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST244085_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST244077_Layout __ND5613891__Project(B_Sele_U_C_C_5(__in,__cfg).__ST250498_Layout __PP5613887) := TRANSFORM
    __EE5613924 := __PP5613887.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5613924),__ST244085_Layout),__NL(__EE5613924));
    SELF := __PP5613887;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5613886,__ND5613891__Project(LEFT));
END;
