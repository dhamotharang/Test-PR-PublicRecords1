...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5133416 := __ENH_Sele_U_C_C_5;
  EXPORT __ST236552_Layout := RECORD
  ...
  END;
  EXPORT __ST236544_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236552_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236544_Layout __ND5133421__Project(B_Sele_U_C_C_5(__in,__cfg).__ST242695_Layout __PP5133417) := TRANSFORM
    __EE5133454 := __PP5133417.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5133454),__ST236552_Layout),__NL(__EE5133454));
    SELF := __PP5133417;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5133416,__ND5133421__Project(LEFT));
END;
