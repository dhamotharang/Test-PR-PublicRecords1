...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3710784 := __ENH_Sele_U_C_C_5;
  EXPORT __ST191936_Layout := RECORD
  ...
  END;
  EXPORT __ST191928_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST191936_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191928_Layout __ND3710789__Project(B_Sele_U_C_C_5(__in,__cfg).__ST197204_Layout __PP3710785) := TRANSFORM
    __EE3710822 := __PP3710785.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3710822),__ST191936_Layout),__NL(__EE3710822));
    SELF := __PP3710785;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE3710784,__ND3710789__Project(LEFT));
END;
