...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6550431 := __ENH_Sele_U_C_C_5;
  EXPORT __ST267098_Layout := RECORD
  ...
  END;
  EXPORT __ST267090_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST267098_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267090_Layout __ND6550436__Project(B_Sele_U_C_C_5(__in,__cfg).__ST273936_Layout __PP6550432) := TRANSFORM
    __EE6550469 := __PP6550432.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6550469),__ST267098_Layout),__NL(__EE6550469));
    SELF := __PP6550432;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE6550431,__ND6550436__Project(LEFT));
END;
