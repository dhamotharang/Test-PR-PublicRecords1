...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4969506 := __ENH_Sele_U_C_C_5;
  EXPORT __ST240369_Layout := RECORD
  ...
  END;
  EXPORT __ST240361_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST240369_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST240361_Layout __ND4969511__Project(B_Sele_U_C_C_5(__in,__cfg).__ST246536_Layout __PP4969507) := TRANSFORM
    __EE4969544 := __PP4969507.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4969544),__ST240369_Layout),__NL(__EE4969544));
    SELF := __PP4969507;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE4969506,__ND4969511__Project(LEFT));
END;
