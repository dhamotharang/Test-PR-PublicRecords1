...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3705837 := __ENH_Sele_U_C_C_5;
  EXPORT __ST183428_Layout := RECORD
  ...
  END;
  EXPORT __ST183420_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST183428_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183420_Layout __ND3705842__Project(B_Sele_U_C_C_5(__in,__cfg).__ST188886_Layout __PP3705838) := TRANSFORM
    __EE3705875 := __PP3705838.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3705875),__ST183428_Layout),__NL(__EE3705875));
    SELF := __PP3705838;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE3705837,__ND3705842__Project(LEFT));
END;
