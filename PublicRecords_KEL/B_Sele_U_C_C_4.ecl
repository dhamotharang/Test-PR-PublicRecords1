...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5131308 := __ENH_Sele_U_C_C_5;
  EXPORT __ST236089_Layout := RECORD
  ...
  END;
  EXPORT __ST236081_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236089_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236081_Layout __ND5131313__Project(B_Sele_U_C_C_5(__in,__cfg).__ST242232_Layout __PP5131309) := TRANSFORM
    __EE5131346 := __PP5131309.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5131346),__ST236089_Layout),__NL(__EE5131346));
    SELF := __PP5131309;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5131308,__ND5131313__Project(LEFT));
END;
