...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5400879 := __ENH_Sele_U_C_C_5;
  EXPORT __ST243357_Layout := RECORD
  ...
  END;
  EXPORT __ST243349_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST243357_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243349_Layout __ND5400884__Project(B_Sele_U_C_C_5(__in,__cfg).__ST249729_Layout __PP5400880) := TRANSFORM
    __EE5400917 := __PP5400880.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5400917),__ST243357_Layout),__NL(__EE5400917));
    SELF := __PP5400880;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5400879,__ND5400884__Project(LEFT));
END;
