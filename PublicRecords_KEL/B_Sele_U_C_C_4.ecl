...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5834580 := __ENH_Sele_U_C_C_5;
  EXPORT __ST251481_Layout := RECORD
  ...
  END;
  EXPORT __ST251473_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251481_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251473_Layout __ND5834585__Project(B_Sele_U_C_C_5(__in,__cfg).__ST257998_Layout __PP5834581) := TRANSFORM
    __EE5834618 := __PP5834581.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5834618),__ST251481_Layout),__NL(__EE5834618));
    SELF := __PP5834581;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE5834580,__ND5834585__Project(LEFT));
END;
