...
EXPORT B_Sele_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6953329 := __ENH_Sele_U_C_C_5;
  EXPORT __ST273672_Layout := RECORD
  ...
  END;
  EXPORT __ST273664_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST273672_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273664_Layout __ND6953334__Project(B_Sele_U_C_C_5(__in,__cfg).__ST280613_Layout __PP6953330) := TRANSFORM
    __EE6953367 := __PP6953330.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6953367),__ST273672_Layout),__NL(__EE6953367));
    SELF := __PP6953330;
  END;
  EXPORT __ENH_Sele_U_C_C_4 := PROJECT(__EE6953329,__ND6953334__Project(LEFT));
END;
