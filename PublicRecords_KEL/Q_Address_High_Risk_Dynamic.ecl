...
EXPORT Q_Address_High_Risk_Dynamic(KEL.typ.str __PInputStreetNumber, KEL.typ.str __PInputStreetName, KEL.typ.int __PInputZip, KEL.typ.str __PInputPredirectional, KEL.typ.str __PInputSuffix, KEL.typ.str __PInputPostDirectional, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11782403 := __ENH_Address_Slim;
  SHARED __EE11782483 := __EE11782403(__T(__AND(__OP2(__EE11782403.Primary_Range_,=,__CN(__PInputStreetNumber)),__AND(__OP2(__EE11782403.Primary_Name_,=,__CN(__PInputStreetName)),__AND(__OP2(__EE11782403.Z_I_P5_,=,__CN(__PInputZip)),__AND(__OP2(__EE11782403.Predirectional_,=,__CN(__PInputPredirectional)),__AND(__OP2(__EE11782403.Suffix_,=,__CN(__PInputSuffix)),__OP2(__EE11782403.Postdirectional_,=,__CN(__PInputPostDirectional)))))))));
  SHARED __ST78086_Layout := RECORD
