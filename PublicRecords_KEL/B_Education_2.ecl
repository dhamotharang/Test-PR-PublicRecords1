...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7333649 := __ENH_Education_3;
  EXPORT __ST219275_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST219275_Layout __ND7333781__Project(B_Education_7(__in,__cfg).__ST267585_Layout __PP7333650) := TRANSFORM
    __BS7333692 := __T(__PP7333650.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS7333692(__T(__OP2(__T(__PP7333650.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP7333650;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE7333649,__ND7333781__Project(LEFT));
END;
