...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7186536 := __ENH_Education_3;
  EXPORT __ST216211_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST216211_Layout __ND7186668__Project(B_Education_7(__in,__cfg).__ST264397_Layout __PP7186537) := TRANSFORM
    __BS7186579 := __T(__PP7186537.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS7186579(__T(__OP2(__T(__PP7186537.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP7186537;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE7186536,__ND7186668__Project(LEFT));
END;
