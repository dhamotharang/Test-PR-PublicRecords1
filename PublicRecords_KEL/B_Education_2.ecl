...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7276357 := __ENH_Education_3;
  EXPORT __ST221701_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST221701_Layout __ND7276489__Project(B_Education_7(__in,__cfg).__ST269662_Layout __PP7276358) := TRANSFORM
    __BS7276400 := __T(__PP7276358.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS7276400(__T(__OP2(__T(__PP7276358.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP7276358;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE7276357,__ND7276489__Project(LEFT));
END;
