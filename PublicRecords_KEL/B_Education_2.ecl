...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7926639 := __ENH_Education_3;
  EXPORT __ST229163_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST229163_Layout __ND7926771__Project(B_Education_7(__in,__cfg).__ST280618_Layout __PP7926640) := TRANSFORM
    __BS7926682 := __T(__PP7926640.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS7926682(__T(__OP2(__T(__PP7926640.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP7926640;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE7926639,__ND7926771__Project(LEFT));
END;
