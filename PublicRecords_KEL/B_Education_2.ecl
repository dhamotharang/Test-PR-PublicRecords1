...
EXPORT B_Education_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7370299 := __ENH_Education_3;
  EXPORT __ST223195_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST223195_Layout __ND7370431__Project(B_Education_7(__in,__cfg).__ST271298_Layout __PP7370300) := TRANSFORM
    __BS7370342 := __T(__PP7370300.College_Characteristics_);
    SELF.Coll_Rec_Flag_ := EXISTS(__BS7370342(__T(__OP2(__T(__PP7370300.College_Characteristics_).File_Type_,IN,__CN(['C','H','O'])))));
    SELF := __PP7370300;
  END;
  EXPORT __ENH_Education_2 := PROJECT(__EE7370299,__ND7370431__Project(LEFT));
END;
