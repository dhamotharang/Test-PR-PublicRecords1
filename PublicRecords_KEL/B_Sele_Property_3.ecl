...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6061924 := __ENH_Sele_Property_4;
  EXPORT __ST225080_Layout := RECORD
  ...
  END;
  SHARED __ST225080_Layout __ND6061929__Project(B_Sele_Property_4(__in,__cfg).__ST235738_Layout __PP6061925) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6061925.Property_Is_Owned_Assessment_ OR __PP6061925.Property_Is_Owned_Deed_) AND NOT (__PP6061925.Property_Is_Sold_);
    SELF := __PP6061925;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6061924,__ND6061929__Project(LEFT));
END;
