...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6753987 := __ENH_Sele_Property_4;
  EXPORT __ST237345_Layout := RECORD
  ...
  END;
  SHARED __ST237345_Layout __ND6753992__Project(B_Sele_Property_4(__in,__cfg).__ST248509_Layout __PP6753988) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6753988.Property_Is_Owned_Assessment_ OR __PP6753988.Property_Is_Owned_Deed_) AND NOT (__PP6753988.Property_Is_Sold_);
    SELF := __PP6753988;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6753987,__ND6753992__Project(LEFT));
END;
