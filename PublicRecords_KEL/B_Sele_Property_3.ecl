...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6813804 := __ENH_Sele_Property_4;
  EXPORT __ST240139_Layout := RECORD
  ...
  END;
  SHARED __ST240139_Layout __ND6813809__Project(B_Sele_Property_4(__in,__cfg).__ST251322_Layout __PP6813805) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6813805.Property_Is_Owned_Assessment_ OR __PP6813805.Property_Is_Owned_Deed_) AND NOT (__PP6813805.Property_Is_Sold_);
    SELF := __PP6813805;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6813804,__ND6813809__Project(LEFT));
END;
