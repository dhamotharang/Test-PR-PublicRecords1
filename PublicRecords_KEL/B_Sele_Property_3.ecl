...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6064207 := __ENH_Sele_Property_4;
  EXPORT __ST225755_Layout := RECORD
  ...
  END;
  SHARED __ST225755_Layout __ND6064212__Project(B_Sele_Property_4(__in,__cfg).__ST236413_Layout __PP6064208) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6064208.Property_Is_Owned_Assessment_ OR __PP6064208.Property_Is_Owned_Deed_) AND NOT (__PP6064208.Property_Is_Sold_);
    SELF := __PP6064208;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6064207,__ND6064212__Project(LEFT));
END;
