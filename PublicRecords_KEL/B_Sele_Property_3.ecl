...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7983145 := __ENH_Sele_Property_4;
  EXPORT __ST261708_Layout := RECORD
  ...
  END;
  SHARED __ST261708_Layout __ND7983150__Project(B_Sele_Property_4(__in,__cfg).__ST273513_Layout __PP7983146) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP7983146.Property_Is_Owned_Assessment_ OR __PP7983146.Property_Is_Owned_Deed_) AND NOT (__PP7983146.Property_Is_Sold_);
    SELF := __PP7983146;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE7983145,__ND7983150__Project(LEFT));
END;
