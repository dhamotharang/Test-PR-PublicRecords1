...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6969961 := __ENH_Sele_Property_4;
  ...
  END;
  SHARED __ST247205_Layout __ND6969966__Project(B_Sele_Property_4(__in,__cfg).__ST258408_Layout __PP6969962) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6969962.Property_Is_Owned_Assessment_ OR __PP6969962.Property_Is_Owned_Deed_) AND NOT (__PP6969962.Property_Is_Sold_);
    SELF := __PP6969962;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6969961,__ND6969966__Project(LEFT));
END;
