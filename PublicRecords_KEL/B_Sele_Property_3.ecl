...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6752401 := __ENH_Sele_Property_4;
  EXPORT __ST237375_Layout := RECORD
  ...
  END;
  SHARED __ST237375_Layout __ND6752406__Project(B_Sele_Property_4(__in,__cfg).__ST248539_Layout __PP6752402) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6752402.Property_Is_Owned_Assessment_ OR __PP6752402.Property_Is_Owned_Deed_) AND NOT (__PP6752402.Property_Is_Sold_);
    SELF := __PP6752402;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6752401,__ND6752406__Project(LEFT));
END;
