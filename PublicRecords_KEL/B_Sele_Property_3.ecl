...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6844519 := __ENH_Sele_Property_4;
  EXPORT __ST238952_Layout := RECORD
  ...
  END;
  SHARED __ST238952_Layout __ND6844524__Project(B_Sele_Property_4(__in,__cfg).__ST250097_Layout __PP6844520) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP6844520.Property_Is_Owned_Assessment_ OR __PP6844520.Property_Is_Owned_Deed_) AND NOT (__PP6844520.Property_Is_Sold_);
    SELF := __PP6844520;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE6844519,__ND6844524__Project(LEFT));
END;
