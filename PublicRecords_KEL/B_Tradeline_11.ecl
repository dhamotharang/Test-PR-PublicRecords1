...
EXPORT B_Tradeline_11(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE110019 := __E_Tradeline;
  EXPORT __ST109825_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST109825_Layout __ND110147__Project(E_Tradeline(__in,__cfg).Layout __PP109890) := TRANSFORM
    ...
    SELF := __PP109890;
  END;
  EXPORT __ENH_Tradeline_11 := PROJECT(__EE110019,__ND110147__Project(LEFT));
END;
