...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8889751 := __ENH_Tradeline_3;
  EXPORT __ST240049_Layout := RECORD
  ...
  END;
  EXPORT __ST240042_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST240049_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST240042_Layout __ND8889686__Project(B_Tradeline_3(__in,__cfg).__ST255733_Layout __PP8889086) := TRANSFORM
    __EE8889754 := __PP8889086.Records_;
    __ST240049_Layout __ND8889600__Project(B_Tradeline_3(__in,__cfg).__ST255740_Layout __PP8889130) := TRANSFORM
      __EE8889593 := __PP8889086.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP8889086.Is_Active_,__OP2(__PP8889130.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE8889593,__T(__EE8889593).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP8889130.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP8889130.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP8889130.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP8889130.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP8889130;
    END;
    SELF.Records_ := __PROJECT(__EE8889754,__ND8889600__Project(LEFT));
    SELF := __PP8889086;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE8889751,__ND8889686__Project(LEFT));
END;
