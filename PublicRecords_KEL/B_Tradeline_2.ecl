...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9307596 := __ENH_Tradeline_3;
  EXPORT __ST246777_Layout := RECORD
  ...
  END;
  EXPORT __ST246770_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST246777_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246770_Layout __ND9307531__Project(B_Tradeline_3(__in,__cfg).__ST262237_Layout __PP9306931) := TRANSFORM
    __EE9307599 := __PP9306931.Records_;
    __ST246777_Layout __ND9307445__Project(B_Tradeline_3(__in,__cfg).__ST262244_Layout __PP9306975) := TRANSFORM
      __EE9307438 := __PP9306931.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP9306931.Is_Active_,__OP2(__PP9306975.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE9307438,__T(__EE9307438).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP9306975.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP9306975.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP9306975.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP9306975.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP9306975;
    END;
    SELF.Records_ := __PROJECT(__EE9307599,__ND9307445__Project(LEFT));
    SELF := __PP9306931;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE9307596,__ND9307531__Project(LEFT));
END;
