...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE675315 := __ENH_Tradeline_3;
  EXPORT __ST83778_Layout := RECORD
  ...
  END;
  EXPORT __ST83771_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST83778_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST83771_Layout __ND675247__Project(B_Tradeline_3(__in,__cfg).__ST89167_Layout __PP674926) := TRANSFORM
    __EE675318 := __PP674926.Records_;
    __ST83778_Layout __ND675161__Project(B_Tradeline_3(__in,__cfg).__ST89174_Layout __PP674928) := TRANSFORM
      __EE675154 := __PP674926.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP674926.Is_Active_,__OP2(__PP674928.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE675154,__T(__EE675154).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP674928.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP674928.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP674928.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP674928.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP674928;
    END;
    SELF.Records_ := __PROJECT(__EE675318,__ND675161__Project(LEFT));
    SELF := __PP674926;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE675315,__ND675247__Project(LEFT));
END;
