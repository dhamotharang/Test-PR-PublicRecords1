...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8291923 := __ENH_Tradeline_3;
  EXPORT __ST232798_Layout := RECORD
  ...
  EXPORT __ST232791_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST232798_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST232791_Layout __ND8291858__Project(B_Tradeline_3(__in,__cfg).__ST247734_Layout __PP8291258) := TRANSFORM
    __EE8291926 := __PP8291258.Records_;
    __ST232798_Layout __ND8291772__Project(B_Tradeline_3(__in,__cfg).__ST247741_Layout __PP8291302) := TRANSFORM
      __EE8291765 := __PP8291258.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP8291258.Is_Active_,__OP2(__PP8291302.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE8291765,__T(__EE8291765).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP8291302.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP8291302.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP8291302.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP8291302.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP8291302;
    END;
    SELF.Records_ := __PROJECT(__EE8291926,__ND8291772__Project(LEFT));
    SELF := __PP8291258;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE8291923,__ND8291858__Project(LEFT));
END;
