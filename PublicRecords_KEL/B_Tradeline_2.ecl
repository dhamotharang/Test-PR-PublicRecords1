...
EXPORT B_Tradeline_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8252001 := __ENH_Tradeline_3;
  EXPORT __ST228935_Layout := RECORD
  ...
  END;
  EXPORT __ST228928_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST228935_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST228928_Layout __ND8251936__Project(B_Tradeline_3(__in,__cfg).__ST243856_Layout __PP8251336) := TRANSFORM
    __EE8252004 := __PP8251336.Records_;
    __ST228935_Layout __ND8251850__Project(B_Tradeline_3(__in,__cfg).__ST243863_Layout __PP8251380) := TRANSFORM
      __EE8251843 := __PP8251336.Records_;
      SELF.Is_Most_Recent_Active_Record_ := __AND(__PP8251336.Is_Active_,__OP2(__PP8251380.A_R_Date_,=,KEL.Aggregates.MaxNN(__EE8251843,__T(__EE8251843).A_R_Date_)));
      SELF.Perf_Level_ := MAP(__T(__OP2(__PP8251380.Aging91_Plus_L_N_,>,__CN(0)))=>4,__T(__OP2(__PP8251380.Aging61_To90_L_N_,>,__CN(0)))=>3,__T(__OP2(__PP8251380.Aging31_To60_L_N_,>,__CN(0)))=>2,__T(__OP2(__PP8251380.Aging1_To30_L_N_,>,__CN(0)))=>1,0);
      SELF := __PP8251380;
    END;
    SELF.Records_ := __PROJECT(__EE8252004,__ND8251850__Project(LEFT));
    SELF := __PP8251336;
  END;
  EXPORT __ENH_Tradeline_2 := PROJECT(__EE8252001,__ND8251936__Project(LEFT));
END;
