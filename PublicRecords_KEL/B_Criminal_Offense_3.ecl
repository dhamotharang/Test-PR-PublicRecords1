...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5510549 := __ENH_Criminal_Offense_4;
  ...
  EXPORT __ST219404_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST219451_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219404_Layout __ND5510554__Project(B_Criminal_Offense_4(__in,__cfg).__ST231900_Layout __PP5510550) := TRANSFORM
    __EE5510710 := __PP5510550.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE5510710),__ST219451_Layout),__NL(__EE5510710));
    SELF := __PP5510550;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE5510549,__ND5510554__Project(LEFT));
END;
