...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE21877 := __ENH_Criminal_Offense_4;
  EXPORT __ST19082_Layout := RECORD
  ...
  END;
  EXPORT __ST19035_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST19082_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST19035_Layout __ND22651__Project(B_Criminal_Offense_4(__in,__cfg).__ST19426_Layout __PP21413) := TRANSFORM
    __EE21648 := __PP21413.Offense_Charges_;
    __ST19082_Layout __ND22636__Project(B_Criminal_Offense_4(__in,__cfg).__ST19473_Layout __PP22108) := TRANSFORM
      SELF.Age_In_Days_ := FN_Compile.FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP22108.Criminal_Date_),__ECAST(KEL.typ.nkdate,__PP21413.Current_Date_));
      SELF.Is_Criminal_Count_ := __NOT(__PP22108.Dismissed_Charges_);
      SELF.Is_Felony_ := __AND(__AND(__NOT(__PP22108.Dismissed_Charges_),IF(__T(__NT(__PP22108.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP22108.Offense_Score_,=,__CN('F'))))),__OP2(__PP21413.Recent_Offender_Level_,=,__CN(4)));
      SELF := __PP22108;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE21648,__ND22636__Project(LEFT));
    SELF := __PP21413;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE21877,__ND22651__Project(LEFT));
END;
