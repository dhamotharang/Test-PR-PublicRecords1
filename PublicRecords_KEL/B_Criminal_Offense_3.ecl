...
EXPORT B_Criminal_Offense_3(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5964419 := __ENH_Criminal_Offense_4;
  EXPORT __ST226265_Layout := RECORD
  ...
  END;
  EXPORT __ST226218_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST226265_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST226218_Layout __ND5964424__Project(B_Criminal_Offense_4(__cfg).__ST239047_Layout __PP5964420) := TRANSFORM
    __EE5964580 := __PP5964420.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE5964580),__ST226265_Layout),__NL(__EE5964580));
    SELF := __PP5964420;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE5964419,__ND5964424__Project(LEFT));
END;
