...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE21767 := __ENH_Criminal_Offense_4;
  EXPORT __ST18972_Layout := RECORD
  ...
  END;
  EXPORT __ST18925_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST18972_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST18925_Layout __ND22541__Project(B_Criminal_Offense_4(__in,__cfg).__ST19316_Layout __PP21303) := TRANSFORM
    __EE21538 := __PP21303.Offense_Charges_;
    __ST18972_Layout __ND22526__Project(B_Criminal_Offense_4(__in,__cfg).__ST19363_Layout __PP21998) := TRANSFORM
      SELF.Age_In_Days_ := FN_Compile.FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP21998.Criminal_Date_),__ECAST(KEL.typ.nkdate,__PP21303.Current_Date_));
      SELF.Is_Criminal_Count_ := __NOT(__PP21998.Dismissed_Charges_);
      SELF.Is_Felony_ := __AND(__AND(__NOT(__PP21998.Dismissed_Charges_),IF(__T(__NT(__PP21998.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP21998.Offense_Score_,=,__CN('F'))))),__OP2(__PP21303.Recent_Offender_Level_,=,__CN(4)));
      SELF := __PP21998;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE21538,__ND22526__Project(LEFT));
    SELF := __PP21303;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE21767,__ND22541__Project(LEFT));
END;
