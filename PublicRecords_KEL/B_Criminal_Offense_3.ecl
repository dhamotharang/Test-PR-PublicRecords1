...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5508270 := __ENH_Criminal_Offense_4;
  EXPORT __ST218776_Layout := RECORD
  ...
  END;
  EXPORT __ST218729_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST218776_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218729_Layout __ND5508275__Project(B_Criminal_Offense_4(__in,__cfg).__ST231225_Layout __PP5508271) := TRANSFORM
    __EE5508431 := __PP5508271.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE5508431),__ST218776_Layout),__NL(__EE5508431));
    SELF := __PP5508271;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE5508270,__ND5508275__Project(LEFT));
END;
