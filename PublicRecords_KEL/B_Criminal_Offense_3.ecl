...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5625259 := __ENH_Criminal_Offense_4;
  EXPORT __ST219955_Layout := RECORD
  ...
  END;
  EXPORT __ST219908_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST219955_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST219908_Layout __ND5625264__Project(B_Criminal_Offense_4(__in,__cfg).__ST232431_Layout __PP5625260) := TRANSFORM
    __EE5625420 := __PP5625260.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE5625420),__ST219955_Layout),__NL(__EE5625420));
    SELF := __PP5625260;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE5625259,__ND5625264__Project(LEFT));
END;
