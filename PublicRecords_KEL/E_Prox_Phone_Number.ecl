...
EXPORT E_Prox_Phone_Number(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping6 := 'Site_(DEFAULT:Site_:0),efx_phone(OVERRIDE:Phone_Number_:0),siccode(DEFAULT:S_I_C_Code_:\'\'),naicscode(DEFAULT:N_A_I_C_S_Code_:\'\'),bestphone(DEFAULT:Best_Phone_:\'\'),bestphonerank(DEFAULT:Best_Phone_Rank_:0),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),omitindicator(DEFAULT:Omit_Indicator_:\'\'),efx_mrkt_telever(OVERRIDE:Is_Phone_Marketable_),efx_mrkt_telescore(OVERRIDE:Phone_Marketability_Score_:0),dt_vendor_first_reported(OVERRIDE:Date_Vendor_First_Reported_:DATE),dt_vendor_last_reported(OVERRIDE:Date_Vendor_Last_Reported_:DATE),source(OVERRIDE:Source_:\'\'),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  Layout Prox_Phone_Number__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Best_Phone_Details_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Best_Phone_,Best_Phone_Rank_},Best_Phone_,Best_Phone_Rank_),Best_Phone_Details_Layout)(__NN(Best_Phone_) OR __NN(Best_Phone_Rank_)));
    SELF.Phone_Details_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Prior_Area_Code_,Current_Flag_,Business_Flag_,Publish_Code_,Listing_Type_,Is_Active_,Omit_Indicator_,No_Solicit_Code_,Record_Type_,Source_},Prior_Area_Code_,Current_Flag_,Business_Flag_,Publish_Code_,Listing_Type_,Is_Active_,Omit_Indicator_,No_Solicit_Code_,Record_Type_,Source_),Phone_Details_Layout)(__NN(Prior_Area_Code_) OR __NN(Current_Flag_) OR __NN(Business_Flag_) OR __NN(Publish_Code_) OR __NN(Listing_Type_) OR __NN(Is_Active_) OR __NN(Omit_Indicator_) OR __NN(No_Solicit_Code_) OR __NN(Record_Type_) OR __NN(Source_)));
  ...
  Layout Prox_Phone_Number__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Best_Phone_Details_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Best_Phone_Details_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Best_Phone_) OR __NN(Best_Phone_Rank_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d0(__NL(Date_Vendor_First_Reported_))),COUNT(__d0(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d0(__NL(Date_Vendor_Last_Reported_))),COUNT(__d0(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d1(__NL(Date_Vendor_First_Reported_))),COUNT(__d1(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d1(__NL(Date_Vendor_Last_Reported_))),COUNT(__d1(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d2(__NL(Date_Vendor_First_Reported_))),COUNT(__d2(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d2(__NL(Date_Vendor_Last_Reported_))),COUNT(__d2(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d3(__NL(Date_Vendor_First_Reported_))),COUNT(__d3(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d3(__NL(Date_Vendor_Last_Reported_))),COUNT(__d3(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d4(__NL(Date_Vendor_First_Reported_))),COUNT(__d4(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d4(__NL(Date_Vendor_Last_Reported_))),COUNT(__d4(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d5(__NL(Date_Vendor_First_Reported_))),COUNT(__d5(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d5(__NL(Date_Vendor_Last_Reported_))),COUNT(__d5(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_first_reported',COUNT(__d6(__NL(Date_Vendor_First_Reported_))),COUNT(__d6(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_last_reported',COUNT(__d6(__NL(Date_Vendor_Last_Reported_))),COUNT(__d6(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d7(__NL(Date_Vendor_First_Reported_))),COUNT(__d7(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d7(__NL(Date_Vendor_Last_Reported_))),COUNT(__d7(__NN(Date_Vendor_Last_Reported_)))},
    ...
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d8(__NL(Date_Vendor_First_Reported_))),COUNT(__d8(__NN(Date_Vendor_First_Reported_)))},
    {'ProxPhoneNumber','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d8(__NL(Date_Vendor_Last_Reported_))),COUNT(__d8(__NN(Date_Vendor_Last_Reported_)))},
