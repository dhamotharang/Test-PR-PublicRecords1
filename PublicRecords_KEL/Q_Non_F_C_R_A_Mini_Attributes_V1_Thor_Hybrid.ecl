...
EXPORT Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, KEL.typ.kdate __PRunDateToMimic, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE9661113 := __ENH_Person;
  SHARED __EE9662892 := __EE9661113(__T(__OP2(__EE9661113.UID,=,__CN(__PLexID_in))));
  SHARED __ST125971_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE9662892,TRANSFORM(__ST125971_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
