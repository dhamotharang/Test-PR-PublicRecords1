...
EXPORT Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, KEL.typ.kdate __PRunDateToMimic, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE12226089 := __ENH_Person;
  SHARED __EE12228171 := __EE12226089(__T(__OP2(__EE12226089.UID,=,__CN(__PLexID_in))));
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12228171,TRANSFORM(__ST136801_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Phone_Result,NAMED('DBG_E_Phone_Result_Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid')),
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_10,NAMED('DBG_E_Input_P_I_I_Intermediate_10_Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_7,NAMED('DBG_E_Criminal_Offense_Intermediate_7_Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_6,NAMED('DBG_E_Criminal_Offense_Intermediate_6_Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid')),
    ...
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Non_F_C_R_A_Mini_Attributes_V1_Thor_Hybrid')),
