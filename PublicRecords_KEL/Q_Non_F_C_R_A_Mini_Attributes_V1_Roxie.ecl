...
EXPORT Q_Non_F_C_R_A_Mini_Attributes_V1_Roxie(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE6236570 := __ENH_Person;
  SHARED __EE6236751 := __EE6236570(__T(__OP2(__EE6236570.UID,IN,__CN(__PLexID_in))));
  SHARED __ST96890_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE6236751,TRANSFORM(__ST96890_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
