...
IMPORT KEL15 AS KEL;
IMPORT B_Property_Event_1,B_Property_Event_5,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT B_Property_Event(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12046935 := __ENH_Property_Event_1;
  EXPORT __ENH_Property_Event := __EE12046935;
END;
