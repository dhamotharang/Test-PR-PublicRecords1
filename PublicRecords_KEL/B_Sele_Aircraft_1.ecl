...
IMPORT KEL12 AS KEL;
IMPORT CFG_Compile,E_Aircraft,E_Business_Org,E_Business_Sele,E_Business_Ult,E_Sele_Aircraft,FN_Compile FROM $;
...
EXPORT B_Sele_Aircraft_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1164778 := __E_Sele_Aircraft;
  ...
  END;
  SHARED __ST92795_Layout __ND1164839__Project(E_Sele_Aircraft(__in,__cfg).Layout __PP1164692) := TRANSFORM
    ...
    SELF := __PP1164692;
  END;
  EXPORT __ENH_Sele_Aircraft_1 := PROJECT(__EE1164778,__ND1164839__Project(LEFT));
END;
