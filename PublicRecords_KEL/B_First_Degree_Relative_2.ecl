...
EXPORT B_First_Degree_Relative_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7186719 := __ENH_First_Degree_Relative_3;
  EXPORT __ST1608988_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_2 := PROJECT(__EE7186719,__ST1608988_Layout);
END;
