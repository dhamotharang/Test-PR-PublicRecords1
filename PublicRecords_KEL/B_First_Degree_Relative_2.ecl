...
EXPORT B_First_Degree_Relative_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6434330 := __ENH_First_Degree_Relative_3;
  EXPORT __ST1470134_Layout := RECORD
  ...
  END;
  EXPORT __ENH_First_Degree_Relative_2 := PROJECT(__EE6434330,__ST1470134_Layout);
END;
