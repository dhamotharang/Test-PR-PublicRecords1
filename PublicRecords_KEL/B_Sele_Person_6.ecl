...
EXPORT B_Sele_Person_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE373704 := __ENH_Sele_Person_7;
  EXPORT __ST164156_Layout := RECORD
  ...
  END;
  SHARED __ST164156_Layout __ND373772__Project(B_Sele_Person_7(__in,__cfg).__ST166642_Layout __PP373570) := TRANSFORM
    ...
    SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP373570.Assoc_Date_),__ECAST(KEL.typ.nkdate,__CC9656));
    SELF := __PP373570;
  END;
  EXPORT __ENH_Sele_Person_6 := PROJECT(__EE373704,__ND373772__Project(LEFT));
END;
