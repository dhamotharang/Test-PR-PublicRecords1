...
EXPORT B_Sele_Person_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6616312 := __ENH_Sele_Person_7;
  EXPORT __ST285626_Layout := RECORD
  ...
  END;
  SHARED __ST285626_Layout __ND6616317__Project(B_Sele_Person_7(__in,__cfg).__ST289002_Layout __PP6616313) := TRANSFORM
    ...
    SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP6616313.Assoc_Date_),__ECAST(KEL.typ.nkdate,__CC13459));
    SELF := __PP6616313;
  END;
  EXPORT __ENH_Sele_Person_6 := PROJECT(__EE6616312,__ND6616317__Project(LEFT));
END;
