...
EXPORT B_Sele_Person_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4876806 := __ENH_Sele_Person_7;
  EXPORT __ST246672_Layout := RECORD
  ...
  END;
  SHARED __ST246672_Layout __ND4876811__Project(B_Sele_Person_7(__in,__cfg).__ST249706_Layout __PP4876807) := TRANSFORM
    ...
    SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP4876807.Assoc_Date_),__ECAST(KEL.typ.nkdate,__CC13174));
    SELF := __PP4876807;
  END;
  EXPORT __ENH_Sele_Person_6 := PROJECT(__EE4876806,__ND4876811__Project(LEFT));
END;
