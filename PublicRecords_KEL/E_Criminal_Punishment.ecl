...
EXPORT E_Criminal_Punishment(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  Layout Criminal_Punishment__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Sources_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Source_File_},Source_File_),Sources_Layout)(__NN(Source_File_)));
    SELF.Reported_Punishment_Persistent_I_Ds_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Punishment_Persistent_I_D_},Punishment_Persistent_I_D_),Reported_Punishment_Persistent_I_Ds_Layout)(__NN(Punishment_Persistent_I_D_)));
    SELF.Reported_Punishment_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Sentence_Length_,Sentence_Description_,Sentence_Length_Description_,Sentence_Type_,Date_Of_Sentence_,Incarceration_Admission_Date_,Scheduled_Release_Date_,Actual_Release_Date_,Control_Release_Date_,Presumptive_Parole_Release_Date_,Parole_Current_Status_,Parole_Current_Status_Description_,Parole_Start_Date_,Parole_Scheduled_Release_Date_,Parole_Actual_Release_Date_,Parole_County_,Probation_Start_Date_,Probation_End_Date_,Probation_Status_,Additional_Provision1_,Additional_Provision2_,Additional_Sentence_Dates_,Probation_Description_,Minimum_Term_,Minimum_Term_Description_,Maximum_Term_,Maximum_Term_Description_},Sentence_Length_,Sentence_Description_,Sentence_Length_Description_,Sentence_Type_,Date_Of_Sentence_,Incarceration_Admission_Date_,Scheduled_Release_Date_,Actual_Release_Date_,Control_Release_Date_,Presumptive_Parole_Release_Date_,Parole_Current_Status_,Parole_Current_Status_Description_,Parole_Start_Date_,Parole_Scheduled_Release_Date_,Parole_Actual_Release_Date_,Parole_County_,Probation_Start_Date_,Probation_End_Date_,Probation_Status_,Additional_Provision1_,Additional_Provision2_,Additional_Sentence_Dates_,Probation_Description_,Minimum_Term_,Minimum_Term_Description_,Maximum_Term_,Maximum_Term_Description_),Reported_Punishment_Layout)(__NN(Sentence_Length_) OR __NN(Sentence_Description_) OR __NN(Sentence_Length_Description_) OR __NN(Sentence_Type_) OR __NN(Date_Of_Sentence_) OR __NN(Incarceration_Admission_Date_) OR __NN(Scheduled_Release_Date_) OR __NN(Actual_Release_Date_) OR __NN(Control_Release_Date_) OR __NN(Presumptive_Parole_Release_Date_) OR __NN(Parole_Current_Status_) OR __NN(Parole_Current_Status_Description_) OR __NN(Parole_Start_Date_) OR __NN(Parole_Scheduled_Release_Date_) OR __NN(Parole_Actual_Release_Date_) OR __NN(Parole_County_) OR __NN(Probation_Start_Date_) OR __NN(Probation_End_Date_) OR __NN(Probation_Status_) OR __NN(Additional_Provision1_) OR __NN(Additional_Provision2_) OR __NN(Additional_Sentence_Dates_) OR __NN(Probation_Description_) OR __NN(Minimum_Term_) OR __NN(Minimum_Term_Description_) OR __NN(Maximum_Term_) OR __NN(Maximum_Term_Description_)));
