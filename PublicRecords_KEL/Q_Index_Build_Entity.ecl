...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5415486 := __E_Accident;
  SHARED __EE5415488 := __EE5415486;
  EXPORT Res0 := __UNWRAP(__EE5415488);
  SHARED __EE12068443 := __ENH_Address;
  SHARED __EE12068445 := __EE12068443;
  EXPORT Res1 := __UNWRAP(__EE12068445);
  SHARED __EE12068448 := __ENH_Address_Summary;
  SHARED __EE12068450 := __EE12068448;
  EXPORT Res2 := __UNWRAP(__EE12068450);
  SHARED __EE5415497 := __E_Aircraft;
  SHARED __EE5415499 := __EE5415497;
  EXPORT Res3 := __UNWRAP(__EE5415499);
  SHARED __EE12068454 := __ENH_Bankruptcy;
  SHARED __EE12068456 := __EE12068454;
  EXPORT Res4 := __UNWRAP(__EE12068456);
  SHARED __EE5415504 := __E_Business_Ult;
  SHARED __EE5415506 := __EE5415504;
  EXPORT Res5 := __UNWRAP(__EE5415506);
  SHARED __EE5415507 := __E_Business_Org;
  SHARED __EE5415509 := __EE5415507;
  EXPORT Res6 := __UNWRAP(__EE5415509);
  SHARED __EE12068461 := __ENH_Business_Sele;
  SHARED __EE12068463 := __EE12068461;
  EXPORT Res7 := __UNWRAP(__EE12068463);
  SHARED __EE12068466 := __ENH_Business_Prox;
  SHARED __EE12068468 := __EE12068466;
  EXPORT Res8 := __UNWRAP(__EE12068468);
  SHARED __EE5415518 := __E_Business_Pow;
  SHARED __EE5415520 := __EE5415518;
  EXPORT Res9 := __UNWRAP(__EE5415520);
  SHARED __EE5415521 := __E_Criminal_Offender;
  SHARED __EE5415523 := __EE5415521;
  EXPORT Res10 := __UNWRAP(__EE5415523);
  SHARED __EE12068473 := __ENH_Criminal_Offense;
  SHARED __EE12068475 := __EE12068473;
  EXPORT Res11 := __UNWRAP(__EE12068475);
  SHARED __EE5415528 := __E_Criminal_Punishment;
  SHARED __EE5415530 := __EE5415528;
  EXPORT Res12 := __UNWRAP(__EE5415530);
  SHARED __EE5415531 := __E_Drivers_License;
  SHARED __EE5415533 := __EE5415531;
  EXPORT Res13 := __UNWRAP(__EE5415533);
  SHARED __EE5415534 := __E_E_B_R_Tradeline;
  SHARED __EE5415536 := __EE5415534;
  EXPORT Res14 := __UNWRAP(__EE5415536);
  SHARED __EE12068481 := __ENH_Education;
  SHARED __EE12068483 := __EE12068481;
  EXPORT Res15 := __UNWRAP(__EE12068483);
  SHARED __EE12068486 := __ENH_Email;
  SHARED __EE12068488 := __EE12068486;
  EXPORT Res16 := __UNWRAP(__EE12068488);
  SHARED __EE5415545 := __E_Household;
  SHARED __EE5415547 := __EE5415545;
  EXPORT Res17 := __UNWRAP(__EE5415547);
  SHARED __EE12068492 := __ENH_Inquiry;
  SHARED __EE12068494 := __EE12068492;
  EXPORT Res18 := __UNWRAP(__EE12068494);
  SHARED __EE12068497 := __ENH_Lien_Judgment;
  SHARED __EE12068499 := __EE12068497;
  EXPORT Res19 := __UNWRAP(__EE12068499);
  SHARED __EE5415556 := __E_Geo_Link;
  SHARED __EE5415558 := __EE5415556;
  EXPORT Res20 := __UNWRAP(__EE5415558);
  SHARED __EE12068503 := __ENH_Name_Summary;
  SHARED __EE12068505 := __EE12068503;
  EXPORT Res21 := __UNWRAP(__EE12068505);
  SHARED __EE12068508 := __ENH_Person;
  SHARED __EE12068510 := __EE12068508;
  EXPORT Res22 := __UNWRAP(__EE12068510);
  SHARED __EE5415567 := __E_Phone;
  SHARED __EE5415569 := __EE5415567;
  EXPORT Res23 := __UNWRAP(__EE5415569);
  SHARED __EE12068514 := __ENH_Phone_Summary;
  SHARED __EE12068516 := __EE12068514;
  EXPORT Res24 := __UNWRAP(__EE12068516);
  SHARED __EE12068519 := __ENH_Professional_License;
  SHARED __EE12068521 := __EE12068519;
  EXPORT Res25 := __UNWRAP(__EE12068521);
  SHARED __EE12068524 := __ENH_Property;
  SHARED __EE12068526 := __EE12068524;
  EXPORT Res26 := __UNWRAP(__EE12068526);
  SHARED __EE12068529 := __ENH_Property_Event;
  SHARED __EE12068531 := __EE12068529;
  EXPORT Res27 := __UNWRAP(__EE12068531);
  SHARED __EE5415586 := __E_Sex_Offender;
  SHARED __EE5415588 := __EE5415586;
  EXPORT Res28 := __UNWRAP(__EE5415588);
  SHARED __EE5415589 := __E_Social_Security_Number;
  SHARED __EE5415591 := __EE5415589;
  EXPORT Res29 := __UNWRAP(__EE5415591);
  SHARED __EE12068536 := __ENH_S_S_N_Summary;
  SHARED __EE12068538 := __EE12068536;
  EXPORT Res30 := __UNWRAP(__EE12068538);
  SHARED __EE5415596 := __E_Surname;
  SHARED __EE5415598 := __EE5415596;
  EXPORT Res31 := __UNWRAP(__EE5415598);
  SHARED __EE5415599 := __E_T_I_N;
  SHARED __EE5415601 := __EE5415599;
  EXPORT Res32 := __UNWRAP(__EE5415601);
  SHARED __EE12068543 := __ENH_Tradeline;
  SHARED __EE12068545 := __EE12068543;
  EXPORT Res33 := __UNWRAP(__EE12068545);
  SHARED __EE12068548 := __ENH_U_C_C;
  SHARED __EE12068550 := __EE12068548;
  EXPORT Res34 := __UNWRAP(__EE12068550);
  SHARED __EE5415610 := __E_Utility;
  SHARED __EE5415612 := __EE5415610;
  EXPORT Res35 := __UNWRAP(__EE5415612);
  SHARED __EE5415613 := __E_Vehicle;
  SHARED __EE5415615 := __EE5415613;
  EXPORT Res36 := __UNWRAP(__EE5415615);
  SHARED __EE5415616 := __E_Watercraft;
  SHARED __EE5415618 := __EE5415616;
  EXPORT Res37 := __UNWRAP(__EE5415618);
  SHARED __EE5415619 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5415619);
