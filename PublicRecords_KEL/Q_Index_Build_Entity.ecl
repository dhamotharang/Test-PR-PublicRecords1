...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5504847 := __E_Accident;
  SHARED __EE5504849 := __EE5504847;
  EXPORT Res0 := __UNWRAP(__EE5504849);
  SHARED __EE15135212 := __ENH_Address;
  SHARED __EE15135214 := __EE15135212;
  EXPORT Res1 := __UNWRAP(__EE15135214);
  SHARED __EE15135217 := __ENH_Address_Summary;
  SHARED __EE15135219 := __EE15135217;
  EXPORT Res2 := __UNWRAP(__EE15135219);
  SHARED __EE5504858 := __E_Aircraft;
  SHARED __EE5504860 := __EE5504858;
  EXPORT Res3 := __UNWRAP(__EE5504860);
  SHARED __EE15135223 := __ENH_Bankruptcy;
  SHARED __EE15135225 := __EE15135223;
  EXPORT Res4 := __UNWRAP(__EE15135225);
  SHARED __EE5504865 := __E_Business_Ult;
  SHARED __EE5504867 := __EE5504865;
  EXPORT Res5 := __UNWRAP(__EE5504867);
  SHARED __EE5504868 := __E_Business_Org;
  SHARED __EE5504870 := __EE5504868;
  EXPORT Res6 := __UNWRAP(__EE5504870);
  SHARED __EE15135230 := __ENH_Business_Sele;
  SHARED __EE15135232 := __EE15135230;
  EXPORT Res7 := __UNWRAP(__EE15135232);
  SHARED __EE15135235 := __ENH_Business_Prox;
  SHARED __EE15135237 := __EE15135235;
  EXPORT Res8 := __UNWRAP(__EE15135237);
  SHARED __EE5504879 := __E_Business_Pow;
  SHARED __EE5504881 := __EE5504879;
  EXPORT Res9 := __UNWRAP(__EE5504881);
  SHARED __EE5504882 := __E_Criminal_Offender;
  SHARED __EE5504884 := __EE5504882;
  EXPORT Res10 := __UNWRAP(__EE5504884);
  SHARED __EE15135242 := __ENH_Criminal_Offense;
  SHARED __EE15135244 := __EE15135242;
  EXPORT Res11 := __UNWRAP(__EE15135244);
  SHARED __EE5504889 := __E_Criminal_Punishment;
  SHARED __EE5504891 := __EE5504889;
  EXPORT Res12 := __UNWRAP(__EE5504891);
  SHARED __EE5504892 := __E_Drivers_License;
  SHARED __EE5504894 := __EE5504892;
  EXPORT Res13 := __UNWRAP(__EE5504894);
  SHARED __EE5504895 := __E_E_B_R_Tradeline;
  SHARED __EE5504897 := __EE5504895;
  EXPORT Res14 := __UNWRAP(__EE5504897);
  SHARED __EE15135250 := __ENH_Education;
  SHARED __EE15135252 := __EE15135250;
  EXPORT Res15 := __UNWRAP(__EE15135252);
  SHARED __EE15135255 := __ENH_Email;
  SHARED __EE15135257 := __EE15135255;
  EXPORT Res16 := __UNWRAP(__EE15135257);
  SHARED __EE5504906 := __E_Household;
  SHARED __EE5504908 := __EE5504906;
  EXPORT Res17 := __UNWRAP(__EE5504908);
  SHARED __EE15135261 := __ENH_Inquiry;
  SHARED __EE15135263 := __EE15135261;
  EXPORT Res18 := __UNWRAP(__EE15135263);
  SHARED __EE15135266 := __ENH_Lien_Judgment;
  SHARED __EE15135268 := __EE15135266;
  EXPORT Res19 := __UNWRAP(__EE15135268);
  SHARED __EE5504917 := __E_Geo_Link;
  SHARED __EE5504919 := __EE5504917;
  EXPORT Res20 := __UNWRAP(__EE5504919);
  SHARED __EE15135272 := __ENH_Name_Summary;
  SHARED __EE15135274 := __EE15135272;
  EXPORT Res21 := __UNWRAP(__EE15135274);
  SHARED __EE15135277 := __ENH_Person;
  SHARED __EE15135279 := __EE15135277;
  EXPORT Res22 := __UNWRAP(__EE15135279);
  SHARED __EE5504928 := __E_Phone;
  SHARED __EE5504930 := __EE5504928;
  EXPORT Res23 := __UNWRAP(__EE5504930);
  SHARED __EE15135283 := __ENH_Phone_Summary;
  SHARED __EE15135285 := __EE15135283;
  EXPORT Res24 := __UNWRAP(__EE15135285);
  SHARED __EE15135288 := __ENH_Professional_License;
  SHARED __EE15135290 := __EE15135288;
  EXPORT Res25 := __UNWRAP(__EE15135290);
  SHARED __EE15135293 := __ENH_Property;
  SHARED __EE15135295 := __EE15135293;
  EXPORT Res26 := __UNWRAP(__EE15135295);
  SHARED __EE15135298 := __ENH_Property_Event;
  SHARED __EE15135300 := __EE15135298;
  EXPORT Res27 := __UNWRAP(__EE15135300);
  SHARED __EE5504947 := __E_Sex_Offender;
  SHARED __EE5504949 := __EE5504947;
  EXPORT Res28 := __UNWRAP(__EE5504949);
  SHARED __EE5504950 := __E_Social_Security_Number;
  SHARED __EE5504952 := __EE5504950;
  EXPORT Res29 := __UNWRAP(__EE5504952);
  SHARED __EE15135305 := __ENH_S_S_N_Summary;
  SHARED __EE15135307 := __EE15135305;
  EXPORT Res30 := __UNWRAP(__EE15135307);
  SHARED __EE5504957 := __E_Surname;
  SHARED __EE5504959 := __EE5504957;
  EXPORT Res31 := __UNWRAP(__EE5504959);
  SHARED __EE5504960 := __E_T_I_N;
  SHARED __EE5504962 := __EE5504960;
  EXPORT Res32 := __UNWRAP(__EE5504962);
  SHARED __EE15135312 := __ENH_Tradeline;
  SHARED __EE15135314 := __EE15135312;
  EXPORT Res33 := __UNWRAP(__EE15135314);
  SHARED __EE15135317 := __ENH_U_C_C;
  SHARED __EE15135319 := __EE15135317;
  EXPORT Res34 := __UNWRAP(__EE15135319);
  SHARED __EE5504971 := __E_Utility;
  SHARED __EE5504973 := __EE5504971;
  EXPORT Res35 := __UNWRAP(__EE5504973);
  SHARED __EE5504974 := __E_Vehicle;
  SHARED __EE5504976 := __EE5504974;
  EXPORT Res36 := __UNWRAP(__EE5504976);
  SHARED __EE5504977 := __E_Watercraft;
  SHARED __EE5504979 := __EE5504977;
  EXPORT Res37 := __UNWRAP(__EE5504979);
  SHARED __EE5504980 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5504980);
