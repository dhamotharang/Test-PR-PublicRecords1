...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5003281 := __E_Accident;
  SHARED __EE5003283 := __EE5003281;
  EXPORT Res0 := __UNWRAP(__EE5003283);
  SHARED __EE11472769 := __ENH_Address;
  SHARED __EE11472771 := __EE11472769;
  EXPORT Res1 := __UNWRAP(__EE11472771);
  SHARED __EE11472774 := __ENH_Address_Summary;
  SHARED __EE11472776 := __EE11472774;
  EXPORT Res2 := __UNWRAP(__EE11472776);
  SHARED __EE5003292 := __E_Aircraft;
  SHARED __EE5003294 := __EE5003292;
  EXPORT Res3 := __UNWRAP(__EE5003294);
  SHARED __EE11472780 := __ENH_Bankruptcy;
  SHARED __EE11472782 := __EE11472780;
  EXPORT Res4 := __UNWRAP(__EE11472782);
  SHARED __EE5003299 := __E_Business_Ult;
  SHARED __EE5003301 := __EE5003299;
  EXPORT Res5 := __UNWRAP(__EE5003301);
  SHARED __EE5003302 := __E_Business_Org;
  SHARED __EE5003304 := __EE5003302;
  EXPORT Res6 := __UNWRAP(__EE5003304);
  SHARED __EE11472787 := __ENH_Business_Sele;
  SHARED __EE11472789 := __EE11472787;
  EXPORT Res7 := __UNWRAP(__EE11472789);
  SHARED __EE11472792 := __ENH_Business_Prox;
  SHARED __EE11472794 := __EE11472792;
  EXPORT Res8 := __UNWRAP(__EE11472794);
  SHARED __EE5003313 := __E_Business_Pow;
  SHARED __EE5003315 := __EE5003313;
  EXPORT Res9 := __UNWRAP(__EE5003315);
  SHARED __EE5003316 := __E_Criminal_Offender;
  SHARED __EE5003318 := __EE5003316;
  EXPORT Res10 := __UNWRAP(__EE5003318);
  SHARED __EE11472799 := __ENH_Criminal_Offense;
  SHARED __EE11472801 := __EE11472799;
  EXPORT Res11 := __UNWRAP(__EE11472801);
  SHARED __EE5003323 := __E_Criminal_Punishment;
  SHARED __EE5003325 := __EE5003323;
  EXPORT Res12 := __UNWRAP(__EE5003325);
  SHARED __EE5003326 := __E_Drivers_License;
  SHARED __EE5003328 := __EE5003326;
  EXPORT Res13 := __UNWRAP(__EE5003328);
  SHARED __EE5003329 := __E_E_B_R_Tradeline;
  SHARED __EE5003331 := __EE5003329;
  EXPORT Res14 := __UNWRAP(__EE5003331);
  SHARED __EE11472807 := __ENH_Education;
  SHARED __EE11472809 := __EE11472807;
  EXPORT Res15 := __UNWRAP(__EE11472809);
  SHARED __EE11472812 := __ENH_Email;
  SHARED __EE11472814 := __EE11472812;
  EXPORT Res16 := __UNWRAP(__EE11472814);
  SHARED __EE5003340 := __E_Household;
  SHARED __EE5003342 := __EE5003340;
  EXPORT Res17 := __UNWRAP(__EE5003342);
  SHARED __EE11472818 := __ENH_Inquiry;
  SHARED __EE11472820 := __EE11472818;
  EXPORT Res18 := __UNWRAP(__EE11472820);
  SHARED __EE11472823 := __ENH_Lien_Judgment;
  SHARED __EE11472825 := __EE11472823;
  EXPORT Res19 := __UNWRAP(__EE11472825);
  SHARED __EE5003351 := __E_Geo_Link;
  SHARED __EE5003353 := __EE5003351;
  EXPORT Res20 := __UNWRAP(__EE5003353);
  SHARED __EE11472829 := __ENH_Name_Summary;
  SHARED __EE11472831 := __EE11472829;
  EXPORT Res21 := __UNWRAP(__EE11472831);
  SHARED __EE11472834 := __ENH_Person;
  SHARED __EE11472836 := __EE11472834;
  EXPORT Res22 := __UNWRAP(__EE11472836);
  SHARED __EE5003362 := __E_Phone;
  SHARED __EE5003364 := __EE5003362;
  EXPORT Res23 := __UNWRAP(__EE5003364);
  SHARED __EE11472840 := __ENH_Phone_Summary;
  SHARED __EE11472842 := __EE11472840;
  EXPORT Res24 := __UNWRAP(__EE11472842);
  SHARED __EE11472845 := __ENH_Professional_License;
  SHARED __EE11472847 := __EE11472845;
  EXPORT Res25 := __UNWRAP(__EE11472847);
  SHARED __EE11472850 := __ENH_Property;
  SHARED __EE11472852 := __EE11472850;
  EXPORT Res26 := __UNWRAP(__EE11472852);
  SHARED __EE11472855 := __ENH_Property_Event;
  SHARED __EE11472857 := __EE11472855;
  EXPORT Res27 := __UNWRAP(__EE11472857);
  SHARED __EE5003381 := __E_Sex_Offender;
  SHARED __EE5003383 := __EE5003381;
  EXPORT Res28 := __UNWRAP(__EE5003383);
  SHARED __EE5003384 := __E_Social_Security_Number;
  SHARED __EE5003386 := __EE5003384;
  EXPORT Res29 := __UNWRAP(__EE5003386);
  SHARED __EE11472862 := __ENH_S_S_N_Summary;
  SHARED __EE11472864 := __EE11472862;
  EXPORT Res30 := __UNWRAP(__EE11472864);
  SHARED __EE5003391 := __E_Surname;
  SHARED __EE5003393 := __EE5003391;
  EXPORT Res31 := __UNWRAP(__EE5003393);
  SHARED __EE5003394 := __E_T_I_N;
  SHARED __EE5003396 := __EE5003394;
  EXPORT Res32 := __UNWRAP(__EE5003396);
  SHARED __EE11472869 := __ENH_Tradeline;
  SHARED __EE11472871 := __EE11472869;
  EXPORT Res33 := __UNWRAP(__EE11472871);
  SHARED __EE11472874 := __ENH_U_C_C;
  SHARED __EE11472876 := __EE11472874;
  EXPORT Res34 := __UNWRAP(__EE11472876);
  SHARED __EE5003405 := __E_Utility;
  SHARED __EE5003407 := __EE5003405;
  EXPORT Res35 := __UNWRAP(__EE5003407);
  SHARED __EE5003408 := __E_Vehicle;
  SHARED __EE5003410 := __EE5003408;
  EXPORT Res36 := __UNWRAP(__EE5003410);
  SHARED __EE5003411 := __E_Watercraft;
  SHARED __EE5003413 := __EE5003411;
  EXPORT Res37 := __UNWRAP(__EE5003413);
  SHARED __EE5003414 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5003414);
