...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5342460 := __E_Accident;
  SHARED __EE5342462 := __EE5342460;
  EXPORT Res0 := __UNWRAP(__EE5342462);
  SHARED __EE11750514 := __ENH_Address;
  SHARED __EE11750516 := __EE11750514;
  EXPORT Res1 := __UNWRAP(__EE11750516);
  SHARED __EE11750519 := __ENH_Address_Summary;
  SHARED __EE11750521 := __EE11750519;
  EXPORT Res2 := __UNWRAP(__EE11750521);
  SHARED __EE5342471 := __E_Aircraft;
  SHARED __EE5342473 := __EE5342471;
  EXPORT Res3 := __UNWRAP(__EE5342473);
  SHARED __EE11750525 := __ENH_Bankruptcy;
  SHARED __EE11750527 := __EE11750525;
  EXPORT Res4 := __UNWRAP(__EE11750527);
  SHARED __EE5342478 := __E_Business_Ult;
  SHARED __EE5342480 := __EE5342478;
  EXPORT Res5 := __UNWRAP(__EE5342480);
  SHARED __EE5342481 := __E_Business_Org;
  SHARED __EE5342483 := __EE5342481;
  EXPORT Res6 := __UNWRAP(__EE5342483);
  SHARED __EE11750532 := __ENH_Business_Sele;
  SHARED __EE11750534 := __EE11750532;
  EXPORT Res7 := __UNWRAP(__EE11750534);
  SHARED __EE11750537 := __ENH_Business_Prox;
  SHARED __EE11750539 := __EE11750537;
  EXPORT Res8 := __UNWRAP(__EE11750539);
  SHARED __EE5342492 := __E_Business_Pow;
  SHARED __EE5342494 := __EE5342492;
  EXPORT Res9 := __UNWRAP(__EE5342494);
  SHARED __EE5342495 := __E_Criminal_Offender;
  SHARED __EE5342497 := __EE5342495;
  EXPORT Res10 := __UNWRAP(__EE5342497);
  SHARED __EE11750544 := __ENH_Criminal_Offense;
  SHARED __EE11750546 := __EE11750544;
  EXPORT Res11 := __UNWRAP(__EE11750546);
  SHARED __EE5342502 := __E_Criminal_Punishment;
  SHARED __EE5342504 := __EE5342502;
  EXPORT Res12 := __UNWRAP(__EE5342504);
  SHARED __EE5342505 := __E_Drivers_License;
  SHARED __EE5342507 := __EE5342505;
  EXPORT Res13 := __UNWRAP(__EE5342507);
  SHARED __EE5342508 := __E_E_B_R_Tradeline;
  SHARED __EE5342510 := __EE5342508;
  EXPORT Res14 := __UNWRAP(__EE5342510);
  SHARED __EE11750552 := __ENH_Education;
  SHARED __EE11750554 := __EE11750552;
  EXPORT Res15 := __UNWRAP(__EE11750554);
  SHARED __EE11750557 := __ENH_Email;
  SHARED __EE11750559 := __EE11750557;
  EXPORT Res16 := __UNWRAP(__EE11750559);
  SHARED __EE5342519 := __E_Household;
  SHARED __EE5342521 := __EE5342519;
  EXPORT Res17 := __UNWRAP(__EE5342521);
  SHARED __EE11750563 := __ENH_Inquiry;
  SHARED __EE11750565 := __EE11750563;
  EXPORT Res18 := __UNWRAP(__EE11750565);
  SHARED __EE11750568 := __ENH_Lien_Judgment;
  SHARED __EE11750570 := __EE11750568;
  EXPORT Res19 := __UNWRAP(__EE11750570);
  SHARED __EE5342530 := __E_Geo_Link;
  SHARED __EE5342532 := __EE5342530;
  EXPORT Res20 := __UNWRAP(__EE5342532);
  SHARED __EE11750574 := __ENH_Name_Summary;
  SHARED __EE11750576 := __EE11750574;
  EXPORT Res21 := __UNWRAP(__EE11750576);
  SHARED __EE11750579 := __ENH_Person;
  SHARED __EE11750581 := __EE11750579;
  EXPORT Res22 := __UNWRAP(__EE11750581);
  SHARED __EE5342541 := __E_Phone;
  SHARED __EE5342543 := __EE5342541;
  EXPORT Res23 := __UNWRAP(__EE5342543);
  SHARED __EE11750585 := __ENH_Phone_Summary;
  SHARED __EE11750587 := __EE11750585;
  EXPORT Res24 := __UNWRAP(__EE11750587);
  SHARED __EE11750590 := __ENH_Professional_License;
  SHARED __EE11750592 := __EE11750590;
  EXPORT Res25 := __UNWRAP(__EE11750592);
  SHARED __EE11750595 := __ENH_Property;
  SHARED __EE11750597 := __EE11750595;
  EXPORT Res26 := __UNWRAP(__EE11750597);
  SHARED __EE11750600 := __ENH_Property_Event;
  SHARED __EE11750602 := __EE11750600;
  EXPORT Res27 := __UNWRAP(__EE11750602);
  SHARED __EE5342560 := __E_Sex_Offender;
  SHARED __EE5342562 := __EE5342560;
  EXPORT Res28 := __UNWRAP(__EE5342562);
  SHARED __EE5342563 := __E_Social_Security_Number;
  SHARED __EE5342565 := __EE5342563;
  EXPORT Res29 := __UNWRAP(__EE5342565);
  SHARED __EE11750607 := __ENH_S_S_N_Summary;
  SHARED __EE11750609 := __EE11750607;
  EXPORT Res30 := __UNWRAP(__EE11750609);
  SHARED __EE5342570 := __E_Surname;
  SHARED __EE5342572 := __EE5342570;
  EXPORT Res31 := __UNWRAP(__EE5342572);
  SHARED __EE5342573 := __E_T_I_N;
  SHARED __EE5342575 := __EE5342573;
  EXPORT Res32 := __UNWRAP(__EE5342575);
  SHARED __EE11750614 := __ENH_Tradeline;
  SHARED __EE11750616 := __EE11750614;
  EXPORT Res33 := __UNWRAP(__EE11750616);
  SHARED __EE11750619 := __ENH_U_C_C;
  SHARED __EE11750621 := __EE11750619;
  EXPORT Res34 := __UNWRAP(__EE11750621);
  SHARED __EE5342584 := __E_Utility;
  SHARED __EE5342586 := __EE5342584;
  EXPORT Res35 := __UNWRAP(__EE5342586);
  SHARED __EE5342587 := __E_Vehicle;
  SHARED __EE5342589 := __EE5342587;
  EXPORT Res36 := __UNWRAP(__EE5342589);
  SHARED __EE5342590 := __E_Watercraft;
  SHARED __EE5342592 := __EE5342590;
  EXPORT Res37 := __UNWRAP(__EE5342592);
  SHARED __EE5342593 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5342593);
