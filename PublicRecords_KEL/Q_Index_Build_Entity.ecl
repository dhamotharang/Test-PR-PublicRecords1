...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4735470 := __E_Accident;
  SHARED __EE4735472 := __EE4735470;
  EXPORT Res0 := __UNWRAP(__EE4735472);
  SHARED __EE11608300 := __ENH_Address;
  SHARED __EE11608302 := __EE11608300;
  EXPORT Res1 := __UNWRAP(__EE11608302);
  SHARED __EE11608305 := __ENH_Address_Summary;
  SHARED __EE11608307 := __EE11608305;
  EXPORT Res2 := __UNWRAP(__EE11608307);
  SHARED __EE4735481 := __E_Aircraft;
  SHARED __EE4735483 := __EE4735481;
  EXPORT Res3 := __UNWRAP(__EE4735483);
  SHARED __EE11608311 := __ENH_Bankruptcy;
  SHARED __EE11608313 := __EE11608311;
  EXPORT Res4 := __UNWRAP(__EE11608313);
  SHARED __EE4735488 := __E_Business_Ult;
  SHARED __EE4735490 := __EE4735488;
  EXPORT Res5 := __UNWRAP(__EE4735490);
  SHARED __EE4735491 := __E_Business_Org;
  SHARED __EE4735493 := __EE4735491;
  EXPORT Res6 := __UNWRAP(__EE4735493);
  SHARED __EE11608318 := __ENH_Business_Sele;
  SHARED __EE11608320 := __EE11608318;
  EXPORT Res7 := __UNWRAP(__EE11608320);
  SHARED __EE11608323 := __ENH_Business_Prox;
  SHARED __EE11608325 := __EE11608323;
  EXPORT Res8 := __UNWRAP(__EE11608325);
  SHARED __EE4735502 := __E_Business_Pow;
  SHARED __EE4735504 := __EE4735502;
  EXPORT Res9 := __UNWRAP(__EE4735504);
  SHARED __EE4735505 := __E_Criminal_Offender;
  SHARED __EE4735507 := __EE4735505;
  EXPORT Res10 := __UNWRAP(__EE4735507);
  SHARED __EE11608330 := __ENH_Criminal_Offense;
  SHARED __EE11608332 := __EE11608330;
  EXPORT Res11 := __UNWRAP(__EE11608332);
  SHARED __EE4735512 := __E_Criminal_Punishment;
  SHARED __EE4735514 := __EE4735512;
  EXPORT Res12 := __UNWRAP(__EE4735514);
  SHARED __EE4735515 := __E_Drivers_License;
  SHARED __EE4735517 := __EE4735515;
  EXPORT Res13 := __UNWRAP(__EE4735517);
  SHARED __EE4735518 := __E_E_B_R_Tradeline;
  SHARED __EE4735520 := __EE4735518;
  EXPORT Res14 := __UNWRAP(__EE4735520);
  SHARED __EE11608338 := __ENH_Education;
  SHARED __EE11608340 := __EE11608338;
  EXPORT Res15 := __UNWRAP(__EE11608340);
  SHARED __EE11608343 := __ENH_Email;
  SHARED __EE11608345 := __EE11608343;
  EXPORT Res16 := __UNWRAP(__EE11608345);
  SHARED __EE4735529 := __E_Household;
  SHARED __EE4735531 := __EE4735529;
  EXPORT Res17 := __UNWRAP(__EE4735531);
  SHARED __EE11608349 := __ENH_Inquiry;
  SHARED __EE11608351 := __EE11608349;
  EXPORT Res18 := __UNWRAP(__EE11608351);
  SHARED __EE11608354 := __ENH_Lien_Judgment;
  SHARED __EE11608356 := __EE11608354;
  EXPORT Res19 := __UNWRAP(__EE11608356);
  SHARED __EE4735540 := __E_Geo_Link;
  SHARED __EE4735542 := __EE4735540;
  EXPORT Res20 := __UNWRAP(__EE4735542);
  SHARED __EE11608360 := __ENH_Name_Summary;
  SHARED __EE11608362 := __EE11608360;
  EXPORT Res21 := __UNWRAP(__EE11608362);
  SHARED __EE11608365 := __ENH_Person;
  SHARED __EE11608367 := __EE11608365;
  EXPORT Res22 := __UNWRAP(__EE11608367);
  SHARED __EE4735551 := __E_Phone;
  SHARED __EE4735553 := __EE4735551;
  EXPORT Res23 := __UNWRAP(__EE4735553);
  SHARED __EE11608371 := __ENH_Phone_Summary;
  SHARED __EE11608373 := __EE11608371;
  EXPORT Res24 := __UNWRAP(__EE11608373);
  SHARED __EE11608376 := __ENH_Professional_License;
  SHARED __EE11608378 := __EE11608376;
  EXPORT Res25 := __UNWRAP(__EE11608378);
  SHARED __EE11608381 := __ENH_Property;
  SHARED __EE11608383 := __EE11608381;
  EXPORT Res26 := __UNWRAP(__EE11608383);
  SHARED __EE11608386 := __ENH_Property_Event;
  SHARED __EE11608388 := __EE11608386;
  EXPORT Res27 := __UNWRAP(__EE11608388);
  SHARED __EE4735570 := __E_Sex_Offender;
  SHARED __EE4735572 := __EE4735570;
  EXPORT Res28 := __UNWRAP(__EE4735572);
  SHARED __EE4735573 := __E_Social_Security_Number;
  SHARED __EE4735575 := __EE4735573;
  EXPORT Res29 := __UNWRAP(__EE4735575);
  SHARED __EE11608393 := __ENH_S_S_N_Summary;
  SHARED __EE11608395 := __EE11608393;
  EXPORT Res30 := __UNWRAP(__EE11608395);
  SHARED __EE4735580 := __E_Surname;
  SHARED __EE4735582 := __EE4735580;
  EXPORT Res31 := __UNWRAP(__EE4735582);
  SHARED __EE4735583 := __E_T_I_N;
  SHARED __EE4735585 := __EE4735583;
  EXPORT Res32 := __UNWRAP(__EE4735585);
  SHARED __EE11608400 := __ENH_Tradeline;
  SHARED __EE11608402 := __EE11608400;
  EXPORT Res33 := __UNWRAP(__EE11608402);
  SHARED __EE11608405 := __ENH_U_C_C;
  SHARED __EE11608407 := __EE11608405;
  EXPORT Res34 := __UNWRAP(__EE11608407);
  SHARED __EE4735594 := __E_Utility;
  SHARED __EE4735596 := __EE4735594;
  EXPORT Res35 := __UNWRAP(__EE4735596);
  SHARED __EE4735597 := __E_Vehicle;
  SHARED __EE4735599 := __EE4735597;
  EXPORT Res36 := __UNWRAP(__EE4735599);
  SHARED __EE4735600 := __E_Watercraft;
  SHARED __EE4735602 := __EE4735600;
  EXPORT Res37 := __UNWRAP(__EE4735602);
  SHARED __EE4735603 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4735603);
