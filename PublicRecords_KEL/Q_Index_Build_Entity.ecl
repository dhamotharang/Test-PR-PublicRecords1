...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5355557 := __E_Accident;
  SHARED __EE5355559 := __EE5355557;
  EXPORT Res0 := __UNWRAP(__EE5355559);
  SHARED __EE11939211 := __ENH_Address;
  SHARED __EE11939213 := __EE11939211;
  EXPORT Res1 := __UNWRAP(__EE11939213);
  SHARED __EE11939216 := __ENH_Address_Summary;
  SHARED __EE11939218 := __EE11939216;
  EXPORT Res2 := __UNWRAP(__EE11939218);
  SHARED __EE5355568 := __E_Aircraft;
  SHARED __EE5355570 := __EE5355568;
  EXPORT Res3 := __UNWRAP(__EE5355570);
  SHARED __EE11939222 := __ENH_Bankruptcy;
  SHARED __EE11939224 := __EE11939222;
  EXPORT Res4 := __UNWRAP(__EE11939224);
  SHARED __EE5355575 := __E_Business_Ult;
  SHARED __EE5355577 := __EE5355575;
  EXPORT Res5 := __UNWRAP(__EE5355577);
  SHARED __EE5355578 := __E_Business_Org;
  SHARED __EE5355580 := __EE5355578;
  EXPORT Res6 := __UNWRAP(__EE5355580);
  SHARED __EE11939229 := __ENH_Business_Sele;
  SHARED __EE11939231 := __EE11939229;
  EXPORT Res7 := __UNWRAP(__EE11939231);
  SHARED __EE11939234 := __ENH_Business_Prox;
  SHARED __EE11939236 := __EE11939234;
  EXPORT Res8 := __UNWRAP(__EE11939236);
  SHARED __EE5355589 := __E_Business_Pow;
  SHARED __EE5355591 := __EE5355589;
  EXPORT Res9 := __UNWRAP(__EE5355591);
  SHARED __EE5355592 := __E_Criminal_Offender;
  SHARED __EE5355594 := __EE5355592;
  EXPORT Res10 := __UNWRAP(__EE5355594);
  SHARED __EE11939241 := __ENH_Criminal_Offense;
  SHARED __EE11939243 := __EE11939241;
  EXPORT Res11 := __UNWRAP(__EE11939243);
  SHARED __EE5355599 := __E_Criminal_Punishment;
  SHARED __EE5355601 := __EE5355599;
  EXPORT Res12 := __UNWRAP(__EE5355601);
  SHARED __EE5355602 := __E_Drivers_License;
  SHARED __EE5355604 := __EE5355602;
  EXPORT Res13 := __UNWRAP(__EE5355604);
  SHARED __EE5355605 := __E_E_B_R_Tradeline;
  SHARED __EE5355607 := __EE5355605;
  EXPORT Res14 := __UNWRAP(__EE5355607);
  SHARED __EE11939249 := __ENH_Education;
  SHARED __EE11939251 := __EE11939249;
  EXPORT Res15 := __UNWRAP(__EE11939251);
  SHARED __EE11939254 := __ENH_Email;
  SHARED __EE11939256 := __EE11939254;
  EXPORT Res16 := __UNWRAP(__EE11939256);
  SHARED __EE5355616 := __E_Household;
  SHARED __EE5355618 := __EE5355616;
  EXPORT Res17 := __UNWRAP(__EE5355618);
  SHARED __EE11939260 := __ENH_Inquiry;
  SHARED __EE11939262 := __EE11939260;
  EXPORT Res18 := __UNWRAP(__EE11939262);
  SHARED __EE11939265 := __ENH_Lien_Judgment;
  SHARED __EE11939267 := __EE11939265;
  EXPORT Res19 := __UNWRAP(__EE11939267);
  SHARED __EE5355627 := __E_Geo_Link;
  SHARED __EE5355629 := __EE5355627;
  EXPORT Res20 := __UNWRAP(__EE5355629);
  SHARED __EE11939271 := __ENH_Name_Summary;
  SHARED __EE11939273 := __EE11939271;
  EXPORT Res21 := __UNWRAP(__EE11939273);
  SHARED __EE11939276 := __ENH_Person;
  SHARED __EE11939278 := __EE11939276;
  EXPORT Res22 := __UNWRAP(__EE11939278);
  SHARED __EE5355638 := __E_Phone;
  SHARED __EE5355640 := __EE5355638;
  EXPORT Res23 := __UNWRAP(__EE5355640);
  SHARED __EE11939282 := __ENH_Phone_Summary;
  SHARED __EE11939284 := __EE11939282;
  EXPORT Res24 := __UNWRAP(__EE11939284);
  SHARED __EE11939287 := __ENH_Professional_License;
  SHARED __EE11939289 := __EE11939287;
  EXPORT Res25 := __UNWRAP(__EE11939289);
  SHARED __EE11939292 := __ENH_Property;
  SHARED __EE11939294 := __EE11939292;
  EXPORT Res26 := __UNWRAP(__EE11939294);
  SHARED __EE11939297 := __ENH_Property_Event;
  SHARED __EE11939299 := __EE11939297;
  EXPORT Res27 := __UNWRAP(__EE11939299);
  SHARED __EE5355657 := __E_Sex_Offender;
  SHARED __EE5355659 := __EE5355657;
  EXPORT Res28 := __UNWRAP(__EE5355659);
  SHARED __EE5355660 := __E_Social_Security_Number;
  SHARED __EE5355662 := __EE5355660;
  EXPORT Res29 := __UNWRAP(__EE5355662);
  SHARED __EE11939304 := __ENH_S_S_N_Summary;
  SHARED __EE11939306 := __EE11939304;
  EXPORT Res30 := __UNWRAP(__EE11939306);
  SHARED __EE5355667 := __E_Surname;
  SHARED __EE5355669 := __EE5355667;
  EXPORT Res31 := __UNWRAP(__EE5355669);
  SHARED __EE5355670 := __E_T_I_N;
  SHARED __EE5355672 := __EE5355670;
  EXPORT Res32 := __UNWRAP(__EE5355672);
  SHARED __EE11939311 := __ENH_Tradeline;
  SHARED __EE11939313 := __EE11939311;
  EXPORT Res33 := __UNWRAP(__EE11939313);
  SHARED __EE11939316 := __ENH_U_C_C;
  SHARED __EE11939318 := __EE11939316;
  EXPORT Res34 := __UNWRAP(__EE11939318);
  SHARED __EE5355681 := __E_Utility;
  SHARED __EE5355683 := __EE5355681;
  EXPORT Res35 := __UNWRAP(__EE5355683);
  SHARED __EE5355684 := __E_Vehicle;
  SHARED __EE5355686 := __EE5355684;
  EXPORT Res36 := __UNWRAP(__EE5355686);
  SHARED __EE5355687 := __E_Watercraft;
  SHARED __EE5355689 := __EE5355687;
  EXPORT Res37 := __UNWRAP(__EE5355689);
  SHARED __EE5355690 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5355690);
