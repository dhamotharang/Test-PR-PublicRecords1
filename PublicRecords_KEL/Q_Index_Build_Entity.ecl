...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4738441 := __E_Accident;
  SHARED __EE4738443 := __EE4738441;
  EXPORT Res0 := __UNWRAP(__EE4738443);
  SHARED __EE11618517 := __ENH_Address;
  SHARED __EE11618519 := __EE11618517;
  EXPORT Res1 := __UNWRAP(__EE11618519);
  SHARED __EE11618522 := __ENH_Address_Summary;
  SHARED __EE11618524 := __EE11618522;
  EXPORT Res2 := __UNWRAP(__EE11618524);
  SHARED __EE4738452 := __E_Aircraft;
  SHARED __EE4738454 := __EE4738452;
  EXPORT Res3 := __UNWRAP(__EE4738454);
  SHARED __EE11618528 := __ENH_Bankruptcy;
  SHARED __EE11618530 := __EE11618528;
  EXPORT Res4 := __UNWRAP(__EE11618530);
  SHARED __EE4738459 := __E_Business_Ult;
  SHARED __EE4738461 := __EE4738459;
  EXPORT Res5 := __UNWRAP(__EE4738461);
  SHARED __EE4738462 := __E_Business_Org;
  SHARED __EE4738464 := __EE4738462;
  EXPORT Res6 := __UNWRAP(__EE4738464);
  SHARED __EE11618535 := __ENH_Business_Sele;
  SHARED __EE11618537 := __EE11618535;
  EXPORT Res7 := __UNWRAP(__EE11618537);
  SHARED __EE11618540 := __ENH_Business_Prox;
  SHARED __EE11618542 := __EE11618540;
  EXPORT Res8 := __UNWRAP(__EE11618542);
  SHARED __EE4738473 := __E_Business_Pow;
  SHARED __EE4738475 := __EE4738473;
  EXPORT Res9 := __UNWRAP(__EE4738475);
  SHARED __EE4738476 := __E_Criminal_Offender;
  SHARED __EE4738478 := __EE4738476;
  EXPORT Res10 := __UNWRAP(__EE4738478);
  SHARED __EE11618547 := __ENH_Criminal_Offense;
  SHARED __EE11618549 := __EE11618547;
  EXPORT Res11 := __UNWRAP(__EE11618549);
  SHARED __EE4738483 := __E_Criminal_Punishment;
  SHARED __EE4738485 := __EE4738483;
  EXPORT Res12 := __UNWRAP(__EE4738485);
  SHARED __EE4738486 := __E_Drivers_License;
  SHARED __EE4738488 := __EE4738486;
  EXPORT Res13 := __UNWRAP(__EE4738488);
  SHARED __EE4738489 := __E_E_B_R_Tradeline;
  SHARED __EE4738491 := __EE4738489;
  EXPORT Res14 := __UNWRAP(__EE4738491);
  SHARED __EE11618555 := __ENH_Education;
  SHARED __EE11618557 := __EE11618555;
  EXPORT Res15 := __UNWRAP(__EE11618557);
  SHARED __EE11618560 := __ENH_Email;
  SHARED __EE11618562 := __EE11618560;
  EXPORT Res16 := __UNWRAP(__EE11618562);
  SHARED __EE4738500 := __E_Household;
  SHARED __EE4738502 := __EE4738500;
  EXPORT Res17 := __UNWRAP(__EE4738502);
  SHARED __EE11618566 := __ENH_Inquiry;
  SHARED __EE11618568 := __EE11618566;
  EXPORT Res18 := __UNWRAP(__EE11618568);
  SHARED __EE11618571 := __ENH_Lien_Judgment;
  SHARED __EE11618573 := __EE11618571;
  EXPORT Res19 := __UNWRAP(__EE11618573);
  SHARED __EE4738511 := __E_Geo_Link;
  SHARED __EE4738513 := __EE4738511;
  EXPORT Res20 := __UNWRAP(__EE4738513);
  SHARED __EE11618577 := __ENH_Name_Summary;
  SHARED __EE11618579 := __EE11618577;
  EXPORT Res21 := __UNWRAP(__EE11618579);
  SHARED __EE11618582 := __ENH_Person;
  SHARED __EE11618584 := __EE11618582;
  EXPORT Res22 := __UNWRAP(__EE11618584);
  SHARED __EE4738522 := __E_Phone;
  SHARED __EE4738524 := __EE4738522;
  EXPORT Res23 := __UNWRAP(__EE4738524);
  SHARED __EE11618588 := __ENH_Phone_Summary;
  SHARED __EE11618590 := __EE11618588;
  EXPORT Res24 := __UNWRAP(__EE11618590);
  SHARED __EE11618593 := __ENH_Professional_License;
  SHARED __EE11618595 := __EE11618593;
  EXPORT Res25 := __UNWRAP(__EE11618595);
  SHARED __EE11618598 := __ENH_Property;
  SHARED __EE11618600 := __EE11618598;
  EXPORT Res26 := __UNWRAP(__EE11618600);
  SHARED __EE11618603 := __ENH_Property_Event;
  SHARED __EE11618605 := __EE11618603;
  EXPORT Res27 := __UNWRAP(__EE11618605);
  SHARED __EE4738541 := __E_Sex_Offender;
  SHARED __EE4738543 := __EE4738541;
  EXPORT Res28 := __UNWRAP(__EE4738543);
  SHARED __EE4738544 := __E_Social_Security_Number;
  SHARED __EE4738546 := __EE4738544;
  EXPORT Res29 := __UNWRAP(__EE4738546);
  SHARED __EE11618610 := __ENH_S_S_N_Summary;
  SHARED __EE11618612 := __EE11618610;
  EXPORT Res30 := __UNWRAP(__EE11618612);
  SHARED __EE4738551 := __E_Surname;
  SHARED __EE4738553 := __EE4738551;
  EXPORT Res31 := __UNWRAP(__EE4738553);
  SHARED __EE4738554 := __E_T_I_N;
  SHARED __EE4738556 := __EE4738554;
  EXPORT Res32 := __UNWRAP(__EE4738556);
  SHARED __EE11618617 := __ENH_Tradeline;
  SHARED __EE11618619 := __EE11618617;
  EXPORT Res33 := __UNWRAP(__EE11618619);
  SHARED __EE11618622 := __ENH_U_C_C;
  SHARED __EE11618624 := __EE11618622;
  EXPORT Res34 := __UNWRAP(__EE11618624);
  SHARED __EE4738565 := __E_Utility;
  SHARED __EE4738567 := __EE4738565;
  EXPORT Res35 := __UNWRAP(__EE4738567);
  SHARED __EE4738568 := __E_Vehicle;
  SHARED __EE4738570 := __EE4738568;
  EXPORT Res36 := __UNWRAP(__EE4738570);
  SHARED __EE4738571 := __E_Watercraft;
  SHARED __EE4738573 := __EE4738571;
  EXPORT Res37 := __UNWRAP(__EE4738573);
  SHARED __EE4738574 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4738574);
