...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5421600 := __E_Accident;
  SHARED __EE5421602 := __EE5421600;
  EXPORT Res0 := __UNWRAP(__EE5421602);
  SHARED __EE11817955 := __ENH_Address;
  SHARED __EE11817957 := __EE11817955;
  EXPORT Res1 := __UNWRAP(__EE11817957);
  SHARED __EE11817960 := __ENH_Address_Summary;
  SHARED __EE11817962 := __EE11817960;
  EXPORT Res2 := __UNWRAP(__EE11817962);
  SHARED __EE5421611 := __E_Aircraft;
  SHARED __EE5421613 := __EE5421611;
  EXPORT Res3 := __UNWRAP(__EE5421613);
  SHARED __EE11817966 := __ENH_Bankruptcy;
  SHARED __EE11817968 := __EE11817966;
  EXPORT Res4 := __UNWRAP(__EE11817968);
  SHARED __EE5421618 := __E_Business_Ult;
  SHARED __EE5421620 := __EE5421618;
  EXPORT Res5 := __UNWRAP(__EE5421620);
  SHARED __EE5421621 := __E_Business_Org;
  SHARED __EE5421623 := __EE5421621;
  EXPORT Res6 := __UNWRAP(__EE5421623);
  SHARED __EE11817973 := __ENH_Business_Sele;
  SHARED __EE11817975 := __EE11817973;
  EXPORT Res7 := __UNWRAP(__EE11817975);
  SHARED __EE11817978 := __ENH_Business_Prox;
  SHARED __EE11817980 := __EE11817978;
  EXPORT Res8 := __UNWRAP(__EE11817980);
  SHARED __EE5421632 := __E_Business_Pow;
  SHARED __EE5421634 := __EE5421632;
  EXPORT Res9 := __UNWRAP(__EE5421634);
  SHARED __EE5421635 := __E_Criminal_Offender;
  SHARED __EE5421637 := __EE5421635;
  EXPORT Res10 := __UNWRAP(__EE5421637);
  SHARED __EE11817985 := __ENH_Criminal_Offense;
  SHARED __EE11817987 := __EE11817985;
  EXPORT Res11 := __UNWRAP(__EE11817987);
  SHARED __EE5421642 := __E_Criminal_Punishment;
  SHARED __EE5421644 := __EE5421642;
  EXPORT Res12 := __UNWRAP(__EE5421644);
  SHARED __EE5421645 := __E_Drivers_License;
  SHARED __EE5421647 := __EE5421645;
  EXPORT Res13 := __UNWRAP(__EE5421647);
  SHARED __EE5421648 := __E_E_B_R_Tradeline;
  SHARED __EE5421650 := __EE5421648;
  EXPORT Res14 := __UNWRAP(__EE5421650);
  SHARED __EE11817993 := __ENH_Education;
  SHARED __EE11817995 := __EE11817993;
  EXPORT Res15 := __UNWRAP(__EE11817995);
  SHARED __EE11817998 := __ENH_Email;
  SHARED __EE11818000 := __EE11817998;
  EXPORT Res16 := __UNWRAP(__EE11818000);
  SHARED __EE5421659 := __E_Household;
  SHARED __EE5421661 := __EE5421659;
  EXPORT Res17 := __UNWRAP(__EE5421661);
  SHARED __EE11818004 := __ENH_Inquiry;
  SHARED __EE11818006 := __EE11818004;
  EXPORT Res18 := __UNWRAP(__EE11818006);
  SHARED __EE11818009 := __ENH_Lien_Judgment;
  SHARED __EE11818011 := __EE11818009;
  EXPORT Res19 := __UNWRAP(__EE11818011);
  SHARED __EE5421670 := __E_Geo_Link;
  SHARED __EE5421672 := __EE5421670;
  EXPORT Res20 := __UNWRAP(__EE5421672);
  SHARED __EE11818015 := __ENH_Name_Summary;
  SHARED __EE11818017 := __EE11818015;
  EXPORT Res21 := __UNWRAP(__EE11818017);
  SHARED __EE11818020 := __ENH_Person;
  SHARED __EE11818022 := __EE11818020;
  EXPORT Res22 := __UNWRAP(__EE11818022);
  SHARED __EE5421681 := __E_Phone;
  SHARED __EE5421683 := __EE5421681;
  EXPORT Res23 := __UNWRAP(__EE5421683);
  SHARED __EE11818026 := __ENH_Phone_Summary;
  SHARED __EE11818028 := __EE11818026;
  EXPORT Res24 := __UNWRAP(__EE11818028);
  SHARED __EE11818031 := __ENH_Professional_License;
  SHARED __EE11818033 := __EE11818031;
  EXPORT Res25 := __UNWRAP(__EE11818033);
  SHARED __EE11818036 := __ENH_Property;
  SHARED __EE11818038 := __EE11818036;
  EXPORT Res26 := __UNWRAP(__EE11818038);
  SHARED __EE11818041 := __ENH_Property_Event;
  SHARED __EE11818043 := __EE11818041;
  EXPORT Res27 := __UNWRAP(__EE11818043);
  SHARED __EE5421700 := __E_Sex_Offender;
  SHARED __EE5421702 := __EE5421700;
  EXPORT Res28 := __UNWRAP(__EE5421702);
  SHARED __EE5421703 := __E_Social_Security_Number;
  SHARED __EE5421705 := __EE5421703;
  EXPORT Res29 := __UNWRAP(__EE5421705);
  SHARED __EE11818048 := __ENH_S_S_N_Summary;
  SHARED __EE11818050 := __EE11818048;
  EXPORT Res30 := __UNWRAP(__EE11818050);
  SHARED __EE5421710 := __E_Surname;
  SHARED __EE5421712 := __EE5421710;
  EXPORT Res31 := __UNWRAP(__EE5421712);
  SHARED __EE5421713 := __E_T_I_N;
  SHARED __EE5421715 := __EE5421713;
  EXPORT Res32 := __UNWRAP(__EE5421715);
  SHARED __EE11818055 := __ENH_Tradeline;
  SHARED __EE11818057 := __EE11818055;
  EXPORT Res33 := __UNWRAP(__EE11818057);
  SHARED __EE11818060 := __ENH_U_C_C;
  SHARED __EE11818062 := __EE11818060;
  EXPORT Res34 := __UNWRAP(__EE11818062);
  SHARED __EE5421724 := __E_Utility;
  SHARED __EE5421726 := __EE5421724;
  EXPORT Res35 := __UNWRAP(__EE5421726);
  SHARED __EE5421727 := __E_Vehicle;
  SHARED __EE5421729 := __EE5421727;
  EXPORT Res36 := __UNWRAP(__EE5421729);
  SHARED __EE5421730 := __E_Watercraft;
  SHARED __EE5421732 := __EE5421730;
  EXPORT Res37 := __UNWRAP(__EE5421732);
  SHARED __EE5421733 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5421733);
