...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4738436 := __E_Accident;
  SHARED __EE4738438 := __EE4738436;
  EXPORT Res0 := __UNWRAP(__EE4738438);
  SHARED __EE11618512 := __ENH_Address;
  SHARED __EE11618514 := __EE11618512;
  EXPORT Res1 := __UNWRAP(__EE11618514);
  SHARED __EE11618517 := __ENH_Address_Summary;
  SHARED __EE11618519 := __EE11618517;
  EXPORT Res2 := __UNWRAP(__EE11618519);
  SHARED __EE4738447 := __E_Aircraft;
  SHARED __EE4738449 := __EE4738447;
  EXPORT Res3 := __UNWRAP(__EE4738449);
  SHARED __EE11618523 := __ENH_Bankruptcy;
  SHARED __EE11618525 := __EE11618523;
  EXPORT Res4 := __UNWRAP(__EE11618525);
  SHARED __EE4738454 := __E_Business_Ult;
  SHARED __EE4738456 := __EE4738454;
  EXPORT Res5 := __UNWRAP(__EE4738456);
  SHARED __EE4738457 := __E_Business_Org;
  SHARED __EE4738459 := __EE4738457;
  EXPORT Res6 := __UNWRAP(__EE4738459);
  SHARED __EE11618530 := __ENH_Business_Sele;
  SHARED __EE11618532 := __EE11618530;
  EXPORT Res7 := __UNWRAP(__EE11618532);
  SHARED __EE11618535 := __ENH_Business_Prox;
  SHARED __EE11618537 := __EE11618535;
  EXPORT Res8 := __UNWRAP(__EE11618537);
  SHARED __EE4738468 := __E_Business_Pow;
  SHARED __EE4738470 := __EE4738468;
  EXPORT Res9 := __UNWRAP(__EE4738470);
  SHARED __EE4738471 := __E_Criminal_Offender;
  SHARED __EE4738473 := __EE4738471;
  EXPORT Res10 := __UNWRAP(__EE4738473);
  SHARED __EE11618542 := __ENH_Criminal_Offense;
  SHARED __EE11618544 := __EE11618542;
  EXPORT Res11 := __UNWRAP(__EE11618544);
  SHARED __EE4738478 := __E_Criminal_Punishment;
  SHARED __EE4738480 := __EE4738478;
  EXPORT Res12 := __UNWRAP(__EE4738480);
  SHARED __EE4738481 := __E_Drivers_License;
  SHARED __EE4738483 := __EE4738481;
  EXPORT Res13 := __UNWRAP(__EE4738483);
  SHARED __EE4738484 := __E_E_B_R_Tradeline;
  SHARED __EE4738486 := __EE4738484;
  EXPORT Res14 := __UNWRAP(__EE4738486);
  SHARED __EE11618550 := __ENH_Education;
  SHARED __EE11618552 := __EE11618550;
  EXPORT Res15 := __UNWRAP(__EE11618552);
  SHARED __EE11618555 := __ENH_Email;
  SHARED __EE11618557 := __EE11618555;
  EXPORT Res16 := __UNWRAP(__EE11618557);
  SHARED __EE4738495 := __E_Household;
  SHARED __EE4738497 := __EE4738495;
  EXPORT Res17 := __UNWRAP(__EE4738497);
  SHARED __EE11618561 := __ENH_Inquiry;
  SHARED __EE11618563 := __EE11618561;
  EXPORT Res18 := __UNWRAP(__EE11618563);
  SHARED __EE11618566 := __ENH_Lien_Judgment;
  SHARED __EE11618568 := __EE11618566;
  EXPORT Res19 := __UNWRAP(__EE11618568);
  SHARED __EE4738506 := __E_Geo_Link;
  SHARED __EE4738508 := __EE4738506;
  EXPORT Res20 := __UNWRAP(__EE4738508);
  SHARED __EE11618572 := __ENH_Name_Summary;
  SHARED __EE11618574 := __EE11618572;
  EXPORT Res21 := __UNWRAP(__EE11618574);
  SHARED __EE11618577 := __ENH_Person;
  SHARED __EE11618579 := __EE11618577;
  EXPORT Res22 := __UNWRAP(__EE11618579);
  SHARED __EE4738517 := __E_Phone;
  SHARED __EE4738519 := __EE4738517;
  EXPORT Res23 := __UNWRAP(__EE4738519);
  SHARED __EE11618583 := __ENH_Phone_Summary;
  SHARED __EE11618585 := __EE11618583;
  EXPORT Res24 := __UNWRAP(__EE11618585);
  SHARED __EE11618588 := __ENH_Professional_License;
  SHARED __EE11618590 := __EE11618588;
  EXPORT Res25 := __UNWRAP(__EE11618590);
  SHARED __EE11618593 := __ENH_Property;
  SHARED __EE11618595 := __EE11618593;
  EXPORT Res26 := __UNWRAP(__EE11618595);
  SHARED __EE11618598 := __ENH_Property_Event;
  SHARED __EE11618600 := __EE11618598;
  EXPORT Res27 := __UNWRAP(__EE11618600);
  SHARED __EE4738536 := __E_Sex_Offender;
  SHARED __EE4738538 := __EE4738536;
  EXPORT Res28 := __UNWRAP(__EE4738538);
  SHARED __EE4738539 := __E_Social_Security_Number;
  SHARED __EE4738541 := __EE4738539;
  EXPORT Res29 := __UNWRAP(__EE4738541);
  SHARED __EE11618605 := __ENH_S_S_N_Summary;
  SHARED __EE11618607 := __EE11618605;
  EXPORT Res30 := __UNWRAP(__EE11618607);
  SHARED __EE4738546 := __E_Surname;
  SHARED __EE4738548 := __EE4738546;
  EXPORT Res31 := __UNWRAP(__EE4738548);
  SHARED __EE4738549 := __E_T_I_N;
  SHARED __EE4738551 := __EE4738549;
  EXPORT Res32 := __UNWRAP(__EE4738551);
  SHARED __EE11618612 := __ENH_Tradeline;
  SHARED __EE11618614 := __EE11618612;
  EXPORT Res33 := __UNWRAP(__EE11618614);
  SHARED __EE11618617 := __ENH_U_C_C;
  SHARED __EE11618619 := __EE11618617;
  EXPORT Res34 := __UNWRAP(__EE11618619);
  SHARED __EE4738560 := __E_Utility;
  SHARED __EE4738562 := __EE4738560;
  EXPORT Res35 := __UNWRAP(__EE4738562);
  SHARED __EE4738563 := __E_Vehicle;
  SHARED __EE4738565 := __EE4738563;
  EXPORT Res36 := __UNWRAP(__EE4738565);
  SHARED __EE4738566 := __E_Watercraft;
  SHARED __EE4738568 := __EE4738566;
  EXPORT Res37 := __UNWRAP(__EE4738568);
  SHARED __EE4738569 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4738569);
