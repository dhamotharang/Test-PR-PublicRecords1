...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE5401313 := __E_Accident;
  SHARED __EE5401315 := __EE5401313;
  EXPORT Res0 := __UNWRAP(__EE5401315);
  SHARED __EE11789601 := __ENH_Address;
  SHARED __EE11789603 := __EE11789601;
  EXPORT Res1 := __UNWRAP(__EE11789603);
  SHARED __EE11789606 := __ENH_Address_Summary;
  SHARED __EE11789608 := __EE11789606;
  EXPORT Res2 := __UNWRAP(__EE11789608);
  SHARED __EE5401324 := __E_Aircraft;
  SHARED __EE5401326 := __EE5401324;
  EXPORT Res3 := __UNWRAP(__EE5401326);
  SHARED __EE11789612 := __ENH_Bankruptcy;
  SHARED __EE11789614 := __EE11789612;
  EXPORT Res4 := __UNWRAP(__EE11789614);
  SHARED __EE5401331 := __E_Business_Ult;
  SHARED __EE5401333 := __EE5401331;
  EXPORT Res5 := __UNWRAP(__EE5401333);
  SHARED __EE5401334 := __E_Business_Org;
  SHARED __EE5401336 := __EE5401334;
  EXPORT Res6 := __UNWRAP(__EE5401336);
  SHARED __EE11789619 := __ENH_Business_Sele;
  SHARED __EE11789621 := __EE11789619;
  EXPORT Res7 := __UNWRAP(__EE11789621);
  SHARED __EE11789624 := __ENH_Business_Prox;
  SHARED __EE11789626 := __EE11789624;
  EXPORT Res8 := __UNWRAP(__EE11789626);
  SHARED __EE5401345 := __E_Business_Pow;
  SHARED __EE5401347 := __EE5401345;
  EXPORT Res9 := __UNWRAP(__EE5401347);
  SHARED __EE5401348 := __E_Criminal_Offender;
  SHARED __EE5401350 := __EE5401348;
  EXPORT Res10 := __UNWRAP(__EE5401350);
  SHARED __EE11789631 := __ENH_Criminal_Offense;
  SHARED __EE11789633 := __EE11789631;
  EXPORT Res11 := __UNWRAP(__EE11789633);
  SHARED __EE5401355 := __E_Criminal_Punishment;
  SHARED __EE5401357 := __EE5401355;
  EXPORT Res12 := __UNWRAP(__EE5401357);
  SHARED __EE5401358 := __E_Drivers_License;
  SHARED __EE5401360 := __EE5401358;
  EXPORT Res13 := __UNWRAP(__EE5401360);
  SHARED __EE5401361 := __E_E_B_R_Tradeline;
  SHARED __EE5401363 := __EE5401361;
  EXPORT Res14 := __UNWRAP(__EE5401363);
  SHARED __EE11789639 := __ENH_Education;
  SHARED __EE11789641 := __EE11789639;
  EXPORT Res15 := __UNWRAP(__EE11789641);
  SHARED __EE11789644 := __ENH_Email;
  SHARED __EE11789646 := __EE11789644;
  EXPORT Res16 := __UNWRAP(__EE11789646);
  SHARED __EE5401372 := __E_Household;
  SHARED __EE5401374 := __EE5401372;
  EXPORT Res17 := __UNWRAP(__EE5401374);
  SHARED __EE11789650 := __ENH_Inquiry;
  SHARED __EE11789652 := __EE11789650;
  EXPORT Res18 := __UNWRAP(__EE11789652);
  SHARED __EE11789655 := __ENH_Lien_Judgment;
  SHARED __EE11789657 := __EE11789655;
  EXPORT Res19 := __UNWRAP(__EE11789657);
  SHARED __EE5401383 := __E_Geo_Link;
  SHARED __EE5401385 := __EE5401383;
  EXPORT Res20 := __UNWRAP(__EE5401385);
  SHARED __EE11789661 := __ENH_Name_Summary;
  SHARED __EE11789663 := __EE11789661;
  EXPORT Res21 := __UNWRAP(__EE11789663);
  SHARED __EE11789666 := __ENH_Person;
  SHARED __EE11789668 := __EE11789666;
  EXPORT Res22 := __UNWRAP(__EE11789668);
  SHARED __EE5401394 := __E_Phone;
  SHARED __EE5401396 := __EE5401394;
  EXPORT Res23 := __UNWRAP(__EE5401396);
  SHARED __EE11789672 := __ENH_Phone_Summary;
  SHARED __EE11789674 := __EE11789672;
  EXPORT Res24 := __UNWRAP(__EE11789674);
  SHARED __EE11789677 := __ENH_Professional_License;
  SHARED __EE11789679 := __EE11789677;
  EXPORT Res25 := __UNWRAP(__EE11789679);
  SHARED __EE11789682 := __ENH_Property;
  SHARED __EE11789684 := __EE11789682;
  EXPORT Res26 := __UNWRAP(__EE11789684);
  SHARED __EE11789687 := __ENH_Property_Event;
  SHARED __EE11789689 := __EE11789687;
  EXPORT Res27 := __UNWRAP(__EE11789689);
  SHARED __EE5401413 := __E_Sex_Offender;
  SHARED __EE5401415 := __EE5401413;
  EXPORT Res28 := __UNWRAP(__EE5401415);
  SHARED __EE5401416 := __E_Social_Security_Number;
  SHARED __EE5401418 := __EE5401416;
  EXPORT Res29 := __UNWRAP(__EE5401418);
  SHARED __EE11789694 := __ENH_S_S_N_Summary;
  SHARED __EE11789696 := __EE11789694;
  EXPORT Res30 := __UNWRAP(__EE11789696);
  SHARED __EE5401423 := __E_Surname;
  SHARED __EE5401425 := __EE5401423;
  EXPORT Res31 := __UNWRAP(__EE5401425);
  SHARED __EE5401426 := __E_T_I_N;
  SHARED __EE5401428 := __EE5401426;
  EXPORT Res32 := __UNWRAP(__EE5401428);
  SHARED __EE11789701 := __ENH_Tradeline;
  SHARED __EE11789703 := __EE11789701;
  EXPORT Res33 := __UNWRAP(__EE11789703);
  SHARED __EE11789706 := __ENH_U_C_C;
  SHARED __EE11789708 := __EE11789706;
  EXPORT Res34 := __UNWRAP(__EE11789708);
  SHARED __EE5401437 := __E_Utility;
  SHARED __EE5401439 := __EE5401437;
  EXPORT Res35 := __UNWRAP(__EE5401439);
  SHARED __EE5401440 := __E_Vehicle;
  SHARED __EE5401442 := __EE5401440;
  EXPORT Res36 := __UNWRAP(__EE5401442);
  SHARED __EE5401443 := __E_Watercraft;
  SHARED __EE5401445 := __EE5401443;
  EXPORT Res37 := __UNWRAP(__EE5401445);
  SHARED __EE5401446 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE5401446);
