...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1728183 := __E_Accident;
  SHARED __EE1728185 := __EE1728183;
  EXPORT Res0 := __UNWRAP(__EE1728185);
  SHARED __EE1728187 := __E_Address;
  SHARED __EE1728189 := __EE1728187;
  EXPORT Res1 := __UNWRAP(__EE1728189);
  SHARED __EE1728192 := __ENH_Aircraft;
  SHARED __EE1728194 := __EE1728192;
  EXPORT Res2 := __UNWRAP(__EE1728194);
  SHARED __EE1728197 := __ENH_Bankruptcy;
  SHARED __EE1728199 := __EE1728197;
  EXPORT Res3 := __UNWRAP(__EE1728199);
  SHARED __EE1728201 := __E_Business_Ult;
  SHARED __EE1728203 := __EE1728201;
  EXPORT Res4 := __UNWRAP(__EE1728203);
  SHARED __EE1728205 := __E_Business_Org;
  SHARED __EE1728207 := __EE1728205;
  EXPORT Res5 := __UNWRAP(__EE1728207);
  SHARED __EE1728210 := __ENH_Business_Sele;
  SHARED __EE1728212 := __EE1728210;
  EXPORT Res6 := __UNWRAP(__EE1728212);
  SHARED __EE1728772 := __E_Business_Prox;
  SHARED __EE1728774 := __EE1728772;
  EXPORT Res7 := __UNWRAP(__EE1728774);
  SHARED __EE1728776 := __E_Business_Pow;
  SHARED __EE1728778 := __EE1728776;
  EXPORT Res8 := __UNWRAP(__EE1728778);
  SHARED __EE1728781 := __ENH_Criminal_Offender;
  SHARED __EE1728783 := __EE1728781;
  EXPORT Res9 := __UNWRAP(__EE1728783);
  SHARED __EE1728786 := __ENH_Criminal_Offense;
  SHARED __EE1728788 := __EE1728786;
  EXPORT Res10 := __UNWRAP(__EE1728788);
  SHARED __EE1728791 := __ENH_Criminal_Punishment;
  SHARED __EE1728793 := __EE1728791;
  EXPORT Res11 := __UNWRAP(__EE1728793);
  SHARED __EE1728795 := __E_Drivers_License;
  SHARED __EE1728797 := __EE1728795;
  EXPORT Res12 := __UNWRAP(__EE1728797);
  SHARED __EE1728799 := __E_Education;
  SHARED __EE1728801 := __EE1728799;
  EXPORT Res13 := __UNWRAP(__EE1728801);
  SHARED __EE1728803 := __E_Email;
  SHARED __EE1728805 := __EE1728803;
  EXPORT Res14 := __UNWRAP(__EE1728805);
  SHARED __EE1728807 := __E_Employment;
  SHARED __EE1728809 := __EE1728807;
  EXPORT Res15 := __UNWRAP(__EE1728809);
  SHARED __EE1728811 := __E_Household;
  SHARED __EE1728813 := __EE1728811;
  EXPORT Res16 := __UNWRAP(__EE1728813);
  SHARED __EE1728816 := __ENH_Inquiry;
  SHARED __EE1728818 := __EE1728816;
  EXPORT Res17 := __UNWRAP(__EE1728818);
  SHARED __EE1728820 := __E_Lien_Judgment;
  SHARED __EE1728822 := __EE1728820;
  EXPORT Res18 := __UNWRAP(__EE1728822);
  SHARED __EE1728824 := __E_Neighborhood;
  SHARED __EE1728826 := __EE1728824;
  EXPORT Res19 := __UNWRAP(__EE1728826);
  SHARED __EE1728829 := __ENH_Person;
  SHARED __EE1728831 := __EE1728829;
  EXPORT Res20 := __UNWRAP(__EE1728831);
  SHARED __EE1728927 := __ENH_Phone;
  SHARED __EE1728929 := __EE1728927;
  EXPORT Res21 := __UNWRAP(__EE1728929);
  SHARED __EE1728932 := __ENH_Professional_License;
  SHARED __EE1728934 := __EE1728932;
  EXPORT Res22 := __UNWRAP(__EE1728934);
  SHARED __EE1728937 := __ENH_Property;
  SHARED __EE1728939 := __EE1728937;
  EXPORT Res23 := __UNWRAP(__EE1728939);
  SHARED __EE1728941 := __E_Property_Event;
  SHARED __EE1728943 := __EE1728941;
  EXPORT Res24 := __UNWRAP(__EE1728943);
  SHARED __EE1728945 := __E_Social_Security_Number;
  SHARED __EE1728947 := __EE1728945;
  EXPORT Res25 := __UNWRAP(__EE1728947);
  SHARED __EE1728949 := __E_T_I_N;
  SHARED __EE1728951 := __EE1728949;
  EXPORT Res26 := __UNWRAP(__EE1728951);
  SHARED __EE1728954 := __ENH_Tradeline;
  SHARED __EE1728956 := __EE1728954;
  EXPORT Res27 := __UNWRAP(__EE1728956);
  SHARED __EE1728958 := __E_U_C_C;
  SHARED __EE1728960 := __EE1728958;
  EXPORT Res28 := __UNWRAP(__EE1728960);
  SHARED __EE1728962 := __E_Utility;
  SHARED __EE1728964 := __EE1728962;
  EXPORT Res29 := __UNWRAP(__EE1728964);
  SHARED __EE1728967 := __ENH_Vehicle;
  SHARED __EE1728969 := __EE1728967;
  EXPORT Res30 := __UNWRAP(__EE1728969);
  SHARED __EE1728972 := __ENH_Watercraft;
  SHARED __EE1728974 := __EE1728972;
  EXPORT Res31 := __UNWRAP(__EE1728974);
  SHARED __EE1728976 := __E_Zip_Code;
  EXPORT Res32 := __UNWRAP(__EE1728976);
END;
