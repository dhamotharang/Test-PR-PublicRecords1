...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4995924 := __E_Accident;
  SHARED __EE4995926 := __EE4995924;
  EXPORT Res0 := __UNWRAP(__EE4995926);
  SHARED __EE11457916 := __ENH_Address;
  SHARED __EE11457918 := __EE11457916;
  EXPORT Res1 := __UNWRAP(__EE11457918);
  SHARED __EE11457921 := __ENH_Address_Summary;
  SHARED __EE11457923 := __EE11457921;
  EXPORT Res2 := __UNWRAP(__EE11457923);
  SHARED __EE4995935 := __E_Aircraft;
  SHARED __EE4995937 := __EE4995935;
  EXPORT Res3 := __UNWRAP(__EE4995937);
  SHARED __EE11457927 := __ENH_Bankruptcy;
  SHARED __EE11457929 := __EE11457927;
  EXPORT Res4 := __UNWRAP(__EE11457929);
  SHARED __EE4995942 := __E_Business_Ult;
  SHARED __EE4995944 := __EE4995942;
  EXPORT Res5 := __UNWRAP(__EE4995944);
  SHARED __EE4995945 := __E_Business_Org;
  SHARED __EE4995947 := __EE4995945;
  EXPORT Res6 := __UNWRAP(__EE4995947);
  SHARED __EE11457934 := __ENH_Business_Sele;
  SHARED __EE11457936 := __EE11457934;
  EXPORT Res7 := __UNWRAP(__EE11457936);
  SHARED __EE11457939 := __ENH_Business_Prox;
  SHARED __EE11457941 := __EE11457939;
  EXPORT Res8 := __UNWRAP(__EE11457941);
  SHARED __EE4995956 := __E_Business_Pow;
  SHARED __EE4995958 := __EE4995956;
  EXPORT Res9 := __UNWRAP(__EE4995958);
  SHARED __EE4995959 := __E_Criminal_Offender;
  SHARED __EE4995961 := __EE4995959;
  EXPORT Res10 := __UNWRAP(__EE4995961);
  SHARED __EE11457946 := __ENH_Criminal_Offense;
  SHARED __EE11457948 := __EE11457946;
  EXPORT Res11 := __UNWRAP(__EE11457948);
  SHARED __EE4995966 := __E_Criminal_Punishment;
  SHARED __EE4995968 := __EE4995966;
  EXPORT Res12 := __UNWRAP(__EE4995968);
  SHARED __EE4995969 := __E_Drivers_License;
  SHARED __EE4995971 := __EE4995969;
  EXPORT Res13 := __UNWRAP(__EE4995971);
  SHARED __EE4995972 := __E_E_B_R_Tradeline;
  SHARED __EE4995974 := __EE4995972;
  EXPORT Res14 := __UNWRAP(__EE4995974);
  SHARED __EE11457954 := __ENH_Education;
  SHARED __EE11457956 := __EE11457954;
  EXPORT Res15 := __UNWRAP(__EE11457956);
  SHARED __EE11457959 := __ENH_Email;
  SHARED __EE11457961 := __EE11457959;
  EXPORT Res16 := __UNWRAP(__EE11457961);
  SHARED __EE4995983 := __E_Household;
  SHARED __EE4995985 := __EE4995983;
  EXPORT Res17 := __UNWRAP(__EE4995985);
  SHARED __EE11457965 := __ENH_Inquiry;
  SHARED __EE11457967 := __EE11457965;
  EXPORT Res18 := __UNWRAP(__EE11457967);
  SHARED __EE11457970 := __ENH_Lien_Judgment;
  SHARED __EE11457972 := __EE11457970;
  EXPORT Res19 := __UNWRAP(__EE11457972);
  SHARED __EE4995994 := __E_Geo_Link;
  SHARED __EE4995996 := __EE4995994;
  EXPORT Res20 := __UNWRAP(__EE4995996);
  SHARED __EE11457976 := __ENH_Name_Summary;
  SHARED __EE11457978 := __EE11457976;
  EXPORT Res21 := __UNWRAP(__EE11457978);
  SHARED __EE11457981 := __ENH_Person;
  SHARED __EE11457983 := __EE11457981;
  EXPORT Res22 := __UNWRAP(__EE11457983);
  SHARED __EE4996005 := __E_Phone;
  SHARED __EE4996007 := __EE4996005;
  EXPORT Res23 := __UNWRAP(__EE4996007);
  SHARED __EE11457987 := __ENH_Phone_Summary;
  SHARED __EE11457989 := __EE11457987;
  EXPORT Res24 := __UNWRAP(__EE11457989);
  SHARED __EE11457992 := __ENH_Professional_License;
  SHARED __EE11457994 := __EE11457992;
  EXPORT Res25 := __UNWRAP(__EE11457994);
  SHARED __EE11457997 := __ENH_Property;
  SHARED __EE11457999 := __EE11457997;
  EXPORT Res26 := __UNWRAP(__EE11457999);
  SHARED __EE11458002 := __ENH_Property_Event;
  SHARED __EE11458004 := __EE11458002;
  EXPORT Res27 := __UNWRAP(__EE11458004);
  SHARED __EE4996024 := __E_Sex_Offender;
  SHARED __EE4996026 := __EE4996024;
  EXPORT Res28 := __UNWRAP(__EE4996026);
  SHARED __EE4996027 := __E_Social_Security_Number;
  SHARED __EE4996029 := __EE4996027;
  EXPORT Res29 := __UNWRAP(__EE4996029);
  SHARED __EE11458009 := __ENH_S_S_N_Summary;
  SHARED __EE11458011 := __EE11458009;
  EXPORT Res30 := __UNWRAP(__EE11458011);
  SHARED __EE4996034 := __E_Surname;
  SHARED __EE4996036 := __EE4996034;
  EXPORT Res31 := __UNWRAP(__EE4996036);
  SHARED __EE4996037 := __E_T_I_N;
  SHARED __EE4996039 := __EE4996037;
  EXPORT Res32 := __UNWRAP(__EE4996039);
  SHARED __EE11458016 := __ENH_Tradeline;
  SHARED __EE11458018 := __EE11458016;
  EXPORT Res33 := __UNWRAP(__EE11458018);
  SHARED __EE11458021 := __ENH_U_C_C;
  SHARED __EE11458023 := __EE11458021;
  EXPORT Res34 := __UNWRAP(__EE11458023);
  SHARED __EE4996048 := __E_Utility;
  SHARED __EE4996050 := __EE4996048;
  EXPORT Res35 := __UNWRAP(__EE4996050);
  SHARED __EE4996051 := __E_Vehicle;
  SHARED __EE4996053 := __EE4996051;
  EXPORT Res36 := __UNWRAP(__EE4996053);
  SHARED __EE4996054 := __E_Watercraft;
  SHARED __EE4996056 := __EE4996054;
  EXPORT Res37 := __UNWRAP(__EE4996056);
  SHARED __EE4996057 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4996057);
