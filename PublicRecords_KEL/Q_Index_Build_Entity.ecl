...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA100 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE3465980 := __E_Accident;
  SHARED __EE3465982 := __EE3465980;
  EXPORT Res0 := __UNWRAP(__EE3465982);
  SHARED __EE6452916 := __ENH_Address;
  SHARED __EE6452918 := __EE6452916;
  EXPORT Res1 := __UNWRAP(__EE6452918);
  SHARED __EE3465987 := __E_Aircraft;
  SHARED __EE3465989 := __EE3465987;
  EXPORT Res2 := __UNWRAP(__EE3465989);
  SHARED __EE6452922 := __ENH_Bankruptcy;
  SHARED __EE6452924 := __EE6452922;
  EXPORT Res3 := __UNWRAP(__EE6452924);
  SHARED __EE3465994 := __E_Business_Ult;
  SHARED __EE3465996 := __EE3465994;
  EXPORT Res4 := __UNWRAP(__EE3465996);
  SHARED __EE3465997 := __E_Business_Org;
  SHARED __EE3465999 := __EE3465997;
  EXPORT Res5 := __UNWRAP(__EE3465999);
  SHARED __EE6452929 := __ENH_Business_Sele;
  SHARED __EE6452931 := __EE6452929;
  EXPORT Res6 := __UNWRAP(__EE6452931);
  SHARED __EE6452934 := __ENH_Business_Prox;
  SHARED __EE6452936 := __EE6452934;
  EXPORT Res7 := __UNWRAP(__EE6452936);
  SHARED __EE3466008 := __E_Business_Pow;
  SHARED __EE3466010 := __EE3466008;
  EXPORT Res8 := __UNWRAP(__EE3466010);
  SHARED __EE3466011 := __E_Criminal_Offender;
  SHARED __EE3466013 := __EE3466011;
  EXPORT Res9 := __UNWRAP(__EE3466013);
  SHARED __EE6452941 := __ENH_Criminal_Offense;
  SHARED __EE6452943 := __EE6452941;
  EXPORT Res10 := __UNWRAP(__EE6452943);
  SHARED __EE3466018 := __E_Criminal_Punishment;
  SHARED __EE3466020 := __EE3466018;
  EXPORT Res11 := __UNWRAP(__EE3466020);
  SHARED __EE3466021 := __E_Drivers_License;
  SHARED __EE3466023 := __EE3466021;
  EXPORT Res12 := __UNWRAP(__EE3466023);
  SHARED __EE3466024 := __E_E_B_R_Tradeline;
  SHARED __EE3466026 := __EE3466024;
  EXPORT Res13 := __UNWRAP(__EE3466026);
  SHARED __EE6452949 := __ENH_Education;
  SHARED __EE6452951 := __EE6452949;
  EXPORT Res14 := __UNWRAP(__EE6452951);
  SHARED __EE3466031 := __E_Email;
  SHARED __EE3466033 := __EE3466031;
  EXPORT Res15 := __UNWRAP(__EE3466033);
  SHARED __EE3466034 := __E_Household;
  SHARED __EE3466036 := __EE3466034;
  EXPORT Res16 := __UNWRAP(__EE3466036);
  SHARED __EE3466037 := __E_Inquiry;
  SHARED __EE3466039 := __EE3466037;
  EXPORT Res17 := __UNWRAP(__EE3466039);
  SHARED __EE6452957 := __ENH_Lien_Judgment;
  SHARED __EE6452959 := __EE6452957;
  EXPORT Res18 := __UNWRAP(__EE6452959);
  SHARED __EE3466044 := __E_Geo_Link;
  SHARED __EE3466046 := __EE3466044;
  EXPORT Res19 := __UNWRAP(__EE3466046);
  SHARED __EE6452963 := __ENH_Person;
  SHARED __EE6452965 := __EE6452963;
  EXPORT Res20 := __UNWRAP(__EE6452965);
  SHARED __EE3466051 := __E_Phone;
  SHARED __EE3466053 := __EE3466051;
  EXPORT Res21 := __UNWRAP(__EE3466053);
  SHARED __EE6452969 := __ENH_Professional_License;
  SHARED __EE6452971 := __EE6452969;
  EXPORT Res22 := __UNWRAP(__EE6452971);
  SHARED __EE6452974 := __ENH_Property;
  SHARED __EE6452976 := __EE6452974;
  EXPORT Res23 := __UNWRAP(__EE6452976);
  SHARED __EE6452979 := __ENH_Property_Event;
  SHARED __EE6452981 := __EE6452979;
  EXPORT Res24 := __UNWRAP(__EE6452981);
  SHARED __EE3466066 := __E_Social_Security_Number;
  SHARED __EE3466068 := __EE3466066;
  EXPORT Res25 := __UNWRAP(__EE3466068);
  SHARED __EE3466069 := __E_Surname;
  SHARED __EE3466071 := __EE3466069;
  EXPORT Res26 := __UNWRAP(__EE3466071);
  SHARED __EE3466072 := __E_T_I_N;
  SHARED __EE3466074 := __EE3466072;
  EXPORT Res27 := __UNWRAP(__EE3466074);
  SHARED __EE6452987 := __ENH_Tradeline;
  SHARED __EE6452989 := __EE6452987;
  EXPORT Res28 := __UNWRAP(__EE6452989);
  SHARED __EE6452992 := __ENH_U_C_C;
  SHARED __EE6452994 := __EE6452992;
  EXPORT Res29 := __UNWRAP(__EE6452994);
  SHARED __EE3466083 := __E_Utility;
  SHARED __EE3466085 := __EE3466083;
  EXPORT Res30 := __UNWRAP(__EE3466085);
  SHARED __EE3466086 := __E_Vehicle;
  SHARED __EE3466088 := __EE3466086;
  EXPORT Res31 := __UNWRAP(__EE3466088);
  SHARED __EE3466089 := __E_Watercraft;
  SHARED __EE3466091 := __EE3466089;
  EXPORT Res32 := __UNWRAP(__EE3466091);
  SHARED __EE3466092 := __E_Zip_Code;
  SHARED __EE3466094 := __EE3466092;
  EXPORT Res33 := __UNWRAP(__EE3466094);
  SHARED __EE3466095 := __E_Name_Summary;
  SHARED __EE3466097 := __EE3466095;
  EXPORT Res34 := __UNWRAP(__EE3466097);
  SHARED __EE3466098 := __E_S_S_N_Summary;
  SHARED __EE3466100 := __EE3466098;
  EXPORT Res35 := __UNWRAP(__EE3466100);
  SHARED __EE3466101 := __E_Phone_Summary;
  SHARED __EE3466103 := __EE3466101;
  EXPORT Res36 := __UNWRAP(__EE3466103);
  SHARED __EE3466104 := __E_Address_Summary;
  EXPORT Res37 := __UNWRAP(__EE3466104);
END;
