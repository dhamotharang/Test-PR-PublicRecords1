...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4737578 := __E_Accident;
  SHARED __EE4737580 := __EE4737578;
  EXPORT Res0 := __UNWRAP(__EE4737580);
  SHARED __EE11616624 := __ENH_Address;
  SHARED __EE11616626 := __EE11616624;
  EXPORT Res1 := __UNWRAP(__EE11616626);
  SHARED __EE11616629 := __ENH_Address_Summary;
  SHARED __EE11616631 := __EE11616629;
  EXPORT Res2 := __UNWRAP(__EE11616631);
  SHARED __EE4737589 := __E_Aircraft;
  SHARED __EE4737591 := __EE4737589;
  EXPORT Res3 := __UNWRAP(__EE4737591);
  SHARED __EE11616635 := __ENH_Bankruptcy;
  SHARED __EE11616637 := __EE11616635;
  EXPORT Res4 := __UNWRAP(__EE11616637);
  SHARED __EE4737596 := __E_Business_Ult;
  SHARED __EE4737598 := __EE4737596;
  EXPORT Res5 := __UNWRAP(__EE4737598);
  SHARED __EE4737599 := __E_Business_Org;
  SHARED __EE4737601 := __EE4737599;
  EXPORT Res6 := __UNWRAP(__EE4737601);
  SHARED __EE11616642 := __ENH_Business_Sele;
  SHARED __EE11616644 := __EE11616642;
  EXPORT Res7 := __UNWRAP(__EE11616644);
  SHARED __EE11616647 := __ENH_Business_Prox;
  SHARED __EE11616649 := __EE11616647;
  EXPORT Res8 := __UNWRAP(__EE11616649);
  SHARED __EE4737610 := __E_Business_Pow;
  SHARED __EE4737612 := __EE4737610;
  EXPORT Res9 := __UNWRAP(__EE4737612);
  SHARED __EE4737613 := __E_Criminal_Offender;
  SHARED __EE4737615 := __EE4737613;
  EXPORT Res10 := __UNWRAP(__EE4737615);
  SHARED __EE11616654 := __ENH_Criminal_Offense;
  SHARED __EE11616656 := __EE11616654;
  EXPORT Res11 := __UNWRAP(__EE11616656);
  SHARED __EE4737620 := __E_Criminal_Punishment;
  SHARED __EE4737622 := __EE4737620;
  EXPORT Res12 := __UNWRAP(__EE4737622);
  SHARED __EE4737623 := __E_Drivers_License;
  SHARED __EE4737625 := __EE4737623;
  EXPORT Res13 := __UNWRAP(__EE4737625);
  SHARED __EE4737626 := __E_E_B_R_Tradeline;
  SHARED __EE4737628 := __EE4737626;
  EXPORT Res14 := __UNWRAP(__EE4737628);
  SHARED __EE11616662 := __ENH_Education;
  SHARED __EE11616664 := __EE11616662;
  EXPORT Res15 := __UNWRAP(__EE11616664);
  SHARED __EE11616667 := __ENH_Email;
  SHARED __EE11616669 := __EE11616667;
  EXPORT Res16 := __UNWRAP(__EE11616669);
  SHARED __EE4737637 := __E_Household;
  SHARED __EE4737639 := __EE4737637;
  EXPORT Res17 := __UNWRAP(__EE4737639);
  SHARED __EE11616673 := __ENH_Inquiry;
  SHARED __EE11616675 := __EE11616673;
  EXPORT Res18 := __UNWRAP(__EE11616675);
  SHARED __EE11616678 := __ENH_Lien_Judgment;
  SHARED __EE11616680 := __EE11616678;
  EXPORT Res19 := __UNWRAP(__EE11616680);
  SHARED __EE4737648 := __E_Geo_Link;
  SHARED __EE4737650 := __EE4737648;
  EXPORT Res20 := __UNWRAP(__EE4737650);
  SHARED __EE11616684 := __ENH_Name_Summary;
  SHARED __EE11616686 := __EE11616684;
  EXPORT Res21 := __UNWRAP(__EE11616686);
  SHARED __EE11616689 := __ENH_Person;
  SHARED __EE11616691 := __EE11616689;
  EXPORT Res22 := __UNWRAP(__EE11616691);
  SHARED __EE4737659 := __E_Phone;
  SHARED __EE4737661 := __EE4737659;
  EXPORT Res23 := __UNWRAP(__EE4737661);
  SHARED __EE11616695 := __ENH_Phone_Summary;
  SHARED __EE11616697 := __EE11616695;
  EXPORT Res24 := __UNWRAP(__EE11616697);
  SHARED __EE11616700 := __ENH_Professional_License;
  SHARED __EE11616702 := __EE11616700;
  EXPORT Res25 := __UNWRAP(__EE11616702);
  SHARED __EE11616705 := __ENH_Property;
  SHARED __EE11616707 := __EE11616705;
  EXPORT Res26 := __UNWRAP(__EE11616707);
  SHARED __EE11616710 := __ENH_Property_Event;
  SHARED __EE11616712 := __EE11616710;
  EXPORT Res27 := __UNWRAP(__EE11616712);
  SHARED __EE4737678 := __E_Sex_Offender;
  SHARED __EE4737680 := __EE4737678;
  EXPORT Res28 := __UNWRAP(__EE4737680);
  SHARED __EE4737681 := __E_Social_Security_Number;
  SHARED __EE4737683 := __EE4737681;
  EXPORT Res29 := __UNWRAP(__EE4737683);
  SHARED __EE11616717 := __ENH_S_S_N_Summary;
  SHARED __EE11616719 := __EE11616717;
  EXPORT Res30 := __UNWRAP(__EE11616719);
  SHARED __EE4737688 := __E_Surname;
  SHARED __EE4737690 := __EE4737688;
  EXPORT Res31 := __UNWRAP(__EE4737690);
  SHARED __EE4737691 := __E_T_I_N;
  SHARED __EE4737693 := __EE4737691;
  EXPORT Res32 := __UNWRAP(__EE4737693);
  SHARED __EE11616724 := __ENH_Tradeline;
  SHARED __EE11616726 := __EE11616724;
  EXPORT Res33 := __UNWRAP(__EE11616726);
  SHARED __EE11616729 := __ENH_U_C_C;
  SHARED __EE11616731 := __EE11616729;
  EXPORT Res34 := __UNWRAP(__EE11616731);
  SHARED __EE4737702 := __E_Utility;
  SHARED __EE4737704 := __EE4737702;
  EXPORT Res35 := __UNWRAP(__EE4737704);
  SHARED __EE4737705 := __E_Vehicle;
  SHARED __EE4737707 := __EE4737705;
  EXPORT Res36 := __UNWRAP(__EE4737707);
  SHARED __EE4737708 := __E_Watercraft;
  SHARED __EE4737710 := __EE4737708;
  EXPORT Res37 := __UNWRAP(__EE4737710);
  SHARED __EE4737711 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4737711);
