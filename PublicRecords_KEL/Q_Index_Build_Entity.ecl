...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Bankruptcy().__Result) __E_Bankruptcy := E_Bankruptcy_Filtered.__Result;
  SHARED TYPEOF(E_Business_Org().__Result) __E_Business_Org := E_Business_Org_Filtered.__Result;
  SHARED TYPEOF(E_Business_Pow().__Result) __E_Business_Pow := E_Business_Pow_Filtered.__Result;
  ...
  SHARED TYPEOF(E_Business_Sele().__Result) __E_Business_Sele := E_Business_Sele_Filtered.__Result;
  SHARED TYPEOF(E_Business_Ult().__Result) __E_Business_Ult := E_Business_Ult_Filtered.__Result;
  ...
  SHARED TYPEOF(E_Geo_Link().__Result) __E_Geo_Link := E_Geo_Link_Filtered.__Result;
  ...
  SHARED TYPEOF(E_Surname().__Result) __E_Surname := E_Surname_Filtered.__Result;
  ...
  SHARED TYPEOF(E_Zip_Code().__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE17719061 := __E_Accident;
  SHARED __EE17719063 := __EE17719061;
  EXPORT Res0 := __UNWRAP(__EE17719063);
  SHARED __EE17719066 := __ENH_Address;
  SHARED __EE17719068 := __EE17719066;
  EXPORT Res1 := __UNWRAP(__EE17719068);
  SHARED __EE17719070 := __E_Aircraft;
  SHARED __EE17719072 := __EE17719070;
  EXPORT Res2 := __UNWRAP(__EE17719072);
  SHARED __EE17719075 := __ENH_Bankruptcy;
  SHARED __EE17719077 := __EE17719075;
  EXPORT Res3 := __UNWRAP(__EE17719077);
  SHARED __EE17719079 := __E_Business_Ult;
  SHARED __EE17719081 := __EE17719079;
  EXPORT Res4 := __UNWRAP(__EE17719081);
  SHARED __EE17719083 := __E_Business_Org;
  SHARED __EE17719085 := __EE17719083;
  EXPORT Res5 := __UNWRAP(__EE17719085);
  SHARED __EE17719088 := __ENH_Business_Sele;
  SHARED __EE17719090 := __EE17719088;
  EXPORT Res6 := __UNWRAP(__EE17719090);
  SHARED __EE21439243 := __ENH_Business_Prox;
  SHARED __EE21439245 := __EE21439243;
  EXPORT Res7 := __UNWRAP(__EE21439245);
  SHARED __EE21439247 := __E_Business_Pow;
  SHARED __EE21439249 := __EE21439247;
  EXPORT Res8 := __UNWRAP(__EE21439249);
  SHARED __EE21439251 := __E_Criminal_Offender;
  SHARED __EE21439253 := __EE21439251;
  EXPORT Res9 := __UNWRAP(__EE21439253);
  SHARED __EE21439256 := __ENH_Criminal_Offense;
  SHARED __EE21439258 := __EE21439256;
  EXPORT Res10 := __UNWRAP(__EE21439258);
  SHARED __EE21439260 := __E_Criminal_Punishment;
  SHARED __EE21439262 := __EE21439260;
  EXPORT Res11 := __UNWRAP(__EE21439262);
  SHARED __EE21439264 := __E_Drivers_License;
  SHARED __EE21439266 := __EE21439264;
  EXPORT Res12 := __UNWRAP(__EE21439266);
  SHARED __EE21439269 := __ENH_Education;
  SHARED __EE21439271 := __EE21439269;
  EXPORT Res13 := __UNWRAP(__EE21439271);
  SHARED __EE21439273 := __E_Email;
  SHARED __EE21439275 := __EE21439273;
  EXPORT Res14 := __UNWRAP(__EE21439275);
  SHARED __EE21439277 := __E_Employment;
  SHARED __EE21439279 := __EE21439277;
  EXPORT Res15 := __UNWRAP(__EE21439279);
  SHARED __EE21439281 := __E_Household;
  SHARED __EE21439283 := __EE21439281;
  EXPORT Res16 := __UNWRAP(__EE21439283);
  SHARED __EE21439285 := __E_Inquiry;
  SHARED __EE21439287 := __EE21439285;
  EXPORT Res17 := __UNWRAP(__EE21439287);
  SHARED __EE21439290 := __ENH_Lien_Judgment;
  SHARED __EE21439292 := __EE21439290;
  EXPORT Res18 := __UNWRAP(__EE21439292);
  SHARED __EE21439294 := __E_Geo_Link;
  SHARED __EE21439296 := __EE21439294;
  EXPORT Res19 := __UNWRAP(__EE21439296);
  SHARED __EE21439299 := __ENH_Person;
  SHARED __EE21439301 := __EE21439299;
  EXPORT Res20 := __UNWRAP(__EE21439301);
  SHARED __EE21439397 := __E_Phone;
  SHARED __EE21439399 := __EE21439397;
  EXPORT Res21 := __UNWRAP(__EE21439399);
  SHARED __EE21439402 := __ENH_Professional_License;
  SHARED __EE21439404 := __EE21439402;
  EXPORT Res22 := __UNWRAP(__EE21439404);
  SHARED __EE21439406 := __E_Property;
  SHARED __EE21439408 := __EE21439406;
  EXPORT Res23 := __UNWRAP(__EE21439408);
  SHARED __EE21439411 := __ENH_Property_Event;
  SHARED __EE21439413 := __EE21439411;
  EXPORT Res24 := __UNWRAP(__EE21439413);
  SHARED __EE21439415 := __E_Social_Security_Number;
  SHARED __EE21439417 := __EE21439415;
  EXPORT Res25 := __UNWRAP(__EE21439417);
  SHARED __EE21439419 := __E_Surname;
  SHARED __EE21439421 := __EE21439419;
  EXPORT Res26 := __UNWRAP(__EE21439421);
  SHARED __EE21439423 := __E_T_I_N;
  SHARED __EE21439425 := __EE21439423;
  EXPORT Res27 := __UNWRAP(__EE21439425);
  SHARED __EE21439428 := __ENH_Tradeline;
  SHARED __EE21439430 := __EE21439428;
  EXPORT Res28 := __UNWRAP(__EE21439430);
  SHARED __EE21439433 := __ENH_U_C_C;
  SHARED __EE21439435 := __EE21439433;
  EXPORT Res29 := __UNWRAP(__EE21439435);
  SHARED __EE21439437 := __E_Utility;
  SHARED __EE21439439 := __EE21439437;
  EXPORT Res30 := __UNWRAP(__EE21439439);
  SHARED __EE21439441 := __E_Vehicle;
  SHARED __EE21439443 := __EE21439441;
  EXPORT Res31 := __UNWRAP(__EE21439443);
  SHARED __EE21439445 := __E_Watercraft;
  SHARED __EE21439447 := __EE21439445;
  EXPORT Res32 := __UNWRAP(__EE21439447);
  SHARED __EE21439449 := __E_Zip_Code;
  EXPORT Res33 := __UNWRAP(__EE21439449);
END;
