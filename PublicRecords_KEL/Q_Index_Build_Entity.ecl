...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4730233 := __E_Accident;
  SHARED __EE4730235 := __EE4730233;
  EXPORT Res0 := __UNWRAP(__EE4730235);
  SHARED __EE11598546 := __ENH_Address;
  SHARED __EE11598548 := __EE11598546;
  EXPORT Res1 := __UNWRAP(__EE11598548);
  SHARED __EE11598551 := __ENH_Address_Summary;
  SHARED __EE11598553 := __EE11598551;
  EXPORT Res2 := __UNWRAP(__EE11598553);
  SHARED __EE4730244 := __E_Aircraft;
  SHARED __EE4730246 := __EE4730244;
  EXPORT Res3 := __UNWRAP(__EE4730246);
  SHARED __EE11598557 := __ENH_Bankruptcy;
  SHARED __EE11598559 := __EE11598557;
  EXPORT Res4 := __UNWRAP(__EE11598559);
  SHARED __EE4730251 := __E_Business_Ult;
  SHARED __EE4730253 := __EE4730251;
  EXPORT Res5 := __UNWRAP(__EE4730253);
  SHARED __EE4730254 := __E_Business_Org;
  SHARED __EE4730256 := __EE4730254;
  EXPORT Res6 := __UNWRAP(__EE4730256);
  SHARED __EE11598564 := __ENH_Business_Sele;
  SHARED __EE11598566 := __EE11598564;
  EXPORT Res7 := __UNWRAP(__EE11598566);
  SHARED __EE11598569 := __ENH_Business_Prox;
  SHARED __EE11598571 := __EE11598569;
  EXPORT Res8 := __UNWRAP(__EE11598571);
  SHARED __EE4730265 := __E_Business_Pow;
  SHARED __EE4730267 := __EE4730265;
  EXPORT Res9 := __UNWRAP(__EE4730267);
  SHARED __EE4730268 := __E_Criminal_Offender;
  SHARED __EE4730270 := __EE4730268;
  EXPORT Res10 := __UNWRAP(__EE4730270);
  SHARED __EE11598576 := __ENH_Criminal_Offense;
  SHARED __EE11598578 := __EE11598576;
  EXPORT Res11 := __UNWRAP(__EE11598578);
  SHARED __EE4730275 := __E_Criminal_Punishment;
  SHARED __EE4730277 := __EE4730275;
  EXPORT Res12 := __UNWRAP(__EE4730277);
  SHARED __EE4730278 := __E_Drivers_License;
  SHARED __EE4730280 := __EE4730278;
  EXPORT Res13 := __UNWRAP(__EE4730280);
  SHARED __EE4730281 := __E_E_B_R_Tradeline;
  SHARED __EE4730283 := __EE4730281;
  EXPORT Res14 := __UNWRAP(__EE4730283);
  SHARED __EE11598584 := __ENH_Education;
  SHARED __EE11598586 := __EE11598584;
  EXPORT Res15 := __UNWRAP(__EE11598586);
  SHARED __EE11598589 := __ENH_Email;
  SHARED __EE11598591 := __EE11598589;
  EXPORT Res16 := __UNWRAP(__EE11598591);
  SHARED __EE4730292 := __E_Household;
  SHARED __EE4730294 := __EE4730292;
  EXPORT Res17 := __UNWRAP(__EE4730294);
  SHARED __EE11598595 := __ENH_Inquiry;
  SHARED __EE11598597 := __EE11598595;
  EXPORT Res18 := __UNWRAP(__EE11598597);
  SHARED __EE11598600 := __ENH_Lien_Judgment;
  SHARED __EE11598602 := __EE11598600;
  EXPORT Res19 := __UNWRAP(__EE11598602);
  SHARED __EE4730303 := __E_Geo_Link;
  SHARED __EE4730305 := __EE4730303;
  EXPORT Res20 := __UNWRAP(__EE4730305);
  SHARED __EE11598606 := __ENH_Name_Summary;
  SHARED __EE11598608 := __EE11598606;
  EXPORT Res21 := __UNWRAP(__EE11598608);
  SHARED __EE11598611 := __ENH_Person;
  SHARED __EE11598613 := __EE11598611;
  EXPORT Res22 := __UNWRAP(__EE11598613);
  SHARED __EE4730314 := __E_Phone;
  SHARED __EE4730316 := __EE4730314;
  EXPORT Res23 := __UNWRAP(__EE4730316);
  SHARED __EE11598617 := __ENH_Phone_Summary;
  SHARED __EE11598619 := __EE11598617;
  EXPORT Res24 := __UNWRAP(__EE11598619);
  SHARED __EE11598622 := __ENH_Professional_License;
  SHARED __EE11598624 := __EE11598622;
  EXPORT Res25 := __UNWRAP(__EE11598624);
  SHARED __EE11598627 := __ENH_Property;
  SHARED __EE11598629 := __EE11598627;
  EXPORT Res26 := __UNWRAP(__EE11598629);
  SHARED __EE11598632 := __ENH_Property_Event;
  SHARED __EE11598634 := __EE11598632;
  EXPORT Res27 := __UNWRAP(__EE11598634);
  SHARED __EE4730333 := __E_Sex_Offender;
  SHARED __EE4730335 := __EE4730333;
  EXPORT Res28 := __UNWRAP(__EE4730335);
  SHARED __EE4730336 := __E_Social_Security_Number;
  SHARED __EE4730338 := __EE4730336;
  EXPORT Res29 := __UNWRAP(__EE4730338);
  SHARED __EE11598639 := __ENH_S_S_N_Summary;
  SHARED __EE11598641 := __EE11598639;
  EXPORT Res30 := __UNWRAP(__EE11598641);
  SHARED __EE4730343 := __E_Surname;
  SHARED __EE4730345 := __EE4730343;
  EXPORT Res31 := __UNWRAP(__EE4730345);
  SHARED __EE4730346 := __E_T_I_N;
  SHARED __EE4730348 := __EE4730346;
  EXPORT Res32 := __UNWRAP(__EE4730348);
  SHARED __EE11598646 := __ENH_Tradeline;
  SHARED __EE11598648 := __EE11598646;
  EXPORT Res33 := __UNWRAP(__EE11598648);
  SHARED __EE11598651 := __ENH_U_C_C;
  SHARED __EE11598653 := __EE11598651;
  EXPORT Res34 := __UNWRAP(__EE11598653);
  SHARED __EE4730357 := __E_Utility;
  SHARED __EE4730359 := __EE4730357;
  EXPORT Res35 := __UNWRAP(__EE4730359);
  SHARED __EE4730360 := __E_Vehicle;
  SHARED __EE4730362 := __EE4730360;
  EXPORT Res36 := __UNWRAP(__EE4730362);
  SHARED __EE4730363 := __E_Watercraft;
  SHARED __EE4730365 := __EE4730363;
  EXPORT Res37 := __UNWRAP(__EE4730365);
  SHARED __EE4730366 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4730366);
