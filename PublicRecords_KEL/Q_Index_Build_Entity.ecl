...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4579308 := __E_Accident;
  SHARED __EE4579310 := __EE4579308;
  EXPORT Res0 := __UNWRAP(__EE4579310);
  SHARED __EE9669127 := __ENH_Address;
  SHARED __EE9669129 := __EE9669127;
  EXPORT Res1 := __UNWRAP(__EE9669129);
  SHARED __EE9669132 := __ENH_Address_Summary;
  SHARED __EE9669134 := __EE9669132;
  EXPORT Res2 := __UNWRAP(__EE9669134);
  SHARED __EE4579319 := __E_Aircraft;
  SHARED __EE4579321 := __EE4579319;
  EXPORT Res3 := __UNWRAP(__EE4579321);
  SHARED __EE9669138 := __ENH_Bankruptcy;
  SHARED __EE9669140 := __EE9669138;
  EXPORT Res4 := __UNWRAP(__EE9669140);
  SHARED __EE4579326 := __E_Business_Ult;
  SHARED __EE4579328 := __EE4579326;
  EXPORT Res5 := __UNWRAP(__EE4579328);
  SHARED __EE4579329 := __E_Business_Org;
  SHARED __EE4579331 := __EE4579329;
  EXPORT Res6 := __UNWRAP(__EE4579331);
  SHARED __EE9669145 := __ENH_Business_Sele;
  SHARED __EE9669147 := __EE9669145;
  EXPORT Res7 := __UNWRAP(__EE9669147);
  SHARED __EE9669150 := __ENH_Business_Prox;
  SHARED __EE9669152 := __EE9669150;
  EXPORT Res8 := __UNWRAP(__EE9669152);
  SHARED __EE4579340 := __E_Business_Pow;
  SHARED __EE4579342 := __EE4579340;
  EXPORT Res9 := __UNWRAP(__EE4579342);
  SHARED __EE4579343 := __E_Criminal_Offender;
  SHARED __EE4579345 := __EE4579343;
  EXPORT Res10 := __UNWRAP(__EE4579345);
  SHARED __EE9669157 := __ENH_Criminal_Offense;
  SHARED __EE9669159 := __EE9669157;
  EXPORT Res11 := __UNWRAP(__EE9669159);
  SHARED __EE4579350 := __E_Criminal_Punishment;
  SHARED __EE4579352 := __EE4579350;
  EXPORT Res12 := __UNWRAP(__EE4579352);
  SHARED __EE4579353 := __E_Drivers_License;
  SHARED __EE4579355 := __EE4579353;
  EXPORT Res13 := __UNWRAP(__EE4579355);
  SHARED __EE4579356 := __E_E_B_R_Tradeline;
  SHARED __EE4579358 := __EE4579356;
  EXPORT Res14 := __UNWRAP(__EE4579358);
  SHARED __EE9669165 := __ENH_Education;
  SHARED __EE9669167 := __EE9669165;
  EXPORT Res15 := __UNWRAP(__EE9669167);
  SHARED __EE9669170 := __ENH_Email;
  SHARED __EE9669172 := __EE9669170;
  EXPORT Res16 := __UNWRAP(__EE9669172);
  SHARED __EE4579367 := __E_Household;
  SHARED __EE4579369 := __EE4579367;
  EXPORT Res17 := __UNWRAP(__EE4579369);
  SHARED __EE9669176 := __ENH_Inquiry;
  SHARED __EE9669178 := __EE9669176;
  EXPORT Res18 := __UNWRAP(__EE9669178);
  SHARED __EE9669181 := __ENH_Lien_Judgment;
  SHARED __EE9669183 := __EE9669181;
  EXPORT Res19 := __UNWRAP(__EE9669183);
  SHARED __EE4579378 := __E_Geo_Link;
  SHARED __EE4579380 := __EE4579378;
  EXPORT Res20 := __UNWRAP(__EE4579380);
  SHARED __EE9669187 := __ENH_Name_Summary;
  SHARED __EE9669189 := __EE9669187;
  EXPORT Res21 := __UNWRAP(__EE9669189);
  SHARED __EE9669192 := __ENH_Person;
  SHARED __EE9669194 := __EE9669192;
  EXPORT Res22 := __UNWRAP(__EE9669194);
  SHARED __EE4579389 := __E_Phone;
  SHARED __EE4579391 := __EE4579389;
  EXPORT Res23 := __UNWRAP(__EE4579391);
  SHARED __EE9669198 := __ENH_Phone_Summary;
  SHARED __EE9669200 := __EE9669198;
  EXPORT Res24 := __UNWRAP(__EE9669200);
  SHARED __EE9669203 := __ENH_Professional_License;
  SHARED __EE9669205 := __EE9669203;
  EXPORT Res25 := __UNWRAP(__EE9669205);
  SHARED __EE9669208 := __ENH_Property;
  SHARED __EE9669210 := __EE9669208;
  EXPORT Res26 := __UNWRAP(__EE9669210);
  SHARED __EE9669213 := __ENH_Property_Event;
  SHARED __EE9669215 := __EE9669213;
  EXPORT Res27 := __UNWRAP(__EE9669215);
  SHARED __EE4579408 := __E_Sex_Offender;
  SHARED __EE4579410 := __EE4579408;
  EXPORT Res28 := __UNWRAP(__EE4579410);
  SHARED __EE4579411 := __E_Social_Security_Number;
  SHARED __EE4579413 := __EE4579411;
  EXPORT Res29 := __UNWRAP(__EE4579413);
  SHARED __EE9669220 := __ENH_S_S_N_Summary;
  SHARED __EE9669222 := __EE9669220;
  EXPORT Res30 := __UNWRAP(__EE9669222);
  SHARED __EE4579418 := __E_Surname;
  SHARED __EE4579420 := __EE4579418;
  EXPORT Res31 := __UNWRAP(__EE4579420);
  SHARED __EE4579421 := __E_T_I_N;
  SHARED __EE4579423 := __EE4579421;
  EXPORT Res32 := __UNWRAP(__EE4579423);
  SHARED __EE9669227 := __ENH_Tradeline;
  SHARED __EE9669229 := __EE9669227;
  EXPORT Res33 := __UNWRAP(__EE9669229);
  SHARED __EE9669232 := __ENH_U_C_C;
  SHARED __EE9669234 := __EE9669232;
  EXPORT Res34 := __UNWRAP(__EE9669234);
  SHARED __EE4579432 := __E_Utility;
  SHARED __EE4579434 := __EE4579432;
  EXPORT Res35 := __UNWRAP(__EE4579434);
  SHARED __EE4579435 := __E_Vehicle;
  SHARED __EE4579437 := __EE4579435;
  EXPORT Res36 := __UNWRAP(__EE4579437);
  SHARED __EE4579438 := __E_Watercraft;
  SHARED __EE4579440 := __EE4579438;
  EXPORT Res37 := __UNWRAP(__EE4579440);
  SHARED __EE4579441 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4579441);
