...
EXPORT Q_Index_Build_Entity(KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Zip_Code(__in,__cfg_Local).__Result) __E_Zip_Code := E_Zip_Code_Filtered.__Result;
  SHARED __EE4735871 := __E_Accident;
  SHARED __EE4735873 := __EE4735871;
  EXPORT Res0 := __UNWRAP(__EE4735873);
  SHARED __EE11612743 := __ENH_Address;
  SHARED __EE11612745 := __EE11612743;
  EXPORT Res1 := __UNWRAP(__EE11612745);
  SHARED __EE11612748 := __ENH_Address_Summary;
  SHARED __EE11612750 := __EE11612748;
  EXPORT Res2 := __UNWRAP(__EE11612750);
  SHARED __EE4735882 := __E_Aircraft;
  SHARED __EE4735884 := __EE4735882;
  EXPORT Res3 := __UNWRAP(__EE4735884);
  SHARED __EE11612754 := __ENH_Bankruptcy;
  SHARED __EE11612756 := __EE11612754;
  EXPORT Res4 := __UNWRAP(__EE11612756);
  SHARED __EE4735889 := __E_Business_Ult;
  SHARED __EE4735891 := __EE4735889;
  EXPORT Res5 := __UNWRAP(__EE4735891);
  SHARED __EE4735892 := __E_Business_Org;
  SHARED __EE4735894 := __EE4735892;
  EXPORT Res6 := __UNWRAP(__EE4735894);
  SHARED __EE11612761 := __ENH_Business_Sele;
  SHARED __EE11612763 := __EE11612761;
  EXPORT Res7 := __UNWRAP(__EE11612763);
  SHARED __EE11612766 := __ENH_Business_Prox;
  SHARED __EE11612768 := __EE11612766;
  EXPORT Res8 := __UNWRAP(__EE11612768);
  SHARED __EE4735903 := __E_Business_Pow;
  SHARED __EE4735905 := __EE4735903;
  EXPORT Res9 := __UNWRAP(__EE4735905);
  SHARED __EE4735906 := __E_Criminal_Offender;
  SHARED __EE4735908 := __EE4735906;
  EXPORT Res10 := __UNWRAP(__EE4735908);
  SHARED __EE11612773 := __ENH_Criminal_Offense;
  SHARED __EE11612775 := __EE11612773;
  EXPORT Res11 := __UNWRAP(__EE11612775);
  SHARED __EE4735913 := __E_Criminal_Punishment;
  SHARED __EE4735915 := __EE4735913;
  EXPORT Res12 := __UNWRAP(__EE4735915);
  SHARED __EE4735916 := __E_Drivers_License;
  SHARED __EE4735918 := __EE4735916;
  EXPORT Res13 := __UNWRAP(__EE4735918);
  SHARED __EE4735919 := __E_E_B_R_Tradeline;
  SHARED __EE4735921 := __EE4735919;
  EXPORT Res14 := __UNWRAP(__EE4735921);
  SHARED __EE11612781 := __ENH_Education;
  SHARED __EE11612783 := __EE11612781;
  EXPORT Res15 := __UNWRAP(__EE11612783);
  SHARED __EE11612786 := __ENH_Email;
  SHARED __EE11612788 := __EE11612786;
  EXPORT Res16 := __UNWRAP(__EE11612788);
  SHARED __EE4735930 := __E_Household;
  SHARED __EE4735932 := __EE4735930;
  EXPORT Res17 := __UNWRAP(__EE4735932);
  SHARED __EE11612792 := __ENH_Inquiry;
  SHARED __EE11612794 := __EE11612792;
  EXPORT Res18 := __UNWRAP(__EE11612794);
  SHARED __EE11612797 := __ENH_Lien_Judgment;
  SHARED __EE11612799 := __EE11612797;
  EXPORT Res19 := __UNWRAP(__EE11612799);
  SHARED __EE4735941 := __E_Geo_Link;
  SHARED __EE4735943 := __EE4735941;
  EXPORT Res20 := __UNWRAP(__EE4735943);
  SHARED __EE11612803 := __ENH_Name_Summary;
  SHARED __EE11612805 := __EE11612803;
  EXPORT Res21 := __UNWRAP(__EE11612805);
  SHARED __EE11612808 := __ENH_Person;
  SHARED __EE11612810 := __EE11612808;
  EXPORT Res22 := __UNWRAP(__EE11612810);
  SHARED __EE4735952 := __E_Phone;
  SHARED __EE4735954 := __EE4735952;
  EXPORT Res23 := __UNWRAP(__EE4735954);
  SHARED __EE11612814 := __ENH_Phone_Summary;
  SHARED __EE11612816 := __EE11612814;
  EXPORT Res24 := __UNWRAP(__EE11612816);
  SHARED __EE11612819 := __ENH_Professional_License;
  SHARED __EE11612821 := __EE11612819;
  EXPORT Res25 := __UNWRAP(__EE11612821);
  SHARED __EE11612824 := __ENH_Property;
  SHARED __EE11612826 := __EE11612824;
  EXPORT Res26 := __UNWRAP(__EE11612826);
  SHARED __EE11612829 := __ENH_Property_Event;
  SHARED __EE11612831 := __EE11612829;
  EXPORT Res27 := __UNWRAP(__EE11612831);
  SHARED __EE4735971 := __E_Sex_Offender;
  SHARED __EE4735973 := __EE4735971;
  EXPORT Res28 := __UNWRAP(__EE4735973);
  SHARED __EE4735974 := __E_Social_Security_Number;
  SHARED __EE4735976 := __EE4735974;
  EXPORT Res29 := __UNWRAP(__EE4735976);
  SHARED __EE11612836 := __ENH_S_S_N_Summary;
  SHARED __EE11612838 := __EE11612836;
  EXPORT Res30 := __UNWRAP(__EE11612838);
  SHARED __EE4735981 := __E_Surname;
  SHARED __EE4735983 := __EE4735981;
  EXPORT Res31 := __UNWRAP(__EE4735983);
  SHARED __EE4735984 := __E_T_I_N;
  SHARED __EE4735986 := __EE4735984;
  EXPORT Res32 := __UNWRAP(__EE4735986);
  SHARED __EE11612843 := __ENH_Tradeline;
  SHARED __EE11612845 := __EE11612843;
  EXPORT Res33 := __UNWRAP(__EE11612845);
  SHARED __EE11612848 := __ENH_U_C_C;
  SHARED __EE11612850 := __EE11612848;
  EXPORT Res34 := __UNWRAP(__EE11612850);
  SHARED __EE4735995 := __E_Utility;
  SHARED __EE4735997 := __EE4735995;
  EXPORT Res35 := __UNWRAP(__EE4735997);
  SHARED __EE4735998 := __E_Vehicle;
  SHARED __EE4736000 := __EE4735998;
  EXPORT Res36 := __UNWRAP(__EE4736000);
  SHARED __EE4736001 := __E_Watercraft;
  SHARED __EE4736003 := __EE4736001;
  EXPORT Res37 := __UNWRAP(__EE4736003);
  SHARED __EE4736004 := __E_Zip_Code;
  EXPORT Res38 := __UNWRAP(__EE4736004);
