...
EXPORT B_Watercraft_Owner_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE224554 := __E_Watercraft_Owner;
  EXPORT __ST93583_Layout := RECORD
  ...
  END;
  SHARED __ST93583_Layout __ND224576__Project(E_Watercraft_Owner(__in,__cfg).Layout __PP224515) := TRANSFORM
    ...
    SELF := __PP224515;
  END;
  EXPORT __ENH_Watercraft_Owner_4 := PROJECT(__EE224554,__ND224576__Project(LEFT));
END;
