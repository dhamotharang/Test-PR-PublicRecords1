...
EXPORT B_Watercraft_Owner_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE223151 := __E_Watercraft_Owner;
  EXPORT __ST92157_Layout := RECORD
  ...
  END;
  SHARED __ST92157_Layout __ND223173__Project(E_Watercraft_Owner(__in,__cfg).Layout __PP223112) := TRANSFORM
    ...
    SELF := __PP223112;
  END;
  EXPORT __ENH_Watercraft_Owner_4 := PROJECT(__EE223151,__ND223173__Project(LEFT));
END;
