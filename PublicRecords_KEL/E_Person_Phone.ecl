...
EXPORT E_Person_Phone(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping6 := 'did(OVERRIDE:Subject_:0),cellphone(OVERRIDE:Phone_Number_:0),ownerflag(DEFAULT:Owner_Flag_:0),headerhitflag(DEFAULT:Header_Hit_Flag_),phonequality(DEFAULT:Phone_Quality_:\'\'),tnt(DEFAULT:T_N_T_:\'\'),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),listingtype(OVERRIDE:Listing_Type_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),omitindicator(DEFAULT:Omit_Indicator_:\'\'),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),confidencescore(OVERRIDE:Confidence_Score_:0),iverindicator(DEFAULT:Iver_Indicator_:0),sourcefile(DEFAULT:Source_File_:0),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),addrdatefirstseen(DEFAULT:Addr_Date_First_Seen_:DATE),rundate(DEFAULT:Run_Date_:DATE),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_6Rule),datelastseen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_6Rule),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping8 := 'did(OVERRIDE:Subject_:0),cellphone(OVERRIDE:Phone_Number_:0),append_latest_phone_owner_flag(OVERRIDE:Owner_Flag_:0),headerhitflag(DEFAULT:Header_Hit_Flag_),phonequality(DEFAULT:Phone_Quality_:\'\'),tnt(DEFAULT:T_N_T_:\'\'),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),omitindicator(DEFAULT:Omit_Indicator_:\'\'),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),confidencescore(DEFAULT:Confidence_Score_:0),iverindicator(DEFAULT:Iver_Indicator_:0),sourcefile(DEFAULT:Source_File_:0),source(OVERRIDE:Source_:\'\'),src(OVERRIDE:Original_Source_:\'\'),addrdatefirstseen(DEFAULT:Addr_Date_First_Seen_:DATE),rundate(DEFAULT:Run_Date_:DATE),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_8Rule),datelastseen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_8Rule),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping10 := 'did(OVERRIDE:Subject_:0),phone(OVERRIDE:Phone_Number_:0),ownerflag(DEFAULT:Owner_Flag_:0),phonequality(DEFAULT:Phone_Quality_:\'\'),tnt(DEFAULT:T_N_T_:\'\'),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),omitindicator(DEFAULT:Omit_Indicator_:\'\'),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),confidencescore(DEFAULT:Confidence_Score_:0),iverindicator(DEFAULT:Iver_Indicator_:0),sourcefile(DEFAULT:Source_File_:0),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),addr_dt_first_seen(OVERRIDE:Addr_Date_First_Seen_:DATE:Addr_Date_First_Seen_10Rule),run_date(OVERRIDE:Run_Date_:DATE:Run_Date_10Rule),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping11 := 'did(OVERRIDE:Subject_:0),phone(OVERRIDE:Phone_Number_:0),ownerflag(DEFAULT:Owner_Flag_:0),phonequality(DEFAULT:Phone_Quality_:\'\'),tnt(DEFAULT:T_N_T_:\'\'),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),omitindicator(DEFAULT:Omit_Indicator_:\'\'),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),confidencescore(DEFAULT:Confidence_Score_:0),iverindicator(DEFAULT:Iver_Indicator_:0),sourcefile(DEFAULT:Source_File_:0),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),addr_dt_first_seen(OVERRIDE:Addr_Date_First_Seen_:DATE:Addr_Date_First_Seen_11Rule),run_date(OVERRIDE:Run_Date_:DATE:Run_Date_11Rule),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  Layout Person_Phone__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Header_Phone_Quality_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Phone_Quality_,T_N_T_},Phone_Quality_,T_N_T_),Header_Phone_Quality_Layout)(__NN(Phone_Quality_) OR __NN(T_N_T_)));
    SELF.Owner_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Owner_Flag_},Owner_Flag_),Owner_Layout)(__NN(Owner_Flag_)));
    SELF.Phone_Details_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Prior_Area_Code_,Current_Flag_,Business_Flag_,Publish_Code_,Listing_Type_,Is_Active_,Omit_Indicator_,Confidence_Score_,No_Solicit_Code_,Record_Type_,Phone_Type_,Validation_Flag_,Validation_Date_,Source_File_,Iver_Indicator_,Source_},Prior_Area_Code_,Current_Flag_,Business_Flag_,Publish_Code_,Listing_Type_,Is_Active_,Omit_Indicator_,Confidence_Score_,No_Solicit_Code_,Record_Type_,Phone_Type_,Validation_Flag_,Validation_Date_,Source_File_,Iver_Indicator_,Source_),Phone_Details_Layout)(__NN(Prior_Area_Code_) OR __NN(Current_Flag_) OR __NN(Business_Flag_) OR __NN(Publish_Code_) OR __NN(Listing_Type_) OR __NN(Is_Active_) OR __NN(Omit_Indicator_) OR __NN(Confidence_Score_) OR __NN(No_Solicit_Code_) OR __NN(Record_Type_) OR __NN(Phone_Type_) OR __NN(Validation_Flag_) OR __NN(Validation_Date_) OR __NN(Source_File_) OR __NN(Iver_Indicator_) OR __NN(Source_)));
    SELF.Data_Sources_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Source_,Original_Source_,Header_Hit_Flag_,Addr_Date_First_Seen_,Run_Date_},Source_,Original_Source_,Header_Hit_Flag_,Addr_Date_First_Seen_,Run_Date_),Data_Sources_Layout)(__NN(Source_) OR __NN(Original_Source_) OR __NN(Header_Hit_Flag_) OR __NN(Addr_Date_First_Seen_) OR __NN(Run_Date_)));
  ...
  Layout Person_Phone__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Header_Phone_Quality_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Header_Phone_Quality_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF:=LEFT))(__NN(Phone_Quality_) OR __NN(T_N_T_)));
    SELF.Owner_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Owner_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF:=LEFT))(__NN(Owner_Flag_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d0(__NL(Addr_Date_First_Seen_))),COUNT(__d0(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d0(__NL(Run_Date_))),COUNT(__d0(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d0(Date_Vendor_First_Reported_=0)),COUNT(__d0(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d0(Date_Vendor_Last_Reported_=0)),COUNT(__d0(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d1(__NL(Addr_Date_First_Seen_))),COUNT(__d1(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d1(__NL(Run_Date_))),COUNT(__d1(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d1(Date_Vendor_First_Reported_=0)),COUNT(__d1(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d1(Date_Vendor_Last_Reported_=0)),COUNT(__d1(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d2(__NL(Addr_Date_First_Seen_))),COUNT(__d2(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d2(__NL(Run_Date_))),COUNT(__d2(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d2(Date_Vendor_First_Reported_=0)),COUNT(__d2(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d2(Date_Vendor_Last_Reported_=0)),COUNT(__d2(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d3(__NL(Addr_Date_First_Seen_))),COUNT(__d3(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d3(__NL(Run_Date_))),COUNT(__d3(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d3(Date_Vendor_First_Reported_=0)),COUNT(__d3(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d3(Date_Vendor_Last_Reported_=0)),COUNT(__d3(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d4(__NL(Addr_Date_First_Seen_))),COUNT(__d4(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d4(__NL(Run_Date_))),COUNT(__d4(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d4(Date_Vendor_First_Reported_=0)),COUNT(__d4(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d4(Date_Vendor_Last_Reported_=0)),COUNT(__d4(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d5(__NL(Addr_Date_First_Seen_))),COUNT(__d5(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d5(__NL(Run_Date_))),COUNT(__d5(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d5(Date_Vendor_First_Reported_=0)),COUNT(__d5(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d5(Date_Vendor_Last_Reported_=0)),COUNT(__d5(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d6(__NL(Addr_Date_First_Seen_))),COUNT(__d6(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d6(__NL(Run_Date_))),COUNT(__d6(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d6(Date_Vendor_First_Reported_=0)),COUNT(__d6(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d6(Date_Vendor_Last_Reported_=0)),COUNT(__d6(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d7(__NL(Addr_Date_First_Seen_))),COUNT(__d7(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d7(__NL(Run_Date_))),COUNT(__d7(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d7(Date_Vendor_First_Reported_=0)),COUNT(__d7(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d7(Date_Vendor_Last_Reported_=0)),COUNT(__d7(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddrDateFirstSeen',COUNT(__d8(__NL(Addr_Date_First_Seen_))),COUNT(__d8(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RunDate',COUNT(__d8(__NL(Run_Date_))),COUNT(__d8(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d8(Date_Vendor_First_Reported_=0)),COUNT(__d8(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d8(Date_Vendor_Last_Reported_=0)),COUNT(__d8(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.addr_dt_first_seen',COUNT(__d9(__NL(Addr_Date_First_Seen_))),COUNT(__d9(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.run_date',COUNT(__d9(__NL(Run_Date_))),COUNT(__d9(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d9(Date_Vendor_First_Reported_=0)),COUNT(__d9(Date_Vendor_First_Reported_!=0))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d9(Date_Vendor_Last_Reported_=0)),COUNT(__d9(Date_Vendor_Last_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addr_dt_first_seen',COUNT(__d10(__NL(Addr_Date_First_Seen_))),COUNT(__d10(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','run_date',COUNT(__d10(__NL(Run_Date_))),COUNT(__d10(__NN(Run_Date_)))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d10(Date_Vendor_First_Reported_=0)),COUNT(__d10(Date_Vendor_First_Reported_!=0))},
    ...
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','addr_dt_first_seen',COUNT(__d11(__NL(Addr_Date_First_Seen_))),COUNT(__d11(__NN(Addr_Date_First_Seen_)))},
    {'PersonPhone','PublicRecords_KEL.ECL_Functions.Dataset_FDC','run_date',COUNT(__d11(__NL(Run_Date_))),COUNT(__d11(__NN(Run_Date_)))},
