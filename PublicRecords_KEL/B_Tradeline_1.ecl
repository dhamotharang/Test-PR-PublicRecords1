...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8384001 := __ENH_Tradeline_2;
  EXPORT __ST199901_Layout := RECORD
  ...
  END;
  EXPORT __ST199894_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST199901_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST199894_Layout __ND8384006__Project(B_Tradeline_2(__in,__cfg).__ST218505_Layout __PP8384002) := TRANSFORM
    __EE8384046 := __PP8384002.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE8384046),__ST199901_Layout),__NL(__EE8384046));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP8384002.Date_First_Seen_);
    SELF := __PP8384002;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE8384001,__ND8384006__Project(LEFT));
END;
