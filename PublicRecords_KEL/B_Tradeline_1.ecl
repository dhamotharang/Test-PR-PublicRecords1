...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9323943 := __ENH_Tradeline_2;
  ...
  END;
  EXPORT __ST204065_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST204072_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST204065_Layout __ND9323948__Project(B_Tradeline_2(__in,__cfg).__ST223056_Layout __PP9323944) := TRANSFORM
    __EE9323988 := __PP9323944.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9323988),__ST204072_Layout),__NL(__EE9323988));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP9323944.Date_First_Seen_);
    SELF := __PP9323944;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE9323943,__ND9323948__Project(LEFT));
END;
