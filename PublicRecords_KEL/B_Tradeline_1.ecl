...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9687230 := __ENH_Tradeline_2;
  EXPORT __ST213582_Layout := RECORD
  ...
  END;
  EXPORT __ST213575_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST213582_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213575_Layout __ND9687235__Project(B_Tradeline_2(__in,__cfg).__ST232717_Layout __PP9687231) := TRANSFORM
    __EE9687275 := __PP9687231.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9687275),__ST213582_Layout),__NL(__EE9687275));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP9687231.Date_First_Seen_);
    SELF := __PP9687231;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE9687230,__ND9687235__Project(LEFT));
END;
