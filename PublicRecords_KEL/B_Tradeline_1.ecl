...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7952115 := __ENH_Tradeline_2;
  EXPORT __ST193824_Layout := RECORD
  ...
  END;
  EXPORT __ST193817_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST193824_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST193817_Layout __ND7952120__Project(B_Tradeline_2(__in,__cfg).__ST212120_Layout __PP7952116) := TRANSFORM
    __EE7952160 := __PP7952116.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE7952160),__ST193824_Layout),__NL(__EE7952160));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP7952116.Date_First_Seen_);
    SELF := __PP7952116;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE7952115,__ND7952120__Project(LEFT));
END;
