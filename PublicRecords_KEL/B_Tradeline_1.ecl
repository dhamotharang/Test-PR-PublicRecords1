...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE936689 := __ENH_Tradeline_2;
  EXPORT __ST76532_Layout := RECORD
  ...
  END;
  EXPORT __ST76525_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST76532_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST76525_Layout __ND936978__Project(B_Tradeline_2(__in,__cfg).__ST83771_Layout __PP936324) := TRANSFORM
    __EE936399 := __PP936324.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE936399),__ST76532_Layout),__NL(__EE936399));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP936324.Date_First_Seen_);
    SELF := __PP936324;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE936689,__ND936978__Project(LEFT));
END;
