...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7941607 := __ENH_Tradeline_2;
  EXPORT __ST193314_Layout := RECORD
  ...
  END;
  EXPORT __ST193307_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST193314_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST193307_Layout __ND7941612__Project(B_Tradeline_2(__in,__cfg).__ST211599_Layout __PP7941608) := TRANSFORM
    __EE7941652 := __PP7941608.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE7941652),__ST193314_Layout),__NL(__EE7941652));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP7941608.Date_First_Seen_);
    SELF := __PP7941608;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE7941607,__ND7941612__Project(LEFT));
END;
