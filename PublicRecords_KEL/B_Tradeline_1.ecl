...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8456683 := __ENH_Tradeline_2;
  EXPORT __ST201579_Layout := RECORD
  ...
  END;
  EXPORT __ST201572_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST201579_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201572_Layout __ND8456688__Project(B_Tradeline_2(__in,__cfg).__ST220317_Layout __PP8456684) := TRANSFORM
    __EE8456728 := __PP8456684.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE8456728),__ST201579_Layout),__NL(__EE8456728));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP8456684.Date_First_Seen_);
    SELF := __PP8456684;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE8456683,__ND8456688__Project(LEFT));
END;
