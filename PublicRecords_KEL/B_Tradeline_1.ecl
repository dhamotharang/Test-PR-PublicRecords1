...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9394396 := __ENH_Tradeline_2;
  EXPORT __ST206570_Layout := RECORD
  ...
  END;
  EXPORT __ST206563_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST206570_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST206563_Layout __ND9394401__Project(B_Tradeline_2(__in,__cfg).__ST225744_Layout __PP9394397) := TRANSFORM
    __EE9394441 := __PP9394397.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9394441),__ST206570_Layout),__NL(__EE9394441));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP9394397.Date_First_Seen_);
    SELF := __PP9394397;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE9394396,__ND9394401__Project(LEFT));
END;
