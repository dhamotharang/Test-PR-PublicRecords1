...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9691881 := __ENH_Tradeline_2;
  EXPORT __ST213643_Layout := RECORD
  ...
  END;
  EXPORT __ST213636_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST213643_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST213636_Layout __ND9691886__Project(B_Tradeline_2(__in,__cfg).__ST232791_Layout __PP9691882) := TRANSFORM
    __EE9691926 := __PP9691882.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9691926),__ST213643_Layout),__NL(__EE9691926));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP9691882.Date_First_Seen_);
    SELF := __PP9691882;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE9691881,__ND9691886__Project(LEFT));
END;
