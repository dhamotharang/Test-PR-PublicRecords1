...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9322357 := __ENH_Tradeline_2;
  EXPORT __ST204102_Layout := RECORD
  ...
  END;
  EXPORT __ST204095_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST204102_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST204095_Layout __ND9322362__Project(B_Tradeline_2(__in,__cfg).__ST223086_Layout __PP9322358) := TRANSFORM
    __EE9322402 := __PP9322358.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE9322402),__ST204102_Layout),__NL(__EE9322402));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP9322358.Date_First_Seen_);
    SELF := __PP9322358;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE9322357,__ND9322362__Project(LEFT));
END;
