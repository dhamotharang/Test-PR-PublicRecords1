...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8443661 := __ENH_Tradeline_2;
  ...
  EXPORT __ST201235_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST201242_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201235_Layout __ND8443666__Project(B_Tradeline_2(__in,__cfg).__ST219958_Layout __PP8443662) := TRANSFORM
    __EE8443706 := __PP8443662.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE8443706),__ST201242_Layout),__NL(__EE8443706));
    SELF.Trade_Date_ := KEL.era.ToDate(__PP8443662.Date_First_Seen_);
    SELF := __PP8443662;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE8443661,__ND8443666__Project(LEFT));
END;
