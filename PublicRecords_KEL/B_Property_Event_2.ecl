...
IMPORT KEL13 AS KEL;
IMPORT B_Property_Event_3,B_Property_Event_4,CFG_Compile,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT B_Property_Event_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4608703 := __ENH_Property_Event_3;
  EXPORT __ENH_Property_Event_2 := __EE4608703;
END;
