...
EXPORT B_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5780543 := __ENH_Address_3;
  SHARED __EE5780545 := __E_Zip_Code;
  SHARED __ST1128801_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC5780554(B_Address_5(__in,__cfg).__ST240895_Layout __EE5780543, E_Zip_Code(__in,__cfg).Layout __EE5780545) := __EEQP(__EE5780543.Z_I_P5_,__EE5780545.UID);
  __ST1128801_Layout __JT5780554(B_Address_5(__in,__cfg).__ST240895_Layout __l, E_Zip_Code(__in,__cfg).Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Data_Sources__1_ := __r.Data_Sources_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE5780715 := JOIN(__EE5780543,__EE5780545,__JC5780554(LEFT,RIGHT),__JT5780554(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST198116_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    KEL.typ.nstr Primary_Name_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST198116_Layout __ND5780292__Project(__ST1128801_Layout __PP5778812) := TRANSFORM
    __EE5780287 := __PP5778812.Bestchild_Advo_;
    SELF.College_Flag_ := (__T(__EE5780287))[1].College_Indicator_;
    __EE5780302 := __PP5778812.Bestchild_Advo_;
    SELF.Do_Not_Deliver_Flag_ := (__T(__EE5780302))[1].Do_Not_Deliver_Indicator_;
    __EE5780316 := __PP5778812.Bestchild_Advo_;
    SELF.Drop_Indicator_Flag_ := (__T(__EE5780316))[1].Drop_Indicator_;
    __BS5780322 := __T(__PP5778812.Address_Type_);
    SELF.Is_P_O_Box_A_D_V_O_ := EXISTS(__BS5780322(__T(__OP2(__T(__PP5778812.Address_Type_).Address_Type_Code_,=,__CN('9')))));
    SELF.Is_P_O_Box_Zip_ := __OP2(__PP5778812.Zip_Class_,=,__CN('P'));
    __EE5780349 := __PP5778812.Bestchild_Advo_;
    SELF.Seasonal_Delivery_Flag_ := (__T(__EE5780349))[1].Seasonal_Delivery_Indicator_;
    __EE5780363 := __PP5778812.Bestchild_Advo_;
    SELF.Style_Flag_ := (__T(__EE5780363))[1].Style_Code_;
    __EE5780377 := __PP5778812.Bestchild_Advo_;
    SELF.Throw_Back_Flag_ := (__T(__EE5780377))[1].Throw_Back_Indicator_;
    SELF := __PP5778812;
  END;
  EXPORT __ENH_Address_2 := PROJECT(__EE5780715,__ND5780292__Project(LEFT));
END;
