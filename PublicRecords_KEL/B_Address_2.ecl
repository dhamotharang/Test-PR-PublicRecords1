...
EXPORT B_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6068104 := __ENH_Address_3;
  SHARED __EE6068106 := __E_Zip_Code;
  SHARED __ST1145320_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC6068115(B_Address_5(__in,__cfg).__ST237103_Layout __EE6068104, E_Zip_Code(__in,__cfg).Layout __EE6068106) := __EEQP(__EE6068104.Z_I_P5_,__EE6068106.UID);
  __ST1145320_Layout __JT6068115(B_Address_5(__in,__cfg).__ST237103_Layout __l, E_Zip_Code(__in,__cfg).Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Data_Sources__1_ := __r.Data_Sources_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE6068276 := JOIN(__EE6068104,__EE6068106,__JC6068115(LEFT,RIGHT),__JT6068115(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST194162_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    KEL.typ.nstr Primary_Name_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST194162_Layout __ND6067853__Project(__ST1145320_Layout __PP6066373) := TRANSFORM
    __EE6067848 := __PP6066373.Bestchild_Advo_;
    SELF.College_Flag_ := (__T(__EE6067848))[1].College_Indicator_;
    __EE6067863 := __PP6066373.Bestchild_Advo_;
    SELF.Do_Not_Deliver_Flag_ := (__T(__EE6067863))[1].Do_Not_Deliver_Indicator_;
    __EE6067877 := __PP6066373.Bestchild_Advo_;
    SELF.Drop_Indicator_Flag_ := (__T(__EE6067877))[1].Drop_Indicator_;
    __BS6067883 := __T(__PP6066373.Address_Type_);
    SELF.Is_P_O_Box_A_D_V_O_ := EXISTS(__BS6067883(__T(__OP2(__T(__PP6066373.Address_Type_).Address_Type_Code_,=,__CN('9')))));
    SELF.Is_P_O_Box_Zip_ := __OP2(__PP6066373.Zip_Class_,=,__CN('P'));
    __EE6067910 := __PP6066373.Bestchild_Advo_;
    SELF.Seasonal_Delivery_Flag_ := (__T(__EE6067910))[1].Seasonal_Delivery_Indicator_;
    __EE6067924 := __PP6066373.Bestchild_Advo_;
    SELF.Style_Flag_ := (__T(__EE6067924))[1].Style_Code_;
    __EE6067938 := __PP6066373.Bestchild_Advo_;
    SELF.Throw_Back_Flag_ := (__T(__EE6067938))[1].Throw_Back_Indicator_;
    SELF := __PP6066373;
  END;
  EXPORT __ENH_Address_2 := PROJECT(__EE6068276,__ND6067853__Project(LEFT));
END;
