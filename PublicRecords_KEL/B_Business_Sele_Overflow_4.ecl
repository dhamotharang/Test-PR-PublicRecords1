...
EXPORT B_Business_Sele_Overflow_4(CFG_Compile __cfg = CFG_Compile) := MODULE
  SHARED VIRTUAL TYPEOF(B_Business_Sele_Overflow_5(__cfg).__ENH_Business_Sele_Overflow_5) __ENH_Business_Sele_Overflow_5 := B_Business_Sele_Overflow_5(__cfg).__ENH_Business_Sele_Overflow_5;
  SHARED __EE5526501 := __ENH_Business_Sele_Overflow_5;
  EXPORT __ST238816_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST238816_Layout __ND5526872__Project(B_Business_Sele_Overflow_5(__cfg).__ST246456_Layout __PP5526502) := TRANSFORM
    __CC14570 := KEL.Routines.MinN(FN_Compile(__cfg).FN_G_E_T_B_U_I_L_D_D_A_T_E(__ECAST(KEL.typ.nstr,__CN('Corp_build_version'))),__CN(__cfg.CurrentDate));
    SELF.S_O_S_Dom_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP5526502.S_O_S_Dom_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC14570);
    SELF.S_O_S_Dom_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP5526502.S_O_S_Dom_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC14570);
    SELF.S_O_S_Filing_Total_Count_ := __PP5526502.S_O_S_Domestic_Filing_Count_ + __PP5526502.S_O_S_Foreign_Filing_Count_;
    SELF.S_O_S_Frgn_Date_First_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP5526502.S_O_S_Frgn_Date_First_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC14570);
    SELF.S_O_S_Frgn_Date_Last_Seen_Capped_ := __FN3(KEL.Routines.BoundsFold,__PP5526502.S_O_S_Frgn_Date_Last_Seen_,KEL.Routines.CastStringToDate(__CN('19000101')),__CC14570);
    SELF := __PP5526502;
  END;
  EXPORT __ENH_Business_Sele_Overflow_4 := PROJECT(__EE5526501,__ND5526872__Project(LEFT));
END;
