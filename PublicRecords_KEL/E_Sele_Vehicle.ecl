...
EXPORT E_Sele_Vehicle(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  Layout Sele_Vehicle__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Party_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Party_Type_,Party_Name_Type_},Party_Type_,Party_Name_Type_),Party_Layout)(__NN(Party_Type_) OR __NN(Party_Name_Type_)));
    SELF.Registration_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Registration_First_Date_,Registration_Earliest_Effective_Date_,Registration_Latest_Effective_Date_,Registration_Latest_Expiratione_Date_,Registration_Record_Count_,Registration_Decal_Number_,Registratoin_Decal_Year_,Registration_Status_Code_,Registration_Status_Description_,Registration_True_License_Plate_,Registration_License_Plate_,Registration_License_State_,Registration_License_Plate_Type_Code_,Registration_License_Plate_Type_Description_,Registration_Previous_License_State_,Registration_Previous_License_Plate_},Registration_First_Date_,Registration_Earliest_Effective_Date_,Registration_Latest_Effective_Date_,Registration_Latest_Expiratione_Date_,Registration_Record_Count_,Registration_Decal_Number_,Registratoin_Decal_Year_,Registration_Status_Code_,Registration_Status_Description_,Registration_True_License_Plate_,Registration_License_Plate_,Registration_License_State_,Registration_License_Plate_Type_Code_,Registration_License_Plate_Type_Description_,Registration_Previous_License_State_,Registration_Previous_License_Plate_),Registration_Layout)(__NN(Registration_First_Date_) OR __NN(Registration_Earliest_Effective_Date_) OR __NN(Registration_Latest_Effective_Date_) OR __NN(Registration_Latest_Expiratione_Date_) OR __NN(Registration_Record_Count_) OR __NN(Registration_Decal_Number_) OR __NN(Registratoin_Decal_Year_) OR __NN(Registration_Status_Code_) OR __NN(Registration_Status_Description_) OR __NN(Registration_True_License_Plate_) OR __NN(Registration_License_Plate_) OR __NN(Registration_License_State_) OR __NN(Registration_License_Plate_Type_Code_) OR __NN(Registration_License_Plate_Type_Description_) OR __NN(Registration_Previous_License_State_) OR __NN(Registration_Previous_License_Plate_)));
    SELF.Title_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Title_Number_,Title_Earliest_Issue_Date_,Title_Latest_Issue_Date_,Title_Previous_Issue_Date_,Title_Record_Count_,Title_Status_Code_,Title_Status_Description_,Title_Odometer_Mileage_,Title_Odometer_Status_Code_,Title_Odometer_Status_Description_,Title_Odometer_Date_},Title_Number_,Title_Earliest_Issue_Date_,Title_Latest_Issue_Date_,Title_Previous_Issue_Date_,Title_Record_Count_,Title_Status_Code_,Title_Status_Description_,Title_Odometer_Mileage_,Title_Odometer_Status_Code_,Title_Odometer_Status_Description_,Title_Odometer_Date_),Title_Layout)(__NN(Title_Number_) OR __NN(Title_Earliest_Issue_Date_) OR __NN(Title_Latest_Issue_Date_) OR __NN(Title_Previous_Issue_Date_) OR __NN(Title_Record_Count_) OR __NN(Title_Status_Code_) OR __NN(Title_Status_Description_) OR __NN(Title_Odometer_Mileage_) OR __NN(Title_Odometer_Status_Code_) OR __NN(Title_Odometer_Status_Description_) OR __NN(Title_Odometer_Date_)));
    SELF.Counts_Model_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Sequence_Key_,History_},Sequence_Key_,History_),Counts_Model_Layout)(__NN(Sequence_Key_) OR __NN(History_)));
