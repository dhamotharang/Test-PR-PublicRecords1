...
IMPORT CFG_Compile,E_Business_Org,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_Vehicle FROM PublicRecords_KEL;
IMPORT * FROM KEL15.Null;
EXPORT E_Sele_Vehicle(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault((STRING20)vehicle_key <> '' AND (UNSIGNED)ultid<>0 AND (UNSIGNED)orgid<>0 AND (UNSIGNED)seleid<>0);
  SHARED __d0_Legal__Layout := RECORD
    RECORDOF(__d0_KELfiltered);
    KEL.typ.uid Legal_;
  END;
  SHARED __d0_Missing_Legal__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_KELfiltered,'ultid,orgid,seleid','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault');
  ...
  END;
  SHARED __d0_Missing_Automobile__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_Legal__Mapped,'vehicle_key','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault');
  SHARED __d0_Automobile__Mapped := IF(__d0_Missing_Automobile__UIDComponents = 'vehicle_key',PROJECT(__d0_Legal__Mapped,TRANSFORM(__d0_Automobile__Layout,SELF.Automobile_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d0_Legal__Mapped,__d0_Missing_Automobile__UIDComponents),E_Vehicle(__cfg).Lookup,TRIM((STRING)LEFT.vehicle_key) = RIGHT.KeyVal,TRANSFORM(__d0_Automobile__Layout,SELF.Automobile_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  SHARED __d0_Prefiltered := __d0_Automobile__Mapped;
  SHARED __d0 := __SourceFilter(KEL.FromFlat.Convert(__d0_Prefiltered,InLayout,__Mapping0,'PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault'));
  ...
  EXPORT __d1_KELfiltered := PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault((STRING20)vehicle_key <> '' AND (UNSIGNED)ultid<>0 AND (UNSIGNED)orgid<>0 AND (UNSIGNED)seleid<>0);
  SHARED __d1_Legal__Layout := RECORD
    RECORDOF(__d1_KELfiltered);
    KEL.typ.uid Legal_;
  END;
  SHARED __d1_Missing_Legal__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d1_KELfiltered,'ultid,orgid,seleid','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault');
  ...
  SHARED __d1_Automobile__Layout := RECORD
    ...
    KEL.typ.uid Automobile_;
  END;
  SHARED __d1_Missing_Automobile__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d1_Legal__Mapped,'vehicle_key','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault');
  SHARED __d1_Automobile__Mapped := IF(__d1_Missing_Automobile__UIDComponents = 'vehicle_key',PROJECT(__d1_Legal__Mapped,TRANSFORM(__d1_Automobile__Layout,SELF.Automobile_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d1_Legal__Mapped,__d1_Missing_Automobile__UIDComponents),E_Vehicle(__cfg).Lookup,TRIM((STRING)LEFT.vehicle_key) = RIGHT.KeyVal,TRANSFORM(__d1_Automobile__Layout,SELF.Automobile_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,SMART));
  SHARED __d1_Prefiltered := __d1_Automobile__Mapped;
  SHARED __d1 := __SourceFilter(KEL.FromFlat.Convert(__d1_Prefiltered,InLayout,__Mapping1,'PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault'));
  ...
  EXPORT NullCounts := DATASET([
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','Legal',COUNT(__d0(__NL(Legal_))),COUNT(__d0(__NN(Legal_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','Automobile',COUNT(__d0(__NL(Automobile_))),COUNT(__d0(__NN(Automobile_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ultid',COUNT(__d0(__NL(Ult_I_D_))),COUNT(__d0(__NN(Ult_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','orgid',COUNT(__d0(__NL(Org_I_D_))),COUNT(__d0(__NN(Org_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','seleid',COUNT(__d0(__NL(Sele_I_D_))),COUNT(__d0(__NN(Sele_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','vehicle_key',COUNT(__d0(__NL(Vehicle_Key_))),COUNT(__d0(__NN(Vehicle_Key_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','orig_party_type',COUNT(__d0(__NL(Party_Type_))),COUNT(__d0(__NN(Party_Type_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','orig_name_type',COUNT(__d0(__NL(Party_Name_Type_))),COUNT(__d0(__NN(Party_Name_Type_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_first_date',COUNT(__d0(__NL(Registration_First_Date_))),COUNT(__d0(__NN(Registration_First_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_earliest_effective_date',COUNT(__d0(__NL(Registration_Earliest_Effective_Date_))),COUNT(__d0(__NN(Registration_Earliest_Effective_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_latest_effective_date',COUNT(__d0(__NL(Registration_Latest_Effective_Date_))),COUNT(__d0(__NN(Registration_Latest_Effective_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_latest_expiration_date',COUNT(__d0(__NL(Registration_Latest_Expiratione_Date_))),COUNT(__d0(__NN(Registration_Latest_Expiratione_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_rollup_count',COUNT(__d0(__NL(Registration_Record_Count_))),COUNT(__d0(__NN(Registration_Record_Count_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_decal_number',COUNT(__d0(__NL(Registration_Decal_Number_))),COUNT(__d0(__NN(Registration_Decal_Number_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_decal_year',COUNT(__d0(__NL(Registratoin_Decal_Year_))),COUNT(__d0(__NN(Registratoin_Decal_Year_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_status_code',COUNT(__d0(__NL(Registration_Status_Code_))),COUNT(__d0(__NN(Registration_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_status_desc',COUNT(__d0(__NL(Registration_Status_Description_))),COUNT(__d0(__NN(Registration_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_true_license_plate',COUNT(__d0(__NL(Registration_True_License_Plate_))),COUNT(__d0(__NN(Registration_True_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate',COUNT(__d0(__NL(Registration_License_Plate_))),COUNT(__d0(__NN(Registration_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_state',COUNT(__d0(__NL(Registration_License_State_))),COUNT(__d0(__NN(Registration_License_State_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate_type_code',COUNT(__d0(__NL(Registration_License_Plate_Type_Code_))),COUNT(__d0(__NN(Registration_License_Plate_Type_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate_type_desc',COUNT(__d0(__NL(Registration_License_Plate_Type_Description_))),COUNT(__d0(__NN(Registration_License_Plate_Type_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_previous_license_state',COUNT(__d0(__NL(Registration_Previous_License_State_))),COUNT(__d0(__NN(Registration_Previous_License_State_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_previous_license_plate',COUNT(__d0(__NL(Registration_Previous_License_Plate_))),COUNT(__d0(__NN(Registration_Previous_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_number',COUNT(__d0(__NL(Title_Number_))),COUNT(__d0(__NN(Title_Number_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_earliest_issue_date',COUNT(__d0(__NL(Title_Earliest_Issue_Date_))),COUNT(__d0(__NN(Title_Earliest_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_latest_issue_date',COUNT(__d0(__NL(Title_Latest_Issue_Date_))),COUNT(__d0(__NN(Title_Latest_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_previous_issue_date',COUNT(__d0(__NL(Title_Previous_Issue_Date_))),COUNT(__d0(__NN(Title_Previous_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_rollup_count',COUNT(__d0(__NL(Title_Record_Count_))),COUNT(__d0(__NN(Title_Record_Count_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_status_code',COUNT(__d0(__NL(Title_Status_Code_))),COUNT(__d0(__NN(Title_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_status_desc',COUNT(__d0(__NL(Title_Status_Description_))),COUNT(__d0(__NN(Title_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_mileage',COUNT(__d0(__NL(Title_Odometer_Mileage_))),COUNT(__d0(__NN(Title_Odometer_Mileage_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_status_code',COUNT(__d0(__NL(Title_Odometer_Status_Code_))),COUNT(__d0(__NN(Title_Odometer_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_status_desc',COUNT(__d0(__NL(Title_Odometer_Status_Description_))),COUNT(__d0(__NN(Title_Odometer_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_date',COUNT(__d0(__NL(Title_Odometer_Date_))),COUNT(__d0(__NN(Title_Odometer_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','sequence_key',COUNT(__d0(__NL(Sequence_Key_))),COUNT(__d0(__NN(Sequence_Key_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','history',COUNT(__d0(__NL(History_))),COUNT(__d0(__NN(History_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','source_code',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','Legal',COUNT(__d1(__NL(Legal_))),COUNT(__d1(__NN(Legal_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','Automobile',COUNT(__d1(__NL(Automobile_))),COUNT(__d1(__NN(Automobile_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ultid',COUNT(__d1(__NL(Ult_I_D_))),COUNT(__d1(__NN(Ult_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','orgid',COUNT(__d1(__NL(Org_I_D_))),COUNT(__d1(__NN(Org_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','seleid',COUNT(__d1(__NL(Sele_I_D_))),COUNT(__d1(__NN(Sele_I_D_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','vehicle_key',COUNT(__d1(__NL(Vehicle_Key_))),COUNT(__d1(__NN(Vehicle_Key_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','orig_party_type',COUNT(__d1(__NL(Party_Type_))),COUNT(__d1(__NN(Party_Type_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','orig_name_type',COUNT(__d1(__NL(Party_Name_Type_))),COUNT(__d1(__NN(Party_Name_Type_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_first_date',COUNT(__d1(__NL(Registration_First_Date_))),COUNT(__d1(__NN(Registration_First_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_earliest_effective_date',COUNT(__d1(__NL(Registration_Earliest_Effective_Date_))),COUNT(__d1(__NN(Registration_Earliest_Effective_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_latest_effective_date',COUNT(__d1(__NL(Registration_Latest_Effective_Date_))),COUNT(__d1(__NN(Registration_Latest_Effective_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_latest_expiration_date',COUNT(__d1(__NL(Registration_Latest_Expiratione_Date_))),COUNT(__d1(__NN(Registration_Latest_Expiratione_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_rollup_count',COUNT(__d1(__NL(Registration_Record_Count_))),COUNT(__d1(__NN(Registration_Record_Count_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_decal_number',COUNT(__d1(__NL(Registration_Decal_Number_))),COUNT(__d1(__NN(Registration_Decal_Number_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_decal_year',COUNT(__d1(__NL(Registratoin_Decal_Year_))),COUNT(__d1(__NN(Registratoin_Decal_Year_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_status_code',COUNT(__d1(__NL(Registration_Status_Code_))),COUNT(__d1(__NN(Registration_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_status_desc',COUNT(__d1(__NL(Registration_Status_Description_))),COUNT(__d1(__NN(Registration_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_true_license_plate',COUNT(__d1(__NL(Registration_True_License_Plate_))),COUNT(__d1(__NN(Registration_True_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_license_plate',COUNT(__d1(__NL(Registration_License_Plate_))),COUNT(__d1(__NN(Registration_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_license_state',COUNT(__d1(__NL(Registration_License_State_))),COUNT(__d1(__NN(Registration_License_State_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_license_plate_type_code',COUNT(__d1(__NL(Registration_License_Plate_Type_Code_))),COUNT(__d1(__NN(Registration_License_Plate_Type_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_license_plate_type_desc',COUNT(__d1(__NL(Registration_License_Plate_Type_Description_))),COUNT(__d1(__NN(Registration_License_Plate_Type_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_previous_license_state',COUNT(__d1(__NL(Registration_Previous_License_State_))),COUNT(__d1(__NN(Registration_Previous_License_State_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','reg_previous_license_plate',COUNT(__d1(__NL(Registration_Previous_License_Plate_))),COUNT(__d1(__NN(Registration_Previous_License_Plate_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_number',COUNT(__d1(__NL(Title_Number_))),COUNT(__d1(__NN(Title_Number_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_earliest_issue_date',COUNT(__d1(__NL(Title_Earliest_Issue_Date_))),COUNT(__d1(__NN(Title_Earliest_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_latest_issue_date',COUNT(__d1(__NL(Title_Latest_Issue_Date_))),COUNT(__d1(__NN(Title_Latest_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_previous_issue_date',COUNT(__d1(__NL(Title_Previous_Issue_Date_))),COUNT(__d1(__NN(Title_Previous_Issue_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_rollup_count',COUNT(__d1(__NL(Title_Record_Count_))),COUNT(__d1(__NN(Title_Record_Count_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_status_code',COUNT(__d1(__NL(Title_Status_Code_))),COUNT(__d1(__NN(Title_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_status_desc',COUNT(__d1(__NL(Title_Status_Description_))),COUNT(__d1(__NN(Title_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_odometer_mileage',COUNT(__d1(__NL(Title_Odometer_Mileage_))),COUNT(__d1(__NN(Title_Odometer_Mileage_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_odometer_status_code',COUNT(__d1(__NL(Title_Odometer_Status_Code_))),COUNT(__d1(__NN(Title_Odometer_Status_Code_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_odometer_status_desc',COUNT(__d1(__NL(Title_Odometer_Status_Description_))),COUNT(__d1(__NN(Title_Odometer_Status_Description_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','ttl_odometer_date',COUNT(__d1(__NL(Title_Odometer_Date_))),COUNT(__d1(__NN(Title_Odometer_Date_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','sequence_key',COUNT(__d1(__NL(Sequence_Key_))),COUNT(__d1(__NN(Sequence_Key_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','history',COUNT(__d1(__NL(History_))),COUNT(__d1(__NN(History_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','source_code',COUNT(__d1(__NL(Source_))),COUNT(__d1(__NN(Source_)))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','Archive_Date',COUNT(__d1(Archive___Date_=0)),COUNT(__d1(Archive___Date_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','DateFirstSeen',COUNT(__d1(Date_First_Seen_=0)),COUNT(__d1(Date_First_Seen_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','DateLastSeen',COUNT(__d1(Date_Last_Seen_=0)),COUNT(__d1(Date_Last_Seen_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','HybridArchiveDate',COUNT(__d1(Hybrid_Archive_Date_=0)),COUNT(__d1(Hybrid_Archive_Date_!=0))},
    {'SeleVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_linkids_Vault','VaultDateLastSeen',COUNT(__d1(Vault_Date_Last_Seen_=0)),COUNT(__d1(Vault_Date_Last_Seen_!=0))}]
