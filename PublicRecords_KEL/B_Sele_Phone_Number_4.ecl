...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5919003 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST258327_Layout := RECORD
  ...
  END;
  EXPORT __ST258289_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258327_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258289_Layout __ND5919008__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST265039_Layout __PP5919004) := TRANSFORM
    __EE5919057 := __PP5919004.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5919057),__ST258327_Layout),__NL(__EE5919057));
    SELF := __PP5919004;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5919003,__ND5919008__Project(LEFT));
END;
