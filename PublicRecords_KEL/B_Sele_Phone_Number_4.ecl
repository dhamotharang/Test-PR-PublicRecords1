...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5609677 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST243845_Layout := RECORD
  ...
  END;
  EXPORT __ST243807_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST243845_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243807_Layout __ND5609682__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST250334_Layout __PP5609678) := TRANSFORM
    __EE5609731 := __PP5609678.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5609731),__ST243845_Layout),__NL(__EE5609731));
    SELF := __PP5609678;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5609677,__ND5609682__Project(LEFT));
END;
