...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3700869 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST183187_Layout := RECORD
  ...
  END;
  EXPORT __ST183149_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST183187_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183149_Layout __ND3700874__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST188722_Layout __PP3700870) := TRANSFORM
    __EE3700923 := __PP3700870.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3700923),__ST183187_Layout),__NL(__EE3700923));
    SELF := __PP3700870;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE3700869,__ND3700874__Project(LEFT));
END;
