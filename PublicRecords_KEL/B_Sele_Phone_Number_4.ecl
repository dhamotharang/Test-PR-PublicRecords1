...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5771161 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST248458_Layout := RECORD
  ...
  END;
  EXPORT __ST248420_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST248458_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248420_Layout __ND5771166__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST255051_Layout __PP5771162) := TRANSFORM
    __EE5771215 := __PP5771162.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5771215),__ST248458_Layout),__NL(__EE5771215));
    SELF := __PP5771162;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5771161,__ND5771166__Project(LEFT));
END;
