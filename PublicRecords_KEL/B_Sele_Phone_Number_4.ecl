...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5772747 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST248428_Layout := RECORD
  ...
  END;
  EXPORT __ST248390_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST248428_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248390_Layout __ND5772752__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST255021_Layout __PP5772748) := TRANSFORM
    __EE5772801 := __PP5772748.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5772801),__ST248428_Layout),__NL(__EE5772801));
    SELF := __PP5772748;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5772747,__ND5772752__Project(LEFT));
END;
