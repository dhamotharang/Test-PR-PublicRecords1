...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5915130 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST258227_Layout := RECORD
  ...
  END;
  EXPORT __ST258189_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258227_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258189_Layout __ND5915135__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST264926_Layout __PP5915131) := TRANSFORM
    __EE5915184 := __PP5915131.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5915184),__ST258227_Layout),__NL(__EE5915184));
    SELF := __PP5915131;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5915130,__ND5915135__Project(LEFT));
END;
