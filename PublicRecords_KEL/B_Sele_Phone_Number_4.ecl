...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5130065 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST236332_Layout := RECORD
  ...
  END;
  EXPORT __ST236294_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236332_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236294_Layout __ND5130070__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST242551_Layout __PP5130066) := TRANSFORM
    __EE5130119 := __PP5130066.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5130119),__ST236332_Layout),__NL(__EE5130119));
    SELF := __PP5130066;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5130065,__ND5130070__Project(LEFT));
END;
