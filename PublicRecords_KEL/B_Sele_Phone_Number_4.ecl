...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5127786 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST235657_Layout := RECORD
  ...
  END;
  EXPORT __ST235619_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST235657_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST235619_Layout __ND5127791__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST241876_Layout __PP5127787) := TRANSFORM
    __EE5127840 := __PP5127787.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5127840),__ST235657_Layout),__NL(__EE5127840));
    SELF := __PP5127787;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5127786,__ND5127791__Project(LEFT));
END;
