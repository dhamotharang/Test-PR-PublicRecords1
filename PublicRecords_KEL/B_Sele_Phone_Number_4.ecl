...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5429096 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST245176_Layout := RECORD
  ...
  END;
  EXPORT __ST245138_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245176_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245138_Layout __ND5429101__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST251653_Layout __PP5429097) := TRANSFORM
    __EE5429150 := __PP5429097.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5429150),__ST245176_Layout),__NL(__EE5429150));
    SELF := __PP5429097;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5429096,__ND5429101__Project(LEFT));
END;
