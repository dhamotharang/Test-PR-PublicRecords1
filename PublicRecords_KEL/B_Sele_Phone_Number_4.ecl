...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3708183 := __ENH_Sele_Phone_Number_5;
  ...
  EXPORT __ST191658_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST191696_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191658_Layout __ND3708188__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST197040_Layout __PP3708184) := TRANSFORM
    __EE3708237 := __PP3708184.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3708237),__ST191696_Layout),__NL(__EE3708237));
    SELF := __PP3708184;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE3708183,__ND3708188__Project(LEFT));
END;
