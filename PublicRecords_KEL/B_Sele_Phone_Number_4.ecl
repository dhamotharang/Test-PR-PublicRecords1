...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5129207 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST236312_Layout := RECORD
  ...
  END;
  EXPORT __ST236274_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236312_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236274_Layout __ND5129212__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST242531_Layout __PP5129208) := TRANSFORM
    __EE5129261 := __PP5129208.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5129261),__ST236312_Layout),__NL(__EE5129261));
    SELF := __PP5129208;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5129207,__ND5129212__Project(LEFT));
END;
