...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5130070 := __ENH_Sele_Phone_Number_5;
  ...
  END;
  EXPORT __ST236299_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236337_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236299_Layout __ND5130075__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST242556_Layout __PP5130071) := TRANSFORM
    __EE5130124 := __PP5130071.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5130124),__ST236337_Layout),__NL(__EE5130124));
    SELF := __PP5130071;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5130070,__ND5130075__Project(LEFT));
END;
