...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3720830 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST194377_Layout := RECORD
  ...
  END;
  EXPORT __ST194339_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST194377_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST194339_Layout __ND3720835__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST199717_Layout __PP3720831) := TRANSFORM
    __EE3720884 := __PP3720831.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3720884),__ST194377_Layout),__NL(__EE3720884));
    SELF := __PP3720831;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE3720830,__ND3720835__Project(LEFT));
END;
