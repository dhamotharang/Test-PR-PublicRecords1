...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5830321 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST251241_Layout := RECORD
  ...
  EXPORT __ST251203_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251241_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251203_Layout __ND5830326__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST257834_Layout __PP5830322) := TRANSFORM
    __EE5830375 := __PP5830322.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5830375),__ST251241_Layout),__NL(__EE5830375));
    SELF := __PP5830322;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5830321,__ND5830326__Project(LEFT));
END;
