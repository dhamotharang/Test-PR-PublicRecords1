...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6949070 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST273432_Layout := RECORD
  ...
  END;
  EXPORT __ST273394_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST273432_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273394_Layout __ND6949075__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST280449_Layout __PP6949071) := TRANSFORM
    __EE6949124 := __PP6949071.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6949124),__ST273432_Layout),__NL(__EE6949124));
    SELF := __PP6949071;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE6949070,__ND6949075__Project(LEFT));
END;
