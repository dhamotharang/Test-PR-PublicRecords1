...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5946937 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST258248_Layout := RECORD
  ...
  END;
  EXPORT __ST258210_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258248_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258210_Layout __ND5946942__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST264947_Layout __PP5946938) := TRANSFORM
    __EE5946991 := __PP5946938.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5946991),__ST258248_Layout),__NL(__EE5946991));
    SELF := __PP5946938;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5946937,__ND5946942__Project(LEFT));
END;
