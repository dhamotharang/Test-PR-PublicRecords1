...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6546172 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST266858_Layout := RECORD
  ...
  END;
  EXPORT __ST266820_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST266858_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266820_Layout __ND6546177__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST273772_Layout __PP6546173) := TRANSFORM
    __EE6546226 := __PP6546173.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6546226),__ST266858_Layout),__NL(__EE6546226));
    SELF := __PP6546173;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE6546172,__ND6546177__Project(LEFT));
END;
