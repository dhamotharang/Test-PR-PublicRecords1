...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5850688 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST251543_Layout := RECORD
  ...
  END;
  EXPORT __ST251505_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251543_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251505_Layout __ND5850693__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST258136_Layout __PP5850689) := TRANSFORM
    __EE5850742 := __PP5850689.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5850742),__ST251543_Layout),__NL(__EE5850742));
    SELF := __PP5850689;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5850688,__ND5850693__Project(LEFT));
END;
