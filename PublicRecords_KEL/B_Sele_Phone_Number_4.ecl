...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5429066 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST245146_Layout := RECORD
  ...
  END;
  EXPORT __ST245108_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST245146_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245108_Layout __ND5429071__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST251623_Layout __PP5429067) := TRANSFORM
    __EE5429120 := __PP5429067.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5429120),__ST245146_Layout),__NL(__EE5429120));
    SELF := __PP5429067;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5429066,__ND5429071__Project(LEFT));
END;
