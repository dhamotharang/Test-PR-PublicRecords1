...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE713478 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST156147_Layout := RECORD
  ...
  END;
  EXPORT __ST156109_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST156147_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156109_Layout __ND713759__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST161275_Layout __PP713276) := TRANSFORM
    __EE713398 := __PP713276.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE713398),__ST156147_Layout),__NL(__EE713398));
    SELF := __PP713276;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE713478,__ND713759__Project(LEFT));
END;
