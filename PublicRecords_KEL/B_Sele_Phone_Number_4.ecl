...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5244775 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST236863_Layout := RECORD
  ...
  END;
  EXPORT __ST236825_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST236863_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236825_Layout __ND5244780__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST243082_Layout __PP5244776) := TRANSFORM
    __EE5244829 := __PP5244776.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5244829),__ST236863_Layout),__NL(__EE5244829));
    SELF := __PP5244776;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5244775,__ND5244780__Project(LEFT));
END;
