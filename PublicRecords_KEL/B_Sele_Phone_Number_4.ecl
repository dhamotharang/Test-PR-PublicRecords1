...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5977384 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST254429_Layout := RECORD
  ...
  END;
  EXPORT __ST254391_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST254429_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254391_Layout __ND5977389__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST261022_Layout __PP5977385) := TRANSFORM
    __EE5977438 := __PP5977385.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5977438),__ST254429_Layout),__NL(__EE5977438));
    SELF := __PP5977385;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5977384,__ND5977389__Project(LEFT));
END;
