...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5421352 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST244770_Layout := RECORD
  ...
  END;
  EXPORT __ST244732_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST244770_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST244732_Layout __ND5421357__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST251235_Layout __PP5421353) := TRANSFORM
    __EE5421406 := __PP5421353.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5421406),__ST244770_Layout),__NL(__EE5421406));
    SELF := __PP5421353;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE5421352,__ND5421357__Project(LEFT));
END;
