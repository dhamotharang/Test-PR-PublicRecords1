...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8474022 := __ENH_Criminal_Offense_1;
  EXPORT __ST146277_Layout := RECORD
  ...
  END;
  EXPORT __ST146230_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST146277_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146230_Layout __ND8474027__Project(B_Criminal_Offense_1(__in,__cfg).__ST180927_Layout __PP8474023) := TRANSFORM
    __EE8474183 := __PP8474023.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8474183),__ST146277_Layout),__NL(__EE8474183));
    SELF := __PP8474023;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8474022,__ND8474027__Project(LEFT));
END;
