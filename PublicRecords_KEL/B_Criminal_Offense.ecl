...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9527410 := __ENH_Criminal_Offense_1;
  EXPORT __ST154228_Layout := RECORD
  ...
  END;
  EXPORT __ST154181_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST154228_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST154181_Layout __ND9527415__Project(B_Criminal_Offense_1(__in,__cfg).__ST191643_Layout __PP9527411) := TRANSFORM
    __EE9527571 := __PP9527411.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE9527571),__ST154228_Layout),__NL(__EE9527571));
    SELF := __PP9527411;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE9527410,__ND9527415__Project(LEFT));
END;
