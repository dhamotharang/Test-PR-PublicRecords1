...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE280117 := __ENH_Criminal_Offense_1;
  EXPORT __ST24654_Layout := RECORD
  ...
  END;
  EXPORT __ST24607_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST24654_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST24607_Layout __ND280779__Project(B_Criminal_Offense_1(__in,__cfg).__ST31578_Layout __PP279660) := TRANSFORM
    __EE279895 := __PP279660.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE279895),__ST24654_Layout),__NL(__EE279895));
    SELF := __PP279660;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE280117,__ND280779__Project(LEFT));
END;
