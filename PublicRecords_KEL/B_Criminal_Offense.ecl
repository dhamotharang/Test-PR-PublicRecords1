...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8977282 := __ENH_Criminal_Offense_1;
  EXPORT __ST151584_Layout := RECORD
  ...
  EXPORT __ST151537_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST151584_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151537_Layout __ND8977287__Project(B_Criminal_Offense_1(__in,__cfg).__ST187957_Layout __PP8977283) := TRANSFORM
    __EE8977443 := __PP8977283.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8977443),__ST151584_Layout),__NL(__EE8977443));
    SELF := __PP8977283;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8977282,__ND8977287__Project(LEFT));
END;
