...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10128783 := __ENH_Criminal_Offense_1;
  EXPORT __ST159818_Layout := RECORD
  ...
  END;
  EXPORT __ST159771_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159818_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159771_Layout __ND10128788__Project(B_Criminal_Offense_1(__in,__cfg).__ST197593_Layout __PP10128784) := TRANSFORM
    __EE10128944 := __PP10128784.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE10128944),__ST159818_Layout),__NL(__EE10128944));
    SELF := __PP10128784;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE10128783,__ND10128788__Project(LEFT));
END;
