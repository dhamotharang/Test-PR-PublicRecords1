...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8977252 := __ENH_Criminal_Offense_1;
  EXPORT __ST151554_Layout := RECORD
  ...
  END;
  EXPORT __ST151507_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST151554_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151507_Layout __ND8977257__Project(B_Criminal_Offense_1(__in,__cfg).__ST187927_Layout __PP8977253) := TRANSFORM
    __EE8977413 := __PP8977253.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8977413),__ST151554_Layout),__NL(__EE8977413));
    SELF := __PP8977253;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8977252,__ND8977257__Project(LEFT));
END;
