...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10077041 := __ENH_Criminal_Offense_1;
  EXPORT __ST155690_Layout := RECORD
  ...
  END;
  EXPORT __ST155643_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155690_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155643_Layout __ND10077046__Project(B_Criminal_Offense_1(__in,__cfg).__ST194662_Layout __PP10077042) := TRANSFORM
    __EE10077202 := __PP10077042.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE10077202),__ST155690_Layout),__NL(__EE10077202));
    SELF := __PP10077042;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE10077041,__ND10077046__Project(LEFT));
END;
