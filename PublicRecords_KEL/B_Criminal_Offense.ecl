...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE228745 := __ENH_Criminal_Offense_1;
  EXPORT __ST21555_Layout := RECORD
  ...
  END;
  EXPORT __ST21508_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST21555_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21508_Layout __ND229407__Project(B_Criminal_Offense_1(__in,__cfg).__ST27862_Layout __PP228288) := TRANSFORM
    __EE228523 := __PP228288.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE228523),__ST21555_Layout),__NL(__EE228523));
    SELF := __PP228288;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE228745,__ND229407__Project(LEFT));
END;
