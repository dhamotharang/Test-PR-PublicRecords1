...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE579156 := __ENH_Criminal_Offense_1;
  EXPORT __ST41684_Layout := RECORD
  ...
  END;
  EXPORT __ST41637_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST41684_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST41637_Layout __ND579818__Project(B_Criminal_Offense_1(__in,__cfg).__ST52731_Layout __PP578699) := TRANSFORM
    __EE578934 := __PP578699.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE578934),__ST41684_Layout),__NL(__EE578934));
    SELF := __PP578699;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE579156,__ND579818__Project(LEFT));
END;
