...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8587258 := __ENH_Criminal_Offense_1;
  EXPORT __ST146371_Layout := RECORD
  ...
  END;
  EXPORT __ST146324_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST146371_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146324_Layout __ND8587263__Project(B_Criminal_Offense_1(__in,__cfg).__ST181304_Layout __PP8587259) := TRANSFORM
    __EE8587419 := __PP8587259.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8587419),__ST146371_Layout),__NL(__EE8587419));
    SELF := __PP8587259;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8587258,__ND8587263__Project(LEFT));
END;
