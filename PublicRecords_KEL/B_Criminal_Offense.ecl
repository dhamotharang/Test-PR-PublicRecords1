...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10239642 := __ENH_Criminal_Offense_1;
  ...
  END;
  EXPORT __ST160686_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST160733_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160686_Layout __ND10239647__Project(B_Criminal_Offense_1(__in,__cfg).__ST198872_Layout __PP10239643) := TRANSFORM
    __EE10239803 := __PP10239643.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE10239803),__ST160733_Layout),__NL(__EE10239803));
    SELF := __PP10239643;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE10239642,__ND10239647__Project(LEFT));
END;
