...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6047030 := __ENH_Criminal_Offense_1;
  EXPORT __ST115113_Layout := RECORD
  ...
  END;
  EXPORT __ST115066_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST115113_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST115066_Layout __ND6047035__Project(B_Criminal_Offense_1(__in,__cfg).__ST140444_Layout __PP6047031) := TRANSFORM
    __EE6047191 := __PP6047031.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE6047191),__ST115113_Layout),__NL(__EE6047191));
    SELF := __PP6047031;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE6047030,__ND6047035__Project(LEFT));
END;
