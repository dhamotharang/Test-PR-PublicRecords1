...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8472450 := __ENH_Criminal_Offense_1;
  EXPORT __ST146284_Layout := RECORD
  ...
  END;
  EXPORT __ST146237_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST146284_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146237_Layout __ND8472455__Project(B_Criminal_Offense_1(__in,__cfg).__ST180936_Layout __PP8472451) := TRANSFORM
    __EE8472611 := __PP8472451.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8472611),__ST146284_Layout),__NL(__EE8472611));
    SELF := __PP8472451;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8472450,__ND8472455__Project(LEFT));
END;
