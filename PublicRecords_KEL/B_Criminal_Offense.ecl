...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8474027 := __ENH_Criminal_Offense_1;
  EXPORT __ST146282_Layout := RECORD
  ...
  END;
  EXPORT __ST146235_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST146282_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST146235_Layout __ND8474032__Project(B_Criminal_Offense_1(__in,__cfg).__ST180932_Layout __PP8474028) := TRANSFORM
    __EE8474188 := __PP8474028.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8474188),__ST146282_Layout),__NL(__EE8474188));
    SELF := __PP8474028;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE8474027,__ND8474032__Project(LEFT));
END;
