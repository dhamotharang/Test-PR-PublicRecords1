...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1138558 := __ENH_Criminal_Offense_1;
  EXPORT __ST57373_Layout := RECORD
  ...
  END;
  EXPORT __ST57326_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST57373_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST57326_Layout __ND1139203__Project(B_Criminal_Offense_1(__in,__cfg).__ST71914_Layout __PP1138101) := TRANSFORM
    __EE1138336 := __PP1138101.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1138336),__ST57373_Layout),__NL(__EE1138336));
    SELF := __PP1138101;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE1138558,__ND1139203__Project(LEFT));
END;
