...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10013512 := __ENH_Criminal_Offense_1;
  EXPORT __ST158979_Layout := RECORD
  ...
  END;
  EXPORT __ST158932_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST158979_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158932_Layout __ND10013517__Project(B_Criminal_Offense_1(__in,__cfg).__ST196531_Layout __PP10013513) := TRANSFORM
    __EE10013673 := __PP10013513.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE10013673),__ST158979_Layout),__NL(__EE10013673));
    SELF := __PP10013513;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE10013512,__ND10013517__Project(LEFT));
END;
