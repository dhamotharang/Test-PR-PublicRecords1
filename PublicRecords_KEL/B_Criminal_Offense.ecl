...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE223132 := __ENH_Criminal_Offense_1;
  EXPORT __ST21125_Layout := RECORD
  ...
  END;
  EXPORT __ST21078_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST21125_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21078_Layout __ND223794__Project(B_Criminal_Offense_1(__in,__cfg).__ST27398_Layout __PP222675) := TRANSFORM
    __EE222910 := __PP222675.Offense_Charges_;
