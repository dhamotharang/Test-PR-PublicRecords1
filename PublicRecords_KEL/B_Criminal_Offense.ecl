...
EXPORT B_Criminal_Offense(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1141911 := __ENH_Criminal_Offense_1;
  EXPORT __ST56495_Layout := RECORD
  ...
  END;
  EXPORT __ST56448_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST56495_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST56448_Layout __ND1142556__Project(B_Criminal_Offense_1(__in,__cfg).__ST70730_Layout __PP1141454) := TRANSFORM
    __EE1141689 := __PP1141454.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1141689),__ST56495_Layout),__NL(__EE1141689));
    SELF := __PP1141454;
  END;
  EXPORT __ENH_Criminal_Offense := PROJECT(__EE1141911,__ND1142556__Project(LEFT));
END;
