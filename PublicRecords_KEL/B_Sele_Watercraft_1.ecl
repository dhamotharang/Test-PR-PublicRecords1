...
EXPORT B_Sele_Watercraft_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE939489 := __E_Sele_Watercraft;
  ...
  END;
  SHARED __ST74902_Layout __ND939550__Project(E_Sele_Watercraft(__in,__cfg).Layout __PP939403) := TRANSFORM
    ...
    SELF := __PP939403;
  END;
  EXPORT __ENH_Sele_Watercraft_1 := PROJECT(__EE939489,__ND939550__Project(LEFT));
END;
