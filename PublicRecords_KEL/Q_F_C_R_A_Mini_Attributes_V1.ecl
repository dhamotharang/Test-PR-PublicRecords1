...
EXPORT Q_F_C_R_A_Mini_Attributes_V1(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA100 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE6452573 := __ENH_Person;
  SHARED __EE6452730 := __EE6452573(__T(__OP2(__EE6452573.UID,IN,__CN(__PLexID_in))));
  SHARED __ST91127_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE6452730,TRANSFORM(__ST91127_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
