...
EXPORT E_Person(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping5 := 'did(OVERRIDE:UID),title(OVERRIDE:Title_),fname(OVERRIDE:First_Name_),mname(OVERRIDE:Middle_Name_),lname(OVERRIDE:Last_Name_),name_suffix(OVERRIDE:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),lexidsegment2(DEFAULT:Lex_I_D_Segment2_:\'\'),dob(OVERRIDE:Date_Of_Birth_:DATE),dobpadded(OVERRIDE:Date_Of_Birth_Padded_:\'\'),validdob(DEFAULT:Valid_D_O_B_:\'\'),dod(OVERRIDE:Date_Of_Death_:DATE),fdnindicator(DEFAULT:F_D_N_Indicator_),deathmasterflag(DEFAULT:Death_Master_Flag_),src(OVERRIDE:Source_:\'\'),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),thrivedatefirstseen(DEFAULT:Thrive_Date_First_Seen_:DATE),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),namescore(DEFAULT:Name_Score_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  SHARED InLayout __Mapping5_Transform(InLayout __r) := TRANSFORM
    SELF.Header_Hit_Flag_ := __CN(FALSE);
    SELF.Best_ := __CN(TRUE);
    SELF := __r;
  END;
  SHARED __d5_Norm := NORMALIZE(__in,LEFT.Dataset_Best_Person__Key_Watchdog_FCRA_nonEN,TRANSFORM(RECORDOF(__in.Dataset_Best_Person__Key_Watchdog_FCRA_nonEN),SELF:=RIGHT));
  EXPORT __d5_KELfiltered := __d5_Norm((UNSIGNED)did != 0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Best_Person__Key_Watchdog_FCRA_nonEN_Invalid := __d5_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED InLayout __Mapping6_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __d6_Norm := NORMALIZE(__in,LEFT.Dataset_Best_Person__Key_Watchdog_FCRA_nonEQ,TRANSFORM(RECORDOF(__in.Dataset_Best_Person__Key_Watchdog_FCRA_nonEQ),SELF:=RIGHT));
  EXPORT __d6_KELfiltered := __d6_Norm((UNSIGNED)did != 0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Best_Person__Key_Watchdog_FCRA_nonEQ_Invalid := __d6_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED __Mapping7 := 'appended_lexid(OVERRIDE:UID),title(DEFAULT:Title_),first_name(OVERRIDE:First_Name_),middle_name(OVERRIDE:Middle_Name_),last_name(OVERRIDE:Last_Name_),namesuffix(DEFAULT:Name_Suffix_),lexidsegment(DEFAULT:Lex_I_D_Segment_:\'\'),lexidsegment2(DEFAULT:Lex_I_D_Segment2_:\'\'),dob(OVERRIDE:Date_Of_Birth_:DATE),dobpadded(OVERRIDE:Date_Of_Birth_Padded_:\'\'),validdob(DEFAULT:Valid_D_O_B_:\'\'),dateofdeath(DEFAULT:Date_Of_Death_:DATE),headerhitflag(DEFAULT:Header_Hit_Flag_),best(DEFAULT:Best_),deathmasterflag(DEFAULT:Death_Master_Flag_),src(OVERRIDE:Source_:\'\'),ishuntfish(DEFAULT:Is_Hunt_Fish_),isccw(DEFAULT:Is_C_C_W_),permitnumber(DEFAULT:Permit_Number_:\'\'),weaponpermitstype(DEFAULT:Weapon_Permits_Type_:\'\'),weaponregistrationdate(DEFAULT:Weapon_Registration_Date_:DATE),weaponexpirationdate(DEFAULT:Weapon_Expiration_Date_:DATE),licensedate(DEFAULT:License_Date_:DATE),homestate(DEFAULT:Home_State_:\'\'),sourcestate(DEFAULT:Source_State_:\'\'),isresident(DEFAULT:Is_Resident_),ishunting(DEFAULT:Is_Hunting_),isfishing(DEFAULT:Is_Fishing_),statementid(DEFAULT:Statement_I_D_:0),statementtype(DEFAULT:Statement_Type_:\'\'),datagroup(DEFAULT:Data_Group_:\'\'),content(DEFAULT:Content_:\'\'),correctedflag(DEFAULT:Corrected_Flag_),consumerstatementflag(DEFAULT:Consumer_Statement_Flag_),disputeflag(DEFAULT:Dispute_Flag_),securityfreeze(DEFAULT:Security_Freeze_),securityalert(DEFAULT:Security_Alert_),negativealert(DEFAULT:Negative_Alert_),idtheftflag(DEFAULT:I_D_Theft_Flag_),legalholdalert(DEFAULT:Legal_Hold_Alert_),thrivedatefirstseen(DEFAULT:Thrive_Date_First_Seen_:DATE),employer(DEFAULT:Employer_:\'\'),payfrequency(DEFAULT:Pay_Frequency_:\'\'),income(DEFAULT:Income_:0),namescore(DEFAULT:Name_Score_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  SHARED InLayout __Mapping7_Transform(InLayout __r) := TRANSFORM
    SELF.F_D_N_Indicator_ := __CN(TRUE);
    SELF := __r;
  END;
  SHARED __d7_Norm := NORMALIZE(__in,LEFT.Dataset_fraudpoint3__Key_DID,TRANSFORM(RECORDOF(__in.Dataset_fraudpoint3__Key_DID),SELF:=RIGHT));
  EXPORT __d7_KELfiltered := __d7_Norm((unsigned)appended_lexid !=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_fraudpoint3__Key_DID_Invalid := __d7_KELfiltered((KEL.typ.uid)appended_lexid = 0);
  SHARED __d7_Prefiltered := __d7_KELfiltered((KEL.typ.uid)appended_lexid <> 0);
  ...
  SHARED InLayout __Mapping8_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __d8_Norm := NORMALIZE(__in,LEFT.Dataset_eMerges__Key_HuntFish_Rid,TRANSFORM(RECORDOF(__in.Dataset_eMerges__Key_HuntFish_Rid),SELF:=RIGHT));
  EXPORT __d8_KELfiltered := __d8_Norm((unsigned)did!=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__Key_HuntFish_Rid_Invalid := __d8_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED InLayout __Mapping9_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __d9_Norm := NORMALIZE(__in,LEFT.Dataset_eMerges__key_ccw_rid,TRANSFORM(RECORDOF(__in.Dataset_eMerges__key_ccw_rid),SELF:=RIGHT));
  EXPORT __d9_KELfiltered := __d9_Norm((unsigned)did!=0);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__key_ccw_rid_Invalid := __d9_KELfiltered((KEL.typ.uid)did = 0);
  ...
  SHARED __d10_Norm := NORMALIZE(__in,LEFT.Dataset_Thrive__Key___Did_QA,TRANSFORM(RECORDOF(__in.Dataset_Thrive__Key___Did_QA),SELF:=RIGHT));
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Thrive__Key___Did_QA_Invalid := __d10_Norm((KEL.typ.uid)did = 0);
  SHARED __d10_Prefiltered := __d10_Norm((KEL.typ.uid)did <> 0);
  ...
  SHARED __d11_Norm := NORMALIZE(__in,LEFT.Dataset_SexOffender__Key_SexOffender_SPK,TRANSFORM(RECORDOF(__in.Dataset_SexOffender__Key_SexOffender_SPK),SELF:=RIGHT));
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_SexOffender__Key_SexOffender_SPK_Invalid := __d11_Norm((KEL.typ.uid)did = 0);
  ...
  SHARED __d12_Norm := NORMALIZE(__in,LEFT.Dataset_Header__key_ADL_segmentation,TRANSFORM(RECORDOF(__in.Dataset_Header__key_ADL_segmentation),SELF:=RIGHT));
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Header__key_ADL_segmentation_Invalid := __d12_Norm((KEL.typ.uid)did = 0);
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Best_Person__Key_Watchdog_Invalid),COUNT(__d4)},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.title',COUNT(__d4(__NL(Title_))),COUNT(__d4(__NN(Title_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.fname',COUNT(__d4(__NL(First_Name_))),COUNT(__d4(__NN(First_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.mname',COUNT(__d4(__NL(Middle_Name_))),COUNT(__d4(__NN(Middle_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.lname',COUNT(__d4(__NL(Last_Name_))),COUNT(__d4(__NN(Last_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.name_suffix',COUNT(__d4(__NL(Name_Suffix_))),COUNT(__d4(__NN(Name_Suffix_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.dob',COUNT(__d4(__NL(Date_Of_Birth_))),COUNT(__d4(__NN(Date_Of_Birth_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rec.dod',COUNT(__d4(__NL(Date_Of_Death_))),COUNT(__d4(__NN(Date_Of_Death_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Best_Person__Key_Watchdog_FCRA_nonEN_Invalid),COUNT(__d5)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dob',COUNT(__d5(__NL(Date_Of_Birth_))),COUNT(__d5(__NN(Date_Of_Birth_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dod',COUNT(__d5(__NL(Date_Of_Death_))),COUNT(__d5(__NN(Date_Of_Death_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Best_Person__Key_Watchdog_FCRA_nonEQ_Invalid),COUNT(__d6)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_fraudpoint3__Key_DID_Invalid),COUNT(__d7)},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Title',COUNT(__d7(__NL(Title_))),COUNT(__d7(__NN(Title_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','first_name',COUNT(__d7(__NL(First_Name_))),COUNT(__d7(__NN(First_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','middle_name',COUNT(__d7(__NL(Middle_Name_))),COUNT(__d7(__NN(Middle_Name_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','last_name',COUNT(__d7(__NL(Last_Name_))),COUNT(__d7(__NN(Last_Name_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__Key_HuntFish_Rid_Invalid),COUNT(__d8)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirth',COUNT(__d8(__NL(Date_Of_Birth_))),COUNT(__d8(__NN(Date_Of_Birth_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','source_state',COUNT(__d8(__NL(Source_State_))),COUNT(__d8(__NN(Source_State_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_eMerges__key_ccw_rid_Invalid),COUNT(__d9)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwpermnum',COUNT(__d9(__NL(Permit_Number_))),COUNT(__d9(__NN(Permit_Number_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwpermtype',COUNT(__d9(__NL(Weapon_Permits_Type_))),COUNT(__d9(__NN(Weapon_Permits_Type_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwregdate',COUNT(__d9(__NL(Weapon_Registration_Date_))),COUNT(__d9(__NN(Weapon_Registration_Date_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ccwexpdate',COUNT(__d9(__NL(Weapon_Expiration_Date_))),COUNT(__d9(__NN(Weapon_Expiration_Date_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Thrive__Key___Did_QA_Invalid),COUNT(__d10)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_first_seen',COUNT(__d10(__NL(Thrive_Date_First_Seen_))),COUNT(__d10(__NN(Thrive_Date_First_Seen_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','employer',COUNT(__d10(__NL(Employer_))),COUNT(__d10(__NN(Employer_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','pay_frequency',COUNT(__d10(__NL(Pay_Frequency_))),COUNT(__d10(__NN(Pay_Frequency_)))},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_SexOffender__Key_SexOffender_SPK_Invalid),COUNT(__d11)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Header__key_ADL_segmentation_Invalid),COUNT(__d12)},
    ...
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ind1',COUNT(__d12(__NL(Lex_I_D_Segment_))),COUNT(__d12(__NN(Lex_I_D_Segment_)))},
    {'Person','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ind2',COUNT(__d12(__NL(Lex_I_D_Segment2_))),COUNT(__d12(__NN(Lex_I_D_Segment2_)))},
