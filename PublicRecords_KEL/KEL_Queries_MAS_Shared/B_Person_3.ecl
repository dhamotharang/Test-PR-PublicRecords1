...
EXPORT B_Person_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE215757 := __ENH_Person_4;
  EXPORT __ST160398_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.nint Curr_Addr_Full_Rank_;
  ...
  END;
  SHARED __ST160398_Layout __ND215583__Project(B_Person_4(__in,__cfg).__ST160051_Layout __PP214876) := TRANSFORM
    __EE215578 := __PP214876.Curr_Addr_Full_Set_;
    SELF.Curr_Addr_Full_Rank_ := (__T(__EE215578))[1].Address_Rank_;
    __EE215595 := __PP214876.Curr_Addr_Full_Set_;
    SELF.Prep_Current_Addr_Full_ := (__T(__EE215595))[1].Addr_Full_;
    SELF := __PP214876;
  END;
  EXPORT __ENH_Person_3 := PROJECT(__EE215757,__ND215583__Project(LEFT));
END;
