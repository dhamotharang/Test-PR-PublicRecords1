...
EXPORT B_Person_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE186899 := __ENH_Person_4;
  EXPORT __ST151369_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST151369_Layout __ND186745__Project(B_Person_4(__in,__cfg).__ST151029_Layout __PP186091) := TRANSFORM
    __EE186740 := __PP186091.Curr_Addr_Full_Set_;
    SELF.Prep_Current_Addr_Full_ := (__T(__EE186740))[1].Addr_Full_;
    SELF := __PP186091;
  END;
  EXPORT __ENH_Person_3 := PROJECT(__EE186899,__ND186745__Project(LEFT));
END;
