...
EXPORT Q_Input_Attributes_V1_Hybrid(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, KEL.typ.kdate __PRunDateToMimic, DATA57 __PDPM, KEL.typ.bool __PisFCRA, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE15078882 := __ENH_Input_P_I_I;
  SHARED __EE15078885 := __ENH_Person;
  SHARED __ST5471249_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC15082258(B_Input_P_I_I(__in,__cfg_Local).__ST167233_Layout __EE15078882, B_Person(__in,__cfg_Local).__ST182156_Layout __EE15078885) := __EEQP(__EE15078882.Subject_,__EE15078885.UID);
  __ST5471249_Layout __JT15082258(B_Input_P_I_I(__in,__cfg_Local).__ST167233_Layout __l, B_Person(__in,__cfg_Local).__ST182156_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE15082259 := JOIN(__EE15078885,__EE15078882,__JC15082258(RIGHT,LEFT),__JT15082258(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST132812_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST132812_Layout __ND15087771__Project(__ST5471249_Layout __PP15078895) := TRANSFORM
    SELF.G___Proc_U_I_D_ := __PP15078895.UID;
    SELF.P___Inp_Acct_ := __PP15078895.Input_Account_Value_;
    SELF.P___Inp_Lex_I_D_ := __PP15078895.Input_Lex_I_D_Value_;
    SELF.P___Inp_Name_First_ := __PP15078895.Input_First_Name_Value_;
    SELF.P___Inp_Name_Mid_ := __PP15078895.Input_Middle_Name_Value_;
    SELF.P___Inp_Name_Last_ := __PP15078895.Input_Last_Name_Value_;
    SELF.P___Inp_Addr_Line1_ := __PP15078895.Input_Street_Value_;
    SELF.P___Inp_Addr_Line2_ := __PP15078895.P___Inp_Addr_Line2_Value_;
    SELF.P___Inp_Addr_City_ := __PP15078895.Input_City_Value_;
    SELF.P___Inp_Addr_State_ := __PP15078895.Input_State_Value_;
    SELF.P___Inp_Addr_Zip_ := __PP15078895.Input_Zip_Value_;
    SELF.P___Inp_S_S_N_ := __PP15078895.Input_S_S_N_Value_;
    SELF.P___Inp_D_O_B_ := __PP15078895.Input_D_O_B_Value_;
    SELF.P___Inp_D_L_ := __PP15078895.Input_D_L_Value_;
    SELF.P___Inp_D_L_State_ := __PP15078895.Input_D_L_State_Value_;
    SELF.P___Inp_Phone_Home_ := __PP15078895.Input_Home_Phone_Value_;
    SELF.P___Inp_Phone_Work_ := __PP15078895.Input_Work_Phone_Value_;
    SELF.P___Inp_Email_ := __PP15078895.Input_Email_Value_;
    SELF.P___Inp_I_P_Addr_ := __PP15078895.Input_I_P_Addr_Value_;
    SELF.P___Inp_Arch_Dt_ := __PP15078895.Input_Archive_Date_Value_;
    SELF.P___Inp_Acct_Flag_ := __PP15078895.P___Inp_Acct_Flag_Value_;
    SELF.P___Inp_Lex_I_D_Flag_ := __PP15078895.P___Inp_Lex_I_D_Flag_Value_;
    SELF.P___Inp_Name_First_Flag_ := __PP15078895.P___Inp_Name_First_Flag_Value_;
    SELF.P___Inp_Name_Mid_Flag_ := __PP15078895.P___Inp_Name_Mid_Flag_Value_;
    SELF.P___Inp_Name_Last_Flag_ := __PP15078895.P___Inp_Name_Last_Flag_Value_;
    SELF.P___Inp_Addr_St_Flag_ := __PP15078895.P___Inp_Addr_St_Flag_Value_;
    SELF.P___Inp_Addr_City_Flag_ := __PP15078895.P___Inp_Addr_City_Flag_Value_;
    SELF.P___Inp_Addr_State_Flag_ := __PP15078895.P___Inp_Addr_State_Flag_Value_;
    SELF.P___Inp_Addr_Zip_Flag_ := __PP15078895.P___Inp_Addr_Zip_Flag_Value_;
    SELF.P___Inp_S_S_N_Flag_ := __PP15078895.P___Inp_S_S_N_Flag_Value_;
    SELF.P___Inp_D_O_B_Flag_ := __PP15078895.P___Inp_D_O_B_Flag_Value_;
    SELF.P___Inp_D_L_Flag_ := __PP15078895.P___Inp_D_L_Flag_Value_;
    SELF.P___Inp_D_L_State_Flag_ := __PP15078895.P___Inp_D_L_State_Flag_Value_;
    SELF.P___Inp_Phone_Home_Flag_ := __PP15078895.P___Inp_Phone_Home_Flag_Value_;
    SELF.P___Inp_Phone_Work_Flag_ := __PP15078895.P___Inp_Phone_Work_Flag_Value_;
    SELF.P___Inp_Email_Flag_ := __PP15078895.P___Inp_Email_Flag_Value_;
    SELF.P___Inp_I_P_Addr_Flag_ := __PP15078895.P___Inp_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Arch_Dt_Flag_ := __PP15078895.P___Inp_Arch_Dt_Flag_Value_;
    SELF.P___Inp_Cln_Name_Prfx_ := __PP15078895.Input_Prefix_Clean_Value_;
    SELF.P___Inp_Cln_Name_First_ := __PP15078895.Input_First_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Mid_ := __PP15078895.Input_Middle_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Last_ := __PP15078895.Input_Last_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Sffx_ := __PP15078895.Input_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP15078895.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_ := __PP15078895.Input_Pre_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP15078895.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_ := __PP15078895.Input_Address_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_ := __PP15078895.Input_Post_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_ := __PP15078895.Input_Unit_Desig_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_ := __PP15078895.Input_Secondary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_ := __PP15078895.Input_City_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_ := __PP15078895.Input_City_Post_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_ := __PP15078895.Input_State_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP15078895.Input_Zip5_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_ := __PP15078895.Input_Zip4_Clean_Value_;
    SELF.P___Inp_Cln_Addr_St_ := __PP15078895.Input_Street_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Full_ := __PP15078895.Input_Full_Address_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lat_ := __PP15078895.Input_Latitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lng_ := __PP15078895.Input_Longitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_Code_ := __PP15078895.Input_State_Code_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_ := __PP15078895.Input_County_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Geo_ := __PP15078895.Input_Geoblock_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Type_ := __PP15078895.Input_Address_Type_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Status_ := __PP15078895.Input_Address_Status_Clean_Value_;
    SELF.P___Inp_Cln_S_S_N_ := __PP15078895.Input_S_S_N_Clean_Value_;
    SELF.P___Inp_Cln_D_O_B_ := __PP15078895.Input_D_O_B_Clean_Value_;
    SELF.P___Inp_Cln_D_L_ := __PP15078895.Input_D_L_Clean_Value_;
    SELF.P___Inp_Cln_D_L_State_ := __PP15078895.Input_D_L_State_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Home_ := __PP15078895.Input_Home_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Work_ := __PP15078895.Input_Work_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Email_ := __PP15078895.Input_Email_Clean_Value_;
    SELF.P___Inp_Cln_Arch_Dt_ := __PP15078895.Input_Archive_Date_Clean_Value_;
    SELF.P___Inp_Cln_Name_Prfx_Flag_ := __PP15078895.P___Inp_Cln_Name_Prfx_Flag_Value_;
    SELF.P___Inp_Cln_Name_First_Flag_ := __PP15078895.P___Inp_Cln_Name_First_Flag_Value_;
    SELF.P___Inp_Cln_Name_Mid_Flag_ := __PP15078895.P___Inp_Cln_Name_Mid_Flag_Value_;
    SELF.P___Inp_Cln_Name_Last_Flag_ := __PP15078895.P___Inp_Cln_Name_Last_Flag_Value_;
    SELF.P___Inp_Cln_Name_Sffx_Flag_ := __PP15078895.P___Inp_Cln_Name_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_Flag_ := __PP15078895.P___Inp_Cln_Addr_Prim_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_Flag_ := __PP15078895.P___Inp_Cln_Addr_Pre_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_Flag_ := __PP15078895.P___Inp_Cln_Addr_Prim_Name_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_Flag_ := __PP15078895.P___Inp_Cln_Addr_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_Flag_ := __PP15078895.P___Inp_Cln_Addr_Post_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_Flag_ := __PP15078895.P___Inp_Cln_Addr_Unit_Desig_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_Flag_ := __PP15078895.P___Inp_Cln_Addr_Sec_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Flag_ := __PP15078895.P___Inp_Cln_Addr_City_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_Flag_ := __PP15078895.P___Inp_Cln_Addr_City_Post_Flag_Value_;
    SELF.P___Inp_Cln_Addr_State_Flag_ := __PP15078895.P___Inp_Cln_Addr_State_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_Flag_ := __PP15078895.P___Inp_Cln_Addr_Zip5_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_Flag_ := __PP15078895.P___Inp_Cln_Addr_Zip4_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_Bad_Len_Flag_ := __PP15078895.P___Inp_Val_Addr_Zip_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_All_Zero_Flag_ := __PP15078895.P___Inp_Val_Addr_Zip_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Addr_State_Bad_Abbr_Flag_ := __PP15078895.P___Inp_Val_Addr_State_Bad_Abbr_Flag_Value_;
    SELF.P___Inp_Cln_Addr_St_Flag_ := __PP15078895.P___Inp_Cln_Addr_St_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Full_Flag_ := __PP15078895.P___Inp_Cln_Addr_Full_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lat_Flag_ := __PP15078895.P___Inp_Cln_Addr_Lat_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lng_Flag_ := __PP15078895.P___Inp_Cln_Addr_Lng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_Flag_ := __PP15078895.P___Inp_Cln_Addr_Cnty_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Geo_Flag_ := __PP15078895.P___Inp_Cln_Addr_Geo_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Type_Flag_ := __PP15078895.P___Inp_Cln_Addr_Type_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Status_Flag_ := __PP15078895.P___Inp_Cln_Addr_Status_Flag_Value_;
    SELF.P___Inp_Cln_S_S_N_Flag_ := __PP15078895.P___Inp_Cln_S_S_N_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Char_Flag_ := __PP15078895.P___Inp_Val_S_S_N_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Len_Flag_ := __PP15078895.P___Inp_Val_S_S_N_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bogus_Flag_ := __PP15078895.P___Inp_Val_S_S_N_Bogus_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Non_S_S_A_Flag_ := __PP15078895.P___Inp_Val_S_S_N_Non_S_S_A_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_ := __PP15078895.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_Value_;
    SELF.P___Inp_Cln_D_O_B_Flag_ := __PP15078895.P___Inp_Cln_D_O_B_Flag_Value_;
    SELF.P___Inp_Cln_D_L_Flag_ := __PP15078895.P___Inp_Cln_D_L_Flag_Value_;
    SELF.P___Inp_Cln_D_L_State_Flag_ := __PP15078895.P___Inp_Cln_D_L_State_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Home_Flag_ := __PP15078895.P___Inp_Cln_Phone_Home_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Work_Flag_ := __PP15078895.P___Inp_Cln_Phone_Work_Flag_Value_;
    SELF.P___Inp_Cln_Email_Flag_ := __PP15078895.P___Inp_Cln_Email_Flag_Value_;
    SELF.P___Inp_Cln_I_P_Addr_Flag_ := __PP15078895.P___Inp_Cln_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Val_Email_Bogus_Flag_ := __PP15078895.P___Inp_Val_Email_Bogus_Flag_Value_;
    SELF.P___Inp_Val_Email_User_All_Zero_Flag_ := __PP15078895.P___Inp_Val_Email_User_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_User_Bad_Char_Flag_ := __PP15078895.P___Inp_Val_Email_User_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_All_Zero_Flag_ := __PP15078895.P___Inp_Val_Email_Dom_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_Bad_Char_Flag_ := __PP15078895.P___Inp_Val_Email_Dom_Bad_Char_Flag_Value_;
    SELF.P___Inp_Cln_Arch_Dt_Flag_ := __PP15078895.P___Inp_Cln_Arch_Dt_Flag_Value_;
    SELF.P_I___Inp_Addr_State_D_L_Avail_Flag_ := __PP15078895.P_I___Inp_Addr_State_D_L_Avail_Flag___Non_F_C_R_A_;
    SELF.P_I___Inp_Addr_State_Voter_Avail_Flag_ := IF(__PisFCRA,__PP15078895.P_I___Inp_Addr_State_Voter_Avail_Flag___F_C_R_A_,__PP15078895.P_I___Inp_Addr_State_Voter_Avail_Flag___Non_F_C_R_A_);
    __CC13588 := -99999;
    SELF.P_I___Inp_Addr_Subj_Flag_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC13588,__PP15078895.P_I___Inp_Addr_Subj_Flag_);
    __CC13585 := '-99999';
    SELF.P_I___Inp_Addr_Subj_Old_Dt_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13585)),__ECAST(KEL.typ.nstr,__PP15078895.P_I___Inp_Addr_Subj_Old_Dt_));
    SELF.P_I___Inp_Addr_Subj_New_Dt_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13585)),__ECAST(KEL.typ.nstr,__PP15078895.P_I___Inp_Addr_Subj_New_Dt_));
    SELF.P_I___Inp_Addr_Subj_Old_Msnc_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15078895.P_I___Inp_Addr_Subj_Old_Msnc_));
    SELF.P_I___Inp_Addr_Subj_New_Msnc_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15078895.P_I___Inp_Addr_Subj_New_Msnc_));
    SELF.P_I___Inp_Addr_Subj_Res_Span_ := IF(__PisFCRA AND __PP15078895.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15078895.P_I___Inp_Addr_Subj_Res_Span_));
    SELF.Rep_Number_ := __PP15078895.I_Rep_Number_Value_;
    SELF.I_Paddr_ := __PP15078895._ipaddr_;
    SELF.I_Presponse_ := __PP15078895._ipresponse_;
    SELF.Net_Acuity_Royalty_ := __PP15078895._netacuityroyalty_;
    SELF := __PP15078895;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE15082259,__ND15087771__Project(LEFT)));
