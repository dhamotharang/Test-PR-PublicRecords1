...
IMPORT KEL15 AS KEL;
IMPORT B_Address_Property_5,CFG_Compile,E_Address,E_Address_Property,E_Geo_Link,E_Property,E_Property_Event,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT B_Address_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6701991 := __ENH_Address_Property_5;
  EXPORT __ENH_Address_Property_4 := __EE6701991;
END;
