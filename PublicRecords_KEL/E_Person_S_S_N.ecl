...
EXPORT E_Person_S_S_N(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping0 := 'did(Subject_:0),ssn(Social_:0),templegacyssn(Temp_Legacy_S_S_N_),src(Source_:\'\'),dt_first_seen(Date_First_Seen_:EPOCH:Date_First_Seen_0Rule),dt_last_seen(Date_Last_Seen_:EPOCH:Date_Last_Seen_0Rule),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping1 := 'did(Subject_:0),ssn(Social_:0),templegacyssn(Temp_Legacy_S_S_N_),src(Source_:\'\'),dt_first_seen(Date_First_Seen_:EPOCH:Date_First_Seen_1Rule),dt_last_seen(Date_Last_Seen_:EPOCH:Date_Last_Seen_1Rule),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping2 := 'did(Subject_:0),ssn(Social_:0),templegacyssn(Temp_Legacy_S_S_N_),src(Source_:\'\'),earliest_offense_date(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'did(Subject_:0),ssn(Social_:0),templegacyssn(Temp_Legacy_S_S_N_),src(Source_:\'\'),fcra_date(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping4 := 'did(Subject_:0),ssn(Social_:0),templegacyssn(Temp_Legacy_S_S_N_),date_first_seen(Date_First_Seen_:EPOCH),date_last_seen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
