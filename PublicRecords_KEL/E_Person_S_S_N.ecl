...
EXPORT E_Person_S_S_N(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping := 'subject(DEFAULT:Subject_:0),social(DEFAULT:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),headerhitflag(DEFAULT:Header_Hit_Flag_),source(DEFAULT:Source_:\'\'),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH)';
  ...
  SHARED __Mapping0 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),src(OVERRIDE:Source_:\'\'),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_0Rule),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_0Rule),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping1 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),src(OVERRIDE:Source_:\'\'),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_1Rule),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_1Rule),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping2 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),headerhitflag(DEFAULT:Header_Hit_Flag_),src(OVERRIDE:Source_:\'\'),earliest_offense_date(OVERRIDE:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),headerhitflag(DEFAULT:Header_Hit_Flag_),src(OVERRIDE:Source_:\'\'),fcra_date(OVERRIDE:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping4 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),headerhitflag(DEFAULT:Header_Hit_Flag_),date_first_seen(OVERRIDE:Date_First_Seen_:EPOCH),date_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  EXPORT __d4_KELfiltered := __d4_Norm((UNSIGNED)ssn != 0 AND (UNSIGNED)did != 0);
  ...
  SHARED __Mapping5 := 'did(OVERRIDE:Subject_:0),ssn(OVERRIDE:Social_:0),templegacyssn(DEFAULT:Temp_Legacy_S_S_N_),headerhitflag(DEFAULT:Header_Hit_Flag_),src(OVERRIDE:Source_:\'\'),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  EXPORT __d5_KELfiltered := __d5_Norm((UNSIGNED)did != 0 AND (UNSIGNED)ssn != 0);
  ...
  Layout Person_S_S_N__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Temp_Legacy_S_S_N_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Temp_Legacy_S_S_N_},Temp_Legacy_S_S_N_),Temp_Legacy_S_S_N_Layout)(__NN(Temp_Legacy_S_S_N_)));
  ...
  Layout Person_S_S_N__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Temp_Legacy_S_S_N_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Temp_Legacy_S_S_N_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Temp_Legacy_S_S_N_)));
