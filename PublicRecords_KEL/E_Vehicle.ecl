...
EXPORT E_Vehicle(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping0 := 'UID(UID),vehicle_key(Vehicle_Key_:\'\'),orig_vin(Original_Vin_:\'\'),orig_year(Original_Year_Make_:0),orig_make_code(Original_Make_:\'\'),orig_make_desc(Original_Make_Description_:\'\'),orig_series_code(Original_Series_:\'\'),orig_series_desc(Original_Series_Description_:\'\'),orig_model_code(Original_Model_:\'\'),orig_model_desc(Original_Model_Description_:\'\'),orig_body_code(Original_Body_:\'\'),orig_body_desc(Original_Body_Description_:\'\'),orig_net_weight(Original_Net_Weight_:0),orig_gross_weight(Original_Gross_Weight_:0),orig_number_axles(Original_Number_Axles_:0),orig_vehicle_use_code(Original_Vehicle_Use_:\'\'),orig_vehicle_use_desc(Original_Vehicle_Use_Description_:\'\'),orig_vehicle_type_code(Original_Vehicle_Type_:\'\'),orig_vehicle_type_desc(Original_Vehicle_Type_Description_:\'\'),orig_major_color_code(Original_Major_Color_:\'\'),orig_major_color_desc(Original_Major_Color_Description_:\'\'),orig_minor_color_code(Original_Minor_Color_:\'\'),orig_minor_color_desc(Original_Minor_Color_Description_:\'\'),vina_vin(Vina_Vin_:\'\'),vina_vin_pattern_indicator(Vina_Vin_Pattern_:\'\'),vina_bypass_code(Vina_Bypass_Code_:\'\'),vina_veh_type(Vina_Vehicle_Type_:\'\'),vina_ncic_make(Vina_N_C_I_C_Make_:\'\'),vina_model_year_yy(Vina_Model_Year_Y_Y_:0),vina_vp_restraint(Vina_Restraint_:\'\'),vina_vp_abbrev_make_name(Vina_Make_Name_:\'\'),vina_vp_year(Vina_Year_:0),vina_vp_series(Vina_Vp_Series_:\'\'),vina_vp_model(Vina_Vp_Model_:\'\'),vina_vp_air_conditioning(Vina_Air_Conditioning_:\'\'),vina_vp_power_steering(Vina_Power_Steering_:\'\'),vina_vp_power_brakes(Vina_Power_Brakes_:\'\'),vina_vp_power_windows(Vina_Power_Windows_:\'\'),vina_vp_tilt_wheel(Vina_Tilt_Wheel_:\'\'),vina_vp_roof(Vina_Roof_:0),vina_vp_optional_roof1(Vina_Optional_Roof1_:0),vina_vp_optional_roof2(Vina_Optional_Roof2_:0),vina_vp_radio(Vina_Radio_:\'\'),vina_vp_optional_radio1(Vina_Optional_Radio1_:\'\'),vina_vp_optional_radio2(Vina_Optional_Radio2_:\'\'),vina_vp_transmission(Vina_Transmission_:\'\'),vina_vp_optional_transmission1(Vina_Optional_Transmission1_:\'\'),vina_vp_optional_transmission2(Vina_Optional_Transmission2_:\'\'),vina_vp_anti_lock_brakes(Vina_A_L_B_:0),vina_vp_front_wheel_drive(Vina_Front_W_D_:\'\'),vina_vp_four_wheel_drive(Vina_Four_W_D_:\'\'),vina_vp_security_system(Vina_Security_System_:\'\'),vina_vp_daytime_running_lights(Vina_D_R_L_:\'\'),vina_vp_series_name(Vina_Series_Name_:\'\'),vina_model_year(Vina_Model_Year_:0),vina_series(Vina_Series_:\'\'),vina_model(Vina_Model_:\'\'),vina_body_style(Vina_Body_Style_:\'\'),vina_make_desc(Vina_Make_Description_:\'\'),vina_model_desc(Vina_Model_Description_:\'\'),vina_series_desc(Vina_Series_Description_:\'\'),vina_body_style_desc(Vina_Body_Style_Description_:\'\'),vina_number_of_cylinders(Vina_Cylinders_:0),vina_engine_size(Vina_Engine_Size_:0),vina_vuel_code(Vina_Fuel_Code_:\'\'),vina_price(Vina_Price_:0),best_make_code(Best_Make_Code_:\'\'),best_series_code(Best_Series_Code_:\'\'),best_model_code(Best_Model_Code_:\'\'),best_body_code(Best_Body_Code_:\'\'),best_model_year(Best_Model_Year_:0),best_major_color_code(Best_Major_Color_:\'\'),best_minor_color_code(Best_Minor_Color_:\'\'),branded_title_flag(Branded_Title_Flag_:\'\'),brand_code_1(Brand_Code1_:\'\'),cleaned_brand_date_1(Brand_Date1_:DATE),brand_state_1(Brand_State1_:\'\'),brand_code_2(Brand_Code2_:\'\'),cleaned_brand_date_2(Brand_Date2_:DATE),brand_state_2(Brand_Sate2_:\'\'),brand_code_3(Brand_Code3_:\'\'),cleaned_brand_date_3(Brand_Date3_:DATE),brand_state_3(Brand_Sate3_:\'\'),brand_code_4(Brand_Code4_:\'\'),cleaned_brand_date_4(Brand_Date4_:DATE),brand_state_4(Brand_Sate4_:\'\'),brand_code_5(Brand_Code5_:\'\'),cleaned_brand_date_5(Brand_Date5_:DATE),brand_state_5(Brand_Sate5_:\'\'),tod_flag(Tod_Flag_:\'\'),model_class_code(Model_Class_Code_:\'\'),model_class(Model_Class_:\'\'),min_door_count(Min_Door_Count_:\'\'),saftey_type(Saftey_Type_:\'\'),airbag_driver(Airbag_Driver_:\'\'),airbag_front_driver_side(Airbag_Front_Driver_Side_:\'\'),airbag_front_head_curtain(Airbag_Front_Head_Curtain_:\'\'),airbag_front_pass(Airbag_Front_Passanger_:\'\'),airbag_front_pass_side(Airbag_Front_Passanger_Side_:\'\'),airbags(Airbags_:\'\'),state_origin(State_Of_Origin_:\'\'),latestvehicleflag(Latest_Vehicle_Flag_:\'\'),latestvehicleiterationflag(Latest_Vehicle_Iteration_Flag_:\'\'),datevendorfirstreported(Date_Vendor_First_Reported_:DATE),datevendorlastreported(Date_Vendor_Last_Reported_:DATE),sourcefirstdate(Source_First_Date_:DATE),sourcelastdate(Source_Last_Date_:DATE),standardlienholdername(Standard_Lienholder_Name_:\'\'),src(Source_:\'\'),datefirstseen(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __d0_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d0_UID_Mapped := JOIN(__d0_KELfiltered,Lookup,TRIM((STRING)LEFT.vehicle_key) = RIGHT.KeyVal,TRANSFORM(__d0_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  ...
  SHARED __Mapping1 := 'UID(UID),vehicle_key(Vehicle_Key_:\'\'),originalvin(Original_Vin_:\'\'),originalyearmake(Original_Year_Make_:0),originalmake(Original_Make_:\'\'),originalmakedescription(Original_Make_Description_:\'\'),originalseries(Original_Series_:\'\'),originalseriesdescription(Original_Series_Description_:\'\'),originalmodel(Original_Model_:\'\'),originalmodeldescription(Original_Model_Description_:\'\'),originalbody(Original_Body_:\'\'),originalbodydescription(Original_Body_Description_:\'\'),originalnetweight(Original_Net_Weight_:0),originalgrossweight(Original_Gross_Weight_:0),originalnumberaxles(Original_Number_Axles_:0),originalvehicleuse(Original_Vehicle_Use_:\'\'),originalvehicleusedescription(Original_Vehicle_Use_Description_:\'\'),originalvehicletype(Original_Vehicle_Type_:\'\'),originalvehicletypedescription(Original_Vehicle_Type_Description_:\'\'),originalmajorcolor(Original_Major_Color_:\'\'),originalmajorcolordescription(Original_Major_Color_Description_:\'\'),originalminorcolor(Original_Minor_Color_:\'\'),originalminorcolordescription(Original_Minor_Color_Description_:\'\'),vinavin(Vina_Vin_:\'\'),vinavinpattern(Vina_Vin_Pattern_:\'\'),vinabypasscode(Vina_Bypass_Code_:\'\'),vinavehicletype(Vina_Vehicle_Type_:\'\'),vinancicmake(Vina_N_C_I_C_Make_:\'\'),vinamodelyearyy(Vina_Model_Year_Y_Y_:0),vinarestraint(Vina_Restraint_:\'\'),vinamakename(Vina_Make_Name_:\'\'),vinayear(Vina_Year_:0),vinavpseries(Vina_Vp_Series_:\'\'),vinavpmodel(Vina_Vp_Model_:\'\'),vinaairconditioning(Vina_Air_Conditioning_:\'\'),vinapowersteering(Vina_Power_Steering_:\'\'),vinapowerbrakes(Vina_Power_Brakes_:\'\'),vinapowerwindows(Vina_Power_Windows_:\'\'),vinatiltwheel(Vina_Tilt_Wheel_:\'\'),vinaroof(Vina_Roof_:0),vinaoptionalroof1(Vina_Optional_Roof1_:0),vinaoptionalroof2(Vina_Optional_Roof2_:0),vinaradio(Vina_Radio_:\'\'),vinaoptionalradio1(Vina_Optional_Radio1_:\'\'),vinaoptionalradio2(Vina_Optional_Radio2_:\'\'),vinatransmission(Vina_Transmission_:\'\'),vinaoptionaltransmission1(Vina_Optional_Transmission1_:\'\'),vinaoptionaltransmission2(Vina_Optional_Transmission2_:\'\'),vinaalb(Vina_A_L_B_:0),vinafrontwd(Vina_Front_W_D_:\'\'),vinafourwd(Vina_Four_W_D_:\'\'),vinasecuritysystem(Vina_Security_System_:\'\'),vinadrl(Vina_D_R_L_:\'\'),vinaseriesname(Vina_Series_Name_:\'\'),vinamodelyear(Vina_Model_Year_:0),vinaseries(Vina_Series_:\'\'),vinamodel(Vina_Model_:\'\'),vinabodystyle(Vina_Body_Style_:\'\'),vinamakedescription(Vina_Make_Description_:\'\'),vinamodeldescription(Vina_Model_Description_:\'\'),vinaseriesdescription(Vina_Series_Description_:\'\'),vinabodystyledescription(Vina_Body_Style_Description_:\'\'),vinacylinders(Vina_Cylinders_:0),vinaenginesize(Vina_Engine_Size_:0),vinafuelcode(Vina_Fuel_Code_:\'\'),vinaprice(Vina_Price_:0),bestmakecode(Best_Make_Code_:\'\'),bestseriescode(Best_Series_Code_:\'\'),bestmodelcode(Best_Model_Code_:\'\'),bestbodycode(Best_Body_Code_:\'\'),bestmodelyear(Best_Model_Year_:0),bestmajorcolor(Best_Major_Color_:\'\'),bestminorcolor(Best_Minor_Color_:\'\'),brandedtitleflag(Branded_Title_Flag_:\'\'),brandcode1(Brand_Code1_:\'\'),branddate1(Brand_Date1_:DATE),brandstate1(Brand_State1_:\'\'),brandcode2(Brand_Code2_:\'\'),branddate2(Brand_Date2_:DATE),brandsate2(Brand_Sate2_:\'\'),brandcode3(Brand_Code3_:\'\'),branddate3(Brand_Date3_:DATE),brandsate3(Brand_Sate3_:\'\'),brandcode4(Brand_Code4_:\'\'),branddate4(Brand_Date4_:DATE),brandsate4(Brand_Sate4_:\'\'),brandcode5(Brand_Code5_:\'\'),branddate5(Brand_Date5_:DATE),brandsate5(Brand_Sate5_:\'\'),todflag(Tod_Flag_:\'\'),modelclasscode(Model_Class_Code_:\'\'),modelclass(Model_Class_:\'\'),mindoorcount(Min_Door_Count_:\'\'),safteytype(Saftey_Type_:\'\'),airbagdriver(Airbag_Driver_:\'\'),airbagfrontdriverside(Airbag_Front_Driver_Side_:\'\'),airbagfrontheadcurtain(Airbag_Front_Head_Curtain_:\'\'),airbagfrontpassanger(Airbag_Front_Passanger_:\'\'),airbagfrontpassangerside(Airbag_Front_Passanger_Side_:\'\'),airbags(Airbags_:\'\'),state_origin(State_Of_Origin_:\'\'),latest_vehicle_flag(Latest_Vehicle_Flag_:\'\'),latest_vehicle_iteration_flag(Latest_Vehicle_Iteration_Flag_:\'\'),date_vendor_first_reported(Date_Vendor_First_Reported_:DATE),date_vendor_last_reported(Date_Vendor_Last_Reported_:DATE),src_first_date(Source_First_Date_:DATE),src_last_date(Source_Last_Date_:DATE),std_lienholder_name(Standard_Lienholder_Name_:\'\'),source_code(Source_:\'\'),date_first_seen(Date_First_Seen_:EPOCH:Date_First_Seen_1Rule),date_last_seen(Date_Last_Seen_:EPOCH:Date_Last_Seen_1Rule),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __d1_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d1_UID_Mapped := JOIN(__d1_KELfiltered,Lookup,TRIM((STRING)LEFT.vehicle_key) = RIGHT.KeyVal,TRANSFORM(__d1_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_number_axles',COUNT(__d0(__NL(Original_Number_Axles_))),COUNT(__d0(__NN(Original_Number_Axles_)))},
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','vina_vuel_code',COUNT(__d0(__NL(Vina_Fuel_Code_))),COUNT(__d0(__NN(Vina_Fuel_Code_)))},
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','saftey_type',COUNT(__d0(__NL(Saftey_Type_))),COUNT(__d0(__NN(Saftey_Type_)))},
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SafteyType',COUNT(__d1(__NL(Saftey_Type_))),COUNT(__d1(__NN(Saftey_Type_)))},
    ...
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','date_vendor_first_reported',COUNT(__d1(__NL(Date_Vendor_First_Reported_))),COUNT(__d1(__NN(Date_Vendor_First_Reported_)))},
    {'Vehicle','PublicRecords_KEL.ECL_Functions.Dataset_FDC','date_vendor_last_reported',COUNT(__d1(__NL(Date_Vendor_Last_Reported_))),COUNT(__d1(__NN(Date_Vendor_Last_Reported_)))},
