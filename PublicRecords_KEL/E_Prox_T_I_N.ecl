...
IMPORT CFG_Compile,E_Business_Org,E_Business_Prox,E_Business_Sele,E_Business_Sele_Overflow,E_Business_Ult,E_T_I_N FROM PublicRecords_KEL;
IMPORT * FROM KEL15.Null;
EXPORT E_Prox_T_I_N(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping0 := 'Business_Location_(DEFAULT:Business_Location_:0),company_fein(OVERRIDE:Tax_I_D_:0|OVERRIDE:Best_T_I_N_:0),ultid(OVERRIDE:Ult_I_D_:0),orgid(OVERRIDE:Org_I_D_:0),seleid(OVERRIDE:Sele_I_D_:0),proxid(OVERRIDE:Prox_I_D_:0),company_fein_method(OVERRIDE:Best_T_I_N_Rank_:0),headerhitflag(DEFAULT:Header_Hit_Flag_),src(OVERRIDE:Source_:\'\'),archive_date(OVERRIDE:Archive___Date_:EPOCH),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN(proxid != 0 AND seleid != 0 AND company_fein <> '');
  SHARED __d0_Business_Location__Layout := RECORD
    RECORDOF(__d0_KELfiltered);
    KEL.typ.uid Business_Location_;
  END;
  SHARED __d0_Missing_Business_Location__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_KELfiltered,'ultid,orgid,seleid,proxid','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN');
  ...
  SHARED __d0 := __SourceFilter(KEL.FromFlat.Convert(__d0_Prefiltered,InLayout,__Mapping0,'PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN'));
  EXPORT InData := __d0;
  ...
  EXPORT NullCounts := DATASET([
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','BusinessLocation',COUNT(__d0(__NL(Business_Location_))),COUNT(__d0(__NN(Business_Location_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','company_fein',COUNT(__d0(__NL(Tax_I_D_))),COUNT(__d0(__NN(Tax_I_D_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','ultid',COUNT(__d0(__NL(Ult_I_D_))),COUNT(__d0(__NN(Ult_I_D_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','orgid',COUNT(__d0(__NL(Org_I_D_))),COUNT(__d0(__NN(Org_I_D_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','seleid',COUNT(__d0(__NL(Sele_I_D_))),COUNT(__d0(__NN(Sele_I_D_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','proxid',COUNT(__d0(__NL(Prox_I_D_))),COUNT(__d0(__NN(Prox_I_D_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','company_fein',COUNT(__d0(__NL(Best_T_I_N_))),COUNT(__d0(__NN(Best_T_I_N_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','company_fein_method',COUNT(__d0(__NL(Best_T_I_N_Rank_))),COUNT(__d0(__NN(Best_T_I_N_Rank_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','HeaderHitFlag',COUNT(__d0(__NL(Header_Hit_Flag_))),COUNT(__d0(__NN(Header_Hit_Flag_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','Src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'ProxTIN','PublicRecords_KEL.Files.NonFCRA.BIPV2_Best__Key_LinkIds__Company_FEIN','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
