...
EXPORT B_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE394853 := __ENH_Bankruptcy_2;
  EXPORT __ST72384_Layout := RECORD
  ...
  END;
  EXPORT __ST72377_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST72384_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST72377_Layout __ND395164__Project(B_Bankruptcy_2(__in,__cfg).__ST72169_Layout __PP394542) := TRANSFORM
    __EE394601 := __PP394542.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE394601),__ST72384_Layout),__NL(__EE394601));
    SELF := __PP394542;
  END;
  EXPORT __ENH_Bankruptcy_1 := PROJECT(__EE394853,__ND395164__Project(LEFT));
END;
