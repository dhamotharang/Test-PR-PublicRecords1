...
EXPORT B_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE396464 := __ENH_Bankruptcy_2;
  EXPORT __ST72865_Layout := RECORD
  ...
  END;
  EXPORT __ST72858_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST72865_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST72858_Layout __ND396785__Project(B_Bankruptcy_2(__in,__cfg).__ST72589_Layout __PP396143) := TRANSFORM
    __EE396202 := __PP396143.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE396202),__ST72865_Layout),__NL(__EE396202));
    SELF := __PP396143;
  END;
  EXPORT __ENH_Bankruptcy_1 := PROJECT(__EE396464,__ND396785__Project(LEFT));
END;
