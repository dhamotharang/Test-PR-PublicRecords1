...
EXPORT B_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE175041 := __ENH_Bankruptcy_2;
  EXPORT __ST40789_Layout := RECORD
  ...
  END;
  EXPORT __ST40782_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST40789_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST40782_Layout __ND175352__Project(B_Bankruptcy_2(__in,__cfg).__ST40574_Layout __PP174730) := TRANSFORM
    __EE174789 := __PP174730.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE174789),__ST40789_Layout),__NL(__EE174789));
    SELF := __PP174730;
  END;
  EXPORT __ENH_Bankruptcy_1 := PROJECT(__EE175041,__ND175352__Project(LEFT));
END;
