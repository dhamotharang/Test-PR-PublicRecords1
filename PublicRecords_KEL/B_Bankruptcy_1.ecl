...
EXPORT B_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE25590 := __ENH_Bankruptcy_2;
  EXPORT __ST12326_Layout := RECORD
  ...
  END;
  EXPORT __ST12319_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST12326_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST12319_Layout __ND26202__Project(B_Bankruptcy_2(__in,__cfg).__ST13020_Layout __PP25222) := TRANSFORM
    __EE25341 := __PP25222.Records_;
    SELF.Records_ := __PROJECT(__EE25341,__ST12326_Layout);
    SELF := __PP25222;
  END;
  EXPORT __ENH_Bankruptcy_1 := PROJECT(__EE25590,__ND26202__Project(LEFT));
END;
