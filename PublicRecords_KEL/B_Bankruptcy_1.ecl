...
EXPORT B_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE45798 := __ENH_Bankruptcy_2;
  EXPORT __ST21390_Layout := RECORD
  ...
  END;
  EXPORT __ST21383_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr Court_Code_;
    KEL.typ.nstr Case_Number_;
    KEL.typ.nstr Original_Case_Number_;
    KEL.typ.ndataset(__ST21390_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21383_Layout __ND46034__Project(B_Bankruptcy_2(__in,__cfg).__ST23647_Layout __PP45562) := TRANSFORM
    __EE45619 := __PP45562.Records_;
    SELF.Records_ := __PROJECT(__EE45619,__ST21390_Layout);
    SELF := __PP45562;
  END;
  EXPORT __ENH_Bankruptcy_1 := PROJECT(__EE45798,__ND46034__Project(LEFT));
END;
