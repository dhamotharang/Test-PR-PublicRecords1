...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5574369 := __ENH_Inquiry_4;
  EXPORT __ST265888_Layout := RECORD
  ...
  END;
  EXPORT __ST265861_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST265888_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265861_Layout __ND5574374__Project(B_Inquiry_4(__in,__cfg).__ST233386_Layout __PP5574370) := TRANSFORM
    __EE5574444 := __PP5574370.Person_Info_;
    __ST265888_Layout __ND5574449__Project(B_Inquiry_4(__in,__cfg).__ST233413_Layout __PP5574445) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP5574445.Primary_Name_),+,__FN1(TRIM,__PP5574445.Primary_Range_)),+,__FN1(TRIM,__PP5574445.Z_I_P5_));
      SELF := __PP5574445;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5574444,__ND5574449__Project(LEFT));
    SELF := __PP5574370;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE5574369,__ND5574374__Project(LEFT));
END;
