...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5937197 := __ENH_Inquiry_4;
  EXPORT __ST291424_Layout := RECORD
  ...
  END;
  EXPORT __ST291397_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST291424_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST291397_Layout __ND5937202__Project(B_Inquiry_4(__in,__cfg).__ST242059_Layout __PP5937198) := TRANSFORM
    __EE5937272 := __PP5937198.Person_Info_;
    __ST291424_Layout __ND5937277__Project(B_Inquiry_4(__in,__cfg).__ST242086_Layout __PP5937273) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP5937273.Primary_Name_),+,__FN1(TRIM,__PP5937273.Primary_Range_)),+,__FN1(TRIM,__PP5937273.Z_I_P5_));
      SELF := __PP5937273;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5937272,__ND5937277__Project(LEFT));
    SELF := __PP5937198;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE5937197,__ND5937202__Project(LEFT));
END;
