...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6425721 := __ENH_Inquiry_4;
  EXPORT __ST311737_Layout := RECORD
  ...
  END;
  EXPORT __ST311710_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST311737_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST311710_Layout __ND6425726__Project(B_Inquiry_4(__in,__cfg).__ST251084_Layout __PP6425722) := TRANSFORM
    __EE6425797 := __PP6425722.Person_Info_;
    __ST311737_Layout __ND6425802__Project(B_Inquiry_4(__in,__cfg).__ST251111_Layout __PP6425798) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP6425798.Primary_Name_),+,__FN1(TRIM,__PP6425798.Primary_Range_)),+,__FN1(TRIM,__PP6425798.Z_I_P5_));
      SELF := __PP6425798;
    END;
    SELF.Person_Info_ := __PROJECT(__EE6425797,__ND6425802__Project(LEFT));
    SELF := __PP6425722;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE6425721,__ND6425726__Project(LEFT));
END;
