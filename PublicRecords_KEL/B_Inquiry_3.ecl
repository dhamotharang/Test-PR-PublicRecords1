...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5937227 := __ENH_Inquiry_4;
  EXPORT __ST277643_Layout := RECORD
  ...
  END;
  EXPORT __ST277616_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST277643_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST277616_Layout __ND5937232__Project(B_Inquiry_4(__in,__cfg).__ST242089_Layout __PP5937228) := TRANSFORM
    __EE5937302 := __PP5937228.Person_Info_;
    __ST277643_Layout __ND5937307__Project(B_Inquiry_4(__in,__cfg).__ST242116_Layout __PP5937303) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP5937303.Primary_Name_),+,__FN1(TRIM,__PP5937303.Primary_Range_)),+,__FN1(TRIM,__PP5937303.Z_I_P5_));
      SELF := __PP5937303;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5937302,__ND5937307__Project(LEFT));
    SELF := __PP5937228;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE5937227,__ND5937232__Project(LEFT));
END;
