...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5572090 := __ENH_Inquiry_4;
  ...
  END;
  EXPORT __ST266302_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST266329_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266302_Layout __ND5572095__Project(B_Inquiry_4(__in,__cfg).__ST232711_Layout __PP5572091) := TRANSFORM
    __EE5572165 := __PP5572091.Person_Info_;
    __ST266329_Layout __ND5572170__Project(B_Inquiry_4(__in,__cfg).__ST232738_Layout __PP5572166) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP5572166.Primary_Name_),+,__FN1(TRIM,__PP5572166.Primary_Range_)),+,__FN1(TRIM,__PP5572166.Z_I_P5_));
      SELF := __PP5572166;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5572165,__ND5572170__Project(LEFT));
    SELF := __PP5572091;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE5572090,__ND5572095__Project(LEFT));
END;
