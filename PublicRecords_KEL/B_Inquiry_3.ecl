...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6027050 := __ENH_Inquiry_4;
  EXPORT __ST309695_Layout := RECORD
  ...
  END;
  EXPORT __ST309668_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST309695_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST309668_Layout __ND6027055__Project(B_Inquiry_4(__in,__cfg).__ST239177_Layout __PP6027051) := TRANSFORM
    __EE6027125 := __PP6027051.Person_Info_;
    __ST309695_Layout __ND6027130__Project(B_Inquiry_4(__in,__cfg).__ST239204_Layout __PP6027126) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP6027126.Primary_Name_),+,__FN1(TRIM,__PP6027126.Primary_Range_)),+,__FN1(TRIM,__PP6027126.Z_I_P5_));
      SELF := __PP6027126;
    END;
    SELF.Person_Info_ := __PROJECT(__EE6027125,__ND6027130__Project(LEFT));
    SELF := __PP6027051;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE6027050,__ND6027055__Project(LEFT));
END;
