...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6430402 := __ENH_Inquiry_4;
  EXPORT __ST315953_Layout := RECORD
  ...
  END;
  EXPORT __ST315926_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST315953_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST315926_Layout __ND6430407__Project(B_Inquiry_4(__in,__cfg).__ST254882_Layout __PP6430403) := TRANSFORM
    __EE6430478 := __PP6430403.Person_Info_;
    __ST315953_Layout __ND6430483__Project(B_Inquiry_4(__in,__cfg).__ST254909_Layout __PP6430479) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP6430479.Primary_Name_),+,__FN1(TRIM,__PP6430479.Primary_Range_)),+,__FN1(TRIM,__PP6430479.Z_I_P5_));
      SELF := __PP6430479;
    END;
    SELF.Person_Info_ := __PROJECT(__EE6430478,__ND6430483__Project(LEFT));
    SELF := __PP6430403;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE6430402,__ND6430407__Project(LEFT));
END;
