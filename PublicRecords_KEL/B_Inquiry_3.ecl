...
EXPORT B_Inquiry_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5574374 := __ENH_Inquiry_4;
  EXPORT __ST284866_Layout := RECORD
  ...
  END;
  EXPORT __ST284839_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST284866_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST284839_Layout __ND5574379__Project(B_Inquiry_4(__in,__cfg).__ST233391_Layout __PP5574375) := TRANSFORM
    __EE5574449 := __PP5574375.Person_Info_;
    __ST284866_Layout __ND5574454__Project(B_Inquiry_4(__in,__cfg).__ST233418_Layout __PP5574450) := TRANSFORM
      SELF.Combined_Address_ := __OP2(__OP2(__FN1(TRIM,__PP5574450.Primary_Name_),+,__FN1(TRIM,__PP5574450.Primary_Range_)),+,__FN1(TRIM,__PP5574450.Z_I_P5_));
      SELF := __PP5574450;
    END;
    SELF.Person_Info_ := __PROJECT(__EE5574449,__ND5574454__Project(LEFT));
    SELF := __PP5574375;
  END;
  EXPORT __ENH_Inquiry_3 := PROJECT(__EE5574374,__ND5574379__Project(LEFT));
END;
