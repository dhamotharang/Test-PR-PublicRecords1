...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5293040 := __ENH_Property_Event_8;
  EXPORT __ST258287_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST258287_Layout __ND5293045__Project(B_Property_Event_8(__in,__cfg).__ST260984_Layout __PP5293041) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP5293041.Date_Last_Seen_);
    SELF := __PP5293041;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE5293040,__ND5293045__Project(LEFT));
END;
