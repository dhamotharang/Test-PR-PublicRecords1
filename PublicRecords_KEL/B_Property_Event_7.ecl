...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6537075 := __ENH_Property_Event_8;
  EXPORT __ST288910_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST288910_Layout __ND6537080__Project(B_Property_Event_8(__in,__cfg).__ST291571_Layout __PP6537076) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP6537076.Date_Last_Seen_);
    SELF := __PP6537076;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE6537075,__ND6537080__Project(LEFT));
END;
