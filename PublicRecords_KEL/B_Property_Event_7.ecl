...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6177676 := __ENH_Property_Event_8;
  EXPORT __ST282464_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST282464_Layout __ND6177681__Project(B_Property_Event_8(__in,__cfg).__ST285397_Layout __PP6177677) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP6177677.Date_Last_Seen_);
    SELF := __PP6177677;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE6177676,__ND6177681__Project(LEFT));
END;
