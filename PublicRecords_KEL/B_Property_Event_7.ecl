...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5101532 := __ENH_Property_Event_8;
  EXPORT __ST259715_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST259715_Layout __ND5101537__Project(B_Property_Event_8(__in,__cfg).__ST262477_Layout __PP5101533) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP5101533.Date_Last_Seen_);
    SELF := __PP5101533;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE5101532,__ND5101537__Project(LEFT));
END;
