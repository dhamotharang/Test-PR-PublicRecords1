...
EXPORT Q_Input_Bus_Attributes_V1(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.InputEcho_Layout)) __PInputPIIDataset, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.AttrBusWithUID_Layout)) __PInputBIIDataset, KEL.typ.str __PBusInputArchiveDateEcho, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE129621 := __ENH_Input_B_I_I;
  SHARED __ST9802_Layout := RECORD
  ...
  END;
  SHARED __ST9802_Layout __ND129371__Project(B_Input_B_I_I(__in).__ST13718_Layout __PP129304) := TRANSFORM
    SELF.Bus_Input_U_I_D_Append_ := __PP129304.UID;
    SELF.Bus_Input_Account_Echo_ := __PP129304.Bus_Input_Account_Echo_Value_;
    SELF.Bus_Input_U_I_D_Append__1_ := __PP129304.Bus_Input_U_I_D_Append_;
    SELF.Input_Lex_I_D_Bus_Extended_Family_Echo_ := __PP129304.Input_Lex_I_D_Bus_Extended_Family_Echo_Value_;
    SELF.Input_Lex_I_D_Bus_Legal_Family_Echo_ := __PP129304.Input_Lex_I_D_Bus_Legal_Family_Echo_Value_;
    SELF.Input_Lex_I_D_Bus_Legal_Entity_Echo_ := __PP129304.Input_Lex_I_D_Bus_Legal_Entity_Echo_Value_;
    SELF.Input_Lex_I_D_Bus_Place_Group_Echo_ := __PP129304.Input_Lex_I_D_Bus_Place_Group_Echo_Value_;
    SELF.Input_Lex_I_D_Bus_Place_Echo_ := __PP129304.Input_Lex_I_D_Bus_Place_Echo_Value_;
    SELF.Bus_Input_Name_Echo_ := __PP129304.Bus_Input_Name_Echo_Value_;
    SELF.Bus_Input_Alternate_Name_Echo_ := __PP129304.Bus_Input_Alternate_Name_Echo_Value_;
    SELF.Bus_Input_Street_Echo_ := __PP129304.Bus_Input_Street_Echo_Value_;
    SELF.Bus_Input_City_Echo_ := __PP129304.Bus_Input_City_Echo_Value_;
    SELF.Bus_Input_State_Echo_ := __PP129304.Bus_Input_State_Echo_Value_;
    SELF.Bus_Input_Zip_Echo_ := __PP129304.Bus_Input_Zip_Echo_Value_;
    SELF.Bus_Input_Phone_Echo_ := __PP129304.Bus_Input_Phone_Echo_Value_;
    SELF.Bus_Input_I_P_Address_Echo_ := __PP129304.Bus_Input_I_P_Address_Echo_Value_;
    SELF.Bus_Input_U_R_L_Echo_ := __PP129304.Bus_Input_U_R_L_Echo_Value_;
    SELF.Bus_Input_Email_Echo_ := __PP129304.Bus_Input_Email_Echo_Value_;
    SELF.Bus_Input_S_I_C_Code_Echo_ := __PP129304.Bus_Input_S_I_C_Code_Echo_Value_;
    SELF.Bus_Input_N_A_I_C_S_Code_Echo_ := __PP129304.Bus_Input_N_A_I_C_S_Code_Echo_Value_;
    SELF.Bus_Input_Archive_Date_Echo_ := __PP129304.Bus_Input_Archive_Date_Echo_Value_;
    SELF.Bus_Input_Rep1_Lex_I_D_Echo_ := __PP129304.Bus_Input_Rep1_Lex_I_D_Echo_Value_;
    SELF.Bus_Input_Rep1_First_Name_Echo_ := __PP129304.Bus_Input_Rep1_First_Name_Echo_Value_;
    SELF.Bus_Input_Rep1_Street_Echo_ := __PP129304.Bus_Input_Rep1_Street_Echo_Value_;
    SELF.Bus_Input_Rep1_City_Echo_ := __PP129304.Bus_Input_Rep1_City_Echo_Value_;
    SELF.Bus_Input_Rep1_State_Echo_ := __PP129304.Bus_Input_Rep1_State_Echo_Value_;
    SELF.Bus_Input_Rep1_Zip_Echo_ := __PP129304.Bus_Input_Rep1_Zip_Echo_Value_;
    SELF.Bus_Input_Rep1_Phone_Echo_ := __PP129304.Bus_Input_Rep1_Phone_Echo_Value_;
    SELF.Bus_Input_Rep1_Email_Echo_ := __PP129304.Bus_Input_Rep1_Email_Echo_Value_;
    SELF.Bus_Input_Rep2_Lex_I_D_Echo_ := __PP129304.Bus_Input_Rep2_Lex_I_D_Echo_Value_;
    SELF.Bus_Input_Rep2_First_Name_Echo_ := __PP129304.Bus_Input_Rep2_First_Name_Echo_Value_;
    SELF.Bus_Input_Rep2_Street_Echo_ := __PP129304.Bus_Input_Rep2_Street_Echo_Value_;
    SELF.Bus_Input_Rep2_City_Echo_ := __PP129304.Bus_Input_Rep2_City_Echo_Value_;
    SELF.Bus_Input_Rep2_State_Echo_ := __PP129304.Bus_Input_Rep2_State_Echo_Value_;
    SELF.Bus_Input_Rep2_Zip_Echo_ := __PP129304.Bus_Input_Rep2_Zip_Echo_Value_;
    SELF.Bus_Input_Rep2_Phone_Echo_ := __PP129304.Bus_Input_Rep2_Phone_Echo_Value_;
    SELF.Bus_Input_Rep2_Email_Echo_ := __PP129304.Bus_Input_Rep2_Email_Echo_Value_;
    SELF.Bus_Input_Rep3_Lex_I_D_Echo_ := __PP129304.Bus_Input_Rep3_Lex_I_D_Echo_Value_;
    SELF.Bus_Input_Rep3_First_Name_Echo_ := __PP129304.Bus_Input_Rep3_First_Name_Echo_Value_;
    SELF.Bus_Input_Rep3_Street_Echo_ := __PP129304.Bus_Input_Rep3_Street_Echo_Value_;
    SELF.Bus_Input_Rep3_City_Echo_ := __PP129304.Bus_Input_Rep3_City_Echo_Value_;
    SELF.Bus_Input_Rep3_State_Echo_ := __PP129304.Bus_Input_Rep3_State_Echo_Value_;
    SELF.Bus_Input_Rep3_Zip_Echo_ := __PP129304.Bus_Input_Rep3_Zip_Echo_Value_;
    SELF.Bus_Input_Rep3_Phone_Echo_ := __PP129304.Bus_Input_Rep3_Phone_Echo_Value_;
    SELF.Bus_Input_Rep3_Email_Echo_ := __PP129304.Bus_Input_Rep3_Email_Echo_Value_;
    SELF.Bus_Input_Rep4_Lex_I_D_Echo_ := __PP129304.Bus_Input_Rep4_Lex_I_D_Echo_Value_;
    SELF.Bus_Input_Rep4_First_Name_Echo_ := __PP129304.Bus_Input_Rep4_First_Name_Echo_Value_;
    SELF.Bus_Input_Rep4_Street_Echo_ := __PP129304.Bus_Input_Rep4_Street_Echo_Value_;
    SELF.Bus_Input_Rep4_City_Echo_ := __PP129304.Bus_Input_Rep4_City_Echo_Value_;
    SELF.Bus_Input_Rep4_State_Echo_ := __PP129304.Bus_Input_Rep4_State_Echo_Value_;
    SELF.Bus_Input_Rep4_Zip_Echo_ := __PP129304.Bus_Input_Rep4_Zip_Echo_Value_;
    SELF.Bus_Input_Rep4_Phone_Echo_ := __PP129304.Bus_Input_Rep4_Phone_Echo_Value_;
    SELF.Bus_Input_Rep4_Email_Echo_ := __PP129304.Bus_Input_Rep4_Email_Echo_Value_;
    SELF.Bus_Input_Rep5_Lex_I_D_Echo_ := __PP129304.Bus_Input_Rep5_Lex_I_D_Echo_Value_;
    SELF.Bus_Input_Rep5_First_Name_Echo_ := __PP129304.Bus_Input_Rep5_First_Name_Echo_Value_;
    SELF.Bus_Input_Rep5_Street_Echo_ := __PP129304.Bus_Input_Rep5_Street_Echo_Value_;
    SELF.Bus_Input_Rep5_City_Echo_ := __PP129304.Bus_Input_Rep5_City_Echo_Value_;
    SELF.Bus_Input_Rep5_State_Echo_ := __PP129304.Bus_Input_Rep5_State_Echo_Value_;
    SELF.Bus_Input_Rep5_Zip_Echo_ := __PP129304.Bus_Input_Rep5_Zip_Echo_Value_;
    SELF.Bus_Input_Rep5_Phone_Echo_ := __PP129304.Bus_Input_Rep5_Phone_Echo_Value_;
    SELF.Bus_Input_Rep5_Email_Echo_ := __PP129304.Bus_Input_Rep5_Email_Echo_Value_;
    SELF := __PP129304;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE129621,__ND129371__Project(LEFT)));
END;
