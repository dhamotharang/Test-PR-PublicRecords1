...
EXPORT B_Lien_Judgment_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE134309 := __E_Lien_Judgment;
  EXPORT __ST108852_Layout := RECORD
  ...
  END;
  EXPORT __ST108847_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST108852_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST108847_Layout __ND134532__Project(E_Lien_Judgment(__in,__cfg).Layout __PP134465) := TRANSFORM
    __EE134157 := __PP134465.Filing_;
    __ST108852_Layout __ND134468__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP134467) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP134465.T_M_S_I_D_;
      SELF := __PP134467;
    END;
    SELF.Filing_ := __PROJECT(__EE134157,__ND134468__Project(LEFT));
    SELF := __PP134465;
  END;
  EXPORT __ENH_Lien_Judgment_6 := PROJECT(__EE134309,__ND134532__Project(LEFT));
END;
