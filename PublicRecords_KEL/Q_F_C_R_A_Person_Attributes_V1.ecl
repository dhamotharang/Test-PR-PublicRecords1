...
EXPORT Q_F_C_R_A_Person_Attributes_V1(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1712636 := __ENH_Person;
  SHARED __EE1718914 := __EE1712636(__T(__OP2(__EE1712636.UID,=,__CN(__PLexID_in))));
  SHARED __ST38847_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE1718914,TRANSFORM(__ST38847_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
