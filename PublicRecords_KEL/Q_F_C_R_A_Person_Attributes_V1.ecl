...
EXPORT Q_F_C_R_A_Person_Attributes_V1(KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1714580 := __ENH_Person;
  SHARED __EE1720834 := __EE1714580(__T(__OP2(__EE1714580.UID,=,__CN(__PLexID_in))));
  SHARED __ST37975_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE1720834,TRANSFORM(__ST37975_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
