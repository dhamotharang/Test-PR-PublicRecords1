...
EXPORT Q_F_C_R_A_Person_Attributes_V1(SET OF KEL.typ.uid __PLexIDs, KEL.typ.kdate __PInputArchiveDateClean, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE503709 := __ENH_Person;
  SHARED __EE507761 := __EE503709(__T(__OP2(__EE503709.UID,IN,__CN(__PLexIDs))));
  SHARED __ST19585_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE507761,TRANSFORM(__ST19585_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
