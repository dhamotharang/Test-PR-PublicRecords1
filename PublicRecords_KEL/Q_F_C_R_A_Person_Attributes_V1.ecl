...
EXPORT Q_F_C_R_A_Person_Attributes_V1(SET OF KEL.typ.uid __PLexIDs, KEL.typ.kdate __PArchiveDate, UNSIGNED1 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE116288 := __ENH_Person;
  SHARED __EE116881 := __EE116288(__T(__OP2(__EE116288.UID,IN,__CN(__PLexIDs))));
  SHARED __ST9358_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE116881,TRANSFORM(__ST9358_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
