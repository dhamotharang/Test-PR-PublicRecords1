...
EXPORT Q_F_C_R_A_Person_Attributes_V1(SET OF KEL.typ.uid __PLexIDs, KEL.typ.kdate __PArchiveDate, UNSIGNED1 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE140969 := __ENH_Person;
  SHARED __EE141432 := __EE140969(__T(__OP2(__EE140969.UID,IN,__CN(__PLexIDs))));
  SHARED __ST11131_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE141432,TRANSFORM(__ST11131_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
END;
