...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5538807 := __ENH_Input_B_I_I_10;
  EXPORT __ST277266_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST277266_Layout __ND5539101__Project(B_Input_B_I_I_10(__in,__cfg).__ST278987_Layout __PP5538808) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5538808.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5538808.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5538808.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5538808.B___Inp_Addr_Line2_)));
    SELF := __PP5538808;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5538807,__ND5539101__Project(LEFT));
END;
