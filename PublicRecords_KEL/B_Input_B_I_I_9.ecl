...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5064272 := __ENH_Input_B_I_I_10;
  EXPORT __ST263355_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST263355_Layout __ND5064566__Project(B_Input_B_I_I_10(__in,__cfg).__ST265067_Layout __PP5064273) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5064273.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5064273.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5064273.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5064273.B___Inp_Addr_Line2_)));
    SELF := __PP5064273;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5064272,__ND5064566__Project(LEFT));
END;
