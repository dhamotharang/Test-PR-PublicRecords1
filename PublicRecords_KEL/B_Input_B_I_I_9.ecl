...
EXPORT B_Input_B_I_I_9(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5225057 := __ENH_Input_B_I_I_10;
  EXPORT __ST261863_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST261863_Layout __ND5225351__Project(B_Input_B_I_I_10(__cfg).__ST263553_Layout __PP5225058) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5225058.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5225058.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5225058.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5225058.B___Inp_Addr_Line2_)));
    SELF := __PP5225058;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5225057,__ND5225351__Project(LEFT));
END;
