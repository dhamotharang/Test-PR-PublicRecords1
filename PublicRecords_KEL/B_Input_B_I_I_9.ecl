...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5032579 := __ENH_Input_B_I_I_10;
  ...
  END;
  SHARED __ST261285_Layout __ND5032873__Project(B_Input_B_I_I_10(__in,__cfg).__ST262993_Layout __PP5032580) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5032580.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5032580.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5032580.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5032580.B___Inp_Addr_Line2_)));
    SELF := __PP5032580;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5032579,__ND5032873__Project(LEFT));
END;
