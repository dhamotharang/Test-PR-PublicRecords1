...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3504424 := __ENH_Input_B_I_I_10;
  EXPORT __ST198109_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST198109_Layout __ND3504718__Project(B_Input_B_I_I_10(__in,__cfg).__ST199156_Layout __PP3504425) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP3504425.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP3504425.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP3504425.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP3504425.B___Inp_Addr_Line2_)));
    SELF := __PP3504425;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE3504424,__ND3504718__Project(LEFT));
END;
