...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5611523 := __ENH_Input_B_I_I_10;
  ...
  END;
  SHARED __ST272992_Layout __ND5611817__Project(B_Input_B_I_I_10(__in,__cfg).__ST274705_Layout __PP5611524) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5611524.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5611524.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5611524.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5611524.B___Inp_Addr_Line2_)));
    SELF := __PP5611524;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5611523,__ND5611817__Project(LEFT));
END;
