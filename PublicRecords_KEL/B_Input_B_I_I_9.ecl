...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5536099 := __ENH_Input_B_I_I_10;
  EXPORT __ST276847_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST276847_Layout __ND5536393__Project(B_Input_B_I_I_10(__in,__cfg).__ST278568_Layout __PP5536100) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP5536100.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP5536100.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP5536100.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP5536100.B___Inp_Addr_Line2_)));
    SELF := __PP5536100;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE5536099,__ND5536393__Project(LEFT));
END;
