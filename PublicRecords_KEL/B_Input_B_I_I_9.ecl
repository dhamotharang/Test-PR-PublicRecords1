...
EXPORT B_Input_B_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4797636 := __ENH_Input_B_I_I_10;
  EXPORT __ST253477_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST253477_Layout __ND4797930__Project(B_Input_B_I_I_10(__in,__cfg).__ST255162_Layout __PP4797637) := TRANSFORM
    SELF.B___Inp_Addr_ := __OP2(IF(__T(__NT(__PP4797637.B___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP4797637.B___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP4797637.B___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP4797637.B___Inp_Addr_Line2_)));
    SELF := __PP4797637;
  END;
  EXPORT __ENH_Input_B_I_I_9 := PROJECT(__EE4797636,__ND4797930__Project(LEFT));
END;
