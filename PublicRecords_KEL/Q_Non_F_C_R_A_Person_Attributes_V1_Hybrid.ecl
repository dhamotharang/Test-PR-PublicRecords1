...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11434820 := __ENH_Person;
  SHARED __EE11440173 := __EE11434820(__T(__OP2(__EE11434820.UID,=,__CN(__PLexID_in))));
  SHARED __ST126079_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3782376_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3782396_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST86479_Layout) P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST86732_Layout) P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88356_Layout) P_L___Drg_Bk_Dt_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88378_Layout) P_L___Drg_Bk_Dt_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88400_Layout) P_L___Drg_Bk_Dt_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88639_Layout) P_L___Drg_Bk_Ch_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88669_Layout) P_L___Drg_Bk_Ch_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88699_Layout) P_L___Drg_Bk_Ch_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89498_Layout) P_L___Drg_Bk_Disp_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89532_Layout) P_L___Drg_Bk_Disp_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST89566_Layout) P_L___Drg_Bk_Disp_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90106_Layout) P_L___Drg_Bk_Type_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90143_Layout) P_L___Drg_Bk_Type_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90180_Layout) P_L___Drg_Bk_Type_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90582_Layout) P_L___Prof_Lic_Issue_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90590_Layout) P_L___Prof_Lic_Exp_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90605_Layout) P_L___Prof_Lic_Indx_By_Lic_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST93497_Layout) Crim_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST93512_Layout) Banko_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST93528_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST93545_Layout) L_T_D7_Y_List_;
  ...
  END;
  SHARED __ST126079_Layout __ND11440178__Project(B_Person(__in,__cfg_Local).__ST171419_Layout __PP11440174) := TRANSFORM
    SELF.Lex_I_D_ := __PP11440174.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP11440174.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    SELF := __PP11440174;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11440173,__ND11440178__Project(LEFT)));
