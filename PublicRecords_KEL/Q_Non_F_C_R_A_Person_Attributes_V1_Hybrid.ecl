...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11434790 := __ENH_Person;
  SHARED __EE11440143 := __EE11434790(__T(__OP2(__EE11434790.UID,=,__CN(__PLexID_in))));
  SHARED __ST126049_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3782346_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3782366_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
  ...
  END;
  SHARED __ST126049_Layout __ND11440148__Project(B_Person(__in,__cfg_Local).__ST171389_Layout __PP11440144) := TRANSFORM
    SELF.Lex_I_D_ := __PP11440144.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP11440144.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    SELF := __PP11440144;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11440143,__ND11440148__Project(LEFT)));
