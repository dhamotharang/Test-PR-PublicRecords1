...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11581805 := __ENH_Person;
  SHARED __EE11586930 := __EE11581805(__T(__OP2(__EE11581805.UID,=,__CN(__PLexID_in))));
  SHARED __ST121021_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3617396_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3617416_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST81767_Layout) P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST82020_Layout) P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83648_Layout) P_L___Drg_Bk_Dt_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83670_Layout) P_L___Drg_Bk_Dt_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83692_Layout) P_L___Drg_Bk_Dt_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83931_Layout) P_L___Drg_Bk_Ch_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83961_Layout) P_L___Drg_Bk_Ch_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST83991_Layout) P_L___Drg_Bk_Ch_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST84790_Layout) P_L___Drg_Bk_Disp_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST84824_Layout) P_L___Drg_Bk_Disp_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST84858_Layout) P_L___Drg_Bk_Disp_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85398_Layout) P_L___Drg_Bk_Type_List1_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85435_Layout) P_L___Drg_Bk_Type_List7_Y_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85472_Layout) P_L___Drg_Bk_Type_List10_Y_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85841_Layout) P_L___Prof_Lic_Issue_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85849_Layout) P_L___Prof_Lic_Exp_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST85864_Layout) P_L___Prof_Lic_Indx_By_Lic_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88934_Layout) Crim_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88949_Layout) Banko_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88965_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST88982_Layout) L_T_D7_Y_List_;
  ...
  END;
  SHARED __ST121021_Layout __ND11586935__Project(B_Person(__in,__cfg_Local).__ST164582_Layout __PP11586931) := TRANSFORM
    SELF.Lex_I_D_ := __PP11586931.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP11586931.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    SELF := __PP11586931;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11586930,__ND11586935__Project(LEFT)));
