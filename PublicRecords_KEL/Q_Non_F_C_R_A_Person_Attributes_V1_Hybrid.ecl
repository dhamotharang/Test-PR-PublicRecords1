...
EXPORT Q_Non_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, KEL.typ.kdate __PRunDateToMimic, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE9639287 := __ENH_Person;
  SHARED __EE9644100 := __EE9639287(__T(__OP2(__EE9639287.UID,=,__CN(__PLexID_in))));
  SHARED __ST124027_Layout := RECORD
    KEL.typ.nuid Lex_I_D_;
    KEL.typ.str P___Lex_I_D_Seen_Flag_ := '';
    KEL.typ.nstr P___Lex_I_D_Category_;
    KEL.typ.int P_L___Ast_Veh_Auto_Cnt_Ev_ := 0;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3819198_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST3819218_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
  ...
  END;
  SHARED __ST124027_Layout __ND9644105__Project(B_Person(__in,__cfg_Local).__ST168221_Layout __PP9644101) := TRANSFORM
    SELF.Lex_I_D_ := __PP9644101.UID;
    SELF.P_L___Email_Cnt_Ev_ := __PP9644101.P_L___Email_Cnt_Ev_Non_F_C_R_A_;
    ...
    SELF := __PP9644101;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE9644100,__ND9644105__Project(LEFT)));
