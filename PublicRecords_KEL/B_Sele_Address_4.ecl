...
EXPORT B_Sele_Address_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE675951 := __ENH_Sele_Address_5;
  EXPORT __ST155782_Layout := RECORD
  ...
  END;
  EXPORT __ST155726_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST155782_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155726_Layout __ND676528__Project(B_Sele_Address_5(__in,__cfg).__ST160817_Layout __PP675637) := TRANSFORM
    __EE675830 := __PP675637.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE675830),__ST155782_Layout),__NL(__EE675830));
    SELF := __PP675637;
  END;
  EXPORT __ENH_Sele_Address_4 := PROJECT(__EE675951,__ND676528__Project(LEFT));
END;
