...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11778835 := __ENH_Property_1;
  EXPORT __ST177810_Layout := RECORD
  ...
  END;
  EXPORT __ST177792_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST177810_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177792_Layout __ND11778840__Project(B_Property_1(__in,__cfg).__ST312160_Layout __PP11778836) := TRANSFORM
    __EE11778880 := __PP11778836.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11778880),__ST177810_Layout),__NL(__EE11778880));
    SELF := __PP11778836;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11778835,__ND11778840__Project(LEFT));
END;
