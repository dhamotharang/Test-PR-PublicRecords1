...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11541354 := __ENH_Property_1;
  EXPORT __ST166232_Layout := RECORD
  ...
  END;
  EXPORT __ST166214_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST166232_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166214_Layout __ND11541359__Project(B_Property_1(__in,__cfg).__ST264441_Layout __PP11541355) := TRANSFORM
    __EE11541399 := __PP11541355.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11541399),__ST166232_Layout),__NL(__EE11541399));
    SELF := __PP11541355;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11541354,__ND11541359__Project(LEFT));
END;
