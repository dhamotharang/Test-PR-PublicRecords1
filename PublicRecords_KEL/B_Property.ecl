...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11399027 := __ENH_Property_1;
  EXPORT __ST173662_Layout := RECORD
  ...
  END;
  EXPORT __ST173644_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST173662_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST173644_Layout __ND11399032__Project(B_Property_1(__in,__cfg).__ST290568_Layout __PP11399028) := TRANSFORM
    __EE11399072 := __PP11399028.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11399072),__ST173662_Layout),__NL(__EE11399072));
    SELF := __PP11399028;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11399027,__ND11399032__Project(LEFT));
END;
