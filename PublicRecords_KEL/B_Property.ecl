...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11506340 := __ENH_Property_1;
  EXPORT __ST171356_Layout := RECORD
  ...
  END;
  EXPORT __ST171338_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST171356_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171338_Layout __ND11506345__Project(B_Property_1(__in,__cfg).__ST309478_Layout __PP11506341) := TRANSFORM
    __EE11506385 := __PP11506341.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11506385),__ST171356_Layout),__NL(__EE11506385));
    SELF := __PP11506341;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11506340,__ND11506345__Project(LEFT));
END;
