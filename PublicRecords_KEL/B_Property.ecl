...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE15032322 := __ENH_Property_1;
  EXPORT __ST184593_Layout := RECORD
  ...
  END;
  EXPORT __ST184575_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST184593_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184575_Layout __ND15032327__Project(B_Property_1(__in,__cfg).__ST348872_Layout __PP15032323) := TRANSFORM
    __EE15032367 := __PP15032323.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE15032367),__ST184593_Layout),__NL(__EE15032367));
    SELF := __PP15032323;
  END;
  EXPORT __ENH_Property := PROJECT(__EE15032322,__ND15032327__Project(LEFT));
END;
