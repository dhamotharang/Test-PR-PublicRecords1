...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11966407 := __ENH_Property_1;
  EXPORT __ST183318_Layout := RECORD
  ...
  END;
  EXPORT __ST183300_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST183318_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183300_Layout __ND11966412__Project(B_Property_1(__in,__cfg).__ST345537_Layout __PP11966408) := TRANSFORM
    __EE11966452 := __PP11966408.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11966452),__ST183318_Layout),__NL(__EE11966452));
    SELF := __PP11966408;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11966407,__ND11966412__Project(LEFT));
END;
