...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE13749739 := __ENH_Property_1;
  EXPORT __ST195209_Layout := RECORD
  ...
  END;
  EXPORT __ST195191_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST195209_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195191_Layout __ND13749744__Project(B_Property_1(__in,__cfg).__ST371997_Layout __PP13749740) := TRANSFORM
    __EE13749784 := __PP13749740.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE13749784),__ST195209_Layout),__NL(__EE13749784));
    SELF := __PP13749740;
  END;
  EXPORT __ENH_Property := PROJECT(__EE13749739,__ND13749744__Project(LEFT));
END;
