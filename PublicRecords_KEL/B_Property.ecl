...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12046727 := __ENH_Property_1;
  EXPORT __ST167175_Layout := RECORD
  ...
  END;
  EXPORT __ST167157_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST167175_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167157_Layout __ND12046732__Project(B_Property_1(__in,__cfg).__ST268326_Layout __PP12046728) := TRANSFORM
    __EE12046772 := __PP12046728.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE12046772),__ST167175_Layout),__NL(__EE12046772));
    SELF := __PP12046728;
  END;
  EXPORT __ENH_Property := PROJECT(__EE12046727,__ND12046732__Project(LEFT));
END;
