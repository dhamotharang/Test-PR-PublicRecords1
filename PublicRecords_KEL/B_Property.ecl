...
EXPORT B_Property(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11713302 := __ENH_Property_1;
  EXPORT __ST175422_Layout := RECORD
  ...
  END;
  EXPORT __ST175404_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST175422_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175404_Layout __ND11713307__Project(B_Property_1(__in,__cfg).__ST334474_Layout __PP11713303) := TRANSFORM
    __EE11713347 := __PP11713303.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE11713347),__ST175422_Layout),__NL(__EE11713347));
    SELF := __PP11713303;
  END;
  EXPORT __ENH_Property := PROJECT(__EE11713302,__ND11713307__Project(LEFT));
END;
