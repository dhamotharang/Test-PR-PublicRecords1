...
EXPORT B_Tradeline_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4970385 := __ENH_Tradeline_5;
  ...
  END;
  EXPORT __ST240617_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST240624_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST240617_Layout __ND4970320__Project(B_Tradeline_5(__in,__cfg).__ST246764_Layout __PP4969641) := TRANSFORM
    __EE4970388 := __PP4969641.Records_;
    __ST240624_Layout __ND4970256__Project(B_Tradeline_5(__in,__cfg).__ST246771_Layout __PP4969684) := TRANSFORM
      SELF.A_R_Date_Group_ := __FN3(KEL.Routines.DateFromParts,__FN1(KEL.Routines.Year,__PP4969684.A_R_Date_),__FN1(KEL.Routines.Month,__PP4969684.A_R_Date_),__CN(0));
      __EE4970243 := __PP4969641.Records_;
      __BS4970244 := __T(__EE4970243);
      __EE4970249 := __BS4970244(__T(__T(__EE4970243).Is1_Y_Record_));
      SELF.Is_Most_Recent_Active_Record1_Y_ := __AND(__PP4969641.Is_Active1_Y_,__OP2(__PP4969684.A_R_Date_,=,KEL.Aggregates.MaxN(__EE4970249,__EE4970249.A_R_Date_)));
      SELF.Total_A_R_L_N_ := __OP2(__OP2(__OP2(__OP2(__PP4969684.Current_A_R_L_N_,+,__PP4969684.Aging1_To30_L_N_),+,__PP4969684.Aging31_To60_L_N_),+,__PP4969684.Aging61_To90_L_N_),+,__PP4969684.Aging91_Plus_L_N_);
      SELF := __PP4969684;
    END;
    SELF.Records_ := __PROJECT(__EE4970388,__ND4970256__Project(LEFT));
    __CC41018 := 90;
    SELF.Is_Active_ := __OP2(__PP4969641.Newest_Record_Age_In_Days_,<=,__CN(__CC41018));
    SELF := __PP4969641;
  END;
  EXPORT __ENH_Tradeline_4 := PROJECT(__EE4970385,__ND4970320__Project(LEFT));
END;
