...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9544226 := __ENH_Person_Property_2;
  SHARED __EE9544229 := __ENH_Property_2;
  SHARED __ST3584135_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST227147_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC9544237(B_Person_Property_2(__in,__cfg).__ST226489_Layout __EE9544226, B_Property_2(__in,__cfg).__ST227129_Layout __EE9544229) := __EEQP(__EE9544226.Prop_,__EE9544229.UID);
  __ST3584135_Layout __JT9544237(B_Person_Property_2(__in,__cfg).__ST226489_Layout __l, B_Property_2(__in,__cfg).__ST227129_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE9544238 := JOIN(__EE9544226,__EE9544229,__JC9544237(LEFT,RIGHT),__JT9544237(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST207061_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207061_Layout __ND9544359__Project(__ST3584135_Layout __PP9544239) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP9544239.Is_Business_Address_ AND __PP9544239.Is_Ever_Owned_;
    SELF := __PP9544239;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE9544238,__ND9544359__Project(LEFT));
END;
