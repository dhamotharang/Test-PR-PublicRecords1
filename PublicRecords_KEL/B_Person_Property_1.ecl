...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9311775 := __ENH_Person_Property_2;
  SHARED __EE9311778 := __ENH_Property_2;
  SHARED __ST3492139_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST221275_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC9311786(B_Person_Property_2(__in,__cfg).__ST220617_Layout __EE9311775, B_Property_2(__in,__cfg).__ST221257_Layout __EE9311778) := __EEQP(__EE9311775.Prop_,__EE9311778.UID);
  __ST3492139_Layout __JT9311786(B_Person_Property_2(__in,__cfg).__ST220617_Layout __l, B_Property_2(__in,__cfg).__ST221257_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE9311787 := JOIN(__EE9311775,__EE9311778,__JC9311786(LEFT,RIGHT),__JT9311786(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST201499_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST201499_Layout __ND9311908__Project(__ST3492139_Layout __PP9311788) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP9311788.Is_Business_Address_ AND __PP9311788.Is_Ever_Owned_;
    SELF := __PP9311788;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE9311787,__ND9311908__Project(LEFT));
END;
