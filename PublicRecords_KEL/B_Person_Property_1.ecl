...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8513162 := __ENH_Person_Property_2;
  SHARED __EE8513165 := __ENH_Property_2;
  SHARED __ST3108194_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST215842_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC8513173(B_Person_Property_2(__in,__cfg).__ST215203_Layout __EE8513162, B_Property_2(__in,__cfg).__ST215824_Layout __EE8513165) := __EEQP(__EE8513162.Prop_,__EE8513165.UID);
  __ST3108194_Layout __JT8513173(B_Person_Property_2(__in,__cfg).__ST215203_Layout __l, B_Property_2(__in,__cfg).__ST215824_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE8513174 := JOIN(__EE8513162,__EE8513165,__JC8513173(LEFT,RIGHT),__JT8513173(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST196432_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST196432_Layout __ND8513290__Project(__ST3108194_Layout __PP8513175) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP8513175.Is_Business_Address_ AND __PP8513175.Is_Ever_Owned_;
    SELF := __PP8513175;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE8513174,__ND8513290__Project(LEFT));
END;
