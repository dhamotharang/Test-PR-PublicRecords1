...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10278936 := __ENH_Person_Property_2;
  SHARED __EE10278939 := __ENH_Property_2;
  SHARED __ST3852278_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST238261_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC10278947(B_Person_Property_2(__in,__cfg).__ST237603_Layout __EE10278936, B_Property_2(__in,__cfg).__ST238243_Layout __EE10278939) := __EEQP(__EE10278936.Prop_,__EE10278939.UID);
  __ST3852278_Layout __JT10278947(B_Person_Property_2(__in,__cfg).__ST237603_Layout __l, B_Property_2(__in,__cfg).__ST238243_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE10278948 := JOIN(__EE10278936,__EE10278939,__JC10278947(LEFT,RIGHT),__JT10278947(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST217044_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217044_Layout __ND10279069__Project(__ST3852278_Layout __PP10278949) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP10278949.Is_Business_Address_ AND __PP10278949.Is_Ever_Owned_;
    SELF := __PP10278949;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE10278948,__ND10279069__Project(LEFT));
END;
