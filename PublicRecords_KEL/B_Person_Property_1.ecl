...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8055074 := __ENH_Person_Property_2;
  SHARED __EE8055077 := __ENH_Property_2;
  SHARED __ST2869925_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST210883_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC8055085(B_Person_Property_2(__in,__cfg).__ST210207_Layout __EE8055074, B_Property_2(__in,__cfg).__ST210865_Layout __EE8055077) := __EEQP(__EE8055074.Prop_,__EE8055077.UID);
  __ST2869925_Layout __JT8055085(B_Person_Property_2(__in,__cfg).__ST210207_Layout __l, B_Property_2(__in,__cfg).__ST210865_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE8055086 := JOIN(__EE8055074,__EE8055077,__JC8055085(LEFT,RIGHT),__JT8055085(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST191718_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191718_Layout __ND8055190__Project(__ST2869925_Layout __PP8055087) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP8055087.Is_Business_Address_ AND __PP8055087.Is_Ever_Owned_;
    SELF := __PP8055087;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE8055086,__ND8055190__Project(LEFT));
END;
