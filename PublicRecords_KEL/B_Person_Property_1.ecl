...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8535891 := __ENH_Person_Property_2;
  SHARED __EE8535894 := __ENH_Property_2;
  SHARED __ST3119414_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST217243_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC8535902(B_Person_Property_2(__in,__cfg).__ST216604_Layout __EE8535891, B_Property_2(__in,__cfg).__ST217225_Layout __EE8535894) := __EEQP(__EE8535891.Prop_,__EE8535894.UID);
  __ST3119414_Layout __JT8535902(B_Person_Property_2(__in,__cfg).__ST216604_Layout __l, B_Property_2(__in,__cfg).__ST217225_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE8535903 := JOIN(__EE8535891,__EE8535894,__JC8535902(LEFT,RIGHT),__JT8535902(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST197808_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197808_Layout __ND8536019__Project(__ST3119414_Layout __PP8535904) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP8535904.Is_Business_Address_ AND __PP8535904.Is_Ever_Owned_;
    SELF := __PP8535904;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE8535903,__ND8536019__Project(LEFT));
END;
