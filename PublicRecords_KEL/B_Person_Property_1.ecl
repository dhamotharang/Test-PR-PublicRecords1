...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9679713 := __ENH_Person_Property_2;
  SHARED __EE9679716 := __ENH_Property_2;
  SHARED __ST3564097_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST231010_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC9679724(B_Person_Property_2(__in,__cfg).__ST230352_Layout __EE9679713, B_Property_2(__in,__cfg).__ST230992_Layout __EE9679716) := __EEQP(__EE9679713.Prop_,__EE9679716.UID);
  __ST3564097_Layout __JT9679724(B_Person_Property_2(__in,__cfg).__ST230352_Layout __l, B_Property_2(__in,__cfg).__ST230992_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE9679725 := JOIN(__EE9679713,__EE9679716,__JC9679724(LEFT,RIGHT),__JT9679724(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST211070_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211070_Layout __ND9679846__Project(__ST3564097_Layout __PP9679726) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP9679726.Is_Business_Address_ AND __PP9679726.Is_Ever_Owned_;
    SELF := __PP9679726;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE9679725,__ND9679846__Project(LEFT));
END;
