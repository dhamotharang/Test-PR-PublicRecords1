...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8444800 := __ENH_Person_Property_2;
  SHARED __EE8444803 := __ENH_Property_2;
  SHARED __ST3007045_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST218548_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC8444811(B_Person_Property_2(__in,__cfg).__ST217904_Layout __EE8444800, B_Property_2(__in,__cfg).__ST218530_Layout __EE8444803) := __EEQP(__EE8444800.Prop_,__EE8444803.UID);
  __ST3007045_Layout __JT8444811(B_Person_Property_2(__in,__cfg).__ST217904_Layout __l, B_Property_2(__in,__cfg).__ST218530_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE8444812 := JOIN(__EE8444800,__EE8444803,__JC8444811(LEFT,RIGHT),__JT8444811(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST199037_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST199037_Layout __ND8444928__Project(__ST3007045_Layout __PP8444813) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP8444813.Is_Business_Address_ AND __PP8444813.Is_Ever_Owned_;
    SELF := __PP8444813;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE8444812,__ND8444928__Project(LEFT));
END;
