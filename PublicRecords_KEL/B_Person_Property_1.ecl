...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9405111 := __ENH_Person_Property_2;
  SHARED __EE9405114 := __ENH_Property_2;
  SHARED __ST3534512_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST224265_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC9405122(B_Person_Property_2(__in,__cfg).__ST223607_Layout __EE9405111, B_Property_2(__in,__cfg).__ST224247_Layout __EE9405114) := __EEQP(__EE9405111.Prop_,__EE9405114.UID);
  __ST3534512_Layout __JT9405122(B_Person_Property_2(__in,__cfg).__ST223607_Layout __l, B_Property_2(__in,__cfg).__ST224247_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE9405123 := JOIN(__EE9405111,__EE9405114,__JC9405122(LEFT,RIGHT),__JT9405122(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST204291_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST204291_Layout __ND9405244__Project(__ST3534512_Layout __PP9405124) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP9405124.Is_Business_Address_ AND __PP9405124.Is_Ever_Owned_;
    SELF := __PP9405124;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE9405123,__ND9405244__Project(LEFT));
END;
