...
EXPORT B_Person_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9706869 := __ENH_Person_Property_2;
  SHARED __EE9706872 := __ENH_Property_2;
  SHARED __ST3559936_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Property_2(__in,__cfg).__ST230957_Layout) Automated_Valuation_Model_;
  ...
  END;
  __JC9706880(B_Person_Property_2(__in,__cfg).__ST230299_Layout __EE9706869, B_Property_2(__in,__cfg).__ST230939_Layout __EE9706872) := __EEQP(__EE9706869.Prop_,__EE9706872.UID);
  __ST3559936_Layout __JT9706880(B_Person_Property_2(__in,__cfg).__ST230299_Layout __l, B_Property_2(__in,__cfg).__ST230939_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE9706881 := JOIN(__EE9706869,__EE9706872,__JC9706880(LEFT,RIGHT),__JT9706880(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST211030_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211030_Layout __ND9707002__Project(__ST3559936_Layout __PP9706882) := TRANSFORM
    SELF.Is_Ever_Owned_Business_Address_ := __PP9706882.Is_Business_Address_ AND __PP9706882.Is_Ever_Owned_;
    SELF := __PP9706882;
  END;
  EXPORT __ENH_Person_Property_1 := PROJECT(__EE9706881,__ND9707002__Project(LEFT));
END;
