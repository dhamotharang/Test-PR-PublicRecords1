...
EXPORT E_Inquiry(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping3 := 'UID(DEFAULT:UID),search_info.transaction_id(OVERRIDE:Transaction_I_D_:\'\'),search_info.sequence_number(OVERRIDE:Sequence_Number_:\'\'),search_info.method(OVERRIDE:Method_:\'\'),search_info.product_code(OVERRIDE:Product_Code_:0),search_info.function_description(OVERRIDE:Function_Description_:\'\'),permissions.glb_purpose(OVERRIDE:G_L_B_Purpose_:0),permissions.dppa_purpose(OVERRIDE:D_P_P_A_Purpose_:0),permissions.fcra_purpose(OVERRIDE:F_C_R_A_Purpose_:0),bus_intel.primary_market_code(OVERRIDE:Primary_Market_Code_:\'\'),bus_intel.secondary_market_code(OVERRIDE:Secondary_Market_Code_:\'\'),bus_intel.industry_1_code(OVERRIDE:Industry_Code1_:\'\'),bus_intel.industry_2_code(OVERRIDE:Industry_Code2_:\'\'),bus_intel.sub_market(OVERRIDE:Sub_Market_:\'\'),bus_intel.vertical(OVERRIDE:Vertical_:\'\'),bus_intel.industry(OVERRIDE:Industry_:\'\'),fraudpointscore(DEFAULT:Fraudpoint_Score_:0),person_q.fname(OVERRIDE:First_Name_:\'\'),person_q.lname(OVERRIDE:Last_Name_:\'\'),person_q.dob(OVERRIDE:Date_Of_Birth_:DATE),person_q.appended_adl(OVERRIDE:Lex_I_D_:0),person_q.prim_range(OVERRIDE:Primary_Range_:\'\'),person_q.predir(OVERRIDE:Predirectional_:\'\'),person_q.prim_name(OVERRIDE:Primary_Name_:\'\'),person_q.addr_suffix(OVERRIDE:Suffix_:\'\'),person_q.postdir(OVERRIDE:Postdirectional_:\'\'),person_q.sec_range(OVERRIDE:Secondary_Range_:\'\'),person_q.zip5(OVERRIDE:Z_I_P5_:\'\'),ssn(OVERRIDE:S_S_N_:\'\'),person_q.personal_phone(OVERRIDE:Personal_Phone_Number_:0),person_q.work_phone(OVERRIDE:Work_Phone_Number_:0),person_q.email_address(OVERRIDE:Email_Address_:\'\'),companyname(DEFAULT:Company_Name_:\'\'),companyphone(DEFAULT:Company_Phone_:\'\'),tin(DEFAULT:T_I_N_:0),ultid(DEFAULT:Ult_I_D_:0),orgid(DEFAULT:Org_I_D_:0),seleid(DEFAULT:Sele_I_D_:0),src(OVERRIDE:Source_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),dateofinquiry(OVERRIDE:Date_First_Seen_:EPOCH|OVERRIDE:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  SHARED __Mapping9 := 'UID(DEFAULT:UID),search_info.transaction_id(OVERRIDE:Transaction_I_D_:\'\'),search_info.sequence_number(OVERRIDE:Sequence_Number_:\'\'),search_info.method(OVERRIDE:Method_:\'\'),search_info.product_code(OVERRIDE:Product_Code_:0),search_info.function_description(OVERRIDE:Function_Description_:\'\'),permissions.glb_purpose(OVERRIDE:G_L_B_Purpose_:0),permissions.dppa_purpose(OVERRIDE:D_P_P_A_Purpose_:0),permissions.fcra_purpose(OVERRIDE:F_C_R_A_Purpose_:0),bus_intel.primary_market_code(OVERRIDE:Primary_Market_Code_:\'\'),bus_intel.secondary_market_code(OVERRIDE:Secondary_Market_Code_:\'\'),bus_intel.industry_1_code(OVERRIDE:Industry_Code1_:\'\'),bus_intel.industry_2_code(OVERRIDE:Industry_Code2_:\'\'),bus_intel.sub_market(OVERRIDE:Sub_Market_:\'\'),bus_intel.vertical(OVERRIDE:Vertical_:\'\'),bus_intel.industry(OVERRIDE:Industry_:\'\'),fraudpointscore(DEFAULT:Fraudpoint_Score_:0),bususer_q.fname(OVERRIDE:First_Name_:\'\'),bususer_q.lname(OVERRIDE:Last_Name_:\'\'),bususer_q.dob(OVERRIDE:Date_Of_Birth_:DATE),bususer_q.appended_adl(OVERRIDE:Lex_I_D_:0),bus_q.prim_range(OVERRIDE:Primary_Range_:\'\'),bus_q.predir(OVERRIDE:Predirectional_:\'\'),bus_q.prim_name(OVERRIDE:Primary_Name_:\'\'),bus_q.addr_suffix(OVERRIDE:Suffix_:\'\'),bus_q.postdir(OVERRIDE:Postdirectional_:\'\'),bus_q.sec_range(OVERRIDE:Secondary_Range_:\'\'),bus_q.zip5(OVERRIDE:Z_I_P5_:\'\'),bususer_q.appended_ssn(OVERRIDE:S_S_N_:\'\'),bususer_q.personal_phone(OVERRIDE:Personal_Phone_Number_:0),workphonenumber(DEFAULT:Work_Phone_Number_:0),emailaddress(DEFAULT:Email_Address_:\'\'),bus_q.cname(OVERRIDE:Company_Name_:\'\'),bus_q.company_phone(OVERRIDE:Company_Phone_:\'\'),appended_ein(OVERRIDE:T_I_N_:0),ultid(DEFAULT:Ult_I_D_:0),orgid(DEFAULT:Org_I_D_:0),seleid(DEFAULT:Sele_I_D_:0),src(OVERRIDE:Source_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),dateofinquiry(OVERRIDE:Date_First_Seen_:EPOCH|OVERRIDE:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  Layout Inquiry__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Search_Info_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Method_,Product_Code_,Function_Description_},Method_,Product_Code_,Function_Description_),Search_Info_Layout)(__NN(Method_) OR __NN(Product_Code_) OR __NN(Function_Description_)));
    SELF.Permissions_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),G_L_B_Purpose_,D_P_P_A_Purpose_,F_C_R_A_Purpose_},G_L_B_Purpose_,D_P_P_A_Purpose_,F_C_R_A_Purpose_),Permissions_Layout)(__NN(G_L_B_Purpose_) OR __NN(D_P_P_A_Purpose_) OR __NN(F_C_R_A_Purpose_)));
    SELF.Bus_Intel_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Primary_Market_Code_,Secondary_Market_Code_,Industry_Code1_,Industry_Code2_,Sub_Market_,Vertical_,Industry_},Primary_Market_Code_,Secondary_Market_Code_,Industry_Code1_,Industry_Code2_,Sub_Market_,Vertical_,Industry_),Bus_Intel_Layout)(__NN(Primary_Market_Code_) OR __NN(Secondary_Market_Code_) OR __NN(Industry_Code1_) OR __NN(Industry_Code2_) OR __NN(Sub_Market_) OR __NN(Vertical_) OR __NN(Industry_)));
    SELF.Person_Info_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Lex_I_D_,First_Name_,Last_Name_,Date_Of_Birth_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Z_I_P5_,Secondary_Range_,S_S_N_,Personal_Phone_Number_,Work_Phone_Number_,Email_Address_},Lex_I_D_,First_Name_,Last_Name_,Date_Of_Birth_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Z_I_P5_,Secondary_Range_,S_S_N_,Personal_Phone_Number_,Work_Phone_Number_,Email_Address_),Person_Info_Layout)(__NN(Lex_I_D_) OR __NN(First_Name_) OR __NN(Last_Name_) OR __NN(Date_Of_Birth_) OR __NN(Primary_Range_) OR __NN(Predirectional_) OR __NN(Primary_Name_) OR __NN(Suffix_) OR __NN(Postdirectional_) OR __NN(Z_I_P5_) OR __NN(Secondary_Range_) OR __NN(S_S_N_) OR __NN(Personal_Phone_Number_) OR __NN(Work_Phone_Number_) OR __NN(Email_Address_)));
    SELF.Business_Info_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Ult_I_D_,Org_I_D_,Sele_I_D_,Company_Name_,Company_Phone_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Z_I_P5_,Secondary_Range_,T_I_N_},Ult_I_D_,Org_I_D_,Sele_I_D_,Company_Name_,Company_Phone_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Z_I_P5_,Secondary_Range_,T_I_N_),Business_Info_Layout)(__NN(Ult_I_D_) OR __NN(Org_I_D_) OR __NN(Sele_I_D_) OR __NN(Company_Name_) OR __NN(Company_Phone_) OR __NN(Primary_Range_) OR __NN(Predirectional_) OR __NN(Primary_Name_) OR __NN(Suffix_) OR __NN(Postdirectional_) OR __NN(Z_I_P5_) OR __NN(Secondary_Range_) OR __NN(T_I_N_)));
  ...
  Layout Inquiry__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Search_Info_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Search_Info_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Method_) OR __NN(Product_Code_) OR __NN(Function_Description_)));
    SELF.Permissions_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Permissions_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(G_L_B_Purpose_) OR __NN(D_P_P_A_Purpose_) OR __NN(F_C_R_A_Purpose_)));
    SELF.Bus_Intel_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Bus_Intel_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Primary_Market_Code_) OR __NN(Secondary_Market_Code_) OR __NN(Industry_Code1_) OR __NN(Industry_Code2_) OR __NN(Sub_Market_) OR __NN(Vertical_) OR __NN(Industry_)));
    SELF.Person_Info_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Person_Info_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Lex_I_D_) OR __NN(First_Name_) OR __NN(Last_Name_) OR __NN(Date_Of_Birth_) OR __NN(Primary_Range_) OR __NN(Predirectional_) OR __NN(Primary_Name_) OR __NN(Suffix_) OR __NN(Postdirectional_) OR __NN(Z_I_P5_) OR __NN(Secondary_Range_) OR __NN(S_S_N_) OR __NN(Personal_Phone_Number_) OR __NN(Work_Phone_Number_) OR __NN(Email_Address_)));
    SELF.Business_Info_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Business_Info_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Ult_I_D_) OR __NN(Org_I_D_) OR __NN(Sele_I_D_) OR __NN(Company_Name_) OR __NN(Company_Phone_) OR __NN(Primary_Range_) OR __NN(Predirectional_) OR __NN(Primary_Name_) OR __NN(Suffix_) OR __NN(Postdirectional_) OR __NN(Z_I_P5_) OR __NN(Secondary_Range_) OR __NN(T_I_N_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d0(__NL(S_S_N_))),COUNT(__d0(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d0(Vault_Date_First_Seen_=0)),COUNT(__d0(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d1(__NL(S_S_N_))),COUNT(__d1(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d1(Date_Vendor_First_Reported_=0)),COUNT(__d1(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d1(Date_Vendor_Last_Reported_=0)),COUNT(__d1(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d1(Vault_Date_First_Seen_=0)),COUNT(__d1(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d2(__NL(S_S_N_))),COUNT(__d2(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d2(Date_Vendor_First_Reported_=0)),COUNT(__d2(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d2(Date_Vendor_Last_Reported_=0)),COUNT(__d2(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d2(Vault_Date_First_Seen_=0)),COUNT(__d2(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d3(Date_Vendor_First_Reported_=0)),COUNT(__d3(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d3(Date_Vendor_Last_Reported_=0)),COUNT(__d3(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d3(Vault_Date_First_Seen_=0)),COUNT(__d3(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d4(Date_Vendor_First_Reported_=0)),COUNT(__d4(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d4(Date_Vendor_Last_Reported_=0)),COUNT(__d4(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d4(Vault_Date_First_Seen_=0)),COUNT(__d4(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d5(__NL(S_S_N_))),COUNT(__d5(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d5(Date_Vendor_First_Reported_=0)),COUNT(__d5(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d5(Date_Vendor_Last_Reported_=0)),COUNT(__d5(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d5(Vault_Date_First_Seen_=0)),COUNT(__d5(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d6(__NL(S_S_N_))),COUNT(__d6(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d6(Date_Vendor_First_Reported_=0)),COUNT(__d6(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d6(Date_Vendor_Last_Reported_=0)),COUNT(__d6(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d6(Vault_Date_First_Seen_=0)),COUNT(__d6(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d7(__NL(S_S_N_))),COUNT(__d7(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d7(Date_Vendor_First_Reported_=0)),COUNT(__d7(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d7(Date_Vendor_Last_Reported_=0)),COUNT(__d7(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d7(Vault_Date_First_Seen_=0)),COUNT(__d7(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.appended_ssn',COUNT(__d8(__NL(S_S_N_))),COUNT(__d8(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d8(Date_Vendor_First_Reported_=0)),COUNT(__d8(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d8(Date_Vendor_Last_Reported_=0)),COUNT(__d8(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d8(Vault_Date_First_Seen_=0)),COUNT(__d8(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','bususer_q.appended_ssn',COUNT(__d9(__NL(S_S_N_))),COUNT(__d9(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d9(Date_Vendor_First_Reported_=0)),COUNT(__d9(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d9(Date_Vendor_Last_Reported_=0)),COUNT(__d9(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d9(Vault_Date_First_Seen_=0)),COUNT(__d9(Vault_Date_First_Seen_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','bususer_q.appended_ssn',COUNT(__d10(__NL(S_S_N_))),COUNT(__d10(__NN(S_S_N_)))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d10(Date_Vendor_First_Reported_=0)),COUNT(__d10(Date_Vendor_First_Reported_!=0))},
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d10(Date_Vendor_Last_Reported_=0)),COUNT(__d10(Date_Vendor_Last_Reported_!=0))},
    ...
    {'Inquiry','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d10(Vault_Date_First_Seen_=0)),COUNT(__d10(Vault_Date_First_Seen_!=0))},
