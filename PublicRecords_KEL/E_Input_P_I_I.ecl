...
IMPORT KEL12 AS KEL;
IMPORT CFG_Compile,E_Geo_Link,E_Person,E_Surname FROM PublicRecords_KEL;
...
EXPORT E_Input_P_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  Layout Input_P_I_I__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.P___Inp_Cln_Addr_Property_U_I_D_ := KEL.Intake.SingleValue(__recs,P___Inp_Cln_Addr_Property_U_I_D_);
  ...
  EXPORT P___Inp_Cln_Addr_Property_U_I_D__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,P___Inp_Cln_Addr_Property_U_I_D_);
  ...
  EXPORT P___Inp_Cln_Addr_State_Code__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,P___Inp_Cln_Addr_State_Code_);
  ...
  EXPORT Geo_Link_I_D__SingleValue_Invalid := KEL.Intake.DetectMultipleValues(__PreResult,Geo_Link_I_D_);
