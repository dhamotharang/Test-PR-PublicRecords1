...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8214471 := __ENH_Sele_Address_3;
  EXPORT __ST227940_Layout := RECORD
  ...
  END;
  EXPORT __ST227884_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST227940_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST227884_Layout __ND8214476__Project(B_Sele_Address_3(__in,__cfg).__ST242991_Layout __PP8214472) := TRANSFORM
    __EE8214567 := __PP8214472.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8214567),__ST227940_Layout),__NL(__EE8214567));
    SELF := __PP8214472;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE8214471,__ND8214476__Project(LEFT));
END;
