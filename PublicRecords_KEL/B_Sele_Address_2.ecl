...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7537944 := __ENH_Sele_Address_3;
  EXPORT __ST217517_Layout := RECORD
  ...
  END;
  EXPORT __ST217461_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST217517_Layout) Data_Sources_;
    KEL.typ.nbool Input_Address_Match_;
    KEL.typ.nbool Matches_Is_Best_Helper_Attr_;
    KEL.typ.ndataset(B_Sele_Address_3(__in,__cfg).__ST1180276_Layout) Rolled_Source_List_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217461_Layout __ND7537949__Project(B_Sele_Address_3(__in,__cfg).__ST232028_Layout __PP7537945) := TRANSFORM
    __EE7538040 := __PP7537945.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7538040),__ST217517_Layout),__NL(__EE7538040));
    SELF := __PP7537945;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7537944,__ND7537949__Project(LEFT));
END;
