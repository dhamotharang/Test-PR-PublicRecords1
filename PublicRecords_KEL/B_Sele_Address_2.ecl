...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7197823 := __ENH_Sele_Address_3;
  EXPORT __ST210611_Layout := RECORD
  ...
  END;
  EXPORT __ST210555_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST210611_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210555_Layout __ND7197828__Project(B_Sele_Address_3(__in,__cfg).__ST224902_Layout __PP7197824) := TRANSFORM
    __EE7197919 := __PP7197824.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7197919),__ST210611_Layout),__NL(__EE7197919));
    SELF := __PP7197824;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7197823,__ND7197828__Project(LEFT));
END;
