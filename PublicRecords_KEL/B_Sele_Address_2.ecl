...
EXPORT B_Sele_Address_2(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7721438 := __ENH_Sele_Address_3;
  EXPORT __ST217966_Layout := RECORD
  ...
  END;
  EXPORT __ST217910_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST217966_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217910_Layout __ND7721443__Project(B_Sele_Address_3(__cfg).__ST232566_Layout __PP7721439) := TRANSFORM
    __EE7721534 := __PP7721439.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7721534),__ST217966_Layout),__NL(__EE7721534));
    SELF := __PP7721439;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7721438,__ND7721443__Project(LEFT));
END;
