...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7321584 := __ENH_Sele_Address_3;
  EXPORT __ST211656_Layout := RECORD
  ...
  END;
  EXPORT __ST211600_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211656_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211600_Layout __ND7321589__Project(B_Sele_Address_3(__in,__cfg).__ST225950_Layout __PP7321585) := TRANSFORM
    __EE7321680 := __PP7321585.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7321680),__ST211656_Layout),__NL(__EE7321680));
    SELF := __PP7321585;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7321584,__ND7321589__Project(LEFT));
END;
