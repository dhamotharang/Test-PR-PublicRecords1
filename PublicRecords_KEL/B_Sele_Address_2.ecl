...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7745910 := __ENH_Sele_Address_3;
  ...
  END;
  EXPORT __ST217968_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218024_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST217968_Layout __ND7745915__Project(B_Sele_Address_3(__in,__cfg).__ST232612_Layout __PP7745911) := TRANSFORM
    __EE7746006 := __PP7745911.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7746006),__ST218024_Layout),__NL(__EE7746006));
    SELF := __PP7745911;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7745910,__ND7745915__Project(LEFT));
END;
