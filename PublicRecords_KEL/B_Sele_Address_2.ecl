...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7206880 := __ENH_Sele_Address_3;
  ...
  END;
  EXPORT __ST211101_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211157_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211101_Layout __ND7206885__Project(B_Sele_Address_3(__in,__cfg).__ST225424_Layout __PP7206881) := TRANSFORM
    __EE7206976 := __PP7206881.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7206976),__ST211157_Layout),__NL(__EE7206976));
    SELF := __PP7206881;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7206880,__ND7206885__Project(LEFT));
END;
