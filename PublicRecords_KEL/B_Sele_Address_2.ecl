...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7206875 := __ENH_Sele_Address_3;
  EXPORT __ST211152_Layout := RECORD
  ...
  END;
  EXPORT __ST211096_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211152_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211096_Layout __ND7206880__Project(B_Sele_Address_3(__in,__cfg).__ST225419_Layout __PP7206876) := TRANSFORM
    __EE7206971 := __PP7206876.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7206971),__ST211152_Layout),__NL(__EE7206971));
    SELF := __PP7206876;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7206875,__ND7206880__Project(LEFT));
END;
