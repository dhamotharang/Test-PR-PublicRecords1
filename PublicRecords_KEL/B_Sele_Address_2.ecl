...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7718825 := __ENH_Sele_Address_3;
  EXPORT __ST216623_Layout := RECORD
  ...
  END;
  EXPORT __ST216567_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST216623_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216567_Layout __ND7718830__Project(B_Sele_Address_3(__in,__cfg).__ST231210_Layout __PP7718826) := TRANSFORM
    __EE7718921 := __PP7718826.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7718921),__ST216623_Layout),__NL(__EE7718921));
    SELF := __PP7718826;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7718825,__ND7718830__Project(LEFT));
END;
