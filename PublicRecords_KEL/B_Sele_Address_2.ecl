...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8281735 := __ENH_Sele_Address_3;
  EXPORT __ST231750_Layout := RECORD
  ...
  END;
  EXPORT __ST231694_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST231750_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231694_Layout __ND8281740__Project(B_Sele_Address_3(__in,__cfg).__ST246803_Layout __PP8281736) := TRANSFORM
    __EE8281831 := __PP8281736.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8281831),__ST231750_Layout),__NL(__EE8281831));
    SELF := __PP8281736;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE8281735,__ND8281740__Project(LEFT));
END;
