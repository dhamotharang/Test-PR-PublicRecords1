...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8001245 := __ENH_Sele_Address_3;
  EXPORT __ST222068_Layout := RECORD
  ...
  EXPORT __ST222012_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST222068_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST222012_Layout __ND8001250__Project(B_Sele_Address_3(__in,__cfg).__ST237009_Layout __PP8001246) := TRANSFORM
    __EE8001341 := __PP8001246.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8001341),__ST222068_Layout),__NL(__EE8001341));
    SELF := __PP8001246;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE8001245,__ND8001250__Project(LEFT));
END;
