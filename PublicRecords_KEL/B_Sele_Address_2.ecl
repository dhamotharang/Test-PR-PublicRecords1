...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8068183 := __ENH_Sele_Address_3;
  EXPORT __ST228954_Layout := RECORD
  ...
  END;
  EXPORT __ST228898_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST228954_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST228898_Layout __ND8068188__Project(B_Sele_Address_3(__in,__cfg).__ST243869_Layout __PP8068184) := TRANSFORM
    __EE8068279 := __PP8068184.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8068279),__ST228954_Layout),__NL(__EE8068279));
    SELF := __PP8068184;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE8068183,__ND8068188__Project(LEFT));
END;
