...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7205777 := __ENH_Sele_Address_3;
  EXPORT __ST211132_Layout := RECORD
  ...
  END;
  EXPORT __ST211076_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST211132_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211076_Layout __ND7205782__Project(B_Sele_Address_3(__in,__cfg).__ST225399_Layout __PP7205778) := TRANSFORM
    __EE7205873 := __PP7205778.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7205873),__ST211132_Layout),__NL(__EE7205873));
    SELF := __PP7205778;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7205777,__ND7205782__Project(LEFT));
END;
