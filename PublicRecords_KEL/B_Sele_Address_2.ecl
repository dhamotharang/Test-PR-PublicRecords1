...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7204487 := __ENH_Sele_Address_3;
  EXPORT __ST210477_Layout := RECORD
  ...
  END;
  EXPORT __ST210421_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST210477_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210421_Layout __ND7204492__Project(B_Sele_Address_3(__in,__cfg).__ST224744_Layout __PP7204488) := TRANSFORM
    __EE7204583 := __PP7204488.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7204583),__ST210477_Layout),__NL(__EE7204583));
    SELF := __PP7204488;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE7204487,__ND7204492__Project(LEFT));
END;
