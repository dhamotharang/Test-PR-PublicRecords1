...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8085052 := __ENH_Sele_Address_3;
  EXPORT __ST225058_Layout := RECORD
  ...
  END;
  EXPORT __ST225002_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST225058_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225002_Layout __ND8085057__Project(B_Sele_Address_3(__in,__cfg).__ST240105_Layout __PP8085053) := TRANSFORM
    __EE8085148 := __PP8085053.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8085148),__ST225058_Layout),__NL(__EE8085148));
    SELF := __PP8085053;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE8085052,__ND8085057__Project(LEFT));
END;
