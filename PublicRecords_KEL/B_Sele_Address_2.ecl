...
EXPORT B_Sele_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6915035 := __ENH_Sele_Address_3;
  EXPORT __ST215028_Layout := RECORD
  ...
  EXPORT __ST214972_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST215028_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST214972_Layout __ND6915040__Project(B_Sele_Address_3(__in,__cfg).__ST229257_Layout __PP6915036) := TRANSFORM
    __EE6915131 := __PP6915036.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6915131),__ST215028_Layout),__NL(__EE6915131));
    SELF := __PP6915036;
  END;
  EXPORT __ENH_Sele_Address_2 := PROJECT(__EE6915035,__ND6915040__Project(LEFT));
END;
