...
EXPORT B_Watercraft_Owner_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1290470 := __E_Watercraft_Owner;
  EXPORT __ST246311_Layout := RECORD
  ...
  END;
  SHARED __ST246311_Layout __ND1290479__Project(E_Watercraft_Owner(__in,__cfg).Layout __PP1290423) := TRANSFORM
    ...
    SELF.Date_First_Seen_Capped_ := IF(__T(__OP2(KEL.era.ToDate(__PP1290423.Date_First_Seen_),>,__CC13362)),__ECAST(KEL.typ.nkdate,__CC13362),__ECAST(KEL.typ.nkdate,KEL.era.ToDate(__PP1290423.Date_First_Seen_)));
    SELF := __PP1290423;
  END;
  EXPORT __ENH_Watercraft_Owner_3 := PROJECT(__EE1290470,__ND1290479__Project(LEFT));
END;
