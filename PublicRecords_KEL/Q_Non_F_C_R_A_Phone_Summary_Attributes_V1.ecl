...
IMPORT B_Input_P_I_I_3,B_Input_P_I_I_4,B_Input_P_I_I_5,B_Input_P_I_I_6,B_Input_P_I_I_7,B_Input_P_I_I_8,B_Input_P_I_I_9,B_Phone_Summary,B_Phone_Summary_1,B_Phone_Summary_2,B_Phone_Summary_3,B_Phone_Summary_4,B_Phone_Summary_5,B_Property_4,B_Property_5,CFG_Compile,E_Address,E_Geo_Link,E_Input_P_I_I,E_Person,E_Phone_Summary,E_Property,E_Surname,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT Q_Non_F_C_R_A_Phone_Summary_Attributes_V1(KEL.typ.str __PPhone, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE6200171 := __ENH_Phone_Summary;
  SHARED __EE6200200 := __EE6200171(__T(__OP2(__EE6200171.Phone10_,=,__CN(__PPhone))));
  SHARED __ST56759_Layout := RECORD
