...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5548085 := __ENH_Criminal_Offense_7;
  ...
  END;
  EXPORT __ST260347_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST260394_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260347_Layout __ND5548463__Project(B_Criminal_Offense_7(__in,__cfg).__ST264596_Layout __PP5548086) := TRANSFORM
    __EE5548246 := __PP5548086.Offense_Charges_;
    __ST260394_Layout __ND5548450__Project(B_Criminal_Offense_7(__in,__cfg).__ST264643_Layout __PP5548247) := TRANSFORM
      __CC13837 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP5548247.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP5548247.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13837)));
      SELF := __PP5548247;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE5548246,__ND5548450__Project(LEFT));
    SELF := __PP5548086;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE5548085,__ND5548463__Project(LEFT));
END;
