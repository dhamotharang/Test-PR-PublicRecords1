...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5674781 := __ENH_Criminal_Offense_7;
  EXPORT __ST263280_Layout := RECORD
  ...
  END;
  EXPORT __ST263233_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST263280_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263233_Layout __ND5675159__Project(B_Criminal_Offense_7(__in,__cfg).__ST267482_Layout __PP5674782) := TRANSFORM
    __EE5674942 := __PP5674782.Offense_Charges_;
    __ST263280_Layout __ND5675146__Project(B_Criminal_Offense_7(__in,__cfg).__ST267529_Layout __PP5674943) := TRANSFORM
      __CC13800 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP5674943.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP5674943.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13800)));
      SELF := __PP5674943;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE5674942,__ND5675146__Project(LEFT));
    SELF := __PP5674782;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE5674781,__ND5675159__Project(LEFT));
END;
