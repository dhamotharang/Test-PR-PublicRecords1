...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5527718 := __ENH_Criminal_Offense_7;
  EXPORT __ST260092_Layout := RECORD
  ...
  END;
  EXPORT __ST260045_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST260092_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260045_Layout __ND5528096__Project(B_Criminal_Offense_7(__in,__cfg).__ST264294_Layout __PP5527719) := TRANSFORM
    __EE5527879 := __PP5527719.Offense_Charges_;
    __ST260092_Layout __ND5528083__Project(B_Criminal_Offense_7(__in,__cfg).__ST264341_Layout __PP5527880) := TRANSFORM
      __CC13837 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP5527880.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP5527880.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13837)));
      SELF := __PP5527880;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE5527879,__ND5528083__Project(LEFT));
    SELF := __PP5527719;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE5527718,__ND5528096__Project(LEFT));
END;
