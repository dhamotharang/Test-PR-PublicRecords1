...
EXPORT B_Person_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6549899 := __ENH_Person_Property_4;
  SHARED __EE6549902 := __ENH_Property_4;
  SHARED __ST1216486_Layout := RECORD
  ...
  END;
  __JC6549910(B_Person_Property_4(__in,__cfg).__ST242750_Layout __EE6549899, B_Property_4(__in,__cfg).__ST243138_Layout __EE6549902) := __EEQP(__EE6549899.Prop_,__EE6549902.UID);
  __ST1216486_Layout __JT6549910(B_Person_Property_4(__in,__cfg).__ST242750_Layout __l, B_Property_4(__in,__cfg).__ST243138_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE6549911 := JOIN(__EE6549899,__EE6549902,__JC6549910(LEFT,RIGHT),__JT6549910(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST231442_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST231442_Layout __ND6550013__Project(__ST1216486_Layout __PP6549912) := TRANSFORM
    SELF.Is_Currently_Owned_Business_Address_ := __PP6549912.Is_Business_Address_ AND __PP6549912.Is_Currently_Owned_;
    SELF := __PP6549912;
  END;
  EXPORT __ENH_Person_Property_3 := PROJECT(__EE6549911,__ND6550013__Project(LEFT));
END;
