...
EXPORT B_Person_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6386954 := __ENH_Person_Property_4;
  SHARED __EE6386957 := __ENH_Property_4;
  SHARED __ST1173447_Layout := RECORD
  ...
  END;
  __JC6386965(B_Person_Property_4(__in,__cfg).__ST242051_Layout __EE6386954, B_Property_4(__in,__cfg).__ST242410_Layout __EE6386957) := __EEQP(__EE6386954.Prop_,__EE6386957.UID);
  __ST1173447_Layout __JT6386965(B_Person_Property_4(__in,__cfg).__ST242051_Layout __l, B_Property_4(__in,__cfg).__ST242410_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE6386966 := JOIN(__EE6386954,__EE6386957,__JC6386965(LEFT,RIGHT),__JT6386965(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST230887_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Property().Typ) Prop_;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST230887_Layout __ND6387068__Project(__ST1173447_Layout __PP6386967) := TRANSFORM
    SELF.Is_Currently_Owned_Business_Address_ := __PP6386967.Is_Business_Address_ AND __PP6386967.Is_Currently_Owned_;
    SELF := __PP6386967;
  END;
  EXPORT __ENH_Person_Property_3 := PROJECT(__EE6386966,__ND6387068__Project(LEFT));
END;
