...
EXPORT Q_Input_Attributes_V1(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Attr_Layout)) __PInputPIIDataset, KEL.typ.str __PInputArchiveDateClean, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE114762 := __ENH_Input_P_I_I;
  SHARED __ST7682_Layout := RECORD
  ...
  END;
  SHARED __ST7682_Layout __ND114604__Project(B_Input_P_I_I(__in).__ST12277_Layout __PP114560) := TRANSFORM
    SELF.Input_U_I_D_Append_ := __PP114560.UID;
    SELF.Input_Account_Echo_ := __PP114560.Input_Account_Value_;
    SELF.Input_Lex_I_D_Echo_ := __PP114560.Input_Lex_I_D_Value_;
    SELF.Input_First_Name_Echo_ := __PP114560.Input_First_Name_Value_;
    SELF.Input_Address_Echo_ := __PP114560.Input_Address_Value_;
    SELF.Input_City_Echo_ := __PP114560.Input_City_Value_;
    SELF.Input_State_Echo_ := __PP114560.Input_State_Value_;
    SELF.Input_Zip_Echo_ := __PP114560.Input_Zip_Value_;
    SELF.Input_Home_Phone_Echo_ := __PP114560.Input_Home_Phone_Value_;
    SELF.Input_Work_Phone_Echo_ := __PP114560.Input_Work_Phone_Value_;
    SELF.Input_Email_Echo_ := __PP114560.Input_Email_Value_;
    SELF.Input_Archive_Date_Echo_ := __PP114560.Input_Archive_Date_Value_;
    SELF.Input_Archive_Date_Clean_ := __PP114560.Input_Archive_Date_Value_;
    SELF.Rep_Number_ := __PP114560.I_Rep_Number_Value_;
    SELF := __PP114560;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE114762,__ND114604__Project(LEFT)));
END;
