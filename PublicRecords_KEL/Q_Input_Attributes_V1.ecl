...
EXPORT Q_Input_Attributes_V1(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Attr_Layout)) __PInputPIIDataset, KEL.typ.str __PInputArchiveDateClean, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE113363 := __ENH_Input_P_I_I;
  SHARED __ST6929_Layout := RECORD
  ...
  END;
  SHARED __ST6929_Layout __ND113205__Project(B_Input_P_I_I(__in).__ST11522_Layout __PP113161) := TRANSFORM
    SELF.Input_U_I_D_Append_ := __PP113161.UID;
    SELF.Input_Account_Echo_ := __PP113161.Input_Account_Value_;
    SELF.Input_Lex_I_D_Echo_ := __PP113161.Input_Lex_I_D_Value_;
    SELF.Input_First_Name_Echo_ := __PP113161.Input_First_Name_Value_;
    SELF.Input_Address_Echo_ := __PP113161.Input_Address_Value_;
    SELF.Input_City_Echo_ := __PP113161.Input_City_Value_;
    SELF.Input_State_Echo_ := __PP113161.Input_State_Value_;
    SELF.Input_Zip_Echo_ := __PP113161.Input_Zip_Value_;
    SELF.Input_Home_Phone_Echo_ := __PP113161.Input_Home_Phone_Value_;
    SELF.Input_Work_Phone_Echo_ := __PP113161.Input_Work_Phone_Value_;
    SELF.Input_Email_Echo_ := __PP113161.Input_Email_Value_;
    SELF.Input_Archive_Date_Echo_ := __PP113161.Input_Archive_Date_Value_;
    SELF.Input_Archive_Date_Clean_ := __PP113161.Input_Archive_Date_Value_;
    SELF.Rep_Number_ := __PP113161.I_Rep_Number_Value_;
    SELF := __PP113161;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE113363,__ND113205__Project(LEFT)));
END;
