...
EXPORT Q_Input_Attributes_V1(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.str __PInputArchiveDateClean, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE141004 := __ENH_Input_P_I_I;
  SHARED __ST9114_Layout := RECORD
  ...
  END;
  SHARED __ST9114_Layout __ND140590__Project(B_Input_P_I_I(__in).__ST17864_Layout __PP140482) := TRANSFORM
    SELF.Input_U_I_D_Append_ := __PP140482.UID;
    SELF.Input_Account_Echo_ := __PP140482.Input_Account_Value_;
    SELF.Input_Lex_I_D_Echo_ := __PP140482.Input_Lex_I_D_Value_;
    SELF.Input_First_Name_Echo_ := __PP140482.Input_First_Name_Value_;
    SELF.Input_Middle_Name_Echo_ := __PP140482.Input_Middle_Name_Value_;
    SELF.Input_Last_Name_Echo_ := __PP140482.Input_Last_Name_Value_;
    SELF.Input_Street_Echo_ := __PP140482.Input_Street_Value_;
    SELF.Input_City_Echo_ := __PP140482.Input_City_Value_;
    SELF.Input_State_Echo_ := __PP140482.Input_State_Value_;
    SELF.Input_Zip_Echo_ := __PP140482.Input_Zip_Value_;
    SELF.Input_S_S_N_Echo_ := __PP140482.Input_S_S_N_Value_;
    SELF.Input_D_O_B_Echo_ := __PP140482.Input_D_O_B_Value_;
    SELF.Input_D_L_Echo_ := __PP140482.Input_D_L_Value_;
    SELF.Input_D_L_State_Echo_ := __PP140482.Input_D_L_State_Value_;
    SELF.Input_Home_Phone_Echo_ := __PP140482.Input_Home_Phone_Value_;
    SELF.Input_Work_Phone_Echo_ := __PP140482.Input_Work_Phone_Value_;
    SELF.Input_Email_Echo_ := __PP140482.Input_Email_Value_;
    SELF.Input_Archive_Date_Echo_ := __PP140482.Input_Archive_Date_Value_;
    SELF.Input_Account_Echo_Pop_ := __PP140482.Input_Account_Echo_Pop_Value_;
    SELF.Input_Lex_I_D_Echo_Pop_ := __PP140482.Input_Lex_I_D_Echo_Pop_Value_;
    SELF.Input_First_Name_Echo_Pop_ := __PP140482.Input_First_Name_Echo_Pop_Value_;
    SELF.Input_Middle_Name_Echo_Pop_ := __PP140482.Input_Middle_Name_Echo_Pop_Value_;
    SELF.Input_Last_Name_Echo_Pop_ := __PP140482.Input_Last_Name_Echo_Pop_Value_;
    SELF.Input_Street_Echo_Pop_ := __PP140482.Input_Street_Echo_Pop_Value_;
    SELF.Input_City_Echo_Pop_ := __PP140482.Input_City_Echo_Pop_Value_;
    SELF.Input_State_Echo_Pop_ := __PP140482.Input_State_Echo_Pop_Value_;
    SELF.Input_Zip_Echo_Pop_ := __PP140482.Input_Zip_Echo_Pop_Value_;
    SELF.Input_S_S_N_Echo_Pop_ := __PP140482.Input_S_S_N_Echo_Pop_Value_;
    SELF.Input_D_O_B_Echo_Pop_ := __PP140482.Input_D_O_B_Echo_Pop_Value_;
    SELF.Input_D_L_Echo_Pop_ := __PP140482.Input_D_L_Echo_Pop_Value_;
    SELF.Input_D_L_State_Echo_Pop_ := __PP140482.Input_D_L_State_Echo_Pop_Value_;
    SELF.Input_Home_Phone_Echo_Pop_ := __PP140482.Input_Home_Phone_Echo_Pop_Value_;
    SELF.Input_Work_Phone_Echo_Pop_ := __PP140482.Input_Work_Phone_Echo_Pop_Value_;
    SELF.Input_Email_Echo_Pop_ := __PP140482.Input_Email_Echo_Pop_Value_;
    SELF.Input_Archive_Date_Echo_Pop_ := __PP140482.Input_Archive_Date_Echo_Pop_Value_;
    SELF.Input_Prefix_Clean_ := __PP140482.Input_Prefix_Clean_Value_;
    SELF.Input_First_Name_Clean_ := __PP140482.Input_First_Name_Clean_Value_;
    SELF.Input_Middle_Name_Clean_ := __PP140482.Input_Middle_Name_Clean_Value_;
    SELF.Input_Last_Name_Clean_ := __PP140482.Input_Last_Name_Clean_Value_;
    SELF.Input_Suffix_Clean_ := __PP140482.Input_Suffix_Clean_Value_;
    SELF.Input_Primary_Range_Clean_ := __PP140482.Input_Primary_Range_Clean_Value_;
    SELF.Input_Pre_Direction_Clean_ := __PP140482.Input_Pre_Direction_Clean_Value_;
    SELF.Input_Primary_Name_Clean_ := __PP140482.Input_Primary_Name_Clean_Value_;
    SELF.Input_Address_Suffix_Clean_ := __PP140482.Input_Address_Suffix_Clean_Value_;
    SELF.Input_Post_Direction_Clean_ := __PP140482.Input_Post_Direction_Clean_Value_;
    SELF.Input_Unit_Desig_Clean_ := __PP140482.Input_Unit_Desig_Clean_Value_;
    SELF.Input_Secondary_Range_Clean_ := __PP140482.Input_Secondary_Range_Clean_Value_;
    SELF.Input_City_Clean_ := __PP140482.Input_City_Clean_Value_;
    SELF.Input_State_Clean_ := __PP140482.Input_State_Clean_Value_;
    SELF.Input_Zip5_Clean_ := __PP140482.Input_Zip5_Clean_Value_;
    SELF.Input_Zip4_Clean_ := __PP140482.Input_Zip4_Clean_Value_;
    SELF.Input_Street_Clean_ := __PP140482.Input_Street_Clean_Value_;
    SELF.Input_Full_Address_Clean_ := __PP140482.Input_Full_Address_Clean_Value_;
    SELF.Input_Latitude_Clean_ := __PP140482.Input_Latitude_Clean_Value_;
    SELF.Input_Longitude_Clean_ := __PP140482.Input_Longitude_Clean_Value_;
    SELF.Input_County_Clean_ := __PP140482.Input_County_Clean_Value_;
    SELF.Input_Geoblock_Clean_ := __PP140482.Input_Geoblock_Clean_Value_;
    SELF.Input_Address_Type_Clean_ := __PP140482.Input_Address_Type_Clean_Value_;
    SELF.Input_Address_Status_Clean_ := __PP140482.Input_Address_Status_Clean_Value_;
    SELF.Input_S_S_N_Clean_ := __PP140482.Input_S_S_N_Clean_Value_;
    SELF.Input_D_O_B_Clean_ := __PP140482.Input_D_O_B_Clean_Value_;
    SELF.Input_D_L_Clean_ := __PP140482.Input_D_L_Clean_Value_;
    SELF.Input_D_L_State_Clean_ := __PP140482.Input_D_L_State_Clean_Value_;
    SELF.Input_Home_Phone_Clean_ := __PP140482.Input_Home_Phone_Clean_Value_;
    SELF.Input_Work_Phone_Clean_ := __PP140482.Input_Work_Phone_Clean_Value_;
    SELF.Input_Email_Clean_ := __PP140482.Input_Email_Clean_Value_;
    SELF.Input_Archive_Date_Clean_ := __PP140482.Input_Archive_Date_Value_;
    SELF.Input_Prefix_Clean_Pop_ := __PP140482.Input_Prefix_Clean_Pop_Value_;
    SELF.Input_First_Name_Clean_Pop_ := __PP140482.Input_First_Name_Clean_Pop_Value_;
    SELF.Input_Middle_Name_Clean_Pop_ := __PP140482.Input_Middle_Name_Clean_Pop_Value_;
    SELF.Input_Last_Name_Clean_Pop_ := __PP140482.Input_Last_Name_Clean_Pop_Value_;
    SELF.Input_Suffix_Clean_Pop_ := __PP140482.Input_Suffix_Clean_Pop_Value_;
    SELF.Input_Primary_Range_Clean_Pop_ := __PP140482.Input_Primary_Range_Clean_Pop_Value_;
    SELF.Input_Pre_Direction_Clean_Pop_ := __PP140482.Input_Pre_Direction_Clean_Pop_Value_;
    SELF.Input_Primary_Name_Clean_Pop_ := __PP140482.Input_Primary_Name_Clean_Pop_Value_;
    SELF.Input_Address_Suffix_Clean_Pop_ := __PP140482.Input_Address_Suffix_Clean_Pop_Value_;
    SELF.Input_Post_Direction_Clean_Pop_ := __PP140482.Input_Post_Direction_Clean_Pop_Value_;
    SELF.Input_Unit_Desig_Clean_Pop_ := __PP140482.Input_Unit_Desig_Clean_Pop_Value_;
    SELF.Input_Secondary_Range_Clean_Pop_ := __PP140482.Input_Secondary_Range_Clean_Pop_Value_;
    SELF.Input_City_Clean_Pop_ := __PP140482.Input_City_Clean_Pop_Value_;
    SELF.Input_State_Clean_Pop_ := __PP140482.Input_State_Clean_Pop_Value_;
    SELF.Input_Zip5_Clean_Pop_ := __PP140482.Input_Zip5_Clean_Pop_Value_;
    SELF.Input_Zip4_Clean_Pop_ := __PP140482.Input_Zip4_Clean_Pop_Value_;
    SELF.Input_Street_Clean_Pop_ := __PP140482.Input_Street_Clean_Pop_Value_;
    SELF.Input_Full_Address_Clean_Pop_ := __PP140482.Input_Full_Address_Clean_Pop_Value_;
    SELF.Input_Latitude_Clean_Pop_ := __PP140482.Input_Latitude_Clean_Pop_Value_;
    SELF.Input_Longitude_Clean_Pop_ := __PP140482.Input_Longitude_Clean_Pop_Value_;
    SELF.Input_County_Clean_Pop_ := __PP140482.Input_County_Clean_Pop_Value_;
    SELF.Input_Geoblock_Clean_Pop_ := __PP140482.Input_Geoblock_Clean_Pop_Value_;
    SELF.Input_Address_Type_Clean_Pop_ := __PP140482.Input_Address_Type_Clean_Pop_Value_;
    SELF.Input_Address_Status_Clean_Pop_ := __PP140482.Input_Address_Status_Clean_Pop_Value_;
    SELF.Input_S_S_N_Clean_Pop_ := __PP140482.Input_S_S_N_Clean_Pop_Value_;
    SELF.Input_D_O_B_Clean_Pop_ := __PP140482.Input_D_O_B_Clean_Pop_Value_;
    SELF.Input_D_L_Clean_Pop_ := __PP140482.Input_D_L_Clean_Pop_Value_;
    SELF.Input_D_L_State_Clean_Pop_ := __PP140482.Input_D_L_State_Clean_Pop_Value_;
    SELF.Input_Home_Phone_Clean_Pop_ := __PP140482.Input_Home_Phone_Clean_Pop_Value_;
    SELF.Input_Work_Phone_Clean_Pop_ := __PP140482.Input_Work_Phone_Clean_Pop_Value_;
    SELF.Input_Email_Clean_Pop_ := __PP140482.Input_Email_Clean_Pop_Value_;
    SELF.Input_Archive_Date_Clean_Pop_ := __PP140482.Input_Archive_Date_Clean_Pop_Value_;
    SELF.Rep_Number_ := __PP140482.I_Rep_Number_Value_;
    SELF := __PP140482;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE141004,__ND140590__Project(LEFT)));
END;
