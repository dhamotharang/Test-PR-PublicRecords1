...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5424195 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST250372_Layout := RECORD
  ...
  END;
  EXPORT __ST250334_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST250372_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250334_Layout __ND5424200__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST255157_Layout __PP5424196) := TRANSFORM
    __EE5424249 := __PP5424196.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5424249),__ST250372_Layout),__NL(__EE5424249));
    SELF := __PP5424196;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5424195,__ND5424200__Project(LEFT));
END;
