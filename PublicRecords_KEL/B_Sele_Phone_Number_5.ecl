...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE483120 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST161012_Layout := RECORD
  ...
  END;
  EXPORT __ST160974_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST161012_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160974_Layout __ND483401__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST164217_Layout __PP482918) := TRANSFORM
    __EE483040 := __PP482918.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE483040),__ST161012_Layout),__NL(__EE483040));
    SELF := __PP482918;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE483120,__ND483401__Project(LEFT));
END;
