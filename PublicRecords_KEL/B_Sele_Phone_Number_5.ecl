...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5654954 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST263354_Layout := RECORD
  ...
  END;
  EXPORT __ST263316_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST263354_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263316_Layout __ND5654959__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST268268_Layout __PP5654955) := TRANSFORM
    __EE5655008 := __PP5654955.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5655008),__ST263354_Layout),__NL(__EE5655008));
    SELF := __PP5654955;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5654954,__ND5654959__Project(LEFT));
END;
