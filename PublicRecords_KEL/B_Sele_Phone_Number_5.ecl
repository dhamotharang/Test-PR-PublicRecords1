...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5716804 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST265077_Layout := RECORD
  ...
  END;
  EXPORT __ST265039_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST265077_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265039_Layout __ND5716809__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST270153_Layout __PP5716805) := TRANSFORM
    __EE5716858 := __PP5716805.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5716858),__ST265077_Layout),__NL(__EE5716858));
    SELF := __PP5716805;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5716804,__ND5716809__Project(LEFT));
END;
