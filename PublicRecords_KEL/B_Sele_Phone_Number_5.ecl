...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5712945 := __ENH_Sele_Phone_Number_6;
  ...
  EXPORT __ST264926_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST264964_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264926_Layout __ND5712950__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST269883_Layout __PP5712946) := TRANSFORM
    __EE5712999 := __PP5712946.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5712999),__ST264964_Layout),__NL(__EE5712999));
    SELF := __PP5712946;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5712945,__ND5712950__Project(LEFT));
END;
