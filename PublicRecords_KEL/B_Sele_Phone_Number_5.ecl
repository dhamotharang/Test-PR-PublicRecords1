...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE512950 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST161313_Layout := RECORD
  ...
  END;
  EXPORT __ST161275_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST161313_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161275_Layout __ND513231__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST164631_Layout __PP512748) := TRANSFORM
    __EE512870 := __PP512748.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE512870),__ST161313_Layout),__NL(__EE512870));
    SELF := __PP512748;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE512950,__ND513231__Project(LEFT));
END;
