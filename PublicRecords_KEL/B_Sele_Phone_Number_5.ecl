...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4939786 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST242569_Layout := RECORD
  ...
  END;
  EXPORT __ST242531_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242569_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242531_Layout __ND4939791__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST247196_Layout __PP4939787) := TRANSFORM
    __EE4939840 := __PP4939787.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4939840),__ST242569_Layout),__NL(__EE4939840));
    SELF := __PP4939787;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE4939786,__ND4939791__Project(LEFT));
END;
