...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5397196 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST248965_Layout := RECORD
  ...
  EXPORT __ST248927_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST248965_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248927_Layout __ND5397201__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST253746_Layout __PP5397197) := TRANSFORM
    __EE5397250 := __PP5397197.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5397250),__ST248965_Layout),__NL(__EE5397250));
    SELF := __PP5397197;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5397196,__ND5397201__Project(LEFT));
END;
