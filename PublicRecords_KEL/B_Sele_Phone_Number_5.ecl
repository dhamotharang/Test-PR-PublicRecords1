...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5641744 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST257872_Layout := RECORD
  ...
  END;
  EXPORT __ST257834_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST257872_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST257834_Layout __ND5641749__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST262854_Layout __PP5641745) := TRANSFORM
    __EE5641798 := __PP5641745.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5641798),__ST257872_Layout),__NL(__EE5641798));
    SELF := __PP5641745;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5641744,__ND5641749__Project(LEFT));
END;
