...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5609440 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST256713_Layout := RECORD
  ...
  END;
  EXPORT __ST256675_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST256713_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256675_Layout __ND5609445__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST261617_Layout __PP5609441) := TRANSFORM
    __EE5609494 := __PP5609441.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5609494),__ST256713_Layout),__NL(__EE5609494));
    SELF := __PP5609441;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5609440,__ND5609445__Project(LEFT));
END;
