...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5216381 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST251273_Layout := RECORD
  ...
  END;
  EXPORT __ST251235_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251273_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251235_Layout __ND5216386__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST256074_Layout __PP5216382) := TRANSFORM
    __EE5216435 := __PP5216382.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5216435),__ST251273_Layout),__NL(__EE5216435));
    SELF := __PP5216382;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5216381,__ND5216386__Project(LEFT));
END;
