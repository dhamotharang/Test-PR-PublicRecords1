...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4940644 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST242589_Layout := RECORD
  ...
  END;
  EXPORT __ST242551_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242589_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242551_Layout __ND4940649__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST247216_Layout __PP4940645) := TRANSFORM
    __EE4940698 := __PP4940645.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4940698),__ST242589_Layout),__NL(__EE4940698));
    SELF := __PP4940645;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE4940644,__ND4940649__Project(LEFT));
END;
