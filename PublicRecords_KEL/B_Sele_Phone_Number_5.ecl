...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5055354 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST243120_Layout := RECORD
  ...
  END;
  EXPORT __ST243082_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST243120_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243082_Layout __ND5055359__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST247747_Layout __PP5055355) := TRANSFORM
    __EE5055408 := __PP5055355.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5055408),__ST243120_Layout),__NL(__EE5055408));
    SELF := __PP5055355;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5055354,__ND5055359__Project(LEFT));
END;
