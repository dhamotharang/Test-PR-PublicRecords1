...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5584198 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST255059_Layout := RECORD
  ...
  END;
  EXPORT __ST255021_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST255059_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255021_Layout __ND5584203__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST260041_Layout __PP5584199) := TRANSFORM
    __EE5584252 := __PP5584199.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5584252),__ST255059_Layout),__NL(__EE5584252));
    SELF := __PP5584199;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5584198,__ND5584203__Project(LEFT));
END;
