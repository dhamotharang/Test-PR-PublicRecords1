...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3613921 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST197078_Layout := RECORD
  ...
  END;
  EXPORT __ST197040_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST197078_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197040_Layout __ND3613926__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST200830_Layout __PP3613922) := TRANSFORM
    __EE3613975 := __PP3613922.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3613975),__ST197078_Layout),__NL(__EE3613975));
    SELF := __PP3613922;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE3613921,__ND3613926__Project(LEFT));
END;
