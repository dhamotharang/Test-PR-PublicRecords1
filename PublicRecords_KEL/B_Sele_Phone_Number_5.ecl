...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5744752 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST264985_Layout := RECORD
  ...
  END;
  EXPORT __ST264947_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST264985_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264947_Layout __ND5744757__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST269904_Layout __PP5744753) := TRANSFORM
    __EE5744806 := __PP5744753.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5744806),__ST264985_Layout),__NL(__EE5744806));
    SELF := __PP5744753;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5744752,__ND5744757__Project(LEFT));
END;
