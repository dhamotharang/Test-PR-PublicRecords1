...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5662111 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST258174_Layout := RECORD
  ...
  END;
  EXPORT __ST258136_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST258174_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258136_Layout __ND5662116__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST263156_Layout __PP5662112) := TRANSFORM
    __EE5662165 := __PP5662112.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5662165),__ST258174_Layout),__NL(__EE5662165));
    SELF := __PP5662112;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5662111,__ND5662116__Project(LEFT));
END;
