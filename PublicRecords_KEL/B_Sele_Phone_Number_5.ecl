...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5582612 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST255089_Layout := RECORD
  ...
  EXPORT __ST255051_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST255089_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255051_Layout __ND5582617__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST260071_Layout __PP5582613) := TRANSFORM
    __EE5582666 := __PP5582613.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5582666),__ST255089_Layout),__NL(__EE5582666));
    SELF := __PP5582613;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5582612,__ND5582617__Project(LEFT));
END;
