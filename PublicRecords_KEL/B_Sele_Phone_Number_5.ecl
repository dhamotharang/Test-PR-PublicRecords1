...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4938365 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST241914_Layout := RECORD
  ...
  END;
  EXPORT __ST241876_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST241914_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST241876_Layout __ND4938370__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST246541_Layout __PP4938366) := TRANSFORM
    __EE4938419 := __PP4938366.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4938419),__ST241914_Layout),__NL(__EE4938419));
    SELF := __PP4938366;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE4938365,__ND4938370__Project(LEFT));
END;
