...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4932401 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST242072_Layout := RECORD
  ...
  END;
  EXPORT __ST242034_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242072_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242034_Layout __ND4932406__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST246699_Layout __PP4932402) := TRANSFORM
    __EE4932455 := __PP4932402.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4932455),__ST242072_Layout),__NL(__EE4932455));
    SELF := __PP4932402;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE4932401,__ND4932406__Project(LEFT));
END;
