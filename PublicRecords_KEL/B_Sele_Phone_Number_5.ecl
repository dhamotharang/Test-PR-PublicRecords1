...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5223762 := __ENH_Sele_Phone_Number_6;
  ...
  END;
  EXPORT __ST251653_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST251691_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251653_Layout __ND5223767__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST256492_Layout __PP5223763) := TRANSFORM
    __EE5223816 := __PP5223763.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5223816),__ST251691_Layout),__NL(__EE5223816));
    SELF := __PP5223763;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5223762,__ND5223767__Project(LEFT));
END;
