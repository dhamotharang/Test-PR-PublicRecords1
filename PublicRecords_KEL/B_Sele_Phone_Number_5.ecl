...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4940649 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST242594_Layout := RECORD
  ...
  END;
  EXPORT __ST242556_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242594_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242556_Layout __ND4940654__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST247221_Layout __PP4940650) := TRANSFORM
    __EE4940703 := __PP4940650.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE4940703),__ST242594_Layout),__NL(__EE4940703));
    SELF := __PP4940650;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE4940649,__ND4940654__Project(LEFT));
END;
