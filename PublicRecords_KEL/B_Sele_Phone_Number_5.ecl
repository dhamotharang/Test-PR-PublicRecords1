...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3609302 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST188760_Layout := RECORD
  ...
  EXPORT __ST188722_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST188760_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST188722_Layout __ND3609307__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST192457_Layout __PP3609303) := TRANSFORM
    __EE3609356 := __PP3609303.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE3609356),__ST188760_Layout),__NL(__EE3609356));
    SELF := __PP3609303;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE3609302,__ND3609307__Project(LEFT));
END;
