...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6700103 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST280487_Layout := RECORD
  ...
  END;
  EXPORT __ST280449_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST280487_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST280449_Layout __ND6700108__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST285687_Layout __PP6700104) := TRANSFORM
    __EE6700157 := __PP6700104.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6700157),__ST280487_Layout),__NL(__EE6700157));
    SELF := __PP6700104;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE6700103,__ND6700108__Project(LEFT));
END;
