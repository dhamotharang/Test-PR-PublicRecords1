...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5593759 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST261966_Layout := RECORD
  ...
  END;
  EXPORT __ST261928_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST261966_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST261928_Layout __ND5593764__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST266870_Layout __PP5593760) := TRANSFORM
    __EE5593813 := __PP5593760.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5593813),__ST261966_Layout),__NL(__EE5593813));
    SELF := __PP5593760;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5593759,__ND5593764__Project(LEFT));
END;
