...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5191892 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST249603_Layout := RECORD
  ...
  END;
  EXPORT __ST249565_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST249603_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249565_Layout __ND5191897__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST254400_Layout __PP5191893) := TRANSFORM
    __EE5191946 := __PP5191893.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5191946),__ST249603_Layout),__NL(__EE5191946));
    SELF := __PP5191893;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE5191892,__ND5191897__Project(LEFT));
END;
