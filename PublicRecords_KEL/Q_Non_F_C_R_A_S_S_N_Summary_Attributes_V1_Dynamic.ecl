...
EXPORT Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Dynamic(KEL.typ.str __PSSN_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE9608818 := __ENH_S_S_N_Summary;
  SHARED __EE9609126 := __EE9608818(__T(__OP2(__EE9608818.S_S_N_,=,__CN(__PSSN_in))));
  SHARED __ST79267_Layout := RECORD
    KEL.typ.nbool Exp1_;
  ...
  END;
  SHARED __ST79267_Layout __ND9609134__Project(B_S_S_N_Summary(__in,__cfg_Local).__ST171165_Layout __PP9609127) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP9609127.P___Inp_Cln_S_S_N_,=,__PP9609127.S_S_N_);
    SELF := __PP9609127;
  END;
  SHARED __ST79267_Layout __ND9609134__Rollup(__ST79267_Layout __r, DATASET(__ST79267_Layout) __recs) := TRANSFORM
