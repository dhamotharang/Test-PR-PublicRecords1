...
EXPORT Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Dynamic(KEL.typ.str __PSSN_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11403812 := __ENH_S_S_N_Summary;
  SHARED __EE11404120 := __EE11403812(__T(__OP2(__EE11403812.S_S_N_,=,__CN(__PSSN_in))));
  SHARED __ST80992_Layout := RECORD
    KEL.typ.nbool Exp1_;
  ...
  END;
  SHARED __ST80992_Layout __ND11404128__Project(B_S_S_N_Summary(__in,__cfg_Local).__ST174458_Layout __PP11404121) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP11404121.P___Inp_Cln_S_S_N_,=,__PP11404121.S_S_N_);
    SELF := __PP11404121;
  END;
  SHARED __ST80992_Layout __ND11404128__Rollup(__ST80992_Layout __r, DATASET(__ST80992_Layout) __recs) := TRANSFORM
