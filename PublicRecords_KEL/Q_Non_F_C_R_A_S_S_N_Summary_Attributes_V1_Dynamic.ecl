...
EXPORT Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Dynamic(KEL.typ.str __PSSN_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE11560067 := __ENH_S_S_N_Summary;
  SHARED __EE11560375 := __EE11560067(__T(__OP2(__EE11560067.S_S_N_,=,__CN(__PSSN_in))));
  SHARED __ST79444_Layout := RECORD
    KEL.typ.nbool Exp1_;
  ...
  END;
  SHARED __ST79444_Layout __ND11560383__Project(B_S_S_N_Summary(__cfg_Local).__ST173457_Layout __PP11560376) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP11560376.P___Inp_Cln_S_S_N_,=,__PP11560376.S_S_N_);
    SELF := __PP11560376;
  END;
  SHARED __ST79444_Layout __ND11560383__Rollup(__ST79444_Layout __r, DATASET(__ST79444_Layout) __recs) := TRANSFORM
    ...
    SELF := __r;
  END;
  EXPORT Res0 := __UNWRAP(ROLLUP(GROUP(KEL.Routines.SortAndAppendFilteredChildren(PROJECT(__EE11560375,__ND11560383__Project(LEFT)),'S_S_N_Summary_Source_List_Sorted_','s_s_n_summary_source_list_sorted_','clean','__recordcount,archive___date_,date_first_seen_,date_last_seen_,hybrid_archive_date_,vault_date_last_seen_'),Exp1_,P___Inp_Cln_Phone_Home_,S_S_N_Summary_Source_List_Sorted_Clean,P_I___Src_W_Inp_A_S_List_Ev_,P_I___Src_W_Inp_A_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_A_S_Last_Dt_List_Ev_,P_I___Src_W_Inp_S_D_List_Ev_,P_I___Src_W_Inp_S_D_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_S_D_Last_Dt_List_Ev_,P_I___Src_W_Inp_P_S_List_Ev_,P_I___Src_W_Inp_P_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_P_S_Last_Dt_List_Ev_,P_I___Src_W_Inp_F_L_S_List_Ev_,P_I___Src_W_Inp_F_L_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_F_L_S_Last_Dt_List_Ev_,ALL),GROUP,__ND11560383__Rollup(ROW(LEFT,__ST79444_Layout), PROJECT(ROWS(LEFT),__ST79444_Layout))));
