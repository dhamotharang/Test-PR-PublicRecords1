...
EXPORT E_Person_Vehicle(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED InLayout __Mapping0_Transform(InLayout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault((STRING20)vehicle_key <> '' AND (UNSIGNED)append_did != 0);
  SHARED __d0_Automobile__Layout := RECORD
    RECORDOF(__d0_KELfiltered);
    KEL.typ.uid Automobile_;
  END;
  SHARED __d0_Missing_Automobile__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_KELfiltered,'vehicle_key','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault');
  ...
  SHARED __d0 := __SourceFilter(PROJECT(KEL.FromFlat.Convert(__d0_Prefiltered,InLayout,__Mapping0,'PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault'),__Mapping0_Transform(LEFT)));
  EXPORT InData := __d0;
  ...
  EXPORT NullCounts := DATASET([
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','append_did',COUNT(__d0(__NL(Subject_))),COUNT(__d0(__NN(Subject_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','Automobile',COUNT(__d0(__NL(Automobile_))),COUNT(__d0(__NN(Automobile_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_first_date',COUNT(__d0(__NL(Registration_First_Date_))),COUNT(__d0(__NN(Registration_First_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_earliest_effective_date',COUNT(__d0(__NL(Registration_Earliest_Effective_Date_))),COUNT(__d0(__NN(Registration_Earliest_Effective_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_latest_effective_date',COUNT(__d0(__NL(Registration_Latest_Effective_Date_))),COUNT(__d0(__NN(Registration_Latest_Effective_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_latest_expiration_date',COUNT(__d0(__NL(Registration_Latest_Expiratione_Date_))),COUNT(__d0(__NN(Registration_Latest_Expiratione_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_rollup_count',COUNT(__d0(__NL(Registration_Record_Count_))),COUNT(__d0(__NN(Registration_Record_Count_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_decal_number',COUNT(__d0(__NL(Registration_Decal_Number_))),COUNT(__d0(__NN(Registration_Decal_Number_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_decal_year',COUNT(__d0(__NL(Registratoin_Decal_Year_))),COUNT(__d0(__NN(Registratoin_Decal_Year_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_status_code',COUNT(__d0(__NL(Registration_Status_Code_))),COUNT(__d0(__NN(Registration_Status_Code_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_status_desc',COUNT(__d0(__NL(Registration_Status_Description_))),COUNT(__d0(__NN(Registration_Status_Description_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_true_license_plate',COUNT(__d0(__NL(Registration_True_License_Plate_))),COUNT(__d0(__NN(Registration_True_License_Plate_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate',COUNT(__d0(__NL(Registration_License_Plate_))),COUNT(__d0(__NN(Registration_License_Plate_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_state',COUNT(__d0(__NL(Registration_License_State_))),COUNT(__d0(__NN(Registration_License_State_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate_type_code',COUNT(__d0(__NL(Registration_License_Plate_Type_Code_))),COUNT(__d0(__NN(Registration_License_Plate_Type_Code_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_license_plate_type_desc',COUNT(__d0(__NL(Registration_License_Plate_Type_Description_))),COUNT(__d0(__NN(Registration_License_Plate_Type_Description_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_previous_license_state',COUNT(__d0(__NL(Registration_Previous_License_State_))),COUNT(__d0(__NN(Registration_Previous_License_State_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','reg_previous_license_plate',COUNT(__d0(__NL(Registration_Previous_License_Plate_))),COUNT(__d0(__NN(Registration_Previous_License_Plate_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_number',COUNT(__d0(__NL(Title_Number_))),COUNT(__d0(__NN(Title_Number_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_earliest_issue_date',COUNT(__d0(__NL(Title_Earliest_Issue_Date_))),COUNT(__d0(__NN(Title_Earliest_Issue_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_latest_issue_date',COUNT(__d0(__NL(Title_Latest_Issue_Date_))),COUNT(__d0(__NN(Title_Latest_Issue_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_previous_issue_date',COUNT(__d0(__NL(Title_Previous_Issue_Date_))),COUNT(__d0(__NN(Title_Previous_Issue_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_rollup_count',COUNT(__d0(__NL(Title_Record_Count_))),COUNT(__d0(__NN(Title_Record_Count_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_status_code',COUNT(__d0(__NL(Title_Status_Code_))),COUNT(__d0(__NN(Title_Status_Code_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_status_desc',COUNT(__d0(__NL(Title_Status_Description_))),COUNT(__d0(__NN(Title_Status_Description_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_mileage',COUNT(__d0(__NL(Title_Odometer_Mileage_))),COUNT(__d0(__NN(Title_Odometer_Mileage_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_status_code',COUNT(__d0(__NL(Title_Odometer_Status_Code_))),COUNT(__d0(__NN(Title_Odometer_Status_Code_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_status_desc',COUNT(__d0(__NL(Title_Odometer_Status_Description_))),COUNT(__d0(__NN(Title_Odometer_Status_Description_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','ttl_odometer_date',COUNT(__d0(__NL(Title_Odometer_Date_))),COUNT(__d0(__NN(Title_Odometer_Date_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','sequence_key',COUNT(__d0(__NL(Sequence_Key_))),COUNT(__d0(__NN(Sequence_Key_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','history',COUNT(__d0(__NL(History_))),COUNT(__d0(__NN(History_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','source_code',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'PersonVehicle','PublicRecords_KEL.Files.NonFCRA.VehicleV2__Key_Vehicle_Party_Key_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
