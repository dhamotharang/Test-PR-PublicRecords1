...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE369528 := __E_Property_Event;
  EXPORT __ST262477_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST262477_Layout __ND369595__Project(E_Property_Event(__in,__cfg).Layout __PP369196) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP369196.Date_First_Seen_);
    SELF := __PP369196;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE369528,__ND369595__Project(LEFT));
END;
