...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE363081 := __E_Property_Event;
  EXPORT __ST260377_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST260377_Layout __ND363148__Project(E_Property_Event(__in,__cfg).Layout __PP362749) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP362749.Date_First_Seen_);
    SELF := __PP362749;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE363081,__ND363148__Project(LEFT));
END;
