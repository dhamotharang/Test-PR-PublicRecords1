...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE414227 := __E_Property_Event;
  EXPORT __ST269197_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST269197_Layout __ND414295__Project(E_Property_Event(__in,__cfg).Layout __PP413890) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP413890.Date_First_Seen_);
    SELF := __PP413890;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE414227,__ND414295__Project(LEFT));
END;
