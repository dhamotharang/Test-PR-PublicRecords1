...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE364819 := __E_Property_Event;
  EXPORT __ST262059_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST262059_Layout __ND364886__Project(E_Property_Event(__in,__cfg).Layout __PP364487) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP364487.Date_First_Seen_);
    SELF := __PP364487;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE364819,__ND364886__Project(LEFT));
END;
