...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE422369 := __E_Property_Event;
  EXPORT __ST276357_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST276357_Layout __ND422437__Project(E_Property_Event(__in,__cfg).Layout __PP422032) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP422032.Date_First_Seen_);
    SELF := __PP422032;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE422369,__ND422437__Project(LEFT));
END;
