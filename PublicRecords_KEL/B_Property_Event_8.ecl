...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE413888 := __E_Property_Event;
  EXPORT __ST268895_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST268895_Layout __ND413956__Project(E_Property_Event(__in,__cfg).Layout __PP413551) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP413551.Date_First_Seen_);
    SELF := __PP413551;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE413888,__ND413956__Project(LEFT));
END;
