...
EXPORT B_Person_S_S_N_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6942369 := __ENH_Person_S_S_N_5;
  EXPORT __ST332805_Layout := RECORD
  ...
  END;
  EXPORT __ST332797_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST332805_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST332797_Layout __ND6942374__Project(B_Person_S_S_N_5(__in,__cfg).__ST332754_Layout __PP6942370) := TRANSFORM
    __EE6942389 := __PP6942370.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6942389),__ST332805_Layout),__NL(__EE6942389));
    SELF := __PP6942370;
  END;
  EXPORT __ENH_Person_S_S_N_4 := PROJECT(__EE6942369,__ND6942374__Project(LEFT));
END;
