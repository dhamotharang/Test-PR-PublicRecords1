...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7938820 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST192622_Layout := RECORD
  ...
  EXPORT __ST192584_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST192622_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192584_Layout __ND7938825__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST210795_Layout __PP7938821) := TRANSFORM
    __EE7938874 := __PP7938821.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7938874),__ST192622_Layout),__NL(__EE7938874));
    SELF := __PP7938821;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE7938820,__ND7938825__Project(LEFT));
END;
