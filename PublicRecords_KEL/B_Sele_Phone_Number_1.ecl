...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9679311 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST212854_Layout := RECORD
  ...
  END;
  EXPORT __ST212816_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST212854_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212816_Layout __ND9679316__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST231873_Layout __PP9679312) := TRANSFORM
    __EE9679365 := __PP9679312.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9679365),__ST212854_Layout),__NL(__EE9679365));
    SELF := __PP9679312;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9679311,__ND9679316__Project(LEFT));
END;
