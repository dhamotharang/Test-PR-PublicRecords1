...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9683962 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST212915_Layout := RECORD
  ...
  END;
  EXPORT __ST212877_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST212915_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST212877_Layout __ND9683967__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST231947_Layout __PP9683963) := TRANSFORM
    __EE9684016 := __PP9683963.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9684016),__ST212915_Layout),__NL(__EE9684016));
    SELF := __PP9683963;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9683962,__ND9683967__Project(LEFT));
END;
