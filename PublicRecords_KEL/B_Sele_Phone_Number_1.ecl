...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8448860 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST200821_Layout := RECORD
  ...
  END;
  EXPORT __ST200783_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200821_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200783_Layout __ND8448865__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST219443_Layout __PP8448861) := TRANSFORM
    __EE8448914 := __PP8448861.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8448914),__ST200821_Layout),__NL(__EE8448914));
    SELF := __PP8448861;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8448860,__ND8448865__Project(LEFT));
END;
