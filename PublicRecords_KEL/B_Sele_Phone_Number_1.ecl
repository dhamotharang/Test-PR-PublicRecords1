...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7941793 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST192441_Layout := RECORD
  ...
  END;
  EXPORT __ST192403_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST192441_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192403_Layout __ND7941798__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST210621_Layout __PP7941794) := TRANSFORM
    __EE7941847 := __PP7941794.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7941847),__ST192441_Layout),__NL(__EE7941847));
    SELF := __PP7941794;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE7941793,__ND7941798__Project(LEFT));
END;
