...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9314438 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST203374_Layout := RECORD
  ...
  END;
  EXPORT __ST203336_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST203374_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST203336_Layout __ND9314443__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST222242_Layout __PP9314439) := TRANSFORM
    __EE9314492 := __PP9314439.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9314492),__ST203374_Layout),__NL(__EE9314492));
    SELF := __PP9314439;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9314438,__ND9314443__Project(LEFT));
END;
