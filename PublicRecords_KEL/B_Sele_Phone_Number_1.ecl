...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9316024 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST203344_Layout := RECORD
  ...
  END;
  EXPORT __ST203306_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST203344_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST203306_Layout __ND9316029__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST222212_Layout __PP9316025) := TRANSFORM
    __EE9316078 := __PP9316025.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9316078),__ST203344_Layout),__NL(__EE9316078));
    SELF := __PP9316025;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9316024,__ND9316029__Project(LEFT));
END;
