...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2797381 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST124597_Layout := RECORD
  ...
  END;
  EXPORT __ST124559_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST124597_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Date_Vendor_First_Reported_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST124559_Layout __ND2797647__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST136646_Layout __PP2797194) := TRANSFORM
    __EE2797314 := __PP2797194.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE2797314),__ST124597_Layout),__NL(__EE2797314));
    SELF := __PP2797194;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE2797381,__ND2797647__Project(LEFT));
END;
