...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9548475 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST208906_Layout := RECORD
  ...
  END;
  EXPORT __ST208868_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST208906_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST208868_Layout __ND9548480__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST228084_Layout __PP9548476) := TRANSFORM
    __EE9548529 := __PP9548476.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9548529),__ST208906_Layout),__NL(__EE9548529));
    SELF := __PP9548476;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9548475,__ND9548480__Project(LEFT));
END;
