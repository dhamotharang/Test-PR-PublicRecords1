...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8059130 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST193586_Layout := RECORD
  ...
  END;
  EXPORT __ST193548_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST193586_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST193548_Layout __ND8059135__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST211800_Layout __PP8059131) := TRANSFORM
    __EE8059184 := __PP8059131.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8059184),__ST193586_Layout),__NL(__EE8059184));
    SELF := __PP8059131;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8059130,__ND8059135__Project(LEFT));
END;
