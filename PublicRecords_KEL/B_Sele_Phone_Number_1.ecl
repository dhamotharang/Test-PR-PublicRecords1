...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8435868 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST200514_Layout := RECORD
  ...
  END;
  EXPORT __ST200476_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200514_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200476_Layout __ND8435873__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST219114_Layout __PP8435869) := TRANSFORM
    __EE8435922 := __PP8435869.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8435922),__ST200514_Layout),__NL(__EE8435922));
    SELF := __PP8435869;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8435868,__ND8435873__Project(LEFT));
END;
