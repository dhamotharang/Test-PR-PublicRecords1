...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8517349 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST198255_Layout := RECORD
  ...
  END;
  EXPORT __ST198217_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST198255_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST198217_Layout __ND8517354__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST216767_Layout __PP8517350) := TRANSFORM
    __EE8517403 := __PP8517350.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8517403),__ST198255_Layout),__NL(__EE8517403));
    SELF := __PP8517350;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8517349,__ND8517354__Project(LEFT));
END;
