...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9386477 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST205842_Layout := RECORD
  ...
  END;
  EXPORT __ST205804_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST205842_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST205804_Layout __ND9386482__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST224900_Layout __PP9386478) := TRANSFORM
    __EE9386531 := __PP9386478.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9386531),__ST205842_Layout),__NL(__EE9386531));
    SELF := __PP9386478;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9386477,__ND9386482__Project(LEFT));
END;
