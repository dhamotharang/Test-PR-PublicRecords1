...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5497802 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST147545_Layout := RECORD
  ...
  END;
  EXPORT __ST147507_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST147545_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST147507_Layout __ND5497807__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST162102_Layout __PP5497803) := TRANSFORM
    __EE5497856 := __PP5497803.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5497856),__ST147545_Layout),__NL(__EE5497856));
    SELF := __PP5497803;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE5497802,__ND5497807__Project(LEFT));
END;
