...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9409360 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST206136_Layout := RECORD
  ...
  END;
  EXPORT __ST206098_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST206136_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST206098_Layout __ND9409365__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST225202_Layout __PP9409361) := TRANSFORM
    __EE9409414 := __PP9409361.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE9409414),__ST206136_Layout),__NL(__EE9409414));
    SELF := __PP9409361;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE9409360,__ND9409365__Project(LEFT));
END;
