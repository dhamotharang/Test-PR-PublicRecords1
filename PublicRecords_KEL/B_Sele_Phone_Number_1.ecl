...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7933814 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST192586_Layout := RECORD
  ...
  END;
  EXPORT __ST192548_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST192586_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192548_Layout __ND7933819__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST210755_Layout __PP7933815) := TRANSFORM
    __EE7933868 := __PP7933815.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7933868),__ST192586_Layout),__NL(__EE7933868));
    SELF := __PP7933815;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE7933814,__ND7933819__Project(LEFT));
END;
