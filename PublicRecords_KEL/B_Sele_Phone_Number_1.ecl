...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10843757 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST225664_Layout := RECORD
  ...
  END;
  EXPORT __ST225626_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST225664_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST225626_Layout __ND10843762__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST245926_Layout __PP10843758) := TRANSFORM
    __EE10843811 := __PP10843758.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE10843811),__ST225664_Layout),__NL(__EE10843811));
    SELF := __PP10843758;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE10843757,__ND10843762__Project(LEFT));
END;
