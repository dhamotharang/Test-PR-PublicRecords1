...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5176232 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST157309_Layout := RECORD
  ...
  END;
  EXPORT __ST157271_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST157309_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157271_Layout __ND5176237__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST172779_Layout __PP5176233) := TRANSFORM
    __EE5176286 := __PP5176233.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5176286),__ST157309_Layout),__NL(__EE5176286));
    SELF := __PP5176233;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE5176232,__ND5176237__Project(LEFT));
END;
