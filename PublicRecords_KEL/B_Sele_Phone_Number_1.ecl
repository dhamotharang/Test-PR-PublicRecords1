...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7945894 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST193101_Layout := RECORD
  ...
  END;
  EXPORT __ST193063_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST193101_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST193063_Layout __ND7945899__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST211296_Layout __PP7945895) := TRANSFORM
    __EE7945948 := __PP7945895.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE7945948),__ST193101_Layout),__NL(__EE7945948));
    SELF := __PP7945895;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE7945894,__ND7945899__Project(LEFT));
END;
