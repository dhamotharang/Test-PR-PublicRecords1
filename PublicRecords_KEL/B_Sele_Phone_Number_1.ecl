...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5158218 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST155092_Layout := RECORD
  ...
  END;
  EXPORT __ST155054_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST155092_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155054_Layout __ND5158223__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST170315_Layout __PP5158219) := TRANSFORM
    __EE5158272 := __PP5158219.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE5158272),__ST155092_Layout),__NL(__EE5158272));
    SELF := __PP5158219;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE5158218,__ND5158223__Project(LEFT));
END;
