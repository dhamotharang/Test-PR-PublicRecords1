...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8999018 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST204949_Layout := RECORD
  ...
  END;
  EXPORT __ST204911_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST204949_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST204911_Layout __ND8999023__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST223845_Layout __PP8999019) := TRANSFORM
    __EE8999072 := __PP8999019.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8999072),__ST204949_Layout),__NL(__EE8999072));
    SELF := __PP8999019;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8999018,__ND8999023__Project(LEFT));
END;
