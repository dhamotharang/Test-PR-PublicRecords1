...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10283185 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST218889_Layout := RECORD
  ...
  END;
  EXPORT __ST218851_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST218889_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST218851_Layout __ND10283190__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST239198_Layout __PP10283186) := TRANSFORM
    __EE10283239 := __PP10283186.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE10283239),__ST218889_Layout),__NL(__EE10283239));
    SELF := __PP10283186;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE10283185,__ND10283190__Project(LEFT));
END;
