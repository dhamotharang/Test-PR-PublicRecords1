...
EXPORT B_Sele_Phone_Number_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8448890 := __ENH_Sele_Phone_Number_2;
  EXPORT __ST200851_Layout := RECORD
  ...
  END;
  EXPORT __ST200813_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST200851_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST200813_Layout __ND8448895__Project(B_Sele_Phone_Number_2(__in,__cfg).__ST219473_Layout __PP8448891) := TRANSFORM
    __EE8448944 := __PP8448891.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE8448944),__ST200851_Layout),__NL(__EE8448944));
    SELF := __PP8448891;
  END;
  EXPORT __ENH_Sele_Phone_Number_1 := PROJECT(__EE8448890,__ND8448895__Project(LEFT));
END;
