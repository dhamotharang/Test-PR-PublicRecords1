...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5174363 := __ENH_Property_2;
  EXPORT __ST235572_Layout := RECORD
  ...
  END;
  EXPORT __ST235554_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST235572_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST235554_Layout __ND5174368__Project(B_Property_2(__in,__cfg).__ST171849_Layout __PP5174364) := TRANSFORM
    __EE5174407 := __PP5174364.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE5174407),__ST235572_Layout),__NL(__EE5174407));
    SELF := __PP5174364;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE5174363,__ND5174368__Project(LEFT));
END;
