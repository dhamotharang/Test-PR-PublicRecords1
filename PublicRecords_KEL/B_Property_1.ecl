...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8374089 := __ENH_Property_2;
  EXPORT __ST281974_Layout := RECORD
  ...
  END;
  EXPORT __ST281956_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST281974_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST281956_Layout __ND8374094__Project(B_Property_2(__in,__cfg).__ST216718_Layout __PP8374090) := TRANSFORM
    __EE8374134 := __PP8374090.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8374134),__ST281974_Layout),__NL(__EE8374134));
    SELF := __PP8374090;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8374089,__ND8374094__Project(LEFT));
END;
