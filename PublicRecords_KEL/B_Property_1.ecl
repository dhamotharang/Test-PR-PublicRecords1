...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7943780 := __ENH_Property_2;
  EXPORT __ST284373_Layout := RECORD
  ...
  END;
  EXPORT __ST284355_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST284373_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST284355_Layout __ND7943785__Project(B_Property_2(__in,__cfg).__ST210358_Layout __PP7943781) := TRANSFORM
    __EE7943825 := __PP7943781.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7943825),__ST284373_Layout),__NL(__EE7943825));
    SELF := __PP7943781;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE7943780,__ND7943785__Project(LEFT));
END;
