...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5496945 := __ENH_Property_2;
  EXPORT __ST224378_Layout := RECORD
  ...
  END;
  EXPORT __ST224360_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST224378_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST224360_Layout __ND5496950__Project(B_Property_2(__in,__cfg).__ST161070_Layout __PP5496946) := TRANSFORM
    __EE5496989 := __PP5496946.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE5496989),__ST224378_Layout),__NL(__EE5496989));
    SELF := __PP5496946;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE5496945,__ND5496950__Project(LEFT));
END;
