...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8996899 := __ENH_Property_2;
  EXPORT __ST339253_Layout := RECORD
  ...
  END;
  EXPORT __ST339235_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST339253_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST339235_Layout __ND8996904__Project(B_Property_2(__in,__cfg).__ST222902_Layout __PP8996900) := TRANSFORM
    __EE8996944 := __PP8996900.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8996944),__ST339253_Layout),__NL(__EE8996944));
    SELF := __PP8996900;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8996899,__ND8996904__Project(LEFT));
END;
