...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7943775 := __ENH_Property_2;
  EXPORT __ST266469_Layout := RECORD
  ...
  END;
  EXPORT __ST266451_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST266469_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266451_Layout __ND7943780__Project(B_Property_2(__in,__cfg).__ST210353_Layout __PP7943776) := TRANSFORM
    __EE7943820 := __PP7943776.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7943820),__ST266469_Layout),__NL(__EE7943820));
    SELF := __PP7943776;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE7943775,__ND7943780__Project(LEFT));
END;
