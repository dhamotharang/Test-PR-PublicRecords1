...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9681837 := __ENH_Property_2;
  EXPORT __ST316258_Layout := RECORD
  ...
  END;
  EXPORT __ST316240_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST316258_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST316240_Layout __ND9681842__Project(B_Property_2(__in,__cfg).__ST230992_Layout __PP9681838) := TRANSFORM
    __EE9681882 := __PP9681838.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9681882),__ST316258_Layout),__NL(__EE9681882));
    SELF := __PP9681838;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9681837,__ND9681842__Project(LEFT));
END;
