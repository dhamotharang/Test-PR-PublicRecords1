...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9546350 := __ENH_Property_2;
  EXPORT __ST312322_Layout := RECORD
  ...
  EXPORT __ST312304_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST312322_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST312304_Layout __ND9546355__Project(B_Property_2(__in,__cfg).__ST227129_Layout __PP9546351) := TRANSFORM
    __EE9546395 := __PP9546351.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9546395),__ST312322_Layout),__NL(__EE9546395));
    SELF := __PP9546351;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9546350,__ND9546355__Project(LEFT));
END;
