...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10841632 := __ENH_Property_2;
  EXPORT __ST372015_Layout := RECORD
  ...
  END;
  EXPORT __ST371997_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST372015_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST371997_Layout __ND10841637__Project(B_Property_2(__in,__cfg).__ST244971_Layout __PP10841633) := TRANSFORM
    __EE10841677 := __PP10841633.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE10841677),__ST372015_Layout),__NL(__EE10841677));
    SELF := __PP10841633;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE10841632,__ND10841637__Project(LEFT));
END;
