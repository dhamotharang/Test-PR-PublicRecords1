...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8099279 := __ENH_Property_2;
  EXPORT __ST281206_Layout := RECORD
  ...
  END;
  EXPORT __ST281188_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST281206_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST281188_Layout __ND8099284__Project(B_Property_2(__in,__cfg).__ST214227_Layout __PP8099280) := TRANSFORM
    __EE8099324 := __PP8099280.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8099324),__ST281206_Layout),__NL(__EE8099324));
    SELF := __PP8099280;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8099279,__ND8099284__Project(LEFT));
END;
