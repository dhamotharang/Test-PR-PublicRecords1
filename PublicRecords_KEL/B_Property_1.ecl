...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8446741 := __ENH_Property_2;
  EXPORT __ST290586_Layout := RECORD
  ...
  END;
  EXPORT __ST290568_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST290586_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST290568_Layout __ND8446746__Project(B_Property_2(__in,__cfg).__ST218500_Layout __PP8446742) := TRANSFORM
    __EE8446786 := __PP8446742.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8446786),__ST290586_Layout),__NL(__EE8446786));
    SELF := __PP8446742;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8446741,__ND8446746__Project(LEFT));
END;
