...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9677186 := __ENH_Property_2;
  EXPORT __ST318662_Layout := RECORD
  ...
  EXPORT __ST318644_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST318662_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST318644_Layout __ND9677191__Project(B_Property_2(__in,__cfg).__ST230918_Layout __PP9677187) := TRANSFORM
    __EE9677231 := __PP9677187.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9677231),__ST318662_Layout),__NL(__EE9677231));
    SELF := __PP9677187;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9677186,__ND9677191__Project(LEFT));
END;
