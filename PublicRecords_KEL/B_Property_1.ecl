...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9407235 := __ENH_Property_2;
  EXPORT __ST312178_Layout := RECORD
  ...
  END;
  EXPORT __ST312160_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST312178_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST312160_Layout __ND9407240__Project(B_Property_2(__in,__cfg).__ST224247_Layout __PP9407236) := TRANSFORM
    __EE9407280 := __PP9407236.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9407280),__ST312178_Layout),__NL(__EE9407280));
    SELF := __PP9407236;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9407235,__ND9407240__Project(LEFT));
END;
