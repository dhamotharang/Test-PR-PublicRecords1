...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9483001 := __ENH_Property_2;
  EXPORT __ST312731_Layout := RECORD
  ...
  END;
  EXPORT __ST312713_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST312731_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST312713_Layout __ND9483006__Project(B_Property_2(__in,__cfg).__ST228155_Layout __PP9483002) := TRANSFORM
    __EE9483046 := __PP9483002.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9483046),__ST312731_Layout),__NL(__EE9483046));
    SELF := __PP9483002;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9483001,__ND9483006__Project(LEFT));
END;
