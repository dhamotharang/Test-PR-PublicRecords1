...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8537959 := __ENH_Property_2;
  EXPORT __ST326046_Layout := RECORD
  ...
  END;
  EXPORT __ST326028_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST326046_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST326028_Layout __ND8537964__Project(B_Property_2(__in,__cfg).__ST217225_Layout __PP8537960) := TRANSFORM
    __EE8538004 := __PP8537960.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8538004),__ST326046_Layout),__NL(__EE8538004));
    SELF := __PP8537960;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8537959,__ND8537964__Project(LEFT));
END;
