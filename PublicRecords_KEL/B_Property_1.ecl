...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9598146 := __ENH_Property_2;
  EXPORT __ST345555_Layout := RECORD
  ...
  END;
  EXPORT __ST345537_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST345555_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST345537_Layout __ND9598151__Project(B_Property_2(__in,__cfg).__ST229412_Layout __PP9598147) := TRANSFORM
    __EE9598191 := __PP9598147.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9598191),__ST345555_Layout),__NL(__EE9598191));
    SELF := __PP9598147;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9598146,__ND9598151__Project(LEFT));
END;
