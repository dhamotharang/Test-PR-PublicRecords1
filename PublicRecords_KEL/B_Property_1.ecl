...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5156277 := __ENH_Property_2;
  EXPORT __ST233457_Layout := RECORD
  ...
  END;
  EXPORT __ST233439_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST233457_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST233439_Layout __ND5156282__Project(B_Property_2(__in,__cfg).__ST169370_Layout __PP5156278) := TRANSFORM
    __EE5156321 := __PP5156278.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE5156321),__ST233457_Layout),__NL(__EE5156321));
    SELF := __PP5156278;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE5156277,__ND5156282__Project(LEFT));
END;
