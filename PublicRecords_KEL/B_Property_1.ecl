...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9384352 := __ENH_Property_2;
  EXPORT __ST308307_Layout := RECORD
  ...
  END;
  EXPORT __ST308289_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST308307_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST308289_Layout __ND9384357__Project(B_Property_2(__in,__cfg).__ST223945_Layout __PP9384353) := TRANSFORM
    __EE9384397 := __PP9384353.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9384397),__ST308307_Layout),__NL(__EE9384397));
    SELF := __PP9384353;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9384352,__ND9384357__Project(LEFT));
END;
