...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7939674 := __ENH_Property_2;
  ...
  END;
  EXPORT __ST264441_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST264459_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264441_Layout __ND7939679__Project(B_Property_2(__in,__cfg).__ST209678_Layout __PP7939675) := TRANSFORM
    __EE7939719 := __PP7939675.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE7939719),__ST264459_Layout),__NL(__EE7939719));
    SELF := __PP7939675;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE7939674,__ND7939679__Project(LEFT));
END;
