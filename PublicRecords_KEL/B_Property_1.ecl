...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE10281060 := __ENH_Property_2;
  EXPORT __ST334504_Layout := RECORD
  ...
  END;
  EXPORT __ST334486_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST334504_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST334486_Layout __ND10281065__Project(B_Property_2(__in,__cfg).__ST238243_Layout __PP10281061) := TRANSFORM
    __EE10281105 := __PP10281061.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE10281105),__ST334504_Layout),__NL(__EE10281105));
    SELF := __PP10281061;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE10281060,__ND10281065__Project(LEFT));
END;
