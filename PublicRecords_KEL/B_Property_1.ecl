...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9708993 := __ENH_Property_2;
  EXPORT __ST348890_Layout := RECORD
  ...
  END;
  EXPORT __ST348872_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST348890_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST348872_Layout __ND9708998__Project(B_Property_2(__in,__cfg).__ST230939_Layout __PP9708994) := TRANSFORM
    __EE9709038 := __PP9708994.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE9709038),__ST348890_Layout),__NL(__EE9709038));
    SELF := __PP9708994;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE9708993,__ND9708998__Project(LEFT));
END;
