...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8433749 := __ENH_Property_2;
  EXPORT __ST283490_Layout := RECORD
  ...
  END;
  EXPORT __ST283472_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST283490_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST283472_Layout __ND8433754__Project(B_Property_2(__in,__cfg).__ST218171_Layout __PP8433750) := TRANSFORM
    __EE8433794 := __PP8433750.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8433794),__ST283490_Layout),__NL(__EE8433794));
    SELF := __PP8433750;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8433749,__ND8433754__Project(LEFT));
END;
