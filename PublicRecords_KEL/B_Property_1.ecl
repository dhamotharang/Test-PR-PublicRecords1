...
EXPORT B_Property_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8446771 := __ENH_Property_2;
  EXPORT __ST289722_Layout := RECORD
  ...
  END;
  EXPORT __ST289704_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST289722_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST289704_Layout __ND8446776__Project(B_Property_2(__in,__cfg).__ST218530_Layout __PP8446772) := TRANSFORM
    __EE8446816 := __PP8446772.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE8446816),__ST289722_Layout),__NL(__EE8446816));
    SELF := __PP8446772;
  END;
  EXPORT __ENH_Property_1 := PROJECT(__EE8446771,__ND8446776__Project(LEFT));
END;
