...
EXPORT B_Input_P_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE265421 := __ENH_Input_P_I_I_1;
  EXPORT __ST23207_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST23207_Layout __ND265583__Project(B_Input_P_I_I_1(__in,__cfg).__ST27130_Layout __PP264626) := TRANSFORM
    SELF.I_Rep_Number_Value_ := __PP264626.Rep_Number_;
    SELF.Input_Account_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP264626.Input_Account_Echo_));
    __CC3203 := '-99999';
    __CC3208 := '-99998';
    SELF.Input_Archive_Date_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP264626.Input_Archive_Date_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,__CN(__CC3208)));
    SELF.Input_Archive_Date_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP264626.Input_Archive_Date_Echo_));
    SELF.Input_Archive_Date_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP264626.Input_Archive_Date_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3203)));
    SELF.Input_Work_Phone_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP264626.Input_Work_Phone_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,__CN(__CC3208)));
    SELF.Input_Work_Phone_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP264626.Input_Work_Phone_Echo_));
    SELF.Input_Work_Phone_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP264626.Input_Work_Phone_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3203)));
    SELF := __PP264626;
  END;
  EXPORT __ENH_Input_P_I_I := PROJECT(__EE265421,__ND265583__Project(LEFT));
END;
