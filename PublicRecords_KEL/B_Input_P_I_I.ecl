...
EXPORT B_Input_P_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE128411 := __ENH_Input_P_I_I_1;
  EXPORT __ST16649_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST16649_Layout __ND128611__Project(B_Input_P_I_I_1(__in,__cfg).__ST18849_Layout __PP127411) := TRANSFORM
    SELF.I_Rep_Number_Value_ := __PP127411.Rep_Number_;
    SELF.Input_Account_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Account_Echo_));
    __CC3032 := '-99';
    __CC3037 := '-98';
    SELF.Input_Archive_Date_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Archive_Date_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Archive_Date_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Archive_Date_Echo_));
    SELF.Input_Archive_Date_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_Archive_Date_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_D_L_State_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_D_L_State_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_D_L_State_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_D_L_State_Echo_));
    SELF.Input_D_L_State_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_D_L_State_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_D_L_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_D_L_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_D_O_B_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_D_O_B_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_Full_Address_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Full_Address_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Last_Name_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_Last_Name_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_Lex_I_D_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Lex_I_D_Echo_));
    SELF.Input_Middle_Name_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Middle_Name_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Middle_Name_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Middle_Name_Echo_));
    SELF.Input_Middle_Name_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_Middle_Name_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_Prefix_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Prefix_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_S_S_N_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_S_S_N_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF.Input_Street_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Suffix_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Suffix_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Work_Phone_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Work_Phone_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3032)),__ECAST(KEL.typ.nstr,__CN(__CC3037)));
    SELF.Input_Work_Phone_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP127411.Input_Work_Phone_Echo_));
    SELF.Input_Work_Phone_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP127411.Input_Work_Phone_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3032)));
    SELF := __PP127411;
  END;
  EXPORT __ENH_Input_P_I_I := PROJECT(__EE128411,__ND128611__Project(LEFT));
END;
