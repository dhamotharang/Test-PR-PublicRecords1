...
EXPORT B_Input_P_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE148306 := __ENH_Input_P_I_I_1;
  EXPORT __ST19906_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST19906_Layout __ND148468__Project(B_Input_P_I_I_1(__in,__cfg).__ST22865_Layout __PP147511) := TRANSFORM
    SELF.I_Rep_Number_Value_ := __PP147511.Rep_Number_;
    SELF.Input_Account_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP147511.Input_Account_Echo_));
    __CC3192 := '-99999';
    __CC3197 := '-99998';
    SELF.Input_Archive_Date_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP147511.Input_Archive_Date_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,__CN(__CC3197)));
    SELF.Input_Archive_Date_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP147511.Input_Archive_Date_Echo_));
    SELF.Input_Archive_Date_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP147511.Input_Archive_Date_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3192)));
    SELF.Input_Work_Phone_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP147511.Input_Work_Phone_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,__CN(__CC3197)));
    SELF.Input_Work_Phone_Echo_Pop_Value_ := FN_Compile.FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP147511.Input_Work_Phone_Echo_));
    SELF.Input_Work_Phone_Value_ := FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP147511.Input_Work_Phone_Echo_),__ECAST(KEL.typ.nstr,__CN(__CC3192)));
    SELF := __PP147511;
  END;
  EXPORT __ENH_Input_P_I_I := PROJECT(__EE148306,__ND148468__Project(LEFT));
END;
