...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8001570 := __ENH_Sele_Person_3;
  EXPORT __ST222143_Layout := RECORD
  ...
  END;
  SHARED __ST222143_Layout __ND8001575__Project(B_Sele_Person_3(__in,__cfg).__ST237151_Layout __PP8001571) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8001571.Assoc_Fs_Date_,__CC13435);
    SELF := __PP8001571;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8001570,__ND8001575__Project(LEFT));
END;
