...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7538269 := __ENH_Sele_Person_3;
  EXPORT __ST217592_Layout := RECORD
  ...
  END;
  SHARED __ST217592_Layout __ND7538274__Project(B_Sele_Person_3(__in,__cfg).__ST232170_Layout __PP7538270) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7538270.Assoc_Fs_Date_,__CC13228);
    SELF := __PP7538270;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7538269,__ND7538274__Project(LEFT));
END;
