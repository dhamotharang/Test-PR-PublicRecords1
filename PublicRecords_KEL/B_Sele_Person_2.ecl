...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7567230 := __ENH_Sele_Person_3;
  EXPORT __ST219045_Layout := RECORD
  ...
  END;
  SHARED __ST219045_Layout __ND7567235__Project(B_Sele_Person_3(__in,__cfg).__ST233747_Layout __PP7567231) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7567231.Assoc_Fs_Date_,__CC13263);
    SELF := __PP7567231;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7567230,__ND7567235__Project(LEFT));
END;
