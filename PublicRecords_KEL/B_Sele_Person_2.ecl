...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7578818 := __ENH_Sele_Person_3;
  EXPORT __ST219404_Layout := RECORD
  ...
  END;
  SHARED __ST219404_Layout __ND7578823__Project(B_Sele_Person_3(__in,__cfg).__ST234132_Layout __PP7578819) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7578819.Assoc_Fs_Date_,__CC13333);
    SELF := __PP7578819;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7578818,__ND7578823__Project(LEFT));
END;
