...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8250253 := __ENH_Sele_Person_3;
  EXPORT __ST231804_Layout := RECORD
  ...
  END;
  SHARED __ST231804_Layout __ND8250258__Project(B_Sele_Person_3(__in,__cfg).__ST246924_Layout __PP8250254) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8250254.Assoc_Fs_Date_,__CC13435);
    SELF := __PP8250254;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8250253,__ND8250258__Project(LEFT));
END;
