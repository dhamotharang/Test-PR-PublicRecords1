...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7207205 := __ENH_Sele_Person_3;
  EXPORT __ST211232_Layout := RECORD
  ...
  END;
  SHARED __ST211232_Layout __ND7207210__Project(B_Sele_Person_3(__in,__cfg).__ST225566_Layout __PP7207206) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7207206.Assoc_Fs_Date_,__CC13210);
    SELF := __PP7207206;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7207205,__ND7207210__Project(LEFT));
END;
