...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7719150 := __ENH_Sele_Person_3;
  EXPORT __ST216698_Layout := RECORD
  ...
  END;
  SHARED __ST216698_Layout __ND7719155__Project(B_Sele_Person_3(__in,__cfg).__ST231352_Layout __PP7719151) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7719151.Assoc_Fs_Date_,__CC13214);
    SELF := __PP7719151;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7719150,__ND7719155__Project(LEFT));
END;
