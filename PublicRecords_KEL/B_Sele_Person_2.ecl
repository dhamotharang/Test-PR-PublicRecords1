...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6915360 := __ENH_Sele_Person_3;
  EXPORT __ST215103_Layout := RECORD
  ...
  END;
  SHARED __ST215103_Layout __ND6915365__Project(B_Sele_Person_3(__in,__cfg).__ST229399_Layout __PP6915361) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP6915361.Assoc_Fs_Date_,__CC13450);
    SELF := __PP6915361;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE6915360,__ND6915365__Project(LEFT));
END;
