...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7203177 := __ENH_Sele_Person_3;
  EXPORT __ST210726_Layout := RECORD
  ...
  END;
  SHARED __ST210726_Layout __ND7203182__Project(B_Sele_Person_3(__in,__cfg).__ST225078_Layout __PP7203178) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7203178.Assoc_Fs_Date_,__CC13174);
    SELF := __PP7203178;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7203177,__ND7203182__Project(LEFT));
END;
