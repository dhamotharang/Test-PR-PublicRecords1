...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8254718 := __ENH_Sele_Person_3;
  EXPORT __ST231878_Layout := RECORD
  ...
  END;
  SHARED __ST231878_Layout __ND8254723__Project(B_Sele_Person_3(__in,__cfg).__ST247011_Layout __PP8254719) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8254719.Assoc_Fs_Date_,__CC13435);
    SELF := __PP8254719;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8254718,__ND8254723__Project(LEFT));
END;
