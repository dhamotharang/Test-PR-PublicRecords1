...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8214796 := __ENH_Sele_Person_3;
  EXPORT __ST228015_Layout := RECORD
  ...
  END;
  SHARED __ST228015_Layout __ND8214801__Project(B_Sele_Person_3(__in,__cfg).__ST243133_Layout __PP8214797) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8214797.Assoc_Fs_Date_,__CC13398);
    SELF := __PP8214797;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8214796,__ND8214801__Project(LEFT));
END;
