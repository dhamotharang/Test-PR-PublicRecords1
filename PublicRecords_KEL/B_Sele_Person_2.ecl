...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7204812 := __ENH_Sele_Person_3;
  EXPORT __ST210552_Layout := RECORD
  ...
  END;
  SHARED __ST210552_Layout __ND7204817__Project(B_Sele_Person_3(__in,__cfg).__ST224886_Layout __PP7204813) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7204813.Assoc_Fs_Date_,__CC13185);
    SELF := __PP7204813;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7204812,__ND7204817__Project(LEFT));
END;
