...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7578788 := __ENH_Sele_Person_3;
  EXPORT __ST219374_Layout := RECORD
  ...
  END;
  SHARED __ST219374_Layout __ND7578793__Project(B_Sele_Person_3(__in,__cfg).__ST234102_Layout __PP7578789) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7578789.Assoc_Fs_Date_,__CC13303);
    SELF := __PP7578789;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7578788,__ND7578793__Project(LEFT));
END;
