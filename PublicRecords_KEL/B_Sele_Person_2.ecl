...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8085377 := __ENH_Sele_Person_3;
  EXPORT __ST225133_Layout := RECORD
  ...
  END;
  SHARED __ST225133_Layout __ND8085382__Project(B_Sele_Person_3(__in,__cfg).__ST240247_Layout __PP8085378) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8085378.Assoc_Fs_Date_,__CC13435);
    SELF := __PP8085378;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8085377,__ND8085382__Project(LEFT));
END;
