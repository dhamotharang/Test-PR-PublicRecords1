...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8064757 := __ENH_Sele_Person_3;
  EXPORT __ST224831_Layout := RECORD
  ...
  END;
  SHARED __ST224831_Layout __ND8064762__Project(B_Sele_Person_3(__in,__cfg).__ST239945_Layout __PP8064758) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8064758.Assoc_Fs_Date_,__CC13435);
    SELF := __PP8064758;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8064757,__ND8064762__Project(LEFT));
END;
