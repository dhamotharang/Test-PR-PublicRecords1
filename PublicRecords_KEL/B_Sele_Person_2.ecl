...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1915372 := __ENH_Sele_Person_3;
  EXPORT __ST136588_Layout := RECORD
  ...
  END;
  SHARED __ST136588_Layout __ND1915495__Project(B_Sele_Person_3(__in,__cfg).__ST147245_Layout __PP1915206) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP1915206.Assoc_Fs_Date_,__CC9656);
    SELF := __PP1915206;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE1915372,__ND1915495__Project(LEFT));
END;
