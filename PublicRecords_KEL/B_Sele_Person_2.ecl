...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9270391 := __ENH_Sele_Person_3;
  EXPORT __ST245857_Layout := RECORD
  ...
  END;
  SHARED __ST245857_Layout __ND9270396__Project(B_Sele_Person_3(__in,__cfg).__ST261514_Layout __PP9270392) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP9270392.Assoc_Fs_Date_,__CC13459);
    SELF := __PP9270392;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE9270391,__ND9270396__Project(LEFT));
END;
