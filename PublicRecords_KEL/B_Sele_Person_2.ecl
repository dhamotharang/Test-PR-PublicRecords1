...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7999984 := __ENH_Sele_Person_3;
  EXPORT __ST222173_Layout := RECORD
  ...
  END;
  SHARED __ST222173_Layout __ND7999989__Project(B_Sele_Person_3(__in,__cfg).__ST237181_Layout __PP7999985) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7999985.Assoc_Fs_Date_,__CC13435);
    SELF := __PP7999985;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7999984,__ND7999989__Project(LEFT));
END;
