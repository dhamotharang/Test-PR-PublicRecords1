...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8852546 := __ENH_Sele_Person_3;
  EXPORT __ST239129_Layout := RECORD
  ...
  END;
  SHARED __ST239129_Layout __ND8852551__Project(B_Sele_Person_3(__in,__cfg).__ST255010_Layout __PP8852547) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8852547.Assoc_Fs_Date_,__CC13400);
    SELF := __PP8852547;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8852546,__ND8852551__Project(LEFT));
END;
