...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7207200 := __ENH_Sele_Person_3;
  EXPORT __ST211227_Layout := RECORD
  ...
  END;
  SHARED __ST211227_Layout __ND7207205__Project(B_Sele_Person_3(__in,__cfg).__ST225561_Layout __PP7207201) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP7207201.Assoc_Fs_Date_,__CC13205);
    SELF := __PP7207201;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE7207200,__ND7207205__Project(LEFT));
END;
