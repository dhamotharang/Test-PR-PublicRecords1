...
EXPORT B_Sele_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8084189 := __ENH_Sele_Person_3;
  EXPORT __ST223776_Layout := RECORD
  ...
  END;
  SHARED __ST223776_Layout __ND8084194__Project(B_Sele_Person_3(__in,__cfg).__ST238758_Layout __PP8084190) := TRANSFORM
    ...
    SELF.Datemonths_ := __FN2(KEL.Routines.MonthsBetween,__PP8084190.Assoc_Fs_Date_,__CC13377);
    SELF := __PP8084190;
  END;
  EXPORT __ENH_Sele_Person_2 := PROJECT(__EE8084189,__ND8084194__Project(LEFT));
END;
