...
IMPORT B_Tradeline_Business_2,B_Tradeline_Business_3,CFG_Compile,E_Business,E_Tradeline,E_Tradeline_Business FROM PublicRecords_KEL;
...
EXPORT B_Tradeline_Business_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE266358 := __ENH_Tradeline_Business_2;
  EXPORT __ENH_Tradeline_Business_1 := __EE266358;
END;
