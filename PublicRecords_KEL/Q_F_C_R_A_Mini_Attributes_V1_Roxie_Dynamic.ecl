...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Roxie_Dynamic(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE12867689 := __ENH_Person;
  SHARED __EE12869749 := __EE12867689(__T(__OP2(__EE12867689.UID,IN,__CN(__PLexID_in))));
  SHARED __ST127672_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12869749,TRANSFORM(__ST127672_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
