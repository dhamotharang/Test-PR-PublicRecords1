...
EXPORT Q_F_C_R_A_Mini_Attributes_V1_Roxie_Dynamic(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11606196 := __ENH_Person;
  SHARED __EE11608084 := __EE11606196(__T(__OP2(__EE11606196.UID,IN,__CN(__PLexID_in))));
  SHARED __ST122729_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11608084,TRANSFORM(__ST122729_Layout,SELF.Lex_I_D_ := LEFT.UID,SELF := LEFT)));
