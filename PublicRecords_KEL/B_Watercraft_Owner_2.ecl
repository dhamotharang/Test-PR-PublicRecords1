...
EXPORT B_Watercraft_Owner_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7241739 := __ENH_Watercraft_Owner_3;
  EXPORT __ST211727_Layout := RECORD
  ...
  END;
  SHARED __ST211727_Layout __ND7241784__Project(B_Watercraft_Owner_3(__in,__cfg).__ST225862_Layout __PP7241740) := TRANSFORM
    __CC13561 := '-99997';
    SELF.Watercraft_Min_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP7241740.Date_First_Seen_Capped_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP7241740.Date_First_Seen_Capped_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13561)));
    SELF := __PP7241740;
  END;
  EXPORT __ENH_Watercraft_Owner_2 := PROJECT(__EE7241739,__ND7241784__Project(LEFT));
END;
