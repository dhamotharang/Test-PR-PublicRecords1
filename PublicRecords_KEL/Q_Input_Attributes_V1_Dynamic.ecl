...
EXPORT Q_Input_Attributes_V1_Dynamic(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, KEL.typ.bool __PisFCRA, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE15035995 := __ENH_Input_P_I_I;
  SHARED __EE15035998 := __ENH_Person;
  SHARED __ST5438669_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST182162_Layout) Full_Name_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST182178_Layout) Reported_Dates_Of_Birth_;
    KEL.typ.ndataset(E_Person(__in,__cfg_Local).Reported_Dates_Of_Death_Layout) Reported_Dates_Of_Death_;
    KEL.typ.nstr Race_;
    KEL.typ.nstr Race_Description_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST182194_Layout) Data_Sources_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST101647_Layout) A_V_M_List_;
    KEL.typ.ndataset(B_Person_Accident_8(__in,__cfg_Local).__ST275736_Layout) Accident_Recs_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST106976_Layout) Accident_Recs_Formatted_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST106976_Layout) Accident_Recs_Formatted_Dedup_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST106976_Layout) Accident_Recs_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST96898_Layout) Active_Professional_License_Issue_Exp_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST97076_Layout) Active_Professional_License_Issue_Exp_Date_Group_;
    ...
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST85373_Layout) Address_Hierarchy_Set_;
    KEL.typ.nint Age_;
    KEL.typ.nbool Age_More_Than18_;
    KEL.typ.nkdate Aircraft_Build_Current_Date_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST102751_Layout) All_Inquiries_Past5_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST2679930_Layout) All_Lien_Data_;
    ...
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST85373_Layout) Curr_Addr_Full_Set_;
    ...
    B_Person_10(__in,__cfg_Local).__ST85373_Layout Current_;
    ...
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST99878_Layout) Edu_Coll_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST99878_Layout) Edu_Coll_Rec_Ver_Source_List_Filtered_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST99878_Layout) Edu_H_S_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST99878_Layout) Edu_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST99851_Layout) Edu_Rec_Ver_Source_List_Pre_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST99878_Layout) Edu_Rec_Ver_Source_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102334_Layout) Inquiries5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Auto_Srch5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102998_Layout) Inquiries_Auto_Srch5_Y_List_Sorted_;
    KEL.typ.nint Inquiries_Banking5_Y_Count_;
    KEL.typ.nstr Inquiries_Banking5_Y_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST102800_Layout) Inquiries_Banking5_Y_Sorted_;
    KEL.typ.nint Inquiries_Comm5_Y_Count_;
    KEL.typ.nstr Inquiries_Comm5_Y_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST103796_Layout) Inquiries_Comm5_Y_Sorted_;
    KEL.typ.nstr Inquiries_Dt5_Y_List_;
    KEL.typ.nstr Inquiries_High_Risk5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102558_Layout) Inquiries_High_Risk5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Mortgage5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST103197_Layout) Inquiries_Mortgage5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Other5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST104716_Layout) Inquiries_Other5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Over_All5_Y_Dt_List_;
    KEL.typ.nstr Inquiries_Prepaid_Card5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST103595_Layout) Inquiries_Prepaid_Card5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Quiz_Provider5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST104392_Layout) Inquiries_Quiz_Provider5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Retail_Payment5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST104193_Layout) Inquiries_Retail_Payment5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Student_Loan5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST103994_Layout) Inquiries_Student_Loan5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Utility5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST103396_Layout) Inquiries_Utility5_Y_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST106640_Layout) Is_Bureau_Source_Test_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST98754_Layout) L_T_D7_Y_List_Sorted_;
    ...
    B_Person_6(__in,__cfg_Local).__ST106976_Layout Latest_Acc_With_Amount_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST99770_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST99334_Layout) Ln_J7_Y_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST106481_Layout) Members_Not_Subject_;
    KEL.typ.nint Months_Since_;
    KEL.typ.nstr Most_Recent_Chapter10_Y_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST95154_Layout) Most_Recent_Chapter10_Y_List_;
    KEL.typ.nstr Most_Recent_Chapter10_Y_With_Null_;
    KEL.typ.nstr Most_Recent_Chapter1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94948_Layout) Most_Recent_Chapter1_Y_List_;
    KEL.typ.nstr Most_Recent_Chapter1_Y_With_Null_;
    KEL.typ.nstr Most_Recent_Chapter7_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95051_Layout) Most_Recent_Chapter7_Y_List_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST95943_Layout) Most_Recent_Dispo_List10_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95839_Layout) Most_Recent_Dispo_List1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95891_Layout) Most_Recent_Dispo_List7_Y_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95564_Layout) Most_Recent_Update_Bks10_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95438_Layout) Most_Recent_Update_Bks1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95501_Layout) Most_Recent_Update_Bks7_Y_;
    B_Person_1(__in,__cfg_Local).__ST97704_Layout Only_Curr_Address_Helper_Flag_;
    B_Person_1(__in,__cfg_Local).__ST98360_Layout Only_Previous_Address_Helper_Flag_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST92552_Layout) P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST4339320_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST4339340_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
    KEL.typ.int P_L___Ast_Veh_Wtr_Cnt_Ev_ := 0;
    KEL.typ.nstr P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST92812_Layout) P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94849_Layout) P_L___Drg_Bk_Ch_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Ch_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94765_Layout) P_L___Drg_Bk_Ch_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Ch_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94807_Layout) P_L___Drg_Bk_Ch_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95752_Layout) P_L___Drg_Bk_Disp_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Disp_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95660_Layout) P_L___Drg_Bk_Disp_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Disp_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95706_Layout) P_L___Drg_Bk_Disp_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94513_Layout) P_L___Drg_Bk_Dt_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Dt_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94443_Layout) P_L___Drg_Bk_Dt_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Dt_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94478_Layout) P_L___Drg_Bk_Dt_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST96396_Layout) P_L___Drg_Bk_Type_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Type_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST96304_Layout) P_L___Drg_Bk_Type_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Type_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST96350_Layout) P_L___Drg_Bk_Type_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST96846_Layout) P_L___Prof_Lic_Indx_By_Lic_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1066831_Layout) Person_S_S_N_Match_Sources_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST107899_Layout) Person_S_S_N_Match_Sources_Pre_;
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST85373_Layout) Prev_Addr_Full_Set_;
    B_Person_10(__in,__cfg_Local).__ST85373_Layout Previous_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST96798_Layout) Professional_License_Dates_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST101309_Layout) Property_Data_Set_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST101309_Layout) Property_Date_First_Seen_Sorted_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST101309_Layout) Property_Date_Last_Seen_Sorted_;
    KEL.typ.nstr Property_Min_Date_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST101309_Layout) Property_Sales_Sorted_;
    KEL.typ.int Purchase1_Y_Count_ := 0;
    KEL.typ.int Purchase5_Y_Count_ := 0;
    KEL.typ.int Purchase_Count_Ever_ := 0;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102004_Layout) Purchase_Date_List_Sorted_;
    KEL.typ.nstr Purchase_New_Date_Ev_;
    KEL.typ.nstr Purchase_Old_Date_Ev_;
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST85373_Layout) Recent_Addr_Full_Set_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST104584_Layout) Retail_Inquiries5_Yrs_;
    KEL.typ.nkdate Select_Age_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST107316_Layout) Short_Term_Loans1_Y_Sorted_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST107316_Layout) Short_Term_Loans2_Y_Sorted_;
    KEL.typ.nstr Short_Term_Loans5_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST107316_Layout) Short_Term_Loans5_Y_Sorted_;
    KEL.typ.nstr Suit7_Y_New_Date_;
    KEL.typ.nstr Suit7_Y_Old_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST99113_Layout) Suits7_Y_List_Sorted_;
    KEL.typ.nstr Suits_Amount7_Y_List_;
    KEL.typ.nstr Suits_Dates7_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST107316_Layout) Thrive_Data_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST137500_Layout) Top1_Chapter10_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST95102_Layout) Top1_Chapter10_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST137422_Layout) Top1_Chapter1_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94893_Layout) Top1_Chapter1_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST137461_Layout) Top1_Chapter7_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94999_Layout) Top1_Chapter7_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST96561_Layout) Top1_Dt_Of_Bks_List10_Y_With_Null_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST137532_Layout) Top1_Dt_Of_Bks_List1_Y_With_Null_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST137570_Layout) Top1_Dt_Of_Bks_List7_Y_With_Null_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST575507_Layout) Translated_Sources_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST2680753_Layout) Unique_Addresses_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST100868_Layout) Util_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST100850_Layout) Util_List_Pre_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST100868_Layout) Util_List_Sorted_;
    KEL.typ.nkdate Vehicle_Build_Current_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST137840_Layout) Velocity_Inquiries_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_A_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_A_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_F_L_A_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_F_L_A_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_F_L_A_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_F_L_A_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_F_L_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_F_L_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_F_L_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_F_L_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667786_Layout) Velocity_Inquiries_With_S_D_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1667807_Layout) Velocity_Inquiries_With_S_D_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110236_Layout) Velocity_Inquiry_Addrs_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105501_Layout) Velocity_Inquiry_Addrs_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110324_Layout) Velocity_Inquiry_D_O_Bs_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105577_Layout) Velocity_Inquiry_D_O_Bs_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105595_Layout) Velocity_Inquiry_Emails_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110282_Layout) Velocity_Inquiry_First_Names_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105541_Layout) Velocity_Inquiry_First_Names_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST137863_Layout) Velocity_Inquiry_Last_Names_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110261_Layout) Velocity_Inquiry_Last_Names_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105523_Layout) Velocity_Inquiry_Last_Names_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST137856_Layout) Velocity_Inquiry_Lex_I_Ds_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110303_Layout) Velocity_Inquiry_Phones_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105559_Layout) Velocity_Inquiry_Phones_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST137870_Layout) Velocity_Inquiry_S_S_Ns_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST110215_Layout) Velocity_Inquiry_S_S_Ns_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST105483_Layout) Velocity_Inquiry_S_S_Ns_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745475_Layout) Ver_Inp_F_Names_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745475_Layout) Ver_Inp_F_Names_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745490_Layout) Ver_Inp_L_Names_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745490_Layout) Ver_Inp_L_Names_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1066831_Layout) Ver_S_S_N_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1066831_Layout) Ver_S_S_N_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST106620_Layout) Ver_Source_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST106640_Layout) Ver_Source_List_Sorted_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST135042_Layout) Ver_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST107548_Layout) Verified_First_Name_Sources_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745475_Layout) Verified_First_Name_Sources_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745475_Layout) Verified_First_Name_Sources_With_Dates_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST107710_Layout) Verified_Last_Name_Sources_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745490_Layout) Verified_Last_Name_Sources_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST745490_Layout) Verified_Last_Name_Sources_With_Dates_;
  ...
  END;
  __JC15039371(B_Input_P_I_I(__in,__cfg_Local).__ST167233_Layout __EE15035995, B_Person(__in,__cfg_Local).__ST182156_Layout __EE15035998) := __EEQP(__EE15035995.Subject_,__EE15035998.UID);
  __ST5438669_Layout __JT15039371(B_Input_P_I_I(__in,__cfg_Local).__ST167233_Layout __l, B_Person(__in,__cfg_Local).__ST182156_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE15039372 := JOIN(__EE15035998,__EE15035995,__JC15039371(RIGHT,LEFT),__JT15039371(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST86098_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST86098_Layout __ND15044884__Project(__ST5438669_Layout __PP15036008) := TRANSFORM
    SELF.G___Proc_U_I_D_ := __PP15036008.UID;
    SELF.P___Inp_Acct_ := __PP15036008.Input_Account_Value_;
    SELF.P___Inp_Lex_I_D_ := __PP15036008.Input_Lex_I_D_Value_;
    SELF.P___Inp_Name_First_ := __PP15036008.Input_First_Name_Value_;
    SELF.P___Inp_Name_Mid_ := __PP15036008.Input_Middle_Name_Value_;
    SELF.P___Inp_Name_Last_ := __PP15036008.Input_Last_Name_Value_;
    SELF.P___Inp_Addr_Line1_ := __PP15036008.Input_Street_Value_;
    SELF.P___Inp_Addr_Line2_ := __PP15036008.P___Inp_Addr_Line2_Value_;
    SELF.P___Inp_Addr_City_ := __PP15036008.Input_City_Value_;
    SELF.P___Inp_Addr_State_ := __PP15036008.Input_State_Value_;
    SELF.P___Inp_Addr_Zip_ := __PP15036008.Input_Zip_Value_;
    SELF.P___Inp_S_S_N_ := __PP15036008.Input_S_S_N_Value_;
    SELF.P___Inp_D_O_B_ := __PP15036008.Input_D_O_B_Value_;
    SELF.P___Inp_D_L_ := __PP15036008.Input_D_L_Value_;
    SELF.P___Inp_D_L_State_ := __PP15036008.Input_D_L_State_Value_;
    SELF.P___Inp_Phone_Home_ := __PP15036008.Input_Home_Phone_Value_;
    SELF.P___Inp_Phone_Work_ := __PP15036008.Input_Work_Phone_Value_;
    SELF.P___Inp_Email_ := __PP15036008.Input_Email_Value_;
    SELF.P___Inp_I_P_Addr_ := __PP15036008.Input_I_P_Addr_Value_;
    SELF.P___Inp_Arch_Dt_ := __PP15036008.Input_Archive_Date_Value_;
    SELF.P___Inp_Acct_Flag_ := __PP15036008.P___Inp_Acct_Flag_Value_;
    SELF.P___Inp_Lex_I_D_Flag_ := __PP15036008.P___Inp_Lex_I_D_Flag_Value_;
    SELF.P___Inp_Name_First_Flag_ := __PP15036008.P___Inp_Name_First_Flag_Value_;
    SELF.P___Inp_Name_Mid_Flag_ := __PP15036008.P___Inp_Name_Mid_Flag_Value_;
    SELF.P___Inp_Name_Last_Flag_ := __PP15036008.P___Inp_Name_Last_Flag_Value_;
    SELF.P___Inp_Addr_St_Flag_ := __PP15036008.P___Inp_Addr_St_Flag_Value_;
    SELF.P___Inp_Addr_City_Flag_ := __PP15036008.P___Inp_Addr_City_Flag_Value_;
    SELF.P___Inp_Addr_State_Flag_ := __PP15036008.P___Inp_Addr_State_Flag_Value_;
    SELF.P___Inp_Addr_Zip_Flag_ := __PP15036008.P___Inp_Addr_Zip_Flag_Value_;
    SELF.P___Inp_S_S_N_Flag_ := __PP15036008.P___Inp_S_S_N_Flag_Value_;
    SELF.P___Inp_D_O_B_Flag_ := __PP15036008.P___Inp_D_O_B_Flag_Value_;
    SELF.P___Inp_D_L_Flag_ := __PP15036008.P___Inp_D_L_Flag_Value_;
    SELF.P___Inp_D_L_State_Flag_ := __PP15036008.P___Inp_D_L_State_Flag_Value_;
    SELF.P___Inp_Phone_Home_Flag_ := __PP15036008.P___Inp_Phone_Home_Flag_Value_;
    SELF.P___Inp_Phone_Work_Flag_ := __PP15036008.P___Inp_Phone_Work_Flag_Value_;
    SELF.P___Inp_Email_Flag_ := __PP15036008.P___Inp_Email_Flag_Value_;
    SELF.P___Inp_I_P_Addr_Flag_ := __PP15036008.P___Inp_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Arch_Dt_Flag_ := __PP15036008.P___Inp_Arch_Dt_Flag_Value_;
    SELF.P___Inp_Cln_Name_Prfx_ := __PP15036008.Input_Prefix_Clean_Value_;
    SELF.P___Inp_Cln_Name_First_ := __PP15036008.Input_First_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Mid_ := __PP15036008.Input_Middle_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Last_ := __PP15036008.Input_Last_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Sffx_ := __PP15036008.Input_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP15036008.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_ := __PP15036008.Input_Pre_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP15036008.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_ := __PP15036008.Input_Address_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_ := __PP15036008.Input_Post_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_ := __PP15036008.Input_Unit_Desig_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_ := __PP15036008.Input_Secondary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_ := __PP15036008.Input_City_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_ := __PP15036008.Input_City_Post_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_ := __PP15036008.Input_State_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP15036008.Input_Zip5_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_ := __PP15036008.Input_Zip4_Clean_Value_;
    SELF.P___Inp_Cln_Addr_St_ := __PP15036008.Input_Street_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Full_ := __PP15036008.Input_Full_Address_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lat_ := __PP15036008.Input_Latitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lng_ := __PP15036008.Input_Longitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_Code_ := __PP15036008.Input_State_Code_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_ := __PP15036008.Input_County_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Geo_ := __PP15036008.Input_Geoblock_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Type_ := __PP15036008.Input_Address_Type_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Status_ := __PP15036008.Input_Address_Status_Clean_Value_;
    SELF.P___Inp_Cln_S_S_N_ := __PP15036008.Input_S_S_N_Clean_Value_;
    SELF.P___Inp_Cln_D_O_B_ := __PP15036008.Input_D_O_B_Clean_Value_;
    SELF.P___Inp_Cln_D_L_ := __PP15036008.Input_D_L_Clean_Value_;
    SELF.P___Inp_Cln_D_L_State_ := __PP15036008.Input_D_L_State_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Home_ := __PP15036008.Input_Home_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Work_ := __PP15036008.Input_Work_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Email_ := __PP15036008.Input_Email_Clean_Value_;
    SELF.P___Inp_Cln_Arch_Dt_ := __PP15036008.Input_Archive_Date_Clean_Value_;
    SELF.P___Inp_Cln_Name_Prfx_Flag_ := __PP15036008.P___Inp_Cln_Name_Prfx_Flag_Value_;
    SELF.P___Inp_Cln_Name_First_Flag_ := __PP15036008.P___Inp_Cln_Name_First_Flag_Value_;
    SELF.P___Inp_Cln_Name_Mid_Flag_ := __PP15036008.P___Inp_Cln_Name_Mid_Flag_Value_;
    SELF.P___Inp_Cln_Name_Last_Flag_ := __PP15036008.P___Inp_Cln_Name_Last_Flag_Value_;
    SELF.P___Inp_Cln_Name_Sffx_Flag_ := __PP15036008.P___Inp_Cln_Name_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_Flag_ := __PP15036008.P___Inp_Cln_Addr_Prim_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_Flag_ := __PP15036008.P___Inp_Cln_Addr_Pre_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_Flag_ := __PP15036008.P___Inp_Cln_Addr_Prim_Name_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_Flag_ := __PP15036008.P___Inp_Cln_Addr_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_Flag_ := __PP15036008.P___Inp_Cln_Addr_Post_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_Flag_ := __PP15036008.P___Inp_Cln_Addr_Unit_Desig_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_Flag_ := __PP15036008.P___Inp_Cln_Addr_Sec_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Flag_ := __PP15036008.P___Inp_Cln_Addr_City_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_Flag_ := __PP15036008.P___Inp_Cln_Addr_City_Post_Flag_Value_;
    SELF.P___Inp_Cln_Addr_State_Flag_ := __PP15036008.P___Inp_Cln_Addr_State_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_Flag_ := __PP15036008.P___Inp_Cln_Addr_Zip5_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_Flag_ := __PP15036008.P___Inp_Cln_Addr_Zip4_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_Bad_Len_Flag_ := __PP15036008.P___Inp_Val_Addr_Zip_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_All_Zero_Flag_ := __PP15036008.P___Inp_Val_Addr_Zip_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Addr_State_Bad_Abbr_Flag_ := __PP15036008.P___Inp_Val_Addr_State_Bad_Abbr_Flag_Value_;
    SELF.P___Inp_Cln_Addr_St_Flag_ := __PP15036008.P___Inp_Cln_Addr_St_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Full_Flag_ := __PP15036008.P___Inp_Cln_Addr_Full_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lat_Flag_ := __PP15036008.P___Inp_Cln_Addr_Lat_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lng_Flag_ := __PP15036008.P___Inp_Cln_Addr_Lng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_Flag_ := __PP15036008.P___Inp_Cln_Addr_Cnty_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Geo_Flag_ := __PP15036008.P___Inp_Cln_Addr_Geo_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Type_Flag_ := __PP15036008.P___Inp_Cln_Addr_Type_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Status_Flag_ := __PP15036008.P___Inp_Cln_Addr_Status_Flag_Value_;
    SELF.P___Inp_Cln_S_S_N_Flag_ := __PP15036008.P___Inp_Cln_S_S_N_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Char_Flag_ := __PP15036008.P___Inp_Val_S_S_N_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Len_Flag_ := __PP15036008.P___Inp_Val_S_S_N_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bogus_Flag_ := __PP15036008.P___Inp_Val_S_S_N_Bogus_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Non_S_S_A_Flag_ := __PP15036008.P___Inp_Val_S_S_N_Non_S_S_A_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_ := __PP15036008.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_Value_;
    SELF.P___Inp_Cln_D_O_B_Flag_ := __PP15036008.P___Inp_Cln_D_O_B_Flag_Value_;
    SELF.P___Inp_Cln_D_L_Flag_ := __PP15036008.P___Inp_Cln_D_L_Flag_Value_;
    SELF.P___Inp_Cln_D_L_State_Flag_ := __PP15036008.P___Inp_Cln_D_L_State_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Home_Flag_ := __PP15036008.P___Inp_Cln_Phone_Home_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Work_Flag_ := __PP15036008.P___Inp_Cln_Phone_Work_Flag_Value_;
    SELF.P___Inp_Cln_Email_Flag_ := __PP15036008.P___Inp_Cln_Email_Flag_Value_;
    SELF.P___Inp_Cln_I_P_Addr_Flag_ := __PP15036008.P___Inp_Cln_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Val_Email_Bogus_Flag_ := __PP15036008.P___Inp_Val_Email_Bogus_Flag_Value_;
    SELF.P___Inp_Val_Email_User_All_Zero_Flag_ := __PP15036008.P___Inp_Val_Email_User_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_User_Bad_Char_Flag_ := __PP15036008.P___Inp_Val_Email_User_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_All_Zero_Flag_ := __PP15036008.P___Inp_Val_Email_Dom_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_Bad_Char_Flag_ := __PP15036008.P___Inp_Val_Email_Dom_Bad_Char_Flag_Value_;
    SELF.P___Inp_Cln_Arch_Dt_Flag_ := __PP15036008.P___Inp_Cln_Arch_Dt_Flag_Value_;
    SELF.P_I___Inp_Addr_State_D_L_Avail_Flag_ := __PP15036008.P_I___Inp_Addr_State_D_L_Avail_Flag___Non_F_C_R_A_;
    SELF.P_I___Inp_Addr_State_Voter_Avail_Flag_ := IF(__PisFCRA,__PP15036008.P_I___Inp_Addr_State_Voter_Avail_Flag___F_C_R_A_,__PP15036008.P_I___Inp_Addr_State_Voter_Avail_Flag___Non_F_C_R_A_);
    __CC13588 := -99999;
    SELF.P_I___Inp_Addr_Subj_Flag_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC13588,__PP15036008.P_I___Inp_Addr_Subj_Flag_);
    __CC13585 := '-99999';
    SELF.P_I___Inp_Addr_Subj_Old_Dt_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13585)),__ECAST(KEL.typ.nstr,__PP15036008.P_I___Inp_Addr_Subj_Old_Dt_));
    SELF.P_I___Inp_Addr_Subj_New_Dt_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13585)),__ECAST(KEL.typ.nstr,__PP15036008.P_I___Inp_Addr_Subj_New_Dt_));
    SELF.P_I___Inp_Addr_Subj_Old_Msnc_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15036008.P_I___Inp_Addr_Subj_Old_Msnc_));
    SELF.P_I___Inp_Addr_Subj_New_Msnc_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15036008.P_I___Inp_Addr_Subj_New_Msnc_));
    SELF.P_I___Inp_Addr_Subj_Res_Span_ := IF(__PisFCRA AND __PP15036008.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13588)),__ECAST(KEL.typ.nint,__PP15036008.P_I___Inp_Addr_Subj_Res_Span_));
    SELF.Rep_Number_ := __PP15036008.I_Rep_Number_Value_;
    SELF.I_Paddr_ := __PP15036008._ipaddr_;
    SELF.I_Presponse_ := __PP15036008._ipresponse_;
    SELF.Net_Acuity_Royalty_ := __PP15036008._netacuityroyalty_;
    SELF := __PP15036008;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE15039372,__ND15044884__Project(LEFT)));
