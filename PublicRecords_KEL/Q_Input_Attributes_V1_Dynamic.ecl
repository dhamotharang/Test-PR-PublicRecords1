...
EXPORT Q_Input_Attributes_V1_Dynamic(DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, KEL.typ.bool __PisFCRA, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11841691 := __ENH_Input_P_I_I;
  SHARED __EE11841694 := __ENH_Person;
  SHARED __ST5290805_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST179874_Layout) Full_Name_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST179890_Layout) Reported_Dates_Of_Birth_;
    KEL.typ.ndataset(E_Person(__in,__cfg_Local).Reported_Dates_Of_Death_Layout) Reported_Dates_Of_Death_;
    KEL.typ.nstr Race_;
    KEL.typ.nstr Race_Description_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST179905_Layout) Data_Sources_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST100474_Layout) A_V_M_List_;
    KEL.typ.ndataset(B_Person_Accident_8(__in,__cfg_Local).__ST272696_Layout) Accident_Recs_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST105503_Layout) Accident_Recs_Formatted_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST105503_Layout) Accident_Recs_Formatted_Dedup_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST105503_Layout) Accident_Recs_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST95857_Layout) Active_Professional_License_Issue_Exp_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST96035_Layout) Active_Professional_License_Issue_Exp_Date_Group_;
    ...
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST84346_Layout) Address_Hierarchy_Set_;
    KEL.typ.nint Age_;
    KEL.typ.nbool Age_More_Than18_;
    KEL.typ.nkdate Aircraft_Build_Current_Date_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST101290_Layout) All_Inquiries_Past5_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST2640722_Layout) All_Lien_Data_;
    ...
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST84346_Layout) Curr_Addr_Full_Set_;
    ...
    B_Person_10(__in,__cfg_Local).__ST84346_Layout Current_;
    ...
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST98837_Layout) Edu_Coll_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST98837_Layout) Edu_Coll_Rec_Ver_Source_List_Filtered_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST98837_Layout) Edu_H_S_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST98837_Layout) Edu_Rec_Ver_Source_List_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST98810_Layout) Edu_Rec_Ver_Source_List_Pre_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST98837_Layout) Edu_Rec_Ver_Source_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST100873_Layout) Inquiries5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Auto_Srch5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST101537_Layout) Inquiries_Auto_Srch5_Y_List_Sorted_;
    KEL.typ.nint Inquiries_Banking5_Y_Count_;
    KEL.typ.nstr Inquiries_Banking5_Y_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST101339_Layout) Inquiries_Banking5_Y_Sorted_;
    KEL.typ.nint Inquiries_Comm5_Y_Count_;
    KEL.typ.nstr Inquiries_Comm5_Y_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST102335_Layout) Inquiries_Comm5_Y_Sorted_;
    KEL.typ.nstr Inquiries_Dt5_Y_List_;
    KEL.typ.nstr Inquiries_High_Risk5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST101097_Layout) Inquiries_High_Risk5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Mortgage5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST101736_Layout) Inquiries_Mortgage5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Other5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST103255_Layout) Inquiries_Other5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Over_All5_Y_Dt_List_;
    KEL.typ.nstr Inquiries_Prepaid_Card5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102134_Layout) Inquiries_Prepaid_Card5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Quiz_Provider5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102931_Layout) Inquiries_Quiz_Provider5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Retail_Payment5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102732_Layout) Inquiries_Retail_Payment5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Student_Loan5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST102533_Layout) Inquiries_Student_Loan5_Y_List_Sorted_;
    KEL.typ.nstr Inquiries_Utility5_Y_Dt_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST101935_Layout) Inquiries_Utility5_Y_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105167_Layout) Is_Bureau_Source_Test_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST97713_Layout) L_T_D7_Y_List_Sorted_;
    ...
    B_Person_6(__in,__cfg_Local).__ST105503_Layout Latest_Acc_With_Amount_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST98729_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST98293_Layout) Ln_J7_Y_List_Sorted_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105008_Layout) Members_Not_Subject_;
    KEL.typ.nint Months_Since_;
    KEL.typ.nstr Most_Recent_Chapter10_Y_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST94127_Layout) Most_Recent_Chapter10_Y_List_;
    KEL.typ.nstr Most_Recent_Chapter10_Y_With_Null_;
    KEL.typ.nstr Most_Recent_Chapter1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST93921_Layout) Most_Recent_Chapter1_Y_List_;
    KEL.typ.nstr Most_Recent_Chapter1_Y_With_Null_;
    KEL.typ.nstr Most_Recent_Chapter7_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94024_Layout) Most_Recent_Chapter7_Y_List_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST94916_Layout) Most_Recent_Dispo_List10_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94812_Layout) Most_Recent_Dispo_List1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94864_Layout) Most_Recent_Dispo_List7_Y_;
    ...
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94537_Layout) Most_Recent_Update_Bks10_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94411_Layout) Most_Recent_Update_Bks1_Y_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST94474_Layout) Most_Recent_Update_Bks7_Y_;
    B_Person_1(__in,__cfg_Local).__ST96663_Layout Only_Curr_Address_Helper_Flag_;
    B_Person_1(__in,__cfg_Local).__ST97319_Layout Only_Previous_Address_Helper_Flag_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST91525_Layout) P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST4280430_Layout) P_L___Ast_Veh_Auto_Emrg_Dt_List_Ev_;
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST4280450_Layout) P_L___Ast_Veh_Auto_Last_Dt_List_Ev_;
    KEL.typ.int P_L___Ast_Veh_Wtr_Cnt_Ev_ := 0;
    KEL.typ.nstr P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST91785_Layout) P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93822_Layout) P_L___Drg_Bk_Ch_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Ch_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93738_Layout) P_L___Drg_Bk_Ch_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Ch_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93780_Layout) P_L___Drg_Bk_Ch_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94725_Layout) P_L___Drg_Bk_Disp_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Disp_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94633_Layout) P_L___Drg_Bk_Disp_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Disp_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST94679_Layout) P_L___Drg_Bk_Disp_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93486_Layout) P_L___Drg_Bk_Dt_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Dt_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93416_Layout) P_L___Drg_Bk_Dt_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Dt_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST93451_Layout) P_L___Drg_Bk_Dt_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95369_Layout) P_L___Drg_Bk_Type_List10_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Type_List1_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95277_Layout) P_L___Drg_Bk_Type_List1_Y_Pre_;
    KEL.typ.nstr P_L___Drg_Bk_Type_List7_Y_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95323_Layout) P_L___Drg_Bk_Type_List7_Y_Pre_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95805_Layout) P_L___Prof_Lic_Indx_By_Lic_List_Ev_Pre_;
    ...
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1059565_Layout) Person_S_S_N_Match_Sources_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST106426_Layout) Person_S_S_N_Match_Sources_Pre_;
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST84346_Layout) Prev_Addr_Full_Set_;
    B_Person_10(__in,__cfg_Local).__ST84346_Layout Previous_;
    ...
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST95757_Layout) Professional_License_Dates_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST100136_Layout) Property_Data_Set_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST100136_Layout) Property_Date_First_Seen_Sorted_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST100136_Layout) Property_Date_Last_Seen_Sorted_;
    KEL.typ.nstr Property_Min_Date_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST100136_Layout) Property_Sales_Sorted_;
    KEL.typ.ndataset(B_Person_10(__in,__cfg_Local).__ST84346_Layout) Recent_Addr_Full_Set_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST103123_Layout) Retail_Inquiries5_Yrs_;
    KEL.typ.nkdate Select_Age_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105843_Layout) Short_Term_Loans1_Y_Sorted_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105843_Layout) Short_Term_Loans2_Y_Sorted_;
    KEL.typ.nstr Short_Term_Loans5_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105843_Layout) Short_Term_Loans5_Y_Sorted_;
    KEL.typ.nstr Suit7_Y_New_Date_;
    KEL.typ.nstr Suit7_Y_Old_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST98072_Layout) Suits7_Y_List_Sorted_;
    KEL.typ.nstr Suits_Amount7_Y_List_;
    KEL.typ.nstr Suits_Dates7_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105843_Layout) Thrive_Data_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST135729_Layout) Top1_Chapter10_Y_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST94075_Layout) Top1_Chapter10_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST135651_Layout) Top1_Chapter1_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST93866_Layout) Top1_Chapter1_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST135690_Layout) Top1_Chapter7_Y_List_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST93972_Layout) Top1_Chapter7_Y_List_With_Null_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST95534_Layout) Top1_Dt_Of_Bks_List10_Y_With_Null_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST135761_Layout) Top1_Dt_Of_Bks_List1_Y_With_Null_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST135799_Layout) Top1_Dt_Of_Bks_List7_Y_With_Null_;
    KEL.typ.ndataset(B_Person_5(__in,__cfg_Local).__ST571658_Layout) Translated_Sources_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST2641521_Layout) Unique_Addresses_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST99822_Layout) Util_List_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST99804_Layout) Util_List_Pre_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST99822_Layout) Util_List_Sorted_;
    KEL.typ.nkdate Vehicle_Build_Current_Date_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST136066_Layout) Velocity_Inquiries_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_A_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_A_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_F_L_A_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_F_L_A_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_F_L_A_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_F_L_A_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_F_L_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_F_L_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_F_L_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_F_L_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_P_S_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_P_S_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653467_Layout) Velocity_Inquiries_With_S_D_Match_F_C_R_A_;
    KEL.typ.ndataset(B_Person_2(__in,__cfg_Local).__ST1653488_Layout) Velocity_Inquiries_With_S_D_Match_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108559_Layout) Velocity_Inquiry_Addrs_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104028_Layout) Velocity_Inquiry_Addrs_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108647_Layout) Velocity_Inquiry_D_O_Bs_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104104_Layout) Velocity_Inquiry_D_O_Bs_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104122_Layout) Velocity_Inquiry_Emails_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108605_Layout) Velocity_Inquiry_First_Names_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104068_Layout) Velocity_Inquiry_First_Names_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST136089_Layout) Velocity_Inquiry_Last_Names_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108584_Layout) Velocity_Inquiry_Last_Names_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104050_Layout) Velocity_Inquiry_Last_Names_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST136082_Layout) Velocity_Inquiry_Lex_I_Ds_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108626_Layout) Velocity_Inquiry_Phones_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104086_Layout) Velocity_Inquiry_Phones_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST136096_Layout) Velocity_Inquiry_S_S_Ns_Per_Curr_Addr_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST108538_Layout) Velocity_Inquiry_S_S_Ns_Per_Lex_I_D_F_C_R_A_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST104010_Layout) Velocity_Inquiry_S_S_Ns_Per_Lex_I_D_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738967_Layout) Ver_Inp_F_Names_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738967_Layout) Ver_Inp_F_Names_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738982_Layout) Ver_Inp_L_Names_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738982_Layout) Ver_Inp_L_Names_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1059565_Layout) Ver_S_S_N_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST1059565_Layout) Ver_S_S_N_Source_List_Sorted_Non_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST105147_Layout) Ver_Source_List_;
    KEL.typ.ndataset(B_Person_3(__in,__cfg_Local).__ST105167_Layout) Ver_Source_List_Sorted_;
    KEL.typ.ndataset(B_Person_1(__in,__cfg_Local).__ST133285_Layout) Ver_Source_List_Sorted_F_C_R_A_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST106075_Layout) Verified_First_Name_Sources_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738967_Layout) Verified_First_Name_Sources_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738967_Layout) Verified_First_Name_Sources_With_Dates_;
    KEL.typ.ndataset(B_Person_6(__in,__cfg_Local).__ST106237_Layout) Verified_Last_Name_Sources_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738982_Layout) Verified_Last_Name_Sources_F_C_R_A_;
    KEL.typ.ndataset(B_Person_4(__in,__cfg_Local).__ST738982_Layout) Verified_Last_Name_Sources_With_Dates_;
  ...
  END;
  __JC11845027(B_Input_P_I_I(__in,__cfg_Local).__ST165479_Layout __EE11841691, B_Person(__in,__cfg_Local).__ST179868_Layout __EE11841694) := __EEQP(__EE11841691.Subject_,__EE11841694.UID);
  __ST5290805_Layout __JT11845027(B_Input_P_I_I(__in,__cfg_Local).__ST165479_Layout __l, B_Person(__in,__cfg_Local).__ST179868_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE11845028 := JOIN(__EE11841694,__EE11841691,__JC11845027(RIGHT,LEFT),__JT11845027(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST85071_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST85071_Layout __ND11850460__Project(__ST5290805_Layout __PP11841704) := TRANSFORM
    SELF.G___Proc_U_I_D_ := __PP11841704.UID;
    SELF.P___Inp_Acct_ := __PP11841704.Input_Account_Value_;
    SELF.P___Inp_Lex_I_D_ := __PP11841704.Input_Lex_I_D_Value_;
    SELF.P___Inp_Name_First_ := __PP11841704.Input_First_Name_Value_;
    SELF.P___Inp_Name_Mid_ := __PP11841704.Input_Middle_Name_Value_;
    SELF.P___Inp_Name_Last_ := __PP11841704.Input_Last_Name_Value_;
    SELF.P___Inp_Addr_Line1_ := __PP11841704.Input_Street_Value_;
    SELF.P___Inp_Addr_Line2_ := __PP11841704.P___Inp_Addr_Line2_Value_;
    SELF.P___Inp_Addr_City_ := __PP11841704.Input_City_Value_;
    SELF.P___Inp_Addr_State_ := __PP11841704.Input_State_Value_;
    SELF.P___Inp_Addr_Zip_ := __PP11841704.Input_Zip_Value_;
    SELF.P___Inp_S_S_N_ := __PP11841704.Input_S_S_N_Value_;
    SELF.P___Inp_D_O_B_ := __PP11841704.Input_D_O_B_Value_;
    SELF.P___Inp_D_L_ := __PP11841704.Input_D_L_Value_;
    SELF.P___Inp_D_L_State_ := __PP11841704.Input_D_L_State_Value_;
    SELF.P___Inp_Phone_Home_ := __PP11841704.Input_Home_Phone_Value_;
    SELF.P___Inp_Phone_Work_ := __PP11841704.Input_Work_Phone_Value_;
    SELF.P___Inp_Email_ := __PP11841704.Input_Email_Value_;
    SELF.P___Inp_I_P_Addr_ := __PP11841704.Input_I_P_Addr_Value_;
    SELF.P___Inp_Arch_Dt_ := __PP11841704.Input_Archive_Date_Value_;
    SELF.P___Inp_Acct_Flag_ := __PP11841704.P___Inp_Acct_Flag_Value_;
    SELF.P___Inp_Lex_I_D_Flag_ := __PP11841704.P___Inp_Lex_I_D_Flag_Value_;
    SELF.P___Inp_Name_First_Flag_ := __PP11841704.P___Inp_Name_First_Flag_Value_;
    SELF.P___Inp_Name_Mid_Flag_ := __PP11841704.P___Inp_Name_Mid_Flag_Value_;
    SELF.P___Inp_Name_Last_Flag_ := __PP11841704.P___Inp_Name_Last_Flag_Value_;
    SELF.P___Inp_Addr_St_Flag_ := __PP11841704.P___Inp_Addr_St_Flag_Value_;
    SELF.P___Inp_Addr_City_Flag_ := __PP11841704.P___Inp_Addr_City_Flag_Value_;
    SELF.P___Inp_Addr_State_Flag_ := __PP11841704.P___Inp_Addr_State_Flag_Value_;
    SELF.P___Inp_Addr_Zip_Flag_ := __PP11841704.P___Inp_Addr_Zip_Flag_Value_;
    SELF.P___Inp_S_S_N_Flag_ := __PP11841704.P___Inp_S_S_N_Flag_Value_;
    SELF.P___Inp_D_O_B_Flag_ := __PP11841704.P___Inp_D_O_B_Flag_Value_;
    SELF.P___Inp_D_L_Flag_ := __PP11841704.P___Inp_D_L_Flag_Value_;
    SELF.P___Inp_D_L_State_Flag_ := __PP11841704.P___Inp_D_L_State_Flag_Value_;
    SELF.P___Inp_Phone_Home_Flag_ := __PP11841704.P___Inp_Phone_Home_Flag_Value_;
    SELF.P___Inp_Phone_Work_Flag_ := __PP11841704.P___Inp_Phone_Work_Flag_Value_;
    SELF.P___Inp_Email_Flag_ := __PP11841704.P___Inp_Email_Flag_Value_;
    SELF.P___Inp_I_P_Addr_Flag_ := __PP11841704.P___Inp_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Arch_Dt_Flag_ := __PP11841704.P___Inp_Arch_Dt_Flag_Value_;
    SELF.P___Inp_Cln_Name_Prfx_ := __PP11841704.Input_Prefix_Clean_Value_;
    SELF.P___Inp_Cln_Name_First_ := __PP11841704.Input_First_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Mid_ := __PP11841704.Input_Middle_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Last_ := __PP11841704.Input_Last_Name_Clean_Value_;
    SELF.P___Inp_Cln_Name_Sffx_ := __PP11841704.Input_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_ := __PP11841704.Input_Primary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_ := __PP11841704.Input_Pre_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_ := __PP11841704.Input_Primary_Name_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_ := __PP11841704.Input_Address_Suffix_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_ := __PP11841704.Input_Post_Direction_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_ := __PP11841704.Input_Unit_Desig_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_ := __PP11841704.Input_Secondary_Range_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_ := __PP11841704.Input_City_Clean_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_ := __PP11841704.Input_City_Post_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_ := __PP11841704.Input_State_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_ := __PP11841704.Input_Zip5_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_ := __PP11841704.Input_Zip4_Clean_Value_;
    SELF.P___Inp_Cln_Addr_St_ := __PP11841704.Input_Street_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Full_ := __PP11841704.Input_Full_Address_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lat_ := __PP11841704.Input_Latitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Lng_ := __PP11841704.Input_Longitude_Clean_Value_;
    SELF.P___Inp_Cln_Addr_State_Code_ := __PP11841704.Input_State_Code_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_ := __PP11841704.Input_County_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Geo_ := __PP11841704.Input_Geoblock_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Type_ := __PP11841704.Input_Address_Type_Clean_Value_;
    SELF.P___Inp_Cln_Addr_Status_ := __PP11841704.Input_Address_Status_Clean_Value_;
    SELF.P___Inp_Cln_S_S_N_ := __PP11841704.Input_S_S_N_Clean_Value_;
    SELF.P___Inp_Cln_D_O_B_ := __PP11841704.Input_D_O_B_Clean_Value_;
    SELF.P___Inp_Cln_D_L_ := __PP11841704.Input_D_L_Clean_Value_;
    SELF.P___Inp_Cln_D_L_State_ := __PP11841704.Input_D_L_State_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Home_ := __PP11841704.Input_Home_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Phone_Work_ := __PP11841704.Input_Work_Phone_Clean_Value_;
    SELF.P___Inp_Cln_Email_ := __PP11841704.Input_Email_Clean_Value_;
    SELF.P___Inp_Cln_Arch_Dt_ := __PP11841704.Input_Archive_Date_Clean_Value_;
    SELF.P___Inp_Cln_Name_Prfx_Flag_ := __PP11841704.P___Inp_Cln_Name_Prfx_Flag_Value_;
    SELF.P___Inp_Cln_Name_First_Flag_ := __PP11841704.P___Inp_Cln_Name_First_Flag_Value_;
    SELF.P___Inp_Cln_Name_Mid_Flag_ := __PP11841704.P___Inp_Cln_Name_Mid_Flag_Value_;
    SELF.P___Inp_Cln_Name_Last_Flag_ := __PP11841704.P___Inp_Cln_Name_Last_Flag_Value_;
    SELF.P___Inp_Cln_Name_Sffx_Flag_ := __PP11841704.P___Inp_Cln_Name_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Rng_Flag_ := __PP11841704.P___Inp_Cln_Addr_Prim_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Pre_Dir_Flag_ := __PP11841704.P___Inp_Cln_Addr_Pre_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Prim_Name_Flag_ := __PP11841704.P___Inp_Cln_Addr_Prim_Name_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sffx_Flag_ := __PP11841704.P___Inp_Cln_Addr_Sffx_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Post_Dir_Flag_ := __PP11841704.P___Inp_Cln_Addr_Post_Dir_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Unit_Desig_Flag_ := __PP11841704.P___Inp_Cln_Addr_Unit_Desig_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Sec_Rng_Flag_ := __PP11841704.P___Inp_Cln_Addr_Sec_Rng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Flag_ := __PP11841704.P___Inp_Cln_Addr_City_Flag_Value_;
    SELF.P___Inp_Cln_Addr_City_Post_Flag_ := __PP11841704.P___Inp_Cln_Addr_City_Post_Flag_Value_;
    SELF.P___Inp_Cln_Addr_State_Flag_ := __PP11841704.P___Inp_Cln_Addr_State_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip5_Flag_ := __PP11841704.P___Inp_Cln_Addr_Zip5_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Zip4_Flag_ := __PP11841704.P___Inp_Cln_Addr_Zip4_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_Bad_Len_Flag_ := __PP11841704.P___Inp_Val_Addr_Zip_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_Addr_Zip_All_Zero_Flag_ := __PP11841704.P___Inp_Val_Addr_Zip_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Addr_State_Bad_Abbr_Flag_ := __PP11841704.P___Inp_Val_Addr_State_Bad_Abbr_Flag_Value_;
    SELF.P___Inp_Cln_Addr_St_Flag_ := __PP11841704.P___Inp_Cln_Addr_St_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Full_Flag_ := __PP11841704.P___Inp_Cln_Addr_Full_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lat_Flag_ := __PP11841704.P___Inp_Cln_Addr_Lat_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Lng_Flag_ := __PP11841704.P___Inp_Cln_Addr_Lng_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Cnty_Flag_ := __PP11841704.P___Inp_Cln_Addr_Cnty_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Geo_Flag_ := __PP11841704.P___Inp_Cln_Addr_Geo_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Type_Flag_ := __PP11841704.P___Inp_Cln_Addr_Type_Flag_Value_;
    SELF.P___Inp_Cln_Addr_Status_Flag_ := __PP11841704.P___Inp_Cln_Addr_Status_Flag_Value_;
    SELF.P___Inp_Cln_S_S_N_Flag_ := __PP11841704.P___Inp_Cln_S_S_N_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Char_Flag_ := __PP11841704.P___Inp_Val_S_S_N_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bad_Len_Flag_ := __PP11841704.P___Inp_Val_S_S_N_Bad_Len_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Bogus_Flag_ := __PP11841704.P___Inp_Val_S_S_N_Bogus_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Non_S_S_A_Flag_ := __PP11841704.P___Inp_Val_S_S_N_Non_S_S_A_Flag_Value_;
    SELF.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_ := __PP11841704.P___Inp_Val_S_S_N_Is_I_T_I_N_Flag_Value_;
    SELF.P___Inp_Cln_D_O_B_Flag_ := __PP11841704.P___Inp_Cln_D_O_B_Flag_Value_;
    SELF.P___Inp_Cln_D_L_Flag_ := __PP11841704.P___Inp_Cln_D_L_Flag_Value_;
    SELF.P___Inp_Cln_D_L_State_Flag_ := __PP11841704.P___Inp_Cln_D_L_State_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Home_Flag_ := __PP11841704.P___Inp_Cln_Phone_Home_Flag_Value_;
    SELF.P___Inp_Cln_Phone_Work_Flag_ := __PP11841704.P___Inp_Cln_Phone_Work_Flag_Value_;
    SELF.P___Inp_Cln_Email_Flag_ := __PP11841704.P___Inp_Cln_Email_Flag_Value_;
    SELF.P___Inp_Cln_I_P_Addr_Flag_ := __PP11841704.P___Inp_Cln_I_P_Addr_Flag_Value_;
    SELF.P___Inp_Val_Email_Bogus_Flag_ := __PP11841704.P___Inp_Val_Email_Bogus_Flag_Value_;
    SELF.P___Inp_Val_Email_User_All_Zero_Flag_ := __PP11841704.P___Inp_Val_Email_User_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_User_Bad_Char_Flag_ := __PP11841704.P___Inp_Val_Email_User_Bad_Char_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_All_Zero_Flag_ := __PP11841704.P___Inp_Val_Email_Dom_All_Zero_Flag_Value_;
    SELF.P___Inp_Val_Email_Dom_Bad_Char_Flag_ := __PP11841704.P___Inp_Val_Email_Dom_Bad_Char_Flag_Value_;
    SELF.P___Inp_Cln_Arch_Dt_Flag_ := __PP11841704.P___Inp_Cln_Arch_Dt_Flag_Value_;
    SELF.P_I___Inp_Addr_State_D_L_Avail_Flag_ := __PP11841704.P_I___Inp_Addr_State_D_L_Avail_Flag___Non_F_C_R_A_;
    SELF.P_I___Inp_Addr_State_Voter_Avail_Flag_ := IF(__PisFCRA,__PP11841704.P_I___Inp_Addr_State_Voter_Avail_Flag___F_C_R_A_,__PP11841704.P_I___Inp_Addr_State_Voter_Avail_Flag___Non_F_C_R_A_);
    __CC13579 := -99999;
    SELF.P_I___Inp_Addr_Subj_Flag_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC13579,__PP11841704.P_I___Inp_Addr_Subj_Flag_);
    __CC13576 := '-99999';
    SELF.P_I___Inp_Addr_Subj_Old_Dt_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13576)),__ECAST(KEL.typ.nstr,__PP11841704.P_I___Inp_Addr_Subj_Old_Dt_));
    SELF.P_I___Inp_Addr_Subj_New_Dt_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13576)),__ECAST(KEL.typ.nstr,__PP11841704.P_I___Inp_Addr_Subj_New_Dt_));
    SELF.P_I___Inp_Addr_Subj_Old_Msnc_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13579)),__ECAST(KEL.typ.nint,__PP11841704.P_I___Inp_Addr_Subj_Old_Msnc_));
    SELF.P_I___Inp_Addr_Subj_New_Msnc_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13579)),__ECAST(KEL.typ.nint,__PP11841704.P_I___Inp_Addr_Subj_New_Msnc_));
    SELF.P_I___Inp_Addr_Subj_Res_Span_ := IF(__PisFCRA AND __PP11841704.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC13579)),__ECAST(KEL.typ.nint,__PP11841704.P_I___Inp_Addr_Subj_Res_Span_));
    SELF.Rep_Number_ := __PP11841704.I_Rep_Number_Value_;
    SELF.I_Paddr_ := __PP11841704._ipaddr_;
    SELF.I_Presponse_ := __PP11841704._ipresponse_;
    SELF.Net_Acuity_Royalty_ := __PP11841704._netacuityroyalty_;
    SELF := __PP11841704;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11845028,__ND11850460__Project(LEFT)));
