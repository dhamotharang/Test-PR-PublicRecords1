...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5635213 := __ENH_Input_P_I_I_6;
  EXPORT __ST281667_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST281667_Layout __ND5635779__Project(B_Input_P_I_I_6(__in,__cfg).__ST281151_Layout __PP5635214) := TRANSFORM
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_Zip5_));
    ...
    __CC13564 := '-99999';
    __CC13569 := '-99998';
    SELF.Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP5635214.P___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13564)),__T(__AND(__CN(__PP5635214.P___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13569)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13569)))));
    SELF.Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP5635214.P___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13564)),__T(__AND(__CN(__PP5635214.P___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13569)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13569)))));
    SELF.Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP5635214.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13564)),__T(__AND(__CN(__PP5635214.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13569)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13569)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP5635214.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13564)),__T(__AND(__CN(__PP5635214.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP5635214.Addr_Not_Populated_),__PP5635214.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13569)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13569)))));
    SELF.Name_Not_Populated_ := IF(FN_Compile(__cfg).FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__PP5635214.P___Inp_Name_Last_)),TRUE,FALSE);
    SELF.P___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP5635214.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13564)),__ECAST(KEL.typ.nstr,__CN(__CC13569)));
    SELF.P___Inp_Val_Name_Bogus_Flag_ := MAP(__T(__AND(__AND(__OP2(__PP5635214.Input_First_Name_Value_,=,__CN(__CC13564)),__OP2(__PP5635214.Input_Middle_Name_Value_,=,__CN(__CC13564))),__OP2(__PP5635214.Input_Last_Name_Value_,=,__CN(__CC13564))))=>__CC13564,__T(__OP2(FN_Compile(__cfg).FN__fn_Bogus_Names(__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5635214.P___Inp_Name_First_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5635214.Input_Middle_Name_Value_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5635214.Input_Last_Name_Value_))),=,__CAST(KEL.typ.str,__CN(1))))=>(KEL.typ.str)1,(KEL.typ.str)0);
    SELF.Targus_Gateway_I_P_ := FN_Compile(__cfg).FN_G_E_T___T_A_R_G_U_S___U_R_L(__ECAST(KEL.typ.nstr,__CN('DummyValue')));
    SELF := __PP5635214;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE5635213,__ND5635779__Project(LEFT));
END;
