...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE33934 := __E_Input_P_I_I;
  ...
  END;
  SHARED __ST31110_Layout __ND33932__Project(E_Input_P_I_I(__in,__cfg).Layout __PP33623) := TRANSFORM
    SELF.Addr_Not_Populated_ := IF(FN_Compile.FN_Addr_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP33623.Input_Street_Echo_),__ECAST(KEL.typ.nstr,__PP33623.Input_City_Echo_),__ECAST(KEL.typ.nstr,__PP33623.Input_State_Echo_),__ECAST(KEL.typ.nstr,__PP33623.Input_Zip_Echo_)),TRUE,FALSE);
    SELF := __PP33623;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE33934,__ND33932__Project(LEFT));
END;
