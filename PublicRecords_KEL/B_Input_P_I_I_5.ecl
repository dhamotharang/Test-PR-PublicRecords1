...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5717800 := __ENH_Input_P_I_I_6;
  EXPORT __ST284635_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST284635_Layout __ND5718391__Project(B_Input_P_I_I_6(__in,__cfg).__ST284003_Layout __PP5717801) := TRANSFORM
    ...
    __CC13585 := '-99999';
    __CC13590 := '-99998';
    SELF.Input_Full_Address_Clean_Value_ := MAP(__T(__OR(__CN(__PP5717801.Addr_Not_Populated_),__PP5717801.City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13585)),__T(__OR(__OP2(__PP5717801.P___Inp_Cln_Addr_St_Flag_Value_,=,__CN('0')),__PP5717801.Clean_City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13590)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP5717801.Input_Primary_Range_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP5717801.Input_Pre_Direction_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Primary_Name_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Address_Suffix_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Post_Direction_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Unit_Desig_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Secondary_Range_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Sec_Rng_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_City_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_City_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_State_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_State_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Zip5_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Zip5_),+,__CN(' '))))),+,IF(__T(__OP2(__PP5717801.Input_Zip4_Clean_Value_,=,__CN(__CC13590))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP5717801.P___Inp_Cln_Addr_Zip4_))))));
    SELF.Name_Not_Populated_ := IF(FN_Compile(__cfg).FN_Name_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP5717801.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__PP5717801.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__PP5717801.P___Inp_Name_Last_)),TRUE,FALSE);
    SELF.P___Inp_Val_Name_Bogus_Flag_ := MAP(__T(__AND(__AND(__OP2(__PP5717801.Input_First_Name_Value_,=,__CN(__CC13585)),__OP2(__PP5717801.Input_Middle_Name_Value_,=,__CN(__CC13585))),__OP2(__PP5717801.Input_Last_Name_Value_,=,__CN(__CC13585))))=>__CC13585,__T(__OP2(FN_Compile(__cfg).FN__fn_Bogus_Names(__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5717801.P___Inp_Name_First_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5717801.Input_Middle_Name_Value_)),__ECAST(KEL.typ.nstr,__FN1(KEL.Routines.ToUpperCase,__PP5717801.Input_Last_Name_Value_))),=,__CAST(KEL.typ.str,__CN(1))))=>(KEL.typ.str)1,(KEL.typ.str)0);
    SELF.Targus_Gateway_I_P_ := FN_Compile(__cfg).FN_G_E_T___T_A_R_G_U_S___U_R_L(__ECAST(KEL.typ.nstr,__CN('DummyValue')));
    SELF := __PP5717801;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE5717800,__ND5718391__Project(LEFT));
END;
