...
EXPORT E_Prox_Utility(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault((UNSIGNED)proxid<>0);
  SHARED __d0_Business_Location__Layout := RECORD
    RECORDOF(__d0_KELfiltered);
    KEL.typ.uid Business_Location_;
  END;
  SHARED __d0_Missing_Business_Location__UIDComponents := KEL.Intake.ConstructMissingFieldList(__d0_KELfiltered,'ultid,orgid,seleid,proxid','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault');
  ...
  EXPORT NullCounts := DATASET([
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','id',COUNT(__d0(__NL(Util_))),COUNT(__d0(__NN(Util_)))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','BusinessLocation',COUNT(__d0(__NL(Business_Location_))),COUNT(__d0(__NN(Business_Location_)))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','connect_date',COUNT(__d0(__NL(Connect_Date_))),COUNT(__d0(__NN(Connect_Date_)))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','util_type',COUNT(__d0(__NL(Utility_Type_))),COUNT(__d0(__NN(Utility_Type_)))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','src',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'ProxUtility','PublicRecords_KEL.Files.NonFCRA.UtilFile__Key_LinkIds_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
