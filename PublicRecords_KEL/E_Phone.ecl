...
EXPORT E_Phone(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping2 := 'phone(OVERRIDE:UID|OVERRIDE:Phone10_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),portabilityindicator(DEFAULT:Portability_Indicator_:0),nxxtype(DEFAULT:N_X_X_Type_:0),coctype(DEFAULT:C_O_C_Type_:\'\'),scc(DEFAULT:S_C_C_:\'\'),portedmatch(DEFAULT:Ported_Match_:0),phoneuse(DEFAULT:Phone_Use_:\'\'),phonenumbercompanytype(DEFAULT:Phone_Number_Company_Type_:0),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),carriername(DEFAULT:Carrier_Name_:\'\'),confidencescore(DEFAULT:Confidence_Score_:0),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),maximumconfidencescore(DEFAULT:Maximum_Confidence_Score_:0),minimumconfidencescore(DEFAULT:Minimum_Confidence_Score_:0),omitindicator(DEFAULT:Omit_Indicator_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),rec_type(OVERRIDE:Record_Type_:\'\'),sourcefile(DEFAULT:Source_File_:0),iverindicator(DEFAULT:Iver_Indicator_:0),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_2Rule),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_2Rule),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'cellphone(OVERRIDE:UID|OVERRIDE:Phone10_:\'\'),listingtype(OVERRIDE:Listing_Type_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),portabilityindicator(DEFAULT:Portability_Indicator_:0),nxxtype(DEFAULT:N_X_X_Type_:0),coctype(DEFAULT:C_O_C_Type_:\'\'),scc(DEFAULT:S_C_C_:\'\'),portedmatch(DEFAULT:Ported_Match_:0),phoneuse(DEFAULT:Phone_Use_:\'\'),phonenumbercompanytype(DEFAULT:Phone_Number_Company_Type_:0),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),carriername(DEFAULT:Carrier_Name_:\'\'),confidencescore(OVERRIDE:Confidence_Score_:0),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),maximumconfidencescore(DEFAULT:Maximum_Confidence_Score_:0),minimumconfidencescore(DEFAULT:Minimum_Confidence_Score_:0),omitindicator(DEFAULT:Omit_Indicator_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),sourcefile(DEFAULT:Source_File_:0),iverindicator(DEFAULT:Iver_Indicator_:0),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),datefirstseen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_3Rule),datelastseen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_3Rule),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping5 := 'cellphone(OVERRIDE:UID|OVERRIDE:Phone10_:\'\'),listingtype(DEFAULT:Listing_Type_:\'\'),publishcode(DEFAULT:Publish_Code_:\'\'),portabilityindicator(DEFAULT:Portability_Indicator_:0),nxxtype(DEFAULT:N_X_X_Type_:0),coctype(DEFAULT:C_O_C_Type_:\'\'),scc(DEFAULT:S_C_C_:\'\'),portedmatch(DEFAULT:Ported_Match_:0),phoneuse(DEFAULT:Phone_Use_:\'\'),phonenumbercompanytype(DEFAULT:Phone_Number_Company_Type_:0),priorareacode(DEFAULT:Prior_Area_Code_:\'\'),isactive(DEFAULT:Is_Active_:\'\'),carriername(DEFAULT:Carrier_Name_:\'\'),confidencescore(DEFAULT:Confidence_Score_:0),nosolicitcode(DEFAULT:No_Solicit_Code_:\'\'),maximumconfidencescore(DEFAULT:Maximum_Confidence_Score_:0),minimumconfidencescore(DEFAULT:Minimum_Confidence_Score_:0),omitindicator(DEFAULT:Omit_Indicator_:\'\'),currentflag(DEFAULT:Current_Flag_:\'\'),businessflag(DEFAULT:Business_Flag_:\'\'),recordtype(DEFAULT:Record_Type_:\'\'),sourcefile(DEFAULT:Source_File_:0),iverindicator(DEFAULT:Iver_Indicator_:0),phonetype(DEFAULT:Phone_Type_:\'\'),validationflag(DEFAULT:Validation_Flag_:\'\'),validationdate(DEFAULT:Validation_Date_:\'\'),src(OVERRIDE:Source_:\'\'),originalsource(DEFAULT:Original_Source_:\'\'),datefirstseen(DEFAULT:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
