...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5355571 := __ENH_U_C_C_7;
  EXPORT __ST255618_Layout := RECORD
  ...
  END;
  EXPORT __ST255614_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST255618_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255614_Layout __ND5355576__Project(B_U_C_C_7(__in,__cfg).__ST258761_Layout __PP5355572) := TRANSFORM
    __EE5355611 := __PP5355572.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5355611),__ST255618_Layout),__NL(__EE5355611));
    SELF := __PP5355572;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5355571,__ND5355576__Project(LEFT));
END;
