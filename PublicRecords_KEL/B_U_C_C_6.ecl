...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5524550 := __ENH_U_C_C_7;
  EXPORT __ST267331_Layout := RECORD
  ...
  END;
  EXPORT __ST267327_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST267331_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267327_Layout __ND5524555__Project(B_U_C_C_7(__in,__cfg).__ST270607_Layout __PP5524551) := TRANSFORM
    __EE5524590 := __PP5524551.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5524590),__ST267331_Layout),__NL(__EE5524590));
    SELF := __PP5524551;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5524550,__ND5524555__Project(LEFT));
END;
