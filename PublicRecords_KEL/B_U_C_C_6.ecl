...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5571084 := __ENH_U_C_C_7;
  EXPORT __ST263315_Layout := RECORD
  ...
  END;
  EXPORT __ST263311_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST263315_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263311_Layout __ND5571089__Project(B_U_C_C_7(__in,__cfg).__ST266636_Layout __PP5571085) := TRANSFORM
    __EE5571124 := __PP5571085.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5571124),__ST263315_Layout),__NL(__EE5571124));
    SELF := __PP5571085;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5571084,__ND5571089__Project(LEFT));
END;
