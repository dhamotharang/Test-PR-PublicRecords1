...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4875164 := __ENH_U_C_C_7;
  ...
  END;
  EXPORT __ST247156_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST247160_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247156_Layout __ND4875169__Project(B_U_C_C_7(__in,__cfg).__ST250055_Layout __PP4875165) := TRANSFORM
    __EE4875204 := __PP4875165.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4875204),__ST247160_Layout),__NL(__EE4875204));
    SELF := __PP4875165;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4875164,__ND4875169__Project(LEFT));
END;
