...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4883412 := __ENH_U_C_C_7;
  EXPORT __ST247682_Layout := RECORD
  ...
  END;
  EXPORT __ST247678_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST247682_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247678_Layout __ND4883417__Project(B_U_C_C_7(__in,__cfg).__ST250577_Layout __PP4883413) := TRANSFORM
    __EE4883452 := __PP4883413.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4883452),__ST247682_Layout),__NL(__EE4883452));
    SELF := __PP4883413;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4883412,__ND4883417__Project(LEFT));
END;
