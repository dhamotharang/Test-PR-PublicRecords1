...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5162006 := __ENH_U_C_C_7;
  EXPORT __ST256953_Layout := RECORD
  ...
  END;
  EXPORT __ST256949_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST256953_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256949_Layout __ND5162011__Project(B_U_C_C_7(__in,__cfg).__ST260189_Layout __PP5162007) := TRANSFORM
    __EE5162046 := __PP5162007.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5162046),__ST256953_Layout),__NL(__EE5162046));
    SELF := __PP5162007;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5162006,__ND5162011__Project(LEFT));
END;
