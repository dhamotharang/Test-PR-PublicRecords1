...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4883407 := __ENH_U_C_C_7;
  EXPORT __ST247677_Layout := RECORD
  ...
  END;
  EXPORT __ST247673_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST247677_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247673_Layout __ND4883412__Project(B_U_C_C_7(__in,__cfg).__ST250572_Layout __PP4883408) := TRANSFORM
    __EE4883447 := __PP4883408.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4883447),__ST247677_Layout),__NL(__EE4883447));
    SELF := __PP4883408;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4883407,__ND4883412__Project(LEFT));
END;
