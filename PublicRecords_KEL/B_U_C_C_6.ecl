...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5154649 := __ENH_U_C_C_7;
  ...
  END;
  EXPORT __ST256531_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST256535_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256531_Layout __ND5154654__Project(B_U_C_C_7(__in,__cfg).__ST259771_Layout __PP5154650) := TRANSFORM
    __EE5154689 := __PP5154650.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5154689),__ST256535_Layout),__NL(__EE5154689));
    SELF := __PP5154650;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5154649,__ND5154654__Project(LEFT));
END;
