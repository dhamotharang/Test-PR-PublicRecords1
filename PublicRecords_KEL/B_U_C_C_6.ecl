...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5718147 := __ENH_U_C_C_7;
  EXPORT __ST266503_Layout := RECORD
  ...
  END;
  EXPORT __ST266499_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST266503_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266499_Layout __ND5718152__Project(B_U_C_C_7(__in,__cfg).__ST269824_Layout __PP5718148) := TRANSFORM
    __EE5718187 := __PP5718148.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5718187),__ST266503_Layout),__NL(__EE5718187));
    SELF := __PP5718148;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5718147,__ND5718152__Project(LEFT));
END;
