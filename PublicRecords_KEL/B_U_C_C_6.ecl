...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5584770 := __ENH_U_C_C_7;
  EXPORT __ST268729_Layout := RECORD
  ...
  END;
  EXPORT __ST268725_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST268729_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST268725_Layout __ND5584775__Project(B_U_C_C_7(__in,__cfg).__ST272007_Layout __PP5584771) := TRANSFORM
    __EE5584810 := __PP5584771.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5584810),__ST268729_Layout),__NL(__EE5584810));
    SELF := __PP5584771;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5584770,__ND5584775__Project(LEFT));
END;
