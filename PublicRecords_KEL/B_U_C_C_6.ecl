...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5161976 := __ENH_U_C_C_7;
  ...
  EXPORT __ST256919_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256919_Layout __ND5161981__Project(B_U_C_C_7(__in,__cfg).__ST260159_Layout __PP5161977) := TRANSFORM
    __EE5162016 := __PP5161977.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5162016),__ST256923_Layout),__NL(__EE5162016));
    SELF := __PP5161977;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5161976,__ND5161981__Project(LEFT));
END;
