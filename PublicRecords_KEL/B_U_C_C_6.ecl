...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5540231 := __ENH_U_C_C_7;
  EXPORT __ST262078_Layout := RECORD
  ...
  END;
  EXPORT __ST262074_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST262078_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST262074_Layout __ND5540236__Project(B_U_C_C_7(__in,__cfg).__ST265354_Layout __PP5540232) := TRANSFORM
    __EE5540271 := __PP5540232.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5540271),__ST262078_Layout),__NL(__EE5540271));
    SELF := __PP5540232;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5540231,__ND5540236__Project(LEFT));
END;
