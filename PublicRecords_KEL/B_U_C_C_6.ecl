...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4882549 := __ENH_U_C_C_7;
  EXPORT __ST247657_Layout := RECORD
  ...
  END;
  EXPORT __ST247653_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST247657_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247653_Layout __ND4882554__Project(B_U_C_C_7(__in,__cfg).__ST250552_Layout __PP4882550) := TRANSFORM
    __EE4882589 := __PP4882550.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4882589),__ST247657_Layout),__NL(__EE4882589));
    SELF := __PP4882550;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4882549,__ND4882554__Project(LEFT));
END;
