...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4998117 := __ENH_U_C_C_7;
  EXPORT __ST248208_Layout := RECORD
  ...
  END;
  EXPORT __ST248204_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST248208_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST248204_Layout __ND4998122__Project(B_U_C_C_7(__in,__cfg).__ST251103_Layout __PP4998118) := TRANSFORM
    __EE4998157 := __PP4998118.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4998157),__ST248208_Layout),__NL(__EE4998157));
    SELF := __PP4998118;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4998117,__ND4998122__Project(LEFT));
END;
