...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5130237 := __ENH_U_C_C_7;
  ...
  END;
  EXPORT __ST254857_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST254861_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254857_Layout __ND5130242__Project(B_U_C_C_7(__in,__cfg).__ST258093_Layout __PP5130238) := TRANSFORM
    __EE5130277 := __PP5130238.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5130277),__ST254861_Layout),__NL(__EE5130277));
    SELF := __PP5130238;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5130237,__ND5130242__Project(LEFT));
END;
