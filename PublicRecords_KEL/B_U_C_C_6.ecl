...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3560519 := __ENH_U_C_C_7;
  EXPORT __ST192918_Layout := RECORD
  ...
  END;
  EXPORT __ST192914_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST192918_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192914_Layout __ND3560524__Project(B_U_C_C_7(__in,__cfg).__ST195426_Layout __PP3560520) := TRANSFORM
    __EE3560559 := __PP3560520.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3560559),__ST192918_Layout),__NL(__EE3560559));
    SELF := __PP3560520;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE3560519,__ND3560524__Project(LEFT));
END;
