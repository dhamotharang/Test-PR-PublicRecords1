...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5513538 := __ENH_U_C_C_7;
  EXPORT __ST260502_Layout := RECORD
  ...
  END;
  EXPORT __ST260498_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST260502_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260498_Layout __ND5513543__Project(B_U_C_C_7(__in,__cfg).__ST263823_Layout __PP5513539) := TRANSFORM
    __EE5513578 := __PP5513539.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5513578),__ST260502_Layout),__NL(__EE5513578));
    SELF := __PP5513539;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5513538,__ND5513543__Project(LEFT));
END;
