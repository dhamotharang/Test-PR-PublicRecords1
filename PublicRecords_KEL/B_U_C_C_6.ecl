...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5511952 := __ENH_U_C_C_7;
  EXPORT __ST260532_Layout := RECORD
  ...
  END;
  EXPORT __ST260528_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST260532_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260528_Layout __ND5511957__Project(B_U_C_C_7(__in,__cfg).__ST263853_Layout __PP5511953) := TRANSFORM
    __EE5511992 := __PP5511953.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5511992),__ST260532_Layout),__NL(__EE5511992));
    SELF := __PP5511953;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5511952,__ND5511957__Project(LEFT));
END;
