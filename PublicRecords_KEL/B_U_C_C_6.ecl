...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4881128 := __ENH_U_C_C_7;
  EXPORT __ST247002_Layout := RECORD
  ...
  END;
  EXPORT __ST246998_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST247002_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST246998_Layout __ND4881133__Project(B_U_C_C_7(__in,__cfg).__ST249897_Layout __PP4881129) := TRANSFORM
    __EE4881168 := __PP4881129.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4881168),__ST247002_Layout),__NL(__EE4881168));
    SELF := __PP4881129;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE4881128,__ND4881133__Project(LEFT));
END;
