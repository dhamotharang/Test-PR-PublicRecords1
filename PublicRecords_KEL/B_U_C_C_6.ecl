...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5646090 := __ENH_U_C_C_7;
  EXPORT __ST270614_Layout := RECORD
  ...
  END;
  EXPORT __ST270610_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST270614_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST270610_Layout __ND5646095__Project(B_U_C_C_7(__in,__cfg).__ST274043_Layout __PP5646091) := TRANSFORM
    __EE5646130 := __PP5646091.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5646130),__ST270614_Layout),__NL(__EE5646130));
    SELF := __PP5646091;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5646090,__ND5646095__Project(LEFT));
END;
