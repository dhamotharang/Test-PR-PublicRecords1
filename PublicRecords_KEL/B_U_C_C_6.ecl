...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5591451 := __ENH_U_C_C_7;
  ...
  END;
  EXPORT __ST263613_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST263617_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263613_Layout __ND5591456__Project(B_U_C_C_7(__in,__cfg).__ST266938_Layout __PP5591452) := TRANSFORM
    __EE5591491 := __PP5591452.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5591491),__ST263617_Layout),__NL(__EE5591491));
    SELF := __PP5591452;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE5591451,__ND5591456__Project(LEFT));
END;
