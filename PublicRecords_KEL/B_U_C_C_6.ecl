...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE378438 := __ENH_U_C_C_7;
  EXPORT __ST164678_Layout := RECORD
  ...
  END;
  EXPORT __ST164674_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST164678_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST164674_Layout __ND378699__Project(B_U_C_C_7(__in,__cfg).__ST167025_Layout __PP378180) := TRANSFORM
    __EE378249 := __PP378180.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE378249),__ST164678_Layout),__NL(__EE378249));
    SELF := __PP378180;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE378438,__ND378699__Project(LEFT));
END;
