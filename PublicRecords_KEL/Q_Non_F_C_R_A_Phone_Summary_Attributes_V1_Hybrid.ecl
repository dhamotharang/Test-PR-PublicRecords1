...
EXPORT Q_Non_F_C_R_A_Phone_Summary_Attributes_V1_Hybrid(KEL.typ.str __PPhone, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE12785009 := __ENH_Phone_Summary;
  SHARED __EE12785147 := __EE12785009(__T(__OP2(__EE12785009.Phone10_,=,__CN(__PPhone))));
  SHARED __ST124577_Layout := RECORD
