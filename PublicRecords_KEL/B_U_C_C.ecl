...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12049796 := __ENH_U_C_C_1;
  ...
  EXPORT __ST168555_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST168559_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168555_Layout __ND12049801__Project(B_U_C_C_1(__in,__cfg).__ST268239_Layout __PP12049797) := TRANSFORM
    __EE12049839 := __PP12049797.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE12049839),__ST168559_Layout),__NL(__EE12049839));
    SELF := __PP12049797;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE12049796,__ND12049801__Project(LEFT));
END;
