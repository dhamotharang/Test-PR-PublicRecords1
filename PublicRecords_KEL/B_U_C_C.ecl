...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11402126 := __ENH_U_C_C_1;
  ...
  END;
  EXPORT __ST175084_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST175088_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175084_Layout __ND11402131__Project(B_U_C_C_1(__in,__cfg).__ST300252_Layout __PP11402127) := TRANSFORM
    __EE11402169 := __PP11402127.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE11402169),__ST175088_Layout),__NL(__EE11402169));
    SELF := __PP11402127;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE11402126,__ND11402131__Project(LEFT));
END;
