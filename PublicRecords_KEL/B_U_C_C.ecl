...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11387293 := __ENH_U_C_C_1;
  EXPORT __ST174771_Layout := RECORD
  ...
  END;
  EXPORT __ST174767_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST174771_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174767_Layout __ND11387298__Project(B_U_C_C_1(__in,__cfg).__ST283385_Layout __PP11387294) := TRANSFORM
    __EE11387336 := __PP11387294.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE11387336),__ST174771_Layout),__NL(__EE11387336));
    SELF := __PP11387294;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE11387293,__ND11387298__Project(LEFT));
END;
