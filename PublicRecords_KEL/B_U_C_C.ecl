...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9607318 := __ENH_U_C_C_1;
  EXPORT __ST171795_Layout := RECORD
  ...
  END;
  EXPORT __ST171791_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST171795_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST171791_Layout __ND9607323__Project(B_U_C_C_1(__in,__cfg).__ST292908_Layout __PP9607319) := TRANSFORM
    __EE9607361 := __PP9607319.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE9607361),__ST171795_Layout),__NL(__EE9607361));
    SELF := __PP9607319;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE9607318,__ND9607323__Project(LEFT));
END;
