...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11544423 := __ENH_U_C_C_1;
  EXPORT __ST167628_Layout := RECORD
  ...
  END;
  EXPORT __ST167624_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST167628_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167624_Layout __ND11544428__Project(B_U_C_C_1(__in,__cfg).__ST267444_Layout __PP11544424) := TRANSFORM
    __EE11544466 := __PP11544424.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE11544466),__ST167628_Layout),__NL(__EE11544466));
    SELF := __PP11544424;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE11544423,__ND11544428__Project(LEFT));
END;
