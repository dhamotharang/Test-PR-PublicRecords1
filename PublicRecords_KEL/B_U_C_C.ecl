...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11550162 := __ENH_U_C_C_1;
  EXPORT __ST168176_Layout := RECORD
  ...
  EXPORT __ST168172_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST168176_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168172_Layout __ND11550167__Project(B_U_C_C_1(__in,__cfg).__ST265548_Layout __PP11550163) := TRANSFORM
    __EE11550205 := __PP11550163.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE11550205),__ST168176_Layout),__NL(__EE11550205));
    SELF := __PP11550163;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE11550162,__ND11550167__Project(LEFT));
END;
