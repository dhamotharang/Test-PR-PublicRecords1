...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE11530372 := __ENH_U_C_C_1;
  EXPORT __ST167711_Layout := RECORD
  ...
  END;
  EXPORT __ST167707_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST167711_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167707_Layout __ND11530377__Project(B_U_C_C_1(__in,__cfg).__ST267485_Layout __PP11530373) := TRANSFORM
    __EE11530415 := __PP11530373.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE11530415),__ST167711_Layout),__NL(__EE11530415));
    SELF := __PP11530373;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE11530372,__ND11530377__Project(LEFT));
END;
