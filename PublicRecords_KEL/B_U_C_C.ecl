...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE13752814 := __ENH_U_C_C_1;
  ...
  END;
  EXPORT __ST196613_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST196617_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST196613_Layout __ND13752819__Project(B_U_C_C_1(__in,__cfg).__ST371596_Layout __PP13752815) := TRANSFORM
    __EE13752857 := __PP13752815.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE13752857),__ST196617_Layout),__NL(__EE13752857));
    SELF := __PP13752815;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE13752814,__ND13752819__Project(LEFT));
END;
