...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6199924 := __ENH_U_C_C_1;
  EXPORT __ST134324_Layout := RECORD
  ...
  END;
  EXPORT __ST134320_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST134324_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST134320_Layout __ND6199929__Project(B_U_C_C_1(__in,__cfg).__ST217759_Layout __PP6199925) := TRANSFORM
    __EE6199967 := __PP6199925.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6199967),__ST134324_Layout),__NL(__EE6199967));
    SELF := __PP6199925;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE6199924,__ND6199929__Project(LEFT));
END;
