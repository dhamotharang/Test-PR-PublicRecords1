...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE12135500 := __ENH_U_C_C_1;
  EXPORT __ST186028_Layout := RECORD
  ...
  END;
  EXPORT __ST186024_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST186028_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186024_Layout __ND12135505__Project(B_U_C_C_1(__in,__cfg).__ST338183_Layout __PP12135501) := TRANSFORM
    __EE12135543 := __PP12135501.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE12135543),__ST186028_Layout),__NL(__EE12135543));
    SELF := __PP12135501;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE12135500,__ND12135505__Project(LEFT));
END;
