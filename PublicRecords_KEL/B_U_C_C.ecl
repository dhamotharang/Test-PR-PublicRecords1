...
EXPORT B_U_C_C(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE13022632 := __ENH_U_C_C_1;
  EXPORT __ST190256_Layout := RECORD
  ...
  END;
  EXPORT __ST190252_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST190256_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST190252_Layout __ND13022637__Project(B_U_C_C_1(__in,__cfg).__ST334399_Layout __PP13022633) := TRANSFORM
    __EE13022675 := __PP13022633.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE13022675),__ST190256_Layout),__NL(__EE13022675));
    SELF := __PP13022633;
  END;
  EXPORT __ENH_U_C_C := PROJECT(__EE13022632,__ND13022637__Project(LEFT));
END;
