...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6953580 := __ENH_Address_2;
  ...
  END;
  SHARED __ST171914_Layout __ND6953408__Project(B_Address_2(__in,__cfg).__ST198116_Layout __PP6952677) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP6952677.Is_P_O_Box_Zip_,__CN(__PP6952677.Is_P_O_Box_A_D_V_O_));
    __EE6953403 := __PP6952677.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE6953403))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP6952677;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE6953580,__ND6953408__Project(LEFT));
END;
