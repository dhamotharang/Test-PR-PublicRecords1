...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7576164 := __ENH_Address_2;
  EXPORT __ST173672_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST173672_Layout __ND7575992__Project(B_Address_2(__in,__cfg).__ST200229_Layout __PP7575261) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP7575261.Is_P_O_Box_Zip_,__CN(__PP7575261.Is_P_O_Box_A_D_V_O_));
    __EE7575987 := __PP7575261.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE7575987))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP7575261;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE7576164,__ND7575992__Project(LEFT));
END;
