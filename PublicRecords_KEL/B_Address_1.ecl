...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7245095 := __ENH_Address_2;
  EXPORT __ST168295_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST168295_Layout __ND7244923__Project(B_Address_2(__in,__cfg).__ST194157_Layout __PP7244192) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP7244192.Is_P_O_Box_Zip_,__CN(__PP7244192.Is_P_O_Box_A_D_V_O_));
    __EE7244918 := __PP7244192.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE7244918))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP7244192;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE7245095,__ND7244923__Project(LEFT));
END;
