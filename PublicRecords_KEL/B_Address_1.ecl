...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4641725 := __ENH_Address_2;
  EXPORT __ST134443_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST134443_Layout __ND4641553__Project(B_Address_2(__in,__cfg).__ST156148_Layout __PP4640962) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP4640962.Is_P_O_Box_Zip_,__CN(__PP4640962.Is_P_O_Box_A_D_V_O_));
    __EE4641548 := __PP4640962.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE4641548))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP4640962;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE4641725,__ND4641553__Project(LEFT));
END;
