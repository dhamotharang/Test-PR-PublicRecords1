...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7605125 := __ENH_Address_2;
  EXPORT __ST174890_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST174890_Layout __ND7604953__Project(B_Address_2(__in,__cfg).__ST201570_Layout __PP7604222) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP7604222.Is_P_O_Box_Zip_,__CN(__PP7604222.Is_P_O_Box_A_D_V_O_));
    __EE7604948 := __PP7604222.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE7604948))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP7604222;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE7605125,__ND7604953__Project(LEFT));
END;
