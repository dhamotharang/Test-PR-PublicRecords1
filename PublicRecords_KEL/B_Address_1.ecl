...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4656189 := __ENH_Address_2;
  EXPORT __ST136323_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST136323_Layout __ND4656017__Project(B_Address_2(__in,__cfg).__ST158365_Layout __PP4655426) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP4655426.Is_P_O_Box_Zip_,__CN(__PP4655426.Is_P_O_Box_A_D_V_O_));
    __EE4656012 := __PP4655426.Bestchild_Advo_;
    SELF.Only_G_M_Flag_ := (__T(__EE4656012))[1].Only_Way_To_Get_Mail_Indicator_;
    SELF := __PP4655426;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE4656189,__ND4656017__Project(LEFT));
END;
