...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1719939 := __ENH_Business_Sele;
  SHARED __EE1722900 := __EE1719939(__T(__AND(__OP2(__EE1719939.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE1719939.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE1719939.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST45378_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Business_Sele(__in,__cfg_Local).__ST39169_Layout) B_E___Ver_Src_List_;
