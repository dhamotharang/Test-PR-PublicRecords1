...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.kdate __PInputArchiveDateClean, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE810303 := __ENH_Business;
  SHARED __EE812886 := __EE810303(__T(__AND(__OP2(__EE810303.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE810303.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE810303.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST32040_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Business(__in,__cfg_Local).__ST26895_Layout) Src_Ver_Bus_Legal_Entity_List_;
