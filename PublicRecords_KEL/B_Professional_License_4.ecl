...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5416552 := __ENH_Professional_License_5;
  EXPORT __ST243968_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST243968_Layout __ND5416736__Project(B_Professional_License_5(__in,__cfg).__ST250610_Layout __PP5416553) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP5416553.Max_Expire_Date_,>,__PP5416553.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP5416553.License_Number_,<>,__CN('')),__OR(__OP2(__PP5416553.Max_Issue_Date_,<,__PP5416553.B_U_I_L_D___D_A_T_E_),__NT(__PP5416553.Max_Issue_Date_)));
    SELF := __PP5416553;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE5416552,__ND5416736__Project(LEFT));
END;
