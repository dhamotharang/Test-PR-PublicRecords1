...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5910305 := __ENH_Professional_License_5;
  EXPORT __ST257413_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST257413_Layout __ND5910489__Project(B_Professional_License_5(__in,__cfg).__ST264289_Layout __PP5910306) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP5910306.Max_Expire_Date_,>,__PP5910306.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP5910306.License_Number_,<>,__CN('')),__OR(__OP2(__PP5910306.Max_Issue_Date_,<,__PP5910306.B_U_I_L_D___D_A_T_E_),__NT(__PP5910306.Max_Issue_Date_)));
    SELF := __PP5910306;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE5910305,__ND5910489__Project(LEFT));
END;
