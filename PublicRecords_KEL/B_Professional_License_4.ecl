...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5767923 := __ENH_Professional_License_5;
  EXPORT __ST247614_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST247614_Layout __ND5768107__Project(B_Professional_License_5(__in,__cfg).__ST254384_Layout __PP5767924) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP5767924.Max_Expire_Date_,>,__PP5767924.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP5767924.License_Number_,<>,__CN('')),__OR(__OP2(__PP5767924.Max_Issue_Date_,<,__PP5767924.B_U_I_L_D___D_A_T_E_),__NT(__PP5767924.Max_Issue_Date_)));
    SELF := __PP5767924;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE5767923,__ND5768107__Project(LEFT));
END;
