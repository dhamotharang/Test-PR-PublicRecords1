...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5845864 := __ENH_Professional_License_5;
  EXPORT __ST250729_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST250729_Layout __ND5846048__Project(B_Professional_License_5(__in,__cfg).__ST257499_Layout __PP5845865) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP5845865.Max_Expire_Date_,>,__PP5845865.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP5845865.License_Number_,<>,__CN('')),__OR(__OP2(__PP5845865.Max_Issue_Date_,<,__PP5845865.B_U_I_L_D___D_A_T_E_),__NT(__PP5845865.Max_Issue_Date_)));
    SELF := __PP5845865;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE5845864,__ND5846048__Project(LEFT));
END;
