...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5123427 := __ENH_Professional_License_5;
  EXPORT __ST234857_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST234857_Layout __ND5123599__Project(B_Professional_License_5(__in,__cfg).__ST241253_Layout __PP5123428) := TRANSFORM
    ...
    SELF.Is_Active_ := __OP2(__PP5123428.Max_Expire_Date_,>,__CC13041);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP5123428.License_Number_,<>,__CN('')),__OR(__OP2(__PP5123428.Max_Issue_Date_,<,__CC13041),__NT(__PP5123428.Max_Issue_Date_)));
    SELF := __PP5123428;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE5123427,__ND5123599__Project(LEFT));
END;
