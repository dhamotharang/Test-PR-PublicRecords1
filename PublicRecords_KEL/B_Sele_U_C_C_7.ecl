...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5102282 := __ENH_Sele_U_C_C_8;
  EXPORT __ST259890_Layout := RECORD
  ...
  END;
  EXPORT __ST259882_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST259890_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST259882_Layout __ND5102260__Project(B_Sele_U_C_C_8(__in,__cfg).__ST370093_Layout __PP5102127) := TRANSFORM
    __EE5102285 := __PP5102127.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5102285),__ST259890_Layout),__NL(__EE5102285));
    __EE5102255 := __PP5102127.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE5102255))[1].Party_Type_;
    SELF := __PP5102127;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE5102282,__ND5102260__Project(LEFT));
END;
