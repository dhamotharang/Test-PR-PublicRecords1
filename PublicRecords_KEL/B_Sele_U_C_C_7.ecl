...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5655126 := __ENH_Sele_U_C_C_8;
  EXPORT __ST269525_Layout := RECORD
  ...
  END;
  EXPORT __ST269517_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST269525_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST269517_Layout __ND5655104__Project(B_Sele_U_C_C_8(__in,__cfg).__ST418159_Layout __PP5654971) := TRANSFORM
    __EE5655129 := __PP5654971.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5655129),__ST269525_Layout),__NL(__EE5655129));
    __EE5655099 := __PP5654971.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE5655099))[1].Party_Type_;
    SELF := __PP5654971;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE5655126,__ND5655104__Project(LEFT));
END;
