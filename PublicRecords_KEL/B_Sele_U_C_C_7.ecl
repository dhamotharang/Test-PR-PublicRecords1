...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6537831 := __ENH_Sele_U_C_C_8;
  EXPORT __ST289086_Layout := RECORD
  ...
  END;
  EXPORT __ST289078_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST289086_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST289078_Layout __ND6537809__Project(B_Sele_U_C_C_8(__in,__cfg).__ST442817_Layout __PP6537676) := TRANSFORM
    __EE6537834 := __PP6537676.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6537834),__ST289086_Layout),__NL(__EE6537834));
    __EE6537804 := __PP6537676.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE6537804))[1].Party_Type_;
    SELF := __PP6537676;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE6537831,__ND6537809__Project(LEFT));
END;
