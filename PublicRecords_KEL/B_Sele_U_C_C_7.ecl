...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5448931 := __ENH_Sele_U_C_C_8;
  EXPORT __ST263554_Layout := RECORD
  ...
  END;
  EXPORT __ST263546_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST263554_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263546_Layout __ND5448909__Project(B_Sele_U_C_C_8(__in,__cfg).__ST410734_Layout __PP5448776) := TRANSFORM
    __EE5448934 := __PP5448776.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5448934),__ST263554_Layout),__NL(__EE5448934));
    __EE5448904 := __PP5448776.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE5448904))[1].Party_Type_;
    SELF := __PP5448776;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE5448931,__ND5448909__Project(LEFT));
END;
