...
EXPORT B_Sele_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4945061 := __ENH_Sele_U_C_C_8;
  EXPORT __ST250804_Layout := RECORD
  ...
  END;
  EXPORT __ST250796_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST250804_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250796_Layout __ND4945039__Project(B_Sele_U_C_C_8(__in,__cfg).__ST352812_Layout __PP4944906) := TRANSFORM
    __EE4945064 := __PP4944906.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4945064),__ST250804_Layout),__NL(__EE4945064));
    __EE4945034 := __PP4944906.Best_Party_Types_;
    SELF.Filtered_Party_Type_ := (__T(__EE4945034))[1].Party_Type_;
    SELF := __PP4944906;
  END;
  EXPORT __ENH_Sele_U_C_C_7 := PROJECT(__EE4945061,__ND4945039__Project(LEFT));
END;
