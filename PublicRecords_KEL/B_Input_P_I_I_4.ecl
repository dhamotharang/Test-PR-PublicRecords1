...
EXPORT B_Input_P_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE37912 := __ENH_Input_P_I_I_5;
  EXPORT __ST31071_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST31071_Layout __ND37985__Project(B_Input_P_I_I_5(__in,__cfg).__ST31319_Layout __PP37546) := TRANSFORM
    __CC3208 := '-99999';
    __CC3213 := '-99998';
    SELF.Input_Address_Suffix_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Address_Suffix_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Post_Direction_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Post_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Pre_Direction_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Pre_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Primary_Name_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Primary_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Primary_Range_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Primary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Secondary_Range_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Secondary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF.Input_Unit_Desig_Clean_Value_ := IF(__PP37546.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3208)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP37546.Input_Unit_Desig_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3213)))));
    SELF := __PP37546;
  END;
  EXPORT __ENH_Input_P_I_I_4 := PROJECT(__EE37912,__ND37985__Project(LEFT));
END;
