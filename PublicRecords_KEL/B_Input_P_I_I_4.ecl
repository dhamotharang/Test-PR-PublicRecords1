...
EXPORT B_Input_P_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE29563 := __ENH_Input_P_I_I_5;
  EXPORT __ST26091_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST26091_Layout __ND29636__Project(B_Input_P_I_I_5(__in,__cfg).__ST26227_Layout __PP29197) := TRANSFORM
    __CC3203 := '-99999';
    __CC3208 := '-99998';
    SELF.Input_Address_Suffix_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Address_Suffix_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Post_Direction_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Post_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Pre_Direction_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Pre_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Primary_Name_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Primary_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Primary_Range_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Primary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Secondary_Range_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Secondary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF.Input_Unit_Desig_Clean_Value_ := IF(__PP29197.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3203)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29197.Input_Unit_Desig_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3208)))));
    SELF := __PP29197;
  END;
  EXPORT __ENH_Input_P_I_I_4 := PROJECT(__EE29563,__ND29636__Project(LEFT));
END;
