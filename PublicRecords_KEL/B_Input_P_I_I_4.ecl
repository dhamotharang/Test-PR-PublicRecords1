...
EXPORT B_Input_P_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE29554 := __ENH_Input_P_I_I_5;
  EXPORT __ST26082_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST26082_Layout __ND29627__Project(B_Input_P_I_I_5(__in,__cfg).__ST26218_Layout __PP29188) := TRANSFORM
    __CC3192 := '-99999';
    __CC3197 := '-99998';
    SELF.Input_Address_Suffix_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Address_Suffix_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Post_Direction_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Post_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Pre_Direction_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Pre_Direction_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Primary_Name_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Primary_Name_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Primary_Range_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Primary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Secondary_Range_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Secondary_Range_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF.Input_Unit_Desig_Clean_Value_ := IF(__PP29188.Addr_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC3192)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP29188.Input_Unit_Desig_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3197)))));
    SELF := __PP29188;
  END;
  EXPORT __ENH_Input_P_I_I_4 := PROJECT(__EE29554,__ND29627__Project(LEFT));
END;
