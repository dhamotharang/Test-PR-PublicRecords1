...
EXPORT E_Criminal_Details(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __d1_Offender__Mapped := IF(__d1_Missing_Offender__UIDComponents = 'offender_key',PROJECT(__d1_Norm,TRANSFORM(__d1_Offender__Layout,SELF.Offender_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d1_Norm,__d1_Missing_Offender__UIDComponents),E_Criminal_Offender(__in,__cfg).Lookup,TRIM((STRING)LEFT.offender_key) = RIGHT.KeyVal,TRANSFORM(__d1_Offender__Layout,SELF.Offender_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH));
  ...
  SHARED __d2_Punishment__Mapped := IF(__d2_Missing_Punishment__UIDComponents = 'offender_key',PROJECT(__d2_Offense__Mapped,TRANSFORM(__d2_Punishment__Layout,SELF.Punishment_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d2_Offense__Mapped,__d2_Missing_Punishment__UIDComponents),E_Criminal_Punishment(__in,__cfg).Lookup,TRIM((STRING)LEFT.offender_key) = RIGHT.KeyVal,TRANSFORM(__d2_Punishment__Layout,SELF.Punishment_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH));
  ...
  SHARED __d3_Offender__Mapped := IF(__d3_Missing_Offender__UIDComponents = 'offender_key',PROJECT(__d3_Norm,TRANSFORM(__d3_Offender__Layout,SELF.Offender_:=0,SELF:=LEFT)),JOIN(KEL.Intake.AppendFields(__d3_Norm,__d3_Missing_Offender__UIDComponents),E_Criminal_Offender(__in,__cfg).Lookup,TRIM((STRING)LEFT.offender_key) = RIGHT.KeyVal,TRANSFORM(__d3_Offender__Layout,SELF.Offender_:=RIGHT.UID,SELF:=LEFT),LEFT OUTER,HASH));
