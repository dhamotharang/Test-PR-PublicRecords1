...
EXPORT B_Person_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE937324 := __E_Person_Bankruptcy;
  EXPORT __ST74521_Layout := RECORD
  ...
  END;
  SHARED __ST74521_Layout __ND937346__Project(E_Person_Bankruptcy(__in,__cfg).Layout __PP937285) := TRANSFORM
    ...
    SELF := __PP937285;
  END;
  EXPORT __ENH_Person_Bankruptcy_1 := PROJECT(__EE937324,__ND937346__Project(LEFT));
END;
