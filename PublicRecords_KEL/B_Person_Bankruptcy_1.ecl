...
EXPORT B_Person_Bankruptcy_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE933967 := __E_Person_Bankruptcy;
  EXPORT __ST75822_Layout := RECORD
  ...
  END;
  SHARED __ST75822_Layout __ND933989__Project(E_Person_Bankruptcy(__in,__cfg).Layout __PP933928) := TRANSFORM
    ...
    SELF := __PP933928;
  END;
  EXPORT __ENH_Person_Bankruptcy_1 := PROJECT(__EE933967,__ND933989__Project(LEFT));
END;
