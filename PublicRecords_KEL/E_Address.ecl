...
EXPORT E_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Trimmed := RECORD, MAXLENGTH(5000)
    STRING KeyVal;
  END;
  SHARED __d0_KELfiltered := __in.Dataset_ADVO__Key_Addr1((STRING28)prim_name != '' AND (UNSIGNED3)zip != 0);
  ...
  SHARED __d1_KELfiltered := __in.Dataset_ADVO__Key_Addr1_History((STRING28)prim_name != '' AND (UNSIGNED3)zip != 0);
  ...
  SHARED __d2_KELfiltered := __in.Dataset_DMA__Key_DNM_Name_Address((STRING28)prim_name != '' AND (UNSIGNED3)zip != 0);
  ...
  SHARED __d3_KELfiltered := __in.Dataset_Fraudpoint3__Key_Address((STRING28)prim_name != '' AND (UNSIGNED3)zip != 0);
  ...
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_ADVO__Key_Addr1_Invalid := __d0_Geo_Link_I_D__Mapped(UID = 0);
  ...
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_ADVO__Key_Addr1_History_Invalid := __d1_Geo_Link_I_D__Mapped(UID = 0);
  ...
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DMA__Key_DNM_Name_Address_Invalid := __d2_Geo_Link_I_D__Mapped(UID = 0);
  ...
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Fraudpoint3__Key_Address_Invalid := __d3_Geo_Link_I_D__Mapped(UID = 0);
