...
EXPORT Q_Mini_Attributes_V1_Roxie_Dynamic(SET OF KEL.typ.uid __PLexID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, KEL.typ.bool __PIsFCRA, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE13787511 := __ENH_Person;
  SHARED __EE13790478 := __EE13787511(__T(__OP2(__EE13787511.UID,IN,__CN(__PLexID_in))));
  SHARED __ST136672_Layout := RECORD
  ...
  END;
  SHARED __ST136672_Layout __ND13790483__Project(B_Person(__in,__cfg_Local).__ST192570_Layout __PP13790479) := TRANSFORM
    SELF.Lex_I_D_ := __PP13790479.UID;
    SELF.P___Lex_I_D_Seen_Flag_ := IF(__PIsFCRA,__PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_,__PP13790479.P___Lex_I_D_Seen_Flag_);
    SELF.Prep_Current_Addr_Prim_Rng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Prim_Rng_));
    SELF.Prep_Current_Addr_Pre_Dir_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Pre_Dir_));
    SELF.Prep_Current_Addr_Prim_Name_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Prim_Name_));
    SELF.Prep_Current_Postdirectional_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Postdirectional_));
    SELF.Prep_Current_Addr_Sffx_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Sffx_));
    SELF.Prep_Current_Addr_Sec_Rng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Sec_Rng_));
    SELF.Prep_Current_Addr_State_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_State_));
    SELF.Prep_Current_Addr_Zip5_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Zip5_));
    SELF.Prep_Current_Addr_Zip4_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Zip4_));
    SELF.Prep_Current_Addr_State_Code_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_State_Code_));
    SELF.Prep_Current_Addr_Cnty_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Cnty_));
    SELF.Prep_Current_Addr_Geo_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Geo_));
    SELF.Prep_Current_Addr_City_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_City_));
    SELF.Prep_Current_Addr_Lat_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Lat_));
    SELF.Prep_Current_Addr_Lng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Lng_));
    SELF.Prep_Current_Addr_Unit_Designation_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Unit_Designation_));
    SELF.Prep_Current_Addr_Type_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Type_));
    SELF.Prep_Current_Addr_Status_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Status_));
    SELF.Prep_Current_Addr_Date_First_Seen_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Date_First_Seen_));
    SELF.Prep_Current_Addr_Date_Last_Seen_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Date_Last_Seen_));
    SELF.Prep_Current_Addr_Full_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Current_Addr_Full_));
    SELF.Prep_Previous_Addr_Prim_Rng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Prim_Rng_));
    SELF.Prep_Previous_Addr_Pre_Dir_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Pre_Dir_));
    SELF.Prep_Previous_Addr_Prim_Name_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Prim_Name_));
    SELF.Prep_Previous_Postdirectional_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Postdirectional_));
    SELF.Prep_Previous_Addr_Sffx_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Sffx_));
    SELF.Prep_Previous_Addr_Sec_Rng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Sec_Rng_));
    SELF.Prep_Previous_Addr_State_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_State_));
    SELF.Prep_Previous_Addr_Zip5_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Zip5_));
    SELF.Prep_Previous_Addr_Zip4_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Zip4_));
    SELF.Prep_Previous_Addr_State_Code_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_State_Code_));
    SELF.Prep_Previous_Addr_Cnty_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Cnty_));
    SELF.Prep_Previous_Addr_Geo_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Geo_));
    SELF.Prep_Previous_Addr_City_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_City_));
    SELF.Prep_Previous_Addr_Lat_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Lat_));
    SELF.Prep_Previous_Addr_Lng_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Lng_));
    SELF.Prep_Previous_Addr_Unit_Designation_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Unit_Designation_));
    SELF.Prep_Previous_Addr_Type_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Type_));
    SELF.Prep_Previous_Addr_Status_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Status_));
    SELF.Prep_Previous_Addr_Date_First_Seen_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Date_First_Seen_));
    SELF.Prep_Previous_Addr_Date_Last_Seen_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Date_Last_Seen_));
    SELF.Prep_Previous_Addr_Full_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP13790479.Prep_Previous_Addr_Full_));
    __CC13938 := '-99999';
    SELF.P_L___Best_Name_First_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13938)),__ECAST(KEL.typ.nstr,__PP13790479.P_L___Best_Name_First_));
    SELF.P_L___Best_Name_Mid_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13938)),__ECAST(KEL.typ.nstr,__PP13790479.P_L___Best_Name_Mid_));
    SELF.P_L___Best_Name_Last_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13938)),__ECAST(KEL.typ.nstr,__PP13790479.P_L___Best_Name_Last_));
    SELF.P_L___Best_S_S_N_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13938)),__ECAST(KEL.typ.nstr,__PP13790479.P_L___Best_S_S_N_));
    SELF.P_L___Best_D_O_B_ := IF(__PIsFCRA AND __PP13790479.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC13938)),__ECAST(KEL.typ.nstr,__PP13790479.P_L___Best_D_O_B_));
    SELF := __PP13790479;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE13790478,__ND13790483__Project(LEFT)));
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    OUTPUT(DBG_E_Accident_Result,NAMED('DBG_E_Accident_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Result,NAMED('DBG_E_Address_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Inquiry_Result,NAMED('DBG_E_Address_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Property_Result,NAMED('DBG_E_Address_Property_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Aircraft_Owner_Result,NAMED('DBG_E_Aircraft_Owner_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Result,NAMED('DBG_E_Bankruptcy_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Result,NAMED('DBG_E_Criminal_Offense_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Result,NAMED('DBG_E_Education_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Email_Result,NAMED('DBG_E_Email_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Email_Inquiry_Result,NAMED('DBG_E_Email_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_First_Degree_Associations_Result,NAMED('DBG_E_First_Degree_Associations_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_First_Degree_Relative_Result,NAMED('DBG_E_First_Degree_Relative_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Household_Result,NAMED('DBG_E_Household_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Household_Member_Result,NAMED('DBG_E_Household_Member_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Result,NAMED('DBG_E_Input_P_I_I_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Result,NAMED('DBG_E_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Lien_Judgment_Result,NAMED('DBG_E_Lien_Judgment_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Result,NAMED('DBG_E_Person_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Accident_Result,NAMED('DBG_E_Person_Accident_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Address_Result,NAMED('DBG_E_Person_Address_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Bankruptcy_Result,NAMED('DBG_E_Person_Bankruptcy_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Education_Result,NAMED('DBG_E_Person_Education_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Email_Result,NAMED('DBG_E_Person_Email_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Result,NAMED('DBG_E_Person_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Result,NAMED('DBG_E_Person_Lien_Judgment_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Offenses_Result,NAMED('DBG_E_Person_Offenses_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Result,NAMED('DBG_E_Person_Property_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Event_Result,NAMED('DBG_E_Person_Property_Event_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Result,NAMED('DBG_E_Person_S_S_N_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Vehicle_Result,NAMED('DBG_E_Person_Vehicle_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Phone_Result,NAMED('DBG_E_Phone_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Phone_Inquiry_Result,NAMED('DBG_E_Phone_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Result,NAMED('DBG_E_Professional_License_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Person_Result,NAMED('DBG_E_Professional_License_Person_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Result,NAMED('DBG_E_Property_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Result,NAMED('DBG_E_Property_Event_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_S_S_N_Inquiry_Result,NAMED('DBG_E_S_S_N_Inquiry_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Result,NAMED('DBG_E_Sele_Person_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Social_Security_Number_Result,NAMED('DBG_E_Social_Security_Number_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Utility_Person_Result,NAMED('DBG_E_Utility_Person_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Watercraft_Owner_Result,NAMED('DBG_E_Watercraft_Owner_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Zip_Code_Result,NAMED('DBG_E_Zip_Code_Result_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_14,NAMED('DBG_E_Lien_Judgment_Intermediate_14_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_13_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_12,NAMED('DBG_E_Person_Intermediate_12_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_11,NAMED('DBG_E_Inquiry_Intermediate_11_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_11,NAMED('DBG_E_Person_Intermediate_11_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_10,NAMED('DBG_E_Inquiry_Intermediate_10_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_10,NAMED('DBG_E_Person_Intermediate_10_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_9,NAMED('DBG_E_Bankruptcy_Intermediate_9_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_9,NAMED('DBG_E_Input_P_I_I_Intermediate_9_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_9,NAMED('DBG_E_Inquiry_Intermediate_9_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_9,NAMED('DBG_E_Person_Intermediate_9_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_8,NAMED('DBG_E_Bankruptcy_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_8,NAMED('DBG_E_Criminal_Offense_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_8,NAMED('DBG_E_Education_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_8,NAMED('DBG_E_Input_P_I_I_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_8,NAMED('DBG_E_Inquiry_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_8,NAMED('DBG_E_Person_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Accident_Intermediate_8,NAMED('DBG_E_Person_Accident_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_8,NAMED('DBG_E_Person_Inquiry_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_8,NAMED('DBG_E_Person_Property_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_8,NAMED('DBG_E_Property_Event_Intermediate_8_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_7,NAMED('DBG_E_Bankruptcy_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_7,NAMED('DBG_E_Criminal_Offense_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_7,NAMED('DBG_E_Education_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_7,NAMED('DBG_E_Input_P_I_I_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_7,NAMED('DBG_E_Inquiry_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_7,NAMED('DBG_E_Person_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_7,NAMED('DBG_E_Person_Inquiry_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_7,NAMED('DBG_E_Person_Property_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_7,NAMED('DBG_E_Person_S_S_N_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_7,NAMED('DBG_E_Property_Event_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Intermediate_7,NAMED('DBG_E_Sele_Person_Intermediate_7_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Intermediate_6,NAMED('DBG_E_Address_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_6,NAMED('DBG_E_Bankruptcy_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_6,NAMED('DBG_E_Criminal_Offense_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_6,NAMED('DBG_E_Education_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_6,NAMED('DBG_E_Input_P_I_I_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_6,NAMED('DBG_E_Inquiry_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_6,NAMED('DBG_E_Person_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_6,NAMED('DBG_E_Person_Inquiry_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_6,NAMED('DBG_E_Person_Property_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_6,NAMED('DBG_E_Person_S_S_N_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_6,NAMED('DBG_E_Property_Event_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Intermediate_6,NAMED('DBG_E_Sele_Person_Intermediate_6_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Intermediate_5,NAMED('DBG_E_Address_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Property_Intermediate_5,NAMED('DBG_E_Address_Property_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_5,NAMED('DBG_E_Bankruptcy_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_5,NAMED('DBG_E_Criminal_Offense_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_5,NAMED('DBG_E_Education_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_First_Degree_Relative_Intermediate_5,NAMED('DBG_E_First_Degree_Relative_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_5,NAMED('DBG_E_Input_P_I_I_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_5,NAMED('DBG_E_Inquiry_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_5,NAMED('DBG_E_Person_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_5,NAMED('DBG_E_Person_Inquiry_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_5,NAMED('DBG_E_Person_Property_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_5,NAMED('DBG_E_Person_S_S_N_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Intermediate_5,NAMED('DBG_E_Professional_License_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Intermediate_5,NAMED('DBG_E_Property_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_5,NAMED('DBG_E_Property_Event_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Intermediate_5,NAMED('DBG_E_Sele_Person_Intermediate_5_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Intermediate_4,NAMED('DBG_E_Address_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Property_Intermediate_4,NAMED('DBG_E_Address_Property_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_4,NAMED('DBG_E_Bankruptcy_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_4,NAMED('DBG_E_Criminal_Offense_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_4,NAMED('DBG_E_Education_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_4,NAMED('DBG_E_Input_P_I_I_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_4,NAMED('DBG_E_Inquiry_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_4,NAMED('DBG_E_Person_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_4,NAMED('DBG_E_Person_Inquiry_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_4,NAMED('DBG_E_Person_Property_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_4,NAMED('DBG_E_Person_S_S_N_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Intermediate_4,NAMED('DBG_E_Professional_License_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Intermediate_4,NAMED('DBG_E_Property_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_4,NAMED('DBG_E_Property_Event_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Intermediate_4,NAMED('DBG_E_Sele_Person_Intermediate_4_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Intermediate_3,NAMED('DBG_E_Address_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Property_Intermediate_3,NAMED('DBG_E_Address_Property_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Aircraft_Owner_Intermediate_3,NAMED('DBG_E_Aircraft_Owner_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_3,NAMED('DBG_E_Bankruptcy_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_3,NAMED('DBG_E_Criminal_Offense_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_3,NAMED('DBG_E_Education_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_3,NAMED('DBG_E_Input_P_I_I_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Inquiry_Intermediate_3,NAMED('DBG_E_Inquiry_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_3,NAMED('DBG_E_Person_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_3,NAMED('DBG_E_Person_Inquiry_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_3,NAMED('DBG_E_Person_Property_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_3,NAMED('DBG_E_Person_S_S_N_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Vehicle_Intermediate_3,NAMED('DBG_E_Person_Vehicle_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Intermediate_3,NAMED('DBG_E_Professional_License_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Intermediate_3,NAMED('DBG_E_Property_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_3,NAMED('DBG_E_Property_Event_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Sele_Person_Intermediate_3,NAMED('DBG_E_Sele_Person_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Watercraft_Owner_Intermediate_3,NAMED('DBG_E_Watercraft_Owner_Intermediate_3_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Address_Intermediate_2,NAMED('DBG_E_Address_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Aircraft_Owner_Intermediate_2,NAMED('DBG_E_Aircraft_Owner_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_2,NAMED('DBG_E_Bankruptcy_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_2,NAMED('DBG_E_Criminal_Offense_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_2,NAMED('DBG_E_Education_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Email_Intermediate_2,NAMED('DBG_E_Email_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_2,NAMED('DBG_E_Input_P_I_I_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_2,NAMED('DBG_E_Person_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_2,NAMED('DBG_E_Person_Property_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_2,NAMED('DBG_E_Person_S_S_N_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Vehicle_Intermediate_2,NAMED('DBG_E_Person_Vehicle_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Intermediate_2,NAMED('DBG_E_Professional_License_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Intermediate_2,NAMED('DBG_E_Property_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_2,NAMED('DBG_E_Property_Event_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Watercraft_Owner_Intermediate_2,NAMED('DBG_E_Watercraft_Owner_Intermediate_2_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Aircraft_Owner_Intermediate_1,NAMED('DBG_E_Aircraft_Owner_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_1,NAMED('DBG_E_Bankruptcy_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_1,NAMED('DBG_E_Criminal_Offense_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Education_Intermediate_1,NAMED('DBG_E_Education_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_1,NAMED('DBG_E_Input_P_I_I_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Intermediate_1,NAMED('DBG_E_Person_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Property_Intermediate_1,NAMED('DBG_E_Person_Property_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_1,NAMED('DBG_E_Person_S_S_N_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Person_Vehicle_Intermediate_1,NAMED('DBG_E_Person_Vehicle_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Professional_License_Intermediate_1,NAMED('DBG_E_Professional_License_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Property_Event_Intermediate_1,NAMED('DBG_E_Property_Event_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
    OUTPUT(DBG_E_Watercraft_Owner_Intermediate_1,NAMED('DBG_E_Watercraft_Owner_Intermediate_1_Q_Mini_Attributes_V1_Roxie_Dynamic')),
