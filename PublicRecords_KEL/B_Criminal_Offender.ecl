...
EXPORT B_Criminal_Offender(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE578374 := __E_Criminal_Offender;
  EXPORT __ST41478_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST41478_Layout __ND578528__Project(E_Criminal_Offender(__in,__cfg).Layout __PP578233) := TRANSFORM
    ...
    SELF := __PP578233;
  END;
  EXPORT __ENH_Criminal_Offender := PROJECT(__EE578374,__ND578528__Project(LEFT));
END;
