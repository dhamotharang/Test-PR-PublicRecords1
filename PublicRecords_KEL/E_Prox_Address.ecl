...
EXPORT E_Prox_Address(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT __d8_KELfiltered := __d8_Norm((STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0  AND (UNSIGNED)proxid<>0);
  ...
  EXPORT __d10_KELfiltered := __d10_Norm((STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0 AND (UNSIGNED)proxid<>0 AND ((UNSIGNED)efx_secsic1 > 0 OR (UNSIGNED)efx_secnaics1 > 0));
  ...
  EXPORT __d11_KELfiltered := __d11_Norm((STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0 AND (UNSIGNED)proxid<>0 AND ((UNSIGNED)efx_secsic2 > 0 OR (UNSIGNED)efx_secnaics2 > 0));
  ...
  EXPORT __d12_KELfiltered := __d12_Norm((STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0 AND (UNSIGNED)proxid<>0 AND ((UNSIGNED)efx_secsic3 > 0 OR (UNSIGNED)efx_secnaics3 > 0));
  ...
  EXPORT __d13_KELfiltered := __d13_Norm((STRING10)prim_range != '' AND (STRING28)prim_name != '' AND (UNSIGNED3)zip != 0 AND (UNSIGNED)proxid<>0 AND ((UNSIGNED)efx_secsic4 > 0 OR (UNSIGNED)efx_secnaics4 > 0));
  ...
  EXPORT Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __PostFilter := __GroupedFilter(GROUP(InData,Site_,Location_,Primary_Range_,Predirectional_,Primary_Name_,Suffix_,Postdirectional_,Secondary_Range_,Z_I_P5_,ALL));
  Prox_Address_Group := __PostFilter;
  Layout Prox_Address__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    SELF.Other_Location_Details_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Unit_Designation_,Postal_City_,Vanity_City_,State_,Z_I_P4_,Metropolitan_Statistical_Area_},Unit_Designation_,Postal_City_,Vanity_City_,State_,Z_I_P4_,Metropolitan_Statistical_Area_),Other_Location_Details_Layout)(__NN(Unit_Designation_) OR __NN(Postal_City_) OR __NN(Vanity_City_) OR __NN(State_) OR __NN(Z_I_P4_) OR __NN(Metropolitan_Statistical_Area_)));
    SELF.Address_Types_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Company_Address_Type_Raw_,Company_Address_Type_Derived_,Address_Type_Derived_},Company_Address_Type_Raw_,Company_Address_Type_Derived_,Address_Type_Derived_),Address_Types_Layout)(__NN(Company_Address_Type_Raw_) OR __NN(Company_Address_Type_Derived_) OR __NN(Address_Type_Derived_)));
    ...
    SELF.Data_Sources_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_,Date_Vendor_First_Reported_,Date_Vendor_Last_Reported_,Date_First_Seen_Company_Address_,Date_Last_Seen_Company_Address_},Source_,Date_Vendor_First_Reported_,Date_Vendor_Last_Reported_,Date_First_Seen_Company_Address_,Date_Last_Seen_Company_Address_),Data_Sources_Layout)(__NN(Source_) OR __NN(Date_Vendor_First_Reported_) OR __NN(Date_Vendor_Last_Reported_) OR __NN(Date_First_Seen_Company_Address_) OR __NN(Date_Last_Seen_Company_Address_)));
  ...
  Layout Prox_Address__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Other_Location_Details_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Other_Location_Details_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Unit_Designation_) OR __NN(Postal_City_) OR __NN(Vanity_City_) OR __NN(State_) OR __NN(Z_I_P4_) OR __NN(Metropolitan_Statistical_Area_)));
    SELF.Address_Types_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Address_Types_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Company_Address_Type_Raw_) OR __NN(Company_Address_Type_Derived_) OR __NN(Address_Type_Derived_)));
    ...
    SELF.Data_Sources_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Data_Sources_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Source_) OR __NN(Date_Vendor_First_Reported_) OR __NN(Date_Vendor_Last_Reported_) OR __NN(Date_First_Seen_Company_Address_) OR __NN(Date_Last_Seen_Company_Address_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_last_reported',COUNT(__d9(__NL(Date_Vendor_Last_Reported_))),COUNT(__d9(__NN(Date_Vendor_Last_Reported_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dt_vendor_first_reported',COUNT(__d9(__NL(Date_Vendor_First_Reported_))),COUNT(__d9(__NN(Date_Vendor_First_Reported_)))},
    ...
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d14(__NL(Date_Vendor_Last_Reported_))),COUNT(__d14(__NN(Date_Vendor_Last_Reported_)))},
    {'ProxAddress','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d14(__NL(Date_Vendor_First_Reported_))),COUNT(__d14(__NN(Date_Vendor_First_Reported_)))},
