...
EXPORT B_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3706309 := __ENH_Property_5;
  EXPORT __ST191037_Layout := RECORD
  ...
  END;
  EXPORT __ST191019_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST191037_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST191019_Layout __ND3706314__Project(B_Property_5(__in,__cfg).__ST196512_Layout __PP3706310) := TRANSFORM
    __EE3706353 := __PP3706310.Automated_Valuation_Model_;
    __ST191037_Layout __ND3706358__Project(B_Property_5(__in,__cfg).__ST196530_Layout __PP3706354) := TRANSFORM
      ...
      SELF.A_V_M_Years_ := FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP3706354.A_V_M_Value_Date_),__ECAST(KEL.typ.nkdate,__CC10302));
      SELF := __PP3706354;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE3706353,__ND3706358__Project(LEFT));
    SELF := __PP3706310;
  END;
  EXPORT __ENH_Property_4 := PROJECT(__EE3706309,__ND3706314__Project(LEFT));
END;
