...
EXPORT Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid(KEL.typ.str __PSSN_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11340643 := __ENH_S_S_N_Summary;
  SHARED __EE11340951 := __EE11340643(__T(__OP2(__EE11340643.S_S_N_,=,__CN(__PSSN_in))));
  SHARED __ST124130_Layout := RECORD
    KEL.typ.nbool Exp1_;
    KEL.typ.nstr P___Inp_Cln_Phone_Home_;
    KEL.typ.ndataset(B_S_S_N_Summary_3(__in,__cfg_Local).__ST79297_Layout) S_S_N_Summary_Source_List_Sorted_;
  ...
  SHARED __ST124130_Layout __ND11340959__Rollup(__ST124130_Layout __r, DATASET(__ST124130_Layout) __recs) := TRANSFORM
    ...
    SELF := __r;
  END;
  EXPORT Res0 := __UNWRAP(ROLLUP(GROUP(KEL.Routines.SortAndAppendFilteredChildren(PROJECT(__EE11340951,__ND11340959__Project(LEFT)),'S_S_N_Summary_Source_List_Sorted_','s_s_n_summary_source_list_sorted_','clean','__recordcount,archive___date_,date_first_seen_,date_last_seen_,hybrid_archive_date_,vault_date_last_seen_'),Exp1_,P___Inp_Cln_Phone_Home_,S_S_N_Summary_Source_List_Sorted_Clean,P_I___Src_W_Inp_A_S_List_Ev_,P_I___Src_W_Inp_A_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_A_S_Last_Dt_List_Ev_,P_I___Src_W_Inp_S_D_List_Ev_,P_I___Src_W_Inp_S_D_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_S_D_Last_Dt_List_Ev_,P_I___Src_W_Inp_P_S_List_Ev_,P_I___Src_W_Inp_P_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_P_S_Last_Dt_List_Ev_,P_I___Src_W_Inp_F_L_S_List_Ev_,P_I___Src_W_Inp_F_L_S_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_F_L_S_Last_Dt_List_Ev_,ALL),GROUP,__ND11340959__Rollup(ROW(LEFT,__ST124130_Layout), PROJECT(ROWS(LEFT),__ST124130_Layout))));
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    OUTPUT(DBG_E_Input_P_I_I_PreEntity,NAMED('DBG_E_Input_P_I_I_PreEntity_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Result,NAMED('DBG_E_Input_P_I_I_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Accident_Result,NAMED('DBG_E_Accident_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Address_Result,NAMED('DBG_E_Address_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Address_Inquiry_Result,NAMED('DBG_E_Address_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Address_Property_Result,NAMED('DBG_E_Address_Property_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Aircraft_Owner_Result,NAMED('DBG_E_Aircraft_Owner_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Bankruptcy_Result,NAMED('DBG_E_Bankruptcy_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Criminal_Offense_Result,NAMED('DBG_E_Criminal_Offense_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Education_Result,NAMED('DBG_E_Education_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Email_Result,NAMED('DBG_E_Email_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Email_Inquiry_Result,NAMED('DBG_E_Email_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_First_Degree_Associations_Result,NAMED('DBG_E_First_Degree_Associations_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_First_Degree_Relative_Result,NAMED('DBG_E_First_Degree_Relative_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Household_Result,NAMED('DBG_E_Household_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Household_Member_Result,NAMED('DBG_E_Household_Member_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Result,NAMED('DBG_E_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Lien_Judgment_Result,NAMED('DBG_E_Lien_Judgment_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Result,NAMED('DBG_E_Person_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Accident_Result,NAMED('DBG_E_Person_Accident_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Address_Result,NAMED('DBG_E_Person_Address_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Bankruptcy_Result,NAMED('DBG_E_Person_Bankruptcy_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Education_Result,NAMED('DBG_E_Person_Education_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Email_Result,NAMED('DBG_E_Person_Email_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Inquiry_Result,NAMED('DBG_E_Person_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Result,NAMED('DBG_E_Person_Lien_Judgment_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Offenses_Result,NAMED('DBG_E_Person_Offenses_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Result,NAMED('DBG_E_Person_Property_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Event_Result,NAMED('DBG_E_Person_Property_Event_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_S_S_N_Result,NAMED('DBG_E_Person_S_S_N_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Vehicle_Result,NAMED('DBG_E_Person_Vehicle_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Phone_Result,NAMED('DBG_E_Phone_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Phone_Inquiry_Result,NAMED('DBG_E_Phone_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Professional_License_Result,NAMED('DBG_E_Professional_License_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Professional_License_Person_Result,NAMED('DBG_E_Professional_License_Person_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Result,NAMED('DBG_E_Property_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Event_Result,NAMED('DBG_E_Property_Event_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Inquiry_Result,NAMED('DBG_E_S_S_N_Inquiry_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Result,NAMED('DBG_E_S_S_N_Summary_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Sele_Person_Result,NAMED('DBG_E_Sele_Person_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Social_Security_Number_Result,NAMED('DBG_E_Social_Security_Number_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Utility_Person_Result,NAMED('DBG_E_Utility_Person_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Watercraft_Owner_Result,NAMED('DBG_E_Watercraft_Owner_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Zip_Code_Result,NAMED('DBG_E_Zip_Code_Result_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Lien_Judgment_Intermediate_13_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_12,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_12_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_11,NAMED('DBG_E_Inquiry_Intermediate_11_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_11,NAMED('DBG_E_Person_Intermediate_11_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_10,NAMED('DBG_E_Input_P_I_I_Intermediate_10_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_10,NAMED('DBG_E_Inquiry_Intermediate_10_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_10,NAMED('DBG_E_Person_Intermediate_10_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_9,NAMED('DBG_E_Input_P_I_I_Intermediate_9_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_9,NAMED('DBG_E_Inquiry_Intermediate_9_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_9,NAMED('DBG_E_Person_Intermediate_9_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_8,NAMED('DBG_E_Bankruptcy_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_8,NAMED('DBG_E_Input_P_I_I_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_8,NAMED('DBG_E_Inquiry_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_8,NAMED('DBG_E_Person_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Accident_Intermediate_8,NAMED('DBG_E_Person_Accident_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_8,NAMED('DBG_E_Person_Inquiry_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Intermediate_8,NAMED('DBG_E_Person_Property_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Event_Intermediate_8,NAMED('DBG_E_Property_Event_Intermediate_8_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_7,NAMED('DBG_E_Bankruptcy_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Education_Intermediate_7,NAMED('DBG_E_Education_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_7,NAMED('DBG_E_Input_P_I_I_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_7,NAMED('DBG_E_Inquiry_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_7,NAMED('DBG_E_Person_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_7,NAMED('DBG_E_Person_Inquiry_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Intermediate_7,NAMED('DBG_E_Person_Property_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Event_Intermediate_7,NAMED('DBG_E_Property_Event_Intermediate_7_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Address_Intermediate_6,NAMED('DBG_E_Address_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_6,NAMED('DBG_E_Bankruptcy_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_6,NAMED('DBG_E_Input_P_I_I_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_6,NAMED('DBG_E_Inquiry_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_6,NAMED('DBG_E_Person_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_6,NAMED('DBG_E_Person_Inquiry_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Intermediate_6,NAMED('DBG_E_Person_Property_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Event_Intermediate_6,NAMED('DBG_E_Property_Event_Intermediate_6_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Address_Intermediate_5,NAMED('DBG_E_Address_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Bankruptcy_Intermediate_5,NAMED('DBG_E_Bankruptcy_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_5,NAMED('DBG_E_Input_P_I_I_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_5,NAMED('DBG_E_Inquiry_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_5,NAMED('DBG_E_Person_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Inquiry_Intermediate_5,NAMED('DBG_E_Person_Inquiry_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Property_Intermediate_5,NAMED('DBG_E_Person_Property_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Intermediate_5,NAMED('DBG_E_Property_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Intermediate_5,NAMED('DBG_E_S_S_N_Summary_Intermediate_5_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_4,NAMED('DBG_E_Input_P_I_I_Intermediate_4_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Inquiry_Intermediate_4,NAMED('DBG_E_Inquiry_Intermediate_4_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Person_Intermediate_4,NAMED('DBG_E_Person_Intermediate_4_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Property_Intermediate_4,NAMED('DBG_E_Property_Intermediate_4_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Intermediate_4,NAMED('DBG_E_S_S_N_Summary_Intermediate_4_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_3,NAMED('DBG_E_Input_P_I_I_Intermediate_3_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Intermediate_3,NAMED('DBG_E_S_S_N_Summary_Intermediate_3_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Intermediate_2,NAMED('DBG_E_S_S_N_Summary_Intermediate_2_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Intermediate_1,NAMED('DBG_E_S_S_N_Summary_Intermediate_1_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid')),
    OUTPUT(DBG_E_S_S_N_Summary_Annotated,NAMED('DBG_E_S_S_N_Summary_Annotated_Q_Non_F_C_R_A_S_S_N_Summary_Attributes_V1_Hybrid'))
  );
