...
EXPORT B_Property_Event_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4012114 := __ENH_Property_Event_4;
  EXPORT __ST173128_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST173128_Layout __ND4012119__Project(B_Property_Event_4(__in,__cfg).__ST182503_Layout __PP4012115) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP4012115.Date_First_Seen_);
    SELF := __PP4012115;
  END;
  EXPORT __ENH_Property_Event_3 := PROJECT(__EE4012114,__ND4012119__Project(LEFT));
END;
