...
EXPORT B_Property_Event_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1107272 := __ENH_Property_Event_4;
  EXPORT __ST146619_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST146619_Layout __ND1107603__Project(B_Property_Event_5(__in,__cfg).__ST160280_Layout __PP1105620) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP1105620.Date_First_Seen_);
    SELF := __PP1105620;
  END;
  EXPORT __ENH_Property_Event_3 := PROJECT(__EE1107272,__ND1107603__Project(LEFT));
END;
