...
EXPORT B_Lien_Judgment_14(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE370807 := __E_Lien_Judgment;
  EXPORT __ST290156_Layout := RECORD
  ...
  END;
  EXPORT __ST290151_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST290156_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST290151_Layout __ND371116__Project(E_Lien_Judgment(__in,__cfg).Layout __PP371049) := TRANSFORM
    __EE370655 := __PP371049.Filing_;
    __ST290156_Layout __ND371052__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP371051) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP371049.T_M_S_I_D_;
      SELF := __PP371051;
    END;
    SELF.Filing_ := __PROJECT(__EE370655,__ND371052__Project(LEFT));
    SELF := __PP371049;
  END;
  EXPORT __ENH_Lien_Judgment_14 := PROJECT(__EE370807,__ND371116__Project(LEFT));
END;
