...
EXPORT B_Email_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1620074 := __E_Email;
  EXPORT __ST221754_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST221754_Layout __ND7276564__Project(E_Email(__in,__cfg).Layout __PP1619879) := TRANSFORM
    ...
    __CC34201 := 2556;
    SELF.Emails7y_ := __OP2(FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__CC13258),__ECAST(KEL.typ.nkdate,KEL.era.ToDate(__PP1619879.Date_Last_Seen_))),<,__CN(__CC34201));
    SELF := __PP1619879;
  END;
  EXPORT __ENH_Email_2 := PROJECT(__EE1620074,__ND7276564__Project(LEFT));
END;
