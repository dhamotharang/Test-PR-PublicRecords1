...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11969170 := __ENH_Business_Sele;
  SHARED __EE11970508 := __EE11969170(__T(__AND(__OP2(__EE11969170.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11969170.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11969170.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11970510 := __EE11970508;
  EXPORT Res0 := __UNWRAP(__EE11970510);
  SHARED __EE11970513 := __ENH_Business_Prox;
  SHARED __EE11970782 := __EE11970513(__T(__AND(__OP2(__EE11970513.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11970513.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11970513.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11970513.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11970784 := __EE11970782;
  EXPORT Res1 := __UNWRAP(__EE11970784);
  SHARED __EE4770729 := __E_Phone;
  SHARED __EE11970861 := __EE4770729(__T(__OP2(__EE4770729.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11970863 := __EE11970861;
  EXPORT Res2 := __UNWRAP(__EE11970863);
  SHARED __EE11970866 := __ENH_Address;
  SHARED __EE11971052 := __EE11970866(__T(__AND(__OP2(__EE11970866.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11970866.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11970866.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11970866.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11970866.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11970866.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11970866.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11971054 := __EE11971052;
  EXPORT Res3 := __UNWRAP(__EE11971054);
  SHARED __EE11971057 := __ENH_Property;
  SHARED __EE11971145 := __EE11971057(__T(__AND(__OP2(__EE11971057.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11971057.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11971057.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11971057.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11971057.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11971057.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11971057.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11971145);
