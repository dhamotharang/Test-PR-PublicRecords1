...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11837909 := __ENH_Business_Sele;
  SHARED __EE11839247 := __EE11837909(__T(__AND(__OP2(__EE11837909.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11837909.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11837909.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11839249 := __EE11839247;
  EXPORT Res0 := __UNWRAP(__EE11839249);
  SHARED __EE11839252 := __ENH_Business_Prox;
  SHARED __EE11839521 := __EE11839252(__T(__AND(__OP2(__EE11839252.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11839252.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11839252.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11839252.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11839523 := __EE11839521;
  EXPORT Res1 := __UNWRAP(__EE11839523);
  SHARED __EE5038718 := __E_Phone;
  SHARED __EE11839602 := __EE5038718(__T(__OP2(__EE5038718.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11839604 := __EE11839602;
  EXPORT Res2 := __UNWRAP(__EE11839604);
  SHARED __EE11839607 := __ENH_Address;
  SHARED __EE11839793 := __EE11839607(__T(__AND(__OP2(__EE11839607.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11839607.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11839607.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11839607.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11839607.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11839607.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11839607.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11839795 := __EE11839793;
  EXPORT Res3 := __UNWRAP(__EE11839795);
  SHARED __EE11839798 := __ENH_Property;
  SHARED __EE11839886 := __EE11839798(__T(__AND(__OP2(__EE11839798.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11839798.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11839798.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11839798.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11839798.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11839798.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11839798.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11839886);
