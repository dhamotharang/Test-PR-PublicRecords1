...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12214122 := __ENH_Business_Sele;
  SHARED __EE12215460 := __EE12214122(__T(__AND(__OP2(__EE12214122.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12214122.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12214122.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12215462 := __EE12215460;
  EXPORT Res0 := __UNWRAP(__EE12215462);
  SHARED __EE12215465 := __ENH_Business_Prox;
  SHARED __EE12215734 := __EE12215465(__T(__AND(__OP2(__EE12215465.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12215465.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12215465.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12215465.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12215736 := __EE12215734;
  EXPORT Res1 := __UNWRAP(__EE12215736);
  SHARED __EE5459362 := __E_Phone;
  SHARED __EE12215815 := __EE5459362(__T(__OP2(__EE5459362.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12215817 := __EE12215815;
  EXPORT Res2 := __UNWRAP(__EE12215817);
  SHARED __EE12215820 := __ENH_Address;
  SHARED __EE12216006 := __EE12215820(__T(__AND(__OP2(__EE12215820.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12215820.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12215820.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12215820.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12215820.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12215820.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12215820.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12216008 := __EE12216006;
  EXPORT Res3 := __UNWRAP(__EE12216008);
  SHARED __EE12216011 := __ENH_Property;
  SHARED __EE12216099 := __EE12216011(__T(__AND(__OP2(__EE12216011.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12216011.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12216011.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12216011.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12216011.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12216011.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12216011.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12216099);
