...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11837939 := __ENH_Business_Sele;
  SHARED __EE11839277 := __EE11837939(__T(__AND(__OP2(__EE11837939.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11837939.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11837939.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11839279 := __EE11839277;
  EXPORT Res0 := __UNWRAP(__EE11839279);
  SHARED __EE11839282 := __ENH_Business_Prox;
  SHARED __EE11839551 := __EE11839282(__T(__AND(__OP2(__EE11839282.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11839282.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11839282.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11839282.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11839553 := __EE11839551;
  EXPORT Res1 := __UNWRAP(__EE11839553);
  SHARED __EE5038748 := __E_Phone;
  SHARED __EE11839632 := __EE5038748(__T(__OP2(__EE5038748.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11839634 := __EE11839632;
  EXPORT Res2 := __UNWRAP(__EE11839634);
  SHARED __EE11839637 := __ENH_Address;
  SHARED __EE11839823 := __EE11839637(__T(__AND(__OP2(__EE11839637.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11839637.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11839637.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11839637.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11839637.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11839637.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11839637.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11839825 := __EE11839823;
  EXPORT Res3 := __UNWRAP(__EE11839825);
  SHARED __EE11839828 := __ENH_Property;
  SHARED __EE11839916 := __EE11839828(__T(__AND(__OP2(__EE11839828.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11839828.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11839828.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11839828.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11839828.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11839828.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11839828.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11839916);
