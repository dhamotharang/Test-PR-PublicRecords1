...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE14251679 := __ENH_Business_Sele;
  SHARED __EE14253017 := __EE14251679(__T(__AND(__OP2(__EE14251679.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE14251679.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE14251679.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE14253019 := __EE14253017;
  EXPORT Res0 := __UNWRAP(__EE14253019);
  SHARED __EE14253022 := __ENH_Business_Prox;
  SHARED __EE14253291 := __EE14253022(__T(__AND(__OP2(__EE14253022.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE14253022.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE14253022.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE14253022.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE14253293 := __EE14253291;
  EXPORT Res1 := __UNWRAP(__EE14253293);
  SHARED __EE6467233 := __E_Phone;
  SHARED __EE14253372 := __EE6467233(__T(__OP2(__EE6467233.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE14253374 := __EE14253372;
  EXPORT Res2 := __UNWRAP(__EE14253374);
  SHARED __EE14253377 := __ENH_Address;
  SHARED __EE14253563 := __EE14253377(__T(__AND(__OP2(__EE14253377.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE14253377.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE14253377.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE14253377.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE14253377.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE14253377.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE14253377.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE14253565 := __EE14253563;
  EXPORT Res3 := __UNWRAP(__EE14253565);
  SHARED __EE14253568 := __ENH_Property;
  SHARED __EE14253656 := __EE14253568(__T(__AND(__OP2(__EE14253568.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE14253568.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE14253568.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE14253568.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE14253568.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE14253568.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE14253568.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE14253656);
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_14,NAMED('DBG_E_Lien_Judgment_Intermediate_14_Q_Temporary_Index_Builds')),
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Lien_Judgment_Intermediate_13_Q_Temporary_Index_Builds')),
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_13_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Person_Intermediate_12,NAMED('DBG_E_Person_Intermediate_12_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Bankruptcy_Intermediate_9,NAMED('DBG_E_Bankruptcy_Intermediate_9_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_8,NAMED('DBG_E_Criminal_Offense_Intermediate_8_Q_Temporary_Index_Builds')),
    OUTPUT(DBG_E_Education_Intermediate_8,NAMED('DBG_E_Education_Intermediate_8_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_7,NAMED('DBG_E_Criminal_Offense_Intermediate_7_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_7,NAMED('DBG_E_Person_S_S_N_Intermediate_7_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_6,NAMED('DBG_E_Criminal_Offense_Intermediate_6_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_5,NAMED('DBG_E_Address_Property_Intermediate_5_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_4,NAMED('DBG_E_Address_Property_Intermediate_4_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_3,NAMED('DBG_E_Address_Property_Intermediate_3_Q_Temporary_Index_Builds')),
    ...
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Temporary_Index_Builds')),
