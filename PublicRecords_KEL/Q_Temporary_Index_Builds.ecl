...
IMPORT KEL11 AS KEL;
IMPORT B_Bankruptcy_1,B_Bankruptcy_2,B_Bankruptcy_3,B_Bankruptcy_4,B_Bankruptcy_5,B_Bankruptcy_6,B_Bankruptcy_7,B_Business_Sele,B_Business_Sele_1,B_Business_Sele_2,B_Business_Sele_3,B_Business_Sele_4,B_Business_Sele_5,B_Business_Sele_6,B_Phone,B_Sele_Aircraft_1,B_Sele_Bankruptcy_1,B_Sele_Tradeline_1,B_Sele_Tradeline_2,B_Sele_Tradeline_3,B_Sele_Vehicle_1,B_Sele_Vehicle_2,B_Sele_Vehicle_3,B_Sele_Vehicle_4,B_Sele_Watercraft_1,B_Tradeline_1,B_Tradeline_10,B_Tradeline_11,B_Tradeline_2,B_Tradeline_3,B_Tradeline_4,B_Tradeline_5,B_Tradeline_6,B_Tradeline_7,B_Tradeline_8,B_Tradeline_9,CFG_Compile,E_Address,E_Bankruptcy,E_Business_Org,E_Business_Prox,E_Business_Sele,E_Business_Ult,E_Phone,E_Sele_Aircraft,E_Sele_Bankruptcy,E_Sele_Tradeline,E_Sele_Vehicle,E_Sele_Watercraft,E_Tradeline,E_Vehicle,E_Zip_Code FROM PublicRecords_KEL;
...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.str __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1861897 := __ENH_Business_Sele;
  SHARED __EE1861918 := __EE1861897(__T(__AND(__OP2(__EE1861897.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE1861897.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE1861897.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE1861920 := __EE1861918;
  EXPORT Res0 := __UNWRAP(__EE1861920);
  SHARED __EE1862516 := __E_Business_Prox;
  SHARED __EE1862541 := __EE1862516(__T(__AND(__OP2(__EE1862516.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE1862516.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE1862516.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE1862516.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE1862543 := __EE1862541;
  EXPORT Res1 := __UNWRAP(__EE1862543);
  SHARED __EE1862566 := __ENH_Phone;
  SHARED __EE1862578 := __EE1862566(__T(__OP2(__EE1862566.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE1862580 := __EE1862578;
  EXPORT Res2 := __UNWRAP(__EE1862580);
  SHARED __EE1862620 := __E_Address;
  SHARED __EE1862657 := __EE1862620(__T(__AND(__OP2(__EE1862620.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE1862620.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE1862620.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE1862620.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE1862620.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__CAST(KEL.typ.str,__EE1862620.Z_I_P5_),=,__CN(__PZIP5_in)),__OP2(__EE1862620.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res3 := __UNWRAP(__EE1862657);
END;
