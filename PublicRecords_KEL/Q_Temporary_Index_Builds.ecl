...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11964727 := __ENH_Business_Sele;
  SHARED __EE11966065 := __EE11964727(__T(__AND(__OP2(__EE11964727.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11964727.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11964727.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11966067 := __EE11966065;
  EXPORT Res0 := __UNWRAP(__EE11966067);
  SHARED __EE11966070 := __ENH_Business_Prox;
  SHARED __EE11966339 := __EE11966070(__T(__AND(__OP2(__EE11966070.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11966070.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11966070.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11966070.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11966341 := __EE11966339;
  EXPORT Res1 := __UNWRAP(__EE11966341);
  SHARED __EE4770329 := __E_Phone;
  SHARED __EE11966418 := __EE4770329(__T(__OP2(__EE4770329.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11966420 := __EE11966418;
  EXPORT Res2 := __UNWRAP(__EE11966420);
  SHARED __EE11966423 := __ENH_Address;
  SHARED __EE11966609 := __EE11966423(__T(__AND(__OP2(__EE11966423.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11966423.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11966423.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11966423.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11966423.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11966423.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11966423.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11966611 := __EE11966609;
  EXPORT Res3 := __UNWRAP(__EE11966611);
  SHARED __EE11966614 := __ENH_Property;
  SHARED __EE11966702 := __EE11966614(__T(__AND(__OP2(__EE11966614.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11966614.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11966614.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11966614.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11966614.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11966614.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11966614.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11966702);
