...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12548549 := __ENH_Business_Sele;
  SHARED __EE12549887 := __EE12548549(__T(__AND(__OP2(__EE12548549.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12548549.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12548549.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12549889 := __EE12549887;
  EXPORT Res0 := __UNWRAP(__EE12549889);
  SHARED __EE12549892 := __ENH_Business_Prox;
  SHARED __EE12550161 := __EE12549892(__T(__AND(__OP2(__EE12549892.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12549892.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12549892.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12549892.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12550163 := __EE12550161;
  EXPORT Res1 := __UNWRAP(__EE12550163);
  SHARED __EE5408304 := __E_Phone;
  SHARED __EE12550242 := __EE5408304(__T(__OP2(__EE5408304.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12550244 := __EE12550242;
  EXPORT Res2 := __UNWRAP(__EE12550244);
  SHARED __EE12550247 := __ENH_Address;
  SHARED __EE12550433 := __EE12550247(__T(__AND(__OP2(__EE12550247.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12550247.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12550247.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12550247.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12550247.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12550247.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12550247.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12550435 := __EE12550433;
  EXPORT Res3 := __UNWRAP(__EE12550435);
  SHARED __EE12550438 := __ENH_Property;
  SHARED __EE12550526 := __EE12550438(__T(__AND(__OP2(__EE12550438.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12550438.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12550438.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12550438.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12550438.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12550438.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12550438.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12550526);
