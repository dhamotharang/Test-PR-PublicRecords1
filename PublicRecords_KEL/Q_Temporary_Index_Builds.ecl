...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.str __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, UNSIGNED8 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE1859341 := __ENH_Business_Sele;
  SHARED __EE1859362 := __EE1859341(__T(__AND(__OP2(__EE1859341.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE1859341.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE1859341.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE1859364 := __EE1859362;
  EXPORT Res0 := __UNWRAP(__EE1859364);
  SHARED __EE1859960 := __E_Business_Prox;
  SHARED __EE1859985 := __EE1859960(__T(__AND(__OP2(__EE1859960.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE1859960.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE1859960.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE1859960.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE1859987 := __EE1859985;
  EXPORT Res1 := __UNWRAP(__EE1859987);
  SHARED __EE1860010 := __ENH_Phone;
  SHARED __EE1860022 := __EE1860010(__T(__OP2(__EE1860010.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE1860024 := __EE1860022;
  EXPORT Res2 := __UNWRAP(__EE1860024);
  SHARED __EE1860064 := __E_Address;
  SHARED __EE1860101 := __EE1860064(__T(__AND(__OP2(__EE1860064.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE1860064.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE1860064.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE1860064.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE1860064.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__CAST(KEL.typ.str,__EE1860064.Z_I_P5_),=,__CN(__PZIP5_in)),__OP2(__EE1860064.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res3 := __UNWRAP(__EE1860101);
END;
