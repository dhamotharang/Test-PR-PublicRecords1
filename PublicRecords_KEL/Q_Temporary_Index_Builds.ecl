...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11956944 := __ENH_Business_Sele;
  SHARED __EE11958282 := __EE11956944(__T(__AND(__OP2(__EE11956944.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11956944.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11956944.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11958284 := __EE11958282;
  EXPORT Res0 := __UNWRAP(__EE11958284);
  SHARED __EE11958287 := __ENH_Business_Prox;
  SHARED __EE11958556 := __EE11958287(__T(__AND(__OP2(__EE11958287.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11958287.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11958287.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11958287.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11958558 := __EE11958556;
  EXPORT Res1 := __UNWRAP(__EE11958558);
  SHARED __EE5198591 := __E_Phone;
  SHARED __EE11958635 := __EE5198591(__T(__OP2(__EE5198591.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11958637 := __EE11958635;
  EXPORT Res2 := __UNWRAP(__EE11958637);
  SHARED __EE11958640 := __ENH_Address;
  SHARED __EE11958826 := __EE11958640(__T(__AND(__OP2(__EE11958640.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11958640.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11958640.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11958640.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11958640.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11958640.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11958640.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11958828 := __EE11958826;
  EXPORT Res3 := __UNWRAP(__EE11958828);
  SHARED __EE11958831 := __ENH_Property;
  SHARED __EE11958919 := __EE11958831(__T(__AND(__OP2(__EE11958831.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11958831.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11958831.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11958831.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11958831.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11958831.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11958831.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11958919);
