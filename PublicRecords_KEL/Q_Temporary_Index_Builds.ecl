...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE10022833 := __ENH_Business_Sele;
  SHARED __EE10024171 := __EE10022833(__T(__AND(__OP2(__EE10022833.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE10022833.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE10022833.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE10024173 := __EE10024171;
  EXPORT Res0 := __UNWRAP(__EE10024173);
  SHARED __EE10024176 := __ENH_Business_Prox;
  SHARED __EE10024445 := __EE10024176(__T(__AND(__OP2(__EE10024176.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE10024176.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE10024176.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE10024176.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE10024447 := __EE10024445;
  EXPORT Res1 := __UNWRAP(__EE10024447);
  SHARED __EE4613883 := __E_Phone;
  SHARED __EE10024526 := __EE4613883(__T(__OP2(__EE4613883.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE10024528 := __EE10024526;
  EXPORT Res2 := __UNWRAP(__EE10024528);
  SHARED __EE10024531 := __ENH_Address;
  SHARED __EE10024717 := __EE10024531(__T(__AND(__OP2(__EE10024531.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE10024531.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE10024531.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE10024531.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE10024531.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE10024531.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE10024531.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE10024719 := __EE10024717;
  EXPORT Res3 := __UNWRAP(__EE10024719);
  SHARED __EE10024722 := __ENH_Property;
  SHARED __EE10024810 := __EE10024722(__T(__AND(__OP2(__EE10024722.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE10024722.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE10024722.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE10024722.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE10024722.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE10024722.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE10024722.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE10024810);
