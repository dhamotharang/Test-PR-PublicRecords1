...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12393903 := __ENH_Business_Sele;
  SHARED __EE12395241 := __EE12393903(__T(__AND(__OP2(__EE12393903.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12393903.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12393903.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12395243 := __EE12395241;
  EXPORT Res0 := __UNWRAP(__EE12395243);
  SHARED __EE12395246 := __ENH_Business_Prox;
  SHARED __EE12395515 := __EE12395246(__T(__AND(__OP2(__EE12395246.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12395246.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12395246.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12395246.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12395517 := __EE12395515;
  EXPORT Res1 := __UNWRAP(__EE12395517);
  SHARED __EE5586058 := __E_Phone;
  SHARED __EE12395596 := __EE5586058(__T(__OP2(__EE5586058.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12395598 := __EE12395596;
  EXPORT Res2 := __UNWRAP(__EE12395598);
  SHARED __EE12395601 := __ENH_Address;
  SHARED __EE12395787 := __EE12395601(__T(__AND(__OP2(__EE12395601.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12395601.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12395601.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12395601.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12395601.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12395601.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12395601.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12395789 := __EE12395787;
  EXPORT Res3 := __UNWRAP(__EE12395789);
  SHARED __EE12395792 := __ENH_Property;
  SHARED __EE12395880 := __EE12395792(__T(__AND(__OP2(__EE12395792.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12395792.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12395792.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12395792.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12395792.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12395792.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12395792.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12395880);
