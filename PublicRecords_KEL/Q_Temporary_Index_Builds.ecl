...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE15525775 := __ENH_Business_Sele;
  SHARED __EE15527113 := __EE15525775(__T(__AND(__OP2(__EE15525775.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE15525775.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE15525775.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE15527115 := __EE15527113;
  EXPORT Res0 := __UNWRAP(__EE15527115);
  SHARED __EE15527118 := __ENH_Business_Prox;
  SHARED __EE15527387 := __EE15527118(__T(__AND(__OP2(__EE15527118.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE15527118.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE15527118.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE15527118.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE15527389 := __EE15527387;
  EXPORT Res1 := __UNWRAP(__EE15527389);
  SHARED __EE5542258 := __E_Phone;
  SHARED __EE15527468 := __EE5542258(__T(__OP2(__EE5542258.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE15527470 := __EE15527468;
  EXPORT Res2 := __UNWRAP(__EE15527470);
  SHARED __EE15527473 := __ENH_Address;
  SHARED __EE15527659 := __EE15527473(__T(__AND(__OP2(__EE15527473.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE15527473.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE15527473.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE15527473.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE15527473.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE15527473.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE15527473.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE15527661 := __EE15527659;
  EXPORT Res3 := __UNWRAP(__EE15527661);
  SHARED __EE15527664 := __ENH_Property;
  SHARED __EE15527752 := __EE15527664(__T(__AND(__OP2(__EE15527664.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE15527664.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE15527664.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE15527664.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE15527664.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE15527664.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE15527664.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE15527752);
