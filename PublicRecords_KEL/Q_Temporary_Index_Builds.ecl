...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE6362910 := __ENH_Business_Sele;
  SHARED __EE6362937 := __EE6362910(__T(__AND(__OP2(__EE6362910.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE6362910.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE6362910.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE6362939 := __EE6362937;
  EXPORT Res0 := __UNWRAP(__EE6362939);
  SHARED __EE6362942 := __ENH_Business_Prox;
  SHARED __EE6362976 := __EE6362942(__T(__AND(__OP2(__EE6362942.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE6362942.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE6362942.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE6362942.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE6362978 := __EE6362976;
  EXPORT Res1 := __UNWRAP(__EE6362978);
  SHARED __EE3497416 := __E_Phone;
  SHARED __EE6362983 := __EE3497416(__T(__OP2(__EE3497416.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE6362985 := __EE6362983;
  EXPORT Res2 := __UNWRAP(__EE6362985);
  SHARED __EE6362988 := __ENH_Address;
  SHARED __EE6363043 := __EE6362988(__T(__AND(__OP2(__EE6362988.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE6362988.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE6362988.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE6362988.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE6362988.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE6362988.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE6362988.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE6363045 := __EE6363043;
  EXPORT Res3 := __UNWRAP(__EE6363045);
  SHARED __EE6363048 := __ENH_Property;
  SHARED __EE6363103 := __EE6363048(__T(__AND(__OP2(__EE6363048.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE6363048.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE6363048.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE6363048.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE6363048.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE6363048.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE6363048.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE6363103);
END;
