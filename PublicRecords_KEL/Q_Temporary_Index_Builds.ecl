...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11823086 := __ENH_Business_Sele;
  SHARED __EE11824424 := __EE11823086(__T(__AND(__OP2(__EE11823086.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11823086.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11823086.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11824426 := __EE11824424;
  EXPORT Res0 := __UNWRAP(__EE11824426);
  SHARED __EE11824429 := __ENH_Business_Prox;
  SHARED __EE11824698 := __EE11824429(__T(__AND(__OP2(__EE11824429.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11824429.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11824429.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11824429.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11824700 := __EE11824698;
  EXPORT Res1 := __UNWRAP(__EE11824700);
  SHARED __EE5031391 := __E_Phone;
  SHARED __EE11824779 := __EE5031391(__T(__OP2(__EE5031391.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11824781 := __EE11824779;
  EXPORT Res2 := __UNWRAP(__EE11824781);
  SHARED __EE11824784 := __ENH_Address;
  SHARED __EE11824970 := __EE11824784(__T(__AND(__OP2(__EE11824784.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11824784.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11824784.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11824784.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11824784.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11824784.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11824784.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11824972 := __EE11824970;
  EXPORT Res3 := __UNWRAP(__EE11824972);
  SHARED __EE11824975 := __ENH_Property;
  SHARED __EE11825063 := __EE11824975(__T(__AND(__OP2(__EE11824975.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11824975.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11824975.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11824975.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11824975.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11824975.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11824975.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11825063);
