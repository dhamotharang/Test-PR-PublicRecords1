...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12141105 := __ENH_Business_Sele;
  SHARED __EE12142443 := __EE12141105(__T(__AND(__OP2(__EE12141105.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12141105.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12141105.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12142445 := __EE12142443;
  EXPORT Res0 := __UNWRAP(__EE12142445);
  SHARED __EE12142448 := __ENH_Business_Prox;
  SHARED __EE12142717 := __EE12142448(__T(__AND(__OP2(__EE12142448.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12142448.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12142448.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12142448.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12142719 := __EE12142717;
  EXPORT Res1 := __UNWRAP(__EE12142719);
  SHARED __EE5379874 := __E_Phone;
  SHARED __EE12142798 := __EE5379874(__T(__OP2(__EE5379874.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12142800 := __EE12142798;
  EXPORT Res2 := __UNWRAP(__EE12142800);
  SHARED __EE12142803 := __ENH_Address;
  SHARED __EE12142989 := __EE12142803(__T(__AND(__OP2(__EE12142803.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12142803.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12142803.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12142803.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12142803.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12142803.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12142803.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12142991 := __EE12142989;
  EXPORT Res3 := __UNWRAP(__EE12142991);
  SHARED __EE12142994 := __ENH_Property;
  SHARED __EE12143082 := __EE12142994(__T(__AND(__OP2(__EE12142994.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12142994.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12142994.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12142994.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12142994.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12142994.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12142994.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12143082);
