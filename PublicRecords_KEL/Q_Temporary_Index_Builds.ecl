...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12484277 := __ENH_Business_Sele;
  SHARED __EE12485615 := __EE12484277(__T(__AND(__OP2(__EE12484277.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12484277.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12484277.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12485617 := __EE12485615;
  EXPORT Res0 := __UNWRAP(__EE12485617);
  SHARED __EE12485620 := __ENH_Business_Prox;
  SHARED __EE12485889 := __EE12485620(__T(__AND(__OP2(__EE12485620.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12485620.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12485620.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12485620.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12485891 := __EE12485889;
  EXPORT Res1 := __UNWRAP(__EE12485891);
  SHARED __EE4888005 := __E_Phone;
  SHARED __EE12485968 := __EE4888005(__T(__OP2(__EE4888005.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12485970 := __EE12485968;
  EXPORT Res2 := __UNWRAP(__EE12485970);
  SHARED __EE12485973 := __ENH_Address;
  SHARED __EE12486159 := __EE12485973(__T(__AND(__OP2(__EE12485973.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12485973.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12485973.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12485973.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12485973.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12485973.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12485973.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12486161 := __EE12486159;
  EXPORT Res3 := __UNWRAP(__EE12486161);
  SHARED __EE12486164 := __ENH_Property;
  SHARED __EE12486252 := __EE12486164(__T(__AND(__OP2(__EE12486164.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12486164.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12486164.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12486164.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12486164.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12486164.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12486164.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12486252);
