...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12620257 := __ENH_Business_Sele;
  SHARED __EE12621595 := __EE12620257(__T(__AND(__OP2(__EE12620257.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12620257.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12620257.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12621597 := __EE12621595;
  EXPORT Res0 := __UNWRAP(__EE12621597);
  SHARED __EE12621600 := __ENH_Business_Prox;
  SHARED __EE12621869 := __EE12621600(__T(__AND(__OP2(__EE12621600.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12621600.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12621600.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12621600.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12621871 := __EE12621869;
  EXPORT Res1 := __UNWRAP(__EE12621871);
  SHARED __EE5510451 := __E_Phone;
  SHARED __EE12621950 := __EE5510451(__T(__OP2(__EE5510451.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12621952 := __EE12621950;
  EXPORT Res2 := __UNWRAP(__EE12621952);
  SHARED __EE12621955 := __ENH_Address;
  SHARED __EE12622141 := __EE12621955(__T(__AND(__OP2(__EE12621955.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12621955.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12621955.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12621955.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12621955.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12621955.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12621955.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12622143 := __EE12622141;
  EXPORT Res3 := __UNWRAP(__EE12622143);
  SHARED __EE12622146 := __ENH_Property;
  SHARED __EE12622234 := __EE12622146(__T(__AND(__OP2(__EE12622146.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12622146.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12622146.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12622146.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12622146.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12622146.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12622146.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12622234);
