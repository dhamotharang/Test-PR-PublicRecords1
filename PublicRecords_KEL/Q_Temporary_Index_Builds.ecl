...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12184728 := __ENH_Business_Sele;
  SHARED __EE12186066 := __EE12184728(__T(__AND(__OP2(__EE12184728.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12184728.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12184728.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12186068 := __EE12186066;
  EXPORT Res0 := __UNWRAP(__EE12186068);
  SHARED __EE12186071 := __ENH_Business_Prox;
  SHARED __EE12186340 := __EE12186071(__T(__AND(__OP2(__EE12186071.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12186071.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12186071.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12186071.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12186342 := __EE12186340;
  EXPORT Res1 := __UNWRAP(__EE12186342);
  SHARED __EE5438995 := __E_Phone;
  SHARED __EE12186421 := __EE5438995(__T(__OP2(__EE5438995.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12186423 := __EE12186421;
  EXPORT Res2 := __UNWRAP(__EE12186423);
  SHARED __EE12186426 := __ENH_Address;
  SHARED __EE12186612 := __EE12186426(__T(__AND(__OP2(__EE12186426.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12186426.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12186426.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12186426.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12186426.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12186426.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12186426.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12186614 := __EE12186612;
  EXPORT Res3 := __UNWRAP(__EE12186614);
  SHARED __EE12186617 := __ENH_Property;
  SHARED __EE12186705 := __EE12186617(__T(__AND(__OP2(__EE12186617.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12186617.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12186617.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12186617.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12186617.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12186617.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12186617.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12186705);
