...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE13494787 := __ENH_Business_Sele;
  SHARED __EE13496125 := __EE13494787(__T(__AND(__OP2(__EE13494787.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE13494787.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE13494787.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE13496127 := __EE13496125;
  EXPORT Res0 := __UNWRAP(__EE13496127);
  SHARED __EE13496130 := __ENH_Business_Prox;
  SHARED __EE13496399 := __EE13496130(__T(__AND(__OP2(__EE13496130.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE13496130.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE13496130.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE13496130.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE13496401 := __EE13496399;
  EXPORT Res1 := __UNWRAP(__EE13496401);
  SHARED __EE6104872 := __E_Phone;
  SHARED __EE13496480 := __EE6104872(__T(__OP2(__EE6104872.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE13496482 := __EE13496480;
  EXPORT Res2 := __UNWRAP(__EE13496482);
  SHARED __EE13496485 := __ENH_Address;
  SHARED __EE13496671 := __EE13496485(__T(__AND(__OP2(__EE13496485.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE13496485.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE13496485.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE13496485.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE13496485.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE13496485.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE13496485.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE13496673 := __EE13496671;
  EXPORT Res3 := __UNWRAP(__EE13496673);
  SHARED __EE13496676 := __ENH_Property;
  SHARED __EE13496764 := __EE13496676(__T(__AND(__OP2(__EE13496676.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE13496676.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE13496676.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE13496676.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE13496676.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE13496676.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE13496676.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE13496764);
