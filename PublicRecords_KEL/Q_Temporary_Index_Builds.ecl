...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12625906 := __ENH_Business_Sele;
  SHARED __EE12627244 := __EE12625906(__T(__AND(__OP2(__EE12625906.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12625906.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12625906.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12627246 := __EE12627244;
  EXPORT Res0 := __UNWRAP(__EE12627246);
  SHARED __EE12627249 := __ENH_Business_Prox;
  SHARED __EE12627518 := __EE12627249(__T(__AND(__OP2(__EE12627249.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12627249.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12627249.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12627249.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12627520 := __EE12627518;
  EXPORT Res1 := __UNWRAP(__EE12627520);
  SHARED __EE5513159 := __E_Phone;
  SHARED __EE12627599 := __EE5513159(__T(__OP2(__EE5513159.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12627601 := __EE12627599;
  EXPORT Res2 := __UNWRAP(__EE12627601);
  SHARED __EE12627604 := __ENH_Address;
  SHARED __EE12627790 := __EE12627604(__T(__AND(__OP2(__EE12627604.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12627604.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12627604.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12627604.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12627604.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12627604.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12627604.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12627792 := __EE12627790;
  EXPORT Res3 := __UNWRAP(__EE12627792);
  SHARED __EE12627795 := __ENH_Property;
  SHARED __EE12627883 := __EE12627795(__T(__AND(__OP2(__EE12627795.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12627795.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12627795.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12627795.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12627795.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12627795.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12627795.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12627883);
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Input_P_I_I_Intermediate_10,NAMED('DBG_E_Input_P_I_I_Intermediate_10_Q_Temporary_Index_Builds')),
