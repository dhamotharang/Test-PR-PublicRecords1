...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12455765 := __ENH_Business_Sele;
  SHARED __EE12457103 := __EE12455765(__T(__AND(__OP2(__EE12455765.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12455765.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12455765.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12457105 := __EE12457103;
  EXPORT Res0 := __UNWRAP(__EE12457105);
  SHARED __EE12457108 := __ENH_Business_Prox;
  SHARED __EE12457377 := __EE12457108(__T(__AND(__OP2(__EE12457108.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12457108.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12457108.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12457108.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12457379 := __EE12457377;
  EXPORT Res1 := __UNWRAP(__EE12457379);
  SHARED __EE5452714 := __E_Phone;
  SHARED __EE12457458 := __EE5452714(__T(__OP2(__EE5452714.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12457460 := __EE12457458;
  EXPORT Res2 := __UNWRAP(__EE12457460);
  SHARED __EE12457463 := __ENH_Address;
  SHARED __EE12457649 := __EE12457463(__T(__AND(__OP2(__EE12457463.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12457463.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12457463.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12457463.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12457463.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12457463.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12457463.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12457651 := __EE12457649;
  EXPORT Res3 := __UNWRAP(__EE12457651);
  SHARED __EE12457654 := __ENH_Property;
  SHARED __EE12457742 := __EE12457654(__T(__AND(__OP2(__EE12457654.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12457654.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12457654.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12457654.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12457654.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12457654.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12457654.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12457742);
