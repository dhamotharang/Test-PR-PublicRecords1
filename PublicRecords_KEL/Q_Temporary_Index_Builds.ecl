...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11974939 := __ENH_Business_Sele;
  SHARED __EE11976277 := __EE11974939(__T(__AND(__OP2(__EE11974939.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11974939.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11974939.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11976279 := __EE11976277;
  EXPORT Res0 := __UNWRAP(__EE11976279);
  SHARED __EE11976282 := __ENH_Business_Prox;
  SHARED __EE11976551 := __EE11976282(__T(__AND(__OP2(__EE11976282.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11976282.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11976282.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11976282.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11976553 := __EE11976551;
  EXPORT Res1 := __UNWRAP(__EE11976553);
  SHARED __EE4773295 := __E_Phone;
  SHARED __EE11976630 := __EE4773295(__T(__OP2(__EE4773295.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11976632 := __EE11976630;
  EXPORT Res2 := __UNWRAP(__EE11976632);
  SHARED __EE11976635 := __ENH_Address;
  SHARED __EE11976821 := __EE11976635(__T(__AND(__OP2(__EE11976635.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11976635.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11976635.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11976635.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11976635.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11976635.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11976635.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11976823 := __EE11976821;
  EXPORT Res3 := __UNWRAP(__EE11976823);
  SHARED __EE11976826 := __ENH_Property;
  SHARED __EE11976914 := __EE11976826(__T(__AND(__OP2(__EE11976826.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11976826.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11976826.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11976826.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11976826.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11976826.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11976826.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11976914);
