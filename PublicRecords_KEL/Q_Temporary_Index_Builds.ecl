...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11974944 := __ENH_Business_Sele;
  SHARED __EE11976282 := __EE11974944(__T(__AND(__OP2(__EE11974944.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11974944.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11974944.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11976284 := __EE11976282;
  EXPORT Res0 := __UNWRAP(__EE11976284);
  SHARED __EE11976287 := __ENH_Business_Prox;
  SHARED __EE11976556 := __EE11976287(__T(__AND(__OP2(__EE11976287.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11976287.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11976287.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11976287.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11976558 := __EE11976556;
  EXPORT Res1 := __UNWRAP(__EE11976558);
  SHARED __EE4773300 := __E_Phone;
  SHARED __EE11976635 := __EE4773300(__T(__OP2(__EE4773300.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11976637 := __EE11976635;
  EXPORT Res2 := __UNWRAP(__EE11976637);
  SHARED __EE11976640 := __ENH_Address;
  SHARED __EE11976826 := __EE11976640(__T(__AND(__OP2(__EE11976640.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11976640.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11976640.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11976640.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11976640.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11976640.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11976640.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11976828 := __EE11976826;
  EXPORT Res3 := __UNWRAP(__EE11976828);
  SHARED __EE11976831 := __ENH_Property;
  SHARED __EE11976919 := __EE11976831(__T(__AND(__OP2(__EE11976831.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11976831.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11976831.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11976831.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11976831.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11976831.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11976831.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11976919);
