...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11993258 := __ENH_Business_Sele;
  SHARED __EE11994596 := __EE11993258(__T(__AND(__OP2(__EE11993258.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11993258.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11993258.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11994598 := __EE11994596;
  EXPORT Res0 := __UNWRAP(__EE11994598);
  SHARED __EE11994601 := __ENH_Business_Prox;
  SHARED __EE11994870 := __EE11994601(__T(__AND(__OP2(__EE11994601.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11994601.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11994601.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11994601.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11994872 := __EE11994870;
  EXPORT Res1 := __UNWRAP(__EE11994872);
  SHARED __EE5225542 := __E_Phone;
  SHARED __EE11994949 := __EE5225542(__T(__OP2(__EE5225542.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11994951 := __EE11994949;
  EXPORT Res2 := __UNWRAP(__EE11994951);
  SHARED __EE11994954 := __ENH_Address;
  SHARED __EE11995140 := __EE11994954(__T(__AND(__OP2(__EE11994954.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11994954.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11994954.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11994954.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11994954.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11994954.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11994954.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11995142 := __EE11995140;
  EXPORT Res3 := __UNWRAP(__EE11995142);
  SHARED __EE11995145 := __ENH_Property;
  SHARED __EE11995233 := __EE11995145(__T(__AND(__OP2(__EE11995145.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11995145.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11995145.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11995145.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11995145.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11995145.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11995145.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11995233);
