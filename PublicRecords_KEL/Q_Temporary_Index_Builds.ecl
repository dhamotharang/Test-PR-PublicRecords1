...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12324009 := __ENH_Business_Sele;
  SHARED __EE12325347 := __EE12324009(__T(__AND(__OP2(__EE12324009.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12324009.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12324009.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12325349 := __EE12325347;
  EXPORT Res0 := __UNWRAP(__EE12325349);
  SHARED __EE12325352 := __ENH_Business_Prox;
  SHARED __EE12325621 := __EE12325352(__T(__AND(__OP2(__EE12325352.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12325352.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12325352.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12325352.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12325623 := __EE12325621;
  EXPORT Res1 := __UNWRAP(__EE12325623);
  SHARED __EE5392623 := __E_Phone;
  SHARED __EE12325702 := __EE5392623(__T(__OP2(__EE5392623.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12325704 := __EE12325702;
  EXPORT Res2 := __UNWRAP(__EE12325704);
  SHARED __EE12325707 := __ENH_Address;
  SHARED __EE12325893 := __EE12325707(__T(__AND(__OP2(__EE12325707.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12325707.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12325707.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12325707.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12325707.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12325707.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12325707.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12325895 := __EE12325893;
  EXPORT Res3 := __UNWRAP(__EE12325895);
  SHARED __EE12325898 := __ENH_Property;
  SHARED __EE12325986 := __EE12325898(__T(__AND(__OP2(__EE12325898.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12325898.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12325898.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12325898.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12325898.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12325898.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12325898.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12325986);
