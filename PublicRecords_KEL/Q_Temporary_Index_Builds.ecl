...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE12142713 := __ENH_Business_Sele;
  SHARED __EE12144051 := __EE12142713(__T(__AND(__OP2(__EE12142713.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12142713.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12142713.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE12144053 := __EE12144051;
  EXPORT Res0 := __UNWRAP(__EE12144053);
  SHARED __EE12144056 := __ENH_Business_Prox;
  SHARED __EE12144325 := __EE12144056(__T(__AND(__OP2(__EE12144056.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12144056.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE12144056.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE12144056.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE12144327 := __EE12144325;
  EXPORT Res1 := __UNWRAP(__EE12144327);
  SHARED __EE5381460 := __E_Phone;
  SHARED __EE12144406 := __EE5381460(__T(__OP2(__EE5381460.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE12144408 := __EE12144406;
  EXPORT Res2 := __UNWRAP(__EE12144408);
  SHARED __EE12144411 := __ENH_Address;
  SHARED __EE12144597 := __EE12144411(__T(__AND(__OP2(__EE12144411.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12144411.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12144411.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12144411.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12144411.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12144411.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12144411.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE12144599 := __EE12144597;
  EXPORT Res3 := __UNWRAP(__EE12144599);
  SHARED __EE12144602 := __ENH_Property;
  SHARED __EE12144690 := __EE12144602(__T(__AND(__OP2(__EE12144602.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE12144602.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE12144602.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE12144602.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE12144602.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE12144602.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE12144602.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE12144690);
