...
EXPORT Q_Temporary_Index_Builds(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.int __PProxID_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PPredirectional_in, KEL.typ.str __PPrimaryName_in, KEL.typ.str __PAddrSuffix_in, KEL.typ.str __PPostdirectional_in, KEL.typ.uid __PZIP5_in, KEL.typ.str __PSecondaryRange_in, KEL.typ.str __PPhone_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED TYPEOF(E_Property(__in,__cfg_Local).__Result) __E_Property := E_Property_Filtered.__Result;
  SHARED __EE11747546 := __ENH_Business_Sele;
  SHARED __EE11748884 := __EE11747546(__T(__AND(__OP2(__EE11747546.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11747546.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE11747546.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __EE11748886 := __EE11748884;
  EXPORT Res0 := __UNWRAP(__EE11748886);
  SHARED __EE11748889 := __ENH_Business_Prox;
  SHARED __EE11749158 := __EE11748889(__T(__AND(__OP2(__EE11748889.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE11748889.Org_I_D_,=,__CN(__POrgID_in)),__AND(__OP2(__EE11748889.Sele_I_D_,=,__CN(__PSeleID_in)),__OP2(__EE11748889.Prox_I_D_,=,__CN(__PProxID_in)))))));
  SHARED __EE11749160 := __EE11749158;
  EXPORT Res1 := __UNWRAP(__EE11749160);
  SHARED __EE5007029 := __E_Phone;
  SHARED __EE11749239 := __EE5007029(__T(__OP2(__EE5007029.Phone10_,=,__CN(__PPhone_in))));
  SHARED __EE11749241 := __EE11749239;
  EXPORT Res2 := __UNWRAP(__EE11749241);
  SHARED __EE11749244 := __ENH_Address;
  SHARED __EE11749430 := __EE11749244(__T(__AND(__OP2(__EE11749244.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11749244.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11749244.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11749244.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11749244.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11749244.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11749244.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  SHARED __EE11749432 := __EE11749430;
  EXPORT Res3 := __UNWRAP(__EE11749432);
  SHARED __EE11749435 := __ENH_Property;
  SHARED __EE11749523 := __EE11749435(__T(__AND(__OP2(__EE11749435.Primary_Range_,=,__CN(__PPrimaryRange_in)),__AND(__OP2(__EE11749435.Predirectional_,=,__CN(__PPredirectional_in)),__AND(__OP2(__EE11749435.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE11749435.Suffix_,=,__CN(__PAddrSuffix_in)),__AND(__OP2(__EE11749435.Postdirectional_,=,__CN(__PPostdirectional_in)),__AND(__OP2(__EE11749435.Z_I_P5_,=,__CN(__PZIP5_in)),__OP2(__EE11749435.Secondary_Range_,=,__CN(__PSecondaryRange_in))))))))));
  EXPORT Res4 := __UNWRAP(__EE11749523);
