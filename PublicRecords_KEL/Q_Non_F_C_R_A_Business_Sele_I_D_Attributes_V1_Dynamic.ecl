...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputBII)) __PInputBIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE13777025 := __ENH_Business_Sele;
  SHARED __EE13780451 := __EE13777025(__T(__AND(__OP2(__EE13777025.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE13777025.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE13777025.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST134426_Layout := RECORD
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Education_Intermediate_8,NAMED('DBG_E_Education_Intermediate_8_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_S_S_N_Intermediate_7,NAMED('DBG_E_Person_S_S_N_Intermediate_7_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_5,NAMED('DBG_E_Address_Property_Intermediate_5_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_4,NAMED('DBG_E_Address_Property_Intermediate_4_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Address_Property_Intermediate_3,NAMED('DBG_E_Address_Property_Intermediate_3_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
