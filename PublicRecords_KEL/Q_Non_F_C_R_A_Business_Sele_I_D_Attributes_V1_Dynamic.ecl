...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputBII)) __PInputBIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE13045994 := __ENH_Business_Sele;
  SHARED __EE13049420 := __EE13045994(__T(__AND(__OP2(__EE13045994.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE13045994.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE13045994.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST132460_Layout := RECORD
  ...
  EXPORT DBG_OutputAll := PARALLEL(
    ...
    OUTPUT(DBG_E_Phone_Result,NAMED('DBG_E_Phone_Result_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Lien_Judgment_Intermediate_14,NAMED('DBG_E_Lien_Judgment_Intermediate_14_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Lien_Judgment_Intermediate_13,NAMED('DBG_E_Person_Lien_Judgment_Intermediate_13_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Person_Intermediate_12,NAMED('DBG_E_Person_Intermediate_12_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Bankruptcy_Intermediate_9,NAMED('DBG_E_Bankruptcy_Intermediate_9_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Criminal_Offense_Intermediate_8,NAMED('DBG_E_Criminal_Offense_Intermediate_8_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
    ...
    OUTPUT(DBG_E_Email_Intermediate_3,NAMED('DBG_E_Email_Intermediate_3_Q_Non_F_C_R_A_Business_Sele_I_D_Attributes_V1_Dynamic')),
