...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4940188 := __ENH_U_C_C_6;
  ...
  EXPORT __ST242451_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST242455_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST242451_Layout __ND4940150__Project(B_U_C_C_6(__in,__cfg).__ST246998_Layout __PP4939850) := TRANSFORM
    __EE4940191 := __PP4939850.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4940191),__ST242455_Layout),__NL(__EE4940191));
    __EE4940145 := __PP4939850.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE4940145),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP4939850;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE4940188,__ND4940150__Project(LEFT));
END;
