...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5643567 := __ENH_U_C_C_6;
  EXPORT __ST258413_Layout := RECORD
  ...
  END;
  EXPORT __ST258409_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258413_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258409_Layout __ND5643529__Project(B_U_C_C_6(__in,__cfg).__ST263311_Layout __PP5643229) := TRANSFORM
    __EE5643570 := __PP5643229.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5643570),__ST258413_Layout),__NL(__EE5643570));
    __EE5643524 := __PP5643229.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5643524),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5643229;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5643567,__ND5643529__Project(LEFT));
END;
