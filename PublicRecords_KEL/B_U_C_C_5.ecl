...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5399019 := __ENH_U_C_C_6;
  ...
  END;
  EXPORT __ST249502_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST249506_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249502_Layout __ND5398981__Project(B_U_C_C_6(__in,__cfg).__ST254203_Layout __PP5398681) := TRANSFORM
    __EE5399022 := __PP5398681.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5399022),__ST249506_Layout),__NL(__EE5399022));
    __EE5398976 := __PP5398681.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5398976),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5398681;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5399019,__ND5398981__Project(LEFT));
END;
