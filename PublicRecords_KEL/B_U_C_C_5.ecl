...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5218204 := __ENH_U_C_C_6;
  EXPORT __ST251814_Layout := RECORD
  ...
  END;
  EXPORT __ST251810_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST251814_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251810_Layout __ND5218166__Project(B_U_C_C_6(__in,__cfg).__ST256531_Layout __PP5217866) := TRANSFORM
    __EE5218207 := __PP5217866.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5218207),__ST251814_Layout),__NL(__EE5218207));
    __EE5218161 := __PP5217866.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5218161),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5217866;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5218204,__ND5218166__Project(LEFT));
END;
