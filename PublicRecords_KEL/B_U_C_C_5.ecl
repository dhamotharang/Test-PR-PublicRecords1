...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5663934 := __ENH_U_C_C_6;
  ...
  END;
  EXPORT __ST258711_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258715_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258711_Layout __ND5663896__Project(B_U_C_C_6(__in,__cfg).__ST263613_Layout __PP5663596) := TRANSFORM
    __EE5663937 := __PP5663596.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5663937),__ST258715_Layout),__NL(__EE5663937));
    __EE5663891 := __PP5663596.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5663891),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5663596;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5663934,__ND5663896__Project(LEFT));
END;
