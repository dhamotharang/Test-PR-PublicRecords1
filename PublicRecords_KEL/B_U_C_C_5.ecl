...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5656777 := __ENH_U_C_C_6;
  EXPORT __ST263895_Layout := RECORD
  ...
  EXPORT __ST263891_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST263895_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST263891_Layout __ND5656739__Project(B_U_C_C_6(__in,__cfg).__ST268725_Layout __PP5656439) := TRANSFORM
    __EE5656780 := __PP5656439.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5656780),__ST263895_Layout),__NL(__EE5656780));
    __EE5656734 := __PP5656439.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5656734),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5656439;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5656777,__ND5656739__Project(LEFT));
END;
