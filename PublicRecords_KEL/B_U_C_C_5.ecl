...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3616088 := __ENH_U_C_C_6;
  EXPORT __ST197619_Layout := RECORD
  ...
  END;
  EXPORT __ST197615_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST197619_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197615_Layout __ND3616050__Project(B_U_C_C_6(__in,__cfg).__ST201287_Layout __PP3615815) := TRANSFORM
    __EE3616091 := __PP3615815.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3616091),__ST197619_Layout),__NL(__EE3616091));
    __EE3616045 := __PP3615815.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE3616045),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP3615815;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE3616088,__ND3616050__Project(LEFT));
END;
