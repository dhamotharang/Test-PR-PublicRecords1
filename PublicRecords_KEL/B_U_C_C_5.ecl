...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5714768 := __ENH_U_C_C_6;
  EXPORT __ST265505_Layout := RECORD
  ...
  END;
  EXPORT __ST265501_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST265505_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265501_Layout __ND5714730__Project(B_U_C_C_6(__in,__cfg).__ST270340_Layout __PP5714430) := TRANSFORM
    __EE5714771 := __PP5714430.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5714771),__ST265505_Layout),__NL(__EE5714771));
    __EE5714725 := __PP5714430.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5714725),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5714430;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5714768,__ND5714730__Project(LEFT));
END;
