...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5718627 := __ENH_U_C_C_6;
  EXPORT __ST265618_Layout := RECORD
  ...
  END;
  EXPORT __ST265614_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST265618_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265614_Layout __ND5718589__Project(B_U_C_C_6(__in,__cfg).__ST270610_Layout __PP5718289) := TRANSFORM
    __EE5718630 := __PP5718289.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5718630),__ST265618_Layout),__NL(__EE5718630));
    __EE5718584 := __PP5718289.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5718584),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5718289;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5718627,__ND5718589__Project(LEFT));
END;
