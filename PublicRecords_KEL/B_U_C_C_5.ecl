...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5595582 := __ENH_U_C_C_6;
  EXPORT __ST262507_Layout := RECORD
  ...
  END;
  EXPORT __ST262503_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST262507_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST262503_Layout __ND5595544__Project(B_U_C_C_6(__in,__cfg).__ST267327_Layout __PP5595244) := TRANSFORM
    __EE5595585 := __PP5595244.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5595585),__ST262507_Layout),__NL(__EE5595585));
    __EE5595539 := __PP5595244.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5595539),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5595244;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5595582,__ND5595544__Project(LEFT));
END;
