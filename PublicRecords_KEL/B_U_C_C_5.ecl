...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3611469 := __ENH_U_C_C_6;
  EXPORT __ST189301_Layout := RECORD
  ...
  END;
  EXPORT __ST189297_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST189301_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST189297_Layout __ND3611431__Project(B_U_C_C_6(__in,__cfg).__ST192914_Layout __PP3611196) := TRANSFORM
    __EE3611472 := __PP3611196.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3611472),__ST189301_Layout),__NL(__EE3611472));
    __EE3611426 := __PP3611196.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE3611426),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP3611196;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE3611469,__ND3611431__Project(LEFT));
END;
