...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5426018 := __ENH_U_C_C_6;
  EXPORT __ST250913_Layout := RECORD
  ...
  END;
  EXPORT __ST250909_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250913_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250909_Layout __ND5425980__Project(B_U_C_C_6(__in,__cfg).__ST255614_Layout __PP5425680) := TRANSFORM
    __EE5426021 := __PP5425680.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5426021),__ST250913_Layout),__NL(__EE5426021));
    __EE5425975 := __PP5425680.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5425975),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5425680;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5426018,__ND5425980__Project(LEFT));
END;
