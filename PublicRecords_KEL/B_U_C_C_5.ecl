...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5790630 := __ENH_U_C_C_6;
  EXPORT __ST261601_Layout := RECORD
  ...
  END;
  EXPORT __ST261597_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST261601_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST261597_Layout __ND5790592__Project(B_U_C_C_6(__in,__cfg).__ST266499_Layout __PP5790292) := TRANSFORM
    __EE5790633 := __PP5790292.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5790633),__ST261601_Layout),__NL(__EE5790633));
    __EE5790587 := __PP5790292.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5790587),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5790292;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5790630,__ND5790592__Project(LEFT));
END;
