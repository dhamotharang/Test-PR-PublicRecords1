...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5193715 := __ENH_U_C_C_6;
  EXPORT __ST250144_Layout := RECORD
  ...
  END;
  EXPORT __ST250140_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST250144_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250140_Layout __ND5193677__Project(B_U_C_C_6(__in,__cfg).__ST254857_Layout __PP5193377) := TRANSFORM
    __EE5193718 := __PP5193377.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5193718),__ST250144_Layout),__NL(__EE5193718));
    __EE5193672 := __PP5193377.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE5193672),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP5193377;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE5193715,__ND5193677__Project(LEFT));
END;
