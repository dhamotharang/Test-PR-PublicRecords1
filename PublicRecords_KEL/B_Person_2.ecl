...
EXPORT B_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE20456 := __E_Person;
  EXPORT __ST13293_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST13293_Layout __ND20556__Project(E_Person(__in,__cfg).Layout __PP20336) := TRANSFORM
    ...
    SELF := __PP20336;
  END;
  EXPORT __ENH_Person_2 := PROJECT(__EE20456,__ND20556__Project(LEFT));
END;
