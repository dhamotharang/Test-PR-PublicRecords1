...
EXPORT B_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE25097 := __E_Person;
  EXPORT __ST16529_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST16529_Layout __ND25197__Project(E_Person(__in,__cfg).Layout __PP24977) := TRANSFORM
    ...
    SELF := __PP24977;
  END;
  EXPORT __ENH_Person_2 := PROJECT(__EE25097,__ND25197__Project(LEFT));
END;
