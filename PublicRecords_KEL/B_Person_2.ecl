...
EXPORT B_Person_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE21001 := __E_Person;
  EXPORT __ST13312_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST13312_Layout __ND21101__Project(E_Person(__in,__cfg).Layout __PP20881) := TRANSFORM
    ...
    SELF := __PP20881;
  END;
  EXPORT __ENH_Person_2 := PROJECT(__EE21001,__ND21101__Project(LEFT));
END;
