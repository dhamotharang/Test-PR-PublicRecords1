...
EXPORT E_Drivers_License(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Trimmed := RECORD, MAXLENGTH(5000)
    STRING KeyVal;
  END;
  SHARED __d0_KELfiltered := PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault(dl_number != '' AND orig_state != '');
  ...
  SHARED __d0_Out := RECORD
    RECORDOF(PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault);
    KEL.typ.uid UID := 0;
  END;
  ...
  EXPORT PublicRecords_KEL_Files_NonFCRA_DriversV2__Key_DL_Number_Vault_Invalid := __d0_UID_Mapped(UID = 0);
  SHARED __d0_Prefiltered := __d0_UID_Mapped(UID <> 0);
  SHARED __d0 := __SourceFilter(KEL.FromFlat.Convert(__d0_Prefiltered,InLayout,__Mapping0,'PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault'));
  EXPORT InData := __d0;
  ...
  EXPORT SanityCheck := DATASET([{COUNT(PublicRecords_KEL_Files_NonFCRA_DriversV2__Key_DL_Number_Vault_Invalid),COUNT(Drivers_License_Number__SingleValue_Invalid),COUNT(Issuing_State__SingleValue_Invalid),COUNT(State_Name__SingleValue_Invalid),COUNT(Drivers_License_Sequence__SingleValue_Invalid),COUNT(License_Class__SingleValue_Invalid),COUNT(License_Type__SingleValue_Invalid),COUNT(Moxie_License_Type__SingleValue_Invalid),COUNT(Attention__SingleValue_Invalid),COUNT(Attention_Code__SingleValue_Invalid),COUNT(Restrictions__SingleValue_Invalid),COUNT(Restrictions_Delimited__SingleValue_Invalid),COUNT(Original_Expiration_Date__SingleValue_Invalid),COUNT(Original_Issue_Date__SingleValue_Invalid),COUNT(Issue_Date__SingleValue_Invalid),COUNT(Expiration_Date__SingleValue_Invalid),COUNT(Active_Date__SingleValue_Invalid),COUNT(Inactive_Date__SingleValue_Invalid),COUNT(Endorsement__SingleValue_Invalid),COUNT(Motorcycle_Code__SingleValue_Invalid),COUNT(Driver_Education_Code__SingleValue_Invalid),COUNT(Duplicate_Count__SingleValue_Invalid),COUNT(R_C_D_Stat__SingleValue_Invalid),COUNT(Issuance__SingleValue_Invalid),COUNT(C_D_L_Status__SingleValue_Invalid),COUNT(County__SingleValue_Invalid),COUNT(History_Name__SingleValue_Invalid),COUNT(History__SingleValue_Invalid),TopSourcedUIDs(1)}],{KEL.typ.int PublicRecords_KEL_Files_NonFCRA_DriversV2__Key_DL_Number_Vault_Invalid,KEL.typ.int Drivers_License_Number__SingleValue_Invalid,KEL.typ.int Issuing_State__SingleValue_Invalid,KEL.typ.int State_Name__SingleValue_Invalid,KEL.typ.int Drivers_License_Sequence__SingleValue_Invalid,KEL.typ.int License_Class__SingleValue_Invalid,KEL.typ.int License_Type__SingleValue_Invalid,KEL.typ.int Moxie_License_Type__SingleValue_Invalid,KEL.typ.int Attention__SingleValue_Invalid,KEL.typ.int Attention_Code__SingleValue_Invalid,KEL.typ.int Restrictions__SingleValue_Invalid,KEL.typ.int Restrictions_Delimited__SingleValue_Invalid,KEL.typ.int Original_Expiration_Date__SingleValue_Invalid,KEL.typ.int Original_Issue_Date__SingleValue_Invalid,KEL.typ.int Issue_Date__SingleValue_Invalid,KEL.typ.int Expiration_Date__SingleValue_Invalid,KEL.typ.int Active_Date__SingleValue_Invalid,KEL.typ.int Inactive_Date__SingleValue_Invalid,KEL.typ.int Endorsement__SingleValue_Invalid,KEL.typ.int Motorcycle_Code__SingleValue_Invalid,KEL.typ.int Driver_Education_Code__SingleValue_Invalid,KEL.typ.int Duplicate_Count__SingleValue_Invalid,KEL.typ.int R_C_D_Stat__SingleValue_Invalid,KEL.typ.int Issuance__SingleValue_Invalid,KEL.typ.int C_D_L_Status__SingleValue_Invalid,KEL.typ.int County__SingleValue_Invalid,KEL.typ.int History_Name__SingleValue_Invalid,KEL.typ.int History__SingleValue_Invalid,DATASET(RECORDOF(UIDSourceCounts)) topSourcedUID});
  EXPORT NullCounts := DATASET([
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','UID',COUNT(PublicRecords_KEL_Files_NonFCRA_DriversV2__Key_DL_Number_Vault_Invalid),COUNT(__d0)},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','dl_number',COUNT(__d0(__NL(Drivers_License_Number_))),COUNT(__d0(__NN(Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','orig_state',COUNT(__d0(__NL(Issuing_State_))),COUNT(__d0(__NN(Issuing_State_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','dl_seq',COUNT(__d0(__NL(Drivers_License_Sequence_))),COUNT(__d0(__NN(Drivers_License_Sequence_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','license_class',COUNT(__d0(__NL(License_Class_))),COUNT(__d0(__NN(License_Class_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','license_type',COUNT(__d0(__NL(License_Type_))),COUNT(__d0(__NN(License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','moxie_license_type',COUNT(__d0(__NL(Moxie_License_Type_))),COUNT(__d0(__NN(Moxie_License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','attention_name',COUNT(__d0(__NL(Attention_))),COUNT(__d0(__NN(Attention_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','attention_flag',COUNT(__d0(__NL(Attention_Code_))),COUNT(__d0(__NN(Attention_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','restrictions',COUNT(__d0(__NL(Restrictions_))),COUNT(__d0(__NN(Restrictions_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','restrictions_delimited',COUNT(__d0(__NL(Restrictions_Delimited_))),COUNT(__d0(__NN(Restrictions_Delimited_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','orig_expiration_date',COUNT(__d0(__NL(Original_Expiration_Date_))),COUNT(__d0(__NN(Original_Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','orig_issue_date',COUNT(__d0(__NL(Original_Issue_Date_))),COUNT(__d0(__NN(Original_Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','lic_issue_date',COUNT(__d0(__NL(Issue_Date_))),COUNT(__d0(__NN(Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','expiration_date',COUNT(__d0(__NL(Expiration_Date_))),COUNT(__d0(__NN(Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','active_date',COUNT(__d0(__NL(Active_Date_))),COUNT(__d0(__NN(Active_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','inactive_date',COUNT(__d0(__NL(Inactive_Date_))),COUNT(__d0(__NN(Inactive_Date_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','lic_endorsement',COUNT(__d0(__NL(Endorsement_))),COUNT(__d0(__NN(Endorsement_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','motorcycle_code',COUNT(__d0(__NL(Motorcycle_Code_))),COUNT(__d0(__NN(Motorcycle_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','driver_edu_code',COUNT(__d0(__NL(Driver_Education_Code_))),COUNT(__d0(__NN(Driver_Education_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','dup_lic_count',COUNT(__d0(__NL(Duplicate_Count_))),COUNT(__d0(__NN(Duplicate_Count_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','rcd_stat_flag',COUNT(__d0(__NL(R_C_D_Stat_))),COUNT(__d0(__NN(R_C_D_Stat_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','oos_previous_dl_number',COUNT(__d0(__NL(O_O_S_Previous_Drivers_License_Number_))),COUNT(__d0(__NN(O_O_S_Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','oos_previous_st',COUNT(__d0(__NL(Previous_State_))),COUNT(__d0(__NN(Previous_State_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','old_dl_number',COUNT(__d0(__NL(Previous_Drivers_License_Number_))),COUNT(__d0(__NN(Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','dl_key_number',COUNT(__d0(__NL(Drivers_License_Key_Number_))),COUNT(__d0(__NN(Drivers_License_Key_Number_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','issuance',COUNT(__d0(__NL(Issuance_))),COUNT(__d0(__NN(Issuance_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','cdl_status',COUNT(__d0(__NL(C_D_L_Status_))),COUNT(__d0(__NN(C_D_L_Status_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','county_name',COUNT(__d0(__NL(County_))),COUNT(__d0(__NN(County_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','address_change',COUNT(__d0(__NL(Address_Change_))),COUNT(__d0(__NN(Address_Change_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','name_change',COUNT(__d0(__NL(Name_Change_))),COUNT(__d0(__NN(Name_Change_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','dob_change',COUNT(__d0(__NL(Date_Of_Birth_Change_))),COUNT(__d0(__NN(Date_Of_Birth_Change_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','sex_change',COUNT(__d0(__NL(Sex_Change_))),COUNT(__d0(__NN(Sex_Change_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','height',COUNT(__d0(__NL(Height_))),COUNT(__d0(__NN(Height_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','weight',COUNT(__d0(__NL(Weight_))),COUNT(__d0(__NN(Weight_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','race_name',COUNT(__d0(__NL(Race_))),COUNT(__d0(__NN(Race_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','race',COUNT(__d0(__NL(Race_Code_))),COUNT(__d0(__NN(Race_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','sex_name',COUNT(__d0(__NL(Sex_))),COUNT(__d0(__NN(Sex_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','sex_flag',COUNT(__d0(__NL(Sex_Code_))),COUNT(__d0(__NN(Sex_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','hair_color',COUNT(__d0(__NL(Hair_Color_))),COUNT(__d0(__NN(Hair_Color_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','HairColorCode',COUNT(__d0(__NL(Hair_Color_Code_))),COUNT(__d0(__NN(Hair_Color_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','eye_color',COUNT(__d0(__NL(Eye_Color_))),COUNT(__d0(__NN(Eye_Color_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','EyeColorCode',COUNT(__d0(__NL(Eye_Color_Code_))),COUNT(__d0(__NN(Eye_Color_Code_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','orig_state_name',COUNT(__d0(__NL(State_Name_))),COUNT(__d0(__NN(State_Name_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','history_name',COUNT(__d0(__NL(History_Name_))),COUNT(__d0(__NN(History_Name_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','history',COUNT(__d0(__NL(History_))),COUNT(__d0(__NN(History_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','source_code',COUNT(__d0(__NL(Source_))),COUNT(__d0(__NN(Source_)))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','Archive_Date',COUNT(__d0(Archive___Date_=0)),COUNT(__d0(Archive___Date_!=0))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','DateFirstSeen',COUNT(__d0(Date_First_Seen_=0)),COUNT(__d0(Date_First_Seen_!=0))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','DateLastSeen',COUNT(__d0(Date_Last_Seen_=0)),COUNT(__d0(Date_Last_Seen_!=0))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','HybridArchiveDate',COUNT(__d0(Hybrid_Archive_Date_=0)),COUNT(__d0(Hybrid_Archive_Date_!=0))},
    {'DriversLicense','PublicRecords_KEL.Files.NonFCRA.DriversV2__Key_DL_Number_Vault','VaultDateLastSeen',COUNT(__d0(Vault_Date_Last_Seen_=0)),COUNT(__d0(Vault_Date_Last_Seen_!=0))}]
