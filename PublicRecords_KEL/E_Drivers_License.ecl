...
EXPORT E_Drivers_License(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __d1_KELfiltered := __in.Dataset_Inquiry_AccLogs__Key_FCRA_DID(person_q.dl <> '' OR person_q.dl_st <> '');
  SHARED __d1_Trim := PROJECT(__d1_KELfiltered,TRANSFORM(__Trimmed,SELF.KeyVal:=TRIM((STRING)LEFT.person_q.dl) + '|' + TRIM((STRING)LEFT.person_q.dl_st)));
  SHARED __d2_KELfiltered := __in.Dataset_DriversV2__Key_DL_DID(orig_state != '');
  ...
  SHARED __d3_KELfiltered := __in.Dataset_DriversV2__Key_DL_Number(orig_state != '');
  SHARED __d3_Trim := PROJECT(__d3_KELfiltered,TRANSFORM(__Trimmed,SELF.KeyVal:=TRIM((STRING)LEFT.dl_number) + '|' + TRIM((STRING)LEFT.orig_state)));
  ...
  SHARED __Mapping0 := 'UID(DEFAULT:UID),dl_num(OVERRIDE:Drivers_License_Number_:\'\'),dl_state(OVERRIDE:Issuing_State_:\'\'),dl_seq(DEFAULT:Drivers_License_Sequence_:0),licenseclass(DEFAULT:License_Class_:\'\'),licensetype(DEFAULT:License_Type_:\'\'),moxielicensetype(DEFAULT:Moxie_License_Type_:\'\'),attention(DEFAULT:Attention_:\'\'),attentioncode(DEFAULT:Attention_Code_:\'\'),restrictions(DEFAULT:Restrictions_:\'\'),restrictionsdelimited(DEFAULT:Restrictions_Delimited_:\'\'),originalexpirationdate(DEFAULT:Original_Expiration_Date_:DATE),originalissuedate(DEFAULT:Original_Issue_Date_:DATE),issuedate(DEFAULT:Issue_Date_:DATE),expirationdate(DEFAULT:Expiration_Date_:DATE),activedate(DEFAULT:Active_Date_:DATE:Active_Date_0Rule),inactivedate(DEFAULT:Inactive_Date_:DATE:Inactive_Date_0Rule),endorsement(DEFAULT:Endorsement_:\'\'),motorcyclecode(DEFAULT:Motorcycle_Code_:\'\'),drivereducationcode(DEFAULT:Driver_Education_Code_:0),duplicatecount(DEFAULT:Duplicate_Count_:0),rcdstat(DEFAULT:R_C_D_Stat_:\'\'),oospreviousdriverslicensenumber(DEFAULT:O_O_S_Previous_Drivers_License_Number_:\'\'),previousstate(DEFAULT:Previous_State_:\'\'),previousdriverslicensenumber(DEFAULT:Previous_Drivers_License_Number_:\'\'),driverslicensekeynumber(DEFAULT:Drivers_License_Key_Number_:0),issuance(DEFAULT:Issuance_:\'\'),cdlstatus(DEFAULT:C_D_L_Status_:\'\'),county(DEFAULT:County_:\'\'),addresschange(DEFAULT:Address_Change_:\'\'),namechange(DEFAULT:Name_Change_:\'\'),dateofbirthchange(DEFAULT:Date_Of_Birth_Change_:\'\'),sexchange(DEFAULT:Sex_Change_:\'\'),height(DEFAULT:Height_:\'\'),weight(DEFAULT:Weight_:0),race(DEFAULT:Race_:\'\'),racecode(DEFAULT:Race_Code_:\'\'),sex(DEFAULT:Sex_:\'\'),sexcode(DEFAULT:Sex_Code_:\'\'),haircolor(DEFAULT:Hair_Color_:\'\'),haircolorcode(DEFAULT:Hair_Color_Code_:\'\'),eyecolor(DEFAULT:Eye_Color_:\'\'),eyecolorcode(DEFAULT:Eye_Color_Code_:\'\'),statename(DEFAULT:State_Name_:\'\'),historyname(DEFAULT:History_Name_:\'\'),history(DEFAULT:History_:\'\'),src(OVERRIDE:Source_:\'\'),earliest_offense_date(OVERRIDE:Date_First_Seen_:EPOCH),datelastseen(DEFAULT:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __Mapping1 := 'UID(DEFAULT:UID),person_q.dl(OVERRIDE:Drivers_License_Number_:\'\'),person_q.dl_st(OVERRIDE:Issuing_State_:\'\'),dl_seq(DEFAULT:Drivers_License_Sequence_:0),licenseclass(DEFAULT:License_Class_:\'\'),licensetype(DEFAULT:License_Type_:\'\'),moxielicensetype(DEFAULT:Moxie_License_Type_:\'\'),attention(DEFAULT:Attention_:\'\'),attentioncode(DEFAULT:Attention_Code_:\'\'),restrictions(DEFAULT:Restrictions_:\'\'),restrictionsdelimited(DEFAULT:Restrictions_Delimited_:\'\'),originalexpirationdate(DEFAULT:Original_Expiration_Date_:DATE),originalissuedate(DEFAULT:Original_Issue_Date_:DATE),issuedate(DEFAULT:Issue_Date_:DATE),expirationdate(DEFAULT:Expiration_Date_:DATE),activedate(DEFAULT:Active_Date_:DATE:Active_Date_1Rule),inactivedate(DEFAULT:Inactive_Date_:DATE:Inactive_Date_1Rule),endorsement(DEFAULT:Endorsement_:\'\'),motorcyclecode(DEFAULT:Motorcycle_Code_:\'\'),drivereducationcode(DEFAULT:Driver_Education_Code_:0),duplicatecount(DEFAULT:Duplicate_Count_:0),rcdstat(DEFAULT:R_C_D_Stat_:\'\'),oospreviousdriverslicensenumber(DEFAULT:O_O_S_Previous_Drivers_License_Number_:\'\'),previousstate(DEFAULT:Previous_State_:\'\'),previousdriverslicensenumber(DEFAULT:Previous_Drivers_License_Number_:\'\'),driverslicensekeynumber(DEFAULT:Drivers_License_Key_Number_:0),issuance(DEFAULT:Issuance_:\'\'),cdlstatus(DEFAULT:C_D_L_Status_:\'\'),county(DEFAULT:County_:\'\'),addresschange(DEFAULT:Address_Change_:\'\'),namechange(DEFAULT:Name_Change_:\'\'),dateofbirthchange(DEFAULT:Date_Of_Birth_Change_:\'\'),sexchange(DEFAULT:Sex_Change_:\'\'),height(DEFAULT:Height_:\'\'),weight(DEFAULT:Weight_:0),race(DEFAULT:Race_:\'\'),racecode(DEFAULT:Race_Code_:\'\'),sex(DEFAULT:Sex_:\'\'),sexcode(DEFAULT:Sex_Code_:\'\'),haircolor(DEFAULT:Hair_Color_:\'\'),haircolorcode(DEFAULT:Hair_Color_Code_:\'\'),eyecolor(DEFAULT:Eye_Color_:\'\'),eyecolorcode(DEFAULT:Eye_Color_Code_:\'\'),statename(DEFAULT:State_Name_:\'\'),historyname(DEFAULT:History_Name_:\'\'),history(DEFAULT:History_:\'\'),src(OVERRIDE:Source_:\'\'),dateofinquiry(OVERRIDE:Date_First_Seen_:EPOCH|OVERRIDE:Date_Last_Seen_:EPOCH),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  ...
  SHARED __d1_Out := RECORD
    ...
    KEL.typ.uid UID := 0;
  END;
  SHARED __d1_UID_Mapped := JOIN(__d1_KELfiltered,Lookup,TRIM((STRING)LEFT.person_q.dl) + '|' + TRIM((STRING)LEFT.person_q.dl_st) = RIGHT.KeyVal,TRANSFORM(__d1_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Inquiry_AccLogs__Key_FCRA_DID_Invalid := __d1_UID_Mapped(UID = 0);
  ...
  SHARED Active_Date_3Rule(STRING a) := MAP(KEL.Routines.IsValidDate((KEL.typ.kdate)(a[1..6]+'01'))=>a[1..6]+'01','0');
  SHARED Inactive_Date_3Rule(STRING a) := MAP(KEL.Routines.IsValidDate((KEL.typ.kdate)(a[1..6]+'01'))=>a[1..6]+'01','0');
  ...
  SHARED __Mapping3 := 'UID(DEFAULT:UID),dl_number(OVERRIDE:Drivers_License_Number_:\'\'),orig_state(OVERRIDE:Issuing_State_:\'\'),dl_seq(OVERRIDE:Drivers_License_Sequence_:0),license_class(OVERRIDE:License_Class_:\'\'),license_type(OVERRIDE:License_Type_:\'\'),moxie_license_type(OVERRIDE:Moxie_License_Type_:\'\'),attention_name(OVERRIDE:Attention_:\'\'),attention_flag(OVERRIDE:Attention_Code_:\'\'),restrictions(OVERRIDE:Restrictions_:\'\'),restrictions_delimited(OVERRIDE:Restrictions_Delimited_:\'\'),orig_expiration_date(OVERRIDE:Original_Expiration_Date_:DATE),orig_issue_date(OVERRIDE:Original_Issue_Date_:DATE),lic_issue_date(OVERRIDE:Issue_Date_:DATE),expiration_date(OVERRIDE:Expiration_Date_:DATE),active_date(OVERRIDE:Active_Date_:DATE:Active_Date_3Rule),inactive_date(OVERRIDE:Inactive_Date_:DATE:Inactive_Date_3Rule),lic_endorsement(OVERRIDE:Endorsement_:\'\'),motorcycle_code(OVERRIDE:Motorcycle_Code_:\'\'),driver_edu_code(OVERRIDE:Driver_Education_Code_:0),dup_lic_count(OVERRIDE:Duplicate_Count_:0),rcd_stat_flag(OVERRIDE:R_C_D_Stat_:\'\'),oos_previous_dl_number(OVERRIDE:O_O_S_Previous_Drivers_License_Number_:\'\'),oos_previous_st(OVERRIDE:Previous_State_:\'\'),old_dl_number(OVERRIDE:Previous_Drivers_License_Number_:\'\'),dl_key_number(OVERRIDE:Drivers_License_Key_Number_:0),issuance(OVERRIDE:Issuance_:\'\'),cdl_status(OVERRIDE:C_D_L_Status_:\'\'),county_name(OVERRIDE:County_:\'\'),address_change(OVERRIDE:Address_Change_:\'\'),name_change(OVERRIDE:Name_Change_:\'\'),dob_change(OVERRIDE:Date_Of_Birth_Change_:\'\'),sex_change(OVERRIDE:Sex_Change_:\'\'),height(OVERRIDE:Height_:\'\'),weight(OVERRIDE:Weight_:0),race_name(OVERRIDE:Race_:\'\'),race(OVERRIDE:Race_Code_:\'\'),sex_name(OVERRIDE:Sex_:\'\'),sex_flag(OVERRIDE:Sex_Code_:\'\'),hair_color_name(OVERRIDE:Hair_Color_:\'\'),haircolorcode(DEFAULT:Hair_Color_Code_:\'\'),eye_color_name(OVERRIDE:Eye_Color_:\'\'),eyecolorcode(DEFAULT:Eye_Color_Code_:\'\'),orig_state_name(OVERRIDE:State_Name_:\'\'),history_name(OVERRIDE:History_Name_:\'\'),history(OVERRIDE:History_:\'\'),source_code(OVERRIDE:Source_:\'\'),dt_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_3Rule),dt_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH:Date_Last_Seen_3Rule),DPMBitmap(DEFAULT:__Permits:PERMITS)';
  SHARED __d3_Norm := NORMALIZE(__in,LEFT.Dataset_DriversV2__Key_DL_Number,TRANSFORM(RECORDOF(__in.Dataset_DriversV2__Key_DL_Number),SELF:=RIGHT));
  SHARED __d3_Out := RECORD
    RECORDOF(PublicRecords_KEL.ECL_Functions.Dataset_FDC.Dataset_DriversV2__Key_DL_Number);
    KEL.typ.uid UID := 0;
  END;
  SHARED __d3_UID_Mapped := JOIN(__d3_KELfiltered,Lookup,TRIM((STRING)LEFT.dl_number) + '|' + TRIM((STRING)LEFT.orig_state) = RIGHT.KeyVal,TRANSFORM(__d3_Out,SELF.UID:=RIGHT.UID,SELF:=LEFT),HASH);
  EXPORT PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DriversV2__Key_DL_Number_Invalid := __d3_UID_Mapped(UID = 0);
  ...
  Layout Drivers_License__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Previous_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),O_O_S_Previous_Drivers_License_Number_,Previous_State_,Drivers_License_Key_Number_,Previous_Drivers_License_Number_},O_O_S_Previous_Drivers_License_Number_,Previous_State_,Drivers_License_Key_Number_,Previous_Drivers_License_Number_),Previous_Layout)(__NN(O_O_S_Previous_Drivers_License_Number_) OR __NN(Previous_State_) OR __NN(Drivers_License_Key_Number_) OR __NN(Previous_Drivers_License_Number_)));
    SELF.Change_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Address_Change_,Name_Change_,Date_Of_Birth_Change_,Sex_Change_},Address_Change_,Name_Change_,Date_Of_Birth_Change_,Sex_Change_),Change_Layout)(__NN(Address_Change_) OR __NN(Name_Change_) OR __NN(Date_Of_Birth_Change_) OR __NN(Sex_Change_)));
    SELF.Person_Info_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Height_,Weight_,Race_,Race_Code_,Sex_,Sex_Code_,Hair_Color_,Hair_Color_Code_,Eye_Color_,Eye_Color_Code_},Height_,Weight_,Race_,Race_Code_,Sex_,Sex_Code_,Hair_Color_,Hair_Color_Code_,Eye_Color_,Eye_Color_Code_),Person_Info_Layout)(__NN(Height_) OR __NN(Weight_) OR __NN(Race_) OR __NN(Race_Code_) OR __NN(Sex_) OR __NN(Sex_Code_) OR __NN(Hair_Color_) OR __NN(Hair_Color_Code_) OR __NN(Eye_Color_) OR __NN(Eye_Color_Code_)));
  ...
  Layout Drivers_License__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Previous_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Previous_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(O_O_S_Previous_Drivers_License_Number_) OR __NN(Previous_State_) OR __NN(Drivers_License_Key_Number_) OR __NN(Previous_Drivers_License_Number_)));
    SELF.Change_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Change_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Address_Change_) OR __NN(Name_Change_) OR __NN(Date_Of_Birth_Change_) OR __NN(Sex_Change_)));
    SELF.Person_Info_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Person_Info_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Height_) OR __NN(Weight_) OR __NN(Race_) OR __NN(Race_Code_) OR __NN(Sex_) OR __NN(Sex_Code_) OR __NN(Hair_Color_) OR __NN(Hair_Color_Code_) OR __NN(Eye_Color_) OR __NN(Eye_Color_Code_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_Inquiry_AccLogs__Key_FCRA_DID_Invalid),COUNT(__d1)},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.dl',COUNT(__d1(__NL(Drivers_License_Number_))),COUNT(__d1(__NN(Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','person_q.dl_st',COUNT(__d1(__NL(Issuing_State_))),COUNT(__d1(__NN(Issuing_State_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','LicenseClass',COUNT(__d1(__NL(License_Class_))),COUNT(__d1(__NN(License_Class_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','LicenseType',COUNT(__d1(__NL(License_Type_))),COUNT(__d1(__NN(License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','MoxieLicenseType',COUNT(__d1(__NL(Moxie_License_Type_))),COUNT(__d1(__NN(Moxie_License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Attention',COUNT(__d1(__NL(Attention_))),COUNT(__d1(__NN(Attention_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AttentionCode',COUNT(__d1(__NL(Attention_Code_))),COUNT(__d1(__NN(Attention_Code_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RestrictionsDelimited',COUNT(__d1(__NL(Restrictions_Delimited_))),COUNT(__d1(__NN(Restrictions_Delimited_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OriginalExpirationDate',COUNT(__d1(__NL(Original_Expiration_Date_))),COUNT(__d1(__NN(Original_Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OriginalIssueDate',COUNT(__d1(__NL(Original_Issue_Date_))),COUNT(__d1(__NN(Original_Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','IssueDate',COUNT(__d1(__NL(Issue_Date_))),COUNT(__d1(__NN(Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ExpirationDate',COUNT(__d1(__NL(Expiration_Date_))),COUNT(__d1(__NN(Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','ActiveDate',COUNT(__d1(__NL(Active_Date_))),COUNT(__d1(__NN(Active_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','InactiveDate',COUNT(__d1(__NL(Inactive_Date_))),COUNT(__d1(__NN(Inactive_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Endorsement',COUNT(__d1(__NL(Endorsement_))),COUNT(__d1(__NN(Endorsement_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','MotorcycleCode',COUNT(__d1(__NL(Motorcycle_Code_))),COUNT(__d1(__NN(Motorcycle_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DriverEducationCode',COUNT(__d1(__NL(Driver_Education_Code_))),COUNT(__d1(__NN(Driver_Education_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DuplicateCount',COUNT(__d1(__NL(Duplicate_Count_))),COUNT(__d1(__NN(Duplicate_Count_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RCDStat',COUNT(__d1(__NL(R_C_D_Stat_))),COUNT(__d1(__NN(R_C_D_Stat_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','OOSPreviousDriversLicenseNumber',COUNT(__d1(__NL(O_O_S_Previous_Drivers_License_Number_))),COUNT(__d1(__NN(O_O_S_Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','PreviousState',COUNT(__d1(__NL(Previous_State_))),COUNT(__d1(__NN(Previous_State_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','PreviousDriversLicenseNumber',COUNT(__d1(__NL(Previous_Drivers_License_Number_))),COUNT(__d1(__NN(Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DriversLicenseKeyNumber',COUNT(__d1(__NL(Drivers_License_Key_Number_))),COUNT(__d1(__NN(Drivers_License_Key_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Issuance',COUNT(__d1(__NL(Issuance_))),COUNT(__d1(__NN(Issuance_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','CDLStatus',COUNT(__d1(__NL(C_D_L_Status_))),COUNT(__d1(__NN(C_D_L_Status_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','County',COUNT(__d1(__NL(County_))),COUNT(__d1(__NN(County_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','AddressChange',COUNT(__d1(__NL(Address_Change_))),COUNT(__d1(__NN(Address_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','NameChange',COUNT(__d1(__NL(Name_Change_))),COUNT(__d1(__NN(Name_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateOfBirthChange',COUNT(__d1(__NL(Date_Of_Birth_Change_))),COUNT(__d1(__NN(Date_Of_Birth_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SexChange',COUNT(__d1(__NL(Sex_Change_))),COUNT(__d1(__NN(Sex_Change_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Race',COUNT(__d1(__NL(Race_))),COUNT(__d1(__NN(Race_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','RaceCode',COUNT(__d1(__NL(Race_Code_))),COUNT(__d1(__NN(Race_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Sex',COUNT(__d1(__NL(Sex_))),COUNT(__d1(__NN(Sex_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','SexCode',COUNT(__d1(__NL(Sex_Code_))),COUNT(__d1(__NN(Sex_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','HairColor',COUNT(__d1(__NL(Hair_Color_))),COUNT(__d1(__NN(Hair_Color_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','EyeColor',COUNT(__d1(__NL(Eye_Color_))),COUNT(__d1(__NN(Eye_Color_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','StateName',COUNT(__d1(__NL(State_Name_))),COUNT(__d1(__NN(State_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','HistoryName',COUNT(__d1(__NL(History_Name_))),COUNT(__d1(__NN(History_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','History',COUNT(__d1(__NL(History_))),COUNT(__d1(__NN(History_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','Src',COUNT(__d1(__NL(Source_))),COUNT(__d1(__NN(Source_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DriversV2__Key_DL_DID_Invalid),COUNT(__d2)},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','license_class',COUNT(__d2(__NL(License_Class_))),COUNT(__d2(__NN(License_Class_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','license_type',COUNT(__d2(__NL(License_Type_))),COUNT(__d2(__NN(License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','moxie_license_type',COUNT(__d2(__NL(Moxie_License_Type_))),COUNT(__d2(__NN(Moxie_License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','attention_name',COUNT(__d2(__NL(Attention_))),COUNT(__d2(__NN(Attention_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','attention_flag',COUNT(__d2(__NL(Attention_Code_))),COUNT(__d2(__NN(Attention_Code_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','restrictions_delimited',COUNT(__d2(__NL(Restrictions_Delimited_))),COUNT(__d2(__NN(Restrictions_Delimited_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_expiration_date',COUNT(__d2(__NL(Original_Expiration_Date_))),COUNT(__d2(__NN(Original_Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_issue_date',COUNT(__d2(__NL(Original_Issue_Date_))),COUNT(__d2(__NN(Original_Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','lic_issue_date',COUNT(__d2(__NL(Issue_Date_))),COUNT(__d2(__NN(Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','expiration_date',COUNT(__d2(__NL(Expiration_Date_))),COUNT(__d2(__NN(Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','active_date',COUNT(__d2(__NL(Active_Date_))),COUNT(__d2(__NN(Active_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','inactive_date',COUNT(__d2(__NL(Inactive_Date_))),COUNT(__d2(__NN(Inactive_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','lic_endorsement',COUNT(__d2(__NL(Endorsement_))),COUNT(__d2(__NN(Endorsement_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','motorcycle_code',COUNT(__d2(__NL(Motorcycle_Code_))),COUNT(__d2(__NN(Motorcycle_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','driver_edu_code',COUNT(__d2(__NL(Driver_Education_Code_))),COUNT(__d2(__NN(Driver_Education_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dup_lic_count',COUNT(__d2(__NL(Duplicate_Count_))),COUNT(__d2(__NN(Duplicate_Count_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rcd_stat_flag',COUNT(__d2(__NL(R_C_D_Stat_))),COUNT(__d2(__NN(R_C_D_Stat_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','oos_previous_dl_number',COUNT(__d2(__NL(O_O_S_Previous_Drivers_License_Number_))),COUNT(__d2(__NN(O_O_S_Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','oos_previous_st',COUNT(__d2(__NL(Previous_State_))),COUNT(__d2(__NN(Previous_State_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','old_dl_number',COUNT(__d2(__NL(Previous_Drivers_License_Number_))),COUNT(__d2(__NN(Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dl_key_number',COUNT(__d2(__NL(Drivers_License_Key_Number_))),COUNT(__d2(__NN(Drivers_License_Key_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','issuance',COUNT(__d2(__NL(Issuance_))),COUNT(__d2(__NN(Issuance_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','cdl_status',COUNT(__d2(__NL(C_D_L_Status_))),COUNT(__d2(__NN(C_D_L_Status_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','county_name',COUNT(__d2(__NL(County_))),COUNT(__d2(__NN(County_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','address_change',COUNT(__d2(__NL(Address_Change_))),COUNT(__d2(__NN(Address_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','name_change',COUNT(__d2(__NL(Name_Change_))),COUNT(__d2(__NN(Name_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dob_change',COUNT(__d2(__NL(Date_Of_Birth_Change_))),COUNT(__d2(__NN(Date_Of_Birth_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_change',COUNT(__d2(__NL(Sex_Change_))),COUNT(__d2(__NN(Sex_Change_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','race_name',COUNT(__d2(__NL(Race_))),COUNT(__d2(__NN(Race_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','race',COUNT(__d2(__NL(Race_Code_))),COUNT(__d2(__NN(Race_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_name',COUNT(__d2(__NL(Sex_))),COUNT(__d2(__NN(Sex_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_flag',COUNT(__d2(__NL(Sex_Code_))),COUNT(__d2(__NN(Sex_Code_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_state_name',COUNT(__d2(__NL(State_Name_))),COUNT(__d2(__NN(State_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','history_name',COUNT(__d2(__NL(History_Name_))),COUNT(__d2(__NN(History_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','history',COUNT(__d2(__NL(History_))),COUNT(__d2(__NN(History_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','source_code',COUNT(__d2(__NL(Source_))),COUNT(__d2(__NN(Source_)))},
    ...
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','UID',COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DriversV2__Key_DL_Number_Invalid),COUNT(__d3)},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dl_number',COUNT(__d3(__NL(Drivers_License_Number_))),COUNT(__d3(__NN(Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_state',COUNT(__d3(__NL(Issuing_State_))),COUNT(__d3(__NN(Issuing_State_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dl_seq',COUNT(__d3(__NL(Drivers_License_Sequence_))),COUNT(__d3(__NN(Drivers_License_Sequence_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','license_class',COUNT(__d3(__NL(License_Class_))),COUNT(__d3(__NN(License_Class_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','license_type',COUNT(__d3(__NL(License_Type_))),COUNT(__d3(__NN(License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','moxie_license_type',COUNT(__d3(__NL(Moxie_License_Type_))),COUNT(__d3(__NN(Moxie_License_Type_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','attention_name',COUNT(__d3(__NL(Attention_))),COUNT(__d3(__NN(Attention_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','attention_flag',COUNT(__d3(__NL(Attention_Code_))),COUNT(__d3(__NN(Attention_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','restrictions',COUNT(__d3(__NL(Restrictions_))),COUNT(__d3(__NN(Restrictions_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','restrictions_delimited',COUNT(__d3(__NL(Restrictions_Delimited_))),COUNT(__d3(__NN(Restrictions_Delimited_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_expiration_date',COUNT(__d3(__NL(Original_Expiration_Date_))),COUNT(__d3(__NN(Original_Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_issue_date',COUNT(__d3(__NL(Original_Issue_Date_))),COUNT(__d3(__NN(Original_Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','lic_issue_date',COUNT(__d3(__NL(Issue_Date_))),COUNT(__d3(__NN(Issue_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','expiration_date',COUNT(__d3(__NL(Expiration_Date_))),COUNT(__d3(__NN(Expiration_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','active_date',COUNT(__d3(__NL(Active_Date_))),COUNT(__d3(__NN(Active_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','inactive_date',COUNT(__d3(__NL(Inactive_Date_))),COUNT(__d3(__NN(Inactive_Date_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','lic_endorsement',COUNT(__d3(__NL(Endorsement_))),COUNT(__d3(__NN(Endorsement_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','motorcycle_code',COUNT(__d3(__NL(Motorcycle_Code_))),COUNT(__d3(__NN(Motorcycle_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','driver_edu_code',COUNT(__d3(__NL(Driver_Education_Code_))),COUNT(__d3(__NN(Driver_Education_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dup_lic_count',COUNT(__d3(__NL(Duplicate_Count_))),COUNT(__d3(__NN(Duplicate_Count_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','rcd_stat_flag',COUNT(__d3(__NL(R_C_D_Stat_))),COUNT(__d3(__NN(R_C_D_Stat_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','oos_previous_dl_number',COUNT(__d3(__NL(O_O_S_Previous_Drivers_License_Number_))),COUNT(__d3(__NN(O_O_S_Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','oos_previous_st',COUNT(__d3(__NL(Previous_State_))),COUNT(__d3(__NN(Previous_State_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','old_dl_number',COUNT(__d3(__NL(Previous_Drivers_License_Number_))),COUNT(__d3(__NN(Previous_Drivers_License_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dl_key_number',COUNT(__d3(__NL(Drivers_License_Key_Number_))),COUNT(__d3(__NN(Drivers_License_Key_Number_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','issuance',COUNT(__d3(__NL(Issuance_))),COUNT(__d3(__NN(Issuance_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','cdl_status',COUNT(__d3(__NL(C_D_L_Status_))),COUNT(__d3(__NN(C_D_L_Status_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','county_name',COUNT(__d3(__NL(County_))),COUNT(__d3(__NN(County_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','address_change',COUNT(__d3(__NL(Address_Change_))),COUNT(__d3(__NN(Address_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','name_change',COUNT(__d3(__NL(Name_Change_))),COUNT(__d3(__NN(Name_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','dob_change',COUNT(__d3(__NL(Date_Of_Birth_Change_))),COUNT(__d3(__NN(Date_Of_Birth_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_change',COUNT(__d3(__NL(Sex_Change_))),COUNT(__d3(__NN(Sex_Change_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','height',COUNT(__d3(__NL(Height_))),COUNT(__d3(__NN(Height_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','weight',COUNT(__d3(__NL(Weight_))),COUNT(__d3(__NN(Weight_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','race_name',COUNT(__d3(__NL(Race_))),COUNT(__d3(__NN(Race_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','race',COUNT(__d3(__NL(Race_Code_))),COUNT(__d3(__NN(Race_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_name',COUNT(__d3(__NL(Sex_))),COUNT(__d3(__NN(Sex_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','sex_flag',COUNT(__d3(__NL(Sex_Code_))),COUNT(__d3(__NN(Sex_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','hair_color_name',COUNT(__d3(__NL(Hair_Color_))),COUNT(__d3(__NN(Hair_Color_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','HairColorCode',COUNT(__d3(__NL(Hair_Color_Code_))),COUNT(__d3(__NN(Hair_Color_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','eye_color_name',COUNT(__d3(__NL(Eye_Color_))),COUNT(__d3(__NN(Eye_Color_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','EyeColorCode',COUNT(__d3(__NL(Eye_Color_Code_))),COUNT(__d3(__NN(Eye_Color_Code_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','orig_state_name',COUNT(__d3(__NL(State_Name_))),COUNT(__d3(__NN(State_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','history_name',COUNT(__d3(__NL(History_Name_))),COUNT(__d3(__NN(History_Name_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','history',COUNT(__d3(__NL(History_))),COUNT(__d3(__NN(History_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','source_code',COUNT(__d3(__NL(Source_))),COUNT(__d3(__NN(Source_)))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateFirstSeen',COUNT(__d3(Date_First_Seen_=0)),COUNT(__d3(Date_First_Seen_!=0))},
    {'DriversLicense','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateLastSeen',COUNT(__d3(Date_Last_Seen_=0)),COUNT(__d3(Date_Last_Seen_!=0))}]
