...
EXPORT LIB_BusinessSeleAttributes_Function(DATASET(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputBII) InputData,
	...
	BusinessSeleAttributes_Results := LIBRARY('PublicRecords_KEL.Library.LIB_BusinessSeleAttributes', PublicRecords_KEL.Library.LIB_BusinessSeleAttributes_Interface(InputData, FDCDataset, Options)).Results;
#else
	BusinessSeleAttributes_Results := PublicRecords_KEL.FnRoxie_GetBusinessSeleIDAttributes(InputData, FDCDataset, Options);
#end
