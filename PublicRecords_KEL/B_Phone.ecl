...
EXPORT B_Phone(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1924948 := __E_Phone;
  EXPORT __ST75420_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST75420_Layout __ND1925447__Project(E_Phone(__in,__cfg).Layout __PP1924674) := TRANSFORM
    ...
    SELF := __PP1924674;
  END;
  EXPORT __ENH_Phone := PROJECT(__EE1924948,__ND1925447__Project(LEFT));
END;
