...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE977431 := __ENH_Criminal_Offense_2;
  EXPORT __ST82955_Layout := RECORD
  ...
  END;
  EXPORT __ST82908_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST82955_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST82908_Layout __ND977980__Project(B_Criminal_Offense_2(__in,__cfg).__ST93118_Layout __PP976992) := TRANSFORM
    __EE977219 := __PP976992.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE977219),__ST82955_Layout),__NL(__EE977219));
    SELF := __PP976992;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE977431,__ND977980__Project(LEFT));
END;
