...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9223083 := __ENH_Criminal_Offense_2;
  EXPORT __ST203125_Layout := RECORD
  ...
  END;
  EXPORT __ST203078_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST203125_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST203078_Layout __ND9223088__Project(B_Criminal_Offense_2(__in,__cfg).__ST229040_Layout __PP9223084) := TRANSFORM
    __EE9223244 := __PP9223084.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE9223244),__ST203125_Layout),__NL(__EE9223244));
    SELF := __PP9223084;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE9223083,__ND9223088__Project(LEFT));
END;
