...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7568027 := __ENH_Criminal_Offense_2;
  EXPORT __ST180979_Layout := RECORD
  ...
  END;
  EXPORT __ST180932_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST180979_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180932_Layout __ND7568032__Project(B_Criminal_Offense_2(__in,__cfg).__ST203186_Layout __PP7568028) := TRANSFORM
    __EE7568188 := __PP7568028.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7568188),__ST180979_Layout),__NL(__EE7568188));
    SELF := __PP7568028;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7568027,__ND7568032__Project(LEFT));
END;
