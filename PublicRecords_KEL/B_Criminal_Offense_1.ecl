...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1581950 := __ENH_Criminal_Offense_2;
  EXPORT __ST110699_Layout := RECORD
  ...
  END;
  EXPORT __ST110652_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST110699_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST110652_Layout __ND1582492__Project(B_Criminal_Offense_2(__in,__cfg).__ST123613_Layout __PP1581516) := TRANSFORM
    __EE1581741 := __PP1581516.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE1581741),__ST110699_Layout),__NL(__EE1581741));
    SELF := __PP1581516;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1581950,__ND1582492__Project(LEFT));
END;
