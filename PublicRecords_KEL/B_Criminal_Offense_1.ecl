...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7558814 := __ENH_Criminal_Offense_2;
  EXPORT __ST180503_Layout := RECORD
  ...
  EXPORT __ST180456_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST180503_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180456_Layout __ND7558819__Project(B_Criminal_Offense_2(__in,__cfg).__ST202660_Layout __PP7558815) := TRANSFORM
    __EE7558975 := __PP7558815.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7558975),__ST180503_Layout),__NL(__EE7558975));
    SELF := __PP7558815;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7558814,__ND7558819__Project(LEFT));
END;
