...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE31309 := __ENH_Criminal_Offense_2;
  ...
  END;
  EXPORT __ST14099_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST14146_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST14099_Layout __ND31950__Project(B_Criminal_Offense_2(__in,__cfg).__ST15385_Layout __PP30867) := TRANSFORM
    __EE31098 := __PP30867.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE31098,__ST14146_Layout);
    SELF := __PP30867;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE31309,__ND31950__Project(LEFT));
END;
