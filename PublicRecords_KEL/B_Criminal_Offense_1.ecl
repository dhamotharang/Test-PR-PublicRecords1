...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7900098 := __ENH_Criminal_Offense_2;
  EXPORT __ST186375_Layout := RECORD
  ...
  END;
  EXPORT __ST186328_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST186375_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186328_Layout __ND7900103__Project(B_Criminal_Offense_2(__in,__cfg).__ST209277_Layout __PP7900099) := TRANSFORM
    __EE7900259 := __PP7900099.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7900259),__ST186375_Layout),__NL(__EE7900259));
    SELF := __PP7900099;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7900098,__ND7900103__Project(LEFT));
END;
