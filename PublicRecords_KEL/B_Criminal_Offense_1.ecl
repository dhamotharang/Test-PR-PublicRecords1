...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE9642946 := __ENH_Criminal_Offense_2;
  EXPORT __ST209553_Layout := RECORD
  ...
  END;
  EXPORT __ST209506_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST209553_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST209506_Layout __ND9642951__Project(B_Criminal_Offense_2(__in,__cfg).__ST235882_Layout __PP9642947) := TRANSFORM
    __EE9643107 := __PP9642947.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE9643107),__ST209553_Layout),__NL(__EE9643107));
    SELF := __PP9642947;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE9642946,__ND9642951__Project(LEFT));
END;
