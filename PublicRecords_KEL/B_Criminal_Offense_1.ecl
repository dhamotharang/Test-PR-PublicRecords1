...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2646196 := __ENH_Criminal_Offense_2;
  EXPORT __ST120115_Layout := RECORD
  ...
  END;
  EXPORT __ST120068_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST120115_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST120068_Layout __ND2646734__Project(B_Criminal_Offense_2(__in,__cfg).__ST132823_Layout __PP2645767) := TRANSFORM
    __EE2645992 := __PP2645767.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2645992,__ST120115_Layout);
    SELF := __PP2645767;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE2646196,__ND2646734__Project(LEFT));
END;
