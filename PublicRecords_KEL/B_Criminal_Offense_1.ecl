...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE37056 := __ENH_Criminal_Offense_2;
  EXPORT __ST18031_Layout := RECORD
  ...
  END;
  EXPORT __ST17984_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST18031_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17984_Layout __ND37697__Project(B_Criminal_Offense_2(__in,__cfg).__ST19733_Layout __PP36614) := TRANSFORM
    __EE36845 := __PP36614.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE36845,__ST18031_Layout);
    SELF := __PP36614;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE37056,__ND37697__Project(LEFT));
END;
