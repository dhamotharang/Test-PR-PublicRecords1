...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7943068 := __ENH_Criminal_Offense_2;
  EXPORT __ST187974_Layout := RECORD
  ...
  END;
  EXPORT __ST187927_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST187974_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST187927_Layout __ND7943073__Project(B_Criminal_Offense_2(__in,__cfg).__ST211020_Layout __PP7943069) := TRANSFORM
    __EE7943229 := __PP7943069.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7943229),__ST187974_Layout),__NL(__EE7943229));
    SELF := __PP7943069;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7943068,__ND7943073__Project(LEFT));
END;
