...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8618973 := __ENH_Criminal_Offense_2;
  EXPORT __ST198898_Layout := RECORD
  ...
  EXPORT __ST198851_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST198898_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST198851_Layout __ND8618978__Project(B_Criminal_Offense_2(__in,__cfg).__ST223055_Layout __PP8618974) := TRANSFORM
    __EE8619134 := __PP8618974.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8619134),__ST198898_Layout),__NL(__EE8619134));
    SELF := __PP8618974;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE8618973,__ND8618978__Project(LEFT));
END;
