...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7565634 := __ENH_Criminal_Offense_2;
  EXPORT __ST180426_Layout := RECORD
  ...
  END;
  EXPORT __ST180379_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST180426_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180379_Layout __ND7565639__Project(B_Criminal_Offense_2(__in,__cfg).__ST202521_Layout __PP7565635) := TRANSFORM
    __EE7565795 := __PP7565635.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7565795),__ST180426_Layout),__NL(__EE7565795));
    SELF := __PP7565635;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7565634,__ND7565639__Project(LEFT));
END;
