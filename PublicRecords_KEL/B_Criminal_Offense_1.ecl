...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE141964 := __ENH_Criminal_Offense_2;
  EXPORT __ST25710_Layout := RECORD
  ...
  END;
  EXPORT __ST25663_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST25710_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST25663_Layout __ND142613__Project(B_Criminal_Offense_2(__in,__cfg).__ST28457_Layout __PP141517) := TRANSFORM
    __EE141750 := __PP141517.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE141750,__ST25710_Layout);
    SELF := __PP141517;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE141964,__ND142613__Project(LEFT));
END;
