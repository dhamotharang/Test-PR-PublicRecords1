...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7943098 := __ENH_Criminal_Offense_2;
  ...
  END;
  EXPORT __ST187957_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST188004_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST187957_Layout __ND7943103__Project(B_Criminal_Offense_2(__in,__cfg).__ST211050_Layout __PP7943099) := TRANSFORM
    __EE7943259 := __PP7943099.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7943259),__ST188004_Layout),__NL(__EE7943259));
    SELF := __PP7943099;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7943098,__ND7943103__Project(LEFT));
END;
