...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7568022 := __ENH_Criminal_Offense_2;
  EXPORT __ST180974_Layout := RECORD
  ...
  END;
  EXPORT __ST180927_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST180974_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180927_Layout __ND7568027__Project(B_Criminal_Offense_2(__in,__cfg).__ST203181_Layout __PP7568023) := TRANSFORM
    __EE7568183 := __PP7568023.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7568183),__ST180974_Layout),__NL(__EE7568183));
    SELF := __PP7568023;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7568022,__ND7568027__Project(LEFT));
END;
