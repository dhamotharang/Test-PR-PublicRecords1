...
EXPORT B_Criminal_Offense_1(CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE8086508 := __ENH_Criminal_Offense_2;
  EXPORT __ST186885_Layout := RECORD
  ...
  END;
  EXPORT __ST186838_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST186885_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST186838_Layout __ND8086513__Project(B_Criminal_Offense_2(__cfg).__ST209671_Layout __PP8086509) := TRANSFORM
    __EE8086669 := __PP8086509.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE8086669),__ST186885_Layout),__NL(__EE8086669));
    SELF := __PP8086509;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE8086508,__ND8086513__Project(LEFT));
END;
