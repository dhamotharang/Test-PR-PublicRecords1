...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7275703 := __ENH_Criminal_Offense_2;
  EXPORT __ST184617_Layout := RECORD
  ...
  END;
  EXPORT __ST184570_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST184617_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST184570_Layout __ND7275708__Project(B_Criminal_Offense_2(__in,__cfg).__ST207164_Layout __PP7275704) := TRANSFORM
    __EE7275864 := __PP7275704.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7275864),__ST184617_Layout),__NL(__EE7275864));
    SELF := __PP7275704;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7275703,__ND7275708__Project(LEFT));
END;
