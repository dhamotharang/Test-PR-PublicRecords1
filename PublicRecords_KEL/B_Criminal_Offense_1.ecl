...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE60074 := __ENH_Criminal_Offense_2;
  EXPORT __ST22689_Layout := RECORD
  ...
  END;
  EXPORT __ST22642_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST22689_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST22642_Layout __ND60723__Project(B_Criminal_Offense_2(__in,__cfg).__ST25243_Layout __PP59627) := TRANSFORM
    __EE59860 := __PP59627.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE59860,__ST22689_Layout);
    SELF := __PP59627;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE60074,__ND60723__Project(LEFT));
END;
