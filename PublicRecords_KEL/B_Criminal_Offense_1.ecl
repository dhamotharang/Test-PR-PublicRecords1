...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE141965 := __ENH_Criminal_Offense_2;
  EXPORT __ST25711_Layout := RECORD
  ...
  END;
  EXPORT __ST25664_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST25711_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST25664_Layout __ND142614__Project(B_Criminal_Offense_2(__in,__cfg).__ST28458_Layout __PP141518) := TRANSFORM
    __EE141751 := __PP141518.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE141751,__ST25711_Layout);
    SELF := __PP141518;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE141965,__ND142614__Project(LEFT));
END;
