...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE42049 := __ENH_Criminal_Offense_2;
  EXPORT __ST19259_Layout := RECORD
  ...
  END;
  EXPORT __ST19212_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST19259_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST19212_Layout __ND42698__Project(B_Criminal_Offense_2(__in,__cfg).__ST21281_Layout __PP41602) := TRANSFORM
    __EE41835 := __PP41602.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE41835,__ST19259_Layout);
    SELF := __PP41602;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE42049,__ND42698__Project(LEFT));
END;
