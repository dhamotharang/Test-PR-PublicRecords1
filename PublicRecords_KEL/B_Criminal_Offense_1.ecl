...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE785363 := __ENH_Criminal_Offense_2;
  EXPORT __ST70777_Layout := RECORD
  ...
  END;
  EXPORT __ST70730_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST70777_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST70730_Layout __ND786008__Project(B_Criminal_Offense_2(__in,__cfg).__ST79896_Layout __PP784906) := TRANSFORM
    __EE785141 := __PP784906.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE785141),__ST70777_Layout),__NL(__EE785141));
    SELF := __PP784906;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE785363,__ND786008__Project(LEFT));
END;
