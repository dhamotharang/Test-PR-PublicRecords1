...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE192265 := __ENH_Criminal_Offense_2;
  EXPORT __ST31625_Layout := RECORD
  ...
  END;
  EXPORT __ST31578_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST31625_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST31578_Layout __ND192927__Project(B_Criminal_Offense_2(__in,__cfg).__ST34774_Layout __PP191808) := TRANSFORM
    __EE192043 := __PP191808.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE192043),__ST31625_Layout),__NL(__EE192043));
    SELF := __PP191808;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE192265,__ND192927__Project(LEFT));
END;
