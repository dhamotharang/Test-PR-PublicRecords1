...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE141393 := __ENH_Criminal_Offense_2;
  EXPORT __ST25482_Layout := RECORD
  ...
  END;
  EXPORT __ST25435_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST25482_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST25435_Layout __ND142042__Project(B_Criminal_Offense_2(__in,__cfg).__ST28215_Layout __PP140946) := TRANSFORM
    __EE141179 := __PP140946.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE141179,__ST25482_Layout);
    SELF := __PP140946;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE141393,__ND142042__Project(LEFT));
END;
