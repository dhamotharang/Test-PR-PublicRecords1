...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE138553 := __ENH_Criminal_Offense_2;
  EXPORT __ST25340_Layout := RECORD
  ...
  END;
  EXPORT __ST25293_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST25340_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST25293_Layout __ND139202__Project(B_Criminal_Offense_2(__in,__cfg).__ST27959_Layout __PP138106) := TRANSFORM
    __EE138339 := __PP138106.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE138339,__ST25340_Layout);
    SELF := __PP138106;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE138553,__ND139202__Project(LEFT));
END;
