...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7931489 := __ENH_Criminal_Offense_2;
  ...
  END;
  EXPORT __ST187640_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST187687_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST187640_Layout __ND7931494__Project(B_Criminal_Offense_2(__in,__cfg).__ST210713_Layout __PP7931490) := TRANSFORM
    __EE7931650 := __PP7931490.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE7931650),__ST187687_Layout),__NL(__EE7931650));
    SELF := __PP7931490;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE7931489,__ND7931494__Project(LEFT));
END;
