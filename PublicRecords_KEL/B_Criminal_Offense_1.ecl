...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE46674 := __ENH_Criminal_Offense_2;
  EXPORT __ST21581_Layout := RECORD
  ...
  END;
  EXPORT __ST21534_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST21581_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST21534_Layout __ND47323__Project(B_Criminal_Offense_2(__in,__cfg).__ST23824_Layout __PP46227) := TRANSFORM
    __EE46460 := __PP46227.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE46460,__ST21581_Layout);
    SELF := __PP46227;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE46674,__ND47323__Project(LEFT));
END;
