...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5366458 := __ENH_Criminal_Offense_2;
  EXPORT __ST140491_Layout := RECORD
  ...
  END;
  EXPORT __ST140444_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST140491_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST140444_Layout __ND5366463__Project(B_Criminal_Offense_2(__in,__cfg).__ST157384_Layout __PP5366459) := TRANSFORM
    __EE5366619 := __PP5366459.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE5366619),__ST140491_Layout),__NL(__EE5366619));
    SELF := __PP5366459;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE5366458,__ND5366463__Project(LEFT));
END;
