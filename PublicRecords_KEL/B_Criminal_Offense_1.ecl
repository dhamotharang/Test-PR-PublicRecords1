...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE788421 := __ENH_Criminal_Offense_2;
  EXPORT __ST71961_Layout := RECORD
  ...
  END;
  EXPORT __ST71914_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST71961_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST71914_Layout __ND789066__Project(B_Criminal_Offense_2(__in,__cfg).__ST81208_Layout __PP787964) := TRANSFORM
    __EE788199 := __PP787964.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE788199),__ST71961_Layout),__NL(__EE788199));
    SELF := __PP787964;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE788421,__ND789066__Project(LEFT));
END;
