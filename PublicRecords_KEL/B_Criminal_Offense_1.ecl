...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4968882 := __ENH_Criminal_Offense_2;
  EXPORT __ST147068_Layout := RECORD
  ...
  END;
  EXPORT __ST147021_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST147068_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST147021_Layout __ND4968887__Project(B_Criminal_Offense_2(__in,__cfg).__ST165071_Layout __PP4968883) := TRANSFORM
    __EE4969043 := __PP4968883.Offense_Charges_;
    SELF.Offense_Charges_ := __BN(PROJECT(__T(__EE4969043),__ST147068_Layout),__NL(__EE4969043));
    SELF := __PP4968883;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE4968882,__ND4968887__Project(LEFT));
END;
