...
EXPORT B_Input_P_I_I_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE366929 := __E_Input_P_I_I;
  ...
  END;
  SHARED __ST260642_Layout __ND5224279__Project(E_Input_P_I_I(__in,__cfg).Layout __PP366519) := TRANSFORM
    SELF.P___Inp_Addr_ := __OP2(IF(__T(__NT(__PP366519.P___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP366519.P___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP366519.P___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP366519.P___Inp_Addr_Line2_)));
    SELF := __PP366519;
  END;
  EXPORT __ENH_Input_P_I_I_9 := PROJECT(__EE366929,__ND5224279__Project(LEFT));
END;
