...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE12089721 := __ENH_Person;
  SHARED __EE12094466 := __EE12089721(__T(__OP2(__EE12089721.UID,=,__CN(__PLexID_in))));
  SHARED __ST121642_Layout := RECORD
  ...
  END;
  SHARED __ST121642_Layout __ND12094471__Project(B_Person(__in,__cfg_Local).__ST164640_Layout __PP12094467) := TRANSFORM
    SELF.Lex_I_D_ := __PP12094467.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP12094467.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF := __PP12094467;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12094466,__ND12094471__Project(LEFT)));
