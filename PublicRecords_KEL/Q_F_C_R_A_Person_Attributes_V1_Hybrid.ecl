...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11550059 := __ENH_Person;
  SHARED __EE11555076 := __EE11550059(__T(__OP2(__EE11550059.UID,=,__CN(__PLexID_in))));
  SHARED __ST124774_Layout := RECORD
  ...
  END;
  SHARED __ST124774_Layout __ND11555081__Project(B_Person(__in,__cfg_Local).__ST169030_Layout __PP11555077) := TRANSFORM
    SELF.Lex_I_D_ := __PP11555077.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP11555077.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Cnt_Ev_ := __PP11555077.P_L___Ver_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_List_Ev_ := __PP11555077.P_L___Ver_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Emrg_Dt_List_Ev_ := __PP11555077.P_L___Ver_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Last_Dt_List_Ev_ := __PP11555077.P_L___Ver_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Old_Dt_Ev_ := __PP11555077.P_L___Ver_Src_Old_Dt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_New_Dt_Ev_ := __PP11555077.P_L___Ver_Src_New_Dt_Ev_F_C_R_A_;
    SELF.P___Lex_I_D_Rstd_Only_Flag_ := __PP11555077.P___Lex_I_D_Rstd_Only_Flag_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Cnt_Ev_ := __PP11555077.P_L___Ver_Name_First_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_List_Ev_ := __PP11555077.P_L___Ver_Name_First_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_ := __PP11555077.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_ := __PP11555077.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Cnt_Ev_ := __PP11555077.P_L___Ver_Name_Last_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_List_Ev_ := __PP11555077.P_L___Ver_Name_Last_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_ := __PP11555077.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_ := __PP11555077.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Cnt_Ev_ := __PP11555077.P_L___Ver_S_S_N_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_List_Ev_ := __PP11555077.P_L___Ver_S_S_N_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_ := __PP11555077.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_ := __PP11555077.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF := __PP11555077;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11555076,__ND11555081__Project(LEFT)));
