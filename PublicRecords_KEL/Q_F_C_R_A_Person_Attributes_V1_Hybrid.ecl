...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  END;
  SHARED E_Person_Address_Filtered_1 := MODULE(E_Person_Address(__cfg_Local))
    SHARED __AsofFitler(DATASET(InLayout) __ds) := __ds(__T(__OP2(KEL.era.ToDateMinNull(__ds.Hybrid_Archive_Date_),<=,__CN(__PP_InpClnArchDt))));
    SHARED __UsingFitler(DATASET(InLayout) __ds) := __ds(KEL.Permits.BitAnd(__ds.__Permits,__PDPM) = __ds.__Permits);
    SHARED __SourceFilter(DATASET(InLayout) __ds) := __UsingFitler(__AsofFitler(__ds));
  ...
  SHARED E_Person_Offenses_Filtered_1 := MODULE(E_Person_Offenses(__cfg_Local))
    ...
    SHARED __GroupedFilter(GROUPED DATASET(InLayout) __ds) := JOIN(__ds,E_Person_Filtered_2.__PostFilter,__EEQP(LEFT.Subject_,RIGHT.UID),TRANSFORM(InLayout,SELF:=LEFT),HASH,GROUPED,KEEP(1));
  END;
  SHARED E_Person_Property_Filtered_1 := MODULE(E_Person_Property(__cfg_Local))
    SHARED __AsofFitler(DATASET(InLayout) __ds) := __ds(__T(__OP2(KEL.era.ToDateMinNull(__ds.Hybrid_Archive_Date_),<=,__CN(__PP_InpClnArchDt))));
    SHARED __UsingFitler(DATASET(InLayout) __ds) := __ds(KEL.Permits.BitAnd(__ds.__Permits,__PDPM) = __ds.__Permits);
    SHARED __SourceFilter(DATASET(InLayout) __ds) := __UsingFitler(__AsofFitler(__ds));
    SHARED __GroupedFilter(GROUPED DATASET(InLayout) __ds) := JOIN(__ds,E_Person_Filtered_2.__PostFilter,__EEQP(LEFT.Subject_,RIGHT.UID),TRANSFORM(InLayout,SELF:=LEFT),HASH,GROUPED,KEEP(1));
  ...
  SHARED E_Address_Filtered := MODULE(E_Address(__cfg_Local))
    ...
    SHARED __UsingFitler(DATASET(InLayout) __ds) := __ds(KEL.Permits.BitAnd(__ds.__Permits,__PDPM) = __ds.__Permits);
    SHARED __SourceFilter(DATASET(InLayout) __ds) := __UsingFitler(__AsofFitler(__ds));
    SHARED __GroupedFilter(GROUPED DATASET(InLayout) __ds) := JOIN(__ds,E_Person_Address_Filtered_1.__PostFilter,__EEQP(LEFT.UID,RIGHT.Location_),TRANSFORM(InLayout,SELF:=LEFT),HASH,GROUPED,KEEP(1));
  END;
  ...
  SHARED E_Inquiry_Filtered := MODULE(E_Inquiry(__cfg_Local))
    ...
    SHARED __UsingFitler(DATASET(InLayout) __ds) := __ds(KEL.Permits.BitAnd(__ds.__Permits,__PDPM) = __ds.__Permits);
    SHARED __SourceFilter(DATASET(InLayout) __ds) := __UsingFitler(__AsofFitler(__ds));
    SHARED __GroupedFilter(GROUPED DATASET(InLayout) __ds) := JOIN(__ds,E_Person_Inquiry_Filtered_1.__PostFilter,__EEQP(LEFT.UID,RIGHT.Transaction_),TRANSFORM(InLayout,SELF:=LEFT),HASH,GROUPED,KEEP(1));
  END;
  ...
  SHARED E_Property_Filtered := MODULE(E_Property(__cfg_Local))
    ...
    SHARED __UsingFitler(DATASET(InLayout) __ds) := __ds(KEL.Permits.BitAnd(__ds.__Permits,__PDPM) = __ds.__Permits);
    SHARED __SourceFilter(DATASET(InLayout) __ds) := __UsingFitler(__AsofFitler(__ds));
    SHARED __GroupedFilter(GROUPED DATASET(InLayout) __ds) := JOIN(__ds,E_Person_Property_Filtered_1.__PostFilter,__EEQP(LEFT.UID,RIGHT.Prop_),TRANSFORM(InLayout,SELF:=LEFT),HASH,GROUPED,KEEP(1));
  END;
  ...
  SHARED __EE12804959 := __ENH_Person;
  SHARED __EE12809976 := __EE12804959(__T(__OP2(__EE12804959.UID,=,__CN(__PLexID_in))));
  SHARED __ST126102_Layout := RECORD
  ...
  END;
  SHARED __ST126102_Layout __ND12809981__Project(B_Person(__cfg_Local).__ST170352_Layout __PP12809977) := TRANSFORM
    SELF.Lex_I_D_ := __PP12809977.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP12809977.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Cnt_Ev_ := __PP12809977.P_L___Ver_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_List_Ev_ := __PP12809977.P_L___Ver_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Emrg_Dt_List_Ev_ := __PP12809977.P_L___Ver_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Last_Dt_List_Ev_ := __PP12809977.P_L___Ver_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_Old_Dt_Ev_ := __PP12809977.P_L___Ver_Src_Old_Dt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Src_New_Dt_Ev_ := __PP12809977.P_L___Ver_Src_New_Dt_Ev_F_C_R_A_;
    SELF.P___Lex_I_D_Rstd_Only_Flag_ := __PP12809977.P___Lex_I_D_Rstd_Only_Flag_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Cnt_Ev_ := __PP12809977.P_L___Ver_Name_First_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_List_Ev_ := __PP12809977.P_L___Ver_Name_First_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_ := __PP12809977.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_ := __PP12809977.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Cnt_Ev_ := __PP12809977.P_L___Ver_Name_Last_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_List_Ev_ := __PP12809977.P_L___Ver_Name_Last_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_ := __PP12809977.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_ := __PP12809977.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Cnt_Ev_ := __PP12809977.P_L___Ver_S_S_N_Src_Cnt_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_List_Ev_ := __PP12809977.P_L___Ver_S_S_N_Src_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_ := __PP12809977.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_F_C_R_A_;
    SELF.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_ := __PP12809977.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_F_C_R_A_;
    SELF := __PP12809977;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE12809976,__ND12809981__Project(LEFT)));
