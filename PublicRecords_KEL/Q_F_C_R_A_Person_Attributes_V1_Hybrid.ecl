...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11578899 := __ENH_Person;
  SHARED __EE11583476 := __EE11578899(__T(__OP2(__EE11578899.UID,=,__CN(__PLexID_in))));
  SHARED __ST121183_Layout := RECORD
  ...
  END;
  SHARED __ST121183_Layout __ND11583481__Project(B_Person(__in,__cfg_Local).__ST164109_Layout __PP11583477) := TRANSFORM
    SELF.Lex_I_D_ := __PP11583477.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP11583477.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF := __PP11583477;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11583476,__ND11583481__Project(LEFT)));
