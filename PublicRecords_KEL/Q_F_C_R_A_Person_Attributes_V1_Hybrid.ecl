...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Hybrid(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE11589111 := __ENH_Person;
  SHARED __EE11593688 := __EE11589111(__T(__OP2(__EE11589111.UID,=,__CN(__PLexID_in))));
  SHARED __ST121542_Layout := RECORD
  ...
  END;
  SHARED __ST121542_Layout __ND11593693__Project(B_Person(__in,__cfg_Local).__ST164577_Layout __PP11593689) := TRANSFORM
    SELF.Lex_I_D_ := __PP11593689.UID;
    ...
    SELF.P_L___Email_Cnt_Ev_ := __PP11593689.P_L___Email_Cnt_Ev_F_C_R_A_;
    SELF := __PP11593689;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE11593688,__ND11593693__Project(LEFT)));
