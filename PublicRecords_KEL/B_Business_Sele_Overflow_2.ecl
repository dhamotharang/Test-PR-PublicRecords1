...
EXPORT B_Business_Sele_Overflow_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6802954 := __ENH_Business_Sele_Overflow_3;
  SHARED __EE6802957 := __EE6802954;
  SHARED __ST1521744_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __ST1521744_Layout __JT6802968(B_Business_Sele_Overflow_3(__in,__cfg).__ST227451_Layout __l, B_Business_Sele_Overflow_3(__in,__cfg).__ST113386_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE6802969 := NORMALIZE(__EE6802957,__T(LEFT.S_O_S_Domestic_States_),__JT6802968(LEFT,RIGHT));
  SHARED __ST1521912_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC6803103(__ST1521744_Layout __EE6802969, B_Business_Sele_Overflow_3(__in,__cfg).__ST113375_Layout __EE6803090) := __T(__OP2(__EE6802969.S_O_S_Incorporation_State_,=,__EE6803090.S_O_S_Incorporation_State_));
  __ST1521912_Layout __JT6803103(__ST1521744_Layout __l, B_Business_Sele_Overflow_3(__in,__cfg).__ST113375_Layout __r) := TRANSFORM, SKIP(NOT(__JC6803103(__l,__r)))
    ...
    SELF := __r;
  END;
  SHARED __EE6803104 := NORMALIZE(__EE6802969,__T(LEFT.S_O_S_Foreign_States_),__JT6803103(LEFT,RIGHT));
  SHARED __ST1521330_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr S_O_S_Incorporation_State_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE6803238 := PROJECT(__EE6803104,TRANSFORM(__ST1521330_Layout,SELF.S_O_S_Incorporation_State_ := LEFT.S_O_S_Incorporation_State__1_,SELF := LEFT));
  SHARED __ST1521349_Layout := RECORD
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE6804375 := PROJECT(__CLEANANDDO(__EE6803238,TABLE(__EE6803238,{KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),KEL.typ.int C_O_U_N_T___S_O_S_Foreign_States_ := COUNT(GROUP),UID},UID,MERGE)),__ST1521349_Layout);
  SHARED __ST1522078_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC6803259(B_Business_Sele_Overflow_3(__in,__cfg).__ST227451_Layout __EE6802954, __ST1521349_Layout __EE6804375) := __EEQP(__EE6802954.UID,__EE6804375.UID);
  __ST1522078_Layout __JT6803259(B_Business_Sele_Overflow_3(__in,__cfg).__ST227451_Layout __l, __ST1521349_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE6803260 := JOIN(__EE6802954,__EE6804375,__JC6803259(LEFT,RIGHT),__JT6803259(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST210809_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST210782_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Company_Types_Layout) S_O_S_Company_Types_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Registered_Agents_Layout) S_O_S_Registered_Agents_;
    KEL.typ.ndataset(__ST210809_Layout) S_O_S_Statuses_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Incorporation_Details_Layout) S_O_S_Incorporation_Details_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Charter_Numbers_Layout) S_O_S_Charter_Numbers_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Term_Exist_Codes_Layout) S_O_S_Term_Exist_Codes_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).Government_Debarred_Layout) Government_Debarred_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST210782_Layout __ND6804250__Project(__ST1522078_Layout __PP6803261) := TRANSFORM
    __EE6803514 := __PP6803261.S_O_S_Statuses_;
    __ST210809_Layout __ND6803519__Project(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Statuses_Layout __PP6803515) := TRANSFORM
      ...
      SELF.Days_Since_Status_ := __FN2(KEL.Routines.MonthsBetween,__PP6803515.S_O_S_Process_Date_,__CC13277);
      SELF := __PP6803515;
    END;
    SELF.S_O_S_Statuses_ := __PROJECT(__EE6803514,__ND6803519__Project(LEFT));
    SELF.S_O_S_Filing_States_Count_Dups_ := __PP6803261.C_O_U_N_T___S_O_S_Foreign_States_;
    SELF.S_O_S_Incorporation_New_Date_ := KEL.Routines.MaxN(__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Dom_Filing_Max_Date_),__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Frgn_Filing_Max_Date_));
    __CC13586 := '-99997';
    SELF.S_O_S_Incorporation_Old_Date_ := IF(__T(__OP2(__CAST(KEL.typ.str,KEL.Routines.MinN(__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Frgn_Filing_Min_Date_))),=,__CN(__CC13586))),__ECAST(KEL.typ.nint,KEL.Routines.MaxN(__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Frgn_Filing_Min_Date_))),__ECAST(KEL.typ.nint,KEL.Routines.MinN(__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP6803261.S_O_S_Frgn_Filing_Min_Date_))));
    SELF := __PP6803261;
  END;
  EXPORT __ENH_Business_Sele_Overflow_2 := PROJECT(__EE6803260,__ND6804250__Project(LEFT));
END;
