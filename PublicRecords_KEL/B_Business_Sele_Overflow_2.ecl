...
EXPORT B_Business_Sele_Overflow_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE7273531 := __ENH_Business_Sele_Overflow_3;
  SHARED __EE7273534 := __EE7273531;
  SHARED __ST1614949_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __ST1614949_Layout __JT7273545(B_Business_Sele_Overflow_3(__in,__cfg).__ST238343_Layout __l, B_Business_Sele_Overflow_3(__in,__cfg).__ST120164_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE7273546 := NORMALIZE(__EE7273534,__T(LEFT.S_O_S_Domestic_States_),__JT7273545(LEFT,RIGHT));
  SHARED __ST1615117_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC7273680(__ST1614949_Layout __EE7273546, B_Business_Sele_Overflow_3(__in,__cfg).__ST120153_Layout __EE7273667) := __T(__OP2(__EE7273546.S_O_S_Incorporation_State_,=,__EE7273667.S_O_S_Incorporation_State_));
  __ST1615117_Layout __JT7273680(__ST1614949_Layout __l, B_Business_Sele_Overflow_3(__in,__cfg).__ST120153_Layout __r) := TRANSFORM, SKIP(NOT(__JC7273680(__l,__r)))
    ...
    SELF := __r;
  END;
  SHARED __EE7273681 := NORMALIZE(__EE7273546,__T(LEFT.S_O_S_Foreign_States_),__JT7273680(LEFT,RIGHT));
  SHARED __ST1614535_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr S_O_S_Incorporation_State_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE7273815 := PROJECT(__EE7273681,TRANSFORM(__ST1614535_Layout,SELF.S_O_S_Incorporation_State_ := LEFT.S_O_S_Incorporation_State__1_,SELF := LEFT));
  SHARED __ST1614554_Layout := RECORD
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE7274952 := PROJECT(__CLEANANDDO(__EE7273815,TABLE(__EE7273815,{KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),KEL.typ.int C_O_U_N_T___S_O_S_Foreign_States_ := COUNT(GROUP),UID},UID,MERGE)),__ST1614554_Layout);
  SHARED __ST1615283_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC7273836(B_Business_Sele_Overflow_3(__in,__cfg).__ST238343_Layout __EE7273531, __ST1614554_Layout __EE7274952) := __EEQP(__EE7273531.UID,__EE7274952.UID);
  __ST1615283_Layout __JT7273836(B_Business_Sele_Overflow_3(__in,__cfg).__ST238343_Layout __l, __ST1614554_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE7273837 := JOIN(__EE7273531,__EE7274952,__JC7273836(LEFT,RIGHT),__JT7273836(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST221341_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ST221314_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    ...
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Company_Types_Layout) S_O_S_Company_Types_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Registered_Agents_Layout) S_O_S_Registered_Agents_;
    KEL.typ.ndataset(__ST221341_Layout) S_O_S_Statuses_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Incorporation_Details_Layout) S_O_S_Incorporation_Details_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Charter_Numbers_Layout) S_O_S_Charter_Numbers_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Term_Exist_Codes_Layout) S_O_S_Term_Exist_Codes_;
    KEL.typ.ndataset(E_Business_Sele_Overflow(__in,__cfg).Government_Debarred_Layout) Government_Debarred_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST221314_Layout __ND7274827__Project(__ST1615283_Layout __PP7273838) := TRANSFORM
    __EE7274091 := __PP7273838.S_O_S_Statuses_;
    __ST221341_Layout __ND7274096__Project(E_Business_Sele_Overflow(__in,__cfg).S_O_S_Statuses_Layout __PP7274092) := TRANSFORM
      ...
      SELF.Days_Since_Status_ := __FN2(KEL.Routines.MonthsBetween,__PP7274092.S_O_S_Process_Date_,__CC13394);
      SELF := __PP7274092;
    END;
    SELF.S_O_S_Statuses_ := __PROJECT(__EE7274091,__ND7274096__Project(LEFT));
    SELF.S_O_S_Filing_States_Count_Dups_ := __PP7273838.C_O_U_N_T___S_O_S_Foreign_States_;
    SELF.S_O_S_Incorporation_New_Date_ := KEL.Routines.MaxN(__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Dom_Filing_Max_Date_),__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Frgn_Filing_Max_Date_));
    __CC13703 := '-99997';
    SELF.S_O_S_Incorporation_Old_Date_ := IF(__T(__OP2(__CAST(KEL.typ.str,KEL.Routines.MinN(__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Frgn_Filing_Min_Date_))),=,__CN(__CC13703))),__ECAST(KEL.typ.nint,KEL.Routines.MaxN(__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Frgn_Filing_Min_Date_))),__ECAST(KEL.typ.nint,KEL.Routines.MinN(__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Dom_Filing_Min_Date_),__ECAST(KEL.typ.nint,__PP7273838.S_O_S_Frgn_Filing_Min_Date_))));
    SELF := __PP7273838;
  END;
  EXPORT __ENH_Business_Sele_Overflow_2 := PROJECT(__EE7273837,__ND7274827__Project(LEFT));
END;
