...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE269602 := __ENH_U_C_C_9;
  EXPORT __ST168252_Layout := RECORD
  ...
  END;
  EXPORT __ST168248_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST168252_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168248_Layout __ND269863__Project(B_U_C_C_9(__in,__cfg).__ST169117_Layout __PP269344) := TRANSFORM
    __EE269413 := __PP269344.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE269413),__ST168252_Layout),__NL(__EE269413));
    SELF := __PP269344;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE269602,__ND269863__Project(LEFT));
END;
