...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5592736 := __ENH_U_C_C_9;
  EXPORT __ST276345_Layout := RECORD
  ...
  EXPORT __ST276341_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST276345_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST276341_Layout __ND5592741__Project(B_U_C_C_9(__in,__cfg).__ST278186_Layout __PP5592737) := TRANSFORM
    __EE5592776 := __PP5592737.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5592776),__ST276345_Layout),__NL(__EE5592776));
    SELF := __PP5592737;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5592736,__ND5592741__Project(LEFT));
END;
