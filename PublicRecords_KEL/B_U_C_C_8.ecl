...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4816978 := __ENH_U_C_C_9;
  EXPORT __ST252954_Layout := RECORD
  ...
  END;
  EXPORT __ST252950_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST252954_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST252950_Layout __ND4816983__Project(B_U_C_C_9(__in,__cfg).__ST254759_Layout __PP4816979) := TRANSFORM
    __EE4817018 := __PP4816979.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4817018),__ST252954_Layout),__NL(__EE4817018));
    SELF := __PP4816979;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4816978,__ND4816983__Project(LEFT));
END;
