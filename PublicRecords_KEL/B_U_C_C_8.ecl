...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3520474 := __ENH_U_C_C_9;
  EXPORT __ST197496_Layout := RECORD
  ...
  END;
  EXPORT __ST197492_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST197496_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST197492_Layout __ND3520479__Project(B_U_C_C_9(__in,__cfg).__ST198663_Layout __PP3520475) := TRANSFORM
    __EE3520514 := __PP3520475.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3520514),__ST197496_Layout),__NL(__EE3520514));
    SELF := __PP3520475;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE3520474,__ND3520479__Project(LEFT));
END;
