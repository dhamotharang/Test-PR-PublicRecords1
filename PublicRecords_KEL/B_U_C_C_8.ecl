...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6512200 := __ENH_U_C_C_9;
  EXPORT __ST291957_Layout := RECORD
  ...
  END;
  EXPORT __ST291953_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST291957_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST291953_Layout __ND6512205__Project(B_U_C_C_9(__in,__cfg).__ST293609_Layout __PP6512201) := TRANSFORM
    __EE6512240 := __PP6512201.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6512240),__ST291957_Layout),__NL(__EE6512240));
    SELF := __PP6512201;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE6512200,__ND6512205__Project(LEFT));
END;
