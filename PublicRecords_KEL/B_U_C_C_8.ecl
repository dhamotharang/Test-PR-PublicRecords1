...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5054391 := __ENH_U_C_C_9;
  ...
  END;
  EXPORT __ST260758_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST260762_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260758_Layout __ND5054396__Project(B_U_C_C_9(__in,__cfg).__ST262590_Layout __PP5054392) := TRANSFORM
    __EE5054431 := __PP5054392.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5054431),__ST260762_Layout),__NL(__EE5054431));
    SELF := __PP5054392;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5054391,__ND5054396__Project(LEFT));
END;
