...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5442990 := __ENH_U_C_C_9;
  EXPORT __ST273303_Layout := RECORD
  ...
  END;
  EXPORT __ST273299_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST273303_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST273299_Layout __ND5442995__Project(B_U_C_C_9(__in,__cfg).__ST275142_Layout __PP5442991) := TRANSFORM
    __EE5443030 := __PP5442991.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5443030),__ST273303_Layout),__NL(__EE5443030));
    SELF := __PP5442991;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5442990,__ND5442995__Project(LEFT));
END;
