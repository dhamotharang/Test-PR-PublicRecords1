...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5458671 := __ENH_U_C_C_9;
  EXPORT __ST268050_Layout := RECORD
  ...
  END;
  EXPORT __ST268046_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST268050_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST268046_Layout __ND5458676__Project(B_U_C_C_9(__in,__cfg).__ST269889_Layout __PP5458672) := TRANSFORM
    __EE5458711 := __PP5458672.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5458711),__ST268050_Layout),__NL(__EE5458711));
    SELF := __PP5458672;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5458671,__ND5458676__Project(LEFT));
END;
