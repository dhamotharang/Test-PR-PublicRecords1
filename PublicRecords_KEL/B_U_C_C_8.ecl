...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4814870 := __ENH_U_C_C_9;
  ...
  END;
  EXPORT __ST252487_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST252491_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST252487_Layout __ND4814875__Project(B_U_C_C_9(__in,__cfg).__ST254296_Layout __PP4814871) := TRANSFORM
    __EE4814910 := __PP4814871.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4814910),__ST252491_Layout),__NL(__EE4814910));
    SELF := __PP4814871;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4814870,__ND4814875__Project(LEFT));
END;
