...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE280991 := __ENH_U_C_C_9;
  EXPORT __ST169105_Layout := RECORD
  ...
  END;
  EXPORT __ST169101_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST169105_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169101_Layout __ND281252__Project(B_U_C_C_9(__in,__cfg).__ST170132_Layout __PP280733) := TRANSFORM
    __EE280802 := __PP280733.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE280802),__ST169105_Layout),__NL(__EE280802));
    SELF := __PP280733;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE280991,__ND281252__Project(LEFT));
END;
