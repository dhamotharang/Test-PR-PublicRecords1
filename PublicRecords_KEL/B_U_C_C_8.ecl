...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4809593 := __ENH_U_C_C_9;
  EXPORT __ST252457_Layout := RECORD
  ...
  END;
  EXPORT __ST252453_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST252457_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST252453_Layout __ND4809598__Project(B_U_C_C_9(__in,__cfg).__ST254262_Layout __PP4809594) := TRANSFORM
    __EE4809633 := __PP4809594.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4809633),__ST252457_Layout),__NL(__EE4809633));
    SELF := __PP4809594;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4809593,__ND4809598__Project(LEFT));
END;
