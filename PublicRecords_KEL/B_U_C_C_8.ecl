...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4815557 := __ENH_U_C_C_9;
  EXPORT __ST252299_Layout := RECORD
  ...
  END;
  EXPORT __ST252295_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST252299_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST252295_Layout __ND4815562__Project(B_U_C_C_9(__in,__cfg).__ST254104_Layout __PP4815558) := TRANSFORM
    __EE4815597 := __PP4815558.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4815597),__ST252299_Layout),__NL(__EE4815597));
    SELF := __PP4815558;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4815557,__ND4815562__Project(LEFT));
END;
