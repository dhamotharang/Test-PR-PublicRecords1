...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6157523 := __ENH_U_C_C_9;
  EXPORT __ST285783_Layout := RECORD
  ...
  END;
  EXPORT __ST285779_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST285783_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST285779_Layout __ND6157528__Project(B_U_C_C_9(__in,__cfg).__ST287722_Layout __PP6157524) := TRANSFORM
    __EE6157563 := __PP6157524.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE6157563),__ST285783_Layout),__NL(__EE6157563));
    SELF := __PP6157524;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE6157523,__ND6157528__Project(LEFT));
END;
