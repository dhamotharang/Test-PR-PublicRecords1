...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4817836 := __ENH_U_C_C_9;
  EXPORT __ST252974_Layout := RECORD
  ...
  END;
  EXPORT __ST252970_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST252974_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST252970_Layout __ND4817841__Project(B_U_C_C_9(__in,__cfg).__ST254779_Layout __PP4817837) := TRANSFORM
    __EE4817876 := __PP4817837.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4817876),__ST252974_Layout),__NL(__EE4817876));
    SELF := __PP4817837;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4817836,__ND4817841__Project(LEFT));
END;
