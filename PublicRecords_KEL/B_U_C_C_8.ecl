...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5503098 := __ENH_U_C_C_9;
  EXPORT __ST274705_Layout := RECORD
  ...
  EXPORT __ST274701_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST274705_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST274701_Layout __ND5503103__Project(B_U_C_C_9(__in,__cfg).__ST276544_Layout __PP5503099) := TRANSFORM
    __EE5503138 := __PP5503099.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5503138),__ST274705_Layout),__NL(__EE5503138));
    SELF := __PP5503099;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5503098,__ND5503103__Project(LEFT));
END;
