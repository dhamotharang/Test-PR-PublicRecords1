...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4658615 := __ENH_U_C_C_9;
  EXPORT __ST256860_Layout := RECORD
  ...
  END;
  EXPORT __ST256856_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST256860_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256856_Layout __ND4658620__Project(B_U_C_C_9(__in,__cfg).__ST258687_Layout __PP4658616) := TRANSFORM
    __EE4658655 := __PP4658616.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE4658655),__ST256860_Layout),__NL(__EE4658655));
    SELF := __PP4658616;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE4658615,__ND4658620__Project(LEFT));
END;
