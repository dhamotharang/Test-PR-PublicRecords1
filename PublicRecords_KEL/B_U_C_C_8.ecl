...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5431321 := __ENH_U_C_C_9;
  EXPORT __ST266460_Layout := RECORD
  ...
  EXPORT __ST266456_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST266460_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST266456_Layout __ND5431326__Project(B_U_C_C_9(__in,__cfg).__ST268293_Layout __PP5431322) := TRANSFORM
    __EE5431361 := __PP5431322.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5431361),__ST266460_Layout),__NL(__EE5431361));
    SELF := __PP5431322;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5431321,__ND5431326__Project(LEFT));
END;
