...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5078779 := __ENH_U_C_C_9;
  EXPORT __ST262444_Layout := RECORD
  ...
  EXPORT __ST262440_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST262444_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST262440_Layout __ND5078784__Project(B_U_C_C_9(__in,__cfg).__ST264276_Layout __PP5078780) := TRANSFORM
    __EE5078819 := __PP5078780.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5078819),__ST262444_Layout),__NL(__EE5078819));
    SELF := __PP5078780;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE5078779,__ND5078784__Project(LEFT));
END;
