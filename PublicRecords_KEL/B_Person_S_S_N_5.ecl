...
EXPORT B_Person_S_S_N_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6698596 := __ENH_Person_S_S_N_6;
  EXPORT __ST332762_Layout := RECORD
  ...
  END;
  EXPORT __ST332754_Layout := RECORD
    KEL.typ.ntyp(E_Person().Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number().Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N(__in,__cfg).Valid_S_S_N_Layout) Valid_S_S_N_;
    KEL.typ.ndataset(__ST332762_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST332754_Layout __ND6698601__Project(B_Person_S_S_N_6(__in,__cfg).__ST332711_Layout __PP6698597) := TRANSFORM
    __EE6698616 := __PP6698597.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE6698616),__ST332762_Layout),__NL(__EE6698616));
    SELF := __PP6698597;
  END;
  EXPORT __ENH_Person_S_S_N_5 := PROJECT(__EE6698596,__ND6698601__Project(LEFT));
END;
