...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE433067 := __E_Criminal_Offense;
  ...
  END;
  EXPORT __ST264596_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST264643_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264596_Layout __ND433699__Project(E_Criminal_Offense(__in,__cfg).Layout __PP432662) := TRANSFORM
    __EE432887 := __PP432662.Offense_Charges_;
    __ST264643_Layout __ND433322__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP433318) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP433318.Date_First_Seen_);
      SELF := __PP433318;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE432887,__ND433322__Project(LEFT));
    SELF := __PP432662;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE433067,__ND433699__Project(LEFT));
END;
