...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE436431 := __E_Criminal_Offense;
  EXPORT __ST267529_Layout := RECORD
  ...
  END;
  EXPORT __ST267482_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST267529_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST267482_Layout __ND437063__Project(E_Criminal_Offense(__in,__cfg).Layout __PP436026) := TRANSFORM
    __EE436251 := __PP436026.Offense_Charges_;
    __ST267529_Layout __ND436686__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP436682) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP436682.Date_First_Seen_);
      SELF := __PP436682;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE436251,__ND436686__Project(LEFT));
    SELF := __PP436026;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE436431,__ND437063__Project(LEFT));
END;
