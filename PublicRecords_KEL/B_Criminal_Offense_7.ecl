...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE432728 := __E_Criminal_Offense;
  ...
  END;
  EXPORT __ST264294_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST264341_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST264294_Layout __ND433360__Project(E_Criminal_Offense(__in,__cfg).Layout __PP432323) := TRANSFORM
    __EE432548 := __PP432323.Offense_Charges_;
    __ST264341_Layout __ND432983__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP432979) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP432979.Date_First_Seen_);
      SELF := __PP432979;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE432548,__ND432983__Project(LEFT));
    SELF := __PP432323;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE432728,__ND433360__Project(LEFT));
END;
