...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3711454 := __ENH_U_C_C_5;
  EXPORT __ST192378_Layout := RECORD
  ...
  EXPORT __ST192374_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST192378_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192374_Layout __ND3711642__Project(B_U_C_C_5(__in,__cfg).__ST197615_Layout __PP3711455) := TRANSFORM
    __EE3711496 := __PP3711455.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3711496),__ST192378_Layout),__NL(__EE3711496));
    SELF.Terminated_Filing_ := __OP2(__PP3711455.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP3711455;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE3711454,__ND3711642__Project(LEFT));
END;
