...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3724101 := __ENH_U_C_C_5;
  EXPORT __ST195059_Layout := RECORD
  ...
  END;
  EXPORT __ST195055_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST195059_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195055_Layout __ND3724289__Project(B_U_C_C_5(__in,__cfg).__ST200292_Layout __PP3724102) := TRANSFORM
    __EE3724143 := __PP3724102.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3724143),__ST195059_Layout),__NL(__EE3724143));
    SELF.Terminated_Filing_ := __OP2(__PP3724102.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP3724102;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE3724101,__ND3724289__Project(LEFT));
END;
