...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5776365 := __ENH_U_C_C_5;
  EXPORT __ST249140_Layout := RECORD
  ...
  EXPORT __ST249136_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST249140_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249136_Layout __ND5776603__Project(B_U_C_C_5(__in,__cfg).__ST255626_Layout __PP5776366) := TRANSFORM
    __EE5776407 := __PP5776366.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5776407),__ST249140_Layout),__NL(__EE5776407));
    SELF.Terminated_Filing_ := __OP2(__PP5776366.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5776366;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5776365,__ND5776603__Project(LEFT));
END;
