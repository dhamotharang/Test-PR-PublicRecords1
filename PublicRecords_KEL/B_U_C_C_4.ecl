...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5920334 := __ENH_U_C_C_5;
  EXPORT __ST258909_Layout := RECORD
  ...
  END;
  EXPORT __ST258905_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258909_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258905_Layout __ND5920572__Project(B_U_C_C_5(__in,__cfg).__ST265501_Layout __PP5920335) := TRANSFORM
    __EE5920376 := __PP5920335.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5920376),__ST258909_Layout),__NL(__EE5920376));
    SELF.Terminated_Filing_ := __OP2(__PP5920335.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5920335;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5920334,__ND5920572__Project(LEFT));
END;
