...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5135224 := __ENH_U_C_C_5;
  EXPORT __ST237019_Layout := RECORD
  ...
  END;
  EXPORT __ST237015_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST237019_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST237015_Layout __ND5135462__Project(B_U_C_C_5(__in,__cfg).__ST243131_Layout __PP5135225) := TRANSFORM
    __EE5135266 := __PP5135225.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5135266),__ST237019_Layout),__NL(__EE5135266));
    SELF.Terminated_Filing_ := __OP2(__PP5135225.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5135225;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5135224,__ND5135462__Project(LEFT));
END;
