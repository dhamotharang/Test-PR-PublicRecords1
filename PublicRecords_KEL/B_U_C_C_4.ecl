...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5835525 := __ENH_U_C_C_5;
  EXPORT __ST251923_Layout := RECORD
  ...
  END;
  EXPORT __ST251919_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST251923_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251919_Layout __ND5835763__Project(B_U_C_C_5(__in,__cfg).__ST258409_Layout __PP5835526) := TRANSFORM
    __EE5835567 := __PP5835526.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5835567),__ST251923_Layout),__NL(__EE5835567));
    SELF.Terminated_Filing_ := __OP2(__PP5835526.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5835526;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5835525,__ND5835763__Project(LEFT));
END;
