...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5434250 := __ENH_U_C_C_5;
  EXPORT __ST245858_Layout := RECORD
  ...
  END;
  EXPORT __ST245854_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST245858_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245854_Layout __ND5434488__Project(B_U_C_C_5(__in,__cfg).__ST252228_Layout __PP5434251) := TRANSFORM
    __EE5434292 := __PP5434251.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5434292),__ST245858_Layout),__NL(__EE5434292));
    SELF.Terminated_Filing_ := __OP2(__PP5434251.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5434251;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5434250,__ND5434488__Project(LEFT));
END;
