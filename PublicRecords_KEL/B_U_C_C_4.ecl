...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5777951 := __ENH_U_C_C_5;
  EXPORT __ST249110_Layout := RECORD
  ...
  END;
  EXPORT __ST249106_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST249110_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST249106_Layout __ND5778189__Project(B_U_C_C_5(__in,__cfg).__ST255596_Layout __PP5777952) := TRANSFORM
    __EE5777993 := __PP5777952.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5777993),__ST249110_Layout),__NL(__EE5777993));
    SELF.Terminated_Filing_ := __OP2(__PP5777952.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5777952;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5777951,__ND5778189__Project(LEFT));
END;
