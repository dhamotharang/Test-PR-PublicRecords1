...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5426506 := __ENH_U_C_C_5;
  EXPORT __ST245452_Layout := RECORD
  ...
  END;
  EXPORT __ST245448_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST245452_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST245448_Layout __ND5426744__Project(B_U_C_C_5(__in,__cfg).__ST251810_Layout __PP5426507) := TRANSFORM
    __EE5426548 := __PP5426507.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5426548),__ST245452_Layout),__NL(__EE5426548));
    SELF.Terminated_Filing_ := __OP2(__PP5426507.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5426507;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5426506,__ND5426744__Project(LEFT));
END;
