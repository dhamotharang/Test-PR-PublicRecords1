...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5249929 := __ENH_U_C_C_5;
  EXPORT __ST237545_Layout := RECORD
  ...
  END;
  EXPORT __ST237541_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST237545_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST237541_Layout __ND5250167__Project(B_U_C_C_5(__in,__cfg).__ST243657_Layout __PP5249930) := TRANSFORM
    __EE5249971 := __PP5249930.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5249971),__ST237545_Layout),__NL(__EE5249971));
    SELF.Terminated_Filing_ := __OP2(__PP5249930.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5249930;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5249929,__ND5250167__Project(LEFT));
END;
