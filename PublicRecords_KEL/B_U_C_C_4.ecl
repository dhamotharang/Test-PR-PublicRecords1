...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5614831 := __ENH_U_C_C_5;
  EXPORT __ST244527_Layout := RECORD
  ...
  END;
  EXPORT __ST244523_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST244527_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST244523_Layout __ND5615069__Project(B_U_C_C_5(__in,__cfg).__ST250909_Layout __PP5614832) := TRANSFORM
    __EE5614873 := __PP5614832.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5614873),__ST244527_Layout),__NL(__EE5614873));
    SELF.Terminated_Filing_ := __OP2(__PP5614832.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5614832;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5614831,__ND5615069__Project(LEFT));
END;
