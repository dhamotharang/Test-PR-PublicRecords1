...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5126976 := __ENH_U_C_C_5;
  EXPORT __ST236497_Layout := RECORD
  ...
  END;
  EXPORT __ST236493_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST236497_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236493_Layout __ND5127214__Project(B_U_C_C_5(__in,__cfg).__ST242609_Layout __PP5126977) := TRANSFORM
    __EE5127018 := __PP5126977.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5127018),__ST236497_Layout),__NL(__EE5127018));
    SELF.Terminated_Filing_ := __OP2(__PP5126977.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5126977;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5126976,__ND5127214__Project(LEFT));
END;
