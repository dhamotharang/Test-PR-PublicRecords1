...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5134361 := __ENH_U_C_C_5;
  EXPORT __ST236994_Layout := RECORD
  ...
  END;
  EXPORT __ST236990_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST236994_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236990_Layout __ND5134599__Project(B_U_C_C_5(__in,__cfg).__ST243106_Layout __PP5134362) := TRANSFORM
    __EE5134403 := __PP5134362.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5134403),__ST236994_Layout),__NL(__EE5134403));
    SELF.Terminated_Filing_ := __OP2(__PP5134362.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5134362;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5134361,__ND5134599__Project(LEFT));
END;
