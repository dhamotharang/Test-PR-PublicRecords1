...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5401824 := __ENH_U_C_C_5;
  EXPORT __ST243799_Layout := RECORD
  ...
  EXPORT __ST243795_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST243799_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243795_Layout __ND5402062__Project(B_U_C_C_5(__in,__cfg).__ST250140_Layout __PP5401825) := TRANSFORM
    __EE5401866 := __PP5401825.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5401866),__ST243799_Layout),__NL(__EE5401866));
    SELF.Terminated_Filing_ := __OP2(__PP5401825.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5401825;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5401824,__ND5402062__Project(LEFT));
END;
