...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5132940 := __ENH_U_C_C_5;
  EXPORT __ST236339_Layout := RECORD
  ...
  END;
  EXPORT __ST236335_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST236339_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST236335_Layout __ND5133178__Project(B_U_C_C_5(__in,__cfg).__ST242451_Layout __PP5132941) := TRANSFORM
    __EE5132982 := __PP5132941.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5132982),__ST236339_Layout),__NL(__EE5132982));
    SELF.Terminated_Filing_ := __OP2(__PP5132941.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5132941;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5132940,__ND5133178__Project(LEFT));
END;
