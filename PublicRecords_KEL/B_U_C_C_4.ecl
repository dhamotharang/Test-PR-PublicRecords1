...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5816580 := __ENH_U_C_C_5;
  EXPORT __ST250698_Layout := RECORD
  ...
  EXPORT __ST250694_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST250698_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST250694_Layout __ND5816818__Project(B_U_C_C_5(__in,__cfg).__ST257250_Layout __PP5816581) := TRANSFORM
    __EE5816622 := __PP5816581.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5816622),__ST250698_Layout),__NL(__EE5816622));
    SELF.Terminated_Filing_ := __OP2(__PP5816581.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5816581;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5816580,__ND5816818__Project(LEFT));
END;
