...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5135219 := __ENH_U_C_C_5;
  EXPORT __ST237014_Layout := RECORD
  ...
  END;
  EXPORT __ST237010_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST237014_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST237010_Layout __ND5135457__Project(B_U_C_C_5(__in,__cfg).__ST243126_Layout __PP5135220) := TRANSFORM
    __EE5135261 := __PP5135220.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5135261),__ST237014_Layout),__NL(__EE5135261));
    SELF.Terminated_Filing_ := __OP2(__PP5135220.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5135220;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5135219,__ND5135457__Project(LEFT));
END;
