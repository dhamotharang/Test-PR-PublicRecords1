...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3706507 := __ENH_U_C_C_5;
  EXPORT __ST183870_Layout := RECORD
  ...
  END;
  EXPORT __ST183866_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST183870_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183866_Layout __ND3706695__Project(B_U_C_C_5(__in,__cfg).__ST189297_Layout __PP3706508) := TRANSFORM
    __EE3706549 := __PP3706508.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE3706549),__ST183870_Layout),__NL(__EE3706549));
    SELF.Terminated_Filing_ := __OP2(__PP3706508.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP3706508;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE3706507,__ND3706695__Project(LEFT));
END;
