...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5952141 := __ENH_U_C_C_5;
  EXPORT __ST258930_Layout := RECORD
  ...
  END;
  EXPORT __ST258926_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST258930_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST258926_Layout __ND5952379__Project(B_U_C_C_5(__in,__cfg).__ST265522_Layout __PP5952142) := TRANSFORM
    __EE5952183 := __PP5952142.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE5952183),__ST258930_Layout),__NL(__EE5952183));
    SELF.Terminated_Filing_ := __OP2(__PP5952142.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP5952142;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE5952141,__ND5952379__Project(LEFT));
END;
