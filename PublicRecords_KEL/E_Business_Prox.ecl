...
EXPORT E_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  Layout Business_Prox__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Contacts_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Date_Vendor_First_Reported_,Date_Vendor_Last_Reported_,Header_Hit_Flag_,Source_},Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Date_Vendor_First_Reported_,Date_Vendor_Last_Reported_,Header_Hit_Flag_,Source_),Contacts_Layout)(__NN(Contact_First_Name_) OR __NN(Contact_Middle_Name_) OR __NN(Contact_Last_Name_) OR __NN(Contact_Name_Suffix_) OR __NN(Contact_Primary_Range_) OR __NN(Contact_Predirectional_) OR __NN(Contact_Primary_Name_) OR __NN(Contact_Suffix_) OR __NN(Contact_Postdirectional_) OR __NN(Contact_Secondary_Range_) OR __NN(Contact_State_) OR __NN(Contact_Z_I_P5_) OR __NN(Contact_S_S_N_) OR __NN(Contact_Phone_Number_) OR __NN(Contact_Score_) OR __NN(Contact_Type_) OR __NN(Contact_Job_Title_) OR __NN(Contact_Status_) OR __NN(Contact_Is_Executive_) OR __NN(Contact_Executive_Order_) OR __NN(Is_Contact_) OR __NN(Contact_Email_) OR __NN(Contact_Email_Username_) OR __NN(Contact_Email_Domain_) OR __NN(Date_Regustered_Agent_Resigned_) OR __NN(Date_Vendor_First_Reported_) OR __NN(Date_Vendor_Last_Reported_) OR __NN(Header_Hit_Flag_) OR __NN(Source_)));
  ...
  Layout Business_Prox__Single_Rollup(InLayout __r) := TRANSFORM
    ...
    SELF.Contacts_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Contacts_Layout,SELF.__RecordCount:=1;,SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Contact_First_Name_) OR __NN(Contact_Middle_Name_) OR __NN(Contact_Last_Name_) OR __NN(Contact_Name_Suffix_) OR __NN(Contact_Primary_Range_) OR __NN(Contact_Predirectional_) OR __NN(Contact_Primary_Name_) OR __NN(Contact_Suffix_) OR __NN(Contact_Postdirectional_) OR __NN(Contact_Secondary_Range_) OR __NN(Contact_State_) OR __NN(Contact_Z_I_P5_) OR __NN(Contact_S_S_N_) OR __NN(Contact_Phone_Number_) OR __NN(Contact_Score_) OR __NN(Contact_Type_) OR __NN(Contact_Job_Title_) OR __NN(Contact_Status_) OR __NN(Contact_Is_Executive_) OR __NN(Contact_Executive_Order_) OR __NN(Is_Contact_) OR __NN(Contact_Email_) OR __NN(Contact_Email_Username_) OR __NN(Contact_Email_Domain_) OR __NN(Date_Regustered_Agent_Resigned_) OR __NN(Date_Vendor_First_Reported_) OR __NN(Date_Vendor_Last_Reported_) OR __NN(Header_Hit_Flag_) OR __NN(Source_)));
