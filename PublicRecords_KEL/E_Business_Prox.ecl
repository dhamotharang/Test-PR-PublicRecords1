...
EXPORT E_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  Layout Business_Prox__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Cortera_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Cortera_Ultimate_Link_I_D_,Cortera_Link_I_D_},Cortera_Ultimate_Link_I_D_,Cortera_Link_I_D_),Cortera_Layout)(__NN(Cortera_Ultimate_Link_I_D_) OR __NN(Cortera_Link_I_D_)));
    SELF.Deleted_I_D_Numbers_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Deleted_Key_},Deleted_Key_),Deleted_I_D_Numbers_Layout)(__NN(Deleted_Key_)));
    SELF.Best_Company_Names_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Best_Company_Name_,Best_Company_Name_Rank_},Best_Company_Name_,Best_Company_Name_Rank_),Best_Company_Names_Layout)(__NN(Best_Company_Name_) OR __NN(Best_Company_Name_Rank_)));
    SELF.Best_S_I_C_Codes_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Best_S_I_C_Code_,Best_S_I_C_Code_Rank_},Best_S_I_C_Code_,Best_S_I_C_Code_Rank_),Best_S_I_C_Codes_Layout)(__NN(Best_S_I_C_Code_) OR __NN(Best_S_I_C_Code_Rank_)));
    SELF.Best_N_A_I_C_S_Codes_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Best_N_A_I_C_S_Code_,Best_N_A_I_C_S_Code_Rank_},Best_N_A_I_C_S_Code_,Best_N_A_I_C_S_Code_Rank_),Best_N_A_I_C_S_Codes_Layout)(__NN(Best_N_A_I_C_S_Code_) OR __NN(Best_N_A_I_C_S_Code_Rank_)));
    SELF.O_S_H_A_Inspection_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),O_S_H_A_Inspection_Opening_Date_,O_S_H_A_Inspection_Close_Date_,O_S_H_A_Advance_Notice_Flag_,O_S_H_A_Union_Flag_,O_S_H_A_Inspection_Type_,O_S_H_A_Inspection_Type_Code_,O_S_H_A_Inspection_Scope_,O_S_H_A_Walk_Around_Flag_,O_S_H_A_Employees_Interviewed_Flag_,O_S_H_A_No_Inspection_Code_,O_S_H_A_Case_Closed_Flag_,O_S_H_A_Previous_Activity_Type_,O_S_H_A_Previous_Activity_Type_Description_},O_S_H_A_Inspection_Opening_Date_,O_S_H_A_Inspection_Close_Date_,O_S_H_A_Advance_Notice_Flag_,O_S_H_A_Union_Flag_,O_S_H_A_Inspection_Type_,O_S_H_A_Inspection_Type_Code_,O_S_H_A_Inspection_Scope_,O_S_H_A_Walk_Around_Flag_,O_S_H_A_Employees_Interviewed_Flag_,O_S_H_A_No_Inspection_Code_,O_S_H_A_Case_Closed_Flag_,O_S_H_A_Previous_Activity_Type_,O_S_H_A_Previous_Activity_Type_Description_),O_S_H_A_Inspection_Layout)(__NN(O_S_H_A_Inspection_Opening_Date_) OR __NN(O_S_H_A_Inspection_Close_Date_) OR __NN(O_S_H_A_Advance_Notice_Flag_) OR __NN(O_S_H_A_Union_Flag_) OR __NN(O_S_H_A_Inspection_Type_) OR __NN(O_S_H_A_Inspection_Type_Code_) OR __NN(O_S_H_A_Inspection_Scope_) OR __NN(O_S_H_A_Walk_Around_Flag_) OR __NN(O_S_H_A_Employees_Interviewed_Flag_) OR __NN(O_S_H_A_No_Inspection_Code_) OR __NN(O_S_H_A_Case_Closed_Flag_) OR __NN(O_S_H_A_Previous_Activity_Type_) OR __NN(O_S_H_A_Previous_Activity_Type_Description_)));
    SELF.O_S_H_A_Violations_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),O_S_H_A_Total_Violations_,O_S_H_A_Total_Serious_Violations_,O_S_H_A_Number_Of_Violations_,O_S_H_A_Number_Of_Events_,O_S_H_A_Number_Of_Hazardous_Substance_,O_S_H_A_Number_Of_Accidents_,O_S_H_A_Safety_Health_Flag_},O_S_H_A_Total_Violations_,O_S_H_A_Total_Serious_Violations_,O_S_H_A_Number_Of_Violations_,O_S_H_A_Number_Of_Events_,O_S_H_A_Number_Of_Hazardous_Substance_,O_S_H_A_Number_Of_Accidents_,O_S_H_A_Safety_Health_Flag_),O_S_H_A_Violations_Layout)(__NN(O_S_H_A_Total_Violations_) OR __NN(O_S_H_A_Total_Serious_Violations_) OR __NN(O_S_H_A_Number_Of_Violations_) OR __NN(O_S_H_A_Number_Of_Events_) OR __NN(O_S_H_A_Number_Of_Hazardous_Substance_) OR __NN(O_S_H_A_Number_Of_Accidents_) OR __NN(O_S_H_A_Safety_Health_Flag_)));
    SELF.O_S_H_A_Business_Information_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),O_S_H_A_Owner_Type_,O_S_H_A_Owner_Type_Description_,O_S_H_A_Employee_Count12_Months_},O_S_H_A_Owner_Type_,O_S_H_A_Owner_Type_Description_,O_S_H_A_Employee_Count12_Months_),O_S_H_A_Business_Information_Layout)(__NN(O_S_H_A_Owner_Type_) OR __NN(O_S_H_A_Owner_Type_Description_) OR __NN(O_S_H_A_Employee_Count12_Months_)));
    SELF.Vendor_Dates_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Process_Date_,Source_},Process_Date_,Source_),Vendor_Dates_Layout)(__NN(Process_Date_) OR __NN(Source_)));
    SELF.Associated_Address_Type_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Associated_Addr_Commercial_,Associated_Addr_Residential_},Associated_Addr_Commercial_,Associated_Addr_Residential_),Associated_Address_Type_Layout)(__NN(Associated_Addr_Commercial_) OR __NN(Associated_Addr_Residential_)));
    SELF.Business_Characteristics_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Year_Established_,Public_Private_Indicator_,Corporation_Code_,Date_Last_Seen_Location_,Location_Corp_Hierarchy_,Is_S_B_E_,Is_Small_Business_Home_Office_,Is_Not_S_B_E_,Is_Goverment_,Is_Federal_Goverment_,Goverment_Type_,Is_Non_Profit_,Minority_Woman_Status_,Is_N_M_S_D_C_Certified_,Is_W_B_E_N_C_Certified_,Is_California_P_U_C_Certified_,Is_Texas_H_U_B_Certified_,Is_California_Caltrans_Certified_,Is_Educational_Institution_,Is_Minority_Institue_,Is_Alaska_Native_Corporation_,Is_S_B_A_H_U_B_Zone_,Is_Hist_Black_College_,Merchant_Type_,Employee_Count_,Employee_Count_Code_,Business_Size_,Financial_Amount_Figure_,Financial_Amount_Code_,Financial_Amount_Type_,Financial_Amount_Precision_,Source_},Year_Established_,Public_Private_Indicator_,Corporation_Code_,Date_Last_Seen_Location_,Location_Corp_Hierarchy_,Is_S_B_E_,Is_Small_Business_Home_Office_,Is_Not_S_B_E_,Is_Goverment_,Is_Federal_Goverment_,Goverment_Type_,Is_Non_Profit_,Minority_Woman_Status_,Is_N_M_S_D_C_Certified_,Is_W_B_E_N_C_Certified_,Is_California_P_U_C_Certified_,Is_Texas_H_U_B_Certified_,Is_California_Caltrans_Certified_,Is_Educational_Institution_,Is_Minority_Institue_,Is_Alaska_Native_Corporation_,Is_S_B_A_H_U_B_Zone_,Is_Hist_Black_College_,Merchant_Type_,Employee_Count_,Employee_Count_Code_,Business_Size_,Financial_Amount_Figure_,Financial_Amount_Code_,Financial_Amount_Type_,Financial_Amount_Precision_,Source_),Business_Characteristics_Layout)(__NN(Year_Established_) OR __NN(Public_Private_Indicator_) OR __NN(Corporation_Code_) OR __NN(Date_Last_Seen_Location_) OR __NN(Location_Corp_Hierarchy_) OR __NN(Is_S_B_E_) OR __NN(Is_Small_Business_Home_Office_) OR __NN(Is_Not_S_B_E_) OR __NN(Is_Goverment_) OR __NN(Is_Federal_Goverment_) OR __NN(Goverment_Type_) OR __NN(Is_Non_Profit_) OR __NN(Minority_Woman_Status_) OR __NN(Is_N_M_S_D_C_Certified_) OR __NN(Is_W_B_E_N_C_Certified_) OR __NN(Is_California_P_U_C_Certified_) OR __NN(Is_Texas_H_U_B_Certified_) OR __NN(Is_California_Caltrans_Certified_) OR __NN(Is_Educational_Institution_) OR __NN(Is_Minority_Institue_) OR __NN(Is_Alaska_Native_Corporation_) OR __NN(Is_S_B_A_H_U_B_Zone_) OR __NN(Is_Hist_Black_College_) OR __NN(Merchant_Type_) OR __NN(Employee_Count_) OR __NN(Employee_Count_Code_) OR __NN(Business_Size_) OR __NN(Financial_Amount_Figure_) OR __NN(Financial_Amount_Code_) OR __NN(Financial_Amount_Type_) OR __NN(Financial_Amount_Precision_) OR __NN(Source_)));
    SELF.Location_Status_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Company_Status_,Is_Closed_,Date_Closed_,Is_Dead_,Date_Dead_},Company_Status_,Is_Closed_,Date_Closed_,Is_Dead_,Date_Dead_),Location_Status_Layout)(__NN(Company_Status_) OR __NN(Is_Closed_) OR __NN(Date_Closed_) OR __NN(Is_Dead_) OR __NN(Date_Dead_)));
    SELF.Marketability_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),General_Marketability_Score_,General_Marketability_Indicator_,Is_Vacant_,Is_Seasonal_,U_R_L_},General_Marketability_Score_,General_Marketability_Indicator_,Is_Vacant_,Is_Seasonal_,U_R_L_),Marketability_Layout)(__NN(General_Marketability_Score_) OR __NN(General_Marketability_Indicator_) OR __NN(Is_Vacant_) OR __NN(Is_Seasonal_) OR __NN(U_R_L_)));
    SELF.Business_Owned_Characteristics_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Is_Minority_Owned_,Is_Woman_Owned_,Is_Woman_Owned_S_B_E_,Is_Minority_Woman_Owned_,Is_Disadvantage_Owned_,Is_Veteran_Owned_,Is_Veteran_Owned_S_B_E_,Is_Disabled_Vet_Owned_,Is_Disabled_Vet_Owned_S_B_E_,Is_S_B_A_Disadvantaged_Owned_,Is_S_B_A8_A_Owned_,S_B_A8_A_Owned_Date_,Is_Disabled_Owned_,Is_Gay_Lesbian_Owned_},Is_Minority_Owned_,Is_Woman_Owned_,Is_Woman_Owned_S_B_E_,Is_Minority_Woman_Owned_,Is_Disadvantage_Owned_,Is_Veteran_Owned_,Is_Veteran_Owned_S_B_E_,Is_Disabled_Vet_Owned_,Is_Disabled_Vet_Owned_S_B_E_,Is_S_B_A_Disadvantaged_Owned_,Is_S_B_A8_A_Owned_,S_B_A8_A_Owned_Date_,Is_Disabled_Owned_,Is_Gay_Lesbian_Owned_),Business_Owned_Characteristics_Layout)(__NN(Is_Minority_Owned_) OR __NN(Is_Woman_Owned_) OR __NN(Is_Woman_Owned_S_B_E_) OR __NN(Is_Minority_Woman_Owned_) OR __NN(Is_Disadvantage_Owned_) OR __NN(Is_Veteran_Owned_) OR __NN(Is_Veteran_Owned_S_B_E_) OR __NN(Is_Disabled_Vet_Owned_) OR __NN(Is_Disabled_Vet_Owned_S_B_E_) OR __NN(Is_S_B_A_Disadvantaged_Owned_) OR __NN(Is_S_B_A8_A_Owned_) OR __NN(S_B_A8_A_Owned_Date_) OR __NN(Is_Disabled_Owned_) OR __NN(Is_Gay_Lesbian_Owned_)));
    SELF.Contacts_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Header_Hit_Flag_,Source_},Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Header_Hit_Flag_,Source_),Contacts_Layout)(__NN(Contact_First_Name_) OR __NN(Contact_Middle_Name_) OR __NN(Contact_Last_Name_) OR __NN(Contact_Name_Suffix_) OR __NN(Contact_Primary_Range_) OR __NN(Contact_Predirectional_) OR __NN(Contact_Primary_Name_) OR __NN(Contact_Suffix_) OR __NN(Contact_Postdirectional_) OR __NN(Contact_Secondary_Range_) OR __NN(Contact_State_) OR __NN(Contact_Z_I_P5_) OR __NN(Contact_S_S_N_) OR __NN(Contact_Phone_Number_) OR __NN(Contact_Score_) OR __NN(Contact_Type_) OR __NN(Contact_Job_Title_) OR __NN(Contact_Status_) OR __NN(Contact_Is_Executive_) OR __NN(Contact_Executive_Order_) OR __NN(Is_Contact_) OR __NN(Contact_Email_) OR __NN(Contact_Email_Username_) OR __NN(Contact_Email_Domain_) OR __NN(Date_Regustered_Agent_Resigned_) OR __NN(Header_Hit_Flag_) OR __NN(Source_)));
