...
EXPORT E_Business_Prox(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping4 := 'UID(DEFAULT:UID),ultid(OVERRIDE:Ult_I_D_:0),orgid(OVERRIDE:Org_I_D_:0),seleid(OVERRIDE:Sele_I_D_:0),proxid(OVERRIDE:Prox_I_D_:0),Prox_Sele_(DEFAULT:Prox_Sele_:0),parentproxid(DEFAULT:Parent_Prox_I_D_:0),seleproxid(DEFAULT:Sele_Prox_I_D_:0),orgproxid(DEFAULT:Org_Prox_I_D_:0),ultproxid(DEFAULT:Ult_Prox_I_D_:0),levelsfromtop(DEFAULT:Levels_From_Top_:0),nodesbelow(DEFAULT:Nodes_Below_:0),proxsegment(DEFAULT:Prox_Segment_:\'\'),storenumber(DEFAULT:Store_Number_:\'\'),activedunsnumber(DEFAULT:Active_Duns_Number_:\'\'),histdunsnumber(DEFAULT:Hist_Duns_Number_:\'\'),deletedkey(DEFAULT:Deleted_Key_:\'\'),dunsnumber(DEFAULT:D_U_N_S_Number_:\'\'),oshapreviousactivitytype(DEFAULT:O_S_H_A_Previous_Activity_Type_:\'\'),oshapreviousactivitytypedescription(DEFAULT:O_S_H_A_Previous_Activity_Type_Description_:\'\'),oshaadvancenoticeflag(DEFAULT:O_S_H_A_Advance_Notice_Flag_),oshainspectionopeningdate(DEFAULT:O_S_H_A_Inspection_Opening_Date_:DATE),oshainspectionclosedate(DEFAULT:O_S_H_A_Inspection_Close_Date_:DATE),oshasafetyhealthflag(DEFAULT:O_S_H_A_Safety_Health_Flag_:\'\'),oshainspectiontype(DEFAULT:O_S_H_A_Inspection_Type_:\'\'),oshainspectionscope(DEFAULT:O_S_H_A_Inspection_Scope_:\'\'),oshawalkaroundflag(DEFAULT:O_S_H_A_Walk_Around_Flag_),oshaemployeesinterviewedflag(DEFAULT:O_S_H_A_Employees_Interviewed_Flag_),oshaunionflag(DEFAULT:O_S_H_A_Union_Flag_),oshacaseclosedflag(DEFAULT:O_S_H_A_Case_Closed_Flag_),oshanoinspectioncode(DEFAULT:O_S_H_A_No_Inspection_Code_:\'\'),oshainspectiontypecode(DEFAULT:O_S_H_A_Inspection_Type_Code_:\'\'),oshatotalviolations(DEFAULT:O_S_H_A_Total_Violations_:0),oshatotalseriousviolations(DEFAULT:O_S_H_A_Total_Serious_Violations_:0),oshanumberofviolations(DEFAULT:O_S_H_A_Number_Of_Violations_:0),oshanumberofevents(DEFAULT:O_S_H_A_Number_Of_Events_:0),oshanumberofhazardoussubstance(DEFAULT:O_S_H_A_Number_Of_Hazardous_Substance_:0),oshanumberofaccidents(DEFAULT:O_S_H_A_Number_Of_Accidents_:0),oshaownertype(DEFAULT:O_S_H_A_Owner_Type_:\'\'),oshaownertypedescription(DEFAULT:O_S_H_A_Owner_Type_Description_:\'\'),oshaemployeecount12months(DEFAULT:O_S_H_A_Employee_Count12_Months_:0),bestcompanyname(DEFAULT:Best_Company_Name_:\'\'),bestcompanynamerank(DEFAULT:Best_Company_Name_Rank_:0),bestsiccode(DEFAULT:Best_S_I_C_Code_:0),bestsiccoderank(DEFAULT:Best_S_I_C_Code_Rank_:0),bestnaicscode(DEFAULT:Best_N_A_I_C_S_Code_:0),bestnaicscoderank(DEFAULT:Best_N_A_I_C_S_Code_Rank_:0),headerhitflag(DEFAULT:Header_Hit_Flag_),corporationcode(DEFAULT:Corporation_Code_:\'\'),contactfirstname(DEFAULT:Contact_First_Name_:\'\'),contactmiddlename(DEFAULT:Contact_Middle_Name_:\'\'),contactlastname(DEFAULT:Contact_Last_Name_:\'\'),contactnamesuffix(DEFAULT:Contact_Name_Suffix_:\'\'),contactprimaryrange(DEFAULT:Contact_Primary_Range_:\'\'),contactpredirectional(DEFAULT:Contact_Predirectional_:\'\'),contactprimaryname(DEFAULT:Contact_Primary_Name_:\'\'),contactsuffix(DEFAULT:Contact_Suffix_:\'\'),contactpostdirectional(DEFAULT:Contact_Postdirectional_:\'\'),contactsecondaryrange(DEFAULT:Contact_Secondary_Range_:\'\'),contactstate(DEFAULT:Contact_State_:\'\'),contactzip5(DEFAULT:Contact_Z_I_P5_:0),contactssn(DEFAULT:Contact_S_S_N_:0),contactphonenumber(DEFAULT:Contact_Phone_Number_:0),contactscore(DEFAULT:Contact_Score_:0),contacttype(DEFAULT:Contact_Type_:\'\'),contactemail(DEFAULT:Contact_Email_:\'\'),contactemailusername(DEFAULT:Contact_Email_Username_:\'\'),contactemaildomain(DEFAULT:Contact_Email_Domain_:\'\'),corteraultimatelinkid(DEFAULT:Cortera_Ultimate_Link_I_D_:0),corteralinkid(DEFAULT:Cortera_Link_I_D_:0),contactjobtitle(DEFAULT:Contact_Job_Title_:\'\'),contactstatus(DEFAULT:Contact_Status_:\'\'),location_code(OVERRIDE:Location_Corp_Hierarchy_:\'\'),companystatus(DEFAULT:Company_Status_:\'\'),isclosed(DEFAULT:Is_Closed_),contactisexecutive(DEFAULT:Contact_Is_Executive_),iscontact(DEFAULT:Is_Contact_),contactexecutiveorder(DEFAULT:Contact_Executive_Order_:0),recordstatus(DEFAULT:Record_Status_:\'\'),equifaxid(DEFAULT:Equifax_I_D_:0),issmallbusinesshomeoffice(DEFAULT:Is_Small_Business_Home_Office_),url(DEFAULT:U_R_L_:\'\'),employeecount(DEFAULT:Employee_Count_:\'\'),employeecountcode(DEFAULT:Employee_Count_Code_:\'\'),financialamountfigure(DEFAULT:Financial_Amount_Figure_:\'\'),financialamountcode(DEFAULT:Financial_Amount_Code_:\'\'),financialamounttype(DEFAULT:Financial_Amount_Type_:\'\'),financialamountprecision(DEFAULT:Financial_Amount_Precision_:\'\'),isdead(DEFAULT:Is_Dead_),datedead(DEFAULT:Date_Dead_:DATE),associatedaddrcommercial(DEFAULT:Associated_Addr_Commercial_),associatedaddrresidential(DEFAULT:Associated_Addr_Residential_),generalmarketabilityscore(DEFAULT:General_Marketability_Score_:0),generalmarketabilityindicator(DEFAULT:General_Marketability_Indicator_:\'\'),isvacant(DEFAULT:Is_Vacant_),isseasonal(DEFAULT:Is_Seasonal_),isminorityowned(DEFAULT:Is_Minority_Owned_),iswomanowned(DEFAULT:Is_Woman_Owned_),isminoritywomanowned(DEFAULT:Is_Minority_Woman_Owned_),issbadisadvantagedowned(DEFAULT:Is_S_B_A_Disadvantaged_Owned_),issbahubzone(DEFAULT:Is_S_B_A_H_U_B_Zone_),isdisadvantageowned(DEFAULT:Is_Disadvantage_Owned_),isveteranowned(DEFAULT:Is_Veteran_Owned_),isdisabledvetowned(DEFAULT:Is_Disabled_Vet_Owned_),issba8aowned(DEFAULT:Is_S_B_A8_A_Owned_),sba8aowneddate(DEFAULT:S_B_A8_A_Owned_Date_:DATE),isdisabledowned(DEFAULT:Is_Disabled_Owned_),ishistblackcollege(DEFAULT:Is_Hist_Black_College_),isgaylesbianowned(DEFAULT:Is_Gay_Lesbian_Owned_),iswomanownedsbe(DEFAULT:Is_Woman_Owned_S_B_E_),isveteranownedsbe(DEFAULT:Is_Veteran_Owned_S_B_E_),isdisabledvetownedsbe(DEFAULT:Is_Disabled_Vet_Owned_S_B_E_),issbe(DEFAULT:Is_S_B_E_),isnotsbe(DEFAULT:Is_Not_S_B_E_),isgoverment(DEFAULT:Is_Goverment_),isfederalgoverment(DEFAULT:Is_Federal_Goverment_),merchanttype(DEFAULT:Merchant_Type_:\'\'),processdate(DEFAULT:Process_Date_:DATE),yearestablished(DEFAULT:Year_Established_:\'\'),publicprivateindicator(DEFAULT:Public_Private_Indicator_:\'\'),businesssize(DEFAULT:Business_Size_:\'\'),govermenttype(DEFAULT:Goverment_Type_:\'\'),isnonprofit(DEFAULT:Is_Non_Profit_),minoritywomanstatus(DEFAULT:Minority_Woman_Status_:\'\'),isnmsdccertified(DEFAULT:Is_N_M_S_D_C_Certified_),iswbenccertified(DEFAULT:Is_W_B_E_N_C_Certified_),iscaliforniapuccertified(DEFAULT:Is_California_P_U_C_Certified_),istexashubcertified(DEFAULT:Is_Texas_H_U_B_Certified_),iscaliforniacaltranscertified(DEFAULT:Is_California_Caltrans_Certified_),iseducationalinstitution(DEFAULT:Is_Educational_Institution_),isminorityinstitue(DEFAULT:Is_Minority_Institue_),isalaskanativecorporation(DEFAULT:Is_Alaska_Native_Corporation_),datelastseenlocation(DEFAULT:Date_Last_Seen_Location_:DATE),dateregusteredagentresigned(DEFAULT:Date_Regustered_Agent_Resigned_:DATE),dateclosed(DEFAULT:Date_Closed_:DATE),src(OVERRIDE:Source_:\'\'),archive_date(DEFAULT:Archive___Date_:EPOCH),date_first_seen(OVERRIDE:Date_First_Seen_:EPOCH:Date_First_Seen_4Rule),date_last_seen(OVERRIDE:Date_Last_Seen_:EPOCH),datevendorfirstreported(DEFAULT:Date_Vendor_First_Reported_:EPOCH),datevendorlastreported(DEFAULT:Date_Vendor_Last_Reported_:EPOCH),hybridarchivedate(DEFAULT:Hybrid_Archive_Date_:EPOCH),vaultdatefirstseen(DEFAULT:Vault_Date_First_Seen_:EPOCH),vaultdatelastseen(DEFAULT:Vault_Date_Last_Seen_:EPOCH),DPMBitmap(OVERRIDE:__Permits:PERMITS)';
  ...
  Layout Business_Prox__Rollup(InLayout __r, DATASET(InLayout) __recs) := TRANSFORM
    ...
    SELF.Cortera_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Cortera_Ultimate_Link_I_D_,Cortera_Link_I_D_},Cortera_Ultimate_Link_I_D_,Cortera_Link_I_D_),Cortera_Layout)(__NN(Cortera_Ultimate_Link_I_D_) OR __NN(Cortera_Link_I_D_)));
    SELF.Deleted_I_D_Numbers_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Deleted_Key_},Deleted_Key_),Deleted_I_D_Numbers_Layout)(__NN(Deleted_Key_)));
    SELF.Best_Company_Names_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Best_Company_Name_,Best_Company_Name_Rank_},Best_Company_Name_,Best_Company_Name_Rank_),Best_Company_Names_Layout)(__NN(Best_Company_Name_) OR __NN(Best_Company_Name_Rank_)));
    SELF.Best_S_I_C_Codes_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Best_S_I_C_Code_,Best_S_I_C_Code_Rank_},Best_S_I_C_Code_,Best_S_I_C_Code_Rank_),Best_S_I_C_Codes_Layout)(__NN(Best_S_I_C_Code_) OR __NN(Best_S_I_C_Code_Rank_)));
    SELF.Best_N_A_I_C_S_Codes_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Best_N_A_I_C_S_Code_,Best_N_A_I_C_S_Code_Rank_},Best_N_A_I_C_S_Code_,Best_N_A_I_C_S_Code_Rank_),Best_N_A_I_C_S_Codes_Layout)(__NN(Best_N_A_I_C_S_Code_) OR __NN(Best_N_A_I_C_S_Code_Rank_)));
    SELF.O_S_H_A_Inspection_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),O_S_H_A_Inspection_Opening_Date_,O_S_H_A_Inspection_Close_Date_,O_S_H_A_Advance_Notice_Flag_,O_S_H_A_Union_Flag_,O_S_H_A_Inspection_Type_,O_S_H_A_Inspection_Type_Code_,O_S_H_A_Inspection_Scope_,O_S_H_A_Walk_Around_Flag_,O_S_H_A_Employees_Interviewed_Flag_,O_S_H_A_No_Inspection_Code_,O_S_H_A_Case_Closed_Flag_,O_S_H_A_Previous_Activity_Type_,O_S_H_A_Previous_Activity_Type_Description_},O_S_H_A_Inspection_Opening_Date_,O_S_H_A_Inspection_Close_Date_,O_S_H_A_Advance_Notice_Flag_,O_S_H_A_Union_Flag_,O_S_H_A_Inspection_Type_,O_S_H_A_Inspection_Type_Code_,O_S_H_A_Inspection_Scope_,O_S_H_A_Walk_Around_Flag_,O_S_H_A_Employees_Interviewed_Flag_,O_S_H_A_No_Inspection_Code_,O_S_H_A_Case_Closed_Flag_,O_S_H_A_Previous_Activity_Type_,O_S_H_A_Previous_Activity_Type_Description_),O_S_H_A_Inspection_Layout)(__NN(O_S_H_A_Inspection_Opening_Date_) OR __NN(O_S_H_A_Inspection_Close_Date_) OR __NN(O_S_H_A_Advance_Notice_Flag_) OR __NN(O_S_H_A_Union_Flag_) OR __NN(O_S_H_A_Inspection_Type_) OR __NN(O_S_H_A_Inspection_Type_Code_) OR __NN(O_S_H_A_Inspection_Scope_) OR __NN(O_S_H_A_Walk_Around_Flag_) OR __NN(O_S_H_A_Employees_Interviewed_Flag_) OR __NN(O_S_H_A_No_Inspection_Code_) OR __NN(O_S_H_A_Case_Closed_Flag_) OR __NN(O_S_H_A_Previous_Activity_Type_) OR __NN(O_S_H_A_Previous_Activity_Type_Description_)));
    SELF.O_S_H_A_Violations_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),O_S_H_A_Total_Violations_,O_S_H_A_Total_Serious_Violations_,O_S_H_A_Number_Of_Violations_,O_S_H_A_Number_Of_Events_,O_S_H_A_Number_Of_Hazardous_Substance_,O_S_H_A_Number_Of_Accidents_,O_S_H_A_Safety_Health_Flag_},O_S_H_A_Total_Violations_,O_S_H_A_Total_Serious_Violations_,O_S_H_A_Number_Of_Violations_,O_S_H_A_Number_Of_Events_,O_S_H_A_Number_Of_Hazardous_Substance_,O_S_H_A_Number_Of_Accidents_,O_S_H_A_Safety_Health_Flag_),O_S_H_A_Violations_Layout)(__NN(O_S_H_A_Total_Violations_) OR __NN(O_S_H_A_Total_Serious_Violations_) OR __NN(O_S_H_A_Number_Of_Violations_) OR __NN(O_S_H_A_Number_Of_Events_) OR __NN(O_S_H_A_Number_Of_Hazardous_Substance_) OR __NN(O_S_H_A_Number_Of_Accidents_) OR __NN(O_S_H_A_Safety_Health_Flag_)));
    SELF.O_S_H_A_Business_Information_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),O_S_H_A_Owner_Type_,O_S_H_A_Owner_Type_Description_,O_S_H_A_Employee_Count12_Months_},O_S_H_A_Owner_Type_,O_S_H_A_Owner_Type_Description_,O_S_H_A_Employee_Count12_Months_),O_S_H_A_Business_Information_Layout)(__NN(O_S_H_A_Owner_Type_) OR __NN(O_S_H_A_Owner_Type_Description_) OR __NN(O_S_H_A_Employee_Count12_Months_)));
    SELF.Vendor_Dates_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Process_Date_,Source_},Process_Date_,Source_),Vendor_Dates_Layout)(__NN(Process_Date_) OR __NN(Source_)));
    SELF.Associated_Address_Type_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Associated_Addr_Commercial_,Associated_Addr_Residential_},Associated_Addr_Commercial_,Associated_Addr_Residential_),Associated_Address_Type_Layout)(__NN(Associated_Addr_Commercial_) OR __NN(Associated_Addr_Residential_)));
    SELF.Business_Characteristics_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Year_Established_,Public_Private_Indicator_,Corporation_Code_,Date_Last_Seen_Location_,Location_Corp_Hierarchy_,Is_S_B_E_,Is_Small_Business_Home_Office_,Is_Not_S_B_E_,Is_Goverment_,Is_Federal_Goverment_,Goverment_Type_,Is_Non_Profit_,Minority_Woman_Status_,Is_N_M_S_D_C_Certified_,Is_W_B_E_N_C_Certified_,Is_California_P_U_C_Certified_,Is_Texas_H_U_B_Certified_,Is_California_Caltrans_Certified_,Is_Educational_Institution_,Is_Minority_Institue_,Is_Alaska_Native_Corporation_,Is_S_B_A_H_U_B_Zone_,Is_Hist_Black_College_,Merchant_Type_,Employee_Count_,Employee_Count_Code_,Business_Size_,Financial_Amount_Figure_,Financial_Amount_Code_,Financial_Amount_Type_,Financial_Amount_Precision_,Source_},Year_Established_,Public_Private_Indicator_,Corporation_Code_,Date_Last_Seen_Location_,Location_Corp_Hierarchy_,Is_S_B_E_,Is_Small_Business_Home_Office_,Is_Not_S_B_E_,Is_Goverment_,Is_Federal_Goverment_,Goverment_Type_,Is_Non_Profit_,Minority_Woman_Status_,Is_N_M_S_D_C_Certified_,Is_W_B_E_N_C_Certified_,Is_California_P_U_C_Certified_,Is_Texas_H_U_B_Certified_,Is_California_Caltrans_Certified_,Is_Educational_Institution_,Is_Minority_Institue_,Is_Alaska_Native_Corporation_,Is_S_B_A_H_U_B_Zone_,Is_Hist_Black_College_,Merchant_Type_,Employee_Count_,Employee_Count_Code_,Business_Size_,Financial_Amount_Figure_,Financial_Amount_Code_,Financial_Amount_Type_,Financial_Amount_Precision_,Source_),Business_Characteristics_Layout)(__NN(Year_Established_) OR __NN(Public_Private_Indicator_) OR __NN(Corporation_Code_) OR __NN(Date_Last_Seen_Location_) OR __NN(Location_Corp_Hierarchy_) OR __NN(Is_S_B_E_) OR __NN(Is_Small_Business_Home_Office_) OR __NN(Is_Not_S_B_E_) OR __NN(Is_Goverment_) OR __NN(Is_Federal_Goverment_) OR __NN(Goverment_Type_) OR __NN(Is_Non_Profit_) OR __NN(Minority_Woman_Status_) OR __NN(Is_N_M_S_D_C_Certified_) OR __NN(Is_W_B_E_N_C_Certified_) OR __NN(Is_California_P_U_C_Certified_) OR __NN(Is_Texas_H_U_B_Certified_) OR __NN(Is_California_Caltrans_Certified_) OR __NN(Is_Educational_Institution_) OR __NN(Is_Minority_Institue_) OR __NN(Is_Alaska_Native_Corporation_) OR __NN(Is_S_B_A_H_U_B_Zone_) OR __NN(Is_Hist_Black_College_) OR __NN(Merchant_Type_) OR __NN(Employee_Count_) OR __NN(Employee_Count_Code_) OR __NN(Business_Size_) OR __NN(Financial_Amount_Figure_) OR __NN(Financial_Amount_Code_) OR __NN(Financial_Amount_Type_) OR __NN(Financial_Amount_Precision_) OR __NN(Source_)));
    SELF.Location_Status_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Company_Status_,Is_Closed_,Date_Closed_,Is_Dead_,Date_Dead_},Company_Status_,Is_Closed_,Date_Closed_,Is_Dead_,Date_Dead_),Location_Status_Layout)(__NN(Company_Status_) OR __NN(Is_Closed_) OR __NN(Date_Closed_) OR __NN(Is_Dead_) OR __NN(Date_Dead_)));
    SELF.Marketability_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),General_Marketability_Score_,General_Marketability_Indicator_,Is_Vacant_,Is_Seasonal_,U_R_L_},General_Marketability_Score_,General_Marketability_Indicator_,Is_Vacant_,Is_Seasonal_,U_R_L_),Marketability_Layout)(__NN(General_Marketability_Score_) OR __NN(General_Marketability_Indicator_) OR __NN(Is_Vacant_) OR __NN(Is_Seasonal_) OR __NN(U_R_L_)));
    SELF.Business_Owned_Characteristics_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Is_Minority_Owned_,Is_Woman_Owned_,Is_Woman_Owned_S_B_E_,Is_Minority_Woman_Owned_,Is_Disadvantage_Owned_,Is_Veteran_Owned_,Is_Veteran_Owned_S_B_E_,Is_Disabled_Vet_Owned_,Is_Disabled_Vet_Owned_S_B_E_,Is_S_B_A_Disadvantaged_Owned_,Is_S_B_A8_A_Owned_,S_B_A8_A_Owned_Date_,Is_Disabled_Owned_,Is_Gay_Lesbian_Owned_},Is_Minority_Owned_,Is_Woman_Owned_,Is_Woman_Owned_S_B_E_,Is_Minority_Woman_Owned_,Is_Disadvantage_Owned_,Is_Veteran_Owned_,Is_Veteran_Owned_S_B_E_,Is_Disabled_Vet_Owned_,Is_Disabled_Vet_Owned_S_B_E_,Is_S_B_A_Disadvantaged_Owned_,Is_S_B_A8_A_Owned_,S_B_A8_A_Owned_Date_,Is_Disabled_Owned_,Is_Gay_Lesbian_Owned_),Business_Owned_Characteristics_Layout)(__NN(Is_Minority_Owned_) OR __NN(Is_Woman_Owned_) OR __NN(Is_Woman_Owned_S_B_E_) OR __NN(Is_Minority_Woman_Owned_) OR __NN(Is_Disadvantage_Owned_) OR __NN(Is_Veteran_Owned_) OR __NN(Is_Veteran_Owned_S_B_E_) OR __NN(Is_Disabled_Vet_Owned_) OR __NN(Is_Disabled_Vet_Owned_S_B_E_) OR __NN(Is_S_B_A_Disadvantaged_Owned_) OR __NN(Is_S_B_A8_A_Owned_) OR __NN(S_B_A8_A_Owned_Date_) OR __NN(Is_Disabled_Owned_) OR __NN(Is_Gay_Lesbian_Owned_)));
    SELF.Contacts_ := __CN(PROJECT(TABLE(__recs,{KEL.typ.int __RecordCount := COUNT(GROUP),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Date_Vendor_First_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_First_Reported_,MIN,FALSE),KEL.typ.epoch Date_Vendor_Last_Reported_ := KEL.era.SimpleRoll(GROUP,Date_Vendor_Last_Reported_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,FALSE),Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Header_Hit_Flag_,Source_},Contact_First_Name_,Contact_Middle_Name_,Contact_Last_Name_,Contact_Name_Suffix_,Contact_Primary_Range_,Contact_Predirectional_,Contact_Primary_Name_,Contact_Suffix_,Contact_Postdirectional_,Contact_Secondary_Range_,Contact_State_,Contact_Z_I_P5_,Contact_S_S_N_,Contact_Phone_Number_,Contact_Score_,Contact_Type_,Contact_Job_Title_,Contact_Status_,Contact_Is_Executive_,Contact_Executive_Order_,Is_Contact_,Contact_Email_,Contact_Email_Username_,Contact_Email_Domain_,Date_Regustered_Agent_Resigned_,Header_Hit_Flag_,Source_),Contacts_Layout)(__NN(Contact_First_Name_) OR __NN(Contact_Middle_Name_) OR __NN(Contact_Last_Name_) OR __NN(Contact_Name_Suffix_) OR __NN(Contact_Primary_Range_) OR __NN(Contact_Predirectional_) OR __NN(Contact_Primary_Name_) OR __NN(Contact_Suffix_) OR __NN(Contact_Postdirectional_) OR __NN(Contact_Secondary_Range_) OR __NN(Contact_State_) OR __NN(Contact_Z_I_P5_) OR __NN(Contact_S_S_N_) OR __NN(Contact_Phone_Number_) OR __NN(Contact_Score_) OR __NN(Contact_Type_) OR __NN(Contact_Job_Title_) OR __NN(Contact_Status_) OR __NN(Contact_Is_Executive_) OR __NN(Contact_Executive_Order_) OR __NN(Is_Contact_) OR __NN(Contact_Email_) OR __NN(Contact_Email_Username_) OR __NN(Contact_Email_Domain_) OR __NN(Date_Regustered_Agent_Resigned_) OR __NN(Header_Hit_Flag_) OR __NN(Source_)));
  ...
  Layout Business_Prox__Single_Rollup(InLayout __r) := TRANSFORM
    SELF.Cortera_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Cortera_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Cortera_Ultimate_Link_I_D_) OR __NN(Cortera_Link_I_D_)));
    SELF.Deleted_I_D_Numbers_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Deleted_I_D_Numbers_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Deleted_Key_)));
    SELF.Best_Company_Names_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Best_Company_Names_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Best_Company_Name_) OR __NN(Best_Company_Name_Rank_)));
    SELF.Best_S_I_C_Codes_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Best_S_I_C_Codes_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Best_S_I_C_Code_) OR __NN(Best_S_I_C_Code_Rank_)));
    SELF.Best_N_A_I_C_S_Codes_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Best_N_A_I_C_S_Codes_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Best_N_A_I_C_S_Code_) OR __NN(Best_N_A_I_C_S_Code_Rank_)));
    SELF.O_S_H_A_Inspection_ := __CN(PROJECT(DATASET(__r),TRANSFORM(O_S_H_A_Inspection_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(O_S_H_A_Inspection_Opening_Date_) OR __NN(O_S_H_A_Inspection_Close_Date_) OR __NN(O_S_H_A_Advance_Notice_Flag_) OR __NN(O_S_H_A_Union_Flag_) OR __NN(O_S_H_A_Inspection_Type_) OR __NN(O_S_H_A_Inspection_Type_Code_) OR __NN(O_S_H_A_Inspection_Scope_) OR __NN(O_S_H_A_Walk_Around_Flag_) OR __NN(O_S_H_A_Employees_Interviewed_Flag_) OR __NN(O_S_H_A_No_Inspection_Code_) OR __NN(O_S_H_A_Case_Closed_Flag_) OR __NN(O_S_H_A_Previous_Activity_Type_) OR __NN(O_S_H_A_Previous_Activity_Type_Description_)));
    SELF.O_S_H_A_Violations_ := __CN(PROJECT(DATASET(__r),TRANSFORM(O_S_H_A_Violations_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(O_S_H_A_Total_Violations_) OR __NN(O_S_H_A_Total_Serious_Violations_) OR __NN(O_S_H_A_Number_Of_Violations_) OR __NN(O_S_H_A_Number_Of_Events_) OR __NN(O_S_H_A_Number_Of_Hazardous_Substance_) OR __NN(O_S_H_A_Number_Of_Accidents_) OR __NN(O_S_H_A_Safety_Health_Flag_)));
    SELF.O_S_H_A_Business_Information_ := __CN(PROJECT(DATASET(__r),TRANSFORM(O_S_H_A_Business_Information_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(O_S_H_A_Owner_Type_) OR __NN(O_S_H_A_Owner_Type_Description_) OR __NN(O_S_H_A_Employee_Count12_Months_)));
    SELF.Vendor_Dates_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Vendor_Dates_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Process_Date_) OR __NN(Source_)));
    SELF.Associated_Address_Type_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Associated_Address_Type_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Associated_Addr_Commercial_) OR __NN(Associated_Addr_Residential_)));
    SELF.Business_Characteristics_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Business_Characteristics_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Year_Established_) OR __NN(Public_Private_Indicator_) OR __NN(Corporation_Code_) OR __NN(Date_Last_Seen_Location_) OR __NN(Location_Corp_Hierarchy_) OR __NN(Is_S_B_E_) OR __NN(Is_Small_Business_Home_Office_) OR __NN(Is_Not_S_B_E_) OR __NN(Is_Goverment_) OR __NN(Is_Federal_Goverment_) OR __NN(Goverment_Type_) OR __NN(Is_Non_Profit_) OR __NN(Minority_Woman_Status_) OR __NN(Is_N_M_S_D_C_Certified_) OR __NN(Is_W_B_E_N_C_Certified_) OR __NN(Is_California_P_U_C_Certified_) OR __NN(Is_Texas_H_U_B_Certified_) OR __NN(Is_California_Caltrans_Certified_) OR __NN(Is_Educational_Institution_) OR __NN(Is_Minority_Institue_) OR __NN(Is_Alaska_Native_Corporation_) OR __NN(Is_S_B_A_H_U_B_Zone_) OR __NN(Is_Hist_Black_College_) OR __NN(Merchant_Type_) OR __NN(Employee_Count_) OR __NN(Employee_Count_Code_) OR __NN(Business_Size_) OR __NN(Financial_Amount_Figure_) OR __NN(Financial_Amount_Code_) OR __NN(Financial_Amount_Type_) OR __NN(Financial_Amount_Precision_) OR __NN(Source_)));
    SELF.Location_Status_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Location_Status_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Company_Status_) OR __NN(Is_Closed_) OR __NN(Date_Closed_) OR __NN(Is_Dead_) OR __NN(Date_Dead_)));
    SELF.Marketability_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Marketability_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(General_Marketability_Score_) OR __NN(General_Marketability_Indicator_) OR __NN(Is_Vacant_) OR __NN(Is_Seasonal_) OR __NN(U_R_L_)));
    SELF.Business_Owned_Characteristics_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Business_Owned_Characteristics_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Is_Minority_Owned_) OR __NN(Is_Woman_Owned_) OR __NN(Is_Woman_Owned_S_B_E_) OR __NN(Is_Minority_Woman_Owned_) OR __NN(Is_Disadvantage_Owned_) OR __NN(Is_Veteran_Owned_) OR __NN(Is_Veteran_Owned_S_B_E_) OR __NN(Is_Disabled_Vet_Owned_) OR __NN(Is_Disabled_Vet_Owned_S_B_E_) OR __NN(Is_S_B_A_Disadvantaged_Owned_) OR __NN(Is_S_B_A8_A_Owned_) OR __NN(S_B_A8_A_Owned_Date_) OR __NN(Is_Disabled_Owned_) OR __NN(Is_Gay_Lesbian_Owned_)));
    SELF.Contacts_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Contacts_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Contact_First_Name_) OR __NN(Contact_Middle_Name_) OR __NN(Contact_Last_Name_) OR __NN(Contact_Name_Suffix_) OR __NN(Contact_Primary_Range_) OR __NN(Contact_Predirectional_) OR __NN(Contact_Primary_Name_) OR __NN(Contact_Suffix_) OR __NN(Contact_Postdirectional_) OR __NN(Contact_Secondary_Range_) OR __NN(Contact_State_) OR __NN(Contact_Z_I_P5_) OR __NN(Contact_S_S_N_) OR __NN(Contact_Phone_Number_) OR __NN(Contact_Score_) OR __NN(Contact_Type_) OR __NN(Contact_Job_Title_) OR __NN(Contact_Status_) OR __NN(Contact_Is_Executive_) OR __NN(Contact_Executive_Order_) OR __NN(Is_Contact_) OR __NN(Contact_Email_) OR __NN(Contact_Email_Username_) OR __NN(Contact_Email_Domain_) OR __NN(Date_Regustered_Agent_Resigned_) OR __NN(Header_Hit_Flag_) OR __NN(Source_)));
    SELF.Data_Sources_ := __CN(PROJECT(DATASET(__r),TRANSFORM(Data_Sources_Layout,SELF.__RecordCount:=1;,SELF.Archive___Date_:=KEL.era.SimpleRollSingleRow(LEFT,Archive___Date_,FALSE),SELF.Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_First_Seen_,FALSE),SELF.Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Last_Seen_,FALSE),SELF.Date_Vendor_First_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_First_Reported_,FALSE),SELF.Date_Vendor_Last_Reported_:=KEL.era.SimpleRollSingleRow(LEFT,Date_Vendor_Last_Reported_,FALSE),SELF.Hybrid_Archive_Date_:=KEL.era.SimpleRollSingleRow(LEFT,Hybrid_Archive_Date_,FALSE),SELF.Vault_Date_First_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_First_Seen_,FALSE),SELF.Vault_Date_Last_Seen_:=KEL.era.SimpleRollSingleRow(LEFT,Vault_Date_Last_Seen_,FALSE),SELF:=LEFT))(__NN(Source_) OR __NN(Header_Hit_Flag_) OR __NN(Record_Status_)));
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d0(Date_Vendor_First_Reported_=0)),COUNT(__d0(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d0(Date_Vendor_Last_Reported_=0)),COUNT(__d0(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d0(Vault_Date_First_Seen_=0)),COUNT(__d0(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d1(Date_Vendor_First_Reported_=0)),COUNT(__d1(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d1(Date_Vendor_Last_Reported_=0)),COUNT(__d1(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d1(Vault_Date_First_Seen_=0)),COUNT(__d1(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d2(Date_Vendor_First_Reported_=0)),COUNT(__d2(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d2(Date_Vendor_Last_Reported_=0)),COUNT(__d2(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d2(Vault_Date_First_Seen_=0)),COUNT(__d2(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d3(Date_Vendor_First_Reported_=0)),COUNT(__d3(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d3(Date_Vendor_Last_Reported_=0)),COUNT(__d3(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d3(Vault_Date_First_Seen_=0)),COUNT(__d3(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d4(Date_Vendor_First_Reported_=0)),COUNT(__d4(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d4(Date_Vendor_Last_Reported_=0)),COUNT(__d4(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d4(Vault_Date_First_Seen_=0)),COUNT(__d4(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d5(Date_Vendor_First_Reported_=0)),COUNT(__d5(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d5(Date_Vendor_Last_Reported_=0)),COUNT(__d5(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d5(Vault_Date_First_Seen_=0)),COUNT(__d5(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d6(Date_Vendor_First_Reported_=0)),COUNT(__d6(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d6(Date_Vendor_Last_Reported_=0)),COUNT(__d6(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d6(Vault_Date_First_Seen_=0)),COUNT(__d6(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d7(Date_Vendor_First_Reported_=0)),COUNT(__d7(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d7(Date_Vendor_Last_Reported_=0)),COUNT(__d7(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d7(Vault_Date_First_Seen_=0)),COUNT(__d7(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d8(Date_Vendor_First_Reported_=0)),COUNT(__d8(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d8(Date_Vendor_Last_Reported_=0)),COUNT(__d8(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d8(Vault_Date_First_Seen_=0)),COUNT(__d8(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d9(Date_Vendor_First_Reported_=0)),COUNT(__d9(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d9(Date_Vendor_Last_Reported_=0)),COUNT(__d9(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d9(Vault_Date_First_Seen_=0)),COUNT(__d9(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d10(Date_Vendor_First_Reported_=0)),COUNT(__d10(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d10(Date_Vendor_Last_Reported_=0)),COUNT(__d10(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d10(Vault_Date_First_Seen_=0)),COUNT(__d10(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d11(Date_Vendor_First_Reported_=0)),COUNT(__d11(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d11(Date_Vendor_Last_Reported_=0)),COUNT(__d11(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d11(Vault_Date_First_Seen_=0)),COUNT(__d11(Vault_Date_First_Seen_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorFirstReported',COUNT(__d12(Date_Vendor_First_Reported_=0)),COUNT(__d12(Date_Vendor_First_Reported_!=0))},
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','DateVendorLastReported',COUNT(__d12(Date_Vendor_Last_Reported_=0)),COUNT(__d12(Date_Vendor_Last_Reported_!=0))},
    ...
    {'BusinessProx','PublicRecords_KEL.ECL_Functions.Dataset_FDC','VaultDateFirstSeen',COUNT(__d12(Vault_Date_First_Seen_=0)),COUNT(__d12(Vault_Date_First_Seen_!=0))},
