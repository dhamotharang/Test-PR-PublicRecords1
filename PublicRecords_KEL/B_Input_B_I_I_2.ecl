...
EXPORT B_Input_B_I_I_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE63975 := __ENH_Input_B_I_I_3;
  EXPORT __ST28862_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST28862_Layout __ND64064__Project(B_Input_B_I_I_3(__in,__cfg).__ST30569_Layout __PP63516) := TRANSFORM
    __CC3212 := '-99999';
    __CC3217 := '-99998';
    SELF.Bus_Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP63516.Bus_Input_City_Echo_Pop_Value_ = '0'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3212)),__T(__AND(__CN(__PP63516.Bus_Input_City_Echo_Pop_Value_ = '1'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3217)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_City_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3217)))));
    SELF.Bus_Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP63516.Bus_Input_State_Echo_Pop_Value_ = '0'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3212)),__T(__AND(__CN(__PP63516.Bus_Input_State_Echo_Pop_Value_ = '1'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3217)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_State_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3217)))));
    SELF.Bus_Input_Street_Clean_Pop_Value_ := FN_Compile.FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC3212)),__ECAST(KEL.typ.nstr,__CN(__CC3217)));
    SELF.Bus_Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP63516.Bus_Input_Zip_Echo_Pop_Value_ = '0'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3212)),__T(__AND(__CN(__PP63516.Bus_Input_Zip_Echo_Pop_Value_ = '1'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3217)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_Zip4_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3217)))));
    SELF.Bus_Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP63516.Bus_Input_Zip_Echo_Pop_Value_ = '0'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3212)),__T(__AND(__CN(__PP63516.Bus_Input_Zip_Echo_Pop_Value_ = '1'),__OR(__CN(__PP63516.Addr_Not_Populated_),__PP63516.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC3217)),__ECAST(KEL.typ.nstr,FN_Compile.FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_Zip5_Clean_),__ECAST(KEL.typ.nstr,__CN(__CC3217)))));
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile.FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_City_Clean_),__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_State_Clean_),__ECAST(KEL.typ.nstr,__PP63516.Bus_Input_Zip5_Clean_));
    SELF := __PP63516;
  END;
  EXPORT __ENH_Input_B_I_I_2 := PROJECT(__EE63975,__ND64064__Project(LEFT));
END;
