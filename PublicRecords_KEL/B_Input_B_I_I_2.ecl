...
EXPORT B_Input_B_I_I_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE25635 := __E_Input_B_I_I;
  EXPORT __ST18404_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST18404_Layout __ND25633__Project(E_Input_B_I_I(__in,__cfg).Layout __PP25379) := TRANSFORM
    SELF.Addr_Not_Populated_ := IF(FN_Compile.FN_Addr_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP25379.Bus_Input_Street_Echo_),__ECAST(KEL.typ.nstr,__PP25379.Bus_Input_City_Echo_),__ECAST(KEL.typ.nstr,__PP25379.Bus_Input_State_Echo_),__ECAST(KEL.typ.nstr,__PP25379.Bus_Input_Zip_Echo_)),TRUE,FALSE);
    SELF := __PP25379;
  END;
  EXPORT __ENH_Input_B_I_I_2 := PROJECT(__EE25635,__ND25633__Project(LEFT));
END;
