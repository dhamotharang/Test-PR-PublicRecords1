...
EXPORT E_Email(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  EXPORT SanityCheck := DATASET([{COUNT(PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DX_Email__Key_Email_Payload_Invalid),COUNT(Email_Address__SingleValue_Invalid),COUNT(Email_Rec_Key__SingleValue_Invalid),COUNT(Rules__SingleValue_Invalid),COUNT(User_Name__SingleValue_Invalid),COUNT(Domain_Name__SingleValue_Invalid),COUNT(Domain_Type__SingleValue_Invalid),COUNT(Domain_Root__SingleValue_Invalid),COUNT(Domain_Extension__SingleValue_Invalid),COUNT(Is_Top_Level_Domain_State__SingleValue_Invalid),COUNT(Is_Top_Level_Domain_Generic__SingleValue_Invalid),COUNT(Is_Top_Level_Domain_Country__SingleValue_Invalid),COUNT(Orig_Login_Date__SingleValue_Invalid),COUNT(Orig_Site__SingleValue_Invalid),COUNT(E360_I_D__SingleValue_Invalid),COUNT(Teramedia_I_D__SingleValue_Invalid),COUNT(Process_Date__SingleValue_Invalid),COUNT(Active_Code__SingleValue_Invalid),COUNT(Date_Vendor_First_Reported__SingleValue_Invalid),COUNT(Date_Vendor_Last_Reported__SingleValue_Invalid),COUNT(Company_Name__SingleValue_Invalid),COUNT(Company_Title__SingleValue_Invalid)}],{KEL.typ.int PublicRecords_KEL_ECL_Functions_Dataset_FDC_Dataset_DX_Email__Key_Email_Payload_Invalid,KEL.typ.int Email_Address__SingleValue_Invalid,KEL.typ.int Email_Rec_Key__SingleValue_Invalid,KEL.typ.int Rules__SingleValue_Invalid,KEL.typ.int User_Name__SingleValue_Invalid,KEL.typ.int Domain_Name__SingleValue_Invalid,KEL.typ.int Domain_Type__SingleValue_Invalid,KEL.typ.int Domain_Root__SingleValue_Invalid,KEL.typ.int Domain_Extension__SingleValue_Invalid,KEL.typ.int Is_Top_Level_Domain_State__SingleValue_Invalid,KEL.typ.int Is_Top_Level_Domain_Generic__SingleValue_Invalid,KEL.typ.int Is_Top_Level_Domain_Country__SingleValue_Invalid,KEL.typ.int Orig_Login_Date__SingleValue_Invalid,KEL.typ.int Orig_Site__SingleValue_Invalid,KEL.typ.int E360_I_D__SingleValue_Invalid,KEL.typ.int Teramedia_I_D__SingleValue_Invalid,KEL.typ.int Process_Date__SingleValue_Invalid,KEL.typ.int Active_Code__SingleValue_Invalid,KEL.typ.int Date_Vendor_First_Reported__SingleValue_Invalid,KEL.typ.int Date_Vendor_Last_Reported__SingleValue_Invalid,KEL.typ.int Company_Name__SingleValue_Invalid,KEL.typ.int Company_Title__SingleValue_Invalid});
