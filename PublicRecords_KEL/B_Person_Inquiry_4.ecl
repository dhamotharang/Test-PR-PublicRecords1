...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5850137 := __ENH_Person_Inquiry_5;
  EXPORT __ST788974_Layout := RECORD
  ...
  EXPORT __ST255280_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255280_Layout __ND5850123__Project(B_Person_Inquiry_5(__in,__cfg).__ST262263_Layout __PP5849837) := TRANSFORM
    __EE5850121 := __PP5849837.Gather_Inquiries_;
    __ST788974_Layout __ND5850072__Project(B_Person_Inquiry_5(__in,__cfg).__ST591588_Layout __PP5849862) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5849862.Is_Banking_ OR __PP5849862.Is_Auto_Srch_ OR __PP5849862.Is_Retail_ OR __PP5849862.Is_Mortgage_ OR __PP5849862.Is_Utility_ OR __PP5849862.Is_Prepaid_Card_ OR __PP5849862.Is_Communications_ OR __PP5849862.Is_Student_Loan_ OR __PP5849862.Is_Retail_Payment_ OR __PP5849862.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5849862.Valid_Inquiries_,__CN(__PP5849862.Is_Retail_));
      SELF := __PP5849862;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5850121,__ND5850072__Project(LEFT));
    SELF := __PP5849837;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5850137,__ND5850123__Project(LEFT));
END;
