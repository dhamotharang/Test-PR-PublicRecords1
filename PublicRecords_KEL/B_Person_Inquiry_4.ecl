...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5912121 := __ENH_Person_Inquiry_5;
  EXPORT __ST794455_Layout := RECORD
  ...
  EXPORT __ST256977_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256977_Layout __ND5912107__Project(B_Person_Inquiry_5(__in,__cfg).__ST263983_Layout __PP5911821) := TRANSFORM
    __EE5912105 := __PP5911821.Gather_Inquiries_;
    __ST794455_Layout __ND5912056__Project(B_Person_Inquiry_5(__in,__cfg).__ST596914_Layout __PP5911846) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5911846.Is_Banking_ OR __PP5911846.Is_Auto_Srch_ OR __PP5911846.Is_Retail_ OR __PP5911846.Is_Mortgage_ OR __PP5911846.Is_Utility_ OR __PP5911846.Is_Prepaid_Card_ OR __PP5911846.Is_Communications_ OR __PP5911846.Is_Student_Loan_ OR __PP5911846.Is_Retail_Payment_ OR __PP5911846.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5911846.Valid_Inquiries_,__CN(__PP5911846.Is_Retail_));
      SELF := __PP5911846;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5912105,__ND5912056__Project(LEFT));
    SELF := __PP5911821;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5912121,__ND5912107__Project(LEFT));
END;
