...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6942059 := __ENH_Person_Inquiry_5;
  EXPORT __ST857024_Layout := RECORD
  ...
  EXPORT __ST272058_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST272058_Layout __ND6942045__Project(B_Person_Inquiry_5(__in,__cfg).__ST279369_Layout __PP6941759) := TRANSFORM
    __EE6942043 := __PP6941759.Gather_Inquiries_;
    __ST857024_Layout __ND6941994__Project(B_Person_Inquiry_5(__in,__cfg).__ST632020_Layout __PP6941784) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP6941784.Is_Banking_ OR __PP6941784.Is_Auto_Srch_ OR __PP6941784.Is_Retail_ OR __PP6941784.Is_Mortgage_ OR __PP6941784.Is_Utility_ OR __PP6941784.Is_Prepaid_Card_ OR __PP6941784.Is_Communications_ OR __PP6941784.Is_Student_Loan_ OR __PP6941784.Is_Retail_Payment_ OR __PP6941784.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP6941784.Valid_Inquiries_,__CN(__PP6941784.Is_Retail_));
      SELF := __PP6941784;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE6942043,__ND6941994__Project(LEFT));
    SELF := __PP6941759;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE6942059,__ND6942045__Project(LEFT));
END;
