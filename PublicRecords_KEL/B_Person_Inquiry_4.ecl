...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5788913 := __ENH_Person_Inquiry_5;
  EXPORT __ST784775_Layout := RECORD
  ...
  EXPORT __ST253956_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST253956_Layout __ND5788899__Project(B_Person_Inquiry_5(__in,__cfg).__ST260905_Layout __PP5788613) := TRANSFORM
    __EE5788897 := __PP5788613.Gather_Inquiries_;
    __ST784775_Layout __ND5788848__Project(B_Person_Inquiry_5(__in,__cfg).__ST589958_Layout __PP5788638) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5788638.Is_Banking_ OR __PP5788638.Is_Auto_Srch_ OR __PP5788638.Is_Retail_ OR __PP5788638.Is_Mortgage_ OR __PP5788638.Is_Utility_ OR __PP5788638.Is_Prepaid_Card_ OR __PP5788638.Is_Communications_ OR __PP5788638.Is_Student_Loan_ OR __PP5788638.Is_Retail_Payment_ OR __PP5788638.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5788638.Valid_Inquiries_,__CN(__PP5788638.Is_Retail_));
      SELF := __PP5788638;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5788897,__ND5788848__Project(LEFT));
    SELF := __PP5788613;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5788913,__ND5788899__Project(LEFT));
END;
