...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5108116 := __ENH_Person_Inquiry_5;
  EXPORT __ST679522_Layout := RECORD
  ...
  EXPORT __ST234599_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234599_Layout __ND5108102__Project(B_Person_Inquiry_5(__in,__cfg).__ST241144_Layout __PP5107816) := TRANSFORM
    __EE5108100 := __PP5107816.Gather_Inquiries_;
    __ST679522_Layout __ND5108051__Project(B_Person_Inquiry_5(__in,__cfg).__ST502638_Layout __PP5107841) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5107841.Is_Banking_ OR __PP5107841.Is_Auto_Srch_ OR __PP5107841.Is_Retail_ OR __PP5107841.Is_Mortgage_ OR __PP5107841.Is_Utility_ OR __PP5107841.Is_Prepaid_Card_ OR __PP5107841.Is_Communications_ OR __PP5107841.Is_Student_Loan_ OR __PP5107841.Is_Retail_Payment_ OR __PP5107841.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5107841.Valid_Inquiries_,__CN(__PP5107841.Is_Retail_));
      SELF := __PP5107841;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5108100,__ND5108051__Project(LEFT));
    SELF := __PP5107816;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5108116,__ND5108102__Project(LEFT));
END;
