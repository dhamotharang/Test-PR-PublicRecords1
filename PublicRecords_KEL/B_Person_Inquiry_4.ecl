...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5389963 := __ENH_Person_Inquiry_5;
  EXPORT __ST712713_Layout := RECORD
  ...
  EXPORT __ST241846_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST241846_Layout __ND5389949__Project(B_Person_Inquiry_5(__in,__cfg).__ST248584_Layout __PP5389663) := TRANSFORM
    __EE5389947 := __PP5389663.Gather_Inquiries_;
    __ST712713_Layout __ND5389898__Project(B_Person_Inquiry_5(__in,__cfg).__ST521119_Layout __PP5389688) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5389688.Is_Banking_ OR __PP5389688.Is_Auto_Srch_ OR __PP5389688.Is_Retail_ OR __PP5389688.Is_Mortgage_ OR __PP5389688.Is_Utility_ OR __PP5389688.Is_Prepaid_Card_ OR __PP5389688.Is_Communications_ OR __PP5389688.Is_Student_Loan_ OR __PP5389688.Is_Retail_Payment_ OR __PP5389688.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5389688.Valid_Inquiries_,__CN(__PP5389688.Is_Retail_));
      SELF := __PP5389688;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5389947,__ND5389898__Project(LEFT));
    SELF := __PP5389663;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5389963,__ND5389949__Project(LEFT));
END;
