...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5414625 := __ENH_Person_Inquiry_5;
  EXPORT __ST715220_Layout := RECORD
  ...
  EXPORT __ST243486_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST243486_Layout __ND5414611__Project(B_Person_Inquiry_5(__in,__cfg).__ST250241_Layout __PP5414325) := TRANSFORM
    __EE5414609 := __PP5414325.Gather_Inquiries_;
    __ST715220_Layout __ND5414560__Project(B_Person_Inquiry_5(__in,__cfg).__ST522899_Layout __PP5414350) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5414350.Is_Banking_ OR __PP5414350.Is_Auto_Srch_ OR __PP5414350.Is_Retail_ OR __PP5414350.Is_Mortgage_ OR __PP5414350.Is_Utility_ OR __PP5414350.Is_Prepaid_Card_ OR __PP5414350.Is_Communications_ OR __PP5414350.Is_Student_Loan_ OR __PP5414350.Is_Retail_Payment_ OR __PP5414350.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5414350.Valid_Inquiries_,__CN(__PP5414350.Is_Retail_));
      SELF := __PP5414350;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5414609,__ND5414560__Project(LEFT));
    SELF := __PP5414325;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5414625,__ND5414611__Project(LEFT));
END;
