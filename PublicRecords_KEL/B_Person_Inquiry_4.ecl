...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6539292 := __ENH_Person_Inquiry_5;
  EXPORT __ST849357_Layout := RECORD
  ...
  EXPORT __ST265508_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST265508_Layout __ND6539278__Project(B_Person_Inquiry_5(__in,__cfg).__ST272716_Layout __PP6538992) := TRANSFORM
    __EE6539276 := __PP6538992.Gather_Inquiries_;
    __ST849357_Layout __ND6539227__Project(B_Person_Inquiry_5(__in,__cfg).__ST632953_Layout __PP6539017) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP6539017.Is_Banking_ OR __PP6539017.Is_Auto_Srch_ OR __PP6539017.Is_Retail_ OR __PP6539017.Is_Mortgage_ OR __PP6539017.Is_Utility_ OR __PP6539017.Is_Prepaid_Card_ OR __PP6539017.Is_Communications_ OR __PP6539017.Is_Student_Loan_ OR __PP6539017.Is_Retail_Payment_ OR __PP6539017.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP6539017.Valid_Inquiries_,__CN(__PP6539017.Is_Retail_));
      SELF := __PP6539017;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE6539276,__ND6539227__Project(LEFT));
    SELF := __PP6538992;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE6539292,__ND6539278__Project(LEFT));
END;
