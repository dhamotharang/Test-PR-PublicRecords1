...
EXPORT B_Person_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5114080 := __ENH_Person_Inquiry_5;
  EXPORT __ST679317_Layout := RECORD
  ...
  EXPORT __ST234441_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST234441_Layout __ND5114066__Project(B_Person_Inquiry_5(__in,__cfg).__ST240986_Layout __PP5113780) := TRANSFORM
    __EE5114064 := __PP5113780.Gather_Inquiries_;
    __ST679317_Layout __ND5114015__Project(B_Person_Inquiry_5(__in,__cfg).__ST502433_Layout __PP5113805) := TRANSFORM
      SELF.Is_Other_ := NOT (__PP5113805.Is_Banking_ OR __PP5113805.Is_Auto_Srch_ OR __PP5113805.Is_Retail_ OR __PP5113805.Is_Mortgage_ OR __PP5113805.Is_Utility_ OR __PP5113805.Is_Prepaid_Card_ OR __PP5113805.Is_Communications_ OR __PP5113805.Is_Student_Loan_ OR __PP5113805.Is_Retail_Payment_ OR __PP5113805.Is_Quiz_Provider_);
      SELF.Valid_Retail_ := __AND(__PP5113805.Valid_Inquiries_,__CN(__PP5113805.Is_Retail_));
      SELF := __PP5113805;
    END;
    SELF.Gather_Inquiries_ := __PROJECT(__EE5114064,__ND5114015__Project(LEFT));
    SELF := __PP5113780;
  END;
  EXPORT __ENH_Person_Inquiry_4 := PROJECT(__EE5114080,__ND5114066__Project(LEFT));
END;
