...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5511903 := __ENH_Tradeline_7;
  EXPORT __ST260368_Layout := RECORD
  ...
  END;
  EXPORT __ST260361_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST260368_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260361_Layout __ND5511877__Project(B_Tradeline_7(__in,__cfg).__ST263687_Layout __PP5511610) := TRANSFORM
    __EE5511906 := __PP5511610.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5511906),__ST260368_Layout),__NL(__EE5511906));
    __EE5511872 := __PP5511610.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5511872,__T(__EE5511872).Record_Age_In_Days1_Y_);
    SELF := __PP5511610;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5511903,__ND5511877__Project(LEFT));
END;
