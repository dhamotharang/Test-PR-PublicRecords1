...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5513489 := __ENH_Tradeline_7;
  EXPORT __ST260338_Layout := RECORD
  ...
  END;
  EXPORT __ST260331_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST260338_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST260331_Layout __ND5513463__Project(B_Tradeline_7(__in,__cfg).__ST263657_Layout __PP5513196) := TRANSFORM
    __EE5513492 := __PP5513196.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5513492),__ST260338_Layout),__NL(__EE5513492));
    __EE5513458 := __PP5513196.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5513458,__T(__EE5513458).Record_Age_In_Days1_Y_);
    SELF := __PP5513196;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5513489,__ND5513463__Project(LEFT));
END;
