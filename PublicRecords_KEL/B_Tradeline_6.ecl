...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5646041 := __ENH_Tradeline_7;
  EXPORT __ST270450_Layout := RECORD
  ...
  END;
  EXPORT __ST270443_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST270450_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST270443_Layout __ND5646015__Project(B_Tradeline_7(__in,__cfg).__ST273877_Layout __PP5645748) := TRANSFORM
    __EE5646044 := __PP5645748.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5646044),__ST270450_Layout),__NL(__EE5646044));
    __EE5646010 := __PP5645748.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5646010,__T(__EE5646010).Record_Age_In_Days1_Y_);
    SELF := __PP5645748;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5646041,__ND5646015__Project(LEFT));
END;
