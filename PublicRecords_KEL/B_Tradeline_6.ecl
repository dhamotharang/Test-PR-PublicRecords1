...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5154600 := __ENH_Tradeline_7;
  ...
  EXPORT __ST256364_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST256371_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256364_Layout __ND5154574__Project(B_Tradeline_7(__in,__cfg).__ST259605_Layout __PP5154307) := TRANSFORM
    __EE5154603 := __PP5154307.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5154603),__ST256371_Layout),__NL(__EE5154603));
    __EE5154569 := __PP5154307.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5154569,__T(__EE5154569).Record_Age_In_Days1_Y_);
    SELF := __PP5154307;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5154600,__ND5154574__Project(LEFT));
END;
