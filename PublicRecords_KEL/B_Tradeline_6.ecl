...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4724709 := __ENH_Tradeline_7;
  EXPORT __ST251347_Layout := RECORD
  ...
  END;
  EXPORT __ST251340_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST251347_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST251340_Layout __ND4724683__Project(B_Tradeline_7(__in,__cfg).__ST254266_Layout __PP4724416) := TRANSFORM
    __EE4724712 := __PP4724416.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE4724712),__ST251347_Layout),__NL(__EE4724712));
    __EE4724678 := __PP4724416.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE4724678,__T(__EE4724678).Record_Age_In_Days1_Y_);
    SELF := __PP4724416;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE4724709,__ND4724683__Project(LEFT));
END;
