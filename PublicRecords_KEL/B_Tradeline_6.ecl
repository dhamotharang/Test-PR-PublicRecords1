...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5355522 := __ENH_Tradeline_7;
  EXPORT __ST255454_Layout := RECORD
  ...
  END;
  EXPORT __ST255447_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST255454_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST255447_Layout __ND5355496__Project(B_Tradeline_7(__in,__cfg).__ST258595_Layout __PP5355229) := TRANSFORM
    __EE5355525 := __PP5355229.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5355525),__ST255454_Layout),__NL(__EE5355525));
    __EE5355491 := __PP5355229.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5355491,__T(__EE5355491).Record_Age_In_Days1_Y_);
    SELF := __PP5355229;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5355522,__ND5355496__Project(LEFT));
END;
