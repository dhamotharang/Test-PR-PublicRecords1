...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5642666 := __ENH_Tradeline_7;
  EXPORT __ST270180_Layout := RECORD
  ...
  END;
  EXPORT __ST270173_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST270180_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST270173_Layout __ND5642640__Project(B_Tradeline_7(__in,__cfg).__ST273458_Layout __PP5642373) := TRANSFORM
    __EE5642669 := __PP5642373.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5642669),__ST270180_Layout),__NL(__EE5642669));
    __EE5642635 := __PP5642373.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5642635,__T(__EE5642635).Record_Age_In_Days1_Y_);
    SELF := __PP5642373;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5642666,__ND5642640__Project(LEFT));
END;
