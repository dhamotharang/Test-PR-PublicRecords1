...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5161957 := __ENH_Tradeline_7;
  EXPORT __ST256789_Layout := RECORD
  ...
  EXPORT __ST256782_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST256789_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST256782_Layout __ND5161931__Project(B_Tradeline_7(__in,__cfg).__ST260023_Layout __PP5161664) := TRANSFORM
    __EE5161960 := __PP5161664.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5161960),__ST256789_Layout),__NL(__EE5161960));
    __EE5161926 := __PP5161664.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5161926,__T(__EE5161926).Record_Age_In_Days1_Y_);
    SELF := __PP5161664;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5161957,__ND5161931__Project(LEFT));
END;
