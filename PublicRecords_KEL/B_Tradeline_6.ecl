...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5328541 := __ENH_Tradeline_7;
  EXPORT __ST254043_Layout := RECORD
  ...
  END;
  EXPORT __ST254036_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST254043_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254036_Layout __ND5328515__Project(B_Tradeline_7(__in,__cfg).__ST257184_Layout __PP5328248) := TRANSFORM
    __EE5328544 := __PP5328248.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5328544),__ST254043_Layout),__NL(__EE5328544));
    __EE5328510 := __PP5328248.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5328510,__T(__EE5328510).Record_Age_In_Days1_Y_);
    SELF := __PP5328248;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5328541,__ND5328515__Project(LEFT));
END;
