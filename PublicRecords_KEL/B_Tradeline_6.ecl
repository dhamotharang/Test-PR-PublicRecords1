...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE378044 := __ENH_Tradeline_7;
  EXPORT __ST164514_Layout := RECORD
  ...
  END;
  EXPORT __ST164507_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST164514_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST164507_Layout __ND378018__Project(B_Tradeline_7(__in,__cfg).__ST166859_Layout __PP377477) := TRANSFORM
    __EE378047 := __PP377477.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE378047),__ST164514_Layout),__NL(__EE378047));
    __EE378013 := __PP377477.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE378013,__T(__EE378013).Record_Age_In_Days1_Y_);
    SELF := __PP377477;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE378044,__ND378018__Project(LEFT));
END;
