...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE135504 := __ENH_Tradeline_7;
  ...
  END;
  EXPORT __ST109055_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST109062_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST109055_Layout __ND135477__Project(B_Tradeline_7(__in,__cfg).__ST109472_Layout __PP134924) := TRANSFORM
    __EE135507 := __PP134924.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE135507),__ST109062_Layout),__NL(__EE135507));
    __EE135472 := __PP134924.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE135472,__T(__EE135472).Record_Age_In_Days1_Y_);
    SELF := __PP134924;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE135504,__ND135477__Project(LEFT));
END;
