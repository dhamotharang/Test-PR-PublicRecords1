...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE109640 := __ENH_Tradeline_7;
  ...
  END;
  EXPORT __ST87780_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST87787_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST87780_Layout __ND109613__Project(B_Tradeline_7(__in,__cfg).__ST88057_Layout __PP109060) := TRANSFORM
    __EE109643 := __PP109060.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE109643),__ST87787_Layout),__NL(__EE109643));
    __EE109608 := __PP109060.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE109608,__T(__EE109608).Record_Age_In_Days1_Y_);
    SELF := __PP109060;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE109640,__ND109613__Project(LEFT));
END;
