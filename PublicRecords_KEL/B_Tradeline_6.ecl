...
EXPORT B_Tradeline_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5130188 := __ENH_Tradeline_7;
  EXPORT __ST254697_Layout := RECORD
  ...
  END;
  EXPORT __ST254690_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST254697_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST254690_Layout __ND5130162__Project(B_Tradeline_7(__in,__cfg).__ST257927_Layout __PP5129895) := TRANSFORM
    __EE5130191 := __PP5129895.Records_;
    SELF.Records_ := __BN(PROJECT(__T(__EE5130191),__ST254697_Layout),__NL(__EE5130191));
    __EE5130157 := __PP5129895.Records_;
    SELF.Newest_Record_Age_In_Days1_Y_ := KEL.Aggregates.MinNN(__EE5130157,__T(__EE5130157).Record_Age_In_Days1_Y_);
    SELF := __PP5129895;
  END;
  EXPORT __ENH_Tradeline_6 := PROJECT(__EE5130188,__ND5130162__Project(LEFT));
END;
