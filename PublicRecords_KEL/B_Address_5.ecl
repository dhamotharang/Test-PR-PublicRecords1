...
EXPORT B_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE4884547 := __ENH_Address_6;
  ...
  END;
  SHARED __ST237103_Layout __ND4884381__Project(B_Address_6(__in,__cfg).__ST243212_Layout __PP4883694) := TRANSFORM
    __EE4884376 := __PP4883694.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE4884376))[1].Residential_Or_Business_Indicator_;
    __EE4884391 := __PP4883694.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE4884391))[1].Vacancy_Indicator_;
    SELF := __PP4883694;
  END;
  EXPORT __ENH_Address_5 := PROJECT(__EE4884547,__ND4884381__Project(LEFT));
END;
