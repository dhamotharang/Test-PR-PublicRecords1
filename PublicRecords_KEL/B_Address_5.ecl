...
EXPORT B_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5329725 := __ENH_Address_6;
  EXPORT __ST243208_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST243208_Layout __ND5329559__Project(B_Address_6(__in,__cfg).__ST249583_Layout __PP5328872) := TRANSFORM
    __EE5329554 := __PP5328872.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE5329554))[1].Residential_Or_Business_Indicator_;
    __EE5329569 := __PP5328872.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE5329569))[1].Vacancy_Indicator_;
    SELF := __PP5328872;
  END;
  EXPORT __ENH_Address_5 := PROJECT(__EE5329725,__ND5329559__Project(LEFT));
END;
