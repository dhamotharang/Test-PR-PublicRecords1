...
EXPORT B_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE5647225 := __ENH_Address_6;
  EXPORT __ST259093_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST259093_Layout __ND5647059__Project(B_Address_6(__in,__cfg).__ST265695_Layout __PP5646372) := TRANSFORM
    __EE5647054 := __PP5646372.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE5647054))[1].Residential_Or_Business_Indicator_;
    __EE5647069 := __PP5646372.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE5647069))[1].Vacancy_Indicator_;
    SELF := __PP5646372;
  END;
  EXPORT __ENH_Address_5 := PROJECT(__EE5647225,__ND5647059__Project(LEFT));
END;
