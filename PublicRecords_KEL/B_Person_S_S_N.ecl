...
EXPORT B_Person_S_S_N(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE425088 := __E_Person_S_S_N;
  EXPORT __ST26468_Layout := RECORD
  ...
  END;
  SHARED __ST26468_Layout __ND425153__Project(E_Person_S_S_N(__in,__cfg).Layout __PP425013) := TRANSFORM
