...
EXPORT B_Tradeline_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6561054 := __ENH_Tradeline_4;
  EXPORT __ST233484_Layout := RECORD
  ...
  END;
  EXPORT __ST233477_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST233484_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST233477_Layout __ND6561019__Project(B_Tradeline_4(__in,__cfg).__ST244333_Layout __PP6560370) := TRANSFORM
    __EE6561057 := __PP6560370.Records_;
    __ST233484_Layout __ND6560418__Project(B_Tradeline_4(__in,__cfg).__ST244340_Layout __PP6560414) := TRANSFORM
      SELF.D_P_D1_Total_ := __OP2(__OP2(__OP2(__PP6560414.Aging1_To30_L_N_,+,__PP6560414.Aging31_To60_L_N_),+,__PP6560414.Aging61_To90_L_N_),+,__PP6560414.Aging91_Plus_L_N_);
      SELF.D_P_D31_Total_ := __OP2(__OP2(__PP6560414.Aging31_To60_L_N_,+,__PP6560414.Aging61_To90_L_N_),+,__PP6560414.Aging91_Plus_L_N_);
      SELF.D_P_D61_Total_ := __OP2(__PP6560414.Aging61_To90_L_N_,+,__PP6560414.Aging91_Plus_L_N_);
      SELF.D_P_D91_Total_ := __PP6560414.Aging91_Plus_L_N_;
      SELF := __PP6560414;
    END;
    SELF.Records_ := __PROJECT(__EE6561057,__ND6560418__Project(LEFT));
    __EE6560993 := __PP6560370.Records_;
    __EE6561008 := __PP6560370.Records_;
    __BS6560994 := __T(__EE6560993);
    __EE6561014 := __BS6560994(__T(__OP2(__T(__EE6560993).Record_Age_In_Days_,=,KEL.Aggregates.MinNN(__EE6561008,__T(__EE6561008).Record_Age_In_Days_))));
    SELF.Total_A_R_L_N_ := (__EE6561014)[1].Total_A_R_L_N_;
    SELF := __PP6560370;
  END;
  EXPORT __ENH_Tradeline_3 := PROJECT(__EE6561054,__ND6561019__Project(LEFT));
END;
