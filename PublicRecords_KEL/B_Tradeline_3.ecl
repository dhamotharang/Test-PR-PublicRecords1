...
EXPORT B_Tradeline_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE6999214 := __ENH_Tradeline_4;
  EXPORT __ST247675_Layout := RECORD
  ...
  END;
  EXPORT __ST247668_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST247675_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST247668_Layout __ND6999179__Project(B_Tradeline_4(__in,__cfg).__ST258736_Layout __PP6998530) := TRANSFORM
    __EE6999217 := __PP6998530.Records_;
    __ST247675_Layout __ND6998578__Project(B_Tradeline_4(__in,__cfg).__ST258743_Layout __PP6998574) := TRANSFORM
      SELF.D_P_D1_Total_ := __OP2(__OP2(__OP2(__PP6998574.Aging1_To30_L_N_,+,__PP6998574.Aging31_To60_L_N_),+,__PP6998574.Aging61_To90_L_N_),+,__PP6998574.Aging91_Plus_L_N_);
      SELF.D_P_D31_Total_ := __OP2(__OP2(__PP6998574.Aging31_To60_L_N_,+,__PP6998574.Aging61_To90_L_N_),+,__PP6998574.Aging91_Plus_L_N_);
      SELF.D_P_D61_Total_ := __OP2(__PP6998574.Aging61_To90_L_N_,+,__PP6998574.Aging91_Plus_L_N_);
      SELF.D_P_D91_Total_ := __PP6998574.Aging91_Plus_L_N_;
      SELF := __PP6998574;
    END;
    SELF.Records_ := __PROJECT(__EE6999217,__ND6998578__Project(LEFT));
    __EE6999153 := __PP6998530.Records_;
    __EE6999168 := __PP6998530.Records_;
    __BS6999154 := __T(__EE6999153);
    __EE6999174 := __BS6999154(__T(__OP2(__T(__EE6999153).Record_Age_In_Days_,=,KEL.Aggregates.MinNN(__EE6999168,__T(__EE6999168).Record_Age_In_Days_))));
    SELF.Total_A_R_L_N_ := (__EE6999174)[1].Total_A_R_L_N_;
    SELF := __PP6998530;
  END;
  EXPORT __ENH_Tradeline_3 := PROJECT(__EE6999214,__ND6999179__Project(LEFT));
END;
