...
EXPORT E_Social_Security_Number(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __Mapping2 := 'ssn(UID|S_S_N_:\'\'),officialfirstseen(Official_First_Seen_:DATE),officiallastseen(Official_Last_Seen_:DATE),dateofdeath(Date_Of_Death_:DATE),st(Issue_State_:\'\'),headerfirstseen(Header_First_Seen_:DATE),src(Source_:\'\'),earliest_offense_date(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping3 := 'ssn(UID|S_S_N_:\'\'),officialfirstseen(Official_First_Seen_:DATE),officiallastseen(Official_Last_Seen_:DATE),dateofdeath(Date_Of_Death_:DATE),issuestate(Issue_State_:\'\'),headerfirstseen(Header_First_Seen_:DATE),src(Source_:\'\'),fcra_date(Date_First_Seen_:EPOCH),datelastseen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
  ...
  SHARED __Mapping4 := 'ssn(UID|S_S_N_:\'\'),officialfirstseen(Official_First_Seen_:DATE),officiallastseen(Official_Last_Seen_:DATE),dateofdeath(Date_Of_Death_:DATE),st(Issue_State_:\'\'),headerfirstseen(Header_First_Seen_:DATE),date_first_seen(Date_First_Seen_:EPOCH),date_last_seen(Date_Last_Seen_:EPOCH),DPMBitmap(__Permits:PERMITS)';
