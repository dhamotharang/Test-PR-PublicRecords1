...
EXPORT Q_Non_F_C_R_A_Business_Sele_I_D_No_Dates_Attributes_V1_Dynamic(KEL.typ.int __PUltID_in, KEL.typ.int __POrgID_in, KEL.typ.int __PSeleID_in, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM) := MODULE
  ...
  SHARED __EE12780076 := __ENH_Business_Sele;
  SHARED __EE12781434 := __EE12780076(__T(__AND(__OP2(__EE12780076.Ult_I_D_,=,__CN(__PUltID_in)),__AND(__OP2(__EE12780076.Org_I_D_,=,__CN(__POrgID_in)),__OP2(__EE12780076.Sele_I_D_,=,__CN(__PSeleID_in))))));
  SHARED __ST123901_Layout := RECORD
