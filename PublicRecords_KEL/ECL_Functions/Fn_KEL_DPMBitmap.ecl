...
EXPORT Fn_KEL_DPMBitmap := MODULE
	...
	EXPORT SetValue(STRING Source = '', BOOLEAN FCRA_Restricted = FALSE, BOOLEAN GLBA_Restricted = FALSE, BOOLEAN Pre_GLB_Restricted = FALSE, BOOLEAN DPPA_Restricted = FALSE, STRING DPPA_State = '', BOOLEAN Generic_Restriction = FALSE, BOOLEAN Is_Business_Header = FALSE, STRING Marketing_State = '', BOOLEAN Not_Restricted = FALSE, BOOLEAN Insurance_Product_Restricted = FALSE, UNSIGNED watchdogPermissionsColumn = 0, PublicRecords_KEL.CFG_Compile KELPermissions = PublicRecords_KEL.CFG_Compile, UNSIGNED BIPBitMask = 0) := FUNCTION
		Permissions := 
			...
			IF(MDR.SourceTools.SourceIsDPPA(Source) OR DPPA_Restricted, 
				...
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[1].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup1, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[2].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup2, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[3].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup3, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[4].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup4, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[5].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup5, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[6].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup6, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[7].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup7, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[8].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup8, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[9].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup9, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[10].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup10, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[11].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup11, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[12].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup12, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[13].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup13, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[14].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup14, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[15].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup15, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[16].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup16, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[17].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup17, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[18].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup18, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[19].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup19, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[20].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup20, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[21].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup21, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[22].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup22, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[23].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup23, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[24].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup24, 0) |
				IF(EXISTS(PublicRecords_KEL.ECL_Functions.DPPA_Permits.DPPAGroups[25].States(State = DPPA_State AND IsExperian = MDR.sourceTools.SourceIsExperianVehicle(Source))), KELPermissions.Permit_DPPAGroup25, 0) |
	...
	EXPORT Generate(STRING DataRestrictionMask, STRING DataPermissionMask, UNSIGNED1 GLBA, UNSIGNED1 DPPA, BOOLEAN isFCRA, BOOLEAN isMarketing = FALSE, BOOLEAN AllowDNBDMI = FALSE, BOOLEAN OverrideExperianRestriction = FALSE, STRING PermissiblePurpose, STRING IndustryClass = '', PublicRecords_KEL.CFG_Compile KELPermissions = PublicRecords_KEL.CFG_Compile, BOOLEAN IsInsuranceProduct = FALSE) := FUNCTION
		Permissions := 
			...
			CASE(DPPA,
				1 => PublicRecords_KEL.ECL_Functions.DPPA_Permits.CheckDPPAPermits(RestrictDPPA1, isFCRA),
				2 => PublicRecords_KEL.ECL_Functions.DPPA_Permits.CheckDPPAPermits(RestrictDPPA2, isFCRA),
				3 => PublicRecords_KEL.ECL_Functions.DPPA_Permits.CheckDPPAPermits(RestrictDPPA3, isFCRA),
				4 => PublicRecords_KEL.ECL_Functions.DPPA_Permits.CheckDPPAPermits(RestrictDPPA4, isFCRA),
