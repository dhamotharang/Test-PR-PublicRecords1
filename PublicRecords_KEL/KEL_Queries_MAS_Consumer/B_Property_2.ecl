...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE438116 := __ENH_Property_3;
  EXPORT __ST155403_Layout := RECORD
  ...
  END;
  EXPORT __ST155385_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155403_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155385_Layout __ND438121__Project(B_Property_3(__in,__cfg).__ST156769_Layout __PP438117) := TRANSFORM
    __EE438160 := __PP438117.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE438160),__ST155403_Layout),__NL(__EE438160));
    SELF := __PP438117;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE438116,__ND438121__Project(LEFT));
END;
