...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE436427 := __ENH_Property_3;
  EXPORT __ST153714_Layout := RECORD
  ...
  END;
  EXPORT __ST153696_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST153714_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST153696_Layout __ND436432__Project(B_Property_3(__in,__cfg).__ST155080_Layout __PP436428) := TRANSFORM
    __EE436471 := __PP436428.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE436471),__ST153714_Layout),__NL(__EE436471));
    SELF := __PP436428;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE436427,__ND436432__Project(LEFT));
END;
