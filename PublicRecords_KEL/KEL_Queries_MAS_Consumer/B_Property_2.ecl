...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE436472 := __ENH_Property_3;
  EXPORT __ST153759_Layout := RECORD
  ...
  END;
  EXPORT __ST153741_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST153759_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST153741_Layout __ND436477__Project(B_Property_3(__in,__cfg).__ST155125_Layout __PP436473) := TRANSFORM
    __EE436516 := __PP436473.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE436516),__ST153759_Layout),__NL(__EE436516));
    SELF := __PP436473;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE436472,__ND436477__Project(LEFT));
END;
