...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE437442 := __ENH_Property_3;
  EXPORT __ST154729_Layout := RECORD
  ...
  END;
  EXPORT __ST154711_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST154729_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST154711_Layout __ND437447__Project(B_Property_3(__in,__cfg).__ST156095_Layout __PP437443) := TRANSFORM
    __EE437486 := __PP437443.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE437486),__ST154729_Layout),__NL(__EE437486));
    SELF := __PP437443;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE437442,__ND437447__Project(LEFT));
END;
