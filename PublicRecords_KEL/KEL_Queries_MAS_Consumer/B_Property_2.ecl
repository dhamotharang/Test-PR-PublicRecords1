...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE435825 := __ENH_Property_3;
  EXPORT __ST153112_Layout := RECORD
  ...
  END;
  EXPORT __ST153094_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST153112_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST153094_Layout __ND435830__Project(B_Property_3(__in,__cfg).__ST154478_Layout __PP435826) := TRANSFORM
    __EE435869 := __PP435826.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE435869),__ST153112_Layout),__NL(__EE435869));
    SELF := __PP435826;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE435825,__ND435830__Project(LEFT));
END;
