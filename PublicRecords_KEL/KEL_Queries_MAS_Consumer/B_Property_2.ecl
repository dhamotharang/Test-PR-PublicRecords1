...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE441717 := __ENH_Property_3;
  EXPORT __ST159004_Layout := RECORD
  ...
  END;
  EXPORT __ST158986_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159004_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158986_Layout __ND441722__Project(B_Property_3(__in,__cfg).__ST160370_Layout __PP441718) := TRANSFORM
    __EE441761 := __PP441718.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE441761),__ST159004_Layout),__NL(__EE441761));
    SELF := __PP441718;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE441717,__ND441722__Project(LEFT));
END;
