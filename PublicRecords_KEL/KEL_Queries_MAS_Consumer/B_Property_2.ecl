...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE440449 := __ENH_Property_3;
  EXPORT __ST147899_Layout := RECORD
  ...
  END;
  EXPORT __ST147881_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST147899_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST147881_Layout __ND440454__Project(B_Property_3(__in,__cfg).__ST149274_Layout __PP440450) := TRANSFORM
    __EE440493 := __PP440450.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE440493),__ST147899_Layout),__NL(__EE440493));
    SELF := __PP440450;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE440449,__ND440454__Project(LEFT));
END;
