...
EXPORT B_Property_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE446441 := __ENH_Property_3;
  EXPORT __ST153891_Layout := RECORD
  ...
  END;
  EXPORT __ST153873_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST153891_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST153873_Layout __ND446446__Project(B_Property_3(__in,__cfg).__ST155266_Layout __PP446442) := TRANSFORM
    __EE446485 := __PP446442.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE446485),__ST153891_Layout),__NL(__EE446485));
    SELF := __PP446442;
  END;
  EXPORT __ENH_Property_2 := PROJECT(__EE446441,__ND446446__Project(LEFT));
END;
