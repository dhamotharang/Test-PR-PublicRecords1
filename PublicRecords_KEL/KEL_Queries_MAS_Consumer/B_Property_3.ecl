...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE379213 := __ENH_Property_4;
  EXPORT __ST154325_Layout := RECORD
  ...
  END;
  EXPORT __ST154307_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST154325_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST154307_Layout __ND379218__Project(B_Property_4(__in,__cfg).__ST155169_Layout __PP379214) := TRANSFORM
    __EE379257 := __PP379214.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE379257),__ST154325_Layout),__NL(__EE379257));
    SELF := __PP379214;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE379213,__ND379218__Project(LEFT));
END;
