...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE385276 := __ENH_Property_4;
  EXPORT __ST160388_Layout := RECORD
  ...
  END;
  EXPORT __ST160370_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST160388_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160370_Layout __ND385281__Project(B_Property_4(__in,__cfg).__ST161232_Layout __PP385277) := TRANSFORM
    __EE385320 := __PP385277.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE385320),__ST160388_Layout),__NL(__EE385320));
    SELF := __PP385277;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE385276,__ND385281__Project(LEFT));
END;
