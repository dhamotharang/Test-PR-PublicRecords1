...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE384201 := __ENH_Property_4;
  EXPORT __ST148297_Layout := RECORD
  ...
  END;
  EXPORT __ST148279_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST148297_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST148279_Layout __ND384206__Project(B_Property_4(__in,__cfg).__ST149252_Layout __PP384202) := TRANSFORM
    __EE384245 := __PP384202.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE384245),__ST148297_Layout),__NL(__EE384245));
    SELF := __PP384202;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE384201,__ND384206__Project(LEFT));
END;
