...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE379579 := __ENH_Property_4;
  EXPORT __ST143675_Layout := RECORD
  ...
  END;
  EXPORT __ST143657_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST143675_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST143657_Layout __ND379584__Project(B_Property_4(__in,__cfg).__ST144630_Layout __PP379580) := TRANSFORM
    __EE379623 := __PP379580.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE379623),__ST143675_Layout),__NL(__EE379623));
    SELF := __PP379580;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE379579,__ND379584__Project(LEFT));
END;
