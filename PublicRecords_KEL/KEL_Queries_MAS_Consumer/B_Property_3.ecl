...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE379384 := __ENH_Property_4;
  EXPORT __ST154496_Layout := RECORD
  ...
  END;
  EXPORT __ST154478_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST154496_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST154478_Layout __ND379389__Project(B_Property_4(__in,__cfg).__ST155340_Layout __PP379385) := TRANSFORM
    __EE379428 := __PP379385.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE379428),__ST154496_Layout),__NL(__EE379428));
    SELF := __PP379385;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE379384,__ND379389__Project(LEFT));
END;
