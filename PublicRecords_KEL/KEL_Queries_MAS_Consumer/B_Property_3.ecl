...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE381675 := __ENH_Property_4;
  EXPORT __ST156787_Layout := RECORD
  ...
  END;
  EXPORT __ST156769_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST156787_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156769_Layout __ND381680__Project(B_Property_4(__in,__cfg).__ST157631_Layout __PP381676) := TRANSFORM
    __EE381719 := __PP381676.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE381719),__ST156787_Layout),__NL(__EE381719));
    SELF := __PP381676;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE381675,__ND381680__Project(LEFT));
END;
