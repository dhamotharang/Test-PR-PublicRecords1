...
IMPORT KEL16 AS KEL;
IMPORT B_Property_4,CFG_Compile,E_Property,E_Zip_Code FROM PublicRecords_KEL.KEL_Queries_MAS_Consumer;
...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE383491 := __ENH_Property_4;
  EXPORT __ST149292_Layout := RECORD
  ...
  END;
  EXPORT __ST149274_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST149292_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST149274_Layout __ND383496__Project(B_Property_4(__in,__cfg).__ST150255_Layout __PP383492) := TRANSFORM
    __EE383535 := __PP383492.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE383535),__ST149292_Layout),__NL(__EE383535));
    SELF := __PP383492;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE383491,__ND383496__Project(LEFT));
END;
