...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE379986 := __ENH_Property_4;
  EXPORT __ST155098_Layout := RECORD
  ...
  END;
  EXPORT __ST155080_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155098_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155080_Layout __ND379991__Project(B_Property_4(__in,__cfg).__ST155942_Layout __PP379987) := TRANSFORM
    __EE380030 := __PP379987.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE380030),__ST155098_Layout),__NL(__EE380030));
    SELF := __PP379987;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE379986,__ND379991__Project(LEFT));
END;
