...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE381001 := __ENH_Property_4;
  EXPORT __ST156113_Layout := RECORD
  ...
  END;
  EXPORT __ST156095_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST156113_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156095_Layout __ND381006__Project(B_Property_4(__in,__cfg).__ST156957_Layout __PP381002) := TRANSFORM
    __EE381045 := __PP381002.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE381045),__ST156113_Layout),__NL(__EE381045));
    SELF := __PP381002;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE381001,__ND381006__Project(LEFT));
END;
