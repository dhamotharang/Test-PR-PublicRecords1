...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE469334 := __ENH_Inquiry_2;
  EXPORT __ST152267_Layout := RECORD
  ...
  END;
  EXPORT __ST152240_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST152267_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST152240_Layout __ND469339__Project(B_Inquiry_2(__in,__cfg).__ST153769_Layout __PP469335) := TRANSFORM
    __EE469395 := __PP469335.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE469395),__ST152267_Layout),__NL(__EE469395));
    SELF := __PP469335;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE469334,__ND469339__Project(LEFT));
END;
