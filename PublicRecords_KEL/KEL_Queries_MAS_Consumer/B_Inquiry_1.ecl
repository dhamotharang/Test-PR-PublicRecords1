...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE465221 := __ENH_Inquiry_2;
  EXPORT __ST152111_Layout := RECORD
  ...
  END;
  EXPORT __ST152084_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST152111_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST152084_Layout __ND465226__Project(B_Inquiry_2(__in,__cfg).__ST153592_Layout __PP465222) := TRANSFORM
    __EE465282 := __PP465222.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE465282),__ST152111_Layout),__NL(__EE465282));
    SELF := __PP465222;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE465221,__ND465226__Project(LEFT));
END;
