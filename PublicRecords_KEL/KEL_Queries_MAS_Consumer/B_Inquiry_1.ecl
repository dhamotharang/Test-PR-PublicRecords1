...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE464619 := __ENH_Inquiry_2;
  EXPORT __ST151509_Layout := RECORD
  ...
  END;
  EXPORT __ST151482_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST151509_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151482_Layout __ND464624__Project(B_Inquiry_2(__in,__cfg).__ST152990_Layout __PP464620) := TRANSFORM
    __EE464680 := __PP464620.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE464680),__ST151509_Layout),__NL(__EE464680));
    SELF := __PP464620;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE464619,__ND464624__Project(LEFT));
END;
