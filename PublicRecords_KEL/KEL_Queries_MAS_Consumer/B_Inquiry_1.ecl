...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE470511 := __ENH_Inquiry_2;
  EXPORT __ST157401_Layout := RECORD
  ...
  END;
  EXPORT __ST157374_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST157401_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157374_Layout __ND470516__Project(B_Inquiry_2(__in,__cfg).__ST158882_Layout __PP470512) := TRANSFORM
    __EE470572 := __PP470512.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE470572),__ST157401_Layout),__NL(__EE470572));
    SELF := __PP470512;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE470511,__ND470516__Project(LEFT));
END;
