...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE460034 := __ENH_Inquiry_2;
  EXPORT __ST140630_Layout := RECORD
  ...
  END;
  EXPORT __ST140603_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST140630_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST140603_Layout __ND460039__Project(B_Inquiry_2(__in,__cfg).__ST142146_Layout __PP460035) := TRANSFORM
    __EE460095 := __PP460035.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE460095),__ST140630_Layout),__NL(__EE460095));
    SELF := __PP460035;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE460034,__ND460039__Project(LEFT));
END;
