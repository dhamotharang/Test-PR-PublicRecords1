...
EXPORT B_Inquiry_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE464448 := __ENH_Inquiry_2;
  EXPORT __ST151338_Layout := RECORD
  ...
  END;
  EXPORT __ST151311_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST151338_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151311_Layout __ND464453__Project(B_Inquiry_2(__in,__cfg).__ST152819_Layout __PP464449) := TRANSFORM
    __EE464509 := __PP464449.Person_Info_;
    SELF.Person_Info_ := __BN(PROJECT(__T(__EE464509),__ST151338_Layout),__NL(__EE464509));
    SELF := __PP464449;
  END;
  EXPORT __ENH_Inquiry_1 := PROJECT(__EE464448,__ND464453__Project(LEFT));
END;
