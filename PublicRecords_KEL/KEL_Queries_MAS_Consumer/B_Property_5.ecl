...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE171022 := __E_Property;
  ...
  END;
  EXPORT __ST157653_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST157671_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST157653_Layout __ND171260__Project(E_Property(__in,__cfg).Layout __PP170833) := TRANSFORM
    __EE170903 := __PP170833.Automated_Valuation_Model_;
    __ST157671_Layout __ND171180__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP171176) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP171176.Date_First_Seen_);
      SELF := __PP171176;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE170903,__ND171180__Project(LEFT));
    SELF := __PP170833;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE171022,__ND171260__Project(LEFT));
END;
