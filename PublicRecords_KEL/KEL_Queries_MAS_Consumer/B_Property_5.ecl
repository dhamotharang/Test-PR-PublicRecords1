...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE169234 := __E_Property;
  EXPORT __ST155883_Layout := RECORD
  ...
  EXPORT __ST155865_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST155883_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155865_Layout __ND169472__Project(E_Property(__in,__cfg).Layout __PP169045) := TRANSFORM
    __EE169115 := __PP169045.Automated_Valuation_Model_;
    __ST155883_Layout __ND169392__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP169388) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP169388.Date_First_Seen_);
      SELF := __PP169388;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE169115,__ND169392__Project(LEFT));
    SELF := __PP169045;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE169234,__ND169472__Project(LEFT));
END;
