...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE169405 := __E_Property;
  EXPORT __ST156054_Layout := RECORD
  ...
  END;
  EXPORT __ST156036_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST156054_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156036_Layout __ND169643__Project(E_Property(__in,__cfg).Layout __PP169216) := TRANSFORM
    __EE169286 := __PP169216.Automated_Valuation_Model_;
    __ST156054_Layout __ND169563__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP169559) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP169559.Date_First_Seen_);
      SELF := __PP169559;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE169286,__ND169563__Project(LEFT));
    SELF := __PP169216;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE169405,__ND169643__Project(LEFT));
END;
