...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE160460 := __E_Property;
  EXPORT __ST145430_Layout := RECORD
  ...
  END;
  EXPORT __ST145412_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST145430_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST145412_Layout __ND160698__Project(E_Property(__in,__cfg).Layout __PP160271) := TRANSFORM
    __EE160341 := __PP160271.Automated_Valuation_Model_;
    __ST145430_Layout __ND160618__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP160614) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP160614.Date_First_Seen_);
      SELF := __PP160614;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE160341,__ND160618__Project(LEFT));
    SELF := __PP160271;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE160460,__ND160698__Project(LEFT));
END;
