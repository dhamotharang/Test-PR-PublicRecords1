...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE165082 := __E_Property;
  EXPORT __ST150052_Layout := RECORD
  ...
  END;
  EXPORT __ST150034_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST150052_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST150034_Layout __ND165320__Project(E_Property(__in,__cfg).Layout __PP164893) := TRANSFORM
    __EE164963 := __PP164893.Automated_Valuation_Model_;
    __ST150052_Layout __ND165240__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP165236) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP165236.Date_First_Seen_);
      SELF := __PP165236;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE164963,__ND165240__Project(LEFT));
    SELF := __PP164893;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE165082,__ND165320__Project(LEFT));
END;
