...
EXPORT B_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE309469 := __ENH_Property_5;
  EXPORT __ST156265_Layout := RECORD
  ...
  EXPORT __ST156247_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST156265_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156247_Layout __ND309474__Project(B_Property_5(__in,__cfg).__ST157037_Layout __PP309470) := TRANSFORM
    __EE309513 := __PP309470.Automated_Valuation_Model_;
    __ST156265_Layout __ND309518__Project(B_Property_5(__in,__cfg).__ST157055_Layout __PP309514) := TRANSFORM
      ...
      SELF.A_V_M_Years_ := FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP309514.A_V_M_Value_Date_),__ECAST(KEL.typ.nkdate,__CC13280));
      SELF := __PP309514;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE309513,__ND309518__Project(LEFT));
    SELF := __PP309470;
  END;
  EXPORT __ENH_Property_4 := PROJECT(__EE309469,__ND309474__Project(LEFT));
END;
