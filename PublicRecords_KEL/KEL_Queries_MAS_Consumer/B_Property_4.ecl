...
EXPORT B_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE306945 := __ENH_Property_5;
  EXPORT __ST155960_Layout := RECORD
  ...
  END;
  EXPORT __ST155942_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST155960_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST155942_Layout __ND306950__Project(B_Property_5(__in,__cfg).__ST156638_Layout __PP306946) := TRANSFORM
    __EE306989 := __PP306946.Automated_Valuation_Model_;
    __ST155960_Layout __ND306994__Project(B_Property_5(__in,__cfg).__ST156656_Layout __PP306990) := TRANSFORM
      ...
      SELF.A_V_M_Years_ := FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP306990.A_V_M_Value_Date_),__ECAST(KEL.typ.nkdate,__CC13235));
      SELF := __PP306990;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE306989,__ND306994__Project(LEFT));
    SELF := __PP306946;
  END;
  EXPORT __ENH_Property_4 := PROJECT(__EE306945,__ND306950__Project(LEFT));
END;
