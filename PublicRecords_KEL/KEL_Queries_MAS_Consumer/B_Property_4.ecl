...
EXPORT B_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE303477 := __ENH_Property_5;
  EXPORT __ST150273_Layout := RECORD
  ...
  END;
  EXPORT __ST150255_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST150273_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST150255_Layout __ND303482__Project(B_Property_5(__in,__cfg).__ST151045_Layout __PP303478) := TRANSFORM
    __EE303521 := __PP303478.Automated_Valuation_Model_;
    __ST150273_Layout __ND303526__Project(B_Property_5(__in,__cfg).__ST151063_Layout __PP303522) := TRANSFORM
      ...
      SELF.A_V_M_Years_ := FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP303522.A_V_M_Value_Date_),__ECAST(KEL.typ.nkdate,__CC13274));
      SELF := __PP303522;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE303521,__ND303526__Project(LEFT));
    SELF := __PP303478;
  END;
  EXPORT __ENH_Property_4 := PROJECT(__EE303477,__ND303482__Project(LEFT));
END;
