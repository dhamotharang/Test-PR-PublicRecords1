...
EXPORT B_Inquiry_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE290199 := __E_Inquiry;
  EXPORT __ST157453_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST157453_Layout __ND290132__Project(E_Inquiry(__in,__cfg).Layout __PP164240) := TRANSFORM
    __EE290125 := __PP164240.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE290125))[1].Sub_Market_,'');
    SELF := __PP164240;
  END;
  EXPORT __ENH_Inquiry_7 := PROJECT(__EE290199,__ND290132__Project(LEFT));
END;
