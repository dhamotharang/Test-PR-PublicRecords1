...
EXPORT B_Inquiry_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE286267 := __E_Inquiry;
  EXPORT __ST152031_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST152031_Layout __ND286200__Project(E_Inquiry(__in,__cfg).Layout __PP160407) := TRANSFORM
    __EE286193 := __PP160407.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE286193))[1].Sub_Market_,'');
    SELF := __PP160407;
  END;
  EXPORT __ENH_Inquiry_7 := PROJECT(__EE286267,__ND286200__Project(LEFT));
END;
