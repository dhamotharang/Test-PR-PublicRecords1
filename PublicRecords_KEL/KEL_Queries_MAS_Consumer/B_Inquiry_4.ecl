...
EXPORT B_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE308194 := __ENH_Inquiry_5;
  EXPORT __ST157518_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST157518_Layout __ND308485__Project(B_Inquiry_5(__in,__cfg).__ST158217_Layout __PP308195) := TRANSFORM
    ...
    SELF.Is_Valid_Velocity_Inquiry_Non_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__OP2(__PP308195.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP308195.Is_Collection_))),__CN(NOT (__PP308195.Is_Batch_Monitoring_Method_))),__PP308195.Is_Product_Code_Ok_),__CN(NOT (__PP308195.Inquiry_Function_Description_ IN __CC40635))),__PP308195.Is_Non_Fcra_Ok_);
    SELF := __PP308195;
  END;
  EXPORT __ENH_Inquiry_4 := PROJECT(__EE308194,__ND308485__Project(LEFT));
END;
