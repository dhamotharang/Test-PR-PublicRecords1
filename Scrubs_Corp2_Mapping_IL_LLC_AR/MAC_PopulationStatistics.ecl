...
+    #IF( #TEXT(Input_ar_amount_paid)='' )
      '' 
    #ELSE
        IF( le.Input_ar_amount_paid = (TYPEOF(le.Input_ar_amount_paid))'','',':ar_amount_paid')
    #END
;
  END;
  #uniquename(op)
