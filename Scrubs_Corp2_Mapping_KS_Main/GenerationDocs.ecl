...
Command line options: -MScrubs_Corp2_Mapping_KS_Main -eC:\Users\butlersx\AppData\Local\Temp\TFRF380.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_KS_Main
FILENAME:In_KS
...
FIELDTYPE:invalid_corp_vendor:ENUM(20)
FIELDTYPE:invalid_state_origin:ENUM(KS)
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_KS_Main.Functions.invalid_ln_name_type_cd>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_KS_Main.Functions.invalid_ln_name_type_desc>0,recordorigin)
...
FIELDTYPE:invalid_org_structure_cd:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_alphablank:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ )
FIELDTYPE:invalid_forgn_state_desc:CUSTOM(Scrubs_Corp2_Mapping_KS_Main.Functions.invalid_forgn_state_desc>0)
...
FIELD:corp_fiscal_year_month:TYPE(STRING8):LIKE(invalid_numblank):0,0
...
FIELD:corp_name_status_cd:TYPE(STRING2):LIKE(invalid_status):0,0
