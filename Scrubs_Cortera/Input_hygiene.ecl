IMPORT SALT311,STD;
EXPORT Input_hygiene(dataset(Input_layout_Cortera) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Input_Fields.InValid_link_id((SALT311.StrType)le.link_id),
    Input_Fields.InValid_name((SALT311.StrType)le.name),
    Input_Fields.InValid_alternate_business_name((SALT311.StrType)le.alternate_business_name),
    Input_Fields.InValid_address((SALT311.StrType)le.address),
    ...
    Input_Fields.InValid_postalcode((SALT311.StrType)le.postalcode),
    ...
    Input_Fields.InValid_fein((SALT311.StrType)le.fein),
    Input_Fields.InValid_position_type((SALT311.StrType)le.position_type),
    Input_Fields.InValid_ultimate_linkid((SALT311.StrType)le.ultimate_linkid),
    Input_Fields.InValid_ultimate_name((SALT311.StrType)le.ultimate_name),
    Input_Fields.InValid_loc_date_last_seen((SALT311.StrType)le.loc_date_last_seen),
    Input_Fields.InValid_primary_sic((SALT311.StrType)le.primary_sic),
    Input_Fields.InValid_sic_desc((SALT311.StrType)le.sic_desc),
    Input_Fields.InValid_primary_naics((SALT311.StrType)le.primary_naics),
    Input_Fields.InValid_naics_desc((SALT311.StrType)le.naics_desc),
    Input_Fields.InValid_segment_id((SALT311.StrType)le.segment_id),
    Input_Fields.InValid_segment_desc((SALT311.StrType)le.segment_desc),
    Input_Fields.InValid_year_start((SALT311.StrType)le.year_start),
    Input_Fields.InValid_ownership((SALT311.StrType)le.ownership),
    Input_Fields.InValid_total_employees((SALT311.StrType)le.total_employees),
    Input_Fields.InValid_employee_range((SALT311.StrType)le.employee_range),
    Input_Fields.InValid_total_sales((SALT311.StrType)le.total_sales),
    Input_Fields.InValid_sales_range((SALT311.StrType)le.sales_range),
    Input_Fields.InValid_executive_name1((SALT311.StrType)le.executive_name1),
    Input_Fields.InValid_title1((SALT311.StrType)le.title1),
    Input_Fields.InValid_executive_name2((SALT311.StrType)le.executive_name2),
    Input_Fields.InValid_title2((SALT311.StrType)le.title2),
    Input_Fields.InValid_executive_name3((SALT311.StrType)le.executive_name3),
    Input_Fields.InValid_title3((SALT311.StrType)le.title3),
    Input_Fields.InValid_executive_name4((SALT311.StrType)le.executive_name4),
    Input_Fields.InValid_title4((SALT311.StrType)le.title4),
    Input_Fields.InValid_executive_name5((SALT311.StrType)le.executive_name5),
    Input_Fields.InValid_title5((SALT311.StrType)le.title5),
    Input_Fields.InValid_executive_name6((SALT311.StrType)le.executive_name6),
    Input_Fields.InValid_title6((SALT311.StrType)le.title6),
    Input_Fields.InValid_executive_name7((SALT311.StrType)le.executive_name7),
    Input_Fields.InValid_title7((SALT311.StrType)le.title7),
    Input_Fields.InValid_executive_name8((SALT311.StrType)le.executive_name8),
    Input_Fields.InValid_title8((SALT311.StrType)le.title8),
    Input_Fields.InValid_executive_name9((SALT311.StrType)le.executive_name9),
    Input_Fields.InValid_title9((SALT311.StrType)le.title9),
    Input_Fields.InValid_executive_name10((SALT311.StrType)le.executive_name10),
    Input_Fields.InValid_title10((SALT311.StrType)le.title10),
    Input_Fields.InValid_status((SALT311.StrType)le.status),
    Input_Fields.InValid_is_closed((SALT311.StrType)le.is_closed),
    Input_Fields.InValid_closed_date((SALT311.StrType)le.closed_date),
    0);
...
PrettyErrorTotals := RECORD
  ...
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Input_Fields.InValidMessage_link_id(TotalErrors.ErrorNum),Input_Fields.InValidMessage_name(TotalErrors.ErrorNum),Input_Fields.InValidMessage_alternate_business_name(TotalErrors.ErrorNum),Input_Fields.InValidMessage_address(TotalErrors.ErrorNum),Input_Fields.InValidMessage_address2(TotalErrors.ErrorNum),Input_Fields.InValidMessage_city(TotalErrors.ErrorNum),Input_Fields.InValidMessage_state(TotalErrors.ErrorNum),Input_Fields.InValidMessage_country(TotalErrors.ErrorNum),Input_Fields.InValidMessage_postalcode(TotalErrors.ErrorNum),Input_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Input_Fields.InValidMessage_fax(TotalErrors.ErrorNum),Input_Fields.InValidMessage_latitude(TotalErrors.ErrorNum),Input_Fields.InValidMessage_longitude(TotalErrors.ErrorNum),Input_Fields.InValidMessage_url(TotalErrors.ErrorNum),Input_Fields.InValidMessage_fein(TotalErrors.ErrorNum),Input_Fields.InValidMessage_position_type(TotalErrors.ErrorNum),Input_Fields.InValidMessage_ultimate_linkid(TotalErrors.ErrorNum),Input_Fields.InValidMessage_ultimate_name(TotalErrors.ErrorNum),Input_Fields.InValidMessage_loc_date_last_seen(TotalErrors.ErrorNum),Input_Fields.InValidMessage_primary_sic(TotalErrors.ErrorNum),Input_Fields.InValidMessage_sic_desc(TotalErrors.ErrorNum),Input_Fields.InValidMessage_primary_naics(TotalErrors.ErrorNum),Input_Fields.InValidMessage_naics_desc(TotalErrors.ErrorNum),Input_Fields.InValidMessage_segment_id(TotalErrors.ErrorNum),Input_Fields.InValidMessage_segment_desc(TotalErrors.ErrorNum),Input_Fields.InValidMessage_year_start(TotalErrors.ErrorNum),Input_Fields.InValidMessage_ownership(TotalErrors.ErrorNum),Input_Fields.InValidMessage_total_employees(TotalErrors.ErrorNum),Input_Fields.InValidMessage_employee_range(TotalErrors.ErrorNum),Input_Fields.InValidMessage_total_sales(TotalErrors.ErrorNum),Input_Fields.InValidMessage_sales_range(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name1(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title1(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name2(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title2(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name3(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title3(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name4(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title4(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name5(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title5(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name6(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title6(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name7(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title7(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name8(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title8(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name9(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title9(TotalErrors.ErrorNum),Input_Fields.InValidMessage_executive_name10(TotalErrors.ErrorNum),Input_Fields.InValidMessage_title10(TotalErrors.ErrorNum),Input_Fields.InValidMessage_status(TotalErrors.ErrorNum),Input_Fields.InValidMessage_is_closed(TotalErrors.ErrorNum),Input_Fields.InValidMessage_closed_date(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Cortera, Input_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
