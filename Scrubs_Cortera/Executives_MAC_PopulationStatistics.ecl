...
+    #IF( #TEXT(Input_exec_title)='' )
      '' 
    #ELSE
        IF( le.Input_exec_title = (TYPEOF(le.Input_exec_title))'','',':exec_title')
    #END
;
  END;
  #uniquename(op)
