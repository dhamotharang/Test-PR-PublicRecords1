...
SHARED FldIds := DATASET([{1,'link_id'}
      ...
      ,{52,'status'}
      ,{53,'is_closed'}
      ,{54,'closed_date'}],SALT311.MAC_Character_Counts.Field_Identification);
