IMPORT SALT311,STD;
EXPORT Header_hygiene(dataset(Header_layout_Cortera) h) := MODULE
...
SHARED FldIds := DATASET([{1,'link_id'}
      ...
      ,{62,'prim_name'}
      ,{63,'p_city_name'}
      ,{64,'v_city_name'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Header_Fields.InValid_link_id((SALT311.StrType)le.link_id),
    Header_Fields.InValid_name((SALT311.StrType)le.name),
    Header_Fields.InValid_alternate_business_name((SALT311.StrType)le.alternate_business_name),
    Header_Fields.InValid_address((SALT311.StrType)le.address),
    Header_Fields.InValid_address2((SALT311.StrType)le.address2),
    Header_Fields.InValid_city((SALT311.StrType)le.city),
    Header_Fields.InValid_state((SALT311.StrType)le.state),
    Header_Fields.InValid_country((SALT311.StrType)le.country),
    Header_Fields.InValid_postalcode((SALT311.StrType)le.postalcode),
    Header_Fields.InValid_phone((SALT311.StrType)le.phone),
    Header_Fields.InValid_fax((SALT311.StrType)le.fax),
    Header_Fields.InValid_latitude((SALT311.StrType)le.latitude),
    Header_Fields.InValid_longitude((SALT311.StrType)le.longitude),
    Header_Fields.InValid_url((SALT311.StrType)le.url),
    Header_Fields.InValid_fein((SALT311.StrType)le.fein),
    Header_Fields.InValid_position_type((SALT311.StrType)le.position_type),
    Header_Fields.InValid_ultimate_linkid((SALT311.StrType)le.ultimate_linkid),
    Header_Fields.InValid_ultimate_name((SALT311.StrType)le.ultimate_name),
    Header_Fields.InValid_loc_date_last_seen((SALT311.StrType)le.loc_date_last_seen),
    Header_Fields.InValid_primary_sic((SALT311.StrType)le.primary_sic),
    Header_Fields.InValid_sic_desc((SALT311.StrType)le.sic_desc),
    Header_Fields.InValid_primary_naics((SALT311.StrType)le.primary_naics),
    Header_Fields.InValid_naics_desc((SALT311.StrType)le.naics_desc),
    Header_Fields.InValid_segment_id((SALT311.StrType)le.segment_id),
    Header_Fields.InValid_segment_desc((SALT311.StrType)le.segment_desc),
    Header_Fields.InValid_year_start((SALT311.StrType)le.year_start),
    Header_Fields.InValid_ownership((SALT311.StrType)le.ownership),
    Header_Fields.InValid_total_employees((SALT311.StrType)le.total_employees),
    Header_Fields.InValid_employee_range((SALT311.StrType)le.employee_range),
    Header_Fields.InValid_total_sales((SALT311.StrType)le.total_sales),
    Header_Fields.InValid_sales_range((SALT311.StrType)le.sales_range),
    Header_Fields.InValid_executive_name1((SALT311.StrType)le.executive_name1),
    Header_Fields.InValid_title1((SALT311.StrType)le.title1),
    Header_Fields.InValid_executive_name2((SALT311.StrType)le.executive_name2),
    Header_Fields.InValid_title2((SALT311.StrType)le.title2),
    Header_Fields.InValid_executive_name3((SALT311.StrType)le.executive_name3),
    Header_Fields.InValid_title3((SALT311.StrType)le.title3),
    Header_Fields.InValid_executive_name4((SALT311.StrType)le.executive_name4),
    Header_Fields.InValid_title4((SALT311.StrType)le.title4),
    Header_Fields.InValid_executive_name5((SALT311.StrType)le.executive_name5),
    Header_Fields.InValid_title5((SALT311.StrType)le.title5),
    Header_Fields.InValid_executive_name6((SALT311.StrType)le.executive_name6),
    Header_Fields.InValid_title6((SALT311.StrType)le.title6),
    Header_Fields.InValid_executive_name7((SALT311.StrType)le.executive_name7),
    Header_Fields.InValid_title7((SALT311.StrType)le.title7),
    Header_Fields.InValid_executive_name8((SALT311.StrType)le.executive_name8),
    Header_Fields.InValid_title8((SALT311.StrType)le.title8),
    Header_Fields.InValid_executive_name9((SALT311.StrType)le.executive_name9),
    Header_Fields.InValid_title9((SALT311.StrType)le.title9),
    Header_Fields.InValid_executive_name10((SALT311.StrType)le.executive_name10),
    Header_Fields.InValid_title10((SALT311.StrType)le.title10),
    Header_Fields.InValid_status((SALT311.StrType)le.status),
    Header_Fields.InValid_is_closed((SALT311.StrType)le.is_closed),
    Header_Fields.InValid_closed_date((SALT311.StrType)le.closed_date),
    Header_Fields.InValid_processdate((SALT311.StrType)le.processdate),
    Header_Fields.InValid_version((SALT311.StrType)le.version),
    Header_Fields.InValid_persistent_record_id((SALT311.StrType)le.persistent_record_id),
    Header_Fields.InValid_dt_first_seen((SALT311.StrType)le.dt_first_seen),
    Header_Fields.InValid_dt_last_seen((SALT311.StrType)le.dt_last_seen),
    Header_Fields.InValid_dt_vendor_first_reported((SALT311.StrType)le.dt_vendor_first_reported),
    Header_Fields.InValid_dt_vendor_last_reported((SALT311.StrType)le.dt_vendor_last_reported),
    Header_Fields.InValid_prim_name((SALT311.StrType)le.prim_name),
    Header_Fields.InValid_p_city_name((SALT311.StrType)le.p_city_name),
    Header_Fields.InValid_v_city_name((SALT311.StrType)le.v_city_name),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Header_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Numeric','Unknown','Unknown','Unknown','Unknown','Unknown','Invalid_St','Country','Numeric_Optional','Invalid_Phone','Invalid_Phone','Invalid_LatLong','Invalid_LatLong','Unknown','Feintype','CorpHierarchy','Numeric','Unknown','Invalid_Future_Date','Invalid_Sic','Unknown','Invalid_Naics','Unknown','Unknown','Unknown','Unknown','OwnershipTypes','Unknown','Unknown','Unknown','Unknown','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','Alpha','StatusTypes','YesNo','Unknown','Invalid_Date','Invalid_Date','Numeric','Invalid_Date','Invalid_Date','Invalid_Date','Invalid_Date','Alpha','Alpha','Alpha');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Header_Fields.InValidMessage_link_id(TotalErrors.ErrorNum),Header_Fields.InValidMessage_name(TotalErrors.ErrorNum),Header_Fields.InValidMessage_alternate_business_name(TotalErrors.ErrorNum),Header_Fields.InValidMessage_address(TotalErrors.ErrorNum),Header_Fields.InValidMessage_address2(TotalErrors.ErrorNum),Header_Fields.InValidMessage_city(TotalErrors.ErrorNum),Header_Fields.InValidMessage_state(TotalErrors.ErrorNum),Header_Fields.InValidMessage_country(TotalErrors.ErrorNum),Header_Fields.InValidMessage_postalcode(TotalErrors.ErrorNum),Header_Fields.InValidMessage_phone(TotalErrors.ErrorNum),Header_Fields.InValidMessage_fax(TotalErrors.ErrorNum),Header_Fields.InValidMessage_latitude(TotalErrors.ErrorNum),Header_Fields.InValidMessage_longitude(TotalErrors.ErrorNum),Header_Fields.InValidMessage_url(TotalErrors.ErrorNum),Header_Fields.InValidMessage_fein(TotalErrors.ErrorNum),Header_Fields.InValidMessage_position_type(TotalErrors.ErrorNum),Header_Fields.InValidMessage_ultimate_linkid(TotalErrors.ErrorNum),Header_Fields.InValidMessage_ultimate_name(TotalErrors.ErrorNum),Header_Fields.InValidMessage_loc_date_last_seen(TotalErrors.ErrorNum),Header_Fields.InValidMessage_primary_sic(TotalErrors.ErrorNum),Header_Fields.InValidMessage_sic_desc(TotalErrors.ErrorNum),Header_Fields.InValidMessage_primary_naics(TotalErrors.ErrorNum),Header_Fields.InValidMessage_naics_desc(TotalErrors.ErrorNum),Header_Fields.InValidMessage_segment_id(TotalErrors.ErrorNum),Header_Fields.InValidMessage_segment_desc(TotalErrors.ErrorNum),Header_Fields.InValidMessage_year_start(TotalErrors.ErrorNum),Header_Fields.InValidMessage_ownership(TotalErrors.ErrorNum),Header_Fields.InValidMessage_total_employees(TotalErrors.ErrorNum),Header_Fields.InValidMessage_employee_range(TotalErrors.ErrorNum),Header_Fields.InValidMessage_total_sales(TotalErrors.ErrorNum),Header_Fields.InValidMessage_sales_range(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name1(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title1(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name2(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title2(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name3(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title3(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name4(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title4(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name5(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title5(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name6(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title6(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name7(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title7(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name8(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title8(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name9(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title9(TotalErrors.ErrorNum),Header_Fields.InValidMessage_executive_name10(TotalErrors.ErrorNum),Header_Fields.InValidMessage_title10(TotalErrors.ErrorNum),Header_Fields.InValidMessage_status(TotalErrors.ErrorNum),Header_Fields.InValidMessage_is_closed(TotalErrors.ErrorNum),Header_Fields.InValidMessage_closed_date(TotalErrors.ErrorNum),Header_Fields.InValidMessage_processdate(TotalErrors.ErrorNum),Header_Fields.InValidMessage_version(TotalErrors.ErrorNum),Header_Fields.InValidMessage_persistent_record_id(TotalErrors.ErrorNum),Header_Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Header_Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Header_Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Header_Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Header_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Header_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Header_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Cortera, Header_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
