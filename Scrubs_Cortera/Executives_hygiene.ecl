...
SHARED FldIds := DATASET([{1,'link_id'}
      ...
      ,{64,'v_city_name'}
      ,{65,'executive_name'}
      ,{66,'exec_title'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Executives_Fields.InValid_exec_title((SALT311.StrType)le.exec_title),
    0);
