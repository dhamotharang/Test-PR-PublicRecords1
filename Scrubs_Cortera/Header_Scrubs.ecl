...
EXPORT FromNone(DATASET(Header_Layout_Cortera) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.name_Invalid := Header_Fields.InValid_name((SALT311.StrType)le.name);
  ...
  // field error stats
    SALT311.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Header_Fields.InvalidMessage_name(1)
          ,Header_Fields.InvalidMessage_country(1),Header_Fields.InvalidMessage_country(2)
