...
EXPORT Header_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_Crt_Sort_Sz:ENUM(A|B|C|D|)\n'
    + 'FIELDTYPE:Invalid_Date:CUSTOM(Scrubs.functions.fn_valid_date>0)\n'
    + 'FIELDTYPE:Invalid_Direction:ALLOW(ENSW)\n'
    + 'FIELDTYPE:Invalid_Err_Stat:CUSTOM(Scrubs.functions.fn_ASCII_printable>0)\n'
    + 'FIELDTYPE:Invalid_Future_Date:CUSTOM(Scrubs.functions.fn_valid_date>0,\'future\')\n'
    + 'FIELDTYPE:Invalid_Geo_Match:CUSTOM(Scrubs.functions.fn_numeric_optional>0,1)\n'
    ...
    + 'FIELDTYPE:Invalid_Percentage:CUSTOM(Scrubs.functions.fn_range_numeric>0,0,100)\n'
    ...
    + 'FIELDTYPE:Invalid_Zip5:CUSTOM(Scrubs.functions.fn_numeric_optional>0,5)\n'
