...
IMPORT SALT311;
EXPORT Header_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + '//PROCESS:<ProcessName>\n'
    + 'FIELDTYPE:alpha:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789\'):SPACES( <>{}[]-^=!+&,./\\:#"()?;)\n'
    + 'FIELDTYPE:name:ALLOW(ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz./\\ \',&()123:"-)\n'
    ...
    + 'FIELDTYPE:Invalid_LatLong:ALLOW(0123456789.-)\n'
