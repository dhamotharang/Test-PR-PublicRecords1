// Output(Seed_Files.RiskViewReport_keys.criminal);

#CONSTANT('DataLocationCC', 'NONAME');  
import Seed_Files;
key_in := Seed_Files.RiskViewReport_keys.criminal;
...
EXPORT file_Seed_Files_RiskViewReport_keys_criminal := project(key_in,makelayout(left));