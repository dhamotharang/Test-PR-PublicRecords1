// Output(Seed_Files.RiskViewReport_keys.education);

// Output(FCRA.Key_Override_Student_FFID);

#CONSTANT('DataLocationCC', 'NONAME');  
import Seed_Files;
key_in := Seed_Files.RiskViewReport_keys.education;
...
EXPORT file_Seed_Files_RiskViewReport_keys_education := project(key_in,makelayout(left));