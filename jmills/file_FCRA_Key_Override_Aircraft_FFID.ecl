// Output(FCRA.Key_Override_Aircraft_FFID);

#CONSTANT('DataLocationCC', 'NONAME');  
import FCRA;
key_in := FCRA.Key_Override_Aircraft_FFID;
...
EXPORT file_FCRA_Key_Override_Aircraft_FFID := project(key_in,makelayout(left));