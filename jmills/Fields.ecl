...
EXPORT SALT28.StrType FieldName(UNSIGNED2 i) := CHOOSE(i,'flag_file_id','clean_email','append_email_username','append_domain','append_domain_type','append_domain_root','append_domain_ext','append_is_tld_state','append_is_tld_generic','append_is_tld_country','append_is_valid_domain_ext','email_rec_key','email_src','rec_src_all','email_src_all','email_src_num','num_email_per_did','num_did_per_email','orig_pmghousehold_id','orig_pmgindividual_id','orig_first_name','orig_last_name','orig_address','orig_city','orig_state','orig_zip','orig_zip4','orig_email','orig_ip','orig_login_date','orig_site','orig_e360_id','orig_teramedia_id','did','did_score','did_type','is_did_prop','hhid','title','fname','mname','lname','name_suffix','name_score','prim_range','predir','prim_name','addr_suffix','postdir','unit_desig','sec_range','p_city_name','v_city_name','st','zip','zip4','cart','cr_sort_sz','lot','lot_order','dbpc','chk_digit','rec_type','county','geo_lat','geo_long','msa','geo_blk','geo_match','err_stat','append_rawaid','best_ssn','best_dob','process_date','activecode','date_first_seen','date_last_seen','date_vendor_first_reported','date_vendor_last_reported','current_rec');
EXPORT FieldNum(SALT28.StrType fn) := CASE(fn,'flag_file_id' => 1,'clean_email' => 2,'append_email_username' => 3,'append_domain' => 4,'append_domain_type' => 5,'append_domain_root' => 6,'append_domain_ext' => 7,'append_is_tld_state' => 8,'append_is_tld_generic' => 9,'append_is_tld_country' => 10,'append_is_valid_domain_ext' => 11,'email_rec_key' => 12,'email_src' => 13,'rec_src_all' => 14,'email_src_all' => 15,'email_src_num' => 16,'num_email_per_did' => 17,'num_did_per_email' => 18,'orig_pmghousehold_id' => 19,'orig_pmgindividual_id' => 20,'orig_first_name' => 21,'orig_last_name' => 22,'orig_address' => 23,'orig_city' => 24,'orig_state' => 25,'orig_zip' => 26,'orig_zip4' => 27,'orig_email' => 28,'orig_ip' => 29,'orig_login_date' => 30,'orig_site' => 31,'orig_e360_id' => 32,'orig_teramedia_id' => 33,'did' => 34,'did_score' => 35,'did_type' => 36,'is_did_prop' => 37,'hhid' => 38,'title' => 39,'fname' => 40,'mname' => 41,'lname' => 42,'name_suffix' => 43,'name_score' => 44,'prim_range' => 45,'predir' => 46,'prim_name' => 47,'addr_suffix' => 48,'postdir' => 49,'unit_desig' => 50,'sec_range' => 51,'p_city_name' => 52,'v_city_name' => 53,'st' => 54,'zip' => 55,'zip4' => 56,'cart' => 57,'cr_sort_sz' => 58,'lot' => 59,'lot_order' => 60,'dbpc' => 61,'chk_digit' => 62,'rec_type' => 63,'county' => 64,'geo_lat' => 65,'geo_long' => 66,'msa' => 67,'geo_blk' => 68,'geo_match' => 69,'err_stat' => 70,'append_rawaid' => 71,'best_ssn' => 72,'best_dob' => 73,'process_date' => 74,'activecode' => 75,'date_first_seen' => 76,'date_last_seen' => 77,'date_vendor_first_reported' => 78,'date_vendor_last_reported' => 79,'current_rec' => 80,0);
//Individual field level validation
EXPORT Make_flag_file_id(SALT28.StrType s0) := s0;
EXPORT InValid_flag_file_id(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_flag_file_id(UNSIGNED1 wh) := '';
EXPORT Make_clean_email(SALT28.StrType s0) := s0;
EXPORT InValid_clean_email(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_clean_email(UNSIGNED1 wh) := '';
EXPORT Make_append_email_username(SALT28.StrType s0) := s0;
EXPORT InValid_append_email_username(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_email_username(UNSIGNED1 wh) := '';
EXPORT Make_append_domain(SALT28.StrType s0) := s0;
EXPORT InValid_append_domain(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_domain(UNSIGNED1 wh) := '';
EXPORT Make_append_domain_type(SALT28.StrType s0) := s0;
EXPORT InValid_append_domain_type(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_domain_type(UNSIGNED1 wh) := '';
EXPORT Make_append_domain_root(SALT28.StrType s0) := s0;
EXPORT InValid_append_domain_root(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_domain_root(UNSIGNED1 wh) := '';
EXPORT Make_append_domain_ext(SALT28.StrType s0) := s0;
EXPORT InValid_append_domain_ext(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_domain_ext(UNSIGNED1 wh) := '';
EXPORT Make_append_is_tld_state(SALT28.StrType s0) := s0;
EXPORT InValid_append_is_tld_state(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_is_tld_state(UNSIGNED1 wh) := '';
EXPORT Make_append_is_tld_generic(SALT28.StrType s0) := s0;
EXPORT InValid_append_is_tld_generic(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_is_tld_generic(UNSIGNED1 wh) := '';
EXPORT Make_append_is_tld_country(SALT28.StrType s0) := s0;
EXPORT InValid_append_is_tld_country(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_is_tld_country(UNSIGNED1 wh) := '';
EXPORT Make_append_is_valid_domain_ext(SALT28.StrType s0) := s0;
EXPORT InValid_append_is_valid_domain_ext(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_is_valid_domain_ext(UNSIGNED1 wh) := '';
EXPORT Make_email_rec_key(SALT28.StrType s0) := s0;
EXPORT InValid_email_rec_key(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_email_rec_key(UNSIGNED1 wh) := '';
EXPORT Make_email_src(SALT28.StrType s0) := s0;
EXPORT InValid_email_src(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_email_src(UNSIGNED1 wh) := '';
EXPORT Make_rec_src_all(SALT28.StrType s0) := s0;
EXPORT InValid_rec_src_all(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_rec_src_all(UNSIGNED1 wh) := '';
EXPORT Make_email_src_all(SALT28.StrType s0) := s0;
EXPORT InValid_email_src_all(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_email_src_all(UNSIGNED1 wh) := '';
EXPORT Make_email_src_num(SALT28.StrType s0) := s0;
EXPORT InValid_email_src_num(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_email_src_num(UNSIGNED1 wh) := '';
EXPORT Make_num_email_per_did(SALT28.StrType s0) := s0;
EXPORT InValid_num_email_per_did(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_num_email_per_did(UNSIGNED1 wh) := '';
EXPORT Make_num_did_per_email(SALT28.StrType s0) := s0;
EXPORT InValid_num_did_per_email(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_num_did_per_email(UNSIGNED1 wh) := '';
EXPORT Make_orig_pmghousehold_id(SALT28.StrType s0) := s0;
EXPORT InValid_orig_pmghousehold_id(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_pmghousehold_id(UNSIGNED1 wh) := '';
EXPORT Make_orig_pmgindividual_id(SALT28.StrType s0) := s0;
EXPORT InValid_orig_pmgindividual_id(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_pmgindividual_id(UNSIGNED1 wh) := '';
EXPORT Make_orig_first_name(SALT28.StrType s0) := s0;
EXPORT InValid_orig_first_name(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_first_name(UNSIGNED1 wh) := '';
EXPORT Make_orig_last_name(SALT28.StrType s0) := s0;
EXPORT InValid_orig_last_name(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_last_name(UNSIGNED1 wh) := '';
EXPORT Make_orig_address(SALT28.StrType s0) := s0;
EXPORT InValid_orig_address(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_address(UNSIGNED1 wh) := '';
EXPORT Make_orig_city(SALT28.StrType s0) := s0;
EXPORT InValid_orig_city(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_city(UNSIGNED1 wh) := '';
EXPORT Make_orig_state(SALT28.StrType s0) := s0;
EXPORT InValid_orig_state(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_state(UNSIGNED1 wh) := '';
EXPORT Make_orig_zip(SALT28.StrType s0) := s0;
EXPORT InValid_orig_zip(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_zip(UNSIGNED1 wh) := '';
EXPORT Make_orig_zip4(SALT28.StrType s0) := s0;
EXPORT InValid_orig_zip4(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_zip4(UNSIGNED1 wh) := '';
EXPORT Make_orig_email(SALT28.StrType s0) := s0;
EXPORT InValid_orig_email(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_email(UNSIGNED1 wh) := '';
EXPORT Make_orig_ip(SALT28.StrType s0) := s0;
EXPORT InValid_orig_ip(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_ip(UNSIGNED1 wh) := '';
EXPORT Make_orig_login_date(SALT28.StrType s0) := s0;
EXPORT InValid_orig_login_date(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_login_date(UNSIGNED1 wh) := '';
EXPORT Make_orig_site(SALT28.StrType s0) := s0;
EXPORT InValid_orig_site(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_site(UNSIGNED1 wh) := '';
EXPORT Make_orig_e360_id(SALT28.StrType s0) := s0;
EXPORT InValid_orig_e360_id(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_e360_id(UNSIGNED1 wh) := '';
EXPORT Make_orig_teramedia_id(SALT28.StrType s0) := s0;
EXPORT InValid_orig_teramedia_id(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_orig_teramedia_id(UNSIGNED1 wh) := '';
EXPORT Make_did(SALT28.StrType s0) := s0;
EXPORT InValid_did(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_did(UNSIGNED1 wh) := '';
EXPORT Make_did_score(SALT28.StrType s0) := s0;
EXPORT InValid_did_score(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_did_score(UNSIGNED1 wh) := '';
EXPORT Make_did_type(SALT28.StrType s0) := s0;
EXPORT InValid_did_type(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_did_type(UNSIGNED1 wh) := '';
EXPORT Make_is_did_prop(SALT28.StrType s0) := s0;
EXPORT InValid_is_did_prop(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_is_did_prop(UNSIGNED1 wh) := '';
EXPORT Make_hhid(SALT28.StrType s0) := s0;
EXPORT InValid_hhid(SALT28.StrType s) := FALSE;
...
EXPORT Make_fname(SALT28.StrType s0) := s0;
EXPORT InValid_fname(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_fname(UNSIGNED1 wh) := '';
EXPORT Make_mname(SALT28.StrType s0) := s0;
EXPORT InValid_mname(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_mname(UNSIGNED1 wh) := '';
EXPORT Make_lname(SALT28.StrType s0) := s0;
EXPORT InValid_lname(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_lname(UNSIGNED1 wh) := '';
EXPORT Make_name_suffix(SALT28.StrType s0) := s0;
EXPORT InValid_name_suffix(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_name_suffix(UNSIGNED1 wh) := '';
EXPORT Make_name_score(SALT28.StrType s0) := s0;
EXPORT InValid_name_score(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_name_score(UNSIGNED1 wh) := '';
EXPORT Make_prim_range(SALT28.StrType s0) := s0;
EXPORT InValid_prim_range(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_prim_range(UNSIGNED1 wh) := '';
EXPORT Make_predir(SALT28.StrType s0) := s0;
EXPORT InValid_predir(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_predir(UNSIGNED1 wh) := '';
EXPORT Make_prim_name(SALT28.StrType s0) := s0;
EXPORT InValid_prim_name(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_prim_name(UNSIGNED1 wh) := '';
EXPORT Make_addr_suffix(SALT28.StrType s0) := s0;
EXPORT InValid_addr_suffix(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_addr_suffix(UNSIGNED1 wh) := '';
EXPORT Make_postdir(SALT28.StrType s0) := s0;
EXPORT InValid_postdir(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_postdir(UNSIGNED1 wh) := '';
EXPORT Make_unit_desig(SALT28.StrType s0) := s0;
EXPORT InValid_unit_desig(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_unit_desig(UNSIGNED1 wh) := '';
EXPORT Make_sec_range(SALT28.StrType s0) := s0;
EXPORT InValid_sec_range(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_sec_range(UNSIGNED1 wh) := '';
EXPORT Make_p_city_name(SALT28.StrType s0) := s0;
EXPORT InValid_p_city_name(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_p_city_name(UNSIGNED1 wh) := '';
EXPORT Make_v_city_name(SALT28.StrType s0) := s0;
EXPORT InValid_v_city_name(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_v_city_name(UNSIGNED1 wh) := '';
EXPORT Make_st(SALT28.StrType s0) := s0;
EXPORT InValid_st(SALT28.StrType s) := FALSE;
...
EXPORT Make_zip4(SALT28.StrType s0) := s0;
EXPORT InValid_zip4(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_zip4(UNSIGNED1 wh) := '';
EXPORT Make_cart(SALT28.StrType s0) := s0;
EXPORT InValid_cart(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_cart(UNSIGNED1 wh) := '';
EXPORT Make_cr_sort_sz(SALT28.StrType s0) := s0;
EXPORT InValid_cr_sort_sz(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_cr_sort_sz(UNSIGNED1 wh) := '';
EXPORT Make_lot(SALT28.StrType s0) := s0;
EXPORT InValid_lot(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_lot(UNSIGNED1 wh) := '';
EXPORT Make_lot_order(SALT28.StrType s0) := s0;
EXPORT InValid_lot_order(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_lot_order(UNSIGNED1 wh) := '';
EXPORT Make_dbpc(SALT28.StrType s0) := s0;
EXPORT InValid_dbpc(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_dbpc(UNSIGNED1 wh) := '';
EXPORT Make_chk_digit(SALT28.StrType s0) := s0;
EXPORT InValid_chk_digit(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_chk_digit(UNSIGNED1 wh) := '';
EXPORT Make_rec_type(SALT28.StrType s0) := s0;
EXPORT InValid_rec_type(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_rec_type(UNSIGNED1 wh) := '';
EXPORT Make_county(SALT28.StrType s0) := s0;
EXPORT InValid_county(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_county(UNSIGNED1 wh) := '';
EXPORT Make_geo_lat(SALT28.StrType s0) := s0;
EXPORT InValid_geo_lat(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_geo_lat(UNSIGNED1 wh) := '';
EXPORT Make_geo_long(SALT28.StrType s0) := s0;
EXPORT InValid_geo_long(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_geo_long(UNSIGNED1 wh) := '';
EXPORT Make_msa(SALT28.StrType s0) := s0;
EXPORT InValid_msa(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_msa(UNSIGNED1 wh) := '';
EXPORT Make_geo_blk(SALT28.StrType s0) := s0;
EXPORT InValid_geo_blk(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_geo_blk(UNSIGNED1 wh) := '';
EXPORT Make_geo_match(SALT28.StrType s0) := s0;
EXPORT InValid_geo_match(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_geo_match(UNSIGNED1 wh) := '';
EXPORT Make_err_stat(SALT28.StrType s0) := s0;
EXPORT InValid_err_stat(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_err_stat(UNSIGNED1 wh) := '';
EXPORT Make_append_rawaid(SALT28.StrType s0) := s0;
EXPORT InValid_append_rawaid(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_append_rawaid(UNSIGNED1 wh) := '';
EXPORT Make_best_ssn(SALT28.StrType s0) := s0;
EXPORT InValid_best_ssn(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_best_ssn(UNSIGNED1 wh) := '';
EXPORT Make_best_dob(SALT28.StrType s0) := s0;
EXPORT InValid_best_dob(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_best_dob(UNSIGNED1 wh) := '';
EXPORT Make_process_date(SALT28.StrType s0) := s0;
EXPORT InValid_process_date(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_process_date(UNSIGNED1 wh) := '';
EXPORT Make_activecode(SALT28.StrType s0) := s0;
EXPORT InValid_activecode(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_activecode(UNSIGNED1 wh) := '';
EXPORT Make_date_first_seen(SALT28.StrType s0) := s0;
EXPORT InValid_date_first_seen(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_date_first_seen(UNSIGNED1 wh) := '';
EXPORT Make_date_last_seen(SALT28.StrType s0) := s0;
EXPORT InValid_date_last_seen(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_date_last_seen(UNSIGNED1 wh) := '';
EXPORT Make_date_vendor_first_reported(SALT28.StrType s0) := s0;
EXPORT InValid_date_vendor_first_reported(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_date_vendor_first_reported(UNSIGNED1 wh) := '';
EXPORT Make_date_vendor_last_reported(SALT28.StrType s0) := s0;
EXPORT InValid_date_vendor_last_reported(SALT28.StrType s) := FALSE;
EXPORT InValidMessage_date_vendor_last_reported(UNSIGNED1 wh) := '';
EXPORT Make_current_rec(SALT28.StrType s0) := s0;
EXPORT InValid_current_rec(SALT28.StrType s) := FALSE;
