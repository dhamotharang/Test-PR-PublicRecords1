// Output(Seed_Files.RiskViewReport_keys.license);

#CONSTANT('DataLocationCC', 'NONAME');  
import Seed_Files;
key_in := Seed_Files.RiskViewReport_keys.license;
...
EXPORT file_Seed_Files_RiskViewReport_keys_license := project(key_in,makelayout(left));