//Output(doxie.key_death_masterV2_DID_fcra);

#CONSTANT('DataLocationCC', 'NONAME');  
import doxie;
key_in := doxie.key_death_masterV2_DID_fcra;
...
EXPORT file_doxie_key_death_masterV2_DID_fcra := project(key_in,makelayout(left));
