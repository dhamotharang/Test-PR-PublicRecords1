...
#workunit('name','Scrubs_Civil_Court.Party_BWR_Hygiene - Hygiene & Stats - SALT V3.9.0');
IMPORT Scrubs_Civil_Court,SALT39;
// First create an instantiated hygiene module
  infile := Scrubs_Civil_Court.Party_In_Civil_Court;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Civil_Court.Party_hygiene(ip);
  ...
  OUTPUT(SALT39.MAC_Character_Counts.EclRecord(p,'Party_Layout_Civil_Court'),NAMED('OptimizedLayout'));// File layout suggested by data
