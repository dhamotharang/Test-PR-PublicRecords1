IMPORT SALT39,STD;
EXPORT Matter_hygiene(dataset(Matter_layout_Civil_Court) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Matter_Fields.InValid_dt_first_reported((SALT39.StrType)le.dt_first_reported),
    Matter_Fields.InValid_dt_last_reported((SALT39.StrType)le.dt_last_reported),
    Matter_Fields.InValid_process_date((SALT39.StrType)le.process_date),
    Matter_Fields.InValid_vendor((SALT39.StrType)le.vendor),
    Matter_Fields.InValid_state_origin((SALT39.StrType)le.state_origin),
    Matter_Fields.InValid_source_file((SALT39.StrType)le.source_file),
    Matter_Fields.InValid_case_key((SALT39.StrType)le.case_key),
    Matter_Fields.InValid_parent_case_key((SALT39.StrType)le.parent_case_key),
    Matter_Fields.InValid_court_code((SALT39.StrType)le.court_code),
    Matter_Fields.InValid_court((SALT39.StrType)le.court),
    Matter_Fields.InValid_case_number((SALT39.StrType)le.case_number),
    Matter_Fields.InValid_case_type_code((SALT39.StrType)le.case_type_code),
    Matter_Fields.InValid_case_type((SALT39.StrType)le.case_type),
    Matter_Fields.InValid_case_title((SALT39.StrType)le.case_title),
    Matter_Fields.InValid_case_cause_code((SALT39.StrType)le.case_cause_code),
    Matter_Fields.InValid_case_cause((SALT39.StrType)le.case_cause),
    Matter_Fields.InValid_manner_of_filing_code((SALT39.StrType)le.manner_of_filing_code),
    Matter_Fields.InValid_manner_of_filing((SALT39.StrType)le.manner_of_filing),
    Matter_Fields.InValid_filing_date((SALT39.StrType)le.filing_date),
    Matter_Fields.InValid_manner_of_judgmt_code((SALT39.StrType)le.manner_of_judgmt_code),
    Matter_Fields.InValid_manner_of_judgmt((SALT39.StrType)le.manner_of_judgmt),
    Matter_Fields.InValid_judgmt_date((SALT39.StrType)le.judgmt_date),
    Matter_Fields.InValid_ruled_for_against_code((SALT39.StrType)le.ruled_for_against_code),
    Matter_Fields.InValid_ruled_for_against((SALT39.StrType)le.ruled_for_against),
    Matter_Fields.InValid_judgmt_type_code((SALT39.StrType)le.judgmt_type_code),
    Matter_Fields.InValid_judgmt_type((SALT39.StrType)le.judgmt_type),
    Matter_Fields.InValid_judgmt_disposition_date((SALT39.StrType)le.judgmt_disposition_date),
    Matter_Fields.InValid_judgmt_disposition_code((SALT39.StrType)le.judgmt_disposition_code),
    Matter_Fields.InValid_judgmt_disposition((SALT39.StrType)le.judgmt_disposition),
    Matter_Fields.InValid_disposition_code((SALT39.StrType)le.disposition_code),
    Matter_Fields.InValid_disposition_description((SALT39.StrType)le.disposition_description),
    Matter_Fields.InValid_disposition_date((SALT39.StrType)le.disposition_date),
    Matter_Fields.InValid_suit_amount((SALT39.StrType)le.suit_amount),
    Matter_Fields.InValid_award_amount((SALT39.StrType)le.award_amount),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Matter_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'Invalid_Date','Invalid_Date','Invalid_Date','Invalid_Num','Invalid_CapLetter','Unknown','Invalid_Char','Invalid_Char','Invalid_Char','Unknown','Invalid_Char','Invalid_Char','Unknown','Unknown','Invalid_Char','Unknown','Invalid_CapLetter','Unknown','Invalid_Date','Invalid_Char','Unknown','Invalid_Date','Invalid_CapLetter','Unknown','Invalid_CapLetter','Unknown','Invalid_Date','Invalid_CapLetter','Unknown','Invalid_Char','Unknown','Invalid_Date','Invalid_Num','Invalid_Num');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Matter_Fields.InValidMessage_dt_first_reported(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_dt_last_reported(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_process_date(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_vendor(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_state_origin(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_source_file(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_key(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_parent_case_key(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_court_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_court(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_number(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_type_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_type(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_title(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_cause_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_case_cause(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_manner_of_filing_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_manner_of_filing(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_filing_date(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_manner_of_judgmt_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_manner_of_judgmt(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_date(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_ruled_for_against_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_ruled_for_against(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_type_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_type(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_disposition_date(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_disposition_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_judgmt_disposition(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_disposition_code(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_disposition_description(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_disposition_date(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_suit_amount(TotalErrors.ErrorNum),Matter_Fields.InValidMessage_award_amount(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT39.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Civil_Court, Matter_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
