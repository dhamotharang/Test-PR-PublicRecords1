...
EXPORT SET OF SALT39.StrType FieldRules(UNSIGNED2 i) := CHOOSE(i,[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]);
...
EXPORT Make_dt_first_reported(SALT39.StrType s0) := s0;
EXPORT InValid_dt_first_reported(SALT39.StrType s) := 0;
EXPORT InValidMessage_dt_first_reported(UNSIGNED1 wh) := '';
 
EXPORT Make_dt_last_reported(SALT39.StrType s0) := s0;
EXPORT InValid_dt_last_reported(SALT39.StrType s) := 0;
EXPORT InValidMessage_dt_last_reported(UNSIGNED1 wh) := '';
 
EXPORT Make_process_date(SALT39.StrType s0) := s0;
EXPORT InValid_process_date(SALT39.StrType s) := 0;
EXPORT InValidMessage_process_date(UNSIGNED1 wh) := '';
 
EXPORT Make_vendor(SALT39.StrType s0) := s0;
EXPORT InValid_vendor(SALT39.StrType s) := 0;
EXPORT InValidMessage_vendor(UNSIGNED1 wh) := '';
 
EXPORT Make_state_origin(SALT39.StrType s0) := s0;
EXPORT InValid_state_origin(SALT39.StrType s) := 0;
...
EXPORT Make_case_key(SALT39.StrType s0) := s0;
EXPORT InValid_case_key(SALT39.StrType s) := 0;
EXPORT InValidMessage_case_key(UNSIGNED1 wh) := '';
 
EXPORT Make_parent_case_key(SALT39.StrType s0) := s0;
EXPORT InValid_parent_case_key(SALT39.StrType s) := 0;
EXPORT InValidMessage_parent_case_key(UNSIGNED1 wh) := '';
 
EXPORT Make_court_code(SALT39.StrType s0) := s0;
EXPORT InValid_court_code(SALT39.StrType s) := 0;
...
EXPORT Make_case_number(SALT39.StrType s0) := s0;
EXPORT InValid_case_number(SALT39.StrType s) := 0;
EXPORT InValidMessage_case_number(UNSIGNED1 wh) := '';
 
EXPORT Make_case_type_code(SALT39.StrType s0) := s0;
EXPORT InValid_case_type_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_case_type_code(UNSIGNED1 wh) := '';
...
EXPORT Make_case_cause_code(SALT39.StrType s0) := s0;
EXPORT InValid_case_cause_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_case_cause_code(UNSIGNED1 wh) := '';
...
EXPORT Make_manner_of_filing_code(SALT39.StrType s0) := s0;
EXPORT InValid_manner_of_filing_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_manner_of_filing_code(UNSIGNED1 wh) := '';
...
EXPORT Make_filing_date(SALT39.StrType s0) := s0;
EXPORT InValid_filing_date(SALT39.StrType s) := 0;
EXPORT InValidMessage_filing_date(UNSIGNED1 wh) := '';
 
EXPORT Make_manner_of_judgmt_code(SALT39.StrType s0) := s0;
EXPORT InValid_manner_of_judgmt_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_manner_of_judgmt_code(UNSIGNED1 wh) := '';
...
EXPORT Make_judgmt_date(SALT39.StrType s0) := s0;
EXPORT InValid_judgmt_date(SALT39.StrType s) := 0;
EXPORT InValidMessage_judgmt_date(UNSIGNED1 wh) := '';
 
EXPORT Make_ruled_for_against_code(SALT39.StrType s0) := s0;
EXPORT InValid_ruled_for_against_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_ruled_for_against_code(UNSIGNED1 wh) := '';
...
EXPORT Make_judgmt_type_code(SALT39.StrType s0) := s0;
EXPORT InValid_judgmt_type_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_judgmt_type_code(UNSIGNED1 wh) := '';
...
EXPORT Make_judgmt_disposition_date(SALT39.StrType s0) := s0;
EXPORT InValid_judgmt_disposition_date(SALT39.StrType s) := 0;
EXPORT InValidMessage_judgmt_disposition_date(UNSIGNED1 wh) := '';
 
EXPORT Make_judgmt_disposition_code(SALT39.StrType s0) := s0;
EXPORT InValid_judgmt_disposition_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_judgmt_disposition_code(UNSIGNED1 wh) := '';
...
EXPORT Make_disposition_code(SALT39.StrType s0) := s0;
EXPORT InValid_disposition_code(SALT39.StrType s) := 0;
EXPORT InValidMessage_disposition_code(UNSIGNED1 wh) := '';
...
EXPORT Make_disposition_date(SALT39.StrType s0) := s0;
EXPORT InValid_disposition_date(SALT39.StrType s) := 0;
EXPORT InValidMessage_disposition_date(UNSIGNED1 wh) := '';
 
EXPORT Make_suit_amount(SALT39.StrType s0) := s0;
EXPORT InValid_suit_amount(SALT39.StrType s) := 0;
EXPORT InValidMessage_suit_amount(UNSIGNED1 wh) := '';
 
EXPORT Make_award_amount(SALT39.StrType s0) := s0;
EXPORT InValid_award_amount(SALT39.StrType s) := 0;
EXPORT InValidMessage_award_amount(UNSIGNED1 wh) := '';
