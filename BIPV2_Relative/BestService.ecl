...
TheData := PROJECT(BIPV2_Relative.Keys(BIPV2_Relative.In_DOT_Base).InData(Proxid=uid),BIPV2_Relative.Layout_DOT_Base);
s := GLOBAL(PROJECT(BIPV2_Relative.Keys(TheData).Specificities_Key,BIPV2_Relative.Layout_Specificities.R)[1]);
CM := BIPV2_Relative.Best(TheData,s,TRUE);
