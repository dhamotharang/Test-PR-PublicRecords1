...
#workunit('name','BIPV2_Relative.BWR_Best - BEST - SALT V2.5 Gold');
...
// BIPV2_Relative.Keys(BIPV2_Relative.In_DOT_Base).BuildData;
// The statistics for the best (also builds all the persists)
BIPV2_Relative.Best(BIPV2_Relative.In_DOT_Base).Stats;
...
b := BIPV2_Relative.Best(BIPV2_Relative.In_DOT_Base); // Instantiate Best module
