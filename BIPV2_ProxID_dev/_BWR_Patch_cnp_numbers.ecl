...
dbasebuilt  := BIPV2_ProxID_dev.files('20130808_43').base.logical;
...
writefile   := tools.macf_writefile(BIPV2_ProxID_dev.filenames(newversion).base.logical,dsproxidproj,poverwrite := true,pDescription := 'fix cnp_numbers, patch overlinked dotids and proxids');
