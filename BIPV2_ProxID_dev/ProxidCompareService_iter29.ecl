...
IMPORT SALT24,BIPV2_ProxID_dev,ut,tools,BIPV2;
...
odl := PROJECT(CHOOSEN(BIPV2_ProxID_dev.Keys(BFile,both).Candidates(Proxid=Proxidone),100000),BIPV2_ProxID_dev.match_candidates(BFile).layout_candidates);
odr := PROJECT(CHOOSEN(BIPV2_ProxID_dev.Keys(BFile,both).Candidates(Proxid=ProxidTwo),100000),BIPV2_ProxID_dev.match_candidates(BFile).layout_candidates);
k := BIPV2_ProxID_dev.Keys(BFile,both).Specificities_Key;
