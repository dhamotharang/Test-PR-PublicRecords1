//Executable code
import tools;
EXPORT _Proc_Iterate_Experimental(string modname = 'BIPV2_ProxID_dev',boolean pIsTesting = false) := MODULE
...
FUNCTION
  ...
  names       :=    BIPV2_ProxID_dev.filenames(combo).dall_filenames
                  ...
                  + BIPV2_ProxID_dev.filenames(lversion).dall_filenames
                  + BIPV2_ProxID_dev.keynames (lversion).dall_filenames
                  + BIPV2_ProxID_dev.filenames(siter).dall_filenames
                  + BIPV2_ProxID_dev.keynames (siter).dall_filenames
                  ;
