...
#workunit('name','BIPV2_ProxID_dev.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
IMPORT BIPV2_ProxID_dev,SALT30;
IMPORT SALTTOOLS30;
//BIPV2_ProxID_dev.Specificities(BIPV2_ProxID_dev.In_DOT_Base).Build; // Used to create calibration keys
...
P := BIPV2_ProxID_dev.Proc_Iterate('1'); // Change '1' for later iterations
...
SALT30.MAC_MatchSamplePatterns(BIPV2_ProxID_dev.Keys(BIPV2_ProxID_dev.In_DOT_Base).MatchSample,MatchPatterns,Proxid1,Proxid2,8,27-33);
...
ConfThreshold:=30;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_ProxID_dev.Keys(BIPV2_ProxID_dev.In_DOT_Base).MatchSample,BIPV2_ProxID_dev.Keys(BIPV2_ProxID_dev.In_DOT_Base).Candidates,BIPV2_ProxID_dev.In_DOT_Base,Proxid,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
