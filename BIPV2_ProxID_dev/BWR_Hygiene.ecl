...
#workunit('name','BIPV2_ProxID_dev.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_ProxID_dev,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_ProxID_dev.In_DOT_Base;
  h := BIPV2_ProxID_dev.Hygiene(infile);
  ...
  CM := BIPV2_ProxID_dev.Fields.UIDConsistency(BIPV2_ProxID_dev.In_DOT_Base);
