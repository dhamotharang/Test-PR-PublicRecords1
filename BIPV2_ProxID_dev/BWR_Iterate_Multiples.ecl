//so take iteration 24 from BIPV2_ProxID_dev 
...
//#workunit('name','BIPV2_ProxID_dev.BWR_Specificities - Specificities');
IMPORT BIPV2_ProxID_dev,SALT25;
IMPORT SALTTOOLS22;
dotbase := BIPV2_ProxID_dev.files().base.built;
SpecMod := BIPV2_ProxID_dev.specificities(dotbase);
...
//  ,BIPV2_ProxID_dev.Promote('0').new2built    //promote it as zeroth iteration to superfile(for attribute file use)
  ,SpecMod.Build
  ,parallel(
