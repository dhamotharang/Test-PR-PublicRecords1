...
TheData := PROJECT(BIPV2_ProxID_dev.Keys(BIPV2_ProxID_dev.In_DOT_Base).InData(Proxid=uid),BIPV2_ProxID_dev.Layout_DOT_Base);
s := GLOBAL(PROJECT(BIPV2_ProxID_dev.Keys(TheData).Specificities_Key,BIPV2_ProxID_dev.Layout_Specificities.R)[1]);
CM := BIPV2_ProxID_dev.Cleave(TheData,s,TRUE);
