import LiensV2, did_add, ut, header_slimsort, didville, business_header,business_header_ss, address,watchdog,mdr,header;

export Proc_DID_BDID_Liensv2_Hogan(dataset(LiensV2.Layout_liens_party_SSN_for_hogan_BIPV2_with_LinkFlags) ds,string sourcename) := function
...
LiensV2.Layout_liens_party_SSN_for_hogan_BIPV2_with_LinkFlags tremovetempDID(preDID_rec L) := transform
self := L;
end;
