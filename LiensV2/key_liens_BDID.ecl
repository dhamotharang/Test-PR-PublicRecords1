...
export Key_liens_BDID := index(slim_dedup,{unsigned6 p_bdid :=(unsigned6)bdid},{TMSID,RMSID},Data_Services.Data_location.Prefix('Liensv2')+'thor_data400::key::liensv2::BDID_' + Doxie.Version_SuperKey);
