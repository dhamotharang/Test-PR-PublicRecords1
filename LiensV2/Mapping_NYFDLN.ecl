...
liensV2.Layout_Liens_Temp_Base main_mapping_format(LiensV2.Layout_liens_nyfdln L) := transform
...
self.orig_filing_type                :=  L.filing_type;
...
self.debtor_tax_id                   := '' ;
self.debtor_ssn                      := '' ;
self.debtor_address1                 := L.address1 ;
self.debtor_address2                 := L.address2 ;
self.debtor_city                     := L.CITY ;
self.debtor_state                    := L.STATE ;
self.debtor_zip5                     := L.ZIP5;
self.debtor_zip4                     := L.ZIP4 ;
self.debtor_country                  := '' ;
self.creditor_name                   := '' ;
...
export Mapping_NYFDLN := project(liensV2.file_NYFDLN_in, main_mapping_format(left)) ;
