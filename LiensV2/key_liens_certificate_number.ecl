...
export key_liens_certificate_number := index(slim_main_dedup ,{certificate_number},{tmsid,rmsid},
                                   Data_Services.Data_location.Prefix('Liensv2')+'thor_data400::key::liensv2::main::certificate_number_'+ doxie.Version_SuperKey) ;