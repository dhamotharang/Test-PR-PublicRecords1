...
// Insurance input file for the main build process put in same format as Boca file for ease of merging data for keybuild	
	EXPORT Alpha_Base			:= DATASET(PRTE2_Watercraft.Constants.BASE_PREFIX + '::qa::alldata_alpha', PRTE2_Watercraft.Layouts.Base_new - [bug_num, cust_name, link_inc_date], THOR);
