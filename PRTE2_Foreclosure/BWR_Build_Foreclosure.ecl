...
// IF you are in PROD, should DOPS UpdateVersion and copyMissingKeys happen?
DOPS_Indicator := PRTE2_Common.Constants.FULL_RUN_WITH_DOPS;				// Yes do CopyMissingKeys and DOPS
// DOPS_Indicator := PRTE2_Common.Constants.TRIAL_RUN_ONLY_NO_DOPS;	// NO I will manually do CopyMissingKeys and DOPS
