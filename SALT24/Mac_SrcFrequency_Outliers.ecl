EXPORT mac_srcfrequency_outliers(infile,infield,srcfield,o) := MACRO
  #uniquename(r)
  %r% := RECORD
	  SALT24.Str30Type fieldname := #TEXT(infield);
	  SALT24.StrType fieldvalue {maxlength(200000)} := (SALT24.StrType)infile.infield ;
		SALT24.StrType src {maxlength(30)} := infile.srcfield ;
