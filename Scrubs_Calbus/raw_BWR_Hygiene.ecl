...
#workunit('name','Scrubs_Calbus.raw_BWR_Hygiene - Hygiene & Stats - SALT V3.8.0');
...
// First create an instantiated hygiene module
  ...
  OUTPUT(SALT38.MAC_Character_Counts.EclRecord(p,'raw_Layout_Calbus'),NAMED('OptimizedLayout'));// File layout suggested by data
