EXPORT Validate_DEV_PRCT(buildVersion, isDev=true ) := functionmacro
...
// Key instantid
	instantidSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_instantid,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_Instantid1,
																																				...
																																				KeyValidation.PRCTMappings.instantidUniqueField , isdev);		
...
// Key Binstantid
	BInstantIDSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_binstantid,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_BInstantid,
																																				...
																																				KeyValidation.PRCTMappings.BInstantIDUniqueField , isdev);		
	...
	FlexIDSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_Flexid,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_Flexid,
																																				...
																																				KeyValidation.PRCTMappings.FlexIDUniqueField , isdev);		
	...
	LeadIntegrityAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_LeadIntegrityAttributes,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_LeadIntegrityAttributes,
																																				...
																																				KeyValidation.PRCTMappings.LeadIntegrityAttributesUniqueField , isdev);		
	...
	smallbusinessanalyticsSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_smallbusinessanalytics,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_smallbusinessanalytics,
																																				...
																																				KeyValidation.PRCTMappings.smallbusinessanalyticsUniqueField , isdev);		
	...
	AMLRiskAttributesBusnV2Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_AMLRiskAttributesBusnV2,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_AMLRiskAttributesBusnV2,
																																				...
																																				KeyValidation.PRCTMappings.AMLRiskAttributesBusnV2UniqueField , isdev);					
	...
	ProfileBoosterSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_ProfileBooster,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_ProfileBooster,
																																				...
																																				KeyValidation.PRCTMappings.ProfileBoosterUniqueField , isdev);																																			
...
AMLRiskAttributesV2Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_AMLRiskAttributesV2,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_AMLRiskAttributesV2,
																																				...
																																				KeyValidation.PRCTMappings.AMLRiskAttributesV2UniqueField , isdev);																																			
...
AMLRiskAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_AMLRiskAttributes,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_AMLRiskAttributes,
																																				...
																																				KeyValidation.PRCTMappings.AMLRiskAttributesUniqueField , isdev);
	...
	AMLRiskAttributesBusnSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_AMLRiskAttributesBusn,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_AMLRiskAttributesBusn,
																																				...
																																				KeyValidation.PRCTMappings.AMLRiskAttributesBusnUniqueField , isdev);
	businessdefenderSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_businessdefender,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_businessdefender,
																																				...
																																				KeyValidation.PRCTMappings.businessdefenderUniqueField , isdev);
	...
	redflagsSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_redflags,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_redflags,
																																				...
																																				KeyValidation.PRCTMappings.redflagsUniqueField , isdev);
	...
	SmallBusModelsSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_SmallBusModels,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_SmallBusModels,
																																				...
																																				KeyValidation.PRCTMappings.SmallBusModelsUniqueField , isdev);
	...
	SmallBusFinancialExchangeSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_keyPRCT_SmallBusFinancialExchange,
																																				KeyValidation.PRCT_DEV_KeyFiles.key_SBFEAttributes,
																																				...
																																				KeyValidation.PRCTMappings.SmallBusFinancialExchangeUniqueField , isdev);
	...
	OSSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_OS,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_OS,
																																				KeyValidation.PRCTMappings.OSKeySet,
																																				KeyValidation.PRCTMappings.OSParentSet,
																																				KeyValidation.PRCTMappings.OSIgnoredFields ,
																																				KeyValidation.PRCTMappings.OSUniqueField , isdev);
	...
	OSAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_OSAttributes,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_OSAttributes,
																																				...
																																				KeyValidation.PRCTMappings.OSAttributesUniqueField , isdev);
	...
	CBDSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_CBD,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_CBD,
																																				KeyValidation.PRCTMappings.CBDKeySet,
																																				KeyValidation.PRCTMappings.CBDParentSet,
																																				KeyValidation.PRCTMappings.CBDIgnoredFields ,
																																				KeyValidation.PRCTMappings.CBDUniqueField , isdev);
	...
	CBDAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_CBDAttributes,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_CBDAttributes,
																																				...
																																				KeyValidation.PRCTMappings.CBDAttributesUniqueField , isdev);
	...
	BS_ServicesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_BS_Services,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_BS_Services,
																																				...
																																				KeyValidation.PRCTMappings.BS_ServicesUniqueField , isdev);
	...
	FOVInteractiveSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_FOVInteractive,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_FOVInteractive,
																																				...
																																				KeyValidation.PRCTMappings.FOVInteractiveUniqueField , isdev);
	...
	FOVRenewalSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_FOVRenewal,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_FOVRenewal,
																																				...
																																				KeyValidation.PRCTMappings.FOVRenewalUniqueField , isdev);
	...
	frauddefenderSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_frauddefender,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_frauddefender,
																																				...
																																				KeyValidation.PRCTMappings.frauddefenderUniqueField , isdev);
		...
		HealthCareAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_HealthCareAttributes,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_HealthCareAttributes,
																																				...
																																				KeyValidation.PRCTMappings.HealthCareAttributesUniqueField , isdev);
		...
		Identifier2Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_Identifier2,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_Identifier2,
																																				...
																																				KeyValidation.PRCTMappings.Identifier2UniqueField , isdev);
	...
	IntlIID_GG2Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_IntlIID_GG2,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_IntlIID_GG2,
																																				...
																																				KeyValidation.PRCTMappings.IntlIID_GG2UniqueField , isdev);
	...
	LNSmallBusinessSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_LNSmallBusiness,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_LNSmallBusiness,
																																				...
																																				KeyValidation.PRCTMappings.LNSmallBusinessUniqueField , isdev);
	...
	VerificationOfOccupancySummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_KeyPRCT_VerificationOfOccupancy,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_VerificationOfOccupancy,
																																				...
																																				KeyValidation.PRCTMappings.VerificationOfOccupancyUniqueField , isdev);
	...
	BIIDV2_1Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_keyPRCT_BIID20keypart1,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_BIIDV2_1,
																																				...
																																				KeyValidation.PRCTMappings.BIIDV2_1UniqueField , isdev);
	//Key BIIDV2 part2
	BIIDV2_2Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_keyPRCT_BIID20keypart2,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_BIIDV2_2,
																																				...
																																				KeyValidation.PRCTMappings.BIIDV2_2UniqueField , isdev);																												
...
//Key BIIDV2 part3
	BIIDV2_3Summary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				...
																																				buildVersion,
																																			  KeyValidation.PRCT_DEV_ParentFiles.ParentFile_keyPRCT_BIID20keypart3,
																																				KeyValidation.PRCT_DEV_KeyFiles.Key_BIIDV2_3,
																																				...
																																				KeyValidation.PRCTMappings.BIIDV2_3UniqueField , isdev);				
	
	// SBFEAttributesSummary := KeyValidation.validateKeysMacrov2(DatasetName,
																																				// KeyValidation.PRCTMappings.SBFEAttributesKeyName,
																																				// KeyValidation.PRCTMappings.SBFEAttributesKeyType,
																																				// KeyValidation.PRCTMappings.SBFEAttributesParentName,
																																				// buildVersion,
																																			  // KeyValidation.PRCT_DEV_ParentFiles.ParentFile_keyPRCT_SBFEAttributes,
																																				// KeyValidation.PRCT_DEV_KeyFiles.Key_SBFEAttributes,
																																				// KeyValidation.PRCTMappings.SBFEAttributesKeySet,
																																				// KeyValidation.PRCTMappings.SBFEAttributesParentSet,
																																				// KeyValidation.PRCTMappings.SBFEAttributesIgnoredFields ,
																																				// KeyValidation.PRCTMappings.SBFEAttributesUniqueField , isdev);
																																																																										
	 PRCTSummary := instantidSummary  +BInstantIDSummary + FlexIDSummary +LeadIntegrityAttributesSummary 
																		+smallbusinessanalyticsSummary + AMLRiskAttributesBusnV2Summary + ProfileBoosterSummary + AMLRiskAttributesV2Summary + 	 AMLRiskAttributesSummary 
																		+ businessdefenderSummary + AMLRiskAttributesBusnSummary + redflagsSummary + SmallBusModelsSummary +SmallBusFinancialExchangeSummary +
