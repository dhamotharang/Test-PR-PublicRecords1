...
DataFile := '~QA::RTTEMP::TestKeyedJoin';
KeyFile1 := '~QA::RTTEMP::lname.fnameKey';
KeyFile2 := '~QA::RTTEMP::lname.fnameKeyPay';
KeyFile3 := '~QA::RTTEMP::sequenceKey';
KeyFile4 := '~QA::RTTEMP::sequenceKeyPay';
