...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:src:SPACES( ):ALLOW(!+.01234567?ABCDEFGHIKLMNOPQRSTUVWXYZ):LENGTHS(2,1,0):WORDS(1):ONFAIL(CLEAN)\n'
    ...
    + 'FIELDTYPE:tnt:SPACES( ):ALLOW(DNPY):LENGTHS(0,1):WORDS(1):ONFAIL(CLEAN)\n'
