...
persistname := '~thor_data400::' + 'persist::WaterCraftV2_services::BWR_buildautokey_bid';
...
AutoKeyB2.MAC_Build (autokey_ready,fname,mname,lname,
						...
						lbdid,
						WatercraftV2_Services.Constants(filedate).ak_keyname_bid,
						WatercraftV2_Services.Constants(filedate).ak_logical_bid,
						outaction,false,
						[],true,WatercraftV2_Services.Constants(filedate).ak_typeStr_bid,true,,,zero) 



AutoKeyB2.MAC_AcceptSK_to_QA(WatercraftV2_Services.Constants(filedate).ak_keyname_bid,mymove)
