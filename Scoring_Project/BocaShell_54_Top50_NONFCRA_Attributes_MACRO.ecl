EXPORT BocaShell_54_Top50_NONFCRA_Attributes_MACRO(dateyymmdd_curr,dateyymmdd_prev) := functionmacro
...
estimated_income ;
 ...
 res := output(fields_sum,,'~scoring_project::Top50_bocashell_54_nonFCRA_attributes_stats_' + dateyymmdd_curr, thor, overwrite);
