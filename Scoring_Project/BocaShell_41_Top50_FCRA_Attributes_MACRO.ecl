EXPORT BocaShell_41_Top50_FCRA_Attributes_MACRO(dateyymmdd_curr,dateyymmdd_prev) := functionmacro
...
Input_Address_Information_unit_count := Scoring_Project.MACRO_distinct_values(pj, 'Input_Address_Information_unit_count', 'Address_Verification-Input_Address_Information');	
...
owned_property_total := Scoring_Project.MACRO_Range_1_2_3(pj, 'owned_property_total', 'Address_Verification-owned');	
...
dirs_predir + distwphoneaddr + disthphonewphone + dirsaddr_lastscore + dirs_unit_desig + dirs_postdir + cityzipflag + statezipflag + drlcgender + drlcdob +
...
r5 := record
string100 field_name := 'Student_AGE';
	string100 category := 'Student';
  string30 distribution_type := 'RANGE';
  string50 attribute_value := MAP((integer)pj.Student_AGE  = 00  => '00',
																	(integer)pj.Student_AGE  between 01  and 17  => '01 to 17',
																	(integer)pj.Student_AGE  between 18  and 22  => '18 to 22',
																	(integer)pj.Student_AGE  between 23  and 30  => '23 to 30',
																	(integer)pj.Student_AGE >= 31 => '> 30',
																	'UNDEFINED');
decimal20_4 frequency := count(group);
end;


Student_AGE := table(pj,r5, MAP((integer)pj.Student_AGE  = 00  => '00',
																	(integer)pj.Student_AGE  between 01  and 17  => '01 to 17',
																	(integer)pj.Student_AGE  between 18  and 22  => '18 to 22',
																	(integer)pj.Student_AGE  between 23  and 30  => '23 to 30',
																	(integer)pj.Student_AGE >= 31 => '> 30',
...
estimated_income ;
 ...
 res := output(fields_sum,,'~scoring_project::Top50_bocashell_41_FCRA_attributes_stats_' + dateyymmdd_curr, thor, overwrite);
