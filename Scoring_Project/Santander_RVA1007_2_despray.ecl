...
EXPORT Santander_RVA1007_2_despray(filename) := functionmacro
...
String Score_file := '~sghatti::out::santander_rva1007_2_cust_rec_' + date_suffix;


Santander_rva1007_2_XML := dataset(Score_file,Scoring_Project.Scores_layouts.Santander_RVA1007, CSV(heading(1), quote('"'), MAXLENGTH(8192)));

////////////////////////////T MOBILE rvt1210 Mode-XML////////////////////////////////////////////////////////////////////////////////////////
Santander_rva1007_2 := sghatti.Normalized_code_attributes_Scores(Santander_rva1007_2_XML, 'acctno', 'SANTANDER RVA1007-2', 'XML', '4.0', 'FCRA', 'CERT', 'CUSTOM', datetime);

Santander_rva1007_2_prj := sghatti.Splitting_Scores_ReasonCodes(Santander_rva1007_2);	

Santander_rva1007_2_SCORES := Santander_rva1007_2_prj(flag = 1);
Santander_rva1007_2_REASON_CODES := Santander_rva1007_2_prj(flag = 0);

ALL_SCORES :=   Santander_rva1007_2_SCORES ;
							
ALL_REASON_CODES := Santander_rva1007_2_REASON_CODES;
