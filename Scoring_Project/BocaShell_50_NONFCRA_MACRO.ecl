EXPORT BocaShell_50_NONFCRA_MACRO(dateyymmdd_curr,dateyymmdd_prev) := functionmacro
...
bs_cert_curr := dataset('~scoringqa::out::nonfcra::bocashell_50_historydate_999999_cert_' + dateyymmdd_curr + '_1', lay, thor);

bs_cert_prev := dataset('~scoringqa::out::nonfcra::bocashell_50_historydate_999999_cert_' + dateyymmdd_prev + '_1', lay,thor);
...
Employment + advo_addr_hist2 + advo_addr_hist1 + advo_input_addr + ADL_Shell_Flags + ConsumerFlags +  Professional_License + Student + AirCraft + Accident_Data +
 ...
 res := output(fields_sum,,'~scoring_project::bocashell_50_cert_nonFCRA_stats_' + dateyymmdd_curr, thor, overwrite);
