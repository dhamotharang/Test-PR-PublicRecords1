...
EXPORT TMobile_rvt1212_despray(filename) := functionmacro
...
String Score_file := '~sghatti::out::t_mobile_rvt1212_1_cust_rec_' + date_suffix;


T_mobile_rvt1212 := dataset('~sghatti::out::' + filename,Scoring_Project.Scores_layouts.T_mobile_rvt1212, CSV(heading(1), quote('"'), MAXLENGTH(8192)));

////////////////////////////T MOBILE rvt1212 Mode-XML////////////////////////////////////////////////////////////////////////////////////////
Tmobile_rvt1212 := sghatti.Normalized_code_attributes_Scores(T_mobile_rvt1212, 'acctno', 'T-MOBILE rvt1212', 'XML', '4.0', 'FCRA', 'CERT', 'CUSTOM', datetime);

Tmobile_rvt1212_prj := sghatti.Splitting_Scores_ReasonCodes(Tmobile_rvt1212);	

Tmobile_rvt1212_SCORES := Tmobile_rvt1212_prj(flag = 1);
Tmobile_rvt1212_REASON_CODES := Tmobile_rvt1212_prj(flag = 0);

ALL_SCORES :=   Tmobile_rvt1212_SCORES ;
							
ALL_REASON_CODES := Tmobile_rvt1212_REASON_CODES;
