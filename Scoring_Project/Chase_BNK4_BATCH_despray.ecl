...
chase_bnk4_scores1 := sghatti.Normalized_code_attributes_Scores(chase_bnk4_batch_scores_project, 'acctno', 'CHASE-BNK4', 'BATCH', '4.0', 'NON-FCRA', 'CERT', 'CUSTOM', datetime);
