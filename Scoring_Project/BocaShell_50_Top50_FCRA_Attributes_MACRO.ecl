EXPORT BocaShell_50_Top50_FCRA_Attributes_MACRO(dateyymmdd_curr,dateyymmdd_prev) := functionmacro
...
estimated_income ;
 ...
 res := output(fields_sum,,'~scoring_project::Top50_bocashell_50_FCRA_attributes_stats_' + dateyymmdd_curr, thor, overwrite);
