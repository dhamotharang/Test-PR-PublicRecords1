EXPORT BocaShell_54_FCRA_MACRO(dateyymmdd_curr,dateyymmdd_prev) := functionmacro
...
Employment + advo_addr_hist2 + advo_addr_hist1 + advo_input_addr + ADL_Shell_Flags + ConsumerFlags +  Professional_License + Student + AirCraft + Accident_Data +
 ...
 res := output(fields_sum,,'~scoring_project::bocashell_54_cert_FCRA_stats_' + dateyymmdd_curr, thor, overwrite);
