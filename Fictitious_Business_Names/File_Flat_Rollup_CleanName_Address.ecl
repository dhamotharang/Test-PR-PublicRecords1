//export File_Flat_Rollup_CleanName_Address := 'todo';
...
Layout_clean_Addresses xform1(file_out_name InputRecord) := Transform
...
file_out_clean_addresses := Project(file_out_name,xform1(left));
