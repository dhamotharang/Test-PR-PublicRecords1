...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_WA_Event';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_WA_Event\n'
    + 'FILENAME:In_WA\n'
    ...
    + 'FIELDTYPE:invalid_event_desc:ALLOW( \\(\\),-ABCDEFGHIJKLMNOPQRSTUVWXYZ/0123456789)\n'
    + '\n'
    + '//FIELD DEFINITIONS\n'
