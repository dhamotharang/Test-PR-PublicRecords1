/*
output(wk_ut_dev.get_WUGetGraph('W20140209-122304','graph5','737'));// powid iteration
output(wk_ut_dev.get_WUGetGraph('W20140206-084814','graph47','1720'));

  get_WUGetGraph gets graphs for workunits
Can you be a little bit more specific, we have:
î€š         Subgraphs (a group of activities)
î€š         Activities (nodes/vertices)
î€š         Edges (the lines joining two activities)

There are no counts associated with subgraphs, but there are timings associated with the top level subgraphs.

Activities will get a î€šrecordCountî€š property, which (in the example I am looking at) looks like this:  î€š500000..500000[memory]î€š
...
function
	...
	record	
	  ...
	  dataset(lGraphs)      Graphs             {xpath('Graphs'                       )};
  ...
  &lt;att&gt;
   &lt;graph&gt;
    &lt;node id=&quot;2&quot; label=&quot;SOAP dataset&quot;&gt;
     &lt;att name=&quot;definition&quot; value=&quot;wk_ut_dev.get_wuinfo(170,3)&quot;/&gt;
  ...
  &lt;att&gt;
   &lt;graph&gt;
    &lt;node id=&quot;16&quot; label=&quot;SOAP action&quot;&gt;
     &lt;att name=&quot;definition&quot; value=&quot;wk_ut_dev.mac_notify(34,15)&quot;/&gt;
     &lt;att name=&quot;definition&quot; value=&quot;wk_ut_dev.remote_notify(2,1)&quot;/&gt;
     &lt;att name=&quot;name&quot; value=&quot;remote_notify&quot;/&gt;
     &lt;att name=&quot;definition&quot; value=&quot;wk_ut_dev.remote_notify(17,9)&quot;/&gt;
