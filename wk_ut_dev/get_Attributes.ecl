...
module
  ...
  /////////////////////////////////////////////
	export fGetAttributes(
		...
		,string		pEsp						= _Constants.LocalEsp + ':8145'
		,string		pUserName     	= ''
		,string		pPattern      	= ''
		,string		pRegexp       	= ''
...
/*
    url := map(
       _Constants.IsDev = true  and pEsp = '10.241.3.242:8145'  => url1
      ,_Constants.IsDev = true  and pEsp = '10.173.84.202:8145' => url3
      ,_Constants.IsDev = false and pEsp = '10.173.84.202:8145' => url1
      ,_Constants.IsDev = false and pEsp = '10.241.3.242:8145'  => url2
      ,''
    );
*/				
		results := SOAPCALL(
