/*
  ...
  Example calls:
wk_ut_dev.do_WUAction(dataset([{'W20140116-153630'}],wk_ut_dev.layouts.WuidItems),'Protect');
wk_ut_dev.do_WUAction(dataset([{'W20140116-153630'}],wk_ut_dev.layouts.WuidItems),'Restore');
wk_ut_dev.do_WUAction(dataset([{'W20140116-153630'}],wk_ut_dev.layouts.WuidItems),'Unprotect');
*/
import _control;
