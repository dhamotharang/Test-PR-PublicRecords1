EXPORT mac_createSALTSummaryReport(
  ...
  ,pCleaveID                 = '\'\''           //For Cleaves, i.e. 'Proxid' would equal 'ProxidsCreatedByCleave'
  ,pOwner                    = ''
  ,pCluster                  = ''
...
functionmacro
  ...
  #IF(pSALT28 = true)
    ...
    #SET(ClusterCountsScalar   ,',\'PreClusterCount[1].Proxid_Count\'   ,\'{UNSIGNED rcid_Count,UNSIGNED Proxid_Count}\',\'PostClusterCount[1].Proxid_Count\'  ,\'{UNSIGNED rcid_Count,UNSIGNED Proxid_Count}\'')
  #ELSE
...
//    ,['MatchesPerformed','PreClusterCount','PostClusterCount','BasicMatchesPerformed','SlicesPerformed']
  ...
  #ELSE
    #SET(cleave ,'[\'MatchesPerformed\'' + %'ClusterCountsScalar'% + ',\'BasicMatchesPerformed\',\'SlicesPerformed\',\'' + trim(pCleaveID,all) + 'sCreatedByCleave\']')
  #END

  return  wk_ut_dev.mac_CreateSummaryReport ( 
     pversion
    ,pLowWuid 
    ,pHighWuid
    ,pOwner
