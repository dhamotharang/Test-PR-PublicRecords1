...
//////////////////////////////////////////////////////////////////////////////////////////////
export do_WUWaitComplete(string pWorkunitID = '',integer pWait = -1,boolean pReturnOnWait = false,string pesp = _constants.LocalEsp) :=
function

	export WUWaitCompleteRequest :=
  ...
  return if(wk_ut_dev.Is_Valid_Wuid(pWorkunitID)  ,results ,dataset([],WUWaitCompleteOutRecord));
