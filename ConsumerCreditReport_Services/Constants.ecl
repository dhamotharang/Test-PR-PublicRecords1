...
EXPORT Constants := MODULE
	...
	EXPORT GATEWAY_FAILURE_CODE      := 22; // Gateway returned a failure status code > 0
	...
	EXPORT GATEWAY_FAILURE      := DATASET([{'Roxie',GATEWAY_FAILURE_CODE,'Gateway',doxie.ErrorCodes(GATEWAY_FAILURE_CODE)}],iesp.share.t_WsException);
