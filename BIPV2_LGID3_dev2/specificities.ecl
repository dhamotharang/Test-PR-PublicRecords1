...
SHARED reject := Fields.Invalid_nodes_total((SALT30.StrType)h0.nodes_total)>0 OR Fields.Invalid_company_name((SALT30.StrType)h0.company_name)>0;
EXPORT rejected_file := h0(reject);
 
EXPORT input_file_np := h0; // No-persist version for remote_linking
 
EXPORT input_file := h0(~Reject) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have LGID3 specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LGID3;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LGID3,LOCAL) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::Cluster_Sizes',EXPIRE(Config.PersistExpire));
...
EXPORT  source_record_id_deduped := SALT30.MAC_Field_By_UID(input_file,LGID3,source_record_id); // Reduce to field values by UID
  SALT30.Mac_Field_Count_UID(source_record_id_deduped,source_record_id,LGID3,counted,counted_clusters) // count the number of UIDs with each field value
  r1 := RECORD
    counted;
    UNSIGNED4 id := 0; // Used to identify value later
  end;
  ...
  ut.MAC_Sequence_Records(with_id,id,sequenced)
  SALT30.MAC_Field_Specificities(sequenced,specs_added) // Compute specificity for each value
EXPORT source_record_id_values_persisted_temp := specs_added;
...
EXPORT company_nameValuesKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::company_name';
...
EXPORT sbfe_idValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::sbfe_id';
...
EXPORT source_record_idValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::source_record_id';
...
SALT30.MAC_Field_Nulls(source_record_id_values_persisted,Layout_Specificities.source_record_id_ChildRec,nv) // Use automated NULL spotting
EXPORT source_record_id_nulls := nv;
SALT30.MAC_Field_Bfoul(source_record_id_deduped,source_record_id,LGID3,source_record_id_nulls,ClusterSizes,false,false,bf) // Compute the chances of a field having 2 values for one entity
EXPORT source_record_id_switch := bf;
EXPORT source_record_id_max := MAX(source_record_id_values_persisted,field_specificity);
SALT30.MAC_Field_Specificity(source_record_id_values_persisted,source_record_id,source_record_id_nulls,ol) // Compute column level specificity
EXPORT source_record_id_specificity := ol;
 
EXPORT company_nameValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::company_name';
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::cnp_number';
...
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::active_duns_number';
...
EXPORT duns_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::duns_number';
...
EXPORT duns_number_conceptValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::duns_number_concept';
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::company_fein';
...
EXPORT company_inc_stateValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::company_inc_state';
...
EXPORT company_charter_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::company_charter_number';
...
EXPORT cnp_btypeValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Word::cnp_btype';
...
EXPORT SpecIndexKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Specificities';
iSpecificities := DATASET([{0,sbfe_id_specificity,sbfe_id_switch,sbfe_id_max,sbfe_id_nulls,source_record_id_specificity,source_record_id_switch,source_record_id_max,source_record_id_nulls,company_name_specificity,company_name_switch,company_name_max,company_name_nulls,cnp_number_specificity,cnp_number_switch,cnp_number_max,cnp_number_nulls,active_duns_number_specificity,active_duns_number_switch,active_duns_number_max,active_duns_number_nulls,duns_number_specificity,duns_number_switch,duns_number_max,duns_number_nulls,duns_number_concept_specificity,duns_number_concept_switch,duns_number_concept_max,duns_number_concept_nulls,company_fein_specificity,company_fein_switch,company_fein_max,company_fein_nulls,company_inc_state_specificity,company_inc_state_switch,company_inc_state_max,company_inc_state_nulls,company_charter_number_specificity,company_charter_number_switch,company_charter_number_max,company_charter_number_nulls,cnp_btype_specificity,cnp_btype_switch,cnp_btype_max,cnp_btype_nulls}],Layout_Specificities.R);
 
EXPORT Specificities_Index := INDEX(iSpecificities,{1},{iSpecificities},SpecIndexKeyName);
EXPORT Build := SEQUENTIAL ( PARALLEL(BUILDINDEX(sbfe_id_values_index, OVERWRITE),BUILDINDEX(source_record_id_values_index, OVERWRITE),BUILDINDEX(company_name_values_index, OVERWRITE),BUILDINDEX(cnp_number_values_index, OVERWRITE),BUILDINDEX(active_duns_number_values_index, OVERWRITE),BUILDINDEX(duns_number_values_index, OVERWRITE),BUILDINDEX(duns_number_concept_values_index, OVERWRITE),BUILDINDEX(company_fein_values_index, OVERWRITE),BUILDINDEX(company_inc_state_values_index, OVERWRITE),BUILDINDEX(company_charter_number_values_index, OVERWRITE),BUILDINDEX(cnp_btype_values_index, OVERWRITE)), BUILDINDEX(Specificities_Index, OVERWRITE, FEW) );
...
SpcShiftR := RECORD
  integer1 sbfe_id_shift0 := ROUND(Specificities[1].sbfe_id_specificity - 26);
  integer2 sbfe_id_switch_shift0 := ROUND(1000*Specificities[1].sbfe_id_switch - 528);
  integer1 source_record_id_shift0 := ROUND(Specificities[1].source_record_id_specificity - 26);
  integer2 source_record_id_switch_shift0 := ROUND(1000*Specificities[1].source_record_id_switch - 528);
  integer1 company_name_shift0 := ROUND(Specificities[1].company_name_specificity - 26);
  integer2 company_name_switch_shift0 := ROUND(1000*Specificities[1].company_name_switch - 370);
  ...
  integer2 active_duns_number_switch_shift0 := ROUND(1000*Specificities[1].active_duns_number_switch - 30);
  integer1 duns_number_shift0 := ROUND(Specificities[1].duns_number_specificity - 26);
  integer2 duns_number_switch_shift0 := ROUND(1000*Specificities[1].duns_number_switch - 103);
  integer1 duns_number_concept_shift0 := ROUND(Specificities[1].duns_number_concept_specificity - 26);
  integer2 duns_number_concept_switch_shift0 := ROUND(1000*Specificities[1].duns_number_concept_switch - 153);
  integer1 company_fein_shift0 := ROUND(Specificities[1].company_fein_specificity - 26);
  integer2 company_fein_switch_shift0 := ROUND(1000*Specificities[1].company_fein_switch - 202);
  integer1 company_inc_state_shift0 := ROUND(Specificities[1].company_inc_state_specificity - 6);
  integer2 company_inc_state_switch_shift0 := ROUND(1000*Specificities[1].company_inc_state_switch - 25);
  integer1 company_charter_number_shift0 := ROUND(Specificities[1].company_charter_number_specificity - 26);
  integer2 company_charter_number_switch_shift0 := ROUND(1000*Specificities[1].company_charter_number_switch - 90);
  integer1 cnp_btype_shift0 := ROUND(Specificities[1].cnp_btype_specificity - 3);
  integer2 cnp_btype_switch_shift0 := ROUND(1000*Specificities[1].cnp_btype_switch - 41);
  END;
...
// Service functions for specificity profiling
  ...
  SALT30.MAC_Specificity_Values(source_record_id_values_persisted,source_record_id,'source_record_id',source_record_id_specificity,source_record_id_specificity_profile);
