...
#workunit('name','BIPV2_LGID3_dev2.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_LGID3_dev2,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_LGID3_dev2.In_LGID3;
  h := BIPV2_LGID3_dev2.Hygiene(infile);
  ...
  CM := BIPV2_LGID3_dev2.Fields.UIDConsistency(BIPV2_LGID3_dev2.In_LGID3);
...
//  OUTPUT(CM.orgid_TwoParents,NAMED('Twoparentsorgid'));
  ...
  //  OUTPUT(SALT30.MAC_CrossTab(infile,source,source_record_id,Examples),NAMED('source_record_idBysource'));
