...
// EXPORT In_LGID3 := project(ds_tweak, transform(BIPV2_LGID3_dev2.Layout_LGID3, self.LGID3:=left.proxid, self:=left));

// Followup iterations
// EXPORT In_LGID3 := dataset('~temp::lgid3::BIPV2_LGID3_dev2::it6d', BIPV2_LGID3_dev2.Layout_LGID3, thor);

EXPORT In_LGID3 := BIPV2_Files.files_lgid3.DS_BUILDING;
// EXPORT In_LGID3 := BIPV2_LGID3_dev2._files().base.built;