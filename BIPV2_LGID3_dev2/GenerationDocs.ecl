...
FIELD:sbfe_id:WEIGHT(2.0):26,528
FIELD:source_record_id:CONTEXT(sbfe_id):SWITCH0:WEIGHT(2.0):26,528
 
// Legal Name
// FIELD:company_name:LIKE(multiword):BAGOFWORDS(MOST):EDIT1(2):PROP:FORCE(+):TYPE(string250):25,147
FIELD:company_name:LIKE(multiword):LIKE(Noblanks):BAGOFWORDS(MOST):EDIT1(2):PROP:TYPE(string250):26,370
...
// DUNS number (v2)
FIELD:active_duns_number:PROP:27,30
FIELD:duns_number:PROP:SWITCH0:26,103
CONCEPT:duns_number_concept:active_duns_number:duns_number:26,153
...
FIELD:company_fein:26,202
FIELD:company_inc_state:PROP:FORCE(+,OR(active_duns_number),OR(duns_number),OR(duns_number_concept),OR(company_fein),OR(sbfe_id)):6,25
FIELD:company_charter_number:PROP:CONTEXT(company_inc_state):26,90
FIELD:cnp_btype:3,41
...
Total available specificity:231
User specified threshold 42
...
This process was told to produce 3 nines of accuracy on a population of 225000000 with  5831662592 records.
A matching threshold of 38 is recommended although this was overridden to 42.
...
but should average 26 points with a failed match substracting 12 points.
(This subtraction estimate is based upon 52% of clusters with 2 or more records have 2 or more values for sbfe_id.)
The SPC file has specified that the weight should be multiplied by  2.00
 
source_record_id Scoring: 
The scoring for this field is ignored unless the sbfe_id fields are identical.
Two source_record_id fields will be considered to match if:
  - they are identical
The exact number of points allocated to a match will depend upon the global scarcity of the source_record_id
but should average 26 points with a failed match substracting 12 points.
(This subtraction estimate is based upon 52% of clusters with 2 or more records have 2 or more values for source_record_id.)
The SPC file has specified that the weight should be multiplied by  2.00
...
and the degree of fuzziness required but should average 26 points with a failed match substracting 16 points.
...
This field is scaled to match with its parent duns_number_concept, on average that will mean multiplying by 49%
...
(This subtraction estimate is based upon 10% of clusters with 2 or more records have 2 or more values for duns_number.)
...
(This subtraction estimate is based upon 20% of clusters with 2 or more records have 2 or more values for company_fein.)
