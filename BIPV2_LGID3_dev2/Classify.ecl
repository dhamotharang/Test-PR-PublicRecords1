...
SHARED TotalClusters := specificities(h).TotalClusters;
  sbfe_id_tokens := PROJECT(specificities(h).sbfe_id_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.sbfe_id; SELF.TokenType := 2; SELF.Spc := LEFT.field_Specificity ));
  source_record_id_tokens := PROJECT(specificities(h).source_record_id_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.source_record_id; SELF.TokenType := 3; SELF.Spc := LEFT.field_Specificity ));
  ...
  cnp_number_tokens := PROJECT(specificities(h).cnp_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_number; SELF.TokenType := 5; SELF.Spc := LEFT.field_Specificity ));
  active_duns_number_tokens := PROJECT(specificities(h).active_duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.active_duns_number; SELF.TokenType := 6; SELF.Spc := LEFT.field_Specificity ));
  duns_number_tokens := PROJECT(specificities(h).duns_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.duns_number; SELF.TokenType := 7; SELF.Spc := LEFT.field_Specificity ));
  ...
  company_inc_state_tokens := PROJECT(specificities(h).company_inc_state_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_inc_state; SELF.TokenType := 10; SELF.Spc := LEFT.field_Specificity ));
  company_charter_number_tokens := PROJECT(specificities(h).company_charter_number_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.company_charter_number; SELF.TokenType := 11; SELF.Spc := LEFT.field_Specificity ));
  cnp_btype_tokens := PROJECT(specificities(h).cnp_btype_values_persisted,TRANSFORM(SALT30.Layout_Classify_Token,SELF.TokenValue := (SALT30.StrType)LEFT.cnp_btype; SELF.TokenType := 12; SELF.Spc := LEFT.field_Specificity ));
SHARED all_tokens0 := sbfe_id_tokens + source_record_id_tokens + company_name_tokens + cnp_number_tokens + active_duns_number_tokens + duns_number_tokens + company_fein_tokens + company_inc_state_tokens + company_charter_number_tokens + cnp_btype_tokens;
  all_tokens := SALT30.fn_process_multitokens(all_tokens0);
 
EXPORT TokenKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Token::TokenKey';
 
EXPORT TokenKey := INDEX(all_tokens,{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens},TokenKeyName);
 
EXPORT MultiTokenKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Token::MultiTokenKey';
...
EXPORT MultiTokenKey := INDEX(all_tokens0(SALT30.WordCount(TokenValue)>1),{UNSIGNED4 TokenHash := HASH32(TokenValue),TokenType},{all_tokens0},MultiTokenKeyName);
  duns_number_concept_tokens := PROJECT(specificities(h).duns_number_concept_values_persisted,TRANSFORM(SALT30.Layout_Classify_Concept,SELF.ConceptHash := LEFT.duns_number_concept; SELF.TokenType := 8; SELF.Spc := LEFT.field_Specificity ));
all_tokens1 := duns_number_concept_tokens;
 
EXPORT ConceptKeyName := '~'+'key::BIPV2_LGID3_dev2::LGID3::Token::ConceptKey';
...
shared duns_number_concept_combinations := o_tot;
  Layout_ConceptTemplate Into(duns_number_concept_combinations le) := TRANSFORM
    SELF.FieldNumber1 := MAP ( le.active_duns_number_filled => 6, le.duns_number_filled => 7,0);
    SELF.FieldNumber2 := MAP ( le.duns_number_filled AND SELF.FieldNumber1 != 7 => 7,0);
    SELF := le;
  END;
...
EXPORT ConceptTemplatesKey := '~'+'key::BIPV2_LGID3_dev2::LGID3::Token::ConceptKey';
