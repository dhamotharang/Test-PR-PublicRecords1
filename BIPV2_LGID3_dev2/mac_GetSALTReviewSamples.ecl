...
iter := '25';
#workunit('name','BIPV2_LGID3_dev2 Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_LGID3_dev2.Keys(BIPV2_LGID3_dev2.In_LGID3).MatchSample ,BIPV2_LGID3_dev2.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_LGID3_dev2.In_LGID3)
