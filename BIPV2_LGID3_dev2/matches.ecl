...
SHARED match_candidates(ih).layout_matches match_join(match_candidates(ih).layout_candidates le,match_candidates(ih).layout_candidates ri,UNSIGNED c=0,UNSIGNED outside=0) := TRANSFORM
  ...
  INTEGER2 source_record_id_score := source_record_id_score_temp*2.00; 
...
dn0_deduped := dn0(active_duns_number_weight100>=500); // Use specificity to flag high-dup counts
mj0 := JOIN( dn0_deduped, dn0_deduped, LEFT.LGID3 > RIGHT.LGID3 AND ( LEFT.SALT_Partition = RIGHT.SALT_Partition OR LEFT.SALT_Partition='' OR RIGHT.SALT_Partition = '' ) AND LEFT.active_duns_number = RIGHT.active_duns_number AND ( left.cnp_number = right.cnp_number OR left.cnp_number_isnull OR right.cnp_number_isnull ) AND (( ~left.company_inc_state_isnull AND ~right.company_inc_state_isnull ) OR ( ~left.active_duns_number_isnull AND ~right.active_duns_number_isnull ) OR ( ~left.duns_number_isnull AND ~right.duns_number_isnull ) OR ( ~left.duns_number_concept_isnull AND ~right.duns_number_concept_isnull ) OR ( ~left.company_fein_isnull AND ~right.company_fein_isnull ) OR ( ~left.sbfe_id_isnull AND ~right.sbfe_id_isnull )),trans(LEFT,RIGHT,0),HINT(unsorted_output),ATMOST(LEFT.active_duns_number = RIGHT.active_duns_number,10000),HASH);
 
//Fixed fields ->:sbfe_id(26)
 
dn1 := hfile(~sbfe_id_isnull);
dn1_deduped := dn1(sbfe_id_weight100>=500); // Use specificity to flag high-dup counts
mj1 := JOIN( dn1_deduped, dn1_deduped, LEFT.LGID3 > RIGHT.LGID3 AND ( LEFT.SALT_Partition = RIGHT.SALT_Partition OR LEFT.SALT_Partition='' OR RIGHT.SALT_Partition = '' ) AND LEFT.sbfe_id = RIGHT.sbfe_id AND ( left.cnp_number = right.cnp_number OR left.cnp_number_isnull OR right.cnp_number_isnull ) AND (( ~left.company_inc_state_isnull AND ~right.company_inc_state_isnull ) OR ( ~left.active_duns_number_isnull AND ~right.active_duns_number_isnull ) OR ( ~left.duns_number_isnull AND ~right.duns_number_isnull ) OR ( ~left.duns_number_concept_isnull AND ~right.duns_number_concept_isnull ) OR ( ~left.company_fein_isnull AND ~right.company_fein_isnull ) OR ( ~left.sbfe_id_isnull AND ~right.sbfe_id_isnull )),trans(LEFT,RIGHT,1),HINT(unsorted_output),ATMOST(LEFT.sbfe_id = RIGHT.sbfe_id,10000),HASH);
 
//Fixed fields ->:source_record_id(26)
 
dn2 := hfile(~source_record_id_isnull);
dn2_deduped := dn2(source_record_id_weight100>=500); // Use specificity to flag high-dup counts
mj2 := JOIN( dn2_deduped, dn2_deduped, LEFT.LGID3 > RIGHT.LGID3 AND ( LEFT.SALT_Partition = RIGHT.SALT_Partition OR LEFT.SALT_Partition='' OR RIGHT.SALT_Partition = '' ) AND LEFT.source_record_id = RIGHT.source_record_id AND LEFT.sbfe_id = RIGHT.sbfe_id AND ( left.cnp_number = right.cnp_number OR left.cnp_number_isnull OR right.cnp_number_isnull ) AND (( ~left.company_inc_state_isnull AND ~right.company_inc_state_isnull ) OR ( ~left.active_duns_number_isnull AND ~right.active_duns_number_isnull ) OR ( ~left.duns_number_isnull AND ~right.duns_number_isnull ) OR ( ~left.duns_number_concept_isnull AND ~right.duns_number_concept_isnull ) OR ( ~left.company_fein_isnull AND ~right.company_fein_isnull ) OR ( ~left.sbfe_id_isnull AND ~right.sbfe_id_isnull )),trans(LEFT,RIGHT,2),HINT(unsorted_output),ATMOST(LEFT.source_record_id = RIGHT.source_record_id AND LEFT.sbfe_id = RIGHT.sbfe_id,10000),HASH);
...
mj3 := JOIN( dn3_deduped, dn3_deduped, LEFT.LGID3 > RIGHT.LGID3 AND ( LEFT.SALT_Partition = RIGHT.SALT_Partition OR LEFT.SALT_Partition='' OR RIGHT.SALT_Partition = '' ) AND LEFT.company_name = RIGHT.company_name AND ( left.cnp_number = right.cnp_number OR left.cnp_number_isnull OR right.cnp_number_isnull ) AND (( ~left.company_inc_state_isnull AND ~right.company_inc_state_isnull ) OR ( ~left.active_duns_number_isnull AND ~right.active_duns_number_isnull ) OR ( ~left.duns_number_isnull AND ~right.duns_number_isnull ) OR ( ~left.duns_number_concept_isnull AND ~right.duns_number_concept_isnull ) OR ( ~left.company_fein_isnull AND ~right.company_fein_isnull ) OR ( ~left.sbfe_id_isnull AND ~right.sbfe_id_isnull )),trans(LEFT,RIGHT,3),HINT(unsorted_output),ATMOST(LEFT.company_name = RIGHT.company_name,10000),HASH);
...
mjs0 := o0 : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::mj::0',EXPIRE(Config.PersistExpire));
...
mj6 := JOIN( dn6_deduped, dn6_deduped, LEFT.LGID3 > RIGHT.LGID3 AND ( LEFT.SALT_Partition = RIGHT.SALT_Partition OR LEFT.SALT_Partition='' OR RIGHT.SALT_Partition = '' ) AND LEFT.company_charter_number = RIGHT.company_charter_number AND LEFT.company_inc_state = RIGHT.company_inc_state AND ( left.cnp_number = right.cnp_number OR left.cnp_number_isnull OR right.cnp_number_isnull ) AND (( ~left.company_inc_state_isnull AND ~right.company_inc_state_isnull ) OR ( ~left.active_duns_number_isnull AND ~right.active_duns_number_isnull ) OR ( ~left.duns_number_isnull AND ~right.duns_number_isnull ) OR ( ~left.duns_number_concept_isnull AND ~right.duns_number_concept_isnull ) OR ( ~left.company_fein_isnull AND ~right.company_fein_isnull ) OR ( ~left.sbfe_id_isnull AND ~right.sbfe_id_isnull )),trans(LEFT,RIGHT,6),HINT(unsorted_output),ATMOST(LEFT.company_charter_number = RIGHT.company_charter_number AND LEFT.company_inc_state = RIGHT.company_inc_state,10000),HASH);
...
EXPORT All_Matches := all_mjs : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::all_m',EXPIRE(Config.PersistExpire)); // To by used by rcid and LGID3
...
EXPORT PossibleMatches := o : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::mt',EXPIRE(Config.PersistExpire));
SALT30.mac_get_BestPerRecord( All_Matches,rcid1,LGID31,rcid2,LGID32,o );
EXPORT BestPerRecord := o : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::mr',EXPIRE(Config.PersistExpire));
...
EXPORT ClusterLinkages := o1 : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::clu',EXPIRE(Config.PersistExpire));
...
EXPORT ToSlice := IF ( Config.DoSliceouts, DEDUP(SORT(DISTRIBUTE(BetterElsewhere(Pref_Margin>10),HASH(LGID3)),LGID3,-Pref_Margin,LOCAL),LGID3,LOCAL)) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev2::Matches::ToSlice',EXPIRE(Config.PersistExpire));
...
EXPORT PreIDs := BIPV2_LGID3_dev2.Fields.UIDConsistency(ih_thin/*HACK*/); // Export whole consistency module
EXPORT PostIDs := BIPV2_LGID3_dev2.Fields.UIDConsistency(Patched_Infile_thin); // Export whole consistency module
