...
Command line options: -MScrubs_Corp2_Mapping_MS_Stock -eC:\Users\mireleaa\AppData\Local\Temp\TFRABCD.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_MS_Stock
FILENAME:In_MS
...
FIELDTYPE:invalid_stock_class:ENUM(COMMON|COMMON NON-VOTING|COMMON A|COMMON A NON-VOTING|COMMON B|COMMON B NON-VOTING|COMMON C|COMMON C NON-VOTING|PREFERRED|PREFERRED A|PREFERRED B|OTHER| )
