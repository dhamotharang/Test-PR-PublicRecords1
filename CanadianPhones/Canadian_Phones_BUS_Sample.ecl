...
prodVersion := dataset('~thor_200::in::axciomBUS::20100628::canada_clean', layout_Canadian_BUSraw  ,flat);
current := dataset('~thor_200::in::axciomBUS::20100727::canada_clean',layout_Canadian_BUSraw  ,flat);
...
output(jrecs,named('SampleCanadianBUS'));
