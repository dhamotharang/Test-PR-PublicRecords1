export fGetRegExPattern := module
	...
	export Address := module
		...
		shared PatternInvalidWords1 	:= '^NONE SAME AS ABOVE|^SAME$| SAME |SEE DOCUMENT|NONE GIVEN|UNDER NONE|^NONE$|^NONE | NONE |UNKNOWN';
	...
	export FirstName := module
		...
		shared PatternInvalidWords1	 	:= 'NOT REQUIRED|NOT ASSIGNED|RESIGNED|^SAME$|^SAME | SAME |^NONE$|^NONE | NONE |UNKNOWN';
		export InvalidWords						:= PatternInvalidWords1;
	end;
