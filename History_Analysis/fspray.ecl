...
Export fspray(  string pVersion, string datasetname, string location, string cluster, string enviroment, string start_date, string end_date, string dopsenv ) :=  Module
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////dops input file is processed depending date range desired ///////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// processed datatset in processed_dops file
Shared processed_dops := History_Analysis.Process_Dops(pVersion, datasetname, location, cluster, enviroment, start_date, end_date, dopsenv);
...
Export build_3 := History_Analysis.Filenames(pVersion).DopsInputRawdata;


Export build_4 := STD.File.SprayDelimited('10.121.149.194',
