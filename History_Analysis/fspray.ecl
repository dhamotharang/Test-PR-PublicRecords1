...
Export fspray( string vip, string pVersion, string datasetname, string location, string cluster, string fromdate, string todate ) :=  Module
...
Export build_1 := STD.File.SprayDelimited(vip,
...
Export build_2 := STD.File.SprayDelimited(vip,
...
Export build_5 := STD.File.SprayDelimited(vip,
