...
ECL0:= 
 '//INQL_v2._CRON_Build_FCRA_Daily_Controller\n'
+'//Controller job name -> ' + INQL_v2._Constants.FCRA_DAILY_BLD_CONTROLLERNAME + '\n'
...
ECL :=
		ECL0
+'	NOTIFY(\'' + INQL_v2._Constants.FCRA_DAILY_KEYS_EVENTNAME + '\',\'*\');\n'
;

#WORKUNIT('protect',true);
#WORKUNIT('name', INQL_v2._Constants.FCRA_DAILY_BLD_CONTROLLERNAME);
wk_ut.CreateWuid(ECL,'hthor',INQL_v2._Constants.FCRA_ESP):
													...
													,'*** ALERT **** ' + INQL_v2._Constants.FCRA_DAILY_BLD_CONTROLLERNAME
