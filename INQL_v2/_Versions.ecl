...
EXPORT dops_get_release_history           := DOPS.GetReleaseHistory('B','N','InquiryTableUpdateKeys','prod');
...
shared dops_versions_table                := dops_get_release_history (certversion < dops_nonfcra_update_keys_prod);	
