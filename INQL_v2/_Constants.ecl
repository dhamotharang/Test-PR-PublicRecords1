...
EXPORT _Constants  := module
	...
	export NEW_NONFCRA_PREFIX                           := if(_Control.ThisEnvironment.ThisDaliIp = _Control.IPAddress.NewLogTHOR_dali
	                                                       ,'~uspr::',data_services.foreign_logs + 'uspr::');

	export NEW_FCRA_PREFIX                              := if(_Control.ThisEnvironment.ThisDaliIp = _Control.IPAddress.FCRALogTHOR_dali
	                                                       ,'~uspr::',data_services.foreign_fcra_logs + 'uspr::');
	...
	export DONE_NONFCRA_DIR 			                := ROOTDIR + 'done_nonfcra/';
	export DONE_FCRA_DIR 		    	                := ROOTDIR + 'done_fcra/';
	...
	export NON_FCRA_DAILY_BLD_SCHEDULERNAME				:= 'INQL NONFCRA DAILY BUILD';	
