...
export extract_official_records_marriage_divorces := function
...
END;
	...
	return output(ds_with_filing_type(filing_type<>''),,'~thor_200::out::official_records_marriage_divorce_party',Overwrite);
end;