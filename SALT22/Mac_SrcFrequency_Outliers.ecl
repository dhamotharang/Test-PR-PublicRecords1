export mac_srcfrequency_outliers(infile,infield,srcfield,o) := macro
  #uniquename(r)
  %r% := record
	  SALT22.Str30Type fieldname := #TEXT(infield);
	  SALT22.StrType fieldvalue {maxlength(200000)} := (SALT22.StrType)infile.infield ;
		SALT22.StrType src {maxlength(30)} := infile.srcfield ;
