/*--SOAP--
<message name="Vehicle_Biz_Search_Service">
...
/*--INFO-- Search Vehicle for matching data!</p><p>Input fields are cleaned according to the standard hygiene requirements of this file.</p>
...
EXPORT Vehicle_Biz_Search_Service := MACRO
  ...
  pm := BIPV2_WAF.Mod_Vehicle().MEOW_(Input_Data); // Instantiate search module
