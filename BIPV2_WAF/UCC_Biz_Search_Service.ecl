/*--SOAP--
<message name="UCC_Biz_Search_Service">
...
/*--INFO-- Search UCC for matching data!</p><p>Input fields are cleaned according to the standard hygiene requirements of this file.</p>
...
EXPORT UCC_Biz_Search_Service := MACRO
  ...
  pm := BIPV2_WAF.Mod_UCC().MEOW_(Input_Data); // Instantiate search module
