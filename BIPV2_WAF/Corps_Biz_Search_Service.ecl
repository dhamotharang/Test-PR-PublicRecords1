/*--SOAP--
<message name="Corps_Biz_Search_Service">
...
/*--INFO-- Search Corps for matching data!</p><p>Input fields are cleaned according to the standard hygiene requirements of this file.</p>
...
EXPORT Corps_Biz_Search_Service := MACRO
  ...
  pm := BIPV2_WAF.Mod_Corps().MEOW_(Input_Data); // Instantiate search module
