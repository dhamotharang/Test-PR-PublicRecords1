/*--SOAP--
<message name="BizContacts_Biz_Search_Service">
...
/*--INFO-- Search BizContacts for matching data!</p><p>Input fields are cleaned according to the standard hygiene requirements of this file.</p>
...
EXPORT BizContacts_Biz_Search_Service := MACRO
  ...
  pm := BIPV2_WAF.Mod_BizContacts().MEOW_(Input_Data); // Instantiate search module
