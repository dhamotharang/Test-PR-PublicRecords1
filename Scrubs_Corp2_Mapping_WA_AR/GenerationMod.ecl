...
EXPORT GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spc_MODULE := 'Scrubs_Corp2_Mapping_WA_AR';
  ...
  EXPORT spcString :=
    'OPTIONS:-gh \n'
    + 'MODULE:Scrubs_Corp2_Mapping_WA_AR\n'
    + 'FILENAME:In_WA\n'
    ...
    + 'FIELDTYPE:invalid_corp_key:ALLOW(0123456789-):LENGTHS(10,11,12)\n'
    + 'FIELDTYPE:invalid_corp_vendor:ENUM(53|53)\n'
    + 'FIELDTYPE:invalid_state_origin:ENUM(WA|WA)\n'
    ...
    + 'FIELDTYPE:invalid_charter_nbr:ALLOW(0123456789):LENGTHS(7,8,9)\n'
    + 'FIELDTYPE:invalid_numeric:ALLOW(0123456789)\n'
    + 'FIELDTYPE:invalid_ar_comment:CUSTOM(Scrubs_Corp2_Mapping_WA_AR.Functions.fn_valid_ar_comment>0)\n'
    + '\n'
    + '\n'
    + '//FIELDTYPE DEFINITIONS\n'
    ...
    + 'FIELD:ar_due_dt:TYPE(STRING8):LIKE(invalid_future_date):0,0 \n'
    + 'FIELD:ar_filed_dt:TYPE(STRING8):0,0 \n'
    + 'FIELD:ar_report_dt:TYPE(STRING8):LIKE(invalid_date):0,0\n'
    ...
    + 'FIELD:ar_comment:TYPE(STRING350):LIKE(invalid_ar_comment):0,0\n'
