...
#workunit('name', 'CREATE UCC Debtor Master Keys ' + ucc.UCC_Build_Date);

h := ucc.File_UCC_Debtor_Master_Keybuild;
...
BUILDINDEX( t, {bdid,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'bdid.key', moxie,overwrite);
BUILDINDEX( t, {ssn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'ssn.key', moxie,overwrite);
BUILDINDEX( t, {zip,street_name,suffix,predir,postdir,prim_range,company1,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.street_name.suffix.predir.postdir.prim_range.company.key', moxie,overwrite);
BUILDINDEX( t, {zip,street_name,suffix,predir,postdir,prim_range,lfmname,sec_range,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.street_name.suffix.predir.postdir.prim_range.lfmname.sec_range.key', moxie,overwrite);
...
BUILDINDEX( t, {lfmname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'lfmname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {st,lfmname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.lfmname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {st,city,lfmname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.lfmname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {zip,lfmname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.lfmname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {dph_lname,name_first,name_middle,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'dph_lname.name_first.name_middle.key', moxie,overwrite);
BUILDINDEX( t, {st,dph_lname,name_first,name_middle,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.dph_lname.name_first.name_middle.key', moxie,overwrite);
BUILDINDEX( t, {st,city,dph_lname,name_first,name_middle,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.dph_lname.name_first.name_middle.key', moxie,overwrite);
BUILDINDEX( t, {zip,dph_lname,name_first,name_middle,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.dph_lname.name_first.name_middle.key', moxie,overwrite);
BUILDINDEX( t, {asisname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'asisname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {st,asisname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.asisname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {st,city,asisname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.asisname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {zip,asisname,event_flag,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.asisname.event_flag.key', moxie,overwrite);
BUILDINDEX( t, {zip,prim_name,suffix,predir,postdir,prim_range,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.prim_name.suffix.predir.postdir.prim_range.key', moxie,overwrite);
BUILDINDEX( t, {z5,prim_name,prim_range,lname,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'z5.prim_name.prim_range.lname.key', moxie,overwrite);
BUILDINDEX( t, {st,city,prim_name,prim_range,predir,postdir,suffix,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.prim_name.prim_range.predir.postdir.suffix.key', moxie,overwrite);
...
BUILDINDEX( cn_records(cn <> ''), {cn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'cn.key', moxie,overwrite);
BUILDINDEX( cn_records(st <> ''), {st,cn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.cn.key', moxie,overwrite);
BUILDINDEX( cn_records(st <> ''), {st,city,cn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.cn.key', moxie,overwrite);
BUILDINDEX( cn_records(zip <> ''), {zip,cn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.cn.key', moxie,overwrite);
...
BUILDINDEX( pcn_records(pcn<>''),{pcn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'pcn.key', moxie, overwrite);
BUILDINDEX( pcn_records(st <> ''),{st,pcn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.pcn.key', moxie, overwrite);
BUILDINDEX( pcn_records(st <> ''),{st,city,pcn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'st.city.pcn.key', moxie,overwrite);
BUILDINDEX( pcn_records(zip <> ''),{zip,pcn,(big_endian unsigned8 )__filepos},
			ucc.Base_Key_Name_Debtor + 'zip.pcn.key', moxie,overwrite);