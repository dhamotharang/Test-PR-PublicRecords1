...
EXPORT Summary(SALT311.Str30Type  txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    populated_rawfields_biography_cnt := COUNT(GROUP,h.rawfields_biography <> (TYPEOF(h.rawfields_biography))'');
    populated_rawfields_biography_pcnt := AVE(GROUP,IF(h.rawfields_biography = (TYPEOF(h.rawfields_biography))'',0,100));
    maxlength_rawfields_biography := MAX(GROUP,LENGTH(TRIM((SALT311.StrType)h.rawfields_biography)));
    avelength_rawfields_biography := AVE(GROUP,LENGTH(TRIM((SALT311.StrType)h.rawfields_biography)),h.rawfields_biography<>(typeof(h.rawfields_biography))'');
...
SHARED FldIds := DATASET([{1,'did'}
      ...
      ,{55,'rawfields_biography'}
      ,{56,'clean_contact_name_title'}
      ,{57,'clean_contact_name_fname'}
      ,{58,'clean_contact_name_mname'}
      ,{59,'clean_contact_name_lname'}
      ,{60,'clean_contact_name_name_suffix'}
      ,{61,'clean_contact_name_name_score'}
      ,{62,'clean_contact_address_prim_range'}
      ,{63,'clean_contact_address_predir'}
      ,{64,'clean_contact_address_prim_name'}
      ,{65,'clean_contact_address_addr_suffix'}
      ,{66,'clean_contact_address_postdir'}
      ,{67,'clean_contact_address_unit_desig'}
      ,{68,'clean_contact_address_sec_range'}
      ,{69,'clean_contact_address_p_city_name'}
      ,{70,'clean_contact_address_v_city_name'}
      ,{71,'clean_contact_address_st'}
      ,{72,'clean_contact_address_zip'}
      ,{73,'clean_contact_address_zip4'}
      ,{74,'clean_contact_address_cart'}
      ,{75,'clean_contact_address_cr_sort_sz'}
      ,{76,'clean_contact_address_lot'}
      ,{77,'clean_contact_address_lot_order'}
      ,{78,'clean_contact_address_dbpc'}
      ,{79,'clean_contact_address_chk_digit'}
      ,{80,'clean_contact_address_rec_type'}
      ,{81,'clean_contact_address_fips_state'}
      ,{82,'clean_contact_address_fips_county'}
      ,{83,'clean_contact_address_geo_lat'}
      ,{84,'clean_contact_address_geo_long'}
      ,{85,'clean_contact_address_msa'}
      ,{86,'clean_contact_address_geo_blk'}
      ,{87,'clean_contact_address_geo_match'}
      ,{88,'clean_contact_address_err_stat'}
      ,{89,'clean_dates_entrydate'}
      ,{90,'clean_dates_lastupdate'}
      ,{91,'clean_phones_officephone'}
      ,{92,'clean_phones_directdial'}
      ,{93,'clean_phones_mobilephone'}
      ,{94,'global_sid'}
      ,{95,'record_sid'}],SALT311.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Contacts_Fields.InValid_rawfields_biography((SALT311.StrType)le.rawfields_biography),
