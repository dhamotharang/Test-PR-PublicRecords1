...
+    #IF( #TEXT(Input_rawfields_biography)='' )
      '' 
    #ELSE
        IF( le.Input_rawfields_biography = (TYPEOF(le.Input_rawfields_biography))'','',':rawfields_biography')
    #END
