...
+    #IF( #TEXT(Input_rawfields_description)='' )
      '' 
    #ELSE
        IF( le.Input_rawfields_description = (TYPEOF(le.Input_rawfields_description))'','',':rawfields_description')
    #END
