...
EXPORT Companies_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:Invalid_Zip:LIKE(Invalid_No):LENGTHS(0,5,9,10)\n'
    + '\n'
    ...
    + 'FIELD:rawfields_auditor:TYPE(STRING):LIKE(Invalid_Alpha):0,0\n'
    ...
    + 'FIELD:clean_address_prim_name:TYPE(STRING28):LIKE(Invalid_AlphaCaps):0,0\n'
