...
export layout_orig := record
	string90 		orig_name;
	string25 		orig_address1;
	string25 		orig_address2;
	string25 		orig_address3 := '';
	string20 		orig_city;
	string2 		orig_state;
	string9 		orig_zip;
	string10 		orig_phone;
	string8 		orig_Dob := '';
  string10 		orig_AgeGroup := '';
  string8 		orig_gender := '';
  string50 		orig_email := '';
