...
*/
IMPORT SALT39;
EXPORT BOOLEAN WithinEditN(StrType l, StrType r, UNSIGNED1 d, UNSIGNED1 edit_threshold=0, BOOLEAN edFunction(STRING l,STRING r,UNSIGNED1 d,UNSIGNED1 mode=0) = SALT39.utWithinEditN) := FUNCTION
