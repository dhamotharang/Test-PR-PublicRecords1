...
%vls% := PROJECT ( TOPN (values_file,SALT39.Config.Specificity_Profile_MaxExamples,-field_specificity),%intoval%(LEFT) ) +
         SORT ( PROJECT ( TOPN (values_file,SALT39.Config.Specificity_Profile_MaxExamples,field_specificity),%intoval%(LEFT) ),cnt );
