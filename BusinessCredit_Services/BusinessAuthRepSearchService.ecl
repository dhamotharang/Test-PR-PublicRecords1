...
IMPORT Address, AutoStandardI, BIPV2, Doxie, iesp, TopBusiness_Services, WSInput, STD;
...
EXPORT BusinessAuthRepSearchService :=
  MACRO
    ...
    personRecs_raw := doxie.HeaderFileRollupService_Records.fn_get_personRecords( mod_access, ta1_tempmod, ta2_tempmod );
