...
export BCD_BusinessSearch() := MACRO
	...
	rec_in := iesp.bcd_bizsearch.t_BcdBusinessSearchRequest;
...
TopBusiness_Services.BusinessSearch_Layouts.OptionsLayout search_options() := TRANSFORM		
  ...
  iesp.ECL2ESP.Marshall.MAC_Marshall_Results(tmpRecs, results, iesp.bcd_bizsearch.t_BizCreditBizSearchResponse);
