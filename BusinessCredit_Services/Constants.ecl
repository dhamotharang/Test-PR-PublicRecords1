IMPORT BusinessCredit_Services,MDR;
...
EXPORT Constants := MODULE
    ...
    EXPORT STRING15   BLENDED_SCORE_BBFM_NSBFEWITHEXP	:= 'BBFM1903_1_0';
    EXPORT STRING15   BBFM1906_1_0                    := 'BBFM1906_1_0';
    ...
    EXPORT STRING     SBFE_V5_LAYOUT_CHANGE_DATE      := '20201001';  // SBFE layout change 

    EXPORT SET OF STRING	SET_ALLOWED_ACCOUNT := ['002' , '003' , '006']; 
    EXPORT SET OF STRING	SET_CHARGEOFF_STATUS := ['009','011','032'];
    ...
    EXPORT MODEL_NAME_SETS :=
      MODULE
        ...
        EXPORT SET OF STRING  BLENDED_BBFM_NSBFEWITHEXP         := [BLENDED_SCORE_BBFM_NSBFEWITHEXP];
        EXPORT SET OF STRING  BBFM1906_1_0                      := [BBFM1906_1_0];
        EXPORT SET OF STRING  CREDIT_BLENDED_BBFM_SBFEATTR      := [CREDIT_SCORE_MODEL, BLENDED_SCORE_BBFM_SBFEATTR];
        EXPORT SET OF STRING  CREDIT_BLENDED_BBFM_NSBFEWITHEXP  := [CREDIT_SCORE_MODEL,BLENDED_SCORE_BBFM_NSBFEWITHEXP];
        ...
        EXPORT SET OF STRING  CREDIT_BLENDED_ALL                := [CREDIT_SCORE_MODEL, BLENDED_SCORE_MODEL, CREDIT_SCORE_SLBO, BLENDED_SCORE_SLBB, BLENDED_SCORE_BBFM,CREDIT_SCORE_BOFM,BLENDED_SCORE_BBFM_SBFEATTR,BLENDED_SCORE_BBFM_NSBFEWITHEXP];		
        EXPORT SET OF STRING  BLENDED_ALL                       := [BLENDED_SCORE_MODEL,BLENDED_SCORE_SLBB,BLENDED_SCORE_BBFM, BLENDED_SCORE_SLBBNFEL,BLENDED_SCORE_BBFM_SBFEATTR,BLENDED_SCORE_BBFM_NSBFEWITHEXP,BBFM1906_1_0];		
    ...
    EXPORT SET OF STRING Closed_Account_Status_Codes := ['002','003','004','005','008','009','011','016','017','018','022','023','024','025','027','028','029','030','032'];	
