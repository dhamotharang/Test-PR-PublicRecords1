...
EXPORT Constants := MODULE
    ...
    EXPORT MODEL_NAME_SETS := 
      MODULE
        ...
        EXPORT SET OF STRING	CREDIT_BLENDED_ALL                := [CREDIT_SCORE_MODEL, BLENDED_SCORE_MODEL, CREDIT_SCORE_SLBO, BLENDED_SCORE_SLBB, BLENDED_SCORE_BBFM,CREDIT_SCORE_BOFM];		
        EXPORT SET OF STRING	BLENDED_ALL                       := [BLENDED_SCORE_MODEL,BLENDED_SCORE_SLBB,BLENDED_SCORE_BBFM, BLENDED_SCORE_SLBBNFEL];		
