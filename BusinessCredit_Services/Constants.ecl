...
EXPORT Constants := MODULE
    ...
    EXPORT MODEL_NAME_SETS := 
      MODULE
        EXPORT SET OF STRING	BLENDED     	 := [BLENDED_SCORE_MODEL/* BLENDED_SCORE_SLBB*/];
        EXPORT SET OF STRING	CREDIT    		 := [CREDIT_SCORE_MODEL, CREDIT_SCORE_SLBO];
        EXPORT SET OF STRING	CREDIT_BLENDED := [CREDIT_SCORE_MODEL , BLENDED_SCORE_MODEL, CREDIT_SCORE_SLBO/*, BLENDED_SCORE_SLBB*/];
