...
EXPORT Constants := MODULE
    ...
    EXPORT MODEL_NAME_SETS := 
      MODULE
        ...
        EXPORT SET OF STRING	BLENDED_ALL                       := [BLENDED_SCORE_MODEL,BLENDED_SCORE_SLBB,BLENDED_SCORE_BBFM, BLENDED_SCORE_SLBBNFEL,BLENDED_SCORE_BBFM_SBFEATTR,BLENDED_SCORE_BBFM_NSBFEWITHEXP];		
