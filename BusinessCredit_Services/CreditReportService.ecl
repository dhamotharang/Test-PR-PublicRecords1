...
EXPORT CreditReportService := MACRO
   ...
   **********************************************/
	...
	Deltabase_Logging_prep := project(results, transform(Risk_Reporting.Layouts.LOG_Deltabase_Layout_Record,
																									 ...
																									 self.i_address := If(trim(ReportBy.AuthorizedRep.address.streetaddress1)!='', ReportBy.AuthorizedRep.address.streetaddress1,
																									 ...
																									 self.i_bus_address := If(trim(ReportBy.Company.address.streetaddress1)!='', ReportBy.Company.address.streetaddress1,
																									 ...
																									 self.o_score_1    := (Integer)left.Records.Scorings.Scores[1].Score,
																									 ...
																									 self.o_score_2    := (Integer)left.Records.Scorings.Scores[2].Score,
