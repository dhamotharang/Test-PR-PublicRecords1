...
EXPORT BCD_SmallBizCombinedReport := 
  ...
  // #option ('optimizelevel', 0);  // NEVER RELEASE THIS LINE OF CODE TO PROD
    ...
    requestIn := DATASET([], iesp.bcd_SmallBizCombinedReport.t_SmallBizCombinedReportRequest) : STORED('SmallBizCombinedReportRequest', FEW);
  ...
  ds_Results := 
    PROJECT(ds_Results_withSmBizSBFEroyalty,
      TRANSFORM(iesp.bcd_SmallBizCombinedReport.t_SmallBizCombinedReportResponse, 
