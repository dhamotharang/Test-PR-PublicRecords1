Import Data_Services, Prof_Licensev2,text_search;
	...
	ret := dataset(Data_Services.Data_location.Prefix()+'thor_data400::persist::prolic::boolean',text_search.Layout_DocSeg,thor);
...
export Key_Boolean_Map := index(if(nothor(fileservices.fileexists(Data_Services.Data_location.Prefix()+'thor_data400::persist::prolic::boolean')),
																		tmsid_map,read_ret),{src},{doc},Data_Services.Data_location.Prefix()+'thor_data400::key::prolic::qa::docref.seq');
