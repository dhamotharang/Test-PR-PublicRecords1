...
filename := if (IsFCRA, 
								Data_Services.Data_location.Prefix('DEFAULT') + 'thor_data400::key::prolicv2::fcra::' + doxie.Version_SuperKey + '::professional_license_type_lookup',
								Data_Services.Data_location.Prefix('DEFAULT') + 'thor_data400::key::prolicv2::' + doxie.Version_SuperKey + '::professional_license_type_lookup');
