...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_party_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.party_name)));
    avelength_party_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.party_name)),h.party_name<>(typeof(h.party_name))'');
    ...
    maxlength_party_vocation := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.party_vocation)));
    avelength_party_vocation := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.party_vocation)),h.party_vocation<>(typeof(h.party_vocation))'');
    ...
    maxlength_inaddress := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.inaddress)));
    avelength_inaddress := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.inaddress)),h.inaddress<>(typeof(h.inaddress))'');
    populated_incity_pcnt := AVE(GROUP,IF(h.incity = (TYPEOF(h.incity))'',0,100));
    maxlength_incity := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.incity)));
    avelength_incity := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.incity)),h.incity<>(typeof(h.incity))'');
    populated_instate_pcnt := AVE(GROUP,IF(h.instate = (TYPEOF(h.instate))'',0,100));
    maxlength_instate := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.instate)));
    avelength_instate := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.instate)),h.instate<>(typeof(h.instate))'');
    populated_inzip_pcnt := AVE(GROUP,IF(h.inzip = (TYPEOF(h.inzip))'',0,100));
    maxlength_inzip := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.inzip)));
    avelength_inzip := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.inzip)),h.inzip<>(typeof(h.inzip))'');
    populated_ssnumber_pcnt := AVE(GROUP,IF(h.ssnumber = (TYPEOF(h.ssnumber))'',0,100));
    maxlength_ssnumber := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ssnumber)));
    avelength_ssnumber := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ssnumber)),h.ssnumber<>(typeof(h.ssnumber))'');
    populated_fines_levied_pcnt := AVE(GROUP,IF(h.fines_levied = (TYPEOF(h.fines_levied))'',0,100));
    maxlength_fines_levied := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fines_levied)));
    avelength_fines_levied := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fines_levied)),h.fines_levied<>(typeof(h.fines_levied))'');
    ...
    maxlength_ok_for_fcr := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ok_for_fcr)));
    avelength_ok_for_fcr := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ok_for_fcr)),h.ok_for_fcr<>(typeof(h.ok_for_fcr))'');
    ...
    maxlength_dba_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.dba_name)));
    avelength_dba_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.dba_name)),h.dba_name<>(typeof(h.dba_name))'');
    populated_contact_name_pcnt := AVE(GROUP,IF(h.contact_name = (TYPEOF(h.contact_name))'',0,100));
    maxlength_contact_name := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_name)));
    avelength_contact_name := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.contact_name)),h.contact_name<>(typeof(h.contact_name))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.party_name),TRIM((SALT33.StrType)le.party_position),TRIM((SALT33.StrType)le.party_vocation),TRIM((SALT33.StrType)le.party_firm),TRIM((SALT33.StrType)le.inaddress),TRIM((SALT33.StrType)le.incity),TRIM((SALT33.StrType)le.instate),TRIM((SALT33.StrType)le.inzip),TRIM((SALT33.StrType)le.ssnumber),TRIM((SALT33.StrType)le.fines_levied),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.party_text),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip5),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.fips_state),TRIM((SALT33.StrType)le.fips_county),TRIM((SALT33.StrType)le.addr_rec_type),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.cbsa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dpbc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.err_stat),IF (le.dotid <> 0,TRIM((SALT33.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT33.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT33.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT33.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT33.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT33.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT33.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT33.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT33.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT33.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT33.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT33.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT33.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT33.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT33.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT33.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT33.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT33.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT33.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT33.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT33.StrType)le.ultweight), ''),IF (le.source_rec_id <> 0,TRIM((SALT33.StrType)le.source_rec_id), ''),IF (le.did <> 0,TRIM((SALT33.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT33.StrType)le.did_score), ''),IF (le.bdid <> 0,TRIM((SALT33.StrType)le.bdid), ''),IF (le.bdid_score <> 0,TRIM((SALT33.StrType)le.bdid_score), ''),TRIM((SALT33.StrType)le.ssn_appended),TRIM((SALT33.StrType)le.dba_name),TRIM((SALT33.StrType)le.contact_name),TRIM((SALT33.StrType)le.enh_did_src)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 82);
  SELF.FldNo2 := 1 + (C % 82);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.party_name),TRIM((SALT33.StrType)le.party_position),TRIM((SALT33.StrType)le.party_vocation),TRIM((SALT33.StrType)le.party_firm),TRIM((SALT33.StrType)le.inaddress),TRIM((SALT33.StrType)le.incity),TRIM((SALT33.StrType)le.instate),TRIM((SALT33.StrType)le.inzip),TRIM((SALT33.StrType)le.ssnumber),TRIM((SALT33.StrType)le.fines_levied),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.party_text),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip5),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.fips_state),TRIM((SALT33.StrType)le.fips_county),TRIM((SALT33.StrType)le.addr_rec_type),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.cbsa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dpbc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.err_stat),IF (le.dotid <> 0,TRIM((SALT33.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT33.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT33.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT33.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT33.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT33.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT33.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT33.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT33.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT33.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT33.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT33.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT33.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT33.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT33.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT33.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT33.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT33.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT33.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT33.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT33.StrType)le.ultweight), ''),IF (le.source_rec_id <> 0,TRIM((SALT33.StrType)le.source_rec_id), ''),IF (le.did <> 0,TRIM((SALT33.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT33.StrType)le.did_score), ''),IF (le.bdid <> 0,TRIM((SALT33.StrType)le.bdid), ''),IF (le.bdid_score <> 0,TRIM((SALT33.StrType)le.bdid_score), ''),TRIM((SALT33.StrType)le.ssn_appended),TRIM((SALT33.StrType)le.dba_name),TRIM((SALT33.StrType)le.contact_name),TRIM((SALT33.StrType)le.enh_did_src)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.party_name),TRIM((SALT33.StrType)le.party_position),TRIM((SALT33.StrType)le.party_vocation),TRIM((SALT33.StrType)le.party_firm),TRIM((SALT33.StrType)le.inaddress),TRIM((SALT33.StrType)le.incity),TRIM((SALT33.StrType)le.instate),TRIM((SALT33.StrType)le.inzip),TRIM((SALT33.StrType)le.ssnumber),TRIM((SALT33.StrType)le.fines_levied),TRIM((SALT33.StrType)le.restitution),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.party_text),TRIM((SALT33.StrType)le.title),TRIM((SALT33.StrType)le.fname),TRIM((SALT33.StrType)le.mname),TRIM((SALT33.StrType)le.lname),TRIM((SALT33.StrType)le.name_suffix),TRIM((SALT33.StrType)le.name_score),TRIM((SALT33.StrType)le.cname),TRIM((SALT33.StrType)le.prim_range),TRIM((SALT33.StrType)le.predir),TRIM((SALT33.StrType)le.prim_name),TRIM((SALT33.StrType)le.addr_suffix),TRIM((SALT33.StrType)le.postdir),TRIM((SALT33.StrType)le.unit_desig),TRIM((SALT33.StrType)le.sec_range),TRIM((SALT33.StrType)le.p_city_name),TRIM((SALT33.StrType)le.v_city_name),TRIM((SALT33.StrType)le.st),TRIM((SALT33.StrType)le.zip5),TRIM((SALT33.StrType)le.zip4),TRIM((SALT33.StrType)le.fips_state),TRIM((SALT33.StrType)le.fips_county),TRIM((SALT33.StrType)le.addr_rec_type),TRIM((SALT33.StrType)le.geo_lat),TRIM((SALT33.StrType)le.geo_long),TRIM((SALT33.StrType)le.cbsa),TRIM((SALT33.StrType)le.geo_blk),TRIM((SALT33.StrType)le.geo_match),TRIM((SALT33.StrType)le.cart),TRIM((SALT33.StrType)le.cr_sort_sz),TRIM((SALT33.StrType)le.lot),TRIM((SALT33.StrType)le.lot_order),TRIM((SALT33.StrType)le.dpbc),TRIM((SALT33.StrType)le.chk_digit),TRIM((SALT33.StrType)le.err_stat),IF (le.dotid <> 0,TRIM((SALT33.StrType)le.dotid), ''),IF (le.dotscore <> 0,TRIM((SALT33.StrType)le.dotscore), ''),IF (le.dotweight <> 0,TRIM((SALT33.StrType)le.dotweight), ''),IF (le.empid <> 0,TRIM((SALT33.StrType)le.empid), ''),IF (le.empscore <> 0,TRIM((SALT33.StrType)le.empscore), ''),IF (le.empweight <> 0,TRIM((SALT33.StrType)le.empweight), ''),IF (le.powid <> 0,TRIM((SALT33.StrType)le.powid), ''),IF (le.powscore <> 0,TRIM((SALT33.StrType)le.powscore), ''),IF (le.powweight <> 0,TRIM((SALT33.StrType)le.powweight), ''),IF (le.proxid <> 0,TRIM((SALT33.StrType)le.proxid), ''),IF (le.proxscore <> 0,TRIM((SALT33.StrType)le.proxscore), ''),IF (le.proxweight <> 0,TRIM((SALT33.StrType)le.proxweight), ''),IF (le.seleid <> 0,TRIM((SALT33.StrType)le.seleid), ''),IF (le.selescore <> 0,TRIM((SALT33.StrType)le.selescore), ''),IF (le.seleweight <> 0,TRIM((SALT33.StrType)le.seleweight), ''),IF (le.orgid <> 0,TRIM((SALT33.StrType)le.orgid), ''),IF (le.orgscore <> 0,TRIM((SALT33.StrType)le.orgscore), ''),IF (le.orgweight <> 0,TRIM((SALT33.StrType)le.orgweight), ''),IF (le.ultid <> 0,TRIM((SALT33.StrType)le.ultid), ''),IF (le.ultscore <> 0,TRIM((SALT33.StrType)le.ultscore), ''),IF (le.ultweight <> 0,TRIM((SALT33.StrType)le.ultweight), ''),IF (le.source_rec_id <> 0,TRIM((SALT33.StrType)le.source_rec_id), ''),IF (le.did <> 0,TRIM((SALT33.StrType)le.did), ''),IF (le.did_score <> 0,TRIM((SALT33.StrType)le.did_score), ''),IF (le.bdid <> 0,TRIM((SALT33.StrType)le.bdid), ''),IF (le.bdid_score <> 0,TRIM((SALT33.StrType)le.bdid_score), ''),TRIM((SALT33.StrType)le.ssn_appended),TRIM((SALT33.StrType)le.dba_name),TRIM((SALT33.StrType)le.contact_name),TRIM((SALT33.StrType)le.enh_did_src)));
  END;
...
SHARED FldIds := DATASET([{1,'batch_number'}
      ...
      ,{80,'dba_name'}
      ,{81,'contact_name'}
      ,{82,'enh_did_src'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    party_Fields.InValid_batch_number((SALT33.StrType)le.batch_number),
    party_Fields.InValid_incident_number((SALT33.StrType)le.incident_number),
    party_Fields.InValid_party_number((SALT33.StrType)le.party_number),
    party_Fields.InValid_record_type((SALT33.StrType)le.record_type),
    party_Fields.InValid_order_number((SALT33.StrType)le.order_number),
    party_Fields.InValid_party_name((SALT33.StrType)le.party_name),
    party_Fields.InValid_party_position((SALT33.StrType)le.party_position),
    party_Fields.InValid_party_vocation((SALT33.StrType)le.party_vocation),
    party_Fields.InValid_party_firm((SALT33.StrType)le.party_firm),
    party_Fields.InValid_inaddress((SALT33.StrType)le.inaddress),
    party_Fields.InValid_incity((SALT33.StrType)le.incity),
    party_Fields.InValid_instate((SALT33.StrType)le.instate),
    party_Fields.InValid_inzip((SALT33.StrType)le.inzip),
    party_Fields.InValid_ssnumber((SALT33.StrType)le.ssnumber),
    party_Fields.InValid_fines_levied((SALT33.StrType)le.fines_levied),
    party_Fields.InValid_restitution((SALT33.StrType)le.restitution),
    party_Fields.InValid_ok_for_fcr((SALT33.StrType)le.ok_for_fcr),
    party_Fields.InValid_party_text((SALT33.StrType)le.party_text),
    party_Fields.InValid_title((SALT33.StrType)le.title),
    party_Fields.InValid_fname((SALT33.StrType)le.fname),
    party_Fields.InValid_mname((SALT33.StrType)le.mname),
    party_Fields.InValid_lname((SALT33.StrType)le.lname),
    party_Fields.InValid_name_suffix((SALT33.StrType)le.name_suffix),
    party_Fields.InValid_name_score((SALT33.StrType)le.name_score),
    party_Fields.InValid_cname((SALT33.StrType)le.cname),
    party_Fields.InValid_prim_range((SALT33.StrType)le.prim_range),
    party_Fields.InValid_predir((SALT33.StrType)le.predir),
    party_Fields.InValid_prim_name((SALT33.StrType)le.prim_name),
    party_Fields.InValid_addr_suffix((SALT33.StrType)le.addr_suffix),
    party_Fields.InValid_postdir((SALT33.StrType)le.postdir),
    party_Fields.InValid_unit_desig((SALT33.StrType)le.unit_desig),
    party_Fields.InValid_sec_range((SALT33.StrType)le.sec_range),
    party_Fields.InValid_p_city_name((SALT33.StrType)le.p_city_name),
    party_Fields.InValid_v_city_name((SALT33.StrType)le.v_city_name),
    party_Fields.InValid_st((SALT33.StrType)le.st),
    party_Fields.InValid_zip5((SALT33.StrType)le.zip5),
    party_Fields.InValid_zip4((SALT33.StrType)le.zip4),
    party_Fields.InValid_fips_state((SALT33.StrType)le.fips_state),
    party_Fields.InValid_fips_county((SALT33.StrType)le.fips_county),
    party_Fields.InValid_addr_rec_type((SALT33.StrType)le.addr_rec_type),
    party_Fields.InValid_geo_lat((SALT33.StrType)le.geo_lat),
    party_Fields.InValid_geo_long((SALT33.StrType)le.geo_long),
    party_Fields.InValid_cbsa((SALT33.StrType)le.cbsa),
    party_Fields.InValid_geo_blk((SALT33.StrType)le.geo_blk),
    party_Fields.InValid_geo_match((SALT33.StrType)le.geo_match),
    party_Fields.InValid_cart((SALT33.StrType)le.cart),
    party_Fields.InValid_cr_sort_sz((SALT33.StrType)le.cr_sort_sz),
    party_Fields.InValid_lot((SALT33.StrType)le.lot),
    party_Fields.InValid_lot_order((SALT33.StrType)le.lot_order),
    party_Fields.InValid_dpbc((SALT33.StrType)le.dpbc),
    party_Fields.InValid_chk_digit((SALT33.StrType)le.chk_digit),
    party_Fields.InValid_err_stat((SALT33.StrType)le.err_stat),
    party_Fields.InValid_dotid((SALT33.StrType)le.dotid),
    party_Fields.InValid_dotscore((SALT33.StrType)le.dotscore),
    party_Fields.InValid_dotweight((SALT33.StrType)le.dotweight),
    party_Fields.InValid_empid((SALT33.StrType)le.empid),
    party_Fields.InValid_empscore((SALT33.StrType)le.empscore),
    party_Fields.InValid_empweight((SALT33.StrType)le.empweight),
    party_Fields.InValid_powid((SALT33.StrType)le.powid),
    party_Fields.InValid_powscore((SALT33.StrType)le.powscore),
    party_Fields.InValid_powweight((SALT33.StrType)le.powweight),
    party_Fields.InValid_proxid((SALT33.StrType)le.proxid),
    party_Fields.InValid_proxscore((SALT33.StrType)le.proxscore),
    party_Fields.InValid_proxweight((SALT33.StrType)le.proxweight),
    party_Fields.InValid_seleid((SALT33.StrType)le.seleid),
    party_Fields.InValid_selescore((SALT33.StrType)le.selescore),
    party_Fields.InValid_seleweight((SALT33.StrType)le.seleweight),
    party_Fields.InValid_orgid((SALT33.StrType)le.orgid),
    party_Fields.InValid_orgscore((SALT33.StrType)le.orgscore),
    party_Fields.InValid_orgweight((SALT33.StrType)le.orgweight),
    party_Fields.InValid_ultid((SALT33.StrType)le.ultid),
    party_Fields.InValid_ultscore((SALT33.StrType)le.ultscore),
    party_Fields.InValid_ultweight((SALT33.StrType)le.ultweight),
    party_Fields.InValid_source_rec_id((SALT33.StrType)le.source_rec_id),
    party_Fields.InValid_did((SALT33.StrType)le.did),
    party_Fields.InValid_did_score((SALT33.StrType)le.did_score),
    party_Fields.InValid_bdid((SALT33.StrType)le.bdid),
    party_Fields.InValid_bdid_score((SALT33.StrType)le.bdid_score),
    party_Fields.InValid_ssn_appended((SALT33.StrType)le.ssn_appended),
    party_Fields.InValid_dba_name((SALT33.StrType)le.dba_name),
    party_Fields.InValid_contact_name((SALT33.StrType)le.contact_name),
    party_Fields.InValid_enh_did_src((SALT33.StrType)le.enh_did_src),
    0);
