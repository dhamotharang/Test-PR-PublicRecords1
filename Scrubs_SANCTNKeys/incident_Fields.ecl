...
EXPORT SALT33.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'Invalid_Batch','Invalid_Num','Invalid_Date','Invalid_CleanDate');
EXPORT FieldTypeNum(SALT33.StrType fn) := CASE(fn,'Invalid_Batch' => 1,'Invalid_Num' => 2,'Invalid_Date' => 3,'Invalid_CleanDate' => 4,0);
...
EXPORT MakeFT_Invalid_CleanDate(SALT33.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_Invalid_CleanDate(SALT33.StrType s) := WHICH(~Scrubs.fn_valid_date(s)>0);
EXPORT InValidMessageFT_Invalid_CleanDate(UNSIGNED1 wh) := CHOOSE(wh,SALT33.HygieneErrors.CustomFail('Scrubs.fn_valid_date'),SALT33.HygieneErrors.Good);
...
EXPORT FieldNum(SALT33.StrType fn) := CASE(fn,'batch_number' => 0,'incident_number' => 1,'party_number' => 2,'record_type' => 3,'order_number' => 4,'ag_code' => 5,'case_number' => 6,'incident_date' => 7,'jurisdiction' => 8,'source_document' => 9,'additional_info' => 10,'agency' => 11,'alleged_amount' => 12,'estimated_loss' => 13,'fcr_date' => 14,'ok_for_fcr' => 15,'modified_date' => 16,'load_date' => 17,'incident_text' => 18,'incident_date_clean' => 19,'fcr_date_clean' => 20,'cln_modified_date' => 21,'cln_load_date' => 22,0);
...
EXPORT Make_ag_code(SALT33.StrType s0) := s0;
EXPORT InValid_ag_code(SALT33.StrType s) := FALSE;
...
EXPORT Make_incident_date(SALT33.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_incident_date(SALT33.StrType s) := InValidFT_Invalid_Date(s);
...
EXPORT Make_source_document(SALT33.StrType s0) := s0;
EXPORT InValid_source_document(SALT33.StrType s) := FALSE;
...
EXPORT Make_alleged_amount(SALT33.StrType s0) := s0;
EXPORT InValid_alleged_amount(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_alleged_amount(UNSIGNED1 wh) := '';
EXPORT Make_estimated_loss(SALT33.StrType s0) := s0;
EXPORT InValid_estimated_loss(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_estimated_loss(UNSIGNED1 wh) := '';
EXPORT Make_fcr_date(SALT33.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_fcr_date(SALT33.StrType s) := InValidFT_Invalid_Date(s);
...
EXPORT Make_modified_date(SALT33.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_modified_date(SALT33.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_modified_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
EXPORT Make_load_date(SALT33.StrType s0) := MakeFT_Invalid_Date(s0);
EXPORT InValid_load_date(SALT33.StrType s) := InValidFT_Invalid_Date(s);
EXPORT InValidMessage_load_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_Date(wh);
EXPORT Make_incident_text(SALT33.StrType s0) := s0;
EXPORT InValid_incident_text(SALT33.StrType s) := FALSE;
EXPORT InValidMessage_incident_text(UNSIGNED1 wh) := '';
EXPORT Make_incident_date_clean(SALT33.StrType s0) := MakeFT_Invalid_CleanDate(s0);
EXPORT InValid_incident_date_clean(SALT33.StrType s) := InValidFT_Invalid_CleanDate(s);
EXPORT InValidMessage_incident_date_clean(UNSIGNED1 wh) := InValidMessageFT_Invalid_CleanDate(wh);
EXPORT Make_fcr_date_clean(SALT33.StrType s0) := MakeFT_Invalid_CleanDate(s0);
EXPORT InValid_fcr_date_clean(SALT33.StrType s) := InValidFT_Invalid_CleanDate(s);
EXPORT InValidMessage_fcr_date_clean(UNSIGNED1 wh) := InValidMessageFT_Invalid_CleanDate(wh);
EXPORT Make_cln_modified_date(SALT33.StrType s0) := MakeFT_Invalid_CleanDate(s0);
EXPORT InValid_cln_modified_date(SALT33.StrType s) := InValidFT_Invalid_CleanDate(s);
EXPORT InValidMessage_cln_modified_date(UNSIGNED1 wh) := InValidMessageFT_Invalid_CleanDate(wh);
EXPORT Make_cln_load_date(SALT33.StrType s0) := MakeFT_Invalid_CleanDate(s0);
EXPORT InValid_cln_load_date(SALT33.StrType s) := InValidFT_Invalid_CleanDate(s);
