...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_license_number := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_number)));
    avelength_license_number := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_number)),h.license_number<>(typeof(h.license_number))'');
    populated_license_type_pcnt := AVE(GROUP,IF(h.license_type = (TYPEOF(h.license_type))'',0,100));
    maxlength_license_type := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_type)));
    avelength_license_type := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_type)),h.license_type<>(typeof(h.license_type))'');
    populated_license_state_pcnt := AVE(GROUP,IF(h.license_state = (TYPEOF(h.license_state))'',0,100));
    maxlength_license_state := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_state)));
    avelength_license_state := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.license_state)),h.license_state<>(typeof(h.license_state))'');
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.license_number),TRIM((SALT33.StrType)le.license_type),TRIM((SALT33.StrType)le.license_state),TRIM((SALT33.StrType)le.cln_license_number),TRIM((SALT33.StrType)le.std_type_desc)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 10);
  SELF.FldNo2 := 1 + (C % 10);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.license_number),TRIM((SALT33.StrType)le.license_type),TRIM((SALT33.StrType)le.license_state),TRIM((SALT33.StrType)le.cln_license_number),TRIM((SALT33.StrType)le.std_type_desc)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.license_number),TRIM((SALT33.StrType)le.license_type),TRIM((SALT33.StrType)le.license_state),TRIM((SALT33.StrType)le.cln_license_number),TRIM((SALT33.StrType)le.std_type_desc)));
  END;
...
SHARED FldIds := DATASET([{1,'batch_number'}
      ...
      ,{10,'std_type_desc'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    license_Fields.InValid_batch_number((SALT33.StrType)le.batch_number),
    license_Fields.InValid_incident_number((SALT33.StrType)le.incident_number),
    license_Fields.InValid_party_number((SALT33.StrType)le.party_number),
    license_Fields.InValid_record_type((SALT33.StrType)le.record_type),
    license_Fields.InValid_order_number((SALT33.StrType)le.order_number),
    license_Fields.InValid_license_number((SALT33.StrType)le.license_number),
    license_Fields.InValid_license_type((SALT33.StrType)le.license_type),
    license_Fields.InValid_license_state((SALT33.StrType)le.license_state),
    license_Fields.InValid_cln_license_number((SALT33.StrType)le.cln_license_number),
    license_Fields.InValid_std_type_desc((SALT33.StrType)le.std_type_desc),
    0);
