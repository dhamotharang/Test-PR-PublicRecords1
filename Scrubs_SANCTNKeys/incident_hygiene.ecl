...
EXPORT Summary(SALT33.Str30Type txt) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_ag_code := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.ag_code)));
    avelength_ag_code := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.ag_code)),h.ag_code<>(typeof(h.ag_code))'');
    ...
    maxlength_source_document := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_document)));
    avelength_source_document := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.source_document)),h.source_document<>(typeof(h.source_document))'');
    ...
    maxlength_alleged_amount := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.alleged_amount)));
    avelength_alleged_amount := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.alleged_amount)),h.alleged_amount<>(typeof(h.alleged_amount))'');
    populated_estimated_loss_pcnt := AVE(GROUP,IF(h.estimated_loss = (TYPEOF(h.estimated_loss))'',0,100));
    maxlength_estimated_loss := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.estimated_loss)));
    avelength_estimated_loss := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.estimated_loss)),h.estimated_loss<>(typeof(h.estimated_loss))'');
    populated_fcr_date_pcnt := AVE(GROUP,IF(h.fcr_date = (TYPEOF(h.fcr_date))'',0,100));
    maxlength_fcr_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcr_date)));
    avelength_fcr_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcr_date)),h.fcr_date<>(typeof(h.fcr_date))'');
    ...
    maxlength_load_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.load_date)));
    avelength_load_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.load_date)),h.load_date<>(typeof(h.load_date))'');
    populated_incident_text_pcnt := AVE(GROUP,IF(h.incident_text = (TYPEOF(h.incident_text))'',0,100));
    maxlength_incident_text := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.incident_text)));
    avelength_incident_text := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.incident_text)),h.incident_text<>(typeof(h.incident_text))'');
    populated_incident_date_clean_pcnt := AVE(GROUP,IF(h.incident_date_clean = (TYPEOF(h.incident_date_clean))'',0,100));
    maxlength_incident_date_clean := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.incident_date_clean)));
    avelength_incident_date_clean := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.incident_date_clean)),h.incident_date_clean<>(typeof(h.incident_date_clean))'');
    populated_fcr_date_clean_pcnt := AVE(GROUP,IF(h.fcr_date_clean = (TYPEOF(h.fcr_date_clean))'',0,100));
    maxlength_fcr_date_clean := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcr_date_clean)));
    avelength_fcr_date_clean := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.fcr_date_clean)),h.fcr_date_clean<>(typeof(h.fcr_date_clean))'');
    populated_cln_modified_date_pcnt := AVE(GROUP,IF(h.cln_modified_date = (TYPEOF(h.cln_modified_date))'',0,100));
    maxlength_cln_modified_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cln_modified_date)));
    avelength_cln_modified_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cln_modified_date)),h.cln_modified_date<>(typeof(h.cln_modified_date))'');
    populated_cln_load_date_pcnt := AVE(GROUP,IF(h.cln_load_date = (TYPEOF(h.cln_load_date))'',0,100));
    maxlength_cln_load_date := MAX(GROUP,LENGTH(TRIM((SALT33.StrType)h.cln_load_date)));
    avelength_cln_load_date := AVE(GROUP,LENGTH(TRIM((SALT33.StrType)h.cln_load_date)),h.cln_load_date<>(typeof(h.cln_load_date))'');
  END;
...
SALT33.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.ag_code),TRIM((SALT33.StrType)le.case_number),TRIM((SALT33.StrType)le.incident_date),TRIM((SALT33.StrType)le.jurisdiction),TRIM((SALT33.StrType)le.source_document),TRIM((SALT33.StrType)le.additional_info),TRIM((SALT33.StrType)le.agency),TRIM((SALT33.StrType)le.alleged_amount),TRIM((SALT33.StrType)le.estimated_loss),TRIM((SALT33.StrType)le.fcr_date),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.modified_date),TRIM((SALT33.StrType)le.load_date),TRIM((SALT33.StrType)le.incident_text),TRIM((SALT33.StrType)le.incident_date_clean),TRIM((SALT33.StrType)le.fcr_date_clean),TRIM((SALT33.StrType)le.cln_modified_date),TRIM((SALT33.StrType)le.cln_load_date)));
  SELF.FldNo := C;
END;
...
SALT33.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 23);
  SELF.FldNo2 := 1 + (C % 23);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.ag_code),TRIM((SALT33.StrType)le.case_number),TRIM((SALT33.StrType)le.incident_date),TRIM((SALT33.StrType)le.jurisdiction),TRIM((SALT33.StrType)le.source_document),TRIM((SALT33.StrType)le.additional_info),TRIM((SALT33.StrType)le.agency),TRIM((SALT33.StrType)le.alleged_amount),TRIM((SALT33.StrType)le.estimated_loss),TRIM((SALT33.StrType)le.fcr_date),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.modified_date),TRIM((SALT33.StrType)le.load_date),TRIM((SALT33.StrType)le.incident_text),TRIM((SALT33.StrType)le.incident_date_clean),TRIM((SALT33.StrType)le.fcr_date_clean),TRIM((SALT33.StrType)le.cln_modified_date),TRIM((SALT33.StrType)le.cln_load_date)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT33.StrType)le.batch_number),TRIM((SALT33.StrType)le.incident_number),TRIM((SALT33.StrType)le.party_number),TRIM((SALT33.StrType)le.record_type),TRIM((SALT33.StrType)le.order_number),TRIM((SALT33.StrType)le.ag_code),TRIM((SALT33.StrType)le.case_number),TRIM((SALT33.StrType)le.incident_date),TRIM((SALT33.StrType)le.jurisdiction),TRIM((SALT33.StrType)le.source_document),TRIM((SALT33.StrType)le.additional_info),TRIM((SALT33.StrType)le.agency),TRIM((SALT33.StrType)le.alleged_amount),TRIM((SALT33.StrType)le.estimated_loss),TRIM((SALT33.StrType)le.fcr_date),TRIM((SALT33.StrType)le.ok_for_fcr),TRIM((SALT33.StrType)le.modified_date),TRIM((SALT33.StrType)le.load_date),TRIM((SALT33.StrType)le.incident_text),TRIM((SALT33.StrType)le.incident_date_clean),TRIM((SALT33.StrType)le.fcr_date_clean),TRIM((SALT33.StrType)le.cln_modified_date),TRIM((SALT33.StrType)le.cln_load_date)));
  END;
...
SHARED FldIds := DATASET([{1,'batch_number'}
      ...
      ,{23,'cln_load_date'}],SALT33.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    incident_Fields.InValid_batch_number((SALT33.StrType)le.batch_number),
    incident_Fields.InValid_incident_number((SALT33.StrType)le.incident_number),
    incident_Fields.InValid_party_number((SALT33.StrType)le.party_number),
    incident_Fields.InValid_record_type((SALT33.StrType)le.record_type),
    incident_Fields.InValid_order_number((SALT33.StrType)le.order_number),
    incident_Fields.InValid_ag_code((SALT33.StrType)le.ag_code),
    incident_Fields.InValid_case_number((SALT33.StrType)le.case_number),
    incident_Fields.InValid_incident_date((SALT33.StrType)le.incident_date),
    incident_Fields.InValid_jurisdiction((SALT33.StrType)le.jurisdiction),
    incident_Fields.InValid_source_document((SALT33.StrType)le.source_document),
    incident_Fields.InValid_additional_info((SALT33.StrType)le.additional_info),
    incident_Fields.InValid_agency((SALT33.StrType)le.agency),
    incident_Fields.InValid_alleged_amount((SALT33.StrType)le.alleged_amount),
    incident_Fields.InValid_estimated_loss((SALT33.StrType)le.estimated_loss),
    incident_Fields.InValid_fcr_date((SALT33.StrType)le.fcr_date),
    incident_Fields.InValid_ok_for_fcr((SALT33.StrType)le.ok_for_fcr),
    incident_Fields.InValid_modified_date((SALT33.StrType)le.modified_date),
    incident_Fields.InValid_load_date((SALT33.StrType)le.load_date),
    incident_Fields.InValid_incident_text((SALT33.StrType)le.incident_text),
    incident_Fields.InValid_incident_date_clean((SALT33.StrType)le.incident_date_clean),
    incident_Fields.InValid_fcr_date_clean((SALT33.StrType)le.fcr_date_clean),
    incident_Fields.InValid_cln_modified_date((SALT33.StrType)le.cln_modified_date),
    incident_Fields.InValid_cln_load_date((SALT33.StrType)le.cln_load_date),
    0);
