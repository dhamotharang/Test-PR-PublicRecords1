...
IMPORT B_Customer_3,B_Customer_4,B_Event_3,E_Address,E_Bank,E_Bank_Account,E_Customer,E_Drivers_License,E_Email,E_Event,E_Internet_Protocol,E_Person,E_Phone FROM KELOtto;
...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE306548 := __ENH_Event_3;
  SHARED __EE307351 := __EE306548;
  SHARED __ST307969_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __ST307969_Layout __JT307966(B_Event_3.__ST51658_Layout __l, E_Event.Event_Types_Layout __r) := TRANSFORM
    SELF.__RecordCount := __r.__RecordCount;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE307967 := NORMALIZE(__EE307351,__T(LEFT.Event_Types_),__JT307966(LEFT,RIGHT));
  SHARED __ST307470_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE308181 := PROJECT(__EE307967,__ST307470_Layout);
  SHARED __ST307489_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nbool Exp1_;
    KEL.typ.nbool Exp2_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST307489_Layout __ND311222__Project(__ST307470_Layout __PP310988) := TRANSFORM
    SELF.Exp1_ := __OP2(__PP310988.Event_Type_,IN,__CN(['202','204','292','100']));
    SELF.Exp2_ := __OP2(__PP310988.Event_Type_,IN,__CN(['893','890']));
    SELF := __PP310988;
  END;
  SHARED __EE311229 := PROJECT(__EE308181,__ND311222__Project(LEFT));
  SHARED __ST307509_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE312467 := PROJECT(__CLEANANDDO(__EE311229,TABLE(__EE311229,{KEL.typ.int C_O_U_N_T___Event_Types_ := COUNT(GROUP,__T(__EE311229.Exp1_)),KEL.typ.int C_O_U_N_T___Event_Types__1_ := COUNT(GROUP,__T(__EE311229.Exp2_)),UID},UID,MERGE)),__ST307509_Layout);
  SHARED __ST308188_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC312476(B_Event_3.__ST51658_Layout __EE306548, __ST307509_Layout __EE312467) := __EEQP(__EE306548.UID,__EE312467.UID);
  __ST308188_Layout __JT312476(B_Event_3.__ST51658_Layout __l, __ST307509_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE312477 := JOIN(__EE306548,__EE312467,__JC312476(LEFT,RIGHT),__JT312476(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE306216 := __ENH_Customer_3;
  SHARED __ST309193_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC312486(__ST308188_Layout __EE312477, B_Customer_3.__ST50972_Layout __EE306216) := __EEQP(__EE312477._r_Customer_,__EE306216.UID);
  __ST309193_Layout __JT312486(__ST308188_Layout __l, B_Customer_3.__ST50972_Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE312487 := JOIN(__EE312477,__EE306216,__JC312486(LEFT,RIGHT),__JT312486(LEFT,RIGHT),LEFT OUTER,LOOKUP);
  EXPORT __ST49401_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
  ...
  SHARED __ST49401_Layout __ND311674__Project(__ST309193_Layout __PP311670) := TRANSFORM
    ...
    SELF := __PP311670;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE312487,__ND311674__Project(LEFT));
END;
