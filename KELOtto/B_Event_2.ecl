...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE123536 := __ENH_Event_3;
  EXPORT __ST20694_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST20694_Layout __ND124988__Project(B_Event_4.__ST22007_Layout __PP123539) := TRANSFORM
    SELF.Ip_High_Risk_City_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP123539._edgecity_),IN,__CN(['MIAMI'])))=>1,0);
    SELF := __PP123539;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE123536,__ND124988__Project(LEFT));
END;
