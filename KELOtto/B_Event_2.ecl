...
EXPORT B_Event_2 := MODULE
  ...
  SHARED __EE121775 := __ENH_Event_3;
  EXPORT __ST20684_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST20684_Layout __ND123227__Project(B_Event_4.__ST21996_Layout __PP121778) := TRANSFORM
    SELF.Ip_High_Risk_City_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP121778._edgecity_),IN,__CN(['MIAMI'])))=>1,0);
    SELF := __PP121778;
  END;
  EXPORT __ENH_Event_2 := PROJECT(__EE121775,__ND123227__Project(LEFT));
END;
