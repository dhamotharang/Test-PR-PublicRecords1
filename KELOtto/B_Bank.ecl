...
EXPORT B_Bank := MODULE
  SHARED __EE504497 := E_Bank.__Result;
  SHARED IDX_Bank_UID_Layout := RECORD
    KEL.typ.uid UID;
    __EE504497._r_Customer_;
    __EE504497.Source_Customers_;
    __EE504497.Routing_Number_;
    __EE504497.Date_First_Seen_;
    __EE504497.Date_Last_Seen_;
    __EE504497.__RecordCount;
  END;
  SHARED IDX_Bank_UID_Projected := PROJECT(__EE504497,TRANSFORM(IDX_Bank_UID_Layout,SELF.UID:=__T(LEFT.UID),SELF:=LEFT));
  ...
  EXPORT __ST504499_Layout := RECORDOF(IDX_Bank_UID);
