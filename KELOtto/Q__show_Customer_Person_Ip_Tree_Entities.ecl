...
EXPORT Q__show_Customer_Person_Ip_Tree_Entities := MODULE
  ...
  SHARED __EE3238596 := __E_Person_Ip_Address;
  SHARED __EE3238579 := __ENH_Person;
  SHARED __ST3238614_Layout := RECORD
  ...
  END;
  __JC3238611(E_Person_Ip_Address.Layout __EE3238596, B_Person.__ST45670_Layout __EE3238579) := __EEQP(__EE3238596.Subject_,__EE3238579.UID);
  __ST3238614_Layout __JT3238611(E_Person_Ip_Address.Layout __l, B_Person.__ST45670_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3238612 := JOIN(__EE3238596,__EE3238579,__JC3238611(LEFT,RIGHT),__JT3238611(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3238567 := __ENH_Internet_Protocol;
  SHARED __ST3239063_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3240579(__ST3238614_Layout __EE3238612, B_Internet_Protocol.__ST42820_Layout __EE3238567) := __EEQP(__EE3238612.Ip_,__EE3238567.UID);
  __ST3239063_Layout __JT3240579(__ST3238614_Layout __l, B_Internet_Protocol.__ST42820_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3240580 := JOIN(__EE3238612,__EE3238567,__JC3240579(LEFT,RIGHT),__JT3240579(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3238552 := __E_Customer;
  SHARED __ST3239919_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3240581(__ST3239063_Layout __EE3240580, E_Customer.Layout __EE3238552) := __EEQP(__EE3240580._r_Customer_,__EE3238552.UID);
  __ST3239919_Layout __JT3240581(__ST3239063_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3240582 := JOIN(__EE3240580,__EE3238552,__JC3240581(LEFT,RIGHT),__JT3240581(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST32995_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32995_Layout __ND3240571__Project(__ST3239919_Layout __PP3240570) := TRANSFORM
    SELF.Source_Customer_ := __PP3240570._r_Customer_;
    SELF.Customer_Id_ := __PP3240570.Customer_Id__2_;
    SELF.Industry_Type_ := __PP3240570.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP3240570.Entity_Context_Uid__1_;
    SELF := __PP3240570;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE3240582,__ND3240571__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST32995_Layout));
END;
