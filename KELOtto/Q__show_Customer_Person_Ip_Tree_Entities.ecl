...
IMPORT B_Internet_Protocol,B_Person,B_Person_1,B_Person_2,E_Address,E_Customer,E_Internet_Protocol,E_Person,E_Person_Ip_Address FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT Q__show_Customer_Person_Ip_Tree_Entities := MODULE
  ...
  SHARED __EE3233624 := __E_Person_Ip_Address;
  SHARED __EE3233607 := __ENH_Person;
  SHARED __ST3233642_Layout := RECORD
  ...
  END;
  __JC3233639(E_Person_Ip_Address.Layout __EE3233624, B_Person.__ST45628_Layout __EE3233607) := __EEQP(__EE3233624.Subject_,__EE3233607.UID);
  __ST3233642_Layout __JT3233639(E_Person_Ip_Address.Layout __l, B_Person.__ST45628_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3233640 := JOIN(__EE3233624,__EE3233607,__JC3233639(LEFT,RIGHT),__JT3233639(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3233595 := __ENH_Internet_Protocol;
  SHARED __ST3234091_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3235607(__ST3233642_Layout __EE3233640, B_Internet_Protocol.__ST42785_Layout __EE3233595) := __EEQP(__EE3233640.Ip_,__EE3233595.UID);
  __ST3234091_Layout __JT3235607(__ST3233642_Layout __l, B_Internet_Protocol.__ST42785_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3235608 := JOIN(__EE3233640,__EE3233595,__JC3235607(LEFT,RIGHT),__JT3235607(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3233580 := __E_Customer;
  SHARED __ST3234947_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3235609(__ST3234091_Layout __EE3235608, E_Customer.Layout __EE3233580) := __EEQP(__EE3235608._r_Customer_,__EE3233580.UID);
  __ST3234947_Layout __JT3235609(__ST3234091_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3235610 := JOIN(__EE3235608,__EE3233580,__JC3235609(LEFT,RIGHT),__JT3235609(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST32960_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST32960_Layout __ND3235599__Project(__ST3234947_Layout __PP3235598) := TRANSFORM
    SELF.Source_Customer_ := __PP3235598._r_Customer_;
    SELF.Customer_Id_ := __PP3235598.Customer_Id__2_;
    SELF.Industry_Type_ := __PP3235598.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP3235598.Entity_Context_Uid__1_;
    SELF := __PP3235598;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE3235610,__ND3235599__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST32960_Layout));
END;
