...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE834912 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE834912(__NN(__EE834912.Ip_));
  ...
  EXPORT __ST834914_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
