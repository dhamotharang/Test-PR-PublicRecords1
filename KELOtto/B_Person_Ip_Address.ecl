...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE825298 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE825298(__NN(__EE825298.Ip_));
  ...
  EXPORT __ST825300_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
