...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE502587 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE502587(__NN(__EE502587.Ip_));
  ...
  EXPORT __ST502589_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
