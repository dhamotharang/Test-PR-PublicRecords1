...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE526872 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE526872(__NN(__EE526872.Ip_));
  ...
  EXPORT __ST526874_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
