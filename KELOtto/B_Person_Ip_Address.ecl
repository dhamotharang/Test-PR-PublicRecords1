...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE831272 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE831272(__NN(__EE831272.Ip_));
  ...
  EXPORT __ST831274_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
