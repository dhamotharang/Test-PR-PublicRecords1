...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE732630 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE732630(__NN(__EE732630.Ip_));
  ...
  EXPORT __ST732632_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
