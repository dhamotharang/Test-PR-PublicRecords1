...
EXPORT B_Person_Ip_Address := MODULE
  SHARED __EE832588 := E_Person_Ip_Address.__Result;
  SHARED __IDX_Person_Ip_Address_Ip__Filtered := __EE832588(__NN(__EE832588.Ip_));
  ...
  EXPORT __ST832590_Layout := RECORDOF(IDX_Person_Ip_Address_Ip_);
