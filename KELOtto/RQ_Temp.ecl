...
IMPORT B_Person,B_Person_2,B_Person_Person,E_Customer,E_Person,E_Person_Person FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ_Temp := MODULE
  SHARED __EE184268 := B_Person_Person.IDX_Person_Person_From_Person__Wrapped;
  SHARED __ST185945_Layout := RECORD
  ...
  END;
  SHARED __EE185959 := PROJECT(TABLE(PROJECT(__EE184268,__ST185945_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_,Public_Records_,Contributory_Records_,Same_Address_Email_Match_,Same_Address_Ssn_Match_,Same_Address_Phone_Number_Match_,Same_Address_Same_Day_Count_,High_Frequency_Same_Address_Same_Day_Count_,Non_High_Frequency_Address_Count_,Shared_Address_Count_},_r_Customer_,From_Person_,To_Person_,Public_Records_,Contributory_Records_,Same_Address_Email_Match_,Same_Address_Ssn_Match_,Same_Address_Phone_Number_Match_,Same_Address_Same_Day_Count_,High_Frequency_Same_Address_Same_Day_Count_,Non_High_Frequency_Address_Count_,Shared_Address_Count_,MERGE),__ST185945_Layout);
  SHARED __EE184271 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST186265_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE186438 := PROJECT(__EE184271,TRANSFORM(__ST186265_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST186633_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nint Public_Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC186445(__ST185945_Layout __EE185959, __ST186265_Layout __EE186438) := __EEQP(__EE185959.To_Person_,__EE186438.UID);
  __ST186633_Layout __JT186445(__ST185945_Layout __l, __ST186265_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE186631 := JOIN(__EE185959,__EE186438,__JC186445(LEFT,RIGHT),__JT186445(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE185193 := __EE184271;
  SHARED __ST176922_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nint Public_Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC186822(__ST186633_Layout __EE186631, B_Person.__ST2655_Layout __EE185193) := __EEQP(__EE186631.From_Person_,__EE185193.UID);
  __ST176922_Layout __JT186822(__ST186633_Layout __l, B_Person.__ST2655_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE187521 := JOIN(__EE186631,__EE185193,__JC186822(LEFT,RIGHT),__JT186822(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST176513_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nint Lex_Id_;
    KEL.typ.nint Lex_Id__1_;
    KEL.typ.nint Public_Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST176513_Layout __ND188175__Project(__ST176922_Layout __PP187522) := TRANSFORM
    SELF.Lex_Id_ := __PP187522.Lex_Id__1_;
    SELF.Lex_Id__1_ := __PP187522.Lex_Id_;
    SELF := __PP187522;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE187521,__ND188175__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Lex_Id_,Lex_Id__1_,Public_Records_,Contributory_Records_,Same_Address_Email_Match_,Same_Address_Ssn_Match_,Same_Address_Phone_Number_Match_,Non_High_Frequency_Address_Count_,Same_Address_Same_Day_Count_,High_Frequency_Same_Address_Same_Day_Count_,Shared_Address_Count_,Deceased_,Deceased_Event_Count_,Death_Prior_To_All_Events_},_r_Customer_,Lex_Id_,Lex_Id__1_,Public_Records_,Contributory_Records_,Same_Address_Email_Match_,Same_Address_Ssn_Match_,Same_Address_Phone_Number_Match_,Non_High_Frequency_Address_Count_,Same_Address_Same_Day_Count_,High_Frequency_Same_Address_Same_Day_Count_,Shared_Address_Count_,Deceased_,Deceased_Event_Count_,Death_Prior_To_All_Events_,MERGE),__ST176513_Layout));
END;
