...
PersonDeceasedFile := PROJECT(PULL(FraudGovPlatform.files(,KELOtto.Constants.useOtherEnvironmentDali).base.Death.built), TRANSFORM(rPersonDeceasedLayout, SELF.did := (UNSIGNED)LEFT.did, SELF := LEFT));
