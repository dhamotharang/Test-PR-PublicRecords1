...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE792714 := __E_Person_Bank_Account;
  SHARED __EE792762 := __ENH_Person;
  SHARED __ST792795_Layout := RECORD
  ...
  END;
  __JC792792(E_Person_Bank_Account.Layout __EE792714, B_Person.__ST18771_Layout __EE792762) := __EEQP(__EE792714.Subject_,__EE792762.UID);
  __ST792795_Layout __JT792792(E_Person_Bank_Account.Layout __l, B_Person.__ST18771_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE792793 := JOIN(__EE792714,__EE792762,__JC792792(LEFT,RIGHT),__JT792792(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE792751 := __ENH_Bank_Account;
  SHARED __ST793119_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC793960(__ST792795_Layout __EE792793, B_Bank_Account.__ST17785_Layout __EE792751) := __EEQP(__EE792793.Account_,__EE792751.UID);
  __ST793119_Layout __JT793960(__ST792795_Layout __l, B_Bank_Account.__ST17785_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE793961 := JOIN(__EE792793,__EE792751,__JC793960(LEFT,RIGHT),__JT793960(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE792737 := __E_Customer;
  SHARED __ST793572_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC793962(__ST793119_Layout __EE793961, E_Customer.Layout __EE792737) := __EEQP(__EE793961._r_Customer_,__EE792737.UID);
  __ST793572_Layout __JT793962(__ST793119_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE793963 := JOIN(__EE793961,__EE792737,__JC793962(LEFT,RIGHT),__JT793962(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST17564_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17564_Layout __ND793952__Project(__ST793572_Layout __PP793951) := TRANSFORM
    SELF.Source_Customer_ := __PP793951._r_Customer_;
    SELF.Customer_Id_ := __PP793951.Customer_Id__2_;
    SELF.Industry_Type_ := __PP793951.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP793951.Entity_Context_Uid__1_;
    SELF := __PP793951;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE793963,__ND793952__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST17564_Layout));
END;
