...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE696314 := __E_Person_Bank_Account;
  SHARED __EE696362 := __ENH_Person;
  SHARED __ST696395_Layout := RECORD
  ...
  END;
  __JC696392(E_Person_Bank_Account.Layout __EE696314, B_Person.__ST14833_Layout __EE696362) := __EEQP(__EE696314.Subject_,__EE696362.UID);
  __ST696395_Layout __JT696392(E_Person_Bank_Account.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE696393 := JOIN(__EE696314,__EE696362,__JC696392(LEFT,RIGHT),__JT696392(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE696351 := __ENH_Bank_Account;
  SHARED __ST696661_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC697386(__ST696395_Layout __EE696393, B_Bank_Account.__ST13934_Layout __EE696351) := __EEQP(__EE696393.Account_,__EE696351.UID);
  __ST696661_Layout __JT697386(__ST696395_Layout __l, B_Bank_Account.__ST13934_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE697387 := JOIN(__EE696393,__EE696351,__JC697386(LEFT,RIGHT),__JT697386(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE696337 := __E_Customer;
  SHARED __ST697056_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC697388(__ST696661_Layout __EE697387, E_Customer.Layout __EE696337) := __EEQP(__EE697387._r_Customer_,__EE696337.UID);
  __ST697056_Layout __JT697388(__ST696661_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE697389 := JOIN(__EE697387,__EE696337,__JC697388(LEFT,RIGHT),__JT697388(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST13717_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST13717_Layout __ND697378__Project(__ST697056_Layout __PP697377) := TRANSFORM
    SELF.Source_Customer_ := __PP697377._r_Customer_;
    SELF.Customer_Id_ := __PP697377.Customer_Id__2_;
    SELF.Industry_Type_ := __PP697377.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP697377.Entity_Context_Uid__1_;
    SELF := __PP697377;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE697389,__ND697378__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST13717_Layout));
END;
