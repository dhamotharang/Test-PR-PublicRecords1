...
EXPORT Q__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  ...
  SHARED __EE685404 := __E_Person_Bank_Account;
  SHARED __EE685452 := __ENH_Person;
  SHARED __ST685485_Layout := RECORD
  ...
  END;
  __JC685482(E_Person_Bank_Account.Layout __EE685404, B_Person.__ST14816_Layout __EE685452) := __EEQP(__EE685404.Subject_,__EE685452.UID);
  __ST685485_Layout __JT685482(E_Person_Bank_Account.Layout __l, B_Person.__ST14816_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE685483 := JOIN(__EE685404,__EE685452,__JC685482(LEFT,RIGHT),__JT685482(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE685441 := __ENH_Bank_Account;
  SHARED __ST685751_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC685748(__ST685485_Layout __EE685483, B_Bank_Account.__ST13917_Layout __EE685441) := __EEQP(__EE685483.Account_,__EE685441.UID);
  __ST685751_Layout __JT685748(__ST685485_Layout __l, B_Bank_Account.__ST13917_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE685749 := JOIN(__EE685441,__EE685483,__JC685748(RIGHT,LEFT),__JT685748(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST686788_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nunk Entity_Context_Uid__1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __EE686793 := PROJECT(TABLE(PROJECT(__EE685749,__ST686788_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_},_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_,MERGE),__ST686788_Layout);
  SHARED __EE685427 := __E_Customer;
  SHARED __ST686803_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST686803_Layout __ND686796__Project(E_Customer.Layout __PP686795) := TRANSFORM
    SELF.U_I_D__2_ := __PP686795.UID;
    SELF.Customer_Id__2_ := __PP686795.Customer_Id_;
    SELF.Industry_Type__2_ := __PP686795.Industry_Type_;
    SELF := __PP686795;
  END;
  SHARED __EE686808 := PROJECT(__EE685427,__ND686796__Project(LEFT));
  SHARED __ST686826_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nunk Entity_Context_Uid__1_;
    KEL.typ.nuid U_I_D__2_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC686815(__ST686788_Layout __EE686793, __ST686803_Layout __EE686808) := __EEQP(__EE686793._r_Customer_,__EE686808.U_I_D__2_);
  __ST686826_Layout __JT686815(__ST686788_Layout __l, __ST686803_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE686824 := JOIN(__EE686793,__EE686808,__JC686815(LEFT,RIGHT),__JT686815(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST13700_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST13700_Layout __ND686837__Project(__ST686826_Layout __PP686825) := TRANSFORM
    SELF.Source_Customer_ := __PP686825._r_Customer_;
    SELF.Customer_Id_ := __PP686825.Customer_Id__2_;
    SELF.Industry_Type_ := __PP686825.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP686825.Entity_Context_Uid__1_;
    SELF := __PP686825;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE686824,__ND686837__Project(LEFT)));
END;
