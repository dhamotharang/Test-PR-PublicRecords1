...
EXPORT B_Event_7 := MODULE
  ...
  SHARED __EE23701 := __E_Event;
  EXPORT __ST23252_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST23252_Layout __ND25080__Project(E_Event.Layout __PP23704) := TRANSFORM
    SELF.Event_Type_Count_ := KEL.Aggregates.CountN(__PP23704.Event_Types_);
    SELF := __PP23704;
  END;
  EXPORT __ENH_Event_7 := PROJECT(__EE23701,__ND25080__Project(LEFT));
END;
