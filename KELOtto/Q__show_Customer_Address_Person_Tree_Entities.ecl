...
EXPORT Q__show_Customer_Address_Person_Tree_Entities := MODULE
  ...
  SHARED __EE679200 := __E_Person_Address;
  SHARED __EE679248 := __ENH_Person;
  SHARED __ST679281_Layout := RECORD
  ...
  END;
  __JC679278(E_Person_Address.Layout __EE679200, B_Person.__ST14833_Layout __EE679248) := __EEQP(__EE679200.Subject_,__EE679248.UID);
  __ST679281_Layout __JT679278(E_Person_Address.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE679279 := JOIN(__EE679200,__EE679248,__JC679278(LEFT,RIGHT),__JT679278(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE679237 := __ENH_Address;
  SHARED __ST679547_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC680384(__ST679281_Layout __EE679279, B_Address.__ST13794_Layout __EE679237) := __EEQP(__EE679279.Location_,__EE679237.UID);
  __ST679547_Layout __JT680384(__ST679281_Layout __l, B_Address.__ST13794_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE680385 := JOIN(__EE679279,__EE679237,__JC680384(LEFT,RIGHT),__JT680384(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE679223 := __E_Customer;
  SHARED __ST680008_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC680386(__ST679547_Layout __EE680385, E_Customer.Layout __EE679223) := __EEQP(__EE680385._r_Customer_,__EE679223.UID);
  __ST680008_Layout __JT680386(__ST679547_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE680387 := JOIN(__EE680385,__EE679223,__JC680386(LEFT,RIGHT),__JT680386(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST13597_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST13597_Layout __ND680376__Project(__ST680008_Layout __PP680375) := TRANSFORM
    SELF.Source_Customer_ := __PP680375._r_Customer_;
    SELF.Customer_Id_ := __PP680375.Customer_Id__2_;
    SELF.Industry_Type_ := __PP680375.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP680375.Entity_Context_Uid__1_;
    SELF := __PP680375;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE680387,__ND680376__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST13597_Layout));
END;
