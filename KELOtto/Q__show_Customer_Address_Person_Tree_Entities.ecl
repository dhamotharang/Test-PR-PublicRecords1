...
EXPORT Q__show_Customer_Address_Person_Tree_Entities := MODULE
  ...
  SHARED __EE168260 := __E_Person_Event;
  SHARED __ST169642_Layout := RECORD
  ...
  END;
  SHARED __EE169647 := PROJECT(TABLE(PROJECT(__EE168260,__ST169642_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Subject_,Location_},_r_Customer_,Subject_,Location_,MERGE),__ST169642_Layout);
  SHARED __EE168308 := __ENH_Person;
  SHARED __ST169953_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE170126 := PROJECT(__EE168308,TRANSFORM(__ST169953_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST170312_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC170133(__ST169642_Layout __EE169647, __ST169953_Layout __EE170126) := __EEQP(__EE169647.Subject_,__EE170126.UID);
  __ST170312_Layout __JT170133(__ST169642_Layout __l, __ST169953_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE170310 := JOIN(__EE169647,__EE170126,__JC170133(LEFT,RIGHT),__JT170133(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE168297 := __ENH_Address;
  SHARED __ST168555_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC170492(__ST170312_Layout __EE170310, B_Address.__ST2423_Layout __EE168297) := __EEQP(__EE170310.Location_,__EE168297.UID);
  __ST168555_Layout __JT170492(__ST170312_Layout __l, B_Address.__ST2423_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE170759 := JOIN(__EE170310,__EE168297,__JC170492(LEFT,RIGHT),__JT170492(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE168283 := __E_Customer;
  SHARED __ST168847_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC171018(__ST168555_Layout __EE170759, E_Customer.Layout __EE168283) := __EEQP(__EE170759._r_Customer_,__EE168283.UID);
  __ST168847_Layout __JT171018(__ST168555_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE171273 := JOIN(__EE170759,__EE168283,__JC171018(LEFT,RIGHT),__JT171018(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2253_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2253_Layout __ND171519__Project(__ST168847_Layout __PP171274) := TRANSFORM
    SELF.Source_Customer_ := __PP171274._r_Customer_;
    SELF.Customer_Id_ := __PP171274.Customer_Id__2_;
    SELF.Industry_Type_ := __PP171274.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP171274.Entity_Context_Uid__1_;
    SELF := __PP171274;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE171273,__ND171519__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2253_Layout));
END;
