...
EXPORT Q__show_Customer_Address_Person_Tree_Entities := MODULE
  ...
  SHARED __EE765252 := __E_Person_Address;
  SHARED __EE765300 := __ENH_Person;
  SHARED __ST765333_Layout := RECORD
  ...
  END;
  __JC765330(E_Person_Address.Layout __EE765252, B_Person.__ST18765_Layout __EE765300) := __EEQP(__EE765252.Subject_,__EE765300.UID);
  __ST765333_Layout __JT765330(E_Person_Address.Layout __l, B_Person.__ST18765_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE765331 := JOIN(__EE765252,__EE765300,__JC765330(LEFT,RIGHT),__JT765330(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE765289 := __ENH_Address;
  SHARED __ST765654_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC766609(__ST765333_Layout __EE765331, B_Address.__ST17637_Layout __EE765289) := __EEQP(__EE765331.Location_,__EE765289.UID);
  __ST765654_Layout __JT766609(__ST765333_Layout __l, B_Address.__ST17637_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE766610 := JOIN(__EE765331,__EE765289,__JC766609(LEFT,RIGHT),__JT766609(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE765275 := __E_Customer;
  SHARED __ST766174_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC766611(__ST765654_Layout __EE766610, E_Customer.Layout __EE765275) := __EEQP(__EE766610._r_Customer_,__EE765275.UID);
  __ST766174_Layout __JT766611(__ST765654_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE766612 := JOIN(__EE766610,__EE765275,__JC766611(LEFT,RIGHT),__JT766611(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST17440_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17440_Layout __ND766601__Project(__ST766174_Layout __PP766600) := TRANSFORM
    SELF.Source_Customer_ := __PP766600._r_Customer_;
    SELF.Customer_Id_ := __PP766600.Customer_Id__2_;
    SELF.Industry_Type_ := __PP766600.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP766600.Entity_Context_Uid__1_;
    SELF := __PP766600;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE766612,__ND766601__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST17440_Layout));
END;
