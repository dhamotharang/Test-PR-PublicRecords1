...
EXPORT B_Person_Phone := MODULE
  SHARED __EE502270 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE502270(__NN(__EE502270.Phone_Number_));
  ...
  EXPORT __ST502272_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
