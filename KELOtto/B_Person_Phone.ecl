...
EXPORT B_Person_Phone := MODULE
  SHARED __EE831815 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE831815(__NN(__EE831815.Phone_Number_));
  ...
  EXPORT __ST831817_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
