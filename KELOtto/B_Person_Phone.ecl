...
EXPORT B_Person_Phone := MODULE
  SHARED __EE827160 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE827160(__NN(__EE827160.Phone_Number_));
  ...
  EXPORT __ST827162_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
