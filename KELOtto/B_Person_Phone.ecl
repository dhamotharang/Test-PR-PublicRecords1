...
EXPORT B_Person_Phone := MODULE
  SHARED __EE828730 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE828730(__NN(__EE828730.Phone_Number_));
  ...
  EXPORT __ST828732_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
