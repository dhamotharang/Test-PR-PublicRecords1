...
EXPORT B_Person_Phone := MODULE
  SHARED __EE831450 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE831450(__NN(__EE831450.Phone_Number_));
  ...
  EXPORT __ST831452_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
