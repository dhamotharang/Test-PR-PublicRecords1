...
EXPORT B_Person_Phone := MODULE
  SHARED __EE830913 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE830913(__NN(__EE830913.Phone_Number_));
  ...
  EXPORT __ST830915_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
