...
EXPORT B_Person_Phone := MODULE
  SHARED __EE720820 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE720820(__NN(__EE720820.Phone_Number_));
  ...
  EXPORT __ST720822_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
