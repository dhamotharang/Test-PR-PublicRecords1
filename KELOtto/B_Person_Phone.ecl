...
EXPORT B_Person_Phone := MODULE
  SHARED __EE835331 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE835331(__NN(__EE835331.Phone_Number_));
  ...
  EXPORT __ST835333_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
