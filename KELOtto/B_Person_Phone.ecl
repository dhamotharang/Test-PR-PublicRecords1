...
EXPORT B_Person_Phone := MODULE
  SHARED __EE526168 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE526168(__NN(__EE526168.Phone_Number_));
  ...
  EXPORT __ST526170_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
