...
EXPORT B_Person_Phone := MODULE
  SHARED __EE489446 := E_Person_Phone.__Result;
  SHARED __IDX_Person_Phone_Phone_Number__Filtered := __EE489446(__NN(__EE489446.Phone_Number_));
  ...
  EXPORT __ST489448_Layout := RECORDOF(IDX_Person_Phone_Phone_Number_);
