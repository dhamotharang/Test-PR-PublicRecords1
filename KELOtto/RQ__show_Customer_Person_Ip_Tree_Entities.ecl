...
IMPORT B_Customer,B_Customer_4,B_Internet_Protocol,B_Person,B_Person_2,B_Person_Ip_Address,E_Customer,E_Internet_Protocol,E_Person,E_Person_Ip_Address FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Ip_Tree_Entities := MODULE
  SHARED __EE2739415 := PROJECT(B_Person_Ip_Address.IDX_Person_Ip_Address_Ip__Wrapped,E_Person_Ip_Address.Layout);
  SHARED __EE2739418 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2622114_Layout := RECORD
  ...
  END;
  __JC2739426(E_Person_Ip_Address.Layout __EE2739415, B_Person.__ST39519_Layout __EE2739418) := __EEQP(__EE2739415.Subject_,__EE2739418.UID);
  __ST2622114_Layout __JT2739426(E_Person_Ip_Address.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2739427 := JOIN(__EE2739415,__EE2739418,__JC2739426(LEFT,RIGHT),__JT2739426(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2739752 := B_Internet_Protocol.IDX_Internet_Protocol_UID_Wrapped;
  SHARED __ST2622477_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2739760(__ST2622114_Layout __EE2739427, B_Internet_Protocol.__ST37077_Layout __EE2739752) := __EEQP(__EE2739427.Ip_,__EE2739752.UID);
  __ST2622477_Layout __JT2739760(__ST2622114_Layout __l, B_Internet_Protocol.__ST37077_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2739761 := JOIN(__EE2739427,__EE2739752,__JC2739760(LEFT,RIGHT),__JT2739760(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2741046 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2623215_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Internet_Protocol.Typ) Ip_;
    KEL.typ.ndataset(E_Person_Ip_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2741060(__ST2622477_Layout __EE2739761, E_Customer.Layout __EE2741046) := __EEQP(__EE2739761._r_Customer_,__EE2741046.UID);
  __ST2623215_Layout __JT2741060(__ST2622477_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2741588 := JOIN(__EE2739761,__EE2741046,__JC2741060(LEFT,RIGHT),__JT2741060(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2622019_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2622019_Layout __ND2742107__Project(__ST2623215_Layout __PP2741589) := TRANSFORM
    SELF.Source_Customer_ := __PP2741589._r_Customer_;
    SELF.Customer_Id_ := __PP2741589.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2741589.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2741589.Entity_Context_Uid__1_;
    SELF := __PP2741589;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2741588,__ND2742107__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2622019_Layout));
END;
