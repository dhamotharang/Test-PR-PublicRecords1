...
EXPORT B_Event_6 := MODULE
  ...
  SHARED __EE23867 := __ENH_Event_7;
  SHARED __EE24469 := __ENH_Person_7;
  SHARED __ST25155_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC25152(B_Event_7.__ST19271_Layout __EE23867, B_Person_7.__ST19489_Layout __EE24469) := __EEQP(__EE23867.Subject_,__EE24469.UID);
  __ST25155_Layout __JT25152(B_Event_7.__ST19271_Layout __l, B_Person_7.__ST19489_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE25153 := JOIN(__EE23867,__EE24469,__JC25152(LEFT,RIGHT),__JT25152(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE24488 := __E_Customer;
  SHARED __ST26156_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC27808(__ST25155_Layout __EE25153, E_Customer.Layout __EE24488) := __EEQP(__EE25153._r_Customer_,__EE24488.UID);
  __ST26156_Layout __JT27808(__ST25155_Layout __l, E_Customer.Layout __r) := TRANSFORM
    SELF.U_I_D__2_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE27809 := JOIN(__EE25153,__EE24488,__JC27808(LEFT,RIGHT),__JT27808(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST18825_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ndataset(E_Event.Source_Customers_Layout) Source_Customers_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST18825_Layout __ND28044__Project(__ST26156_Layout __PP27038) := TRANSFORM
    SELF.Deceased_Prior_To_Event_ := MAP(__T(__AND(__CN(__PP27038.Deceased_ = 1),__OP2(__PP27038.Deceased_Date__1_,<,__PP27038.Event_Date_)))=>1,0);
    SELF.Demo_Customer_ := __OP2(__CAST(KEL.typ.str,__PP27038.Customer_Id_),IN,__CN(['248283691','248283681','248283671']));
    __BS26869 := __T(__PP27038.Source_Customers_);
    SELF.In_Customer_Population_ := MAP(EXISTS(__BS26869(__T(__OP2(__T(__PP27038.Source_Customers_)._r_Source_Customer_,=,__PP27038._r_Customer_))))=>1,0);
    SELF := __PP27038;
  END;
  EXPORT __ENH_Event_6 := PROJECT(__EE27809,__ND28044__Project(LEFT));
END;
