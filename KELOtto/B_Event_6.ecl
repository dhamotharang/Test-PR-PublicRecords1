...
EXPORT B_Event_6 := MODULE
  ...
  __ST73962_Layout __JT81136(E_Event.Layout __l, __ST73071_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE81137 := JOIN(__EE70773,__EE81127,__JC81136(LEFT,RIGHT),__JT81136(LEFT,RIGHT),LEFT OUTER,HASH);
  ...
  __ST76220_Layout __JT81156(__ST74977_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE81157 := JOIN(__EE81147,__EE69814,__JC81156(LEFT,RIGHT),__JT81156(LEFT,RIGHT),LEFT OUTER,HASH);
