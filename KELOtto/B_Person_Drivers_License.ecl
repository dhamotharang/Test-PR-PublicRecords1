...
EXPORT B_Person_Drivers_License := MODULE
  SHARED __EE720632 := E_Person_Drivers_License.__Result;
  SHARED __IDX_Person_Drivers_License_License__Filtered := __EE720632(__NN(__EE720632.License_));
  ...
  EXPORT __ST720634_Layout := RECORDOF(IDX_Person_Drivers_License_License_);
