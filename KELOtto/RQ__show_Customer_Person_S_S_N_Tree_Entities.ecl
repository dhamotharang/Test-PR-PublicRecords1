...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE801662 := B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped;
  SHARED __EE801665 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST713966_Layout := RECORD
  ...
  END;
  __JC801673(E_Person_S_S_N.Layout __EE801662, B_Person.__ST14816_Layout __EE801665) := __EEQP(__EE801662.Subject_,__EE801665.UID);
  __ST713966_Layout __JT801673(E_Person_S_S_N.Layout __l, B_Person.__ST14816_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE801674 := JOIN(__EE801662,__EE801665,__JC801673(LEFT,RIGHT),__JT801673(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE801903 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST714232_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC801911(__ST713966_Layout __EE801674, B_Social_Security_Number.__ST15119_Layout __EE801903) := __EEQP(__EE801674.Social_,__EE801903.UID);
  __ST714232_Layout __JT801911(__ST713966_Layout __l, B_Social_Security_Number.__ST15119_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE801912 := JOIN(__EE801903,__EE801674,__JC801911(RIGHT,LEFT),__JT801911(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST802999_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nunk Entity_Context_Uid__1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __EE803004 := PROJECT(TABLE(PROJECT(__EE801912,__ST802999_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_},_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_,MERGE),__ST802999_Layout);
  SHARED __EE802682 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST803014_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST803014_Layout __ND803007__Project(E_Customer.Layout __PP803006) := TRANSFORM
    SELF.U_I_D__2_ := __PP803006.UID;
    SELF.Customer_Id__2_ := __PP803006.Customer_Id_;
    SELF.Industry_Type__2_ := __PP803006.Industry_Type_;
    SELF := __PP803006;
  END;
  SHARED __EE803019 := PROJECT(__EE802682,__ND803007__Project(LEFT));
  SHARED __ST803037_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nunk Entity_Context_Uid__1_;
    KEL.typ.nuid U_I_D__2_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC803026(__ST802999_Layout __EE803004, __ST803014_Layout __EE803019) := __EEQP(__EE803004._r_Customer_,__EE803019.U_I_D__2_);
  __ST803037_Layout __JT803026(__ST802999_Layout __l, __ST803014_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE803035 := JOIN(__EE803004,__EE803019,__JC803026(LEFT,RIGHT),__JT803026(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST713877_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST713877_Layout __ND803048__Project(__ST803037_Layout __PP803036) := TRANSFORM
    SELF.Source_Customer_ := __PP803036._r_Customer_;
    SELF.Customer_Id_ := __PP803036.Customer_Id__2_;
    SELF.Industry_Type_ := __PP803036.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP803036.Entity_Context_Uid__1_;
    SELF := __PP803036;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE803035,__ND803048__Project(LEFT)));
END;
