...
IMPORT B_Customer,B_Customer_4,B_Person,B_Person_2,B_Person_S_S_N,B_Social_Security_Number,E_Customer,E_Person,E_Person_S_S_N,E_Social_Security_Number FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE2735407 := PROJECT(B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped,E_Person_S_S_N.Layout);
  SHARED __EE2735410 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2620435_Layout := RECORD
  ...
  END;
  __JC2735418(E_Person_S_S_N.Layout __EE2735407, B_Person.__ST39519_Layout __EE2735410) := __EEQP(__EE2735407.Subject_,__EE2735410.UID);
  __ST2620435_Layout __JT2735418(E_Person_S_S_N.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2735419 := JOIN(__EE2735407,__EE2735410,__JC2735418(LEFT,RIGHT),__JT2735418(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2735744 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST2620798_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2735752(__ST2620435_Layout __EE2735419, B_Social_Security_Number.__ST41891_Layout __EE2735744) := __EEQP(__EE2735419.Social_,__EE2735744.UID);
  __ST2620798_Layout __JT2735752(__ST2620435_Layout __l, B_Social_Security_Number.__ST41891_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2735753 := JOIN(__EE2735419,__EE2735744,__JC2735752(LEFT,RIGHT),__JT2735752(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2736954 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2621509_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2736968(__ST2620798_Layout __EE2735753, E_Customer.Layout __EE2736954) := __EEQP(__EE2735753._r_Customer_,__EE2736954.UID);
  __ST2621509_Layout __JT2736968(__ST2620798_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2737439 := JOIN(__EE2735753,__EE2736954,__JC2736968(LEFT,RIGHT),__JT2736968(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2620340_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2620340_Layout __ND2737901__Project(__ST2621509_Layout __PP2737440) := TRANSFORM
    SELF.Source_Customer_ := __PP2737440._r_Customer_;
    SELF.Customer_Id_ := __PP2737440.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2737440.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2737440.Entity_Context_Uid__1_;
    SELF := __PP2737440;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2737439,__ND2737901__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2620340_Layout));
END;
