...
EXPORT RQ__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  SHARED __EE810425 := B_Person_S_S_N.IDX_Person_S_S_N_Social__Wrapped;
  SHARED __EE810428 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST725956_Layout := RECORD
  ...
  END;
  __JC810436(E_Person_S_S_N.Layout __EE810425, B_Person.__ST14833_Layout __EE810428) := __EEQP(__EE810425.Subject_,__EE810428.UID);
  __ST725956_Layout __JT810436(E_Person_S_S_N.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE810437 := JOIN(__EE810425,__EE810428,__JC810436(LEFT,RIGHT),__JT810436(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE810666 := B_Social_Security_Number.IDX_Social_Security_Number_UID_Wrapped;
  SHARED __ST726222_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC810674(__ST725956_Layout __EE810437, B_Social_Security_Number.__ST15136_Layout __EE810666) := __EEQP(__EE810437.Social_,__EE810666.UID);
  __ST726222_Layout __JT810674(__ST725956_Layout __l, B_Social_Security_Number.__ST15136_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE810675 := JOIN(__EE810437,__EE810666,__JC810674(LEFT,RIGHT),__JT810674(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE811445 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST726667_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC811455(__ST726222_Layout __EE810675, E_Customer.Layout __EE811445) := __EEQP(__EE810675._r_Customer_,__EE811445.UID);
  __ST726667_Layout __JT811455(__ST726222_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE811767 := JOIN(__EE810675,__EE811445,__JC811455(LEFT,RIGHT),__JT811455(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST725867_Layout := RECORD
