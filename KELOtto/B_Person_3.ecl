...
EXPORT B_Person_3 := MODULE
  ...
  SHARED __EE21729 := __ENH_Person_4;
  EXPORT __ST3750_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST3750_Layout __ND21556__Project(B_Person_4.__ST4013_Layout __PP19745) := TRANSFORM
    __BS21542 := __T(__PP19745.Reported_Date_Of_Birth_);
    SELF.Deceased_Dob_Match_ := MAP(EXISTS(__BS21542(__T(__OP2(__PP19745.Deceased_Date_Of_Birth_,=,__T(__PP19745.Reported_Date_Of_Birth_).Date_Of_Birth_))))=>1,0);
    __BS21560 := __T(__PP19745.Full_Name_);
    SELF.Deceased_Name_Match_ := MAP(EXISTS(__BS21560(__T(__AND(__OP2(__T(__PP19745.Full_Name_).First_Name_,=,__PP19745.Deceased_First_),__OP2(__T(__PP19745.Full_Name_).Last_Name_,=,__PP19745.Deceased_Last_)))))=>1,0);
    SELF.High_Risk_Death_Prior_To_All_Events_ := MAP(__T(__AND(__CN(__PP19745.Death_Prior_To_All_Events_ = 1),__OP2(__PP19745.Max_Deceased_To_Event_Diff_,<,__CN(-4))))=>1,0);
    SELF := __PP19745;
  END;
  EXPORT __ENH_Person_3 := PROJECT(__EE21729,__ND21556__Project(LEFT));
END;
