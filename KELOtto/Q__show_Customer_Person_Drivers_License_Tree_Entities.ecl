...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE786077 := __E_Person_Drivers_License;
  SHARED __EE786125 := __ENH_Person;
  SHARED __ST786158_Layout := RECORD
  ...
  END;
  __JC786155(E_Person_Drivers_License.Layout __EE786077, B_Person.__ST18647_Layout __EE786125) := __EEQP(__EE786077.Subject_,__EE786125.UID);
  __ST786158_Layout __JT786155(E_Person_Drivers_License.Layout __l, B_Person.__ST18647_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE786156 := JOIN(__EE786077,__EE786125,__JC786155(LEFT,RIGHT),__JT786155(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE786114 := __ENH_Drivers_License;
  SHARED __ST786477_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC787316(__ST786158_Layout __EE786156, B_Drivers_License.__ST17756_Layout __EE786114) := __EEQP(__EE786156.License_,__EE786114.UID);
  __ST786477_Layout __JT787316(__ST786158_Layout __l, B_Drivers_License.__ST17756_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE787317 := JOIN(__EE786156,__EE786114,__JC787316(LEFT,RIGHT),__JT787316(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE786100 := __E_Customer;
  SHARED __ST786931_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC787318(__ST786477_Layout __EE787317, E_Customer.Layout __EE786100) := __EEQP(__EE787317._r_Customer_,__EE786100.UID);
  __ST786931_Layout __JT787318(__ST786477_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE787319 := JOIN(__EE787317,__EE786100,__JC787318(LEFT,RIGHT),__JT787318(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST17464_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17464_Layout __ND787308__Project(__ST786931_Layout __PP787307) := TRANSFORM
    SELF.Source_Customer_ := __PP787307._r_Customer_;
    SELF.Customer_Id_ := __PP787307.Customer_Id__2_;
    SELF.Industry_Type_ := __PP787307.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP787307.Entity_Context_Uid__1_;
    SELF := __PP787307;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE787319,__ND787308__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST17464_Layout));
END;
