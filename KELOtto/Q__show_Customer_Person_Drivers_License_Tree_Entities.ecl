...
IMPORT B_Drivers_License,B_Person,B_Person_1,B_Person_2,E_Address,E_Customer,E_Drivers_License,E_Person,E_Person_Drivers_License FROM KELOtto;
...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE3253564 := __E_Person_Drivers_License;
  SHARED __EE3253547 := __ENH_Person;
  SHARED __ST3253582_Layout := RECORD
  ...
  END;
  __JC3253579(E_Person_Drivers_License.Layout __EE3253564, B_Person.__ST45628_Layout __EE3253547) := __EEQP(__EE3253564.Subject_,__EE3253547.UID);
  __ST3253582_Layout __JT3253579(E_Person_Drivers_License.Layout __l, B_Person.__ST45628_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE3253580 := JOIN(__EE3253564,__EE3253547,__JC3253579(LEFT,RIGHT),__JT3253579(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3253535 := __ENH_Drivers_License;
  SHARED __ST3254031_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3255389(__ST3253582_Layout __EE3253580, B_Drivers_License.__ST36980_Layout __EE3253535) := __EEQP(__EE3253580.License_,__EE3253535.UID);
  __ST3254031_Layout __JT3255389(__ST3253582_Layout __l, B_Drivers_License.__ST36980_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3255390 := JOIN(__EE3253580,__EE3253535,__JC3255389(LEFT,RIGHT),__JT3255389(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE3253520 := __E_Customer;
  SHARED __ST3254805_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC3255391(__ST3254031_Layout __EE3255390, E_Customer.Layout __EE3253520) := __EEQP(__EE3255390._r_Customer_,__EE3253520.UID);
  __ST3254805_Layout __JT3255391(__ST3254031_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE3255392 := JOIN(__EE3255390,__EE3253520,__JC3255391(LEFT,RIGHT),__JT3255391(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST33040_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST33040_Layout __ND3255381__Project(__ST3254805_Layout __PP3255380) := TRANSFORM
    SELF.Source_Customer_ := __PP3255380._r_Customer_;
    SELF.Customer_Id_ := __PP3255380.Customer_Id__2_;
    SELF.Industry_Type_ := __PP3255380.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP3255380.Entity_Context_Uid__1_;
    SELF := __PP3255380;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE3255392,__ND3255381__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST33040_Layout));
END;
