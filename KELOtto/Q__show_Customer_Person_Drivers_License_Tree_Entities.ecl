...
EXPORT Q__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  ...
  SHARED __EE698940 := __E_Person_Drivers_License;
  SHARED __EE698988 := __ENH_Person;
  SHARED __ST699021_Layout := RECORD
  ...
  END;
  __JC699018(E_Person_Drivers_License.Layout __EE698940, B_Person.__ST14833_Layout __EE698988) := __EEQP(__EE698940.Subject_,__EE698988.UID);
  __ST699021_Layout __JT699018(E_Person_Drivers_License.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE699019 := JOIN(__EE698940,__EE698988,__JC699018(LEFT,RIGHT),__JT699018(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE698977 := __ENH_Drivers_License;
  SHARED __ST699287_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC700020(__ST699021_Layout __EE699019, B_Drivers_License.__ST14025_Layout __EE698977) := __EEQP(__EE699019.License_,__EE698977.UID);
  __ST699287_Layout __JT700020(__ST699021_Layout __l, B_Drivers_License.__ST14025_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE700021 := JOIN(__EE699019,__EE698977,__JC700020(LEFT,RIGHT),__JT700020(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE698963 := __E_Customer;
  SHARED __ST699688_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC700022(__ST699287_Layout __EE700021, E_Customer.Layout __EE698963) := __EEQP(__EE700021._r_Customer_,__EE698963.UID);
  __ST699688_Layout __JT700022(__ST699287_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE700023 := JOIN(__EE700021,__EE698963,__JC700022(LEFT,RIGHT),__JT700022(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST13737_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST13737_Layout __ND700012__Project(__ST699688_Layout __PP700011) := TRANSFORM
    SELF.Source_Customer_ := __PP700011._r_Customer_;
    SELF.Customer_Id_ := __PP700011.Customer_Id__2_;
    SELF.Industry_Type_ := __PP700011.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP700011.Entity_Context_Uid__1_;
    SELF := __PP700011;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE700023,__ND700012__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST13737_Layout));
END;
