...
IMPORT B_Address,B_Customer,B_Person,B_Person_2,B_Person_Event,E_Address,E_Customer,E_Event,E_Person,E_Person_Event FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE209197 := B_Person_Event.IDX_Person_Event_Location__Wrapped;
  SHARED __ST209956_Layout := RECORD
  ...
  END;
  SHARED __EE209961 := PROJECT(TABLE(PROJECT(__EE209197,__ST209956_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Subject_,Location_},_r_Customer_,Subject_,Location_,MERGE),__ST209956_Layout);
  SHARED __EE209200 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST210267_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE210440 := PROJECT(__EE209200,TRANSFORM(__ST210267_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST210626_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC210447(__ST209956_Layout __EE209961, __ST210267_Layout __EE210440) := __EEQP(__EE209961.Subject_,__EE210440.UID);
  __ST210626_Layout __JT210447(__ST209956_Layout __l, __ST210267_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE210624 := JOIN(__EE209961,__EE210440,__JC210447(LEFT,RIGHT),__JT210447(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE209387 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST183357_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC210806(__ST210626_Layout __EE210624, B_Address.__ST2423_Layout __EE209387) := __EEQP(__EE210624.Location_,__EE209387.UID);
  __ST183357_Layout __JT210806(__ST210626_Layout __l, B_Address.__ST2423_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE211073 := JOIN(__EE210624,__EE209387,__JC210806(LEFT,RIGHT),__JT210806(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE211329 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST183649_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC211342(__ST183357_Layout __EE211073, E_Customer.Layout __EE211329) := __EEQP(__EE211073._r_Customer_,__EE211329.UID);
  __ST183649_Layout __JT211342(__ST183357_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE211597 := JOIN(__EE211073,__EE211329,__JC211342(LEFT,RIGHT),__JT211342(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST183054_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST183054_Layout __ND211843__Project(__ST183649_Layout __PP211598) := TRANSFORM
    SELF.Source_Customer_ := __PP211598._r_Customer_;
    SELF.Customer_Id_ := __PP211598.Customer_Id__2_;
    SELF.Industry_Type_ := __PP211598.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP211598.Entity_Context_Uid_;
    SELF.Entity_Context_Uid_ := __PP211598.Entity_Context_Uid__1_;
    SELF := __PP211598;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE211597,__ND211843__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST183054_Layout));
END;
