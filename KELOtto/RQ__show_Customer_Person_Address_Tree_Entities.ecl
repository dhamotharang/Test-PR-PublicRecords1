...
EXPORT RQ__show_Customer_Person_Address_Tree_Entities := MODULE
  SHARED __EE807639 := B_Person_Address.IDX_Person_Address_Location__Wrapped;
  SHARED __EE807642 := B_Person.IDX_Person_UID_Wrapped;
  ...
  END;
  __JC807650(E_Person_Address.Layout __EE807639, B_Person.__ST14833_Layout __EE807642) := __EEQP(__EE807639.Subject_,__EE807642.UID);
  __ST724756_Layout __JT807650(E_Person_Address.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE807651 := JOIN(__EE807639,__EE807642,__JC807650(LEFT,RIGHT),__JT807650(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE807880 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST725022_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC807888(__ST724756_Layout __EE807651, B_Address.__ST13794_Layout __EE807880) := __EEQP(__EE807651.Location_,__EE807880.UID);
  __ST725022_Layout __JT807888(__ST724756_Layout __l, B_Address.__ST13794_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE807889 := JOIN(__EE807651,__EE807880,__JC807888(LEFT,RIGHT),__JT807888(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE808711 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST725483_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC808721(__ST725022_Layout __EE807889, E_Customer.Layout __EE808711) := __EEQP(__EE807889._r_Customer_,__EE808711.UID);
  __ST725483_Layout __JT808721(__ST725022_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE809069 := JOIN(__EE807889,__EE808711,__JC808721(LEFT,RIGHT),__JT808721(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST724667_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST724667_Layout __ND809408__Project(__ST725483_Layout __PP809070) := TRANSFORM
    SELF.Source_Customer_ := __PP809070._r_Customer_;
    SELF.Customer_Id_ := __PP809070.Customer_Id__2_;
    SELF.Industry_Type_ := __PP809070.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP809070.Entity_Context_Uid__1_;
    SELF := __PP809070;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE809069,__ND809408__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST724667_Layout));
END;
