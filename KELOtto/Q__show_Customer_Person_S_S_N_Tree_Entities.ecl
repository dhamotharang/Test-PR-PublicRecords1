...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE774033 := __E_Person_S_S_N;
  SHARED __EE774081 := __ENH_Person;
  SHARED __ST774114_Layout := RECORD
  ...
  END;
  __JC774111(E_Person_S_S_N.Layout __EE774033, B_Person.__ST18775_Layout __EE774081) := __EEQP(__EE774033.Subject_,__EE774081.UID);
  __ST774114_Layout __JT774111(E_Person_S_S_N.Layout __l, B_Person.__ST18775_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE774112 := JOIN(__EE774033,__EE774081,__JC774111(LEFT,RIGHT),__JT774111(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE774070 := __ENH_Social_Security_Number;
  SHARED __ST774435_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC775334(__ST774114_Layout __EE774112, B_Social_Security_Number.__ST19136_Layout __EE774070) := __EEQP(__EE774112.Social_,__EE774070.UID);
  __ST774435_Layout __JT775334(__ST774114_Layout __l, B_Social_Security_Number.__ST19136_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE775335 := JOIN(__EE774112,__EE774070,__JC775334(LEFT,RIGHT),__JT775334(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE774056 := __E_Customer;
  SHARED __ST774937_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC775336(__ST774435_Layout __EE775335, E_Customer.Layout __EE774056) := __EEQP(__EE775335._r_Customer_,__EE774056.UID);
  __ST774937_Layout __JT775336(__ST774435_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE775337 := JOIN(__EE775335,__EE774056,__JC775336(LEFT,RIGHT),__JT775336(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST17490_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17490_Layout __ND775326__Project(__ST774937_Layout __PP775325) := TRANSFORM
    SELF.Source_Customer_ := __PP775325._r_Customer_;
    SELF.Customer_Id_ := __PP775325.Customer_Id__2_;
    SELF.Industry_Type_ := __PP775325.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP775325.Entity_Context_Uid__1_;
    SELF := __PP775325;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE775337,__ND775326__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST17490_Layout));
END;
