...
EXPORT Q__show_Customer_Person_S_S_N_Tree_Entities := MODULE
  ...
  SHARED __EE2559681 := __E_Person_S_S_N;
  SHARED __EE2559664 := __ENH_Person;
  SHARED __ST2559699_Layout := RECORD
  ...
  END;
  __JC2559696(E_Person_S_S_N.Layout __EE2559681, B_Person.__ST39519_Layout __EE2559664) := __EEQP(__EE2559681.Subject_,__EE2559664.UID);
  __ST2559699_Layout __JT2559696(E_Person_S_S_N.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2559697 := JOIN(__EE2559681,__EE2559664,__JC2559696(LEFT,RIGHT),__JT2559696(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2559652 := __ENH_Social_Security_Number;
  SHARED __ST2560062_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2561274(__ST2559699_Layout __EE2559697, B_Social_Security_Number.__ST41891_Layout __EE2559652) := __EEQP(__EE2559697.Social_,__EE2559652.UID);
  __ST2560062_Layout __JT2561274(__ST2559699_Layout __l, B_Social_Security_Number.__ST41891_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2561275 := JOIN(__EE2559697,__EE2559652,__JC2561274(LEFT,RIGHT),__JT2561274(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2559637 := __E_Customer;
  SHARED __ST2560773_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Social_Security_Number.Typ) Social_;
    KEL.typ.ndataset(E_Person_S_S_N.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2561276(__ST2560062_Layout __EE2561275, E_Customer.Layout __EE2559637) := __EEQP(__EE2561275._r_Customer_,__EE2559637.UID);
  __ST2560773_Layout __JT2561276(__ST2560062_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2561277 := JOIN(__EE2561275,__EE2559637,__JC2561276(LEFT,RIGHT),__JT2561276(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST28501_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST28501_Layout __ND2561266__Project(__ST2560773_Layout __PP2561265) := TRANSFORM
    SELF.Source_Customer_ := __PP2561265._r_Customer_;
    SELF.Customer_Id_ := __PP2561265.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2561265.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2561265.Entity_Context_Uid__1_;
    SELF := __PP2561265;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2561277,__ND2561266__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST28501_Layout));
END;
