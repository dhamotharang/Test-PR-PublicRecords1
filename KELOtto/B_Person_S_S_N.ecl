...
EXPORT B_Person_S_S_N := MODULE
  SHARED __EE502595 := E_Person_S_S_N.__Result;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE502595(__NN(__EE502595.Social_));
  ...
  EXPORT __ST502597_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
