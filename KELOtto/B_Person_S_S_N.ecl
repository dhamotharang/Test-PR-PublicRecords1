...
EXPORT B_Person_S_S_N := MODULE
  SHARED __EE831646 := E_Person_S_S_N.__Result;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE831646(__NN(__EE831646.Social_));
  ...
  EXPORT __ST831648_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
