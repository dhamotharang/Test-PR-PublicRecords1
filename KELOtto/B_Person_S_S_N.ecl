...
EXPORT B_Person_S_S_N := MODULE
  SHARED __EE831283 := E_Person_S_S_N.__Result;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE831283(__NN(__EE831283.Social_));
  ...
  EXPORT __ST831285_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
