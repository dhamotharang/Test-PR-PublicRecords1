...
IMPORT E_Person,E_Person_S_S_N,E_Social_Security_Number FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT B_Person_S_S_N := MODULE
  SHARED __EE627582 := E_Person_S_S_N.__Result;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE627582(__NN(__EE627582.Social_));
  ...
  EXPORT __ST627584_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
