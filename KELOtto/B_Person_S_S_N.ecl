...
EXPORT B_Person_S_S_N := MODULE
  SHARED __EE828582 := E_Person_S_S_N.__Result;
  SHARED __IDX_Person_S_S_N_Social__Filtered := __EE828582(__NN(__EE828582.Social_));
  ...
  EXPORT __ST828584_Layout := RECORDOF(IDX_Person_S_S_N_Social_);
