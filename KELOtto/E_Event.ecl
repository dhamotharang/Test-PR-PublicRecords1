...
EXPORT E_Event := MODULE
  ...
  EXPORT KELOtto_PersonEventTypes_Invalid := __d1__r_Drivers_License__Mapped(UID = 0);
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'Event','KELOtto.fraudgovshared','rPhone',COUNT(__d0(__NL(_r_Phone_))),COUNT(__d0(__NN(_r_Phone_)))},
    {'Event','KELOtto.fraudgovshared','rEmail',COUNT(__d0(__NL(_r_Email_))),COUNT(__d0(__NN(_r_Email_)))},
    {'Event','KELOtto.fraudgovshared','rInternetProtocol',COUNT(__d0(__NL(_r_Internet_Protocol_))),COUNT(__d0(__NN(_r_Internet_Protocol_)))},
    {'Event','KELOtto.fraudgovshared','rBankAccount',COUNT(__d0(__NL(_r_Bank_Account_))),COUNT(__d0(__NN(_r_Bank_Account_)))},
    {'Event','KELOtto.fraudgovshared','rDriversLicense',COUNT(__d0(__NL(_r_Drivers_License_))),COUNT(__d0(__NN(_r_Drivers_License_)))},
    {'Event','KELOtto.fraudgovshared','clean_phones.phone_number',COUNT(__d0(__NL(Phone_Number_))),COUNT(__d0(__NN(Phone_Number_)))},
    {'Event','KELOtto.fraudgovshared','OttoAddressId',COUNT(__d0(__NL(Otto_Address_Id_))),COUNT(__d0(__NN(Otto_Address_Id_)))},
    {'Event','KELOtto.fraudgovshared','OttoEmailId',COUNT(__d0(__NL(Otto_Email_Id_))),COUNT(__d0(__NN(Otto_Email_Id_)))},
    {'Event','KELOtto.fraudgovshared','OttoIpAddressId',COUNT(__d0(__NL(Otto_Ip_Address_Id_))),COUNT(__d0(__NN(Otto_Ip_Address_Id_)))},
    {'Event','KELOtto.fraudgovshared','OttoDriversLicenseId',COUNT(__d0(__NL(Otto_Drivers_License_Id_))),COUNT(__d0(__NN(Otto_Drivers_License_Id_)))},
    ...
    {'Event','KELOtto.fraudgovshared','advo_hitflag',COUNT(__d0(__NL(_advo__hitflag_))),COUNT(__d0(__NN(_advo__hitflag_)))},
    {'Event','KELOtto.fraudgovshared','advo_vacancyindicator',COUNT(__d0(__NL(_advo__vacancyindicator_))),COUNT(__d0(__NN(_advo__vacancyindicator_)))},
    {'Event','KELOtto.fraudgovshared','advo_addressstyle',COUNT(__d0(__NL(_advo__addressstyle_))),COUNT(__d0(__NN(_advo__addressstyle_)))},
    {'Event','KELOtto.fraudgovshared','advo_dropindicator',COUNT(__d0(__NL(_advo__dropindicator_))),COUNT(__d0(__NN(_advo__dropindicator_)))},
    {'Event','KELOtto.fraudgovshared','advo_residentialorbusinessindicator',COUNT(__d0(__NL(_advo__residentialorbusinessindicator_))),COUNT(__d0(__NN(_advo__residentialorbusinessindicator_)))},
    {'Event','KELOtto.fraudgovshared','advo_addresstype',COUNT(__d0(__NL(_advo__addresstype_))),COUNT(__d0(__NN(_advo__addresstype_)))},
    {'Event','KELOtto.fraudgovshared','advo_addressusagetype',COUNT(__d0(__NL(_advo__addressusagetype_))),COUNT(__d0(__NN(_advo__addressusagetype_)))},
    {'Event','KELOtto.fraudgovshared','ACECleanerErrorCode',COUNT(__d0(__NL(A_C_E_Cleaner_Error_Code_))),COUNT(__d0(__NN(A_C_E_Cleaner_Error_Code_)))},
    ...
    {'Event','KELOtto.PersonEventTypes','rPhone',COUNT(__d1(__NL(_r_Phone_))),COUNT(__d1(__NN(_r_Phone_)))},
    {'Event','KELOtto.PersonEventTypes','rEmail',COUNT(__d1(__NL(_r_Email_))),COUNT(__d1(__NN(_r_Email_)))},
    {'Event','KELOtto.PersonEventTypes','rInternetProtocol',COUNT(__d1(__NL(_r_Internet_Protocol_))),COUNT(__d1(__NN(_r_Internet_Protocol_)))},
    {'Event','KELOtto.PersonEventTypes','rBankAccount',COUNT(__d1(__NL(_r_Bank_Account_))),COUNT(__d1(__NN(_r_Bank_Account_)))},
    {'Event','KELOtto.PersonEventTypes','rDriversLicense',COUNT(__d1(__NL(_r_Drivers_License_))),COUNT(__d1(__NN(_r_Drivers_License_)))},
    {'Event','KELOtto.PersonEventTypes','PhoneNumber',COUNT(__d1(__NL(Phone_Number_))),COUNT(__d1(__NN(Phone_Number_)))},
    {'Event','KELOtto.PersonEventTypes','OttoAddressId',COUNT(__d1(__NL(Otto_Address_Id_))),COUNT(__d1(__NN(Otto_Address_Id_)))},
    {'Event','KELOtto.PersonEventTypes','OttoEmailId',COUNT(__d1(__NL(Otto_Email_Id_))),COUNT(__d1(__NN(Otto_Email_Id_)))},
    {'Event','KELOtto.PersonEventTypes','OttoIpAddressId',COUNT(__d1(__NL(Otto_Ip_Address_Id_))),COUNT(__d1(__NN(Otto_Ip_Address_Id_)))},
    {'Event','KELOtto.PersonEventTypes','OttoDriversLicenseId',COUNT(__d1(__NL(Otto_Drivers_License_Id_))),COUNT(__d1(__NN(Otto_Drivers_License_Id_)))},
    ...
    {'Event','KELOtto.PersonEventTypes','advo_hitflag',COUNT(__d1(__NL(_advo__hitflag_))),COUNT(__d1(__NN(_advo__hitflag_)))},
    {'Event','KELOtto.PersonEventTypes','advo_vacancyindicator',COUNT(__d1(__NL(_advo__vacancyindicator_))),COUNT(__d1(__NN(_advo__vacancyindicator_)))},
    {'Event','KELOtto.PersonEventTypes','advo_addressstyle',COUNT(__d1(__NL(_advo__addressstyle_))),COUNT(__d1(__NN(_advo__addressstyle_)))},
    {'Event','KELOtto.PersonEventTypes','advo_dropindicator',COUNT(__d1(__NL(_advo__dropindicator_))),COUNT(__d1(__NN(_advo__dropindicator_)))},
    {'Event','KELOtto.PersonEventTypes','advo_residentialorbusinessindicator',COUNT(__d1(__NL(_advo__residentialorbusinessindicator_))),COUNT(__d1(__NN(_advo__residentialorbusinessindicator_)))},
    {'Event','KELOtto.PersonEventTypes','advo_addresstype',COUNT(__d1(__NL(_advo__addresstype_))),COUNT(__d1(__NN(_advo__addresstype_)))},
    {'Event','KELOtto.PersonEventTypes','advo_addressusagetype',COUNT(__d1(__NL(_advo__addressusagetype_))),COUNT(__d1(__NN(_advo__addressusagetype_)))},
    {'Event','KELOtto.PersonEventTypes','ACECleanerErrorCode',COUNT(__d1(__NL(A_C_E_Cleaner_Error_Code_))),COUNT(__d1(__NN(A_C_E_Cleaner_Error_Code_)))},
