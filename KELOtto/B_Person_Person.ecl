...
EXPORT B_Person_Person := MODULE
  SHARED __EE343088 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE343088(__NN(__EE343088.From_Person_));
  ...
  EXPORT __ST343090_Layout := RECORDOF(IDX_Person_Person_From_Person_);
