...
EXPORT B_Person_Person := MODULE
  SHARED __EE733726 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE733726(__NN(__EE733726.From_Person_));
  ...
  EXPORT __ST733728_Layout := RECORDOF(IDX_Person_Person_From_Person_);
