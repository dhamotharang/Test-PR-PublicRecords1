...
EXPORT B_Person_Person := MODULE
  SHARED __EE3311301 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE3311301(__NN(__EE3311301.From_Person_));
  ...
  EXPORT __ST3311303_Layout := RECORDOF(IDX_Person_Person_From_Person_);
