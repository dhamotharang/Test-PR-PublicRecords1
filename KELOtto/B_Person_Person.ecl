...
EXPORT B_Person_Person := MODULE
  SHARED __EE3177255 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE3177255(__NN(__EE3177255.From_Person_));
  ...
  EXPORT __ST3177257_Layout := RECORDOF(IDX_Person_Person_From_Person_);
