...
EXPORT B_Person_Person := MODULE
  SHARED __EE831823 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE831823(__NN(__EE831823.From_Person_));
  ...
  EXPORT __ST831825_Layout := RECORDOF(IDX_Person_Person_From_Person_);
