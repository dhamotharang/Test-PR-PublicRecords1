...
EXPORT B_Person_Person := MODULE
  SHARED __EE184004 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE184004(__NN(__EE184004.From_Person_));
  ...
  EXPORT __ST184006_Layout := RECORDOF(IDX_Person_Person_From_Person_);
