...
EXPORT B_Person_Person := MODULE
  SHARED __EE831276 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE831276(__NN(__EE831276.From_Person_));
  ...
  EXPORT __ST831278_Layout := RECORDOF(IDX_Person_Person_From_Person_);
