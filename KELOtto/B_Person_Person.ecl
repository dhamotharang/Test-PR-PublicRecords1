...
EXPORT B_Person_Person := MODULE
  SHARED __EE502142 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE502142(__NN(__EE502142.From_Person_));
  ...
  EXPORT __ST502144_Layout := RECORDOF(IDX_Person_Person_From_Person_);
