...
EXPORT B_Person_Person := MODULE
  SHARED __EE829232 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE829232(__NN(__EE829232.From_Person_));
  ...
  EXPORT __ST829234_Layout := RECORDOF(IDX_Person_Person_From_Person_);
