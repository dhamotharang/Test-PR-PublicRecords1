...
EXPORT B_Person_Person := MODULE
  SHARED __EE505132 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE505132(__NN(__EE505132.From_Person_));
  ...
  EXPORT __ST505134_Layout := RECORDOF(IDX_Person_Person_From_Person_);
