...
EXPORT B_Person_Person := MODULE
  SHARED __EE834882 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE834882(__NN(__EE834882.From_Person_));
  ...
  EXPORT __ST834884_Layout := RECORDOF(IDX_Person_Person_From_Person_);
