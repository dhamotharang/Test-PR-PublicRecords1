...
EXPORT B_Person_Person := MODULE
  SHARED __EE720640 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE720640(__NN(__EE720640.From_Person_));
  ...
  EXPORT __ST720642_Layout := RECORDOF(IDX_Person_Person_From_Person_);
