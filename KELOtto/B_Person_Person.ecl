...
EXPORT B_Person_Person := MODULE
  SHARED __EE527006 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE527006(__NN(__EE527006.From_Person_));
  ...
  EXPORT __ST527008_Layout := RECORDOF(IDX_Person_Person_From_Person_);
