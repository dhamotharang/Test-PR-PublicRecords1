...
EXPORT B_Person_Person := MODULE
  SHARED __EE824416 := E_Person_Person.__Result;
  SHARED __IDX_Person_Person_From_Person__Filtered := __EE824416(__NN(__EE824416.From_Person_));
  ...
  EXPORT __ST824418_Layout := RECORDOF(IDX_Person_Person_From_Person_);
