...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE815997 := B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped;
  SHARED __EE816000 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST728366_Layout := RECORD
  ...
  END;
  __JC816008(E_Person_Phone.Layout __EE815997, B_Person.__ST14833_Layout __EE816000) := __EEQP(__EE815997.Subject_,__EE816000.UID);
  __ST728366_Layout __JT816008(E_Person_Phone.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE816009 := JOIN(__EE815997,__EE816000,__JC816008(LEFT,RIGHT),__JT816008(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE816238 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST728632_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC816246(__ST728366_Layout __EE816009, B_Phone.__ST15061_Layout __EE816238) := __EEQP(__EE816009.Phone_Number_,__EE816238.UID);
  __ST728632_Layout __JT816246(__ST728366_Layout __l, B_Phone.__ST15061_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE816247 := JOIN(__EE816009,__EE816238,__JC816246(LEFT,RIGHT),__JT816246(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE816963 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST729037_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC816973(__ST728632_Layout __EE816247, E_Customer.Layout __EE816963) := __EEQP(__EE816247._r_Customer_,__EE816963.UID);
  __ST729037_Layout __JT816973(__ST728632_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE817271 := JOIN(__EE816247,__EE816963,__JC816973(LEFT,RIGHT),__JT816973(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST728277_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST728277_Layout __ND817560__Project(__ST729037_Layout __PP817272) := TRANSFORM
    SELF.Source_Customer_ := __PP817272._r_Customer_;
    SELF.Customer_Id_ := __PP817272.Customer_Id__2_;
    SELF.Industry_Type_ := __PP817272.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP817272.Entity_Context_Uid__1_;
    SELF := __PP817272;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE817271,__ND817560__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST728277_Layout));
END;
