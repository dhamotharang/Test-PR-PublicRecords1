...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE806692 := B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped;
  SHARED __EE806695 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST716374_Layout := RECORD
  ...
  END;
  __JC806703(E_Person_Phone.Layout __EE806692, B_Person.__ST14816_Layout __EE806695) := __EEQP(__EE806692.Subject_,__EE806695.UID);
  __ST716374_Layout __JT806703(E_Person_Phone.Layout __l, B_Person.__ST14816_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE806704 := JOIN(__EE806692,__EE806695,__JC806703(LEFT,RIGHT),__JT806703(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE806933 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST716640_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC806941(__ST716374_Layout __EE806704, B_Phone.__ST15044_Layout __EE806933) := __EEQP(__EE806704.Phone_Number_,__EE806933.UID);
  __ST716640_Layout __JT806941(__ST716374_Layout __l, B_Phone.__ST15044_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE806942 := JOIN(__EE806933,__EE806704,__JC806941(RIGHT,LEFT),__JT806941(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST807961_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nstr Entity_Context_Uid__1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __EE807966 := PROJECT(TABLE(PROJECT(__EE806942,__ST807961_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_},_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_,MERGE),__ST807961_Layout);
  SHARED __EE807658 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST807976_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST807976_Layout __ND807969__Project(E_Customer.Layout __PP807968) := TRANSFORM
    SELF.U_I_D__2_ := __PP807968.UID;
    SELF.Customer_Id__2_ := __PP807968.Customer_Id_;
    SELF.Industry_Type__2_ := __PP807968.Industry_Type_;
    SELF := __PP807968;
  END;
  SHARED __EE807981 := PROJECT(__EE807658,__ND807969__Project(LEFT));
  SHARED __ST807999_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nstr Entity_Context_Uid__1_;
    KEL.typ.nuid U_I_D__2_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC807988(__ST807961_Layout __EE807966, __ST807976_Layout __EE807981) := __EEQP(__EE807966._r_Customer_,__EE807981.U_I_D__2_);
  __ST807999_Layout __JT807988(__ST807961_Layout __l, __ST807976_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE807997 := JOIN(__EE807966,__EE807981,__JC807988(LEFT,RIGHT),__JT807988(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST716285_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST716285_Layout __ND808010__Project(__ST807999_Layout __PP807998) := TRANSFORM
    SELF.Source_Customer_ := __PP807998._r_Customer_;
    SELF.Customer_Id_ := __PP807998.Customer_Id__2_;
    SELF.Industry_Type_ := __PP807998.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP807998.Entity_Context_Uid__1_;
    SELF := __PP807998;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE807997,__ND808010__Project(LEFT)));
END;
