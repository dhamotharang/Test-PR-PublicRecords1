...
IMPORT B_Customer,B_Customer_4,B_Person,B_Person_2,B_Person_Phone,B_Phone,E_Customer,E_Person,E_Person_Phone,E_Phone FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE2743705 := PROJECT(B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped,E_Person_Phone.Layout);
  SHARED __EE2743708 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2623877_Layout := RECORD
  ...
  END;
  __JC2743716(E_Person_Phone.Layout __EE2743705, B_Person.__ST39519_Layout __EE2743708) := __EEQP(__EE2743705.Subject_,__EE2743708.UID);
  __ST2623877_Layout __JT2743716(E_Person_Phone.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2743717 := JOIN(__EE2743705,__EE2743708,__JC2743716(LEFT,RIGHT),__JT2743716(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2744042 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST2624240_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2744050(__ST2623877_Layout __EE2743717, B_Phone.__ST40876_Layout __EE2744042) := __EEQP(__EE2743717.Phone_Number_,__EE2744042.UID);
  __ST2624240_Layout __JT2744050(__ST2623877_Layout __l, B_Phone.__ST40876_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2744051 := JOIN(__EE2743717,__EE2744042,__JC2744050(LEFT,RIGHT),__JT2744050(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2745200 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2624912_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2745214(__ST2624240_Layout __EE2744051, E_Customer.Layout __EE2745200) := __EEQP(__EE2744051._r_Customer_,__EE2745200.UID);
  __ST2624912_Layout __JT2745214(__ST2624240_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2745672 := JOIN(__EE2744051,__EE2745200,__JC2745214(LEFT,RIGHT),__JT2745214(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2623782_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2623782_Layout __ND2746121__Project(__ST2624912_Layout __PP2745673) := TRANSFORM
    SELF.Source_Customer_ := __PP2745673._r_Customer_;
    SELF.Customer_Id_ := __PP2745673.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2745673.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2745673.Entity_Context_Uid__1_;
    SELF := __PP2745673;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2745672,__ND2746121__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2623782_Layout));
END;
