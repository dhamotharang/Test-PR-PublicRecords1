...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE561627 := B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped;
  SHARED __EE561630 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST485181_Layout := RECORD
  ...
  END;
  __JC561638(E_Person_Phone.Layout __EE561627, B_Person.__ST11169_Layout __EE561630) := __EEQP(__EE561627.Subject_,__EE561630.UID);
  __ST485181_Layout __JT561638(E_Person_Phone.Layout __l, B_Person.__ST11169_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE561639 := JOIN(__EE561627,__EE561630,__JC561638(LEFT,RIGHT),__JT561638(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE561838 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST485417_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC561846(__ST485181_Layout __EE561639, B_Phone.__ST11368_Layout __EE561838) := __EEQP(__EE561639.Phone_Number_,__EE561838.UID);
  __ST485417_Layout __JT561846(__ST485181_Layout __l, B_Phone.__ST11368_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE561847 := JOIN(__EE561838,__EE561639,__JC561846(RIGHT,LEFT),__JT561846(RIGHT,LEFT),RIGHT OUTER,HASH);
  SHARED __ST562772_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nstr Entity_Context_Uid__1_;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __EE562777 := PROJECT(TABLE(PROJECT(__EE561847,__ST562772_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_},_r_Customer_,Entity_Context_Uid_,Entity_Context_Uid__1_,MERGE),__ST562772_Layout);
  SHARED __EE562499 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST562787_Layout := RECORD
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __ST562787_Layout __ND562780__Project(E_Customer.Layout __PP562779) := TRANSFORM
    SELF.U_I_D__2_ := __PP562779.UID;
    SELF.Customer_Id__2_ := __PP562779.Customer_Id_;
    SELF.Industry_Type__2_ := __PP562779.Industry_Type_;
    SELF := __PP562779;
  END;
  SHARED __EE562792 := PROJECT(__EE562499,__ND562780__Project(LEFT));
  SHARED __ST562810_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.nunk Entity_Context_Uid_;
    KEL.typ.nstr Entity_Context_Uid__1_;
    KEL.typ.nuid U_I_D__2_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC562799(__ST562772_Layout __EE562777, __ST562787_Layout __EE562792) := __EEQP(__EE562777._r_Customer_,__EE562792.U_I_D__2_);
  __ST562810_Layout __JT562799(__ST562772_Layout __l, __ST562787_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE562808 := JOIN(__EE562777,__EE562792,__JC562799(LEFT,RIGHT),__JT562799(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST485092_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST485092_Layout __ND562821__Project(__ST562810_Layout __PP562809) := TRANSFORM
    SELF.Source_Customer_ := __PP562809._r_Customer_;
    SELF.Customer_Id_ := __PP562809.Customer_Id__2_;
    SELF.Industry_Type_ := __PP562809.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP562809.Entity_Context_Uid__1_;
    SELF := __PP562809;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE562808,__ND562821__Project(LEFT)));
END;
