...
EXPORT RQ__show_Customer_Person_Phone_Tree_Entities := MODULE
  SHARED __EE928060 := B_Person_Phone.IDX_Person_Phone_Phone_Number__Wrapped;
  SHARED __EE928063 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST826292_Layout := RECORD
  ...
  END;
  __JC928071(E_Person_Phone.Layout __EE928060, B_Person.__ST18764_Layout __EE928063) := __EEQP(__EE928060.Subject_,__EE928063.UID);
  __ST826292_Layout __JT928071(E_Person_Phone.Layout __l, B_Person.__ST18764_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE928072 := JOIN(__EE928060,__EE928063,__JC928071(LEFT,RIGHT),__JT928071(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE928359 := B_Phone.IDX_Phone_UID_Wrapped;
  SHARED __ST826616_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC928367(__ST826292_Layout __EE928072, B_Phone.__ST19049_Layout __EE928359) := __EEQP(__EE928072.Phone_Number_,__EE928359.UID);
  __ST826616_Layout __JT928367(__ST826292_Layout __l, B_Phone.__ST19049_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE928368 := JOIN(__EE928072,__EE928359,__JC928367(LEFT,RIGHT),__JT928367(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE929206 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST827082_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC929216(__ST826616_Layout __EE928368, E_Customer.Layout __EE929206) := __EEQP(__EE928368._r_Customer_,__EE929206.UID);
  __ST827082_Layout __JT929216(__ST826616_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE929575 := JOIN(__EE928368,__EE929206,__JC929216(LEFT,RIGHT),__JT929216(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST826203_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST826203_Layout __ND929925__Project(__ST827082_Layout __PP929576) := TRANSFORM
    SELF.Source_Customer_ := __PP929576._r_Customer_;
    SELF.Customer_Id_ := __PP929576.Customer_Id__2_;
    SELF.Industry_Type_ := __PP929576.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP929576.Entity_Context_Uid__1_;
    SELF := __PP929576;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE929575,__ND929925__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST826203_Layout));
END;
