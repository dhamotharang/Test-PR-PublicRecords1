...
IMPORT B_Customer,B_Customer_4,B_Email,B_Person,B_Person_2,B_Person_Email,E_Customer,E_Email,E_Person,E_Person_Email FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Email_Tree_Entities := MODULE
  SHARED __EE2747583 := PROJECT(B_Person_Email.IDX_Person_Email_Emailof__Wrapped,E_Person_Email.Layout);
  SHARED __EE2747586 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2625504_Layout := RECORD
  ...
  END;
  __JC2747594(E_Person_Email.Layout __EE2747583, B_Person.__ST39519_Layout __EE2747586) := __EEQP(__EE2747583.Subject_,__EE2747586.UID);
  __ST2625504_Layout __JT2747594(E_Person_Email.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2747595 := JOIN(__EE2747583,__EE2747586,__JC2747594(LEFT,RIGHT),__JT2747594(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2747920 := B_Email.IDX_Email_UID_Wrapped;
  SHARED __ST2625867_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2747928(__ST2625504_Layout __EE2747595, B_Email.__ST33168_Layout __EE2747920) := __EEQP(__EE2747595.Emailof_,__EE2747920.UID);
  __ST2625867_Layout __JT2747928(__ST2625504_Layout __l, B_Email.__ST33168_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2747929 := JOIN(__EE2747595,__EE2747920,__JC2747928(LEFT,RIGHT),__JT2747928(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2749074 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2626531_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2749088(__ST2625867_Layout __EE2747929, E_Customer.Layout __EE2749074) := __EEQP(__EE2747929._r_Customer_,__EE2749074.UID);
  __ST2626531_Layout __JT2749088(__ST2625867_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2749551 := JOIN(__EE2747929,__EE2749074,__JC2749088(LEFT,RIGHT),__JT2749088(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2625409_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2625409_Layout __ND2750005__Project(__ST2626531_Layout __PP2749552) := TRANSFORM
    SELF.Source_Customer_ := __PP2749552._r_Customer_;
    SELF.Customer_Id_ := __PP2749552.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2749552.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2749552.Entity_Context_Uid__1_;
    SELF := __PP2749552;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2749551,__ND2750005__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2625409_Layout));
END;
