...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE2726967 := PROJECT(B_Person_Address.IDX_Person_Address_Location__Wrapped,E_Person_Address.Layout);
  SHARED __EE2726970 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2616949_Layout := RECORD
  ...
  END;
  __JC2726978(E_Person_Address.Layout __EE2726967, B_Person.__ST39519_Layout __EE2726970) := __EEQP(__EE2726967.Subject_,__EE2726970.UID);
  __ST2616949_Layout __JT2726978(E_Person_Address.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2726979 := JOIN(__EE2726967,__EE2726970,__JC2726978(LEFT,RIGHT),__JT2726978(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2727304 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST2617312_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2727312(__ST2616949_Layout __EE2726979, B_Address.__ST29865_Layout __EE2727304) := __EEQP(__EE2726979.Location_,__EE2727304.UID);
  __ST2617312_Layout __JT2727312(__ST2616949_Layout __l, B_Address.__ST29865_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2727313 := JOIN(__EE2726979,__EE2727304,__JC2727312(LEFT,RIGHT),__JT2727312(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2728578 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2618045_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2728592(__ST2617312_Layout __EE2727313, E_Customer.Layout __EE2728578) := __EEQP(__EE2727313._r_Customer_,__EE2728578.UID);
  __ST2618045_Layout __JT2728592(__ST2617312_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2729105 := JOIN(__EE2727313,__EE2728578,__JC2728592(LEFT,RIGHT),__JT2728592(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2616854_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2616854_Layout __ND2729609__Project(__ST2618045_Layout __PP2729106) := TRANSFORM
    SELF.Source_Customer_ := __PP2729106._r_Customer_;
    SELF.Customer_Id_ := __PP2729106.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2729106.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2729106.Entity_Context_Uid__1_;
    SELF := __PP2729106;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2729105,__ND2729609__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2616854_Layout));
END;
