...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE804853 := B_Person_Address.IDX_Person_Address_Location__Wrapped;
  SHARED __EE804856 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST723556_Layout := RECORD
  ...
  END;
  __JC804864(E_Person_Address.Layout __EE804853, B_Person.__ST14833_Layout __EE804856) := __EEQP(__EE804853.Subject_,__EE804856.UID);
  __ST723556_Layout __JT804864(E_Person_Address.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE804865 := JOIN(__EE804853,__EE804856,__JC804864(LEFT,RIGHT),__JT804864(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE805094 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST723822_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC805102(__ST723556_Layout __EE804865, B_Address.__ST13794_Layout __EE805094) := __EEQP(__EE804865.Location_,__EE805094.UID);
  __ST723822_Layout __JT805102(__ST723556_Layout __l, B_Address.__ST13794_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE805103 := JOIN(__EE804865,__EE805094,__JC805102(LEFT,RIGHT),__JT805102(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE805925 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST724283_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC805935(__ST723822_Layout __EE805103, E_Customer.Layout __EE805925) := __EEQP(__EE805103._r_Customer_,__EE805925.UID);
  __ST724283_Layout __JT805935(__ST723822_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE806283 := JOIN(__EE805103,__EE805925,__JC805935(LEFT,RIGHT),__JT805935(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST723467_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST723467_Layout __ND806622__Project(__ST724283_Layout __PP806284) := TRANSFORM
    SELF.Source_Customer_ := __PP806284._r_Customer_;
    SELF.Customer_Id_ := __PP806284.Customer_Id__2_;
    SELF.Industry_Type_ := __PP806284.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP806284.Entity_Context_Uid__1_;
    SELF := __PP806284;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE806283,__ND806622__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST723467_Layout));
END;
