...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE205679 := B_Person_Event.IDX_Person_Event_Location__Wrapped;
  SHARED __ST206438_Layout := RECORD
  ...
  END;
  SHARED __EE206443 := PROJECT(TABLE(PROJECT(__EE205679,__ST206438_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,Subject_,Location_},_r_Customer_,Subject_,Location_,MERGE),__ST206438_Layout);
  SHARED __EE205682 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST206749_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE206922 := PROJECT(__EE205682,TRANSFORM(__ST206749_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST207108_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC206929(__ST206438_Layout __EE206443, __ST206749_Layout __EE206922) := __EEQP(__EE206443.Subject_,__EE206922.UID);
  __ST207108_Layout __JT206929(__ST206438_Layout __l, __ST206749_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE207106 := JOIN(__EE206443,__EE206922,__JC206929(LEFT,RIGHT),__JT206929(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE205869 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST182470_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC207288(__ST207108_Layout __EE207106, B_Address.__ST2423_Layout __EE205869) := __EEQP(__EE207106.Location_,__EE205869.UID);
  __ST182470_Layout __JT207288(__ST207108_Layout __l, B_Address.__ST2423_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE207555 := JOIN(__EE207106,__EE205869,__JC207288(LEFT,RIGHT),__JT207288(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE207811 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST182762_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC207824(__ST182470_Layout __EE207555, E_Customer.Layout __EE207811) := __EEQP(__EE207555._r_Customer_,__EE207811.UID);
  __ST182762_Layout __JT207824(__ST182470_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE208079 := JOIN(__EE207555,__EE207811,__JC207824(LEFT,RIGHT),__JT207824(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST182167_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST182167_Layout __ND208325__Project(__ST182762_Layout __PP208080) := TRANSFORM
    SELF.Source_Customer_ := __PP208080._r_Customer_;
    SELF.Customer_Id_ := __PP208080.Customer_Id__2_;
    SELF.Industry_Type_ := __PP208080.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP208080.Entity_Context_Uid__1_;
    SELF := __PP208080;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE208079,__ND208325__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST182167_Layout));
END;
