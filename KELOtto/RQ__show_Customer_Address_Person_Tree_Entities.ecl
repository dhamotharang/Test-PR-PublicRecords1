...
EXPORT RQ__show_Customer_Address_Person_Tree_Entities := MODULE
  SHARED __EE917746 := B_Person_Address.IDX_Person_Address_Location__Wrapped;
  SHARED __EE917749 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST823544_Layout := RECORD
  ...
  END;
  __JC917757(E_Person_Address.Layout __EE917746, B_Person.__ST18771_Layout __EE917749) := __EEQP(__EE917746.Subject_,__EE917749.UID);
  __ST823544_Layout __JT917757(E_Person_Address.Layout __l, B_Person.__ST18771_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE917758 := JOIN(__EE917746,__EE917749,__JC917757(LEFT,RIGHT),__JT917757(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE918045 := B_Address.IDX_Address_UID_Wrapped;
  SHARED __ST823868_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC918053(__ST823544_Layout __EE917758, B_Address.__ST17641_Layout __EE918045) := __EEQP(__EE917758.Location_,__EE918045.UID);
  __ST823868_Layout __JT918053(__ST823544_Layout __l, B_Address.__ST17641_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE918054 := JOIN(__EE917758,__EE918045,__JC918053(LEFT,RIGHT),__JT918053(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE919000 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST824391_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC919010(__ST823868_Layout __EE918054, E_Customer.Layout __EE919000) := __EEQP(__EE918054._r_Customer_,__EE919000.UID);
  __ST824391_Layout __JT919010(__ST823868_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE919420 := JOIN(__EE918054,__EE919000,__JC919010(LEFT,RIGHT),__JT919010(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST823455_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST823455_Layout __ND919821__Project(__ST824391_Layout __PP919421) := TRANSFORM
    SELF.Source_Customer_ := __PP919421._r_Customer_;
    SELF.Customer_Id_ := __PP919421.Customer_Id__2_;
    SELF.Industry_Type_ := __PP919421.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP919421.Entity_Context_Uid__1_;
    SELF := __PP919421;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE919420,__ND919821__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST823455_Layout));
END;
