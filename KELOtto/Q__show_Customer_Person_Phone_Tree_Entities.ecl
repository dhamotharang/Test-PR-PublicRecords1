...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE776883 := __E_Person_Phone;
  SHARED __EE776931 := __ENH_Person;
  SHARED __ST776964_Layout := RECORD
  ...
  END;
  __JC776961(E_Person_Phone.Layout __EE776883, B_Person.__ST18647_Layout __EE776931) := __EEQP(__EE776883.Subject_,__EE776931.UID);
  __ST776964_Layout __JT776961(E_Person_Phone.Layout __l, B_Person.__ST18647_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE776962 := JOIN(__EE776883,__EE776931,__JC776961(LEFT,RIGHT),__JT776961(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE776920 := __ENH_Phone;
  SHARED __ST777283_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC778126(__ST776964_Layout __EE776962, B_Phone.__ST18928_Layout __EE776920) := __EEQP(__EE776962.Phone_Number_,__EE776920.UID);
  __ST777283_Layout __JT778126(__ST776964_Layout __l, B_Phone.__ST18928_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE778127 := JOIN(__EE776962,__EE776920,__JC778126(LEFT,RIGHT),__JT778126(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE776906 := __E_Customer;
  SHARED __ST777744_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC778128(__ST777283_Layout __EE778127, E_Customer.Layout __EE776906) := __EEQP(__EE778127._r_Customer_,__EE776906.UID);
  __ST777744_Layout __JT778128(__ST777283_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE778129 := JOIN(__EE778127,__EE776906,__JC778128(LEFT,RIGHT),__JT778128(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST17404_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST17404_Layout __ND778118__Project(__ST777744_Layout __PP778117) := TRANSFORM
    SELF.Source_Customer_ := __PP778117._r_Customer_;
    SELF.Customer_Id_ := __PP778117.Customer_Id__2_;
    SELF.Industry_Type_ := __PP778117.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP778117.Entity_Context_Uid__1_;
    SELF := __PP778117;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE778129,__ND778118__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST17404_Layout));
END;
