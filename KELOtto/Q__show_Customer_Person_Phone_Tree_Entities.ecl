...
EXPORT Q__show_Customer_Person_Phone_Tree_Entities := MODULE
  ...
  SHARED __EE2568493 := __E_Person_Phone;
  SHARED __EE2568476 := __ENH_Person;
  SHARED __ST2568511_Layout := RECORD
  ...
  END;
  __JC2568508(E_Person_Phone.Layout __EE2568493, B_Person.__ST39519_Layout __EE2568476) := __EEQP(__EE2568493.Subject_,__EE2568476.UID);
  __ST2568511_Layout __JT2568508(E_Person_Phone.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2568509 := JOIN(__EE2568493,__EE2568476,__JC2568508(LEFT,RIGHT),__JT2568508(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2568464 := __ENH_Phone;
  SHARED __ST2568874_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2570034(__ST2568511_Layout __EE2568509, B_Phone.__ST40876_Layout __EE2568464) := __EEQP(__EE2568509.Phone_Number_,__EE2568464.UID);
  __ST2568874_Layout __JT2570034(__ST2568511_Layout __l, B_Phone.__ST40876_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2570035 := JOIN(__EE2568509,__EE2568464,__JC2570034(LEFT,RIGHT),__JT2570034(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2568449 := __E_Customer;
  SHARED __ST2569546_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Phone.Typ) Phone_Number_;
    KEL.typ.ndataset(E_Person_Phone.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2570036(__ST2568874_Layout __EE2570035, E_Customer.Layout __EE2568449) := __EEQP(__EE2570035._r_Customer_,__EE2568449.UID);
  __ST2569546_Layout __JT2570036(__ST2568874_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2570037 := JOIN(__EE2570035,__EE2568449,__JC2570036(LEFT,RIGHT),__JT2570036(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST28541_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST28541_Layout __ND2570026__Project(__ST2569546_Layout __PP2570025) := TRANSFORM
    SELF.Source_Customer_ := __PP2570025._r_Customer_;
    SELF.Customer_Id_ := __PP2570025.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2570025.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2570025.Entity_Context_Uid__1_;
    SELF := __PP2570025;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2570037,__ND2570026__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST28541_Layout));
END;
