...
EXPORT Q__show_Customer_Person_Tree_Entities := MODULE
  ...
  SHARED __EE432339 := __E_Person_Person;
  SHARED __ST436455_Layout := RECORD
  ...
  END;
  SHARED __EE436460 := PROJECT(TABLE(PROJECT(__EE432339,__ST436455_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST436455_Layout);
  SHARED __EE432376 := __ENH_Person;
  SHARED __EE435047 := __EE432376;
  SHARED __ST436808_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE437005 := PROJECT(__EE435047,TRANSFORM(__ST436808_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST437215_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC437012(__ST436455_Layout __EE436460, __ST436808_Layout __EE437005) := __EEQP(__EE436460.To_Person_,__EE437005.UID);
  __ST437215_Layout __JT437012(__ST436455_Layout __l, __ST436808_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE437213 := JOIN(__EE436460,__EE437005,__JC437012(LEFT,RIGHT),__JT437012(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST432667_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC437419(__ST437215_Layout __EE437213, B_Person.__ST11169_Layout __EE432376) := __EEQP(__EE437213.From_Person_,__EE432376.UID);
  __ST432667_Layout __JT437419(__ST437215_Layout __l, B_Person.__ST11169_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE438161 := JOIN(__EE437213,__EE432376,__JC437419(LEFT,RIGHT),__JT437419(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE432362 := __E_Customer;
  SHARED __ST433448_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC438895(__ST432667_Layout __EE438161, E_Customer.Layout __EE432362) := __EEQP(__EE438161._r_Customer_,__EE432362.UID);
  __ST433448_Layout __JT438895(__ST432667_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE439302 := JOIN(__EE438161,__EE432362,__JC438895(LEFT,RIGHT),__JT438895(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST10282_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST10282_Layout __ND439700__Project(__ST433448_Layout __PP439303) := TRANSFORM
    SELF.Source_Customer_ := __PP439303._r_Customer_;
    SELF.Customer_Id_ := __PP439303.Customer_Id__2_;
    SELF.Industry_Type_ := __PP439303.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP439303.Entity_Context_Uid__1_;
    SELF := __PP439303;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE439302,__ND439700__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST10282_Layout));
END;
