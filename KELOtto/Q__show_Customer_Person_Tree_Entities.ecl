...
EXPORT Q__show_Customer_Person_Tree_Entities := MODULE
  ...
  SHARED __EE2536211 := __E_Person_Person;
  SHARED __ST2542813_Layout := RECORD
  ...
  END;
  SHARED __EE2542818 := PROJECT(TABLE(PROJECT(__EE2536211,__ST2542813_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST2542813_Layout);
  SHARED __EE2536182 := __ENH_Person;
  SHARED __EE2540511 := __EE2536182;
  SHARED __ST2543408_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE2543728 := PROJECT(__EE2540511,TRANSFORM(__ST2543408_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST2544061_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2543735(__ST2542813_Layout __EE2542818, __ST2543408_Layout __EE2543728) := __EEQP(__EE2542818.To_Person_,__EE2543728.UID);
  __ST2544061_Layout __JT2543735(__ST2542813_Layout __l, __ST2543408_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2544059 := JOIN(__EE2542818,__EE2543728,__JC2543735(LEFT,RIGHT),__JT2543735(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2536610_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2544388(__ST2544061_Layout __EE2544059, B_Person.__ST39519_Layout __EE2536182) := __EEQP(__EE2544059.From_Person_,__EE2536182.UID);
  __ST2536610_Layout __JT2544388(__ST2544061_Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2545618 := JOIN(__EE2544059,__EE2536182,__JC2544388(LEFT,RIGHT),__JT2544388(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2536167 := __E_Customer;
  SHARED __ST2537890_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2546840(__ST2536610_Layout __EE2545618, E_Customer.Layout __EE2536167) := __EEQP(__EE2545618._r_Customer_,__EE2536167.UID);
  __ST2537890_Layout __JT2546840(__ST2536610_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2547497 := JOIN(__EE2545618,__EE2536167,__JC2546840(LEFT,RIGHT),__JT2546840(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST28441_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST28441_Layout __ND2548145__Project(__ST2537890_Layout __PP2547498) := TRANSFORM
    SELF.Source_Customer_ := __PP2547498._r_Customer_;
    SELF.Customer_Id_ := __PP2547498.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2547498.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2547498.Entity_Context_Uid__1_;
    SELF := __PP2547498;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2547497,__ND2548145__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST28441_Layout));
END;
