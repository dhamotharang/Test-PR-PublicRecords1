...
EXPORT Q__show_Customer_Person_Tree_Entities := MODULE
  ...
  SHARED __EE160377 := __E_Person_Person;
  SHARED __ST164035_Layout := RECORD
  ...
  END;
  SHARED __EE164040 := PROJECT(TABLE(PROJECT(__EE160377,__ST164035_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST164035_Layout);
  SHARED __EE160414 := __ENH_Person;
  SHARED __EE162786 := __EE160414;
  SHARED __ST164346_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE164519 := PROJECT(__EE162786,TRANSFORM(__ST164346_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST164705_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC164526(__ST164035_Layout __EE164040, __ST164346_Layout __EE164519) := __EEQP(__EE164040.To_Person_,__EE164519.UID);
  __ST164705_Layout __JT164526(__ST164035_Layout __l, __ST164346_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE164703 := JOIN(__EE164040,__EE164519,__JC164526(LEFT,RIGHT),__JT164526(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST160680_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC164885(__ST164705_Layout __EE164703, B_Person.__ST2655_Layout __EE160414) := __EEQP(__EE164703.From_Person_,__EE160414.UID);
  __ST160680_Layout __JT164885(__ST164705_Layout __l, B_Person.__ST2655_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE165539 := JOIN(__EE164703,__EE160414,__JC164885(LEFT,RIGHT),__JT164885(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE160400 := __E_Customer;
  SHARED __ST161370_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC166185(__ST160680_Layout __EE165539, E_Customer.Layout __EE160400) := __EEQP(__EE165539._r_Customer_,__EE160400.UID);
  __ST161370_Layout __JT166185(__ST160680_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE166547 := JOIN(__EE165539,__EE160400,__JC166185(LEFT,RIGHT),__JT166185(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2233_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2233_Layout __ND166900__Project(__ST161370_Layout __PP166548) := TRANSFORM
    SELF.Source_Customer_ := __PP166548._r_Customer_;
    SELF.Customer_Id_ := __PP166548.Customer_Id__2_;
    SELF.Industry_Type_ := __PP166548.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP166548.Entity_Context_Uid__1_;
    SELF := __PP166548;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE166547,__ND166900__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2233_Layout));
END;
