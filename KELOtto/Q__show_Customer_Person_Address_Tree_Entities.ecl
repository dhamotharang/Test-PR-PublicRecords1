...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE682162 := __E_Person_Address;
  SHARED __EE682210 := __ENH_Person;
  SHARED __ST682243_Layout := RECORD
  ...
  END;
  __JC682240(E_Person_Address.Layout __EE682162, B_Person.__ST14833_Layout __EE682210) := __EEQP(__EE682162.Subject_,__EE682210.UID);
  __ST682243_Layout __JT682240(E_Person_Address.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE682241 := JOIN(__EE682162,__EE682210,__JC682240(LEFT,RIGHT),__JT682240(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE682199 := __ENH_Address;
  SHARED __ST682509_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC683346(__ST682243_Layout __EE682241, B_Address.__ST13794_Layout __EE682199) := __EEQP(__EE682241.Location_,__EE682199.UID);
  __ST682509_Layout __JT683346(__ST682243_Layout __l, B_Address.__ST13794_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE683347 := JOIN(__EE682241,__EE682199,__JC683346(LEFT,RIGHT),__JT683346(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE682185 := __E_Customer;
  SHARED __ST682970_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC683348(__ST682509_Layout __EE683347, E_Customer.Layout __EE682185) := __EEQP(__EE683347._r_Customer_,__EE682185.UID);
  __ST682970_Layout __JT683348(__ST682509_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE683349 := JOIN(__EE683347,__EE682185,__JC683348(LEFT,RIGHT),__JT683348(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST13617_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST13617_Layout __ND683338__Project(__ST682970_Layout __PP683337) := TRANSFORM
    SELF.Source_Customer_ := __PP683337._r_Customer_;
    SELF.Customer_Id_ := __PP683337.Customer_Id__2_;
    SELF.Industry_Type_ := __PP683337.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP683337.Entity_Context_Uid__1_;
    SELF := __PP683337;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE683349,__ND683338__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST13617_Layout));
END;
