...
EXPORT Q__show_Customer_Person_Address_Tree_Entities := MODULE
  ...
  SHARED __EE2555209 := __E_Person_Address;
  SHARED __EE2555192 := __ENH_Person;
  SHARED __ST2555227_Layout := RECORD
  ...
  END;
  __JC2555224(E_Person_Address.Layout __EE2555209, B_Person.__ST39519_Layout __EE2555192) := __EEQP(__EE2555209.Subject_,__EE2555192.UID);
  __ST2555227_Layout __JT2555224(E_Person_Address.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2555225 := JOIN(__EE2555209,__EE2555192,__JC2555224(LEFT,RIGHT),__JT2555224(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2555180 := __ENH_Address;
  SHARED __ST2555590_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2556866(__ST2555227_Layout __EE2555225, B_Address.__ST29865_Layout __EE2555180) := __EEQP(__EE2555225.Location_,__EE2555180.UID);
  __ST2555590_Layout __JT2556866(__ST2555227_Layout __l, B_Address.__ST29865_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2556867 := JOIN(__EE2555225,__EE2555180,__JC2556866(LEFT,RIGHT),__JT2556866(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2555165 := __E_Customer;
  SHARED __ST2556323_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Address.Typ) Location_;
    KEL.typ.ndataset(E_Person_Address.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2556868(__ST2555590_Layout __EE2556867, E_Customer.Layout __EE2555165) := __EEQP(__EE2556867._r_Customer_,__EE2555165.UID);
  __ST2556323_Layout __JT2556868(__ST2555590_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2556869 := JOIN(__EE2556867,__EE2555165,__JC2556868(LEFT,RIGHT),__JT2556868(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST28481_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST28481_Layout __ND2556858__Project(__ST2556323_Layout __PP2556857) := TRANSFORM
    SELF.Source_Customer_ := __PP2556857._r_Customer_;
    SELF.Customer_Id_ := __PP2556857.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2556857.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2556857.Entity_Context_Uid__1_;
    SELF := __PP2556857;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2556869,__ND2556858__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST28481_Layout));
END;
