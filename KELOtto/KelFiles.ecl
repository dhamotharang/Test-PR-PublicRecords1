EXPORT KelFiles := MODULE
  ...
  EXPORT CustomerStatsPivot := KELOtto.macPivotOttoOutput(KELOtto.Q__show_Customer.Res0, 'industry_type_,customer_id_', 'address_count_,all_address_count_,all_deceased_matched_percent_,all_deceased_matched_person_count_,all_deceased_person_count_,all_deceased_person_percent_,all_high_frequency_address_count_,all_high_frequency_address_percent_,all_person_count_,deceased_person_count_,deceased_person_percent_,high_frequency_address_count_,high_frequency_address_percent_,person_count_');
	
  EXPORT PersonStats := KELOtto.SlimDataSet(KELOtto.Q__show_Customer_Person.Res0, 'industry_type_,customer_id_,entity_context_uid_', 'label_,_r_customer_,deceased_ssn_,_nas__summary_,_nap__summary_,_subjectssncount_,_dobmatchlevel_,_ssnfoundforlexid_,subject_ssn_count_,date_of_birth_match_level_,stolen_identity_index_,synthetic_identity_index_,manipulated_identity_index_,vulnerable_victim_index_,friendlyfraud_index_,suspicious_activity_index_,all_death_prior_to_all_events_,all_deceased_event_count_,all_deceased_event_percent_,all_high_risk_death_prior_to_all_events_,all_max_deceased_to_event_diff_,death_prior_to_all_events_,deceased_,deceased_dob_match_,deceased_event_count_,deceased_event_percent_,deceased_match_,deceased_match_description_,deceased_name_match_,entity_type_,high_risk_death_prior_to_all_events_,in_customer_population_,max_deceased_to_event_diff_,no_lex_id_,' + 
                        'nas9_flag_,nap3_flag_,cl_death_prior_to_all_events_identity_count_,cl_high_risk_death_prior_to_all_events_identity_count_,cl_event_count_,cl_identity_count_,cl_full_identity_count_,cl_nas9_identity_count_,cl_nap3_identity_count_,cl_address_count_,cl_identity_event_avg_,cl_identity_count_percentile_,cl_event_count_percentile_,cl_impact_weight_,kr_high_risk_flag_,kr_medium_risk_flag_');
