...
EXPORT E_Person_Phone := MODULE
  ...
  EXPORT NullCounts := DATASET([
    ...
    {'PersonPhone','KELOtto.fraudgovshared','EventDate',COUNT(__d0(__NL(Event_Date_))),COUNT(__d0(__NN(Event_Date_)))},
    ...
    {'PersonPhone','KELOtto.fraudgovshared','EventDate',COUNT(__d1(__NL(Event_Date_))),COUNT(__d1(__NN(Event_Date_)))},
