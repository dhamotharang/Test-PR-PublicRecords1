...
IMPORT B_Bank_Account,B_Customer,B_Customer_4,B_Person,B_Person_2,B_Person_Bank_Account,E_Bank,E_Bank_Account,E_Customer,E_Person,E_Person_Bank_Account FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Bank_Account_Tree_Entities := MODULE
  SHARED __EE2751463 := PROJECT(B_Person_Bank_Account.IDX_Person_Bank_Account_Account__Wrapped,E_Person_Bank_Account.Layout);
  SHARED __EE2751466 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2627129_Layout := RECORD
  ...
  END;
  __JC2751474(E_Person_Bank_Account.Layout __EE2751463, B_Person.__ST39519_Layout __EE2751466) := __EEQP(__EE2751463.Subject_,__EE2751466.UID);
  __ST2627129_Layout __JT2751474(E_Person_Bank_Account.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2751475 := JOIN(__EE2751463,__EE2751466,__JC2751474(LEFT,RIGHT),__JT2751474(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2751800 := B_Bank_Account.IDX_Bank_Account_UID_Wrapped;
  SHARED __ST2627492_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2751808(__ST2627129_Layout __EE2751475, B_Bank_Account.__ST30967_Layout __EE2751800) := __EEQP(__EE2751475.Account_,__EE2751800.UID);
  __ST2627492_Layout __JT2751808(__ST2627129_Layout __l, B_Bank_Account.__ST30967_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2751809 := JOIN(__EE2751475,__EE2751800,__JC2751808(LEFT,RIGHT),__JT2751808(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2752946 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2628151_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Bank_Account.Typ) Account_;
    KEL.typ.ndataset(E_Person_Bank_Account.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2752960(__ST2627492_Layout __EE2751809, E_Customer.Layout __EE2752946) := __EEQP(__EE2751809._r_Customer_,__EE2752946.UID);
  __ST2628151_Layout __JT2752960(__ST2627492_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2753419 := JOIN(__EE2751809,__EE2752946,__JC2752960(LEFT,RIGHT),__JT2752960(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2627034_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2627034_Layout __ND2753869__Project(__ST2628151_Layout __PP2753420) := TRANSFORM
    SELF.Source_Customer_ := __PP2753420._r_Customer_;
    SELF.Customer_Id_ := __PP2753420.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2753420.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2753420.Entity_Context_Uid__1_;
    SELF := __PP2753420;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2753419,__ND2753869__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2627034_Layout));
END;
