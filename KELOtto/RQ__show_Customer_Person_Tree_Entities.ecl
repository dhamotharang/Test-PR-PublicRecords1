...
EXPORT RQ__show_Customer_Person_Tree_Entities := MODULE
  SHARED __EE796240 := B_Person_Person.IDX_Person_Person_From_Person__Wrapped;
  SHARED __ST799305_Layout := RECORD
  ...
  END;
  SHARED __EE799310 := PROJECT(TABLE(PROJECT(__EE796240,__ST799305_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST799305_Layout);
  SHARED __EE796243 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST799718_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE799945 := PROJECT(__EE796243,TRANSFORM(__ST799718_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST800185_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC799952(__ST799305_Layout __EE799310, __ST799718_Layout __EE799945) := __EEQP(__EE799310.To_Person_,__EE799945.UID);
  __ST800185_Layout __JT799952(__ST799305_Layout __l, __ST799718_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE800183 := JOIN(__EE799310,__EE799945,__JC799952(LEFT,RIGHT),__JT799952(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE797909 := __EE796243;
  SHARED __ST722026_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC800419(__ST800185_Layout __EE800183, B_Person.__ST14833_Layout __EE797909) := __EEQP(__EE800183.From_Person_,__EE797909.UID);
  __ST722026_Layout __JT800419(__ST800185_Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE801281 := JOIN(__EE800183,__EE797909,__JC800419(LEFT,RIGHT),__JT800419(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE802132 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST722938_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC802144(__ST722026_Layout __EE801281, E_Customer.Layout __EE802132) := __EEQP(__EE801281._r_Customer_,__EE802132.UID);
  __ST722938_Layout __JT802144(__ST722026_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE802611 := JOIN(__EE801281,__EE802132,__JC802144(LEFT,RIGHT),__JT802144(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST721649_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST721649_Layout __ND803069__Project(__ST722938_Layout __PP802612) := TRANSFORM
    SELF.Source_Customer_ := __PP802612._r_Customer_;
    SELF.Customer_Id_ := __PP802612.Customer_Id__2_;
    SELF.Industry_Type_ := __PP802612.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP802612.Entity_Context_Uid__1_;
    SELF := __PP802612;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE802611,__ND803069__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST721649_Layout));
END;
