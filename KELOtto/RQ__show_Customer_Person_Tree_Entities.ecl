...
EXPORT RQ__show_Customer_Person_Tree_Entities := MODULE
  SHARED __EE784259 := B_Person_Person.IDX_Person_Person_From_Person__Wrapped;
  SHARED __ST787324_Layout := RECORD
  ...
  END;
  SHARED __EE787329 := PROJECT(TABLE(PROJECT(__EE784259,__ST787324_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST787324_Layout);
  SHARED __EE784262 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST787737_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE787964 := PROJECT(__EE784262,TRANSFORM(__ST787737_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST788204_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC787971(__ST787324_Layout __EE787329, __ST787737_Layout __EE787964) := __EEQP(__EE787329.To_Person_,__EE787964.UID);
  __ST788204_Layout __JT787971(__ST787324_Layout __l, __ST787737_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE788202 := JOIN(__EE787329,__EE787964,__JC787971(LEFT,RIGHT),__JT787971(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE785928 := __EE784262;
  SHARED __ST709986_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC788438(__ST788204_Layout __EE788202, B_Person.__ST14816_Layout __EE785928) := __EEQP(__EE788202.From_Person_,__EE785928.UID);
  __ST709986_Layout __JT788438(__ST788204_Layout __l, B_Person.__ST14816_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE789300 := JOIN(__EE788202,__EE785928,__JC788438(LEFT,RIGHT),__JT788438(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE790151 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST710898_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC790163(__ST709986_Layout __EE789300, E_Customer.Layout __EE790151) := __EEQP(__EE789300._r_Customer_,__EE790151.UID);
  __ST710898_Layout __JT790163(__ST709986_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE790630 := JOIN(__EE789300,__EE790151,__JC790163(LEFT,RIGHT),__JT790163(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST709609_Layout := RECORD
