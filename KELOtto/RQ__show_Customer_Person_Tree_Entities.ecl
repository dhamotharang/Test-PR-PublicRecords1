...
EXPORT RQ__show_Customer_Person_Tree_Entities := MODULE
  SHARED __EE199109 := B_Person_Person.IDX_Person_Person_From_Person__Wrapped;
  SHARED __ST201438_Layout := RECORD
  ...
  END;
  SHARED __EE201443 := PROJECT(TABLE(PROJECT(__EE199109,__ST201438_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),_r_Customer_,From_Person_,To_Person_},_r_Customer_,From_Person_,To_Person_,MERGE),__ST201438_Layout);
  SHARED __EE199112 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST201749_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.epoch Date_Last_Seen_ := 0;
  END;
  SHARED __EE201922 := PROJECT(__EE199112,TRANSFORM(__ST201749_Layout,SELF._r_Customer__1_ := LEFT._r_Customer_,SELF := LEFT));
  SHARED __ST202108_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC201929(__ST201438_Layout __EE201443, __ST201749_Layout __EE201922) := __EEQP(__EE201443.To_Person_,__EE201922.UID);
  __ST202108_Layout __JT201929(__ST201438_Layout __l, __ST201749_Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE202106 := JOIN(__EE201443,__EE201922,__JC201929(LEFT,RIGHT),__JT201929(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE200379 := __EE199112;
  SHARED __ST181067_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC202288(__ST202108_Layout __EE202106, B_Person.__ST2655_Layout __EE200379) := __EEQP(__EE202106.From_Person_,__EE200379.UID);
  __ST181067_Layout __JT202288(__ST202108_Layout __l, B_Person.__ST2655_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE202942 := JOIN(__EE202106,__EE200379,__JC202288(LEFT,RIGHT),__JT202288(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE203585 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST181757_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) From_Person_;
    KEL.typ.ntyp(E_Person.Typ) To_Person_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC203598(__ST181067_Layout __EE202942, E_Customer.Layout __EE203585) := __EEQP(__EE202942._r_Customer_,__EE203585.UID);
  __ST181757_Layout __JT203598(__ST181067_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE203960 := JOIN(__EE202942,__EE203585,__JC203598(LEFT,RIGHT),__JT203598(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST180756_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST180756_Layout __ND204313__Project(__ST181757_Layout __PP203961) := TRANSFORM
    SELF.Source_Customer_ := __PP203961._r_Customer_;
    SELF.Customer_Id_ := __PP203961.Customer_Id__2_;
    SELF.Industry_Type_ := __PP203961.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP203961.Entity_Context_Uid__1_;
    SELF := __PP203961;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE203960,__ND204313__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST180756_Layout));
END;
