...
//OttoRules := Dataset('~foreign::10.173.44.105::thor_data400::in::fraudgov::sprayed::mbsfdnmasteridindtypeinclusion',Fraudshared.Layouts.input.mbsfdnmasteridindtypeinclusion,csv(SEPARATOR('|\t|'),QUOTE(''),TERMINATOR('|\n')));
