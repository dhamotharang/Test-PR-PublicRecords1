...
EXPORT B_Phone_5 := MODULE
  ...
  __ST152317_Layout __JT154501(B_Event_6.__ST63668_Layout __l, E_Phone_Event.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE154502 := JOIN(__EE154483,__EE151294,__JC154501(RIGHT,LEFT),__JT154501(RIGHT,LEFT),INNER,HASH);
  ...
  __ST153276_Layout __JT155483(E_Phone.Layout __l, __ST151247_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE155484 := JOIN(__EE149079,__EE155477,__JC155483(LEFT,RIGHT),__JT155483(LEFT,RIGHT),LEFT OUTER,HASH);
