...
PersonIPMetadataPrep1 :=  If(RunKelDemo=false,FraudGovPlatform.files(,KELOtto.Constants.useOtherEnvironmentDali).base.IPMetaData.built
															,FraudGovPlatform.files(,KELOtto.Constants.useOtherEnvironmentDali).base.IPMetaData_Demo.built);
...
EXPORT PersonIPMetadata := PersonIPMetadataPrep2;
