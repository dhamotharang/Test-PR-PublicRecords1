...
EXPORT B_Person_Address := MODULE
  SHARED __EE834779 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE834779(__NN(__EE834779.Location_));
  ...
  EXPORT __ST834781_Layout := RECORDOF(IDX_Person_Address_Location_);
