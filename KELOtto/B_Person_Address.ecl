...
EXPORT B_Person_Address := MODULE
  SHARED __EE828722 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE828722(__NN(__EE828722.Location_));
  ...
  EXPORT __ST828724_Layout := RECORDOF(IDX_Person_Address_Location_);
