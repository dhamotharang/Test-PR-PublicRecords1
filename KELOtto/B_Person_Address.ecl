...
EXPORT B_Person_Address := MODULE
  SHARED __EE733028 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE733028(__NN(__EE733028.Location_));
  ...
  EXPORT __ST733030_Layout := RECORDOF(IDX_Person_Address_Location_);
