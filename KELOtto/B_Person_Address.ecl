...
EXPORT B_Person_Address := MODULE
  SHARED __EE824408 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE824408(__NN(__EE824408.Location_));
  ...
  EXPORT __ST824410_Layout := RECORDOF(IDX_Person_Address_Location_);
