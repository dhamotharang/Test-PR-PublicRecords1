...
EXPORT B_Person_Address := MODULE
  SHARED __EE831654 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE831654(__NN(__EE831654.Location_));
  ...
  EXPORT __ST831656_Layout := RECORDOF(IDX_Person_Address_Location_);
