...
EXPORT B_Person_Address := MODULE
  SHARED __EE504776 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE504776(__NN(__EE504776.Location_));
  ...
  EXPORT __ST504778_Layout := RECORDOF(IDX_Person_Address_Location_);
