...
EXPORT B_Person_Address := MODULE
  SHARED __EE827611 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE827611(__NN(__EE827611.Location_));
  ...
  EXPORT __ST827613_Layout := RECORDOF(IDX_Person_Address_Location_);
