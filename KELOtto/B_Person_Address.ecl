...
EXPORT B_Person_Address := MODULE
  SHARED __EE184236 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE184236(__NN(__EE184236.Location_));
  ...
  EXPORT __ST184238_Layout := RECORDOF(IDX_Person_Address_Location_);
