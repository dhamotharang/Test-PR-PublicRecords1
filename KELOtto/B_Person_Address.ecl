...
EXPORT B_Person_Address := MODULE
  SHARED __EE831310 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE831310(__NN(__EE831310.Location_));
  ...
  EXPORT __ST831312_Layout := RECORDOF(IDX_Person_Address_Location_);
