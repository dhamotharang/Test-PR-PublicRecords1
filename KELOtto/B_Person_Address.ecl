...
EXPORT B_Person_Address := MODULE
  SHARED __EE489216 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE489216(__NN(__EE489216.Location_));
  ...
  EXPORT __ST489218_Layout := RECORDOF(IDX_Person_Address_Location_);
