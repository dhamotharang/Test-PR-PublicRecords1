...
EXPORT B_Person_Address := MODULE
  SHARED __EE721124 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE721124(__NN(__EE721124.Location_));
  ...
  EXPORT __ST721126_Layout := RECORDOF(IDX_Person_Address_Location_);
