...
EXPORT B_Person_Address := MODULE
  SHARED __EE830921 := E_Person_Address.__Result;
  SHARED __IDX_Person_Address_Location__Filtered := __EE830921(__NN(__EE830921.Location_));
  ...
  EXPORT __ST830923_Layout := RECORDOF(IDX_Person_Address_Location_);
