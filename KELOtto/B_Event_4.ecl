...
EXPORT B_Event_4 := MODULE
  ...
  SHARED __EE48162 := __ENH_Event_5;
  ...
  END;
  SHARED __ST22002_Layout __ND47998__Project(B_Event_5.__ST22478_Layout __PP45921) := TRANSFORM
    SELF.Id_Nas9_Flag_ := MAP(__T(__OP2(__CAST(KEL.typ.str,__PP45921._nas__summary_),=,__CN('9')))=>1,0);
    SELF.Ip_Hosted_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP45921._proxytype_),=,__CN('HOSTING')))=>1,0);
    SELF.Ip_Not_Us_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP45921._edgecountry_),IN,__CN(['USA',''])))=>0,1);
    SELF.Ip_Tor_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP45921._proxydescription_),IN,__CN(['TOR EXIT','TOR RELAY'])))=>1,0);
    SELF.Ip_Vpn_ := MAP(__T(__OP2(__FN1(KEL.Routines.ToUpperCase,__PP45921._proxydescription_),=,__CN('VPN')))=>1,0);
    __BS47939 := __T(__PP45921.Event_Types_);
    SELF.Kr_High_Risk_Identity_Flag_ := MAP(__PP45921.Kr_Identity_Risk_ = 1 OR EXISTS(__BS47939(__T(__OP2(__T(__PP45921.Event_Types_).Event_Type_,IN,__CN(['10000','10001','10002','10004','10005','10006','10007','11000','11001','11002','11003','11004','11005','11006','11007','11008','11009','11010','11011','11012','11013','11014','11015','11016','11017','11018','11019','12000','12001','12002','12003','12004','12005','12006','12007','13000','13001','13002','13003','13004','13005','13006','13007','1400'])))))=>1,0);
    SELF := __PP45921;
  END;
  EXPORT __ENH_Event_4 := PROJECT(__EE48162,__ND47998__Project(LEFT));
END;
