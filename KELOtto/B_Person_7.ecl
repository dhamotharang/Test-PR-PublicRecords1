...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE5007 := __E_Person;
  EXPORT __ST4763_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST4763_Layout __ND5974__Project(E_Person.Layout __PP5010) := TRANSFORM
    SELF.Deceased_ := MAP(__T(__FN1(KEL.Routines.IsValidDate,__PP5010.Deceased_Date_))=>1,0);
    SELF := __PP5010;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE5007,__ND5974__Project(LEFT));
END;
