...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE25106 := __ENH_Person_8;
  EXPORT __ST23325_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST23325_Layout __ND25869__Project(B_Person_8.__ST23480_Layout __PP25109) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP25109.Deceased_ = 1 AND __PP25109.Deceased_Name_Match_ = 1 AND __PP25109.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP25109;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE25106,__ND25869__Project(LEFT));
END;
