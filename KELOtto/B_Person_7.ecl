...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE27397 := __ENH_Person_8;
  EXPORT __ST23632_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST23632_Layout __ND28160__Project(B_Person_8.__ST23787_Layout __PP27400) := TRANSFORM
    SELF.Deceased_Match_ := MAP(__PP27400.Deceased_ = 1 AND __PP27400.Deceased_Name_Match_ = 1 AND __PP27400.Deceased_Dob_Match_ = 1=>1,0);
    SELF := __PP27400;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE27397,__ND28160__Project(LEFT));
END;
