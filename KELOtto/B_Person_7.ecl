...
EXPORT B_Person_7 := MODULE
  ...
  SHARED __EE21623 := __E_Person;
  EXPORT __ST19489_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST19489_Layout __ND22344__Project(E_Person.Layout __PP21626) := TRANSFORM
    SELF.Deceased_ := MAP(__T(__FN1(KEL.Routines.IsValidDate,__PP21626.Deceased_Date_))=>1,0);
    SELF := __PP21626;
  END;
  EXPORT __ENH_Person_7 := PROJECT(__EE21623,__ND22344__Project(LEFT));
END;
