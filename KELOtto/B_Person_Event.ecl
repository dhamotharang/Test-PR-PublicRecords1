...
EXPORT B_Person_Event := MODULE
  SHARED __EE489224 := E_Person_Event.__Result;
  SHARED __IDX_Person_Event_Account__Filtered := __EE489224(__NN(__EE489224.Account_));
  ...
  EXPORT __ST489226_Layout := RECORDOF(IDX_Person_Event_Account_);
