...
EXPORT B_Person_Event := MODULE
  SHARED __EE502570 := E_Person_Event.__Result;
  SHARED __IDX_Person_Event_Account__Filtered := __EE502570(__NN(__EE502570.Account_));
  ...
  EXPORT __ST502572_Layout := RECORDOF(IDX_Person_Event_Account_);
