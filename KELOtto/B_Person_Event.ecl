...
EXPORT B_Person_Event := MODULE
  SHARED __EE527025 := E_Person_Event.__Result;
  SHARED __IDX_Person_Event_Account__Filtered := __EE527025(__NN(__EE527025.Account_));
  ...
  EXPORT __ST527027_Layout := RECORDOF(IDX_Person_Event_Account_);
