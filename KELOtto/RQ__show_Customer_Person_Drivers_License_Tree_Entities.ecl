...
IMPORT B_Customer,B_Customer_4,B_Drivers_License,B_Person,B_Person_2,B_Person_Drivers_License,E_Customer,E_Drivers_License,E_Person,E_Person_Drivers_License FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT RQ__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  SHARED __EE2755319 := PROJECT(B_Person_Drivers_License.IDX_Person_Drivers_License_License__Wrapped,E_Person_Drivers_License.Layout);
  SHARED __EE2755322 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST2628744_Layout := RECORD
  ...
  END;
  __JC2755330(E_Person_Drivers_License.Layout __EE2755319, B_Person.__ST39519_Layout __EE2755322) := __EEQP(__EE2755319.Subject_,__EE2755322.UID);
  __ST2628744_Layout __JT2755330(E_Person_Drivers_License.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2755331 := JOIN(__EE2755319,__EE2755322,__JC2755330(LEFT,RIGHT),__JT2755330(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2755656 := B_Drivers_License.IDX_Drivers_License_UID_Wrapped;
  SHARED __ST2629107_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2755664(__ST2628744_Layout __EE2755331, B_Drivers_License.__ST32177_Layout __EE2755656) := __EEQP(__EE2755331.License_,__EE2755656.UID);
  __ST2629107_Layout __JT2755664(__ST2628744_Layout __l, B_Drivers_License.__ST32177_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2755665 := JOIN(__EE2755331,__EE2755656,__JC2755664(LEFT,RIGHT),__JT2755664(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2756810 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST2629772_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.ndataset(E_Person_Drivers_License.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2756824(__ST2629107_Layout __EE2755665, E_Customer.Layout __EE2756810) := __EEQP(__EE2755665._r_Customer_,__EE2756810.UID);
  __ST2629772_Layout __JT2756824(__ST2629107_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2757285 := JOIN(__EE2755665,__EE2756810,__JC2756824(LEFT,RIGHT),__JT2756824(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST2628649_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST2628649_Layout __ND2757737__Project(__ST2629772_Layout __PP2757286) := TRANSFORM
    SELF.Source_Customer_ := __PP2757286._r_Customer_;
    SELF.Customer_Id_ := __PP2757286.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2757286.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2757286.Entity_Context_Uid__1_;
    SELF := __PP2757286;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2757285,__ND2757737__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST2628649_Layout));
END;
