...
EXPORT RQ__show_Customer_Person_Drivers_License_Tree_Entities := MODULE
  SHARED __EE823375 := B_Person_Drivers_License.IDX_Person_Drivers_License_License__Wrapped;
  SHARED __EE823378 := B_Person.IDX_Person_UID_Wrapped;
  SHARED __ST731626_Layout := RECORD
  ...
  END;
  __JC823386(E_Person_Drivers_License.Layout __EE823375, B_Person.__ST14833_Layout __EE823378) := __EEQP(__EE823375.Subject_,__EE823378.UID);
  __ST731626_Layout __JT823386(E_Person_Drivers_License.Layout __l, B_Person.__ST14833_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE823387 := JOIN(__EE823375,__EE823378,__JC823386(LEFT,RIGHT),__JT823386(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE823616 := B_Drivers_License.IDX_Drivers_License_UID_Wrapped;
  SHARED __ST731892_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC823624(__ST731626_Layout __EE823387, B_Drivers_License.__ST14025_Layout __EE823616) := __EEQP(__EE823387.License_,__EE823616.UID);
  __ST731892_Layout __JT823624(__ST731626_Layout __l, B_Drivers_License.__ST14025_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE823625 := JOIN(__EE823387,__EE823616,__JC823624(LEFT,RIGHT),__JT823624(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE824343 := PROJECT(B_Customer.IDX_Customer_UID_Wrapped,E_Customer.Layout);
  SHARED __ST732293_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Drivers_License.Typ) License_;
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC824353(__ST731892_Layout __EE823625, E_Customer.Layout __EE824343) := __EEQP(__EE823625._r_Customer_,__EE824343.UID);
  __ST732293_Layout __JT824353(__ST731892_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE824657 := JOIN(__EE823625,__EE824343,__JC824353(LEFT,RIGHT),__JT824353(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST731537_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST731537_Layout __ND824952__Project(__ST732293_Layout __PP824658) := TRANSFORM
    SELF.Source_Customer_ := __PP824658._r_Customer_;
    SELF.Customer_Id_ := __PP824658.Customer_Id__2_;
    SELF.Industry_Type_ := __PP824658.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP824658.Entity_Context_Uid__1_;
    SELF := __PP824658;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE824657,__ND824952__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST731537_Layout));
END;
