...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE61329 := __E_Bank;
  EXPORT __ST21223_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST21223_Layout __ND61441__Project(E_Bank.Layout __PP61332) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP61332.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP61332;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE61329,__ND61441__Project(LEFT));
END;
