...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE57463 := __E_Bank;
  EXPORT __ST17255_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST17255_Layout __ND57575__Project(E_Bank.Layout __PP57466) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP57466.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194','061210237','081501340'])))=>1,0);
    SELF := __PP57466;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE57463,__ND57575__Project(LEFT));
END;
