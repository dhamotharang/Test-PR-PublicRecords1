...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE62689 := __E_Bank;
  EXPORT __ST21360_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST21360_Layout __ND62801__Project(E_Bank.Layout __PP62692) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP62692.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP62692;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE62689,__ND62801__Project(LEFT));
END;
