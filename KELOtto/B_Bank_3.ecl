...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE51722 := __E_Bank;
  EXPORT __ST15636_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST15636_Layout __ND51834__Project(E_Bank.Layout __PP51725) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP51725.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194','061210237','081501340'])))=>1,0);
    SELF := __PP51725;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE51722,__ND51834__Project(LEFT));
END;
