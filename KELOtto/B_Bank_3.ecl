...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE59831 := __E_Bank;
  EXPORT __ST21351_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST21351_Layout __ND59943__Project(E_Bank.Layout __PP59834) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP59834.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP59834;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE59831,__ND59943__Project(LEFT));
END;
