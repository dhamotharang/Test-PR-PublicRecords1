...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE195929 := __E_Bank;
  EXPORT __ST58516_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST58516_Layout __ND195964__Project(E_Bank.Layout __PP195851) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP195851.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP195851;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE195929,__ND195964__Project(LEFT)) : PERSIST('~temp::KEL::KELOtto::Bank::Annotated_3',EXPIRE(7));
END;
