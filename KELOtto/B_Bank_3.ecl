...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE63395 := __E_Bank;
  EXPORT __ST21355_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST21355_Layout __ND63507__Project(E_Bank.Layout __PP63398) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP63398.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194','061210237','081501340'])))=>1,0);
    SELF := __PP63398;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE63395,__ND63507__Project(LEFT));
END;
