...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE177561 := __E_Bank;
  EXPORT __ST50889_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST50889_Layout __ND177596__Project(E_Bank.Layout __PP177483) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP177483.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194'])))=>1,0);
    SELF := __PP177483;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE177561,__ND177596__Project(LEFT));
END;
