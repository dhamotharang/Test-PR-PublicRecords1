...
EXPORT B_Bank_3 := MODULE
  ...
  SHARED __EE62495 := __E_Bank;
  EXPORT __ST21367_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST21367_Layout __ND62607__Project(E_Bank.Layout __PP62498) := TRANSFORM
    SELF.High_Risk_Routing_ := MAP(__T(__OP2(__PP62498.Routing_Number_,IN,__CN(['031101169','124071889','124303120','073972181','084003997','114924742','031101169','063115194','061210237','081501340'])))=>1,0);
    SELF := __PP62498;
  END;
  EXPORT __ENH_Bank_3 := PROJECT(__EE62495,__ND62607__Project(LEFT));
END;
