...
EXPORT B_Person_Email := MODULE
  SHARED __EE829540 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE829540(__NN(__EE829540.Emailof_));
  ...
  EXPORT __ST829542_Layout := RECORDOF(IDX_Person_Email_Emailof_);
