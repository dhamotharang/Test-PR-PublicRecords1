...
EXPORT B_Person_Email := MODULE
  SHARED __EE526176 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE526176(__NN(__EE526176.Emailof_));
  ...
  EXPORT __ST526178_Layout := RECORDOF(IDX_Person_Email_Emailof_);
