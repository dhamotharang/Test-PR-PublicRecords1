...
EXPORT B_Person_Email := MODULE
  SHARED __EE831343 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE831343(__NN(__EE831343.Emailof_));
  ...
  EXPORT __ST831345_Layout := RECORDOF(IDX_Person_Email_Emailof_);
