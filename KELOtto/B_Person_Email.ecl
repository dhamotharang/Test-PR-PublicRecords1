...
EXPORT B_Person_Email := MODULE
  SHARED __EE824400 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE824400(__NN(__EE824400.Emailof_));
  ...
  EXPORT __ST824402_Layout := RECORDOF(IDX_Person_Email_Emailof_);
