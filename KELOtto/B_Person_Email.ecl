...
EXPORT B_Person_Email := MODULE
  SHARED __EE505276 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE505276(__NN(__EE505276.Emailof_));
  ...
  EXPORT __ST505278_Layout := RECORDOF(IDX_Person_Email_Emailof_);
