...
EXPORT B_Person_Email := MODULE
  SHARED __EE830703 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE830703(__NN(__EE830703.Emailof_));
  ...
  EXPORT __ST830705_Layout := RECORDOF(IDX_Person_Email_Emailof_);
