...
EXPORT B_Person_Email := MODULE
  SHARED __EE834066 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE834066(__NN(__EE834066.Emailof_));
  ...
  EXPORT __ST834068_Layout := RECORDOF(IDX_Person_Email_Emailof_);
