...
EXPORT B_Person_Email := MODULE
  SHARED __EE831381 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE831381(__NN(__EE831381.Emailof_));
  ...
  EXPORT __ST831383_Layout := RECORDOF(IDX_Person_Email_Emailof_);
