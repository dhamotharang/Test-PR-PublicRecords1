...
EXPORT B_Person_Email := MODULE
  SHARED __EE720998 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE720998(__NN(__EE720998.Emailof_));
  ...
  EXPORT __ST721000_Layout := RECORDOF(IDX_Person_Email_Emailof_);
