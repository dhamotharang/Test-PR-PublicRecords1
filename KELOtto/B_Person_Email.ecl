...
EXPORT B_Person_Email := MODULE
  SHARED __EE502901 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE502901(__NN(__EE502901.Emailof_));
  ...
  EXPORT __ST502903_Layout := RECORDOF(IDX_Person_Email_Emailof_);
