...
IMPORT E_Email,E_Person,E_Person_Email FROM KELOtto;
IMPORT * FROM KEL011.Null;
EXPORT B_Person_Email := MODULE
  SHARED __EE627726 := E_Person_Email.__Result;
  SHARED __IDX_Person_Email_Emailof__Filtered := __EE627726(__NN(__EE627726.Emailof_));
  ...
  EXPORT __ST627728_Layout := RECORDOF(IDX_Person_Email_Emailof_);
