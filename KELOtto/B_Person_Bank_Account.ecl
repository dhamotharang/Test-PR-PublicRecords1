...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE825290 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE825290(__NN(__EE825290.Account_));
  ...
  EXPORT __ST825292_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
