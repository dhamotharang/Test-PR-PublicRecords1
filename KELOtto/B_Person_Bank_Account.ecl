...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE831515 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE831515(__NN(__EE831515.Account_));
  ...
  EXPORT __ST831517_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
