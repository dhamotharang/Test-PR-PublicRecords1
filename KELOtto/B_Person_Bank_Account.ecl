...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE721519 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE721519(__NN(__EE721519.Account_));
  ...
  EXPORT __ST721521_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
