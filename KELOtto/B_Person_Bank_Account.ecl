...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE832058 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE832058(__NN(__EE832058.Account_));
  ...
  EXPORT __ST832060_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
