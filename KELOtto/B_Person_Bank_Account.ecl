...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE489718 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE489718(__NN(__EE489718.Account_));
  ...
  EXPORT __ST489720_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
