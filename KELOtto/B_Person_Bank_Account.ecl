...
EXPORT B_Person_Bank_Account := MODULE
  SHARED __EE733718 := E_Person_Bank_Account.__Result;
  SHARED __IDX_Person_Bank_Account_Account__Filtered := __EE733718(__NN(__EE733718.Account_));
  ...
  EXPORT __ST733720_Layout := RECORDOF(IDX_Person_Bank_Account_Account_);
