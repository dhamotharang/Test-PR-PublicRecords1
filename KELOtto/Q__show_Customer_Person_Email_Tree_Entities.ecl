...
EXPORT Q__show_Customer_Person_Email_Tree_Entities := MODULE
  ...
  SHARED __EE2572617 := __E_Person_Email;
  SHARED __EE2572600 := __ENH_Person;
  SHARED __ST2572635_Layout := RECORD
  ...
  END;
  __JC2572632(E_Person_Email.Layout __EE2572617, B_Person.__ST39519_Layout __EE2572600) := __EEQP(__EE2572617.Subject_,__EE2572600.UID);
  __ST2572635_Layout __JT2572632(E_Person_Email.Layout __l, B_Person.__ST39519_Layout __r) := TRANSFORM
    SELF._r_Customer__1_ := __r._r_Customer_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2572633 := JOIN(__EE2572617,__EE2572600,__JC2572632(LEFT,RIGHT),__JT2572632(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2572588 := __ENH_Email;
  SHARED __ST2572998_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2574156(__ST2572635_Layout __EE2572633, B_Email.__ST33168_Layout __EE2572588) := __EEQP(__EE2572633.Emailof_,__EE2572588.UID);
  __ST2572998_Layout __JT2574156(__ST2572635_Layout __l, B_Email.__ST33168_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2574157 := JOIN(__EE2572633,__EE2572588,__JC2574156(LEFT,RIGHT),__JT2574156(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __EE2572573 := __E_Customer;
  SHARED __ST2573662_Layout := RECORD
    KEL.typ.ntyp(E_Customer.Typ) _r_Customer_;
    KEL.typ.ntyp(E_Person.Typ) Subject_;
    KEL.typ.ntyp(E_Email.Typ) Emailof_;
    KEL.typ.ndataset(E_Person_Email.Event_Dates_Layout) Event_Dates_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC2574158(__ST2572998_Layout __EE2574157, E_Customer.Layout __EE2572573) := __EEQP(__EE2574157._r_Customer_,__EE2572573.UID);
  __ST2573662_Layout __JT2574158(__ST2572998_Layout __l, E_Customer.Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE2574159 := JOIN(__EE2574157,__EE2572573,__JC2574158(LEFT,RIGHT),__JT2574158(LEFT,RIGHT),LEFT OUTER,HASH);
  SHARED __ST28561_Layout := RECORD
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST28561_Layout __ND2574148__Project(__ST2573662_Layout __PP2574147) := TRANSFORM
    SELF.Source_Customer_ := __PP2574147._r_Customer_;
    SELF.Customer_Id_ := __PP2574147.Customer_Id__2_;
    SELF.Industry_Type_ := __PP2574147.Industry_Type__2_;
    SELF.Tree_Uid_ := __PP2574147.Entity_Context_Uid__1_;
    SELF := __PP2574147;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE2574159,__ND2574148__Project(LEFT)),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,TRUE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_},Source_Customer_,Customer_Id_,Industry_Type_,Tree_Uid_,Entity_Context_Uid_,MERGE),__ST28561_Layout));
END;
