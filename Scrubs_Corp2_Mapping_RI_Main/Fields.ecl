IMPORT SALT36;
IMPORT Scrubs,Scrubs_Corp2_Mapping_RI_Main; // Import modules for FieldTypes attribute definitions
EXPORT Fields := MODULE
 
// Processing for each FieldType
EXPORT SALT36.StrType FieldTypeName(UNSIGNED2 i) := CHOOSE(i,'invalid_corp_key','invalid_charter_nbr','invalid_corp_vendor','invalid_state_origin','invalid_mandatory','invalid_date','invalid_future_date','invalid_corp_term_exist_cd','invalid_for_dom_ind','invalid_Y_N','invalid_ln_name_type_cd','invalid_recordorigin','invalid_alphablank','invalid_state_desc','invalid_country');
EXPORT FieldTypeNum(SALT36.StrType fn) := CASE(fn,'invalid_corp_key' => 1,'invalid_charter_nbr' => 2,'invalid_corp_vendor' => 3,'invalid_state_origin' => 4,'invalid_mandatory' => 5,'invalid_date' => 6,'invalid_future_date' => 7,'invalid_corp_term_exist_cd' => 8,'invalid_for_dom_ind' => 9,'invalid_Y_N' => 10,'invalid_ln_name_type_cd' => 11,'invalid_recordorigin' => 12,'invalid_alphablank' => 13,'invalid_state_desc' => 14,'invalid_country' => 15,0);
...
EXPORT MakeFT_invalid_corp_vendor(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_vendor(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['44']);
EXPORT InValidMessageFT_invalid_corp_vendor(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('44'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_state_origin(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_state_origin(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['RI']);
EXPORT InValidMessageFT_invalid_state_origin(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('RI'),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_future_date(SALT36.StrType s0) := FUNCTION
  s1 := SALT36.stringfilter(s0,'0123456789'); // Only allow valid symbols
  RETURN  s1;
END;
EXPORT InValidFT_invalid_future_date(SALT36.StrType s) := WHICH(LENGTH(TRIM(s))<>LENGTH(TRIM(SALT36.StringFilter(s,'0123456789'))),~Scrubs.fn_valid_GeneralDate(s)>0);
EXPORT InValidMessageFT_invalid_future_date(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInChars('0123456789'),SALT36.HygieneErrors.CustomFail('Scrubs.fn_valid_GeneralDate'),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_corp_term_exist_cd(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_corp_term_exist_cd(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['D','P',' ']);
EXPORT InValidMessageFT_invalid_corp_term_exist_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('D|P| '),SALT36.HygieneErrors.Good);
...
EXPORT MakeFT_invalid_Y_N(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_Y_N(SALT36.StrType s) := WHICH(((SALT36.StrType) s) NOT IN ['Y','N',' ']);
EXPORT InValidMessageFT_invalid_Y_N(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.NotInEnum('Y|N| '),SALT36.HygieneErrors.Good);
 
EXPORT MakeFT_invalid_ln_name_type_cd(SALT36.StrType s0) := FUNCTION
  RETURN  s0;
END;
EXPORT InValidFT_invalid_ln_name_type_cd(SALT36.StrType s,SALT36.StrType recordorigin) := WHICH(~Scrubs_Corp2_Mapping_RI_Main.Functions.invalid_name_type_code(s,recordorigin)>0);
EXPORT InValidMessageFT_invalid_ln_name_type_cd(UNSIGNED1 wh) := CHOOSE(wh,SALT36.HygieneErrors.CustomFail('Scrubs_Corp2_Mapping_RI_Main.Functions.invalid_name_type_code'),SALT36.HygieneErrors.Good);
...
EXPORT Make_corp_ln_name_type_cd(SALT36.StrType s0) := MakeFT_invalid_ln_name_type_cd(s0);
EXPORT InValid_corp_ln_name_type_cd(SALT36.StrType s,SALT36.StrType recordorigin) := InValidFT_invalid_ln_name_type_cd(s,recordorigin);
EXPORT InValidMessage_corp_ln_name_type_cd(UNSIGNED1 wh) := InValidMessageFT_invalid_ln_name_type_cd(wh);
...
EXPORT Make_corp_address1_type_cd(SALT36.StrType s0) := s0;
EXPORT InValid_corp_address1_type_cd(SALT36.StrType s) := 0;
...
EXPORT Make_corp_filing_date(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_filing_date(SALT36.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_status_cd(SALT36.StrType s0) := s0;
EXPORT InValid_corp_status_cd(SALT36.StrType s) := 0;
...
EXPORT Make_corp_status_date(SALT36.StrType s0) := MakeFT_invalid_date(s0);
EXPORT InValid_corp_status_date(SALT36.StrType s) := InValidFT_invalid_date(s);
...
EXPORT Make_corp_inc_state(SALT36.StrType s0) := MakeFT_invalid_state_origin(s0);
EXPORT InValid_corp_inc_state(SALT36.StrType s) := InValidFT_invalid_state_origin(s);
...
EXPORT Make_corp_term_exist_cd(SALT36.StrType s0) := MakeFT_invalid_corp_term_exist_cd(s0);
EXPORT InValid_corp_term_exist_cd(SALT36.StrType s) := InValidFT_invalid_corp_term_exist_cd(s);
...
EXPORT Make_corp_orig_org_structure_cd(SALT36.StrType s0) := s0;
EXPORT InValid_corp_orig_org_structure_cd(SALT36.StrType s) := 0;
...
EXPORT Make_corp_for_profit_ind(SALT36.StrType s0) := MakeFT_invalid_Y_N(s0);
EXPORT InValid_corp_for_profit_ind(SALT36.StrType s) := InValidFT_invalid_Y_N(s);
...
EXPORT Make_cont_title1_desc(SALT36.StrType s0) := s0;
EXPORT InValid_cont_title1_desc(SALT36.StrType s) := 0;
...
EXPORT Make_InternalField1(SALT36.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_InternalField1(SALT36.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_InternalField1(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
 
EXPORT Make_InternalField2(SALT36.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_InternalField2(SALT36.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_InternalField2(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
 
EXPORT Make_InternalField3(SALT36.StrType s0) := MakeFT_invalid_country(s0);
EXPORT InValid_InternalField3(SALT36.StrType s) := InValidFT_invalid_country(s);
EXPORT InValidMessage_InternalField3(UNSIGNED1 wh) := InValidMessageFT_invalid_country(wh);
 
EXPORT Make_InternalField4(SALT36.StrType s0) := MakeFT_invalid_alphablank(s0);
EXPORT InValid_InternalField4(SALT36.StrType s) := InValidFT_invalid_alphablank(s);
EXPORT InValidMessage_InternalField4(UNSIGNED1 wh) := InValidMessageFT_invalid_alphablank(wh);
...
export MAC_CountDifferencesByPivot(in_left,in_right,pivot_exp,bad_pivots,out_counts) := MACRO
  IMPORT SALT36,Scrubs_Corp2_Mapping_RI_Main;
...
#uniquename(AggRec)
  %AggRec% := RECORD
    ...
    Count_Diff_InternalField4 := COUNT(GROUP,%Closest%.Diff_InternalField4);
