...
Command line options: -MScrubs_Corp2_Mapping_RI_Main -eC:\Users\myanasx\AppData\Local\Temp\TFR9B31.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_RI_Main
FILENAME:in_file
...
FIELDTYPE:invalid_corp_vendor:ENUM(44)
FIELDTYPE:invalid_state_origin:ENUM(RI)
...
FIELDTYPE:invalid_ln_name_type_cd:CUSTOM(Scrubs_Corp2_Mapping_RI_Main.Functions.invalid_name_type_code>0,recordorigin)
...
FIELD:InternalField3:TYPE(STRING100):LIKE(invalid_country):0,0
FIELD:InternalField4:TYPE(STRING100):LIKE(invalid_alphablank):0,0
