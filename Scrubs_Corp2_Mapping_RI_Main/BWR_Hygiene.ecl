...
#workunit('name','Scrubs_Corp2_Mapping_RI_Main.BWR_Hygiene - Hygiene & Stats - SALT V3.6.0');
IMPORT Scrubs_Corp2_Mapping_RI_Main,SALT36;
// First create an instantiated hygiene module
  infile := Scrubs_Corp2_Mapping_RI_Main.In_in_file;
  ip := DISTRIBUTE(infile, SKEW(0.1));
  h := Scrubs_Corp2_Mapping_RI_Main.Hygiene(ip);
