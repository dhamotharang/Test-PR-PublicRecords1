...
+    #IF( #TEXT(Input_InternalField2)='' )
      '' 
    #ELSE
        IF( le.Input_InternalField2 = (TYPEOF(le.Input_InternalField2))'','',':InternalField2')
    #END
 
+    #IF( #TEXT(Input_InternalField3)='' )
      '' 
    #ELSE
        IF( le.Input_InternalField3 = (TYPEOF(le.Input_InternalField3))'','',':InternalField3')
    #END
 
+    #IF( #TEXT(Input_InternalField4)='' )
      '' 
    #ELSE
        IF( le.Input_InternalField4 = (TYPEOF(le.Input_InternalField4))'','',':InternalField4')
    #END
