...
Command line options: -MScrubs_DL_NE -eC:\Users\wolfkg\AppData\Local\Temp\TFR61A4.tmp 
...
FIELDTYPE:invalid_dln:LENGTHS(9):CUSTOM(Scrubs_DL_NE.Functions.fn_check_dl_number>0)
FIELDTYPE:invalid_state:CUSTOM(Scrubs_DL_NE.Functions.fn_verify_state>0)
FIELDTYPE:invalid_zip5:LENGTHS(5):LIKE(invalid_numeric)
FIELDTYPE:invalid_zip4:LENGTHS(0,4):LIKE(invalid_numeric)
FIELDTYPE:invalid_gender:ENUM(F|M)
FIELDTYPE:invalid_height:LENGTHS(3):CUSTOM(Scrubs_DL_NE.Functions.fn_verify_height>0)
FIELDTYPE:invalid_weight:LENGTHS(3):CUSTOM(Scrubs_DL_NE.Functions.fn_verify_weight>0)
FIELDTYPE:invalid_eye_color:CUSTOM(Scrubs_DL_NE.Functions.fn_check_eye_color>0)
FIELDTYPE:invalid_hair_color:CUSTOM(Scrubs_DL_NE.Functions.fn_check_hair_color>0)
FIELDTYPE:invalid_license_type:CUSTOM(Scrubs_DL_NE.Functions.fn_check_license_type>0)
FIELDTYPE:invalid_name:LIKE(invalid_wordbag):CUSTOM(Scrubs_DL_NE.Functions.fn_valid_name>0,fname,mname)
...
FIELDTYPE:invalid_record_type:CUSTOM(Scrubs_DL_NE.Functions.fn_addr_rec_type>0)
...
FIELD:dln:TYPE(STRING9):LIKE(invalid_dln):0,0
FIELD:name:TYPE(STRING35):LIKE(invalid_mandatory):0,0
FIELD:dob:TYPE(STRING10):LIKE(invalid_8pastdate):0,0
FIELD:address_street:TYPE(STRING30):LIKE(invalid_mandatory):0,0
FIELD:address_city:TYPE(STRING18):LIKE(invalid_mandatory):0,0
FIELD:address_state:TYPE(STRING2):LIKE(invalid_state):0,0
FIELD:address_zip5:TYPE(STRING5):LIKE(invalid_zip5):0,0
FIELD:address_zip4:TYPE(STRING4):LIKE(invalid_zip4):0,0
FIELD:gender:TYPE(STRING1):LIKE(invalid_gender):0,0
FIELD:height:TYPE(STRING3):LIKE(invalid_height):0,0
FIELD:weight:TYPE(STRING3):LIKE(invalid_weight):0,0
FIELD:eye_color:TYPE(STRING3):LIKE(invalid_eye_color):0,0
FIELD:hair_color:TYPE(STRING3):LIKE(invalid_hair_color):0,0
FIELD:license_type:TYPE(STRING4):LIKE(invalid_license_type):0,0
...
FIELD:suffix:TYPE(STRING4):LIKE(invalid_alpha_specials):0,0
FIELD:postdir:TYPE(STRING2):LIKE(invalid_direction):0,0
FIELD:unit_desig:TYPE(STRING10):0,0
FIELD:sec_range:TYPE(STRING8):0,0
FIELD:p_city_name:TYPE(STRING25):LIKE(invalid_alpha_specials):0,0
FIELD:v_city_name:TYPE(STRING25):LIKE(invalid_alpha_specials):0,0
