...
//*
export ToEdina_v41_BtSt( dataset(final_layout) final, string50 DataRestrictionMask = risk_indicators.iid_constants.default_DataRestriction ) := FUNCTION
	ox := record
		risk_indicators.Layout_Boca_Shell_Edina_v41 bto;
		risk_indicators.Layout_Boca_Shell_Edina_v41 sto;
		risk_indicators.Layout_EDDO eddo;
		riskwise.Layout_IP2O ip2o;
	end;


	ox convertToEdina_v41(final le) := transform
	...
	edina := project(final, convertToEdina_v41(left));
