...
sc := risk_indicators.Score_And_Distance_Function(iid_btst, dppa, glb);
...
btst_Deeds_Addrs := Risk_Indicators.Boca_Shell_BtSt_Address(iid_btst_filtered, dppa, glb, DataRestriction, BSversion);
