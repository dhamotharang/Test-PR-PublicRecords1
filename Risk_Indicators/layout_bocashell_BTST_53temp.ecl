...
EXPORT layout_bocashell_BTST_53temp := RECORD
  ...
  integer8 btst_cbd_inq_ver_count;
  integer8 st_addr_is_bt_business_addr;
  integer8 btst_economic_trajectory;
  integer8 btst_cbd_ids_per_bt_id_ct;
  integer8 btst_cbd_ids_per_st_id_ct;
  integer8 btst_bt_bip_addr_ct;
  integer8 btst_st_bip_addr_ct;
  boolean btst_bt_addr_bip_match;
  boolean btst_st_addr_bip_match;
  unsigned2 btst_did_summary;
  string15 btst_association_type;
  string10 btst_association_confidence;
  integer2 btst_cohabit_cnt;
  unsigned2 btst_overlap_mths;
  boolean btst_any_lname_match;
  boolean btst_any_phone_match;
  boolean btst_early_lname_match;
  boolean btst_curr_lname_match;
  boolean btst_mixed_lname_match;
  boolean btst_personal_association;
  boolean btst_business_association;
  boolean btst_other_association;
  unsigned1 btst_st_relation_to_bt;
  string1 btst_st_associate_or_relative;
  boolean btst_st_isbusiness;
  integer8 btst_businesses_in_common;
  integer8 btst_property_deeds_in_common;
  integer8 btst_addrs_in_common;
  integer8 btst_owned_addrs_in_common;
  integer8 btst_lres_in_common;
  integer8 btst_addr_dists_in_common;
  integer8 btst_addr_states_in_common;
  integer8 btst_phones_in_common;
  integer8 btst_landlines_in_common;
  integer8 btst_cellphones_in_common;
  integer8 btst_last_names_in_common;
  integer8 btst_emails_in_common;
  integer8 btst_free_emails_in_common;
  integer8 btst_isp_emails_in_common;
  integer8 btst_edu_emails_in_common;
  integer8 btst_corp_emails_in_common;
  integer8 bt_phone_found_on_st_inq_count;
  integer8 bt_addr_found_on_st_inq_count;
  integer8 bt_ssn_found_on_st_inq_count;
  integer8 st_phone_found_on_bt_inq_count;
  integer8 st_addr_found_on_bt_inq_count;
  integer8 st_ssn_found_on_bt_inq_count;
  integer8 bt_phone_found_on_st_inq_auto_count;
  integer8 bt_addr_found_on_st_inq_auto_count;
  integer8 bt_ssn_found_on_st_inq_auto_count;
  integer8 st_phone_found_on_bt_inq_auto_count;
  integer8 st_addr_found_on_bt_inq_auto_count;
  integer8 st_ssn_found_on_bt_inq_auto_count;
  integer8 bt_phone_found_on_st_inq_banking_count;
  integer8 bt_addr_found_on_st_inq_banking_count;
  integer8 bt_ssn_found_on_st_inq_banking_count;
  integer8 st_phone_found_on_bt_inq_banking_count;
  integer8 st_addr_found_on_bt_inq_banking_count;
  integer8 st_ssn_found_on_bt_inq_banking_count;
  integer8 bt_phone_found_on_st_inq_collection_count;
  integer8 bt_addr_found_on_st_inq_collection_count;
  integer8 bt_ssn_found_on_st_inq_collection_count;
  integer8 st_phone_found_on_bt_inq_collection_count;
  integer8 st_addr_found_on_bt_inq_collection_count;
  integer8 st_ssn_found_on_bt_inq_collection_count;
  integer8 bt_phone_found_on_st_inq_mortgage_count;
  integer8 bt_addr_found_on_st_inq_mortgage_count;
  integer8 bt_ssn_found_on_st_inq_mortgage_count;
  integer8 st_phone_found_on_bt_inq_mortgage_count;
  integer8 st_addr_found_on_bt_inq_mortgage_count;
  integer8 st_ssn_found_on_bt_inq_mortgage_count;
  integer8 bt_phone_found_on_st_inq_highriskcredit_count;
  integer8 bt_addr_found_on_st_inq_highriskcredit_count;
  integer8 bt_ssn_found_on_st_inq_highriskcredit_count;
  integer8 st_phone_found_on_bt_inq_highriskcredit_count;
  integer8 st_addr_found_on_bt_inq_highriskcredit_count;
  integer8 st_ssn_found_on_bt_inq_highriskcredit_count;
  integer8 bt_phone_found_on_st_inq_retail_count;
  integer8 bt_addr_found_on_st_inq_retail_count;
  integer8 bt_ssn_found_on_st_inq_retail_count;
  integer8 st_phone_found_on_bt_inq_retail_count;
  integer8 st_addr_found_on_bt_inq_retail_count;
  integer8 st_ssn_found_on_bt_inq_retail_count;
  integer8 bt_phone_found_on_st_inq_communications_count;
  integer8 bt_addr_found_on_st_inq_communications_count;
  integer8 bt_ssn_found_on_st_inq_communications_count;
  integer8 st_phone_found_on_bt_inq_communications_count;
  integer8 st_addr_found_on_bt_inq_communications_count;
  integer8 st_ssn_found_on_bt_inq_communications_count;
  integer8 bt_phone_found_on_st_inq_other_count;
  integer8 bt_addr_found_on_st_inq_other_count;
  integer8 bt_ssn_found_on_st_inq_other_count;
  integer8 st_phone_found_on_bt_inq_other_count;
  integer8 st_addr_found_on_bt_inq_other_count;
  integer8 st_ssn_found_on_bt_inq_other_count;
  integer8 bt_phone_found_on_st_inq_prepaidcards_count;
  integer8 bt_addr_found_on_st_inq_prepaidcards_count;
  integer8 bt_ssn_found_on_st_inq_prepaidcards_count;
  integer8 st_phone_found_on_bt_inq_prepaidcards_count;
  integer8 st_addr_found_on_bt_inq_prepaidcards_count;
  integer8 st_ssn_found_on_bt_inq_prepaidcards_count;
  integer8 bt_phone_found_on_st_inq_quizprovider_count;
  integer8 bt_addr_found_on_st_inq_quizprovider_count;
  integer8 bt_ssn_found_on_st_inq_quizprovider_count;
  integer8 st_phone_found_on_bt_inq_quizprovider_count;
  integer8 st_addr_found_on_bt_inq_quizprovider_count;
  integer8 st_ssn_found_on_bt_inq_quizprovider_count;
  integer8 bt_phone_found_on_st_inq_retailpayments_count;
  integer8 bt_addr_found_on_st_inq_retailpayments_count;
  integer8 bt_ssn_found_on_st_inq_retailpayments_count;
  integer8 st_phone_found_on_bt_inq_retailpayments_count;
  integer8 st_addr_found_on_bt_inq_retailpayments_count;
  integer8 st_ssn_found_on_bt_inq_retailpayments_count;
  integer8 bt_phone_found_on_st_inq_studentloans_count;
  integer8 bt_addr_found_on_st_inq_studentloans_count;
  integer8 bt_ssn_found_on_st_inq_studentloans_count;
  integer8 st_phone_found_on_bt_inq_studentloans_count;
  integer8 st_addr_found_on_bt_inq_studentloans_count;
  integer8 st_ssn_found_on_bt_inq_studentloans_count;
  integer8 bt_phone_found_on_st_inq_utilities_count;
  integer8 bt_addr_found_on_st_inq_utilities_count;
  integer8 bt_ssn_found_on_st_inq_utilities_count;
  integer8 st_phone_found_on_bt_inq_utilities_count;
  integer8 st_addr_found_on_bt_inq_utilities_count;
  integer8 st_ssn_found_on_bt_inq_utilities_count;
  integer8 btst_schools_in_common;
  integer8 btst_relationship_index_v1;
  integer8 btst_relationship_index_v2;
