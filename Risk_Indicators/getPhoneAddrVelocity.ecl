...
import _Control, risk_indicators, dx_Gong, riskwise, ut, dx_header, mdr, drivers, FCRA, data_services, Doxie, Suppress;
...
gong_history_did_key := dx_Gong.key_history_did(iType);

{risk_indicators.iid_constants.layout_outx, UNSIGNED4 global_sid} addPhone(iid le, gong_history_did_key ri) := transform
