...
layout_inquiries_edina := RECORD
   ...
   unsigned2 inquiryadlsperphone;
	 ...
	 unsigned2 inquiryemailsperADL;// new for shell 5.0
   unsigned2 inquiryADLsperEmail;// new for shell 5.0
...
Layout_Address_Information_Edina1 := RECORD
	...
	integer1 occupancy_index;  // new for shell 5.0
...
Layout_Address_Information_Edina2 := RECORD
	...
	string1 addr_type;
	unsigned2 lres; 
	// new for shell 5.0 - advo fields from shell 4.0
		string1		Address_Vacancy_Indicator		;
		string1		Throw_Back_Indicator			;
		string1		Seasonal_Delivery_Indicator		;
		string1		DND_Indicator					;
...
integer1 economic_trajectory := 0; // new for shell 5.0 
integer1 economic_trajectory_index := 0; // new for shell 5.0 
boolean addrsMilitaryEver := false; // new for shell 5.0 
	...
	integer unverified_addr_count := 0;  // new for shell 5.0
END;
...
Layout_American_Student := RECORD
	...
	string1 FILE_TYPE;
	string1 COLLEGE_TIER;  // using new college tier2 in shell 5.0
...
Layout_RV_Scores := RECORD
	...
	// placeholders for v5 scores and reason codes (no retail flagship in this version)
	string3 bankcardv5 := '';
	string3 reason1bv5 := '';
	string3 reason2bv5 := '';
	string3 reason3bv5 := '';
...
Layout_FD_Scores := RECORD
	...
	// new fraudpoint v2 scores and reason codes for v41
	...
	// new fraudpoint v3 scores and reason codes
...
Layout_Derogs_edina := RECORD
	...
	UNSIGNED1 bk_dismissed_recent_count;  // new for shell 5.0
	UNSIGNED1 bk_dismissed_historical_count;// new for shell 5.0
	string3 bk_chapter;// new for shell 5.0
...
export Layout_Boca_Shell_Edina_v50 := RECORD
	#if(includeADLFields)
	...
	decimal4_1 source_profile;  					// new for shell 5.0
	integer source_profile_index; 				// new for shell 5.0
	...
	layouts.Layout_iBehavior						iBehavior;	// new to shell 4.1
	layouts.layout_employment 					employment;  // new to shell 4.0
	Layout_Infutor											Infutor;
	Layout_Impulse											Impulse;
	layouts.layout_email_50							email_summary;  // modified layout in shell 5.0
	Layout_Attributes										Attributes;
	layout_virtual_fraud								Virtual_Fraud;	
	layouts.layout_fd_attributesv2			fdAttributesv2;	// new to shell 4.1
	...
	string2 AssetValueIndex := '';  // placeholder for rv attributes v5
	string3 AssetIndexPrimaryFactor := '';  // placeholder for rv attributes v5
	string2 StabilityIndex := '';  // placeholder for rv attributes v5
	string3 StabilityPrimaryFactor := '';  // placeholder for rv attributes v5
	string2 AbilityIndex := '';  // placeholder for rv attributes v5
	string3 AbilityIndexPrimaryFactor := '';  // placeholder for rv attributes v5
	string2 WillingnessIndex := '';  // placeholder for rv attributes v5
	string3 WillingnessIndexPrimaryFactor := '';  // placeholder for rv attributes v5
