import business_header,header,gong_v2,fcra, ut;

EXPORT Phone_Table_gongv2 (boolean isFCRA = false) := FUNCTION
...
rec slimg(gong_v2.proc_roxie_keybuild_prep le) := TRANSFORM
...
good_phns := gong_v2.proc_roxie_keybuild_prep(goodphone(phone10));
...
END;
  ...
  p_name := IF (IsFCRA, 'maltemp::phone_table_FCRA_v2', 'maltemp::phone_table_v2'); 
