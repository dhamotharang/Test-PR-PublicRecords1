Import Data_Services, doxie, Data_Services, ut;
...
export Key_Address_Table_v4 := index(f,{zip,prim_name,prim_range,sec_range},{f},
				...
				Data_Services.Data_location.Prefix('NONAMEGIVEN')+'thor_data400::key::death_master::'+doxie.Version_SuperKey+'::address_table_v4');
