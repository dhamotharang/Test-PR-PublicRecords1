// creating this attribute just in case anyone needs to look at old files on thor which are stored in this 4.0 layout
layout_input_temp4 := RECORD
   unsigned4 seq;
   unsigned6 did;
   unsigned2 score;
   string5 title;
...
layout_address_avm_temp4 := RECORD
...
layout_consumerflags_temp4 := RECORD
...
EXPORT layout_bocashell_4temp := RECORD
  unsigned4 seq;
  unsigned6 did;
  boolean truedid;
