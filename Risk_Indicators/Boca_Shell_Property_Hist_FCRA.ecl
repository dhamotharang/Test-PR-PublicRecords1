...
layout_PropertyRecordPlus get_property_by_addr (layout_propertyRecord le, recordof(LN_PropertyV2.Key_Addr_Fid(isFCRA)) ri) := TRANSFORM
...
layout_PropertyRecordPlus getSearch_FCRA(layout_PropertyRecordPlus le, recordof(LN_PropertyV2.key_search_fid(isFCRA)) ri) := TRANSFORM
...
layout_PropertyRecordPlus add_assess_FCRA(layout_PropertyRecordPlus le, recordof(LN_PropertyV2.key_assessor_fid(isFCRA)) ri) := TRANSFORM
...
layout_PropertyRecordPlus add_deeds_FCRA(layout_PropertyRecordPlus le, recordof(LN_PropertyV2.key_deed_fid(isFCRA)) ri) := TRANSFORM
	...
	deedMortgageType := iid_constants.mortgage_type(fidelity, fares, mt);
	...
	self.type_financing := iid_constants.type_financing(fidelity, fares, ft);
...
layout_PropertyRecordPlus fillall(deeds_added le, distressed ri) := transform
