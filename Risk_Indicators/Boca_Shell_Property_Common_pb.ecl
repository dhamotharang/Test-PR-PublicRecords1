...
EXPORT Boca_Shell_Property_Common_pb(GROUPED DATASET(Layout_PropertyRecord) p_address,
...
// for batch transactions performance enhancement
	...
	Single_Property_roxie := SORT(GROUP(SORT(ds_final,seq),seq),prim_name,prim_range,zip5,sec_range,census_loose,dataSrce);
	Single_Property_thor := SORT(GROUP(SORT(ds_final,seq),seq),prim_name,prim_range,zip5,sec_range,census_loose,dataSrce);
	Single_Property := if(onThor, single_property_thor, single_property_roxie);
