// creating this attribute just in case anyone needs to look at old files on thor which are stored in this 5.0 layout

_layout_input := RECORD
   unsigned4 seq;
   unsigned6 did;
   unsigned2 score;
   string5 title;
...
layout_avm := RECORD
   _layout_address_avm input_address_information;
   _layout_address_avm address_history_1;
   _layout_address_avm address_history_2;
  END;
...
EXPORT layout_bocashell_50temp := RECORD
  unsigned4 seq;
  unsigned6 did;
  boolean truedid;
  string15 adlcategory;
  _layout_input shell_input;
  ...
  _layout_consumerflags consumerflags;
