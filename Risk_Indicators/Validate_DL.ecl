...
ret := CASE(state,
		...
		'CT' =>  	MAP(dob='' => '99',
				    ...
				    dl_len=9 => '12',
				    '1'),
		'DE' =>  	MAP(dl_len<=8 AND IsAllNumeric(dl_trim) => '0',
				    dl_len<=8 => '12',
				    '1'),
		'DC' =>  	MAP(dl_len=7 AND IsAllNumeric(dl_trim) => '0',
				    dl_len=7 => '12',
				    '1'),
		'FL' =>  	MAP(dob='' => '99',
		...
		'MN' =>  	MAP(dl_len=13 AND dl_trim[1]>='A' AND dl_trim[1]<='Z' AND IsAllNumeric(dl_trim[2..13]) => '0',
					   ...
					   '1'),
		'MS' =>  	MAP(dl_len=9 and IsAllNumeric(dl_trim) => '0',
				   	dl_len=9 => '12',
			   		'1'),
		'MO' =>  	MAP(dl_len between 7 and 10 AND dl_trim[1]>='A' AND dl_trim[1]<='Z' AND IsAllNumeric(dl_trim[2..dl_len]) =>'0',
        dl_len=10 AND dl_trim[4]>='A' AND dl_trim[4]<='Z' AND IsAllNumeric(dl_trim[1..3]) AND IsAllNumeric(dl_trim[5..dl_len]) => '0',
		...
		'NE' =>  	MAP(dl_len<10 AND dl_trim[1] in ['A','B','C','E','G','H','V'] AND IsAllNumeric(dl_trim[2..dl_len]) => '0',
				    dl_len<10 AND dl_trim[1] in ['A','B','C','E','G','H','V'] => '12',
				    dl_len<10 => '6',
				    '1'),
		'NV' =>  	MAP((dl_len in [10,12] AND IsAllNumeric(dl_trim))=>'0',
								dl_len in [10,12] => '12',
								'1'),
		'NH' =>  	MAP(dl_len=11 AND dl_trim[1..2] = 'NH' and dl_trim[3] >= 'A' and dl_trim[3] <= 'Z' and IsAllNumeric(dl_trim[4..11]) => '0',
		...
		'NC' =>  	MAP(dl_len<13 AND IsAllNumeric(dl_trim) => '0',
				    ...
				    '1'),
		'ND' =>  	MAP(dob='' => '99',
				    dl_len=9 AND LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..3]), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))=3 AND 
     dl_trim[4..5]=dob[3..4] AND IsAllNumeric(dl_trim[6..9]) => '0',
				    dl_len=9 AND LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..3]), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))=3 AND 
     dl_trim[4..5]=dob[3..4] => '12',
				    dl_len=9 AND LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..3]), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'))=3 => '5',
				    dl_len=9 => '6',
				    '1'),
		'OH' =>  	MAP(dl_len=8 AND dl_trim[1]>='A' AND dl_trim[1]<='Z' AND dl_trim[2]>='A' AND dl_trim[2]<='Z' AND IsAllNumeric(dl_trim[3..8]) => '0',
				    dl_len=8 => '12',
				    '1'),
		'OK' =>  	MAP(dl_len=10 AND dl_trim[1]>='A' AND dl_trim[1]<='Z' AND IsAllNumeric(dl_trim[2..10]) => '0',
					   dl_len in [9,10] => '12',
				    '1'),
  ...
  'RI' =>  	MAP(dl_len=7 AND dl_trim[1] ='V' AND IsAllNumeric(dl_trim[2..7]) => '0',
        dl_len=7 AND dl_trim[1]>='A' and dl_trim[1]<='Z' and IsAllNumeric(dl_trim[2..7]) => '6',
        dl_len=7 AND IsAllNumeric(dl_trim) => '0',
        dl_len=8 AND dl_trim[1] ='4' AND IsAllNumeric(dl_trim) => '0',
        dl_len=8 AND IsAllNumeric(dl_trim) => '6',
        dl_len in [7,8] => '12',
        '1'),
		...
		'SD' =>  	MAP(dl_len=8 AND IsAllNumeric(dl_trim) => '0',
				    dl_len=8=> '12',
				    '1'),
		'TN' =>  	MAP(dl_len=9 AND IsAllNumeric(dl_trim) => '0',
				    dl_len=9 => '12',
				    '1'),
		...
		'WV' =>  	MAP(dl_len=7 AND IsAllNumeric(dl_trim) => '0',
				    dl_len=7 AND 
     LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..7]), '1234567890')) = 6 AND 
     LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..7]), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')) = 1  => '0',
				    dl_len=7 AND LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..7]), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')) > 1 => '12',
				    dl_len=7 => '13',
				    '1'),
  ...
  // American Samoa
  'AS' => MAP(dl_len = 6 AND IsAllNumeric(dl_trim[1..6]) => '0',
        dl_len = 6 => '12',
        '1'),
		...
		'MP' => MAP(dl_len = 8 AND IsAllNumeric(dl_trim[1..8]) => '0',
        dl_len = 8 => '12',
								'1'),	
								
		// US Virgin Islands
		'VI' => MAP(dl_len = 13 AND IsAllNumeric(dl_trim[2..13]) AND (dl_trim[1]>='A' AND dl_trim[1]<='Z') => '0',
        dl_len = 13 AND IsAllNumeric(dl_trim[2..13]) => '6',
        dl_len = 10 AND IsAllNumeric(dl_trim) => '0',
        dl_len in [13,10] => '12',
								'1'),	
