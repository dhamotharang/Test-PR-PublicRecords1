...
ret := CASE(state,
		...
		'NV' =>  	MAP((dl_len=10 AND IsAllNumeric(dl_trim))=>'0',
                  (dl_len=12 AND dl_trim[11..12]=dob[3..4])=>'0',
                  (dl_len=9 AND dl_trim[1]>='A' AND dl_trim[1]<='Z' AND IsAllNumeric(dl_trim[2..dl_len]))=>'0',
                  (dl_len=10 AND LENGTH(StringLib.StringFilter(StringLib.StringToUpperCase(dl_trim[1..2] ), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890'))=2 AND IsAllNumeric(dl_trim[3..dl_len]))=> '0',
									 dl_len=10 => '12',
									'1'),
		'NH' =>  	MAP(dob='' => '99',
