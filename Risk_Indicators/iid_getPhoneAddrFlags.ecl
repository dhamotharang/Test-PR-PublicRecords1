...
import _Control, riskwise, risk_indicators, dx_Gong, Doxie, data_services, Suppress;
...
layout_gonghistory := dx_Gong.layouts.i_history_phone;
gong_key := dx_Gong.key_history_phone(iType);
...
connected_h_phones_roxie := Suppress.MAC_SuppressSource(connected_h_phones_roxie_unsuppressed, mod_access, data_env := iType);
...
connected_h_phones_thor := Suppress.MAC_SuppressSource(connected_h_phones_thor_unsuppressed, mod_access, data_env := iType);
...
connected_w_phones_roxie := Suppress.MAC_SuppressSource(connected_w_phones_roxie_unsuppressed, mod_access, data_env := iType);
...
connected_w_phones_thor := Suppress.MAC_SuppressSource(connected_w_phones_thor_unsuppressed, mod_access, data_env := iType);
...
//TODO: choose less clumsy name?
Key_FCRA_Business_Header_Phone_Table_Filtered_V2 := dx_Gong.key_phone_table(iType);
