...
RoxieKeyBuild.MAC_build_logical(Prof_License_Mari.Key_Base_Delta_Rid(), Prof_License_Mari.Data_Key_Base_Delta_Rid, Prof_License_Mari.Names(filedate).i_base_delta_rid_super, Prof_License_Mari.Names(filedate).i_base_delta_rid_logical, bk_base_delta_rid);
...
RoxieKeyBuild.MAC_build_logical(Prof_License_Mari.Key_Intermediate_Delta_Rid(), Prof_License_Mari.Data_Key_Intermediate_Delta_Rid, Prof_License_Mari.Names(filedate).i_intermediate_delta_rid_super, Prof_License_Mari.Names(filedate).i_intermediate_delta_rid_logical, bk_intermediate_delta_rid);
RoxieKeyBuild.MAC_build_logical(Prof_License_Mari.Key_Midex_Did_Delta_Rid(), Prof_License_Mari.Data_Key_Midex_Did_Delta_Rid, Prof_License_Mari.Names(filedate).i_midex_did_delta_rid_super, Prof_License_Mari.Names(filedate).i_midex_did_delta_rid_logical, bk_midex_did_delta_rid);
...
Keys	:=	parallel(	key1, key2, key3, key4, key5, key6, key7, key8, key9, key10, key11, fcra_key1,
                        bk_base_delta_rid,bk_disciplinary_actions_delta_rid,bk_regulatory_actions_delta_rid,bk_individual_detail_delta_rid,bk_intermediate_delta_rid,bk_midex_did_delta_rid,bk_search_delta_rid);
...
//DF-28229 Build Delta_Rid keys for base files
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::base::delta_rid','D',mv_base_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::regulatory_actions::delta_rid','D',mv_regulatory_actions_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::disciplinary_actions::delta_rid','D',mv_disciplinary_actions_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::individual_detail::delta_rid','D',mv_individual_detail_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::intermediate::delta_rid','D',mv_intermediate_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::midex_did::delta_rid','D',mv_midex_did_delta_rid_to_qa,filedate,2);
RoxieKeyBuild.Mac_SK_Move_v3('~thor_data400::key::proflic_mari::@version@::search::delta_rid','D',mv_search_delta_rid_to_qa,filedate,2);
...
To_qa	:=	parallel(mv1_qa, mv2_qa, mv3_qa, mv4_qa, mv5_qa, mv6_qa, mv7_qa, mv8_qa, mv9_qa, mv10_qa, mv11_qa, mv1_qa_fcra,
                     mv_base_delta_rid_to_qa,mv_regulatory_actions_delta_rid_to_qa,mv_disciplinary_actions_delta_rid_to_qa,mv_individual_detail_delta_rid_to_qa,mv_intermediate_delta_rid_to_qa,mv_midex_did_delta_rid_to_qa,mv_search_delta_rid_to_qa);
