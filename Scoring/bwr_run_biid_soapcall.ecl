...
f := dataset('~eschepers::in::GE_Samp_BIID', pb1i_layout, csv(quote('"')));
...
roxieIP :='http://oroxievip.sc.seisint.com:9876'; 
...
// output(final,, '~thor_data50::out::biid_testing', overwrite);