IMPORT ut, RoxieKeyBuild, AutoKeyB2, PRTE2_UCC, PRTE2_Common, PRTE, _control;
...
RoxieKeyBuild.Mac_SK_BuildProcess_v2_Local(Keys.key_rmsid_party_linkids,Constants.KEY_PREFIX + 'party_rmsid_linkids',Constants.KEY_PREFIX + filedate +'::party_rmsid_linkids',party_linkids_key);
...
RoxieKeyBuild.Mac_SK_Move_To_Built_V2(Constants.KEY_PREFIX + '@version@::party_rmsid_linkids',Constants.KEY_PREFIX + filedate +'::party_rmsid_linkids',party_linkids_mv);
...
RoxieKeyBuild.Mac_SK_Move_V2(Constants.KEY_PREFIX + '@version@::party_rmsid_linkids','Q',party_linkids_mv_QA);
...
RoxieKeyBuild.Mac_SK_Move_V2(Constants.KEY_PREFIX + 'fcra::' + '@version@::did_w_type','Q', did_w_type_mv_QA_fcra);
	...
	updatedops   		 		:= PRTE.UpdateVersion('UCCV2Keys',filedate,_control.MyInfo.EmailAddressNormal,'B','N','N');
	updatedops_fcra  		:= PRTE.UpdateVersion('FCRA_UCCKeys',filedate,_control.MyInfo.EmailAddressNormal,'B','F','N');
...
build_keys := sequential(
													parallel(did_key, bdid_key, main_rmsid_key, party_rmsid_key, filing_number_key, rmsid_key,
																	did_w_type_key, bdid_w_type_key, linkids_key, party_linkids_key),
													...
													parallel(did_mv, bdid_mv, main_rmsid_mv, party_rmsid_mv, filing_number_mv, rmsid_mv,
																	did_w_type_mv, bdid_w_type_mv, linkids_mv, party_linkids_mv),
													...
													parallel(did_mv_QA, bdid_mv_QA, main_rmsid_mv_QA, party_rmsid_mv_QA, filing_number_mv_QA, rmsid_mv_QA,
																	did_w_type_mv_QA, bdid_w_type_mv_QA, linkids_mv_QA, party_linkids_mv_QA),
