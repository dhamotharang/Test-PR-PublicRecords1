import prof_licenseV2, riskwise, ut, risk_indicators, Prof_License_Mari;

export IndProfLic(DATASET(Layouts.AMLExecLayoutV2) ExecIds,
													 boolean isFCRA = false, 
													 string50 DataRestriction) := FUNCTION
...
Layout_PL_Plus PL_nonFCRA(ExecIds le, keyProfLicDID rt) := transform
