...
export AMLcommonFunction(grouped DATASET(risk_indicators.Layout_Output) with_did, 
							...
							boolean isFCRA=false, unsigned1 BSversion=50, 
...
with_hierarchy := Risk_Indicators.iid_append_address_hierarchy(with_header, isFCRA, bsversion);
...
with_best_addr := risk_indicators.iid_check_best(with_addr_history, with_ssn_flags, ExactMatchLevel, bsversion);
