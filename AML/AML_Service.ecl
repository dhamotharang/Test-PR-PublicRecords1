...
/* **********************************************
   ...
   **********************************************/
	...
	Industry_Search := Inquiry_AccLogs.Key_Inquiry_industry_use_vertical(FALSE)(s_company_id = CompanyID and s_product_id = (String)Risk_Reporting.ProductID.AML__AML_Service);
/* ************* End Scout Fields **************/
...
Deltabase_Logging_prep := project(FINAL, transform(Risk_Reporting.Layouts.LOG_Deltabase_Layout_Record,
																							 ...
																							 self.i_address := If(trim(search.Individual.address.streetaddress1)!='', search.Individual.address.streetaddress1,
																							 ...
																							 self.i_bus_name := If(search.Business.CompanyName <> '', search.Business.CompanyName, search.Business.AlternateCompanyName),
