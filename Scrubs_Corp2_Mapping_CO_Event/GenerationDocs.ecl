...
Command line options: -MScrubs_Corp2_Mapping_CO_Event -eC:\Users\butlersx\AppData\Local\Temp\TFR3C80.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_CO_Event
FILENAME:In_CO
...
FIELDTYPE:invalid_charter_no:ALLOW(0123456789):LENGTHS(1..)
...
FIELDTYPE:invalid_numericorblank:ALLOW( 0123456789)
...
FIELD:corp_sos_charter_nbr:TYPE(STRING32):LIKE(invalid_charter_no):0,0
FIELD:event_filing_reference_nbr:TYPE(STRING30):LIKE(invalid_numericorblank):0,0
