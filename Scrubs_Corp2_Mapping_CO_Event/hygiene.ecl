...
EXPORT hygiene(dataset(Corp2_Mapping.LayoutsCommon.Events) h) := MODULE
...
SHARED FldIds := DATASET([{1,'corp_key'}
      ...
      ,{29,'event_certification_number'}],SALT34.MAC_Character_Counts.Field_Identification);
