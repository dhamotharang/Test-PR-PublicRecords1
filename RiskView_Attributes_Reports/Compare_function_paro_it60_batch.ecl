EXPORT Compare_function_paro_it60_batch(current_dt,previous_dt) := functionmacro



file1:= dataset('~foreign::10.241.3.238::sghatti::out::paro_it60_batch_score_'+previous_dt, RiskView_Attributes_Reports.paro_it60_batch_layout,


 CSV(HEADING(single), QUOTE('"')));
file2:= dataset('~foreign::10.241.3.238::sghatti::out::paro_it60_batch_score_'+current_dt, RiskView_Attributes_Reports.paro_it60_batch_layout,
