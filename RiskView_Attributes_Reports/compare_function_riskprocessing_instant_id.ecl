EXPORT compare_function_riskprocessing_instant_id(current_dt,previous_dt) := functionmacro


riskprocessing_instant_id_layout:=RECORD
  string30 acctno;
  string12 did;
  string12 seq;
  string5 title;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::riskprocessing_instant_id_'+previous_dt, riskprocessing_instant_id_layout,


 CSV(HEADING(single), QUOTE('"')));

DS2:= dataset('~foreign::10.241.3.238::sghatti::out::riskprocessing_instant_id_'+current_dt, riskprocessing_instant_id_layout,
