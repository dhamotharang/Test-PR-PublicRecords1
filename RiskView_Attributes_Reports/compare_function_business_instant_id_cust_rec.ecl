EXPORT compare_function_business_instant_id_cust_rec(current_dt,previous_dt) := functionmacro
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::business_instant_id_cust_rec_'+previous_dt, layout,
...
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::business_instant_id_cust_rec_'+current_dt, layout,
