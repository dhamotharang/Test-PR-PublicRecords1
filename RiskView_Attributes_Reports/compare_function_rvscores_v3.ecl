EXPORT compare_function_rvscores_v3(current_dt,previous_dt) := functionmacro


 fcra_rvscores_v30_layout := RECORD
  string30 acctno;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::fcra_rvscores_v30_'+previous_dt, fcra_rvscores_v30_layout,


 CSV(HEADING(single), QUOTE('"')));
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::fcra_rvscores_v30_'+current_dt, fcra_rvscores_v30_layout,
