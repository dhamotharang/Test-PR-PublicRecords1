EXPORT compare_function_regional_acceptance_rva1008_1(current_dt,previous_dt) := functionmacro


regional_acceptance_rva1008_1_layout:=RECORD
  string30 acctno;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::regional_acceptance_rva1008_1_'+previous_dt, regional_acceptance_rva1008_1_layout,


 CSV(HEADING(single), QUOTE('"')));
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::regional_acceptance_rva1008_1_'+current_dt, regional_acceptance_rva1008_1_layout,
