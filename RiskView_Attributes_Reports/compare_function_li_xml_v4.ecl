EXPORT compare_function_li_xml_v4(current_dt,previous_dt) := functionmacro



 file1:= dataset('~foreign::10.241.3.238::sghatti::out::nonfcra_liattributes_v4_'+previous_dt, RiskView_Attributes_Reports.nonfcra_liattributes_v4_layout,


 CSV(HEADING(single), QUOTE('"')));

 file2:= dataset('~foreign::10.241.3.238::sghatti::out::nonfcra_liattributes_v4_'+current_dt, RiskView_Attributes_Reports.nonfcra_liattributes_v4_layout,
