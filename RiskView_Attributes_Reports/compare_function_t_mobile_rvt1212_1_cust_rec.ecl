EXPORT compare_function_t_mobile_rvt1212_1_cust_rec(current_dt,previous_dt) :=  functionmacro

 t_mobile_rvt1212_1_cust_rec_layout := RECORD
  string30 acctno;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::t_mobile_rvt1212_1_cust_rec_'+previous_dt, t_mobile_rvt1212_1_cust_rec_layout,


 CSV(HEADING(single), QUOTE('"')));
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::t_mobile_rvt1212_1_cust_rec_'+current_dt, t_mobile_rvt1212_1_cust_rec_layout,
