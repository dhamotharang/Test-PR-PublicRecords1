EXPORT compare_function_santander_rva1007_1(current_dt,previous_dt) := functionmacro


santander_rva1007_1_layout:=RECORD
  string30 acctno;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::santander_rva1007_1_'+previous_dt, santander_rva1007_1_layout,


 CSV(HEADING(single), QUOTE('"')));
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::santander_rva1007_1_'+current_dt, santander_rva1007_1_layout,
         	                                        ...
         	                                        left.field_name = right.field_name and
            									                      ...
            									                      // left.Count1 = right.Count1
      																							,transform(	compare_layout, 
																										self.file_version:='santander_rva1007_1',
																										self.mode:='xml',
