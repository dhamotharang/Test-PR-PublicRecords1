EXPORT Compare_function_paro_it61_batch(current_dt,previous_dt) := functionmacro



file1:= dataset('~foreign::10.241.3.238::sghatti::out::paro_it61_batch_score_'+previous_dt, RiskView_Attributes_Reports.paro_it61_batch_layout,


 CSV(HEADING(single), QUOTE('"')));
file2:= dataset('~foreign::10.241.3.238::sghatti::out::paro_it61_batch_score_'+current_dt, RiskView_Attributes_Reports.paro_it61_batch_layout,
     	 ...
     	 compare_result1:= join(result2_stats,result1_stats,
      	                                        ...
      	                                        left.field_name = right.field_name and
         									                      ...
         									                      // left.Count1 = right.Count1
   																							,transform(	compare_layout, self.file_version:='paro_it61',
																								                            self.mode:='batch',
