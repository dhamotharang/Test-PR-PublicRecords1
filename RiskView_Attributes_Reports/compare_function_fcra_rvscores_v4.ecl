EXPORT compare_function_fcra_rvscores_v4(current_dt,previous_dt) := functionmacro


fcra_rvscores_v0_layout:=RECORD
  string30 acctno;
...
DS1:= dataset('~foreign::10.241.3.238::sghatti::out::fcra_rvscores_v0_'+previous_dt, fcra_rvscores_v0_layout,


 CSV(HEADING(single), QUOTE('"')));
DS2:= dataset('~foreign::10.241.3.238::sghatti::out::fcra_rvscores_v0_'+current_dt, fcra_rvscores_v0_layout,
