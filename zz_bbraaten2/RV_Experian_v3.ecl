...
basefilename := '~scoringqa::out::fcra::riskview_xml_experian_attributes_v3_20160224_1';        // Can change xml to Batch
testfilename := '~scoringqa::out::fcra::riskview_xml_experian_attributes_v3_20160225_1';        
...
// ashirey.Diff(ds_baseline, ds_new, ['accountnumber'], j1, 'LIA4' );
 ...
 j1 := join(ds_join_baseline, ds_join_second, left.results.accountnumber = right.results.accountnumber
					...
					AND LEFT.results.num_nonderogs30 <> RIGHT.results.num_nonderogs30
					AND Left.results.did = ''
					AND right.results.did = '',
...
Scoring_Project_PIP.CROSSTAB_MACRO(clean_ds_baseline, clean_ds_new, ['AccountNumber'],'num_nonderogs30');
