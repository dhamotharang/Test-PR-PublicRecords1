/*2015-05-14T23:44:26Z (Karthik Reddy)
global layouts added and matched count logic added
*/
...
Address_History_2_standardized_land_use_code := Scoring_Project.MACRO_Populating_Value(pj, 'Address_History_2_standardized_land_use_code', 'Address_Verification-Address_History_2');	
...
Address_History_1_standardized_land_use_code := Scoring_Project.MACRO_Populating_Value(pj, 'Address_History_1_standardized_land_use_code', 'Address_Verification-Address_History_1');	
...
Input_Address_Information_standardized_land_use_code := Scoring_Project.MACRO_Populating_Value(pj, 'Input_Address_Information_standardized_land_use_code', 'Address_Verification-Input_Address_Information');	
...
ambiguous_property_owned_purchase_total := Scoring_Project.MACRO_distinct_values(pj, 'ambiguous_property_owned_purchase_total', 'Address_Verification-ambiguous');	
...
ambiguous_property_owned_assessed_total := Scoring_Project.MACRO_distinct_values(pj, 'ambiguous_property_owned_assessed_total', 'Address_Verification-ambiguous');	
...
Inquiries_Count24 := Scoring_Project.MACRO_Range_1_to_10(pj, 'Inquiries_Count24', 'acc_logs-Inquiries');	
Inquiries_Count12 := Scoring_Project.MACRO_Range_1_to_10(pj, 'Inquiries_Count12', 'acc_logs-Inquiries');	
Inquiries_Count06 := Scoring_Project.MACRO_Range_1_to_10(pj, 'Inquiries_Count06', 'acc_logs-Inquiries');	
Inquiries_Count03 := Scoring_Project.MACRO_Range_1_to_10(pj, 'Inquiries_Count03', 'acc_logs-Inquiries');	
Inquiries_Count01 := Scoring_Project.MACRO_Range_1_to_10(pj, 'Inquiries_Count01', 'acc_logs-Inquiries');	
...
ver_sources_last_seen_date := Scoring_Project.MACRO_Parsing_Text(pj, 'ver_sources_last_seen_date', 'header_summary');
...
Shell_input_age := Scoring_Project.MACRO_Range_10(pj, 'Shell_input_age', 'Shell_input');	
...
wphone10 := Scoring_Project.MACRO_distinct_values(pj, 'wphone10', 'Shell_input');	
...
DIDdeceasedlast := Scoring_Project.MACRO_distinct_values(pj, 'DIDdeceasedlast', 'iid');	
DIDdeceasedfirst := Scoring_Project.MACRO_distinct_values(pj, 'DIDdeceasedfirst', 'iid');	
DIDdeceasedDOB := Scoring_Project.MACRO_distinct_values(pj, 'DIDdeceasedDOB', 'iid');	
DIDdeceasedDate := Scoring_Project.MACRO_distinct_values(pj, 'DIDdeceasedDate', 'iid');	
...
email_domain_Free_ct := Scoring_Project.Macro_Range_5(pj, 'email_domain_Free_ct', 'email_summary');	
...
//Relatives
/*******************************************************************************************************************************************/
criminal_relative_withinOther := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'criminal_relative_withinOther', 'Relatives');
criminal_relative_within500miles := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'criminal_relative_within500miles', 'Relatives');
criminal_relative_within100miles := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'criminal_relative_within100miles', 'Relatives');
criminal_relative_within25miles := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'criminal_relative_within25miles', 'Relatives');
relative_felony_total := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'relative_felony_total', 'Relatives');
relative_felony_count := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'relative_felony_count', 'Relatives');
relative_criminal_total := Scoring_Project.MACRO_Range_100(pj, 'relative_criminal_total', 'Relatives');
relative_criminal_count := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'relative_criminal_count', 'Relatives');
relative_bankrupt_count := Scoring_Project.MACRO_Range_10(pj, 'relative_bankrupt_count', 'Relatives');
relative_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'relative_count', 'Relatives');
...
sold_relatives_property_owned_assessed_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'sold_relatives_property_owned_assessed_count', 'Relatives-Sold');
...
sold_relatives_property_owned_purchase_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'sold_relatives_property_owned_purchase_count', 'Relatives-Sold');
...
sold_relatives_property_total := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'sold_relatives_property_total', 'Relatives-Sold');
sold_relatives_property_count := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'sold_relatives_property_count', 'Relatives-Sold');

	relative_withinOther_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'relative_withinOther_count', 'Relatives');
relative_within500miles_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'relative_within500miles_count', 'Relatives');
relative_within100miles_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'relative_within100miles_count', 'Relatives');
relative_within25miles_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'relative_within25miles_count', 'Relatives');

ambiguous_relatives_property_owned_assessed_count := Scoring_Project.MACRO_Range_1_2_3_4_5(pj, 'ambiguous_relatives_property_owned_assessed_count', 'Relatives-Ambiguous');
ambiguous_relatives_property_owned_assessed_total := Scoring_Project.MACRO_Range_Dollar(pj, 'ambiguous_relatives_property_owned_assessed_total', 'Relatives-Ambiguous');
ambiguous_relatives_property_owned_purchase_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'ambiguous_relatives_property_owned_purchase_count', 'Relatives-Ambiguous');
ambiguous_relatives_property_owned_purchase_total := Scoring_Project.MACRO_Range_Dollar(pj, 'ambiguous_relatives_property_owned_purchase_total', 'Relatives-Ambiguous');
ambiguous_relatives_property_total := Scoring_Project.MACRO_Range_1_to_10(pj, 'ambiguous_relatives_property_total', 'Relatives-Ambiguous');
ambiguous_relatives_property_count := Scoring_Project.MACRO_Range_1_to_10(pj, 'ambiguous_relatives_property_count', 'Relatives-Ambiguous');
...
filing_count := Scoring_Project.MACRO_distinct_values(pj, 'filing_count', 'bjl');
...
liens_recent_unreleased_count := Scoring_Project.MACRO_distinct_values(pj, 'liens_recent_unreleased_count', 'bjl');

liens_historical_unreleased_count := Scoring_Project.MACRO_distinct_values(pj, 'liens_historical_unreleased_count', 'bjl');
...
liens_recent_released_count := Scoring_Project.MACRO_distinct_values(pj, 'liens_recent_released_count', 'bjl');
liens_historical_released_count := Scoring_Project.MACRO_distinct_values(pj, 'liens_historical_released_count', 'bjl');
...
criminal_count := Scoring_Project.MACRO_Range_5(pj, 'criminal_count', 'bjl');
...
felony_count := Scoring_Project.MACRO_distinct_values(pj, 'felony_count', 'bjl');
...
eviction_count60 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count60', 'bjl');
eviction_count36 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count36', 'bjl');
eviction_count24 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count24', 'bjl');
eviction_count12 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count12', 'bjl');
eviction_count180 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count180', 'bjl');
	eviction_count90 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count90', 'bjl');
eviction_count30 := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count30', 'bjl');
eviction_count := Scoring_Project.MACRO_distinct_values(pj, 'eviction_count', 'bjl');
...
imp_count := Scoring_Project.MACRO_distinct_values(pj, 'imp_count', 'Impulse');
...
addrs_per_adl := Scoring_Project.MACRO_Range_5(pj, 'addrs_per_adl', 'Velocity_Counters');
ssns_per_adl := Scoring_Project.MACRO_Range_5(pj, 'ssns_per_adl', 'Velocity_Counters');
...
Business_active_phone_ct := Scoring_Project.MACRO_distinct_values(pj, 'Business_active_phone_ct', 'Employment'  );
Dead_business_ct := Scoring_Project.MACRO_distinct_values(pj, 'Dead_business_ct', 'Employment'  );
...
address_history_advo_college_hit := Scoring_Project.MACRO_distinct_values(pj, 'address_history_advo_college_hit', 'address_history_summary' );
...
previous_addr_sources_recordcount := Scoring_Project.MACRO_distinct_values(pj, 'previous_addr_sources_recordcount', 'address_sources_summary');
previous_addr_sources_first_seen_date := Scoring_Project.Macro_Dates_Within_30(pj, 'previous_addr_sources_first_seen_date', 'address_sources_summary', 30);
previous_addr_sources := Scoring_Project.MACRO_distinct_values(pj, 'previous_addr_sources', 'address_sources_summary');
current_addr_sources_recordcount := Scoring_Project.MACRO_distinct_values(pj, 'current_addr_sources_recordcount', 'address_sources_summary');
current_addr_sources_first_seen_date := Scoring_Project.Macro_Dates_Within_30(pj, 'current_addr_sources_first_seen_date', 'address_sources_summary', 30);
current_addr_sources := Scoring_Project.MACRO_distinct_values(pj, 'current_addr_sources', 'address_sources_summary');
input_addr_sources_recordcount := Scoring_Project.MACRO_distinct_values(pj, 'input_addr_sources_recordcount', 'address_sources_summary');
input_addr_sources_first_seen_date := Scoring_Project.Macro_Dates_Within_30(pj, 'input_addr_sources_first_seen_date', 'address_sources_summary', 30);
input_addr_sources := Scoring_Project.MACRO_distinct_values(pj, 'input_addr_sources', 'address_sources_summary');
...
//rv_scores
/*******************************************************************************************************************************************/	
prescreenV4 := Scoring_Project.MACRO_distinct_values(pj, 'prescreenV4', 'rv_scores');
...
msbV4 := Scoring_Project.MACRO_distinct_values(pj, 'msbV4', 'rv_scores');
...
telecomV4 := Scoring_Project.MACRO_distinct_values(pj, 'telecomV4', 'rv_scores');
...
autoV4 := Scoring_Project.MACRO_distinct_values(pj, 'autoV4', 'rv_scores');
...
retailV4 := Scoring_Project.MACRO_distinct_values(pj, 'retailV4', 'rv_scores');
...
bankcardV4 := Scoring_Project.MACRO_distinct_values(pj, 'bankcardV4', 'rv_scores');
prescreenV3 := Scoring_Project.MACRO_distinct_values(pj, 'prescreenV3', 'rv_scores');
...
msbV3 := Scoring_Project.MACRO_distinct_values(pj, 'msbV3', 'rv_scores');
...
telecomV3 := Scoring_Project.MACRO_distinct_values(pj, 'telecomV3', 'rv_scores');
...
autoV3 := Scoring_Project.MACRO_distinct_values(pj, 'autoV3', 'rv_scores');
...
retailV3 := Scoring_Project.MACRO_distinct_values(pj, 'retailV3', 'rv_scores');
...
bankcardV3 := Scoring_Project.MACRO_distinct_values(pj, 'bankcardV3', 'rv_scores');
...
prescreenV2 := Scoring_Project.MACRO_distinct_values(pj, 'prescreenV2', 'rv_scores'); //ALL THESE ARE POPULATED AS BLANKS AS ON Feb 24, 2014
msbV2 := Scoring_Project.MACRO_distinct_values(pj, 'msbV2', 'rv_scores');
telecomV2 := Scoring_Project.MACRO_distinct_values(pj, 'telecomV2', 'rv_scores');
autoV2 := Scoring_Project.MACRO_distinct_values(pj, 'autoV2', 'rv_scores');
retailV2 := Scoring_Project.MACRO_distinct_values(pj, 'retailV2', 'rv_scores');
bankcardV2 := Scoring_Project.MACRO_distinct_values(pj, 'bankcardV2', 'rv_scores');
...
telecom := Scoring_Project.MACRO_distinct_values(pj, 'telecom', 'rv_scores');
auto := Scoring_Project.MACRO_distinct_values(pj, 'auto', 'rv_scores');
retail := Scoring_Project.MACRO_distinct_values(pj, 'retail', 'rv_scores');
bankcard := Scoring_Project.MACRO_distinct_values(pj, 'bankcard', 'rv_scores');
...
distance := Scoring_Project.MACRO_Populating_Value(pj, 'distance', 'Phone_Verification');
...
gong_did_phone_ct := Scoring_Project.MACRO_distinct_values(pj, 'gong_did_phone_ct', 'Phone_Verification');//waiting for Nathan's response
...
age := Scoring_Project.MACRO_Range_10(pj, 'age','Name_Verification');
...
attended_college := Scoring_Project.MACRO_distinct_values(pj, 'attended_college', 'attended_college');
 source_profile := Scoring_Project.MACRO_distinct_values(pj, 'source_profile', 'source_profile');
...
estimated_income := Scoring_Project.MACRO_Range_50000(pj, 'estimated_income', 'estimated_income');
inferred_age := Scoring_Project.MACRO_Range_10(pj, 'inferred_age', 'inferred_age');
lres := Scoring_Project.MACRO_Range_100(pj, 'lres', 'lres');
...
truedid := Scoring_Project.MACRO_distinct_values(pj, 'truedid', 'truedid');
 adlcategory := Scoring_Project.MACRO_distinct_values(pj, 'adlcategory', 'adlcategory');
