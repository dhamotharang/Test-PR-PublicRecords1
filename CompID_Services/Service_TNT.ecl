/*
2008-12-19 Sanjay Kumar Initial Version
*/
/*--SOAP--
<message name="Service_TNT">
...
Result := CompID_Services.Search_TNT.TNTBestAddressHistory(seq_value, ssn_value,  dob_value,  addr1_val,  addr2_val,  fname_val,
																													...
																													pname_value, name_value, min_score, maxrecordstoreturn, false); 

output(Result, named('CompId_TNT'));
