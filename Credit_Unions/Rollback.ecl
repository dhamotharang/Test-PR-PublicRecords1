...
module
	...
	export inputfiles	:= tools.mod_RollbackInput(pInputFilenames,pFilter,pDelete,pIsTesting);
	export buildfiles	:= tools.mod_RollbackBuild(pversion,pBuildFilenames,pFilter,pDelete,pIsTesting);
