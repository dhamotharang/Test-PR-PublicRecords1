  ...
  keyAssessmentFID := LN_PropertyV2.key_assessor_fid();
	...
	TRANSFORM		
		...
		TRANSFORM
			...
			SELF.Sale.MonthsSinceSaleDate      := IF((INTEGER)pInput.contract_date > (INTEGER)ut.GetDate or pInput.contract_date = '',
																								-1,
																								ut.DaysApart(ut.GetDate,pInput.contract_date) DIV 30);
