...
EXPORT Summary(SALT30.Str30Type txt,BOOLEAN Glob=TRUE) := FUNCTION
  SummaryLayout := RECORD
    ...
    maxlength_dppa_flag := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.dppa_flag)));
    avelength_dppa_flag := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.dppa_flag)),h.dppa_flag<>(typeof(h.dppa_flag))'');
    ...
    maxlength_orig_name_type_code := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_type_code)));
    avelength_orig_name_type_code := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_type_code)),h.orig_name_type_code<>(typeof(h.orig_name_type_code))'');
    ...
    maxlength_orig_name_type_description := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_type_description)));
    avelength_orig_name_type_description := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_type_description)),h.orig_name_type_description<>(typeof(h.orig_name_type_description))'');
    populated_orig_name_first_pcnt := AVE(GROUP,IF(h.orig_name_first = (TYPEOF(h.orig_name_first))'',0,100));
    maxlength_orig_name_first := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_first)));
    avelength_orig_name_first := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_first)),h.orig_name_first<>(typeof(h.orig_name_first))'');
    populated_orig_name_middle_pcnt := AVE(GROUP,IF(h.orig_name_middle = (TYPEOF(h.orig_name_middle))'',0,100));
    maxlength_orig_name_middle := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_middle)));
    avelength_orig_name_middle := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_middle)),h.orig_name_middle<>(typeof(h.orig_name_middle))'');
    populated_orig_name_last_pcnt := AVE(GROUP,IF(h.orig_name_last = (TYPEOF(h.orig_name_last))'',0,100));
    maxlength_orig_name_last := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_last)));
    avelength_orig_name_last := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_name_last)),h.orig_name_last<>(typeof(h.orig_name_last))'');
    ...
    maxlength_orig_address_1 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_address_1)));
    avelength_orig_address_1 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_address_1)),h.orig_address_1<>(typeof(h.orig_address_1))'');
    populated_orig_address_2_pcnt := AVE(GROUP,IF(h.orig_address_2 = (TYPEOF(h.orig_address_2))'',0,100));
    maxlength_orig_address_2 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_address_2)));
    avelength_orig_address_2 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_address_2)),h.orig_address_2<>(typeof(h.orig_address_2))'');
    ...
    maxlength_orig_fips := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_fips)));
    avelength_orig_fips := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_fips)),h.orig_fips<>(typeof(h.orig_fips))'');
    populated_orig_province_pcnt := AVE(GROUP,IF(h.orig_province = (TYPEOF(h.orig_province))'',0,100));
    maxlength_orig_province := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_province)));
    avelength_orig_province := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_province)),h.orig_province<>(typeof(h.orig_province))'');
    ...
    maxlength_orig_ssn := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_ssn)));
    avelength_orig_ssn := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_ssn)),h.orig_ssn<>(typeof(h.orig_ssn))'');
    populated_orig_fein_pcnt := AVE(GROUP,IF(h.orig_fein = (TYPEOF(h.orig_fein))'',0,100));
    maxlength_orig_fein := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_fein)));
    avelength_orig_fein := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.orig_fein)),h.orig_fein<>(typeof(h.orig_fein))'');
    ...
    maxlength_phone_1 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.phone_1)));
    avelength_phone_1 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.phone_1)),h.phone_1<>(typeof(h.phone_1))'');
    populated_phone_2_pcnt := AVE(GROUP,IF(h.phone_2 = (TYPEOF(h.phone_2))'',0,100));
    maxlength_phone_2 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.phone_2)));
    avelength_phone_2 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.phone_2)),h.phone_2<>(typeof(h.phone_2))'');
    ...
    maxlength_name_cleaning_score := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.name_cleaning_score)));
    avelength_name_cleaning_score := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.name_cleaning_score)),h.name_cleaning_score<>(typeof(h.name_cleaning_score))'');
    ...
    maxlength_reg_owner_name_2 := MAX(GROUP,LENGTH(TRIM((SALT30.StrType)h.reg_owner_name_2)));
    avelength_reg_owner_name_2 := AVE(GROUP,LENGTH(TRIM((SALT30.StrType)h.reg_owner_name_2)),h.reg_owner_name_2<>(typeof(h.reg_owner_name_2))'');
...
SALT30.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  ...
  SELF.Fld := TRIM(CHOOSE(C,TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.watercraft_key),TRIM((SALT30.StrType)le.sequence_key),TRIM((SALT30.StrType)le.state_origin),TRIM((SALT30.StrType)le.source_code),TRIM((SALT30.StrType)le.dppa_flag),TRIM((SALT30.StrType)le.orig_name),TRIM((SALT30.StrType)le.orig_name_type_code),TRIM((SALT30.StrType)le.orig_name_type_description),TRIM((SALT30.StrType)le.orig_name_first),TRIM((SALT30.StrType)le.orig_name_middle),TRIM((SALT30.StrType)le.orig_name_last),TRIM((SALT30.StrType)le.orig_name_suffix),TRIM((SALT30.StrType)le.orig_address_1),TRIM((SALT30.StrType)le.orig_address_2),TRIM((SALT30.StrType)le.orig_city),TRIM((SALT30.StrType)le.orig_state),TRIM((SALT30.StrType)le.orig_zip),TRIM((SALT30.StrType)le.orig_fips),TRIM((SALT30.StrType)le.orig_province),TRIM((SALT30.StrType)le.orig_country),TRIM((SALT30.StrType)le.dob),TRIM((SALT30.StrType)le.orig_ssn),TRIM((SALT30.StrType)le.orig_fein),TRIM((SALT30.StrType)le.gender),TRIM((SALT30.StrType)le.phone_1),TRIM((SALT30.StrType)le.phone_2),TRIM((SALT30.StrType)le.title),TRIM((SALT30.StrType)le.fname),TRIM((SALT30.StrType)le.mname),TRIM((SALT30.StrType)le.lname),TRIM((SALT30.StrType)le.name_suffix),TRIM((SALT30.StrType)le.name_cleaning_score),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip5),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dpbc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.ace_fips_st),TRIM((SALT30.StrType)le.ace_fips_county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.bdid),TRIM((SALT30.StrType)le.fein),TRIM((SALT30.StrType)le.did),TRIM((SALT30.StrType)le.did_score),TRIM((SALT30.StrType)le.ssn),TRIM((SALT30.StrType)le.history_flag),TRIM((SALT30.StrType)le.rawaid),TRIM((SALT30.StrType)le.reg_owner_name_2),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_rec_id),TRIM((SALT30.StrType)le.dotscore),TRIM((SALT30.StrType)le.dotweight),TRIM((SALT30.StrType)le.empid),TRIM((SALT30.StrType)le.empscore),TRIM((SALT30.StrType)le.empweight),TRIM((SALT30.StrType)le.powid),TRIM((SALT30.StrType)le.powscore),TRIM((SALT30.StrType)le.powweight),TRIM((SALT30.StrType)le.proxid),TRIM((SALT30.StrType)le.proxscore),TRIM((SALT30.StrType)le.proxweight),TRIM((SALT30.StrType)le.seleid),TRIM((SALT30.StrType)le.selescore),TRIM((SALT30.StrType)le.seleweight),TRIM((SALT30.StrType)le.orgid),TRIM((SALT30.StrType)le.orgscore),TRIM((SALT30.StrType)le.orgweight),TRIM((SALT30.StrType)le.ultid),TRIM((SALT30.StrType)le.ultscore),TRIM((SALT30.StrType)le.ultweight)));
  SELF.FldNo := C;
END;
...
SALT30.MAC_Correlate.Data_Layout IntoP(h le,UNSIGNED C) := TRANSFORM
  SELF.FldNo1 := 1 + (C / 95);
  SELF.FldNo2 := 1 + (C % 95);
  SELF.Fld1 := TRIM(CHOOSE(SELF.FldNo1,TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.watercraft_key),TRIM((SALT30.StrType)le.sequence_key),TRIM((SALT30.StrType)le.state_origin),TRIM((SALT30.StrType)le.source_code),TRIM((SALT30.StrType)le.dppa_flag),TRIM((SALT30.StrType)le.orig_name),TRIM((SALT30.StrType)le.orig_name_type_code),TRIM((SALT30.StrType)le.orig_name_type_description),TRIM((SALT30.StrType)le.orig_name_first),TRIM((SALT30.StrType)le.orig_name_middle),TRIM((SALT30.StrType)le.orig_name_last),TRIM((SALT30.StrType)le.orig_name_suffix),TRIM((SALT30.StrType)le.orig_address_1),TRIM((SALT30.StrType)le.orig_address_2),TRIM((SALT30.StrType)le.orig_city),TRIM((SALT30.StrType)le.orig_state),TRIM((SALT30.StrType)le.orig_zip),TRIM((SALT30.StrType)le.orig_fips),TRIM((SALT30.StrType)le.orig_province),TRIM((SALT30.StrType)le.orig_country),TRIM((SALT30.StrType)le.dob),TRIM((SALT30.StrType)le.orig_ssn),TRIM((SALT30.StrType)le.orig_fein),TRIM((SALT30.StrType)le.gender),TRIM((SALT30.StrType)le.phone_1),TRIM((SALT30.StrType)le.phone_2),TRIM((SALT30.StrType)le.title),TRIM((SALT30.StrType)le.fname),TRIM((SALT30.StrType)le.mname),TRIM((SALT30.StrType)le.lname),TRIM((SALT30.StrType)le.name_suffix),TRIM((SALT30.StrType)le.name_cleaning_score),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip5),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dpbc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.ace_fips_st),TRIM((SALT30.StrType)le.ace_fips_county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.bdid),TRIM((SALT30.StrType)le.fein),TRIM((SALT30.StrType)le.did),TRIM((SALT30.StrType)le.did_score),TRIM((SALT30.StrType)le.ssn),TRIM((SALT30.StrType)le.history_flag),TRIM((SALT30.StrType)le.rawaid),TRIM((SALT30.StrType)le.reg_owner_name_2),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_rec_id),TRIM((SALT30.StrType)le.dotscore),TRIM((SALT30.StrType)le.dotweight),TRIM((SALT30.StrType)le.empid),TRIM((SALT30.StrType)le.empscore),TRIM((SALT30.StrType)le.empweight),TRIM((SALT30.StrType)le.powid),TRIM((SALT30.StrType)le.powscore),TRIM((SALT30.StrType)le.powweight),TRIM((SALT30.StrType)le.proxid),TRIM((SALT30.StrType)le.proxscore),TRIM((SALT30.StrType)le.proxweight),TRIM((SALT30.StrType)le.seleid),TRIM((SALT30.StrType)le.selescore),TRIM((SALT30.StrType)le.seleweight),TRIM((SALT30.StrType)le.orgid),TRIM((SALT30.StrType)le.orgscore),TRIM((SALT30.StrType)le.orgweight),TRIM((SALT30.StrType)le.ultid),TRIM((SALT30.StrType)le.ultscore),TRIM((SALT30.StrType)le.ultweight)));
  SELF.Fld2 := TRIM(CHOOSE(SELF.FldNo2,TRIM((SALT30.StrType)le.date_first_seen),TRIM((SALT30.StrType)le.date_last_seen),TRIM((SALT30.StrType)le.date_vendor_first_reported),TRIM((SALT30.StrType)le.date_vendor_last_reported),TRIM((SALT30.StrType)le.watercraft_key),TRIM((SALT30.StrType)le.sequence_key),TRIM((SALT30.StrType)le.state_origin),TRIM((SALT30.StrType)le.source_code),TRIM((SALT30.StrType)le.dppa_flag),TRIM((SALT30.StrType)le.orig_name),TRIM((SALT30.StrType)le.orig_name_type_code),TRIM((SALT30.StrType)le.orig_name_type_description),TRIM((SALT30.StrType)le.orig_name_first),TRIM((SALT30.StrType)le.orig_name_middle),TRIM((SALT30.StrType)le.orig_name_last),TRIM((SALT30.StrType)le.orig_name_suffix),TRIM((SALT30.StrType)le.orig_address_1),TRIM((SALT30.StrType)le.orig_address_2),TRIM((SALT30.StrType)le.orig_city),TRIM((SALT30.StrType)le.orig_state),TRIM((SALT30.StrType)le.orig_zip),TRIM((SALT30.StrType)le.orig_fips),TRIM((SALT30.StrType)le.orig_province),TRIM((SALT30.StrType)le.orig_country),TRIM((SALT30.StrType)le.dob),TRIM((SALT30.StrType)le.orig_ssn),TRIM((SALT30.StrType)le.orig_fein),TRIM((SALT30.StrType)le.gender),TRIM((SALT30.StrType)le.phone_1),TRIM((SALT30.StrType)le.phone_2),TRIM((SALT30.StrType)le.title),TRIM((SALT30.StrType)le.fname),TRIM((SALT30.StrType)le.mname),TRIM((SALT30.StrType)le.lname),TRIM((SALT30.StrType)le.name_suffix),TRIM((SALT30.StrType)le.name_cleaning_score),TRIM((SALT30.StrType)le.company_name),TRIM((SALT30.StrType)le.prim_range),TRIM((SALT30.StrType)le.predir),TRIM((SALT30.StrType)le.prim_name),TRIM((SALT30.StrType)le.suffix),TRIM((SALT30.StrType)le.postdir),TRIM((SALT30.StrType)le.unit_desig),TRIM((SALT30.StrType)le.sec_range),TRIM((SALT30.StrType)le.p_city_name),TRIM((SALT30.StrType)le.v_city_name),TRIM((SALT30.StrType)le.st),TRIM((SALT30.StrType)le.zip5),TRIM((SALT30.StrType)le.zip4),TRIM((SALT30.StrType)le.county),TRIM((SALT30.StrType)le.cart),TRIM((SALT30.StrType)le.cr_sort_sz),TRIM((SALT30.StrType)le.lot),TRIM((SALT30.StrType)le.lot_order),TRIM((SALT30.StrType)le.dpbc),TRIM((SALT30.StrType)le.chk_digit),TRIM((SALT30.StrType)le.rec_type),TRIM((SALT30.StrType)le.ace_fips_st),TRIM((SALT30.StrType)le.ace_fips_county),TRIM((SALT30.StrType)le.geo_lat),TRIM((SALT30.StrType)le.geo_long),TRIM((SALT30.StrType)le.msa),TRIM((SALT30.StrType)le.geo_blk),TRIM((SALT30.StrType)le.geo_match),TRIM((SALT30.StrType)le.err_stat),TRIM((SALT30.StrType)le.bdid),TRIM((SALT30.StrType)le.fein),TRIM((SALT30.StrType)le.did),TRIM((SALT30.StrType)le.did_score),TRIM((SALT30.StrType)le.ssn),TRIM((SALT30.StrType)le.history_flag),TRIM((SALT30.StrType)le.rawaid),TRIM((SALT30.StrType)le.reg_owner_name_2),TRIM((SALT30.StrType)le.persistent_record_id),TRIM((SALT30.StrType)le.source_rec_id),TRIM((SALT30.StrType)le.dotscore),TRIM((SALT30.StrType)le.dotweight),TRIM((SALT30.StrType)le.empid),TRIM((SALT30.StrType)le.empscore),TRIM((SALT30.StrType)le.empweight),TRIM((SALT30.StrType)le.powid),TRIM((SALT30.StrType)le.powscore),TRIM((SALT30.StrType)le.powweight),TRIM((SALT30.StrType)le.proxid),TRIM((SALT30.StrType)le.proxscore),TRIM((SALT30.StrType)le.proxweight),TRIM((SALT30.StrType)le.seleid),TRIM((SALT30.StrType)le.selescore),TRIM((SALT30.StrType)le.seleweight),TRIM((SALT30.StrType)le.orgid),TRIM((SALT30.StrType)le.orgscore),TRIM((SALT30.StrType)le.orgweight),TRIM((SALT30.StrType)le.ultid),TRIM((SALT30.StrType)le.ultscore),TRIM((SALT30.StrType)le.ultweight)));
  END;
...
SHARED FldIds := DATASET([{1,'date_first_seen'}
      ...
      ,{93,'ultid'}
      ,{94,'ultscore'}
      ,{95,'ultweight'}],SALT30.MAC_Character_Counts.Field_Identification);
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_dppa_flag((SALT30.StrType)le.dppa_flag),
    Fields.InValid_orig_name((SALT30.StrType)le.orig_name),
    Fields.InValid_orig_name_type_code((SALT30.StrType)le.orig_name_type_code),
    Fields.InValid_orig_name_type_description((SALT30.StrType)le.orig_name_type_description),
    Fields.InValid_orig_name_first((SALT30.StrType)le.orig_name_first),
    Fields.InValid_orig_name_middle((SALT30.StrType)le.orig_name_middle),
    Fields.InValid_orig_name_last((SALT30.StrType)le.orig_name_last),
    Fields.InValid_orig_name_suffix((SALT30.StrType)le.orig_name_suffix),
    Fields.InValid_orig_address_1((SALT30.StrType)le.orig_address_1),
    Fields.InValid_orig_address_2((SALT30.StrType)le.orig_address_2),
    ...
    Fields.InValid_orig_fips((SALT30.StrType)le.orig_fips),
    Fields.InValid_orig_province((SALT30.StrType)le.orig_province),
    Fields.InValid_orig_country((SALT30.StrType)le.orig_country),
    Fields.InValid_dob((SALT30.StrType)le.dob),
    Fields.InValid_orig_ssn((SALT30.StrType)le.orig_ssn),
    Fields.InValid_orig_fein((SALT30.StrType)le.orig_fein),
    Fields.InValid_gender((SALT30.StrType)le.gender),
    Fields.InValid_phone_1((SALT30.StrType)le.phone_1),
    Fields.InValid_phone_2((SALT30.StrType)le.phone_2),
    ...
    Fields.InValid_name_cleaning_score((SALT30.StrType)le.name_cleaning_score),
    ...
    Fields.InValid_reg_owner_name_2((SALT30.StrType)le.reg_owner_name_2),
