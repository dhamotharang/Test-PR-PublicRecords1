...
// The module to handle the case where no scrubs exist
  EXPORT NumRules := 395;
  EXPORT NumRulesFromFieldType := 395;
  EXPORT NumRulesFromRecordType := 0;
  EXPORT NumFieldsWithRules := 385;
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ...
          ,HVCCW_Fields.InvalidMessage_vendor_id(1)
...
EXPORT FromNone(DATASET(HVCCW_Layout_eMerges) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.vendor_id_Invalid := HVCCW_Fields.InValid_vendor_id((SALT311.StrType)le.vendor_id);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.append_seqnum_Invalid << 0 ) + ( le.persistent_record_id_Invalid << 1 ) + ( le.process_date_Invalid << 2 ) + ( le.date_first_seen_Invalid << 3 ) + ( le.date_last_seen_Invalid << 4 ) + ( le.score_Invalid << 5 ) + ( le.best_ssn_Invalid << 6 ) + ( le.did_out_Invalid << 7 ) + ( le.source_Invalid << 8 ) + ( le.file_id_Invalid << 9 ) + ( le.vendor_id_Invalid << 10 ) + ( le.source_state_Invalid << 11 ) + ( le.source_code_Invalid << 12 ) + ( le.file_acquired_date_Invalid << 13 ) + ( le._use_Invalid << 14 ) + ( le.title_in_Invalid << 15 ) + ( le.lname_in_Invalid << 16 ) + ( le.fname_in_Invalid << 17 ) + ( le.mname_in_Invalid << 18 ) + ( le.maiden_prior_Invalid << 19 ) + ( le.name_suffix_in_Invalid << 20 ) + ( le.source_voterid_Invalid << 21 ) + ( le.dob_str_in_Invalid << 22 ) + ( le.agecat_Invalid << 23 ) + ( le.headhousehold_Invalid << 24 ) + ( le.place_of_birth_Invalid << 25 ) + ( le.occupation_Invalid << 26 ) + ( le.maiden_name_Invalid << 27 ) + ( le.motorvoterid_Invalid << 28 ) + ( le.regsource_Invalid << 29 ) + ( le.regdate_in_Invalid << 30 ) + ( le.race_Invalid << 31 ) + ( le.gender_Invalid << 32 ) + ( le.poliparty_Invalid << 33 ) + ( le.phone_Invalid << 34 ) + ( le.work_phone_Invalid << 35 ) + ( le.other_phone_Invalid << 36 ) + ( le.active_status_Invalid << 37 ) + ( le.active_other_Invalid << 38 ) + ( le.voterstatus_Invalid << 39 ) + ( le.resaddr1_Invalid << 40 ) + ( le.resaddr2_Invalid << 41 ) + ( le.res_city_Invalid << 42 ) + ( le.res_state_Invalid << 43 ) + ( le.res_zip_Invalid << 44 ) + ( le.res_county_Invalid << 45 ) + ( le.mail_addr1_Invalid << 46 ) + ( le.mail_addr2_Invalid << 47 ) + ( le.mail_city_Invalid << 48 ) + ( le.mail_state_Invalid << 49 ) + ( le.mail_zip_Invalid << 51 ) + ( le.mail_county_Invalid << 52 ) + ( le.towncode_Invalid << 53 ) + ( le.distcode_Invalid << 54 ) + ( le.countycode_Invalid << 55 ) + ( le.schoolcode_Invalid << 56 ) + ( le.cityinout_Invalid << 57 ) + ( le.spec_dist1_Invalid << 58 ) + ( le.spec_dist2_Invalid << 59 ) + ( le.precinct1_Invalid << 60 ) + ( le.precinct2_Invalid << 61 ) + ( le.precinct3_Invalid << 62 ) + ( le.villageprecinct_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.schoolprecinct_Invalid << 0 ) + ( le.ward_Invalid << 1 ) + ( le.precinct_citytown_Invalid << 2 ) + ( le.ancsmdindc_Invalid << 3 ) + ( le.citycouncildist_Invalid << 4 ) + ( le.countycommdist_Invalid << 5 ) + ( le.statehouse_Invalid << 6 ) + ( le.statesenate_Invalid << 7 ) + ( le.ushouse_Invalid << 8 ) + ( le.elemschooldist_Invalid << 9 ) + ( le.schooldist_Invalid << 10 ) + ( le.commcolldist_Invalid << 11 ) + ( le.municipal_Invalid << 12 ) + ( le.villagedist_Invalid << 13 ) + ( le.policejury_Invalid << 14 ) + ( le.policedist_Invalid << 15 ) + ( le.publicservcomm_Invalid << 16 ) + ( le.rescue_Invalid << 17 ) + ( le.fire_Invalid << 18 ) + ( le.sanitary_Invalid << 19 ) + ( le.sewerdist_Invalid << 20 ) + ( le.waterdist_Invalid << 21 ) + ( le.mosquitodist_Invalid << 22 ) + ( le.taxdist_Invalid << 23 ) + ( le.supremecourt_Invalid << 24 ) + ( le.justiceofpeace_Invalid << 25 ) + ( le.judicialdist_Invalid << 26 ) + ( le.superiorctdist_Invalid << 27 ) + ( le.appealsct_Invalid << 28 ) + ( le.contributorparty_Invalid << 29 ) + ( le.recptparty_Invalid << 30 ) + ( le.dateofcontr_in_Invalid << 31 ) + ( le.dollaramt_Invalid << 32 ) + ( le.officecontto_Invalid << 33 ) + ( le.cumuldollaramt_Invalid << 34 ) + ( le.conttype_Invalid << 35 ) + ( le.primary02_Invalid << 36 ) + ( le.special02_Invalid << 37 ) + ( le.other02_Invalid << 38 ) + ( le.special202_Invalid << 39 ) + ( le.general02_Invalid << 40 ) + ( le.primary01_Invalid << 41 ) + ( le.special01_Invalid << 42 ) + ( le.other01_Invalid << 43 ) + ( le.special201_Invalid << 44 ) + ( le.general01_Invalid << 45 ) + ( le.pres00_Invalid << 46 ) + ( le.primary00_Invalid << 47 ) + ( le.special00_Invalid << 48 ) + ( le.other00_Invalid << 49 ) + ( le.special200_Invalid << 50 ) + ( le.general00_Invalid << 51 ) + ( le.primary99_Invalid << 52 ) + ( le.special99_Invalid << 53 ) + ( le.other99_Invalid << 54 ) + ( le.special299_Invalid << 55 ) + ( le.general99_Invalid << 56 ) + ( le.primary98_Invalid << 57 ) + ( le.special98_Invalid << 58 ) + ( le.other98_Invalid << 59 ) + ( le.special298_Invalid << 60 ) + ( le.general98_Invalid << 61 ) + ( le.primary97_Invalid << 62 ) + ( le.special97_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.other97_Invalid << 0 ) + ( le.special297_Invalid << 1 ) + ( le.general97_Invalid << 2 ) + ( le.pres96_Invalid << 3 ) + ( le.primary96_Invalid << 4 ) + ( le.special96_Invalid << 5 ) + ( le.other96_Invalid << 6 ) + ( le.special296_Invalid << 7 ) + ( le.general96_Invalid << 8 ) + ( le.lastdayvote_in_Invalid << 9 ) + ( le.huntfishperm_Invalid << 10 ) + ( le.datelicense_in_Invalid << 11 ) + ( le.homestate_Invalid << 12 ) + ( le.resident_Invalid << 13 ) + ( le.nonresident_Invalid << 14 ) + ( le.hunt_Invalid << 15 ) + ( le.fish_Invalid << 16 ) + ( le.combosuper_Invalid << 17 ) + ( le.sportsman_Invalid << 18 ) + ( le.trap_Invalid << 19 ) + ( le.archery_Invalid << 20 ) + ( le.muzzle_Invalid << 21 ) + ( le.drawing_Invalid << 22 ) + ( le.day1_Invalid << 23 ) + ( le.day3_Invalid << 24 ) + ( le.day7_Invalid << 25 ) + ( le.day14to15_Invalid << 26 ) + ( le.seasonannual_Invalid << 27 ) + ( le.lifetimepermit_Invalid << 28 ) + ( le.landowner_Invalid << 29 ) + ( le.family_Invalid << 30 ) + ( le.junior_Invalid << 31 ) + ( le.seniorcit_Invalid << 32 ) + ( le.crewmemeber_Invalid << 33 ) + ( le.retarded_Invalid << 34 ) + ( le.indian_Invalid << 35 ) + ( le.serviceman_Invalid << 36 ) + ( le.disabled_Invalid << 37 ) + ( le.lowincome_Invalid << 38 ) + ( le.regioncounty_Invalid << 39 ) + ( le.blind_Invalid << 40 ) + ( le.salmon_Invalid << 41 ) + ( le.freshwater_Invalid << 42 ) + ( le.saltwater_Invalid << 43 ) + ( le.lakesandresevoirs_Invalid << 44 ) + ( le.setlinefish_Invalid << 45 ) + ( le.trout_Invalid << 46 ) + ( le.fallfishing_Invalid << 47 ) + ( le.steelhead_Invalid << 48 ) + ( le.whitejubherring_Invalid << 49 ) + ( le.sturgeon_Invalid << 50 ) + ( le.shellfishcrab_Invalid << 51 ) + ( le.shellfishlobster_Invalid << 52 ) + ( le.deer_Invalid << 53 ) + ( le.bear_Invalid << 54 ) + ( le.elk_Invalid << 55 ) + ( le.moose_Invalid << 56 ) + ( le.buffalo_Invalid << 57 ) + ( le.antelope_Invalid << 58 ) + ( le.sikebull_Invalid << 59 ) + ( le.bighorn_Invalid << 60 ) + ( le.javelina_Invalid << 61 ) + ( le.cougar_Invalid << 62 ) + ( le.anterless_Invalid << 63 );
    SELF.ScrubsBits4 := ( le.pheasant_Invalid << 0 ) + ( le.goose_Invalid << 1 ) + ( le.duck_Invalid << 2 ) + ( le.turkey_Invalid << 3 ) + ( le.snowmobile_Invalid << 4 ) + ( le.biggame_Invalid << 5 ) + ( le.skipass_Invalid << 6 ) + ( le.migbird_Invalid << 7 ) + ( le.smallgame_Invalid << 8 ) + ( le.sturgeon2_Invalid << 9 ) + ( le.gun_Invalid << 10 ) + ( le.bonus_Invalid << 11 ) + ( le.lottery_Invalid << 12 ) + ( le.otherbirds_Invalid << 13 ) + ( le.boatindexnum_Invalid << 14 ) + ( le.boatcoowner_Invalid << 15 ) + ( le.hullidnum_Invalid << 16 ) + ( le.yearmade_Invalid << 17 ) + ( le.model_Invalid << 18 ) + ( le.manufacturer_Invalid << 19 ) + ( le.lengt_Invalid << 20 ) + ( le.hullconstruct_Invalid << 21 ) + ( le.primuse_Invalid << 22 ) + ( le.fueltype_Invalid << 23 ) + ( le.propulsion_Invalid << 24 ) + ( le.modeltype_Invalid << 25 ) + ( le.regexpdate_in_Invalid << 26 ) + ( le.titlenum_Invalid << 27 ) + ( le.stprimuse_Invalid << 28 ) + ( le.titlestatus_Invalid << 29 ) + ( le.vessel_Invalid << 30 ) + ( le.specreg_Invalid << 31 ) + ( le.ccwpermnum_Invalid << 32 ) + ( le.ccwweapontype_Invalid << 33 ) + ( le.ccwregdate_in_Invalid << 34 ) + ( le.ccwexpdate_in_Invalid << 35 ) + ( le.ccwpermtype_Invalid << 36 ) + ( le.dob_str_Invalid << 37 ) + ( le.regdate_Invalid << 38 ) + ( le.dateofcontr_Invalid << 39 ) + ( le.lastdayvote_Invalid << 40 ) + ( le.datelicense_Invalid << 41 ) + ( le.regexpdate_Invalid << 42 ) + ( le.ccwregdate_Invalid << 43 ) + ( le.ccwexpdate_Invalid << 44 ) + ( le.title_Invalid << 45 ) + ( le.fname_Invalid << 46 ) + ( le.mname_Invalid << 47 ) + ( le.lname_Invalid << 48 ) + ( le.name_suffix_Invalid << 49 ) + ( le.score_on_input_Invalid << 50 ) + ( le.append_prep_resaddress1_Invalid << 51 ) + ( le.append_prep_resaddress2_Invalid << 52 ) + ( le.append_resrawaid_Invalid << 53 ) + ( le.append_prep_mailaddress1_Invalid << 54 ) + ( le.append_prep_mailaddress2_Invalid << 55 ) + ( le.append_mailrawaid_Invalid << 56 ) + ( le.append_prep_cassaddress1_Invalid << 57 ) + ( le.append_prep_cassaddress2_Invalid << 58 ) + ( le.append_cassrawaid_Invalid << 59 ) + ( le.aid_resclean_prim_range_Invalid << 60 ) + ( le.aid_resclean_predir_Invalid << 61 ) + ( le.aid_resclean_prim_name_Invalid << 62 ) + ( le.aid_resclean_addr_suffix_Invalid << 63 );
    SELF.ScrubsBits5 := ( le.aid_resclean_postdir_Invalid << 0 ) + ( le.aid_resclean_unit_desig_Invalid << 1 ) + ( le.aid_resclean_sec_range_Invalid << 2 ) + ( le.aid_resclean_p_city_name_Invalid << 3 ) + ( le.aid_resclean_v_city_name_Invalid << 4 ) + ( le.aid_resclean_st_Invalid << 5 ) + ( le.aid_resclean_zip_Invalid << 7 ) + ( le.aid_resclean_zip4_Invalid << 9 ) + ( le.aid_resclean_cart_Invalid << 10 ) + ( le.aid_resclean_cr_sort_sz_Invalid << 11 ) + ( le.aid_resclean_lot_Invalid << 12 ) + ( le.aid_resclean_lot_order_Invalid << 13 ) + ( le.aid_resclean_dpbc_Invalid << 14 ) + ( le.aid_resclean_chk_digit_Invalid << 15 ) + ( le.aid_resclean_record_type_Invalid << 16 ) + ( le.aid_resclean_ace_fips_st_Invalid << 17 ) + ( le.aid_resclean_fipscounty_Invalid << 18 ) + ( le.aid_resclean_geo_lat_Invalid << 19 ) + ( le.aid_resclean_geo_long_Invalid << 20 ) + ( le.aid_resclean_msa_Invalid << 21 ) + ( le.aid_resclean_geo_blk_Invalid << 22 ) + ( le.aid_resclean_geo_match_Invalid << 23 ) + ( le.aid_resclean_err_stat_Invalid << 24 ) + ( le.aid_mailclean_prim_range_Invalid << 25 ) + ( le.aid_mailclean_predir_Invalid << 26 ) + ( le.aid_mailclean_prim_name_Invalid << 27 ) + ( le.aid_mailclean_addr_suffix_Invalid << 28 ) + ( le.aid_mailclean_postdir_Invalid << 29 ) + ( le.aid_mailclean_unit_desig_Invalid << 30 ) + ( le.aid_mailclean_sec_range_Invalid << 31 ) + ( le.aid_mailclean_p_city_name_Invalid << 32 ) + ( le.aid_mailclean_v_city_name_Invalid << 33 ) + ( le.aid_mailclean_st_Invalid << 34 ) + ( le.aid_mailclean_zip_Invalid << 36 ) + ( le.aid_mailclean_zip4_Invalid << 38 ) + ( le.aid_mailclean_cart_Invalid << 39 ) + ( le.aid_mailclean_cr_sort_sz_Invalid << 40 ) + ( le.aid_mailclean_lot_Invalid << 41 ) + ( le.aid_mailclean_lot_order_Invalid << 42 ) + ( le.aid_mailclean_dpbc_Invalid << 43 ) + ( le.aid_mailclean_chk_digit_Invalid << 44 ) + ( le.aid_mailclean_record_type_Invalid << 45 ) + ( le.aid_mailclean_ace_fips_st_Invalid << 46 ) + ( le.aid_mailclean_fipscounty_Invalid << 47 ) + ( le.aid_mailclean_geo_lat_Invalid << 48 ) + ( le.aid_mailclean_geo_long_Invalid << 49 ) + ( le.aid_mailclean_msa_Invalid << 50 ) + ( le.aid_mailclean_geo_blk_Invalid << 51 ) + ( le.aid_mailclean_geo_match_Invalid << 52 ) + ( le.aid_mailclean_err_stat_Invalid << 53 ) + ( le.prim_range_Invalid << 54 ) + ( le.predir_Invalid << 55 ) + ( le.prim_name_Invalid << 56 ) + ( le.suffix_Invalid << 57 ) + ( le.postdir_Invalid << 58 ) + ( le.unit_desig_Invalid << 59 ) + ( le.sec_range_Invalid << 60 ) + ( le.p_city_name_Invalid << 61 ) + ( le.city_name_Invalid << 62 ) + ( le.st_Invalid << 63 );
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.source_code_Invalid := (le.ScrubsBits1 >> 12) & 1;
    SELF.file_acquired_date_Invalid := (le.ScrubsBits1 >> 13) & 1;
    SELF._use_Invalid := (le.ScrubsBits1 >> 14) & 1;
    SELF.title_in_Invalid := (le.ScrubsBits1 >> 15) & 1;
    SELF.lname_in_Invalid := (le.ScrubsBits1 >> 16) & 1;
    SELF.fname_in_Invalid := (le.ScrubsBits1 >> 17) & 1;
    SELF.mname_in_Invalid := (le.ScrubsBits1 >> 18) & 1;
    SELF.maiden_prior_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.name_suffix_in_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.source_voterid_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.dob_str_in_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.agecat_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.headhousehold_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.place_of_birth_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.occupation_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.maiden_name_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.motorvoterid_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.regsource_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.regdate_in_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.race_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.gender_Invalid := (le.ScrubsBits1 >> 32) & 1;
    SELF.poliparty_Invalid := (le.ScrubsBits1 >> 33) & 1;
    SELF.phone_Invalid := (le.ScrubsBits1 >> 34) & 1;
    SELF.work_phone_Invalid := (le.ScrubsBits1 >> 35) & 1;
    SELF.other_phone_Invalid := (le.ScrubsBits1 >> 36) & 1;
    SELF.active_status_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.active_other_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.voterstatus_Invalid := (le.ScrubsBits1 >> 39) & 1;
    ...
    SELF.res_state_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.res_zip_Invalid := (le.ScrubsBits1 >> 44) & 1;
    SELF.res_county_Invalid := (le.ScrubsBits1 >> 45) & 1;
    SELF.mail_addr1_Invalid := (le.ScrubsBits1 >> 46) & 1;
    SELF.mail_addr2_Invalid := (le.ScrubsBits1 >> 47) & 1;
    SELF.mail_city_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.mail_state_Invalid := (le.ScrubsBits1 >> 49) & 3;
    SELF.mail_zip_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.mail_county_Invalid := (le.ScrubsBits1 >> 52) & 1;
    SELF.towncode_Invalid := (le.ScrubsBits1 >> 53) & 1;
    SELF.distcode_Invalid := (le.ScrubsBits1 >> 54) & 1;
    SELF.countycode_Invalid := (le.ScrubsBits1 >> 55) & 1;
    SELF.schoolcode_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.cityinout_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.spec_dist1_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.spec_dist2_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.precinct1_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.precinct2_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.precinct3_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.villageprecinct_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.schoolprecinct_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.ward_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.precinct_citytown_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.ancsmdindc_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.citycouncildist_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.countycommdist_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.statehouse_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.statesenate_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.ushouse_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.elemschooldist_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.schooldist_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.commcolldist_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.municipal_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.villagedist_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.policejury_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.policedist_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.publicservcomm_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.rescue_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.fire_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.sanitary_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.sewerdist_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.waterdist_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.mosquitodist_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.taxdist_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.supremecourt_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.justiceofpeace_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.judicialdist_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.superiorctdist_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.appealsct_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.contributorparty_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.recptparty_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.dateofcontr_in_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.dollaramt_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF.officecontto_Invalid := (le.ScrubsBits2 >> 33) & 1;
    SELF.cumuldollaramt_Invalid := (le.ScrubsBits2 >> 34) & 1;
    SELF.conttype_Invalid := (le.ScrubsBits2 >> 35) & 1;
    ...
    SELF.lastdayvote_in_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.huntfishperm_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF.datelicense_in_Invalid := (le.ScrubsBits3 >> 11) & 1;
    SELF.homestate_Invalid := (le.ScrubsBits3 >> 12) & 1;
    SELF.resident_Invalid := (le.ScrubsBits3 >> 13) & 1;
    SELF.nonresident_Invalid := (le.ScrubsBits3 >> 14) & 1;
    SELF.hunt_Invalid := (le.ScrubsBits3 >> 15) & 1;
    SELF.fish_Invalid := (le.ScrubsBits3 >> 16) & 1;
    SELF.combosuper_Invalid := (le.ScrubsBits3 >> 17) & 1;
    SELF.sportsman_Invalid := (le.ScrubsBits3 >> 18) & 1;
    SELF.trap_Invalid := (le.ScrubsBits3 >> 19) & 1;
    SELF.archery_Invalid := (le.ScrubsBits3 >> 20) & 1;
    SELF.muzzle_Invalid := (le.ScrubsBits3 >> 21) & 1;
    SELF.drawing_Invalid := (le.ScrubsBits3 >> 22) & 1;
    SELF.day1_Invalid := (le.ScrubsBits3 >> 23) & 1;
    SELF.day3_Invalid := (le.ScrubsBits3 >> 24) & 1;
    SELF.day7_Invalid := (le.ScrubsBits3 >> 25) & 1;
    SELF.day14to15_Invalid := (le.ScrubsBits3 >> 26) & 1;
    SELF.seasonannual_Invalid := (le.ScrubsBits3 >> 27) & 1;
    SELF.lifetimepermit_Invalid := (le.ScrubsBits3 >> 28) & 1;
    SELF.landowner_Invalid := (le.ScrubsBits3 >> 29) & 1;
    SELF.family_Invalid := (le.ScrubsBits3 >> 30) & 1;
    SELF.junior_Invalid := (le.ScrubsBits3 >> 31) & 1;
    SELF.seniorcit_Invalid := (le.ScrubsBits3 >> 32) & 1;
    SELF.crewmemeber_Invalid := (le.ScrubsBits3 >> 33) & 1;
    SELF.retarded_Invalid := (le.ScrubsBits3 >> 34) & 1;
    SELF.indian_Invalid := (le.ScrubsBits3 >> 35) & 1;
    SELF.serviceman_Invalid := (le.ScrubsBits3 >> 36) & 1;
    SELF.disabled_Invalid := (le.ScrubsBits3 >> 37) & 1;
    SELF.lowincome_Invalid := (le.ScrubsBits3 >> 38) & 1;
    SELF.regioncounty_Invalid := (le.ScrubsBits3 >> 39) & 1;
    SELF.blind_Invalid := (le.ScrubsBits3 >> 40) & 1;
    SELF.salmon_Invalid := (le.ScrubsBits3 >> 41) & 1;
    SELF.freshwater_Invalid := (le.ScrubsBits3 >> 42) & 1;
    SELF.saltwater_Invalid := (le.ScrubsBits3 >> 43) & 1;
    SELF.lakesandresevoirs_Invalid := (le.ScrubsBits3 >> 44) & 1;
    SELF.setlinefish_Invalid := (le.ScrubsBits3 >> 45) & 1;
    SELF.trout_Invalid := (le.ScrubsBits3 >> 46) & 1;
    SELF.fallfishing_Invalid := (le.ScrubsBits3 >> 47) & 1;
    SELF.steelhead_Invalid := (le.ScrubsBits3 >> 48) & 1;
    SELF.whitejubherring_Invalid := (le.ScrubsBits3 >> 49) & 1;
    SELF.sturgeon_Invalid := (le.ScrubsBits3 >> 50) & 1;
    SELF.shellfishcrab_Invalid := (le.ScrubsBits3 >> 51) & 1;
    SELF.shellfishlobster_Invalid := (le.ScrubsBits3 >> 52) & 1;
    SELF.deer_Invalid := (le.ScrubsBits3 >> 53) & 1;
    SELF.bear_Invalid := (le.ScrubsBits3 >> 54) & 1;
    SELF.elk_Invalid := (le.ScrubsBits3 >> 55) & 1;
    SELF.moose_Invalid := (le.ScrubsBits3 >> 56) & 1;
    SELF.buffalo_Invalid := (le.ScrubsBits3 >> 57) & 1;
    SELF.antelope_Invalid := (le.ScrubsBits3 >> 58) & 1;
    SELF.sikebull_Invalid := (le.ScrubsBits3 >> 59) & 1;
    SELF.bighorn_Invalid := (le.ScrubsBits3 >> 60) & 1;
    SELF.javelina_Invalid := (le.ScrubsBits3 >> 61) & 1;
    SELF.cougar_Invalid := (le.ScrubsBits3 >> 62) & 1;
    SELF.anterless_Invalid := (le.ScrubsBits3 >> 63) & 1;
    SELF.pheasant_Invalid := (le.ScrubsBits4 >> 0) & 1;
    SELF.goose_Invalid := (le.ScrubsBits4 >> 1) & 1;
    SELF.duck_Invalid := (le.ScrubsBits4 >> 2) & 1;
    SELF.turkey_Invalid := (le.ScrubsBits4 >> 3) & 1;
    SELF.snowmobile_Invalid := (le.ScrubsBits4 >> 4) & 1;
    SELF.biggame_Invalid := (le.ScrubsBits4 >> 5) & 1;
    SELF.skipass_Invalid := (le.ScrubsBits4 >> 6) & 1;
    SELF.migbird_Invalid := (le.ScrubsBits4 >> 7) & 1;
    SELF.smallgame_Invalid := (le.ScrubsBits4 >> 8) & 1;
    SELF.sturgeon2_Invalid := (le.ScrubsBits4 >> 9) & 1;
    SELF.gun_Invalid := (le.ScrubsBits4 >> 10) & 1;
    SELF.bonus_Invalid := (le.ScrubsBits4 >> 11) & 1;
    SELF.lottery_Invalid := (le.ScrubsBits4 >> 12) & 1;
    SELF.otherbirds_Invalid := (le.ScrubsBits4 >> 13) & 1;
    SELF.boatindexnum_Invalid := (le.ScrubsBits4 >> 14) & 1;
    SELF.boatcoowner_Invalid := (le.ScrubsBits4 >> 15) & 1;
    SELF.hullidnum_Invalid := (le.ScrubsBits4 >> 16) & 1;
    SELF.yearmade_Invalid := (le.ScrubsBits4 >> 17) & 1;
    SELF.model_Invalid := (le.ScrubsBits4 >> 18) & 1;
    SELF.manufacturer_Invalid := (le.ScrubsBits4 >> 19) & 1;
    SELF.lengt_Invalid := (le.ScrubsBits4 >> 20) & 1;
    SELF.hullconstruct_Invalid := (le.ScrubsBits4 >> 21) & 1;
    SELF.primuse_Invalid := (le.ScrubsBits4 >> 22) & 1;
    SELF.fueltype_Invalid := (le.ScrubsBits4 >> 23) & 1;
    SELF.propulsion_Invalid := (le.ScrubsBits4 >> 24) & 1;
    SELF.modeltype_Invalid := (le.ScrubsBits4 >> 25) & 1;
    SELF.regexpdate_in_Invalid := (le.ScrubsBits4 >> 26) & 1;
    SELF.titlenum_Invalid := (le.ScrubsBits4 >> 27) & 1;
    SELF.stprimuse_Invalid := (le.ScrubsBits4 >> 28) & 1;
    SELF.titlestatus_Invalid := (le.ScrubsBits4 >> 29) & 1;
    SELF.vessel_Invalid := (le.ScrubsBits4 >> 30) & 1;
    SELF.specreg_Invalid := (le.ScrubsBits4 >> 31) & 1;
    SELF.ccwpermnum_Invalid := (le.ScrubsBits4 >> 32) & 1;
    SELF.ccwweapontype_Invalid := (le.ScrubsBits4 >> 33) & 1;
    SELF.ccwregdate_in_Invalid := (le.ScrubsBits4 >> 34) & 1;
    SELF.ccwexpdate_in_Invalid := (le.ScrubsBits4 >> 35) & 1;
    SELF.ccwpermtype_Invalid := (le.ScrubsBits4 >> 36) & 1;
    SELF.dob_str_Invalid := (le.ScrubsBits4 >> 37) & 1;
    SELF.regdate_Invalid := (le.ScrubsBits4 >> 38) & 1;
    SELF.dateofcontr_Invalid := (le.ScrubsBits4 >> 39) & 1;
    SELF.lastdayvote_Invalid := (le.ScrubsBits4 >> 40) & 1;
    SELF.datelicense_Invalid := (le.ScrubsBits4 >> 41) & 1;
    SELF.regexpdate_Invalid := (le.ScrubsBits4 >> 42) & 1;
    SELF.ccwregdate_Invalid := (le.ScrubsBits4 >> 43) & 1;
    SELF.ccwexpdate_Invalid := (le.ScrubsBits4 >> 44) & 1;
    SELF.title_Invalid := (le.ScrubsBits4 >> 45) & 1;
    SELF.fname_Invalid := (le.ScrubsBits4 >> 46) & 1;
    SELF.mname_Invalid := (le.ScrubsBits4 >> 47) & 1;
    SELF.lname_Invalid := (le.ScrubsBits4 >> 48) & 1;
    SELF.name_suffix_Invalid := (le.ScrubsBits4 >> 49) & 1;
    SELF.score_on_input_Invalid := (le.ScrubsBits4 >> 50) & 1;
    SELF.append_prep_resaddress1_Invalid := (le.ScrubsBits4 >> 51) & 1;
    SELF.append_prep_resaddress2_Invalid := (le.ScrubsBits4 >> 52) & 1;
    SELF.append_resrawaid_Invalid := (le.ScrubsBits4 >> 53) & 1;
    SELF.append_prep_mailaddress1_Invalid := (le.ScrubsBits4 >> 54) & 1;
    SELF.append_prep_mailaddress2_Invalid := (le.ScrubsBits4 >> 55) & 1;
    SELF.append_mailrawaid_Invalid := (le.ScrubsBits4 >> 56) & 1;
    SELF.append_prep_cassaddress1_Invalid := (le.ScrubsBits4 >> 57) & 1;
    SELF.append_prep_cassaddress2_Invalid := (le.ScrubsBits4 >> 58) & 1;
    SELF.append_cassrawaid_Invalid := (le.ScrubsBits4 >> 59) & 1;
    SELF.aid_resclean_prim_range_Invalid := (le.ScrubsBits4 >> 60) & 1;
    SELF.aid_resclean_predir_Invalid := (le.ScrubsBits4 >> 61) & 1;
    SELF.aid_resclean_prim_name_Invalid := (le.ScrubsBits4 >> 62) & 1;
    SELF.aid_resclean_addr_suffix_Invalid := (le.ScrubsBits4 >> 63) & 1;
    SELF.aid_resclean_postdir_Invalid := (le.ScrubsBits5 >> 0) & 1;
    SELF.aid_resclean_unit_desig_Invalid := (le.ScrubsBits5 >> 1) & 1;
    SELF.aid_resclean_sec_range_Invalid := (le.ScrubsBits5 >> 2) & 1;
    SELF.aid_resclean_p_city_name_Invalid := (le.ScrubsBits5 >> 3) & 1;
    SELF.aid_resclean_v_city_name_Invalid := (le.ScrubsBits5 >> 4) & 1;
    SELF.aid_resclean_st_Invalid := (le.ScrubsBits5 >> 5) & 3;
    SELF.aid_resclean_zip_Invalid := (le.ScrubsBits5 >> 7) & 3;
    SELF.aid_resclean_zip4_Invalid := (le.ScrubsBits5 >> 9) & 1;
    SELF.aid_resclean_cart_Invalid := (le.ScrubsBits5 >> 10) & 1;
    SELF.aid_resclean_cr_sort_sz_Invalid := (le.ScrubsBits5 >> 11) & 1;
    SELF.aid_resclean_lot_Invalid := (le.ScrubsBits5 >> 12) & 1;
    SELF.aid_resclean_lot_order_Invalid := (le.ScrubsBits5 >> 13) & 1;
    SELF.aid_resclean_dpbc_Invalid := (le.ScrubsBits5 >> 14) & 1;
    SELF.aid_resclean_chk_digit_Invalid := (le.ScrubsBits5 >> 15) & 1;
    SELF.aid_resclean_record_type_Invalid := (le.ScrubsBits5 >> 16) & 1;
    SELF.aid_resclean_ace_fips_st_Invalid := (le.ScrubsBits5 >> 17) & 1;
    SELF.aid_resclean_fipscounty_Invalid := (le.ScrubsBits5 >> 18) & 1;
    SELF.aid_resclean_geo_lat_Invalid := (le.ScrubsBits5 >> 19) & 1;
    SELF.aid_resclean_geo_long_Invalid := (le.ScrubsBits5 >> 20) & 1;
    SELF.aid_resclean_msa_Invalid := (le.ScrubsBits5 >> 21) & 1;
    SELF.aid_resclean_geo_blk_Invalid := (le.ScrubsBits5 >> 22) & 1;
    SELF.aid_resclean_geo_match_Invalid := (le.ScrubsBits5 >> 23) & 1;
    SELF.aid_resclean_err_stat_Invalid := (le.ScrubsBits5 >> 24) & 1;
    SELF.aid_mailclean_prim_range_Invalid := (le.ScrubsBits5 >> 25) & 1;
    SELF.aid_mailclean_predir_Invalid := (le.ScrubsBits5 >> 26) & 1;
    SELF.aid_mailclean_prim_name_Invalid := (le.ScrubsBits5 >> 27) & 1;
    SELF.aid_mailclean_addr_suffix_Invalid := (le.ScrubsBits5 >> 28) & 1;
    SELF.aid_mailclean_postdir_Invalid := (le.ScrubsBits5 >> 29) & 1;
    SELF.aid_mailclean_unit_desig_Invalid := (le.ScrubsBits5 >> 30) & 1;
    SELF.aid_mailclean_sec_range_Invalid := (le.ScrubsBits5 >> 31) & 1;
    SELF.aid_mailclean_p_city_name_Invalid := (le.ScrubsBits5 >> 32) & 1;
    SELF.aid_mailclean_v_city_name_Invalid := (le.ScrubsBits5 >> 33) & 1;
    SELF.aid_mailclean_st_Invalid := (le.ScrubsBits5 >> 34) & 3;
    SELF.aid_mailclean_zip_Invalid := (le.ScrubsBits5 >> 36) & 3;
    SELF.aid_mailclean_zip4_Invalid := (le.ScrubsBits5 >> 38) & 1;
    SELF.aid_mailclean_cart_Invalid := (le.ScrubsBits5 >> 39) & 1;
    SELF.aid_mailclean_cr_sort_sz_Invalid := (le.ScrubsBits5 >> 40) & 1;
    SELF.aid_mailclean_lot_Invalid := (le.ScrubsBits5 >> 41) & 1;
    SELF.aid_mailclean_lot_order_Invalid := (le.ScrubsBits5 >> 42) & 1;
    SELF.aid_mailclean_dpbc_Invalid := (le.ScrubsBits5 >> 43) & 1;
    SELF.aid_mailclean_chk_digit_Invalid := (le.ScrubsBits5 >> 44) & 1;
    SELF.aid_mailclean_record_type_Invalid := (le.ScrubsBits5 >> 45) & 1;
    SELF.aid_mailclean_ace_fips_st_Invalid := (le.ScrubsBits5 >> 46) & 1;
    SELF.aid_mailclean_fipscounty_Invalid := (le.ScrubsBits5 >> 47) & 1;
    SELF.aid_mailclean_geo_lat_Invalid := (le.ScrubsBits5 >> 48) & 1;
    SELF.aid_mailclean_geo_long_Invalid := (le.ScrubsBits5 >> 49) & 1;
    SELF.aid_mailclean_msa_Invalid := (le.ScrubsBits5 >> 50) & 1;
    SELF.aid_mailclean_geo_blk_Invalid := (le.ScrubsBits5 >> 51) & 1;
    SELF.aid_mailclean_geo_match_Invalid := (le.ScrubsBits5 >> 52) & 1;
    SELF.aid_mailclean_err_stat_Invalid := (le.ScrubsBits5 >> 53) & 1;
    SELF.prim_range_Invalid := (le.ScrubsBits5 >> 54) & 1;
    SELF.predir_Invalid := (le.ScrubsBits5 >> 55) & 1;
    SELF.prim_name_Invalid := (le.ScrubsBits5 >> 56) & 1;
    SELF.suffix_Invalid := (le.ScrubsBits5 >> 57) & 1;
    SELF.postdir_Invalid := (le.ScrubsBits5 >> 58) & 1;
    SELF.unit_desig_Invalid := (le.ScrubsBits5 >> 59) & 1;
    SELF.sec_range_Invalid := (le.ScrubsBits5 >> 60) & 1;
    SELF.p_city_name_Invalid := (le.ScrubsBits5 >> 61) & 1;
    SELF.city_name_Invalid := (le.ScrubsBits5 >> 62) & 1;
    SELF.st_Invalid := (le.ScrubsBits5 >> 63) & 1;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  END;
  EXPORT AllErrors := NORMALIZE(h,385,Into(LEFT,COUNTER));
