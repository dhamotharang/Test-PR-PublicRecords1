...
// The module to handle the case where no scrubs exist
  ...
  SHARED toErrorMessage(UNSIGNED c) := CHOOSE(c
          ...
          ,Voters_Fields.InvalidMessage_vendor_id(1)
...
EXPORT FromNone(DATASET(Voters_Layout_eMerges) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.vendor_id_Invalid := Voters_Fields.InValid_vendor_id((SALT311.StrType)le.vendor_id);
  ...
  Bitmap_Layout Into(ExpandedInfile le) := TRANSFORM
    SELF.ScrubsBits1 := ( le.process_date_Invalid << 0 ) + ( le.date_first_seen_Invalid << 1 ) + ( le.date_last_seen_Invalid << 2 ) + ( le.score_Invalid << 3 ) + ( le.best_ssn_Invalid << 4 ) + ( le.did_out_Invalid << 5 ) + ( le.file_id_Invalid << 6 ) + ( le.vendor_id_Invalid << 7 ) + ( le.source_state_Invalid << 8 ) + ( le.source_code_Invalid << 10 ) + ( le.file_acquired_date_Invalid << 11 ) + ( le._use_Invalid << 12 ) + ( le.title_in_Invalid << 13 ) + ( le.lname_in_Invalid << 14 ) + ( le.fname_in_Invalid << 15 ) + ( le.mname_in_Invalid << 16 ) + ( le.maiden_prior_Invalid << 17 ) + ( le.name_suffix_in_Invalid << 18 ) + ( le.source_voterid_Invalid << 19 ) + ( le.dob_Invalid << 20 ) + ( le.agecat_Invalid << 21 ) + ( le.headhousehold_Invalid << 22 ) + ( le.place_of_birth_Invalid << 23 ) + ( le.occupation_Invalid << 24 ) + ( le.maiden_name_Invalid << 25 ) + ( le.motorvoterid_Invalid << 26 ) + ( le.regsource_Invalid << 27 ) + ( le.regdate_Invalid << 28 ) + ( le.race_Invalid << 29 ) + ( le.gender_Invalid << 30 ) + ( le.poliparty_Invalid << 31 ) + ( le.poliparty_mapped_Invalid << 32 ) + ( le.phone_Invalid << 33 ) + ( le.work_phone_Invalid << 34 ) + ( le.other_phone_Invalid << 35 ) + ( le.active_status_Invalid << 36 ) + ( le.active_status_mapped_Invalid << 37 ) + ( le.active_other_Invalid << 38 ) + ( le.voterstatus_Invalid << 39 ) + ( le.voterstatus_mapped_Invalid << 40 ) + ( le.resaddr1_Invalid << 41 ) + ( le.resaddr2_Invalid << 42 ) + ( le.res_city_Invalid << 43 ) + ( le.res_state_Invalid << 44 ) + ( le.res_zip_Invalid << 46 ) + ( le.res_county_Invalid << 48 ) + ( le.mail_addr1_Invalid << 49 ) + ( le.mail_addr2_Invalid << 50 ) + ( le.mail_city_Invalid << 51 ) + ( le.mail_state_Invalid << 52 ) + ( le.mail_zip_Invalid << 54 ) + ( le.mail_county_Invalid << 56 ) + ( le.towncode_Invalid << 57 ) + ( le.distcode_Invalid << 58 ) + ( le.countycode_Invalid << 59 ) + ( le.schoolcode_Invalid << 60 ) + ( le.cityinout_Invalid << 61 ) + ( le.spec_dist1_Invalid << 62 ) + ( le.spec_dist2_Invalid << 63 );
    SELF.ScrubsBits2 := ( le.precinct1_Invalid << 0 ) + ( le.precinct2_Invalid << 1 ) + ( le.precinct3_Invalid << 2 ) + ( le.villageprecinct_Invalid << 3 ) + ( le.schoolprecinct_Invalid << 4 ) + ( le.ward_Invalid << 5 ) + ( le.precinct_citytown_Invalid << 6 ) + ( le.ancsmdindc_Invalid << 7 ) + ( le.citycouncildist_Invalid << 8 ) + ( le.countycommdist_Invalid << 9 ) + ( le.statehouse_Invalid << 10 ) + ( le.statesenate_Invalid << 11 ) + ( le.ushouse_Invalid << 12 ) + ( le.elemschooldist_Invalid << 13 ) + ( le.schooldist_Invalid << 14 ) + ( le.commcolldist_Invalid << 15 ) + ( le.municipal_Invalid << 16 ) + ( le.villagedist_Invalid << 17 ) + ( le.policejury_Invalid << 18 ) + ( le.policedist_Invalid << 19 ) + ( le.publicservcomm_Invalid << 20 ) + ( le.rescue_Invalid << 21 ) + ( le.fire_Invalid << 22 ) + ( le.sanitary_Invalid << 23 ) + ( le.sewerdist_Invalid << 24 ) + ( le.waterdist_Invalid << 25 ) + ( le.mosquitodist_Invalid << 26 ) + ( le.taxdist_Invalid << 27 ) + ( le.supremecourt_Invalid << 28 ) + ( le.justiceofpeace_Invalid << 29 ) + ( le.judicialdist_Invalid << 30 ) + ( le.superiorctdist_Invalid << 31 ) + ( le.appealsct_Invalid << 32 ) + ( le.contributorparty_Invalid << 33 ) + ( le.recptparty_Invalid << 34 ) + ( le.dateofcontr_Invalid << 35 ) + ( le.dollaramt_Invalid << 36 ) + ( le.primary02_Invalid << 37 ) + ( le.special02_Invalid << 38 ) + ( le.other02_Invalid << 39 ) + ( le.special202_Invalid << 40 ) + ( le.general02_Invalid << 41 ) + ( le.primary01_Invalid << 42 ) + ( le.special01_Invalid << 43 ) + ( le.other01_Invalid << 44 ) + ( le.special201_Invalid << 45 ) + ( le.general01_Invalid << 46 ) + ( le.pres00_Invalid << 47 ) + ( le.primary00_Invalid << 48 ) + ( le.special00_Invalid << 49 ) + ( le.other00_Invalid << 50 ) + ( le.special200_Invalid << 51 ) + ( le.general00_Invalid << 52 ) + ( le.primary99_Invalid << 53 ) + ( le.special99_Invalid << 54 ) + ( le.other99_Invalid << 55 ) + ( le.special299_Invalid << 56 ) + ( le.general99_Invalid << 57 ) + ( le.primary98_Invalid << 58 ) + ( le.special98_Invalid << 59 ) + ( le.other98_Invalid << 60 ) + ( le.special298_Invalid << 61 ) + ( le.general98_Invalid << 62 ) + ( le.primary97_Invalid << 63 );
    SELF.ScrubsBits3 := ( le.special97_Invalid << 0 ) + ( le.other97_Invalid << 1 ) + ( le.special297_Invalid << 2 ) + ( le.general97_Invalid << 3 ) + ( le.pres96_Invalid << 4 ) + ( le.primary96_Invalid << 5 ) + ( le.special96_Invalid << 6 ) + ( le.other96_Invalid << 7 ) + ( le.special296_Invalid << 8 ) + ( le.general96_Invalid << 9 ) + ( le.lastdayvote_Invalid << 10 ) + ( le.title_Invalid << 11 ) + ( le.fname_Invalid << 12 ) + ( le.mname_Invalid << 13 ) + ( le.lname_Invalid << 14 ) + ( le.name_suffix_Invalid << 15 ) + ( le.score_on_input_Invalid << 16 ) + ( le.prim_range_Invalid << 17 ) + ( le.predir_Invalid << 18 ) + ( le.prim_name_Invalid << 19 ) + ( le.suffix_Invalid << 20 ) + ( le.postdir_Invalid << 21 ) + ( le.unit_desig_Invalid << 22 ) + ( le.sec_range_Invalid << 23 ) + ( le.p_city_name_Invalid << 24 ) + ( le.city_name_Invalid << 25 ) + ( le.st_Invalid << 26 ) + ( le.zip_Invalid << 27 ) + ( le.zip4_Invalid << 29 ) + ( le.cart_Invalid << 30 ) + ( le.cr_sort_sz_Invalid << 31 ) + ( le.lot_Invalid << 32 ) + ( le.lot_order_Invalid << 33 ) + ( le.dpbc_Invalid << 34 ) + ( le.chk_digit_Invalid << 35 ) + ( le.record_type_Invalid << 36 ) + ( le.ace_fips_st_Invalid << 37 ) + ( le.county_Invalid << 38 ) + ( le.county_name_Invalid << 39 ) + ( le.geo_lat_Invalid << 40 ) + ( le.geo_long_Invalid << 41 ) + ( le.msa_Invalid << 42 ) + ( le.geo_blk_Invalid << 43 ) + ( le.geo_match_Invalid << 44 ) + ( le.err_stat_Invalid << 45 ) + ( le.mail_prim_range_Invalid << 46 ) + ( le.mail_predir_Invalid << 47 ) + ( le.mail_prim_name_Invalid << 48 ) + ( le.mail_addr_suffix_Invalid << 49 ) + ( le.mail_postdir_Invalid << 50 ) + ( le.mail_unit_desig_Invalid << 51 ) + ( le.mail_sec_range_Invalid << 52 ) + ( le.mail_p_city_name_Invalid << 53 ) + ( le.mail_v_city_name_Invalid << 54 ) + ( le.mail_st_Invalid << 55 ) + ( le.mail_ace_zip_Invalid << 56 ) + ( le.mail_zip4_Invalid << 58 ) + ( le.mail_cart_Invalid << 59 ) + ( le.mail_cr_sort_sz_Invalid << 60 ) + ( le.mail_lot_Invalid << 61 ) + ( le.mail_lot_order_Invalid << 62 ) + ( le.mail_dpbc_Invalid << 63 );
    SELF.ScrubsBits4 := ( le.mail_chk_digit_Invalid << 0 ) + ( le.mail_record_type_Invalid << 1 ) + ( le.mail_ace_fips_st_Invalid << 2 ) + ( le.mail_fipscounty_Invalid << 3 ) + ( le.mail_geo_lat_Invalid << 4 ) + ( le.mail_geo_long_Invalid << 5 ) + ( le.mail_msa_Invalid << 6 ) + ( le.mail_geo_blk_Invalid << 7 ) + ( le.mail_geo_match_Invalid << 8 ) + ( le.mail_err_stat_Invalid << 9 );
    SELF := le;
  END;
...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.vendor_id_Invalid := (le.ScrubsBits1 >> 7) & 1;
    SELF.source_state_Invalid := (le.ScrubsBits1 >> 8) & 3;
    SELF.source_code_Invalid := (le.ScrubsBits1 >> 10) & 1;
    SELF.file_acquired_date_Invalid := (le.ScrubsBits1 >> 11) & 1;
    SELF._use_Invalid := (le.ScrubsBits1 >> 12) & 1;
    SELF.title_in_Invalid := (le.ScrubsBits1 >> 13) & 1;
    SELF.lname_in_Invalid := (le.ScrubsBits1 >> 14) & 1;
    SELF.fname_in_Invalid := (le.ScrubsBits1 >> 15) & 1;
    SELF.mname_in_Invalid := (le.ScrubsBits1 >> 16) & 1;
    SELF.maiden_prior_Invalid := (le.ScrubsBits1 >> 17) & 1;
    SELF.name_suffix_in_Invalid := (le.ScrubsBits1 >> 18) & 1;
    SELF.source_voterid_Invalid := (le.ScrubsBits1 >> 19) & 1;
    SELF.dob_Invalid := (le.ScrubsBits1 >> 20) & 1;
    SELF.agecat_Invalid := (le.ScrubsBits1 >> 21) & 1;
    SELF.headhousehold_Invalid := (le.ScrubsBits1 >> 22) & 1;
    SELF.place_of_birth_Invalid := (le.ScrubsBits1 >> 23) & 1;
    SELF.occupation_Invalid := (le.ScrubsBits1 >> 24) & 1;
    SELF.maiden_name_Invalid := (le.ScrubsBits1 >> 25) & 1;
    SELF.motorvoterid_Invalid := (le.ScrubsBits1 >> 26) & 1;
    SELF.regsource_Invalid := (le.ScrubsBits1 >> 27) & 1;
    SELF.regdate_Invalid := (le.ScrubsBits1 >> 28) & 1;
    SELF.race_Invalid := (le.ScrubsBits1 >> 29) & 1;
    SELF.gender_Invalid := (le.ScrubsBits1 >> 30) & 1;
    SELF.poliparty_Invalid := (le.ScrubsBits1 >> 31) & 1;
    SELF.poliparty_mapped_Invalid := (le.ScrubsBits1 >> 32) & 1;
    ...
    SELF.active_status_mapped_Invalid := (le.ScrubsBits1 >> 37) & 1;
    SELF.active_other_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.voterstatus_Invalid := (le.ScrubsBits1 >> 39) & 1;
    SELF.voterstatus_mapped_Invalid := (le.ScrubsBits1 >> 40) & 1;
    SELF.resaddr1_Invalid := (le.ScrubsBits1 >> 41) & 1;
    SELF.resaddr2_Invalid := (le.ScrubsBits1 >> 42) & 1;
    SELF.res_city_Invalid := (le.ScrubsBits1 >> 43) & 1;
    SELF.res_state_Invalid := (le.ScrubsBits1 >> 44) & 3;
    SELF.res_zip_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.res_county_Invalid := (le.ScrubsBits1 >> 48) & 1;
    SELF.mail_addr1_Invalid := (le.ScrubsBits1 >> 49) & 1;
    SELF.mail_addr2_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF.mail_city_Invalid := (le.ScrubsBits1 >> 51) & 1;
    SELF.mail_state_Invalid := (le.ScrubsBits1 >> 52) & 3;
    SELF.mail_zip_Invalid := (le.ScrubsBits1 >> 54) & 3;
    SELF.mail_county_Invalid := (le.ScrubsBits1 >> 56) & 1;
    SELF.towncode_Invalid := (le.ScrubsBits1 >> 57) & 1;
    SELF.distcode_Invalid := (le.ScrubsBits1 >> 58) & 1;
    SELF.countycode_Invalid := (le.ScrubsBits1 >> 59) & 1;
    SELF.schoolcode_Invalid := (le.ScrubsBits1 >> 60) & 1;
    SELF.cityinout_Invalid := (le.ScrubsBits1 >> 61) & 1;
    SELF.spec_dist1_Invalid := (le.ScrubsBits1 >> 62) & 1;
    SELF.spec_dist2_Invalid := (le.ScrubsBits1 >> 63) & 1;
    SELF.precinct1_Invalid := (le.ScrubsBits2 >> 0) & 1;
    SELF.precinct2_Invalid := (le.ScrubsBits2 >> 1) & 1;
    SELF.precinct3_Invalid := (le.ScrubsBits2 >> 2) & 1;
    SELF.villageprecinct_Invalid := (le.ScrubsBits2 >> 3) & 1;
    SELF.schoolprecinct_Invalid := (le.ScrubsBits2 >> 4) & 1;
    SELF.ward_Invalid := (le.ScrubsBits2 >> 5) & 1;
    SELF.precinct_citytown_Invalid := (le.ScrubsBits2 >> 6) & 1;
    SELF.ancsmdindc_Invalid := (le.ScrubsBits2 >> 7) & 1;
    SELF.citycouncildist_Invalid := (le.ScrubsBits2 >> 8) & 1;
    SELF.countycommdist_Invalid := (le.ScrubsBits2 >> 9) & 1;
    SELF.statehouse_Invalid := (le.ScrubsBits2 >> 10) & 1;
    SELF.statesenate_Invalid := (le.ScrubsBits2 >> 11) & 1;
    SELF.ushouse_Invalid := (le.ScrubsBits2 >> 12) & 1;
    SELF.elemschooldist_Invalid := (le.ScrubsBits2 >> 13) & 1;
    SELF.schooldist_Invalid := (le.ScrubsBits2 >> 14) & 1;
    SELF.commcolldist_Invalid := (le.ScrubsBits2 >> 15) & 1;
    SELF.municipal_Invalid := (le.ScrubsBits2 >> 16) & 1;
    SELF.villagedist_Invalid := (le.ScrubsBits2 >> 17) & 1;
    SELF.policejury_Invalid := (le.ScrubsBits2 >> 18) & 1;
    SELF.policedist_Invalid := (le.ScrubsBits2 >> 19) & 1;
    SELF.publicservcomm_Invalid := (le.ScrubsBits2 >> 20) & 1;
    SELF.rescue_Invalid := (le.ScrubsBits2 >> 21) & 1;
    SELF.fire_Invalid := (le.ScrubsBits2 >> 22) & 1;
    SELF.sanitary_Invalid := (le.ScrubsBits2 >> 23) & 1;
    SELF.sewerdist_Invalid := (le.ScrubsBits2 >> 24) & 1;
    SELF.waterdist_Invalid := (le.ScrubsBits2 >> 25) & 1;
    SELF.mosquitodist_Invalid := (le.ScrubsBits2 >> 26) & 1;
    SELF.taxdist_Invalid := (le.ScrubsBits2 >> 27) & 1;
    SELF.supremecourt_Invalid := (le.ScrubsBits2 >> 28) & 1;
    SELF.justiceofpeace_Invalid := (le.ScrubsBits2 >> 29) & 1;
    SELF.judicialdist_Invalid := (le.ScrubsBits2 >> 30) & 1;
    SELF.superiorctdist_Invalid := (le.ScrubsBits2 >> 31) & 1;
    SELF.appealsct_Invalid := (le.ScrubsBits2 >> 32) & 1;
    SELF.contributorparty_Invalid := (le.ScrubsBits2 >> 33) & 1;
    SELF.recptparty_Invalid := (le.ScrubsBits2 >> 34) & 1;
    SELF.dateofcontr_Invalid := (le.ScrubsBits2 >> 35) & 1;
    SELF.dollaramt_Invalid := (le.ScrubsBits2 >> 36) & 1;
    SELF.primary02_Invalid := (le.ScrubsBits2 >> 37) & 1;
    SELF.special02_Invalid := (le.ScrubsBits2 >> 38) & 1;
    SELF.other02_Invalid := (le.ScrubsBits2 >> 39) & 1;
    SELF.special202_Invalid := (le.ScrubsBits2 >> 40) & 1;
    SELF.general02_Invalid := (le.ScrubsBits2 >> 41) & 1;
    SELF.primary01_Invalid := (le.ScrubsBits2 >> 42) & 1;
    SELF.special01_Invalid := (le.ScrubsBits2 >> 43) & 1;
    SELF.other01_Invalid := (le.ScrubsBits2 >> 44) & 1;
    SELF.special201_Invalid := (le.ScrubsBits2 >> 45) & 1;
    SELF.general01_Invalid := (le.ScrubsBits2 >> 46) & 1;
    SELF.pres00_Invalid := (le.ScrubsBits2 >> 47) & 1;
    SELF.primary00_Invalid := (le.ScrubsBits2 >> 48) & 1;
    SELF.special00_Invalid := (le.ScrubsBits2 >> 49) & 1;
    SELF.other00_Invalid := (le.ScrubsBits2 >> 50) & 1;
    SELF.special200_Invalid := (le.ScrubsBits2 >> 51) & 1;
    SELF.general00_Invalid := (le.ScrubsBits2 >> 52) & 1;
    SELF.primary99_Invalid := (le.ScrubsBits2 >> 53) & 1;
    SELF.special99_Invalid := (le.ScrubsBits2 >> 54) & 1;
    SELF.other99_Invalid := (le.ScrubsBits2 >> 55) & 1;
    SELF.special299_Invalid := (le.ScrubsBits2 >> 56) & 1;
    SELF.general99_Invalid := (le.ScrubsBits2 >> 57) & 1;
    SELF.primary98_Invalid := (le.ScrubsBits2 >> 58) & 1;
    SELF.special98_Invalid := (le.ScrubsBits2 >> 59) & 1;
    SELF.other98_Invalid := (le.ScrubsBits2 >> 60) & 1;
    SELF.special298_Invalid := (le.ScrubsBits2 >> 61) & 1;
    SELF.general98_Invalid := (le.ScrubsBits2 >> 62) & 1;
    SELF.primary97_Invalid := (le.ScrubsBits2 >> 63) & 1;
    SELF.special97_Invalid := (le.ScrubsBits3 >> 0) & 1;
    SELF.other97_Invalid := (le.ScrubsBits3 >> 1) & 1;
    SELF.special297_Invalid := (le.ScrubsBits3 >> 2) & 1;
    SELF.general97_Invalid := (le.ScrubsBits3 >> 3) & 1;
    SELF.pres96_Invalid := (le.ScrubsBits3 >> 4) & 1;
    SELF.primary96_Invalid := (le.ScrubsBits3 >> 5) & 1;
    SELF.special96_Invalid := (le.ScrubsBits3 >> 6) & 1;
    SELF.other96_Invalid := (le.ScrubsBits3 >> 7) & 1;
    SELF.special296_Invalid := (le.ScrubsBits3 >> 8) & 1;
    SELF.general96_Invalid := (le.ScrubsBits3 >> 9) & 1;
    SELF.lastdayvote_Invalid := (le.ScrubsBits3 >> 10) & 1;
    SELF.title_Invalid := (le.ScrubsBits3 >> 11) & 1;
    SELF.fname_Invalid := (le.ScrubsBits3 >> 12) & 1;
    SELF.mname_Invalid := (le.ScrubsBits3 >> 13) & 1;
    SELF.lname_Invalid := (le.ScrubsBits3 >> 14) & 1;
    SELF.name_suffix_Invalid := (le.ScrubsBits3 >> 15) & 1;
    SELF.score_on_input_Invalid := (le.ScrubsBits3 >> 16) & 1;
    SELF.prim_range_Invalid := (le.ScrubsBits3 >> 17) & 1;
    SELF.predir_Invalid := (le.ScrubsBits3 >> 18) & 1;
    SELF.prim_name_Invalid := (le.ScrubsBits3 >> 19) & 1;
    SELF.suffix_Invalid := (le.ScrubsBits3 >> 20) & 1;
    SELF.postdir_Invalid := (le.ScrubsBits3 >> 21) & 1;
    SELF.unit_desig_Invalid := (le.ScrubsBits3 >> 22) & 1;
    SELF.sec_range_Invalid := (le.ScrubsBits3 >> 23) & 1;
    SELF.p_city_name_Invalid := (le.ScrubsBits3 >> 24) & 1;
    SELF.city_name_Invalid := (le.ScrubsBits3 >> 25) & 1;
    SELF.st_Invalid := (le.ScrubsBits3 >> 26) & 1;
    SELF.zip_Invalid := (le.ScrubsBits3 >> 27) & 3;
    SELF.zip4_Invalid := (le.ScrubsBits3 >> 29) & 1;
    SELF.cart_Invalid := (le.ScrubsBits3 >> 30) & 1;
    SELF.cr_sort_sz_Invalid := (le.ScrubsBits3 >> 31) & 1;
    SELF.lot_Invalid := (le.ScrubsBits3 >> 32) & 1;
    SELF.lot_order_Invalid := (le.ScrubsBits3 >> 33) & 1;
    SELF.dpbc_Invalid := (le.ScrubsBits3 >> 34) & 1;
    SELF.chk_digit_Invalid := (le.ScrubsBits3 >> 35) & 1;
    SELF.record_type_Invalid := (le.ScrubsBits3 >> 36) & 1;
    SELF.ace_fips_st_Invalid := (le.ScrubsBits3 >> 37) & 1;
    SELF.county_Invalid := (le.ScrubsBits3 >> 38) & 1;
    SELF.county_name_Invalid := (le.ScrubsBits3 >> 39) & 1;
    SELF.geo_lat_Invalid := (le.ScrubsBits3 >> 40) & 1;
    SELF.geo_long_Invalid := (le.ScrubsBits3 >> 41) & 1;
    SELF.msa_Invalid := (le.ScrubsBits3 >> 42) & 1;
    SELF.geo_blk_Invalid := (le.ScrubsBits3 >> 43) & 1;
    SELF.geo_match_Invalid := (le.ScrubsBits3 >> 44) & 1;
    SELF.err_stat_Invalid := (le.ScrubsBits3 >> 45) & 1;
    SELF.mail_prim_range_Invalid := (le.ScrubsBits3 >> 46) & 1;
    SELF.mail_predir_Invalid := (le.ScrubsBits3 >> 47) & 1;
    SELF.mail_prim_name_Invalid := (le.ScrubsBits3 >> 48) & 1;
    SELF.mail_addr_suffix_Invalid := (le.ScrubsBits3 >> 49) & 1;
    SELF.mail_postdir_Invalid := (le.ScrubsBits3 >> 50) & 1;
    SELF.mail_unit_desig_Invalid := (le.ScrubsBits3 >> 51) & 1;
    SELF.mail_sec_range_Invalid := (le.ScrubsBits3 >> 52) & 1;
    SELF.mail_p_city_name_Invalid := (le.ScrubsBits3 >> 53) & 1;
    SELF.mail_v_city_name_Invalid := (le.ScrubsBits3 >> 54) & 1;
    SELF.mail_st_Invalid := (le.ScrubsBits3 >> 55) & 1;
    SELF.mail_ace_zip_Invalid := (le.ScrubsBits3 >> 56) & 3;
    SELF.mail_zip4_Invalid := (le.ScrubsBits3 >> 58) & 1;
    SELF.mail_cart_Invalid := (le.ScrubsBits3 >> 59) & 1;
    SELF.mail_cr_sort_sz_Invalid := (le.ScrubsBits3 >> 60) & 1;
    SELF.mail_lot_Invalid := (le.ScrubsBits3 >> 61) & 1;
    SELF.mail_lot_order_Invalid := (le.ScrubsBits3 >> 62) & 1;
    SELF.mail_dpbc_Invalid := (le.ScrubsBits3 >> 63) & 1;
    SELF.mail_chk_digit_Invalid := (le.ScrubsBits4 >> 0) & 1;
    SELF.mail_record_type_Invalid := (le.ScrubsBits4 >> 1) & 1;
    SELF.mail_ace_fips_st_Invalid := (le.ScrubsBits4 >> 2) & 1;
    SELF.mail_fipscounty_Invalid := (le.ScrubsBits4 >> 3) & 1;
    SELF.mail_geo_lat_Invalid := (le.ScrubsBits4 >> 4) & 1;
    SELF.mail_geo_long_Invalid := (le.ScrubsBits4 >> 5) & 1;
    SELF.mail_msa_Invalid := (le.ScrubsBits4 >> 6) & 1;
    SELF.mail_geo_blk_Invalid := (le.ScrubsBits4 >> 7) & 1;
    SELF.mail_geo_match_Invalid := (le.ScrubsBits4 >> 8) & 1;
    SELF.mail_err_stat_Invalid := (le.ScrubsBits4 >> 9) & 1;
    SELF := le;
  END;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  END;
  EXPORT AllErrors := NORMALIZE(h,195,Into(LEFT,COUNTER));
