#workunit('name','NonFCRA-it51 and it60-processes');
...
outfile_name2 := '~nkoubsky::out::Paro_IT60_Dev196_' + thorlib.wuid();
...
// f := DATASET('~cgrinsteiner::in::Paro_IT60',layout_prii, CSV(QUOTE('"')));

f := DATASET('~sghatti::in::Paro_IT60',layout_prii, thor );
...
// Soapcall the query, once for it60 and once for it60
...
op_final2 := output(it60_results_0,, outfile_name2, CSV(HEADING(single), QUOTE('"')));


sequential(op_final2);

EXPORT Paro_IT60_Cust_Rec := 'Success';
