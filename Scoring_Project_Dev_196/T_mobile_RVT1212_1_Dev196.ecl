#workunit('name','FCRA-RiskView Process RVT1212_1_Cust_Recs');
...
infile_name := '~sghatti::in::T_mobile_RVT1212_1_Cust_Rec_data';
outfile_name := '~nkoubsky::out::T_mobile_RVT1212_1_Cust_Rec_DID_Dev196_' + thorlib.wuid();
...
// f1 := DATASET('~cgrinsteiner::in::T_mobile_RVT1212_1_Cust_Rec_W20130925-101542',input_layout,csv(quote('"')));
...
EXPORT T_mobile_RVT1212_1_with_did := 'success';