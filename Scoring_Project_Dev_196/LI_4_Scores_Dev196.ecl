...
outputFile := '~nkoubsky::out::nonFcra_LIScores_v4_msn1106_0_dev196_'  + thorlib.wuid();
...
ita_attributes := SOAPCALL(ita_input, roxieIP,
       ...
       // XPATH('Models.LeadIntegrity_ServiceResponse/Results/Result/Dataset[@name=\'Results\']/Row'),
				PARALLEL(1), onFail(myFail2(LEFT)));
...
EXPORT LI_4_Scores_Dev196 := output(final,, outputFile, CSV(HEADING(single), QUOTE('"')));
