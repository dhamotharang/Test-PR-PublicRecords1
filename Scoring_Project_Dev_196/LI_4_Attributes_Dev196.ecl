...
outputFile := '~nkoubsky::out::nonFcra_LIAttributes_v4_dev196_'  + thorlib.wuid();

outputshell := '~nkoubsky::out::nonFcra_LIAttributes_v4_shell_'  + thorlib.wuid();
...
op_shell := output(adlappendshell, , outputshell, CSV(HEADING(single), QUOTE('"')));
...
EXPORT LI_4_Attributes_Dev196 := output(final,, outputFile, CSV(HEADING(single), QUOTE('"')));
