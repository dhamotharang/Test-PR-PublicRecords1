 ...
 *                                   Main Options                                 *
 **********************************************************************************/
inputFileName := '~cgrinsteiner::in::Best_Buy_Chargeback_Defender_CDN1109_1_W20130925-115509';

inputfile := '~sghatti::in::Best_buy_CDS_CDN1109_1_data';

outputFileName := '~nkoubsky::out::Best_Buy_Custom_Chargeback_Defender_Score_dev196_' + thorlib.wuid();
...
f:= IF(records > 0, CHOOSEN(DATASET(inputFile, BTSTCustom, thor), records),
                            DATASET(inputFile, BTSTCustom, thor ));
...
EXPORT BestBuy_Chargeback_Defender_Score_dev196 := output(Soap_out,, outputFileName, CSV(HEADING(single), QUOTE('"')));