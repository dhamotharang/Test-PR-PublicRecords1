...
outputFile := '~nkoubsky::out::nonFcra_FPScoresAttributes_v2_dev196_'  + thorlib.wuid();
...
// roxieIP := riskwise.shortcuts.prod_batch_neutral;    //prod roxie
...
EXPORT FPScoresAttributes_XML_Dev196 := output(rolled_to_1_record,,outputfile,CSV(heading(single), quote('"')) );
