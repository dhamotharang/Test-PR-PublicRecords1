...
outfile_name := '~nkoubsky::out::RiskProcessing_Instant_Id_dev192_' + thorlib.wuid();
...
resu := soapcall(dist_dataset, roxieIP,
				'risk_indicators.InstantID.0', {dist_dataset}, 
				DATASET(xlayout),
...
EXPORT Instant_Id_XML_Dev192 := output(j_f,, outfile_name, CSV(HEADING(single), QUOTE('"')));