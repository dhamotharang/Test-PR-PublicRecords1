...
EXPORT gong_by_address_current := dedup (sort (project (g, addcn(left)), record), record) //"record" is temporarily here, I hope. 
           : PERSIST('gong_by_address_current');

// Distribute by {prim_name, st, z5, prim_range, sec_range, predir, suffix}.