// -- BIPV2_LGID3_dev._ApplyHacks('BIPV2_LGID3_dev',,true).do_all_hacks;

import SALTTOOLS22,STD,wk_ut,tools;


EXPORT _ApplyHacks(
   string   pModule               = 'BIPV2_LGID3_dev'
...
module
  ...
  function
    ...
    ,{
       'EXPORT PreIDs := BIPV2_LGID3_dev.Fields[.]UIDConsistency[(]ih[)]; // Export whole consistency module'
      ,''
    ...
    ,{
       'EXPORT PostIDs := BIPV2_LGID3_dev.Fields.UIDConsistency[(]Patched_Infile[)]; // Export whole consistency module'
      ,''
  ...
  function
    ...
    dme := dataset([{
       // '^(?!.*?BIPV2_LGID3_dev[.]_fn_CompareService.*).*$'
       '.*LGID3CompareService.*'
      ...
      + '  IMPORT SALT30,BIPV2_LGID3_dev,ut;\n'
      + 'STRING50 LGID3onestr := \'\'  : STORED(\'LGID3One\');\n'
      + 'STRING20 LGID3twostr := \'*\'  : STORED(\'LGID3two\');\n'
      + 'BIPV2_LGID3_dev._fn_CompareService((unsigned6)LGID3onestr,(unsigned6)LGID3twostr);\n'
      + 'ENDMACRO;\n'
...
*/
  ...
  function
    ...
    dme := dataset([{
          'ChangeName := \'[~]temp::LGID3::BIPV2_LGID3_dev::changes_it\'[+]iter;'
      ,''
      ,   'import bipv2;\n'
