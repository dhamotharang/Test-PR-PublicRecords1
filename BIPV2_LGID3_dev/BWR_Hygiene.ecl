...
#workunit('name','BIPV2_LGID3_dev.BWR_Hygiene - Hygiene & Stats - SALT V3.0 Gold');
IMPORT BIPV2_LGID3_dev,SALT30;
// First create an instantiated hygiene module
  infile := BIPV2_LGID3_dev.In_LGID3;
  h := BIPV2_LGID3_dev.Hygiene(infile);
  ...
  CM := BIPV2_LGID3_dev.Fields.UIDConsistency(BIPV2_LGID3_dev.In_LGID3);
