...
mjs0 := o0 : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::mj::0',EXPIRE(Config.PersistExpire));
...
EXPORT All_Matches := all_mjs : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::all_m',EXPIRE(Config.PersistExpire)); // To by used by rcid and LGID3
...
EXPORT PossibleMatches := o : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::mt',EXPIRE(Config.PersistExpire));
SALT30.mac_get_BestPerRecord( All_Matches,rcid1,LGID31,rcid2,LGID32,o );
EXPORT BestPerRecord := o : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::mr',EXPIRE(Config.PersistExpire));
...
EXPORT ClusterLinkages := o1 : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::clu',EXPIRE(Config.PersistExpire));
...
EXPORT ToSlice := IF ( Config.DoSliceouts, DEDUP(SORT(DISTRIBUTE(BetterElsewhere(Pref_Margin>10),HASH(LGID3)),LGID3,-Pref_Margin,LOCAL),LGID3,LOCAL)) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::Matches::ToSlice',EXPIRE(Config.PersistExpire));
...
EXPORT PreIDs := BIPV2_LGID3_dev.Fields.UIDConsistency(ih_thin/*HACK*/); // Export whole consistency module
EXPORT PostIDs := BIPV2_LGID3_dev.Fields.UIDConsistency(Patched_Infile_thin); // Export whole consistency module
