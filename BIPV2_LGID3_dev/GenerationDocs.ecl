...
FIELD:sbfe_id:WEIGHT(2.0):27,448
...
FIELD:company_name:LIKE(multiword):LIKE(Noblanks):BAGOFWORDS(MOST):EDIT1(2):PROP:TYPE(string250):26,339
...
// DUNS number (v2)
FIELD:active_duns_number:PROP:SWITCH0:27,43
FIELD:duns_number:PROP:SWITCH0:26,114
CONCEPT:duns_number_concept:active_duns_number:duns_number:26,173
...
FIELD:company_charter_number:PROP:CONTEXT(company_inc_state):26,96
...
Total available specificity:233
...
This process was told to produce 3 nines of accuracy on a population of 225000000 with  6134581760 records.
...
(This subtraction estimate is based upon 44% of clusters with 2 or more records have 2 or more values for sbfe_id.)
...
(This subtraction estimate is based upon 33% of clusters with 2 or more records have 2 or more values for company_name.)
...
(This subtraction estimate is based upon 11% of clusters with 2 or more records have 2 or more values for duns_number.)
...
(This subtraction estimate is based upon 17% of clusters with 2 or more records have 2 or more values for company_fein.)
