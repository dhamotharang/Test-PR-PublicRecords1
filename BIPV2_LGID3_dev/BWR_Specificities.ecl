...
#workunit('name','BIPV2_LGID3_dev.BWR_Specificities - Specificities - SALT V3.0 Gold');
IMPORT BIPV2_LGID3_dev,SALT30;
IMPORT SALTTOOLS30;
SpecMod := BIPV2_LGID3_dev.specificities(BIPV2_LGID3_dev.In_LGID3);
...
// SALTTOOLS30.mac_Patch_SPC(SpecMod.Specificities,'BIPV2_LGID3_dev.<your_spc_attribute>',BIPV2_LGID3_dev.In_LGID3);
