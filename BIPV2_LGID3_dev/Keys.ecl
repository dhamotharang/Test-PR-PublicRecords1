...
EXPORT SpecificitiesDebugKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Debug::specificities_debug';
...
EXPORT SampleKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Debug::match_sample_debug';
...
EXPORT PatchedCandidatesKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Datafile::patched_candidates';
...
EXPORT CandidatesKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Debug::match_candidates_debug';
...
EXPORT MatchHistoryName := '~keep::BIPV2_LGID3_dev::LGID3::MatchHistory';
EXPORT MatchHistoryFile := DATASET(MatchHistoryName,Matches(ih).id_shift_r,THOR); // Read in all the change history
 
EXPORT MatchHistoryKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::History::Match';
  MH := MatchHistoryFile;
