...
EXPORT input_file := h0(~Reject) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::Specificities_Cache',EXPIRE(Config.PersistExpire));
//We have LGID3 specified - so we can compute statistics on the cluster counts
  r0 := RECORD
    input_file.LGID3;
    UNSIGNED6 InCluster := COUNT(GROUP);
  end;
EXPORT ClusterSizes := TABLE(input_file,r0,LGID3,LOCAL) : PERSIST('~temp::LGID3::BIPV2_LGID3_dev::Cluster_Sizes',EXPIRE(Config.PersistExpire));
...
EXPORT company_nameValuesKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::company_name';
...
EXPORT sbfe_idValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::sbfe_id';
...
EXPORT Lgid3IfHrchyValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::Lgid3IfHrchy';
...
EXPORT company_nameValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::company_name';
...
EXPORT cnp_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::cnp_number';
...
EXPORT active_duns_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::active_duns_number';
...
EXPORT duns_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::duns_number';
...
EXPORT duns_number_conceptValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::duns_number_concept';
...
EXPORT company_feinValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::company_fein';
...
EXPORT company_inc_stateValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::company_inc_state';
...
EXPORT company_charter_numberValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::company_charter_number';
...
EXPORT cnp_btypeValuesIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Word::cnp_btype';
...
EXPORT SpecIndexKeyName := '~'+'key::BIPV2_LGID3_dev::LGID3::Specificities';
...
SpcShiftR := RECORD
  ...
  integer2 sbfe_id_switch_shift0 := ROUND(1000*Specificities[1].sbfe_id_switch - 448);
  ...
  integer2 company_name_switch_shift0 := ROUND(1000*Specificities[1].company_name_switch - 339);
  ...
  integer2 duns_number_concept_switch_shift0 := ROUND(1000*Specificities[1].duns_number_concept_switch - 173);
  ...
  integer2 company_charter_number_switch_shift0 := ROUND(1000*Specificities[1].company_charter_number_switch - 96);
