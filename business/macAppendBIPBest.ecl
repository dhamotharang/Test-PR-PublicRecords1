...
IMPORT Business,BIPV2,ecl;
  ...
  //Ult
  LOCAL BipUlt := ecl.macJoinKey(dupUltData, Business.Keys.Key_BestStaticLinkIDs,
  ...
  LOCAL dBipUlt := Business.macApplyBusinessRestrictions(BipUlt,bipModule);		
	//Sele
  LOCAL BipSele := ecl.macJoinKey(dupSeleData, Business.Keys.Key_BestStaticLinkIDs, 
  ...
  //Prox
  LOCAL BipProx := ecl.macJoinKey(dupProxData, Business.Keys.Key_BestStaticLinkIDs,
