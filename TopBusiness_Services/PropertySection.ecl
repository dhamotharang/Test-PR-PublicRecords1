  ...
  CnameReport := ReportCompanyName; 
    ...
    TmpMort_info_forLNFARESIDNoExplosCodes := sort(dedup(
	                                 join(property_recs_raw,																	      
																	...
																	AND if(in_options.IncludeVendorSourceB, true, right.record_type NOT IN LN_PropertyV2.Constants.setAssignRelsRecordTypes), //flag is for checking if BK assignments and releases should be
