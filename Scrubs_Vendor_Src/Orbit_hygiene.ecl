IMPORT SALT311,STD;
EXPORT Orbit_hygiene(dataset(Orbit_layout_Vendor_Src) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Orbit_Fields.InValid_item_id((SALT311.StrType)le.item_id),
    Orbit_Fields.InValid_item_name((SALT311.StrType)le.item_name),
    Orbit_Fields.InValid_item_description((SALT311.StrType)le.item_description),
    Orbit_Fields.InValid_status_name((SALT311.StrType)le.status_name),
    Orbit_Fields.InValid_item_source_code((SALT311.StrType)le.item_source_code),
    Orbit_Fields.InValid_source_id((SALT311.StrType)le.source_id),
    Orbit_Fields.InValid_source_name((SALT311.StrType)le.source_name),
    Orbit_Fields.InValid_source_address1((SALT311.StrType)le.source_address1),
    Orbit_Fields.InValid_source_address2((SALT311.StrType)le.source_address2),
    Orbit_Fields.InValid_source_city((SALT311.StrType)le.source_city),
    Orbit_Fields.InValid_source_state((SALT311.StrType)le.source_state),
    Orbit_Fields.InValid_source_zip((SALT311.StrType)le.source_zip),
    Orbit_Fields.InValid_source_phone((SALT311.StrType)le.source_phone),
    Orbit_Fields.InValid_source_website((SALT311.StrType)le.source_website),
    Orbit_Fields.InValid_unused_source_sourcecodes((SALT311.StrType)le.unused_source_sourcecodes),
    Orbit_Fields.InValid_unused_fcra((SALT311.StrType)le.unused_fcra),
    Orbit_Fields.InValid_unused_fcra_comments((SALT311.StrType)le.unused_fcra_comments),
    Orbit_Fields.InValid_market_restrict_flag((SALT311.StrType)le.market_restrict_flag),
    Orbit_Fields.InValid_unused_market_comments((SALT311.StrType)le.unused_market_comments),
    Orbit_Fields.InValid_unused_contact_category_name((SALT311.StrType)le.unused_contact_category_name),
    Orbit_Fields.InValid_unused_contact_name((SALT311.StrType)le.unused_contact_name),
    Orbit_Fields.InValid_unused_contact_phone((SALT311.StrType)le.unused_contact_phone),
    Orbit_Fields.InValid_unused_contact_email((SALT311.StrType)le.unused_contact_email),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := Orbit_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'item_id','item_name','item_description','status_name','item_source_code','source_id','source_name','source_address1','source_address2','source_city','source_state','source_zip','source_phone','source_website','unused_source_sourcecodes','unused_fcra','unused_fcra_comments','market_restrict_flag','unused_market_comments','Unknown','unused_contact_category_name','unused_contact_phone','unused_contact_email');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Orbit_Fields.InValidMessage_item_id(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_item_name(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_item_description(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_status_name(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_item_source_code(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_id(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_name(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_address1(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_address2(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_city(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_state(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_zip(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_phone(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_source_website(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_source_sourcecodes(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_fcra(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_fcra_comments(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_market_restrict_flag(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_market_comments(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_contact_category_name(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_contact_name(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_contact_phone(TotalErrors.ErrorNum),Orbit_Fields.InValidMessage_unused_contact_email(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, Orbit_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
