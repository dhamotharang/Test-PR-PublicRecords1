IMPORT SALT311,STD;
EXPORT Base_hygiene(dataset(Base_layout_Vendor_Src) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Base_Fields.InValid_item_source((SALT311.StrType)le.item_source),
    Base_Fields.InValid_source_code((SALT311.StrType)le.source_code),
    Base_Fields.InValid_display_name((SALT311.StrType)le.display_name),
    Base_Fields.InValid_description((SALT311.StrType)le.description),
    Base_Fields.InValid_status((SALT311.StrType)le.status),
    Base_Fields.InValid_data_notes((SALT311.StrType)le.data_notes),
    Base_Fields.InValid_coverage_1((SALT311.StrType)le.coverage_1),
    Base_Fields.InValid_coverage_2((SALT311.StrType)le.coverage_2),
    Base_Fields.InValid_orbit_item_name((SALT311.StrType)le.orbit_item_name),
    Base_Fields.InValid_orbit_source((SALT311.StrType)le.orbit_source),
    Base_Fields.InValid_orbit_number((SALT311.StrType)le.orbit_number),
    Base_Fields.InValid_website((SALT311.StrType)le.website),
    Base_Fields.InValid_notes((SALT311.StrType)le.notes),
    Base_Fields.InValid_date_added((SALT311.StrType)le.date_added),
    Base_Fields.InValid_input_file_id((SALT311.StrType)le.input_file_id),
    Base_Fields.InValid_market_restrict_flag((SALT311.StrType)le.market_restrict_flag),
    Base_Fields.InValid_clean_phone((SALT311.StrType)le.clean_phone),
    Base_Fields.InValid_clean_fax((SALT311.StrType)le.clean_fax),
    Base_Fields.InValid_prepped_addr1((SALT311.StrType)le.prepped_addr1),
    Base_Fields.InValid_prepped_addr2((SALT311.StrType)le.prepped_addr2),
    Base_Fields.InValid_v_prim_name((SALT311.StrType)le.v_prim_name),
    Base_Fields.InValid_v_zip((SALT311.StrType)le.v_zip),
    Base_Fields.InValid_v_zip4((SALT311.StrType)le.v_zip4),
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'item_source','source_code','display_name','description','status','data_notes','coverage_1','coverage_2','orbit_item_name','orbit_source','orbit_number','website','notes','date_added','input_file_id','market_restrict_flag','clean_phone','clean_fax','prepped_addr1','prepped_addr2','v_prim_name','v_zip','v_zip4','prim_range','predir','prim_name','addr_suffix','postdir','unit_desig','sec_range','p_city_name','v_city_name','st','zip','zip4','cart','cr_sort_sz','lot','lot_order','dbpc','chk_digit','rec_type','county','geo_lat','geo_long','msa','geo_blk','geo_match','err_stat');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Base_Fields.InValidMessage_item_source(TotalErrors.ErrorNum),Base_Fields.InValidMessage_source_code(TotalErrors.ErrorNum),Base_Fields.InValidMessage_display_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_description(TotalErrors.ErrorNum),Base_Fields.InValidMessage_status(TotalErrors.ErrorNum),Base_Fields.InValidMessage_data_notes(TotalErrors.ErrorNum),Base_Fields.InValidMessage_coverage_1(TotalErrors.ErrorNum),Base_Fields.InValidMessage_coverage_2(TotalErrors.ErrorNum),Base_Fields.InValidMessage_orbit_item_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_orbit_source(TotalErrors.ErrorNum),Base_Fields.InValidMessage_orbit_number(TotalErrors.ErrorNum),Base_Fields.InValidMessage_website(TotalErrors.ErrorNum),Base_Fields.InValidMessage_notes(TotalErrors.ErrorNum),Base_Fields.InValidMessage_date_added(TotalErrors.ErrorNum),Base_Fields.InValidMessage_input_file_id(TotalErrors.ErrorNum),Base_Fields.InValidMessage_market_restrict_flag(TotalErrors.ErrorNum),Base_Fields.InValidMessage_clean_phone(TotalErrors.ErrorNum),Base_Fields.InValidMessage_clean_fax(TotalErrors.ErrorNum),Base_Fields.InValidMessage_prepped_addr1(TotalErrors.ErrorNum),Base_Fields.InValidMessage_prepped_addr2(TotalErrors.ErrorNum),Base_Fields.InValidMessage_v_prim_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_v_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_v_zip4(TotalErrors.ErrorNum),Base_Fields.InValidMessage_prim_range(TotalErrors.ErrorNum),Base_Fields.InValidMessage_predir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_prim_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_addr_suffix(TotalErrors.ErrorNum),Base_Fields.InValidMessage_postdir(TotalErrors.ErrorNum),Base_Fields.InValidMessage_unit_desig(TotalErrors.ErrorNum),Base_Fields.InValidMessage_sec_range(TotalErrors.ErrorNum),Base_Fields.InValidMessage_p_city_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_v_city_name(TotalErrors.ErrorNum),Base_Fields.InValidMessage_st(TotalErrors.ErrorNum),Base_Fields.InValidMessage_zip(TotalErrors.ErrorNum),Base_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),Base_Fields.InValidMessage_cart(TotalErrors.ErrorNum),Base_Fields.InValidMessage_cr_sort_sz(TotalErrors.ErrorNum),Base_Fields.InValidMessage_lot(TotalErrors.ErrorNum),Base_Fields.InValidMessage_lot_order(TotalErrors.ErrorNum),Base_Fields.InValidMessage_dbpc(TotalErrors.ErrorNum),Base_Fields.InValidMessage_chk_digit(TotalErrors.ErrorNum),Base_Fields.InValidMessage_rec_type(TotalErrors.ErrorNum),Base_Fields.InValidMessage_county(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_lat(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_long(TotalErrors.ErrorNum),Base_Fields.InValidMessage_msa(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_blk(TotalErrors.ErrorNum),Base_Fields.InValidMessage_geo_match(TotalErrors.ErrorNum),Base_Fields.InValidMessage_err_stat(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, Base_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
