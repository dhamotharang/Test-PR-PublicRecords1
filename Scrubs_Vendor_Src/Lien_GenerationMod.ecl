...
IMPORT SALT311;
EXPORT Lien_GenerationMod := MODULE(SALT311.iGenerationMod)
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:lncourtcode:ALLOW(0123456789 ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz)\n'
    + 'FIELDTYPE:court_code:ALLOW(\'.0123456789 ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz)\n'
    + 'FIELDTYPE:court_name:ALLOW( ,()\'/\\&#-.0123456789 ABCDEFGHIJKLMNOPQRSTUVWXYZ abcdefghijklmnopqrstuvwxyz)\n'
    ...
    + 'FIELD:lncourtcode:LIKE(lncourtcode):TYPE(STRING):0,0\n'
    + 'FIELD:court_code:LIKE(court_code):TYPE(STRING):0,0\n'
    + 'FIELD:court_name:LIKE(court_name):TYPE(STRING):0,0\n'
