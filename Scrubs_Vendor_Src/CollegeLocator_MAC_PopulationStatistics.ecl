...
EXPORT CollegeLocator_MAC_PopulationStatistics(infile,Ref='',Input_lnfilecategory = '',Input_lnsourcetcode = '',Input_vendorname = '',Input_address1 = '',Input_address2 = '',Input_city = '',Input_state = '',Input_zipcode = '',Input_phone = '',OutFile) := MACRO
