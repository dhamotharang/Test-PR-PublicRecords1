IMPORT SALT311,STD;
EXPORT CourtLocator_hygiene(dataset(CourtLocator_layout_Vendor_Src) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    CourtLocator_Fields.InValid_fipscode((SALT311.StrType)le.fipscode),
    CourtLocator_Fields.InValid_statefips((SALT311.StrType)le.statefips),
    CourtLocator_Fields.InValid_countyfips((SALT311.StrType)le.countyfips),
    CourtLocator_Fields.InValid_courtid((SALT311.StrType)le.courtid),
    CourtLocator_Fields.InValid_consolidatedcourtid((SALT311.StrType)le.consolidatedcourtid),
    CourtLocator_Fields.InValid_masterid((SALT311.StrType)le.masterid),
    CourtLocator_Fields.InValid_stateofservice((SALT311.StrType)le.stateofservice),
    CourtLocator_Fields.InValid_countyofservice((SALT311.StrType)le.countyofservice),
    CourtLocator_Fields.InValid_courtname((SALT311.StrType)le.courtname),
    CourtLocator_Fields.InValid_phone((SALT311.StrType)le.phone),
    CourtLocator_Fields.InValid_address1((SALT311.StrType)le.address1),
    CourtLocator_Fields.InValid_address2((SALT311.StrType)le.address2),
    CourtLocator_Fields.InValid_city((SALT311.StrType)le.city),
    CourtLocator_Fields.InValid_state((SALT311.StrType)le.state),
    CourtLocator_Fields.InValid_zipcode((SALT311.StrType)le.zipcode),
    CourtLocator_Fields.InValid_zip4((SALT311.StrType)le.zip4),
    CourtLocator_Fields.InValid_mailaddress1((SALT311.StrType)le.mailaddress1),
    CourtLocator_Fields.InValid_mailaddress2((SALT311.StrType)le.mailaddress2),
    CourtLocator_Fields.InValid_mailcity((SALT311.StrType)le.mailcity),
    CourtLocator_Fields.InValid_mailctate((SALT311.StrType)le.mailctate),
    CourtLocator_Fields.InValid_mailzipcode((SALT311.StrType)le.mailzipcode),
    CourtLocator_Fields.InValid_mailzip4((SALT311.StrType)le.mailzip4),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := CourtLocator_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'fipscode','statefips','countyfips','courtid','consolidatedcourtid','masterid','stateofservice','countyofservice','courtname','phone','address1','address2','city','state','zipcode','zip4','mailaddress1','mailaddress2','mailcity','mailctate','mailzipcode','mailzip4');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,CourtLocator_Fields.InValidMessage_fipscode(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_statefips(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_countyfips(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_courtid(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_consolidatedcourtid(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_masterid(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_stateofservice(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_countyofservice(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_courtname(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_phone(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_address1(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_address2(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_city(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_state(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_zipcode(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_zip4(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailaddress1(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailaddress2(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailcity(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailctate(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailzipcode(TotalErrors.ErrorNum),CourtLocator_Fields.InValidMessage_mailzip4(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, CourtLocator_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
