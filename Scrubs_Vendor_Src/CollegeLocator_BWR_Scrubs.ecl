...
#workunit('name','Scrubs_Vendor_Src.CollegeLocator_BWR_Scrubs - Checking field validity in a file - SALT V3.11.6');
IMPORT Scrubs_Vendor_Src,SALT311;
infile := Scrubs_Vendor_Src.CollegeLocator_In_Vendor_Src;
mod_scrubs := Scrubs_Vendor_Src.CollegeLocator_Scrubs;
