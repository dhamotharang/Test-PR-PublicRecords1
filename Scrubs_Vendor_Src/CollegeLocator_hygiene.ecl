IMPORT SALT311,STD;
EXPORT CollegeLocator_hygiene(dataset(CollegeLocator_layout_Vendor_Src) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    CollegeLocator_Fields.InValid_lnfilecategory((SALT311.StrType)le.lnfilecategory),
    CollegeLocator_Fields.InValid_lnsourcetcode((SALT311.StrType)le.lnsourcetcode),
    CollegeLocator_Fields.InValid_vendorname((SALT311.StrType)le.vendorname),
    CollegeLocator_Fields.InValid_address1((SALT311.StrType)le.address1),
    CollegeLocator_Fields.InValid_address2((SALT311.StrType)le.address2),
    CollegeLocator_Fields.InValid_city((SALT311.StrType)le.city),
    CollegeLocator_Fields.InValid_state((SALT311.StrType)le.state),
    CollegeLocator_Fields.InValid_zipcode((SALT311.StrType)le.zipcode),
    CollegeLocator_Fields.InValid_phone((SALT311.StrType)le.phone),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := CollegeLocator_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'lnfilecategory','lnsourcetcode','vendorname','address1','address2','city','state','zipcode','phone');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,CollegeLocator_Fields.InValidMessage_lnfilecategory(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_lnsourcetcode(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_vendorname(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_address1(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_address2(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_city(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_state(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_zipcode(TotalErrors.ErrorNum),CollegeLocator_Fields.InValidMessage_phone(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, CollegeLocator_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
