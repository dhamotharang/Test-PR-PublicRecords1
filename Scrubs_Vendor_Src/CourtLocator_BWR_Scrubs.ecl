...
#workunit('name','Scrubs_Vendor_Src.CourtLocator_BWR_Scrubs - Checking field validity in a file - SALT V3.11.6');
IMPORT Scrubs_Vendor_Src,SALT311;
infile := Scrubs_Vendor_Src.CourtLocator_In_Vendor_Src;
mod_scrubs := Scrubs_Vendor_Src.CourtLocator_Scrubs;
