...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    Bankruptcy_Fields.InValid_lncourtcode((SALT311.StrType)le.lncourtcode),
    Bankruptcy_Fields.InValid_court_code((SALT311.StrType)le.court_code),
    Bankruptcy_Fields.InValid_court_name((SALT311.StrType)le.court_name),
    Bankruptcy_Fields.InValid_address1((SALT311.StrType)le.address1),
    Bankruptcy_Fields.InValid_address2((SALT311.StrType)le.address2),
    Bankruptcy_Fields.InValid_city((SALT311.StrType)le.city),
    Bankruptcy_Fields.InValid_state((SALT311.StrType)le.state),
    Bankruptcy_Fields.InValid_zip((SALT311.StrType)le.zip),
    Bankruptcy_Fields.InValid_phone((SALT311.StrType)le.phone),
    0);
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, Bankruptcy_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
