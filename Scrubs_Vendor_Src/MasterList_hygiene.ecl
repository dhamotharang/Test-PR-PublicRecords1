IMPORT SALT311,STD;
EXPORT MasterList_hygiene(dataset(MasterList_layout_Vendor_Src) h) := MODULE
...
ErrorRecord NoteErrors(h le,UNSIGNED1 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    MasterList_Fields.InValid_lnfilecategory((SALT311.StrType)le.lnfilecategory),
    MasterList_Fields.InValid_lnsourcetcode((SALT311.StrType)le.lnsourcetcode),
    MasterList_Fields.InValid_vendorname((SALT311.StrType)le.vendorname),
    MasterList_Fields.InValid_address1((SALT311.StrType)le.address1),
    MasterList_Fields.InValid_address2((SALT311.StrType)le.address2),
    MasterList_Fields.InValid_city((SALT311.StrType)le.city),
    MasterList_Fields.InValid_state((SALT311.StrType)le.state),
    MasterList_Fields.InValid_zipcode((SALT311.StrType)le.zipcode),
    MasterList_Fields.InValid_phone((SALT311.StrType)le.phone),
    0);
...
PrettyErrorTotals := RECORD
  FieldNme := MasterList_Fields.FieldName(TotalErrors.FieldNum);
  FieldType := CHOOSE(TotalErrors.FieldNum,'lnfilecategory','lnsourcetcode','vendorname','address1','address2','city','state','zipcode','phone');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,MasterList_Fields.InValidMessage_lnfilecategory(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_lnsourcetcode(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_vendorname(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_address1(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_address2(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_city(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_state(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_zipcode(TotalErrors.ErrorNum),MasterList_Fields.InValidMessage_phone(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
...
EXPORT StandardStats(BOOLEAN doSummaryGlobal = TRUE, BOOLEAN doAllProfiles = TRUE) := FUNCTION
  ...
  SALT311.mod_StandardStatsTransforms.mac_hygieneSummaryTransform(Scrubs_Vendor_Src, MasterList_Fields, 'RECORDOF(fieldPopulationOverall)', FALSE);
