...
// dslayout := RECORD ,maxLength(28000)
...
ds := dataset([],Layout_key_booking);

export Key_Booking := index(ds , {booking_sid},{ds}, 
				Data_Services.Data_location.Prefix('Appriss') + 'thor_200::key::appriss::' + doxie.Version_SuperKey + '::bookings_id');
