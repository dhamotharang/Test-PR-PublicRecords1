...
export fSpray(string version, boolean pUseProd = false)	:=	DATASET([
 	...
 	,'/hds_180/link2tek/'+version[..8]+'/'            //SourceDirectory	 Absolute path of directory on Remote Server where files are located                
	...
	,IF((tools._Constants.IsDataland),'thor40_241','thor400_30')
 	// ,'thor_data400'                                       //Thor Group name, ex. 'thor_data400' = dataland400, 'thor_dell400' = prod400(default)
