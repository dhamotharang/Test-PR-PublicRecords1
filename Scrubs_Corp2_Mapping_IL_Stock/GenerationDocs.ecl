...
Command line options: -MScrubs_Corp2_Mapping_IL_Stock -eC:\Users\butlersx\AppData\Local\Temp\TFR923.tmp 
File being processed :-
OPTIONS:-gh
MODULE:Scrubs_Corp2_Mapping_IL_Stock
FILENAME:In_IL
...
FIELDTYPE:invalid_class:CUSTOM(Scrubs_Corp2_Mapping_IL_Stock.Functions.invalid_class>0)
FIELDTYPE:invalid_shares:CUSTOM(Scrubs_Corp2_Mapping_IL_Stock.Functions.invalid_shares>0)
FIELDTYPE:invalid_money:CUSTOM(Scrubs_Corp2_Mapping_IL_Stock.Functions.invalid_money>0)
...
FIELD:stock_authorized_nbr:TYPE(STRING50):LIKE(invalid_numeric):0,0
FIELD:stock_par_value:TYPE(STRING15):LIKE(invalid_money):0,0
FIELD:stock_nbr_par_shares:TYPE(STRING15):0,0
FIELD:stock_change_ind:TYPE(STRING1):LIKE(invalid_Y_N):0,0
...
FIELD:stock_change_in_cap:TYPE(STRING8):LIKE(invalid_numeric):0,0
FIELD:stock_tax_capital:TYPE(STRING15):LIKE(invalid_money):0,0
