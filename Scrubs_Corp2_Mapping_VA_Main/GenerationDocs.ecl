...
Command line options: -MScrubs_Corp2_Mapping_VA_Main -eC:\Users\mattel01\AppData\Local\Temp\TFRD72E.tmp 
File being processed :-
OPTIONS:-gh 
MODULE:Scrubs_Corp2_Mapping_VA_Main
FILENAME:In_VA
...
FIELDTYPE:invalid_type_cd:CUSTOM(Scrubs_Corp2_Mapping_VA_Main.Functions.ValidCorpLNNameTypeCD>0,recordorigin)
FIELDTYPE:invalid_type_desc:CUSTOM(Scrubs_Corp2_Mapping_VA_Main.Functions.ValidCorpLNNameTypeDesc>0,recordorigin)
FIELDTYPE:invalid_status_desc:CUSTOM(Scrubs_Corp2_Mapping_VA_Main.Functions.ValidCorpStatusDesc>0)
FIELDTYPE:invalid_addr_cd:ENUM( |B)
FIELDTYPE:invalid_addr_desc:ENUM( |BUSINESS)
FIELDTYPE:invalid_term_exist_cd:ENUM(D|P| )
FIELDTYPE:invalid_foreign_domestic_ind:ENUM(D|F| )
FIELDTYPE:invalid_org_bus_type_cd:CUSTOM(Scrubs_Corp2_Mapping_VA_Main.Functions.ValidCorpOrigBusTypeCD>0)
FIELDTYPE:invalid_agent_status_desc:CUSTOM(Scrubs_Corp2_Mapping_VA_Main.Functions.ValidCorpAgentStatusDesc>0,recordorigin)
FIELDTYPE:invalid_numeric:ALLOW(0123456789)
FIELDTYPE:invalid_alphablank:ALLOW( ABCDEFGHIJKLMNOPQRSTUVWXYZ)
FIELDTYPE:invalid_alphaspec:ALLOW( .,ABCDEFGHIJKLMNOPQRSTUVWXYZ)
...
FIELD:corp_address1_type_cd:TYPE(STRING8):LIKE(invalid_addr_cd):0,0
FIELD:corp_address1_type_desc:TYPE(STRING60):LIKE(invalid_addr_desc):0,0
...
FIELD:corp_forgn_state_desc:TYPE(STRING60):LIKE(invalid_alphaspec):0,0
...
FIELD:corp_for_profit_ind:TYPE(STRING1):0,0
...
FIELD:corp_orig_bus_type_cd:TYPE(STRING8):LIKE(invalid_org_bus_type_cd):0,0
...
FIELD:corp_ra_fax_nbr:TYPE(STRING30):0,0
...
FIELD:corp_agent_status_cd:TYPE(STRING2):0,0
FIELD:corp_agent_status_desc:TYPE(STRING50):LIKE(invalid_agent_status_desc):0,0
...
FIELD:corp_name_status_date:TYPE(STRING8):0,00
FIELD:corp_name_status_desc:TYPE(STRING50):0,0
