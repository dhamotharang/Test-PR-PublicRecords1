...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_name_effective_date_Invalid := (le.ScrubsBits1 >> 46) & 3;
    SELF.corp_name_reservation_expiration_date_Invalid := (le.ScrubsBits1 >> 48) & 3;
    SELF.recordorigin_Invalid := (le.ScrubsBits1 >> 50) & 1;
    SELF := le;
  END;
