...
export BWR_Build_Deadco_Boolean(string filedate) :=
...
docs := InfoUSA.Convert_Deadco_Func(indata) + segkeys : persist('~thor_data400::persist::deadco::boolean');
...
inlkeyname := '~thor_data400::key::deadco::'+filedate+'::doc.abinumber';
inskeyname := '~thor_data400::key::deadco::qa::doc.abinumber';
...
retval := sequential(
									...
									fileservices.deletelogicalfile('~thor_data400::persist::deadco::boolean')
									);
