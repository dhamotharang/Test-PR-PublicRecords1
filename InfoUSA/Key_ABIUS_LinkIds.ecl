IMPORT BIPV2, Data_Services, ut;

EXPORT Key_ABIUS_LinkIds := MODULE

  // DEFINE THE INDEX
	shared superfile_name	:= Data_Services.Data_location.Prefix('ABIUS') + 'thor_data400::key::infousa::abius::qa::linkids';
	
	shared Base := INFOUSA.File_ABIUS_Company_Base_AID;
