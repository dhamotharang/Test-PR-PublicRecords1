...
self.clean_address := address.CleanAddress182(L.STREET1,L.CITY1 +' '+L.STATE1+' '+L.ZIP1_5 + L.ZIP1_4);
...
File_DEADCO_Clean_temp := project(Business_HeaderV2.Source_Files.infousa_deadco.BusinessHeader, tdeadcoclean(left));
...
export File_DEADCO_Clean_In_BH := project(File_DEADCO_clean_temp, tdeadtoclean(left));
