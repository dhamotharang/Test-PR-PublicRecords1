/*2008-05-08T11:26:08Z (David A Bayliss)
SALT V1.1
Initial switch value will be lower (deduped correctly)
General switch valuesa more aggressive (count those dids with >1 record as base)
*/
