...
#workunit('name','BIPV2_EMPID_Platform.BWR_Iterate - Internal Linking - SALT V3.0 Gold');
IMPORT BIPV2_EMPID_Platform,SALT30;
IMPORT SALTTOOLS30;
//BIPV2_EMPID_Platform.Specificities(BIPV2_EMPID_Platform.In_EmpID).Build; // Used to create calibration keys
...
P := BIPV2_EMPID_Platform.Proc_Iterate('1'); // Change '1' for later iterations
...
SALT30.MAC_MatchSamplePatterns(BIPV2_EMPID_Platform.Keys(BIPV2_EMPID_Platform.In_EmpID).MatchSample,MatchPatterns,EmpID1,EmpID2,8,40-46);
...
ConfThreshold:=43;
ReviewSamples:=SALTTOOLS30.MAC_GetSALTReviewSamples(BIPV2_EMPID_Platform.Keys(BIPV2_EMPID_Platform.In_EmpID).MatchSample,BIPV2_EMPID_Platform.Keys(BIPV2_EMPID_Platform.In_EmpID).Candidates,BIPV2_EMPID_Platform.In_EmpID,EmpID,ConfThreshold,NumSamplesPerReviewer,Reviewers);
//ReviewSamples;
