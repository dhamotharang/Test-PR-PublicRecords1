...
iter := '25';
#workunit('name','BIPV2_EMPID_Platform Iter ' + iter + ' review samples');
psetReviewers           := ['CM','LB','TL','JL','FN','DW'];
pNumSamplesPerReviewer  := 15;

kmtch      := index(BIPV2_EMPID_Platform.Keys(BIPV2_EMPID_Platform.In_EmpID).MatchSample ,BIPV2_EMPID_Platform.keynames('20130330' + iter).match_sample_debug.logical);
...
EXPORT _mac_GetSALTReviewSamples(
  ...
  ,pInFile                            //Infile for matching(BIPV2_EMPID_Platform.In_EmpID)
