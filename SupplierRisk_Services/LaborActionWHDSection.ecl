IMPORT AutoStandardI, LaborActions_WHD, BIPV2, std, iesp, MDR, TopBusiness_Services;
...
EXPORT LaborActionWHDSection := MODULE
 ...
 EXPORT fn_FullView(
  ...
  //
  // *** Key fetch to get labor action WHD linking data from BIP2 linkids key file.
  ds_labor_recs := LaborActions_WHD.Key_LinkIDS.KFetch(
