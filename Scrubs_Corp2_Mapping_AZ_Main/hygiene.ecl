...
invRec invert(summary0 le, INTEGER C) := TRANSFORM
  ...
  SELF.populated_pcnt := CHOOSE(C,le.populated_dt_vendor_first_reported_pcnt,le.populated_dt_vendor_last_reported_pcnt,le.populated_dt_first_seen_pcnt,le.populated_dt_last_seen_pcnt,le.populated_corp_ra_dt_first_seen_pcnt,le.populated_corp_ra_dt_last_seen_pcnt,le.populated_corp_key_pcnt,le.populated_corp_vendor_pcnt,le.populated_corp_state_origin_pcnt,le.populated_corp_process_date_pcnt,le.populated_corp_orig_sos_charter_nbr_pcnt,le.populated_corp_legal_name_pcnt,le.populated_corp_ln_name_type_cd_pcnt,le.populated_corp_filing_date_pcnt,le.populated_corp_status_date_pcnt,le.populated_corp_inc_date_pcnt,le.populated_corp_forgn_date_pcnt,le.populated_corp_ra_effective_date_pcnt,le.populated_corp_ra_resign_date_pcnt,le.populated_corp_merger_date_pcnt,le.populated_corp_renewal_date_pcnt,le.populated_corp_inc_state_pcnt,le.populated_corp_status_cd_pcnt,le.populated_corp_foreign_domestic_ind_pcnt,le.populated_corp_orig_org_structure_cd_pcnt,le.populated_corp_for_profit_ind_pcnt,le.populated_corp_forgn_state_desc_pcnt,le.populated_recordorigin_pcnt);
  SELF.maxlength := CHOOSE(C,le.maxlength_dt_vendor_first_reported,le.maxlength_dt_vendor_last_reported,le.maxlength_dt_first_seen,le.maxlength_dt_last_seen,le.maxlength_corp_ra_dt_first_seen,le.maxlength_corp_ra_dt_last_seen,le.maxlength_corp_key,le.maxlength_corp_vendor,le.maxlength_corp_state_origin,le.maxlength_corp_process_date,le.maxlength_corp_orig_sos_charter_nbr,le.maxlength_corp_legal_name,le.maxlength_corp_ln_name_type_cd,le.maxlength_corp_filing_date,le.maxlength_corp_status_date,le.maxlength_corp_inc_date,le.maxlength_corp_forgn_date,le.maxlength_corp_ra_effective_date,le.maxlength_corp_ra_resign_date,le.maxlength_corp_merger_date,le.maxlength_corp_renewal_date,le.maxlength_corp_inc_state,le.maxlength_corp_status_cd,le.maxlength_corp_foreign_domestic_ind,le.maxlength_corp_orig_org_structure_cd,le.maxlength_corp_for_profit_ind,le.maxlength_corp_forgn_state_desc,le.maxlength_recordorigin);
  SELF.avelength := CHOOSE(C,le.avelength_dt_vendor_first_reported,le.avelength_dt_vendor_last_reported,le.avelength_dt_first_seen,le.avelength_dt_last_seen,le.avelength_corp_ra_dt_first_seen,le.avelength_corp_ra_dt_last_seen,le.avelength_corp_key,le.avelength_corp_vendor,le.avelength_corp_state_origin,le.avelength_corp_process_date,le.avelength_corp_orig_sos_charter_nbr,le.avelength_corp_legal_name,le.avelength_corp_ln_name_type_cd,le.avelength_corp_filing_date,le.avelength_corp_status_date,le.avelength_corp_inc_date,le.avelength_corp_forgn_date,le.avelength_corp_ra_effective_date,le.avelength_corp_ra_resign_date,le.avelength_corp_merger_date,le.avelength_corp_renewal_date,le.avelength_corp_inc_state,le.avelength_corp_status_cd,le.avelength_corp_foreign_domestic_ind,le.avelength_corp_orig_org_structure_cd,le.avelength_corp_for_profit_ind,le.avelength_corp_forgn_state_desc,le.avelength_recordorigin);
END;
...
SALT32.MAC_Character_Counts.X_Data_Layout Into(h le,unsigned C) := TRANSFORM
  SELF.Fld := TRIM(CHOOSE(C,IF (le.dt_vendor_first_reported <> 0,TRIM((SALT32.StrType)le.dt_vendor_first_reported), ''),IF (le.dt_vendor_last_reported <> 0,TRIM((SALT32.StrType)le.dt_vendor_last_reported), ''),IF (le.dt_first_seen <> 0,TRIM((SALT32.StrType)le.dt_first_seen), ''),IF (le.dt_last_seen <> 0,TRIM((SALT32.StrType)le.dt_last_seen), ''),IF (le.corp_ra_dt_first_seen <> 0,TRIM((SALT32.StrType)le.corp_ra_dt_first_seen), ''),IF (le.corp_ra_dt_last_seen <> 0,TRIM((SALT32.StrType)le.corp_ra_dt_last_seen), ''),TRIM((SALT32.StrType)le.corp_key),TRIM((SALT32.StrType)le.corp_vendor),TRIM((SALT32.StrType)le.corp_state_origin),TRIM((SALT32.StrType)le.corp_process_date),TRIM((SALT32.StrType)le.corp_orig_sos_charter_nbr),TRIM((SALT32.StrType)le.corp_legal_name),TRIM((SALT32.StrType)le.corp_ln_name_type_cd),TRIM((SALT32.StrType)le.corp_filing_date),TRIM((SALT32.StrType)le.corp_status_date),TRIM((SALT32.StrType)le.corp_inc_date),TRIM((SALT32.StrType)le.corp_forgn_date),TRIM((SALT32.StrType)le.corp_ra_effective_date),TRIM((SALT32.StrType)le.corp_ra_resign_date),TRIM((SALT32.StrType)le.corp_merger_date),TRIM((SALT32.StrType)le.corp_renewal_date),TRIM((SALT32.StrType)le.corp_inc_state),TRIM((SALT32.StrType)le.corp_status_cd),TRIM((SALT32.StrType)le.corp_foreign_domestic_ind),TRIM((SALT32.StrType)le.corp_orig_org_structure_cd),TRIM((SALT32.StrType)le.corp_for_profit_ind),TRIM((SALT32.StrType)le.corp_forgn_state_desc),TRIM((SALT32.StrType)le.recordorigin)));
  SELF.FldNo := C;
END;
...
SHARED FldIds := DATASET([{1,'dt_vendor_first_reported'}
      ...
      ,{16,'corp_inc_date'}
      ,{17,'corp_forgn_date'}
      ,{18,'corp_ra_effective_date'}
      ,{19,'corp_ra_resign_date'}
      ,{20,'corp_merger_date'}
      ,{21,'corp_renewal_date'}
      ,{22,'corp_inc_state'}
      ,{23,'corp_status_cd'}
      ,{24,'corp_foreign_domestic_ind'}
      ,{25,'corp_orig_org_structure_cd'}
      ,{26,'corp_for_profit_ind'}
      ,{27,'corp_forgn_state_desc'}
      ,{28,'recordorigin'}],SALT32.MAC_Character_Counts.Field_Identification);
...
PrettyErrorTotals := RECORD
  ...
  FieldType := CHOOSE(TotalErrors.FieldNum,'invalid_optional_date','invalid_optional_date','invalid_date','invalid_date','invalid_optional_date','invalid_optional_date','invalid_corp_key','invalid_corp_vendor','invalid_state_origin','invalid_date','invalid_charter','invalid_mandatory','invalid_name_type_code','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_optional_date','invalid_state_origin','invalid_corp_status_cd','invalid_forgn_dom_code','invalid_orig_org_structure_cd','invalid_for_profit_ind','invalid_alphablankperiod','Unknown');
  ErrorMessage := CHOOSE(TotalErrors.FieldNum,Fields.InValidMessage_dt_vendor_first_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_vendor_last_reported(TotalErrors.ErrorNum),Fields.InValidMessage_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_first_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_dt_last_seen(TotalErrors.ErrorNum),Fields.InValidMessage_corp_key(TotalErrors.ErrorNum),Fields.InValidMessage_corp_vendor(TotalErrors.ErrorNum),Fields.InValidMessage_corp_state_origin(TotalErrors.ErrorNum),Fields.InValidMessage_corp_process_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_sos_charter_nbr(TotalErrors.ErrorNum),Fields.InValidMessage_corp_legal_name(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ln_name_type_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_filing_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_status_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_effective_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_ra_resign_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_merger_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_renewal_date(TotalErrors.ErrorNum),Fields.InValidMessage_corp_inc_state(TotalErrors.ErrorNum),Fields.InValidMessage_corp_status_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_foreign_domestic_ind(TotalErrors.ErrorNum),Fields.InValidMessage_corp_orig_org_structure_cd(TotalErrors.ErrorNum),Fields.InValidMessage_corp_for_profit_ind(TotalErrors.ErrorNum),Fields.InValidMessage_corp_forgn_state_desc(TotalErrors.ErrorNum),Fields.InValidMessage_recordorigin(TotalErrors.ErrorNum));
  TotalErrors.Cnt;
END;
