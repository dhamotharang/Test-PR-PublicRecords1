...
EXPORT FromBits(DATASET(Bitmap_Layout) h) := MODULE
  ...
  Expanded_Layout into(h le) := TRANSFORM
    ...
    SELF.corp_ra_effective_date_Invalid := (le.ScrubsBits1 >> 30) & 3;
    SELF.corp_ra_resign_date_Invalid := (le.ScrubsBits1 >> 32) & 3;
    SELF.corp_merger_date_Invalid := (le.ScrubsBits1 >> 34) & 3;
    SELF.corp_renewal_date_Invalid := (le.ScrubsBits1 >> 36) & 3;
    SELF.corp_inc_state_Invalid := (le.ScrubsBits1 >> 38) & 1;
    SELF.corp_status_cd_Invalid := (le.ScrubsBits1 >> 39) & 1;
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.FieldContents := CHOOSE(c,(SALT32.StrType)le.dt_vendor_first_reported,(SALT32.StrType)le.dt_vendor_last_reported,(SALT32.StrType)le.dt_first_seen,(SALT32.StrType)le.dt_last_seen,(SALT32.StrType)le.corp_ra_dt_first_seen,(SALT32.StrType)le.corp_ra_dt_last_seen,(SALT32.StrType)le.corp_key,(SALT32.StrType)le.corp_vendor,(SALT32.StrType)le.corp_state_origin,(SALT32.StrType)le.corp_process_date,(SALT32.StrType)le.corp_orig_sos_charter_nbr,(SALT32.StrType)le.corp_legal_name,(SALT32.StrType)le.corp_ln_name_type_cd,(SALT32.StrType)le.corp_filing_date,(SALT32.StrType)le.corp_status_date,(SALT32.StrType)le.corp_inc_date,(SALT32.StrType)le.corp_forgn_date,(SALT32.StrType)le.corp_ra_effective_date,(SALT32.StrType)le.corp_ra_resign_date,(SALT32.StrType)le.corp_merger_date,(SALT32.StrType)le.corp_renewal_date,(SALT32.StrType)le.corp_inc_state,(SALT32.StrType)le.corp_status_cd,(SALT32.StrType)le.corp_foreign_domestic_ind,(SALT32.StrType)le.corp_orig_org_structure_cd,(SALT32.StrType)le.corp_for_profit_ind,(SALT32.StrType)le.corp_forgn_state_desc,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD(),STRING10 Src='UNK') := FUNCTION
    SALT32.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'corp_renewal_date:invalid_optional_date:ALLOW','corp_renewal_date:invalid_optional_date:CUSTOM','corp_renewal_date:invalid_optional_date:LENGTH'
          ...
          ,'corp_forgn_state_desc:invalid_alphablankperiod:ALLOW','UNKNOWN');
