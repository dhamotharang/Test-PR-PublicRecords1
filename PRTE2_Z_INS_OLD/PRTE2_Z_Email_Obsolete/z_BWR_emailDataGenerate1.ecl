IMPORT PRTE2_X_DataCleanse, PRTE2_Email, Address;

mergedHeader := PRTE2_X_DataCleanse.Files_Alpha.Merged_Headers_SF_DS(addr_match_flag='OK'); //44,400

PRTE2_Email._layouts.base xEmailData(mergedHeader L):= TRANSFORM 
  //generate email   
  ...
  SELF.email_rec_key := PRTE2_Email._functions.Email_rec_key(SELF.clean_email,
...
OUTPUT(emailResult,,'~prte::ct::base::email_alpha_generated::email_data', OVERWRITE); //44,399
