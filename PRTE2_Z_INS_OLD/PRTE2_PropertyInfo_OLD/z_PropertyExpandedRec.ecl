/*2016-01-21T00:38:00Z (Bruce Petro)

*/
/* *************************************************************************
This is the propertyExpandedRec layout PRIOR to the Jan 2016 move away from 
the old Gateway group's "response" based layout that we started with.
(technically, we started with the old batch_in layout and then expanded to this)
************************************************************************* */
...
//* Layout for Expanded Property Info Records 
	...
	EXPORT z_PropertyExpandedRec := RECORD
