...
EXPORT Layouts := MODULE
	...
	// As of April 2017 - we have two main Alpha layouts:
	// 		AlphaPropertyCSVRec = our CSV layout
	// 		Boca_Official_Layout = Boca official base layout
	EXPORT Boca_Official_Layout := PropertyCharacteristics.Layouts.Base;
	EXPORT AlphaPropertyCSVRec := RECORD
	...
	// EXPORT AlphaPropertyCSVRec_V1 RECORD
			// AlphaPropertyCSVRec	and	not	[	roof_type,src_roof_type,tax_dt_roof_type];
	// END;
