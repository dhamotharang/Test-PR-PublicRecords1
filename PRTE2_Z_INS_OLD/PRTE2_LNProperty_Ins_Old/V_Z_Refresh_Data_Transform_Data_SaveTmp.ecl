/*
***********************************************************************************************
     ********* THIS IS A BACKUP OF WHERE Transform_Data STOOD WHEN I REMOVED CODE CALCULATIONS 
     ********* BECAUSE WE HAD REFRESHED ALL OR ALMOST ALL OF THE CODE FIELDS 
     ********* BECAUSE THE CODES ARE FILLED BY THAT PROCESS WE DO NOT WANT TO HAVE CALCULATIONS
               TRYING TO TAKE DESCRIPTION FIELDS AND JURY RIG THEM BACK TO CODES!
***********************************************************************************************
*/
...
EXPORT Transform_Data(STRING pindexversion) := MODULE
		...
		EXPORT LNPropertyRec  Reformat_PHASE1 (Layouts.batch_in L, Integer C) := TRANSFORM
...
// ----------- fixes ------------------------------- fields not yet filled, mostly blank --
// but at some point we'll populate them in the spreadsheet and we need them to transfer
// Commented ones are either not in the current CSV layout or they have a slightly better guess above until we fix them.
					...
					// SELF.basement_code := L.assess_basement_code;
					...
					// SELF.other_impr_building2_area := L.assess_other_impr_building2_area;
					// SELF.other_impr_building3_area := L.assess_other_impr_building3_area;
					// SELF.other_impr_building4_area := L.assess_other_impr_building4_area;
					// SELF.other_impr_building5_area := L.assess_other_impr_building5_area;
