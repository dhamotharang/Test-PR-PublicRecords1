//*EXPORT Print_Selection := 'todo';
IMPORT PRTE_CSV;
//*X2 := PRTE_CSV.LN_Propertyv2.dthor_data400__key__ln_propertyv2__addr_search_fid;
...
//*X2 := DATASET('~prte::ct::ln_propertyv2::join::ds18',ds18layout,flat);
X2 := PRTE_CSV.LN_Propertyv2.dthor_data400__key__ln_propertyv2__autokey__citystname;
//*PRTE_CSV.LN_Propertyv2.dthor_data400__key__ln_propertyv2__addr_search_fid;

OUTPUT(COUNT(X2),NAMED('citystname'));
OUTPUT(choosen(X2(DID=999933578009),100));
