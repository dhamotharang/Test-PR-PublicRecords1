...
string pIndexOldVersion := '20151030a';			// Has to match DOPS version for LNPropertyV2Keys
string pFCRAOldVersion  := '20151030a';			// Has to match DOPS version for FRCA_LNPropertyV2Keys
