...
Command line options: -MScrubs_Corp2_Mapping_MI_AR -eC:\Users\butlersx\AppData\Local\Temp\TFR214.tmp 
...
FIELDTYPE:invalid_extension:CUSTOM(Scrubs_Corp2_Mapping_MI_AR.Functions.invalid_ar_extension>0)
FIELDTYPE:invalid_frame:CUSTOM(Scrubs_Corp2_Mapping_MI_AR.Functions.invalid_ar_frame>0)
FIELDTYPE:invalid_roll:CUSTOM(Scrubs_Corp2_Mapping_MI_AR.Functions.invalid_ar_roll>0)
...
FIELD:ar_roll:TYPE(STRING10):LIKE(invalid_roll):0,0
FIELD:ar_frame:TYPE(STRING10):LIKE(invalid_frame):0,0
FIELD:ar_extension:TYPE(STRING10):LIKE(invalid_extension):0,0
