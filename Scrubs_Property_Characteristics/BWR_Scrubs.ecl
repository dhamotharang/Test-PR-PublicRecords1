...
#workunit('name','Scrubs_Property_Characteristics.BWR_Scrubs - Checking field validity in a file - SALT V3.11.9');
IMPORT Scrubs_Property_Characteristics,SALT311;
infile := Scrubs_Property_Characteristics.In_Property_Characteristics;
mod_scrubs := Scrubs_Property_Characteristics.Scrubs;
