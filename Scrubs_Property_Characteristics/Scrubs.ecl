...
EXPORT FromNone(DATASET(Layout_Property_Characteristics) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.air_conditioning_type_Invalid := Fields.InValid_air_conditioning_type((SALT311.StrType)le.air_conditioning_type,(SALT311.StrType)le.src_air_conditioning_type);
    ...
    SELF.basement_finish_Invalid := Fields.InValid_basement_finish((SALT311.StrType)le.basement_finish,(SALT311.StrType)le.src_basement_finish);
    ...
    SELF.construction_type_Invalid := Fields.InValid_construction_type((SALT311.StrType)le.construction_type,(SALT311.StrType)le.src_construction_type);
    ...
    SELF.exterior_wall_Invalid := Fields.InValid_exterior_wall((SALT311.StrType)le.exterior_wall,(SALT311.StrType)le.src_exterior_wall);
    ...
    SELF.fireplace_type_Invalid := Fields.InValid_fireplace_type((SALT311.StrType)le.fireplace_type,(SALT311.StrType)le.src_fireplace_type);
    ...
    SELF.garage_Invalid := Fields.InValid_garage((SALT311.StrType)le.garage,(SALT311.StrType)le.src_garage);
    ...
    SELF.heating_Invalid := Fields.InValid_heating((SALT311.StrType)le.heating,(SALT311.StrType)le.src_heating);
    ...
    SELF.parking_type_Invalid := Fields.InValid_parking_type((SALT311.StrType)le.parking_type,(SALT311.StrType)le.src_parking_type);
    ...
    SELF.pool_type_Invalid := Fields.InValid_pool_type((SALT311.StrType)le.pool_type,(SALT311.StrType)le.src_pool_type);
    ...
    SELF.roof_cover_Invalid := Fields.InValid_roof_cover((SALT311.StrType)le.roof_cover,(SALT311.StrType)le.src_roof_cover);
    ...
    SELF.foundation_Invalid := Fields.InValid_foundation((SALT311.StrType)le.foundation,(SALT311.StrType)le.src_foundation);
    ...
    SELF.stories_type_Invalid := Fields.InValid_stories_type((SALT311.StrType)le.stories_type,(SALT311.StrType)le.src_stories_type);
    ...
    SELF.land_use_code_Invalid := Fields.InValid_land_use_code((SALT311.StrType)le.land_use_code,(SALT311.StrType)le.src_land_use_code);
    ...
    SELF.location_influence_code_Invalid := Fields.InValid_location_influence_code((SALT311.StrType)le.location_influence_code,(SALT311.StrType)le.src_location_influence_code);
    ...
    SELF.property_type_code_Invalid := Fields.InValid_property_type_code((SALT311.StrType)le.property_type_code,(SALT311.StrType)le.src_property_type_code);
    ...
    SELF.structure_quality_Invalid := Fields.InValid_structure_quality((SALT311.StrType)le.structure_quality,(SALT311.StrType)le.src_structure_quality);
    ...
    SELF.water_Invalid := Fields.InValid_water((SALT311.StrType)le.water,(SALT311.StrType)le.src_water);
    ...
    SELF.sewer_Invalid := Fields.InValid_sewer((SALT311.StrType)le.sewer,(SALT311.StrType)le.src_sewer);
    ...
    SELF.floor_type_Invalid := Fields.InValid_floor_type((SALT311.StrType)le.floor_type,(SALT311.StrType)le.src_floor_type);
    ...
    SELF.frame_type_Invalid := Fields.InValid_frame_type((SALT311.StrType)le.frame_type,(SALT311.StrType)le.src_frame_type);
    ...
    SELF.fuel_type_Invalid := Fields.InValid_fuel_type((SALT311.StrType)le.fuel_type,(SALT311.StrType)le.src_fuel_type);
    ...
    SELF.style_type_Invalid := Fields.InValid_style_type((SALT311.StrType)le.style_type,(SALT311.StrType)le.src_style_type);
    ...
    SELF.full_part_sale_Invalid := Fields.InValid_full_part_sale((SALT311.StrType)le.full_part_sale,(SALT311.StrType)le.src_full_part_sale);
    ...
    SELF.sale_type_code_Invalid := Fields.InValid_sale_type_code((SALT311.StrType)le.sale_type_code,(SALT311.StrType)le.src_sale_type_code);
    ...
    SELF.loan_type_code_Invalid := Fields.InValid_loan_type_code((SALT311.StrType)le.loan_type_code,(SALT311.StrType)le.src_loan_type_code);
    ...
    SELF.interest_rate_type_code_Invalid := Fields.InValid_interest_rate_type_code((SALT311.StrType)le.interest_rate_type_code,(SALT311.StrType)le.src_interest_rate_type_code);
