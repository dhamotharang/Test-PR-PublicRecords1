...
EXPORT FromNone(DATASET(Layout_Property_Characteristics) h) := MODULE
  SHARED Expanded_Layout toExpanded(h le, BOOLEAN withOnfail) := TRANSFORM
    ...
    SELF.tax_sortby_date_Invalid := Fields.InValid_tax_sortby_date((SALT34.StrType)le.tax_sortby_date);
    SELF.deed_sortby_date_Invalid := Fields.InValid_deed_sortby_date((SALT34.StrType)le.deed_sortby_date);
    SELF.fares_unformatted_apn_Invalid := Fields.InValid_fares_unformatted_apn((SALT34.StrType)le.fares_unformatted_apn);
    SELF.property_street_address_Invalid := Fields.InValid_property_street_address((SALT34.StrType)le.property_street_address);
    SELF.property_city_state_zip_Invalid := Fields.InValid_property_city_state_zip((SALT34.StrType)le.property_city_state_zip);
    ...
    SELF.building_square_footage_Invalid := Fields.InValid_building_square_footage((SALT34.StrType)le.building_square_footage);
    SELF.src_building_square_footage_Invalid := Fields.InValid_src_building_square_footage((SALT34.StrType)le.src_building_square_footage);
    SELF.tax_dt_building_square_footage_Invalid := Fields.InValid_tax_dt_building_square_footage((SALT34.StrType)le.tax_dt_building_square_footage);
    SELF.air_conditioning_type_Invalid := Fields.InValid_air_conditioning_type((SALT34.StrType)le.air_conditioning_type,(SALT34.StrType)le.src_air_conditioning_type);
    SELF.src_air_conditioning_type_Invalid := Fields.InValid_src_air_conditioning_type((SALT34.StrType)le.src_air_conditioning_type);
    SELF.tax_dt_air_conditioning_type_Invalid := Fields.InValid_tax_dt_air_conditioning_type((SALT34.StrType)le.tax_dt_air_conditioning_type);
    SELF.basement_finish_Invalid := Fields.InValid_basement_finish((SALT34.StrType)le.basement_finish,(SALT34.StrType)le.src_basement_finish);
    SELF.src_basement_finish_Invalid := Fields.InValid_src_basement_finish((SALT34.StrType)le.src_basement_finish);
    SELF.tax_dt_basement_finish_Invalid := Fields.InValid_tax_dt_basement_finish((SALT34.StrType)le.tax_dt_basement_finish);
    SELF.construction_type_Invalid := Fields.InValid_construction_type((SALT34.StrType)le.construction_type,(SALT34.StrType)le.src_construction_type);
    SELF.src_construction_type_Invalid := Fields.InValid_src_construction_type((SALT34.StrType)le.src_construction_type);
    SELF.tax_dt_construction_type_Invalid := Fields.InValid_tax_dt_construction_type((SALT34.StrType)le.tax_dt_construction_type);
    SELF.exterior_wall_Invalid := Fields.InValid_exterior_wall((SALT34.StrType)le.exterior_wall,(SALT34.StrType)le.src_exterior_wall);
    SELF.src_exterior_wall_Invalid := Fields.InValid_src_exterior_wall((SALT34.StrType)le.src_exterior_wall);
    SELF.tax_dt_exterior_wall_Invalid := Fields.InValid_tax_dt_exterior_wall((SALT34.StrType)le.tax_dt_exterior_wall);
    SELF.fireplace_ind_Invalid := Fields.InValid_fireplace_ind((SALT34.StrType)le.fireplace_ind);
    SELF.src_fireplace_ind_Invalid := Fields.InValid_src_fireplace_ind((SALT34.StrType)le.src_fireplace_ind);
    SELF.tax_dt_fireplace_ind_Invalid := Fields.InValid_tax_dt_fireplace_ind((SALT34.StrType)le.tax_dt_fireplace_ind);
    SELF.fireplace_type_Invalid := Fields.InValid_fireplace_type((SALT34.StrType)le.fireplace_type,(SALT34.StrType)le.src_fireplace_type);
    SELF.src_fireplace_type_Invalid := Fields.InValid_src_fireplace_type((SALT34.StrType)le.src_fireplace_type);
    SELF.tax_dt_fireplace_type_Invalid := Fields.InValid_tax_dt_fireplace_type((SALT34.StrType)le.tax_dt_fireplace_type);
    SELF.src_flood_zone_panel_Invalid := Fields.InValid_src_flood_zone_panel((SALT34.StrType)le.src_flood_zone_panel);
    SELF.tax_dt_flood_zone_panel_Invalid := Fields.InValid_tax_dt_flood_zone_panel((SALT34.StrType)le.tax_dt_flood_zone_panel);
    SELF.garage_Invalid := Fields.InValid_garage((SALT34.StrType)le.garage,(SALT34.StrType)le.src_garage);
    SELF.src_garage_Invalid := Fields.InValid_src_garage((SALT34.StrType)le.src_garage);
    SELF.tax_dt_garage_Invalid := Fields.InValid_tax_dt_garage((SALT34.StrType)le.tax_dt_garage);
    SELF.first_floor_square_footage_Invalid := Fields.InValid_first_floor_square_footage((SALT34.StrType)le.first_floor_square_footage);
    SELF.src_first_floor_square_footage_Invalid := Fields.InValid_src_first_floor_square_footage((SALT34.StrType)le.src_first_floor_square_footage);
    SELF.tax_dt_first_floor_square_footage_Invalid := Fields.InValid_tax_dt_first_floor_square_footage((SALT34.StrType)le.tax_dt_first_floor_square_footage);
    SELF.heating_Invalid := Fields.InValid_heating((SALT34.StrType)le.heating,(SALT34.StrType)le.src_heating);
    SELF.src_heating_Invalid := Fields.InValid_src_heating((SALT34.StrType)le.src_heating);
    SELF.tax_dt_heating_Invalid := Fields.InValid_tax_dt_heating((SALT34.StrType)le.tax_dt_heating);
    SELF.living_area_square_footage_Invalid := Fields.InValid_living_area_square_footage((SALT34.StrType)le.living_area_square_footage);
    SELF.src_living_area_square_footage_Invalid := Fields.InValid_src_living_area_square_footage((SALT34.StrType)le.src_living_area_square_footage);
    SELF.tax_dt_living_area_square_footage_Invalid := Fields.InValid_tax_dt_living_area_square_footage((SALT34.StrType)le.tax_dt_living_area_square_footage);
    SELF.no_of_baths_Invalid := Fields.InValid_no_of_baths((SALT34.StrType)le.no_of_baths);
    SELF.src_no_of_baths_Invalid := Fields.InValid_src_no_of_baths((SALT34.StrType)le.src_no_of_baths);
    SELF.tax_dt_no_of_baths_Invalid := Fields.InValid_tax_dt_no_of_baths((SALT34.StrType)le.tax_dt_no_of_baths);
    SELF.no_of_bedrooms_Invalid := Fields.InValid_no_of_bedrooms((SALT34.StrType)le.no_of_bedrooms);
    SELF.src_no_of_bedrooms_Invalid := Fields.InValid_src_no_of_bedrooms((SALT34.StrType)le.src_no_of_bedrooms);
    SELF.tax_dt_no_of_bedrooms_Invalid := Fields.InValid_tax_dt_no_of_bedrooms((SALT34.StrType)le.tax_dt_no_of_bedrooms);
    SELF.no_of_fireplaces_Invalid := Fields.InValid_no_of_fireplaces((SALT34.StrType)le.no_of_fireplaces);
    SELF.src_no_of_fireplaces_Invalid := Fields.InValid_src_no_of_fireplaces((SALT34.StrType)le.src_no_of_fireplaces);
    SELF.tax_dt_no_of_fireplaces_Invalid := Fields.InValid_tax_dt_no_of_fireplaces((SALT34.StrType)le.tax_dt_no_of_fireplaces);
    SELF.no_of_full_baths_Invalid := Fields.InValid_no_of_full_baths((SALT34.StrType)le.no_of_full_baths);
    SELF.src_no_of_full_baths_Invalid := Fields.InValid_src_no_of_full_baths((SALT34.StrType)le.src_no_of_full_baths);
    SELF.tax_dt_no_of_full_baths_Invalid := Fields.InValid_tax_dt_no_of_full_baths((SALT34.StrType)le.tax_dt_no_of_full_baths);
    SELF.no_of_half_baths_Invalid := Fields.InValid_no_of_half_baths((SALT34.StrType)le.no_of_half_baths);
    SELF.src_no_of_half_baths_Invalid := Fields.InValid_src_no_of_half_baths((SALT34.StrType)le.src_no_of_half_baths);
    SELF.tax_dt_no_of_half_baths_Invalid := Fields.InValid_tax_dt_no_of_half_baths((SALT34.StrType)le.tax_dt_no_of_half_baths);
    SELF.no_of_stories_Invalid := Fields.InValid_no_of_stories((SALT34.StrType)le.no_of_stories);
    SELF.src_no_of_stories_Invalid := Fields.InValid_src_no_of_stories((SALT34.StrType)le.src_no_of_stories);
    SELF.tax_dt_no_of_stories_Invalid := Fields.InValid_tax_dt_no_of_stories((SALT34.StrType)le.tax_dt_no_of_stories);
    SELF.parking_type_Invalid := Fields.InValid_parking_type((SALT34.StrType)le.parking_type,(SALT34.StrType)le.src_parking_type);
    SELF.src_parking_type_Invalid := Fields.InValid_src_parking_type((SALT34.StrType)le.src_parking_type);
    SELF.tax_dt_parking_type_Invalid := Fields.InValid_tax_dt_parking_type((SALT34.StrType)le.tax_dt_parking_type);
    SELF.src_pool_indicator_Invalid := Fields.InValid_src_pool_indicator((SALT34.StrType)le.src_pool_indicator);
    SELF.tax_dt_pool_indicator_Invalid := Fields.InValid_tax_dt_pool_indicator((SALT34.StrType)le.tax_dt_pool_indicator);
    SELF.pool_type_Invalid := Fields.InValid_pool_type((SALT34.StrType)le.pool_type,(SALT34.StrType)le.src_pool_type);
    SELF.src_pool_type_Invalid := Fields.InValid_src_pool_type((SALT34.StrType)le.src_pool_type);
    SELF.tax_dt_pool_type_Invalid := Fields.InValid_tax_dt_pool_type((SALT34.StrType)le.tax_dt_pool_type);
    SELF.roof_cover_Invalid := Fields.InValid_roof_cover((SALT34.StrType)le.roof_cover,(SALT34.StrType)le.src_roof_cover);
    SELF.src_roof_cover_Invalid := Fields.InValid_src_roof_cover((SALT34.StrType)le.src_roof_cover);
    SELF.tax_dt_roof_cover_Invalid := Fields.InValid_tax_dt_roof_cover((SALT34.StrType)le.tax_dt_roof_cover);
    SELF.year_built_Invalid := Fields.InValid_year_built((SALT34.StrType)le.year_built);
    SELF.src_year_built_Invalid := Fields.InValid_src_year_built((SALT34.StrType)le.src_year_built);
    SELF.tax_dt_year_built_Invalid := Fields.InValid_tax_dt_year_built((SALT34.StrType)le.tax_dt_year_built);
    SELF.foundation_Invalid := Fields.InValid_foundation((SALT34.StrType)le.foundation,(SALT34.StrType)le.src_foundation);
    SELF.src_foundation_Invalid := Fields.InValid_src_foundation((SALT34.StrType)le.src_foundation);
    SELF.tax_dt_foundation_Invalid := Fields.InValid_tax_dt_foundation((SALT34.StrType)le.tax_dt_foundation);
    SELF.basement_square_footage_Invalid := Fields.InValid_basement_square_footage((SALT34.StrType)le.basement_square_footage);
    SELF.src_basement_square_footage_Invalid := Fields.InValid_src_basement_square_footage((SALT34.StrType)le.src_basement_square_footage);
    SELF.tax_dt_basement_square_footage_Invalid := Fields.InValid_tax_dt_basement_square_footage((SALT34.StrType)le.tax_dt_basement_square_footage);
    SELF.effective_year_built_Invalid := Fields.InValid_effective_year_built((SALT34.StrType)le.effective_year_built);
    SELF.src_effective_year_built_Invalid := Fields.InValid_src_effective_year_built((SALT34.StrType)le.src_effective_year_built);
    SELF.tax_dt_effective_year_built_Invalid := Fields.InValid_tax_dt_effective_year_built((SALT34.StrType)le.tax_dt_effective_year_built);
    SELF.garage_square_footage_Invalid := Fields.InValid_garage_square_footage((SALT34.StrType)le.garage_square_footage);
    SELF.src_garage_square_footage_Invalid := Fields.InValid_src_garage_square_footage((SALT34.StrType)le.src_garage_square_footage);
    SELF.tax_dt_garage_square_footage_Invalid := Fields.InValid_tax_dt_garage_square_footage((SALT34.StrType)le.tax_dt_garage_square_footage);
    SELF.stories_type_Invalid := Fields.InValid_stories_type((SALT34.StrType)le.stories_type,(SALT34.StrType)le.src_stories_type);
    SELF.src_stories_type_Invalid := Fields.InValid_src_stories_type((SALT34.StrType)le.src_stories_type);
    SELF.tax_dt_stories_type_Invalid := Fields.InValid_tax_dt_stories_type((SALT34.StrType)le.tax_dt_stories_type);
    SELF.apn_number_Invalid := Fields.InValid_apn_number((SALT34.StrType)le.apn_number);
    SELF.src_apn_number_Invalid := Fields.InValid_src_apn_number((SALT34.StrType)le.src_apn_number);
    SELF.tax_dt_apn_number_Invalid := Fields.InValid_tax_dt_apn_number((SALT34.StrType)le.tax_dt_apn_number);
    SELF.src_census_tract_Invalid := Fields.InValid_src_census_tract((SALT34.StrType)le.src_census_tract);
    SELF.tax_dt_census_tract_Invalid := Fields.InValid_tax_dt_census_tract((SALT34.StrType)le.tax_dt_census_tract);
    SELF.src_range_Invalid := Fields.InValid_src_range((SALT34.StrType)le.src_range);
    SELF.tax_dt_range_Invalid := Fields.InValid_tax_dt_range((SALT34.StrType)le.tax_dt_range);
    SELF.src_zoning_Invalid := Fields.InValid_src_zoning((SALT34.StrType)le.src_zoning);
    SELF.tax_dt_zoning_Invalid := Fields.InValid_tax_dt_zoning((SALT34.StrType)le.tax_dt_zoning);
    SELF.src_block_number_Invalid := Fields.InValid_src_block_number((SALT34.StrType)le.src_block_number);
    SELF.tax_dt_block_number_Invalid := Fields.InValid_tax_dt_block_number((SALT34.StrType)le.tax_dt_block_number);
    SELF.county_name_Invalid := Fields.InValid_county_name((SALT34.StrType)le.county_name);
    SELF.src_county_name_Invalid := Fields.InValid_src_county_name((SALT34.StrType)le.src_county_name);
    SELF.tax_dt_county_name_Invalid := Fields.InValid_tax_dt_county_name((SALT34.StrType)le.tax_dt_county_name);
    SELF.fips_code_Invalid := Fields.InValid_fips_code((SALT34.StrType)le.fips_code);
    SELF.src_fips_code_Invalid := Fields.InValid_src_fips_code((SALT34.StrType)le.src_fips_code);
    SELF.tax_dt_fips_code_Invalid := Fields.InValid_tax_dt_fips_code((SALT34.StrType)le.tax_dt_fips_code);
    SELF.src_subdivision_Invalid := Fields.InValid_src_subdivision((SALT34.StrType)le.src_subdivision);
    SELF.tax_dt_subdivision_Invalid := Fields.InValid_tax_dt_subdivision((SALT34.StrType)le.tax_dt_subdivision);
    SELF.src_municipality_Invalid := Fields.InValid_src_municipality((SALT34.StrType)le.src_municipality);
    SELF.tax_dt_municipality_Invalid := Fields.InValid_tax_dt_municipality((SALT34.StrType)le.tax_dt_municipality);
    SELF.src_township_Invalid := Fields.InValid_src_township((SALT34.StrType)le.src_township);
    SELF.tax_dt_township_Invalid := Fields.InValid_tax_dt_township((SALT34.StrType)le.tax_dt_township);
    SELF.src_homestead_exemption_ind_Invalid := Fields.InValid_src_homestead_exemption_ind((SALT34.StrType)le.src_homestead_exemption_ind);
    SELF.tax_dt_homestead_exemption_ind_Invalid := Fields.InValid_tax_dt_homestead_exemption_ind((SALT34.StrType)le.tax_dt_homestead_exemption_ind);
    SELF.land_use_code_Invalid := Fields.InValid_land_use_code((SALT34.StrType)le.land_use_code,(SALT34.StrType)le.src_land_use_code);
    SELF.src_land_use_code_Invalid := Fields.InValid_src_land_use_code((SALT34.StrType)le.src_land_use_code);
    SELF.tax_dt_land_use_code_Invalid := Fields.InValid_tax_dt_land_use_code((SALT34.StrType)le.tax_dt_land_use_code);
    SELF.src_latitude_Invalid := Fields.InValid_src_latitude((SALT34.StrType)le.src_latitude);
    SELF.tax_dt_latitude_Invalid := Fields.InValid_tax_dt_latitude((SALT34.StrType)le.tax_dt_latitude);
    SELF.src_longitude_Invalid := Fields.InValid_src_longitude((SALT34.StrType)le.src_longitude);
    SELF.tax_dt_longitude_Invalid := Fields.InValid_tax_dt_longitude((SALT34.StrType)le.tax_dt_longitude);
    SELF.location_influence_code_Invalid := Fields.InValid_location_influence_code((SALT34.StrType)le.location_influence_code,(SALT34.StrType)le.src_location_influence_code);
    SELF.src_location_influence_code_Invalid := Fields.InValid_src_location_influence_code((SALT34.StrType)le.src_location_influence_code);
    SELF.tax_dt_location_influence_code_Invalid := Fields.InValid_tax_dt_location_influence_code((SALT34.StrType)le.tax_dt_location_influence_code);
    SELF.src_acres_Invalid := Fields.InValid_src_acres((SALT34.StrType)le.src_acres);
    SELF.tax_dt_acres_Invalid := Fields.InValid_tax_dt_acres((SALT34.StrType)le.tax_dt_acres);
    SELF.src_lot_depth_footage_Invalid := Fields.InValid_src_lot_depth_footage((SALT34.StrType)le.src_lot_depth_footage);
    SELF.tax_dt_lot_depth_footage_Invalid := Fields.InValid_tax_dt_lot_depth_footage((SALT34.StrType)le.tax_dt_lot_depth_footage);
    SELF.src_lot_front_footage_Invalid := Fields.InValid_src_lot_front_footage((SALT34.StrType)le.src_lot_front_footage);
    SELF.tax_dt_lot_front_footage_Invalid := Fields.InValid_tax_dt_lot_front_footage((SALT34.StrType)le.tax_dt_lot_front_footage);
    SELF.src_lot_number_Invalid := Fields.InValid_src_lot_number((SALT34.StrType)le.src_lot_number);
    SELF.tax_dt_lot_number_Invalid := Fields.InValid_tax_dt_lot_number((SALT34.StrType)le.tax_dt_lot_number);
    SELF.src_lot_size_Invalid := Fields.InValid_src_lot_size((SALT34.StrType)le.src_lot_size);
    SELF.tax_dt_lot_size_Invalid := Fields.InValid_tax_dt_lot_size((SALT34.StrType)le.tax_dt_lot_size);
    SELF.property_type_code_Invalid := Fields.InValid_property_type_code((SALT34.StrType)le.property_type_code,(SALT34.StrType)le.src_property_type_code);
    SELF.src_property_type_code_Invalid := Fields.InValid_src_property_type_code((SALT34.StrType)le.src_property_type_code);
    SELF.tax_dt_property_type_code_Invalid := Fields.InValid_tax_dt_property_type_code((SALT34.StrType)le.tax_dt_property_type_code);
    SELF.structure_quality_Invalid := Fields.InValid_structure_quality((SALT34.StrType)le.structure_quality,(SALT34.StrType)le.src_structure_quality);
    SELF.src_structure_quality_Invalid := Fields.InValid_src_structure_quality((SALT34.StrType)le.src_structure_quality);
    SELF.tax_dt_structure_quality_Invalid := Fields.InValid_tax_dt_structure_quality((SALT34.StrType)le.tax_dt_structure_quality);
    SELF.water_Invalid := Fields.InValid_water((SALT34.StrType)le.water,(SALT34.StrType)le.src_water);
    SELF.src_water_Invalid := Fields.InValid_src_water((SALT34.StrType)le.src_water);
    SELF.tax_dt_water_Invalid := Fields.InValid_tax_dt_water((SALT34.StrType)le.tax_dt_water);
    SELF.sewer_Invalid := Fields.InValid_sewer((SALT34.StrType)le.sewer,(SALT34.StrType)le.src_sewer);
    SELF.src_sewer_Invalid := Fields.InValid_src_sewer((SALT34.StrType)le.src_sewer);
    SELF.tax_dt_sewer_Invalid := Fields.InValid_tax_dt_sewer((SALT34.StrType)le.tax_dt_sewer);
    SELF.assessed_land_value_Invalid := Fields.InValid_assessed_land_value((SALT34.StrType)le.assessed_land_value);
    SELF.src_assessed_land_value_Invalid := Fields.InValid_src_assessed_land_value((SALT34.StrType)le.src_assessed_land_value);
    SELF.tax_dt_assessed_land_value_Invalid := Fields.InValid_tax_dt_assessed_land_value((SALT34.StrType)le.tax_dt_assessed_land_value);
    SELF.assessed_year_Invalid := Fields.InValid_assessed_year((SALT34.StrType)le.assessed_year);
    SELF.src_assessed_year_Invalid := Fields.InValid_src_assessed_year((SALT34.StrType)le.src_assessed_year);
    SELF.tax_dt_assessed_year_Invalid := Fields.InValid_tax_dt_assessed_year((SALT34.StrType)le.tax_dt_assessed_year);
    SELF.tax_amount_Invalid := Fields.InValid_tax_amount((SALT34.StrType)le.tax_amount);
    SELF.src_tax_amount_Invalid := Fields.InValid_src_tax_amount((SALT34.StrType)le.src_tax_amount);
    SELF.tax_dt_tax_amount_Invalid := Fields.InValid_tax_dt_tax_amount((SALT34.StrType)le.tax_dt_tax_amount);
    SELF.tax_year_Invalid := Fields.InValid_tax_year((SALT34.StrType)le.tax_year);
    SELF.src_tax_year_Invalid := Fields.InValid_src_tax_year((SALT34.StrType)le.src_tax_year);
    SELF.market_land_value_Invalid := Fields.InValid_market_land_value((SALT34.StrType)le.market_land_value);
    SELF.src_market_land_value_Invalid := Fields.InValid_src_market_land_value((SALT34.StrType)le.src_market_land_value);
    SELF.tax_dt_market_land_value_Invalid := Fields.InValid_tax_dt_market_land_value((SALT34.StrType)le.tax_dt_market_land_value);
    SELF.improvement_value_Invalid := Fields.InValid_improvement_value((SALT34.StrType)le.improvement_value);
    SELF.src_improvement_value_Invalid := Fields.InValid_src_improvement_value((SALT34.StrType)le.src_improvement_value);
    SELF.tax_dt_improvement_value_Invalid := Fields.InValid_tax_dt_improvement_value((SALT34.StrType)le.tax_dt_improvement_value);
    SELF.src_percent_improved_Invalid := Fields.InValid_src_percent_improved((SALT34.StrType)le.src_percent_improved);
    SELF.tax_dt_percent_improved_Invalid := Fields.InValid_tax_dt_percent_improved((SALT34.StrType)le.tax_dt_percent_improved);
    SELF.total_assessed_value_Invalid := Fields.InValid_total_assessed_value((SALT34.StrType)le.total_assessed_value);
    SELF.src_total_assessed_value_Invalid := Fields.InValid_src_total_assessed_value((SALT34.StrType)le.src_total_assessed_value);
    SELF.tax_dt_total_assessed_value_Invalid := Fields.InValid_tax_dt_total_assessed_value((SALT34.StrType)le.tax_dt_total_assessed_value);
    SELF.total_calculated_value_Invalid := Fields.InValid_total_calculated_value((SALT34.StrType)le.total_calculated_value);
    SELF.src_total_calculated_value_Invalid := Fields.InValid_src_total_calculated_value((SALT34.StrType)le.src_total_calculated_value);
    SELF.tax_dt_total_calculated_value_Invalid := Fields.InValid_tax_dt_total_calculated_value((SALT34.StrType)le.tax_dt_total_calculated_value);
    SELF.total_land_value_Invalid := Fields.InValid_total_land_value((SALT34.StrType)le.total_land_value);
    SELF.src_total_land_value_Invalid := Fields.InValid_src_total_land_value((SALT34.StrType)le.src_total_land_value);
    SELF.tax_dt_total_land_value_Invalid := Fields.InValid_tax_dt_total_land_value((SALT34.StrType)le.tax_dt_total_land_value);
    SELF.total_market_value_Invalid := Fields.InValid_total_market_value((SALT34.StrType)le.total_market_value);
    SELF.src_total_market_value_Invalid := Fields.InValid_src_total_market_value((SALT34.StrType)le.src_total_market_value);
    SELF.tax_dt_total_market_value_Invalid := Fields.InValid_tax_dt_total_market_value((SALT34.StrType)le.tax_dt_total_market_value);
    SELF.floor_type_Invalid := Fields.InValid_floor_type((SALT34.StrType)le.floor_type,(SALT34.StrType)le.src_floor_type);
    SELF.src_floor_type_Invalid := Fields.InValid_src_floor_type((SALT34.StrType)le.src_floor_type);
    SELF.tax_dt_floor_type_Invalid := Fields.InValid_tax_dt_floor_type((SALT34.StrType)le.tax_dt_floor_type);
    SELF.frame_type_Invalid := Fields.InValid_frame_type((SALT34.StrType)le.frame_type,(SALT34.StrType)le.src_frame_type);
    SELF.src_frame_type_Invalid := Fields.InValid_src_frame_type((SALT34.StrType)le.src_frame_type);
    SELF.tax_dt_frame_type_Invalid := Fields.InValid_tax_dt_frame_type((SALT34.StrType)le.tax_dt_frame_type);
    SELF.fuel_type_Invalid := Fields.InValid_fuel_type((SALT34.StrType)le.fuel_type,(SALT34.StrType)le.src_fuel_type);
    SELF.src_fuel_type_Invalid := Fields.InValid_src_fuel_type((SALT34.StrType)le.src_fuel_type);
    SELF.tax_dt_fuel_type_Invalid := Fields.InValid_tax_dt_fuel_type((SALT34.StrType)le.tax_dt_fuel_type);
    SELF.no_of_bath_fixtures_Invalid := Fields.InValid_no_of_bath_fixtures((SALT34.StrType)le.no_of_bath_fixtures);
    SELF.src_no_of_bath_fixtures_Invalid := Fields.InValid_src_no_of_bath_fixtures((SALT34.StrType)le.src_no_of_bath_fixtures);
    SELF.tax_dt_no_of_bath_fixtures_Invalid := Fields.InValid_tax_dt_no_of_bath_fixtures((SALT34.StrType)le.tax_dt_no_of_bath_fixtures);
    SELF.no_of_rooms_Invalid := Fields.InValid_no_of_rooms((SALT34.StrType)le.no_of_rooms);
    SELF.src_no_of_rooms_Invalid := Fields.InValid_src_no_of_rooms((SALT34.StrType)le.src_no_of_rooms);
    SELF.tax_dt_no_of_rooms_Invalid := Fields.InValid_tax_dt_no_of_rooms((SALT34.StrType)le.tax_dt_no_of_rooms);
    SELF.no_of_units_Invalid := Fields.InValid_no_of_units((SALT34.StrType)le.no_of_units);
    SELF.src_no_of_units_Invalid := Fields.InValid_src_no_of_units((SALT34.StrType)le.src_no_of_units);
    SELF.tax_dt_no_of_units_Invalid := Fields.InValid_tax_dt_no_of_units((SALT34.StrType)le.tax_dt_no_of_units);
    SELF.style_type_Invalid := Fields.InValid_style_type((SALT34.StrType)le.style_type,(SALT34.StrType)le.src_style_type);
    SELF.src_style_type_Invalid := Fields.InValid_src_style_type((SALT34.StrType)le.src_style_type);
    SELF.tax_dt_style_type_Invalid := Fields.InValid_tax_dt_style_type((SALT34.StrType)le.tax_dt_style_type);
    SELF.assessment_document_number_Invalid := Fields.InValid_assessment_document_number((SALT34.StrType)le.assessment_document_number);
    SELF.src_assessment_document_number_Invalid := Fields.InValid_src_assessment_document_number((SALT34.StrType)le.src_assessment_document_number);
    SELF.tax_dt_assessment_document_number_Invalid := Fields.InValid_tax_dt_assessment_document_number((SALT34.StrType)le.tax_dt_assessment_document_number);
    SELF.assessment_recording_date_Invalid := Fields.InValid_assessment_recording_date((SALT34.StrType)le.assessment_recording_date);
    SELF.src_assessment_recording_date_Invalid := Fields.InValid_src_assessment_recording_date((SALT34.StrType)le.src_assessment_recording_date);
    SELF.tax_dt_assessment_recording_date_Invalid := Fields.InValid_tax_dt_assessment_recording_date((SALT34.StrType)le.tax_dt_assessment_recording_date);
    SELF.deed_document_number_Invalid := Fields.InValid_deed_document_number((SALT34.StrType)le.deed_document_number);
    SELF.src_deed_document_number_Invalid := Fields.InValid_src_deed_document_number((SALT34.StrType)le.src_deed_document_number);
    SELF.rec_dt_deed_document_number_Invalid := Fields.InValid_rec_dt_deed_document_number((SALT34.StrType)le.rec_dt_deed_document_number);
    SELF.deed_recording_date_Invalid := Fields.InValid_deed_recording_date((SALT34.StrType)le.deed_recording_date);
    SELF.src_deed_recording_date_Invalid := Fields.InValid_src_deed_recording_date((SALT34.StrType)le.src_deed_recording_date);
    SELF.full_part_sale_Invalid := Fields.InValid_full_part_sale((SALT34.StrType)le.full_part_sale,(SALT34.StrType)le.src_full_part_sale);
    SELF.src_full_part_sale_Invalid := Fields.InValid_src_full_part_sale((SALT34.StrType)le.src_full_part_sale);
    SELF.rec_dt_full_part_sale_Invalid := Fields.InValid_rec_dt_full_part_sale((SALT34.StrType)le.rec_dt_full_part_sale);
    SELF.sale_amount_Invalid := Fields.InValid_sale_amount((SALT34.StrType)le.sale_amount);
    SELF.src_sale_amount_Invalid := Fields.InValid_src_sale_amount((SALT34.StrType)le.src_sale_amount);
    SELF.rec_dt_sale_amount_Invalid := Fields.InValid_rec_dt_sale_amount((SALT34.StrType)le.rec_dt_sale_amount);
    SELF.sale_date_Invalid := Fields.InValid_sale_date((SALT34.StrType)le.sale_date);
    SELF.src_sale_date_Invalid := Fields.InValid_src_sale_date((SALT34.StrType)le.src_sale_date);
    SELF.rec_dt_sale_date_Invalid := Fields.InValid_rec_dt_sale_date((SALT34.StrType)le.rec_dt_sale_date);
    SELF.sale_type_code_Invalid := Fields.InValid_sale_type_code((SALT34.StrType)le.sale_type_code,(SALT34.StrType)le.src_sale_type_code);
    SELF.src_sale_type_code_Invalid := Fields.InValid_src_sale_type_code((SALT34.StrType)le.src_sale_type_code);
    SELF.rec_dt_sale_type_code_Invalid := Fields.InValid_rec_dt_sale_type_code((SALT34.StrType)le.rec_dt_sale_type_code);
    SELF.mortgage_company_name_Invalid := Fields.InValid_mortgage_company_name((SALT34.StrType)le.mortgage_company_name);
    SELF.src_mortgage_company_name_Invalid := Fields.InValid_src_mortgage_company_name((SALT34.StrType)le.src_mortgage_company_name);
    SELF.rec_dt_mortgage_company_name_Invalid := Fields.InValid_rec_dt_mortgage_company_name((SALT34.StrType)le.rec_dt_mortgage_company_name);
    SELF.loan_amount_Invalid := Fields.InValid_loan_amount((SALT34.StrType)le.loan_amount);
    SELF.src_loan_amount_Invalid := Fields.InValid_src_loan_amount((SALT34.StrType)le.src_loan_amount);
    SELF.rec_dt_loan_amount_Invalid := Fields.InValid_rec_dt_loan_amount((SALT34.StrType)le.rec_dt_loan_amount);
    SELF.second_loan_amount_Invalid := Fields.InValid_second_loan_amount((SALT34.StrType)le.second_loan_amount);
    SELF.src_second_loan_amount_Invalid := Fields.InValid_src_second_loan_amount((SALT34.StrType)le.src_second_loan_amount);
    SELF.rec_dt_second_loan_amount_Invalid := Fields.InValid_rec_dt_second_loan_amount((SALT34.StrType)le.rec_dt_second_loan_amount);
    SELF.loan_type_code_Invalid := Fields.InValid_loan_type_code((SALT34.StrType)le.loan_type_code,(SALT34.StrType)le.src_loan_type_code);
    SELF.src_loan_type_code_Invalid := Fields.InValid_src_loan_type_code((SALT34.StrType)le.src_loan_type_code);
    SELF.rec_dt_loan_type_code_Invalid := Fields.InValid_rec_dt_loan_type_code((SALT34.StrType)le.rec_dt_loan_type_code);
    SELF.interest_rate_type_code_Invalid := Fields.InValid_interest_rate_type_code((SALT34.StrType)le.interest_rate_type_code,(SALT34.StrType)le.src_interest_rate_type_code);
    SELF.src_interest_rate_type_code_Invalid := Fields.InValid_src_interest_rate_type_code((SALT34.StrType)le.src_interest_rate_type_code);
    SELF.rec_dt_interest_rate_type_code_Invalid := Fields.InValid_rec_dt_interest_rate_type_code((SALT34.StrType)le.rec_dt_interest_rate_type_code);
    SELF := le;
  END;
  EXPORT ExpandedInfile0 := PROJECT(h,toExpanded(LEFT,FALSE));
  EXPORT ProcessedInfile0 := PROJECT(PROJECT(h,toExpanded(LEFT,TRUE)),Layout_Property_Characteristics);
  EXPORT WithinList1 := DEDUP(SORT(TABLE(Scrubs_LN_PropertyV2_Assessor.file_fips,{fips_code}),fips_code),ALL) : PERSIST('~temp::Scrubs_Property_Characteristics::Scrubs_LN_PropertyV2_Assessor.file_fips::fips_code',EXPIRE(Config.PersistExpire));
...
EXPORT FromExpanded(DATASET(Expanded_Layout) h) := MODULE
  r := RECORD
    ...
    fares_unformatted_apn_LENGTH_ErrorCount := COUNT(GROUP,h.fares_unformatted_apn_Invalid=2);
    ...
    src_building_square_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_building_square_footage_Invalid=2);
    ...
    src_air_conditioning_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_air_conditioning_type_Invalid=2);
    ...
    src_basement_finish_LENGTH_ErrorCount := COUNT(GROUP,h.src_basement_finish_Invalid=2);
    ...
    src_construction_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_construction_type_Invalid=2);
    ...
    src_exterior_wall_LENGTH_ErrorCount := COUNT(GROUP,h.src_exterior_wall_Invalid=2);
    ...
    src_fireplace_ind_LENGTH_ErrorCount := COUNT(GROUP,h.src_fireplace_ind_Invalid=2);
    ...
    src_fireplace_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_fireplace_type_Invalid=2);
    ...
    src_flood_zone_panel_LENGTH_ErrorCount := COUNT(GROUP,h.src_flood_zone_panel_Invalid=2);
    ...
    src_garage_LENGTH_ErrorCount := COUNT(GROUP,h.src_garage_Invalid=2);
    ...
    src_first_floor_square_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_first_floor_square_footage_Invalid=2);
    ...
    src_heating_LENGTH_ErrorCount := COUNT(GROUP,h.src_heating_Invalid=2);
    ...
    src_living_area_square_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_living_area_square_footage_Invalid=2);
    ...
    src_no_of_baths_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_baths_Invalid=2);
    ...
    src_no_of_bedrooms_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_bedrooms_Invalid=2);
    ...
    src_no_of_fireplaces_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_fireplaces_Invalid=2);
    ...
    src_no_of_full_baths_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_full_baths_Invalid=2);
    ...
    src_no_of_half_baths_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_half_baths_Invalid=2);
    ...
    src_no_of_stories_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_stories_Invalid=2);
    ...
    src_parking_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_parking_type_Invalid=2);
    ...
    src_pool_indicator_LENGTH_ErrorCount := COUNT(GROUP,h.src_pool_indicator_Invalid=2);
    ...
    src_pool_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_pool_type_Invalid=2);
    ...
    src_roof_cover_LENGTH_ErrorCount := COUNT(GROUP,h.src_roof_cover_Invalid=2);
    ...
    year_built_INRANGE_ErrorCount := COUNT(GROUP,h.year_built_Invalid=2);
    year_built_LENGTH_ErrorCount := COUNT(GROUP,h.year_built_Invalid=3);
    ...
    src_year_built_LENGTH_ErrorCount := COUNT(GROUP,h.src_year_built_Invalid=2);
    ...
    src_foundation_LENGTH_ErrorCount := COUNT(GROUP,h.src_foundation_Invalid=2);
    ...
    src_basement_square_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_basement_square_footage_Invalid=2);
    ...
    effective_year_built_INRANGE_ErrorCount := COUNT(GROUP,h.effective_year_built_Invalid=2);
    effective_year_built_LENGTH_ErrorCount := COUNT(GROUP,h.effective_year_built_Invalid=3);
    ...
    src_effective_year_built_LENGTH_ErrorCount := COUNT(GROUP,h.src_effective_year_built_Invalid=2);
    ...
    src_garage_square_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_garage_square_footage_Invalid=2);
    ...
    src_stories_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_stories_type_Invalid=2);
    ...
    apn_number_LENGTH_ErrorCount := COUNT(GROUP,h.apn_number_Invalid=2);
    ...
    src_apn_number_LENGTH_ErrorCount := COUNT(GROUP,h.src_apn_number_Invalid=2);
    ...
    src_census_tract_LENGTH_ErrorCount := COUNT(GROUP,h.src_census_tract_Invalid=2);
    ...
    src_range_LENGTH_ErrorCount := COUNT(GROUP,h.src_range_Invalid=2);
    ...
    src_zoning_LENGTH_ErrorCount := COUNT(GROUP,h.src_zoning_Invalid=2);
    ...
    src_block_number_LENGTH_ErrorCount := COUNT(GROUP,h.src_block_number_Invalid=2);
    ...
    src_county_name_LENGTH_ErrorCount := COUNT(GROUP,h.src_county_name_Invalid=2);
    ...
    src_fips_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_fips_code_Invalid=2);
    ...
    src_subdivision_LENGTH_ErrorCount := COUNT(GROUP,h.src_subdivision_Invalid=2);
    ...
    src_municipality_LENGTH_ErrorCount := COUNT(GROUP,h.src_municipality_Invalid=2);
    ...
    src_township_LENGTH_ErrorCount := COUNT(GROUP,h.src_township_Invalid=2);
    ...
    src_homestead_exemption_ind_LENGTH_ErrorCount := COUNT(GROUP,h.src_homestead_exemption_ind_Invalid=2);
    ...
    src_land_use_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_land_use_code_Invalid=2);
    ...
    src_latitude_LENGTH_ErrorCount := COUNT(GROUP,h.src_latitude_Invalid=2);
    ...
    src_longitude_LENGTH_ErrorCount := COUNT(GROUP,h.src_longitude_Invalid=2);
    ...
    src_location_influence_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_location_influence_code_Invalid=2);
    ...
    src_acres_LENGTH_ErrorCount := COUNT(GROUP,h.src_acres_Invalid=2);
    ...
    src_lot_depth_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_lot_depth_footage_Invalid=2);
    ...
    src_lot_front_footage_LENGTH_ErrorCount := COUNT(GROUP,h.src_lot_front_footage_Invalid=2);
    ...
    src_lot_number_LENGTH_ErrorCount := COUNT(GROUP,h.src_lot_number_Invalid=2);
    ...
    src_lot_size_LENGTH_ErrorCount := COUNT(GROUP,h.src_lot_size_Invalid=2);
    ...
    src_property_type_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_property_type_code_Invalid=2);
    ...
    src_structure_quality_LENGTH_ErrorCount := COUNT(GROUP,h.src_structure_quality_Invalid=2);
    ...
    src_water_LENGTH_ErrorCount := COUNT(GROUP,h.src_water_Invalid=2);
    ...
    src_sewer_LENGTH_ErrorCount := COUNT(GROUP,h.src_sewer_Invalid=2);
    ...
    src_assessed_land_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_assessed_land_value_Invalid=2);
    ...
    assessed_year_INRANGE_ErrorCount := COUNT(GROUP,h.assessed_year_Invalid=2);
    assessed_year_LENGTH_ErrorCount := COUNT(GROUP,h.assessed_year_Invalid=3);
    ...
    src_assessed_year_LENGTH_ErrorCount := COUNT(GROUP,h.src_assessed_year_Invalid=2);
    ...
    src_tax_amount_LENGTH_ErrorCount := COUNT(GROUP,h.src_tax_amount_Invalid=2);
    ...
    tax_year_INRANGE_ErrorCount := COUNT(GROUP,h.tax_year_Invalid=2);
    tax_year_LENGTH_ErrorCount := COUNT(GROUP,h.tax_year_Invalid=3);
    ...
    src_tax_year_LENGTH_ErrorCount := COUNT(GROUP,h.src_tax_year_Invalid=2);
    ...
    src_market_land_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_market_land_value_Invalid=2);
    ...
    src_improvement_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_improvement_value_Invalid=2);
    ...
    src_percent_improved_LENGTH_ErrorCount := COUNT(GROUP,h.src_percent_improved_Invalid=2);
    ...
    src_total_assessed_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_total_assessed_value_Invalid=2);
    ...
    src_total_calculated_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_total_calculated_value_Invalid=2);
    ...
    src_total_land_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_total_land_value_Invalid=2);
    ...
    src_total_market_value_LENGTH_ErrorCount := COUNT(GROUP,h.src_total_market_value_Invalid=2);
    ...
    src_floor_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_floor_type_Invalid=2);
    ...
    src_frame_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_frame_type_Invalid=2);
    ...
    src_fuel_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_fuel_type_Invalid=2);
    ...
    src_no_of_bath_fixtures_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_bath_fixtures_Invalid=2);
    ...
    src_no_of_rooms_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_rooms_Invalid=2);
    ...
    src_no_of_units_LENGTH_ErrorCount := COUNT(GROUP,h.src_no_of_units_Invalid=2);
    ...
    src_style_type_LENGTH_ErrorCount := COUNT(GROUP,h.src_style_type_Invalid=2);
    ...
    src_assessment_document_number_LENGTH_ErrorCount := COUNT(GROUP,h.src_assessment_document_number_Invalid=2);
    ...
    src_assessment_recording_date_LENGTH_ErrorCount := COUNT(GROUP,h.src_assessment_recording_date_Invalid=2);
    ...
    src_deed_document_number_LENGTH_ErrorCount := COUNT(GROUP,h.src_deed_document_number_Invalid=2);
    ...
    src_deed_recording_date_LENGTH_ErrorCount := COUNT(GROUP,h.src_deed_recording_date_Invalid=2);
    ...
    src_full_part_sale_LENGTH_ErrorCount := COUNT(GROUP,h.src_full_part_sale_Invalid=2);
    ...
    src_sale_amount_LENGTH_ErrorCount := COUNT(GROUP,h.src_sale_amount_Invalid=2);
    ...
    src_sale_date_LENGTH_ErrorCount := COUNT(GROUP,h.src_sale_date_Invalid=2);
    ...
    src_sale_type_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_sale_type_code_Invalid=2);
    ...
    src_mortgage_company_name_LENGTH_ErrorCount := COUNT(GROUP,h.src_mortgage_company_name_Invalid=2);
    ...
    src_loan_amount_LENGTH_ErrorCount := COUNT(GROUP,h.src_loan_amount_Invalid=2);
    ...
    src_second_loan_amount_LENGTH_ErrorCount := COUNT(GROUP,h.src_second_loan_amount_Invalid=2);
    ...
    src_loan_type_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_loan_type_code_Invalid=2);
    ...
    src_interest_rate_type_code_LENGTH_ErrorCount := COUNT(GROUP,h.src_interest_rate_type_code_Invalid=2);
  ...
  END;
  EXPORT SummaryStats := TABLE(h,r,vendor_source,FEW);
  r := RECORD
    STRING10 Src;
    STRING FieldName;
    STRING FieldType;
  ...
  r into(h le,UNSIGNED c) := TRANSFORM
    ...
    SELF.ErrorType := IF ( ErrNum = 0, SKIP, CHOOSE(c
          ...
          ,CHOOSE(le.fares_unformatted_apn_Invalid,'ALLOW','LENGTH','UNKNOWN')
    ...
    SELF.FieldContents := CHOOSE(c,(SALT34.StrType)le.dt_vendor_first_reported,(SALT34.StrType)le.dt_vendor_last_reported,(SALT34.StrType)le.tax_sortby_date,(SALT34.StrType)le.deed_sortby_date,(SALT34.StrType)le.fares_unformatted_apn,(SALT34.StrType)le.property_street_address,(SALT34.StrType)le.property_city_state_zip,(SALT34.StrType)le.prim_range,(SALT34.StrType)le.predir,(SALT34.StrType)le.prim_name,(SALT34.StrType)le.addr_suffix,(SALT34.StrType)le.postdir,(SALT34.StrType)le.unit_desig,(SALT34.StrType)le.sec_range,(SALT34.StrType)le.p_city_name,(SALT34.StrType)le.v_city_name,(SALT34.StrType)le.zip,(SALT34.StrType)le.zip4,(SALT34.StrType)le.building_square_footage,(SALT34.StrType)le.src_building_square_footage,(SALT34.StrType)le.tax_dt_building_square_footage,(SALT34.StrType)le.air_conditioning_type,(SALT34.StrType)le.src_air_conditioning_type,(SALT34.StrType)le.tax_dt_air_conditioning_type,(SALT34.StrType)le.basement_finish,(SALT34.StrType)le.src_basement_finish,(SALT34.StrType)le.tax_dt_basement_finish,(SALT34.StrType)le.construction_type,(SALT34.StrType)le.src_construction_type,(SALT34.StrType)le.tax_dt_construction_type,(SALT34.StrType)le.exterior_wall,(SALT34.StrType)le.src_exterior_wall,(SALT34.StrType)le.tax_dt_exterior_wall,(SALT34.StrType)le.fireplace_ind,(SALT34.StrType)le.src_fireplace_ind,(SALT34.StrType)le.tax_dt_fireplace_ind,(SALT34.StrType)le.fireplace_type,(SALT34.StrType)le.src_fireplace_type,(SALT34.StrType)le.tax_dt_fireplace_type,(SALT34.StrType)le.src_flood_zone_panel,(SALT34.StrType)le.tax_dt_flood_zone_panel,(SALT34.StrType)le.garage,(SALT34.StrType)le.src_garage,(SALT34.StrType)le.tax_dt_garage,(SALT34.StrType)le.first_floor_square_footage,(SALT34.StrType)le.src_first_floor_square_footage,(SALT34.StrType)le.tax_dt_first_floor_square_footage,(SALT34.StrType)le.heating,(SALT34.StrType)le.src_heating,(SALT34.StrType)le.tax_dt_heating,(SALT34.StrType)le.living_area_square_footage,(SALT34.StrType)le.src_living_area_square_footage,(SALT34.StrType)le.tax_dt_living_area_square_footage,(SALT34.StrType)le.no_of_baths,(SALT34.StrType)le.src_no_of_baths,(SALT34.StrType)le.tax_dt_no_of_baths,(SALT34.StrType)le.no_of_bedrooms,(SALT34.StrType)le.src_no_of_bedrooms,(SALT34.StrType)le.tax_dt_no_of_bedrooms,(SALT34.StrType)le.no_of_fireplaces,(SALT34.StrType)le.src_no_of_fireplaces,(SALT34.StrType)le.tax_dt_no_of_fireplaces,(SALT34.StrType)le.no_of_full_baths,(SALT34.StrType)le.src_no_of_full_baths,(SALT34.StrType)le.tax_dt_no_of_full_baths,(SALT34.StrType)le.no_of_half_baths,(SALT34.StrType)le.src_no_of_half_baths,(SALT34.StrType)le.tax_dt_no_of_half_baths,(SALT34.StrType)le.no_of_stories,(SALT34.StrType)le.src_no_of_stories,(SALT34.StrType)le.tax_dt_no_of_stories,(SALT34.StrType)le.parking_type,(SALT34.StrType)le.src_parking_type,(SALT34.StrType)le.tax_dt_parking_type,(SALT34.StrType)le.src_pool_indicator,(SALT34.StrType)le.tax_dt_pool_indicator,(SALT34.StrType)le.pool_type,(SALT34.StrType)le.src_pool_type,(SALT34.StrType)le.tax_dt_pool_type,(SALT34.StrType)le.roof_cover,(SALT34.StrType)le.src_roof_cover,(SALT34.StrType)le.tax_dt_roof_cover,(SALT34.StrType)le.year_built,(SALT34.StrType)le.src_year_built,(SALT34.StrType)le.tax_dt_year_built,(SALT34.StrType)le.foundation,(SALT34.StrType)le.src_foundation,(SALT34.StrType)le.tax_dt_foundation,(SALT34.StrType)le.basement_square_footage,(SALT34.StrType)le.src_basement_square_footage,(SALT34.StrType)le.tax_dt_basement_square_footage,(SALT34.StrType)le.effective_year_built,(SALT34.StrType)le.src_effective_year_built,(SALT34.StrType)le.tax_dt_effective_year_built,(SALT34.StrType)le.garage_square_footage,(SALT34.StrType)le.src_garage_square_footage,(SALT34.StrType)le.tax_dt_garage_square_footage,(SALT34.StrType)le.stories_type,(SALT34.StrType)le.src_stories_type,(SALT34.StrType)le.tax_dt_stories_type,(SALT34.StrType)le.apn_number,(SALT34.StrType)le.src_apn_number,(SALT34.StrType)le.tax_dt_apn_number,(SALT34.StrType)le.src_census_tract,(SALT34.StrType)le.tax_dt_census_tract,(SALT34.StrType)le.src_range,(SALT34.StrType)le.tax_dt_range,(SALT34.StrType)le.src_zoning,(SALT34.StrType)le.tax_dt_zoning,(SALT34.StrType)le.src_block_number,(SALT34.StrType)le.tax_dt_block_number,(SALT34.StrType)le.county_name,(SALT34.StrType)le.src_county_name,(SALT34.StrType)le.tax_dt_county_name,(SALT34.StrType)le.fips_code,(SALT34.StrType)le.src_fips_code,(SALT34.StrType)le.tax_dt_fips_code,(SALT34.StrType)le.src_subdivision,(SALT34.StrType)le.tax_dt_subdivision,(SALT34.StrType)le.src_municipality,(SALT34.StrType)le.tax_dt_municipality,(SALT34.StrType)le.src_township,(SALT34.StrType)le.tax_dt_township,(SALT34.StrType)le.src_homestead_exemption_ind,(SALT34.StrType)le.tax_dt_homestead_exemption_ind,(SALT34.StrType)le.land_use_code,(SALT34.StrType)le.src_land_use_code,(SALT34.StrType)le.tax_dt_land_use_code,(SALT34.StrType)le.src_latitude,(SALT34.StrType)le.tax_dt_latitude,(SALT34.StrType)le.src_longitude,(SALT34.StrType)le.tax_dt_longitude,(SALT34.StrType)le.location_influence_code,(SALT34.StrType)le.src_location_influence_code,(SALT34.StrType)le.tax_dt_location_influence_code,(SALT34.StrType)le.src_acres,(SALT34.StrType)le.tax_dt_acres,(SALT34.StrType)le.src_lot_depth_footage,(SALT34.StrType)le.tax_dt_lot_depth_footage,(SALT34.StrType)le.src_lot_front_footage,(SALT34.StrType)le.tax_dt_lot_front_footage,(SALT34.StrType)le.src_lot_number,(SALT34.StrType)le.tax_dt_lot_number,(SALT34.StrType)le.src_lot_size,(SALT34.StrType)le.tax_dt_lot_size,(SALT34.StrType)le.property_type_code,(SALT34.StrType)le.src_property_type_code,(SALT34.StrType)le.tax_dt_property_type_code,(SALT34.StrType)le.structure_quality,(SALT34.StrType)le.src_structure_quality,(SALT34.StrType)le.tax_dt_structure_quality,(SALT34.StrType)le.water,(SALT34.StrType)le.src_water,(SALT34.StrType)le.tax_dt_water,(SALT34.StrType)le.sewer,(SALT34.StrType)le.src_sewer,(SALT34.StrType)le.tax_dt_sewer,(SALT34.StrType)le.assessed_land_value,(SALT34.StrType)le.src_assessed_land_value,(SALT34.StrType)le.tax_dt_assessed_land_value,(SALT34.StrType)le.assessed_year,(SALT34.StrType)le.src_assessed_year,(SALT34.StrType)le.tax_dt_assessed_year,(SALT34.StrType)le.tax_amount,(SALT34.StrType)le.src_tax_amount,(SALT34.StrType)le.tax_dt_tax_amount,(SALT34.StrType)le.tax_year,(SALT34.StrType)le.src_tax_year,(SALT34.StrType)le.market_land_value,(SALT34.StrType)le.src_market_land_value,(SALT34.StrType)le.tax_dt_market_land_value,(SALT34.StrType)le.improvement_value,(SALT34.StrType)le.src_improvement_value,(SALT34.StrType)le.tax_dt_improvement_value,(SALT34.StrType)le.src_percent_improved,(SALT34.StrType)le.tax_dt_percent_improved,(SALT34.StrType)le.total_assessed_value,(SALT34.StrType)le.src_total_assessed_value,(SALT34.StrType)le.tax_dt_total_assessed_value,(SALT34.StrType)le.total_calculated_value,(SALT34.StrType)le.src_total_calculated_value,(SALT34.StrType)le.tax_dt_total_calculated_value,(SALT34.StrType)le.total_land_value,(SALT34.StrType)le.src_total_land_value,(SALT34.StrType)le.tax_dt_total_land_value,(SALT34.StrType)le.total_market_value,(SALT34.StrType)le.src_total_market_value,(SALT34.StrType)le.tax_dt_total_market_value,(SALT34.StrType)le.floor_type,(SALT34.StrType)le.src_floor_type,(SALT34.StrType)le.tax_dt_floor_type,(SALT34.StrType)le.frame_type,(SALT34.StrType)le.src_frame_type,(SALT34.StrType)le.tax_dt_frame_type,(SALT34.StrType)le.fuel_type,(SALT34.StrType)le.src_fuel_type,(SALT34.StrType)le.tax_dt_fuel_type,(SALT34.StrType)le.no_of_bath_fixtures,(SALT34.StrType)le.src_no_of_bath_fixtures,(SALT34.StrType)le.tax_dt_no_of_bath_fixtures,(SALT34.StrType)le.no_of_rooms,(SALT34.StrType)le.src_no_of_rooms,(SALT34.StrType)le.tax_dt_no_of_rooms,(SALT34.StrType)le.no_of_units,(SALT34.StrType)le.src_no_of_units,(SALT34.StrType)le.tax_dt_no_of_units,(SALT34.StrType)le.style_type,(SALT34.StrType)le.src_style_type,(SALT34.StrType)le.tax_dt_style_type,(SALT34.StrType)le.assessment_document_number,(SALT34.StrType)le.src_assessment_document_number,(SALT34.StrType)le.tax_dt_assessment_document_number,(SALT34.StrType)le.assessment_recording_date,(SALT34.StrType)le.src_assessment_recording_date,(SALT34.StrType)le.tax_dt_assessment_recording_date,(SALT34.StrType)le.deed_document_number,(SALT34.StrType)le.src_deed_document_number,(SALT34.StrType)le.rec_dt_deed_document_number,(SALT34.StrType)le.deed_recording_date,(SALT34.StrType)le.src_deed_recording_date,(SALT34.StrType)le.full_part_sale,(SALT34.StrType)le.src_full_part_sale,(SALT34.StrType)le.rec_dt_full_part_sale,(SALT34.StrType)le.sale_amount,(SALT34.StrType)le.src_sale_amount,(SALT34.StrType)le.rec_dt_sale_amount,(SALT34.StrType)le.sale_date,(SALT34.StrType)le.src_sale_date,(SALT34.StrType)le.rec_dt_sale_date,(SALT34.StrType)le.sale_type_code,(SALT34.StrType)le.src_sale_type_code,(SALT34.StrType)le.rec_dt_sale_type_code,(SALT34.StrType)le.mortgage_company_name,(SALT34.StrType)le.src_mortgage_company_name,(SALT34.StrType)le.rec_dt_mortgage_company_name,(SALT34.StrType)le.loan_amount,(SALT34.StrType)le.src_loan_amount,(SALT34.StrType)le.rec_dt_loan_amount,(SALT34.StrType)le.second_loan_amount,(SALT34.StrType)le.src_second_loan_amount,(SALT34.StrType)le.rec_dt_second_loan_amount,(SALT34.StrType)le.loan_type_code,(SALT34.StrType)le.src_loan_type_code,(SALT34.StrType)le.rec_dt_loan_type_code,(SALT34.StrType)le.interest_rate_type_code,(SALT34.StrType)le.src_interest_rate_type_code,(SALT34.StrType)le.rec_dt_interest_rate_type_code,'***SALTBUG***');
  END;
  ...
  EXPORT OrbitStats(UNSIGNED examples = 10,UNSIGNED Pdate=(UNSIGNED)StringLib.getdateYYYYMMDD()) := FUNCTION
    SALT34.ScrubsOrbitLayout Into(SummaryStats le, UNSIGNED c) := TRANSFORM
      ...
      SELF.ruledesc := CHOOSE(c
          ...
          ,'fares_unformatted_apn:invalid_apn:ALLOW','fares_unformatted_apn:invalid_apn:LENGTH'
          ...
          ,'src_building_square_footage:invalid_vendor_source:ENUM','src_building_square_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_building_square_footage:invalid_date:CUSTOM'
          ,'air_conditioning_type:invalid_air_conditioning_type_code:CUSTOM'
          ,'src_air_conditioning_type:invalid_vendor_source:ENUM','src_air_conditioning_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_air_conditioning_type:invalid_date:CUSTOM'
          ,'basement_finish:invalid_basement_finish_type_code:CUSTOM'
          ,'src_basement_finish:invalid_vendor_source:ENUM','src_basement_finish:invalid_vendor_source:LENGTH'
          ,'tax_dt_basement_finish:invalid_date:CUSTOM'
          ,'construction_type:invalid_construction_type_code:CUSTOM'
          ,'src_construction_type:invalid_vendor_source:ENUM','src_construction_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_construction_type:invalid_date:CUSTOM'
          ,'exterior_wall:invalid_exterior_walls_code:CUSTOM'
          ,'src_exterior_wall:invalid_vendor_source:ENUM','src_exterior_wall:invalid_vendor_source:LENGTH'
          ,'tax_dt_exterior_wall:invalid_date:CUSTOM'
          ,'fireplace_ind:invalid_fireplace_indicator:ENUM'
          ,'src_fireplace_ind:invalid_vendor_source:ENUM','src_fireplace_ind:invalid_vendor_source:LENGTH'
          ,'tax_dt_fireplace_ind:invalid_date:CUSTOM'
          ,'fireplace_type:invalid_fireplace_type:CUSTOM'
          ,'src_fireplace_type:invalid_vendor_source:ENUM','src_fireplace_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_fireplace_type:invalid_date:CUSTOM'
          ,'src_flood_zone_panel:invalid_vendor_source:ENUM','src_flood_zone_panel:invalid_vendor_source:LENGTH'
          ,'tax_dt_flood_zone_panel:invalid_date:CUSTOM'
          ,'garage:invalid_garage_type:CUSTOM'
          ,'src_garage:invalid_vendor_source:ENUM','src_garage:invalid_vendor_source:LENGTH'
          ,'tax_dt_garage:invalid_date:CUSTOM'
          ,'first_floor_square_footage:invalid_nums:ALLOW'
          ,'src_first_floor_square_footage:invalid_vendor_source:ENUM','src_first_floor_square_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_first_floor_square_footage:invalid_date:CUSTOM'
          ,'heating:invalid_heating_type:CUSTOM'
          ,'src_heating:invalid_vendor_source:ENUM','src_heating:invalid_vendor_source:LENGTH'
          ,'tax_dt_heating:invalid_date:CUSTOM'
          ,'living_area_square_footage:invalid_nums:ALLOW'
          ,'src_living_area_square_footage:invalid_vendor_source:ENUM','src_living_area_square_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_living_area_square_footage:invalid_date:CUSTOM'
          ,'no_of_baths:invalid_nums:ALLOW'
          ,'src_no_of_baths:invalid_vendor_source:ENUM','src_no_of_baths:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_baths:invalid_date:CUSTOM'
          ,'no_of_bedrooms:invalid_nums:ALLOW'
          ,'src_no_of_bedrooms:invalid_vendor_source:ENUM','src_no_of_bedrooms:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_bedrooms:invalid_date:CUSTOM'
          ,'no_of_fireplaces:invalid_nums:ALLOW'
          ,'src_no_of_fireplaces:invalid_vendor_source:ENUM','src_no_of_fireplaces:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_fireplaces:invalid_date:CUSTOM'
          ,'no_of_full_baths:invalid_nums:ALLOW'
          ,'src_no_of_full_baths:invalid_vendor_source:ENUM','src_no_of_full_baths:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_full_baths:invalid_date:CUSTOM'
          ,'no_of_half_baths:invalid_nums:ALLOW'
          ,'src_no_of_half_baths:invalid_vendor_source:ENUM','src_no_of_half_baths:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_half_baths:invalid_date:CUSTOM'
          ,'no_of_stories:invalid_nums:ALLOW'
          ,'src_no_of_stories:invalid_vendor_source:ENUM','src_no_of_stories:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_stories:invalid_date:CUSTOM'
          ,'parking_type:invalid_parking_type:CUSTOM'
          ,'src_parking_type:invalid_vendor_source:ENUM','src_parking_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_parking_type:invalid_date:CUSTOM'
          ,'src_pool_indicator:invalid_vendor_source:ENUM','src_pool_indicator:invalid_vendor_source:LENGTH'
          ,'tax_dt_pool_indicator:invalid_date:CUSTOM'
          ,'pool_type:invalid_pool_type:CUSTOM'
          ,'src_pool_type:invalid_vendor_source:ENUM','src_pool_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_pool_type:invalid_date:CUSTOM'
          ,'roof_cover:invalid_roof_type:CUSTOM'
          ,'src_roof_cover:invalid_vendor_source:ENUM','src_roof_cover:invalid_vendor_source:LENGTH'
          ,'tax_dt_roof_cover:invalid_date:CUSTOM'
          ,'year_built:invalid_year:ALLOW','year_built:invalid_year:INRANGE','year_built:invalid_year:LENGTH'
          ,'src_year_built:invalid_vendor_source:ENUM','src_year_built:invalid_vendor_source:LENGTH'
          ,'tax_dt_year_built:invalid_date:CUSTOM'
          ,'foundation:invalid_foundation_type:CUSTOM'
          ,'src_foundation:invalid_vendor_source:ENUM','src_foundation:invalid_vendor_source:LENGTH'
          ,'tax_dt_foundation:invalid_date:CUSTOM'
          ,'basement_square_footage:invalid_nums:ALLOW'
          ,'src_basement_square_footage:invalid_vendor_source:ENUM','src_basement_square_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_basement_square_footage:invalid_date:CUSTOM'
          ,'effective_year_built:invalid_year:ALLOW','effective_year_built:invalid_year:INRANGE','effective_year_built:invalid_year:LENGTH'
          ,'src_effective_year_built:invalid_vendor_source:ENUM','src_effective_year_built:invalid_vendor_source:LENGTH'
          ,'tax_dt_effective_year_built:invalid_date:CUSTOM'
          ,'garage_square_footage:invalid_nums:ALLOW'
          ,'src_garage_square_footage:invalid_vendor_source:ENUM','src_garage_square_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_garage_square_footage:invalid_date:CUSTOM'
          ,'stories_type:invalid_stories_type:CUSTOM'
          ,'src_stories_type:invalid_vendor_source:ENUM','src_stories_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_stories_type:invalid_date:CUSTOM'
          ,'apn_number:invalid_apn:ALLOW','apn_number:invalid_apn:LENGTH'
          ,'src_apn_number:invalid_vendor_source:ENUM','src_apn_number:invalid_vendor_source:LENGTH'
          ,'tax_dt_apn_number:invalid_date:CUSTOM'
          ,'src_census_tract:invalid_vendor_source:ENUM','src_census_tract:invalid_vendor_source:LENGTH'
          ,'tax_dt_census_tract:invalid_date:CUSTOM'
          ,'src_range:invalid_vendor_source:ENUM','src_range:invalid_vendor_source:LENGTH'
          ,'tax_dt_range:invalid_date:CUSTOM'
          ,'src_zoning:invalid_vendor_source:ENUM','src_zoning:invalid_vendor_source:LENGTH'
          ,'tax_dt_zoning:invalid_date:CUSTOM'
          ,'src_block_number:invalid_vendor_source:ENUM','src_block_number:invalid_vendor_source:LENGTH'
          ,'tax_dt_block_number:invalid_date:CUSTOM'
          ,'county_name:invalid_county_name:ALLOW','county_name:invalid_county_name:WORDS'
          ,'src_county_name:invalid_vendor_source:ENUM','src_county_name:invalid_vendor_source:LENGTH'
          ...
          ,'src_fips_code:invalid_vendor_source:ENUM','src_fips_code:invalid_vendor_source:LENGTH'
          ,'tax_dt_fips_code:invalid_date:CUSTOM'
          ,'src_subdivision:invalid_vendor_source:ENUM','src_subdivision:invalid_vendor_source:LENGTH'
          ,'tax_dt_subdivision:invalid_date:CUSTOM'
          ,'src_municipality:invalid_vendor_source:ENUM','src_municipality:invalid_vendor_source:LENGTH'
          ,'tax_dt_municipality:invalid_date:CUSTOM'
          ,'src_township:invalid_vendor_source:ENUM','src_township:invalid_vendor_source:LENGTH'
          ,'tax_dt_township:invalid_date:CUSTOM'
          ,'src_homestead_exemption_ind:invalid_vendor_source:ENUM','src_homestead_exemption_ind:invalid_vendor_source:LENGTH'
          ,'tax_dt_homestead_exemption_ind:invalid_date:CUSTOM'
          ,'land_use_code:invalid_land_use:CUSTOM'
          ,'src_land_use_code:invalid_vendor_source:ENUM','src_land_use_code:invalid_vendor_source:LENGTH'
          ,'tax_dt_land_use_code:invalid_date:CUSTOM'
          ,'src_latitude:invalid_vendor_source:ENUM','src_latitude:invalid_vendor_source:LENGTH'
          ,'tax_dt_latitude:invalid_date:CUSTOM'
          ,'src_longitude:invalid_vendor_source:ENUM','src_longitude:invalid_vendor_source:LENGTH'
          ,'tax_dt_longitude:invalid_date:CUSTOM'
          ,'location_influence_code:invalid_location_code:CUSTOM'
          ,'src_location_influence_code:invalid_vendor_source:ENUM','src_location_influence_code:invalid_vendor_source:LENGTH'
          ,'tax_dt_location_influence_code:invalid_date:CUSTOM'
          ,'src_acres:invalid_vendor_source:ENUM','src_acres:invalid_vendor_source:LENGTH'
          ,'tax_dt_acres:invalid_date:CUSTOM'
          ,'src_lot_depth_footage:invalid_vendor_source:ENUM','src_lot_depth_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_lot_depth_footage:invalid_date:CUSTOM'
          ,'src_lot_front_footage:invalid_vendor_source:ENUM','src_lot_front_footage:invalid_vendor_source:LENGTH'
          ,'tax_dt_lot_front_footage:invalid_date:CUSTOM'
          ,'src_lot_number:invalid_vendor_source:ENUM','src_lot_number:invalid_vendor_source:LENGTH'
          ,'tax_dt_lot_number:invalid_date:CUSTOM'
          ,'src_lot_size:invalid_vendor_source:ENUM','src_lot_size:invalid_vendor_source:LENGTH'
          ,'tax_dt_lot_size:invalid_date:CUSTOM'
          ,'property_type_code:invalid_property_code:CUSTOM'
          ,'src_property_type_code:invalid_vendor_source:ENUM','src_property_type_code:invalid_vendor_source:LENGTH'
          ,'tax_dt_property_type_code:invalid_date:CUSTOM'
          ,'structure_quality:invalid_structure_quality_code:CUSTOM'
          ,'src_structure_quality:invalid_vendor_source:ENUM','src_structure_quality:invalid_vendor_source:LENGTH'
          ,'tax_dt_structure_quality:invalid_date:CUSTOM'
          ,'water:invalid_water_type:CUSTOM'
          ,'src_water:invalid_vendor_source:ENUM','src_water:invalid_vendor_source:LENGTH'
          ,'tax_dt_water:invalid_date:CUSTOM'
          ,'sewer:invalid_sewer_type:CUSTOM'
          ,'src_sewer:invalid_vendor_source:ENUM','src_sewer:invalid_vendor_source:LENGTH'
          ...
          ,'src_assessed_land_value:invalid_vendor_source:ENUM','src_assessed_land_value:invalid_vendor_source:LENGTH'
          ,'tax_dt_assessed_land_value:invalid_date:CUSTOM'
          ,'assessed_year:invalid_year:ALLOW','assessed_year:invalid_year:INRANGE','assessed_year:invalid_year:LENGTH'
          ,'src_assessed_year:invalid_vendor_source:ENUM','src_assessed_year:invalid_vendor_source:LENGTH'
          ,'tax_dt_assessed_year:invalid_date:CUSTOM'
          ,'tax_amount:invalid_tax_amount:ALLOW','tax_amount:invalid_tax_amount:INRANGE'
          ,'src_tax_amount:invalid_vendor_source:ENUM','src_tax_amount:invalid_vendor_source:LENGTH'
          ,'tax_dt_tax_amount:invalid_date:CUSTOM'
          ,'tax_year:invalid_year:ALLOW','tax_year:invalid_year:INRANGE','tax_year:invalid_year:LENGTH'
          ,'src_tax_year:invalid_vendor_source:ENUM','src_tax_year:invalid_vendor_source:LENGTH'
          ,'market_land_value:invalid_tax_amount:ALLOW','market_land_value:invalid_tax_amount:INRANGE'
          ,'src_market_land_value:invalid_vendor_source:ENUM','src_market_land_value:invalid_vendor_source:LENGTH'
          ...
          ,'src_improvement_value:invalid_vendor_source:ENUM','src_improvement_value:invalid_vendor_source:LENGTH'
          ,'tax_dt_improvement_value:invalid_date:CUSTOM'
          ,'src_percent_improved:invalid_vendor_source:ENUM','src_percent_improved:invalid_vendor_source:LENGTH'
          ...
          ,'src_total_assessed_value:invalid_vendor_source:ENUM','src_total_assessed_value:invalid_vendor_source:LENGTH'
          ...
          ,'src_total_calculated_value:invalid_vendor_source:ENUM','src_total_calculated_value:invalid_vendor_source:LENGTH'
          ...
          ,'src_total_land_value:invalid_vendor_source:ENUM','src_total_land_value:invalid_vendor_source:LENGTH'
          ...
          ,'src_total_market_value:invalid_vendor_source:ENUM','src_total_market_value:invalid_vendor_source:LENGTH'
          ,'tax_dt_total_market_value:invalid_date:CUSTOM'
          ,'floor_type:invalid_floor_cover_code:CUSTOM'
          ,'src_floor_type:invalid_vendor_source:ENUM','src_floor_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_floor_type:invalid_date:CUSTOM'
          ,'frame_type:invalid_frame_code:CUSTOM'
          ,'src_frame_type:invalid_vendor_source:ENUM','src_frame_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_frame_type:invalid_date:CUSTOM'
          ,'fuel_type:invalid_heating_fuel_type:CUSTOM'
          ,'src_fuel_type:invalid_vendor_source:ENUM','src_fuel_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_fuel_type:invalid_date:CUSTOM'
          ,'no_of_bath_fixtures:invalid_nums:ALLOW'
          ,'src_no_of_bath_fixtures:invalid_vendor_source:ENUM','src_no_of_bath_fixtures:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_bath_fixtures:invalid_date:CUSTOM'
          ,'no_of_rooms:invalid_nums:ALLOW'
          ,'src_no_of_rooms:invalid_vendor_source:ENUM','src_no_of_rooms:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_rooms:invalid_date:CUSTOM'
          ,'no_of_units:invalid_nums:ALLOW'
          ,'src_no_of_units:invalid_vendor_source:ENUM','src_no_of_units:invalid_vendor_source:LENGTH'
          ,'tax_dt_no_of_units:invalid_date:CUSTOM'
          ,'style_type:invalid_style_type:CUSTOM'
          ,'src_style_type:invalid_vendor_source:ENUM','src_style_type:invalid_vendor_source:LENGTH'
          ,'tax_dt_style_type:invalid_date:CUSTOM'
          ,'assessment_document_number:invalid_document_number:ALLOW'
          ,'src_assessment_document_number:invalid_vendor_source:ENUM','src_assessment_document_number:invalid_vendor_source:LENGTH'
          ,'tax_dt_assessment_document_number:invalid_date:CUSTOM'
          ,'assessment_recording_date:invalid_date:CUSTOM'
          ,'src_assessment_recording_date:invalid_vendor_source:ENUM','src_assessment_recording_date:invalid_vendor_source:LENGTH'
          ,'tax_dt_assessment_recording_date:invalid_date:CUSTOM'
          ,'deed_document_number:invalid_document_number:ALLOW'
          ,'src_deed_document_number:invalid_vendor_source:ENUM','src_deed_document_number:invalid_vendor_source:LENGTH'
          ,'rec_dt_deed_document_number:invalid_date:CUSTOM'
          ,'deed_recording_date:invalid_date:CUSTOM'
          ,'src_deed_recording_date:invalid_vendor_source:ENUM','src_deed_recording_date:invalid_vendor_source:LENGTH'
          ,'full_part_sale:invalid_sale_code:CUSTOM'
          ,'src_full_part_sale:invalid_vendor_source:ENUM','src_full_part_sale:invalid_vendor_source:LENGTH'
          ,'rec_dt_full_part_sale:invalid_date:CUSTOM'
          ,'sale_amount:invalid_tax_amount:ALLOW','sale_amount:invalid_tax_amount:INRANGE'
          ,'src_sale_amount:invalid_vendor_source:ENUM','src_sale_amount:invalid_vendor_source:LENGTH'
          ,'rec_dt_sale_amount:invalid_date:CUSTOM'
          ,'sale_date:invalid_date:CUSTOM'
          ,'src_sale_date:invalid_vendor_source:ENUM','src_sale_date:invalid_vendor_source:LENGTH'
          ,'rec_dt_sale_date:invalid_date:CUSTOM'
          ,'sale_type_code:invalid_sale_tran_code:CUSTOM'
          ,'src_sale_type_code:invalid_vendor_source:ENUM','src_sale_type_code:invalid_vendor_source:LENGTH'
          ,'rec_dt_sale_type_code:invalid_date:CUSTOM'
          ,'mortgage_company_name:invalid_alpha:ALLOW'
          ,'src_mortgage_company_name:invalid_vendor_source:ENUM','src_mortgage_company_name:invalid_vendor_source:LENGTH'
          ...
          ,'src_loan_amount:invalid_vendor_source:ENUM','src_loan_amount:invalid_vendor_source:LENGTH'
          ...
          ,'src_second_loan_amount:invalid_vendor_source:ENUM','src_second_loan_amount:invalid_vendor_source:LENGTH'
          ,'rec_dt_second_loan_amount:invalid_date:CUSTOM'
          ,'loan_type_code:invalid_mortgage_loan_type_code:CUSTOM'
          ,'src_loan_type_code:invalid_vendor_source:ENUM','src_loan_type_code:invalid_vendor_source:LENGTH'
          ,'rec_dt_loan_type_code:invalid_date:CUSTOM'
          ,'interest_rate_type_code:invalid_financing_type_code:CUSTOM'
          ,'src_interest_rate_type_code:invalid_vendor_source:ENUM','src_interest_rate_type_code:invalid_vendor_source:LENGTH'
          ,'rec_dt_interest_rate_type_code:invalid_date:CUSTOM','UNKNOWN');
      SELF.ErrorMessage := CHOOSE(c
          ...
          ,Fields.InvalidMessage_year_built(1),Fields.InvalidMessage_year_built(2),Fields.InvalidMessage_year_built(3)
          ...
          ,Fields.InvalidMessage_effective_year_built(1),Fields.InvalidMessage_effective_year_built(2),Fields.InvalidMessage_effective_year_built(3)
          ...
          ,Fields.InvalidMessage_assessed_year(1),Fields.InvalidMessage_assessed_year(2),Fields.InvalidMessage_assessed_year(3)
          ...
          ,Fields.InvalidMessage_tax_year(1),Fields.InvalidMessage_tax_year(2),Fields.InvalidMessage_tax_year(3)
          ...
          ,Fields.InvalidMessage_rec_dt_interest_rate_type_code(1),'UNKNOWN');
      SELF.rulecnt := CHOOSE(c
          ...
          ,le.fares_unformatted_apn_ALLOW_ErrorCount,le.fares_unformatted_apn_LENGTH_ErrorCount
          ...
          ,le.src_building_square_footage_ENUM_ErrorCount,le.src_building_square_footage_LENGTH_ErrorCount
          ,le.tax_dt_building_square_footage_CUSTOM_ErrorCount
          ,le.air_conditioning_type_CUSTOM_ErrorCount
          ,le.src_air_conditioning_type_ENUM_ErrorCount,le.src_air_conditioning_type_LENGTH_ErrorCount
          ,le.tax_dt_air_conditioning_type_CUSTOM_ErrorCount
          ,le.basement_finish_CUSTOM_ErrorCount
          ,le.src_basement_finish_ENUM_ErrorCount,le.src_basement_finish_LENGTH_ErrorCount
          ,le.tax_dt_basement_finish_CUSTOM_ErrorCount
          ,le.construction_type_CUSTOM_ErrorCount
          ,le.src_construction_type_ENUM_ErrorCount,le.src_construction_type_LENGTH_ErrorCount
          ,le.tax_dt_construction_type_CUSTOM_ErrorCount
          ,le.exterior_wall_CUSTOM_ErrorCount
          ,le.src_exterior_wall_ENUM_ErrorCount,le.src_exterior_wall_LENGTH_ErrorCount
          ,le.tax_dt_exterior_wall_CUSTOM_ErrorCount
          ,le.fireplace_ind_ENUM_ErrorCount
          ,le.src_fireplace_ind_ENUM_ErrorCount,le.src_fireplace_ind_LENGTH_ErrorCount
          ,le.tax_dt_fireplace_ind_CUSTOM_ErrorCount
          ,le.fireplace_type_CUSTOM_ErrorCount
          ,le.src_fireplace_type_ENUM_ErrorCount,le.src_fireplace_type_LENGTH_ErrorCount
          ,le.tax_dt_fireplace_type_CUSTOM_ErrorCount
          ,le.src_flood_zone_panel_ENUM_ErrorCount,le.src_flood_zone_panel_LENGTH_ErrorCount
          ,le.tax_dt_flood_zone_panel_CUSTOM_ErrorCount
          ,le.garage_CUSTOM_ErrorCount
          ,le.src_garage_ENUM_ErrorCount,le.src_garage_LENGTH_ErrorCount
          ,le.tax_dt_garage_CUSTOM_ErrorCount
          ,le.first_floor_square_footage_ALLOW_ErrorCount
          ,le.src_first_floor_square_footage_ENUM_ErrorCount,le.src_first_floor_square_footage_LENGTH_ErrorCount
          ,le.tax_dt_first_floor_square_footage_CUSTOM_ErrorCount
          ,le.heating_CUSTOM_ErrorCount
          ,le.src_heating_ENUM_ErrorCount,le.src_heating_LENGTH_ErrorCount
          ,le.tax_dt_heating_CUSTOM_ErrorCount
          ,le.living_area_square_footage_ALLOW_ErrorCount
          ,le.src_living_area_square_footage_ENUM_ErrorCount,le.src_living_area_square_footage_LENGTH_ErrorCount
          ,le.tax_dt_living_area_square_footage_CUSTOM_ErrorCount
          ,le.no_of_baths_ALLOW_ErrorCount
          ,le.src_no_of_baths_ENUM_ErrorCount,le.src_no_of_baths_LENGTH_ErrorCount
          ,le.tax_dt_no_of_baths_CUSTOM_ErrorCount
          ,le.no_of_bedrooms_ALLOW_ErrorCount
          ,le.src_no_of_bedrooms_ENUM_ErrorCount,le.src_no_of_bedrooms_LENGTH_ErrorCount
          ,le.tax_dt_no_of_bedrooms_CUSTOM_ErrorCount
          ,le.no_of_fireplaces_ALLOW_ErrorCount
          ,le.src_no_of_fireplaces_ENUM_ErrorCount,le.src_no_of_fireplaces_LENGTH_ErrorCount
          ,le.tax_dt_no_of_fireplaces_CUSTOM_ErrorCount
          ,le.no_of_full_baths_ALLOW_ErrorCount
          ,le.src_no_of_full_baths_ENUM_ErrorCount,le.src_no_of_full_baths_LENGTH_ErrorCount
          ,le.tax_dt_no_of_full_baths_CUSTOM_ErrorCount
          ,le.no_of_half_baths_ALLOW_ErrorCount
          ,le.src_no_of_half_baths_ENUM_ErrorCount,le.src_no_of_half_baths_LENGTH_ErrorCount
          ,le.tax_dt_no_of_half_baths_CUSTOM_ErrorCount
          ,le.no_of_stories_ALLOW_ErrorCount
          ,le.src_no_of_stories_ENUM_ErrorCount,le.src_no_of_stories_LENGTH_ErrorCount
          ,le.tax_dt_no_of_stories_CUSTOM_ErrorCount
          ,le.parking_type_CUSTOM_ErrorCount
          ,le.src_parking_type_ENUM_ErrorCount,le.src_parking_type_LENGTH_ErrorCount
          ,le.tax_dt_parking_type_CUSTOM_ErrorCount
          ,le.src_pool_indicator_ENUM_ErrorCount,le.src_pool_indicator_LENGTH_ErrorCount
          ,le.tax_dt_pool_indicator_CUSTOM_ErrorCount
          ,le.pool_type_CUSTOM_ErrorCount
          ,le.src_pool_type_ENUM_ErrorCount,le.src_pool_type_LENGTH_ErrorCount
          ,le.tax_dt_pool_type_CUSTOM_ErrorCount
          ,le.roof_cover_CUSTOM_ErrorCount
          ,le.src_roof_cover_ENUM_ErrorCount,le.src_roof_cover_LENGTH_ErrorCount
          ,le.tax_dt_roof_cover_CUSTOM_ErrorCount
          ,le.year_built_ALLOW_ErrorCount,le.year_built_INRANGE_ErrorCount,le.year_built_LENGTH_ErrorCount
          ,le.src_year_built_ENUM_ErrorCount,le.src_year_built_LENGTH_ErrorCount
          ,le.tax_dt_year_built_CUSTOM_ErrorCount
          ,le.foundation_CUSTOM_ErrorCount
          ,le.src_foundation_ENUM_ErrorCount,le.src_foundation_LENGTH_ErrorCount
          ,le.tax_dt_foundation_CUSTOM_ErrorCount
          ,le.basement_square_footage_ALLOW_ErrorCount
          ,le.src_basement_square_footage_ENUM_ErrorCount,le.src_basement_square_footage_LENGTH_ErrorCount
          ,le.tax_dt_basement_square_footage_CUSTOM_ErrorCount
          ,le.effective_year_built_ALLOW_ErrorCount,le.effective_year_built_INRANGE_ErrorCount,le.effective_year_built_LENGTH_ErrorCount
          ,le.src_effective_year_built_ENUM_ErrorCount,le.src_effective_year_built_LENGTH_ErrorCount
          ,le.tax_dt_effective_year_built_CUSTOM_ErrorCount
          ,le.garage_square_footage_ALLOW_ErrorCount
          ,le.src_garage_square_footage_ENUM_ErrorCount,le.src_garage_square_footage_LENGTH_ErrorCount
          ,le.tax_dt_garage_square_footage_CUSTOM_ErrorCount
          ,le.stories_type_CUSTOM_ErrorCount
          ,le.src_stories_type_ENUM_ErrorCount,le.src_stories_type_LENGTH_ErrorCount
          ,le.tax_dt_stories_type_CUSTOM_ErrorCount
          ,le.apn_number_ALLOW_ErrorCount,le.apn_number_LENGTH_ErrorCount
          ,le.src_apn_number_ENUM_ErrorCount,le.src_apn_number_LENGTH_ErrorCount
          ,le.tax_dt_apn_number_CUSTOM_ErrorCount
          ,le.src_census_tract_ENUM_ErrorCount,le.src_census_tract_LENGTH_ErrorCount
          ,le.tax_dt_census_tract_CUSTOM_ErrorCount
          ,le.src_range_ENUM_ErrorCount,le.src_range_LENGTH_ErrorCount
          ,le.tax_dt_range_CUSTOM_ErrorCount
          ,le.src_zoning_ENUM_ErrorCount,le.src_zoning_LENGTH_ErrorCount
          ,le.tax_dt_zoning_CUSTOM_ErrorCount
          ,le.src_block_number_ENUM_ErrorCount,le.src_block_number_LENGTH_ErrorCount
          ,le.tax_dt_block_number_CUSTOM_ErrorCount
          ,le.county_name_ALLOW_ErrorCount,le.county_name_WORDS_ErrorCount
          ,le.src_county_name_ENUM_ErrorCount,le.src_county_name_LENGTH_ErrorCount
          ...
          ,le.src_fips_code_ENUM_ErrorCount,le.src_fips_code_LENGTH_ErrorCount
          ,le.tax_dt_fips_code_CUSTOM_ErrorCount
          ,le.src_subdivision_ENUM_ErrorCount,le.src_subdivision_LENGTH_ErrorCount
          ,le.tax_dt_subdivision_CUSTOM_ErrorCount
          ,le.src_municipality_ENUM_ErrorCount,le.src_municipality_LENGTH_ErrorCount
          ,le.tax_dt_municipality_CUSTOM_ErrorCount
          ,le.src_township_ENUM_ErrorCount,le.src_township_LENGTH_ErrorCount
          ,le.tax_dt_township_CUSTOM_ErrorCount
          ,le.src_homestead_exemption_ind_ENUM_ErrorCount,le.src_homestead_exemption_ind_LENGTH_ErrorCount
          ,le.tax_dt_homestead_exemption_ind_CUSTOM_ErrorCount
          ,le.land_use_code_CUSTOM_ErrorCount
          ,le.src_land_use_code_ENUM_ErrorCount,le.src_land_use_code_LENGTH_ErrorCount
          ,le.tax_dt_land_use_code_CUSTOM_ErrorCount
          ,le.src_latitude_ENUM_ErrorCount,le.src_latitude_LENGTH_ErrorCount
          ,le.tax_dt_latitude_CUSTOM_ErrorCount
          ,le.src_longitude_ENUM_ErrorCount,le.src_longitude_LENGTH_ErrorCount
          ,le.tax_dt_longitude_CUSTOM_ErrorCount
          ,le.location_influence_code_CUSTOM_ErrorCount
          ,le.src_location_influence_code_ENUM_ErrorCount,le.src_location_influence_code_LENGTH_ErrorCount
          ,le.tax_dt_location_influence_code_CUSTOM_ErrorCount
          ,le.src_acres_ENUM_ErrorCount,le.src_acres_LENGTH_ErrorCount
          ,le.tax_dt_acres_CUSTOM_ErrorCount
          ,le.src_lot_depth_footage_ENUM_ErrorCount,le.src_lot_depth_footage_LENGTH_ErrorCount
          ,le.tax_dt_lot_depth_footage_CUSTOM_ErrorCount
          ,le.src_lot_front_footage_ENUM_ErrorCount,le.src_lot_front_footage_LENGTH_ErrorCount
          ,le.tax_dt_lot_front_footage_CUSTOM_ErrorCount
          ,le.src_lot_number_ENUM_ErrorCount,le.src_lot_number_LENGTH_ErrorCount
          ,le.tax_dt_lot_number_CUSTOM_ErrorCount
          ,le.src_lot_size_ENUM_ErrorCount,le.src_lot_size_LENGTH_ErrorCount
          ,le.tax_dt_lot_size_CUSTOM_ErrorCount
          ,le.property_type_code_CUSTOM_ErrorCount
          ,le.src_property_type_code_ENUM_ErrorCount,le.src_property_type_code_LENGTH_ErrorCount
          ,le.tax_dt_property_type_code_CUSTOM_ErrorCount
          ,le.structure_quality_CUSTOM_ErrorCount
          ,le.src_structure_quality_ENUM_ErrorCount,le.src_structure_quality_LENGTH_ErrorCount
          ,le.tax_dt_structure_quality_CUSTOM_ErrorCount
          ,le.water_CUSTOM_ErrorCount
          ,le.src_water_ENUM_ErrorCount,le.src_water_LENGTH_ErrorCount
          ,le.tax_dt_water_CUSTOM_ErrorCount
          ,le.sewer_CUSTOM_ErrorCount
          ,le.src_sewer_ENUM_ErrorCount,le.src_sewer_LENGTH_ErrorCount
          ,le.tax_dt_sewer_CUSTOM_ErrorCount
          ,le.assessed_land_value_ALLOW_ErrorCount,le.assessed_land_value_INRANGE_ErrorCount
          ,le.src_assessed_land_value_ENUM_ErrorCount,le.src_assessed_land_value_LENGTH_ErrorCount
          ,le.tax_dt_assessed_land_value_CUSTOM_ErrorCount
          ,le.assessed_year_ALLOW_ErrorCount,le.assessed_year_INRANGE_ErrorCount,le.assessed_year_LENGTH_ErrorCount
          ,le.src_assessed_year_ENUM_ErrorCount,le.src_assessed_year_LENGTH_ErrorCount
          ,le.tax_dt_assessed_year_CUSTOM_ErrorCount
          ,le.tax_amount_ALLOW_ErrorCount,le.tax_amount_INRANGE_ErrorCount
          ,le.src_tax_amount_ENUM_ErrorCount,le.src_tax_amount_LENGTH_ErrorCount
          ,le.tax_dt_tax_amount_CUSTOM_ErrorCount
          ,le.tax_year_ALLOW_ErrorCount,le.tax_year_INRANGE_ErrorCount,le.tax_year_LENGTH_ErrorCount
          ,le.src_tax_year_ENUM_ErrorCount,le.src_tax_year_LENGTH_ErrorCount
          ,le.market_land_value_ALLOW_ErrorCount,le.market_land_value_INRANGE_ErrorCount
          ,le.src_market_land_value_ENUM_ErrorCount,le.src_market_land_value_LENGTH_ErrorCount
          ...
          ,le.src_improvement_value_ENUM_ErrorCount,le.src_improvement_value_LENGTH_ErrorCount
          ,le.tax_dt_improvement_value_CUSTOM_ErrorCount
          ,le.src_percent_improved_ENUM_ErrorCount,le.src_percent_improved_LENGTH_ErrorCount
          ...
          ,le.src_total_assessed_value_ENUM_ErrorCount,le.src_total_assessed_value_LENGTH_ErrorCount
          ...
          ,le.src_total_calculated_value_ENUM_ErrorCount,le.src_total_calculated_value_LENGTH_ErrorCount
          ...
          ,le.src_total_land_value_ENUM_ErrorCount,le.src_total_land_value_LENGTH_ErrorCount
          ...
          ,le.src_total_market_value_ENUM_ErrorCount,le.src_total_market_value_LENGTH_ErrorCount
          ,le.tax_dt_total_market_value_CUSTOM_ErrorCount
          ,le.floor_type_CUSTOM_ErrorCount
          ,le.src_floor_type_ENUM_ErrorCount,le.src_floor_type_LENGTH_ErrorCount
          ,le.tax_dt_floor_type_CUSTOM_ErrorCount
          ,le.frame_type_CUSTOM_ErrorCount
          ,le.src_frame_type_ENUM_ErrorCount,le.src_frame_type_LENGTH_ErrorCount
          ,le.tax_dt_frame_type_CUSTOM_ErrorCount
          ,le.fuel_type_CUSTOM_ErrorCount
          ,le.src_fuel_type_ENUM_ErrorCount,le.src_fuel_type_LENGTH_ErrorCount
          ,le.tax_dt_fuel_type_CUSTOM_ErrorCount
          ,le.no_of_bath_fixtures_ALLOW_ErrorCount
          ,le.src_no_of_bath_fixtures_ENUM_ErrorCount,le.src_no_of_bath_fixtures_LENGTH_ErrorCount
          ,le.tax_dt_no_of_bath_fixtures_CUSTOM_ErrorCount
          ,le.no_of_rooms_ALLOW_ErrorCount
          ,le.src_no_of_rooms_ENUM_ErrorCount,le.src_no_of_rooms_LENGTH_ErrorCount
          ,le.tax_dt_no_of_rooms_CUSTOM_ErrorCount
          ,le.no_of_units_ALLOW_ErrorCount
          ,le.src_no_of_units_ENUM_ErrorCount,le.src_no_of_units_LENGTH_ErrorCount
          ,le.tax_dt_no_of_units_CUSTOM_ErrorCount
          ,le.style_type_CUSTOM_ErrorCount
          ,le.src_style_type_ENUM_ErrorCount,le.src_style_type_LENGTH_ErrorCount
          ,le.tax_dt_style_type_CUSTOM_ErrorCount
          ,le.assessment_document_number_ALLOW_ErrorCount
          ,le.src_assessment_document_number_ENUM_ErrorCount,le.src_assessment_document_number_LENGTH_ErrorCount
          ,le.tax_dt_assessment_document_number_CUSTOM_ErrorCount
          ,le.assessment_recording_date_CUSTOM_ErrorCount
          ,le.src_assessment_recording_date_ENUM_ErrorCount,le.src_assessment_recording_date_LENGTH_ErrorCount
          ,le.tax_dt_assessment_recording_date_CUSTOM_ErrorCount
          ,le.deed_document_number_ALLOW_ErrorCount
          ,le.src_deed_document_number_ENUM_ErrorCount,le.src_deed_document_number_LENGTH_ErrorCount
          ,le.rec_dt_deed_document_number_CUSTOM_ErrorCount
          ,le.deed_recording_date_CUSTOM_ErrorCount
          ,le.src_deed_recording_date_ENUM_ErrorCount,le.src_deed_recording_date_LENGTH_ErrorCount
          ,le.full_part_sale_CUSTOM_ErrorCount
          ,le.src_full_part_sale_ENUM_ErrorCount,le.src_full_part_sale_LENGTH_ErrorCount
          ,le.rec_dt_full_part_sale_CUSTOM_ErrorCount
          ,le.sale_amount_ALLOW_ErrorCount,le.sale_amount_INRANGE_ErrorCount
          ,le.src_sale_amount_ENUM_ErrorCount,le.src_sale_amount_LENGTH_ErrorCount
          ,le.rec_dt_sale_amount_CUSTOM_ErrorCount
          ,le.sale_date_CUSTOM_ErrorCount
          ,le.src_sale_date_ENUM_ErrorCount,le.src_sale_date_LENGTH_ErrorCount
          ,le.rec_dt_sale_date_CUSTOM_ErrorCount
          ,le.sale_type_code_CUSTOM_ErrorCount
          ,le.src_sale_type_code_ENUM_ErrorCount,le.src_sale_type_code_LENGTH_ErrorCount
          ,le.rec_dt_sale_type_code_CUSTOM_ErrorCount
          ,le.mortgage_company_name_ALLOW_ErrorCount
          ,le.src_mortgage_company_name_ENUM_ErrorCount,le.src_mortgage_company_name_LENGTH_ErrorCount
          ,le.rec_dt_mortgage_company_name_CUSTOM_ErrorCount
          ,le.loan_amount_ALLOW_ErrorCount,le.loan_amount_INRANGE_ErrorCount
          ,le.src_loan_amount_ENUM_ErrorCount,le.src_loan_amount_LENGTH_ErrorCount
          ,le.rec_dt_loan_amount_CUSTOM_ErrorCount
          ,le.second_loan_amount_ALLOW_ErrorCount,le.second_loan_amount_INRANGE_ErrorCount
          ,le.src_second_loan_amount_ENUM_ErrorCount,le.src_second_loan_amount_LENGTH_ErrorCount
          ,le.rec_dt_second_loan_amount_CUSTOM_ErrorCount
          ,le.loan_type_code_CUSTOM_ErrorCount
          ,le.src_loan_type_code_ENUM_ErrorCount,le.src_loan_type_code_LENGTH_ErrorCount
          ,le.rec_dt_loan_type_code_CUSTOM_ErrorCount
          ,le.interest_rate_type_code_CUSTOM_ErrorCount
          ,le.src_interest_rate_type_code_ENUM_ErrorCount,le.src_interest_rate_type_code_LENGTH_ErrorCount
          ,le.rec_dt_interest_rate_type_code_CUSTOM_ErrorCount,0);
      SELF.rulepcnt := 100 * CHOOSE(c
          ...
          ,le.interest_rate_type_code_CUSTOM_ErrorCount
          ,le.src_interest_rate_type_code_ENUM_ErrorCount,le.src_interest_rate_type_code_LENGTH_ErrorCount
          ,le.rec_dt_interest_rate_type_code_CUSTOM_ErrorCount,0) / le.TotalCnt + 0.5;
    END;
    SummaryInfo := NORMALIZE(SummaryStats,354,Into(LEFT,COUNTER));
    orb_r := RECORD
      AllErrors.Src;
