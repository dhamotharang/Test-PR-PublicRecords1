...
ErrorRecord NoteErrors(h le,UNSIGNED2 c) := TRANSFORM
  SELF.ErrorNum := CHOOSE(c,
    ...
    Fields.InValid_air_conditioning_type((SALT311.StrType)le.air_conditioning_type,(SALT311.StrType)le.src_air_conditioning_type),
    ...
    Fields.InValid_basement_finish((SALT311.StrType)le.basement_finish,(SALT311.StrType)le.src_basement_finish),
    ...
    Fields.InValid_construction_type((SALT311.StrType)le.construction_type,(SALT311.StrType)le.src_construction_type),
    ...
    Fields.InValid_exterior_wall((SALT311.StrType)le.exterior_wall,(SALT311.StrType)le.src_exterior_wall),
    ...
    Fields.InValid_fireplace_type((SALT311.StrType)le.fireplace_type,(SALT311.StrType)le.src_fireplace_type),
    ...
    Fields.InValid_garage((SALT311.StrType)le.garage,(SALT311.StrType)le.src_garage),
    ...
    Fields.InValid_heating((SALT311.StrType)le.heating,(SALT311.StrType)le.src_heating),
    ...
    Fields.InValid_parking_type((SALT311.StrType)le.parking_type,(SALT311.StrType)le.src_parking_type),
    ...
    Fields.InValid_pool_type((SALT311.StrType)le.pool_type,(SALT311.StrType)le.src_pool_type),
    ...
    Fields.InValid_roof_cover((SALT311.StrType)le.roof_cover,(SALT311.StrType)le.src_roof_cover),
    ...
    Fields.InValid_foundation((SALT311.StrType)le.foundation,(SALT311.StrType)le.src_foundation),
    ...
    Fields.InValid_stories_type((SALT311.StrType)le.stories_type,(SALT311.StrType)le.src_stories_type),
    ...
    Fields.InValid_land_use_code((SALT311.StrType)le.land_use_code,(SALT311.StrType)le.src_land_use_code),
    ...
    Fields.InValid_location_influence_code((SALT311.StrType)le.location_influence_code,(SALT311.StrType)le.src_location_influence_code),
    ...
    Fields.InValid_property_type_code((SALT311.StrType)le.property_type_code,(SALT311.StrType)le.src_property_type_code),
    ...
    Fields.InValid_structure_quality((SALT311.StrType)le.structure_quality,(SALT311.StrType)le.src_structure_quality),
    ...
    Fields.InValid_water((SALT311.StrType)le.water,(SALT311.StrType)le.src_water),
    Fields.InValid_src_water((SALT311.StrType)le.src_water),
    Fields.InValid_tax_dt_water((SALT311.StrType)le.tax_dt_water),
    Fields.InValid_sewer((SALT311.StrType)le.sewer,(SALT311.StrType)le.src_sewer),
    ...
    Fields.InValid_floor_type((SALT311.StrType)le.floor_type,(SALT311.StrType)le.src_floor_type),
    ...
    Fields.InValid_frame_type((SALT311.StrType)le.frame_type,(SALT311.StrType)le.src_frame_type),
    ...
    Fields.InValid_fuel_type((SALT311.StrType)le.fuel_type,(SALT311.StrType)le.src_fuel_type),
    ...
    Fields.InValid_style_type((SALT311.StrType)le.style_type,(SALT311.StrType)le.src_style_type),
    ...
    Fields.InValid_full_part_sale((SALT311.StrType)le.full_part_sale,(SALT311.StrType)le.src_full_part_sale),
    ...
    Fields.InValid_sale_type_code((SALT311.StrType)le.sale_type_code,(SALT311.StrType)le.src_sale_type_code),
    ...
    Fields.InValid_loan_type_code((SALT311.StrType)le.loan_type_code,(SALT311.StrType)le.src_loan_type_code),
    ...
    Fields.InValid_interest_rate_type_code((SALT311.StrType)le.interest_rate_type_code,(SALT311.StrType)le.src_interest_rate_type_code),
