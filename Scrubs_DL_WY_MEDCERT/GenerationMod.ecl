...
EXPORT GenerationMod := MODULE
  ...
  EXPORT spcString :=
    ...
    + 'FIELDTYPE:invalid_orig_first_name:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,orig_middle_name,orig_last_name)\n'
    + 'FIELDTYPE:invalid_orig_middle_name:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,orig_first_name,orig_last_name)\n'
    + 'FIELDTYPE:invalid_orig_last_name:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,orig_first_name,orig_middle_name)\n'
    ...
    + 'FIELDTYPE:invalid_clean_name_first:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,clean_name_middle,Clean_name_last)\n'
    + 'FIELDTYPE:invalid_clean_name_middle:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,clean_name_first,Clean_name_last)\n'
    + 'FIELDTYPE:invalid_clean_name_last:CUSTOM(Scrubs_DL_WY_MEDCERT.functions.fn_chk_people_names>0,clean_name_first,clean_name_middle)\n'
    + '\n'
    + 'FIELD:append_process_date:TYPE(STRING8):LIKE(invalid_Past_Date):0,0\n'
    + 'FIELD:orig_first_name:TYPE(STRING12):LIKE(invalid_orig_first_name):0,0\n'
    + 'FIELD:orig_middle_name:TYPE(STRING12):LIKE(invalid_orig_middle_name):0,0\n'
    + 'FIELD:orig_last_name:TYPE(STRING20):LIKE(invalid_orig_last_name):0,0\n'
