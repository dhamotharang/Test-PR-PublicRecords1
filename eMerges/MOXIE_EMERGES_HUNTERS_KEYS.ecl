...
#workunit ('name', 'Build Emerges Hunters Keys ');

h := emerges.file_hunters_keybuild;
...
export MOXIE_EMERGES_HUNTERS_KEYS := sequential(parallel(k1,k2,k3,k4,k5,k6,k7,k8,k9),parallel(k10,k11,k12,k13,k14,k15,k16,k17));