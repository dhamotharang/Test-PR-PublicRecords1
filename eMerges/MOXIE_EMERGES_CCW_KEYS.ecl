...
k1 := BUILDINDEX(lfmname_records(lfmname != ''),,emerges.base_key_name_emerges_ccw + 'lfmname.key',moxie,overwrite);

unique_id_rec := record
t.unique_id;
t.__filepos;
end;

unique_id_records := table(t,unique_id_rec);

k1a := BUILDINDEX(unique_id_records(unique_id != ''),,emerges.base_key_name_emerges_ccw + 'unique_id.key',moxie,overwrite);
...
k2 := BUILDINDEX(dph_lname_records(dph_lname != '' and fname != ''),,emerges.base_key_name_emerges_ccw + 'dph_lname.fname.mname.lname.key',moxie,overwrite);
...
k3 := BUILDINDEX(st_lfmname_records(st != '' and lfmname != ''),,emerges.base_key_name_emerges_ccw + 'st.lfmname.key',moxie,overwrite);
...
k4 := BUILDINDEX(st_dph_lname_records(st != '' and dph_lname != ''),,
	emerges.base_key_name_emerges_ccw + 'st.dph_lname.fname.mname.lname.key',moxie,overwrite);
...
k5 := BUILDINDEX(st_city_lfmname_records(st != '' and city_from_zip != ''),,emerges.base_key_name_emerges_ccw + 'st.city.lfmname.key',
			moxie,overwrite);
...
k6 := BUILDINDEX(City_d2(st != '' and city_from_zip != ''),,
			emerges.base_key_name_emerges_ccw + 'st.city.dph_lname.fname.mname.lname.key',
			moxie,overwrite);
...
k7 := BUILDINDEX(z5_lfmname_records,,emerges.base_key_name_emerges_ccw + 'z5.lfmname.key',moxie,overwrite);
...
k8 := BUILDINDEX(z5_dph_lname_records,,
	emerges.base_key_name_emerges_ccw + 'z5.dph_lname.fname.mname.lname.key',moxie,overwrite);
...
k9 := BUILDINDEX(dob_lfmname_records,,emerges.base_key_name_emerges_ccw + 'dob.lfmname.key',moxie,overwrite);
...
k10 := BUILDINDEX(dob_fmlname_records,,emerges.base_key_name_emerges_ccw + 'dob.fmlname.key',moxie,overwrite);
...
k11 := BUILDINDEX(mfname_dob_records,,emerges.base_key_name_emerges_ccw + 'mfname.dob.key',moxie,overwrite);
...
k12 := BUILDINDEX(ssn_records,,emerges.base_key_name_emerges_ccw + 'ssn.key',moxie,overwrite);
...
k13 := BUILDINDEX(state_type_lfmname_records,,emerges.base_key_name_emerges_ccw + 'state.type.lfmname.key',
		moxie,overwrite);
...
k14 := BUILDINDEX(did_records,,emerges.base_key_name_emerges_ccw + 'did.key',moxie,overwrite);
...
k15 := BUILDINDEX(z5_address_records,,emerges.base_key_name_emerges_ccw + 
			'z5.prim_name.suffix.predir.postdir.prim_range.sec_range.lfmname.ssn.key', moxie, overwrite);
k16 := BUILDINDEX(z5_address_records,{z5,prim_name,suffix,predir,postdir,prim_range,sec_range,(big_endian unsigned8 )__filepos},emerges.base_key_name_emerges_ccw + 
